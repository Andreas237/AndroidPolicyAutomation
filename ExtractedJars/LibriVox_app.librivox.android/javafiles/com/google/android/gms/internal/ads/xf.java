	...
	implements ThreadFactory
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #14  <Field String b>
		super();
	//    3    5:aload_0         
	...
	//   10   18:putfield        #24  <Field AtomicInteger a>
	//   11   21:return          
	}
	...
	public final Thread newThread(Runnable runnable)
	{
		String s = b;
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field String b>
	//    2    4:astore_3        
		int i = a.getAndIncrement();
	//    3    5:aload_0         
	//    4    6:getfield        #24  <Field AtomicInteger a>
	//    5    9:invokevirtual   #31  <Method int AtomicInteger.getAndIncrement()>
	//    6   12:istore_2        
		StringBuilder stringbuilder = new StringBuilder(String.valueOf(((Object) (s))).length() + 23);
	//    7   13:new             #33  <Class StringBuilder>
	//    8   16:dup             
	//    9   17:aload_3         
	//   10   18:invokestatic    #39  <Method String String.valueOf(Object)>
	//   11   21:invokevirtual   #42  <Method int String.length()>
	//   12   24:bipush          23
	//   13   26:iadd            
