	...
	implements Runnable
{
	...
	bon(bol bol1, String s, long l, long l1)
	{
		d = bol1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #17  <Field bol d>
		a = s;
	//    3    5:aload_0         
	//    4    6:aload_2         
	...
	public final void run()
	{
		bol.a(d).a(a, b, c);
	//    0    0:aload_0         
	//    1    1:getfield        #17  <Field bol d>
	//    2    4:invokestatic    #33  <Method bok bol.a(bol)>
	//    3    7:aload_0         
	...
	//    9   19:invokeinterface #38  <Method void bok.a(String, long, long)>
	//   10   24:return          
	}
