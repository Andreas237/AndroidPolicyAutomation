...
final class hb extends ha
{
	...
	//    1    1:iload_1         
	//    2    2:aconst_null     
	//    3    3:invokespecial   #9   <Method void ha(int, hb)>
	//    4    6:return          
	}
	...
	public final void a()
	{
		if(!((ha)this).b())
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #16  <Method boolean ha.b()>
	//*   2    4:ifne            134
		{
			for(int i = 0; i < ((ha)this).c(); i++)
	//*   3    7:iconst_0        
	//*   4    8:istore_1        
	//*   5    9:iload_1         
	//*   6   10:aload_0         
	//*   7   11:invokevirtual   #20  <Method int ha.c()>
	//*   8   14:icmpge          66
			{
				java.util.Map.Entry entry = ((ha)this).b(i);
	//    9   17:aload_0         
	//   10   18:iload_1         
	//   11   19:invokevirtual   #23  <Method java.util.Map$Entry ha.b(int)>
	//   12   22:astore_2        
				if(((em)entry.getKey()).d())
	//*  13   23:aload_2         
	//*  14   24:invokeinterface #29  <Method Object java.util.Map$Entry.getKey()>
	//*  15   29:checkcast       #31  <Class em>
	//*  16   32:invokeinterface #34  <Method boolean em.d()>
	//*  17   37:ifeq            59
	...
	//   28   62:istore_1        
	//*  29   63:goto            9
			Iterator iterator = ((ha)this).d().iterator();
	//   30   66:aload_0         
	//   31   67:invokevirtual   #52  <Method Iterable ha.d()>
	...
	//   40   94:astore_3        
				if(((em)entry1.getKey()).d())
	//*  41   95:aload_3         
	//*  42   96:invokeinterface #29  <Method Object java.util.Map$Entry.getKey()>
	//*  43  101:checkcast       #31  <Class em>
	//*  44  104:invokeinterface #34  <Method boolean em.d()>
	//*  45  109:ifeq            76
	...
	//   53  131:goto            76
		...
		super.a();
	//   54  134:aload_0         
	//   55  135:invokespecial   #68  <Method void ha.a()>
	//   56  138:return          
	}
}
