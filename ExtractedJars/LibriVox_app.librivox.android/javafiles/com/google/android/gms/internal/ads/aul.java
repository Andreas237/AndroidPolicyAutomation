	...
	implements att
{
	...
	aul(atv atv, String s, Object aobj[])
	{
	//    0    0:aload_0         
	...
	//*   5    7:icmpne          14
			return asm.h;
	//    6   10:getstatic       #41  <Field int asm.h>
	//    7   13:ireturn         
		else
			return asm.i;
	//    8   14:getstatic       #44  <Field int asm.i>
	//    9   17:ireturn         
	}
