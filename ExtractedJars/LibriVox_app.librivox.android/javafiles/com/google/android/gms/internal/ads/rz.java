	...
	implements android.os.Parcelable.Creator
{
	...
	//   29   55:invokestatic    #46  <Method void a.E(Parcel, int)>
		return ((Object) (new zzasy(parcelfiledescriptor)));
	//   30   58:new             #48  <Class zzasy>
	//   31   61:dup             
	//   32   62:aload           4
	//   33   64:invokespecial   #51  <Method void zzasy(ParcelFileDescriptor)>
	//   34   67:areturn         
	}

	public final Object[] newArray(int i)
	{
		return ((Object []) (new zzasy[i]));
	//    0    0:iload_1         
	//    1    1:anewarray       zzasy[]
	//    2    4:areturn         
	}
