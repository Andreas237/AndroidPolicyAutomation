...
_L16:
	...
	//  223  420:istore          7
		throw new avw(i, j1);
	//  224  422:new             #49  <Class avw>
	//  225  425:dup             
	//  226  426:iload           5
	//  227  428:iload           10
	//  228  430:invokespecial   #52  <Method void avw(int, int)>
	//  229  433:athrow          
_L13:
		i1 = j + 1;
	//  230  434:iload           6
...
_L9:
	...
	abstract int a(int i, byte abyte0[], int j, int k);

	abstract int a(CharSequence charsequence, byte abyte0[], int i, int j);

	abstract void a(CharSequence charsequence, ByteBuffer bytebuffer);

	final boolean a(byte abyte0[], int i, int j)
	{
		return a(0, abyte0, i, j) == 0;
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:aload_1         
	//    3    3:iload_2         
	//    4    4:iload_3         
	//    5    5:invokevirtual   #92  <Method int a(int, byte[], int, int)>
	//    6    8:ifne            13
	//    7   11:iconst_1        
	//    8   12:ireturn         
	//    9   13:iconst_0        
	...
	abstract String b(byte abyte0[], int i, int j);
}
