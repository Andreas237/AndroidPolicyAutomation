...
public final class alh extends ash
	implements atx
{
	...
	public static alh a(aqq aqq1)
	{
		return (alh)ash.a(((ash) (zzfes)), aqq1);
	//    0    0:getstatic       #21  <Field alh zzfes>
	//    1    3:aload_0         
	//    2    4:invokestatic    #37  <Method ash ash.a(ash, aqq)>
	//    3    7:checkcast       #2   <Class alh>
	//    4   10:areturn         
	}

	static void a(alh alh1, int i)
	{
		alh1.b(0);
	//    0    0:aload_0         
	//    1    1:iconst_0        
	...
	static void a(alh alh1, aqq aqq1)
	{
		alh1.b(aqq1);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public static ali c()
	{
		return (ali)(asi)((ash) (zzfes)).a(asm.e, ((Object) (null)), ((Object) (null)));
	//    0    0:getstatic       #21  <Field alh zzfes>
	...
	{
		alj.a[i - 1];
	//    0    0:getstatic       #73  <Field int[] alj.a>
	//    1    3:iload_1         
	//    2    4:iconst_1        
	//    3    5:isub            
	//    4    6:iaload          
...
_L6:
	...
	//   18   68:ifnonnull       110
_L9:
		com/google/android/gms/internal/ads/alh;
	//   19   71:ldc1            #2   <Class alh>
	...
	//   26   81:ifnonnull       99
_L11:
		obj = ((Object) (new asj(((ash) (zzfes)))));
	//   27   84:new             #86  <Class asj>
	//   28   87:dup             
	//   29   88:getstatic       #21  <Field alh zzfes>
...
_L5:
		return ((Object) (zzfes));
	//   45  112:getstatic       #21  <Field alh zzfes>
	//   46  115:areturn         
_L4:
		return a(((atv) (zzfes)), "\000\002\000\000\001\003\002\000\000\000\001\013\003\n", new Object[] {
			"zzfea", "zzfei"
		});
	//   47  116:getstatic       #21  <Field alh zzfes>
	//   48  119:ldc1            #91  <String "\000\002\000\000\001\003\002\000\000\000\001\013\003\n">
	//   49  121:iconst_2        
	...
	//   60  138:areturn         
_L3:
		return ((Object) (new ali(((alj) (null)))));
	//   61  139:new             #65  <Class ali>
	//   62  142:dup             
	//   63  143:aconst_null     
	//   64  144:invokespecial   #101 <Method void ali(alj)>
	//   65  147:areturn         
_L2:
		return ((Object) (new alh()));
	//   66  148:new             #2   <Class alh>
	//   67  151:dup             
	//   68  152:invokespecial   #19  <Method void alh()>
	//   69  155:areturn         
	}
	...
	private static final alh zzfes;
	private int zzfea;
	private aqq zzfei;
	...
	//    0    0:new             #2   <Class alh>
	//    1    3:dup             
	//    2    4:invokespecial   #19  <Method void alh()>
	//    3    7:putstatic       #21  <Field alh zzfes>
		ash.a(com/google/android/gms/internal/ads/alh, ((ash) (zzfes)));
	//    4   10:ldc1            #2   <Class alh>
	//    5   12:getstatic       #21  <Field alh zzfes>
