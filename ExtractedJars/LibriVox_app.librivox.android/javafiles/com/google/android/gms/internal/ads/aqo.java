	...
	implements ast, auh, RandomAccess
{
	...
	//    3    5:iconst_0        
	//    4    6:invokespecial   #29  <Method void aqo(boolean[], int)>
	//    5    9:return          
	}

	private aqo(boolean aflag[], int i)
	{
	//    0    0:aload_0         
	...
	private final void a(int i, boolean flag)
	{
		((aqk)this).c();
	//    0    0:aload_0         
	...
	//*   9   15:icmpgt          122
			{
				boolean aflag[] = b;
	//   10   18:aload_0         
	//   11   19:getfield        #32  <Field boolean[] b>
	//   12   22:astore          4
				if(j < aflag.length)
	//*  13   24:iload_3         
	//*  14   25:aload           4
	...
	//   42   66:invokestatic    #43  <Method void System.arraycopy(Object, int, Object, int, int)>
					System.arraycopy(((Object) (b)), i, ((Object) (aflag1)), i + 1, c - i);
	//   43   69:aload_0         
	//   44   70:getfield        #32  <Field boolean[] b>
	//   45   73:iload_1         
	//   46   74:aload           5
	//   47   76:iload_1         
	//   48   77:iconst_1        
	...
	//   55   88:aload_0         
	//   56   89:aload           5
	//   57   91:putfield        #32  <Field boolean[] b>
				}
				b[i] = flag;
	//   58   94:aload_0         
	//   59   95:getfield        #32  <Field boolean[] b>
	//   60   98:iload_1         
	//   61   99:iload_2         
	//   62  100:bastore         
				c = c + 1;
	...
	//*   3    5:icmplt          28
			return ((ast) (new aqo(Arrays.copyOf(b, i), c)));
	//    4    8:new             #2   <Class aqo>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:getfield        #32  <Field boolean[] b>
	//    8   16:iload_1         
	//    9   17:invokestatic    #81  <Method boolean[] Arrays.copyOf(boolean[], int)>
	//   10   20:aload_0         
	//   11   21:getfield        #34  <Field int c>
	//   12   24:invokespecial   #29  <Method void aqo(boolean[], int)>
	//   13   27:areturn         
		else
	...
	//    2    2:getfield        #34  <Field int c>
	//    3    5:iload_1         
	//    4    6:invokespecial   #87  <Method void a(int, boolean)>
	//    5    9:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:aload_2         
	//    3    3:checkcast       #91  <Class Boolean>
	//    4    6:invokevirtual   #95  <Method boolean Boolean.booleanValue()>
	//    5    9:invokespecial   #87  <Method void a(int, boolean)>
	//    6   12:return          
	}
	...
	//   11   21:ireturn         
		collection = ((Collection) ((aqo)collection));
	//   12   22:aload_1         
	//   13   23:checkcast       #2   <Class aqo>
	//   14   26:astore_1        
		int i = ((aqo) (collection)).c;
	//   15   27:aload_1         
	...
	//   33   54:istore_2        
			boolean aflag[] = b;
	//   34   55:aload_0         
	//   35   56:getfield        #32  <Field boolean[] b>
	//   36   59:astore          4
			if(i > aflag.length)
	//*  37   61:iload_2         
	//*  38   62:aload           4
	//*  39   64:arraylength     
	//*  40   65:icmple          78
				b = Arrays.copyOf(aflag, i);
	//   41   68:aload_0         
	//   42   69:aload           4
	//   43   71:iload_2         
	//   44   72:invokestatic    #81  <Method boolean[] Arrays.copyOf(boolean[], int)>
	//   45   75:putfield        #32  <Field boolean[] b>
			System.arraycopy(((Object) (((aqo) (collection)).b)), 0, ((Object) (b)), c, ((aqo) (collection)).c);
	//   46   78:aload_1         
	//   47   79:getfield        #32  <Field boolean[] b>
	//   48   82:iconst_0        
	//   49   83:aload_0         
	//   50   84:getfield        #32  <Field boolean[] b>
	//   51   87:aload_0         
	...
	//   20   36:iconst_0        
	//   21   37:ireturn         
		obj = ((Object) (((aqo) (obj)).b));
	//   22   38:aload_1         
	//   23   39:getfield        #32  <Field boolean[] b>
	//   24   42:astore_1        
		for(int i = 0; i < c; i++)
	//*  25   43:iconst_0        
	//*  26   44:istore_2        
	...
	//*  30   50:icmpge          74
			if(b[i] != obj[i])
	//*  31   53:aload_0         
	//*  32   54:getfield        #32  <Field boolean[] b>
	//*  33   57:iload_2         
	//*  34   58:baload          
	//*  35   59:aload_1         
	//*  36   60:iload_2         
	...
	//    2    2:invokespecial   #116 <Method void b(int)>
		return ((Object) (Boolean.valueOf(b[i])));
	//    3    5:aload_0         
	//    4    6:getfield        #32  <Field boolean[] b>
	//    5    9:iload_1         
	//    6   10:baload          
	//    7   11:invokestatic    #120 <Method Boolean Boolean.valueOf(boolean)>
	//    8   14:areturn         
	}
	...
	//   10   15:imul            
	//   11   16:aload_0         
	//   12   17:getfield        #32  <Field boolean[] b>
	//   13   20:iload_1         
	//   14   21:baload          
	//   15   22:invokestatic    #125 <Method int aso.a(boolean)>
	//   16   25:iadd            
	//   17   26:istore_2        
	...
	//    4    6:invokespecial   #116 <Method void b(int)>
		boolean aflag[] = b;
	//    5    9:aload_0         
	//    6   10:getfield        #32  <Field boolean[] b>
	//    7   13:astore          4
	...
	//   42   66:iload_3         
	//   43   67:invokestatic    #120 <Method Boolean Boolean.valueOf(boolean)>
	//   44   70:areturn         
	}
	...
	//*   7   11:icmpge          79
			if(obj.equals(((Object) (Boolean.valueOf(b[i])))))
	//*   8   14:aload_1         
	//*   9   15:aload_0         
	//*  10   16:getfield        #32  <Field boolean[] b>
	//*  11   19:iload_2         
	//*  12   20:baload          
	//*  13   21:invokestatic    #120 <Method Boolean Boolean.valueOf(boolean)>
	//*  14   24:invokevirtual   #129 <Method boolean Object.equals(Object)>
	//*  15   27:ifeq            72
			{
				obj = ((Object) (b));
	//   16   30:aload_0         
	//   17   31:getfield        #32  <Field boolean[] b>
	//   18   34:astore_1        
	...
	//    6   10:getfield        #32  <Field boolean[] b>
	//    7   13:astore_3        
			System.arraycopy(((Object) (aflag)), j, ((Object) (aflag)), i, c - j);
	//    8   14:aload_3         
	//    9   15:iload_2         
	//   10   16:aload_3         
	//   11   17:iload_1         
	...
	//    0    0:aload_2         
	//    1    1:checkcast       #91  <Class Boolean>
	//    2    4:invokevirtual   #95  <Method boolean Boolean.booleanValue()>
	//    3    7:istore_3        
		((aqk)this).c();
	//    4    8:aload_0         
	...
	//    8   14:invokespecial   #116 <Method void b(int)>
		obj = ((Object) (b));
	//    9   17:aload_0         
	//   10   18:getfield        #32  <Field boolean[] b>
	//   11   21:astore_2        
	...
	//   19   30:bastore         
		return ((Object) (Boolean.valueOf(flag)));
	//   20   31:iload           4
	//   21   33:invokestatic    #120 <Method Boolean Boolean.valueOf(boolean)>
	//   22   36:areturn         
	}
	...
	//    0    0:new             #2   <Class aqo>
	//    1    3:dup             
	//    2    4:invokespecial   #21  <Method void aqo()>
	//    3    7:astore_0        
		a = aqo1;
	//    4    8:aload_0         
	//    5    9:putstatic       #23  <Field aqo a>
		((aqk) (aqo1)).b();
	//    6   12:aload_0         
