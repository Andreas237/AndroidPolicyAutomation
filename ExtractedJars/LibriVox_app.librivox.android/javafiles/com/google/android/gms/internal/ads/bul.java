...
public final class bul extends ash
	implements atx
{
	...
	public static aug a()
	{
		return (aug)((ash) (zzcgk)).a(asm.g, ((Object) (null)), ((Object) (null)));
	//    0    0:getstatic       #24  <Field bul zzcgk>
...
_L6:
	...
	//   18   68:ifnonnull       110
_L9:
		com/google/android/gms/internal/ads/bul;
	//   19   71:ldc1            #2   <Class bul>
	...
	//   26   81:ifnonnull       99
_L11:
		obj = ((Object) (new asj(((ash) (zzcgk)))));
	//   27   84:new             #63  <Class asj>
	//   28   87:dup             
	//   29   88:getstatic       #24  <Field bul zzcgk>
...
_L5:
		return ((Object) (zzcgk));
	//   45  112:getstatic       #24  <Field bul zzcgk>
	//   46  115:areturn         
_L4:
		obj = ((Object) (buv.b()));
	//   47  116:invokestatic    #71  <Method asr buv.b()>
	//   48  119:astore_2        
		return a(((atv) (zzcgk)), "\001\003\000\001\001\003\003\000\000\000\001\f\000\002\t\001\003\t\002", new Object[] {
			"zzccg", "zzcea", obj, "zzcft", "zzcfu"
		});
	//   49  120:getstatic       #24  <Field bul zzcgk>
	...
	//   74  156:areturn         
_L3:
		return ((Object) (new bum(((bup) (null)))));
	//   75  157:new             #84  <Class bum>
	//   76  160:dup             
	//   77  161:aconst_null     
	//   78  162:invokespecial   #87  <Method void bum(bup)>
	//   79  165:areturn         
_L2:
		return ((Object) (new bul()));
	//   80  166:new             #2   <Class bul>
	//   81  169:dup             
	//   82  170:invokespecial   #22  <Method void bul()>
	//   83  173:areturn         
	}

	private static volatile aug zzcas;
	private static final bul zzcgk;
	private int zzccg;
	private int zzcea;
	private buc zzcft;
	private btw zzcfu;
	...
	//    0    0:new             #2   <Class bul>
	//    1    3:dup             
	//    2    4:invokespecial   #22  <Method void bul()>
	//    3    7:putstatic       #24  <Field bul zzcgk>
		ash.a(com/google/android/gms/internal/ads/bul, ((ash) (zzcgk)));
	//    4   10:ldc1            #2   <Class bul>
	//    5   12:getstatic       #24  <Field bul zzcgk>
