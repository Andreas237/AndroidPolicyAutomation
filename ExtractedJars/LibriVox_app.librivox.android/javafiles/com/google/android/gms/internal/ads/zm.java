...
public final class zm
{
	...
	//   18   38:goto            66
		callable;
	//   19   41:astore_1        
		aag.b("Unexpected exception.", ((Throwable) (callable)));
	//   20   42:ldc1            #42  <String "Unexpected exception.">
	//   21   44:aload_1         
	//   22   45:invokestatic    #48  <Method void aag.b(String, Throwable)>
		qf.a(context).a(((Throwable) (callable)), "StrictModeUtil.runWithLaxStrictMode");
	//   23   48:aload_0         
	//   24   49:invokestatic    #53  <Method qj qf.a(Context)>
	//   25   52:aload_1         
	//   26   53:ldc1            #55  <String "StrictModeUtil.runWithLaxStrictMode">
	//   27   55:invokeinterface #60  <Method void qj.a(Throwable, String)>
		StrictMode.setThreadPolicy(threadpolicy);
	//   28   60:aload_2         
