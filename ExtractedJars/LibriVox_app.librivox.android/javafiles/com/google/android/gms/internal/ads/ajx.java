	...
	implements ait
{
	...
	//*   8   16:iload           4
	//*   9   18:ldc1            #24  <Int 0x106b0411>
	//*  10   20:icmpeq          26
	//*  11   23:goto            42
	//*  12   26:aload           6
	//*  13   28:ldc1            #26  <String "hybriddecrypt">
	...
	//*  32   70:aload_1         
	//*  33   71:ldc1            #33  <String "type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey">
	...
	//*  39   84:ifne            129
			{
				s1 = ((String) (new aju()));
	//   40   87:new             #35  <Class aju>
	//   41   90:dup             
	//   42   91:invokespecial   #36  <Method void aju()>
	//   43   94:astore_2        
				if(i <= 0)
	//*  44   95:iload_3         
	//*  45   96:ifgt            101
