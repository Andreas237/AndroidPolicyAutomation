...
final class eb extends cy
	implements fe, gs, RandomAccess
{
	...
	//    2    3:newarray        double[]
	//    3    5:iconst_0        
	//    4    6:invokespecial   #29  <Method void eb(double[], int)>
	//    5    9:return          
	}

	private eb(double ad[], int i)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #30  <Method void cy()>
		b = ad;
	//    2    4:aload_0         
	//    3    5:aload_1         
	...
	private final void a(int i, double d)
	{
		((cy)this).c();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #37  <Method void cy.c()>
		if(i >= 0)
	//*   2    4:iload_1         
	//*   3    5:iflt            127
		{
	...
	//*   3    5:icmplt          28
			return ((fe) (new eb(Arrays.copyOf(b, i), c)));
	//    4    8:new             #2   <Class eb>
	//    5   11:dup             
	//    6   12:aload_0         
	...
	//   12   24:invokespecial   #29  <Method void eb(double[], int)>
	//   13   27:areturn         
		else
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #37  <Method void cy.c()>
		fa.a(((Object) (collection)));
	//    2    4:aload_1         
	//    3    5:invokestatic    #102 <Method Object fa.a(Object)>
	//    4    8:pop             
		if(!(collection instanceof eb))
	//*   5    9:aload_1         
	//*   6   10:instanceof      #2   <Class eb>
	//*   7   13:ifne            22
			return super.addAll(collection);
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:invokespecial   #104 <Method boolean cy.addAll(Collection)>
	//   11   21:ireturn         
		collection = ((Collection) ((eb)collection));
	//   12   22:aload_1         
	//   13   23:checkcast       #2   <Class eb>
	//   14   26:astore_1        
		int i = ((eb) (collection)).c;
	//   15   27:aload_1         
	...
	//   45   75:putfield        #32  <Field double[] b>
			System.arraycopy(((Object) (((eb) (collection)).b)), 0, ((Object) (b)), c, ((eb) (collection)).c);
	//   46   78:aload_1         
	...
	//*   5    7:aload_1         
	//*   6    8:instanceof      #2   <Class eb>
	//*   7   11:ifne            20
			return super.equals(obj);
	//    8   14:aload_0         
	//    9   15:aload_1         
	//   10   16:invokespecial   #112 <Method boolean cy.equals(Object)>
	//   11   19:ireturn         
		obj = ((Object) ((eb)obj));
	//   12   20:aload_1         
	//   13   21:checkcast       #2   <Class eb>
	//   14   24:astore_1        
		if(c != ((eb) (obj)).c)
	//*  15   25:aload_0         
	...
	//*  30   50:icmpge          81
			if(Double.doubleToLongBits(b[i]) != Double.doubleToLongBits(obj[i]))
	//*  31   53:aload_0         
	//*  32   54:getfield        #32  <Field double[] b>
	//*  33   57:iload_2         
	//*  34   58:daload          
	//*  35   59:invokestatic    #116 <Method long Double.doubleToLongBits(double)>
	//*  36   62:aload_1         
	//*  37   63:iload_2         
	//*  38   64:daload          
	//*  39   65:invokestatic    #116 <Method long Double.doubleToLongBits(double)>
	//*  40   68:lcmp            
	//*  41   69:ifeq            74
				return false;
	//   42   72:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #120 <Method void b(int)>
		return ((Object) (Double.valueOf(b[i])));
	//    3    5:aload_0         
	//    4    6:getfield        #32  <Field double[] b>
	//    5    9:iload_1         
	//    6   10:daload          
	//    7   11:invokestatic    #124 <Method Double Double.valueOf(double)>
	//    8   14:areturn         
	}
	...
	//*   7    9:icmpge          37
			j = j * 31 + fa.a(Double.doubleToLongBits(b[i]));
	//    8   12:iload_2         
	//    9   13:bipush          31
	//   10   15:imul            
	//   11   16:aload_0         
	...
	//   13   20:iload_1         
	//   14   21:daload          
	//   15   22:invokestatic    #116 <Method long Double.doubleToLongBits(double)>
	//   16   25:invokestatic    #129 <Method int fa.a(long)>
	//   17   28:iadd            
	//   18   29:istore_2        
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:invokespecial   #120 <Method void b(int)>
		double ad[] = b;
	//    5    9:aload_0         
	...
	//   29   46:iconst_1        
	//   30   47:isub            
	//   31   48:invokestatic    #43  <Method void System.arraycopy(Object, int, Object, int, int)>
		c = c - 1;
	//   32   51:aload_0         
	//   33   52:aload_0         
	//   34   53:getfield        #34  <Field int c>
	//   35   56:iconst_1        
	//   36   57:isub            
	//   37   58:putfield        #34  <Field int c>
		modCount = modCount + 1;
	//   38   61:aload_0         
	//   39   62:aload_0         
	//   40   63:getfield        #46  <Field int modCount>
	//   41   66:iconst_1        
	//   42   67:iadd            
	//   43   68:putfield        #46  <Field int modCount>
		return ((Object) (Double.valueOf(d)));
	//   44   71:dload_2         
	//   45   72:invokestatic    #124 <Method Double Double.valueOf(double)>
	//   46   75:areturn         
	}
	...
	//*  11   19:iload_2         
	//*  12   20:daload          
	//*  13   21:invokestatic    #124 <Method Double Double.valueOf(double)>
	...
	//   29   47:iconst_1        
	//   30   48:isub            
	//   31   49:invokestatic    #43  <Method void System.arraycopy(Object, int, Object, int, int)>
				c = c - 1;
	//   32   52:aload_0         
	//   33   53:aload_0         
	...
	//   38   62:aload_0         
	//   39   63:aload_0         
	//   40   64:getfield        #46  <Field int modCount>
	//   41   67:iconst_1        
	//   42   68:iadd            
	//   43   69:putfield        #46  <Field int modCount>
				return true;
	//   44   72:iconst_1        
	//   45   73:ireturn         
			}
	...
	//    3    7:dstore_3        
		((cy)this).c();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #37  <Method void cy.c()>
		b(i);
	//    6   12:aload_0         
	//    7   13:iload_1         
	//    8   14:invokespecial   #120 <Method void b(int)>
		obj = ((Object) (b));
	//    9   17:aload_0         
	...
	//   20   31:dload           5
	//   21   33:invokestatic    #124 <Method Double Double.valueOf(double)>
	//   22   36:areturn         
	}
	...
	//    0    0:new             #2   <Class eb>
	//    1    3:dup             
	//    2    4:invokespecial   #21  <Method void eb()>
	//    3    7:astore_0        
		a = eb1;
	//    4    8:aload_0         
	//    5    9:putstatic       #23  <Field eb a>
		((cy) (eb1)).b();
	//    6   12:aload_0         
	//    7   13:invokevirtual   #25  <Method void cy.b()>
	//*   8   16:return          
	}
}
