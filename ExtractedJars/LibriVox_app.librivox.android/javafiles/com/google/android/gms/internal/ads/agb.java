	...
	//*  17   34:monitorenter    
		{
			if(aga.a(a) != i)
	//*  18   35:aload_0         
	//*  19   36:getfield        #12  <Field aga a>
	//*  20   39:invokestatic    #47  <Method int aga.a(aga)>
	//*  21   42:iload_3         
	//*  22   43:icmpeq          62
			{
				aga.a(a, i);
	//   23   46:aload_0         
	//   24   47:getfield        #12  <Field aga a>
	//   25   50:iload_3         
	//   26   51:invokestatic    #50  <Method int aga.a(aga, int)>
	//   27   54:pop             
				a.requestLayout();
	//   28   55:aload_0         
	//   29   56:getfield        #12  <Field aga a>
	//   30   59:invokevirtual   #53  <Method void aga.requestLayout()>
			}
		}
	//   31   62:aload_1         
	//   32   63:monitorexit     
