	...
	implements Runnable
{
	...
	aeu(aeq aeq1, String s, String s1, long l)
	{
		d = aeq1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//   20   44:pop             
		((Map) (hashmap)).put("totalDuration", ((Object) (Long.toString(c))));
	//   21   45:aload_1         
	//   22   46:ldc1            #47  <String "totalDuration">
	//   23   48:aload_0         
	//   24   49:getfield        #23  <Field long c>
	//   25   52:invokestatic    #53  <Method String Long.toString(long)>
