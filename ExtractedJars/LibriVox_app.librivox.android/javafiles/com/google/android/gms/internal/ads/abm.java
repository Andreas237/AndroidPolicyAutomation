...
final class abm extends aam
{

	private abm(Executor executor)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #11  <Method void aam()>
		a = executor;
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #13  <Field Executor a>
	//    5    9:return          
	}

	abm(Executor executor, abk abk)
	{
		this(executor);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #17  <Method void abm(Executor)>
	//    3    5:return          
	}
	...
	public final void execute(Runnable runnable)
	{
		a.execute(runnable);
	//    0    0:aload_0         
	//    1    1:getfield        #13  <Field Executor a>
	//    2    4:aload_1         
