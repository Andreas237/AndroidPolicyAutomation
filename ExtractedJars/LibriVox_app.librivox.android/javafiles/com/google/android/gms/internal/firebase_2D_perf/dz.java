...
final class dz extends dy
{
	...
	dz(byte abyte0[], int i, int j)
	{
		super(((eb) (null)));
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:invokespecial   #15  <Method void dy(eb)>
		if(abyte0 != null)
	//*   3    5:aload_1         
	//*   4    6:ifnull          89
		{
	...
	//   20   28:aload_0         
	//   21   29:aload_1         
	//   22   30:putfield        #17  <Field byte[] b>
				c = 0;
	//   23   33:aload_0         
	//   24   34:iconst_0        
	//   25   35:putfield        #19  <Field int c>
				e = 0;
	//   26   38:aload_0         
	//   27   39:iconst_0        
	//   28   40:putfield        #21  <Field int e>
				d = k;
	//   29   43:aload_0         
	//   30   44:iload           4
	//   31   46:putfield        #23  <Field int d>
				return;
	//   32   49:return          
			} else
			{
	...
	//   33   50:new             #25  <Class IllegalArgumentException>
	//   34   53:dup             
	//   35   54:ldc1            #27  <String "Array range is invalid. Buffer.length=%d, offset=%d, length=%d">
	//   36   56:iconst_3        
	//   37   57:anewarray       Object[]
	//   38   60:dup             
	//   39   61:iconst_0        
	//   40   62:aload_1         
	//   41   63:arraylength     
	//   42   64:invokestatic    #35  <Method Integer Integer.valueOf(int)>
	//   43   67:aastore         
	//   44   68:dup             
	//   45   69:iconst_1        
	//   46   70:iconst_0        
	//   47   71:invokestatic    #35  <Method Integer Integer.valueOf(int)>
	//   48   74:aastore         
	//   49   75:dup             
	//   50   76:iconst_2        
	//   51   77:iload_3         
	//   52   78:invokestatic    #35  <Method Integer Integer.valueOf(int)>
	//   53   81:aastore         
	//   54   82:invokestatic    #41  <Method String String.format(String, Object[])>
	//   55   85:invokespecial   #44  <Method void IllegalArgumentException(String)>
	//   56   88:athrow          
			}
		} else
		{
			throw new NullPointerException("buffer");
	//   57   89:new             #46  <Class NullPointerException>
	//   58   92:dup             
	//   59   93:ldc1            #48  <String "buffer">
	//   60   95:invokespecial   #49  <Method void NullPointerException(String)>
	//   61   98:athrow          
		}
	}

	private final void c(byte abyte0[], int i, int j)
	{
		try
		{
	...
	//    6   10:iload_3         
	//    7   11:invokestatic    #58  <Method void System.arraycopy(Object, int, Object, int, int)>
			e = e + j;
	//    8   14:aload_0         
	//    9   15:aload_0         
	...
	//*  15   25:astore_1        
		{
			throw new ea(String.format("Pos: %d, limit: %d, len: %d", new Object[] {
				Integer.valueOf(e), Integer.valueOf(d), Integer.valueOf(j)
			}), ((Throwable) (abyte0)));
	//   16   26:new             #60  <Class ea>
	//   17   29:dup             
	//   18   30:ldc1            #62  <String "Pos: %d, limit: %d, len: %d">
	//   19   32:iconst_3        
	...
	//   39   66:aload_1         
	//   40   67:invokespecial   #65  <Method void ea(String, Throwable)>
	//   41   70:athrow          
		}
	}
	...
	//   17   23:new             #60  <Class ea>
	//   18   26:dup             
	//   19   27:ldc1            #62  <String "Pos: %d, limit: %d, len: %d">
	//   20   29:iconst_3        
	...
	//   40   63:aload_3         
	//   41   64:invokespecial   #65  <Method void ea(String, Throwable)>
	//   42   67:athrow          
		}
		abyte0[i] = byte0;
	}
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:invokevirtual   #71  <Method void dy.b(int)>
			return;
	//    5    9:return          
		} else
		{
	...
	//    7   11:iload_1         
	//    8   12:i2l             
	//    9   13:invokevirtual   #74  <Method void dy.a(long)>
			return;
	//   10   16:return          
		}
	}
	...
	//    4    4:iload_2         
	//    5    5:ior             
	//    6    6:invokevirtual   #71  <Method void dy.b(int)>
	//    7    9:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:iconst_0        
	//    3    3:invokevirtual   #78  <Method void dy.a(int, int)>
		((dy)this).a(l);
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #74  <Method void dy.a(long)>
	//    7   11:return          
	}

	public final void a(int i, di di1)
	{
		((dy)this).a(i, 2);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	//    4    6:aload_0         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #82  <Method void dy.a(di)>
	//    7   11:return          
	}

	public final void a(int i, gd gd1)
	{
		((dy)this).a(1, 3);
	//    0    0:aload_0         
	//    1    1:iconst_1        
	...
	//    5    7:iconst_2        
	//    6    8:iload_1         
	//    7    9:invokevirtual   #85  <Method void dy.c(int, int)>
		((dy)this).a(3, 2);
	//    8   12:aload_0         
	//    9   13:iconst_3        
	//   10   14:iconst_2        
	//   11   15:invokevirtual   #78  <Method void dy.a(int, int)>
		((dy)this).a(gd1);
	//   12   18:aload_0         
	//   13   19:aload_2         
	//   14   20:invokevirtual   #88  <Method void dy.a(gd)>
		((dy)this).a(1, 4);
	//   15   23:aload_0         
	//   16   24:iconst_1        
	//   17   25:iconst_4        
	//   18   26:invokevirtual   #78  <Method void dy.a(int, int)>
	//   19   29:return          
	}

	final void a(int i, gd gd1, gt gt1)
	{
		((dy)this).a(i, 2);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	//    3    3:invokevirtual   #78  <Method void dy.a(int, int)>
		dc dc1 = (dc)gd1;
	//    4    6:aload_2         
	//    5    7:checkcast       #91  <Class dc>
	//    6   10:astore          5
		int j = dc1.x();
	//    7   12:aload           5
	//    8   14:invokevirtual   #94  <Method int dc.x()>
	//    9   17:istore          4
		i = j;
	//   10   19:iload           4
	//   11   21:istore_1        
	...
	//   15   28:aload_3         
	//   16   29:aload           5
	//   17   31:invokeinterface #99  <Method int gt.b(Object)>
	//   18   36:istore_1        
			dc1.b(i);
	//   19   37:aload           5
	//   20   39:iload_1         
	//   21   40:invokevirtual   #100 <Method void dc.b(int)>
		}
		((dy)this).b(i);
	//   22   43:aload_0         
	//   23   44:iload_1         
	//   24   45:invokevirtual   #71  <Method void dy.b(int)>
		gt1.a(((Object) (gd1)), ((ik) (a)));
	//   25   48:aload_3         
	//   26   49:aload_2         
	//   27   50:aload_0         
	//   28   51:getfield        #103 <Field ec a>
	//   29   54:invokeinterface #106 <Method void gt.a(Object, ik)>
	//   30   59:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #109 <Method void dy.a(String)>
	//    7   11:return          
	}
	...
	//    5    7:iload_2         
	//    6    8:int2byte        
	//    7    9:invokevirtual   #112 <Method void dy.a(byte)>
	//    8   12:return          
	}
	...
	//    1    1:lstore          4
		if(dy.c())
	//*   2    3:invokestatic    #115 <Method boolean dy.c()>
	//*   3    6:ifeq            103
		{
			l1 = l;
	//    4    9:lload_1         
	//    5   10:lstore          4
			if(((dy)this).a() >= 10)
	//*   6   12:aload_0         
	//*   7   13:invokevirtual   #117 <Method int dy.a()>
	//*   8   16:bipush          10
	//*   9   18:icmplt          103
				do
				{
	...
	//   31   54:l2i             
	//   32   55:int2byte        
	//   33   56:invokestatic    #124 <Method void hs.a(byte[], long, byte)>
						return;
	//   34   59:return          
					}
					byte abyte1[] = b;
	...
	//   45   75:putfield        #21  <Field int e>
					hs.a(abyte1, j, (byte)((int)l & 0x7f | 0x80));
	//   46   78:aload           6
	//   47   80:iload_3         
	//   48   81:i2l             
	//   49   82:lload_1         
	...
	//   54   90:ior             
	//   55   91:int2byte        
	//   56   92:invokestatic    #124 <Method void hs.a(byte[], long, byte)>
					l >>>= 7;
	//   57   95:lload_1         
	//   58   96:bipush          7
	//   59   98:lushr           
...
_L1:
	...
	//  113  186:new             #60  <Class ea>
	//  114  189:dup             
	//  115  190:ldc1            #62  <String "Pos: %d, limit: %d, len: %d">
	//  116  192:iconst_3        
	...
	//  136  226:aload           6
	//  137  228:invokespecial   #65  <Method void ea(String, Throwable)>
	//  138  231:athrow          
			}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #127 <Method int di.a()>
	//    3    5:invokevirtual   #71  <Method void dy.b(int)>
		di1.a(((dh) (this)));
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:invokevirtual   #130 <Method void di.a(dh)>
	//    7   13:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokeinterface #135 <Method int gd.A()>
	//    3    7:invokevirtual   #71  <Method void dy.b(int)>
		gd1.a(((dy) (this)));
	//    4   10:aload_1         
	//    5   11:aload_0         
	//    6   12:invokeinterface #138 <Method void gd.a(dy)>
	//    7   17:return          
	}
	...
	//    2    4:istore_2        
		...
		try
		{
			k = g(s.length() * 3);
	//    3    5:aload_1         
	//    4    6:invokevirtual   #143 <Method int String.length()>
	//    5    9:iconst_3        
	//    6   10:imul            
	//    7   11:invokestatic    #147 <Method int g(int)>
	//    8   14:istore          4
			j = g(s.length());
	//    9   16:aload_1         
	//   10   17:invokevirtual   #143 <Method int String.length()>
	//   11   20:invokestatic    #147 <Method int g(int)>
	//   12   23:istore_3        
		}
	//*  13   24:iload_3         
	//*  14   25:iload           4
	...
	//*  26   46:aload_0         
	//*  27   47:invokevirtual   #117 <Method int dy.a()>
	//*  28   50:invokestatic    #152 <Method int hy.a(CharSequence, byte[], int, int)>
	//*  29   53:istore          4
	//*  30   55:aload_0         
	//*  31   56:iload_2         
	...
	//*  37   65:iload_3         
	//*  38   66:isub            
	//*  39   67:invokevirtual   #71  <Method void dy.b(int)>
	//*  40   70:aload_0         
	//*  41   71:iload           4
	...
	//*  44   77:aload_0         
	//*  45   78:aload_1         
	//*  46   79:invokestatic    #155 <Method int hy.a(CharSequence)>
	//*  47   82:invokevirtual   #71  <Method void dy.b(int)>
	//*  48   85:aload_0         
	//*  49   86:aload_1         
	//*  50   87:aload_0         
	...
	//*  54   95:aload_0         
	//*  55   96:invokevirtual   #117 <Method int dy.a()>
	//*  56   99:invokestatic    #152 <Method int hy.a(CharSequence, byte[], int, int)>
	//*  57  102:putfield        #21  <Field int e>
	//*  58  105:return          
	//*  59  106:astore_1        
	//*  60  107:new             #60  <Class ea>
	//*  61  110:dup             
	//*  62  111:aload_1         
	//*  63  112:invokespecial   #158 <Method void ea(Throwable)>
	//*  64  115:athrow          
		catch(ib ib1)
	//*  65  116:astore          5
		{
	...
	//   70  124:aload_1         
	//   71  125:aload           5
	//   72  127:invokevirtual   #161 <Method void dy.a(String, ib)>
			return;
	//   73  130:return          
		}
		// Misplaced declaration of an exception variable
		...
		{
			throw new ea(((Throwable) (s)));
		}
		if(j != k)
			break MISSING_BLOCK_LABEL_77;
		e = i + j;
		k = hy.a(((CharSequence) (s)), b, e, ((dy)this).a());
		e = i;
		((dy)this).b(k - i - j);
		e = k;
		return;
		((dy)this).b(hy.a(((CharSequence) (s))));
		e = hy.a(((CharSequence) (s)), b, e, ((dy)this).a());
		return;
	}
	...
	//    2    2:iload_2         
	//    3    3:iload_3         
	//    4    4:invokespecial   #163 <Method void c(byte[], int, int)>
	//    5    7:return          
	}
	...
	//    1    1:istore_2        
		if(dy.c())
	//*   2    2:invokestatic    #115 <Method boolean dy.c()>
	//*   3    5:ifeq            92
		{
			j = i;
	//    4    8:iload_1         
	//    5    9:istore_2        
			if(((dy)this).a() >= 10)
	//*   6   10:aload_0         
	//*   7   11:invokevirtual   #117 <Method int dy.a()>
	//*   8   14:bipush          10
	//*   9   16:icmplt          92
				do
				{
	...
	//   24   40:putfield        #21  <Field int e>
						hs.a(abyte0, j, (byte)i);
	//   25   43:aload_3         
	//   26   44:iload_2         
	//   27   45:i2l             
	//   28   46:iload_1         
	//   29   47:int2byte        
	//   30   48:invokestatic    #124 <Method void hs.a(byte[], long, byte)>
						return;
	//   31   51:return          
					}
					byte abyte1[] = b;
	...
	//   42   66:putfield        #21  <Field int e>
					hs.a(abyte1, j, (byte)(i & 0x7f | 0x80));
	//   43   69:aload_3         
	//   44   70:iload_2         
	//   45   71:i2l             
	//   46   72:iload_1         
	...
	//   50   79:ior             
	//   51   80:int2byte        
	//   52   81:invokestatic    #124 <Method void hs.a(byte[], long, byte)>
					i >>>= 7;
	//   53   84:iload_1         
	//   54   85:bipush          7
	//   55   87:iushr           
...
_L1:
	...
	//  105  160:new             #60  <Class ea>
	//  106  163:dup             
	//  107  164:ldc1            #62  <String "Pos: %d, limit: %d, len: %d">
	//  108  166:iconst_3        
	...
	//  128  200:aload_3         
	//  129  201:invokespecial   #65  <Method void ea(String, Throwable)>
	//  130  204:athrow          
			}
			abyte2[i] = (byte)j;
			return;
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #165 <Method void dy.a(int)>
	//    7   11:return          
	}

	public final void b(int i, di di1)
	{
		((dy)this).a(1, 3);
	//    0    0:aload_0         
	//    1    1:iconst_1        
	...
	//    9   13:iconst_3        
	//   10   14:aload_2         
	//   11   15:invokevirtual   #167 <Method void dy.a(int, di)>
		((dy)this).a(1, 4);
	//   12   18:aload_0         
	//   13   19:iconst_1        
	//   14   20:iconst_4        
	//   15   21:invokevirtual   #78  <Method void dy.a(int, int)>
	//   16   24:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_3         
	//    2    2:invokevirtual   #71  <Method void dy.b(int)>
		c(abyte0, 0, j);
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:iconst_0        
	//    6    8:iload_3         
	//    7    9:invokespecial   #163 <Method void c(byte[], int, int)>
	//    8   12:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #71  <Method void dy.b(int)>
	//    7   11:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #169 <Method void dy.c(long)>
	//    7   11:return          
	}
	...
	//  152  224:new             #60  <Class ea>
	//  153  227:dup             
	//  154  228:ldc1            #62  <String "Pos: %d, limit: %d, len: %d">
	//  155  230:iconst_3        
	...
	//  175  264:aload           4
	//  176  266:invokespecial   #65  <Method void ea(String, Throwable)>
	//  177  269:athrow          
		}
		abyte0[i] = (byte)(int)l;
		abyte0 = b;
	...
	//   72   99:new             #60  <Class ea>
	//   73  102:dup             
	//   74  103:ldc1            #62  <String "Pos: %d, limit: %d, len: %d">
	//   75  105:iconst_3        
	...
	//   95  139:aload_3         
	//   96  140:invokespecial   #65  <Method void ea(String, Throwable)>
	//   97  143:athrow          
		}
		abyte0[j] = (byte)i;
		abyte0 = b;
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #171 <Method void dy.d(int)>
	//    7   11:return          
	}
