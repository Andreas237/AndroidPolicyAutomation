...
final class dy extends dt
{
	...
	dy(ByteBuffer bytebuffer)
	{
		super(((dz) (null)));
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:invokespecial   #18  <Method void dt(dz)>
		b = bytebuffer;
	//    3    5:aload_0         
	//    4    6:aload_1         
	...
	//   12   24:aload_0         
	//   13   25:aload_1         
	//   14   26:invokestatic    #44  <Method long hv.a(ByteBuffer)>
	...
	//   13   21:lload_2         
	//   14   22:iload_1         
	//   15   23:invokestatic    #74  <Method void hv.a(long, byte)>
			return;
	//   16   26:return          
		} else
		{
			throw new dw(String.format("Pos: %d, limit: %d, len: %d", new Object[] {
				Long.valueOf(l), Long.valueOf(f), Integer.valueOf(1)
			}));
	//   17   27:new             #76  <Class dw>
	//   18   30:dup             
	...
	//   39   64:invokespecial   #100 <Method void dw(String)>
	//   40   67:athrow          
		}
	}
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:invokevirtual   #103 <Method void dt.b(int)>
			return;
	//    5    9:return          
		} else
		{
	...
	//    7   11:iload_1         
	//    8   12:i2l             
	//    9   13:invokevirtual   #105 <Method void dt.a(long)>
			return;
	//   10   16:return          
		}
	}
	...
	//    4    4:iload_2         
	//    5    5:ior             
	//    6    6:invokevirtual   #103 <Method void dt.b(int)>
	//    7    9:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:iconst_0        
	//    3    3:invokevirtual   #109 <Method void dt.a(int, int)>
		((dt)this).a(l);
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #105 <Method void dt.a(long)>
	//    7   11:return          
	}

	public final void a(int j, dc dc1)
	{
		((dt)this).a(j, 2);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	//    4    6:aload_0         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #113 <Method void dt.a(dc)>
	//    7   11:return          
	}

	public final void a(int j, gg gg1)
	{
		((dt)this).a(j, 2);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	//    4    6:aload_0         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #117 <Method void dt.a(gg)>
	//    7   11:return          
	}

	final void a(int j, gg gg1, gx gx1)
	{
		((dt)this).a(j, 2);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	//    5    7:aload_2         
	//    6    8:aload_3         
	//    7    9:invokevirtual   #121 <Method void dt.a(gg, gx)>
	//    8   12:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #124 <Method void dt.a(String)>
	//    7   11:return          
	}
	...
	//    5    7:iload_2         
	//    6    8:int2byte        
	//    7    9:invokevirtual   #127 <Method void dt.a(byte)>
	//    8   12:return          
	}
	...
	//   24   38:l2i             
	//   25   39:int2byte        
	//   26   40:invokestatic    #74  <Method void hv.a(long, byte)>
					return;
	//   27   43:return          
				}
				l1 = h;
	...
	//   42   65:ior             
	//   43   66:int2byte        
	//   44   67:invokestatic    #74  <Method void hv.a(long, byte)>
				l >>>= 7;
	//   45   70:lload_1         
	//   46   71:bipush          7
	//   47   73:lushr           
	...
	//   71  111:l2i             
	//   72  112:int2byte        
	//   73  113:invokestatic    #74  <Method void hv.a(long, byte)>
					return;
	//   74  116:return          
				}
				h = l + 1L;
	...
	//   86  133:ior             
	//   87  134:int2byte        
	//   88  135:invokestatic    #74  <Method void hv.a(long, byte)>
				l1 >>>= 7;
	//   89  138:lload_3         
	//   90  139:bipush          7
	//   91  141:lushr           
	...
	//  116  183:invokespecial   #100 <Method void dw(String)>
	//  117  186:athrow          
			}
		} while(true);
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #133 <Method int dc.a()>
	//    3    5:invokevirtual   #103 <Method void dt.b(int)>
		dc1.a(((db) (this)));
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:invokevirtual   #136 <Method void dc.a(db)>
	//    7   13:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokeinterface #140 <Method int gg.h()>
	//    3    7:invokevirtual   #103 <Method void dt.b(int)>
		gg1.a(((dt) (this)));
	//    4   10:aload_1         
	//    5   11:aload_0         
	//    6   12:invokeinterface #143 <Method void gg.a(dt)>
	//    7   17:return          
	}

	final void a(gg gg1, gx gx1)
	{
		cu cu1 = (cu)gg1;
	//    0    0:aload_1         
	//    1    1:checkcast       #145 <Class cu>
	//    2    4:astore          5
		int k = cu1.e();
	//    3    6:aload           5
	//    4    8:invokevirtual   #147 <Method int cu.e()>
	//    5   11:istore          4
		int j = k;
	//    6   13:iload           4
	//    7   15:istore_3        
	...
	//   11   22:aload_2         
	//   12   23:aload           5
	//   13   25:invokeinterface #152 <Method int gx.b(Object)>
	//   14   30:istore_3        
			cu1.a(j);
	//   15   31:aload           5
	//   16   33:iload_3         
	//   17   34:invokevirtual   #154 <Method void cu.a(int)>
		}
		((dt)this).b(j);
	//   18   37:aload_0         
	//   19   38:iload_3         
	//   20   39:invokevirtual   #103 <Method void dt.b(int)>
		gx1.a(((Object) (gg1)), ((io) (a)));
	//   21   42:aload_2         
	//   22   43:aload_1         
	//   23   44:aload_0         
	//   24   45:getfield        #157 <Field ea a>
	//   25   48:invokeinterface #160 <Method void gx.a(Object, io)>
	//   26   53:return          
	}
	...
	//    2    4:lstore          4
		...
		try
		{
			j = g(s.length() * 3);
	//    3    6:aload_1         
	//    4    7:invokevirtual   #169 <Method int String.length()>
	//    5   10:iconst_3        
	//    6   11:imul            
	//    7   12:invokestatic    #172 <Method int g(int)>
	//    8   15:istore_2        
			k = g(s.length());
	//    9   16:aload_1         
	//   10   17:invokevirtual   #169 <Method int String.length()>
	//   11   20:invokestatic    #172 <Method int g(int)>
	//   12   23:istore_3        
		}
	//*  13   24:iload_3         
	//*  14   25:iload_2         
	...
	//*  33   56:invokestatic    #177 <Method void ib.a(CharSequence, ByteBuffer)>
	//*  34   59:aload_0         
	...
	//*  40   69:aload_0         
	//*  41   70:iload_2         
	//*  42   71:invokevirtual   #103 <Method void dt.b(int)>
	//*  43   74:aload_0         
	//*  44   75:aload_0         
	...
	//*  50   85:return          
	//*  51   86:aload_1         
	//*  52   87:invokestatic    #180 <Method int ib.a(CharSequence)>
	//*  53   90:istore_2        
	//*  54   91:aload_0         
	//*  55   92:iload_2         
	//*  56   93:invokevirtual   #103 <Method void dt.b(int)>
	//*  57   96:aload_0         
	//*  58   97:aload_0         
	//*  59   98:getfield        #63  <Field long h>
	//*  60  101:invokespecial   #182 <Method void i(long)>
	//*  61  104:aload_1         
	//*  62  105:aload_0         
	//*  63  106:getfield        #38  <Field ByteBuffer c>
	//*  64  109:invokestatic    #177 <Method void ib.a(CharSequence, ByteBuffer)>
	//*  65  112:aload_0         
	//*  66  113:aload_0         
	...
	//*  72  123:return          
	//*  73  124:astore_1        
	//*  74  125:new             #76  <Class dw>
	//*  75  128:dup             
	//*  76  129:aload_1         
	//*  77  130:invokespecial   #185 <Method void dw(Throwable)>
	//*  78  133:athrow          
	//*  79  134:astore_1        
	//*  80  135:new             #76  <Class dw>
	//*  81  138:dup             
	//*  82  139:aload_1         
	//*  83  140:invokespecial   #185 <Method void dw(Throwable)>
	//*  84  143:athrow          
		catch(if if1)
	//*  85  144:astore          6
		{
	...
	//   92  157:invokespecial   #182 <Method void i(long)>
			((dt)this).a(s, if1);
	//   93  160:aload_0         
	//   94  161:aload_1         
	//   95  162:aload           6
	//   96  164:invokevirtual   #188 <Method void dt.a(String, if)>
			return;
	//   97  167:return          
		}
		...
		j = (int)(h - d) + k;
		c.position(j);
		ib.a(((CharSequence) (s)), c);
		j = c.position() - j;
		((dt)this).b(j);
		h = h + (long)j;
		return;
		j = ib.a(((CharSequence) (s)));
		((dt)this).b(j);
		i(h);
		ib.a(((CharSequence) (s)), c);
		h = h + (long)j;
	...
	{
		((dt)this).b(abyte0, j, k);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:iload_3         
	//    4    4:invokevirtual   #191 <Method void dt.b(byte[], int, int)>
	//    5    7:return          
	}
	...
	//   21   34:iload_1         
	//   22   35:int2byte        
	//   23   36:invokestatic    #74  <Method void hv.a(long, byte)>
					return;
	//   24   39:return          
				}
				long l1 = h;
	...
	//   38   60:ior             
	//   39   61:int2byte        
	//   40   62:invokestatic    #74  <Method void hv.a(long, byte)>
				j >>>= 7;
	//   41   65:iload_1         
	//   42   66:bipush          7
	//   43   68:iushr           
	...
	//   64  102:iload_2         
	//   65  103:int2byte        
	//   66  104:invokestatic    #74  <Method void hv.a(long, byte)>
					return;
	//   67  107:return          
				}
				h = l2 + 1L;
	...
	//   78  123:ior             
	//   79  124:int2byte        
	//   80  125:invokestatic    #74  <Method void hv.a(long, byte)>
				k >>>= 7;
	//   81  128:iload_2         
	//   82  129:bipush          7
	//   83  131:iushr           
	...
	//  108  173:invokespecial   #100 <Method void dw(String)>
	//  109  176:athrow          
			}
		} while(true);
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #192 <Method void dt.a(int)>
	//    7   11:return          
	}

	public final void b(int j, dc dc1)
	{
		((dt)this).a(1, 3);
	//    0    0:aload_0         
	//    1    1:iconst_1        
	...
	//    5    7:iconst_2        
	//    6    8:iload_1         
	//    7    9:invokevirtual   #194 <Method void dt.c(int, int)>
		((dt)this).a(3, dc1);
	//    8   12:aload_0         
	//    9   13:iconst_3        
	//   10   14:aload_2         
	//   11   15:invokevirtual   #196 <Method void dt.a(int, dc)>
		((dt)this).a(1, 4);
	//   12   18:aload_0         
	//   13   19:iconst_1        
	//   14   20:iconst_4        
	//   15   21:invokevirtual   #109 <Method void dt.a(int, int)>
	//   16   24:return          
	}

	public final void b(int j, gg gg1)
	{
		((dt)this).a(1, 3);
	//    0    0:aload_0         
	//    1    1:iconst_1        
	...
	//    9   13:iconst_3        
	//   10   14:aload_2         
	//   11   15:invokevirtual   #198 <Method void dt.a(int, gg)>
		((dt)this).a(1, 4);
	//   12   18:aload_0         
	//   13   19:iconst_1        
	//   14   20:iconst_4        
	...
	//   31   53:lload           8
	//   32   55:lload           6
	//   33   57:invokestatic    #201 <Method void hv.a(byte[], long, long, long)>
				h = h + l1;
	//   34   60:aload_0         
	//   35   61:aload_0         
	...
	//   43   76:new             #203 <Class NullPointerException>
	//   44   79:dup             
	//   45   80:ldc1            #205 <String "value">
	//   46   82:invokespecial   #206 <Method void NullPointerException(String)>
	//   47   85:athrow          
		else
			throw new dw(String.format("Pos: %d, limit: %d, len: %d", new Object[] {
				Long.valueOf(h), Long.valueOf(f), Integer.valueOf(k)
			}));
	//   48   86:new             #76  <Class dw>
	//   49   89:dup             
	...
	//   71  126:invokespecial   #100 <Method void dw(String)>
	//   72  129:athrow          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #103 <Method void dt.b(int)>
	//    7   11:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #208 <Method void dt.c(long)>
	//    7   11:return          
	}
	...
	//    7   13:l2i             
	//    8   14:lload_1         
	//    9   15:invokevirtual   #212 <Method ByteBuffer ByteBuffer.putLong(int, long)>
	//   10   18:pop             
		h = h + 8L;
	//   11   19:aload_0         
	//   12   20:aload_0         
	//   13   21:getfield        #63  <Field long h>
	//   14   24:ldc2w           #213 <Long 8L>
	//   15   27:ladd            
	...
	//    0    0:aload_0         
	//    1    1:iload_3         
	//    2    2:invokevirtual   #103 <Method void dt.b(int)>
		((dt)this).b(abyte0, 0, k);
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:iconst_0        
	//    6    8:iload_3         
	//    7    9:invokevirtual   #191 <Method void dt.b(byte[], int, int)>
	//    8   12:return          
	}
	...
	//    7   13:l2i             
	//    8   14:iload_1         
	//    9   15:invokevirtual   #218 <Method ByteBuffer ByteBuffer.putInt(int, int)>
	//   10   18:pop             
		h = h + 4L;
	//   11   19:aload_0         
	//   12   20:aload_0         
	//   13   21:getfield        #63  <Field long h>
	//   14   24:ldc2w           #219 <Long 4L>
	//   15   27:ladd            
	//   16   28:putfield        #63  <Field long h>
	//   17   31:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #222 <Method void dt.d(int)>
	//    7   11:return          
	}
