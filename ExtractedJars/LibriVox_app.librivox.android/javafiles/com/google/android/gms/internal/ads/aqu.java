...
final class aqu extends ara
{

	aqu(byte abyte0[], int i, int j)
	{
		super(abyte0);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #12  <Method void ara(byte[])>
	...
	public final byte a(int i)
	{
		int j = ((aqq)this).a();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #28  <Method int aqq.a()>
	//    2    4:istore_2        
		if((j - (i + 1) | i) < 0)
	//*   3    5:iload_2         
	//*   4    6:iload_1         
	...
	{
		System.arraycopy(((Object) (b)), ((ara)this).g(), ((Object) (abyte0)), 0, k);
	//    0    0:aload_0         
	//    1    1:getfield        #58  <Field byte[] b>
	//    2    4:aload_0         
	//    3    5:invokevirtual   #62  <Method int ara.g()>
	//    4    8:aload_1         
	//    5    9:iconst_0        
	//    6   10:iload           4
	//    7   12:invokestatic    #68  <Method void System.arraycopy(Object, int, Object, int, int)>
	//    8   15:return          
	}
