...
public class ViewPropertyAnimatorCompatSet
{
	...
	//    4    8:putfield        #24  <Field long mDuration>
	//    5   11:aload_0         
	//    6   12:new             #26  <Class ViewPropertyAnimatorCompatSet$1>
	//    7   15:dup             
	//    8   16:aload_0         
	//    9   17:invokespecial   #29  <Method void ViewPropertyAnimatorCompatSet$1(ViewPropertyAnimatorCompatSet)>
	//   10   20:putfield        #31  <Field az mProxyListener>
	//   11   23:aload_0         
	//   12   24:new             #33  <Class ArrayList>
	//   13   27:dup             
	//   14   28:invokespecial   #34  <Method void ArrayList()>
	//   15   31:putfield        #36  <Field ArrayList mAnimators>
	//   16   34:return          
	}
	...
	public void cancel()
	{
		if(!mIsStarted)
	//*   0    0:aload_0         
	//*   1    1:getfield        #40  <Field boolean mIsStarted>
	//*   2    4:ifne            8
			return;
	//    3    7:return          
		for(Iterator iterator = mAnimators.iterator(); iterator.hasNext(); ((au)iterator.next()).b());
	//    4    8:aload_0         
	//    5    9:getfield        #36  <Field ArrayList mAnimators>
	//    6   12:invokevirtual   #44  <Method Iterator ArrayList.iterator()>
	//    7   15:astore_1        
	//    8   16:aload_1         
	...
	//   13   31:checkcast       #56  <Class au>
	//   14   34:invokevirtual   #59  <Method void au.b()>
	//*  15   37:goto            16
		mIsStarted = false;
	//   16   40:aload_0         
	//   17   41:iconst_0        
	//   18   42:putfield        #40  <Field boolean mIsStarted>
	//   19   45:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:putfield        #40  <Field boolean mIsStarted>
	//    3    5:return          
	}

	public ViewPropertyAnimatorCompatSet play(au au1)
	{
		if(!mIsStarted)
	//*   0    0:aload_0         
	//*   1    1:getfield        #40  <Field boolean mIsStarted>
	//*   2    4:ifne            16
			mAnimators.add(((Object) (au1)));
	//    3    7:aload_0         
	//    4    8:getfield        #36  <Field ArrayList mAnimators>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #66  <Method boolean ArrayList.add(Object)>
	//    7   15:pop             
		return this;
	//    8   16:aload_0         
	//    9   17:areturn         
	...
	public ViewPropertyAnimatorCompatSet playSequentially(au au1, au au2)
	{
		mAnimators.add(((Object) (au1)));
	//    0    0:aload_0         
	//    1    1:getfield        #36  <Field ArrayList mAnimators>
	//    2    4:aload_1         
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #72  <Method long au.a()>
	//    8   14:invokevirtual   #75  <Method au au.b(long)>
	//    9   17:pop             
		mAnimators.add(((Object) (au2)));
	//   10   18:aload_0         
	//   11   19:getfield        #36  <Field ArrayList mAnimators>
	//   12   22:aload_2         
	//   13   23:invokevirtual   #66  <Method boolean ArrayList.add(Object)>
	//   14   26:pop             
		return this;
	//   15   27:aload_0         
	//   16   28:areturn         
	...
	//    3    7:aload_0         
	//    4    8:lload_1         
	//    5    9:putfield        #24  <Field long mDuration>
		return this;
	//    6   12:aload_0         
	//    7   13:areturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #81  <Field Interpolator mInterpolator>
		return this;
	//    6   12:aload_0         
	//    7   13:areturn         
	}

	public ViewPropertyAnimatorCompatSet setListener(ay ay)
	{
		if(!mIsStarted)
	//*   0    0:aload_0         
	//*   1    1:getfield        #40  <Field boolean mIsStarted>
	...
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #85  <Field ay mListener>
		return this;
	//    6   12:aload_0         
	//    7   13:areturn         
	}
	...
	//    3    7:return          
		au au1;
		for(Iterator iterator = mAnimators.iterator(); iterator.hasNext(); au1.c())
	//*   4    8:aload_0         
	//*   5    9:getfield        #36  <Field ArrayList mAnimators>
	//*   6   12:invokevirtual   #44  <Method Iterator ArrayList.iterator()>
	//*   7   15:astore_3        
	...
	//   14   34:astore          4
			long l = mDuration;
	//   15   36:aload_0         
	//   16   37:getfield        #24  <Field long mDuration>
	//   17   40:lstore_1        
			if(l >= 0L)
	//*  18   41:lload_1         
	//*  19   42:lconst_0        
	...
	//   22   47:aload           4
	//   23   49:lload_1         
	//   24   50:invokevirtual   #88  <Method au au.a(long)>
	//   25   53:pop             
			Interpolator interpolator = mInterpolator;
	//   26   54:aload_0         
	//   27   55:getfield        #81  <Field Interpolator mInterpolator>
	//   28   58:astore          5
	...
	//   31   65:aload           4
	//   32   67:aload           5
	//   33   69:invokevirtual   #91  <Method au au.a(Interpolator)>
	//   34   72:pop             
			if(mListener != null)
	//*  35   73:aload_0         
	//*  36   74:getfield        #85  <Field ay mListener>
	//*  37   77:ifnull          90
				au1.a(((ay) (mProxyListener)));
	//   38   80:aload           4
	//   39   82:aload_0         
	//   40   83:getfield        #31  <Field az mProxyListener>
	//   41   86:invokevirtual   #94  <Method au au.a(ay)>
	//   42   89:pop             
		}

	//   43   90:aload           4
	//   44   92:invokevirtual   #97  <Method void au.c()>
	//*  45   95:goto            16
		mIsStarted = true;
	//   46   98:aload_0         
	//   47   99:iconst_1        
	//   48  100:putfield        #40  <Field boolean mIsStarted>
	//   49  103:return          
	}
	...
	ay mListener;
	private final az mProxyListener = new _cls1();
