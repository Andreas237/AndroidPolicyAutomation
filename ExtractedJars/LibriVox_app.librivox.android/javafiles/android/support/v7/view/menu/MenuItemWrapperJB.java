...
class MenuItemWrapperJB extends MenuItemWrapperICS
{
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #8   <Method void MenuItemWrapperICS(Context, b)>
	//    4    6:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:getfield        #17  <Field Context mContext>
	//    5    9:aload_1         
	//    6   10:invokespecial   #20  <Method void MenuItemWrapperJB$ActionProviderWrapperJB(MenuItemWrapperJB, Context, ActionProvider)>
	//    7   13:areturn         
	}
