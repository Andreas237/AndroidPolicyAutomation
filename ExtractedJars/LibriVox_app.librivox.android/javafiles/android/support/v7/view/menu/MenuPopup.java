	...
	implements MenuPresenter, ShowableListMenu, android.widget.AdapterView.OnItemClickListener
{
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #114 <Method android.widget.Adapter AdapterView.getAdapter()>
	//    2    4:checkcast       #27  <Class ListAdapter>
	//    3    7:astore_2        
		adapterview = ((AdapterView) (toMenuAdapter(((ListAdapter) (view))).mAdapterMenu));
	//    4    8:aload_2         
	//    5    9:invokestatic    #116 <Method MenuAdapter toMenuAdapter(ListAdapter)>
	//    6   12:getfield        #120 <Field MenuBuilder MenuAdapter.mAdapterMenu>
	//    7   15:astore_1        
		view = ((View) ((MenuItem)((ListAdapter) (view)).getItem(i)));
	//    8   16:aload_2         
	//    9   17:iload_3         
	//   10   18:invokeinterface #123 <Method Object ListAdapter.getItem(int)>
	//   11   23:checkcast       #66  <Class MenuItem>
	//   12   26:astore_2        
		if(closeMenuOnSubMenuOpened())
	//*  13   27:aload_0         
	//*  14   28:invokevirtual   #125 <Method boolean closeMenuOnSubMenuOpened()>
	//*  15   31:ifeq            39
			i = 0;
	//   16   34:iconst_0        
	//   17   35:istore_3        
	...
	//   19   39:iconst_4        
	//   20   40:istore_3        
		((MenuBuilder) (adapterview)).a(((MenuItem) (view)), ((MenuPresenter) (this)), i);
	//   21   41:aload_1         
	//   22   42:aload_2         
	//   23   43:aload_0         
	//   24   44:iload_3         
	//   25   45:invokevirtual   #129 <Method boolean MenuBuilder.a(MenuItem, MenuPresenter, int)>
	//   26   48:pop             
	//   27   49:return          
	}
