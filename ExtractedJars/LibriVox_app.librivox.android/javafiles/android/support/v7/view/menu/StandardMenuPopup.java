	...
	implements MenuPresenter, android.view.View.OnKeyListener, android.widget.AdapterView.OnItemClickListener, android.widget.PopupWindow.OnDismissListener
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #59  <Method void MenuPopup()>
	//    2    4:aload_0         
	//    3    5:new             #61  <Class StandardMenuPopup$1>
	//    4    8:dup             
	//    5    9:aload_0         
	//    6   10:invokespecial   #64  <Method void StandardMenuPopup$1(StandardMenuPopup)>
	//    7   13:putfield        #66  <Field android.view.ViewTreeObserver$OnGlobalLayoutListener mGlobalLayoutListener>
	//    8   16:aload_0         
	//    9   17:new             #68  <Class StandardMenuPopup$2>
	//   10   20:dup             
	//   11   21:aload_0         
	...
	//   34   63:getstatic       #54  <Field int ITEM_LAYOUT>
	...
	//   73  145:aload_0         
	//   74  146:aload_1         
	//   75  147:invokevirtual   #145 <Method void MenuBuilder.a(MenuPresenter, Context)>
	//   76  150:return          
	}
	...
	//   49   91:aload_0         
	//   50   92:getfield        #66  <Field android.view.ViewTreeObserver$OnGlobalLayoutListener mGlobalLayoutListener>
	...
	//* 126  254:aload           4
	//* 127  256:ifnull          271
					textview.setText(mMenu.n());
	//  128  259:aload           4
	//  129  261:aload_0         
	//  130  262:getfield        #77  <Field MenuBuilder mMenu>
	//  131  265:invokevirtual   #233 <Method CharSequence MenuBuilder.n()>
	...
	//   21   43:aload_0         
	//   22   44:getfield        #66  <Field android.view.ViewTreeObserver$OnGlobalLayoutListener mGlobalLayoutListener>
	...
	//*   0    0:aload_1         
	//*   1    1:invokevirtual   #316 <Method boolean a.hasVisibleItems()>
	//*   2    4:ifeq            160
		{
			MenuPopupHelper menupopuphelper = new MenuPopupHelper(mContext, ((MenuBuilder) (a1)), mShownAnchorView, mOverflowOnly, mPopupStyleAttr, mPopupStyleRes);
	...
	//   21   43:invokevirtual   #325 <Method void MenuPopupHelper.setPresenterCallback(MenuPresenter$Callback)>
			menupopuphelper.setForceShowIcon(MenuPopup.shouldPreserveIconSpacing(((MenuBuilder) (a1))));
	//   22   46:aload           5
	//   23   48:aload_1         
	...
	//   35   73:iconst_0        
	//   36   74:invokevirtual   #336 <Method void MenuBuilder.b(boolean)>
			int j = mPopup.getHorizontalOffset();
	//   37   77:aload_0         
	//   38   78:getfield        #139 <Field MenuPopupWindow mPopup>
	//   39   81:invokevirtual   #339 <Method int MenuPopupWindow.getHorizontalOffset()>
	//   40   84:istore_3        
			int k = mPopup.getVerticalOffset();
	//   41   85:aload_0         
	//   42   86:getfield        #139 <Field MenuPopupWindow mPopup>
	//   43   89:invokevirtual   #342 <Method int MenuPopupWindow.getVerticalOffset()>
	//   44   92:istore          4
			int i = j;
	//   45   94:iload_3         
	//   46   95:istore_2        
			if((Gravity.getAbsoluteGravity(mDropDownGravity, ac.f(mAnchorView)) & 7) == 5)
	//*  47   96:aload_0         
	//*  48   97:getfield        #73  <Field int mDropDownGravity>
	//*  49  100:aload_0         
	//*  50  101:getfield        #132 <Field View mAnchorView>
	//*  51  104:invokestatic    #348 <Method int ac.f(View)>
	//*  52  107:invokestatic    #353 <Method int Gravity.getAbsoluteGravity(int, int)>
	//*  53  110:bipush          7
	//*  54  112:iand            
	//*  55  113:iconst_5        
	//*  56  114:icmpne          127
	...
	//   60  122:invokevirtual   #356 <Method int View.getWidth()>
	//   61  125:iadd            
	//   62  126:istore_2        
	...
	//*  64  129:iload_2         
	//*  65  130:iload           4
	//*  66  132:invokevirtual   #359 <Method boolean MenuPopupHelper.tryShow(int, int)>
	//*  67  135:ifeq            160
			{
				MenuPresenter.Callback callback = mPresenterCallback;
	//   68  138:aload_0         
	...
	//   73  149:aload           5
	//   74  151:aload_1         
	//   75  152:invokeinterface #362 <Method boolean MenuPresenter$Callback.onOpenSubMenu(MenuBuilder)>
	//   76  157:pop             
				return true;
	//   77  158:iconst_1        
	//   78  159:ireturn         
	...
	//    2    4:iload_1         
	//    3    5:invokevirtual   #364 <Method void MenuAdapter.setForceShowIcon(boolean)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #139 <Field MenuPopupWindow mPopup>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #368 <Method void MenuPopupWindow.setHorizontalOffset(int)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #139 <Field MenuPopupWindow mPopup>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #372 <Method void MenuPopupWindow.setVerticalOffset(int)>
	//    4    8:return          
	}
	...
	public void show()
	{
		if(tryShow())
	//*   0    0:aload_0         
	//*   1    1:invokespecial   #374 <Method boolean tryShow()>
	//*   2    4:ifeq            8
			return;
	//    3    7:return          
		else
			throw new IllegalStateException("StandardMenuPopup cannot be used without an anchor");
	//    4    8:new             #376 <Class IllegalStateException>
	//    5   11:dup             
	//    6   12:ldc2            #378 <String "StandardMenuPopup cannot be used without an anchor">
	//    7   15:invokespecial   #381 <Method void IllegalStateException(String)>
	//    8   18:athrow          
	}
	...
	//    8   14:aload_2         
	//    9   15:invokevirtual   #385 <Method void MenuAdapter.notifyDataSetChanged()>
	//   10   18:return          
	}
	...
	//    0    0:getstatic       #52  <Field int android.support.v7.appcompat.R$layout.abc_popup_menu_item_layout>
	//    1    3:putstatic       #54  <Field int ITEM_LAYOUT>
	//*   2    6:return          
	}
		...
		implements android.view.ViewTreeObserver.OnGlobalLayoutListener
	{
		...
		//*   0    0:aload_0         
		//*   1    1:getfield        #12  <Field StandardMenuPopup this$0>
		//*   2    4:invokevirtual   #23  <Method boolean StandardMenuPopup.isShowing()>
		//*   3    7:ifeq            63
		//*   4   10:aload_0         
		//*   5   11:getfield        #12  <Field StandardMenuPopup this$0>
		...
		//    9   23:aload_0         
		//   10   24:getfield        #12  <Field StandardMenuPopup this$0>
		...
		//*  18   42:goto            56
				{
					mPopup.show();
		//   19   45:aload_0         
		//   20   46:getfield        #12  <Field StandardMenuPopup this$0>
		...
		//   23   55:return          
				...
				dismiss();
		//   24   56:aload_0         
		//   25   57:getfield        #12  <Field StandardMenuPopup this$0>
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #12  <Field StandardMenuPopup this$0>
			super();
		//    3    5:aload_0         
		...
		implements android.view.View.OnAttachStateChangeListener
	{
		...
		//   13   31:putfield        #25  <Field ViewTreeObserver StandardMenuPopup.mTreeObserver>
				mTreeObserver.removeGlobalOnLayoutListener(mGlobalLayoutListener);
		//   14   34:aload_0         
		//   15   35:getfield        #12  <Field StandardMenuPopup this$0>
		//   16   38:getfield        #25  <Field ViewTreeObserver StandardMenuPopup.mTreeObserver>
		//   17   41:aload_0         
		//   18   42:getfield        #12  <Field StandardMenuPopup this$0>
