...
public final class Target$Builder
{
	...
	public Target build()
	{
		return mTarget;
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field Target mTarget>
	//    2    4:areturn         
	}
	...
	//    1    1:getfield        #15  <Field Target mTarget>
	//    2    4:iload_1         
	//    3    5:putfield        #27  <Field boolean Target.mIsExclusive>
		return this;
	//    4    8:aload_0         
	//    5    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field Target mTarget>
	//    2    4:getfield        #33  <Field float[] Target.mWeights>
	//    3    7:iconst_1        
	//    4    8:fload_1         
	//    5    9:fastore         
		return this;
	...
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field Target mTarget>
	//    2    4:getfield        #37  <Field float[] Target.mLightnessTargets>
	//    3    7:iconst_2        
	//    4    8:fload_1         
	//    5    9:fastore         
		return this;
	...
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field Target mTarget>
	//    2    4:getfield        #41  <Field float[] Target.mSaturationTargets>
	//    3    7:iconst_2        
	//    4    8:fload_1         
	//    5    9:fastore         
		return this;
	...
	//    1    1:invokespecial   #10  <Method void Object()>
		mTarget = new Target();
	//    2    4:aload_0         
	//    3    5:new             #12  <Class Target>
	//    4    8:dup             
	//    5    9:invokespecial   #13  <Method void Target()>
	//    6   12:putfield        #15  <Field Target mTarget>
	//    7   15:return          
	}
	...
	//    4    8:dup             
	//    5    9:aload_1         
	//    6   10:invokespecial   #19  <Method void Target(Target)>
	//    7   13:putfield        #15  <Field Target mTarget>
	//    8   16:return          
	}
}
