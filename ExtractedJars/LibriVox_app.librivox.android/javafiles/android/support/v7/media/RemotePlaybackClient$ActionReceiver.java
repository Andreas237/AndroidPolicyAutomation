...
final class RemotePlaybackClient$ActionReceiver extends BroadcastReceiver
{
	...
	//   15   31:invokevirtual   #51  <Method android.os.Bundle Intent.getBundleExtra(String)>
	//   16   34:invokestatic    #57  <Method MediaSessionStatus MediaSessionStatus.fromBundle(android.os.Bundle)>
	//   17   37:astore_3        
	...
	//   38   79:invokevirtual   #51  <Method android.os.Bundle Intent.getBundleExtra(String)>
	//   39   82:invokestatic    #80  <Method MediaItemStatus MediaItemStatus.fromBundle(android.os.Bundle)>
	//   40   85:astore          5
	...
	//   98  206:aload_2         
	//   99  207:invokevirtual   #118 <Method android.os.Bundle Intent.getExtras()>
	//  100  210:aload_1         
	//  101  211:aload_3         
	//  102  212:aload           4
	//  103  214:aload           5
	//  104  216:invokevirtual   #124 <Method void RemotePlaybackClient$StatusCallback.onItemStatusChanged(android.os.Bundle, String, MediaSessionStatus, String, MediaItemStatus)>
					return;
	//  105  219:return          
				}
			} else
	...
	//  151  316:aload_2         
	//  152  317:invokevirtual   #118 <Method android.os.Bundle Intent.getExtras()>
	//  153  320:aload_1         
	//  154  321:aload_3         
	//  155  322:invokevirtual   #132 <Method void RemotePlaybackClient$StatusCallback.onSessionStatusChanged(android.os.Bundle, String, MediaSessionStatus)>
					return;
	//  156  325:return          
				}
			} else
	...
	//  190  394:invokevirtual   #51  <Method android.os.Bundle Intent.getBundleExtra(String)>
	//  191  397:invokeinterface #146 <Method void RemotePlaybackClient$OnMessageReceivedListener.onMessageReceived(String, android.os.Bundle)>
			}
			return;
	//  192  402:return          
		} else
