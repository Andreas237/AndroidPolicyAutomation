...
public class DividerItemDecoration extends RecyclerView.ItemDecoration
{
	...
	//    6   10:new             #176 <Class IllegalArgumentException>
	//    7   13:dup             
	//    8   14:ldc1            #178 <String "Drawable cannot be null.">
	//    9   16:invokespecial   #181 <Method void IllegalArgumentException(String)>
	//   10   19:athrow          
		}
	}
	...
	//    6   12:new             #176 <Class IllegalArgumentException>
	//    7   15:dup             
	//    8   16:ldc1            #183 <String "Invalid orientation. It should be either HORIZONTAL or VERTICAL">
	//    9   18:invokespecial   #181 <Method void IllegalArgumentException(String)>
	//   10   21:athrow          
		} else
		{
			mOrientation = i;
