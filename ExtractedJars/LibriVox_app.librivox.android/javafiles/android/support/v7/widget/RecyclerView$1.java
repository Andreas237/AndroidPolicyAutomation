	...
	implements Runnable
{
	...
	//    8   20:return          
			if(!mIsAttached)
	//*   9   21:aload_0         
	//*  10   22:getfield        #12  <Field RecyclerView this$0>
	//*  11   25:getfield        #30  <Field boolean RecyclerView.mIsAttached>
	//*  12   28:ifne            39
			{
				requestLayout();
	//   13   31:aload_0         
	//   14   32:getfield        #12  <Field RecyclerView this$0>
	...
	//   16   38:return          
			...
			if(mLayoutFrozen)
	//*  17   39:aload_0         
	//*  18   40:getfield        #12  <Field RecyclerView this$0>
	//*  19   43:getfield        #36  <Field boolean RecyclerView.mLayoutFrozen>
	//*  20   46:ifeq            58
			{
				mLayoutWasDefered = true;
	//   21   49:aload_0         
	//   22   50:getfield        #12  <Field RecyclerView this$0>
	//   23   53:iconst_1        
	...
	//   26   58:aload_0         
	//   27   59:getfield        #12  <Field RecyclerView this$0>
