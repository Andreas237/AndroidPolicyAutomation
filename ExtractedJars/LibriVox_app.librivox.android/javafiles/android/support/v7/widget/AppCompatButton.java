	...
	implements ab, d
{
	...
	{
		if(a)
	//*   0    0:getstatic       #69  <Field boolean a>
	//*   1    3:ifeq            11
			return super.getAutoSizeMaxTextSize();
	//    2    6:aload_0         
	//    3    7:invokespecial   #71  <Method int Button.getAutoSizeMaxTextSize()>
	//    4   10:ireturn         
	...
	//   10   20:aload_1         
	//   11   21:invokevirtual   #72  <Method int AppCompatTextHelper.getAutoSizeMaxTextSize()>
	//   12   24:ireturn         
		else
			return -1;
	//   13   25:iconst_m1       
	...
	//    2    6:aload_0         
	//    3    7:invokespecial   #75  <Method int Button.getAutoSizeMinTextSize()>
	//    4   10:ireturn         
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	//    5   11:aload_0         
	//    6   12:getfield        #52  <Field AppCompatTextHelper mTextHelper>
	...
	//   10   20:aload_1         
	//   11   21:invokevirtual   #76  <Method int AppCompatTextHelper.getAutoSizeMinTextSize()>
	//   12   24:ireturn         
		else
			return -1;
	//   13   25:iconst_m1       
	...
	//    2    6:aload_0         
	//    3    7:invokespecial   #79  <Method int Button.getAutoSizeStepGranularity()>
	//    4   10:ireturn         
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	//    5   11:aload_0         
	//    6   12:getfield        #52  <Field AppCompatTextHelper mTextHelper>
	...
	//   10   20:aload_1         
	//   11   21:invokevirtual   #80  <Method int AppCompatTextHelper.getAutoSizeStepGranularity()>
	//   12   24:ireturn         
		else
			return -1;
	//   13   25:iconst_m1       
	...
	//    2    6:aload_0         
	//    3    7:invokespecial   #84  <Method int[] Button.getAutoSizeTextAvailableSizes()>
	//    4   10:areturn         
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	//    5   11:aload_0         
	//    6   12:getfield        #52  <Field AppCompatTextHelper mTextHelper>
	...
	//   10   20:aload_1         
	//   11   21:invokevirtual   #85  <Method int[] AppCompatTextHelper.getAutoSizeTextAvailableSizes()>
	//   12   24:areturn         
		else
			return new int[0];
	//   13   25:iconst_0        
	...
	//*   6   10:aload_0         
	//*   7   11:invokespecial   #88  <Method int Button.getAutoSizeTextType()>
	//*   8   14:iconst_1        
	//*   9   15:icmpne          20
				i = 1;
	//   10   18:iconst_1        
	...
	//   19   31:aload_3         
	//   20   32:invokevirtual   #89  <Method int AppCompatTextHelper.getAutoSizeTextType()>
	//   21   35:ireturn         
		else
			return 0;
	//   22   36:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #93  <Method ColorStateList AppCompatBackgroundHelper.getSupportBackgroundTintList()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #97  <Method android.graphics.PorterDuff$Mode AppCompatBackgroundHelper.getSupportBackgroundTintMode()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #101 <Method void Button.onInitializeAccessibilityEvent(AccessibilityEvent)>
		accessibilityevent.setClassName(((CharSequence) (((Class) (android/widget/Button)).getName())));
	//    3    5:aload_1         
	//    4    6:ldc1            #4   <Class Button>
	//    5    8:invokevirtual   #107 <Method String Class.getName()>
	//    6   11:invokevirtual   #113 <Method void AccessibilityEvent.setClassName(CharSequence)>
	//    7   14:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #117 <Method void Button.onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo)>
		accessibilitynodeinfo.setClassName(((CharSequence) (((Class) (android/widget/Button)).getName())));
	//    3    5:aload_1         
	//    4    6:ldc1            #4   <Class Button>
	//    5    8:invokevirtual   #107 <Method String Class.getName()>
	//    6   11:invokevirtual   #120 <Method void AccessibilityNodeInfo.setClassName(CharSequence)>
	//    7   14:return          
	}
	...
	//    4    4:iload           4
	//    5    6:iload           5
	//    6    8:invokespecial   #124 <Method void Button.onLayout(boolean, int, int, int, int)>
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	//    7   11:aload_0         
	...
	//   16   27:iload           4
	//   17   29:iload           5
	//   18   31:invokevirtual   #125 <Method void AppCompatTextHelper.onLayout(boolean, int, int, int, int)>
	//   19   34:return          
	}
	...
	//    3    3:iload_3         
	//    4    4:iload           4
	//    5    6:invokespecial   #129 <Method void Button.onTextChanged(CharSequence, int, int, int)>
		if(mTextHelper != null && !a && mTextHelper.isAutoSizeEnabled())
	//*   6    9:aload_0         
	//*   7   10:getfield        #52  <Field AppCompatTextHelper mTextHelper>
	//*   8   13:ifnull          39
	//*   9   16:getstatic       #69  <Field boolean a>
	//*  10   19:ifne            39
	//*  11   22:aload_0         
	//*  12   23:getfield        #52  <Field AppCompatTextHelper mTextHelper>
	//*  13   26:invokevirtual   #133 <Method boolean AppCompatTextHelper.isAutoSizeEnabled()>
	//*  14   29:ifeq            39
			mTextHelper.autoSizeText();
	//   15   32:aload_0         
	//   16   33:getfield        #52  <Field AppCompatTextHelper mTextHelper>
	//   17   36:invokevirtual   #136 <Method void AppCompatTextHelper.autoSizeText()>
	//   18   39:return          
	}
	...
	//    5    9:iload_3         
	//    6   10:iload           4
	//    7   12:invokespecial   #140 <Method void Button.setAutoSizeTextTypeUniformWithConfiguration(int, int, int, int)>
			return;
	//    8   15:return          
		}
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	...
	//   17   31:iload_3         
	//   18   32:iload           4
	//   19   34:invokevirtual   #141 <Method void AppCompatTextHelper.setAutoSizeTextTypeUniformWithConfiguration(int, int, int, int)>
	//   20   37:return          
	}
	...
	//    3    7:aload_1         
	//    4    8:iload_2         
	//    5    9:invokespecial   #145 <Method void Button.setAutoSizeTextTypeUniformWithPresetSizes(int[], int)>
			return;
	//    6   12:return          
		}
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	...
	//   13   23:aload_1         
	//   14   24:iload_2         
	//   15   25:invokevirtual   #146 <Method void AppCompatTextHelper.setAutoSizeTextTypeUniformWithPresetSizes(int[], int)>
	//   16   28:return          
	}
	...
	//    2    6:aload_0         
	//    3    7:iload_1         
	//    4    8:invokespecial   #150 <Method void Button.setAutoSizeTextTypeWithDefaults(int)>
			return;
	//    5   11:return          
		}
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	...
	//   11   21:aload_2         
	//   12   22:iload_1         
	//   13   23:invokevirtual   #151 <Method void AppCompatTextHelper.setAutoSizeTextTypeWithDefaults(int)>
	//   14   26:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #155 <Method void Button.setBackgroundDrawable(Drawable)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	...
	//    8   14:aload_2         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #158 <Method void AppCompatBackgroundHelper.onSetBackgroundDrawable(Drawable)>
	//   11   19:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #161 <Method void Button.setBackgroundResource(int)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	//    4    6:getfield        #41  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    5    9:astore_2        
	...
	//    8   14:aload_2         
	//    9   15:iload_1         
	//   10   16:invokevirtual   #164 <Method void AppCompatBackgroundHelper.onSetBackgroundResource(int)>
	//   11   19:return          
	}
	...
	//    1    1:aload_0         
	//    2    2:aload_1         
	//    3    3:invokestatic    #171 <Method android.view.ActionMode$Callback ah.a(android.widget.TextView, android.view.ActionMode$Callback)>
	//    4    6:invokespecial   #173 <Method void Button.setCustomSelectionActionModeCallback(android.view.ActionMode$Callback)>
	//    5    9:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #178 <Method void AppCompatTextHelper.setAllCaps(boolean)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #182 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintList(ColorStateList)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #186 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintMode(android.graphics.PorterDuff$Mode)>
	//    8   14:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #190 <Method void Button.setTextAppearance(Context, int)>
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	//    4    6:aload_0         
	...
	//   10   16:aload_1         
	//   11   17:iload_2         
	//   12   18:invokevirtual   #193 <Method void AppCompatTextHelper.onSetTextAppearance(Context, int)>
	//   13   21:return          
	}
	...
	//    3    7:iload_1         
	//    4    8:fload_2         
	//    5    9:invokespecial   #197 <Method void Button.setTextSize(int, float)>
			return;
	//    6   12:return          
		}
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	...
	//   13   23:iload_1         
	//   14   24:fload_2         
	//   15   25:invokevirtual   #198 <Method void AppCompatTextHelper.setTextSize(int, float)>
	//   16   28:return          
	}
