...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller
{
	...
	{
		double d = calculateTimeForScrolling(i);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	//    4    6:dstore_2        
		Double.isNaN(d);
	//    5    7:dload_2         
	//    6    8:invokestatic    #168 <Method boolean Double.isNaN(double)>
	//    7   11:pop             
		return (int)Math.ceil(d / 0.33560000000000001D);
	//    8   12:dload_2         
	//    9   13:ldc2w           #169 <Double 0.33560000000000001D>
	//   10   16:ddiv            
	//   11   17:invokestatic    #176 <Method double Math.ceil(double)>
	//   12   20:d2i             
	//   13   21:ireturn         
	}
	...
	//    0    0:iload_1         
	//    1    1:invokestatic    #179 <Method int Math.abs(int)>
	//    2    4:i2f             
	//    3    5:aload_0         
	//    4    6:getfield        #70  <Field float MILLISECONDS_PER_PX>
	//    5    9:fmul            
	//    6   10:f2d             
	//    7   11:invokestatic    #176 <Method double Math.ceil(double)>
	//    8   14:d2i             
	//    9   15:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #182 <Field PointF mTargetVector>
	//    2    4:astore_1        
		if(pointf != null && pointf.x != 0.0F)
	//*   3    5:aload_1         
	//*   4    6:ifnull          37
	//*   5    9:aload_1         
	//*   6   10:getfield        #187 <Field float PointF.x>
	//*   7   13:fconst_0        
	//*   8   14:fcmpl           
	//*   9   15:ifne            21
	//*  10   18:goto            37
	...
	//   11   21:aload_0         
	//   12   22:getfield        #182 <Field PointF mTargetVector>
	//   13   25:getfield        #187 <Field float PointF.x>
	//   14   28:fconst_0        
	//   15   29:fcmpl           
	//   16   30:ifle            35
	//   17   33:iconst_1        
	...
	//*   4    6:ifnull          37
	//*   5    9:aload_1         
	//*   6   10:getfield        #191 <Field float PointF.y>
	//*   7   13:fconst_0        
	//*   8   14:fcmpl           
	//*   9   15:ifne            21
	//*  10   18:goto            37
	...
	//   11   21:aload_0         
	//   12   22:getfield        #182 <Field PointF mTargetVector>
	//   13   25:getfield        #191 <Field float PointF.y>
	//   14   28:fconst_0        
	//   15   29:fcmpl           
	//   16   30:ifle            35
	//   17   33:iconst_1        
	...
	protected void onSeekTargetStep(int i, int j, RecyclerView.State state, RecyclerView.SmoothScroller.Action action)
	{
		if(getChildCount() == 0)
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #196 <Method int getChildCount()>
	//*   2    4:ifne            12
		{
			stop();
	//    3    7:aload_0         
	//    4    8:invokevirtual   #199 <Method void stop()>
			return;
	//    5   11:return          
		}
	...
	//   10   18:iload_1         
	//   11   19:invokespecial   #201 <Method int clampApplyScroll(int, int)>
	...
	//   17   31:iload_2         
	//   18   32:invokespecial   #201 <Method int clampApplyScroll(int, int)>
	...
	//   26   52:aload_0         
	//   27   53:aload           4
	//   28   55:invokevirtual   #205 <Method void updateActionForInterimTarget(RecyclerView$SmoothScroller$Action)>
	//   29   58:return          
	}
	...
	//    6   10:aload_0         
	//    7   11:aconst_null     
	//    8   12:putfield        #182 <Field PointF mTargetVector>
	//    9   15:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_0         
	//    3    3:invokevirtual   #211 <Method int getHorizontalSnapPreference()>
	//    4    6:invokevirtual   #213 <Method int calculateDxToMakeVisible(View, int)>
	//    5    9:istore          4
		int j = calculateDyToMakeVisible(view, getVerticalSnapPreference());
	//    6   11:aload_0         
	//    7   12:aload_1         
	//    8   13:aload_0         
	//    9   14:invokevirtual   #215 <Method int getVerticalSnapPreference()>
	//   10   17:invokevirtual   #217 <Method int calculateDyToMakeVisible(View, int)>
	//   11   20:istore          5
	...
	//   19   33:iadd            
	//   20   34:i2d             
	//   21   35:invokestatic    #220 <Method double Math.sqrt(double)>
	//   22   38:d2i             
	//   23   39:invokevirtual   #222 <Method int calculateTimeForDeceleration(int)>
	//   24   42:istore          6
		if(k > 0)
	//*  25   44:iload           6
	//*  26   46:ifle            65
	...
	//   35   62:invokevirtual   #228 <Method void RecyclerView$SmoothScroller$Action.update(int, int, int, android.view.animation.Interpolator)>
	//   36   65:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:invokevirtual   #231 <Method int getTargetPosition()>
	//    3    5:invokevirtual   #235 <Method PointF computeScrollVectorForPosition(int)>
	//    4    8:astore_3        
		if(pointf != null && (pointf.x != 0.0F || pointf.y != 0.0F))
	//*   5    9:aload_3         
	//*   6   10:ifnull          109
	//*   7   13:aload_3         
	//*   8   14:getfield        #187 <Field float PointF.x>
	//*   9   17:fconst_0        
	//*  10   18:fcmpl           
	//*  11   19:ifne            34
	//*  12   22:aload_3         
	//*  13   23:getfield        #191 <Field float PointF.y>
	//*  14   26:fconst_0        
	//*  15   27:fcmpl           
	//*  16   28:ifne            34
	//*  17   31:goto            109
	...
	//   18   34:aload_0         
	//   19   35:aload_3         
	//   20   36:invokevirtual   #239 <Method void normalize(PointF)>
			mTargetVector = pointf;
	//   21   39:aload_0         
	//   22   40:aload_3         
	//   23   41:putfield        #182 <Field PointF mTargetVector>
			mInterimTargetDx = (int)(pointf.x * 10000F);
	//   24   44:aload_0         
	//   25   45:aload_3         
	//   26   46:getfield        #187 <Field float PointF.x>
	//   27   49:ldc1            #240 <Float 10000F>
	//   28   51:fmul            
	//   29   52:f2i             
	//   30   53:putfield        #50  <Field int mInterimTargetDx>
			mInterimTargetDy = (int)(pointf.y * 10000F);
	//   31   56:aload_0         
	//   32   57:aload_3         
	//   33   58:getfield        #191 <Field float PointF.y>
	//   34   61:ldc1            #240 <Float 10000F>
	//   35   63:fmul            
	//   36   64:f2i             
	//   37   65:putfield        #52  <Field int mInterimTargetDy>
			int i = calculateTimeForScrolling(10000);
	//   38   68:aload_0         
	//   39   69:sipush          10000
	//   40   72:invokevirtual   #162 <Method int calculateTimeForScrolling(int)>
	//   41   75:istore_2        
	...
	//   42   76:aload_1         
	//   43   77:aload_0         
	//   44   78:getfield        #50  <Field int mInterimTargetDx>
	//   45   81:i2f             
	//   46   82:ldc1            #22  <Float 1.2F>
	//   47   84:fmul            
	//   48   85:f2i             
	//   49   86:aload_0         
	//   50   87:getfield        #52  <Field int mInterimTargetDy>
	//   51   90:i2f             
	//   52   91:ldc1            #22  <Float 1.2F>
	//   53   93:fmul            
	//   54   94:f2i             
	//   55   95:iload_2         
	//   56   96:i2f             
	//   57   97:ldc1            #22  <Float 1.2F>
	//   58   99:fmul            
	//   59  100:f2i             
	//   60  101:aload_0         
	//   61  102:getfield        #43  <Field LinearInterpolator mLinearInterpolator>
	//   62  105:invokevirtual   #228 <Method void RecyclerView$SmoothScroller$Action.update(int, int, int, android.view.animation.Interpolator)>
			return;
	//   63  108:return          
		} else
		{
	...
	//   64  109:aload_1         
	//   65  110:aload_0         
	//   66  111:invokevirtual   #231 <Method int getTargetPosition()>
	//   67  114:invokevirtual   #244 <Method void RecyclerView$SmoothScroller$Action.jumpTo(int)>
			stop();
	//   68  117:aload_0         
	//   69  118:invokevirtual   #199 <Method void stop()>
			return;
	//   70  121:return          
		}
	}
