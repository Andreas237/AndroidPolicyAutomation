...
class RecyclerView$RecyclerViewDataObserver extends RecyclerView.AdapterDataObserver
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #10  <Field RecyclerView this$0>
	//    2    4:aconst_null     
	//    3    5:invokevirtual   #21  <Method void RecyclerView.assertNotInLayoutOrScroll(String)>
		mState.mStructureChanged = true;
	//    4    8:aload_0         
	//    5    9:getfield        #10  <Field RecyclerView this$0>
	//    6   12:getfield        #25  <Field RecyclerView$State RecyclerView.mState>
	//    7   15:iconst_1        
	//    8   16:putfield        #31  <Field boolean RecyclerView$State.mStructureChanged>
		processDataSetCompletelyChanged(true);
	//    9   19:aload_0         
	//   10   20:getfield        #10  <Field RecyclerView this$0>
	//   11   23:iconst_1        
	//   12   24:invokevirtual   #35  <Method void RecyclerView.processDataSetCompletelyChanged(boolean)>
		if(!mAdapterHelper.hasPendingUpdates())
	//*  13   27:aload_0         
	//*  14   28:getfield        #10  <Field RecyclerView this$0>
	//*  15   31:getfield        #39  <Field AdapterHelper RecyclerView.mAdapterHelper>
	//*  16   34:invokevirtual   #45  <Method boolean AdapterHelper.hasPendingUpdates()>
	//*  17   37:ifne            47
			requestLayout();
	//   18   40:aload_0         
	//   19   41:getfield        #10  <Field RecyclerView this$0>
	//   20   44:invokevirtual   #48  <Method void RecyclerView.requestLayout()>
	//   21   47:return          
	}
	...
	//*   1    3:ifeq            40
	//*   2    6:aload_0         
	//*   3    7:getfield        #10  <Field RecyclerView this$0>
	//*   4   10:getfield        #75  <Field boolean RecyclerView.mHasFixedSize>
	//*   5   13:ifeq            40
	//*   6   16:aload_0         
	//*   7   17:getfield        #10  <Field RecyclerView this$0>
	//*   8   20:getfield        #78  <Field boolean RecyclerView.mIsAttached>
	//*   9   23:ifeq            40
		{
			RecyclerView recyclerview = RecyclerView.this;
	//   10   26:aload_0         
	//   11   27:getfield        #10  <Field RecyclerView this$0>
	//   12   30:astore_1        
			ac.a(((android.view.View) (recyclerview)), recyclerview.mUpdateChildViewsRunnable);
	//   13   31:aload_1         
	//   14   32:aload_1         
	//   15   33:getfield        #82  <Field Runnable RecyclerView.mUpdateChildViewsRunnable>
	//   16   36:invokestatic    #88  <Method void ac.a(android.view.View, Runnable)>
			return;
	//   17   39:return          
		} else
		{
	...
	//   21   45:aload_1         
	//   22   46:iconst_1        
	//   23   47:putfield        #91  <Field boolean RecyclerView.mAdapterUpdateDuringMeasure>
			recyclerview1.requestLayout();
	//   24   50:aload_1         
	//   25   51:invokevirtual   #48  <Method void RecyclerView.requestLayout()>
			return;
	//   26   54:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #10  <Field RecyclerView this$0>
		super();
	//    3    5:aload_0         
	//    4    6:invokespecial   #13  <Method void RecyclerView$AdapterDataObserver()>
	//    5    9:return          
	}
}
