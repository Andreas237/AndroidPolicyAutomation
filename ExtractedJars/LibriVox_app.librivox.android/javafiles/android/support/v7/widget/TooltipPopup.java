...
class TooltipPopup
{
	...
	//   49  105:putfield        #97  <Field String android.view.WindowManager$LayoutParams.packageName>
	...
	//   53  113:aload_1         
	//   54  114:sipush          1002
	//   55  117:putfield        #100 <Field int android.view.WindowManager$LayoutParams.type>
		context.width = -2;
	//   56  120:aload_1         
	//   57  121:bipush          -2
	//   58  123:putfield        #103 <Field int android.view.WindowManager$LayoutParams.width>
		context.height = -2;
	//   59  126:aload_1         
	//   60  127:bipush          -2
	//   61  129:putfield        #106 <Field int android.view.WindowManager$LayoutParams.height>
		context.format = -3;
	//   62  132:aload_1         
	//   63  133:bipush          -3
	//   64  135:putfield        #109 <Field int android.view.WindowManager$LayoutParams.format>
		context.windowAnimations = android.support.v7.appcompat.R.style.Animation_AppCompat_Tooltip;
	//   65  138:aload_1         
	//   66  139:getstatic       #114 <Field int android.support.v7.appcompat.R$style.Animation_AppCompat_Tooltip>
	//   67  142:putfield        #117 <Field int android.view.WindowManager$LayoutParams.windowAnimations>
		mLayoutParams.flags = 24;
	//   68  145:aload_0         
	//   69  146:getfield        #31  <Field android.view.WindowManager$LayoutParams mLayoutParams>
	//   70  149:bipush          24
	//   71  151:putfield        #120 <Field int android.view.WindowManager$LayoutParams.flags>
	//   72  154:return          
	}
	...
	//    0    0:aload           5
	//    1    2:aload_1         
	//    2    3:invokevirtual   #127 <Method android.os.IBinder View.getApplicationWindowToken()>
	//    3    6:putfield        #131 <Field android.os.IBinder android.view.WindowManager$LayoutParams.token>
	...
	//    6   13:invokevirtual   #135 <Method Resources Context.getResources()>
	//    7   16:getstatic       #140 <Field int android.support.v7.appcompat.R$dimen.tooltip_precise_anchor_threshold>
	//    8   19:invokevirtual   #146 <Method int Resources.getDimensionPixelOffset(int)>
	//    9   22:istore          6
		if(view.getWidth() < k)
	//*  10   24:aload_1         
	//*  11   25:invokevirtual   #150 <Method int View.getWidth()>
	//*  12   28:iload           6
	//*  13   30:icmplt          36
	//*  14   33:goto            43
			i = view.getWidth() / 2;
	//   15   36:aload_1         
	//   16   37:invokevirtual   #150 <Method int View.getWidth()>
	//   17   40:iconst_2        
	//   18   41:idiv            
	//   19   42:istore_2        
		if(view.getHeight() >= k)
	//*  20   43:aload_1         
	//*  21   44:invokevirtual   #153 <Method int View.getHeight()>
	//*  22   47:iload           6
	//*  23   49:icmplt          89
		{
	...
	//   26   56:invokevirtual   #135 <Method Resources Context.getResources()>
	//   27   59:getstatic       #156 <Field int android.support.v7.appcompat.R$dimen.tooltip_precise_anchor_extra_offset>
	//   28   62:invokevirtual   #146 <Method int Resources.getDimensionPixelOffset(int)>
	//   29   65:istore          7
			k = j + l;
	//   30   67:iload_3         
	//   31   68:iload           7
	...
	//*  42   86:goto            97
		{
			j = view.getHeight();
	//   43   89:aload_1         
	//   44   90:invokevirtual   #153 <Method int View.getHeight()>
	//   45   93:istore_3        
			k = 0;
	//   46   94:iconst_0        
	//   47   95:istore          6
	...
	//   48   97:aload           5
	//   49   99:bipush          49
	//   50  101:putfield        #159 <Field int android.view.WindowManager$LayoutParams.gravity>
		Object obj = ((Object) (mContext.getResources()));
	//   51  104:aload_0         
	//   52  105:getfield        #42  <Field Context mContext>
	//   53  108:invokevirtual   #135 <Method Resources Context.getResources()>
	//   54  111:astore          9
		int i1;
		if(flag)
	//*  55  113:iload           4
	...
	//   57  118:getstatic       #162 <Field int android.support.v7.appcompat.R$dimen.tooltip_y_offset_touch>
	//   58  121:istore          7
		else
	//*  59  123:goto            131
			i1 = android.support.v7.appcompat.R.dimen.tooltip_y_offset_non_touch;
	//   60  126:getstatic       #165 <Field int android.support.v7.appcompat.R$dimen.tooltip_y_offset_non_touch>
	//   61  129:istore          7
		int j1 = ((Resources) (obj)).getDimensionPixelOffset(i1);
	//   62  131:aload           9
	//   63  133:iload           7
	//   64  135:invokevirtual   #146 <Method int Resources.getDimensionPixelOffset(int)>
	//   65  138:istore          8
		obj = ((Object) (getAppRootView(view)));
	//   66  140:aload_1         
	//   67  141:invokestatic    #169 <Method View getAppRootView(View)>
	//   68  144:astore          9
		if(obj == null)
	//*  69  146:aload           9
	...
	//   71  151:ldc1            #8   <String "TooltipPopup">
	//   72  153:ldc1            #171 <String "Cannot find app view">
	//   73  155:invokestatic    #177 <Method int Log.e(String, String)>
	//   74  158:pop             
			return;
	//   75  159:return          
		}
	...
	//   79  166:invokevirtual   #181 <Method void View.getWindowVisibleDisplayFrame(Rect)>
		if(mTmpDisplayFrame.left < 0 && mTmpDisplayFrame.top < 0)
	//*  80  169:aload_0         
	//*  81  170:getfield        #36  <Field Rect mTmpDisplayFrame>
	//*  82  173:getfield        #184 <Field int Rect.left>
	//*  83  176:ifge            258
	//*  84  179:aload_0         
	//*  85  180:getfield        #36  <Field Rect mTmpDisplayFrame>
	//*  86  183:getfield        #187 <Field int Rect.top>
	//*  87  186:ifge            258
		{
			Object obj1 = ((Object) (mContext.getResources()));
	//   88  189:aload_0         
	//   89  190:getfield        #42  <Field Context mContext>
	//   90  193:invokevirtual   #135 <Method Resources Context.getResources()>
	//   91  196:astore          10
			i1 = ((Resources) (obj1)).getIdentifier("status_bar_height", "dimen", "android");
	//   92  198:aload           10
	//   93  200:ldc1            #189 <String "status_bar_height">
	//   94  202:ldc1            #191 <String "dimen">
	//   95  204:ldc1            #193 <String "android">
	//   96  206:invokevirtual   #197 <Method int Resources.getIdentifier(String, String, String)>
	//   97  209:istore          7
			if(i1 != 0)
	//*  98  211:iload           7
	//*  99  213:ifeq            228
	...
	//  100  216:aload           10
	//  101  218:iload           7
	//  102  220:invokevirtual   #200 <Method int Resources.getDimensionPixelSize(int)>
	//  103  223:istore          7
			else
	//* 104  225:goto            231
				i1 = 0;
	...
	//  107  231:aload           10
	//  108  233:invokevirtual   #204 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//  109  236:astore          10
	...
	//  113  243:iload           7
	//  114  245:aload           10
	//  115  247:getfield        #209 <Field int DisplayMetrics.widthPixels>
	//  116  250:aload           10
	//  117  252:getfield        #212 <Field int DisplayMetrics.heightPixels>
	//  118  255:invokevirtual   #216 <Method void Rect.set(int, int, int, int)>
		}
		((View) (obj)).getLocationOnScreen(mTmpAppPos);
	//  119  258:aload           9
	//  120  260:aload_0         
	//  121  261:getfield        #40  <Field int[] mTmpAppPos>
	//  122  264:invokevirtual   #220 <Method void View.getLocationOnScreen(int[])>
		view.getLocationOnScreen(mTmpAnchorPos);
	//  123  267:aload_1         
	//  124  268:aload_0         
	//  125  269:getfield        #38  <Field int[] mTmpAnchorPos>
	//  126  272:invokevirtual   #220 <Method void View.getLocationOnScreen(int[])>
	...
	//  160  318:iadd            
	//  161  319:aload           9
	//  162  321:invokevirtual   #150 <Method int View.getWidth()>
	//  163  324:iconst_2        
	//  164  325:idiv            
	//  165  326:isub            
	//  166  327:putfield        #223 <Field int android.view.WindowManager$LayoutParams.x>
		i = android.view.View.MeasureSpec.makeMeasureSpec(0, 0);
	//  167  330:iconst_0        
	//  168  331:iconst_0        
	//  169  332:invokestatic    #229 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  170  335:istore_2        
	...
	//  173  340:iload_2         
	//  174  341:iload_2         
	//  175  342:invokevirtual   #233 <Method void View.measure(int, int)>
		i = mContentView.getMeasuredHeight();
	//  176  345:aload_0         
	//  177  346:getfield        #60  <Field View mContentView>
	//  178  349:invokevirtual   #236 <Method int View.getMeasuredHeight()>
	//  179  352:istore_2        
		view = ((View) (mTmpAnchorPos));
	//  180  353:aload_0         
	...
	//  205  390:aload           5
	//  206  392:iload           6
	//  207  394:putfield        #239 <Field int android.view.WindowManager$LayoutParams.y>
				return;
	//  208  397:return          
			} else
			{
	...
	//  209  398:aload           5
	//  210  400:iload_3         
	//  211  401:putfield        #239 <Field int android.view.WindowManager$LayoutParams.y>
				return;
	//  212  404:return          
			}
	...
	//* 218  412:invokevirtual   #241 <Method int Rect.height()>
	//* 219  415:icmpgt          425
		{
			layoutparams.y = j;
	//  220  418:aload           5
	//  221  420:iload_3         
	//  222  421:putfield        #239 <Field int android.view.WindowManager$LayoutParams.y>
			return;
	//  223  424:return          
		} else
		{
	...
	//  224  425:aload           5
	//  225  427:iload           6
	//  226  429:putfield        #239 <Field int android.view.WindowManager$LayoutParams.y>
			return;
	//  227  432:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #245 <Method View View.getRootView()>
	//    2    4:astore_1        
		android.view.ViewGroup.LayoutParams layoutparams = view1.getLayoutParams();
	//    3    5:aload_1         
	//    4    6:invokevirtual   #249 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//    5    9:astore_2        
	...
	//*  11   21:getfield        #100 <Field int android.view.WindowManager$LayoutParams.type>
	//*  12   24:iconst_2        
	//*  13   25:icmpne          30
			return view1;
	//   14   28:aload_1         
	...
	//*  16   30:aload_0         
	//*  17   31:invokevirtual   #253 <Method Context View.getContext()>
	//*  18   34:astore_0        
	//*  19   35:aload_0         
	//*  20   36:instanceof      #255 <Class ContextWrapper>
	//*  21   39:ifeq            71
			if(view instanceof Activity)
	//*  22   42:aload_0         
	//*  23   43:instanceof      #257 <Class Activity>
	//*  24   46:ifeq            60
				return ((Activity)view).getWindow().getDecorView();
	//   25   49:aload_0         
	//   26   50:checkcast       #257 <Class Activity>
	//   27   53:invokevirtual   #261 <Method Window Activity.getWindow()>
	//   28   56:invokevirtual   #266 <Method View Window.getDecorView()>
	//   29   59:areturn         

	//   30   60:aload_0         
	//   31   61:checkcast       #255 <Class ContextWrapper>
	//   32   64:invokevirtual   #269 <Method Context ContextWrapper.getBaseContext()>
	//   33   67:astore_0        
	//*  34   68:goto            35
		return view1;
	//   35   71:aload_1         
	...
	void hide()
	{
		if(!isShowing())
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #274 <Method boolean isShowing()>
	//*   2    4:ifne            8
		{
			return;
	//    3    7:return          
	...
	//    6   12:ldc2            #276 <String "window">
	//    7   15:invokevirtual   #280 <Method Object Context.getSystemService(String)>
	//    8   18:checkcast       #282 <Class WindowManager>
	//    9   21:aload_0         
	//   10   22:getfield        #60  <Field View mContentView>
	//   11   25:invokeinterface #286 <Method void WindowManager.removeView(View)>
			return;
	//   12   30:return          
		}
	}
	...
	//    2    4:invokevirtual   #290 <Method android.view.ViewParent View.getParent()>
	//    3    7:ifnull          12
	//    4   10:iconst_1        
	//    5   11:ireturn         
	//    6   12:iconst_0        
	...
	//*   2    4:ifeq            11
			hide();
	//    3    7:aload_0         
	//    4    8:invokevirtual   #294 <Method void hide()>
		mMessageView.setText(charsequence);
	//    5   11:aload_0         
	//    6   12:getfield        #75  <Field TextView mMessageView>
	//    7   15:aload           5
	//    8   17:invokevirtual   #297 <Method void TextView.setText(CharSequence)>
	...
	//   16   30:invokespecial   #299 <Method void computePosition(View, int, int, boolean, android.view.WindowManager$LayoutParams)>
	...
	//   19   37:ldc2            #276 <String "window">
	//   20   40:invokevirtual   #280 <Method Object Context.getSystemService(String)>
	//   21   43:checkcast       #282 <Class WindowManager>
	//   22   46:aload_0         
	//   23   47:getfield        #60  <Field View mContentView>
	//   24   50:aload_0         
	//   25   51:getfield        #31  <Field android.view.WindowManager$LayoutParams mLayoutParams>
	//   26   54:invokeinterface #303 <Method void WindowManager.addView(View, android.view.ViewGroup$LayoutParams)>
	//   27   59:return          
	}
