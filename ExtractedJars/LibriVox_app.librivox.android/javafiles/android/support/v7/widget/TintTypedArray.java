...
public class TintTypedArray
{
	...
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #19  <Field TypedArray mWrapped>
	//    8   14:return          
	}
	...
	//    4    6:iload_1         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #27  <Method TypedArray Context.obtainStyledAttributes(int, int[])>
	//    7   11:invokespecial   #29  <Method void TintTypedArray(Context, TypedArray)>
	//    8   14:areturn         
	}
	...
	//    4    6:aload_1         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #33  <Method TypedArray Context.obtainStyledAttributes(AttributeSet, int[])>
	//    7   11:invokespecial   #29  <Method void TintTypedArray(Context, TypedArray)>
	//    8   14:areturn         
	}
	...
	//    6    8:iload_3         
	//    7    9:iload           4
	//    8   11:invokevirtual   #37  <Method TypedArray Context.obtainStyledAttributes(AttributeSet, int[], int, int)>
	//    9   14:invokespecial   #29  <Method void TintTypedArray(Context, TypedArray)>
	//   10   17:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #43  <Method boolean TypedArray.getBoolean(int, boolean)>
	//    5    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #47  <Method int TypedArray.getChangingConfigurations()>
	//    3    7:ireturn         
	}
	...
	//    5   11:aload_0         
	//    6   12:getfield        #19  <Field TypedArray mWrapped>
	//    7   15:iload_1         
	//    8   16:iconst_0        
	...
	//   22   40:aload_0         
	//   23   41:getfield        #19  <Field TypedArray mWrapped>
	//   24   44:iload_1         
	...
	//   18   34:aload_0         
	//   19   35:getfield        #19  <Field TypedArray mWrapped>
	//   20   38:iload_1         
	...
	//   14   28:aload_0         
	//   15   29:getfield        #17  <Field Context mContext>
	//   16   32:iload_1         
	//   17   33:iconst_1        
	...
	public Typeface getFont(int i, int j, l l)
	{
		i = mWrapped.getResourceId(i, 0);
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	...
	//    9   15:areturn         
		if(mTypedValue == null)
	//*  10   16:aload_0         
	//*  11   17:getfield        #101 <Field TypedValue mTypedValue>
	//*  12   20:ifnonnull       34
			mTypedValue = new TypedValue();
	//   13   23:aload_0         
	//   14   24:new             #103 <Class TypedValue>
	//   15   27:dup             
	//   16   28:invokespecial   #104 <Method void TypedValue()>
	//   17   31:putfield        #101 <Field TypedValue mTypedValue>
		return k.a(mContext, i, mTypedValue, j, l);
	//   18   34:aload_0         
	//   19   35:getfield        #17  <Field Context mContext>
	//   20   38:iload_1         
	//   21   39:aload_0         
	//   22   40:getfield        #101 <Field TypedValue mTypedValue>
	//   23   43:iload_2         
	//   24   44:aload_3         
	//   25   45:invokestatic    #110 <Method Typeface k.a(Context, int, TypedValue, int, l)>
	//   26   48:areturn         
	}

	public float getFraction(int i, int j, int l, float f)
	{
		return mWrapped.getFraction(i, j, l, f);
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:fload           4
	//    6    9:invokevirtual   #114 <Method float TypedArray.getFraction(int, int, int, float)>
	//    7   12:freturn         
	}
	...
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #118 <Method int TypedArray.getIndex(int)>
	//    4    8:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #121 <Method int TypedArray.getIndexCount()>
	//    3    7:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #124 <Method int TypedArray.getInt(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #127 <Method int TypedArray.getInteger(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #130 <Method int TypedArray.getLayoutDimension(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #133 <Method int TypedArray.getLayoutDimension(int, String)>
	//    5    9:ireturn         
	}
	...
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #137 <Method String TypedArray.getNonResourceString(int)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #141 <Method String TypedArray.getPositionDescription()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #145 <Method Resources TypedArray.getResources()>
	//    3    7:areturn         
	}
	...
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #148 <Method String TypedArray.getString(int)>
	//    4    8:areturn         
	}
	...
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #152 <Method CharSequence TypedArray.getText(int)>
	//    4    8:areturn         
	}
	...
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #156 <Method CharSequence[] TypedArray.getTextArray(int)>
	//    4    8:areturn         
	}
	...
	//*   0    0:getstatic       #163 <Field int android.os.Build$VERSION.SDK_INT>
	//*   1    3:bipush          21
	//*   2    5:icmplt          17
			return mWrapped.getType(i);
	//    3    8:aload_0         
	//    4    9:getfield        #19  <Field TypedArray mWrapped>
	//    5   12:iload_1         
	//    6   13:invokevirtual   #165 <Method int TypedArray.getType(int)>
	//    7   16:ireturn         
		if(mTypedValue == null)
	//*   8   17:aload_0         
	//*   9   18:getfield        #101 <Field TypedValue mTypedValue>
	//*  10   21:ifnonnull       35
			mTypedValue = new TypedValue();
	//   11   24:aload_0         
	//   12   25:new             #103 <Class TypedValue>
	//   13   28:dup             
	//   14   29:invokespecial   #104 <Method void TypedValue()>
	//   15   32:putfield        #101 <Field TypedValue mTypedValue>
		mWrapped.getValue(i, mTypedValue);
	//   16   35:aload_0         
	//   17   36:getfield        #19  <Field TypedArray mWrapped>
	//   18   39:iload_1         
	//   19   40:aload_0         
	//   20   41:getfield        #101 <Field TypedValue mTypedValue>
	//   21   44:invokevirtual   #169 <Method boolean TypedArray.getValue(int, TypedValue)>
	//   22   47:pop             
		return mTypedValue.type;
	//   23   48:aload_0         
	//   24   49:getfield        #101 <Field TypedValue mTypedValue>
	//   25   52:getfield        #172 <Field int TypedValue.type>
	//   26   55:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #169 <Method boolean TypedArray.getValue(int, TypedValue)>
	//    5    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #175 <Method int TypedArray.length()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #179 <Method TypedValue TypedArray.peekValue(int)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #182 <Method void TypedArray.recycle()>
	//    3    7:return          
	}
