...
class ItemTouchHelper$3 extends coverAnimation
{
	...
	//   15   31:getfield        #40  <Field android.support.v7.widget.RecyclerView ItemTouchHelper.mRecyclerView>
	//   16   34:aload_0         
	//   17   35:getfield        #18  <Field android.support.v7.widget.RecyclerView$ViewHolder val$prevSelected>
	//   18   38:invokevirtual   #46  <Method void ItemTouchHelper$Callback.clearView(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
		} else
	//*  19   41:goto            87
		{
	...
	//   25   55:getfield        #56  <Field android.view.View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	...
	//*  43   91:getfield        #72  <Field android.view.View ItemTouchHelper.mOverdrawChild>
	//*  44   94:aload_0         
	//*  45   95:getfield        #18  <Field android.support.v7.widget.RecyclerView$ViewHolder val$prevSelected>
	//*  46   98:getfield        #56  <Field android.view.View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	...
	//   52  112:getfield        #56  <Field android.view.View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   53  115:invokevirtual   #76  <Method void ItemTouchHelper.removeChildDrawingOrderCallbackIfNecessary(android.view.View)>
	//   54  118:return          
	}
