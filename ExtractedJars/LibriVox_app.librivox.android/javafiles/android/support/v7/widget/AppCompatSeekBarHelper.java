...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper
{
	...
	//   22   50:invokestatic    #51  <Method void a.a(Drawable, ColorStateList)>
	...
	//   30   68:invokestatic    #54  <Method void a.a(Drawable, android.graphics.PorterDuff$Mode)>
			if(mTickMark.isStateful())
	//*  31   71:aload_0         
	//*  32   72:getfield        #35  <Field Drawable mTickMark>
	//*  33   75:invokevirtual   #58  <Method boolean Drawable.isStateful()>
	//*  34   78:ifeq            96
	...
	//   39   89:invokevirtual   #64  <Method int[] SeekBar.getDrawableState()>
	//   40   92:invokevirtual   #68  <Method boolean Drawable.setState(int[])>
	//   41   95:pop             
		}
	//   42   96:return          
	}
	...
	//    5   11:invokevirtual   #74  <Method int SeekBar.getMax()>
	//    6   14:istore          5
			int k = 1;
	//    7   16:iconst_1        
	//    8   17:istore          4
	...
	//   14   29:invokevirtual   #77  <Method int Drawable.getIntrinsicWidth()>
	//   15   32:istore_3        
				int i1 = mTickMark.getIntrinsicHeight();
	//   16   33:aload_0         
	//   17   34:getfield        #35  <Field Drawable mTickMark>
	//   18   37:invokevirtual   #80  <Method int Drawable.getIntrinsicHeight()>
	//   19   40:istore          6
				if(i >= 0)
	//*  20   42:iload_3         
	//*  21   43:iflt            53
	...
	//   41   75:iload_3         
	//   42   76:iload           4
	//   43   78:invokevirtual   #84  <Method void Drawable.setBounds(int, int, int, int)>
				float f = (float)(mView.getWidth() - mView.getPaddingLeft() - mView.getPaddingRight()) / (float)l;
	//   44   81:aload_0         
	//   45   82:getfield        #30  <Field SeekBar mView>
	//   46   85:invokevirtual   #87  <Method int SeekBar.getWidth()>
	//   47   88:aload_0         
	//   48   89:getfield        #30  <Field SeekBar mView>
	//   49   92:invokevirtual   #90  <Method int SeekBar.getPaddingLeft()>
	//   50   95:isub            
	//   51   96:aload_0         
	//   52   97:getfield        #30  <Field SeekBar mView>
	//   53  100:invokevirtual   #93  <Method int SeekBar.getPaddingRight()>
	//   54  103:isub            
	//   55  104:i2f             
	//   56  105:iload           5
	//   57  107:i2f             
	...
	//   59  109:fstore_2        
				k = canvas.save();
	//   60  110:aload_1         
	//   61  111:invokevirtual   #98  <Method int Canvas.save()>
	//   62  114:istore          4
				canvas.translate(mView.getPaddingLeft(), mView.getHeight() / 2);
	//   63  116:aload_1         
	//   64  117:aload_0         
	//   65  118:getfield        #30  <Field SeekBar mView>
	//   66  121:invokevirtual   #90  <Method int SeekBar.getPaddingLeft()>
	//   67  124:i2f             
	//   68  125:aload_0         
	//   69  126:getfield        #30  <Field SeekBar mView>
	//   70  129:invokevirtual   #101 <Method int SeekBar.getHeight()>
	//   71  132:iconst_2        
	//   72  133:idiv            
	//   73  134:i2f             
	//   74  135:invokevirtual   #105 <Method void Canvas.translate(float, float)>
				for(int j = 0; j <= l; j++)
	//*  75  138:iconst_0        
	//*  76  139:istore_3        
	//*  77  140:iload_3         
	...
	//   82  150:aload_1         
	//   83  151:invokevirtual   #108 <Method void Drawable.draw(Canvas)>
					canvas.translate(f, 0.0F);
	//   84  154:aload_1         
	//   85  155:fload_2         
	//   86  156:fconst_0        
	//   87  157:invokevirtual   #105 <Method void Canvas.translate(float, float)>
				}
	...
	//   93  167:aload_1         
	//   94  168:iload           4
	//   95  170:invokevirtual   #112 <Method void Canvas.restoreToCount(int)>
			}
		}
	//   96  173:return          
	}
	...
	//*   4    6:ifnull          38
	//*   5    9:aload_1         
	//*   6   10:invokevirtual   #58  <Method boolean Drawable.isStateful()>
	//*   7   13:ifeq            38
	//*   8   16:aload_1         
	//*   9   17:aload_0         
	//*  10   18:getfield        #30  <Field SeekBar mView>
	//*  11   21:invokevirtual   #64  <Method int[] SeekBar.getDrawableState()>
	//*  12   24:invokevirtual   #68  <Method boolean Drawable.setState(int[])>
	//*  13   27:ifeq            38
			mView.invalidateDrawable(drawable);
	//   14   30:aload_0         
	//   15   31:getfield        #30  <Field SeekBar mView>
	//   16   34:aload_1         
	//   17   35:invokevirtual   #117 <Method void SeekBar.invalidateDrawable(Drawable)>
	//   18   38:return          
	}
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #126 <Method void Drawable.jumpToCurrentState()>
	//    7   13:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #130 <Method void AppCompatProgressBarHelper.loadFromAttributes(AttributeSet, int)>
	...
	//    6   10:invokevirtual   #134 <Method android.content.Context SeekBar.getContext()>
	//    7   13:aload_1         
	//    8   14:getstatic       #140 <Field int[] android.support.v7.appcompat.R$styleable.AppCompatSeekBar>
	//    9   17:iload_2         
	//   10   18:iconst_0        
	//   11   19:invokestatic    #146 <Method TintTypedArray TintTypedArray.obtainStyledAttributes(android.content.Context, AttributeSet, int[], int, int)>
	//   12   22:astore_1        
	...
	//   13   23:aload_1         
	//   14   24:getstatic       #150 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_android_thumb>
	//   15   27:invokevirtual   #154 <Method Drawable TintTypedArray.getDrawableIfKnown(int)>
	//   16   30:astore_3        
		if(drawable != null)
	//*  17   31:aload_3         
	//*  18   32:ifnull          43
	...
	//   21   39:aload_3         
	//   22   40:invokevirtual   #157 <Method void SeekBar.setThumb(Drawable)>
		setTickMark(((TintTypedArray) (attributeset)).getDrawable(android.support.v7.appcompat.R.styleable.AppCompatSeekBar_tickMark));
	//   23   43:aload_0         
	//   24   44:aload_1         
	//   25   45:getstatic       #160 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMark>
	//   26   48:invokevirtual   #163 <Method Drawable TintTypedArray.getDrawable(int)>
	//   27   51:invokevirtual   #166 <Method void setTickMark(Drawable)>
		if(((TintTypedArray) (attributeset)).hasValue(android.support.v7.appcompat.R.styleable.AppCompatSeekBar_tickMarkTintMode))
	//*  28   54:aload_1         
	//*  29   55:getstatic       #169 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTintMode>
	//*  30   58:invokevirtual   #173 <Method boolean TintTypedArray.hasValue(int)>
	//*  31   61:ifeq            88
		{
	...
	//   32   64:aload_0         
	//   33   65:aload_1         
	//   34   66:getstatic       #169 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTintMode>
	//   35   69:iconst_m1       
	//   36   70:invokevirtual   #177 <Method int TintTypedArray.getInt(int, int)>
	//   37   73:aload_0         
	//   38   74:getfield        #24  <Field android.graphics.PorterDuff$Mode mTickMarkTintMode>
	//   39   77:invokestatic    #183 <Method android.graphics.PorterDuff$Mode DrawableUtils.parseTintMode(int, android.graphics.PorterDuff$Mode)>
	...
	//*  44   88:aload_1         
	//*  45   89:getstatic       #186 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTint>
	//*  46   92:invokevirtual   #173 <Method boolean TintTypedArray.hasValue(int)>
	//*  47   95:ifeq            114
		{
	...
	//   48   98:aload_0         
	//   49   99:aload_1         
	//   50  100:getstatic       #186 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTint>
	//   51  103:invokevirtual   #190 <Method ColorStateList TintTypedArray.getColorStateList(int)>
	...
	//   56  114:aload_1         
	//   57  115:invokevirtual   #193 <Method void TintTypedArray.recycle()>
		applyTickMarkTint();
	//   58  118:aload_0         
	//   59  119:invokespecial   #195 <Method void applyTickMarkTint()>
	//   60  122:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aconst_null     
	//    7   11:invokevirtual   #199 <Method void Drawable.setCallback(android.graphics.drawable.Drawable$Callback)>
		mTickMark = drawable;
	//    8   14:aload_0         
	//    9   15:aload_1         
	...
	//   16   28:invokevirtual   #199 <Method void Drawable.setCallback(android.graphics.drawable.Drawable$Callback)>
			a.b(drawable, ac.f(((android.view.View) (mView))));
	//   17   31:aload_1         
	//   18   32:aload_0         
	//   19   33:getfield        #30  <Field SeekBar mView>
	//   20   36:invokestatic    #205 <Method int ac.f(android.view.View)>
	//   21   39:invokestatic    #209 <Method boolean a.b(Drawable, int)>
	//   22   42:pop             
			if(drawable.isStateful())
	//*  23   43:aload_1         
	//*  24   44:invokevirtual   #58  <Method boolean Drawable.isStateful()>
	//*  25   47:ifeq            62
				drawable.setState(mView.getDrawableState());
	//   26   50:aload_1         
	//   27   51:aload_0         
	//   28   52:getfield        #30  <Field SeekBar mView>
	//   29   55:invokevirtual   #64  <Method int[] SeekBar.getDrawableState()>
	//   30   58:invokevirtual   #68  <Method boolean Drawable.setState(int[])>
	//   31   61:pop             
			applyTickMarkTint();
	//   32   62:aload_0         
	//   33   63:invokespecial   #195 <Method void applyTickMarkTint()>
		}
		mView.invalidate();
	//   34   66:aload_0         
	//   35   67:getfield        #30  <Field SeekBar mView>
	//   36   70:invokevirtual   #212 <Method void SeekBar.invalidate()>
	//   37   73:return          
	}
	...
	//    5    7:putfield        #26  <Field boolean mHasTickMarkTint>
		applyTickMarkTint();
	//    6   10:aload_0         
	//    7   11:invokespecial   #195 <Method void applyTickMarkTint()>
	//    8   14:return          
	}
