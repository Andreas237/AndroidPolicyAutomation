...
public class AppLinkNavigation
{
	...
	//    4    8:new             #42  <Class IllegalArgumentException>
	//    5   11:dup             
	//    6   12:ldc1            #44  <String "appLink must not be null.">
	//    7   14:invokespecial   #47  <Method void IllegalArgumentException(String)>
	//    8   17:athrow          
	...
	//*  12   22:ifnonnull       34
			bundle2 = new Bundle();
	//   13   25:new             #49  <Class Bundle>
	//   14   28:dup             
	//   15   29:invokespecial   #50  <Method void Bundle()>
	//   16   32:astore          4
		bundle = bundle1;
	//   17   34:aload_3         
	//   18   35:astore_2        
	...
	//*  20   37:ifnonnull       48
			bundle = new Bundle();
	//   21   40:new             #49  <Class Bundle>
	//   22   43:dup             
	//   23   44:invokespecial   #50  <Method void Bundle()>
	//   24   47:astore_2        
		appLink = applink;
	//   25   48:aload_0         
	//   26   49:aload_1         
	//   27   50:putfield        #52  <Field AppLink appLink>
		extras = bundle2;
	//   28   53:aload_0         
	//   29   54:aload           4
	//   30   56:putfield        #54  <Field Bundle extras>
		appLinkData = bundle;
	//   31   59:aload_0         
	//   32   60:aload_2         
	//   33   61:putfield        #56  <Field Bundle appLinkData>
	//   34   64:return          
	}
	...
	//    4    8:new             #49  <Class Bundle>
	//    5   11:dup             
	//    6   12:invokespecial   #50  <Method void Bundle()>
	//    7   15:astore_3        
		if(context != null)
	//*   8   16:aload_1         
	//*   9   17:ifnull          71
	...
	//   52  106:ldc1            #110 <String "Bolts Android 1.2.0">
	...
	//*   0    0:aload_1         
	//*   1    1:instanceof      #49  <Class Bundle>
	//*   2    4:ifeq            16
			return ((Object) (getJSONForBundle((Bundle)obj)));
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:checkcast       #49  <Class Bundle>
	//    6   12:invokespecial   #166 <Method JSONObject getJSONForBundle(Bundle)>
	//    7   15:areturn         
		if(obj instanceof CharSequence)
	//*   8   16:aload_1         
	//*   9   17:instanceof      #168 <Class CharSequence>
	//*  10   20:ifeq            28
			return ((Object) (obj.toString()));
	//   11   23:aload_1         
	//   12   24:invokevirtual   #169 <Method String Object.toString()>
	//   13   27:areturn         
		if(obj instanceof List)
	//*  14   28:aload_1         
	//*  15   29:instanceof      #171 <Class List>
	//*  16   32:ifeq            85
		{
			JSONArray jsonarray = new JSONArray();
	//   17   35:new             #173 <Class JSONArray>
	//   18   38:dup             
	//   19   39:invokespecial   #174 <Method void JSONArray()>
	//   20   42:astore          13
			for(obj = ((Object) (((List)obj).iterator())); ((Iterator) (obj)).hasNext(); jsonarray.put(getJSONValue(((Iterator) (obj)).next())));
	//   21   44:aload_1         
	//   22   45:checkcast       #171 <Class List>
	//   23   48:invokeinterface #175 <Method Iterator List.iterator()>
	//   24   53:astore_1        
	//   25   54:aload_1         
	...
	//   33   75:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//   34   78:pop             
	//*  35   79:goto            54
	...
	//   38   85:aload_1         
	//   39   86:instanceof      #180 <Class SparseArray>
	//   40   89:istore          12
		int i = 0;
	//   41   91:iconst_0        
	//   42   92:istore_2        
	...
	//   63  124:new             #173 <Class JSONArray>
	//   64  127:dup             
	//   65  128:invokespecial   #174 <Method void JSONArray()>
	//   66  131:astore          13
			obj = ((Object) ((SparseArray)obj));
	//   67  133:aload_1         
	//   68  134:checkcast       #180 <Class SparseArray>
	//   69  137:astore_1        
	...
	//*  72  141:iload_2         
	//*  73  142:aload_1         
	//*  74  143:invokevirtual   #184 <Method int SparseArray.size()>
	//*  75  146:icmpge          176
				jsonarray1.put(((SparseArray) (obj)).keyAt(i), getJSONValue(((SparseArray) (obj)).valueAt(i)));
	//   76  149:aload           13
	//   77  151:aload_1         
	//   78  152:iload_2         
	//   79  153:invokevirtual   #188 <Method int SparseArray.keyAt(int)>
	//   80  156:aload_0         
	//   81  157:aload_1         
	//   82  158:iload_2         
	//   83  159:invokevirtual   #192 <Method Object SparseArray.valueAt(int)>
	//   84  162:invokespecial   #159 <Method Object getJSONValue(Object)>
	//   85  165:invokevirtual   #195 <Method JSONArray JSONArray.put(int, Object)>
	//   86  168:pop             
	...
	//*  94  179:aload_1         
	//*  95  180:instanceof      #197 <Class Character>
	//*  96  183:ifeq            191
			return ((Object) (obj.toString()));
	//   97  186:aload_1         
	//   98  187:invokevirtual   #169 <Method String Object.toString()>
	//   99  190:areturn         
		if(obj instanceof Boolean)
	//* 100  191:aload_1         
	//* 101  192:instanceof      #199 <Class Boolean>
	//* 102  195:ifeq            200
			return obj;
	//  103  198:aload_1         
	//  104  199:areturn         
	...
	//* 105  200:aload_1         
	//* 106  201:instanceof      #201 <Class Number>
	//* 107  204:ifeq            246
			if(!(obj instanceof Double) && !(obj instanceof Float))
	//* 108  207:aload_1         
	//* 109  208:instanceof      #203 <Class Double>
	//* 110  211:ifne            235
	//* 111  214:aload_1         
	//* 112  215:instanceof      #205 <Class Float>
	//* 113  218:ifeq            224
	//* 114  221:goto            235
				return ((Object) (Long.valueOf(((Number)obj).longValue())));
	//  115  224:aload_1         
	//  116  225:checkcast       #201 <Class Number>
	//  117  228:invokevirtual   #209 <Method long Number.longValue()>
	//  118  231:invokestatic    #215 <Method Long Long.valueOf(long)>
	//  119  234:areturn         
			else
				return ((Object) (Double.valueOf(((Number)obj).doubleValue())));
	//  120  235:aload_1         
	//  121  236:checkcast       #201 <Class Number>
	//  122  239:invokevirtual   #219 <Method double Number.doubleValue()>
	//  123  242:invokestatic    #222 <Method Double Double.valueOf(double)>
	//  124  245:areturn         
		if(obj instanceof boolean[])
	//* 125  246:aload_1         
	//* 126  247:instanceof      #224 <Class boolean[]>
	//* 127  250:ifeq            301
		{
			JSONArray jsonarray2 = new JSONArray();
	//  128  253:new             #173 <Class JSONArray>
	//  129  256:dup             
	//  130  257:invokespecial   #174 <Method void JSONArray()>
	//  131  260:astore          13
			obj = ((Object) ((boolean[])obj));
	//  132  262:aload_1         
	//  133  263:checkcast       #224 <Class boolean[]>
	//  134  266:astore_1        
	...
	//  144  279:iload_2         
	//  145  280:baload          
	//  146  281:invokestatic    #227 <Method Boolean Boolean.valueOf(boolean)>
	//  147  284:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  148  287:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  149  290:pop             
	...
	//* 157  301:aload_1         
	//* 158  302:instanceof      #229 <Class char[]>
	//* 159  305:ifeq            360
		{
			JSONArray jsonarray3 = new JSONArray();
	//  160  308:new             #173 <Class JSONArray>
	//  161  311:dup             
	//  162  312:invokespecial   #174 <Method void JSONArray()>
	//  163  315:astore          13
			obj = ((Object) ((char[])obj));
	//  164  317:aload_1         
	//  165  318:checkcast       #229 <Class char[]>
	//  166  321:astore_1        
			j4 = obj.length;
	//  167  322:aload_1         
	//  168  323:arraylength     
	...
	//  178  338:iload_2         
	//  179  339:caload          
	//  180  340:invokestatic    #232 <Method Character Character.valueOf(char)>
	//  181  343:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  182  346:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  183  349:pop             
	...
	//  190  359:areturn         
		...
		if(obj instanceof CharSequence[])
	//* 191  360:aload_1         
	//* 192  361:instanceof      #234 <Class CharSequence[]>
	//* 193  364:ifeq            415
		{
			JSONArray jsonarray4 = new JSONArray();
	//  194  367:new             #173 <Class JSONArray>
	//  195  370:dup             
	//  196  371:invokespecial   #174 <Method void JSONArray()>
	//  197  374:astore          13
			obj = ((Object) ((CharSequence[])obj));
	//  198  376:aload_1         
	//  199  377:checkcast       #234 <Class CharSequence[]>
	//  200  380:astore_1        
			int k2 = obj.length;
	//  201  381:aload_1         
	//  202  382:arraylength     
	...
	//  215  401:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  216  404:pop             
	...
	//* 224  415:aload_1         
	//* 225  416:instanceof      #236 <Class double[]>
	//* 226  419:ifeq            473
		{
			JSONArray jsonarray5 = new JSONArray();
	//  227  422:new             #173 <Class JSONArray>
	//  228  425:dup             
	//  229  426:invokespecial   #174 <Method void JSONArray()>
	//  230  429:astore          13
			obj = ((Object) ((double[])obj));
	//  231  431:aload_1         
	//  232  432:checkcast       #236 <Class double[]>
	//  233  435:astore_1        
			int l2 = obj.length;
	//  234  436:aload_1         
	//  235  437:arraylength     
	...
	//  245  451:iload_2         
	//  246  452:daload          
	//  247  453:invokestatic    #222 <Method Double Double.valueOf(double)>
	//  248  456:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  249  459:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  250  462:pop             
	...
	//* 258  473:aload_1         
	//* 259  474:instanceof      #238 <Class float[]>
	//* 260  477:ifeq            531
		{
			JSONArray jsonarray6 = new JSONArray();
	//  261  480:new             #173 <Class JSONArray>
	//  262  483:dup             
	//  263  484:invokespecial   #174 <Method void JSONArray()>
	//  264  487:astore          13
			obj = ((Object) ((float[])obj));
	//  265  489:aload_1         
	//  266  490:checkcast       #238 <Class float[]>
	//  267  493:astore_1        
			int i3 = obj.length;
	//  268  494:aload_1         
	//  269  495:arraylength     
	...
	//  279  509:iload_2         
	//  280  510:faload          
	//  281  511:invokestatic    #241 <Method Float Float.valueOf(float)>
	//  282  514:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  283  517:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  284  520:pop             
	...
	//* 292  531:aload_1         
	//* 293  532:instanceof      #243 <Class int[]>
	//* 294  535:ifeq            589
		{
			JSONArray jsonarray7 = new JSONArray();
	//  295  538:new             #173 <Class JSONArray>
	//  296  541:dup             
	//  297  542:invokespecial   #174 <Method void JSONArray()>
	//  298  545:astore          13
			obj = ((Object) ((int[])obj));
	//  299  547:aload_1         
	//  300  548:checkcast       #243 <Class int[]>
	//  301  551:astore_1        
			int j3 = obj.length;
	//  302  552:aload_1         
	//  303  553:arraylength     
	...
	//  313  567:iload_2         
	//  314  568:iaload          
	//  315  569:invokestatic    #248 <Method Integer Integer.valueOf(int)>
	//  316  572:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  317  575:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  318  578:pop             
	...
	//* 326  589:aload_1         
	//* 327  590:instanceof      #250 <Class long[]>
	//* 328  593:ifeq            647
		{
			JSONArray jsonarray8 = new JSONArray();
	//  329  596:new             #173 <Class JSONArray>
	//  330  599:dup             
	//  331  600:invokespecial   #174 <Method void JSONArray()>
	//  332  603:astore          13
			obj = ((Object) ((long[])obj));
	//  333  605:aload_1         
	//  334  606:checkcast       #250 <Class long[]>
	//  335  609:astore_1        
			int k3 = obj.length;
	//  336  610:aload_1         
	//  337  611:arraylength     
	...
	//  347  625:iload_2         
	//  348  626:laload          
	//  349  627:invokestatic    #215 <Method Long Long.valueOf(long)>
	//  350  630:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  351  633:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  352  636:pop             
	...
	//* 360  647:aload_1         
	//* 361  648:instanceof      #252 <Class short[]>
	//* 362  651:ifeq            705
		{
			JSONArray jsonarray9 = new JSONArray();
	//  363  654:new             #173 <Class JSONArray>
	//  364  657:dup             
	//  365  658:invokespecial   #174 <Method void JSONArray()>
	//  366  661:astore          13
			obj = ((Object) ((short[])obj));
	//  367  663:aload_1         
	//  368  664:checkcast       #252 <Class short[]>
	//  369  667:astore_1        
			int l3 = obj.length;
	//  370  668:aload_1         
	//  371  669:arraylength     
	...
	//  381  683:iload_2         
	//  382  684:saload          
	//  383  685:invokestatic    #257 <Method Short Short.valueOf(short)>
	//  384  688:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  385  691:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  386  694:pop             
	...
	//* 394  705:aload_1         
	//* 395  706:instanceof      #259 <Class String[]>
	//* 396  709:ifeq            760
		{
			JSONArray jsonarray10 = new JSONArray();
	//  397  712:new             #173 <Class JSONArray>
	//  398  715:dup             
	//  399  716:invokespecial   #174 <Method void JSONArray()>
	//  400  719:astore          13
			obj = ((Object) ((String[])obj));
	//  401  721:aload_1         
	//  402  722:checkcast       #259 <Class String[]>
	//  403  725:astore_1        
			int i4 = obj.length;
	//  404  726:aload_1         
	//  405  727:arraylength     
	//  406  728:istore_3        
			for(int i2 = ((int) (flag5)); i2 < i4; i2++)
	//* 407  729:iload           10
	//* 408  731:istore_2        
	//* 409  732:iload_2         
	//* 410  733:iload_3         
	//* 411  734:icmpge          757
				jsonarray10.put(getJSONValue(((Object) (obj[i2]))));
	//  412  737:aload           13
	//  413  739:aload_0         
	//  414  740:aload_1         
	//  415  741:iload_2         
	//  416  742:aaload          
	//  417  743:invokespecial   #159 <Method Object getJSONValue(Object)>
	//  418  746:invokevirtual   #178 <Method JSONArray JSONArray.put(Object)>
	//  419  749:pop             
	...
	//*   0    0:invokestatic    #263 <Method AppLinkResolver getDefaultResolver()>
	//*   1    3:ifnull          10
			return getDefaultResolver();
	//    2    6:invokestatic    #263 <Method AppLinkResolver getDefaultResolver()>
	//    3    9:areturn         
		else
			return ((AppLinkResolver) (new WebViewAppLinkResolver(context)));
	//    4   10:new             #265 <Class WebViewAppLinkResolver>
	//    5   13:dup             
	//    6   14:aload_0         
	//    7   15:invokespecial   #268 <Method void WebViewAppLinkResolver(Context)>
	//    8   18:areturn         
	}
	...
	//    3    5:aconst_null     
	//    4    6:aconst_null     
	//    5    7:invokespecial   #272 <Method void AppLinkNavigation(AppLink, Bundle, Bundle)>
	//    6   10:aload_0         
	//    7   11:invokevirtual   #275 <Method AppLinkNavigation$NavigationResult navigate(Context)>
	//    8   14:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_0         
	//    3    3:invokestatic    #279 <Method AppLinkResolver getResolver(Context)>
	//    4    6:invokestatic    #282 <Method Task navigateInBackground(Context, Uri, AppLinkResolver)>
	//    5    9:areturn         
	}
...
, Task.UI_THREAD_EXECUTOR);
	//    0    0:aload_2         
	//    1    1:aload_1         
	//    2    2:invokeinterface #290 <Method Task AppLinkResolver.getAppLinkFromUrlInBackground(Uri)>
	//    3    7:new             #6   <Class AppLinkNavigation$1>
	//    4   10:dup             
	//    5   11:aload_0         
	//    6   12:invokespecial   #291 <Method void AppLinkNavigation$1(Context)>
	//    7   15:getstatic       #297 <Field java.util.concurrent.Executor Task.UI_THREAD_EXECUTOR>
	//    8   18:invokevirtual   #301 <Method Task Task.onSuccess(Continuation, java.util.concurrent.Executor)>
	//    9   21:areturn         
	}
	...
	//    2    2:aload_0         
	//    3    3:invokestatic    #279 <Method AppLinkResolver getResolver(Context)>
	//    4    6:invokestatic    #306 <Method Task navigateInBackground(Context, String, AppLinkResolver)>
	//    5    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #311 <Method Uri Uri.parse(String)>
	//    3    5:aload_2         
	//    4    6:invokestatic    #282 <Method Task navigateInBackground(Context, Uri, AppLinkResolver)>
	//    5    9:areturn         
	}
	...
	//    2    2:aload_0         
	//    3    3:invokestatic    #279 <Method AppLinkResolver getResolver(Context)>
	//    4    6:invokestatic    #316 <Method Task navigateInBackground(Context, URL, AppLinkResolver)>
	//    5    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #320 <Method String URL.toString()>
	//    3    5:invokestatic    #311 <Method Uri Uri.parse(String)>
	//    4    8:aload_2         
	//    5    9:invokestatic    #282 <Method Task navigateInBackground(Context, Uri, AppLinkResolver)>
	//    6   12:areturn         
	}
	...
	//    0    0:new             #325 <Class HashMap>
	//    1    3:dup             
	//    2    4:invokespecial   #326 <Method void HashMap()>
	//    3    7:astore          5
	...
	//    6   14:aload           5
	//    7   16:ldc2            #328 <String "error">
	//    8   19:aload           4
	//    9   21:invokevirtual   #331 <Method String JSONException.getLocalizedMessage()>
	//   10   24:invokeinterface #336 <Method Object Map.put(Object, Object)>
	//   11   29:pop             
		if(navigationresult.isSucceeded())
	//*  12   30:aload_3         
	//*  13   31:invokevirtual   #339 <Method boolean AppLinkNavigation$NavigationResult.isSucceeded()>
	//*  14   34:ifeq            45
			jsonexception = "1";
	//   15   37:ldc2            #341 <String "1">
	//   16   40:astore          4
		else
	//*  17   42:goto            50
			jsonexception = "0";
	//   18   45:ldc2            #343 <String "0">
	//   19   48:astore          4
		((Map) (hashmap)).put("success", ((Object) (jsonexception)));
	//   20   50:aload           5
	//   21   52:ldc2            #345 <String "success">
	//   22   55:aload           4
	//   23   57:invokeinterface #336 <Method Object Map.put(Object, Object)>
	//   24   62:pop             
		((Map) (hashmap)).put("type", ((Object) (navigationresult.getCode())));
	//   25   63:aload           5
	//   26   65:ldc2            #347 <String "type">
	//   27   68:aload_3         
	//   28   69:invokevirtual   #350 <Method String AppLinkNavigation$NavigationResult.getCode()>
	//   29   72:invokeinterface #336 <Method Object Map.put(Object, Object)>
	//   30   77:pop             
		MeasurementEvent.sendBroadcastEvent(context, "al_nav_out", intent, ((Map) (hashmap)));
	//   31   78:aload_1         
	//   32   79:ldc2            #352 <String "al_nav_out">
	//   33   82:aload_2         
	//   34   83:aload           5
	//   35   85:invokestatic    #358 <Method void MeasurementEvent.sendBroadcastEvent(Context, String, Intent, Map)>
	//   36   88:return          
	}
	...
	public AppLink getAppLink()
	{
		return appLink;
	//    0    0:aload_0         
	//    1    1:getfield        #52  <Field AppLink appLink>
	//    2    4:areturn         
	}
	...
	public Bundle getAppLinkData()
	{
		return appLinkData;
	//    0    0:aload_0         
	//    1    1:getfield        #56  <Field Bundle appLinkData>
	//    2    4:areturn         
	}
	...
	public Bundle getExtras()
	{
		return extras;
	//    0    0:aload_0         
	//    1    1:getfield        #54  <Field Bundle extras>
	//    2    4:areturn         
	}
...
label0:
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #364 <Method PackageManager Context.getPackageManager()>
	//    2    4:astore          4
			obj1 = ((Object) (buildAppLinkDataForNavigation(context)));
	//    3    6:aload_0         
	//    4    7:aload_1         
	//    5    8:invokespecial   #366 <Method Bundle buildAppLinkDataForNavigation(Context)>
	//    6   11:astore_3        
			for(Iterator iterator = getAppLink().getTargets().iterator(); iterator.hasNext();)
	//*   7   12:aload_0         
	//*   8   13:invokevirtual   #97  <Method AppLink getAppLink()>
	//*   9   16:invokevirtual   #370 <Method List AppLink.getTargets()>
	//*  10   19:invokeinterface #175 <Method Iterator List.iterator()>
	//*  11   24:astore          5
	//*  12   26:aload           5
	...
	//   17   43:checkcast       #372 <Class AppLink$Target>
	//   18   46:astore          6
				obj = ((Object) (new Intent("android.intent.action.VIEW")));
	//   19   48:new             #374 <Class Intent>
	//   20   51:dup             
	//   21   52:ldc2            #376 <String "android.intent.action.VIEW">
	//   22   55:invokespecial   #377 <Method void Intent(String)>
	//   23   58:astore_2        
				if(target.getUrl() != null)
	//*  24   59:aload           6
	//*  25   61:invokevirtual   #380 <Method Uri AppLink$Target.getUrl()>
	//*  26   64:ifnull          80
					((Intent) (obj)).setData(target.getUrl());
	//   27   67:aload_2         
	//   28   68:aload           6
	//   29   70:invokevirtual   #380 <Method Uri AppLink$Target.getUrl()>
	//   30   73:invokevirtual   #384 <Method Intent Intent.setData(Uri)>
	//   31   76:pop             
				else
	//*  32   77:goto            92
	...
	//   33   80:aload_2         
	//   34   81:aload_0         
	//   35   82:getfield        #52  <Field AppLink appLink>
	//   36   85:invokevirtual   #103 <Method Uri AppLink.getSourceUrl()>
	//   37   88:invokevirtual   #384 <Method Intent Intent.setData(Uri)>
	//   38   91:pop             
				((Intent) (obj)).setPackage(target.getPackageName());
	//   39   92:aload_2         
	//   40   93:aload           6
	//   41   95:invokevirtual   #385 <Method String AppLink$Target.getPackageName()>
	//   42   98:invokevirtual   #389 <Method Intent Intent.setPackage(String)>
	//   43  101:pop             
				if(target.getClassName() != null)
	//*  44  102:aload           6
	//*  45  104:invokevirtual   #392 <Method String AppLink$Target.getClassName()>
	//*  46  107:ifnull          125
					((Intent) (obj)).setClassName(target.getPackageName(), target.getClassName());
	//   47  110:aload_2         
	//   48  111:aload           6
	//   49  113:invokevirtual   #385 <Method String AppLink$Target.getPackageName()>
	//   50  116:aload           6
	//   51  118:invokevirtual   #392 <Method String AppLink$Target.getClassName()>
	//   52  121:invokevirtual   #396 <Method Intent Intent.setClassName(String, String)>
	//   53  124:pop             
				((Intent) (obj)).putExtra("al_applink_data", ((Bundle) (obj1)));
	//   54  125:aload_2         
	//   55  126:ldc2            #398 <String "al_applink_data">
	//   56  129:aload_3         
	//   57  130:invokevirtual   #402 <Method Intent Intent.putExtra(String, Bundle)>
	//   58  133:pop             
				if(packagemanager.resolveActivity(((Intent) (obj)), 0x10000) != null)
	//*  59  134:aload           4
	//*  60  136:aload_2         
	//*  61  137:ldc2            #403 <Int 0x10000>
	//*  62  140:invokevirtual   #409 <Method android.content.pm.ResolveInfo PackageManager.resolveActivity(Intent, int)>
	//*  63  143:ifnull          26
					break label0;
	//   64  146:goto            151
			}
	...
	//   67  151:getstatic       #413 <Field AppLinkNavigation$NavigationResult AppLinkNavigation$NavigationResult.FAILED>
	//   68  154:astore          4
		if(obj != null)
	//*  69  156:aload_2         
	//*  70  157:ifnull          173
	...
	//   71  160:getstatic       #416 <Field AppLinkNavigation$NavigationResult AppLinkNavigation$NavigationResult.APP>
	//   72  163:astore          4
			obj1 = obj;
	//   73  165:aload_2         
	//   74  166:astore_3        
	...
	//   80  177:invokevirtual   #419 <Method Uri AppLink.getWebUrl()>
	//   81  180:astore          5
			if(uri != null)
	//*  82  182:aload           5
	//*  83  184:ifnull          249
	...
	//   84  187:aload_0         
	//   85  188:aload_3         
	//   86  189:invokespecial   #166 <Method JSONObject getJSONForBundle(Bundle)>
	//   87  192:astore_3        
				}
	//*  88  193:new             #374 <Class Intent>
	//*  89  196:dup             
	//*  90  197:ldc2            #376 <String "android.intent.action.VIEW">
	//*  91  200:aload           5
	//*  92  202:invokevirtual   #423 <Method android.net.Uri$Builder Uri.buildUpon()>
	//*  93  205:ldc2            #398 <String "al_applink_data">
	//*  94  208:aload_3         
	//*  95  209:invokevirtual   #424 <Method String JSONObject.toString()>
	//*  96  212:invokevirtual   #430 <Method android.net.Uri$Builder android.net.Uri$Builder.appendQueryParameter(String, String)>
	//*  97  215:invokevirtual   #433 <Method Uri android.net.Uri$Builder.build()>
	//*  98  218:invokespecial   #436 <Method void Intent(String, Uri)>
	//*  99  221:astore_3        
	//* 100  222:getstatic       #439 <Field AppLinkNavigation$NavigationResult AppLinkNavigation$NavigationResult.WEB>
	//* 101  225:astore_2        
	//* 102  226:goto            254
	...
	//  105  231:aload_1         
	//  106  232:aload_2         
	//  107  233:getstatic       #413 <Field AppLinkNavigation$NavigationResult AppLinkNavigation$NavigationResult.FAILED>
	//  108  236:aload_3         
	//  109  237:invokespecial   #441 <Method void sendAppLinkNavigateEventBroadcast(Context, Intent, AppLinkNavigation$NavigationResult, JSONException)>
					throw new RuntimeException(((Throwable) (obj1)));
	//  110  240:new             #443 <Class RuntimeException>
	//  111  243:dup             
	//  112  244:aload_3         
	//  113  245:invokespecial   #446 <Method void RuntimeException(Throwable)>
	//  114  248:athrow          
				}
	...
	//  122  257:aload_2         
	//  123  258:aconst_null     
	//  124  259:invokespecial   #441 <Method void sendAppLinkNavigateEventBroadcast(Context, Intent, AppLinkNavigation$NavigationResult, JSONException)>
		if(obj1 != null)
	//* 125  262:aload_3         
	//* 126  263:ifnull          271
	...
	//  127  266:aload_1         
	//  128  267:aload_3         
	//  129  268:invokevirtual   #450 <Method void Context.startActivity(Intent)>
