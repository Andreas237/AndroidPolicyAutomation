...
static class ObservableGridView$SavedState extends android.view.View.BaseSavedState
{
...
;
	...
	ObservableGridView$SavedState(Parcel parcel, ObservableGridView._cls1 _pcls1)
	{
		this(parcel);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #58  <Method void ObservableGridView$SavedState(Parcel)>
	//    3    5:return          
	}

	ObservableGridView$SavedState(Parcelable parcelable)
	{
		super(parcelable);
	//    0    0:aload_0         
	//    1    1:aload_1         
