...
static class ObservableWebView$SavedState extends android.view.View.BaseSavedState
{
...
;
	...
	ObservableWebView$SavedState(Parcel parcel, ObservableWebView._cls1 _pcls1)
	{
		this(parcel);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #38  <Method void ObservableWebView$SavedState(Parcel)>
	//    3    5:return          
	}

	ObservableWebView$SavedState(Parcelable parcelable)
	{
		super(parcelable);
	//    0    0:aload_0         
	//    1    1:aload_1         
