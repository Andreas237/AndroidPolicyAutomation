...
public static final class Reflector$ActionBarType extends Enum
{

	public static Reflector$ActionBarType valueOf(String s)
	{
		return (Reflector$ActionBarType)Enum.valueOf(com/github/amlcurran/showcaseview/targets/Reflector$ActionBarType, s);
	...
	public static Reflector$ActionBarType[] values()
	{
		return (Reflector$ActionBarType[])((Reflector$ActionBarType []) ($VALUES)).clone();
	...
	private static final Reflector$ActionBarType $VALUES[];
	public static final Reflector$ActionBarType ACTIONBAR_SHERLOCK;
	public static final Reflector$ActionBarType APP_COMPAT;
	public static final Reflector$ActionBarType STANDARD;

	static 
	{
		STANDARD = new Reflector$ActionBarType("STANDARD", 0);
	...
	//    5   10:putstatic       #23  <Field Reflector$ActionBarType STANDARD>
		APP_COMPAT = new Reflector$ActionBarType("APP_COMPAT", 1);
	...
	//   11   23:putstatic       #26  <Field Reflector$ActionBarType APP_COMPAT>
		ACTIONBAR_SHERLOCK = new Reflector$ActionBarType("ACTIONBAR_SHERLOCK", 2);
	...
	//   17   36:putstatic       #29  <Field Reflector$ActionBarType ACTIONBAR_SHERLOCK>
		$VALUES = (new Reflector$ActionBarType[] {
			STANDARD, APP_COMPAT, ACTIONBAR_SHERLOCK
		});
	//   18   39:iconst_3        
	//   19   40:anewarray       Reflector$ActionBarType[]
	//   20   43:dup             
	//   21   44:iconst_0        
	...
	private Reflector$ActionBarType(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
