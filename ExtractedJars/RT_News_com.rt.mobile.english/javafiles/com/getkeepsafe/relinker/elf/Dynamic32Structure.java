...
public class Dynamic32Structure extends Elf.DynamicStructure
{
	...
	public Dynamic32Structure(ElfParser elfparser, Elf.Header header, long l, int i)
		throws IOException
	{
	//    0    0:aload_0         
	...
	//   22   42:ladd            
	//   23   43:lstore_3        
		tag = elfparser.readWord(bytebuffer, l);
	//   24   44:aload_0         
	//   25   45:aload_1         
	//   26   46:aload           6
	//   27   48:lload_3         
	//   28   49:invokevirtual   #42  <Method long ElfParser.readWord(ByteBuffer, long)>
	//   29   52:putfield        #46  <Field long tag>
		val = elfparser.readWord(bytebuffer, l + 4L);
	//   30   55:aload_0         
	//   31   56:aload_1         
	//   32   57:aload           6
	//   33   59:lload_3         
	//   34   60:ldc2w           #47  <Long 4L>
	//   35   63:ladd            
	//   36   64:invokevirtual   #42  <Method long ElfParser.readWord(ByteBuffer, long)>
