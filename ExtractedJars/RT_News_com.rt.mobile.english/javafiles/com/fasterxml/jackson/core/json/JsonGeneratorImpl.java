...
public abstract class JsonGeneratorImpl extends GeneratorBase
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #137 <Method JsonGenerator GeneratorBase.enable(com.fasterxml.jackson.core.JsonGenerator$Feature)>
	//    3    5:pop             
		if(feature == com.fasterxml.jackson.core.JsonGenerator.Feature.QUOTE_FIELD_NAMES)
	//*   4    6:aload_1         
	//*   5    7:getstatic       #60  <Field com.fasterxml.jackson.core.JsonGenerator$Feature com.fasterxml.jackson.core.JsonGenerator$Feature.QUOTE_FIELD_NAMES>
	...
	//    0    0:aload_0         
	//    1    1:getfield        #141 <Field CharacterEscapes _characterEscapes>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #141 <Field CharacterEscapes _characterEscapes>
	...
	//   10   18:aload_0         
	//   11   19:aload_1         
	//   12   20:invokevirtual   #150 <Method int[] CharacterEscapes.getEscapeCodesForAscii()>
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #160 <Method Class Object.getClass()>
	//    2    4:invokestatic    #166 <Method Version VersionUtil.versionFor(Class)>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #171 <Method void writeFieldName(String)>
		writeString(s1);
	//    3    5:aload_0         
	//    4    6:aload_2         
	//    5    7:invokevirtual   #174 <Method void writeString(String)>
	//    6   10:return          
	}
