	...
	implements PrettyPrinter, Instantiatable, Serializable
{
	...
	//    5    9:new             #39  <Class SerializedString>
	//    6   12:dup             
	//    7   13:aload_1         
	//    8   14:invokespecial   #45  <Method void SerializedString(String)>
	//    9   17:astore_1        
		this(((SerializableString) (s)));
	//   10   18:aload_0         
	//   11   19:aload_1         
	//   12   20:invokespecial   #51  <Method void DefaultPrettyPrinter(SerializableString)>
	//   13   23:return          
	}
	...
	//*   3    5:if_acmpeq       35
		{
			if(serializablestring != null && ((Object) (serializablestring)).equals(((Object) (_rootSeparator))))
	//*   4    8:aload_1         
	//*   5    9:ifnull          25
	//*   6   12:aload_1         
	//*   7   13:aload_0         
	...
	//   10   18:aload_0         
	//   11   19:aload_1         
	//   12   20:invokevirtual   #118 <Method DefaultPrettyPrinter withRootSeparator(SerializableString)>
	//   13   23:areturn         
	}
	...
	//   19   43:aload_1         
	//   20   44:bipush          32
	//   21   46:invokevirtual   #129 <Method void JsonGenerator.writeRaw(char)>
		jsongenerator.writeRaw(']');
	//   22   49:aload_1         
	//   23   50:bipush          93
	//   24   52:invokevirtual   #129 <Method void JsonGenerator.writeRaw(char)>
	//   25   55:return          
	}
