...
public class BufferRecycler
{
	...
	//*  22   38:goto            51
		{
			_byteBuffers[i] = null;
	//   23   41:aload_0         
	//   24   42:getfield        #41  <Field byte[][] _byteBuffers>
	//   25   45:iload_1         
	//   26   46:aconst_null     
	//   27   47:aastore         
			return abyte0;
	...
	//   30   51:aload_0         
	//   31   52:iload_3         
	//   32   53:invokevirtual   #57  <Method byte[] balloc(int)>
	//   33   56:areturn         
		}
	}
	...
	//*  22   38:goto            51
		{
			_charBuffers[i] = null;
	//   23   41:aload_0         
	//   24   42:getfield        #45  <Field char[][] _charBuffers>
	//   25   45:iload_1         
	//   26   46:aconst_null     
	//   27   47:aastore         
			return ac;
	...
	//   30   51:aload_0         
	//   31   52:iload_3         
	//   32   53:invokevirtual   #68  <Method char[] calloc(int)>
	//   33   56:areturn         
		}
	}
