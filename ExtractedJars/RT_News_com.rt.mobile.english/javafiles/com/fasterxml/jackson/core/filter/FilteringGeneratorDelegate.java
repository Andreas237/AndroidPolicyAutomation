...
public class FilteringGeneratorDelegate extends JsonGeneratorDelegate
{
	...
	//*  15   31:aload_0         
	//*  16   32:getfield        #71  <Field boolean _includeImmediateParent>
	//*  17   35:ifeq            49
			_filterContext.writeImmediatePath(_flddelegate);
	//   18   38:aload_0         
	//   19   39:getfield        #33  <Field TokenFilterContext _filterContext>
	//   20   42:aload_0         
	//   21   43:getfield        #61  <Field JsonGenerator _flddelegate>
	//   22   46:invokevirtual   #74  <Method void TokenFilterContext.writeImmediatePath(JsonGenerator)>
		if(!_allowMultipleMatches)
	//*  23   49:aload_0         
	//*  24   50:getfield        #37  <Field boolean _allowMultipleMatches>
	//*  25   53:ifne            63
			_filterContext.skipParentChecks();
	//   26   56:aload_0         
	//   27   57:getfield        #33  <Field TokenFilterContext _filterContext>
	//   28   60:invokevirtual   #68  <Method void TokenFilterContext.skipParentChecks()>
	//   29   63:return          
	}
	...
	//*  15   31:ifnonnull       35
				return;
	//   16   34:return          
			if(tokenfilter != TokenFilter.INCLUDE_ALL && !tokenfilter.includeBoolean(flag))
	//*  17   35:aload_2         
	//*  18   36:getstatic       #47  <Field TokenFilter TokenFilter.INCLUDE_ALL>
	//*  19   39:if_acmpeq       51
	//*  20   42:aload_2         
	//*  21   43:iload_1         
	//*  22   44:invokevirtual   #106 <Method boolean TokenFilter.includeBoolean(boolean)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	//   25   51:aload_0         
	//   26   52:invokevirtual   #54  <Method void _checkParentPath()>
		}
		_flddelegate.writeBoolean(flag);
	//   27   55:aload_0         
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:iload_1         
	//   30   60:invokevirtual   #108 <Method void JsonGenerator.writeBoolean(boolean)>
	//   31   63:return          
	}
	...
	//*  19   39:if_acmpeq       50
	//*  20   42:aload_1         
	//*  21   43:invokevirtual   #145 <Method boolean TokenFilter.includeNull()>
	//*  22   46:ifne            50
				return;
	//   23   49:return          
			_checkParentPath();
	//   24   50:aload_0         
	//   25   51:invokevirtual   #54  <Method void _checkParentPath()>
		}
		_flddelegate.writeNull();
	//   26   54:aload_0         
	//   27   55:getfield        #61  <Field JsonGenerator _flddelegate>
	//   28   58:invokevirtual   #147 <Method void JsonGenerator.writeNull()>
	//   29   61:return          
	}
	...
	//*  20   42:aload_3         
	//*  21   43:dload_1         
	//*  22   44:invokevirtual   #153 <Method boolean TokenFilter.includeNumber(double)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:dload_1         
	//   30   60:invokevirtual   #155 <Method void JsonGenerator.writeNumber(double)>
	//   31   63:return          
	}
	...
	//*  20   42:aload_2         
	//*  21   43:fload_1         
	//*  22   44:invokevirtual   #159 <Method boolean TokenFilter.includeNumber(float)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:fload_1         
	//   30   60:invokevirtual   #161 <Method void JsonGenerator.writeNumber(float)>
	//   31   63:return          
	}
	...
	//*  15   31:ifnonnull       35
				return;
	//   16   34:return          
			if(tokenfilter != TokenFilter.INCLUDE_ALL && !tokenfilter.includeNumber(i))
	//*  17   35:aload_2         
	//*  18   36:getstatic       #47  <Field TokenFilter TokenFilter.INCLUDE_ALL>
	//*  19   39:if_acmpeq       51
	//*  20   42:aload_2         
	//*  21   43:iload_1         
	//*  22   44:invokevirtual   #165 <Method boolean TokenFilter.includeNumber(int)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:iload_1         
	//   30   60:invokevirtual   #167 <Method void JsonGenerator.writeNumber(int)>
	//   31   63:return          
	}
	...
	//*  20   42:aload_3         
	//*  21   43:lload_1         
	//*  22   44:invokevirtual   #171 <Method boolean TokenFilter.includeNumber(long)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:lload_1         
	//   30   60:invokevirtual   #173 <Method void JsonGenerator.writeNumber(long)>
	//   31   63:return          
	}
	...
	//*  19   39:if_acmpeq       50
	//*  20   42:aload_2         
	//*  21   43:invokevirtual   #78  <Method boolean TokenFilter.includeRawValue()>
	//*  22   46:ifne            50
				return;
	//   23   49:return          
			_checkParentPath();
	...
	//   27   55:getfield        #61  <Field JsonGenerator _flddelegate>
	//   28   58:aload_1         
	//   29   59:invokevirtual   #177 <Method void JsonGenerator.writeNumber(String)>
	//   30   62:return          
	}
	...
	//*  20   42:aload_2         
	//*  21   43:aload_1         
	//*  22   44:invokevirtual   #181 <Method boolean TokenFilter.includeNumber(BigDecimal)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:aload_1         
	//   30   60:invokevirtual   #183 <Method void JsonGenerator.writeNumber(BigDecimal)>
	//   31   63:return          
	}
	...
	//*  20   42:aload_2         
	//*  21   43:aload_1         
	//*  22   44:invokevirtual   #187 <Method boolean TokenFilter.includeNumber(BigInteger)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:aload_1         
	//   30   60:invokevirtual   #189 <Method void JsonGenerator.writeNumber(BigInteger)>
	//   31   63:return          
	}
	...
	//*  15   31:ifnonnull       35
				return;
	//   16   34:return          
			if(tokenfilter != TokenFilter.INCLUDE_ALL && !tokenfilter.includeNumber(((int) (word0))))
	//*  17   35:aload_2         
	//*  18   36:getstatic       #47  <Field TokenFilter TokenFilter.INCLUDE_ALL>
	//*  19   39:if_acmpeq       51
	//*  20   42:aload_2         
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:iload_1         
	//   30   60:invokevirtual   #192 <Method void JsonGenerator.writeNumber(short)>
	//   31   63:return          
	}
	...
	//*  39   77:aload_2         
	//*  40   78:getstatic       #47  <Field TokenFilter TokenFilter.INCLUDE_ALL>
	//*  41   81:if_acmpeq       89
			tokenfilter = tokenfilter1.filterStartObject();
	//   42   84:aload_2         
	//   43   85:invokevirtual   #244 <Method TokenFilter TokenFilter.filterStartObject()>
	//   44   88:astore_1        
		if(tokenfilter == TokenFilter.INCLUDE_ALL)
	//*  45   89:aload_1         
	//*  46   90:getstatic       #47  <Field TokenFilter TokenFilter.INCLUDE_ALL>
	//*  47   93:if_acmpne       121
		{
			_checkParentPath();
	//   48   96:aload_0         
	//   49   97:invokevirtual   #54  <Method void _checkParentPath()>
			_filterContext = _filterContext.createChildObjectContext(tokenfilter, true);
	//   50  100:aload_0         
	//   51  101:aload_0         
	//   52  102:getfield        #33  <Field TokenFilterContext _filterContext>
	//   53  105:aload_1         
	//   54  106:iconst_1        
	//   55  107:invokevirtual   #239 <Method TokenFilterContext TokenFilterContext.createChildObjectContext(TokenFilter, boolean)>
	//   56  110:putfield        #33  <Field TokenFilterContext _filterContext>
			_flddelegate.writeStartObject();
	//   57  113:aload_0         
	//   58  114:getfield        #61  <Field JsonGenerator _flddelegate>
	//   59  117:invokevirtual   #241 <Method void JsonGenerator.writeStartObject()>
			return;
	//   60  120:return          
		} else
		{
	...
	//   61  121:aload_0         
	//   62  122:aload_0         
	//   63  123:getfield        #33  <Field TokenFilterContext _filterContext>
	//   64  126:aload_1         
	//   65  127:iconst_0        
	//   66  128:invokevirtual   #239 <Method TokenFilterContext TokenFilterContext.createChildObjectContext(TokenFilter, boolean)>
	//   67  131:putfield        #33  <Field TokenFilterContext _filterContext>
			return;
	//   68  134:return          
		}
	}
	...
	//*  20   42:aload_2         
	//*  21   43:aload_1         
	//*  22   44:invokeinterface #127 <Method String SerializableString.getValue()>
	//*  23   49:invokevirtual   #249 <Method boolean TokenFilter.includeString(String)>
	//*  24   52:ifne            56
				return;
	//   25   55:return          
			_checkParentPath();
	//   26   56:aload_0         
	//   27   57:invokevirtual   #54  <Method void _checkParentPath()>
		}
		_flddelegate.writeString(serializablestring);
	//   28   60:aload_0         
	//   29   61:getfield        #61  <Field JsonGenerator _flddelegate>
	//   30   64:aload_1         
	//   31   65:invokevirtual   #251 <Method void JsonGenerator.writeString(SerializableString)>
	//   32   68:return          
	}
	...
	//*  15   31:ifnonnull       35
				return;
	//   16   34:return          
			if(tokenfilter != TokenFilter.INCLUDE_ALL && !tokenfilter.includeString(s))
	//*  17   35:aload_2         
	//*  18   36:getstatic       #47  <Field TokenFilter TokenFilter.INCLUDE_ALL>
	//*  19   39:if_acmpeq       51
	//*  20   42:aload_2         
	//*  21   43:aload_1         
	//*  22   44:invokevirtual   #249 <Method boolean TokenFilter.includeString(String)>
	//*  23   47:ifne            51
				return;
	//   24   50:return          
			_checkParentPath();
	...
	//   28   56:getfield        #61  <Field JsonGenerator _flddelegate>
	//   29   59:aload_1         
	//   30   60:invokevirtual   #253 <Method void JsonGenerator.writeString(String)>
	//   31   63:return          
	}
	...
	//   23   48:return          
			if(tokenfilter != TokenFilter.INCLUDE_ALL && !tokenfilter.includeString(s))
	//*  24   49:aload           5
	//*  25   51:getstatic       #47  <Field TokenFilter TokenFilter.INCLUDE_ALL>
	//*  26   54:if_acmpeq       68
	//*  27   57:aload           5
	//*  28   59:aload           4
	//*  29   61:invokevirtual   #249 <Method boolean TokenFilter.includeString(String)>
	//*  30   64:ifne            68
				return;
	//   31   67:return          
			_checkParentPath();
	//   32   68:aload_0         
	//   33   69:invokevirtual   #54  <Method void _checkParentPath()>
		}
		_flddelegate.writeString(ac, i, j);
	//   34   72:aload_0         
	//   35   73:getfield        #61  <Field JsonGenerator _flddelegate>
	//   36   76:aload_1         
	//   37   77:iload_2         
	//   38   78:iload_3         
	//   39   79:invokevirtual   #259 <Method void JsonGenerator.writeString(char[], int, int)>
	//   40   82:return          
	}
	...
	//    6   12:iload_2         
	//    7   13:iload_3         
	//    8   14:invokevirtual   #265 <Method void JsonGenerator.writeUTF8String(byte[], int, int)>
	//    9   17:return          
	}
