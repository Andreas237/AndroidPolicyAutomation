...
public final class AdSize
{
	...
	//   17   33:astore          4
		StringBuilder stringbuilder = new StringBuilder(4 + String.valueOf(((Object) (s))).length() + String.valueOf(((Object) (s1))).length());
	//   18   35:new             #85  <Class StringBuilder>
	//   19   38:dup             
	//   20   39:iconst_4        
	//   21   40:aload_3         
	//   22   41:invokestatic    #88  <Method String String.valueOf(Object)>
	//   23   44:invokevirtual   #92  <Method int String.length()>
	//   24   47:iadd            
	//   25   48:aload           4
	...
	//   10   19:new             #85  <Class StringBuilder>
	//   11   22:dup             
	//   12   23:bipush          37
	//   13   25:invokespecial   #95  <Method void StringBuilder(int)>
	//   14   28:astore_3        
			((StringBuilder) (s)).append("Invalid width for AdSize: ");
	//   15   29:aload_3         
	//   16   30:ldc1            #111 <String "Invalid width for AdSize: ">
	//   17   32:invokevirtual   #99  <Method StringBuilder StringBuilder.append(String)>
	//   18   35:pop             
			((StringBuilder) (s)).append(i);
	//   19   36:aload_3         
	//   20   37:iload_1         
	//   21   38:invokevirtual   #114 <Method StringBuilder StringBuilder.append(int)>
	//   22   41:pop             
			throw new IllegalArgumentException(((StringBuilder) (s)).toString());
	//   23   42:new             #116 <Class IllegalArgumentException>
	//   24   45:dup             
	//   25   46:aload_3         
	//   26   47:invokevirtual   #107 <Method String StringBuilder.toString()>
	//   27   50:invokespecial   #119 <Method void IllegalArgumentException(String)>
	//   28   53:athrow          
		}
		if(j < 0 && j != -2 && j != -4)
	//*  29   54:iload_2         
	...
	//   37   70:new             #85  <Class StringBuilder>
	//   38   73:dup             
	//   39   74:bipush          38
	//   40   76:invokespecial   #95  <Method void StringBuilder(int)>
	//   41   79:astore_3        
			((StringBuilder) (s)).append("Invalid height for AdSize: ");
	//   42   80:aload_3         
	//   43   81:ldc1            #121 <String "Invalid height for AdSize: ">
	//   44   83:invokevirtual   #99  <Method StringBuilder StringBuilder.append(String)>
	//   45   86:pop             
			((StringBuilder) (s)).append(j);
	//   46   87:aload_3         
	//   47   88:iload_2         
	//   48   89:invokevirtual   #114 <Method StringBuilder StringBuilder.append(int)>
	//   49   92:pop             
			throw new IllegalArgumentException(((StringBuilder) (s)).toString());
	//   50   93:new             #116 <Class IllegalArgumentException>
	//   51   96:dup             
	//   52   97:aload_3         
	//   53   98:invokevirtual   #107 <Method String StringBuilder.toString()>
	//   54  101:invokespecial   #119 <Method void IllegalArgumentException(String)>
	//   55  104:athrow          
		} else
		{
			zzuq = i;
	//   56  105:aload_0         
	//   57  106:iload_1         
	//   58  107:putfield        #123 <Field int zzuq>
			zzur = j;
	//   59  110:aload_0         
	//   60  111:iload_2         
	//   61  112:putfield        #125 <Field int zzur>
			zzus = s;
	//   62  115:aload_0         
	//   63  116:aload_3         
	//   64  117:putfield        #127 <Field String zzus>
			return;
	//   65  120:return          
		}
	}
