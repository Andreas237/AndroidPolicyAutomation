...
public final class zzak extends zzko
{
	...
	//    3    7:new             #91  <Class IllegalArgumentException>
	//    4   10:dup             
	//    5   11:ldc1            #93  <String "Custom template ID for native custom template ad is empty. Please provide a valid template id.">
	//    6   13:invokespecial   #96  <Method void IllegalArgumentException(String)>
	//    7   16:athrow          
		} else
		{
			zzyo.put(((Object) (s)), ((Object) (zzrf)));
	//    8   17:aload_0         
	//    9   18:getfield        #56  <Field SimpleArrayMap zzyo>
	//   10   21:aload_1         
	//   11   22:aload_2         
	//   12   23:invokevirtual   #100 <Method Object SimpleArrayMap.put(Object, Object)>
	//   13   26:pop             
			zzyn.put(((Object) (s)), ((Object) (zzrc)));
	//   14   27:aload_0         
	//   15   28:getfield        #58  <Field SimpleArrayMap zzyn>
	//   16   31:aload_1         
	//   17   32:aload_3         
	//   18   33:invokevirtual   #100 <Method Object SimpleArrayMap.put(Object, Object)>
	//   19   36:pop             
			return;
	//   20   37:return          
		}
