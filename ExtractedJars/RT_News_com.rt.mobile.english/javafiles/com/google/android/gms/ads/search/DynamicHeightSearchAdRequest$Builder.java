...
public static final class DynamicHeightSearchAdRequest$Builder
{
	...
	static SearchAdRequest.Builder zza(DynamicHeightSearchAdRequest$Builder dynamicheightsearchadrequest$builder)
	{
		return dynamicheightsearchadrequest$builder.zzdgx;
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field SearchAdRequest$Builder zzdgx>
	//    2    4:areturn         
	}

	public final DynamicHeightSearchAdRequest$Builder addCustomEventExtrasBundle(Class class1, Bundle bundle)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder addNetworkExtrasBundle(Class class1, Bundle bundle)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setAdBorderSelectors(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setAdTest(boolean flag)
	{
		Bundle bundle = zzdgy;
	//    0    0:aload_0         
	//    1    1:getfield        #25  <Field Bundle zzdgy>
	...
	public final DynamicHeightSearchAdRequest$Builder setAdvancedOptionValue(String s, String s1)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setBorderSelections(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setChannel(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorAdBorder(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorAdSeparator(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorAnnotation(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorAttribution(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorBackground(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorBorder(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorDomainLink(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorText(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setColorTitleLink(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setDetailedAttribution(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setFontFamily(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setFontFamilyAttribution(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setHostLanguage(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setIsClickToCallEnabled(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setIsLocationEnabled(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setIsPlusOnesEnabled(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setIsSellerRatingsEnabled(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setIsSiteLinksEnabled(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setIsTitleBold(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setIsTitleUnderlined(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setLocationColor(String s)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setLongerHeadlines(boolean flag)
	{
	...
	public final DynamicHeightSearchAdRequest$Builder setQuery(String s)
	{
		zzdgx.setQuery(s);
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field SearchAdRequest$Builder zzdgx>
