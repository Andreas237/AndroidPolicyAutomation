...
public abstract class DeferredLifecycleHelper
{
	...
	//    2    4:aload_0         
	//    3    5:new             #25  <Class zza>
	//    4    8:dup             
	//    5    9:aload_0         
	//    6   10:invokespecial   #28  <Method void zza(DeferredLifecycleHelper)>
	//    7   13:putfield        #30  <Field OnDelegateCreatedListener zzabf>
	//    8   16:return          
	}
	...
	//    0    0:invokestatic    #39  <Method GoogleApiAvailability GoogleApiAvailability.getInstance()>
	//    1    3:astore          5
		android.content.Context context = framelayout.getContext();
	//    2    5:aload_0         
	//    3    6:invokevirtual   #45  <Method android.content.Context FrameLayout.getContext()>
	//    4    9:astore_2        
		int i = ((GoogleApiAvailabilityLight) (googleapiavailability)).isGooglePlayServicesAvailable(context);
	//    5   10:aload           5
	//    6   12:aload_2         
	//    7   13:invokevirtual   #51  <Method int GoogleApiAvailabilityLight.isGooglePlayServicesAvailable(android.content.Context)>
	//    8   16:istore_1        
	...
	//   18   33:dup             
	//   19   34:aload_0         
	//   20   35:invokevirtual   #45  <Method android.content.Context FrameLayout.getContext()>
	...
	//   37   74:dup             
	//   38   75:aload_0         
	//   39   76:invokevirtual   #45  <Method android.content.Context FrameLayout.getContext()>
	...
	//   54  107:invokevirtual   #91  <Method void LinearLayout.addView(View)>
		framelayout = ((FrameLayout) (((GoogleApiAvailabilityLight) (googleapiavailability)).getErrorResolutionIntent(context, i, ((String) (null)))));
	//   55  110:aload           5
	//   56  112:aload_2         
	//   57  113:iload_1         
	//   58  114:aconst_null     
	//   59  115:invokevirtual   #95  <Method android.content.Intent GoogleApiAvailabilityLight.getErrorResolutionIntent(android.content.Context, int, String)>
	//   60  118:astore_0        
		if(framelayout != null)
	//*  61  119:aload_0         
	//*  62  120:ifnull          183
	...
	//   83  166:invokevirtual   #91  <Method void LinearLayout.addView(View)>
			button.setOnClickListener(((android.view.View.OnClickListener) (new zze(context, ((android.content.Intent) (framelayout))))));
	//   84  169:aload           5
	//   85  171:new             #106 <Class zze>
	//   86  174:dup             
	//   87  175:aload_2         
	//   88  176:aload_0         
	//   89  177:invokespecial   #109 <Method void zze(android.content.Context, android.content.Intent)>
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:putfield        #116 <Field Bundle zzabd>
		return null;
	//    3    5:aconst_null     
	//    4    6:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #119 <Field LifecycleDelegate zzabc>
	...
	//    0    0:aload_0         
	//    1    1:getfield        #122 <Field LinkedList zzabe>
	//    2    4:areturn         
	}
	...
	private final void zza(Bundle bundle, zza zza1)
	{
		if(zzabc != null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #119 <Field LifecycleDelegate zzabc>
	//*   2    4:ifnull          18
		{
			zza1.zza(zzabc);
	//    3    7:aload_2         
	//    4    8:aload_0         
	//    5    9:getfield        #119 <Field LifecycleDelegate zzabc>
	//    6   12:invokeinterface #126 <Method void DeferredLifecycleHelper$zza.zza(LifecycleDelegate)>
			return;
	//    7   17:return          
		}
		if(zzabe == null)
	//*   8   18:aload_0         
	//*   9   19:getfield        #122 <Field LinkedList zzabe>
	//*  10   22:ifnonnull       36
	...
	//   15   33:putfield        #122 <Field LinkedList zzabe>
		zzabe.add(((Object) (zza1)));
	//   16   36:aload_0         
	//   17   37:getfield        #122 <Field LinkedList zzabe>
	//   18   40:aload_2         
	...
	//*  22   46:ifnull          78
			if(zzabd == null)
	//*  23   49:aload_0         
	//*  24   50:getfield        #116 <Field Bundle zzabd>
	//*  25   53:ifnonnull       70
	...
	//   30   64:putfield        #116 <Field Bundle zzabd>
			else
	//*  31   67:goto            78
				zzabd.putAll(bundle);
	//   32   70:aload_0         
	//   33   71:getfield        #116 <Field Bundle zzabd>
	//   34   74:aload_1         
	//   35   75:invokevirtual   #143 <Method void Bundle.putAll(Bundle)>
		createDelegate(zzabf);
	//   36   78:aload_0         
	//   37   79:aload_0         
	//   38   80:getfield        #30  <Field OnDelegateCreatedListener zzabf>
	...
	//    3    7:ifne            40
	//    4   10:aload_0         
	//    5   11:getfield        #122 <Field LinkedList zzabe>
	//    6   14:invokevirtual   #157 <Method Object LinkedList.getLast()>
	//    7   17:checkcast       #7   <Class DeferredLifecycleHelper$zza>
	//    8   20:invokeinterface #161 <Method int DeferredLifecycleHelper$zza.getState()>
	//    9   25:iload_1         
	//   10   26:icmplt          40
	//   11   29:aload_0         
	//   12   30:getfield        #122 <Field LinkedList zzabe>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:new             #174 <Class zzc>
	//    3    5:dup             
	//    4    6:aload_0         
	//    5    7:aload_1         
	//    6    8:invokespecial   #177 <Method void zzc(DeferredLifecycleHelper, Bundle)>
	//    7   11:invokespecial   #179 <Method void zza(Bundle, DeferredLifecycleHelper$zza)>
	//    8   14:return          
	}
	...
	//   13   23:aload_2         
	//   14   24:aload_3         
	//   15   25:invokespecial   #190 <Method void zzd(DeferredLifecycleHelper, FrameLayout, LayoutInflater, ViewGroup, Bundle)>
	//   16   28:invokespecial   #179 <Method void zza(Bundle, DeferredLifecycleHelper$zza)>
		if(zzabc == null)
	//*  17   31:aload_0         
	//*  18   32:getfield        #119 <Field LifecycleDelegate zzabc>
	//*  19   35:ifnonnull       44
	...
	//*   2    4:ifnull          17
		{
			zzabc.onDestroy();
	//    3    7:aload_0         
	//    4    8:getfield        #119 <Field LifecycleDelegate zzabc>
	...
	//    7   17:aload_0         
	//    8   18:iconst_1        
	//    9   19:invokespecial   #199 <Method void zzm(int)>
			return;
	//   10   22:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_3         
	//    2    2:new             #206 <Class zzb>
	//    3    5:dup             
	//    4    6:aload_0         
	//    5    7:aload_1         
	//    6    8:aload_2         
	//    7    9:aload_3         
	//    8   10:invokespecial   #209 <Method void zzb(DeferredLifecycleHelper, Activity, Bundle, Bundle)>
	//    9   13:invokespecial   #179 <Method void zza(Bundle, DeferredLifecycleHelper$zza)>
	//   10   16:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:new             #218 <Class zzg>
	//    3    5:dup             
	//    4    6:aload_0         
	//    5    7:invokespecial   #219 <Method void zzg(DeferredLifecycleHelper)>
	//    6   10:invokespecial   #179 <Method void zza(Bundle, DeferredLifecycleHelper$zza)>
	//    7   13:return          
	}
	...
	//*   2    4:ifnull          18
		{
			zzabc.onSaveInstanceState(bundle);
	//    3    7:aload_0         
	//    4    8:getfield        #119 <Field LifecycleDelegate zzabc>
	//    5   11:aload_1         
	...
	//    7   17:return          
		...
		if(zzabd != null)
	//*   8   18:aload_0         
	//*   9   19:getfield        #116 <Field Bundle zzabd>
	//*  10   22:ifnull          33
			bundle.putAll(zzabd);
	//   11   25:aload_1         
	//   12   26:aload_0         
	//   13   27:getfield        #116 <Field Bundle zzabd>
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:new             #225 <Class zzf>
	//    3    5:dup             
	//    4    6:aload_0         
	//    5    7:invokespecial   #226 <Method void zzf(DeferredLifecycleHelper)>
	//    6   10:invokespecial   #179 <Method void zza(Bundle, DeferredLifecycleHelper$zza)>
	//    7   13:return          
	}
