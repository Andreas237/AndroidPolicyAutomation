...
//			zzbfc, zzbez, zzis, zzia, 
//			zzbfa, zzbfi

public final class zzin extends zzbfc
{
	...
	//    2    4:aload_0         
	//    3    5:aconst_null     
	//    4    6:putfield        #15  <Field Integer zzany>
		zzanz = null;
	//    5    9:aload_0         
	//    6   10:aconst_null     
	//    7   11:putfield        #17  <Field zzis zzanz>
		zzebk = null;
	//    8   14:aload_0         
	//    9   15:aconst_null     
	...
	private final zzin zzp(zzbez zzbez1)
		throws IOException
	{
	...
	//   17   31:areturn         
				} else
				{
					if(zzanz == null)
	//*  18   32:aload_0         
	//*  19   33:getfield        #17  <Field zzis zzanz>
	//*  20   36:ifnonnull       50
						zzanz = new zzis();
	//   21   39:aload_0         
	//   22   40:new             #44  <Class zzis>
	//   23   43:dup             
	//   24   44:invokespecial   #45  <Method void zzis()>
	//   25   47:putfield        #17  <Field zzis zzanz>
					zzbez1.zza(((zzbfi) (zzanz)));
	//   26   50:aload_1         
	//   27   51:aload_0         
	//   28   52:getfield        #17  <Field zzis zzanz>
	...
	//   33   65:istore_3        
				try
				{
					zzany = Integer.valueOf(zzia.zzd(zzbez1.zzacc()));
	//   34   66:aload_0         
	//   35   67:aload_1         
	...
	//   39   77:putfield        #15  <Field Integer zzany>
				}
	//*  40   80:goto            0
	//*  41   83:aload_1         
	//*  42   84:iload_3         
	...
	public final zzbfi zza(zzbez zzbez1)
		throws IOException
	{
		return ((zzbfi) (zzp(zzbez1)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #74  <Method zzin zzp(zzbez)>
	//    3    5:areturn         
	}
		...
		throws IOException
	{
		if(zzany != null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #15  <Field Integer zzany>
	//*   2    4:ifnull          19
			zzbfa1.zzm(1, zzany.intValue());
	//    3    7:aload_1         
	//    4    8:iconst_1        
	//    5    9:aload_0         
	//    6   10:getfield        #15  <Field Integer zzany>
	//    7   13:invokevirtual   #78  <Method int Integer.intValue()>
	//    8   16:invokevirtual   #84  <Method void zzbfa.zzm(int, int)>
		if(zzanz != null)
	//*   9   19:aload_0         
	//*  10   20:getfield        #17  <Field zzis zzanz>
	//*  11   23:ifnull          35
			zzbfa1.zza(2, ((zzbfi) (zzanz)));
	//   12   26:aload_1         
	//   13   27:iconst_2        
	//   14   28:aload_0         
	//   15   29:getfield        #17  <Field zzis zzanz>
	...
	//    4    6:istore_1        
		if(zzany != null)
	//*   5    7:aload_0         
	//*   6    8:getfield        #15  <Field Integer zzany>
	//*   7   11:ifnull          28
			i = j + zzbfa.zzq(1, zzany.intValue());
	//    8   14:iload_2         
	//    9   15:iconst_1        
	//   10   16:aload_0         
	//   11   17:getfield        #15  <Field Integer zzany>
	...
	//   17   29:istore_2        
		if(zzanz != null)
	//*  18   30:aload_0         
	//*  19   31:getfield        #17  <Field zzis zzanz>
	//*  20   34:ifnull          48
			j = i + zzbfa.zzb(2, ((zzbfi) (zzanz)));
	//   21   37:iload_1         
	//   22   38:iconst_2        
	//   23   39:aload_0         
	//   24   40:getfield        #17  <Field zzis zzanz>
