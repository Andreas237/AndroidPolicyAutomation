	...
	implements Runnable
{
	...
	zzasl(zzasj zzasj1, View view, zzait zzait, int i)
	{
		zzdes = zzasj1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #18  <Field zzasj zzdes>
		val$view = view;
	//    3    5:aload_0         
	//    4    6:aload_2         
	...
	{
		zzasj.zza(zzdes, val$view, zzdcg, zzdch - 1);
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field zzasj zzdes>
	//    2    4:aload_0         
	...
	//    8   16:iconst_1        
	//    9   17:isub            
	//   10   18:invokestatic    #34  <Method void zzasj.zza(zzasj, View, zzait, int)>
	//   11   21:return          
	}
