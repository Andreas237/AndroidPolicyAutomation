...
final class zzbak extends zzbao
{
	...
	zzbak(byte abyte0[], int i, int j)
	{
		super(abyte0);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #12  <Method void zzbao(byte[])>
		zzd(i, i + j, abyte0.length);
	//    3    5:iload_2         
	//    4    6:iload_2         
	//    5    7:iload_3         
	//    6    8:iadd            
	//    7    9:aload_1         
	//    8   10:arraylength     
	//    9   11:invokestatic    #16  <Method int zzd(int, int, int)>
	//   10   14:pop             
		zzdpt = i;
	//   11   15:aload_0         
	//   12   16:iload_2         
	//   13   17:putfield        #18  <Field int zzdpt>
		zzdpu = j;
	//   14   20:aload_0         
	//   15   21:iload_3         
	//   16   22:putfield        #20  <Field int zzdpu>
	//   17   25:return          
	}
	...
	public final int size()
	{
		return zzdpu;
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field int zzdpu>
	//    2    4:ireturn         
	}

	protected final void zza(byte abyte0[], int i, int j, int k)
	{
		System.arraycopy(((Object) (zzdpw)), ((zzbao)this).zzabh(), ((Object) (abyte0)), 0, k);
	//    0    0:aload_0         
	//    1    1:getfield        #29  <Field byte[] zzdpw>
	//    2    4:aload_0         
	//    3    5:invokevirtual   #32  <Method int zzbao.zzabh()>
	//    4    8:aload_1         
	//    5    9:iconst_0        
	//    6   10:iload           4
	...
	protected final int zzabh()
	{
		return zzdpt;
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field int zzdpt>
	//    2    4:ireturn         
	}

	public final byte zzbn(int i)
	{
		int j = ((zzbah)this).size();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #44  <Method int zzbah.size()>
	//    2    4:istore_2        
		if((j - (i + 1) | i) < 0)
	//*   3    5:iload_2         
	//*   4    6:iload_1         
	...
	//   58  101:athrow          
		...
		{
			return zzdpw[zzdpt + i];
	//   59  102:aload_0         
	//   60  103:getfield        #29  <Field byte[] zzdpw>
	//   61  106:aload_0         
	//   62  107:getfield        #18  <Field int zzdpt>
	//   63  110:iload_1         
	//   64  111:iadd            
	//   65  112:baload          
	//   66  113:ireturn         
