...
public final class zzip extends zzbfc
{
	...
	//    2    4:aload_0         
	//    3    5:aconst_null     
	//    4    6:putfield        #14  <Field Integer zzaol>
		zzaom = null;
	//    5    9:aload_0         
	//    6   10:aconst_null     
	//    7   11:putfield        #16  <Field Integer zzaom>
		zzebk = null;
	//    8   14:aload_0         
	//    9   15:aconst_null     
		...
		throws IOException
	{
		if(zzaol != null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #14  <Field Integer zzaol>
	//*   2    4:ifnull          19
			zzbfa1.zzm(1, zzaol.intValue());
	//    3    7:aload_1         
	//    4    8:iconst_1        
	//    5    9:aload_0         
	//    6   10:getfield        #14  <Field Integer zzaol>
	//    7   13:invokevirtual   #52  <Method int Integer.intValue()>
	//    8   16:invokevirtual   #58  <Method void zzbfa.zzm(int, int)>
		if(zzaom != null)
	//*   9   19:aload_0         
	//*  10   20:getfield        #16  <Field Integer zzaom>
	//*  11   23:ifnull          38
			zzbfa1.zzm(2, zzaom.intValue());
	//   12   26:aload_1         
	//   13   27:iconst_2        
	//   14   28:aload_0         
	//   15   29:getfield        #16  <Field Integer zzaom>
	...
	//    4    6:istore_1        
		if(zzaol != null)
	//*   5    7:aload_0         
	//*   6    8:getfield        #14  <Field Integer zzaol>
	//*   7   11:ifnull          28
			i = j + zzbfa.zzq(1, zzaol.intValue());
	//    8   14:iload_2         
	//    9   15:iconst_1        
	//   10   16:aload_0         
	//   11   17:getfield        #14  <Field Integer zzaol>
	...
	//   17   29:istore_2        
		if(zzaom != null)
	//*  18   30:aload_0         
	//*  19   31:getfield        #16  <Field Integer zzaom>
	//*  20   34:ifnull          51
			j = i + zzbfa.zzq(2, zzaom.intValue());
	//   21   37:iload_1         
	//   22   38:iconst_2        
	//   23   39:aload_0         
	//   24   40:getfield        #16  <Field Integer zzaom>
