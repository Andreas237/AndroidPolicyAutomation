	...
	implements android.os.Parcelable.Creator
{
	...
	//   29   55:invokestatic    #50  <Method void SafeParcelReader.ensureAtEnd(Parcel, int)>
		return ((Object) (new zzaev(parcelfiledescriptor)));
	//   30   58:new             #52  <Class zzaev>
	//   31   61:dup             
	//   32   62:aload           4
	//   33   64:invokespecial   #55  <Method void zzaev(ParcelFileDescriptor)>
	//   34   67:areturn         
	}

	public final Object[] newArray(int i)
	{
		return ((Object []) (new zzaev[i]));
	//    0    0:iload_1         
	//    1    1:anewarray       zzaev[]
	//    2    4:areturn         
	}
