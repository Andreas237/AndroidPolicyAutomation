...
public final class zzabd extends zzek
	implements zzabc
{
	...
	//    7   14:astore_1        
		if(iinterface instanceof zzabc)
	//*   8   15:aload_1         
	//*   9   16:instanceof      #6   <Class zzabc>
	//*  10   19:ifeq            27
			return (zzabc)iinterface;
	//   11   22:aload_1         
	//   12   23:checkcast       #6   <Class zzabc>
	//   13   26:areturn         
		else
			return ((zzabc) (new zzabe(ibinder)));
	//   14   27:new             #18  <Class zzabe>
	//   15   30:dup             
	//   16   31:aload_0         
	//   17   32:invokespecial   #22  <Method void zzabe(IBinder)>
	//   18   35:areturn         
	}
}
