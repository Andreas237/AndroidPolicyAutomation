...
final class zzazu extends WeakReference
{

	public zzazu(Throwable throwable, ReferenceQueue referencequeue)
	{
	...
	//   10   19:athrow          
		...
		{
			zzdpa = System.identityHashCode(((Object) (throwable)));
	//   11   20:aload_0         
	//   12   21:aload_1         
	//   13   22:invokestatic    #25  <Method int System.identityHashCode(Object)>
	//   14   25:putfield        #27  <Field int zzdpa>
			return;
	//   15   28:return          
		}
	}
	...
	//   12   22:iconst_1        
	//   13   23:ireturn         
			obj = ((Object) ((zzazu)obj));
	//   14   24:aload_1         
	//   15   25:checkcast       #2   <Class zzazu>
	//   16   28:astore_1        
			if(zzdpa == ((zzazu) (obj)).zzdpa && get() == ((zzazu) (obj)).get())
	//*  17   29:aload_0         
	//*  18   30:getfield        #27  <Field int zzdpa>
	//*  19   33:aload_1         
	//*  20   34:getfield        #27  <Field int zzdpa>
	//*  21   37:icmpne          53
	//*  22   40:aload_0         
	...
	public final int hashCode()
	{
		return zzdpa;
	//    0    0:aload_0         
	//    1    1:getfield        #27  <Field int zzdpa>
	//    2    4:ireturn         
	}
