...
public abstract class zzra extends zzek
	implements zzqz
{
	...
	//    7   14:astore_1        
		if(iinterface instanceof zzqz)
	//*   8   15:aload_1         
	//*   9   16:instanceof      #6   <Class zzqz>
	//*  10   19:ifeq            27
			return (zzqz)iinterface;
	//   11   22:aload_1         
	//   12   23:checkcast       #6   <Class zzqz>
	//   13   26:areturn         
		else
			return ((zzqz) (new zzrb(ibinder)));
	//   14   27:new             #24  <Class zzrb>
	//   15   30:dup             
	//   16   31:aload_0         
	//   17   32:invokespecial   #27  <Method void zzrb(IBinder)>
	//   18   35:areturn         
	}
	...
	//   11   19:aload_2         
	//   12   20:ldc1            #39  <String "com.google.android.gms.ads.internal.formats.client.INativeContentAd">
	//   13   22:invokeinterface #22  <Method android.os.IInterface IBinder.queryLocalInterface(String)>
	//   14   27:astore          5
				if(iinterface instanceof zzqo)
	//*  15   29:aload           5
	//*  16   31:instanceof      #41  <Class zzqo>
	//*  17   34:ifeq            46
					parcel = ((Parcel) ((zzqo)iinterface));
	//   18   37:aload           5
	//   19   39:checkcast       #41  <Class zzqo>
	//   20   42:astore_2        
				else
	//*  21   43:goto            55
					parcel = ((Parcel) (new zzqq(((IBinder) (parcel)))));
	//   22   46:new             #43  <Class zzqq>
	//   23   49:dup             
	//   24   50:aload_2         
	//   25   51:invokespecial   #44  <Method void zzqq(IBinder)>
	//   26   54:astore_2        
			}
			zza(((zzqo) (parcel)));
	//   27   55:aload_0         
	//   28   56:aload_2         
	//   29   57:invokevirtual   #48  <Method void zza(zzqo)>
