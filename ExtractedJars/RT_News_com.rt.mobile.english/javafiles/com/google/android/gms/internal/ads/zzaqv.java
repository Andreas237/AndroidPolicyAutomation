...
final class zzaqv
{
	...
	static final int zzdbn[];

	static 
	{
		zzdbn = new int[android.webkit.ConsoleMessage.MessageLevel.values().length];
	//    0    0:invokestatic    #16  <Method android.webkit.ConsoleMessage$MessageLevel[] android.webkit.ConsoleMessage$MessageLevel.values()>
	//    1    3:arraylength     
	//    2    4:newarray        int[]
	//    3    6:putstatic       #18  <Field int[] zzdbn>
		try
		{
			zzdbn[android.webkit.ConsoleMessage.MessageLevel.ERROR.ordinal()] = 1;
	//    4    9:getstatic       #18  <Field int[] zzdbn>
	...
	//*   9   20:getstatic       #18  <Field int[] zzdbn>
	...
	//*  12   29:iconst_2        
	//*  13   30:iastore         
	//*  14   31:getstatic       #18  <Field int[] zzdbn>
	...
	//*  17   40:iconst_3        
	//*  18   41:iastore         
	//*  19   42:getstatic       #18  <Field int[] zzdbn>
	...
	//*  22   51:iconst_4        
	//*  23   52:iastore         
	//*  24   53:getstatic       #18  <Field int[] zzdbn>
	...
	//   30   65:astore_0        
		try
		{
			zzdbn[android.webkit.ConsoleMessage.MessageLevel.WARNING.ordinal()] = 2;
		}
	//*  31   66:goto            20
	...
	//   32   69:astore_0        
		try
		{
			zzdbn[android.webkit.ConsoleMessage.MessageLevel.LOG.ordinal()] = 3;
		}
	//*  33   70:goto            31
	...
	//   34   73:astore_0        
		try
		{
			zzdbn[android.webkit.ConsoleMessage.MessageLevel.TIP.ordinal()] = 4;
		}
	//*  35   74:goto            42
	...
	//   36   77:astore_0        
		try
		{
			zzdbn[android.webkit.ConsoleMessage.MessageLevel.DEBUG.ordinal()] = 5;
		}
	//*  37   78:goto            53
