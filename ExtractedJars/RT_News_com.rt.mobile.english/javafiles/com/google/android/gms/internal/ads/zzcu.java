	...
	implements zzcv
{
	...
	{
		activitylifecyclecallbacks.onActivityDestroyed(val$activity);
	//    0    0:aload_1         
	//    1    1:aload_0         
	//    2    2:getfield        #12  <Field Activity val$activity>
	//    3    5:invokeinterface #24  <Method void android.app.Application$ActivityLifecycleCallbacks.onActivityDestroyed(Activity)>
	//    4   10:return          
	}
