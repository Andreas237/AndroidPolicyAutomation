...
public abstract class zzato extends zzek
	implements zzatn
{
	...
	//    7   14:astore_1        
		if(iinterface instanceof zzatn)
	//*   8   15:aload_1         
	//*   9   16:instanceof      #6   <Class zzatn>
	//*  10   19:ifeq            27
			return (zzatn)iinterface;
	//   11   22:aload_1         
	//   12   23:checkcast       #6   <Class zzatn>
	//   13   26:areturn         
		else
			return ((zzatn) (new zzatp(ibinder)));
	//   14   27:new             #18  <Class zzatp>
	//   15   30:dup             
	//   16   31:aload_0         
	//   17   32:invokespecial   #22  <Method void zzatp(IBinder)>
	//   18   35:areturn         
	}
}
