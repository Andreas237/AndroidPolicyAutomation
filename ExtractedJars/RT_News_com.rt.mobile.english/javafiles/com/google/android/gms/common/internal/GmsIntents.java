...
public class GmsIntents
{
	...
	//   16   36:astore_3        
			StringBuilder stringbuilder = new StringBuilder(98 + String.valueOf(((Object) (s))).length());
	//   17   37:new             #333 <Class StringBuilder>
	//   18   40:dup             
	//   19   41:bipush          98
	//   20   43:aload_3         
	//   21   44:invokestatic    #336 <Method String String.valueOf(Object)>
	//   22   47:invokevirtual   #339 <Method int String.length()>
	//   23   50:iadd            
	...
	//   19   40:astore_3        
			StringBuilder stringbuilder = new StringBuilder(72 + String.valueOf(((Object) (s))).length() + String.valueOf(((Object) (ai))).length());
	//   20   41:new             #333 <Class StringBuilder>
	//   21   44:dup             
	//   22   45:bipush          72
	//   23   47:aload_0         
	//   24   48:invokestatic    #336 <Method String String.valueOf(Object)>
	//   25   51:invokevirtual   #339 <Method int String.length()>
	//   26   54:iadd            
	//   27   55:aload_3         
