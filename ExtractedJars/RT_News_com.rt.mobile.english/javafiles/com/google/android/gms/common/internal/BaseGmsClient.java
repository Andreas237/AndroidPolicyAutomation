...
public abstract class BaseGmsClient
{
	...
	protected abstract class CallbackProxy
	{
		...
		//   10   18:astore_2        
				StringBuilder stringbuilder = new StringBuilder(47 + String.valueOf(((Object) (s))).length());
		//   11   19:new             #40  <Class StringBuilder>
		//   12   22:dup             
		//   13   23:bipush          47
		//   14   25:aload_2         
		//   15   26:invokestatic    #38  <Method String String.valueOf(Object)>
		//   16   29:invokevirtual   #44  <Method int String.length()>
		//   17   32:iadd            
		...
		implements ConnectionProgressReportCallbacks
	{
		...
		//    8   16:invokevirtual   #32  <Method Set BaseGmsClient.getScopes()>
		//    9   19:invokevirtual   #36  <Method void BaseGmsClient.getRemoteService(IAccountAccessor, Set)>
				return;
		//   10   22:return          
			}
...
label0:
	...
	private abstract class zza extends CallbackProxy
	{
		...
		//   45   83:iconst_1        
		//   46   84:aconst_null     
		//   47   85:invokestatic    #39  <Method void BaseGmsClient.zza(BaseGmsClient, int, IInterface)>
		...
		//   58  109:iconst_1        
		//   59  110:aconst_null     
		//   60  111:invokestatic    #39  <Method void BaseGmsClient.zza(BaseGmsClient, int, IInterface)>
...
_L3:
	...
	//   59  137:astore          7
			StringBuilder stringbuilder = new StringBuilder(70 + String.valueOf(((Object) (iinterface))).length() + String.valueOf(((Object) (s))).length());
	//   60  139:new             #260 <Class StringBuilder>
	//   61  142:dup             
	//   62  143:bipush          70
	//   63  145:aload_2         
	//   64  146:invokestatic    #264 <Method String String.valueOf(Object)>
	//   65  149:invokevirtual   #268 <Method int String.length()>
	//   66  152:iadd            
	//   67  153:aload           7
...
_L7:
	...
	//  181  397:astore          7
			StringBuilder stringbuilder1 = new StringBuilder(34 + String.valueOf(((Object) (iinterface))).length() + String.valueOf(((Object) (s1))).length());
	//  182  399:new             #260 <Class StringBuilder>
	//  183  402:dup             
	//  184  403:bipush          34
	//  185  405:aload_2         
	//  186  406:invokestatic    #264 <Method String String.valueOf(Object)>
	//  187  409:invokevirtual   #268 <Method int String.length()>
	//  188  412:iadd            
	//  189  413:aload           7
...
label0:
	...
	//   10   18:istore_1        
		...
		mHandler.sendMessage(mHandler.obtainMessage(i, mDisconnectCount.get(), 16));
	//   11   19:aload_0         
	//   12   20:getfield        #178 <Field Handler mHandler>
	//   13   23:aload_0         
	//   14   24:getfield        #178 <Field Handler mHandler>
	//   15   27:iload_1         
	//   16   28:aload_0         
	//   17   29:getfield        #160 <Field AtomicInteger mDisconnectCount>
	//   18   32:invokevirtual   #304 <Method int AtomicInteger.get()>
	//   19   35:bipush          16
	//   20   37:invokevirtual   #392 <Method Message Handler.obtainMessage(int, int, int)>
	//   21   40:invokevirtual   #396 <Method boolean Handler.sendMessage(Message)>
	//   22   43:pop             
	//   23   44:return          
	}
	...
	//    4   10:dup             
	//    5   11:ldc2            #423 <String "Not connected. Call connect() and wait for onConnected() to be called.">
...
_L1:
	...
	//   10   16:aload_2         
	//   11   17:monitorexit     
		mHandler.sendMessage(mHandler.obtainMessage(2, mDisconnectCount.get(), -1, ((Object) (callbackproxy))));
	//   12   18:aload_0         
	//   13   19:getfield        #178 <Field Handler mHandler>
	//   14   22:aload_0         
	//   15   23:getfield        #178 <Field Handler mHandler>
	//   16   26:iconst_2        
	//   17   27:aload_0         
	...
	//   20   34:iconst_m1       
	//   21   35:aload_1         
	//   22   36:invokevirtual   #458 <Method Message Handler.obtainMessage(int, int, int, Object)>
	//   23   39:invokevirtual   #396 <Method boolean Handler.sendMessage(Message)>
	//   24   42:pop             
		return;
	//   25   43:return          
		callbackproxy;
...
_L7:
	...
	//  112  272:lstore          6
			String s1 = ((SimpleDateFormat) (as)).format(new Date(zzrc));
	//  113  274:aload           4
	//  114  276:new             #537 <Class Date>
	//  115  279:dup             
	//  116  280:aload_0         
	//  117  281:getfield        #533 <Field long zzrc>
	//  118  284:invokespecial   #540 <Method void Date(long)>
	//  119  287:invokevirtual   #544 <Method String SimpleDateFormat.format(Date)>
	//  120  290:astore          8
			StringBuilder stringbuilder = new StringBuilder(String.valueOf(((Object) (s1))).length() + 21);
	//  121  292:new             #260 <Class StringBuilder>
	//  122  295:dup             
	//  123  296:aload           8
	//  124  298:invokestatic    #264 <Method String String.valueOf(Object)>
	//  125  301:invokevirtual   #268 <Method int String.length()>
	//  126  304:bipush          21
	//  127  306:iadd            
	//  128  307:invokespecial   #269 <Method void StringBuilder(int)>
	//  129  310:astore          9
			stringbuilder.append(l);
	//  130  312:aload           9
	//  131  314:lload           6
	//  132  316:invokevirtual   #547 <Method StringBuilder StringBuilder.append(long)>
	//  133  319:pop             
			stringbuilder.append(" ");
	//  134  320:aload           9
	//  135  322:ldc2            #549 <String " ">
	//  136  325:invokevirtual   #275 <Method StringBuilder StringBuilder.append(String)>
	//  137  328:pop             
			stringbuilder.append(s1);
	//  138  329:aload           9
	//  139  331:aload           8
	//  140  333:invokevirtual   #275 <Method StringBuilder StringBuilder.append(String)>
	//  141  336:pop             
			((PrintWriter) (filedescriptor)).println(stringbuilder.toString());
	//  142  337:aload_2         
	//  143  338:aload           9
	//  144  340:invokevirtual   #282 <Method String StringBuilder.toString()>
	//  145  343:invokevirtual   #513 <Method void PrintWriter.println(String)>
		}
		if(zzrb <= 0L)
			break MISSING_BLOCK_LABEL_509;
	//  146  346:aload_0         
	//  147  347:getfield        #551 <Field long zzrb>
	//  148  350:lconst_0        
	//  149  351:lcmp            
	//  150  352:ifle            509
	...
	//  151  355:aload_3         
	//  152  356:aload_1         
	//  153  357:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  154  360:ldc2            #553 <String "lastSuspendedCause=">
	//  155  363:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  156  366:pop             
		zzra;
	//  157  367:aload_0         
	//  158  368:getfield        #555 <Field int zzra>
	...
	//	               2 409
		   goto _L9 _L10 _L11
_L9:
		filedescriptor = ((FileDescriptor) (String.valueOf(zzra)));
	//  160  392:aload_0         
	//  161  393:getfield        #555 <Field int zzra>
	//  162  396:invokestatic    #557 <Method String String.valueOf(int)>
	//  163  399:astore_2        
_L13:
		printwriter.append(((CharSequence) (filedescriptor)));
	//  164  400:aload_3         
	//  165  401:aload_2         
	//  166  402:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  167  405:pop             
		break; /* Loop/switch isn't completed */
	//  168  406:goto            423
_L11:
		filedescriptor = "CAUSE_NETWORK_LOST";
	//  169  409:ldc2            #559 <String "CAUSE_NETWORK_LOST">
	//  170  412:astore_2        
		continue; /* Loop/switch isn't completed */
	//  171  413:goto            400
_L10:
		filedescriptor = "CAUSE_SERVICE_DISCONNECTED";
	//  172  416:ldc2            #561 <String "CAUSE_SERVICE_DISCONNECTED">
	//  173  419:astore_2        
...
_L12:
	...
	//  175  423:aload_3         
	//  176  424:ldc2            #563 <String " lastSuspendedTime=">
	//  177  427:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  178  430:astore_2        
		long l1 = zzrb;
	//  179  431:aload_0         
	//  180  432:getfield        #551 <Field long zzrb>
	//  181  435:lstore          6
		String s2 = ((SimpleDateFormat) (as)).format(new Date(zzrb));
	//  182  437:aload           4
	//  183  439:new             #537 <Class Date>
	//  184  442:dup             
	//  185  443:aload_0         
	//  186  444:getfield        #551 <Field long zzrb>
	//  187  447:invokespecial   #540 <Method void Date(long)>
	//  188  450:invokevirtual   #544 <Method String SimpleDateFormat.format(Date)>
	//  189  453:astore          8
		StringBuilder stringbuilder1 = new StringBuilder(String.valueOf(((Object) (s2))).length() + 21);
	//  190  455:new             #260 <Class StringBuilder>
	//  191  458:dup             
	//  192  459:aload           8
	//  193  461:invokestatic    #264 <Method String String.valueOf(Object)>
	//  194  464:invokevirtual   #268 <Method int String.length()>
	//  195  467:bipush          21
	//  196  469:iadd            
	//  197  470:invokespecial   #269 <Method void StringBuilder(int)>
	//  198  473:astore          9
		stringbuilder1.append(l1);
	//  199  475:aload           9
	//  200  477:lload           6
	//  201  479:invokevirtual   #547 <Method StringBuilder StringBuilder.append(long)>
	//  202  482:pop             
		stringbuilder1.append(" ");
	//  203  483:aload           9
	//  204  485:ldc2            #549 <String " ">
	//  205  488:invokevirtual   #275 <Method StringBuilder StringBuilder.append(String)>
	//  206  491:pop             
		stringbuilder1.append(s2);
	//  207  492:aload           9
	//  208  494:aload           8
	//  209  496:invokevirtual   #275 <Method StringBuilder StringBuilder.append(String)>
	//  210  499:pop             
		((PrintWriter) (filedescriptor)).println(stringbuilder1.toString());
	//  211  500:aload_2         
	//  212  501:aload           9
	//  213  503:invokevirtual   #282 <Method String StringBuilder.toString()>
	//  214  506:invokevirtual   #513 <Method void PrintWriter.println(String)>
		if(zzre > 0L)
	//* 215  509:aload_0         
	//* 216  510:getfield        #565 <Field long zzre>
	//* 217  513:lconst_0        
	//* 218  514:lcmp            
	//* 219  515:ifle            618
		{
	...
	//  220  518:aload_3         
	//  221  519:aload_1         
	//  222  520:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  223  523:ldc2            #567 <String "lastFailedStatus=">
	//  224  526:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  225  529:aload_0         
	//  226  530:getfield        #569 <Field int zzrd>
	//  227  533:invokestatic    #574 <Method String CommonStatusCodes.getStatusCodeString(int)>
	//  228  536:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  229  539:pop             
			s = ((String) (printwriter.append(" lastFailedTime=")));
	//  230  540:aload_3         
	//  231  541:ldc2            #576 <String " lastFailedTime=">
	//  232  544:invokevirtual   #467 <Method PrintWriter PrintWriter.append(CharSequence)>
	//  233  547:astore_1        
			long l2 = zzre;
	//  234  548:aload_0         
	//  235  549:getfield        #565 <Field long zzre>
	//  236  552:lstore          6
			filedescriptor = ((FileDescriptor) (((SimpleDateFormat) (as)).format(new Date(zzre))));
	//  237  554:aload           4
	//  238  556:new             #537 <Class Date>
	//  239  559:dup             
	//  240  560:aload_0         
	//  241  561:getfield        #565 <Field long zzre>
	//  242  564:invokespecial   #540 <Method void Date(long)>
	//  243  567:invokevirtual   #544 <Method String SimpleDateFormat.format(Date)>
	//  244  570:astore_2        
			printwriter = ((PrintWriter) (new StringBuilder(21 + String.valueOf(((Object) (filedescriptor))).length())));
	//  245  571:new             #260 <Class StringBuilder>
	//  246  574:dup             
	//  247  575:bipush          21
	//  248  577:aload_2         
	//  249  578:invokestatic    #264 <Method String String.valueOf(Object)>
	//  250  581:invokevirtual   #268 <Method int String.length()>
	//  251  584:iadd            
	//  252  585:invokespecial   #269 <Method void StringBuilder(int)>
	//  253  588:astore_3        
			((StringBuilder) (printwriter)).append(l2);
	//  254  589:aload_3         
	//  255  590:lload           6
	//  256  592:invokevirtual   #547 <Method StringBuilder StringBuilder.append(long)>
	//  257  595:pop             
			((StringBuilder) (printwriter)).append(" ");
	//  258  596:aload_3         
	//  259  597:ldc2            #549 <String " ">
	//  260  600:invokevirtual   #275 <Method StringBuilder StringBuilder.append(String)>
	//  261  603:pop             
			((StringBuilder) (printwriter)).append(((String) (filedescriptor)));
	//  262  604:aload_3         
	//  263  605:aload_2         
	//  264  606:invokevirtual   #275 <Method StringBuilder StringBuilder.append(String)>
	//  265  609:pop             
			((PrintWriter) (s)).println(((StringBuilder) (printwriter)).toString());
	//  266  610:aload_1         
	//  267  611:aload_3         
	//  268  612:invokevirtual   #282 <Method String StringBuilder.toString()>
	//  269  615:invokevirtual   #513 <Method void PrintWriter.println(String)>
		}
		return;
	//  270  618:return          
		s;
	...
	//    6   14:aload_0         
	//    7   15:getfield        #249 <Field GmsServiceEndpoint zzrf>
	//    8   18:invokevirtual   #258 <Method String GmsServiceEndpoint.getPackageName()>
	//    9   21:areturn         
		else
			throw new RuntimeException("Failed to connect when checking package");
	//   10   22:new             #600 <Class RuntimeException>
	//   11   25:dup             
	//   12   26:ldc2            #602 <String "Failed to connect when checking package">
	//   13   29:invokespecial   #603 <Method void RuntimeException(String)>
	//   14   32:athrow          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #172 <Field Context mContext>
	//    5   11:invokevirtual   #616 <Method Class Object.getClass()>
	//    6   14:invokevirtual   #619 <Method String Class.getName()>
	//    7   17:areturn         
		else
			return zzrq;
	//    8   18:aload_0         
	//    9   19:getfield        #204 <Field String zzrq>
	//   10   22:areturn         
	}
	...
	//*  82  158:astore_1        
	//*  83  159:ldc2            #279 <String "GmsClient">
	//*  84  162:ldc2            #685 <String "IGmsServiceBroker.getService failed">
	//*  85  165:aload_1         
	//*  86  166:invokestatic    #688 <Method int Log.w(String, String, Throwable)>
	//*  87  169:pop             
	//*  88  170:aload_0         
	//*  89  171:bipush          8
	//*  90  173:aconst_null     
	//*  91  174:aconst_null     
	//*  92  175:aload_0         
	//*  93  176:getfield        #160 <Field AtomicInteger mDisconnectCount>
	//*  94  179:invokevirtual   #304 <Method int AtomicInteger.get()>
	//*  95  182:invokevirtual   #692 <Method void onPostInitHandler(int, IBinder, Bundle, int)>
	//*  96  185:return          
	//*  97  186:astore_1        
	//*  98  187:aload_1         
	//*  99  188:athrow          
	...
	//  101  190:ldc2            #279 <String "GmsClient">
	//  102  193:ldc2            #685 <String "IGmsServiceBroker.getService failed">
	//  103  196:aload_1         
	//  104  197:invokestatic    #688 <Method int Log.w(String, String, Throwable)>
	//  105  200:pop             
		}
		// Misplaced declaration of an exception variable
		catch(IAccountAccessor iaccountaccessor)
	...
	//  106  201:aload_0         
	//  107  202:iconst_1        
	//  108  203:invokevirtual   #695 <Method void triggerConnectionSuspended(int)>
		return;
	//  109  206:return          
	}
	...
	//    9   15:new             #624 <Class DeadObjectException>
	//   10   18:dup             
	//   11   19:invokespecial   #707 <Method void DeadObjectException()>
	//   12   22:athrow          
		checkConnected();
	//   13   23:aload_0         
	//   14   24:invokevirtual   #709 <Method void checkConnected()>
		boolean flag;
		IInterface iinterface;
		Exception exception;
		if(zzrj != null)
	//*  15   27:aload_0         
	//*  16   28:getfield        #238 <Field IInterface zzrj>
	//*  17   31:ifnull          60
			flag = true;
	//   18   34:iconst_1        
	//   19   35:istore_1        
	...
	//*  20   36:goto            39
	//*  21   39:iload_1         
	//*  22   40:ldc2            #711 <String "Client is connected but service is null">
	//*  23   43:invokestatic    #715 <Method void Preconditions.checkState(boolean, Object)>
	//*  24   46:aload_0         
	//*  25   47:getfield        #238 <Field IInterface zzrj>
	//*  26   50:astore_3        
	//*  27   51:aload_2         
	//*  28   52:monitorexit     
	//*  29   53:aload_3         
...
label0:
	...
	{
		mHandler.sendMessage(mHandler.obtainMessage(1, j, -1, ((Object) (new PostInitCallback(i, ibinder, bundle)))));
	//    0    0:aload_0         
	//    1    1:getfield        #178 <Field Handler mHandler>
	//    2    4:aload_0         
	//    3    5:getfield        #178 <Field Handler mHandler>
	//    4    8:iconst_1        
	//    5    9:iload           4
	//    6   11:iconst_m1       
	//    7   12:new             #28  <Class BaseGmsClient$PostInitCallback>
	//    8   15:dup             
	//    9   16:aload_0         
	//   10   17:iload_1         
	//   11   18:aload_2         
	//   12   19:aload_3         
	//   13   20:invokespecial   #747 <Method void BaseGmsClient$PostInitCallback(BaseGmsClient, int, IBinder, Bundle)>
	//   14   23:invokevirtual   #458 <Method Message Handler.obtainMessage(int, int, int, Object)>
	//   15   26:invokevirtual   #396 <Method boolean Handler.sendMessage(Message)>
	//   16   29:pop             
	//   17   30:return          
	}
	...
	{
		mHandler.sendMessage(mHandler.obtainMessage(7, j, -1, ((Object) (new PostServiceBindingCallback(i, bundle)))));
	//    0    0:aload_0         
	//    1    1:getfield        #178 <Field Handler mHandler>
	//    2    4:aload_0         
	//    3    5:getfield        #178 <Field Handler mHandler>
	...
	//    5   10:iload_3         
	//    6   11:iconst_m1       
	//    7   12:new             #31  <Class BaseGmsClient$PostServiceBindingCallback>
	//    8   15:dup             
	//    9   16:aload_0         
	//   10   17:iload_1         
	//   11   18:aload_2         
	//   12   19:invokespecial   #750 <Method void BaseGmsClient$PostServiceBindingCallback(BaseGmsClient, int, Bundle)>
	//   13   22:invokevirtual   #458 <Method Message Handler.obtainMessage(int, int, int, Object)>
	//   14   25:invokevirtual   #396 <Method boolean Handler.sendMessage(Message)>
	//   15   28:pop             
	//   16   29:return          
	}
	...
	{
		mHandler.sendMessage(mHandler.obtainMessage(6, mDisconnectCount.get(), i));
	//    0    0:aload_0         
	//    1    1:getfield        #178 <Field Handler mHandler>
	//    2    4:aload_0         
	//    3    5:getfield        #178 <Field Handler mHandler>
	//    4    8:bipush          6
	//    5   10:aload_0         
	//    6   11:getfield        #160 <Field AtomicInteger mDisconnectCount>
	//    7   14:invokevirtual   #304 <Method int AtomicInteger.get()>
	//    8   17:iload_1         
	//    9   18:invokevirtual   #392 <Method Message Handler.obtainMessage(int, int, int)>
	//   10   21:invokevirtual   #396 <Method boolean Handler.sendMessage(Message)>
	//   11   24:pop             
	//   12   25:return          
	}
	...
	//    4    8:checkcast       #16  <Class BaseGmsClient$ConnectionProgressReportCallbacks>
	//    5   11:putfield        #431 <Field BaseGmsClient$ConnectionProgressReportCallbacks mConnectionProgressReportCallbacks>
		mHandler.sendMessage(mHandler.obtainMessage(3, mDisconnectCount.get(), i, ((Object) (pendingintent))));
	//    6   14:aload_0         
	//    7   15:getfield        #178 <Field Handler mHandler>
	//    8   18:aload_0         
	//    9   19:getfield        #178 <Field Handler mHandler>
	//   10   22:iconst_3        
	//   11   23:aload_0         
	//   12   24:getfield        #160 <Field AtomicInteger mDisconnectCount>
	//   13   27:invokevirtual   #304 <Method int AtomicInteger.get()>
	//   14   30:iload_2         
	//   15   31:aload_3         
	//   16   32:invokevirtual   #458 <Method Message Handler.obtainMessage(int, int, int, Object)>
	//   17   35:invokevirtual   #396 <Method boolean Handler.sendMessage(Message)>
	//   18   38:pop             
	//   19   39:return          
	}
