...
public final class UnsupportedApiCallException extends UnsupportedOperationException
{
	...
	//    3    7:astore_1        
		StringBuilder stringbuilder = new StringBuilder(8 + String.valueOf(((Object) (s))).length());
	//    4    8:new             #24  <Class StringBuilder>
	//    5   11:dup             
	//    6   12:bipush          8
	//    7   14:aload_1         
	//    8   15:invokestatic    #22  <Method String String.valueOf(Object)>
	//    9   18:invokevirtual   #28  <Method int String.length()>
	//   10   21:iadd            
