	...
	implements android.os.Parcelable.Creator
{
	...
	//*  22   66:goto            13
				case 3: // '\003'
					field = (FastJsonResponse.Field)SafeParcelReader.createParcelable(parcel, k, ((android.os.Parcelable.Creator) (FastJsonResponse.Field.CREATOR)));
	//   23   69:aload_1         
	//   24   70:iload           4
	//   25   72:getstatic       #46  <Field FieldCreator FastJsonResponse$Field.CREATOR>
	...
	//   27   78:checkcast       #42  <Class FastJsonResponse$Field>
	//   28   81:astore          5
					break;
	...
	//   30   86:aload_1         
	//   31   87:iload           4
	//   32   89:invokestatic    #54  <Method String SafeParcelReader.createString(Parcel, int)>
	//   33   92:astore          6
					break;
	...
	//   43  112:new             #63  <Class FieldMappingDictionary$FieldMapPair>
	//   44  115:dup             
	//   45  116:iload_2         
	//   46  117:aload           6
	//   47  119:aload           5
	//   48  121:invokespecial   #66  <Method void FieldMappingDictionary$FieldMapPair(int, String, FastJsonResponse$Field)>
	//   49  124:areturn         
			}
		while(true);
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #69  <Method FieldMappingDictionary$FieldMapPair createFromParcel(Parcel)>
	//    3    5:areturn         
	}
	...
	//    0    0:iload_1         
	//    1    1:anewarray       FieldMappingDictionary.FieldMapPair[]
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #74  <Method FieldMappingDictionary$FieldMapPair[] newArray(int)>
	//    3    5:areturn         
	}
