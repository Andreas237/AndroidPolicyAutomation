...
public class WorkSourceUtil
{
	...
	//*  32   53:ifnull          86
			try
			{
				zzaan.invoke(((Object) (worksource)), new Object[] {
					Integer.valueOf(i)
				});
	//   33   56:getstatic       #34  <Field Method zzaan>
	//   34   59:aload_0         
	//   35   60:iconst_1        
	...
	//   38   65:iconst_0        
	//   39   66:iload_1         
	//   40   67:invokestatic    #81  <Method Integer Integer.valueOf(int)>
	//   41   70:aastore         
	//   42   71:invokevirtual   #87  <Method Object Method.invoke(Object, Object[])>
	//   43   74:pop             
				return;
	//   44   75:return          
			}
	...
	//*  45   76:astore_0        
			{
				Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", ((Throwable) (worksource)));
	//   46   77:ldc1            #8   <String "WorkSourceUtil">
	//   47   79:ldc1            #89  <String "Unable to assign blame through WorkSource">
	//   48   81:aload_0         
	//   49   82:invokestatic    #95  <Method int Log.wtf(String, String, Throwable)>
	//   50   85:pop             
			}
	//   51   86:return          
	}
...
_L3:
	...
	//*  23   45:ifnull          141
	//*  24   48:getstatic       #64  <Field Method zzaat>
	//*  25   51:ifnonnull       57
	//*  26   54:goto            141
			{
				try
				{
					Object obj = zzaas.invoke(((Object) (context)), new Object[0]);
	//   27   57:getstatic       #59  <Field Method zzaas>
	//   28   60:aload_0         
	//   29   61:iconst_0        
	//   30   62:anewarray       Object[]
	//   31   65:invokevirtual   #87  <Method Object Method.invoke(Object, Object[])>
	//   32   68:astore          4
					if(i != zzaam)
	//*  33   70:iload_3         
	//*  34   71:getstatic       #28  <Field int zzaam>
	//*  35   74:icmpeq          101
						zzaat.invoke(obj, new Object[] {
							Integer.valueOf(i), s
						});
	//   36   77:getstatic       #64  <Field Method zzaat>
	//   37   80:aload           4
	//   38   82:iconst_2        
	...
	//   41   87:iconst_0        
	//   42   88:iload_3         
	//   43   89:invokestatic    #81  <Method Integer Integer.valueOf(int)>
	//   44   92:aastore         
	//   45   93:dup             
	//   46   94:iconst_1        
	//   47   95:aload_1         
	//   48   96:aastore         
	//   49   97:invokevirtual   #87  <Method Object Method.invoke(Object, Object[])>
	//   50  100:pop             
					zzaat.invoke(obj, new Object[] {
						Integer.valueOf(zzaam), s1
					});
	//   51  101:getstatic       #64  <Field Method zzaat>
	//   52  104:aload           4
	//   53  106:iconst_2        
	//   54  107:anewarray       Object[]
	//   55  110:dup             
	//   56  111:iconst_0        
	//   57  112:getstatic       #28  <Field int zzaam>
	//   58  115:invokestatic    #81  <Method Integer Integer.valueOf(int)>
	//   59  118:aastore         
	//   60  119:dup             
	//   61  120:iconst_1        
	//   62  121:aload_2         
	//   63  122:aastore         
	//   64  123:invokevirtual   #87  <Method Object Method.invoke(Object, Object[])>
	//   65  126:pop             
				}
	//*  66  127:aload_0         
	//*  67  128:areturn         
	...
	//   69  130:ldc1            #8   <String "WorkSourceUtil">
	//   70  132:ldc1            #162 <String "Unable to assign chained blame through WorkSource">
	//   71  134:aload_1         
	//   72  135:invokestatic    #165 <Method int Log.w(String, String, Throwable)>
	//   73  138:pop             
	...
	//   77  142:iload_3         
	//   78  143:aload_1         
	//   79  144:invokestatic    #167 <Method void add(WorkSource, int, String)>
				return ((WorkSource) (context));
	//   80  147:aload_0         
	//   81  148:areturn         
			}
	...
	//   82  149:ldc1            #8   <String "WorkSourceUtil">
	//   83  151:ldc1            #169 <String "Unexpected null arguments">
	//   84  153:invokestatic    #171 <Method int Log.w(String, String)>
	//   85  156:pop             
			return null;
	//   86  157:aconst_null     
	//   87  158:areturn         
	...
	//    1    3:ifnull          43
		i = ((Integer)zzaaq.invoke(((Object) (worksource)), new Object[] {
			Integer.valueOf(i)
		})).intValue();
	//    2    6:getstatic       #49  <Field Method zzaaq>
	//    3    9:aload_0         
	//    4   10:iconst_1        
	...
	//    7   15:iconst_0        
	//    8   16:iload_1         
	//    9   17:invokestatic    #81  <Method Integer Integer.valueOf(int)>
	//   10   20:aastore         
	//   11   21:invokevirtual   #87  <Method Object Method.invoke(Object, Object[])>
	//   12   24:checkcast       #77  <Class Integer>
	//   13   27:invokevirtual   #176 <Method int Integer.intValue()>
	//   14   30:istore_1        
		return i;
	//   15   31:iload_1         
	//   16   32:ireturn         
	...
	//   17   33:astore_0        
		Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", ((Throwable) (worksource)));
	//   18   34:ldc1            #8   <String "WorkSourceUtil">
	//   19   36:ldc1            #89  <String "Unable to assign blame through WorkSource">
	//   20   38:aload_0         
	//   21   39:invokestatic    #95  <Method int Log.wtf(String, String, Throwable)>
	//   22   42:pop             
		return 0;
	//   23   43:iconst_0        
	//   24   44:ireturn         
	...
	//    1    3:ifnull          40
		worksource = ((WorkSource) ((String)zzaar.invoke(((Object) (worksource)), new Object[] {
			Integer.valueOf(i)
		})));
	//    2    6:getstatic       #54  <Field Method zzaar>
	//    3    9:aload_0         
	//    4   10:iconst_1        
	//    5   11:anewarray       Object[]
	//    6   14:dup             
	...
	//   10   20:aastore         
	//   11   21:invokevirtual   #87  <Method Object Method.invoke(Object, Object[])>
	//   12   24:checkcast       #120 <Class String>
	//   13   27:astore_0        
	...
	//   16   30:astore_0        
		Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", ((Throwable) (worksource)));
	//   17   31:ldc1            #8   <String "WorkSourceUtil">
	//   18   33:ldc1            #89  <String "Unable to assign blame through WorkSource">
	//   19   35:aload_0         
	//   20   36:invokestatic    #95  <Method int Log.wtf(String, String, Throwable)>
	//   21   39:pop             
		return null;
	//   22   40:aconst_null     
	//   23   41:areturn         
	...
	//    1    3:ifnull          36
		int i = ((Integer)zzaap.invoke(((Object) (worksource)), new Object[0])).intValue();
	//    2    6:getstatic       #44  <Field Method zzaap>
	//    3    9:aload_0         
	//    4   10:iconst_0        
	//    5   11:anewarray       Object[]
	//    6   14:invokevirtual   #87  <Method Object Method.invoke(Object, Object[])>
	//    7   17:checkcast       #77  <Class Integer>
	//    8   20:invokevirtual   #176 <Method int Integer.intValue()>
	//    9   23:istore_1        
		return i;
	//   10   24:iload_1         
	//   11   25:ireturn         
	...
	//   12   26:astore_0        
		Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", ((Throwable) (worksource)));
	//   13   27:ldc1            #8   <String "WorkSourceUtil">
	//   14   29:ldc1            #89  <String "Unable to assign blame through WorkSource">
	//   15   31:aload_0         
	//   16   32:invokestatic    #95  <Method int Log.wtf(String, String, Throwable)>
	//   17   35:pop             
		return 0;
	//   18   36:iconst_0        
	//   19   37:ireturn         
