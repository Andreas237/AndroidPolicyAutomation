	...
	extends IInterface
{
		...
		implements ISocketFactoryCreator
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.common.net.ISocketFactoryCreator");
		//    4    6:aload_0         
		...
		//   35   93:aload_3         
		//   36   94:aload_2         
		//   37   95:invokestatic    #68  <Method void zzc.zza(Parcel, IInterface)>
			return true;
		//   38   98:iconst_1        
		//   39   99:ireturn         
		}
		...
		implements ISocketFactoryCreator
	{
		...
		//    6   12:aload           5
		//    7   14:aload_2         
		//    8   15:invokestatic    #32  <Method void zzc.zza(Parcel, IInterface)>
			zzc.zza(parcel, ((IInterface) (iobjectwrapper2)));
		//    9   18:aload           5
		//   10   20:aload_3         
		//   11   21:invokestatic    #32  <Method void zzc.zza(Parcel, IInterface)>
			zzc.zza(parcel, flag);
		//   12   24:aload           5
		//   13   26:iload           4
	...
	public abstract IObjectWrapper newSocketFactory(IObjectWrapper iobjectwrapper, IObjectWrapper iobjectwrapper1, IObjectWrapper iobjectwrapper2, boolean flag)
		throws RemoteException;

	public abstract IObjectWrapper newSocketFactoryWithCacheDir(IObjectWrapper iobjectwrapper, IObjectWrapper iobjectwrapper1, IObjectWrapper iobjectwrapper2, String s)
		throws RemoteException;
}
