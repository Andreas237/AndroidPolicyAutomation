...
public class SafeParcelResponse extends FastSafeParcelableJsonResponse
{
	...
	//*  21   39:aload_0         
	//*  22   40:aload_2         
	//*  23   41:putfield        #64  <Field String mClassName>
	//*  24   44:goto            58
			parcel = ((Parcel) (zzwn.getRootClassName()));
	//   25   47:aload_0         
	//   26   48:getfield        #62  <Field FieldMappingDictionary zzwn>
	//   27   51:invokevirtual   #70  <Method String FieldMappingDictionary.getRootClassName()>
	//   28   54:astore_2        
	...
	//   30   58:aload_0         
	//   31   59:iconst_2        
	//   32   60:putfield        #72  <Field int zzxs>
	//   33   63:return          
	}
	...
	//   19   37:checkcast       #66  <Class FieldMappingDictionary>
	...
	//   25   51:putfield        #64  <Field String mClassName>
		zzxs = 2;
	//   26   54:aload_0         
	//   27   55:iconst_2        
	...
	//    1    1:aload_1         
	//    2    2:aload_1         
	//    3    3:invokevirtual   #70  <Method String FieldMappingDictionary.getRootClassName()>
	...
	//   14   26:checkcast       #66  <Class FieldMappingDictionary>
	...
	//   20   40:putfield        #64  <Field String mClassName>
		zzxs = 0;
	//   21   43:aload_0         
	//   22   44:iconst_0        
	...
	//    0    0:new             #66  <Class FieldMappingDictionary>
	//    1    3:dup             
	//    2    4:aload_0         
...
label13:
	...
	//* 467 1151:iload           5
	//* 468 1153:icmpeq          1194
		{
			stringbuilder = new StringBuilder(37);
	//  469 1156:new             #230 <Class StringBuilder>
	//  470 1159:dup             
	//  471 1160:bipush          37
	//  472 1162:invokespecial   #233 <Method void StringBuilder(int)>
	//  473 1165:astore_1        
			stringbuilder.append("Overread allowed size end=");
	//  474 1166:aload_1         
	//  475 1167:ldc2            #521 <String "Overread allowed size end=">
	//  476 1170:invokevirtual   #239 <Method StringBuilder StringBuilder.append(String)>
	//  477 1173:pop             
			stringbuilder.append(j);
	//  478 1174:aload_1         
	//  479 1175:iload           5
	//  480 1177:invokevirtual   #242 <Method StringBuilder StringBuilder.append(int)>
	//  481 1180:pop             
	...
	//  482 1181:new             #523 <Class com.google.android.gms.common.internal.safeparcel.SafeParcelReader$ParseException>
	//  483 1184:dup             
	//  484 1185:aload_1         
	//  485 1186:invokevirtual   #247 <Method String StringBuilder.toString()>
	//  486 1189:aload_3         
	//  487 1190:invokespecial   #526 <Method void com.google.android.gms.common.internal.safeparcel.SafeParcelReader$ParseException(String, Parcel)>
	//  488 1193:athrow          
		} else
		{
			stringbuilder.append('}');
	//  489 1194:aload_1         
	//  490 1195:bipush          125
	//  491 1197:invokevirtual   #299 <Method StringBuilder StringBuilder.append(char)>
	//  492 1200:pop             
			return;
	//  493 1201:return          
		}
	...
	//    3    7:new             #189 <Class IllegalStateException>
	//    4   10:dup             
	//    5   11:ldc2            #533 <String "Field does not have a valid safe parcelable field id.">
	//    6   14:invokespecial   #416 <Method void IllegalStateException(String)>
	//    7   17:athrow          
		if(zzxq == null)
	//*   8   18:aload_0         
	//*   9   19:getfield        #58  <Field Parcel zzxq>
	//*  10   22:ifnonnull       36
			throw new IllegalStateException("Internal Parcel object is null.");
	//   11   25:new             #189 <Class IllegalStateException>
	//   12   28:dup             
	//   13   29:ldc2            #535 <String "Internal Parcel object is null.">
	//   14   32:invokespecial   #416 <Method void IllegalStateException(String)>
	//   15   35:athrow          
		switch(zzxs)
	//*  16   36:aload_0         
	//*  17   37:getfield        #72  <Field int zzxs>
		{
	//*  18   40:tableswitch     0 2: default 68
	//	               0 91
	//	               1 90
	//	               2 79
		default:
			throw new IllegalStateException("Unknown parse state in SafeParcelResponse.");
	//   19   68:new             #189 <Class IllegalStateException>
	//   20   71:dup             
	//   21   72:ldc2            #537 <String "Unknown parse state in SafeParcelResponse.">
	//   22   75:invokespecial   #416 <Method void IllegalStateException(String)>
	//   23   78:athrow          

		case 2: // '\002'
			throw new IllegalStateException("Attempted to parse JSON with a SafeParcelResponse object that is already filled with data.");
	//   24   79:new             #189 <Class IllegalStateException>
	//   25   82:dup             
	//   26   83:ldc2            #539 <String "Attempted to parse JSON with a SafeParcelResponse object that is already filled with data.">
	//   27   86:invokespecial   #416 <Method void IllegalStateException(String)>
	//   28   89:athrow          
	...
	//   30   91:aload_0         
	//   31   92:aload_0         
	//   32   93:getfield        #58  <Field Parcel zzxq>
	//   33   96:invokestatic    #544 <Method int SafeParcelWriter.beginObjectHeader(Parcel)>
	//   34   99:putfield        #546 <Field int zzxt>
			break;
		}
		zzxs = 1;
	//   35  102:aload_0         
	//   36  103:iconst_1        
	//   37  104:putfield        #72  <Field int zzxs>
	//   38  107:return          
	}
	...
	//    4    8:areturn         
			...
			return zzwn.getFieldMapping(mClassName);
	//    5    9:aload_0         
	//    6   10:getfield        #62  <Field FieldMappingDictionary zzwn>
	//    7   13:aload_0         
	//    8   14:getfield        #64  <Field String mClassName>
	//    9   17:invokevirtual   #587 <Method Map FieldMappingDictionary.getFieldMapping(String)>
	//   10   20:areturn         
	}
	...
	//    7   36:invokestatic    #544 <Method int SafeParcelWriter.beginObjectHeader(Parcel)>
	//    8   39:putfield        #546 <Field int zzxt>
			// fall through
	...
	//   11   46:aload_0         
	//   12   47:getfield        #546 <Field int zzxt>
	...
	//   20   37:aload_0         
	//   21   38:getfield        #64  <Field String mClassName>
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #544 <Method int SafeParcelWriter.beginObjectHeader(Parcel)>
	//    2    4:istore_3        
	...
	//	               2 97
		default:
			i = zzxr;
	//   17   56:aload_0         
	//   18   57:getfield        #60  <Field int zzxr>
	//   19   60:istore_2        
			parcel = ((Parcel) (new StringBuilder(34)));
	//   20   61:new             #230 <Class StringBuilder>
	//   21   64:dup             
	//   22   65:bipush          34
	//   23   67:invokespecial   #233 <Method void StringBuilder(int)>
	//   24   70:astore_1        
			((StringBuilder) (parcel)).append("Invalid creation type: ");
	//   25   71:aload_1         
	//   26   72:ldc2            #753 <String "Invalid creation type: ">
	//   27   75:invokevirtual   #239 <Method StringBuilder StringBuilder.append(String)>
	//   28   78:pop             
			((StringBuilder) (parcel)).append(i);
	//   29   79:aload_1         
	//   30   80:iload_2         
	//   31   81:invokevirtual   #242 <Method StringBuilder StringBuilder.append(int)>
	//   32   84:pop             
			throw new IllegalStateException(((StringBuilder) (parcel)).toString());
	//   33   85:new             #189 <Class IllegalStateException>
	//   34   88:dup             
	//   35   89:aload_1         
	//   36   90:invokevirtual   #247 <Method String StringBuilder.toString()>
	//   37   93:invokespecial   #416 <Method void IllegalStateException(String)>
	//   38   96:athrow          
	...
	//   39   97:aload_0         
	//   40   98:getfield        #62  <Field FieldMappingDictionary zzwn>
	//   41  101:astore          4
			break;
	...
	//   48  113:iload_2         
	//   49  114:iconst_0        
	//   50  115:invokestatic    #757 <Method void SafeParcelWriter.writeParcelable(Parcel, int, android.os.Parcelable, int, boolean)>
		SafeParcelWriter.finishObjectHeader(parcel, j);
	//   51  118:aload_1         
	//   52  119:iload_3         
	//   53  120:invokestatic    #591 <Method void SafeParcelWriter.finishObjectHeader(Parcel, int)>
	//   54  123:return          
	}
