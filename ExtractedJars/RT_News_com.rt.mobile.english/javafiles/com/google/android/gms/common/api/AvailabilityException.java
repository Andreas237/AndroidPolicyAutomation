...
public class AvailabilityException extends Exception
{
	...
	//   34   79:astore          5
			stringbuilder1 = new StringBuilder(2 + String.valueOf(obj1).length() + String.valueOf(obj2).length());
	//   35   81:new             #83  <Class StringBuilder>
	//   36   84:dup             
	//   37   85:iconst_2        
	//   38   86:aload           4
	//   39   88:invokestatic    #81  <Method String String.valueOf(Object)>
	//   40   91:invokevirtual   #87  <Method int String.length()>
	//   41   94:iadd            
	//   42   95:aload           5
