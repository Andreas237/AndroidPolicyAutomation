...
public class ConverterWrapper extends AbstractSafeParcelable
{
	...
	//*   2    4:ifnull          12
			return ((com.google.android.gms.common.server.response.FastJsonResponse.FieldConverter) (zzwd));
	//    3    7:aload_0         
	//    4    8:getfield        #39  <Field StringToIntConverter zzwd>
	//    5   11:areturn         
		else
			throw new IllegalStateException("There was no converter wrapped in this ConverterWrapper.");
	//    6   12:new             #61  <Class IllegalStateException>
	//    7   15:dup             
	//    8   16:ldc1            #63  <String "There was no converter wrapped in this ConverterWrapper.">
	//    9   18:invokespecial   #64  <Method void IllegalStateException(String)>
	//   10   21:athrow          
	}
