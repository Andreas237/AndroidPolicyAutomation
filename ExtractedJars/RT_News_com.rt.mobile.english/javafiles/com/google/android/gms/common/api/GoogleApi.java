...
label0:
	...
	//*   6   12:instanceof      #192 <Class Api$ApiOptions$HasGoogleSignInAccountOptions>
	//*   7   15:ifeq            43
			{
				obj = ((Object) (((Api.ApiOptions.HasGoogleSignInAccountOptions)zzcl).getGoogleSignInAccount()));
	//    8   18:aload_0         
	//    9   19:getfield        #64  <Field Api$ApiOptions zzcl>
	//   10   22:checkcast       #192 <Class Api$ApiOptions$HasGoogleSignInAccountOptions>
	//   11   25:invokeinterface #196 <Method GoogleSignInAccount Api$ApiOptions$HasGoogleSignInAccountOptions.getGoogleSignInAccount()>
	//   12   30:astore_1        
				if(obj != null)
	//*  13   31:aload_1         
	//*  14   32:ifnull          43
	...
	//   15   35:aload_1         
	//   16   36:invokevirtual   #202 <Method Account GoogleSignInAccount.getAccount()>
	//   17   39:astore_1        
					break label0;
	//   18   40:goto            71
				}
			}
			if(zzcl instanceof Api.ApiOptions.HasAccountOptions)
	//*  19   43:aload_0         
	//*  20   44:getfield        #64  <Field Api$ApiOptions zzcl>
	//*  21   47:instanceof      #204 <Class Api$ApiOptions$HasAccountOptions>
	//*  22   50:ifeq            69
				obj = ((Object) (((Api.ApiOptions.HasAccountOptions)zzcl).getAccount()));
	//   23   53:aload_0         
	//   24   54:getfield        #64  <Field Api$ApiOptions zzcl>
	//   25   57:checkcast       #204 <Class Api$ApiOptions$HasAccountOptions>
	//   26   60:invokeinterface #205 <Method Account Api$ApiOptions$HasAccountOptions.getAccount()>
	//   27   65:astore_1        
			else
	//*  28   66:goto            71
				obj = null;
...
label1:
	...
	//   31   71:aload_2         
	//   32   72:aload_1         
	//   33   73:invokevirtual   #209 <Method com.google.android.gms.common.internal.ClientSettings$Builder com.google.android.gms.common.internal.ClientSettings$Builder.setAccount(Account)>
	//   34   76:astore_2        
			if(zzcl instanceof Api.ApiOptions.HasGoogleSignInAccountOptions)
	//*  35   77:aload_0         
	//*  36   78:getfield        #64  <Field Api$ApiOptions zzcl>
	//*  37   81:instanceof      #192 <Class Api$ApiOptions$HasGoogleSignInAccountOptions>
	//*  38   84:ifeq            112
			{
				obj = ((Object) (((Api.ApiOptions.HasGoogleSignInAccountOptions)zzcl).getGoogleSignInAccount()));
	//   39   87:aload_0         
	//   40   88:getfield        #64  <Field Api$ApiOptions zzcl>
	//   41   91:checkcast       #192 <Class Api$ApiOptions$HasGoogleSignInAccountOptions>
	//   42   94:invokeinterface #196 <Method GoogleSignInAccount Api$ApiOptions$HasGoogleSignInAccountOptions.getGoogleSignInAccount()>
	//   43   99:astore_1        
				if(obj != null)
	//*  44  100:aload_1         
	//*  45  101:ifnull          112
	...
	//   46  104:aload_1         
	//   47  105:invokevirtual   #213 <Method java.util.Set GoogleSignInAccount.getRequestedScopes()>
	//   48  108:astore_1        
					break label1;
	//   49  109:goto            116
				}
	...
	//   50  112:invokestatic    #218 <Method java.util.Set Collections.emptySet()>
	//   51  115:astore_1        
		}
	...
	//   52  116:aload_2         
	//   53  117:aload_1         
	//   54  118:invokevirtual   #222 <Method com.google.android.gms.common.internal.ClientSettings$Builder com.google.android.gms.common.internal.ClientSettings$Builder.addAllRequiredScopes(java.util.Collection)>
	//   55  121:aload_0         
	//   56  122:getfield        #60  <Field Context mContext>
	//   57  125:invokevirtual   #226 <Method Class Object.getClass()>
	//   58  128:invokevirtual   #232 <Method String Class.getName()>
	//   59  131:invokevirtual   #236 <Method com.google.android.gms.common.internal.ClientSettings$Builder com.google.android.gms.common.internal.ClientSettings$Builder.setRealClientClassName(String)>
	//   60  134:aload_0         
	//   61  135:getfield        #60  <Field Context mContext>
	//   62  138:invokevirtual   #239 <Method String Context.getPackageName()>
	//   63  141:invokevirtual   #242 <Method com.google.android.gms.common.internal.ClientSettings$Builder com.google.android.gms.common.internal.ClientSettings$Builder.setRealClientPackageName(String)>
	//   64  144:areturn         
	}
