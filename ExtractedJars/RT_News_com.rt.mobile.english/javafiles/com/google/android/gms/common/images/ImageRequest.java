...
label0:
	...
	//    6   13:new             #66  <Class com.google.android.gms.common.images.internal.PostProcessedResourceCache$PostProcessedResource>
	//    7   16:dup             
	//    8   17:iload_3         
	//    9   18:aload_0         
	//   10   19:getfield        #64  <Field int mPostProcessingFlags>
	//   11   22:invokespecial   #69  <Method void com.google.android.gms.common.images.internal.PostProcessedResourceCache$PostProcessedResource(int, int)>
	//   12   25:astore          5
			Drawable drawable = (Drawable)postprocessedresourcecache.get(((Object) (postprocessedresource)));
	//   13   27:aload_2         
	//   14   28:aload           5
	//   15   30:invokevirtual   #75  <Method Object PostProcessedResourceCache.get(Object)>
	//   16   33:checkcast       #77  <Class Drawable>
	//   17   36:astore          4
	...
	//   22   46:aload           6
	//   23   48:iload_3         
	//   24   49:invokevirtual   #83  <Method Drawable Resources.getDrawable(int)>
	//   25   52:astore_1        
				if((mPostProcessingFlags & 1) != 0)
	//*  26   53:aload_0         
	//*  27   54:getfield        #64  <Field int mPostProcessingFlags>
	//*  28   57:iconst_1        
	//*  29   58:iand            
	//*  30   59:ifeq            73
	...
	//   32   63:aload           6
	//   33   65:aload_1         
	//   34   66:invokevirtual   #87  <Method Drawable frameDrawableInCircle(Resources, Drawable)>
	//   35   69:astore_1        
	//*  36   70:goto            73
	...
	//   38   74:aload           5
	//   39   76:aload_1         
	//   40   77:invokevirtual   #91  <Method Object PostProcessedResourceCache.put(Object, Object)>
	//   41   80:pop             
			}
	...
	//   44   83:aload           6
	//   45   85:iload_3         
	//   46   86:invokevirtual   #83  <Method Drawable Resources.getDrawable(int)>
	//   47   89:areturn         
		}
	}
	...
	//*  21   40:ifnull          61
			mOnImageLoadedListener.onImageLoaded(zzpk.uri, ((Drawable) (context)), true);
	//   22   43:aload_0         
	//   23   44:getfield        #120 <Field ImageManager$OnImageLoadedListener mOnImageLoadedListener>
	//   24   47:aload_0         
	//   25   48:getfield        #54  <Field ImageRequest$zza zzpk>
	//   26   51:getfield        #144 <Field Uri ImageRequest$zza.uri>
	//   27   54:aload_1         
	//   28   55:iconst_1        
	//   29   56:invokeinterface #150 <Method void ImageManager$OnImageLoadedListener.onImageLoaded(Uri, Drawable, boolean)>
	...
	//   33   64:iconst_0        
	//   34   65:iconst_1        
	//   35   66:invokevirtual   #152 <Method void loadImage(Drawable, boolean, boolean, boolean)>
	//   36   69:return          
	}
	...
	//    3    7:aconst_null     
	//    4    8:astore_3        
			if(mLoadingPlaceholderResId != 0)
	//*   5    9:aload_0         
	//*   6   10:getfield        #39  <Field int mLoadingPlaceholderResId>
	//*   7   13:ifeq            27
				drawable = zza(context, postprocessedresourcecache, mLoadingPlaceholderResId);
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:aload_2         
	//   11   19:aload_0         
	//   12   20:getfield        #39  <Field int mLoadingPlaceholderResId>
	//   13   23:invokespecial   #155 <Method Drawable zza(Context, PostProcessedResourceCache, int)>
	//   14   26:astore_3        
	...
	//   18   30:iconst_1        
	//   19   31:iconst_0        
	//   20   32:invokevirtual   #152 <Method void loadImage(Drawable, boolean, boolean, boolean)>
		}
	//   21   35:return          
	}
	...
	//*   2    4:ifeq            21
			context = ((Context) (zza(context, postprocessedresourcecache, mNoDataPlaceholderResId)));
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:aload_2         
	//    6   10:aload_0         
	//    7   11:getfield        #41  <Field int mNoDataPlaceholderResId>
	//    8   14:invokespecial   #155 <Method Drawable zza(Context, PostProcessedResourceCache, int)>
	//    9   17:astore_1        
		else
	//*  10   18:goto            23
			context = null;
	...
	//   12   22:astore_1        
		if(mOnImageLoadedListener != null)
	//*  13   23:aload_0         
	//*  14   24:getfield        #120 <Field ImageManager$OnImageLoadedListener mOnImageLoadedListener>
	//*  15   27:ifnull          48
			mOnImageLoadedListener.onImageLoaded(zzpk.uri, ((Drawable) (context)), false);
	//   16   30:aload_0         
	//   17   31:getfield        #120 <Field ImageManager$OnImageLoadedListener mOnImageLoadedListener>
	//   18   34:aload_0         
	//   19   35:getfield        #54  <Field ImageRequest$zza zzpk>
	//   20   38:getfield        #144 <Field Uri ImageRequest$zza.uri>
	//   21   41:aload_1         
	//   22   42:iconst_0        
	//   23   43:invokeinterface #150 <Method void ImageManager$OnImageLoadedListener.onImageLoaded(Uri, Drawable, boolean)>
	...
	//   27   51:iconst_0        
	//   28   52:iconst_0        
	//   29   53:invokevirtual   #152 <Method void loadImage(Drawable, boolean, boolean, boolean)>
	//   30   56:return          
	}
