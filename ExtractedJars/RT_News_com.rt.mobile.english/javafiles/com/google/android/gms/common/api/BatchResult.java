	...
	implements Result
{
	...
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #20  <Field PendingResult[] zzcg>
	//    8   14:return          
	}
	...
	{
		boolean flag;
		if(batchresulttoken.mId < zzcg.length)
	//*   0    0:aload_1         
	//*   1    1:getfield        #33  <Field int BatchResultToken.mId>
	//*   2    4:aload_0         
	//*   3    5:getfield        #20  <Field PendingResult[] zzcg>
	//*   4    8:arraylength     
	//*   5    9:icmpge          17
			flag = true;
	//    6   12:iconst_1        
	...
	//   13   22:invokestatic    #41  <Method void Preconditions.checkArgument(boolean, Object)>
		return zzcg[batchresulttoken.mId].await(0L, TimeUnit.MILLISECONDS);
	//   14   25:aload_0         
	//   15   26:getfield        #20  <Field PendingResult[] zzcg>
	//   16   29:aload_1         
