...
public class SignUp
{
	...
	//   49   94:new             #96  <Class IllegalStateException>
	//   50   97:dup             
	//   51   98:ldc1            #98  <String "Given account does not exist on the device">
	//   52  100:invokespecial   #101 <Method void IllegalStateException(String)>
	//   53  103:athrow          
		else
			return ((AccountManager) (context)).hasFeatures(new Account(s, "com.google"), as, accountmanagercallback, handler);
	//   54  104:aload_0         
	//   55  105:new             #85  <Class Account>
	//   56  108:dup             
	//   57  109:aload_1         
	//   58  110:ldc1            #79  <String "com.google">
	//   59  112:invokespecial   #104 <Method void Account(String, String)>
	//   60  115:aload_2         
	//   61  116:aload_3         
	//   62  117:aload           4
	//   63  119:invokevirtual   #108 <Method AccountManagerFuture AccountManager.hasFeatures(Account, String[], AccountManagerCallback, Handler)>
	//   64  122:areturn         
	}
