...
public class SafeParcelReader
{
	...
	//    4    8:new             #270 <Class StringBuilder>
	//    5   11:dup             
	//    6   12:bipush          37
	//    7   14:invokespecial   #271 <Method void StringBuilder(int)>
	//    8   17:astore_2        
			stringbuilder.append("Overread allowed size end=");
	//    9   18:aload_2         
	//   10   19:ldc2            #273 <String "Overread allowed size end=">
	//   11   22:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   12   25:pop             
			stringbuilder.append(i);
	//   13   26:aload_2         
	//   14   27:iload_1         
	//   15   28:invokevirtual   #279 <Method StringBuilder StringBuilder.append(int)>
	//   16   31:pop             
			throw new ParseException(stringbuilder.toString(), parcel);
	//   17   32:new             #6   <Class SafeParcelReader$ParseException>
	//   18   35:dup             
	//   19   36:aload_2         
	//   20   37:invokevirtual   #282 <Method String StringBuilder.toString()>
	//   21   40:aload_0         
	//   22   41:invokespecial   #285 <Method void SafeParcelReader$ParseException(String, Parcel)>
	//   23   44:athrow          
		} else
		{
			return;
	...
	//   51  101:new             #270 <Class StringBuilder>
	//   52  104:dup             
	//   53  105:bipush          54
	//   54  107:invokespecial   #271 <Method void StringBuilder(int)>
	//   55  110:astore          4
			stringbuilder.append("Size read is invalid start=");
	//   56  112:aload           4
	//   57  114:ldc2            #357 <String "Size read is invalid start=">
	//   58  117:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   59  120:pop             
			stringbuilder.append(i);
	//   60  121:aload           4
	//   61  123:iload_1         
	//   62  124:invokevirtual   #279 <Method StringBuilder StringBuilder.append(int)>
	//   63  127:pop             
			stringbuilder.append(" end=");
	//   64  128:aload           4
	//   65  130:ldc2            #359 <String " end=">
	//   66  133:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   67  136:pop             
			stringbuilder.append(j);
	//   68  137:aload           4
	//   69  139:iload_2         
	//   70  140:invokevirtual   #279 <Method StringBuilder StringBuilder.append(int)>
	//   71  143:pop             
			throw new ParseException(stringbuilder.toString(), parcel);
	//   72  144:new             #6   <Class SafeParcelReader$ParseException>
	//   73  147:dup             
	//   74  148:aload           4
	//   75  150:invokevirtual   #282 <Method String StringBuilder.toString()>
	//   76  153:aload_0         
	//   77  154:invokespecial   #285 <Method void SafeParcelReader$ParseException(String, Parcel)>
	//   78  157:athrow          
		}
	}
	...
	//    7   11:iload_1         
	//    8   12:invokestatic    #335 <Method String Integer.toHexString(int)>
	//    9   15:astore_3        
			StringBuilder stringbuilder = new StringBuilder(46 + String.valueOf(((Object) (s))).length());
	//   10   16:new             #270 <Class StringBuilder>
	//   11   19:dup             
	//   12   20:bipush          46
	//   13   22:aload_3         
	//   14   23:invokestatic    #340 <Method String String.valueOf(Object)>
	//   15   26:invokevirtual   #343 <Method int String.length()>
	//   16   29:iadd            
	//   17   30:invokespecial   #271 <Method void StringBuilder(int)>
	//   18   33:astore          4
			stringbuilder.append("Expected size ");
	//   19   35:aload           4
	//   20   37:ldc2            #361 <String "Expected size ">
	//   21   40:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   22   43:pop             
			stringbuilder.append(j);
	//   23   44:aload           4
	//   24   46:iload_2         
	//   25   47:invokevirtual   #279 <Method StringBuilder StringBuilder.append(int)>
	//   26   50:pop             
			stringbuilder.append(" got ");
	//   27   51:aload           4
	//   28   53:ldc2            #363 <String " got ">
	//   29   56:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   30   59:pop             
			stringbuilder.append(i);
	//   31   60:aload           4
	//   32   62:iload_1         
	//   33   63:invokevirtual   #279 <Method StringBuilder StringBuilder.append(int)>
	//   34   66:pop             
			stringbuilder.append(" (0x");
	//   35   67:aload           4
	//   36   69:ldc2            #365 <String " (0x">
	//   37   72:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   38   75:pop             
			stringbuilder.append(s);
	//   39   76:aload           4
	//   40   78:aload_3         
	//   41   79:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   42   82:pop             
			stringbuilder.append(")");
	//   43   83:aload           4
	//   44   85:ldc2            #367 <String ")">
	//   45   88:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   46   91:pop             
			throw new ParseException(stringbuilder.toString(), parcel);
	//   47   92:new             #6   <Class SafeParcelReader$ParseException>
	//   48   95:dup             
	//   49   96:aload           4
	//   50   98:invokevirtual   #282 <Method String StringBuilder.toString()>
	//   51  101:aload_0         
	//   52  102:invokespecial   #285 <Method void SafeParcelReader$ParseException(String, Parcel)>
	//   53  105:athrow          
		} else
		{
			return;
	...
	//    3    5:iload_2         
	//    4    6:invokestatic    #335 <Method String Integer.toHexString(int)>
	//    5    9:astore          4
			StringBuilder stringbuilder = new StringBuilder(46 + String.valueOf(((Object) (s))).length());
	//    6   11:new             #270 <Class StringBuilder>
	//    7   14:dup             
	//    8   15:bipush          46
	//    9   17:aload           4
	//   10   19:invokestatic    #340 <Method String String.valueOf(Object)>
	//   11   22:invokevirtual   #343 <Method int String.length()>
	//   12   25:iadd            
	//   13   26:invokespecial   #271 <Method void StringBuilder(int)>
	//   14   29:astore          5
			stringbuilder.append("Expected size ");
	//   15   31:aload           5
	//   16   33:ldc2            #361 <String "Expected size ">
	//   17   36:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   18   39:pop             
			stringbuilder.append(k);
	//   19   40:aload           5
	//   20   42:iload_3         
	//   21   43:invokevirtual   #279 <Method StringBuilder StringBuilder.append(int)>
	//   22   46:pop             
			stringbuilder.append(" got ");
	//   23   47:aload           5
	//   24   49:ldc2            #363 <String " got ">
	//   25   52:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   26   55:pop             
			stringbuilder.append(j);
	//   27   56:aload           5
	//   28   58:iload_2         
	//   29   59:invokevirtual   #279 <Method StringBuilder StringBuilder.append(int)>
	//   30   62:pop             
			stringbuilder.append(" (0x");
	//   31   63:aload           5
	//   32   65:ldc2            #365 <String " (0x">
	//   33   68:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   34   71:pop             
			stringbuilder.append(s);
	//   35   72:aload           5
	//   36   74:aload           4
	//   37   76:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   38   79:pop             
			stringbuilder.append(")");
	//   39   80:aload           5
	//   40   82:ldc2            #367 <String ")">
	//   41   85:invokevirtual   #276 <Method StringBuilder StringBuilder.append(String)>
	//   42   88:pop             
			throw new ParseException(stringbuilder.toString(), parcel);
	//   43   89:new             #6   <Class SafeParcelReader$ParseException>
	//   44   92:dup             
	//   45   93:aload           5
	//   46   95:invokevirtual   #282 <Method String StringBuilder.toString()>
	//   47   98:aload_0         
	//   48   99:invokespecial   #285 <Method void SafeParcelReader$ParseException(String, Parcel)>
	//   49  102:athrow          
		} else
		{
			return;
