...
public class GoogleSignatureVerifier
{
	...
	//*   9   19:aload_1         
	//*  10   20:aload_3         
	//*  11   21:invokestatic    #247 <Method GoogleCertificates$CertData zza(PackageInfo, GoogleCertificates$CertData[])>
	//*  12   24:astore_1        
	//*  13   25:goto            44
			{
				acertdata = new GoogleCertificates.CertData[1];
	//   14   28:iconst_1        
	//   15   29:anewarray       GoogleCertificates.CertData[]
	//   16   32:astore_3        
				acertdata[0] = zzd.zzbg[0];
	//   17   33:aload_3         
	//   18   34:iconst_0        
	//   19   35:getstatic       #245 <Field GoogleCertificates$CertData[] zzd.zzbg>
	//   20   38:iconst_0        
	//   21   39:aaload          
	//   22   40:aastore         
			}
			packageinfo = ((PackageInfo) (zza(packageinfo, acertdata)));
	//*  23   41:goto            19
			if(packageinfo != null)
	//*  24   44:aload_1         
	//*  25   45:ifnull          50
