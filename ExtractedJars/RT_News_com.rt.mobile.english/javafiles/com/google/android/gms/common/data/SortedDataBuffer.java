	...
	implements DataBuffer
{
	...
	//    9   19:putfield        #27  <Field Integer[] zzol>
		for(int i = 0; i < zzol.length; i++)
	//*  10   22:iconst_0        
	//*  11   23:istore_3        
	//*  12   24:iload_3         
	//*  13   25:aload_0         
	//*  14   26:getfield        #27  <Field Integer[] zzol>
	//*  15   29:arraylength     
	//*  16   30:icmpge          50
			zzol[i] = Integer.valueOf(i);
	//   17   33:aload_0         
	//   18   34:getfield        #27  <Field Integer[] zzol>
	//   19   37:iload_3         
	//   20   38:iload_3         
	//   21   39:invokestatic    #31  <Method Integer Integer.valueOf(int)>
	//   22   42:aastore         
	...
	//   26   46:istore_3        
	//*  27   47:goto            24
		Arrays.sort(((Object []) (zzol)), ((Comparator) (new zzb(this, comparator))));
	//   28   50:aload_0         
	//   29   51:getfield        #27  <Field Integer[] zzol>
	//   30   54:new             #33  <Class zzb>
	//   31   57:dup             
	//   32   58:aload_0         
	//   33   59:aload_2         
	//   34   60:invokespecial   #36  <Method void zzb(SortedDataBuffer, Comparator)>
	//   35   63:invokestatic    #42  <Method void Arrays.sort(Object[], Comparator)>
	//   36   66:return          
	}
