...
public final class WakeLockEvent extends StatsEvent
{
	...
	//   49  104:astore          7
		StringBuilder stringbuilder = new StringBuilder(45 + String.valueOf(((Object) (s4))).length() + String.valueOf(((Object) (s))).length() + String.valueOf(((Object) (s1))).length() + String.valueOf(((Object) (s2))).length() + String.valueOf(((Object) (s3))).length());
	//   50  106:new             #179 <Class StringBuilder>
	//   51  109:dup             
	//   52  110:bipush          45
	//   53  112:aload           8
	//   54  114:invokestatic    #185 <Method String String.valueOf(Object)>
	//   55  117:invokevirtual   #188 <Method int String.length()>
	//   56  120:iadd            
	//   57  121:aload           4
	...
	//    5    9:aload_0         
	//    6   10:aload_0         
	//    7   11:getfield        #108 <Field long mTimeout>
	//    8   14:putfield        #94  <Field long zzyf>
		int i;
		if(7 == zzxw)
	//*   9   17:bipush          7
	//*  10   19:aload_0         
	//*  11   20:getfield        #82  <Field int zzxw>
	//*  12   23:icmpne          36
			i = 9;
	//   13   26:bipush          9
	//   14   28:istore_1        
	...
	//*  15   29:aload_0         
	//*  16   30:iload_1         
	//*  17   31:putfield        #82  <Field int zzxw>
	//*  18   34:aload_0         
	//*  19   35:areturn         
		if(10 == zzxw)
	//*  20   36:bipush          10
	//*  21   38:aload_0         
	//*  22   39:getfield        #82  <Field int zzxw>
	//*  23   42:icmpne          51
			i = 12;
	//   24   45:bipush          12
	//   25   47:istore_1        
