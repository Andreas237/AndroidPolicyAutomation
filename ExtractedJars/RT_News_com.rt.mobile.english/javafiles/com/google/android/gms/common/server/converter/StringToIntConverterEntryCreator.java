	...
	implements android.os.Parcelable.Creator
{
	...
	//   40  103:invokestatic    #51  <Method void SafeParcelReader.ensureAtEnd(Parcel, int)>
				return new StringToIntConverter.Entry(j, s, i);
	//   41  106:new             #53  <Class StringToIntConverter$Entry>
	//   42  109:dup             
	//   43  110:iload_3         
	//   44  111:aload           6
	//   45  113:iload_2         
	//   46  114:invokespecial   #56  <Method void StringToIntConverter$Entry(int, String, int)>
	//   47  117:areturn         
			}
		while(true);
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #59  <Method StringToIntConverter$Entry createFromParcel(Parcel)>
	//    3    5:areturn         
	}
	...
	//    0    0:iload_1         
	//    1    1:anewarray       StringToIntConverter.Entry[]
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #64  <Method StringToIntConverter$Entry[] newArray(int)>
	//    3    5:areturn         
	}
