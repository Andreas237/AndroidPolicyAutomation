...
_L1:
	...
	//   22   46:aload           8
		JVM INSTR monitorenter ;
	//   23   48:monitorenter    
		Preconditions.checkState(zztl ^ true);
	//   24   49:aload_0         
	//   25   50:getfield        #52  <Field boolean zztl>
	//   26   53:iconst_1        
	//   27   54:ixor            
	//   28   55:invokestatic    #183 <Method void Preconditions.checkState(boolean)>
		mHandler.removeMessages(1);
	//   29   58:aload_0         
	//   30   59:getfield        #63  <Field Handler mHandler>
	//   31   62:iconst_1        
	//   32   63:invokevirtual   #157 <Method void Handler.removeMessages(int)>
		zztl = true;
	//   33   66:aload_0         
	//   34   67:iconst_1        
	//   35   68:putfield        #52  <Field boolean zztl>
		int i;
		int j;
		int k;
		int l;
		...
		if(zzth.size() == 0)
	//*  36   71:aload_0         
	//*  37   72:getfield        #39  <Field ArrayList zzth>
	//*  38   75:invokevirtual   #166 <Method int ArrayList.size()>
	//*  39   78:ifne            236
			flag1 = flag2;
	//   40   81:iload           7
	//   41   83:istore          6
	...
	//*  42   85:goto            88
	//*  43   88:iload           6
	//*  44   90:invokestatic    #183 <Method void Preconditions.checkState(boolean)>
	//*  45   93:new             #34  <Class ArrayList>
	//*  46   96:dup             
	//*  47   97:aload_0         
	//*  48   98:getfield        #37  <Field ArrayList zztg>
	//*  49  101:invokespecial   #160 <Method void ArrayList(java.util.Collection)>
	//*  50  104:astore          9
	//*  51  106:aload_0         
	//*  52  107:getfield        #50  <Field AtomicInteger zztk>
	//*  53  110:invokevirtual   #163 <Method int AtomicInteger.get()>
	//*  54  113:istore          4
	//*  55  115:aload           9
	//*  56  117:checkcast       #34  <Class ArrayList>
	//*  57  120:astore          9
	//*  58  122:aload           9
	//*  59  124:invokevirtual   #166 <Method int ArrayList.size()>
	//*  60  127:istore          5
	//*  61  129:iconst_0        
	//*  62  130:istore_2        
	//*  63  131:iload_2         
	...
	//*  66  137:aload           9
	//*  67  139:iload_2         
	//*  68  140:invokevirtual   #169 <Method Object ArrayList.get(int)>
	//*  69  143:astore          10
	//*  70  145:iload_2         
	//*  71  146:iconst_1        
	//*  72  147:iadd            
	...
	//*  76  154:astore          10
	//*  77  156:aload_0         
	//*  78  157:getfield        #43  <Field boolean zztj>
	//*  79  160:ifeq            214
	//*  80  163:aload_0         
	//*  81  164:getfield        #56  <Field GmsClientEventManager$GmsClientEventState zztf>
	//*  82  167:invokeinterface #88  <Method boolean GmsClientEventManager$GmsClientEventState.isConnected()>
	//*  83  172:ifeq            214
	//*  84  175:aload_0         
	//*  85  176:getfield        #50  <Field AtomicInteger zztk>
	//*  86  179:invokevirtual   #163 <Method int AtomicInteger.get()>
	//*  87  182:iload           4
	//*  88  184:icmpne          214
	//*  89  187:iload_3         
	//*  90  188:istore_2        
	//*  91  189:aload_0         
	//*  92  190:getfield        #39  <Field ArrayList zzth>
	//*  93  193:aload           10
	...
	//* 101  211:goto            131
	//* 102  214:aload_0         
	//* 103  215:getfield        #39  <Field ArrayList zzth>
	//* 104  218:invokevirtual   #186 <Method void ArrayList.clear()>
	//* 105  221:aload_0         
	//* 106  222:iconst_0        
	//* 107  223:putfield        #52  <Field boolean zztl>
	//* 108  226:aload           8
	//* 109  228:monitorexit     
	//* 110  229:return          
	//* 111  230:astore_1        
...
_L1:
	...
	//   15   27:astore_3        
			StringBuilder stringbuilder = new StringBuilder(62 + String.valueOf(((Object) (s))).length());
	//   16   28:new             #102 <Class StringBuilder>
	//   17   31:dup             
	//   18   32:bipush          62
	//   19   34:aload_3         
	//   20   35:invokestatic    #200 <Method String String.valueOf(Object)>
	//   21   38:invokevirtual   #203 <Method int String.length()>
	//   22   41:iadd            
	...
	//   58  115:iconst_1        
	//   59  116:aload_1         
	//   60  117:invokevirtual   #218 <Method Message Handler.obtainMessage(int, Object)>
	//   61  120:invokevirtual   #221 <Method boolean Handler.sendMessage(Message)>
	//   62  123:pop             
		return;
	//   63  124:return          
		connectioncallbacks;
	...
	//   14   24:invokestatic    #200 <Method String String.valueOf(Object)>
	//   15   27:astore_1        
			StringBuilder stringbuilder = new StringBuilder(67 + String.valueOf(((Object) (onconnectionfailedlistener))).length());
	//   16   28:new             #102 <Class StringBuilder>
	//   17   31:dup             
	//   18   32:bipush          67
	//   19   34:aload_1         
	...
	//   14   24:invokestatic    #200 <Method String String.valueOf(Object)>
	//   15   27:astore_1        
			StringBuilder stringbuilder = new StringBuilder(52 + String.valueOf(((Object) (connectioncallbacks))).length());
	//   16   28:new             #102 <Class StringBuilder>
	//   17   31:dup             
	//   18   32:bipush          52
	//   19   34:aload_1         
	...
	//   14   24:invokestatic    #200 <Method String String.valueOf(Object)>
	//   15   27:astore_1        
				StringBuilder stringbuilder = new StringBuilder(57 + String.valueOf(((Object) (onconnectionfailedlistener))).length());
	//   16   28:new             #102 <Class StringBuilder>
	//   17   31:dup             
	//   18   32:bipush          57
	//   19   34:aload_1         
