	...
	implements android.os.Parcelable.Creator
{
	...
	//*  31   55:aload_1         
	//*  32   56:invokevirtual   #29  <Method int Parcel.dataPosition()>
	//*  33   59:iload           7
	//*  34   61:icmpge          317
			{
				int j1 = SafeParcelReader.readHeader(parcel);
	//   35   64:aload_1         
	//   36   65:invokestatic    #32  <Method int SafeParcelReader.readHeader(Parcel)>
	//   37   68:istore          8
				switch(SafeParcelReader.getFieldId(j1))
	//*  38   70:iload           8
	//*  39   72:invokestatic    #36  <Method int SafeParcelReader.getFieldId(int)>
				{
	//*  40   75:tableswitch     1 17: default 156
	//	               1 306
	//	               2 295
	//	               3 156
	//	               4 284
	...
	//   65  208:aload_1         
	//   66  209:iload           8
	//   67  211:invokestatic    #44  <Method String SafeParcelReader.createString(Parcel, int)>
	//   68  214:astore          18
					break;
	...
	//   70  219:aload_1         
	//   71  220:iload           8
	//   72  222:invokestatic    #44  <Method String SafeParcelReader.createString(Parcel, int)>
	//   73  225:astore          16
					break;
	...
	//   75  230:aload_1         
	//   76  231:iload           8
	//   77  233:invokestatic    #56  <Method int SafeParcelReader.readInt(Parcel, int)>
	//   78  236:istore_3        
					break;
	...
	//  117  320:invokestatic    #63  <Method void SafeParcelReader.ensureAtEnd(Parcel, int)>
				return new WakeLockEvent(l, l3, i, s, j, ((java.util.List) (obj)), ((String) (obj1)), l1, k, ((String) (obj2)), ((String) (obj3)), f, l2, ((String) (obj4)));
