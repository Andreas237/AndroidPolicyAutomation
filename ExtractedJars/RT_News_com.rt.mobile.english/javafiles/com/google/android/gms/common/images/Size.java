...
public final class Size
{
	...
	//*  20   35:ifge            43
			throw zzi(s);
	//   21   38:aload_0         
	//   22   39:invokestatic    #38  <Method NumberFormatException zzi(String)>
	//   23   42:athrow          
		Size size;
		try
		{
	...
	//*  40   71:areturn         
	//*  41   72:aload_0         
	//*  42   73:invokestatic    #38  <Method NumberFormatException zzi(String)>
	//*  43   76:athrow          
	...
	{
		StringBuilder stringbuilder = new StringBuilder(16 + String.valueOf(((Object) (s))).length());
	//    0    0:new             #56  <Class StringBuilder>
	//    1    3:dup             
	//    2    4:bipush          16
	//    3    6:aload_0         
	//    4    7:invokestatic    #60  <Method String String.valueOf(Object)>
	//    5   10:invokevirtual   #64  <Method int String.length()>
	//    6   13:iadd            
	...
	{
		return zzpt ^ (zzps << 16 | zzps >>> 16);
	//    0    0:aload_0         
	//    1    1:getfield        #16  <Field int zzpt>
	//    2    4:aload_0         
	//    3    5:getfield        #14  <Field int zzps>
	//    4    8:bipush          16
	//    5   10:ishl            
	//    6   11:aload_0         
	//    7   12:getfield        #14  <Field int zzps>
	//    8   15:bipush          16
	//    9   17:iushr           
	//   10   18:ior             
	//   11   19:ixor            
