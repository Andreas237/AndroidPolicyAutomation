...
public class ViewUtils
{
	...
	//   37   68:astore_2        
						StringBuilder stringbuilder = new StringBuilder(8 + String.valueOf(((Object) (s4))).length() + String.valueOf(((Object) (s3))).length());
	//   38   69:new             #46  <Class StringBuilder>
	//   39   72:dup             
	//   40   73:bipush          8
	//   41   75:aload           8
	//   42   77:invokestatic    #50  <Method String String.valueOf(Object)>
	//   43   80:invokevirtual   #54  <Method int String.length()>
	//   44   83:iadd            
	//   45   84:aload           7
	...
	//*  72  140:bipush          30
	//*  73  142:aload_1         
	//*  74  143:invokestatic    #50  <Method String String.valueOf(Object)>
	//*  75  146:invokevirtual   #54  <Method int String.length()>
	//*  76  149:iadd            
	//*  77  150:aload_0         
	...
	//* 117  227:bipush          28
	//* 118  229:aload_1         
	//* 119  230:invokestatic    #50  <Method String String.valueOf(Object)>
	//* 120  233:invokevirtual   #54  <Method int String.length()>
	//* 121  236:iadd            
	//* 122  237:aload_2         
	...
	//* 157  300:bipush          33
	//* 158  302:aload_1         
	//* 159  303:invokestatic    #50  <Method String String.valueOf(Object)>
	//* 160  306:invokevirtual   #54  <Method int String.length()>
	//* 161  309:iadd            
	...
	//* 182  345:areturn         
					...
					{
						context = ((Context) (new StringBuilder(30 + String.valueOf(((Object) (s1))).length() + String.valueOf(((Object) (s))).length())));
					...
					} else
					{
						...
						attributeset = ((AttributeSet) (new StringBuilder(28 + String.valueOf(((Object) (s1))).length() + String.valueOf(((Object) (context))).length())));
		...
		{
			s = ((String) (new StringBuilder(33 + String.valueOf(((Object) (s1))).length())));
