...
public class AuthAccountRequest extends AbstractSafeParcelable
{
	...
	//*   2    4:ifnull          12
			return zzs;
	//    3    7:aload_0         
	//    4    8:getfield        #59  <Field Account zzs>
	//    5   11:areturn         
		if(zzqv != null)
	//*   6   12:aload_0         
	//*   7   13:getfield        #51  <Field IBinder zzqv>
	//*   8   16:ifnull          30
			return AccountAccessor.getAccountBinderSafe(IAccountAccessor.Stub.asInterface(zzqv));
	//    9   19:aload_0         
	//   10   20:getfield        #51  <Field IBinder zzqv>
	//   11   23:invokestatic    #104 <Method IAccountAccessor IAccountAccessor$Stub.asInterface(IBinder)>
	//   12   26:invokestatic    #110 <Method Account AccountAccessor.getAccountBinderSafe(IAccountAccessor)>
	//   13   29:areturn         
		else
			return null;
	//   14   30:aconst_null     
