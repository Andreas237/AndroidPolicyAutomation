...
label3:
		...
		//   47  131:aload_3         
		//   48  132:aload_2         
		//   49  133:invokestatic    #87  <Method void zzc.zza(Parcel, IInterface)>
			}
			return true;
		//   50  136:iconst_1        
		//   51  137:ireturn         
		...
		implements IGoogleCertificatesApi
	{
		...
		//    6   12:aload           4
		//    7   14:aload_2         
		//    8   15:invokestatic    #59  <Method void zzc.zza(Parcel, IInterface)>
	...
	public abstract boolean isGoogleOrPlatformSigned(GoogleCertificatesQuery googlecertificatesquery, IObjectWrapper iobjectwrapper)
		throws RemoteException;

	public abstract boolean isGoogleReleaseSigned(String s, IObjectWrapper iobjectwrapper)
		throws RemoteException;

	public abstract boolean isGoogleSigned(String s, IObjectWrapper iobjectwrapper)
		throws RemoteException;
}
