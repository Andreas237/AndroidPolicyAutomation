...
public class BaseApi
{
	public static class BaseApiaryOptions
	{
		...
		//*   2    4:ifnull          15
				zzvv = baseapiaryoptions.zzvv;
		//    3    7:aload_0         
		//    4    8:aload_1         
		//    5    9:getfield        #77  <Field String zzvv>
		//    6   12:putfield        #77  <Field String zzvv>
			if(!baseapiaryoptions.zzvt.isEmpty())
		//*   7   15:aload_1         
		//*   8   16:getfield        #31  <Field ArrayList zzvt>
		//*   9   19:invokevirtual   #85  <Method boolean ArrayList.isEmpty()>
		//*  10   22:ifne            44
			{
				zzvt.clear();
		//   11   25:aload_0         
		//   12   26:getfield        #31  <Field ArrayList zzvt>
		//   13   29:invokevirtual   #115 <Method void ArrayList.clear()>
				zzvt.addAll(((java.util.Collection) (baseapiaryoptions.zzvt)));
		//   14   32:aload_0         
		//   15   33:getfield        #31  <Field ArrayList zzvt>
		//   16   36:aload_1         
		//   17   37:getfield        #31  <Field ArrayList zzvt>
		//   18   40:invokevirtual   #119 <Method boolean ArrayList.addAll(java.util.Collection)>
		//   19   43:pop             
			}
			return this;
		//   20   44:aload_0         
...
_L3:
	...
	//*  15   29:aload           4
	//*  16   31:iload_3         
	//*  17   32:invokevirtual   #38  <Method StringBuilder StringBuilder.append(char)>
	//*  18   35:pop             
	//*  19   36:goto            45
			c = '?';
	//   20   39:bipush          63
	...
	//   23   45:aload           4
	//   24   47:aload_1         
	//   25   48:invokevirtual   #27  <Method StringBuilder StringBuilder.append(String)>
	//   26   51:pop             
		stringbuilder.append('=');
	//   27   52:aload           4
	//   28   54:bipush          61
	//   29   56:invokevirtual   #38  <Method StringBuilder StringBuilder.append(char)>
	//   30   59:pop             
		stringbuilder.append(s2);
	//   31   60:aload           4
	//   32   62:aload_2         
	//   33   63:invokevirtual   #27  <Method StringBuilder StringBuilder.append(String)>
	//   34   66:pop             
		return stringbuilder.toString();
	//   35   67:aload           4
	//   36   69:invokevirtual   #42  <Method String StringBuilder.toString()>
	//   37   72:areturn         
	}
	...
	//*   7   13:aload_0         
	//*   8   14:iload_3         
	//*   9   15:invokevirtual   #38  <Method StringBuilder StringBuilder.append(char)>
	//*  10   18:pop             
	//*  11   19:goto            28
			c = '?';
	//   12   22:bipush          63
	...
	//   15   28:aload_0         
	//   16   29:aload_1         
	//   17   30:invokevirtual   #27  <Method StringBuilder StringBuilder.append(String)>
	//   18   33:pop             
		stringbuilder.append('=');
	//   19   34:aload_0         
	//   20   35:bipush          61
	//   21   37:invokevirtual   #38  <Method StringBuilder StringBuilder.append(char)>
	//   22   40:pop             
		stringbuilder.append(s1);
	//   23   41:aload_0         
	//   24   42:aload_2         
	//   25   43:invokevirtual   #27  <Method StringBuilder StringBuilder.append(String)>
	//   26   46:pop             
	//   27   47:return          
	}
