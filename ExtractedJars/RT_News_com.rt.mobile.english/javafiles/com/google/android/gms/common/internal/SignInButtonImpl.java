...
public final class SignInButtonImpl extends Button
{
	...
	private static int zza(int i, int j, int k, int l)
	{
		switch(i)
	//*   0    0:iload_0         
		{
	...
	//   20   38:invokevirtual   #76  <Method void setMinWidth(int)>
		k = zza(j, com.google.android.gms.base.R.drawable.common_google_signin_btn_icon_dark, com.google.android.gms.base.R.drawable.common_google_signin_btn_icon_light, com.google.android.gms.base.R.drawable.common_google_signin_btn_icon_light);
	//   21   41:iload_3         
	...
	//   25   51:invokestatic    #87  <Method int zza(int, int, int, int)>
	//   26   54:istore          4
		int l = zza(j, com.google.android.gms.base.R.drawable.common_google_signin_btn_text_dark, com.google.android.gms.base.R.drawable.common_google_signin_btn_text_light, com.google.android.gms.base.R.drawable.common_google_signin_btn_text_light);
	//   27   56:iload_3         
	...
	//   31   66:invokestatic    #87  <Method int zza(int, int, int, int)>
	//   32   69:istore          5
	...
	//   78  188:invokestatic    #87  <Method int zza(int, int, int, int)>
...
_L3:
	...
	//  108  275:getstatic       #155 <Field int com.google.android.gms.base.R$string.common_signin_button_text_long>
	//  109  278:istore_2        
		  goto _L6
	//* 110  279:goto            286
_L2:
		i = com.google.android.gms.base.R.string.common_signin_button_text;
	//  111  282:getstatic       #158 <Field int com.google.android.gms.base.R$string.common_signin_button_text>
	//  112  285:istore_2        
_L6:
	...
	//  114  287:aload_1         
	//  115  288:iload_2         
	//  116  289:invokevirtual   #162 <Method String Resources.getString(int)>
	//  117  292:invokevirtual   #150 <Method void setText(CharSequence)>
_L5:
		setTransformationMethod(((android.text.method.TransformationMethod) (null)));
	//  118  295:aload_0         
	//  119  296:aconst_null     
	//  120  297:invokevirtual   #166 <Method void setTransformationMethod(android.text.method.TransformationMethod)>
		if(DeviceProperties.isWearable(getContext()))
	//* 121  300:aload_0         
	//* 122  301:invokevirtual   #170 <Method Context getContext()>
	//* 123  304:invokestatic    #176 <Method boolean DeviceProperties.isWearable(Context)>
	//* 124  307:ifeq            316
			setGravity(19);
	//  125  310:aload_0         
	//  126  311:bipush          19
	//  127  313:invokevirtual   #179 <Method void setGravity(int)>
		return;
	//  128  316:return          
	}
