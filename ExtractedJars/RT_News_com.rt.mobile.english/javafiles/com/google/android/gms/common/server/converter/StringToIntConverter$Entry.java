...
public static final class StringToIntConverter$Entry extends AbstractSafeParcelable
{
	...
	StringToIntConverter$Entry(int i, String s, int j)
	{
	//    0    0:aload_0         
	...
	StringToIntConverter$Entry(String s, int i)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #38  <Method void AbstractSafeParcelable()>
		versionCode = 1;
