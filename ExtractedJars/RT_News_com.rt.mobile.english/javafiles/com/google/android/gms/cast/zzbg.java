...
final class zzbg extends RemoteMediaPlayer.zzb
{
	...
	zzbg(RemoteMediaPlayer remotemediaplayer, GoogleApiClient googleapiclient, GoogleApiClient googleapiclient1, JSONObject jsonobject)
	{
	...
	//   11   21:invokevirtual   #51  <Method void RemoteMediaPlayer$zza.zza(GoogleApiClient)>
		RemoteMediaPlayer.zzg(zzfa).zzb(zzgc, zzfi);
	//   12   24:aload_0         
	...
	//   17   35:aload_0         
	//   18   36:getfield        #18  <Field JSONObject zzfi>
	//   19   39:invokevirtual   #65  <Method long zzdh.zzb(com.google.android.gms.internal.cast.zzdm, JSONObject)>
	//   20   42:pop2            
...
_L4:
	...
	//   31   63:aload_0         
	//   32   64:aload_0         
	//   33   65:new             #67  <Class Status>
	//   34   68:dup             
	//   35   69:sipush          2100
	//   36   72:invokespecial   #70  <Method void Status(int)>
	//   37   75:invokevirtual   #74  <Method com.google.android.gms.common.api.Result RemoteMediaPlayer$zzb.createFailedResult(Status)>
	//   38   78:checkcast       #76  <Class RemoteMediaPlayer$MediaChannelResult>
	//   39   81:invokevirtual   #80  <Method void setResult(com.google.android.gms.common.api.Result)>
		zzcn1 = ((zzcn) (RemoteMediaPlayer.zzf(zzfa)));
	//   40   84:aload_0         
