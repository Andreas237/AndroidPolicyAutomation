...
final class zzbk extends RemoteMediaPlayer.zzb
{
	...
	zzbk(RemoteMediaPlayer remotemediaplayer, GoogleApiClient googleapiclient, GoogleApiClient googleapiclient1, boolean flag, JSONObject jsonobject)
	{
	...
	//    6   10:aload_0         
	//    7   11:iload           4
	//    8   13:putfield        #20  <Field boolean zzfx>
		zzfi = jsonobject;
	//    9   16:aload_0         
	//   10   17:aload           5
	...
	//   11   21:invokevirtual   #55  <Method void RemoteMediaPlayer$zza.zza(GoogleApiClient)>
		RemoteMediaPlayer.zzg(zzfa).zza(zzgc, zzfx, zzfi);
	//   12   24:aload_0         
	...
	//   17   35:aload_0         
	//   18   36:getfield        #20  <Field boolean zzfx>
	//   19   39:aload_0         
	//   20   40:getfield        #22  <Field JSONObject zzfi>
	//   21   43:invokevirtual   #68  <Method long zzdh.zza(com.google.android.gms.internal.cast.zzdm, boolean, JSONObject)>
	//   22   46:pop2            
