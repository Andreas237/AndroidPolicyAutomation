...
//			Cast, ApplicationMetadata, LaunchOptions, zzi, 
//			zzg, zzh, zzj, zzf, 
//			zzk, zzl, zzaf
...
public static interface Cast$CastApi
{
		...
		implements Cast.CastApi
	{
		...
		public final void setMessageReceivedCallbacks(GoogleApiClient googleapiclient, String s, Cast.MessageReceivedCallback messagereceivedcallback)
			throws IOException, IllegalStateException
		{
			try
			{
