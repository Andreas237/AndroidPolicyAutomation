...
private final class MediaCodecAudioRenderer$AudioSinkListener
	implements AudioSink.Listener
{

	public void onAudioSessionId(int i)
	{
		MediaCodecAudioRenderer.access$100(MediaCodecAudioRenderer.this).audioSessionId(i);
	//    0    0:aload_0         
	...
	{
		MediaCodecAudioRenderer.access$100(MediaCodecAudioRenderer.this).audioTrackUnderrun(i, l, l1);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field MediaCodecAudioRenderer this$0>
	//    2    4:invokestatic    #28  <Method AudioRendererEventListener$EventDispatcher MediaCodecAudioRenderer.access$100(MediaCodecAudioRenderer)>
	//    3    7:iload_1         
	...
	private MediaCodecAudioRenderer$AudioSinkListener()
	{
	...
	MediaCodecAudioRenderer$AudioSinkListener(MediaCodecAudioRenderer._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #22  <Method void MediaCodecAudioRenderer$AudioSinkListener(MediaCodecAudioRenderer)>
	//    3    5:return          
	}
}
