...
public interface AudioProcessor
{
	public static final class UnhandledFormatException extends Exception
	{
		...
		public UnhandledFormatException(int i, int j, int k)
		{
	...
	public abstract boolean configure(int i, int j, int k)
	...
	public abstract void queueInput(ByteBuffer bytebuffer);
	...
	/* { */
	//    0    0:iconst_0        
	//    1    1:invokestatic    #17  <Method ByteBuffer ByteBuffer.allocateDirect(int)>
	//    2    4:invokestatic    #23  <Method ByteOrder ByteOrder.nativeOrder()>
	//    3    7:invokevirtual   #27  <Method ByteBuffer ByteBuffer.order(ByteOrder)>
	//    4   10:putstatic       #29  <Field ByteBuffer EMPTY_BUFFER>
	//*   5   13:return          
	/* } */
}
