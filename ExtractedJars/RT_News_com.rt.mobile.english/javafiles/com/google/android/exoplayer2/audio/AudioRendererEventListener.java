...
public interface AudioRendererEventListener
{
	public static final class EventDispatcher
	{
		...
		//*   2    4:ifnull          24
				handler.post(((_cls6) (i)). new Runnable() {
		...
		public void audioTrackUnderrun(final int bufferSize, final long bufferSizeMs, long l)
		{
			if(listener != null)
		//*   0    0:aload_0         
		//*   1    1:getfield        #41  <Field AudioRendererEventListener listener>
		...
		//*   1    1:getfield        #41  <Field AudioRendererEventListener listener>
		//*   2    4:ifnull          24
				handler.post(((_cls5) (decodercounters)). new Runnable() {
...
/*
		static AudioRendererEventListener access$000(EventDispatcher eventdispatcher)
		{
...
*/
		...
		public EventDispatcher(Handler handler1, AudioRendererEventListener audiorenderereventlistener)
		{
		//    0    0:aload_0         
	...
	public abstract void onAudioDecoderInitialized(String s, long l, long l1);

	public abstract void onAudioDisabled(DecoderCounters decodercounters);

	public abstract void onAudioEnabled(DecoderCounters decodercounters);

	public abstract void onAudioInputFormatChanged(Format format);

	public abstract void onAudioSessionId(int i);

	public abstract void onAudioSinkUnderrun(int i, long l, long l1);
}
