	...
	implements Runnable
{
	...
	public void run()
	{
		AudioRendererEventListener.EventDispatcher.access$000(AudioRendererEventListener.EventDispatcher.this).onAudioDecoderInitialized(val$decoderName, val$initializedTimestampMs, val$initializationDurationMs);
	//    0    0:aload_0         
	...
	AudioRendererEventListener$EventDispatcher$2()
	{
