...
public static final class DefaultDrmSessionEventListener$EventDispatcher
{
	private static final class HandlerAndListener
	{
		...
		public HandlerAndListener(Handler handler1, DefaultDrmSessionEventListener defaultdrmsessioneventlistener)
		{
		//    0    0:aload_0         
	...
	public void drmKeysLoaded()
	{
		...
		for(Iterator iterator = listeners.iterator(); iterator.hasNext(); handlerandlistener.handler.post(new Runnable() {
		...
		final DefaultDrmSessionEventListener val$listener;
			...
			{
				this$0 = DefaultDrmSessionEventListener.EventDispatcher.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	public DefaultDrmSessionEventListener$EventDispatcher()
	{
	//    0    0:aload_0         
