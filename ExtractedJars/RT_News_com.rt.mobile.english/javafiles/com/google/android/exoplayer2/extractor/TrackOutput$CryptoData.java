...
public static final class TrackOutput$CryptoData
{
	...
	//   12   22:iconst_0        
	//   13   23:ireturn         
			obj = ((Object) ((TrackOutput$CryptoData)obj));
	//   14   24:aload_1         
	//   15   25:checkcast       #2   <Class TrackOutput$CryptoData>
	//   16   28:astore_1        
			return cryptoMode == ((TrackOutput$CryptoData) (obj)).cryptoMode && encryptedBlocks == ((TrackOutput$CryptoData) (obj)).encryptedBlocks && clearBlocks == ((TrackOutput$CryptoData) (obj)).clearBlocks && Arrays.equals(encryptionKey, ((TrackOutput$CryptoData) (obj)).encryptionKey);
	//   17   29:aload_0         
	...
	public TrackOutput$CryptoData(int i, byte abyte0[], int j, int k)
	{
	//    0    0:aload_0         
