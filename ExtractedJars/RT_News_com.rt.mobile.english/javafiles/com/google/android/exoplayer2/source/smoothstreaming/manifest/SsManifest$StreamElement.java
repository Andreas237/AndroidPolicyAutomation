...
public static class SsManifest$StreamElement
{
	...
	public SsManifest$StreamElement copy(Format aformat[])
	{
		return new SsManifest$StreamElement(baseUri, chunkTemplate, type, subType, timescale, name, maxWidth, maxHeight, displayWidth, displayHeight, language, aformat, chunkStartTimes, chunkStartTimesUs, lastChunkDurationUs);
	...
	public SsManifest$StreamElement(String s, String s1, int i, String s2, long l, String s3, 
	...
	private SsManifest$StreamElement(String s, String s1, int i, String s2, long l, String s3, 
			int j, int k, int i1, int j1, String s4, Format aformat[], List list, 
			long al[], long l1)
	{
	//    0    0:aload_0         
