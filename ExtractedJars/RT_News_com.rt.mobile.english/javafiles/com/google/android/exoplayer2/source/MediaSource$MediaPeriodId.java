...
public static final class MediaSource$MediaPeriodId
{
	...
	public MediaSource$MediaPeriodId copyWithPeriodIndex(int i)
	{
		if(periodIndex == i)
	//*   0    0:aload_0         
	...
	//    5    9:areturn         
			...
			return new MediaSource$MediaPeriodId(i, adGroupIndex, adIndexInAdGroup, windowSequenceNumber);
	...
	//   12   22:iconst_0        
	//   13   23:ireturn         
			obj = ((Object) ((MediaSource$MediaPeriodId)obj));
	//   14   24:aload_1         
	//   15   25:checkcast       #2   <Class MediaSource$MediaPeriodId>
	//   16   28:astore_1        
			return periodIndex == ((MediaSource$MediaPeriodId) (obj)).periodIndex && adGroupIndex == ((MediaSource$MediaPeriodId) (obj)).adGroupIndex && adIndexInAdGroup == ((MediaSource$MediaPeriodId) (obj)).adIndexInAdGroup && windowSequenceNumber == ((MediaSource$MediaPeriodId) (obj)).windowSequenceNumber;
	//   17   29:aload_0         
	...
	public MediaSource$MediaPeriodId(int i)
	{
		this(i, -1L);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	public MediaSource$MediaPeriodId(int i, int j, int k, long l)
	{
	//    0    0:aload_0         
	...
	public MediaSource$MediaPeriodId(int i, long l)
	{
		this(i, -1, -1, l);
	//    0    0:aload_0         
	//    1    1:iload_1         
