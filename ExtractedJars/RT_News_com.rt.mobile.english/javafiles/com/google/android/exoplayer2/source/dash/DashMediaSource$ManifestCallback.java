...
private final class DashMediaSource$ManifestCallback
	implements com.google.android.exoplayer2.upstream.Loader.Callback
{
	...
	private DashMediaSource$ManifestCallback()
	{
	...
	DashMediaSource$ManifestCallback(DashMediaSource._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #23  <Method void DashMediaSource$ManifestCallback(DashMediaSource)>
	//    3    5:return          
	}
}
