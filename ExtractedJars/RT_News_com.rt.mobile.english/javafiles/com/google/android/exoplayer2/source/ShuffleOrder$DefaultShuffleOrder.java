...
public static class ShuffleOrder$DefaultShuffleOrder
	implements ShuffleOrder
{
	...
	{
		return ((ShuffleOrder) (new ShuffleOrder$DefaultShuffleOrder(0, new Random(random.nextLong()))));
	...
	//  118  190:istore_3        
	//* 119  191:goto            107
		return ((ShuffleOrder) (new ShuffleOrder$DefaultShuffleOrder(ai2, new Random(random.nextLong()))));
	...
	//   62   99:istore_2        
	//*  63  100:goto            19
		return ((ShuffleOrder) (new ShuffleOrder$DefaultShuffleOrder(ai, new Random(random.nextLong()))));
	...
	public ShuffleOrder$DefaultShuffleOrder(int i)
	{
		this(i, new Random());
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	public ShuffleOrder$DefaultShuffleOrder(int i, long l)
	{
		this(i, new Random(l));
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	private ShuffleOrder$DefaultShuffleOrder(int i, Random random1)
	{
	...
	private ShuffleOrder$DefaultShuffleOrder(int ai[], Random random1)
	{
	//    0    0:aload_0         
