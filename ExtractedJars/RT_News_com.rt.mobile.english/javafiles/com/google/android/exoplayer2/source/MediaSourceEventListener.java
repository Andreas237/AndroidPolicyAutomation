...
public interface MediaSourceEventListener
{
	public static final class EventDispatcher
	{
		...
		{
			downstreamFormatChanged(new MediaLoadData(1, i, format, j, obj, adjustMediaTime(l), 0x1L));
		//    0    0:aload_0         
		...
		public void downstreamFormatChanged(MediaLoadData medialoaddata)
		{
			...
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls9) (medialoaddata)). new Runnable() {
		...
		final MediaLoadData val$mediaLoadData;
			...
			//    5    7:putfield        #26  <Field MediaSourceEventListener val$listener>
				mediaLoadData = MediaLoadData.this;
			//    6   10:aload_0         
			//    7   11:aload_3         
		...
		public void loadCanceled(final LoadEventInfo loadEventInfo, MediaLoadData medialoaddata)
		{
			ListenerAndHandler listenerandhandler;
			final MediaSourceEventListener listener;
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls5) (medialoaddata)). new Runnable() {
		...
		final EventDispatcher this$0;
		final MediaSourceEventListener val$listener;
		final LoadEventInfo val$loadEventInfo;
		final MediaLoadData val$mediaLoadData;
		...
		public void loadCanceled(DataSpec dataspec, int i, int j, Format format, int k, Object obj, long l, long l1, long l2, long l3, 
				long l4)
		{
			loadCanceled(new LoadEventInfo(dataspec, l2, l3, l4), new MediaLoadData(i, j, format, k, obj, adjustMediaTime(l), adjustMediaTime(l1)));
		//    0    0:aload_0         
		...
		public void loadCompleted(final LoadEventInfo loadEventInfo, MediaLoadData medialoaddata)
		{
			ListenerAndHandler listenerandhandler;
			final MediaSourceEventListener listener;
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls4) (medialoaddata)). new Runnable() {
		...
		public void loadCompleted(DataSpec dataspec, int i, int j, Format format, int k, Object obj, long l, long l1, long l2, long l3, 
				long l4)
		{
			loadCompleted(new LoadEventInfo(dataspec, l2, l3, l4), new MediaLoadData(i, j, format, k, obj, adjustMediaTime(l), adjustMediaTime(l1)));
		//    0    0:aload_0         
		//    1    1:new             #152 <Class MediaSourceEventListener$LoadEventInfo>
		//    2    4:dup             
		//    3    5:aload_1         
		...
		public void loadError(final LoadEventInfo loadEventInfo, final MediaLoadData mediaLoadData, final IOException error, boolean flag)
		{
			ListenerAndHandler listenerandhandler;
			final MediaSourceEventListener listener;
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls6) (flag)). new Runnable() {
		...
		{
			loadError(new LoadEventInfo(dataspec, l2, l3, l4), new MediaLoadData(i, j, format, k, obj, adjustMediaTime(l), adjustMediaTime(l1)), ioexception, flag);
		//    0    0:aload_0         
		//    1    1:new             #152 <Class MediaSourceEventListener$LoadEventInfo>
		//    2    4:dup             
		//    3    5:aload_1         
		...
		public void loadStarted(final LoadEventInfo loadEventInfo, MediaLoadData medialoaddata)
		{
			ListenerAndHandler listenerandhandler;
			final MediaSourceEventListener listener;
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls3) (medialoaddata)). new Runnable() {
		...
		{
			loadStarted(new LoadEventInfo(dataspec, l2, 0L, 0L), new MediaLoadData(i, j, format, k, obj, adjustMediaTime(l), adjustMediaTime(l1)));
		//    0    0:aload_0         
		//    1    1:new             #152 <Class MediaSourceEventListener$LoadEventInfo>
		//    2    4:dup             
		//    3    5:aload_1         
		...
		//    9   15:invokestatic    #189 <Method void Assertions.checkState(boolean)>
			...
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls1) (mediasourceeventlistener)). new Runnable() {
		...
		final MediaSourceEventListener val$listener;
			...
			//    2    2:putfield        #22  <Field MediaSourceEventListener$EventDispatcher this$0>
				listener = MediaSourceEventListener.this;
			//    3    5:aload_0         
			//    4    6:aload_2         
		...
		//   20   44:astore_3        
				mediasourceeventlistener = listenerandhandler.listener;
		//   21   45:aload_3         
		...
		//    9   15:invokestatic    #189 <Method void Assertions.checkState(boolean)>
			ListenerAndHandler listenerandhandler;
			MediaSourceEventListener mediasourceeventlistener;
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls2) (mediasourceeventlistener)). new Runnable() {
		...
		//    9   15:invokestatic    #189 <Method void Assertions.checkState(boolean)>
			ListenerAndHandler listenerandhandler;
			MediaSourceEventListener mediasourceeventlistener;
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls7) (mediasourceeventlistener)). new Runnable() {
		...
		{
			upstreamDiscarded(new MediaLoadData(1, i, ((Format) (null)), 3, ((Object) (null)), adjustMediaTime(l), adjustMediaTime(l1)));
		//    0    0:aload_0         
		//    1    1:new             #109 <Class MediaSourceEventListener$MediaLoadData>
		//    2    4:dup             
		//    3    5:iconst_1        
		...
		public void upstreamDiscarded(MediaLoadData medialoaddata)
		{
			ListenerAndHandler listenerandhandler;
			final MediaSourceEventListener listener;
			for(Iterator iterator = listenerAndHandlers.iterator(); iterator.hasNext(); postOrRun(listenerandhandler.handler, ((_cls8) (medialoaddata)). new Runnable() {
		...
		public EventDispatcher withParameters(int i, MediaSource.MediaPeriodId mediaperiodid, long l)
		{
			return new EventDispatcher(listenerAndHandlers, i, mediaperiodid, l);
		...
		private EventDispatcher(CopyOnWriteArrayList copyonwritearraylist, int i, MediaSource.MediaPeriodId mediaperiodid, long l)
		{
		//    0    0:aload_0         
	...
	private static final class EventDispatcher.ListenerAndHandler
	{

		public final Handler handler;
		public final MediaSourceEventListener listener;

		public EventDispatcher.ListenerAndHandler(Handler handler1, MediaSourceEventListener mediasourceeventlistener)
		{
		//    0    0:aload_0         
	...
	public static final class LoadEventInfo
	{
		...
		public LoadEventInfo(DataSpec dataspec, long l, long l1, long l2)
		{
		//    0    0:aload_0         
	...
	public static final class MediaLoadData
	{
		...
		public MediaLoadData(int i, int j, Format format, int k, Object obj, long l, 
				long l1)
		{
		//    0    0:aload_0         
	...
	public abstract void onDownstreamFormatChanged(int i, MediaSource.MediaPeriodId mediaperiodid, MediaLoadData medialoaddata);

	public abstract void onLoadCanceled(int i, MediaSource.MediaPeriodId mediaperiodid, LoadEventInfo loadeventinfo, MediaLoadData medialoaddata);

	public abstract void onLoadCompleted(int i, MediaSource.MediaPeriodId mediaperiodid, LoadEventInfo loadeventinfo, MediaLoadData medialoaddata);

	public abstract void onLoadError(int i, MediaSource.MediaPeriodId mediaperiodid, LoadEventInfo loadeventinfo, MediaLoadData medialoaddata, IOException ioexception, boolean flag);

	public abstract void onLoadStarted(int i, MediaSource.MediaPeriodId mediaperiodid, LoadEventInfo loadeventinfo, MediaLoadData medialoaddata);

	public abstract void onMediaPeriodCreated(int i, MediaSource.MediaPeriodId mediaperiodid);

	public abstract void onMediaPeriodReleased(int i, MediaSource.MediaPeriodId mediaperiodid);

	public abstract void onReadingStarted(int i, MediaSource.MediaPeriodId mediaperiodid);

	public abstract void onUpstreamDiscarded(int i, MediaSource.MediaPeriodId mediaperiodid, MediaLoadData medialoaddata);
}
