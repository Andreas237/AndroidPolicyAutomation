...
class MediaSourceEventListener$EventDispatcher$9
	implements Runnable
{

	public void run()
	{
		val$listener.onDownstreamFormatChanged(windowIndex, mediaPeriodId, val$mediaLoadData);
	//    0    0:aload_0         
	...
	MediaSourceEventListener$EventDispatcher$9()
	{
