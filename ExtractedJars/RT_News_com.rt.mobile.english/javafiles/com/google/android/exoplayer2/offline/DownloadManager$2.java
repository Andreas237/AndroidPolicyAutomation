	...
	implements Runnable
{
	...
	public void run()
	{
		...
		try
		{
			actions = ((Object) (DownloadManager.access$900(DownloadManager.this).load(DownloadManager.access$800(DownloadManager.this))));
	//    0    0:aload_0         
	...
	//*  10   23:goto            41
		...
		catch(final Object actions)
	//*  11   26:astore_1        
		{
			Log.e("DownloadManager", "Action file loading failed.", ((Throwable) (actions)));
	...
	//   16   35:pop             
			actions = ((Object) (new DownloadAction[0]));
	//   17   36:iconst_0        
	//   18   37:anewarray       DownloadAction[]
	//   19   40:astore_1        
		}
		DownloadManager.access$1900(DownloadManager.this).post(new Runnable() {
			...
			//   54  107:pop             
				for(Iterator iterator = DownloadManager.access$1500(this$0).iterator(); iterator.hasNext(); ((DownloadManager.Listener)iterator.next()).onInitialized(this$0));
			//   55  108:aload_0         
			...
			//*  98  220:icmpge          269
				{
					DownloadManager.Task task = (DownloadManager.Task)DownloadManager.access$1200(this$0).get(j);
			//   99  223:aload_0         
			...
			{
				this$1 = DownloadManager._cls2.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
