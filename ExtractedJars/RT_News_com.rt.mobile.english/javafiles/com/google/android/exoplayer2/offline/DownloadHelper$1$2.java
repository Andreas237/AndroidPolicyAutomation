...
class DownloadHelper$1$2
	implements Runnable
{

	public void run()
	{
		val$callback.onPrepareError(this$0, val$e);
	//    0    0:aload_0         
	...
	// Unreferenced inner class com/google/android/exoplayer2/offline/DownloadHelper$1

/* anonymous class */
	class DownloadHelper._cls1 extends Thread
	{
		...
		//    2    4:invokevirtual   #37  <Method void DownloadHelper.prepareInternal()>
				handler.post(new DownloadHelper._cls1._cls1());
		//    3    7:aload_0         
		...
		//*  12   24:astore_1        
			{
				handler.post(((Runnable) (((DownloadHelper._cls1._cls2) (ioexception)). new DownloadHelper._cls1._cls2())));
		//   13   25:aload_0         
		...
		final DownloadHelper.Callback val$callback;
		final Handler val$handler;
			...
			//    5    7:putfield        #25  <Field Handler val$handler>
				callback = DownloadHelper.Callback.this;
			//    6   10:aload_0         
			//    7   11:aload_3         
		...
		// Unreferenced inner class com/google/android/exoplayer2/offline/DownloadHelper$1$1

/* anonymous class */
		class DownloadHelper._cls1._cls1
			implements Runnable
		{
