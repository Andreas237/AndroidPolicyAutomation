...
class DownloadHelper$1$1
	implements Runnable
{

	public void run()
	{
		val$callback.onPrepared(this$0);
	//    0    0:aload_0         
...
/* anonymous class */
	class DownloadHelper._cls1 extends Thread
	{
		...
		//    2    4:invokevirtual   #37  <Method void DownloadHelper.prepareInternal()>
				handler.post(((Runnable) (new DownloadHelper._cls1._cls1())));
		//    3    7:aload_0         
		...
		//*  12   24:astore_1        
			{
				handler.post(new DownloadHelper._cls1._cls2());
		//   13   25:aload_0         
		...
		// Unreferenced inner class com/google/android/exoplayer2/offline/DownloadHelper$1$2

/* anonymous class */
		class DownloadHelper._cls1._cls2
			implements Runnable
		{
