...
public interface VideoRendererEventListener
{
	public static final class EventDispatcher
	{
		...
		public void decoderInitialized(final String decoderName, final long initializedTimestampMs, long l)
		{
			if(listener != null)
		//*   0    0:aload_0         
		//*   1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//*   2    4:ifnull          27
				handler.post(((_cls2) (l)). new Runnable() {
			...
			//    8   12:putfield        #29  <Field long val$initializedTimestampMs>
				initializationDurationMs = J.this;
			//    9   15:aload_0         
			//   10   16:lload           5
		...
		//*   1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//*   2    4:ifnull          24
				handler.post(((_cls7) (decodercounters)). new Runnable() {
		...
		public void droppedFrames(final int droppedFrameCount, long l)
		{
			if(listener != null)
		//*   0    0:aload_0         
		//*   1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//*   2    4:ifnull          25
				handler.post(((_cls4) (l)). new Runnable() {
		...
		//*   1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//*   2    4:ifnull          24
				handler.post(((_cls1) (decodercounters)). new Runnable() {
			...
			//    1    1:aload_1         
			//    2    2:putfield        #22  <Field VideoRendererEventListener$EventDispatcher this$0>
				decoderCounters = DecoderCounters.this;
			//    3    5:aload_0         
			//    4    6:aload_2         
		...
		//*   1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//*   2    4:ifnull          24
				handler.post(((_cls3) (format)). new Runnable() {
		...
		//*   1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//*   2    4:ifnull          24
				handler.post(((_cls6) (surface)). new Runnable() {
		...
		public void videoSizeChanged(final int width, final int height, final int unappliedRotationDegrees, float f)
		{
			if(listener != null)
		//*   0    0:aload_0         
		//*   1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//*   2    4:ifnull          28
				handler.post(((_cls5) (f)). new Runnable() {
...
/*
		static VideoRendererEventListener access$000(EventDispatcher eventdispatcher)
		{
			return eventdispatcher.listener;
		//    0    0:aload_0         
		//    1    1:getfield        #43  <Field VideoRendererEventListener listener>
		//    2    4:areturn         
		}
...
*/
		...
		public EventDispatcher(Handler handler1, VideoRendererEventListener videorenderereventlistener)
		{
		//    0    0:aload_0         
	...
	public abstract void onRenderedFirstFrame(Surface surface);

	public abstract void onVideoDecoderInitialized(String s, long l, long l1);

	public abstract void onVideoDisabled(DecoderCounters decodercounters);

	public abstract void onVideoEnabled(DecoderCounters decodercounters);

	public abstract void onVideoInputFormatChanged(Format format);
