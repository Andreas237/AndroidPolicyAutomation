...
public static class MediaCodecRenderer$DecoderInitializationException extends Exception
{
	...
	public MediaCodecRenderer$DecoderInitializationException(Format format, Throwable throwable, boolean flag, int i)
	{
		StringBuilder stringbuilder = new StringBuilder();
	...
	public MediaCodecRenderer$DecoderInitializationException(Format format, Throwable throwable, boolean flag, String s)
	{
		StringBuilder stringbuilder = new StringBuilder();
	//    0    0:new             #24  <Class StringBuilder>
	//    1    3:dup             
	...
	//*  36   72:bipush          21
	//*  37   74:icmplt          85
			format = ((Format) (getDiagnosticInfoV21(throwable)));
	//   38   77:aload_2         
