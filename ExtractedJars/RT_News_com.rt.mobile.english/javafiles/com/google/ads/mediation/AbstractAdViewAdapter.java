	...
	implements MediationBannerAdapter, MediationNativeAdapter, OnImmersiveModeUpdatedListener, com.google.android.gms.ads.mediation.zza, MediationRewardedVideoAdAdapter, zzatm
{
	...
	//*   2    4:ifnull          24
		{
			VideoController videocontroller = zzgw.getVideoController();
	//    3    7:aload_0         
	//    4    8:getfield        #184 <Field AdView zzgw>
	//    5   11:invokevirtual   #203 <Method VideoController AdView.getVideoController()>
	//    6   14:astore_1        
	...
	//    9   19:aload_1         
	//   10   20:invokevirtual   #207 <Method zzlo VideoController.zzbc()>
	//   11   23:areturn         
		}
		return null;
	//   12   24:aconst_null     
	...
	{
		if(zzgz != null && zzhb != null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #217 <Field Context zzgz>
	//*   2    4:ifnull          97
	//*   3    7:aload_0         
	//*   4    8:getfield        #171 <Field MediationRewardedVideoAdListener zzhb>
	//*   5   11:ifnonnull       17
	//*   6   14:goto            97
		{
			zzha = new InterstitialAd(zzgz);
	//    7   17:aload_0         
	//    8   18:new             #228 <Class InterstitialAd>
	//    9   21:dup             
	//   10   22:aload_0         
	//   11   23:getfield        #217 <Field Context zzgz>
	//   12   26:invokespecial   #231 <Method void InterstitialAd(Context)>
	//   13   29:putfield        #168 <Field InterstitialAd zzha>
			zzha.zza(true);
	//   14   32:aload_0         
	//   15   33:getfield        #168 <Field InterstitialAd zzha>
	//   16   36:iconst_1        
	//   17   37:invokevirtual   #234 <Method void InterstitialAd.zza(boolean)>
			zzha.setAdUnitId(getAdUnitId(bundle));
	//   18   40:aload_0         
	//   19   41:getfield        #168 <Field InterstitialAd zzha>
	//   20   44:aload_0         
	//   21   45:aload_2         
	//   22   46:invokevirtual   #236 <Method String getAdUnitId(Bundle)>
	//   23   49:invokevirtual   #240 <Method void InterstitialAd.setAdUnitId(String)>
			zzha.setRewardedVideoAdListener(zzhc);
	//   24   52:aload_0         
	//   25   53:getfield        #168 <Field InterstitialAd zzha>
	//   26   56:aload_0         
	//   27   57:getfield        #64  <Field RewardedVideoAdListener zzhc>
	//   28   60:invokevirtual   #244 <Method void InterstitialAd.setRewardedVideoAdListener(RewardedVideoAdListener)>
			zzha.zza(((com.google.android.gms.ads.reward.zza) (new com.google.ads.mediation.zzb(this))));
	//   29   63:aload_0         
	//   30   64:getfield        #168 <Field InterstitialAd zzha>
	//   31   67:new             #246 <Class zzb>
	//   32   70:dup             
	//   33   71:aload_0         
	//   34   72:invokespecial   #247 <Method void zzb(AbstractAdViewAdapter)>
	//   35   75:invokevirtual   #250 <Method void InterstitialAd.zza(com.google.android.gms.ads.reward.zza)>
			zzha.loadAd(zza(zzgz, mediationadrequest, bundle1, bundle));
	//   36   78:aload_0         
	//   37   79:getfield        #168 <Field InterstitialAd zzha>
	//   38   82:aload_0         
	//   39   83:aload_0         
	//   40   84:getfield        #217 <Field Context zzgz>
	//   41   87:aload_1         
	//   42   88:aload_3         
	//   43   89:aload_2         
	//   44   90:invokespecial   #252 <Method AdRequest zza(Context, MediationAdRequest, Bundle, Bundle)>
	//   45   93:invokevirtual   #255 <Method void InterstitialAd.loadAd(AdRequest)>
			return;
	//   46   96:return          
		} else
		{
			zzane.e("AdMobAdapter.loadAd called before initialize.");
	//   47   97:ldc2            #257 <String "AdMobAdapter.loadAd called before initialize.">
	//   48  100:invokestatic    #262 <Method void zzane.e(String)>
			return;
	//   49  103:return          
		}
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #184 <Field AdView zzgw>
	//    5   11:invokevirtual   #266 <Method void AdView.destroy()>
			zzgw = null;
	//    6   14:aload_0         
	//    7   15:aconst_null     
	//    8   16:putfield        #184 <Field AdView zzgw>
		}
		if(zzgx != null)
	//*   9   19:aload_0         
	//*  10   20:getfield        #268 <Field InterstitialAd zzgx>
	//*  11   23:ifnull          31
			zzgx = null;
	//   12   26:aload_0         
	//   13   27:aconst_null     
	//   14   28:putfield        #268 <Field InterstitialAd zzgx>
		if(zzgy != null)
	//*  15   31:aload_0         
	//*  16   32:getfield        #270 <Field AdLoader zzgy>
	//*  17   35:ifnull          43
			zzgy = null;
	//   18   38:aload_0         
	//   19   39:aconst_null     
	//   20   40:putfield        #270 <Field AdLoader zzgy>
		if(zzha != null)
	//*  21   43:aload_0         
	//*  22   44:getfield        #168 <Field InterstitialAd zzha>
	//*  23   47:ifnull          55
			zzha = null;
	//   24   50:aload_0         
	//   25   51:aconst_null     
	//   26   52:putfield        #168 <Field InterstitialAd zzha>
	//   27   55:return          
	}
	...
	//*   2    4:ifnull          15
			zzgx.setImmersiveMode(flag);
	//    3    7:aload_0         
	//    4    8:getfield        #268 <Field InterstitialAd zzgx>
	//    5   11:iload_1         
	//    6   12:invokevirtual   #274 <Method void InterstitialAd.setImmersiveMode(boolean)>
		if(zzha != null)
	//*   7   15:aload_0         
	//*   8   16:getfield        #168 <Field InterstitialAd zzha>
	//*   9   19:ifnull          30
			zzha.setImmersiveMode(flag);
	//   10   22:aload_0         
	//   11   23:getfield        #168 <Field InterstitialAd zzha>
	//   12   26:iload_1         
	//   13   27:invokevirtual   #274 <Method void InterstitialAd.setImmersiveMode(boolean)>
	//   14   30:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #184 <Field AdView zzgw>
	//    5   11:invokevirtual   #278 <Method void AdView.pause()>
	//    6   14:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #184 <Field AdView zzgw>
	//    5   11:invokevirtual   #282 <Method void AdView.resume()>
	//    6   14:return          
	}
