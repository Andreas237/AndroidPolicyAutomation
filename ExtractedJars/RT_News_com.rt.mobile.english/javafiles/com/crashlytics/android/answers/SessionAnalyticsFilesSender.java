	...
	implements FilesSender
{
	...
	//   47  106:aload           6
	//   48  108:invokevirtual   #98  <Method HttpRequest HttpRequest.part(String, String, String, File)>
	//   49  111:pop             
		}
	...
	//   55  119:invokestatic    #104 <Method Logger Fabric.getLogger()>
	//   56  122:astore          5
	...
	//   93  204:aload           4
	//   94  206:ldc1            #128 <String "Response code for analytics file send is ">
	...
	//  101  219:aload_1         
	//  102  220:ldc1            #117 <String "Answers">
	//  103  222:aload           4
	//  104  224:invokevirtual   #91  <Method String StringBuilder.toString()>
	//  105  227:invokeinterface #123 <Method void Logger.d(String, String)>
		if(ResponseParser.parse(j) == 0)
	//* 106  232:iload_2         
	//* 107  233:invokestatic    #134 <Method int ResponseParser.parse(int)>
	//* 108  236:ifne            241
			flag = true;
	//  109  239:iconst_1        
	//  110  240:istore_3        
