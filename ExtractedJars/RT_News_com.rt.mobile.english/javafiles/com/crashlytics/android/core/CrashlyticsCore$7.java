	...
	implements Runnable
{
	...
	public void run()
	{
		android.app.r r = new android.app.r(((android.content.Context) (val$activity)));
...
;
	...
	//   20   41:istore_2        
		TextView textview = new TextView(((android.content.Context) (val$activity)));
	...
	//   29   59:invokevirtual   #81  <Method void TextView.setAutoLinkMask(int)>
		textview.setText(((CharSequence) (val$stringResolver.getMessage())));
	//   30   62:aload           5
	//   31   64:aload_0         
	...
	//   34   71:invokevirtual   #91  <Method void TextView.setText(CharSequence)>
		textview.setTextAppearance(((android.content.Context) (val$activity)), 0x1030044);
	//   35   74:aload           5
	//   36   76:aload_0         
	...
	//   48   97:invokevirtual   #104 <Method void TextView.setFocusable(boolean)>
		ScrollView scrollview = new ScrollView(((android.content.Context) (val$activity)));
	...
	//   71  145:invokevirtual   #112 <Method void ScrollView.addView(android.view.View)>
		r.setView(((android.view.View) (scrollview))).setTitle(((CharSequence) (val$stringResolver.getTitle()))).setCancelable(false).setNeutralButton(((CharSequence) (val$stringResolver.getSendButtonTitle())), clicklistener);
	//   72  148:aload_3         
	//   73  149:aload           6
...
;
	...
	//   95  199:astore          4
			r.setNegativeButton(((CharSequence) (val$stringResolver.getCancelButtonTitle())), clicklistener1);
	//   96  201:aload_3         
	//   97  202:aload_0         
...
;
	...
	//  111  233:astore          4
			r.setPositiveButton(((CharSequence) (val$stringResolver.getAlwaysSendButtonTitle())), clicklistener2);
	//  112  235:aload_3         
	//  113  236:aload_0         
