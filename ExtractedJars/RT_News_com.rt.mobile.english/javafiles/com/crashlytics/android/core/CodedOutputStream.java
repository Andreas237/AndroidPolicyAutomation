	...
	implements Flushable
{
	...
	//   15   23:ireturn         
		if((l & 0xffe00000L) == 0L)
	//*  16   24:lload_0         
	//*  17   25:ldc2w           #114 <Long 0xffe00000L>
	//*  18   28:land            
	//*  19   29:lconst_0        
	//*  20   30:lcmp            
	//*  21   31:ifne            36
	...
	//   23   35:ireturn         
		if((l & 0xf0000000L) == 0L)
	//*  24   36:lload_0         
	//*  25   37:ldc2w           #116 <Long 0xf0000000L>
	//*  26   40:land            
	//*  27   41:lconst_0        
	//*  28   42:lcmp            
	//*  29   43:ifne            48
	...
	//   13   23:iload_3         
	//   14   24:invokevirtual   #320 <Method void ByteString.copyTo(byte[], int, int, int)>
			position = position + j;
	//   15   27:aload_0         
	//   16   28:aload_0         
	...
	//   77  135:new             #214 <Class IllegalStateException>
	//   78  138:dup             
	//   79  139:ldc2            #331 <String "Skip failed.">
	//   80  142:invokespecial   #219 <Method void IllegalStateException(String)>
	//   81  145:athrow          
		int l;
		for(; i > 0; i -= l)
	//*  82  146:iload_2         
	...
	//   87  155:invokestatic    #336 <Method int Math.min(int, int)>
	//   88  158:istore_3        
	...
	//   92  164:iconst_0        
	//   93  165:iload_3         
	//   94  166:invokevirtual   #340 <Method int InputStream.read(byte[], int, int)>
	//   95  169:istore          4
			if(l != j)
	//*  96  171:iload           4
	//*  97  173:iload_3         
	...
	//   99  177:new             #214 <Class IllegalStateException>
	//  100  180:dup             
	//  101  181:ldc2            #342 <String "Read failed.">
	//  102  184:invokespecial   #219 <Method void IllegalStateException(String)>
	//  103  187:athrow          
	...
	//  108  196:iconst_0        
	//  109  197:iload           4
	//  110  199:invokevirtual   #207 <Method void OutputStream.write(byte[], int, int)>
		}
	...
	//   12   20:getfield        #33  <Field int position>
	//   13   23:iload_3         
	//   14   24:invokestatic    #351 <Method void System.arraycopy(Object, int, Object, int, int)>
			position = position + j;
	//   15   27:aload_0         
	//   16   28:aload_0         
	//   17   29:getfield        #33  <Field int position>
