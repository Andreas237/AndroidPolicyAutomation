...
class LogFileManager
{
	...
	//    4    8:aload_2         
	//    5    9:ldc1            #19  <String "crashlytics-userlog-">
	//    6   11:invokevirtual   #103 <Method StringBuilder StringBuilder.append(String)>
	//    7   14:pop             
		stringbuilder.append(s);
	//    8   15:aload_2         
	//    9   16:aload_1         
	//   10   17:invokevirtual   #103 <Method StringBuilder StringBuilder.append(String)>
	//   11   20:pop             
		stringbuilder.append(".temp");
	//   12   21:aload_2         
	//   13   22:ldc1            #16  <String ".temp">
	//   14   24:invokevirtual   #103 <Method StringBuilder StringBuilder.append(String)>
	//   15   27:pop             
		s = stringbuilder.toString();
	//   16   28:aload_2         
	//   17   29:invokevirtual   #106 <Method String StringBuilder.toString()>
	//   18   32:astore_1        
		return new File(getLogFileDir(), s);
	//   19   33:new             #59  <Class File>
	//   20   36:dup             
	//   21   37:aload_0         
	//   22   38:invokespecial   #108 <Method File getLogFileDir()>
	//   23   41:aload_1         
	//   24   42:invokespecial   #67  <Method void File(File, String)>
	//   25   45:areturn         
	}
