...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//*  90  188:ifeq            215
			{
				CrashlyticsCore._cls7._cls2 _lcls2 = new CrashlyticsCore._cls7._cls2();
		//   91  191:new             #15  <Class CrashlyticsCore$7$2>
		//   92  194:dup             
		//   93  195:aload_0         
		//   94  196:invokespecial   #141 <Method void CrashlyticsCore$7$2(CrashlyticsCore$7)>
		//   95  199:astore          4
				builder.setNegativeButton(((CharSequence) (stringResolver.getCancelButtonTitle())), ((android.content.DialogInterface.OnClickListener) (_lcls2)));
		//   96  201:aload_3         
		//   97  202:aload_0         
