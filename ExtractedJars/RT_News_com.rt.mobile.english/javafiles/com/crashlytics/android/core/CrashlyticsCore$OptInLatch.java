...
private static class CrashlyticsCore$OptInLatch
{
	...
	CrashlyticsCore$OptInLatch(CrashlyticsCore._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #27  <Method void CrashlyticsCore$OptInLatch()>
	//    2    4:return          
	}
}
