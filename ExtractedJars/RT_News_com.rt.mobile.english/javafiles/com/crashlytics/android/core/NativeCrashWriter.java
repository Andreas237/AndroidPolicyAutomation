...
class NativeCrashWriter
{
	...
	private static abstract class ProtobufMessage
	{
		...
		//    6   11:iconst_0        
		//    7   12:istore_1        
			for(int k = aprotobufmessage.length; i < k; i++)
		//*   8   13:aload           4
		//*   9   15:arraylength     
		//*  10   16:istore_3        
		//*  11   17:iload_1         
		...
		//   15   28:iconst_0        
		//   16   29:istore_2        
			for(int j = aprotobufmessage.length; i < j; i++)
		//*  17   30:aload           4
		//*  18   32:arraylength     
		//*  19   33:istore_3        
		//*  20   34:iload_2         
	...
	private static final class ThreadMessage extends ProtobufMessage
	{
		...
		//   12   24:iconst_2        
		//   13   25:aload_0         
		//   14   26:getfield        #26  <Field int importance>
		//   15   29:invokestatic    #54  <Method int CodedOutputStream.computeUInt32Size(int, int)>
		//   16   32:iload_1         
		//   17   33:iadd            
		//   18   34:ireturn         
		}
	...
	//    7   13:getstatic       #79  <Field NativeCrashWriter$BinaryImageMessage[] EMPTY_BINARY_IMAGE_MESSAGES>
	//    8   16:astore_2        
	...
	//   20   32:iload_1         
	//   21   33:aaload          
	//   22   34:invokespecial   #91  <Method void NativeCrashWriter$BinaryImageMessage(BinaryImageData)>
	//   23   37:aastore         
	...
	//    7   13:getstatic       #81  <Field NativeCrashWriter$CustomAttributeMessage[] EMPTY_CUSTOM_ATTRIBUTE_MESSAGES>
	//    8   16:astore_2        
	...
	//   20   32:iload_1         
	//   21   33:aaload          
	//   22   34:invokespecial   #99  <Method void NativeCrashWriter$CustomAttributeMessage(CustomAttributeData)>
	//   23   37:aastore         
	...
	//    0    0:new             #15  <Class NativeCrashWriter$DeviceMessage>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #107 <Field int DeviceData.batteryCapacity>
	//    4    8:i2f             
	//    5    9:ldc1            #108 <Float 100F>
	//    6   11:fdiv            
	//    7   12:aload_0         
	//    8   13:getfield        #111 <Field int DeviceData.batteryVelocity>
	//    9   16:aload_0         
	//   10   17:getfield        #115 <Field boolean DeviceData.proximity>
	//   11   20:aload_0         
	//   12   21:getfield        #118 <Field int DeviceData.orientation>
	//   13   24:aload_0         
	//   14   25:getfield        #122 <Field long DeviceData.totalPhysicalMemory>
	//   15   28:aload_0         
	//   16   29:getfield        #125 <Field long DeviceData.availablePhysicalMemory>
	//   17   32:lsub            
	//   18   33:aload_0         
	//   19   34:getfield        #128 <Field long DeviceData.totalInternalStorage>
	//   20   37:aload_0         
	//   21   38:getfield        #131 <Field long DeviceData.availableInternalStorage>
	//   22   41:lsub            
	//   23   42:invokespecial   #134 <Method void NativeCrashWriter$DeviceMessage(float, int, boolean, int, long, long)>
	//   24   45:areturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #143 <Field SignalData SessionEventData.signal>
	//*   2    4:ifnull          15
			obj = ((Object) (sessioneventdata.signal));
	//    3    7:aload_0         
	//    4    8:getfield        #143 <Field SignalData SessionEventData.signal>
	//    5   11:astore_3        
		else
	//*   6   12:goto            19
			obj = ((Object) (DEFAULT_SIGNAL));
	//    7   15:getstatic       #71  <Field SignalData DEFAULT_SIGNAL>
	//    8   18:astore_3        
	...
	//   14   30:dup             
	//   15   31:aload_3         
	//   16   32:invokespecial   #146 <Method void NativeCrashWriter$SignalMessage(SignalData)>
	//   17   35:aload_0         
	//   18   36:getfield        #150 <Field ThreadData[] SessionEventData.threads>
	//   19   39:invokestatic    #154 <Method NativeCrashWriter$RepeatedMessage createThreadsMessage(ThreadData[])>
	//   20   42:aload_0         
	//   21   43:getfield        #158 <Field BinaryImageData[] SessionEventData.binaryImages>
	//   22   46:invokestatic    #160 <Method NativeCrashWriter$RepeatedMessage createBinaryImagesMessage(BinaryImageData[])>
	//   23   49:invokespecial   #163 <Method void NativeCrashWriter$ExecutionMessage(NativeCrashWriter$SignalMessage, NativeCrashWriter$RepeatedMessage, NativeCrashWriter$RepeatedMessage)>
	//   24   52:aload_0         
	//   25   53:getfield        #167 <Field CustomAttributeData[] SessionEventData.customAttributes>
	//   26   56:aload_2         
	//   27   57:invokestatic    #171 <Method CustomAttributeData[] mergeCustomAttributes(CustomAttributeData[], Map)>
	//   28   60:invokestatic    #173 <Method NativeCrashWriter$RepeatedMessage createCustomAttributesMessage(CustomAttributeData[])>
	//   29   63:invokespecial   #176 <Method void NativeCrashWriter$ApplicationMessage(NativeCrashWriter$ExecutionMessage, NativeCrashWriter$RepeatedMessage)>
	//   30   66:astore_2        
		obj = ((Object) (createDeviceMessage(sessioneventdata.deviceData)));
	//   31   67:aload_0         
	//   32   68:getfield        #180 <Field DeviceData SessionEventData.deviceData>
	//   33   71:invokestatic    #182 <Method NativeCrashWriter$DeviceMessage createDeviceMessage(DeviceData)>
	//   34   74:astore_3        
		ByteString bytestring = logfilemanager.getByteStringForLog();
	//   35   75:aload_1         
	//   36   76:invokevirtual   #188 <Method ByteString LogFileManager.getByteStringForLog()>
	//   37   79:astore          4
		if(bytestring == null)
	//*  38   81:aload           4
	//*  39   83:ifnonnull       98
			Fabric.getLogger().d("CrashlyticsCore", "No log data to include with this event.");
	//   40   86:invokestatic    #194 <Method Logger Fabric.getLogger()>
	//   41   89:ldc1            #196 <String "CrashlyticsCore">
	//   42   91:ldc1            #198 <String "No log data to include with this event.">
	//   43   93:invokeinterface #204 <Method void Logger.d(String, String)>
		logfilemanager.clearLog();
	//   44   98:aload_1         
	//   45   99:invokevirtual   #207 <Method void LogFileManager.clearLog()>
		if(bytestring != null)
	//*  46  102:aload           4
	//*  47  104:ifnull          120
	...
	//   49  110:dup             
	//   50  111:aload           4
	//   51  113:invokespecial   #210 <Method void NativeCrashWriter$LogMessage(ByteString)>
	//   52  116:astore_1        
		else
	//*  53  117:goto            128
	...
	//   55  123:dup             
	//   56  124:invokespecial   #211 <Method void NativeCrashWriter$NullMessage()>
	//   57  127:astore_1        
	...
	//   59  131:dup             
	//   60  132:aload_0         
	//   61  133:getfield        #214 <Field long SessionEventData.timestamp>
	//   62  136:ldc1            #59  <String "ndk-crash">
	//   63  138:iconst_3        
	...
	//   75  152:aload_1         
	//   76  153:aastore         
	//   77  154:invokespecial   #217 <Method void NativeCrashWriter$EventMessage(long, String, NativeCrashWriter$ProtobufMessage[])>
	//   78  157:areturn         
	}
	...
	//    7   13:getstatic       #77  <Field NativeCrashWriter$FrameMessage[] EMPTY_FRAME_MESSAGES>
	//    8   16:astore_2        
	...
	//   20   32:iload_1         
	//   21   33:aaload          
	//   22   34:invokespecial   #225 <Method void NativeCrashWriter$FrameMessage(com.crashlytics.android.core.internal.models.ThreadData$FrameData)>
	//   23   37:aastore         
	...
	//    7   13:getstatic       #75  <Field NativeCrashWriter$ThreadMessage[] EMPTY_THREAD_MESSAGES>
	//    8   16:astore_2        
	...
	//   23   35:aload_3         
	//   24   36:aload_3         
	//   25   37:getfield        #231 <Field com.crashlytics.android.core.internal.models.ThreadData$FrameData[] ThreadData.frames>
	//   26   40:invokestatic    #233 <Method NativeCrashWriter$RepeatedMessage createFramesMessage(com.crashlytics.android.core.internal.models.ThreadData$FrameData[])>
	//   27   43:invokespecial   #236 <Method void NativeCrashWriter$ThreadMessage(ThreadData, NativeCrashWriter$RepeatedMessage)>
	//   28   46:aastore         
		}
	...
	//   21   32:aload_1         
	//   22   33:aload           5
	//   23   35:getfield        #246 <Field String CustomAttributeData.key>
	//   24   38:aload           5
	//   25   40:getfield        #249 <Field String CustomAttributeData.value>
	//   26   43:invokeinterface #255 <Method Object Map.put(Object, Object)>
	//   27   48:pop             
			}
	...
	//   33   56:aload_1         
	//   34   57:invokeinterface #259 <Method Set Map.entrySet()>
	//   35   62:aload_1         
	//   36   63:invokeinterface #263 <Method int Map.size()>
	//   37   68:anewarray       java.util.Map.Entry[]
	//   38   71:invokeinterface #271 <Method Object[] Set.toArray(Object[])>
	//   39   76:checkcast       #273 <Class java.util.Map$Entry[]>
	//   40   79:astore_0        
	...
	//   51   94:aload_1         
	//   52   95:iload_2         
	//   53   96:new             #243 <Class CustomAttributeData>
	//   54   99:dup             
	//   55  100:aload_0         
	//   56  101:iload_2         
	//   57  102:aaload          
	//   58  103:invokeinterface #277 <Method Object java.util.Map$Entry.getKey()>
	//   59  108:checkcast       #279 <Class String>
	//   60  111:aload_0         
	//   61  112:iload_2         
	//   62  113:aaload          
	//   63  114:invokeinterface #282 <Method Object java.util.Map$Entry.getValue()>
	//   64  119:checkcast       #279 <Class String>
	//   65  122:invokespecial   #284 <Method void CustomAttributeData(String, String)>
	//   66  125:aastore         
