...
class Frame
{
	...
	//   46   71:aload_0         
	//   47   72:iload_2         
	//   48   73:putfield        #42  <Field boolean rsv3>
	...
	//   52   80:iand            
	//   53   81:int2byte        
	//   54   82:putfield        #44  <Field byte opcode>
	//   55   85:return          
	}
	...
	//    6   10:new             #96  <Class EOFException>
	//    7   13:dup             
	//    8   14:invokespecial   #97  <Method void EOFException()>
	//    9   17:athrow          
		else
			return (byte)i;
	//   10   18:iload_1         
	...
	//*  10   16:icmpne          27
				throw new EOFException();
	//   11   19:new             #96  <Class EOFException>
	//   12   22:dup             
	//   13   23:invokespecial   #97  <Method void EOFException()>
	//   14   26:athrow          
			j -= k;
	//   15   27:iload_3         
	//   16   28:iload           4
	...
	//   40   73:aload_0         
	//   41   74:aload_0         
	//   42   75:getfield        #110 <Field long payloadLen>
	//   43   78:l2i             
	//   44   79:newarray        byte[]
	//   45   81:putfield        #116 <Field byte[] payloadData>
		readBytesOrThrow(((InputStream) (bufferedinputstream)), payloadData, 0, (int)payloadLen);
	//   46   84:aload_1         
	//   47   85:aload_0         
	//   48   86:getfield        #116 <Field byte[] payloadData>
	//   49   89:iconst_0        
	//   50   90:aload_0         
	//   51   91:getfield        #110 <Field long payloadLen>
	//   52   94:l2i             
	//   53   95:invokestatic    #78  <Method void readBytesOrThrow(InputStream, byte[], int, int)>
		MaskingHelper.unmask(maskingKey, payloadData, 0, (int)payloadLen);
	//   54   98:aload_0         
	//   55   99:getfield        #114 <Field byte[] maskingKey>
	//   56  102:aload_0         
	//   57  103:getfield        #116 <Field byte[] payloadData>
	//   58  106:iconst_0        
	//   59  107:aload_0         
	//   60  108:getfield        #110 <Field long payloadLen>
	//   61  111:l2i             
	//   62  112:invokestatic    #122 <Method void MaskingHelper.unmask(byte[], byte[], int, int)>
	//   63  115:return          
	}
	...
	//   29   49:new             #139 <Class UnsupportedOperationException>
	//   30   52:dup             
	//   31   53:ldc1            #141 <String "Writing masked data not implemented">
	//   32   55:invokespecial   #142 <Method void UnsupportedOperationException(String)>
	//   33   58:athrow          
		} else
		{
	...
	//   34   59:aload_1         
	//   35   60:aload_0         
	//   36   61:getfield        #116 <Field byte[] payloadData>
	//   37   64:iconst_0        
	//   38   65:aload_0         
	//   39   66:getfield        #110 <Field long payloadLen>
	//   40   69:l2i             
	//   41   70:invokevirtual   #137 <Method void BufferedOutputStream.write(byte[], int, int)>
			return;
	//   42   73:return          
		}
	}
