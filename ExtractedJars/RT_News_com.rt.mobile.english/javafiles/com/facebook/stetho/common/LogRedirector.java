...
public class LogRedirector
{
	...
	//    9   17:aload_0         
	//   10   18:invokestatic    #57  <Method void ThrowableExtension.printStackTrace(Throwable)>
		printwriter.flush();
	//   11   21:aload_2         
	//   12   22:invokevirtual   #60  <Method void PrintWriter.flush()>
		return stringwriter.toString();
	//   13   25:aload_1         
	//   14   26:invokevirtual   #61  <Method String StringWriter.toString()>
	//   15   29:areturn         
	}
	...
	//   18   31:aload_3         
	//   19   32:invokevirtual   #38  <Method String StringBuilder.toString()>
	//   20   35:invokestatic    #64  <Method void i(String, String)>
	//   21   38:return          
	}
	...
	//    0    0:getstatic       #68  <Field LogRedirector$Logger sLogger>
	//    1    3:astore_2        
		if(logger != null)
	//*   2    4:aload_2         
	//*   3    5:ifnull          17
	...
	//    5    9:aload_0         
	//    6   10:iload_1         
	//    7   11:invokeinterface #70  <Method boolean LogRedirector$Logger.isLoggable(String, int)>
	//    8   16:ireturn         
		else
			return Log.isLoggable(s, j);
	//    9   17:aload_0         
	//   10   18:iload_1         
	//   11   19:invokestatic    #73  <Method boolean Log.isLoggable(String, int)>
	//   12   22:ireturn         
	}
	...
	//    6   10:aload_1         
	//    7   11:aload_2         
	//    8   12:invokeinterface #74  <Method void LogRedirector$Logger.log(int, String, String)>
			return;
	//    9   17:return          
		} else
		{
	...
	//   11   19:aload_1         
	//   12   20:aload_2         
	//   13   21:invokestatic    #78  <Method int Log.println(int, String, String)>
	//   14   24:pop             
			return;
	//   15   25:return          
		}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #86  <Method Object Util.throwIfNull(Object)>
	//    2    4:pop             
		Util.throwIfNotNull(((Object) (sLogger)));
	//    3    5:getstatic       #68  <Field LogRedirector$Logger sLogger>
	//    4    8:invokestatic    #90  <Method void Util.throwIfNotNull(Object)>
		sLogger = logger;
	//    5   11:aload_0         
	//    6   12:putstatic       #68  <Field LogRedirector$Logger sLogger>
	//    7   15:return          
	}
	...
	//   18   31:aload_3         
	//   19   32:invokevirtual   #38  <Method String StringBuilder.toString()>
	//   20   35:invokestatic    #93  <Method void v(String, String)>
	//   21   38:return          
	}
	...
	//   18   31:aload_3         
	//   19   32:invokevirtual   #38  <Method String StringBuilder.toString()>
	//   20   35:invokestatic    #96  <Method void w(String, String)>
	//   21   38:return          
	}
