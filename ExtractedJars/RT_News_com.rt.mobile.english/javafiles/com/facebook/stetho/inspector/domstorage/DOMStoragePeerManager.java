...
public class DOMStoragePeerManager extends ChromePeerManager
{
		...
		implements android.content.SharedPreferences.OnSharedPreferenceChangeListener
	{
		...
		//   76  158:new             #92  <Class StringBuilder>
		//   77  161:dup             
		//   78  162:invokespecial   #93  <Method void StringBuilder()>
		//   79  165:astore_1        
				((StringBuilder) (sharedpreferences)).append("Prefs change detected for unknown key=");
		//   80  166:aload_1         
		//   81  167:ldc1            #95  <String "Prefs change detected for unknown key=">
		//   82  169:invokevirtual   #99  <Method StringBuilder StringBuilder.append(String)>
		//   83  172:pop             
				((StringBuilder) (sharedpreferences)).append(s);
		//   84  173:aload_1         
		//   85  174:aload_2         
		//   86  175:invokevirtual   #99  <Method StringBuilder StringBuilder.append(String)>
		//   87  178:pop             
				throw new RuntimeException(((StringBuilder) (sharedpreferences)).toString());
		//   88  179:new             #101 <Class RuntimeException>
		//   89  182:dup             
		//   90  183:aload_1         
		//   91  184:invokevirtual   #105 <Method String StringBuilder.toString()>
		//   92  187:invokespecial   #108 <Method void RuntimeException(String)>
		//   93  190:athrow          
			}
		}
		...
		//    2    4:aload_0         
		//    3    5:invokeinterface #113 <Method void SharedPreferences.unregisterOnSharedPreferenceChangeListener(android.content.SharedPreferences$OnSharedPreferenceChangeListener)>
		//    4   10:return          
		}
		...
		//   12   22:putfield        #32  <Field com.facebook.stetho.inspector.protocol.module.DOMStorage$StorageId mStorageId>
			mStorageId.securityOrigin = s;
		//   13   25:aload_0         
		//   14   26:getfield        #32  <Field com.facebook.stetho.inspector.protocol.module.DOMStorage$StorageId mStorageId>
		//   15   29:aload_3         
		//   16   30:putfield        #36  <Field String com.facebook.stetho.inspector.protocol.module.DOMStorage$StorageId.securityOrigin>
			mStorageId.isLocalStorage = true;
		//   17   33:aload_0         
		//   18   34:getfield        #32  <Field com.facebook.stetho.inspector.protocol.module.DOMStorage$StorageId mStorageId>
		//   19   37:iconst_1        
		//   20   38:putfield        #40  <Field boolean com.facebook.stetho.inspector.protocol.module.DOMStorage$StorageId.isLocalStorage>
			mCopy = DOMStoragePeerManager.prefsCopy(sharedpreferences.getAll());
		//   21   41:aload_0         
		//   22   42:aload_2         
		//   23   43:invokeinterface #46  <Method Map SharedPreferences.getAll()>
		//   24   48:invokestatic    #50  <Method Map DOMStoragePeerManager.access$100(Map)>
		//   25   51:putfield        #52  <Field Map mCopy>
		//   26   54:return          
		}
	}
