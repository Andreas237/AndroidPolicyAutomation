...
public class MethodDispatcher
{
	...
	//    6   12:getstatic       #196 <Field com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode.METHOD_NOT_FOUND>
	//    7   15:astore_1        
	...
	//   12   24:aload_3         
	//   13   25:ldc1            #198 <String "Not implemented: ">
	//   14   27:invokevirtual   #88  <Method StringBuilder StringBuilder.append(String)>
	//   15   30:pop             
			((StringBuilder) (jsonobject)).append(s);
	//   16   31:aload_3         
	//   17   32:aload_2         
	//   18   33:invokevirtual   #88  <Method StringBuilder StringBuilder.append(String)>
	//   19   36:pop             
	...
	//   20   37:new             #181 <Class JsonRpcException>
	//   21   40:dup             
	//   22   41:new             #200 <Class JsonRpcError>
	//   23   44:dup             
	//   24   45:aload_1         
	//   25   46:aload_3         
	//   26   47:invokevirtual   #98  <Method String StringBuilder.toString()>
	//   27   50:aconst_null     
	//   28   51:invokespecial   #203 <Method void JsonRpcError(com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode, String, JSONObject)>
	//   29   54:invokespecial   #206 <Method void JsonRpcException(JsonRpcError)>
	//   30   57:athrow          
		}
		try
		{
	...
	//   32   60:aload_1         
	//   33   61:aload_3         
	//   34   62:invokevirtual   #210 <Method JSONObject MethodDispatcher$MethodDispatchHelper.invoke(JsonRpcPeer, JSONObject)>
	//   35   65:astore_1        
		}
	//*  36   66:aload_1         
	//*  37   67:areturn         
	//*  38   68:astore_1        
	//*  39   69:new             #181 <Class JsonRpcException>
	//*  40   72:dup             
	//*  41   73:new             #200 <Class JsonRpcError>
	//*  42   76:dup             
	//*  43   77:getstatic       #213 <Field com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode.INTERNAL_ERROR>
	//*  44   80:aload_1         
	//*  45   81:invokevirtual   #214 <Method String JSONException.toString()>
	//*  46   84:aconst_null     
	//*  47   85:invokespecial   #203 <Method void JsonRpcError(com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode, String, JSONObject)>
	//*  48   88:invokespecial   #206 <Method void JsonRpcException(JsonRpcError)>
	//*  49   91:athrow          
	//*  50   92:astore_1        
	//*  51   93:new             #216 <Class RuntimeException>
	//*  52   96:dup             
	//*  53   97:aload_1         
	//*  54   98:invokespecial   #219 <Method void RuntimeException(Throwable)>
	//*  55  101:athrow          
	...
	//   57  103:aload_1         
	//   58  104:invokevirtual   #223 <Method Throwable InvocationTargetException.getCause()>
	//   59  107:astore_1        
			ExceptionUtil.propagateIfInstanceOf(((Throwable) (jsonrpcpeer)), com/facebook/stetho/inspector/jsonrpc/JsonRpcException);
	//   60  108:aload_1         
	//   61  109:ldc1            #181 <Class JsonRpcException>
	//   62  111:invokestatic    #229 <Method void ExceptionUtil.propagateIfInstanceOf(Throwable, Class)>
			throw ExceptionUtil.propagate(((Throwable) (jsonrpcpeer)));
	//   63  114:aload_1         
	//   64  115:invokestatic    #233 <Method RuntimeException ExceptionUtil.propagate(Throwable)>
	//   65  118:athrow          
		}
		// Misplaced declaration of an exception variable
		catch(JsonRpcPeer jsonrpcpeer)
