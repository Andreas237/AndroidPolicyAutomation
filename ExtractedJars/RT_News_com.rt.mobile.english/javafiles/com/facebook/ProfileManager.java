...
final class ProfileManager
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #79  <Field Profile currentProfile>
	//    2    4:astore_3        
		currentProfile = profile;
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:putfield        #79  <Field Profile currentProfile>
		if(flag)
	//*   6   10:iload_2         
	//*   7   11:ifeq            36
			if(profile != null)
	...
	//   12   22:aload_1         
	//   13   23:invokevirtual   #83  <Method void ProfileCache.save(Profile)>
			else
	//*  14   26:goto            36
				profileCache.clear();
	//   15   29:aload_0         
	//   16   30:getfield        #39  <Field ProfileCache profileCache>
	//   17   33:invokevirtual   #86  <Method void ProfileCache.clear()>
		if(!Utility.areObjectsEqual(((Object) (profile1)), ((Object) (profile))))
	//*  18   36:aload_3         
	//*  19   37:aload_1         
	//*  20   38:invokestatic    #92  <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  21   41:ifne            50
			sendCurrentProfileChangedBroadcast(profile1, profile);
	//   22   44:aload_0         
	//   23   45:aload_3         
	//   24   46:aload_1         
	//   25   47:invokespecial   #94  <Method void sendCurrentProfileChangedBroadcast(Profile, Profile)>
	//   26   50:return          
	}
	...
	//    2    4:invokevirtual   #101 <Method Profile ProfileCache.load()>
	//    3    7:astore_1        
		if(profile != null)
	//*   4    8:aload_1         
	//*   5    9:ifnull          20
	...
	//    7   13:aload_1         
	//    8   14:iconst_0        
	//    9   15:invokespecial   #103 <Method void setCurrentProfile(Profile, boolean)>
			return true;
	//   10   18:iconst_1        
	//   11   19:ireturn         
		} else
	...
	//    1    1:aload_1         
	//    2    2:iconst_1        
	//    3    3:invokespecial   #103 <Method void setCurrentProfile(Profile, boolean)>
	//    4    6:return          
	}
