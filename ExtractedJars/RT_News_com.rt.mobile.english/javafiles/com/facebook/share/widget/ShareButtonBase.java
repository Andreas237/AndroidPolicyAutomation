...
;
	...
	//    3    7:new             #105 <Class StringBuilder>
	//    4   10:dup             
	//    5   11:invokespecial   #108 <Method void StringBuilder()>
	//    6   14:astore_2        
			stringbuilder.append("Request code ");
	//    7   15:aload_2         
	//    8   16:ldc1            #110 <String "Request code ">
	//    9   18:invokevirtual   #114 <Method StringBuilder StringBuilder.append(String)>
	//   10   21:pop             
			stringbuilder.append(i);
	//   11   22:aload_2         
	//   12   23:iload_1         
	//   13   24:invokevirtual   #117 <Method StringBuilder StringBuilder.append(int)>
	//   14   27:pop             
			stringbuilder.append(" cannot be within the range reserved by the Facebook SDK.");
	//   15   28:aload_2         
	//   16   29:ldc1            #119 <String " cannot be within the range reserved by the Facebook SDK.">
	//   17   31:invokevirtual   #114 <Method StringBuilder StringBuilder.append(String)>
	//   18   34:pop             
			throw new IllegalArgumentException(stringbuilder.toString());
	//   19   35:new             #121 <Class IllegalArgumentException>
	//   20   38:dup             
	//   21   39:aload_2         
	//   22   40:invokevirtual   #125 <Method String StringBuilder.toString()>
	//   23   43:invokespecial   #128 <Method void IllegalArgumentException(String)>
	//   24   46:athrow          
		} else
		{
			requestCode = i;
	//   25   47:aload_0         
	//   26   48:iload_1         
	//   27   49:putfield        #19  <Field int requestCode>
			return;
	//   28   52:return          
		}
	}
