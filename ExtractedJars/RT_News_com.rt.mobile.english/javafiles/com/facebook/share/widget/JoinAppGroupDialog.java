...
public class JoinAppGroupDialog extends FacebookDialogBase
{
	...
	private class WebHandler extends com.facebook.internal.FacebookDialogBase.ModeHandler
	{
		...
		//    3    5:invokevirtual   #28  <Method boolean canShow(String)>
		//    4    8:ireturn         
		}
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #51  <Method void JoinAppGroupDialog(Activity)>
	//    4    8:aload_1         
	...
	{
		(new JoinAppGroupDialog(fragment)).show(((Object) (s)));
	//    0    0:new             #2   <Class JoinAppGroupDialog>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #57  <Method void JoinAppGroupDialog(Fragment)>
	//    4    8:aload_1         
	//    5    9:invokevirtual   #54  <Method void show(Object)>
	//    6   12:return          
	}
	...
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:invokespecial   #76  <Method void JoinAppGroupDialog$WebHandler(JoinAppGroupDialog, JoinAppGroupDialog$1)>
	...
	//    8   14:aload_2         
	//    9   15:aload_2         
	//   10   16:invokespecial   #87  <Method void JoinAppGroupDialog$1(JoinAppGroupDialog, FacebookCallback, FacebookCallback)>
	//   11   19:astore_2        
	...
	//   14   24:aload_0         
	//   15   25:aload_2         
	//   16   26:invokespecial   #90  <Method void JoinAppGroupDialog$2(JoinAppGroupDialog, ResultProcessor)>
	//   17   29:astore_2        
	...
	//    0    0:getstatic       #29  <Field com.facebook.internal.CallbackManagerImpl$RequestCodeOffset com.facebook.internal.CallbackManagerImpl$RequestCodeOffset.AppGroupJoin>
