...
public class GameRequestDialog extends FacebookDialogBase
{
	...
	private class WebHandler extends com.facebook.internal.FacebookDialogBase.ModeHandler
	{
		...
		//    3    5:invokevirtual   #28  <Method boolean canShow(GameRequestContent)>
		//    4    8:ireturn         
		}
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #51  <Method void GameRequestDialog(Activity)>
	//    4    8:aload_1         
	...
	{
		(new GameRequestDialog(fragment)).show(((Object) (gamerequestcontent)));
	//    0    0:new             #2   <Class GameRequestDialog>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #57  <Method void GameRequestDialog(Fragment)>
	//    4    8:aload_1         
	//    5    9:invokevirtual   #54  <Method void show(Object)>
	//    6   12:return          
	}
	...
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:invokespecial   #76  <Method void GameRequestDialog$WebHandler(GameRequestDialog, GameRequestDialog$1)>
	...
	//    8   14:aload_2         
	//    9   15:aload_2         
	//   10   16:invokespecial   #87  <Method void GameRequestDialog$1(GameRequestDialog, FacebookCallback, FacebookCallback)>
	//   11   19:astore_2        
	...
	//   12   20:aload_1         
	//   13   21:aload_0         
	//   14   22:invokevirtual   #64  <Method int getRequestCode()>
	//   15   25:new             #9   <Class GameRequestDialog$2>
	//   16   28:dup             
	//   17   29:aload_0         
	//   18   30:aload_2         
	//   19   31:invokespecial   #90  <Method void GameRequestDialog$2(GameRequestDialog, ResultProcessor)>
	//   20   34:invokevirtual   #96  <Method void CallbackManagerImpl.registerCallback(int, com.facebook.internal.CallbackManagerImpl$Callback)>
	//   21   37:return          
	}
