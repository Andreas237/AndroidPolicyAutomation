...
/*
		static ArrayList access$700(Builder builder)
		{
...
*/
	...
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:invokevirtual   #49  <Method String Parcel.readString()>
	//    9   17:putfield        #53  <Field String to>
		title = parcel.readString();
	//   10   20:aload_0         
	//   11   21:aload_1         
	//   12   22:invokevirtual   #49  <Method String Parcel.readString()>
	//   13   25:putfield        #55  <Field String title>
		data = parcel.readString();
	//   14   28:aload_0         
	//   15   29:aload_1         
	//   16   30:invokevirtual   #49  <Method String Parcel.readString()>
	//   17   33:putfield        #57  <Field String data>
		actionType = ActionType.valueOf(parcel.readString());
	//   18   36:aload_0         
	//   19   37:aload_1         
	//   20   38:invokevirtual   #49  <Method String Parcel.readString()>
	//   21   41:invokestatic    #61  <Method GameRequestContent$ActionType GameRequestContent$ActionType.valueOf(String)>
	//   22   44:putfield        #63  <Field GameRequestContent$ActionType actionType>
		objectId = parcel.readString();
	//   23   47:aload_0         
	//   24   48:aload_1         
	//   25   49:invokevirtual   #49  <Method String Parcel.readString()>
	//   26   52:putfield        #65  <Field String objectId>
		filters = Filters.valueOf(parcel.readString());
	//   27   55:aload_0         
	//   28   56:aload_1         
	//   29   57:invokevirtual   #49  <Method String Parcel.readString()>
	//   30   60:invokestatic    #68  <Method GameRequestContent$Filters GameRequestContent$Filters.valueOf(String)>
	//   31   63:putfield        #70  <Field GameRequestContent$Filters filters>
		suggestions = new ArrayList();
	//   32   66:aload_0         
	//   33   67:new             #72  <Class ArrayList>
	//   34   70:dup             
	//   35   71:invokespecial   #73  <Method void ArrayList()>
	//   36   74:putfield        #75  <Field ArrayList suggestions>
		parcel.readStringList(((java.util.List) (suggestions)));
	//   37   77:aload_1         
	//   38   78:aload_0         
	//   39   79:getfield        #75  <Field ArrayList suggestions>
	//   40   82:invokevirtual   #79  <Method void Parcel.readStringList(java.util.List)>
	//   41   85:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokestatic    #84  <Method String GameRequestContent$Builder.access$000(GameRequestContent$Builder)>
	//    5    9:putfield        #51  <Field String message>
		to = builder.to;
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:invokestatic    #87  <Method String GameRequestContent$Builder.access$100(GameRequestContent$Builder)>
	//    9   17:putfield        #53  <Field String to>
		title = builder.title;
	//   10   20:aload_0         
	//   11   21:aload_1         
	//   12   22:invokestatic    #90  <Method String GameRequestContent$Builder.access$200(GameRequestContent$Builder)>
	//   13   25:putfield        #55  <Field String title>
		data = builder.data;
	//   14   28:aload_0         
	//   15   29:aload_1         
	//   16   30:invokestatic    #93  <Method String GameRequestContent$Builder.access$300(GameRequestContent$Builder)>
	//   17   33:putfield        #57  <Field String data>
		actionType = builder.actionType;
	//   18   36:aload_0         
	//   19   37:aload_1         
	//   20   38:invokestatic    #97  <Method GameRequestContent$ActionType GameRequestContent$Builder.access$400(GameRequestContent$Builder)>
	//   21   41:putfield        #63  <Field GameRequestContent$ActionType actionType>
		objectId = builder.objectId;
	//   22   44:aload_0         
	//   23   45:aload_1         
	//   24   46:invokestatic    #100 <Method String GameRequestContent$Builder.access$500(GameRequestContent$Builder)>
	//   25   49:putfield        #65  <Field String objectId>
		filters = builder.filters;
	//   26   52:aload_0         
	//   27   53:aload_1         
	//   28   54:invokestatic    #104 <Method GameRequestContent$Filters GameRequestContent$Builder.access$600(GameRequestContent$Builder)>
	//   29   57:putfield        #70  <Field GameRequestContent$Filters filters>
		suggestions = builder.suggestions;
	//   30   60:aload_0         
	//   31   61:aload_1         
	//   32   62:invokestatic    #108 <Method ArrayList GameRequestContent$Builder.access$700(GameRequestContent$Builder)>
	//   33   65:putfield        #75  <Field ArrayList suggestions>
	//   34   68:return          
	}
	...
	public ActionType getActionType()
	{
		return actionType;
	//    0    0:aload_0         
	//    1    1:getfield        #63  <Field GameRequestContent$ActionType actionType>
	//    2    4:areturn         
	}
	...
	public String getData()
	{
		return data;
	//    0    0:aload_0         
	//    1    1:getfield        #57  <Field String data>
	//    2    4:areturn         
	}
	...
	public Filters getFilters()
	{
		return filters;
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field GameRequestContent$Filters filters>
	//    2    4:areturn         
	}
	...
	public String getObjectId()
	{
		return objectId;
	//    0    0:aload_0         
	//    1    1:getfield        #65  <Field String objectId>
	//    2    4:areturn         
	}
	...
	public ArrayList getSuggestions()
	{
		return suggestions;
	//    0    0:aload_0         
	//    1    1:getfield        #75  <Field ArrayList suggestions>
	//    2    4:areturn         
	}
	...
	public String getTitle()
	{
		return title;
	//    0    0:aload_0         
	//    1    1:getfield        #55  <Field String title>
	//    2    4:areturn         
	}
	...
	public String getTo()
	{
		return to;
	//    0    0:aload_0         
	//    1    1:getfield        #53  <Field String to>
	//    2    4:areturn         
	}
	...
	//    3    5:invokevirtual   #132 <Method void Parcel.writeString(String)>
		parcel.writeString(to);
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:getfield        #53  <Field String to>
	//    7   13:invokevirtual   #132 <Method void Parcel.writeString(String)>
		parcel.writeString(title);
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #55  <Field String title>
	//   11   21:invokevirtual   #132 <Method void Parcel.writeString(String)>
		parcel.writeString(data);
	//   12   24:aload_1         
	//   13   25:aload_0         
	//   14   26:getfield        #57  <Field String data>
	//   15   29:invokevirtual   #132 <Method void Parcel.writeString(String)>
		parcel.writeString(getActionType().toString());
	//   16   32:aload_1         
	//   17   33:aload_0         
	//   18   34:invokevirtual   #134 <Method GameRequestContent$ActionType getActionType()>
	//   19   37:invokevirtual   #137 <Method String GameRequestContent$ActionType.toString()>
	//   20   40:invokevirtual   #132 <Method void Parcel.writeString(String)>
		parcel.writeString(getObjectId());
	//   21   43:aload_1         
	//   22   44:aload_0         
	//   23   45:invokevirtual   #139 <Method String getObjectId()>
	//   24   48:invokevirtual   #132 <Method void Parcel.writeString(String)>
		parcel.writeString(getFilters().toString());
	//   25   51:aload_1         
	//   26   52:aload_0         
	//   27   53:invokevirtual   #141 <Method GameRequestContent$Filters getFilters()>
	//   28   56:invokevirtual   #142 <Method String GameRequestContent$Filters.toString()>
	//   29   59:invokevirtual   #132 <Method void Parcel.writeString(String)>
		parcel.writeStringList(((java.util.List) (getSuggestions())));
	//   30   62:aload_1         
	//   31   63:aload_0         
	//   32   64:invokevirtual   #144 <Method ArrayList getSuggestions()>
	//   33   67:invokevirtual   #147 <Method void Parcel.writeStringList(java.util.List)>
	//   34   70:return          
	}
