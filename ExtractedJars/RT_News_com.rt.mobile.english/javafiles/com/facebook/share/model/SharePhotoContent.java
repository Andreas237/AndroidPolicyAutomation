...
public final class SharePhotoContent extends ShareContent
{
	public static class Builder extends ShareContent.Builder
	{
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokevirtual   #80  <Method SharePhotoContent$Builder readFrom(Parcel)>
		//    3    5:areturn         
		}
		...
		{
			return readFrom((SharePhotoContent)parcel.readParcelable(((Class) (com/facebook/share/model/SharePhotoContent)).getClassLoader()));
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:ldc1            #7   <Class SharePhotoContent>
		//    3    4:invokevirtual   #87  <Method ClassLoader Class.getClassLoader()>
		//    4    7:invokevirtual   #93  <Method android.os.Parcelable Parcel.readParcelable(ClassLoader)>
		//    5   10:checkcast       #7   <Class SharePhotoContent>
		//    6   13:invokevirtual   #76  <Method SharePhotoContent$Builder readFrom(SharePhotoContent)>
		//    7   16:areturn         
		}
		...
		//    4    6:aload_0         
		//    5    7:aload_1         
		//    6    8:invokespecial   #95  <Method ShareContent$Builder ShareContent$Builder.readFrom(ShareContent)>
		//    7   11:checkcast       #2   <Class SharePhotoContent$Builder>
		//    8   14:aload_1         
		//    9   15:invokevirtual   #99  <Method List SharePhotoContent.getPhotos()>
		//   10   18:invokevirtual   #101 <Method SharePhotoContent$Builder addPhotos(List)>
		//   11   21:areturn         
		}
		...
		//    2    4:invokeinterface #105 <Method void List.clear()>
			addPhotos(list);
		//    3    9:aload_0         
		//    4   10:aload_1         
		//    5   11:invokevirtual   #101 <Method SharePhotoContent$Builder addPhotos(List)>
		//    6   14:pop             
			return this;
		//    7   15:aload_0         
		//    8   16:areturn         
...
*/
	...
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokestatic    #33  <Method List SharePhoto$Builder.readListFrom(Parcel)>
	...
	//    4    6:aload_1         
	//    5    7:aload_0         
	//    6    8:getfield        #41  <Field List photos>
	//    7   11:invokestatic    #68  <Method void SharePhoto$Builder.writeListTo(Parcel, List)>
	//    8   14:return          
	}
