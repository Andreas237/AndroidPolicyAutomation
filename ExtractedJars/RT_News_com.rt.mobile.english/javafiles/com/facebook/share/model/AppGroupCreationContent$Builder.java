	...
	implements ShareModelBuilder
{
	...
	public AppGroupCreationContent$Builder readFrom(Parcel parcel)
	{
		return readFrom((AppGroupCreationContent)parcel.readParcelable(((Class) (com/facebook/share/model/AppGroupCreationContent)).getClassLoader()));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:ldc1            #9   <Class AppGroupCreationContent>
	//    3    4:invokevirtual   #47  <Method ClassLoader Class.getClassLoader()>
	//    4    7:invokevirtual   #53  <Method android.os.Parcelable Parcel.readParcelable(ClassLoader)>
	//    5   10:checkcast       #9   <Class AppGroupCreationContent>
	//    6   13:invokevirtual   #56  <Method AppGroupCreationContent$Builder readFrom(AppGroupCreationContent)>
	//    7   16:areturn         
	}
	...
	//    4    6:aload_0         
	//    5    7:aload_1         
	//    6    8:invokevirtual   #60  <Method String AppGroupCreationContent.getName()>
	//    7   11:invokevirtual   #64  <Method AppGroupCreationContent$Builder setName(String)>
	//    8   14:aload_1         
	//    9   15:invokevirtual   #67  <Method String AppGroupCreationContent.getDescription()>
	//   10   18:invokevirtual   #70  <Method AppGroupCreationContent$Builder setDescription(String)>
	//   11   21:aload_1         
	//   12   22:invokevirtual   #74  <Method AppGroupCreationContent$AppGroupPrivacy AppGroupCreationContent.getAppGroupPrivacy()>
	//   13   25:invokevirtual   #78  <Method AppGroupCreationContent$Builder setAppGroupPrivacy(AppGroupCreationContent$AppGroupPrivacy)>
	//   14   28:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #81  <Method AppGroupCreationContent$Builder readFrom(Parcel)>
	//    3    5:areturn         
	}
	...
	//    3    5:invokevirtual   #56  <Method AppGroupCreationContent$Builder readFrom(AppGroupCreationContent)>
	//    4    8:areturn         
	}
