...
public final class ShareOpenGraphAction extends ShareOpenGraphValueContainer
{
	public static final class Builder extends ShareOpenGraphValueContainer.Builder
	{
		...
		//    2    4:aload_0         
		//    3    5:aconst_null     
		//    4    6:invokespecial   #22  <Method void ShareOpenGraphAction(ShareOpenGraphAction$Builder, ShareOpenGraphAction$1)>
		//    5    9:areturn         
		}
		...
		public volatile Object build()
		{
			return ((Object) (build()));
		//    0    0:aload_0         
		//    1    1:invokevirtual   #25  <Method ShareOpenGraphAction build()>
		//    2    4:areturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokevirtual   #30  <Method ShareOpenGraphAction$Builder readFrom(Parcel)>
		//    3    5:areturn         
		}
		...
		//    3    5:invokevirtual   #34  <Method ShareOpenGraphAction$Builder readFrom(ShareOpenGraphAction)>
		//    4    8:areturn         
		}
		...
		//    6   13:invokevirtual   #34  <Method ShareOpenGraphAction$Builder readFrom(ShareOpenGraphAction)>
		//    7   16:areturn         
		}
		...
		//    4    6:aload_0         
		//    5    7:aload_1         
		//    6    8:invokespecial   #49  <Method ShareOpenGraphValueContainer$Builder ShareOpenGraphValueContainer$Builder.readFrom(ShareOpenGraphValueContainer)>
		//    7   11:checkcast       #2   <Class ShareOpenGraphAction$Builder>
		//    8   14:aload_1         
		//    9   15:invokevirtual   #53  <Method String ShareOpenGraphAction.getActionType()>
		//   10   18:invokevirtual   #57  <Method ShareOpenGraphAction$Builder setActionType(String)>
		//   11   21:areturn         
		}
		...
		public Builder setActionType(String s)
		{
			putString("og:type", s);
		//    0    0:aload_0         
		//    1    1:ldc1            #12  <String "og:type">
		//    2    3:aload_1         
		//    3    4:invokevirtual   #61  <Method ShareOpenGraphValueContainer$Builder putString(String, String)>
		//    4    7:pop             
			return this;
		//    5    8:aload_0         
		//    6    9:areturn         
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #16  <Method void ShareOpenGraphValueContainer$Builder()>
		//    2    4:return          
		}
	}
