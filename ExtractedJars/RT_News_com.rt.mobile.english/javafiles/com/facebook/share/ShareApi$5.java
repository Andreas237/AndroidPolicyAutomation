	...
	implements com.facebook.internal.apper.Collection
{
	...
	{
		return val$arrayList.get(integer.intValue());
	//    0    0:aload_0         
...
;
	...
	public void set(Integer integer, Object obj, com.facebook.internal.apper.OnErrorListener onerrorlistener)
	{
		try
		{
			val$stagedObject.put(integer.intValue(), obj);
	//    0    0:aload_0         
