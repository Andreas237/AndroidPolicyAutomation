...
/* anonymous class */
		...
		implements LikeActionController.RequestCompletionCallback
	{
		...
		//   37   76:invokevirtual   #71  <Method void LikeActionController$PublishLikeRequestWrapper.addToBatch(GraphRequestBatch)>
				graphrequestbatch.addCallback(((com.facebook.GraphRequestBatch.Callback) (((LikeActionController._cls7._cls1) (publishlikerequestwrapper)). new LikeActionController._cls7._cls1())));
		//   38   79:aload_1         
