...
public class LikeActionController
{
	...
	private class GetEngagementRequestWrapper extends AbstractRequestWrapper
	{
		...
		//    0    0:getstatic       #84  <Field LoggingBehavior LoggingBehavior.REQUESTS>
		//    1    3:invokestatic    #88  <Method String LikeActionController.access$100()>
		//    2    6:ldc1            #90  <String "Error fetching engagement for object '%s' with type '%s' : %s">
		//    3    8:iconst_3        
		//    4    9:anewarray       Object[]
		//    5   12:dup             
		//    6   13:iconst_0        
		//    7   14:aload_0         
		//    8   15:getfield        #95  <Field String objectId>
		//    9   18:aastore         
		//   10   19:dup             
		//   11   20:iconst_1        
		//   12   21:aload_0         
		//   13   22:getfield        #99  <Field com.facebook.share.widget.LikeView$ObjectType objectType>
		//   14   25:aastore         
		//   15   26:dup             
		//   16   27:iconst_2        
		//   17   28:aload_1         
		//   18   29:aastore         
		//   19   30:invokestatic    #105 <Method void Logger.log(LoggingBehavior, String, String, Object[])>
			logAppEventForError("get_engagement", facebookrequesterror);
		//   20   33:aload_0         
		//   21   34:getfield        #18  <Field LikeActionController this$0>
		//   22   37:ldc1            #107 <String "get_engagement">
		//   23   39:aload_1         
		//   24   40:invokestatic    #111 <Method void LikeActionController.access$2400(LikeActionController, String, FacebookRequestError)>
		//   25   43:return          
		}
		...
		//    0    0:aload_1         
		//    1    1:invokevirtual   #119 <Method JSONObject GraphResponse.getJSONObject()>
		//    2    4:ldc1            #121 <String "engagement">
		//    3    6:invokestatic    #127 <Method JSONObject Utility.tryGetJSONObjectFromResponse(JSONObject, String)>
		//    4    9:astore_1        
		...
		//    7   14:aload_0         
		//    8   15:aload_1         
		//    9   16:ldc1            #129 <String "count_string_with_like">
		//   10   18:aload_0         
		//   11   19:getfield        #26  <Field String likeCountStringWithLike>
		//   12   22:invokevirtual   #135 <Method String JSONObject.optString(String, String)>
		...
		//   14   28:aload_0         
		//   15   29:aload_1         
		//   16   30:ldc1            #137 <String "count_string_without_like">
		//   17   32:aload_0         
		//   18   33:getfield        #31  <Field String likeCountStringWithoutLike>
		//   19   36:invokevirtual   #135 <Method String JSONObject.optString(String, String)>
		...
		//   21   42:aload_0         
		//   22   43:aload_1         
		//   23   44:ldc1            #139 <String "social_sentence_with_like">
		//   24   46:aload_0         
		//   25   47:getfield        #36  <Field String socialSentenceStringWithLike>
		//   26   50:invokevirtual   #135 <Method String JSONObject.optString(String, String)>
		...
		//   28   56:aload_0         
		//   29   57:aload_1         
		//   30   58:ldc1            #141 <String "social_sentence_without_like">
		//   31   60:aload_0         
		//   32   61:getfield        #41  <Field String socialSentenceStringWithoutLike>
		//   33   64:invokevirtual   #135 <Method String JSONObject.optString(String, String)>
		...
		//   36   72:aload_0         
		//   37   73:new             #56  <Class GraphRequest>
		//   38   76:dup             
		//   39   77:invokestatic    #62  <Method AccessToken AccessToken.getCurrentAccessToken()>
		//   40   80:aload_2         
		//   41   81:aload_1         
		//   42   82:getstatic       #68  <Field HttpMethod HttpMethod.GET>
		//   43   85:invokespecial   #71  <Method void GraphRequest(AccessToken, String, Bundle, HttpMethod)>
		//   44   88:invokevirtual   #75  <Method void setRequest(GraphRequest)>
		//   45   91:return          
		}
	}
		...
		implements LikeRequestWrapper
	{
		...
		//   27   50:astore          5
					if(jsonobject1 != null && accesstoken != null && Utility.areObjectsEqual(((Object) (accesstoken.getApplicationId())), ((Object) (jsonobject1.optString("id")))))
		//*  28   52:aload           4
		//*  29   54:ifnull          90
		//*  30   57:aload           5
		//*  31   59:ifnull          90
		//*  32   62:aload           5
		//*  33   64:invokevirtual   #142 <Method String AccessToken.getApplicationId()>
		//*  34   67:aload           4
		//*  35   69:ldc1            #144 <String "id">
		//*  36   71:invokevirtual   #148 <Method String JSONObject.optString(String)>
		//*  37   74:invokestatic    #152 <Method boolean Utility.areObjectsEqual(Object, Object)>
		//*  38   77:ifeq            90
						unlikeToken = jsonobject.optString("id");
		//   39   80:aload_0         
		//   40   81:aload_3         
		//   41   82:ldc1            #144 <String "id">
		//   42   84:invokevirtual   #148 <Method String JSONObject.optString(String)>
		//   43   87:putfield        #77  <Field String unlikeToken>
				}
		...
		implements Runnable
	{
		...
		//*  19   45:icmplt          88
			{
				String s;
				for(; 64 < mruCachedItems.size(); LikeActionController.cache.remove(((Object) (s))))
		//*  20   48:bipush          64
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #215 <Field String objectId>
		objectType = objecttype;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//    8   14:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aconst_null     
	//    3    3:invokestatic    #258 <Method void broadcastAction(LikeActionController, String, Bundle)>
	//    4    6:return          
	}
	...
	//    0    0:new             #338 <Class Intent>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokespecial   #341 <Method void Intent(String)>
	//    4    8:astore_3        
		s = ((String) (bundle));
	//    5    9:aload_2         
	//    6   10:astore_1        
	...
	//*  12   18:ifnonnull       29
				s = ((String) (new Bundle()));
	//   13   21:new             #343 <Class Bundle>
	//   14   24:dup             
	//   15   25:invokespecial   #344 <Method void Bundle()>
	//   16   28:astore_1        
			((Bundle) (s)).putString("com.facebook.sdk.LikeActionController.OBJECT_ID", likeactioncontroller.getObjectId());
	//   17   29:aload_1         
	//   18   30:ldc1            #92  <String "com.facebook.sdk.LikeActionController.OBJECT_ID">
	//   19   32:aload_0         
	//   20   33:invokevirtual   #347 <Method String getObjectId()>
	//   21   36:invokevirtual   #350 <Method void Bundle.putString(String, String)>
		}
		if(s != null)
	//*  22   39:aload_1         
	//*  23   40:ifnull          49
	...
	//   24   43:aload_3         
	//   25   44:aload_1         
	//   26   45:invokevirtual   #354 <Method Intent Intent.putExtras(Bundle)>
	//   27   48:pop             
		LocalBroadcastManager.getInstance(FacebookSdk.getApplicationContext()).sendBroadcast(intent);
	//   28   49:invokestatic    #360 <Method Context FacebookSdk.getApplicationContext()>
	//   29   52:invokestatic    #366 <Method LocalBroadcastManager LocalBroadcastManager.getInstance(Context)>
	//   30   55:aload_3         
	//   31   56:invokevirtual   #370 <Method boolean LocalBroadcastManager.sendBroadcast(Intent)>
	//   32   59:pop             
	//   33   60:return          
	}
	...
	{
		AccessToken accesstoken = AccessToken.getCurrentAccessToken();
	//    0    0:invokestatic    #378 <Method AccessToken AccessToken.getCurrentAccessToken()>
	//    1    3:astore_1        
	...
	//    2    4:aload_0         
	//    3    5:getfield        #292 <Field boolean objectIsPage>
	//    4    8:ifne            46
	//    5   11:aload_0         
	//    6   12:getfield        #261 <Field String verifiedObjectId>
	//    7   15:ifnull          46
	//    8   18:aload_1         
	//    9   19:ifnull          46
	//   10   22:aload_1         
	//   11   23:invokevirtual   #382 <Method Set AccessToken.getPermissions()>
	//   12   26:ifnull          46
	//   13   29:aload_1         
	//   14   30:invokevirtual   #382 <Method Set AccessToken.getPermissions()>
	//   15   33:ldc2            #384 <String "publish_actions">
	//   16   36:invokeinterface #390 <Method boolean Set.contains(Object)>
	//   17   41:ifeq            46
	//   18   44:iconst_1        
	//   19   45:ireturn         
	//   20   46:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:putfield        #393 <Field Bundle facebookDialogAnalyticsBundle>
		storeObjectIdForPendingController(((String) (null)));
	//    3    5:aconst_null     
	//    4    6:invokestatic    #396 <Method void storeObjectIdForPendingController(String)>
	//    5    9:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #400 <Method LikeActionController getControllerFromInMemoryCache(String)>
	//    2    4:astore_3        
		if(likeactioncontroller != null)
	//*   3    5:aload_3         
	//*   4    6:ifnull          16
	...
	//    6   10:aload_1         
	//    7   11:aload_2         
	//    8   12:invokestatic    #404 <Method void verifyControllerAndInvokeCallback(LikeActionController, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
			return;
	//    9   15:return          
		}
		LikeActionController likeactioncontroller1 = deserializeFromDiskSynchronously(s);
	//   10   16:aload_0         
	//   11   17:invokestatic    #407 <Method LikeActionController deserializeFromDiskSynchronously(String)>
	//   12   20:astore          4
	...
	//   19   34:aload_0         
	//   20   35:aload_1         
	//   21   36:invokespecial   #409 <Method void LikeActionController(String, com.facebook.share.widget.LikeView$ObjectType)>
	//   22   39:astore_3        
			serializeToDiskAsync(likeactioncontroller);
	//   23   40:aload_3         
	//   24   41:invokestatic    #412 <Method void serializeToDiskAsync(LikeActionController)>
		}
		putControllerInMemoryCache(s, likeactioncontroller);
	//   25   44:aload_0         
	//   26   45:aload_3         
	//   27   46:invokestatic    #416 <Method void putControllerInMemoryCache(String, LikeActionController)>
	...
	//   28   49:getstatic       #418 <Field Handler handler>
	//   29   52:new             #14  <Class LikeActionController$2>
	//   30   55:dup             
	//   31   56:aload_3         
	//   32   57:invokespecial   #420 <Method void LikeActionController$2(LikeActionController)>
	//   33   60:invokevirtual   #426 <Method boolean Handler.post(Runnable)>
	//   34   63:pop             
		invokeCallbackWithController(creationcallback, likeactioncontroller, ((FacebookException) (null)));
	//   35   64:aload_2         
	//   36   65:aload_3         
	//   37   66:aconst_null     
	//   38   67:invokestatic    #430 <Method void invokeCallbackWithController(LikeActionController$CreationCallback, LikeActionController, FacebookException)>
	//   39   70:return          
	}
	...
	//    6    8:aload_0         
	//    7    9:invokestatic    #436 <Method String getCacheKeyForObjectId(String)>
	//    8   12:astore_0        
		obj = ((Object) (controllerDiskCache.get(s)));
	//    9   13:getstatic       #323 <Field FileLruCache controllerDiskCache>
	//   10   16:aload_0         
	//   11   17:invokevirtual   #442 <Method java.io.InputStream FileLruCache.get(String)>
	//   12   20:astore_1        
		s = ((String) (obj2));
	//   13   21:aload_3         
	//   14   22:astore_0        
...
_L1:
	...
	//   19   29:aload_1         
	//   20   30:invokestatic    #448 <Method String Utility.readStreamToString(java.io.InputStream)>
	//   21   33:astore          6
		s = ((String) (obj2));
	//   22   35:aload_3         
	//   23   36:astore_0        
	...
	//   26   39:aload           6
	//   27   41:invokestatic    #452 <Method boolean Utility.isNullOrEmpty(String)>
	//   28   44:ifne            64
_L3:
		obj1 = obj;
	//   29   47:aload_1         
	...
	//   31   49:aload           6
	//   32   51:invokestatic    #455 <Method LikeActionController deserializeFromJson(String)>
	//   33   54:astore_0        
		  goto _L2
	//*  34   55:goto            64
...
_L7:
	...
	//   47   74:aload_2         
	//   48   75:invokestatic    #459 <Method void Utility.closeQuietly(java.io.Closeable)>
...
_L4:
	...
	//   60   91:getstatic       #227 <Field String TAG>
	//   61   94:ldc2            #461 <String "Unable to deserialize controller from disk">
	//   62   97:aload_3         
	//   63   98:invokestatic    #467 <Method int Log.e(String, String, Throwable)>
	//   64  101:pop             
		obj1 = ((Object) (obj4));
	//   65  102:aload           5
	//   66  104:astore_2        
...
_L6:
	...
	//*  78  121:ifnull          128
			Utility.closeQuietly(((java.io.Closeable) (obj1)));
	//   79  124:aload_2         
	//   80  125:invokestatic    #459 <Method void Utility.closeQuietly(java.io.Closeable)>
		throw s;
	//   81  128:aload_0         
	//   82  129:athrow          
	}
	...
	//    0    0:new             #471 <Class JSONObject>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #472 <Method void JSONObject(String)>
	//    4    8:astore_1        
		if(jsonobject.optInt("com.facebook.share.internal.LikeActionController.version", -1) != 3)
	//*   5    9:aload_1         
	//*   6   10:ldc1            #113 <String "com.facebook.share.internal.LikeActionController.version">
	//*   7   12:iconst_m1       
	//*   8   13:invokevirtual   #476 <Method int JSONObject.optInt(String, int)>
	//*   9   16:iconst_3        
	//*  10   17:icmpeq          22
			return null;
	//   11   20:aconst_null     
	...
	//   13   22:new             #2   <Class LikeActionController>
	//   14   25:dup             
	//   15   26:aload_1         
	//   16   27:ldc1            #122 <String "object_id">
	//   17   29:invokevirtual   #479 <Method String JSONObject.getString(String)>
	//   18   32:aload_1         
	//   19   33:ldc1            #110 <String "object_type">
	//   20   35:getstatic       #484 <Field com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.UNKNOWN>
	//   21   38:invokevirtual   #487 <Method int com.facebook.share.widget.LikeView$ObjectType.getValue()>
	//   22   41:invokevirtual   #476 <Method int JSONObject.optInt(String, int)>
	//   23   44:invokestatic    #491 <Method com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.fromInt(int)>
	//   24   47:invokespecial   #409 <Method void LikeActionController(String, com.facebook.share.widget.LikeView$ObjectType)>
	//   25   50:astore_0        
			s.likeCountStringWithLike = jsonobject.optString("like_count_string_with_like", ((String) (null)));
	//   26   51:aload_0         
	//   27   52:aload_1         
	//   28   53:ldc1            #119 <String "like_count_string_with_like">
	//   29   55:aconst_null     
	//   30   56:invokevirtual   #495 <Method String JSONObject.optString(String, String)>
	//   31   59:putfield        #330 <Field String likeCountStringWithLike>
			s.likeCountStringWithoutLike = jsonobject.optString("like_count_string_without_like", ((String) (null)));
	//   32   62:aload_0         
	//   33   63:aload_1         
	//   34   64:ldc1            #116 <String "like_count_string_without_like">
	//   35   66:aconst_null     
	//   36   67:invokevirtual   #495 <Method String JSONObject.optString(String, String)>
	//   37   70:putfield        #333 <Field String likeCountStringWithoutLike>
			s.socialSentenceWithLike = jsonobject.optString("social_sentence_with_like", ((String) (null)));
	//   38   73:aload_0         
	//   39   74:aload_1         
	//   40   75:ldc1            #128 <String "social_sentence_with_like">
	//   41   77:aconst_null     
	//   42   78:invokevirtual   #495 <Method String JSONObject.optString(String, String)>
	//   43   81:putfield        #336 <Field String socialSentenceWithLike>
			s.socialSentenceWithoutLike = jsonobject.optString("social_sentence_without_like", ((String) (null)));
	//   44   84:aload_0         
	//   45   85:aload_1         
	//   46   86:ldc1            #125 <String "social_sentence_without_like">
	//   47   88:aconst_null     
	//   48   89:invokevirtual   #495 <Method String JSONObject.optString(String, String)>
	//   49   92:putfield        #231 <Field String socialSentenceWithoutLike>
			s.isObjectLiked = jsonobject.optBoolean("is_object_liked");
	//   50   95:aload_0         
	//   51   96:aload_1         
	//   52   97:ldc1            #104 <String "is_object_liked">
	//   53   99:invokevirtual   #498 <Method boolean JSONObject.optBoolean(String)>
	//   54  102:putfield        #301 <Field boolean isObjectLiked>
			s.unlikeToken = jsonobject.optString("unlike_token", ((String) (null)));
	//   55  105:aload_0         
	//   56  106:aload_1         
	//   57  107:ldc1            #131 <String "unlike_token">
	//   58  109:aconst_null     
	//   59  110:invokevirtual   #495 <Method String JSONObject.optString(String, String)>
	//   60  113:putfield        #234 <Field String unlikeToken>
			jsonobject = jsonobject.optJSONObject("facebook_dialog_analytics_bundle");
	//   61  116:aload_1         
	//   62  117:ldc1            #107 <String "facebook_dialog_analytics_bundle">
	//   63  119:invokevirtual   #502 <Method JSONObject JSONObject.optJSONObject(String)>
	//   64  122:astore_1        
		}
	//*  65  123:aload_1         
	//*  66  124:ifnull          135
	//*  67  127:aload_0         
	//*  68  128:aload_1         
	//*  69  129:invokestatic    #508 <Method Bundle BundleJSONConverter.convertToBundle(JSONObject)>
	//*  70  132:putfield        #393 <Field Bundle facebookDialogAnalyticsBundle>
	//*  71  135:aload_0         
	//*  72  136:areturn         
	...
	//   74  138:getstatic       #227 <Field String TAG>
	//   75  141:ldc2            #510 <String "Unable to deserialize controller from JSON">
	//   76  144:aload_0         
	//   77  145:invokestatic    #467 <Method int Log.e(String, String, Throwable)>
	//   78  148:pop             
			return null;
	//   79  149:aconst_null     
	//   80  150:areturn         
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #261 <Field String verifiedObjectId>
	//*   2    4:invokestatic    #452 <Method boolean Utility.isNullOrEmpty(String)>
	//*   3    7:ifne            21
		{
	...
	//    6   14:aload_1         
	//    7   15:invokeinterface #515 <Method void LikeActionController$RequestCompletionCallback.onComplete()>
			return;
	//    8   20:return          
		} else
		{
	...
	//   11   25:aload_0         
	//   12   26:aload_0         
	//   13   27:getfield        #215 <Field String objectId>
	//   14   30:aload_0         
	//   15   31:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   16   34:invokespecial   #518 <Method void LikeActionController$GetOGObjectIdRequestWrapper(LikeActionController, String, com.facebook.share.widget.LikeView$ObjectType)>
	//   17   37:astore_2        
	...
	//   20   42:aload_0         
	//   21   43:aload_0         
	//   22   44:getfield        #215 <Field String objectId>
	//   23   47:aload_0         
	//   24   48:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   25   51:invokespecial   #519 <Method void LikeActionController$GetPageIdRequestWrapper(LikeActionController, String, com.facebook.share.widget.LikeView$ObjectType)>
	//   26   54:astore_3        
			GraphRequestBatch graphrequestbatch = new GraphRequestBatch();
	//   27   55:new             #521 <Class GraphRequestBatch>
	//   28   58:dup             
	//   29   59:invokespecial   #522 <Method void GraphRequestBatch()>
	//   30   62:astore          4
			objectIdRequest.addToBatch(graphrequestbatch);
	//   31   64:aload_2         
	//   32   65:aload           4
	//   33   67:invokevirtual   #526 <Method void LikeActionController$GetOGObjectIdRequestWrapper.addToBatch(GraphRequestBatch)>
			pageIdRequest.addToBatch(graphrequestbatch);
	//   34   70:aload_3         
	//   35   71:aload           4
	//   36   73:invokevirtual   #527 <Method void LikeActionController$GetPageIdRequestWrapper.addToBatch(GraphRequestBatch)>
	...
	//   42   84:aload_3         
	//   43   85:aload_1         
	//   44   86:invokespecial   #530 <Method void LikeActionController$11(LikeActionController, LikeActionController$GetOGObjectIdRequestWrapper, LikeActionController$GetPageIdRequestWrapper, LikeActionController$RequestCompletionCallback)>
	//   45   89:invokevirtual   #534 <Method void GraphRequestBatch.addCallback(com.facebook.GraphRequestBatch$Callback)>
			graphrequestbatch.executeAsync();
	//   46   92:aload           4
	//   47   94:invokevirtual   #538 <Method com.facebook.GraphRequestAsyncTask GraphRequestBatch.executeAsync()>
	//   48   97:pop             
			return;
	//   49   98:return          
		}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #540 <Field AppEventsLogger appEventsLogger>
	//*   2    4:ifnonnull       17
			appEventsLogger = AppEventsLogger.newLogger(FacebookSdk.getApplicationContext());
	//    3    7:aload_0         
	//    4    8:invokestatic    #360 <Method Context FacebookSdk.getApplicationContext()>
	//    5   11:invokestatic    #546 <Method AppEventsLogger AppEventsLogger.newLogger(Context)>
	//    6   14:putfield        #540 <Field AppEventsLogger appEventsLogger>
		return appEventsLogger;
	//    7   17:aload_0         
	//    8   18:getfield        #540 <Field AppEventsLogger appEventsLogger>
	//    9   21:areturn         
	}
	...
	//    4    8:aload_1         
	//    5    9:invokevirtual   #549 <Method String AccessToken.getToken()>
	//    6   12:astore_1        
		else
	//*   7   13:goto            18
			obj = null;
	...
	//   14   24:aload_1         
	//   15   25:invokestatic    #552 <Method String Utility.md5hash(String)>
	//   16   28:astore_2        
	...
	//   17   29:getstatic       #558 <Field Locale Locale.ROOT>
	//   18   32:ldc2            #560 <String "%s|%s|com.fb.sdk.like|%d">
	//   19   35:iconst_3        
	...
	//   26   44:iconst_1        
	//   27   45:aload_2         
	//   28   46:ldc2            #562 <String "">
	//   29   49:invokestatic    #565 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   30   52:aastore         
	//   31   53:dup             
	//   32   54:iconst_2        
	//   33   55:getstatic       #315 <Field int objectSuffix>
	//   34   58:invokestatic    #571 <Method Integer Integer.valueOf(int)>
	//   35   61:aastore         
	//   36   62:invokestatic    #577 <Method String String.format(Locale, String, Object[])>
	//   37   65:areturn         
	}
	...
	{
		if(!isInitialized)
	//*   0    0:getstatic       #580 <Field boolean isInitialized>
	//*   1    3:ifne            9
			performFirstInitialize();
	//    2    6:invokestatic    #583 <Method void performFirstInitialize()>
		LikeActionController likeactioncontroller = getControllerFromInMemoryCache(s);
	//    3    9:aload_0         
	//    4   10:invokestatic    #400 <Method LikeActionController getControllerFromInMemoryCache(String)>
	//    5   13:astore_3        
		if(likeactioncontroller != null)
	//*   6   14:aload_3         
	//*   7   15:ifnull          25
	...
	//    9   19:aload_1         
	//   10   20:aload_2         
	//   11   21:invokestatic    #404 <Method void verifyControllerAndInvokeCallback(LikeActionController, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
			return;
	//   12   24:return          
		} else
		{
			diskIOWorkQueue.addActiveWorkItem(((Runnable) (new CreateLikeActionControllerWorkItem(s, objecttype, creationcallback))));
	//   13   25:getstatic       #210 <Field WorkQueue diskIOWorkQueue>
	//   14   28:new             #39  <Class LikeActionController$CreateLikeActionControllerWorkItem>
	//   15   31:dup             
	//   16   32:aload_0         
	//   17   33:aload_1         
	//   18   34:aload_2         
	//   19   35:invokespecial   #585 <Method void LikeActionController$CreateLikeActionControllerWorkItem(String, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
	//   20   38:invokevirtual   #589 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   21   41:pop             
			return;
	//   22   42:return          
		}
	...
	private static LikeActionController getControllerFromInMemoryCache(String s)
	{
		s = getCacheKeyForObjectId(s);
	//    0    0:aload_0         
	//    1    1:invokestatic    #436 <Method String getCacheKeyForObjectId(String)>
	//    2    4:astore_0        
		LikeActionController likeactioncontroller = (LikeActionController)cache.get(((Object) (s)));
	//    3    5:getstatic       #201 <Field ConcurrentHashMap cache>
	//    4    8:aload_0         
	//    5    9:invokevirtual   #592 <Method Object ConcurrentHashMap.get(Object)>
	...
	//   10   20:getstatic       #208 <Field WorkQueue mruCacheWorkQueue>
	//   11   23:new             #63  <Class LikeActionController$MRUCacheWorkItem>
	//   12   26:dup             
	//   13   27:aload_0         
	//   14   28:iconst_0        
	//   15   29:invokespecial   #595 <Method void LikeActionController$MRUCacheWorkItem(String, boolean)>
	//   16   32:invokevirtual   #589 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   17   35:pop             
	...
	//    3    5:aconst_null     
	//    4    6:aload_1         
	//    5    7:invokespecial   #600 <Method void LikeActionController$6(LikeActionController, FacebookCallback, Bundle)>
	//    6   10:areturn         
	}
	...
	//*   0    0:getstatic       #604 <Field String objectIdForPendingController>
	//*   1    3:invokestatic    #452 <Method boolean Utility.isNullOrEmpty(String)>
	//*   2    6:ifeq            29
	...
	//    3    9:invokestatic    #360 <Method Context FacebookSdk.getApplicationContext()>
	//    4   12:ldc1            #134 <String "com.facebook.LikeActionController.CONTROLLER_STORE_KEY">
	//    5   14:iconst_0        
	//    6   15:invokevirtual   #610 <Method SharedPreferences Context.getSharedPreferences(String, int)>
	//    7   18:ldc1            #140 <String "PENDING_CONTROLLER_KEY">
	//    8   20:aconst_null     
	//    9   21:invokeinterface #614 <Method String SharedPreferences.getString(String, String)>
	//   10   26:putstatic       #604 <Field String objectIdForPendingController>
		if(Utility.isNullOrEmpty(objectIdForPendingController))
	//*  11   29:getstatic       #604 <Field String objectIdForPendingController>
	//*  12   32:invokestatic    #452 <Method boolean Utility.isNullOrEmpty(String)>
	//*  13   35:ifeq            40
		{
			return false;
	//   14   38:iconst_0        
	...
	//   16   40:getstatic       #604 <Field String objectIdForPendingController>
	//   17   43:getstatic       #484 <Field com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.UNKNOWN>
	//   18   46:new             #6   <Class LikeActionController$1>
	//   19   49:dup             
	//   20   50:iload_0         
	//   21   51:iload_1         
	//   22   52:aload_2         
	//   23   53:invokespecial   #616 <Method void LikeActionController$1(int, int, Intent)>
	//   24   56:invokestatic    #618 <Method void getControllerForObjectId(String, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
			return true;
	//   25   59:iconst_1        
	//   26   60:ireturn         
		}
	...
	//    3    5:getstatic       #418 <Field Handler handler>
	//    4    8:new             #18  <Class LikeActionController$4>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:aload_2         
	//    9   15:invokespecial   #620 <Method void LikeActionController$4(LikeActionController$CreationCallback, LikeActionController, FacebookException)>
	//   10   18:invokevirtual   #426 <Method boolean Handler.post(Runnable)>
	//   11   21:pop             
			return;
	//   12   22:return          
		}
	...
	//    0    0:new             #343 <Class Bundle>
	//    1    3:dup             
	//    2    4:aload_2         
	//    3    5:invokespecial   #622 <Method void Bundle(Bundle)>
	//    4    8:astore_2        
		bundle.putString("object_id", objectId);
	//    5    9:aload_2         
	//    6   10:ldc1            #122 <String "object_id">
	//    7   12:aload_0         
	//    8   13:getfield        #215 <Field String objectId>
	//    9   16:invokevirtual   #350 <Method void Bundle.putString(String, String)>
		bundle.putString("object_type", objectType.toString());
	//   10   19:aload_2         
	//   11   20:ldc1            #110 <String "object_type">
	//   12   22:aload_0         
	//   13   23:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   14   26:invokevirtual   #625 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   15   29:invokevirtual   #350 <Method void Bundle.putString(String, String)>
		bundle.putString("current_action", s);
	//   16   32:aload_2         
	//   17   33:ldc2            #627 <String "current_action">
	//   18   36:aload_1         
	//   19   37:invokevirtual   #350 <Method void Bundle.putString(String, String)>
		getAppEventsLogger().logSdkEvent("fb_like_control_error", ((Double) (null)), bundle);
	//   20   40:aload_0         
	//   21   41:invokespecial   #242 <Method AppEventsLogger getAppEventsLogger()>
	//   22   44:ldc2            #629 <String "fb_like_control_error">
	//   23   47:aconst_null     
	//   24   48:aload_2         
	//   25   49:invokevirtual   #633 <Method void AppEventsLogger.logSdkEvent(String, Double, Bundle)>
	//   26   52:return          
	}
	...
	//    0    0:new             #343 <Class Bundle>
	//    1    3:dup             
	//    2    4:invokespecial   #344 <Method void Bundle()>
	//    3    7:astore_3        
	...
	//    6   12:aload_2         
	//    7   13:invokevirtual   #639 <Method JSONObject FacebookRequestError.getRequestResult()>
	//    8   16:astore_2        
			if(facebookrequesterror != null)
	//*   9   17:aload_2         
	//*  10   18:ifnull          32
				bundle.putString("error", ((JSONObject) (facebookrequesterror)).toString());
	//   11   21:aload_3         
	//   12   22:ldc2            #641 <String "error">
	//   13   25:aload_2         
	//   14   26:invokevirtual   #642 <Method String JSONObject.toString()>
	//   15   29:invokevirtual   #350 <Method void Bundle.putString(String, String)>
		}
	...
	//   17   33:aload_1         
	//   18   34:aload_3         
	//   19   35:invokespecial   #254 <Method void logAppEventForError(String, Bundle)>
	//   20   38:return          
	}
	...
	//    3    3:aload_0         
	//    4    4:aload_0         
	//    5    5:getfield        #393 <Field Bundle facebookDialogAnalyticsBundle>
	//    6    8:invokespecial   #644 <Method ResultProcessor getResultProcessor(Bundle)>
	//    7   11:invokestatic    #650 <Method boolean ShareInternalUtility.handleActivityResult(int, int, Intent, ResultProcessor)>
	//    8   14:pop             
		clearState();
	//    9   15:aload_0         
	//   10   16:invokespecial   #652 <Method void clearState()>
	//   11   19:return          
	}
	...
	//    2    3:getstatic       #580 <Field boolean isInitialized>
	//    3    6:istore_0        
		if(!flag)
	...
	//    9   15:new             #422 <Class Handler>
	//   10   18:dup             
	//   11   19:invokestatic    #658 <Method Looper Looper.getMainLooper()>
	//   12   22:invokespecial   #661 <Method void Handler(Looper)>
	//   13   25:putstatic       #418 <Field Handler handler>
	...
	//   14   28:invokestatic    #360 <Method Context FacebookSdk.getApplicationContext()>
	//   15   31:ldc1            #134 <String "com.facebook.LikeActionController.CONTROLLER_STORE_KEY">
	//   16   33:iconst_0        
	//   17   34:invokevirtual   #610 <Method SharedPreferences Context.getSharedPreferences(String, int)>
	//   18   37:ldc1            #137 <String "OBJECT_SUFFIX">
	//   19   39:iconst_1        
	//   20   40:invokeinterface #664 <Method int SharedPreferences.getInt(String, int)>
	//   21   45:putstatic       #315 <Field int objectSuffix>
		controllerDiskCache = new FileLruCache(TAG, new com.facebook.internal.FileLruCache.Limits());
	//   22   48:new             #438 <Class FileLruCache>
	//   23   51:dup             
	//   24   52:getstatic       #227 <Field String TAG>
	//   25   55:new             #666 <Class com.facebook.internal.FileLruCache$Limits>
	//   26   58:dup             
	//   27   59:invokespecial   #667 <Method void com.facebook.internal.FileLruCache$Limits()>
	//   28   62:invokespecial   #670 <Method void FileLruCache(String, com.facebook.internal.FileLruCache$Limits)>
	//   29   65:putstatic       #323 <Field FileLruCache controllerDiskCache>
		registerAccessTokenTracker();
	//   30   68:invokestatic    #673 <Method void registerAccessTokenTracker()>
	...
	//   31   71:getstatic       #679 <Field com.facebook.internal.CallbackManagerImpl$RequestCodeOffset com.facebook.internal.CallbackManagerImpl$RequestCodeOffset.Like>
	//   32   74:invokevirtual   #682 <Method int com.facebook.internal.CallbackManagerImpl$RequestCodeOffset.toRequestCode()>
	//   33   77:new             #16  <Class LikeActionController$3>
	//   34   80:dup             
	//   35   81:invokespecial   #683 <Method void LikeActionController$3()>
	//   36   84:invokestatic    #689 <Method void CallbackManagerImpl.registerStaticCallback(int, com.facebook.internal.CallbackManagerImpl$Callback)>
		isInitialized = true;
	//   37   87:iconst_1        
	//   38   88:putstatic       #580 <Field boolean isInitialized>
		com/facebook/share/internal/LikeActionController;
	//   39   91:ldc1            #2   <Class LikeActionController>
		JVM INSTR monitorexit ;
	//   40   93:monitorexit     
		return;
	//   41   94:return          
		...
		exception;
	//   42   95:astore_1        
	//*  43   96:ldc1            #2   <Class LikeActionController>
		throw exception;
	//   44   98:monitorexit     
	//   45   99:aload_1         
	//   46  100:athrow          
	...
	//*   0    0:invokestatic    #696 <Method boolean LikeDialog.canShowNativeDialog()>
	//*   1    3:ifeq            14
			s = "fb_like_control_did_present_dialog";
	//    2    6:ldc2            #698 <String "fb_like_control_did_present_dialog">
	//    3    9:astore          4
		else
	//*   4   11:goto            54
		if(LikeDialog.canShowWebFallback())
	//*   5   14:invokestatic    #701 <Method boolean LikeDialog.canShowWebFallback()>
	//*   6   17:ifeq            28
		{
			s = "fb_like_control_did_present_fallback_dialog";
	//    7   20:ldc2            #703 <String "fb_like_control_did_present_fallback_dialog">
	//    8   23:astore          4
		} else
	//*   9   25:goto            54
		{
	...
	//   10   28:aload_0         
	//   11   29:ldc2            #705 <String "present_dialog">
	//   12   32:aload_3         
	//   13   33:invokespecial   #254 <Method void logAppEventForError(String, Bundle)>
			Utility.logd(TAG, "Cannot show the Like Dialog on this device.");
	//   14   36:getstatic       #227 <Field String TAG>
	//   15   39:ldc2            #707 <String "Cannot show the Like Dialog on this device.">
	//   16   42:invokestatic    #710 <Method void Utility.logd(String, String)>
			broadcastAction(((LikeActionController) (null)), "com.facebook.sdk.LikeActionController.UPDATED");
	//   17   45:aconst_null     
	//   18   46:ldc1            #89  <String "com.facebook.sdk.LikeActionController.UPDATED">
	//   19   48:invokestatic    #327 <Method void broadcastAction(LikeActionController, String)>
			s = null;
	//   20   51:aconst_null     
	//   21   52:astore          4
		}
	...
	//*  23   56:ifnull          160
		{
			...
			if(objectType != null)
	//*  24   59:aload_0         
	//*  25   60:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//*  26   63:ifnull          78
				obj = ((Object) (objectType.toString()));
	//   27   66:aload_0         
	//   28   67:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   29   70:invokevirtual   #625 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   30   73:astore          4
			else
	//*  31   75:goto            86
				obj = ((Object) (com.facebook.share.widget.LikeView.ObjectType.UNKNOWN.toString()));
	//   32   78:getstatic       #484 <Field com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.UNKNOWN>
	//   33   81:invokevirtual   #625 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   34   84:astore          4
			obj = ((Object) ((new LikeContent.Builder()).setObjectId(objectId).setObjectType(((String) (obj))).build()));
	//   35   86:new             #712 <Class LikeContent$Builder>
	//   36   89:dup             
	//   37   90:invokespecial   #713 <Method void LikeContent$Builder()>
	//   38   93:aload_0         
	//   39   94:getfield        #215 <Field String objectId>
	//   40   97:invokevirtual   #717 <Method LikeContent$Builder LikeContent$Builder.setObjectId(String)>
	//   41  100:aload           4
	//   42  102:invokevirtual   #720 <Method LikeContent$Builder LikeContent$Builder.setObjectType(String)>
	//   43  105:invokevirtual   #724 <Method LikeContent LikeContent$Builder.build()>
	//   44  108:astore          4
			if(fragment != null)
	//*  45  110:aload_2         
	//*  46  111:ifnull          130
				(new LikeDialog(fragment)).show(obj);
	//   47  114:new             #693 <Class LikeDialog>
	//   48  117:dup             
	//   49  118:aload_2         
	//   50  119:invokespecial   #727 <Method void LikeDialog(Fragment)>
	//   51  122:aload           4
	//   52  124:invokevirtual   #731 <Method void LikeDialog.show(Object)>
			else
	//*  53  127:goto            143
				(new LikeDialog(activity)).show(obj);
	//   54  130:new             #693 <Class LikeDialog>
	//   55  133:dup             
	//   56  134:aload_1         
	//   57  135:invokespecial   #734 <Method void LikeDialog(Activity)>
	//   58  138:aload           4
	//   59  140:invokevirtual   #731 <Method void LikeDialog.show(Object)>
			saveState(bundle);
	//   60  143:aload_0         
	//   61  144:aload_3         
	//   62  145:invokespecial   #737 <Method void saveState(Bundle)>
			getAppEventsLogger().logSdkEvent("fb_like_control_did_present_dialog", ((Double) (null)), bundle);
	//   63  148:aload_0         
	//   64  149:invokespecial   #242 <Method AppEventsLogger getAppEventsLogger()>
	//   65  152:ldc2            #698 <String "fb_like_control_did_present_dialog">
	//   66  155:aconst_null     
	//   67  156:aload_3         
	//   68  157:invokevirtual   #633 <Method void AppEventsLogger.logSdkEvent(String, Double, Bundle)>
		}
	//   69  160:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #301 <Field boolean isObjectLiked>
	//*   2    4:aload_0         
	//*   3    5:getfield        #282 <Field boolean isObjectLikedOnServer>
	//*   4    8:icmpeq          33
	//*   5   11:aload_0         
	//*   6   12:aload_0         
	//*   7   13:getfield        #301 <Field boolean isObjectLiked>
	//*   8   16:aload_1         
	//*   9   17:invokespecial   #741 <Method boolean publishLikeOrUnlikeAsync(boolean, Bundle)>
	//*  10   20:ifne            33
			publishDidError(isObjectLiked ^ true);
	//   11   23:aload_0         
	//   12   24:aload_0         
	//   13   25:getfield        #301 <Field boolean isObjectLiked>
	//   14   28:iconst_1        
	//   15   29:ixor            
	//   16   30:invokespecial   #274 <Method void publishDidError(boolean)>
	//   17   33:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #744 <Method void updateLikeState(boolean)>
		Bundle bundle = new Bundle();
	//    3    5:new             #343 <Class Bundle>
	//    4    8:dup             
	//    5    9:invokespecial   #344 <Method void Bundle()>
	//    6   12:astore_2        
		bundle.putString("com.facebook.platform.status.ERROR_DESCRIPTION", "Unable to publish the like/unlike action");
	//    7   13:aload_2         
	//    8   14:ldc2            #746 <String "com.facebook.platform.status.ERROR_DESCRIPTION">
	//    9   17:ldc1            #101 <String "Unable to publish the like/unlike action">
	//   10   19:invokevirtual   #350 <Method void Bundle.putString(String, String)>
		broadcastAction(this, "com.facebook.sdk.LikeActionController.DID_ERROR", bundle);
	//   11   22:aload_0         
	//   12   23:ldc1            #83  <String "com.facebook.sdk.LikeActionController.DID_ERROR">
	//   13   25:aload_2         
	//   14   26:invokestatic    #258 <Method void broadcastAction(LikeActionController, String, Bundle)>
	//   15   29:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_1        
	//    2    2:putfield        #268 <Field boolean isPendingLikeOrUnlike>
		fetchVerifiedObjectId(new RequestCompletionCallback() {
			...
			//   37   76:invokevirtual   #71  <Method void LikeActionController$PublishLikeRequestWrapper.addToBatch(GraphRequestBatch)>
					graphrequestbatch.addCallback(((_cls1) (publishlikerequestwrapper)). new com.facebook.GraphRequestBatch.Callback() {
	...
	//    6   10:aload_0         
	//    7   11:aload_1         
	//    8   12:invokespecial   #749 <Method void LikeActionController$7(LikeActionController, Bundle)>
	//    9   15:invokespecial   #751 <Method void fetchVerifiedObjectId(LikeActionController$RequestCompletionCallback)>
	//   10   18:return          
	}
	...
	private boolean publishLikeOrUnlikeAsync(boolean flag, Bundle bundle)
	{
		if(canUseOGPublish())
	//*   0    0:aload_0         
	//*   1    1:invokespecial   #753 <Method boolean canUseOGPublish()>
	//*   2    4:ifeq            35
		{
			if(flag)
	//*   3    7:iload_1         
	...
	//    5   11:aload_0         
	//    6   12:aload_2         
	//    7   13:invokespecial   #755 <Method void publishLikeAsync(Bundle)>
				return true;
	//    8   16:iconst_1        
	//    9   17:ireturn         
			}
	...
	//*  10   18:aload_0         
	//*  11   19:getfield        #234 <Field String unlikeToken>
	//*  12   22:invokestatic    #452 <Method boolean Utility.isNullOrEmpty(String)>
	//*  13   25:ifne            35
			{
				publishUnlikeAsync(bundle);
	//   14   28:aload_0         
	//   15   29:aload_2         
	//   16   30:invokespecial   #758 <Method void publishUnlikeAsync(Bundle)>
				return true;
	//   17   33:iconst_1        
	//   18   34:ireturn         
			}
	...
	//    2    2:putfield        #268 <Field boolean isPendingLikeOrUnlike>
		GraphRequestBatch graphrequestbatch = new GraphRequestBatch();
	//    3    5:new             #521 <Class GraphRequestBatch>
	//    4    8:dup             
	//    5    9:invokespecial   #522 <Method void GraphRequestBatch()>
	//    6   12:astore_2        
	...
	//   10   18:aload_0         
	//   11   19:getfield        #234 <Field String unlikeToken>
	//   12   22:invokespecial   #760 <Method void LikeActionController$PublishUnlikeRequestWrapper(LikeActionController, String)>
	//   13   25:astore_3        
		unlikeRequest.addToBatch(graphrequestbatch);
	//   14   26:aload_3         
	//   15   27:aload_2         
	//   16   28:invokevirtual   #761 <Method void LikeActionController$PublishUnlikeRequestWrapper.addToBatch(GraphRequestBatch)>
		graphrequestbatch.addCallback(new com.facebook.GraphRequestBatch.Callback() {
	...
	//   21   37:aload_3         
	//   22   38:aload_1         
	//   23   39:invokespecial   #764 <Method void LikeActionController$8(LikeActionController, LikeActionController$PublishUnlikeRequestWrapper, Bundle)>
	//   24   42:invokevirtual   #534 <Method void GraphRequestBatch.addCallback(com.facebook.GraphRequestBatch$Callback)>
		graphrequestbatch.executeAsync();
	//   25   45:aload_2         
	//   26   46:invokevirtual   #538 <Method com.facebook.GraphRequestAsyncTask GraphRequestBatch.executeAsync()>
	//   27   49:pop             
	//   28   50:return          
	}
	...
	//    3    5:getstatic       #208 <Field WorkQueue mruCacheWorkQueue>
	//    4    8:new             #63  <Class LikeActionController$MRUCacheWorkItem>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:iconst_1        
	//    8   14:invokespecial   #595 <Method void LikeActionController$MRUCacheWorkItem(String, boolean)>
	//    9   17:invokevirtual   #589 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   10   20:pop             
		cache.put(((Object) (s)), ((Object) (likeactioncontroller)));
	//   11   21:getstatic       #201 <Field ConcurrentHashMap cache>
	//   12   24:aload_0         
	//   13   25:aload_1         
	//   14   26:invokevirtual   #768 <Method Object ConcurrentHashMap.put(Object, Object)>
	//   15   29:pop             
	//   16   30:return          
	}
	...
	//    2    6:aload_0         
	//    3    7:invokespecial   #771 <Method void refreshStatusViaService()>
			return;
	//    4   10:return          
		} else
		{
			fetchVerifiedObjectId(new RequestCompletionCallback() {
				...
				//*   6   14:iconst_1        
				//*   7   15:icmpeq          47
						likeRequestWrapper = ((Object) (new GetOGObjectLikesRequestWrapper(verifiedObjectId, objectType)));
				...
				//*  20   44:goto            66
						likeRequestWrapper = ((Object) (new GetPageLikesRequestWrapper(verifiedObjectId)));
				...
				//   51  109:invokevirtual   #66  <Method void LikeActionController$GetEngagementRequestWrapper.addToBatch(GraphRequestBatch)>
					graphrequestbatch.addCallback(((_cls1) (getengagementrequestwrapper)). new com.facebook.GraphRequestBatch.Callback() {
	...
	//    7   15:dup             
	//    8   16:aload_0         
	//    9   17:invokespecial   #772 <Method void LikeActionController$9(LikeActionController)>
	//   10   20:invokespecial   #751 <Method void fetchVerifiedObjectId(LikeActionController$RequestCompletionCallback)>
			return;
	//   11   23:return          
		}
	}
	...
	//    0    0:new             #774 <Class LikeStatusClient>
	//    1    3:dup             
	//    2    4:invokestatic    #360 <Method Context FacebookSdk.getApplicationContext()>
	//    3    7:invokestatic    #777 <Method String FacebookSdk.getApplicationId()>
	//    4   10:aload_0         
	//    5   11:getfield        #215 <Field String objectId>
	//    6   14:invokespecial   #780 <Method void LikeStatusClient(Context, String, String)>
	//    7   17:astore_1        
		if(!likestatusclient.start())
	//*   8   18:aload_1         
	//*   9   19:invokevirtual   #783 <Method boolean LikeStatusClient.start()>
	//*  10   22:ifne            26
		{
			return;
	//   11   25:return          
	...
	//   14   30:dup             
	//   15   31:aload_0         
	//   16   32:invokespecial   #784 <Method void LikeActionController$10(LikeActionController)>
	//   17   35:invokevirtual   #788 <Method void LikeStatusClient.setCompletedListener(com.facebook.internal.PlatformServiceClient$CompletedListener)>
			return;
	//   18   38:return          
		}
	}
	...
	//    1    3:dup             
	//    2    4:invokespecial   #789 <Method void LikeActionController$5()>
	//    3    7:putstatic       #791 <Field AccessTokenTracker accessTokenTracker>
	//    4   10:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #215 <Field String objectId>
	//    2    4:invokestatic    #396 <Method void storeObjectIdForPendingController(String)>
		facebookDialogAnalyticsBundle = bundle;
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #393 <Field Bundle facebookDialogAnalyticsBundle>
		serializeToDiskAsync(this);
	//    6   12:aload_0         
	//    7   13:invokestatic    #412 <Method void serializeToDiskAsync(LikeActionController)>
	//    8   16:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #794 <Method String serializeToJson(LikeActionController)>
	//    2    4:astore_1        
		likeactioncontroller = ((LikeActionController) (getCacheKeyForObjectId(likeactioncontroller.objectId)));
	//    3    5:aload_0         
	//    4    6:getfield        #215 <Field String objectId>
	//    5    9:invokestatic    #436 <Method String getCacheKeyForObjectId(String)>
	//    6   12:astore_0        
		if(!Utility.isNullOrEmpty(s) && !Utility.isNullOrEmpty(((String) (likeactioncontroller))))
	//*   7   13:aload_1         
	//*   8   14:invokestatic    #452 <Method boolean Utility.isNullOrEmpty(String)>
	//*   9   17:ifne            43
	//*  10   20:aload_0         
	//*  11   21:invokestatic    #452 <Method boolean Utility.isNullOrEmpty(String)>
	//*  12   24:ifne            43
			diskIOWorkQueue.addActiveWorkItem(((Runnable) (new SerializeToDiskWorkItem(((String) (likeactioncontroller)), s))));
	//   13   27:getstatic       #210 <Field WorkQueue diskIOWorkQueue>
	//   14   30:new             #78  <Class LikeActionController$SerializeToDiskWorkItem>
	//   15   33:dup             
	//   16   34:aload_0         
	//   17   35:aload_1         
	//   18   36:invokespecial   #796 <Method void LikeActionController$SerializeToDiskWorkItem(String, String)>
	//   19   39:invokevirtual   #589 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   20   42:pop             
	//   21   43:return          
	}
	...
	//    4    4:getstatic       #323 <Field FileLruCache controllerDiskCache>
	//    5    7:aload_0         
	//    6    8:invokevirtual   #800 <Method OutputStream FileLruCache.openPutStream(String)>
	//    7   11:astore_0        
		try
		{
	...
	//    8   12:aload_0         
	//    9   13:aload_1         
	//   10   14:invokevirtual   #804 <Method byte[] String.getBytes()>
	//   11   17:invokevirtual   #810 <Method void OutputStream.write(byte[])>
		}
	//*  12   20:aload_0         
	//*  13   21:ifnull          69
	//*  14   24:aload_0         
	//*  15   25:invokestatic    #459 <Method void Utility.closeQuietly(java.io.Closeable)>
	//*  16   28:return          
	//*  17   29:astore_1        
	//*  18   30:aload_0         
	//*  19   31:astore_2        
	...
	//   30   48:aload_0         
	//   31   49:astore_2        
		Log.e(TAG, "Unable to serialize controller to disk", ((Throwable) (s1)));
	//   32   50:getstatic       #227 <Field String TAG>
	//   33   53:ldc2            #812 <String "Unable to serialize controller to disk">
	//   34   56:aload_1         
	//   35   57:invokestatic    #467 <Method int Log.e(String, String, Throwable)>
	//   36   60:pop             
		if(s != null)
	//*  37   61:aload_0         
	//*  38   62:ifnull          69
			Utility.closeQuietly(((java.io.Closeable) (s)));
	//   39   65:aload_0         
	//   40   66:invokestatic    #459 <Method void Utility.closeQuietly(java.io.Closeable)>
		return;
	//   41   69:return          
		if(s2 != null)
	//*  42   70:aload_2         
	//*  43   71:ifnull          78
			Utility.closeQuietly(((java.io.Closeable) (s2)));
	//   44   74:aload_2         
	//   45   75:invokestatic    #459 <Method void Utility.closeQuietly(java.io.Closeable)>
		throw s;
	//   46   78:aload_0         
	//   47   79:athrow          
	}
	...
	//    0    0:new             #471 <Class JSONObject>
	//    1    3:dup             
	//    2    4:invokespecial   #813 <Method void JSONObject()>
	//    3    7:astore_1        
		jsonobject.put("com.facebook.share.internal.LikeActionController.version", 3);
	//    4    8:aload_1         
	//    5    9:ldc1            #113 <String "com.facebook.share.internal.LikeActionController.version">
	//    6   11:iconst_3        
	//    7   12:invokevirtual   #816 <Method JSONObject JSONObject.put(String, int)>
	//    8   15:pop             
		jsonobject.put("object_id", ((Object) (likeactioncontroller.objectId)));
	//    9   16:aload_1         
	//   10   17:ldc1            #122 <String "object_id">
	//   11   19:aload_0         
	//   12   20:getfield        #215 <Field String objectId>
	//   13   23:invokevirtual   #819 <Method JSONObject JSONObject.put(String, Object)>
	//   14   26:pop             
		jsonobject.put("object_type", likeactioncontroller.objectType.getValue());
	//   15   27:aload_1         
	//   16   28:ldc1            #110 <String "object_type">
	//   17   30:aload_0         
	//   18   31:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   19   34:invokevirtual   #487 <Method int com.facebook.share.widget.LikeView$ObjectType.getValue()>
	//   20   37:invokevirtual   #816 <Method JSONObject JSONObject.put(String, int)>
	//   21   40:pop             
		jsonobject.put("like_count_string_with_like", ((Object) (likeactioncontroller.likeCountStringWithLike)));
	//   22   41:aload_1         
	//   23   42:ldc1            #119 <String "like_count_string_with_like">
	//   24   44:aload_0         
	//   25   45:getfield        #330 <Field String likeCountStringWithLike>
	//   26   48:invokevirtual   #819 <Method JSONObject JSONObject.put(String, Object)>
	//   27   51:pop             
		jsonobject.put("like_count_string_without_like", ((Object) (likeactioncontroller.likeCountStringWithoutLike)));
	//   28   52:aload_1         
	//   29   53:ldc1            #116 <String "like_count_string_without_like">
	//   30   55:aload_0         
	//   31   56:getfield        #333 <Field String likeCountStringWithoutLike>
	//   32   59:invokevirtual   #819 <Method JSONObject JSONObject.put(String, Object)>
	//   33   62:pop             
		jsonobject.put("social_sentence_with_like", ((Object) (likeactioncontroller.socialSentenceWithLike)));
	//   34   63:aload_1         
	//   35   64:ldc1            #128 <String "social_sentence_with_like">
	//   36   66:aload_0         
	//   37   67:getfield        #336 <Field String socialSentenceWithLike>
	//   38   70:invokevirtual   #819 <Method JSONObject JSONObject.put(String, Object)>
	//   39   73:pop             
		jsonobject.put("social_sentence_without_like", ((Object) (likeactioncontroller.socialSentenceWithoutLike)));
	//   40   74:aload_1         
	//   41   75:ldc1            #125 <String "social_sentence_without_like">
	//   42   77:aload_0         
	//   43   78:getfield        #231 <Field String socialSentenceWithoutLike>
	//   44   81:invokevirtual   #819 <Method JSONObject JSONObject.put(String, Object)>
	//   45   84:pop             
		jsonobject.put("is_object_liked", likeactioncontroller.isObjectLiked);
	//   46   85:aload_1         
	//   47   86:ldc1            #104 <String "is_object_liked">
	//   48   88:aload_0         
	//   49   89:getfield        #301 <Field boolean isObjectLiked>
	//   50   92:invokevirtual   #822 <Method JSONObject JSONObject.put(String, boolean)>
	//   51   95:pop             
		jsonobject.put("unlike_token", ((Object) (likeactioncontroller.unlikeToken)));
	//   52   96:aload_1         
	//   53   97:ldc1            #131 <String "unlike_token">
	//   54   99:aload_0         
	//   55  100:getfield        #234 <Field String unlikeToken>
	//   56  103:invokevirtual   #819 <Method JSONObject JSONObject.put(String, Object)>
	//   57  106:pop             
		if(likeactioncontroller.facebookDialogAnalyticsBundle == null)
			break MISSING_BLOCK_LABEL_134;
	//   58  107:aload_0         
	//   59  108:getfield        #393 <Field Bundle facebookDialogAnalyticsBundle>
	//   60  111:ifnull          134
	...
	//   61  114:aload_0         
	//   62  115:getfield        #393 <Field Bundle facebookDialogAnalyticsBundle>
	//   63  118:invokestatic    #826 <Method JSONObject BundleJSONConverter.convertToJSON(Bundle)>
	//   64  121:astore_0        
		if(likeactioncontroller != null)
	//*  65  122:aload_0         
	//*  66  123:ifnull          134
	...
	//   67  126:aload_1         
	//   68  127:ldc1            #107 <String "facebook_dialog_analytics_bundle">
	//   69  129:aload_0         
	//   70  130:invokevirtual   #819 <Method JSONObject JSONObject.put(String, Object)>
	//   71  133:pop             
			}
	//*  72  134:aload_1         
	//*  73  135:invokevirtual   #642 <Method String JSONObject.toString()>
	//*  74  138:areturn         
			// Misplaced declaration of an exception variable
	...
	//   76  140:getstatic       #227 <Field String TAG>
	//   77  143:ldc2            #828 <String "Unable to serialize controller to JSON">
	//   78  146:aload_0         
	//   79  147:invokestatic    #467 <Method int Log.e(String, String, Throwable)>
	//   80  150:pop             
				return null;
	//   81  151:aconst_null     
	//   82  152:areturn         
	...
	//    0    0:aload_0         
	//    1    1:putstatic       #604 <Field String objectIdForPendingController>
	...
	//    2    4:invokestatic    #360 <Method Context FacebookSdk.getApplicationContext()>
	//    3    7:ldc1            #134 <String "com.facebook.LikeActionController.CONTROLLER_STORE_KEY">
	//    4    9:iconst_0        
	//    5   10:invokevirtual   #610 <Method SharedPreferences Context.getSharedPreferences(String, int)>
	//    6   13:invokeinterface #832 <Method android.content.SharedPreferences$Editor SharedPreferences.edit()>
	//    7   18:ldc1            #140 <String "PENDING_CONTROLLER_KEY">
	//    8   20:getstatic       #604 <Field String objectIdForPendingController>
	//    9   23:invokeinterface #837 <Method android.content.SharedPreferences$Editor android.content.SharedPreferences$Editor.putString(String, String)>
	//   10   28:invokeinterface #840 <Method void android.content.SharedPreferences$Editor.apply()>
	//   11   33:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:aload_0         
	//    3    3:getfield        #330 <Field String likeCountStringWithLike>
	//    4    6:aload_0         
	//    5    7:getfield        #333 <Field String likeCountStringWithoutLike>
	//    6   10:aload_0         
	//    7   11:getfield        #336 <Field String socialSentenceWithLike>
	//    8   14:aload_0         
	//    9   15:getfield        #231 <Field String socialSentenceWithoutLike>
	//   10   18:aload_0         
	//   11   19:getfield        #234 <Field String unlikeToken>
	//   12   22:invokespecial   #248 <Method void updateState(boolean, String, String, String, String, String)>
	//   13   25:return          
	}
	...
	//    0    0:aload_2         
	//    1    1:aconst_null     
	//    2    2:invokestatic    #565 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//    3    5:astore_2        
		s1 = Utility.coerceValueIfNullOrEmpty(s1, ((String) (null)));
	//    4    6:aload_3         
	//    5    7:aconst_null     
	//    6    8:invokestatic    #565 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//    7   11:astore_3        
		s2 = Utility.coerceValueIfNullOrEmpty(s2, ((String) (null)));
	//    8   12:aload           4
	//    9   14:aconst_null     
	//   10   15:invokestatic    #565 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   11   18:astore          4
		s3 = Utility.coerceValueIfNullOrEmpty(s3, ((String) (null)));
	//   12   20:aload           5
	//   13   22:aconst_null     
	//   14   23:invokestatic    #565 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   15   26:astore          5
		s4 = Utility.coerceValueIfNullOrEmpty(s4, ((String) (null)));
	//   16   28:aload           6
	//   17   30:aconst_null     
	//   18   31:invokestatic    #565 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   19   34:astore          6
		boolean flag1;
	...
	//*  20   36:iload_1         
	//*  21   37:aload_0         
	//*  22   38:getfield        #301 <Field boolean isObjectLiked>
	//*  23   41:icmpne          111
	//*  24   44:aload_2         
	//*  25   45:aload_0         
	//*  26   46:getfield        #330 <Field String likeCountStringWithLike>
	//*  27   49:invokestatic    #844 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  28   52:ifeq            111
	//*  29   55:aload_3         
	//*  30   56:aload_0         
	//*  31   57:getfield        #333 <Field String likeCountStringWithoutLike>
	//*  32   60:invokestatic    #844 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  33   63:ifeq            111
	//*  34   66:aload           4
	//*  35   68:aload_0         
	//*  36   69:getfield        #336 <Field String socialSentenceWithLike>
	//*  37   72:invokestatic    #844 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  38   75:ifeq            111
	//*  39   78:aload           5
	//*  40   80:aload_0         
	//*  41   81:getfield        #231 <Field String socialSentenceWithoutLike>
	//*  42   84:invokestatic    #844 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  43   87:ifeq            111
	//*  44   90:aload           6
	//*  45   92:aload_0         
	//*  46   93:getfield        #234 <Field String unlikeToken>
	//*  47   96:invokestatic    #844 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  48   99:ifne            105
	//*  49  102:goto            111
			flag1 = false;
	//   50  105:iconst_0        
	...
	//   58  120:aload_0         
	//   59  121:iload_1         
	//   60  122:putfield        #301 <Field boolean isObjectLiked>
			likeCountStringWithLike = s;
	//   61  125:aload_0         
	//   62  126:aload_2         
	//   63  127:putfield        #330 <Field String likeCountStringWithLike>
			likeCountStringWithoutLike = s1;
	//   64  130:aload_0         
	//   65  131:aload_3         
	//   66  132:putfield        #333 <Field String likeCountStringWithoutLike>
			socialSentenceWithLike = s2;
	//   67  135:aload_0         
	//   68  136:aload           4
	//   69  138:putfield        #336 <Field String socialSentenceWithLike>
			socialSentenceWithoutLike = s3;
	//   70  141:aload_0         
	//   71  142:aload           5
	//   72  144:putfield        #231 <Field String socialSentenceWithoutLike>
			unlikeToken = s4;
	//   73  147:aload_0         
	//   74  148:aload           6
	//   75  150:putfield        #234 <Field String unlikeToken>
			serializeToDiskAsync(this);
	//   76  153:aload_0         
	//   77  154:invokestatic    #412 <Method void serializeToDiskAsync(LikeActionController)>
			broadcastAction(this, "com.facebook.sdk.LikeActionController.UPDATED");
	//   78  157:aload_0         
	//   79  158:ldc1            #89  <String "com.facebook.sdk.LikeActionController.UPDATED">
	//   80  160:invokestatic    #327 <Method void broadcastAction(LikeActionController, String)>
			return;
	//   81  163:return          
		}
	}
	...
	//    0    0:aload_1         
	//    1    1:aload_0         
	//    2    2:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//    3    5:invokestatic    #848 <Method com.facebook.share.widget.LikeView$ObjectType ShareInternalUtility.getMostSpecificObjectType(com.facebook.share.widget.LikeView$ObjectType, com.facebook.share.widget.LikeView$ObjectType)>
	//    4    8:astore_3        
		if(objecttype1 == null)
	//*   5    9:aload_3         
	//*   6   10:ifnonnull       57
	...
	//    7   13:new             #850 <Class FacebookException>
	//    8   16:dup             
	//    9   17:ldc2            #852 <String "Object with id:\"%s\" is already marked as type:\"%s\". Cannot change the type to:\"%s\"">
	//   10   20:iconst_3        
	//   11   21:anewarray       Object[]
	//   12   24:dup             
	//   13   25:iconst_0        
	//   14   26:aload_0         
	//   15   27:getfield        #215 <Field String objectId>
	//   16   30:aastore         
	//   17   31:dup             
	//   18   32:iconst_1        
	//   19   33:aload_0         
	//   20   34:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   21   37:invokevirtual   #625 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   22   40:aastore         
	//   23   41:dup             
	//   24   42:iconst_2        
	//   25   43:aload_1         
	//   26   44:invokevirtual   #625 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   27   47:aastore         
	//   28   48:invokespecial   #855 <Method void FacebookException(String, Object[])>
	//   29   51:astore_0        
			objecttype = null;
	//   30   52:aconst_null     
	//   31   53:astore_1        
	...
	//   33   57:aload_0         
	//   34   58:aload_3         
	//   35   59:putfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
			objecttype1 = null;
	//   36   62:aconst_null     
	//   37   63:astore_3        
	...
	//   43   69:aload_1         
	//   44   70:aload_0         
	//   45   71:invokestatic    #430 <Method void invokeCallbackWithController(LikeActionController$CreationCallback, LikeActionController, FacebookException)>
	//   46   74:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #330 <Field String likeCountStringWithLike>
	//    5   11:areturn         
		else
			return likeCountStringWithoutLike;
	//    6   12:aload_0         
	//    7   13:getfield        #333 <Field String likeCountStringWithoutLike>
	//    8   16:areturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #336 <Field String socialSentenceWithLike>
	//    5   11:areturn         
		else
			return socialSentenceWithoutLike;
	//    6   12:aload_0         
	//    7   13:getfield        #231 <Field String socialSentenceWithoutLike>
	//    8   16:areturn         
	}
	...
	//*   1    3:ifne            69
		{
			if(LikeDialog.canShowWebFallback())
	//*   2    6:invokestatic    #701 <Method boolean LikeDialog.canShowWebFallback()>
	//*   3    9:ifeq            14
				return true;
	//    4   12:iconst_1        
	//    5   13:ireturn         
			if(!objectIsPage)
	//*   6   14:aload_0         
	//*   7   15:getfield        #292 <Field boolean objectIsPage>
	//*   8   18:ifne            67
			{
				if(objectType == com.facebook.share.widget.LikeView.ObjectType.PAGE)
	//*   9   21:aload_0         
	//*  10   22:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//*  11   25:getstatic       #861 <Field com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.PAGE>
	//*  12   28:if_acmpne       33
					return false;
	//   13   31:iconst_0        
	//   14   32:ireturn         
				AccessToken accesstoken = AccessToken.getCurrentAccessToken();
	//   15   33:invokestatic    #378 <Method AccessToken AccessToken.getCurrentAccessToken()>
	//   16   36:astore_1        
				return accesstoken != null && accesstoken.getPermissions() != null && accesstoken.getPermissions().contains("publish_actions");
	//   17   37:aload_1         
	//   18   38:ifnull          65
	//   19   41:aload_1         
	//   20   42:invokevirtual   #382 <Method Set AccessToken.getPermissions()>
	//   21   45:ifnull          65
	//   22   48:aload_1         
	//   23   49:invokevirtual   #382 <Method Set AccessToken.getPermissions()>
	//   24   52:ldc2            #384 <String "publish_actions">
	//   25   55:invokeinterface #390 <Method boolean Set.contains(Object)>
	//   26   60:ifeq            65
	//   27   63:iconst_1        
	//   28   64:ireturn         
	//   29   65:iconst_0        
	...
	//    8   13:istore          5
		if(canUseOGPublish())
	//*   9   15:aload_0         
	//*  10   16:invokespecial   #753 <Method boolean canUseOGPublish()>
	//*  11   19:ifeq            83
		{
			updateLikeState(flag1);
	//   12   22:aload_0         
	//   13   23:iload           5
	//   14   25:invokespecial   #744 <Method void updateLikeState(boolean)>
			if(isPendingLikeOrUnlike)
	//*  15   28:aload_0         
	//*  16   29:getfield        #268 <Field boolean isPendingLikeOrUnlike>
	//*  17   32:ifeq            48
			{
				getAppEventsLogger().logSdkEvent("fb_like_control_did_undo_quickly", ((Double) (null)), bundle);
	//   18   35:aload_0         
	//   19   36:invokespecial   #242 <Method AppEventsLogger getAppEventsLogger()>
	//   20   39:ldc2            #864 <String "fb_like_control_did_undo_quickly">
	//   21   42:aconst_null     
	//   22   43:aload_3         
	//   23   44:invokevirtual   #633 <Method void AppEventsLogger.logSdkEvent(String, Double, Bundle)>
				return;
	//   24   47:return          
			}
	...
	//*  26   49:iload           5
	//*  27   51:aload_3         
	//*  28   52:invokespecial   #741 <Method boolean publishLikeOrUnlikeAsync(boolean, Bundle)>
	//*  29   55:ifne            90
			{
				if(flag1)
	//*  30   58:iload           5
	...
	//   35   69:aload_0         
	//   36   70:iload           4
	//   37   72:invokespecial   #744 <Method void updateLikeState(boolean)>
				presentLikeDialog(activity, fragment, bundle);
	//   38   75:aload_0         
	//   39   76:aload_1         
	//   40   77:aload_2         
	//   41   78:aload_3         
	//   42   79:invokespecial   #866 <Method void presentLikeDialog(Activity, Fragment, Bundle)>
				return;
	//   43   82:return          
			}
		} else
	...
	//   46   85:aload_2         
	//   47   86:aload_3         
	//   48   87:invokespecial   #866 <Method void presentLikeDialog(Activity, Fragment, Bundle)>
		}
	//   49   90:return          
	}
	...
	static 
	{
	//    0    0:new             #196 <Class ConcurrentHashMap>
	//    1    3:dup             
	//    2    4:invokespecial   #199 <Method void ConcurrentHashMap()>
	//    3    7:putstatic       #201 <Field ConcurrentHashMap cache>
	//    4   10:new             #203 <Class WorkQueue>
	//    5   13:dup             
	//    6   14:iconst_1        
	//    7   15:invokespecial   #206 <Method void WorkQueue(int)>
	//    8   18:putstatic       #208 <Field WorkQueue mruCacheWorkQueue>
	//    9   21:new             #203 <Class WorkQueue>
	//   10   24:dup             
	//   11   25:iconst_1        
	//   12   26:invokespecial   #206 <Method void WorkQueue(int)>
	//   13   29:putstatic       #210 <Field WorkQueue diskIOWorkQueue>
	//*  14   32:return          
	}
...
/*
	...
	//    2    2:iload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #223 <Method void onActivityResult(int, int, Intent)>
		return;
	//    5    7:return          
	}
...
/*
	...
	{
		return TAG;
	//    0    0:getstatic       #227 <Field String TAG>
	//    1    3:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #231 <Field String socialSentenceWithoutLike>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #234 <Field String unlikeToken>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #234 <Field String unlikeToken>
		return s;
	//    3    5:aload_1         
	//    4    6:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #242 <Method AppEventsLogger getAppEventsLogger()>
	//    2    4:areturn         
	}
...
/*
	...
	//    5    6:aload           5
	//    6    8:aload           6
	//    7   10:invokespecial   #248 <Method void updateState(boolean, String, String, String, String, String)>
		return;
	//    8   13:return          
	}
...
/*
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #254 <Method void logAppEventForError(String, Bundle)>
		return;
	//    4    6:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #261 <Field String verifiedObjectId>
		return s;
	//    3    5:aload_1         
	//    4    6:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #217 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #274 <Method void publishDidError(boolean)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #279 <Method void refreshStatusAsync()>
		return;
	//    2    4:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #282 <Field boolean isObjectLikedOnServer>
		return flag;
	//    3    5:iload_1         
	//    4    6:ireturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #288 <Method void publishAgainIfNeeded(Bundle)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #292 <Field boolean objectIsPage>
		return flag;
	//    3    5:iload_1         
	//    4    6:ireturn         
	}
...
/*
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #297 <Method void logAppEventForError(String, FacebookRequestError)>
		return;
	//    4    6:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #306 <Method void serializeToDiskSynchronously(String, String)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokestatic    #311 <Method void createControllerForObjectIdAndType(String, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
		return;
	//    4    6:return          
	}
...
/*
	...
	{
		return objectSuffix;
	//    0    0:getstatic       #315 <Field int objectSuffix>
	//    1    3:ireturn         
	}
...
/*
	static int access$302(int i)
	{
		objectSuffix = i;
	//    0    0:iload_0         
	//    1    1:putstatic       #315 <Field int objectSuffix>
		return i;
	//    2    4:iload_0         
	//    3    5:ireturn         
	}
...
/*
	...
	{
		return cache;
	//    0    0:getstatic       #201 <Field ConcurrentHashMap cache>
	//    1    3:areturn         
	}
...
/*
	...
	//    0    0:getstatic       #323 <Field FileLruCache controllerDiskCache>
	//    1    3:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #327 <Method void broadcastAction(LikeActionController, String)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #330 <Field String likeCountStringWithLike>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #333 <Field String likeCountStringWithoutLike>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #336 <Field String socialSentenceWithLike>
	//    2    4:areturn         
	}
