...
public static final class ShareFeedContent$Builder extends com.facebook.share.model.ShareContent.Builder
{
	...
	public ShareFeedContent$Builder readFrom(Parcel parcel)
	{
		return readFrom((ShareFeedContent)parcel.readParcelable(((Class) (com/facebook/share/internal/ShareFeedContent)).getClassLoader()));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:ldc1            #7   <Class ShareFeedContent>
	...
	//    5   10:checkcast       #7   <Class ShareFeedContent>
	//    6   13:invokevirtual   #68  <Method ShareFeedContent$Builder readFrom(ShareFeedContent)>
	//    7   16:areturn         
	}
	...
	//    4    6:aload_0         
	//    5    7:aload_1         
	//    6    8:invokespecial   #71  <Method com.facebook.share.model.ShareContent$Builder com.facebook.share.model.ShareContent$Builder.readFrom(ShareContent)>
	//    7   11:checkcast       #2   <Class ShareFeedContent$Builder>
	//    8   14:aload_1         
	//    9   15:invokevirtual   #75  <Method String ShareFeedContent.getToId()>
	//   10   18:invokevirtual   #79  <Method ShareFeedContent$Builder setToId(String)>
	//   11   21:aload_1         
	//   12   22:invokevirtual   #82  <Method String ShareFeedContent.getLink()>
	//   13   25:invokevirtual   #85  <Method ShareFeedContent$Builder setLink(String)>
	//   14   28:aload_1         
	//   15   29:invokevirtual   #88  <Method String ShareFeedContent.getLinkName()>
	//   16   32:invokevirtual   #91  <Method ShareFeedContent$Builder setLinkName(String)>
	//   17   35:aload_1         
	//   18   36:invokevirtual   #94  <Method String ShareFeedContent.getLinkCaption()>
	//   19   39:invokevirtual   #97  <Method ShareFeedContent$Builder setLinkCaption(String)>
	//   20   42:aload_1         
	//   21   43:invokevirtual   #100 <Method String ShareFeedContent.getLinkDescription()>
	//   22   46:invokevirtual   #103 <Method ShareFeedContent$Builder setLinkDescription(String)>
	//   23   49:aload_1         
	//   24   50:invokevirtual   #106 <Method String ShareFeedContent.getPicture()>
	//   25   53:invokevirtual   #109 <Method ShareFeedContent$Builder setPicture(String)>
	//   26   56:aload_1         
	//   27   57:invokevirtual   #112 <Method String ShareFeedContent.getMediaSource()>
	//   28   60:invokevirtual   #115 <Method ShareFeedContent$Builder setMediaSource(String)>
	//   29   63:areturn         
	}
	...
	//    3    5:invokevirtual   #68  <Method ShareFeedContent$Builder readFrom(ShareFeedContent)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #118 <Method ShareFeedContent$Builder readFrom(Parcel)>
	//    3    5:areturn         
	}
