...
public class GraphRequestBatch extends AbstractList
{
	...
	//    3    7:dup             
	//    4    8:ldc1            #163 <String "Argument timeoutInMilliseconds must be >= 0.">
	//    5   10:invokespecial   #165 <Method void IllegalArgumentException(String)>
	//    6   13:athrow          
		} else
		{
	...
	//    7   14:aload_0         
	//    8   15:iload_1         
	//    9   16:putfield        #43  <Field int timeoutInMilliseconds>
			return;
	//   10   19:return          
		}
	}
