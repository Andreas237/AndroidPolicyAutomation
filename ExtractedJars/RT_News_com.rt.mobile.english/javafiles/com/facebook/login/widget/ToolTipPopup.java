...
public class ToolTipPopup
{
	private class PopupContentView extends FrameLayout
	{
		...
		private void init()
		{
			LayoutInflater.from(getContext()).inflate(com.facebook.R.layout.com_facebook_tooltip_bubble, ((android.view.ViewGroup) (this)));
		//    0    0:aload_0         
		//    1    1:invokevirtual   #45  <Method Context getContext()>
		//    2    4:invokestatic    #51  <Method LayoutInflater LayoutInflater.from(Context)>
		//    3    7:getstatic       #57  <Field int com.facebook.R$layout.com_facebook_tooltip_bubble>
		//    4   10:aload_0         
		//    5   11:invokevirtual   #61  <Method View LayoutInflater.inflate(int, android.view.ViewGroup)>
		//    6   14:pop             
			topArrow = (ImageView)findViewById(com.facebook.R.id.com_facebook_tooltip_bubble_view_top_pointer);
		//    7   15:aload_0         
		//    8   16:aload_0         
		//    9   17:getstatic       #66  <Field int com.facebook.R$id.com_facebook_tooltip_bubble_view_top_pointer>
		...
		//   12   26:putfield        #38  <Field ImageView topArrow>
			bottomArrow = (ImageView)findViewById(com.facebook.R.id.com_facebook_tooltip_bubble_view_bottom_pointer);
		//   13   29:aload_0         
		//   14   30:aload_0         
		//   15   31:getstatic       #75  <Field int com.facebook.R$id.com_facebook_tooltip_bubble_view_bottom_pointer>
		...
		//   18   40:putfield        #35  <Field ImageView bottomArrow>
			bodyFrame = findViewById(com.facebook.R.id.com_facebook_body_frame);
		//   19   43:aload_0         
		//   20   44:aload_0         
		//   21   45:getstatic       #78  <Field int com.facebook.R$id.com_facebook_body_frame>
		//   22   48:invokevirtual   #70  <Method View findViewById(int)>
		//   23   51:putfield        #31  <Field View bodyFrame>
			xOut = (ImageView)findViewById(com.facebook.R.id.com_facebook_button_xout);
		//   24   54:aload_0         
		//   25   55:aload_0         
		//   26   56:getstatic       #81  <Field int com.facebook.R$id.com_facebook_button_xout>
...
*/
	...
	//*   2    4:ifnull          42
	//*   3    7:aload_0         
	//*   4    8:getfield        #77  <Field PopupWindow mPopupWindow>
	//*   5   11:invokevirtual   #109 <Method boolean PopupWindow.isShowing()>
	//*   6   14:ifeq            42
		{
			if(mPopupWindow.isAboveAnchor())
	//*   7   17:aload_0         
	//*   8   18:getfield        #77  <Field PopupWindow mPopupWindow>
	//*   9   21:invokevirtual   #112 <Method boolean PopupWindow.isAboveAnchor()>
	//*  10   24:ifeq            35
			{
				mPopupContent.showBottomArrow();
	//   11   27:aload_0         
	//   12   28:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//   13   31:invokevirtual   #115 <Method void ToolTipPopup$PopupContentView.showBottomArrow()>
				return;
	//   14   34:return          
			}
			mPopupContent.showTopArrow();
	//   15   35:aload_0         
	//   16   36:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//   17   39:invokevirtual   #118 <Method void ToolTipPopup$PopupContentView.showTopArrow()>
		}
	//   18   42:return          
	}
	...
	//    5   11:aload_0         
	//    6   12:getfield        #77  <Field PopupWindow mPopupWindow>
	//    7   15:invokevirtual   #121 <Method void PopupWindow.dismiss()>
	//    8   18:return          
	}
	...
	//   11   23:putfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
			((TextView)mPopupContent.findViewById(com.facebook.R.id.com_facebook_tooltip_bubble_view_text_body)).setText(((CharSequence) (mText)));
	//   12   26:aload_0         
	//   13   27:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//   14   30:getstatic       #135 <Field int com.facebook.R$id.com_facebook_tooltip_bubble_view_text_body>
	...
	//*  23   53:if_acmpne       111
			{
				mPopupContent.bodyFrame.setBackgroundResource(com.facebook.R.drawable.com_facebook_tooltip_blue_background);
	//   24   56:aload_0         
	...
	//   27   63:getstatic       #154 <Field int com.facebook.R$drawable.com_facebook_tooltip_blue_background>
	//   28   66:invokevirtual   #158 <Method void View.setBackgroundResource(int)>
				mPopupContent.bottomArrow.setImageResource(com.facebook.R.drawable.com_facebook_tooltip_blue_bottomnub);
	//   29   69:aload_0         
	...
	//   32   76:getstatic       #165 <Field int com.facebook.R$drawable.com_facebook_tooltip_blue_bottomnub>
	//   33   79:invokevirtual   #170 <Method void ImageView.setImageResource(int)>
				mPopupContent.topArrow.setImageResource(com.facebook.R.drawable.com_facebook_tooltip_blue_topnub);
	//   34   82:aload_0         
	...
	//   37   89:getstatic       #176 <Field int com.facebook.R$drawable.com_facebook_tooltip_blue_topnub>
	//   38   92:invokevirtual   #170 <Method void ImageView.setImageResource(int)>
				mPopupContent.xOut.setImageResource(com.facebook.R.drawable.com_facebook_tooltip_blue_xout);
	//   39   95:aload_0         
	...
	//   42  102:getstatic       #182 <Field int com.facebook.R$drawable.com_facebook_tooltip_blue_xout>
	//   43  105:invokevirtual   #170 <Method void ImageView.setImageResource(int)>
			} else
	//*  44  108:goto            163
			{
				mPopupContent.bodyFrame.setBackgroundResource(com.facebook.R.drawable.com_facebook_tooltip_black_background);
	//   45  111:aload_0         
	...
	//   48  118:getstatic       #185 <Field int com.facebook.R$drawable.com_facebook_tooltip_black_background>
	//   49  121:invokevirtual   #158 <Method void View.setBackgroundResource(int)>
				mPopupContent.bottomArrow.setImageResource(com.facebook.R.drawable.com_facebook_tooltip_black_bottomnub);
	//   50  124:aload_0         
	...
	//   53  131:getstatic       #188 <Field int com.facebook.R$drawable.com_facebook_tooltip_black_bottomnub>
	//   54  134:invokevirtual   #170 <Method void ImageView.setImageResource(int)>
				mPopupContent.topArrow.setImageResource(com.facebook.R.drawable.com_facebook_tooltip_black_topnub);
	//   55  137:aload_0         
	...
	//   58  144:getstatic       #191 <Field int com.facebook.R$drawable.com_facebook_tooltip_black_topnub>
	//   59  147:invokevirtual   #170 <Method void ImageView.setImageResource(int)>
				mPopupContent.xOut.setImageResource(com.facebook.R.drawable.com_facebook_tooltip_black_xout);
	//   60  150:aload_0         
	...
	//   63  157:getstatic       #194 <Field int com.facebook.R$drawable.com_facebook_tooltip_black_xout>
	...
	//   87  207:invokevirtual   #226 <Method void ToolTipPopup$PopupContentView.measure(int, int)>
			mPopupWindow = new PopupWindow(((View) (mPopupContent)), mPopupContent.getMeasuredWidth(), mPopupContent.getMeasuredHeight());
	//   88  210:aload_0         
	//   89  211:new             #105 <Class PopupWindow>
	//   90  214:dup             
	//   91  215:aload_0         
	//   92  216:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//   93  219:aload_0         
	//   94  220:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//   95  223:invokevirtual   #229 <Method int ToolTipPopup$PopupContentView.getMeasuredWidth()>
	//   96  226:aload_0         
	//   97  227:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//   98  230:invokevirtual   #232 <Method int ToolTipPopup$PopupContentView.getMeasuredHeight()>
	//   99  233:invokespecial   #235 <Method void PopupWindow(View, int, int)>
	//  100  236:putfield        #77  <Field PopupWindow mPopupWindow>
			mPopupWindow.showAsDropDown((View)mAnchorViewRef.get());
	//  101  239:aload_0         
	//  102  240:getfield        #77  <Field PopupWindow mPopupWindow>
	//  103  243:aload_0         
	//  104  244:getfield        #62  <Field WeakReference mAnchorViewRef>
	//  105  247:invokevirtual   #89  <Method Object WeakReference.get()>
	//  106  250:checkcast       #64  <Class View>
	//  107  253:invokevirtual   #239 <Method void PopupWindow.showAsDropDown(View)>
			updateArrows();
	//  108  256:aload_0         
	//  109  257:invokespecial   #241 <Method void updateArrows()>
			if(mNuxDisplayTime > 0L)
	//* 110  260:aload_0         
	//* 111  261:getfield        #48  <Field long mNuxDisplayTime>
	//* 112  264:lconst_0        
	//* 113  265:lcmp            
	//* 114  266:ifle            289
...
, mNuxDisplayTime);
	//  115  269:aload_0         
	//  116  270:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//  117  273:new             #8   <Class ToolTipPopup$2>
	//  118  276:dup             
	//  119  277:aload_0         
	//  120  278:invokespecial   #242 <Method void ToolTipPopup$2(ToolTipPopup)>
	//  121  281:aload_0         
	//  122  282:getfield        #48  <Field long mNuxDisplayTime>
	//  123  285:invokevirtual   #246 <Method boolean ToolTipPopup$PopupContentView.postDelayed(Runnable, long)>
	//  124  288:pop             
			mPopupWindow.setTouchable(true);
	//  125  289:aload_0         
	//  126  290:getfield        #77  <Field PopupWindow mPopupWindow>
	//  127  293:iconst_1        
	//  128  294:invokevirtual   #250 <Method void PopupWindow.setTouchable(boolean)>
	...
	//  129  297:aload_0         
	//  130  298:getfield        #81  <Field ToolTipPopup$PopupContentView mPopupContent>
	//  131  301:new             #10  <Class ToolTipPopup$3>
	//  132  304:dup             
	//  133  305:aload_0         
	//  134  306:invokespecial   #251 <Method void ToolTipPopup$3(ToolTipPopup)>
	//  135  309:invokevirtual   #255 <Method void ToolTipPopup$PopupContentView.setOnClickListener(android.view.View$OnClickListener)>
		}
	//  136  312:return          
	}
