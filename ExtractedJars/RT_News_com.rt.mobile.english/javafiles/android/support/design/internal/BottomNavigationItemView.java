	...
	implements android.support.v7.view.menu.MenuView.ItemView
{
	...
	//   39   67:fload           5
	//   40   69:fdiv            
	//   41   70:putfield        #78  <Field float mScaleUpFactor>
		mScaleDownFactor = (1.0F * f1) / f;
	//   42   73:aload_0         
	//   43   74:fconst_1        
	//   44   75:fload           5
	//   45   77:fmul            
	//   46   78:fload           4
	//   47   80:fdiv            
	//   48   81:putfield        #80  <Field float mScaleDownFactor>
	...
	//   49   84:aload_1         
	//   50   85:invokestatic    #86  <Method LayoutInflater LayoutInflater.from(Context)>
	//   51   88:getstatic       #91  <Field int android.support.design.R$layout.design_bottom_navigation_item>
	//   52   91:aload_0         
	//   53   92:iconst_1        
	//   54   93:invokevirtual   #95  <Method android.view.View LayoutInflater.inflate(int, android.view.ViewGroup, boolean)>
	//   55   96:pop             
		setBackgroundResource(android.support.design.R.drawable.design_bottom_navigation_item_background);
	//   56   97:aload_0         
	//   57   98:getstatic       #100 <Field int android.support.design.R$drawable.design_bottom_navigation_item_background>
	//   58  101:invokevirtual   #104 <Method void setBackgroundResource(int)>
		mIcon = (ImageView)findViewById(android.support.design.R.id.icon);
	//   59  104:aload_0         
	//   60  105:aload_0         
	//   61  106:getstatic       #109 <Field int android.support.design.R$id.icon>
	//   62  109:invokevirtual   #113 <Method android.view.View findViewById(int)>
	//   63  112:checkcast       #115 <Class ImageView>
	//   64  115:putfield        #117 <Field ImageView mIcon>
		mSmallLabel = (TextView)findViewById(android.support.design.R.id.smallLabel);
	//   65  118:aload_0         
	//   66  119:aload_0         
	//   67  120:getstatic       #120 <Field int android.support.design.R$id.smallLabel>
	//   68  123:invokevirtual   #113 <Method android.view.View findViewById(int)>
	//   69  126:checkcast       #122 <Class TextView>
	//   70  129:putfield        #124 <Field TextView mSmallLabel>
		mLargeLabel = (TextView)findViewById(android.support.design.R.id.largeLabel);
	//   71  132:aload_0         
	//   72  133:aload_0         
	//   73  134:getstatic       #127 <Field int android.support.design.R$id.largeLabel>
	//   74  137:invokevirtual   #113 <Method android.view.View findViewById(int)>
	//   75  140:checkcast       #122 <Class TextView>
	//   76  143:putfield        #129 <Field TextView mLargeLabel>
	//   77  146:return          
	}
	...
	//   10   18:aload_2         
	//   11   19:invokevirtual   #279 <Method Drawable android.graphics.drawable.Drawable$ConstantState.newDrawable()>
	//   12   22:astore_1        
			obj = ((Object) (DrawableCompat.wrap(drawable).mutate()));
	//   13   23:aload_1         
	//   14   24:invokestatic    #285 <Method Drawable DrawableCompat.wrap(Drawable)>
	//   15   27:invokevirtual   #288 <Method Drawable Drawable.mutate()>
	//   16   30:astore_2        
			DrawableCompat.setTintList(((Drawable) (obj)), mIconTint);
	//   17   31:aload_2         
	//   18   32:aload_0         
	//   19   33:getfield        #290 <Field ColorStateList mIconTint>
	//   20   36:invokestatic    #294 <Method void DrawableCompat.setTintList(Drawable, ColorStateList)>
		}
		mIcon.setImageDrawable(((Drawable) (obj)));
	//   21   39:aload_0         
	//   22   40:getfield        #117 <Field ImageView mIcon>
	//   23   43:aload_2         
	//   24   44:invokevirtual   #297 <Method void ImageView.setImageDrawable(Drawable)>
	//   25   47:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #290 <Field ColorStateList mIconTint>
		if(mItemData != null)
	//*   3    5:aload_0         
	...
	//    7   13:iload_1         
	//    8   14:invokestatic    #306 <Method Drawable ContextCompat.getDrawable(Context, int)>
	//    9   17:astore_2        
		ViewCompat.setBackground(((android.view.View) (this)), drawable);
	//   10   18:aload_0         
	//   11   19:aload_2         
	//   12   20:invokestatic    #310 <Method void ViewCompat.setBackground(android.view.View, Drawable)>
	//   13   23:return          
	}
