...
public class TextScale extends Transition
{
	...
	//   32   66:aload_2         
	//   33   67:ldc1            #16  <String "android:textscale:scale">
	//   34   69:invokeinterface #61  <Method Object Map.get(Object)>
	//   35   74:checkcast       #41  <Class Float>
	//   36   77:invokevirtual   #64  <Method float Float.floatValue()>
	//   37   80:fstore          4
			else
	//*  38   82:goto            88
				f = 1.0F;
	...
	//*  41   88:aload_3         
	//*  42   89:ldc1            #16  <String "android:textscale:scale">
	//*  43   91:invokeinterface #61  <Method Object Map.get(Object)>
	//*  44   96:ifnull          115
				f1 = ((Float)((Map) (transitionvalues1)).get("android:textscale:scale")).floatValue();
	//   45   99:aload_3         
	//   46  100:ldc1            #16  <String "android:textscale:scale">
	//   47  102:invokeinterface #61  <Method Object Map.get(Object)>
	//   48  107:checkcast       #41  <Class Float>
	//   49  110:invokevirtual   #64  <Method float Float.floatValue()>
	//   50  113:fstore          5
			if(f == f1)
	//*  51  115:fload           4
	//*  52  117:fload           5
	...
	//   65  135:fload           5
	//   66  137:fastore         
	//   67  138:invokestatic    #70  <Method ValueAnimator ValueAnimator.ofFloat(float[])>
	//   68  141:astore_2        
	...
	//   72  147:aload_0         
	//   73  148:aload_1         
	//   74  149:invokespecial   #73  <Method void TextScale$1(TextScale, TextView)>
	//   75  152:invokevirtual   #77  <Method void ValueAnimator.addUpdateListener(android.animation.ValueAnimator$AnimatorUpdateListener)>
