...
;
	...
	//  146  310:invokespecial   #197 <Method void addCompatibilityTopDivider(Context)>
		mMenu.setCallback(new android.support.v7.view.menu.MenuBuilder.Callback() {
			...
			//   16   40:ireturn         
				...
				return mSelectedListener != null && !mSelectedListener.onNavigationItemSelected(menuitem);
			//   17   41:aload_0         
	...
	//  149  317:new             #6   <Class BottomNavigationView$1>
	//  150  320:dup             
	//  151  321:aload_0         
	//  152  322:invokespecial   #200 <Method void BottomNavigationView$1(BottomNavigationView)>
