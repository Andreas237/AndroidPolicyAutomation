...
public class BottomSheetDialog extends AppCompatDialog
{
	...
	//   14   30:dup             
	//   15   31:iconst_0        
	//   16   32:ldc1            #219 <Int 0x101035b>
	//   17   34:iastore         
	//   18   35:invokevirtual   #223 <Method TypedArray Context.obtainStyledAttributes(int[])>
	//   19   38:astore_1        
	...
	//   22   41:iconst_0        
	//   23   42:iconst_1        
	//   24   43:invokevirtual   #229 <Method boolean TypedArray.getBoolean(int, boolean)>
	//   25   46:putfield        #39  <Field boolean mCanceledOnTouchOutside>
				typedarray.recycle();
	//   26   49:aload_1         
	//   27   50:invokevirtual   #232 <Method void TypedArray.recycle()>
			}
			mCanceledOnTouchOutsideSet = true;
	//   28   53:aload_0         
	//   29   54:iconst_1        
	//   30   55:putfield        #210 <Field boolean mCanceledOnTouchOutsideSet>
		}
