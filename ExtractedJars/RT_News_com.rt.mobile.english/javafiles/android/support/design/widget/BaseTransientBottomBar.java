...
_L2:
	...
	//   34   62:invokevirtual   #244 <Method void ValueAnimator.addListener(android.animation.Animator$AnimatorListener)>
			valueanimator.addUpdateListener(new android.animation.ValueAnimator.AnimatorUpdateListener() {
				...
				//   18   40:getfield        #47  <Field BaseTransientBottomBar$SnackbarBaseLayout BaseTransientBottomBar.mView>
				//   19   43:iload_2         
				//   20   44:i2f             
				...
				//   22   48:aload_0         
				//   23   49:iload_2         
				//   24   50:putfield        #24  <Field int mPreviousAnimatedIntValue>
				//   25   53:return          
				}
	...
	//   14   33:aload_0         
	//   15   34:getfield        #169 <Field BaseTransientBottomBar$SnackbarBaseLayout mView>
	//   16   37:iload_1         
	//   17   38:i2f             
	//   18   39:invokevirtual   #305 <Method void BaseTransientBottomBar$SnackbarBaseLayout.setTranslationY(float)>
			ValueAnimator valueanimator = new ValueAnimator();
	//   19   42:new             #212 <Class ValueAnimator>
	//   20   45:dup             
	//   21   46:invokespecial   #213 <Method void ValueAnimator()>
	//   22   49:astore_2        
			valueanimator.setIntValues(new int[] {
				viewHeight, 0
			});
	...
	//   32   60:iconst_0        
	//   33   61:iastore         
	//   34   62:invokevirtual   #221 <Method void ValueAnimator.setIntValues(int[])>
			valueanimator.setInterpolator(((android.animation.TimeInterpolator) (AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR)));
	//   35   65:aload_2         
	//   36   66:getstatic       #227 <Field android.view.animation.Interpolator AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR>
	//   37   69:invokevirtual   #231 <Method void ValueAnimator.setInterpolator(android.animation.TimeInterpolator)>
			valueanimator.setDuration(250L);
	//   38   72:aload_2         
	//   39   73:ldc2w           #232 <Long 250L>
	//   40   76:invokevirtual   #237 <Method ValueAnimator ValueAnimator.setDuration(long)>
	//   41   79:pop             
			valueanimator.addListener(((android.animation.Animator.AnimatorListener) (new AnimatorListenerAdapter() {
	...
	//   42   80:aload_2         
	//   43   81:new             #27  <Class BaseTransientBottomBar$7>
	//   44   84:dup             
	//   45   85:aload_0         
	//   46   86:invokespecial   #306 <Method void BaseTransientBottomBar$7(BaseTransientBottomBar)>
	//   47   89:invokevirtual   #244 <Method void ValueAnimator.addListener(android.animation.Animator$AnimatorListener)>
			valueanimator.addUpdateListener(new android.animation.ValueAnimator.AnimatorUpdateListener() {
				...
				//   18   40:getfield        #49  <Field BaseTransientBottomBar$SnackbarBaseLayout BaseTransientBottomBar.mView>
				//   19   43:iload_2         
				//   20   44:i2f             
				...
				//   22   48:aload_0         
				//   23   49:iload_2         
				//   24   50:putfield        #26  <Field int mPreviousAnimatedIntValue>
				//   25   53:return          
				}
	...
	//   48   92:aload_2         
	//   49   93:new             #29  <Class BaseTransientBottomBar$8>
	//   50   96:dup             
	//   51   97:aload_0         
	//   52   98:iload_1         
	//   53   99:invokespecial   #307 <Method void BaseTransientBottomBar$8(BaseTransientBottomBar, int)>
	//   54  102:invokevirtual   #249 <Method void ValueAnimator.addUpdateListener(android.animation.ValueAnimator$AnimatorUpdateListener)>
			valueanimator.start();
	//   55  105:aload_2         
	//   56  106:invokevirtual   #252 <Method void ValueAnimator.start()>
			return;
	//   57  109:return          
		} else
		{
	...
	//    9   15:aload_0         
	//   10   16:getfield        #285 <Field List mCallbacks>
	//   11   19:aload_1         
	//   12   20:invokeinterface #385 <Method boolean List.remove(Object)>
	//   13   25:pop             
			return this;
	//   14   26:aload_0         
	//   15   27:areturn         
	...
	{
		return mAccessibilityManager.isEnabled() ^ true;
	//    0    0:aload_0         
...
;
	...
	//   16   34:new             #7   <Class BaseTransientBottomBar$1>
	//   17   37:dup             
	//   18   38:invokespecial   #109 <Method void BaseTransientBottomBar$1()>
