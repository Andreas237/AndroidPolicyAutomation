...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior
{
	...
	//*   9   19:icmpne          156
		{
			View view2 = findFirstDependency(coordinatorlayout.getDependencies(view));
	//   10   22:aload_0         
	//   11   23:aload_1         
	//   12   24:aload_2         
	...
	//   26   56:aload           11
	//   27   58:iconst_1        
	//   28   59:invokestatic    #168 <Method void ViewCompat.setFitsSystemWindows(View, boolean)>
					if(ViewCompat.getFitsSystemWindows(view1))
	//*  29   62:aload           11
	//*  30   64:invokestatic    #116 <Method boolean ViewCompat.getFitsSystemWindows(View)>
	//*  31   67:ifeq            77
					{
						view1.requestLayout();
	//   32   70:aload           11
	//   33   72:invokevirtual   #171 <Method void View.requestLayout()>
						return true;
	//   34   75:iconst_1        
	//   35   76:ireturn         
					}
	...
	//   36   77:iload           5
	//   37   79:invokestatic    #176 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   38   82:istore          7
				k = i1;
	//   39   84:iload           7
	//   40   86:istore          5
	...
	//   43   93:aload_1         
	//   44   94:invokevirtual   #96  <Method int CoordinatorLayout.getHeight()>
	//   45   97:istore          5
				int k1 = view2.getMeasuredHeight();
	//   46   99:aload           12
	//   47  101:invokevirtual   #55  <Method int View.getMeasuredHeight()>
	//   48  104:istore          9
				int l1 = getScrollRange(view2);
	//   49  106:aload_0         
	//   50  107:aload           12
	//   51  109:invokevirtual   #178 <Method int getScrollRange(View)>
	//   52  112:istore          10
				if(j1 == -1)
	//*  53  114:iload           8
	//*  54  116:iconst_m1       
	//*  55  117:icmpne          127
					i1 = 0x40000000;
	//   56  120:ldc1            #179 <Int 0x40000000>
	//   57  122:istore          7
				else
	//*  58  124:goto            131
					i1 = 0x80000000;
	//   59  127:ldc1            #180 <Int 0x80000000>
	//   60  129:istore          7
	...
	//   69  143:iadd            
	//   70  144:iload           7
	//   71  146:invokestatic    #184 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   72  149:iload           6
	//   73  151:invokevirtual   #187 <Method void CoordinatorLayout.onMeasureChild(View, int, int, int, int)>
				return true;
	//   74  154:iconst_1        
	//   75  155:ireturn         
			}
