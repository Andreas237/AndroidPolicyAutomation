	...
	implements tener
{
	...
	//   14   26:putfield        #34  <Field RecyclerView$ViewHolder RecyclerView$ViewHolder.mShadowingHolder>
		if(!RecyclerView.ViewHolder.access$1500(viewholder) && !removeAnimatingView(viewholder.itemView) && viewholder.isTmpDetached())
	//*  15   29:aload_1         
	...
	//*  20   40:aload_1         
	//*  21   41:getfield        #42  <Field android.view.View RecyclerView$ViewHolder.itemView>
	//*  22   44:invokevirtual   #46  <Method boolean RecyclerView.removeAnimatingView(android.view.View)>
	//*  23   47:ifne            69
	//*  24   50:aload_1         
	...
	//   29   61:aload_1         
	//   30   62:getfield        #42  <Field android.view.View RecyclerView$ViewHolder.itemView>
	//   31   65:iconst_0        
	//   32   66:invokevirtual   #54  <Method void RecyclerView.removeDetachedView(android.view.View, boolean)>
	//   33   69:return          
	}
