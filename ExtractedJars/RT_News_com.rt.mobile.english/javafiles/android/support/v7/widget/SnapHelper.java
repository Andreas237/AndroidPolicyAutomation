...
public abstract class SnapHelper extends RecyclerView.OnFlingListener
{
	...
	//    4    8:areturn         
			...
			return ((LinearSmoothScroller) (new LinearSmoothScroller(mRecyclerView.getContext()) {
				...
				//   35   69:iload           6
				//   36   71:aload_0         
				//   37   72:getfield        #61  <Field DecelerateInterpolator mDecelerateInterpolator>
...
label0:
	...
	//   11   21:aload_0         
	//   12   22:aload_1         
	//   13   23:invokevirtual   #158 <Method View findSnapView(RecyclerView$LayoutManager)>
	//   14   26:astore_2        
		if(view == null)
	//*  15   27:aload_2         
	//*  16   28:ifnonnull       32
	...
	//   19   33:aload_1         
	//   20   34:aload_2         
	//   21   35:invokevirtual   #160 <Method int[] calculateDistanceToFinalSnap(RecyclerView$LayoutManager, View)>
	//   22   38:astore_1        
		if(ai[0] != 0 || ai[1] != 0)
	//*  23   39:aload_1         
	//*  24   40:iconst_0        
	...
	//   37   59:iconst_1        
	//   38   60:iaload          
	//   39   61:invokevirtual   #164 <Method void RecyclerView.smoothScrollBy(int, int)>
	//   40   64:return          
	}
