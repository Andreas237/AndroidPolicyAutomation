...
public abstract class SortedListAdapterCallback extends android.support.v7.util.SortedList.Callback
{
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #29  <Method void android.support.v7.widget.RecyclerView$Adapter.notifyItemRangeInserted(int, int)>
	//    5    9:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #33  <Method void android.support.v7.widget.RecyclerView$Adapter.notifyItemMoved(int, int)>
	//    5    9:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #37  <Method void android.support.v7.widget.RecyclerView$Adapter.notifyItemRangeRemoved(int, int)>
	//    5    9:return          
	}
