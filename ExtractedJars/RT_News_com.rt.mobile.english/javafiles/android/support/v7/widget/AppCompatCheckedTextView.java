...
public class AppCompatCheckedTextView extends CheckedTextView
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #73  <Method InputConnection CheckedTextView.onCreateInputConnection(EditorInfo)>
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:invokestatic    #78  <Method InputConnection AppCompatHintHelper.onCreateInputConnection(InputConnection, EditorInfo, android.view.View)>
	//    6   10:areturn         
	}
	...
	//    3    5:iload_1         
	//    4    6:invokestatic    #85  <Method android.graphics.drawable.Drawable AppCompatResources.getDrawable(Context, int)>
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #90  <Method void CheckedTextView.setTextAppearance(Context, int)>
		if(mTextHelper != null)
	//*   4    6:aload_0         
	...
	//    9   17:aload_1         
	//   10   18:iload_2         
	//   11   19:invokevirtual   #93  <Method void AppCompatTextHelper.onSetTextAppearance(Context, int)>
	//   12   22:return          
	}
