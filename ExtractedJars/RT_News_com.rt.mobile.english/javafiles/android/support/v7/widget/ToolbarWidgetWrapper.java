	...
	implements DecorToolbar
{
	...
	//*   9   15:ifeq            41
			{
				if(mLogo != null)
	//*  10   18:aload_0         
	//*  11   19:getfield        #311 <Field Drawable mLogo>
	//*  12   22:ifnull          33
					drawable = mLogo;
	//   13   25:aload_0         
	//   14   26:getfield        #311 <Field Drawable mLogo>
	//   15   29:astore_1        
				else
	//*  16   30:goto            51
					drawable = mIcon;
	//   17   33:aload_0         
	//   18   34:getfield        #313 <Field Drawable mIcon>
	//   19   37:astore_1        
			} else
	//*  20   38:goto            51
			{
				drawable = mIcon;
	//   21   41:aload_0         
	//   22   42:getfield        #313 <Field Drawable mIcon>
	//   23   45:astore_1        
			}
		} else
	//*  24   46:goto            51
	...
	//   27   51:aload_0         
	//   28   52:getfield        #76  <Field Toolbar mToolbar>
	//   29   55:aload_1         
	//   30   56:invokevirtual   #314 <Method void Toolbar.setLogo(Drawable)>
	//   31   59:return          
	}
	...
	//*  11   39:ifnull          102
	//*  12   42:aload_0         
	//*  13   43:getfield        #363 <Field View mTabView>
	//*  14   46:invokevirtual   #456 <Method android.view.ViewParent View.getParent()>
	//*  15   49:aload_0         
	//*  16   50:getfield        #76  <Field Toolbar mToolbar>
	//*  17   53:if_acmpne       102
					mToolbar.removeView(mTabView);
	//   18   56:aload_0         
	//   19   57:getfield        #76  <Field Toolbar mToolbar>
	//   20   60:aload_0         
	//   21   61:getfield        #363 <Field View mTabView>
	//   22   64:invokevirtual   #413 <Method void Toolbar.removeView(View)>
				break;
	//   23   67:goto            102
	...
	//*  24   70:aload_0         
	//*  25   71:getfield        #280 <Field Spinner mSpinner>
	//*  26   74:ifnull          102
	//*  27   77:aload_0         
	//*  28   78:getfield        #280 <Field Spinner mSpinner>
	//*  29   81:invokevirtual   #521 <Method android.view.ViewParent Spinner.getParent()>
	//*  30   84:aload_0         
	//*  31   85:getfield        #76  <Field Toolbar mToolbar>
	//*  32   88:if_acmpne       102
					mToolbar.removeView(((View) (mSpinner)));
	//   33   91:aload_0         
	//   34   92:getfield        #76  <Field Toolbar mToolbar>
	//   35   95:aload_0         
	//   36   96:getfield        #280 <Field Spinner mSpinner>
	//   37   99:invokevirtual   #413 <Method void Toolbar.removeView(View)>
				break;
			}
			mNavigationMode = i;
	//   38  102:aload_0         
	//   39  103:iload_1         
	//   40  104:putfield        #72  <Field int mNavigationMode>
			switch(i)
	//*  41  107:iload_1         
			{
	//*  42  108:tableswitch     0 2: default 136
	//	               0 236
	//	               1 220
	//	               2 170
			default:
				StringBuilder stringbuilder = new StringBuilder();
	//   43  136:new             #523 <Class StringBuilder>
	//   44  139:dup             
	//   45  140:invokespecial   #524 <Method void StringBuilder()>
	//   46  143:astore_3        
				stringbuilder.append("Invalid navigation mode ");
	//   47  144:aload_3         
	//   48  145:ldc2            #526 <String "Invalid navigation mode ">
	//   49  148:invokevirtual   #530 <Method StringBuilder StringBuilder.append(String)>
	//   50  151:pop             
				stringbuilder.append(i);
	//   51  152:aload_3         
	//   52  153:iload_1         
	//   53  154:invokevirtual   #533 <Method StringBuilder StringBuilder.append(int)>
	//   54  157:pop             
				throw new IllegalArgumentException(stringbuilder.toString());
	//   55  158:new             #535 <Class IllegalArgumentException>
	//   56  161:dup             
	//   57  162:aload_3         
	//   58  163:invokevirtual   #539 <Method String StringBuilder.toString()>
	//   59  166:invokespecial   #540 <Method void IllegalArgumentException(String)>
	//   60  169:athrow          
			...
			case 2: // '\002'
				if(mTabView != null)
	//*  61  170:aload_0         
	//*  62  171:getfield        #363 <Field View mTabView>
	//*  63  174:ifnull          236
				{
					mToolbar.addView(mTabView, 0);
	//   64  177:aload_0         
	//   65  178:getfield        #76  <Field Toolbar mToolbar>
	//   66  181:aload_0         
	//   67  182:getfield        #363 <Field View mTabView>
	//   68  185:iconst_0        
	//   69  186:invokevirtual   #459 <Method void Toolbar.addView(View, int)>
					Toolbar.LayoutParams layoutparams = (Toolbar.LayoutParams)mTabView.getLayoutParams();
	//   70  189:aload_0         
	//   71  190:getfield        #363 <Field View mTabView>
	//   72  193:invokevirtual   #460 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   73  196:checkcast       #291 <Class Toolbar$LayoutParams>
	//   74  199:astore_3        
					layoutparams.width = -2;
	//   75  200:aload_3         
	//   76  201:bipush          -2
	//   77  203:putfield        #463 <Field int Toolbar$LayoutParams.width>
					layoutparams.height = -2;
	//   78  206:aload_3         
	//   79  207:bipush          -2
	//   80  209:putfield        #464 <Field int Toolbar$LayoutParams.height>
					layoutparams.gravity = 0x800053;
	//   81  212:aload_3         
	//   82  213:ldc2            #465 <Int 0x800053>
	//   83  216:putfield        #468 <Field int Toolbar$LayoutParams.gravity>
					return;
	//   84  219:return          
				}
				break;
			...
			case 1: // '\001'
				ensureSpinner();
	//   85  220:aload_0         
	//   86  221:invokespecial   #429 <Method void ensureSpinner()>
				mToolbar.addView(((View) (mSpinner)), 0);
	//   87  224:aload_0         
	//   88  225:getfield        #76  <Field Toolbar mToolbar>
	//   89  228:aload_0         
	//   90  229:getfield        #280 <Field Spinner mSpinner>
	//   91  232:iconst_0        
	//   92  233:invokevirtual   #459 <Method void Toolbar.addView(View, int)>
				break;
			}
		}
	//   93  236:return          
