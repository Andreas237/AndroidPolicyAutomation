	...
	implements TintableBackgroundView
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #111 <Method InputConnection MultiAutoCompleteTextView.onCreateInputConnection(EditorInfo)>
	//    3    5:aload_1         
	//    4    6:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #119 <Method void MultiAutoCompleteTextView.setBackgroundDrawable(Drawable)>
		if(mBackgroundTintHelper != null)
	//*   3    5:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #127 <Method void MultiAutoCompleteTextView.setBackgroundResource(int)>
		if(mBackgroundTintHelper != null)
	//*   3    5:aload_0         
	//*   4    6:getfield        #71  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//*   5    9:ifnull          20
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #149 <Method void MultiAutoCompleteTextView.setTextAppearance(Context, int)>
		if(mTextHelper != null)
	//*   4    6:aload_0         
