...
public class DrawableUtils
{
	...
	//*  57  106:aload_0         
	//*  58  107:instanceof      #76  <Class WrappedDrawable>
	//*  59  110:ifeq            126
				return canSafelyMutateDrawable(((WrappedDrawable)drawable).getWrappedDrawable());
	//   60  113:aload_0         
	//   61  114:checkcast       #76  <Class WrappedDrawable>
	//   62  117:invokeinterface #80  <Method Drawable WrappedDrawable.getWrappedDrawable()>
	//   63  122:invokestatic    #74  <Method boolean canSafelyMutateDrawable(Drawable)>
	//   64  125:ireturn         
			if(drawable instanceof DrawableWrapper)
	//*  65  126:aload_0         
	//*  66  127:instanceof      #82  <Class DrawableWrapper>
	//*  67  130:ifeq            144
				return canSafelyMutateDrawable(((DrawableWrapper)drawable).getWrappedDrawable());
	//   68  133:aload_0         
	//   69  134:checkcast       #82  <Class DrawableWrapper>
	//   70  137:invokevirtual   #83  <Method Drawable DrawableWrapper.getWrappedDrawable()>
	...
	//    9   17:aload_0         
	//   10   18:getstatic       #118 <Field int[] ThemeUtils.EMPTY_STATE_SET>
	//   11   21:invokevirtual   #122 <Method boolean Drawable.setState(int[])>
	//   12   24:pop             
		else
	//*  13   25:goto            36
			drawable.setState(ThemeUtils.CHECKED_STATE_SET);
	//   14   28:aload_0         
	//   15   29:getstatic       #125 <Field int[] ThemeUtils.CHECKED_STATE_SET>
	//   16   32:invokevirtual   #122 <Method boolean Drawable.setState(int[])>
	//   17   35:pop             
		drawable.setState(ai);
	//   18   36:aload_0         
	//   19   37:aload_1         
	//   20   38:invokevirtual   #122 <Method boolean Drawable.setState(int[])>
	//   21   41:pop             
	//   22   42:return          
	}
...
_L4:
	...
	//   39   76:astore          7
		i = s.hashCode();
	//   40   78:aload           7
	//   41   80:invokevirtual   #158 <Method int String.hashCode()>
	//   42   83:istore_1        
		if(i == 0xad8d9a2b) goto _L7; else goto _L6
	//   43   84:iload_1         
	//   44   85:ldc1            #159 <Int 0xad8d9a2b>
	//   45   87:icmpeq          156
_L6:
		if(i == 0x1c155) goto _L9; else goto _L8
	//   46   90:iload_1         
	//   47   91:ldc1            #160 <Int 0x1c155>
	//   48   93:icmpeq          141
_L8:
		if(i == 0x32a007) goto _L11; else goto _L10
	//   49   96:iload_1         
	//   50   97:ldc1            #161 <Int 0x32a007>
	//   51   99:icmpeq          126
_L10:
		if(i == 0x677c21c) goto _L13; else goto _L12
	//   52  102:iload_1         
	//   53  103:ldc1            #162 <Int 0x677c21c>
	//   54  105:icmpeq          111
	//*  55  108:goto            250
_L13:
		if(!s.equals("right")) goto _L12; else goto _L14
	//   56  111:aload           7
	//   57  113:ldc1            #164 <String "right">
	//   58  115:invokevirtual   #105 <Method boolean String.equals(Object)>
	//   59  118:ifeq            250
_L14:
		i = 2;
	//   60  121:iconst_2        
...
_L11:
	...
	//   63  126:aload           7
	//   64  128:ldc1            #166 <String "left">
	//   65  130:invokevirtual   #105 <Method boolean String.equals(Object)>
	//   66  133:ifeq            250
_L16:
		i = 0;
	//   67  136:iconst_0        
...
_L9:
	...
	//   70  141:aload           7
	//   71  143:ldc1            #168 <String "top">
	//   72  145:invokevirtual   #105 <Method boolean String.equals(Object)>
	//   73  148:ifeq            250
_L17:
		i = 1;
	//   74  151:iconst_1        
...
_L7:
	...
	//   77  156:aload           7
	//   78  158:ldc1            #170 <String "bottom">
	//   79  160:invokevirtual   #105 <Method boolean String.equals(Object)>
	//   80  163:ifeq            250
_L18:
		i = 3;
	//   81  166:iconst_3        
...
_L26:
	...
	//   85  173:aload           6
	//   86  175:aload_0         
	//   87  176:invokevirtual   #174 <Method int Field.getInt(Object)>
	//   88  179:putfield        #176 <Field int Rect.bottom>
		  goto _L19
	//*  89  182:goto            224
_L23:
	...
	//   91  187:aload           6
	//   92  189:aload_0         
	//   93  190:invokevirtual   #174 <Method int Field.getInt(Object)>
	//   94  193:putfield        #178 <Field int Rect.right>
		  goto _L19
	//*  95  196:goto            224
_L22:
	...
	//   97  201:aload           6
	//   98  203:aload_0         
	//   99  204:invokevirtual   #174 <Method int Field.getInt(Object)>
	//  100  207:putfield        #180 <Field int Rect.top>
		  goto _L19
	//* 101  210:goto            224
_L21:
	...
	//  103  215:aload           6
	//  104  217:aload_0         
	//  105  218:invokevirtual   #174 <Method int Field.getInt(Object)>
	//  106  221:putfield        #182 <Field int Rect.left>
_L19:
		j++;
	//  107  224:iload_2         
	//  108  225:iconst_1        
...
_L20:
	...
	//  114  234:ldc1            #14  <String "DrawableUtils">
	//  115  236:ldc1            #184 <String "Couldn't obtain the optical insets. Ignoring.">
	//  116  238:invokestatic    #190 <Method int Log.e(String, String)>
	//  117  241:pop             
_L2:
		return INSETS_NONE;
	//  118  242:getstatic       #31  <Field Rect INSETS_NONE>
	//  119  245:areturn         
		drawable;
	//  120  246:astore_0        
...
_L27:
	...
	//   13   46:getstatic       #198 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.ADD>
	//   14   49:areturn         

					case 15: // '\017'
						return android.graphics.PorterDuff.Mode.SCREEN;
	//   15   50:getstatic       #201 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SCREEN>
	//   16   53:areturn         

					case 14: // '\016'
						return android.graphics.PorterDuff.Mode.MULTIPLY;
	//   17   54:getstatic       #204 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.MULTIPLY>
	//   18   57:areturn         
					}
				else
					return android.graphics.PorterDuff.Mode.SRC_ATOP;
	//   19   58:getstatic       #207 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_ATOP>
	//   20   61:areturn         
			} else
			{
				return android.graphics.PorterDuff.Mode.SRC_IN;
	//   21   62:getstatic       #210 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_IN>
	//   22   65:areturn         
			}
		} else
		{
			return android.graphics.PorterDuff.Mode.SRC_OVER;
	//   23   66:getstatic       #213 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_OVER>
	//   24   69:areturn         
		}
	}
