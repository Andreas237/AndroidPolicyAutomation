...
private class AppCompatSpinner$DropdownPopup extends ListPopupWindow
{
	...
	//   67  148:istore_3        
			int l = getContext().getResources().getDisplayMetrics().widthPixels - AppCompatSpinner.access$100(AppCompatSpinner.this).left - AppCompatSpinner.access$100(AppCompatSpinner.this).right;
	//   68  149:aload_0         
