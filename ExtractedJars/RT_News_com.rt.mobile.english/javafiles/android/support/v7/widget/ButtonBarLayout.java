...
public class ButtonBarLayout extends LinearLayout
{
	...
	//   97  183:iconst_0        
	//   98  184:aload_0         
	//   99  185:invokevirtual   #128 <Method int getPaddingTop()>
	//  100  188:aload           8
	//  101  190:invokevirtual   #131 <Method int View.getMeasuredHeight()>
	//  102  193:iadd            
	//  103  194:aload           9
	//  104  196:getfield        #134 <Field int android.widget.LinearLayout$LayoutParams.topMargin>
	//  105  199:iadd            
	//  106  200:aload           9
	//  107  202:getfield        #137 <Field int android.widget.LinearLayout$LayoutParams.bottomMargin>
	//  108  205:iadd            
	//  109  206:iadd            
	//  110  207:istore_2        
			if(isStacked())
	...
	//  125  230:aload_0         
	//  126  231:iload_3         
	//  127  232:invokevirtual   #61  <Method View getChildAt(int)>
	//  128  235:invokevirtual   #138 <Method int View.getPaddingTop()>
	//  129  238:ldc1            #139 <Float 16F>
	//  130  240:aload_0         
	//  131  241:invokevirtual   #143 <Method Resources getResources()>
	//  132  244:invokevirtual   #149 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//  133  247:getfield        #155 <Field float DisplayMetrics.density>
	//  134  250:fmul            
	//  135  251:f2i             
	//  136  252:iadd            
	//  137  253:iadd            
	...
	//  140  258:iload_2         
	//  141  259:aload_0         
	//  142  260:invokevirtual   #158 <Method int getPaddingBottom()>
	//  143  263:iadd            
	//  144  264:istore_1        
			}
		}
	...
	//* 145  265:aload_0         
	//* 146  266:invokestatic    #163 <Method int ViewCompat.getMinimumHeight(View)>
	//* 147  269:iload_1         
	//* 148  270:icmpeq          278
			setMinimumHeight(i);
	//  149  273:aload_0         
	//  150  274:iload_1         
	//  151  275:invokevirtual   #167 <Method void setMinimumHeight(int)>
	//  152  278:return          
	}
