...
class ChildHelper
{
	...
	//*   6   12:ifge            48
		{
			StringBuilder stringbuilder = new StringBuilder();
	//    7   15:new             #137 <Class StringBuilder>
	//    8   18:dup             
	//    9   19:invokespecial   #138 <Method void StringBuilder()>
	//   10   22:astore_3        
			stringbuilder.append("view is not a child, cannot hide ");
	//   11   23:aload_3         
	//   12   24:ldc1            #140 <String "view is not a child, cannot hide ">
	//   13   26:invokevirtual   #144 <Method StringBuilder StringBuilder.append(String)>
	//   14   29:pop             
			stringbuilder.append(((Object) (view)));
	//   15   30:aload_3         
	//   16   31:aload_1         
	//   17   32:invokevirtual   #147 <Method StringBuilder StringBuilder.append(Object)>
	//   18   35:pop             
			throw new IllegalArgumentException(stringbuilder.toString());
	//   19   36:new             #149 <Class IllegalArgumentException>
	//   20   39:dup             
	//   21   40:aload_3         
	//   22   41:invokevirtual   #153 <Method String StringBuilder.toString()>
	//   23   44:invokespecial   #156 <Method void IllegalArgumentException(String)>
	//   24   47:athrow          
		} else
		{
			mBucket.set(i);
	//   25   48:aload_0         
	//   26   49:getfield        #34  <Field ChildHelper$Bucket mBucket>
	//   27   52:iload_2         
	//   28   53:invokevirtual   #159 <Method void ChildHelper$Bucket.set(int)>
			hideViewInternal(view);
	//   29   56:aload_0         
	//   30   57:aload_1         
	//   31   58:invokespecial   #82  <Method void hideViewInternal(View)>
			return;
	//   32   61:return          
		}
	}
	...
	//*  26   49:getfield        #34  <Field ChildHelper$Bucket mBucket>
	//*  27   52:iload_2         
	//*  28   53:invokevirtual   #53  <Method boolean ChildHelper$Bucket.get(int)>
	//*  29   56:ifne            92
		{
			StringBuilder stringbuilder1 = new StringBuilder();
	//   30   59:new             #137 <Class StringBuilder>
	//   31   62:dup             
	//   32   63:invokespecial   #138 <Method void StringBuilder()>
	//   33   66:astore_3        
			stringbuilder1.append("trying to unhide a view that was not hidden");
	//   34   67:aload_3         
	//   35   68:ldc1            #188 <String "trying to unhide a view that was not hidden">
	//   36   70:invokevirtual   #144 <Method StringBuilder StringBuilder.append(String)>
	//   37   73:pop             
			stringbuilder1.append(((Object) (view)));
	//   38   74:aload_3         
	//   39   75:aload_1         
	//   40   76:invokevirtual   #147 <Method StringBuilder StringBuilder.append(Object)>
	//   41   79:pop             
			throw new RuntimeException(stringbuilder1.toString());
	//   42   80:new             #190 <Class RuntimeException>
	//   43   83:dup             
	//   44   84:aload_3         
	//   45   85:invokevirtual   #153 <Method String StringBuilder.toString()>
	//   46   88:invokespecial   #191 <Method void RuntimeException(String)>
	//   47   91:athrow          
		} else
		{
			mBucket.clear(i);
	//   48   92:aload_0         
	//   49   93:getfield        #34  <Field ChildHelper$Bucket mBucket>
	//   50   96:iload_2         
	//   51   97:invokevirtual   #194 <Method void ChildHelper$Bucket.clear(int)>
			unhideViewInternal(view);
	//   52  100:aload_0         
	//   53  101:aload_1         
	//   54  102:invokespecial   #175 <Method boolean unhideViewInternal(View)>
	//   55  105:pop             
			return;
	//   56  106:return          
		}
