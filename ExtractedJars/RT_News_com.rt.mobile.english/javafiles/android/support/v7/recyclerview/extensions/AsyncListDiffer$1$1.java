...
class AsyncListDiffer$1$1 extends android.support.v7.util.DiffUtil.Callback
{
	...
	{
		return AsyncListDiffer.access$000(this$0).getDiffCallback().areContentsTheSame(val$oldList.get(i), val$newList.get(j));
	//    0    0:aload_0         
	...
	{
		return AsyncListDiffer.access$000(this$0).getDiffCallback().areItemsTheSame(val$oldList.get(i), val$newList.get(j));
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field AsyncListDiffer$1 this$1>
	//    2    4:getfield        #24  <Field AsyncListDiffer AsyncListDiffer$1.this$0>
	//    3    7:invokestatic    #30  <Method AsyncDifferConfig AsyncListDiffer.access$000(AsyncListDiffer)>
	...
	{
		return AsyncListDiffer.access$000(this$0).getDiffCallback().getChangePayload(val$oldList.get(i), val$newList.get(j));
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field AsyncListDiffer$1 this$1>
	//    2    4:getfield        #24  <Field AsyncListDiffer AsyncListDiffer$1.this$0>
	//    3    7:invokestatic    #30  <Method AsyncDifferConfig AsyncListDiffer.access$000(AsyncListDiffer)>
	...
	// Unreferenced inner class android/support/v7/recyclerview/extensions/AsyncListDiffer$1

/* anonymous class */
	class AsyncListDiffer._cls1
		implements Runnable
	{

		public void run()
		{
			final android.support.v7.util.DiffUtil.DiffResult result = DiffUtil.calculateDiff(((android.support.v7.util.DiffUtil.Callback) (new AsyncListDiffer._cls1._cls1())));
		...
		//    5   11:astore_1        
			AsyncListDiffer.access$000(AsyncListDiffer.this).getMainThreadExecutor().execute(new AsyncListDiffer._cls1._cls2());
		//    6   12:aload_0         
		...
		// Unreferenced inner class android/support/v7/recyclerview/extensions/AsyncListDiffer$1$2

/* anonymous class */
		class AsyncListDiffer._cls1._cls2
			implements Runnable
		{
