...
public static final class AsyncDifferConfig$Builder
{
		...
		implements Executor
	{
		...
		MainThreadExecutor(AsyncDifferConfig._cls1 _pcls1)
		{
			this();
		//    0    0:aload_0         
	...
	//   27   55:aload_2         
	//   28   56:athrow          
		return new AsyncDifferConfig(mMainThreadExecutor, mBackgroundThreadExecutor, mDiffCallback, ((AsyncDifferConfig._cls1) (null)));
	...
	private static final Executor sMainThreadExecutor = new MainThreadExecutor(((AsyncDifferConfig._cls1) (null)));
