	...
	implements Runnable
{
	...
	public void run()
	{
		if(AsyncListDiffer.access$100(this$0) == val$runGeneration)
	//*   0    0:aload_0         
	...
	//*   7   17:icmpne          41
			AsyncListDiffer.access$200(this$0, val$newList, val$result);
	//    8   20:aload_0         
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		public void run()
		{
			android.support.v7.util.DiffUtil.DiffResult diffresult = DiffUtil.calculateDiff(((android.support.v7.util.DiffUtil.Callback) (new AsyncListDiffer._cls1._cls1())));
		...
		//    5   11:astore_1        
			AsyncListDiffer.access$000(AsyncListDiffer.this).getMainThreadExecutor().execute(((Runnable) (((AsyncListDiffer._cls1._cls2) (diffresult)). new AsyncListDiffer._cls1._cls2())));
		//    6   12:aload_0         
		...
		// Unreferenced inner class android/support/v7/recyclerview/extensions/AsyncListDiffer$1$1

/* anonymous class */
		class AsyncListDiffer._cls1._cls1 extends android.support.v7.util.DiffUtil.Callback
		{
