...
label0:
	...
	//   23   46:aload_0         
	//   24   47:getfield        #112 <Field MenuBuilder mMenu>
	//   25   50:aload_0         
	//   26   51:invokevirtual   #167 <Method boolean MenuBuilder.collapseItemActionView(MenuItemImpl)>
	//   27   54:ireturn         
	}
	...
	//   16   34:aload_0         
	//   17   35:getfield        #112 <Field MenuBuilder mMenu>
	//   18   38:aload_0         
	//   19   39:invokevirtual   #177 <Method boolean MenuBuilder.expandItemActionView(MenuItemImpl)>
	//   20   42:ireturn         
	}
	...
	//   21   42:aload_2         
	//   22   43:iload_1         
	//   23   44:invokevirtual   #266 <Method StringBuilder StringBuilder.append(char)>
	//   24   47:pop             
				else
	//*  25   48:goto            81
					stringbuilder.append(sSpaceShortcutLabel);
	//   26   51:aload_2         
	//   27   52:getstatic       #268 <Field String sSpaceShortcutLabel>
	//   28   55:invokevirtual   #271 <Method StringBuilder StringBuilder.append(String)>
	//   29   58:pop             
			} else
	//*  30   59:goto            81
			{
	...
	//   31   62:aload_2         
	//   32   63:getstatic       #273 <Field String sEnterShortcutLabel>
	//   33   66:invokevirtual   #271 <Method StringBuilder StringBuilder.append(String)>
	//   34   69:pop             
			}
		} else
	//*  35   70:goto            81
	...
	//   36   73:aload_2         
	//   37   74:getstatic       #275 <Field String sDeleteShortcutLabel>
	//   38   77:invokevirtual   #271 <Method StringBuilder StringBuilder.append(String)>
	//   39   80:pop             
		}
		return stringbuilder.toString();
	//   40   81:aload_2         
	//   41   82:invokevirtual   #278 <Method String StringBuilder.toString()>
	//   42   85:areturn         
	}
	...
	//*   6   12:goto            20
			charsequence = mTitle;
	//    7   15:aload_0         
	//    8   16:getfield        #122 <Field CharSequence mTitle>
	//    9   19:astore_1        
		if(android.os.Build.VERSION.SDK_INT < 18 && charsequence != null && !(charsequence instanceof String))
	//*  10   20:getstatic       #293 <Field int android.os.Build$VERSION.SDK_INT>
	//*  11   23:bipush          18
	//*  12   25:icmpge          46
	//*  13   28:aload_1         
	//*  14   29:ifnull          46
	//*  15   32:aload_1         
	//*  16   33:instanceof      #295 <Class String>
	//*  17   36:ifne            46
			return ((CharSequence) (charsequence.toString()));
	//   18   39:aload_1         
	//   19   40:invokeinterface #298 <Method String CharSequence.toString()>
	//   20   45:areturn         
		else
			return charsequence;
	//   21   46:aload_1         
	...
	//   20   37:putfield        #155 <Field View mActionView>
			if(mActionView != null)
	//*  21   40:aload_0         
	//*  22   41:getfield        #155 <Field View mActionView>
	//*  23   44:ifnull          49
				flag = true;
	//   24   47:iconst_1        
	//   25   48:istore_2        
	...
	//*  19   39:aload_0         
	//*  20   40:getfield        #206 <Field Runnable mItemCallback>
	//*  21   43:ifnull          57
		{
			mItemCallback.run();
	//   22   46:aload_0         
	//   23   47:getfield        #206 <Field Runnable mItemCallback>
	//   24   50:invokeinterface #332 <Method void Runnable.run()>
			return true;
	//   25   55:iconst_1        
	//   26   56:ireturn         
		}
	...
	//   27   57:aload_0         
	//   28   58:getfield        #234 <Field Intent mIntent>
	//   29   61:ifnull          91
		mMenu.getContext().startActivity(mIntent);
	//   30   64:aload_0         
	//   31   65:getfield        #112 <Field MenuBuilder mMenu>
	//   32   68:invokevirtual   #220 <Method Context MenuBuilder.getContext()>
	//   33   71:aload_0         
	//   34   72:getfield        #234 <Field Intent mIntent>
	//   35   75:invokevirtual   #338 <Method void Context.startActivity(Intent)>
		return true;
	//   36   78:iconst_1        
	//   37   79:ireturn         
	...
	//   39   81:ldc1            #33  <String "MenuItemImpl">
	//   40   83:ldc2            #340 <String "Can't find activity to handle intent; ignoring">
	//   41   86:aload_1         
	//   42   87:invokestatic    #346 <Method int Log.e(String, String, Throwable)>
	//   43   90:pop             
		return mActionProvider != null && mActionProvider.onPerformDefaultAction();
	//   44   91:aload_0         
	//   45   92:getfield        #190 <Field ActionProvider mActionProvider>
	//   46   95:ifnull          110
	//   47   98:aload_0         
	//   48   99:getfield        #190 <Field ActionProvider mActionProvider>
	//   49  102:invokevirtual   #349 <Method boolean ActionProvider.onPerformDefaultAction()>
	//   50  105:ifeq            110
	//   51  108:iconst_1        
	//   52  109:ireturn         
	//   53  110:iconst_0        
	...
	//    5    7:iconst_0        
	//    6    8:istore_2        
		if(actionprovider != null && mActionProvider.overridesItemVisibility())
	//*   7    9:aload_3         
	//*   8   10:ifnull          51
	//*   9   13:aload_0         
	//*  10   14:getfield        #190 <Field ActionProvider mActionProvider>
	//*  11   17:invokevirtual   #359 <Method boolean ActionProvider.overridesItemVisibility()>
	//*  12   20:ifeq            51
		{
			flag = flag1;
	//   13   23:iload_2         
	//   14   24:istore_1        
			if((mFlags & 8) == 0)
	//*  15   25:aload_0         
	//*  16   26:getfield        #106 <Field int mFlags>
	//*  17   29:bipush          8
	//*  18   31:iand            
	//*  19   32:ifne            49
			{
	...
	//*  22   37:aload_0         
	//*  23   38:getfield        #190 <Field ActionProvider mActionProvider>
	//*  24   41:invokevirtual   #361 <Method boolean ActionProvider.isVisible()>
	//*  25   44:ifeq            49
					flag = true;
	//   26   47:iconst_1        
	//   27   48:istore_1        
	...
	//   29   50:ireturn         
		...
		if((mFlags & 8) == 0)
	//*  30   51:aload_0         
	//*  31   52:getfield        #106 <Field int mFlags>
	//*  32   55:bipush          8
	//*  33   57:iand            
	//*  34   58:ifne            63
			flag = true;
	...
	//    4    6:iload_1         
	//    5    7:aload_0         
	//    6    8:getfield        #106 <Field int mFlags>
	//    7   11:bipush          -2
	//    8   13:iand            
	//    9   14:ior             
	//   10   15:putfield        #106 <Field int mFlags>
		if(i != mFlags)
	//*  11   18:iload_2         
	//*  12   19:aload_0         
	//*  13   20:getfield        #106 <Field int mFlags>
	//*  14   23:icmpeq          34
			mMenu.onItemsChanged(false);
	//   15   26:aload_0         
	//   16   27:getfield        #112 <Field MenuBuilder mMenu>
	//   17   30:iconst_0        
	//   18   31:invokevirtual   #405 <Method void MenuBuilder.onItemsChanged(boolean)>
		return ((MenuItem) (this));
	//   19   34:aload_0         
	//   20   35:areturn         
	}
	...
	//   17   28:iand            
	//   18   29:ior             
	//   19   30:putfield        #106 <Field int mFlags>
		if(i != mFlags)
	//*  20   33:iload_3         
	//*  21   34:aload_0         
	//*  22   35:getfield        #106 <Field int mFlags>
	//*  23   38:icmpeq          49
			mMenu.onItemsChanged(false);
	//   24   41:aload_0         
	//   25   42:getfield        #112 <Field MenuBuilder mMenu>
	//   26   45:iconst_0        
	//   27   46:invokevirtual   #405 <Method void MenuBuilder.onItemsChanged(boolean)>
	//   28   49:return          
	}
	...
	//    9   18:aload_0         
	//   10   19:aload_0         
	//   11   20:getfield        #106 <Field int mFlags>
	//   12   23:bipush          -17
	//   13   25:iand            
	//   14   26:putfield        #106 <Field int mFlags>
		mMenu.onItemsChanged(false);
	//   15   29:aload_0         
	//   16   30:getfield        #112 <Field MenuBuilder mMenu>
	//   17   33:iconst_0        
	//   18   34:invokevirtual   #405 <Method void MenuBuilder.onItemsChanged(boolean)>
		return ((MenuItem) (this));
	//   19   37:aload_0         
	//   20   38:areturn         
	}
	...
	//   14   21:iand            
	//   15   22:ior             
	//   16   23:putfield        #106 <Field int mFlags>
	//   17   26:return          
	}
	...
	//   19   32:iand            
	//   20   33:ior             
	//   21   34:putfield        #106 <Field int mFlags>
		flag = flag1;
	//   22   37:iload           5
	//   23   39:istore_1        
		if(i != mFlags)
	//*  24   40:iload_3         
	//*  25   41:aload_0         
	//*  26   42:getfield        #106 <Field int mFlags>
	//*  27   45:icmpeq          50
			flag = true;
	//   28   48:iconst_1        
	//   29   49:istore_1        
