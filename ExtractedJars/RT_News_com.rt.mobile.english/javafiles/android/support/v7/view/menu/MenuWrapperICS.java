	...
	implements Menu
{
	...
	//    9   19:aload_0         
	//   10   20:getfield        #22  <Field Object mWrappedObject>
	//   11   23:checkcast       #24  <Class SupportMenu>
	//   12   26:iload_1         
	//   13   27:iload_2         
	//   14   28:iload_3         
	//   15   29:aload           4
	...
	//   18   35:iload           7
	//   19   37:aload           9
	//   20   39:invokeinterface #45  <Method int SupportMenu.addIntentOptions(int, int, int, ComponentName, Intent[], Intent, int, MenuItem[])>
	//   21   44:istore_2        
		if(amenuitem1 != null)
	//*  22   45:aload           9
	//*  23   47:ifnull          80
	...
	//   36   67:iload_1         
	//   37   68:aaload          
	//   38   69:invokevirtual   #30  <Method MenuItem getMenuItemWrapper(MenuItem)>
	//   39   72:aastore         
