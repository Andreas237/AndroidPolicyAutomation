	...
	implements MenuPresenter
{
	...
	//   14   28:aload_0         
	//   15   29:getfield        #106 <Field MenuBuilder mMenu>
	//   16   32:invokevirtual   #141 <Method void MenuBuilder.flagActionItems()>
			ArrayList arraylist = mMenu.getVisibleItems();
	//   17   35:aload_0         
	//   18   36:getfield        #106 <Field MenuBuilder mMenu>
	//   19   39:invokevirtual   #145 <Method ArrayList MenuBuilder.getVisibleItems()>
	//   20   42:astore          8
			int l = arraylist.size();
	//   21   44:aload           8
	//   22   46:invokevirtual   #150 <Method int ArrayList.size()>
	//   23   49:istore          5
			int j = 0;
	//   24   51:iconst_0        
	//   25   52:istore_3        
	...
	//   31   61:aload           8
	//   32   63:iload_3         
	//   33   64:invokevirtual   #154 <Method Object ArrayList.get(int)>
	//   34   67:checkcast       #156 <Class MenuItemImpl>
	//   35   70:astore          9
				k = i;
	//   36   72:iload_2         
	//   37   73:istore          4
