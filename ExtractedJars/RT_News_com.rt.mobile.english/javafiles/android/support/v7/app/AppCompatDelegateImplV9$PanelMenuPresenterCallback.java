	...
	implements android.support.v7.view.menu.MenuPresenter.Callback
{
	...
	//   18   32:aload           5
	//   19   34:aload_1         
	//   20   35:invokevirtual   #31  <Method AppCompatDelegateImplV9$PanelFeatureState AppCompatDelegateImplV9.findMenuPanel(android.view.Menu)>
	//   21   38:astore_1        
		if(menubuilder != null)
	//*  22   39:aload_1         
	//*  23   40:ifnull          80
	...
	//   30   55:aload_1         
	//   31   56:aload           4
	//   32   58:invokevirtual   #41  <Method void AppCompatDelegateImplV9.callOnPanelClosed(int, AppCompatDelegateImplV9$PanelFeatureState, android.view.Menu)>
