...
_L5:
	...
	//*  73  121:aload           5
	//*  74  123:aconst_null     
	//*  75  124:invokespecial   #177 <Method View createViewByPrefix(Context, String, String)>
	//*  76  127:astore_1        
	//*  77  128:aload_0         
	...
	//* 101  160:athrow          
	//* 102  161:aload_0         
	//* 103  162:getfield        #57  <Field Object[] mConstructorArgs>
	//* 104  165:iconst_0        
	//* 105  166:aconst_null     
	//* 106  167:aastore         
	//* 107  168:aload_0         
	//* 108  169:getfield        #57  <Field Object[] mConstructorArgs>
	//* 109  172:iconst_1        
	//* 110  173:aconst_null     
	//* 111  174:aastore         
	//* 112  175:aconst_null     
...
label0:
	...
	//    2    4:new             #121 <Class StringBuilder>
	//    3    7:dup             
	//    4    8:invokespecial   #122 <Method void StringBuilder()>
	//    5   11:astore_1        
			((StringBuilder) (view)).append(((Object)this).getClass().getName());
	//    6   12:aload_1         
	//    7   13:aload_0         
	//    8   14:invokevirtual   #219 <Method Class Object.getClass()>
	//    9   17:invokevirtual   #222 <Method String Class.getName()>
	//   10   20:invokevirtual   #126 <Method StringBuilder StringBuilder.append(String)>
	//   11   23:pop             
			((StringBuilder) (view)).append(" asked to inflate view for <");
	//   12   24:aload_1         
	//   13   25:ldc1            #224 <String " asked to inflate view for <">
	//   14   27:invokevirtual   #126 <Method StringBuilder StringBuilder.append(String)>
	//   15   30:pop             
			((StringBuilder) (view)).append(s);
	//   16   31:aload_1         
	//   17   32:aload_2         
	//   18   33:invokevirtual   #126 <Method StringBuilder StringBuilder.append(String)>
	//   19   36:pop             
			((StringBuilder) (view)).append(">, but returned null");
	//   20   37:aload_1         
	//   21   38:ldc1            #226 <String ">, but returned null">
	//   22   40:invokevirtual   #126 <Method StringBuilder StringBuilder.append(String)>
	//   23   43:pop             
			throw new IllegalStateException(((StringBuilder) (view)).toString());
	//   24   44:new             #228 <Class IllegalStateException>
	//   25   47:dup             
	//   26   48:aload_1         
	//   27   49:invokevirtual   #130 <Method String StringBuilder.toString()>
	//   28   52:invokespecial   #231 <Method void IllegalStateException(String)>
	//   29   55:athrow          
		} else
		{
			return;
