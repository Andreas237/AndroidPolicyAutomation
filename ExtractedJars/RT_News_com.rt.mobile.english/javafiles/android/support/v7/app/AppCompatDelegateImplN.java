...
class AppCompatDelegateImplN extends AppCompatDelegateImplV23
{
	...
	//    2    2:aload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #14  <Method void AppCompatDelegateImplV23(Context, Window, AppCompatCallback)>
	//    5    7:return          
	}

	android.view.Window.Callback wrapWindowCallback(android.view.Window.Callback callback)
	{
		return ((android.view.Window.Callback) (new AppCompatWindowCallbackN(callback)));
	//    0    0:new             #6   <Class AppCompatDelegateImplN$AppCompatWindowCallbackN>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokespecial   #20  <Method void AppCompatDelegateImplN$AppCompatWindowCallbackN(AppCompatDelegateImplN, android.view.Window$Callback)>
	//    5    9:areturn         
	}
}
