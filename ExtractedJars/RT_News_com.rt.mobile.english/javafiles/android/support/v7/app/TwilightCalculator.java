...
class TwilightCalculator
{
	...
	//   14   23:f2d             
	//   15   24:dstore          9
		double d2 = 0.033419601619243622D * Math.sin(d3) + d3 + 0.00034906598739326D * Math.sin(2.0F * f1) + 5.2360001063789241E-06D * Math.sin(3F * f1) + 1.796593063D + 3.1415926535897931D;
	//   16   26:ldc2w           #49  <Double 0.033419601619243622D>
	//   17   29:dload           9
	//   18   31:invokestatic    #56  <Method double Math.sin(double)>
	//   19   34:dmul            
	//   20   35:dload           9
	//   21   37:dadd            
	//   22   38:ldc2w           #57  <Double 0.00034906598739326D>
	//   23   41:fconst_2        
	//   24   42:fload           12
	//   25   44:fmul            
	//   26   45:f2d             
	//   27   46:invokestatic    #56  <Method double Math.sin(double)>
	//   28   49:dmul            
	//   29   50:dadd            
	//   30   51:ldc2w           #59  <Double 5.2360001063789241E-06D>
	//   31   54:ldc1            #61  <Float 3F>
	//   32   56:fload           12
	//   33   58:fmul            
	//   34   59:f2d             
	//   35   60:invokestatic    #56  <Method double Math.sin(double)>
	//   36   63:dmul            
	//   37   64:dadd            
	...
	//   46   81:ddiv            
	//   47   82:dstore          5
		d1 = (double)((float)Math.round((double)(f - 0.0009F) - d1) + 0.0009F) + d1 + 0.0053D * Math.sin(d3) + -0.0068999999999999999D * Math.sin(2D * d2);
	//   48   84:fload           11
	...
	//   59  101:dload           5
	//   60  103:dadd            
	//   61  104:ldc2w           #72  <Double 0.0053D>
	//   62  107:dload           9
	//   63  109:invokestatic    #56  <Method double Math.sin(double)>
	//   64  112:dmul            
	//   65  113:dadd            
	//   66  114:ldc2w           #74  <Double -0.0068999999999999999D>
	//   67  117:ldc2w           #76  <Double 2D>
	//   68  120:dload           7
	//   69  122:dmul            
	//   70  123:invokestatic    #56  <Method double Math.sin(double)>
	//   71  126:dmul            
	//   72  127:dadd            
	//   73  128:dstore          5
		d2 = Math.asin(Math.sin(d2) * Math.sin(0.40927970409393311D));
	//   74  130:dload           7
	//   75  132:invokestatic    #56  <Method double Math.sin(double)>
	//   76  135:ldc2w           #78  <Double 0.40927970409393311D>
	//   77  138:invokestatic    #56  <Method double Math.sin(double)>
	//   78  141:dmul            
	...
	//   86  156:invokestatic    #56  <Method double Math.sin(double)>
	//   87  159:dload_3         
	//   88  160:invokestatic    #56  <Method double Math.sin(double)>
	//   89  163:dload           7
	//   90  165:invokestatic    #56  <Method double Math.sin(double)>
	//   91  168:dmul            
	//   92  169:dsub            
	//   93  170:dload_3         
