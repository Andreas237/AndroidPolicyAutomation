...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate
{
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #139 <Method ActionBar getSupportActionBar()>
	//    2    4:astore_1        
		if(obj != null)
	//*   3    5:aload_1         
	//*   4    6:ifnull          17
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #144 <Method Context ActionBar.getThemedContext()>
	//    7   13:astore_1        
		else
	//*   8   14:goto            19
			obj = null;
	...
	//*  14   22:ifnonnull       30
			context = mContext;
	//   15   25:aload_0         
	//   16   26:getfield        #83  <Field Context mContext>
	//   17   29:astore_2        
		return context;
	//   18   30:aload_2         
	//   19   31:areturn         
	...
	//*  12   26:goto            34
				context = mContext;
	//   13   29:aload_0         
	//   14   30:getfield        #83  <Field Context mContext>
	//   15   33:astore_1        
			mMenuInflater = ((MenuInflater) (new SupportMenuInflater(context)));
	//   16   34:aload_0         
	//   17   35:new             #160 <Class SupportMenuInflater>
	//   18   38:dup             
	//   19   39:aload_1         
	//   20   40:invokespecial   #163 <Method void SupportMenuInflater(Context)>
	//   21   43:putfield        #153 <Field MenuInflater mMenuInflater>
		}
		return mMenuInflater;
	//   22   46:aload_0         
	//   23   47:getfield        #153 <Field MenuInflater mMenuInflater>
	//   24   50:areturn         
	}
	...
	//    8   15:iload_0         
	//    9   16:putstatic       #59  <Field boolean SHOULD_INSTALL_EXCEPTION_HANDLER>
		if(SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler)
	//*  10   19:getstatic       #59  <Field boolean SHOULD_INSTALL_EXCEPTION_HANDLER>
	//*  11   22:ifeq            48
	//*  12   25:getstatic       #61  <Field boolean sInstalledExceptionHandler>
	//*  13   28:ifne            48
		{
...
label1:
	...
	//   15   34:dup             
	//   16   35:invokestatic    #67  <Method Thread$UncaughtExceptionHandler Thread.getDefaultUncaughtExceptionHandler()>
	//   17   38:invokespecial   #71  <Method void AppCompatDelegateImplBase$1(Thread$UncaughtExceptionHandler)>
	//   18   41:invokestatic    #74  <Method void Thread.setDefaultUncaughtExceptionHandler(Thread$UncaughtExceptionHandler)>
			sInstalledExceptionHandler = true;
	//   19   44:iconst_1        
	//   20   45:putstatic       #61  <Field boolean sInstalledExceptionHandler>
		}
	//   21   48:iconst_1        
	//   22   49:newarray        int[]
	//   23   51:dup             
	//   24   52:iconst_0        
	//   25   53:ldc1            #75  <Int 0x1010054>
	//   26   55:iastore         
	//   27   56:putstatic       #77  <Field int[] sWindowBackgroundStyleable>
	//*  28   59:return          
	}
}
