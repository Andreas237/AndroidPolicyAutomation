...
final class MediaRouteDialogHelper
{
	...
	//   23   40:aload           4
	//   24   42:aload           5
	//   25   44:new             #96  <Class Rect>
	//   26   47:dup             
	//   27   48:aload           6
	//   28   50:invokevirtual   #101 <Method int View.getLeft()>
	//   29   53:aload           6
	//   30   55:invokevirtual   #104 <Method int View.getTop()>
	//   31   58:aload           6
	//   32   60:invokevirtual   #107 <Method int View.getRight()>
	//   33   63:aload           6
	//   34   65:invokevirtual   #110 <Method int View.getBottom()>
	//   35   68:invokespecial   #113 <Method void Rect(int, int, int, int)>
	...
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokespecial   #121 <Method void HashSet(java.util.Collection)>
	//    4    8:astore_1        
		((HashSet) (list1)).removeAll(((java.util.Collection) (list)));
	//    5    9:aload_1         
	//    6   10:aload_0         
	//    7   11:invokevirtual   #125 <Method boolean HashSet.removeAll(java.util.Collection)>
	//    8   14:pop             
		return ((Set) (list1));
	//    9   15:aload_1         
	//   10   16:areturn         
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #130 <Method int View.getWidth()>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #133 <Method int View.getHeight()>
	//    4    8:getstatic       #139 <Field android.graphics.Bitmap$Config android.graphics.Bitmap$Config.ARGB_8888>
	//    5   11:invokestatic    #145 <Method Bitmap Bitmap.createBitmap(int, int, android.graphics.Bitmap$Config)>
	//    6   14:astore_2        
		view.draw(new Canvas(bitmap));
	//    7   15:aload_1         
	//    8   16:new             #147 <Class Canvas>
	//    9   19:dup             
	//   10   20:aload_2         
	//   11   21:invokespecial   #150 <Method void Canvas(Bitmap)>
	//   12   24:invokevirtual   #154 <Method void View.draw(Canvas)>
		return new BitmapDrawable(context.getResources(), bitmap);
	//   13   27:new             #156 <Class BitmapDrawable>
	//   14   30:dup             
	//   15   31:aload_0         
	//   16   32:invokevirtual   #17  <Method Resources Context.getResources()>
	//   17   35:aload_2         
	//   18   36:invokespecial   #159 <Method void BitmapDrawable(Resources, Bitmap)>
	//   19   39:areturn         
	}
	...
	//    2    4:aload_0         
	//    3    5:invokespecial   #121 <Method void HashSet(java.util.Collection)>
	//    4    8:new             #118 <Class HashSet>
	//    5   11:dup             
	//    6   12:aload_1         
	//    7   13:invokespecial   #121 <Method void HashSet(java.util.Collection)>
	//    8   16:invokevirtual   #165 <Method boolean HashSet.equals(Object)>
	//    9   19:ireturn         
	}
}
