...
public final class NavUtils
{
	...
	//    5    9:new             #57  <Class StringBuilder>
	//    6   12:dup             
	//    7   13:invokespecial   #58  <Method void StringBuilder()>
	//    8   16:astore_1        
			((StringBuilder) (obj)).append("Activity ");
	//    9   17:aload_1         
	//   10   18:ldc1            #141 <String "Activity ">
	...
	//   13   24:aload_1         
	//   14   25:aload_0         
	//   15   26:invokevirtual   #145 <Method Class Object.getClass()>
	//   16   29:invokevirtual   #150 <Method String Class.getSimpleName()>
	...
	//   19   36:aload_1         
	//   20   37:ldc1            #152 <String " does not have a parent activity name specified.">
	//   21   39:invokevirtual   #64  <Method StringBuilder StringBuilder.append(String)>
	//   22   42:pop             
			((StringBuilder) (obj)).append(" (Did you forget to add the android.support.PARENT_ACTIVITY <meta-data> ");
	//   23   43:aload_1         
	//   24   44:ldc1            #154 <String " (Did you forget to add the android.support.PARENT_ACTIVITY <meta-data> ">
	//   25   46:invokevirtual   #64  <Method StringBuilder StringBuilder.append(String)>
	//   26   49:pop             
			((StringBuilder) (obj)).append(" element in your manifest?)");
	//   27   50:aload_1         
	//   28   51:ldc1            #156 <String " element in your manifest?)">
	...
	//   31   57:new             #98  <Class IllegalArgumentException>
	//   32   60:dup             
	//   33   61:aload_1         
	//   34   62:invokevirtual   #70  <Method String StringBuilder.toString()>
	//   35   65:invokespecial   #159 <Method void IllegalArgumentException(String)>
	//   36   68:athrow          
		} else
		{
	...
	//   37   69:aload_0         
	//   38   70:aload_1         
	//   39   71:invokestatic    #163 <Method void navigateUpTo(Activity, Intent)>
			return;
	//   40   74:return          
		}
	}
