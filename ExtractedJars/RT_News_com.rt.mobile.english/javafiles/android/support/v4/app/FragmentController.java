...
public class FragmentController
{
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #108 <Method boolean FragmentManagerImpl.execPendingActions()>
	//    4   10:ireturn         
	}
	...
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:aload_1         
	//    4    8:invokevirtual   #113 <Method Fragment FragmentManagerImpl.findFragmentByWho(String)>
	//    5   11:areturn         
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #119 <Method List FragmentManagerImpl.getActiveFragments()>
	//    4   10:areturn         
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #125 <Method int FragmentManagerImpl.getActiveFragmentCount()>
	//    4   10:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:invokevirtual   #131 <Method FragmentManagerImpl FragmentHostCallback.getFragmentManagerImpl()>
	//    3    7:areturn         
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #136 <Method void FragmentManagerImpl.noteStateNotSaved()>
	//    4   10:return          
	}
	...
	//    5    9:aload_3         
	//    6   10:aload           4
	//    7   12:invokevirtual   #140 <Method View FragmentManagerImpl.onCreateView(View, String, Context, AttributeSet)>
	//    8   15:areturn         
	}
	...
	//    3    7:aload_1         
	//    4    8:aload_2         
	//    5    9:invokevirtual   #145 <Method void FragmentManagerImpl.restoreAllState(Parcelable, FragmentManagerNonConfig)>
	//    6   12:return          
	}
	...
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:aload_1         
	//    4    8:new             #148 <Class FragmentManagerNonConfig>
	//    5   11:dup             
	//    6   12:aload_2         
	//    7   13:aconst_null     
	//    8   14:aconst_null     
	//    9   15:invokespecial   #151 <Method void FragmentManagerNonConfig(List, List, List)>
	//   10   18:invokevirtual   #145 <Method void FragmentManagerImpl.restoreAllState(Parcelable, FragmentManagerNonConfig)>
	//   11   21:return          
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #163 <Method FragmentManagerNonConfig FragmentManagerImpl.retainNonConfig()>
	//    4   10:areturn         
	}
	...
	//    7   15:aload_1         
	//    8   16:invokevirtual   #166 <Method List FragmentManagerNonConfig.getFragments()>
	//    9   19:areturn         
		else
			return null;
	//   10   20:aconst_null     
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #171 <Method Parcelable FragmentManagerImpl.saveAllState()>
	//    4   10:areturn         
	}
