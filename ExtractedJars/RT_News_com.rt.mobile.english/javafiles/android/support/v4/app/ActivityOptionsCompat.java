...
public class ActivityOptionsCompat
{
	...
	//    3    8:invokestatic    #50  <Method ActivityOptions ActivityOptions.makeBasic()>
	//    4   11:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//    5   14:areturn         
		else
			return new ActivityOptionsCompat();
	//    6   15:new             #2   <Class ActivityOptionsCompat>
	//    7   18:dup             
	//    8   19:invokespecial   #53  <Method void ActivityOptionsCompat()>
	//    9   22:areturn         
	}
	...
	//    6   11:iload_3         
	//    7   12:iload           4
	//    8   14:invokestatic    #58  <Method ActivityOptions ActivityOptions.makeClipRevealAnimation(View, int, int, int, int)>
	//    9   17:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//   10   20:areturn         
		else
			return new ActivityOptionsCompat();
	//   11   21:new             #2   <Class ActivityOptionsCompat>
	//   12   24:dup             
	//   13   25:invokespecial   #53  <Method void ActivityOptionsCompat()>
	//   14   28:areturn         
	}
	...
	//    4    9:iload_1         
	//    5   10:iload_2         
	//    6   11:invokestatic    #64  <Method ActivityOptions ActivityOptions.makeCustomAnimation(Context, int, int)>
	//    7   14:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//    8   17:areturn         
		else
			return new ActivityOptionsCompat();
	//    9   18:new             #2   <Class ActivityOptionsCompat>
	//   10   21:dup             
	//   11   22:invokespecial   #53  <Method void ActivityOptionsCompat()>
	//   12   25:areturn         
	}
	...
	//    6   11:iload_3         
	//    7   12:iload           4
	//    8   14:invokestatic    #67  <Method ActivityOptions ActivityOptions.makeScaleUpAnimation(View, int, int, int, int)>
	//    9   17:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//   10   20:areturn         
		else
			return new ActivityOptionsCompat();
	...
	//    4    9:aload_1         
	//    5   10:aload_2         
	//    6   11:invokestatic    #72  <Method ActivityOptions ActivityOptions.makeSceneTransitionAnimation(Activity, View, String)>
	//    7   14:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//    8   17:areturn         
		else
			return new ActivityOptionsCompat();
	...
	//   22   36:iload_2         
	//   23   37:aaload          
	//   24   38:getfield        #81  <Field Object android.support.v4.util.Pair.first>
	//   25   41:aload_1         
	//   26   42:iload_2         
	//   27   43:aaload          
	//   28   44:getfield        #84  <Field Object android.support.v4.util.Pair.second>
	//   29   47:invokestatic    #88  <Method Pair Pair.create(Object, Object)>
	//   30   50:aastore         
					i++;
	//   31   51:iload_2         
	//   32   52:iconst_1        
	...
	//   36   58:aload_0         
	//   37   59:aload_3         
	//   38   60:invokestatic    #91  <Method ActivityOptions ActivityOptions.makeSceneTransitionAnimation(Activity, Pair[])>
	//   39   63:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//   40   66:areturn         
		} else
		{
			return new ActivityOptionsCompat();
	...
	//   42   70:dup             
	//   43   71:invokespecial   #53  <Method void ActivityOptionsCompat()>
	//   44   74:areturn         
		}
	}
	...
	//    3    8:invokestatic    #96  <Method ActivityOptions ActivityOptions.makeTaskLaunchBehind()>
	//    4   11:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//    5   14:areturn         
		else
			return new ActivityOptionsCompat();
	...
	//    5   10:iload_2         
	//    6   11:iload_3         
	//    7   12:invokestatic    #101 <Method ActivityOptions ActivityOptions.makeThumbnailScaleUpAnimation(View, Bitmap, int, int)>
	//    8   15:invokestatic    #52  <Method ActivityOptionsCompat createImpl(ActivityOptions)>
	//    9   18:areturn         
		else
			return new ActivityOptionsCompat();
	//   10   19:new             #2   <Class ActivityOptionsCompat>
	//   11   22:dup             
	//   12   23:invokespecial   #53  <Method void ActivityOptionsCompat()>
	//   13   26:areturn         
	}
