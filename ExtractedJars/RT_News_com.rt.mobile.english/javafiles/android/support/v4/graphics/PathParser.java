...
_L34:
	...
	//   22   34:iload_1         
	//   23   35:isub            
	//   24   36:invokestatic    #57  <Method int Math.min(int, int)>
	//   25   39:istore_3        
			float af1[] = new float[j];
	//   26   40:iload_2         
	//   27   41:newarray        float[]
	//   28   43:astore          4
	...
	//   32   49:iconst_0        
	//   33   50:iload_3         
	//   34   51:invokestatic    #63  <Method void System.arraycopy(Object, int, Object, int, int)>
			return af1;
	//   35   54:aload           4
	//   36   56:areturn         
		} else
	...
	//   37   57:new             #65  <Class ArrayIndexOutOfBoundsException>
	//   38   60:dup             
	//   39   61:invokespecial   #66  <Method void ArrayIndexOutOfBoundsException()>
	//   40   64:athrow          
		}
	}
...
label2:
	...
	//   51  122:aload_2         
	//   52  123:iconst_1        
	//   53  124:putfield        #145 <Field boolean PathParser$ExtractFloatResult.mEndWithNegOrDot>
								break label2;
	//   54  127:goto            140
							}
							break;
	...
	//   73  162:aload_2         
	//   74  163:iload           4
	//   75  165:putfield        #149 <Field int PathParser$ExtractFloatResult.mEndPosition>
	//   76  168:return          
	}
