	...
	implements onImpl
{
	...
	public void printBitmap(String s, Bitmap bitmap, lback lback)
	{
	//    0    0:return          
	}

	public void printBitmap(String s, Uri uri, lback lback)
	{
	//    0    0:return          
	}
	...
	PrintHelper$PrintHelperStub(PrintHelper._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #26  <Method void PrintHelper$PrintHelperStub()>
	//    2    4:return          
	}
}
