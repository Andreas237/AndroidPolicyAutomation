...
public class AccessibilityWindowInfoCompat
{
	...
	//   94  168:istore_1        
		if(getChildCount() > 0)
	//*  95  169:aload_0         
	//*  96  170:invokevirtual   #173 <Method int getChildCount()>
	//*  97  173:ifle            178
			flag = true;
	//   98  176:iconst_1        
	//   99  177:istore_1        
	...
	//  100  178:aload_3         
	//  101  179:iload_1         
	//  102  180:invokevirtual   #163 <Method StringBuilder StringBuilder.append(boolean)>
	//  103  183:pop             
		stringbuilder.append(']');
	//  104  184:aload_3         
	//  105  185:bipush          93
	//  106  187:invokevirtual   #176 <Method StringBuilder StringBuilder.append(char)>
	//  107  190:pop             
		return stringbuilder.toString();
	//  108  191:aload_3         
	//  109  192:invokevirtual   #178 <Method String StringBuilder.toString()>
	//  110  195:areturn         
	}
