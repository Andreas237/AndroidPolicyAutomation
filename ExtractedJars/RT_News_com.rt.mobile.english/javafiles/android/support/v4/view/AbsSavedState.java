	...
	implements Parcelable
{
	...
	//    1    1:aload_1         
	//    2    2:aconst_null     
	//    3    3:invokespecial   #36  <Method void AbsSavedState(Parcel, ClassLoader)>
	//    4    6:return          
	}
	...
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #44  <Method Parcelable Parcel.readParcelable(ClassLoader)>
	//    5    9:astore_1        
		if(parcel == null)
	//*   6   10:aload_1         
	//*   7   11:ifnull          17
	...
	//    4    8:new             #47  <Class IllegalArgumentException>
	//    5   11:dup             
	//    6   12:ldc1            #49  <String "superState must not be null">
	//    7   14:invokespecial   #52  <Method void IllegalArgumentException(String)>
	//    8   17:athrow          
	...
	//   15   30:aload_0         
	//   16   31:aload_1         
	//   17   32:putfield        #31  <Field Parcelable mSuperState>
	//   18   35:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:invokevirtual   #65  <Method void Parcel.writeParcelable(Parcelable, int)>
	//    5    9:return          
	}
