...
public class MediaButtonReceiver extends BroadcastReceiver
{
	...
	//   46   92:aload_2         
	//   47   93:ldc1            #154 <String "Expected 1 service that handles ">
	...
	//   54  105:aload_2         
	//   55  106:ldc1            #156 <String ", found ">
	//   56  108:invokevirtual   #50  <Method StringBuilder StringBuilder.append(String)>
	//   57  111:pop             
			stringbuilder.append(((List) (context)).size());
	//   58  112:aload_2         
	//   59  113:aload_0         
	//   60  114:invokeinterface #110 <Method int List.size()>
	//   61  119:invokevirtual   #159 <Method StringBuilder StringBuilder.append(int)>
	//   62  122:pop             
			throw new IllegalStateException(stringbuilder.toString());
	//   63  123:new             #161 <Class IllegalStateException>
	//   64  126:dup             
	//   65  127:aload_2         
	//   66  128:invokevirtual   #57  <Method String StringBuilder.toString()>
	//   67  131:invokespecial   #162 <Method void IllegalStateException(String)>
	//   68  134:athrow          
		}
	}
	...
	//   16   35:invokevirtual   #181 <Method android.os.Parcelable Intent.getParcelableExtra(String)>
	//   17   38:checkcast       #72  <Class KeyEvent>
	//   18   41:astore_1        
			mediasessioncompat.getController().dispatchMediaButtonEvent(((KeyEvent) (intent)));
	//   19   42:aload_0         
	//   20   43:invokevirtual   #187 <Method MediaControllerCompat MediaSessionCompat.getController()>
	//   21   46:aload_1         
	//   22   47:invokevirtual   #193 <Method boolean MediaControllerCompat.dispatchMediaButtonEvent(KeyEvent)>
	//   23   50:pop             
	...
	//   14   31:invokestatic    #210 <Method ComponentName getServiceComponentByAction(Context, String)>
	//   15   34:astore_3        
			if(componentname != null)
	//*  16   35:aload_3         
	//*  17   36:ifnull          51
	...
	//   22   45:aload_1         
	//   23   46:aload_2         
	//   24   47:invokestatic    #212 <Method void startForegroundService(Context, Intent)>
				return;
	//   25   50:return          
			}
			componentname = getServiceComponentByAction(context, "android.media.browse.MediaBrowserService");
	//   26   51:aload_1         
	//   27   52:ldc1            #214 <String "android.media.browse.MediaBrowserService">
	//   28   54:invokestatic    #210 <Method ComponentName getServiceComponentByAction(Context, String)>
	//   29   57:astore_3        
			if(componentname != null)
	//*  30   58:aload_3         
	//*  31   59:ifnull          107
	...
	//   32   62:aload_0         
	//   33   63:invokevirtual   #218 <Method android.content.BroadcastReceiver$PendingResult goAsync()>
	//   34   66:astore          4
				context = context.getApplicationContext();
	//   35   68:aload_1         
	//   36   69:invokevirtual   #222 <Method Context Context.getApplicationContext()>
	//   37   72:astore_1        
	...
	//   41   78:aload_2         
	//   42   79:aload           4
	//   43   81:invokespecial   #225 <Method void MediaButtonReceiver$MediaButtonConnectionCallback(Context, Intent, android.content.BroadcastReceiver$PendingResult)>
	//   44   84:astore_2        
	...
	//   45   85:new             #227 <Class MediaBrowserCompat>
	//   46   88:dup             
	//   47   89:aload_1         
	//   48   90:aload_3         
	//   49   91:aload_2         
	//   50   92:aconst_null     
	//   51   93:invokespecial   #230 <Method void MediaBrowserCompat(Context, ComponentName, android.support.v4.media.MediaBrowserCompat$ConnectionCallback, android.os.Bundle)>
	//   52   96:astore_1        
				((MediaButtonConnectionCallback) (intent)).setMediaBrowser(((MediaBrowserCompat) (context)));
	//   53   97:aload_2         
	//   54   98:aload_1         
	//   55   99:invokevirtual   #234 <Method void MediaButtonReceiver$MediaButtonConnectionCallback.setMediaBrowser(MediaBrowserCompat)>
				((MediaBrowserCompat) (context)).connect();
	//   56  102:aload_1         
	//   57  103:invokevirtual   #237 <Method void MediaBrowserCompat.connect()>
				return;
	//   58  106:return          
			} else
			{
				throw new IllegalStateException("Could not find any Service that handles android.intent.action.MEDIA_BUTTON or implements a media browser service.");
	//   59  107:new             #161 <Class IllegalStateException>
	//   60  110:dup             
	//   61  111:ldc1            #239 <String "Could not find any Service that handles android.intent.action.MEDIA_BUTTON or implements a media browser service.">
	//   62  113:invokespecial   #162 <Method void IllegalStateException(String)>
	//   63  116:athrow          
			}
		} else
		{
	...
	//   68  125:aload_1         
	//   69  126:ldc1            #241 <String "Ignore unsupported intent: ">
	//   70  128:invokevirtual   #50  <Method StringBuilder StringBuilder.append(String)>
	//   71  131:pop             
			((StringBuilder) (context)).append(((Object) (intent)));
	//   72  132:aload_1         
	//   73  133:aload_2         
	//   74  134:invokevirtual   #244 <Method StringBuilder StringBuilder.append(Object)>
	//   75  137:pop             
	...
	//   79  144:invokestatic    #247 <Method int Log.d(String, String)>
	//   80  147:pop             
			return;
	//   81  148:return          
		}
