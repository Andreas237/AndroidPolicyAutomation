...
label1:
	...
	//    2    2:aload_0         
	//    3    3:ifnull          197
	//    4    6:getstatic       #136 <Field int android.os.Build$VERSION.SDK_INT>
	//    5    9:bipush          21
	//    6   11:icmplt          197
				builder = new Builder();
	//    7   14:new             #10  <Class MediaDescriptionCompat$Builder>
	//    8   17:dup             
	//    9   18:invokespecial   #137 <Method void MediaDescriptionCompat$Builder()>
	//   10   21:astore          4
				builder.setMediaId(MediaDescriptionCompatApi21.getMediaId(obj));
	//   11   23:aload           4
	//   12   25:aload_0         
	//   13   26:invokestatic    #143 <Method String MediaDescriptionCompatApi21.getMediaId(Object)>
	//   14   29:invokevirtual   #147 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setMediaId(String)>
	//   15   32:pop             
				builder.setTitle(MediaDescriptionCompatApi21.getTitle(obj));
	//   16   33:aload           4
	//   17   35:aload_0         
	//   18   36:invokestatic    #151 <Method CharSequence MediaDescriptionCompatApi21.getTitle(Object)>
	//   19   39:invokevirtual   #155 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setTitle(CharSequence)>
	//   20   42:pop             
				builder.setSubtitle(MediaDescriptionCompatApi21.getSubtitle(obj));
	//   21   43:aload           4
	//   22   45:aload_0         
	//   23   46:invokestatic    #158 <Method CharSequence MediaDescriptionCompatApi21.getSubtitle(Object)>
	//   24   49:invokevirtual   #161 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setSubtitle(CharSequence)>
	//   25   52:pop             
				builder.setDescription(MediaDescriptionCompatApi21.getDescription(obj));
	//   26   53:aload           4
	//   27   55:aload_0         
	//   28   56:invokestatic    #164 <Method CharSequence MediaDescriptionCompatApi21.getDescription(Object)>
	//   29   59:invokevirtual   #167 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setDescription(CharSequence)>
	//   30   62:pop             
				builder.setIconBitmap(MediaDescriptionCompatApi21.getIconBitmap(obj));
	//   31   63:aload           4
	//   32   65:aload_0         
	//   33   66:invokestatic    #171 <Method Bitmap MediaDescriptionCompatApi21.getIconBitmap(Object)>
	//   34   69:invokevirtual   #175 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setIconBitmap(Bitmap)>
	//   35   72:pop             
				builder.setIconUri(MediaDescriptionCompatApi21.getIconUri(obj));
	//   36   73:aload           4
	//   37   75:aload_0         
	//   38   76:invokestatic    #179 <Method Uri MediaDescriptionCompatApi21.getIconUri(Object)>
	//   39   79:invokevirtual   #183 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setIconUri(Uri)>
	//   40   82:pop             
				Bundle bundle1 = MediaDescriptionCompatApi21.getExtras(obj);
	//   41   83:aload_0         
	//   42   84:invokestatic    #187 <Method Bundle MediaDescriptionCompatApi21.getExtras(Object)>
	//   43   87:astore_3        
				if(bundle1 == null)
	//*  44   88:aload_3         
	//*  45   89:ifnonnull       97
	...
	//   51  100:invokevirtual   #193 <Method Parcelable Bundle.getParcelable(String)>
	//   52  103:checkcast       #117 <Class Uri>
	//   53  106:astore_1        
				if(obj1 != null)
	//*  54  107:aload_1         
	//*  55  108:ifnull          143
	...
	//*  56  111:aload_3         
	//*  57  112:ldc1            #47  <String "android.support.v4.media.description.NULL_BUNDLE_FLAG">
	//*  58  114:invokevirtual   #197 <Method boolean Bundle.containsKey(String)>
	//*  59  117:ifeq            131
	//*  60  120:aload_3         
	//*  61  121:invokevirtual   #201 <Method int Bundle.size()>
	//*  62  124:iconst_2        
	//*  63  125:icmpne          131
						break label1;
	//   64  128:goto            145
	...
	//   65  131:aload_3         
	//   66  132:ldc1            #40  <String "android.support.v4.media.description.MEDIA_URI">
	//   67  134:invokevirtual   #205 <Method void Bundle.remove(String)>
					bundle1.remove("android.support.v4.media.description.NULL_BUNDLE_FLAG");
	//   68  137:aload_3         
	//   69  138:ldc1            #47  <String "android.support.v4.media.description.NULL_BUNDLE_FLAG">
	//   70  140:invokevirtual   #205 <Method void Bundle.remove(String)>
				}
				bundle = bundle1;
	//   71  143:aload_3         
	//   72  144:astore_2        
	...
	//   73  145:aload           4
	//   74  147:aload_2         
	//   75  148:invokevirtual   #209 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setExtras(Bundle)>
	//   76  151:pop             
			if(obj1 != null)
	//*  77  152:aload_1         
	//*  78  153:ifnull          166
	...
	//   79  156:aload           4
	//   80  158:aload_1         
	//   81  159:invokevirtual   #212 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setMediaUri(Uri)>
	//   82  162:pop             
			else
	//*  83  163:goto            184
			if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  84  166:getstatic       #136 <Field int android.os.Build$VERSION.SDK_INT>
	//*  85  169:bipush          23
	//*  86  171:icmplt          184
				builder.setMediaUri(MediaDescriptionCompatApi23.getMediaUri(obj));
	//   87  174:aload           4
	//   88  176:aload_0         
	//   89  177:invokestatic    #217 <Method Uri MediaDescriptionCompatApi23.getMediaUri(Object)>
	//   90  180:invokevirtual   #212 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setMediaUri(Uri)>
	//   91  183:pop             
			obj1 = ((Object) (builder.build()));
	//   92  184:aload           4
	//   93  186:invokevirtual   #221 <Method MediaDescriptionCompat MediaDescriptionCompat$Builder.build()>
	//   94  189:astore_1        
			obj1.mDescriptionObj = obj;
	//   95  190:aload_1         
	//   96  191:aload_0         
	//   97  192:putfield        #223 <Field Object mDescriptionObj>
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #223 <Field Object mDescriptionObj>
	//*   2    4:ifnonnull       159
	...
	//    7   18:invokestatic    #236 <Method Object MediaDescriptionCompatApi21$Builder.newInstance()>
	//    8   21:astore_3        
			MediaDescriptionCompatApi21.Builder.setMediaId(obj, mMediaId);
	//    9   22:aload_3         
	//   10   23:aload_0         
	//   11   24:getfield        #88  <Field String mMediaId>
	//   12   27:invokestatic    #239 <Method void MediaDescriptionCompatApi21$Builder.setMediaId(Object, String)>
			MediaDescriptionCompatApi21.Builder.setTitle(obj, mTitle);
	//   13   30:aload_3         
	//   14   31:aload_0         
	//   15   32:getfield        #103 <Field CharSequence mTitle>
	//   16   35:invokestatic    #242 <Method void MediaDescriptionCompatApi21$Builder.setTitle(Object, CharSequence)>
			MediaDescriptionCompatApi21.Builder.setSubtitle(obj, mSubtitle);
	//   17   38:aload_3         
	//   18   39:aload_0         
	//   19   40:getfield        #105 <Field CharSequence mSubtitle>
	//   20   43:invokestatic    #244 <Method void MediaDescriptionCompatApi21$Builder.setSubtitle(Object, CharSequence)>
			MediaDescriptionCompatApi21.Builder.setDescription(obj, mDescription);
	//   21   46:aload_3         
	//   22   47:aload_0         
	//   23   48:getfield        #107 <Field CharSequence mDescription>
	//   24   51:invokestatic    #246 <Method void MediaDescriptionCompatApi21$Builder.setDescription(Object, CharSequence)>
			MediaDescriptionCompatApi21.Builder.setIconBitmap(obj, mIcon);
	//   25   54:aload_3         
	//   26   55:aload_0         
	//   27   56:getfield        #115 <Field Bitmap mIcon>
	//   28   59:invokestatic    #249 <Method void MediaDescriptionCompatApi21$Builder.setIconBitmap(Object, Bitmap)>
			MediaDescriptionCompatApi21.Builder.setIconUri(obj, mIconUri);
	//   29   62:aload_3         
	//   30   63:aload_0         
	//   31   64:getfield        #119 <Field Uri mIconUri>
	//   32   67:invokestatic    #252 <Method void MediaDescriptionCompatApi21$Builder.setIconUri(Object, Uri)>
			Bundle bundle1 = mExtras;
	//   33   70:aload_0         
	//   34   71:getfield        #125 <Field Bundle mExtras>
	//   35   74:astore_2        
			Bundle bundle = bundle1;
	//   36   75:aload_2         
	//   37   76:astore_1        
			if(android.os.Build.VERSION.SDK_INT < 23)
	//*  38   77:getstatic       #136 <Field int android.os.Build$VERSION.SDK_INT>
	//*  39   80:bipush          23
	//*  40   82:icmpge          125
			{
				bundle = bundle1;
	...
	//   42   86:astore_1        
				if(mMediaUri != null)
	//*  43   87:aload_0         
	//*  44   88:getfield        #127 <Field Uri mMediaUri>
	//*  45   91:ifnull          125
				{
					bundle = bundle1;
	//   46   94:aload_2         
	...
	//*  49   97:ifnonnull       115
					{
						bundle = new Bundle();
	//   50  100:new             #189 <Class Bundle>
	//   51  103:dup             
	//   52  104:invokespecial   #253 <Method void Bundle()>
	//   53  107:astore_1        
						bundle.putBoolean("android.support.v4.media.description.NULL_BUNDLE_FLAG", true);
	//   54  108:aload_1         
	//   55  109:ldc1            #47  <String "android.support.v4.media.description.NULL_BUNDLE_FLAG">
	//   56  111:iconst_1        
	//   57  112:invokevirtual   #257 <Method void Bundle.putBoolean(String, boolean)>
					}
	...
	//   60  118:aload_0         
	//   61  119:getfield        #127 <Field Uri mMediaUri>
	//   62  122:invokevirtual   #261 <Method void Bundle.putParcelable(String, Parcelable)>
				}
			}
			MediaDescriptionCompatApi21.Builder.setExtras(obj, bundle);
	//   63  125:aload_3         
	//   64  126:aload_1         
	//   65  127:invokestatic    #264 <Method void MediaDescriptionCompatApi21$Builder.setExtras(Object, Bundle)>
			if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  66  130:getstatic       #136 <Field int android.os.Build$VERSION.SDK_INT>
	//*  67  133:bipush          23
	//*  68  135:icmplt          146
				MediaDescriptionCompatApi23.Builder.setMediaUri(obj, mMediaUri);
	//   69  138:aload_3         
	//   70  139:aload_0         
	//   71  140:getfield        #127 <Field Uri mMediaUri>
	//   72  143:invokestatic    #268 <Method void MediaDescriptionCompatApi23$Builder.setMediaUri(Object, Uri)>
			mDescriptionObj = MediaDescriptionCompatApi21.Builder.build(obj);
	//   73  146:aload_0         
	//   74  147:aload_3         
	//   75  148:invokestatic    #271 <Method Object MediaDescriptionCompatApi21$Builder.build(Object)>
	//   76  151:putfield        #223 <Field Object mDescriptionObj>
			return mDescriptionObj;
	//   77  154:aload_0         
	//   78  155:getfield        #223 <Field Object mDescriptionObj>
	//   79  158:areturn         
		} else
		{
			return mDescriptionObj;
	//   80  159:aload_0         
	//   81  160:getfield        #223 <Field Object mDescriptionObj>
	//   82  163:areturn         
		}
	}
	...
	//    7   13:invokevirtual   #279 <Method StringBuilder StringBuilder.append(Object)>
	//    8   16:pop             
		stringbuilder.append(", ");
	//    9   17:aload_1         
	//   10   18:ldc2            #281 <String ", ">
	...
	//   16   30:invokevirtual   #279 <Method StringBuilder StringBuilder.append(Object)>
	//   17   33:pop             
		stringbuilder.append(", ");
	//   18   34:aload_1         
	//   19   35:ldc2            #281 <String ", ">
	...
	//   25   47:invokevirtual   #279 <Method StringBuilder StringBuilder.append(Object)>
	//   26   50:pop             
		return stringbuilder.toString();
	//   27   51:aload_1         
	//   28   52:invokevirtual   #286 <Method String StringBuilder.toString()>
	//   29   55:areturn         
	}
