	...
	implements Pools.Pool
{
	...
	//*   2    4:ifle            40
		{
			int i = mPoolSize - 1;
	//    3    7:aload_0         
	//    4    8:getfield        #34  <Field int mPoolSize>
	//    5   11:iconst_1        
	//    6   12:isub            
	//    7   13:istore_1        
			Object obj = mPool[i];
	...
	//   18   28:aload_0         
	//   19   29:aload_0         
	//   20   30:getfield        #34  <Field int mPoolSize>
	//   21   33:iconst_1        
	//   22   34:isub            
	//   23   35:putfield        #34  <Field int mPoolSize>
			return obj;
	//   24   38:aload_2         
	//   25   39:areturn         
		} else
	...
	//    4    8:new             #45  <Class IllegalStateException>
	//    5   11:dup             
	//    6   12:ldc1            #47  <String "Already in the pool!">
	//    7   14:invokespecial   #48  <Method void IllegalStateException(String)>
	//    8   17:athrow          
		if(mPoolSize < mPool.length)
	//*   9   18:aload_0         
	//*  10   19:getfield        #34  <Field int mPoolSize>
	//*  11   22:aload_0         
	...
	//   17   34:aload_0         
	//   18   35:getfield        #34  <Field int mPoolSize>
	//   19   38:aload_1         
	//   20   39:aastore         
			mPoolSize = mPoolSize + 1;
	//   21   40:aload_0         
	//   22   41:aload_0         
	//   23   42:getfield        #34  <Field int mPoolSize>
	//   24   45:iconst_1        
	//   25   46:iadd            
	//   26   47:putfield        #34  <Field int mPoolSize>
			return true;
	//   27   50:iconst_1        
	//   28   51:ireturn         
		} else
