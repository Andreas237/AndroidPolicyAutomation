	...
	implements Cloneable
{
	...
	//  119  225:iadd            
	//  120  226:istore          5
			System.arraycopy(((Object) (al1)), i, ((Object) (al2)), i1, mSize - i);
	//  121  228:aload           6
	//  122  230:iload           4
	//  123  232:aload           7
	//  124  234:iload           5
	//  125  236:aload_0         
	//  126  237:getfield        #48  <Field int mSize>
	//  127  240:iload           4
	//  128  242:isub            
	//  129  243:invokestatic    #62  <Method void System.arraycopy(Object, int, Object, int, int)>
			System.arraycopy(((Object) (mValues)), i, ((Object) (mValues)), i1, mSize - i);
	//  130  246:aload_0         
	//  131  247:getfield        #42  <Field Object[] mValues>
	//  132  250:iload           4
	//  133  252:aload_0         
	//  134  253:getfield        #42  <Field Object[] mValues>
	//  135  256:iload           5
	//  136  258:aload_0         
	//  137  259:getfield        #48  <Field int mSize>
	//  138  262:iload           4
	//  139  264:isub            
	//  140  265:invokestatic    #62  <Method void System.arraycopy(Object, int, Object, int, int)>
		}
		mKeys[i] = l;
	//  141  268:aload_0         
	//  142  269:getfield        #37  <Field long[] mKeys>
	//  143  272:iload           4
	//  144  274:lload_1         
	//  145  275:lastore         
		mValues[i] = obj;
	//  146  276:aload_0         
	//  147  277:getfield        #42  <Field Object[] mValues>
	//  148  280:iload           4
	//  149  282:aload_3         
	//  150  283:aastore         
		mSize = mSize + 1;
	//  151  284:aload_0         
	//  152  285:aload_0         
	//  153  286:getfield        #48  <Field int mSize>
	//  154  289:iconst_1        
	//  155  290:iadd            
	//  156  291:putfield        #48  <Field int mSize>
	//  157  294:return          
	}
