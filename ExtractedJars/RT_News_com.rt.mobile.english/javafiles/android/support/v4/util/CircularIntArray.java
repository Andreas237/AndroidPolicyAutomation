...
public final class CircularIntArray
{
	...
	//*  20   37:iload_1         
	//*  21   38:invokestatic    #34  <Method int Integer.bitCount(int)>
	//*  22   41:iconst_1        
	//*  23   42:icmpeq          54
	...
	//   25   46:iconst_1        
	//   26   47:isub            
	//   27   48:invokestatic    #37  <Method int Integer.highestOneBit(int)>
	//   28   51:iconst_1        
	//   29   52:ishl            
	//   30   53:istore_2        
	...
	//   33   56:iconst_1        
	//   34   57:isub            
	//   35   58:putfield        #39  <Field int mCapacityBitmask>
		mElements = new int[j];
	//   36   61:aload_0         
	//   37   62:iload_2         
	//   38   63:newarray        int[]
	//   39   65:putfield        #41  <Field int[] mElements>
	//   40   68:return          
	}
	...
	//*   6   12:goto            36
		{
			int ai[] = mElements;
	//    7   15:aload_0         
	//    8   16:getfield        #41  <Field int[] mElements>
	//    9   19:astore_3        
			int j = mHead;
	//   10   20:aload_0         
	//   11   21:getfield        #44  <Field int mHead>
	//   12   24:istore_2        
			return ai[mCapacityBitmask & j + i];
	//   13   25:aload_3         
	//   14   26:aload_0         
	//   15   27:getfield        #39  <Field int mCapacityBitmask>
	//   16   30:iload_2         
	//   17   31:iload_1         
	//   18   32:iadd            
	//   19   33:iand            
	...
	//   22   36:new             #69  <Class ArrayIndexOutOfBoundsException>
	//   23   39:dup             
	//   24   40:invokespecial   #70  <Method void ArrayIndexOutOfBoundsException()>
	//   25   43:athrow          
		}
	}
	...
	//   10   20:athrow          
		} else
		{
			int j = mTail;
	//   11   21:aload_0         
	//   12   22:getfield        #57  <Field int mTail>
	//   13   25:istore_2        
			mTail = mCapacityBitmask & j - i;
	//   14   26:aload_0         
	//   15   27:aload_0         
	//   16   28:getfield        #39  <Field int mCapacityBitmask>
	//   17   31:iload_2         
	//   18   32:iload_1         
	//   19   33:isub            
	//   20   34:iand            
	//   21   35:putfield        #57  <Field int mTail>
			return;
	//   22   38:return          
		}
	}
	...
	//   10   20:athrow          
		} else
		{
			int j = mHead;
	//   11   21:aload_0         
	//   12   22:getfield        #44  <Field int mHead>
	//   13   25:istore_2        
	...
	//   19   33:iadd            
	//   20   34:iand            
	//   21   35:putfield        #44  <Field int mHead>
			return;
	//   22   38:return          
		}
	}
