	...
	implements Cloneable
{
	...
	//   27   49:invokespecial   #56  <Method void gc()>
		int j = mSize;
	//   28   52:aload_0         
	//   29   53:getfield        #48  <Field int mSize>
	//   30   56:istore_3        
		if(j >= mKeys.length)
	//*  31   57:iload_3         
	//*  32   58:aload_0         
	...
	//   37   67:iconst_1        
	//   38   68:iadd            
	//   39   69:invokestatic    #46  <Method int ContainerHelpers.idealIntArraySize(int)>
	//   40   72:istore          4
			int ai[] = new int[k];
	//   41   74:iload           4
	//   42   76:newarray        int[]
	...
	//   83  147:iconst_1        
	//   84  148:iadd            
	//   85  149:putfield        #48  <Field int mSize>
	//   86  152:return          
	}
	...
	//*  19   30:iload           4
	//*  20   32:aload_0         
	//*  21   33:getfield        #48  <Field int mSize>
	//*  22   36:icmpge          69
	//*  23   39:aload_0         
	...
	//*  47   82:aload_0         
	//*  48   83:getfield        #48  <Field int mSize>
	//*  49   86:aload_0         
	...
	//   57  102:aload_0         
	//   58  103:getfield        #48  <Field int mSize>
	//   59  106:iload_1         
	...
	//   63  112:istore_3        
		...
		if(mSize >= mKeys.length)
	//*  64  113:aload_0         
	//*  65  114:getfield        #48  <Field int mSize>
	//*  66  117:aload_0         
	...
	//   70  125:aload_0         
	//   71  126:getfield        #48  <Field int mSize>
	//   72  129:iconst_1        
	//   73  130:iadd            
	//   74  131:invokestatic    #46  <Method int ContainerHelpers.idealIntArraySize(int)>
	//   75  134:istore          4
			int ai[] = new int[l];
	//   76  136:iload           4
	//   77  138:newarray        int[]
	...
	//  105  190:putfield        #42  <Field Object[] mValues>
		...
		if(mSize - j != 0)
	//* 106  193:aload_0         
	//* 107  194:getfield        #48  <Field int mSize>
	//* 108  197:iload_3         
	//* 109  198:isub            
	//* 110  199:ifeq            255
		{
	...
	//  113  206:astore          5
			int ai2[] = mKeys;
	//  114  208:aload_0         
	//  115  209:getfield        #37  <Field int[] mKeys>
	//  116  212:astore          6
			int i1 = j + 1;
	//  117  214:iload_3         
	//  118  215:iconst_1        
	...
	//  124  224:iload           4
	//  125  226:aload_0         
	//  126  227:getfield        #48  <Field int mSize>
	//  127  230:iload_3         
	//  128  231:isub            
	//  129  232:invokestatic    #62  <Method void System.arraycopy(Object, int, Object, int, int)>
			System.arraycopy(((Object) (mValues)), j, ((Object) (mValues)), i1, mSize - j);
	//  130  235:aload_0         
	//  131  236:getfield        #42  <Field Object[] mValues>
	//  132  239:iload_3         
	//  133  240:aload_0         
	//  134  241:getfield        #42  <Field Object[] mValues>
	//  135  244:iload           4
	//  136  246:aload_0         
	//  137  247:getfield        #48  <Field int mSize>
	//  138  250:iload_3         
	//  139  251:isub            
	//  140  252:invokestatic    #62  <Method void System.arraycopy(Object, int, Object, int, int)>
		}
		mKeys[j] = i;
	//  141  255:aload_0         
	//  142  256:getfield        #37  <Field int[] mKeys>
	//  143  259:iload_3         
	//  144  260:iload_1         
	//  145  261:iastore         
		mValues[j] = obj;
	//  146  262:aload_0         
	//  147  263:getfield        #42  <Field Object[] mValues>
	//  148  266:iload_3         
	//  149  267:aload_2         
	//  150  268:aastore         
		mSize = mSize + 1;
	//  151  269:aload_0         
	//  152  270:aload_0         
	//  153  271:getfield        #48  <Field int mSize>
	//  154  274:iconst_1        
	//  155  275:iadd            
	//  156  276:putfield        #48  <Field int mSize>
	//  157  279:return          
	}
	...
	//   51   90:aload_2         
	//   52   91:ldc1            #144 <String "(this Map)">
	//   53   93:invokevirtual   #131 <Method StringBuilder StringBuilder.append(String)>
	//   54   96:pop             
		}
