...
public class ShortcutManagerCompat
{
	...
	//*   1    3:bipush          26
	//*   2    5:icmplt          28
			context = ((Context) (((ShortcutManager)context.getSystemService(android/content/pm/ShortcutManager)).createShortcutResultIntent(shortcutinfocompat.toShortcutInfo())));
	//    3    8:aload_0         
	...
	//    9   21:invokevirtual   #45  <Method Intent ShortcutManager.createShortcutResultIntent(android.content.pm.ShortcutInfo)>
	//   10   24:astore_0        
		else
	//*  11   25:goto            30
			context = null;
	...
	//   19   39:dup             
	//   20   40:invokespecial   #48  <Method void Intent()>
	//   21   43:astore_2        
		return shortcutinfocompat.addToIntent(((Intent) (obj)));
	//   22   44:aload_1         
	//   23   45:aload_2         
	//   24   46:invokevirtual   #52  <Method Intent ShortcutInfoCompat.addToIntent(Intent)>
	//   25   49:areturn         
	}
