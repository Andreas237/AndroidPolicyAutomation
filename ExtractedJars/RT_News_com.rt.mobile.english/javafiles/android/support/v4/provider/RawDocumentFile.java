...
class RawDocumentFile extends DocumentFile
{
	...
	//*  23   31:aload           5
	//*  24   33:invokevirtual   #26  <Method boolean File.isDirectory()>
	//*  25   36:ifeq            48
					flag1 = flag & deleteContents(file1);
	//   26   39:iload_3         
	//   27   40:aload           5
	//   28   42:invokestatic    #28  <Method boolean deleteContents(File)>
	//   29   45:iand            
	//   30   46:istore          4
				flag = flag1;
	//   31   48:iload           4
	//   32   50:istore_3        
				if(!file1.delete())
	//*  33   51:aload           5
	//*  34   53:invokevirtual   #31  <Method boolean File.delete()>
	//*  35   56:ifne            97
				{
					StringBuilder stringbuilder = new StringBuilder();
	//   36   59:new             #33  <Class StringBuilder>
	//   37   62:dup             
	//   38   63:invokespecial   #36  <Method void StringBuilder()>
	//   39   66:astore          6
					stringbuilder.append("Failed to delete ");
	//   40   68:aload           6
	//   41   70:ldc1            #38  <String "Failed to delete ">
	//   42   72:invokevirtual   #42  <Method StringBuilder StringBuilder.append(String)>
	//   43   75:pop             
					stringbuilder.append(((Object) (file1)));
	//   44   76:aload           6
	//   45   78:aload           5
	//   46   80:invokevirtual   #45  <Method StringBuilder StringBuilder.append(Object)>
	//   47   83:pop             
					Log.w("DocumentFile", stringbuilder.toString());
	//   48   84:ldc1            #47  <String "DocumentFile">
	//   49   86:aload           6
	//   50   88:invokevirtual   #51  <Method String StringBuilder.toString()>
	//   51   91:invokestatic    #57  <Method int Log.w(String, String)>
	//   52   94:pop             
					flag = false;
	//   53   95:iconst_0        
	//   54   96:istore_3        
	...
	//   18   36:aload_0         
	//   19   37:aload_1         
	//   20   38:invokespecial   #99  <Method void RawDocumentFile(DocumentFile, File)>
	//   21   41:areturn         
	}
	...
	//    9   17:dup             
	//   10   18:invokespecial   #36  <Method void StringBuilder()>
	//   11   21:astore_1        
			((StringBuilder) (s)).append(s1);
	//   12   22:aload_1         
	//   13   23:aload_2         
	//   14   24:invokevirtual   #42  <Method StringBuilder StringBuilder.append(String)>
	//   15   27:pop             
			((StringBuilder) (s)).append(".");
	//   16   28:aload_1         
	//   17   29:ldc1            #108 <String ".">
	//   18   31:invokevirtual   #42  <Method StringBuilder StringBuilder.append(String)>
	//   19   34:pop             
			((StringBuilder) (s)).append(s2);
	//   20   35:aload_1         
	//   21   36:aload_3         
	//   22   37:invokevirtual   #42  <Method StringBuilder StringBuilder.append(String)>
	//   23   40:pop             
			s = ((StringBuilder) (s)).toString();
	//   24   41:aload_1         
	//   25   42:invokevirtual   #51  <Method String StringBuilder.toString()>
	//   26   45:astore_1        
		}
		s = ((String) (new File(mFile, s)));
	//   27   46:new             #18  <Class File>
	//   28   49:dup             
	//   29   50:aload_0         
	//   30   51:getfield        #13  <Field File mFile>
	//   31   54:aload_1         
	//   32   55:invokespecial   #94  <Method void File(File, String)>
	//   33   58:astore_1        
		try
		{
			((File) (s)).createNewFile();
	//   34   59:aload_1         
	//   35   60:invokevirtual   #111 <Method boolean File.createNewFile()>
	//   36   63:pop             
	...
	//   39   68:aload_0         
	//   40   69:aload_1         
	//   41   70:invokespecial   #99  <Method void RawDocumentFile(DocumentFile, File)>
	//   42   73:astore_1        
		}
	//*  43   74:aload_1         
	//*  44   75:areturn         
	...
	//   46   77:new             #33  <Class StringBuilder>
	//   47   80:dup             
	//   48   81:invokespecial   #36  <Method void StringBuilder()>
	//   49   84:astore_2        
			((StringBuilder) (s1)).append("Failed to createFile: ");
	//   50   85:aload_2         
	//   51   86:ldc1            #113 <String "Failed to createFile: ">
	//   52   88:invokevirtual   #42  <Method StringBuilder StringBuilder.append(String)>
	//   53   91:pop             
			((StringBuilder) (s1)).append(((Object) (s)));
	//   54   92:aload_2         
	//   55   93:aload_1         
	//   56   94:invokevirtual   #45  <Method StringBuilder StringBuilder.append(Object)>
	//   57   97:pop             
			Log.w("DocumentFile", ((StringBuilder) (s1)).toString());
	//   58   98:ldc1            #47  <String "DocumentFile">
	//   59  100:aload_2         
	//   60  101:invokevirtual   #51  <Method String StringBuilder.toString()>
	//   61  104:invokestatic    #57  <Method int Log.w(String, String)>
	//   62  107:pop             
			return null;
	//   63  108:aconst_null     
	//   64  109:areturn         
