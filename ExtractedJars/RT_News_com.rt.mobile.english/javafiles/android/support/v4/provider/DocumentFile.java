...
//			RawDocumentFile, SingleDocumentFile, TreeDocumentFile, DocumentsContractApi19
...
public abstract class DocumentFile
{
	...
	//    7   14:aload_1         
	//    8   15:aload_1         
	//    9   16:invokestatic    #47  <Method String DocumentsContract.getTreeDocumentId(Uri)>
	//   10   19:invokestatic    #51  <Method Uri DocumentsContract.buildDocumentUriUsingTree(Uri, String)>
	//   11   22:invokespecial   #52  <Method void TreeDocumentFile(DocumentFile, Context, Uri)>
	//   12   25:areturn         
		else
			return null;
	//   13   26:aconst_null     
	...
	//    3    8:aload_0         
	//    4    9:aload_1         
	//    5   10:invokestatic    #58  <Method boolean DocumentsContractApi19.isDocumentUri(Context, Uri)>
	//    6   13:ireturn         
		else
			return false;
	//    7   14:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #72  <Method DocumentFile[] listFiles()>
	//    2    4:astore          4
		int i = 0;
	//    3    6:iconst_0        
	//    4    7:istore_2        
		for(int j = adocumentfile.length; i < j; i++)
	//*   5    8:aload           4
	//*   6   10:arraylength     
	//*   7   11:istore_3        
	//*   8   12:iload_2         
	...
	//*  15   23:aload_1         
	//*  16   24:aload           5
	//*  17   26:invokevirtual   #76  <Method String getName()>
	//*  18   29:invokevirtual   #82  <Method boolean String.equals(Object)>
	//*  19   32:ifeq            38
				return documentfile;
	//   20   35:aload           5
	//   21   37:areturn         
