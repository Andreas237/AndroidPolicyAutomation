		...
		implements Runnable
	{
		...
		//* 137  273:return          
			...
			if(afontinfo != null && afontinfo.length != 0)
			{
				...
				Typeface typeface1 = FontsContractCompat.buildTypeface(context, ((android.os.CancellationSignal) (null)), afontinfo);
				if(typeface1 == null)
				{
				...
				{
					callerThreadHandler.post(((Runnable) (((FontsContractCompat._cls4._cls9) (typeface1)). new FontsContractCompat._cls4._cls9())));
					return;
				}
			} else
			{
