...
public final class EdgeEffectCompat
{
	...
	//    2    4:fload_1         
	//    3    5:fload_2         
	//    4    6:invokevirtual   #44  <Method void EdgeEffectCompat$EdgeEffectBaseImpl.onPull(EdgeEffect, float, float)>
	//    5    9:return          
	}
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #49  <Method boolean EdgeEffect.draw(Canvas)>
	//    4    8:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #38  <Field EdgeEffect mEdgeEffect>
	//    2    4:invokevirtual   #52  <Method void EdgeEffect.finish()>
	//    3    7:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #38  <Field EdgeEffect mEdgeEffect>
	//    2    4:invokevirtual   #56  <Method boolean EdgeEffect.isFinished()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #38  <Field EdgeEffect mEdgeEffect>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #61  <Method void EdgeEffect.onAbsorb(int)>
		return true;
	//    4    8:iconst_1        
	//    5    9:ireturn         
	}
	...
	//    1    1:getfield        #38  <Field EdgeEffect mEdgeEffect>
	//    2    4:fload_1         
	//    3    5:invokevirtual   #65  <Method void EdgeEffect.onPull(float)>
		return true;
	//    4    8:iconst_1        
	//    5    9:ireturn         
	}
	...
	//    3    7:fload_1         
	//    4    8:fload_2         
	//    5    9:invokevirtual   #44  <Method void EdgeEffectCompat$EdgeEffectBaseImpl.onPull(EdgeEffect, float, float)>
		return true;
	//    6   12:iconst_1        
	//    7   13:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #38  <Field EdgeEffect mEdgeEffect>
	//    2    4:invokevirtual   #69  <Method void EdgeEffect.onRelease()>
		return mEdgeEffect.isFinished();
	//    3    7:aload_0         
	//    4    8:getfield        #38  <Field EdgeEffect mEdgeEffect>
	//    5   11:invokevirtual   #56  <Method boolean EdgeEffect.isFinished()>
	//    6   14:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #73  <Method void EdgeEffect.setSize(int, int)>
	//    5    9:return          
	}
