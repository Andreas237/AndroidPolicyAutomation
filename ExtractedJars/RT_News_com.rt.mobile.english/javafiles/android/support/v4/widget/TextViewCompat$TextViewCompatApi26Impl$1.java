	...
	implements android.view.ActionMode.Callback
{
	...
	private void recomputeProcessTextMenuItems(Menu menu)
	{
		...
		Object obj2;
		obj2 = ((Object) (val$textView.getContext()));
	//    0    0:aload_0         
...
_L2:
		...
		for(i = 0; i < ((List) (obj)).size(); i++)
		{
			...
			menu.add(0, 0, 100 + i, ((ResolveInfo) (obj2)).loadLabel(packagemanager)).setIntent(createProcessTextIntentForResolveInfo(((ResolveInfo) (obj2)), val$textView)).setShowAsAction(1);
		}
	...
	{
		return val$callback.onActionItemClicked(actionmode, menuitem);
	//    0    0:aload_0         
	...
	{
		return val$callback.onCreateActionMode(actionmode, menu);
	//    0    0:aload_0         
	//    1    1:getfield        #36  <Field android.view.ActionMode$Callback val$callback>
	//    2    4:aload_1         
	//    3    5:aload_2         
	...
	{
		val$callback.onDestroyActionMode(actionmode);
	//    0    0:aload_0         
	//    1    1:getfield        #36  <Field android.view.ActionMode$Callback val$callback>
	//    2    4:aload_1         
	...
	//    2    2:invokespecial   #280 <Method void recomputeProcessTextMenuItems(Menu)>
		return val$callback.onPrepareActionMode(actionmode, menu);
	//    3    5:aload_0         
	...
	TextViewCompat$TextViewCompatApi26Impl$1()
	{
