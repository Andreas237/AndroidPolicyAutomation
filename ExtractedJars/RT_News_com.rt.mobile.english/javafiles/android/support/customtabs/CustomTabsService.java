...
;
			...
			//*  13   26:invokestatic    #45  <Method Map CustomTabsService.access$000(CustomTabsService)>
			//*  14   29:astore_3        
			//*  15   30:aload_3         
			//*  16   31:monitorenter    
				{
			...
			//   24   50:invokestatic    #45  <Method Map CustomTabsService.access$000(CustomTabsService)>
			//   25   53:aload_1         
	...
	//    5    7:aload_1         
	//    6    8:invokevirtual   #66  <Method IBinder CustomTabsSessionToken.getCallbackBinder()>
	//    7   11:astore_1        
	...
	//   11   17:aload_1         
	//   12   18:invokeinterface #72  <Method Object Map.get(Object)>
	//   13   23:checkcast       #74  <Class android.os.IBinder$DeathRecipient>
	//   14   26:iconst_0        
	//   15   27:invokeinterface #80  <Method boolean IBinder.unlinkToDeath(android.os.IBinder$DeathRecipient, int)>
	//   16   32:pop             
			mDeathRecipientMap.remove(((Object) (customtabssessiontoken)));
	//   17   33:aload_0         
	//   18   34:getfield        #48  <Field Map mDeathRecipientMap>
	//   19   37:aload_1         
	//   20   38:invokeinterface #83  <Method Object Map.remove(Object)>
	//   21   43:pop             
		}
	//   22   44:aload_2         
	//   23   45:monitorexit     
	...
	private final Map mDeathRecipientMap = new ArrayMap();


/*
	static Map access$000(CustomTabsService customtabsservice)
	{
		return customtabsservice.mDeathRecipientMap;
	//    0    0:aload_0         
	//    1    1:getfield        #48  <Field Map mDeathRecipientMap>
	//    2    4:areturn         
	}
