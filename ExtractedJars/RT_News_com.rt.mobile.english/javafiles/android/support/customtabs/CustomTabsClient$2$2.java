...
class CustomTabsClient$2$2
	implements Runnable
{

	public void run()
	{
		val$callback.extraCallback(val$callbackName, val$args);
	//    0    0:aload_0         
...
/* anonymous class */
	class CustomTabsClient._cls2 extends ICustomTabsCallback.Stub
	{
		...
		//    3    7:return          
			...
			{
				mHandler.post(((Runnable) (((CustomTabsClient._cls2._cls2) (bundle)). new CustomTabsClient._cls2._cls2())));
		//    4    8:aload_0         
