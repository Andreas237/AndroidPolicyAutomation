...
public class CustomTabsSessionToken
{
	...
	//    3    7:dup             
	//    4    8:invokespecial   #36  <Method void CustomTabsSessionToken$MockCallback()>
	//    5   11:invokespecial   #38  <Method void CustomTabsSessionToken(ICustomTabsCallback)>
	//    6   14:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #47  <Method Bundle Intent.getExtras()>
	//    2    4:ldc1            #49  <String "android.support.customtabs.extra.SESSION">
	//    3    6:invokestatic    #55  <Method IBinder BundleCompat.getBinder(Bundle, String)>
	//    4    9:astore_0        
		if(intent == null)
	//*   5   10:aload_0         
	//*   6   11:ifnonnull       16
	...
	//   10   19:dup             
	//   11   20:aload_0         
	//   12   21:invokestatic    #61  <Method ICustomTabsCallback ICustomTabsCallback$Stub.asInterface(IBinder)>
	//   13   24:invokespecial   #38  <Method void CustomTabsSessionToken(ICustomTabsCallback)>
	//   14   27:areturn         
	}
	...
	//    7   13:invokevirtual   #67  <Method IBinder getCallbackBinder()>
	//    8   16:aload_0         
	//    9   17:getfield        #24  <Field ICustomTabsCallback mCallbackBinder>
	//   10   20:invokeinterface #72  <Method IBinder ICustomTabsCallback.asBinder()>
	//   11   25:invokevirtual   #74  <Method boolean Object.equals(Object)>
	//   12   28:ireturn         
	}
	...
	//    2    4:invokeinterface #72  <Method IBinder ICustomTabsCallback.asBinder()>
	//    3    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #67  <Method IBinder getCallbackBinder()>
	//    2    4:invokevirtual   #80  <Method int Object.hashCode()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #86  <Method IBinder CustomTabsSession.getBinder()>
	//    2    4:aload_0         
	//    3    5:getfield        #24  <Field ICustomTabsCallback mCallbackBinder>
	//    4    8:invokevirtual   #74  <Method boolean Object.equals(Object)>
	//    5   11:ireturn         
	}
	...
	private final CustomTabsCallback mCallback = new CustomTabsCallback() {
		...
		//    2    4:invokestatic    #26  <Method ICustomTabsCallback CustomTabsSessionToken.access$000(CustomTabsSessionToken)>
		//    3    7:aload_1         
		//    4    8:aload_2         
...
/*
	static ICustomTabsCallback access$000(CustomTabsSessionToken customtabssessiontoken)
	{
		return customtabssessiontoken.mCallbackBinder;
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field ICustomTabsCallback mCallbackBinder>
	//    2    4:areturn         
	}
