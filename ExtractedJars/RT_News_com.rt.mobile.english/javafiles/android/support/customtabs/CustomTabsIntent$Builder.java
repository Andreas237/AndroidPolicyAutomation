...
public static final class CustomTabsIntent$Builder
{
	...
	public CustomTabsIntent$Builder addMenuItem(String s, PendingIntent pendingintent)
	{
		if(mMenuItems == null)
	//*   0    0:aload_0         
	...
	public CustomTabsIntent$Builder addToolbarItem(int i, Bitmap bitmap, String s, PendingIntent pendingintent)
	...
	//   13   29:new             #113 <Class IllegalStateException>
	//   14   32:dup             
	//   15   33:ldc1            #120 <String "Exceeded maximum toolbar item count of 5">
	//   16   35:invokespecial   #121 <Method void IllegalStateException(String)>
	//   17   38:athrow          
		} else
		{
			Bundle bundle = new Bundle();
	//   18   39:new             #61  <Class Bundle>
	//   19   42:dup             
	//   20   43:invokespecial   #62  <Method void Bundle()>
	//   21   46:astore          5
			bundle.putInt("android.support.customtabs.customaction.ID", i);
	//   22   48:aload           5
	//   23   50:ldc1            #123 <String "android.support.customtabs.customaction.ID">
	//   24   52:iload_1         
	//   25   53:invokevirtual   #127 <Method void Bundle.putInt(String, int)>
			bundle.putParcelable("android.support.customtabs.customaction.ICON", ((android.os.Parcelable) (bitmap)));
	//   26   56:aload           5
	//   27   58:ldc1            #129 <String "android.support.customtabs.customaction.ICON">
	//   28   60:aload_2         
	//   29   61:invokevirtual   #105 <Method void Bundle.putParcelable(String, android.os.Parcelable)>
			bundle.putString("android.support.customtabs.customaction.DESCRIPTION", s);
	//   30   64:aload           5
	//   31   66:ldc1            #131 <String "android.support.customtabs.customaction.DESCRIPTION">
	//   32   68:aload_3         
	//   33   69:invokevirtual   #99  <Method void Bundle.putString(String, String)>
			bundle.putParcelable("android.support.customtabs.customaction.PENDING_INTENT", ((android.os.Parcelable) (pendingintent)));
	//   34   72:aload           5
	//   35   74:ldc1            #101 <String "android.support.customtabs.customaction.PENDING_INTENT">
	//   36   76:aload           4
	//   37   78:invokevirtual   #105 <Method void Bundle.putParcelable(String, android.os.Parcelable)>
			mActionButtons.add(((Object) (bundle)));
	//   38   81:aload_0         
	//   39   82:getfield        #41  <Field ArrayList mActionButtons>
	//   40   85:aload           5
	//   41   87:invokevirtual   #109 <Method boolean ArrayList.add(Object)>
	//   42   90:pop             
			return this;
	//   43   91:aload_0         
	//   44   92:areturn         
	...
	//    3    7:aload_0         
	//    4    8:getfield        #35  <Field Intent mIntent>
	//    5   11:ldc1            #137 <String "android.support.customtabs.extra.MENU_ITEMS">
	//    6   13:aload_0         
	//    7   14:getfield        #37  <Field ArrayList mMenuItems>
	//    8   17:invokevirtual   #141 <Method Intent Intent.putParcelableArrayListExtra(String, ArrayList)>
	//    9   20:pop             
		if(mActionButtons != null)
	//*  10   21:aload_0         
	//*  11   22:getfield        #41  <Field ArrayList mActionButtons>
	//*  12   25:ifnull          42
			mIntent.putParcelableArrayListExtra("android.support.customtabs.extra.TOOLBAR_ITEMS", mActionButtons);
	//   13   28:aload_0         
	//   14   29:getfield        #35  <Field Intent mIntent>
	//   15   32:ldc1            #143 <String "android.support.customtabs.extra.TOOLBAR_ITEMS">
	//   16   34:aload_0         
	//   17   35:getfield        #41  <Field ArrayList mActionButtons>
	//   18   38:invokevirtual   #141 <Method Intent Intent.putParcelableArrayListExtra(String, ArrayList)>
	//   19   41:pop             
		mIntent.putExtra("android.support.customtabs.extra.EXTRA_ENABLE_INSTANT_APPS", mInstantAppsEnabled);
	//   20   42:aload_0         
	//   21   43:getfield        #35  <Field Intent mIntent>
	//   22   46:ldc1            #145 <String "android.support.customtabs.extra.EXTRA_ENABLE_INSTANT_APPS">
	//   23   48:aload_0         
	//   24   49:getfield        #43  <Field boolean mInstantAppsEnabled>
	//   25   52:invokevirtual   #87  <Method Intent Intent.putExtra(String, boolean)>
	//   26   55:pop             
		return new CustomTabsIntent(mIntent, mStartAnimationBundle, ((CustomTabsIntent._cls1) (null)));
	//   27   56:new             #6   <Class CustomTabsIntent>
	//   28   59:dup             
	//   29   60:aload_0         
	//   30   61:getfield        #35  <Field Intent mIntent>
	//   31   64:aload_0         
	//   32   65:getfield        #39  <Field Bundle mStartAnimationBundle>
	//   33   68:aconst_null     
	//   34   69:invokespecial   #148 <Method void CustomTabsIntent(Intent, Bundle, CustomTabsIntent$1)>
	//   35   72:areturn         
	}
	...
	public CustomTabsIntent$Builder setActionButton(Bitmap bitmap, String s, PendingIntent pendingintent)
	{
	...
	public CustomTabsIntent$Builder setActionButton(Bitmap bitmap, String s, PendingIntent pendingintent, boolean flag)
	{
		Bundle bundle = new Bundle();
	...
	//    4    9:aload           5
	//    5   11:ldc1            #123 <String "android.support.customtabs.customaction.ID">
	//    6   13:iconst_0        
	//    7   14:invokevirtual   #127 <Method void Bundle.putInt(String, int)>
		bundle.putParcelable("android.support.customtabs.customaction.ICON", ((android.os.Parcelable) (bitmap)));
	//    8   17:aload           5
	//    9   19:ldc1            #129 <String "android.support.customtabs.customaction.ICON">
	//   10   21:aload_1         
	//   11   22:invokevirtual   #105 <Method void Bundle.putParcelable(String, android.os.Parcelable)>
		bundle.putString("android.support.customtabs.customaction.DESCRIPTION", s);
	//   12   25:aload           5
	//   13   27:ldc1            #131 <String "android.support.customtabs.customaction.DESCRIPTION">
	//   14   29:aload_2         
	//   15   30:invokevirtual   #99  <Method void Bundle.putString(String, String)>
		bundle.putParcelable("android.support.customtabs.customaction.PENDING_INTENT", ((android.os.Parcelable) (pendingintent)));
	//   16   33:aload           5
	...
	public CustomTabsIntent$Builder setExitAnimations(Context context, int i, int j)
	{
	...
	public CustomTabsIntent$Builder setInstantAppsEnabled(boolean flag)
	{
	...
	public CustomTabsIntent$Builder setSecondaryToolbarColor(int i)
	{
	...
	public CustomTabsIntent$Builder setSecondaryToolbarViews(RemoteViews remoteviews, int ai[], PendingIntent pendingintent)
	{
	...
	public CustomTabsIntent$Builder setShowTitle(boolean flag)
	{
	...
	public CustomTabsIntent$Builder setStartAnimations(Context context, int i, int j)
	{
	...
	public CustomTabsIntent$Builder setToolbarColor(int i)
	{
