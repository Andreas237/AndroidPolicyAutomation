	...
	implements Runnable
{
	...
	public void run()
	{
		val$callback.onNavigationEvent(val$navigationEvent, val$extras);
	//    0    0:aload_0         
...
/* anonymous class */
	class CustomTabsClient._cls2 extends ICustomTabsCallback.Stub
	{
		...
		//    3    7:return          
			...
			{
				mHandler.post(((Runnable) (((CustomTabsClient._cls2._cls1) (bundle)). new CustomTabsClient._cls2._cls1())));
		//    4    8:aload_0         
		//    5    9:getfield        #47  <Field Handler mHandler>
