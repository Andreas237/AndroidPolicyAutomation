...
class CustomTabsSessionToken$1 extends CustomTabsCallback
{
	...
	public void extraCallback(String s, Bundle bundle)
	{
		try
		{
			CustomTabsSessionToken.access$000(CustomTabsSessionToken.this).extraCallback(s, bundle);
	//    0    0:aload_0         
	...
	public void onMessageChannelReady(Bundle bundle)
	{
		try
		{
			CustomTabsSessionToken.access$000(CustomTabsSessionToken.this).onMessageChannelReady(bundle);
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field CustomTabsSessionToken this$0>
	//    2    4:invokestatic    #26  <Method ICustomTabsCallback CustomTabsSessionToken.access$000(CustomTabsSessionToken)>
	//    3    7:aload_1         
	...
	public void onNavigationEvent(int i, Bundle bundle)
	{
		try
		{
			CustomTabsSessionToken.access$000(CustomTabsSessionToken.this).onNavigationEvent(i, bundle);
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field CustomTabsSessionToken this$0>
	//    2    4:invokestatic    #26  <Method ICustomTabsCallback CustomTabsSessionToken.access$000(CustomTabsSessionToken)>
	//    3    7:iload_1         
	...
	public void onPostMessage(String s, Bundle bundle)
	{
		try
		{
			CustomTabsSessionToken.access$000(CustomTabsSessionToken.this).onPostMessage(s, bundle);
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field CustomTabsSessionToken this$0>
	//    2    4:invokestatic    #26  <Method ICustomTabsCallback CustomTabsSessionToken.access$000(CustomTabsSessionToken)>
	//    3    7:aload_1         
	...
	public void onRelationshipValidationResult(int i, Uri uri, boolean flag, Bundle bundle)
	{
		try
		{
			CustomTabsSessionToken.access$000(CustomTabsSessionToken.this).onRelationshipValidationResult(i, uri, flag, bundle);
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field CustomTabsSessionToken this$0>
	//    2    4:invokestatic    #26  <Method ICustomTabsCallback CustomTabsSessionToken.access$000(CustomTabsSessionToken)>
	//    3    7:iload_1         
