...
class CustomTabsService$1 extends tub
{
	...
	{
		final CustomTabsSessionToken sessionToken = new CustomTabsSessionToken(icustomtabscallback);
	//    0    0:new             #26  <Class CustomTabsSessionToken>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokespecial   #29  <Method void CustomTabsSessionToken(ICustomTabsCallback)>
	//    4    8:astore          4
		android.os.nt nt = new android.os.IBinder.DeathRecipient() {
			...
			{
				this$1 = CustomTabsService._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
...
;
	...
	//*  16   31:monitorenter    
		{
			icustomtabscallback.asBinder().linkToDeath(nt, 0);
	//   17   32:aload_1         
	...
	//   21   41:invokeinterface #57  <Method void IBinder.linkToDeath(android.os.IBinder$DeathRecipient, int)>
			CustomTabsService.access$000(CustomTabsService.this).put(((Object) (icustomtabscallback.asBinder())), ((Object) (nt)));
	//   22   46:aload_0         
	...
	//   31   68:monitorexit     
		...
		try
		{
			flag = CustomTabsService.this.newSession(sessionToken);
	//   32   69:aload_0         
