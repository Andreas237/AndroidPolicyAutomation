...
public final class CustomTabsIntent
{
	...
	private CustomTabsIntent(Intent intent1, Bundle bundle)
	{
	//    0    0:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #100 <Field Intent intent>
		startAnimationBundle = bundle;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #102 <Field Bundle startAnimationBundle>
	//    8   14:return          
	}
	...
	//    4    6:new             #112 <Class Intent>
	//    5    9:dup             
	//    6   10:ldc1            #114 <String "android.intent.action.VIEW">
	//    7   12:invokespecial   #117 <Method void Intent(String)>
	//    8   15:astore_1        
		intent2.addFlags(0x10000000);
	//    9   16:aload_1         
	//   10   17:ldc1            #118 <Int 0x10000000>
	//   11   19:invokevirtual   #122 <Method Intent Intent.addFlags(int)>
	//   12   22:pop             
		intent2.putExtra("android.support.customtabs.extra.user_opt_out", true);
	//   13   23:aload_1         
	//   14   24:ldc1            #64  <String "android.support.customtabs.extra.user_opt_out">
	//   15   26:iconst_1        
	//   16   27:invokevirtual   #126 <Method Intent Intent.putExtra(String, boolean)>
	//   17   30:pop             
		return intent2;
	//   18   31:aload_1         
	//   19   32:areturn         
	...
	//*   4    4:aload_0         
	//*   5    5:ldc1            #64  <String "android.support.customtabs.extra.user_opt_out">
	//*   6    7:iconst_0        
	//*   7    8:invokevirtual   #132 <Method boolean Intent.getBooleanExtra(String, boolean)>
	//*   8   11:ifeq            28
		{
			flag = flag1;
	//    9   14:iload_2         
	...
	//*  11   16:aload_0         
	//*  12   17:invokevirtual   #135 <Method int Intent.getFlags()>
	//*  13   20:ldc1            #118 <Int 0x10000000>
	//*  14   22:iand            
	//*  15   23:ifeq            28
				flag = true;
	//   16   26:iconst_1        
	...
	public void launchUrl(Context context, Uri uri)
	{
		intent.setData(uri);
	//    0    0:aload_0         
	//    1    1:getfield        #100 <Field Intent intent>
	//    2    4:aload_2         
	//    3    5:invokevirtual   #141 <Method Intent Intent.setData(Uri)>
	//    4    8:pop             
		ContextCompat.startActivity(context, intent, startAnimationBundle);
	//    5    9:aload_1         
	//    6   10:aload_0         
	//    7   11:getfield        #100 <Field Intent intent>
	//    8   14:aload_0         
	//    9   15:getfield        #102 <Field Bundle startAnimationBundle>
	//   10   18:invokestatic    #147 <Method void ContextCompat.startActivity(Context, Intent, Bundle)>
	//   11   21:return          
	}
