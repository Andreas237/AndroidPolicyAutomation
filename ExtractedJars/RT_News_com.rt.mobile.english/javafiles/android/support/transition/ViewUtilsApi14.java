	...
	implements ViewUtilsImpl
{
	...
	//    6   14:aload_0         
	//    7   15:getfield        #85  <Field float[] mMatrixValues>
	//    8   18:astore          10
			float af[] = af1;
	//    9   20:aload           10
	//   10   22:astore          9
	...
	//   16   35:aload_0         
	//   17   36:aload           9
	//   18   38:putfield        #85  <Field float[] mMatrixValues>
			}
			matrix.getValues(af);
	//   19   41:aload_2         
	//   20   42:aload           9
	//   21   44:invokevirtual   #89  <Method void Matrix.getValues(float[])>
			float f = af[3];
	//   22   47:aload           9
	//   23   49:iconst_3        
	//   24   50:faload          
	...
	//   30   56:fsub            
	//   31   57:f2d             
	//   32   58:invokestatic    #95  <Method double Math.sqrt(double)>
	//   33   61:d2f             
	//   34   62:fstore          4
			int i;
			if(af[0] < 0.0F)
	...
	//   53   92:fload           5
	//   54   94:f2d             
	//   55   95:invokestatic    #99  <Method double Math.atan2(double, double)>
	//   56   98:invokestatic    #102 <Method double Math.toDegrees(double)>
	//   57  101:d2f             
	//   58  102:fstore_3        
			f1 = af[0] / f2;
	//   59  103:aload           9
	...
	//   79  133:aload_1         
	//   80  134:fconst_0        
	//   81  135:invokevirtual   #106 <Method void View.setPivotX(float)>
			view.setPivotY(0.0F);
	//   82  138:aload_1         
	//   83  139:fconst_0        
	//   84  140:invokevirtual   #109 <Method void View.setPivotY(float)>
			view.setTranslationX(f3);
	//   85  143:aload_1         
	//   86  144:fload           6
	//   87  146:invokevirtual   #112 <Method void View.setTranslationX(float)>
			view.setTranslationY(f4);
	//   88  149:aload_1         
	//   89  150:fload           7
	//   90  152:invokevirtual   #115 <Method void View.setTranslationY(float)>
			view.setRotation(f);
	//   91  155:aload_1         
	//   92  156:fload_3         
	//   93  157:invokevirtual   #118 <Method void View.setRotation(float)>
			view.setScaleX(f1);
	//   94  160:aload_1         
	//   95  161:fload           4
	//   96  163:invokevirtual   #121 <Method void View.setScaleX(float)>
			view.setScaleY(f2);
	//   97  166:aload_1         
	//   98  167:fload           5
	//   99  169:invokevirtual   #124 <Method void View.setScaleY(float)>
			return;
	//  100  172:return          
		} else
		{
	...
	//  101  173:aload_1         
	//  102  174:aload_1         
	//  103  175:invokevirtual   #127 <Method int View.getWidth()>
	//  104  178:iconst_2        
	//  105  179:idiv            
	//  106  180:i2f             
	//  107  181:invokevirtual   #106 <Method void View.setPivotX(float)>
			view.setPivotY(view.getHeight() / 2);
	//  108  184:aload_1         
	//  109  185:aload_1         
	//  110  186:invokevirtual   #130 <Method int View.getHeight()>
	//  111  189:iconst_2        
	//  112  190:idiv            
	//  113  191:i2f             
	//  114  192:invokevirtual   #109 <Method void View.setPivotY(float)>
			view.setTranslationX(0.0F);
	//  115  195:aload_1         
	//  116  196:fconst_0        
	//  117  197:invokevirtual   #112 <Method void View.setTranslationX(float)>
			view.setTranslationY(0.0F);
	//  118  200:aload_1         
	//  119  201:fconst_0        
	//  120  202:invokevirtual   #115 <Method void View.setTranslationY(float)>
			view.setScaleX(1.0F);
	//  121  205:aload_1         
	//  122  206:fconst_1        
	//  123  207:invokevirtual   #121 <Method void View.setScaleX(float)>
			view.setScaleY(1.0F);
	//  124  210:aload_1         
	//  125  211:fconst_1        
	//  126  212:invokevirtual   #124 <Method void View.setScaleY(float)>
			view.setRotation(0.0F);
	//  127  215:aload_1         
	//  128  216:fconst_0        
	//  129  217:invokevirtual   #118 <Method void View.setRotation(float)>
			return;
	//  130  220:return          
		}
	}
