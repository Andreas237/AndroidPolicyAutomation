	...
	implements ViewOverlayImpl
{
	static class OverlayViewGroup extends ViewGroup
	{
		...
		//*  56   96:goto            107
				i = mDrawables.size();
		//   57   99:aload_0         
		//   58  100:getfield        #51  <Field ArrayList mDrawables>
		//   59  103:invokevirtual   #163 <Method int ArrayList.size()>
		//   60  106:istore_2        
			for(; j < i; j++)
		//*  61  107:iload_3         
		//*  62  108:iload_2         
		...
		//   64  112:aload_0         
		//   65  113:getfield        #51  <Field ArrayList mDrawables>
		//   66  116:iload_3         
		//   67  117:invokevirtual   #167 <Method Object ArrayList.get(int)>
		//   68  120:checkcast       #97  <Class Drawable>
		//   69  123:aload_1         
		//   70  124:invokevirtual   #170 <Method void Drawable.draw(Canvas)>
		...
		//*  32   59:astore_3        
		//*  33   60:aload_3         
		//*  34   61:invokestatic    #218 <Method void ThrowableExtension.printStackTrace(Throwable)>
		//*  35   64:goto            72
				// Misplaced declaration of an exception variable
				catch(Rect rect)
		//*  36   67:astore_3        
				{
					ThrowableExtension.printStackTrace(((Throwable) (rect)));
		//   37   68:aload_3         
		//   38   69:invokestatic    #218 <Method void ThrowableExtension.printStackTrace(Throwable)>
				}
				// Misplaced declaration of an exception variable
				catch(Rect rect)
				{
		...
		//    8   18:invokevirtual   #163 <Method int ArrayList.size()>
		//    9   21:ifne            26
		//   10   24:iconst_1        
		//   11   25:ireturn         
		//   12   26:iconst_0        
		...
		//    4    8:getfield        #51  <Field ArrayList mDrawables>
		//    5   11:aload_1         
		//    6   12:invokevirtual   #229 <Method boolean ArrayList.remove(Object)>
		//    7   15:pop             
				invalidate(drawable.getBounds());
		//    8   16:aload_0         
		//    9   17:aload_1         
		...
		//    2    2:invokespecial   #130 <Method void ViewGroup.removeView(View)>
			if(isEmpty())
		//*   3    5:aload_0         
		//*   4    6:invokevirtual   #231 <Method boolean isEmpty()>
		//*   5    9:ifeq            20
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokespecial   #235 <Method boolean ViewGroup.verifyDrawable(Drawable)>
		//    3    5:ifne            31
		//    4    8:aload_0         
	...
	//    7   11:aload_3         
	//    8   12:aload_0         
	//    9   13:invokespecial   #25  <Method void ViewOverlayApi14$OverlayViewGroup(Context, ViewGroup, View, ViewOverlayApi14)>
	//   10   16:putfield        #27  <Field ViewOverlayApi14$OverlayViewGroup mOverlayViewGroup>
	//   11   19:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #34  <Method ViewGroup getContentView(View)>
	//    2    4:astore_3        
		if(viewgroup != null)
	//*   3    5:aload_3         
	//*   4    6:ifnull          66
	...
	//    5    9:aload_3         
	//    6   10:invokevirtual   #40  <Method int ViewGroup.getChildCount()>
	//    7   13:istore_2        
			for(int i = 0; i < j; i++)
	//*   8   14:iconst_0        
	//*   9   15:istore_1        
	...
	//   13   21:aload_3         
	//   14   22:iload_1         
	//   15   23:invokevirtual   #44  <Method View ViewGroup.getChildAt(int)>
	//   16   26:astore          4
	...
	//   22   41:getfield        #48  <Field ViewOverlayApi14 ViewOverlayApi14$OverlayViewGroup.mViewOverlay>
	//   23   44:areturn         
			}
	...
	//   29   52:new             #50  <Class ViewGroupOverlayApi14>
	//   30   55:dup             
	//   31   56:aload_3         
	//   32   57:invokevirtual   #54  <Method Context ViewGroup.getContext()>
	//   33   60:aload_3         
	//   34   61:aload_0         
	//   35   62:invokespecial   #56  <Method void ViewGroupOverlayApi14(Context, ViewGroup, View)>
	//   36   65:areturn         
		} else
		{
			return null;
	...
	//*   2    4:aload_0         
	//*   3    5:invokevirtual   #61  <Method int View.getId()>
	//*   4    8:ldc1            #62  <Int 0x1020002>
	//*   5   10:icmpne          25
	//*   6   13:aload_0         
	//*   7   14:instanceof      #36  <Class ViewGroup>
	//*   8   17:ifeq            25
				return (ViewGroup)view;
	//    9   20:aload_0         
	//   10   21:checkcast       #36  <Class ViewGroup>
	//   11   24:areturn         
			if(view.getParent() instanceof ViewGroup)
	//*  12   25:aload_0         
	//*  13   26:invokevirtual   #66  <Method ViewParent View.getParent()>
	//*  14   29:instanceof      #36  <Class ViewGroup>
	//*  15   32:ifeq            0
				view = ((View) ((ViewGroup)view.getParent()));
	//   16   35:aload_0         
	//   17   36:invokevirtual   #66  <Method ViewParent View.getParent()>
	//   18   39:checkcast       #36  <Class ViewGroup>
	//   19   42:astore_0        
		} while(true);
	//   20   43:goto            0
		return null;
	...
	//    0    0:aload_0         
	//    1    1:getfield        #27  <Field ViewOverlayApi14$OverlayViewGroup mOverlayViewGroup>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #71  <Method void ViewOverlayApi14$OverlayViewGroup.add(Drawable)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #27  <Field ViewOverlayApi14$OverlayViewGroup mOverlayViewGroup>
	//    2    4:invokevirtual   #75  <Method void ViewOverlayApi14$OverlayViewGroup.clear()>
	//    3    7:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #27  <Field ViewOverlayApi14$OverlayViewGroup mOverlayViewGroup>
	//    2    4:invokevirtual   #81  <Method boolean ViewOverlayApi14$OverlayViewGroup.isEmpty()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #27  <Field ViewOverlayApi14$OverlayViewGroup mOverlayViewGroup>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #84  <Method void ViewOverlayApi14$OverlayViewGroup.remove(Drawable)>
	//    4    8:return          
	}
