...
public class ViewModelProvider
{
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #50  <Method String Class.getCanonicalName()>
	//    2    4:astore_2        
		if(s == null)
	//*   3    5:aload_2         
	//*   4    6:ifnonnull       19
	...
	//    5    9:new             #52  <Class IllegalArgumentException>
	//    6   12:dup             
	//    7   13:ldc1            #54  <String "Local and anonymous classes can not be ViewModels">
	//    8   15:invokespecial   #57  <Method void IllegalArgumentException(String)>
	//    9   18:athrow          
		} else
		{
			StringBuilder stringbuilder = new StringBuilder();
	//   10   19:new             #59  <Class StringBuilder>
	//   11   22:dup             
	//   12   23:invokespecial   #60  <Method void StringBuilder()>
	//   13   26:astore_3        
			stringbuilder.append("android.arch.lifecycle.ViewModelProvider.DefaultKey:");
	//   14   27:aload_3         
	//   15   28:ldc1            #62  <String "android.arch.lifecycle.ViewModelProvider.DefaultKey:">
	//   16   30:invokevirtual   #66  <Method StringBuilder StringBuilder.append(String)>
	//   17   33:pop             
			stringbuilder.append(s);
	//   18   34:aload_3         
	//   19   35:aload_2         
	//   20   36:invokevirtual   #66  <Method StringBuilder StringBuilder.append(String)>
	//   21   39:pop             
			return get(stringbuilder.toString(), class1);
	//   22   40:aload_0         
	//   23   41:aload_3         
	//   24   42:invokevirtual   #69  <Method String StringBuilder.toString()>
	//   25   45:aload_1         
	//   26   46:invokevirtual   #72  <Method ViewModel get(String, Class)>
	//   27   49:areturn         
		}
	}
