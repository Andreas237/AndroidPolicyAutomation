...
public class ArchTaskExecutor extends TaskExecutor
{
	...
	//    0    0:getstatic       #28  <Field Executor sMainThreadExecutor>
	//    1    3:areturn         
	}
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #53  <Method void TaskExecutor.executeOnDiskIO(Runnable)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #40  <Field TaskExecutor mDelegate>
	//    2    4:invokevirtual   #57  <Method boolean TaskExecutor.isMainThread()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #40  <Field TaskExecutor mDelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #60  <Method void TaskExecutor.postToMainThread(Runnable)>
	//    4    8:return          
	}

	public void setDelegate(TaskExecutor taskexecutor)
	{
		TaskExecutor taskexecutor1 = taskexecutor;
	//    0    0:aload_1         
	//    1    1:astore_2        
		if(taskexecutor == null)
	//*   2    2:aload_1         
	//*   3    3:ifnonnull       11
			taskexecutor1 = mDefaultTaskExecutor;
	//    4    6:aload_0         
	//    5    7:getfield        #38  <Field TaskExecutor mDefaultTaskExecutor>
	//    6   10:astore_2        
		mDelegate = taskexecutor1;
	//    7   11:aload_0         
	//    8   12:aload_2         
	//    9   13:putfield        #40  <Field TaskExecutor mDelegate>
	//   10   16:return          
	}
