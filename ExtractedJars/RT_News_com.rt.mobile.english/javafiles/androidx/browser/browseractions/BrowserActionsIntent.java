...
public class BrowserActionsIntent
{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #82  <Field Intent mIntent>
	//    5    9:return          
	}
	...
	//    0    0:new             #91  <Class Intent>
	//    1    3:dup             
	//    2    4:ldc1            #22  <String "androidx.browser.browseractions.browser_action_open">
	//    3    6:ldc1            #64  <String "https://www.example.com">
	//    4    8:invokestatic    #97  <Method Uri Uri.parse(String)>
	//    5   11:invokespecial   #100 <Method void Intent(String, Uri)>
	//    6   14:astore_1        
		return context.getPackageManager().queryIntentActivities(intent, 0x20000);
	//    7   15:aload_0         
	//    8   16:invokevirtual   #106 <Method PackageManager Context.getPackageManager()>
	//    9   19:aload_1         
	//   10   20:ldc1            #107 <Int 0x20000>
	//   11   22:invokevirtual   #113 <Method List PackageManager.queryIntentActivities(Intent, int)>
	//   12   25:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:ldc1            #25  <String "androidx.browser.browseractions.APP_ID">
	//    2    3:invokevirtual   #121 <Method android.os.Parcelable Intent.getParcelableExtra(String)>
	//    3    6:checkcast       #123 <Class PendingIntent>
	//    4    9:astore_0        
		if(intent != null)
	//*   5   10:aload_0         
	//*   6   11:ifnull          32
	...
	//   10   22:aload_0         
	//   11   23:invokevirtual   #132 <Method String PendingIntent.getCreatorPackage()>
	//   12   26:areturn         
			else
				return ((PendingIntent) (intent)).getTargetPackage();
	//   13   27:aload_0         
	//   14   28:invokevirtual   #135 <Method String PendingIntent.getTargetPackage()>
	//   15   31:areturn         
		} else
		{
			return null;
	...
	//    1    1:aload_1         
	//    2    2:aload_0         
	//    3    3:invokestatic    #139 <Method List getBrowserActionsIntentHandlers(Context)>
	//    4    6:invokestatic    #142 <Method void launchIntent(Context, Intent, List)>
	//    5    9:return          
	}
	...
	//*   1    1:ifnull          158
	//*   2    4:aload_2         
	//*   3    5:invokeinterface #153 <Method int List.size()>
	//*   4   10:ifne            16
	//*   5   13:goto            158
		{
			int j = list.size();
	//    6   16:aload_2         
	//    7   17:invokeinterface #153 <Method int List.size()>
	//    8   22:istore          4
			int i = 0;
	//    9   24:iconst_0        
	//   10   25:istore_3        
	...
	//   15   33:aload_2         
	//   16   34:iconst_0        
	//   17   35:invokeinterface #157 <Method Object List.get(int)>
	//   18   40:checkcast       #159 <Class ResolveInfo>
	//   19   43:getfield        #163 <Field ActivityInfo ResolveInfo.activityInfo>
	//   20   46:getfield        #168 <Field String ActivityInfo.packageName>
	//   21   49:invokevirtual   #172 <Method Intent Intent.setPackage(String)>
	//   22   52:pop             
			} else
	//*  23   53:goto            151
			{
				Object obj = ((Object) (new Intent("android.intent.action.VIEW", Uri.parse("https://www.example.com"))));
	//   24   56:new             #91  <Class Intent>
	//   25   59:dup             
	//   26   60:ldc1            #174 <String "android.intent.action.VIEW">
	//   27   62:ldc1            #64  <String "https://www.example.com">
	//   28   64:invokestatic    #97  <Method Uri Uri.parse(String)>
	//   29   67:invokespecial   #100 <Method void Intent(String, Uri)>
	//   30   70:astore          5
				obj = ((Object) (context.getPackageManager().resolveActivity(((Intent) (obj)), 0x10000)));
	//   31   72:aload_0         
	//   32   73:invokevirtual   #106 <Method PackageManager Context.getPackageManager()>
	//   33   76:aload           5
	//   34   78:ldc1            #175 <Int 0x10000>
	//   35   80:invokevirtual   #179 <Method ResolveInfo PackageManager.resolveActivity(Intent, int)>
	//   36   83:astore          5
				if(obj != null)
	//*  37   85:aload           5
	//*  38   87:ifnull          151
	...
	//   39   90:aload           5
	//   40   92:getfield        #163 <Field ActivityInfo ResolveInfo.activityInfo>
	//   41   95:getfield        #168 <Field String ActivityInfo.packageName>
	//   42   98:astore          5
					do
					{
						if(i >= list.size())
	...
	//   43  100:iload_3         
	//   44  101:aload_2         
	//   45  102:invokeinterface #153 <Method int List.size()>
	//   46  107:icmpge          151
						if(((String) (obj)).equals(((Object) (((ResolveInfo)list.get(i)).activityInfo.packageName))))
	//*  47  110:aload           5
	//*  48  112:aload_2         
	//*  49  113:iload_3         
	//*  50  114:invokeinterface #157 <Method Object List.get(int)>
	//*  51  119:checkcast       #159 <Class ResolveInfo>
	//*  52  122:getfield        #163 <Field ActivityInfo ResolveInfo.activityInfo>
	//*  53  125:getfield        #168 <Field String ActivityInfo.packageName>
	//*  54  128:invokevirtual   #185 <Method boolean String.equals(Object)>
	//*  55  131:ifeq            144
						{
							intent.setPackage(((String) (obj)));
	//   56  134:aload_1         
	//   57  135:aload           5
	//   58  137:invokevirtual   #172 <Method Intent Intent.setPackage(String)>
	//   59  140:pop             
							break;
	//   60  141:goto            151
						}
	...
	//   67  152:aload_1         
	//   68  153:aconst_null     
	//   69  154:invokestatic    #191 <Method void ContextCompat.startActivity(Context, Intent, Bundle)>
			return;
	//   70  157:return          
		} else
		{
	...
	//   71  158:aload_0         
	//   72  159:aload_1         
	//   73  160:invokestatic    #194 <Method void openFallbackBrowserActionsMenu(Context, Intent)>
			return;
	//   74  163:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #17  <Class BrowserActionsIntent$Builder>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokespecial   #200 <Method void BrowserActionsIntent$Builder(Context, Uri)>
	//    6   10:invokevirtual   #204 <Method BrowserActionsIntent BrowserActionsIntent$Builder.build()>
	//    7   13:invokevirtual   #208 <Method Intent getIntent()>
	//    8   16:invokestatic    #210 <Method void launchIntent(Context, Intent)>
	//    9   19:return          
	}
	...
	//    5    7:invokespecial   #200 <Method void BrowserActionsIntent$Builder(Context, Uri)>
	//    6   10:iload_2         
	//    7   11:invokevirtual   #215 <Method BrowserActionsIntent$Builder BrowserActionsIntent$Builder.setUrlType(int)>
	//    8   14:aload_3         
	//    9   15:invokevirtual   #219 <Method BrowserActionsIntent$Builder BrowserActionsIntent$Builder.setCustomItems(ArrayList)>
	//   10   18:aload           4
	//   11   20:invokevirtual   #223 <Method BrowserActionsIntent$Builder BrowserActionsIntent$Builder.setOnItemSelectedAction(PendingIntent)>
	//   12   23:invokevirtual   #204 <Method BrowserActionsIntent BrowserActionsIntent$Builder.build()>
	//   13   26:invokevirtual   #208 <Method Intent getIntent()>
	//   14   29:invokestatic    #210 <Method void launchIntent(Context, Intent)>
	//   15   32:return          
	}
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #228 <Method Uri Intent.getData()>
	//    2    4:astore_3        
		int i = intent.getIntExtra("androidx.browser.browseractions.extra.TYPE", 0);
	//    3    5:aload_1         
	//    4    6:ldc1            #34  <String "androidx.browser.browseractions.extra.TYPE">
	//    5    8:iconst_0        
	//    6    9:invokevirtual   #232 <Method int Intent.getIntExtra(String, int)>
	//    7   12:istore_2        
		intent = ((Intent) (intent.getParcelableArrayListExtra("androidx.browser.browseractions.extra.MENU_ITEMS")));
	//    8   13:aload_1         
	//    9   14:ldc1            #28  <String "androidx.browser.browseractions.extra.MENU_ITEMS">
	//   10   16:invokevirtual   #236 <Method ArrayList Intent.getParcelableArrayListExtra(String)>
	//   11   19:astore_1        
		if(intent != null)
	//*  12   20:aload_1         
	//*  13   21:ifnull          32
	...
	//   14   24:aload_1         
	//   15   25:invokestatic    #240 <Method List parseBrowserActionItems(ArrayList)>
	//   16   28:astore_1        
		else
	//*  17   29:goto            34
			intent = null;
	...
	//   22   36:iload_2         
	//   23   37:aload_1         
	//   24   38:invokestatic    #243 <Method void openFallbackBrowserActionsMenu(Context, Uri, int, List)>
	//   25   41:return          
	}
	...
	//    0    0:new             #245 <Class BrowserActionsFallbackMenuUi>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:aload_3         
	//    5    7:invokespecial   #248 <Method void BrowserActionsFallbackMenuUi(Context, Uri, List)>
	//    6   10:invokevirtual   #251 <Method void BrowserActionsFallbackMenuUi.displayMenu()>
		if(sDialogListenter != null)
	//*   7   13:getstatic       #253 <Field BrowserActionsIntent$BrowserActionsFallDialogListener sDialogListenter>
	//*   8   16:ifnull          27
			sDialogListenter.onDialogShown();
	//    9   19:getstatic       #253 <Field BrowserActionsIntent$BrowserActionsFallDialogListener sDialogListenter>
	//   10   22:invokeinterface #256 <Method void BrowserActionsIntent$BrowserActionsFallDialogListener.onDialogShown()>
	//   11   27:return          
	}
	...
	//    0    0:new             #259 <Class ArrayList>
	//    1    3:dup             
	//    2    4:invokespecial   #260 <Method void ArrayList()>
	//    3    7:astore_3        
		for(int i = 0; i < arraylist.size();)
	//*   4    8:iconst_0        
	//*   5    9:istore_1        
	//*   6   10:iload_1         
	//*   7   11:aload_0         
	//*   8   12:invokevirtual   #261 <Method int ArrayList.size()>
	//*   9   15:icmpge          110
		{
			Bundle bundle = (Bundle)arraylist.get(i);
	//   10   18:aload_0         
	//   11   19:iload_1         
	//   12   20:invokevirtual   #262 <Method Object ArrayList.get(int)>
	//   13   23:checkcast       #264 <Class Bundle>
	//   14   26:astore          4
			String s = bundle.getString("androidx.browser.browseractions.TITLE");
	//   15   28:aload           4
	//   16   30:ldc1            #56  <String "androidx.browser.browseractions.TITLE">
	//   17   32:invokevirtual   #268 <Method String Bundle.getString(String)>
	//   18   35:astore          5
			PendingIntent pendingintent = (PendingIntent)bundle.getParcelable("androidx.browser.browseractions.ACTION");
	//   19   37:aload           4
	//   20   39:ldc1            #50  <String "androidx.browser.browseractions.ACTION">
	//   21   41:invokevirtual   #271 <Method android.os.Parcelable Bundle.getParcelable(String)>
	//   22   44:checkcast       #123 <Class PendingIntent>
	//   23   47:astore          6
			int j = bundle.getInt("androidx.browser.browseractions.ICON_ID");
	//   24   49:aload           4
	//   25   51:ldc1            #53  <String "androidx.browser.browseractions.ICON_ID">
	//   26   53:invokevirtual   #275 <Method int Bundle.getInt(String)>
	//   27   56:istore_2        
			if(!TextUtils.isEmpty(((CharSequence) (s))) && pendingintent != null)
	//*  28   57:aload           5
	//*  29   59:invokestatic    #281 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  30   62:ifne            99
	//*  31   65:aload           6
	//*  32   67:ifnonnull       73
	//*  33   70:goto            99
	...
	//   34   73:aload_3         
	//   35   74:new             #283 <Class BrowserActionItem>
	//   36   77:dup             
	//   37   78:aload           5
	//   38   80:aload           6
	//   39   82:iload_2         
	//   40   83:invokespecial   #286 <Method void BrowserActionItem(String, PendingIntent, int)>
	//   41   86:invokeinterface #289 <Method boolean List.add(Object)>
	//   42   91:pop             
				i++;
	//   43   92:iload_1         
	//   44   93:iconst_1        
	...
	//*  47   96:goto            10
			{
				throw new IllegalArgumentException("Custom item should contain a non-empty title and non-null intent.");
	//   48   99:new             #291 <Class IllegalArgumentException>
	//   49  102:dup             
	//   50  103:ldc2            #293 <String "Custom item should contain a non-empty title and non-null intent.">
	//   51  106:invokespecial   #296 <Method void IllegalArgumentException(String)>
	//   52  109:athrow          
			}
		}
	...
	//    0    0:aload_0         
	//    1    1:putstatic       #253 <Field BrowserActionsIntent$BrowserActionsFallDialogListener sDialogListenter>
	//    2    4:return          
	}
	...
	public Intent getIntent()
	{
		return mIntent;
	//    0    0:aload_0         
	//    1    1:getfield        #82  <Field Intent mIntent>
	//    2    4:areturn         
	}
