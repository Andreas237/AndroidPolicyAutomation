...
public static final class OnItemSelected$Callback extends Enum
{

	public static OnItemSelected$Callback valueOf(String s)
	{
		return (OnItemSelected$Callback)Enum.valueOf(butterknife/OnItemSelected$Callback, s);
	...
	{
		return (OnItemSelected$Callback[])((OnItemSelected$Callback []) ($VALUES)).clone();
	...
	static 
	{
		ITEM_SELECTED = new OnItemSelected$Callback("ITEM_SELECTED", 0);
	...
	//    5   10:putstatic       #31  <Field OnItemSelected$Callback ITEM_SELECTED>
		NOTHING_SELECTED = new OnItemSelected$Callback("NOTHING_SELECTED", 1);
	...
	//   11   23:putstatic       #34  <Field OnItemSelected$Callback NOTHING_SELECTED>
		$VALUES = (new OnItemSelected$Callback[] {
			ITEM_SELECTED, NOTHING_SELECTED
		});
	//   12   26:iconst_2        
	//   13   27:anewarray       OnItemSelected$Callback[]
	//   14   30:dup             
	//   15   31:iconst_0        
	...
	private OnItemSelected$Callback(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
