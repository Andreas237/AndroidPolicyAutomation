...
//			ChildJob, ChildHandle, DisposableHandle

public interface Job
	extends kotlin.coroutines.CoroutineContext.Element
{
	public static final class DefaultImpls
	{
		...
		//    2    3:invokestatic    #62  <Method void Intrinsics.checkParameterIsNotNull(Object, String)>
			return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.fold((kotlin.coroutines.CoroutineContext.Element)job, obj, function2);
		//    3    6:aload_0         
		...
		public static kotlin.coroutines.CoroutineContext.Element get(Job job, kotlin.coroutines.CoroutineContext.Key key)
		{
			Intrinsics.checkParameterIsNotNull(((Object) (key)), "key");
		//    0    0:aload_1         
		//    1    1:ldc1            #77  <String "key">
		//    2    3:invokestatic    #62  <Method void Intrinsics.checkParameterIsNotNull(Object, String)>
			return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.get((kotlin.coroutines.CoroutineContext.Element)job, key);
		//    3    6:aload_0         
		//    4    7:checkcast       #64  <Class kotlin.coroutines.CoroutineContext$Element>
		//    5   10:aload_1         
		...
		//    1    1:ldc1            #77  <String "key">
		//    2    3:invokestatic    #62  <Method void Intrinsics.checkParameterIsNotNull(Object, String)>
			return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.minusKey((kotlin.coroutines.CoroutineContext.Element)job, key);
		//    3    6:aload_0         
		//    4    7:checkcast       #64  <Class kotlin.coroutines.CoroutineContext$Element>
		//    5   10:aload_1         
		...
		//    2    3:invokestatic    #62  <Method void Intrinsics.checkParameterIsNotNull(Object, String)>
			return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.plus((kotlin.coroutines.CoroutineContext.Element)job, coroutinecontext);
		//    3    6:aload_0         
		//    4    7:checkcast       #64  <Class kotlin.coroutines.CoroutineContext$Element>
		//    5   10:aload_1         
	...
	public abstract ChildHandle attachChild(ChildJob childjob);
	...
	public abstract DisposableHandle invokeOnCompletion(Function1 function1);

	public abstract DisposableHandle invokeOnCompletion(boolean flag, boolean flag1, Function1 function1);
	...
	public abstract Object join(Continuation continuation);

	public abstract Job plus(Job job);
	...
	//    0    0:getstatic       #69  <Field Job$Key Job$Key.$$INSTANCE>
	//    1    3:putstatic       #71  <Field Job$Key Key>
	//*   2    6:return          
	/* } */
}
