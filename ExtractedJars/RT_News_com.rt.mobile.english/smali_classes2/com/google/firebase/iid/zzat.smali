...
# static fields
.field private static zzco:Lcom/google/firebase/iid/zzat;


# instance fields
.field private final zzcp:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzcq:Ljava/lang/Boolean;

.field final zzcr:Ljava/util/Queue;
...
.field private final zzcs:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcp:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcq:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcr:Ljava/util/Queue;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcs:Ljava/util/Queue;
...
.method public static zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {p0, p3, p2}, Lcom/google/firebase/iid/zzat;->zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static declared-synchronized zzah()Lcom/google/firebase/iid/zzat;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/zzat;->zzco:Lcom/google/firebase/iid/zzat;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/iid/zzat;

    invoke-direct {v1}, Lcom/google/firebase/iid/zzat;-><init>()V

    sput-object v1, Lcom/google/firebase/iid/zzat;->zzco:Lcom/google/firebase/iid/zzat;
...
.method public static zzb(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, v0, p1}, Lcom/google/firebase/iid/zzat;->zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method private final zzd(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcp:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/iid/zzat;->zzcp:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :cond_3
    :goto_0
    iget-object v2, p0, Lcom/google/firebase/iid/zzat;->zzcp:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v2

    :try_start_1
    iget-object v3, p0, Lcom/google/firebase/iid/zzat;->zzcp:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_5
    :try_start_2
    iget-object v1, p0, Lcom/google/firebase/iid/zzat;->zzcq:Ljava/lang/Boolean;
    ...
    :cond_a
    iget-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcq:Ljava/lang/Boolean;
...
.method public final zzai()Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcs:Ljava/util/Queue;
...
.method public final zzb(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzat;->zzcr:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, p3}, Lcom/google/firebase/iid/zzat;->zzd(Landroid/content/Context;Landroid/content/Intent;)I
