...
.field private final zzo:Landroid/content/BroadcastReceiver$PendingResult;

.field private zzp:Z

.field private final zzq:Ljava/util/concurrent/ScheduledFuture;
...
.method constructor <init>(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-boolean v0, p0, Lcom/google/firebase/iid/zzd;->zzp:Z

    iput-object p1, p0, Lcom/google/firebase/iid/zzd;->intent:Landroid/content/Intent;

    iput-object p2, p0, Lcom/google/firebase/iid/zzd;->zzo:Landroid/content/BroadcastReceiver$PendingResult;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/zzd;->zzq:Ljava/util/concurrent/ScheduledFuture;
...
.method final declared-synchronized finish()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/google/firebase/iid/zzd;->zzp:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/google/firebase/iid/zzd;->zzo:Landroid/content/BroadcastReceiver$PendingResult;

    invoke-virtual {v0}, Landroid/content/BroadcastReceiver$PendingResult;->finish()V

    iget-object v0, p0, Lcom/google/firebase/iid/zzd;->zzq:Ljava/util/concurrent/ScheduledFuture;
