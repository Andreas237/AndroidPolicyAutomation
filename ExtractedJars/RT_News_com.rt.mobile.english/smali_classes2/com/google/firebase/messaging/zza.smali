...
# static fields
.field private static zzde:Lcom/google/firebase/messaging/zza;


# instance fields
.field private zzdf:Landroid/os/Bundle;

.field private zzdg:Ljava/lang/reflect/Method;

.field private zzdh:Ljava/lang/reflect/Method;

.field private final zzdi:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzdi:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
...
.method private final zza(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    iget-object v1, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
    ...
    iget-object p1, p0, Lcom/google/firebase/messaging/zza;->zzdg:Ljava/lang/reflect/Method;

    if-nez p1, :cond_6

    const-string p1, "setChannelId"

    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zzl(Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/zza;->zzdg:Ljava/lang/reflect/Method;
...
.method private final zzar()Landroid/os/Bundle;
    .locals 4

    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzdf:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzdf:Landroid/os/Bundle;
...
.method static declared-synchronized zzd(Landroid/content/Context;)Lcom/google/firebase/messaging/zza;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/zza;->zzde:Lcom/google/firebase/messaging/zza;
    ...
    sput-object v1, Lcom/google/firebase/messaging/zza;->zzde:Lcom/google/firebase/messaging/zza;

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/zza;->zzde:Lcom/google/firebase/messaging/zza;
    :try_end_0
...
.method private final zzd(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
...
.method private static zzl(Ljava/lang/String;)Ljava/lang/reflect/Method;
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
...
.method private final zzm(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_1
    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->zzar()Landroid/os/Bundle;
    ...
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
...
.method private final zzn(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/zza;->zzdh:Ljava/lang/reflect/Method;
    ...
    iput-object v2, p0, Lcom/google/firebase/messaging/zza;->zzdh:Ljava/lang/reflect/Method;
    ...
    :goto_1
    iget-object p1, p0, Lcom/google/firebase/messaging/zza;->zzdh:Ljava/lang/reflect/Method;
    ...
    iget-object v8, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;

    sget v9, Lcom/google/firebase/messaging/R$string;->fcm_fallback_notification_channel_label:I
...
.method final zzh(Landroid/os/Bundle;)Z
    ...
    iget-object v3, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
    ...
    invoke-direct {p0, v6}, Lcom/google/firebase/messaging/zza;->zzb(I)Z
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/zza;->zzb(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zzm(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;
    ...
    invoke-static {p1, v3}, Lcom/google/firebase/messaging/zza;->zza(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/zza;->zzv:Landroid/content/Context;

    invoke-virtual {v9}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v3, v9}, Landroid/content/pm/PackageManager;->getLaunchIntentForPackage(Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v10}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzj(Landroid/os/Bundle;)V
    ...
    iget-object v11, p0, Lcom/google/firebase/messaging/zza;->zzdi:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v11}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v11

    invoke-static {v10, v11, v9, v3}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v9

    :goto_5
    invoke-static {p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzk(Landroid/os/Bundle;)Z
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/zza;->zzdi:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v10}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v10

    invoke-static {v9, v10, v8, v3}, Lcom/google/firebase/iid/zzat;->zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v9, p1}, Lcom/google/firebase/messaging/zza;->zza(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-static {v10, v11, v9, v3}, Lcom/google/firebase/iid/zzat;->zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/zza;->zzn(Ljava/lang/String;)Ljava/lang/String;
