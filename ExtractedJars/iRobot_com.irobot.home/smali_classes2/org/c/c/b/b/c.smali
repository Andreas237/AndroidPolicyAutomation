...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/c/c/b/b/c;->a:Ljava/nio/charset/Charset;
...
.method public constructor <init>()V
    ...
    sget-object v3, Lorg/c/c/b/b/c;->a:Ljava/nio/charset/Charset;
    ...
    iput-object v0, p0, Lorg/c/c/b/b/c;->b:Lorg/codehaus/jackson/map/ObjectMapper;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lorg/c/c/b/b/c;->c:Z
...
.method protected a(Ljava/lang/Object;Lorg/c/c/g;)V
    ...
    invoke-virtual {p0, v0}, Lorg/c/c/b/b/c;->c(Lorg/c/c/j;)Lorg/codehaus/jackson/JsonEncoding;

    move-result-object v0

    iget-object v1, p0, Lorg/c/c/b/b/c;->b:Lorg/codehaus/jackson/map/ObjectMapper;
    ...
    invoke-virtual {v1, p2, v0}, Lorg/codehaus/jackson/JsonFactory;->createJsonGenerator(Ljava/io/OutputStream;Lorg/codehaus/jackson/JsonEncoding;)Lorg/codehaus/jackson/JsonGenerator;

    move-result-object p2

    :try_start_0
    iget-boolean v0, p0, Lorg/c/c/b/b/c;->c:Z

    if-eqz v0, :cond_0

    const-string v0, "{} && "

    invoke-virtual {p2, v0}, Lorg/codehaus/jackson/JsonGenerator;->writeRaw(Ljava/lang/String;)V

    :cond_0
    iget-object v0, p0, Lorg/c/c/b/b/c;->b:Lorg/codehaus/jackson/map/ObjectMapper;

    invoke-virtual {v0, p2, p1}, Lorg/codehaus/jackson/map/ObjectMapper;->writeValue(Lorg/codehaus/jackson/JsonGenerator;Ljava/lang/Object;)V
    :try_end_0
...
.method public a(Ljava/lang/Class;Lorg/c/c/j;)Z
    ...
    invoke-virtual {p0, p1}, Lorg/c/c/b/b/c;->b(Ljava/lang/Class;)Lorg/codehaus/jackson/type/JavaType;

    move-result-object p1

    iget-object v0, p0, Lorg/c/c/b/b/c;->b:Lorg/codehaus/jackson/map/ObjectMapper;

    invoke-virtual {v0, p1}, Lorg/codehaus/jackson/map/ObjectMapper;->canDeserialize(Lorg/codehaus/jackson/type/JavaType;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p2}, Lorg/c/c/b/b/c;->a(Lorg/c/c/j;)Z
...
.method protected b(Ljava/lang/Class;Lorg/c/c/d;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, p1}, Lorg/codehaus/jackson/map/ObjectMapper;->readValue(Ljava/io/InputStream;Lorg/codehaus/jackson/type/JavaType;)Ljava/lang/Object;
...
.method public b(Ljava/lang/Class;Lorg/c/c/j;)Z
    ...
    invoke-virtual {p0, p2}, Lorg/c/c/b/b/c;->b(Lorg/c/c/j;)Z
...
.method protected c(Lorg/c/c/j;)Lorg/codehaus/jackson/JsonEncoding;
    .locals 6
    ...
    invoke-virtual {v3}, Lorg/codehaus/jackson/JsonEncoding;->getJavaName()Ljava/lang/String;
    ...
    :cond_1
    sget-object p1, Lorg/codehaus/jackson/JsonEncoding;->UTF8:Lorg/codehaus/jackson/JsonEncoding;
