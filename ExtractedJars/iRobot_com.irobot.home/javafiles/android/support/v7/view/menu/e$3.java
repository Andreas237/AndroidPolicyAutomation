	...
	implements af
{
	...
	{
		a.a.removeCallbacksAndMessages(((Object) (h)));
	//    0    0:aload_0         
...
label0:
	...
	//   56  117:astore          7
		menuitem = ((MenuItem) (new Runnable(e$a1, menuitem, h) {
	...
	//   66  135:lstore          5
		a.a.postAtTime(((Runnable) (menuitem)), ((Object) (h)), l + 200L);
	//   67  137:aload_0         
