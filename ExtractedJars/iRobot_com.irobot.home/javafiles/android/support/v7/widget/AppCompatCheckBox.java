	...
	implements n
{
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:getstatic       #20  <Field int android.support.v7.a.a$a.checkboxStyle>
	...
	//    3    5:aload_2         
	//    4    6:iload_3         
	//    5    7:invokespecial   #29  <Method void CheckBox(Context, AttributeSet, int)>
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #43  <Method int CheckBox.getCompoundPaddingLeft()>
	//    2    4:istore_2        
		int i = j;
	//    3    5:iload_2         
	//    4    6:istore_1        
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #70  <Method void CheckBox.setButtonDrawable(Drawable)>
		if(a != null)
	//*   3    5:aload_0         
