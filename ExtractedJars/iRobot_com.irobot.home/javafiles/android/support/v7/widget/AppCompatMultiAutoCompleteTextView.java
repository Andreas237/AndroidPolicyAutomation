	...
	implements r
{
	...
	//    3    5:aload_2         
	//    4    6:iload_3         
	//    5    7:invokespecial   #38  <Method void MultiAutoCompleteTextView(Context, AttributeSet, int)>
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #82  <Method void MultiAutoCompleteTextView.drawableStateChanged()>
		if(b != null)
	//*   2    4:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #95  <Method void MultiAutoCompleteTextView.setBackgroundDrawable(Drawable)>
		if(b != null)
	//*   3    5:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #101 <Method void MultiAutoCompleteTextView.setBackgroundResource(int)>
		if(b != null)
	//*   3    5:aload_0         
	//*   4    6:getfield        #67  <Field f b>
	//*   5    9:ifnull          20
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #121 <Method void MultiAutoCompleteTextView.setTextAppearance(Context, int)>
		if(c != null)
	//*   4    6:aload_0         
