...
class VisibilityAwareImageButton extends ImageButton
{
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #27  <Method void ImageButton.setVisibility(int)>
		if(flag)
	//*   3    5:iload_2         
	//*   4    6:ifeq            14
			a = i;
	...
	//    1    1:iload_1         
	//    2    2:iconst_1        
	//    3    3:invokevirtual   #30  <Method void a(int, boolean)>
	//    4    6:return          
	}
