...
public static class AppBarLayout$ScrollingViewBehavior extends HeaderScrollingViewBehavior
{
	...
	//*   7   15:ifeq            26
			return ((AppBarLayout.Behavior)appbarlayout).a();
	//    8   18:aload_0         
	...
	//    9   19:checkcast       #57  <Class AppBarLayout$Behavior>
	//   10   22:astore_1        
			s.c(view, ((view1.getBottom() - view.getTop()) + AppBarLayout.Behavior.a(((AppBarLayout.Behavior) (coordinatorlayout))) + a()) - c(view1));
	//   11   23:aload_2         
	//   12   24:aload_3         
	...
	{
		return super.a(coordinatorlayout, view, i, j, k, l);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:iload_3         
