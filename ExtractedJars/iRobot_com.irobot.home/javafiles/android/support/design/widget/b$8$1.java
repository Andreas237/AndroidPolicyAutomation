	...
	implements Runnable
{
	...
	public void run()
	{
		a.a.d(3);
	//    0    0:aload_0         
	//    1    1:getfield        #17  <Field b$8 a>
	//    2    4:getfield        #25  <Field b b$8.a>
	//    3    7:iconst_3        
	//    4    8:invokevirtual   #31  <Method void b.d(int)>
	//    5   11:return          
	}

	final b._cls8 a;

	b$8$1(b._cls8 _pcls8)
	{
		a = _pcls8;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #17  <Field b$8 a>
		super();
	//    3    5:aload_0         
	...
	// Unreferenced inner class com/irobot/home/core/a/b$8

/* anonymous class */
	class b._cls8 extends ApplicationUIServiceDataCallback
	{
		...
		//   10   26:astore_2        
				switch(b._cls9.a[applicationuistate.ordinal()])
