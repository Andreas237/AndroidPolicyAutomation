	...
	implements Parcelable
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #21  <Method void SparseArray()>
	//    2    4:return          
	}
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #28  <Method int Parcel.readInt()>
	//    4    8:istore          4
		int ai[] = new int[j];
	//    5   10:iload           4
	//    6   12:newarray        int[]
	...
	//    8   16:aload_1         
	//    9   17:aload           5
	//   10   19:invokevirtual   #32  <Method void Parcel.readIntArray(int[])>
		parcel = ((Parcel) (parcel.readParcelableArray(classloader)));
	//   11   22:aload_1         
	//   12   23:aload_2         
	//   13   24:invokevirtual   #36  <Method Parcelable[] Parcel.readParcelableArray(ClassLoader)>
	//   14   27:astore_1        
		for(int i = 0; i < j; i++)
	//*  15   28:iconst_0        
	//*  16   29:istore_3        
	...
	//   25   42:iload_3         
	//   26   43:aaload          
	//   27   44:invokevirtual   #40  <Method void put(int, Object)>
	...
	public void writeToParcel(Parcel parcel, int i)
	{
		int k = size();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #46  <Method int size()>
	//    2    4:istore          4
		int ai[] = new int[k];
	//    3    6:iload           4
	//    4    8:newarray        int[]
	...
	//   16   30:aload_0         
	//   17   31:iload_3         
	//   18   32:invokevirtual   #50  <Method int keyAt(int)>
	//   19   35:iastore         
	...
	//   22   39:aload_0         
	//   23   40:iload_3         
	//   24   41:invokevirtual   #54  <Method Object valueAt(int)>
	...
	//   32   55:aload_1         
	//   33   56:iload           4
	//   34   58:invokevirtual   #58  <Method void Parcel.writeInt(int)>
		parcel.writeIntArray(ai);
	//   35   61:aload_1         
	//   36   62:aload           5
	//   37   64:invokevirtual   #61  <Method void Parcel.writeIntArray(int[])>
		parcel.writeParcelableArray(aparcelable, i);
	//   38   67:aload_1         
	//   39   68:aload           6
	//   40   70:iload_2         
	//   41   71:invokevirtual   #65  <Method void Parcel.writeParcelableArray(Parcelable[], int)>
	//   42   74:return          
	}
...
;
	...
	//    1    3:dup             
	//    2    4:invokespecial   #17  <Method void ParcelableSparseArray$1()>
