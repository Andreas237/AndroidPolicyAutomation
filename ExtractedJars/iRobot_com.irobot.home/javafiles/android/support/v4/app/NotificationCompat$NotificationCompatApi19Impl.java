...
static class NotificationCompat$NotificationCompatApi19Impl extends NotificationCompat$NotificationCompatApi16Impl
{
	...
	//   38   76:aload_1         
	//   39   77:getfield        #84  <Field java.util.ArrayList NotificationCompat$Builder.mPeople>
	//   40   80:aload_1         
	...
	//   52  104:invokespecial   #107 <Method void NotificationCompatKitKat$Builder(android.content.Context, Notification, CharSequence, CharSequence, CharSequence, android.widget.RemoteViews, int, android.app.PendingIntent, android.app.PendingIntent, android.graphics.Bitmap, int, int, boolean, boolean, boolean, int, CharSequence, boolean, java.util.ArrayList, android.os.Bundle, String, boolean, String, android.widget.RemoteViews, android.widget.RemoteViews)>
	//   53  107:astore_3        
		NotificationCompat.addActionsToBuilder(((NotificationBuilderWithActions) (builder1)), builder.mActions);
	//   54  108:aload_3         
	//   55  109:aload_1         
	//   56  110:getfield        #110 <Field java.util.ArrayList NotificationCompat$Builder.mActions>
	//   57  113:invokestatic    #114 <Method void NotificationCompat.addActionsToBuilder(NotificationBuilderWithActions, java.util.ArrayList)>
