...
public class FragmentController
{
	...
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:aload_1         
	//    4    8:invokevirtual   #120 <Method Fragment FragmentManagerImpl.findFragmentByWho(String)>
	//    5   11:areturn         
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #125 <Method List FragmentManagerImpl.getActiveFragments()>
	//    4   10:areturn         
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #131 <Method int FragmentManagerImpl.getActiveFragmentCount()>
	//    4   10:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:invokevirtual   #137 <Method FragmentManagerImpl FragmentHostCallback.getFragmentManagerImpl()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:invokevirtual   #143 <Method LoaderManagerImpl FragmentHostCallback.getLoaderManagerImpl()>
	//    3    7:areturn         
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #146 <Method void FragmentManagerImpl.noteStateNotSaved()>
	//    4   10:return          
	}
	...
	//    5    9:aload_3         
	//    6   10:aload           4
	//    7   12:invokevirtual   #150 <Method View FragmentManagerImpl.onCreateView(View, String, Context, AttributeSet)>
	//    8   15:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:invokevirtual   #153 <Method void FragmentHostCallback.reportLoaderStart()>
	//    3    7:return          
	}
	...
	//    3    7:aload_1         
	//    4    8:aload_2         
	//    5    9:invokevirtual   #157 <Method void FragmentManagerImpl.restoreAllState(Parcelable, FragmentManagerNonConfig)>
	//    6   12:return          
	}
	...
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:aload_1         
	//    4    8:new             #161 <Class FragmentManagerNonConfig>
	//    5   11:dup             
	//    6   12:aload_2         
	//    7   13:aconst_null     
	//    8   14:invokespecial   #164 <Method void FragmentManagerNonConfig(List, List)>
	//    9   17:invokevirtual   #157 <Method void FragmentManagerImpl.restoreAllState(Parcelable, FragmentManagerNonConfig)>
	//   10   20:return          
	}

	public void restoreLoaderNonConfig(m m)
	{
		mHost.restoreLoaderNonConfig(m);
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #170 <Method void FragmentHostCallback.restoreLoaderNonConfig(m)>
	//    4    8:return          
	}

	public m retainLoaderNonConfig()
	{
		return mHost.retainLoaderNonConfig();
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:invokevirtual   #175 <Method m FragmentHostCallback.retainLoaderNonConfig()>
	//    3    7:areturn         
	}
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #181 <Method FragmentManagerNonConfig FragmentManagerImpl.retainNonConfig()>
	//    4   10:areturn         
	}
	...
	//    7   15:aload_1         
	//    8   16:invokevirtual   #184 <Method List FragmentManagerNonConfig.getFragments()>
	//    9   19:areturn         
		else
			return null;
	//   10   20:aconst_null     
	...
	//    1    1:getfield        #14  <Field FragmentHostCallback mHost>
	//    2    4:getfield        #30  <Field FragmentManagerImpl FragmentHostCallback.mFragmentManager>
	//    3    7:invokevirtual   #189 <Method Parcelable FragmentManagerImpl.saveAllState()>
	//    4   10:areturn         
	}
