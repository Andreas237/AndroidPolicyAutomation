...
public final class BundleCompat
{
	static class BundleCompatBaseImpl
	{
		...
		//   26   55:getstatic       #47  <Field Method sGetIBinderMethod>
		//   27   58:aload_0         
		//   28   59:iconst_1        
		...
		//   32   65:aload_1         
		//   33   66:aastore         
		//   34   67:invokevirtual   #65  <Method Object Method.invoke(Object, Object[])>
		//   35   70:checkcast       #67  <Class IBinder>
		//   36   73:astore_0        
		...
		//   42   81:aload_0         
		//   43   82:invokestatic    #61  <Method int Log.i(String, String, Throwable)>
		//   44   85:pop             
		...
		//   30   60:getstatic       #77  <Field Method sPutIBinderMethod>
		//   31   63:aload_0         
		//   32   64:iconst_2        
		...
		//   40   74:aload_2         
		//   41   75:aastore         
		//   42   76:invokevirtual   #65  <Method Object Method.invoke(Object, Object[])>
		//   43   79:pop             
				return;
		//   44   80:return          
			}
		...
		//   48   86:aload_0         
		//   49   87:invokestatic    #61  <Method int Log.i(String, String, Throwable)>
		//   50   90:pop             
			}
	...
	//    3    8:aload_0         
	//    4    9:aload_1         
	//    5   10:invokevirtual   #25  <Method IBinder Bundle.getBinder(String)>
	//    6   13:areturn         
		else
			return BundleCompatBaseImpl.getBinder(bundle, s);
	//    7   14:aload_0         
	//    8   15:aload_1         
	//    9   16:invokestatic    #27  <Method IBinder BundleCompat$BundleCompatBaseImpl.getBinder(Bundle, String)>
	//   10   19:areturn         
	}
	...
	//    4    9:aload_1         
	//    5   10:aload_2         
	//    6   11:invokevirtual   #32  <Method void Bundle.putBinder(String, IBinder)>
			return;
	//    7   14:return          
		} else
		{
	...
	//    9   16:aload_1         
	//   10   17:aload_2         
	//   11   18:invokestatic    #34  <Method void BundleCompat$BundleCompatBaseImpl.putBinder(Bundle, String, IBinder)>
			return;
	//   12   21:return          
		}
	}
