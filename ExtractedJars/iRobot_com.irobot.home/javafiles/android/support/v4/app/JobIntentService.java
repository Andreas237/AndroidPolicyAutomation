...
public abstract class JobIntentService extends Service
{
		...
		implements CompatJobEngine
	{
		...
		public IBinder compatGetBinder()
		{
			return getBinder();
		//    0    0:aload_0         
		//    1    1:invokevirtual   #44  <Method IBinder getBinder()>
		//    2    4:areturn         
		}
...
label0:
		...
		//*   4    6:monitorenter    
				{
					if(mParams != null)
						break label0;
		//    5    7:aload_0         
		//    6    8:getfield        #48  <Field JobParameters mParams>
		//    7   11:ifnonnull       18
				}
		//    8   14:aload_1         
		//    9   15:monitorexit     
		...
		//   12   18:aload_0         
		//   13   19:getfield        #48  <Field JobParameters mParams>
		//   14   22:invokevirtual   #53  <Method JobWorkItem JobParameters.dequeueWork()>
		//   15   25:astore_2        
			obj;
		//   16   26:aload_1         
			JVM INSTR monitorexit ;
		...
		//   20   32:aload_2         
		//   21   33:invokevirtual   #59  <Method Intent JobWorkItem.getIntent()>
		//   22   36:aload_0         
		//   23   37:getfield        #38  <Field JobIntentService mService>
		//   24   40:invokevirtual   #63  <Method ClassLoader JobIntentService.getClassLoader()>
		//   25   43:invokevirtual   #69  <Method void Intent.setExtrasClassLoader(ClassLoader)>
		...
		//   28   50:aload_0         
		//   29   51:aload_2         
		//   30   52:invokespecial   #72  <Method void JobIntentService$JobServiceEngineImpl$WrapperWorkItem(JobIntentService$JobServiceEngineImpl, JobWorkItem)>
		//   31   55:areturn         
			} else
			{
				return null;
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #48  <Field JobParameters mParams>
			mService.ensureProcessorRunningLocked(false);
		//    3    5:aload_0         
		//    4    6:getfield        #38  <Field JobIntentService mService>
		//    5    9:iconst_0        
		//    6   10:invokevirtual   #78  <Method void JobIntentService.ensureProcessorRunningLocked(boolean)>
			return true;
		//    7   13:iconst_1        
		//    8   14:ireturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #38  <Field JobIntentService mService>
		//    2    4:invokevirtual   #83  <Method boolean JobIntentService.doStopCurrentWork()>
		//    3    7:istore_2        
			synchronized(mLock)
		//*   4    8:aload_0         
		//*   5    9:getfield        #36  <Field Object mLock>
		//*   6   12:astore_1        
		//*   7   13:aload_1         
		//*   8   14:monitorenter    
			{
		...
		//    9   15:aload_0         
		//   10   16:aconst_null     
		//   11   17:putfield        #48  <Field JobParameters mParams>
			}
		//   12   20:aload_1         
		//   13   21:monitorexit     
			return flag;
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokespecial   #29  <Method void JobServiceEngine(Service)>
		//    3    5:aload_0         
		//    4    6:new             #31  <Class Object>
		//    5    9:dup             
		//    6   10:invokespecial   #34  <Method void Object()>
		//    7   13:putfield        #36  <Field Object mLock>
			mService = jobintentservice;
		//    8   16:aload_0         
		//    9   17:aload_1         
		//   10   18:putfield        #38  <Field JobIntentService mService>
		//   11   21:return          
		}
	}
	...
	//*  16   29:aload_0         
	//*  17   30:aload_1         
	//*  18   31:putfield        #85  <Field ArrayList mCompatQueue>
	//*  19   34:return          
			arraylist = new ArrayList();
	//   20   35:new             #87  <Class ArrayList>
	//   21   38:dup             
	//   22   39:invokespecial   #88  <Method void ArrayList()>
	//   23   42:astore_1        
	...
	//    2    4:new             #92  <Class IllegalArgumentException>
	//    3    7:dup             
	//    4    8:ldc1            #94  <String "work must not be null">
	//    5   10:invokespecial   #97  <Method void IllegalArgumentException(String)>
	//    6   13:athrow          
		synchronized(sLock)
	...
	//   13   24:iconst_1        
	//   14   25:iload_2         
	//   15   26:invokestatic    #101 <Method JobIntentService$WorkEnqueuer getWorkEnqueuer(Context, ComponentName, boolean, int)>
	//   16   29:astore_0        
			((WorkEnqueuer) (context)).ensureJobId(i);
	//   17   30:aload_0         
	//   18   31:iload_2         
	//   19   32:invokevirtual   #105 <Method void JobIntentService$WorkEnqueuer.ensureJobId(int)>
			((WorkEnqueuer) (context)).enqueueWork(intent);
	//   20   35:aload_0         
	//   21   36:aload_3         
	//   22   37:invokevirtual   #108 <Method void JobIntentService$WorkEnqueuer.enqueueWork(Intent)>
		}
	//   23   40:aload           4
	//   24   42:monitorexit     
		return;
	...
	//    0    0:aload_0         
	//    1    1:new             #111 <Class ComponentName>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokespecial   #114 <Method void ComponentName(Context, Class)>
	//    6   10:iload_2         
	//    7   11:aload_3         
	//    8   12:invokestatic    #116 <Method void enqueueWork(Context, ComponentName, int, Intent)>
	//    9   15:return          
	}
	...
	//    1    3:aload_1         
	//    2    4:invokevirtual   #120 <Method Object HashMap.get(Object)>
	...
	//   14   33:new             #92  <Class IllegalArgumentException>
	//   15   36:dup             
	//   16   37:ldc1            #122 <String "Can't be here without a job id">
	//   17   39:invokespecial   #97  <Method void IllegalArgumentException(String)>
	//   18   42:athrow          
	...
	//   22   48:aload_1         
	//   23   49:iload_3         
	//   24   50:invokespecial   #125 <Method void JobIntentService$JobWorkEnqueuer(Context, ComponentName, int)>
	//   25   53:astore_0        
			} else
	//*  26   54:goto            67
			{
	...
	//   29   61:aload_0         
	//   30   62:aload_1         
	//   31   63:invokespecial   #128 <Method void JobIntentService$CompatWorkEnqueuer(Context, ComponentName)>
	//   32   66:astore_0        
			}
	...
	//   34   70:aload_1         
	//   35   71:aload_0         
	//   36   72:invokevirtual   #132 <Method Object HashMap.put(Object, Object)>
	//   37   75:pop             
			obj = ((Object) (context));
	//   38   76:aload_0         
	//   39   77:astore          4
	...
	GenericWorkItem dequeueWork()
	{
		if(mJobImpl != null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #136 <Field JobIntentService$CompatJobEngine mJobImpl>
	//*   2    4:ifnull          17
			return mJobImpl.dequeueWork();
	//    3    7:aload_0         
	//    4    8:getfield        #136 <Field JobIntentService$CompatJobEngine mJobImpl>
	//    5   11:invokeinterface #138 <Method JobIntentService$GenericWorkItem JobIntentService$CompatJobEngine.dequeueWork()>
	//    6   16:areturn         
	...
	//   14   28:invokevirtual   #142 <Method int ArrayList.size()>
	//   15   31:ifle            50
		genericworkitem = (GenericWorkItem)mCompatQueue.remove(0);
	//   16   34:aload_0         
	//   17   35:getfield        #85  <Field ArrayList mCompatQueue>
	//   18   38:iconst_0        
	//   19   39:invokevirtual   #146 <Method Object ArrayList.remove(int)>
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #150 <Field JobIntentService$CommandProcessor mCurProcessor>
	//*   2    4:ifnull          19
			mCurProcessor.cancel(mInterruptIfStopped);
	//    3    7:aload_0         
	//    4    8:getfield        #150 <Field JobIntentService$CommandProcessor mCurProcessor>
	//    5   11:aload_0         
	//    6   12:getfield        #73  <Field boolean mInterruptIfStopped>
	//    7   15:invokevirtual   #154 <Method boolean JobIntentService$CommandProcessor.cancel(boolean)>
	//    8   18:pop             
		mStopped = true;
	//    9   19:aload_0         
	//   10   20:iconst_1        
	...
	//   12   24:aload_0         
	//   13   25:invokevirtual   #157 <Method boolean onStopCurrentWork()>
	//   14   28:ireturn         
	}
	...
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:invokespecial   #162 <Method void JobIntentService$CommandProcessor(JobIntentService)>
	//    8   16:putfield        #150 <Field JobIntentService$CommandProcessor mCurProcessor>
			if(mCompatWorkEnqueuer != null && flag)
	//*   9   19:aload_0         
	//*  10   20:getfield        #164 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//*  11   23:ifnull          37
	//*  12   26:iload_1         
	//*  13   27:ifeq            37
				mCompatWorkEnqueuer.serviceProcessingStarted();
	//   14   30:aload_0         
	//   15   31:getfield        #164 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//   16   34:invokevirtual   #167 <Method void JobIntentService$WorkEnqueuer.serviceProcessingStarted()>
			mCurProcessor.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, ((Object []) (new Void[0])));
	//   17   37:aload_0         
	//   18   38:getfield        #150 <Field JobIntentService$CommandProcessor mCurProcessor>
	//   19   41:getstatic       #173 <Field java.util.concurrent.Executor AsyncTask.THREAD_POOL_EXECUTOR>
	//   20   44:iconst_0        
	//   21   45:anewarray       Void[]
	//   22   48:invokevirtual   #179 <Method AsyncTask JobIntentService$CommandProcessor.executeOnExecutor(java.util.concurrent.Executor, Object[])>
	//   23   51:pop             
		}
	//   24   52:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #136 <Field JobIntentService$CompatJobEngine mJobImpl>
	//    5   11:invokeinterface #186 <Method IBinder JobIntentService$CompatJobEngine.compatGetBinder()>
	//    6   16:areturn         
		else
			return null;
	//    7   17:aconst_null     
	...
	public void onCreate()
	{
		super.onCreate();
	//    0    0:aload_0         
	//    1    1:invokespecial   #189 <Method void Service.onCreate()>
		if(android.os.Build.VERSION.SDK_INT >= 26)
	...
	//    7   16:dup             
	//    8   17:aload_0         
	//    9   18:invokespecial   #190 <Method void JobIntentService$JobServiceEngineImpl(JobIntentService)>
	//   10   21:putfield        #136 <Field JobIntentService$CompatJobEngine mJobImpl>
			mCompatWorkEnqueuer = null;
	//   11   24:aload_0         
	//   12   25:aconst_null     
	//   13   26:putfield        #164 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
			return;
	//   14   29:return          
		} else
		{
	...
	//   15   30:aload_0         
	//   16   31:aconst_null     
	//   17   32:putfield        #136 <Field JobIntentService$CompatJobEngine mJobImpl>
			mCompatWorkEnqueuer = getWorkEnqueuer(((Context) (this)), new ComponentName(((Context) (this)), ((Object)this).getClass()), false, 0);
	//   18   35:aload_0         
	//   19   36:aload_0         
	//   20   37:new             #111 <Class ComponentName>
	//   21   40:dup             
	//   22   41:aload_0         
	//   23   42:aload_0         
	//   24   43:invokevirtual   #194 <Method Class Object.getClass()>
	//   25   46:invokespecial   #114 <Method void ComponentName(Context, Class)>
	//   26   49:iconst_0        
	//   27   50:iconst_0        
	//   28   51:invokestatic    #101 <Method JobIntentService$WorkEnqueuer getWorkEnqueuer(Context, ComponentName, boolean, int)>
	//   29   54:putfield        #164 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
			return;
	//   30   57:return          
		}
	}
	...
	public void onDestroy()
	{
		super.onDestroy();
	//    0    0:aload_0         
	//    1    1:invokespecial   #197 <Method void Service.onDestroy()>
	...
	//   13   23:aload_0         
	//   14   24:getfield        #164 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//   15   27:invokevirtual   #200 <Method void JobIntentService$WorkEnqueuer.serviceProcessingFinished()>
			}
	//   16   30:aload_1         
	//   17   31:monitorexit     
			return;
	...
	//    3    7:aload_0         
	//    4    8:getfield        #164 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//    5   11:invokevirtual   #206 <Method void JobIntentService$WorkEnqueuer.serviceStartReceived()>
		ArrayList arraylist = mCompatQueue;
	//    6   14:aload_0         
	...
	//   16   33:goto            44
		intent = new Intent();
	//   17   36:new             #208 <Class Intent>
	//   18   39:dup             
	//   19   40:invokespecial   #209 <Method void Intent()>
	//   20   43:astore_1        
	...
	//   25   51:aload_1         
	//   26   52:iload_3         
	//   27   53:invokespecial   #212 <Method void JobIntentService$CompatWorkItem(JobIntentService, Intent, int)>
	//   28   56:invokevirtual   #216 <Method boolean ArrayList.add(Object)>
	//   29   59:pop             
		ensureProcessorRunningLocked(true);
	//   30   60:aload_0         
	//   31   61:iconst_1        
	//   32   62:invokevirtual   #218 <Method void ensureProcessorRunningLocked(boolean)>
		arraylist;
	//   33   65:aload           4
		JVM INSTR monitorexit ;
	//   34   67:monitorexit     
	...
	//    8   14:aload_0         
	//    9   15:aconst_null     
	//   10   16:putfield        #150 <Field JobIntentService$CommandProcessor mCurProcessor>
	...
	//*  16   30:invokevirtual   #142 <Method int ArrayList.size()>
	//*  17   33:ifle            44
		{
			ensureProcessorRunningLocked(false);
	//   18   36:aload_0         
	//   19   37:iconst_0        
	//   20   38:invokevirtual   #218 <Method void ensureProcessorRunningLocked(boolean)>
	...
	//*  24   48:ifne            58
			mCompatWorkEnqueuer.serviceProcessingFinished();
	//   25   51:aload_0         
	//   26   52:getfield        #164 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//   27   55:invokevirtual   #200 <Method void JobIntentService$WorkEnqueuer.serviceProcessingFinished()>
		arraylist;
	//   28   58:aload_1         
		JVM INSTR monitorexit ;
	//   29   59:monitorexit     
