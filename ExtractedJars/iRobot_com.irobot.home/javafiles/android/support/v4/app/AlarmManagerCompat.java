...
public final class AlarmManagerCompat
{
	...
	//    3    8:aload_0         
	//    4    9:new             #19  <Class android.app.AlarmManager$AlarmClockInfo>
	//    5   12:dup             
	//    6   13:lload_1         
	//    7   14:aload_3         
	//    8   15:invokespecial   #22  <Method void android.app.AlarmManager$AlarmClockInfo(long, PendingIntent)>
	//    9   18:aload           4
	//   10   20:invokevirtual   #27  <Method void AlarmManager.setAlarmClock(android.app.AlarmManager$AlarmClockInfo, PendingIntent)>
			return;
	//   11   23:return          
		} else
		{
	...
	//   14   26:lload_1         
	//   15   27:aload           4
	//   16   29:invokestatic    #31  <Method void setExact(AlarmManager, int, long, PendingIntent)>
			return;
	//   17   32:return          
		}
	}
	...
	//    5   10:lload_2         
	//    6   11:aload           4
	//    7   13:invokevirtual   #35  <Method void AlarmManager.setAndAllowWhileIdle(int, long, PendingIntent)>
			return;
	//    8   16:return          
		} else
		{
	...
	//   11   19:lload_2         
	//   12   20:aload           4
	//   13   22:invokevirtual   #38  <Method void AlarmManager.set(int, long, PendingIntent)>
			return;
	//   14   25:return          
		}
	}
	...
	//    5   10:lload_2         
	//    6   11:aload           4
	//    7   13:invokevirtual   #40  <Method void AlarmManager.setExact(int, long, PendingIntent)>
			return;
	//    8   16:return          
		} else
		{
	...
	//    5   10:lload_2         
	//    6   11:aload           4
	//    7   13:invokevirtual   #43  <Method void AlarmManager.setExactAndAllowWhileIdle(int, long, PendingIntent)>
			return;
	//    8   16:return          
		} else
		{
	...
	//   11   19:lload_2         
	//   12   20:aload           4
	//   13   22:invokestatic    #31  <Method void setExact(AlarmManager, int, long, PendingIntent)>
			return;
	//   14   25:return          
		}
	}
