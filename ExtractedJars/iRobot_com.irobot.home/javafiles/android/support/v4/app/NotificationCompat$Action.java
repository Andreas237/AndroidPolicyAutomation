...
public static class NotificationCompat$Action extends ion
{
	...
	public static final ion.Factory FACTORY = new NotificationCompatBase.Action.Factory() {
		...
		{
			return ((NotificationCompatBase.Action) (new NotificationCompat.Action(i, charsequence, pendingintent, bundle, (RemoteInput[])aremoteinput, (RemoteInput[])aremoteinput1, flag)));
