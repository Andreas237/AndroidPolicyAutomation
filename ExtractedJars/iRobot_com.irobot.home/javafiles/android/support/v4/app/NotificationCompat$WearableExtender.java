	...
	implements NotificationCompat.Extender
{
	...
	//   37   84:invokevirtual   #265 <Method void Bundle.putParcelable(String, android.os.Parcelable)>
		if(!mPages.isEmpty())
	//*  38   87:aload_0         
	...
	//   51  117:checkcast       #269 <Class android.os.Parcelable[]>
	//   52  120:invokevirtual   #273 <Method void Bundle.putParcelableArray(String, android.os.Parcelable[])>
		if(mBackground != null)
	//*  53  123:aload_0         
	...
	//   60  137:invokevirtual   #265 <Method void Bundle.putParcelable(String, android.os.Parcelable)>
		if(mContentIcon != 0)
	//*  61  140:aload_0         
