...
public abstract class FragmentPagerAdapter extends p
{

	public FragmentPagerAdapter(FragmentManager fragmentmanager)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #22  <Method void p()>
	...
	//    4    8:new             #33  <Class StringBuilder>
	//    5   11:dup             
	//    6   12:invokespecial   #34  <Method void StringBuilder()>
	//    7   15:astore_1        
			((StringBuilder) (viewgroup)).append("ViewPager with adapter ");
	//    8   16:aload_1         
	//    9   17:ldc1            #123 <String "ViewPager with adapter ">
	//   10   19:invokevirtual   #40  <Method StringBuilder StringBuilder.append(String)>
	//   11   22:pop             
			((StringBuilder) (viewgroup)).append(((Object) (this)));
	//   12   23:aload_1         
	//   13   24:aload_0         
	//   14   25:invokevirtual   #126 <Method StringBuilder StringBuilder.append(Object)>
	//   15   28:pop             
			((StringBuilder) (viewgroup)).append(" requires a view id");
	//   16   29:aload_1         
	//   17   30:ldc1            #128 <String " requires a view id">
	//   18   32:invokevirtual   #40  <Method StringBuilder StringBuilder.append(String)>
	//   19   35:pop             
			throw new IllegalStateException(((StringBuilder) (viewgroup)).toString());
	//   20   36:new             #130 <Class IllegalStateException>
	//   21   39:dup             
	//   22   40:aload_1         
	//   23   41:invokevirtual   #52  <Method String StringBuilder.toString()>
	//   24   44:invokespecial   #133 <Method void IllegalStateException(String)>
	//   25   47:athrow          
		} else
		{
			return;
