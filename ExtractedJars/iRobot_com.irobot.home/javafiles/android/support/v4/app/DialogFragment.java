	...
	implements android.content.DialogInterface.OnCancelListener, android.content.DialogInterface.OnDismissListener
{
	...
	//   15   29:new             #132 <Class IllegalStateException>
	//   16   32:dup             
	//   17   33:ldc1            #134 <String "DialogFragment can not be attached to a container view">
	//   18   35:invokespecial   #137 <Method void IllegalStateException(String)>
	//   19   38:athrow          
			mDialog.setContentView(((View) (obj)));
	//   20   39:aload_0         
	//   21   40:getfield        #77  <Field Dialog mDialog>
	//   22   43:aload_2         
	//   23   44:invokevirtual   #141 <Method void Dialog.setContentView(View)>
		}
		obj = ((Object) (getActivity()));
	//   24   47:aload_0         
	//   25   48:invokevirtual   #145 <Method FragmentActivity getActivity()>
	//   26   51:astore_2        
		if(obj != null)
	//*  27   52:aload_2         
	//*  28   53:ifnull          64
	...
	//   31   60:aload_2         
	//   32   61:invokevirtual   #149 <Method void Dialog.setOwnerActivity(android.app.Activity)>
		mDialog.setCancelable(mCancelable);
	//   33   64:aload_0         
	//   34   65:getfield        #77  <Field Dialog mDialog>
	//   35   68:aload_0         
	//   36   69:getfield        #60  <Field boolean mCancelable>
	//   37   72:invokevirtual   #152 <Method void Dialog.setCancelable(boolean)>
		mDialog.setOnCancelListener(((android.content.DialogInterface.OnCancelListener) (this)));
	//   38   75:aload_0         
	//   39   76:getfield        #77  <Field Dialog mDialog>
	//   40   79:aload_0         
	//   41   80:invokevirtual   #156 <Method void Dialog.setOnCancelListener(android.content.DialogInterface$OnCancelListener)>
	...
	//   44   87:aload_0         
	//   45   88:invokevirtual   #160 <Method void Dialog.setOnDismissListener(android.content.DialogInterface$OnDismissListener)>
		if(bundle != null)
	//*  46   91:aload_1         
	//*  47   92:ifnull          114
		{
	...
	//   50   98:invokevirtual   #166 <Method Bundle Bundle.getBundle(String)>
	//   51  101:astore_1        
			if(bundle != null)
	//*  52  102:aload_1         
	//*  53  103:ifnull          114
	...
	//   56  110:aload_1         
	//   57  111:invokevirtual   #169 <Method void Dialog.onRestoreInstanceState(Bundle)>
		}
	//   58  114:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #173 <Method void Fragment.onAttach(Context)>
		if(!mShownByMe)
	//*   3    5:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #178 <Method void Fragment.onCreate(Bundle)>
		boolean flag;
		if(mContainerId == 0)
	//*   3    5:aload_0         
	//*   4    6:getfield        #181 <Field int mContainerId>
	//*   5    9:ifne            17
			flag = true;
	//    6   12:iconst_1        
	//    7   13:istore_2        
	...
	//   19   32:iconst_0        
	//   20   33:invokevirtual   #185 <Method int Bundle.getInt(String, int)>
	...
	//   25   43:iconst_0        
	//   26   44:invokevirtual   #185 <Method int Bundle.getInt(String, int)>
	...
	//   31   54:iconst_1        
	//   32   55:invokevirtual   #189 <Method boolean Bundle.getBoolean(String, boolean)>
	...
	//   39   69:invokevirtual   #189 <Method boolean Bundle.getBoolean(String, boolean)>
	...
	//   44   79:iconst_m1       
	//   45   80:invokevirtual   #185 <Method int Bundle.getInt(String, int)>
	...
	//    4    8:aload_0         
	//    5    9:invokevirtual   #193 <Method int getTheme()>
	//    6   12:invokespecial   #196 <Method void Dialog(Context, int)>
	//    7   15:areturn         
	}
	...
	public void onDestroyView()
	{
		super.onDestroyView();
	//    0    0:aload_0         
	//    1    1:invokespecial   #199 <Method void Fragment.onDestroyView()>
		if(mDialog != null)
	//*   2    4:aload_0         
	...
	public void onDetach()
	{
		super.onDetach();
	//    0    0:aload_0         
	//    1    1:invokespecial   #202 <Method void Fragment.onDetach()>
	...
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:invokespecial   #207 <Method LayoutInflater Fragment.onGetLayoutInflater(Bundle)>
	//    6   12:areturn         
		mDialog = onCreateDialog(bundle);
	//    7   13:aload_0         
	//    8   14:aload_0         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #209 <Method Dialog onCreateDialog(Bundle)>
	...
	//   20   38:invokevirtual   #213 <Method void setupDialog(Dialog, int)>
			bundle = ((Bundle) (mDialog.getContext()));
	//   21   41:aload_0         
	//   22   42:getfield        #77  <Field Dialog mDialog>
	//   23   45:invokevirtual   #217 <Method Context Dialog.getContext()>
	//   24   48:astore_1        
		} else
	//*  25   49:aload_1         
	//*  26   50:ldc1            #219 <String "layout_inflater">
	//*  27   52:invokevirtual   #225 <Method Object Context.getSystemService(String)>
	//*  28   55:checkcast       #227 <Class LayoutInflater>
	//*  29   58:areturn         
		{
			bundle = ((Bundle) (mHost.getContext()));
	//   30   59:aload_0         
	//   31   60:getfield        #231 <Field FragmentHostCallback mHost>
	//   32   63:invokevirtual   #234 <Method Context FragmentHostCallback.getContext()>
	//   33   66:astore_1        
		}
		return (LayoutInflater)((Context) (bundle)).getSystemService("layout_inflater");
	//*  34   67:goto            49
	}
	...
	//    8   16:invokevirtual   #240 <Method Bundle Dialog.onSaveInstanceState()>
	//    9   19:astore_2        
			if(bundle1 != null)
	//*  10   20:aload_2         
	//*  11   21:ifnull          31
	...
	//   14   27:aload_2         
	//   15   28:invokevirtual   #244 <Method void Bundle.putBundle(String, Bundle)>
		}
		if(mStyle != 0)
	//*  16   31:aload_0         
	...
	//   23   45:invokevirtual   #248 <Method void Bundle.putInt(String, int)>
		if(mTheme != 0)
	//*  24   48:aload_0         
	...
	//   31   62:invokevirtual   #248 <Method void Bundle.putInt(String, int)>
		if(!mCancelable)
	//*  32   65:aload_0         
	...
	//   39   79:invokevirtual   #252 <Method void Bundle.putBoolean(String, boolean)>
		if(!mShowsDialog)
	//*  40   82:aload_0         
	...
	//   47   96:invokevirtual   #252 <Method void Bundle.putBoolean(String, boolean)>
		if(mBackStackId != -1)
	//*  48   99:aload_0         
	...
	//   56  114:invokevirtual   #248 <Method void Bundle.putInt(String, int)>
	//   57  117:return          
	}
	...
	//    8   16:aload_0         
	//    9   17:getfield        #77  <Field Dialog mDialog>
	//   10   20:invokevirtual   #258 <Method void Dialog.show()>
		}
	//   11   23:return          
	}
	...
	public void onStop()
	{
		super.onStop();
	//    0    0:aload_0         
	//    1    1:invokespecial   #261 <Method void Fragment.onStop()>
		if(mDialog != null)
	//*   2    4:aload_0         
	//*   3    5:getfield        #77  <Field Dialog mDialog>
	//*   4    8:ifnull          18
	...
	//    7   15:invokevirtual   #264 <Method void Dialog.hide()>
	//    8   18:return          
	}
	...
	//    7   13:getfield        #77  <Field Dialog mDialog>
	//    8   16:iload_1         
	//    9   17:invokevirtual   #152 <Method void Dialog.setCancelable(boolean)>
	//   10   20:return          
	}
	...
	//    3   29:aload_1         
	//    4   30:invokevirtual   #271 <Method Window Dialog.getWindow()>
	//    5   33:bipush          24
	//    6   35:invokevirtual   #277 <Method void Window.addFlags(int)>
			// fall through
	...
	//    7   38:aload_1         
	//    8   39:iconst_1        
	//    9   40:invokevirtual   #281 <Method boolean Dialog.requestWindowFeature(int)>
	//   10   43:pop             
			break;
		}
	//   11   44:return          
	...
	//    7   11:aload_0         
	//    8   12:aload_2         
	//    9   13:invokevirtual   #286 <Method FragmentTransaction FragmentTransaction.add(Fragment, String)>
	//   10   16:pop             
		mViewDestroyed = false;
	//   11   17:aload_0         
	//   12   18:iconst_0        
	...
	//   10   16:aload_0         
	//   11   17:aload_2         
	//   12   18:invokevirtual   #286 <Method FragmentTransaction FragmentTransaction.add(Fragment, String)>
	//   13   21:pop             
