...
public class ListFragment extends Fragment
{
	...
	//   13   26:athrow          
		if(!(obj instanceof ListView)) goto _L2; else goto _L1
	//   14   27:aload_1         
...
_L2:
	...
	//   73  150:putfield        #56  <Field ListView mList>
		if(mEmptyView == null) goto _L5; else goto _L4
	//   74  153:aload_0         
...
_L4:
	...
	//   79  164:astore_1        
		obj1 = ((Object) (mEmptyView));
	//   80  165:aload_0         
	//   81  166:getfield        #82  <Field View mEmptyView>
	//   82  169:astore_2        
_L6:
		((ListView) (obj)).setEmptyView(((View) (obj1)));
	//   83  170:aload_1         
	//   84  171:aload_2         
	//   85  172:invokevirtual   #102 <Method void ListView.setEmptyView(View)>
...
_L5:
		if(mEmptyText == null)
			break; /* Loop/switch isn't completed */
	//   87  178:aload_0         
	//   88  179:getfield        #104 <Field CharSequence mEmptyText>
	//   89  182:ifnull          209
		mStandardEmptyView.setText(mEmptyText);
	//   90  185:aload_0         
	//   91  186:getfield        #79  <Field TextView mStandardEmptyView>
	//   92  189:aload_0         
	//   93  190:getfield        #104 <Field CharSequence mEmptyText>
	//   94  193:invokevirtual   #108 <Method void TextView.setText(CharSequence)>
		obj = ((Object) (mList));
	//   95  196:aload_0         
	//   96  197:getfield        #56  <Field ListView mList>
	//   97  200:astore_1        
		obj1 = ((Object) (mStandardEmptyView));
	//   98  201:aload_0         
	//   99  202:getfield        #79  <Field TextView mStandardEmptyView>
	//  100  205:astore_2        
...
_L3:
	...
	//  102  209:aload_0         
	//  103  210:iconst_1        
	//  104  211:putfield        #110 <Field boolean mListShown>
		mList.setOnItemClickListener(mOnClickListener);
	//  105  214:aload_0         
	//  106  215:getfield        #56  <Field ListView mList>
	//  107  218:aload_0         
	//  108  219:getfield        #52  <Field android.widget.AdapterView$OnItemClickListener mOnClickListener>
	//  109  222:invokevirtual   #114 <Method void ListView.setOnItemClickListener(android.widget.AdapterView$OnItemClickListener)>
		if(mAdapter != null)
	//* 110  225:aload_0         
	//* 111  226:getfield        #116 <Field ListAdapter mAdapter>
	//* 112  229:ifnull          250
		{
			ListAdapter listadapter = mAdapter;
	//  113  232:aload_0         
	//  114  233:getfield        #116 <Field ListAdapter mAdapter>
	//  115  236:astore_1        
			mAdapter = null;
	//  116  237:aload_0         
	//  117  238:aconst_null     
	//  118  239:putfield        #116 <Field ListAdapter mAdapter>
			setListAdapter(listadapter);
	//  119  242:aload_0         
	//  120  243:aload_1         
	//  121  244:invokevirtual   #120 <Method void setListAdapter(ListAdapter)>
		} else
	//* 122  247:goto            263
		if(mProgressContainer != null)
	//* 123  250:aload_0         
	//* 124  251:getfield        #88  <Field View mProgressContainer>
	//* 125  254:ifnull          263
			setListShown(false, false);
	//  126  257:aload_0         
	//  127  258:iconst_0        
	//  128  259:iconst_0        
	//  129  260:invokespecial   #124 <Method void setListShown(boolean, boolean)>
		mHandler.post(mRequestFocus);
	//  130  263:aload_0         
	//  131  264:getfield        #44  <Field Handler mHandler>
	//  132  267:aload_0         
	//  133  268:getfield        #49  <Field Runnable mRequestFocus>
	//  134  271:invokevirtual   #128 <Method boolean Handler.post(Runnable)>
	//  135  274:pop             
		return;
	//  136  275:return          
	}
	...
	//   12   20:aload_0         
	//   13   21:aload_1         
	//   14   22:putfield        #116 <Field ListAdapter mAdapter>
		if(mList != null)
	//*  15   25:aload_0         
	...
	//   18   32:aload_0         
	//   19   33:getfield        #56  <Field ListView mList>
	//   20   36:aload_1         
	//   21   37:invokevirtual   #231 <Method void ListView.setAdapter(ListAdapter)>
			if(!mListShown && !flag)
	//*  22   40:aload_0         
	//*  23   41:getfield        #110 <Field boolean mListShown>
	//*  24   44:ifne            69
	//*  25   47:iload_2         
	//*  26   48:ifne            69
			{
	...
	//*  27   51:aload_0         
	//*  28   52:invokevirtual   #60  <Method View getView()>
	//*  29   55:invokevirtual   #235 <Method android.os.IBinder View.getWindowToken()>
	//*  30   58:ifnull          63
					flag1 = true;
	//   31   61:iconst_1        
	//   32   62:istore_3        
	...
	//   34   64:iconst_1        
	//   35   65:iload_3         
	//   36   66:invokespecial   #124 <Method void setListShown(boolean, boolean)>
			}
		}
	//   37   69:return          
	}
