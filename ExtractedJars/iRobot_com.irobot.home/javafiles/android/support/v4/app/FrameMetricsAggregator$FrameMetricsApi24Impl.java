...
private static class FrameMetricsAggregator$FrameMetricsApi24Impl extends FrameMetricsAggregator.FrameMetricsBaseImpl
{

	public void add(Activity activity)
	{
		if(sHandlerThread == null)
	//*   0    0:getstatic       #59  <Field HandlerThread sHandlerThread>
	//*   1    3:ifnonnull       40
		{
			sHandlerThread = new HandlerThread("FrameMetricsAggregator");
	//    2    6:new             #61  <Class HandlerThread>
	//    3    9:dup             
	//    4   10:ldc1            #63  <String "FrameMetricsAggregator">
	//    5   12:invokespecial   #66  <Method void HandlerThread(String)>
	//    6   15:putstatic       #59  <Field HandlerThread sHandlerThread>
			sHandlerThread.start();
	//    7   18:getstatic       #59  <Field HandlerThread sHandlerThread>
	//    8   21:invokevirtual   #69  <Method void HandlerThread.start()>
			sHandler = new Handler(sHandlerThread.getLooper());
	//    9   24:new             #71  <Class Handler>
	//   10   27:dup             
	//   11   28:getstatic       #59  <Field HandlerThread sHandlerThread>
	//   12   31:invokevirtual   #75  <Method android.os.Looper HandlerThread.getLooper()>
	//   13   34:invokespecial   #78  <Method void Handler(android.os.Looper)>
	//   14   37:putstatic       #80  <Field Handler sHandler>
		}
		for(int i = 0; i <= 8; i++)
	//*  15   40:iconst_0        
	//*  16   41:istore_2        
	...
	//*  20   48:aload_0         
	//*  21   49:getfield        #38  <Field SparseIntArray[] mMetrics>
	//*  22   52:iload_2         
	//*  23   53:aaload          
	//*  24   54:ifnonnull       81
	//*  25   57:aload_0         
	//*  26   58:getfield        #51  <Field int mTrackingFlags>
	//*  27   61:iconst_1        
	//*  28   62:iload_2         
	//*  29   63:ishl            
	//*  30   64:iand            
	...
	//   32   68:aload_0         
	//   33   69:getfield        #38  <Field SparseIntArray[] mMetrics>
	//   34   72:iload_2         
	//   35   73:new             #36  <Class SparseIntArray>
	//   36   76:dup             
	//   37   77:invokespecial   #81  <Method void SparseIntArray()>
	//   38   80:aastore         
	...
	//   44   88:aload_1         
	//   45   89:invokevirtual   #87  <Method Window Activity.getWindow()>
	//   46   92:aload_0         
	//   47   93:getfield        #49  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
	//   48   96:getstatic       #80  <Field Handler sHandler>
	//   49   99:invokevirtual   #93  <Method void Window.addOnFrameMetricsAvailableListener(android.view.Window$OnFrameMetricsAvailableListener, Handler)>
		mActivities.add(((Object) (new WeakReference(((Object) (activity))))));
	//   50  102:aload_0         
	//   51  103:getfield        #44  <Field ArrayList mActivities>
	//   52  106:new             #95  <Class WeakReference>
	//   53  109:dup             
	//   54  110:aload_1         
	//   55  111:invokespecial   #98  <Method void WeakReference(Object)>
	//   56  114:invokevirtual   #101 <Method boolean ArrayList.add(Object)>
	//   57  117:pop             
	//   58  118:return          
	}
	...
	//    2    4:ldc2w           #104 <Long 0x7a120L>
	//    3    7:lload_2         
	//    4    8:ladd            
	//    5    9:ldc2w           #106 <Long 0xf4240L>
	//    6   12:ldiv            
	//    7   13:l2i             
	//    8   14:istore          4
			if(l >= 0L)
	...
	//   15   25:aload_1         
	//   16   26:iload           4
	//   17   28:invokevirtual   #111 <Method int SparseIntArray.get(int)>
	//   18   31:iconst_1        
	//   19   32:iadd            
	//   20   33:invokevirtual   #115 <Method void SparseIntArray.put(int, int)>
		}
	//   21   36:return          
	}
	...
	public SparseIntArray[] getMetrics()
	{
		return mMetrics;
	//    0    0:aload_0         
	//    1    1:getfield        #38  <Field SparseIntArray[] mMetrics>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field ArrayList mActivities>
	//    2    4:invokevirtual   #123 <Method Iterator ArrayList.iterator()>
	//    3    7:astore_2        
		do
		{
			if(!iterator.hasNext())
				break;
	//    4    8:aload_2         
	//    5    9:invokeinterface #129 <Method boolean Iterator.hasNext()>
	//    6   14:ifeq            44
			WeakReference weakreference = (WeakReference)iterator.next();
	//    7   17:aload_2         
	//    8   18:invokeinterface #133 <Method Object Iterator.next()>
	//    9   23:checkcast       #95  <Class WeakReference>
	//   10   26:astore_3        
			if(weakreference.get() != activity)
				continue;
	//   11   27:aload_3         
	//   12   28:invokevirtual   #135 <Method Object WeakReference.get()>
	//   13   31:aload_1         
	//   14   32:if_acmpne       8
			mActivities.remove(((Object) (weakreference)));
	//   15   35:aload_0         
	//   16   36:getfield        #44  <Field ArrayList mActivities>
	//   17   39:aload_3         
	//   18   40:invokevirtual   #137 <Method boolean ArrayList.remove(Object)>
	//   19   43:pop             
			break;
		} while(true);
		activity.getWindow().removeOnFrameMetricsAvailableListener(mListener);
	//   20   44:aload_1         
	//   21   45:invokevirtual   #87  <Method Window Activity.getWindow()>
	//   22   48:aload_0         
	//   23   49:getfield        #49  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
	//   24   52:invokevirtual   #141 <Method void Window.removeOnFrameMetricsAvailableListener(android.view.Window$OnFrameMetricsAvailableListener)>
		return mMetrics;
	//   25   55:aload_0         
	//   26   56:getfield        #38  <Field SparseIntArray[] mMetrics>
	//   27   59:areturn         
	}
	...
	//    6   11:putfield        #38  <Field SparseIntArray[] mMetrics>
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #44  <Field ArrayList mActivities>
	//*   2    4:invokevirtual   #147 <Method int ArrayList.size()>
	//*   3    7:iconst_1        
	//*   4    8:isub            
	//*   5    9:istore_1        
	//*   6   10:iload_1         
	...
	//    8   14:aload_0         
	//    9   15:getfield        #44  <Field ArrayList mActivities>
	//   10   18:iload_1         
	//   11   19:invokevirtual   #150 <Method Object ArrayList.get(int)>
	//   12   22:checkcast       #95  <Class WeakReference>
	//   13   25:astore_2        
			Activity activity = (Activity)weakreference.get();
	//   14   26:aload_2         
	//   15   27:invokevirtual   #135 <Method Object WeakReference.get()>
	//   16   30:checkcast       #83  <Class Activity>
	//   17   33:astore_3        
			if(weakreference.get() != null)
	//*  18   34:aload_2         
	//*  19   35:invokevirtual   #135 <Method Object WeakReference.get()>
	//*  20   38:ifnull          61
			{
				activity.getWindow().removeOnFrameMetricsAvailableListener(mListener);
	//   21   41:aload_3         
	//   22   42:invokevirtual   #87  <Method Window Activity.getWindow()>
	//   23   45:aload_0         
	//   24   46:getfield        #49  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
	//   25   49:invokevirtual   #141 <Method void Window.removeOnFrameMetricsAvailableListener(android.view.Window$OnFrameMetricsAvailableListener)>
				mActivities.remove(i);
	//   26   52:aload_0         
	//   27   53:getfield        #44  <Field ArrayList mActivities>
	//   28   56:iload_1         
	//   29   57:invokevirtual   #152 <Method Object ArrayList.remove(int)>
	//   30   60:pop             
			}
		}
	...
	//*  35   65:goto            10
		return mMetrics;
	//   36   68:aload_0         
	//   37   69:getfield        #38  <Field SparseIntArray[] mMetrics>
	//   38   72:areturn         
	}
...
/*
	static int access$100(FrameMetricsAggregator$FrameMetricsApi24Impl framemetricsaggregator$framemetricsapi24impl)
	{
		return framemetricsaggregator$framemetricsapi24impl.mTrackingFlags;
	//    0    0:aload_0         
	//    1    1:getfield        #51  <Field int mTrackingFlags>
	//    2    4:ireturn         
	}
...
/*
	static SparseIntArray[] access$200(FrameMetricsAggregator$FrameMetricsApi24Impl framemetricsaggregator$framemetricsapi24impl)
	{
		return framemetricsaggregator$framemetricsapi24impl.mMetrics;
	//    0    0:aload_0         
	//    1    1:getfield        #38  <Field SparseIntArray[] mMetrics>
	//    2    4:areturn         
	}
...
*/
	...
	{
		super(((FrameMetricsAggregator._cls1) (null)));
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:invokespecial   #34  <Method void FrameMetricsAggregator$FrameMetricsBaseImpl(FrameMetricsAggregator$1)>
		mMetrics = new SparseIntArray[9];
	//    3    5:aload_0         
	//    4    6:bipush          9
	//    5    8:anewarray       SparseIntArray[]
	...
	//    7   14:aload_0         
	//    8   15:new             #40  <Class ArrayList>
	//    9   18:dup             
	//   10   19:invokespecial   #42  <Method void ArrayList()>
	//   11   22:putfield        #44  <Field ArrayList mActivities>
		mListener = new android.view.Window.OnFrameMetricsAvailableListener() {

			public void onFrameMetricsAvailable(Window window, FrameMetrics framemetrics, int j)
			{
...
;
	...
	//   14   29:dup             
	//   15   30:aload_0         
	//   16   31:invokespecial   #47  <Method void FrameMetricsAggregator$FrameMetricsApi24Impl$1(FrameMetricsAggregator$FrameMetricsApi24Impl)>
	//   17   34:putfield        #49  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
		mTrackingFlags = i;
	//   18   37:aload_0         
	//   19   38:iload_1         
	//   20   39:putfield        #51  <Field int mTrackingFlags>
	//   21   42:return          
	}
}
