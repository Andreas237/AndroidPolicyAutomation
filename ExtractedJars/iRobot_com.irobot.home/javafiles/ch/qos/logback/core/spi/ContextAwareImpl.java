	...
	implements ContextAware
{
	...
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:putfield        #19  <Field int noContextWarning>
		context = context1;
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:putfield        #21  <Field Context context>
		origin = obj;
	//    8   14:aload_0         
	//    9   15:aload_2         
	//   10   16:putfield        #23  <Field Object origin>
	//   11   19:return          
	}

	public void addError(String s)
	{
		addStatus(((Status) (new ErrorStatus(s, getOrigin()))));
	//    0    0:aload_0         
	//    1    1:new             #28  <Class ErrorStatus>
	//    2    4:dup             
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:invokevirtual   #32  <Method Object getOrigin()>
	//    6   10:invokespecial   #35  <Method void ErrorStatus(String, Object)>
	//    7   13:invokevirtual   #39  <Method void addStatus(Status)>
	//    8   16:return          
	}

	public void addError(String s, Throwable throwable)
	{
		addStatus(((Status) (new ErrorStatus(s, getOrigin(), throwable))));
	//    0    0:aload_0         
	//    1    1:new             #28  <Class ErrorStatus>
	//    2    4:dup             
	//    3    5:aload_1         
	...
	//    5    7:invokevirtual   #32  <Method Object getOrigin()>
	//    6   10:aload_2         
	//    7   11:invokespecial   #43  <Method void ErrorStatus(String, Object, Throwable)>
	//    8   14:invokevirtual   #39  <Method void addStatus(Status)>
	//    9   17:return          
	}

	public void addInfo(String s)
	{
		addStatus(((Status) (new InfoStatus(s, getOrigin()))));
	//    0    0:aload_0         
	//    1    1:new             #46  <Class InfoStatus>
	//    2    4:dup             
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:invokevirtual   #32  <Method Object getOrigin()>
	//    6   10:invokespecial   #47  <Method void InfoStatus(String, Object)>
	//    7   13:invokevirtual   #39  <Method void addStatus(Status)>
	//    8   16:return          
	}
	...
	{
		addStatus(((Status) (new InfoStatus(s, getOrigin(), throwable))));
	//    0    0:aload_0         
	//    1    1:new             #46  <Class InfoStatus>
	//    2    4:dup             
	//    3    5:aload_1         
	...
	//    5    7:invokevirtual   #32  <Method Object getOrigin()>
	//    6   10:aload_2         
	//    7   11:invokespecial   #48  <Method void InfoStatus(String, Object, Throwable)>
	//    8   14:invokevirtual   #39  <Method void addStatus(Status)>
	//    9   17:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #19  <Field int noContextWarning>
	//    5   11:istore_2        
	...
	//    8   14:iconst_1        
	//    9   15:iadd            
	//   10   16:putfield        #19  <Field int noContextWarning>
			if(i == 0)
	//*  11   19:iload_2         
	//*  12   20:ifne            56
			{
	...
	//   32   57:aload_0         
	//   33   58:getfield        #21  <Field Context context>
	...
	{
		addStatus(((Status) (new WarnStatus(s, getOrigin()))));
	//    0    0:aload_0         
	...
	{
		addStatus(((Status) (new WarnStatus(s, getOrigin(), throwable))));
	//    0    0:aload_0         
	//    1    1:new             #89  <Class WarnStatus>
	//    2    4:dup             
	//    3    5:aload_1         
	...
	protected Object getOrigin()
	{
		return origin;
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field Object origin>
	//    2    4:areturn         
	}
	...
	//    5    9:aload_0         
	//    6   10:getfield        #21  <Field Context context>
	...
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #21  <Field Context context>
			return;
	//    6   12:return          
		}
		if(context != context1)
	//*   7   13:aload_0         
	//*   8   14:getfield        #21  <Field Context context>
	//*   9   17:aload_1         
	//*  10   18:if_acmpeq       31
