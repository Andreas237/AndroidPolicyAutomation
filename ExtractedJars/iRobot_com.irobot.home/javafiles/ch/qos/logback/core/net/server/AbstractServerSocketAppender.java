...
public abstract class AbstractServerSocketAppender extends AppenderBase
{
	...
	//   10   20:astore_1        
			...
			//    0    0:aload_0         
			//    1    1:aload_1         
			//    2    2:putfield        #20  <Field AbstractServerSocketAppender this$0>
	...
	//   13   25:new             #7   <Class AbstractServerSocketAppender$1>
	//   14   28:dup             
	//   15   29:aload_0         
	//   16   30:aload_1         
	//   17   31:invokespecial   #51  <Method void AbstractServerSocketAppender$1(AbstractServerSocketAppender, Serializable)>
	...
	protected InetAddress getInetAddress()
	{
		if(getAddress() == null)
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #88  <Method String getAddress()>
	//*   2    4:ifnonnull       9
			return null;
	//    3    7:aconst_null     
	//    4    8:areturn         
	...
	//    5    9:aload_0         
	//    6   10:invokevirtual   #88  <Method String getAddress()>
	//    7   13:invokestatic    #94  <Method InetAddress InetAddress.getByName(String)>
	//    8   16:areturn         
	}
	...
	//    0    0:invokestatic    #102 <Method ServerSocketFactory ServerSocketFactory.getDefault()>
	//    1    3:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #28  <Field int backlog>
	//    3    5:return          
	}
	...
	public void start()
	{
		if(isStarted())
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #115 <Method boolean isStarted()>
	//*   2    4:ifeq            8
			return;
	//    3    7:return          
		try
	...
	//    6   10:aload_0         
	//    7   11:aload_0         
	//    8   12:invokevirtual   #117 <Method ServerSocketFactory getServerSocketFactory()>
	//    9   15:aload_0         
	//   10   16:invokevirtual   #119 <Method int getPort()>
	//   11   19:aload_0         
	//   12   20:invokevirtual   #121 <Method int getBacklog()>
	//   13   23:aload_0         
	//   14   24:invokevirtual   #123 <Method InetAddress getInetAddress()>
	//   15   27:invokevirtual   #127 <Method ServerSocket ServerSocketFactory.createServerSocket(int, int, InetAddress)>
	//   16   30:invokevirtual   #129 <Method ServerListener createServerListener(ServerSocket)>
	//   17   33:aload_0         
	//   18   34:invokevirtual   #133 <Method Context getContext()>
	//   19   37:invokeinterface #139 <Method ExecutorService Context.getExecutorService()>
	//   20   42:invokevirtual   #141 <Method ServerRunner createServerRunner(ServerListener, Executor)>
	//   21   45:putfield        #48  <Field ServerRunner runner>
			runner.setContext(getContext());
	//   22   48:aload_0         
	//   23   49:getfield        #48  <Field ServerRunner runner>
	//   24   52:aload_0         
	//   25   53:invokevirtual   #133 <Method Context getContext()>
	//   26   56:invokeinterface #145 <Method void ServerRunner.setContext(Context)>
			getContext().getExecutorService().execute(((Runnable) (runner)));
	//   27   61:aload_0         
	//   28   62:invokevirtual   #133 <Method Context getContext()>
	//   29   65:invokeinterface #139 <Method ExecutorService Context.getExecutorService()>
	//   30   70:aload_0         
	//   31   71:getfield        #48  <Field ServerRunner runner>
	//   32   74:invokeinterface #151 <Method void ExecutorService.execute(Runnable)>
			super.start();
	//   33   79:aload_0         
	//   34   80:invokespecial   #153 <Method void AppenderBase.start()>
			return;
	//   35   83:return          
		}
	...
	//   37   85:new             #155 <Class StringBuilder>
	//   38   88:dup             
	//   39   89:invokespecial   #156 <Method void StringBuilder()>
	//   40   92:astore_2        
			stringbuilder.append("server startup error: ");
	//   41   93:aload_2         
	//   42   94:ldc1            #158 <String "server startup error: ">
	//   43   96:invokevirtual   #161 <Method StringBuilder StringBuilder.append(String)>
	//   44   99:pop             
			stringbuilder.append(((Object) (exception)));
	//   45  100:aload_2         
	//   46  101:aload_1         
	//   47  102:invokevirtual   #164 <Method StringBuilder StringBuilder.append(Object)>
	//   48  105:pop             
			addError(stringbuilder.toString(), ((Throwable) (exception)));
	//   49  106:aload_0         
	//   50  107:aload_2         
	//   51  108:invokevirtual   #167 <Method String StringBuilder.toString()>
	//   52  111:aload_1         
	//   53  112:invokevirtual   #171 <Method void addError(String, Throwable)>
			return;
	//   54  115:return          
		}
	}
	...
	//    6   12:invokeinterface #176 <Method void ServerRunner.stop()>
			super.stop();
	//    7   17:aload_0         
	//    8   18:invokespecial   #177 <Method void AppenderBase.stop()>
			return;
	//    9   21:return          
		}
	...
	//*  10   22:astore_1        
		{
			StringBuilder stringbuilder = new StringBuilder();
	//   11   23:new             #155 <Class StringBuilder>
	//   12   26:dup             
	//   13   27:invokespecial   #156 <Method void StringBuilder()>
	//   14   30:astore_2        
			stringbuilder.append("server shutdown error: ");
	//   15   31:aload_2         
	//   16   32:ldc1            #179 <String "server shutdown error: ">
	//   17   34:invokevirtual   #161 <Method StringBuilder StringBuilder.append(String)>
	//   18   37:pop             
			stringbuilder.append(((Object) (ioexception)));
	//   19   38:aload_2         
	//   20   39:aload_1         
	//   21   40:invokevirtual   #164 <Method StringBuilder StringBuilder.append(Object)>
	//   22   43:pop             
			addError(stringbuilder.toString(), ((Throwable) (ioexception)));
	//   23   44:aload_0         
	//   24   45:aload_2         
	//   25   46:invokevirtual   #167 <Method String StringBuilder.toString()>
	//   26   49:aload_1         
	//   27   50:invokevirtual   #171 <Method void addError(String, Throwable)>
			return;
	//   28   53:return          
		}
	}
