...
public class LineOfCallerConverter extends ClassicConverter
{
	...
	//*   6   12:arraylength     
	//*   7   13:ifle            26
			return Integer.toString(((StackTraceElement) (iloggingevent[0])).getLineNumber());
	//    8   16:aload_1         
	//    9   17:iconst_0        
	//   10   18:aaload          
	//   11   19:invokevirtual   #23  <Method int StackTraceElement.getLineNumber()>
	//   12   22:invokestatic    #29  <Method String Integer.toString(int)>
	//   13   25:areturn         
		else
			return "?";
	//   14   26:ldc1            #31  <String "?">
	//   15   28:areturn         
	}
	...
	//    3    5:invokevirtual   #34  <Method String convert(ILoggingEvent)>
	//    4    8:areturn         
	}
}
