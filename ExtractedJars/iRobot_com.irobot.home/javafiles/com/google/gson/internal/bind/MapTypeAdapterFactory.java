	...
	implements TypeAdapterFactory
{
	...
	//*   0    0:aload_2         
	//*   1    1:getstatic       #33  <Field Class Boolean.TYPE>
	//*   2    4:if_acmpeq       25
	//*   3    7:aload_2         
	//*   4    8:ldc1            #29  <Class Boolean>
	//*   5   10:if_acmpne       16
	//*   6   13:goto            25
			return gson.getAdapter(TypeToken.get(type));
	//    7   16:aload_1         
	//    8   17:aload_2         
	//    9   18:invokestatic    #39  <Method TypeToken TypeToken.get(Type)>
	//   10   21:invokevirtual   #45  <Method TypeAdapter Gson.getAdapter(TypeToken)>
	//   11   24:areturn         
		else
			return TypeAdapters.BOOLEAN_AS_STRING;
	//   12   25:getstatic       #51  <Field TypeAdapter TypeAdapters.BOOLEAN_AS_STRING>
	//   13   28:areturn         
	}
	...
	//    0    0:aload_2         
	//    1    1:invokevirtual   #59  <Method Type TypeToken.getType()>
	//    2    4:astore_3        
		if(!((Class) (java/util/Map)).isAssignableFrom(typetoken.getRawType()))
	//*   3    5:ldc1            #61  <Class Map>
	//*   4    7:aload_2         
	//*   5    8:invokevirtual   #65  <Method Class TypeToken.getRawType()>
	//*   6   11:invokevirtual   #71  <Method boolean Class.isAssignableFrom(Class)>
	//*   7   14:ifne            19
		{
			return null;
	//    8   17:aconst_null     
	...
	//   10   19:aload_3         
	//   11   20:aload_3         
	//   12   21:invokestatic    #76  <Method Class com.google.gson.internal.$Gson$Types.getRawType(Type)>
	//   13   24:invokestatic    #80  <Method Type[] com.google.gson.internal.$Gson$Types.getMapKeyAndValueTypes(Type, Class)>
	//   14   27:astore_3        
	...
	//   18   31:iconst_0        
	//   19   32:aaload          
	//   20   33:invokespecial   #82  <Method TypeAdapter getKeyAdapter(Gson, Type)>
	//   21   36:astore          4
	...
	//   24   40:iconst_1        
	//   25   41:aaload          
	//   26   42:invokestatic    #39  <Method TypeToken TypeToken.get(Type)>
	//   27   45:invokevirtual   #45  <Method TypeAdapter Gson.getAdapter(TypeToken)>
	//   28   48:astore          5
	...
	//   31   54:aload_2         
	//   32   55:invokevirtual   #87  <Method ObjectConstructor ConstructorConstructor.get(TypeToken)>
	//   33   58:astore_2        
	...
	//   45   73:aload           5
	//   46   75:aload_2         
	//   47   76:invokespecial   #90  <Method void MapTypeAdapterFactory$Adapter(MapTypeAdapterFactory, Gson, Type, TypeAdapter, Type, TypeAdapter, ObjectConstructor)>
	//   48   79:areturn         
		}
	}
...
/*
	static boolean access$000(MapTypeAdapterFactory maptypeadapterfactory)
	{
		return maptypeadapterfactory.complexMapKeySerialization;
	//    0    0:aload_0         
	//    1    1:getfield        #22  <Field boolean complexMapKeySerialization>
	//    2    4:ireturn         
	}
