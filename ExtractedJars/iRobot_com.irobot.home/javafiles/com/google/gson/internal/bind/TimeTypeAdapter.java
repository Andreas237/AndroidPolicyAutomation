...
public final class TimeTypeAdapter extends TypeAdapter
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #34  <Method Time read(JsonReader)>
	//    3    5:areturn         
	}
	...
	//   12   20:new             #53  <Class Time>
	//   13   23:dup             
	//   14   24:aload_0         
	//   15   25:getfield        #29  <Field DateFormat format>
	//   16   28:aload_1         
	//   17   29:invokevirtual   #57  <Method String JsonReader.nextString()>
	//   18   32:invokevirtual   #63  <Method Date DateFormat.parse(String)>
	//   19   35:invokevirtual   #69  <Method long Date.getTime()>
	//   20   38:invokespecial   #72  <Method void Time(long)>
	//   21   41:astore_1        
		this;
	//   22   42:aload_0         
		JVM INSTR monitorexit ;
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:checkcast       #53  <Class Time>
	//    4    6:invokevirtual   #82  <Method void write(JsonWriter, Time)>
	//    5    9:return          
	}
	...
	//    9   15:aload_2         
	//   10   16:invokevirtual   #85  <Method String DateFormat.format(Date)>
	//   11   19:astore_2        
