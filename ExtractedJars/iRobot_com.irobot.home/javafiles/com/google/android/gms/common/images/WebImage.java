...
public final class WebImage extends AbstractSafeParcelable
{
	...
	//    2    2:iconst_0        
	//    3    3:iconst_0        
	//    4    4:invokespecial   #55  <Method void WebImage(Uri, int, int)>
	//    5    7:return          
	}
	...
	//    3    3:iload_2         
	//    4    4:iload_3         
	//    5    5:invokespecial   #57  <Method void WebImage(int, Uri, int, int)>
		if(uri == null)
	//*   6    8:aload_1         
	//*   7    9:ifnonnull       22
			throw new IllegalArgumentException("url cannot be null");
	//    8   12:new             #59  <Class IllegalArgumentException>
	//    9   15:dup             
	//   10   16:ldc1            #61  <String "url cannot be null">
	//   11   18:invokespecial   #64  <Method void IllegalArgumentException(String)>
	//   12   21:athrow          
		if(i >= 0 && j >= 0)
	//*  13   22:iload_2         
	//*  14   23:iflt            34
	...
	//   19   34:new             #59  <Class IllegalArgumentException>
	//   20   37:dup             
	//   21   38:ldc1            #66  <String "width and height must not be negative">
	//   22   40:invokespecial   #64  <Method void IllegalArgumentException(String)>
	//   23   43:athrow          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #72  <Method Uri zaa(JSONObject)>
	//    3    5:aload_1         
	...
	//   11   19:invokespecial   #55  <Method void WebImage(Uri, int, int)>
	//   12   22:return          
	}
...
_L1:
	...
	//   14   24:astore_1        
			if(Objects.equal(((Object) (zanf)), ((Object) (((WebImage) (obj)).zanf))) && zand == ((WebImage) (obj)).zand && zane == ((WebImage) (obj)).zane)
	//*  15   25:aload_0         
