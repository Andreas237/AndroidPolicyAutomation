	...
	implements android.content.DialogInterface.OnCancelListener
{
	...
	//    9   16:putfield        #16  <Field int zabp>
		if(zabp == 1) goto _L2; else goto _L1
	//   10   19:aload_0         
...
_L3:
	...
	//   20   39:ldc1            #115 <String "Activity started without extras">
	//   21   41:astore_1        
_L8:
		Log.e("GoogleApiActivity", ((String) (bundle)));
	//   22   42:ldc1            #117 <String "GoogleApiActivity">
	//   23   44:aload_1         
	//   24   45:invokestatic    #123 <Method int Log.e(String, String)>
	//   25   48:pop             
_L6:
		finish();
	//   26   49:aload_0         
	//   27   50:invokevirtual   #90  <Method void finish()>
		return;
	//   28   53:return          
_L4:
		bundle = ((Bundle) ((PendingIntent)((Bundle) (obj)).get("pending_intent")));
	//   29   54:aload_2         
	//   30   55:ldc1            #36  <String "pending_intent">
	//   31   57:invokevirtual   #127 <Method Object Bundle.get(String)>
	//   32   60:checkcast       #25  <Class PendingIntent>
	//   33   63:astore_1        
		obj = ((Object) ((Integer)((Bundle) (obj)).get("error_code")));
	//   34   64:aload_2         
	//   35   65:ldc1            #129 <String "error_code">
	//   36   67:invokevirtual   #127 <Method Object Bundle.get(String)>
	//   37   70:checkcast       #131 <Class Integer>
	//   38   73:astore_2        
	...
	//   43   82:ldc1            #133 <String "Activity started without resolution">
	//   44   84:astore_1        
	...
	//   48   92:aload_0         
	//   49   93:aload_1         
	//   50   94:invokevirtual   #137 <Method android.content.IntentSender PendingIntent.getIntentSender()>
	//   51   97:iconst_1        
	//   52   98:aconst_null     
	//   53   99:iconst_0        
	//   54  100:iconst_0        
	//   55  101:iconst_0        
	//   56  102:invokevirtual   #141 <Method void startIntentSenderForResult(android.content.IntentSender, int, Intent, int, int, int)>
			zabp = 1;
	//   57  105:aload_0         
	//   58  106:iconst_1        
	//   59  107:putfield        #16  <Field int zabp>
			return;
	//   60  110:return          
		}
	...
	//   62  112:ldc1            #117 <String "GoogleApiActivity">
	//   63  114:ldc1            #143 <String "Failed to launch pendingIntent">
	//   64  116:aload_1         
	//   65  117:invokestatic    #146 <Method int Log.e(String, String, Throwable)>
	//   66  120:pop             
		}
...
_L5:
	...
	//   68  124:invokestatic    #152 <Method GoogleApiAvailability GoogleApiAvailability.getInstance()>
	//   69  127:aload_0         
	//   70  128:aload_2         
	//   71  129:invokevirtual   #156 <Method int Integer.intValue()>
	//   72  132:iconst_2        
	//   73  133:aload_0         
	//   74  134:invokevirtual   #160 <Method boolean GoogleApiAvailability.showErrorDialogFragment(Activity, int, int, android.content.DialogInterface$OnCancelListener)>
	//   75  137:pop             
		zabp = 1;
	//   76  138:aload_0         
	//   77  139:iconst_1        
	//   78  140:putfield        #16  <Field int zabp>
_L2:
		return;
	//   79  143:return          
