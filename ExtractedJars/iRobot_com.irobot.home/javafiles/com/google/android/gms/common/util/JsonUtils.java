...
public final class JsonUtils
{
	...
	//    2    2:aload_0         
	//    3    3:invokestatic    #84  <Method boolean TextUtils.isEmpty(CharSequence)>
	//    4    6:ifne            201
_L1:
		Matcher matcher;
		matcher = zzhc.matcher(((CharSequence) (s)));
	//    5    9:getstatic       #25  <Field Pattern zzhc>
	//    6   12:aload_0         
	//    7   13:invokevirtual   #88  <Method Matcher Pattern.matcher(CharSequence)>
	//    8   16:astore          4
		obj = null;
	//    9   18:aconst_null     
	//   10   19:astore_2        
_L17:
	...
	//   11   20:aload           4
	//   12   22:invokevirtual   #93  <Method boolean Matcher.find()>
	//   13   25:ifeq            183
_L3:
		char c;
		Object obj1;
	...
	//   18   34:new             #95  <Class StringBuffer>
	//   19   37:dup             
	//   20   38:invokespecial   #96  <Method void StringBuffer()>
	//   21   41:astore_3        
		c = matcher.group().charAt(0);
	//   22   42:aload           4
	//   23   44:invokevirtual   #100 <Method String Matcher.group()>
	//   24   47:iconst_0        
	//   25   48:invokevirtual   #104 <Method char String.charAt(int)>
	//   26   51:istore_1        
...
_L14:
		obj = "\\\\n";
	//   49  137:ldc1            #110 <String "\\\\n">
	//   50  139:astore_2        
		break; /* Loop/switch isn't completed */
	//   51  140:goto            146
_L13:
		obj = "\\\\t";
	//   52  143:ldc1            #112 <String "\\\\t">
	//   53  145:astore_2        
_L15:
	...
	//   55  148:aload_3         
	//   56  149:aload_2         
	//   57  150:invokevirtual   #116 <Method Matcher Matcher.appendReplacement(StringBuffer, String)>
	//   58  153:pop             
		obj = obj1;
	//   59  154:aload_3         
	//   60  155:astore_2        
...
_L12:
		obj = "\\\\b";
	//   62  159:ldc1            #118 <String "\\\\b">
	//   63  161:astore_2        
		continue; /* Loop/switch isn't completed */
	//   64  162:goto            146
_L10:
		obj = "\\\\\\\\";
	//   65  165:ldc1            #120 <String "\\\\\\\\">
	//   66  167:astore_2        
		continue; /* Loop/switch isn't completed */
	//   67  168:goto            146
_L8:
		obj = "\\\\/";
	//   68  171:ldc1            #122 <String "\\\\/">
	//   69  173:astore_2        
		continue; /* Loop/switch isn't completed */
	//   70  174:goto            146
_L6:
		obj = "\\\\\\\"";
	//   71  177:ldc1            #124 <String "\\\\\\\"">
	//   72  179:astore_2        
...
_L4:
	...
	//   78  189:aload           4
	//   79  191:aload_2         
	//   80  192:invokevirtual   #128 <Method StringBuffer Matcher.appendTail(StringBuffer)>
	//   81  195:pop             
		obj = ((Object) (((StringBuffer) (obj)).toString()));
	//   82  196:aload_2         
	//   83  197:invokevirtual   #131 <Method String StringBuffer.toString()>
	//   84  200:astore_2        
_L2:
		return ((String) (obj));
	//   85  201:aload_2         
...
_L16:
	...
	//    5    9:aload_0         
	//    6   10:invokestatic    #137 <Method String zzd.unescape(String)>
	//    7   13:astore_3        
			Matcher matcher = zzhb.matcher(((CharSequence) (s1)));
	//    8   14:getstatic       #21  <Field Pattern zzhb>
	//    9   17:aload_3         
	//   10   18:invokevirtual   #88  <Method Matcher Pattern.matcher(CharSequence)>
	//   11   21:astore          4
			for(s = null; matcher.find(); s = ((String) (obj)))
	//*  12   23:aconst_null     
	//*  13   24:astore_0        
	//*  14   25:aload           4
	//*  15   27:invokevirtual   #93  <Method boolean Matcher.find()>
	//*  16   30:ifeq            173
			{
				obj = ((Object) (s));
	//   17   33:aload_0         
	...
	//   21   39:new             #95  <Class StringBuffer>
	//   22   42:dup             
	//   23   43:invokespecial   #96  <Method void StringBuffer()>
	//   24   46:astore_2        
				char c = matcher.group().charAt(1);
	//   25   47:aload           4
	//   26   49:invokevirtual   #100 <Method String Matcher.group()>
	//   27   52:iconst_1        
	//   28   53:invokevirtual   #104 <Method char String.charAt(int)>
	//   29   56:istore_1        
				if(c != '"')
	//*  30   57:iload_1         
	//*  31   58:bipush          34
	...
	//   54  105:new             #139 <Class IllegalStateException>
	//   55  108:dup             
	//   56  109:ldc1            #141 <String "Found an escaped character that should never be.">
	//   57  111:invokespecial   #144 <Method void IllegalStateException(String)>
	//   58  114:athrow          
											s = "\t";
	//   59  115:ldc1            #146 <String "\t">
	//   60  117:astore_0        
										} else
	//*  61  118:goto            160
										{
											s = "\r";
	//   62  121:ldc1            #148 <String "\r">
	//   63  123:astore_0        
										}
									} else
	//*  64  124:goto            160
	...
	//   83  162:aload_2         
	//   84  163:aload_0         
	//   85  164:invokevirtual   #116 <Method Matcher Matcher.appendReplacement(StringBuffer, String)>
	//   86  167:pop             
			}
	...
	//   94  179:aload           4
	//   95  181:aload_0         
	//   96  182:invokevirtual   #128 <Method StringBuffer Matcher.appendTail(StringBuffer)>
	//   97  185:pop             
			obj = ((Object) (((StringBuffer) (s)).toString()));
	//   98  186:aload_0         
	//   99  187:invokevirtual   #131 <Method String StringBuffer.toString()>
	//  100  190:astore_2        
		}
		return ((String) (obj));
	//  101  191:aload_2         
