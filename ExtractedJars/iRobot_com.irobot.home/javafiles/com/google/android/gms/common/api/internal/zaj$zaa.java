	...
	implements com.google.android.gms.common.api.iClient.OnConnectionFailedListener
{
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #45  <Method String String.valueOf(Object)>
	//    2    4:astore_2        
	...
	//    7   13:invokevirtual   #51  <Method int String.length()>
	//    8   16:bipush          27
	//    9   18:iadd            
	//   10   19:invokespecial   #54  <Method void StringBuilder(int)>
	//   11   22:astore_3        
		stringbuilder.append("beginFailureResolution for ");
	//   12   23:aload_3         
	//   13   24:ldc1            #56  <String "beginFailureResolution for ">
	//   14   26:invokevirtual   #60  <Method StringBuilder StringBuilder.append(String)>
	//   15   29:pop             
		stringbuilder.append(s);
	//   16   30:aload_3         
	//   17   31:aload_2         
	//   18   32:invokevirtual   #60  <Method StringBuilder StringBuilder.append(String)>
	//   19   35:pop             
		Log.d("AutoManageHelper", stringbuilder.toString());
	//   20   36:ldc1            #62  <String "AutoManageHelper">
	//   21   38:aload_3         
	//   22   39:invokevirtual   #66  <Method String StringBuilder.toString()>
	//   23   42:invokestatic    #72  <Method int Log.d(String, String)>
	//   24   45:pop             
	...
	//   30   55:invokevirtual   #78  <Method void zal.zab(ConnectionResult, int)>
	//   31   58:return          
	}

	public final int zacw;
	public final GoogleApiClient zacx;
	public final com.google.android.gms.common.api.iClient.OnConnectionFailedListener zacy;
	private final zaj zacz;

	public zaj$zaa(zaj zaj1, int i, GoogleApiClient googleapiclient, com.google.android.gms.common.api.iClient.OnConnectionFailedListener onconnectionfailedlistener)
	{
		zacz = zaj1;
	//    0    0:aload_0         
	//    1    1:aload_1         
