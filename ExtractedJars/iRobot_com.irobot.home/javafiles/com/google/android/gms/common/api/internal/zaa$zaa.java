...
static class zaa$zaa extends LifecycleCallback
{
	...
	//    2    2:aload_0         
	//    3    3:invokestatic    #39  <Method LifecycleFragment getFragment(Activity)>
	//    4    6:astore_3        
	...
	//    5    7:aload_3         
	//    6    8:ldc1            #27  <String "LifecycleObserverOnStop">
	//    7   10:ldc1            #2   <Class zaa$zaa>
	//    8   12:invokeinterface #43  <Method LifecycleCallback LifecycleFragment.getCallbackOrNull(String, Class)>
	...
	//   16   30:dup             
	//   17   31:aload_3         
	//   18   32:invokespecial   #44  <Method void zaa$zaa(LifecycleFragment)>
	//   19   35:astore_1        
		activity;
	//   20   36:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #48  <Method void zaa(Runnable)>
	//    3    5:return          
	}
	...
	//    2    2:aload_0         
	//    3    3:getfield        #21  <Field List zacl>
	//    4    6:aload_1         
	...
	static zaa$zaa zab(Activity activity)
	{
		return zaa(activity);
	//    0    0:aload_0         
	//    1    1:invokestatic    #57  <Method zaa$zaa zaa(Activity)>
	//    2    4:areturn         
	}
	...
	//    5    7:aload_0         
	//    6    8:new             #16  <Class ArrayList>
	//    7   11:dup             
	//    8   12:invokespecial   #19  <Method void ArrayList()>
	//    9   15:putfield        #21  <Field List zacl>
		this;
	//   10   18:aload_0         
		JVM INSTR monitorexit ;
	//   11   19:monitorexit     
	...
	//   12   20:aload_1         
	//   13   21:invokeinterface #62  <Method Iterator List.iterator()>
	//   14   26:astore_1        
	//   15   27:aload_1         
	//   16   28:invokeinterface #68  <Method boolean Iterator.hasNext()>
	//   17   33:ifeq            53
	//   18   36:aload_1         
	//   19   37:invokeinterface #72  <Method Object Iterator.next()>
	//   20   42:checkcast       #74  <Class Runnable>
	//   21   45:invokeinterface #77  <Method void Runnable.run()>
	//*  22   50:goto            27
		return;
	//   23   53:return          
		Exception exception;
	...
	//    7   13:putfield        #21  <Field List zacl>
	...
	//   10   20:ldc1            #27  <String "LifecycleObserverOnStop">
	//   11   22:aload_0         
