	...
	implements ResultCallback
{
	...
	//   24   48:new             #49  <Class StringBuilder>
	//   25   51:dup             
	//   26   52:aload_1         
	//   27   53:invokestatic    #47  <Method String String.valueOf(Object)>
	//   28   56:invokevirtual   #53  <Method int String.length()>
	//   29   59:bipush          18
	//   30   61:iadd            
	//   31   62:invokespecial   #56  <Method void StringBuilder(int)>
	//   32   65:astore_3        
				stringbuilder.append("Unable to release ");
	//   33   66:aload_3         
	//   34   67:ldc1            #58  <String "Unable to release ">
	//   35   69:invokevirtual   #62  <Method StringBuilder StringBuilder.append(String)>
	//   36   72:pop             
				stringbuilder.append(((String) (result)));
	//   37   73:aload_3         
	//   38   74:aload_1         
	//   39   75:invokevirtual   #62  <Method StringBuilder StringBuilder.append(String)>
	//   40   78:pop             
				Log.w("ResultCallbacks", stringbuilder.toString(), ((Throwable) (runtimeexception)));
	//   41   79:ldc1            #64  <String "ResultCallbacks">
	//   42   81:aload_3         
	//   43   82:invokevirtual   #68  <Method String StringBuilder.toString()>
	//   44   85:aload_2         
	//   45   86:invokestatic    #74  <Method int Log.w(String, String, Throwable)>
	//   46   89:pop             
			}
	//   47   90:return          
	}
