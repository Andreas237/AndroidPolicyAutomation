	...
	implements IResolveAccountCallbacks
{
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #24  <Method android.os.Parcel zaa.zaa()>
	//    2    4:astore_2        
		zac.zaa(parcel, ((android.os.Parcelable) (resolveaccountresponse)));
	//    3    5:aload_2         
	//    4    6:aload_1         
	//    5    7:invokestatic    #29  <Method void zac.zaa(android.os.Parcel, android.os.Parcelable)>
		((zaa)this).zab(2, parcel);
	//    6   10:aload_0         
	//    7   11:iconst_2        
	//    8   12:aload_2         
	//    9   13:invokevirtual   #33  <Method void zaa.zab(int, android.os.Parcel)>
	//   10   16:return          
	}
