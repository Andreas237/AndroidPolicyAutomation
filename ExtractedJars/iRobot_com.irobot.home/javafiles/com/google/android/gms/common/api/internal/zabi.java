	...
	implements BackgroundDetector.BackgroundStateChangeListener
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #12  <Field GoogleApiManager zail>
		super();
	//    3    5:aload_0         
	...
	{
		GoogleApiManager.zaa(zail).sendMessage(GoogleApiManager.zaa(zail).obtainMessage(1, ((Object) (Boolean.valueOf(flag)))));
	//    0    0:aload_0         
	//    1    1:getfield        #12  <Field GoogleApiManager zail>
	//    2    4:invokestatic    #24  <Method Handler GoogleApiManager.zaa(GoogleApiManager)>
	//    3    7:aload_0         
	//    4    8:getfield        #12  <Field GoogleApiManager zail>
	//    5   11:invokestatic    #24  <Method Handler GoogleApiManager.zaa(GoogleApiManager)>
	//    6   14:iconst_1        
	//    7   15:iload_1         
