	...
	implements android.os.Parcelable.Creator
{
	...
	//*  27   77:goto            13
				case 2: // '\002'
					arraylist = SafeParcelReader.createTypedList(parcel, k, zal.CREATOR);
	//   28   80:aload_1         
	//   29   81:iload           4
	//   30   83:getstatic       #47  <Field android.os.Parcelable$Creator zal.CREATOR>
	//   31   86:invokestatic    #51  <Method java.util.ArrayList SafeParcelReader.createTypedList(Parcel, int, android.os.Parcelable$Creator)>
	//   32   89:astore          6
					break;
	...
	//   34   94:aload_1         
	//   35   95:iload           4
	//   36   97:invokestatic    #55  <Method int SafeParcelReader.readInt(Parcel, int)>
	//   37  100:istore_2        
					break;
				}
			} else
	...
	//   39  104:aload_1         
	//   40  105:iload_3         
	//   41  106:invokestatic    #58  <Method void SafeParcelReader.ensureAtEnd(Parcel, int)>
				return ((Object) (new zak(i, arraylist, s)));
	//   42  109:new             #60  <Class zak>
	//   43  112:dup             
	//   44  113:iload_2         
	//   45  114:aload           6
	//   46  116:aload           5
	//   47  118:invokespecial   #63  <Method void zak(int, java.util.ArrayList, String)>
	//   48  121:areturn         
			}
		while(true);
	}
