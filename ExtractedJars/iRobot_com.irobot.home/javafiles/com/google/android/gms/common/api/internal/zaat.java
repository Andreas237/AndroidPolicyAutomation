	...
	implements com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #14  <Field zaak zagi>
	//    2    4:invokestatic    #44  <Method Lock zaak.zac(zaak)>
	//    3    7:invokeinterface #49  <Method void Lock.lock()>
		if(zaak.zab(zagi, connectionresult))
	//*   4   12:aload_0         
	//*   5   13:getfield        #14  <Field zaak zagi>
	//*   6   16:aload_1         
	//*   7   17:invokestatic    #53  <Method boolean zaak.zab(zaak, ConnectionResult)>
	//*   8   20:ifeq            40
		{
			zaak.zai(zagi);
	//    9   23:aload_0         
	//   10   24:getfield        #14  <Field zaak zagi>
	//   11   27:invokestatic    #56  <Method void zaak.zai(zaak)>
			zaak.zaj(zagi);
	//   12   30:aload_0         
	//   13   31:getfield        #14  <Field zaak zagi>
	//   14   34:invokestatic    #59  <Method void zaak.zaj(zaak)>
	...
	//   18   44:aload_1         
	//   19   45:invokestatic    #62  <Method void zaak.zaa(zaak, ConnectionResult)>
		zaak.zac(zagi).unlock();
	//   20   48:aload_0         
	//   21   49:getfield        #14  <Field zaak zagi>
	//   22   52:invokestatic    #44  <Method Lock zaak.zac(zaak)>
	//   23   55:invokeinterface #65  <Method void Lock.unlock()>
		return;
	//   24   60:return          
		connectionresult;
	//   25   61:astore_1        
	...
	//   28   66:invokestatic    #44  <Method Lock zaak.zac(zaak)>
	//   29   69:invokeinterface #65  <Method void Lock.unlock()>
