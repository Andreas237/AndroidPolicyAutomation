...
public final class ConnectionResult extends AbstractSafeParcelable
{
	...
	//    6   10:invokestatic    #174 <Method Integer Integer.valueOf(int)>
	//    7   13:aastore         
	//    8   14:dup             
	//    9   15:iconst_1        
	//   10   16:aload_0         
	...
	//   17   27:aastore         
	//   18   28:invokestatic    #177 <Method int Objects.hashCode(Object[])>
	//   19   31:ireturn         
	}
	...
	public final void startResolutionForResult(Activity activity, int i)
	{
		if(!hasResolution())
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #182 <Method boolean hasResolution()>
	//*   2    4:ifne            8
		{
			return;
	//    3    7:return          
	...
	//    7   13:invokevirtual   #188 <Method android.content.IntentSender PendingIntent.getIntentSender()>
	//    8   16:iload_2         
	//    9   17:aconst_null     
	//   10   18:iconst_0        
	//   11   19:iconst_0        
	//   12   20:iconst_0        
	//   13   21:invokevirtual   #194 <Method void Activity.startIntentSenderForResult(android.content.IntentSender, int, android.content.Intent, int, int, int)>
			return;
	//   14   24:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #198 <Method com.google.android.gms.common.internal.Objects$ToStringHelper Objects.toStringHelper(Object)>
	//    2    4:ldc1            #200 <String "statusCode">
	//    3    6:aload_0         
	//    4    7:getfield        #98  <Field int zzh>
	//    5   10:invokestatic    #202 <Method String zza(int)>
	//    6   13:invokevirtual   #208 <Method com.google.android.gms.common.internal.Objects$ToStringHelper com.google.android.gms.common.internal.Objects$ToStringHelper.add(String, Object)>
	//    7   16:ldc1            #210 <String "resolution">
	//    8   18:aload_0         
	//    9   19:getfield        #100 <Field PendingIntent zzi>
	//   10   22:invokevirtual   #208 <Method com.google.android.gms.common.internal.Objects$ToStringHelper com.google.android.gms.common.internal.Objects$ToStringHelper.add(String, Object)>
	//   11   25:ldc1            #212 <String "message">
	//   12   27:aload_0         
	//   13   28:getfield        #102 <Field String zzj>
	//   14   31:invokevirtual   #208 <Method com.google.android.gms.common.internal.Objects$ToStringHelper com.google.android.gms.common.internal.Objects$ToStringHelper.add(String, Object)>
	//   15   34:invokevirtual   #213 <Method String com.google.android.gms.common.internal.Objects$ToStringHelper.toString()>
	//   16   37:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #221 <Method int SafeParcelWriter.beginObjectHeader(Parcel)>
	//    2    4:istore_3        
	...
	//    7   11:invokestatic    #225 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeInt(parcel, 2, getErrorCode());
	//    8   14:aload_1         
	//    9   15:iconst_2        
	//   10   16:aload_0         
	//   11   17:invokevirtual   #227 <Method int getErrorCode()>
	//   12   20:invokestatic    #225 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeParcelable(parcel, 3, ((android.os.Parcelable) (getResolution())), i, false);
	//   13   23:aload_1         
	//   14   24:iconst_3        
	//   15   25:aload_0         
	//   16   26:invokevirtual   #229 <Method PendingIntent getResolution()>
	//   17   29:iload_2         
	//   18   30:iconst_0        
	//   19   31:invokestatic    #233 <Method void SafeParcelWriter.writeParcelable(Parcel, int, android.os.Parcelable, int, boolean)>
		SafeParcelWriter.writeString(parcel, 4, getErrorMessage(), false);
	//   20   34:aload_1         
	//   21   35:iconst_4        
	//   22   36:aload_0         
	//   23   37:invokevirtual   #235 <Method String getErrorMessage()>
	//   24   40:iconst_0        
	//   25   41:invokestatic    #239 <Method void SafeParcelWriter.writeString(Parcel, int, String, boolean)>
		SafeParcelWriter.finishObjectHeader(parcel, j);
	//   26   44:aload_1         
	//   27   45:iload_3         
	//   28   46:invokestatic    #242 <Method void SafeParcelWriter.finishObjectHeader(Parcel, int)>
	//   29   49:return          
	}
