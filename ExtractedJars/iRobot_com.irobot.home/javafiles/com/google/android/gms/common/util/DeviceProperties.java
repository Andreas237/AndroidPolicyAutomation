...
public final class DeviceProperties
{
	...
	{
		if(zzgr == null)
	//*   0    0:getstatic       #23  <Field Boolean zzgr>
	//*   1    3:ifnonnull       38
		{
			boolean flag;
	...
	//   16   35:putstatic       #23  <Field Boolean zzgr>
		}
		return zzgr.booleanValue();
	//   17   38:getstatic       #23  <Field Boolean zzgr>
	...
	{
		if(zzgp == null)
	//*   0    0:getstatic       #56  <Field Boolean zzgp>
	//*   1    3:ifnonnull       43
		{
	...
	//   20   40:putstatic       #56  <Field Boolean zzgp>
		}
		return zzgp.booleanValue();
	//   21   43:getstatic       #56  <Field Boolean zzgp>
	...
	{
		if(zzgo == null)
	//*   0    0:getstatic       #66  <Field Boolean zzgo>
	//*   1    3:ifnonnull       38
		{
			boolean flag;
	...
	//   14   31:iload_1         
	//   15   32:invokestatic    #49  <Method Boolean Boolean.valueOf(boolean)>
	//   16   35:putstatic       #66  <Field Boolean zzgo>
		}
		return zzgo.booleanValue();
	//   17   38:getstatic       #66  <Field Boolean zzgo>
	//   18   41:invokevirtual   #52  <Method boolean Boolean.booleanValue()>
	//   19   44:ireturn         
	}
...
label1:
	...
	//    5    7:ireturn         
				if(zzgl != null)
					break label0;
	//    6    8:getstatic       #75  <Field Boolean zzgl>
	//    7   11:ifnonnull       105
				boolean flag;
	...
	//*  21   36:ifne            96
				{
					if(zzgm == null)
	//*  22   39:getstatic       #89  <Field Boolean zzgm>
	//*  23   42:ifnonnull       85
					{
	...
	//   40   76:iconst_0        
	//   41   77:istore_2        
						zzgm = Boolean.valueOf(flag1);
	//   42   78:iload_2         
	//   43   79:invokestatic    #49  <Method Boolean Boolean.valueOf(boolean)>
	//   44   82:putstatic       #89  <Field Boolean zzgm>
					}
					flag2 = flag3;
	//   45   85:iload_3         
	//   46   86:istore_2        
					if(!zzgm.booleanValue())
						break label1;
	//   47   87:getstatic       #89  <Field Boolean zzgm>
	...
	//   51   97:istore_2        
			...
			zzgl = Boolean.valueOf(flag2);
	//   52   98:iload_2         
	//   53   99:invokestatic    #49  <Method Boolean Boolean.valueOf(boolean)>
	//   54  102:putstatic       #75  <Field Boolean zzgl>
		}
		return zzgl.booleanValue();
	//   55  105:getstatic       #75  <Field Boolean zzgl>
	...
	{
		if(zzgs == null)
	//*   0    0:getstatic       #95  <Field Boolean zzgs>
	//*   1    3:ifnonnull       55
		{
			context = ((Context) (context.getPackageManager()));
	//    2    6:aload_0         
	...
	//   25   52:putstatic       #95  <Field Boolean zzgs>
		}
		return zzgs.booleanValue();
	//   26   55:getstatic       #95  <Field Boolean zzgs>
	...
	{
		if(zzgn == null)
	//*   0    0:getstatic       #120 <Field Boolean zzgn>
	//*   1    3:ifnonnull       38
		{
			boolean flag;
	...
	//   12   29:iconst_0        
	//   13   30:istore_1        
			zzgn = Boolean.valueOf(flag);
	//   14   31:iload_1         
	//   15   32:invokestatic    #49  <Method Boolean Boolean.valueOf(boolean)>
	//   16   35:putstatic       #120 <Field Boolean zzgn>
		}
		return zzgn.booleanValue();
	//   17   38:getstatic       #120 <Field Boolean zzgn>
	//   18   41:invokevirtual   #52  <Method boolean Boolean.booleanValue()>
	//   19   44:ireturn         
	}
	...
	{
		if(zzgq == null)
	//*   0    0:getstatic       #137 <Field Boolean zzgq>
	//*   1    3:ifnonnull       47
		{
			boolean flag;
	...
	//   20   44:putstatic       #137 <Field Boolean zzgq>
		}
		return zzgq.booleanValue();
	//   21   47:getstatic       #137 <Field Boolean zzgq>
