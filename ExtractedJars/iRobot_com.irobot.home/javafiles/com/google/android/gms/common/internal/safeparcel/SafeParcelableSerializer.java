...
public final class SafeParcelableSerializer
{
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #19  <Method Object Preconditions.checkNotNull(Object)>
	//    2    4:pop             
		Parcel parcel = Parcel.obtain();
	//    3    5:invokestatic    #25  <Method Parcel Parcel.obtain()>
	//    4    8:astore_2        
	...
	//    8   12:aload_0         
	//    9   13:arraylength     
	//   10   14:invokevirtual   #29  <Method void Parcel.unmarshall(byte[], int, int)>
		parcel.setDataPosition(0);
	//   11   17:aload_2         
	//   12   18:iconst_0        
	//   13   19:invokevirtual   #33  <Method void Parcel.setDataPosition(int)>
		abyte0 = ((byte []) ((SafeParcelable)creator.createFromParcel(parcel)));
	//   14   22:aload_1         
	//   15   23:aload_2         
	//   16   24:invokeinterface #39  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
	//   17   29:checkcast       #41  <Class SafeParcelable>
	//   18   32:astore_0        
		parcel.recycle();
	//   19   33:aload_2         
	//   20   34:invokevirtual   #44  <Method void Parcel.recycle()>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #55  <Method byte[] Intent.getByteArrayExtra(String)>
	//    3    5:astore_0        
		if(intent == null)
	//*   4    6:aload_0         
	//*   5    7:ifnonnull       12
	...
	//    8   12:aload_0         
	//    9   13:aload_2         
	//   10   14:invokestatic    #57  <Method SafeParcelable deserializeFromBytes(byte[], android.os.Parcelable$Creator)>
	//   11   17:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #65  <Method byte[] Base64Utils.decodeUrlSafe(String)>
	//    2    4:aload_1         
	//    3    5:invokestatic    #57  <Method SafeParcelable deserializeFromBytes(byte[], android.os.Parcelable$Creator)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #74  <Method java.io.Serializable Bundle.getSerializable(String)>
	//    3    5:checkcast       #76  <Class ArrayList>
	//    4    8:astore_1        
		if(s == null)
	//*   5    9:aload_1         
	//*   6   10:ifnonnull       15
	...
	//    9   15:new             #76  <Class ArrayList>
	//   10   18:dup             
	//   11   19:aload_1         
	//   12   20:invokevirtual   #80  <Method int ArrayList.size()>
	//   13   23:invokespecial   #82  <Method void ArrayList(int)>
	//   14   26:astore_0        
		s = ((String) ((ArrayList)s));
	//   15   27:aload_1         
	//   16   28:checkcast       #76  <Class ArrayList>
	//   17   31:astore_1        
	...
	//   26   46:aload_1         
	//   27   47:iload_3         
	//   28   48:invokevirtual   #86  <Method Object ArrayList.get(int)>
	//   29   51:astore          5
			i++;
	//   30   53:iload_3         
	//   31   54:iconst_1        
	...
	//   34   57:aload_0         
	//   35   58:aload           5
	//   36   60:checkcast       #88  <Class byte[]>
	//   37   63:aload_2         
	//   38   64:invokestatic    #57  <Method SafeParcelable deserializeFromBytes(byte[], android.os.Parcelable$Creator)>
	//   39   67:invokevirtual   #92  <Method boolean ArrayList.add(Object)>
	//   40   70:pop             
		}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #98  <Method java.io.Serializable Intent.getSerializableExtra(String)>
	//    3    5:checkcast       #76  <Class ArrayList>
	//    4    8:astore_1        
		if(s == null)
	//*   5    9:aload_1         
	...
	//    1    3:dup             
	//    2    4:invokespecial   #102 <Method void ArrayList()>
	//    3    7:astore_3        
	...
	//    4    8:aload_0         
	//    5    9:invokeinterface #108 <Method Iterator Iterable.iterator()>
	//    6   14:astore_0        
	//    7   15:aload_0         
	//    8   16:invokeinterface #114 <Method boolean Iterator.hasNext()>
	//    9   21:ifeq            44
	//   10   24:aload_3         
	//   11   25:aload_0         
	//   12   26:invokeinterface #118 <Method Object Iterator.next()>
	//   13   31:checkcast       #41  <Class SafeParcelable>
	//   14   34:invokestatic    #122 <Method byte[] serializeToBytes(SafeParcelable)>
	//   15   37:invokevirtual   #92  <Method boolean ArrayList.add(Object)>
	//   16   40:pop             
	//*  17   41:goto            15
	...
	//   19   45:aload_2         
	//   20   46:aload_3         
	//   21   47:invokevirtual   #126 <Method void Bundle.putSerializable(String, java.io.Serializable)>
	//   22   50:return          
	}
	...
	//   19   45:aload_2         
	//   20   46:aload_3         
	//   21   47:invokevirtual   #133 <Method Intent Intent.putExtra(String, java.io.Serializable)>
	//   22   50:pop             
	//   23   51:return          
	}
	...
	//    3    5:aload_1         
	//    4    6:iconst_0        
	//    5    7:invokeinterface #138 <Method void SafeParcelable.writeToParcel(Parcel, int)>
		safeparcelable = ((SafeParcelable) (parcel.marshall()));
	//    6   12:aload_1         
	//    7   13:invokevirtual   #142 <Method byte[] Parcel.marshall()>
	//    8   16:astore_0        
		parcel.recycle();
	//    9   17:aload_1         
	//   10   18:invokevirtual   #44  <Method void Parcel.recycle()>
	...
	//    1    1:aload_2         
	//    2    2:aload_0         
	//    3    3:invokestatic    #122 <Method byte[] serializeToBytes(SafeParcelable)>
	//    4    6:invokevirtual   #148 <Method Intent Intent.putExtra(String, byte[])>
	//    5    9:pop             
	//    6   10:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #122 <Method byte[] serializeToBytes(SafeParcelable)>
	//    2    4:invokestatic    #155 <Method String Base64Utils.encodeUrlSafe(byte[])>
	//    3    7:areturn         
	}
}
