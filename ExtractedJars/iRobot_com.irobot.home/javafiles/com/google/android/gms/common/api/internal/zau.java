	...
	implements zabt
{
	...
	//    3    7:invokeinterface #32  <Method void Lock.lock()>
		if(!zas.zac(zaep) && zas.zad(zaep) != null && zas.zad(zaep).isSuccess()) goto _L2; else goto _L1
	//    4   12:aload_0         
...
_L3:
	...
	//   44  102:astore_3        
		zas.zaa(zaep).unlock();
	//   45  103:aload_0         
	//   46  104:getfield        #12  <Field zas zaep>
	//   47  107:invokestatic    #27  <Method Lock zas.zaa(zas)>
	...
	//    5   13:getfield        #12  <Field zas zaep>
	//    6   16:aload_1         
	//    7   17:invokestatic    #69  <Method void zas.zaa(zas, Bundle)>
		zas.zaa(zaep, ConnectionResult.RESULT_SUCCESS);
	//    8   20:aload_0         
	//    9   21:getfield        #12  <Field zas zaep>
	//   10   24:getstatic       #73  <Field ConnectionResult ConnectionResult.RESULT_SUCCESS>
	//   11   27:invokestatic    #76  <Method ConnectionResult zas.zaa(zas, ConnectionResult)>
	//   12   30:pop             
		zas.zab(zaep);
	//   13   31:aload_0         
	//   14   32:getfield        #12  <Field zas zaep>
	//   15   35:invokestatic    #78  <Method void zas.zab(zas)>
		zas.zaa(zaep).unlock();
	//   16   38:aload_0         
	...
	//    5   13:getfield        #12  <Field zas zaep>
	//    6   16:aload_1         
	//    7   17:invokestatic    #76  <Method ConnectionResult zas.zaa(zas, ConnectionResult)>
	//    8   20:pop             
		zas.zab(zaep);
	//    9   21:aload_0         
	//   10   22:getfield        #12  <Field zas zaep>
	//   11   25:invokestatic    #78  <Method void zas.zab(zas)>
		zas.zaa(zaep).unlock();
	//   12   28:aload_0         
