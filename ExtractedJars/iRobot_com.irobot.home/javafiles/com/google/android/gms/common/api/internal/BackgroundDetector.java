	...
	implements android.app.Application.ActivityLifecycleCallbacks, ComponentCallbacks2
{
	...
	//    6   12:putfield        #39  <Field AtomicBoolean zzat>
	//    7   15:aload_0         
	//    8   16:new             #36  <Class AtomicBoolean>
	//    9   19:dup             
	//   10   20:invokespecial   #37  <Method void AtomicBoolean()>
	//   11   23:putfield        #41  <Field AtomicBoolean zzau>
	//   12   26:aload_0         
	//   13   27:new             #43  <Class ArrayList>
	//   14   30:dup             
	//   15   31:invokespecial   #44  <Method void ArrayList()>
	//   16   34:putfield        #46  <Field ArrayList zzav>
		zzaw = false;
	//   17   37:aload_0         
	//   18   38:iconst_0        
	//   19   39:putfield        #48  <Field boolean zzaw>
	//   20   42:return          
	}
	...
	{
		return zzas;
	//    0    0:getstatic       #32  <Field BackgroundDetector zzas>
	//    1    3:areturn         
	}
	...
	//*   3    5:monitorenter    
		{
			if(!zzas.zzaw)
	//*   4    6:getstatic       #32  <Field BackgroundDetector zzas>
	//*   5    9:getfield        #48  <Field boolean zzaw>
	//*   6   12:ifne            36
			{
				application.registerActivityLifecycleCallbacks(((android.app.Application.ActivityLifecycleCallbacks) (zzas)));
	//    7   15:aload_0         
	//    8   16:getstatic       #32  <Field BackgroundDetector zzas>
	//    9   19:invokevirtual   #59  <Method void Application.registerActivityLifecycleCallbacks(android.app.Application$ActivityLifecycleCallbacks)>
				application.registerComponentCallbacks(((android.content.ComponentCallbacks) (zzas)));
	//   10   22:aload_0         
	//   11   23:getstatic       #32  <Field BackgroundDetector zzas>
	//   12   26:invokevirtual   #63  <Method void Application.registerComponentCallbacks(android.content.ComponentCallbacks)>
				zzas.zzaw = true;
	//   13   29:getstatic       #32  <Field BackgroundDetector zzas>
	//   14   32:iconst_1        
	//   15   33:putfield        #48  <Field boolean zzaw>
			}
		}
	//   16   36:aload_1         
	//   17   37:monitorexit     
	...
	//    3    7:monitorenter    
		int j;
		ArrayList arraylist;
		arraylist = (ArrayList)zzav;
	//    4    8:aload_0         
	//    5    9:getfield        #46  <Field ArrayList zzav>
...
_L1:
	...
	//*   3    5:monitorenter    
		{
			zzav.add(((Object) (backgroundstatechangelistener)));
	//    4    6:aload_0         
	//    5    7:getfield        #46  <Field ArrayList zzav>
	//    6   10:aload_1         
	...
	public final boolean isInBackground()
	{
		return zzat.get();
	//    0    0:aload_0         
	//    1    1:getfield        #39  <Field AtomicBoolean zzat>
	...
	{
		boolean flag = zzat.compareAndSet(true, false);
	//    0    0:aload_0         
	//    1    1:getfield        #39  <Field AtomicBoolean zzat>
	//    2    4:iconst_1        
	//    3    5:iconst_0        
	...
	//    5    9:istore_3        
		zzau.set(true);
	//    6   10:aload_0         
	//    7   11:getfield        #41  <Field AtomicBoolean zzau>
	//    8   14:iconst_1        
	...
	{
		if(i == 20 && zzat.compareAndSet(false, true))
	//*   0    0:iload_1         
	//*   1    1:bipush          20
	//*   2    3:icmpne          31
	//*   3    6:aload_0         
	//*   4    7:getfield        #39  <Field AtomicBoolean zzat>
	//*   5   10:iconst_0        
	//*   6   11:iconst_1        
	...
	//*   8   15:ifeq            31
		{
			zzau.set(true);
	//    9   18:aload_0         
	//   10   19:getfield        #41  <Field AtomicBoolean zzau>
	//   11   22:iconst_1        
	...
	public final boolean readCurrentStateIfPossible(boolean flag)
	{
		if(!zzau.get())
	//*   0    0:aload_0         
	//*   1    1:getfield        #41  <Field AtomicBoolean zzau>
	//*   2    4:invokevirtual   #85  <Method boolean AtomicBoolean.get()>
	//*   3    7:ifne            61
	...
	//   11   25:invokestatic    #125 <Method void ActivityManager.getMyMemoryState(android.app.ActivityManager$RunningAppProcessInfo)>
				if(!zzau.getAndSet(true) && runningappprocessinfo.importance > 100)
	//*  12   28:aload_0         
	//*  13   29:getfield        #41  <Field AtomicBoolean zzau>
	//*  14   32:iconst_1        
	...
	//*  20   45:icmple          61
					zzat.set(true);
	//   21   48:aload_0         
	//   22   49:getfield        #39  <Field AtomicBoolean zzat>
	//   23   52:iconst_1        
	...
	private final ArrayList zzav = new ArrayList();
	...
	//    3    7:putstatic       #32  <Field BackgroundDetector zzas>
	//*   4   10:return          
	}
}
