	...
	implements zabs
{
	...
	//   77  143:new             #90  <Class a>
	//   78  146:dup             
	//   79  147:invokespecial   #91  <Method void a()>
	//   80  150:astore_1        
		for(zaaw1 = ((zaaw) (map1.keySet().iterator())); ((Iterator) (zaaw1)).hasNext(); ((a) (context)).put(((Object) ((com.google.android.gms.common.api.Api.AnyClientKey)((Iterator) (zaaw1)).next())), ((Object) (zaee))));
	//   81  151:aload           7
	...
	//   94  187:invokevirtual   #119 <Method Object a.put(Object, Object)>
	//   95  190:pop             
	//*  96  191:goto            164
		for(zaaw1 = ((zaaw) (map.keySet().iterator())); ((Iterator) (zaaw1)).hasNext(); ((a) (context)).put(((Object) ((com.google.android.gms.common.api.Api.AnyClientKey)((Iterator) (zaaw1)).next())), ((Object) (zaef))));
	//   97  194:aload           6
	...
	//  110  230:invokevirtual   #119 <Method Object a.put(Object, Object)>
	//  111  233:pop             
	//* 112  234:goto            207
	...
	//    0    0:new             #90  <Class a>
	//    1    3:dup             
	//    2    4:invokespecial   #91  <Method void a()>
	//    3    7:astore          13
		a a3 = new a();
	//    4    9:new             #90  <Class a>
	//    5   12:dup             
	//    6   13:invokespecial   #91  <Method void a()>
	//    7   16:astore          14
	...
	//*  32   90:ifeq            116
				((Map) (a2)).put(((Object) ((com.google.android.gms.common.api.Api.AnyClientKey)entry.getKey())), ((Object) (client)));
	//   33   93:aload           13
	//   34   95:aload           16
	...
	//*  40  113:goto            35
				((Map) (a3)).put(((Object) ((com.google.android.gms.common.api.Api.AnyClientKey)entry.getKey())), ((Object) (client)));
	//   41  116:aload           14
	//   42  118:aload           16
	...
	//*  48  136:goto            35
		Preconditions.checkState(((Map) (a2)).isEmpty() ^ true, "CompositeGoogleApiClient should not be used without any APIs that require sign-in.");
	//   49  139:aload           13
	...
	//   54  150:invokestatic    #162 <Method void Preconditions.checkState(boolean, Object)>
		a a1 = new a();
	//   55  153:new             #90  <Class a>
	//   56  156:dup             
	//   57  157:invokespecial   #91  <Method void a()>
	//   58  160:astore          12
		obj = ((Object) (new a()));
	//   59  162:new             #90  <Class a>
	//   60  165:dup             
	//   61  166:invokespecial   #91  <Method void a()>
	//   62  169:astore          15
	...
	//   76  212:astore          18
			if(((Map) (a2)).containsKey(((Object) (anyclientkey))))
	//*  77  214:aload           13
	//*  78  216:aload           18
	//*  79  218:invokeinterface #172 <Method boolean Map.containsKey(Object)>
	//*  80  223:ifeq            251
				((Map) (a1)).put(((Object) (api)), ((Object) ((Boolean)map1.get(((Object) (api))))));
	//   81  226:aload           12
	//   82  228:aload           17
	//   83  230:aload           7
	//   84  232:aload           17
	...
	//*  89  248:goto            185
			if(((Map) (a3)).containsKey(((Object) (anyclientkey))))
	//*  90  251:aload           14
	//*  91  253:aload           18
	...
	//  137  360:astore          17
			if(((Map) (a1)).containsKey(((Object) (((zaq) (obj1)).mApi))))
	//* 138  362:aload           12
	//* 139  364:aload           17
	...
	//  162  423:athrow          
		...
		return new zas(context, zaaw1, lock, looper, googleapiavailabilitylight, ((Map) (a2)), ((Map) (a3)), clientsettings, abstractclientbuilder, ((com.google.android.gms.common.api.Api.Client) (map)), ((ArrayList) (map1)), arraylist1, ((Map) (a1)), ((Map) (obj)));
	...
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #220 <Field Bundle zaej>
			return;
	//    6   12:return          
		}
		if(bundle != null)
	...
	//*   8   14:ifnull          25
			zaej.putAll(bundle);
	//    9   17:aload_0         
	//   10   18:getfield        #220 <Field Bundle zaej>
	//   11   21:aload_1         
	//   12   22:invokevirtual   #225 <Method void Bundle.putAll(Bundle)>
	//   13   25:return          
	}
	...
	//    9   17:invokestatic    #273 <Method int System.identityHashCode(Object)>
	//   10   20:aload_0         
	//   11   21:getfield        #71  <Field com.google.android.gms.common.api.Api$Client zaei>
	//   12   24:invokeinterface #277 <Method android.content.Intent com.google.android.gms.common.api.Api$Client.getSignInIntent()>
	//   13   29:ldc2            #278 <Int 0x8000000>
	//   14   32:invokestatic    #284 <Method PendingIntent PendingIntent.getActivity(Context, int, android.content.Intent, int)>
	//   15   35:areturn         
	}
	...
	static void zab(zas zas1)
	{
		zas1.zax();
	//    0    0:aload_0         
	//    1    1:invokespecial   #288 <Method void zax()>
	//    2    4:return          
	}
	...
	//    1    1:ifnull          13
	//    2    4:aload_0         
	//    3    5:invokevirtual   #294 <Method boolean ConnectionResult.isSuccess()>
	//    4    8:ifeq            13
	//    5   11:iconst_1        
	//    6   12:ireturn         
	//    7   13:iconst_0        
	...
	//*   2    4:invokestatic    #302 <Method boolean zab(ConnectionResult)>
	//*   3    7:ifeq            132
		{
			if(!zab(zael) && !zaz())
	//*   4   10:aload_0         
	//*   5   11:getfield        #57  <Field ConnectionResult zael>
	//*   6   14:invokestatic    #302 <Method boolean zab(ConnectionResult)>
	//*   7   17:ifne            66
	//*   8   20:aload_0         
	//*   9   21:invokespecial   #305 <Method boolean zaz()>
	//*  10   24:ifeq            30
	//*  11   27:goto            66
			{
				if(zael != null)
	...
	//*  14   34:ifnull          211
					if(zaeo == 1)
	//*  15   37:aload_0         
	//*  16   38:getfield        #61  <Field int zaeo>
	//*  17   41:iconst_1        
	//*  18   42:icmpne          50
					{
						zay();
	//   19   45:aload_0         
	//   20   46:invokespecial   #245 <Method void zay()>
						return;
	//   21   49:return          
					} else
					{
	...
	//   22   50:aload_0         
	//   23   51:aload_0         
	//   24   52:getfield        #57  <Field ConnectionResult zael>
	//   25   55:invokespecial   #307 <Method void zaa(ConnectionResult)>
						zaee.disconnect();
	//   26   58:aload_0         
	//   27   59:getfield        #83  <Field zabe zaee>
	//   28   62:invokevirtual   #310 <Method void zabe.disconnect()>
						return;
	//   29   65:return          
					}
			} else
			{
				switch(zaeo)
	//*  30   66:aload_0         
	//*  31   67:getfield        #61  <Field int zaeo>
				{
	//*  32   70:tableswitch     1 2: default 92
	//	               1 122
	//	               2 111
				default:
	...
	//   33   92:ldc1            #228 <String "CompositeGAC">
	//   34   94:ldc2            #312 <String "Attempted to call success callbacks in CONNECTION_MODE_NONE. Callbacks should be disabled via GmsClientSupervisor">
	//   35   97:new             #314 <Class AssertionError>
	//   36  100:dup             
	//   37  101:invokespecial   #315 <Method void AssertionError()>
	//   38  104:invokestatic    #239 <Method int Log.wtf(String, String, Throwable)>
	//   39  107:pop             
					break;
	...
	//*  40  108:goto            126
				case 2: // '\002'
					zaed.zab(zaej);
	//   41  111:aload_0         
	//   42  112:getfield        #65  <Field zaaw zaed>
	//   43  115:aload_0         
	//   44  116:getfield        #220 <Field Bundle zaej>
	//   45  119:invokevirtual   #317 <Method void zaaw.zab(Bundle)>
					// fall through

				case 1: // '\001'
					zay();
	//   46  122:aload_0         
	//   47  123:invokespecial   #245 <Method void zay()>
					break;
				}
				zaeo = 0;
	//   48  126:aload_0         
	//   49  127:iconst_0        
	//   50  128:putfield        #61  <Field int zaeo>
				return;
	//   51  131:return          
			}
		} else
	...
	//*  52  132:aload_0         
	//*  53  133:getfield        #55  <Field ConnectionResult zaek>
	//*  54  136:ifnull          165
	//*  55  139:aload_0         
	//*  56  140:getfield        #57  <Field ConnectionResult zael>
	//*  57  143:invokestatic    #302 <Method boolean zab(ConnectionResult)>
	//*  58  146:ifeq            165
			{
				zaef.disconnect();
	//   59  149:aload_0         
	//   60  150:getfield        #88  <Field zabe zaef>
	//   61  153:invokevirtual   #310 <Method void zabe.disconnect()>
				zaa(zaek);
	//   62  156:aload_0         
	//   63  157:aload_0         
	//   64  158:getfield        #55  <Field ConnectionResult zaek>
	//   65  161:invokespecial   #307 <Method void zaa(ConnectionResult)>
				return;
	//   66  164:return          
			}
			if(zaek != null && zael != null)
	//*  67  165:aload_0         
	//*  68  166:getfield        #55  <Field ConnectionResult zaek>
	//*  69  169:ifnull          211
	//*  70  172:aload_0         
	//*  71  173:getfield        #57  <Field ConnectionResult zael>
	//*  72  176:ifnull          211
			{
				ConnectionResult connectionresult = zaek;
	//   73  179:aload_0         
	//   74  180:getfield        #55  <Field ConnectionResult zaek>
	//   75  183:astore_1        
				if(zaef.zahr < zaee.zahr)
	//*  76  184:aload_0         
	//*  77  185:getfield        #88  <Field zabe zaef>
	//*  78  188:getfield        #320 <Field int zabe.zahr>
	//*  79  191:aload_0         
	//*  80  192:getfield        #83  <Field zabe zaee>
	//*  81  195:getfield        #320 <Field int zabe.zahr>
	//*  82  198:icmpge          206
					connectionresult = zael;
	//   83  201:aload_0         
	//   84  202:getfield        #57  <Field ConnectionResult zael>
	//   85  205:astore_1        
				zaa(connectionresult);
	//   86  206:aload_0         
	//   87  207:aload_1         
	//   88  208:invokespecial   #307 <Method void zaa(ConnectionResult)>
			}
		}
	//   89  211:return          
	}
	...
	//    9   25:checkcast       #322 <Class SignInConnectionListener>
	//   10   28:invokeinterface #325 <Method void SignInConnectionListener.onComplete()>
	//*  11   33:goto            10
		zaeh.clear();
	//   12   36:aload_0         
	//   13   37:getfield        #53  <Field Set zaeh>
	//   14   40:invokeinterface #328 <Method void Set.clear()>
	//   15   45:return          
	}
	...
	//    2    4:ifnull          20
	//    3    7:aload_0         
	//    4    8:getfield        #57  <Field ConnectionResult zael>
	//    5   11:invokevirtual   #331 <Method int ConnectionResult.getErrorCode()>
	//    6   14:iconst_4        
	//    7   15:icmpne          20
	//    8   18:iconst_1        
	//    9   19:ireturn         
	...
	//    0    0:new             #335 <Class UnsupportedOperationException>
	//    1    3:dup             
	//    2    4:invokespecial   #336 <Method void UnsupportedOperationException()>
	//    3    7:athrow          
	}
	...
	//   14   24:invokevirtual   #340 <Method void zabe.connect()>
		zaef.connect();
	//   15   27:aload_0         
	//   16   28:getfield        #88  <Field zabe zaef>
	//   17   31:invokevirtual   #340 <Method void zabe.connect()>
	//   18   34:return          
	}
	...
	//   11   19:invokevirtual   #310 <Method void zabe.disconnect()>
		zaef.disconnect();
	//   12   22:aload_0         
	//   13   23:getfield        #88  <Field zabe zaef>
	//   14   26:invokevirtual   #310 <Method void zabe.disconnect()>
		zay();
	//   15   29:aload_0         
	...
	//   14   32:aload_3         
	//   15   33:aload           4
	//   16   35:invokevirtual   #369 <Method void zabe.dump(String, FileDescriptor, PrintWriter, String[])>
	...
	//   31   70:aload_3         
	//   32   71:aload           4
	//   33   73:invokevirtual   #369 <Method void zabe.dump(String, FileDescriptor, PrintWriter, String[])>
	//   34   76:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:aload_1         
	//*   2    2:invokespecial   #375 <Method boolean zaa(BaseImplementation$ApiMethodImpl)>
	//*   3    5:ifeq            43
		{
			if(zaz())
	//*   4    8:aload_0         
	//*   5    9:invokespecial   #305 <Method boolean zaz()>
	//*   6   12:ifeq            34
			{
				apimethodimpl.setFailedResult(new Status(4, ((String) (null)), zaaa()));
	//    7   15:aload_1         
	//    8   16:new             #377 <Class Status>
	//    9   19:dup             
	//   10   20:iconst_4        
	//   11   21:aconst_null     
	//   12   22:aload_0         
	//   13   23:invokespecial   #379 <Method PendingIntent zaaa()>
	//   14   26:invokespecial   #382 <Method void Status(int, String, PendingIntent)>
	//   15   29:invokevirtual   #386 <Method void BaseImplementation$ApiMethodImpl.setFailedResult(Status)>
	...
	//   20   38:aload_1         
	//   21   39:invokevirtual   #388 <Method BaseImplementation$ApiMethodImpl zabe.enqueue(BaseImplementation$ApiMethodImpl)>
	//   22   42:areturn         
			}
		} else
		{
	...
	//   25   47:aload_1         
	//   26   48:invokevirtual   #388 <Method BaseImplementation$ApiMethodImpl zabe.enqueue(BaseImplementation$ApiMethodImpl)>
	//   27   51:areturn         
		}
	}
	...
	//   19   35:getfield        #88  <Field zabe zaef>
	//   20   38:aload_1         
	//   21   39:invokevirtual   #392 <Method BaseImplementation$ApiMethodImpl zabe.execute(BaseImplementation$ApiMethodImpl)>
	//   22   42:areturn         
			}
		} else
		{
	...
	//   24   44:getfield        #83  <Field zabe zaee>
	//   25   47:aload_1         
	//   26   48:invokevirtual   #392 <Method BaseImplementation$ApiMethodImpl zabe.execute(BaseImplementation$ApiMethodImpl)>
	//   27   51:areturn         
		}
	}
	...
	//*   9   23:ifeq            55
		{
			if(zaz())
	//*  10   26:aload_0         
	//*  11   27:invokespecial   #305 <Method boolean zaz()>
	//*  12   30:ifeq            46
				return new ConnectionResult(4, zaaa());
	//   13   33:new             #291 <Class ConnectionResult>
	//   14   36:dup             
	//   15   37:iconst_4        
	//   16   38:aload_0         
	//   17   39:invokespecial   #379 <Method PendingIntent zaaa()>
	//   18   42:invokespecial   #398 <Method void ConnectionResult(int, PendingIntent)>
	//   19   45:areturn         
			else
	...
	//   22   50:aload_1         
	//   23   51:invokevirtual   #400 <Method ConnectionResult zabe.getConnectionResult(Api)>
	//   24   54:areturn         
		} else
		{
	...
	//   27   59:aload_1         
	//   28   60:invokevirtual   #400 <Method ConnectionResult zabe.getConnectionResult(Api)>
	//   29   63:areturn         
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #67  <Field Lock zaen>
	//    2    4:invokeinterface #407 <Method void Lock.lock()>
		boolean flag = zaee.isConnected();
	//    3    9:aload_0         
	//    4   10:getfield        #83  <Field zabe zaee>
	//    5   13:invokevirtual   #409 <Method boolean zabe.isConnected()>
	//    6   16:istore_2        
		boolean flag1;
		flag1 = true;
	//    7   17:iconst_1        
	...
	//   15   29:invokevirtual   #409 <Method boolean zabe.isConnected()>
	//   16   32:ifne            61
		flag = flag1;
	//   17   35:iload_3         
	//   18   36:istore_2        
		...
		if(zaz())
			break MISSING_BLOCK_LABEL_61;
	//   19   37:aload_0         
	//   20   38:invokespecial   #305 <Method boolean zaz()>
	//   21   41:ifne            61
		i = zaeo;
	//   22   44:aload_0         
	...
	//   35   65:invokeinterface #412 <Method void Lock.unlock()>
		return flag;
	//   36   70:iload_2         
	//   37   71:ireturn         
		Exception exception;
	...
	//   41   78:invokeinterface #412 <Method void Lock.unlock()>
		throw exception;
	//   42   83:aload           4
	//   43   85:athrow          
	}
	...
	//   16   30:invokeinterface #412 <Method void Lock.unlock()>
		return flag;
	//   17   35:iload_2         
	//   18   36:ireturn         
		Exception exception;
	...
	//   22   42:invokeinterface #412 <Method void Lock.unlock()>
		throw exception;
	//   23   47:aload_3         
	//   24   48:athrow          
	}
	...
	//    3    9:aload_0         
	//    4   10:invokevirtual   #417 <Method boolean isConnecting()>
	//    5   13:ifne            23
	//    6   16:aload_0         
	//    7   17:invokevirtual   #418 <Method boolean isConnected()>
	//    8   20:ifeq            79
	//    9   23:aload_0         
	//   10   24:getfield        #88  <Field zabe zaef>
	//   11   27:invokevirtual   #409 <Method boolean zabe.isConnected()>
	//   12   30:ifne            79
		zaeh.add(((Object) (signinconnectionlistener)));
	//   13   33:aload_0         
	//   14   34:getfield        #53  <Field Set zaeh>
	//   15   37:aload_1         
	//   16   38:invokeinterface #419 <Method boolean Set.add(Object)>
	//   17   43:pop             
		if(zaeo == 0)
	//*  18   44:aload_0         
	...
	//   29   65:invokevirtual   #340 <Method void zabe.connect()>
		zaen.unlock();
	//   30   68:aload_0         
	//   31   69:getfield        #67  <Field Lock zaen>
	//   32   72:invokeinterface #412 <Method void Lock.unlock()>
		return true;
	//   33   77:iconst_1        
	//   34   78:ireturn         
		zaen.unlock();
	...
	//   37   83:invokeinterface #412 <Method void Lock.unlock()>
		return false;
	//   38   88:iconst_0        
	//   39   89:ireturn         
	...
	//   43   95:invokeinterface #412 <Method void Lock.unlock()>
	...
	//    8   18:invokevirtual   #310 <Method void zabe.disconnect()>
		zael = new ConnectionResult(4);
	//    9   21:aload_0         
	//   10   22:new             #291 <Class ConnectionResult>
	//   11   25:dup             
	//   12   26:iconst_4        
	...
	//   17   37:new             #425 <Class zal>
	//   18   40:dup             
	//   19   41:aload_0         
	//   20   42:getfield        #69  <Field Looper zabj>
	//   21   45:invokespecial   #428 <Method void zal(Looper)>
	//   22   48:new             #430 <Class zat>
	//   23   51:dup             
	//   24   52:aload_0         
	//   25   53:invokespecial   #432 <Method void zat(zas)>
	//   26   56:invokevirtual   #438 <Method boolean Handler.post(Runnable)>
	//   27   59:pop             
	...
	//   33   71:invokeinterface #412 <Method void Lock.unlock()>
		return;
	//   34   76:return          
		Exception exception;
		exception;
	...
	//   38   82:invokeinterface #412 <Method void Lock.unlock()>
		throw exception;
	//   39   87:aload_2         
	//   40   88:athrow          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #83  <Field zabe zaee>
	//    2    4:invokevirtual   #441 <Method void zabe.zaw()>
		zaef.zaw();
	//    3    7:aload_0         
	//    4    8:getfield        #88  <Field zabe zaef>
	//    5   11:invokevirtual   #441 <Method void zabe.zaw()>
	//    6   14:return          
	}
