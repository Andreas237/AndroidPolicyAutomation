	...
	implements zabt
{
	...
	//    3    7:invokeinterface #32  <Method void Lock.lock()>
		if(!zas.zac(zaep)) goto _L2; else goto _L1
	//    4   12:aload_0         
...
_L3:
	...
	//   34   76:astore_3        
		zas.zaa(zaep).unlock();
	//   35   77:aload_0         
	//   36   78:getfield        #12  <Field zas zaep>
	//   37   81:invokestatic    #27  <Method Lock zas.zaa(zas)>
	...
	//    4   12:aload_0         
	//    5   13:getfield        #12  <Field zas zaep>
	//    6   16:getstatic       #62  <Field ConnectionResult ConnectionResult.RESULT_SUCCESS>
	//    7   19:invokestatic    #65  <Method ConnectionResult zas.zab(zas, ConnectionResult)>
	//    8   22:pop             
		zas.zab(zaep);
	//    9   23:aload_0         
	//   10   24:getfield        #12  <Field zas zaep>
	//   11   27:invokestatic    #67  <Method void zas.zab(zas)>
		zas.zaa(zaep).unlock();
	//   12   30:aload_0         
	...
	//    5   13:getfield        #12  <Field zas zaep>
	//    6   16:aload_1         
	//    7   17:invokestatic    #65  <Method ConnectionResult zas.zab(zas, ConnectionResult)>
	//    8   20:pop             
		zas.zab(zaep);
	//    9   21:aload_0         
	//   10   22:getfield        #12  <Field zas zaep>
	//   11   25:invokestatic    #67  <Method void zas.zab(zas)>
		zas.zaa(zaep).unlock();
	//   12   28:aload_0         
