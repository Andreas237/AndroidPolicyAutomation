...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight
{
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #68  <Method int GooglePlayServicesUtilLight.isGooglePlayServicesAvailable(Context)>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokestatic    #72  <Method int GooglePlayServicesUtilLight.isGooglePlayServicesAvailable(Context, int)>
	//    3    5:ireturn         
	}
	...
	//    0    0:iload_0         
	//    1    1:invokestatic    #76  <Method boolean GooglePlayServicesUtilLight.isUserRecoverableError(int)>
	//    2    4:ireturn         
	}
	...
	//    2    2:iload_2         
	//    3    3:aconst_null     
	//    4    4:invokestatic    #81  <Method boolean showErrorDialogFragment(int, Activity, int, android.content.DialogInterface$OnCancelListener)>
	//    5    7:ireturn         
	}
	...
	//    3    3:iload_2         
	//    4    4:aload_3         
	//    5    5:invokestatic    #84  <Method boolean showErrorDialogFragment(int, Activity, Fragment, int, android.content.DialogInterface$OnCancelListener)>
	//    6    8:ireturn         
	}
	...
	//   15   29:iload_3         
	//   16   30:aload           4
	//   17   32:invokevirtual   #87  <Method boolean GoogleApiAvailability.showErrorDialogFragment(Activity, int, int, android.content.DialogInterface$OnCancelListener)>
	//   18   35:ireturn         
		fragment = ((Fragment) (GoogleApiAvailability.zaa(((Context) (activity)), k, DialogRedirect.getInstance(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(((Context) (activity)), k, "d"), j), oncancellistener)));
	//   19   36:aload_1         
	//   20   37:iload           5
	//   21   39:aload_2         
	...
	//   23   43:aload_1         
	//   24   44:iload           5
	//   25   46:ldc1            #89  <String "d">
	//   26   48:invokevirtual   #93  <Method android.content.Intent GoogleApiAvailability.getErrorResolutionIntent(Context, int, String)>
	//   27   51:iload_3         
	//   28   52:invokestatic    #98  <Method DialogRedirect DialogRedirect.getInstance(Fragment, android.content.Intent, int)>
	//   29   55:aload           4
	//   30   57:invokestatic    #102 <Method Dialog GoogleApiAvailability.zaa(Context, int, DialogRedirect, android.content.DialogInterface$OnCancelListener)>
	//   31   60:astore_2        
		if(fragment == null)
	//*  32   61:aload_2         
	//*  33   62:ifnonnull       67
	...
	//   35   66:ireturn         
		...
		{
			GoogleApiAvailability.zaa(activity, ((Dialog) (fragment)), "GooglePlayServicesErrorDialog", oncancellistener);
	//   36   67:aload_1         
	//   37   68:aload_2         
	//   38   69:ldc1            #8   <String "GooglePlayServicesErrorDialog">
	//   39   71:aload           4
	//   40   73:invokestatic    #105 <Method void GoogleApiAvailability.zaa(Activity, Dialog, String, android.content.DialogInterface$OnCancelListener)>
			return true;
	//   41   76:iconst_1        
	//   42   77:ireturn         
		}
	...
	//*   6   12:aload_1         
	//*   7   13:iload_0         
	//*   8   14:invokestatic    #110 <Method boolean GooglePlayServicesUtilLight.isPlayStorePossiblyUpdating(Context, int)>
	//*   9   17:ifeq            23
	//*  10   20:goto            30
		{
	...
	//   12   24:aload_1         
	//   13   25:iload_0         
	//   14   26:invokevirtual   #113 <Method void GoogleApiAvailability.showErrorNotification(Context, int)>
			return;
	//   15   29:return          
		} else
		{
	...
	//   16   30:aload_2         
	//   17   31:aload_1         
	//   18   32:invokevirtual   #116 <Method void GoogleApiAvailability.zaa(Context)>
			return;
	//   19   35:return          
		}
	}
