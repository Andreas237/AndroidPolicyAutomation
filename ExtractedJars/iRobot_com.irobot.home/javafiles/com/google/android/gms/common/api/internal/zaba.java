	...
	implements ResultCallback
{
	...
	//    0    0:aload_1         
	//    1    1:checkcast       #33  <Class Status>
	//    2    4:astore_1        
		Storage.getInstance(zaaw.zac(zahg)).zaf();
	//    3    5:aload_0         
	//    4    6:getfield        #19  <Field zaaw zahg>
	//    5    9:invokestatic    #39  <Method android.content.Context zaaw.zac(zaaw)>
	//    6   12:invokestatic    #45  <Method Storage Storage.getInstance(android.content.Context)>
	//    7   15:invokevirtual   #48  <Method void Storage.zaf()>
		if(((Status) (result)).isSuccess() && ((GoogleApiClient) (zahg)).isConnected())
	//*   8   18:aload_1         
	//*   9   19:invokevirtual   #52  <Method boolean Status.isSuccess()>
	//*  10   22:ifeq            42
	//*  11   25:aload_0         
	//*  12   26:getfield        #19  <Field zaaw zahg>
	//*  13   29:invokevirtual   #57  <Method boolean GoogleApiClient.isConnected()>
	//*  14   32:ifeq            42
			((GoogleApiClient) (zahg)).reconnect();
	//   15   35:aload_0         
	//   16   36:getfield        #19  <Field zaaw zahg>
	//   17   39:invokevirtual   #60  <Method void GoogleApiClient.reconnect()>
		((BasePendingResult) (zahi)).setResult(result);
	//   18   42:aload_0         
	//   19   43:getfield        #21  <Field StatusPendingResult zahi>
	//   20   46:aload_1         
	//   21   47:invokevirtual   #65  <Method void BasePendingResult.setResult(Result)>
		if(zahj)
	//*  22   50:aload_0         
	...
	//   27   61:invokevirtual   #68  <Method void GoogleApiClient.disconnect()>
	//   28   64:return          
	}
