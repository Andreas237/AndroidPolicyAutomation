...
label0:
	...
	//*  95  171:icmpge          185
					throw new zzxp(j, k1);
	//   96  174:new             #56  <Class zzxp>
	//   97  177:dup             
	//   98  178:iload_2         
	//   99  179:iload           7
	//  100  181:invokespecial   #59  <Method void zzxp(int, int)>
	//  101  184:athrow          
				l = j + 1;
	//  102  185:iload_2         
	//  103  186:iconst_1        
	...
	//  123  215:new             #61  <Class StringBuilder>
	//  124  218:dup             
	//  125  219:bipush          54
	//  126  221:invokespecial   #64  <Method void StringBuilder(int)>
	//  127  224:astore_0        
			((StringBuilder) (charsequence)).append("UTF-8 length does not fit in int: ");
	//  128  225:aload_0         
	//  129  226:ldc1            #66  <String "UTF-8 length does not fit in int: ">
	//  130  228:invokevirtual   #70  <Method StringBuilder StringBuilder.append(String)>
	//  131  231:pop             
			((StringBuilder) (charsequence)).append(l1 + 0x0L);
	//  132  232:aload_0         
	//  133  233:lload           9
	//  134  235:ldc2w           #71  <Long 0x0L>
	//  135  238:ladd            
	//  136  239:invokevirtual   #75  <Method StringBuilder StringBuilder.append(long)>
	//  137  242:pop             
			throw new IllegalArgumentException(((StringBuilder) (charsequence)).toString());
	//  138  243:new             #77  <Class IllegalArgumentException>
	//  139  246:dup             
	//  140  247:aload_0         
	//  141  248:invokevirtual   #81  <Method String StringBuilder.toString()>
	//  142  251:invokespecial   #84  <Method void IllegalArgumentException(String)>
	//  143  254:athrow          
		} else
		{
			return k;
	...
	{
		return zzcdi.zzb(charsequence, abyte0, i, j);
	//    0    0:getstatic       #32  <Field zzxn zzcdi>
	//    1    3:aload_0         
	//    2    4:aload_1         
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #90  <Method int zzxn.zzb(CharSequence, byte[], int, int)>
	//    6   10:ireturn         
	}
	...
	//*  26   46:ifeq            56
		{
			zzxn1.zzb(charsequence, bytebuffer);
	//   27   49:aload_3         
	//   28   50:aload_0         
	//   29   51:aload_1         
	//   30   52:invokevirtual   #119 <Method void zzxn.zzb(CharSequence, ByteBuffer)>
			return;
	//   31   55:return          
		} else
		{
	...
	//   32   56:aload_0         
	//   33   57:aload_1         
	//   34   58:invokestatic    #122 <Method void zzxn.zzc(CharSequence, ByteBuffer)>
			return;
	//   35   61:return          
		}
	}
	...
	static int zzca(int i)
	{
		return zzbz(i);
	//    0    0:iload_0         
	//    1    1:invokestatic    #128 <Method int zzbz(int)>
	//    2    4:ireturn         
	}
	...
	{
		return zzcdi.zzf(abyte0, i, j);
	//    0    0:getstatic       #32  <Field zzxn zzcdi>
	//    1    3:aload_0         
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #135 <Method boolean zzxn.zzf(byte[], int, int)>
	//    5    9:ireturn         
	}
	...
	//   24   56:ireturn         
		...
		case 1: // '\001'
			return zzq(((int) (byte0)), ((int) (abyte0[i])));
	//   25   57:iload_3         
	//   26   58:aload_0         
	//   27   59:iload_1         
	//   28   60:baload          
	//   29   61:invokestatic    #144 <Method int zzq(int, int)>
	//   30   64:ireturn         

		case 0: // '\0'
			return zzbz(((int) (byte0)));
	//   31   65:iload_3         
	//   32   66:invokestatic    #128 <Method int zzbz(int)>
	//   33   69:ireturn         
		}
	}

	static String zzh(byte abyte0[], int i, int j)
	{
		return zzcdi.zzh(abyte0, i, j);
	//    0    0:getstatic       #32  <Field zzxn zzcdi>
	//    1    3:aload_0         
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #148 <Method String zzxn.zzh(byte[], int, int)>
	//    5    9:areturn         
	}

	static int zzi(byte abyte0[], int i, int j)
	{
		return zzg(abyte0, i, j);
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:iload_2         
	//    3    3:invokestatic    #151 <Method int zzg(byte[], int, int)>
	//    4    6:ireturn         
	}

	public static boolean zzl(byte abyte0[])
	{
		return zzcdi.zzf(abyte0, 0, abyte0.length);
	//    0    0:getstatic       #32  <Field zzxn zzcdi>
	//    1    3:aload_0         
	//    2    4:iconst_0        
	//    3    5:aload_0         
	//    4    6:arraylength     
	//    5    7:invokevirtual   #135 <Method boolean zzxn.zzf(byte[], int, int)>
	//    6   10:ireturn         
	}

	private static int zzq(int i, int j)
	{
		if(i <= -12 && j <= -65)
	//*   0    0:iload_0         
	//*   1    1:bipush          -12
	...
	static int zzr(int i, int j)
	{
		return zzq(i, j);
	//    0    0:iload_0         
	//    1    1:iload_1         
	//    2    2:invokestatic    #144 <Method int zzq(int, int)>
	//    3    5:ireturn         
	}
	...
	//*   0    0:invokestatic    #14  <Method boolean zzxj.zzyo()>
	//*   1    3:ifeq            17
	//*   2    6:invokestatic    #17  <Method boolean zzxj.zzyp()>
	//*   3    9:ifeq            17
			flag = true;
	//    4   12:iconst_1        
	//    5   13:istore_0        
	...
	//*   9   19:iload_0         
	//*  10   20:ifeq            40
	//*  11   23:invokestatic    #22  <Method boolean zztb.zzub()>
	//*  12   26:ifne            40
			obj = ((Object) (new zzxq()));
	//   13   29:new             #24  <Class zzxq>
	//   14   32:dup             
	//   15   33:invokespecial   #27  <Method void zzxq()>
	//   16   36:astore_1        
		else
	//*  17   37:goto            48
			obj = ((Object) (new zzxo()));
	//   18   40:new             #29  <Class zzxo>
	//   19   43:dup             
	//   20   44:invokespecial   #30  <Method void zzxo()>
	//   21   47:astore_1        
		zzcdi = ((zzxn) (obj));
	//   22   48:aload_1         
	//   23   49:putstatic       #32  <Field zzxn zzcdi>
	//*  24   52:return          
	}
}
