...
class zzwx extends AbstractSet
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #11  <Field zzwo zzcca>
		super();
	//    3    5:aload_0         
	...
	//*   6   10:ifne            38
		{
			zzcca.zza((Comparable)((java.util.Map.Entry) (obj)).getKey(), ((java.util.Map.Entry) (obj)).getValue());
	//    7   13:aload_0         
	//    8   14:getfield        #11  <Field zzwo zzcca>
	//    9   17:aload_1         
	...
	public void clear()
	{
		zzcca.clear();
	//    0    0:aload_0         
	//    1    1:getfield        #11  <Field zzwo zzcca>
	...
	//    1    1:checkcast       #22  <Class java.util.Map$Entry>
	//    2    4:astore_2        
		obj = zzcca.get(((java.util.Map.Entry) (obj1)).getKey());
	//    3    5:aload_0         
	//    4    6:getfield        #11  <Field zzwo zzcca>
	//    5    9:aload_2         
	...
	{
		return ((Iterator) (new zzww(zzcca, ((zzwp) (null)))));
	//    0    0:new             #56  <Class zzww>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #11  <Field zzwo zzcca>
	//    4    8:aconst_null     
	...
	//*   6   10:ifeq            29
		{
			zzcca.remove(((java.util.Map.Entry) (obj)).getKey());
	//    7   13:aload_0         
	//    8   14:getfield        #11  <Field zzwo zzcca>
	//    9   17:aload_1         
	//   10   18:invokeinterface #29  <Method Object java.util.Map$Entry.getKey()>
