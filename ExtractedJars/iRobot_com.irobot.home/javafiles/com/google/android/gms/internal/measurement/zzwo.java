...
class zzwo extends AbstractMap
{
	...
	private final int zza(Comparable comparable)
	{
		int k = zzcbu.size() - 1;
	//    0    0:aload_0         
	//    1    1:getfield        #35  <Field List zzcbu>
	...
	//*   7   13:iflt            57
		{
			int i = comparable.compareTo(((Object) ((Comparable)((zzwv)zzcbu.get(k)).getKey())));
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #35  <Field List zzcbu>
	//   11   21:iload_3         
	...
	//   38   68:idiv            
	//   39   69:istore          4
			int i1 = comparable.compareTo(((Object) ((Comparable)((zzwv)zzcbu.get(l)).getKey())));
	//   40   71:aload_1         
	//   41   72:aload_0         
	//   42   73:getfield        #35  <Field List zzcbu>
	//   43   76:iload           4
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #81  <Method void zzyf()>
		Object obj = ((zzwv)zzcbu.remove(i)).getValue();
	//    2    4:aload_0         
	//    3    5:getfield        #35  <Field List zzcbu>
	//    4    8:iload_1         
	...
	//    8   20:astore_2        
		if(!zzcbv.isEmpty())
	//*   9   21:aload_0         
	//*  10   22:getfield        #41  <Field Map zzcbv>
	...
	//   17   47:astore_3        
			zzcbu.add(((Object) (new zzwv(this, (java.util.Map.Entry)iterator.next()))));
	//   18   48:aload_0         
	//   19   49:getfield        #35  <Field List zzcbu>
	...
	static Map zzc(zzwo zzwo1)
	{
		return zzwo1.zzcbv;
	//    0    0:aload_0         
	//    1    1:getfield        #41  <Field Map zzcbv>
	//    2    4:areturn         
	}
	...
	static Map zzd(zzwo zzwo1)
	{
		return zzwo1.zzcbx;
	//    0    0:aload_0         
	//    1    1:getfield        #43  <Field Map zzcbx>
	//    2    4:areturn         
	}
	...
	private final void zzyf()
	{
		if(zzbqa)
	//*   0    0:aload_0         
	//*   1    1:getfield        #139 <Field boolean zzbqa>
	//*   2    4:ifeq            15
			throw new UnsupportedOperationException();
	//    3    7:new             #141 <Class UnsupportedOperationException>
	//    4   10:dup             
	//    5   11:invokespecial   #142 <Method void UnsupportedOperationException()>
	//    6   14:athrow          
		else
			return;
	//    7   15:return          
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #81  <Method void zzyf()>
		if(zzcbv.isEmpty() && !(zzcbv instanceof TreeMap))
	//*   2    4:aload_0         
	//*   3    5:getfield        #41  <Field Map zzcbv>
	//*   4    8:invokeinterface #101 <Method boolean Map.isEmpty()>
	//*   5   13:ifeq            51
	//*   6   16:aload_0         
	//*   7   17:getfield        #41  <Field Map zzcbv>
	//*   8   20:instanceof      #144 <Class TreeMap>
	//*   9   23:ifne            51
		{
			zzcbv = ((Map) (new TreeMap()));
	//   10   26:aload_0         
	//   11   27:new             #144 <Class TreeMap>
	//   12   30:dup             
	//   13   31:invokespecial   #145 <Method void TreeMap()>
	//   14   34:putfield        #41  <Field Map zzcbv>
			zzcbx = ((Map) (((TreeMap)zzcbv).descendingMap()));
	//   15   37:aload_0         
	//   16   38:aload_0         
	//   17   39:getfield        #41  <Field Map zzcbv>
	//   18   42:checkcast       #144 <Class TreeMap>
	//   19   45:invokevirtual   #149 <Method java.util.NavigableMap TreeMap.descendingMap()>
	//   20   48:putfield        #43  <Field Map zzcbx>
		}
		return (SortedMap)zzcbv;
	//   21   51:aload_0         
	//   22   52:getfield        #41  <Field Map zzcbv>
	...
	//*   5   13:ifne            25
			zzcbu.clear();
	//    6   16:aload_0         
	//    7   17:getfield        #35  <Field List zzcbu>
	//    8   20:invokeinterface #154 <Method void List.clear()>
		if(!zzcbv.isEmpty())
	//*   9   25:aload_0         
	//*  10   26:getfield        #41  <Field Map zzcbv>
	//*  11   29:invokeinterface #101 <Method boolean Map.isEmpty()>
	//*  12   34:ifne            46
			zzcbv.clear();
	//   13   37:aload_0         
	//   14   38:getfield        #41  <Field Map zzcbv>
	...
	//    2    4:astore_1        
		return zza(((Comparable) (obj))) >= 0 || zzcbv.containsKey(obj);
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokespecial   #158 <Method int zza(Comparable)>
	//    6   10:ifge            31
	//    7   13:aload_0         
	//    8   14:getfield        #41  <Field Map zzcbv>
	//    9   17:aload_1         
	...
	public Set entrySet()
	{
		if(zzcbw == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #162 <Field zzwx zzcbw>
	//*   2    4:ifnonnull       20
			zzcbw = new zzwx(this, ((zzwp) (null)));
	//    3    7:aload_0         
	...
	//    9   17:putfield        #162 <Field zzwx zzcbw>
		return ((Set) (zzcbw));
	//   10   20:aload_0         
	//   11   21:getfield        #162 <Field zzwx zzcbw>
	//   12   24:areturn         
	}
	...
	//*  58  106:iload_3         
	//*  59  107:icmpeq          124
			return zzcbv.equals(((Object) (((zzwo) (obj)).zzcbv)));
	//   60  110:aload_0         
	//   61  111:getfield        #41  <Field Map zzcbv>
	//   62  114:aload_1         
	//   63  115:getfield        #41  <Field Map zzcbv>
	...
	//*   7   11:iload_2         
	//*   8   12:iflt            32
			return ((zzwv)zzcbu.get(i)).getValue();
	//    9   15:aload_0         
	//   10   16:getfield        #35  <Field List zzcbu>
	//   11   19:iload_2         
	...
	//   15   31:areturn         
			...
			return zzcbv.get(obj);
	//   16   32:aload_0         
	//   17   33:getfield        #41  <Field Map zzcbv>
	//   18   36:aload_1         
	...
	//*   8   10:iload_3         
	//*   9   11:icmpge          40
			i += ((zzwv)zzcbu.get(j)).hashCode();
	//   10   14:iload_1         
	//   11   15:aload_0         
	//   12   16:getfield        #35  <Field List zzcbu>
	//   13   19:iload_2         
	...
	//   25   41:istore_2        
		if(zzcbv.size() > 0)
	//*  26   42:aload_0         
	//*  27   43:getfield        #41  <Field Map zzcbv>
	//*  28   46:invokeinterface #191 <Method int Map.size()>
	//*  29   51:ifle            66
			j = i + zzcbv.hashCode();
	//   30   54:iload_1         
	//   31   55:aload_0         
	//   32   56:getfield        #41  <Field Map zzcbv>
	...
	//   14   24:areturn         
		if(zzcbv.isEmpty())
	//*  15   25:aload_0         
	//*  16   26:getfield        #41  <Field Map zzcbv>
	...
	//   20   38:areturn         
			...
			return zzcbv.remove(obj);
	//   21   39:aload_0         
	//   22   40:getfield        #41  <Field Map zzcbv>
	//   23   43:aload_1         
	...
	public int size()
	{
		return zzcbu.size() + zzcbv.size();
	//    0    0:aload_0         
	//    1    1:getfield        #35  <Field List zzcbu>
	//    2    4:invokeinterface #55  <Method int List.size()>
	//    3    9:aload_0         
	//    4   10:getfield        #41  <Field Map zzcbv>
	...
	//*   6   10:iload_3         
	//*   7   11:iflt            32
			return ((zzwv)zzcbu.get(i)).setValue(obj);
	//    8   14:aload_0         
	//    9   15:getfield        #35  <Field List zzcbu>
	//   10   18:iload_3         
	...
	//   17   33:invokespecial   #81  <Method void zzyf()>
		if(zzcbu.isEmpty() && !(zzcbu instanceof ArrayList))
	//*  18   36:aload_0         
	//*  19   37:getfield        #35  <Field List zzcbu>
	//*  20   40:invokeinterface #152 <Method boolean List.isEmpty()>
	//*  21   45:ifeq            73
	//*  22   48:aload_0         
	//*  23   49:getfield        #35  <Field List zzcbu>
	//*  24   52:instanceof      #205 <Class ArrayList>
	//*  25   55:ifne            73
			zzcbu = ((List) (new ArrayList(zzcbt)));
	//   26   58:aload_0         
	//   27   59:new             #205 <Class ArrayList>
	//   28   62:dup             
	//   29   63:aload_0         
	//   30   64:getfield        #27  <Field int zzcbt>
	//   31   67:invokespecial   #206 <Method void ArrayList(int)>
	//   32   70:putfield        #35  <Field List zzcbu>
		i = -(i + 1);
	//   33   73:iload_3         
	//   34   74:iconst_1        
	//   35   75:iadd            
	...
	//*  38   78:iload_3         
	//*  39   79:aload_0         
	//*  40   80:getfield        #27  <Field int zzcbt>
	//*  41   83:icmplt          98
	...
	//   47   97:areturn         
		if(zzcbu.size() == zzcbt)
	//*  48   98:aload_0         
	//*  49   99:getfield        #35  <Field List zzcbu>
	//*  50  102:invokeinterface #55  <Method int List.size()>
	//*  51  107:aload_0         
	//*  52  108:getfield        #27  <Field int zzcbt>
	//*  53  111:icmpne          157
		{
			zzwv zzwv1 = (zzwv)zzcbu.remove(zzcbt - 1);
	//   54  114:aload_0         
	//   55  115:getfield        #35  <Field List zzcbu>
	//   56  118:aload_0         
	//   57  119:getfield        #27  <Field int zzcbt>
	//   58  122:iconst_1        
	//   59  123:isub            
	//   60  124:invokeinterface #92  <Method Object List.remove(int)>
	//   61  129:checkcast       #61  <Class zzwv>
	//   62  132:astore          4
			zzyg().put(((Object) ((Comparable)zzwv1.getKey())), zzwv1.getValue());
	//   63  134:aload_0         
	//   64  135:invokespecial   #105 <Method SortedMap zzyg()>
	//   65  138:aload           4
	//   66  140:invokevirtual   #65  <Method Object zzwv.getKey()>
	//   67  143:checkcast       #67  <Class Comparable>
	//   68  146:aload           4
	//   69  148:invokevirtual   #95  <Method Object zzwv.getValue()>
	//   70  151:invokeinterface #208 <Method Object SortedMap.put(Object, Object)>
	//   71  156:pop             
		}
		zzcbu.add(i, ((Object) (new zzwv(this, comparable, obj))));
	//   72  157:aload_0         
	//   73  158:getfield        #35  <Field List zzcbu>
	//   74  161:iload_3         
	//   75  162:new             #61  <Class zzwv>
	//   76  165:dup             
	//   77  166:aload_0         
	//   78  167:aload_1         
	//   79  168:aload_2         
	//   80  169:invokespecial   #211 <Method void zzwv(zzwo, Comparable, Object)>
	...
	{
		return (java.util.Map.Entry)zzcbu.get(i);
	//    0    0:aload_0         
	//    1    1:getfield        #35  <Field List zzcbu>
	//    2    4:iload_1         
	...
	//*   2    4:ifne            76
		{
			...
			if(zzcbv.isEmpty())
	//*   3    7:aload_0         
	//*   4    8:getfield        #41  <Field Map zzcbv>
	...
	//   10   26:aload_0         
	//   11   27:getfield        #41  <Field Map zzcbv>
	//   12   30:invokestatic    #221 <Method Map Collections.unmodifiableMap(Map)>
	//   13   33:astore_1        
			zzcbv = map;
	//   14   34:aload_0         
	//   15   35:aload_1         
	//   16   36:putfield        #41  <Field Map zzcbv>
			if(zzcbx.isEmpty())
	//*  17   39:aload_0         
	//*  18   40:getfield        #43  <Field Map zzcbx>
	...
	//*  23   55:goto            66
				map = Collections.unmodifiableMap(zzcbx);
	//   24   58:aload_0         
	//   25   59:getfield        #43  <Field Map zzcbx>
	//   26   62:invokestatic    #221 <Method Map Collections.unmodifiableMap(Map)>
	//   27   65:astore_1        
			zzcbx = map;
	//   28   66:aload_0         
	//   29   67:aload_1         
	//   30   68:putfield        #43  <Field Map zzcbx>
			zzbqa = true;
	//   31   71:aload_0         
	//   32   72:iconst_1        
	//   33   73:putfield        #139 <Field boolean zzbqa>
		}
	//   34   76:return          
	}
	...
	//    5   15:areturn         
			...
			return ((Iterable) (zzcbv.entrySet()));
	//    6   16:aload_0         
	//    7   17:getfield        #41  <Field Map zzcbv>
	...
	final Set zzye()
	{
		if(zzcby == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #233 <Field zzwr zzcby>
	//*   2    4:ifnonnull       20
			zzcby = new zzwr(this, ((zzwp) (null)));
	//    3    7:aload_0         
	...
	//    9   17:putfield        #233 <Field zzwr zzcby>
		return ((Set) (zzcby));
	//   10   20:aload_0         
	//   11   21:getfield        #233 <Field zzwr zzcby>
	//   12   24:areturn         
	}
