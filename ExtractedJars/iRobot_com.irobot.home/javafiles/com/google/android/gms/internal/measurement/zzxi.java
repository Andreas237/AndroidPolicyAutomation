	...
	implements Iterator
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #16  <Field zzxg zzccm>
		super();
	//    3    5:aload_0         
	//    4    6:invokespecial   #19  <Method void Object()>
		zzccn = zzxg.zza(zzccm).iterator();
	//    5    9:aload_0         
	//    6   10:aload_0         
	//    7   11:getfield        #16  <Field zzxg zzccm>
	//    8   14:invokestatic    #25  <Method zzve zzxg.zza(zzxg)>
	//    9   17:invokeinterface #31  <Method Iterator zzve.iterator()>
	//   10   22:putfield        #33  <Field Iterator zzccn>
	//   11   25:return          
	}

	public final boolean hasNext()
	{
		return zzccn.hasNext();
	//    0    0:aload_0         
	//    1    1:getfield        #33  <Field Iterator zzccn>
	...
	{
		return ((Object) ((String)zzccn.next()));
	//    0    0:aload_0         
	//    1    1:getfield        #33  <Field Iterator zzccn>
