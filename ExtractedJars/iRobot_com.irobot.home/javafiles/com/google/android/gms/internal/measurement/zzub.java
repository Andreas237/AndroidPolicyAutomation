...
public class zzub
{
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #36  <Method void Object()>
		zzbvg = Collections.emptyMap();
	//    2    4:aload_0         
	//    3    5:invokestatic    #47  <Method Map Collections.emptyMap()>
	//    4    8:putfield        #41  <Field Map zzbvg>
	//    5   11:return          
	}
	...
	public static zzub zzvs()
	{
		Object obj;
		obj = ((Object) (zzbve));
	//    0    0:getstatic       #76  <Field zzub zzbve>
	//    1    3:astore_0        
		if(obj != null)
	...
	//    5   10:monitorenter    
		zzub zzub1 = zzbve;
	//    6   11:getstatic       #76  <Field zzub zzbve>
	//    7   14:astore_1        
		obj = ((Object) (zzub1));
	//    8   15:aload_1         
	//    9   16:astore_0        
	...
	//   13   24:astore_0        
		zzbve = ((zzub) (obj));
	//   14   25:aload_0         
	//   15   26:putstatic       #76  <Field zzub zzbve>
		com/google/android/gms/internal/measurement/zzub;
	...
	{
		return (zzuo.zzd)zzbvg.get(((Object) (new zza(((Object) (zzvv)), i))));
	//    0    0:aload_0         
	//    1    1:getfield        #41  <Field Map zzbvg>
