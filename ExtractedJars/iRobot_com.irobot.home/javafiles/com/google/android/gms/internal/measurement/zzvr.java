	...
	implements zzvq
{
	...
	//   15   33:aload_2         
	//   16   34:invokeinterface #67  <Method Object Iterator.next()>
	//   17   39:checkcast       #69  <Class java.util.Map$Entry>
	//   18   42:astore_2        
			((java.util.Map.Entry) (obj)).getKey();
	//   19   43:aload_2         
	//   20   44:invokeinterface #72  <Method Object java.util.Map$Entry.getKey()>
	//   21   49:pop             
			((java.util.Map.Entry) (obj)).getValue();
	//   22   50:aload_2         
	//   23   51:invokeinterface #75  <Method Object java.util.Map$Entry.getValue()>
	//   24   56:pop             
			throw new NoSuchMethodError();
	//   25   57:new             #41  <Class NoSuchMethodError>
	//   26   60:dup             
	//   27   61:invokespecial   #42  <Method void NoSuchMethodError()>
	//   28   64:athrow          
		} else
		{
			return 0;
