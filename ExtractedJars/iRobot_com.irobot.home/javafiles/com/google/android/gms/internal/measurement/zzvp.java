...
public final class zzvp extends LinkedHashMap
{
	...
	//    2    4:aload_0         
	//    3    5:iconst_1        
	//    4    6:putfield        #18  <Field boolean zzbtn>
	//    5    9:return          
	}
	...
	//    3    5:aload_0         
	//    4    6:iconst_1        
	//    5    7:putfield        #18  <Field boolean zzbtn>
	//    6   10:return          
	}
	...
	//   10   22:new             #39  <Class UnsupportedOperationException>
	//   11   25:dup             
	//   12   26:invokespecial   #40  <Method void UnsupportedOperationException()>
	//   13   29:athrow          
		else
			return obj.hashCode();
	//   14   30:aload_0         
	//   15   31:invokevirtual   #45  <Method int Object.hashCode()>
	//   16   34:ireturn         
	}
	...
	{
		return zzcan;
	//    0    0:getstatic       #16  <Field zzvp zzcan>
	//    1    3:areturn         
	}
	...
	private final void zzxi()
	{
		if(!zzbtn)
	//*   0    0:aload_0         
	//*   1    1:getfield        #18  <Field boolean zzbtn>
	//*   2    4:ifne            15
			throw new UnsupportedOperationException();
	//    3    7:new             #39  <Class UnsupportedOperationException>
	//    4   10:dup             
	//    5   11:invokespecial   #40  <Method void UnsupportedOperationException()>
	//    6   14:athrow          
		else
			return;
	//    7   15:return          
...
_L5:
	...
	//*  42  115:aload           5
	//*  43  117:instanceof      #29  <Class byte[]>
	//*  44  120:ifeq            148
	//*  45  123:aload           6
	//*  46  125:instanceof      #29  <Class byte[]>
	//*  47  128:ifeq            148
			flag1 = Arrays.equals((byte[])obj1, (byte[])obj2);
	//   48  131:aload           5
	//   49  133:checkcast       #29  <Class byte[]>
	//   50  136:aload           6
	//   51  138:checkcast       #29  <Class byte[]>
...
_L2:
	...
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:putfield        #18  <Field boolean zzbtn>
	//    3    5:return          
	}
	...
	//    3    7:astore_0        
		zzcan = zzvp1;
	//    4    8:aload_0         
	//    5    9:putstatic       #16  <Field zzvp zzcan>
		zzvp1.zzbtn = false;
	//    6   12:aload_0         
	//    7   13:iconst_0        
	//    8   14:putfield        #18  <Field boolean zzbtn>
	//*   9   17:return          
	}
}
