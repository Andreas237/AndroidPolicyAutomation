	...
	implements ExceptionParser
{
	...
	//    6   12:putfield        #20  <Field TreeSet zzsw>
	...
	//*  24   39:aload_0         
	//*  25   40:getfield        #20  <Field TreeSet zzsw>
	...
	public void setIncludedPackages(Context context, Collection collection)
	{
		zzsw.clear();
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field TreeSet zzsw>
	...
	//   33   77:aload_0         
	//   34   78:getfield        #20  <Field TreeSet zzsw>
	...
	//*  51  123:ifeq            144
						zzsw.remove(((Object) (s)));
	//   52  126:aload_0         
	//   53  127:getfield        #20  <Field TreeSet zzsw>
	//   54  130:aload           5
	...
	//*  61  144:iload_3         
	//*  62  145:ifeq            56
				zzsw.add(((Object) (collection)));
	//   63  148:aload_0         
	//   64  149:getfield        #20  <Field TreeSet zzsw>
	//   65  152:aload_2         
	...
	private final TreeSet zzsw = new TreeSet();
}
