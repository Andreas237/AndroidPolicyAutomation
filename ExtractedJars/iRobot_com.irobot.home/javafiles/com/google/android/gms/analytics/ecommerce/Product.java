...
public class Product
{
	...
	//    6   12:putfield        #17  <Field Map zzvj>
	//    7   15:return          
	}
	...
	//    4    7:aload_0         
	//    5    8:getfield        #17  <Field Map zzvj>
	//    6   11:aload_1         
	//    7   12:aload_2         
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokestatic    #52  <Method String zzd.zzo(int)>
	//    3    5:aload_2         
	...
	{
		put(zzd.zzp(i), Integer.toString(j));
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokestatic    #57  <Method String zzd.zzp(int)>
	//    3    5:iload_2         
	...
	public String toString()
	{
		return zzi.zza(zzvj);
	//    0    0:aload_0         
	//    1    1:getfield        #17  <Field Map zzvj>
	...
	//    3    7:astore_3        
		...
		for(Iterator iterator = zzvj.entrySet().iterator(); iterator.hasNext(); ((Map) (hashmap)).put(((Object) (s1)), ((Object) ((String)entry.getValue()))))
	//*   4    8:aload_0         
	//*   5    9:getfield        #17  <Field Map zzvj>
	...
	//   12   34:aload           4
	//   13   36:invokeinterface #116 <Method Object Iterator.next()>
	//   14   41:checkcast       #118 <Class java.util.Map$Entry>
	//   15   44:astore          5
			s1 = String.valueOf(((Object) (s)));
	//   16   46:aload_1         
	//   17   47:invokestatic    #124 <Method String String.valueOf(Object)>
	//   18   50:astore_2        
			String s2 = String.valueOf(((Object) ((String)entry.getKey())));
	//   19   51:aload           5
	//   20   53:invokeinterface #127 <Method Object java.util.Map$Entry.getKey()>
	//   21   58:checkcast       #120 <Class String>
	//   22   61:invokestatic    #124 <Method String String.valueOf(Object)>
	//   23   64:astore          6
			if(s2.length() != 0)
	//*  24   66:aload           6
	//*  25   68:invokevirtual   #131 <Method int String.length()>
	//*  26   71:ifeq            84
				s1 = s1.concat(s2);
	//   27   74:aload_2         
	//   28   75:aload           6
	//   29   77:invokevirtual   #135 <Method String String.concat(String)>
	//   30   80:astore_2        
			else
	//*  31   81:goto            93
				s1 = new String(s1);
	//   32   84:new             #120 <Class String>
	//   33   87:dup             
	//   34   88:aload_2         
	//   35   89:invokespecial   #138 <Method void String(String)>
	//   36   92:astore_2        
		}
	...
	//   38   94:aload_2         
	//   39   95:aload           5
	//   40   97:invokeinterface #141 <Method Object java.util.Map$Entry.getValue()>
	//   41  102:checkcast       #120 <Class String>
