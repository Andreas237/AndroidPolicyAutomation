...
public static class p$b extends p
{

	protected Class a()
	{
		return android/R$id;
	//    0    0:ldc1            #21  <Class android.R$id>
	//    1    2:areturn         
	}
	...
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:getfield        #14  <Field String a>
	//    7   13:invokevirtual   #32  <Method StringBuilder StringBuilder.append(String)>
	//    8   16:pop             
		((StringBuilder) (context)).append(".R$id");
	//    9   17:aload_1         
	//   10   18:ldc1            #34  <String ".R$id">
	...
	public p$b(String s, Context context)
	{
		super(context);
	//    0    0:aload_0         
	//    1    1:aload_2         
	//    2    2:invokespecial   #12  <Method void p(Context)>
		a = s;
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:putfield        #14  <Field String a>
		b();
	//    6   10:aload_0         
