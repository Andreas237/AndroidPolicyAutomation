	...
	implements android.view.nTouchListener
{
	...
	{
		return g.c(a.a).onTouchEvent(motionevent);
	//    0    0:aload_0         
	//    1    1:getfield        #17  <Field g$2 a>
	//    2    4:getfield        #25  <Field g g$2.a>
	//    3    7:invokestatic    #31  <Method GestureDetector g.c(g)>
	//    4   10:aload_2         
	//    5   11:invokevirtual   #37  <Method boolean GestureDetector.onTouchEvent(MotionEvent)>
	//    6   14:ireturn         
	}

	final g._cls2 a;

	g$2$1(g._cls2 _pcls2)
	{
		a = _pcls2;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #17  <Field g$2 a>
		super();
	//    3    5:aload_0         
	...
	// Unreferenced inner class com/irobot/a/g$2
