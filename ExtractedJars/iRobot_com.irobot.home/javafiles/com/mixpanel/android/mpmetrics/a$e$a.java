...
_L2:
	...
	//  110  237:pop             
		com.mixpanel.android.mpmetrics.a.a(((a) (obj1)), ((StringBuilder) (abyte0)).toString());
	//  111  238:aload           10
	//  112  240:aload           11
	...
	//  163  349:pop             
		com.mixpanel.android.mpmetrics.a.a(((a) (obj3)), stringbuilder.toString());
	//  164  350:aload           12
	//  165  352:aload           15
	...
	//  183  393:pop             
		com.mixpanel.android.mpmetrics.a.a(((a) (obj1)), ((StringBuilder) (obj3)).toString());
	//  184  394:aload           10
	//  185  396:aload           12
	...
	//  228  490:pop             
		com.mixpanel.android.mpmetrics.a.a(((a) (obj2)), ((StringBuilder) (obj3)).toString(), ((Throwable) (obj1)));
	//  229  491:aload           11
	//  230  493:aload           12
...
_L1:
	...
	//  405  853:pop             
		com.mixpanel.android.mpmetrics.a.a(((a) (k)), ((StringBuilder) (s1)).toString());
	//  406  854:aload_1         
	//  407  855:aload_2         
...
_L1:
	...
	//   18   40:pop             
		String s1;
		if(android.os.VERSION.RELEASE == null)
...
_L3:
		obj = ((Object) (com.mixpanel.android.mpmetrics.a.e.c(a).f()));
		...
		obj = ((Object) (com.mixpanel.android.mpmetrics.a.e.c(a).a()));
		if(obj != null)
		{
			jsonobject.put("$app_version", obj);
			jsonobject.put("$app_version_string", obj);
		}
		obj = ((Object) (com.mixpanel.android.mpmetrics.a.e.c(a).b()));
		if(obj != null)
		{
			jsonobject.put("$app_release", obj);
			jsonobject.put("$app_build_number", obj);
		}
		obj = ((Object) (Boolean.valueOf(com.mixpanel.android.mpmetrics.a.e.c(a).d())));
		if(obj != null)
			jsonobject.put("$has_nfc", ((Boolean) (obj)).booleanValue());
		obj = ((Object) (Boolean.valueOf(com.mixpanel.android.mpmetrics.a.e.c(a).e())));
		if(obj != null)
			jsonobject.put("$has_telephone", ((Boolean) (obj)).booleanValue());
		obj = ((Object) (com.mixpanel.android.mpmetrics.a.e.c(a).g()));
		if(obj != null)
			jsonobject.put("$carrier", obj);
		obj = ((Object) (com.mixpanel.android.mpmetrics.a.e.c(a).h()));
		if(obj != null)
			jsonobject.put("$wifi", ((Boolean) (obj)).booleanValue());
		obj = ((Object) (com.mixpanel.android.mpmetrics.a.e.c(a).i()));
		if(obj != null)
			jsonobject.put("$bluetooth_enabled", obj);
		obj = ((Object) (com.mixpanel.android.mpmetrics.a.e.c(a).j()));
		if(obj != null)
...
_L1:
	...
	//   71  160:pop             
		com.mixpanel.android.mpmetrics.a.a(((a) (message)), stringbuilder1.toString());
	//   72  161:aload_1         
	//   73  162:aload           10
...
_L4:
	...
	//  122  271:pop             
		com.mixpanel.android.mpmetrics.a.a(((a) (message)), stringbuilder4.toString());
	//  123  272:aload_1         
	//  124  273:aload           11
...
_L6:
	...
	//  188  415:invokestatic    #126 <Method void a.a(a, String)>
		com.mixpanel.android.mpmetrics.a.e.a(a);
	//  189  418:aload_0         
...
_L16:
	...
	//  340  726:invokevirtual   #588 <Method void i.a()>
			com.mixpanel.android.mpmetrics.a.e.a(a, ((Handler) (null)));
	//  341  729:aload_0         
...
_L18:
	...
	public a$e$a(a.e e1, Looper looper)
	{
		a = e1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//    8   12:putfield        #31  <Field i b>
		com.mixpanel.android.mpmetrics.a.e.a(e1, s.a(e1.a.a));
	//    9   15:aload_1         
	//   10   16:aload_1         
