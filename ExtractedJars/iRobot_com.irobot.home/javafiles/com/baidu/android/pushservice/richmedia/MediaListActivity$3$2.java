	...
	implements android.content.kListener
{
	...
	MediaListActivity$3$2(MediaListActivity._cls3 _pcls3, long l)
	{
		b = _pcls3;
	//    0    0:aload_0         
	//    1    1:aload_1         
...
/* anonymous class */
		...
		implements android.widget.AdapterView.OnItemLongClickListener
	{
		...
		{
			(new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setTitle("\u63D0\u793A").setMessage("\u786E\u5B9A\u8981\u5220\u9664\u8BE5\u8BB0\u5F55\uFF1F").setPositiveButton("\u786E\u5B9A", ((android.content.DialogInterface.OnClickListener) (new MediaListActivity._cls3._cls2(this, l)))).setNegativeButton("\u53D6\u6D88", new MediaListActivity._cls3._cls1()).show();
		...
		// Unreferenced inner class com/baidu/android/pushservice/richmedia/MediaListActivity$3$1

/* anonymous class */
		class MediaListActivity._cls3._cls1
			implements android.content.DialogInterface.OnClickListener
		{
			...
			final MediaListActivity._cls3 a;
					...
					{
						a = MediaListActivity._cls3.this;
					//    0    0:aload_0         
					//    1    1:aload_1         
