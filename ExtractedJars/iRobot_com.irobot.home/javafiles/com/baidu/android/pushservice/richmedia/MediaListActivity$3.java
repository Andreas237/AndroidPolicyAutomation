	...
	implements android.widget.ngClickListener
{
	...
	{
		(new android.app.AlertDialog$Builder(((android.content.Context) (a)))).setTitle("\u63D0\u793A").setMessage("\u786E\u5B9A\u8981\u5220\u9664\u8BE5\u8BB0\u5F55\uFF1F").setPositiveButton("\u786E\u5B9A", new android.content.DialogInterface.OnClickListener(l) {
	...
	MediaListActivity$3(MediaListActivity medialistactivity)
	{
		a = medialistactivity;
	//    0    0:aload_0         
	//    1    1:aload_1         
