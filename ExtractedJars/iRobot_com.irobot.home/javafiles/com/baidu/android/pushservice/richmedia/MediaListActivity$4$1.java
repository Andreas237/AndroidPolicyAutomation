	...
	implements Runnable
{
	...
	MediaListActivity$4$1(MediaListActivity._cls4 _pcls4)
	{
		a = _pcls4;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/baidu/android/pushservice/richmedia/MediaListActivity$4

/* anonymous class */
	class MediaListActivity._cls4
		implements f
	{
		...
		//*  78  159:bipush          16
		//*  79  161:icmplt          193
					a1 = ((a) ((new android.app.Notification.Builder(((android.content.Context) (a)))).setSmallIcon(0x1080081).setWhen(System.currentTimeMillis()).build()));
		...
		//   92  182:invokevirtual   #229 <Method void ContentValues.put(String, String)>
						a1 = ((a) (a.getContentResolver().insert(android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI, contentvalues)));
		//   93  185:aload_0         
		...
		//    8   16:iconst_0        
		//    9   17:invokevirtual   #157 <Method void NotificationManager.cancel(String, int)>
			a.runOnUiThread(((Runnable) (new MediaListActivity._cls4._cls1(this))));
		//   10   20:aload_0         
		//   11   21:getfield        #18  <Field MediaListActivity a>
