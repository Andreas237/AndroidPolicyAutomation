...
public abstract class NetworkSessionAttributeUtil
{
	private static final class CppProxy extends NetworkSessionAttributeUtil
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void NetworkSessionAttributeUtil()>
		//    2    4:aload_0         
	...
	public NetworkSessionAttributeUtil()
	{
	//    0    0:aload_0         
	...
	public static native AssetId assetIdFromAttributes(HashMap hashmap);

	public static native NetworkAddress networkAddressFromAttributes(HashMap hashmap);
}
