...
//			ApplicationUIServiceData, ApplicationUIServiceDataCallback, ApplicationUIServiceCommand

public abstract class ApplicationUIService
{
	private static final class CppProxy extends ApplicationUIService
	{
	...
	public abstract ApplicationUIServiceData getServiceData();

	public abstract boolean isAssetConfigured(String s);

	public abstract boolean isCurrentCountryChina();

	public abstract boolean isCurrentCountryRussia();

	public abstract boolean registerSubscriber(ApplicationUIServiceDataCallback applicationuiservicedatacallback);

	public abstract boolean registerUISubscriber(ApplicationUIServiceDataCallback applicationuiservicedatacallback);

	public abstract void sendCommand(ApplicationUIServiceCommand applicationuiservicecommand, ApplicationUIServiceData applicationuiservicedata);

	public abstract boolean unregisterSubscriber(ApplicationUIServiceDataCallback applicationuiservicedatacallback);
}
