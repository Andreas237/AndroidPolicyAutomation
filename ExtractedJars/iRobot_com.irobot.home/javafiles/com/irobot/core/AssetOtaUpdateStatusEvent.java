...
//			AssetEvent, OtaUpdateError, OtaUpdateStatus, AssetId, 
//			Event, EventType

public abstract class AssetOtaUpdateStatusEvent extends AssetEvent
{
	private static final class CppProxy extends AssetOtaUpdateStatusEvent
	{
	...
	public AssetOtaUpdateStatusEvent()
	{
	//    0    0:aload_0         
	...
	public abstract OtaUpdateError error();

	public abstract String packageLabel();

	public abstract OtaUpdateStatus status();

	public abstract boolean statusTerminal();
}
