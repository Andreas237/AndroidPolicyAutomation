...
//			AssetEvent, RobotReadinessState, AssetId, Event, 
//			EventType

public abstract class RobotReadinessEvent extends AssetEvent
{
	private static final class CppProxy extends RobotReadinessEvent
	{
		...
		private native RobotReadinessState native_readinessState(long l);
		...
		public RobotReadinessState readinessState()
		{
			return native_readinessState(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method RobotReadinessState native_readinessState(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotReadinessEvent()>
		//    2    4:aload_0         
	...
	public abstract RobotReadinessState readinessState();
}
