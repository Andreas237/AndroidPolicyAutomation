...
//			AssetMissingEvent, AssetId, Event, EventType

private static final class AssetMissingEvent$CppProxy extends AssetMissingEvent
{
	...
	private native boolean native_isMissing(long l);
	...
	{
		return native_isMissing(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #82  <Method boolean native_isMissing(long)>
	//    4    8:ireturn         
	}
	...
	private AssetMissingEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void AssetMissingEvent()>
	//    2    4:aload_0         
