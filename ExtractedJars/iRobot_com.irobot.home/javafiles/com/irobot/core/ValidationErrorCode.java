...
{
	private static final class CppProxy extends ValidationErrorCode
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void ValidationErrorCode()>
		//    2    4:aload_0         
	...
	public static final int UNAUTHORIZED_ASSET = 201;
	public static final int UNKNOWN_ASSET = 200;
	public static final int UNREGISTERED_ASSET = 203;
}
