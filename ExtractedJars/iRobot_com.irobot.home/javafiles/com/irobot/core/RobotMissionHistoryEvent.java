...
public abstract class RobotMissionHistoryEvent extends AssetEvent
{
	private static final class CppProxy extends RobotMissionHistoryEvent
	{
		...
		private native ArrayList native_missions(long l);
		...
		{
			return native_missions(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method ArrayList native_missions(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotMissionHistoryEvent()>
		//    2    4:aload_0         
	...
	public RobotMissionHistoryEvent()
	{
	//    0    0:aload_0         
	...
	public abstract ArrayList missions();
}
