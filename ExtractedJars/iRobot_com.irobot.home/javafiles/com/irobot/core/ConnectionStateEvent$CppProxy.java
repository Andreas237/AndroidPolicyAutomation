...
//			ConnectionStateEvent, AssetId, Event, EventType

private static final class ConnectionStateEvent$CppProxy extends ConnectionStateEvent
{
	...
	private native HashMap native_networkState(long l);
	...
	public HashMap networkState()
	{
		return native_networkState(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #88  <Method HashMap native_networkState(long)>
	//    4    8:areturn         
	}
	...
	private ConnectionStateEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void ConnectionStateEvent()>
	//    2    4:aload_0         
