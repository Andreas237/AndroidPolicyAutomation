...
{
	private static final class CppProxy extends AccountUtils
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void AccountUtils()>
		//    2    4:aload_0         
	...
	public static native HashSet getAllAccountFlagTypes();

	public static native HashSet getAllFeatureTypes();

	public static native HashSet getAllLegalTermTypes();

	public static native HashSet getBetaProgramFeatureTypes();

	public static native HashSet getInternalFeatureSwitchFeatureTypes();

	public static native boolean isBetaFeatureType(FeatureType featuretype);
}
