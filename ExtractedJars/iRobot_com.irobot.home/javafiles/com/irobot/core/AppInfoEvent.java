...
//			Event, AppId, EventType

public abstract class AppInfoEvent extends Event
{
	private static final class CppProxy extends AppInfoEvent
	{

		private native void nativeDestroy(long l);

		private native AppId native_appId(long l);

		private native String native_appLanguage(long l);

		private native String native_appVersion(long l);
		...
		public AppId appId()
		{
			return native_appId(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #54  <Method AppId native_appId(long)>
		//    4    8:areturn         
		}

		public String appLanguage()
		{
			return native_appLanguage(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #58  <Method String native_appLanguage(long)>
		//    4    8:areturn         
		}

		public String appVersion()
		{
			return native_appVersion(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #61  <Method String native_appVersion(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AppInfoEvent()>
		//    2    4:aload_0         
	...
	public static native AppInfoEvent create(AppId appid, String s, String s1);
