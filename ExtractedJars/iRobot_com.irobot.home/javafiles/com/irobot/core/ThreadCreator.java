...
{
	private static final class CppProxy extends ThreadCreator
	{
	...
	public abstract boolean isRunningOnMainThread();

	public abstract void postOnMainThread(String s, ThreadRunner threadrunner);

	public abstract void postOnMainThreadAfterDelay(String s, ThreadRunner threadrunner, long l);

	public abstract void startThread(String s, ThreadRunner threadrunner);
}
