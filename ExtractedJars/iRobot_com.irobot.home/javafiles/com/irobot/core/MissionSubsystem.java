...
//			ResolvedMissionStatusEvent, LogStreamUIServiceDataCallback, MissionUIServiceDataCallback, CommandType, 
//			MissionUIServiceCommand, MissionUIServiceData
...
public abstract class MissionSubsystem
{
	...
	public abstract HashSet availableCommands();
	...
	public abstract boolean registerLogStreamSubscriber(LogStreamUIServiceDataCallback logstreamuiservicedatacallback);

	public abstract boolean registerSubscriber(MissionUIServiceDataCallback missionuiservicedatacallback);

	public abstract boolean registerUISubscriber(MissionUIServiceDataCallback missionuiservicedatacallback);

	public abstract void sendCommand(CommandType commandtype);

	public abstract void sendCommandJson(String s);

	public abstract void sendServiceCommand(MissionUIServiceCommand missionuiservicecommand, MissionUIServiceData missionuiservicedata);

	public abstract boolean unregisterLogStreamSubscriber(LogStreamUIServiceDataCallback logstreamuiservicedatacallback);

	public abstract boolean unregisterSubscriber(MissionUIServiceDataCallback missionuiservicedatacallback);
}
