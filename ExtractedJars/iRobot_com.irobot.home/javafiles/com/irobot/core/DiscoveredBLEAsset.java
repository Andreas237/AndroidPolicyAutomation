...
//			DiscoveredAsset, AssetInfo, DiscoveryType

public abstract class DiscoveredBLEAsset extends DiscoveredAsset
{
	private static final class CppProxy extends DiscoveredBLEAsset
	{
		...
		//    3    5:invokespecial   #44  <Method AssetInfo native_assetInfo(long)>
		//    4    8:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #55  <Method DiscoveryType native_discoveryType(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void DiscoveredBLEAsset()>
		//    2    4:aload_0         
	...
	public static native DiscoveredBLEAsset create(AssetInfo assetinfo);
}
