...
public abstract class AssetWetnessLevelEvent extends AssetEvent
{
	private static final class CppProxy extends AssetWetnessLevelEvent
	{
		...
		private native HashMap native_wetnessLevels(long l);
		...
		public HashMap wetnessLevels()
		{
			return native_wetnessLevels(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #92  <Method HashMap native_wetnessLevels(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetWetnessLevelEvent()>
		//    2    4:aload_0         
	...
	public abstract HashMap wetnessLevels();
}
