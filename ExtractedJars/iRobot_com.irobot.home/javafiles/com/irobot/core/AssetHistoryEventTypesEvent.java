...
public abstract class AssetHistoryEventTypesEvent extends AssetEvent
{
	private static final class CppProxy extends AssetHistoryEventTypesEvent
	{

		private native void nativeDestroy(long l);

		private native HashSet native_accumulatedHistoryEventTypes(long l);
		...
		private native HashSet native_robotMissionHistoryItemEventTypes(long l);

		private native Date native_timestamp(long l);

		public HashSet accumulatedHistoryEventTypes()
		{
			return native_accumulatedHistoryEventTypes(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #55  <Method HashSet native_accumulatedHistoryEventTypes(long)>
		//    4    8:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #61  <Method AssetId native_assetId(long)>
		//    4    8:areturn         
		}
		...
		public HashSet robotMissionHistoryItemEventTypes()
		{
			return native_robotMissionHistoryItemEventTypes(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #94  <Method HashSet native_robotMissionHistoryItemEventTypes(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetHistoryEventTypesEvent()>
		//    2    4:aload_0         
	...
	public AssetHistoryEventTypesEvent()
	{
	//    0    0:aload_0         
	...
	public abstract HashSet accumulatedHistoryEventTypes();

	public abstract HashSet robotMissionHistoryItemEventTypes();
}
