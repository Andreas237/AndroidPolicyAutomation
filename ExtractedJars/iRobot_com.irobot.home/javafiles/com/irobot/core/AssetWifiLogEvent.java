...
public abstract class AssetWifiLogEvent extends AssetEvent
{
	private static final class CppProxy extends AssetWifiLogEvent
	{
		...
		private native ArrayList native_log(long l);
		...
		{
			return native_log(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method ArrayList native_log(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetWifiLogEvent()>
		//    2    4:aload_0         
