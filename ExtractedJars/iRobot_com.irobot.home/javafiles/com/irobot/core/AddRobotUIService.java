...
//			AddRobotUIServiceDataCallback, AddRobotUIServiceCommand, AddRobotUIServiceData

public abstract class AddRobotUIService
{
	private static final class CppProxy extends AddRobotUIService
	{
	...
	public abstract boolean registerSubscriber(AddRobotUIServiceDataCallback addrobotuiservicedatacallback);

	public abstract boolean registerUISubscriber(AddRobotUIServiceDataCallback addrobotuiservicedatacallback);

	public abstract void sendCommand(AddRobotUIServiceCommand addrobotuiservicecommand, AddRobotUIServiceData addrobotuiservicedata);

	public abstract boolean unregisterSubscriber(AddRobotUIServiceDataCallback addrobotuiservicedatacallback);
}
