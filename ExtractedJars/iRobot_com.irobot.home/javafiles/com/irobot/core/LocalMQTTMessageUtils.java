...
public abstract class LocalMQTTMessageUtils
{
	private static final class CppProxy extends LocalMQTTMessageUtils
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void LocalMQTTMessageUtils()>
		//    2    4:aload_0         
	...
	public static native MessageLengthT decodeMessageLength(byte abyte0[]);

	public static native byte getMaximumEncodingLengthInBytes();

	public static native boolean reachedEndOfEncodedLength(byte byte0);
}
