...
//			AccountService, AssetId, AddRobotUIService, AnalyticsSubsystem, 
//			ApplicationUIService, AssetService, AssetSetupUIService, AssetStatusSubsystem, 
//			CommandTierAgent, EventBusHandler, HistoryUIService, MaintenanceUIService, 
//			MapsUIService, MissionSubsystem, AssetNetworkUIService, NotificationCenterUIService, 
//			PMIApplicationService, PersistenceHandler, PushNotificationService, RegistrationService, 
//			ResourceHandler, ScheduleUIService, SettingsSubsystem, PMIAssetInfo, 
//			TimeService, UpdateUIService, AssetInfo, ProvisioningType
...
public abstract class Assembler
{
	...
	public abstract AddRobotUIService getAddRobotUIService(AssetId assetid);

	public abstract AnalyticsSubsystem getAnalyticsSubsystem();

	public abstract ApplicationUIService getApplicationUIService();

	public abstract AssetService getAssetService();

	public abstract AssetSetupUIService getAssetSetupUIService();
	...
	public abstract HistoryUIService getHistoryUIService(AssetId assetid);

	public abstract MaintenanceUIService getMaintenanceUIService(String s);

	public abstract MapsUIService getMapsUIService(AssetId assetid);

	public abstract MissionSubsystem getMissionSubsystem(AssetId assetid);

	public abstract AssetNetworkUIService getNetworkUIService(AssetId assetid);

	public abstract NotificationCenterUIService getNotificationCenterUIService(AssetId assetid);

	public abstract PMIApplicationService getPMIApplicationService();
	...
	public abstract ScheduleUIService getScheduleUIService(AssetId assetid);

	public abstract SettingsSubsystem getSettingsSubsystem(AssetId assetid);

	public abstract SettingsSubsystem getSettingsUIService(PMIAssetInfo pmiassetinfo);

	public abstract TimeService getTimeService();

	public abstract UpdateUIService getUpdateUIService(AssetId assetid);
	...
	public abstract void initializeAssetForProvisioning(AssetInfo assetinfo, ProvisioningType provisioningtype);

	public abstract void initializeGlobalServices(String s, String s1);

	public abstract boolean isInitialized(AssetId assetid);

	public abstract boolean isKeepOutZonesEnabled();

	public abstract boolean isMapDemoModeEnabled();

	public abstract boolean isPMapsEnabled();

	public abstract void removeAsset(AssetId assetid);

	public abstract void setDomainEventBus(EventBusHandler eventbushandler);

	public abstract void setKeepOutZonesEnabled(boolean flag);

	public abstract void setMapDemoModeEnabled(boolean flag);

	public abstract void setPMapsEnabled(boolean flag);

	public abstract void setResourceHandler(ResourceHandler resourcehandler);
}
