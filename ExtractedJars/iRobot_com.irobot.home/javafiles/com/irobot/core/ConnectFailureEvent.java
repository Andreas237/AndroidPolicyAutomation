...
//			AssetEvent, AssetId, ConnectFailureReason, Event, 
//			EventType

public abstract class ConnectFailureEvent extends AssetEvent
{
	private static final class CppProxy extends ConnectFailureEvent
	{
		...
		private native ConnectFailureReason native_reason(long l);
		...
		public ConnectFailureReason reason()
		{
			return native_reason(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method ConnectFailureReason native_reason(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void ConnectFailureEvent()>
		//    2    4:aload_0         
	...
	public static native ConnectFailureEvent create(AssetId assetid, ConnectFailureReason connectfailurereason);

	public abstract ConnectFailureReason reason();
}
