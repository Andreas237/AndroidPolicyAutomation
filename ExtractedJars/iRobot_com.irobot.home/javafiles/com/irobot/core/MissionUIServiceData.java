...
//			DockState, EvacuationDockMode, MissionStatusAction, ResolvedMissionStatus

public abstract class MissionUIServiceData
{
	private static final class CppProxy extends MissionUIServiceData
	{
	...
	public static native MissionUIServiceData create();

	public abstract short getBatteryLevelPercentage();

	public abstract DockState getDockState();

	public abstract EvacuationDockMode getEvacDockMode();

	public abstract String getEvacHelpContentId();

	public abstract String getEvacStatusMessage();

	public abstract ArrayList getEvacStatusMessageArgs();

	public abstract String getHelpContentId();

	public abstract String getHelpContentUrl();

	public abstract boolean getIsBinfull();

	public abstract boolean getIsCharging();

	public abstract boolean getIsLogStreamEnabled();

	public abstract boolean getIsStatusConnectionRelated();

	public abstract boolean getIsTankLow();

	public abstract boolean getIsTraining();

	public abstract String getLogStreamData();

	public abstract ArrayList getMissionDataStates();

	public abstract MissionStatusAction getMissionStatusAction();

	public abstract short getPauseExpireTime();

	public abstract short getPauseResumeTime();

	public abstract ResolvedMissionStatus getResolvedMissionStatus();

	public abstract boolean getShowEvacDockTour();

	public abstract String getStatusMessage();

	public abstract ArrayList getStatusMessageArgs();

	public abstract boolean isPaused();

	public abstract void setMissionStatusAction(MissionStatusAction missionstatusaction);
}
