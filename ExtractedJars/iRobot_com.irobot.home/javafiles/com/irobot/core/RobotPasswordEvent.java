...
public abstract class RobotPasswordEvent extends AssetEvent
{
	private static final class CppProxy extends RobotPasswordEvent
	{
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #86  <Method String native_password(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotPasswordEvent()>
		//    2    4:aload_0         
	...
	public static native RobotPasswordEvent create(AssetId assetid, String s);
