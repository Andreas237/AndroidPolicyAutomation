...
//			PMIAccountsComponent, PMIAssetService, PMIProvisioningService, PMIAssetInfo

public abstract class PMIApplicationService
{
	private static final class CppProxy extends PMIApplicationService
	{
	...
	public static native PMIApplicationService getInstance();

	public abstract PMIAccountsComponent getAccountsComponent();
	...
	public abstract PMIAssetService getAsset(String s);

	public abstract ArrayList getAssets();

	public abstract PMIProvisioningService getProvisioningService();

	public abstract void loadProtocolConfig(String s);

	public abstract void registerAsset(PMIAssetInfo pmiassetinfo);

	public abstract void removeAsset(String s);

	public abstract void setAppLanguage(String s);
