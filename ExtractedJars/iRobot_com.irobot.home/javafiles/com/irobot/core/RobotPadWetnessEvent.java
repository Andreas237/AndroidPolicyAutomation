...
public abstract class RobotPadWetnessEvent extends AssetEvent
{
	private static final class CppProxy extends RobotPadWetnessEvent
	{
		...
		private native HashMap native_padWetness(long l);
		...
		public HashMap padWetness()
		{
			return native_padWetness(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method HashMap native_padWetness(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotPadWetnessEvent()>
		//    2    4:aload_0         
	...
	public abstract HashMap padWetness();
}
