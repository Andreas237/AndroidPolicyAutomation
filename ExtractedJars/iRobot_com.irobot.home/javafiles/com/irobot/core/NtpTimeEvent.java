...
public abstract class NtpTimeEvent extends Event
{
	private static final class CppProxy extends NtpTimeEvent
	{
		...
		private native Date native_time(long l);
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #81  <Method boolean native_success(long)>
		//    4    8:ireturn         
		}

		public Date time()
		{
			return native_time(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #85  <Method Date native_time(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void NtpTimeEvent()>
		//    2    4:aload_0         
