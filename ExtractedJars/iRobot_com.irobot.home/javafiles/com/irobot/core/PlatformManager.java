...
//			ABTestHandler, AccountHandler, AccountViewHandler, ApplicationInfoHandler, 
//			AuthenticatedHttpsRequestor, BluetoothHandler, ConfiguredAssetsHandler, DeviceInfoHandler, 
//			DirectoryHandler, DiscoveryManager, HttpsRequestor, LocaleHandler, 
//			LogHandler, PersistenceHandler, PushNotificationHandler, WebServicesHandler
...
public abstract class PlatformManager
{
	...
	public abstract AccountViewHandler getAccountViewHandler();

	public abstract ApplicationInfoHandler getAppInfoHandler();

	public abstract AuthenticatedHttpsRequestor getAuthenticatedHttpsRequestor();

	public abstract BluetoothHandler getBluetoothHandler();

	public abstract ConfiguredAssetsHandler getConfiguredAssetsHandler();

	public abstract DeviceInfoHandler getDeviceInfoHandler();

	public abstract DirectoryHandler getDirectoryHandler();

	public abstract DiscoveryManager getDiscoveryManager();

	public abstract HttpsRequestor getHttpsRequestor();

	public abstract LocaleHandler getLocaleHandler();

	public abstract LogHandler getLogHandler();
	...
	public abstract WebServicesHandler getWebServicesHandler();
	...
	public abstract void setAccountViewHandler(AccountViewHandler accountviewhandler);
	...
	public abstract void setBluetoothHandler(BluetoothHandler bluetoothhandler);

	public abstract void setConfiguredAssetsHandler(ConfiguredAssetsHandler configuredassetshandler);
	...
	public abstract void setDiscoveryManager(DiscoveryManager discoverymanager);
