...
public abstract class RobotLanguageEvent extends AssetEvent
{
	private static final class CppProxy extends RobotLanguageEvent
	{
		...
		private native int native_robotLanguage(long l);
		...
		public int robotLanguage()
		{
			return native_robotLanguage(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method int native_robotLanguage(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotLanguageEvent()>
		//    2    4:aload_0         
	...
	public abstract int robotLanguage();
}
