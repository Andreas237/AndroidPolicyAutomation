...
public abstract class PMIAssetEvent extends PMIEvent
{
	private static final class CppProxy extends PMIAssetEvent
	{
		...
		//    3    5:aload_1         
		//    4    6:invokespecial   #62  <Method ArrayList native_arrayIntValue(long, String)>
		//    5    9:areturn         
		}
		...
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:aload_1         
		//    4    6:invokespecial   #67  <Method ArrayList native_arrayObjectValue(long, String)>
		//    5    9:areturn         
		}
		...
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:aload_1         
		//    4    6:invokespecial   #71  <Method ArrayList native_arrayStringValue(long, String)>
		//    5    9:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #76  <Method String native_assetId(long)>
		//    4    8:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:iload_2         
		//    5    7:invokespecial   #80  <Method boolean native_boolValue(long, String, boolean)>
		//    6   10:ireturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:fload_2         
		//    5    7:invokespecial   #98  <Method float native_float32Value(long, String, float)>
		//    6   10:freturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #101 <Method String native_id(long)>
		//    4    8:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:iload_2         
		//    5    7:invokespecial   #105 <Method short native_int16Value(long, String, short)>
		//    6   10:ireturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:iload_2         
		//    5    7:invokespecial   #109 <Method int native_int32Value(long, String, int)>
		//    6   10:ireturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #113 <Method ArrayList native_keys(long)>
		//    4    8:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:aload_2         
		//    5    7:invokespecial   #118 <Method PMIEvent native_objectValue(long, String, PMIEvent)>
		//    6   10:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #121 <Method String native_rawData(long)>
		//    4    8:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:aload_2         
		//    5    7:invokespecial   #125 <Method String native_stringValue(long, String, String)>
		//    6   10:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void PMIAssetEvent()>
		//    2    4:aload_0         
	...
	public PMIAssetEvent()
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #11  <Method void PMIEvent()>
	//    2    4:return          
	}
