...
public abstract class AvailableSettingsEvent extends AssetEvent
{
	private static final class CppProxy extends AvailableSettingsEvent
	{
		...
		private native HashSet native_availableSettings(long l);
		...
		public HashSet availableSettings()
		{
			return native_availableSettings(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #58  <Method HashSet native_availableSettings(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AvailableSettingsEvent()>
		//    2    4:aload_0         
	...
	public abstract HashSet availableSettings();
}
