...
public abstract class RobotBinFullEvent extends AssetEvent
{
	private static final class CppProxy extends RobotBinFullEvent
	{
		...
		private native boolean native_isBinFull(long l);
		...
		{
			return native_isBinFull(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #82  <Method boolean native_isBinFull(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotBinFullEvent()>
		//    2    4:aload_0         
	...
	public abstract boolean isBinFull();
}
