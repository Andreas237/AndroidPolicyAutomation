...
//			AssetSerialNumberEvent, AssetId, Event, EventType

private static final class AssetSerialNumberEvent$CppProxy extends AssetSerialNumberEvent
{
	...
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #86  <Method String native_serialNumber(long)>
	//    4    8:areturn         
	}
	...
	private AssetSerialNumberEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void AssetSerialNumberEvent()>
	//    2    4:aload_0         
