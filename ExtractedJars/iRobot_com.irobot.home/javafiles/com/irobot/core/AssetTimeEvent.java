...
//			AssetEvent, DayOfTheWeek, AssetId, Event, 
//			EventType

public abstract class AssetTimeEvent extends AssetEvent
{
	private static final class CppProxy extends AssetTimeEvent
	{
		...
		private native DayOfTheWeek native_day(long l);
		...
		private native short native_hour(long l);

		private native String native_key(long l);

		private native short native_minute(long l);
		...
		{
			return native_day(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #61  <Method DayOfTheWeek native_day(long)>
		//    4    8:areturn         
		}
		...
		public short hour()
		{
			return native_hour(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #91  <Method short native_hour(long)>
		//    4    8:ireturn         
		}
		...
		public short minute()
		{
			return native_minute(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #98  <Method short native_minute(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetTimeEvent()>
		//    2    4:aload_0         
	...
	public abstract DayOfTheWeek day();
