...
//			AssetEvent, UpdateStatus, FirmwareUpdateItem, AssetId, 
//			Event, EventType

public abstract class AssetUpdateAvailabilityEvent extends AssetEvent
{
	private static final class CppProxy extends AssetUpdateAvailabilityEvent
	{
		...
		private native String native_currentVersion(long l);
		...
		private native UpdateStatus native_status(long l);

		private native Date native_timestamp(long l);

		private native FirmwareUpdateItem native_updateInfo(long l);
		...
		{
			return native_currentVersion(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #61  <Method String native_currentVersion(long)>
		//    4    8:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #94  <Method UpdateStatus native_status(long)>
		//    4    8:areturn         
		}
		...
		public FirmwareUpdateItem updateInfo()
		{
			return native_updateInfo(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #102 <Method FirmwareUpdateItem native_updateInfo(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetUpdateAvailabilityEvent()>
		//    2    4:aload_0         
	...
	public AssetUpdateAvailabilityEvent()
	{
	//    0    0:aload_0         
	...
	public abstract UpdateStatus status();

	public abstract FirmwareUpdateItem updateInfo();
}
