...
//			AssetOtaDeploymentIdEvent, AssetId, Event, EventType

private static final class AssetOtaDeploymentIdEvent$CppProxy extends AssetOtaDeploymentIdEvent
{
	...
	private native String native_deploymentId(long l);
	...
	private native boolean native_isUserInitiated(long l);
	...
	{
		return native_deploymentId(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #58  <Method String native_deploymentId(long)>
	//    4    8:areturn         
	}
	...
	{
		return native_isUserInitiated(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #87  <Method boolean native_isUserInitiated(long)>
	//    4    8:ireturn         
	}
	...
	private AssetOtaDeploymentIdEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void AssetOtaDeploymentIdEvent()>
	//    2    4:aload_0         
