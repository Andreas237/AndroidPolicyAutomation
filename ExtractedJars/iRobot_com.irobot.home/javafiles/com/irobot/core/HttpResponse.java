...
{
	private static final class CppProxy extends HttpResponse
	{
		...
		//    3    5:invokespecial   #58  <Method String native_json(long)>
		//    4    8:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #62  <Method int native_statusCode(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void HttpResponse()>
		//    2    4:aload_0         
	...
	public static native HttpResponse create(String s, int i);
