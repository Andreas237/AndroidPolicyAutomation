...
//			Event, FeatureType, EventType

public abstract class AccountFeatureUpdateFailedEvent extends Event
{
	private static final class CppProxy extends AccountFeatureUpdateFailedEvent
	{
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #86  <Method FeatureType native_type(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AccountFeatureUpdateFailedEvent()>
		//    2    4:aload_0         
	...
	public AccountFeatureUpdateFailedEvent()
	{
	//    0    0:aload_0         
