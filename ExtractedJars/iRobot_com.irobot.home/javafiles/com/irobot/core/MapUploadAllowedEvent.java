...
public abstract class MapUploadAllowedEvent extends AssetEvent
{
	private static final class CppProxy extends MapUploadAllowedEvent
	{
		...
		private native boolean native_isMapUploadAllowed(long l);
		...
		public boolean isMapUploadAllowed()
		{
			return native_isMapUploadAllowed(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #82  <Method boolean native_isMapUploadAllowed(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void MapUploadAllowedEvent()>
		//    2    4:aload_0         
	...
	public abstract boolean isMapUploadAllowed();
}
