...
public abstract class Core
{
	private static final class CppProxy extends Core
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void Core()>
		//    2    4:aload_0         
	...
	public static native String codename();

	public static native String copyright();

	public static native LogLevel logLevel();

	public static native String logTag();

	public static native void setLogLevel(LogLevel loglevel);

	public static native void setLogTag(String s);

	public static native void setLogger(Logger logger);

	public static native void setThreadCreator(ThreadCreator threadcreator);
