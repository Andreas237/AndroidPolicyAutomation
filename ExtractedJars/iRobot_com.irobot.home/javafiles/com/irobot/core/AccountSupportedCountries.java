...
public abstract class AccountSupportedCountries
{
	private static final class CppProxy extends AccountSupportedCountries
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void AccountSupportedCountries()>
		//    2    4:aload_0         
	...
	public AccountSupportedCountries()
	{
	//    0    0:aload_0         
	...
	public static native HashSet getMultiAccountList();

	public static native HashSet getOptInList();
}
