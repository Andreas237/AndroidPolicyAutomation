...
public abstract class RobotBinRemovalEvent extends AssetEvent
{
	private static final class CppProxy extends RobotBinRemovalEvent
	{
		...
		private native boolean native_isBinRemoved(long l);
		...
		public boolean isBinRemoved()
		{
			return native_isBinRemoved(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #82  <Method boolean native_isBinRemoved(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotBinRemovalEvent()>
		//    2    4:aload_0         
	...
	public abstract boolean isBinRemoved();
}
