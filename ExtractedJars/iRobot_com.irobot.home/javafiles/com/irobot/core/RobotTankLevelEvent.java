...
public abstract class RobotTankLevelEvent extends AssetEvent
{
	private static final class CppProxy extends RobotTankLevelEvent
	{
		...
		private native boolean native_isTankLow(long l);

		private native String native_key(long l);

		private native int native_tankLevel(long l);
		...
		public boolean isTankLow()
		{
			return native_isTankLow(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #84  <Method boolean native_isTankLow(long)>
		//    4    8:ireturn         
		}
		...
		{
			return native_tankLevel(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #92  <Method int native_tankLevel(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotTankLevelEvent()>
		//    2    4:aload_0         
	...
	public abstract boolean isTankLow();

	public abstract int tankLevel();
}
