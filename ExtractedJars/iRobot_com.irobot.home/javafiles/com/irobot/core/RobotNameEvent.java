...
public abstract class RobotNameEvent extends AssetEvent
{
	private static final class CppProxy extends RobotNameEvent
	{
		...
		private native String native_robotName(long l);
		...
		{
			return native_robotName(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #86  <Method String native_robotName(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotNameEvent()>
		//    2    4:aload_0         
	...
	public abstract String robotName();
}
