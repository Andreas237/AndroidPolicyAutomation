...
public abstract class AssetRegistrationDateEvent extends AssetEvent
{
	private static final class CppProxy extends AssetRegistrationDateEvent
	{
		...
		private native Date native_registrationDate(long l);
		...
		{
			return native_registrationDate(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #87  <Method Date native_registrationDate(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetRegistrationDateEvent()>
		//    2    4:aload_0         
	...
	public AssetRegistrationDateEvent()
	{
	//    0    0:aload_0         
	...
	public abstract Date registrationDate();
}
