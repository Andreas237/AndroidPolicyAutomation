...
//			AnalyticsType, BaseAnalyticsHandler, AnalyticsEvent, AccountError, 
//			ContactType, AssetInfo, RobotPadCategory, RobotCareType, 
//			CarpetBoostMode, ScheduleMultipleMappingType, ScheduleLocationType, MultiPassMode, 
//			CleanPresetType, CommandType, EnjoyingAppPromptResponse, HelpDocumentType, 
//			HelpVideoType, RobotMissionHistoryCompletionStatus, SatisfactionRating, PushNotificationSetting, 
//			OnDemandOtaPath, AddRobotSelection, BleDiscoveryResult, ProvisioningStep, 
//			ProvisioningType, WifiProvisioningStatus, V1ProvisioningError, ViewId
...
public abstract class AnalyticsSubsystem
{
	...
	public abstract void trackAccountError(int i, String s, String s1, boolean flag);

	public abstract void trackAccountInfoRequestFinished(int i, int j);
	...
	public abstract void trackAppFeedbackResponseGiven(String s);

	public abstract void trackAppForegrounded();

	public abstract void trackAppLanguageCode(String s);

	public abstract void trackAppLaunched(boolean flag, ArrayList arraylist);

	public abstract void trackAppLaunchedAfterAppInstall();

	public abstract void trackAppLaunchedAfterAppUpgrade();

	public abstract void trackAppServiceDiscoveryFinished(int i, int j);

	public abstract int trackAppServiceDiscoveryStarted();

	public abstract void trackAssetRegistrationWithCloudFinished(AssetInfo assetinfo);

	public abstract void trackAssetRegistrationWithCloudStarted();

	public abstract void trackAssetServiceDiscoveryFinished(int i, boolean flag);

	public abstract int trackAssetServiceDiscoveryStarted();

	public abstract void trackBadgedAppOpened();

	public abstract void trackBetaProgramFeedbackSubmitted(String s, String s1);

	public abstract void trackBetaProgramIWantInButtonPressed(AssetInfo assetinfo);

	public abstract void trackBetaProgramThreeDotsButtonPressed(AssetInfo assetinfo);
	...
	public abstract void trackChooseRoomsButtonPressed(AssetInfo assetinfo);

	public abstract void trackCleanButtonIntro1CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackCleanButtonIntro1NextButtonPressed(AssetInfo assetinfo);

	public abstract void trackCleanButtonIntro2CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackCleanButtonIntro2CompleteButtonPressed(AssetInfo assetinfo);

	public abstract void trackCleanMapEnabledSettingChanged(AssetInfo assetinfo, boolean flag);

	public abstract void trackCleanMapInteractionFinished(AssetInfo assetinfo, boolean flag, boolean flag1, boolean flag2, boolean flag3, boolean flag4);

	public abstract void trackCleanMapInteractionStarted();

	public abstract void trackCleanScheduleTwoAddPressed(AssetInfo assetinfo);

	public abstract void trackCleanScheduleTwoExistingScheduleDeleted(AssetInfo assetinfo);

	public abstract void trackCleanScheduleTwoExistingScheduleEdited(AssetInfo assetinfo, ScheduleMultipleMappingType schedulemultiplemappingtype, int i, int j, ArrayList arraylist, ScheduleLocationType schedulelocationtype, HashMap hashmap);

	public abstract void trackCleanScheduleTwoExistingScheduleToggled(AssetInfo assetinfo, boolean flag);

	public abstract void trackCleanScheduleTwoNewScheduleCreated(AssetInfo assetinfo, ScheduleMultipleMappingType schedulemultiplemappingtype, int i, int j, ArrayList arraylist, ScheduleLocationType schedulelocationtype, HashMap hashmap);

	public abstract void trackCleanScheduleTwoPopularPressed(AssetInfo assetinfo);

	public abstract void trackCleanScheduleTwoSchedulesDeletedFromPMAPSChange(AssetInfo assetinfo, int i);

	public abstract void trackCleanScheduleTwoTimeoutError(AssetInfo assetinfo, String s);

	public abstract void trackCleanScheduleTwoUpdateFinished(AssetInfo assetinfo, String s);

	public abstract void trackCleanScheduleTwoUpdateStarted();
	...
	public abstract void trackCleaningPresetSettingChanged(AssetInfo assetinfo, CleanPresetType cleanpresettype);
	...
	public abstract void trackCountryPickerSelection(String s);

	public abstract void trackDirectedRoomCleaningStarted(AssetInfo assetinfo);

	public abstract void trackEdgeCleanSettingChanged(AssetInfo assetinfo, boolean flag);

	public abstract void trackEnjoyingAppPromptResponseGiven(EnjoyingAppPromptResponse enjoyingapppromptresponse);

	public abstract void trackEvacuationDockEmptyBinButtonPressed(AssetInfo assetinfo);

	public abstract void trackEvacuationDockErrorHelpContentViewed(AssetInfo assetinfo, String s);

	public abstract void trackExpeditedOtaRequested(AssetInfo assetinfo);

	public abstract void trackFinishWhenBinFullSettingChanged(AssetInfo assetinfo, boolean flag);
	...
	public abstract void trackHistoryDetailView(AssetInfo assetinfo, RobotMissionHistoryCompletionStatus robotmissionhistorycompletionstatus, boolean flag, int i, int j);

	public abstract void trackHistoryMissionMapRated(AssetInfo assetinfo, int i, String s, SatisfactionRating satisfactionrating);

	public abstract void trackHistoryProvideFeedbackButtonPressed(AssetInfo assetinfo);

	public abstract void trackHistorySummaryTabChanged();

	public abstract void trackHistorySummaryView(AssetInfo assetinfo, int i);

	public abstract void trackIsLegacyUser(boolean flag);

	public abstract void trackLeaveBetaProgramConfirmationButtonPressed(AssetInfo assetinfo);

	public abstract void trackLifetimeHistoryInfoButtonPressed(AssetInfo assetinfo);

	public abstract void trackLocalOtaFirmwareUpdateFinished(AssetInfo assetinfo, int i);

	public abstract void trackLocalOtaFirmwareUpdateStarted();
	...
	public abstract void trackNewAppVersionAvailableSkipClicked(String s);

	public abstract void trackNewAppVersionAvailableUpdateClicked(String s);

	public abstract void trackNewAppVersionAvailableViewed(String s);

	public abstract void trackNotificationBackSelected(AssetInfo assetinfo, String s, int i, int j);

	public abstract void trackNotificationCenterBellIconPressed(AssetInfo assetinfo, boolean flag);

	public abstract void trackNotificationCenterVideoViewed(AssetInfo assetinfo, String s, int i, int j);

	public abstract void trackNotificationCenterViewed(AssetInfo assetinfo, int i);

	public abstract void trackNotificationFeedback(AssetInfo assetinfo, boolean flag, String s, int i, int j);

	public abstract void trackNotificationSelected(AssetInfo assetinfo, String s, int i, int j);

	public abstract void trackNotificationSettingChanged(PushNotificationSetting pushnotificationsetting);

	public abstract void trackNotificationSmartScheduleAccepted(AssetInfo assetinfo, String s, int i, String s1);

	public abstract void trackNotificationSmartScheduleBackSelected(AssetInfo assetinfo, String s, int i, String s1);

	public abstract void trackNotificationSmartScheduleDeclined(AssetInfo assetinfo, String s, int i, String s1);

	public abstract void trackNotificationSmartScheduleMessageSelected(AssetInfo assetinfo, String s, int i, String s1);

	public abstract void trackOnDemandOtaAvailableHelpButtonPressed(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaAvailableViewed(AssetInfo assetinfo, OnDemandOtaPath ondemandotapath);

	public abstract void trackOnDemandOtaFailedHelpButtonPressed(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFailedTryAgainButtonPressed(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFailedUpdateLaterButtonPressed(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFirmwareUpdateAvailableFinished(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFirmwareUpdateAvailableStarted();

	public abstract void trackOnDemandOtaFirmwareUpdateError(AssetInfo assetinfo, int i);

	public abstract void trackOnDemandOtaFirmwareUpdateInstallingFinished(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFirmwareUpdateInstallingStarted();

	public abstract void trackOnDemandOtaFirmwareUpdateLoadingFinished(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFirmwareUpdateLoadingStarted();

	public abstract void trackOnDemandOtaFirmwareUpdateReadyFinished(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFirmwareUpdateReadyStarted();

	public abstract void trackOnDemandOtaFirmwareUpdateSuccessFinished(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaFirmwareUpdateSuccessStarted();

	public abstract void trackOnDemandOtaInProgressHelpButtonPressed(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaInProgressViewed(AssetInfo assetinfo, OnDemandOtaPath ondemandotapath);

	public abstract void trackOnDemandOtaUpdateLaterButtonPressed(AssetInfo assetinfo);

	public abstract void trackOnDemandOtaUpdateNowButtonPressed(AssetInfo assetinfo, OnDemandOtaPath ondemandotapath);

	public abstract void trackOnboardingBegan(boolean flag);

	public abstract void trackPMapCustomizeCompleteCleanButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapCustomizeCompleteScheduleButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapCustomizeLabelRoomsCancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapCustomizeLabelRoomsDoneButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapCustomizeNameMapCancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapCustomizeNameMapNextButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapCustomizeSetupRoomsCancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapCustomizeSetupRoomsNextButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapErrorEmptyMap(AssetInfo assetinfo);

	public abstract void trackPMapErrorRoomTooSmall(AssetInfo assetinfo);

	public abstract void trackPMapErrorSaveFloorNameTimedOut(AssetInfo assetinfo);

	public abstract void trackPMapErrorSaveTimedOut(AssetInfo assetinfo);

	public abstract void trackPMapErrorSegmentationTransferFailed(AssetInfo assetinfo);

	public abstract void trackPMapErrorSplitInvalidMap(AssetInfo assetinfo);

	public abstract void trackPMapSectionMapListCleanButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapSectionMapListTrainButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapSectionMapPreviewNotRightButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapSectionMapReadyCustomizeButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapSectionMapReadyNotRightButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapTroubleshootIncompleteCleanButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapTroubleshootIncompleteTrainButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapTroubleshootWrongDeleteButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsErrorRegionDuplicatePoints(AssetInfo assetinfo, String s, String s1);

	public abstract void trackPMapsSectionIntro1CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro1NextButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro2CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro2NextButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro3ActivateButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro3CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro4AddTrainingRunButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro4CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro4MaybeLaterButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro5CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntro5StartTrainingRunButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntroCompleteCancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsSectionIntroCompleteTipsButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsTip1CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsTip1NextButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsTip2CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsTip2NextButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsTip3CancelButtonPressed(AssetInfo assetinfo);

	public abstract void trackPMapsTip3CompleteButtonPressed(AssetInfo assetinfo);

	public abstract void trackProvAddRobotSelected(AddRobotSelection addrobotselection);

	public abstract void trackProvBleDiscoveryPageResult(BleDiscoveryResult blediscoveryresult);

	public abstract void trackProvCancelButtonPressed(ProvisioningStep provisioningstep);

	public abstract void trackProvError(ProvisioningType provisioningtype, AssetInfo assetinfo, int i);

	public abstract void trackProvFinished(ProvisioningType provisioningtype, AssetInfo assetinfo);

	public abstract void trackProvInfoButtonPressed(ProvisioningStep provisioningstep);

	public abstract void trackProvRobotNameDone(boolean flag);

	public abstract void trackProvStarted(ProvisioningType provisioningtype, AssetInfo assetinfo);

	public abstract void trackProvStatus(ProvisioningType provisioningtype, AssetInfo assetinfo, WifiProvisioningStatus wifiprovisioningstatus);

	public abstract void trackProvStepViewed(ProvisioningStep provisioningstep);

	public abstract void trackProvWifiPasswordDone(boolean flag);

	public abstract void trackReActivateAppOverviewPressed(AssetInfo assetinfo);

	public abstract void trackReAddRobotPressedAfterBlidHealing();

	public abstract void trackRobotAdded(AssetInfo assetinfo);

	public abstract void trackRobotAssetsForUser(ArrayList arraylist);

	public abstract void trackRobotHealedMessageViewed();
	...
	public abstract void trackScheduleChanged(AssetInfo assetinfo, HashMap hashmap);

	public abstract void trackSideMenuView();

	public abstract void trackSmartMapsButtonPressed(AssetInfo assetinfo);

	public abstract void trackStoreView();

	public abstract void trackTrainingRunStarted(AssetInfo assetinfo);

	public abstract void trackUserLoggedIn();

	public abstract void trackUserLoggedOut();

	public abstract void trackUserNotificationSettings(ArrayList arraylist);

	public abstract void trackUserTermsLinkPressed();

	public abstract void trackView(ViewId viewid);

	public abstract void trackViewForAsset(ViewId viewid, AssetInfo assetinfo);

	public abstract void trackWifiCoverageToggled(AssetInfo assetinfo, boolean flag);

	public abstract void trackWifiMapFeedbackResponseGiven(float f, float f1, float f2);
}
