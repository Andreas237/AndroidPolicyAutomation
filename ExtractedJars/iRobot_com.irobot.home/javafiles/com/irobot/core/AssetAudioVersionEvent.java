...
public abstract class AssetAudioVersionEvent extends AssetEvent
{
	private static final class CppProxy extends AssetAudioVersionEvent
	{
		...
		private native short native_audioVersion(long l);
		...
		public short audioVersion()
		{
			return native_audioVersion(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #58  <Method short native_audioVersion(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetAudioVersionEvent()>
		//    2    4:aload_0         
	...
	public abstract short audioVersion();
}
