...
public abstract class PMapLearningAllowedEvent extends AssetEvent
{
	private static final class CppProxy extends PMapLearningAllowedEvent
	{
		...
		private native boolean native_isPMapLearningAllowed(long l);
		...
		public boolean isPMapLearningAllowed()
		{
			return native_isPMapLearningAllowed(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #82  <Method boolean native_isPMapLearningAllowed(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void PMapLearningAllowedEvent()>
		//    2    4:aload_0         
	...
	public PMapLearningAllowedEvent()
	{
	//    0    0:aload_0         
	...
	public abstract boolean isPMapLearningAllowed();
}
