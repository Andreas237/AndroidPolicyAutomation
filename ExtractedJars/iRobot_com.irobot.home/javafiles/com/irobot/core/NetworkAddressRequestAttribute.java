...
//			RequestAttribute, NetworkAddress

public abstract class NetworkAddressRequestAttribute extends RequestAttribute
{
	private static final class CppProxy extends NetworkAddressRequestAttribute
	{
	...
	public NetworkAddressRequestAttribute()
	{
	//    0    0:aload_0         
	...
	public static native NetworkAddressRequestAttribute create(NetworkAddress networkaddress);
