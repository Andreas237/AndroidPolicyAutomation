...
//			AssetSoftwareLastUpdatedEvent, AssetId, Event, EventType

private static final class AssetSoftwareLastUpdatedEvent$CppProxy extends AssetSoftwareLastUpdatedEvent
{
	...
	private native Date native_lastUpdateTime(long l);
	...
	{
		return native_lastUpdateTime(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #87  <Method Date native_lastUpdateTime(long)>
	//    4    8:areturn         
	}
	...
	private AssetSoftwareLastUpdatedEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void AssetSoftwareLastUpdatedEvent()>
	//    2    4:aload_0         
