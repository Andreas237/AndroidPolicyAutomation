...
//			AssetEvent, DockState, AssetId, Event, 
//			EventType

public abstract class RobotDockEvent extends AssetEvent
{
	private static final class CppProxy extends RobotDockEvent
	{
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #84  <Method DockState native_getDockState(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotDockEvent()>
		//    2    4:aload_0         
