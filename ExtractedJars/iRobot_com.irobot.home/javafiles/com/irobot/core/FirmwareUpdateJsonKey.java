...
public abstract class FirmwareUpdateJsonKey
{
	private static final class CppProxy extends FirmwareUpdateJsonKey
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void FirmwareUpdateJsonKey()>
		//    2    4:aload_0         
	...
	public static final String DOWNLOAD_U_R_L = "downloadUrl";
	public static final String META_PACKAGE = "deploymentMpkg";
