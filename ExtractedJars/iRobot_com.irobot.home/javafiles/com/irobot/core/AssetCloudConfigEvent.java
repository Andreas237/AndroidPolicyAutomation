...
public abstract class AssetCloudConfigEvent extends AssetEvent
{
	private static final class CppProxy extends AssetCloudConfigEvent
	{
		...
		private native String native_cloudConfigHost(long l);
		...
		public String cloudConfigHost()
		{
			return native_cloudConfigHost(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #57  <Method String native_cloudConfigHost(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetCloudConfigEvent()>
		//    2    4:aload_0         
	...
	public abstract String cloudConfigHost();
}
