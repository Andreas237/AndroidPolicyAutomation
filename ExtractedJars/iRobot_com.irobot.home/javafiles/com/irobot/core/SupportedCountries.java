...
public abstract class SupportedCountries
{
	private static final class CppProxy extends SupportedCountries
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void SupportedCountries()>
		//    2    4:aload_0         
	...
	public static native ArrayList getList();
}
