...
public abstract class MixpanelUtils
{
	private static final class CppProxy extends MixpanelUtils
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void MixpanelUtils()>
		//    2    4:aload_0         
	...
	public static native String projectToken(BuildType buildtype);
}
