...
public abstract class EuropeanUnionCountries
{
	private static final class CppProxy extends EuropeanUnionCountries
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void EuropeanUnionCountries()>
		//    2    4:aload_0         
	...
	public static native HashSet getList();
}
