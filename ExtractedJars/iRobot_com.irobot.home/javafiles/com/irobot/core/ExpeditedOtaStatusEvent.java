...
//			AssetEvent, ExpeditedOtaStatus, AssetId, Event, 
//			EventType

public abstract class ExpeditedOtaStatusEvent extends AssetEvent
{
	private static final class CppProxy extends ExpeditedOtaStatusEvent
	{
		...
		private native ExpeditedOtaStatus native_status(long l);
		...
		public ExpeditedOtaStatus status()
		{
			return native_status(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method ExpeditedOtaStatus native_status(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void ExpeditedOtaStatusEvent()>
		//    2    4:aload_0         
	...
	public ExpeditedOtaStatusEvent()
	{
	//    0    0:aload_0         
	...
	public abstract ExpeditedOtaStatus status();
}
