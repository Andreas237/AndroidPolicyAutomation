...
//			AssetEvent, ResetRobotStatus, AssetId, Event, 
//			EventType

public abstract class ResetRobotEvent extends AssetEvent
{
	private static final class CppProxy extends ResetRobotEvent
	{
		...
		private native ResetRobotStatus native_resetStatus(long l);
		...
		public ResetRobotStatus resetStatus()
		{
			return native_resetStatus(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method ResetRobotStatus native_resetStatus(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void ResetRobotEvent()>
		//    2    4:aload_0         
	...
	public abstract ResetRobotStatus resetStatus();
}
