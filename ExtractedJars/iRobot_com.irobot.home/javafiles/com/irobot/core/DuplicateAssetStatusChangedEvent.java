...
public abstract class DuplicateAssetStatusChangedEvent extends AssetEvent
{
	private static final class CppProxy extends DuplicateAssetStatusChangedEvent
	{
		...
		private native boolean native_isUniqueBlid(long l);

		private native String native_key(long l);

		private native boolean native_nonUniqueAssetHealed(long l);
		...
		public boolean isUniqueBlid()
		{
			return native_isUniqueBlid(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #83  <Method boolean native_isUniqueBlid(long)>
		//    4    8:ireturn         
		}
		...
		public boolean nonUniqueAssetHealed()
		{
			return native_nonUniqueAssetHealed(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #90  <Method boolean native_nonUniqueAssetHealed(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void DuplicateAssetStatusChangedEvent()>
		//    2    4:aload_0         
	...
	public DuplicateAssetStatusChangedEvent()
	{
	//    0    0:aload_0         
	...
	public abstract boolean isUniqueBlid();

	public abstract boolean nonUniqueAssetHealed();
}
