...
//			AssetEvent, BatteryType, AssetId, Event, 
//			EventType

public abstract class AssetBatteryTypeEvent extends AssetEvent
{
	private static final class CppProxy extends AssetBatteryTypeEvent
	{
		...
		private native BatteryType native_batteryType(long l);
		...
		{
			return native_batteryType(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #58  <Method BatteryType native_batteryType(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetBatteryTypeEvent()>
		//    2    4:aload_0         
	...
	public abstract BatteryType batteryType();
}
