...
//			Event, AssetId, EventType

public abstract class AssetEvent extends Event
{
	private static final class CppProxy extends AssetEvent
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetEvent()>
		//    2    4:aload_0         
	...
	public static native AssetEvent create(AssetId assetid);
