...
//			AssetEvent, RemoveRobotStatus, AssetId, Event, 
//			EventType

public abstract class RemoveRobotEvent extends AssetEvent
{
	private static final class CppProxy extends RemoveRobotEvent
	{
		...
		private native RemoveRobotStatus native_removeStatus(long l);
		...
		public RemoveRobotStatus removeStatus()
		{
			return native_removeStatus(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method RemoveRobotStatus native_removeStatus(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RemoveRobotEvent()>
		//    2    4:aload_0         
	...
	public abstract RemoveRobotStatus removeStatus();
}
