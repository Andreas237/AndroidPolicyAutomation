...
public abstract class RobotPreferencesEvent extends AssetEvent
{
	private static final class CppProxy extends RobotPreferencesEvent
	{
	...
	public abstract boolean isBinPause();

	public abstract boolean isCleanButton();

	public abstract boolean isEcoCharge();

	public abstract boolean isManUpd();

	public abstract boolean isNoAutomaticNumberOfPasses();

	public abstract boolean isNoBoost();

	public abstract boolean isNoPersistentPass();

	public abstract boolean isOpenOnly();

	public abstract boolean isSchedHold();

	public abstract boolean isVacuumHigh();
}
