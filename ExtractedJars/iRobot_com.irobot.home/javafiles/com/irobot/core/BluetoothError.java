...
public abstract class BluetoothError
{
	private static final class CppProxy extends BluetoothError
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void BluetoothError()>
		//    2    4:aload_0         
	...
	public static native Error errorForBluetoothErrorCode(int i);
}
