...
{
	private static final class CppProxy extends GenericEvent
	{
		...
		//    3    5:aload_1         
		//    4    6:invokespecial   #72  <Method ArrayList native_arrayIntValue(long, String)>
		//    5    9:areturn         
		}
		...
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:aload_1         
		//    4    6:invokespecial   #77  <Method ArrayList native_arrayObjectValue(long, String)>
		//    5    9:areturn         
		}
		...
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:aload_1         
		//    4    6:invokespecial   #81  <Method ArrayList native_arrayStringValue(long, String)>
		//    5    9:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:iload_2         
		//    5    7:invokespecial   #86  <Method boolean native_boolValue(long, String, boolean)>
		//    6   10:ireturn         
		}
		...
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:aload_1         
		//    4    6:invokespecial   #97  <Method boolean native_equals(long, Event)>
		//    5    9:ireturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #101 <Method Error native_error(long)>
		//    4    8:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #105 <Method EventType native_eventType(long)>
		//    4    8:areturn         
		}
		...
		protected void finalize()
		{
			destroy();
		//    0    0:aload_0         
		//    1    1:invokevirtual   #108 <Method void destroy()>
			((Object)this).finalize();
		//    2    4:aload_0         
		//    3    5:invokespecial   #112 <Method void Object.finalize()>
		//    4    8:return          
		}
		...
		//    3    5:aload_1         
		//    4    6:fload_2         
		//    5    7:invokespecial   #116 <Method float native_float32Value(long, String, float)>
		//    6   10:freturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #120 <Method boolean native_forcedPublish(long)>
		//    4    8:ireturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #124 <Method String native_id(long)>
		//    4    8:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:iload_2         
		//    5    7:invokespecial   #128 <Method short native_int16Value(long, String, short)>
		//    6   10:ireturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:iload_2         
		//    5    7:invokespecial   #132 <Method int native_int32Value(long, String, int)>
		//    6   10:ireturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #135 <Method String native_key(long)>
		//    4    8:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #139 <Method ArrayList native_keys(long)>
		//    4    8:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:aload_2         
		//    5    7:invokespecial   #144 <Method GenericEvent native_objectValue(long, String, GenericEvent)>
		//    6   10:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #147 <Method String native_rawData(long)>
		//    4    8:areturn         
		}
		...
		//    3    5:aload_1         
		//    4    6:aload_2         
		//    5    7:invokespecial   #151 <Method String native_stringValue(long, String, String)>
		//    6   10:areturn         
		}
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #155 <Method Date native_timestamp(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void GenericEvent()>
		//    2    4:aload_0         
	...
	public static native GenericEvent nullEvent();
	...
	public abstract GenericEvent objectValue(String s, GenericEvent genericevent);
