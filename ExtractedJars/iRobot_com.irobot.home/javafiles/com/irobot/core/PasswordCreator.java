...
{
	private static final class CppProxy extends PasswordCreator
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void PasswordCreator()>
		//    2    4:aload_0         
	...
	public static native String createAwsFormattedAssetPassword();

	public static native String createRoombaPassword(AssetInfo assetinfo);
}
