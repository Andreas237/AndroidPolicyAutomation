...
public abstract class NotificationCenterDataItem
{
	private static final class CppProxy extends NotificationCenterDataItem
	{
	...
	public NotificationCenterDataItem()
	{
	//    0    0:aload_0         
	...
	public abstract ArrayList getActionPayload();
	...
	public abstract String getCategoryTitleTextId();

	public abstract int getDetailsContentId();

	public abstract int getDetailsContentVersion();

	public abstract String getDisplayType();

	public abstract String getEventId();

	public abstract int getEventState();

	public abstract String getHeadlineText();

	public abstract String getHeadlineTextId();

	public abstract String getNotificationType();

	public abstract boolean getReadStatus();

	public abstract String getSchedulingVersion();

	public abstract int getTimestamp();

	public abstract HashMap getV1ScheduleDayMap();

	public abstract void setNotificationAsRead();
}
