...
//			AssetEvent, MultiPassMode, AssetId, Event, 
//			EventType

public abstract class AssetMultiPassEvent extends AssetEvent
{
	private static final class CppProxy extends AssetMultiPassEvent
	{
		...
		private native MultiPassMode native_mode(long l);
		...
		public MultiPassMode mode()
		{
			return native_mode(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method MultiPassMode native_mode(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetMultiPassEvent()>
		//    2    4:aload_0         
	...
	public abstract MultiPassMode mode();
}
