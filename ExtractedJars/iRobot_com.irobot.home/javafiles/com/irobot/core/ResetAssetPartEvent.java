...
public abstract class ResetAssetPartEvent extends AssetEvent
{
	private static final class CppProxy extends ResetAssetPartEvent
	{
		...
		private native boolean native_wasPartReset(long l);
		...
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #87  <Method Date native_timestamp(long)>
		//    4    8:areturn         
		}

		public boolean wasPartReset()
		{
			return native_wasPartReset(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #90  <Method boolean native_wasPartReset(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void ResetAssetPartEvent()>
		//    2    4:aload_0         
	...
	public abstract boolean wasPartReset();
}
