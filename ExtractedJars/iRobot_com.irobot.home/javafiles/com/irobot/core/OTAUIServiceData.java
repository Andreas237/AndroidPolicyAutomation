...
//			ExpeditedOtaStatus, LocalOtaError, LocalOtaStatus, OnDemandOTAError, 
//			OtaUpdateStatus, SoftwareUpdateStatus, OnDemandOTAPathType

public abstract class OTAUIServiceData
{
	private static final class CppProxy extends OTAUIServiceData
	{
	...
	public static native OTAUIServiceData create();

	public abstract ArrayList getDataStates();

	public abstract ExpeditedOtaStatus getExpeditedOtaStatus();

	public abstract boolean getIsOnDemandOTACommError();

	public abstract boolean getIsOnDemandOTACompleted();

	public abstract LocalOtaError getLocalOTAError();

	public abstract LocalOtaStatus getLocalOTAStatus();

	public abstract OnDemandOTAError getOnDemandOTAError();

	public abstract OtaUpdateStatus getOnDemandOTAStatus();

	public abstract SoftwareUpdateStatus getSoftwareUpdateStatus();

	public abstract void setOnDemandOTAPathType(OnDemandOTAPathType ondemandotapathtype);
}
