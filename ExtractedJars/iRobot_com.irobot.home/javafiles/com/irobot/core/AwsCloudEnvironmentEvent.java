...
public abstract class AwsCloudEnvironmentEvent extends AssetEvent
{
	private static final class CppProxy extends AwsCloudEnvironmentEvent
	{
		...
		private native String native_cloudEnvironment(long l);
		...
		{
			return native_cloudEnvironment(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #57  <Method String native_cloudEnvironment(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AwsCloudEnvironmentEvent()>
		//    2    4:aload_0         
	...
	public AwsCloudEnvironmentEvent()
	{
	//    0    0:aload_0         
	...
	public abstract String cloudEnvironment();
}
