...
//			WifiConfigEvent, AssetId, Event, EventType

private static final class WifiConfigEvent$CppProxy extends WifiConfigEvent
{
	...
	private native String native_ssid(long l);
	...
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #87  <Method String native_password(long)>
	//    4    8:areturn         
	}

	public String ssid()
	{
		return native_ssid(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #90  <Method String native_ssid(long)>
	//    4    8:areturn         
	}
	...
	private WifiConfigEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void WifiConfigEvent()>
	//    2    4:aload_0         
