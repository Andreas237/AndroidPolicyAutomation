...
{
	private static final class CppProxy extends UnitConverter
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void UnitConverter()>
		//    2    4:aload_0         
	...
	public static native int daysToSeconds(int i);

	public static native int minutesToSeconds(int i);

	public static native float squareFeetToSquareMeters(float f);
