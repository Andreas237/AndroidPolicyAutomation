...
public abstract class RobotBatteryLevelEvent extends AssetEvent
{
	private static final class CppProxy extends RobotBatteryLevelEvent
	{
		...
		private native short native_currentBatteryLevel(long l);
		...
		public short currentBatteryLevel()
		{
			return native_currentBatteryLevel(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #58  <Method short native_currentBatteryLevel(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotBatteryLevelEvent()>
		//    2    4:aload_0         
	...
	public abstract short currentBatteryLevel();
}
