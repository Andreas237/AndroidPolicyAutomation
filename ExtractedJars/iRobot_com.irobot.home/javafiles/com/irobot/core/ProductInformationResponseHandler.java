...
public abstract class ProductInformationResponseHandler
{
	private static final class CppProxy extends ProductInformationResponseHandler
	{
	...
	public ProductInformationResponseHandler()
	{
	//    0    0:aload_0         
	...
	public abstract void onGetProductInformationFailed();

	public abstract void onGetProductInformationSuccess(String s, String s1, String s2);
}
