...
//			PushNotificationsGetSettingsFailedStatus, FeatureType, PushNotificationType

public abstract class AccountUIServiceData
{
	private static final class CppProxy extends AccountUIServiceData
	{
	...
	public static native AccountUIServiceData create();

	public abstract ArrayList getAvailableBetaFeatures();

	public abstract boolean getCleanMapReportsAvailable();

	public abstract String getDataSecurityUrl();

	public abstract ArrayList getDataStates();

	public abstract String getEULAConsentDate();

	public abstract String getEULAUrl();

	public abstract PushNotificationsGetSettingsFailedStatus getFailedPushNotificationSettingStatus();

	public abstract String getMappingRobotsUrl();

	public abstract String getPrivacyConsentDate();

	public abstract String getPrivacyPolicyUrl();

	public abstract String getTermsAndConditionsUrl();

	public abstract String getTermsConsentDate();

	public abstract ArrayList getUpdatedPushNotificationSetting();

	public abstract ArrayList getViewStates();

	public abstract void setBetaEnrollmentChanged(boolean flag);

	public abstract void setBetaFeatureStatus(boolean flag);

	public abstract void setBetaFeatureType(FeatureType featuretype);

	public abstract void setCleanMapReportsEnabled(boolean flag);

	public abstract void setCountryCode(String s);

	public abstract void setEmailOptIn(boolean flag);

	public abstract void setLanguageCode(String s);

	public abstract void setPushNotificationSetting(boolean flag);

	public abstract void setPushNotificationType(PushNotificationType pushnotificationtype);
}
