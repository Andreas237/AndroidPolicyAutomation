...
public abstract class PushNotificationResponseHandler
{
	private static final class CppProxy extends PushNotificationResponseHandler
	{
	...
	public PushNotificationResponseHandler()
	{
	//    0    0:aload_0         
	...
	public abstract void onGetSettingsFailed();

	public abstract void onGetSettingsSuccess(ArrayList arraylist);

	public abstract void onSetSettingFailed();

	public abstract void onSetSettingSuccess(ArrayList arraylist);

	public abstract void onTokenRegistrationFailed();

	public abstract void onTokenRegistrationSuccess(String s, ArrayList arraylist);
}
