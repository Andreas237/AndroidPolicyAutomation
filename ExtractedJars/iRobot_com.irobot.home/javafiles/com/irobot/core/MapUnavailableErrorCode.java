...
public abstract class MapUnavailableErrorCode
{
	private static final class CppProxy extends MapUnavailableErrorCode
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void MapUnavailableErrorCode()>
		//    2    4:aload_0         
	...
	public MapUnavailableErrorCode()
	{
	//    0    0:aload_0         
	...
	public static final int INVALID_MAP_DATA = 3;
	public static final int INVALID_MAP_ID = 2;
