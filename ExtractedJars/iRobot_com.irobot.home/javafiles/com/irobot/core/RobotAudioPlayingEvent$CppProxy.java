...
//			RobotAudioPlayingEvent, AssetId, Event, EventType

private static final class RobotAudioPlayingEvent$CppProxy extends RobotAudioPlayingEvent
{
	...
	private native boolean native_isAudioActive(long l);
	...
	{
		return native_isAudioActive(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #82  <Method boolean native_isAudioActive(long)>
	//    4    8:ireturn         
	}
	...
	private RobotAudioPlayingEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void RobotAudioPlayingEvent()>
	//    2    4:aload_0         
