...
public abstract class AssetWifiSignalStrengthEvent extends AssetEvent
{
	private static final class CppProxy extends AssetWifiSignalStrengthEvent
	{
		...
		private native short native_signalStrength(long l);
		...
		{
			return native_signalStrength(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method short native_signalStrength(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetWifiSignalStrengthEvent()>
		//    2    4:aload_0         
	...
	public AssetWifiSignalStrengthEvent()
	{
	//    0    0:aload_0         
	...
	public abstract short signalStrength();
}
