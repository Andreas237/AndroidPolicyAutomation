...
public abstract class AssetUmiVersionEvent extends AssetEvent
{
	private static final class CppProxy extends AssetUmiVersionEvent
	{
		...
		private native short native_umiVersion(long l);
		...
		public short umiVersion()
		{
			return native_umiVersion(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #92  <Method short native_umiVersion(long)>
		//    4    8:ireturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetUmiVersionEvent()>
		//    2    4:aload_0         
	...
	public abstract short umiVersion();
}
