...
//			AssetRegisteredEvent, AssetId, Event, EventType

private static final class AssetRegisteredEvent$CppProxy extends AssetRegisteredEvent
{
	...
	private native boolean native_isRegistered(long l);
	...
	{
		return native_isRegistered(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #82  <Method boolean native_isRegistered(long)>
	//    4    8:ireturn         
	}
	...
	private AssetRegisteredEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void AssetRegisteredEvent()>
	//    2    4:aload_0         
