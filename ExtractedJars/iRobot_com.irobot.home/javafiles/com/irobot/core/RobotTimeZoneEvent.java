...
public abstract class RobotTimeZoneEvent extends AssetEvent
{
	private static final class CppProxy extends RobotTimeZoneEvent
	{
		...
		private native String native_robotTimeZone(long l);
		...
		public String robotTimeZone()
		{
			return native_robotTimeZone(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #86  <Method String native_robotTimeZone(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotTimeZoneEvent()>
		//    2    4:aload_0         
	...
	public abstract String robotTimeZone();
}
