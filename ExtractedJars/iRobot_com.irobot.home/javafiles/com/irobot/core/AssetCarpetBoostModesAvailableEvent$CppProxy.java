...
//			AssetCarpetBoostModesAvailableEvent, AssetId, Event, EventType

private static final class AssetCarpetBoostModesAvailableEvent$CppProxy extends AssetCarpetBoostModesAvailableEvent
{
	...
	private native ArrayList native_getModes(long l);
	...
	{
		return native_getModes(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #84  <Method ArrayList native_getModes(long)>
	//    4    8:areturn         
	}
	...
	private AssetCarpetBoostModesAvailableEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void AssetCarpetBoostModesAvailableEvent()>
	//    2    4:aload_0         
