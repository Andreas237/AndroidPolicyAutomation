...
//			AssetEvent, Error, AssetId, Event, 
//			EventType

public abstract class UmfParsingErrorEvent extends AssetEvent
{
	private static final class CppProxy extends UmfParsingErrorEvent
	{
		...
		private native Error native_errorObject(long l);
		...
		{
			return native_errorObject(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #69  <Method Error native_errorObject(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void UmfParsingErrorEvent()>
		//    2    4:aload_0         
	...
	public abstract Error errorObject();
}
