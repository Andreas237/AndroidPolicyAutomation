...
//			AssetEvent, RobotPadCategory, AssetId, Event, 
//			EventType

public abstract class RobotPadCategoryEvent extends AssetEvent
{
	private static final class CppProxy extends RobotPadCategoryEvent
	{
		...
		private native RobotPadCategory native_padCategory(long l);
		...
		public RobotPadCategory padCategory()
		{
			return native_padCategory(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #88  <Method RobotPadCategory native_padCategory(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void RobotPadCategoryEvent()>
		//    2    4:aload_0         
	...
	public abstract RobotPadCategory padCategory();
}
