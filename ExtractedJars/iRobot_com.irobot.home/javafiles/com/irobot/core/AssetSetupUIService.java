...
//			AssetSetupUIServiceData, AssetSetupUIServiceDataCallback, AssetSetupUIServiceCommand

public abstract class AssetSetupUIService
{
	private static final class CppProxy extends AssetSetupUIService
	{
	...
	public abstract AssetSetupUIServiceData getServiceData();

	public abstract boolean registerSubscriber(AssetSetupUIServiceDataCallback assetsetupuiservicedatacallback);

	public abstract boolean registerUISubscriber(AssetSetupUIServiceDataCallback assetsetupuiservicedatacallback);

	public abstract void sendCommand(AssetSetupUIServiceCommand assetsetupuiservicecommand, AssetSetupUIServiceData assetsetupuiservicedata);

	public abstract boolean unregisterSubscriber(AssetSetupUIServiceDataCallback assetsetupuiservicedatacallback);
}
