...
public abstract class AltadenaRequestErrorCode
{
	private static final class CppProxy extends AltadenaRequestErrorCode
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void AltadenaRequestErrorCode()>
		//    2    4:aload_0         
	...
	public AltadenaRequestErrorCode()
	{
	//    0    0:aload_0         
	...
	public static final int ROBOT_ERROR = 5;
	public static final int ROBOT_MISSING = 3;
	public static final int TIMED_OUT = 3;
	public static final int TRANSFER_FAILED = 6;
	public static final int UNAVAILABLE = 0;
	public static final int WRONG_ROBOT_APPLICATION = 7;
}
