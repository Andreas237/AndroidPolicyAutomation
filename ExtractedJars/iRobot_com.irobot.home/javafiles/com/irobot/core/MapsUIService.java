...
//			MissionMapType, RenderPresenter, MapsUIServiceData, RobotMissionHistoryItem, 
//			MapsUIServiceDataCallback, MapsUIServiceCommand

public abstract class MapsUIService
{
	private static final class CppProxy extends MapsUIService
	{
	...
	public abstract RenderPresenter getMissionMapRenderer(MissionMapType missionmaptype);

	public abstract ArrayList getMissionMapTypes();

	public abstract MapsUIServiceData getServiceData();

	public abstract boolean isMapAtDefaultZoom(MissionMapType missionmaptype);

	public abstract void queryMissionMap(RobotMissionHistoryItem robotmissionhistoryitem, MissionMapType missionmaptype, float f, float f1);

	public abstract void queryStaticMap(String s, MissionMapType missionmaptype, float f, float f1);

	public abstract boolean registerSubscriber(MapsUIServiceDataCallback mapsuiservicedatacallback);

	public abstract boolean registerUISubscriber(MapsUIServiceDataCallback mapsuiservicedatacallback);

	public abstract void sendCommand(MapsUIServiceCommand mapsuiservicecommand, MapsUIServiceData mapsuiservicedata);

	public abstract void setMissionDetailsInfo(int i, int j, int k, boolean flag);

	public abstract boolean unregisterSubscriber(MapsUIServiceDataCallback mapsuiservicedatacallback);
}
