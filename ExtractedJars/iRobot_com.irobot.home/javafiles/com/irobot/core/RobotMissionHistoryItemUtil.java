...
public abstract class RobotMissionHistoryItemUtil
{
	private static final class CppProxy extends RobotMissionHistoryItemUtil
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void RobotMissionHistoryItemUtil()>
		//    2    4:aload_0         
	...
	public RobotMissionHistoryItemUtil()
	{
	//    0    0:aload_0         
	...
	public static native ArrayList getPersistentMapIdAndVersion(RobotMissionHistoryItem robotmissionhistoryitem);

	public static native boolean isMapAssociatedWithItem(RobotMissionHistoryItem robotmissionhistoryitem);

	public static native Date makeStartDateForItem(RobotMissionHistoryItem robotmissionhistoryitem);
}
