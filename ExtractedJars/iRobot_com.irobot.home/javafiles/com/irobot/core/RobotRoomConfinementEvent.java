...
public abstract class RobotRoomConfinementEvent extends AssetEvent
{
	private static final class CppProxy extends RobotRoomConfinementEvent
	{
	...
	public RobotRoomConfinementEvent()
	{
	//    0    0:aload_0         
