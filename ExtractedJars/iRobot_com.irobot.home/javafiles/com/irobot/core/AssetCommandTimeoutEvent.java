...
//			AssetEvent, CommandType, AssetId, Event, 
//			EventType

public abstract class AssetCommandTimeoutEvent extends AssetEvent
{
	private static final class CppProxy extends AssetCommandTimeoutEvent
	{
		...
		private native CommandType native_commandType(long l);
		...
		{
			return native_commandType(nativeRef);
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:getfield        #35  <Field long nativeRef>
		//    3    5:invokespecial   #58  <Method CommandType native_commandType(long)>
		//    4    8:areturn         
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #19  <Method void AssetCommandTimeoutEvent()>
		//    2    4:aload_0         
	...
	public AssetCommandTimeoutEvent()
	{
	//    0    0:aload_0         
