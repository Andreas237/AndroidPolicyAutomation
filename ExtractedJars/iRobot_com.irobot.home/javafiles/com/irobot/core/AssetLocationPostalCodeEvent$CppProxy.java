...
//			AssetLocationPostalCodeEvent, AssetId, Event, EventType

private static final class AssetLocationPostalCodeEvent$CppProxy extends AssetLocationPostalCodeEvent
{
	...
	private native String native_postalCode(long l);
	...
	{
		return native_postalCode(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #86  <Method String native_postalCode(long)>
	//    4    8:areturn         
	}
	...
	private AssetLocationPostalCodeEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void AssetLocationPostalCodeEvent()>
	//    2    4:aload_0         
