...
public abstract class AltadenaJsonCommandValue
{
	private static final class CppProxy extends AltadenaJsonCommandValue
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #14  <Method void AltadenaJsonCommandValue()>
		//    2    4:aload_0         
	...
	public AltadenaJsonCommandValue()
	{
	//    0    0:aload_0         
	...
	public static final String START_VIBRATE = "start_vibrate";
	public static final String STOP_CLEAN = "stop_clean";
	public static final String STOP_VIBRATE = "stop_vibrate";
}
