...
//			RobotMissionAreaCoveredEvent, AssetId, Event, EventType

private static final class RobotMissionAreaCoveredEvent$CppProxy extends RobotMissionAreaCoveredEvent
{
	...
	private native int native_squareFeet(long l);
	...
	{
		return native_squareFeet(nativeRef);
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #35  <Field long nativeRef>
	//    3    5:invokespecial   #88  <Method int native_squareFeet(long)>
	//    4    8:ireturn         
	}
	...
	private RobotMissionAreaCoveredEvent$CppProxy(long l)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void RobotMissionAreaCoveredEvent()>
	//    2    4:aload_0         
