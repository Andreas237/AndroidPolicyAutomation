...
public abstract class PMIAssetInfo
{
	private static final class CppProxy extends PMIAssetInfo
	{
	...
	public static native PMIAssetInfo create(String s, String s1, String s2, String s3, String s4, String s5);

	public static native PMIAssetInfo createFromJson(String s);

	public abstract String asJson();

	public abstract boolean equals(PMIAssetInfo pmiassetinfo);
