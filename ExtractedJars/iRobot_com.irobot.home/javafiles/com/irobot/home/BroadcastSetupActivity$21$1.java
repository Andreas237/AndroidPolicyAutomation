...
class BroadcastSetupActivity$21$1
	implements Runnable
{
	...
	BroadcastSetupActivity$21$1(BroadcastSetupActivity._cls21 _pcls21, DiscoveredWifiAsset discoveredwifiasset, DiscoveredAsset discoveredasset)
	{
		c = _pcls21;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/irobot/home/BroadcastSetupActivity$21

/* anonymous class */
	class BroadcastSetupActivity._cls21
		implements b
	{
		...
		//   61  126:invokestatic    #105 <Method void BroadcastSetupActivity.j(BroadcastSetupActivity)>
			(new Handler(Looper.getMainLooper())).post(((Runnable) (new BroadcastSetupActivity._cls21._cls1(this, ((DiscoveredWifiAsset) (discoverytype)), discoveredasset))));
