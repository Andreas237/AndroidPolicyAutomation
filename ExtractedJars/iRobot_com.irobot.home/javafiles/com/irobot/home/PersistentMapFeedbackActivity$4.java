...
class PersistentMapFeedbackActivity$4
	implements Runnable
{
	...
	//    7   15:invokestatic    #35  <Method void PersistentMapFeedbackActivity.d(PersistentMapFeedbackActivity)>
		a.j = (new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setMessage(0x7f0f02ec).setPositiveButton(0x7f0f05bb, new android.content.DialogInterface.OnClickListener() {
			...
			{
				a = PersistentMapFeedbackActivity._cls4.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	PersistentMapFeedbackActivity$4(PersistentMapFeedbackActivity persistentmapfeedbackactivity)
	{
