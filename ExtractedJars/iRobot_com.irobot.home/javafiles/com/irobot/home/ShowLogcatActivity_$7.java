...
class ShowLogcatActivity_$7 extends org.androidannotations.api.a.a
{
	...
	public void a()
	{
		try
		{
			ShowLogcatActivity_.c(a);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field ShowLogcatActivity_ a>
	//    2    4:invokestatic    #25  <Method void ShowLogcatActivity_.c(ShowLogcatActivity_)>
			return;
	//    3    7:return          
		}
	...
	ShowLogcatActivity_$7(ShowLogcatActivity_ showlogcatactivity_, String s, long l, String s1)
	{
		a = showlogcatactivity_;
	//    0    0:aload_0         
	//    1    1:aload_1         
