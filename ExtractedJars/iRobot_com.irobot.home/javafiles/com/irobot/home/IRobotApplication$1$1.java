...
class IRobotApplication$1$1 extends TimerTask
{
	...
	IRobotApplication$1$1(IRobotApplication._cls1 _pcls1)
	{
		a = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/irobot/home/IRobotApplication$1

/* anonymous class */
	class IRobotApplication._cls1
		implements android.view.View.OnTouchListener
	{
		...
		//   23   54:astore_1        
				view = ((View) ((BugReportActivity_.a)BugReportActivity_.a(((android.content.Context) (b))).b(((String) (view))).g(0x10000000)));
		//   24   55:aload_0         
		...
		//   53  113:pop             
				IRobotApplication.a(b).schedule(((TimerTask) (new IRobotApplication._cls1._cls1(this))), 500L);
		//   54  114:aload_0         
