...
class PersistentMapFeedbackActivity$3
	implements Runnable
{
	...
	//    2    4:invokestatic    #26  <Method void PersistentMapFeedbackActivity.d(PersistentMapFeedbackActivity)>
		a.j = (new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setMessage(0x7f0f02f0).setPositiveButton(0x7f0f05bb, new android.content.DialogInterface.OnClickListener() {
			...
			{
				a = PersistentMapFeedbackActivity._cls3.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	PersistentMapFeedbackActivity$3(PersistentMapFeedbackActivity persistentmapfeedbackactivity)
	{
