...
//			TroubleshootMapDetailActivity_

public static class TroubleshootMapDetailActivity_$a extends a
{
	...
	public TroubleshootMapDetailActivity_$a b(int i)
	{
		return (TroubleshootMapDetailActivity_$a)super.a("toolbarTitle", i);
	//    0    0:aload_0         
	//    1    1:ldc1            #65  <String "toolbarTitle">
	//    2    3:iload_1         
	//    3    4:invokespecial   #68  <Method org.androidannotations.api.a.d a.a(String, int)>
	//    4    7:checkcast       #2   <Class TroubleshootMapDetailActivity_$a>
	//    5   10:areturn         
	}

	public TroubleshootMapDetailActivity_$a c(int i)
	{
		return (TroubleshootMapDetailActivity_$a)super.a("helpType", i);
	//    0    0:aload_0         
	...
	public TroubleshootMapDetailActivity_$a d(int i)
	{
		return (TroubleshootMapDetailActivity_$a)super.a("descriptionResource", i);
	//    0    0:aload_0         
	...
	public TroubleshootMapDetailActivity_$a e(int i)
	{
		return (TroubleshootMapDetailActivity_$a)super.a("learningPercent", i);
	//    0    0:aload_0         
	...
	public TroubleshootMapDetailActivity_$a(Context context)
	{
