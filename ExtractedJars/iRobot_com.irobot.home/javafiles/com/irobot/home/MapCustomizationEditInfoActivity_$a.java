...
//			MapCustomizationEditInfoActivity_

public static class MapCustomizationEditInfoActivity_$a extends a
{

	public MapCustomizationEditInfoActivity_$a a(String s)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("assetId", s);
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a a(ArrayList arraylist)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("infoText", ((java.io.Serializable) (arraylist)));
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a a(boolean flag)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("isImageRes", flag);
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a b(int i)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("titleId", i);
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a b(boolean flag)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("loopBack", flag);
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a c(int i)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("resId", i);
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a c(boolean flag)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("showActionButton", flag);
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a d(int i)
	{
		return (MapCustomizationEditInfoActivity_$a)super.a("buttonTextResource", i);
	//    0    0:aload_0         
	...
	public MapCustomizationEditInfoActivity_$a(Context context)
	{
