...
class BaseHelpTableActivity_$5 extends org.androidannotations.api.a.a
{
	...
	public void a()
	{
		try
		{
			BaseHelpTableActivity_.b(a);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field BaseHelpTableActivity_ a>
	//    2    4:invokestatic    #25  <Method void BaseHelpTableActivity_.b(BaseHelpTableActivity_)>
			return;
	//    3    7:return          
		}
	...
	BaseHelpTableActivity_$5(BaseHelpTableActivity_ basehelptableactivity_, String s, long l, String s1)
	{
		a = basehelptableactivity_;
	//    0    0:aload_0         
	//    1    1:aload_1         
