...
class BaseHelpTableActivity_$3
	implements Runnable
{

	public void run()
	{
		BaseHelpTableActivity_.b(b, a);
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field BaseHelpTableActivity_ b>
	//    2    4:aload_0         
	//    3    5:getfield        #21  <Field int a>
	//    4    8:invokestatic    #28  <Method void BaseHelpTableActivity_.b(BaseHelpTableActivity_, int)>
	//    5   11:return          
	}
	...
	BaseHelpTableActivity_$3(BaseHelpTableActivity_ basehelptableactivity_, int i)
	{
