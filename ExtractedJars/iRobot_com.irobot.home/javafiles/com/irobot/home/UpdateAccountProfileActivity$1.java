...
class UpdateAccountProfileActivity$1
	implements com.irobot.home.util.g.a
{
	...
	//*   5   13:ifnonnull       60
				UpdateAccountProfileActivity.a(a, (new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setMessage(0x7f0f04db).setPositiveButton(0x7f0f05bb, ((android.content.) (null))).setOnDismissListener(new android.content.DialogInterface.OnDismissListener() {
			...
			{
				a = UpdateAccountProfileActivity._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	UpdateAccountProfileActivity$1(UpdateAccountProfileActivity updateaccountprofileactivity)
	{
