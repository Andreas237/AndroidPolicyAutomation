...
class UpdateAccountPasswordActivity$1
	implements com.irobot.home.util.g.a
{
	...
	//*   5   13:ifnonnull       60
				UpdateAccountPasswordActivity.a(a, (new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setMessage(0x7f0f04db).setPositiveButton(0x7f0f05bb, ((android.content.DialogInterface$OnClickListener) (null))).setOnDismissListener(new android.content.DialogInterface.OnDismissListener() {
			...
			{
				a = UpdateAccountPasswordActivity._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	UpdateAccountPasswordActivity$1(UpdateAccountPasswordActivity updateaccountpasswordactivity)
	{
