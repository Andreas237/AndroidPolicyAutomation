...
public static class CarpetBoostSettingsActivity_$a extends a
{

	public CarpetBoostSettingsActivity_$a a(String s)
	{
		return (CarpetBoostSettingsActivity_$a)super.a("robotBlid", s);
	//    0    0:aload_0         
	...
	//    7   15:iload_1         
	//    8   16:invokevirtual   #41  <Method void Fragment.startActivityForResult(android.content.Intent, int)>
		else
	//*   9   19:goto            95
		if(d != null)
	//*  10   22:aload_0         
	...
	//   17   37:iload_1         
	//   18   38:aload_0         
	//   19   39:getfield        #46  <Field android.os.Bundle a>
	//   20   42:invokevirtual   #51  <Method void android.app.Fragment.startActivityForResult(android.content.Intent, int, android.os.Bundle)>
		else
	//*  21   45:goto            95
	...
	//   31   69:iload_1         
	//   32   70:aload_0         
	//   33   71:getfield        #46  <Field android.os.Bundle a>
	...
	//   40   88:aload_0         
	//   41   89:getfield        #46  <Field android.os.Bundle a>
	...
	public CarpetBoostSettingsActivity_$a(Fragment fragment)
	{
