...
class RobotSettingsActivity_$11
	implements Runnable
{

	public void run()
	{
		RobotSettingsActivity_.c(b, a);
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field RobotSettingsActivity_ b>
	//    2    4:aload_0         
	//    3    5:getfield        #21  <Field boolean a>
	//    4    8:invokestatic    #29  <Method void RobotSettingsActivity_.c(RobotSettingsActivity_, boolean)>
	//    5   11:return          
	}
	...
	RobotSettingsActivity_$11(RobotSettingsActivity_ robotsettingsactivity_, boolean flag)
	{
