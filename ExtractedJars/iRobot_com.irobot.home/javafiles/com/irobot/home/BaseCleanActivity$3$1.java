...
//			BroadcastSetupActivity_, BaseCleanActivity

class BaseCleanActivity$3$1
	implements android.content.kListener
{
	...
	public void onClick(DialogInterface dialoginterface, int i)
	{
		a.a.post(new Runnable() {
			...
			{
				a = BaseCleanActivity._cls3._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	BaseCleanActivity$3$1(BaseCleanActivity._cls3 _pcls3)
	{
		a = _pcls3;
	//    0    0:aload_0         
	//    1    1:aload_1         
		...
		implements Runnable
	{
		...
		//    3    9:astore_1        
			(new android.app.AlertDialog.Builder(((android.content.Context) (c)))).setTitle(0x7f0f0786).setMessage(((CharSequence) (c.getString(0x7f0f019f, new Object[] {
				s, s
			})))).setCancelable(false).setPositiveButton(0x7f0f05bb, ((android.content.DialogInterface.OnClickListener) (new BaseCleanActivity._cls3._cls1(this)))).show();
