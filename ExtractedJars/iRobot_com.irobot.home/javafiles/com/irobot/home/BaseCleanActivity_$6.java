...
class BaseCleanActivity_$6 extends org.androidannotations.api.a.a
{
	...
	public void a()
	{
		try
		{
			BaseCleanActivity_.c(a);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field BaseCleanActivity_ a>
	//    2    4:invokestatic    #25  <Method void BaseCleanActivity_.c(BaseCleanActivity_)>
			return;
	//    3    7:return          
		}
	...
	BaseCleanActivity_$6(BaseCleanActivity_ basecleanactivity_, String s, long l, String s1)
	{
		a = basecleanactivity_;
	//    0    0:aload_0         
	//    1    1:aload_1         
