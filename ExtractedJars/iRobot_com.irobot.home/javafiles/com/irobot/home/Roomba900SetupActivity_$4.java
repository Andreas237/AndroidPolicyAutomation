...
class Roomba900SetupActivity_$4
	implements Runnable
{

	public void run()
	{
		Roomba900SetupActivity_.b(b, a);
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field Roomba900SetupActivity_ b>
	//    2    4:aload_0         
	//    3    5:getfield        #21  <Field int a>
	//    4    8:invokestatic    #28  <Method void Roomba900SetupActivity_.b(Roomba900SetupActivity_, int)>
	//    5   11:return          
	}
	...
	Roomba900SetupActivity_$4(Roomba900SetupActivity_ roomba900setupactivity_, int i)
	{
