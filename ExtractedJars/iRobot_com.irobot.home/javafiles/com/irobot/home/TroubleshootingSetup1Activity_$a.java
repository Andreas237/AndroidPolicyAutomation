...
public static class TroubleshootingSetup1Activity_$a extends a
{

	public TroubleshootingSetup1Activity_$a a(String s)
	{
		return (TroubleshootingSetup1Activity_$a)super.a("robotSku", s);
	//    0    0:aload_0         
	...
	public TroubleshootingSetup1Activity_$a b(int i)
	{
		return (TroubleshootingSetup1Activity_$a)super.a("topicsArrayId", i);
	//    0    0:aload_0         
	...
	public TroubleshootingSetup1Activity_$a c(int i)
	{
		return (TroubleshootingSetup1Activity_$a)super.a("answersArrayId", i);
	//    0    0:aload_0         
	...
	public TroubleshootingSetup1Activity_$a(Context context)
	{
