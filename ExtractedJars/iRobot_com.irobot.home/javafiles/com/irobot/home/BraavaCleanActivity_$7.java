...
class BraavaCleanActivity_$7
	implements Runnable
{

	public void run()
	{
		BraavaCleanActivity_.a(b, a);
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field BraavaCleanActivity_ b>
	//    2    4:aload_0         
	//    3    5:getfield        #21  <Field AccountLoggedOutEvent a>
	//    4    8:invokestatic    #28  <Method void BraavaCleanActivity_.a(BraavaCleanActivity_, AccountLoggedOutEvent)>
	//    5   11:return          
	}
	...
	BraavaCleanActivity_$7(BraavaCleanActivity_ braavacleanactivity_, AccountLoggedOutEvent accountloggedoutevent)
	{
