...
class LegalTermsActivity_$2 extends org.androidannotations.api.a.a
{
	...
	public void a()
	{
		try
		{
			LegalTermsActivity_.b(a);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field LegalTermsActivity_ a>
	//    2    4:invokestatic    #25  <Method void LegalTermsActivity_.b(LegalTermsActivity_)>
			return;
	//    3    7:return          
		}
	...
	LegalTermsActivity_$2(LegalTermsActivity_ legaltermsactivity_, String s, long l, String s1)
	{
		a = legaltermsactivity_;
	//    0    0:aload_0         
	//    1    1:aload_1         
