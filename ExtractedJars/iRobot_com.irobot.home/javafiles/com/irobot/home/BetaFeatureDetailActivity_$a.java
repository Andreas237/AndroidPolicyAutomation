...
//			BetaFeatureDetailActivity_

public static class BetaFeatureDetailActivity_$a extends a
{

	public BetaFeatureDetailActivity_$a a(FeatureType featuretype)
	{
		return (BetaFeatureDetailActivity_$a)super.a("featureType", ((java.io.Serializable) (featuretype)));
	//    0    0:aload_0         
	...
	public BetaFeatureDetailActivity_$a b(int i)
	{
		return (BetaFeatureDetailActivity_$a)super.a("titleResource", i);
	//    0    0:aload_0         
	//    1    1:ldc1            #71  <String "titleResource">
	//    2    3:iload_1         
	//    3    4:invokespecial   #74  <Method org.androidannotations.api.a.d a.a(String, int)>
	//    4    7:checkcast       #2   <Class BetaFeatureDetailActivity_$a>
	//    5   10:areturn         
	}

	public BetaFeatureDetailActivity_$a c(int i)
	{
		return (BetaFeatureDetailActivity_$a)super.a("explanationResource", i);
	//    0    0:aload_0         
	...
	public BetaFeatureDetailActivity_$a d(int i)
	{
		return (BetaFeatureDetailActivity_$a)super.a("instructionsResource", i);
	//    0    0:aload_0         
	...
	public BetaFeatureDetailActivity_$a e(int i)
	{
		return (BetaFeatureDetailActivity_$a)super.a("footerResource", i);
	//    0    0:aload_0         
	...
	public BetaFeatureDetailActivity_$a(Context context)
	{
