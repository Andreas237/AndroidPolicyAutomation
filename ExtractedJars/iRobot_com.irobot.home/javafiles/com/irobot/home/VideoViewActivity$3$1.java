	...
	implements Runnable
{
	...
	VideoViewActivity$3$1(VideoViewActivity._cls3 _pcls3)
	{
		a = _pcls3;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/irobot/home/VideoViewActivity$3

/* anonymous class */
	class VideoViewActivity._cls3
		implements android.media.MediaPlayer.OnPreparedListener
	{
		...
		//   10   24:invokevirtual   #40  <Method void VideoView.start()>
			a.d.postDelayed(((Runnable) (new VideoViewActivity._cls3._cls1(this))), 400L);
		//   11   27:aload_0         
