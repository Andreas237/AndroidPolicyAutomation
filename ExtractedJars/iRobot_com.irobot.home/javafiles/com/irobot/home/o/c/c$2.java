	...
	implements com.irobot.awsservices.b.b$b
{
	...
	public void a(com.irobot.awsservices.b.b$a b$a1)
	{
		if(b$a1 == com.irobot.awsservices.b.b$a.ConnectionLost)
	//*   0    0:aload_1         
	...
	//   46   95:aload_1         
	//   47   96:athrow          
		if(b$a1 == com.irobot.awsservices.b.b$a.Disconnected)
	//*  48   97:aload_1         
	...
	//   77  157:aload_1         
	//   78  158:athrow          
		if(b$a1 != com.irobot.awsservices.b.b$a.Connected) goto _L2; else goto _L1
	//   79  159:aload_1         
	//   80  160:getstatic       #87  <Field com.irobot.awsservices.b.b$a com.irobot.awsservices.b.b$a.Connected>
	//   81  163:if_acmpne       268
_L1:
		ConnectivityStateReceiver.a().a(((com.irobot.home.util.ectivityStateReceiver.a) (a)));
...
_L3:
	...
	//  101  207:invokestatic    #106 <Method void Thread.sleep(long)>
		b$a1 = ((com.irobot.awsservices.b.b$a) (c.a(a)));
	//  102  210:aload_0         
	...
	//  105  217:astore_1        
_L6:
		((NetworkSessionCallback) (b$a1)).connected();
	//  106  218:aload_1         
