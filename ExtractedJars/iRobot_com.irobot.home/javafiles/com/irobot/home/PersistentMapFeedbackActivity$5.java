...
class PersistentMapFeedbackActivity$5 extends ApplicationUIServiceDataCallback
{
	...
	//   10   26:astore_2        
			switch(PersistentMapFeedbackActivity$6.a[applicationuistate.ordinal()])
	...
	//*  43  120:goto            8
			case 1: // '\001'
				PersistentMapFeedbackActivity.f(a);
	//   44  123:aload_0         
	//   45  124:getfield        #12  <Field PersistentMapFeedbackActivity a>
	//   46  127:invokestatic    #84  <Method void PersistentMapFeedbackActivity.f(PersistentMapFeedbackActivity)>
				break;
			}
		} while(true);
	//*  47  130:goto            8
	...
	PersistentMapFeedbackActivity$5(PersistentMapFeedbackActivity persistentmapfeedbackactivity)
	{
