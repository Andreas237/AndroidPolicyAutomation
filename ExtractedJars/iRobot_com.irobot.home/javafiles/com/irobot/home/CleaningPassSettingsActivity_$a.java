...
//			CleaningPassSettingsActivity_

public static class CleaningPassSettingsActivity_$a extends a
{

	public CleaningPassSettingsActivity_$a a(String s)
	{
		return (CleaningPassSettingsActivity_$a)super.a("robotBlid", s);
	//    0    0:aload_0         
	...
	public CleaningPassSettingsActivity_$a a(boolean flag)
	{
		return (CleaningPassSettingsActivity_$a)super.a("shouldSendUpdates", flag);
	//    0    0:aload_0         
	...
	//    5   11:aload_0         
	//    6   12:getfield        #43  <Field android.content.Intent c>
	//    7   15:iload_1         
	//    8   16:invokevirtual   #47  <Method void Fragment.startActivityForResult(android.content.Intent, int)>
		else
	//*   9   19:goto            95
		if(d != null)
	//*  10   22:aload_0         
	...
	//   15   33:aload_0         
	//   16   34:getfield        #43  <Field android.content.Intent c>
	//   17   37:iload_1         
	//   18   38:aload_0         
	//   19   39:getfield        #52  <Field android.os.Bundle a>
	//   20   42:invokevirtual   #57  <Method void android.app.Fragment.startActivityForResult(android.content.Intent, int, android.os.Bundle)>
		else
	//*  21   45:goto            95
	...
	//   29   65:aload_0         
	//   30   66:getfield        #43  <Field android.content.Intent c>
	//   31   69:iload_1         
	//   32   70:aload_0         
	//   33   71:getfield        #52  <Field android.os.Bundle a>
	...
	//   38   84:aload_0         
	//   39   85:getfield        #43  <Field android.content.Intent c>
	//   40   88:aload_0         
	//   41   89:getfield        #52  <Field android.os.Bundle a>
	...
	public CleaningPassSettingsActivity_$a(Fragment fragment)
	{
