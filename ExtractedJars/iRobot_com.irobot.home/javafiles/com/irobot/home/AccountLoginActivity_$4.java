...
class AccountLoginActivity_$4 extends org.androidannotations.api.a.a
{
	...
	public void a()
	{
		try
		{
			AccountLoginActivity_.c(a);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field AccountLoginActivity_ a>
	//    2    4:invokestatic    #25  <Method void AccountLoginActivity_.c(AccountLoginActivity_)>
			return;
	//    3    7:return          
		}
	...
	AccountLoginActivity_$4(AccountLoginActivity_ accountloginactivity_, String s, long l, String s1)
	{
		a = accountloginactivity_;
	//    0    0:aload_0         
	//    1    1:aload_1         
