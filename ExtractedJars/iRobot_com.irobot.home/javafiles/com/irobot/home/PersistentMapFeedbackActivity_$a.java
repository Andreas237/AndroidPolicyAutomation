...
//			PersistentMapFeedbackActivity_

public static class PersistentMapFeedbackActivity_$a extends a
{

	public PersistentMapFeedbackActivity_$a a(String s)
	{
		return (PersistentMapFeedbackActivity_$a)super.a("assetId", s);
	//    0    0:aload_0         
	...
	public PersistentMapFeedbackActivity_$a b(String s)
	{
		return (PersistentMapFeedbackActivity_$a)super.a("imagePath", s);
	//    0    0:aload_0         
	...
	public PersistentMapFeedbackActivity_$a c(String s)
	{
		return (PersistentMapFeedbackActivity_$a)super.a("mapId", s);
	//    0    0:aload_0         
	...
	public PersistentMapFeedbackActivity_$a d(String s)
	{
		return (PersistentMapFeedbackActivity_$a)super.a("mapVersion", s);
	//    0    0:aload_0         
	...
	public PersistentMapFeedbackActivity_$a(Context context)
	{
