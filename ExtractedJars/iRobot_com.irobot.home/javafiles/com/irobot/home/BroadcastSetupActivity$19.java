...
class BroadcastSetupActivity$19
	implements Runnable
{

	public void run()
	{
		(new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setMessage(0x7f0f07fc).setNegativeButton(0x7f0f04d3, new android.content.DialogInterface.OnClickListener() {
	...
	BroadcastSetupActivity$19(BroadcastSetupActivity broadcastsetupactivity)
	{
