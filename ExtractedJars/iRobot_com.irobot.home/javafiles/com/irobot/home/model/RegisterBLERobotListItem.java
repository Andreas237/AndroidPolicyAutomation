...
public class RegisterBLERobotListItem
	implements Parcelable
{

	public RegisterBLERobotListItem(Parcel parcel)
	{
	//    0    0:aload_0         
	...
	//    3    5:invokevirtual   #49  <Method void Parcel.writeString(String)>
		parcel.writeString(b);
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:getfield        #36  <Field String b>
	//    7   13:invokevirtual   #49  <Method void Parcel.writeString(String)>
		parcel.writeInt(c);
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #42  <Field int c>
	//   11   21:invokevirtual   #53  <Method void Parcel.writeInt(int)>
	//   12   24:return          
	}
...
;
	...
	static 
	{
	//    0    0:new             #8   <Class RegisterBLERobotListItem$1>
	//    1    3:dup             
	//    2    4:invokespecial   #21  <Method void RegisterBLERobotListItem$1()>
