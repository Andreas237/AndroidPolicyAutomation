...
//			MapCustomizationEditInfoActivity

public final class MapCustomizationEditInfoActivity_ extends MapCustomizationEditInfoActivity
	implements org.androidannotations.api.c.a, b
{
	public static class a extends org.androidannotations.api.a.a
	{
		...
		//    4    7:checkcast       #2   <Class MapCustomizationEditInfoActivity_$a>
		//    5   10:areturn         
		}
		...
		{
			super(context, com/irobot/home/MapCustomizationEditInfoActivity_);
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:ldc1            #7   <Class MapCustomizationEditInfoActivity_>
	...
	public MapCustomizationEditInfoActivity_()
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void MapCustomizationEditInfoActivity()>
	//    2    4:aload_0         
	//    3    5:new             #21  <Class c>
	//    4    8:dup             
	...
	//    0    0:new             #12  <Class MapCustomizationEditInfoActivity_$a>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #29  <Method void MapCustomizationEditInfoActivity_$a(Context)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #128 <Method View findViewById(int)>
	//    3    5:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:ldc1            #132 <Int 0x7f09001e>
	//    3    4:invokeinterface #134 <Method View a.a(int)>
	//    4    9:checkcast       #136 <Class Button>
	//    5   12:putfield        #140 <Field Button o>
		if(o != null)
	//*   6   15:aload_0         
	//*   7   16:getfield        #140 <Field Button o>
	//*   8   19:ifnull          37
			o.setOnClickListener(new android.view.View.OnClickListener() {
				...
				public void onClick(View view)
				{
					a.e();
				//    0    0:aload_0         
				//    1    1:getfield        #16  <Field MapCustomizationEditInfoActivity_ a>
				//    2    4:invokevirtual   #25  <Method void com.irobot.home.MapCustomizationEditInfoActivity_.e()>
				//    3    7:return          
				}

				final MapCustomizationEditInfoActivity_ a;

			
			{
				a = MapCustomizationEditInfoActivity_.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
			//    2    2:putfield        #16  <Field MapCustomizationEditInfoActivity_ a>
				super();
			//    3    5:aload_0         
	...
	//    9   22:aload_0         
	//   10   23:getfield        #140 <Field Button o>
	//   11   26:new             #10  <Class MapCustomizationEditInfoActivity_$1>
	//   12   29:dup             
	//   13   30:aload_0         
	//   14   31:invokespecial   #143 <Method void MapCustomizationEditInfoActivity_$1(MapCustomizationEditInfoActivity_)>
	//   15   34:invokevirtual   #147 <Method void Button.setOnClickListener(android.view.View$OnClickListener)>
		f();
	//   16   37:aload_0         
	//   17   38:invokevirtual   #149 <Method void f()>
	//   18   41:return          
	}
	...
	//    7   13:aload_0         
	//    8   14:aload_1         
	//    9   15:invokespecial   #157 <Method void MapCustomizationEditInfoActivity.onCreate(Bundle)>
		c.a(c1);
	//   10   18:aload_2         
	...
	//   13   23:aload_0         
	//   14   24:ldc1            #158 <Int 0x7f0b007a>
	//   15   26:invokevirtual   #162 <Method void setContentView(int)>
	//   16   29:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #163 <Method void MapCustomizationEditInfoActivity.setContentView(int)>
		b.a(((org.androidannotations.api.c.a) (this)));
	//    3    5:aload_0         
	//    4    6:getfield        #24  <Field c b>
	//    5    9:aload_0         
	//    6   10:invokevirtual   #165 <Method void c.a(a)>
	//    7   13:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #168 <Method void MapCustomizationEditInfoActivity.setContentView(View)>
		b.a(((org.androidannotations.api.c.a) (this)));
	//    3    5:aload_0         
	//    4    6:getfield        #24  <Field c b>
	//    5    9:aload_0         
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #171 <Method void MapCustomizationEditInfoActivity.setContentView(View, android.view.ViewGroup$LayoutParams)>
		b.a(((org.androidannotations.api.c.a) (this)));
	//    4    6:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #175 <Method void MapCustomizationEditInfoActivity.setIntent(Intent)>
		g();
	//    3    5:aload_0         
