	...
	implements Runnable
{
	...
	//   12   30:invokestatic    #54  <Method a a.a(String)>
	//   13   33:getstatic       #60  <Field i i.WIPE>
	//   14   36:invokevirtual   #63  <Method void a.a(i)>
		}
	//*  15   39:goto            83
	...
	final BaseCleanActivity._cls3._cls1 a;

	BaseCleanActivity$3$1$1(BaseCleanActivity._cls3._cls1 _pcls1)
	{
		a = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/irobot/home/BaseCleanActivity$3

/* anonymous class */
	class BaseCleanActivity._cls3
		implements Runnable
	{
		...
		//    0    0:invokestatic    #40  <Method com.irobot.home.model.a j.j()>
		//    1    3:invokevirtual   #45  <Method AssetInfo com.irobot.home.model.a.a()>
		...
		//    3    9:astore_1        
			(new android.app.AlertDialog.Builder(((android.content.Context) (c)))).setTitle(0x7f0f0786).setMessage(((CharSequence) (c.getString(0x7f0f019f, new Object[] {
				s, s
			})))).setCancelable(false).setPositiveButton(0x7f0f05bb, new BaseCleanActivity._cls3._cls1(this)).show();
	...
	// Unreferenced inner class com/irobot/home/BaseCleanActivity$3$1

/* anonymous class */
	class BaseCleanActivity._cls3._cls1
		implements android.content.DialogInterface.OnClickListener
	{

		public void onClick(DialogInterface dialoginterface, int k)
		{
			a.a.post(((Runnable) (new BaseCleanActivity._cls3._cls1._cls1(this))));
		//    0    0:aload_0         
