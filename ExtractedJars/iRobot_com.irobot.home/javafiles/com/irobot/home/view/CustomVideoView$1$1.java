	...
	implements Runnable
{
	...
	CustomVideoView$1$1(CustomVideoView._cls1 _pcls1, MediaPlayer mediaplayer)
	{
		b = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/irobot/home/view/CustomVideoView$1

/* anonymous class */
	class CustomVideoView._cls1
		implements android.media.MediaPlayer.OnPreparedListener
	{
		...
		//   12   28:invokevirtual   #43  <Method void MediaPlayer.start()>
			(new Handler()).post(((Runnable) (new CustomVideoView._cls1._cls1(this, mediaplayer))));
