...
class WebViewActivity_$3 extends org.androidannotations.api.a.a
{
	...
	public void a()
	{
		try
		{
			WebViewActivity_.c(a);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field WebViewActivity_ a>
	//    2    4:invokestatic    #25  <Method void WebViewActivity_.c(WebViewActivity_)>
			return;
	//    3    7:return          
		}
	...
	WebViewActivity_$3(WebViewActivity_ webviewactivity_, String s, long l, String s1)
	{
		a = webviewactivity_;
	//    0    0:aload_0         
	//    1    1:aload_1         
