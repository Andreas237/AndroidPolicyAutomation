...
class ao$1 extends HistoryUIServiceDataCallback
{
	...
	//   14   34:invokestatic    #54  <Method void o.a(String, String)>
			switch(ao$3.a[historydatastate.ordinal()])
	//*  15   37:getstatic       #59  <Field int[] ao$3.a>
	//*  16   40:aload_3         
	...
	//*  25   79:goto            8
			case 1: // '\001'
				ao.a(a, historyuiservicedata);
	//   26   82:aload_0         
	//   27   83:getfield        #12  <Field ao a>
	//   28   86:aload_1         
	//   29   87:invokestatic    #68  <Method void ao.a(ao, HistoryUIServiceData)>
				break;
			}
		} while(true);
	//*  30   90:goto            8
