...
class ca$b extends BroadcastReceiver
{
	...
	//   28   59:pop             
			o.b("UpdatingRobot", ((StringBuilder) (intent)).toString());
	...
	//   32   66:invokestatic    #73  <Method void o.b(String, String)>
			if(ca$3.a[((NetworkInfo) (context)).getState().ordinal()] != 1)
	//*  33   69:getstatic       #78  <Field int[] ca$3.a>
	//*  34   72:aload_1         
