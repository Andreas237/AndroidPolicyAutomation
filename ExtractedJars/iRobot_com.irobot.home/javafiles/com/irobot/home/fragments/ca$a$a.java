...
public static final class ca$a$a extends Enum
{

	public static ca$a$a valueOf(String s)
	{
		return (ca$a$a)Enum.valueOf(com/irobot/home/fragments/ca$a$a, s);
	...
	public static ca$a$a[] values()
	{
		return (ca$a$a[])((ca$a$a []) ($VALUES)).clone();
	...
	private static final ca$a$a $VALUES[];
	public static final ca$a$a ROBOT_NOT_CONNECTED;
	public static final ca$a$a ROBOT_NOT_DOCKED;
	public static final ca$a$a ROBOT_NOT_READY;
	public static final ca$a$a UPDATE_INTERRUPTED;

	static 
	{
		ROBOT_NOT_CONNECTED = new ca$a$a("ROBOT_NOT_CONNECTED", 0);
	...
	//    5   10:putstatic       #26  <Field ca$a$a ROBOT_NOT_CONNECTED>
		ROBOT_NOT_DOCKED = new ca$a$a("ROBOT_NOT_DOCKED", 1);
	...
	//   11   23:putstatic       #29  <Field ca$a$a ROBOT_NOT_DOCKED>
		ROBOT_NOT_READY = new ca$a$a("ROBOT_NOT_READY", 2);
	...
	//   17   36:putstatic       #32  <Field ca$a$a ROBOT_NOT_READY>
		UPDATE_INTERRUPTED = new ca$a$a("UPDATE_INTERRUPTED", 3);
