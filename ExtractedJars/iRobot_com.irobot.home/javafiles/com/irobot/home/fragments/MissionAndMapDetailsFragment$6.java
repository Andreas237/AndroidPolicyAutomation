...
class MissionAndMapDetailsFragment$6 extends AssetNetworkUIServiceDataCallback
{
	...
	//   13   31:astore_3        
			if(MissionAndMapDetailsFragment$7.d[assetnetworkuiservicedatastate.ordinal()] == 1)
	...
	//*  19   41:icmpeq          47
	//*  20   44:goto            13
				MissionAndMapDetailsFragment.a(a, assetnetworkuiservicedata.getConnectionStateForRemote());
	//   21   47:aload_0         
	...
	//   25   55:invokestatic    #59  <Method void MissionAndMapDetailsFragment.a(MissionAndMapDetailsFragment, com.irobot.core.NetworkState)>
		} while(true);
	//   26   58:goto            13
	//   27   61:return          
	}
	...
	MissionAndMapDetailsFragment$6(MissionAndMapDetailsFragment missionandmapdetailsfragment)
	{
