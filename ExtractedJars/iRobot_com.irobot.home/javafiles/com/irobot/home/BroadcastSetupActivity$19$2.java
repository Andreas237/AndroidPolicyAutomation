...
class BroadcastSetupActivity$19$2
	implements android.content.ner
{
	...
	BroadcastSetupActivity$19$2(BroadcastSetupActivity._cls19 _pcls19)
	{
		a = _pcls19;
	//    0    0:aload_0         
	//    1    1:aload_1         
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		public void run()
		{
			(new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setMessage(0x7f0f07fc).setNegativeButton(0x7f0f04d3, ((android.content.DialogInterface.OnClickListener) (new BroadcastSetupActivity._cls19._cls2(this)))).setPositiveButton(0x7f0f0986, new BroadcastSetupActivity._cls19._cls1()).show();
		...
		// Unreferenced inner class com/irobot/home/BroadcastSetupActivity$19$1

/* anonymous class */
		class BroadcastSetupActivity._cls19._cls1
