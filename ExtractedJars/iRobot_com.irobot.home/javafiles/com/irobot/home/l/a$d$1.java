	...
	implements Runnable
{
	...
	//*   4   10:ifnull          35
		{
			com.irobot.home.l.a.c(c.a).onTranslationStart(a, b);
	//    5   13:aload_0         
	...
	//   13   31:invokevirtual   #44  <Method void RenderPresenter.onTranslationStart(float, float)>
			return;
	//   14   34:return          
		} else
		{
	...
	//   16   38:ldc1            #49  <String "mRenderPresenter null in onScroll">
