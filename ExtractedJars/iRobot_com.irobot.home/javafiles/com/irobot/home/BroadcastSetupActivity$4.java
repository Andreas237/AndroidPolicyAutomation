...
class BroadcastSetupActivity$4
	implements Runnable
{

	public void run()
	{
		(new android.app.AlertDialog.Builder(((android.content.Context) (a)))).setTitle("Update Required").setMessage("BLE provisioning requires the robot firmware to be updated.\n\nPlease upgrade your robot or select another robot to provision.").setPositiveButton(0x7f0f05bb, new android.content.DialogInterface.OnClickListener() {
			...
			{
				a = BroadcastSetupActivity._cls4.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	BroadcastSetupActivity$4(BroadcastSetupActivity broadcastsetupactivity)
	{
