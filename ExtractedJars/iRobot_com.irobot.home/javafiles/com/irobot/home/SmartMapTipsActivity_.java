...
public final class SmartMapTipsActivity_ extends SmartMapTipsActivity
	implements org.androidannotations.api.c.a, b
{
	public static class a extends org.androidannotations.api.a.a
	{
		...
		{
			super(context, com/irobot/home/SmartMapTipsActivity_);
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:ldc1            #7   <Class SmartMapTipsActivity_>
	...
	public SmartMapTipsActivity_()
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #19  <Method void SmartMapTipsActivity()>
	//    2    4:aload_0         
	//    3    5:new             #21  <Class c>
	//    4    8:dup             
	...
	//    0    0:new             #12  <Class SmartMapTipsActivity_$a>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #29  <Method void SmartMapTipsActivity_$a(Context)>
	//    4    8:areturn         
	}
	...
	//*  14   34:ifnull          52
			b.setOnClickListener(new android.view.View.OnClickListener() {
				...
				public void onClick(View view)
				{
					a.f();
				//    0    0:aload_0         
				//    1    1:getfield        #16  <Field SmartMapTipsActivity_ a>
				//    2    4:invokevirtual   #25  <Method void SmartMapTipsActivity_.f()>
				//    3    7:return          
				}

				final SmartMapTipsActivity_ a;

			
			{
				a = SmartMapTipsActivity_.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
			//    2    2:putfield        #16  <Field SmartMapTipsActivity_ a>
				super();
			//    3    5:aload_0         
	...
	//   17   41:new             #10  <Class SmartMapTipsActivity_$1>
	//   18   44:dup             
	//   19   45:aload_0         
	//   20   46:invokespecial   #58  <Method void SmartMapTipsActivity_$1(SmartMapTipsActivity_)>
	...
	//    7   13:aload_0         
	//    8   14:aload_1         
	//    9   15:invokespecial   #73  <Method void SmartMapTipsActivity.onCreate(Bundle)>
		org.androidannotations.api.c.c.a(c1);
	//   10   18:aload_2         
	//   11   19:invokestatic    #69  <Method c c.a(c)>
	//   12   22:pop             
		setContentView(0x7f0b0072);
	//   13   23:aload_0         
	//   14   24:ldc1            #74  <Int 0x7f0b0072>
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #79  <Method void SmartMapTipsActivity.setContentView(int)>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #84  <Method void SmartMapTipsActivity.setContentView(View)>
		c.a(((org.androidannotations.api.c.a) (this)));
	//    3    5:aload_0         
	//    4    6:getfield        #24  <Field c c>
	//    5    9:aload_0         
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #87  <Method void SmartMapTipsActivity.setContentView(View, android.view.ViewGroup$LayoutParams)>
		c.a(((org.androidannotations.api.c.a) (this)));
	//    4    6:aload_0         
