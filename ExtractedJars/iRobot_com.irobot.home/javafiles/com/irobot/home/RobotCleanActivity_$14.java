...
class RobotCleanActivity_$14 extends org.androidannotations.api.a.a
{
	...
	public void a()
	{
		try
		{
			RobotCleanActivity_.c(a);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field RobotCleanActivity_ a>
	//    2    4:invokestatic    #25  <Method void RobotCleanActivity_.c(RobotCleanActivity_)>
			return;
	//    3    7:return          
		}
	...
	RobotCleanActivity_$14(RobotCleanActivity_ robotcleanactivity_, String s, long l, String s1)
	{
		a = robotcleanactivity_;
	//    0    0:aload_0         
	//    1    1:aload_1         
