	...
	implements g.h
{
	...
	//    8   18:iconst_0        
	//    9   19:aload_2         
	//   10   20:invokeinterface #29  <Method void g$e.a(g, byte, d)>
			return;
	//   11   25:return          
		}
		if(abyte0 != null)
	...
	//   20   42:pop             
			obj = ((Object) (new h.o(((h) (obj)))));
	//   21   43:new             #38  <Class h$o>
	//   22   46:dup             
	//   23   47:aload_3         
	//   24   48:invokespecial   #41  <Method void h$o(h)>
	//   25   51:astore_3        
			((h.o) (obj)).a(abyte0);
	//   26   52:aload_3         
	//   27   53:aload_1         
	//   28   54:invokevirtual   #44  <Method void h$o.a(byte[])>
			((h.o) (obj)).b();
	//   29   57:aload_3         
	//   30   58:invokevirtual   #47  <Method void h$o.b()>
			((g.e)a.a).a(a, ((h.o) (obj)).a, d);
	//   31   61:aload_0         
	...
	//   37   75:aload_3         
	//   38   76:getfield        #50  <Field byte h$o.a>
	//   39   79:aload_2         
	//   40   80:invokeinterface #29  <Method void g$e.a(g, byte, d)>
		}
	//   41   85:return          
	}
