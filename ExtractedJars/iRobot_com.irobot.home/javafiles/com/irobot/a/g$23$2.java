	...
	implements Runnable
{
	...
	g$23$2(g._cls23 _pcls23, BluetoothGatt bluetoothgatt)
	{
		b = _pcls23;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/irobot/a/g$23

/* anonymous class */
	class g._cls23 extends BluetoothGattCallback
	{
...
_L3:
		...
		//   34   71:astore          5
				obj = ((Object) (new g._cls23._cls1(bluetoothgatt)));
		...
		//  135  287:astore          4
				g._cls23._cls2 _lcls2 = new g._cls23._cls2(this, bluetoothgatt);
		...
		// Unreferenced inner class com/irobot/a/g$23$1

/* anonymous class */
		class g._cls23._cls1
			implements Runnable
		{
