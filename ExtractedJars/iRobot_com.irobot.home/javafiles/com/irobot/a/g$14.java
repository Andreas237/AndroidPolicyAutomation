	...
	implements g.h
{
	...
	//    8   18:aconst_null     
	//    9   19:aload_2         
	//   10   20:invokeinterface #29  <Method void g$e.a(g, h$c, d)>
			return;
	//   11   25:return          
		}
		if(abyte0 != null)
	...
	//   20   42:pop             
			obj = ((Object) (new h.c(((h) (obj)))));
	//   21   43:new             #38  <Class h$c>
	//   22   46:dup             
	//   23   47:aload_3         
	//   24   48:invokespecial   #41  <Method void h$c(h)>
	//   25   51:astore_3        
			((h.c) (obj)).a(abyte0);
	//   26   52:aload_3         
	//   27   53:aload_1         
	//   28   54:invokevirtual   #44  <Method void h$c.a(byte[])>
			((h.c) (obj)).b();
	//   29   57:aload_3         
	//   30   58:invokevirtual   #47  <Method void h$c.b()>
			((g.e)a.a).a(a, ((h.c) (obj)), d);
	//   31   61:aload_0         
	...
	//   37   75:aload_3         
	//   38   76:aload_2         
	//   39   77:invokeinterface #29  <Method void g$e.a(g, h$c, d)>
		}
	//   40   82:return          
	}
