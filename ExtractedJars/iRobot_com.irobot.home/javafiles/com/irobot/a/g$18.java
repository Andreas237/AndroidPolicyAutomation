	...
	implements g.h
{
	...
	//    8   18:iconst_0        
	//    9   19:aload_2         
	//   10   20:invokeinterface #30  <Method void g$e.d(g, byte, d)>
			return;
	//   11   25:return          
		}
		if(abyte0 != null)
	...
	//   20   42:pop             
			obj = ((Object) (new h.i(((h) (obj)))));
	//   21   43:new             #39  <Class h$i>
	//   22   46:dup             
	//   23   47:aload_3         
	//   24   48:invokespecial   #42  <Method void h$i(h)>
	//   25   51:astore_3        
			((h.i) (obj)).a(abyte0);
	//   26   52:aload_3         
	//   27   53:aload_1         
	//   28   54:invokevirtual   #45  <Method void h$i.a(byte[])>
			((h.i) (obj)).b();
	//   29   57:aload_3         
	//   30   58:invokevirtual   #48  <Method void h$i.b()>
			((g.e)a.a).d(a, ((h.i) (obj)).a, d);
	//   31   61:aload_0         
	...
	//   37   75:aload_3         
	//   38   76:getfield        #51  <Field byte h$i.a>
	//   39   79:aload_2         
	//   40   80:invokeinterface #30  <Method void g$e.d(g, byte, d)>
		}
	//   41   85:return          
	}
