	...
	implements a
{
	...
	//    1    3:dup             
	//    2    4:invokespecial   #74  <Method void JSONObject()>
	//    3    7:astore_2        
			SessionEventMetadata sessioneventmetadata = sessionevent.sessionEventMetadata;
	//    4    8:aload_1         
	//    5    9:getfield        #80  <Field SessionEventMetadata SessionEvent.sessionEventMetadata>
	//    6   12:astore_3        
			jsonobject.put("appBundleId", ((Object) (sessioneventmetadata.appBundleId)));
	//    7   13:aload_2         
	//    8   14:ldc1            #11  <String "appBundleId">
	//    9   16:aload_3         
	//   10   17:getfield        #84  <Field String SessionEventMetadata.appBundleId>
	//   11   20:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   12   23:pop             
			jsonobject.put("executionId", ((Object) (sessioneventmetadata.executionId)));
	//   13   24:aload_2         
	//   14   25:ldc1            #38  <String "executionId">
	//   15   27:aload_3         
	//   16   28:getfield        #90  <Field String SessionEventMetadata.executionId>
	//   17   31:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   18   34:pop             
			jsonobject.put("installationId", ((Object) (sessioneventmetadata.installationId)));
	//   19   35:aload_2         
	//   20   36:ldc1            #41  <String "installationId">
	//   21   38:aload_3         
	//   22   39:getfield        #92  <Field String SessionEventMetadata.installationId>
	//   23   42:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   24   45:pop             
	...
	//   27   49:aload_3         
	//   28   50:getfield        #95  <Field Boolean SessionEventMetadata.limitAdTrackingEnabled>
	//   29   53:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   30   56:pop             
			jsonobject.put("betaDeviceToken", ((Object) (sessioneventmetadata.betaDeviceToken)));
	//   31   57:aload_2         
	//   32   58:ldc1            #20  <String "betaDeviceToken">
	//   33   60:aload_3         
	//   34   61:getfield        #97  <Field String SessionEventMetadata.betaDeviceToken>
	//   35   64:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   36   67:pop             
			jsonobject.put("buildId", ((Object) (sessioneventmetadata.buildId)));
	//   37   68:aload_2         
	//   38   69:ldc1            #23  <String "buildId">
	//   39   71:aload_3         
	//   40   72:getfield        #99  <Field String SessionEventMetadata.buildId>
	//   41   75:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   42   78:pop             
			jsonobject.put("osVersion", ((Object) (sessioneventmetadata.osVersion)));
	//   43   79:aload_2         
	//   44   80:ldc1            #47  <String "osVersion">
	//   45   82:aload_3         
	//   46   83:getfield        #101 <Field String SessionEventMetadata.osVersion>
	//   47   86:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   48   89:pop             
			jsonobject.put("deviceModel", ((Object) (sessioneventmetadata.deviceModel)));
	//   49   90:aload_2         
	//   50   91:ldc1            #35  <String "deviceModel">
	//   51   93:aload_3         
	//   52   94:getfield        #103 <Field String SessionEventMetadata.deviceModel>
	//   53   97:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   54  100:pop             
			jsonobject.put("appVersionCode", ((Object) (sessioneventmetadata.appVersionCode)));
	//   55  101:aload_2         
	//   56  102:ldc1            #14  <String "appVersionCode">
	//   57  104:aload_3         
	//   58  105:getfield        #105 <Field String SessionEventMetadata.appVersionCode>
	//   59  108:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   60  111:pop             
			jsonobject.put("appVersionName", ((Object) (sessioneventmetadata.appVersionName)));
	//   61  112:aload_2         
	//   62  113:ldc1            #17  <String "appVersionName">
	//   63  115:aload_3         
	//   64  116:getfield        #107 <Field String SessionEventMetadata.appVersionName>
	//   65  119:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   66  122:pop             
			jsonobject.put("timestamp", sessionevent.timestamp);
	//   67  123:aload_2         
	//   68  124:ldc1            #56  <String "timestamp">
	//   69  126:aload_1         
	//   70  127:getfield        #110 <Field long SessionEvent.timestamp>
	//   71  130:invokevirtual   #113 <Method JSONObject JSONObject.put(String, long)>
	//   72  133:pop             
			jsonobject.put("type", ((Object) (sessionevent.type.toString())));
	//   73  134:aload_2         
	//   74  135:ldc1            #59  <String "type">
	//   75  137:aload_1         
	//   76  138:getfield        #116 <Field SessionEvent$Type SessionEvent.type>
	//   77  141:invokevirtual   #122 <Method String SessionEvent$Type.toString()>
	//   78  144:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   79  147:pop             
			if(sessionevent.details != null)
	//*  80  148:aload_1         
	//*  81  149:getfield        #125 <Field java.util.Map SessionEvent.details>
	//*  82  152:ifnull          173
				jsonobject.put("details", ((Object) (new JSONObject(sessionevent.details))));
	//   83  155:aload_2         
	//   84  156:ldc1            #32  <String "details">
	//   85  158:new             #73  <Class JSONObject>
	//   86  161:dup             
	//   87  162:aload_1         
	//   88  163:getfield        #125 <Field java.util.Map SessionEvent.details>
	//   89  166:invokespecial   #128 <Method void JSONObject(java.util.Map)>
	//   90  169:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   91  172:pop             
			jsonobject.put("customType", ((Object) (sessionevent.customType)));
	//   92  173:aload_2         
	//   93  174:ldc1            #29  <String "customType">
	//   94  176:aload_1         
	//   95  177:getfield        #130 <Field String SessionEvent.customType>
	//   96  180:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//   97  183:pop             
			if(sessionevent.customAttributes != null)
	//*  98  184:aload_1         
	//*  99  185:getfield        #132 <Field java.util.Map SessionEvent.customAttributes>
	//* 100  188:ifnull          209
	...
	//  103  194:new             #73  <Class JSONObject>
	//  104  197:dup             
	//  105  198:aload_1         
	//  106  199:getfield        #132 <Field java.util.Map SessionEvent.customAttributes>
	//  107  202:invokespecial   #128 <Method void JSONObject(java.util.Map)>
	//  108  205:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//  109  208:pop             
			jsonobject.put("predefinedType", ((Object) (sessionevent.predefinedType)));
	//  110  209:aload_2         
	//  111  210:ldc1            #53  <String "predefinedType">
	//  112  212:aload_1         
	//  113  213:getfield        #134 <Field String SessionEvent.predefinedType>
	//  114  216:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//  115  219:pop             
			if(sessionevent.predefinedAttributes != null)
	//* 116  220:aload_1         
	//* 117  221:getfield        #136 <Field java.util.Map SessionEvent.predefinedAttributes>
	//* 118  224:ifnull          245
	...
	//  121  230:new             #73  <Class JSONObject>
	//  122  233:dup             
	//  123  234:aload_1         
	//  124  235:getfield        #136 <Field java.util.Map SessionEvent.predefinedAttributes>
	//  125  238:invokespecial   #128 <Method void JSONObject(java.util.Map)>
	//  126  241:invokevirtual   #88  <Method JSONObject JSONObject.put(String, Object)>
	//  127  244:pop             
		}
	//* 128  245:aload_2         
	//* 129  246:areturn         
	...
	//* 131  248:getstatic       #142 <Field int android.os.Build$VERSION.SDK_INT>
	//* 132  251:bipush          9
	//* 133  253:icmplt          269
				throw new IOException(((JSONException) (sessionevent)).getMessage(), ((Throwable) (sessionevent)));
	//  134  256:new             #144 <Class IOException>
	//  135  259:dup             
	//  136  260:aload_1         
	...
	//  141  269:new             #144 <Class IOException>
	//  142  272:dup             
	//  143  273:aload_1         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #158 <Method JSONObject buildJsonForEvent(SessionEvent)>
	//    3    5:invokevirtual   #159 <Method String JSONObject.toString()>
	//    4    8:ldc1            #161 <String "UTF-8">
	//    5   10:invokevirtual   #167 <Method byte[] String.getBytes(String)>
	//    6   13:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #76  <Class SessionEvent>
	//    3    5:invokevirtual   #170 <Method byte[] toBytes(SessionEvent)>
	//    4    8:areturn         
	}
