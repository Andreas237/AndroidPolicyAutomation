...
final class SessionEvent
{
	...
	//    3    7:new             #152 <Class StringBuilder>
	//    4   10:dup             
	//    5   11:invokespecial   #153 <Method void StringBuilder()>
	//    6   14:astore_1        
			stringbuilder.append("[");
	//    7   15:aload_1         
	//    8   16:ldc1            #155 <String "[">
	//    9   18:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   10   21:pop             
			stringbuilder.append(((Object)this).getClass().getSimpleName());
	//   11   22:aload_1         
	//   12   23:aload_0         
	//   13   24:invokevirtual   #123 <Method Class Object.getClass()>
	//   14   27:invokevirtual   #162 <Method String Class.getSimpleName()>
	//   15   30:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   16   33:pop             
			stringbuilder.append(": ");
	//   17   34:aload_1         
	//   18   35:ldc1            #164 <String ": ">
	//   19   37:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   20   40:pop             
			stringbuilder.append("timestamp=");
	//   21   41:aload_1         
	//   22   42:ldc1            #166 <String "timestamp=">
	//   23   44:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   24   47:pop             
			stringbuilder.append(timestamp);
	//   25   48:aload_1         
	//   26   49:aload_0         
	//   27   50:getfield        #49  <Field long timestamp>
	//   28   53:invokevirtual   #169 <Method StringBuilder StringBuilder.append(long)>
	//   29   56:pop             
			stringbuilder.append(", type=");
	//   30   57:aload_1         
	//   31   58:ldc1            #171 <String ", type=">
	//   32   60:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   33   63:pop             
			stringbuilder.append(((Object) (type)));
	//   34   64:aload_1         
	//   35   65:aload_0         
	//   36   66:getfield        #51  <Field SessionEvent$Type type>
	//   37   69:invokevirtual   #174 <Method StringBuilder StringBuilder.append(Object)>
	//   38   72:pop             
			stringbuilder.append(", details=");
	//   39   73:aload_1         
	//   40   74:ldc1            #176 <String ", details=">
	//   41   76:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   42   79:pop             
			stringbuilder.append(((Object) (details)));
	//   43   80:aload_1         
	//   44   81:aload_0         
	//   45   82:getfield        #53  <Field Map details>
	//   46   85:invokevirtual   #174 <Method StringBuilder StringBuilder.append(Object)>
	//   47   88:pop             
			stringbuilder.append(", customType=");
	//   48   89:aload_1         
	//   49   90:ldc1            #178 <String ", customType=">
	//   50   92:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   51   95:pop             
			stringbuilder.append(customType);
	//   52   96:aload_1         
	//   53   97:aload_0         
	//   54   98:getfield        #55  <Field String customType>
	//   55  101:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   56  104:pop             
			stringbuilder.append(", customAttributes=");
	//   57  105:aload_1         
	//   58  106:ldc1            #180 <String ", customAttributes=">
	//   59  108:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   60  111:pop             
			stringbuilder.append(((Object) (customAttributes)));
	//   61  112:aload_1         
	//   62  113:aload_0         
	//   63  114:getfield        #57  <Field Map customAttributes>
	//   64  117:invokevirtual   #174 <Method StringBuilder StringBuilder.append(Object)>
	//   65  120:pop             
			stringbuilder.append(", predefinedType=");
	//   66  121:aload_1         
	//   67  122:ldc1            #182 <String ", predefinedType=">
	//   68  124:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   69  127:pop             
			stringbuilder.append(predefinedType);
	//   70  128:aload_1         
	//   71  129:aload_0         
	//   72  130:getfield        #59  <Field String predefinedType>
	//   73  133:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   74  136:pop             
			stringbuilder.append(", predefinedAttributes=");
	//   75  137:aload_1         
	//   76  138:ldc1            #184 <String ", predefinedAttributes=">
	//   77  140:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   78  143:pop             
			stringbuilder.append(((Object) (predefinedAttributes)));
	//   79  144:aload_1         
	//   80  145:aload_0         
	//   81  146:getfield        #61  <Field Map predefinedAttributes>
	//   82  149:invokevirtual   #174 <Method StringBuilder StringBuilder.append(Object)>
	//   83  152:pop             
			stringbuilder.append(", metadata=[");
	//   84  153:aload_1         
	//   85  154:ldc1            #186 <String ", metadata=[">
	//   86  156:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   87  159:pop             
			stringbuilder.append(((Object) (sessionEventMetadata)));
	//   88  160:aload_1         
	//   89  161:aload_0         
	//   90  162:getfield        #47  <Field SessionEventMetadata sessionEventMetadata>
	//   91  165:invokevirtual   #174 <Method StringBuilder StringBuilder.append(Object)>
	//   92  168:pop             
			stringbuilder.append("]]");
	//   93  169:aload_1         
	//   94  170:ldc1            #188 <String "]]">
	//   95  172:invokevirtual   #159 <Method StringBuilder StringBuilder.append(String)>
	//   96  175:pop             
			stringRepresentation = stringbuilder.toString();
	//   97  176:aload_0         
	//   98  177:aload_1         
	//   99  178:invokevirtual   #190 <Method String StringBuilder.toString()>
	//  100  181:putfield        #150 <Field String stringRepresentation>
		}
		return stringRepresentation;
	//  101  184:aload_0         
	//  102  185:getfield        #150 <Field String stringRepresentation>
	//  103  188:areturn         
	}
