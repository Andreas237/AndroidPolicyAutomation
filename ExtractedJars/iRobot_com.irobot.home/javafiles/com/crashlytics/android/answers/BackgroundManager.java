...
, 5000L, TimeUnit.MILLISECONDS))));
	...
	//*  24   52:astore_1        
			{
				c.g().a("Answers", "Failed to schedule background detector", ((Throwable) (rejectedexecutionexception)));
	//   25   53:invokestatic    #98  <Method l c.g()>
	//   26   56:ldc1            #100 <String "Answers">
	//   27   58:ldc1            #102 <String "Failed to schedule background detector">
	//   28   60:aload_1         
	//   29   61:invokeinterface #108 <Method void l.a(String, String, Throwable)>
			}
		}
	//   30   66:return          
	}
