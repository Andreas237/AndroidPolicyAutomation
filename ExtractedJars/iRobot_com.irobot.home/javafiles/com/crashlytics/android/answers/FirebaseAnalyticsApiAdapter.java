...
class FirebaseAnalyticsApiAdapter
{
	...
	//*  16   32:ifnonnull       73
		{
			obj = ((Object) (c.g()));
	//   17   35:invokestatic    #46  <Method l c.g()>
	//   18   38:astore_2        
	...
	//   30   59:pop             
			((l) (obj)).a("Answers", ((StringBuilder) (obj1)).toString());
	//   31   60:aload_2         
	//   32   61:ldc1            #48  <String "Answers">
	//   33   63:aload_3         
	//   34   64:invokevirtual   #76  <Method String StringBuilder.toString()>
	//   35   67:invokeinterface #56  <Method void l.a(String, String)>
			return;
	//   36   72:return          
		}
