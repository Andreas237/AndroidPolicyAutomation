...
class CrashPromptDialog
{
	...
	public static CrashPromptDialog create(Activity activity, o o1, AlwaysSendCallback alwayssendcallback)
	{
	...
	//    4    8:astore_3        
		DialogStringResolver dialogstringresolver = new DialogStringResolver(((android.content.Context) (activity)), o1);
	//    5    9:new             #37  <Class DialogStringResolver>
	//    6   12:dup             
	//    7   13:aload_0         
	//    8   14:aload_1         
	//    9   15:invokespecial   #40  <Method void DialogStringResolver(android.content.Context, o)>
	//   10   18:astore          4
...
;
	...
	//   38   78:pop             
		if(o1.d)
	//*  39   79:aload_1         
	//*  40   80:getfield        #84  <Field boolean o.d>
	//*  41   83:ifeq            107
		{
	...
	//   52  106:pop             
		...
		if(o1.f)
	//*  53  107:aload_1         
	//*  54  108:getfield        #94  <Field boolean o.f>
	//*  55  111:ifeq            136
		{
