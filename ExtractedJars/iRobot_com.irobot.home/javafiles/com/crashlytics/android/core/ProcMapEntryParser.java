...
final class ProcMapEntryParser
{
	...
	//    8   16:areturn         
		...
		try
		{
			long l1 = Long.valueOf(((Matcher) (obj)).group(1), 16).longValue();
	//    9   17:aload_3         
	//   10   18:iconst_1        
	...
	//   15   30:lstore_1        
			obj = ((Object) (new ProcMapEntry(l1, Long.valueOf(((Matcher) (obj)).group(2), 16).longValue() - l1, ((Matcher) (obj)).group(3), ((Matcher) (obj)).group(4))));
	...
	//*  35   65:aload_3         
	//*  36   66:areturn         
	//*  37   67:invokestatic    #61  <Method l c.g()>
	//*  38   70:astore_3        
	...
	//*  55  103:invokeinterface #82  <Method void l.a(String, String)>
	//*  56  108:aconst_null     
	//*  57  109:areturn         
