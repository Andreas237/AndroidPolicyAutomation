...
//			CrashlyticsController, MetaDataStore, UserMetaData
	...
	implements Callable
{
	...
	//    3    7:astore_1        
		(new MetaDataStore(getFilesDir())).writeUserData(s, new UserMetaData(val$userId, val$userName, val$userEmail));
	//    4    8:new             #43  <Class MetaDataStore>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:getfield        #22  <Field CrashlyticsController this$0>
	//    8   16:invokevirtual   #47  <Method java.io.File CrashlyticsController.getFilesDir()>
	//    9   19:invokespecial   #50  <Method void MetaDataStore(java.io.File)>
	//   10   22:aload_1         
