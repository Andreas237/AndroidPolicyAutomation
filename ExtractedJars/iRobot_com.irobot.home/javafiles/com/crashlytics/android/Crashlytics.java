...
public class Crashlytics extends i
	implements j
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #40  <Method void i()>
		answers = answers1;
	//    2    4:aload_0         
	//    3    5:aload_1         
	...
	//   10   16:putfield        #46  <Field CrashlyticsCore core>
		kits = Collections.unmodifiableCollection(((Collection) (Arrays.asList(((Object []) (new i[] {
	...
	{
		return (Crashlytics)c.a(com/crashlytics/android/Crashlytics);
	//    0    0:ldc1            #2   <Class Crashlytics>
	//    1    2:invokestatic    #78  <Method i c.a(Class)>
	...
	public static void log(int k, String s, String s1)
	{
		checkInitialized();
	//    0    0:invokestatic    #82  <Method void checkInitialized()>
		getInstance().core.log(k, s, s1);
	//    1    3:invokestatic    #65  <Method Crashlytics getInstance()>
	//    2    6:getfield        #46  <Field CrashlyticsCore core>
	//    3    9:iload_0         
	//    4   10:aload_1         
	...
	public static void setInt(String s, int k)
	{
		checkInitialized();
	//    0    0:invokestatic    #82  <Method void checkInitialized()>
		getInstance().core.setInt(s, k);
	//    1    3:invokestatic    #65  <Method Crashlytics getInstance()>
	//    2    6:getfield        #46  <Field CrashlyticsCore core>
	//    3    9:aload_0         
	//    4   10:iload_1         
	...
	public static void setLong(String s, long l1)
	{
		checkInitialized();
	//    0    0:invokestatic    #82  <Method void checkInitialized()>
		getInstance().core.setLong(s, l1);
	//    1    3:invokestatic    #65  <Method Crashlytics getInstance()>
	//    2    6:getfield        #46  <Field CrashlyticsCore core>
	//    3    9:aload_0         
	//    4   10:lload_1         
	...
	//    3    7:invokeinterface #129 <Method void l.d(String, String)>
		getFabric();
	//    4   12:aload_0         
	//    5   13:invokevirtual   #158 <Method c getFabric()>
	//    6   16:pop             
		return c.h();
	//    7   17:invokestatic    #161 <Method boolean c.h()>
	//    8   20:ireturn         
	}
