...
class GSPluginFragment$3$1
	implements GSAndroidPermissionListener
{
	...
	// Unreferenced inner class com/gigya/socialize/android/GSPluginFragment$3

/* anonymous class */
	class GSPluginFragment._cls3 extends WebChromeClient
	{
		...
		//   16   38:pop             
			int i = GSAPI.getInstance().getNextAndroidPermissionsRequestCode(((GSAndroidPermissionListener) (new GSPluginFragment._cls3._cls1())));
