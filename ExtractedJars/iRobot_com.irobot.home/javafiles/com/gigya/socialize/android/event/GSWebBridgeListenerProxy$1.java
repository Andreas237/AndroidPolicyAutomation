...
class GSWebBridgeListenerProxy$1
	implements Runnable
{

	public void run()
	{
		GSWebBridgeListenerProxy.access$000(GSWebBridgeListenerProxy.this).beforeLogin(val$webView, val$requestType, val$params);
	//    0    0:aload_0         
	...
	final com.gigya.socialize.android.Type val$requestType;
	final WebView val$webView;

	GSWebBridgeListenerProxy$1()
	{
