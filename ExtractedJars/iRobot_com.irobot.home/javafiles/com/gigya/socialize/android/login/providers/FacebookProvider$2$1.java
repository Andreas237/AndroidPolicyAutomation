	...
	implements FacebookCallback
{
	...
	//    1    1:getfield        #22  <Field FragmentActivity val$activity>
	//    2    4:invokevirtual   #32  <Method void FragmentActivity.finish()>
		fail(val$callback, facebookexception.getMessage());
	//    3    7:aload_0         
	//    4    8:getfield        #20  <Field FacebookProvider$2 this$1>
	//    5   11:getfield        #36  <Field FacebookProvider FacebookProvider$2.this$0>
	//    6   14:aload_0         
	...
	//    7   17:astore          4
		AccessToken accesstoken1 = val$fbAccessTokenBeforeLogin;
	//    8   19:aload_0         
	...
	//*  15   32:ifnull          80
		{
			flag = accesstoken.getApplicationId().equals(((Object) (val$fbAccessTokenBeforeLogin.getApplicationId()))) ^ true;
	//   16   35:aload           4
	...
	//   24   54:ixor            
	//   25   55:istore_2        
			flag1 = true ^ accesstoken.getUserId().equals(((Object) (val$fbAccessTokenBeforeLogin.getUserId())));
	//   26   56:iconst_1        
	//   27   57:aload           4
	...
	//*  54  116:goto            149
			success(val$callback, accesstoken.getToken(), accesstoken.getExpires().getTime());
	//   55  119:aload_0         
	...
	// Unreferenced inner class com/gigya/socialize/android/login/providers/FacebookProvider$2

/* anonymous class */
	class FacebookProvider._cls2
		implements com.gigya.socialize.android.ui.HostActivity.HostActivityHandler
	{
		...
		public void onCreate(FragmentActivity fragmentactivity, Bundle bundle)
		{
			try
			{
				FacebookProvider.access$400(FacebookProvider.this).setLoginBehavior(FacebookProvider.access$300(FacebookProvider.this, params));
		//    0    0:aload_0         
		//    1    1:getfield        #27  <Field FacebookProvider this$0>
		...
		//    9   21:pop             
				FacebookProvider.access$400(FacebookProvider.this).registerCallback(FacebookProvider.access$500(FacebookProvider.this), ((FacebookCallback) (((FacebookProvider._cls2._cls1) (fragmentactivity)). new FacebookProvider._cls2._cls1())));
		//   10   22:aload_0         
		...
		//   21   45:invokevirtual   #81  <Method void LoginManager.registerCallback(CallbackManager, FacebookCallback)>
				FacebookProvider.access$400(FacebookProvider.this).logInWithReadPermissions(((android.app.Activity) (fragmentactivity)), ((java.util.Collection) (permissions)));
		//   22   48:aload_0         
