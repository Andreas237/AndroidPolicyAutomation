...
class ProviderSelection$1
	implements com.gigya.socialize.android.ui.ivityHandler
{
	...
	{
		val$callback.onCancel(ProviderSelection.this, fragmentactivity);
	//    0    0:aload_0         
	...
	//*   1    1:ifnonnull       123
		{
			if(val$mode.equals(((Object) (com.gigya.socialize.android.RequestType.addConnection))))
	//*   2    4:aload_0         
	...
	//   11   25:astore_2        
			bundle = ((Bundle) (val$params.getString("captionText", ((String) (bundle)))));
	//   12   26:aload_0         
	...
	//   17   36:astore_2        
			ProviderSelection.access$002(ProviderSelection.this, (WebViewFragment)activity.getSupportFragmentManager().findFragmentByTag("GigyaWebViewFragment"));
	//   18   37:aload_0         
	...
	//*  30   64:ifnonnull       123
			{
				ProviderSelection.access$002(ProviderSelection.this, WebViewFragment.create(activity, "GigyaWebViewFragment", ((String) (bundle)), getUrl(val$mode, val$params), "gsapi://result/", new com.gigya.socialize.android.ui.WebViewFragment.WebViewFragmentHandler() {
					...
					//*   4    7:ifeq            35
						{
							callback.onError(this$0, activity, gsobject);
					//    5   10:aload_0         
					...
					//*  20   45:ifne            87
							callback.onSelect(this$0, activity, gsobject.getString("provider", ""), gsobject.getString("displayName", ""));
					//   21   48:aload_0         
			...
			{
				this$1 = ProviderSelection._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
...
, Boolean.valueOf(false)));
	...
	{
		val$callback.onShow(ProviderSelection.this, fragmentactivity);
	//    0    0:aload_0         
	//    1    1:getfield        #31  <Field ProviderSelection$ProviderSelectionHandler val$callback>
	//    2    4:aload_0         
	//    3    5:getfield        #25  <Field ProviderSelection this$0>
	...
	final oviderSelectionHandler val$callback;
	final com.gigya.socialize.android.RequestType val$mode;
	...
	//    8   12:putfield        #29  <Field GSObject val$params>
		val$callback = oviderSelectionHandler.this;
	//    9   15:aload_0         
	//   10   16:aload           4
