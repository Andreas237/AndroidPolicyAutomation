...
class GigyaWebViewProvider$1
	implements com.gigya.socialize.android.ui.tyHandler
{
	...
	//    3    7:astore_2        
		((StringBuilder) (bundle)).append(val$params.getString("provider", "provider"));
	//    4    8:aload_2         
	//    5    9:aload_0         
	...
	//   18   35:astore_2        
		if(activity.getSupportFragmentManager().findFragmentByTag(((String) (bundle))) == null)
	//*  19   36:aload_1         
	...
	//*  23   44:ifnonnull       139
		{
			PostRequest postrequest = (PostRequest)getUrl(true, "gsapi://login_result", val$params.getString("endPoint", "socialize.login"), GSAPI.getInstance().getAPIDomain(), val$params, d.POST);
	//   24   47:aload_0         
	...
	//   40   84:astore_3        
			GigyaWebViewProvider.access$002(GigyaWebViewProvider.this, WebViewFragment.create(activity, ((String) (bundle)), val$params.getString("captionText", ""), postrequest, "gsapi://login_result", new com.gigya.socialize.android.ui.WebViewFragment.WebViewFragmentHandler() {
			...
			{
				this$1 = GigyaWebViewProvider._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
