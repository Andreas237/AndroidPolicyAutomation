...
//			GigyaProvider, PostRequest

public class GigyaWebViewProvider extends GigyaProvider
{

	public GigyaWebViewProvider()
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void GigyaProvider()>
		isTransparent = Boolean.valueOf(false);
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:invokestatic    #22  <Method Boolean Boolean.valueOf(boolean)>
	//    5    9:putfield        #24  <Field Boolean isTransparent>
	//    6   12:return          
	}
	...
	public void login(Activity activity, final GSObject params, final LoginProvider.ProviderCallback callback)
	{
		createActivity(new com.gigya.socialize.android.ui.HostActivity.HostActivityHandler() {
			...
			//   40   84:astore_3        
					webviewDialog = WebViewFragment.create(fragmentactivity, ((String) (bundle)), params.getString("captionText", ""), postrequest, "gsapi://login_result", ((_cls1) (fragmentactivity)). new com.gigya.socialize.android.ui.WebViewFragment.WebViewFragmentHandler() {
...
, isTransparent);
			...
			{
				this$0 = GigyaWebViewProvider.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	//    0    0:aload_0         
	//    1    1:new             #6   <Class GigyaWebViewProvider$1>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:aload_2         
	//    5    7:aload_3         
	//    6    8:invokespecial   #36  <Method void GigyaWebViewProvider$1(GigyaWebViewProvider, GSObject, LoginProvider$ProviderCallback)>
	//    7   11:invokevirtual   #40  <Method void createActivity(com.gigya.socialize.android.ui.HostActivity$HostActivityHandler)>
	//    8   14:return          
	}
...
/*
	static WebViewFragment access$000(GigyaWebViewProvider gigyawebviewprovider)
	{
		return gigyawebviewprovider.webviewDialog;
	//    0    0:aload_0         
	//    1    1:getfield        #29  <Field WebViewFragment webviewDialog>
	//    2    4:areturn         
	}
...
/*
	static WebViewFragment access$002(GigyaWebViewProvider gigyawebviewprovider, WebViewFragment webviewfragment)
	{
		gigyawebviewprovider.webviewDialog = webviewfragment;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #29  <Field WebViewFragment webviewDialog>
