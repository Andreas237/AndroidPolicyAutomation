	...
	implements ILogger
{
	...
	//    0    0:aload_1         
	//    1    1:aload_2         
	//    2    2:invokestatic    #35  <Method int Log.v(String, String)>
	//    3    5:pop             
	//    4    6:return          
	}
	...
	//    1    1:aload_2         
	//    2    2:aload_3         
	//    3    3:invokestatic    #37  <Method int Log.v(String, String, Throwable)>
	//    4    6:pop             
	//    5    7:return          
	}
	...
	//    0    0:aload_1         
	//    1    1:aload_2         
	//    2    2:invokestatic    #40  <Method int Log.w(String, String)>
	//    3    5:pop             
	//    4    6:return          
	}
	...
	//    1    1:aload_2         
	//    2    2:aload_3         
	//    3    3:invokestatic    #42  <Method int Log.w(String, String, Throwable)>
	//    4    6:pop             
	//    5    7:return          
	}
}
