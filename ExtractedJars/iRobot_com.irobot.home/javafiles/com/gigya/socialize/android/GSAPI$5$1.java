	...
	implements GSResponseListener
{
	...
	{
		val$selector.dismissProgressDialog();
	//    0    0:aload_0         
	...
	//*  24   54:ifnull          71
				val$uiListener.onClose(false, obj);
	//   25   57:aload_0         
	...
	//*  37   85:ifne            168
			{
				if(val$mode == uest.LoginRequestType.login)
	//*  38   88:aload_0         
	...
	//*  42   98:if_acmpne       128
					((GSLoginUIListener)val$uiListener).onLogin(val$provider, gsresponse.getData(), obj);
	//   43  101:aload_0         
	...
	//*  53  125:goto            187
				if(val$mode == uest.LoginRequestType.addConnection)
	//*  54  128:aload_0         
	...
	//*  58  138:if_acmpne       187
					((GSConnectUIListener)val$uiListener).onConnectionAdded(val$provider, gsresponse.getData(), obj);
	//   59  141:aload_0         
	...
	//*  70  168:iload           4
	//*  71  170:ifne            187
				val$uiListener.onError(gsresponse, obj);
	//   72  173:aload_0         
	...
	//   77  182:invokeinterface #90  <Method void GSUIListener.onError(GSResponse, Object)>
		val$selector.setDisableSelection(false);
	//   78  187:aload_0         
	...
	//    2    2:putfield        #21  <Field GSAPI$5 this$1>
		val$selector = providerselection;
	//    3    5:aload_0         
	//    4    6:aload_2         
	...
	// Unreferenced inner class com/gigya/socialize/android/GSAPI$5

/* anonymous class */
	class GSAPI._cls5
		implements com.gigya.socialize.android.login.ProviderSelection.ProviderSelectionHandler
	{
		...
		//   21   41:invokevirtual   #88  <Method void GSObject.put(String, String)>
			s = ((String) (((GSAPI._cls5._cls1) (s)). new GSAPI._cls5._cls1()));
		...
		//*  32   62:if_acmpne       84
			{
				addConnection(((android.app.Activity) (fragmentactivity)), params, ((GSResponseListener) (s)), context);
		//   33   65:aload_0         
		...
		//   43   83:return          
			...
			try
			{
				login(((android.app.Activity) (fragmentactivity)), params, ((GSResponseListener) (s)), context);
		//   44   84:aload_0         
		...
		//   79  155:astore_2        
			if(uiListener != null)
				uiListener.onError(new GSResponse(method, new GSObject(), 0x7a121, GSResponse.getErrorMessage(0x7a121), ((com.gigya.socialize.GSLogger) (null))), context);
