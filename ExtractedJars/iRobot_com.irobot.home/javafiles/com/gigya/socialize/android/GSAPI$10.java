...
//			GSAPI, GSPermissionResultHandler, GSAsyncRequest, GSSession
	...
	implements Runnable
{
	...
	public void run()
	{
		final GSObject params2;
		if(val$params == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #36  <Field GSObject val$params>
	//*   2    4:ifnonnull       18
			params2 = new GSObject();
	...
	//   10   22:astore_1        
		requestPermissionsIfNeeded(val$method, params2, new GSPermissionResultHandler() {
			...
			//  112  244:astore_2        
						params2.put("oauth_token", GSAPI.access$500(this$0).getSession().getToken());
			//  113  245:aload_0         
