...
class PluginPresentor$1
	implements ctivityHandler
{
	...
	{
		GSPluginFragment gspluginfragment = (GSPluginFragment)activity.getSupportFragmentManager().findFragmentByTag("PluginDialog");
	//    0    0:aload_1         
	...
	//*   9   16:ifnonnull       42
		{
			bundle = ((Bundle) (GSPluginFragment.newInstance(val$plugin, val$params, true)));
	//   10   19:aload_0         
	...
	//   16   31:astore_2        
			((GSPluginFragment) (bundle)).show(activity.getSupportFragmentManager(), "PluginDialog");
	//   17   32:aload_2         
	//   18   33:aload_1         
	...
	//   24   44:invokevirtual   #72  <Method void GSPluginFragment.setRetainInstance(boolean)>
		((GSPluginFragment) (bundle)).setPluginListener(val$pluginListener);
	//   25   47:aload_2         
	//   26   48:aload_0         
	...
	//   28   52:invokevirtual   #76  <Method void GSPluginFragment.setPluginListener(GSPluginListener)>
		((GSPluginFragment) (bundle)).setOnDismissListener(new GSDialogListener() {
			...
			{
				this$1 = PluginPresentor._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	//    8   12:putfield        #31  <Field GSObject val$params>
		val$pluginListener = gspluginlistener;
	//    9   15:aload_0         
	//   10   16:aload           4
	//   11   18:putfield        #33  <Field GSPluginListener val$pluginListener>
		val$dialogListener = GSDialogListener.this;
	//   12   21:aload_0         
	//   13   22:aload           5
