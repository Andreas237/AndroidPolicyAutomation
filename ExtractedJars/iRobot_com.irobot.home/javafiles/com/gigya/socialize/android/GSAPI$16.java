...
class GSAPI$16
	implements com.gigya.socialize.android.ui.ity.HostActivityHandler
{
	...
	//   20   42:astore_3        
		if(val$text == null || val$text.equals("")) goto _L2; else goto _L1
	//   21   43:aload_0         
	...
	//   28   59:ifne            104
_L1:
		fragmentactivity = ((FragmentActivity) (val$text));
	//   29   62:aload_0         
...
_L4:
	...
	//   40   82:pop             
			GSAPI.access$1200(GSAPI.this).setOnKeyListener(new android.content.DialogInterface.OnKeyListener() {
