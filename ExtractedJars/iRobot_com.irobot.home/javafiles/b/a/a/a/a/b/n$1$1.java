...
class n$1$1 extends h
{
	...
	public void onRun()
	{
		a.run();
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field Runnable a>
	...
	n$1$1(n._cls1 _pcls1, Runnable runnable)
	{
		b = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #17  <Field n$1 b>
		a = runnable;
	//    3    5:aload_0         
	//    4    6:aload_2         
	//    5    7:putfield        #19  <Field Runnable a>
		super();
	//    6   10:aload_0         
	//    7   11:invokespecial   #22  <Method void h()>
	//    8   14:return          
	}

	// Unreferenced inner class com/baidu/android/pushservice/f/n$1

/* anonymous class */
	static final class n._cls1 extends c
	{
		...
		//   52  100:invokestatic    #77  <Method void a.e(String, String)>
				...
				if(!com.baidu.android.pushservice.f.a.b.d(com.baidu.android.pushservice.f.n.b(a)))
		//*  53  103:aload_0         
