...
public class Configuration
{
	public static final class Builder
	{
		...
		public Builder jobSerializer(com.birbit.android.jobqueue.persistentQueue.sqlite.SqliteJobQueue.JobSerializer jobserializer)
		{
			configuration.queueFactory = ((QueueFactory) (new DefaultQueueFactory(jobserializer)));
		//    0    0:aload_0         
		//    1    1:getfield        #32  <Field Configuration configuration>
		...
		public Builder scheduler(Scheduler scheduler1)
		{
		...
		public Builder scheduler(Scheduler scheduler1, boolean flag)
		{
		...
		public Builder timer(Timer timer1)
		{
	...
	//    1    1:invokespecial   #53  <Method void Object()>
		id = "default_job_manager";
	//    2    4:aload_0         
	//    3    5:ldc1            #13  <String "default_job_manager">
	//    4    7:putfield        #55  <Field String id>
		maxConsumerCount = 5;
	//    5   10:aload_0         
	//    6   11:iconst_5        
	//    7   12:putfield        #57  <Field int maxConsumerCount>
		minConsumerCount = 0;
	//    8   15:aload_0         
	//    9   16:iconst_0        
	//   10   17:putfield        #59  <Field int minConsumerCount>
		consumerKeepAlive = 15;
	//   11   20:aload_0         
	//   12   21:bipush          15
	//   13   23:putfield        #61  <Field int consumerKeepAlive>
		loadFactor = 3;
	//   14   26:aload_0         
	//   15   27:iconst_3        
	//   16   28:putfield        #63  <Field int loadFactor>
		customLogger = ((CustomLogger) (new com.birbit.android.jobqueue.log.JqLog.ErrorLogger()));
	//   17   31:aload_0         
	//   18   32:new             #65  <Class com.birbit.android.jobqueue.log.JqLog$ErrorLogger>
	//   19   35:dup             
	//   20   36:invokespecial   #66  <Method void com.birbit.android.jobqueue.log.JqLog$ErrorLogger()>
	//   21   39:putfield        #68  <Field CustomLogger customLogger>
		inTestMode = false;
	//   22   42:aload_0         
	//   23   43:iconst_0        
	//   24   44:putfield        #70  <Field boolean inTestMode>
		resetDelaysOnRestart = false;
	//   25   47:aload_0         
	//   26   48:iconst_0        
	//   27   49:putfield        #72  <Field boolean resetDelaysOnRestart>
		threadPriority = 5;
	//   28   52:aload_0         
	//   29   53:iconst_5        
	//   30   54:putfield        #74  <Field int threadPriority>
		batchSchedulerRequests = true;
	//   31   57:aload_0         
	//   32   58:iconst_1        
	//   33   59:putfield        #76  <Field boolean batchSchedulerRequests>
		threadFactory = null;
	//   34   62:aload_0         
	//   35   63:aconst_null     
	//   36   64:putfield        #78  <Field ThreadFactory threadFactory>
	//   37   67:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #76  <Field boolean batchSchedulerRequests>
	//    2    4:ireturn         
	}
	...
	public Context getAppContext()
	{
		return appContext;
	//    0    0:aload_0         
	//    1    1:getfield        #87  <Field Context appContext>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #61  <Field int consumerKeepAlive>
	//    2    4:ireturn         
	}
	...
	public CustomLogger getCustomLogger()
	{
		return customLogger;
	//    0    0:aload_0         
	//    1    1:getfield        #68  <Field CustomLogger customLogger>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #97  <Field DependencyInjector dependencyInjector>
	//    2    4:areturn         
	}
	...
	public int getLoadFactor()
	{
		return loadFactor;
	//    0    0:aload_0         
	//    1    1:getfield        #63  <Field int loadFactor>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #57  <Field int maxConsumerCount>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #59  <Field int minConsumerCount>
	//    2    4:ireturn         
	}
	...
	public NetworkUtil getNetworkUtil()
	{
		return networkUtil;
	//    0    0:aload_0         
	//    1    1:getfield        #106 <Field NetworkUtil networkUtil>
	//    2    4:areturn         
	}
	...
	public QueueFactory getQueueFactory()
	{
		return queueFactory;
	//    0    0:aload_0         
	//    1    1:getfield        #110 <Field QueueFactory queueFactory>
	//    2    4:areturn         
	}
	...
	public Scheduler getScheduler()
	{
		return scheduler;
	//    0    0:aload_0         
	//    1    1:getfield        #114 <Field Scheduler scheduler>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #78  <Field ThreadFactory threadFactory>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #74  <Field int threadPriority>
	//    2    4:ireturn         
	}
	...
	public Timer getTimer()
	{
		return timer;
	//    0    0:aload_0         
	//    1    1:getfield        #121 <Field Timer timer>
	//    2    4:areturn         
	}
	...
	public boolean isInTestMode()
	{
		return inTestMode;
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field boolean inTestMode>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #72  <Field boolean resetDelaysOnRestart>
	//    2    4:ireturn         
	}
