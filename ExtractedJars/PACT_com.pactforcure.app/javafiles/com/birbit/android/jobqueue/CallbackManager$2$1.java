...
class CallbackManager$2$1 extends MessageQueueConsumer
{
...
_L5:
	...
	// Unreferenced inner class com/birbit/android/jobqueue/CallbackManager$2

/* anonymous class */
	class CallbackManager._cls2
		implements Runnable
	{

		public void run()
		{
			messageQueue.consume(((MessageQueueConsumer) (new CallbackManager._cls2._cls1())));
		//    0    0:aload_0         
