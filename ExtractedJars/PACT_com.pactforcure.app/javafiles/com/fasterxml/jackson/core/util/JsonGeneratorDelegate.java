...
public class JsonGeneratorDelegate extends JsonGenerator
{
	...
	//    3    5:aload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #158 <Method int JsonGenerator.writeBinary(Base64Variant, InputStream, int)>
	//    6   10:ireturn         
	}
	...
	//    4    6:iload_3         
	//    5    7:iload           4
	//    6    9:invokevirtual   #161 <Method void JsonGenerator.writeBinary(Base64Variant, byte[], int, int)>
	//    7   12:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #165 <Method void JsonGenerator.writeBoolean(boolean)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:invokevirtual   #168 <Method void JsonGenerator.writeEndArray()>
	//    3    7:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:invokevirtual   #171 <Method void JsonGenerator.writeEndObject()>
	//    3    7:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #175 <Method void JsonGenerator.writeFieldName(SerializableString)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #178 <Method void JsonGenerator.writeFieldName(String)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:invokevirtual   #181 <Method void JsonGenerator.writeNull()>
	//    3    7:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:dload_1         
	//    3    5:invokevirtual   #185 <Method void JsonGenerator.writeNumber(double)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:fload_1         
	//    3    5:invokevirtual   #188 <Method void JsonGenerator.writeNumber(float)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #191 <Method void JsonGenerator.writeNumber(int)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:lload_1         
	//    3    5:invokevirtual   #194 <Method void JsonGenerator.writeNumber(long)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #198 <Method void JsonGenerator.writeNumber(String)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #201 <Method void JsonGenerator.writeNumber(BigDecimal)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #204 <Method void JsonGenerator.writeNumber(BigInteger)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #207 <Method void JsonGenerator.writeNumber(short)>
	//    4    8:return          
	}
	...
	//    4    8:getfield        #19  <Field JsonGenerator _flddelegate>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #212 <Method void JsonGenerator.writeObject(Object)>
			return;
	//    7   15:return          
		}
		if(obj == null)
	...
	//*   9   17:ifnonnull       25
		{
			writeNull();
	//   10   20:aload_0         
	//   11   21:invokevirtual   #213 <Method void writeNull()>
			return;
	//   12   24:return          
		}
		if(getCodec() != null)
	//*  13   25:aload_0         
	//*  14   26:invokevirtual   #214 <Method ObjectCodec getCodec()>
	//*  15   29:ifnull          42
		{
			getCodec().writeValue(((JsonGenerator) (this)), obj);
	//   16   32:aload_0         
	//   17   33:invokevirtual   #214 <Method ObjectCodec getCodec()>
	//   18   36:aload_0         
	//   19   37:aload_1         
	//   20   38:invokevirtual   #220 <Method void ObjectCodec.writeValue(JsonGenerator, Object)>
			return;
	//   21   41:return          
		} else
		{
	...
	//   22   42:aload_0         
	//   23   43:aload_1         
	//   24   44:invokevirtual   #223 <Method void _writeSimpleObject(Object)>
			return;
	//   25   47:return          
		}
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #226 <Method void JsonGenerator.writeObjectId(Object)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #229 <Method void JsonGenerator.writeObjectRef(Object)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #232 <Method void JsonGenerator.writeOmittedField(String)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #236 <Method void JsonGenerator.writeRaw(char)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #238 <Method void JsonGenerator.writeRaw(SerializableString)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #240 <Method void JsonGenerator.writeRaw(String)>
	//    4    8:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #243 <Method void JsonGenerator.writeRaw(String, int, int)>
	//    6   10:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #246 <Method void JsonGenerator.writeRaw(char[], int, int)>
	//    6   10:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #250 <Method void JsonGenerator.writeRawUTF8String(byte[], int, int)>
	//    6   10:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #253 <Method void JsonGenerator.writeRawValue(String)>
	//    4    8:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #255 <Method void JsonGenerator.writeRawValue(String, int, int)>
	//    6   10:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #257 <Method void JsonGenerator.writeRawValue(char[], int, int)>
	//    6   10:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:invokevirtual   #260 <Method void JsonGenerator.writeStartArray()>
	//    3    7:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #262 <Method void JsonGenerator.writeStartArray(int)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:invokevirtual   #265 <Method void JsonGenerator.writeStartObject()>
	//    3    7:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #268 <Method void JsonGenerator.writeString(SerializableString)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #270 <Method void JsonGenerator.writeString(String)>
	//    4    8:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #272 <Method void JsonGenerator.writeString(char[], int, int)>
	//    6   10:return          
	}
	...
	//    4    8:getfield        #19  <Field JsonGenerator _flddelegate>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #276 <Method void JsonGenerator.writeTree(TreeNode)>
			return;
	//    7   15:return          
		}
		if(treenode == null)
	...
	//   16   32:new             #278 <Class IllegalStateException>
	//   17   35:dup             
	//   18   36:ldc2            #280 <String "No ObjectCodec defined">
	//   19   39:invokespecial   #282 <Method void IllegalStateException(String)>
	//   20   42:athrow          
		} else
		{
			getCodec().writeValue(((JsonGenerator) (this)), ((Object) (treenode)));
	//   21   43:aload_0         
	//   22   44:invokevirtual   #214 <Method ObjectCodec getCodec()>
	//   23   47:aload_0         
	//   24   48:aload_1         
	//   25   49:invokevirtual   #220 <Method void ObjectCodec.writeValue(JsonGenerator, Object)>
			return;
	//   26   52:return          
		}
	}
	...
	//    1    1:getfield        #19  <Field JsonGenerator _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #285 <Method void JsonGenerator.writeTypeId(Object)>
	//    4    8:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #288 <Method void JsonGenerator.writeUTF8String(byte[], int, int)>
	//    6   10:return          
	}
