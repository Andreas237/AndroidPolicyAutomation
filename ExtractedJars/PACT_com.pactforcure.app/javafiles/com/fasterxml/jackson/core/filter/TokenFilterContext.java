...
_L3:
	...
	//   37   75:invokevirtual   #57  <Method void JsonGenerator.writeStartObject()>
		if(!_needToHandleName) goto _L1; else goto _L4
	//   38   78:aload_0         
...
_L4:
	...
	//   47   95:invokevirtual   #54  <Method void JsonGenerator.writeFieldName(String)>
		return;
	//   48   98:return          
		if(_type != 1) goto _L1; else goto _L5
	//   49   99:aload_0         
...
_L5:
	...
	//*  31   60:aload_1         
	//*  32   61:bipush          125
	//*  33   63:invokevirtual   #75  <Method StringBuilder StringBuilder.append(char)>
	//*  34   66:pop             
	//*  35   67:return          
			{
				stringbuilder.append('?');
	//   36   68:aload_1         
	//   37   69:bipush          63
	//   38   71:invokevirtual   #75  <Method StringBuilder StringBuilder.append(char)>
	//   39   74:pop             
			}
			stringbuilder.append('}');
			return;
