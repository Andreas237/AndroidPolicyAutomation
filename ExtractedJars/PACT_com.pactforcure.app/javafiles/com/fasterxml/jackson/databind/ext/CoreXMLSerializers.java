...
public class CoreXMLSerializers extends com.fasterxml.jackson.databind.ser.Serializers.Base
{
		...
		implements ContextualSerializer
	{
		...
		//*  11   17:if_acmpeq       29
				serializerprovider = ((SerializerProvider) (new XMLGregorianCalendarSerializer(((JsonSerializer) (beanproperty)))));
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #11  <Method void com.fasterxml.jackson.databind.ser.Serializers$Base()>
	//    2    4:return          
	}
	...
	//    0    0:aload_2         
	//    1    1:invokevirtual   #20  <Method Class JavaType.getRawClass()>
	//    2    4:astore_1        
		if(((Class) (javax/xml/datatype/Duration)).isAssignableFrom(((Class) (serializationconfig))) || ((Class) (javax/xml/namespace/QName)).isAssignableFrom(((Class) (serializationconfig))))
	//*   3    5:ldc1            #22  <Class Duration>
	//*   4    7:aload_1         
	//*   5    8:invokevirtual   #28  <Method boolean Class.isAssignableFrom(Class)>
	//*   6   11:ifne            23
	//*   7   14:ldc1            #30  <Class QName>
	//*   8   16:aload_1         
	//*   9   17:invokevirtual   #28  <Method boolean Class.isAssignableFrom(Class)>
	//*  10   20:ifeq            27
			return ((JsonSerializer) (ToStringSerializer.instance));
	//   11   23:getstatic       #36  <Field ToStringSerializer ToStringSerializer.instance>
	//   12   26:areturn         
		if(((Class) (javax/xml/datatype/XMLGregorianCalendar)).isAssignableFrom(((Class) (serializationconfig))))
	//*  13   27:ldc1            #38  <Class XMLGregorianCalendar>
	//*  14   29:aload_1         
	//*  15   30:invokevirtual   #28  <Method boolean Class.isAssignableFrom(Class)>
	//*  16   33:ifeq            40
			return ((JsonSerializer) (XMLGregorianCalendarSerializer.instance));
	//   17   36:getstatic       #41  <Field CoreXMLSerializers$XMLGregorianCalendarSerializer CoreXMLSerializers$XMLGregorianCalendarSerializer.instance>
	//   18   39:areturn         
		else
			return null;
	//   19   40:aconst_null     
