...
public class UnresolvedForwardReference extends JsonMappingException
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #36  <Method void JsonMappingException(String)>
		_unresolvedIds = ((List) (new ArrayList()));
	//    3    5:aload_0         
	//    4    6:new             #20  <Class ArrayList>
	//    5    9:dup             
	//    6   10:invokespecial   #23  <Method void ArrayList()>
	//    7   13:putfield        #25  <Field List _unresolvedIds>
	//    8   16:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #41  <Method void JsonMappingException(String, JsonLocation)>
		_roid = readableobjectid;
	//    4    6:aload_0         
	//    5    7:aload_3         
	//    6    8:putfield        #32  <Field ReadableObjectId _roid>
	//    7   11:return          
	}
	...
	//    2    4:new             #45  <Class UnresolvedId>
	//    3    7:dup             
	//    4    8:aload_1         
	//    5    9:aload_2         
	//    6   10:aload_3         
	//    7   11:invokespecial   #47  <Method void UnresolvedId(Object, Class, JsonLocation)>
	//    8   14:invokeinterface #53  <Method boolean List.add(Object)>
	//    9   19:pop             
	//   10   20:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #59  <Method String JsonMappingException.getMessage()>
	//    2    4:astore_1        
	...
	//    8   14:new             #61  <Class StringBuilder>
	//    9   17:dup             
	//   10   18:aload_1         
	//   11   19:invokespecial   #62  <Method void StringBuilder(String)>
	//   12   22:astore_1        
		Iterator iterator = _unresolvedIds.iterator();
	//   13   23:aload_0         
	//   14   24:getfield        #25  <Field List _unresolvedIds>
	//   15   27:invokeinterface #66  <Method Iterator List.iterator()>
	//   16   32:astore_2        
		do
		{
			if(!iterator.hasNext())
				break;
	//   17   33:aload_2         
	//   18   34:invokeinterface #72  <Method boolean Iterator.hasNext()>
	//   19   39:ifeq            78
			((StringBuilder) (obj)).append(((UnresolvedId)iterator.next()).toString());
	//   20   42:aload_1         
	//   21   43:aload_2         
	//   22   44:invokeinterface #76  <Method Object Iterator.next()>
	//   23   49:checkcast       #45  <Class UnresolvedId>
	//   24   52:invokevirtual   #79  <Method String UnresolvedId.toString()>
	//   25   55:invokevirtual   #83  <Method StringBuilder StringBuilder.append(String)>
	//   26   58:pop             
			if(iterator.hasNext())
	//*  27   59:aload_2         
	//*  28   60:invokeinterface #72  <Method boolean Iterator.hasNext()>
	//*  29   65:ifeq            33
				((StringBuilder) (obj)).append(", ");
	//   30   68:aload_1         
	//   31   69:ldc1            #85  <String ", ">
	//   32   71:invokevirtual   #83  <Method StringBuilder StringBuilder.append(String)>
	//   33   74:pop             
		} while(true);
	//   34   75:goto            33
		((StringBuilder) (obj)).append('.');
	//   35   78:aload_1         
	//   36   79:bipush          46
	//   37   81:invokevirtual   #88  <Method StringBuilder StringBuilder.append(char)>
	//   38   84:pop             
		return ((StringBuilder) (obj)).toString();
	//   39   85:aload_1         
	//   40   86:invokevirtual   #89  <Method String StringBuilder.toString()>
	//   41   89:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #32  <Field ReadableObjectId _roid>
	//    2    4:invokevirtual   #98  <Method com.fasterxml.jackson.annotation.ObjectIdGenerator$IdKey ReadableObjectId.getKey()>
	//    3    7:getfield        #104 <Field Object com.fasterxml.jackson.annotation.ObjectIdGenerator$IdKey.key>
	//    4   10:areturn         
	}
