...
public class IgnoredPropertyException extends PropertyBindingException
{
	...
	public IgnoredPropertyException(JsonParser jsonparser, String s, JsonLocation jsonlocation, Class class1, String s1, Collection collection)
	{
	...
	//*  27   59:ldc1            #47  <String ") encountered; mapper configured not to allow this">
	...
	//*  33   73:aload_2         
	//*  34   74:aload_3         
	//*  35   75:invokespecial   #57  <Method void IgnoredPropertyException(JsonParser, String, JsonLocation, Class, String, Collection)>
	//*  36   78:astore_0        
	//*  37   79:aload_0         
	//*  38   80:aload_1         
	//*  39   81:aload_2         
	...
	//   45   91:astore          4
		jsonparser = ((JsonParser) (new IgnoredPropertyException(jsonparser, (new StringBuilder()).append("Ignored field \"").append(s).append("\" (class ").append(class1.getName()).append(") encountered; mapper configured not to allow this").toString(), jsonparser.getCurrentLocation(), class1, s, collection)));
		((IgnoredPropertyException) (jsonparser)).prependPath(obj, s);
		return ((IgnoredPropertyException) (jsonparser));
	//*  46   93:goto            25
	}
