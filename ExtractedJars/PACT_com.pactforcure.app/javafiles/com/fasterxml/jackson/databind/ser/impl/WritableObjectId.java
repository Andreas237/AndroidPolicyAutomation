...
public final class WritableObjectId
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field ObjectIdGenerator generator>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #29  <Method Object ObjectIdGenerator.generateId(Object)>
	//    4    8:astore_1        
		id = obj;
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:putfield        #31  <Field Object id>
		return obj;
	//    8   14:aload_1         
	//    9   15:areturn         
	}
	...
	//    6   12:aload_1         
	//    7   13:aload_0         
	//    8   14:getfield        #31  <Field Object id>
	...
	//   22   45:aload_0         
	//   23   46:getfield        #31  <Field Object id>
	//   24   49:aload_1         
	//   25   50:aload_2         
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #31  <Field Object id>
	//*   2    4:ifnull          57
	//*   3    7:aload_0         
	...
	//   12   28:aload_1         
	//   13   29:aload_0         
	//   14   30:getfield        #31  <Field Object id>
	...
	//*  18   40:ireturn         
				objectidwriter.serializer.serialize(id, jsongenerator, serializerprovider);
	//   19   41:aload_3         
	//   20   42:getfield        #65  <Field JsonSerializer ObjectIdWriter.serializer>
	//   21   45:aload_0         
	//   22   46:getfield        #31  <Field Object id>
	//   23   49:aload_1         
	//   24   50:aload_2         
	//   25   51:invokevirtual   #71  <Method void JsonSerializer.serialize(Object, JsonGenerator, SerializerProvider)>
			return true;
		} else
	//*  26   54:goto            39
		{
