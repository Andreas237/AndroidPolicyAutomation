...
public static class StdArraySerializers$FloatArraySerializer extends rializer
{
	...
	{
		return ((JsonSerializer) (new StdArraySerializers$FloatArraySerializer(this, beanproperty, _valueTypeSerializer, boolean1)));
	...
	{
		return ((ContainerSerializer) (new StdArraySerializers$FloatArraySerializer(this, _property, typeserializer, _unwrapSingle)));
	//    0    0:new             #2   <Class StdArraySerializers$FloatArraySerializer>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_0         
	...
	public StdArraySerializers$FloatArraySerializer(StdArraySerializers$FloatArraySerializer stdarrayserializers$floatarrayserializer, BeanProperty beanproperty, TypeSerializer typeserializer, Boolean boolean1)
	{
		super(((rializer) (stdarrayserializers$floatarrayserializer)), beanproperty, typeserializer, boolean1);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:aload_3         
