...
public static final class Notify$Method extends Enum
{

	public static Notify$Method valueOf(String s)
	{
		return (Notify$Method)Enum.valueOf(com/raizlabs/android/dbflow/annotation/provider/Notify$Method, s);
	...
	public static Notify$Method[] values()
	{
		return (Notify$Method[])((Notify$Method []) ($VALUES)).clone();
	...
	private static final Notify$Method $VALUES[];
	public static final Notify$Method DELETE;
	public static final Notify$Method INSERT;
	public static final Notify$Method UPDATE;

	static 
	{
		INSERT = new Notify$Method("INSERT", 0);
	...
	//    5   10:putstatic       #23  <Field Notify$Method INSERT>
		UPDATE = new Notify$Method("UPDATE", 1);
	...
	//   11   23:putstatic       #26  <Field Notify$Method UPDATE>
		DELETE = new Notify$Method("DELETE", 2);
	...
	//   17   36:putstatic       #29  <Field Notify$Method DELETE>
		$VALUES = (new Notify$Method[] {
			INSERT, UPDATE, DELETE
		});
	//   18   39:iconst_3        
	//   19   40:anewarray       Notify$Method[]
	//   20   43:dup             
	//   21   44:iconst_0        
	...
	private Notify$Method(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
