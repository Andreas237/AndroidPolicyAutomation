	...
	implements Report
{
	...
	//   13   17:aaload          
	//   14   18:astore          4
			Fabric.getLogger().d("CrashlyticsCore", (new StringBuilder()).append("Removing invalid report file at ").append(file.getPath()).toString());
	//   15   20:invokestatic    #64  <Method Logger Fabric.getLogger()>
	//   16   23:ldc1            #66  <String "CrashlyticsCore">
	//   17   25:new             #68  <Class StringBuilder>
	//   18   28:dup             
	//   19   29:invokespecial   #69  <Method void StringBuilder()>
	//   20   32:ldc1            #71  <String "Removing invalid report file at ">
	//   21   34:invokevirtual   #75  <Method StringBuilder StringBuilder.append(String)>
	//   22   37:aload           4
	//   23   39:invokevirtual   #78  <Method String File.getPath()>
	//   24   42:invokevirtual   #75  <Method StringBuilder StringBuilder.append(String)>
	//   25   45:invokevirtual   #81  <Method String StringBuilder.toString()>
	//   26   48:invokeinterface #87  <Method void Logger.d(String, String)>
			file.delete();
	//   27   53:aload           4
	//   28   55:invokevirtual   #91  <Method boolean File.delete()>
	//   29   58:pop             
		}
