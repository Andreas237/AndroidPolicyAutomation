	...
	implements Flushable
{
	...
	//    4   10:dup             
	//    5   11:invokespecial   #202 <Method void CodedOutputStream$OutOfSpaceException()>
	//    6   14:athrow          
		} else
		{
	...
	//   14   28:invokevirtual   #207 <Method void OutputStream.write(byte[], int, int)>
			position = 0;
	//   15   31:aload_0         
	//   16   32:iconst_0        
	...
	//    3    7:new             #214 <Class IllegalStateException>
	//    4   10:dup             
	//    5   11:ldc1            #216 <String "Did not write as much data as expected.">
	//    6   13:invokespecial   #219 <Method void IllegalStateException(String)>
	//    7   16:athrow          
		else
			return;
	//    8   17:return          
	...
	//*   4    6:aload_0         
	//*   5    7:iload_2         
	//*   6    8:invokevirtual   #241 <Method void writeRawByte(int)>
	//*   7   11:return          
			i = 0;
	//    8   12:iconst_0        
	//    9   13:istore_2        
	...
	//    4    6:aload_0         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #247 <Method void writeBytesNoTag(ByteString)>
	//    7   11:return          
	}
	...
	//    3    5:invokevirtual   #250 <Method void writeRawVarint32(int)>
		writeRawBytes(bytestring);
	//    4    8:aload_0         
	//    5    9:aload_1         
	//    6   10:invokevirtual   #253 <Method void writeRawBytes(ByteString)>
	//    7   13:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:dload_2         
	//    6    8:invokevirtual   #259 <Method void writeDoubleNoTag(double)>
	//    7   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:dload_1         
	//    2    2:invokestatic    #265 <Method long Double.doubleToRawLongBits(double)>
	//    3    5:invokevirtual   #269 <Method void writeRawLittleEndian64(long)>
	//    4    8:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #273 <Method void writeEnumNoTag(int)>
	//    7   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #276 <Method void writeInt32NoTag(int)>
	//    3    5:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #280 <Method void writeFixed32NoTag(int)>
	//    7   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #283 <Method void writeRawLittleEndian32(int)>
	//    3    5:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #288 <Method void writeFixed64NoTag(long)>
	//    7   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:invokevirtual   #269 <Method void writeRawLittleEndian64(long)>
	//    3    5:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:fload_2         
	//    6    8:invokevirtual   #294 <Method void writeFloatNoTag(float)>
	//    7   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:fload_1         
	//    2    2:invokestatic    #299 <Method int Float.floatToRawIntBits(float)>
	//    3    5:invokevirtual   #283 <Method void writeRawLittleEndian32(int)>
	//    4    8:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #276 <Method void writeInt32NoTag(int)>
	//    7   11:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:invokevirtual   #250 <Method void writeRawVarint32(int)>
			return;
	//    5    9:return          
		} else
		{
	...
	//    7   11:iload_1         
	//    8   12:i2l             
	//    9   13:invokevirtual   #303 <Method void writeRawVarint64(long)>
			return;
	//   10   16:return          
		}
	}
	...
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #307 <Method void writeInt64NoTag(long)>
	//    7   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:invokevirtual   #303 <Method void writeRawVarint64(long)>
	//    3    5:return          
	}
	...
	public void writeRawBytes(ByteString bytestring, int i, int j)
		throws IOException
	{
		if(limit - position < j) goto _L2; else goto _L1
	//    0    0:aload_0         
...
_L2:
	...
	//   26   46:isub            
	//   27   47:istore          5
		bytestring.copyTo(buffer, i, position, i1);
	//   28   49:aload_1         
	//   29   50:aload_0         
	...
	//   67  117:astore_1        
		if((long)k != ((InputStream) (bytestring)).skip(k))
	//*  68  118:iload           4
	//*  69  120:i2l             
	//*  70  121:aload_1         
	//*  71  122:iload           4
	//*  72  124:i2l             
	//*  73  125:invokevirtual   #326 <Method long InputStream.skip(long)>
	//*  74  128:lcmp            
	//*  75  129:ifeq            162
			throw new IllegalStateException("Skip failed.");
	//   76  132:new             #214 <Class IllegalStateException>
	//   77  135:dup             
	//   78  136:ldc2            #328 <String "Skip failed.">
	//   79  139:invokespecial   #219 <Method void IllegalStateException(String)>
	//   80  142:athrow          
		continue;
		while(i > 0) 
	//*  81  143:aload_0         
	//*  82  144:getfield        #29  <Field OutputStream output>
	//*  83  147:aload_0         
	//*  84  148:getfield        #31  <Field byte[] buffer>
	//*  85  151:iconst_0        
	//*  86  152:iload           4
	//*  87  154:invokevirtual   #207 <Method void OutputStream.write(byte[], int, int)>
	//*  88  157:iload_2         
	//*  89  158:iload           4
	//*  90  160:isub            
	//*  91  161:istore_2        
	...
	//   94  166:iload_2         
	//   95  167:aload_0         
	//   96  168:getfield        #35  <Field int limit>
	//   97  171:invokestatic    #333 <Method int Math.min(int, int)>
	//   98  174:istore_3        
			l = ((InputStream) (bytestring)).read(buffer, 0, j);
	//   99  175:aload_1         
	//  100  176:aload_0         
	//  101  177:getfield        #31  <Field byte[] buffer>
	//  102  180:iconst_0        
	//  103  181:iload_3         
	//  104  182:invokevirtual   #337 <Method int InputStream.read(byte[], int, int)>
	//  105  185:istore          4
			if(l != j)
	//* 106  187:iload           4
	//* 107  189:iload_3         
	...
	//  109  193:new             #214 <Class IllegalStateException>
	//  110  196:dup             
	//  111  197:ldc2            #339 <String "Read failed.">
	//  112  200:invokespecial   #219 <Method void IllegalStateException(String)>
	//  113  203:athrow          
...
_L5:
	...
	//   68  116:iload_2         
	//   69  117:iload_3         
	//   70  118:invokevirtual   #207 <Method void OutputStream.write(byte[], int, int)>
			return;
	//   71  121:return          
		}
	}
	...
	//    2    2:sipush          255
	//    3    5:iand            
	//    4    6:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//    9   14:sipush          255
	//   10   17:iand            
	//   11   18:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   16   26:sipush          255
	//   17   29:iand            
	//   18   30:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   23   38:sipush          255
	//   24   41:iand            
	//   25   42:invokevirtual   #241 <Method void writeRawByte(int)>
	//   26   45:return          
	}
	...
	//    3    3:sipush          255
	//    4    6:iand            
	//    5    7:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   11   16:sipush          255
	//   12   19:iand            
	//   13   20:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   19   29:sipush          255
	//   20   32:iand            
	//   21   33:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   27   42:sipush          255
	//   28   45:iand            
	//   29   46:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   35   55:sipush          255
	//   36   58:iand            
	//   37   59:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   43   68:sipush          255
	//   44   71:iand            
	//   45   72:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   51   81:sipush          255
	//   52   84:iand            
	//   53   85:invokevirtual   #241 <Method void writeRawByte(int)>
	...
	//   59   94:sipush          255
	//   60   97:iand            
	//   61   98:invokevirtual   #241 <Method void writeRawByte(int)>
	//   62  101:return          
	}
	...
	//    5    7:iconst_2        
	//    6    8:iload_1         
	//    7    9:invokevirtual   #352 <Method void writeUInt32(int, int)>
		writeBytes(3, bytestring);
	//    8   12:aload_0         
	//    9   13:iconst_3        
	//   10   14:aload_2         
	//   11   15:invokevirtual   #354 <Method void writeBytes(int, ByteString)>
		writeTag(1, 4);
	//   12   18:aload_0         
	//   13   19:iconst_1        
	//   14   20:iconst_4        
	...
	//    4    7:aload_0         
	//    5    8:iload_1         
	//    6    9:invokevirtual   #241 <Method void writeRawByte(int)>
				return;
	//    7   12:return          
			}
	...
	//   12   18:sipush          128
	//   13   21:ior             
	//   14   22:invokevirtual   #241 <Method void writeRawByte(int)>
			i >>>= 7;
	//   15   25:iload_1         
	//   16   26:bipush          7
	//   17   28:iushr           
	...
	//    7   11:lload_1         
	//    8   12:l2i             
	//    9   13:invokevirtual   #241 <Method void writeRawByte(int)>
				return;
	//   10   16:return          
			}
	...
	//   16   23:sipush          128
	//   17   26:ior             
	//   18   27:invokevirtual   #241 <Method void writeRawByte(int)>
			l >>>= 7;
	//   19   30:lload_1         
	//   20   31:bipush          7
	//   21   33:lushr           
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #358 <Method void writeSFixed32NoTag(int)>
	//    7   11:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #362 <Method void writeSFixed64NoTag(long)>
	//    7   11:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #366 <Method void writeSInt32NoTag(int)>
	//    7   11:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #370 <Method void writeSInt64NoTag(long)>
	//    7   11:return          
	}
	...
	//    3    5:invokevirtual   #303 <Method void writeRawVarint64(long)>
	//    4    8:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #375 <Method void writeStringNoTag(String)>
	//    7   11:return          
	}
	...
	//    5    8:aload_1         
	//    6    9:arraylength     
	//    7   10:invokevirtual   #250 <Method void writeRawVarint32(int)>
		writeRawBytes(((byte []) (s)));
	//    8   13:aload_0         
	//    9   14:aload_1         
	//   10   15:invokevirtual   #377 <Method void writeRawBytes(byte[])>
	//   11   18:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_2         
	//    6    8:invokevirtual   #380 <Method void writeUInt32NoTag(int)>
	//    7   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #250 <Method void writeRawVarint32(int)>
	//    3    5:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:lload_2         
	//    6    8:invokevirtual   #384 <Method void writeUInt64NoTag(long)>
	//    7   11:return          
	}
