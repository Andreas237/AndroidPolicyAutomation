...
final class ByteString
{
	...
	//*  16   36:aload_0         
	//*  17   37:invokeinterface #72  <Method Iterator List.iterator()>
	//*  18   42:astore_2        
	//*  19   43:aload_2         
	//*  20   44:invokeinterface #78  <Method boolean Iterator.hasNext()>
	//*  21   49:ifeq            70
			i += ((ByteString)iterator.next()).size();
	//   22   52:iload_1         
	//   23   53:aload_2         
	...
	//*  35   76:aload_0         
	//*  36   77:invokeinterface #72  <Method Iterator List.iterator()>
	//*  37   82:astore_0        
	//*  38   83:aload_0         
	//*  39   84:invokeinterface #78  <Method boolean Iterator.hasNext()>
	//*  40   89:ifeq            126
		{
			ByteString bytestring = (ByteString)((Iterator) (list)).next();
	//   41   92:aload_0         
	//   42   93:invokeinterface #82  <Method Object Iterator.next()>
	//   43   98:checkcast       #2   <Class ByteString>
	//   44  101:astore_3        
			System.arraycopy(((Object) (bytestring.bytes)), 0, ((Object) (abyte0)), i, bytestring.size());
	//   45  102:aload_3         
	...
	//   40   57:aload_0         
	//   41   58:iload_2         
	//   42   59:putfield        #31  <Field int hash>
		}
		return k;
	//   43   62:iload_2         
	//   44   63:ireturn         
