...
static class Chart$2
{
	...
	static 
	{
		$SwitchMap$android$graphics$Bitmap$CompressFormat = new int[android.graphics.ompressFormat.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$android$graphics$Bitmap$CompressFormat>
		try
		{
			$SwitchMap$android$graphics$Bitmap$CompressFormat[android.graphics.ompressFormat.PNG.ordinal()] = 1;
	...
	//   24   49:astore_0        
		try
		{
			$SwitchMap$android$graphics$Bitmap$CompressFormat[android.graphics.ompressFormat.WEBP.ordinal()] = 2;
		}
		catch(NoSuchFieldError nosuchfielderror1) { }
		try
		{
			$SwitchMap$android$graphics$Bitmap$CompressFormat[android.graphics.ompressFormat.JPEG.ordinal()] = 3;
		}
