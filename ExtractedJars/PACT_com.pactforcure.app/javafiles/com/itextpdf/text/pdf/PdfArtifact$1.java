...
static class PdfArtifact$1
{
	...
	static 
	{
		$SwitchMap$com$itextpdf$text$pdf$PdfArtifact$ArtifactType = new int[tifactType.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$com$itextpdf$text$pdf$PdfArtifact$ArtifactType>
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PdfArtifact$ArtifactType[tifactType.BACKGROUND.ordinal()] = 1;
	...
	//   31   64:astore_0        
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PdfArtifact$ArtifactType[tifactType.LAYOUT.ordinal()] = 2;
		}
		catch(NoSuchFieldError nosuchfielderror2) { }
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PdfArtifact$ArtifactType[tifactType.PAGE.ordinal()] = 3;
		}
		catch(NoSuchFieldError nosuchfielderror1) { }
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PdfArtifact$ArtifactType[tifactType.PAGINATION.ordinal()] = 4;
		}
