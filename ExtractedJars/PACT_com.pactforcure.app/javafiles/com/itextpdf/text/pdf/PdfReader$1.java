...
static class PdfReader$1
{
	...
	//   52  111:astore_0        
		...
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PRTokeniser$TokenType[TokenType.NUMBER.ordinal()] = 3;
		}
		catch(NoSuchFieldError nosuchfielderror4) { }
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PRTokeniser$TokenType[TokenType.STRING.ordinal()] = 4;
		}
		catch(NoSuchFieldError nosuchfielderror3) { }
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PRTokeniser$TokenType[TokenType.NAME.ordinal()] = 5;
		}
		catch(NoSuchFieldError nosuchfielderror2) { }
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PRTokeniser$TokenType[TokenType.REF.ordinal()] = 6;
		}
		catch(NoSuchFieldError nosuchfielderror1) { }
		try
		{
			$SwitchMap$com$itextpdf$text$pdf$PRTokeniser$TokenType[TokenType.ENDOFFILE.ordinal()] = 7;
		}
