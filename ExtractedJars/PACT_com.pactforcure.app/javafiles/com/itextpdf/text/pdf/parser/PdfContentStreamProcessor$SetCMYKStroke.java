...
private static class PdfContentStreamProcessor$SetCMYKStroke
	implements ContentOperator
{

	public void invoke(PdfContentStreamProcessor pdfcontentstreamprocessor, PdfLiteral pdfliteral, ArrayList arraylist)
	{
		pdfcontentstreamprocessor.gs().strokeColor = PdfContentStreamProcessor.access$5500(4, ((java.util.List) (arraylist)));
	//    0    0:aload_1         
	...
	private PdfContentStreamProcessor$SetCMYKStroke()
	{
	//    0    0:aload_0         
	...
	PdfContentStreamProcessor$SetCMYKStroke(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void PdfContentStreamProcessor$SetCMYKStroke()>
	//    2    4:return          
	}
}
