...
private class PdfContentStreamProcessor$SetLineCap
	implements ContentOperator
{
	...
	private PdfContentStreamProcessor$SetLineCap()
	{
	...
	PdfContentStreamProcessor$SetLineCap(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #22  <Method void PdfContentStreamProcessor$SetLineCap(PdfContentStreamProcessor)>
	//    3    5:return          
	}
}
