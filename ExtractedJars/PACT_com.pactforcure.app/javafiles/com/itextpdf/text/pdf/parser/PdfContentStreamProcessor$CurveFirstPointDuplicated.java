...
private static class PdfContentStreamProcessor$CurveFirstPointDuplicated
	implements ContentOperator
{
	...
	public void invoke(PdfContentStreamProcessor pdfcontentstreamprocessor, PdfLiteral pdfliteral, ArrayList arraylist)
		throws Exception
	{
		PdfContentStreamProcessor.access$6200(pdfcontentstreamprocessor, 4, Arrays.asList(((Object []) (new Float[] {
	...
	private PdfContentStreamProcessor$CurveFirstPointDuplicated()
	{
	//    0    0:aload_0         
	...
	PdfContentStreamProcessor$CurveFirstPointDuplicated(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void PdfContentStreamProcessor$CurveFirstPointDuplicated()>
	//    2    4:return          
	}
}
