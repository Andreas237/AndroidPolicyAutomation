...
private static class PdfContentStreamProcessor$MoveTo
	implements ContentOperator
{
	...
	public void invoke(PdfContentStreamProcessor pdfcontentstreamprocessor, PdfLiteral pdfliteral, ArrayList arraylist)
		throws Exception
	{
		PdfContentStreamProcessor.access$6200(pdfcontentstreamprocessor, 1, Arrays.asList(((Object []) (new Float[] {
	...
	private PdfContentStreamProcessor$MoveTo()
	{
	//    0    0:aload_0         
	...
	PdfContentStreamProcessor$MoveTo(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void PdfContentStreamProcessor$MoveTo()>
	//    2    4:return          
	}
}
