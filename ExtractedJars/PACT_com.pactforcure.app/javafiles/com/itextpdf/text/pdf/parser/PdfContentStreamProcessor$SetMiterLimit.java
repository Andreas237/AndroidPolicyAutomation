...
private class PdfContentStreamProcessor$SetMiterLimit
	implements ContentOperator
{
	...
	private PdfContentStreamProcessor$SetMiterLimit()
	{
	...
	PdfContentStreamProcessor$SetMiterLimit(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #22  <Method void PdfContentStreamProcessor$SetMiterLimit(PdfContentStreamProcessor)>
	//    3    5:return          
	}
}
