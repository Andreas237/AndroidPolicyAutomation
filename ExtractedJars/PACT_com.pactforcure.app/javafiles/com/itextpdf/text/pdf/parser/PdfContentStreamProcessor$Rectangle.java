...
private static class PdfContentStreamProcessor$Rectangle
	implements ContentOperator
{
	...
	public void invoke(PdfContentStreamProcessor pdfcontentstreamprocessor, PdfLiteral pdfliteral, ArrayList arraylist)
		throws Exception
	{
		PdfContentStreamProcessor.access$6200(pdfcontentstreamprocessor, 7, Arrays.asList(((Object []) (new Float[] {
	...
	//   39   74:aastore         
	//   40   75:invokestatic    #44  <Method java.util.List Arrays.asList(Object[])>
	//   41   78:invokestatic    #48  <Method void PdfContentStreamProcessor.access$6200(PdfContentStreamProcessor, int, java.util.List)>
	//   42   81:return          
	}

	private PdfContentStreamProcessor$Rectangle()
	{
	//    0    0:aload_0         
	...
	PdfContentStreamProcessor$Rectangle(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void PdfContentStreamProcessor$Rectangle()>
	//    2    4:return          
	}
}
