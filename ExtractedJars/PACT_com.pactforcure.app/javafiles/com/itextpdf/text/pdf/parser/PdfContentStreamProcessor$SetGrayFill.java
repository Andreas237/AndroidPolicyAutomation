...
private static class PdfContentStreamProcessor$SetGrayFill
	implements ContentOperator
{

	public void invoke(PdfContentStreamProcessor pdfcontentstreamprocessor, PdfLiteral pdfliteral, ArrayList arraylist)
	{
		pdfcontentstreamprocessor.gs().fillColor = PdfContentStreamProcessor.access$5500(1, ((java.util.List) (arraylist)));
	//    0    0:aload_1         
	...
	private PdfContentStreamProcessor$SetGrayFill()
	{
	//    0    0:aload_0         
	...
	PdfContentStreamProcessor$SetGrayFill(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void PdfContentStreamProcessor$SetGrayFill()>
	//    2    4:return          
	}
}
