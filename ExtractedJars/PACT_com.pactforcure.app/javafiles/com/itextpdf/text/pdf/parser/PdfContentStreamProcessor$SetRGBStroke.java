...
private static class PdfContentStreamProcessor$SetRGBStroke
	implements ContentOperator
{

	public void invoke(PdfContentStreamProcessor pdfcontentstreamprocessor, PdfLiteral pdfliteral, ArrayList arraylist)
	{
		pdfcontentstreamprocessor.gs().strokeColor = PdfContentStreamProcessor.access$5500(3, ((java.util.List) (arraylist)));
	//    0    0:aload_1         
	...
	private PdfContentStreamProcessor$SetRGBStroke()
	{
	//    0    0:aload_0         
	...
	PdfContentStreamProcessor$SetRGBStroke(PdfContentStreamProcessor._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void PdfContentStreamProcessor$SetRGBStroke()>
	//    2    4:return          
	}
}
