...
public static final class PdfArtifact$ArtifactType extends Enum
{

	public static PdfArtifact$ArtifactType valueOf(String s)
	{
		return (PdfArtifact$ArtifactType)Enum.valueOf(com/itextpdf/text/pdf/PdfArtifact$ArtifactType, s);
	...
	public static PdfArtifact$ArtifactType[] values()
	{
		return (PdfArtifact$ArtifactType[])((PdfArtifact$ArtifactType []) ($VALUES)).clone();
	...
	private static final PdfArtifact$ArtifactType $VALUES[];
	public static final PdfArtifact$ArtifactType BACKGROUND;
	public static final PdfArtifact$ArtifactType LAYOUT;
	public static final PdfArtifact$ArtifactType PAGE;
	public static final PdfArtifact$ArtifactType PAGINATION;

	static 
	{
		PAGINATION = new PdfArtifact$ArtifactType("PAGINATION", 0);
	...
	//    5   10:putstatic       #24  <Field PdfArtifact$ArtifactType PAGINATION>
		LAYOUT = new PdfArtifact$ArtifactType("LAYOUT", 1);
	...
	//   11   23:putstatic       #27  <Field PdfArtifact$ArtifactType LAYOUT>
		PAGE = new PdfArtifact$ArtifactType("PAGE", 2);
	...
	//   17   36:putstatic       #30  <Field PdfArtifact$ArtifactType PAGE>
		BACKGROUND = new PdfArtifact$ArtifactType("BACKGROUND", 3);
	...
	//   23   49:putstatic       #33  <Field PdfArtifact$ArtifactType BACKGROUND>
		$VALUES = (new PdfArtifact$ArtifactType[] {
			PAGINATION, LAYOUT, PAGE, BACKGROUND
		});
	//   24   52:iconst_4        
	//   25   53:anewarray       PdfArtifact$ArtifactType[]
	//   26   56:dup             
	//   27   57:iconst_0        
	...
	private PdfArtifact$ArtifactType(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
