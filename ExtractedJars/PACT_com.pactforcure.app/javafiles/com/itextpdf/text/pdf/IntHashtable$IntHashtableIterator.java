	...
	implements Iterator
{
	...
	//*  14   22:ifle            46
			{
				IntHashtable.Entry entry1 = table[index];
	//   15   25:aload_0         
	...
	//*  26   46:ifnull          64
		{
			IntHashtable.Entry entry2 = entry;
	//   27   49:aload_0         
	...
	IntHashtable$IntHashtableIterator(IntHashtable.Entry aentry[])
	{
	//    0    0:aload_0         
