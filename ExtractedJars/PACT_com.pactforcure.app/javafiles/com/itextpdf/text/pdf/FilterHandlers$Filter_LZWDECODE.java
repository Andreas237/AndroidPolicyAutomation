...
private static class FilterHandlers$Filter_LZWDECODE
	implements FilterHandlers.FilterHandler
{
	...
	private FilterHandlers$Filter_LZWDECODE()
	{
	//    0    0:aload_0         
	...
	FilterHandlers$Filter_LZWDECODE(FilterHandlers._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void FilterHandlers$Filter_LZWDECODE()>
	//    2    4:return          
	}
}
