...
public class NoCustomContextException extends Exception
{
	...
	public NoCustomContextException(String s)
	{
		super(s);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public NoCustomContextException(String s, Throwable throwable)
	{
		super(s, throwable);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public NoCustomContextException(Throwable throwable)
	{
		super(throwable);
	//    0    0:aload_0         
	//    1    1:aload_1         
