...
public class zzabb extends zzzw
{
	...
	private zzabb(zzaax zzaax1)
	{
		super(zzaax1);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #11  <Method void zzzw(zzaax)>
	...
	//    7   13:putfield        #18  <Field TaskCompletionSource zzayo>
		zzaBs.zza("GmsAvailabilityHelper", ((zzaaw) (this)));
	//    8   16:aload_0         
	//    9   17:getfield        #22  <Field zzaax zzaBs>
	//   10   20:ldc1            #24  <String "GmsAvailabilityHelper">
	//   11   22:aload_0         
	//   12   23:invokeinterface #30  <Method void zzaax.zza(String, zzaaw)>
	//   13   28:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #37  <Method zzaax zzs(Activity)>
	//    2    4:astore_0        
		zzabb zzabb1 = (zzabb)((zzaax) (activity)).zza("GmsAvailabilityHelper", com/google/android/gms/internal/zzabb);
	//    3    5:aload_0         
	//    4    6:ldc1            #24  <String "GmsAvailabilityHelper">
	//    5    8:ldc1            #2   <Class zzabb>
	//    6   10:invokeinterface #40  <Method zzaaw zzaax.zza(String, Class)>
	//    7   15:checkcast       #2   <Class zzabb>
	//    8   18:astore_1        
		if(zzabb1 != null)
	//*   9   19:aload_1         
	//*  10   20:ifnull          49
		{
			if(zzabb1.zzayo.getTask().isComplete())
	//*  11   23:aload_1         
	//*  12   24:getfield        #18  <Field TaskCompletionSource zzayo>
	//*  13   27:invokevirtual   #44  <Method Task TaskCompletionSource.getTask()>
	//*  14   30:invokevirtual   #50  <Method boolean Task.isComplete()>
	//*  15   33:ifeq            47
				zzabb1.zzayo = new TaskCompletionSource();
	//   16   36:aload_1         
	//   17   37:new             #13  <Class TaskCompletionSource>
	//   18   40:dup             
	//   19   41:invokespecial   #16  <Method void TaskCompletionSource()>
	//   20   44:putfield        #18  <Field TaskCompletionSource zzayo>
			return zzabb1;
	//   21   47:aload_1         
	//   22   48:areturn         
		} else
		{
			return new zzabb(((zzaax) (activity)));
	//   23   49:new             #2   <Class zzabb>
	//   24   52:dup             
	//   25   53:aload_0         
	//   26   54:invokespecial   #51  <Method void zzabb(zzaax)>
	//   27   57:areturn         
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field TaskCompletionSource zzayo>
	...
	public void onDestroy()
	{
		super.onDestroy();
	//    0    0:aload_0         
	//    1    1:invokespecial   #56  <Method void zzzw.onDestroy()>
		zzayo.setException(((Exception) (new CancellationException("Host activity was destroyed before Google Play services could be made available."))));
	//    2    4:aload_0         
	//    3    5:getfield        #18  <Field TaskCompletionSource zzayo>
	...
	{
		zzayo.setException(((Exception) (zzb.zzl(connectionresult))));
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field TaskCompletionSource zzayo>
	//    2    4:aload_1         
	...
	protected void zzuW()
	{
		int i = zzaxX.isGooglePlayServicesAvailable(((android.content.Context) (zzaBs.zzwo())));
	//    0    0:aload_0         
	//    1    1:getfield        #84  <Field GoogleApiAvailability zzaxX>
	//    2    4:aload_0         
	//    3    5:getfield        #22  <Field zzaax zzaBs>
	//    4    8:invokeinterface #88  <Method Activity zzaax.zzwo()>
	...
	//*   8   18:ifne            30
		{
			zzayo.setResult(((Object) (null)));
	//    9   21:aload_0         
	//   10   22:getfield        #18  <Field TaskCompletionSource zzayo>
	//   11   25:aconst_null     
	...
	private TaskCompletionSource zzayo;
}
