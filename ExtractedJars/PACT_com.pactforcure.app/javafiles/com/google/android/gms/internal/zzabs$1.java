...
final class zzabs$1 extends zzabs
{

	protected Object zzdd(String s)
	{
		return ((Object) (zzde(s)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	protected Boolean zzde(String s)
	{
		s = zzAH;
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field String zzAH>
	//    2    4:astore_1        
		s = ((String) ((Boolean)zzAI));
	//    3    5:aload_0         
	...
	zzabs$1(String s, Boolean boolean1)
	{
		super(s, ((Object) (boolean1)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
