	...
	implements android.os.Parcelable.Creator
{
	...
	static void zza(zzaxz zzaxz1, Parcel parcel, int i)
	{
		int j = zzc.zzaV(parcel);
	//    0    0:aload_1         
	//    1    1:invokestatic    #20  <Method int zzc.zzaV(Parcel)>
	//    2    4:istore_3        
		zzc.zzc(parcel, 1, zzaxz1.mVersionCode);
	//    3    5:aload_1         
	//    4    6:iconst_1        
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field int zzaxz.mVersionCode>
	//    7   11:invokestatic    #30  <Method void zzc.zzc(Parcel, int, int)>
		zzc.zza(parcel, 2, ((android.os.Parcelable) (zzaxz1.zzOo())), i, false);
	//    8   14:aload_1         
	//    9   15:iconst_2        
	//   10   16:aload_0         
	//   11   17:invokevirtual   #34  <Method zzad zzaxz.zzOo()>
	//   12   20:iload_2         
	//   13   21:iconst_0        
	...
	{
		return ((Object) (zziR(parcel)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #47  <Method zzaxz zziR(Parcel)>
	//    3    5:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #53  <Method zzaxz[] zzmM(int)>
	//    3    5:areturn         
	}
	...
	//   50  125:athrow          
				...
				return new zzaxz(i, zzad1);
	//   51  126:new             #22  <Class zzaxz>
	//   52  129:dup             
	//   53  130:iload_2         
	//   54  131:aload           5
	//   55  133:invokespecial   #113 <Method void zzaxz(int, zzad)>
	//   56  136:areturn         
		while(true);
	}
