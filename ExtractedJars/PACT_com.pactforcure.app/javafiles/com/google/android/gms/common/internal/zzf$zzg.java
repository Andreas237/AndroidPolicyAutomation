...
public static final class zzf$zzg extends zzu$zza
{
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:putfield        #19  <Field zzf zzaDX>
	//    3    5:return          
	}

	public void zza(int i, IBinder ibinder, Bundle bundle)
	{
		zzac.zzb(((Object) (zzaDX)), "onPostInitComplete can be called only once per call to getRemoteService");
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field zzf zzaDX>
	...
	//    4    9:pop             
		zzaDX.zza(i, ibinder, bundle, zzaDY);
	//    5   10:aload_0         
	//    6   11:getfield        #19  <Field zzf zzaDX>
	//    7   14:iload_1         
	//    8   15:aload_2         
	//    9   16:aload_3         
	//   10   17:aload_0         
	//   11   18:getfield        #21  <Field int zzaDY>
	//   12   21:invokevirtual   #39  <Method void zzf.zza(int, IBinder, Bundle, int)>
		zzxc();
	//   13   24:aload_0         
	//   14   25:invokespecial   #41  <Method void zzxc()>
	//   15   28:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #19  <Field zzf zzaDX>
		zzaDY = i;
	//    5    9:aload_0         
	//    6   10:iload_2         
	//    7   11:putfield        #21  <Field int zzaDY>
	//    8   14:return          
	}
}
