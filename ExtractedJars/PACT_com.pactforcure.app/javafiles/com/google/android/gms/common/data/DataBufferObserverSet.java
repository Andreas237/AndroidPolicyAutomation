	...
	implements DataBufferObserver, DataBufferObserver.Observable
{
	...
	//    6   12:putfield        #20  <Field HashSet zzaCl>
	//    7   15:return          
	}

	public void addObserver(DataBufferObserver databufferobserver)
	{
		zzaCl.add(((Object) (databufferobserver)));
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field HashSet zzaCl>
	//    2    4:aload_1         
	...
	{
		for(Iterator iterator = zzaCl.iterator(); iterator.hasNext(); ((DataBufferObserver)iterator.next()).onDataChanged());
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field HashSet zzaCl>
	...
	{
		for(Iterator iterator = zzaCl.iterator(); iterator.hasNext(); ((DataBufferObserver)iterator.next()).onDataRangeChanged(i, j));
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field HashSet zzaCl>
	//    2    4:invokevirtual   #40  <Method Iterator HashSet.iterator()>
	//    3    7:astore_3        
	...
	{
		for(Iterator iterator = zzaCl.iterator(); iterator.hasNext(); ((DataBufferObserver)iterator.next()).onDataRangeInserted(i, j));
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field HashSet zzaCl>
	//    2    4:invokevirtual   #40  <Method Iterator HashSet.iterator()>
	//    3    7:astore_3        
	...
	{
		for(Iterator iterator = zzaCl.iterator(); iterator.hasNext(); ((DataBufferObserver)iterator.next()).onDataRangeMoved(i, j, k));
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field HashSet zzaCl>
	//    2    4:invokevirtual   #40  <Method Iterator HashSet.iterator()>
	//    3    7:astore          4
	...
	{
		for(Iterator iterator = zzaCl.iterator(); iterator.hasNext(); ((DataBufferObserver)iterator.next()).onDataRangeRemoved(i, j));
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field HashSet zzaCl>
	//    2    4:invokevirtual   #40  <Method Iterator HashSet.iterator()>
	//    3    7:astore_3        
	...
	{
		zzaCl.remove(((Object) (databufferobserver)));
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field HashSet zzaCl>
	//    2    4:aload_1         
