...
public final class WebImage extends zza
{
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:putfield        #27  <Field int mVersionCode>
		zzarW = uri;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #29  <Field Uri zzarW>
		zzrG = j;
	//    8   14:aload_0         
	//    9   15:iload_3         
	//   10   16:putfield        #31  <Field int zzrG>
		zzrH = k;
	//   11   19:aload_0         
	//   12   20:iload           4
	//   13   22:putfield        #33  <Field int zzrH>
	//   14   25:return          
	}
	...
	//   14   24:astore_1        
			if(!zzaa.equal(((Object) (zzarW)), ((Object) (((WebImage) (obj)).zzarW))) || zzrG != ((WebImage) (obj)).zzrG || zzrH != ((WebImage) (obj)).zzrH)
	//*  15   25:aload_0         
	//*  16   26:getfield        #29  <Field Uri zzarW>
	//*  17   29:aload_1         
	//*  18   30:getfield        #29  <Field Uri zzarW>
	//*  19   33:invokestatic    #90  <Method boolean zzaa.equal(Object, Object)>
	//*  20   36:ifeq            61
	//*  21   39:aload_0         
	//*  22   40:getfield        #31  <Field int zzrG>
	//*  23   43:aload_1         
	//*  24   44:getfield        #31  <Field int zzrG>
	//*  25   47:icmpne          61
	//*  26   50:aload_0         
	//*  27   51:getfield        #33  <Field int zzrH>
	//*  28   54:aload_1         
	//*  29   55:getfield        #33  <Field int zzrH>
	//*  30   58:icmpeq          5
				return false;
	//   31   61:iconst_0        
	//   32   62:ireturn         
	...
	public int getHeight()
	{
		return zzrH;
	//    0    0:aload_0         
	//    1    1:getfield        #33  <Field int zzrH>
	//    2    4:ireturn         
	}
	...
	public Uri getUrl()
	{
		return zzarW;
	//    0    0:aload_0         
	//    1    1:getfield        #29  <Field Uri zzarW>
	//    2    4:areturn         
	}
	...
	public int getWidth()
	{
		return zzrG;
	//    0    0:aload_0         
	//    1    1:getfield        #31  <Field int zzrG>
	//    2    4:ireturn         
	}
	...
	public int hashCode()
	{
		return zzaa.hashCode(new Object[] {
			zzarW, Integer.valueOf(zzrG), Integer.valueOf(zzrH)
		});
	//    0    0:iconst_3        
	...
	//    3    5:iconst_0        
	//    4    6:aload_0         
	//    5    7:getfield        #29  <Field Uri zzarW>
	//    6   10:aastore         
	//    7   11:dup             
	//    8   12:iconst_1        
	//    9   13:aload_0         
	//   10   14:getfield        #31  <Field int zzrG>
	//   11   17:invokestatic    #104 <Method Integer Integer.valueOf(int)>
	//   12   20:aastore         
	//   13   21:dup             
	//   14   22:iconst_2        
	//   15   23:aload_0         
	//   16   24:getfield        #33  <Field int zzrH>
	...
	public String toString()
	{
		return String.format(Locale.US, "Image %dx%d %s", new Object[] {
			Integer.valueOf(zzrG), Integer.valueOf(zzrH), zzarW.toString()
		});
