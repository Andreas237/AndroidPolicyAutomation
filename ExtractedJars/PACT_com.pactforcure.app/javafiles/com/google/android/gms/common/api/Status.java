	...
	implements Result, ReflectedParcelable
{
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:putfield        #60  <Field int mVersionCode>
		zzauz = j;
	//    5    9:aload_0         
	//    6   10:iload_2         
	//    7   11:putfield        #62  <Field int zzauz>
		zzawY = s;
	//    8   14:aload_0         
	//    9   15:aload_3         
	//   10   16:putfield        #64  <Field String zzawY>
	...
	//*   7   13:astore_1        
			if(mVersionCode == ((Status) (obj = ((Object) ((Status)obj)))).mVersionCode && zzauz == ((Status) (obj)).zzauz && zzaa.equal(((Object) (zzawY)), ((Object) (((Status) (obj)).zzawY))) && zzaa.equal(((Object) (mPendingIntent)), ((Object) (((Status) (obj)).mPendingIntent))))
	//*   8   14:aload_0         
	//*   9   15:getfield        #60  <Field int mVersionCode>
	//*  10   18:aload_1         
	//*  11   19:getfield        #60  <Field int mVersionCode>
	//*  12   22:icmpne          7
	//*  13   25:aload_0         
	//*  14   26:getfield        #62  <Field int zzauz>
	//*  15   29:aload_1         
	//*  16   30:getfield        #62  <Field int zzauz>
	//*  17   33:icmpne          7
	//*  18   36:aload_0         
	//*  19   37:getfield        #64  <Field String zzawY>
	//*  20   40:aload_1         
	//*  21   41:getfield        #64  <Field String zzawY>
	...
	public int getStatusCode()
	{
		return zzauz;
	//    0    0:aload_0         
	//    1    1:getfield        #62  <Field int zzauz>
	//    2    4:ireturn         
	}
	...
	public String getStatusMessage()
	{
		return zzawY;
	//    0    0:aload_0         
	//    1    1:getfield        #64  <Field String zzawY>
	//    2    4:areturn         
	}
	...
	public int hashCode()
	{
		return zzaa.hashCode(new Object[] {
			Integer.valueOf(mVersionCode), Integer.valueOf(zzauz), zzawY, mPendingIntent
		});
	//    0    0:iconst_4        
	...
	{
		return zzaa.zzv(((Object) (this))).zzg("statusCode", ((Object) (zzuU()))).zzg("resolution", ((Object) (mPendingIntent))).toString();
	//    0    0:aload_0         
	...
	//    3    6:aload_0         
	//    4    7:invokevirtual   #133 <Method String zzuU()>
	...
	//*   2    4:ifnull          12
			return zzawY;
	//    3    7:aload_0         
	//    4    8:getfield        #64  <Field String zzawY>
	//    5   11:areturn         
		else
			return CommonStatusCodes.getStatusCodeString(zzauz);
	//    6   12:aload_0         
	//    7   13:getfield        #62  <Field int zzauz>
