...
{
	private static final class zza extends zzzx
	{
	...
	private static final class zzb extends zzzx
	{
	...
	private static final class zzc extends zzzx
	{
	...
	{
		zzabl zzabl1 = new zzabl(Looper.getMainLooper());
	//    0    0:new             #22  <Class zzabl>
	//    1    3:dup             
	//    2    4:invokestatic    #28  <Method Looper Looper.getMainLooper()>
	//    3    7:invokespecial   #31  <Method void zzabl(Looper)>
	//    4   10:astore_0        
		zzabl1.cancel();
	//    5   11:aload_0         
	//    6   12:invokevirtual   #34  <Method void zzabl.cancel()>
	...
	//*  11   23:iload_1         
	//*  12   24:ldc1            #58  <String "Status code must be CommonStatusCodes.CANCELED">
	//*  13   26:invokestatic    #61  <Method void zzac.zzb(boolean, Object)>
	//*  14   29:new             #6   <Class PendingResults$zza>
	//*  15   32:dup             
	//*  16   33:aload_0         
	//*  17   34:invokespecial   #64  <Method void PendingResults$zza(Result)>
	//*  18   37:astore_0        
	//*  19   38:aload_0         
	//*  20   39:invokevirtual   #65  <Method void PendingResults$zza.cancel()>
	//*  21   42:aload_0         
	//*  22   43:areturn         
			flag = false;
	//   23   44:iconst_0        
	...
	//   11   18:invokevirtual   #73  <Method void PendingResults$zzc.zzb(Result)>
		return ((OptionalPendingResult) (new zzabc(((PendingResult) (zzc1)))));
	//   12   21:new             #75  <Class zzabc>
	//   13   24:dup             
	//   14   25:aload_1         
	//   15   26:invokespecial   #78  <Method void zzabc(PendingResult)>
	//   16   29:areturn         
	}
	...
	//    3    6:pop             
		zzabl zzabl1 = new zzabl(Looper.getMainLooper());
	//    4    7:new             #22  <Class zzabl>
	//    5   10:dup             
	//    6   11:invokestatic    #28  <Method Looper Looper.getMainLooper()>
	//    7   14:invokespecial   #31  <Method void zzabl(Looper)>
	//    8   17:astore_1        
		zzabl1.zzb(((Result) (status)));
	//    9   18:aload_1         
	//   10   19:aload_0         
	//   11   20:invokevirtual   #81  <Method void zzabl.zzb(Result)>
		return ((PendingResult) (zzabl1));
	//   12   23:aload_1         
	//   13   24:areturn         
	}
	...
	//*  10   21:iload_2         
	//*  11   22:ldc1            #89  <String "Status code must not be SUCCESS">
	//*  12   24:invokestatic    #61  <Method void zzac.zzb(boolean, Object)>
	//*  13   27:new             #9   <Class PendingResults$zzb>
	//*  14   30:dup             
	//*  15   31:aload_1         
	//*  16   32:aload_0         
	//*  17   33:invokespecial   #92  <Method void PendingResults$zzb(GoogleApiClient, Result)>
	//*  18   36:astore_1        
	//*  19   37:aload_1         
	//*  20   38:aload_0         
	//*  21   39:invokevirtual   #93  <Method void PendingResults$zzb.zzb(Result)>
	//*  22   42:aload_1         
	//*  23   43:areturn         
			flag = false;
	//   24   44:iconst_0        
	...
	//    2    3:invokestatic    #44  <Method Object zzac.zzb(Object, Object)>
	//    3    6:pop             
		googleapiclient = ((GoogleApiClient) (new zzabl(googleapiclient)));
	//    4    7:new             #22  <Class zzabl>
	//    5   10:dup             
	//    6   11:aload_1         
	//    7   12:invokespecial   #96  <Method void zzabl(GoogleApiClient)>
	//    8   15:astore_1        
		((zzabl) (googleapiclient)).zzb(((Result) (status)));
	//    9   16:aload_1         
	//   10   17:aload_0         
	//   11   18:invokevirtual   #81  <Method void zzabl.zzb(Result)>
		return ((PendingResult) (googleapiclient));
	//   12   21:aload_1         
	//   13   22:areturn         
	}
	...
	//   10   17:aload_0         
	//   11   18:invokevirtual   #73  <Method void PendingResults$zzc.zzb(Result)>
		return ((OptionalPendingResult) (new zzabc(((PendingResult) (googleapiclient)))));
	//   12   21:new             #75  <Class zzabc>
	//   13   24:dup             
	//   14   25:aload_1         
	//   15   26:invokespecial   #78  <Method void zzabc(PendingResult)>
