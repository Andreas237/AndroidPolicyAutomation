...
public class FlagProviderImpl extends com.google.android.gms.internal.zzapq.zza
{

	public FlagProviderImpl()
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #13  <Method void com.google.android.gms.internal.zzapq$zza()>
		zztW = false;
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:putfield        #15  <Field boolean zztW>
	//    5    9:return          
	}
	...
	public boolean getBooleanFlagValue(String s, boolean flag, int i)
	{
		if(!zztW)
	//*   0    0:aload_0         
	//*   1    1:getfield        #15  <Field boolean zztW>
	//*   2    4:ifne            9
			return flag;
	//    3    7:iload_2         
	//    4    8:ireturn         
		else
			return zza.zza.zza(zzAN, s, Boolean.valueOf(flag)).booleanValue();
	//    5    9:aload_0         
	//    6   10:getfield        #20  <Field SharedPreferences zzAN>
	//    7   13:aload_1         
	//    8   14:iload_2         
	...
	//    4    8:ireturn         
			...
			return zza.zzb.zza(zzAN, s, Integer.valueOf(i)).intValue();
	//    5    9:aload_0         
	//    6   10:getfield        #20  <Field SharedPreferences zzAN>
	//    7   13:aload_1         
	//    8   14:iload_2         
	...
	//    4    8:lreturn         
			...
			return zza.zzc.zza(zzAN, s, Long.valueOf(l)).longValue();
	//    5    9:aload_0         
	//    6   10:getfield        #20  <Field SharedPreferences zzAN>
	//    7   13:aload_1         
	//    8   14:lload_2         
	...
	{
		zzd = ((zzd) ((Context)zze.zzE(zzd)));
	//    0    0:aload_1         
	//    1    1:invokestatic    #85  <Method Object zze.zzE(zzd)>
	//    2    4:checkcast       #87  <Class Context>
	//    3    7:astore_1        
		if(zztW)
	//*   4    8:aload_0         
	//*   5    9:getfield        #15  <Field boolean zztW>
	//*   6   12:ifeq            16
			return;
	//    7   15:return          
		try
		{
			zzAN = zzb.zzm(((Context) (zzd)).createPackageContext("com.google.android.gms", 0));
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:ldc1            #89  <String "com.google.android.gms">
	//   11   20:iconst_0        
	//   12   21:invokevirtual   #93  <Method Context Context.createPackageContext(String, int)>
	//   13   24:invokestatic    #99  <Method SharedPreferences zzb.zzm(Context)>
	//   14   27:putfield        #20  <Field SharedPreferences zzAN>
			zztW = true;
	//   15   30:aload_0         
	//   16   31:iconst_1        
	//   17   32:putfield        #15  <Field boolean zztW>
			return;
	//   18   35:return          
		}
