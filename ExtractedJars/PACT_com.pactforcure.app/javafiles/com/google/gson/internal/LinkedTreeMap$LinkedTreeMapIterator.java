...
private abstract class LinkedTreeMap$LinkedTreeMapIterator
	implements Iterator
{
	...
	LinkedTreeMap$LinkedTreeMapIterator(LinkedTreeMap._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #44  <Method void LinkedTreeMap$LinkedTreeMapIterator(LinkedTreeMap)>
	//    3    5:return          
	}
}
