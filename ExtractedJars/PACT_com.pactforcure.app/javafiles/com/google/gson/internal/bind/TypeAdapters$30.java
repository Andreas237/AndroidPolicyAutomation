	...
	implements TypeAdapterFactory
{
	...
	{
		return (new StringBuilder()).append("Factory[type=").append(val$base.getName()).append("+").append(val$sub.getName()).append(",adapter=").append(((Object) (val$typeAdapter))).append("]").toString();
	...
	TypeAdapters$30(Class class1, Class class2, TypeAdapter typeadapter)
	{
		val$base = class1;
	//    0    0:aload_0         
	//    1    1:aload_1         
