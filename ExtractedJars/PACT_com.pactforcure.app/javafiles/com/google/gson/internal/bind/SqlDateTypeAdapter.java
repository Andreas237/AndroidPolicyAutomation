...
_L2:
	...
	//   14   22:new             #56  <Class Date>
	//   15   25:dup             
	//   16   26:aload_0         
	//   17   27:getfield        #29  <Field DateFormat format>
	//   18   30:aload_1         
	//   19   31:invokevirtual   #60  <Method String JsonReader.nextString()>
	//   20   34:invokevirtual   #66  <Method java.util.Date DateFormat.parse(String)>
	//   21   37:invokevirtual   #72  <Method long java.util.Date.getTime()>
	//   22   40:invokespecial   #75  <Method void Date(long)>
	//   23   43:astore_1        
...
_L2:
	...
	//   15   21:aload_2         
	//   16   22:invokevirtual   #94  <Method String DateFormat.format(java.util.Date)>
	//   17   25:astore_2        
		if(true) goto _L4; else goto _L3
	//   18   26:goto            8
_L3:
