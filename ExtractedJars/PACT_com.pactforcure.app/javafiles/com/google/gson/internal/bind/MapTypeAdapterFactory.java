	...
	implements TypeAdapterFactory
{
	...
	//    6   13:getstatic       #39  <Field TypeAdapter TypeAdapters.BOOLEAN_AS_STRING>
	//    7   16:areturn         
		else
			return gson.getAdapter(TypeToken.get(type));
	//    8   17:aload_1         
	//    9   18:aload_2         
	//   10   19:invokestatic    #45  <Method TypeToken TypeToken.get(Type)>
	//   11   22:invokevirtual   #51  <Method TypeAdapter Gson.getAdapter(TypeToken)>
	//   12   25:areturn         
	}
	...
	//   24   40:iconst_1        
	//   25   41:aaload          
	//   26   42:invokestatic    #45  <Method TypeToken TypeToken.get(Type)>
	//   27   45:invokevirtual   #51  <Method TypeAdapter Gson.getAdapter(TypeToken)>
	//   28   48:astore          5
