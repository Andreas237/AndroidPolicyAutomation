...
private abstract class LinkedHashTreeMap$LinkedTreeMapIterator
	implements Iterator
{
	...
	{
		LinkedHashTreeMap.Node node = next;
	//    0    0:aload_0         
	//    1    1:getfield        #33  <Field LinkedHashTreeMap$Node next>
	//    2    4:astore_1        
		if(node == header)
	...
	private LinkedHashTreeMap$LinkedTreeMapIterator()
	{
	...
	LinkedHashTreeMap$LinkedTreeMapIterator(LinkedHashTreeMap._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #44  <Method void LinkedHashTreeMap$LinkedTreeMapIterator(LinkedHashTreeMap)>
	//    3    5:return          
	}
}
