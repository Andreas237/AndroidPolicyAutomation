	...
	implements Iterable
{
	...
	//    5    9:getstatic       #28  <Field JsonNull JsonNull.INSTANCE>
	//    6   12:astore_1        
		else
	//*   7   13:aload_2         
	//*   8   14:aload_1         
	...
	//   12   22:new             #36  <Class JsonPrimitive>
	//   13   25:dup             
	//   14   26:aload_1         
	//   15   27:invokespecial   #38  <Method void JsonPrimitive(Boolean)>
	//   16   30:astore_1        
	...
	//   13   25:dup             
	//   14   26:aload_1         
	//   15   27:invokespecial   #41  <Method void JsonPrimitive(Character)>
	//   16   30:astore_1        
	...
	//   13   25:dup             
	//   14   26:aload_1         
	//   15   27:invokespecial   #44  <Method void JsonPrimitive(Number)>
	//   16   30:astore_1        
	...
	//   13   25:dup             
	//   14   26:aload_1         
	//   15   27:invokespecial   #47  <Method void JsonPrimitive(String)>
	//   16   30:astore_1        
		list.add(((Object) (s)));
	//*  17   31:goto            13
	}
	...
	//    4    8:invokeinterface #52  <Method boolean List.addAll(java.util.Collection)>
	//    5   13:pop             
	//    6   14:return          
	}
	...
	//    1    1:getfield        #19  <Field List elements>
	//    2    4:aload_1         
	//    3    5:invokeinterface #56  <Method boolean List.contains(Object)>
	//    4   10:ireturn         
	}
	...
	//    1    3:dup             
	//    2    4:invokespecial   #59  <Method void JsonArray()>
	//    3    7:astore_1        
	...
	//   11   27:aload_1         
	//   12   28:aload_2         
	//   13   29:invokeinterface #73  <Method Object Iterator.next()>
	//   14   34:checkcast       #5   <Class JsonElement>
	//   15   37:invokevirtual   #76  <Method JsonElement JsonElement.deepCopy()>
	//   16   40:invokevirtual   #78  <Method void add(JsonElement)>
	//*  17   43:goto            18
		return jsonarray;
	//   18   46:aload_1         
	//   19   47:areturn         
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #80  <Method JsonArray deepCopy()>
	//    2    4:areturn         
	}
	...
	//   11   23:invokeinterface #83  <Method boolean List.equals(Object)>
	//   12   28:ifeq            33
	//   13   31:iconst_1        
	//   14   32:ireturn         
	//   15   33:iconst_0        
	...
	//    1    1:getfield        #19  <Field List elements>
	//    2    4:iload_1         
	//    3    5:invokeinterface #88  <Method Object List.get(int)>
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #19  <Field List elements>
	//*   2    4:invokeinterface #94  <Method int List.size()>
	//*   3    9:iconst_1        
	//*   4   10:icmpne          30
	...
	//    7   17:iconst_0        
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #96  <Method BigDecimal JsonElement.getAsBigDecimal()>
	//   11   29:areturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	//   13   33:dup             
	//   14   34:invokespecial   #99  <Method void IllegalStateException()>
	//   15   37:athrow          
	}
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #103 <Method BigInteger JsonElement.getAsBigInteger()>
	//   11   29:areturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #106 <Method boolean JsonElement.getAsBoolean()>
	//   11   29:ireturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #110 <Method byte JsonElement.getAsByte()>
	//   11   29:ireturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #114 <Method char JsonElement.getAsCharacter()>
	//   11   29:ireturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #118 <Method double JsonElement.getAsDouble()>
	//   11   29:dreturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #122 <Method float JsonElement.getAsFloat()>
	//   11   29:freturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #125 <Method int JsonElement.getAsInt()>
	//   11   29:ireturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #129 <Method long JsonElement.getAsLong()>
	//   11   29:lreturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #133 <Method Number JsonElement.getAsNumber()>
	//   11   29:areturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #137 <Method short JsonElement.getAsShort()>
	//   11   29:ireturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    8   18:invokeinterface #88  <Method Object List.get(int)>
	//    9   23:checkcast       #5   <Class JsonElement>
	//   10   26:invokevirtual   #141 <Method String JsonElement.getAsString()>
	//   11   29:areturn         
		else
			throw new IllegalStateException();
	//   12   30:new             #98  <Class IllegalStateException>
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field List elements>
	//    2    4:invokeinterface #144 <Method int List.hashCode()>
	//    3    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field List elements>
	//    2    4:invokeinterface #63  <Method Iterator List.iterator()>
	//    3    9:areturn         
	}
	...
	//    1    1:getfield        #19  <Field List elements>
	//    2    4:iload_1         
	//    3    5:invokeinterface #149 <Method Object List.remove(int)>
	//    4   10:checkcast       #5   <Class JsonElement>
	//    5   13:areturn         
	}
	...
	//    1    1:getfield        #19  <Field List elements>
	//    2    4:aload_1         
	//    3    5:invokeinterface #151 <Method boolean List.remove(Object)>
	//    4   10:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokeinterface #156 <Method Object List.set(int, Object)>
