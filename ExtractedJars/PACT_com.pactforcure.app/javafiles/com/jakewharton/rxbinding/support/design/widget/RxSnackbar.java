...
public final class RxSnackbar
{
	...
	public static Observable dismisses(Snackbar snackbar)
	{
		return Observable.create(((rx.Observable.OnSubscribe) (new SnackbarDismissesOnSubscribe(snackbar))));
	//    0    0:new             #22  <Class SnackbarDismissesOnSubscribe>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #25  <Method void SnackbarDismissesOnSubscribe(Snackbar)>
