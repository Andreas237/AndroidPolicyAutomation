...
public final class SeekBarStopChangeEvent extends SeekBarChangeEvent
{
	...
	//    0    0:new             #2   <Class SeekBarStopChangeEvent>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #15  <Method void SeekBarStopChangeEvent(SeekBar)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:instanceof      #2   <Class SeekBarStopChangeEvent>
	//    2    4:ifeq            23
	//    3    7:aload_1         
	//    4    8:checkcast       #2   <Class SeekBarStopChangeEvent>
	...
	{
		return (new StringBuilder()).append("SeekBarStopChangeEvent{view=").append(((Object) (view()))).append('}').toString();
	//    0    0:new             #34  <Class StringBuilder>
	//    1    3:dup             
	//    2    4:invokespecial   #37  <Method void StringBuilder()>
	//    3    7:ldc1            #39  <String "SeekBarStopChangeEvent{view=">
