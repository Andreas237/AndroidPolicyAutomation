...
//			AdapterViewSelectionOnSubscribe, AdapterViewItemSelectionEvent, AdapterViewNothingSelectionEvent

class AdapterViewSelectionOnSubscribe$1
	implements android.widget.
{
	...
	//*   3    7:ifne            25
			val$subscriber.onNext(((Object) (AdapterViewItemSelectionEvent.create(adapterview, view, i, l))));
	//    4   10:aload_0         
	...
	//*   2    4:invokevirtual   #33  <Method boolean Subscriber.isUnsubscribed()>
	//*   3    7:ifne            21
			val$subscriber.onNext(((Object) (AdapterViewNothingSelectionEvent.create(adapterview))));
	//    4   10:aload_0         
	//    5   11:getfield        #21  <Field Subscriber val$subscriber>
	//    6   14:aload_1         
	...
	AdapterViewSelectionOnSubscribe$1()
	{
		this$0 = final_adapterviewselectiononsubscribe;
	//    0    0:aload_0         
	//    1    1:aload_1         
