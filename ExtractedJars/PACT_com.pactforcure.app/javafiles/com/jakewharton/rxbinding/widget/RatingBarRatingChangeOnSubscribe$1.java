...
class RatingBarRatingChangeOnSubscribe$1
	implements android.widget.
{
	...
	//*   3    7:ifne            21
			val$subscriber.onNext(((Object) (Float.valueOf(f))));
	//    4   10:aload_0         
	...
	RatingBarRatingChangeOnSubscribe$1()
	{
		this$0 = final_ratingbarratingchangeonsubscribe;
	//    0    0:aload_0         
	//    1    1:aload_1         
