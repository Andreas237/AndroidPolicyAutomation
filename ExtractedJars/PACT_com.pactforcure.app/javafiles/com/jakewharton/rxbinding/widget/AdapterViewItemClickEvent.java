...
public final class AdapterViewItemClickEvent extends ViewEvent
{

	private AdapterViewItemClickEvent(AdapterView adapterview, View view, int i, long l)
	{
	...
	public static AdapterViewItemClickEvent create(AdapterView adapterview, View view, int i, long l)
	{
		return new AdapterViewItemClickEvent(adapterview, view, i, l);
	//    0    0:new             #2   <Class AdapterViewItemClickEvent>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:iload_2         
	//    5    7:lload_3         
	//    6    8:invokespecial   #32  <Method void AdapterViewItemClickEvent(AdapterView, View, int, long)>
	//    7   11:areturn         
	}
	...
	//*   5    7:aload_1         
	//*   6    8:instanceof      #2   <Class AdapterViewItemClickEvent>
	//*   7   11:ifne            16
				return false;
	//    8   14:iconst_0        
	//    9   15:ireturn         
			obj = ((Object) ((AdapterViewItemClickEvent)obj));
	//   10   16:aload_1         
	//   11   17:checkcast       #2   <Class AdapterViewItemClickEvent>
	//   12   20:astore_1        
			if(((AdapterViewItemClickEvent) (obj)).view() != view() || ((AdapterViewItemClickEvent) (obj)).clickedView != clickedView || ((AdapterViewItemClickEvent) (obj)).position != position || ((AdapterViewItemClickEvent) (obj)).id != id)
	//*  13   21:aload_1         
	...
	{
		return (new StringBuilder()).append("AdapterViewItemClickEvent{view=").append(((Object) (view()))).append(", clickedView=").append(((Object) (clickedView))).append(", position=").append(position).append(", id=").append(id).append('}').toString();
	//    0    0:new             #53  <Class StringBuilder>
	//    1    3:dup             
	//    2    4:invokespecial   #56  <Method void StringBuilder()>
	//    3    7:ldc1            #58  <String "AdapterViewItemClickEvent{view=">
