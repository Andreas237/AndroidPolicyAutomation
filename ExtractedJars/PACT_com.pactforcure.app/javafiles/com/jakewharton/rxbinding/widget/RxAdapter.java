...
public final class RxAdapter
{
	...
	public static Observable dataChanges(Adapter adapter)
	{
		return Observable.create(((rx.Observable.OnSubscribe) (new AdapterDataChangeOnSubscribe(adapter))));
	//    0    0:new             #22  <Class AdapterDataChangeOnSubscribe>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #25  <Method void AdapterDataChangeOnSubscribe(Adapter)>
