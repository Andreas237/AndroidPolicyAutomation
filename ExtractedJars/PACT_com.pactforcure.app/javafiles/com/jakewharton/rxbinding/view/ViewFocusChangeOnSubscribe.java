	...
	implements rx.Observable.OnSubscribe
{
	...
	public ViewFocusChangeOnSubscribe(View view1)
	{
	//    0    0:aload_0         
	...
	//    0    0:invokestatic    #35  <Method void Preconditions.checkUiThread()>
		android.view.View.OnFocusChangeListener onfocuschangelistener = new android.view.View.OnFocusChangeListener() {
			...
			//    0    0:aload_0         
			//    1    1:aload_1         
			//    2    2:putfield        #19  <Field ViewFocusChangeOnSubscribe this$0>
...
;
	//    1    3:new             #9   <Class ViewFocusChangeOnSubscribe$1>
	//    2    6:dup             
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:invokespecial   #38  <Method void ViewFocusChangeOnSubscribe$1(ViewFocusChangeOnSubscribe, Subscriber)>
	//    6   12:astore_2        
	...
	//   11   21:aload_1         
	//   12   22:new             #11  <Class ViewFocusChangeOnSubscribe$2>
	//   13   25:dup             
	//   14   26:aload_0         
	//   15   27:invokespecial   #47  <Method void ViewFocusChangeOnSubscribe$2(ViewFocusChangeOnSubscribe)>
	//   16   30:invokevirtual   #51  <Method void Subscriber.add(rx.Subscription)>
		subscriber.onNext(((Object) (Boolean.valueOf(view.hasFocus()))));
	//   17   33:aload_1         
	//   18   34:aload_0         
	//   19   35:getfield        #20  <Field View view>
	//   20   38:invokevirtual   #55  <Method boolean View.hasFocus()>
...
/*
	static View access$000(ViewFocusChangeOnSubscribe viewfocuschangeonsubscribe)
	{
		return viewfocuschangeonsubscribe.view;
	//    0    0:aload_0         
