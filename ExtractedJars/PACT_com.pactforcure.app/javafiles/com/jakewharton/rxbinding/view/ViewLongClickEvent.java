...
public final class ViewLongClickEvent extends ViewEvent
{
	...
	//    0    0:new             #2   <Class ViewLongClickEvent>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #16  <Method void ViewLongClickEvent(View)>
	//    4    8:areturn         
	}
	...
	//*   4    6:ireturn         
		{
			if(!(obj instanceof ViewLongClickEvent))
	//*   5    7:aload_1         
	//*   6    8:instanceof      #2   <Class ViewLongClickEvent>
	//*   7   11:ifne            16
				return false;
	//    8   14:iconst_0        
	//    9   15:ireturn         
			if(((ViewLongClickEvent)obj).view() != view())
	//*  10   16:aload_1         
	//*  11   17:checkcast       #2   <Class ViewLongClickEvent>
	...
	{
		return (new StringBuilder()).append("ViewLongClickEvent{view=").append(((Object) (view()))).append('}').toString();
	//    0    0:new             #33  <Class StringBuilder>
	//    1    3:dup             
	//    2    4:invokespecial   #36  <Method void StringBuilder()>
	//    3    7:ldc1            #38  <String "ViewLongClickEvent{view=">
