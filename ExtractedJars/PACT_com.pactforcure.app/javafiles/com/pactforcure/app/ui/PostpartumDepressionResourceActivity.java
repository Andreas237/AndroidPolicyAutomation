...
public class PostpartumDepressionResourceActivity extends BaseResourceActivity
{

	public PostpartumDepressionResourceActivity()
	{
	//    0    0:aload_0         
	...
	{
		return 0x7f040028;
	//    0    0:ldc1            #12  <Int 0x7f040028>
	//    1    2:ireturn         
	}

	protected String getScreenTitle()
	{
		return Res.getStudySpecificString(0x7f0802e6);
	//    0    0:ldc1            #15  <Int 0x7f0802e6>
	...
	//   10   19:invokevirtual   #43  <Method void TextView.setMovementMethod(android.text.method.MovementMethod)>
		((TextView) (bundle)).setText(((CharSequence) (Html.fromHtml(Res.getStudySpecificRawAsString(0x7f07001e)))));
	//   11   22:aload_1         
	//   12   23:ldc1            #44  <Int 0x7f07001e>
