...
//			OnSurveyProgressStatusChanged, DnaCollectionActivity, DnaConsentActivity, SurveyActivity, 
//			DashboardCardBuilder

public class SurveyTasksFragment extends Fragment
	implements OnSurveyProgressStatusChanged
{
	private class AddCards
	{
		...
		//   16   26:invokevirtual   #55  <Method void LinearLayout.addView(View, int)>
			dynamicViewsIds.add(((Object) (Integer.valueOf(view.getId()))));
		//   17   29:aload_0         
		...
		//* 101  194:if_acmpne       215
			{
					...
					implements android.view.View.OnClickListener
				{
					...
					public static android.view.View.OnClickListener lambdaFactory$(AddCards addcards, int l)
					{
					...
					{
						AddCards.lambda.addHealthEconomicsCards._mth56(arg$1, arg$2, view);
					//    0    0:aload_0         
...
_L1:
		...
		//*  38   80:invokevirtual   #202 <Method View DashboardCardBuilder.buildCard(ViewGroup)>
		...
		//   45   96:iconst_0        
		//   46   97:istore_3        
			addCompletedCard(((DashboardCardBuilder) (s)).completed(flag).buildCard(((ViewGroup) (binding.container))));
		//*  47   98:goto            64
		}

		private void createAndAddToDoCard(String s, android.view.View.OnClickListener onclicklistener)
		{
			s = ((String) ((new DashboardCardBuilder()).label(s).withAttentionCircle().buildCard(((ViewGroup) (binding.container)))));
		//    0    0:new             #167 <Class DashboardCardBuilder>
		//    1    3:dup             
		//    2    4:invokespecial   #168 <Method void DashboardCardBuilder()>
		//    3    7:aload_1         
		...
		//   10   24:invokevirtual   #202 <Method View DashboardCardBuilder.buildCard(ViewGroup)>
		//   11   27:astore_1        
		...
		//   14   30:invokevirtual   #213 <Method void View.setOnClickListener(android.view.View$OnClickListener)>
			onclicklistener = ((android.view.View.OnClickListener) (binding.container));
		//   15   33:aload_0         
		...
		//   40   74:putfield        #29  <Field boolean hasTodoCards>
			dynamicViewsIds.add(((Object) (Integer.valueOf(((View) (s)).getId()))));
		//   41   77:aload_0         
		...
		static void lambda$addHealthEconomicsCards$56(AddCards addcards, int i, View view)
		{
			addcards.this$0.goToQuestionnaire(i);
		//    0    0:aload_0         
		//    1    1:getfield        #24  <Field SurveyTasksFragment this$0>
		//    2    4:iload_1         
		...
		static void lambda$invoke$53(AddCards addcards, View view)
		{
			addcards.this$0.goToQuestionnaire(0x7f0e0013);
		//    0    0:aload_0         
		//    1    1:getfield        #24  <Field SurveyTasksFragment this$0>
		...
		static void lambda$invoke$54(AddCards addcards, View view)
		{
			addcards.this$0.goToDnaCollection();
		//    0    0:aload_0         
		//    1    1:getfield        #24  <Field SurveyTasksFragment this$0>
		...
		static void lambda$invoke$55(AddCards addcards, View view)
		{
			addcards.this$0.goToDnaConsent();
		//    0    0:aload_0         
		//    1    1:getfield        #24  <Field SurveyTasksFragment this$0>
		...
		void invoke()
		{
			...
			Object obj1;
			Object obj3;
			obj = ((Object) (binding.todoLabel));
		//    0    0:aload_0         
		//    1    1:getfield        #24  <Field SurveyTasksFragment this$0>
		//    2    4:invokestatic    #41  <Method FragmentSurveyTasksBinding SurveyTasksFragment.access$100(SurveyTasksFragment)>
		//    3    7:getfield        #237 <Field TextView FragmentSurveyTasksBinding.todoLabel>
		//    4   10:astore_3        
			todoIndex = binding.container.indexOfChild(((View) (obj)));
		//    5   11:aload_0         
		//    6   12:aload_0         
		...
		//   12   26:putfield        #215 <Field int todoIndex>
			obj1 = ((Object) (binding.completedLabel));
		//   13   29:aload_0         
		...
		//   17   39:astore          4
			completedIndex = binding.container.indexOfChild(((View) (obj1)));
		//   18   41:aload_0         
		//   19   42:aload_0         
		...
		//   25   57:putfield        #49  <Field int completedIndex>
			binding.completedLabel.setVisibility(0);
		//   26   60:aload_0         
...
_L1:
				...
				implements android.view.View.OnClickListener
			{
				...
				public static android.view.View.OnClickListener lambdaFactory$(AddCards addcards)
				{
				...
				public void onClick(View view)
				{
					AddCards.lambda.invoke._mth53(arg$1, view);
				//    0    0:aload_0         
...
_L3:
		...
		//   64  151:invokespecial   #275 <Method void addHealthEconomicsCards(StudyId)>
				...
				implements android.view.View.OnClickListener
			{
				...
				public void onClick(View view)
				{
					AddCards.lambda.invoke._mth55(arg$1, view);
				//    0    0:aload_0         
				//    1    1:getfield        #15  <Field SurveyTasksFragment$AddCards arg$1>
				//    2    4:aload_1         
		...
		//   94  227:invokevirtual   #202 <Method View DashboardCardBuilder.buildCard(ViewGroup)>
		//   95  230:invokespecial   #204 <Method void addCompletedCard(View)>
						...
						implements android.view.View.OnClickListener
					{
						...
						public void onClick(View view)
						{
							AddCards.lambda.invoke._mth54(arg$1, view);
						//    0    0:aload_0         
						//    1    1:getfield        #15  <Field SurveyTasksFragment$AddCards arg$1>
						//    2    4:aload_1         
		...
		//* 141  338:invokevirtual   #202 <Method View DashboardCardBuilder.buildCard(ViewGroup)>
		...
		//* 156  377:invokevirtual   #202 <Method View DashboardCardBuilder.buildCard(ViewGroup)>
		//* 157  380:astore_3        
		...
		//  244  567:iconst_0        
		//  245  568:istore_2        
						addCompletedCard(((DashboardCardBuilder) (obj3)).completed(flag).buildCard(((ViewGroup) (binding.container))));
					} else
		//* 246  569:goto            321
					{
		...
		//  259  600:invokespecial   #149 <Method void createAndAddToDoCard(String, android.view.View$OnClickListener)>
			...
			if(!hasTodoCards)
			{
				obj = ((Object) ((new DashboardCardBuilder()).label(Res.getStudySpecificString(0x7f080342)).buildCard(((ViewGroup) (binding.container)))));
				...
				obj2 = ((Object) (binding.container));
				i = todoIndex + 1;
				todoIndex = i;
				((LinearLayout) (obj2)).addView(((View) (obj)), i);
				binding.container.getChildAt(todoIndex - 1).setVisibility(8);
				completedIndex = completedIndex + 1;
				dynamicViewsIds.add(((Object) (Integer.valueOf(((View) (obj)).getId()))));
			} else
		//* 260  603:goto            344
			{
		...
		//  263  608:invokevirtual   #334 <Method void View.setVisibility(int)>
			...
			if(!hasCompletedCards)
				binding.completedLabel.setVisibility(8);
			return;
_L2:
...
_L4:
	...
	private class AddCards.SurveyAndProgress
	{

		public final ProgressStatus progressStatus;
		public final Survey survey;
		public final int surveyId;
		final AddCards this$1;

		public AddCards.SurveyAndProgress(Survey survey1, int i, ProgressStatus progressstatus)
		{
			this$1 = AddCards.this;
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	private void goToDnaCollection()
	{
		if(processingOrLoadingQuestionnaires)
	//*   0    0:aload_0         
	//*   1    1:getfield        #58  <Field boolean processingOrLoadingQuestionnaires>
	//*   2    4:ifeq            8
		{
			return;
	//    3    7:return          
		...
		{
			startActivity(new Intent(getContext(), com/pactforcure/app/ui/DnaCollectionActivity));
	//    4    8:aload_0         
	//    5    9:new             #60  <Class Intent>
	//    6   12:dup             
	//    7   13:aload_0         
	//    8   14:invokevirtual   #64  <Method Context getContext()>
	//    9   17:ldc1            #66  <Class DnaCollectionActivity>
	//   10   19:invokespecial   #69  <Method void Intent(Context, Class)>
	//   11   22:invokevirtual   #73  <Method void startActivity(Intent)>
			return;
	//   12   25:return          
		}
	}

	private void goToDnaConsent()
	{
		if(processingOrLoadingQuestionnaires)
	//*   0    0:aload_0         
	//*   1    1:getfield        #58  <Field boolean processingOrLoadingQuestionnaires>
	...
	//    3    7:return          
		...
		{
			startActivity(new Intent(getContext(), com/pactforcure/app/ui/DnaConsentActivity));
	//    4    8:aload_0         
	//    5    9:new             #60  <Class Intent>
	//    6   12:dup             
	//    7   13:aload_0         
	//    8   14:invokevirtual   #64  <Method Context getContext()>
	//    9   17:ldc1            #75  <Class DnaConsentActivity>
	//   10   19:invokespecial   #69  <Method void Intent(Context, Class)>
	//   11   22:invokevirtual   #73  <Method void startActivity(Intent)>
			return;
	//   12   25:return          
	...
	private void goToQuestionnaire(int i)
	{
		if(processingOrLoadingQuestionnaires)
	//*   0    0:aload_0         
	//*   1    1:getfield        #58  <Field boolean processingOrLoadingQuestionnaires>
	...
	//    3    7:return          
		...
		{
			Intent intent = new Intent(getContext(), com/pactforcure/app/ui/SurveyActivity);
	//    4    8:new             #60  <Class Intent>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:invokevirtual   #64  <Method Context getContext()>
	//    8   16:ldc1            #78  <Class SurveyActivity>
	//    9   18:invokespecial   #69  <Method void Intent(Context, Class)>
	//   10   21:astore_2        
			intent.putExtra("SURVEY_CODE_EXTRA", i);
	//   11   22:aload_2         
	//   12   23:ldc1            #80  <String "SURVEY_CODE_EXTRA">
	//   13   25:iload_1         
	//   14   26:invokevirtual   #84  <Method Intent Intent.putExtra(String, int)>
	//   15   29:pop             
			startActivityForResult(intent, 0);
	//   16   30:aload_0         
	//   17   31:aload_2         
	//   18   32:iconst_0        
	//   19   33:invokevirtual   #88  <Method void startActivityForResult(Intent, int)>
			return;
	//   20   36:return          
		}
	}
	...
	{
		(new AddCards()).invoke();
	//    0    0:new             #10  <Class SurveyTasksFragment$AddCards>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aconst_null     
	//    4    6:invokespecial   #93  <Method void SurveyTasksFragment$AddCards(SurveyTasksFragment, SurveyTasksFragment$1)>
	//    5    9:invokevirtual   #96  <Method void SurveyTasksFragment$AddCards.invoke()>
	//    6   12:return          
	}

	public static Fragment newInstance()
	{
		return ((Fragment) (new SurveyTasksFragment()));
	//    0    0:new             #2   <Class SurveyTasksFragment>
	//    1    3:dup             
	//    2    4:invokespecial   #99  <Method void SurveyTasksFragment()>
	//    3    7:areturn         
	}

	private void removeAndCreateSurveyCards()
	{
		Integer integer;
		for(Iterator iterator = dynamicViewsIds.iterator(); iterator.hasNext(); binding.container.removeView(binding.container.findViewById(integer.intValue())))
	//*   0    0:aload_0         
	//*   1    1:getfield        #41  <Field List dynamicViewsIds>
	...
	//    9   25:checkcast       #118 <Class Integer>
	//   10   28:astore_2        

	//   11   29:aload_0         
	//   12   30:getfield        #37  <Field FragmentSurveyTasksBinding binding>
	//   13   33:getfield        #124 <Field LinearLayout FragmentSurveyTasksBinding.container>
	//   14   36:aload_0         
	//   15   37:getfield        #37  <Field FragmentSurveyTasksBinding binding>
	//   16   40:getfield        #124 <Field LinearLayout FragmentSurveyTasksBinding.container>
	//   17   43:aload_2         
	//   18   44:invokevirtual   #128 <Method int Integer.intValue()>
	//   19   47:invokevirtual   #134 <Method View LinearLayout.findViewById(int)>
	//   20   50:invokevirtual   #138 <Method void LinearLayout.removeView(View)>
	//*  21   53:goto            10
		dynamicViewsIds.clear();
	//   22   56:aload_0         
	//   23   57:getfield        #41  <Field List dynamicViewsIds>
	//   24   60:invokeinterface #141 <Method void List.clear()>
		loadAndDisplayItems();
	//   25   65:aload_0         
	//   26   66:invokespecial   #143 <Method void loadAndDisplayItems()>
	//   27   69:return          
	}
	...
	//*   2    3:icmpne          22
		{
			processingOrLoadingQuestionnaires = true;
	//    3    6:aload_0         
	//    4    7:iconst_1        
	//    5    8:putfield        #58  <Field boolean processingOrLoadingQuestionnaires>
			binding.progressBar.setVisibility(0);
	//    6   11:aload_0         
	//    7   12:getfield        #37  <Field FragmentSurveyTasksBinding binding>
	//    8   15:getfield        #149 <Field ProgressBar FragmentSurveyTasksBinding.progressBar>
	//    9   18:iconst_0        
	//   10   19:invokevirtual   #154 <Method void ProgressBar.setVisibility(int)>
		}
	//   11   22:return          
	}
	...
	{
		binding = (FragmentSurveyTasksBinding)DataBindingUtil.inflate(layoutinflater, 0x7f040042, viewgroup, false);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:ldc1            #158 <Int 0x7f040042>
	//    3    4:aload_2         
	//    4    5:iconst_0        
	//    5    6:invokestatic    #164 <Method android.databinding.ViewDataBinding DataBindingUtil.inflate(LayoutInflater, int, ViewGroup, boolean)>
	//    6    9:checkcast       #120 <Class FragmentSurveyTasksBinding>
	//    7   12:putfield        #37  <Field FragmentSurveyTasksBinding binding>
		dynamicViewsIds = ((List) (new ArrayList()));
	//    8   15:aload_0         
	//    9   16:new             #166 <Class ArrayList>
	//   10   19:dup             
	//   11   20:invokespecial   #167 <Method void ArrayList()>
	//   12   23:putfield        #41  <Field List dynamicViewsIds>
		loadAndDisplayItems();
	//   13   26:aload_0         
	//   14   27:invokespecial   #143 <Method void loadAndDisplayItems()>
		return binding.getRoot();
	//   15   30:aload_0         
	//   16   31:getfield        #37  <Field FragmentSurveyTasksBinding binding>
	//   17   34:invokevirtual   #171 <Method View FragmentSurveyTasksBinding.getRoot()>
	//   18   37:areturn         
	}

	public void onSurveyProgressStatusChanged()
	{
		processingOrLoadingQuestionnaires = false;
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:putfield        #58  <Field boolean processingOrLoadingQuestionnaires>
		if(binding != null)
	//*   3    5:aload_0         
	//*   4    6:getfield        #37  <Field FragmentSurveyTasksBinding binding>
	//*   5    9:ifnull          23
			binding.progressBar.setVisibility(4);
	//    6   12:aload_0         
	//    7   13:getfield        #37  <Field FragmentSurveyTasksBinding binding>
	//    8   16:getfield        #149 <Field ProgressBar FragmentSurveyTasksBinding.progressBar>
	//    9   19:iconst_4        
	//   10   20:invokevirtual   #154 <Method void ProgressBar.setVisibility(int)>
		removeAndCreateSurveyCards();
	//   11   23:aload_0         
	//   12   24:invokespecial   #175 <Method void removeAndCreateSurveyCards()>
	//   13   27:return          
	}

	private static final int REQUEST_QUESTIONNAIRE = 0;
	private static final String TAG = "SurveyTasksFragment";
	private FragmentSurveyTasksBinding binding;
	private List dynamicViewsIds;
	private boolean processingOrLoadingQuestionnaires;


/*
	static FragmentSurveyTasksBinding access$100(SurveyTasksFragment surveytasksfragment)
	{
		return surveytasksfragment.binding;
	//    0    0:aload_0         
	//    1    1:getfield        #37  <Field FragmentSurveyTasksBinding binding>
	//    2    4:areturn         
	}
...
/*
	static List access$200(SurveyTasksFragment surveytasksfragment)
	{
		return surveytasksfragment.dynamicViewsIds;
	//    0    0:aload_0         
	//    1    1:getfield        #41  <Field List dynamicViewsIds>
	//    2    4:areturn         
	}
...
/*
	static void access$300(SurveyTasksFragment surveytasksfragment, int i)
	{
		surveytasksfragment.goToQuestionnaire(i);
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #47  <Method void goToQuestionnaire(int)>
		return;
	//    3    5:return          
	}
...
/*
	static void access$400(SurveyTasksFragment surveytasksfragment)
	{
		surveytasksfragment.goToDnaConsent();
	//    0    0:aload_0         
	//    1    1:invokespecial   #52  <Method void goToDnaConsent()>
		return;
	//    2    4:return          
	}
...
/*
	static void access$500(SurveyTasksFragment surveytasksfragment)
	{
		surveytasksfragment.goToDnaCollection();
	//    0    0:aload_0         
	//    1    1:invokespecial   #56  <Method void goToDnaCollection()>
		return;
	//    2    4:return          
	}
