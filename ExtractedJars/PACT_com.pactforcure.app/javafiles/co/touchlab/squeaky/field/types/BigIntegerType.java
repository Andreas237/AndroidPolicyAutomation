...
public class BigIntegerType extends BaseDataType
{
	...
	{
		return singleTon;
	//    0    0:getstatic       #17  <Field BigIntegerType singleTon>
	//    1    3:areturn         
	}

	public Object javaToSqlArg(FieldType fieldtype, Object obj)
	{
		return ((Object) (((BigInteger)obj).toString()));
	//    0    0:aload_2         
	//    1    1:checkcast       #28  <Class BigInteger>
	//    2    4:invokevirtual   #41  <Method String BigInteger.toString()>
	//    3    7:areturn         
	}
		...
		throws SQLException
	{
		...
		try
		{
			s1 = (new BigInteger(s)).toString();
	//    0    0:new             #28  <Class BigInteger>
	//    1    3:dup             
	//    2    4:aload_2         
	//    3    5:invokespecial   #50  <Method void BigInteger(String)>
	//    4    8:invokevirtual   #41  <Method String BigInteger.toString()>
	//    5   11:astore_3        
		}
	//*   6   12:aload_3         
	//*   7   13:areturn         
	...
	//*   8   14:astore_3        
		{
			throw SqlExceptionUtil.create((new StringBuilder()).append("Problems with field ").append(((Object) (fieldtype))).append(" parsing default BigInteger string '").append(s).append("'").toString(), ((Throwable) (illegalargumentexception)));
	...
	//   16   31:ldc1            #64  <String " parsing default BigInteger string '">
		...
		throws SQLException
	{
		try
		{
			fieldtype = ((FieldType) (new BigInteger((String)obj)));
	//    0    0:new             #28  <Class BigInteger>
	//    1    3:dup             
	//    2    4:aload_2         
	//    3    5:checkcast       #86  <Class String>
	//    4    8:invokespecial   #50  <Method void BigInteger(String)>
	//    5   11:astore_1        
		}
	//*   6   12:aload_1         
	//*   7   13:areturn         
	...
	//*   8   14:astore_1        
		{
			throw SqlExceptionUtil.create((new StringBuilder()).append("Problems with column ").append(i).append(" parsing BigInteger string '").append(obj).append("'").toString(), ((Throwable) (fieldtype)));
	//    9   15:new             #52  <Class StringBuilder>
	//   10   18:dup             
	//   11   19:invokespecial   #53  <Method void StringBuilder()>
	...
	//   16   31:ldc1            #93  <String " parsing BigInteger string '">
	//   17   33:invokevirtual   #59  <Method StringBuilder StringBuilder.append(String)>
	//   18   36:aload_2         
	...
	//    2    6:new             #2   <Class BigIntegerType>
	//    3    9:dup             
	//    4   10:invokespecial   #15  <Method void BigIntegerType()>
	//    5   13:putstatic       #17  <Field BigIntegerType singleTon>
	//*   6   16:return          
	}
}
