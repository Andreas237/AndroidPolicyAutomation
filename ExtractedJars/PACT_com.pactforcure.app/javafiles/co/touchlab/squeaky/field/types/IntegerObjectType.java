...
public class IntegerObjectType extends BaseDataType
{
	...
	{
		return singleTon;
	//    0    0:getstatic       #13  <Field IntegerObjectType singleTon>
	//    1    3:areturn         
	}
	...
	//    0    0:aload_2         
	//    1    1:invokestatic    #39  <Method int Integer.parseInt(String)>
	//    2    4:invokestatic    #43  <Method Integer Integer.valueOf(int)>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_2         
	//    1    1:iload_3         
	//    2    2:invokeinterface #53  <Method int Cursor.getInt(int)>
	...
	static 
	{
	//    0    0:new             #2   <Class IntegerObjectType>
	//    1    3:dup             
	//    2    4:invokespecial   #11  <Method void IntegerObjectType()>
	//    3    7:putstatic       #13  <Field IntegerObjectType singleTon>
	//*   4   10:return          
	}
}
