...
static final class ExecutorUtils$1
	implements ThreadFactory
{

	public Thread newThread(final Runnable runnable)
	{
		runnable = ((Runnable) (Executors.defaultThreadFactory().newThread(((Runnable) (new BackgroundPriorityRunnable() {
	...
	//    7   17:astore_1        
		((Thread) (runnable)).setName((new StringBuilder()).append(val$threadNameTemplate).append(val$count.getAndIncrement()).toString());
	//    8   18:aload_1         
	...
	ExecutorUtils$1(String s, AtomicLong atomiclong)
	{
