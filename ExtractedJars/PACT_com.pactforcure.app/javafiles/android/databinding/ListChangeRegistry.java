...
public class ListChangeRegistry extends CallbackRegistry
{
	...
	//    4    4:iload_2         
	//    5    5:aload_3         
	//    6    6:invokespecial   #65  <Method void CallbackRegistry.notifyCallbacks(Object, int, Object)>
		if(listchanges == null)
	...
	//   10   16:aload_3         
	//   11   17:invokevirtual   #69  <Method boolean android.support.v4.util.Pools$SynchronizedPool.release(Object)>
	//   12   20:pop             
		this;
	//   13   21:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #71  <Class ObservableList>
	//    3    5:iload_2         
	//    4    6:aload_3         
	//    5    7:checkcast       #9   <Class ListChangeRegistry$ListChanges>
	//    6   10:invokevirtual   #73  <Method void notifyCallbacks(ObservableList, int, ListChangeRegistry$ListChanges)>
	//    7   13:return          
	}
	...
	//    2    2:iconst_0        
	//    3    3:aconst_null     
	//    4    4:invokevirtual   #73  <Method void notifyCallbacks(ObservableList, int, ListChangeRegistry$ListChanges)>
	//    5    7:return          
	}
	...
	//    4    4:iconst_0        
	//    5    5:iload_3         
	//    6    6:invokestatic    #78  <Method ListChangeRegistry$ListChanges acquire(int, int, int)>
	//    7    9:invokevirtual   #73  <Method void notifyCallbacks(ObservableList, int, ListChangeRegistry$ListChanges)>
	//    8   12:return          
	}
	...
	//    4    4:iload_3         
	//    5    5:iload           4
	//    6    7:invokestatic    #78  <Method ListChangeRegistry$ListChanges acquire(int, int, int)>
	//    7   10:invokevirtual   #73  <Method void notifyCallbacks(ObservableList, int, ListChangeRegistry$ListChanges)>
	//    8   13:return          
	}
