...
public class CardViewBindingAdapter
{
	...
	//    3    3:iload_1         
	//    4    4:iload_1         
	//    5    5:invokevirtual   #33  <Method void CardView.setContentPadding(int, int, int, int)>
	//    6    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:invokevirtual   #40  <Method int CardView.getContentPaddingLeft()>
	//    3    5:aload_0         
	//    4    6:invokevirtual   #43  <Method int CardView.getContentPaddingTop()>
	//    5    9:aload_0         
	//    6   10:invokevirtual   #46  <Method int CardView.getContentPaddingRight()>
	//    7   13:iload_1         
	//    8   14:invokevirtual   #33  <Method void CardView.setContentPadding(int, int, int, int)>
	//    9   17:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:aload_0         
	//    3    3:invokevirtual   #43  <Method int CardView.getContentPaddingTop()>
	//    4    6:aload_0         
	//    5    7:invokevirtual   #46  <Method int CardView.getContentPaddingRight()>
	//    6   10:aload_0         
	//    7   11:invokevirtual   #51  <Method int CardView.getContentPaddingBottom()>
	//    8   14:invokevirtual   #33  <Method void CardView.setContentPadding(int, int, int, int)>
	//    9   17:return          
	}
