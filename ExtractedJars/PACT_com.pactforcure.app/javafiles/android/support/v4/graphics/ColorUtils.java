...
_L1:
	...
	//   56  110:iconst_0        
	//   57  111:sipush          255
	//   58  114:invokestatic    #55  <Method int constrain(int, int, int)>
	//   59  117:iload           6
	//   60  119:iconst_0        
	//   61  120:sipush          255
	//   62  123:invokestatic    #55  <Method int constrain(int, int, int)>
	//   63  126:iload           5
	//   64  128:iconst_0        
	//   65  129:sipush          255
	//   66  132:invokestatic    #55  <Method int constrain(int, int, int)>
	//   67  135:invokestatic    #60  <Method int Color.rgb(int, int, int)>
	//   68  138:ireturn         
_L2:
		k = Math.round(255F * (f1 + f2));
	//   69  139:ldc1            #61  <Float 255F>
	//   70  141:fload_2         
	//   71  142:fload_3         
	//   72  143:fadd            
	//   73  144:fmul            
	//   74  145:invokestatic    #65  <Method int Math.round(float)>
	//   75  148:istore          7
		j = Math.round(255F * (f3 + f2));
	//   76  150:ldc1            #61  <Float 255F>
	//   77  152:fload           4
	//   78  154:fload_3         
	//   79  155:fadd            
	//   80  156:fmul            
	//   81  157:invokestatic    #65  <Method int Math.round(float)>
	//   82  160:istore          6
		i = Math.round(255F * f2);
	//   83  162:ldc1            #61  <Float 255F>
	//   84  164:fload_3         
	//   85  165:fmul            
	//   86  166:invokestatic    #65  <Method int Math.round(float)>
	//   87  169:istore          5
		continue; /* Loop/switch isn't completed */
	//   88  171:goto            108
_L3:
		k = Math.round(255F * (f3 + f2));
	//   89  174:ldc1            #61  <Float 255F>
	//   90  176:fload           4
	//   91  178:fload_3         
	//   92  179:fadd            
	//   93  180:fmul            
	//   94  181:invokestatic    #65  <Method int Math.round(float)>
	//   95  184:istore          7
		j = Math.round(255F * (f1 + f2));
	//   96  186:ldc1            #61  <Float 255F>
	//   97  188:fload_2         
	//   98  189:fload_3         
	//   99  190:fadd            
	//  100  191:fmul            
	//  101  192:invokestatic    #65  <Method int Math.round(float)>
	//  102  195:istore          6
		i = Math.round(255F * f2);
	//  103  197:ldc1            #61  <Float 255F>
	//  104  199:fload_3         
	//  105  200:fmul            
	//  106  201:invokestatic    #65  <Method int Math.round(float)>
	//  107  204:istore          5
		continue; /* Loop/switch isn't completed */
	//  108  206:goto            108
_L4:
		k = Math.round(255F * f2);
	//  109  209:ldc1            #61  <Float 255F>
	//  110  211:fload_3         
	//  111  212:fmul            
	//  112  213:invokestatic    #65  <Method int Math.round(float)>
	//  113  216:istore          7
		j = Math.round(255F * (f1 + f2));
	//  114  218:ldc1            #61  <Float 255F>
	//  115  220:fload_2         
	//  116  221:fload_3         
	//  117  222:fadd            
	//  118  223:fmul            
	//  119  224:invokestatic    #65  <Method int Math.round(float)>
	//  120  227:istore          6
		i = Math.round(255F * (f3 + f2));
	//  121  229:ldc1            #61  <Float 255F>
	//  122  231:fload           4
	//  123  233:fload_3         
	//  124  234:fadd            
	//  125  235:fmul            
	//  126  236:invokestatic    #65  <Method int Math.round(float)>
	//  127  239:istore          5
		continue; /* Loop/switch isn't completed */
	//  128  241:goto            108
_L5:
		k = Math.round(255F * f2);
	//  129  244:ldc1            #61  <Float 255F>
	//  130  246:fload_3         
	//  131  247:fmul            
	//  132  248:invokestatic    #65  <Method int Math.round(float)>
	//  133  251:istore          7
		j = Math.round(255F * (f3 + f2));
	//  134  253:ldc1            #61  <Float 255F>
	//  135  255:fload           4
	//  136  257:fload_3         
	//  137  258:fadd            
	//  138  259:fmul            
	//  139  260:invokestatic    #65  <Method int Math.round(float)>
	//  140  263:istore          6
		i = Math.round(255F * (f1 + f2));
	//  141  265:ldc1            #61  <Float 255F>
	//  142  267:fload_2         
	//  143  268:fload_3         
	//  144  269:fadd            
	//  145  270:fmul            
	//  146  271:invokestatic    #65  <Method int Math.round(float)>
	//  147  274:istore          5
		continue; /* Loop/switch isn't completed */
	//  148  276:goto            108
_L6:
		k = Math.round(255F * (f3 + f2));
	//  149  279:ldc1            #61  <Float 255F>
	//  150  281:fload           4
	//  151  283:fload_3         
	//  152  284:fadd            
	//  153  285:fmul            
	//  154  286:invokestatic    #65  <Method int Math.round(float)>
	//  155  289:istore          7
		j = Math.round(255F * f2);
	//  156  291:ldc1            #61  <Float 255F>
	//  157  293:fload_3         
	//  158  294:fmul            
	//  159  295:invokestatic    #65  <Method int Math.round(float)>
	//  160  298:istore          6
		i = Math.round(255F * (f1 + f2));
	//  161  300:ldc1            #61  <Float 255F>
	//  162  302:fload_2         
	//  163  303:fload_3         
	//  164  304:fadd            
	//  165  305:fmul            
	//  166  306:invokestatic    #65  <Method int Math.round(float)>
	//  167  309:istore          5
		continue; /* Loop/switch isn't completed */
	//  168  311:goto            108
_L7:
		k = Math.round(255F * (f1 + f2));
	//  169  314:ldc1            #61  <Float 255F>
	//  170  316:fload_2         
	//  171  317:fload_3         
	//  172  318:fadd            
	//  173  319:fmul            
	//  174  320:invokestatic    #65  <Method int Math.round(float)>
	//  175  323:istore          7
		j = Math.round(255F * f2);
	//  176  325:ldc1            #61  <Float 255F>
	//  177  327:fload_3         
	//  178  328:fmul            
	//  179  329:invokestatic    #65  <Method int Math.round(float)>
	//  180  332:istore          6
		i = Math.round(255F * (f3 + f2));
	//  181  334:ldc1            #61  <Float 255F>
	//  182  336:fload           4
	//  183  338:fload_3         
	//  184  339:fadd            
	//  185  340:fmul            
	//  186  341:invokestatic    #65  <Method int Math.round(float)>
	//  187  344:istore          5
...
_L8:
	...
	//*  42   85:aload           6
	//*  43   87:iconst_0        
	//*  44   88:ldc2w           #21  <Double 95.046999999999997D>
	//*  45   91:dload_2         
	//*  46   92:dmul            
	//*  47   93:dastore         
	//*  48   94:aload           6
	//*  49   96:iconst_1        
	//*  50   97:ldc2w           #24  <Double 100D>
	//*  51  100:dload_0         
	//*  52  101:dmul            
	//*  53  102:dastore         
	//*  54  103:aload           6
	//*  55  105:iconst_2        
	//*  56  106:ldc2w           #27  <Double 108.883D>
	//*  57  109:dload           4
	//*  58  111:dmul            
	//*  59  112:dastore         
	//*  60  113:return          
...
_L6:
	...
	//*  80  145:aload_3         
	//*  81  146:iconst_2        
	//*  82  147:ldc2w           #24  <Double 100D>
	//*  83  150:ldc2w           #159 <Double 0.019300000000000001D>
	//*  84  153:dload           4
	//*  85  155:dmul            
	//*  86  156:ldc2w           #161 <Double 0.1192D>
	//*  87  159:dload           6
	//*  88  161:dmul            
	//*  89  162:dadd            
	//*  90  163:ldc2w           #163 <Double 0.95050000000000001D>
	//*  91  166:dload           8
	//*  92  168:dmul            
	//*  93  169:dadd            
	//*  94  170:dmul            
	...
	//   97  173:ldc2w           #165 <Double 0.055D>
	//   98  176:dload           4
	//   99  178:dadd            
	...
	//  106  194:ldc2w           #165 <Double 0.055D>
	//  107  197:dload           6
	//  108  199:dadd            
	...
	//  115  215:ldc2w           #165 <Double 0.055D>
	//  116  218:dload           8
	//  117  220:dadd            
	...
	//  122  231:dstore          8
		...
		ad[2] = 100D * (0.019300000000000001D * d + 0.1192D * d1 + 0.95050000000000001D * d2);
	//* 123  233:goto            91
	}
	...
	//*  44   77:dcmpl           
	//*  45   78:ifle            204
			d = 1.0549999999999999D * Math.pow(d4, 0.41666666666666669D) - 0.055D;
	//   46   81:ldc2w           #167 <Double 1.0549999999999999D>
	//   47   84:dload           8
	//   48   86:ldc2w           #191 <Double 0.41666666666666669D>
	//   49   89:invokestatic    #103 <Method double Math.pow(double, double)>
	//   50   92:dmul            
	...
	//* 108  211:goto            98
			d1 = d3 * 12.92D;
	//  109  214:dload           6
	//  110  216:ldc2w           #145 <Double 12.92D>
	//  111  219:dmul            
	//  112  220:dstore_2        
		if(d2 > 0.0031308D)
	...
	//* 113  221:goto            124
			d2 *= 12.92D;
	//  114  224:dload           4
	//  115  226:ldc2w           #145 <Double 12.92D>
	//  116  229:dmul            
	//  117  230:dstore          4
...
_L3:
	...
	//   41   83:iload_3         
	//   42   84:istore          6
		if(k - i1 <= 1) goto _L4; else goto _L5
	//   43   86:iload_3         
	//   44   87:iload           5
	//   45   89:isub            
	//   46   90:iconst_1        
