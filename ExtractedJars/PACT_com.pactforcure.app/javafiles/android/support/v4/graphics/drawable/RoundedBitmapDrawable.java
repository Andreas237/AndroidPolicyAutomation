...
public abstract class RoundedBitmapDrawable extends Drawable
{
	...
	//    5    9:return          
		updateDstRect();
	//    6   10:aload_0         
	//    7   11:invokevirtual   #124 <Method void updateDstRect()>
		if(mPaint.getShader() == null)
	//*   8   14:aload_0         
	//*   9   15:getfield        #47  <Field Paint mPaint>
	//*  10   18:invokevirtual   #128 <Method android.graphics.Shader Paint.getShader()>
	//*  11   21:ifnonnull       39
		{
	...
	//   19   35:invokevirtual   #134 <Method void Canvas.drawBitmap(Bitmap, Rect, Rect, Paint)>
			return;
	//   20   38:return          
		} else
		{
	...
	//   30   56:invokevirtual   #138 <Method void Canvas.drawRoundRect(RectF, float, float, Paint)>
			return;
	//   31   59:return          
		}
	}
	...
	//    2    4:invokevirtual   #142 <Method int Paint.getAlpha()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #47  <Field Paint mPaint>
	//    2    4:invokevirtual   #148 <Method ColorFilter Paint.getColorFilter()>
	//    3    7:areturn         
	}
	...
	//*   3    6:icmpne          16
	//*   4    9:aload_0         
	//*   5   10:getfield        #156 <Field boolean mIsCircular>
	//*   6   13:ifeq            19
	//*   7   16:bipush          -3
	//*   8   18:ireturn         
	//*   9   19:aload_0         
	//*  10   20:getfield        #77  <Field Bitmap mBitmap>
	//*  11   23:astore_1        
			if((bitmap = mBitmap) != null && !bitmap.hasAlpha() && mPaint.getAlpha() >= 255 && !isGreaterThanZero(mCornerRadius))
	//*  12   24:aload_1         
	//*  13   25:ifnull          16
	//*  14   28:aload_1         
	//*  15   29:invokevirtual   #160 <Method boolean Bitmap.hasAlpha()>
	//*  16   32:ifne            16
	//*  17   35:aload_0         
	//*  18   36:getfield        #47  <Field Paint mPaint>
	//*  19   39:invokevirtual   #142 <Method int Paint.getAlpha()>
	//*  20   42:sipush          255
	//*  21   45:icmplt          16
	//*  22   48:aload_0         
	//*  23   49:getfield        #119 <Field float mCornerRadius>
	//*  24   52:invokestatic    #162 <Method boolean isGreaterThanZero(float)>
	//*  25   55:ifne            16
				return -1;
	//   26   58:iconst_m1       
	//   27   59:ireturn         
	...
	//    0    0:new             #168 <Class UnsupportedOperationException>
	//    1    3:dup             
	//    2    4:invokespecial   #169 <Method void UnsupportedOperationException()>
	//    3    7:athrow          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #47  <Field Paint mPaint>
	//    2    4:invokevirtual   #173 <Method boolean Paint.isAntiAlias()>
	//    3    7:ireturn         
	}
	...
	public boolean isCircular()
	{
		return mIsCircular;
	//    0    0:aload_0         
	//    1    1:getfield        #156 <Field boolean mIsCircular>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #179 <Method void Drawable.onBoundsChange(Rect)>
		if(mIsCircular)
	//*   3    5:aload_0         
	//*   4    6:getfield        #156 <Field boolean mIsCircular>
	//*   5    9:ifeq            16
			updateCircularCornerRadius();
	//    6   12:aload_0         
	//    7   13:invokespecial   #181 <Method void updateCircularCornerRadius()>
		mApplyGravity = true;
	//    8   16:aload_0         
	//    9   17:iconst_1        
	...
	//*   3    5:invokevirtual   #142 <Method int Paint.getAlpha()>
	//*   4    8:icmpeq          23
		{
			mPaint.setAlpha(i);
	//    5   11:aload_0         
	...
	//    7   15:iload_1         
	//    8   16:invokevirtual   #184 <Method void Paint.setAlpha(int)>
			invalidateSelf();
	//    9   19:aload_0         
	//   10   20:invokevirtual   #187 <Method void invalidateSelf()>
		}
	//   11   23:return          
	}
	...
	//    1    1:getfield        #47  <Field Paint mPaint>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #191 <Method void Paint.setAntiAlias(boolean)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #187 <Method void invalidateSelf()>
	//    6   12:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #156 <Field boolean mIsCircular>
		mApplyGravity = true;
	//    3    5:aload_0         
	//    4    6:iconst_1        
	...
	//*   7   11:ifeq            35
		{
			updateCircularCornerRadius();
	//    8   14:aload_0         
	//    9   15:invokespecial   #181 <Method void updateCircularCornerRadius()>
	...
	//   14   26:invokevirtual   #196 <Method android.graphics.Shader Paint.setShader(android.graphics.Shader)>
	//   15   29:pop             
			invalidateSelf();
	//   16   30:aload_0         
	//   17   31:invokevirtual   #187 <Method void invalidateSelf()>
			return;
	//   18   34:return          
		} else
		{
	...
	//   19   35:aload_0         
	//   20   36:fconst_0        
	//   21   37:invokevirtual   #200 <Method void setCornerRadius(float)>
			return;
	//   22   40:return          
		}
	}
	...
	//    1    1:getfield        #47  <Field Paint mPaint>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #205 <Method ColorFilter Paint.setColorFilter(ColorFilter)>
	//    4    8:pop             
		invalidateSelf();
	//    5    9:aload_0         
	//    6   10:invokevirtual   #187 <Method void invalidateSelf()>
	//    7   13:return          
	}
	...
	//    6   10:aload_0         
	//    7   11:iconst_0        
	//    8   12:putfield        #156 <Field boolean mIsCircular>
		if(isGreaterThanZero(f))
	//*   9   15:fload_1         
	//*  10   16:invokestatic    #162 <Method boolean isGreaterThanZero(float)>
	//*  11   19:ifeq            44
			mPaint.setShader(((android.graphics.Shader) (mBitmapShader)));
	//   12   22:aload_0         
	...
	//   16   30:invokevirtual   #196 <Method android.graphics.Shader Paint.setShader(android.graphics.Shader)>
	//   17   33:pop             
		else
	//*  18   34:aload_0         
	//*  19   35:fload_1         
	//*  20   36:putfield        #119 <Field float mCornerRadius>
	//*  21   39:aload_0         
	//*  22   40:invokevirtual   #187 <Method void invalidateSelf()>
	//*  23   43:return          
			mPaint.setShader(((android.graphics.Shader) (null)));
	//   24   44:aload_0         
	//   25   45:getfield        #47  <Field Paint mPaint>
	//   26   48:aconst_null     
	//   27   49:invokevirtual   #196 <Method android.graphics.Shader Paint.setShader(android.graphics.Shader)>
	//   28   52:pop             
		mCornerRadius = f;
		invalidateSelf();
	//*  29   53:goto            34
	...
	//    1    1:getfield        #47  <Field Paint mPaint>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #208 <Method void Paint.setDither(boolean)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #187 <Method void invalidateSelf()>
	//    6   12:return          
	...
	//    1    1:getfield        #47  <Field Paint mPaint>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #211 <Method void Paint.setFilterBitmap(boolean)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #187 <Method void invalidateSelf()>
	//    6   12:return          
	...
	//    9   15:putfield        #64  <Field boolean mApplyGravity>
			invalidateSelf();
	//   10   18:aload_0         
	//   11   19:invokevirtual   #187 <Method void invalidateSelf()>
		}
	//   12   22:return          
	}
	...
	//   17   31:invokespecial   #80  <Method void computeBitmapSize()>
			invalidateSelf();
	//   18   34:aload_0         
	//   19   35:invokevirtual   #187 <Method void invalidateSelf()>
		}
	//   20   38:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #217 <Method int Canvas.getDensity()>
	//    3    5:invokevirtual   #219 <Method void setTargetDensity(int)>
	//    4    8:return          
	}
	...
	//*   2    4:ifeq            219
		{
			if(mIsCircular)
	//*   3    7:aload_0         
	//*   4    8:getfield        #156 <Field boolean mIsCircular>
	//*   5   11:ifeq            220
			{
	...
	//   16   32:iload_1         
	//   17   33:aload_0         
	//   18   34:invokevirtual   #224 <Method Rect getBounds()>
	//   19   37:aload_0         
	//   20   38:getfield        #57  <Field Rect mDstRect>
	//   21   41:invokevirtual   #226 <Method void gravityCompatApply(int, int, int, Rect, Rect)>
				i = Math.min(mDstRect.width(), mDstRect.height());
	//   22   44:aload_0         
	//   23   45:getfield        #57  <Field Rect mDstRect>
	//   24   48:invokevirtual   #229 <Method int Rect.width()>
	//   25   51:aload_0         
	//   26   52:getfield        #57  <Field Rect mDstRect>
	//   27   55:invokevirtual   #232 <Method int Rect.height()>
	...
	//   33   67:invokevirtual   #229 <Method int Rect.width()>
	//   34   70:iload_1         
	//   35   71:isub            
	//   36   72:iconst_2        
	//   37   73:idiv            
	//   38   74:invokestatic    #235 <Method int Math.max(int, int)>
	//   39   77:istore_2        
				int k = Math.max(0, (mDstRect.height() - i) / 2);
	//   40   78:iconst_0        
	//   41   79:aload_0         
	//   42   80:getfield        #57  <Field Rect mDstRect>
	//   43   83:invokevirtual   #232 <Method int Rect.height()>
	//   44   86:iload_1         
	//   45   87:isub            
	//   46   88:iconst_2        
	//   47   89:idiv            
	//   48   90:invokestatic    #235 <Method int Math.max(int, int)>
	//   49   93:istore_3        
				mDstRect.inset(j, k);
	//   50   94:aload_0         
	...
	//   52   98:iload_2         
	//   53   99:iload_3         
	//   54  100:invokevirtual   #239 <Method void Rect.inset(int, int)>
				mCornerRadius = 0.5F * (float)i;
	//   55  103:aload_0         
	//   56  104:ldc1            #240 <Float 0.5F>
	//   57  106:iload_1         
	//   58  107:i2f             
	//   59  108:fmul            
	...
	//*  61  112:aload_0         
	//*  62  113:getfield        #62  <Field RectF mDstRectF>
	//*  63  116:aload_0         
	//*  64  117:getfield        #57  <Field Rect mDstRect>
	//*  65  120:invokevirtual   #243 <Method void RectF.set(Rect)>
	//*  66  123:aload_0         
	//*  67  124:getfield        #93  <Field BitmapShader mBitmapShader>
	//*  68  127:ifnull          214
	//*  69  130:aload_0         
	//*  70  131:getfield        #52  <Field Matrix mShaderMatrix>
	//*  71  134:aload_0         
	//*  72  135:getfield        #62  <Field RectF mDstRectF>
	//*  73  138:getfield        #246 <Field float RectF.left>
	//*  74  141:aload_0         
	//*  75  142:getfield        #62  <Field RectF mDstRectF>
	//*  76  145:getfield        #249 <Field float RectF.top>
	//*  77  148:invokevirtual   #253 <Method void Matrix.setTranslate(float, float)>
	//*  78  151:aload_0         
	//*  79  152:getfield        #52  <Field Matrix mShaderMatrix>
	//*  80  155:aload_0         
	//*  81  156:getfield        #62  <Field RectF mDstRectF>
	//*  82  159:invokevirtual   #255 <Method float RectF.width()>
	//*  83  162:aload_0         
	//*  84  163:getfield        #77  <Field Bitmap mBitmap>
	//*  85  166:invokevirtual   #258 <Method int Bitmap.getWidth()>
	//*  86  169:i2f             
	//*  87  170:fdiv            
	//*  88  171:aload_0         
	//*  89  172:getfield        #62  <Field RectF mDstRectF>
	//*  90  175:invokevirtual   #260 <Method float RectF.height()>
	//*  91  178:aload_0         
	//*  92  179:getfield        #77  <Field Bitmap mBitmap>
	//*  93  182:invokevirtual   #263 <Method int Bitmap.getHeight()>
	//*  94  185:i2f             
	//*  95  186:fdiv            
	//*  96  187:invokevirtual   #267 <Method boolean Matrix.preScale(float, float)>
	//*  97  190:pop             
	//*  98  191:aload_0         
	//*  99  192:getfield        #93  <Field BitmapShader mBitmapShader>
	//* 100  195:aload_0         
	//* 101  196:getfield        #52  <Field Matrix mShaderMatrix>
	//* 102  199:invokevirtual   #271 <Method void BitmapShader.setLocalMatrix(Matrix)>
	//* 103  202:aload_0         
	//* 104  203:getfield        #47  <Field Paint mPaint>
	//* 105  206:aload_0         
	//* 106  207:getfield        #93  <Field BitmapShader mBitmapShader>
	//* 107  210:invokevirtual   #196 <Method android.graphics.Shader Paint.setShader(android.graphics.Shader)>
	//* 108  213:pop             
	//* 109  214:aload_0         
	//* 110  215:iconst_0        
	//* 111  216:putfield        #64  <Field boolean mApplyGravity>
	//* 112  219:return          
			{
				gravityCompatApply(mGravity, mBitmapWidth, mBitmapHeight, getBounds(), mDstRect);
	//  113  220:aload_0         
	//  114  221:aload_0         
	//  115  222:getfield        #40  <Field int mGravity>
	//  116  225:aload_0         
	//  117  226:getfield        #97  <Field int mBitmapWidth>
	//  118  229:aload_0         
	//  119  230:getfield        #95  <Field int mBitmapHeight>
	//  120  233:aload_0         
	//  121  234:invokevirtual   #224 <Method Rect getBounds()>
	//  122  237:aload_0         
	//  123  238:getfield        #57  <Field Rect mDstRect>
	//  124  241:invokevirtual   #226 <Method void gravityCompatApply(int, int, int, Rect, Rect)>
			}
