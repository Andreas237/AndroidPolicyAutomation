...
public abstract class FragmentPagerAdapter extends PagerAdapter
{
	...
	//*  31   63:aload_1         
	//*  32   64:aload_0         
	//*  33   65:getfield        #26  <Field Fragment mCurrentPrimaryItem>
	//*  34   68:if_acmpeq       81
	//*  35   71:aload_1         
	//*  36   72:iconst_0        
	//*  37   73:invokevirtual   #100 <Method void Fragment.setMenuVisibility(boolean)>
	//*  38   76:aload_1         
	//*  39   77:iconst_0        
	//*  40   78:invokevirtual   #103 <Method void Fragment.setUserVisibleHint(boolean)>
	//*  41   81:aload_1         
	//*  42   82:areturn         
		{
	...
	//   43   83:aload_0         
	//   44   84:iload_2         
	//   45   85:invokevirtual   #105 <Method Fragment getItem(int)>
	//   46   88:astore          5
			mCurTransaction.add(viewgroup.getId(), fragment, makeFragmentName(viewgroup.getId(), l));
	//   47   90:aload_0         
	//   48   91:getfield        #24  <Field FragmentTransaction mCurTransaction>
	//   49   94:aload_1         
	//   50   95:invokevirtual   #87  <Method int ViewGroup.getId()>
	//   51   98:aload           5
	//   52  100:aload_1         
	//   53  101:invokevirtual   #87  <Method int ViewGroup.getId()>
	//   54  104:lload_3         
	//   55  105:invokestatic    #89  <Method String makeFragmentName(int, long)>
	//   56  108:invokevirtual   #109 <Method FragmentTransaction FragmentTransaction.add(int, Fragment, String)>
	//   57  111:pop             
	...
	//   12   24:iconst_0        
	//   13   25:invokevirtual   #100 <Method void Fragment.setMenuVisibility(boolean)>
				mCurrentPrimaryItem.setUserVisibleHint(false);
	//   14   28:aload_0         
	//   15   29:getfield        #26  <Field Fragment mCurrentPrimaryItem>
	//   16   32:iconst_0        
	//   17   33:invokevirtual   #103 <Method void Fragment.setUserVisibleHint(boolean)>
			}
			if(viewgroup != null)
	//*  18   36:aload_1         
	//*  19   37:ifnull          50
	...
	//   20   40:aload_1         
	//   21   41:iconst_1        
	//   22   42:invokevirtual   #100 <Method void Fragment.setMenuVisibility(boolean)>
				((Fragment) (viewgroup)).setUserVisibleHint(true);
	//   23   45:aload_1         
	//   24   46:iconst_1        
	//   25   47:invokevirtual   #103 <Method void Fragment.setUserVisibleHint(boolean)>
			}
