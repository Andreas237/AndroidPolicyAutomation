...
//			NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions, NotificationCompatKitKat, NotificationCompatJellybean

public static class NotificationCompatKitKat$Builder
	implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #31  <Field List mActionExtrasList>
	//    2    4:invokestatic    #250 <Method android.util.SparseArray NotificationCompatJellybean.buildActionExtrasMap(List)>
	//    3    7:astore_1        
		if(obj != null)
	//*   4    8:aload_1         
	//*   5    9:ifnull          22
	...
	//    9   18:aload_1         
	//   10   19:invokevirtual   #256 <Method void Bundle.putSparseParcelableArray(String, android.util.SparseArray)>
		b.setExtras(mExtras);
	//   11   22:aload_0         
	...
	public NotificationCompatKitKat$Builder(Context context, Notification notification, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, RemoteViews remoteviews, int i, 
