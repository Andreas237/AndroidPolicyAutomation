...
public final class NavUtils
{
	...
	//   15   28:aconst_null     
	//   16   29:areturn         
		componentname = new ComponentName(((Context) (activity)), s);
...
label0:
	...
	//*  26   45:ifnonnull       56
			{
				activity = ((Activity) (Intent.makeMainActivity(componentname)));
	//   27   48:aload_2         
	...
	//   31   56:new             #45  <Class Intent>
	//   32   59:dup             
	//   33   60:invokespecial   #50  <Method void Intent()>
	//   34   63:aload_2         
	//   35   64:invokevirtual   #53  <Method Intent Intent.setComponent(ComponentName)>
	//   36   67:astore_0        
			}
	//*  37   68:goto            104
	...
	//   39   72:ldc1            #11  <String "NavUtils">
	//   40   74:new             #55  <Class StringBuilder>
	//   41   77:dup             
	//   42   78:invokespecial   #56  <Method void StringBuilder()>
	//   43   81:ldc1            #58  <String "getParentActivityIntent: bad parentActivityName '">
	//   44   83:invokevirtual   #62  <Method StringBuilder StringBuilder.append(String)>
	//   45   86:aload_1         
	//   46   87:invokevirtual   #62  <Method StringBuilder StringBuilder.append(String)>
	//   47   90:ldc1            #64  <String "' in manifest">
	//   48   92:invokevirtual   #62  <Method StringBuilder StringBuilder.append(String)>
	//   49   95:invokevirtual   #68  <Method String StringBuilder.toString()>
	//   50   98:invokestatic    #74  <Method int Log.e(String, String)>
	//   51  101:pop             
				return null;
	//   52  102:aconst_null     
	//   53  103:areturn         
	...
	//*  35   63:bipush          46
	//*  36   65:icmpne          90
			componentname = ((ComponentName) ((new StringBuilder()).append(context.getPackageName()).append(s1).toString()));
