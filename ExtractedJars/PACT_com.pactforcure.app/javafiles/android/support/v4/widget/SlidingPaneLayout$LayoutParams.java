...
public static class SlidingPaneLayout$LayoutParams extends android.view.ViewGroup.MarginLayoutParams
{
	...
	public SlidingPaneLayout$LayoutParams(int i, int j)
	{
		super(i, j);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	{
		super(((android.view.ViewGroup.MarginLayoutParams) (slidingpanelayout$layoutparams)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//    5    7:putfield        #28  <Field float weight>
		weight = slidingpanelayout$layoutparams.weight;
	//    6   10:aload_0         
	//    7   11:aload_1         
