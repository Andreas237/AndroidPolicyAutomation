...
_L3:
	...
	//   15   27:aload           4
	//   16   29:aload_0         
	//   17   30:invokestatic    #143 <Method String MediaDescriptionCompatApi21.getMediaId(Object)>
	//   18   33:invokevirtual   #147 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setMediaId(String)>
	//   19   36:pop             
		builder.setTitle(MediaDescriptionCompatApi21.getTitle(obj));
	//   20   37:aload           4
	//   21   39:aload_0         
	//   22   40:invokestatic    #151 <Method CharSequence MediaDescriptionCompatApi21.getTitle(Object)>
	//   23   43:invokevirtual   #155 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setTitle(CharSequence)>
	//   24   46:pop             
		builder.setSubtitle(MediaDescriptionCompatApi21.getSubtitle(obj));
	//   25   47:aload           4
	//   26   49:aload_0         
	//   27   50:invokestatic    #158 <Method CharSequence MediaDescriptionCompatApi21.getSubtitle(Object)>
	//   28   53:invokevirtual   #161 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setSubtitle(CharSequence)>
	//   29   56:pop             
		builder.setDescription(MediaDescriptionCompatApi21.getDescription(obj));
	//   30   57:aload           4
	//   31   59:aload_0         
	//   32   60:invokestatic    #164 <Method CharSequence MediaDescriptionCompatApi21.getDescription(Object)>
	//   33   63:invokevirtual   #167 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setDescription(CharSequence)>
	//   34   66:pop             
		builder.setIconBitmap(MediaDescriptionCompatApi21.getIconBitmap(obj));
	//   35   67:aload           4
	//   36   69:aload_0         
	//   37   70:invokestatic    #171 <Method Bitmap MediaDescriptionCompatApi21.getIconBitmap(Object)>
	//   38   73:invokevirtual   #175 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setIconBitmap(Bitmap)>
	//   39   76:pop             
		builder.setIconUri(MediaDescriptionCompatApi21.getIconUri(obj));
	//   40   77:aload           4
	//   41   79:aload_0         
	//   42   80:invokestatic    #179 <Method Uri MediaDescriptionCompatApi21.getIconUri(Object)>
	//   43   83:invokevirtual   #183 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setIconUri(Uri)>
	//   44   86:pop             
		Bundle bundle1 = MediaDescriptionCompatApi21.getExtras(obj);
	//   45   87:aload_0         
	//   46   88:invokestatic    #187 <Method Bundle MediaDescriptionCompatApi21.getExtras(Object)>
	//   47   91:astore_3        
		Bundle bundle;
		if(bundle1 == null)
	//*  48   92:aload_3         
	...
	//*  55  101:ifnull          123
	//*  56  104:aload_3         
	//*  57  105:ldc1            #47  <String "android.support.v4.media.description.NULL_BUNDLE_FLAG">
	//*  58  107:invokevirtual   #193 <Method boolean Bundle.containsKey(String)>
	//*  59  110:ifeq            167
	//*  60  113:aload_3         
	//*  61  114:invokevirtual   #197 <Method int Bundle.size()>
	//*  62  117:iconst_2        
	//*  63  118:icmpne          167
	//*  64  121:aconst_null     
	//*  65  122:astore_2        
	//*  66  123:aload           4
	//*  67  125:aload_2         
	//*  68  126:invokevirtual   #201 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setExtras(Bundle)>
	//*  69  129:pop             
	//*  70  130:aload_1         
	//*  71  131:ifnull          184
	//*  72  134:aload           4
	//*  73  136:aload_1         
	//*  74  137:invokevirtual   #204 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setMediaUri(Uri)>
	//*  75  140:pop             
	//*  76  141:aload           4
	//*  77  143:invokevirtual   #208 <Method MediaDescriptionCompat MediaDescriptionCompat$Builder.build()>
	//*  78  146:astore_1        
	//*  79  147:aload_1         
	//*  80  148:aload_0         
	//*  81  149:putfield        #210 <Field Object mDescriptionObj>
	//*  82  152:aload_1         
	//*  83  153:areturn         
			obj1 = ((Object) ((Uri)bundle1.getParcelable("android.support.v4.media.description.MEDIA_URI")));
	//   84  154:aload_3         
	//   85  155:ldc1            #40  <String "android.support.v4.media.description.MEDIA_URI">
	//   86  157:invokevirtual   #214 <Method Parcelable Bundle.getParcelable(String)>
	//   87  160:checkcast       #117 <Class Uri>
	//   88  163:astore_1        
		bundle = bundle1;
		if(obj1 != null)
	...
	//   90  167:aload_3         
	//   91  168:ldc1            #40  <String "android.support.v4.media.description.MEDIA_URI">
	//   92  170:invokevirtual   #218 <Method void Bundle.remove(String)>
				bundle1.remove("android.support.v4.media.description.NULL_BUNDLE_FLAG");
	//   93  173:aload_3         
	//   94  174:ldc1            #47  <String "android.support.v4.media.description.NULL_BUNDLE_FLAG">
	//   95  176:invokevirtual   #218 <Method void Bundle.remove(String)>
				bundle = bundle1;
	//   96  179:aload_3         
	//   97  180:astore_2        
			}
...
_L5:
	...
	//*  99  184:getstatic       #136 <Field int android.os.Build$VERSION.SDK_INT>
	//* 100  187:bipush          23
	//* 101  189:icmplt          141
			builder.setMediaUri(MediaDescriptionCompatApi23.getMediaUri(obj));
	//  102  192:aload           4
	//  103  194:aload_0         
	//  104  195:invokestatic    #223 <Method Uri MediaDescriptionCompatApi23.getMediaUri(Object)>
	//  105  198:invokevirtual   #204 <Method MediaDescriptionCompat$Builder MediaDescriptionCompat$Builder.setMediaUri(Uri)>
	//  106  201:pop             
