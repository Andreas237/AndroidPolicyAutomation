...
public class MediaSessionCompat
{
	public static abstract class Callback
	{
		...
		//   18   33:invokevirtual   #149 <Method Parcelable Intent.getParcelableExtra(String)>
...
_L1:
		...
		//   30   59:aload_1         
		//   31   60:invokestatic    #70  <Method void BundleCompat.putBinder(Bundle, String, IBinder)>
		...
		//*  37   70:aload_1         
		//*  38   71:invokeinterface #82  <Method IBinder IMediaSession.asBinder()>
		//*  39   76:astore_1        
		//*  40   77:goto            56
		//*  41   80:aload_1         
		...
		//*  53  105:invokevirtual   #102 <Method Parcelable Bundle.getParcelable(String)>
		...
		//   75  150:invokevirtual   #102 <Method Parcelable Bundle.getParcelable(String)>
		...
		//   94  191:invokevirtual   #102 <Method Parcelable Bundle.getParcelable(String)>
...
;
	...
	//*   1    1:ifnull          15
	//*   2    4:aload_0         
	//*   3    5:invokevirtual   #319 <Method long PlaybackStateCompat.getPosition()>
	//*   4    8:ldc2w           #320 <Long -1L>
	//*   5   11:lcmp            
	//*   6   12:ifne            17
_L2:
		return playbackstatecompat;
	...
	//    9   17:aload_0         
	//   10   18:invokevirtual   #325 <Method int PlaybackStateCompat.getState()>
	//   11   21:iconst_3        
	//   12   22:icmpeq          41
	//   13   25:aload_0         
	//   14   26:invokevirtual   #325 <Method int PlaybackStateCompat.getState()>
	//   15   29:iconst_4        
	//   16   30:icmpeq          41
	//   17   33:aload_0         
	//   18   34:invokevirtual   #325 <Method int PlaybackStateCompat.getState()>
	//   19   37:iconst_5        
	//   20   38:icmpne          15
_L1:
		long l = playbackstatecompat.getLastPositionUpdateTime();
	//   21   41:aload_0         
	//   22   42:invokevirtual   #328 <Method long PlaybackStateCompat.getLastPositionUpdateTime()>
	//   23   45:lstore_2        
...
_L3:
	...
	//   28   52:invokestatic    #333 <Method long SystemClock.elapsedRealtime()>
	//   29   55:lstore          8
		l1 = (long)(playbackstatecompat.getPlaybackSpeed() * (float)(l3 - l)) + playbackstatecompat.getPosition();
	//   30   57:aload_0         
	//   31   58:invokevirtual   #337 <Method float PlaybackStateCompat.getPlaybackSpeed()>
	//   32   61:lload           8
	//   33   63:lload_2         
	//   34   64:lsub            
	//   35   65:l2f             
	...
	//   37   67:f2l             
	//   38   68:aload_0         
	//   39   69:invokevirtual   #319 <Method long PlaybackStateCompat.getPosition()>
	//   40   72:ladd            
	//   41   73:lstore          4
		long l2 = -1L;
	//   42   75:ldc2w           #320 <Long -1L>
	//   43   78:lstore          6
		l = l2;
	//   44   80:lload           6
	//   45   82:lstore_2        
