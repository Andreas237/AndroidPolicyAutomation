...
class FontsContractCompat$4$7
	implements Runnable
{

	public void run()
	{
		val$callback.onTypefaceRequestFailed(val$resultCode);
	//    0    0:aload_0         
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//*  74  155:icmpge          223
			{
				FontsContractCompat.FontInfo fontinfo = afontinfo[i];
		//   75  158:aload_3         
		//   76  159:iload_1         
		//   77  160:aaload          
		//   78  161:astore          4
		...
		//   95  197:return          
					...
					{
						callerThreadHandler.post(((Runnable) (((FontsContractCompat._cls4._cls7) (i)). new FontsContractCompat._cls4._cls7())));
		//   96  198:aload_0         
