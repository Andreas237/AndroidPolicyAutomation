	...
	implements Runnable
{
	...
	public void run()
	{
		...
		try
		{
			typeface = ((Typeface) (FontsContractCompat.fetchFonts(val$context, ((android.os.CancellationSignal) (null)), val$request)));
	//    0    0:aload_0         
	...
	//   31   82:return          
		...
		if(((ntFamilyResult) (typeface)).getStatusCode() != 0)
		{
			switch(((ntFamilyResult) (typeface)).getStatusCode())
			{
			default:
				val$callerThreadHandler.post(new Runnable() {
	...
	//   49  116:return          
		...
		ntInfo antinfo[] = ((ntFamilyResult) (typeface)).getFonts();
	//   50  117:aload_3         
	...
	//  109  219:istore_1        
	//* 110  220:goto            153
		antinfo = ((ntInfo []) (FontsContractCompat.buildTypeface(val$context, ((android.os.CancellationSignal) (null)), antinfo)));
	//  111  223:aload_0         
