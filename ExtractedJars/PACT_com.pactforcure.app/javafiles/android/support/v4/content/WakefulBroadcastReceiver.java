...
public abstract class WakefulBroadcastReceiver extends BroadcastReceiver
{
	...
	//   27   48:iconst_1        
	//   28   49:ireturn         
		Log.w("WakefulBroadcastReceiv.", (new StringBuilder()).append("No active wake lock id #").append(i).toString());
	//   29   50:ldc1            #50  <String "WakefulBroadcastReceiv.">
	...
	//   51   98:getstatic       #23  <Field SparseArray sActiveWakeLocks>
	//   52  101:iload_2         
	//   53  102:aload_0         
