...
public final class IntentCompat
{
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #61  <Method Intent Intent.makeMainActivity(ComponentName)>
	//    2    4:areturn         
	}
	...
	//    0    0:getstatic       #52  <Field IntentCompat$IntentCompatBaseImpl IMPL>
	//    1    3:aload_0         
	//    2    4:aload_1         
	//    3    5:invokevirtual   #66  <Method Intent IntentCompat$IntentCompatBaseImpl.makeMainSelectorActivity(String, String)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #69  <Method Intent Intent.makeRestartActivityTask(ComponentName)>
	//    2    4:areturn         
	}
	...
	//    4   11:dup             
	//    5   12:invokespecial   #50  <Method void IntentCompat$IntentCompatApi15Impl()>
	//    6   15:putstatic       #52  <Field IntentCompat$IntentCompatBaseImpl IMPL>
	//    7   18:return          
		else
			IMPL = new IntentCompatBaseImpl();
	//    8   19:new             #9   <Class IntentCompat$IntentCompatBaseImpl>
	//    9   22:dup             
	//   10   23:invokespecial   #53  <Method void IntentCompat$IntentCompatBaseImpl()>
	//   11   26:putstatic       #52  <Field IntentCompat$IntentCompatBaseImpl IMPL>
	//*  12   29:return          
	}
}
