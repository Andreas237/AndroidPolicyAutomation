...
_L1:
	...
	//    7   13:invokevirtual   #36  <Method Object Context.getSystemService(Class)>
	//    8   16:checkcast       #30  <Class ShortcutManager>
	//    9   19:invokevirtual   #59  <Method boolean ShortcutManager.isRequestPinShortcutSupported()>
	//   10   22:istore_1        
_L4:
		return flag;
	//   11   23:iload_1         
...
_L2:
	...
	//   15   27:aload_0         
	//   16   28:ldc1            #14  <String "com.android.launcher.permission.INSTALL_SHORTCUT">
	//   17   30:invokestatic    #65  <Method int ContextCompat.checkSelfPermission(Context, String)>
	//   18   33:ifne            23
		context = ((Context) (context.getPackageManager().queryBroadcastReceivers(new Intent("com.android.launcher.action.INSTALL_SHORTCUT"), 0).iterator()));
	//   19   36:aload_0         
	//   20   37:invokevirtual   #69  <Method PackageManager Context.getPackageManager()>
	//   21   40:new             #47  <Class Intent>
	//   22   43:dup             
	//   23   44:ldc1            #10  <String "com.android.launcher.action.INSTALL_SHORTCUT">
	//   24   46:invokespecial   #72  <Method void Intent(String)>
	//   25   49:iconst_0        
	//   26   50:invokevirtual   #78  <Method List PackageManager.queryBroadcastReceivers(Intent, int)>
	//   27   53:invokeinterface #84  <Method Iterator List.iterator()>
	//   28   58:astore_0        
		do
		{
			flag = flag1;
	...
	//   30   60:istore_1        
			if(!((Iterator) (context)).hasNext())
				continue; /* Loop/switch isn't completed */
	//   31   61:aload_0         
	//   32   62:invokeinterface #89  <Method boolean Iterator.hasNext()>
	//   33   67:ifeq            23
			String s = ((ResolveInfo)((Iterator) (context)).next()).activityInfo.permission;
	//   34   70:aload_0         
	//   35   71:invokeinterface #93  <Method Object Iterator.next()>
	//   36   76:checkcast       #95  <Class ResolveInfo>
	//   37   79:getfield        #99  <Field ActivityInfo ResolveInfo.activityInfo>
	//   38   82:getfield        #104 <Field String ActivityInfo.permission>
	//   39   85:astore_3        
			if(TextUtils.isEmpty(((CharSequence) (s))) || "com.android.launcher.permission.INSTALL_SHORTCUT".equals(((Object) (s))))
	//*  40   86:aload_3         
	//*  41   87:invokestatic    #110 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  42   90:ifne            102
	//*  43   93:ldc1            #14  <String "com.android.launcher.permission.INSTALL_SHORTCUT">
	//*  44   95:aload_3         
	//*  45   96:invokevirtual   #116 <Method boolean String.equals(Object)>
	//*  46   99:ifeq            59
				return true;
	//   47  102:iconst_1        
	//   48  103:ireturn         
