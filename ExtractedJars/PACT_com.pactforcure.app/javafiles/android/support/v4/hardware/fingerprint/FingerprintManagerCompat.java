...
public final class FingerprintManagerCompat
{
		...
		implements FingerprintManagerCompatImpl
	{
		...
		//*   4    6:aload_0         
		//*   5    7:invokevirtual   #27  <Method Cipher FingerprintManagerCompatApi23$CryptoObject.getCipher()>
		//*   6   10:ifnull          25
					return new CryptoObject(cryptoobject.getCipher());
		//    7   13:new             #29  <Class FingerprintManagerCompat$CryptoObject>
		//    8   16:dup             
		//    9   17:aload_0         
		//   10   18:invokevirtual   #27  <Method Cipher FingerprintManagerCompatApi23$CryptoObject.getCipher()>
		//   11   21:invokespecial   #32  <Method void FingerprintManagerCompat$CryptoObject(Cipher)>
		//   12   24:areturn         
				if(cryptoobject.getSignature() != null)
		//*  13   25:aload_0         
		//*  14   26:invokevirtual   #36  <Method Signature FingerprintManagerCompatApi23$CryptoObject.getSignature()>
		//*  15   29:ifnull          44
					return new CryptoObject(cryptoobject.getSignature());
		//   16   32:new             #29  <Class FingerprintManagerCompat$CryptoObject>
		//   17   35:dup             
		//   18   36:aload_0         
		//   19   37:invokevirtual   #36  <Method Signature FingerprintManagerCompatApi23$CryptoObject.getSignature()>
		//   20   40:invokespecial   #39  <Method void FingerprintManagerCompat$CryptoObject(Signature)>
		//   21   43:areturn         
				if(cryptoobject.getMac() != null)
		//*  22   44:aload_0         
		//*  23   45:invokevirtual   #43  <Method Mac FingerprintManagerCompatApi23$CryptoObject.getMac()>
		//*  24   48:ifnull          4
					return new CryptoObject(cryptoobject.getMac());
		//   25   51:new             #29  <Class FingerprintManagerCompat$CryptoObject>
		//   26   54:dup             
		//   27   55:aload_0         
		//   28   56:invokevirtual   #43  <Method Mac FingerprintManagerCompatApi23$CryptoObject.getMac()>
		//   29   59:invokespecial   #46  <Method void FingerprintManagerCompat$CryptoObject(Mac)>
		//   30   62:areturn         
			}
			return null;
		}
		...
		//*   3    5:areturn         
			{
				if(cryptoobject.getCipher() != null)
		//*   4    6:aload_0         
		//*   5    7:invokevirtual   #54  <Method Cipher FingerprintManagerCompat$CryptoObject.getCipher()>
		//*   6   10:ifnull          25
		...
		//    8   16:dup             
		//    9   17:aload_0         
		//   10   18:invokevirtual   #54  <Method Cipher FingerprintManagerCompat$CryptoObject.getCipher()>
		//   11   21:invokespecial   #55  <Method void FingerprintManagerCompatApi23$CryptoObject(Cipher)>
		//   12   24:areturn         
				if(cryptoobject.getSignature() != null)
		//*  13   25:aload_0         
		//*  14   26:invokevirtual   #56  <Method Signature FingerprintManagerCompat$CryptoObject.getSignature()>
		//*  15   29:ifnull          44
		...
		//   17   35:dup             
		//   18   36:aload_0         
		//   19   37:invokevirtual   #56  <Method Signature FingerprintManagerCompat$CryptoObject.getSignature()>
		//   20   40:invokespecial   #57  <Method void FingerprintManagerCompatApi23$CryptoObject(Signature)>
		//   21   43:areturn         
				if(cryptoobject.getMac() != null)
		//*  22   44:aload_0         
		//*  23   45:invokevirtual   #58  <Method Mac FingerprintManagerCompat$CryptoObject.getMac()>
		//*  24   48:ifnull          4
		...
		//   26   54:dup             
		//   27   55:aload_0         
		//   28   56:invokevirtual   #58  <Method Mac FingerprintManagerCompat$CryptoObject.getMac()>
		//   29   59:invokespecial   #59  <Method void FingerprintManagerCompatApi23$CryptoObject(Mac)>
		//   30   62:areturn         
			}
			return null;
		}
