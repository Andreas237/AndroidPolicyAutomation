	...
	implements android.content.DialogInterface.OnClickListener
{
	...
	//    7   16:astore_1        
			mPreference = (DialogPreference)((DialogPreference.TargetFragment)getTargetFragment()).findPreference(((CharSequence) (s)));
	//    8   17:aload_0         
	//    9   18:aload_0         
	//   10   19:invokevirtual   #78  <Method android.support.v4.app.Fragment getTargetFragment()>
	//   11   22:checkcast       #80  <Class DialogPreference$TargetFragment>
	//   12   25:aload_1         
	//   13   26:invokeinterface #84  <Method Preference DialogPreference$TargetFragment.findPreference(CharSequence)>
	...
	//    3    5:aload_0         
	//    4    6:invokevirtual   #78  <Method android.support.v4.app.Fragment getTargetFragment()>
	//    5    9:astore_2        
		if(!(obj instanceof DialogPreference.TargetFragment))
	//*   6   10:aload_2         
	//*   7   11:instanceof      #80  <Class DialogPreference$TargetFragment>
	//*   8   14:ifne            27
	...
	//   13   26:athrow          
		obj = ((Object) ((DialogPreference.TargetFragment)obj));
	//   14   27:aload_2         
	//   15   28:checkcast       #80  <Class DialogPreference$TargetFragment>
	//   16   31:astore_2        
	...
	//   23   43:ifnonnull       203
_L1:
		mPreference = (DialogPreference)((DialogPreference.TargetFragment) (obj)).findPreference(((CharSequence) (s)));
	//   24   46:aload_0         
	//   25   47:aload_2         
	//   26   48:aload_3         
	//   27   49:invokeinterface #84  <Method Preference DialogPreference$TargetFragment.findPreference(CharSequence)>
...
_L5:
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #235 <Method android.support.v4.app.FragmentActivity getActivity()>
	//    2    4:astore_2        
		mWhichButtonClicked = -2;
	//    3    5:aload_0         
	//    4    6:bipush          -2
	//    5    8:putfield        #127 <Field int mWhichButtonClicked>
		bundle = ((Bundle) ((new android.support.v7.app.AlertDialog.Builder(((Context) (obj)))).setTitle(mDialogTitle).setIcon(((Drawable) (mDialogIcon))).setPositiveButton(mPositiveButtonText, ((android.content.DialogInterface.OnClickListener) (this))).setNegativeButton(mNegativeButtonText, ((android.content.DialogInterface.OnClickListener) (this)))));
	//    6   11:new             #237 <Class android.support.v7.app.AlertDialog$Builder>
	//    7   14:dup             
	//    8   15:aload_2         
	//    9   16:invokespecial   #240 <Method void android.support.v7.app.AlertDialog$Builder(Context)>
	//   10   19:aload_0         
	//   11   20:getfield        #144 <Field CharSequence mDialogTitle>
	//   12   23:invokevirtual   #244 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setTitle(CharSequence)>
	//   13   26:aload_0         
	//   14   27:getfield        #170 <Field BitmapDrawable mDialogIcon>
	//   15   30:invokevirtual   #248 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setIcon(Drawable)>
	//   16   33:aload_0         
	//   17   34:getfield        #149 <Field CharSequence mPositiveButtonText>
	//   18   37:aload_0         
	//   19   38:invokevirtual   #252 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setPositiveButton(CharSequence, android.content.DialogInterface$OnClickListener)>
	//   20   41:aload_0         
	//   21   42:getfield        #154 <Field CharSequence mNegativeButtonText>
	//   22   45:aload_0         
	//   23   46:invokevirtual   #255 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setNegativeButton(CharSequence, android.content.DialogInterface$OnClickListener)>
	//   24   49:astore_1        
	...
	//   33   62:invokevirtual   #261 <Method void onBindDialogView(View)>
			((android.support.v7.app.AlertDialog.Builder) (bundle)).setView(((View) (obj)));
	//   34   65:aload_1         
	//   35   66:aload_2         
	//   36   67:invokevirtual   #265 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setView(View)>
	//   37   70:pop             
		} else
	//*  38   71:aload_0         
	//*  39   72:aload_1         
	//*  40   73:invokevirtual   #269 <Method void onPrepareDialogBuilder(android.support.v7.app.AlertDialog$Builder)>
	//*  41   76:aload_1         
	//*  42   77:invokevirtual   #273 <Method android.support.v7.app.AlertDialog android.support.v7.app.AlertDialog$Builder.create()>
	//*  43   80:astore_1        
	//*  44   81:aload_0         
	...
	//*  51   94:areturn         
		{
			((android.support.v7.app.AlertDialog.Builder) (bundle)).setMessage(mDialogMessage);
	//   52   95:aload_1         
	//   53   96:aload_0         
	//   54   97:getfield        #104 <Field CharSequence mDialogMessage>
	//   55  100:invokevirtual   #280 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setMessage(CharSequence)>
	//   56  103:pop             
		}
		onPrepareDialogBuilder(((android.support.v7.app.AlertDialog.Builder) (bundle)));
		bundle = ((Bundle) (((android.support.v7.app.AlertDialog.Builder) (bundle)).create()));
		if(needInputMethod())
