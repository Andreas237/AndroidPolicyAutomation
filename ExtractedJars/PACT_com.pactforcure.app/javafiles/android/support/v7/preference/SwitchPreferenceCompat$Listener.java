...
private class SwitchPreferenceCompat$Listener
	implements android.widget.stener
{
	...
	private SwitchPreferenceCompat$Listener()
	{
	...
	SwitchPreferenceCompat$Listener(SwitchPreferenceCompat._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #22  <Method void SwitchPreferenceCompat$Listener(SwitchPreferenceCompat)>
	//    3    5:return          
	}
}
