...
public class MultiSelectListPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #31  <Method void PreferenceDialogFragmentCompat()>
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #55  <Method DialogPreference getPreference()>
	...
	//    0    0:new             #2   <Class MultiSelectListPreferenceDialogFragmentCompat>
	//    1    3:dup             
	//    2    4:invokespecial   #60  <Method void MultiSelectListPreferenceDialogFragmentCompat()>
	//    3    7:astore_1        
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #78  <Method void PreferenceDialogFragmentCompat.onCreate(Bundle)>
		if(bundle == null)
	//*   3    5:aload_1         
	//*   4    6:ifnonnull       83
		{
	...
	//   42   87:invokeinterface #99  <Method void Set.clear()>
			mNewValues.addAll(((java.util.Collection) (bundle.getStringArrayList("MultiSelectListPreferenceDialogFragmentCompat.values"))));
	//   43   92:aload_0         
	//   44   93:getfield        #36  <Field Set mNewValues>
	//   45   96:aload_1         
	//   46   97:ldc1            #19  <String "MultiSelectListPreferenceDialogFragmentCompat.values">
	...
	//   50  108:aload_0         
	//   51  109:aload_1         
	//   52  110:ldc1            #10  <String "MultiSelectListPreferenceDialogFragmentCompat.changed">
	//   53  112:iconst_0        
	...
	//   56  119:aload_0         
	//   57  120:aload_1         
	//   58  121:ldc1            #13  <String "MultiSelectListPreferenceDialogFragmentCompat.entries">
	...
	//   61  129:aload_0         
	//   62  130:aload_1         
	//   63  131:ldc1            #16  <String "MultiSelectListPreferenceDialogFragmentCompat.entryValues">
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #135 <Method void PreferenceDialogFragmentCompat.onPrepareDialogBuilder(android.support.v7.app.AlertDialog$Builder)>
	...
	//   34   59:aload           4
	//   35   61:new             #6   <Class MultiSelectListPreferenceDialogFragmentCompat$1>
	//   36   64:dup             
	//   37   65:aload_0         
	//   38   66:invokespecial   #147 <Method void MultiSelectListPreferenceDialogFragmentCompat$1(MultiSelectListPreferenceDialogFragmentCompat)>
	//   39   69:invokevirtual   #153 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setMultiChoiceItems(CharSequence[], boolean[], android.content.DialogInterface$OnMultiChoiceClickListener)>
	//   40   72:pop             
	//   41   73:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #157 <Method void PreferenceDialogFragmentCompat.onSaveInstanceState(Bundle)>
		bundle.putStringArrayList("MultiSelectListPreferenceDialogFragmentCompat.values", new ArrayList(((java.util.Collection) (mNewValues))));
	//    3    5:aload_1         
	//    4    6:ldc1            #19  <String "MultiSelectListPreferenceDialogFragmentCompat.values">
	...
	//   11   22:aload_1         
	//   12   23:ldc1            #10  <String "MultiSelectListPreferenceDialogFragmentCompat.changed">
	//   13   25:aload_0         
	...
	//   16   32:aload_1         
	//   17   33:ldc1            #13  <String "MultiSelectListPreferenceDialogFragmentCompat.entries">
	//   18   35:aload_0         
	...
	//   21   42:aload_1         
	//   22   43:ldc1            #16  <String "MultiSelectListPreferenceDialogFragmentCompat.entryValues">
	//   23   45:aload_0         
...
/*
	static boolean access$000(MultiSelectListPreferenceDialogFragmentCompat multiselectlistpreferencedialogfragmentcompat)
	{
		return multiselectlistpreferencedialogfragmentcompat.mPreferenceChanged;
	//    0    0:aload_0         
...
/*
	static boolean access$002(MultiSelectListPreferenceDialogFragmentCompat multiselectlistpreferencedialogfragmentcompat, boolean flag)
	{
		multiselectlistpreferencedialogfragmentcompat.mPreferenceChanged = flag;
	//    0    0:aload_0         
	//    1    1:iload_1         
...
/*
	static CharSequence[] access$100(MultiSelectListPreferenceDialogFragmentCompat multiselectlistpreferencedialogfragmentcompat)
	{
		return multiselectlistpreferencedialogfragmentcompat.mEntryValues;
	//    0    0:aload_0         
...
/*
	static Set access$200(MultiSelectListPreferenceDialogFragmentCompat multiselectlistpreferencedialogfragmentcompat)
	{
		return multiselectlistpreferencedialogfragmentcompat.mNewValues;
	//    0    0:aload_0         
