...
public class SortedList
{
	...
	//*  30   49:iload           4
	//*  31   51:aload_0         
	//*  32   52:getfield        #64  <Field int mSize>
	//*  33   55:icmpge          25
			{
				Object obj1 = mData[j];
	//   34   58:aload_0         
	//   35   59:getfield        #60  <Field Object[] mData>
	//   36   62:iload           4
	//   37   64:aaload          
	//   38   65:astore          5
				i = j;
	...
	//*  41   70:aload_0         
	//*  42   71:getfield        #62  <Field SortedList$Callback mCallback>
	//*  43   74:aload           5
	//*  44   76:aload_1         
	//*  45   77:invokevirtual   #83  <Method boolean SortedList$Callback.areItemsTheSame(Object, Object)>
	//*  46   80:ifeq            25
					if(mCallback.areContentsTheSame(obj1, obj))
	//*  47   83:aload_0         
	//*  48   84:getfield        #62  <Field SortedList$Callback mCallback>
	//*  49   87:aload           5
	//*  50   89:aload_1         
	//*  51   90:invokevirtual   #86  <Method boolean SortedList$Callback.areContentsTheSame(Object, Object)>
	//*  52   93:ifeq            107
					{
						mData[j] = obj;
	//   53   96:aload_0         
	//   54   97:getfield        #60  <Field Object[] mData>
	//   55  100:iload           4
	//   56  102:aload_1         
	//   57  103:aastore         
						return j;
	...
	//   59  106:ireturn         
					} else
					{
						mData[j] = obj;
	//   60  107:aload_0         
	//   61  108:getfield        #60  <Field Object[] mData>
	//   62  111:iload           4
	//   63  113:aload_1         
	//   64  114:aastore         
						mCallback.onChanged(j, 1);
	//   65  115:aload_0         
	//   66  116:getfield        #62  <Field SortedList$Callback mCallback>
	//   67  119:iload           4
	//   68  121:iconst_1        
	//   69  122:invokevirtual   #89  <Method void SortedList$Callback.onChanged(int, int)>
						return j;
	//   70  125:iload           4
	//   71  127:ireturn         
					}
	...
	//*  30   54:aload           8
	//*  31   56:aload_1         
	//*  32   57:invokevirtual   #83  <Method boolean SortedList$Callback.areItemsTheSame(Object, Object)>
	//*  33   60:ifeq            66
	//*  34   63:iload           6
	//*  35   65:ireturn         
				{
...
_L3:
		if(mCallback.areItemsTheSame(obj1, obj))
	//*  38   66:aload_0         
	//*  39   67:getfield        #62  <Field SortedList$Callback mCallback>
	//*  40   70:aload           6
	//*  41   72:aload_1         
	//*  42   73:invokevirtual   #83  <Method boolean SortedList$Callback.areItemsTheSame(Object, Object)>
	//*  43   76:ifeq            82
			return l;
	//   44   79:iload           5
	//   45   81:ireturn         
	...
	//*  50   88:goto            5
		if(mCallback.areItemsTheSame(obj1, obj))
	//*  51   91:aload_0         
	//*  52   92:getfield        #62  <Field SortedList$Callback mCallback>
	//*  53   95:aload           6
	//*  54   97:aload_1         
	//*  55   98:invokevirtual   #83  <Method boolean SortedList$Callback.areItemsTheSame(Object, Object)>
	//*  56  101:ifeq            106
			return i;
	//   57  104:iload_2         
	//   58  105:ireturn         
