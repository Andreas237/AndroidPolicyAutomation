...
public abstract class ActionBar
{
	...
	//    4    6:new             #123 <Class UnsupportedOperationException>
	//    5    9:dup             
	//    6   10:ldc1            #125 <String "Setting a non-zero elevation is not supported in this action bar configuration.">
	//    7   12:invokespecial   #128 <Method void UnsupportedOperationException(String)>
	//    8   15:athrow          
		else
			return;
	//    9   16:return          
	...
	//    2    4:new             #123 <Class UnsupportedOperationException>
	//    3    7:dup             
	//    4    8:ldc1            #131 <String "Setting an explicit action bar hide offset is not supported in this action bar configuration.">
	//    5   10:invokespecial   #128 <Method void UnsupportedOperationException(String)>
	//    6   13:athrow          
		else
			return;
	//    7   14:return          
	...
	//    2    4:new             #123 <Class UnsupportedOperationException>
	//    3    7:dup             
	//    4    8:ldc1            #134 <String "Hide on content scroll is not supported in this action bar configuration.">
	//    5   10:invokespecial   #128 <Method void UnsupportedOperationException(String)>
	//    6   13:athrow          
		else
			return;
