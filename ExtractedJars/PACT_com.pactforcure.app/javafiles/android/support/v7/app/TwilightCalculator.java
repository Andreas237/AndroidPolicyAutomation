...
class TwilightCalculator
{
	...
	//   14   24:fload           10
	//   15   26:f2d             
	//   16   27:ldc2w           #51  <Double 0.033419601619243622D>
	//   17   30:fload           10
	//   18   32:f2d             
	//   19   33:invokestatic    #58  <Method double Math.sin(double)>
	//   20   36:dmul            
	//   21   37:dadd            
	//   22   38:ldc2w           #59  <Double 0.00034906598739326D>
	//   23   41:fconst_2        
	//   24   42:fload           10
	//   25   44:fmul            
	//   26   45:f2d             
	//   27   46:invokestatic    #58  <Method double Math.sin(double)>
	//   28   49:dmul            
	//   29   50:dadd            
	//   30   51:ldc2w           #61  <Double 5.2360001063789241E-06D>
	//   31   54:ldc1            #63  <Float 3F>
	//   32   56:fload           10
	//   33   58:fmul            
	//   34   59:f2d             
	//   35   60:invokestatic    #58  <Method double Math.sin(double)>
	//   36   63:dmul            
	//   37   64:dadd            
	//   38   65:dadd            
	...
	//   58   98:dload           5
	//   59  100:dadd            
	//   60  101:ldc2w           #72  <Double 0.0053D>
	//   61  104:fload           10
	//   62  106:f2d             
	//   63  107:invokestatic    #58  <Method double Math.sin(double)>
	//   64  110:dmul            
	//   65  111:dadd            
	//   66  112:ldc2w           #74  <Double -0.0068999999999999999D>
	//   67  115:ldc2w           #76  <Double 2D>
	//   68  118:dload           7
	//   69  120:dmul            
	//   70  121:invokestatic    #58  <Method double Math.sin(double)>
	//   71  124:dmul            
	//   72  125:dadd            
	//   73  126:dstore          5
		d2 = Math.asin(Math.sin(d2) * Math.sin(0.40927970409393311D));
	//   74  128:dload           7
	//   75  130:invokestatic    #58  <Method double Math.sin(double)>
	//   76  133:ldc2w           #78  <Double 0.40927970409393311D>
	//   77  136:invokestatic    #58  <Method double Math.sin(double)>
	//   78  139:dmul            
	...
	//   86  154:invokestatic    #58  <Method double Math.sin(double)>
	//   87  157:dload_3         
	//   88  158:invokestatic    #58  <Method double Math.sin(double)>
	//   89  161:dload           7
	//   90  163:invokestatic    #58  <Method double Math.sin(double)>
	//   91  166:dmul            
	//   92  167:dsub            
	//   93  168:dload_3         
