	...
	implements AppCompatCallback, android.support.v4.app.TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider
{
	...
	//   16   36:aload_0         
	//   17   37:invokespecial   #135 <Method Resources FragmentActivity.getResources()>
	//   18   40:areturn         
		else
			return mResources;
	//   19   41:aload_0         
	//   20   42:getfield        #128 <Field Resources mResources>
	//   21   45:areturn         
	}
	...
	//*  24   49:aload_0         
	//*  25   50:aload_1         
	//*  26   51:invokespecial   #188 <Method void FragmentActivity.onCreate(Bundle)>
	//*  27   54:return          
				setTheme(mThemeId);
	//   28   55:aload_0         
	//   29   56:aload_0         
	//   30   57:getfield        #22  <Field int mThemeId>
	//   31   60:invokevirtual   #192 <Method void setTheme(int)>
	...
	//*  24   42:astore_1        
				{
					finish();
	//   25   43:aload_0         
	//   26   44:invokevirtual   #287 <Method void finish()>
				}
			} else
	//*  27   47:goto            40
			{
	...
	//   28   50:aload_0         
	//   29   51:aload_1         
	//   30   52:invokevirtual   #291 <Method void supportNavigateUpTo(Intent)>
			}
			return true;
		} else
	//*  31   55:goto            40
