...
_L2:
	...
	//   43   93:aload           6
	//   44   95:aload_1         
	//   45   96:invokeinterface #218 <Method boolean MenuPresenter.onSubMenuSelected(SubMenuBuilder)>
	//   46  101:istore_3        
		} while(true);
	//   47  102:goto            38
...
label0:
	...
	//   56  115:aload_0         
	//   57  116:aconst_null     
	//   58  117:putfield        #434 <Field MenuItemImpl mExpandedItem>
				return flag1;
	//   59  120:iload_3         
	//   60  121:ireturn         
			}
...
label0:
	...
	//*  55  109:iload           4
	//*  56  111:aload           9
	//*  57  113:getfield        #517 <Field char[] android.view.KeyCharacterMap$KeyData.meta>
	//*  58  116:iconst_0        
	//*  59  117:caload          
	//*  60  118:icmpne          128
	//*  61  121:iload           5
	...
	//*  65  128:iload           4
	//*  66  130:aload           9
	//*  67  132:getfield        #517 <Field char[] android.view.KeyCharacterMap$KeyData.meta>
	//*  68  135:iconst_2        
	//*  69  136:caload          
	//*  70  137:icmpne          147
	//*  71  140:iload           5
	...
	//   85  167:aload_2         
	//   86  168:invokevirtual   #520 <Method char MenuItemImpl.getNumericShortcut()>
	//   87  171:istore          4
	...
	//*  52  114:istore          6
	//*  53  116:ldc2            #527 <Int 0x1100f>
	//*  54  119:iload           7
	//*  55  121:iand            
	//*  56  122:ldc2            #527 <Int 0x1100f>
	//*  57  125:iload           6
	//*  58  127:iand            
	//*  59  128:icmpne          232
	//*  60  131:iconst_1        
...
_L3:
	...
	//    4    8:ifnull          19
	//    5   11:aload           7
	//    6   13:invokevirtual   #530 <Method boolean MenuItemImpl.isEnabled()>
	//    7   16:ifne            25
_L1:
		boolean flag1 = false;
	//    8   19:iconst_0        
...
_L2:
	...
	//   12   25:aload           7
	//   13   27:invokevirtual   #602 <Method boolean MenuItemImpl.invoke()>
	//   14   30:istore          6
		menuitem = ((MenuItem) (((MenuItemImpl) (obj)).getSupportActionProvider()));
	//   15   32:aload           7
	//   16   34:invokevirtual   #606 <Method ActionProvider MenuItemImpl.getSupportActionProvider()>
	//   17   37:astore_1        
		if(menuitem != null && ((ActionProvider) (menuitem)).hasSubMenu())
	//*  18   38:aload_1         
	//*  19   39:ifnull          87
	//*  20   42:aload_1         
	//*  21   43:invokevirtual   #609 <Method boolean ActionProvider.hasSubMenu()>
	//*  22   46:ifeq            87
			flag = true;
	//   23   49:iconst_1        
	//   24   50:istore          4
	...
	//*  25   52:aload           7
	//*  26   54:invokevirtual   #612 <Method boolean MenuItemImpl.hasCollapsibleActionView()>
	//*  27   57:ifeq            93
	//*  28   60:iload           6
	//*  29   62:aload           7
	//*  30   64:invokevirtual   #615 <Method boolean MenuItemImpl.expandActionView()>
	//*  31   67:ior             
	//*  32   68:istore          6
	//*  33   70:iload           6
	//*  34   72:istore          5
	...
	//*  37   79:aload_0         
	//*  38   80:iconst_1        
	//*  39   81:invokevirtual   #448 <Method void close(boolean)>
	//*  40   84:iload           6
	//*  41   86:ireturn         
			flag = false;
	//   42   87:iconst_0        
...
_L3:
		if(!((MenuItemImpl) (obj)).hasSubMenu() && !flag)
			break; /* Loop/switch isn't completed */
	//   45   93:aload           7
	//   46   95:invokevirtual   #478 <Method boolean MenuItemImpl.hasSubMenu()>
	//   47   98:ifne            106
	//   48  101:iload           4
	//   49  103:ifeq            194
		if((i & 4) == 0)
	...
	//   54  112:aload_0         
	//   55  113:iconst_0        
	//   56  114:invokevirtual   #448 <Method void close(boolean)>
		if(!((MenuItemImpl) (obj)).hasSubMenu())
	//*  57  117:aload           7
	//*  58  119:invokevirtual   #478 <Method boolean MenuItemImpl.hasSubMenu()>
	//*  59  122:ifne            144
			((MenuItemImpl) (obj)).setSubMenu(new SubMenuBuilder(getContext(), this, ((MenuItemImpl) (obj))));
	//   60  125:aload           7
	//   61  127:new             #416 <Class SubMenuBuilder>
	//   62  130:dup             
	//   63  131:aload_0         
	//   64  132:invokevirtual   #265 <Method Context getContext()>
	//   65  135:aload_0         
	//   66  136:aload           7
	//   67  138:invokespecial   #419 <Method void SubMenuBuilder(Context, MenuBuilder, MenuItemImpl)>
	//   68  141:invokevirtual   #423 <Method void MenuItemImpl.setSubMenu(SubMenuBuilder)>
		obj = ((Object) ((SubMenuBuilder)((MenuItemImpl) (obj)).getSubMenu()));
	//   69  144:aload           7
	//   70  146:invokevirtual   #482 <Method SubMenu MenuItemImpl.getSubMenu()>
	//   71  149:checkcast       #416 <Class SubMenuBuilder>
	//   72  152:astore          7
		if(flag)
	//*  73  154:iload           4
	//*  74  156:ifeq            165
	...
	//   75  159:aload_1         
	//   76  160:aload           7
	//   77  162:invokevirtual   #619 <Method void ActionProvider.onPrepareSubMenu(SubMenu)>
		flag2 |= dispatchSubMenuSelected(((SubMenuBuilder) (obj)), menupresenter);
	//   78  165:iload           6
	//   79  167:aload_0         
	//   80  168:aload           7
	//   81  170:aload_2         
	//   82  171:invokespecial   #621 <Method boolean dispatchSubMenuSelected(SubMenuBuilder, MenuPresenter)>
	//   83  174:ior             
	//   84  175:istore          6
		flag1 = flag2;
	//   85  177:iload           6
	...
	//   89  186:aload_0         
	//   90  187:iconst_1        
	//   91  188:invokevirtual   #448 <Method void close(boolean)>
			return flag2;
	//   92  191:iload           6
	//   93  193:ireturn         
		}
...
_L5:
	...
	//  100  204:aload_0         
	//  101  205:iconst_1        
	//  102  206:invokevirtual   #448 <Method void close(boolean)>
			return flag2;
	//  103  209:iload           6
	//  104  211:ireturn         
		}
