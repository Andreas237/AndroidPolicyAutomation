...
_L4:
	...
	{
		Object obj = ((Object) (mContext.openFileInput(mHistoryFileName)));
	//    0    0:aload_0         
...
_L1:
	...
	//   55  116:aload_0         
	//   56  117:getfield        #120 <Field List mHistoricalRecords>
	//   57  120:astore          4
		list.clear();
	//   58  122:aload           4
	//   59  124:invokeinterface #211 <Method void List.clear()>
_L3:
		i = ((XmlPullParser) (obj1)).next();
	//   60  129:aload_3         
	//   61  130:invokeinterface #289 <Method int XmlPullParser.next()>
	//   62  135:istore_1        
		if(i == 1)
	//*  63  136:iload_1         
	//*  64  137:iconst_1        
	...
	//*  67  142:ifnull          297
				try
				{
					((FileInputStream) (obj)).close();
	//   68  145:aload_2         
	//   69  146:invokevirtual   #311 <Method void FileInputStream.close()>
					return;
	//   70  149:return          
				}
				// Misplaced declaration of an exception variable
...
_L2:
	...
	//*  79  162:ldc1            #58  <String "historical-record">
	//*  80  164:aload_3         
	//*  81  165:invokeinterface #292 <Method String XmlPullParser.getName()>
	//*  82  170:invokevirtual   #295 <Method boolean String.equals(Object)>
	//*  83  173:ifne            230
			throw new XmlPullParserException("Share records file not well-formed.");
	//   84  176:new             #266 <Class XmlPullParserException>
	//   85  179:dup             
	//   86  180:ldc2            #313 <String "Share records file not well-formed.">
	//   87  183:invokespecial   #298 <Method void XmlPullParserException(String)>
	//   88  186:athrow          
		break MISSING_BLOCK_LABEL_230;
		obj1;
	//   89  187:astore_3        
		Log.e(LOG_TAG, (new StringBuilder()).append("Error reading historical recrod file: ").append(mHistoryFileName).toString(), ((Throwable) (obj1)));
	//   90  188:getstatic       #96  <Field String LOG_TAG>
	//   91  191:new             #155 <Class StringBuilder>
	//   92  194:dup             
	//   93  195:invokespecial   #156 <Method void StringBuilder()>
	//   94  198:ldc2            #300 <String "Error reading historical recrod file: ">
	//   95  201:invokevirtual   #160 <Method StringBuilder StringBuilder.append(String)>
	//   96  204:aload_0         
	//   97  205:getfield        #165 <Field String mHistoryFileName>
	//   98  208:invokevirtual   #160 <Method StringBuilder StringBuilder.append(String)>
	//   99  211:invokevirtual   #163 <Method String StringBuilder.toString()>
	//  100  214:aload_3         
	//  101  215:invokestatic    #306 <Method int Log.e(String, String, Throwable)>
	//  102  218:pop             
		if(obj != null)
	//* 103  219:aload_2         
	//* 104  220:ifnull          297
			try
			{
				((FileInputStream) (obj)).close();
	//  105  223:aload_2         
	//  106  224:invokevirtual   #311 <Method void FileInputStream.close()>
				return;
	//  107  227:return          
			}
			// Misplaced declaration of an exception variable
	...
	//  110  230:aload           4
	//  111  232:new             #18  <Class ActivityChooserModel$HistoricalRecord>
	//  112  235:dup             
	//  113  236:aload_3         
	//  114  237:aconst_null     
	//  115  238:ldc1            #29  <String "activity">
	//  116  240:invokeinterface #317 <Method String XmlPullParser.getAttributeValue(String, String)>
	//  117  245:aload_3         
	//  118  246:aconst_null     
	//  119  247:ldc1            #32  <String "time">
	//  120  249:invokeinterface #317 <Method String XmlPullParser.getAttributeValue(String, String)>
	//  121  254:invokestatic    #323 <Method long Long.parseLong(String)>
	//  122  257:aload_3         
	//  123  258:aconst_null     
	//  124  259:ldc1            #35  <String "weight">
	//  125  261:invokeinterface #317 <Method String XmlPullParser.getAttributeValue(String, String)>
	//  126  266:invokestatic    #329 <Method float Float.parseFloat(String)>
	//  127  269:invokespecial   #332 <Method void ActivityChooserModel$HistoricalRecord(String, long, float)>
	//  128  272:invokeinterface #173 <Method boolean List.add(Object)>
	//  129  277:pop             
		  goto _L3
	//* 130  278:goto            129
		Exception exception;
	...
	//* 133  283:ifnull          290
			try
			{
				((FileInputStream) (obj)).close();
	//  134  286:aload_2         
	//  135  287:invokevirtual   #311 <Method void FileInputStream.close()>
			}
	//* 136  290:aload_3         
	//* 137  291:athrow          
