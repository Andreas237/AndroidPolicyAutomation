	...
	implements TintableCompoundButton
{
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:getstatic       #20  <Field int android.support.v7.appcompat.R$attr.radioButtonStyle>
	...
	//    3    5:aload_2         
	//    4    6:iload_3         
	//    5    7:invokespecial   #30  <Method void RadioButton(Context, AttributeSet, int)>
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #45  <Method int RadioButton.getCompoundPaddingLeft()>
	//    2    4:istore_2        
		int i = j;
	//    3    5:iload_2         
	//    4    6:istore_1        
	...
	//*   5    7:aload_0         
	//*   6    8:getfield        #37  <Field AppCompatCompoundButtonHelper mCompoundButtonHelper>
	//*   7   11:ifnull          23
			i = mCompoundButtonHelper.getCompoundPaddingLeft(j);
	//    8   14:aload_0         
	//    9   15:getfield        #37  <Field AppCompatCompoundButtonHelper mCompoundButtonHelper>
	//   10   18:iload_2         
	//   11   19:invokevirtual   #48  <Method int AppCompatCompoundButtonHelper.getCompoundPaddingLeft(int)>
	//   12   22:istore_1        
		return i;
	//   13   23:iload_1         
	//   14   24:ireturn         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #80  <Method void RadioButton.setButtonDrawable(Drawable)>
		if(mCompoundButtonHelper != null)
	//*   3    5:aload_0         
