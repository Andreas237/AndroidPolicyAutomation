...
;
	...
	//   19   37:aload_1         
	//   20   38:aload_2         
	//   21   39:getfield        #154 <Field int Rect.left>
	//   22   42:putfield        #151 <Field int ActionBarOverlayLayout$LayoutParams.leftMargin>
			}
		}
		flag = flag4;
	//   23   45:iload           7
	...
	//   36   69:aload_1         
	//   37   70:aload_2         
	//   38   71:getfield        #160 <Field int Rect.top>
	//   39   74:putfield        #157 <Field int ActionBarOverlayLayout$LayoutParams.topMargin>
			}
		}
		flag1 = flag;
	//   40   77:iload_3         
	...
	//   53  102:aload_1         
	//   54  103:aload_2         
	//   55  104:getfield        #166 <Field int Rect.right>
	//   56  107:putfield        #163 <Field int ActionBarOverlayLayout$LayoutParams.rightMargin>
			}
		}
		flag = flag1;
	//   57  110:iload           4
	...
	//*  63  121:aload_1         
	//*  64  122:getfield        #169 <Field int ActionBarOverlayLayout$LayoutParams.bottomMargin>
	//*  65  125:aload_2         
	//*  66  126:getfield        #172 <Field int Rect.bottom>
	//*  67  129:icmpeq          142
			{
				flag = true;
	//   68  132:iconst_1        
	...
	//   70  134:aload_1         
	//   71  135:aload_2         
	//   72  136:getfield        #172 <Field int Rect.bottom>
	//   73  139:putfield        #169 <Field int ActionBarOverlayLayout$LayoutParams.bottomMargin>
			}
		}
		return flag;
	//   74  142:iload_3         
	...
	//   35   65:aload_0         
	//   36   66:getfield        #104 <Field Rect mLastBaseInnerInsets>
	//   37   69:aload_0         
	//   38   70:getfield        #102 <Field Rect mBaseInnerInsets>
	//   39   73:invokevirtual   #350 <Method void Rect.set(Rect)>
		}
	...
	//   48   92:aload_0         
	//   49   93:getfield        #98  <Field Rect mLastBaseContentInsets>
	//   50   96:aload_0         
	//   51   97:getfield        #96  <Field Rect mBaseContentInsets>
	//   52  100:invokevirtual   #350 <Method void Rect.set(Rect)>
		}
		if(flag)
	//*  53  103:iload_2         
	//*  54  104:ifeq            111
	...
	//   38   75:iload           4
	//   39   77:aload           11
	//   40   79:getfield        #151 <Field int ActionBarOverlayLayout$LayoutParams.leftMargin>
	//   41   82:iadd            
	//   42   83:istore          8
				int l1 = l + layoutparams.topMargin;
	//   43   85:iload           5
	//   44   87:aload           11
	//   45   89:getfield        #157 <Field int ActionBarOverlayLayout$LayoutParams.topMargin>
	//   46   92:iadd            
	//   47   93:istore          9
	...
	//    4    6:aload_0         
	//    5    7:aload_0         
	//    6    8:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//    7   11:iload_1         
	//    8   12:iconst_0        
	//    9   13:iload_2         
	//   10   14:iconst_0        
	//   11   15:invokevirtual   #478 <Method void measureChildWithMargins(View, int, int, int, int)>
		Object obj = ((Object) ((LayoutParams)mActionBarTop.getLayoutParams()));
	//   12   18:aload_0         
	//   13   19:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//   14   22:invokevirtual   #479 <Method android.view.ViewGroup$LayoutParams ActionBarContainer.getLayoutParams()>
	...
	//   17   30:iconst_0        
	//   18   31:aload_0         
	//   19   32:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//   20   35:invokevirtual   #480 <Method int ActionBarContainer.getMeasuredWidth()>
	//   21   38:aload           9
	//   22   40:getfield        #151 <Field int ActionBarOverlayLayout$LayoutParams.leftMargin>
	//   23   43:iadd            
	//   24   44:aload           9
	//   25   46:getfield        #163 <Field int ActionBarOverlayLayout$LayoutParams.rightMargin>
	//   26   49:iadd            
	//   27   50:invokestatic    #485 <Method int Math.max(int, int)>
	//   28   53:istore          8
		int l1 = Math.max(0, mActionBarTop.getMeasuredHeight() + ((LayoutParams) (obj)).topMargin + ((LayoutParams) (obj)).bottomMargin);
	//   29   55:iconst_0        
	//   30   56:aload_0         
	//   31   57:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//   32   60:invokevirtual   #486 <Method int ActionBarContainer.getMeasuredHeight()>
	//   33   63:aload           9
	//   34   65:getfield        #157 <Field int ActionBarOverlayLayout$LayoutParams.topMargin>
	//   35   68:iadd            
	//   36   69:aload           9
	//   37   71:getfield        #169 <Field int ActionBarOverlayLayout$LayoutParams.bottomMargin>
	//   38   74:iadd            
	//   39   75:invokestatic    #485 <Method int Math.max(int, int)>
	//   40   78:istore          7
		int k1 = View.combineMeasuredStates(0, mActionBarTop.getMeasuredState());
	//   41   80:iconst_0        
	//   42   81:aload_0         
	//   43   82:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//   44   85:invokevirtual   #489 <Method int ActionBarContainer.getMeasuredState()>
	//   45   88:invokestatic    #492 <Method int View.combineMeasuredStates(int, int)>
	//   46   91:istore          6
		int l;
		int j1;
		if((ViewCompat.getWindowSystemUiVisibility(((View) (this))) & 0x100) != 0)
	//*  47   93:aload_0         
	//*  48   94:invokestatic    #344 <Method int ViewCompat.getWindowSystemUiVisibility(View)>
	//*  49   97:sipush          256
	//*  50  100:iand            
	//*  51  101:ifeq            430
			l = 1;
	...
	//*  55  109:ifeq            436
	//*  56  112:aload_0         
	//*  57  113:getfield        #235 <Field int mActionBarHeight>
	//*  58  116:istore          5
	//*  59  118:iload           5
	//*  60  120:istore_3        
	//*  61  121:aload_0         
	//*  62  122:getfield        #494 <Field boolean mHasNonEmbeddedTabs>
	//*  63  125:ifeq            149
	//*  64  128:iload           5
	//*  65  130:istore_3        
	//*  66  131:aload_0         
	//*  67  132:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//*  68  135:invokevirtual   #498 <Method View ActionBarContainer.getTabContainer()>
	//*  69  138:ifnull          149
	//*  70  141:iload           5
	//*  71  143:aload_0         
	//*  72  144:getfield        #235 <Field int mActionBarHeight>
	//*  73  147:iadd            
	//*  74  148:istore_3        
	//*  75  149:aload_0         
	//*  76  150:getfield        #100 <Field Rect mContentInsets>
	//*  77  153:aload_0         
	//*  78  154:getfield        #96  <Field Rect mBaseContentInsets>
	//*  79  157:invokevirtual   #350 <Method void Rect.set(Rect)>
	//*  80  160:aload_0         
	//*  81  161:getfield        #106 <Field Rect mInnerInsets>
	//*  82  164:aload_0         
	//*  83  165:getfield        #102 <Field Rect mBaseInnerInsets>
	//*  84  168:invokevirtual   #350 <Method void Rect.set(Rect)>
	//*  85  171:aload_0         
	//*  86  172:getfield        #425 <Field boolean mOverlayMode>
	//*  87  175:ifne            459
	//*  88  178:iload           4
	//*  89  180:ifne            459
	//*  90  183:aload_0         
	//*  91  184:getfield        #100 <Field Rect mContentInsets>
	//*  92  187:astore          9
	//*  93  189:aload           9
	//*  94  191:aload           9
	//*  95  193:getfield        #160 <Field int Rect.top>
	//*  96  196:iload_3         
	//*  97  197:iadd            
	//*  98  198:putfield        #160 <Field int Rect.top>
	//*  99  201:aload_0         
	//* 100  202:getfield        #100 <Field Rect mContentInsets>
	//* 101  205:astore          9
	//* 102  207:aload           9
	//* 103  209:aload           9
	//* 104  211:getfield        #172 <Field int Rect.bottom>
	//* 105  214:iconst_0        
	//* 106  215:iadd            
	//* 107  216:putfield        #172 <Field int Rect.bottom>
	//* 108  219:aload_0         
	//* 109  220:aload_0         
	//* 110  221:getfield        #500 <Field ContentFrameLayout mContent>
	//* 111  224:aload_0         
	//* 112  225:getfield        #100 <Field Rect mContentInsets>
	//* 113  228:iconst_1        
	//* 114  229:iconst_1        
	//* 115  230:iconst_1        
	//* 116  231:iconst_1        
	//* 117  232:invokespecial   #346 <Method boolean applyInsets(View, Rect, boolean, boolean, boolean, boolean)>
	//* 118  235:pop             
	//* 119  236:aload_0         
	//* 120  237:getfield        #108 <Field Rect mLastInnerInsets>
	//* 121  240:aload_0         
	//* 122  241:getfield        #106 <Field Rect mInnerInsets>
	//* 123  244:invokevirtual   #360 <Method boolean Rect.equals(Object)>
	//* 124  247:ifne            272
	//* 125  250:aload_0         
	//* 126  251:getfield        #108 <Field Rect mLastInnerInsets>
	//* 127  254:aload_0         
	//* 128  255:getfield        #106 <Field Rect mInnerInsets>
	//* 129  258:invokevirtual   #350 <Method void Rect.set(Rect)>
	//* 130  261:aload_0         
	//* 131  262:getfield        #500 <Field ContentFrameLayout mContent>
	//* 132  265:aload_0         
	//* 133  266:getfield        #106 <Field Rect mInnerInsets>
	//* 134  269:invokevirtual   #505 <Method void ContentFrameLayout.dispatchFitSystemWindows(Rect)>
	//* 135  272:aload_0         
	//* 136  273:aload_0         
	//* 137  274:getfield        #500 <Field ContentFrameLayout mContent>
	//* 138  277:iload_1         
	//* 139  278:iconst_0        
	//* 140  279:iload_2         
	//* 141  280:iconst_0        
	//* 142  281:invokevirtual   #478 <Method void measureChildWithMargins(View, int, int, int, int)>
	//* 143  284:aload_0         
	//* 144  285:getfield        #500 <Field ContentFrameLayout mContent>
	//* 145  288:invokevirtual   #506 <Method android.view.ViewGroup$LayoutParams ContentFrameLayout.getLayoutParams()>
	//* 146  291:checkcast       #19  <Class ActionBarOverlayLayout$LayoutParams>
	//* 147  294:astore          9
	//* 148  296:iload           8
	//* 149  298:aload_0         
	//* 150  299:getfield        #500 <Field ContentFrameLayout mContent>
	//* 151  302:invokevirtual   #507 <Method int ContentFrameLayout.getMeasuredWidth()>
	//* 152  305:aload           9
	//* 153  307:getfield        #151 <Field int ActionBarOverlayLayout$LayoutParams.leftMargin>
	//* 154  310:iadd            
	//* 155  311:aload           9
	//* 156  313:getfield        #163 <Field int ActionBarOverlayLayout$LayoutParams.rightMargin>
	//* 157  316:iadd            
	//* 158  317:invokestatic    #485 <Method int Math.max(int, int)>
	//* 159  320:istore_3        
	//* 160  321:iload           7
	//* 161  323:aload_0         
	//* 162  324:getfield        #500 <Field ContentFrameLayout mContent>
	//* 163  327:invokevirtual   #508 <Method int ContentFrameLayout.getMeasuredHeight()>
	//* 164  330:aload           9
	//* 165  332:getfield        #157 <Field int ActionBarOverlayLayout$LayoutParams.topMargin>
	//* 166  335:iadd            
	//* 167  336:aload           9
	//* 168  338:getfield        #169 <Field int ActionBarOverlayLayout$LayoutParams.bottomMargin>
	//* 169  341:iadd            
	//* 170  342:invokestatic    #485 <Method int Math.max(int, int)>
	//* 171  345:istore          4
	//* 172  347:iload           6
	//* 173  349:aload_0         
	//* 174  350:getfield        #500 <Field ContentFrameLayout mContent>
	//* 175  353:invokevirtual   #509 <Method int ContentFrameLayout.getMeasuredState()>
	//* 176  356:invokestatic    #492 <Method int View.combineMeasuredStates(int, int)>
	//* 177  359:istore          5
	//* 178  361:aload_0         
	//* 179  362:invokevirtual   #450 <Method int getPaddingLeft()>
	//* 180  365:istore          6
	//* 181  367:aload_0         
	//* 182  368:invokevirtual   #453 <Method int getPaddingRight()>
	//* 183  371:istore          7
	//* 184  373:iload           4
	//* 185  375:aload_0         
	//* 186  376:invokevirtual   #456 <Method int getPaddingTop()>
	//* 187  379:aload_0         
	//* 188  380:invokevirtual   #459 <Method int getPaddingBottom()>
	//* 189  383:iadd            
	//* 190  384:iadd            
	//* 191  385:aload_0         
	//* 192  386:invokevirtual   #512 <Method int getSuggestedMinimumHeight()>
	//* 193  389:invokestatic    #485 <Method int Math.max(int, int)>
	//* 194  392:istore          4
	//* 195  394:aload_0         
	//* 196  395:iload_3         
	//* 197  396:iload           6
	...
	//* 200  401:iadd            
	//* 201  402:aload_0         
	//* 202  403:invokevirtual   #515 <Method int getSuggestedMinimumWidth()>
	//* 203  406:invokestatic    #485 <Method int Math.max(int, int)>
	//* 204  409:iload_1         
	//* 205  410:iload           5
	//* 206  412:invokestatic    #519 <Method int View.resolveSizeAndState(int, int, int)>
	//* 207  415:iload           4
	//* 208  417:iload_2         
	//* 209  418:iload           5
	//* 210  420:bipush          16
	//* 211  422:ishl            
	//* 212  423:invokestatic    #519 <Method int View.resolveSizeAndState(int, int, int)>
	//* 213  426:invokevirtual   #522 <Method void setMeasuredDimension(int, int)>
	//* 214  429:return          
			l = 0;
	//  215  430:iconst_0        
	//  216  431:istore          4
	...
	//* 218  436:aload_0         
	//* 219  437:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//* 220  440:invokevirtual   #315 <Method int ActionBarContainer.getVisibility()>
	//* 221  443:bipush          8
	//* 222  445:icmpeq          149
			k = mActionBarTop.getMeasuredHeight();
	//  223  448:aload_0         
	//  224  449:getfield        #288 <Field ActionBarContainer mActionBarTop>
	//  225  452:invokevirtual   #486 <Method int ActionBarContainer.getMeasuredHeight()>
	//  226  455:istore_3        
	...
	//  228  459:aload_0         
	//  229  460:getfield        #106 <Field Rect mInnerInsets>
	//  230  463:astore          9
			rect.top = rect.top + k;
	//  231  465:aload           9
	//  232  467:aload           9
	//  233  469:getfield        #160 <Field int Rect.top>
	//  234  472:iload_3         
	//  235  473:iadd            
	//  236  474:putfield        #160 <Field int Rect.top>
			rect = mInnerInsets;
	//  237  477:aload_0         
	//  238  478:getfield        #106 <Field Rect mInnerInsets>
	//  239  481:astore          9
			rect.bottom = rect.bottom + 0;
	//  240  483:aload           9
	//  241  485:aload           9
	//  242  487:getfield        #172 <Field int Rect.bottom>
	//  243  490:iconst_0        
	//  244  491:iadd            
	//  245  492:putfield        #172 <Field int Rect.bottom>
		}
