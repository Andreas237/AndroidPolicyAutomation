	...
	implements android.view.View.OnClickListener
{
	...
	//    3    7:astore_3        
		...
		try
		{
			obj1 = ((Object) (((PackageManager) (obj)).getActivityInfo(componentname, 128)));
	//    4    8:aload_3         
	//    5    9:aload_1         
	//    6   10:sipush          128
	...
	//   19   33:ldc1            #19  <String "SuggestionsAdapter">
	//   20   35:aload_1         
	//   21   36:invokevirtual   #199 <Method String android.content.pm.PackageManager$NameNotFoundException.toString()>
	//   22   39:invokestatic    #205 <Method int Log.w(String, String)>
	//   23   42:pop             
			return null;
	//   24   43:aconst_null     
	//   25   44:areturn         
		...
		{
			obj1 = ((Object) (((PackageManager) (obj)).getDrawable(componentname.getPackageName(), i, ((ActivityInfo) (obj1)).applicationInfo)));
	//   26   45:aload_3         
	//   27   46:aload_1         
	//   28   47:invokevirtual   #210 <Method String ComponentName.getPackageName()>
	//   29   50:iload_2         
	//   30   51:aload           4
	//   31   53:getfield        #214 <Field android.content.pm.ApplicationInfo ActivityInfo.applicationInfo>
	//   32   56:invokevirtual   #218 <Method Drawable PackageManager.getDrawable(String, int, android.content.pm.ApplicationInfo)>
	//   33   59:astore          4
			obj = obj1;
	//   34   61:aload           4
	//   35   63:astore_3        
	...
	//   38   69:ldc1            #19  <String "SuggestionsAdapter">
	//   39   71:new             #220 <Class StringBuilder>
	//   40   74:dup             
	//   41   75:invokespecial   #221 <Method void StringBuilder()>
	//   42   78:ldc1            #223 <String "Invalid icon resource ">
	//   43   80:invokevirtual   #227 <Method StringBuilder StringBuilder.append(String)>
	//   44   83:iload_2         
	//   45   84:invokevirtual   #230 <Method StringBuilder StringBuilder.append(int)>
	//   46   87:ldc1            #232 <String " for ">
	//   47   89:invokevirtual   #227 <Method StringBuilder StringBuilder.append(String)>
	//   48   92:aload_1         
	//   49   93:invokevirtual   #235 <Method String ComponentName.flattenToShortString()>
	//   50   96:invokevirtual   #227 <Method StringBuilder StringBuilder.append(String)>
	//   51   99:invokevirtual   #236 <Method String StringBuilder.toString()>
	//   52  102:invokestatic    #205 <Method int Log.w(String, String)>
	//   53  105:pop             
				return null;
	//   54  106:aconst_null     
	//   55  107:areturn         
	...
	//*  32   58:aload_0         
	//*  33   59:getfield        #103 <Field WeakHashMap mOutsideDrawablesCache>
	//*  34   62:aload_2         
	//*  35   63:aload_1         
	//*  36   64:invokevirtual   #250 <Method Object WeakHashMap.put(Object, Object)>
	//*  37   67:pop             
	//*  38   68:aload_3         
	//*  39   69:areturn         
			componentname = ((ComponentName) (drawable.getConstantState()));
	//   40   70:aload_3         
	//   41   71:invokevirtual   #256 <Method android.graphics.drawable.Drawable$ConstantState Drawable.getConstantState()>
	//   42   74:astore_1        
...
_L3:
	...
	//   13   24:invokeinterface #452 <Method int Cursor.getInt(int)>
	//   14   29:istore          4
		if(((ChildViewCache) (context)).mText1 != null)
	//*  15   31:aload_2         
	//*  16   32:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//*  17   35:ifnull          56
		{
	...
	//   23   47:aload_0         
	//   24   48:aload_2         
	//   25   49:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//   26   52:aload_1         
	//   27   53:invokespecial   #458 <Method void setViewText(TextView, CharSequence)>
		}
		if(((ChildViewCache) (context)).mText2 == null) goto _L2; else goto _L1
	//   28   56:aload_2         
	//   29   57:getfield        #461 <Field TextView SuggestionsAdapter$ChildViewCache.mText2>
	//   30   60:ifnull          121
_L1:
	...
	//   38   76:aload_0         
	//   39   77:aload_1         
	//   40   78:invokespecial   #463 <Method CharSequence formatUrl(CharSequence)>
	//   41   81:astore_1        
		else
	//*  42   82:aload_1         
	//*  43   83:invokestatic    #425 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  44   86:ifeq            230
	//*  45   89:aload_2         
	//*  46   90:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//*  47   93:ifnull          112
	//*  48   96:aload_2         
	//*  49   97:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//*  50  100:iconst_0        
	//*  51  101:invokevirtual   #467 <Method void TextView.setSingleLine(boolean)>
	//*  52  104:aload_2         
	//*  53  105:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//*  54  108:iconst_2        
	//*  55  109:invokevirtual   #470 <Method void TextView.setMaxLines(int)>
	//*  56  112:aload_0         
	//*  57  113:aload_2         
	//*  58  114:getfield        #461 <Field TextView SuggestionsAdapter$ChildViewCache.mText2>
	//*  59  117:aload_1         
	//*  60  118:invokespecial   #458 <Method void setViewText(TextView, CharSequence)>
	//*  61  121:aload_2         
	//*  62  122:getfield        #474 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon1>
	//*  63  125:ifnull          142
	//*  64  128:aload_0         
	//*  65  129:aload_2         
	//*  66  130:getfield        #474 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon1>
	//*  67  133:aload_0         
	//*  68  134:aload_3         
	//*  69  135:invokespecial   #476 <Method Drawable getIcon1(Cursor)>
	//*  70  138:iconst_4        
	//*  71  139:invokespecial   #478 <Method void setViewDrawable(ImageView, Drawable, int)>
	//*  72  142:aload_2         
	//*  73  143:getfield        #481 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon2>
	//*  74  146:ifnull          164
	//*  75  149:aload_0         
	//*  76  150:aload_2         
	//*  77  151:getfield        #481 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon2>
	//*  78  154:aload_0         
	//*  79  155:aload_3         
	//*  80  156:invokespecial   #483 <Method Drawable getIcon2(Cursor)>
	//*  81  159:bipush          8
	//*  82  161:invokespecial   #478 <Method void setViewDrawable(ImageView, Drawable, int)>
	//*  83  164:aload_0         
	//*  84  165:getfield        #63  <Field int mQueryRefinement>
	//*  85  168:iconst_2        
	//*  86  169:icmpeq          187
	//*  87  172:aload_0         
	//*  88  173:getfield        #63  <Field int mQueryRefinement>
	//*  89  176:iconst_1        
	//*  90  177:icmpne          256
	//*  91  180:iload           4
	//*  92  182:iconst_1        
	...
	//*  94  184:ifeq            256
	//*  95  187:aload_2         
	//*  96  188:getfield        #486 <Field ImageView SuggestionsAdapter$ChildViewCache.mIconRefine>
	//*  97  191:iconst_0        
	//*  98  192:invokevirtual   #409 <Method void ImageView.setVisibility(int)>
	//*  99  195:aload_2         
	//* 100  196:getfield        #486 <Field ImageView SuggestionsAdapter$ChildViewCache.mIconRefine>
	//* 101  199:aload_2         
	//* 102  200:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//* 103  203:invokevirtual   #490 <Method CharSequence TextView.getText()>
	//* 104  206:invokevirtual   #494 <Method void ImageView.setTag(Object)>
	//* 105  209:aload_2         
	//* 106  210:getfield        #486 <Field ImageView SuggestionsAdapter$ChildViewCache.mIconRefine>
	//* 107  213:aload_0         
	//* 108  214:invokevirtual   #498 <Method void ImageView.setOnClickListener(android.view.View$OnClickListener)>
	//* 109  217:return          
			view = ((View) (getStringOrNull(cursor, mText2Col)));
	//  110  218:aload_3         
	//  111  219:aload_0         
	//  112  220:getfield        #67  <Field int mText2Col>
	//  113  223:invokestatic    #268 <Method String getStringOrNull(Cursor, int)>
	//  114  226:astore_1        
...
_L2:
	...
	//* 115  227:goto            82
	//* 116  230:aload_2         
	//* 117  231:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//* 118  234:ifnull          112
	//* 119  237:aload_2         
	//* 120  238:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//* 121  241:iconst_1        
	//* 122  242:invokevirtual   #467 <Method void TextView.setSingleLine(boolean)>
	//* 123  245:aload_2         
	//* 124  246:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//* 125  249:iconst_1        
	//* 126  250:invokevirtual   #470 <Method void TextView.setMaxLines(int)>
	//* 127  253:goto            112
		{
			((ChildViewCache) (context)).mIconRefine.setVisibility(8);
	//  128  256:aload_2         
	//  129  257:getfield        #486 <Field ImageView SuggestionsAdapter$ChildViewCache.mIconRefine>
	//  130  260:bipush          8
	//  131  262:invokevirtual   #409 <Method void ImageView.setVisibility(int)>
			return;
	//  132  265:return          
		}
_L4:
...
_L3:
	...
	//    6    8:aload_1         
	//    7    9:ldc2            #523 <String "suggest_intent_query">
	//    8   12:invokestatic    #525 <Method String getColumnString(Cursor, String)>
	//    9   15:astore_3        
			obj = ((Object) (s1));
	//   10   16:aload_3         
	//   11   17:astore_2        
	...
	//*  14   22:aload_0         
	//*  15   23:getfield        #94  <Field SearchableInfo mSearchable>
	//*  16   26:invokevirtual   #528 <Method boolean SearchableInfo.shouldRewriteQueryFromData()>
	//*  17   29:ifeq            46
				{
					String s = getColumnString(cursor, "suggest_intent_data");
	//   18   32:aload_1         
	//   19   33:ldc2            #530 <String "suggest_intent_data">
	//   20   36:invokestatic    #525 <Method String getColumnString(Cursor, String)>
	//   21   39:astore_2        
					if(s != null)
	//*  22   40:aload_2         
	//*  23   41:ifnull          46
	...
	//*  26   46:aload_0         
	//*  27   47:getfield        #94  <Field SearchableInfo mSearchable>
	//*  28   50:invokevirtual   #533 <Method boolean SearchableInfo.shouldRewriteQueryFromText()>
	//*  29   53:ifeq            70
				{
					cursor = ((Cursor) (getColumnString(cursor, "suggest_text_1")));
	//   30   56:aload_1         
	//   31   57:ldc2            #506 <String "suggest_text_1">
	//   32   60:invokestatic    #525 <Method String getColumnString(Cursor, String)>
	//   33   63:astore_1        
					if(cursor != null)
	//*  34   64:aload_1         
	//*  35   65:ifnull          70
	...
	//*   8   10:astore          4
		{
			Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", ((Throwable) (runtimeexception)));
	//    9   12:ldc1            #19  <String "SuggestionsAdapter">
	//   10   14:ldc2            #580 <String "Search suggestions cursor threw exception.">
	//   11   17:aload           4
	//   12   19:invokestatic    #582 <Method int Log.w(String, String, Throwable)>
	//   13   22:pop             
			viewgroup = ((ViewGroup) (newDropDownView(mContext, mCursor, viewgroup)));
	//   14   23:aload_0         
	//   15   24:aload_0         
	//   16   25:getfield        #78  <Field Context mContext>
	//   17   28:aload_0         
	//   18   29:getfield        #586 <Field Cursor mCursor>
	//   19   32:aload_3         
	//   20   33:invokevirtual   #590 <Method View newDropDownView(Context, Cursor, ViewGroup)>
	//   21   36:astore_3        
			view = ((View) (viewgroup));
	//   22   37:aload_3         
	//   23   38:astore_2        
	...
	//*  25   40:ifnull          8
			{
				((ChildViewCache)((View) (viewgroup)).getTag()).mText1.setText(((CharSequence) (runtimeexception.toString())));
	//   26   43:aload_3         
	//   27   44:invokevirtual   #448 <Method Object View.getTag()>
	//   28   47:checkcast       #8   <Class SuggestionsAdapter$ChildViewCache>
	//   29   50:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//   30   53:aload           4
	//   31   55:invokevirtual   #591 <Method String RuntimeException.toString()>
	//   32   58:invokevirtual   #420 <Method void TextView.setText(CharSequence)>
	...
	//*  49  100:ifle            116
	//*  50  103:aload           4
	//*  51  105:ldc2            #633 <String "limit">
	//*  52  108:iload_3         
	//*  53  109:invokestatic    #636 <Method String String.valueOf(int)>
	//*  54  112:invokevirtual   #640 <Method android.net.Uri$Builder android.net.Uri$Builder.appendQueryParameter(String, String)>
	//*  55  115:pop             
	//*  56  116:aload           4
	//*  57  118:invokevirtual   #644 <Method Uri android.net.Uri$Builder.build()>
	//*  58  121:astore_2        
	//*  59  122:aload_0         
	//*  60  123:getfield        #78  <Field Context mContext>
	//*  61  126:invokevirtual   #322 <Method ContentResolver Context.getContentResolver()>
	//*  62  129:aload_2         
	//*  63  130:aconst_null     
	//*  64  131:aload           5
	//*  65  133:aload_1         
	//*  66  134:aconst_null     
	//*  67  135:invokevirtual   #647 <Method Cursor ContentResolver.query(Uri, String[], String, String[], String)>
	//*  68  138:areturn         
				{
					((android.net.Uri.Builder) (obj)).appendPath(s);
	//   69  139:aload           4
	//   70  141:aload_2         
	//   71  142:invokevirtual   #628 <Method android.net.Uri$Builder android.net.Uri$Builder.appendPath(String)>
	//   72  145:pop             
				}
				if(i > 0)
	...
	//   18   29:getfield        #586 <Field Cursor mCursor>
	//   19   32:aload_3         
	//   20   33:invokevirtual   #653 <Method View newView(Context, Cursor, ViewGroup)>
	//   21   36:astore_3        
			view = ((View) (viewgroup));
	//   22   37:aload_3         
	//   23   38:astore_2        
...
_L1:
	...
	//*  24   51:astore_1        
_L2:
		if((charsequence = ((CharSequence) (getSearchManagerSuggestions(mSearchable, ((String) (charsequence)), 50)))) == null) goto _L1; else goto _L3
	//   25   52:aload_1         
	//   26   53:ifnull          28
_L3:
		try
