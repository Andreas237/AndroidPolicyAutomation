	...
	implements Runnable
{
	...
	//    2    4:invokevirtual   #22  <Method void ActionBarOverlayLayout.haltActionBarHideOffsetAnimations()>
		mCurrentActionBarTopAnimator = mActionBarTop.animate().translationY(-mActionBarTop.getHeight()).setListener(((android.animation.) (mTopAnimatorListener)));
	//    3    7:aload_0         
	...
	//   18   40:getfield        #46  <Field android.animation.AnimatorListenerAdapter ActionBarOverlayLayout.mTopAnimatorListener>
