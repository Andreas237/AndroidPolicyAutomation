...
public class SwitchCompat extends CompoundButton
{
	...
	//*   8   14:aload_0         
	//*   9   15:invokespecial   #401 <Method int getThumbScrollRange()>
	//*  10   18:i2f             
	//*  11   19:fload_1         
	//*  12   20:fmul            
	...
	//   20   38:aload_0         
	//   21   39:getfield        #430 <Field int mSwitchLeft>
	//   22   42:iload           5
	//   23   44:iadd            
	//   24   45:aload_0         
...
_L5:
	...
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:putfield        #484 <Field int mTouchMode>
		boolean flag;
		boolean flag1;
		boolean flag2;
		if(motionevent.getAction() == 1 && isEnabled())
	//*   3    5:aload_1         
	//*   4    6:invokevirtual   #487 <Method int MotionEvent.getAction()>
	//*   5    9:iconst_1        
	//*   6   10:icmpne          103
	//*   7   13:aload_0         
	//*   8   14:invokevirtual   #490 <Method boolean isEnabled()>
	//*   9   17:ifeq            103
			flag = true;
	//   10   20:iconst_1        
	//   11   21:istore_3        
	...
	//*  12   22:aload_0         
	//*  13   23:invokevirtual   #309 <Method boolean isChecked()>
	//*  14   26:istore          5
	//*  15   28:iload_3         
	//*  16   29:ifeq            141
	//*  17   32:aload_0         
	//*  18   33:getfield        #134 <Field VelocityTracker mVelocityTracker>
	//*  19   36:sipush          1000
	//*  20   39:invokevirtual   #493 <Method void VelocityTracker.computeCurrentVelocity(int)>
	//*  21   42:aload_0         
	//*  22   43:getfield        #134 <Field VelocityTracker mVelocityTracker>
	//*  23   46:invokevirtual   #497 <Method float VelocityTracker.getXVelocity()>
	//*  24   49:fstore_2        
	//*  25   50:fload_2         
	//*  26   51:invokestatic    #501 <Method float Math.abs(float)>
	//*  27   54:aload_0         
	//*  28   55:getfield        #302 <Field int mMinFlingVelocity>
	//*  29   58:i2f             
	//*  30   59:fcmpl           
	//*  31   60:ifle            132
	//*  32   63:aload_0         
	//*  33   64:invokestatic    #398 <Method boolean ViewUtils.isLayoutRtl(android.view.View)>
	//*  34   67:ifeq            114
	//*  35   70:fload_2         
	//*  36   71:fconst_0        
	//*  37   72:fcmpg           
	...
	//   70  132:aload_0         
	//   71  133:invokespecial   #508 <Method boolean getTargetCheckedState()>
	//   72  136:istore          4
			}
		} else
	//*  73  138:goto            79
	...
	//    5   10:istore          5
		int k2 = mSwitchTop;
	//    6   12:aload_0         
	//    7   13:getfield        #428 <Field int mSwitchTop>
	//    8   16:istore          11
		int j = mSwitchRight;
	//    9   18:aload_0         
	//   10   19:getfield        #512 <Field int mSwitchRight>
	//   11   22:istore_3        
	...
	//   15   29:iload           5
	//   16   31:aload_0         
	//   17   32:invokespecial   #426 <Method int getThumbOffset()>
	//   18   35:iadd            
	//   19   36:istore          4
		int i;
		Object obj;
		if(mThumbDrawable != null)
	//*  20   38:aload_0         
	//*  21   39:getfield        #183 <Field Drawable mThumbDrawable>
	//*  22   42:ifnull          359
			obj = ((Object) (DrawableUtils.getOpticalBounds(mThumbDrawable)));
	//   23   45:aload_0         
	//   24   46:getfield        #183 <Field Drawable mThumbDrawable>
	//   25   49:invokestatic    #409 <Method Rect DrawableUtils.getOpticalBounds(Drawable)>
	//   26   52:astore          14
		else
	//*  27   54:iload           4
	//*  28   56:istore_2        
	//*  29   57:aload_0         
	//*  30   58:getfield        #194 <Field Drawable mTrackDrawable>
	//*  31   61:ifnull          280
	//*  32   64:aload_0         
	//*  33   65:getfield        #194 <Field Drawable mTrackDrawable>
	//*  34   68:aload           15
	//*  35   70:invokevirtual   #405 <Method boolean Drawable.getPadding(Rect)>
	//*  36   73:pop             
	//*  37   74:iload           4
	//*  38   76:aload           15
	//*  39   78:getfield        #416 <Field int Rect.left>
	//*  40   81:iadd            
	//*  41   82:istore          13
	//*  42   84:iload           11
	//*  43   86:istore          4
	...
	//*  57  114:istore_2        
	//*  58  115:aload           14
	//*  59  117:getfield        #416 <Field int Rect.left>
	//*  60  120:aload           15
	//*  61  122:getfield        #416 <Field int Rect.left>
	//*  62  125:icmple          143
	//*  63  128:iload           5
	//*  64  130:aload           14
	//*  65  132:getfield        #416 <Field int Rect.left>
	//*  66  135:aload           15
	//*  67  137:getfield        #416 <Field int Rect.left>
	//*  68  140:isub            
	//*  69  141:iadd            
	//*  70  142:istore_2        
	//*  71  143:iload           4
	//*  72  145:istore          5
	//*  73  147:aload           14
	//*  74  149:getfield        #515 <Field int Rect.top>
	//*  75  152:aload           15
	//*  76  154:getfield        #515 <Field int Rect.top>
	//*  77  157:icmple          176
	//*  78  160:iload           4
	//*  79  162:aload           14
	//*  80  164:getfield        #515 <Field int Rect.top>
	//*  81  167:aload           15
	//*  82  169:getfield        #515 <Field int Rect.top>
	//*  83  172:isub            
	//*  84  173:iadd            
	//*  85  174:istore          5
	//*  86  176:iload_3         
	//*  87  177:istore          4
	//*  88  179:aload           14
	//*  89  181:getfield        #419 <Field int Rect.right>
	//*  90  184:aload           15
	//*  91  186:getfield        #419 <Field int Rect.right>
	//*  92  189:icmple          207
	//*  93  192:iload_3         
	//*  94  193:aload           14
	//*  95  195:getfield        #419 <Field int Rect.right>
	//*  96  198:aload           15
	//*  97  200:getfield        #419 <Field int Rect.right>
	//*  98  203:isub            
	//*  99  204:isub            
	//* 100  205:istore          4
	//* 101  207:iload           6
	...
	//* 108  220:istore          9
	//* 109  222:aload           14
	//* 110  224:getfield        #518 <Field int Rect.bottom>
	//* 111  227:aload           15
	//* 112  229:getfield        #518 <Field int Rect.bottom>
	//* 113  232:icmple          262
	//* 114  235:iload           6
	//* 115  237:aload           14
	//* 116  239:getfield        #518 <Field int Rect.bottom>
	//* 117  242:aload           15
	//* 118  244:getfield        #518 <Field int Rect.bottom>
	//* 119  247:isub            
	//* 120  248:isub            
	//* 121  249:istore          10
	//* 122  251:iload           5
	...
	//* 127  260:istore          7
	//* 128  262:aload_0         
	//* 129  263:getfield        #194 <Field Drawable mTrackDrawable>
	//* 130  266:iload           7
	//* 131  268:iload           9
	//* 132  270:iload           8
	//* 133  272:iload           10
	//* 134  274:invokevirtual   #522 <Method void Drawable.setBounds(int, int, int, int)>
	//* 135  277:iload           13
	//* 136  279:istore_2        
	//* 137  280:aload_0         
	//* 138  281:getfield        #183 <Field Drawable mThumbDrawable>
	//* 139  284:ifnull          353
	//* 140  287:aload_0         
	//* 141  288:getfield        #183 <Field Drawable mThumbDrawable>
	//* 142  291:aload           15
	//* 143  293:invokevirtual   #405 <Method boolean Drawable.getPadding(Rect)>
	//* 144  296:pop             
	//* 145  297:iload_2         
	//* 146  298:aload           15
	//* 147  300:getfield        #416 <Field int Rect.left>
	//* 148  303:isub            
	//* 149  304:istore_3        
	//* 150  305:aload_0         
	//* 151  306:getfield        #413 <Field int mThumbWidth>
	//* 152  309:iload_2         
	//* 153  310:iadd            
	//* 154  311:aload           15
	//* 155  313:getfield        #419 <Field int Rect.right>
	//* 156  316:iadd            
	//* 157  317:istore_2        
	//* 158  318:aload_0         
	//* 159  319:getfield        #183 <Field Drawable mThumbDrawable>
	//* 160  322:iload_3         
	//* 161  323:iload           11
	//* 162  325:iload_2         
	//* 163  326:iload           12
	//* 164  328:invokevirtual   #522 <Method void Drawable.setBounds(int, int, int, int)>
	//* 165  331:aload_0         
	//* 166  332:invokevirtual   #525 <Method Drawable getBackground()>
	//* 167  335:astore          14
	//* 168  337:aload           14
	//* 169  339:ifnull          353
	//* 170  342:aload           14
	...
	//* 173  347:iload_2         
	//* 174  348:iload           12
	//* 175  350:invokestatic    #529 <Method void DrawableCompat.setHotspotBounds(Drawable, int, int, int, int)>
	//* 176  353:aload_0         
	//* 177  354:aload_1         
	//* 178  355:invokespecial   #531 <Method void CompoundButton.draw(Canvas)>
	//* 179  358:return          
			obj = ((Object) (DrawableUtils.INSETS_NONE));
	//  180  359:getstatic       #422 <Field Rect DrawableUtils.INSETS_NONE>
	//  181  362:astore          14
		i = l;
		if(mTrackDrawable != null)
		{
	...
	//* 112  241:aload           10
	//* 113  243:getfield        #419 <Field int Rect.right>
	//* 114  246:iadd            
	//* 115  247:istore_2        
	//* 116  248:iload_2         
	//* 117  249:iconst_2        
	...
	//* 119  251:istore_2        
	//* 120  252:aload           9
	//* 121  254:invokevirtual   #646 <Method int Layout.getWidth()>
	//* 122  257:iconst_2        
	//* 123  258:idiv            
	//* 124  259:istore          8
	//* 125  261:iload           4
	...
	//* 134  274:istore          4
	//* 135  276:aload           9
	//* 136  278:invokevirtual   #649 <Method int Layout.getHeight()>
	//* 137  281:iconst_2        
	//* 138  282:idiv            
	//* 139  283:istore          5
	//* 140  285:aload_1         
	...
	//* 147  295:isub            
	//* 148  296:i2f             
	//* 149  297:invokevirtual   #652 <Method void Canvas.translate(float, float)>
	//* 150  300:aload           9
	//* 151  302:aload_1         
	//* 152  303:invokevirtual   #653 <Method void Layout.draw(Canvas)>
	//* 153  306:aload_1         
	//* 154  307:iload_3         
	//* 155  308:invokevirtual   #623 <Method void Canvas.restoreToCount(int)>
	//* 156  311:return          
			((Rect) (obj)).setEmpty();
	//  157  312:aload           9
	//  158  314:invokevirtual   #656 <Method void Rect.setEmpty()>
		l = mSwitchTop;
		i1 = mSwitchBottom;
		j1 = ((Rect) (obj)).top;
		k1 = ((Rect) (obj)).bottom;
	...
	//  160  320:aload           11
	//  161  322:aload_1         
	//  162  323:invokevirtual   #620 <Method void Drawable.draw(Canvas)>
			}
		k = canvas.save();
		if(obj1 != null)
	...
	//  164  329:aload_0         
	//  165  330:getfield        #658 <Field Layout mOffLayout>
	//  166  333:astore          9
		if(obj != null)
		{
			ai = getDrawableState();
	...
	//* 167  335:goto            180
			{
				j = getWidth();
	//  168  338:aload_0         
	//  169  339:invokevirtual   #659 <Method int getWidth()>
	//  170  342:istore_2        
			}
			j /= 2;
...
label0:
	...
	//    4    4:iload           4
	//    5    6:iload           5
	//    6    8:invokespecial   #694 <Method void CompoundButton.onLayout(boolean, int, int, int, int)>
		i = 0;
	//    7   11:iconst_0        
	//    8   12:istore_2        
		j = 0;
	...
	//   10   14:istore_3        
		if(mThumbDrawable != null)
	//*  11   15:aload_0         
	//*  12   16:getfield        #183 <Field Drawable mThumbDrawable>
	//*  13   19:ifnull          86
		{
			Rect rect = mTempRect;
	//   14   22:aload_0         
	//   15   23:getfield        #140 <Field Rect mTempRect>
	//   16   26:astore          6
			Rect rect1;
			if(mTrackDrawable != null)
	//*  17   28:aload_0         
	//*  18   29:getfield        #194 <Field Drawable mTrackDrawable>
	//*  19   32:ifnull          183
				mTrackDrawable.getPadding(rect);
	//   20   35:aload_0         
	//   21   36:getfield        #194 <Field Drawable mTrackDrawable>
	//   22   39:aload           6
	//   23   41:invokevirtual   #405 <Method boolean Drawable.getPadding(Rect)>
	//   24   44:pop             
			else
	//*  25   45:aload_0         
	//*  26   46:getfield        #183 <Field Drawable mThumbDrawable>
	//*  27   49:invokestatic    #409 <Method Rect DrawableUtils.getOpticalBounds(Drawable)>
	//*  28   52:astore          7
	//*  29   54:iconst_0        
	//*  30   55:aload           7
	//*  31   57:getfield        #416 <Field int Rect.left>
	//*  32   60:aload           6
	//*  33   62:getfield        #416 <Field int Rect.left>
	//*  34   65:isub            
	//*  35   66:invokestatic    #697 <Method int Math.max(int, int)>
	//*  36   69:istore_2        
	//*  37   70:iconst_0        
	//*  38   71:aload           7
	//*  39   73:getfield        #419 <Field int Rect.right>
	//*  40   76:aload           6
	//*  41   78:getfield        #419 <Field int Rect.right>
	//*  42   81:isub            
	//*  43   82:invokestatic    #697 <Method int Math.max(int, int)>
	//*  44   85:istore_3        
	//*  45   86:aload_0         
	//*  46   87:invokestatic    #398 <Method boolean ViewUtils.isLayoutRtl(android.view.View)>
	//*  47   90:ifeq            191
	//*  48   93:aload_0         
	//*  49   94:invokevirtual   #700 <Method int getPaddingLeft()>
	//*  50   97:iload_2         
	//*  51   98:iadd            
	//*  52   99:istore          4
	//*  53  101:aload_0         
	//*  54  102:getfield        #411 <Field int mSwitchWidth>
	//*  55  105:iload           4
	//*  56  107:iadd            
	//*  57  108:iload_2         
	//*  58  109:isub            
	...
	//*  61  112:istore          5
	//*  62  114:aload_0         
	//*  63  115:invokevirtual   #703 <Method int getGravity()>
	//*  64  118:bipush          112
	//*  65  120:iand            
	//*  66  121:lookupswitch    2: default 148
	//	               16: 220
	//	               80: 254
	//*  67  148:aload_0         
	//*  68  149:invokevirtual   #706 <Method int getPaddingTop()>
	//*  69  152:istore_3        
	//*  70  153:iload_3         
	//*  71  154:aload_0         
	//*  72  155:getfield        #708 <Field int mSwitchHeight>
	//*  73  158:iadd            
	//*  74  159:istore_2        
	//*  75  160:aload_0         
	//*  76  161:iload           4
	//*  77  163:putfield        #430 <Field int mSwitchLeft>
	//*  78  166:aload_0         
	//*  79  167:iload_3         
	//*  80  168:putfield        #428 <Field int mSwitchTop>
	//*  81  171:aload_0         
	//*  82  172:iload_2         
	//*  83  173:putfield        #432 <Field int mSwitchBottom>
	//*  84  176:aload_0         
	//*  85  177:iload           5
	//*  86  179:putfield        #512 <Field int mSwitchRight>
	//*  87  182:return          
				rect.setEmpty();
	//   88  183:aload           6
	//   89  185:invokevirtual   #656 <Method void Rect.setEmpty()>
	...
	//   91  191:aload_0         
	//   92  192:invokevirtual   #659 <Method int getWidth()>
	//   93  195:aload_0         
	//   94  196:invokevirtual   #711 <Method int getPaddingRight()>
	//   95  199:isub            
	//   96  200:iload_3         
	//   97  201:isub            
	//   98  202:istore          5
	...
	//   99  204:iload           5
	//  100  206:aload_0         
	//  101  207:getfield        #411 <Field int mSwitchWidth>
	//  102  210:isub            
	//  103  211:iload_2         
	//  104  212:iadd            
	//  105  213:iload_3         
...
_L2:
	...
	//  109  220:aload_0         
	//  110  221:invokevirtual   #706 <Method int getPaddingTop()>
	//  111  224:aload_0         
	//  112  225:invokevirtual   #712 <Method int getHeight()>
	//  113  228:iadd            
	//  114  229:aload_0         
	//  115  230:invokevirtual   #715 <Method int getPaddingBottom()>
	//  116  233:isub            
	//  117  234:iconst_2        
	//  118  235:idiv            
	//  119  236:aload_0         
	//  120  237:getfield        #708 <Field int mSwitchHeight>
	//  121  240:iconst_2        
	//  122  241:idiv            
	//  123  242:isub            
	//  124  243:istore_3        
	...
	//  125  244:iload_3         
	//  126  245:aload_0         
	//  127  246:getfield        #708 <Field int mSwitchHeight>
	//  128  249:iadd            
	//  129  250:istore_2        
		continue; /* Loop/switch isn't completed */
	//  130  251:goto            160
_L3:
	...
	//  131  254:aload_0         
	//  132  255:invokevirtual   #712 <Method int getHeight()>
	//  133  258:aload_0         
	//  134  259:invokevirtual   #715 <Method int getPaddingBottom()>
	//  135  262:isub            
	//  136  263:istore_2        
		j = i - mSwitchHeight;
	//  137  264:iload_2         
	//  138  265:aload_0         
	//  139  266:getfield        #708 <Field int mSwitchHeight>
	//  140  269:isub            
	//  141  270:istore_3        
...
_L4:
	...
	//    7   15:aload_0         
	//    8   16:aload_0         
	//    9   17:getfield        #203 <Field CharSequence mTextOn>
	//   10   20:invokespecial   #718 <Method Layout makeLayout(CharSequence)>
	//   11   23:putfield        #625 <Field Layout mOnLayout>
			if(mOffLayout == null)
	//*  12   26:aload_0         
	//*  13   27:getfield        #658 <Field Layout mOffLayout>
	//*  14   30:ifnonnull       45
				mOffLayout = makeLayout(mTextOff);
	//   15   33:aload_0         
	//   16   34:aload_0         
	//   17   35:aload_0         
	//   18   36:getfield        #208 <Field CharSequence mTextOff>
	//   19   39:invokespecial   #718 <Method Layout makeLayout(CharSequence)>
	//   20   42:putfield        #658 <Field Layout mOffLayout>
		}
		Rect rect = mTempRect;
	//   21   45:aload_0         
	//   22   46:getfield        #140 <Field Rect mTempRect>
	//   23   49:astore          9
		int k;
		int l;
		int i1;
		...
		if(mThumbDrawable != null)
	//*  24   51:aload_0         
	//*  25   52:getfield        #183 <Field Drawable mThumbDrawable>
	//*  26   55:ifnull          292
		{
			mThumbDrawable.getPadding(rect);
	//   27   58:aload_0         
	//   28   59:getfield        #183 <Field Drawable mThumbDrawable>
	//   29   62:aload           9
	//   30   64:invokevirtual   #405 <Method boolean Drawable.getPadding(Rect)>
	//   31   67:pop             
			l = mThumbDrawable.getIntrinsicWidth() - rect.left - rect.right;
	//   32   68:aload_0         
	//   33   69:getfield        #183 <Field Drawable mThumbDrawable>
	//   34   72:invokevirtual   #721 <Method int Drawable.getIntrinsicWidth()>
	//   35   75:aload           9
	//   36   77:getfield        #416 <Field int Rect.left>
	//   37   80:isub            
	//   38   81:aload           9
	//   39   83:getfield        #419 <Field int Rect.right>
	//   40   86:isub            
	//   41   87:istore          4
			k = mThumbDrawable.getIntrinsicHeight();
	//   42   89:aload_0         
	//   43   90:getfield        #183 <Field Drawable mThumbDrawable>
	//   44   93:invokevirtual   #724 <Method int Drawable.getIntrinsicHeight()>
	//   45   96:istore_3        
		} else
	//*  46   97:aload_0         
	//*  47   98:getfield        #217 <Field boolean mShowText>
	//*  48  101:ifeq            300
	//*  49  104:aload_0         
	//*  50  105:getfield        #625 <Field Layout mOnLayout>
	//*  51  108:invokevirtual   #646 <Method int Layout.getWidth()>
	//*  52  111:aload_0         
	//*  53  112:getfield        #658 <Field Layout mOffLayout>
	//*  54  115:invokevirtual   #646 <Method int Layout.getWidth()>
	//*  55  118:invokestatic    #697 <Method int Math.max(int, int)>
	//*  56  121:aload_0         
	//*  57  122:getfield        #226 <Field int mThumbTextPadding>
	//*  58  125:iconst_2        
	//*  59  126:imul            
	//*  60  127:iadd            
	//*  61  128:istore          5
	...
	//*  63  131:iload           5
	//*  64  133:iload           4
	//*  65  135:invokestatic    #697 <Method int Math.max(int, int)>
	//*  66  138:putfield        #413 <Field int mThumbWidth>
	//*  67  141:aload_0         
	//*  68  142:getfield        #194 <Field Drawable mTrackDrawable>
	//*  69  145:ifnull          306
	//*  70  148:aload_0         
	//*  71  149:getfield        #194 <Field Drawable mTrackDrawable>
	//*  72  152:aload           9
	//*  73  154:invokevirtual   #405 <Method boolean Drawable.getPadding(Rect)>
	//*  74  157:pop             
	//*  75  158:aload_0         
	//*  76  159:getfield        #194 <Field Drawable mTrackDrawable>
	//*  77  162:invokevirtual   #724 <Method int Drawable.getIntrinsicHeight()>
	//*  78  165:istore          4
	//*  79  167:aload           9
	//*  80  169:getfield        #416 <Field int Rect.left>
	//*  81  172:istore          8
	//*  82  174:aload           9
	//*  83  176:getfield        #419 <Field int Rect.right>
	//*  84  179:istore          7
	//*  85  181:iload           8
	//*  86  183:istore          6
	//*  87  185:iload           7
	//*  88  187:istore          5
	//*  89  189:aload_0         
	//*  90  190:getfield        #183 <Field Drawable mThumbDrawable>
	//*  91  193:ifnull          229
	//*  92  196:aload_0         
	//*  93  197:getfield        #183 <Field Drawable mThumbDrawable>
	//*  94  200:invokestatic    #409 <Method Rect DrawableUtils.getOpticalBounds(Drawable)>
	//*  95  203:astore          9
	//*  96  205:iload           8
	//*  97  207:aload           9
	//*  98  209:getfield        #416 <Field int Rect.left>
	//*  99  212:invokestatic    #697 <Method int Math.max(int, int)>
	//* 100  215:istore          6
	//* 101  217:iload           7
	//* 102  219:aload           9
	//* 103  221:getfield        #419 <Field int Rect.right>
	//* 104  224:invokestatic    #697 <Method int Math.max(int, int)>
	//* 105  227:istore          5
	//* 106  229:aload_0         
	//* 107  230:getfield        #231 <Field int mSwitchMinWidth>
	//* 108  233:aload_0         
	//* 109  234:getfield        #413 <Field int mThumbWidth>
	//* 110  237:iconst_2        
	//* 111  238:imul            
	//* 112  239:iload           6
	//* 113  241:iadd            
	//* 114  242:iload           5
	//* 115  244:iadd            
	//* 116  245:invokestatic    #697 <Method int Math.max(int, int)>
	//* 117  248:istore          5
	//* 118  250:iload           4
	//* 119  252:iload_3         
	//* 120  253:invokestatic    #697 <Method int Math.max(int, int)>
	//* 121  256:istore_3        
	//* 122  257:aload_0         
	//* 123  258:iload           5
	//* 124  260:putfield        #411 <Field int mSwitchWidth>
	//* 125  263:aload_0         
	//* 126  264:iload_3         
	//* 127  265:putfield        #708 <Field int mSwitchHeight>
	//* 128  268:aload_0         
	//* 129  269:iload_1         
	//* 130  270:iload_2         
	//* 131  271:invokespecial   #726 <Method void CompoundButton.onMeasure(int, int)>
	//* 132  274:aload_0         
	//* 133  275:invokevirtual   #729 <Method int getMeasuredHeight()>
	//* 134  278:iload_3         
	//* 135  279:icmpge          291
	//* 136  282:aload_0         
	//* 137  283:aload_0         
	//* 138  284:invokevirtual   #732 <Method int getMeasuredWidthAndState()>
	//* 139  287:iload_3         
	//* 140  288:invokevirtual   #735 <Method void setMeasuredDimension(int, int)>
	//* 141  291:return          
		{
			l = 0;
	//  142  292:iconst_0        
	...
	//* 149  303:goto            130
		{
			rect.setEmpty();
	//  150  306:aload           9
	//  151  308:invokevirtual   #656 <Method void Rect.setEmpty()>
			l = 0;
	//  152  311:iconst_0        
	//  153  312:istore          4
		}
...
_L4:
	...
	//* 105  242:fstore_3        
	//* 106  243:aload_0         
	//* 107  244:getfield        #317 <Field float mThumbPosition>
	//* 108  247:fload_3         
	//* 109  248:fadd            
	//* 110  249:fconst_0        
	//* 111  250:fconst_1        
