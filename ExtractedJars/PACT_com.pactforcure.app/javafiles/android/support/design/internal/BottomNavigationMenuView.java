...
;
	...
	//*  66  110:ifle            133
	//*  67  113:aload_0         
	//*  68  114:getfield        #134 <Field int[] mTempChildWidths>
	//*  69  117:astore          8
	//*  70  119:aload           8
	//*  71  121:iload_1         
	//*  72  122:aload           8
	...
	//*  98  157:idiv            
	//*  99  158:aload_0         
	//* 100  159:getfield        #91  <Field int mActiveItemMaxWidth>
	//* 101  162:invokestatic    #234 <Method int Math.min(int, int)>
	//* 102  165:istore          5
	//* 103  167:iload_2         
	//* 104  168:iload           5
	//* 105  170:iload           4
	...
	//* 113  180:icmpge          232
	//* 114  183:aload_0         
	//* 115  184:getfield        #134 <Field int[] mTempChildWidths>
	//* 116  187:iload_1         
	//* 117  188:iload           5
	//* 118  190:iastore         
	//* 119  191:iload_2         
	...
	//* 122  194:ifle            217
	//* 123  197:aload_0         
	//* 124  198:getfield        #134 <Field int[] mTempChildWidths>
	//* 125  201:astore          8
	//* 126  203:aload           8
	//* 127  205:iload_1         
	//* 128  206:aload           8
	...
	//  155  242:aload_0         
	//  156  243:iload_1         
	//  157  244:invokevirtual   #255 <Method View getChildAt(int)>
	//  158  247:astore          8
			if(view.getVisibility() != 8)
	//* 159  249:aload           8
	//* 160  251:invokevirtual   #260 <Method int View.getVisibility()>
	//* 161  254:bipush          8
	//* 162  256:icmpne          266
	//* 163  259:iload_1         
	//* 164  260:iconst_1        
	...
	//  168  266:aload           8
	//  169  268:aload_0         
	//  170  269:getfield        #134 <Field int[] mTempChildWidths>
	//  171  272:iload_1         
	//  172  273:iaload          
	//  173  274:ldc2            #281 <Int 0x40000000>
	//  174  277:invokestatic    #284 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  175  280:iload           7
	//  176  282:invokevirtual   #287 <Method void View.measure(int, int)>
				view.getLayoutParams().width = view.getMeasuredWidth();
	//  177  285:aload           8
	//  178  287:invokevirtual   #291 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//  179  290:aload           8
	//  180  292:invokevirtual   #269 <Method int View.getMeasuredWidth()>
	//  181  295:putfield        #296 <Field int android.view.ViewGroup$LayoutParams.width>
				j += view.getMeasuredWidth();
	//  182  298:iload_2         
	//  183  299:aload           8
	//  184  301:invokevirtual   #269 <Method int View.getMeasuredWidth()>
	//  185  304:iadd            
	//  186  305:istore_2        
			}
			i++;
	...
	//  189  310:iload_2         
	//  190  311:iload_2         
	//  191  312:ldc2            #281 <Int 0x40000000>
	//  192  315:invokestatic    #284 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  193  318:iconst_0        
	//  194  319:invokestatic    #300 <Method int View.resolveSizeAndState(int, int, int)>
	//  195  322:aload_0         
	//  196  323:getfield        #96  <Field int mItemHeight>
	//  197  326:iload           7
	//  198  328:iconst_0        
	//  199  329:invokestatic    #300 <Method int View.resolveSizeAndState(int, int, int)>
	//  200  332:invokevirtual   #303 <Method void setMeasuredDimension(int, int)>
	//  201  335:return          
	}
