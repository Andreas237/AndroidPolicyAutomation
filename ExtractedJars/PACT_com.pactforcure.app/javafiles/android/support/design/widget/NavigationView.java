...
;
	...
	//*  64  136:istore_3        
	//*  65  137:aload           7
	//*  66  139:getstatic       #134 <Field int android.support.design.R$styleable.NavigationView_itemTextAppearance>
	//*  67  142:invokevirtual   #100 <Method boolean TintTypedArray.hasValue(int)>
	//*  68  145:ifeq            161
	//*  69  148:aload           7
	//*  70  150:getstatic       #134 <Field int android.support.design.R$styleable.NavigationView_itemTextAppearance>
	//*  71  153:iconst_0        
	//*  72  154:invokevirtual   #137 <Method int TintTypedArray.getResourceId(int, int)>
	//*  73  157:istore_3        
	//*  74  158:iconst_1        
	//*  75  159:istore          4
	//*  76  161:aconst_null     
	//*  77  162:astore_2        
	//*  78  163:aload           7
	//*  79  165:getstatic       #140 <Field int android.support.design.R$styleable.NavigationView_itemTextColor>
	//*  80  168:invokevirtual   #100 <Method boolean TintTypedArray.hasValue(int)>
	//*  81  171:ifeq            183
	//*  82  174:aload           7
	//*  83  176:getstatic       #140 <Field int android.support.design.R$styleable.NavigationView_itemTextColor>
	//*  84  179:invokevirtual   #131 <Method ColorStateList TintTypedArray.getColorStateList(int)>
	//*  85  182:astore_2        
	//*  86  183:aload_2         
	//*  87  184:astore          6
	//*  88  186:iload           4
	...
	//*  91  192:astore          6
	//*  92  194:aload_2         
	//*  93  195:ifnonnull       206
	//*  94  198:aload_0         
	//*  95  199:ldc1            #141 <Int 0x1010036>
	//*  96  201:invokespecial   #144 <Method ColorStateList createDefaultColorStateList(int)>
	//*  97  204:astore          6
	//*  98  206:aload           7
	//*  99  208:getstatic       #147 <Field int android.support.design.R$styleable.NavigationView_itemBackground>
	//* 100  211:invokevirtual   #87  <Method Drawable TintTypedArray.getDrawable(int)>
	//* 101  214:astore_2        
	//* 102  215:aload_0         
	//* 103  216:getfield        #64  <Field NavigationMenu mMenu>
	//* 104  219:new             #6   <Class NavigationView$1>
	//* 105  222:dup             
	//* 106  223:aload_0         
	//* 107  224:invokespecial   #150 <Method void NavigationView$1(NavigationView)>
	//* 108  227:invokevirtual   #154 <Method void NavigationMenu.setCallback(android.support.v7.view.menu.MenuBuilder$Callback)>
	//* 109  230:aload_0         
	//* 110  231:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 111  234:iconst_1        
	//* 112  235:invokevirtual   #158 <Method void NavigationMenuPresenter.setId(int)>
	//* 113  238:aload_0         
	//* 114  239:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 115  242:aload_1         
	//* 116  243:aload_0         
	//* 117  244:getfield        #64  <Field NavigationMenu mMenu>
	//* 118  247:invokevirtual   #162 <Method void NavigationMenuPresenter.initForMenu(Context, MenuBuilder)>
	//* 119  250:aload_0         
	//* 120  251:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 121  254:aload           5
	//* 122  256:invokevirtual   #166 <Method void NavigationMenuPresenter.setItemIconTintList(ColorStateList)>
	//* 123  259:iload           4
	//* 124  261:ifeq            272
	//* 125  264:aload_0         
	//* 126  265:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 127  268:iload_3         
	//* 128  269:invokevirtual   #169 <Method void NavigationMenuPresenter.setItemTextAppearance(int)>
	//* 129  272:aload_0         
	//* 130  273:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 131  276:aload           6
	//* 132  278:invokevirtual   #172 <Method void NavigationMenuPresenter.setItemTextColor(ColorStateList)>
	//* 133  281:aload_0         
	//* 134  282:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 135  285:aload_2         
	//* 136  286:invokevirtual   #176 <Method void NavigationMenuPresenter.setItemBackground(Drawable)>
	//* 137  289:aload_0         
	//* 138  290:getfield        #64  <Field NavigationMenu mMenu>
	//* 139  293:aload_0         
	//* 140  294:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 141  297:invokevirtual   #180 <Method void NavigationMenu.addMenuPresenter(android.support.v7.view.menu.MenuPresenter)>
	//* 142  300:aload_0         
	//* 143  301:aload_0         
	//* 144  302:getfield        #53  <Field NavigationMenuPresenter mPresenter>
	//* 145  305:aload_0         
	//* 146  306:invokevirtual   #184 <Method android.support.v7.view.menu.MenuView NavigationMenuPresenter.getMenuView(android.view.ViewGroup)>
	//* 147  309:checkcast       #186 <Class View>
	//* 148  312:invokevirtual   #190 <Method void addView(View)>
	//* 149  315:aload           7
	//* 150  317:getstatic       #193 <Field int android.support.design.R$styleable.NavigationView_menu>
	//* 151  320:invokevirtual   #100 <Method boolean TintTypedArray.hasValue(int)>
	//* 152  323:ifeq            339
	//* 153  326:aload_0         
	//* 154  327:aload           7
	//* 155  329:getstatic       #193 <Field int android.support.design.R$styleable.NavigationView_menu>
	//* 156  332:iconst_0        
	//* 157  333:invokevirtual   #137 <Method int TintTypedArray.getResourceId(int, int)>
	//* 158  336:invokevirtual   #196 <Method void inflateMenu(int)>
	//* 159  339:aload           7
	//* 160  341:getstatic       #199 <Field int android.support.design.R$styleable.NavigationView_headerLayout>
	//* 161  344:invokevirtual   #100 <Method boolean TintTypedArray.hasValue(int)>
	//* 162  347:ifeq            364
	//* 163  350:aload_0         
	//* 164  351:aload           7
	//* 165  353:getstatic       #199 <Field int android.support.design.R$styleable.NavigationView_headerLayout>
	//* 166  356:iconst_0        
	//* 167  357:invokevirtual   #137 <Method int TintTypedArray.getResourceId(int, int)>
	//* 168  360:invokevirtual   #203 <Method View inflateHeaderView(int)>
	//* 169  363:pop             
	//* 170  364:aload           7
	//* 171  366:invokevirtual   #206 <Method void TintTypedArray.recycle()>
	//* 172  369:return          
			colorstatelist = createDefaultColorStateList(0x1010038);
	//  173  370:aload_0         
	//  174  371:ldc1            #207 <Int 0x1010038>
	//  175  373:invokespecial   #144 <Method ColorStateList createDefaultColorStateList(int)>
	//  176  376:astore          5
		flag = false;
		i = 0;
