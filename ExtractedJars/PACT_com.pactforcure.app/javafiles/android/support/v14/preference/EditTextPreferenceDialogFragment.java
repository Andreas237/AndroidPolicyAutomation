...
public class EditTextPreferenceDialogFragment extends PreferenceDialogFragment
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void PreferenceDialogFragment()>
	//    2    4:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #23  <Method android.support.v7.preference.DialogPreference getPreference()>
	...
	//    0    0:new             #2   <Class EditTextPreferenceDialogFragment>
	//    1    3:dup             
	//    2    4:invokespecial   #28  <Method void EditTextPreferenceDialogFragment()>
	//    3    7:astore_1        
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #54  <Method void PreferenceDialogFragment.onBindDialogView(View)>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #81  <Method void PreferenceDialogFragment.onCreate(Bundle)>
		if(bundle == null)
	//*   3    5:aload_1         
	//*   4    6:ifnonnull       21
		{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #111 <Method void PreferenceDialogFragment.onSaveInstanceState(Bundle)>
