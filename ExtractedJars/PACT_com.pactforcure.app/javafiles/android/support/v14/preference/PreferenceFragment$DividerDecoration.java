...
private class PreferenceFragment$DividerDecoration extends android.support.v7.widget.RecyclerView.ItemDecoration
{
	...
	//   16   30:putfield        #59  <Field int mDividerHeight>
		mDivider = drawable;
		PreferenceFragment.access$200(PreferenceFragment.this).invalidateItemDecorations();
	//*  17   33:goto            12
	}
	...
	private PreferenceFragment$DividerDecoration()
	{
	...
	PreferenceFragment$DividerDecoration(PreferenceFragment._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #24  <Method void PreferenceFragment$DividerDecoration(PreferenceFragment)>
	//    3    5:return          
	}
}
