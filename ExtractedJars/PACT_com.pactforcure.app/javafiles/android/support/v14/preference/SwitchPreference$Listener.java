...
private class SwitchPreference$Listener
	implements android.widget.angeListener
{
	...
	private SwitchPreference$Listener()
	{
	...
	SwitchPreference$Listener(SwitchPreference._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #22  <Method void SwitchPreference$Listener(SwitchPreference)>
	//    3    5:return          
	}
}
