...
private static class TranslationAnimationCreator$TransitionPositionListener extends AnimatorListenerAdapter
{
	...
	private TranslationAnimationCreator$TransitionPositionListener(View view, View view1, int i, int j, float f, float f1)
	{
	//    0    0:aload_0         
	...
	TranslationAnimationCreator$TransitionPositionListener(View view, View view1, int i, int j, float f, float f1, TranslationAnimationCreator._cls1 _pcls1)
	{
	...
	//    5    6:fload           5
	//    6    8:fload           6
	//    7   10:invokespecial   #72  <Method void TranslationAnimationCreator$TransitionPositionListener(View, View, int, int, float, float)>
	//    8   13:return          
	}
}
