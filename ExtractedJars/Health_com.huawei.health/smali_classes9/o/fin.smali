...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lo/fin;->d:Z

    .line 69
    invoke-direct {p0, p1}, Lo/fin;->b(Landroid/content/Context;)V
...
.method private b(Landroid/content/Context;)V
    ...
    .line 83
    iput-object p1, p0, Lo/fin;->e:Landroid/content/Context;

    .line 84
    iget-object v0, p0, Lo/fin;->e:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0}, Lo/fin;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/widget/TextView;

    iput-object v0, p0, Lo/fin;->i:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lo/fin;->g:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lo/fin;->k:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lo/fin;->h:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object v0, p0, Lo/fin;->f:Landroid/widget/RelativeLayout;

    .line 90
    iget-object v0, p0, Lo/fin;->f:Landroid/widget/RelativeLayout;
    ...
    iput-object v0, p0, Lo/fin;->m:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object v0, p0, Lo/fin;->p:Lo/bym;
    ...
    .line 95
    iget-object v0, p0, Lo/fin;->k:Landroid/widget/ImageView;
    ...
    .line 100
    :goto_0
    iget-object v0, p0, Lo/fin;->h:Landroid/support/v7/widget/RecyclerView;
...
.method private e()V
    ...
    .line 222
    iget-object v0, p0, Lo/fin;->a:Lcom/huawei/pluginmessagecenter/provider/data/MessageObject;
    ...
    iget-object v3, p0, Lo/fin;->a:Lcom/huawei/pluginmessagecenter/provider/data/MessageObject;
    ...
    iput-object v0, p0, Lo/fin;->b:Ljava/util/List;

    .line 225
    iget-object v0, p0, Lo/fin;->b:Ljava/util/List;
    ...
    iget-object v3, p0, Lo/fin;->b:Ljava/util/List;
    ...
    new-instance v1, Lo/fin$a;

    invoke-direct {v1}, Lo/fin$a;-><init>()V
    ...
    iput-object v0, p0, Lo/fin;->c:Ljava/util/List;
...
.method public c(Lcom/huawei/pluginmessagecenter/provider/data/MessageObject;)V
    ...
    .line 109
    iput-object p1, p0, Lo/fin;->a:Lcom/huawei/pluginmessagecenter/provider/data/MessageObject;
    ...
    .line 112
    iget-object v0, p0, Lo/fin;->g:Landroid/widget/TextView;
    ...
    .line 118
    iget-object v0, p0, Lo/fin;->i:Landroid/widget/TextView;

    iget-object v1, p0, Lo/fin;->a:Lcom/huawei/pluginmessagecenter/provider/data/MessageObject;
    ...
    .line 119
    new-instance v5, Lo/fio;

    iget-object v0, p0, Lo/fin;->e:Landroid/content/Context;

    iget-object v1, p0, Lo/fin;->c:Ljava/util/List;

    iget-object v2, p0, Lo/fin;->a:Lcom/huawei/pluginmessagecenter/provider/data/MessageObject;
    ...
    invoke-direct {v5, v0, v1, v2, v3}, Lo/fio;-><init>(Landroid/content/Context;Ljava/util/List;II)V
    ...
    .line 122
    :pswitch_0
    iget-object v0, p0, Lo/fin;->m:Landroid/support/v7/widget/RecyclerView;

    new-instance v1, Landroid/support/v7/widget/LinearLayoutManager;

    iget-object v2, p0, Lo/fin;->e:Landroid/content/Context;
    ...
    .line 124
    iget-object v0, p0, Lo/fin;->p:Lo/bym;
    ...
    .line 133
    new-instance v6, Lo/fin$4;

    iget-object v0, p0, Lo/fin;->e:Landroid/content/Context;

    const/4 v1, 0x4

    invoke-direct {v6, p0, v0, v1}, Lo/fin$4;-><init>(Lo/fin;Landroid/content/Context;I)V
    ...
    .line 145
    new-instance v6, Lo/fin$1;

    iget-object v0, p0, Lo/fin;->e:Landroid/content/Context;

    const/4 v1, 0x3

    invoke-direct {v6, p0, v0, v1}, Lo/fin$1;-><init>(Lo/fin;Landroid/content/Context;I)V

    goto :goto_0

    .line 157
    :cond_2
    new-instance v6, Lo/fin$3;

    iget-object v0, p0, Lo/fin;->e:Landroid/content/Context;

    const/4 v1, 0x2

    invoke-direct {v6, p0, v0, v1}, Lo/fin$3;-><init>(Lo/fin;Landroid/content/Context;I)V

    goto :goto_0

    .line 170
    :cond_3
    new-instance v6, Lo/fin$2;

    iget-object v0, p0, Lo/fin;->e:Landroid/content/Context;

    const/4 v1, 0x2

    invoke-direct {v6, p0, v0, v1}, Lo/fin$2;-><init>(Lo/fin;Landroid/content/Context;I)V
    ...
    .line 188
    :pswitch_2
    new-instance v7, Lo/fin$5;

    iget-object v0, p0, Lo/fin;->e:Landroid/content/Context;

    invoke-direct {v7, p0, v0}, Lo/fin$5;-><init>(Lo/fin;Landroid/content/Context;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lo/fin;->e:Landroid/content/Context;
