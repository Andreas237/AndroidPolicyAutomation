...
.method public e(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    .line 42
    iget-object v0, p0, Lo/bhx;->b:Landroid/content/Context;
    ...
    .line 44
    new-instance v4, Lo/bgz;

    iget-object v0, p0, Lo/bhx;->b:Landroid/content/Context;

    invoke-direct {v4, v0}, Lo/bgz;-><init>(Landroid/content/Context;)V

    .line 45
    sget v0, Lcom/huawei/android/sns/R$layout;->sns_group_member_item:I
    ...
    .line 47
    invoke-virtual {v4, v5}, Lo/bgz;->d(Landroid/view/View;)Lo/bfl;

    .line 48
    invoke-virtual {p0, v4}, Lo/bhx;->d(Lo/bfl;)V
