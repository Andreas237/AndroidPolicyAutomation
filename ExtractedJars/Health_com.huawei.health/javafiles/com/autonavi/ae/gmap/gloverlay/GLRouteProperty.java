...
{
	public static final class EAMapRouteTexture extends Enum
	{

		public static EAMapRouteTexture valueOf(String s)
		{
			return (EAMapRouteTexture)Enum.valueOf(com/autonavi/ae/gmap/gloverlay/GLRouteProperty$EAMapRouteTexture, s);
		...
		public static EAMapRouteTexture[] values()
		{
			return (EAMapRouteTexture[])((EAMapRouteTexture []) ($VALUES)).clone();
		...
		private static final EAMapRouteTexture $VALUES[];
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_AMBLE;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_ARROW;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_CHARGE;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_CONGESTED;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_DEFAULT;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_FASTER;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_FERRY;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_FREE;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_JAM;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_LIMIT;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_NAVI;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_NONAVI;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_NUMBER;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_OPEN;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_SLOWER;
		public static final EAMapRouteTexture AMAP_ROUTE_TEXTURE_WRONG;

		static 
		{
			AMAP_ROUTE_TEXTURE_NONAVI = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_NONAVI", 0);
		...
		//    5   10:putstatic       #36  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_NONAVI>
			AMAP_ROUTE_TEXTURE_NAVI = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_NAVI", 1);
		...
		//   11   23:putstatic       #39  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_NAVI>
			AMAP_ROUTE_TEXTURE_DEFAULT = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_DEFAULT", 2);
		...
		//   17   36:putstatic       #42  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_DEFAULT>
			AMAP_ROUTE_TEXTURE_OPEN = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_OPEN", 3);
		...
		//   23   49:putstatic       #45  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_OPEN>
			AMAP_ROUTE_TEXTURE_AMBLE = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_AMBLE", 4);
		...
		//   29   62:putstatic       #48  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_AMBLE>
			AMAP_ROUTE_TEXTURE_JAM = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_JAM", 5);
		...
		//   35   75:putstatic       #51  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_JAM>
			AMAP_ROUTE_TEXTURE_CONGESTED = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_CONGESTED", 6);
		...
		//   41   89:putstatic       #54  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_CONGESTED>
			AMAP_ROUTE_TEXTURE_ARROW = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_ARROW", 7);
		...
		//   47  103:putstatic       #57  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_ARROW>
			AMAP_ROUTE_TEXTURE_CHARGE = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_CHARGE", 8);
		...
		//   53  117:putstatic       #60  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_CHARGE>
			AMAP_ROUTE_TEXTURE_FREE = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_FREE", 9);
		...
		//   59  131:putstatic       #63  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_FREE>
			AMAP_ROUTE_TEXTURE_LIMIT = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_LIMIT", 10);
		...
		//   65  145:putstatic       #66  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_LIMIT>
			AMAP_ROUTE_TEXTURE_SLOWER = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_SLOWER", 11);
		...
		//   71  159:putstatic       #69  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_SLOWER>
			AMAP_ROUTE_TEXTURE_FASTER = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_FASTER", 12);
		...
		//   77  173:putstatic       #72  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_FASTER>
			AMAP_ROUTE_TEXTURE_WRONG = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_WRONG", 13);
		...
		//   83  187:putstatic       #75  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_WRONG>
			AMAP_ROUTE_TEXTURE_FERRY = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_FERRY", 14);
		...
		//   89  201:putstatic       #78  <Field GLRouteProperty$EAMapRouteTexture AMAP_ROUTE_TEXTURE_FERRY>
			AMAP_ROUTE_TEXTURE_NUMBER = new EAMapRouteTexture("AMAP_ROUTE_TEXTURE_NUMBER", 15);
		...
		//   96  218:bipush          16
		//   97  220:anewarray       EAMapRouteTexture[]
		//   98  223:dup             
		//   99  224:iconst_0        
		...
		private EAMapRouteTexture(String s, int i)
		{
			super(s, i);
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	public GLRouteProperty()
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #45  <Method void Object()>
		mSimple3DFillResId = -1;
	//    2    4:aload_0         
	//    3    5:iconst_m1       
	//    4    6:putfield        #47  <Field int mSimple3DFillResId>
		mShowArrow = false;
	//    5    9:aload_0         
	//    6   10:iconst_0        
	//    7   11:putfield        #49  <Field boolean mShowArrow>
		mbTexPreMulAlpha = false;
	//    8   14:aload_0         
	//    9   15:iconst_0        
	//   10   16:putfield        #51  <Field boolean mbTexPreMulAlpha>
	//   11   19:return          
	}
