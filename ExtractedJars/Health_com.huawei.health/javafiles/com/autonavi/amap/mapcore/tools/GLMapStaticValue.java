...
public class GLMapStaticValue
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #367 <Method void Object()>
	//    2    4:return          
	}
	...
	public static int ESCREEN_SHOT_CALLBACK_BITMAP = 0;
	public static int ESCREEN_SHOT_CALLBACK_BUFFER = 0;
	public static int ESCREEN_SHOT_CALLBACK_FILE = 0;
	public static int ESCREEN_SHOT_CARTYPE_DEFAULT = 0;
	public static int ESCREEN_SHOT_CARTYPE_JILI = 0;
	public static int ESCREEN_SHOT_CARTYPE_LUCHANG = 0;
	public static int ESCREEN_SHOT_MODE_BACKGROUND = 0;
	public static int ESCREEN_SHOT_MODE_FRONT = 0;
	...
	public static int RENDER_FPS_ANIMATION = 0;
	public static int RENDER_FPS_ANIMATION_WATERWAVE = 0;
	public static int RENDER_FPS_GESTURE_ACTION = 0;
	public static final int RENDER_FPS_MAX = 60;
	public static int RENDER_FPS_NAVI = 0;
	public static int RENDER_FPS_NORMAL = 0;
	public static int SCREEN_SHOT_BITMAP_COMPRESS_RATIO = 0;
	...
	static 
	{
		RENDER_FPS_NAVI = 10;
	//    0    0:bipush          10
	//    1    2:putstatic       #331 <Field int RENDER_FPS_NAVI>
		RENDER_FPS_NORMAL = 20;
	//    2    5:bipush          20
	//    3    7:putstatic       #333 <Field int RENDER_FPS_NORMAL>
		RENDER_FPS_ANIMATION = 50;
	//    4   10:bipush          50
	//    5   12:putstatic       #335 <Field int RENDER_FPS_ANIMATION>
		RENDER_FPS_GESTURE_ACTION = 50;
	//    6   15:bipush          50
	//    7   17:putstatic       #337 <Field int RENDER_FPS_GESTURE_ACTION>
		RENDER_FPS_ANIMATION_WATERWAVE = 30;
	//    8   20:bipush          30
	//    9   22:putstatic       #339 <Field int RENDER_FPS_ANIMATION_WATERWAVE>
		LOG_NAVI_STATE = false;
	//   10   25:iconst_0        
	//   11   26:putstatic       #341 <Field boolean LOG_NAVI_STATE>
		ESCREEN_SHOT_MODE_NULL = 0;
	//   12   29:iconst_0        
	//   13   30:putstatic       #343 <Field int ESCREEN_SHOT_MODE_NULL>
		ESCREEN_SHOT_MODE_BACKGROUND = 1;
	//   14   33:iconst_1        
	//   15   34:putstatic       #345 <Field int ESCREEN_SHOT_MODE_BACKGROUND>
		ESCREEN_SHOT_MODE_FRONT = 2;
	//   16   37:iconst_2        
	//   17   38:putstatic       #347 <Field int ESCREEN_SHOT_MODE_FRONT>
		ESCREEN_SHOT_CARTYPE_DEFAULT = 0;
	//   18   41:iconst_0        
	//   19   42:putstatic       #349 <Field int ESCREEN_SHOT_CARTYPE_DEFAULT>
		ESCREEN_SHOT_CARTYPE_JILI = 1;
	//   20   45:iconst_1        
	//   21   46:putstatic       #351 <Field int ESCREEN_SHOT_CARTYPE_JILI>
		ESCREEN_SHOT_CARTYPE_LUCHANG = 2;
	//   22   49:iconst_2        
	//   23   50:putstatic       #353 <Field int ESCREEN_SHOT_CARTYPE_LUCHANG>
		SCREEN_SHOT_BITMAP_COMPRESS_RATIO = 80;
	//   24   53:bipush          80
	//   25   55:putstatic       #355 <Field int SCREEN_SHOT_BITMAP_COMPRESS_RATIO>
		ESCREEN_SHOT_CALLBACK_BUFFER = 0;
	//   26   58:iconst_0        
	//   27   59:putstatic       #357 <Field int ESCREEN_SHOT_CALLBACK_BUFFER>
		ESCREEN_SHOT_CALLBACK_BITMAP = 1;
	//   28   62:iconst_1        
	//   29   63:putstatic       #359 <Field int ESCREEN_SHOT_CALLBACK_BITMAP>
		ESCREEN_SHOT_CALLBACK_FILE = 2;
	//   30   66:iconst_2        
	//   31   67:putstatic       #361 <Field int ESCREEN_SHOT_CALLBACK_FILE>
		E_DISPLAY_DEFAULT = 0;
	//   32   70:iconst_0        
	//   33   71:putstatic       #363 <Field int E_DISPLAY_DEFAULT>
	//*  34   74:return          
	}
}
