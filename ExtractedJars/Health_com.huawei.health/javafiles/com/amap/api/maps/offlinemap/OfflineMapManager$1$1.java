	...
	implements Runnable
{
	...
	OfflineMapManager$1$1(OfflineMapManager._cls1 _pcls1, bd bd1)
	{
		b = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
...
/* anonymous class */
		...
		implements com.amap.api.mapcore.util.be.a
	{
		...
		//*   4   10:aload_1         
		//*   5   11:ifnull          34
				OfflineMapManager.b(a).post(((Runnable) (new OfflineMapManager._cls1._cls1(this, bd1))));
		//    6   14:aload_0         
