	...
	implements com.amap.api.mapcore.util.be.a
{
	...
	//*   3    7:ifnull          29
			OfflineMapManager.b(a).post(new Runnable() {
	...
	//*   4   10:aload_1         
	//*   5   11:ifnull          34
			OfflineMapManager.b(a).post(new Runnable(bd) {
	...
	OfflineMapManager$1(OfflineMapManager offlinemapmanager)
	{
		a = offlinemapmanager;
	//    0    0:aload_0         
	//    1    1:aload_1         
