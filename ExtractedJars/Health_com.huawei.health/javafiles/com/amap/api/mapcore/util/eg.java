	...
	implements TileProvider
{
	class a extends jj
	{
		...
		public a(int j, int k, int i1, String s)
		{
			a = eg.this;
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	public eg(int i, int j, MapConfig mapconfig)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #22  <Method void Object()>
		b = new Random();
	//    2    4:aload_0         
	//    3    5:new             #24  <Class Random>
	//    4    8:dup             
	//    5    9:invokespecial   #25  <Method void Random()>
	//    6   12:putfield        #27  <Field Random b>
		c = i;
	//    7   15:aload_0         
	//    8   16:iload_1         
	//    9   17:putfield        #29  <Field int c>
		d = j;
	//   10   20:aload_0         
	//   11   21:iload_2         
	//   12   22:putfield        #31  <Field int d>
		e = mapconfig;
	//   13   25:aload_0         
	//   14   26:aload_3         
	//   15   27:putfield        #33  <Field MapConfig e>
	//   16   30:return          
	}

	private byte[] a(int i, int j, int k, String s)
		throws IOException
	{
		try
		{
			s = ((String) (new a(i, j, k, s)));
	//    0    0:new             #8   <Class eg$a>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:iload_2         
	//    5    7:iload_3         
	//    6    8:aload           4
	//    7   10:invokespecial   #42  <Method void eg$a(eg, int, int, int, String)>
	//    8   13:astore          4
			a = ji.a(false);
	//    9   15:aload_0         
	//   10   16:iconst_0        
	//   11   17:invokestatic    #47  <Method ji ji.a(boolean)>
	//   12   20:putfield        #49  <Field ji a>
			s = ((String) (a.d(((jj) (s)))));
	//   13   23:aload_0         
	//   14   24:getfield        #49  <Field ji a>
	//   15   27:aload           4
	//   16   29:invokevirtual   #52  <Method byte[] ji.d(jj)>
	//   17   32:astore          4
		}
	//*  18   34:aload           4
	//*  19   36:areturn         
	...
	//    0    0:aload_0         
	//    1    1:getfield        #33  <Field MapConfig e>
	//    2    4:ifnull          67
_L1:
		Object obj = ((Object) (e.getMapLanguage()));
	//    3    7:aload_0         
	//    4    8:getfield        #33  <Field MapConfig e>
	//    5   11:invokevirtual   #61  <Method String MapConfig.getMapLanguage()>
	//    6   14:astore          4
	//*   7   16:goto            19
_L4:
		try
		{
			obj = ((Object) (a(i, j, k, ((String) (obj)))));
	//    8   19:aload_0         
	//    9   20:iload_1         
	//   10   21:iload_2         
	//   11   22:iload_3         
	//   12   23:aload           4
	//   13   25:invokespecial   #63  <Method byte[] a(int, int, int, String)>
	//   14   28:astore          4
		}
	//*  15   30:aload           4
	//*  16   32:ifnonnull       43
	//*  17   35:getstatic       #67  <Field Tile NO_TILE>
	//*  18   38:astore          4
	//*  19   40:aload           4
	//*  20   42:areturn         
	//*  21   43:aload_0         
	//*  22   44:getfield        #29  <Field int c>
	//*  23   47:aload_0         
	//*  24   48:getfield        #31  <Field int d>
	//*  25   51:aload           4
	//*  26   53:invokestatic    #73  <Method Tile Tile.obtain(int, int, byte[])>
	//*  27   56:astore          4
	//*  28   58:aload           4
	//*  29   60:areturn         
		// Misplaced declaration of an exception variable
	...
	//*  30   61:astore          4
		{
			return NO_TILE;
	//   31   63:getstatic       #67  <Field Tile NO_TILE>
	//   32   66:areturn         
		}
		if(obj != null)
		...
		obj = ((Object) (NO_TILE));
		return ((Tile) (obj));
		obj = ((Object) (Tile.obtain(c, d, ((byte []) (obj)))));
		return ((Tile) (obj));
_L2:
		obj = "zh_cn";
	//   33   67:ldc1            #75  <String "zh_cn">
	//   34   69:astore          4
