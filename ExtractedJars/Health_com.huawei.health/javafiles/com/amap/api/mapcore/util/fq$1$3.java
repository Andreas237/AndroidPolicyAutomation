	...
	implements Runnable
{
	...
	fq$1$3(fq._cls1 _pcls1, float f)
	{
		b = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
...
/* anonymous class */
		...
		implements AMapWidgetListener
	{
		...
		//    4   10:return          
			...
			{
				fq.b(a).post(new fq._cls1._cls2());
		//    5   11:aload_0         
		...
		//    4   10:return          
			...
			{
				fq.c(a).post(((Runnable) (new fq._cls1._cls3(this, f))));
		//    5   11:aload_0         
		//    6   12:getfield        #22  <Field fq a>
...
/* anonymous class */
		...
		// Unreferenced inner class com/amap/api/mapcore/util/fq$1$2

/* anonymous class */
		class fq._cls1._cls2
			implements Runnable
		{
