...
static final class iz$1
	implements ThreadFactory
{

	public Thread newThread(Runnable runnable)
	{
		return new Thread(runnable, (new StringBuilder()).append("disklrucache#").append(a.getAndIncrement()).toString());
	...
	//    6   12:ldc1            #31  <String "disklrucache#">
