	...
	implements Runnable
{
	...
	fo$1$1(fo._cls1 _pcls1, int i, int j)
	{
		c = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//*  50  102:idiv            
		//*  51  103:icmple          127
					a.post(((Runnable) (new fo._cls1._cls1(this, j, k))));
		//   52  106:aload_0         
		...
		// Unreferenced inner class com/amap/api/mapcore/util/fo$1$2

/* anonymous class */
		class fo._cls1._cls2
			implements Runnable
		{
