	...
	implements Runnable
{
	...
	fo$1$2(fo._cls1 _pcls1, int i, int j)
	{
		c = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/amap/api/mapcore/util/fo$1
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//*  62  124:goto            145
					a.post(((Runnable) (new fo._cls1._cls2(this, j, k))));
		//   63  127:aload_0         
		...
		// Unreferenced inner class com/amap/api/mapcore/util/fo$1$1

/* anonymous class */
		class fo._cls1._cls1
			implements Runnable
		{
