...
static final class ed$1
	implements ThreadFactory
{

	public Thread newThread(Runnable runnable)
	{
		return new Thread(runnable, (new StringBuilder()).append("AbstractAsyncTask #").append(a.getAndIncrement()).toString());
	...
	//    6   12:ldc1            #31  <String "AbstractAsyncTask #">
