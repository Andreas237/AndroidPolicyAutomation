...
//			AbstractParser, Any, InvalidProtocolBufferException, CodedInputStream, 
//			ExtensionRegistryLite

static final class Any$1 extends AbstractParser
{

	public Any parsePartialFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
		throws InvalidProtocolBufferException
	{
		return new Any(codedinputstream, extensionregistrylite, ((Any$1) (null)));
	//    0    0:new             #7   <Class Any>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:aload_2         
