...
public static final class DescriptorProtos$DescriptorProto$ReservedRange extends GeneratedMessageV3
	implements rBuilder
{
		...
		implements DescriptorProtos.DescriptorProto.ReservedRangeOrBuilder
	{
		...
		public Builder mergeFrom(DescriptorProtos.DescriptorProto.ReservedRange reservedrange)
		{
	...
	public static Builder newBuilder(DescriptorProtos$DescriptorProto$ReservedRange descriptorprotos$descriptorproto$reservedrange)
	{
	...
	public static DescriptorProtos$DescriptorProto$ReservedRange parseFrom(byte abyte0[])
		throws InvalidProtocolBufferException
	{
		return (DescriptorProtos$DescriptorProto$ReservedRange)PARSER.parseFrom(abyte0);
	//    0    0:getstatic       #47  <Field Parser PARSER>
	//    1    3:aload_0         
	...
	public static DescriptorProtos$DescriptorProto$ReservedRange parseFrom(byte abyte0[], ExtensionRegistryLite extensionregistrylite)
		throws InvalidProtocolBufferException
	{
		return (DescriptorProtos$DescriptorProto$ReservedRange)PARSER.parseFrom(abyte0, extensionregistrylite);
	//    0    0:getstatic       #47  <Field Parser PARSER>
	//    1    3:aload_0         
	//    2    4:aload_1         
	...
	//    3    5:iconst_1        
	//    4    6:ireturn         
		if(!(obj instanceof DescriptorProtos$DescriptorProto$ReservedRange))
	//*   5    7:aload_1         
	...
	//   11   19:ireturn         
		obj = ((Object) ((DescriptorProtos$DescriptorProto$ReservedRange)obj));
	//   12   20:aload_1         
	//   13   21:checkcast       #2   <Class DescriptorProtos$DescriptorProto$ReservedRange>
	//   14   24:astore_1        
		boolean flag;
		if(true && hasStart() == ((DescriptorProtos$DescriptorProto$ReservedRange) (obj)).hasStart())
	//*  15   25:iconst_1        
	//*  16   26:ifeq            45
	//*  17   29:aload_0         
	...
	//*  31   53:ifeq            78
			if(flag && getStart() == ((DescriptorProtos$DescriptorProto$ReservedRange) (obj)).getStart())
	//*  32   56:iload_2         
	//*  33   57:ifeq            76
	//*  34   60:aload_0         
	...
	//   42   76:iconst_0        
	//   43   77:istore_3        
		if(flag1 && hasEnd() == ((DescriptorProtos$DescriptorProto$ReservedRange) (obj)).hasEnd())
	//*  44   78:iload_3         
	//*  45   79:ifeq            98
	//*  46   82:aload_0         
	...
	//*  60  106:ifeq            131
			if(flag && getEnd() == ((DescriptorProtos$DescriptorProto$ReservedRange) (obj)).getEnd())
	//*  61  109:iload_2         
	//*  62  110:ifeq            129
	//*  63  113:aload_0         
	...
	//   71  129:iconst_0        
	//   72  130:istore_3        
		return flag1 && unknownFields.equals(((Object) (((DescriptorProtos$DescriptorProto$ReservedRange) (obj)).unknownFields)));
	//   73  131:iload_3         
	//   74  132:ifeq            151
	//   75  135:aload_0         
...
/*
	static int access$4302(DescriptorProtos$DescriptorProto$ReservedRange descriptorprotos$descriptorproto$reservedrange, int i)
	{
		descriptorprotos$descriptorproto$reservedrange.start_ = i;
	//    0    0:aload_0         
	//    1    1:iload_1         
...
/*
	static int access$4402(DescriptorProtos$DescriptorProto$ReservedRange descriptorprotos$descriptorproto$reservedrange, int i)
	{
		descriptorprotos$descriptorproto$reservedrange.end_ = i;
	//    0    0:aload_0         
	//    1    1:iload_1         
...
/*
	static int access$4502(DescriptorProtos$DescriptorProto$ReservedRange descriptorprotos$descriptorproto$reservedrange, int i)
	{
		descriptorprotos$descriptorproto$reservedrange.bitField0_ = i;
	//    0    0:aload_0         
	//    1    1:iload_1         
...
_L7:
	...
	DescriptorProtos$DescriptorProto$ReservedRange(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite, DescriptorProtos._cls1 _pcls1)
		throws InvalidProtocolBufferException
	{
	...
	private DescriptorProtos$DescriptorProto$ReservedRange(GeneratedMessageV3.Builder builder)
	{
		super(builder);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	DescriptorProtos$DescriptorProto$ReservedRange(GeneratedMessageV3.Builder builder, DescriptorProtos._cls1 _pcls1)
	{
		this(builder);
	//    0    0:aload_0         
	//    1    1:aload_1         
