...
public static final class DescriptorProtos$ExtensionRangeOptions extends GeneratedMessageV3.ExtendableMessage
	implements rBuilder
{
		...
		implements DescriptorProtos.ExtensionRangeOptionsOrBuilder
	{
		...
		//   28   51:putfield        #47  <Field int bitField0_>
				...
				extensionrangeoptions.uninterpretedOption_ = uninterpretedOption_;
		//   29   54:aload_2         
		//   30   55:aload_0         
		...
		//*  34   63:goto            78
			{
				extensionrangeoptions.uninterpretedOption_ = uninterpretedOptionBuilder_.build();
		//   35   66:aload_2         
		//   36   67:aload_0         
		...
		public Builder mergeFrom(DescriptorProtos.ExtensionRangeOptions extensionrangeoptions)
		{
		...
		//*  15   37:ifeq            62
					{
						uninterpretedOption_ = extensionrangeoptions.uninterpretedOption_;
		//   16   40:aload_0         
		//   17   41:aload_1         
		...
		//   28   63:invokespecial   #88  <Method void ensureUninterpretedOptionIsMutable()>
						uninterpretedOption_.addAll(((java.util.Collection) (extensionrangeoptions.uninterpretedOption_)));
		//   29   66:aload_0         
		...
		//*  73  161:goto            176
				{
					uninterpretedOptionBuilder_.addAllMessages(((Iterable) (extensionrangeoptions.uninterpretedOption_)));
		//   74  164:aload_0         
	...
	//    0    0:getstatic       #40  <Field DescriptorProtos$ExtensionRangeOptions DEFAULT_INSTANCE>
	//    1    3:areturn         
	}
	...
	{
		return DescriptorProtos.access$6200();
	//    0    0:invokestatic    #141 <Method Descriptors$Descriptor DescriptorProtos.access$6200()>
	//    1    3:areturn         
	}
	...
	//    0    0:getstatic       #40  <Field DescriptorProtos$ExtensionRangeOptions DEFAULT_INSTANCE>
	//    1    3:invokevirtual   #145 <Method DescriptorProtos$ExtensionRangeOptions$Builder toBuilder()>
	//    2    6:areturn         
	}
	...
	//    1    3:invokevirtual   #145 <Method DescriptorProtos$ExtensionRangeOptions$Builder toBuilder()>
	//    2    6:aload_0         
	//    3    7:invokevirtual   #149 <Method DescriptorProtos$ExtensionRangeOptions$Builder DescriptorProtos$ExtensionRangeOptions$Builder.mergeFrom(DescriptorProtos$ExtensionRangeOptions)>
	//    4   10:areturn         
	}
	...
	//    3    7:checkcast       #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//    4   10:areturn         
	}
	...
	//    4    8:checkcast       #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//    5   11:areturn         
	}
	...
	//    3    9:checkcast       #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//    4   12:areturn         
	}
	...
	//    4   10:checkcast       #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//    5   13:areturn         
	}
	...
	public static DescriptorProtos$ExtensionRangeOptions parseFrom(byte abyte0[])
		throws InvalidProtocolBufferException
	{
		return (DescriptorProtos$ExtensionRangeOptions)PARSER.parseFrom(abyte0);
	//    0    0:getstatic       #43  <Field Parser PARSER>
	//    1    3:aload_0         
	...
	public static DescriptorProtos$ExtensionRangeOptions parseFrom(byte abyte0[], ExtensionRegistryLite extensionregistrylite)
		throws InvalidProtocolBufferException
	{
		return (DescriptorProtos$ExtensionRangeOptions)PARSER.parseFrom(abyte0, extensionregistrylite);
	//    0    0:getstatic       #43  <Field Parser PARSER>
	//    1    3:aload_0         
	//    2    4:aload_1         
	...
	//*   5    7:aload_1         
	//*   6    8:instanceof      #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//*   7   11:ifne            20
	...
	//   11   19:ireturn         
		obj = ((Object) ((DescriptorProtos$ExtensionRangeOptions)obj));
	//   12   20:aload_1         
	//   13   21:checkcast       #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//   14   24:astore_1        
		boolean flag;
		if(true && getUninterpretedOptionList().equals(((Object) (((DescriptorProtos$ExtensionRangeOptions) (obj)).getUninterpretedOptionList()))))
	//*  15   25:iconst_1        
	//*  16   26:ifeq            50
	//*  17   29:aload_0         
	...
	//   26   50:iconst_0        
	//   27   51:istore_2        
		if(flag && unknownFields.equals(((Object) (((DescriptorProtos$ExtensionRangeOptions) (obj)).unknownFields))))
	//*  28   52:iload_2         
	//*  29   53:ifeq            75
	//*  30   56:aload_0         
	...
	//   39   75:iconst_0        
	//   40   76:istore_2        
		return flag && getExtensionFields().equals(((Object) (((DescriptorProtos$ExtensionRangeOptions) (obj)).getExtensionFields())));
	//   41   77:iload_2         
	//   42   78:ifeq            99
	//   43   81:aload_0         
	...
	public volatile Message getDefaultInstanceForType()
	{
		return ((Message) (getDefaultInstanceForType()));
	//    0    0:aload_0         
	//    1    1:invokevirtual   #223 <Method DescriptorProtos$ExtensionRangeOptions getDefaultInstanceForType()>
	//    2    4:areturn         
	}
	...
	{
		return DescriptorProtos.access$6300().ensureFieldAccessorsInitialized(com/google/protobuf/DescriptorProtos$ExtensionRangeOptions, com/google/protobuf/DescriptorProtos$ExtensionRangeOptions$Builder);
	//    0    0:invokestatic    #283 <Method GeneratedMessageV3$FieldAccessorTable DescriptorProtos.access$6300()>
	//    1    3:ldc1            #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//    2    5:ldc1            #14  <Class DescriptorProtos$ExtensionRangeOptions$Builder>
	...
	{
		return newBuilder();
	//    0    0:invokestatic    #301 <Method DescriptorProtos$ExtensionRangeOptions$Builder newBuilder()>
	//    1    3:areturn         
	}
	...
	//    0    0:new             #14  <Class DescriptorProtos$ExtensionRangeOptions$Builder>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:aconst_null     
	//    4    6:invokespecial   #305 <Method void DescriptorProtos$ExtensionRangeOptions$Builder(GeneratedMessageV3$BuilderParent, DescriptorProtos$1)>
	//    5    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #308 <Method DescriptorProtos$ExtensionRangeOptions$Builder newBuilderForType()>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #311 <Method DescriptorProtos$ExtensionRangeOptions$Builder newBuilderForType(GeneratedMessageV3$BuilderParent)>
	//    3    5:areturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getstatic       #40  <Field DescriptorProtos$ExtensionRangeOptions DEFAULT_INSTANCE>
	//*   2    4:if_acmpne       16
			return new Builder(((DescriptorProtos._cls1) (null)));
	//    3    7:new             #14  <Class DescriptorProtos$ExtensionRangeOptions$Builder>
	//    4   10:dup             
	//    5   11:aconst_null     
	//    6   12:invokespecial   #315 <Method void DescriptorProtos$ExtensionRangeOptions$Builder(DescriptorProtos$1)>
	//    7   15:areturn         
		else
			return (new Builder(((DescriptorProtos._cls1) (null)))).mergeFrom(this);
	//    8   16:new             #14  <Class DescriptorProtos$ExtensionRangeOptions$Builder>
	//    9   19:dup             
	//   10   20:aconst_null     
	//   11   21:invokespecial   #315 <Method void DescriptorProtos$ExtensionRangeOptions$Builder(DescriptorProtos$1)>
	//   12   24:aload_0         
	//   13   25:invokevirtual   #149 <Method DescriptorProtos$ExtensionRangeOptions$Builder DescriptorProtos$ExtensionRangeOptions$Builder.mergeFrom(DescriptorProtos$ExtensionRangeOptions)>
	//   14   28:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #145 <Method DescriptorProtos$ExtensionRangeOptions$Builder toBuilder()>
	//    2    4:areturn         
	}
	...
	public void writeTo(CodedOutputStream codedoutputstream)
		throws IOException
	{
		tensionWriter tensionwriter = newExtensionWriter();
	//    0    0:aload_0         
	...
	//   21   43:istore_2        
	//*  22   44:goto            7
		tensionwriter.writeUntil(0x20000000, codedoutputstream);
	//   23   47:aload_3         
	...
	public static final Parser PARSER = new AbstractParser() {
		...
		public DescriptorProtos.ExtensionRangeOptions parsePartialFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
			throws InvalidProtocolBufferException
		{
			return new DescriptorProtos.ExtensionRangeOptions(codedinputstream, extensionregistrylite, ((DescriptorProtos._cls1) (null)));
		//    0    0:new             #7   <Class DescriptorProtos$ExtensionRangeOptions>
		//    1    3:dup             
		//    2    4:aload_1         
		//    3    5:aload_2         
		//    4    6:aconst_null     
		//    5    7:invokespecial   #22  <Method void DescriptorProtos$ExtensionRangeOptions(CodedInputStream, ExtensionRegistryLite, DescriptorProtos$1)>
		//    6   10:areturn         
		}
		...
		//    1    1:aload_1         
		//    2    2:aload_2         
		//    3    3:invokevirtual   #26  <Method DescriptorProtos$ExtensionRangeOptions parsePartialFrom(CodedInputStream, ExtensionRegistryLite)>
		//    4    6:areturn         
		}
...
;
	...
	static 
	{
	//    0    0:new             #2   <Class DescriptorProtos$ExtensionRangeOptions>
	//    1    3:dup             
	//    2    4:invokespecial   #38  <Method void DescriptorProtos$ExtensionRangeOptions()>
	//    3    7:putstatic       #40  <Field DescriptorProtos$ExtensionRangeOptions DEFAULT_INSTANCE>
	//    4   10:new             #12  <Class DescriptorProtos$ExtensionRangeOptions$1>
	//    5   13:dup             
	//    6   14:invokespecial   #41  <Method void DescriptorProtos$ExtensionRangeOptions$1()>
...
/*
	static List access$6700(DescriptorProtos$ExtensionRangeOptions descriptorprotos$extensionrangeoptions)
	{
...
/*
	static List access$6702(DescriptorProtos$ExtensionRangeOptions descriptorprotos$extensionrangeoptions, List list)
	{
...
*/
	...
	private DescriptorProtos$ExtensionRangeOptions(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
		throws InvalidProtocolBufferException
	{
		boolean flag;
		boolean flag5;
		...
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #38  <Method void DescriptorProtos$ExtensionRangeOptions()>
...
_L6:
	...
	//   73  153:iload           4
	//   74  155:istore          5
		uninterpretedOption_.add(((Object) (codedinputstream.readMessage(DescriptorProtos.UninterpretedOption.PARSER, extensionregistrylite))));
	//   75  157:aload_0         
...
_L2:
	...
	DescriptorProtos$ExtensionRangeOptions(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite, DescriptorProtos._cls1 _pcls1)
		throws InvalidProtocolBufferException
	{
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #123 <Method void DescriptorProtos$ExtensionRangeOptions(CodedInputStream, ExtensionRegistryLite)>
	//    4    6:return          
	}

	private DescriptorProtos$ExtensionRangeOptions(GeneratedMessageV3.ExtendableBuilder extendablebuilder)
	{
	...
	DescriptorProtos$ExtensionRangeOptions(GeneratedMessageV3.ExtendableBuilder extendablebuilder, DescriptorProtos._cls1 _pcls1)
	{
		this(extendablebuilder);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #130 <Method void DescriptorProtos$ExtensionRangeOptions(GeneratedMessageV3$ExtendableBuilder)>
	//    3    5:return          
	}
}
