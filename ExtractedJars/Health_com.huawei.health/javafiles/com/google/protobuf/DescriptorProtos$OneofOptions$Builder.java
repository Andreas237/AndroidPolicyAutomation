...
public static final class DescriptorProtos$OneofOptions$Builder extends GeneratedMessageV3.ExtendableBuilder
	implements 
{
	...
	public DescriptorProtos$OneofOptions$Builder addExtension(GeneratedMessage.GeneratedExtension generatedextension, Object obj)
	{
		return (DescriptorProtos$OneofOptions$Builder)super.addExtension(generatedextension, obj);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	...
	public DescriptorProtos$OneofOptions$Builder addRepeatedField(Descriptors.FieldDescriptor fielddescriptor, Object obj)
	{
	...
	public DescriptorProtos$OneofOptions$Builder addUninterpretedOption(int i, uilder uilder)
	{
		if(uninterpretedOptionBuilder_ == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #61  <Field RepeatedFieldBuilderV3 uninterpretedOptionBuilder_>
	...
	public DescriptorProtos$OneofOptions$Builder addUninterpretedOption(uilder uilder)
	{
		if(uninterpretedOptionBuilder_ == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #61  <Field RepeatedFieldBuilderV3 uninterpretedOptionBuilder_>
	...
	//   28   51:putfield        #47  <Field int bitField0_>
			...
			DescriptorProtos.OneofOptions.access$20602(oneofoptions, uninterpretedOption_);
	//   29   54:aload_2         
	//   30   55:aload_0         
	...
	//*  34   63:goto            78
		{
			DescriptorProtos.OneofOptions.access$20602(oneofoptions, uninterpretedOptionBuilder_.build());
	//   35   66:aload_2         
	//   36   67:aload_0         
	...
	public DescriptorProtos$OneofOptions$Builder clearExtension(GeneratedMessage.GeneratedExtension generatedextension)
	{
		return (DescriptorProtos$OneofOptions$Builder)super.clearExtension(generatedextension);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public DescriptorProtos$OneofOptions$Builder clearField(Descriptors.FieldDescriptor fielddescriptor)
	{
	...
	public DescriptorProtos$OneofOptions$Builder clearOneof(Descriptors.OneofDescriptor oneofdescriptor)
	{
	...
	public DescriptorProtos$OneofOptions$Builder mergeFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
		throws IOException
	{
	...
	//*   7   13:ifnonnull       87
		{
			if(!DescriptorProtos.OneofOptions.access$20600(oneofoptions).isEmpty())
	//*   8   16:aload_1         
	...
	//*  15   37:ifeq            62
				{
					uninterpretedOption_ = DescriptorProtos.OneofOptions.access$20600(oneofoptions);
	//   16   40:aload_0         
	//   17   41:aload_1         
	...
	//   28   63:invokespecial   #88  <Method void ensureUninterpretedOptionIsMutable()>
					uninterpretedOption_.addAll(((java.util.Collection) (DescriptorProtos.OneofOptions.access$20600(oneofoptions))));
	//   29   66:aload_0         
	...
	//*  73  161:goto            176
			{
				uninterpretedOptionBuilder_.addAllMessages(((Iterable) (DescriptorProtos.OneofOptions.access$20600(oneofoptions))));
	//   74  164:aload_0         
	...
	public DescriptorProtos$OneofOptions$Builder setExtension(GeneratedMessage.GeneratedExtension generatedextension, int i, Object obj)
	{
		return (DescriptorProtos$OneofOptions$Builder)super.setExtension(generatedextension, i, obj);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:aload_3         
	...
	public DescriptorProtos$OneofOptions$Builder setExtension(GeneratedMessage.GeneratedExtension generatedextension, Object obj)
	{
		return (DescriptorProtos$OneofOptions$Builder)super.setExtension(generatedextension, obj);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	...
	public DescriptorProtos$OneofOptions$Builder setField(Descriptors.FieldDescriptor fielddescriptor, Object obj)
	{
	...
	public DescriptorProtos$OneofOptions$Builder setRepeatedField(Descriptors.FieldDescriptor fielddescriptor, int i, Object obj)
	{
	...
	public DescriptorProtos$OneofOptions$Builder setUninterpretedOption(int i, uilder uilder)
	{
		if(uninterpretedOptionBuilder_ == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #61  <Field RepeatedFieldBuilderV3 uninterpretedOptionBuilder_>
	...
	DescriptorProtos$OneofOptions$Builder(DescriptorProtos._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	...
	DescriptorProtos$OneofOptions$Builder(GeneratedMessageV3.BuilderParent builderparent, DescriptorProtos._cls1 _pcls1)
	{
		this(builderparent);
	//    0    0:aload_0         
	//    1    1:aload_1         
