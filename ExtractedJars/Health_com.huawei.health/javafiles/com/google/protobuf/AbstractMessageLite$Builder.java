...
//			AbstractMessageLite, Internal, LazyStringList, ByteString, 
//			PrimitiveNonBoxingCollection, UninitializedMessageException, ExtensionRegistryLite, CodedInputStream, 
//			InvalidProtocolBufferException, MessageLite

public static abstract class AbstractMessageLite$Builder
	implements MessageLite.Builder
{
	...
	protected abstract AbstractMessageLite$Builder internalMergeFrom(AbstractMessageLite abstractmessagelite);
	...
	public abstract AbstractMessageLite$Builder mergeFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
		throws IOException;

	public AbstractMessageLite$Builder mergeFrom(MessageLite messagelite)
	{
	...
	public AbstractMessageLite$Builder mergeFrom(byte abyte0[])
		throws InvalidProtocolBufferException
	{
	...
	public AbstractMessageLite$Builder mergeFrom(byte abyte0[], int i, int j)
		throws InvalidProtocolBufferException
	{
		try
		{
	...
	public AbstractMessageLite$Builder mergeFrom(byte abyte0[], int i, int j, ExtensionRegistryLite extensionregistrylite)
		throws InvalidProtocolBufferException
	{
		try
		{
	...
	public AbstractMessageLite$Builder mergeFrom(byte abyte0[], ExtensionRegistryLite extensionregistrylite)
		throws InvalidProtocolBufferException
	{
