...
//			Parser, AbstractParser, InvalidProtocolBufferException, CodedInputStream, 
//			Message, ExtensionRegistryLite
...
public final class DiscardUnknownFieldsParser
{
	...
	{
		return ((Parser) (new AbstractParser(parser) {
			...
			//    1    1:invokevirtual   #29  <Method void CodedInputStream.discardUnknownFields()>
				extensionregistrylite = ((ExtensionRegistryLite) ((Message)parser.parsePartialFrom(codedinputstream, extensionregistrylite)));
			//    2    4:aload_0         
	...
	//    0    0:new             #6   <Class DiscardUnknownFieldsParser$1>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #16  <Method void DiscardUnknownFieldsParser$1(Parser)>
	//    4    8:areturn         
	}
}
