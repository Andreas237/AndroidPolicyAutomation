...
//			AbstractParser, Api, InvalidProtocolBufferException, CodedInputStream, 
//			ExtensionRegistryLite

static final class Api$1 extends AbstractParser
{

	public Api parsePartialFrom(CodedInputStream codedinputstream, ExtensionRegistryLite extensionregistrylite)
		throws InvalidProtocolBufferException
	{
		return new Api(codedinputstream, extensionregistrylite, ((Api$1) (null)));
	//    0    0:new             #7   <Class Api>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:aload_2         
