	...
	implements android.os.Parcelable.Creator
{
	...
	static void zza(zzbn zzbn1, Parcel parcel, int i)
	{
		int j = zzc.zzaZ(parcel);
	//    0    0:aload_1         
	//    1    1:invokestatic    #20  <Method int zzc.zzaZ(Parcel)>
	//    2    4:istore_3        
		zzc.zzc(parcel, 2, zzbn1.statusCode);
	//    3    5:aload_1         
	//    4    6:iconst_2        
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field int zzbn.statusCode>
	//    7   11:invokestatic    #30  <Method void zzc.zzc(Parcel, int, int)>
		zzc.zza(parcel, 3, ((android.os.Parcelable) (zzbn1.zzbUC)), i, false);
	//    8   14:aload_1         
	//    9   15:iconst_3        
	//   10   16:aload_0         
	//   11   17:getfield        #34  <Field zzao zzbn.zzbUC>
	//   12   20:iload_2         
	//   13   21:iconst_0        
	...
	{
		return ((Object) (zzlk(parcel)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #47  <Method zzbn zzlk(Parcel)>
	//    3    5:areturn         
	}

	public Object[] newArray(int i)
	{
		return ((Object []) (zzpM(i)));
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #53  <Method zzbn[] zzpM(int)>
	//    3    5:areturn         
	}

	public zzbn zzlk(Parcel parcel)
	{
	...
	//*  22   66:goto            92
				case 3: // '\003'
					zzao1 = (zzao)zzb.zza(parcel, k, zzao.CREATOR);
	//   23   69:aload_1         
	//   24   70:iload           4
	//   25   72:getstatic       #81  <Field android.os.Parcelable$Creator zzao.CREATOR>
	//   26   75:invokestatic    #84  <Method android.os.Parcelable zzb.zza(Parcel, int, android.os.Parcelable$Creator)>
	//   27   78:checkcast       #77  <Class zzao>
	//   28   81:astore          5
					break;
	...
	//   51  132:athrow          
				...
				return new zzbn(i, zzao1);
	//   52  133:new             #22  <Class zzbn>
	//   53  136:dup             
	//   54  137:iload_2         
	//   55  138:aload           5
	//   56  140:invokespecial   #113 <Method void zzbn(int, zzao)>
	//   57  143:areturn         
		while(true);
	}

	public zzbn[] zzpM(int i)
	{
		return new zzbn[i];
	//    0    0:iload_1         
	//    1    1:anewarray       zzbn[]
