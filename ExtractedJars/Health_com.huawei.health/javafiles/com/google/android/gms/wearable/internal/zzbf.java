	...
	implements android.os.Parcelable.Creator
{
	...
	static void zza(zzbg zzbg1, Parcel parcel, int i)
	{
		i = zzc.zzaZ(parcel);
	//    0    0:aload_1         
	//    1    1:invokestatic    #20  <Method int zzc.zzaZ(Parcel)>
	//    2    4:istore_2        
		zzc.zzc(parcel, 2, zzbg1.statusCode);
	//    3    5:aload_1         
	//    4    6:iconst_2        
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field int zzbg.statusCode>
	//    7   11:invokestatic    #30  <Method void zzc.zzc(Parcel, int, int)>
		zzc.zza(parcel, 3, zzbg1.enabled);
	//    8   14:aload_1         
	//    9   15:iconst_3        
	//   10   16:aload_0         
	//   11   17:getfield        #34  <Field boolean zzbg.enabled>
	...
	{
		return ((Object) (zzlg(parcel)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #47  <Method zzbg zzlg(Parcel)>
	//    3    5:areturn         
	}

	public Object[] newArray(int i)
	{
		return ((Object []) (zzpI(i)));
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #53  <Method zzbg[] zzpI(int)>
	//    3    5:areturn         
	}
	...
	//   49  126:athrow          
				...
				return new zzbg(i, flag);
	//   50  127:new             #22  <Class zzbg>
	//   51  130:dup             
	//   52  131:iload_2         
	//   53  132:iload           5
	//   54  134:invokespecial   #107 <Method void zzbg(int, boolean)>
	//   55  137:areturn         
		while(true);
	}
