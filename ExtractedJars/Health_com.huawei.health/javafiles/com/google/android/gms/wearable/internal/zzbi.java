	...
	implements android.os.Parcelable.Creator
{
	...
	static void zza(zzbh zzbh1, Parcel parcel, int i)
	{
		int j = zzc.zzaZ(parcel);
	//    0    0:aload_1         
	//    1    1:invokestatic    #20  <Method int zzc.zzaZ(Parcel)>
	//    2    4:istore_3        
		zzc.zzc(parcel, 2, zzbh1.statusCode);
	//    3    5:aload_1         
	//    4    6:iconst_2        
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field int zzbh.statusCode>
	//    7   11:invokestatic    #30  <Method void zzc.zzc(Parcel, int, int)>
		zzc.zza(parcel, 3, ((android.os.Parcelable) (zzbh1.zzbUz)), i, false);
	//    8   14:aload_1         
	//    9   15:iconst_3        
	//   10   16:aload_0         
	//   11   17:getfield        #34  <Field ConnectionConfiguration zzbh.zzbUz>
	//   12   20:iload_2         
	//   13   21:iconst_0        
	...
	{
		return ((Object) (zzlh(parcel)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #47  <Method zzbh zzlh(Parcel)>
	//    3    5:areturn         
	}

	public Object[] newArray(int i)
	{
		return ((Object []) (zzpJ(i)));
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #53  <Method zzbh[] zzpJ(int)>
	//    3    5:areturn         
	}
	...
	//*  22   66:goto            92
				case 3: // '\003'
					connectionconfiguration = (ConnectionConfiguration)zzb.zza(parcel, k, ConnectionConfiguration.CREATOR);
	//   23   69:aload_1         
	//   24   70:iload           4
	...
	//   27   78:checkcast       #77  <Class ConnectionConfiguration>
	//   28   81:astore          5
					break;
	...
	//   52  133:new             #22  <Class zzbh>
	//   53  136:dup             
	//   54  137:iload_2         
	//   55  138:aload           5
	//   56  140:invokespecial   #113 <Method void zzbh(int, ConnectionConfiguration)>
	//   57  143:areturn         
		while(true);
	}
