	...
	implements android.os.Parcelable.Creator
{
	...
	static void zza(zzco zzco1, Parcel parcel, int i)
	{
		i = zzc.zzaZ(parcel);
	//    0    0:aload_1         
	//    1    1:invokestatic    #20  <Method int zzc.zzaZ(Parcel)>
	//    2    4:istore_2        
		zzc.zzc(parcel, 2, zzco1.statusCode);
	//    3    5:aload_1         
	//    4    6:iconst_2        
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field int zzco.statusCode>
	//    7   11:invokestatic    #30  <Method void zzc.zzc(Parcel, int, int)>
		zzc.zzc(parcel, 3, zzco1.zzbhU);
	//    8   14:aload_1         
	//    9   15:iconst_3        
	//   10   16:aload_0         
	//   11   17:getfield        #33  <Field int zzco.zzbhU>
	...
	{
		return ((Object) (zzlu(parcel)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #43  <Method zzco zzlu(Parcel)>
	//    3    5:areturn         
	}

	public Object[] newArray(int i)
	{
		return ((Object []) (zzpW(i)));
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #49  <Method zzco[] zzpW(int)>
	//    3    5:areturn         
	}
	...
	//   49  127:athrow          
				...
				return new zzco(j, i);
	//   50  128:new             #22  <Class zzco>
	//   51  131:dup             
	//   52  132:iload_3         
	//   53  133:iload_2         
	//   54  134:invokespecial   #100 <Method void zzco(int, int)>
	//   55  137:areturn         
		while(true);
	}
