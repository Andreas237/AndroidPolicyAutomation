	...
	implements android.os.Parcelable.Creator
{
	...
	static void zza(zzbl zzbl1, Parcel parcel, int i)
	{
		i = zzc.zzaZ(parcel);
	//    0    0:aload_1         
	//    1    1:invokestatic    #20  <Method int zzc.zzaZ(Parcel)>
	//    2    4:istore_2        
		zzc.zzc(parcel, 2, zzbl1.statusCode);
	//    3    5:aload_1         
	//    4    6:iconst_2        
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field int zzbl.statusCode>
	//    7   11:invokestatic    #30  <Method void zzc.zzc(Parcel, int, int)>
		zzc.zzc(parcel, 3, zzbl1.zzbUB, false);
	//    8   14:aload_1         
	//    9   15:iconst_3        
	//   10   16:aload_0         
	//   11   17:getfield        #34  <Field java.util.List zzbl.zzbUB>
	//   12   20:iconst_0        
	...
	{
		return ((Object) (zzlj(parcel)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #47  <Method zzbl zzlj(Parcel)>
	//    3    5:areturn         
	}

	public Object[] newArray(int i)
	{
		return ((Object []) (zzpL(i)));
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #53  <Method zzbl[] zzpL(int)>
	//    3    5:areturn         
	}

	public zzbl zzlj(Parcel parcel)
	{
	...
	//*  22   66:goto            89
				case 3: // '\003'
					arraylist = zzb.zzc(parcel, k, zzcc.CREATOR);
	//   23   69:aload_1         
	//   24   70:iload           4
	//   25   72:getstatic       #81  <Field android.os.Parcelable$Creator zzcc.CREATOR>
	...
	//   50  129:athrow          
				...
				return new zzbl(i, ((java.util.List) (arraylist)));
	//   51  130:new             #22  <Class zzbl>
	//   52  133:dup             
	//   53  134:iload_2         
	//   54  135:aload           5
	//   55  137:invokespecial   #113 <Method void zzbl(int, java.util.List)>
	//   56  140:areturn         
		while(true);
	}

	public zzbl[] zzpL(int i)
	{
		return new zzbl[i];
	//    0    0:iload_1         
	//    1    1:anewarray       zzbl[]
