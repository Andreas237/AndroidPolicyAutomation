	...
	implements Result
{
	...
	protected DataItem zzD(int i, int j)
	{
		return ((DataItem) (new zzaq(zzaBi, i, j)));
	//    0    0:new             #33  <Class zzaq>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #37  <Field DataHolder zzaBi>
	//    4    8:iload_1         
	//    5    9:iload_2         
	//    6   10:invokespecial   #40  <Method void zzaq(DataHolder, int, int)>
	//    7   13:areturn         
	}

	public Object zzo(int i, int j)
	{
		return ((Object) (zzD(i, j)));
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:iload_2         
	//    3    3:invokevirtual   #44  <Method DataItem zzD(int, int)>
	//    4    6:areturn         
	}
