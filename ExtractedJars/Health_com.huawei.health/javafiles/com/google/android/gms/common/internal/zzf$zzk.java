...
protected final class zzf$zzk extends zzf$zza
{
	...
	{
		zzaFu.zzaFi.zzg(connectionresult);
	//    0    0:aload_0         
	//    1    1:getfield        #16  <Field zzf zzaFu>
	//    2    4:getfield        #27  <Field zzf$zzf zzf.zzaFi>
	//    3    7:aload_1         
	//    4    8:invokeinterface #32  <Method void zzf$zzf.zzg(ConnectionResult)>
		zzaFu.onConnectionFailed(connectionresult);
	//    5   13:aload_0         
	//    6   14:getfield        #16  <Field zzf zzaFu>
	//    7   17:aload_1         
	...
	{
		zzaFu.zzaFi.zzg(ConnectionResult.zzayj);
	//    0    0:aload_0         
	//    1    1:getfield        #16  <Field zzf zzaFu>
	//    2    4:getfield        #27  <Field zzf$zzf zzf.zzaFi>
	//    3    7:getstatic       #43  <Field ConnectionResult ConnectionResult.zzayj>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #16  <Field zzf zzaFu>
		super(zzf1, i, bundle);
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:iload_2         
