...
public abstract class GoogleApiClient
{
	public static final class Builder
	{
		...
		private Builder zza(zzabd zzabd1, int i, OnConnectionFailedListener onconnectionfailedlistener)
		{
			boolean flag;
			if(i >= 0)
		//*   0    0:iload_2         
		...
		//   12   22:putfield        #68  <Field int zzazl>
			zzazm = onconnectionfailedlistener;
		//   13   25:aload_0         
		//   14   26:aload_3         
		...
		//   66  153:astore          12
				obj2 = ((Object) (zza(zza1, obj1, mContext, zzrs, zzg1, ((ConnectionCallbacks) (obj2)), ((OnConnectionFailedListener) (obj2)))));
		//   67  155:aload           12
		//   68  157:aload           4
		//   69  159:aload_0         
		...
		//    7   15:pop             
			zzazj.put(((Object) (api)), ((Object) (hasoptions)));
		//    8   16:aload_0         
		...
		//   13   27:pop             
			api = ((Api) (api.zzve().zzp(((Object) (hasoptions)))));
		//   14   28:aload_1         
		...
		//    2    4:invokestatic    #132 <Method Object zzac.zzb(Object, Object)>
		//    3    7:pop             
			zzazp.add(((Object) (connectioncallbacks)));
		//    4    8:aload_0         
		...
		//    2    4:invokestatic    #132 <Method Object zzac.zzb(Object, Object)>
		//    3    7:pop             
			zzazq.add(((Object) (onconnectionfailedlistener)));
		//    4    8:aload_0         
...
_L1:
		...
		{
			return zza(new zzabd(((android.app.Activity) (fragmentactivity))), i, onconnectionfailedlistener);
		//    0    0:aload_0         
	...
	{
		Set set = zzazc;
	//    0    0:getstatic       #36  <Field Set zzazc>
	//    1    3:astore          6
		set;
	//    2    5:aload           6
		JVM INSTR monitorenter ;
	...
	//    6   11:aload_0         
	//    7   12:invokestatic    #46  <Method String String.valueOf(Object)>
	//    8   15:ldc1            #48  <String "  ">
	//    9   17:invokevirtual   #52  <Method String String.concat(String)>
	//   10   20:astore          7
		iterator = zzazc.iterator();
	//   11   22:getstatic       #36  <Field Set zzazc>
	//   12   25:invokeinterface #58  <Method Iterator Set.iterator()>
	//   13   30:astore          8
_L1:
	...
	//   20   52:astore          9
		printwriter1 = printwriter.append(((CharSequence) (s))).append("GoogleApiClient#");
	//   21   54:aload_2         
	//   22   55:aload_0         
	...
	//   29   69:iadd            
	//   30   70:istore          5
		printwriter1.println(i);
	//   31   72:aload           10
	//   32   74:iload           4
	//   33   76:invokevirtual   #80  <Method void PrintWriter.println(int)>
	...
	//   37   84:aload_2         
	//   38   85:aload_3         
	//   39   86:invokevirtual   #83  <Method void dump(String, FileDescriptor, PrintWriter, String[])>
		i = j;
	//   40   89:iload           5
	//   41   91:istore          4
		  goto _L1
	...
	//    3    5:monitorenter    
		Set set1 = zzazc;
	//    4    6:getstatic       #36  <Field Set zzazc>
	//    5    9:astore_1        
		set;
	//    6   10:aload_0         
		JVM INSTR monitorexit ;
	...
	public com.google.android.gms.internal.zzaad.zza zza(com.google.android.gms.internal.zzaad.zza zza1)
	{
		throw new UnsupportedOperationException();
	//    0    0:new             #97  <Class UnsupportedOperationException>
	//    1    3:dup             
	...
	public com.google.android.gms.internal.zzaad.zza zzb(com.google.android.gms.internal.zzaad.zza zza1)
	{
		throw new UnsupportedOperationException();
	//    0    0:new             #97  <Class UnsupportedOperationException>
	//    1    3:dup             
	...
	private static final Set zzazc = Collections.newSetFromMap(((Map) (new WeakHashMap())));
	...
	//    4   10:putstatic       #36  <Field Set zzazc>
	//*   5   13:return          
	}
}
