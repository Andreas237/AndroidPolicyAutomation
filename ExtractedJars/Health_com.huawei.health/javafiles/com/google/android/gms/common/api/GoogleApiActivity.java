	...
	implements android.content.DialogInterface.OnCancelListener
{
	...
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:putfield        #14  <Field int zzazb>
	//    5    9:return          
	}
	...
	private void zza(int i, zzaax zzaax1)
	{
		switch(i)
	//*   0    0:iload_1         
		{
	...
	//    2   28:return          
		...
		case 0: // '\0'
			zzaax1.zza(new ConnectionResult(13, ((PendingIntent) (null))), getIntent().getIntExtra("failing_client_id", -1));
	//    3   29:aload_2         
	//    4   30:new             #34  <Class ConnectionResult>
	//    5   33:dup             
	//    6   34:bipush          13
	//    7   36:aconst_null     
	//    8   37:invokespecial   #37  <Method void ConnectionResult(int, PendingIntent)>
	//    9   40:aload_0         
	//   10   41:invokevirtual   #41  <Method Intent getIntent()>
	//   11   44:ldc1            #43  <String "failing_client_id">
	//   12   46:iconst_m1       
	//   13   47:invokevirtual   #49  <Method int Intent.getIntExtra(String, int)>
	//   14   50:invokevirtual   #54  <Method void zzaax.zza(ConnectionResult, int)>
			return;
	//   15   53:return          
		...
		case -1: 
			zzaax1.zzvx();
	//   16   54:aload_2         
	//   17   55:invokevirtual   #57  <Method void zzaax.zzvx()>
			return;
	//   18   58:return          
		}
	}
	...
	//   45   83:aload_0         
	//   46   84:iconst_1        
	//   47   85:putfield        #14  <Field int zzazb>
				return;
	//   48   88:return          
			}
	...
	//   66  118:aload_0         
	//   67  119:iconst_1        
	//   68  120:putfield        #14  <Field int zzazb>
			return;
	//   69  123:return          
		}
	}
	...
	//   14   24:aload_0         
	//   15   25:iconst_0        
	//   16   26:putfield        #14  <Field int zzazb>
			setResultCode(j);
	//   17   29:aload_0         
	//   18   30:iload_2         
	...
	//*  20   34:iload           4
	//*  21   36:ifeq            48
				zza(j, zzaax.zzaP(((Context) (this))));
	//   22   39:aload_0         
	//   23   40:iload_2         
	//   24   41:aload_0         
	//   25   42:invokestatic    #149 <Method zzaax zzaax.zzaP(Context)>
	//   26   45:invokespecial   #151 <Method void zza(int, zzaax)>
		} else
	//*  27   48:goto            66
		if(i == 2)
	//*  28   51:iload_1         
	...
	//   31   56:aload_0         
	//   32   57:iconst_0        
	//   33   58:putfield        #14  <Field int zzazb>
			setResultCode(j);
	//   34   61:aload_0         
	//   35   62:iload_2         
	//   36   63:invokevirtual   #145 <Method void setResultCode(int)>
		}
		finish();
	//   37   66:aload_0         
	//   38   67:invokevirtual   #94  <Method void finish()>
	//   39   70:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:putfield        #14  <Field int zzazb>
		setResult(0);
	//    3    5:aload_0         
	//    4    6:iconst_0        
	...
	//*   3    5:aload_1         
	//*   4    6:ifnull          19
			zzazb = bundle.getInt("resolution");
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:ldc1            #162 <String "resolution">
	//    8   13:invokevirtual   #166 <Method int Bundle.getInt(String)>
	//    9   16:putfield        #14  <Field int zzazb>
		if(zzazb != 1)
	//*  10   19:aload_0         
	//*  11   20:getfield        #14  <Field int zzazb>
	//*  12   23:iconst_1        
	//*  13   24:icmpeq          31
			zzvl();
	//   14   27:aload_0         
	//   15   28:invokespecial   #168 <Method void zzvl()>
	//   16   31:return          
	}

	protected void onSaveInstanceState(Bundle bundle)
	{
		bundle.putInt("resolution", zzazb);
	//    0    0:aload_1         
	//    1    1:ldc1            #162 <String "resolution">
	//    2    3:aload_0         
	//    3    4:getfield        #14  <Field int zzazb>
