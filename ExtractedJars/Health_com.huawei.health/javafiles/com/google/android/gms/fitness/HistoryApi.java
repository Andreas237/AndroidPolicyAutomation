...
public interface HistoryApi
{
	...
	public abstract PendingResult readDailyTotalFromLocalDevice(GoogleApiClient googleapiclient, DataType datatype);

	public abstract PendingResult readData(GoogleApiClient googleapiclient, DataReadRequest datareadrequest);

	public abstract PendingResult registerDataUpdateListener(GoogleApiClient googleapiclient, DataUpdateListenerRegistrationRequest dataupdatelistenerregistrationrequest);

	public abstract PendingResult unregisterDataUpdateListener(GoogleApiClient googleapiclient, PendingIntent pendingintent);

	public abstract PendingResult updateData(GoogleApiClient googleapiclient, DataUpdateRequest dataupdaterequest);
}
