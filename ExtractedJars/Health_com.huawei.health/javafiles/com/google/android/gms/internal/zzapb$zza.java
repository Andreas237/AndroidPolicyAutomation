...
public static abstract class zzapb$zza extends Binder
	implements zzapb
{
	static class zza
		implements zzapb
	{
		...
		//    2    4:aload_2         
		//    3    5:ldc1            #32  <String "com.google.android.gms.fitness.internal.IReadRawCallback">
		...
		//   11   20:aload_2         
		//   12   21:iconst_0        
		//   13   22:invokevirtual   #46  <Method void zzp.writeToParcel(Parcel, int)>
	...
	//    4    6:aload_0         
	//    5    7:ldc1            #13  <String "com.google.android.gms.fitness.internal.IReadRawCallback">
	//    6    9:invokeinterface #19  <Method android.os.IInterface IBinder.queryLocalInterface(String)>
	//    7   14:astore_1        
		if(iinterface != null && (iinterface instanceof zzapb))
	//*   8   15:aload_1         
	//*   9   16:ifnull          31
	//*  10   19:aload_1         
	//*  11   20:instanceof      #6   <Class zzapb>
	//*  12   23:ifeq            31
			return (zzapb)iinterface;
	//   13   26:aload_1         
	//   14   27:checkcast       #6   <Class zzapb>
	//   15   30:areturn         
		else
			return ((zzapb) (new zza(ibinder)));
	//   16   31:new             #9   <Class zzapb$zza$zza>
	//   17   34:dup             
	//   18   35:aload_0         
	//   19   36:invokespecial   #23  <Method void zzapb$zza$zza(IBinder)>
	//   20   39:areturn         
	}
	...
	//    3   31:aload_3         
	//    4   32:ldc1            #13  <String "com.google.android.gms.fitness.internal.IReadRawCallback">
	...
	//    8   39:aload_2         
	//    9   40:ldc1            #13  <String "com.google.android.gms.fitness.internal.IReadRawCallback">
	//   10   42:invokevirtual   #37  <Method void Parcel.enforceInterface(String)>
			if(parcel.readInt() != 0)
	//*  11   45:aload_2         
	//*  12   46:invokevirtual   #41  <Method int Parcel.readInt()>
	//*  13   49:ifeq            68
				parcel = ((Parcel) ((zzp)zzp.CREATOR.createFromParcel(parcel)));
	//   14   52:getstatic       #47  <Field android.os.Parcelable$Creator zzp.CREATOR>
	//   15   55:aload_2         
	//   16   56:invokeinterface #53  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
	//   17   61:checkcast       #43  <Class zzp>
	//   18   64:astore_2        
			else
	//*  19   65:goto            70
				parcel = null;
	...
	//   22   70:aload_0         
	//   23   71:aload_2         
	//   24   72:invokevirtual   #56  <Method void zza(zzp)>
			return true;
	//   25   75:iconst_1        
	//   26   76:ireturn         
		}
