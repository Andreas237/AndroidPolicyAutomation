...
//			zzbxl, zzbxm, zzbxt, zzbxw

public static final class zzbld$zza extends zzbxn
{
	public static final class zza extends zzbxn
	{
		...
		//   27   49:ireturn         
			...
			if(!zzbVy.equals(((Object) (((zza) (obj)).zzbVy))))
		//*  28   50:aload_0         
...
_L7:
		...
		private static volatile zza zzbVx[];
		public int type;
		public zza zzbVy;
	...
	public static final class zza.zza extends zzbxn
	{
		...
		//   12   20:astore_1        
			if(!Arrays.equals(zzbVz, ((zza.zza) (obj)).zzbVz))
		//*  13   21:aload_0         
		...
		//   28   52:ireturn         
			...
			if(!zzbVA.equals(((Object) (((zza.zza) (obj)).zzbVA))))
		//*  29   53:aload_0         
		...
		//   35   67:iconst_0        
		//   36   68:ireturn         
			if(Double.doubleToLongBits(zzbVB) != Double.doubleToLongBits(((zza.zza) (obj)).zzbVB))
		//*  37   69:aload_0         
		...
		//   45   87:iconst_0        
		//   46   88:ireturn         
			if(Float.floatToIntBits(zzbVC) != Float.floatToIntBits(((zza.zza) (obj)).zzbVC))
		//*  47   89:aload_0         
		...
		//   83  159:iconst_0        
		//   84  160:ireturn         
			if(!zzbxr.equals(((Object []) (zzbVH)), ((Object []) (((zza.zza) (obj)).zzbVH))))
		//*  85  161:aload_0         
		...
		//   91  175:iconst_0        
		//   92  176:ireturn         
			if(!zzbxr.equals(((Object []) (zzbVI)), ((Object []) (((zza.zza) (obj)).zzbVI))))
		//*  93  177:aload_0         
		...
		//   99  191:iconst_0        
		//  100  192:ireturn         
			if(!zzbxr.equals(((Object []) (zzbVJ)), ((Object []) (((zza.zza) (obj)).zzbVJ))))
		//* 101  193:aload_0         
		...
		//  107  207:iconst_0        
		//  108  208:ireturn         
			if(!zzbxr.equals(zzbVK, ((zza.zza) (obj)).zzbVK))
		//* 109  209:aload_0         
		...
		//  115  223:iconst_0        
		//  116  224:ireturn         
			if(!zzbxr.equals(zzbVL, ((zza.zza) (obj)).zzbVL))
		//* 117  225:aload_0         
		...
		public zza.zza zzaa(zzbxl zzbxl1)
			throws IOException
		{
			do
			{
		...
		//  139  400:arraylength     
		//  140  401:istore_2        
					zza azza1[] = new zza[k + j2];
		//  141  402:iload_2         
		//  142  403:iload_3         
		//  143  404:iadd            
		//  144  405:anewarray       zza[]
		//  145  408:astore          5
					j2 = k;
		//  146  410:iload_2         
		//  147  411:istore_3        
	...
	//*   7   15:ifnonnull       25
			zzbVv = new zzbld$zza[0];
	//    8   18:iconst_0        
	//    9   19:anewarray       zzbld$zza[]
	...
	//   20   36:ireturn         
		...
		if(!name.equals(((Object) (((zzbld$zza) (obj)).name))))
	//*  21   37:aload_0         
	...
	//   36   68:ireturn         
		...
		if(!zzbVw.equals(((Object) (((zzbld$zza) (obj)).zzbVw))))
	//*  37   69:aload_0         
	...
	//*  51   99:ifeq            123
			return ((zzbld$zza) (obj)).zzcuI == null || ((zzbld$zza) (obj)).zzcuI.isEmpty();
	//   52  102:aload_1         
	...
	//   62  122:ireturn         
			...
			return zzcuI.equals(((Object) (((zzbld$zza) (obj)).zzcuI)));
	//   63  123:aload_0         
	...
	public zzbld$zza zzY(zzbxl zzbxl1)
		throws IOException
	{
		do
		{
	...
	private static volatile zzbld$zza zzbVv[];
	public String name;
	public zza zzbVw;
