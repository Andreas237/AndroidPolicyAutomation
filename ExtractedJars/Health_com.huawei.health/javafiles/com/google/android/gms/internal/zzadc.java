	...
	implements ThreadFactory
{
	...
	public zzadc(String s)
	{
		this(s, 0);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:iconst_0        
	//    3    3:invokespecial   #19  <Method void zzadc(String, int)>
	//    4    6:return          
	}

	public zzadc(String s, int i)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #23  <Method void Object()>
		zzaIw = new AtomicInteger();
	//    2    4:aload_0         
	//    3    5:new             #25  <Class AtomicInteger>
	//    4    8:dup             
	//    5    9:invokespecial   #26  <Method void AtomicInteger()>
	//    6   12:putfield        #28  <Field AtomicInteger zzaIw>
		zzaIx = Executors.defaultThreadFactory();
	//    7   15:aload_0         
	//    8   16:invokestatic    #34  <Method ThreadFactory Executors.defaultThreadFactory()>
	//    9   19:putfield        #36  <Field ThreadFactory zzaIx>
		zzaIv = (String)zzac.zzb(((Object) (s)), "Name must not be null");
	//   10   22:aload_0         
	//   11   23:aload_1         
	...
	//   15   32:putfield        #48  <Field String zzaIv>
		mPriority = i;
	//   16   35:aload_0         
	//   17   36:iload_2         
	...
	{
		runnable = ((Runnable) (zzaIx.newThread(((Runnable) (new zzadd(runnable, mPriority))))));
	//    0    0:aload_0         
	//    1    1:getfield        #36  <Field ThreadFactory zzaIx>
	//    2    4:new             #54  <Class zzadd>
	//    3    7:dup             
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:getfield        #50  <Field int mPriority>
	//    7   13:invokespecial   #57  <Method void zzadd(Runnable, int)>
	//    8   16:invokeinterface #59  <Method Thread ThreadFactory.newThread(Runnable)>
	//    9   21:astore_1        
		String s = zzaIv;
	//   10   22:aload_0         
	//   11   23:getfield        #48  <Field String zzaIv>
	//   12   26:astore_3        
		int i = zzaIw.getAndIncrement();
	//   13   27:aload_0         
	//   14   28:getfield        #28  <Field AtomicInteger zzaIw>
