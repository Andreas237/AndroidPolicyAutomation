...
public static abstract class zzaon$zza extends Binder
	implements zzaon
{
	static class zza
		implements zzaon
	{
		...
		//    2    4:aload_2         
		//    3    5:ldc1            #32  <String "com.google.android.gms.fitness.internal.IDataSourcesCallback">
		...
		//   11   20:aload_2         
		//   12   21:iconst_0        
		//   13   22:invokevirtual   #46  <Method void DataSourcesResult.writeToParcel(Parcel, int)>
	...
	//    2    4:aconst_null     
	//    3    5:areturn         
		android.os.IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.fitness.internal.IDataSourcesCallback");
	//    4    6:aload_0         
	//    5    7:ldc1            #15  <String "com.google.android.gms.fitness.internal.IDataSourcesCallback">
	//    6    9:invokeinterface #28  <Method android.os.IInterface IBinder.queryLocalInterface(String)>
	//    7   14:astore_1        
		if(iinterface != null && (iinterface instanceof zzaon))
	//*   8   15:aload_1         
	//*   9   16:ifnull          31
	//*  10   19:aload_1         
	//*  11   20:instanceof      #6   <Class zzaon>
	//*  12   23:ifeq            31
			return (zzaon)iinterface;
	//   13   26:aload_1         
	//   14   27:checkcast       #6   <Class zzaon>
	//   15   30:areturn         
		else
			return ((zzaon) (new zza(ibinder)));
	//   16   31:new             #9   <Class zzaon$zza$zza>
	//   17   34:dup             
	//   18   35:aload_0         
	//   19   36:invokespecial   #31  <Method void zzaon$zza$zza(IBinder)>
	//   20   39:areturn         
	}
	...
	//    3   31:aload_3         
	//    4   32:ldc1            #15  <String "com.google.android.gms.fitness.internal.IDataSourcesCallback">
	...
	//    8   39:aload_2         
	//    9   40:ldc1            #15  <String "com.google.android.gms.fitness.internal.IDataSourcesCallback">
	//   10   42:invokevirtual   #46  <Method void Parcel.enforceInterface(String)>
			if(parcel.readInt() != 0)
	//*  11   45:aload_2         
	//*  12   46:invokevirtual   #50  <Method int Parcel.readInt()>
	//*  13   49:ifeq            68
				parcel = ((Parcel) ((DataSourcesResult)DataSourcesResult.CREATOR.createFromParcel(parcel)));
	//   14   52:getstatic       #56  <Field android.os.Parcelable$Creator DataSourcesResult.CREATOR>
	//   15   55:aload_2         
	//   16   56:invokeinterface #62  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
	//   17   61:checkcast       #52  <Class DataSourcesResult>
	//   18   64:astore_2        
			else
	//*  19   65:goto            70
				parcel = null;
	//   20   68:aconst_null     
	//   21   69:astore_2        
			zza(((DataSourcesResult) (parcel)));
	//   22   70:aload_0         
	//   23   71:aload_2         
	//   24   72:invokevirtual   #65  <Method void zza(DataSourcesResult)>
			return true;
	//   25   75:iconst_1        
	//   26   76:ireturn         
		}
	...
	//    1    1:invokespecial   #13  <Method void Binder()>
		attachInterface(((android.os.IInterface) (this)), "com.google.android.gms.fitness.internal.IDataSourcesCallback");
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:ldc1            #15  <String "com.google.android.gms.fitness.internal.IDataSourcesCallback">
