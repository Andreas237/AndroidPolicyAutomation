...
class zzapl$1$1 extends zzaor$zza
{
	...
	// Unreferenced inner class com/google/android/gms/internal/zzapl$1

/* anonymous class */
	class zzapl._cls1 extends zzaof.zza
	{
		...
		protected void zza(zzaof zzaof1)
			throws RemoteException
		{
			zzapl._cls1._cls1 _lcls1 = new zzapl._cls1._cls1(this);
		//    0    0:new             #12  <Class zzapl$1$1>
		//    1    3:dup             
		//    2    4:aload_0         
		//    3    5:invokespecial   #42  <Method void zzapl$1$1(zzapl$1)>
		//    4    8:astore_2        
			((zzaou)zzaof1.zzxD()).zza(new GoalsReadRequest(zzaUJ, ((zzaor) (_lcls1))));
		//    5    9:aload_1         
