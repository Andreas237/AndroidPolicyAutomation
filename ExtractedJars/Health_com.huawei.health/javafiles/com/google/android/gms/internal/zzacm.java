...
public class zzacm
{
	...
	private zzacm(String s, String s1)
	{
	//    0    0:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_2         
	//    4    6:putfield        #18  <Field String zzaGs>
		mTag = s;
	//    5    9:aload_0         
	//    6   10:aload_1         
	...
	//   13   23:putfield        #27  <Field zzq zzaGO>
		zzafc = getLogLevel();
	//   14   26:aload_0         
	//   15   27:aload_0         
	//   16   28:invokespecial   #31  <Method int getLogLevel()>
	//   17   31:putfield        #33  <Field int zzafc>
	//   18   34:return          
	}

	public transient zzacm(String s, String as[])
	{
		this(s, zzd(as));
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//    4    6:invokespecial   #41  <Method void zzacm(String, String)>
	//    5    9:return          
	}
	...
	//   12   18:astore_3        
		...
		return zzaGs.concat(s1);
	//   13   19:aload_0         
	//   14   20:getfield        #18  <Field String zzaGs>
	//   15   23:aload_3         
	...
	//*   0    0:aload_0         
	//*   1    1:iconst_2        
	//*   2    2:invokevirtual   #84  <Method boolean zzak(int)>
	//*   3    5:ifeq            22
	...
	public boolean zzak(int i)
	{
		return zzafc <= i;
	//    0    0:aload_0         
	//    1    1:getfield        #33  <Field int zzafc>
	//    2    4:iload_1         
	//    3    5:icmpgt          10
	//    4    8:iconst_1        
	//    5    9:ireturn         
