...
public abstract class zzabo
{
	...
	{
		return zzaCm;
	//    0    0:getstatic       #35  <Field ExecutorService zzaCm>
	//    1    3:areturn         
	}

	private static final ExecutorService zzaCm;

	static 
	{
		zzaCm = ((ExecutorService) (new ThreadPoolExecutor(0, 4, 60L, TimeUnit.SECONDS, ((java.util.concurrent.BlockingQueue) (new LinkedBlockingQueue())), ((java.util.concurrent.ThreadFactory) (new zzadc("GAC_Transform"))))));
	...
	//    9   19:new             #25  <Class zzadc>
	//   10   22:dup             
	//   11   23:ldc1            #27  <String "GAC_Transform">
	//   12   25:invokespecial   #30  <Method void zzadc(String)>
	...
	//   14   31:putstatic       #35  <Field ExecutorService zzaCm>
	//*  15   34:return          
	}
}
