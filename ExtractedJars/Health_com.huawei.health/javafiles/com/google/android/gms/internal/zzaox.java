	...
	extends IInterface
{
		...
		implements zzaox
	{
		...
		//    4    6:aload_0         
		//    5    7:ldc1            #13  <String "com.google.android.gms.fitness.internal.IGoogleFitRecordingApi">
		//    6    9:invokeinterface #19  <Method IInterface IBinder.queryLocalInterface(String)>
		//    7   14:astore_1        
			if(iinterface != null && (iinterface instanceof zzaox))
		//*   8   15:aload_1         
		//*   9   16:ifnull          31
		//*  10   19:aload_1         
		//*  11   20:instanceof      #6   <Class zzaox>
		//*  12   23:ifeq            31
				return (zzaox)iinterface;
		//   13   26:aload_1         
		//   14   27:checkcast       #6   <Class zzaox>
		//   15   30:areturn         
			else
				return ((zzaox) (new zza(ibinder)));
		//   16   31:new             #9   <Class zzaox$zza$zza>
		//   17   34:dup             
		//   18   35:aload_0         
		//   19   36:invokespecial   #23  <Method void zzaox$zza$zza(IBinder)>
		//   20   39:areturn         
		}
		...
		//    3   47:aload_3         
		//    4   48:ldc1            #13  <String "com.google.android.gms.fitness.internal.IGoogleFitRecordingApi">
		...
		//    8   55:aload_2         
		//    9   56:ldc1            #13  <String "com.google.android.gms.fitness.internal.IGoogleFitRecordingApi">
		//   10   58:invokevirtual   #37  <Method void Parcel.enforceInterface(String)>
				if(parcel.readInt() != 0)
		//*  11   61:aload_2         
		//*  12   62:invokevirtual   #41  <Method int Parcel.readInt()>
		//*  13   65:ifeq            84
					parcel = ((Parcel) ((zzbm)zzbm.CREATOR.createFromParcel(parcel)));
		//   14   68:getstatic       #47  <Field android.os.Parcelable$Creator zzbm.CREATOR>
		//   15   71:aload_2         
		//   16   72:invokeinterface #53  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
		//   17   77:checkcast       #43  <Class zzbm>
		//   18   80:astore_2        
				else
		//*  19   81:goto            86
					parcel = null;
		...
		//   22   86:aload_0         
		//   23   87:aload_2         
		//   24   88:invokevirtual   #56  <Method void zza(zzbm)>
		...
		//   28   96:ireturn         
			...
			case 2: // '\002'
				parcel.enforceInterface("com.google.android.gms.fitness.internal.IGoogleFitRecordingApi");
		//   29   97:aload_2         
		//   30   98:ldc1            #13  <String "com.google.android.gms.fitness.internal.IGoogleFitRecordingApi">
		//   31  100:invokevirtual   #37  <Method void Parcel.enforceInterface(String)>
				if(parcel.readInt() != 0)
		//*  32  103:aload_2         
		//*  33  104:invokevirtual   #41  <Method int Parcel.readInt()>
		//*  34  107:ifeq            126
					parcel = ((Parcel) ((zzbq)zzbq.CREATOR.createFromParcel(parcel)));
		//   35  110:getstatic       #63  <Field android.os.Parcelable$Creator zzbq.CREATOR>
		//   36  113:aload_2         
		//   37  114:invokeinterface #53  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
		//   38  119:checkcast       #62  <Class zzbq>
		//   39  122:astore_2        
				else
		//*  40  123:goto            128
					parcel = null;
		...
		//   43  128:aload_0         
		//   44  129:aload_2         
		//   45  130:invokevirtual   #66  <Method void zza(zzbq)>
				parcel1.writeNoException();
		//   46  133:aload_3         
		...
		//   49  138:ireturn         
			...
			case 3: // '\003'
				parcel.enforceInterface("com.google.android.gms.fitness.internal.IGoogleFitRecordingApi");
		//   50  139:aload_2         
		//   51  140:ldc1            #13  <String "com.google.android.gms.fitness.internal.IGoogleFitRecordingApi">
		//   52  142:invokevirtual   #37  <Method void Parcel.enforceInterface(String)>
				if(parcel.readInt() != 0)
		//*  53  145:aload_2         
		//*  54  146:invokevirtual   #41  <Method int Parcel.readInt()>
		//*  55  149:ifeq            168
					parcel = ((Parcel) ((zzam)zzam.CREATOR.createFromParcel(parcel)));
		//   56  152:getstatic       #69  <Field android.os.Parcelable$Creator zzam.CREATOR>
		//   57  155:aload_2         
		//   58  156:invokeinterface #53  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
		//   59  161:checkcast       #68  <Class zzam>
		//   60  164:astore_2        
				else
		//*  61  165:goto            170
					parcel = null;
		...
		//   64  170:aload_0         
		//   65  171:aload_2         
		//   66  172:invokevirtual   #72  <Method void zza(zzam)>
				parcel1.writeNoException();
		//   67  175:aload_3         
	...
	public abstract void zza(zzam zzam)
		throws RemoteException;

	public abstract void zza(zzbm zzbm)
		throws RemoteException;

	public abstract void zza(zzbq zzbq)
		throws RemoteException;
}
