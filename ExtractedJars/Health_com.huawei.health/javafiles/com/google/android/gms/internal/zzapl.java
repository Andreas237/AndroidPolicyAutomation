	...
	implements GoalsApi
{
	...
	public PendingResult readCurrentGoals(GoogleApiClient googleapiclient, GoalsReadRequest goalsreadrequest)
	{
		return ((PendingResult) (googleapiclient.zza(((zzaad.zza) (new zzaof.zza(googleapiclient, goalsreadrequest) {
			...
			protected void zza(zzaof zzaof1)
				throws RemoteException
			{
				zzaor.zza zza1 = new zzaor.zza(this) {
...
;
			...
			//    4    8:astore_2        
				((zzaou)zzaof1.zzxD()).zza(new GoalsReadRequest(zzaUJ, ((zzaor) (zza1))));
			//    5    9:aload_1         
	...
	//    0    0:aload_1         
	//    1    1:new             #8   <Class zzapl$1>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:aload_2         
	//    6    8:invokespecial   #20  <Method void zzapl$1(zzapl, GoogleApiClient, GoalsReadRequest)>
	//    7   11:invokevirtual   #26  <Method zzaad$zza GoogleApiClient.zza(zzaad$zza)>
	//    8   14:areturn         
	}
}
