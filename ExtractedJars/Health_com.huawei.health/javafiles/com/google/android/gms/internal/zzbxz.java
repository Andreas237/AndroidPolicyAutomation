...
public interface zzbxz
{
	...
	public static final class zzb extends zzbxn
	{
		...
		public static zzb zzak(byte abyte0[])
			throws zzbxs
		{
			return (zzb)zzbxt.zza(((zzbxt) (new zzb())), abyte0);
...
_L15:
		...
		//   92  330:arraylength     
		//   93  331:istore_2        
			zza azza[] = new zza[k + l];
		//   94  332:iload_2         
		//   95  333:iload_3         
		//   96  334:iadd            
		//   97  335:anewarray       zza[]
		//   98  338:astore          4
			l = k;
		//   99  340:iload_2         
		//  100  341:istore_3        
		...
		//* 102  343:ifeq            360
			{
				System.arraycopy(((Object) (zzcwb)), 0, ((Object) (azza)), 0, k);
		//  103  346:aload_0         
