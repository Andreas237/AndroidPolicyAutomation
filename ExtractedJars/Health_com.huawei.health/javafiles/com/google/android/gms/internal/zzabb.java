	...
	extends IInterface
{
		...
		implements zzabb
	{
		...
		//    7   14:astore_1        
			if(iinterface != null && (iinterface instanceof zzabb))
		//*   8   15:aload_1         
		//*   9   16:ifnull          31
		//*  10   19:aload_1         
		//*  11   20:instanceof      #6   <Class zzabb>
		//*  12   23:ifeq            31
				return (zzabb)iinterface;
		//   13   26:aload_1         
		//   14   27:checkcast       #6   <Class zzabb>
		//   15   30:areturn         
			else
				return ((zzabb) (new zza(ibinder)));
		//   16   31:new             #9   <Class zzabb$zza$zza>
		//   17   34:dup             
		//   18   35:aload_0         
		//   19   36:invokespecial   #31  <Method void zzabb$zza$zza(IBinder)>
		//   20   39:areturn         
		}
		...
		//    3   31:aload_3         
		//    4   32:ldc1            #15  <String "com.google.android.gms.common.api.internal.IStatusCallback">
		...
		//    8   39:aload_2         
		//    9   40:ldc1            #15  <String "com.google.android.gms.common.api.internal.IStatusCallback">
		...
		//    1    1:invokespecial   #13  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.google.android.gms.common.api.internal.IStatusCallback");
		//    2    4:aload_0         
		//    3    5:aload_0         
