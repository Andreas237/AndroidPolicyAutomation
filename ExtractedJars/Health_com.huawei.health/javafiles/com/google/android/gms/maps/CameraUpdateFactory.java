...
public final class CameraUpdateFactory
{
	...
	public static CameraUpdate newCameraPosition(CameraPosition cameraposition)
	{
		try
		{
			cameraposition = ((CameraPosition) (new CameraUpdate(zzJn().newCameraPosition(cameraposition))));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:aload_0         
	...
	public static CameraUpdate newLatLng(LatLng latlng)
	{
		try
		{
			latlng = ((LatLng) (new CameraUpdate(zzJn().newLatLng(latlng))));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:aload_0         
	...
	public static CameraUpdate newLatLngBounds(LatLngBounds latlngbounds, int i)
	{
		try
		{
			latlngbounds = ((LatLngBounds) (new CameraUpdate(zzJn().newLatLngBounds(latlngbounds, i))));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:aload_0         
	...
	public static CameraUpdate newLatLngBounds(LatLngBounds latlngbounds, int i, int j, int k)
	{
		try
		{
			latlngbounds = ((LatLngBounds) (new CameraUpdate(zzJn().newLatLngBoundsWithSize(latlngbounds, i, j, k))));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:aload_0         
	...
	public static CameraUpdate newLatLngZoom(LatLng latlng, float f)
	{
		try
		{
			latlng = ((LatLng) (new CameraUpdate(zzJn().newLatLngZoom(latlng, f))));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:aload_0         
	...
	public static CameraUpdate scrollBy(float f, float f1)
	{
		...
		try
		{
			cameraupdate = new CameraUpdate(zzJn().scrollBy(f, f1));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:fload_0         
	...
	public static CameraUpdate zoomBy(float f)
	{
		...
		try
		{
			cameraupdate = new CameraUpdate(zzJn().zoomBy(f));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:fload_0         
	...
	public static CameraUpdate zoomBy(float f, Point point)
	{
		try
		{
			point = ((Point) (new CameraUpdate(zzJn().zoomByWithFocus(f, point.x, point.y))));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:fload_0         
	...
	public static CameraUpdate zoomIn()
	{
		...
		try
		{
			cameraupdate = new CameraUpdate(zzJn().zoomIn());
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	...
	public static CameraUpdate zoomOut()
	{
		...
		try
		{
			cameraupdate = new CameraUpdate(zzJn().zoomOut());
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	...
	public static CameraUpdate zoomTo(float f)
	{
		...
		try
		{
			cameraupdate = new CameraUpdate(zzJn().zoomTo(f));
	//    0    0:new             #17  <Class CameraUpdate>
	//    1    3:dup             
	//    2    4:invokestatic    #21  <Method ICameraUpdateFactoryDelegate zzJn()>
	//    3    7:fload_0         
	...
	{
		return (ICameraUpdateFactoryDelegate)zzac.zzb(((Object) (zzbnv)), "CameraUpdateFactory is not initialized");
	//    0    0:getstatic       #91  <Field ICameraUpdateFactoryDelegate zzbnv>
	//    1    3:ldc1            #93  <String "CameraUpdateFactory is not initialized">
	//    2    5:invokestatic    #99  <Method Object zzac.zzb(Object, Object)>
	...
	{
		zzbnv = (ICameraUpdateFactoryDelegate)zzac.zzw(((Object) (icameraupdatefactorydelegate)));
	//    0    0:aload_0         
	//    1    1:invokestatic    #105 <Method Object zzac.zzw(Object)>
	//    2    4:checkcast       #23  <Class ICameraUpdateFactoryDelegate>
	//    3    7:putstatic       #91  <Field ICameraUpdateFactoryDelegate zzbnv>
	//    4   10:return          
	}
