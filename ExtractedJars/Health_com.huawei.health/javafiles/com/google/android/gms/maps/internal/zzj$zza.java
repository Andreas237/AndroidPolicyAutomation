...
public static abstract class zzj$zza extends Binder
	implements zzj
{
	static class zza
		implements zzj
	{
		...
		//    4    8:aload_2         
		//    5    9:ldc1            #32  <String "com.google.android.gms.maps.internal.IOnCircleClickListener">
...
_L1:
		...
		//    9   18:aload_1         
		//   10   19:invokeinterface #40  <Method IBinder zzb.asBinder()>
		//   11   24:astore_1        
		//*  12   25:goto            28
_L4:
...
_L3:
	...
	//    2    4:aconst_null     
	//    3    5:areturn         
		android.os.IInterface iinterface = ibinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnCircleClickListener");
	//    4    6:aload_0         
	//    5    7:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnCircleClickListener">
	...
	//*   9   16:ifnull          31
	//*  10   19:aload_1         
	//*  11   20:instanceof      #6   <Class zzj>
	//*  12   23:ifeq            31
			return (zzj)iinterface;
	//   13   26:aload_1         
	//   14   27:checkcast       #6   <Class zzj>
	//   15   30:areturn         
		else
			return ((zzj) (new zza(ibinder)));
	//   16   31:new             #9   <Class zzj$zza$zza>
	//   17   34:dup             
	//   18   35:aload_0         
	//   19   36:invokespecial   #31  <Method void zzj$zza$zza(IBinder)>
	//   20   39:areturn         
	}
	...
	//*   2   28:goto            62
		case 1598968902: 
			parcel1.writeString("com.google.android.gms.maps.internal.IOnCircleClickListener");
	//    3   31:aload_3         
	//    4   32:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnCircleClickListener">
	...
	//    8   39:aload_2         
	//    9   40:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnCircleClickListener">
	...
	//   14   50:invokestatic    #55  <Method zzb com.google.android.gms.maps.model.internal.zzb$zza.zzej(IBinder)>
	//   15   53:invokevirtual   #58  <Method void zza(zzb)>
	...
	//    1    1:invokespecial   #13  <Method void Binder()>
		attachInterface(((android.os.IInterface) (this)), "com.google.android.gms.maps.internal.IOnCircleClickListener");
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnCircleClickListener">
