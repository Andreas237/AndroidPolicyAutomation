...
public class MapFragment extends Fragment
{
		...
		implements MapLifecycleDelegate
	{
		...
		//    2    4:new             #11  <Class MapFragment$zza$1>
		//    3    7:dup             
		//    4    8:aload_0         
		//    5    9:aload_1         
		//    6   10:invokespecial   #42  <Method void MapFragment$zza$1(MapFragment$zza, OnMapReadyCallback)>
	...
	static class zzb extends com.google.android.gms.dynamic.zza
	{
		...
		//    5   11:checkcast       #50  <Class MapFragment$zza>
		//    6   14:aload_1         
		//    7   15:invokevirtual   #52  <Method void MapFragment$zza.getMapAsync(OnMapReadyCallback)>
				return;
		//    8   18:return          
			} else
			{
		...
		//    5   11:checkcast       #50  <Class MapFragment$zza>
		//    6   14:aload_1         
		//    7   15:invokevirtual   #62  <Method void MapFragment$zza.onEnterAmbient(Bundle)>
		//    8   18:return          
		}
		...
		//    4    8:invokevirtual   #48  <Method com.google.android.gms.dynamic.LifecycleDelegate zzBN()>
		//    5   11:checkcast       #50  <Class MapFragment$zza>
		//    6   14:invokevirtual   #65  <Method void MapFragment$zza.onExitAmbient()>
		//    7   17:return          
		}
		...
		//*  26   58:new             #50  <Class MapFragment$zza>
		//*  27   61:dup             
		//*  28   62:aload_0         
		//*  29   63:getfield        #30  <Field Fragment zzaRK>
		//*  30   66:aload_1         
		//*  31   67:invokespecial   #98  <Method void MapFragment$zza(Fragment, IMapFragmentDelegate)>
		...
		//*  46  108:checkcast       #50  <Class MapFragment$zza>
		//*  47  111:aload_2         
		//*  48  112:invokevirtual   #52  <Method void MapFragment$zza.getMapAsync(OnMapReadyCallback)>
		//*  49  115:goto            85
		//*  50  118:aload_0         
		...
		//   62  140:return          
			...
			if(obj == null)
				return;
			zzbor.zza(((com.google.android.gms.dynamic.LifecycleDelegate) (new zza(zzaRK, ((IMapFragmentDelegate) (obj))))));
		...
		//    7   15:aload_0         
		//    8   16:aload_1         
		//    9   17:putfield        #30  <Field Fragment zzaRK>
		//   10   20:return          
		}
	}
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #21  <Method void Fragment()>
	//    2    4:aload_0         
	//    3    5:new             #11  <Class MapFragment$zzb>
	//    4    8:dup             
	//    5    9:aload_0         
	//    6   10:invokespecial   #24  <Method void MapFragment$zzb(Fragment)>
	//    7   13:putfield        #26  <Field MapFragment$zzb zzboo>
	//    8   16:return          
	}
	...
	//    1    3:dup             
	//    2    4:invokespecial   #30  <Method void MapFragment()>
	//    3    7:areturn         
	}
	...
	//    4    8:new             #33  <Class Bundle>
	//    5   11:dup             
	//    6   12:invokespecial   #34  <Method void Bundle()>
	//    7   15:astore_2        
		bundle.putParcelable("MapOptions", ((android.os.Parcelable) (googlemapoptions)));
	//    8   16:aload_2         
	//    9   17:ldc1            #36  <String "MapOptions">
	//   10   19:aload_0         
	//   11   20:invokevirtual   #40  <Method void Bundle.putParcelable(String, android.os.Parcelable)>
		mapfragment.setArguments(bundle);
	//   12   23:aload_1         
	//   13   24:aload_2         
	//   14   25:invokevirtual   #44  <Method void setArguments(Bundle)>
		return mapfragment;
	//   15   28:aload_1         
	//   16   29:areturn         
	}
	...
	//    0    0:ldc1            #48  <String "getMapAsync must be called on the main thread.">
	//    1    2:invokestatic    #54  <Method void zzac.zzdj(String)>
		zzboo.getMapAsync(onmapreadycallback);
	//    2    5:aload_0         
	//    3    6:getfield        #26  <Field MapFragment$zzb zzboo>
	//    4    9:aload_1         
	//    5   10:invokevirtual   #56  <Method void MapFragment$zzb.getMapAsync(OnMapReadyCallback)>
	//    6   13:return          
	}
	...
	//    4    7:invokevirtual   #63  <Method ClassLoader Class.getClassLoader()>
	//    5   10:invokevirtual   #67  <Method void Bundle.setClassLoader(ClassLoader)>
		super.onActivityCreated(bundle);
	//    6   13:aload_0         
	//    7   14:aload_1         
	//    8   15:invokespecial   #69  <Method void Fragment.onActivityCreated(Bundle)>
	//    9   18:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #73  <Method void Fragment.onAttach(Activity)>
		zzb.zza(zzboo, activity);
	//    3    5:aload_0         
	//    4    6:getfield        #26  <Field MapFragment$zzb zzboo>
	//    5    9:aload_1         
	//    6   10:invokestatic    #76  <Method void MapFragment$zzb.zza(MapFragment$zzb, Activity)>
	//    7   13:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #79  <Method void Fragment.onCreate(Bundle)>
		zzboo.onCreate(bundle);
	//    3    5:aload_0         
	//    4    6:getfield        #26  <Field MapFragment$zzb zzboo>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #80  <Method void MapFragment$zzb.onCreate(Bundle)>
	//    7   13:return          
	}

	public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
	{
		layoutinflater = ((LayoutInflater) (zzboo.onCreateView(layoutinflater, viewgroup, bundle)));
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field MapFragment$zzb zzboo>
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:aload_3         
	//    5    7:invokevirtual   #84  <Method View MapFragment$zzb.onCreateView(LayoutInflater, ViewGroup, Bundle)>
	//    6   10:astore_1        
		((View) (layoutinflater)).setClickable(true);
	//    7   11:aload_1         
	//    8   12:iconst_1        
	//    9   13:invokevirtual   #90  <Method void View.setClickable(boolean)>
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field MapFragment$zzb zzboo>
	//    2    4:invokevirtual   #93  <Method void MapFragment$zzb.onDestroy()>
		super.onDestroy();
	//    3    7:aload_0         
	//    4    8:invokespecial   #94  <Method void Fragment.onDestroy()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field MapFragment$zzb zzboo>
	//    2    4:invokevirtual   #97  <Method void MapFragment$zzb.onDestroyView()>
		super.onDestroyView();
	//    3    7:aload_0         
	//    4    8:invokespecial   #98  <Method void Fragment.onDestroyView()>
	//    5   11:return          
	}
	...
	//    0    0:ldc1            #101 <String "onEnterAmbient must be called on the main thread.">
	//    1    2:invokestatic    #54  <Method void zzac.zzdj(String)>
		zzboo.onEnterAmbient(bundle);
	//    2    5:aload_0         
	//    3    6:getfield        #26  <Field MapFragment$zzb zzboo>
	//    4    9:aload_1         
	//    5   10:invokevirtual   #103 <Method void MapFragment$zzb.onEnterAmbient(Bundle)>
	//    6   13:return          
	}
	...
	//    0    0:ldc1            #106 <String "onExitAmbient must be called on the main thread.">
	//    1    2:invokestatic    #54  <Method void zzac.zzdj(String)>
		zzboo.onExitAmbient();
	//    2    5:aload_0         
	//    3    6:getfield        #26  <Field MapFragment$zzb zzboo>
	//    4    9:invokevirtual   #108 <Method void MapFragment$zzb.onExitAmbient()>
	//    5   12:return          
	}
	...
	//    2    2:aload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #114 <Method void Fragment.onInflate(Activity, AttributeSet, Bundle)>
		zzb.zza(zzboo, activity);
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field MapFragment$zzb zzboo>
	//    7   11:aload_1         
	//    8   12:invokestatic    #76  <Method void MapFragment$zzb.zza(MapFragment$zzb, Activity)>
		attributeset = ((AttributeSet) (GoogleMapOptions.createFromAttributes(((android.content.Context) (activity)), attributeset)));
	//    9   15:aload_1         
	//   10   16:aload_2         
	//   11   17:invokestatic    #120 <Method GoogleMapOptions GoogleMapOptions.createFromAttributes(android.content.Context, AttributeSet)>
	//   12   20:astore_2        
		Bundle bundle1 = new Bundle();
	//   13   21:new             #33  <Class Bundle>
	//   14   24:dup             
	//   15   25:invokespecial   #34  <Method void Bundle()>
	//   16   28:astore          4
		bundle1.putParcelable("MapOptions", ((android.os.Parcelable) (attributeset)));
	//   17   30:aload           4
	//   18   32:ldc1            #36  <String "MapOptions">
	//   19   34:aload_2         
	//   20   35:invokevirtual   #40  <Method void Bundle.putParcelable(String, android.os.Parcelable)>
		zzboo.onInflate(activity, bundle1, bundle);
	//   21   38:aload_0         
	//   22   39:getfield        #26  <Field MapFragment$zzb zzboo>
	//   23   42:aload_1         
	//   24   43:aload           4
	//   25   45:aload_3         
	//   26   46:invokevirtual   #123 <Method void MapFragment$zzb.onInflate(Activity, Bundle, Bundle)>
	//   27   49:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field MapFragment$zzb zzboo>
	//    2    4:invokevirtual   #127 <Method void MapFragment$zzb.onLowMemory()>
		super.onLowMemory();
	//    3    7:aload_0         
	//    4    8:invokespecial   #128 <Method void Fragment.onLowMemory()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field MapFragment$zzb zzboo>
	//    2    4:invokevirtual   #131 <Method void MapFragment$zzb.onPause()>
		super.onPause();
	//    3    7:aload_0         
	//    4    8:invokespecial   #132 <Method void Fragment.onPause()>
	//    5   11:return          
	}
	...
	public void onResume()
	{
		super.onResume();
	//    0    0:aload_0         
	//    1    1:invokespecial   #135 <Method void Fragment.onResume()>
		zzboo.onResume();
	//    2    4:aload_0         
	//    3    5:getfield        #26  <Field MapFragment$zzb zzboo>
	//    4    8:invokevirtual   #136 <Method void MapFragment$zzb.onResume()>
	//    5   11:return          
	}
	...
	//    6   13:aload_0         
	//    7   14:aload_1         
	//    8   15:invokespecial   #139 <Method void Fragment.onSaveInstanceState(Bundle)>
		zzboo.onSaveInstanceState(bundle);
	//    9   18:aload_0         
	//   10   19:getfield        #26  <Field MapFragment$zzb zzboo>
	//   11   22:aload_1         
	//   12   23:invokevirtual   #140 <Method void MapFragment$zzb.onSaveInstanceState(Bundle)>
	//   13   26:return          
	}
	...
	public void onStart()
	{
		super.onStart();
	//    0    0:aload_0         
	//    1    1:invokespecial   #143 <Method void Fragment.onStart()>
		zzboo.onStart();
	//    2    4:aload_0         
	//    3    5:getfield        #26  <Field MapFragment$zzb zzboo>
	//    4    8:invokevirtual   #144 <Method void MapFragment$zzb.onStart()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field MapFragment$zzb zzboo>
	//    2    4:invokevirtual   #147 <Method void MapFragment$zzb.onStop()>
		super.onStop();
	//    3    7:aload_0         
	//    4    8:invokespecial   #148 <Method void Fragment.onStop()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #149 <Method void Fragment.setArguments(Bundle)>
	//    3    5:return          
	}

	private final zzb zzboo = new zzb(((Fragment) (this)));
}
