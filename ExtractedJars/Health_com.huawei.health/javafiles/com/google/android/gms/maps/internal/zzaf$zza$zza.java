...
//			zzaf, IStreetViewPanoramaDelegate

static class zzaf$zza$zza
	implements zzaf
{
	...
	//    4    8:aload_2         
	//    5    9:ldc1            #32  <String "com.google.android.gms.maps.internal.IOnStreetViewPanoramaReadyCallback">
	//    6   11:invokevirtual   #36  <Method void Parcel.writeInterfaceToken(String)>
		if(istreetviewpanoramadelegate == null) goto _L2; else goto _L1
	//    7   14:aload_1         
	//    8   15:ifnull          71
_L1:
		istreetviewpanoramadelegate = ((IStreetViewPanoramaDelegate) (istreetviewpanoramadelegate.asBinder()));
	//    9   18:aload_1         
	//   10   19:invokeinterface #40  <Method IBinder IStreetViewPanoramaDelegate.asBinder()>
	//   11   24:astore_1        
	//*  12   25:goto            28
_L4:
		parcel.writeStrongBinder(((IBinder) (istreetviewpanoramadelegate)));
	//   13   28:aload_2         
	//   14   29:aload_1         
