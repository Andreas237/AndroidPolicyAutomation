...
static class StreetViewPanoramaFragment$zzb extends zza
{
	...
	static void zza(StreetViewPanoramaFragment$zzb streetviewpanoramafragment$zzb, Activity activity)
	{
		streetviewpanoramafragment$zzb.setActivity(activity);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//*   2    4:ifnull          19
		{
			((StreetViewPanoramaFragment$zza)zzBN()).getStreetViewPanoramaAsync(onstreetviewpanoramareadycallback);
	//    3    7:aload_0         
	...
	//   20   48:astore_1        
			zzbor.zza(((com.google.android.gms.dynamic.LifecycleDelegate) (new StreetViewPanoramaFragment$zza(zzaRK, istreetviewpanoramafragmentdelegate))));
	//   21   49:aload_0         
	...
	//   27   61:aload_1         
	//   28   62:invokespecial   #91  <Method void StreetViewPanoramaFragment$zza(Fragment, com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate)>
	//   29   65:invokeinterface #96  <Method void zze.zza(com.google.android.gms.dynamic.LifecycleDelegate)>
			...
			for(Iterator iterator = zzboI.iterator(); iterator.hasNext(); ((StreetViewPanoramaFragment$zza)zzBN()).getStreetViewPanoramaAsync(onstreetviewpanoramareadycallback))
	//*  30   70:aload_0         
