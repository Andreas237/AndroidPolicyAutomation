...
public class StreetViewPanoramaFragment extends Fragment
{
	...
	static class zzb extends com.google.android.gms.dynamic.zza
	{
		...
		//    5   11:checkcast       #50  <Class StreetViewPanoramaFragment$zza>
		//    6   14:aload_1         
		//    7   15:invokevirtual   #52  <Method void StreetViewPanoramaFragment$zza.getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback)>
				return;
		//    8   18:return          
			} else
			{
		...
		//   20   48:astore_1        
				zzbor.zza(((com.google.android.gms.dynamic.LifecycleDelegate) (new zza(zzaRK, istreetviewpanoramafragmentdelegate))));
		//   21   49:aload_0         
		//   22   50:getfield        #64  <Field zze zzbor>
		//   23   53:new             #50  <Class StreetViewPanoramaFragment$zza>
		//   24   56:dup             
		//   25   57:aload_0         
		//   26   58:getfield        #30  <Field Fragment zzaRK>
		//   27   61:aload_1         
		//   28   62:invokespecial   #91  <Method void StreetViewPanoramaFragment$zza(Fragment, IStreetViewPanoramaFragmentDelegate)>
		...
		//   43  103:checkcast       #50  <Class StreetViewPanoramaFragment$zza>
		//   44  106:aload_2         
		//   45  107:invokevirtual   #52  <Method void StreetViewPanoramaFragment$zza.getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback)>
			}
		//*  46  110:goto            80
		//*  47  113:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:new             #11  <Class StreetViewPanoramaFragment$zzb>
	//    4    8:dup             
	//    5    9:aload_0         
	//    6   10:invokespecial   #24  <Method void StreetViewPanoramaFragment$zzb(Fragment)>
	//    7   13:putfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    8   16:return          
	}
	...
	//    1    3:dup             
	//    2    4:invokespecial   #30  <Method void StreetViewPanoramaFragment()>
	//    3    7:areturn         
	}
	...
	//    8   16:aload_2         
	//    9   17:ldc1            #36  <String "StreetViewPanoramaOptions">
	//   10   19:aload_0         
	...
	//    0    0:ldc1            #48  <String "getStreetViewPanoramaAsync() must be called on the main thread">
	//    1    2:invokestatic    #54  <Method void zzac.zzdj(String)>
		zzboF.getStreetViewPanoramaAsync(onstreetviewpanoramareadycallback);
	//    2    5:aload_0         
	//    3    6:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    4    9:aload_1         
	//    5   10:invokevirtual   #56  <Method void StreetViewPanoramaFragment$zzb.getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback)>
	//    6   13:return          
	}
	...
	//    2    2:invokespecial   #73  <Method void Fragment.onAttach(Activity)>
		zzb.zza(zzboF, activity);
	//    3    5:aload_0         
	//    4    6:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    5    9:aload_1         
	//    6   10:invokestatic    #76  <Method void StreetViewPanoramaFragment$zzb.zza(StreetViewPanoramaFragment$zzb, Activity)>
	//    7   13:return          
	}
	...
	//    2    2:invokespecial   #79  <Method void Fragment.onCreate(Bundle)>
		zzboF.onCreate(bundle);
	//    3    5:aload_0         
	//    4    6:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #80  <Method void StreetViewPanoramaFragment$zzb.onCreate(Bundle)>
	//    7   13:return          
	}

	public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
	{
		return zzboF.onCreateView(layoutinflater, viewgroup, bundle);
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:aload_3         
	//    5    7:invokevirtual   #84  <Method View StreetViewPanoramaFragment$zzb.onCreateView(LayoutInflater, ViewGroup, Bundle)>
	//    6   10:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    2    4:invokevirtual   #87  <Method void StreetViewPanoramaFragment$zzb.onDestroy()>
		super.onDestroy();
	//    3    7:aload_0         
	//    4    8:invokespecial   #88  <Method void Fragment.onDestroy()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    2    4:invokevirtual   #91  <Method void StreetViewPanoramaFragment$zzb.onDestroyView()>
		super.onDestroyView();
	//    3    7:aload_0         
	//    4    8:invokespecial   #92  <Method void Fragment.onDestroyView()>
	//    5   11:return          
	}
	...
	//    2    2:aload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #98  <Method void Fragment.onInflate(Activity, AttributeSet, Bundle)>
		zzb.zza(zzboF, activity);
	//    5    7:aload_0         
	//    6    8:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    7   11:aload_1         
	//    8   12:invokestatic    #76  <Method void StreetViewPanoramaFragment$zzb.zza(StreetViewPanoramaFragment$zzb, Activity)>
		attributeset = ((AttributeSet) (new Bundle()));
	//    9   15:new             #33  <Class Bundle>
	//   10   18:dup             
	//   11   19:invokespecial   #34  <Method void Bundle()>
	//   12   22:astore_2        
		zzboF.onInflate(activity, ((Bundle) (attributeset)), bundle);
	//   13   23:aload_0         
	//   14   24:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//   15   27:aload_1         
	//   16   28:aload_2         
	//   17   29:aload_3         
	//   18   30:invokevirtual   #101 <Method void StreetViewPanoramaFragment$zzb.onInflate(Activity, Bundle, Bundle)>
	//   19   33:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    2    4:invokevirtual   #105 <Method void StreetViewPanoramaFragment$zzb.onLowMemory()>
		super.onLowMemory();
	//    3    7:aload_0         
	//    4    8:invokespecial   #106 <Method void Fragment.onLowMemory()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    2    4:invokevirtual   #109 <Method void StreetViewPanoramaFragment$zzb.onPause()>
		super.onPause();
	//    3    7:aload_0         
	//    4    8:invokespecial   #110 <Method void Fragment.onPause()>
	//    5   11:return          
	}
	...
	public void onResume()
	{
		super.onResume();
	//    0    0:aload_0         
	//    1    1:invokespecial   #113 <Method void Fragment.onResume()>
		zzboF.onResume();
	//    2    4:aload_0         
	//    3    5:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//    4    8:invokevirtual   #114 <Method void StreetViewPanoramaFragment$zzb.onResume()>
	//    5   11:return          
	}
	...
	//    6   13:aload_0         
	//    7   14:aload_1         
	//    8   15:invokespecial   #117 <Method void Fragment.onSaveInstanceState(Bundle)>
		zzboF.onSaveInstanceState(bundle);
	//    9   18:aload_0         
	//   10   19:getfield        #26  <Field StreetViewPanoramaFragment$zzb zzboF>
	//   11   22:aload_1         
	//   12   23:invokevirtual   #118 <Method void StreetViewPanoramaFragment$zzb.onSaveInstanceState(Bundle)>
	//   13   26:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #119 <Method void Fragment.setArguments(Bundle)>
	//    3    5:return          
	}

	private final zzb zzboF = new zzb(((Fragment) (this)));
}
