...
public final class Projection
{
	...
	//    1    1:invokespecial   #11  <Method void Object()>
		zzboz = iprojectiondelegate;
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #13  <Field IProjectionDelegate zzboz>
	//    5    9:return          
	}
	...
	public LatLng fromScreenLocation(Point point)
	{
		try
		{
			point = ((Point) (zzboz.fromScreenLocation(zzd.zzA(((Object) (point))))));
	//    0    0:aload_0         
	//    1    1:getfield        #13  <Field IProjectionDelegate zzboz>
	//    2    4:aload_1         
	//    3    5:invokestatic    #24  <Method com.google.android.gms.dynamic.IObjectWrapper zzd.zzA(Object)>
	...
	public VisibleRegion getVisibleRegion()
	{
		...
		try
		{
			visibleregion = zzboz.getVisibleRegion();
	//    0    0:aload_0         
	//    1    1:getfield        #13  <Field IProjectionDelegate zzboz>
	...
	public Point toScreenLocation(LatLng latlng)
	{
		try
		{
			latlng = ((LatLng) ((Point)zzd.zzF(zzboz.toScreenLocation(latlng))));
	//    0    0:aload_0         
	//    1    1:getfield        #13  <Field IProjectionDelegate zzboz>
	//    2    4:aload_1         
	//    3    5:invokeinterface #43  <Method com.google.android.gms.dynamic.IObjectWrapper IProjectionDelegate.toScreenLocation(LatLng)>
	//    4   10:invokestatic    #47  <Method Object zzd.zzF(com.google.android.gms.dynamic.IObjectWrapper)>
