...
static class MapFragment$zzb extends zza
{
	...
	//*   2    4:ifnull          19
		{
			((MapFragment$zza)zzBN()).getMapAsync(onmapreadycallback);
	//    3    7:aload_0         
	...
	//*   1    1:invokevirtual   #48  <Method com.google.android.gms.dynamic.LifecycleDelegate zzBN()>
	//*   2    4:ifnull          18
			((MapFragment$zza)zzBN()).onEnterAmbient(bundle);
	//    3    7:aload_0         
	//    4    8:invokevirtual   #48  <Method com.google.android.gms.dynamic.LifecycleDelegate zzBN()>
	//    5   11:checkcast       #50  <Class MapFragment$zza>
	//    6   14:aload_1         
	...
	//*   1    1:invokevirtual   #48  <Method com.google.android.gms.dynamic.LifecycleDelegate zzBN()>
	//*   2    4:ifnull          17
			((MapFragment$zza)zzBN()).onExitAmbient();
	//    3    7:aload_0         
	//    4    8:invokevirtual   #48  <Method com.google.android.gms.dynamic.LifecycleDelegate zzBN()>
	//    5   11:checkcast       #50  <Class MapFragment$zza>
	...
	//*  30   66:aload_1         
	//*  31   67:invokespecial   #98  <Method void MapFragment$zza(Fragment, com.google.android.gms.maps.internal.IMapFragmentDelegate)>
	...
	//   62  140:return          
		...
		if(obj == null)
			return;
		zzbor.zza(((com.google.android.gms.dynamic.LifecycleDelegate) (new MapFragment$zza(zzaRK, ((com.google.android.gms.maps.internal.IMapFragmentDelegate) (obj))))));
		for(obj = ((Object) (zzbos.iterator())); ((Iterator) (obj)).hasNext(); ((MapFragment$zza)zzBN()).getMapAsync(onmapreadycallback))
