...
public static abstract class zzq$zza extends Binder
	implements zzq
{
	static class zza
		implements zzq
	{
		...
		//    4    8:aload_2         
		//    5    9:ldc1            #33  <String "com.google.android.gms.maps.internal.IOnMapClickListener">
	...
	//    4    6:aload_0         
	//    5    7:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnMapClickListener">
	...
	//*   9   16:ifnull          31
	//*  10   19:aload_1         
	//*  11   20:instanceof      #6   <Class zzq>
	//*  12   23:ifeq            31
			return (zzq)iinterface;
	//   13   26:aload_1         
	//   14   27:checkcast       #6   <Class zzq>
	//   15   30:areturn         
		else
			return ((zzq) (new zza(ibinder)));
	//   16   31:new             #9   <Class zzq$zza$zza>
	//   17   34:dup             
	//   18   35:aload_0         
	//   19   36:invokespecial   #31  <Method void zzq$zza$zza(IBinder)>
	//   20   39:areturn         
	}
	...
	//    3   31:aload_3         
	//    4   32:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnMapClickListener">
	...
	//    8   39:aload_2         
	//    9   40:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnMapClickListener">
	...
	//   20   68:aconst_null     
	//   21   69:astore_2        
			onMapClick(((LatLng) (parcel)));
	//   22   70:aload_0         
	//   23   71:aload_2         
	//   24   72:invokevirtual   #66  <Method void onMapClick(LatLng)>
	...
	//    1    1:invokespecial   #13  <Method void Binder()>
		attachInterface(((android.os.IInterface) (this)), "com.google.android.gms.maps.internal.IOnMapClickListener");
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:ldc1            #15  <String "com.google.android.gms.maps.internal.IOnMapClickListener">
