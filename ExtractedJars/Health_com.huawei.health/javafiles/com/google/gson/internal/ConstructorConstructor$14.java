	...
	implements ObjectConstructor
{
	...
	//*   8   14:astore_1        
		{
			throw new RuntimeException((new StringBuilder()).append("Unable to invoke no-args constructor for ").append(((Object) (val$type))).append(". Registering an InstanceCreator with Gson for this type may fix this problem.").toString(), ((Throwable) (exception)));
