...
class TypeAdapters$35$1 extends TypeAdapter
{
	...
	//    5   11:astore_1        
		if(jsonreader != null && !val$requestedType.isInstance(((Object) (jsonreader))))
	//*   6   12:aload_1         
	//*   7   13:ifnull          75
	//*   8   16:aload_0         
	...
	//*  12   24:ifne            75
			throw new JsonSyntaxException((new StringBuilder()).append("Expected a ").append(val$requestedType.getName()).append(" but was ").append(((Object) (jsonreader)).getClass().getName()).toString());
	...
	public void write(JsonWriter jsonwriter, Object obj)
		throws IOException
	{
		val$typeAdapter.write(jsonwriter, obj);
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field TypeAdapters$35 this$0>
	//    2    4:getfield        #32  <Field TypeAdapter TypeAdapters$35.val$typeAdapter>
	//    3    7:aload_1         
...
/* anonymous class */
		...
		implements TypeAdapterFactory
	{
		...
		//    9   17:areturn         
				...
				return ((TypeAdapter) (((TypeAdapters._cls35._cls1) (gson)). new TypeAdapters._cls35._cls1()));
