	...
	extends IInterface
{
		...
		implements IDesktopLyricService
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.android.mediacenter.ui.desktoplyric.IDesktopLyricService");
		//    4    6:aload_0         
		...
		//    1    1:invokespecial   #23  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.android.mediacenter.ui.desktoplyric.IDesktopLyricService");
		//    2    4:aload_0         
		//    3    5:aload_0         
	...
	public abstract void startDesktopLyric(boolean flag)
		throws RemoteException;

	public abstract void stopDesktopLyric()
		throws RemoteException;
}
