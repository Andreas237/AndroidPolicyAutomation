...
public class JsonArrayRequest extends JsonRequest
{
	...
	//    5    9:aload_3         
	//    6   10:invokevirtual   #21  <Method String JSONArray.toString()>
	//    7   13:astore_3        
		super(i, s, ((String) (jsonarray)), listener, errorlistener);
	//    8   14:aload_0         
	//    9   15:iload_1         
	//   10   16:aload_2         
	//   11   17:aload_3         
	...
	//    5    9:aload_3         
	//    6   10:invokevirtual   #26  <Method String JSONObject.toString()>
	//    7   13:astore_3        
	...
	//   11   18:aload_3         
	//   12   19:aload           4
	//   13   21:invokespecial   #32  <Method void JsonArrayRequest(int, String, JSONArray, com.android.volley.Response$Listener, com.android.volley.Response$ErrorListener)>
	//   14   24:return          
	}
	...
	//   11   18:aload_3         
	//   12   19:aload           4
	//   13   21:invokespecial   #36  <Method void JsonArrayRequest(int, String, JSONObject, com.android.volley.Response$Listener, com.android.volley.Response$ErrorListener)>
	//   14   24:return          
	}
	...
	public Response parseNetworkResponse(NetworkResponse networkresponse)
	{
		try
		{
			networkresponse = ((NetworkResponse) (Response.success(((Object) (new JSONArray(new String(networkresponse.data, HttpHeaderParser.parseCharset(networkresponse.headers, "utf-8"))))), HttpHeaderParser.parseCacheHeaders(networkresponse))));
	//    0    0:new             #17  <Class JSONArray>
	//    1    3:dup             
	//    2    4:new             #45  <Class String>
	//    3    7:dup             
	//    4    8:aload_1         
	//    5    9:getfield        #51  <Field byte[] NetworkResponse.data>
	//    6   12:aload_1         
	//    7   13:getfield        #55  <Field java.util.Map NetworkResponse.headers>
	//    8   16:ldc1            #57  <String "utf-8">
	//    9   18:invokestatic    #63  <Method String HttpHeaderParser.parseCharset(java.util.Map, String)>
	//   10   21:invokespecial   #66  <Method void String(byte[], String)>
	//   11   24:invokespecial   #69  <Method void JSONArray(String)>
	//   12   27:aload_1         
	//   13   28:invokestatic    #73  <Method com.android.volley.Cache$Entry HttpHeaderParser.parseCacheHeaders(NetworkResponse)>
	//   14   31:invokestatic    #79  <Method Response Response.success(Object, com.android.volley.Cache$Entry)>
	//   15   34:astore_1        
		}
	//*  16   35:aload_1         
	//*  17   36:areturn         
	...
	//   19   38:new             #81  <Class ParseError>
	//   20   41:dup             
	//   21   42:aload_1         
	//   22   43:invokespecial   #84  <Method void ParseError(Throwable)>
	//   23   46:invokestatic    #88  <Method Response Response.error(com.android.volley.VolleyError)>
	//   24   49:areturn         
		}
		// Misplaced declaration of an exception variable
		catch(NetworkResponse networkresponse)
	//*  25   50:astore_1        
		{
			return Response.error(((com.android.volley.VolleyError) (new ParseError(((Throwable) (networkresponse))))));
	//   26   51:new             #81  <Class ParseError>
	//   27   54:dup             
	//   28   55:aload_1         
	//   29   56:invokespecial   #84  <Method void ParseError(Throwable)>
	//   30   59:invokestatic    #88  <Method Response Response.error(com.android.volley.VolleyError)>
	//   31   62:areturn         
		}
