	...
	implements RequestManagerTreeNode
{
	...
	//*  20   48:aload_3         
	//*  21   49:invokevirtual   #53  <Method com.bumptech.glide.RequestManager SupportRequestManagerFragment.getRequestManager()>
	//*  22   52:ifnull          64
				hashset.add(((Object) (supportrequestmanagerfragment.getRequestManager())));
	//   23   55:aload_1         
	//   24   56:aload_3         
	//   25   57:invokevirtual   #53  <Method com.bumptech.glide.RequestManager SupportRequestManagerFragment.getRequestManager()>
