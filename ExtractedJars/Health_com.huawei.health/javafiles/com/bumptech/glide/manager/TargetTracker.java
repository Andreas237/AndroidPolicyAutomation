	...
	implements LifecycleListener
{
	...
	public List getAll()
	{
		return ((List) (new ArrayList(((java.util.Collection) (targets)))));
	//    0    0:new             #34  <Class ArrayList>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #24  <Field Set targets>
	//    4    8:invokespecial   #37  <Method void ArrayList(java.util.Collection)>
	//    5   11:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field Set targets>
	//    2    4:invokestatic    #46  <Method List Util.getSnapshot(java.util.Collection)>
	//    3    7:invokeinterface #52  <Method Iterator List.iterator()>
	//    4   12:astore_1        
	//    5   13:aload_1         
	//    6   14:invokeinterface #58  <Method boolean Iterator.hasNext()>
	//    7   19:ifeq            39
	//    8   22:aload_1         
	//    9   23:invokeinterface #62  <Method Object Iterator.next()>
	//   10   28:checkcast       #64  <Class Target>
	//   11   31:invokeinterface #66  <Method void Target.onDestroy()>
	//*  12   36:goto            13
	//   13   39:return          
	}
	...
	//    9   23:invokeinterface #62  <Method Object Iterator.next()>
	//   10   28:checkcast       #64  <Class Target>
	//   11   31:invokeinterface #69  <Method void Target.onStart()>
	//*  12   36:goto            13
	//   13   39:return          
	}
	...
	//    9   23:invokeinterface #62  <Method Object Iterator.next()>
	//   10   28:checkcast       #64  <Class Target>
	//   11   31:invokeinterface #72  <Method void Target.onStop()>
	//*  12   36:goto            13
	//   13   39:return          
	}
	...
	//    1    1:getfield        #24  <Field Set targets>
	//    2    4:aload_1         
	//    3    5:invokeinterface #78  <Method boolean Set.add(Object)>
	//    4   10:pop             
	//    5   11:return          
	}
	...
	//    1    1:getfield        #24  <Field Set targets>
	//    2    4:aload_1         
	//    3    5:invokeinterface #83  <Method boolean Set.remove(Object)>
	//    4   10:pop             
	//    5   11:return          
	}
