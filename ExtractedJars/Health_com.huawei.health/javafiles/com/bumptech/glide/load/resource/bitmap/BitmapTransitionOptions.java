...
public final class BitmapTransitionOptions extends TransitionOptions
{
	...
	//    1    3:dup             
	//    2    4:invokespecial   #13  <Method void BitmapTransitionOptions()>
	//    3    7:aload_0         
	...
	//    1    3:dup             
	//    2    4:invokespecial   #13  <Method void BitmapTransitionOptions()>
	//    3    7:invokevirtual   #24  <Method BitmapTransitionOptions crossFade()>
	//    4   10:areturn         
	}
	...
	//    2    4:invokespecial   #13  <Method void BitmapTransitionOptions()>
	//    3    7:iload_0         
	//    4    8:invokevirtual   #27  <Method BitmapTransitionOptions crossFade(int)>
	//    5   11:areturn         
	}
	...
	//    2    4:invokespecial   #13  <Method void BitmapTransitionOptions()>
	//    3    7:aload_0         
	//    4    8:invokevirtual   #30  <Method BitmapTransitionOptions crossFade(com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder)>
	//    5   11:areturn         
	}
	...
	//    2    4:invokespecial   #13  <Method void BitmapTransitionOptions()>
	//    3    7:aload_0         
	//    4    8:invokevirtual   #33  <Method BitmapTransitionOptions crossFade(DrawableCrossFadeFactory)>
	//    5   11:areturn         
	}
	...
	//    2    4:invokespecial   #13  <Method void BitmapTransitionOptions()>
	//    3    7:aload_0         
	//    4    8:invokevirtual   #37  <Method BitmapTransitionOptions transitionUsing(TransitionFactory)>
	//    5   11:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #40  <Class com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder>
	//    2    4:dup             
	//    3    5:invokespecial   #41  <Method void com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder()>
	//    4    8:invokevirtual   #30  <Method BitmapTransitionOptions crossFade(com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder)>
	//    5   11:areturn         
	}
	...
	//    2    4:dup             
	//    3    5:iload_1         
	//    4    6:invokespecial   #44  <Method void com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder(int)>
	//    5    9:invokevirtual   #30  <Method BitmapTransitionOptions crossFade(com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder)>
	//    6   12:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #48  <Method DrawableCrossFadeFactory com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder.build()>
	//    3    5:invokevirtual   #37  <Method BitmapTransitionOptions transitionUsing(TransitionFactory)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #37  <Method BitmapTransitionOptions transitionUsing(TransitionFactory)>
	//    3    5:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #50  <Class BitmapTransitionFactory>
	//    2    4:dup             
	//    3    5:aload_1         
	//    4    6:invokespecial   #53  <Method void BitmapTransitionFactory(TransitionFactory)>
	//    5    9:invokevirtual   #17  <Method TransitionOptions transition(TransitionFactory)>
