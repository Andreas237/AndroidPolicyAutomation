	...
	implements ResourceEncoder
{
	...
	//    2    4:new             #28  <Class BitmapResource>
	//    3    7:dup             
	//    4    8:aload_1         
	//    5    9:invokeinterface #34  <Method Object Resource.get()>
	//    6   14:checkcast       #36  <Class BitmapDrawable>
	//    7   17:invokevirtual   #40  <Method android.graphics.Bitmap BitmapDrawable.getBitmap()>
	//    8   20:aload_0         
	//    9   21:getfield        #19  <Field BitmapPool bitmapPool>
	//   10   24:invokespecial   #43  <Method void BitmapResource(android.graphics.Bitmap, BitmapPool)>
	//   11   27:aload_2         
	//   12   28:aload_3         
	//   13   29:invokeinterface #46  <Method boolean ResourceEncoder.encode(Object, File, Options)>
	//   14   34:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #30  <Class Resource>
	//    3    5:aload_2         
	//    4    6:aload_3         
	//    5    7:invokevirtual   #49  <Method boolean encode(Resource, File, Options)>
	//    6   10:ireturn         
	}
	...
	//    1    1:getfield        #21  <Field ResourceEncoder encoder>
	//    2    4:aload_1         
	//    3    5:invokeinterface #53  <Method EncodeStrategy ResourceEncoder.getEncodeStrategy(Options)>
	//    4   10:areturn         
	}
