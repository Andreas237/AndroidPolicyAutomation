...
public class CenterInside extends BitmapTransformation
{
	...
	public CenterInside(Context context)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #31  <Method void CenterInside()>
	//    2    4:return          
	}
	...
	//    0    0:ldc1            #8   <String "com.bumptech.glide.load.resource.bitmap.CenterInside">
	...
	//    2    2:iload_3         
	//    3    3:iload           4
	//    4    5:invokestatic    #47  <Method Bitmap TransformationUtils.centerInside(BitmapPool, Bitmap, int, int)>
	//    5    8:areturn         
	}
