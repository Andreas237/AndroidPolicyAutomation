	...
	implements ResourceEncoder
{
	...
	//    0    0:aload_1         
	//    1    1:invokeinterface #26  <Method Object Resource.get()>
	//    2    6:checkcast       #28  <Class GifDrawable>
	//    3    9:astore_1        
		try
		{
			ByteBufferUtil.toFile(((GifDrawable) (resource)).getBuffer(), file);
	//    4   10:aload_1         
	//    5   11:invokevirtual   #32  <Method java.nio.ByteBuffer GifDrawable.getBuffer()>
	//    6   14:aload_2         
	//    7   15:invokestatic    #38  <Method void ByteBufferUtil.toFile(java.nio.ByteBuffer, File)>
		}
	//*   8   18:iconst_1        
	//*   9   19:ireturn         
	...
	//*  12   23:iconst_5        
	//*  13   24:invokestatic    #44  <Method boolean Log.isLoggable(String, int)>
	//*  14   27:ifeq            39
				Log.w("GifEncoder", "Failed to encode GIF drawable data", ((Throwable) (resource)));
	//   15   30:ldc1            #11  <String "GifEncoder">
	//   16   32:ldc1            #46  <String "Failed to encode GIF drawable data">
	//   17   34:aload_1         
	//   18   35:invokestatic    #50  <Method int Log.w(String, String, Throwable)>
	//   19   38:pop             
			return false;
	//   20   39:iconst_0        
	//   21   40:ireturn         
