	...
	implements ResourceDecoder
{
	...
	//*   0    0:aload_1         
	//*   1    1:instanceof      #30  <Class RecyclableBufferedInputStream>
	//*   2    4:ifeq            18
		{
			inputstream = ((InputStream) ((RecyclableBufferedInputStream)inputstream));
	//    3    7:aload_1         
	//    4    8:checkcast       #30  <Class RecyclableBufferedInputStream>
	//    5   11:astore_1        
			flag = false;
	//    6   12:iconst_0        
	//    7   13:istore          5
	...
	//    9   18:new             #30  <Class RecyclableBufferedInputStream>
	//   10   21:dup             
	//   11   22:aload_1         
	//   12   23:aload_0         
	//   13   24:getfield        #23  <Field ArrayPool byteArrayPool>
	//   14   27:invokespecial   #33  <Method void RecyclableBufferedInputStream(InputStream, ArrayPool)>
	//   15   30:astore_1        
			flag = true;
	//   16   31:iconst_1        
	//   17   32:istore          5
	...
	//   18   34:aload_1         
	//   19   35:invokestatic    #39  <Method ExceptionCatchingInputStream ExceptionCatchingInputStream.obtain(InputStream)>
	//   20   38:astore          6
		markenforcinginputstream = new MarkEnforcingInputStream(((InputStream) (exceptioncatchinginputstream)));
	//   21   40:new             #41  <Class MarkEnforcingInputStream>
	//   22   43:dup             
	//   23   44:aload           6
	//   24   46:invokespecial   #44  <Method void MarkEnforcingInputStream(InputStream)>
	//   25   49:astore          7
	...
	//   28   55:aload_1         
	//   29   56:aload           6
	//   30   58:invokespecial   #47  <Method void StreamBitmapDecoder$UntrustedCallbacks(RecyclableBufferedInputStream, ExceptionCatchingInputStream)>
	//   31   61:astore          8
	...
	//   37   71:aload           4
	//   38   73:aload           8
	//   39   75:invokevirtual   #52  <Method Resource Downsampler.decode(InputStream, int, int, Options, Downsampler$DecodeCallbacks)>
	//   40   78:astore          4
		exceptioncatchinginputstream.release();
	//   41   80:aload           6
	//   42   82:invokevirtual   #55  <Method void ExceptionCatchingInputStream.release()>
		if(flag)
	//*  43   85:iload           5
	//*  44   87:ifeq            94
			((RecyclableBufferedInputStream) (inputstream)).release();
	//   45   90:aload_1         
	//   46   91:invokevirtual   #56  <Method void RecyclableBufferedInputStream.release()>
	...
	//   49   97:astore          4
		exceptioncatchinginputstream.release();
	//   50   99:aload           6
	//   51  101:invokevirtual   #55  <Method void ExceptionCatchingInputStream.release()>
		if(flag)
	//*  52  104:iload           5
	//*  53  106:ifeq            113
			((RecyclableBufferedInputStream) (inputstream)).release();
	//   54  109:aload_1         
	//   55  110:invokevirtual   #56  <Method void RecyclableBufferedInputStream.release()>
		throw options;
	//   56  113:aload           4
	//   57  115:athrow          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #62  <Class InputStream>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #64  <Method Resource decode(InputStream, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #69  <Method boolean Downsampler.handles(InputStream)>
	//    4    8:ireturn         
	}
	...
	//    2    2:checkcast       #62  <Class InputStream>
	//    3    5:aload_2         
	//    4    6:invokevirtual   #72  <Method boolean handles(InputStream, Options)>
	//    5    9:ireturn         
	}
