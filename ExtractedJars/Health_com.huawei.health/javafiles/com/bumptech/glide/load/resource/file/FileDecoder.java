	...
	implements ResourceDecoder
{
	...
	//    0    0:new             #16  <Class FileResource>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokespecial   #19  <Method void FileResource(File)>
	//    4    8:areturn         
	}
	...
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #28  <Method Resource decode(File, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    2    2:checkcast       #26  <Class File>
	//    3    5:aload_2         
	//    4    6:invokevirtual   #34  <Method boolean handles(File, Options)>
	//    5    9:ireturn         
	}
}
