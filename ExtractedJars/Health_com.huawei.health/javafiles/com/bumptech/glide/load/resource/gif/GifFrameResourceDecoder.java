	...
	implements ResourceDecoder
{
	...
	//    0    0:aload_1         
	//    1    1:invokeinterface #25  <Method android.graphics.Bitmap GifDecoder.getNextFrame()>
	//    2    6:aload_0         
	//    3    7:getfield        #16  <Field BitmapPool bitmapPool>
	//    4   10:invokestatic    #31  <Method BitmapResource BitmapResource.obtain(android.graphics.Bitmap, BitmapPool)>
	//    5   13:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #21  <Class GifDecoder>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #38  <Method Resource decode(GifDecoder, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    2    2:checkcast       #21  <Class GifDecoder>
	//    3    5:aload_2         
	//    4    6:invokevirtual   #44  <Method boolean handles(GifDecoder, Options)>
	//    5    9:ireturn         
	}
