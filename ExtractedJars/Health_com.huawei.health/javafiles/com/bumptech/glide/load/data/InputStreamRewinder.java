	...
	implements DataRewinder
{
		...
		implements DataRewinder.Factory
	{
		...
		//    5    9:invokespecial   #25  <Method void InputStreamRewinder(InputStream, ArrayPool)>
		//    6   12:areturn         
		}
		...
		//    3    5:invokevirtual   #32  <Method DataRewinder build(InputStream)>
		//    4    8:areturn         
		}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #26  <Field RecyclableBufferedInputStream bufferedStream>
	//    2    4:invokevirtual   #42  <Method void RecyclableBufferedInputStream.reset()>
