	...
	implements DiskCache.Factory
{
	...
	//    2    4:aload_0         
	//    3    5:iload_2         
	//    4    6:putfield        #24  <Field int diskCacheSize>
	...
	public DiskLruCacheFactory(final String diskCacheFolder, int i)
	{
...
, i);
	...
	//    5    9:iload_2         
	//    6   10:invokespecial   #33  <Method void DiskLruCacheFactory(DiskLruCacheFactory$CacheDirectoryGetter, int)>
	//    7   13:return          
	}

	public DiskLruCacheFactory(final String diskCacheFolder, final String diskCacheName, int i)
	{
		this(new CacheDirectoryGetter() {
...
, i);
	...
	//    6   10:iload_3         
	//    7   11:invokespecial   #33  <Method void DiskLruCacheFactory(DiskLruCacheFactory$CacheDirectoryGetter, int)>
	//    8   14:return          
	}
	...
	//   19   39:aload_1         
	//   20   40:aload_0         
	//   21   41:getfield        #24  <Field int diskCacheSize>
	//   22   44:invokestatic    #61  <Method DiskCache DiskLruCacheWrapper.get(File, int)>
	//   23   47:areturn         
	}
