	...
	implements ModelLoader
{
		...
		implements ModelLoaderFactory
	{
		...
		//    6   12:invokespecial   #29  <Method void HttpUriLoader(ModelLoader)>
		//    7   15:areturn         
		}
	...
	//    2    4:new             #56  <Class GlideUrl>
	//    3    7:dup             
	//    4    8:aload_1         
	//    5    9:invokevirtual   #62  <Method String Uri.toString()>
	//    6   12:invokespecial   #65  <Method void GlideUrl(String)>
	//    7   15:iload_2         
	//    8   16:iload_3         
	//    9   17:aload           4
	//   10   19:invokeinterface #68  <Method com.bumptech.glide.load.model.ModelLoader$LoadData ModelLoader.buildLoadData(Object, int, int, Options)>
	//   11   24:areturn         
	}
	...
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #71  <Method com.bumptech.glide.load.model.ModelLoader$LoadData buildLoadData(Uri, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    1    3:aload_1         
	//    2    4:invokevirtual   #76  <Method String Uri.getScheme()>
	//    3    7:invokeinterface #82  <Method boolean Set.contains(Object)>
	//    4   12:ireturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:checkcast       #58  <Class Uri>
	//    3    5:invokevirtual   #84  <Method boolean handles(Uri)>
	//    4    8:ireturn         
	}
