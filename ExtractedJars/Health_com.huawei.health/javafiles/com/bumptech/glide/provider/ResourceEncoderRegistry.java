...
public class ResourceEncoderRegistry
{
	...
	public void add(Class class1, ResourceEncoder resourceencoder)
	{
		this;
	//    0    0:aload_0         
	...
	//    6   10:aload_1         
	//    7   11:aload_2         
	//    8   12:invokespecial   #24  <Method void ResourceEncoderRegistry$Entry(Class, ResourceEncoder)>
	//    9   15:invokeinterface #29  <Method boolean List.add(Object)>
	//   10   20:pop             
		this;
	//   11   21:aload_0         
	...
	//    2    2:aload_0         
	//    3    3:getfield        #19  <Field List encoders>
	//    4    6:invokeinterface #38  <Method int List.size()>
	//    5   11:istore_3        
		int i = 0;
	//    6   12:iconst_0        
	//    7   13:istore_2        
_L2:
	...
	//   13   23:iload_2         
	//   14   24:invokeinterface #41  <Method Object List.get(int)>
	...
	//   17   34:aload           4
	//   18   36:aload_1         
	//   19   37:invokevirtual   #45  <Method boolean ResourceEncoderRegistry$Entry.handles(Class)>
	//   20   40:ifeq            53
		class1 = ((Class) (entry.encoder));
	//   21   43:aload           4
	//   22   45:getfield        #49  <Field ResourceEncoder ResourceEncoderRegistry$Entry.encoder>
	//   23   48:astore_1        
		this;
	//   24   49:aload_0         
		JVM INSTR monitorexit ;
