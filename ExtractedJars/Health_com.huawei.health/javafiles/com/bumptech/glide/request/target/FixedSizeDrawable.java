...
public class FixedSizeDrawable extends Drawable
{
	static class State extends android.graphics.drawable.Drawable.ConstantState
	{
		...
		//    5    9:invokevirtual   #33  <Method Drawable android.graphics.drawable.Drawable$ConstantState.newDrawable()>
		//    6   12:invokespecial   #36  <Method void FixedSizeDrawable(FixedSizeDrawable$State, Drawable)>
		//    7   15:areturn         
		}
		...
		//    4    6:getfield        #19  <Field android.graphics.drawable.Drawable$ConstantState wrapped>
		//    5    9:aload_1         
		//    6   10:invokevirtual   #39  <Method Drawable android.graphics.drawable.Drawable$ConstantState.newDrawable(Resources)>
		//    7   13:invokespecial   #36  <Method void FixedSizeDrawable(FixedSizeDrawable$State, Drawable)>
		//    8   16:areturn         
		}
	...
	public void draw(Canvas canvas)
	{
		canvas.save();
	//    0    0:aload_1         
	//    1    1:invokevirtual   #91  <Method int Canvas.save()>
	//    2    4:pop             
		canvas.concat(matrix);
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:getfield        #60  <Field Matrix matrix>
	//    6   10:invokevirtual   #95  <Method void Canvas.concat(Matrix)>
		wrapped.draw(canvas);
	//    7   13:aload_0         
	//    8   14:getfield        #44  <Field Drawable wrapped>
	//    9   17:aload_1         
	//   10   18:invokevirtual   #97  <Method void Drawable.draw(Canvas)>
		canvas.restore();
	//   11   21:aload_1         
	//   12   22:invokevirtual   #100 <Method void Canvas.restore()>
	//   13   25:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:invokevirtual   #106 <Method int Drawable.getAlpha()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:invokevirtual   #111 <Method android.graphics.drawable.Drawable$Callback Drawable.getCallback()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:invokevirtual   #114 <Method int Drawable.getChangingConfigurations()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:invokevirtual   #118 <Method Drawable Drawable.getCurrent()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #42  <Field FixedSizeDrawable$State state>
	//    2    4:getfield        #122 <Field int FixedSizeDrawable$State.height>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #42  <Field FixedSizeDrawable$State state>
	//    2    4:getfield        #125 <Field int FixedSizeDrawable$State.width>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:invokevirtual   #128 <Method int Drawable.getMinimumHeight()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:invokevirtual   #131 <Method int Drawable.getMinimumWidth()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:invokevirtual   #134 <Method int Drawable.getOpacity()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #138 <Method boolean Drawable.getPadding(Rect)>
	//    4    8:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #141 <Method void Drawable.invalidateSelf()>
		wrapped.invalidateSelf();
	//    2    4:aload_0         
	//    3    5:getfield        #44  <Field Drawable wrapped>
	//    4    8:invokevirtual   #141 <Method void Drawable.invalidateSelf()>
	//    5   11:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #144 <Field boolean mutated>
	//*   2    4:ifne            46
	//*   3    7:aload_0         
	//*   4    8:invokespecial   #146 <Method Drawable Drawable.mutate()>
	//*   5   11:aload_0         
	//*   6   12:if_acmpne       46
		{
	...
	//   10   20:invokevirtual   #146 <Method Drawable Drawable.mutate()>
	//   11   23:putfield        #44  <Field Drawable wrapped>
	...
	//   17   35:invokespecial   #149 <Method void FixedSizeDrawable$State(FixedSizeDrawable$State)>
	//   18   38:putfield        #42  <Field FixedSizeDrawable$State state>
			mutated = true;
	//   19   41:aload_0         
	//   20   42:iconst_1        
	//   21   43:putfield        #144 <Field boolean mutated>
		}
	...
	//    1    1:aload_1         
	//    2    2:lload_2         
	//    3    3:invokespecial   #153 <Method void Drawable.scheduleSelf(Runnable, long)>
		wrapped.scheduleSelf(runnable, l);
	//    4    6:aload_0         
	//    5    7:getfield        #44  <Field Drawable wrapped>
	//    6   10:aload_1         
	//    7   11:lload_2         
	//    8   12:invokevirtual   #153 <Method void Drawable.scheduleSelf(Runnable, long)>
	//    9   15:return          
	}
	...
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #157 <Method void Drawable.setAlpha(int)>
	//    4    8:return          
	}
	...
	//   14   19:iload           4
	//   15   21:i2f             
	//   16   22:invokevirtual   #160 <Method void RectF.set(float, float, float, float)>
		updateMatrix();
	//   17   25:aload_0         
	//   18   26:invokespecial   #162 <Method void updateMatrix()>
	//   19   29:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #165 <Method void Drawable.setBounds(Rect)>
		bounds.set(rect);
	//    3    5:aload_0         
	//    4    6:getfield        #70  <Field RectF bounds>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #167 <Method void RectF.set(Rect)>
		updateMatrix();
	//    7   13:aload_0         
	//    8   14:invokespecial   #162 <Method void updateMatrix()>
	//    9   17:return          
	}
	...
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #170 <Method void Drawable.setChangingConfigurations(int)>
	//    4    8:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #174 <Method void Drawable.setColorFilter(int, android.graphics.PorterDuff$Mode)>
	//    5    9:return          
	}
	...
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #177 <Method void Drawable.setColorFilter(ColorFilter)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #181 <Method void Drawable.setDither(boolean)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #44  <Field Drawable wrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #184 <Method void Drawable.setFilterBitmap(boolean)>
	//    4    8:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #188 <Method boolean Drawable.setVisible(boolean, boolean)>
	//    5    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #192 <Method void Drawable.unscheduleSelf(Runnable)>
		wrapped.unscheduleSelf(runnable);
	//    3    5:aload_0         
	//    4    6:getfield        #44  <Field Drawable wrapped>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #192 <Method void Drawable.unscheduleSelf(Runnable)>
	//    7   13:return          
	}
