...
public final class GenericTransitionOptions extends TransitionOptions
{
	...
	//    1    3:dup             
	//    2    4:invokespecial   #13  <Method void GenericTransitionOptions()>
	//    3    7:iload_0         
	//    4    8:invokevirtual   #17  <Method TransitionOptions transition(int)>
	...
	//    2    4:invokespecial   #13  <Method void GenericTransitionOptions()>
	//    3    7:aload_0         
	//    4    8:invokevirtual   #23  <Method TransitionOptions transition(TransitionFactory)>
	//    5   11:checkcast       #2   <Class GenericTransitionOptions>
	//    6   14:areturn         
	}
	...
	//    2    4:invokespecial   #13  <Method void GenericTransitionOptions()>
	//    3    7:aload_0         
	//    4    8:invokevirtual   #28  <Method TransitionOptions transition(com.bumptech.glide.request.transition.ViewPropertyTransition$Animator)>
	//    5   11:checkcast       #2   <Class GenericTransitionOptions>
	//    6   14:areturn         
	}
	...
	//    1    3:dup             
	//    2    4:invokespecial   #13  <Method void GenericTransitionOptions()>
	//    3    7:invokevirtual   #35  <Method TransitionOptions dontTransition()>
