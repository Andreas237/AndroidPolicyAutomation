	...
	implements android.support.design.widget.BaseTransientBottomBar.ContentViewCallback
{
	...
	//*  49   93:ifeq            140
	//*  50   96:aload_0         
	//*  51   97:getfield        #52  <Field int mMaxInlineActionWidth>
	//*  52  100:ifle            140
	//*  53  103:aload_0         
	//*  54  104:getfield        #137 <Field Button mActionView>
	//*  55  107:invokevirtual   #203 <Method int Button.getMeasuredWidth()>
	//*  56  110:aload_0         
	//*  57  111:getfield        #52  <Field int mMaxInlineActionWidth>
	//*  58  114:icmple          140
		{
			i = ((int) (flag));
	//   59  117:iload           6
	...
	//*  65  126:iload           5
	//*  66  128:isub            
	//*  67  129:invokespecial   #205 <Method boolean updateViewsWithinLayout(int, int, int)>
	//*  68  132:ifeq            168
				i = 1;
	//   69  135:iconst_1        
	//   70  136:istore_1        
	...
	//*  81  156:iload           4
	//*  82  158:iload           4
	//*  83  160:invokespecial   #205 <Method boolean updateViewsWithinLayout(int, int, int)>
	//*  84  163:ifeq            168
				i = 1;
	//   85  166:iconst_1        
	//   86  167:istore_1        
	...
	//   90  173:iload_3         
	//   91  174:iload_2         
	//   92  175:invokespecial   #167 <Method void LinearLayout.onMeasure(int, int)>
	//   93  178:return          
	}
