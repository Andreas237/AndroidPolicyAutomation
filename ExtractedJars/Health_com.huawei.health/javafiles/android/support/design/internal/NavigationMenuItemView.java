	...
	implements android.support.v7.view.menu.MenuView.ItemView
{
	...
	//    4    4:invokespecial   #47  <Method void ForegroundLinearLayout(Context, AttributeSet, int)>
		mAccessibilityDelegate = ((AccessibilityDelegateCompat) (new AccessibilityDelegateCompat() {
			...
			//    3    3:invokespecial   #20  <Method void AccessibilityDelegateCompat.onInitializeAccessibilityNodeInfo(View, AccessibilityNodeInfoCompat)>
				accessibilitynodeinfocompat.setCheckable(e.mCheckable);
			//    4    6:aload_2         
			//    5    7:aload_0         
			//    6    8:getfield        #12  <Field NavigationMenuItemView e>
			...
			final NavigationMenuItemView e;

			
			{
				e = NavigationMenuItemView.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
			//    2    2:putfield        #12  <Field NavigationMenuItemView e>
				super();
			//    3    5:aload_0         
	...
	//    5    7:aload_0         
	//    6    8:new             #8   <Class NavigationMenuItemView$2>
	//    7   11:dup             
	//    8   12:aload_0         
	//    9   13:invokespecial   #50  <Method void NavigationMenuItemView$2(NavigationMenuItemView)>
	...
	//   48   93:invokevirtual   #262 <Method void setContentDescription(CharSequence)>
		ViewCompat.setTooltipText(((View) (this)), menuitemimpl.getTooltipText());
	//   49   96:aload_0         
	//   50   97:aload_1         
	//   51   98:invokevirtual   #265 <Method CharSequence MenuItemImpl.getTooltipText()>
	//   52  101:invokestatic    #269 <Method void ViewCompat.setTooltipText(View, CharSequence)>
		adjustAppearance();
	//   53  104:aload_0         
	//   54  105:invokespecial   #271 <Method void adjustAppearance()>
	//   55  108:return          
	}
	...
	//    2    2:iconst_1        
	//    3    3:iadd            
	//    4    4:invokespecial   #275 <Method int[] ForegroundLinearLayout.onCreateDrawableState(int)>
	//    5    7:astore_2        
	...
	//   19   39:invokestatic    #279 <Method int[] mergeDrawableStates(int[], int[])>
	//   20   42:pop             
		return ai;
	//   21   43:aload_2         
	//   22   44:areturn         
	...
	//   10   20:aconst_null     
	//   11   21:aconst_null     
	//   12   22:invokevirtual   #285 <Method void CheckedTextView.setCompoundDrawables(Drawable, Drawable, Drawable, Drawable)>
	//   13   25:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #288 <Method void refreshDrawableState()>
		if(mCheckable != flag)
	//*   2    4:aload_0         
	//*   3    5:getfield        #290 <Field boolean mCheckable>
	//*   4    8:iload_1         
	//*   5    9:icmpeq          31
		{
			mCheckable = flag;
	//    6   12:aload_0         
	//    7   13:iload_1         
	//    8   14:putfield        #290 <Field boolean mCheckable>
	...
	//   13   25:sipush          2048
	//   14   28:invokevirtual   #296 <Method void AccessibilityDelegateCompat.sendAccessibilityEvent(View, int)>
		}
	//   15   31:return          
	}
	...
	//    4    8:iload_1         
	//    5    9:invokevirtual   #297 <Method void CheckedTextView.setChecked(boolean)>
	//    6   12:return          
	}
	...
	//    3    5:astore_2        
			if(mHasIconTintList)
	//*   4    6:aload_0         
	//*   5    7:getfield        #299 <Field boolean mHasIconTintList>
	//*   6   10:ifeq            46
			{
				obj = ((Object) (drawable.getConstantState()));
	//    7   13:aload_1         
	//    8   14:invokevirtual   #305 <Method android.graphics.drawable.Drawable$ConstantState Drawable.getConstantState()>
	//    9   17:astore_2        
				if(obj != null)
	//*  10   18:aload_2         
	//*  11   19:ifnonnull       25
	...
	//   13   25:aload_2         
	//   14   26:invokevirtual   #310 <Method Drawable android.graphics.drawable.Drawable$ConstantState.newDrawable()>
	//   15   29:astore_1        
				obj = ((Object) (DrawableCompat.wrap(drawable).mutate()));
	//   16   30:aload_1         
	//   17   31:invokestatic    #316 <Method Drawable DrawableCompat.wrap(Drawable)>
	//   18   34:invokevirtual   #319 <Method Drawable Drawable.mutate()>
	//   19   37:astore_2        
				DrawableCompat.setTintList(((Drawable) (obj)), mIconTintList);
	//   20   38:aload_2         
	//   21   39:aload_0         
	//   22   40:getfield        #321 <Field ColorStateList mIconTintList>
	//   23   43:invokestatic    #325 <Method void DrawableCompat.setTintList(Drawable, ColorStateList)>
			}
	...
	//   31   57:invokevirtual   #329 <Method void Drawable.setBounds(int, int, int, int)>
	...
	//*  34   62:goto            129
		if(mNeedsEmptyIcon)
	//*  35   65:aload_0         
	//*  36   66:getfield        #331 <Field boolean mNeedsEmptyIcon>
	//*  37   69:ifeq            129
		{
			if(mEmptyDrawable == null)
	//*  38   72:aload_0         
	//*  39   73:getfield        #333 <Field Drawable mEmptyDrawable>
	//*  40   76:ifnonnull       124
			{
	...
	//   41   79:aload_0         
	//   42   80:aload_0         
	//   43   81:invokevirtual   #334 <Method Resources getResources()>
	//   44   84:getstatic       #339 <Field int android.support.design.R$drawable.navigation_empty_icon>
	//   45   87:aload_0         
	...
	//   48   94:invokestatic    #345 <Method Drawable ResourcesCompat.getDrawable(Resources, int, android.content.res.Resources$Theme)>
	//   49   97:putfield        #333 <Field Drawable mEmptyDrawable>
				if(mEmptyDrawable != null)
	//*  50  100:aload_0         
	//*  51  101:getfield        #333 <Field Drawable mEmptyDrawable>
	//*  52  104:ifnull          124
					mEmptyDrawable.setBounds(0, 0, mIconSize, mIconSize);
	//   53  107:aload_0         
	//   54  108:getfield        #333 <Field Drawable mEmptyDrawable>
	//   55  111:iconst_0        
	//   56  112:iconst_0        
	//   57  113:aload_0         
	...
	//   61  121:invokevirtual   #329 <Method void Drawable.setBounds(int, int, int, int)>
			}
			drawable = mEmptyDrawable;
	//   62  124:aload_0         
	//   63  125:getfield        #333 <Field Drawable mEmptyDrawable>
	//   64  128:astore_1        
		}
	...
	//   69  135:aconst_null     
	//   70  136:aconst_null     
	//   71  137:invokestatic    #351 <Method void TextViewCompat.setCompoundDrawablesRelative(android.widget.TextView, Drawable, Drawable, Drawable, Drawable)>
	//   72  140:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #321 <Field ColorStateList mIconTintList>
		boolean flag;
		if(mIconTintList != null)
	//*   3    5:aload_0         
	//*   4    6:getfield        #321 <Field ColorStateList mIconTintList>
	//*   5    9:ifnull          17
			flag = true;
	//    6   12:iconst_1        
	//    7   13:istore_2        
	...
	//   11   19:aload_0         
	//   12   20:iload_2         
	//   13   21:putfield        #299 <Field boolean mHasIconTintList>
		if(mItemData != null)
	//*  14   24:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #331 <Field boolean mNeedsEmptyIcon>
	//    3    5:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:invokestatic    #360 <Method void TextViewCompat.setTextAppearance(android.widget.TextView, int)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #103 <Field CheckedTextView mTextView>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #363 <Method void CheckedTextView.setTextColor(ColorStateList)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #103 <Field CheckedTextView mTextView>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #366 <Method void CheckedTextView.setText(CharSequence)>
	//    4    8:return          
	}
