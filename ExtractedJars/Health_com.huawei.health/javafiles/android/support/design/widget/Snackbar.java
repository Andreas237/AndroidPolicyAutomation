...
public final class Snackbar extends BaseTransientBottomBar
{
	...
	public static final class SnackbarLayout extends BaseTransientBottomBar.c
	{
		...
		//    1    1:iload_1         
		//    2    2:iload_2         
		//    3    3:invokespecial   #23  <Method void BaseTransientBottomBar$c.onMeasure(int, int)>
			j = getChildCount();
		//    4    6:aload_0         
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokespecial   #15  <Method void BaseTransientBottomBar$c(Context)>
		//    3    5:return          
		}
		...
		//    1    1:aload_1         
		//    2    2:aload_2         
		//    3    3:invokespecial   #19  <Method void BaseTransientBottomBar$c(Context, AttributeSet)>
		//    4    6:return          
		}
	}
	...
	public Snackbar setAction(CharSequence charsequence, android.view.View.OnClickListener onclicklistener)
	{
		android.widget.Button button = ((SnackbarContentLayout)mView.getChildAt(0)).getActionView();
	//    0    0:aload_0         
	//    1    1:getfield        #119 <Field BaseTransientBottomBar$c mView>
	//    2    4:iconst_0        
	//    3    5:invokevirtual   #125 <Method View BaseTransientBottomBar$c.getChildAt(int)>
	...
	//   12   26:aload_3         
	//   13   27:bipush          8
	//   14   29:invokevirtual   #141 <Method void TextView.setVisibility(int)>
			((TextView) (button)).setOnClickListener(((android.view.View.OnClickListener) (null)));
	//   15   32:aload_3         
	//   16   33:aconst_null     
	//   17   34:invokevirtual   #145 <Method void TextView.setOnClickListener(android.view.View$OnClickListener)>
			return this;
	//   18   37:aload_0         
	//   19   38:areturn         
		} else
	...
	//   20   39:aload_3         
	//   21   40:iconst_0        
	//   22   41:invokevirtual   #141 <Method void TextView.setVisibility(int)>
			((TextView) (button)).setText(charsequence);
	//   23   44:aload_3         
	//   24   45:aload_1         
	//   25   46:invokevirtual   #148 <Method void TextView.setText(CharSequence)>
			((TextView) (button)).setOnClickListener(new android.view.View.OnClickListener(onclicklistener) {
	...
	//   26   49:aload_3         
	//   27   50:new             #7   <Class Snackbar$5>
	//   28   53:dup             
	//   29   54:aload_0         
	//   30   55:aload_2         
	//   31   56:invokespecial   #151 <Method void Snackbar$5(Snackbar, android.view.View$OnClickListener)>
	//   32   59:invokevirtual   #145 <Method void TextView.setOnClickListener(android.view.View$OnClickListener)>
			return this;
	//   33   62:aload_0         
	//   34   63:areturn         
		}
	...
	//    6   14:aload_1         
	//    7   15:invokevirtual   #148 <Method void TextView.setText(CharSequence)>
		return this;
	//    8   18:aload_0         
	//    9   19:areturn         
	}
