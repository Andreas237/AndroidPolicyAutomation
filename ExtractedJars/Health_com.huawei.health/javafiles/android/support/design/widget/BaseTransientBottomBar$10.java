...
class BaseTransientBottomBar$10
	implements BaseTransientBottomBar.b
{

	public void a(View view, int i, int j, int k, int l)
	{
		e.mView.setOnLayoutChangeListener(((BaseTransientBottomBar.b) (null)));
	//    0    0:aload_0         
	...
	BaseTransientBottomBar$10(BaseTransientBottomBar basetransientbottombar)
	{
