	...
	implements Iterable
{
	...
	//   27   50:ldc1            #114 <String "Bad ComponentName while traversing activity parent metadata">
	//   28   52:invokestatic    #120 <Method int Log.e(String, String)>
	//   29   55:pop             
			throw new IllegalArgumentException(((Throwable) (componentname)));
	//   30   56:new             #122 <Class IllegalArgumentException>
	//   31   59:dup             
	//   32   60:aload_1         
	//   33   61:invokespecial   #125 <Method void IllegalArgumentException(Throwable)>
	//   34   64:athrow          
		}
		if(componentname == null)
