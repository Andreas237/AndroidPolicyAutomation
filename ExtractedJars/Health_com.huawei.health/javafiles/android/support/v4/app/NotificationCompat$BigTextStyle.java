...
public static class NotificationCompat$BigTextStyle extends NotificationCompat.Style
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #26  <Method CharSequence NotificationCompat$Builder.limitCharSequenceLength(CharSequence)>
	//    3    5:putfield        #28  <Field CharSequence mBigText>
		return this;
	//    4    8:aload_0         
	//    5    9:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:invokestatic    #26  <Method CharSequence NotificationCompat$Builder.limitCharSequenceLength(CharSequence)>
	//    3    5:putfield        #32  <Field CharSequence mBigContentTitle>
		return this;
	//    4    8:aload_0         
	//    5    9:areturn         
	}
