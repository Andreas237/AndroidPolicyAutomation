...
static class NotificationCompat$NotificationCompatBaseImpl
	implements NotificationCompat.NotificationCompatImpl
{
	...
	//    8   14:aload_1         
	//    9   15:invokevirtual   #33  <Method CharSequence NotificationCompat$Builder.resolveTitle()>
	//   10   18:aload_1         
	//   11   19:invokevirtual   #36  <Method CharSequence NotificationCompat$Builder.resolveText()>
	//   12   22:aload_1         
	//   13   23:getfield        #40  <Field CharSequence NotificationCompat$Builder.mContentInfo>
	//   14   26:aload_1         
	//   15   27:getfield        #44  <Field RemoteViews NotificationCompat$Builder.mTickerView>
	//   16   30:aload_1         
	//   17   31:getfield        #48  <Field int NotificationCompat$Builder.mNumber>
	//   18   34:aload_1         
	//   19   35:getfield        #52  <Field PendingIntent NotificationCompat$Builder.mContentIntent>
	//   20   38:aload_1         
	//   21   39:getfield        #55  <Field PendingIntent NotificationCompat$Builder.mFullScreenIntent>
	//   22   42:aload_1         
	//   23   43:getfield        #59  <Field Bitmap NotificationCompat$Builder.mLargeIcon>
	//   24   46:aload_1         
	//   25   47:getfield        #62  <Field int NotificationCompat$Builder.mProgressMax>
	//   26   50:aload_1         
	//   27   51:getfield        #65  <Field int NotificationCompat$Builder.mProgress>
	//   28   54:aload_1         
	//   29   55:getfield        #69  <Field boolean NotificationCompat$Builder.mProgressIndeterminate>
	//   30   58:invokespecial   #72  <Method void NotificationCompat$NotificationCompatBaseImpl$BuilderBase(Context, Notification, CharSequence, CharSequence, CharSequence, RemoteViews, int, PendingIntent, PendingIntent, Bitmap, int, int, boolean)>
	//   31   61:invokevirtual   #77  <Method Notification NotificationCompat$BuilderExtender.build(NotificationCompat$Builder, NotificationBuilderWithBuilderAccessor)>
	//   32   64:areturn         
	}
	...
	public NotificationCompatBase.UnreadConversation getUnreadConversationFromBundle(Bundle bundle, ory ory, RemoteInputCompatBase.RemoteInput.Factory factory)
	{
		return null;
	//    0    0:aconst_null     
	//    1    1:areturn         
	...
	NotificationCompat$NotificationCompatBaseImpl()
	{
	//    0    0:aload_0         
