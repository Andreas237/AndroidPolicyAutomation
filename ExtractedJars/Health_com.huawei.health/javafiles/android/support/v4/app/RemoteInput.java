...
;
	...
	//*   8   21:getstatic       #62  <Field int android.os.Build$VERSION.SDK_INT>
	//*   9   24:bipush          16
	//*  10   26:icmplt          42
			IMPL = ((Impl) (new ImplJellybean()));
	//   11   29:new             #20  <Class RemoteInput$ImplJellybean>
	//   12   32:dup             
	//   13   33:invokespecial   #68  <Method void RemoteInput$ImplJellybean()>
	//   14   36:putstatic       #67  <Field RemoteInput$Impl IMPL>
		else
	//*  15   39:goto            52
			IMPL = ((Impl) (new ImplBase()));
	//   16   42:new             #17  <Class RemoteInput$ImplBase>
	//   17   45:dup             
	//   18   46:invokespecial   #69  <Method void RemoteInput$ImplBase()>
	//   19   49:putstatic       #67  <Field RemoteInput$Impl IMPL>
	//   20   52:new             #6   <Class RemoteInput$1>
	//   21   55:dup             
	//   22   56:invokespecial   #70  <Method void RemoteInput$1()>
	//   23   59:putstatic       #72  <Field RemoteInputCompatBase$RemoteInput$Factory FACTORY>
	//*  24   62:return          
	}
}
