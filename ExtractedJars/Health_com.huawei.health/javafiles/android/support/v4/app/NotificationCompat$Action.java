...
;
	...
	//*  14   27:goto            39
			bundle = new Bundle();
	//   15   30:new             #48  <Class Bundle>
	//   16   33:dup             
	//   17   34:invokespecial   #49  <Method void Bundle()>
	//   18   37:astore          4
		mExtras = bundle;
	//   19   39:aload_0         
	//   20   40:aload           4
	//   21   42:putfield        #67  <Field Bundle mExtras>
		mRemoteInputs = aremoteinput;
	//   22   45:aload_0         
	//   23   46:aload           5
	//   24   48:putfield        #69  <Field RemoteInput[] mRemoteInputs>
		mDataOnlyRemoteInputs = aremoteinput1;
	//   25   51:aload_0         
	//   26   52:aload           6
	//   27   54:putfield        #71  <Field RemoteInput[] mDataOnlyRemoteInputs>
		mAllowGeneratedReplies = flag;
	//   28   57:aload_0         
	//   29   58:iload           7
	//   30   60:putfield        #73  <Field boolean mAllowGeneratedReplies>
	//   31   63:return          
	}
}
