...
public final class RoundedBitmapDrawableFactory
{
	...
	//*   7   13:ifnonnull       41
			Log.w("RoundedBitmapDrawableFactory", (new StringBuilder()).append("RoundedBitmapDrawable cannot decode ").append(((Object) (inputstream))).toString());
	//    8   16:ldc1            #11  <String "RoundedBitmapDrawableFactory">
	...
	//*   6   10:invokevirtual   #45  <Method Bitmap RoundedBitmapDrawable.getBitmap()>
	//*   7   13:ifnonnull       41
			Log.w("RoundedBitmapDrawableFactory", (new StringBuilder()).append("RoundedBitmapDrawable cannot decode ").append(s).toString());
	//    8   16:ldc1            #11  <String "RoundedBitmapDrawableFactory">
	//    9   18:new             #47  <Class StringBuilder>
	//   10   21:dup             
	//   11   22:invokespecial   #48  <Method void StringBuilder()>
