	...
	implements android.graphics.drawable.Drawable.Callback, DrawableWrapper, TintAwareDrawable
{
	...
	//   50   97:aload_0         
	//   51   98:iconst_0        
	//   52   99:putfield        #95  <Field boolean mColorFilterSet>
			clearColorFilter();
	//   53  102:aload_0         
	//   54  103:invokevirtual   #106 <Method void clearColorFilter()>
		}
		return false;
	//   55  106:iconst_0        
	//   56  107:ireturn         
	...
	//   15   27:ior             
	//   16   28:aload_0         
	//   17   29:getfield        #110 <Field Drawable mDrawable>
	//   18   32:invokevirtual   #115 <Method int Drawable.getChangingConfigurations()>
	//   19   35:ior             
	//   20   36:ireturn         
	}
	...
	//   14   28:ifnull          38
	//   15   31:aload_1         
	//   16   32:invokevirtual   #165 <Method boolean ColorStateList.isStateful()>
	//   17   35:ifne            48
	//   18   38:aload_0         
	//   19   39:getfield        #110 <Field Drawable mDrawable>
	//   20   42:invokevirtual   #166 <Method boolean Drawable.isStateful()>
	//   21   45:ifeq            50
	//   22   48:iconst_1        
	//   23   49:ireturn         
	//   24   50:iconst_0        
	...
	//   34   70:aload_2         
	//   35   71:aload_1         
	//   36   72:putfield        #66  <Field android.graphics.drawable.Drawable$ConstantState DrawableWrapperApi14$DrawableWrapperState.mDrawableState>
			}
			mMutated = true;
	//   37   75:aload_0         
	//   38   76:iconst_1        
	//   39   77:putfield        #172 <Field boolean mMutated>
		}
