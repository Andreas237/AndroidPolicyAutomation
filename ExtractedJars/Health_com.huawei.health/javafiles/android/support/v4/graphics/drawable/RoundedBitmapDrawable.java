...
public abstract class RoundedBitmapDrawable extends Drawable
{
	...
	//   11   23:astore_1        
		return bitmap != null && !bitmap.hasAlpha() && mPaint.getAlpha() >= 255 && !isGreaterThanZero(mCornerRadius) ? -1 : -3;
	//   12   24:aload_1         
	//   13   25:ifnull          58
	//   14   28:aload_1         
	...
	//   21   41:aconst_null     
	//   22   42:invokevirtual   #196 <Method android.graphics.Shader Paint.setShader(android.graphics.Shader)>
	//   23   45:pop             
		mCornerRadius = f;
	//   24   46:aload_0         
	//   25   47:fload_1         
	//   26   48:putfield        #119 <Field float mCornerRadius>
		invalidateSelf();
	//   27   51:aload_0         
	//   28   52:invokevirtual   #187 <Method void invalidateSelf()>
	//   29   55:return          
	}
	...
	//    9   19:aload_0         
	//   10   20:iload_1         
	//   11   21:putfield        #38  <Field int mTargetDensity>
			if(mBitmap != null)
	//*  12   24:aload_0         
	//*  13   25:getfield        #77  <Field Bitmap mBitmap>
	//*  14   28:ifnull          35
				computeBitmapSize();
	//   15   31:aload_0         
	//   16   32:invokespecial   #80  <Method void computeBitmapSize()>
			invalidateSelf();
	//   17   35:aload_0         
	//   18   36:invokevirtual   #187 <Method void invalidateSelf()>
		}
	//   19   39:return          
	}
	...
	//   69  128:aload_0         
	//   70  129:invokevirtual   #224 <Method Rect getBounds()>
	//   71  132:aload_0         
	//   72  133:getfield        #57  <Field Rect mDstRect>
	//   73  136:invokevirtual   #226 <Method void gravityCompatApply(int, int, int, Rect, Rect)>
			}
	...
	//   78  147:invokevirtual   #243 <Method void RectF.set(Rect)>
	...
	//   86  165:getfield        #246 <Field float RectF.left>
	//   87  168:aload_0         
	//   88  169:getfield        #62  <Field RectF mDstRectF>
	//   89  172:getfield        #249 <Field float RectF.top>
	//   90  175:invokevirtual   #253 <Method void Matrix.setTranslate(float, float)>
	...
	//   95  186:invokevirtual   #255 <Method float RectF.width()>
	//   96  189:aload_0         
	//   97  190:getfield        #77  <Field Bitmap mBitmap>
	//   98  193:invokevirtual   #258 <Method int Bitmap.getWidth()>
	//   99  196:i2f             
	//  100  197:fdiv            
	//  101  198:aload_0         
	//  102  199:getfield        #62  <Field RectF mDstRectF>
	//  103  202:invokevirtual   #260 <Method float RectF.height()>
	//  104  205:aload_0         
	//  105  206:getfield        #77  <Field Bitmap mBitmap>
	//  106  209:invokevirtual   #263 <Method int Bitmap.getHeight()>
	//  107  212:i2f             
	//  108  213:fdiv            
	//  109  214:invokevirtual   #267 <Method boolean Matrix.preScale(float, float)>
	//  110  217:pop             
	...
	//  115  226:invokevirtual   #271 <Method void BitmapShader.setLocalMatrix(Matrix)>
				mPaint.setShader(((android.graphics.Shader) (mBitmapShader)));
	//  116  229:aload_0         
	//  117  230:getfield        #47  <Field Paint mPaint>
	//  118  233:aload_0         
	//  119  234:getfield        #93  <Field BitmapShader mBitmapShader>
	//  120  237:invokevirtual   #196 <Method android.graphics.Shader Paint.setShader(android.graphics.Shader)>
	//  121  240:pop             
			}
			mApplyGravity = false;
	//  122  241:aload_0         
