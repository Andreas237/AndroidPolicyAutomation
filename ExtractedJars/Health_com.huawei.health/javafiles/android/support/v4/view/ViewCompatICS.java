...
/*
		static void access$000(TooltipHandler tooltiphandler, int i)
		{
			tooltiphandler.show(i);
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:invokespecial   #52  <Method void show(int)>
			return;
...
*/
	...
	//*   0    0:aload_1         
	//*   1    1:invokestatic    #25  <Method boolean TextUtils.isEmpty(CharSequence)>
	//*   2    4:ifeq            23
		{
			view.setOnLongClickListener(((android.view.View.OnLongClickListener) (null)));
	//    3    7:aload_0         
	//    4    8:aconst_null     
	//    5    9:invokevirtual   #31  <Method void View.setOnLongClickListener(android.view.View$OnLongClickListener)>
			view.setLongClickable(false);
	//    6   12:aload_0         
	//    7   13:iconst_0        
	//    8   14:invokevirtual   #35  <Method void View.setLongClickable(boolean)>
			view.setOnHoverListener(((android.view.View.OnHoverListener) (null)));
	//    9   17:aload_0         
	//   10   18:aconst_null     
	//   11   19:invokevirtual   #39  <Method void View.setOnHoverListener(android.view.View$OnHoverListener)>
			return;
	//   12   22:return          
		} else
		{
			new TooltipHandler(view, charsequence);
	//   13   23:new             #6   <Class ViewCompatICS$TooltipHandler>
	//   14   26:dup             
	//   15   27:aload_0         
	//   16   28:aload_1         
	//   17   29:invokespecial   #41  <Method void ViewCompatICS$TooltipHandler(View, CharSequence)>
	//   18   32:pop             
			return;
	//   19   33:return          
		}
	...
	// Unreferenced inner class android/support/v4/view/ViewCompatICS$TooltipHandler$1

/* anonymous class */
	class TooltipHandler._cls1
		implements Runnable
	{
		...
		final TooltipHandler this$0;

			
			{
				this$0 = TooltipHandler.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
