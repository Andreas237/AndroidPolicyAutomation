	...
	static class InflateThread extends Thread
	{
		...
		public void run()
		{
			do
			{
				...
				try
				{
					obj = ((Object) ((InflateRequest)mQueue.take()));
		//    0    0:aload_0         
		//    1    1:getfield        #34  <Field ArrayBlockingQueue mQueue>
		...
		//   11   22:goto            0
				...
				try
				{
					obj.view = ((InflateRequest) (obj)).inflater.mInflater.inflate(((InflateRequest) (obj)).resid, ((InflateRequest) (obj)).parent, false);
		//   12   25:aload_1         
		//   13   26:aload_1         
		...
		//   18   37:aload_1         
		//   19   38:getfield        #78  <Field ViewGroup AsyncLayoutInflater$InflateRequest.parent>
		//   20   41:iconst_0        
		//   21   42:invokevirtual   #112 <Method View LayoutInflater.inflate(int, ViewGroup, boolean)>
		//   22   45:putfield        #86  <Field View AsyncLayoutInflater$InflateRequest.view>
				}
		//*  23   48:goto            61
		...
		//   29   60:pop             
				...
				Message.obtain(((InflateRequest) (obj)).inflater.mHandler, 0, obj).sendToTarget();
		//   30   61:aload_1         
		//   31   62:getfield        #74  <Field AsyncLayoutInflater AsyncLayoutInflater$InflateRequest.inflater>
		//   32   65:getfield        #121 <Field Handler AsyncLayoutInflater.mHandler>
		//   33   68:iconst_0        
		//   34   69:aload_1         
		//   35   70:invokestatic    #127 <Method Message Message.obtain(Handler, int, Object)>
