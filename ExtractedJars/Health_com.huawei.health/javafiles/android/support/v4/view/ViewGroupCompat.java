...
public final class ViewGroupCompat
{
	...
	//    0    0:getstatic       #32  <Field ViewGroupCompat$ViewGroupCompatBaseImpl IMPL>
	//    1    3:aload_0         
	//    2    4:invokevirtual   #43  <Method int ViewGroupCompat$ViewGroupCompatBaseImpl.getNestedScrollAxes(ViewGroup)>
	//    3    7:ireturn         
	}
	...
	//    0    0:getstatic       #32  <Field ViewGroupCompat$ViewGroupCompatBaseImpl IMPL>
	//    1    3:aload_0         
	//    2    4:invokevirtual   #47  <Method boolean ViewGroupCompat$ViewGroupCompatBaseImpl.isTransitionGroup(ViewGroup)>
	//    3    7:ireturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokevirtual   #55  <Method boolean ViewGroup.onRequestSendAccessibilityEvent(View, AccessibilityEvent)>
	//    4    6:ireturn         
	}
	...
	//    1    3:aload_0         
	//    2    4:iload_1         
	//    3    5:invokevirtual   #60  <Method void ViewGroupCompat$ViewGroupCompatBaseImpl.setLayoutMode(ViewGroup, int)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #65  <Method void ViewGroup.setMotionEventSplittingEnabled(boolean)>
	//    3    5:return          
	}
	...
	//    1    3:aload_0         
	//    2    4:iload_1         
	//    3    5:invokevirtual   #68  <Method void ViewGroupCompat$ViewGroupCompatBaseImpl.setTransitionGroup(ViewGroup, boolean)>
	//    4    8:return          
	}
	...
	//    5   10:new             #9   <Class ViewGroupCompat$ViewGroupCompatApi21Impl>
	//    6   13:dup             
	//    7   14:invokespecial   #30  <Method void ViewGroupCompat$ViewGroupCompatApi21Impl()>
	//    8   17:putstatic       #32  <Field ViewGroupCompat$ViewGroupCompatBaseImpl IMPL>
	//    9   20:return          
		else
		if(i >= 18)
	//*  10   21:iload_0         
	...
	//   13   27:new             #6   <Class ViewGroupCompat$ViewGroupCompatApi18Impl>
	//   14   30:dup             
	//   15   31:invokespecial   #33  <Method void ViewGroupCompat$ViewGroupCompatApi18Impl()>
	//   16   34:putstatic       #32  <Field ViewGroupCompat$ViewGroupCompatBaseImpl IMPL>
	//   17   37:return          
		else
			IMPL = new ViewGroupCompatBaseImpl();
	//   18   38:new             #12  <Class ViewGroupCompat$ViewGroupCompatBaseImpl>
	//   19   41:dup             
	//   20   42:invokespecial   #34  <Method void ViewGroupCompat$ViewGroupCompatBaseImpl()>
	//   21   45:putstatic       #32  <Field ViewGroupCompat$ViewGroupCompatBaseImpl IMPL>
	//*  22   48:return          
	}
}
