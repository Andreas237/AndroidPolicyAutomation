...
public class PagerTabStrip extends PagerTitleStrip
{
	...
	//*  55   97:ifeq            149
		{
			mTabPaint.setColor(mIndicatorColor & 0xffffff | 0xff000000);
	//   56  100:aload_0         
	//   57  101:getfield        #60  <Field Paint mTabPaint>
	//   58  104:aload_0         
	//   59  105:getfield        #76  <Field int mIndicatorColor>
	//   60  108:ldc1            #208 <Int 0xffffff>
	//   61  110:iand            
	//   62  111:ldc1            #215 <Int 0xff000000>
	//   63  113:ior             
	...
	//   19   63:aload_0         
	//   20   64:fload_2         
	//   21   65:putfield        #236 <Field float mInitialMotionX>
			mInitialMotionY = f1;
	//   22   68:aload_0         
	//   23   69:fload_3         
	//   24   70:putfield        #238 <Field float mInitialMotionY>
			mIgnoreTap = false;
	//   25   73:aload_0         
	//   26   74:iconst_0        
	//   27   75:putfield        #227 <Field boolean mIgnoreTap>
			break;
	//   28   78:goto            196
	...
	//*  29   81:fload_2         
	//*  30   82:aload_0         
	//*  31   83:getfield        #236 <Field float mInitialMotionX>
	//*  32   86:fsub            
	//*  33   87:invokestatic    #242 <Method float Math.abs(float)>
	//*  34   90:aload_0         
	//*  35   91:getfield        #127 <Field int mTouchSlop>
	//*  36   94:i2f             
	//*  37   95:fcmpl           
	//*  38   96:ifgt            117
	//*  39   99:fload_3         
	//*  40  100:aload_0         
	//*  41  101:getfield        #238 <Field float mInitialMotionY>
	//*  42  104:fsub            
	//*  43  105:invokestatic    #242 <Method float Math.abs(float)>
	//*  44  108:aload_0         
	//*  45  109:getfield        #127 <Field int mTouchSlop>
	//*  46  112:i2f             
	//*  47  113:fcmpl           
	//*  48  114:ifle            196
				mIgnoreTap = true;
	//   49  117:aload_0         
	//   50  118:iconst_1        
	//   51  119:putfield        #227 <Field boolean mIgnoreTap>
			break;
	//   52  122:goto            196
	...
	//*  53  125:fload_2         
	//*  54  126:aload_0         
	//*  55  127:getfield        #201 <Field TextView mCurrText>
	//*  56  130:invokevirtual   #204 <Method int TextView.getLeft()>
	//*  57  133:aload_0         
	//*  58  134:getfield        #110 <Field int mTabPadding>
	//*  59  137:isub            
	//*  60  138:i2f             
	//*  61  139:fcmpg           
	//*  62  140:ifge            162
			{
				mPager.setCurrentItem(mPager.getCurrentItem() - 1);
	//   63  143:aload_0         
	//   64  144:getfield        #246 <Field ViewPager mPager>
	//   65  147:aload_0         
	//   66  148:getfield        #246 <Field ViewPager mPager>
	//   67  151:invokevirtual   #251 <Method int ViewPager.getCurrentItem()>
	//   68  154:iconst_1        
	//   69  155:isub            
	//   70  156:invokevirtual   #254 <Method void ViewPager.setCurrentItem(int)>
				break;
	//   71  159:goto            196
			}
	...
	//*  72  162:fload_2         
	//*  73  163:aload_0         
	//*  74  164:getfield        #201 <Field TextView mCurrText>
	//*  75  167:invokevirtual   #207 <Method int TextView.getRight()>
	//*  76  170:aload_0         
	//*  77  171:getfield        #110 <Field int mTabPadding>
	//*  78  174:iadd            
	//*  79  175:i2f             
	//*  80  176:fcmpl           
	//*  81  177:ifle            196
				mPager.setCurrentItem(mPager.getCurrentItem() + 1);
	//   82  180:aload_0         
	//   83  181:getfield        #246 <Field ViewPager mPager>
	//   84  184:aload_0         
	//   85  185:getfield        #246 <Field ViewPager mPager>
	//   86  188:invokevirtual   #251 <Method int ViewPager.getCurrentItem()>
	//   87  191:iconst_1        
	//   88  192:iadd            
	//   89  193:invokevirtual   #254 <Method void ViewPager.setCurrentItem(int)>
			break;
		}
		return true;
	//   90  196:iconst_1        
	...
	//   15   26:aload_0         
	//   16   27:iload_2         
	//   17   28:putfield        #69  <Field boolean mDrawFullUnderline>
		}
	//   18   31:return          
	}
	...
	//   13   23:aload_0         
	//   14   24:iload_2         
	//   15   25:putfield        #69  <Field boolean mDrawFullUnderline>
		}
	//   16   28:return          
	}
