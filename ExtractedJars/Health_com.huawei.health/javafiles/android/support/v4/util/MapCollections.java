...
abstract class MapCollections
{
		...
		implements Set
	{
		...
		//*   4    6:invokevirtual   #38  <Method int MapCollections.colGetSize()>
		//*   5    9:iconst_1        
		//*   6   10:isub            
		//*   7   11:istore_1        
		//*   8   12:iload_1         
		...
		implements Set
	{
		...
		//*   2    2:aload_0         
		//*   3    3:getfield        #16  <Field MapCollections this$0>
		//*   4    6:invokevirtual   #59  <Method int MapCollections.colGetSize()>
		//*   5    9:iconst_1        
		//*   6   10:isub            
		//*   7   11:istore_1        
		//*   8   12:iload_1         
...
label0:
	...
	//   15   31:checkcast       #151 <Class Object[]>
	//   16   34:astore          5
		for(int j = 0; j < k; j++)
	//*  17   36:iconst_0        
	//*  18   37:istore_3        
	...
	//   25   48:iload_3         
	//   26   49:iload_2         
	//   27   50:invokevirtual   #133 <Method Object colGetEntry(int, int)>
	//   28   53:aastore         
