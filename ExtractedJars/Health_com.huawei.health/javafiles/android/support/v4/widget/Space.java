...
public class Space extends View
{
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:invokevirtual   #45  <Method int getSuggestedMinimumWidth()>
	//    3    5:iload_1         
	//    4    6:invokestatic    #47  <Method int getDefaultSize2(int, int)>
	//    5    9:aload_0         
	//    6   10:invokevirtual   #50  <Method int getSuggestedMinimumHeight()>
	//    7   13:iload_2         
	//    8   14:invokestatic    #47  <Method int getDefaultSize2(int, int)>
	//    9   17:invokevirtual   #53  <Method void setMeasuredDimension(int, int)>
	//   10   20:return          
	}
}
