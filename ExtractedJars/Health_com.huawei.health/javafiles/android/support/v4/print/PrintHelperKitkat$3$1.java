...
class PrintHelperKitkat$3$1 extends AsyncTask
{
	...
	protected transient Bitmap doInBackground(Uri auri[])
	{
		try
		{
			auri = ((Uri []) (PrintHelperKitkat.access$400(this$0, val$imageFile, 3500)));
	//    0    0:aload_0         
	...
	//   20   40:monitorenter    
		android.print.ize ize = mAttributes.getMediaSize();
	//   21   41:aload_0         
...
_L1:
	...
	//*  69  125:ifnull          187
		{
			bitmap = ((Bitmap) ((new android.print.der(val$jobName)).setContentType(1).setPageCount(1).build()));
...
_L1:
		...
		//   46   85:return          
			...
			{
				mLoadBitmap = (((PrintHelperKitkat._cls3._cls1) (layoutresultcallback)). new PrintHelperKitkat._cls3._cls1()).execute(((Object []) (new Uri[0])));
		//   47   86:aload_0         
