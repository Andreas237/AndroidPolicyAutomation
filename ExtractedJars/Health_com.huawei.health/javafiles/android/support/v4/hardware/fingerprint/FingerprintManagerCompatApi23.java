...
public final class FingerprintManagerCompatApi23
{
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #37  <Method FingerprintManager getFingerprintManagerOrNull(Context)>
	//    2    4:astore_0        
		if(context != null)
	//*   3    5:aload_0         
	//*   4    6:ifnull          29
	...
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:invokestatic    #41  <Method android.hardware.fingerprint.FingerprintManager$CryptoObject wrapCryptoObject(FingerprintManagerCompatApi23$CryptoObject)>
	//    8   14:aload_3         
	//    9   15:checkcast       #43  <Class CancellationSignal>
	//   10   18:iload_2         
	//   11   19:aload           4
	//   12   21:invokestatic    #47  <Method android.hardware.fingerprint.FingerprintManager$AuthenticationCallback wrapCallback(FingerprintManagerCompatApi23$AuthenticationCallback)>
	//   13   24:aload           5
	//   14   26:invokevirtual   #52  <Method void FingerprintManager.authenticate(android.hardware.fingerprint.FingerprintManager$CryptoObject, CancellationSignal, int, android.hardware.fingerprint.FingerprintManager$AuthenticationCallback, Handler)>
	//   15   29:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #58  <Method PackageManager Context.getPackageManager()>
	//*   2    4:ldc1            #60  <String "android.hardware.fingerprint">
	//*   3    6:invokevirtual   #66  <Method boolean PackageManager.hasSystemFeature(String)>
	//*   4    9:ifeq            22
			return (FingerprintManager)context.getSystemService(android/hardware/fingerprint/FingerprintManager);
	//    5   12:aload_0         
	//    6   13:ldc1            #49  <Class FingerprintManager>
	//    7   15:invokevirtual   #70  <Method Object Context.getSystemService(Class)>
	//    8   18:checkcast       #49  <Class FingerprintManager>
	//    9   21:areturn         
		else
			return null;
	//   10   22:aconst_null     
	...
	//    4    6:ifnull          18
	//    5    9:aload_0         
	//    6   10:invokevirtual   #75  <Method boolean FingerprintManager.hasEnrolledFingerprints()>
	//    7   13:ifeq            18
	//    8   16:iconst_1        
	//    9   17:ireturn         
	//   10   18:iconst_0        
	...
	//    4    6:ifnull          18
	//    5    9:aload_0         
	//    6   10:invokevirtual   #78  <Method boolean FingerprintManager.isHardwareDetected()>
	//    7   13:ifeq            18
	//    8   16:iconst_1        
	//    9   17:ireturn         
	//   10   18:iconst_0        
	...
	//*   4    6:aload_0         
	//*   5    7:invokevirtual   #84  <Method Cipher android.hardware.fingerprint.FingerprintManager$CryptoObject.getCipher()>
	//*   6   10:ifnull          25
			return new CryptoObject(cryptoobject.getCipher());
	//    7   13:new             #14  <Class FingerprintManagerCompatApi23$CryptoObject>
	//    8   16:dup             
	//    9   17:aload_0         
	//   10   18:invokevirtual   #84  <Method Cipher android.hardware.fingerprint.FingerprintManager$CryptoObject.getCipher()>
	//   11   21:invokespecial   #87  <Method void FingerprintManagerCompatApi23$CryptoObject(Cipher)>
	//   12   24:areturn         
		if(cryptoobject.getSignature() != null)
	//*  13   25:aload_0         
	//*  14   26:invokevirtual   #91  <Method Signature android.hardware.fingerprint.FingerprintManager$CryptoObject.getSignature()>
	//*  15   29:ifnull          44
			return new CryptoObject(cryptoobject.getSignature());
	//   16   32:new             #14  <Class FingerprintManagerCompatApi23$CryptoObject>
	//   17   35:dup             
	//   18   36:aload_0         
	//   19   37:invokevirtual   #91  <Method Signature android.hardware.fingerprint.FingerprintManager$CryptoObject.getSignature()>
	//   20   40:invokespecial   #94  <Method void FingerprintManagerCompatApi23$CryptoObject(Signature)>
	//   21   43:areturn         
		if(cryptoobject.getMac() != null)
	//*  22   44:aload_0         
	//*  23   45:invokevirtual   #98  <Method Mac android.hardware.fingerprint.FingerprintManager$CryptoObject.getMac()>
	//*  24   48:ifnull          63
			return new CryptoObject(cryptoobject.getMac());
	//   25   51:new             #14  <Class FingerprintManagerCompatApi23$CryptoObject>
	//   26   54:dup             
	//   27   55:aload_0         
	//   28   56:invokevirtual   #98  <Method Mac android.hardware.fingerprint.FingerprintManager$CryptoObject.getMac()>
	//   29   59:invokespecial   #101 <Method void FingerprintManagerCompatApi23$CryptoObject(Mac)>
	//   30   62:areturn         
		else
			return null;
	//   31   63:aconst_null     
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #104 <Method void FingerprintManagerCompatApi23$1(FingerprintManagerCompatApi23$AuthenticationCallback)>
	//    4    8:areturn         
	}
	...
	//    3    5:areturn         
		if(cryptoobject.getCipher() != null)
	//*   4    6:aload_0         
	//*   5    7:invokevirtual   #105 <Method Cipher FingerprintManagerCompatApi23$CryptoObject.getCipher()>
	//*   6   10:ifnull          25
			return new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getCipher());
	//    7   13:new             #80  <Class android.hardware.fingerprint.FingerprintManager$CryptoObject>
	//    8   16:dup             
	//    9   17:aload_0         
	//   10   18:invokevirtual   #105 <Method Cipher FingerprintManagerCompatApi23$CryptoObject.getCipher()>
	//   11   21:invokespecial   #106 <Method void android.hardware.fingerprint.FingerprintManager$CryptoObject(Cipher)>
	//   12   24:areturn         
		if(cryptoobject.getSignature() != null)
	//*  13   25:aload_0         
	//*  14   26:invokevirtual   #107 <Method Signature FingerprintManagerCompatApi23$CryptoObject.getSignature()>
	//*  15   29:ifnull          44
			return new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getSignature());
	//   16   32:new             #80  <Class android.hardware.fingerprint.FingerprintManager$CryptoObject>
	//   17   35:dup             
	//   18   36:aload_0         
	//   19   37:invokevirtual   #107 <Method Signature FingerprintManagerCompatApi23$CryptoObject.getSignature()>
	//   20   40:invokespecial   #108 <Method void android.hardware.fingerprint.FingerprintManager$CryptoObject(Signature)>
	//   21   43:areturn         
		if(cryptoobject.getMac() != null)
	//*  22   44:aload_0         
	//*  23   45:invokevirtual   #109 <Method Mac FingerprintManagerCompatApi23$CryptoObject.getMac()>
	//*  24   48:ifnull          63
			return new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getMac());
	//   25   51:new             #80  <Class android.hardware.fingerprint.FingerprintManager$CryptoObject>
	//   26   54:dup             
	//   27   55:aload_0         
	//   28   56:invokevirtual   #109 <Method Mac FingerprintManagerCompatApi23$CryptoObject.getMac()>
	//   29   59:invokespecial   #110 <Method void android.hardware.fingerprint.FingerprintManager$CryptoObject(Mac)>
	//   30   62:areturn         
		else
			return null;
	//   31   63:aconst_null     
