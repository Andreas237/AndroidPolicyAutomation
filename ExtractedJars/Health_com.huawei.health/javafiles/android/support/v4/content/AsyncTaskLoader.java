...
public abstract class AsyncTaskLoader extends Loader
{
	...
	//   52  106:aconst_null     
	//   53  107:invokevirtual   #145 <Method ModernAsyncTask AsyncTaskLoader$LoadTask.executeOnExecutor(Executor, Object[])>
	//   54  110:pop             
		}
	//   55  111:return          
	}
	...
	//*   2    4:ifnull          118
		{
			if(mCancellingTask != null)
	//*   3    7:aload_0         
	//*   4    8:getfield        #55  <Field AsyncTaskLoader$LoadTask mCancellingTask>
	//*   5   11:ifnull          50
			{
				if(mTask.waiting)
	//*   6   14:aload_0         
	...
	//   19   43:aload_0         
	//   20   44:aconst_null     
	//   21   45:putfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
				return false;
	//   22   48:iconst_0        
	//   23   49:ireturn         
			}
			if(mTask.waiting)
	//*  24   50:aload_0         
	//*  25   51:getfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
	//*  26   54:getfield        #106 <Field boolean AsyncTaskLoader$LoadTask.waiting>
	//*  27   57:ifeq            86
			{
				mTask.waiting = false;
	//   28   60:aload_0         
	//   29   61:getfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
	//   30   64:iconst_0        
	//   31   65:putfield        #106 <Field boolean AsyncTaskLoader$LoadTask.waiting>
				mHandler.removeCallbacks(((Runnable) (mTask)));
	//   32   68:aload_0         
	//   33   69:getfield        #131 <Field Handler mHandler>
	//   34   72:aload_0         
	//   35   73:getfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
	//   36   76:invokevirtual   #137 <Method void Handler.removeCallbacks(Runnable)>
				mTask = null;
	//   37   79:aload_0         
	//   38   80:aconst_null     
	//   39   81:putfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
				return false;
	//   40   84:iconst_0        
	//   41   85:ireturn         
			}
	...
	//   42   86:aload_0         
	//   43   87:getfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
	//   44   90:iconst_0        
	//   45   91:invokevirtual   #153 <Method boolean AsyncTaskLoader$LoadTask.cancel(boolean)>
	//   46   94:istore_1        
			if(flag)
	//*  47   95:iload_1         
	//*  48   96:ifeq            111
	...
	//   49   99:aload_0         
	//   50  100:aload_0         
	//   51  101:getfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
	//   52  104:putfield        #55  <Field AsyncTaskLoader$LoadTask mCancellingTask>
				cancelLoadInBackground();
	//   53  107:aload_0         
	//   54  108:invokevirtual   #155 <Method void cancelLoadInBackground()>
			}
			mTask = null;
	//   55  111:aload_0         
	//   56  112:aconst_null     
	//   57  113:putfield        #75  <Field AsyncTaskLoader$LoadTask mTask>
			return flag;
	//   58  116:iload_1         
	//   59  117:ireturn         
		} else
	...
	protected void onForceLoad()
	{
		super.onForceLoad();
	//    0    0:aload_0         
	//    1    1:invokespecial   #159 <Method void Loader.onForceLoad()>
		cancelLoad();
	//    2    4:aload_0         
	//    3    5:invokevirtual   #162 <Method boolean cancelLoad()>
	//    4    8:pop             
		mTask = new LoadTask();
	//    5    9:aload_0         
	...
	//    7   13:dup             
	//    8   14:aload_0         
	//    9   15:invokespecial   #165 <Method void AsyncTaskLoader$LoadTask(AsyncTaskLoader)>
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #168 <Method Object loadInBackground()>
	//    2    4:areturn         
	}
	...
	//    9   15:dup             
	//   10   16:invokespecial   #173 <Method void Handler()>
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #180 <Method void AsyncTaskLoader$LoadTask.waitForLoader()>
	//    7   13:return          
	}
