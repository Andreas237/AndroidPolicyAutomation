...
public class PagerSnapHelper extends SnapHelper
{
	...
	//   32   62:iconst_m1       
	//   33   63:ireturn         
		int k = layoutmanager.getPosition(view);
	//   34   64:aload_1         
	//   35   65:aload           7
	...
	//   64  117:istore_3        
		if(layoutmanager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider)
	//*  65  118:aload_1         
	//*  66  119:instanceof      #100 <Class RecyclerView$SmoothScroller$ScrollVectorProvider>
	//*  67  122:ifeq            171
		{
	...
	//   68  125:aload_1         
	//   69  126:checkcast       #100 <Class RecyclerView$SmoothScroller$ScrollVectorProvider>
	//   70  129:iload           6
	//   71  131:iconst_1        
	//   72  132:isub            
	//   73  133:invokeinterface #131 <Method PointF RecyclerView$SmoothScroller$ScrollVectorProvider.computeScrollVectorForPosition(int)>
	//   74  138:astore_1        
			j = ((int) (flag));
	//   75  139:iload           4
	//   76  141:istore_3        
	...
	//*  79  146:aload_1         
	//*  80  147:getfield        #137 <Field float PointF.x>
	//*  81  150:fconst_0        
	//*  82  151:fcmpg           
	//*  83  152:iflt            164
	//*  84  155:aload_1         
	//*  85  156:getfield        #140 <Field float PointF.y>
	//*  86  159:fconst_0        
	//*  87  160:fcmpg           
	//*  88  161:ifge            169
					j = 1;
