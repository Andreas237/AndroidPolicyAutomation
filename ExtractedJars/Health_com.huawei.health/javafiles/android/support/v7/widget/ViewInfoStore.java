...
class ViewInfoStore
{
	...
	//   44   86:new             #58  <Class IllegalArgumentException>
	//   45   89:dup             
	//   46   90:ldc1            #60  <String "Must provide flag PRE or POST">
	//   47   92:invokespecial   #63  <Method void IllegalArgumentException(String)>
	//   48   95:athrow          
			if((inforecord.flags & 0xc) == 0)
	//*  49   96:aload           4
	//*  50   98:getfield        #49  <Field int ViewInfoStore$InfoRecord.flags>
	//*  51  101:bipush          12
	//*  52  103:iand            
	//*  53  104:ifne            121
			{
	...
	//   54  107:aload_0         
	//   55  108:getfield        #29  <Field ArrayMap mLayoutHolderMap>
	//   56  111:iload_3         
	//   57  112:invokevirtual   #66  <Method Object ArrayMap.removeAt(int)>
	//   58  115:pop             
				InfoRecord.recycle(inforecord);
	//   59  116:aload           4
	//   60  118:invokestatic    #70  <Method void ViewInfoStore$InfoRecord.recycle(ViewInfoStore$InfoRecord)>
			}
	...
	//   16   31:iload_2         
	//   17   32:invokevirtual   #66  <Method Object ArrayMap.removeAt(int)>
	...
	//  105  244:istore_3        
			InfoRecord.recycle(inforecord);
	//  106  245:aload           5
	//  107  247:invokestatic    #70  <Method void ViewInfoStore$InfoRecord.recycle(ViewInfoStore$InfoRecord)>
		}
	...
	//   32   60:aload_1         
	//   33   61:invokestatic    #70  <Method void ViewInfoStore$InfoRecord.recycle(ViewInfoStore$InfoRecord)>
	//   34   64:return          
	}
