...
class RoundRectDrawable extends Drawable
{
	...
	//    2    4:iconst_0        
	//    3    5:invokestatic    #87  <Method ColorStateList ColorStateList.valueOf(int)>
	//    4    8:astore_1        
	//*   5    9:goto            12
		mBackground = colorstatelist;
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:putfield        #89  <Field ColorStateList mBackground>
		mPaint.setColor(mBackground.getColorForState(getState(), mBackground.getDefaultColor()));
	//    9   17:aload_0         
	//   10   18:getfield        #51  <Field Paint mPaint>
	//   11   21:aload_0         
	//   12   22:getfield        #89  <Field ColorStateList mBackground>
	//   13   25:aload_0         
	//   14   26:invokevirtual   #74  <Method int[] getState()>
	//   15   29:aload_0         
	//   16   30:getfield        #89  <Field ColorStateList mBackground>
	//   17   33:invokevirtual   #93  <Method int ColorStateList.getDefaultColor()>
	//   18   36:invokevirtual   #80  <Method int ColorStateList.getColorForState(int[], int)>
	//   19   39:invokevirtual   #96  <Method void Paint.setColor(int)>
	//   20   42:return          
	}
