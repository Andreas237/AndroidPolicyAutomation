...
public class ViewUtils
{
	...
	//    0    0:iload_0         
	//    1    1:iload_1         
	//    2    2:invokestatic    #65  <Method int View.combineMeasuredStates(int, int)>
	//    3    5:ireturn         
	}
	...
	//   12   20:aload_2         
	//   13   21:aastore         
	//   14   22:invokevirtual   #73  <Method Object Method.invoke(Object, Object[])>
	//   15   25:pop             
				return;
	//   16   26:return          
			}
	...
	//   19   30:ldc1            #75  <String "Could not invoke computeFitSystemWindows">
	//   20   32:aload_0         
	//   21   33:invokestatic    #78  <Method int Log.d(String, String, Throwable)>
	//   22   36:pop             
			}
	//   23   37:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #86  <Method int ViewCompat.getLayoutDirection(View)>
	//    2    4:iconst_1        
	//    3    5:icmpne          10
	//    4    8:iconst_1        
	//    5    9:ireturn         
	...
	//    3    8:aload_0         
	//    4    9:invokevirtual   #96  <Method Class Object.getClass()>
	//    5   12:ldc1            #97  <String "makeOptionalFitsSystemWindows">
	//    6   14:iconst_0        
	//    7   15:anewarray       Class[]
	//    8   18:invokevirtual   #100 <Method Method Class.getMethod(String, Class[])>
	//    9   21:astore_1        
	...
	//   20   40:invokevirtual   #73  <Method Object Method.invoke(Object, Object[])>
	//   21   43:pop             
				return;
	//   22   44:return          
			}
	...
	//   25   48:ldc1            #102 <String "Could not find method makeOptionalFitsSystemWindows. Oh well...">
	...
	//   31   58:ldc1            #104 <String "Could not invoke makeOptionalFitsSystemWindows">
	//   32   60:aload_0         
	//   33   61:invokestatic    #78  <Method int Log.d(String, String, Throwable)>
	//   34   64:pop             
				return;
	//   35   65:return          
			}
	...
	//   38   69:ldc1            #104 <String "Could not invoke makeOptionalFitsSystemWindows">
	//   39   71:aload_0         
	//   40   72:invokestatic    #78  <Method int Log.d(String, String, Throwable)>
	//   41   75:pop             
			}
	//   42   76:return          
	}
