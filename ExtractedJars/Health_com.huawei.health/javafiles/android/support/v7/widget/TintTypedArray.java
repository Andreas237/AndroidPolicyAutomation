...
public class TintTypedArray
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #51  <Method int TypedArray.getChangingConfigurations()>
	//    3    7:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #55  <Method int TypedArray.getColor(int, int)>
	//    5    9:ireturn         
	}
	...
	//*   1    1:getfield        #23  <Field TypedArray mWrapped>
	//*   2    4:iload_1         
	//*   3    5:invokevirtual   #61  <Method boolean TypedArray.hasValue(int)>
	//*   4    8:ifeq            40
		{
	...
	//    7   15:iload_1         
	//    8   16:iconst_0        
	//    9   17:invokevirtual   #64  <Method int TypedArray.getResourceId(int, int)>
	//   10   20:istore_2        
			if(j != 0)
	//*  11   21:iload_2         
	//*  12   22:ifeq            40
	...
	//   15   29:iload_2         
	//   16   30:invokestatic    #69  <Method ColorStateList AppCompatResources.getColorStateList(Context, int)>
	//   17   33:astore_3        
	...
	//   24   44:iload_1         
	//   25   45:invokevirtual   #71  <Method ColorStateList TypedArray.getColorStateList(int)>
	//   26   48:areturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:fload_2         
	//    4    6:invokevirtual   #75  <Method float TypedArray.getDimension(int, float)>
	//    5    9:freturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #78  <Method int TypedArray.getDimensionPixelOffset(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #81  <Method int TypedArray.getDimensionPixelSize(int, int)>
	//    5    9:ireturn         
	}
	...
	//   14   26:getfield        #21  <Field Context mContext>
	//   15   29:iload_2         
	//   16   30:invokestatic    #86  <Method Drawable AppCompatResources.getDrawable(Context, int)>
	//   17   33:areturn         
		}
	...
	//   20   38:iload_1         
	//   21   39:invokevirtual   #88  <Method Drawable TypedArray.getDrawable(int)>
	//   22   42:areturn         
	}
	...
	//   13   25:invokestatic    #95  <Method AppCompatDrawableManager AppCompatDrawableManager.get()>
	//   14   28:aload_0         
	//   15   29:getfield        #21  <Field Context mContext>
	//   16   32:iload_1         
	//   17   33:iconst_1        
	//   18   34:invokevirtual   #98  <Method Drawable AppCompatDrawableManager.getDrawable(Context, int, boolean)>
	//   19   37:areturn         
		}
		return null;
	//   20   38:aconst_null     
	...
	//    2    4:iload_1         
	//    3    5:fload_2         
	//    4    6:invokevirtual   #101 <Method float TypedArray.getFloat(int, float)>
	//    5    9:freturn         
	}
	...
	//    4    6:iload_3         
	//    5    7:fload           4
	//    6    9:invokevirtual   #105 <Method float TypedArray.getFraction(int, int, int, float)>
	//    7   12:freturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #109 <Method int TypedArray.getIndex(int)>
	//    4    8:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #112 <Method int TypedArray.getIndexCount()>
	//    3    7:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #115 <Method int TypedArray.getInt(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #118 <Method int TypedArray.getInteger(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #121 <Method int TypedArray.getLayoutDimension(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #124 <Method int TypedArray.getLayoutDimension(int, String)>
	//    5    9:ireturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #128 <Method String TypedArray.getNonResourceString(int)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #132 <Method String TypedArray.getPositionDescription()>
	//    3    7:areturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #64  <Method int TypedArray.getResourceId(int, int)>
	//    5    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #136 <Method Resources TypedArray.getResources()>
	//    3    7:areturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #139 <Method String TypedArray.getString(int)>
	//    4    8:areturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #143 <Method CharSequence TypedArray.getText(int)>
	//    4    8:areturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #147 <Method CharSequence[] TypedArray.getTextArray(int)>
	//    4    8:areturn         
	}
	...
	//*   0    0:getstatic       #154 <Field int android.os.Build$VERSION.SDK_INT>
	//*   1    3:bipush          21
	//*   2    5:icmplt          17
	...
	//    5   12:iload_1         
	//    6   13:invokevirtual   #156 <Method int TypedArray.getType(int)>
	//    7   16:ireturn         
		if(mTypedValue == null)
	//*   8   17:aload_0         
	//*   9   18:getfield        #158 <Field TypedValue mTypedValue>
	//*  10   21:ifnonnull       35
			mTypedValue = new TypedValue();
	//   11   24:aload_0         
	//   12   25:new             #160 <Class TypedValue>
	//   13   28:dup             
	//   14   29:invokespecial   #161 <Method void TypedValue()>
	//   15   32:putfield        #158 <Field TypedValue mTypedValue>
		mWrapped.getValue(i, mTypedValue);
	//   16   35:aload_0         
	//   17   36:getfield        #23  <Field TypedArray mWrapped>
	//   18   39:iload_1         
	//   19   40:aload_0         
	//   20   41:getfield        #158 <Field TypedValue mTypedValue>
	//   21   44:invokevirtual   #165 <Method boolean TypedArray.getValue(int, TypedValue)>
	//   22   47:pop             
		return mTypedValue.type;
	//   23   48:aload_0         
	//   24   49:getfield        #158 <Field TypedValue mTypedValue>
	//   25   52:getfield        #168 <Field int TypedValue.type>
	//   26   55:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #165 <Method boolean TypedArray.getValue(int, TypedValue)>
	//    5    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #171 <Method int TypedArray.length()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #175 <Method TypedValue TypedArray.peekValue(int)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #178 <Method void TypedArray.recycle()>
	//    3    7:return          
	}
