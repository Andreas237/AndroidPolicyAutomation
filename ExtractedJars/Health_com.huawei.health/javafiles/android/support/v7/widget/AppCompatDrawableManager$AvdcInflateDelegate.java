...
static class AppCompatDrawableManager$AvdcInflateDelegate
	implements AppCompatDrawableManager.InflateDelegate
{
	...
	//    0    0:aload_1         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #31  <Method android.content.res.Resources Context.getResources()>
	//    3    5:aload_2         
	//    4    6:aload_3         
	//    5    7:aload           4
	//    6    9:invokestatic    #36  <Method AnimatedVectorDrawableCompat AnimatedVectorDrawableCompat.createFromXmlInner(Context, android.content.res.Resources, XmlPullParser, AttributeSet, android.content.res.Resources$Theme)>
	//    7   12:astore_1        
		}
	//*   8   13:aload_1         
	//*   9   14:areturn         
