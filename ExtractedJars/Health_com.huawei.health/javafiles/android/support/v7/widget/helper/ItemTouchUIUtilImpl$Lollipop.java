...
static class ItemTouchUIUtilImpl$Lollipop extends 
{
	...
	//   18   38:aload_0         
	//   19   39:aload_1         
	//   20   40:invokespecial   #60  <Method void ItemTouchUIUtilImpl$Honeycomb.clearView(View)>
	//   21   43:return          
	}
	...
	//   28   53:iload           6
	//   29   55:iload           7
	//   30   57:invokespecial   #70  <Method void ItemTouchUIUtilImpl$Honeycomb.onDraw(Canvas, RecyclerView, View, float, float, int, boolean)>
	//   31   60:return          
	}
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #11  <Method void ItemTouchUIUtilImpl$Honeycomb()>
	//    2    4:return          
	}
}
