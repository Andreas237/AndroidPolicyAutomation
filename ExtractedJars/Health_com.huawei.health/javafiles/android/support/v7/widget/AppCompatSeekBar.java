...
public class AppCompatSeekBar extends SeekBar
{
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #44  <Method void SeekBar.jumpDrawablesToCurrentState()>
		mAppCompatSeekBarHelper.jumpDrawablesToCurrentState();
	//    2    4:aload_0         
	//    3    5:getfield        #29  <Field AppCompatSeekBarHelper mAppCompatSeekBarHelper>
	//    4    8:invokevirtual   #45  <Method void AppCompatSeekBarHelper.jumpDrawablesToCurrentState()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #50  <Method void SeekBar.onDraw(Canvas)>
		mAppCompatSeekBarHelper.drawTickMarks(canvas);
	//    3    5:aload_0         
	//    4    6:getfield        #29  <Field AppCompatSeekBarHelper mAppCompatSeekBarHelper>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #53  <Method void AppCompatSeekBarHelper.drawTickMarks(Canvas)>
	//    7   13:return          
	}
