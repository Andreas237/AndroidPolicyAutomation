...
public class AsyncListUtil
{
	...
	//   53   95:aload_0         
	//   54   96:iconst_0        
	//   55   97:putfield        #67  <Field int mScrollHint>
		else
	//*  56  100:goto            146
		if(mTmpRange[0] < mPrevRange[0])
	//*  57  103:aload_0         
	//*  58  104:getfield        #61  <Field int[] mTmpRange>
	//*  59  107:iconst_0        
	//*  60  108:iaload          
	//*  61  109:aload_0         
	//*  62  110:getfield        #63  <Field int[] mPrevRange>
	//*  63  113:iconst_0        
	//*  64  114:iaload          
	//*  65  115:icmpge          126
			mScrollHint = 1;
	//   66  118:aload_0         
	//   67  119:iconst_1        
	//   68  120:putfield        #67  <Field int mScrollHint>
		else
	//*  69  123:goto            146
		if(mTmpRange[0] > mPrevRange[0])
	//*  70  126:aload_0         
	//*  71  127:getfield        #61  <Field int[] mTmpRange>
	//*  72  130:iconst_0        
	//*  73  131:iaload          
	//*  74  132:aload_0         
	//*  75  133:getfield        #63  <Field int[] mPrevRange>
	//*  76  136:iconst_0        
	//*  77  137:iaload          
	//*  78  138:icmple          146
			mScrollHint = 2;
	//   79  141:aload_0         
	//   80  142:iconst_2        
	//   81  143:putfield        #67  <Field int mScrollHint>
		mPrevRange[0] = mTmpRange[0];
	//   82  146:aload_0         
	//   83  147:getfield        #63  <Field int[] mPrevRange>
	//   84  150:iconst_0        
	//   85  151:aload_0         
	//   86  152:getfield        #61  <Field int[] mTmpRange>
	//   87  155:iconst_0        
	//   88  156:iaload          
	//   89  157:iastore         
		mPrevRange[1] = mTmpRange[1];
	//   90  158:aload_0         
	//   91  159:getfield        #63  <Field int[] mPrevRange>
	//   92  162:iconst_1        
	//   93  163:aload_0         
	...
	//   98  170:aload_0         
	//   99  171:getfield        #94  <Field AsyncListUtil$ViewCallback mViewCallback>
	//  100  174:aload_0         
	//  101  175:getfield        #61  <Field int[] mTmpRange>
	//  102  178:aload_0         
	//  103  179:getfield        #65  <Field int[] mTmpRangeExtended>
	//  104  182:aload_0         
	//  105  183:getfield        #67  <Field int mScrollHint>
	//  106  186:invokevirtual   #198 <Method void AsyncListUtil$ViewCallback.extendRangeInto(int[], int[], int)>
		mTmpRangeExtended[0] = Math.min(mTmpRange[0], Math.max(mTmpRangeExtended[0], 0));
	//  107  189:aload_0         
	//  108  190:getfield        #65  <Field int[] mTmpRangeExtended>
	//  109  193:iconst_0        
	//  110  194:aload_0         
	//  111  195:getfield        #61  <Field int[] mTmpRange>
	//  112  198:iconst_0        
	//  113  199:iaload          
	//  114  200:aload_0         
	//  115  201:getfield        #65  <Field int[] mTmpRangeExtended>
	//  116  204:iconst_0        
	//  117  205:iaload          
	//  118  206:iconst_0        
	//  119  207:invokestatic    #204 <Method int Math.max(int, int)>
	//  120  210:invokestatic    #207 <Method int Math.min(int, int)>
	//  121  213:iastore         
		mTmpRangeExtended[1] = Math.max(mTmpRange[1], Math.min(mTmpRangeExtended[1], mItemCount - 1));
	//  122  214:aload_0         
	//  123  215:getfield        #65  <Field int[] mTmpRangeExtended>
	//  124  218:iconst_1        
	//  125  219:aload_0         
	//  126  220:getfield        #61  <Field int[] mTmpRange>
	//  127  223:iconst_1        
	//  128  224:iaload          
	//  129  225:aload_0         
	//  130  226:getfield        #65  <Field int[] mTmpRangeExtended>
	//  131  229:iconst_1        
	//  132  230:iaload          
	//  133  231:aload_0         
	//  134  232:getfield        #69  <Field int mItemCount>
	//  135  235:iconst_1        
	//  136  236:isub            
	//  137  237:invokestatic    #207 <Method int Math.min(int, int)>
	//  138  240:invokestatic    #204 <Method int Math.max(int, int)>
	//  139  243:iastore         
		mBackgroundProxy.updateRange(mTmpRange[0], mTmpRange[1], mTmpRangeExtended[0], mTmpRangeExtended[1], mScrollHint);
	//  140  244:aload_0         
	//  141  245:getfield        #118 <Field ThreadUtil$BackgroundCallback mBackgroundProxy>
	//  142  248:aload_0         
	//  143  249:getfield        #61  <Field int[] mTmpRange>
	//  144  252:iconst_0        
	//  145  253:iaload          
	//  146  254:aload_0         
	//  147  255:getfield        #61  <Field int[] mTmpRange>
	//  148  258:iconst_1        
	//  149  259:iaload          
	//  150  260:aload_0         
	//  151  261:getfield        #65  <Field int[] mTmpRangeExtended>
	//  152  264:iconst_0        
	//  153  265:iaload          
	//  154  266:aload_0         
	//  155  267:getfield        #65  <Field int[] mTmpRangeExtended>
	//  156  270:iconst_1        
	//  157  271:iaload          
	//  158  272:aload_0         
	//  159  273:getfield        #67  <Field int mScrollHint>
	//  160  276:invokeinterface #210 <Method void ThreadUtil$BackgroundCallback.updateRange(int, int, int, int, int)>
	//  161  281:return          
	}
