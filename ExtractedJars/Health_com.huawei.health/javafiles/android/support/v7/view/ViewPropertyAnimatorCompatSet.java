...
public class ViewPropertyAnimatorCompatSet
{
	...
	//   14   34:astore_2        
			if(mDuration >= 0L)
	//*  15   35:aload_0         
	//*  16   36:getfield        #31  <Field long mDuration>
	//*  17   39:lconst_0        
	//*  18   40:lcmp            
	//*  19   41:iflt            53
	...
	//   20   44:aload_2         
	//   21   45:aload_0         
	//   22   46:getfield        #31  <Field long mDuration>
	//   23   49:invokevirtual   #93  <Method ViewPropertyAnimatorCompat ViewPropertyAnimatorCompat.setDuration(long)>
	//   24   52:pop             
			if(mInterpolator != null)
	//*  25   53:aload_0         
	//*  26   54:getfield        #86  <Field Interpolator mInterpolator>
	//*  27   57:ifnull          69
				viewpropertyanimatorcompat.setInterpolator(mInterpolator);
	//   28   60:aload_2         
	//   29   61:aload_0         
	//   30   62:getfield        #86  <Field Interpolator mInterpolator>
	//   31   65:invokevirtual   #96  <Method ViewPropertyAnimatorCompat ViewPropertyAnimatorCompat.setInterpolator(Interpolator)>
	//   32   68:pop             
			if(mListener != null)
	//*  33   69:aload_0         
	//*  34   70:getfield        #90  <Field ViewPropertyAnimatorListener mListener>
	//*  35   73:ifnull          85
				viewpropertyanimatorcompat.setListener(((ViewPropertyAnimatorListener) (mProxyListener)));
	//   36   76:aload_2         
	//   37   77:aload_0         
	//   38   78:getfield        #36  <Field ViewPropertyAnimatorListenerAdapter mProxyListener>
	//   39   81:invokevirtual   #99  <Method ViewPropertyAnimatorCompat ViewPropertyAnimatorCompat.setListener(ViewPropertyAnimatorListener)>
	//   40   84:pop             
		}

	//   41   85:aload_2         
	//   42   86:invokevirtual   #101 <Method void ViewPropertyAnimatorCompat.start()>
	//*  43   89:goto            16
		mIsStarted = true;
	//   44   92:aload_0         
	//   45   93:iconst_1        
	//   46   94:putfield        #45  <Field boolean mIsStarted>
	//   47   97:return          
	}
