...
public class MenuAdapter extends BaseAdapter
{
	...
	//    8   18:aload_0         
	//    9   19:getfield        #40  <Field MenuBuilder mAdapterMenu>
	//   10   22:invokevirtual   #71  <Method ArrayList MenuBuilder.getVisibleItems()>
	//   11   25:astore_1        
		if(mExpandedIndex < 0)
	//*  12   26:aload_0         
	//*  13   27:getfield        #34  <Field int mExpandedIndex>
	//*  14   30:ifge            38
			return arraylist.size();
	//   15   33:aload_1         
	//   16   34:invokevirtual   #59  <Method int ArrayList.size()>
	//   17   37:ireturn         
		else
	...
	//   13   27:istore_2        
		if(mExpandedIndex >= 0)
	//*  14   28:aload_0         
	//*  15   29:getfield        #34  <Field int mExpandedIndex>
	//*  16   32:iflt            49
		{
			j = i;
	//   17   35:iload_1         
	...
	//*  19   37:iload_1         
	//*  20   38:aload_0         
	//*  21   39:getfield        #34  <Field int mExpandedIndex>
	//*  22   42:icmplt          49
				j = i + 1;
	//   23   45:iload_1         
	//   24   46:iconst_1        
	...
	//   27   49:aload_3         
	//   28   50:iload_2         
	//   29   51:invokevirtual   #63  <Method Object ArrayList.get(int)>
	//   30   54:checkcast       #65  <Class MenuItemImpl>
	//   31   57:areturn         
	}
	...
	//    4    7:aload_0         
	//    5    8:getfield        #38  <Field LayoutInflater mInflater>
	//    6   11:getstatic       #27  <Field int ITEM_LAYOUT>
	//    7   14:aload_3         
	//    8   15:iconst_0        
	//    9   16:invokevirtual   #89  <Method View LayoutInflater.inflate(int, ViewGroup, boolean)>
	//   10   19:astore          4
		view = ((View) ((MenuView.ItemView)view1));
	//   11   21:aload           4
	//   12   23:checkcast       #91  <Class MenuView$ItemView>
	//   13   26:astore_2        
		if(mForceShowIcon)
	//*  14   27:aload_0         
	//*  15   28:getfield        #75  <Field boolean mForceShowIcon>
	//*  16   31:ifeq            43
			((ListMenuItemView)view1).setForceShowIcon(true);
	//   17   34:aload           4
	//   18   36:checkcast       #93  <Class ListMenuItemView>
	//   19   39:iconst_1        
	//   20   40:invokevirtual   #97  <Method void ListMenuItemView.setForceShowIcon(boolean)>
		((MenuView.ItemView) (view)).initialize(getItem(i), 0);
	//   21   43:aload_2         
	//   22   44:aload_0         
	//   23   45:iload_1         
	//   24   46:invokevirtual   #79  <Method MenuItemImpl getItem(int)>
	//   25   49:iconst_0        
	//   26   50:invokeinterface #101 <Method void MenuView$ItemView.initialize(MenuItemImpl, int)>
		return view1;
	//   27   55:aload           4
	//   28   57:areturn         
	}
