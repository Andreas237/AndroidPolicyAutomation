	...
	implements MenuView.ItemView
{
	...
	//   48   91:aload_0         
	//   49   92:aload_1         
	//   50   93:invokevirtual   #232 <Method CharSequence MenuItemImpl.getTooltipText()>
	//   51   96:invokestatic    #238 <Method void ViewCompat.setTooltipText(android.view.View, CharSequence)>
	//   52   99:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #241 <Method void LinearLayout.onFinishInflate()>
		ViewCompat.setBackground(((android.view.View) (this)), mBackground);
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:getfield        #77  <Field Drawable mBackground>
	//    5    9:invokestatic    #245 <Method void ViewCompat.setBackground(android.view.View, Drawable)>
		mTitleView = (TextView)findViewById(android.support.v7.appcompat.R.id.title);
	//    6   12:aload_0         
	//    7   13:aload_0         
	//    8   14:getstatic       #250 <Field int android.support.v7.appcompat.R$id.title>
	//    9   17:invokevirtual   #254 <Method android.view.View findViewById(int)>
	//   10   20:checkcast       #256 <Class TextView>
	//   11   23:putfield        #258 <Field TextView mTitleView>
	...
	//   16   34:aload_0         
	//   17   35:getfield        #258 <Field TextView mTitleView>
	//   18   38:aload_0         
	//   19   39:getfield        #97  <Field Context mTextAppearanceContext>
	//   20   42:aload_0         
	//   21   43:getfield        #86  <Field int mTextAppearance>
	//   22   46:invokevirtual   #262 <Method void TextView.setTextAppearance(Context, int)>
		mShortcutView = (TextView)findViewById(android.support.v7.appcompat.R.id.shortcut);
	//   23   49:aload_0         
	//   24   50:aload_0         
	//   25   51:getstatic       #265 <Field int android.support.v7.appcompat.R$id.shortcut>
	//   26   54:invokevirtual   #254 <Method android.view.View findViewById(int)>
	//   27   57:checkcast       #256 <Class TextView>
	//   28   60:putfield        #267 <Field TextView mShortcutView>
		mSubMenuArrowView = (ImageView)findViewById(android.support.v7.appcompat.R.id.submenuarrow);
	//   29   63:aload_0         
	//   30   64:aload_0         
	//   31   65:getstatic       #270 <Field int android.support.v7.appcompat.R$id.submenuarrow>
	//   32   68:invokevirtual   #254 <Method android.view.View findViewById(int)>
	...
	//   42   92:invokevirtual   #273 <Method void ImageView.setImageDrawable(Drawable)>
	//   43   95:return          
	}
	...
	//    6   14:aload_0         
	//    7   15:invokevirtual   #279 <Method android.view.ViewGroup$LayoutParams getLayoutParams()>
	//    8   18:astore_3        
	...
	//   11   23:invokevirtual   #280 <Method android.view.ViewGroup$LayoutParams ImageView.getLayoutParams()>
	//   12   26:checkcast       #282 <Class android.widget.LinearLayout$LayoutParams>
	//   13   29:astore          4
			if(layoutparams.height > 0 && layoutparams1.width <= 0)
	//*  14   31:aload_3         
	//*  15   32:getfield        #287 <Field int android.view.ViewGroup$LayoutParams.height>
	//*  16   35:ifle            55
	//*  17   38:aload           4
	//*  18   40:getfield        #290 <Field int android.widget.LinearLayout$LayoutParams.width>
	//*  19   43:ifgt            55
				layoutparams1.width = layoutparams.height;
	//   20   46:aload           4
	//   21   48:aload_3         
	//   22   49:getfield        #287 <Field int android.view.ViewGroup$LayoutParams.height>
	//   23   52:putfield        #290 <Field int android.widget.LinearLayout$LayoutParams.width>
		}
		super.onMeasure(i, j);
	//   24   55:aload_0         
	//   25   56:iload_1         
	//   26   57:iload_2         
	//   27   58:invokespecial   #292 <Method void LinearLayout.onMeasure(int, int)>
	//   28   61:return          
	}
	...
	//*  11   23:invokevirtual   #296 <Method boolean MenuItemImpl.isExclusiveCheckable()>
	//*  12   26:ifeq            54
		{
	...
	//*  15   33:ifnonnull       40
				insertRadioButton();
	//   16   36:aload_0         
	//   17   37:invokespecial   #298 <Method void insertRadioButton()>
	...
	//*  27   58:ifnonnull       65
				insertCheckBox();
	//   28   61:aload_0         
	//   29   62:invokespecial   #300 <Method void insertCheckBox()>
	...
	//   41   85:invokevirtual   #303 <Method boolean MenuItemImpl.isChecked()>
	//   42   88:invokevirtual   #308 <Method void CompoundButton.setChecked(boolean)>
			byte byte0;
			if(flag)
	//*  43   91:iload_1         
	//*  44   92:ifeq            100
	...
	//*  50  103:aload_3         
	//*  51  104:invokevirtual   #312 <Method int CompoundButton.getVisibility()>
	//*  52  107:iload_2         
	//*  53  108:icmpeq          116
				((CompoundButton) (obj)).setVisibility(((int) (byte0)));
	//   54  111:aload_3         
	//   55  112:iload_2         
	//   56  113:invokevirtual   #313 <Method void CompoundButton.setVisibility(int)>
			if(obj1 != null && ((CompoundButton) (obj1)).getVisibility() != 8)
	//*  57  116:aload           4
	//*  58  118:ifnull          138
	//*  59  121:aload           4
	//*  60  123:invokevirtual   #312 <Method int CompoundButton.getVisibility()>
	//*  61  126:bipush          8
	//*  62  128:icmpeq          138
				((CompoundButton) (obj1)).setVisibility(8);
	//   63  131:aload           4
	//   64  133:bipush          8
	//   65  135:invokevirtual   #313 <Method void CompoundButton.setVisibility(int)>
			return;
	//   66  138:return          
		}
		if(mCheckBox != null)
	...
	//   72  150:bipush          8
	//   73  152:invokevirtual   #314 <Method void CheckBox.setVisibility(int)>
		if(mRadioButton != null)
	//*  74  155:aload_0         
	...
	//   79  166:bipush          8
	//   80  168:invokevirtual   #315 <Method void RadioButton.setVisibility(int)>
	//   81  171:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #167 <Field MenuItemImpl mItemData>
	//*   2    4:invokevirtual   #296 <Method boolean MenuItemImpl.isExclusiveCheckable()>
	//*   3    7:ifeq            29
		{
			if(mRadioButton == null)
	//*   4   10:aload_0         
	...
	//*   6   14:ifnonnull       21
				insertRadioButton();
	//    7   17:aload_0         
	//    8   18:invokespecial   #298 <Method void insertRadioButton()>
			obj = ((Object) (mRadioButton));
	//    9   21:aload_0         
	...
	//*  15   33:ifnonnull       40
				insertCheckBox();
	//   16   36:aload_0         
	//   17   37:invokespecial   #300 <Method void insertCheckBox()>
			obj = ((Object) (mCheckBox));
	//   18   40:aload_0         
	...
	//   21   45:aload_2         
	//   22   46:iload_1         
	//   23   47:invokevirtual   #308 <Method void CompoundButton.setChecked(boolean)>
	//   24   50:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #318 <Field boolean mForceShowIcon>
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #167 <Field MenuItemImpl mItemData>
	//*   2    4:invokevirtual   #321 <Method boolean MenuItemImpl.shouldShowIcon()>
	//*   3    7:ifne            17
	//*   4   10:aload_0         
	//*   5   11:getfield        #318 <Field boolean mForceShowIcon>
	//*   6   14:ifeq            22
			flag = true;
	//    7   17:iconst_1        
	//    8   18:istore_2        
	...
	//*  13   25:ifne            36
	//*  14   28:aload_0         
	//*  15   29:getfield        #95  <Field boolean mPreserveIconSpacing>
	//*  16   32:ifne            36
			return;
	//   17   35:return          
	...
	//   26   54:return          
		if(mIconView == null)
	//*  27   55:aload_0         
	//*  28   56:getfield        #144 <Field ImageView mIconView>
	//*  29   59:ifnonnull       66
			insertIconView();
	//   30   62:aload_0         
	//   31   63:invokespecial   #323 <Method void insertIconView()>
		if(drawable != null || mPreserveIconSpacing)
	//*  32   66:aload_1         
	//*  33   67:ifnonnull       77
	//*  34   70:aload_0         
	//*  35   71:getfield        #95  <Field boolean mPreserveIconSpacing>
	//*  36   74:ifeq            115
		{
			ImageView imageview = mIconView;
	//   37   77:aload_0         
	//   38   78:getfield        #144 <Field ImageView mIconView>
	//   39   81:astore_3        
			if(!flag)
	//*  40   82:iload_2         
	//*  41   83:ifeq            89
	...
	//   45   91:aload_3         
	//   46   92:aload_1         
	//   47   93:invokevirtual   #273 <Method void ImageView.setImageDrawable(Drawable)>
			if(mIconView.getVisibility() != 0)
	//*  48   96:aload_0         
	//*  49   97:getfield        #144 <Field ImageView mIconView>
	//*  50  100:invokevirtual   #324 <Method int ImageView.getVisibility()>
	//*  51  103:ifeq            124
			{
				mIconView.setVisibility(0);
	//   52  106:aload_0         
	//   53  107:getfield        #144 <Field ImageView mIconView>
	//   54  110:iconst_0        
	//   55  111:invokevirtual   #163 <Method void ImageView.setVisibility(int)>
				return;
	//   56  114:return          
			}
		} else
	...
	//   57  115:aload_0         
	//   58  116:getfield        #144 <Field ImageView mIconView>
	//   59  119:bipush          8
	//   60  121:invokevirtual   #163 <Method void ImageView.setVisibility(int)>
		}
	//   61  124:return          
	}
	...
	//   13   26:aload_0         
	//   14   27:getfield        #267 <Field TextView mShortcutView>
	//   15   30:aload_0         
	//   16   31:getfield        #167 <Field MenuItemImpl mItemData>
	//   17   34:invokevirtual   #328 <Method String MenuItemImpl.getShortcutLabel()>
	//   18   37:invokevirtual   #331 <Method void TextView.setText(CharSequence)>
		if(mShortcutView.getVisibility() != c)
	//*  19   40:aload_0         
	//*  20   41:getfield        #267 <Field TextView mShortcutView>
	//*  21   44:invokevirtual   #332 <Method int TextView.getVisibility()>
	//*  22   47:iload_2         
	//*  23   48:icmpeq          59
			mShortcutView.setVisibility(((int) (c)));
	//   24   51:aload_0         
	//   25   52:getfield        #267 <Field TextView mShortcutView>
	//   26   55:iload_2         
	//   27   56:invokevirtual   #333 <Method void TextView.setVisibility(int)>
	//   28   59:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:getfield        #258 <Field TextView mTitleView>
	//    4    8:aload_1         
	//    5    9:invokevirtual   #331 <Method void TextView.setText(CharSequence)>
			if(mTitleView.getVisibility() != 0)
	//*   6   12:aload_0         
	//*   7   13:getfield        #258 <Field TextView mTitleView>
	//*   8   16:invokevirtual   #332 <Method int TextView.getVisibility()>
	//*   9   19:ifeq            52
			{
				mTitleView.setVisibility(0);
	//   10   22:aload_0         
	//   11   23:getfield        #258 <Field TextView mTitleView>
	//   12   26:iconst_0        
	//   13   27:invokevirtual   #333 <Method void TextView.setVisibility(int)>
				return;
	//   14   30:return          
			}
		} else
	...
	//*  15   31:aload_0         
	//*  16   32:getfield        #258 <Field TextView mTitleView>
	//*  17   35:invokevirtual   #332 <Method int TextView.getVisibility()>
	//*  18   38:bipush          8
	//*  19   40:icmpeq          52
			mTitleView.setVisibility(8);
	//   20   43:aload_0         
	//   21   44:getfield        #258 <Field TextView mTitleView>
	//   22   47:bipush          8
	//   23   49:invokevirtual   #333 <Method void TextView.setVisibility(int)>
	//   24   52:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #318 <Field boolean mForceShowIcon>
	//    2    4:ireturn         
	}
