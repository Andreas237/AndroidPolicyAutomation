...
static class NotificationCompat$LollipopExtender extends android.support.v4.app.NotificationCompat.BuilderExtender
{
	...
	{
		android.widget.RemoteViews remoteviews = NotificationCompat.access$600(notificationbuilderwithbuilderaccessor, builder);
	//    0    0:aload_2         
	//    1    1:aload_1         
	//    2    2:invokestatic    #18  <Method android.widget.RemoteViews NotificationCompat.access$600(NotificationBuilderWithBuilderAccessor, android.support.v4.app.NotificationCompat$Builder)>
	//    3    5:astore_3        
	...
	//   11   19:putfield        #29  <Field android.widget.RemoteViews Notification.contentView>
		NotificationCompat.access$700(((Notification) (notificationbuilderwithbuilderaccessor)), builder);
	//   12   22:aload_2         
	//   13   23:aload_1         
	//   14   24:invokestatic    #33  <Method void NotificationCompat.access$700(Notification, android.support.v4.app.NotificationCompat$Builder)>
		NotificationCompat.access$800(((Notification) (notificationbuilderwithbuilderaccessor)), builder);
	//   15   27:aload_2         
	//   16   28:aload_1         
