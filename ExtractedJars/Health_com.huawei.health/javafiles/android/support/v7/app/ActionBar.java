...
public abstract class ActionBar
{
	...
	//    4    6:new             #122 <Class UnsupportedOperationException>
	//    5    9:dup             
	//    6   10:ldc1            #124 <String "Setting a non-zero elevation is not supported in this action bar configuration.">
	//    7   12:invokespecial   #127 <Method void UnsupportedOperationException(String)>
	//    8   15:athrow          
		else
			return;
	//    9   16:return          
	...
	//    2    4:new             #122 <Class UnsupportedOperationException>
	//    3    7:dup             
	//    4    8:ldc1            #130 <String "Setting an explicit action bar hide offset is not supported in this action bar configuration.">
	//    5   10:invokespecial   #127 <Method void UnsupportedOperationException(String)>
	//    6   13:athrow          
		else
			return;
	//    7   14:return          
	...
	//    2    4:new             #122 <Class UnsupportedOperationException>
	//    3    7:dup             
	//    4    8:ldc1            #133 <String "Hide on content scroll is not supported in this action bar configuration.">
	//    5   10:invokespecial   #127 <Method void UnsupportedOperationException(String)>
	//    6   13:athrow          
		else
			return;
