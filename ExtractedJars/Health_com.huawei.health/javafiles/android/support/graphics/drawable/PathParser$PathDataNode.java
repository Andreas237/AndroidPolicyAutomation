...
public static class PathParser$PathDataNode
{
	...
	//  608 1477:fstore          6
				...
				path.rCubicTo(f1, f3, af1[c + 0], af1[c + 1], af1[c + 2], af1[c + 3]);
	//  609 1479:aload_0         
	//  610 1480:fload           5
	//  611 1482:fload           6
	//  612 1484:aload           4
	...
	//  697 1618:fstore          5
				...
				path.cubicTo(f3, f1, af1[c + 0], af1[c + 1], af1[c + 2], af1[c + 3]);
	//  698 1620:aload_0         
	//  699 1621:fload           6
	//  700 1623:fload           5
	//  701 1625:aload           4
	...
	//  884 1895:fstore          5
				...
				path.rQuadTo(f3, f1, af1[c + 0], af1[c + 1]);
	//  885 1897:aload_0         
	//  886 1898:fload           6
	//  887 1900:fload           5
	//  888 1902:aload           4
	...
	//  955 2016:fstore          5
				...
				path.quadTo(f3, f1, af1[c + 0], af1[c + 1]);
	//  956 2018:aload_0         
	//  957 2019:fload           6
	//  958 2021:fload           5
	//  959 2023:aload           4
	...
	//  139  244:dstore          35
			d8 = (Math.sin(d16 - d8) * (Math.sqrt(3D * d20 * d20 + 4D) - 1.0D)) / 3D;
	//  140  246:dload           27
	//  141  248:dload           17
	//  142  250:dsub            
	...
	//  156  276:ddiv            
	//  157  277:dstore          17
			path.rCubicTo((float)(d6 + d8 * d4) - (float)d6, (float)(d7 + d8 * d5) - (float)d7, (float)(d15 - d8 * d10) - (float)d6, (float)(d12 - d8 * d14) - (float)d7, (float)d15 - (float)d6, (float)d12 - (float)d7);
	//  158  279:aload_0         
	//  159  280:dload           13
	//  160  282:dload           17
	//  161  284:dload           9
	...
	//*  10   14:icmpge          50
		{
			addCommand(path, af, c, apathparser$pathdatanode[i].type, apathparser$pathdatanode[i].params);
	//   11   17:aload_1         
	//   12   18:aload           4
	//   13   20:iload_2         
	//   14   21:aload_0         
	...
	//   22   33:invokestatic    #140 <Method void addCommand(Path, float[], char, char, float[])>
			c = apathparser$pathdatanode[i].type;
	//   23   36:aload_0         
	//   24   37:iload_3         
	//   25   38:aaload          
	...
	{
		for(int i = 0; i < pathparser$pathdatanode.params.length; i++)
	//*   0    0:iconst_0        
	//*   1    1:istore          4
	//*   2    3:iload           4
	//*   3    5:aload_1         
	...
	//*   5    9:arraylength     
	//*   6   10:icmpge          50
			params[i] = pathparser$pathdatanode.params[i] * (1.0F - f) + pathparser$pathdatanode1.params[i] * f;
	//    7   13:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void Object()>
		type = pathparser$pathdatanode.type;
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:getfield        #18  <Field char type>
	//    5    9:putfield        #18  <Field char type>
		params = PathParser.a(pathparser$pathdatanode.params, 0, pathparser$pathdatanode.params.length);
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:getfield        #20  <Field float[] params>
	//    9   17:iconst_0        
