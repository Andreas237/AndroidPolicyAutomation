	...
	extends IInterface
{
		...
		implements IPackageInstallObserver
	{
		...
		//   10   17:invokeinterface #46  <Method IInterface IBinder.queryLocalInterface(String)>
		//   11   22:astore_1        
		...
		//    5   11:pop             
			attachInterface(((IInterface) (this)), "android.content.pm.IPackageInstallObserver");
		//    6   12:aload_0         
		//    7   13:aload_0         
		//    8   14:ldc1            #14  <String "android.content.pm.IPackageInstallObserver">
		//    9   16:invokevirtual   #35  <Method void attachInterface(IInterface, String)>
		//   10   19:return          
		}
	}

	static class Stub.MyProxy
		implements IPackageInstallObserver
	{
