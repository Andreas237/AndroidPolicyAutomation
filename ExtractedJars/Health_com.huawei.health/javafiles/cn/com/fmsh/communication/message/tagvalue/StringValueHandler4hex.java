	...
	implements StringValueHandler
{
	...
	//    8   12:aload_1         
	//    9   13:invokestatic    #18  <Method String FM_Bytes.bytesToHexString(byte[])>
	//   10   16:areturn         
	}
	...
	//    3    5:areturn         
			...
			return FM_Bytes.hexStringToBytes(s);
	//    4    6:aload_1         
	//    5    7:invokestatic    #23  <Method byte[] FM_Bytes.hexStringToBytes(String)>
	//    6   10:areturn         
	}
}
