...
{
	public static final class OpenSessionExceptionType extends Enum
	{

		public static OpenSessionExceptionType instance(int i)
		{
			OpenSessionExceptionType aopensessionexceptiontype[] = values();
		//    0    0:invokestatic    #91  <Method OpenSessionException$OpenSessionExceptionType[] values()>
		//    1    3:astore_3        
			int k = aopensessionexceptiontype.length;
		//    2    4:aload_3         
		//    3    5:arraylength     
		//    4    6:istore_2        
			for(int j = 0; j < k; j++)
		...
		//*   7    9:goto            33
			{
				OpenSessionExceptionType opensessionexceptiontype = aopensessionexceptiontype[j];
		//    8   12:aload_3         
		//    9   13:iload_1         
		//   10   14:aaload          
		//   11   15:astore          4
		...
		public static OpenSessionExceptionType valueOf(String s)
		{
			return (OpenSessionExceptionType)Enum.valueOf(cn/com/fmsh/communication/exception/session/OpenSessionException$OpenSessionExceptionType, s);
		...
		public static OpenSessionExceptionType[] values()
		{
			OpenSessionExceptionType aopensessionexceptiontype[] = ENUM$VALUES;
		//    0    0:getstatic       #77  <Field OpenSessionException$OpenSessionExceptionType[] ENUM$VALUES>
		//    1    3:astore_1        
			int i = aopensessionexceptiontype.length;
		//    2    4:aload_1         
		//    3    5:arraylength     
		//    4    6:istore_0        
			OpenSessionExceptionType aopensessionexceptiontype1[] = new OpenSessionExceptionType[i];
		//    5    7:iload_0         
		//    6    8:anewarray       OpenSessionExceptionType[]
		//    7   11:astore_2        
			System.arraycopy(((Object) (aopensessionexceptiontype)), 0, ((Object) (aopensessionexceptiontype1)), 0, i);
		//    8   12:aload_1         
		//    9   13:iconst_0        
		//   10   14:aload_2         
		//   11   15:iconst_0        
		...
		//   13   17:invokestatic    #106 <Method void System.arraycopy(Object, int, Object, int, int)>
			return aopensessionexceptiontype1;
		//   14   20:aload_2         
		//   15   21:areturn         
		}
		...
		public static final OpenSessionExceptionType DATA_FORMAT_ERROR;
		public static final OpenSessionExceptionType DECRYPT_FAIL;
		private static final OpenSessionExceptionType ENUM$VALUES[];
		public static final OpenSessionExceptionType INVALID_KEY_INDEX;
		public static final OpenSessionExceptionType INVALID_TERMINAL;
		public static final OpenSessionExceptionType INVALID_TERMINAL_ID;
		public static final OpenSessionExceptionType INVALID_TIME;
		public static final OpenSessionExceptionType SECURITY_CODE;
		public static final OpenSessionExceptionType SYSTEM_BUSY;
		public static final OpenSessionExceptionType UNKNOW;
		private String description;
		private byte value;

		static 
		{
			SYSTEM_BUSY = new OpenSessionExceptionType("SYSTEM_BUSY", 0, (byte)-128, "\u7CFB\u7EDF\u5FD9\uFF0C\u6682\u505C\u63A5\u5165\u670D\u52A1");
		...
		//    7   14:putstatic       #35  <Field OpenSessionException$OpenSessionExceptionType SYSTEM_BUSY>
			INVALID_TERMINAL = new OpenSessionExceptionType("INVALID_TERMINAL", 1, (byte)-127, "\u65E0\u6548\u7EC8\u7AEF\u7C7B\u578B");
		...
		//   15   31:putstatic       #40  <Field OpenSessionException$OpenSessionExceptionType INVALID_TERMINAL>
			INVALID_KEY_INDEX = new OpenSessionExceptionType("INVALID_KEY_INDEX", 2, (byte)-126, "\u7B7E\u5230\u4F7F\u7528\u5BC6\u94A5\u7D22\u5F15\u65E0\u6548");
		...
		//   23   48:putstatic       #45  <Field OpenSessionException$OpenSessionExceptionType INVALID_KEY_INDEX>
			DECRYPT_FAIL = new OpenSessionExceptionType("DECRYPT_FAIL", 3, (byte)-125, "\u7B7E\u5230\u8BF7\u6C42\u6570\u636E\u89E3\u5BC6\u5931\u8D25");
		...
		//   31   65:putstatic       #50  <Field OpenSessionException$OpenSessionExceptionType DECRYPT_FAIL>
			DATA_FORMAT_ERROR = new OpenSessionExceptionType("DATA_FORMAT_ERROR", 4, (byte)-124, "\u7B7E\u5230\u8BF7\u6C42\u6570\u636E\u683C\u5F0F\u9519\u8BEF");
		...
		//   39   82:putstatic       #55  <Field OpenSessionException$OpenSessionExceptionType DATA_FORMAT_ERROR>
			INVALID_TERMINAL_ID = new OpenSessionExceptionType("INVALID_TERMINAL_ID", 5, (byte)-123, "\u65E0\u6548\u7EC8\u7AEF\u7F16\u53F7");
		...
		//   47   99:putstatic       #60  <Field OpenSessionException$OpenSessionExceptionType INVALID_TERMINAL_ID>
			SECURITY_CODE = new OpenSessionExceptionType("SECURITY_CODE", 6, (byte)-122, "\u9632\u4F2A\u7801\u9A8C\u8BC1\u5931\u8D25");
		...
		//   55  117:putstatic       #65  <Field OpenSessionException$OpenSessionExceptionType SECURITY_CODE>
			INVALID_TIME = new OpenSessionExceptionType("INVALID_TIME", 7, (byte)-121, "\u7EC8\u7AEF\u65F6\u95F4\u5F02\u5E38");
		...
		//   63  135:putstatic       #70  <Field OpenSessionException$OpenSessionExceptionType INVALID_TIME>
			UNKNOW = new OpenSessionExceptionType("UNKNOW", 8, (byte)-1, "\u672A\u77E5\u9519\u8BEF");
		...
		//   71  152:putstatic       #75  <Field OpenSessionException$OpenSessionExceptionType UNKNOW>
			ENUM$VALUES = (new OpenSessionExceptionType[] {
		...
		//   72  155:bipush          9
		//   73  157:anewarray       OpenSessionExceptionType[]
		//   74  160:dup             
		//   75  161:iconst_0        
		...
		private OpenSessionExceptionType(String s, int i, byte byte0, String s1)
		{
			super(s, i);
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	public OpenSessionException(String s)
	{
		super(s);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #17  <Method void FM_Exception(String)>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #22  <Field OpenSessionException$OpenSessionExceptionType exceptionType>
	//    2    4:areturn         
	}

	public void setExceptionType(OpenSessionExceptionType opensessionexceptiontype)
	{
		exceptionType = opensessionexceptiontype;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #22  <Field OpenSessionException$OpenSessionExceptionType exceptionType>
	//    3    5:return          
	}
