...
{
	public static final class ScriptHandleExceptionType extends Enum
	{

		public static ScriptHandleExceptionType valueOf(String s)
		{
			return (ScriptHandleExceptionType)Enum.valueOf(cn/com/fmsh/script/exception/FMScriptHandleException$ScriptHandleExceptionType, s);
		...
		public static ScriptHandleExceptionType[] values()
		{
			ScriptHandleExceptionType ascripthandleexceptiontype[] = ENUM$VALUES;
		//    0    0:getstatic       #53  <Field FMScriptHandleException$ScriptHandleExceptionType[] ENUM$VALUES>
		//    1    3:astore_1        
			int i = ascripthandleexceptiontype.length;
		//    2    4:aload_1         
		//    3    5:arraylength     
		//    4    6:istore_0        
			ScriptHandleExceptionType ascripthandleexceptiontype1[] = new ScriptHandleExceptionType[i];
		//    5    7:iload_0         
		//    6    8:anewarray       ScriptHandleExceptionType[]
		//    7   11:astore_2        
			System.arraycopy(((Object) (ascripthandleexceptiontype)), 0, ((Object) (ascripthandleexceptiontype1)), 0, i);
		//    8   12:aload_1         
		//    9   13:iconst_0        
		//   10   14:aload_2         
		//   11   15:iconst_0        
		...
		//   13   17:invokestatic    #74  <Method void System.arraycopy(Object, int, Object, int, int)>
			return ascripthandleexceptiontype1;
		//   14   20:aload_2         
		//   15   21:areturn         
		}
		...
		private static final ScriptHandleExceptionType ENUM$VALUES[];
		public static final ScriptHandleExceptionType INVALID_FIRST_ID;
		public static final ScriptHandleExceptionType INVALID_NEXT;
		public static final ScriptHandleExceptionType OPENMOBILE_TRANSMIT_EXCEPTION;
		public static final ScriptHandleExceptionType STOPED;
		public static final ScriptHandleExceptionType UNKNOW;
		private String description;
		private byte value;

		static 
		{
			STOPED = new ScriptHandleExceptionType("STOPED", 0, (byte)1, "\u5F53\u524D\u64CD\u4F5C\u88AB\u505C\u6B62");
		...
		//    7   13:putstatic       #31  <Field FMScriptHandleException$ScriptHandleExceptionType STOPED>
			INVALID_FIRST_ID = new ScriptHandleExceptionType("INVALID_FIRST_ID", 1, (byte)2, "\u7B2C\u4E00\u6761\u6307\u4EE4\u65E0\u6548");
		...
		//   15   29:putstatic       #36  <Field FMScriptHandleException$ScriptHandleExceptionType INVALID_FIRST_ID>
			INVALID_NEXT = new ScriptHandleExceptionType("INVALID_NEXT", 2, (byte)3, "\u4E0B\u6761\u6307\u4EE4\u5E8F\u53F7\u5927\u4E8E\u5F53\u524D\u5E8F\u53F7");
		...
		//   23   45:putstatic       #41  <Field FMScriptHandleException$ScriptHandleExceptionType INVALID_NEXT>
			OPENMOBILE_TRANSMIT_EXCEPTION = new ScriptHandleExceptionType("OPENMOBILE_TRANSMIT_EXCEPTION", 3, (byte)4, "open mobile \u4EA4\u4E92\u5F02\u5E38");
		...
		//   31   61:putstatic       #46  <Field FMScriptHandleException$ScriptHandleExceptionType OPENMOBILE_TRANSMIT_EXCEPTION>
			UNKNOW = new ScriptHandleExceptionType("UNKNOW", 4, (byte)-1, "\u672A\u77E5\u9519\u8BEF");
		...
		//   39   77:putstatic       #51  <Field FMScriptHandleException$ScriptHandleExceptionType UNKNOW>
			ENUM$VALUES = (new ScriptHandleExceptionType[] {
				STOPED, INVALID_FIRST_ID, INVALID_NEXT, OPENMOBILE_TRANSMIT_EXCEPTION, UNKNOW
			});
		//   40   80:iconst_5        
		//   41   81:anewarray       ScriptHandleExceptionType[]
		//   42   84:dup             
		//   43   85:iconst_0        
		...
		private ScriptHandleExceptionType(String s, int i, byte byte0, String s1)
		{
			super(s, i);
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	public FMScriptHandleException(String s)
	{
		super(s);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public ScriptHandleExceptionType getType()
	{
		return type;
	//    0    0:aload_0         
	//    1    1:getfield        #22  <Field FMScriptHandleException$ScriptHandleExceptionType type>
	//    2    4:areturn         
	}

	public void setType(ScriptHandleExceptionType scripthandleexceptiontype)
	{
		type = scripthandleexceptiontype;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #22  <Field FMScriptHandleException$ScriptHandleExceptionType type>
	//    3    5:return          
	}

	private static final long serialVersionUID = 0x551cb82fL;
