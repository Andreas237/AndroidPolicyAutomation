...
{
	public static final class ErrorMessage extends Enum
	{

		public static ErrorMessage instance(String s)
		{
			ErrorMessage aerrormessage[] = values();
		//    0    0:invokestatic    #1189 <Method BusinessException$ErrorMessage[] values()>
		//    1    3:astore_3        
			int j = aerrormessage.length;
		//    2    4:aload_3         
		//    3    5:arraylength     
		//    4    6:istore_2        
			for(int i = 0; i < j; i++)
		...
		//*   7    9:goto            36
			{
				ErrorMessage errormessage = aerrormessage[i];
		//    8   12:aload_3         
		//    9   13:iload_1         
		//   10   14:aaload          
		//   11   15:astore          4
				if(errormessage.getId().equals(((Object) (s))))
		//*  12   17:aload           4
		...
		{
			return (ErrorMessage)Enum.valueOf(cn/com/fmsh/tsm/business/exception/BusinessException$ErrorMessage, s);
		...
		{
			ErrorMessage aerrormessage[] = ENUM$VALUES;
		//    0    0:getstatic       #1173 <Field BusinessException$ErrorMessage[] ENUM$VALUES>
		//    1    3:astore_1        
			int i = aerrormessage.length;
		//    2    4:aload_1         
		//    3    5:arraylength     
		//    4    6:istore_0        
			ErrorMessage aerrormessage1[] = new ErrorMessage[i];
		//    5    7:iload_0         
		//    6    8:anewarray       ErrorMessage[]
		//    7   11:astore_2        
			System.arraycopy(((Object) (aerrormessage)), 0, ((Object) (aerrormessage1)), 0, i);
		//    8   12:aload_1         
		//    9   13:iconst_0        
		//   10   14:aload_2         
		//   11   15:iconst_0        
		...
		private static final ErrorMessage ENUM$VALUES[];
		...
		public static final ErrorMessage amount_invalid;
		public static final ErrorMessage apdu_exec_fail;
		public static final ErrorMessage apdu_result_ffff;
		public static final ErrorMessage app_issuer_fail;
		public static final ErrorMessage app_move_code_invalid;
		...
		public static final ErrorMessage move_user_no_issure;
		public static final ErrorMessage no_activity;
		public static final ErrorMessage no_stock;
		...
		public static final ErrorMessage order_amount_low;
		public static final ErrorMessage order_apply_frequent;
		public static final ErrorMessage pasm_overrun;
		...
		public static final ErrorMessage third_seq_repeat;
		...
		static 
		{
			local_business_cancel = new ErrorMessage("local_business_cancel", 0, "9001", ErrorType.local, "\u4E1A\u52A1\u5904\u7406\u8FC7\u7A0B\u4E2D\uFF0C\u63A5\u6536\u5230\u53D6\u6D88\u6307\u4EE4");
		...
		//    8   17:putstatic       #178 <Field BusinessException$ErrorMessage local_business_cancel>
			local_business_apdu_handler_null = new ErrorMessage("local_business_apdu_handler_null", 1, "9002", ErrorType.local, "APDU\u6307\u4EE4\u5904\u7406\u5668\u672A\u6CE8\u518C");
		...
		//   17   37:putstatic       #185 <Field BusinessException$ErrorMessage local_business_apdu_handler_null>
			local_business_execute_fail = new ErrorMessage("local_business_execute_fail", 2, "9003", ErrorType.local, "APDU\u6307\u4EE4\u5904\u7406\u5668\u5904\u7406APDU\u8BF7\u6C42\u5931\u8D25");
		...
		//   26   57:putstatic       #192 <Field BusinessException$ErrorMessage local_business_execute_fail>
			local_business_init_fail = new ErrorMessage("local_business_init_fail", 3, "9004", ErrorType.local, "\u4E1A\u52A1\u5904\u7406\u5668\u521D\u59CB\u5316\u5931\u8D25");
		...
		//   35   77:putstatic       #199 <Field BusinessException$ErrorMessage local_business_init_fail>
			local_business_no_card_app_type = new ErrorMessage("local_business_no_card_app_type", 4, "9005", ErrorType.local, "\u6CA1\u6709\u5BF9\u5E94\u7C7B\u578B\u7684\u5361");
		...
		//   44   97:putstatic       #206 <Field BusinessException$ErrorMessage local_business_no_card_app_type>
			local_business_apdu_handler_busying = new ErrorMessage("local_business_apdu_handler_busying", 5, "9006", ErrorType.local, "APDU\u6307\u4EE4\u5904\u7406\u5668\u6B63\u5FD9");
		...
		//   53  117:putstatic       #213 <Field BusinessException$ErrorMessage local_business_apdu_handler_busying>
			local_message_platform_business_handle_fail = new ErrorMessage("local_message_platform_business_handle_fail", 6, "9007", ErrorType.local, "\u5E73\u53F0\u5904\u7406\u4E1A\u52A1\u5931\u8D25");
		...
		//   62  138:putstatic       #220 <Field BusinessException$ErrorMessage local_message_platform_business_handle_fail>
			local_business_local_data_handler_null = new ErrorMessage("local_business_local_data_handler_null", 7, "9008", ErrorType.local, "\u672C\u5730\u6570\u636E\u5904\u7406\u5668\u4E3A\u7A7A");
		...
		//   71  159:putstatic       #227 <Field BusinessException$ErrorMessage local_business_local_data_handler_null>
			local_business_para_error = new ErrorMessage("local_business_para_error", 8, "9009", ErrorType.local, "\u51FD\u6570\u8C03\u7528\u65F6\uFF0C\u53C2\u6570\u5F02\u5E38");
		...
		//   80  180:putstatic       #234 <Field BusinessException$ErrorMessage local_business_para_error>
			local_communication_connect_fail = new ErrorMessage("local_communication_connect_fail", 9, "9010", ErrorType.local, "\u7EC8\u7AEF\u548C\u5E73\u53F0\u7684\u94FE\u63A5\u5931\u8D25");
		...
		//   89  201:putstatic       #241 <Field BusinessException$ErrorMessage local_communication_connect_fail>
			local_communication_connect_param_error = new ErrorMessage("local_communication_connect_param_error", 10, "9011", ErrorType.local, "\u7EC8\u7AEF\u5411\u5E73\u53F0\u94FE\u63A5\u8BF7\u6C42\u65F6\uFF0C\u4F20\u5165\u7684\u5E73\u53F0\u94FE\u63A5\u4FE1\u606F\u65E0\u6548");
		...
		//   98  222:putstatic       #248 <Field BusinessException$ErrorMessage local_communication_connect_param_error>
			local_communication_disconnect_fail = new ErrorMessage("local_communication_disconnect_fail", 11, "9012", ErrorType.local, "\u7EC8\u7AEF\u5173\u95ED\u5230\u7EC8\u7AEF\u7684\u94FE\u63A5\u51FA\u73B0\u5F02\u5E38");
		...
		//  107  243:putstatic       #255 <Field BusinessException$ErrorMessage local_communication_disconnect_fail>
			local_communication_sign_in_fail = new ErrorMessage("local_communication_sign_in_fail", 12, "9013", ErrorType.local, "\u7EC8\u7AEF\u7B7E\u5230\u5931\u8D25");
		...
		//  116  267:putstatic       #262 <Field BusinessException$ErrorMessage local_communication_sign_in_fail>
			local_communication_request_param_error = new ErrorMessage("local_communication_request_param_error", 13, "9014", ErrorType.local, "\u7EC8\u7AEF\u5411\u5E73\u53F0\u4E1A\u52A1\u8BF7\u6C42\u65F6\uFF0C\u7EC8\u7AEF\u6307\u4EE4\u65E0\u6548");
		...
		//  125  291:putstatic       #269 <Field BusinessException$ErrorMessage local_communication_request_param_error>
			local_communication_no_response = new ErrorMessage("local_communication_no_response", 14, "9017", ErrorType.local, "\u7EC8\u7AEF\u672A\u6536\u5230\u5E73\u53F0\u7684\u5E94\u7B54\u6570\u636E");
		...
		//  134  315:putstatic       #276 <Field BusinessException$ErrorMessage local_communication_no_response>
			local_communication_invalid_version = new ErrorMessage("local_communication_invalid_version", 15, "9018", ErrorType.local, "\u7EC8\u7AEF\u901A\u4FE1\u5305\u7684\u7248\u672C\u65E0\u6548");
		...
		//  143  339:putstatic       #283 <Field BusinessException$ErrorMessage local_communication_invalid_version>
			local_communication_invalid_format = new ErrorMessage("local_communication_invalid_format", 16, "9019", ErrorType.local, "\u7EC8\u7AEF\u8BF7\u6C42\u6570\u636E\u683C\u5F0F\u65E0\u6548");
		...
		//  152  363:putstatic       #290 <Field BusinessException$ErrorMessage local_communication_invalid_format>
			local_communication_invalid_verify = new ErrorMessage("local_communication_invalid_verify", 17, "9020", ErrorType.local, "\u62A5\u6587\u68C0\u9A8C\u5931\u8D25");
		...
		//  161  387:putstatic       #297 <Field BusinessException$ErrorMessage local_communication_invalid_verify>
			local_communication_invalid_control = new ErrorMessage("local_communication_invalid_control", 18, "9021", ErrorType.local, "\u65E0\u6548\u7684\u62A5\u6587\u63A7\u5236\u5B57");
		...
		//  170  411:putstatic       #304 <Field BusinessException$ErrorMessage local_communication_invalid_control>
			local_communication_invalid_session = new ErrorMessage("local_communication_invalid_session", 19, "9022", ErrorType.local, "\u65E0\u6548\u7684\u4F1A\u8BDD");
		...
		//  179  435:putstatic       #311 <Field BusinessException$ErrorMessage local_communication_invalid_session>
			local_communication_invalid_session_serial = new ErrorMessage("local_communication_invalid_session_serial", 20, "9023", ErrorType.local, "\u4F1A\u8BDD\u6D41\u6C34\u9519\u8BEF");
		...
		//  188  459:putstatic       #318 <Field BusinessException$ErrorMessage local_communication_invalid_session_serial>
			local_communication_invalid_direction = new ErrorMessage("local_communication_invalid_direction", 21, "9024", ErrorType.local, "\u4F1A\u8BDD\u6D41\u6C34\u9519\u8BEF");
		...
		//  197  483:putstatic       #323 <Field BusinessException$ErrorMessage local_communication_invalid_direction>
			local_communication_invalid_response = new ErrorMessage("local_communication_invalid_response", 22, "9025", ErrorType.local, "\u901A\u8BAF\u5E94\u7B54\u6570\u636E\u65E0\u6548");
		...
		//  206  507:putstatic       #330 <Field BusinessException$ErrorMessage local_communication_invalid_response>
			local_communication_no_key = new ErrorMessage("local_communication_no_key", 23, "9027", ErrorType.local, "\u901A\u4FE1\u65F6\uFF0C\u672A\u627E\u4E0D\u5230\u901A\u4FE1\u516C\u94A5");
		...
		//  215  531:putstatic       #337 <Field BusinessException$ErrorMessage local_communication_no_key>
			local_communication_sign_out_fail = new ErrorMessage("local_communication_sign_out_fail", 24, "9028", ErrorType.local, "\u7B7E\u9000\u5931\u8D25");
		...
		//  224  555:putstatic       #344 <Field BusinessException$ErrorMessage local_communication_sign_out_fail>
			local_communication_register_notify_exception = new ErrorMessage("local_communication_register_notify_exception", 25, "9030", ErrorType.local, "\u901A\u4FE1\u6D88\u606F\u5904\u7406\u5668\u6CE8\u518C\u5F02\u5E38");
		...
		//  233  579:putstatic       #351 <Field BusinessException$ErrorMessage local_communication_register_notify_exception>
			local_message_load_config_fail = new ErrorMessage("local_message_load_config_fail", 26, "9050", ErrorType.local, "\u52A0\u8F7DMessage\u914D\u7F6E\u6587\u4EF6\u5931\u8D25");
		...
		//  242  603:putstatic       #358 <Field BusinessException$ErrorMessage local_message_load_config_fail>
			local_message_command_data_invaild = new ErrorMessage("local_message_command_data_invaild", 27, "9051", ErrorType.local, "\u65E0\u6548\u7684\u5E73\u53F0\u54CD\u5E94\u6570\u636E");
		...
		//  251  627:putstatic       #365 <Field BusinessException$ErrorMessage local_message_command_data_invaild>
			local_message_apdu_execute_exception = new ErrorMessage("local_message_apdu_execute_exception", 28, "9053", ErrorType.local, "APDU\u6307\u4EE4\u6267\u884C\u5F02\u5E38");
		...
		//  260  651:putstatic       #372 <Field BusinessException$ErrorMessage local_message_apdu_execute_exception>
			local_message_message_handle_exception = new ErrorMessage("local_message_message_handle_exception", 29, "9054", ErrorType.local, "Message\u5904\u7406\u51FA\u73B0\u5F02\u5E38");
		...
		//  269  675:putstatic       #379 <Field BusinessException$ErrorMessage local_message_message_handle_exception>
			local_message_open_mobile_exception = new ErrorMessage("local_message_open_mobile_exception", 30, "9055", ErrorType.local, "Open mobile\u51FA\u73B0\u5F02\u5E38");
		...
		//  278  699:putstatic       #386 <Field BusinessException$ErrorMessage local_message_open_mobile_exception>
			local_get_app_info_fail = new ErrorMessage("local_get_app_info_fail", 31, "9080", ErrorType.local, "\u83B7\u53D6\u5361\u4E0A\u5E94\u7528\u4FE1\u606F\u5931\u8D25");
		...
		//  287  723:putstatic       #393 <Field BusinessException$ErrorMessage local_get_app_info_fail>
			local_apdu_reponse_invalid = new ErrorMessage("local_apdu_reponse_invalid", 32, "9081", ErrorType.local, "apdu\u6307\u4EE4\u7684\u54CD\u5E94\u65E0\u6548");
		...
		//  296  747:putstatic       #400 <Field BusinessException$ErrorMessage local_apdu_reponse_invalid>
			local_get_app_info_no_sptcc = new ErrorMessage("local_get_app_info_no_sptcc", 33, "9082", ErrorType.local, "\u4E0D\u662F\u4E0A\u6D77\u4EA4\u901A\u5361");
		...
		//  305  771:putstatic       #407 <Field BusinessException$ErrorMessage local_get_app_info_no_sptcc>
			local_app_load_config_fail = new ErrorMessage("local_app_load_config_fail", 34, "9070", ErrorType.local, "\u4E1A\u52A1\u914D\u7F6E\u6587\u4EF6\u52A0\u8F7D\u5931\u8D25");
		...
		//  314  795:putstatic       #414 <Field BusinessException$ErrorMessage local_app_load_config_fail>
			local_app_config_invaild_content = new ErrorMessage("local_app_config_invaild_content", 35, "9071", ErrorType.local, "\u4E1A\u52A1\u914D\u7F6E\u6587\u4EF6\u5185\u5BB9\u65E0\u6548");
		...
		//  323  819:putstatic       #421 <Field BusinessException$ErrorMessage local_app_config_invaild_content>
			local_app_query_app_no_fail = new ErrorMessage("local_app_query_app_no_fail", 36, "9072", ErrorType.local, "\u7EC8\u7AEF\u83B7\u53D6\u5361\u7684\u5E94\u7528\u5E8F\u5217\u53F7\u5931\u8D25");
		...
		//  332  843:putstatic       #428 <Field BusinessException$ErrorMessage local_app_query_app_no_fail>
			local_app_query_server_fail = new ErrorMessage("local_app_query_server_fail", 37, "9073", ErrorType.local, "\u6839\u636E\u6839\u636E\u4E1A\u52A1\u4FE1\u606F\u83B7\u53D6\u5F85\u8BBF\u95EE\u7684\u5E73\u53F0\u5931\u8D25");
		...
		//  341  867:putstatic       #435 <Field BusinessException$ErrorMessage local_app_query_server_fail>
			business_order_codenot_exist = new ErrorMessage("business_order_codenot_exist", 38, "0001", ErrorType.remote, "\u4EA4\u6613\u4EE3\u7801\u4E0D\u5B58\u5728");
		...
		//  350  891:putstatic       #445 <Field BusinessException$ErrorMessage business_order_codenot_exist>
			business_invalid_message_format = new ErrorMessage("business_invalid_message_format", 39, "0002", ErrorType.remote, "\u62A5\u6587\u683C\u5F0F\u9519\u8BEF");
		...
		//  359  915:putstatic       #452 <Field BusinessException$ErrorMessage business_invalid_message_format>
			business_invalid_message_type = new ErrorMessage("business_invalid_message_type", 40, "0003", ErrorType.remote, "\u65E0\u6548\u7684\u6D88\u606F\u7C7B\u578B");
		...
		//  368  939:putstatic       #459 <Field BusinessException$ErrorMessage business_invalid_message_type>
			business_message_check_fail = new ErrorMessage("business_message_check_fail", 41, "0004", ErrorType.remote, "\u62A5\u6587\u68C0\u9A8C\u5931\u8D25");
		...
		//  377  963:putstatic       #464 <Field BusinessException$ErrorMessage business_message_check_fail>
			business_business_no_support = new ErrorMessage("business_business_no_support", 42, "0005", ErrorType.remote, "\u8BE5\u4E1A\u52A1\u6682\u4E0D\u652F\u6301");
		...
		//  386  987:putstatic       #471 <Field BusinessException$ErrorMessage business_business_no_support>
			business_platform_busy = new ErrorMessage("business_platform_busy", 43, "0006", ErrorType.remote, "\u7CFB\u7EDF\u5FD9,\u8BF7\u7A0D\u5019\u518D\u8BD5");
		...
		//  395 1011:putstatic       #478 <Field BusinessException$ErrorMessage business_platform_busy>
			business_invalid_terminal = new ErrorMessage("business_invalid_terminal", 44, "0007", ErrorType.remote, "\u624B\u673A\u7EC8\u7AEF\u53F7\u65E0\u6548");
		...
		//  404 1035:putstatic       #485 <Field BusinessException$ErrorMessage business_invalid_terminal>
			business_operate_timeout = new ErrorMessage("business_operate_timeout", 45, "0008", ErrorType.remote, "\u64CD\u4F5C\u8D85\u65F6\uFF0C\u8BF7\u91CD\u65B0\u767B\u5F55");
		...
		//  413 1059:putstatic       #492 <Field BusinessException$ErrorMessage business_operate_timeout>
			business_repeat_message = new ErrorMessage("business_repeat_message", 46, "0010", ErrorType.remote, "\u91CD\u590D\u5305");
		...
		//  422 1083:putstatic       #499 <Field BusinessException$ErrorMessage business_repeat_message>
			business_message_invalid_serial = new ErrorMessage("business_message_invalid_serial", 47, "0011", ErrorType.remote, "\u5305\u5E8F\u5217\u53F7\u4E0D\u8FDE\u7EED");
		...
		//  431 1107:putstatic       #506 <Field BusinessException$ErrorMessage business_message_invalid_serial>
			business_serial_not_exist = new ErrorMessage("business_serial_not_exist", 48, "0012", ErrorType.remote, "\u539F\u7EC8\u7AEF\u4EA4\u6613\u6D41\u6C34\u53F7\u4E0D\u5B58\u5728");
		...
		//  440 1131:putstatic       #513 <Field BusinessException$ErrorMessage business_serial_not_exist>
			business_system_error = new ErrorMessage("business_system_error", 49, "0014", ErrorType.remote, "\u7CFB\u7EDF\u9519\u8BEF");
		...
		//  449 1155:putstatic       #520 <Field BusinessException$ErrorMessage business_system_error>
			business_invalid_message_length = new ErrorMessage("business_invalid_message_length", 50, "0015", ErrorType.remote, "\u62A5\u6587\u957F\u5EA6\u9519\u8BEF");
		...
		//  458 1179:putstatic       #527 <Field BusinessException$ErrorMessage business_invalid_message_length>
			business_trade_timeout = new ErrorMessage("business_trade_timeout", 51, "0016", ErrorType.remote, "\u4EA4\u6613\u8D85\u65F6");
		...
		//  467 1203:putstatic       #534 <Field BusinessException$ErrorMessage business_trade_timeout>
			business_1920_unknow = new ErrorMessage("business_1920_unknow", 52, "0017", ErrorType.remote, "1920\u672A\u77E5\u9519\u8BEF");
		...
		//  476 1227:putstatic       #541 <Field BusinessException$ErrorMessage business_1920_unknow>
			business_interface_version_error = new ErrorMessage("business_interface_version_error", 53, "0018", ErrorType.remote, "\u4E1A\u52A1\u63A5\u53E3\u7248\u672C\u9519\u8BEF");
		...
		//  485 1251:putstatic       #548 <Field BusinessException$ErrorMessage business_interface_version_error>
			business_merchants_not_exist = new ErrorMessage("business_merchants_not_exist", 54, "0019", ErrorType.remote, "\u5546\u6237\u4E0D\u5B58\u5728");
		...
		//  494 1275:putstatic       #555 <Field BusinessException$ErrorMessage business_merchants_not_exist>
			business_business_stop = new ErrorMessage("business_business_stop", 55, "0020", ErrorType.remote, "\u5BF9\u8BE5\u5546\u6237\u5DF2\u505C\u6B62\u670D\u52A1");
		...
		//  503 1299:putstatic       #562 <Field BusinessException$ErrorMessage business_business_stop>
			business_business_will_exist = new ErrorMessage("business_business_will_exist", 56, "0021", ErrorType.remote, "\u4E1A\u52A1\u5373\u5C06\u63A8\u51FA\uFF0C\u5C3D\u8BF7\u671F\u5F85");
		...
		//  512 1323:putstatic       #569 <Field BusinessException$ErrorMessage business_business_will_exist>
			business_system_unknow_error = new ErrorMessage("business_system_unknow_error", 57, "0099", ErrorType.remote, "\u7CFB\u7EDF\u672A\u77E5\u9519\u8BEF");
		...
		//  521 1347:putstatic       #576 <Field BusinessException$ErrorMessage business_system_unknow_error>
			OT_CHECK_FAIL = new ErrorMessage("OT_CHECK_FAIL", 58, "5011", ErrorType.remote, "\u5E94\u7528\u5B89\u88C5\u51C6\u5907\u672C\u5730\u8D44\u683C\u5BA1\u67E5\u5931\u8D25");
		...
		//  530 1371:putstatic       #583 <Field BusinessException$ErrorMessage OT_CHECK_FAIL>
			OT_APPLY_SIR_FAIL = new ErrorMessage("OT_APPLY_SIR_FAIL", 59, "5012", ErrorType.remote, "\u5411\u6B27\u8D1D\u7279\u7533\u8BF7\u670D\u52A1\u5B9E\u4F8B\u5F15\u7528\u53F7\uFF08sir\uFF09\u5931\u8D25");
		...
		//  539 1395:putstatic       #590 <Field BusinessException$ErrorMessage OT_APPLY_SIR_FAIL>
			OT_STATE_CHANGE_NOTICE = new ErrorMessage("OT_STATE_CHANGE_NOTICE", 60, "5013", ErrorType.remote, "\u5411\u6B27\u8D1D\u7279\u53D1\u8D77\u670D\u52A1\u72B6\u6001\u53D8\u66F4\u901A\u77E5\u5931\u8D25");
		...
		//  548 1419:putstatic       #597 <Field BusinessException$ErrorMessage OT_STATE_CHANGE_NOTICE>
			OT_AC_REQUEST_NOTICE = new ErrorMessage("OT_AC_REQUEST_NOTICE", 61, "5014", ErrorType.remote, "\u5411\u6B27\u8D1D\u7279\u53D1\u8D77\u643A\u5E26AC\u89C4\u5219\u7684\u5F02\u6B65\u670D\u52A1\u90E8\u7F72\u8BF7\u6C42\u5931\u8D25");
		...
		//  557 1443:putstatic       #604 <Field BusinessException$ErrorMessage OT_AC_REQUEST_NOTICE>
			OT_BUSY = new ErrorMessage("OT_BUSY", 62, "9029", ErrorType.remote, "OT\u5E73\u53F0\u6B63\u5728\u5904\u7406\u5B89\u88C5\u51C6\u5907");
		...
		//  566 1467:putstatic       #611 <Field BusinessException$ErrorMessage OT_BUSY>
			user_unregistered = new ErrorMessage("user_unregistered", 63, "1000", ErrorType.remote, "\u7528\u6237\u672A\u6CE8\u518C");
		...
		//  575 1491:putstatic       #618 <Field BusinessException$ErrorMessage user_unregistered>
			user_incorrect_password = new ErrorMessage("user_incorrect_password", 64, "1001", ErrorType.remote, "\u7528\u6237\u5BC6\u7801\u4E0D\u6B63\u786E");
		...
		//  584 1515:putstatic       #625 <Field BusinessException$ErrorMessage user_incorrect_password>
			user_not_sign = new ErrorMessage("user_not_sign", 65, "1002", ErrorType.remote, "\u7528\u6237\u672A\u7B7E\u7EA6");
		...
		//  593 1539:putstatic       #632 <Field BusinessException$ErrorMessage user_not_sign>
			user_sign_apply = new ErrorMessage("user_sign_apply", 66, "1003", ErrorType.remote, "\u7528\u6237\u5728\u7B7E\u7EA6\u7533\u8BF7\u4E2D");
		...
		//  602 1563:putstatic       #639 <Field BusinessException$ErrorMessage user_sign_apply>
			user_sign_fail = new ErrorMessage("user_sign_fail", 67, "1004", ErrorType.remote, "\u7B7E\u7EA6\u5931\u8D25");
		...
		//  611 1587:putstatic       #646 <Field BusinessException$ErrorMessage user_sign_fail>
			user_sign_sucess = new ErrorMessage("user_sign_sucess", 68, "1005", ErrorType.remote, "\u7B7E\u7EA6\u5DF2\u6210\u529F");
		...
		//  620 1611:putstatic       #653 <Field BusinessException$ErrorMessage user_sign_sucess>
			user_logout = new ErrorMessage("user_logout", 69, "1006", ErrorType.remote, "\u7528\u6237\u5DF2\u6CE8\u9500");
		...
		//  629 1635:putstatic       #660 <Field BusinessException$ErrorMessage user_logout>
			user_register = new ErrorMessage("user_register", 70, "1007", ErrorType.remote, "\u7528\u6237\u5DF2\u6CE8\u518C");
		...
		//  638 1659:putstatic       #667 <Field BusinessException$ErrorMessage user_register>
			user_severance = new ErrorMessage("user_severance", 71, "1008", ErrorType.remote, "\u7528\u6237\u5DF2\u89E3\u7EA6");
		...
		//  647 1683:putstatic       #674 <Field BusinessException$ErrorMessage user_severance>
			user_not_login = new ErrorMessage("user_not_login", 72, "1009", ErrorType.remote, "\u7528\u6237\u672A\u767B\u5F55");
		...
		//  656 1707:putstatic       #681 <Field BusinessException$ErrorMessage user_not_login>
			user_id_not_matching = new ErrorMessage("user_id_not_matching", 73, "1010", ErrorType.remote, "\u7528\u6237\u8EAB\u4EFD\u8BC1\u4FE1\u606F\u4E0D\u5339\u914D");
		...
		//  665 1731:putstatic       #688 <Field BusinessException$ErrorMessage user_id_not_matching>
			user_locked = new ErrorMessage("user_locked", 74, "1011", ErrorType.remote, "\u7528\u6237\u5DF2\u9501\u5B9A");
		...
		//  674 1755:putstatic       #695 <Field BusinessException$ErrorMessage user_locked>
			user_freeze = new ErrorMessage("user_freeze", 75, "1012", ErrorType.remote, "\u7528\u6237\u5DF2\u51BB\u7ED3");
		...
		//  683 1779:putstatic       #702 <Field BusinessException$ErrorMessage user_freeze>
			user_get_password_count_exceed = new ErrorMessage("user_get_password_count_exceed", 76, "1013", ErrorType.remote, "\u5BC6\u7801\u627E\u56DE\u5DF2\u7ECF\u8FBE\u5230\u5F53\u65E5\u4E0A\u9650");
		...
		//  692 1803:putstatic       #709 <Field BusinessException$ErrorMessage user_get_password_count_exceed>
			user_info_incomplete = new ErrorMessage("user_info_incomplete", 77, "1014", ErrorType.remote, "\u7528\u6237\u6CE8\u518C\u4FE1\u606F\u4E0D\u5B8C\u6574\uFF0C\u8BF7\u8865\u5145\u767B\u8BB0\u76F8\u5173\u4FE1\u606F");
		...
		//  701 1827:putstatic       #716 <Field BusinessException$ErrorMessage user_info_incomplete>
			user_auth_code_invalid = new ErrorMessage("user_auth_code_invalid", 78, "1016", ErrorType.remote, "\u7528\u6237\u8BA4\u8BC1\u7801\u6821\u9A8C\u5931\u8D25");
		...
		//  710 1851:putstatic       #723 <Field BusinessException$ErrorMessage user_auth_code_invalid>
			user_auth_code_mobile_invalid = new ErrorMessage("user_auth_code_mobile_invalid", 79, "1017", ErrorType.remote, "\u9A8C\u8BC1\u7801\u624B\u673A\u53F7\u548C\u6CE8\u518C\u624B\u673A\u53F7\u4E0D\u4E00\u81F4");
		...
		//  719 1875:putstatic       #730 <Field BusinessException$ErrorMessage user_auth_code_mobile_invalid>
			not_support_retrieve_email = new ErrorMessage("not_support_retrieve_email", 80, "1018", ErrorType.remote, "\u5BC6\u7801\u4E0D\u652F\u6301\u90AE\u7BB1\u627E\u56DE");
		...
		//  728 1899:putstatic       #737 <Field BusinessException$ErrorMessage not_support_retrieve_email>
			user_auth_code_type_invalid = new ErrorMessage("user_auth_code_type_invalid", 81, "1019", ErrorType.remote, "\u9A8C\u8BC1\u7801\u7C7B\u578B\u4E0D\u5339\u914D");
		...
		//  737 1923:putstatic       #744 <Field BusinessException$ErrorMessage user_auth_code_type_invalid>
			user_auth_code_expire = new ErrorMessage("user_auth_code_expire", 82, "1020", ErrorType.remote, "\u9A8C\u8BC1\u7801\u5DF2\u8FC7\u671F");
		...
		//  746 1947:putstatic       #751 <Field BusinessException$ErrorMessage user_auth_code_expire>
			sptc_open_exception = new ErrorMessage("sptc_open_exception", 83, "1021", ErrorType.remote, "\u4EA4\u901A\u5361\u5F00\u901A\u53D1\u751F\u5F02\u5E38\uFF0C\u8BF7\u91CD\u8BD5");
		...
		//  755 1971:putstatic       #758 <Field BusinessException$ErrorMessage sptc_open_exception>
			sptc_close_exception = new ErrorMessage("sptc_close_exception", 84, "1022", ErrorType.remote, "\u4EA4\u901A\u5361\u5173\u95ED\u53D1\u751F\u5F02\u5E38\uFF0C\u8BF7\u91CD\u8BD5");
		...
		//  764 1995:putstatic       #765 <Field BusinessException$ErrorMessage sptc_close_exception>
			sptc_personalization_fail = new ErrorMessage("sptc_personalization_fail", 85, "1023", ErrorType.remote, "\u4EA4\u901A\u5361\u4E2A\u4EBA\u5316\u5931\u8D25");
		...
		//  773 2019:putstatic       #772 <Field BusinessException$ErrorMessage sptc_personalization_fail>
			app_issuer_fail = new ErrorMessage("app_issuer_fail", 86, "1024", ErrorType.remote, "\u7528\u6237\u5361\u53D1\u884C\u5931\u8D25");
		...
		//  782 2043:putstatic       #779 <Field BusinessException$ErrorMessage app_issuer_fail>
			sptc_data_not_matching = new ErrorMessage("sptc_data_not_matching", 87, "1029", ErrorType.remote, "\u4EA4\u901A\u5361\u6570\u636E\u4E0D\u5339\u914D");
		...
		//  791 2067:putstatic       #786 <Field BusinessException$ErrorMessage sptc_data_not_matching>
			card_invaild_check = new ErrorMessage("card_invaild_check", 88, "1030", ErrorType.remote, "\u5361\u7247\u9A8C\u8BC1\u65E0\u6548");
		...
		//  800 2091:putstatic       #793 <Field BusinessException$ErrorMessage card_invaild_check>
			card_not_order = new ErrorMessage("card_not_order", 89, "1031", ErrorType.remote, "\u5361\u7247\u8BA2\u8D2D\u5173\u7CFB\u4E0D\u5B58\u5728");
		...
		//  809 2115:putstatic       #800 <Field BusinessException$ErrorMessage card_not_order>
			card_order_by_other = new ErrorMessage("card_order_by_other", 90, "1032", ErrorType.remote, "\u5361\u7247\u8BA2\u8D2D\u5173\u7CFB\u4E0D\u5339\u914D\uFF0C\u5DF2\u88AB\u5176\u4ED6\u6CE8\u518C\u7528\u6237\u8BA2\u8D2D");
		...
		//  818 2139:putstatic       #807 <Field BusinessException$ErrorMessage card_order_by_other>
			user_order_open = new ErrorMessage("user_order_open", 91, "1033", ErrorType.remote, "\u7528\u6237\u5DF2\u8BA2\u8D2D\u4E14\u5361\u5DF2\u5F00\u901A");
		...
		//  827 2163:putstatic       #814 <Field BusinessException$ErrorMessage user_order_open>
			user_unsubscribe_closed = new ErrorMessage("user_unsubscribe_closed", 92, "1034", ErrorType.remote, "\u7528\u6237\u5DF2\u9000\u8BA2\u4E14\u5173\u95ED\u4E86\u529F\u80FD");
		...
		//  836 2187:putstatic       #821 <Field BusinessException$ErrorMessage user_unsubscribe_closed>
			user_order_no_open = new ErrorMessage("user_order_no_open", 93, "1035", ErrorType.remote, "\u7528\u6237\u5DF2\u8BA2\u8D2D\u4F46\u8FD8\u672A\u5F00\u901A");
		...
		//  845 2211:putstatic       #828 <Field BusinessException$ErrorMessage user_order_no_open>
			user_order_fail = new ErrorMessage("user_order_fail", 94, "1036", ErrorType.remote, "\u7528\u6237\u8BA2\u8D2D\u5931\u8D25");
		...
		//  854 2235:putstatic       #835 <Field BusinessException$ErrorMessage user_order_fail>
			user_unsubscribe_fail = new ErrorMessage("user_unsubscribe_fail", 95, "1037", ErrorType.remote, "\u7528\u6237\u9000\u8BA2\u5931\u8D25");
		...
		//  863 2259:putstatic       #842 <Field BusinessException$ErrorMessage user_unsubscribe_fail>
			user_order_invaild_info = new ErrorMessage("user_order_invaild_info", 96, "1038", ErrorType.remote, "\u8BA2\u8D2D\u4FE1\u606F\u6570\u636E\u6709\u95EE\u9898");
		...
		//  872 2283:putstatic       #849 <Field BusinessException$ErrorMessage user_order_invaild_info>
			sptc_app_not_issuer = new ErrorMessage("sptc_app_not_issuer", 97, "1039", ErrorType.remote, "\u4EA4\u901A\u5361\u5E94\u7528\u672A\u4E0B\u8F7D");
		...
		//  881 2307:putstatic       #856 <Field BusinessException$ErrorMessage sptc_app_not_issuer>
			sptc_personalization = new ErrorMessage("sptc_personalization", 98, "1040", ErrorType.remote, "\u4EA4\u901A\u5361\u5DF2\u5B8C\u6210\u4E2A\u4EBA\u5316");
		...
		//  890 2331:putstatic       #863 <Field BusinessException$ErrorMessage sptc_personalization>
			invaild_personalization_info = new ErrorMessage("invaild_personalization_info", 99, "1041", ErrorType.remote, "\u4E2A\u4EBA\u5316\u6570\u636E\u4E0D\u8DB3");
		...
		//  899 2355:putstatic       #870 <Field BusinessException$ErrorMessage invaild_personalization_info>
			ack_card_app_unpersonal = new ErrorMessage("ack_card_app_unpersonal", 100, "1042", ErrorType.remote, "\u5E94\u7528\u672A\u4E2A\u4EBA\u5316");
		...
		//  908 2379:putstatic       #877 <Field BusinessException$ErrorMessage ack_card_app_unpersonal>
			ack_card_app_unprepare = new ErrorMessage("ack_card_app_unprepare", 101, "1043", ErrorType.remote, "\u5E94\u7528\u5B89\u88C5\u672A\u51C6\u5907");
		...
		//  917 2403:putstatic       #884 <Field BusinessException$ErrorMessage ack_card_app_unprepare>
			ack_card_app_order_fail = new ErrorMessage("ack_card_app_order_fail", 102, "1044", ErrorType.remote, "\u7528\u6237\u975E\u8BA2\u8D2D\u6210\u529F\u72B6\u6001");
		...
		//  926 2427:putstatic       #891 <Field BusinessException$ErrorMessage ack_card_app_order_fail>
			ack_card_app_unorder_fail = new ErrorMessage("ack_card_app_unorder_fail", 103, "1045", ErrorType.remote, "\u7528\u6237\u975E\u9000\u8BA2\u6210\u529F\u72B6\u6001");
		...
		//  935 2451:putstatic       #898 <Field BusinessException$ErrorMessage ack_card_app_unorder_fail>
			no_suppert_in_card = new ErrorMessage("no_suppert_in_card", 104, "1046", ErrorType.remote, "\u6682\u4E0D\u652F\u6301\u5185\u5361");
		...
		//  944 2475:putstatic       #905 <Field BusinessException$ErrorMessage no_suppert_in_card>
			no_suppert_out_card = new ErrorMessage("no_suppert_out_card", 105, "1047", ErrorType.remote, "\u6682\u4E0D\u652F\u6301\u5916\u5361");
		...
		//  953 2499:putstatic       #912 <Field BusinessException$ErrorMessage no_suppert_out_card>
			business_order_not_exist = new ErrorMessage("business_order_not_exist", 106, "1101", ErrorType.remote, "\u8BA2\u5355\u4E0D\u5B58\u5728");
		...
		//  962 2523:putstatic       #919 <Field BusinessException$ErrorMessage business_order_not_exist>
			business_order_apply_no_pay = new ErrorMessage("business_order_apply_no_pay", 107, "1102", ErrorType.remote, "\u8BA2\u5355\u5DF2\u7533\u8BF7\u3001\u672A\u6263\u6B3E");
		...
		//  971 2547:putstatic       #926 <Field BusinessException$ErrorMessage business_order_apply_no_pay>
			business_order_pay_no_write = new ErrorMessage("business_order_pay_no_write", 108, "1103", ErrorType.remote, "\u8BA2\u5355\u5DF2\u6263\u6B3E\u3001\u672A\u5145\u503C");
		...
		//  980 2571:putstatic       #933 <Field BusinessException$ErrorMessage business_order_pay_no_write>
			business_order_recharge_sucess = new ErrorMessage("business_order_recharge_sucess", 109, "1104", ErrorType.remote, "\u8BA2\u5355\u5DF2\u7ECF\u5145\u503C\u6210\u529F");
		...
		//  989 2595:putstatic       #940 <Field BusinessException$ErrorMessage business_order_recharge_sucess>
			business_order_amount_inconsistent = new ErrorMessage("business_order_amount_inconsistent", 110, "1105", ErrorType.remote, "\u8BA2\u5355\u91D1\u989D\u4E0D\u7B26");
		...
		//  998 2619:putstatic       #947 <Field BusinessException$ErrorMessage business_order_amount_inconsistent>
			business_order_unsettled_exist = new ErrorMessage("business_order_unsettled_exist", 111, "1106", ErrorType.remote, "\u5B58\u5728\u53EF\u7591\u8BA2\u5355");
		...
		// 1007 2643:putstatic       #954 <Field BusinessException$ErrorMessage business_order_unsettled_exist>
			business_order_recharget_fail = new ErrorMessage("business_order_recharget_fail", 112, "1107", ErrorType.remote, "\u8BA2\u5355\u4EA4\u6613\u5931\u8D25");
		...
		// 1016 2667:putstatic       #961 <Field BusinessException$ErrorMessage business_order_recharget_fail>
			business_order_apply_refund = new ErrorMessage("business_order_apply_refund", 113, "1108", ErrorType.remote, "\u8BA2\u5355\u7533\u8BF7\u9000\u6B3E\u4E2D");
		...
		// 1025 2691:putstatic       #968 <Field BusinessException$ErrorMessage business_order_apply_refund>
			business_order_refund = new ErrorMessage("business_order_refund", 114, "1109", ErrorType.remote, "\u8BA2\u5355\u5DF2\u9000\u6B3E");
		...
		// 1034 2715:putstatic       #975 <Field BusinessException$ErrorMessage business_order_refund>
			business_order_rechargeting = new ErrorMessage("business_order_rechargeting", 115, "1110", ErrorType.remote, "\u8BA2\u5355\u6B63\u5728\u5145\u503C\u4E2D");
		...
		// 1043 2739:putstatic       #982 <Field BusinessException$ErrorMessage business_order_rechargeting>
			business_order_paying = new ErrorMessage("business_order_paying", 116, "1111", ErrorType.remote, "\u8BA2\u5355\u6B63\u5728\u652F\u4ED8\u4E2D");
		...
		// 1052 2763:putstatic       #989 <Field BusinessException$ErrorMessage business_order_paying>
			business_order_no_refund = new ErrorMessage("business_order_no_refund", 117, "1112", ErrorType.remote, "\u8BA2\u5355\u4E0D\u80FD\u9000\u6B3E");
		...
		// 1061 2787:putstatic       #996 <Field BusinessException$ErrorMessage business_order_no_refund>
			business_order_card_no_inconsistent = new ErrorMessage("business_order_card_no_inconsistent", 118, "1113", ErrorType.remote, "\u8BA2\u5355\u7ED1\u5B9A\u7684\u5361\u53F7\u548C\u672C\u6B21\u4EA4\u6613\u7684\u5361\u53F7\u4E0D\u4E00\u81F4");
		...
		// 1070 2811:putstatic       #1003 <Field BusinessException$ErrorMessage business_order_card_no_inconsistent>
			business_order_invoice = new ErrorMessage("business_order_invoice", 119, "1114", ErrorType.remote, "\u53D1\u7968\u5DF2\u9886\u53D6");
		...
		// 1079 2835:putstatic       #1010 <Field BusinessException$ErrorMessage business_order_invoice>
			business_order_no_invoice = new ErrorMessage("business_order_no_invoice", 120, "1115", ErrorType.remote, "\u8BE5\u7B14\u4EA4\u6613\u5DF2\u5931\u6548\uFF0C\u4E0D\u80FD\u9886\u53D6\u53D1\u7968");
		...
		// 1088 2859:putstatic       #1017 <Field BusinessException$ErrorMessage business_order_no_invoice>
			business_unsettled_overrun = new ErrorMessage("business_unsettled_overrun", 121, "1116", ErrorType.remote, "\u53EF\u7591\u8BA2\u5355\u8D85\u8FC7\u4E0A\u9650\uFF0C\u8BF7\u8FDB\u884C\u5904\u7406");
		...
		// 1097 2883:putstatic       #1024 <Field BusinessException$ErrorMessage business_unsettled_overrun>
			order_apply_frequent = new ErrorMessage("order_apply_frequent", 122, "1126", ErrorType.remote, "\u8BA2\u5355\u91CD\u590D\u7533\u8BF7\u5C0F\u4E8E\u8BA2\u5355\u95F4\u9694");
		...
		// 1106 2907:putstatic       #1031 <Field BusinessException$ErrorMessage order_apply_frequent>
			app_move_code_invalid = new ErrorMessage("app_move_code_invalid", 123, "1127", ErrorType.remote, "\u5E94\u7528\u8FC1\u79FB\u8FC7\u4E86\u6709\u6548\u671F");
		...
		// 1115 2931:putstatic       #1038 <Field BusinessException$ErrorMessage app_move_code_invalid>
			order_amount_low = new ErrorMessage("order_amount_low", 124, "1128", ErrorType.remote, "\u8BA2\u5355\u7533\u8BF7\u91D1\u989D\u5C0F\u4E8E\u914D\u7F6E");
		...
		// 1124 2955:putstatic       #1045 <Field BusinessException$ErrorMessage order_amount_low>
			trade_not_exist = new ErrorMessage("trade_not_exist", 125, "1201", ErrorType.remote, "\u4EA4\u6613\u4E0D\u5B58\u5728");
		...
		// 1133 2979:putstatic       #1052 <Field BusinessException$ErrorMessage trade_not_exist>
			trade_handling = new ErrorMessage("trade_handling", 126, "1202", ErrorType.remote, "\u4EA4\u6613\u5904\u7406\u4E2D");
		...
		// 1142 3003:putstatic       #1059 <Field BusinessException$ErrorMessage trade_handling>
			trade_fail = new ErrorMessage("trade_fail", 127, "1203", ErrorType.remote, "\u4EA4\u6613\u5931\u8D25");
		...
		// 1151 3027:putstatic       #1066 <Field BusinessException$ErrorMessage trade_fail>
			trade_sucess = new ErrorMessage("trade_sucess", 128, "1204", ErrorType.remote, "\u4EA4\u6613\u6210\u529F");
		...
		// 1160 3052:putstatic       #1073 <Field BusinessException$ErrorMessage trade_sucess>
			trade_act_check_fail = new ErrorMessage("trade_act_check_fail", 129, "1207", ErrorType.remote, "\u6D3B\u52A8\u4EE3\u7801\u6821\u9A8C\u5931\u8D25");
		...
		// 1169 3077:putstatic       #1080 <Field BusinessException$ErrorMessage trade_act_check_fail>
			trade_act_used = new ErrorMessage("trade_act_used", 130, "1208", ErrorType.remote, "\u6D3B\u52A8\u4EE3\u7801\u5DF2\u4F7F\u7528");
		...
		// 1178 3102:putstatic       #1087 <Field BusinessException$ErrorMessage trade_act_used>
			apdu_exec_fail = new ErrorMessage("apdu_exec_fail", 131, "1209", ErrorType.remote, "\u53D1\u5361\u7EC8\u7AEF\u6307\u4EE4\u6267\u884C\u5931\u8D25");
		...
		// 1187 3127:putstatic       #1094 <Field BusinessException$ErrorMessage apdu_exec_fail>
			third_seq_repeat = new ErrorMessage("third_seq_repeat", 132, "1210", ErrorType.remote, "\u7B2C\u4E09\u65B9\u5E73\u53F0\u6D41\u6C34\u91CD\u590D");
		...
		// 1196 3152:putstatic       #1101 <Field BusinessException$ErrorMessage third_seq_repeat>
			ese_no_space = new ErrorMessage("ese_no_space", 133, "1211", ErrorType.remote, "\u7EC8\u7AEFeSE\u7A7A\u95F4\u4E0D\u8DB3");
		...
		// 1205 3177:putstatic       #1108 <Field BusinessException$ErrorMessage ese_no_space>
			load_more = new ErrorMessage("load_more", 134, "1212", ErrorType.remote, "\u5708\u5B58\u9519\u8BEF\u6B21\u6570\u8D85\u9650");
		...
		// 1214 3202:putstatic       #1115 <Field BusinessException$ErrorMessage load_more>
			apdu_result_ffff = new ErrorMessage("apdu_result_ffff", 135, "1213", ErrorType.remote, "\u7EC8\u7AEF\u6307\u4EE4\u6267\u884C\u8FD4\u56DEFFFF");
		...
		// 1223 3227:putstatic       #1122 <Field BusinessException$ErrorMessage apdu_result_ffff>
			no_stock = new ErrorMessage("no_stock", 136, "1214", ErrorType.remote, "\u5361\u6570\u636E\u5E93\u5B58\u4E0D\u8DB3");
		...
		// 1232 3252:putstatic       #1129 <Field BusinessException$ErrorMessage no_stock>
			move_user_no_issure = new ErrorMessage("move_user_no_issure", 137, "1215", ErrorType.remote, "\u5E94\u7528\u8FC1\u79FB\u7528\u6237\u975E\u53D1\u5361\u7528\u6237");
		...
		// 1241 3277:putstatic       #1136 <Field BusinessException$ErrorMessage move_user_no_issure>
			card_balance_overrun = new ErrorMessage("card_balance_overrun", 138, "3013", ErrorType.remote, "\u5361\u4E0A\u4F59\u989D\u8D85\u9650");
		...
		// 1250 3302:putstatic       #1143 <Field BusinessException$ErrorMessage card_balance_overrun>
			amount_invalid = new ErrorMessage("amount_invalid", 139, "3016", ErrorType.remote, "\u975E\u6CD5\u4EA4\u6613\u91D1\u989D");
		...
		// 1259 3327:putstatic       #1150 <Field BusinessException$ErrorMessage amount_invalid>
			pasm_overrun = new ErrorMessage("pasm_overrun", 140, "3017", ErrorType.remote, "PASM\u91D1\u989D\u8D85\u8FC7\u5F53\u65E5\u4E0A\u9650");
		...
		// 1268 3352:putstatic       #1157 <Field BusinessException$ErrorMessage pasm_overrun>
			card_invalid = new ErrorMessage("card_invalid", 141, "3018", ErrorType.remote, "\u4EA4\u901A\u5361\u5F02\u5E38\u6216\u975E\u6CD5\u5361");
		...
		// 1277 3377:putstatic       #1164 <Field BusinessException$ErrorMessage card_invalid>
			no_activity = new ErrorMessage("no_activity", 142, "5001", ErrorType.remote, "\u8BE5\u5382\u5546\u6CA1\u6709\u6D3B\u52A8\u4FE1\u606F");
		...
		// 1288 3408:anewarray       ErrorMessage[]
		// 1289 3411:dup             
		// 1290 3412:iconst_0        
		...
		private ErrorMessage(String s, int i, String s1, ErrorType errortype, String s2)
		{
			super(s, i);
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	static final class ErrorMessage.ErrorType extends Enum
	{

		public static ErrorMessage.ErrorType valueOf(String s)
		{
			return (ErrorMessage.ErrorType)Enum.valueOf(cn/com/fmsh/tsm/business/exception/BusinessException$ErrorMessage$ErrorType, s);
		...
		public static ErrorMessage.ErrorType[] values()
		{
			ErrorMessage.ErrorType aerrortype[] = ENUM$VALUES;
		...
		//    3    5:arraylength     
		//    4    6:istore_0        
			ErrorMessage.ErrorType aerrortype1[] = new ErrorMessage.ErrorType[i];
		//    5    7:iload_0         
		//    6    8:anewarray       ErrorMessage.ErrorType[]
		//    7   11:astore_2        
		...
		private static final ErrorMessage.ErrorType ENUM$VALUES[];
		public static final ErrorMessage.ErrorType local;
		public static final ErrorMessage.ErrorType remote;

		static 
		{
			local = new ErrorMessage.ErrorType("local", 0);
		...
		//    5   10:putstatic       #25  <Field BusinessException$ErrorMessage$ErrorType local>
			remote = new ErrorMessage.ErrorType("remote", 1);
		...
		//   11   23:putstatic       #28  <Field BusinessException$ErrorMessage$ErrorType remote>
			ENUM$VALUES = (new ErrorMessage.ErrorType[] {
				local, remote
			});
		//   12   26:iconst_2        
		//   13   27:anewarray       ErrorMessage.ErrorType[]
		//   14   30:dup             
		//   15   31:iconst_0        
		...
		private ErrorMessage.ErrorType(String s, int i)
		{
			super(s, i);
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #20  <Method void FM_Exception(String)>
	//    3    5:return          
	}

	public BusinessException(String s, ErrorMessage errormessage)
	{
		super(s);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//    3    5:aload_0         
	//    4    6:aload_2         
	//    5    7:putfield        #24  <Field BusinessException$ErrorMessage errorMsg>
	//    6   10:return          
	}
	...
	public ErrorMessage getErrorMsg()
	{
		return errorMsg;
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field BusinessException$ErrorMessage errorMsg>
	//    2    4:areturn         
	}

	private static final long serialVersionUID = 0xc5bf2b6bL;
