...
public abstract class r extends ViewOffsetBehavior
{
	...
	protected abstract View findFirstDependency(List list);

	protected final int getOverlapPixelsForOffset(View view)
	{
		if(mOverlayTop == 0)
	//*   0    0:aload_0         
	...
	//    4    8:ireturn         
			...
			return w.b((int)(getOverlapRatioForOffset(view) * (float)mOverlayTop), 0, mOverlayTop);
	//    5    9:aload_0         
	//    6   10:aload_1         
	...
	//   16   26:invokestatic    #47  <Method int w.b(int, int, int)>
	//   17   29:ireturn         
	}
	...
	//   10   20:checkcast       #72  <Class android.support.design.widget.CoordinatorLayout$LayoutParams>
	//   11   23:astore          5
	...
	//   18   37:aload           5
	//   19   39:getfield        #78  <Field int android.support.design.widget.CoordinatorLayout$LayoutParams.leftMargin>
	//   20   42:iadd            
	//   21   43:aload           4
	//   22   45:invokevirtual   #81  <Method int View.getBottom()>
	//   23   48:aload           5
	//   24   50:getfield        #84  <Field int android.support.design.widget.CoordinatorLayout$LayoutParams.topMargin>
	//   25   53:iadd            
	//   26   54:aload_1         
	...
	//   30   62:isub            
	//   31   63:aload           5
	//   32   65:getfield        #93  <Field int android.support.design.widget.CoordinatorLayout$LayoutParams.rightMargin>
	//   33   68:isub            
	//   34   69:aload_1         
	...
	//   41   83:isub            
	//   42   84:aload           5
	//   43   86:getfield        #102 <Field int android.support.design.widget.CoordinatorLayout$LayoutParams.bottomMargin>
	//   44   89:isub            
	...
	//   74  155:aload           5
	//   75  157:getfield        #133 <Field int android.support.design.widget.CoordinatorLayout$LayoutParams.gravity>
	...
	//*  56  118:goto            125
					i1 = 0x80000000;
	//   57  121:ldc1            #180 <Int 0x80000000>
	//   58  123:istore          7
	...
	//   67  137:iadd            
	//   68  138:iload           7
	//   69  140:invokestatic    #184 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   70  143:iload           6
	//   71  145:invokevirtual   #187 <Method void CoordinatorLayout.onMeasureChild(View, int, int, int, int)>
				return true;
	//   72  148:iconst_1        
	//   73  149:ireturn         
			}
