...
public static abstract class bc$e extends Binder
	implements bc
{
	static class e
		implements bc
	...
	//    2    4:aconst_null     
	//    3    5:areturn         
		android.os.IInterface iinterface = ibinder.queryLocalInterface("com.uodis.opendevice.aidl.OpenDeviceIdentifierService");
	//    4    6:aload_0         
