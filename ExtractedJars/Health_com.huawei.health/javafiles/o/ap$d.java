...
static class ap$d extends ViewGroup
{
	...
	//   21   43:invokevirtual   #104 <Method void invalidate(Rect)>
			drawable.setCallback(((android.graphics.drawable.ble.Callback) (this)));
	//   22   46:aload_1         
	//   23   47:aload_0         
	...
	//   11   21:invokevirtual   #104 <Method void invalidate(Rect)>
			drawable.setCallback(((android.graphics.drawable.ble.Callback) (null)));
	//   12   24:aload_1         
	//   13   25:aconst_null     
	...
	ap$d(Context context, ViewGroup viewgroup, View view, ap ap1)
	{
		super(context);
	//    0    0:aload_0         
	//    1    1:aload_1         
