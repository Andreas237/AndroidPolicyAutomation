...
public class ju
{
	...
	//    5   11:aconst_null     
	//    6   12:areturn         
		if(s.contains("SuccessCode=\"0\""))
	//*   7   13:aload_1         
	//*   8   14:ldc1            #28  <String "SuccessCode=\"0\"">
	//*   9   16:invokevirtual   #32  <Method boolean String.contains(CharSequence)>
	//*  10   19:ifeq            24
			return null;
	//   11   22:aconst_null     
	//   12   23:areturn         
	...
	//   15   26:new             #34  <Class ByteArrayInputStream>
	//   16   29:dup             
	//   17   30:aload_1         
	//   18   31:ldc1            #36  <String "UTF-8">
	//   19   33:invokevirtual   #40  <Method byte[] String.getBytes(String)>
	//   20   36:invokespecial   #43  <Method void ByteArrayInputStream(byte[])>
	//   21   39:astore_1        
		}
	//*  22   40:goto            46
		// Misplaced declaration of an exception variable
	...
	//   26   46:invokestatic    #49  <Method SAXParserFactory SAXParserFactory.newInstance()>
	//   27   49:astore_3        
		a1 = new a();
	//   28   50:new             #8   <Class ju$a>
	//   29   53:dup             
	//   30   54:aconst_null     
	//   31   55:invokespecial   #52  <Method void ju$a(ju$1)>
	//   32   58:astore_2        
		if(s == null)
	...
	//   34   60:ifnull          76
		try
		{
			saxparserfactory.newSAXParser().parse(((InputStream) (s)), ((DefaultHandler) (a1)));
	//   35   63:aload_3         
	//   36   64:invokevirtual   #56  <Method SAXParser SAXParserFactory.newSAXParser()>
	//   37   67:aload_1         
	//   38   68:aload_2         
	//   39   69:invokevirtual   #62  <Method void SAXParser.parse(InputStream, DefaultHandler)>
			((InputStream) (s)).close();
	//   40   72:aload_1         
	//   41   73:invokevirtual   #67  <Method void InputStream.close()>
			break MISSING_BLOCK_LABEL_90;
	//   42   76:goto            90
		}
		// Misplaced declaration of an exception variable
	...
	//   43   79:astore_1        
		((Throwable) (s)).printStackTrace();
	//   44   80:aload_1         
	//   45   81:invokevirtual   #70  <Method void Throwable.printStackTrace()>
		break MISSING_BLOCK_LABEL_90;
	//   46   84:goto            90
		s;
	//   47   87:astore_1        
	...
	//   49   89:athrow          
		a1.d.f("network");
	//   50   90:aload_2         
	//   51   91:getfield        #74  <Field jt ju$a.d>
	//   52   94:ldc1            #76  <String "network">
	//   53   96:invokevirtual   #82  <Method void jt.f(String)>
		if(a1.d.k() == 0L)
	//*  54   99:aload_2         
	//*  55  100:getfield        #74  <Field jt ju$a.d>
	//*  56  103:invokevirtual   #86  <Method long jt.k()>
	//*  57  106:lconst_0        
	//*  58  107:lcmp            
	//*  59  108:ifne            121
			a1.d.b(ke.e());
	//   60  111:aload_2         
	//   61  112:getfield        #74  <Field jt ju$a.d>
	//   62  115:invokestatic    #91  <Method long ke.e()>
	//   63  118:invokevirtual   #95  <Method void jt.b(long)>
		return a1.d;
	//   64  121:aload_2         
	//   65  122:getfield        #74  <Field jt ju$a.d>
	//   66  125:areturn         
	}
}
