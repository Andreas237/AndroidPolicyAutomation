...
//			AdInformationPositions

public static final class AdInformationPositions$Position extends Enum
{

	public static AdInformationPositions$Position getByIndex(long l)
	{
		AdInformationPositions$Position adinformationpositions$position = BOTTOM_LEFT;
	//    0    0:getstatic       #35  <Field AdInformationPositions$Position BOTTOM_LEFT>
	//    1    3:astore_3        
		AdInformationPositions$Position aadinformationpositions$position[] = values();
	//    2    4:invokestatic    #58  <Method AdInformationPositions$Position[] values()>
	//    3    7:astore          4
		for(int i = 0; i < aadinformationpositions$position.length; i++)
	//*   4    9:iconst_0        
	//*   5   10:istore_2        
	//*   6   11:iload_2         
	//*   7   12:aload           4
	//*   8   14:arraylength     
	//*   9   15:icmpge          43
			if((long)aadinformationpositions$position[i].getIndex() == l)
	//*  10   18:aload           4
	//*  11   20:iload_2         
	//*  12   21:aaload          
	...
	//*  16   27:lcmp            
	//*  17   28:ifne            36
				adinformationpositions$position = aadinformationpositions$position[i];
	//   18   31:aload           4
	//   19   33:iload_2         
	//   20   34:aaload          
	//   21   35:astore_3        
	...
	//   25   39:istore_2        
	//*  26   40:goto            11
		return adinformationpositions$position;
	//   27   43:aload_3         
	//   28   44:areturn         
	}

	public static AdInformationPositions$Position getByName(String s)
	{
		AdInformationPositions$Position adinformationpositions$position = BOTTOM_LEFT;
	//    0    0:getstatic       #35  <Field AdInformationPositions$Position BOTTOM_LEFT>
	//    1    3:astore_2        
	...
	//*   8   12:arraylength     
	//*   9   13:icmpge          46
			if(aadinformationpositions$position[i].name().toLowerCase().compareTo(s.toLowerCase()) == 0)
	//*  10   16:aload_3         
	//*  11   17:iload_1         
	//*  12   18:aaload          
	...
	public static AdInformationPositions$Position valueOf(String s)
	{
		return (AdInformationPositions$Position)Enum.valueOf(com/startapp/android/publish/adsCommon/adinformation/AdInformationPositions$Position, s);
	...
	public static AdInformationPositions$Position[] values()
	{
		return (AdInformationPositions$Position[])((AdInformationPositions$Position []) ($VALUES)).clone();
	...
	private static final AdInformationPositions$Position $VALUES[];
	public static final AdInformationPositions$Position BOTTOM_LEFT;
	public static final AdInformationPositions$Position BOTTOM_RIGHT;
	public static final AdInformationPositions$Position TOP_LEFT;
	public static final AdInformationPositions$Position TOP_RIGHT;
	...
	static 
	{
		TOP_LEFT = new AdInformationPositions$Position("TOP_LEFT", 0, 1, new int[] {
			10, 9
		}, -1);
	...
	//   17   25:putstatic       #29  <Field AdInformationPositions$Position TOP_LEFT>
		TOP_RIGHT = new AdInformationPositions$Position("TOP_RIGHT", 1, 2, new int[] {
			10, 11
		}, 1);
	...
	//   35   53:putstatic       #32  <Field AdInformationPositions$Position TOP_RIGHT>
		BOTTOM_LEFT = new AdInformationPositions$Position("BOTTOM_LEFT", 2, 3, new int[] {
			12, 9
		}, -1);
	...
	//   53   81:putstatic       #35  <Field AdInformationPositions$Position BOTTOM_LEFT>
		BOTTOM_RIGHT = new AdInformationPositions$Position("BOTTOM_RIGHT", 3, 4, new int[] {
			12, 11
		}, 1);
	...
	//   71  109:putstatic       #38  <Field AdInformationPositions$Position BOTTOM_RIGHT>
		$VALUES = (new AdInformationPositions$Position[] {
			TOP_LEFT, TOP_RIGHT, BOTTOM_LEFT, BOTTOM_RIGHT
		});
	//   72  112:iconst_4        
	//   73  113:anewarray       AdInformationPositions$Position[]
	//   74  116:dup             
	//   75  117:iconst_0        
	...
	private AdInformationPositions$Position(String s, int i, int j, int ai[], int k)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
