...
// Referenced classes of package com.startapp.android.publish.adsCommon.adListeners:
//			AdDisplayListener

public static final class AdDisplayListener$NotDisplayedReason extends Enum
{

	public static AdDisplayListener$NotDisplayedReason valueOf(String s)
	{
		return (AdDisplayListener$NotDisplayedReason)Enum.valueOf(com/startapp/android/publish/adsCommon/adListeners/AdDisplayListener$NotDisplayedReason, s);
	...
	public static AdDisplayListener$NotDisplayedReason[] values()
	{
		return (AdDisplayListener$NotDisplayedReason[])((AdDisplayListener$NotDisplayedReason []) ($VALUES)).clone();
	...
	private static final AdDisplayListener$NotDisplayedReason $VALUES[];
	public static final AdDisplayListener$NotDisplayedReason AD_CLOSED_TOO_QUICKLY;
	public static final AdDisplayListener$NotDisplayedReason AD_EXPIRED;
	public static final AdDisplayListener$NotDisplayedReason AD_NOT_READY;
	public static final AdDisplayListener$NotDisplayedReason AD_NOT_READY_VIDEO_FALLBACK;
	public static final AdDisplayListener$NotDisplayedReason AD_RULES;
	public static final AdDisplayListener$NotDisplayedReason APP_IN_BACKGROUND;
	public static final AdDisplayListener$NotDisplayedReason INTERNAL_ERROR;
	public static final AdDisplayListener$NotDisplayedReason NETWORK_PROBLEM;
	public static final AdDisplayListener$NotDisplayedReason SERVING_ADS_DISABLED;
	public static final AdDisplayListener$NotDisplayedReason VIDEO_BACK;
	public static final AdDisplayListener$NotDisplayedReason VIDEO_ERROR;

	static 
	{
		NETWORK_PROBLEM = new AdDisplayListener$NotDisplayedReason("NETWORK_PROBLEM", 0);
	...
	//    5   10:putstatic       #31  <Field AdDisplayListener$NotDisplayedReason NETWORK_PROBLEM>
		AD_RULES = new AdDisplayListener$NotDisplayedReason("AD_RULES", 1);
	...
	//   11   23:putstatic       #34  <Field AdDisplayListener$NotDisplayedReason AD_RULES>
		AD_NOT_READY = new AdDisplayListener$NotDisplayedReason("AD_NOT_READY", 2);
	...
	//   17   36:putstatic       #37  <Field AdDisplayListener$NotDisplayedReason AD_NOT_READY>
		AD_EXPIRED = new AdDisplayListener$NotDisplayedReason("AD_EXPIRED", 3);
	...
	//   23   49:putstatic       #40  <Field AdDisplayListener$NotDisplayedReason AD_EXPIRED>
		VIDEO_BACK = new AdDisplayListener$NotDisplayedReason("VIDEO_BACK", 4);
	...
	//   29   62:putstatic       #43  <Field AdDisplayListener$NotDisplayedReason VIDEO_BACK>
		VIDEO_ERROR = new AdDisplayListener$NotDisplayedReason("VIDEO_ERROR", 5);
	...
	//   35   75:putstatic       #46  <Field AdDisplayListener$NotDisplayedReason VIDEO_ERROR>
		INTERNAL_ERROR = new AdDisplayListener$NotDisplayedReason("INTERNAL_ERROR", 6);
	...
	//   41   89:putstatic       #49  <Field AdDisplayListener$NotDisplayedReason INTERNAL_ERROR>
		AD_NOT_READY_VIDEO_FALLBACK = new AdDisplayListener$NotDisplayedReason("AD_NOT_READY_VIDEO_FALLBACK", 7);
	...
	//   47  103:putstatic       #52  <Field AdDisplayListener$NotDisplayedReason AD_NOT_READY_VIDEO_FALLBACK>
		APP_IN_BACKGROUND = new AdDisplayListener$NotDisplayedReason("APP_IN_BACKGROUND", 8);
	...
	//   53  117:putstatic       #55  <Field AdDisplayListener$NotDisplayedReason APP_IN_BACKGROUND>
		AD_CLOSED_TOO_QUICKLY = new AdDisplayListener$NotDisplayedReason("AD_CLOSED_TOO_QUICKLY", 9);
	...
	//   59  131:putstatic       #58  <Field AdDisplayListener$NotDisplayedReason AD_CLOSED_TOO_QUICKLY>
		SERVING_ADS_DISABLED = new AdDisplayListener$NotDisplayedReason("SERVING_ADS_DISABLED", 10);
	...
	//   65  145:putstatic       #61  <Field AdDisplayListener$NotDisplayedReason SERVING_ADS_DISABLED>
		$VALUES = (new AdDisplayListener$NotDisplayedReason[] {
	...
	//   66  148:bipush          11
	//   67  150:anewarray       AdDisplayListener$NotDisplayedReason[]
	//   68  153:dup             
	//   69  154:iconst_0        
	...
	private AdDisplayListener$NotDisplayedReason(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
