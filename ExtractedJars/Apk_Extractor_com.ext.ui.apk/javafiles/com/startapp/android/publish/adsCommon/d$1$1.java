	...
	implements Runnable
{
	...
	d$1$1(d._cls1 _pcls1, Boolean boolean1)
	{
		b = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/startapp/android/publish/adsCommon/d$1
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//    5   12:astore_1        
			(new Handler(Looper.getMainLooper())).post(((Runnable) (new d._cls1._cls1(this, boolean1))));
