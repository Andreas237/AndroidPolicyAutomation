	...
	implements Runnable
{
	...
	i$2$1(i._cls2 _pcls2, List list)
	{
		b = _pcls2;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/startapp/android/publish/cache/i$2

/* anonymous class */
	static final class i._cls2
		implements Runnable
	{
		...
		//    5   12:astore_1        
				(new Handler(Looper.getMainLooper())).post(((Runnable) (new i._cls2._cls1(this, list))));
