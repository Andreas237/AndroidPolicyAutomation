	...
	implements com.startapp.common.a.a
{
	...
	NativeAdDetails$1$1(NativeAdDetails._cls1 _pcls1)
	{
		a = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/startapp/android/publish/ads/nativead/NativeAdDetails$1

/* anonymous class */
	class NativeAdDetails._cls1
		implements com.startapp.common.a.a
	{
		...
		//    3    5:invokevirtual   #26  <Method void com.startapp.android.publish.ads.nativead.NativeAdDetails.a(Bitmap)>
			(new a(a.getSecondaryImageUrl(), ((com.startapp.common.a.a) (new NativeAdDetails._cls1._cls1(this))), i)).a();
		//    4    8:new             #28  <Class a>
		//    5   11:dup             
		//    6   12:aload_0         
