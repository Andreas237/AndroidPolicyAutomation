	...
	implements Runnable
{
	...
	//    4    8:invokevirtual   #31  <Method void com.startapp.android.publish.ads.video.f.f(int)>
			return;
	//    5   11:return          
		}
	...
	//*   6   12:astore_1        
		{
			f.a(b.b().getApplicationContext(), new e(d.b, "VideoMode.scheduleFractionProgressEvents", exception.getMessage()), f.a(b));
	//    7   13:aload_0         
	...
	//   14   30:ldc1            #49  <String "VideoMode.scheduleFractionProgressEvents">
	//   15   32:aload_1         
	...
	f$6(com.startapp.android.publish.ads.video.f f1, int i)
	{
		b = f1;
	//    0    0:aload_0         
	//    1    1:aload_1         
