	...
	implements ThreadFactory
{
	...
	{
		return new Thread(runnable, (new StringBuilder()).append("highPriorityThreadFactory #").append(a.getAndIncrement()).toString());
	...
	//    6   12:ldc1            #31  <String "highPriorityThreadFactory #">
