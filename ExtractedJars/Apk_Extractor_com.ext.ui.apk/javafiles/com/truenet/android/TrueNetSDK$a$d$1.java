...
static final class TrueNetSDK$a$d$1 extends af
	implements v
{
	...
	TrueNetSDK$a$d$1(TrueNetSDK.a.d d1, android.support.v7.aj.a a1)
	{
		this$0 = d1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/truenet/android/TrueNetSDK$a$d
		...
		implements Runnable
	{
		...
		//    7   13:putfield        #39  <Field Object android.support.v7.aj$a.a>
			if(a == 0L && ((v)new TrueNetSDK.a.d._cls1(this, ((android.support.v7.aj.a) (obj)))).a() != null)
		//*   8   16:aload_0         
		...
		//   32   66:invokestatic    #55  <Method void ae.a()>
				TrueNetSDK.a.a(a1, context, ((String) (obj)), (v)TrueNetSDK.a.d._cls2.a);
		//   33   69:aload_1         
		//   34   70:aload_2         
		//   35   71:aload_3         
		...
		// Unreferenced inner class com/truenet/android/TrueNetSDK$a$d$2

/* anonymous class */
		static final class TrueNetSDK.a.d._cls2 extends af
			implements v
		{
			...
			public static final TrueNetSDK.a.d._cls2 a = new TrueNetSDK.a.d._cls2();
