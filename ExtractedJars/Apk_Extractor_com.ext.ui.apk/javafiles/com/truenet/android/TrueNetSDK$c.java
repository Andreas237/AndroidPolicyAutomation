	...
	implements b
{
	...
	//*  11   25:ifeq            60
		{
			TrueNetSDK$a truenetsdk$a = TrueNetSDK.Companion;
	...
	//   16   36:invokestatic    #50  <Method void ae.a(Object, String)>
			...
			a(Map map, Context context, int i, com.startapp.common.b.a.b.b b1)
			{
				$extras$inlined = map;
			//    0    0:aload_0         
			//    1    1:aload_1         
			...
			truenetsdk$a.a(context, (v)new a(map, context, i, b1));
	//   17   39:aload           6
	//   18   41:aload_1         
