...
public static final class i$a
{
	...
	//   19   36:astore_2        
				...
				implements Runnable
			{
				...
				{
					Object obj1 = ((Object) ((new WebView(a)).getSettings()));
			...
			a(Context context, SynchronousQueue synchronousqueue)
			{
				a = context;
			//    0    0:aload_0         
			//    1    1:aload_1         
