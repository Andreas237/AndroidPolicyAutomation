	...
	implements Runnable
{
	...
	final MainActivity._cls3._cls1 a;

	MainActivity$3$1$1(MainActivity._cls3._cls1 _pcls1)
	{
		a = _pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class com/ext/ui/MainActivity$3
...
/* anonymous class */
		...
		implements android.support.v7.widget.SearchView.OnQueryTextListener
	{
		...
		{
			(new Thread(new MainActivity._cls3._cls1(this, new Handler(), s))).start();
	...
	// Unreferenced inner class com/ext/ui/MainActivity$3$1
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		public void run()
		{
			a.post(((Runnable) (new MainActivity._cls3._cls1._cls1(this))));
		//    0    0:aload_0         
