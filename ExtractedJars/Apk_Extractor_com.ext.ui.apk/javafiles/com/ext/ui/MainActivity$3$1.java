	...
	implements Runnable
{
	...
	public void run()
	{
		a.post(new Runnable() {
			...
			{
				a = MainActivity._cls3._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	MainActivity$3$1(MainActivity._cls3 _pcls3, Handler handler, String s)
	{
		c = _pcls3;
	//    0    0:aload_0         
	//    1    1:aload_1         
...
/* anonymous class */
		...
		implements android.support.v7.widget.SearchView.OnQueryTextListener
	{
		...
		{
			(new Thread(((Runnable) (new MainActivity._cls3._cls1(this, new Handler(), s))))).start();
