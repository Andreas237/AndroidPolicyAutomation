	...
	private static class VPathRenderer
	{
		...
		//  278  543:astore_1        
				...
				if(((VFullPath) (vpath)).mStrokeColor != 0)
				{
					...
					((Paint) (vgroup)).setStrokeWidth(f1 * f * ((VFullPath) (vpath)).mStrokeWidth);
...
*/
	...
	//    0    0:iload_0         
	//    1    1:invokestatic    #127 <Method int Color.alpha(int)>
	//    2    4:i2f             
	//    3    5:fload_1         
	//    4    6:fmul            
	//    5    7:f2i             
	...
	//    6   13:new             #211 <Class Stack>
	//    7   16:dup             
	//    8   17:invokespecial   #212 <Method void Stack()>
	//    9   20:astore          11
	...
	//   13   29:invokevirtual   #220 <Method Object Stack.push(Object)>
	//   14   32:pop             
		int j = xmlpullparser.getEventType();
	//   15   33:aload_2         
	//   16   34:invokeinterface #223 <Method int XmlPullParser.getEventType()>
	//   17   39:istore          7
		int k = xmlpullparser.getDepth();
	//   18   41:aload_2         
	//   19   42:invokeinterface #226 <Method int XmlPullParser.getDepth()>
	//   20   47:istore          8
		boolean flag = true;
	//   21   49:iconst_1        
	//   22   50:istore          5
	...
	//   76  168:aload           9
	//   77  170:getfield        #269 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
	//   78  173:istore          6
						vectordrawablecompatstate.mChangingConfigurations = ((VFullPath) (obj)).mChangingConfigurations | i;
	//   79  175:aload           9
	//   80  177:aload           13
	//   81  179:getfield        #270 <Field int VectorDrawableCompat$VFullPath.mChangingConfigurations>
	//   82  182:iload           6
	//   83  184:ior             
	//   84  185:putfield        #269 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
					} else
	//*  85  188:iload           5
	//*  86  190:istore          6
	//*  87  192:aload_2         
	//*  88  193:invokeinterface #181 <Method int XmlPullParser.next()>
	//*  89  198:istore          7
	//*  90  200:iload           6
	//*  91  202:istore          5
	//*  92  204:goto            52
					if("clip-path".equals(obj))
	//*  93  207:ldc1            #48  <String "clip-path">
	//*  94  209:aload           13
	//*  95  211:invokevirtual   #240 <Method boolean String.equals(Object)>
	//*  96  214:ifeq            290
					{
						obj = ((Object) (new VClipPath()));
	//   97  217:new             #6   <Class VectorDrawableCompat$VClipPath>
	//   98  220:dup             
	//   99  221:invokespecial   #271 <Method void VectorDrawableCompat$VClipPath()>
	//  100  224:astore          13
	...
	//  104  230:aload           4
	//  105  232:aload_2         
	//  106  233:invokevirtual   #272 <Method void VectorDrawableCompat$VClipPath.inflate(Resources, AttributeSet, android.content.res.Resources$Theme, XmlPullParser)>
						vgroup.mChildren.add(obj);
	//  107  236:aload           12
	//  108  238:getfield        #248 <Field ArrayList VectorDrawableCompat$VGroup.mChildren>
	//  109  241:aload           13
	//  110  243:invokevirtual   #253 <Method boolean ArrayList.add(Object)>
	//  111  246:pop             
						if(((VClipPath) (obj)).getPathName() != null)
	//* 112  247:aload           13
	//* 113  249:invokevirtual   #273 <Method String VectorDrawableCompat$VClipPath.getPathName()>
	//* 114  252:ifnull          271
							vpathrenderer.mVGTargetsMap.put(((Object) (((VClipPath) (obj)).getPathName())), obj);
	//  115  255:aload           10
	//  116  257:getfield        #260 <Field ArrayMap VectorDrawableCompat$VPathRenderer.mVGTargetsMap>
	//  117  260:aload           13
	//  118  262:invokevirtual   #273 <Method String VectorDrawableCompat$VClipPath.getPathName()>
	//  119  265:aload           13
	//  120  267:invokevirtual   #266 <Method Object ArrayMap.put(Object, Object)>
	//  121  270:pop             
	...
	//  122  271:aload           9
	//  123  273:aload           9
	//  124  275:getfield        #269 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
	//  125  278:aload           13
	//  126  280:getfield        #274 <Field int VectorDrawableCompat$VClipPath.mChangingConfigurations>
	//  127  283:ior             
	//  128  284:putfield        #269 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
					} else
	//* 129  287:goto            188
					if("group".equals(obj))
	...
	//* 178  395:ldc1            #51  <String "group">
	//* 179  397:aload_2         
	//* 180  398:invokeinterface #230 <Method String XmlPullParser.getName()>
	//* 181  403:invokevirtual   #240 <Method boolean String.equals(Object)>
	//* 182  406:ifeq            192
						{
							stack.pop();
	//  183  409:aload           11
	//  184  411:invokevirtual   #283 <Method Object Stack.pop()>
	//  185  414:pop             
							flag1 = flag;
	//  186  415:iload           5
	//  187  417:istore          6
	...
	//  191  427:new             #285 <Class StringBuffer>
	//  192  430:dup             
	//  193  431:invokespecial   #286 <Method void StringBuffer()>
	//  194  434:astore_1        
				if(((StringBuffer) (resources)).length() > 0)
	//* 195  435:aload_1         
	//* 196  436:invokevirtual   #289 <Method int StringBuffer.length()>
	//* 197  439:ifle            450
					((StringBuffer) (resources)).append(" or ");
	//  198  442:aload_1         
	//  199  443:ldc2            #291 <String " or ">
	//  200  446:invokevirtual   #295 <Method StringBuffer StringBuffer.append(String)>
	//  201  449:pop             
				((StringBuffer) (resources)).append("path");
	//  202  450:aload_1         
	//  203  451:ldc1            #54  <String "path">
	//  204  453:invokevirtual   #295 <Method StringBuffer StringBuffer.append(String)>
	//  205  456:pop             
				throw new XmlPullParserException((new StringBuilder()).append("no ").append(((Object) (resources))).append(" defined").toString());
	//  206  457:new             #134 <Class XmlPullParserException>
	//  207  460:dup             
	//  208  461:new             #297 <Class StringBuilder>
	//  209  464:dup             
	//  210  465:invokespecial   #298 <Method void StringBuilder()>
	//  211  468:ldc2            #300 <String "no ">
	//  212  471:invokevirtual   #303 <Method StringBuilder StringBuilder.append(String)>
	//  213  474:aload_1         
	//  214  475:invokevirtual   #306 <Method StringBuilder StringBuilder.append(Object)>
	//  215  478:ldc2            #308 <String " defined">
	//  216  481:invokevirtual   #303 <Method StringBuilder StringBuilder.append(String)>
	//  217  484:invokevirtual   #311 <Method String StringBuilder.toString()>
	//  218  487:invokespecial   #186 <Method void XmlPullParserException(String)>
	//  219  490:athrow          
			}
			return;
	//  220  491:return          
...
_L3:
	...
	//*  71  136:fload_3         
	//*  72  137:aload_0         
	//*  73  138:getfield        #100 <Field Rect mTmpBounds>
	//*  74  141:invokevirtual   #480 <Method int Rect.width()>
	//*  75  144:i2f             
	//*  76  145:fmul            
	//*  77  146:f2i             
	//*  78  147:istore          6
	//*  79  149:fload_2         
	//*  80  150:aload_0         
	//*  81  151:getfield        #100 <Field Rect mTmpBounds>
	//*  82  154:invokevirtual   #483 <Method int Rect.height()>
	//*  83  157:i2f             
	//*  84  158:fmul            
	//*  85  159:f2i             
	//*  86  160:istore          7
