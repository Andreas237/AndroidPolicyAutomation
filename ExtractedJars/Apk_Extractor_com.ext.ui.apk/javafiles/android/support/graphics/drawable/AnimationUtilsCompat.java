...
_L6:
	...
	//   84  156:aload_3         
	//   85  157:astore_2        
		context = ((Context) (new android.content.res.Resources.NotFoundException((new StringBuilder()).append("Can't load animation resource ID #0x").append(Integer.toHexString(i)).toString())));
	//   86  158:new             #120 <Class android.content.res.Resources$NotFoundException>
	//   87  161:dup             
	//   88  162:new             #102 <Class StringBuilder>
	//   89  165:dup             
	//   90  166:invokespecial   #103 <Method void StringBuilder()>
	//   91  169:ldc1            #170 <String "Can't load animation resource ID #0x">
	//   92  171:invokevirtual   #109 <Method StringBuilder StringBuilder.append(String)>
	//   93  174:iload_1         
	//   94  175:invokestatic    #176 <Method String Integer.toHexString(int)>
	//   95  178:invokevirtual   #109 <Method StringBuilder StringBuilder.append(String)>
	//   96  181:invokevirtual   #112 <Method String StringBuilder.toString()>
	//   97  184:invokespecial   #177 <Method void android.content.res.Resources$NotFoundException(String)>
	//   98  187:astore_0        
		obj = obj1;
	//   99  188:aload_3         
	//  100  189:astore_2        
		((android.content.res.Resources.NotFoundException) (context)).initCause(((Throwable) (obj2)));
	//  101  190:aload_0         
	//  102  191:aload           4
	...
	//  112  206:aload_2         
	//  113  207:invokeinterface #168 <Method void XmlResourceParser.close()>
		throw context;
	//  114  212:aload_0         
	//  115  213:athrow          
		context;
	...
	//  119  218:new             #120 <Class android.content.res.Resources$NotFoundException>
	//  120  221:dup             
	//  121  222:new             #102 <Class StringBuilder>
	//  122  225:dup             
	//  123  226:invokespecial   #103 <Method void StringBuilder()>
	//  124  229:ldc1            #170 <String "Can't load animation resource ID #0x">
	//  125  231:invokevirtual   #109 <Method StringBuilder StringBuilder.append(String)>
	//  126  234:iload_1         
	//  127  235:invokestatic    #176 <Method String Integer.toHexString(int)>
	//  128  238:invokevirtual   #109 <Method StringBuilder StringBuilder.append(String)>
	//  129  241:invokevirtual   #112 <Method String StringBuilder.toString()>
	//  130  244:invokespecial   #177 <Method void android.content.res.Resources$NotFoundException(String)>
	//  131  247:astore_3        
		obj = obj2;
	//  132  248:aload           4
	//  133  250:astore_2        
	...
	//  134  251:aload_3         
	//  135  252:aload_0         
	//  136  253:invokevirtual   #181 <Method Throwable android.content.res.Resources$NotFoundException.initCause(Throwable)>
	//  137  256:pop             
		obj = obj2;
	//  138  257:aload           4
	//  139  259:astore_2        
