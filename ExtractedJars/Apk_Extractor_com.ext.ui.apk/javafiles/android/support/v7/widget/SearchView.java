...
_L8:
	...
	//    2    3:aload_2         
	//    3    4:invokevirtual   #536 <Method ComponentName SearchableInfo.getSearchActivity()>
	//    4    7:astore          9
		Object obj = ((Object) (new Intent("android.intent.action.SEARCH")));
	//    5    9:new             #452 <Class Intent>
	//    6   12:dup             
	//    7   13:ldc2            #611 <String "android.intent.action.SEARCH">
	//    8   16:invokespecial   #457 <Method void Intent(String)>
	//    9   19:astore          4
		((Intent) (obj)).setComponent(componentname);
	//   10   21:aload           4
	//   11   23:aload           9
	//   12   25:invokevirtual   #540 <Method Intent Intent.setComponent(ComponentName)>
	//   13   28:pop             
		PendingIntent pendingintent = PendingIntent.getActivity(getContext(), 0, ((Intent) (obj)), 0x40000000);
	//   14   29:aload_0         
	//   15   30:invokevirtual   #617 <Method Context getContext()>
	//   16   33:iconst_0        
	//   17   34:aload           4
	//   18   36:ldc2            #618 <Int 0x40000000>
	//   19   39:invokestatic    #624 <Method PendingIntent PendingIntent.getActivity(Context, int, Intent, int)>
	//   20   42:astore          7
		Bundle bundle = new Bundle();
	//   21   44:new             #626 <Class Bundle>
	//   22   47:dup             
	//   23   48:invokespecial   #627 <Method void Bundle()>
	//   24   51:astore          8
		if(mAppSearchData != null)
	//*  25   53:aload_0         
	//*  26   54:getfield        #516 <Field Bundle mAppSearchData>
	//*  27   57:ifnull          72
			bundle.putParcelable("app_data", ((Parcelable) (mAppSearchData)));
	//   28   60:aload           8
	//   29   62:ldc2            #518 <String "app_data">
	//   30   65:aload_0         
	//   31   66:getfield        #516 <Field Bundle mAppSearchData>
	//   32   69:invokevirtual   #631 <Method void Bundle.putParcelable(String, Parcelable)>
		Intent intent1 = new Intent(intent);
	//   33   72:new             #452 <Class Intent>
	//   34   75:dup             
	//   35   76:aload_1         
	//   36   77:invokespecial   #634 <Method void Intent(Intent)>
	//   37   80:astore          10
		intent = "free_form";
	//   38   82:ldc2            #636 <String "free_form">
	//   39   85:astore_1        
		int i = 1;
	//   40   86:iconst_1        
	//   41   87:istore_3        
	...
	//   42   88:aload_0         
	//   43   89:invokevirtual   #331 <Method Resources getResources()>
	//   44   92:astore          5
		if(searchableinfo.getVoiceLanguageModeId() != 0)
	//*  45   94:aload_2         
	//*  46   95:invokevirtual   #639 <Method int SearchableInfo.getVoiceLanguageModeId()>
	//*  47   98:ifeq            111
			intent = ((Intent) (((Resources) (obj1)).getString(searchableinfo.getVoiceLanguageModeId())));
	//   48  101:aload           5
	//   49  103:aload_2         
	//   50  104:invokevirtual   #639 <Method int SearchableInfo.getVoiceLanguageModeId()>
	//   51  107:invokevirtual   #342 <Method String Resources.getString(int)>
	//   52  110:astore_1        
		if(searchableinfo.getVoicePromptTextId() != 0)
	//*  53  111:aload_2         
	//*  54  112:invokevirtual   #642 <Method int SearchableInfo.getVoicePromptTextId()>
	//*  55  115:ifeq            259
			obj = ((Object) (((Resources) (obj1)).getString(searchableinfo.getVoicePromptTextId())));
	//   56  118:aload           5
	//   57  120:aload_2         
	//   58  121:invokevirtual   #642 <Method int SearchableInfo.getVoicePromptTextId()>
	//   59  124:invokevirtual   #342 <Method String Resources.getString(int)>
	//   60  127:astore          4
		else
	//*  61  129:aload_2         
	//*  62  130:invokevirtual   #645 <Method int SearchableInfo.getVoiceLanguageId()>
	//*  63  133:ifeq            253
	//*  64  136:aload           5
	//*  65  138:aload_2         
	//*  66  139:invokevirtual   #645 <Method int SearchableInfo.getVoiceLanguageId()>
	//*  67  142:invokevirtual   #342 <Method String Resources.getString(int)>
	//*  68  145:astore          5
	//*  69  147:aload_2         
	//*  70  148:invokevirtual   #648 <Method int SearchableInfo.getVoiceMaxResults()>
	//*  71  151:ifeq            159
	//*  72  154:aload_2         
	//*  73  155:invokevirtual   #648 <Method int SearchableInfo.getVoiceMaxResults()>
	//*  74  158:istore_3        
	//*  75  159:aload           10
	//*  76  161:ldc2            #466 <String "android.speech.extra.LANGUAGE_MODEL">
	//*  77  164:aload_1         
	//*  78  165:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//*  79  168:pop             
	//*  80  169:aload           10
	//*  81  171:ldc2            #650 <String "android.speech.extra.PROMPT">
	//*  82  174:aload           4
	//*  83  176:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//*  84  179:pop             
	//*  85  180:aload           10
	//*  86  182:ldc2            #652 <String "android.speech.extra.LANGUAGE">
	//*  87  185:aload           5
	//*  88  187:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//*  89  190:pop             
	//*  90  191:aload           10
	//*  91  193:ldc2            #654 <String "android.speech.extra.MAX_RESULTS">
	//*  92  196:iload_3         
	//*  93  197:invokevirtual   #526 <Method Intent Intent.putExtra(String, int)>
	//*  94  200:pop             
	//*  95  201:aload           9
	//*  96  203:ifnonnull       244
	//*  97  206:aload           6
	//*  98  208:astore_1        
	//*  99  209:aload           10
	//* 100  211:ldc2            #656 <String "calling_package">
	//* 101  214:aload_1         
	//* 102  215:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//* 103  218:pop             
	//* 104  219:aload           10
	//* 105  221:ldc2            #658 <String "android.speech.extra.RESULTS_PENDINGINTENT">
	//* 106  224:aload           7
	//* 107  226:invokevirtual   #661 <Method Intent Intent.putExtra(String, Parcelable)>
	//* 108  229:pop             
	//* 109  230:aload           10
	//* 110  232:ldc2            #663 <String "android.speech.extra.RESULTS_PENDINGINTENT_BUNDLE">
	//* 111  235:aload           8
	//* 112  237:invokevirtual   #521 <Method Intent Intent.putExtra(String, Bundle)>
	//* 113  240:pop             
	//* 114  241:aload           10
	//* 115  243:areturn         
	//* 116  244:aload           9
	//* 117  246:invokevirtual   #668 <Method String ComponentName.flattenToShortString()>
	//* 118  249:astore_1        
	//* 119  250:goto            209
	//* 120  253:aconst_null     
	//* 121  254:astore          5
...
label0:
	...
	//*  32   60:aload           6
	//*  33   62:iload_2         
	//*  34   63:invokevirtual   #914 <Method void View.setVisibility(int)>
	//*  35   66:iload_3         
	//*  36   67:istore_2        
	//*  37   68:aload_0         
	//*  38   69:getfield        #290 <Field ImageView mCollapsedIcon>
	//*  39   72:invokevirtual   #850 <Method Drawable ImageView.getDrawable()>
	//*  40   75:ifnull          87
	//*  41   78:aload_0         
	//*  42   79:getfield        #491 <Field boolean mIconifiedByDefault>
	//*  43   82:ifeq            134
	//*  44   85:iload_3         
	//*  45   86:istore_2        
	//*  46   87:aload_0         
	//*  47   88:getfield        #290 <Field ImageView mCollapsedIcon>
	//*  48   91:iload_2         
	//*  49   92:invokevirtual   #847 <Method void ImageView.setVisibility(int)>
	//*  50   95:aload_0         
	//*  51   96:invokespecial   #924 <Method void updateCloseButton()>
	//*  52   99:iload           4
	//*  53  101:ifne            139
	//*  54  104:iload           5
	//*  55  106:istore_1        
	//*  56  107:aload_0         
	//*  57  108:iload_1         
	//*  58  109:invokespecial   #927 <Method void updateVoiceButton(boolean)>
	//*  59  112:aload_0         
	//*  60  113:invokespecial   #929 <Method void updateSubmitArea()>
	//*  61  116:return          
			i = 8;
	//   62  117:bipush          8
	//   63  119:istore_2        
	...
	//*  14   29:aload_0         
	//*  15   30:getfield        #285 <Field ImageView mVoiceButton>
	//*  16   33:iload_2         
	//*  17   34:invokevirtual   #847 <Method void ImageView.setVisibility(int)>
	//*  18   37:return          
		{
			i = 8;
	//   19   38:bipush          8
	...
	//   27   59:aload           7
	//   28   61:getstatic       #945 <Field int android.support.v7.appcompat.R$dimen.abc_dropdownitem_text_padding_left>
	//   29   64:invokevirtual   #733 <Method int Resources.getDimensionPixelSize(int)>
	//   30   67:iload_1         
	//   31   68:iadd            
	//   32   69:istore_1        
			} else
	//*  33   70:aload_0         
	//*  34   71:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//*  35   74:invokevirtual   #948 <Method Drawable SearchView$SearchAutoComplete.getDropDownBackground()>
	//*  36   77:aload           8
	//*  37   79:invokevirtual   #952 <Method boolean Drawable.getPadding(Rect)>
	//*  38   82:pop             
	//*  39   83:iload           6
	//*  40   85:ifeq            149
	//*  41   88:aload           8
	//*  42   90:getfield        #955 <Field int Rect.left>
	//*  43   93:ineg            
	//*  44   94:istore_2        
	//*  45   95:aload_0         
	//*  46   96:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//*  47   99:iload_2         
	//*  48  100:invokevirtual   #958 <Method void SearchView$SearchAutoComplete.setDropDownHorizontalOffset(int)>
	//*  49  103:aload_0         
	//*  50  104:getfield        #482 <Field View mDropDownAnchor>
	//*  51  107:invokevirtual   #683 <Method int View.getWidth()>
	//*  52  110:istore_2        
	//*  53  111:aload           8
	//*  54  113:getfield        #955 <Field int Rect.left>
	//*  55  116:istore          4
	//*  56  118:aload           8
	//*  57  120:getfield        #961 <Field int Rect.right>
	//*  58  123:istore          5
	//*  59  125:aload_0         
	//*  60  126:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//*  61  129:iload_1         
	//*  62  130:iload_2         
	//*  63  131:iload           4
	//*  64  133:iadd            
	...
	//*  68  138:iload_3         
	//*  69  139:isub            
	//*  70  140:invokevirtual   #964 <Method void SearchView$SearchAutoComplete.setDropDownWidth(int)>
	//*  71  143:return          
			{
				i = 0;
	//   72  144:iconst_0        
	...
	//   75  149:iload_3         
	//   76  150:aload           8
	//   77  152:getfield        #955 <Field int Rect.left>
	//   78  155:iload_1         
	//   79  156:iadd            
	//   80  157:isub            
	//   81  158:istore_2        
			...
			l = rect.left;
			i1 = rect.right;
			mSearchSrcTextView.setDropDownWidth((i + (j + l + i1)) - k);
		}
	//*  82  159:goto            95
	}
...
_L3:
	...
	//    7   13:ifeq            7
		if(!isIconified())
	//*   8   16:aload_0         
	//*   9   17:invokevirtual   #778 <Method boolean isIconified()>
	//*  10   20:ifne            44
		{
			boolean flag = mSearchSrcTextView.requestFocus(i, rect);
	//   11   23:aload_0         
	//   12   24:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   13   27:iload_1         
	//   14   28:aload_2         
	//   15   29:invokevirtual   #1193 <Method boolean SearchView$SearchAutoComplete.requestFocus(int, Rect)>
	//   16   32:istore_3        
			if(flag)
	//*  17   33:iload_3         
	//*  18   34:ifeq            42
	...
	//   19   37:aload_0         
	//   20   38:iconst_0        
	//   21   39:invokespecial   #494 <Method void updateViewsVisibility(boolean)>
			return flag;
	//   22   42:iload_3         
	//   23   43:ireturn         
		} else
	...
	//   25   45:iload_1         
	//   26   46:aload_2         
	//   27   47:invokespecial   #1194 <Method boolean LinearLayoutCompat.requestFocus(int, Rect)>
	//   28   50:ireturn         
		}
	}
