...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #16  <Method void AccessibilityDelegateCompat()>
		mRecyclerView = recyclerview;
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #18  <Field RecyclerView mRecyclerView>
	//    5    9:aload_0         
	//    6   10:new             #6   <Class RecyclerViewAccessibilityDelegate$ItemDelegate>
	//    7   13:dup             
	//    8   14:aload_0         
	//    9   15:invokespecial   #21  <Method void RecyclerViewAccessibilityDelegate$ItemDelegate(RecyclerViewAccessibilityDelegate)>
	//   10   18:putfield        #23  <Field AccessibilityDelegateCompat mItemDelegate>
	//   11   21:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field AccessibilityDelegateCompat mItemDelegate>
	//    2    4:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #30  <Method void AccessibilityDelegateCompat.onInitializeAccessibilityEvent(View, AccessibilityEvent)>
		accessibilityevent.setClassName(((CharSequence) (((Class) (android/support/v7/widget/RecyclerView)).getName())));
	//    4    6:aload_2         
	//    5    7:ldc1            #32  <Class RecyclerView>
	//    6    9:invokevirtual   #38  <Method String Class.getName()>
	//    7   12:invokevirtual   #44  <Method void AccessibilityEvent.setClassName(CharSequence)>
		if((view instanceof RecyclerView) && !shouldIgnore())
	//*   8   15:aload_1         
	//*   9   16:instanceof      #32  <Class RecyclerView>
	//*  10   19:ifeq            49
	//*  11   22:aload_0         
	//*  12   23:invokevirtual   #48  <Method boolean shouldIgnore()>
	//*  13   26:ifne            49
		{
			view = ((View) ((RecyclerView)view));
	//   14   29:aload_1         
	//   15   30:checkcast       #32  <Class RecyclerView>
	//   16   33:astore_1        
			if(((RecyclerView) (view)).getLayoutManager() != null)
	//*  17   34:aload_1         
	//*  18   35:invokevirtual   #52  <Method RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//*  19   38:ifnull          49
				((RecyclerView) (view)).getLayoutManager().onInitializeAccessibilityEvent(accessibilityevent);
	//   20   41:aload_1         
	//   21   42:invokevirtual   #52  <Method RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//   22   45:aload_2         
	//   23   46:invokevirtual   #57  <Method void RecyclerView$LayoutManager.onInitializeAccessibilityEvent(AccessibilityEvent)>
		}
	//   24   49:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #61  <Method void AccessibilityDelegateCompat.onInitializeAccessibilityNodeInfo(View, AccessibilityNodeInfoCompat)>
		accessibilitynodeinfocompat.setClassName(((CharSequence) (((Class) (android/support/v7/widget/RecyclerView)).getName())));
	//    4    6:aload_2         
	//    5    7:ldc1            #32  <Class RecyclerView>
	//    6    9:invokevirtual   #38  <Method String Class.getName()>
	//    7   12:invokevirtual   #64  <Method void AccessibilityNodeInfoCompat.setClassName(CharSequence)>
		if(!shouldIgnore() && mRecyclerView.getLayoutManager() != null)
	//*   8   15:aload_0         
	//*   9   16:invokevirtual   #48  <Method boolean shouldIgnore()>
	//*  10   19:ifne            43
	//*  11   22:aload_0         
	//*  12   23:getfield        #18  <Field RecyclerView mRecyclerView>
	//*  13   26:invokevirtual   #52  <Method RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//*  14   29:ifnull          43
			mRecyclerView.getLayoutManager().onInitializeAccessibilityNodeInfo(accessibilitynodeinfocompat);
	//   15   32:aload_0         
	//   16   33:getfield        #18  <Field RecyclerView mRecyclerView>
	//   17   36:invokevirtual   #52  <Method RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//   18   39:aload_2         
	//   19   40:invokevirtual   #67  <Method void RecyclerView$LayoutManager.onInitializeAccessibilityNodeInfo(AccessibilityNodeInfoCompat)>
	//   20   43:return          
	}
	...
	//*   2    2:iload_2         
	//*   3    3:aload_3         
	//*   4    4:invokespecial   #71  <Method boolean AccessibilityDelegateCompat.performAccessibilityAction(View, int, Bundle)>
	//*   5    7:ifeq            12
			return true;
	//    6   10:iconst_1        
	//    7   11:ireturn         
		if(!shouldIgnore() && mRecyclerView.getLayoutManager() != null)
	//*   8   12:aload_0         
	//*   9   13:invokevirtual   #48  <Method boolean shouldIgnore()>
	//*  10   16:ifne            42
	//*  11   19:aload_0         
	//*  12   20:getfield        #18  <Field RecyclerView mRecyclerView>
	//*  13   23:invokevirtual   #52  <Method RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//*  14   26:ifnull          42
			return mRecyclerView.getLayoutManager().performAccessibilityAction(i, bundle);
	//   15   29:aload_0         
	//   16   30:getfield        #18  <Field RecyclerView mRecyclerView>
	//   17   33:invokevirtual   #52  <Method RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//   18   36:iload_2         
	//   19   37:aload_3         
	//   20   38:invokevirtual   #74  <Method boolean RecyclerView$LayoutManager.performAccessibilityAction(int, Bundle)>
	//   21   41:ireturn         
		else
			return false;
	//   22   42:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field RecyclerView mRecyclerView>
	//    2    4:invokevirtual   #77  <Method boolean RecyclerView.hasPendingAdapterUpdates()>
	//    3    7:ireturn         
	}
