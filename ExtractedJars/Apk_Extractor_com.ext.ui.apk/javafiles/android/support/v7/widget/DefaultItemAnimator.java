...
public class DefaultItemAnimator extends SimpleItemAnimator
{
	...
	//    4    5:aload_1         
	//    5    6:getfield        #144 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.newHolder>
	//    6    9:aload_2         
	//    7   10:if_acmpne       52
_L1:
	...
	//    8   13:aload_1         
	//    9   14:aconst_null     
	//   10   15:putfield        #144 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.newHolder>
_L6:
		viewholder.itemView.setAlpha(1.0F);
	//   11   18:aload_2         
	//   12   19:getfield        #87  <Field View RecyclerView$ViewHolder.itemView>
	//   13   22:fconst_1        
	//   14   23:invokevirtual   #154 <Method void View.setAlpha(float)>
		viewholder.itemView.setTranslationX(0.0F);
	//   15   26:aload_2         
	//   16   27:getfield        #87  <Field View RecyclerView$ViewHolder.itemView>
	//   17   30:fconst_0        
	//   18   31:invokevirtual   #157 <Method void View.setTranslationX(float)>
		viewholder.itemView.setTranslationY(0.0F);
	//   19   34:aload_2         
	//   20   35:getfield        #87  <Field View RecyclerView$ViewHolder.itemView>
	//   21   38:fconst_0        
	//   22   39:invokevirtual   #160 <Method void View.setTranslationY(float)>
		dispatchChangeFinished(viewholder, flag);
	//   23   42:aload_0         
	//   24   43:aload_2         
	//   25   44:iload_3         
	//   26   45:invokevirtual   #164 <Method void dispatchChangeFinished(RecyclerView$ViewHolder, boolean)>
		flag = true;
	//   27   48:iconst_1        
	//   28   49:istore_3        
_L4:
...
_L2:
	...
	//   33   55:aload_1         
	//   34   56:getfield        #141 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.oldHolder>
	//   35   59:aload_2         
	//   36   60:if_acmpne       50
_L3:
	...
	//   37   63:aload_1         
	//   38   64:aconst_null     
	//   39   65:putfield        #141 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.oldHolder>
		flag = true;
	//   40   68:iconst_1        
	//   41   69:istore_3        
...
_L5:
	...
	//    2    2:aload_1         
	//    3    3:getfield        #141 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.oldHolder>
	//    4    6:astore_2        
	...
	//*   9   13:aload_1         
	//*  10   14:getfield        #144 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.newHolder>
	//*  11   17:astore          4
	//*  12   19:aload           4
	//*  13   21:ifnull          30
	//*  14   24:aload           4
	//*  15   26:getfield        #87  <Field View RecyclerView$ViewHolder.itemView>
	//*  16   29:astore_3        
	//*  17   30:aload_2         
	//*  18   31:ifnull          115
	//*  19   34:aload_2         
	//*  20   35:invokevirtual   #93  <Method ViewPropertyAnimator View.animate()>
	//*  21   38:aload_0         
	//*  22   39:invokevirtual   #215 <Method long getChangeDuration()>
	//*  23   42:invokevirtual   #107 <Method ViewPropertyAnimator ViewPropertyAnimator.setDuration(long)>
	//*  24   45:astore          4
	//*  25   47:aload_0         
	//*  26   48:getfield        #78  <Field ArrayList mChangeAnimations>
	//*  27   51:aload_1         
	//*  28   52:getfield        #141 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.oldHolder>
	//*  29   55:invokevirtual   #97  <Method boolean ArrayList.add(Object)>
	//*  30   58:pop             
	//*  31   59:aload           4
	//*  32   61:aload_1         
	//*  33   62:getfield        #219 <Field int DefaultItemAnimator$ChangeInfo.toX>
	//*  34   65:aload_1         
	//*  35   66:getfield        #222 <Field int DefaultItemAnimator$ChangeInfo.fromX>
	//*  36   69:isub            
	//*  37   70:i2f             
	//*  38   71:invokevirtual   #225 <Method ViewPropertyAnimator ViewPropertyAnimator.translationX(float)>
	//*  39   74:pop             
	//*  40   75:aload           4
	//*  41   77:aload_1         
	//*  42   78:getfield        #228 <Field int DefaultItemAnimator$ChangeInfo.toY>
	//*  43   81:aload_1         
	//*  44   82:getfield        #231 <Field int DefaultItemAnimator$ChangeInfo.fromY>
	//*  45   85:isub            
	//*  46   86:i2f             
	//*  47   87:invokevirtual   #234 <Method ViewPropertyAnimator ViewPropertyAnimator.translationY(float)>
	//*  48   90:pop             
	//*  49   91:aload           4
	//*  50   93:fconst_0        
	//*  51   94:invokevirtual   #111 <Method ViewPropertyAnimator ViewPropertyAnimator.alpha(float)>
	//*  52   97:new             #18  <Class DefaultItemAnimator$7>
	//*  53  100:dup             
	//*  54  101:aload_0         
	//*  55  102:aload_1         
	//*  56  103:aload           4
	//*  57  105:aload_2         
	//*  58  106:invokespecial   #237 <Method void DefaultItemAnimator$7(DefaultItemAnimator, DefaultItemAnimator$ChangeInfo, ViewPropertyAnimator, View)>
	//*  59  109:invokevirtual   #118 <Method ViewPropertyAnimator ViewPropertyAnimator.setListener(android.animation.Animator$AnimatorListener)>
	//*  60  112:invokevirtual   #121 <Method void ViewPropertyAnimator.start()>
	//*  61  115:aload_3         
	//*  62  116:ifnull          173
	//*  63  119:aload_3         
	//*  64  120:invokevirtual   #93  <Method ViewPropertyAnimator View.animate()>
	//*  65  123:astore_2        
	//*  66  124:aload_0         
	//*  67  125:getfield        #78  <Field ArrayList mChangeAnimations>
	//*  68  128:aload_1         
	//*  69  129:getfield        #144 <Field RecyclerView$ViewHolder DefaultItemAnimator$ChangeInfo.newHolder>
	//*  70  132:invokevirtual   #97  <Method boolean ArrayList.add(Object)>
	//*  71  135:pop             
	//*  72  136:aload_2         
	//*  73  137:fconst_0        
	//*  74  138:invokevirtual   #225 <Method ViewPropertyAnimator ViewPropertyAnimator.translationX(float)>
	//*  75  141:fconst_0        
	//*  76  142:invokevirtual   #234 <Method ViewPropertyAnimator ViewPropertyAnimator.translationY(float)>
	//*  77  145:aload_0         
	//*  78  146:invokevirtual   #215 <Method long getChangeDuration()>
	//*  79  149:invokevirtual   #107 <Method ViewPropertyAnimator ViewPropertyAnimator.setDuration(long)>
	//*  80  152:fconst_1        
	//*  81  153:invokevirtual   #111 <Method ViewPropertyAnimator ViewPropertyAnimator.alpha(float)>
	//*  82  156:new             #20  <Class DefaultItemAnimator$8>
	//*  83  159:dup             
	//*  84  160:aload_0         
	//*  85  161:aload_1         
	//*  86  162:aload_2         
	//*  87  163:aload_3         
	//*  88  164:invokespecial   #238 <Method void DefaultItemAnimator$8(DefaultItemAnimator, DefaultItemAnimator$ChangeInfo, ViewPropertyAnimator, View)>
	//*  89  167:invokevirtual   #118 <Method ViewPropertyAnimator ViewPropertyAnimator.setListener(android.animation.Animator$AnimatorListener)>
	//*  90  170:invokevirtual   #121 <Method void ViewPropertyAnimator.start()>
	//*  91  173:return          
			view = ((Object) (((RecyclerView.ViewHolder) (view)).itemView));
	//   92  174:aload_2         
	//   93  175:getfield        #87  <Field View RecyclerView$ViewHolder.itemView>
	//   94  178:astore_2        
