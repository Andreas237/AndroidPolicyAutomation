...
public class TintTypedArray
{
	...
	public Typeface getFont(int i, int j, TextView textview)
	{
		i = mWrapped.getResourceId(i, 0);
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	...
	//    9   15:areturn         
		if(mTypedValue == null)
	//*  10   16:aload_0         
	//*  11   17:getfield        #111 <Field TypedValue mTypedValue>
	//*  12   20:ifnonnull       34
			mTypedValue = new TypedValue();
	//   13   23:aload_0         
	//   14   24:new             #113 <Class TypedValue>
	//   15   27:dup             
	//   16   28:invokespecial   #114 <Method void TypedValue()>
	//   17   31:putfield        #111 <Field TypedValue mTypedValue>
		return ResourcesCompat.getFont(mContext, i, mTypedValue, j, textview);
	//   18   34:aload_0         
	//   19   35:getfield        #21  <Field Context mContext>
	//   20   38:iload_1         
	//   21   39:aload_0         
	//   22   40:getfield        #111 <Field TypedValue mTypedValue>
	//   23   43:iload_2         
	//   24   44:aload_3         
	//   25   45:invokestatic    #119 <Method Typeface ResourcesCompat.getFont(Context, int, TypedValue, int, TextView)>
	//   26   48:areturn         
	}
	...
	//    4    6:iload_3         
	//    5    7:fload           4
	//    6    9:invokevirtual   #124 <Method float TypedArray.getFraction(int, int, int, float)>
	//    7   12:freturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #128 <Method int TypedArray.getIndex(int)>
	//    4    8:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #131 <Method int TypedArray.getIndexCount()>
	//    3    7:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #134 <Method int TypedArray.getInt(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #137 <Method int TypedArray.getInteger(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokevirtual   #140 <Method int TypedArray.getLayoutDimension(int, int)>
	//    5    9:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #143 <Method int TypedArray.getLayoutDimension(int, String)>
	//    5    9:ireturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #147 <Method String TypedArray.getNonResourceString(int)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #151 <Method String TypedArray.getPositionDescription()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #155 <Method Resources TypedArray.getResources()>
	//    3    7:areturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #158 <Method String TypedArray.getString(int)>
	//    4    8:areturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #162 <Method CharSequence TypedArray.getText(int)>
	//    4    8:areturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #166 <Method CharSequence[] TypedArray.getTextArray(int)>
	//    4    8:areturn         
	}
	...
	//*   0    0:getstatic       #173 <Field int android.os.Build$VERSION.SDK_INT>
	//*   1    3:bipush          21
	//*   2    5:icmplt          17
	...
	//    5   12:iload_1         
	//    6   13:invokevirtual   #175 <Method int TypedArray.getType(int)>
	//    7   16:ireturn         
		if(mTypedValue == null)
	//*   8   17:aload_0         
	//*   9   18:getfield        #111 <Field TypedValue mTypedValue>
	//*  10   21:ifnonnull       35
			mTypedValue = new TypedValue();
	//   11   24:aload_0         
	//   12   25:new             #113 <Class TypedValue>
	//   13   28:dup             
	//   14   29:invokespecial   #114 <Method void TypedValue()>
	//   15   32:putfield        #111 <Field TypedValue mTypedValue>
		mWrapped.getValue(i, mTypedValue);
	//   16   35:aload_0         
	//   17   36:getfield        #23  <Field TypedArray mWrapped>
	//   18   39:iload_1         
	//   19   40:aload_0         
	//   20   41:getfield        #111 <Field TypedValue mTypedValue>
	//   21   44:invokevirtual   #179 <Method boolean TypedArray.getValue(int, TypedValue)>
	//   22   47:pop             
		return mTypedValue.type;
	//   23   48:aload_0         
	//   24   49:getfield        #111 <Field TypedValue mTypedValue>
	//   25   52:getfield        #182 <Field int TypedValue.type>
	//   26   55:ireturn         
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #179 <Method boolean TypedArray.getValue(int, TypedValue)>
	//    5    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #185 <Method int TypedArray.length()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #189 <Method TypedValue TypedArray.peekValue(int)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field TypedArray mWrapped>
	//    2    4:invokevirtual   #192 <Method void TypedArray.recycle()>
	//    3    7:return          
	}
