...
public abstract class OrientationHelper
{
	...
	//    2    4:aload_0         
	//    3    5:ldc1            #13  <Int 0x80000000>
	//    4    7:putfield        #27  <Field int mLastTotalSpace>
		mTmpRect = new Rect();
	//    5   10:aload_0         
	//    6   11:new             #29  <Class Rect>
	//    7   14:dup             
	//    8   15:invokespecial   #30  <Method void Rect()>
	//    9   18:putfield        #32  <Field Rect mTmpRect>
		mLayoutManager = layoutmanager;
	//   10   21:aload_0         
	//   11   22:aload_1         
	//   12   23:putfield        #34  <Field RecyclerView$LayoutManager mLayoutManager>
	//   13   26:return          
	}
	...
	public static OrientationHelper createHorizontalHelper(RecyclerView.LayoutManager layoutmanager)
	{
		return ((OrientationHelper) (new OrientationHelper(layoutmanager) {
			...
			//    9   17:aload_3         
			//   10   18:getfield        #36  <Field int RecyclerView$LayoutParams.rightMargin>
			//   11   21:iload_2         
			//   12   22:iadd            
			//   13   23:ireturn         
			}
			...
			//    6   13:aload_1         
			//    7   14:invokevirtual   #40  <Method int RecyclerView$LayoutManager.getDecoratedMeasuredWidth(View)>
			//    8   17:istore_2        
				int j = layoutparams.leftMargin;
			//    9   18:aload           4
			//   10   20:getfield        #43  <Field int RecyclerView$LayoutParams.leftMargin>
			//   11   23:istore_3        
				return layoutparams.rightMargin + (i + j);
			//   12   24:aload           4
			//   13   26:getfield        #36  <Field int RecyclerView$LayoutParams.rightMargin>
			//   14   29:iload_2         
			//   15   30:iload_3         
			//   16   31:iadd            
			//   17   32:iadd            
			...
			//    5   10:getfield        #27  <Field RecyclerView$LayoutManager mLayoutManager>
			//    6   13:aload_1         
			//    7   14:invokevirtual   #47  <Method int RecyclerView$LayoutManager.getDecoratedMeasuredHeight(View)>
			//    8   17:istore_2        
				int j = layoutparams.topMargin;
			//    9   18:aload           4
			//   10   20:getfield        #50  <Field int RecyclerView$LayoutParams.topMargin>
			//   11   23:istore_3        
				return layoutparams.bottomMargin + (i + j);
			//   12   24:aload           4
			//   13   26:getfield        #53  <Field int RecyclerView$LayoutParams.bottomMargin>
			//   14   29:iload_2         
			//   15   30:iload_3         
			//   16   31:iadd            
			//   17   32:iadd            
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #41  <Method void OrientationHelper$1(RecyclerView$LayoutManager)>
	//    4    8:areturn         
	}
	...
	//    2   24:new             #45  <Class IllegalArgumentException>
	//    3   27:dup             
	//    4   28:ldc1            #47  <String "invalid orientation">
	//    5   30:invokespecial   #50  <Method void IllegalArgumentException(String)>
	//    6   33:athrow          

		case 0: // '\0'
			return createHorizontalHelper(layoutmanager);
	//    7   34:aload_0         
	//    8   35:invokestatic    #52  <Method OrientationHelper createHorizontalHelper(RecyclerView$LayoutManager)>
	//    9   38:areturn         

		case 1: // '\001'
			return createVerticalHelper(layoutmanager);
	//   10   39:aload_0         
	//   11   40:invokestatic    #55  <Method OrientationHelper createVerticalHelper(RecyclerView$LayoutManager)>
	//   12   43:areturn         
		}
	}
	...
	//*   0    0:ldc1            #13  <Int 0x80000000>
	//*   1    2:aload_0         
	//*   2    3:getfield        #27  <Field int mLastTotalSpace>
	//*   3    6:icmpne          11
			return 0;
	//    4    9:iconst_0        
	//    5   10:ireturn         
	...
	//    6   11:aload_0         
	//    7   12:invokevirtual   #72  <Method int getTotalSpace()>
	//    8   15:aload_0         
	//    9   16:getfield        #27  <Field int mLastTotalSpace>
	//   10   19:isub            
	//   11   20:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:invokevirtual   #72  <Method int getTotalSpace()>
	//    3    5:putfield        #27  <Field int mLastTotalSpace>
	//    4    8:return          
	}
