...
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator
{
	...
	//*  20   38:iload           5
	//*  21   40:iload           6
	//*  22   42:invokevirtual   #52  <Method boolean animateChange(RecyclerView$ViewHolder, RecyclerView$ViewHolder, int, int, int, int)>
	//*  23   45:ireturn         
		{
			i = itemholderinfo1.left;
	//   24   46:aload           4
	//   25   48:getfield        #31  <Field int RecyclerView$ItemAnimator$ItemHolderInfo.left>
	//   26   51:istore          5
			j = itemholderinfo1.top;
	//   27   53:aload           4
	//   28   55:getfield        #34  <Field int RecyclerView$ItemAnimator$ItemHolderInfo.top>
	//   29   58:istore          6
		}
	...
	//*  15   28:ifnonnull       103
	//*  16   31:aload_2         
	//*  17   32:invokevirtual   #66  <Method int View.getTop()>
	//*  18   35:istore          5
	//*  19   37:aload_1         
	//*  20   38:invokevirtual   #69  <Method boolean RecyclerView$ViewHolder.isRemoved()>
	//*  21   41:ifne            112
	//*  22   44:iload           6
	//*  23   46:iload           4
	//*  24   48:icmpne          58
	...
	//*  30   61:iload           5
	//*  31   63:aload_2         
	//*  32   64:invokevirtual   #72  <Method int View.getWidth()>
	//*  33   67:iload           4
	//*  34   69:iadd            
	//*  35   70:aload_2         
	//*  36   71:invokevirtual   #75  <Method int View.getHeight()>
	//*  37   74:iload           5
	//*  38   76:iadd            
	//*  39   77:invokevirtual   #79  <Method void View.layout(int, int, int, int)>
	//*  40   80:aload_0         
	//*  41   81:aload_1         
	//*  42   82:iload           6
	//*  43   84:iload           7
	//*  44   86:iload           4
	//*  45   88:iload           5
	//*  46   90:invokevirtual   #38  <Method boolean animateMove(RecyclerView$ViewHolder, int, int, int, int)>
	//*  47   93:ireturn         
			i = itemholderinfo1.left;
	//   48   94:aload_3         
	//   49   95:getfield        #31  <Field int RecyclerView$ItemAnimator$ItemHolderInfo.left>
	//   50   98:istore          4
		if(itemholderinfo1 == null)
	...
	//*  51  100:goto            27
			j = itemholderinfo1.top;
	//   52  103:aload_3         
	//   53  104:getfield        #34  <Field int RecyclerView$ItemAnimator$ItemHolderInfo.top>
	//   54  107:istore          5
