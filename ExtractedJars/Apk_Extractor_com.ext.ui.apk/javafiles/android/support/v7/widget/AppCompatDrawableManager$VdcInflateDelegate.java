	...
	implements AppCompatDrawableManager.InflateDelegate
{
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #26  <Method android.content.res.Resources Context.getResources()>
	//    2    4:aload_2         
	//    3    5:aload_3         
	//    4    6:aload           4
	//    5    8:invokestatic    #31  <Method VectorDrawableCompat VectorDrawableCompat.createFromXmlInner(android.content.res.Resources, XmlPullParser, AttributeSet, android.content.res.Resources$Theme)>
	//    6   11:astore_1        
		}
	//*   7   12:aload_1         
	//*   8   13:areturn         
