...
public class AppCompatImageHelper
{
	...
	//   44   86:aload_2         
	//   45   87:aload_0         
	//   46   88:getfield        #21  <Field ImageView mView>
	//   47   91:invokevirtual   #64  <Method int[] ImageView.getDrawableState()>
	//   48   94:invokestatic    #70  <Method void AppCompatDrawableManager.tintDrawable(Drawable, TintInfo, int[])>
			return true;
	//   49   97:iconst_1        
	//   50   98:ireturn         
		} else
...
_L5:
	...
	//*  16   32:aload_0         
	//*  17   33:invokevirtual   #177 <Method void applySupportImageTint()>
	//*  18   36:return          
		{
			mView.setImageDrawable(((Drawable) (null)));
	//   19   37:aload_0         
	//   20   38:getfield        #21  <Field ImageView mView>
	//   21   41:aconst_null     
	//   22   42:invokevirtual   #141 <Method void ImageView.setImageDrawable(Drawable)>
		}
	...
	//*  18   38:aload_0         
	//*  19   39:invokevirtual   #177 <Method void applySupportImageTint()>
	//*  20   42:return          
		{
			mInternalImageTint = null;
	//   21   43:aload_0         
	//   22   44:aconst_null     
	//   23   45:putfield        #81  <Field TintInfo mInternalImageTint>
		}
		applySupportImageTint();
	//*  24   48:goto            38
	}
