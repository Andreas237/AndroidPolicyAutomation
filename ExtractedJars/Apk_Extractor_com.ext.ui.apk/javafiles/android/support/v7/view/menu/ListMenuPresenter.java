...
_L4:
	...
	//   16   34:aload_0         
	//   17   35:aload_2         
	//   18   36:putfield        #112 <Field MenuBuilder mMenu>
		if(mAdapter != null)
	//*  19   39:aload_0         
	//*  20   40:getfield        #71  <Field ListMenuPresenter$MenuAdapter mAdapter>
	//*  21   43:ifnull          53
			mAdapter.notifyDataSetChanged();
	//   22   46:aload_0         
	//   23   47:getfield        #71  <Field ListMenuPresenter$MenuAdapter mAdapter>
	//   24   50:invokevirtual   #115 <Method void ListMenuPresenter$MenuAdapter.notifyDataSetChanged()>
		return;
	//   25   53:return          
_L2:
		if(mContext != null)
	//*  26   54:aload_0         
	//*  27   55:getfield        #54  <Field Context mContext>
	//*  28   58:ifnull          34
		{
			mContext = context;
	//   29   61:aload_0         
	//   30   62:aload_1         
	//   31   63:putfield        #54  <Field Context mContext>
			if(mInflater == null)
	//*  32   66:aload_0         
	//*  33   67:getfield        #62  <Field LayoutInflater mInflater>
	//*  34   70:ifnonnull       34
				mInflater = LayoutInflater.from(mContext);
	//   35   73:aload_0         
	//   36   74:aload_0         
	//   37   75:getfield        #54  <Field Context mContext>
	//   38   78:invokestatic    #60  <Method LayoutInflater LayoutInflater.from(Context)>
	//   39   81:putfield        #62  <Field LayoutInflater mInflater>
		}
