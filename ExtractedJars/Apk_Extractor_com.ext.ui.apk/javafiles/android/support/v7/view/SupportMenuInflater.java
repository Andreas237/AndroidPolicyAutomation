...
_L10:
	...
	//	               2 163
	//	               3 250;
	//   35   72:tableswitch     1 3: default 100
	//	               1 368
	//	               2 163
	//	               3 250
...
_L14:
	...
	//   36  100:aload_1         
	//   37  101:invokeinterface #104 <Method int XmlPullParser.next()>
	//   38  106:istore          6
		if(true) goto _L10; else goto _L9
	//   39  108:goto            65
_L4:
		throw new RuntimeException((new StringBuilder()).append("Expecting menu, got ").append(((String) (menu))).toString());
	//   40  111:new             #106 <Class RuntimeException>
	//   41  114:dup             
	//   42  115:new             #108 <Class StringBuilder>
	//   43  118:dup             
	//   44  119:invokespecial   #110 <Method void StringBuilder()>
	//   45  122:ldc1            #112 <String "Expecting menu, got ">
	//   46  124:invokevirtual   #116 <Method StringBuilder StringBuilder.append(String)>
	//   47  127:aload_3         
	//   48  128:invokevirtual   #116 <Method StringBuilder StringBuilder.append(String)>
	//   49  131:invokevirtual   #119 <Method String StringBuilder.toString()>
	//   50  134:invokespecial   #122 <Method void RuntimeException(String)>
	//   51  137:athrow          
_L2:
		j = xmlpullparser.next();
	//   52  138:aload_1         
	//   53  139:invokeinterface #104 <Method int XmlPullParser.next()>
	//   54  144:istore          5
		i = j;
	//   55  146:iload           5
	//   56  148:istore          4
...
_L9:
	...
	//   66  171:aload_1         
	//   67  172:invokeinterface #95  <Method String XmlPullParser.getName()>
	//   68  177:astore          8
			if(s.equals("group"))
	//*  69  179:aload           8
	//*  70  181:ldc1            #28  <String "group">
	//*  71  183:invokevirtual   #101 <Method boolean String.equals(Object)>
	//*  72  186:ifeq            198
				menustate.readGroup(attributeset);
	//   73  189:aload           9
	//   74  191:aload_2         
	//   75  192:invokevirtual   #126 <Method void SupportMenuInflater$MenuState.readGroup(AttributeSet)>
			else
	//*  76  195:goto            100
			if(s.equals("item"))
	//*  77  198:aload           8
	//*  78  200:ldc1            #31  <String "item">
	//*  79  202:invokevirtual   #101 <Method boolean String.equals(Object)>
	//*  80  205:ifeq            217
				menustate.readItem(attributeset);
	//   81  208:aload           9
	//   82  210:aload_2         
	//   83  211:invokevirtual   #129 <Method void SupportMenuInflater$MenuState.readItem(AttributeSet)>
			else
	//*  84  214:goto            100
			if(s.equals("menu"))
	//*  85  217:aload           8
	//*  86  219:ldc1            #34  <String "menu">
	//*  87  221:invokevirtual   #101 <Method boolean String.equals(Object)>
	//*  88  224:ifeq            241
			{
	...
	//   91  229:aload_2         
	//   92  230:aload           9
	//   93  232:invokevirtual   #133 <Method SubMenu SupportMenuInflater$MenuState.addSubMenuItem()>
	//   94  235:invokespecial   #135 <Method void parseMenu(XmlPullParser, AttributeSet, Menu)>
			} else
	//*  95  238:goto            100
			{
				menu = ((Menu) (s));
...
_L8:
	...
	//  101  250:aload_1         
	//  102  251:invokeinterface #95  <Method String XmlPullParser.getName()>
	//  103  256:astore          8
		if(i != 0 && s1.equals(((Object) (menu))))
	//* 104  258:iload           4
	//* 105  260:ifeq            280
	//* 106  263:aload           8
	//* 107  265:aload_3         
	//* 108  266:invokevirtual   #101 <Method boolean String.equals(Object)>
	//* 109  269:ifeq            280
		{
			menu = null;
	//  110  272:aconst_null     
	...
	//* 114  277:goto            100
		if(s1.equals("group"))
	//* 115  280:aload           8
	//* 116  282:ldc1            #28  <String "group">
	//* 117  284:invokevirtual   #101 <Method boolean String.equals(Object)>
	//* 118  287:ifeq            298
			menustate.resetGroup();
	//  119  290:aload           9
	//  120  292:invokevirtual   #138 <Method void SupportMenuInflater$MenuState.resetGroup()>
		else
	//* 121  295:goto            100
		if(s1.equals("item"))
	//* 122  298:aload           8
	//* 123  300:ldc1            #31  <String "item">
	//* 124  302:invokevirtual   #101 <Method boolean String.equals(Object)>
	//* 125  305:ifeq            352
		{
			if(!menustate.hasAddedItem())
	//* 126  308:aload           9
	//* 127  310:invokevirtual   #142 <Method boolean SupportMenuInflater$MenuState.hasAddedItem()>
	//* 128  313:ifne            100
				if(menustate.itemActionProvider != null && menustate.itemActionProvider.hasSubMenu())
	//* 129  316:aload           9
	//* 130  318:getfield        #146 <Field ActionProvider SupportMenuInflater$MenuState.itemActionProvider>
	//* 131  321:ifnull          344
	//* 132  324:aload           9
	//* 133  326:getfield        #146 <Field ActionProvider SupportMenuInflater$MenuState.itemActionProvider>
	//* 134  329:invokevirtual   #151 <Method boolean ActionProvider.hasSubMenu()>
	//* 135  332:ifeq            344
					menustate.addSubMenuItem();
	//  136  335:aload           9
	//  137  337:invokevirtual   #133 <Method SubMenu SupportMenuInflater$MenuState.addSubMenuItem()>
	//  138  340:pop             
				else
	//* 139  341:goto            100
					menustate.addItem();
	//  140  344:aload           9
	//  141  346:invokevirtual   #154 <Method void SupportMenuInflater$MenuState.addItem()>
		} else
	//* 142  349:goto            100
		if(s1.equals("menu"))
	//* 143  352:aload           8
	//* 144  354:ldc1            #34  <String "menu">
	//* 145  356:invokevirtual   #101 <Method boolean String.equals(Object)>
	//* 146  359:ifeq            100
			j = 1;
	//  147  362:iconst_1        
	//  148  363:istore          5
...
_L6:
	...
	//  150  368:new             #106 <Class RuntimeException>
	//  151  371:dup             
	//  152  372:ldc1            #156 <String "Unexpected end of document">
	//  153  374:invokespecial   #122 <Method void RuntimeException(String)>
	//  154  377:athrow          
	//  155  378:return          
		  goto _L13
	}
