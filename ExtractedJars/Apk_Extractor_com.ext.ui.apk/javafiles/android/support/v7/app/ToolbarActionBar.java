...
class ToolbarActionBar extends ActionBar
{
	...
	void populateOptionsMenu()
	{
		...
		Menu menu = getMenu();
	//    0    0:aload_0         
	//    1    1:invokespecial   #214 <Method Menu getMenu()>
	//    2    4:astore_2        
		if(menu instanceof MenuBuilder)
	//*   3    5:aload_2         
	//*   4    6:instanceof      #251 <Class MenuBuilder>
	//*   5    9:ifeq            75
			menubuilder = (MenuBuilder)menu;
	//    6   12:aload_2         
	//    7   13:checkcast       #251 <Class MenuBuilder>
	//    8   16:astore_1        
		else
	//*   9   17:aload_1         
	//*  10   18:ifnull          25
	//*  11   21:aload_1         
	//*  12   22:invokevirtual   #254 <Method void MenuBuilder.stopDispatchingItemsChanged()>
	//*  13   25:aload_2         
	//*  14   26:invokeinterface #257 <Method void Menu.clear()>
	//*  15   31:aload_0         
	//*  16   32:getfield        #64  <Field android.view.Window$Callback mWindowCallback>
	//*  17   35:iconst_0        
	//*  18   36:aload_2         
	//*  19   37:invokeinterface #263 <Method boolean android.view.Window$Callback.onCreatePanelMenu(int, Menu)>
	//*  20   42:ifeq            60
	//*  21   45:aload_0         
	//*  22   46:getfield        #64  <Field android.view.Window$Callback mWindowCallback>
	//*  23   49:iconst_0        
	//*  24   50:aconst_null     
	//*  25   51:aload_2         
	//*  26   52:invokeinterface #267 <Method boolean android.view.Window$Callback.onPreparePanel(int, View, Menu)>
	//*  27   57:ifne            66
	//*  28   60:aload_2         
	//*  29   61:invokeinterface #257 <Method void Menu.clear()>
	//*  30   66:aload_1         
	//*  31   67:ifnull          74
	//*  32   70:aload_1         
	//*  33   71:invokevirtual   #270 <Method void MenuBuilder.startDispatchingItemsChanged()>
	//*  34   74:return          
			menubuilder = null;
	//   35   75:aconst_null     
	//   36   76:astore_1        
	...
	//*  40   82:ifnull          89
			menubuilder.startDispatchingItemsChanged();
	//   41   85:aload_1         
	//   42   86:invokevirtual   #270 <Method void MenuBuilder.startDispatchingItemsChanged()>
		throw exception;
	//   43   89:aload_2         
	//   44   90:athrow          
	}
