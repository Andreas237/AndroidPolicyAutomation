...
_L9:
	...
	//*   2    4:aload_2         
	//*   3    5:instanceof      #252 <Class ViewStub>
	//*   4    8:ifeq            71
				view = ((ViewStub)view1).inflate();
	//    5   11:aload_2         
	//    6   12:checkcast       #252 <Class ViewStub>
	//    7   15:invokevirtual   #256 <Method View ViewStub.inflate()>
	//    8   18:astore_1        
			else
	//*   9   19:aload_1         
	//*  10   20:checkcast       #206 <Class ViewGroup>
	//*  11   23:areturn         
	//*  12   24:aload_2         
	//*  13   25:ifnull          48
	//*  14   28:aload_2         
	//*  15   29:invokevirtual   #260 <Method android.view.ViewParent View.getParent()>
	//*  16   32:astore_3        
	//*  17   33:aload_3         
	//*  18   34:instanceof      #206 <Class ViewGroup>
	//*  19   37:ifeq            48
	//*  20   40:aload_3         
	//*  21   41:checkcast       #206 <Class ViewGroup>
	//*  22   44:aload_2         
	//*  23   45:invokevirtual   #264 <Method void ViewGroup.removeView(View)>
	//*  24   48:aload_1         
	//*  25   49:instanceof      #252 <Class ViewStub>
	//*  26   52:ifeq            68
	//*  27   55:aload_1         
	//*  28   56:checkcast       #252 <Class ViewStub>
	//*  29   59:invokevirtual   #256 <Method View ViewStub.inflate()>
	//*  30   62:astore_1        
	//*  31   63:aload_1         
	//*  32   64:checkcast       #206 <Class ViewGroup>
	//*  33   67:areturn         
	//*  34   68:goto            63
				view = view1;
	//   35   71:aload_2         
	...
	{
		final View bottom = null;
	//    0    0:aconst_null     
	//    1    1:astore          5
		View view1 = mWindow.findViewById(android.support.v7.appcompat.R.id.scrollIndicatorUp);
	//    2    3:aload_0         
	//    3    4:getfield        #119 <Field Window mWindow>
	//    4    7:getstatic       #274 <Field int android.support.v7.appcompat.R$id.scrollIndicatorUp>
	//    5   10:invokevirtual   #279 <Method View Window.findViewById(int)>
	//    6   13:astore          7
		View view = mWindow.findViewById(android.support.v7.appcompat.R.id.scrollIndicatorDown);
	//    7   15:aload_0         
	//    8   16:getfield        #119 <Field Window mWindow>
	//    9   19:getstatic       #282 <Field int android.support.v7.appcompat.R$id.scrollIndicatorDown>
	//   10   22:invokevirtual   #279 <Method View Window.findViewById(int)>
	//   11   25:astore          6
		if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  12   27:getstatic       #287 <Field int android.os.Build$VERSION.SDK_INT>
	//*  13   30:bipush          23
	//*  14   32:icmplt          65
		{
	...
	//   16   36:iload_3         
	//   17   37:iload           4
	//   18   39:invokestatic    #292 <Method void ViewCompat.setScrollIndicators(View, int, int)>
			if(view1 != null)
	//*  19   42:aload           7
	//*  20   44:ifnull          53
	...
	//   21   47:aload_1         
	//   22   48:aload           7
	//   23   50:invokevirtual   #264 <Method void ViewGroup.removeView(View)>
			if(view != null)
	//*  24   53:aload           6
	//*  25   55:ifnull          64
	...
	//   26   58:aload_1         
	//   27   59:aload           6
	//   28   61:invokevirtual   #264 <Method void ViewGroup.removeView(View)>
		} else
	//*  29   64:return          
		{
			top = view1;
	...
	//   40   82:aload_1         
	//   41   83:aload           7
	//   42   85:invokevirtual   #264 <Method void ViewGroup.removeView(View)>
					top = null;
	//   43   88:aconst_null     
	//   44   89:astore_2        
				}
	...
	//   51  101:aload_1         
	//   52  102:aload           6
	//   53  104:invokevirtual   #264 <Method void ViewGroup.removeView(View)>
			else
	//*  54  107:aload_2         
	...
	//*  57  113:ifnull          64
	//*  58  116:aload_0         
	//*  59  117:getfield        #294 <Field CharSequence mMessage>
	//*  60  120:ifnull          161
	//*  61  123:aload_0         
	//*  62  124:getfield        #296 <Field NestedScrollView mScrollView>
	//*  63  127:new             #8   <Class AlertController$2>
	//*  64  130:dup             
	//*  65  131:aload_0         
	//*  66  132:aload_2         
	//*  67  133:aload           5
	//*  68  135:invokespecial   #299 <Method void AlertController$2(AlertController, View, View)>
	//*  69  138:invokevirtual   #305 <Method void NestedScrollView.setOnScrollChangeListener(android.support.v4.widget.NestedScrollView$OnScrollChangeListener)>
	//*  70  141:aload_0         
	//*  71  142:getfield        #296 <Field NestedScrollView mScrollView>
	//*  72  145:new             #10  <Class AlertController$3>
	//*  73  148:dup             
	//*  74  149:aload_0         
	//*  75  150:aload_2         
	//*  76  151:aload           5
	//*  77  153:invokespecial   #306 <Method void AlertController$3(AlertController, View, View)>
	//*  78  156:invokevirtual   #310 <Method boolean NestedScrollView.post(Runnable)>
	//*  79  159:pop             
	//*  80  160:return          
	//*  81  161:aload_0         
	//*  82  162:getfield        #312 <Field ListView mListView>
	//*  83  165:ifnull          206
	//*  84  168:aload_0         
	//*  85  169:getfield        #312 <Field ListView mListView>
	//*  86  172:new             #12  <Class AlertController$4>
	//*  87  175:dup             
	//*  88  176:aload_0         
	//*  89  177:aload_2         
	//*  90  178:aload           5
	//*  91  180:invokespecial   #313 <Method void AlertController$4(AlertController, View, View)>
	//*  92  183:invokevirtual   #319 <Method void ListView.setOnScrollListener(android.widget.AbsListView$OnScrollListener)>
	//*  93  186:aload_0         
	//*  94  187:getfield        #312 <Field ListView mListView>
	//*  95  190:new             #14  <Class AlertController$5>
	//*  96  193:dup             
	//*  97  194:aload_0         
	//*  98  195:aload_2         
	//*  99  196:aload           5
	//* 100  198:invokespecial   #320 <Method void AlertController$5(AlertController, View, View)>
	//* 101  201:invokevirtual   #321 <Method boolean ListView.post(Runnable)>
	//* 102  204:pop             
	//* 103  205:return          
	//* 104  206:aload_2         
	//* 105  207:ifnull          215
	//* 106  210:aload_1         
	//* 107  211:aload_2         
	//* 108  212:invokevirtual   #264 <Method void ViewGroup.removeView(View)>
	//* 109  215:aload           5
	//* 110  217:ifnull          64
	//* 111  220:aload_1         
	//* 112  221:aload           5
	//* 113  223:invokevirtual   #264 <Method void ViewGroup.removeView(View)>
	//* 114  226:return          
				bottom = view;
	//  115  227:aload           6
	//  116  229:astore          5
	...
	//    2    2:aload_0         
	//    3    3:aload_1         
	//    4    4:ldc2            #324 <Int 0x1020019>
	//    5    7:invokevirtual   #325 <Method View ViewGroup.findViewById(int)>
	//    6   10:checkcast       #220 <Class Button>
	//    7   13:putfield        #327 <Field Button mButtonPositive>
		mButtonPositive.setOnClickListener(mButtonHandler);
	//    8   16:aload_0         
	//    9   17:getfield        #327 <Field Button mButtonPositive>
	//   10   20:aload_0         
	//   11   21:getfield        #113 <Field android.view.View$OnClickListener mButtonHandler>
	//   12   24:invokevirtual   #331 <Method void Button.setOnClickListener(android.view.View$OnClickListener)>
		int i;
		if(TextUtils.isEmpty(mButtonPositiveText))
	//*  13   27:aload_0         
	//*  14   28:getfield        #333 <Field CharSequence mButtonPositiveText>
	//*  15   31:invokestatic    #339 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  16   34:ifeq            176
		{
			mButtonPositive.setVisibility(8);
	//   17   37:aload_0         
	//   18   38:getfield        #327 <Field Button mButtonPositive>
	//   19   41:bipush          8
	//   20   43:invokevirtual   #340 <Method void Button.setVisibility(int)>
			i = 0;
	//   21   46:iconst_0        
	//   22   47:istore_2        
		} else
	...
	//   94  200:aload_0         
	//   95  201:getfield        #343 <Field Button mButtonNegative>
	//   96  204:aload_0         
	//   97  205:getfield        #345 <Field CharSequence mButtonNegativeText>
	//   98  208:invokevirtual   #361 <Method void Button.setText(CharSequence)>
			mButtonNegative.setVisibility(0);
	//   99  211:aload_0         
	//  100  212:getfield        #343 <Field Button mButtonNegative>
	//  101  215:iconst_0        
	//  102  216:invokevirtual   #340 <Method void Button.setVisibility(int)>
			i |= 2;
	//  103  219:iload_2         
	//  104  220:iconst_2        
	//  105  221:ior             
	...
	//  108  226:aload_0         
	//  109  227:getfield        #348 <Field Button mButtonNeutral>
	//  110  230:aload_0         
	//  111  231:getfield        #350 <Field CharSequence mButtonNeutralText>
	//  112  234:invokevirtual   #361 <Method void Button.setText(CharSequence)>
			mButtonNeutral.setVisibility(0);
	//  113  237:aload_0         
	//  114  238:getfield        #348 <Field Button mButtonNeutral>
	//  115  241:iconst_0        
	//  116  242:invokevirtual   #340 <Method void Button.setVisibility(int)>
			i |= 4;
	//  117  245:iload_2         
	//  118  246:iconst_4        
	//  119  247:ior             
	...
	//  125  257:aload_0         
	//  126  258:aload_0         
	//  127  259:getfield        #343 <Field Button mButtonNegative>
	//  128  262:invokespecial   #356 <Method void centerButton(Button)>
			else
	//* 129  265:goto            159
			if(i == 4)
	//* 130  268:iload_2         
	...
	//  133  273:aload_0         
	//  134  274:aload_0         
	//  135  275:getfield        #348 <Field Button mButtonNeutral>
	//  136  278:invokespecial   #356 <Method void centerButton(Button)>
		if(i != 0)
			i = ((int) (flag));
		else
	//* 137  281:goto            159
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #442 <Field View mCustomTitleView>
	//*   2    4:ifnull          44
		{
			android.view.ViewGroup.LayoutParams layoutparams = new android.view.ViewGroup.LayoutParams(-1, -2);
	//    3    7:new             #390 <Class android.view.ViewGroup$LayoutParams>
	//    4   10:dup             
	//    5   11:iconst_m1       
	//    6   12:bipush          -2
	//    7   14:invokespecial   #393 <Method void android.view.ViewGroup$LayoutParams(int, int)>
	//    8   17:astore_3        
			viewgroup.addView(mCustomTitleView, 0, layoutparams);
	//    9   18:aload_1         
	//   10   19:aload_0         
	//   11   20:getfield        #442 <Field View mCustomTitleView>
	//   12   23:iconst_0        
	//   13   24:aload_3         
	//   14   25:invokevirtual   #397 <Method void ViewGroup.addView(View, int, android.view.ViewGroup$LayoutParams)>
	...
	//   17   32:getstatic       #445 <Field int android.support.v7.appcompat.R$id.title_template>
	//   18   35:invokevirtual   #279 <Method View Window.findViewById(int)>
	//   19   38:bipush          8
	//   20   40:invokevirtual   #247 <Method void View.setVisibility(int)>
			return;
	//   21   43:return          
		}
	...
	//   25   49:ldc2            #446 <Int 0x1020006>
	//   26   52:invokevirtual   #279 <Method View Window.findViewById(int)>
	//   27   55:checkcast       #448 <Class ImageView>
	//   28   58:putfield        #450 <Field ImageView mIconView>
		boolean flag;
		if(!TextUtils.isEmpty(mTitle))
	//*  29   61:aload_0         
	//*  30   62:getfield        #452 <Field CharSequence mTitle>
	//*  31   65:invokestatic    #339 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  32   68:ifne            131
			flag = true;
	//   33   71:iconst_1        
	//   34   72:istore_2        
	...
	//*  36   74:ifeq            200
	//*  37   77:aload_0         
	//*  38   78:getfield        #186 <Field boolean mShowTitle>
	//*  39   81:ifeq            200
	//*  40   84:aload_0         
	//*  41   85:aload_0         
	//*  42   86:getfield        #119 <Field Window mWindow>
	//*  43   89:getstatic       #455 <Field int android.support.v7.appcompat.R$id.alertTitle>
	//*  44   92:invokevirtual   #279 <Method View Window.findViewById(int)>
	//*  45   95:checkcast       #375 <Class TextView>
	//*  46   98:putfield        #457 <Field TextView mTitleView>
	//*  47  101:aload_0         
	//*  48  102:getfield        #457 <Field TextView mTitleView>
	//*  49  105:aload_0         
	//*  50  106:getfield        #452 <Field CharSequence mTitle>
	//*  51  109:invokevirtual   #378 <Method void TextView.setText(CharSequence)>
	//*  52  112:aload_0         
	//*  53  113:getfield        #104 <Field int mIconId>
	//*  54  116:ifeq            136
	//*  55  119:aload_0         
	//*  56  120:getfield        #450 <Field ImageView mIconView>
	//*  57  123:aload_0         
	//*  58  124:getfield        #104 <Field int mIconId>
	//*  59  127:invokevirtual   #460 <Method void ImageView.setImageResource(int)>
	//*  60  130:return          
			flag = false;
	//   61  131:iconst_0        
	//   62  132:istore_2        
	...
	//*  63  133:goto            73
			if(mIcon != null)
	//*  64  136:aload_0         
	//*  65  137:getfield        #462 <Field Drawable mIcon>
	//*  66  140:ifnull          155
			{
				mIconView.setImageDrawable(mIcon);
	//   67  143:aload_0         
	//   68  144:getfield        #450 <Field ImageView mIconView>
	//   69  147:aload_0         
	//   70  148:getfield        #462 <Field Drawable mIcon>
	//   71  151:invokevirtual   #466 <Method void ImageView.setImageDrawable(Drawable)>
				return;
	//   72  154:return          
			} else
			{
	...
	//   73  155:aload_0         
	//   74  156:getfield        #457 <Field TextView mTitleView>
	//   75  159:aload_0         
	//   76  160:getfield        #450 <Field ImageView mIconView>
	//   77  163:invokevirtual   #469 <Method int ImageView.getPaddingLeft()>
	//   78  166:aload_0         
	//   79  167:getfield        #450 <Field ImageView mIconView>
	//   80  170:invokevirtual   #472 <Method int ImageView.getPaddingTop()>
	//   81  173:aload_0         
	//   82  174:getfield        #450 <Field ImageView mIconView>
	//   83  177:invokevirtual   #475 <Method int ImageView.getPaddingRight()>
	//   84  180:aload_0         
	//   85  181:getfield        #450 <Field ImageView mIconView>
	//   86  184:invokevirtual   #478 <Method int ImageView.getPaddingBottom()>
	//   87  187:invokevirtual   #479 <Method void TextView.setPadding(int, int, int, int)>
				mIconView.setVisibility(8);
	//   88  190:aload_0         
	//   89  191:getfield        #450 <Field ImageView mIconView>
	//   90  194:bipush          8
	//   91  196:invokevirtual   #480 <Method void ImageView.setVisibility(int)>
				return;
	//   92  199:return          
			}
		} else
	...
	//   95  204:getstatic       #445 <Field int android.support.v7.appcompat.R$id.title_template>
	//   96  207:invokevirtual   #279 <Method View Window.findViewById(int)>
	//   97  210:bipush          8
	//   98  212:invokevirtual   #247 <Method void View.setVisibility(int)>
			mIconView.setVisibility(8);
	//   99  215:aload_0         
	//  100  216:getfield        #450 <Field ImageView mIconView>
	//  101  219:bipush          8
	//  102  221:invokevirtual   #480 <Method void ImageView.setVisibility(int)>
			viewgroup.setVisibility(8);
	//  103  224:aload_1         
	//  104  225:bipush          8
	//  105  227:invokevirtual   #357 <Method void ViewGroup.setVisibility(int)>
			return;
	//  106  230:return          
		}
	}
	...
	//  214  459:iconst_0        
	//  215  460:istore_2        
				setScrollIndicators(((ViewGroup) (obj2)), ((View) (obj1)), byte0 | i, 3);
			}
		}
		obj1 = ((Object) (mListView));
