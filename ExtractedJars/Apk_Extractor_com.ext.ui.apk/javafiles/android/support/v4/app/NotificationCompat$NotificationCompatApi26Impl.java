...
static class NotificationCompat$NotificationCompatApi26Impl extends NotificationCompat$NotificationCompatApi24Impl
{
	...
	//   66  132:aload_1         
	//   67  133:getfield        #132 <Field int NotificationCompat$Builder.mBadgeIcon>
	//   68  136:aload_1         
	//   69  137:getfield        #135 <Field String NotificationCompat$Builder.mShortcutId>
	//   70  140:aload_1         
	//   71  141:getfield        #139 <Field long NotificationCompat$Builder.mTimeout>
	//   72  144:aload_1         
	//   73  145:getfield        #142 <Field boolean NotificationCompat$Builder.mColorized>
	//   74  148:aload_1         
	//   75  149:getfield        #145 <Field boolean NotificationCompat$Builder.mColorizedSet>
	//   76  152:aload_1         
	//   77  153:invokestatic    #149 <Method int NotificationCompat$Builder.access$000(NotificationCompat$Builder)>
	//   78  156:invokespecial   #152 <Method void NotificationCompatApi26$Builder(android.content.Context, Notification, CharSequence, CharSequence, CharSequence, android.widget.RemoteViews, int, android.app.PendingIntent, android.app.PendingIntent, android.graphics.Bitmap, int, int, boolean, boolean, boolean, int, CharSequence, boolean, String, java.util.ArrayList, android.os.Bundle, int, int, Notification, String, boolean, String, CharSequence[], android.widget.RemoteViews, android.widget.RemoteViews, android.widget.RemoteViews, String, int, String, long, boolean, boolean, int)>
	//   79  159:astore_3        
		NotificationCompat.addActionsToBuilder(((NotificationBuilderWithActions) (builder1)), builder.mActions);
	//   80  160:aload_3         
	//   81  161:aload_1         
	//   82  162:getfield        #155 <Field java.util.ArrayList NotificationCompat$Builder.mActions>
	//   83  165:invokestatic    #159 <Method void NotificationCompat.addActionsToBuilder(NotificationBuilderWithActions, java.util.ArrayList)>
		if(builder.mStyle != null)
	//*  84  168:aload_1         
	//*  85  169:getfield        #163 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//*  86  172:ifnull          183
			builder.mStyle.apply(((NotificationBuilderWithBuilderAccessor) (builder1)));
	//   87  175:aload_1         
	//   88  176:getfield        #163 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//   89  179:aload_3         
	//   90  180:invokevirtual   #169 <Method void NotificationCompat$Style.apply(NotificationBuilderWithBuilderAccessor)>
	...
	//   92  184:aload_1         
	//   93  185:aload_3         
	//   94  186:invokevirtual   #174 <Method Notification NotificationCompat$BuilderExtender.build(NotificationCompat$Builder, NotificationBuilderWithBuilderAccessor)>
	//   95  189:astore_2        
		if(builder.mStyle != null)
	//*  96  190:aload_1         
	//*  97  191:getfield        #163 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//*  98  194:ifnull          208
			builder.mStyle.addCompatExtras(NotificationCompat.getExtras(((Notification) (builderextender))));
	//   99  197:aload_1         
	//  100  198:getfield        #163 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//  101  201:aload_2         
	//  102  202:invokestatic    #178 <Method android.os.Bundle NotificationCompat.getExtras(Notification)>
	//  103  205:invokevirtual   #182 <Method void NotificationCompat$Style.addCompatExtras(android.os.Bundle)>
