...
static class NotificationCompat$NotificationCompatApi24Impl extends NotificationCompat$NotificationCompatApi21Impl
{
	...
	//   40   80:aload_1         
	//   41   81:getfield        #91  <Field ArrayList NotificationCompat$Builder.mPeople>
	//   42   84:aload_1         
	...
	//   64  128:aload_1         
	//   65  129:invokestatic    #130 <Method int NotificationCompat$Builder.access$000(NotificationCompat$Builder)>
	//   66  132:invokespecial   #133 <Method void NotificationCompatApi24$Builder(android.content.Context, Notification, CharSequence, CharSequence, CharSequence, android.widget.RemoteViews, int, android.app.PendingIntent, android.app.PendingIntent, android.graphics.Bitmap, int, int, boolean, boolean, boolean, int, CharSequence, boolean, String, ArrayList, android.os.Bundle, int, int, Notification, String, boolean, String, CharSequence[], android.widget.RemoteViews, android.widget.RemoteViews, android.widget.RemoteViews, int)>
	//   67  135:astore_3        
		NotificationCompat.addActionsToBuilder(((NotificationBuilderWithActions) (builder1)), builder.mActions);
	//   68  136:aload_3         
	//   69  137:aload_1         
	//   70  138:getfield        #136 <Field ArrayList NotificationCompat$Builder.mActions>
	//   71  141:invokestatic    #140 <Method void NotificationCompat.addActionsToBuilder(NotificationBuilderWithActions, ArrayList)>
		if(builder.mStyle != null)
	//*  72  144:aload_1         
	//*  73  145:getfield        #144 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//*  74  148:ifnull          159
			builder.mStyle.apply(((NotificationBuilderWithBuilderAccessor) (builder1)));
	//   75  151:aload_1         
	//   76  152:getfield        #144 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//   77  155:aload_3         
	//   78  156:invokevirtual   #150 <Method void NotificationCompat$Style.apply(NotificationBuilderWithBuilderAccessor)>
	...
	//   80  160:aload_1         
	//   81  161:aload_3         
	//   82  162:invokevirtual   #155 <Method Notification NotificationCompat$BuilderExtender.build(NotificationCompat$Builder, NotificationBuilderWithBuilderAccessor)>
	//   83  165:astore_2        
		if(builder.mStyle != null)
	//*  84  166:aload_1         
	//*  85  167:getfield        #144 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//*  86  170:ifnull          184
			builder.mStyle.addCompatExtras(NotificationCompat.getExtras(((Notification) (builderextender))));
	//   87  173:aload_1         
	//   88  174:getfield        #144 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//   89  177:aload_2         
	//   90  178:invokestatic    #159 <Method android.os.Bundle NotificationCompat.getExtras(Notification)>
	//   91  181:invokevirtual   #163 <Method void NotificationCompat$Style.addCompatExtras(android.os.Bundle)>
	...
	//    0    0:aload_1         
	//    1    1:iload_2         
	//    2    2:getstatic       #171 <Field NotificationCompatBase$Action$Factory NotificationCompat$Action.FACTORY>
	//    3    5:getstatic       #176 <Field RemoteInputCompatBase$RemoteInput$Factory RemoteInput.FACTORY>
	//    4    8:invokestatic    #181 <Method NotificationCompatBase$Action NotificationCompatApi24.getAction(Notification, int, NotificationCompatBase$Action$Factory, RemoteInputCompatBase$RemoteInput$Factory)>
	//    5   11:checkcast       #167 <Class NotificationCompat$Action>
	//    6   14:areturn         
	}

	public NotificationCompat.Action[] getActionsFromParcelableArrayList(ArrayList arraylist)
	{
		return (NotificationCompat.Action[])(NotificationCompat.Action[])NotificationCompatApi24.getActionsFromParcelableArrayList(arraylist, NotificationCompat.Action.FACTORY, RemoteInput.FACTORY);
	//    0    0:aload_1         
	//    1    1:getstatic       #171 <Field NotificationCompatBase$Action$Factory NotificationCompat$Action.FACTORY>
	//    2    4:getstatic       #176 <Field RemoteInputCompatBase$RemoteInput$Factory RemoteInput.FACTORY>
	//    3    7:invokestatic    #186 <Method NotificationCompatBase$Action[] NotificationCompatApi24.getActionsFromParcelableArrayList(ArrayList, NotificationCompatBase$Action$Factory, RemoteInputCompatBase$RemoteInput$Factory)>
	//    4   10:checkcast       #188 <Class NotificationCompat$Action[]>
	//    5   13:checkcast       #188 <Class NotificationCompat$Action[]>
	//    6   16:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #195 <Method ArrayList NotificationCompatApi24.getParcelableArrayListForActions(NotificationCompatBase$Action[])>
	//    2    4:areturn         
	}
