...
public final class RemoteInput extends RemoteInputCompatBase.RemoteInput
{
		...
		implements Impl
	{
		...
		//    1    1:aload_2         
		//    2    2:aload_3         
		//    3    3:invokestatic    #24  <Method void RemoteInputCompatApi20.addDataResultToIntent(RemoteInputCompatBase$RemoteInput, Intent, Map)>
		//    4    6:return          
		}
		...
		//    1    1:aload_2         
		//    2    2:aload_3         
		//    3    3:invokestatic    #31  <Method void RemoteInputCompatApi20.addResultsToIntent(RemoteInputCompatBase$RemoteInput[], Intent, Bundle)>
		//    4    6:return          
		}
		...
		//    0    0:aload_1         
		//    1    1:aload_2         
		//    2    2:invokestatic    #35  <Method Map RemoteInputCompatApi20.getDataResultsFromIntent(Intent, String)>
		//    3    5:areturn         
		}
		...
		//    0    0:aload_1         
		//    1    1:invokestatic    #40  <Method Bundle RemoteInputCompatApi20.getResultsFromIntent(Intent)>
		//    2    4:areturn         
		}
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #75  <Method void RemoteInputCompatBase$RemoteInput()>
		mResultKey = s;
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #77  <Field String mResultKey>
		mLabel = charsequence;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #79  <Field CharSequence mLabel>
		mChoices = acharsequence;
	//    8   14:aload_0         
	//    9   15:aload_3         
	//   10   16:putfield        #81  <Field CharSequence[] mChoices>
		mAllowFreeFormTextInput = flag;
	//   11   19:aload_0         
	//   12   20:iload           4
	//   13   22:putfield        #83  <Field boolean mAllowFreeFormTextInput>
		mExtras = bundle;
	//   14   25:aload_0         
	//   15   26:aload           5
	//   16   28:putfield        #85  <Field Bundle mExtras>
		mAllowedDataTypes = set;
	//   17   31:aload_0         
	//   18   32:aload           6
	//   19   34:putfield        #87  <Field Set mAllowedDataTypes>
	//   20   37:return          
	}
	...
	//    0    0:getstatic       #67  <Field RemoteInput$Impl IMPL>
	//    1    3:aload_0         
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:invokeinterface #93  <Method void RemoteInput$Impl.addDataResultToIntent(RemoteInput, Intent, Map)>
	//    5   11:return          
	}
	...
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:invokeinterface #98  <Method void RemoteInput$Impl.addResultsToIntent(RemoteInput[], Intent, Bundle)>
	//    5   11:return          
	}
	...
	//    1    3:aload_0         
	//    2    4:aload_1         
	//    3    5:invokeinterface #102 <Method Map RemoteInput$Impl.getDataResultsFromIntent(Intent, String)>
	//    4   10:areturn         
	}
	...
	//    0    0:getstatic       #67  <Field RemoteInput$Impl IMPL>
	//    1    3:aload_0         
	//    2    4:invokeinterface #107 <Method Bundle RemoteInput$Impl.getResultsFromIntent(Intent)>
	//    3    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #83  <Field boolean mAllowFreeFormTextInput>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #87  <Field Set mAllowedDataTypes>
	//    2    4:areturn         
	}
	...
	public CharSequence[] getChoices()
	{
		return mChoices;
	//    0    0:aload_0         
	//    1    1:getfield        #81  <Field CharSequence[] mChoices>
	//    2    4:areturn         
	}
	...
	public Bundle getExtras()
	{
		return mExtras;
	//    0    0:aload_0         
	//    1    1:getfield        #85  <Field Bundle mExtras>
	//    2    4:areturn         
	}
	...
	public CharSequence getLabel()
	{
		return mLabel;
	//    0    0:aload_0         
	//    1    1:getfield        #79  <Field CharSequence mLabel>
	//    2    4:areturn         
	}
	...
	public String getResultKey()
	{
		return mResultKey;
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field String mResultKey>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #123 <Method boolean getAllowFreeFormInput()>
	//    2    4:ifne            43
	//    3    7:aload_0         
	//    4    8:invokevirtual   #125 <Method CharSequence[] getChoices()>
	//    5   11:ifnull          22
	//    6   14:aload_0         
	//    7   15:invokevirtual   #125 <Method CharSequence[] getChoices()>
	//    8   18:arraylength     
	//    9   19:ifne            43
	//   10   22:aload_0         
	//   11   23:invokevirtual   #127 <Method Set getAllowedDataTypes()>
	//   12   26:ifnull          43
	//   13   29:aload_0         
	//   14   30:invokevirtual   #127 <Method Set getAllowedDataTypes()>
	//   15   33:invokeinterface #132 <Method boolean Set.isEmpty()>
	//   16   38:ifne            43
	//   17   41:iconst_1        
	//   18   42:ireturn         
	//   19   43:iconst_0        
...
;
	...
	//    4   11:dup             
	//    5   12:invokespecial   #65  <Method void RemoteInput$ImplApi20()>
	//    6   15:putstatic       #67  <Field RemoteInput$Impl IMPL>
		else
	//*   7   18:new             #6   <Class RemoteInput$1>
	//*   8   21:dup             
	//*   9   22:invokespecial   #68  <Method void RemoteInput$1()>
	//*  10   25:putstatic       #70  <Field RemoteInputCompatBase$RemoteInput$Factory FACTORY>
	//*  11   28:return          
		if(android.os.Build.VERSION.SDK_INT >= 16)
	//*  12   29:getstatic       #62  <Field int android.os.Build$VERSION.SDK_INT>
	//*  13   32:bipush          16
	//*  14   34:icmplt          50
			IMPL = ((Impl) (new ImplJellybean()));
	//   15   37:new             #20  <Class RemoteInput$ImplJellybean>
	//   16   40:dup             
	//   17   41:invokespecial   #71  <Method void RemoteInput$ImplJellybean()>
	//   18   44:putstatic       #67  <Field RemoteInput$Impl IMPL>
		else
	//*  19   47:goto            18
			IMPL = ((Impl) (new ImplBase()));
	//   20   50:new             #17  <Class RemoteInput$ImplBase>
	//   21   53:dup             
	//   22   54:invokespecial   #72  <Method void RemoteInput$ImplBase()>
	//   23   57:putstatic       #67  <Field RemoteInput$Impl IMPL>
	//*  24   60:goto            18
	}
}
