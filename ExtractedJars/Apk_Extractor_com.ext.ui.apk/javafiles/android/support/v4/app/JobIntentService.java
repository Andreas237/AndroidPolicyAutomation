...
label0:
	...
	//*  26   54:getstatic       #69  <Field HashMap sClassWorkEnqueuer>
	//*  27   57:aload_1         
	//*  28   58:aload_0         
	//*  29   59:invokevirtual   #131 <Method Object HashMap.put(Object, Object)>
	//*  30   62:pop             
	//*  31   63:aload_0         
	//*  32   64:astore          4
	//*  33   66:aload           4
	...
	//   35   69:new             #12  <Class JobIntentService$CompatWorkEnqueuer>
	//   36   72:dup             
	//   37   73:aload_0         
	//   38   74:aload_1         
	//   39   75:invokespecial   #134 <Method void JobIntentService$CompatWorkEnqueuer(Context, ComponentName)>
	//   40   78:astore_0        
			}
...
_L1:
	...
	//   16   33:aload           5
	//   17   35:new             #15  <Class JobIntentService$CompatWorkItem>
	//   18   38:dup             
	//   19   39:aload_0         
	//   20   40:aload_1         
	//   21   41:iload_3         
	//   22   42:invokespecial   #212 <Method void JobIntentService$CompatWorkItem(JobIntentService, Intent, int)>
	//   23   45:invokevirtual   #216 <Method boolean ArrayList.add(Object)>
	//   24   48:pop             
		ensureProcessorRunningLocked(true);
	//   25   49:aload_0         
	//   26   50:iconst_1        
	//   27   51:invokevirtual   #218 <Method void ensureProcessorRunningLocked(boolean)>
		arraylist;
	//   28   54:aload           4
		JVM INSTR monitorexit ;
	//   29   56:monitorexit     
	...
	//   31   58:ireturn         
		intent = new Intent();
	//   32   59:new             #220 <Class Intent>
	//   33   62:dup             
	//   34   63:invokespecial   #221 <Method void Intent()>
	//   35   66:astore_1        
		  goto _L1
	//*  36   67:goto            33
		intent;
...
_L2:
		if(!mDestroyed)
	//*  24   44:aload_0         
	//*  25   45:getfield        #77  <Field boolean mDestroyed>
	//*  26   48:ifne            41
			mCompatWorkEnqueuer.serviceProcessingFinished();
	//   27   51:aload_0         
	//   28   52:getfield        #166 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//   29   55:invokevirtual   #202 <Method void JobIntentService$WorkEnqueuer.serviceProcessingFinished()>
