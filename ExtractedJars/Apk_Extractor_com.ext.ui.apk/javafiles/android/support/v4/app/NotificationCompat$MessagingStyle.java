...
public static class NotificationCompat$MessagingStyle extends NotificationCompat.Style
{
	...
	//*  11   25:iload           4
	//*  12   27:ifeq            170
	//*  13   30:ldc1            #113 <Int 0xff000000>
	//*  14   32:istore_2        
	//*  15   33:aload_1         
	//*  16   34:invokevirtual   #72  <Method CharSequence NotificationCompat$MessagingStyle$Message.getSender()>
	//*  17   37:astore          5
	//*  18   39:aload_1         
	//*  19   40:invokevirtual   #72  <Method CharSequence NotificationCompat$MessagingStyle$Message.getSender()>
	//*  20   43:invokestatic    #78  <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  21   46:ifeq            192
	//*  22   49:aload_0         
	//*  23   50:getfield        #33  <Field CharSequence mUserDisplayName>
	//*  24   53:ifnonnull       175
	//*  25   56:ldc1            #115 <String "">
	//*  26   58:astore          5
	//*  27   60:iload_2         
	//*  28   61:istore_3        
	//*  29   62:iload           4
	...
	//*  32   68:istore_3        
	//*  33   69:aload_0         
	//*  34   70:getfield        #119 <Field NotificationCompat$Builder mBuilder>
	//*  35   73:invokevirtual   #124 <Method int NotificationCompat$Builder.getColor()>
	//*  36   76:ifeq            87
	//*  37   79:aload_0         
	//*  38   80:getfield        #119 <Field NotificationCompat$Builder mBuilder>
	//*  39   83:invokevirtual   #124 <Method int NotificationCompat$Builder.getColor()>
	//*  40   86:istore_3        
	//*  41   87:aload           6
	//*  42   89:aload           5
	//*  43   91:invokevirtual   #128 <Method CharSequence BidiFormatter.unicodeWrap(CharSequence)>
	//*  44   94:astore          5
	//*  45   96:aload           7
	//*  46   98:aload           5
	//*  47  100:invokevirtual   #132 <Method SpannableStringBuilder SpannableStringBuilder.append(CharSequence)>
	//*  48  103:pop             
	//*  49  104:aload           7
	//*  50  106:aload_0         
	//*  51  107:iload_3         
	//*  52  108:invokespecial   #134 <Method TextAppearanceSpan makeFontColorSpan(int)>
	//*  53  111:aload           7
	//*  54  113:invokevirtual   #137 <Method int SpannableStringBuilder.length()>
	//*  55  116:aload           5
	//*  56  118:invokeinterface #140 <Method int CharSequence.length()>
	//*  57  123:isub            
	//*  58  124:aload           7
	//*  59  126:invokevirtual   #137 <Method int SpannableStringBuilder.length()>
	//*  60  129:bipush          33
	//*  61  131:invokevirtual   #144 <Method void SpannableStringBuilder.setSpan(Object, int, int, int)>
	//*  62  134:aload_1         
	//*  63  135:invokevirtual   #147 <Method CharSequence NotificationCompat$MessagingStyle$Message.getText()>
	//*  64  138:ifnonnull       184
	//*  65  141:ldc1            #115 <String "">
	//*  66  143:astore_1        
	//*  67  144:aload           7
	//*  68  146:ldc1            #149 <String "  ">
	//*  69  148:invokevirtual   #132 <Method SpannableStringBuilder SpannableStringBuilder.append(CharSequence)>
	//*  70  151:aload           6
	//*  71  153:aload_1         
	//*  72  154:invokevirtual   #128 <Method CharSequence BidiFormatter.unicodeWrap(CharSequence)>
	//*  73  157:invokevirtual   #132 <Method SpannableStringBuilder SpannableStringBuilder.append(CharSequence)>
	//*  74  160:pop             
	//*  75  161:aload           7
	//*  76  163:areturn         
			flag = false;
	...
	//   83  175:aload_0         
	//   84  176:getfield        #33  <Field CharSequence mUserDisplayName>
	//   85  179:astore          5
			j = i;
			if(flag)
			{
	...
	//*  86  181:goto            60
	//*  87  184:aload_1         
	//*  88  185:invokevirtual   #147 <Method CharSequence NotificationCompat$MessagingStyle$Message.getText()>
	//*  89  188:astore_1        
	//*  90  189:goto            144
		{
			j = i;
	...
	//   92  193:istore_3        
		...
		obj = ((Object) (bidiformatter.unicodeWrap(((CharSequence) (obj)))));
