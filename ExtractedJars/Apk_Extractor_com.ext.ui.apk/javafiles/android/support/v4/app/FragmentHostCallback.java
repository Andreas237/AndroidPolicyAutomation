...
_L3:
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #236 <Method int SimpleArrayMap.size()>
	//    4    8:istore_3        
			for(int i = 0; i < j; i++)
	//*   5    9:iconst_0        
	//*   6   10:istore_2        
	...
	//    1    1:istore_2        
		...
		if(mAllLoaderManagers != null)
	//*   2    2:aload_0         
	//*   3    3:getfield        #145 <Field SimpleArrayMap mAllLoaderManagers>
	//*   4    6:ifnull          147
		{
			int k = mAllLoaderManagers.size();
	//    5    9:aload_0         
	//    6   10:getfield        #145 <Field SimpleArrayMap mAllLoaderManagers>
	//    7   13:invokevirtual   #236 <Method int SimpleArrayMap.size()>
	//    8   16:istore          4
			LoaderManagerImpl aloadermanagerimpl[] = new LoaderManagerImpl[k];
	//    9   18:iload           4
	//   10   20:anewarray       LoaderManagerImpl[]
	//   11   23:astore          6
			for(int i = k - 1; i >= 0; i--)
	//*  12   25:iload           4
	//*  13   27:iconst_1        
	...
	//   19   36:iload_1         
	//   20   37:aload_0         
	//   21   38:getfield        #145 <Field SimpleArrayMap mAllLoaderManagers>
	//   22   41:iload_1         
	//   23   42:invokevirtual   #240 <Method Object SimpleArrayMap.valueAt(int)>
	//   24   45:checkcast       #57  <Class LoaderManagerImpl>
	//   25   48:aastore         
	...
	//   31   56:aload_0         
	//   32   57:invokevirtual   #258 <Method boolean getRetainLoaders()>
	//   33   60:istore          5
			boolean flag = false;
	//   34   62:iconst_0        
	//   35   63:istore_1        
	...
	//*  45   78:aload           7
	//*  46   80:getfield        #167 <Field boolean LoaderManagerImpl.mRetaining>
	//*  47   83:ifne            109
	//*  48   86:iload           5
	//*  49   88:ifeq            109
				{
					if(!loadermanagerimpl.mStarted)
	//*  50   91:aload           7
	//*  51   93:getfield        #81  <Field boolean LoaderManagerImpl.mStarted>
	//*  52   96:ifne            104
						loadermanagerimpl.doStart();
	//   53   99:aload           7
	//   54  101:invokevirtual   #70  <Method void LoaderManagerImpl.doStart()>
					loadermanagerimpl.doRetain();
	//   55  104:aload           7
	//   56  106:invokevirtual   #64  <Method void LoaderManagerImpl.doRetain()>
				}
				if(loadermanagerimpl.mRetaining)
	//*  57  109:aload           7
	//*  58  111:getfield        #167 <Field boolean LoaderManagerImpl.mRetaining>
	//*  59  114:ifeq            126
				{
					flag = true;
	//   60  117:iconst_1        
	...
	//*  66  123:goto            64
				{
					loadermanagerimpl.doDestroy();
	//   67  126:aload           7
	//   68  128:invokevirtual   #60  <Method void LoaderManagerImpl.doDestroy()>
					mAllLoaderManagers.remove(((Object) (loadermanagerimpl.mWho)));
	//   69  131:aload_0         
	//   70  132:getfield        #145 <Field SimpleArrayMap mAllLoaderManagers>
	//   71  135:aload           7
	//   72  137:getfield        #262 <Field String LoaderManagerImpl.mWho>
	//   73  140:invokevirtual   #170 <Method Object SimpleArrayMap.remove(Object)>
	//   74  143:pop             
				}
				j++;
			} while(true);
	...
	//   80  153:aload_0         
	//   81  154:getfield        #145 <Field SimpleArrayMap mAllLoaderManagers>
	//   82  157:areturn         
		else
			return null;
	//   83  158:aconst_null     
