...
_L2:
	...
	//    8   12:aload_0         
	//    9   13:instanceof      #42  <Class TransitionSet>
	//   10   16:ifeq            50
		obj = ((Object) ((TransitionSet)obj));
	//   11   19:aload_0         
	//   12   20:checkcast       #42  <Class TransitionSet>
	//   13   23:astore_0        
		int k = ((TransitionSet) (obj)).getTransitionCount();
	//   14   24:aload_0         
	//   15   25:invokevirtual   #46  <Method int TransitionSet.getTransitionCount()>
	//   16   28:istore_3        
		while(i < k) 
	//*  17   29:iload_2         
	//*  18   30:iload_3         
...
label0:
	...
	//    9   14:aload_0         
	//   10   15:iload_3         
	//   11   16:invokeinterface #98  <Method Object List.get(int)>
	//   12   21:aload_1         
	//   13   22:if_acmpne       31
					flag = true;
	//   14   25:iconst_1        
	...
	//    4    6:astore_0        
		if(obj instanceof TransitionSet)
	//*   5    7:aload_0         
	//*   6    8:instanceof      #42  <Class TransitionSet>
	//*   7   11:ifeq            48
		{
			obj = ((Object) ((TransitionSet)obj));
	//    8   14:aload_0         
	//    9   15:checkcast       #42  <Class TransitionSet>
	//   10   18:astore_0        
			for(int l = ((TransitionSet) (obj)).getTransitionCount(); i < l; i++)
	//*  11   19:aload_0         
	//*  12   20:invokevirtual   #46  <Method int TransitionSet.getTransitionCount()>
	//*  13   23:istore          4
	//*  14   25:iload_3         
	//*  15   26:iload           4
	//*  16   28:icmpge          168
