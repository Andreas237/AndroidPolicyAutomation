	...
	implements NotificationCompat.Extender
{
	...
	//*  36   69:aload_1         
	//*  37   70:ifnull          254
	//*  38   73:getstatic       #144 <Field NotificationCompat$NotificationCompatImpl NotificationCompat.IMPL>
	//*  39   76:aload_1         
	//*  40   77:ldc1            #36  <String "actions">
	//*  41   79:invokevirtual   #148 <Method ArrayList Bundle.getParcelableArrayList(String)>
	//*  42   82:invokeinterface #154 <Method NotificationCompat$Action[] NotificationCompat$NotificationCompatImpl.getActionsFromParcelableArrayList(ArrayList)>
	//*  43   87:astore_2        
	//*  44   88:aload_2         
	//*  45   89:ifnull          101
	//*  46   92:aload_0         
	//*  47   93:getfield        #116 <Field ArrayList mActions>
	//*  48   96:aload_2         
	//*  49   97:invokestatic    #160 <Method boolean Collections.addAll(java.util.Collection, Object[])>
	//*  50  100:pop             
	//*  51  101:aload_0         
	//*  52  102:aload_1         
	//*  53  103:ldc1            #66  <String "flags">
	//*  54  105:iconst_1        
	//*  55  106:invokevirtual   #164 <Method int Bundle.getInt(String, int)>
	//*  56  109:putfield        #118 <Field int mFlags>
	//*  57  112:aload_0         
	//*  58  113:aload_1         
	//*  59  114:ldc1            #63  <String "displayIntent">
	//*  60  116:invokevirtual   #168 <Method android.os.Parcelable Bundle.getParcelable(String)>
	//*  61  119:checkcast       #170 <Class PendingIntent>
	//*  62  122:putfield        #172 <Field PendingIntent mDisplayIntent>
	//*  63  125:aload_1         
	//*  64  126:ldc1            #75  <String "pages">
	//*  65  128:invokestatic    #176 <Method Notification[] NotificationCompat.getNotificationArrayFromBundle(Bundle, String)>
	//*  66  131:astore_2        
	//*  67  132:aload_2         
	//*  68  133:ifnull          145
	//*  69  136:aload_0         
	//*  70  137:getfield        #120 <Field ArrayList mPages>
	//*  71  140:aload_2         
	//*  72  141:invokestatic    #160 <Method boolean Collections.addAll(java.util.Collection, Object[])>
	//*  73  144:pop             
	//*  74  145:aload_0         
	//*  75  146:aload_1         
	//*  76  147:ldc1            #39  <String "background">
	//*  77  149:invokevirtual   #168 <Method android.os.Parcelable Bundle.getParcelable(String)>
	//*  78  152:checkcast       #178 <Class Bitmap>
	//*  79  155:putfield        #180 <Field Bitmap mBackground>
	//*  80  158:aload_0         
	//*  81  159:aload_1         
	//*  82  160:ldc1            #48  <String "contentIcon">
	//*  83  162:invokevirtual   #183 <Method int Bundle.getInt(String)>
	//*  84  165:putfield        #185 <Field int mContentIcon>
	//*  85  168:aload_0         
	//*  86  169:aload_1         
	//*  87  170:ldc1            #51  <String "contentIconGravity">
	//*  88  172:ldc1            #12  <Int 0x800005>
	//*  89  174:invokevirtual   #164 <Method int Bundle.getInt(String, int)>
	//*  90  177:putfield        #122 <Field int mContentIconGravity>
	//*  91  180:aload_0         
	//*  92  181:aload_1         
	//*  93  182:ldc1            #45  <String "contentActionIndex">
	//*  94  184:iconst_m1       
	//*  95  185:invokevirtual   #164 <Method int Bundle.getInt(String, int)>
	//*  96  188:putfield        #124 <Field int mContentActionIndex>
	//*  97  191:aload_0         
	//*  98  192:aload_1         
	//*  99  193:ldc1            #57  <String "customSizePreset">
	//* 100  195:iconst_0        
	//* 101  196:invokevirtual   #164 <Method int Bundle.getInt(String, int)>
	//* 102  199:putfield        #126 <Field int mCustomSizePreset>
	//* 103  202:aload_0         
	//* 104  203:aload_1         
	//* 105  204:ldc1            #54  <String "customContentHeight">
	//* 106  206:invokevirtual   #183 <Method int Bundle.getInt(String)>
	//* 107  209:putfield        #187 <Field int mCustomContentHeight>
	//* 108  212:aload_0         
	//* 109  213:aload_1         
	//* 110  214:ldc1            #69  <String "gravity">
	//* 111  216:bipush          80
	//* 112  218:invokevirtual   #164 <Method int Bundle.getInt(String, int)>
	//* 113  221:putfield        #128 <Field int mGravity>
	//* 114  224:aload_0         
	//* 115  225:aload_1         
	//* 116  226:ldc1            #72  <String "hintScreenTimeout">
	//* 117  228:invokevirtual   #183 <Method int Bundle.getInt(String)>
	//* 118  231:putfield        #189 <Field int mHintScreenTimeout>
	//* 119  234:aload_0         
	//* 120  235:aload_1         
	//* 121  236:ldc1            #60  <String "dismissalId">
	//* 122  238:invokevirtual   #193 <Method String Bundle.getString(String)>
	//* 123  241:putfield        #195 <Field String mDismissalId>
	//* 124  244:aload_0         
	//* 125  245:aload_1         
	//* 126  246:ldc1            #42  <String "bridgeTag">
	//* 127  248:invokevirtual   #193 <Method String Bundle.getString(String)>
	//* 128  251:putfield        #197 <Field String mBridgeTag>
	//* 129  254:return          
			notification = null;
	//  130  255:aconst_null     
	//  131  256:astore_1        
