...
public final class ShareCompat
{
	...
	public static class IntentReader
	{
		...
		{
			Object obj = ((Object) (mIntent.getStringExtra("android.intent.extra.HTML_TEXT")));
		//    0    0:aload_0         
		//    1    1:getfield        #35  <Field Intent mIntent>
		...
		//    7   14:aload_0         
		//    8   15:invokevirtual   #157 <Method CharSequence getText()>
		//    9   18:astore_1        
				if(charsequence instanceof Spanned)
		//*  10   19:aload_1         
		//*  11   20:instanceof      #159 <Class Spanned>
		//*  12   23:ifeq            34
					return Html.toHtml((Spanned)charsequence);
		//   13   26:aload_1         
		//   14   27:checkcast       #159 <Class Spanned>
		//   15   30:invokestatic    #165 <Method String Html.toHtml(Spanned)>
		//   16   33:areturn         
				if(charsequence != null)
		//*  17   34:aload_1         
		//*  18   35:ifnull          76
					if(android.os.Build.VERSION.SDK_INT >= 16)
		//*  19   38:getstatic       #171 <Field int android.os.Build$VERSION.SDK_INT>
		//*  20   41:bipush          16
		//*  21   43:icmplt          51
					{
						return Html.escapeHtml(charsequence);
		//   22   46:aload_1         
		//   23   47:invokestatic    #175 <Method String Html.escapeHtml(CharSequence)>
		//   24   50:areturn         
					} else
					{
						obj = ((Object) (new StringBuilder()));
		//   25   51:new             #64  <Class StringBuilder>
		//   26   54:dup             
		//   27   55:invokespecial   #73  <Method void StringBuilder()>
		//   28   58:astore_2        
		...
		//   31   61:iconst_0        
		//   32   62:aload_1         
		//   33   63:invokeinterface #179 <Method int CharSequence.length()>
		//   34   68:invokestatic    #181 <Method void withinStyle(StringBuilder, CharSequence, int, int)>
						return ((StringBuilder) (obj)).toString();
		//   35   71:aload_2         
		//   36   72:invokevirtual   #84  <Method String StringBuilder.toString()>
		//   37   75:areturn         
					}
			}
			return ((String) (obj));
