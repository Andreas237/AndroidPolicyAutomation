	...
	implements android.view.View.OnAttachStateChangeListener, android.view.ViewTreeObserver.OnPreDrawListener
{
	...
	//*   8   18:aload_0         
	//*   9   19:getfield        #21  <Field View mView>
	//*  10   22:aload_0         
	//*  11   23:invokevirtual   #68  <Method void View.removeOnAttachStateChangeListener(android.view.View$OnAttachStateChangeListener)>
	//*  12   26:return          
			mView.getViewTreeObserver().removeOnPreDrawListener(((android.view.ViewTreeObserver.OnPreDrawListener) (this)));
	//   13   27:aload_0         
	//   14   28:getfield        #21  <Field View mView>
	//   15   31:invokevirtual   #27  <Method ViewTreeObserver View.getViewTreeObserver()>
	//   16   34:aload_0         
	//   17   35:invokevirtual   #65  <Method void ViewTreeObserver.removeOnPreDrawListener(android.view.ViewTreeObserver$OnPreDrawListener)>
