	...
	implements Iterable
{
	...
	//*   4    6:ifeq            19
			obj = ((Object) (((SupportParentable)activity).getSupportParentActivityIntent()));
	//    5    9:aload_1         
	...
	//*   9   19:aload_2         
	//*  10   20:ifnonnull       69
			activity = ((Activity) (NavUtils.getParentActivityIntent(activity)));
	//   11   23:aload_1         
	//   12   24:invokestatic    #100 <Method Intent NavUtils.getParentActivityIntent(Activity)>
	//   13   27:astore_1        
		else
	//*  14   28:aload_1         
	//*  15   29:ifnull          67
	//*  16   32:aload_1         
	//*  17   33:invokevirtual   #73  <Method ComponentName Intent.getComponent()>
	//*  18   36:astore_3        
	//*  19   37:aload_3         
	//*  20   38:astore_2        
	//*  21   39:aload_3         
	...
	//*  23   43:aload_1         
	//*  24   44:aload_0         
	//*  25   45:getfield        #51  <Field Context mSourceContext>
	//*  26   48:invokevirtual   #79  <Method android.content.pm.PackageManager Context.getPackageManager()>
	//*  27   51:invokevirtual   #83  <Method ComponentName Intent.resolveActivity(android.content.pm.PackageManager)>
	//*  28   54:astore_2        
	//*  29   55:aload_0         
	//*  30   56:aload_2         
	//*  31   57:invokevirtual   #87  <Method TaskStackBuilder addParentStack(ComponentName)>
	//*  32   60:pop             
	//*  33   61:aload_0         
	//*  34   62:aload_1         
	//*  35   63:invokevirtual   #89  <Method TaskStackBuilder addNextIntent(Intent)>
	//*  36   66:pop             
	//*  37   67:aload_0         
	//*  38   68:areturn         
	...
	//   40   70:astore_1        
		if(activity != null)
		{
			ComponentName componentname = ((Intent) (activity)).getComponent();
			obj = ((Object) (componentname));
			if(componentname == null)
				obj = ((Object) (((Intent) (activity)).resolveActivity(mSourceContext.getPackageManager())));
			addParentStack(((ComponentName) (obj)));
			addNextIntent(((Intent) (activity)));
		}
		return this;
	//*  41   71:goto            28
	}
