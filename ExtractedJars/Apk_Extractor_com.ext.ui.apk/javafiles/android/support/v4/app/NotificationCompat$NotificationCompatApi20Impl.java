...
static class NotificationCompat$NotificationCompatApi20Impl extends NotificationCompat$NotificationCompatApi19Impl
{
	...
	//   38   76:aload_1         
	//   39   77:getfield        #87  <Field ArrayList NotificationCompat$Builder.mPeople>
	//   40   80:aload_1         
	...
	//   52  104:aload_1         
	//   53  105:invokestatic    #111 <Method int NotificationCompat$Builder.access$000(NotificationCompat$Builder)>
	//   54  108:invokespecial   #114 <Method void NotificationCompatApi20$Builder(android.content.Context, Notification, CharSequence, CharSequence, CharSequence, android.widget.RemoteViews, int, android.app.PendingIntent, android.app.PendingIntent, android.graphics.Bitmap, int, int, boolean, boolean, boolean, int, CharSequence, boolean, ArrayList, android.os.Bundle, String, boolean, String, android.widget.RemoteViews, android.widget.RemoteViews, int)>
	//   55  111:astore_3        
		NotificationCompat.addActionsToBuilder(((NotificationBuilderWithActions) (builder1)), builder.mActions);
	//   56  112:aload_3         
	//   57  113:aload_1         
	//   58  114:getfield        #117 <Field ArrayList NotificationCompat$Builder.mActions>
	//   59  117:invokestatic    #121 <Method void NotificationCompat.addActionsToBuilder(NotificationBuilderWithActions, ArrayList)>
		if(builder.mStyle != null)
	//*  60  120:aload_1         
	//*  61  121:getfield        #125 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//*  62  124:ifnull          135
			builder.mStyle.apply(((NotificationBuilderWithBuilderAccessor) (builder1)));
	//   63  127:aload_1         
	//   64  128:getfield        #125 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//   65  131:aload_3         
	//   66  132:invokevirtual   #131 <Method void NotificationCompat$Style.apply(NotificationBuilderWithBuilderAccessor)>
	...
	//   68  136:aload_1         
	//   69  137:aload_3         
	//   70  138:invokevirtual   #136 <Method Notification NotificationCompat$BuilderExtender.build(NotificationCompat$Builder, NotificationBuilderWithBuilderAccessor)>
	//   71  141:astore_2        
		if(builder.mStyle != null)
	//*  72  142:aload_1         
	//*  73  143:getfield        #125 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//*  74  146:ifnull          160
			builder.mStyle.addCompatExtras(NotificationCompat.getExtras(((Notification) (builderextender))));
	//   75  149:aload_1         
	//   76  150:getfield        #125 <Field NotificationCompat$Style NotificationCompat$Builder.mStyle>
	//   77  153:aload_2         
	//   78  154:invokestatic    #140 <Method android.os.Bundle NotificationCompat.getExtras(Notification)>
	//   79  157:invokevirtual   #144 <Method void NotificationCompat$Style.addCompatExtras(android.os.Bundle)>
	...
	//    0    0:aload_1         
	//    1    1:iload_2         
	//    2    2:getstatic       #152 <Field NotificationCompatBase$Action$Factory NotificationCompat$Action.FACTORY>
	//    3    5:getstatic       #157 <Field RemoteInputCompatBase$RemoteInput$Factory RemoteInput.FACTORY>
	//    4    8:invokestatic    #162 <Method NotificationCompatBase$Action NotificationCompatApi20.getAction(Notification, int, NotificationCompatBase$Action$Factory, RemoteInputCompatBase$RemoteInput$Factory)>
	//    5   11:checkcast       #148 <Class NotificationCompat$Action>
	//    6   14:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:getstatic       #152 <Field NotificationCompatBase$Action$Factory NotificationCompat$Action.FACTORY>
	//    2    4:getstatic       #157 <Field RemoteInputCompatBase$RemoteInput$Factory RemoteInput.FACTORY>
	//    3    7:invokestatic    #167 <Method NotificationCompatBase$Action[] NotificationCompatApi20.getActionsFromParcelableArrayList(ArrayList, NotificationCompatBase$Action$Factory, RemoteInputCompatBase$RemoteInput$Factory)>
	//    4   10:checkcast       #169 <Class NotificationCompat$Action[]>
	//    5   13:checkcast       #169 <Class NotificationCompat$Action[]>
	//    6   16:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #176 <Method ArrayList NotificationCompatApi20.getParcelableArrayListForActions(NotificationCompatBase$Action[])>
	//    2    4:areturn         
	}
