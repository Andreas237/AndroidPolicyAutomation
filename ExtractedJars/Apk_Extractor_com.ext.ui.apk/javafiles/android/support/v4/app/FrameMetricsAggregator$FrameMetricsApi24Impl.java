...
private static class FrameMetricsAggregator$FrameMetricsApi24Impl extends FrameMetricsAggregator.FrameMetricsBaseImpl
{
	...
	//*   0    0:getstatic       #33  <Field HandlerThread sHandlerThread>
	//*   1    3:ifnonnull       40
		{
			sHandlerThread = new HandlerThread("FrameMetricsAggregator");
	//    2    6:new             #66  <Class HandlerThread>
	//    3    9:dup             
	//    4   10:ldc1            #68  <String "FrameMetricsAggregator">
	//    5   12:invokespecial   #71  <Method void HandlerThread(String)>
	//    6   15:putstatic       #33  <Field HandlerThread sHandlerThread>
			sHandlerThread.start();
	//    7   18:getstatic       #33  <Field HandlerThread sHandlerThread>
	//    8   21:invokevirtual   #74  <Method void HandlerThread.start()>
			sHandler = new Handler(sHandlerThread.getLooper());
	//    9   24:new             #76  <Class Handler>
	//   10   27:dup             
	//   11   28:getstatic       #33  <Field HandlerThread sHandlerThread>
	//   12   31:invokevirtual   #80  <Method android.os.Looper HandlerThread.getLooper()>
	//   13   34:invokespecial   #83  <Method void Handler(android.os.Looper)>
	//   14   37:putstatic       #35  <Field Handler sHandler>
		}
		for(int i = 0; i <= 8; i++)
	//*  15   40:iconst_0        
	//*  16   41:istore_2        
	...
	//*  20   48:aload_0         
	//*  21   49:getfield        #45  <Field SparseIntArray[] mMetrics>
	//*  22   52:iload_2         
	//*  23   53:aaload          
	//*  24   54:ifnonnull       81
	//*  25   57:aload_0         
	//*  26   58:getfield        #58  <Field int mTrackingFlags>
	//*  27   61:iconst_1        
	//*  28   62:iload_2         
	//*  29   63:ishl            
	//*  30   64:iand            
	...
	//   32   68:aload_0         
	//   33   69:getfield        #45  <Field SparseIntArray[] mMetrics>
	//   34   72:iload_2         
	//   35   73:new             #43  <Class SparseIntArray>
	//   36   76:dup             
	...
	//   46   92:aload_0         
	//   47   93:getfield        #56  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
	//   48   96:getstatic       #35  <Field Handler sHandler>
	...
	//   50  102:aload_0         
	//   51  103:getfield        #51  <Field ArrayList mActivities>
	...
	public SparseIntArray[] getMetrics()
	{
		return mMetrics;
	//    0    0:aload_0         
	//    1    1:getfield        #45  <Field SparseIntArray[] mMetrics>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #51  <Field ArrayList mActivities>
	...
	//   15   35:aload_0         
	//   16   36:getfield        #51  <Field ArrayList mActivities>
	//   17   39:aload_3         
	...
	//   22   48:aload_0         
	//   23   49:getfield        #56  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
	//   24   52:invokevirtual   #144 <Method void Window.removeOnFrameMetricsAvailableListener(android.view.Window$OnFrameMetricsAvailableListener)>
		return mMetrics;
	//   25   55:aload_0         
	//   26   56:getfield        #45  <Field SparseIntArray[] mMetrics>
	//   27   59:areturn         
	}
	...
	//    6   11:putfield        #45  <Field SparseIntArray[] mMetrics>
	...
	//    8   14:aload_0         
	//    9   15:getfield        #51  <Field ArrayList mActivities>
	//   10   18:iload_1         
	...
	//   23   45:aload_0         
	//   24   46:getfield        #56  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
	...
	//   26   52:aload_0         
	//   27   53:getfield        #51  <Field ArrayList mActivities>
	//   28   56:iload_1         
	...
	//*  35   65:goto            10
		return mMetrics;
	//   36   68:aload_0         
	//   37   69:getfield        #45  <Field SparseIntArray[] mMetrics>
	//   38   72:areturn         
	}
	...
	{
	//    0    0:aconst_null     
	//    1    1:putstatic       #33  <Field HandlerThread sHandlerThread>
	//    2    4:aconst_null     
	//    3    5:putstatic       #35  <Field Handler sHandler>
	//*   4    8:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #58  <Field int mTrackingFlags>
	//    2    4:ireturn         
	}
...
*/
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:invokespecial   #41  <Method void FrameMetricsAggregator$FrameMetricsBaseImpl(FrameMetricsAggregator$1)>
		mMetrics = new SparseIntArray[9];
	//    3    5:aload_0         
	//    4    6:bipush          9
	//    5    8:anewarray       SparseIntArray[]
	...
	//    9   18:dup             
	//   10   19:invokespecial   #49  <Method void ArrayList()>
	//   11   22:putfield        #51  <Field ArrayList mActivities>
...
;
	...
	//   14   29:dup             
	//   15   30:aload_0         
	//   16   31:invokespecial   #54  <Method void FrameMetricsAggregator$FrameMetricsApi24Impl$1(FrameMetricsAggregator$FrameMetricsApi24Impl)>
	//   17   34:putfield        #56  <Field android.view.Window$OnFrameMetricsAvailableListener mListener>
		mTrackingFlags = i;
	//   18   37:aload_0         
	//   19   38:iload_1         
	//   20   39:putfield        #58  <Field int mTrackingFlags>
	//   21   42:return          
	}
}
