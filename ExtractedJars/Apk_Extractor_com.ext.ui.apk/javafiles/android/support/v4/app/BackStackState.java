	...
	implements Parcelable
{
	...
	//    2    2:new             #98  <Class BackStackRecord>
	//    3    5:dup             
	//    4    6:aload_1         
	//    5    7:invokespecial   #160 <Method void BackStackRecord(FragmentManagerImpl)>
	//    6   10:astore          5
		int i = 0;
	//    7   12:iconst_0        
	//    8   13:istore_2        
	...
	//* 110  209:aload           6
	//* 111  211:aload_0         
	//* 112  212:getfield        #48  <Field int[] mOps>
	//* 113  215:iload           4
	//* 114  217:iaload          
	//* 115  218:putfield        #143 <Field int BackStackRecord$Op.popExitAnim>
	//* 116  221:aload           5
	//* 117  223:aload           6
	//* 118  225:getfield        #134 <Field int BackStackRecord$Op.enterAnim>
	//* 119  228:putfield        #206 <Field int BackStackRecord.mEnterAnim>
	//* 120  231:aload           5
	//* 121  233:aload           6
	//* 122  235:getfield        #137 <Field int BackStackRecord$Op.exitAnim>
	//* 123  238:putfield        #209 <Field int BackStackRecord.mExitAnim>
	//* 124  241:aload           5
	//* 125  243:aload           6
	//* 126  245:getfield        #140 <Field int BackStackRecord$Op.popEnterAnim>
	//* 127  248:putfield        #212 <Field int BackStackRecord.mPopEnterAnim>
	//* 128  251:aload           5
	//* 129  253:aload           6
	//* 130  255:getfield        #143 <Field int BackStackRecord$Op.popExitAnim>
	//* 131  258:putfield        #215 <Field int BackStackRecord.mPopExitAnim>
	//* 132  261:aload           5
	//* 133  263:aload           6
	//* 134  265:invokevirtual   #219 <Method void BackStackRecord.addOp(BackStackRecord$Op)>
	//* 135  268:iload_2         
	//* 136  269:iconst_1        
	//* 137  270:iadd            
	//* 138  271:istore_2        
	...
	//  144  280:aload           6
	//  145  282:aconst_null     
	//  146  283:putfield        #128 <Field Fragment BackStackRecord$Op.fragment>
			ai = mOps;
			k = j + 1;
			op.enterAnim = ai[j];
			ai = mOps;
	...
	//  148  289:aload           5
	//  149  291:aload_0         
	//  150  292:getfield        #54  <Field int mTransition>
	//  151  295:putfield        #144 <Field int BackStackRecord.mTransition>
		backstackrecord.mTransitionStyle = mTransitionStyle;
	//  152  298:aload           5
	//  153  300:aload_0         
	//  154  301:getfield        #56  <Field int mTransitionStyle>
	//  155  304:putfield        #145 <Field int BackStackRecord.mTransitionStyle>
		backstackrecord.mName = mName;
	//  156  307:aload           5
	//  157  309:aload_0         
	//  158  310:getfield        #62  <Field String mName>
	//  159  313:putfield        #146 <Field String BackStackRecord.mName>
		backstackrecord.mIndex = mIndex;
	//  160  316:aload           5
	//  161  318:aload_0         
	//  162  319:getfield        #64  <Field int mIndex>
	//  163  322:putfield        #147 <Field int BackStackRecord.mIndex>
		backstackrecord.mAddToBackStack = true;
	//  164  325:aload           5
	//  165  327:iconst_1        
	//  166  328:putfield        #108 <Field boolean BackStackRecord.mAddToBackStack>
		backstackrecord.mBreadCrumbTitleRes = mBreadCrumbTitleRes;
	//  167  331:aload           5
	//  168  333:aload_0         
	//  169  334:getfield        #66  <Field int mBreadCrumbTitleRes>
	//  170  337:putfield        #148 <Field int BackStackRecord.mBreadCrumbTitleRes>
		backstackrecord.mBreadCrumbTitleText = mBreadCrumbTitleText;
	//  171  340:aload           5
	//  172  342:aload_0         
	//  173  343:getfield        #81  <Field CharSequence mBreadCrumbTitleText>
	//  174  346:putfield        #149 <Field CharSequence BackStackRecord.mBreadCrumbTitleText>
		backstackrecord.mBreadCrumbShortTitleRes = mBreadCrumbShortTitleRes;
	//  175  349:aload           5
	//  176  351:aload_0         
	//  177  352:getfield        #83  <Field int mBreadCrumbShortTitleRes>
	//  178  355:putfield        #150 <Field int BackStackRecord.mBreadCrumbShortTitleRes>
		backstackrecord.mBreadCrumbShortTitleText = mBreadCrumbShortTitleText;
	//  179  358:aload           5
	//  180  360:aload_0         
	//  181  361:getfield        #85  <Field CharSequence mBreadCrumbShortTitleText>
	//  182  364:putfield        #151 <Field CharSequence BackStackRecord.mBreadCrumbShortTitleText>
		backstackrecord.mSharedElementSourceNames = mSharedElementSourceNames;
	//  183  367:aload           5
	//  184  369:aload_0         
	//  185  370:getfield        #91  <Field ArrayList mSharedElementSourceNames>
	//  186  373:putfield        #152 <Field ArrayList BackStackRecord.mSharedElementSourceNames>
		backstackrecord.mSharedElementTargetNames = mSharedElementTargetNames;
	//  187  376:aload           5
	//  188  378:aload_0         
	//  189  379:getfield        #93  <Field ArrayList mSharedElementTargetNames>
	//  190  382:putfield        #153 <Field ArrayList BackStackRecord.mSharedElementTargetNames>
		backstackrecord.mReorderingAllowed = mReorderingAllowed;
	//  191  385:aload           5
	//  192  387:aload_0         
	//  193  388:getfield        #95  <Field boolean mReorderingAllowed>
	//  194  391:putfield        #154 <Field boolean BackStackRecord.mReorderingAllowed>
		backstackrecord.bumpBackStackNesting(1);
	//  195  394:aload           5
	//  196  396:iconst_1        
	//  197  397:invokevirtual   #223 <Method void BackStackRecord.bumpBackStackNesting(int)>
