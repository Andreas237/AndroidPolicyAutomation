...
class NotificationCompatApi24
{
	...
	//    4    6:aload_1         
	//    5    7:aload_0         
	//    6    8:invokevirtual   #195 <Method int ArrayList.size()>
	//    7   11:invokeinterface #199 <Method NotificationCompatBase$Action[] NotificationCompatBase$Action$Factory.newArray(int)>
	//    8   16:astore          4
	...
	//   17   30:aload_0         
	//   18   31:iload_3         
	//   19   32:invokevirtual   #200 <Method Object ArrayList.get(int)>
	//   20   35:checkcast       #158 <Class android.app.Notification$Action>
	//   21   38:aload_1         
	//   22   39:aload_2         
	//   23   40:invokestatic    #156 <Method NotificationCompatBase$Action getActionCompatFromAction(android.app.Notification$Action, NotificationCompatBase$Action$Factory, RemoteInputCompatBase$RemoteInput$Factory)>
	//   24   43:aastore         
