...
_L5:
	...
	//    6   13:aload_3         
	//    7   14:aload_1         
	//    8   15:invokevirtual   #204 <Method void PrintWriter.print(String)>
			printwriter.println("Active Loaders:");
	//    9   18:aload_3         
	//   10   19:ldc1            #206 <String "Active Loaders:">
	//   11   21:invokevirtual   #209 <Method void PrintWriter.println(String)>
			String s1 = (new StringBuilder()).append(s).append("    ").toString();
	//   12   24:new             #84  <Class StringBuilder>
	//   13   27:dup             
	//   14   28:invokespecial   #85  <Method void StringBuilder()>
	//   15   31:aload_1         
	//   16   32:invokevirtual   #91  <Method StringBuilder StringBuilder.append(String)>
	//   17   35:ldc1            #211 <String "    ">
	//   18   37:invokevirtual   #91  <Method StringBuilder StringBuilder.append(String)>
	//   19   40:invokevirtual   #103 <Method String StringBuilder.toString()>
	//   20   43:astore          7
	...
	//*  23   48:iload           5
	//*  24   50:aload_0         
	//*  25   51:getfield        #39  <Field SparseArrayCompat mLoaders>
	//*  26   54:invokevirtual   #147 <Method int SparseArrayCompat.size()>
	//*  27   57:icmpge          133
			{
				LoaderInfo loaderinfo = (LoaderInfo)mLoaders.valueAt(i);
	//   28   60:aload_0         
	//   29   61:getfield        #39  <Field SparseArrayCompat mLoaders>
	//   30   64:iload           5
	//   31   66:invokevirtual   #117 <Method Object SparseArrayCompat.valueAt(int)>
	//   32   69:checkcast       #6   <Class LoaderManagerImpl$LoaderInfo>
	//   33   72:astore          8
				printwriter.print(s);
	//   34   74:aload_3         
	//   35   75:aload_1         
	//   36   76:invokevirtual   #204 <Method void PrintWriter.print(String)>
				printwriter.print("  #");
	//   37   79:aload_3         
	//   38   80:ldc1            #213 <String "  #">
	//   39   82:invokevirtual   #204 <Method void PrintWriter.print(String)>
				printwriter.print(mLoaders.keyAt(i));
	//   40   85:aload_3         
	//   41   86:aload_0         
	//   42   87:getfield        #39  <Field SparseArrayCompat mLoaders>
	//   43   90:iload           5
	//   44   92:invokevirtual   #216 <Method int SparseArrayCompat.keyAt(int)>
	//   45   95:invokevirtual   #218 <Method void PrintWriter.print(int)>
				printwriter.print(": ");
	//   46   98:aload_3         
	//   47   99:ldc1            #220 <String ": ">
	//   48  101:invokevirtual   #204 <Method void PrintWriter.print(String)>
				printwriter.println(loaderinfo.toString());
	//   49  104:aload_3         
	//   50  105:aload           8
	//   51  107:invokevirtual   #221 <Method String LoaderManagerImpl$LoaderInfo.toString()>
	//   52  110:invokevirtual   #209 <Method void PrintWriter.println(String)>
	...
	//   56  118:aload_3         
	//   57  119:aload           4
	//   58  121:invokevirtual   #223 <Method void LoaderManagerImpl$LoaderInfo.dump(String, FileDescriptor, PrintWriter, String[])>
			}
	...
	//*  64  133:aload_0         
	//*  65  134:getfield        #41  <Field SparseArrayCompat mInactiveLoaders>
	//*  66  137:invokevirtual   #147 <Method int SparseArrayCompat.size()>
	//*  67  140:ifle            264
		{
			printwriter.print(s);
	//   68  143:aload_3         
	//   69  144:aload_1         
	//   70  145:invokevirtual   #204 <Method void PrintWriter.print(String)>
			printwriter.println("Inactive Loaders:");
	//   71  148:aload_3         
	//   72  149:ldc1            #225 <String "Inactive Loaders:">
	//   73  151:invokevirtual   #209 <Method void PrintWriter.println(String)>
			String s2 = (new StringBuilder()).append(s).append("    ").toString();
	//   74  154:new             #84  <Class StringBuilder>
	//   75  157:dup             
	//   76  158:invokespecial   #85  <Method void StringBuilder()>
	//   77  161:aload_1         
	//   78  162:invokevirtual   #91  <Method StringBuilder StringBuilder.append(String)>
	//   79  165:ldc1            #211 <String "    ">
	//   80  167:invokevirtual   #91  <Method StringBuilder StringBuilder.append(String)>
	//   81  170:invokevirtual   #103 <Method String StringBuilder.toString()>
	//   82  173:astore          7
			for(int j = ((int) (flag)); j < mInactiveLoaders.size(); j++)
	//*  83  175:iload           6
	//*  84  177:istore          5
	//*  85  179:iload           5
	//*  86  181:aload_0         
	//*  87  182:getfield        #41  <Field SparseArrayCompat mInactiveLoaders>
	//*  88  185:invokevirtual   #147 <Method int SparseArrayCompat.size()>
	//*  89  188:icmpge          264
			{
				LoaderInfo loaderinfo1 = (LoaderInfo)mInactiveLoaders.valueAt(j);
	//   90  191:aload_0         
	//   91  192:getfield        #41  <Field SparseArrayCompat mInactiveLoaders>
	//   92  195:iload           5
	//   93  197:invokevirtual   #117 <Method Object SparseArrayCompat.valueAt(int)>
	//   94  200:checkcast       #6   <Class LoaderManagerImpl$LoaderInfo>
	//   95  203:astore          8
				printwriter.print(s);
	//   96  205:aload_3         
	//   97  206:aload_1         
	//   98  207:invokevirtual   #204 <Method void PrintWriter.print(String)>
				printwriter.print("  #");
	//   99  210:aload_3         
	//  100  211:ldc1            #213 <String "  #">
	//  101  213:invokevirtual   #204 <Method void PrintWriter.print(String)>
				printwriter.print(mInactiveLoaders.keyAt(j));
	//  102  216:aload_3         
	//  103  217:aload_0         
	//  104  218:getfield        #41  <Field SparseArrayCompat mInactiveLoaders>
	//  105  221:iload           5
	//  106  223:invokevirtual   #216 <Method int SparseArrayCompat.keyAt(int)>
	//  107  226:invokevirtual   #218 <Method void PrintWriter.print(int)>
				printwriter.print(": ");
	//  108  229:aload_3         
	//  109  230:ldc1            #220 <String ": ">
	//  110  232:invokevirtual   #204 <Method void PrintWriter.print(String)>
				printwriter.println(loaderinfo1.toString());
	//  111  235:aload_3         
	//  112  236:aload           8
	//  113  238:invokevirtual   #221 <Method String LoaderManagerImpl$LoaderInfo.toString()>
	//  114  241:invokevirtual   #209 <Method void PrintWriter.println(String)>
	...
	//  118  249:aload_3         
	//  119  250:aload           4
	//  120  252:invokevirtual   #223 <Method void LoaderManagerImpl$LoaderInfo.dump(String, FileDescriptor, PrintWriter, String[])>
			}
