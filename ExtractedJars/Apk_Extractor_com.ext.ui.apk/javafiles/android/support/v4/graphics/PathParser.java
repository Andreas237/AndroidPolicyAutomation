...
_L3:
	...
	//*  12   19:iload_2         
	//*  13   20:aload_0         
	//*  14   21:invokevirtual   #75  <Method int String.length()>
	//*  15   24:icmpge          83
		{
			j = nextStart(s, j);
	//   16   27:aload_0         
	//   17   28:iload_2         
	//   18   29:invokestatic    #79  <Method int nextStart(String, int)>
	//   19   32:istore_2        
			String s1 = s.substring(i, j).trim();
	//   20   33:aload_0         
	//   21   34:iload_1         
	//   22   35:iload_2         
	//   23   36:invokevirtual   #83  <Method String String.substring(int, int)>
	//   24   39:invokevirtual   #87  <Method String String.trim()>
	//   25   42:astore          5
			if(s1.length() > 0)
	//*  26   44:aload           5
	//*  27   46:invokevirtual   #75  <Method int String.length()>
	//*  28   49:ifle            72
			{
				float af[] = getFloats(s1);
	//   29   52:aload           5
	//   30   54:invokestatic    #91  <Method float[] getFloats(String)>
	//   31   57:astore          6
				addNode(arraylist, s1.charAt(0), af);
	//   32   59:aload           4
	//   33   61:aload           5
	//   34   63:iconst_0        
	//   35   64:invokevirtual   #95  <Method char String.charAt(int)>
	//   36   67:aload           6
	//   37   69:invokestatic    #97  <Method void addNode(ArrayList, char, float[])>
			}
			k = j + 1;
	//   38   72:iload_2         
	//   39   73:iconst_1        
	...
	//*  52   90:iload_1         
	//*  53   91:aload_0         
	//*  54   92:invokevirtual   #75  <Method int String.length()>
	//*  55   95:icmpge          111
			addNode(arraylist, s.charAt(i), new float[0]);
	//   56   98:aload           4
	//   57  100:aload_0         
	//   58  101:iload_1         
	//   59  102:invokevirtual   #95  <Method char String.charAt(int)>
	//   60  105:iconst_0        
	//   61  106:newarray        float[]
	//   62  108:invokestatic    #97  <Method void addNode(ArrayList, char, float[])>
		return (PathDataNode[])arraylist.toArray(((Object []) (new PathDataNode[arraylist.size()])));
	//   63  111:aload           4
	//   64  113:aload           4
	//   65  115:invokevirtual   #100 <Method int ArrayList.size()>
	//   66  118:anewarray       PathDataNode[]
	//   67  121:invokevirtual   #104 <Method Object[] ArrayList.toArray(Object[])>
	//   68  124:checkcast       #106 <Class PathParser$PathDataNode[]>
	//   69  127:areturn         
	}
...
_L12:
	...
	//   11   16:iload           5
	//   12   18:aload_0         
	//   13   19:invokevirtual   #75  <Method int String.length()>
	//   14   22:icmpge          95
_L1:
		s.charAt(j);
	//   15   25:aload_0         
	//   16   26:iload           5
	//   17   28:invokevirtual   #95  <Method char String.charAt(int)>
	...
	//	               69: 159
	//	               101: 159;
	//   18   31:lookupswitch    6: default 88
	//	               32: 102
	//	               44: 102
	//	               45: 110
	//	               46: 133
...
_L2:
	...
	//   23   95:aload_2         
	//   24   96:iload           5
	//   25   98:putfield        #149 <Field int PathParser$ExtractFloatResult.mEndPosition>
		return;
	//   26  101:return          
_L4:
		flag = false;
...
_L10:
	...
	//   37  120:aload_2         
	//   38  121:iconst_1        
	//   39  122:putfield        #145 <Field boolean PathParser$ExtractFloatResult.mEndWithNegOrDot>
		flag = false;
	//   40  125:iconst_0        
	//   41  126:istore_3        
		flag1 = true;
...
_L6:
	...
	//   52  146:aload_2         
	//   53  147:iconst_1        
	//   54  148:putfield        #145 <Field boolean PathParser$ExtractFloatResult.mEndWithNegOrDot>
			flag = false;
	//   55  151:iconst_0        
	//   56  152:istore_3        
			flag1 = true;
...
_L11:
	...
	//*   2    2:aload_0         
	//*   3    3:iconst_0        
	//*   4    4:invokevirtual   #95  <Method char String.charAt(int)>
	//*   5    7:bipush          122
	//*   6    9:icmpeq          22
	//*   7   12:aload_0         
	//*   8   13:iconst_0        
	//*   9   14:invokevirtual   #95  <Method char String.charAt(int)>
	//*  10   17:bipush          90
	//*  11   19:icmpne          26
			return new float[0];
	//   12   22:iconst_0        
	//   13   23:newarray        float[]
	//   14   25:areturn         
		int l;
		int i1;
		float af[];
	...
	//   15   26:aload_0         
	//   16   27:invokevirtual   #75  <Method int String.length()>
	//   17   30:newarray        float[]
	//   18   32:astore          6
