...
public class TypefaceCompatUtil
{
	...
	{
		Object obj = ((Object) (new FileOutputStream(file, false)));
	//    0    0:new             #65  <Class FileOutputStream>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:invokespecial   #68  <Method void FileOutputStream(File, boolean)>
	//    5    9:astore_3        
		file = ((File) (obj));
	//    6   10:aload_3         
	//    7   11:astore_0        
...
_L2:
	...
	//   13   21:aload_1         
	//   14   22:aload           4
	//   15   24:invokevirtual   #74  <Method int InputStream.read(byte[])>
	//   16   27:istore_2        
		if(i == -1)
	...
	//   24   38:iconst_0        
	//   25   39:iload_2         
	//   26   40:invokevirtual   #78  <Method void FileOutputStream.write(byte[], int, int)>
...
_L6:
	...
	//   35   53:ldc1            #15  <String "TypefaceCompatUtil">
	//   36   55:new             #80  <Class StringBuilder>
	//   37   58:dup             
	//   38   59:invokespecial   #81  <Method void StringBuilder()>
	//   39   62:ldc1            #83  <String "Error copying resource contents to temp file: ">
	//   40   64:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   41   67:aload_3         
	//   42   68:invokevirtual   #91  <Method String IOException.getMessage()>
	//   43   71:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   44   74:invokevirtual   #94  <Method String StringBuilder.toString()>
	//   45   77:invokestatic    #100 <Method int Log.e(String, String)>
	//   46   80:pop             
		closeQuietly(((Closeable) (inputstream)));
	//   47   81:aload_1         
	//   48   82:invokestatic    #63  <Method void closeQuietly(Closeable)>
		return false;
	//   49   85:iconst_0        
	//   50   86:ireturn         
_L1:
	...
	//   51   87:aload_3         
	//   52   88:invokestatic    #63  <Method void closeQuietly(Closeable)>
		return true;
	//   53   91:iconst_1        
	//   54   92:ireturn         
		inputstream;
...
_L4:
	...
	//   58   96:aload_0         
	//   59   97:invokestatic    #63  <Method void closeQuietly(Closeable)>
		throw inputstream;
	//   60  100:aload_1         
	//   61  101:athrow          
		inputstream;
...
_L19:
	...
	//   82  141:ifnull          153
_L14:
		if(cancellationsignal == null) goto _L17; else goto _L16
	//   83  144:aload_1         
	//   84  145:ifnull          166
_L16:
		((FileInputStream) (obj)).close();
