...
_L2:
		...
		//   31   52:aload_1         
		//   32   53:aload_2         
		//   33   54:invokespecial   #39  <Method View LayoutInflater.onCreateView(String, AttributeSet)>
		//   34   57:areturn         
		}
	...
	private static class InflateThread extends Thread
	{
		...
		//*  16   34:aload_1         
		//*  17   35:getfield        #74  <Field AsyncLayoutInflater AsyncLayoutInflater$InflateRequest.inflater>
		//*  18   38:getfield        #111 <Field Handler AsyncLayoutInflater.mHandler>
		//*  19   41:iconst_0        
		//*  20   42:aload_1         
		//*  21   43:invokestatic    #117 <Method Message Message.obtain(Handler, int, Object)>
		//*  22   46:invokevirtual   #120 <Method void Message.sendToTarget()>
		//*  23   49:return          
			catch(InterruptedException interruptedexception)
		//*  24   50:astore_1        
			{
				Log.w("AsyncLayoutInflater", ((Throwable) (interruptedexception)));
		//   25   51:ldc1            #122 <String "AsyncLayoutInflater">
		//   26   53:aload_1         
		//   27   54:invokestatic    #128 <Method int Log.w(String, Throwable)>
		//   28   57:pop             
				return;
		//   29   58:return          
			}
		...
		//   31   60:ldc1            #122 <String "AsyncLayoutInflater">
		//   32   62:ldc1            #130 <String "Failed to inflate resource in the background! Retrying on the UI thread">
		//   33   64:aload_2         
		//   34   65:invokestatic    #133 <Method int Log.w(String, String, Throwable)>
		//   35   68:pop             
			}
