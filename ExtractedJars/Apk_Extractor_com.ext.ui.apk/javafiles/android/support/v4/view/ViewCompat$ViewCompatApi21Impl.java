...
static class ViewCompat$ViewCompatApi21Impl extends ViewCompat$ViewCompatApi19Impl
{
	...
	//*  35   78:aload_1         
	//*  36   79:iload_2         
	//*  37   80:invokespecial   #150 <Method void ViewCompat$ViewCompatApi19Impl.offsetLeftAndRight(View, int)>
	//*  38   83:iload_3         
	//*  39   84:ifeq            121
	//*  40   87:aload           4
	//*  41   89:aload_1         
	//*  42   90:invokevirtual   #132 <Method int View.getLeft()>
	//*  43   93:aload_1         
	//*  44   94:invokevirtual   #135 <Method int View.getTop()>
	//*  45   97:aload_1         
	//*  46   98:invokevirtual   #138 <Method int View.getRight()>
	//*  47  101:aload_1         
	//*  48  102:invokevirtual   #141 <Method int View.getBottom()>
	//*  49  105:invokevirtual   #153 <Method boolean Rect.intersect(int, int, int, int)>
	//*  50  108:ifeq            121
	//*  51  111:aload           5
	//*  52  113:checkcast       #53  <Class View>
	//*  53  116:aload           4
	//*  54  118:invokevirtual   #157 <Method void View.invalidate(Rect)>
	//*  55  121:return          
				flag = false;
	//   56  122:iconst_0        
	//   57  123:istore_3        
	...
	//*  35   78:aload_1         
	//*  36   79:iload_2         
	//*  37   80:invokespecial   #160 <Method void ViewCompat$ViewCompatApi19Impl.offsetTopAndBottom(View, int)>
	//*  38   83:iload_3         
	//*  39   84:ifeq            121
	//*  40   87:aload           4
	//*  41   89:aload_1         
