...
public class AccessibilityDelegateCompat
{
	...
	static class AccessibilityDelegateBaseImpl
	{
		...
		public android.view.View.AccessibilityDelegate newAccessibilityDelegateBridge(AccessibilityDelegateCompat accessibilitydelegatecompat)
		{
			return ((android.view.View.AccessibilityDelegate) (((_cls1) (accessibilitydelegatecompat)). new android.view.View.AccessibilityDelegate() {
				...
				//    2    4:aload_1         
				//    3    5:aload_2         
				//    4    6:invokestatic    #42  <Method AccessibilityNodeInfoCompat AccessibilityNodeInfoCompat.wrap(AccessibilityNodeInfo)>
				//    5    9:invokevirtual   #45  <Method void AccessibilityDelegateCompat.onInitializeAccessibilityNodeInfo(View, AccessibilityNodeInfoCompat)>
				//    6   12:return          
				}
				...
				//    2    4:aload_1         
				//    3    5:aload_2         
				//    4    6:invokevirtual   #48  <Method void AccessibilityDelegateCompat.onPopulateAccessibilityEvent(View, AccessibilityEvent)>
				//    5    9:return          
				}
				...
				//    3    5:aload_2         
				//    4    6:aload_3         
				//    5    7:invokevirtual   #52  <Method boolean AccessibilityDelegateCompat.onRequestSendAccessibilityEvent(ViewGroup, View, AccessibilityEvent)>
				//    6   10:ireturn         
				}
				...
				//    2    4:aload_1         
				//    3    5:iload_2         
				//    4    6:invokevirtual   #56  <Method void AccessibilityDelegateCompat.sendAccessibilityEvent(View, int)>
				//    5    9:return          
				}
				...
				//    2    4:aload_1         
				//    3    5:aload_2         
				//    4    6:invokevirtual   #59  <Method void AccessibilityDelegateCompat.sendAccessibilityEventUnchecked(View, AccessibilityEvent)>
				//    5    9:return          
				}
	...
	//    0    0:getstatic       #37  <Field android.view.View$AccessibilityDelegate DEFAULT_DELEGATE>
	//    1    3:aload_1         
	//    2    4:aload_2         
	...
	//    1    3:getstatic       #37  <Field android.view.View$AccessibilityDelegate DEFAULT_DELEGATE>
	//    2    6:aload_1         
	...
	//    1    3:aload_1         
	//    2    4:aload_2         
	//    3    5:invokevirtual   #69  <Method AccessibilityNodeInfo AccessibilityNodeInfoCompat.unwrap()>
	//    4    8:invokevirtual   #72  <Method void android.view.View$AccessibilityDelegate.onInitializeAccessibilityNodeInfo(View, AccessibilityNodeInfo)>
	//    5   11:return          
	}
	...
	//    1    3:aload_1         
	//    2    4:aload_2         
	//    3    5:invokevirtual   #75  <Method void android.view.View$AccessibilityDelegate.onPopulateAccessibilityEvent(View, AccessibilityEvent)>
	//    4    8:return          
	}
	...
	//    2    4:aload_2         
	//    3    5:aload_3         
	//    4    6:invokevirtual   #79  <Method boolean android.view.View$AccessibilityDelegate.onRequestSendAccessibilityEvent(ViewGroup, View, AccessibilityEvent)>
	//    5    9:ireturn         
	}
	...
	//    3    7:iload_2         
	//    4    8:aload_3         
	//    5    9:invokevirtual   #84  <Method boolean AccessibilityDelegateCompat$AccessibilityDelegateBaseImpl.performAccessibilityAction(android.view.View$AccessibilityDelegate, View, int, Bundle)>
	//    6   12:ireturn         
	}
	...
	//    1    3:aload_1         
	//    2    4:iload_2         
	//    3    5:invokevirtual   #88  <Method void android.view.View$AccessibilityDelegate.sendAccessibilityEvent(View, int)>
	//    4    8:return          
	}
	...
	//    1    3:aload_1         
	//    2    4:aload_2         
	//    3    5:invokevirtual   #91  <Method void android.view.View$AccessibilityDelegate.sendAccessibilityEventUnchecked(View, AccessibilityEvent)>
	//    4    8:return          
	}
	...
	//*   7   18:new             #34  <Class android.view.View$AccessibilityDelegate>
	//*   8   21:dup             
	//*   9   22:invokespecial   #35  <Method void android.view.View$AccessibilityDelegate()>
	//*  10   25:putstatic       #37  <Field android.view.View$AccessibilityDelegate DEFAULT_DELEGATE>
	//*  11   28:return          
			IMPL = new AccessibilityDelegateBaseImpl();
	//   12   29:new             #11  <Class AccessibilityDelegateCompat$AccessibilityDelegateBaseImpl>
	//   13   32:dup             
	//   14   33:invokespecial   #38  <Method void AccessibilityDelegateCompat$AccessibilityDelegateBaseImpl()>
	//   15   36:putstatic       #32  <Field AccessibilityDelegateCompat$AccessibilityDelegateBaseImpl IMPL>
	//*  16   39:goto            18
	}
}
