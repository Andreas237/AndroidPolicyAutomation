...
abstract class ModernAsyncTask
{
	...
	//   16   57:dup             
	//   17   58:ldc1            #170 <String "Cannot execute task: the task is already running.">
	...
	//   21   67:dup             
	//   22   68:ldc1            #172 <String "Cannot execute task: the task has already been executed (a task can be executed only once)">
	...
	//*   6   12:aload_0         
	//*   7   13:getstatic       #195 <Field ModernAsyncTask$Status ModernAsyncTask$Status.FINISHED>
	//*   8   16:putfield        #96  <Field ModernAsyncTask$Status mStatus>
	//*   9   19:return          
			onPostExecute(obj);
	//   10   20:aload_0         
	//   11   21:aload_1         
	//   12   22:invokevirtual   #198 <Method void onPostExecute(Object)>
