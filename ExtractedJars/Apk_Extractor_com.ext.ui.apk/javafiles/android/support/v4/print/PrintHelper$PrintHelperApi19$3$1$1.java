...
class PrintHelper$PrintHelperApi19$3$1$1
	implements android.os.
{
	...
	PrintHelper$PrintHelperApi19$3$1$1()
	{
...
/* anonymous class */
	class PrintHelper.PrintHelperApi19._cls3 extends PrintDocumentAdapter
	{
		...
		//*  45   80:goto            68
			{
				mLoadBitmap = ((PrintHelper.PrintHelperApi19._cls3._cls1) (((PrintHelper.PrintHelperApi19._cls3._cls1) (layoutresultcallback)). new PrintHelper.PrintHelperApi19._cls3._cls1())).execute(((Object []) (new Uri[0])));
		//   46   83:aload_0         
...
*/
	...
	// Unreferenced inner class android/support/v4/print/PrintHelper$PrintHelperApi19$3$1

/* anonymous class */
	class PrintHelper.PrintHelperApi19._cls3._cls1 extends AsyncTask
	{
		...
		{
			cancellationSignal.setOnCancelListener(((android.os.CancellationSignal.OnCancelListener) (new PrintHelper.PrintHelperApi19._cls3._cls1._cls1())));
		//    0    0:aload_0         
