...
public final class PrintHelper
{
		...
		implements PrintHelperVersionImpl
	{
		...
		//*   3    3:ifnull          13
		//*   4    6:aload_0         
		//*   5    7:getfield        #59  <Field Context mContext>
		//*   6   10:ifnonnull       23
				throw new IllegalArgumentException("bad argument to loadBitmap");
		//    7   13:new             #178 <Class IllegalArgumentException>
		//    8   16:dup             
		//    9   17:ldc1            #180 <String "bad argument to loadBitmap">
		//   10   19:invokespecial   #183 <Method void IllegalArgumentException(String)>
		//   11   22:athrow          
		...
		//    7   13:new             #178 <Class IllegalArgumentException>
		//    8   16:dup             
		//    9   17:ldc1            #216 <String "bad argument to getScaledBitmap">
		//   10   19:invokespecial   #183 <Method void IllegalArgumentException(String)>
		//   11   22:athrow          
			android.graphics.BitmapFactory.Options options = new android.graphics.BitmapFactory.Options();
		//   12   23:new             #218 <Class android.graphics.BitmapFactory$Options>
		//   13   26:dup             
		//   14   27:invokespecial   #219 <Method void android.graphics.BitmapFactory$Options()>
		//   15   30:astore          6
			options.inJustDecodeBounds = true;
		//   16   32:aload           6
		//   17   34:iconst_1        
		//   18   35:putfield        #222 <Field boolean android.graphics.BitmapFactory$Options.inJustDecodeBounds>
			loadBitmap(uri, options);
		//   19   38:aload_0         
		//   20   39:aload_1         
		//   21   40:aload           6
		//   22   42:invokespecial   #224 <Method Bitmap loadBitmap(Uri, android.graphics.BitmapFactory$Options)>
		//   23   45:pop             
			k = options.outWidth;
		//   24   46:aload           6
		//   25   48:getfield        #227 <Field int android.graphics.BitmapFactory$Options.outWidth>
		//   26   51:istore          4
			l = options.outHeight;
		//   27   53:aload           6
		//   28   55:getfield        #230 <Field int android.graphics.BitmapFactory$Options.outHeight>
		//   29   58:istore          5
...
_L1:
		...
		//   35   71:areturn         
_L2:
			for(int j = Math.max(k, l); j > 3500;)
		//*  36   72:iload           4
		//*  37   74:iload           5
		//*  38   76:invokestatic    #233 <Method int Math.max(int, int)>
		//*  39   79:istore_3        
		//*  40   80:iload_3         
		//*  41   81:sipush          3500
		//*  42   84:icmple          98
...
_L3:
		...
		//   33   60:astore          7
			((_cls2) (((_cls2) (writeresultcallback)). new AsyncTask() {
...
_L11:
		...
		//   42   88:astore          5
			...
			printmanager.print(jobName, ((PrintDocumentAdapter) (((_cls1) (onprintfinishcallback)). new PrintDocumentAdapter() {
			...
			throws FileNotFoundException
		{
			...
			imageFile = ((Uri) (((_cls3) (mScaleMode)). new PrintDocumentAdapter() {
...
/*
			static void access$300(PrintHelperApi19._cls3 _pcls3)
			{
				_pcls3.cancelLoad();
			//    0    0:aload_0         
...
/*
			static PrintAttributes access$500(PrintHelperApi19._cls3 _pcls3)
			{
...
/*
		static void access$000(PrintHelperApi19 printhelperapi19, PrintAttributes printattributes, int i, Bitmap bitmap, ParcelFileDescriptor parcelfiledescriptor, CancellationSignal cancellationsignal, android.print.PrintDocumentAdapter.WriteResultCallback writeresultcallback)
		{
...
/*
		static Bitmap access$100(PrintHelperApi19 printhelperapi19, Bitmap bitmap, int i)
		{
...
/*
		static Matrix access$200(PrintHelperApi19 printhelperapi19, int i, int j, RectF rectf, int k)
		{
			return printhelperapi19.getMatrix(i, j, rectf, k);
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:iload_2         
		//    3    3:aload_3         
...
/*
		static Bitmap access$400(PrintHelperApi19 printhelperapi19, Uri uri)
			throws FileNotFoundException
		{
...
/*
		static Object access$700(PrintHelperApi19 printhelperapi19)
		{
			return printhelperapi19.mLock;
		//    0    0:aload_0         
...
*/
	...
	//*   2    4:getstatic       #67  <Field int android.os.Build$VERSION.SDK_INT>
	//*   3    7:bipush          24
	//*   4    9:icmplt          25
		{
			mImpl = ((PrintHelperVersionImpl) (new PrintHelperApi24(context)));
	//    5   12:aload_0         
	//    6   13:new             #36  <Class PrintHelper$PrintHelperApi24>
	//    7   16:dup             
	//    8   17:aload_1         
	//    9   18:invokespecial   #69  <Method void PrintHelper$PrintHelperApi24(Context)>
	//   10   21:putfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
			return;
	//   11   24:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  12   25:getstatic       #67  <Field int android.os.Build$VERSION.SDK_INT>
	//*  13   28:bipush          23
	//*  14   30:icmplt          46
		{
			mImpl = ((PrintHelperVersionImpl) (new PrintHelperApi23(context)));
	//   15   33:aload_0         
	//   16   34:new             #33  <Class PrintHelper$PrintHelperApi23>
	//   17   37:dup             
	//   18   38:aload_1         
	//   19   39:invokespecial   #72  <Method void PrintHelper$PrintHelperApi23(Context)>
	//   20   42:putfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
			return;
	//   21   45:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 20)
	//*  22   46:getstatic       #67  <Field int android.os.Build$VERSION.SDK_INT>
	//*  23   49:bipush          20
	//*  24   51:icmplt          67
		{
			mImpl = ((PrintHelperVersionImpl) (new PrintHelperApi20(context)));
	//   25   54:aload_0         
	//   26   55:new             #30  <Class PrintHelper$PrintHelperApi20>
	//   27   58:dup             
	//   28   59:aload_1         
	//   29   60:invokespecial   #73  <Method void PrintHelper$PrintHelperApi20(Context)>
	//   30   63:putfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
			return;
	//   31   66:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 19)
	//*  32   67:getstatic       #67  <Field int android.os.Build$VERSION.SDK_INT>
	//*  33   70:bipush          19
	//*  34   72:icmplt          88
		{
			mImpl = ((PrintHelperVersionImpl) (new PrintHelperApi19(context)));
	//   35   75:aload_0         
	//   36   76:new             #17  <Class PrintHelper$PrintHelperApi19>
	//   37   79:dup             
	//   38   80:aload_1         
	//   39   81:invokespecial   #74  <Method void PrintHelper$PrintHelperApi19(Context)>
	//   40   84:putfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
			return;
	//   41   87:return          
		} else
		{
			mImpl = ((PrintHelperVersionImpl) (new PrintHelperStub()));
	//   42   88:aload_0         
	//   43   89:new             #39  <Class PrintHelper$PrintHelperStub>
	//   44   92:dup             
	//   45   93:aconst_null     
	//   46   94:invokespecial   #77  <Method void PrintHelper$PrintHelperStub(PrintHelper$1)>
	//   47   97:putfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
			return;
	//   48  100:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
	//    2    4:invokeinterface #84  <Method int PrintHelper$PrintHelperVersionImpl.getColorMode()>
	//    3    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
	//    2    4:invokeinterface #87  <Method int PrintHelper$PrintHelperVersionImpl.getOrientation()>
	//    3    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
	//    2    4:invokeinterface #90  <Method int PrintHelper$PrintHelperVersionImpl.getScaleMode()>
	//    3    9:ireturn         
	}
	...
	//    3    5:aload_2         
	//    4    6:aconst_null     
	//    5    7:invokeinterface #95  <Method void PrintHelper$PrintHelperVersionImpl.printBitmap(String, Bitmap, PrintHelper$OnPrintFinishCallback)>
	//    6   12:return          
	}
	...
	//    3    5:aload_2         
	//    4    6:aconst_null     
	//    5    7:invokeinterface #101 <Method void PrintHelper$PrintHelperVersionImpl.printBitmap(String, Uri, PrintHelper$OnPrintFinishCallback)>
	//    6   12:return          
	}
	...
	//    1    1:getfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
	//    2    4:iload_1         
	//    3    5:invokeinterface #106 <Method void PrintHelper$PrintHelperVersionImpl.setColorMode(int)>
	//    4   10:return          
	}
	...
	//    1    1:getfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
	//    2    4:iload_1         
	//    3    5:invokeinterface #109 <Method void PrintHelper$PrintHelperVersionImpl.setOrientation(int)>
	//    4   10:return          
	}
	...
	//    1    1:getfield        #71  <Field PrintHelper$PrintHelperVersionImpl mImpl>
	//    2    4:iload_1         
	//    3    5:invokeinterface #112 <Method void PrintHelper$PrintHelperVersionImpl.setScaleMode(int)>
	//    4   10:return          
	}
