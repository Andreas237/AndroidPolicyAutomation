...
/* anonymous class */
		...
		implements Runnable
	{
		...
		public void run()
		{
			...
			try
			{
				obj = ((Object) (FontsContractCompat.fetchFonts(context, ((android.os.CancellationSignal) (null)), request)));
		//    0    0:aload_0         
		...
		//   31   82:return          
			...
			if(((FontsContractCompat.FontFamilyResult) (obj)).getStatusCode() != 0)
			{
				switch(((FontsContractCompat.FontFamilyResult) (obj)).getStatusCode())
				{
				default:
		...
		//   49  116:return          
			...
			FontsContractCompat.FontInfo afontinfo[] = ((FontsContractCompat.FontFamilyResult) (obj)).getFonts();
		//   50  117:aload_3         
		...
		//  127  253:return          
			...
			{
				callerThreadHandler.post(((Runnable) (((FontsContractCompat._cls4._cls9) (afontinfo)). new FontsContractCompat._cls4._cls9())));
		//  128  254:aload_0         
