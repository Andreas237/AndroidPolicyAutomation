	...
	implements Animatable
{
	...
	private static class Ring
	{
		...
		//   55   87:fload_3         
		//   56   88:aload_2         
		//   57   89:invokevirtual   #129 <Method int Rect.centerY()>
		//   58   92:i2f             
		//   59   93:fadd            
		...
		//*  66  126:fload           5
		//*  67  128:aload           4
		//*  68  130:invokevirtual   #146 <Method float RectF.centerX()>
		//*  69  133:fadd            
		//*  70  134:fload           6
		//*  71  136:fsub            
		//*  72  137:aload           4
	...
	//   32   52:aload_2         
	//   33   53:invokevirtual   #144 <Method float CircularProgressDrawable$Ring.getStartingRotation()>
	//   34   56:fstore          4
		ring.setRotation((f1 - ring.getStartingRotation()) * f + f2);
	//   35   58:aload_2         
	//   36   59:fload_3         
	//   37   60:aload_2         
	//   38   61:invokevirtual   #144 <Method float CircularProgressDrawable$Ring.getStartingRotation()>
	//   39   64:fsub            
	//   40   65:fload_1         
	//   41   66:fmul            
	//   42   67:fload           4
	//   43   69:fadd            
	//   44   70:invokevirtual   #165 <Method void CircularProgressDrawable$Ring.setRotation(float)>
	//   45   73:return          
	}
	...
	//   29   52:fload           4
	//   30   54:invokeinterface #173 <Method float Interpolator.getInterpolation(float)>
	//   31   59:ldc1            #174 <Float 0.79F>
	//   32   61:fmul            
	...
	//   20   34:iand            
	//   21   35:istore_2        
		return k + (int)((float)((j >> 24 & 0xff) - k) * f) << 24 | l + (int)((float)((j >> 16 & 0xff) - l) * f) << 16 | (int)((float)((j >> 8 & 0xff) - i1) * f) + i1 << 8 | (int)((float)((j & 0xff) - i) * f) + i;
	//   22   36:iload           4
	//   23   38:iload_3         
	//   24   39:bipush          24
	//   25   41:ishr            
