	...
	implements CursorFilter.CursorFilterClient, Filterable
{
	...
	//   29   64:aload_0         
	//   30   65:aload_0         
	//   31   66:getfield        #93  <Field Context mContext>
	//   32   69:aload_0         
	//   33   70:getfield        #81  <Field Cursor mCursor>
	//   34   73:aload_3         
	//   35   74:invokevirtual   #145 <Method View newView(Context, Cursor, ViewGroup)>
	//   36   77:astore          4
		bindView(view1, mContext, mCursor);
	//   37   79:aload_0         
	//   38   80:aload           4
	//   39   82:aload_0         
	//   40   83:getfield        #93  <Field Context mContext>
	//   41   86:aload_0         
	//   42   87:getfield        #81  <Field Cursor mCursor>
	//   43   90:invokevirtual   #99  <Method void bindView(View, Context, Cursor)>
		return view1;
	//   44   93:aload           4
	//   45   95:areturn         
	}
