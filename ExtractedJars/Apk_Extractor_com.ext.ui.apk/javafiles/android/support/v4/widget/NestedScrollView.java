...
;
	...
	//*  17   28:iload_1         
	//*  18   29:aload_0         
	//*  19   30:invokevirtual   #175 <Method int getPaddingTop()>
	//*  20   33:iadd            
	//*  21   34:aload_0         
...
_L2:
	...
	//   14   27:iload           8
	//   15   29:icmpge          189
		view = (View)((List) (arraylist)).get(k);
	//   16   32:aload           12
	//   17   34:iload           6
...
label0:
	...
	//*  57  119:iload           7
	//*  58  121:aload           11
	//*  59  123:invokevirtual   #233 <Method int View.getTop()>
	//*  60  126:icmplt          143
	//*  61  129:iload_1         
	//*  62  130:ifne            164
	//*  63  133:iload           9
	//*  64  135:aload           11
	//*  65  137:invokevirtual   #236 <Method int View.getBottom()>
	//*  66  140:icmple          164
					l = 1;
	//   67  143:iconst_1        
	//   68  144:istore          7
...
_L1:
	...
	//*  37   69:aload           8
	//*  38   71:aload_0         
	//*  39   72:invokevirtual   #408 <Method View findFocus()>
	//*  40   75:if_acmpeq       85
	//*  41   78:aload           8
	//*  42   80:iload_1         
	//*  43   81:invokevirtual   #412 <Method boolean View.requestFocus(int)>
	//*  44   84:pop             
	//*  45   85:iload           6
	//*  46   87:ireturn         
			flag = false;
	...
	//*  56  104:aload_0         
	//*  57  105:iload_2         
	//*  58  106:invokespecial   #414 <Method void doScrollY(int)>
	//*  59  109:iconst_1        
	//*  60  110:istore          6
	//*  61  112:goto            69
				j = k - i1;
...
label0:
	...
	public boolean arrowScroll(int i)
	{
		...
		view1 = findFocus();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #408 <Method View findFocus()>
	//    2    4:astore          7
		view = view1;
	//    3    6:aload           7
	//    4    8:astore          6
	...
	//   10   19:invokestatic    #442 <Method FocusFinder FocusFinder.getInstance()>
	//   11   22:aload_0         
	//   12   23:aload           6
	//   13   25:iload_1         
	//   14   26:invokevirtual   #446 <Method View FocusFinder.findNextFocus(ViewGroup, View, int)>
	//   15   29:astore          7
		k = getMaxScrollAmount();
	//   16   31:aload_0         
	//   17   32:invokevirtual   #449 <Method int getMaxScrollAmount()>
	//   18   35:istore_3        
	...
	//   23   44:iload_3         
	//   24   45:aload_0         
	//   25   46:invokevirtual   #172 <Method int getHeight()>
	//   26   49:invokespecial   #358 <Method boolean isWithinDeltaOfScreen(View, int, int)>
	//   27   52:ifeq            139
_L1:
		view1.getDrawingRect(mTempRect);
	//   28   55:aload           7
	//   29   57:aload_0         
	//   30   58:getfield        #98  <Field Rect mTempRect>
	//   31   61:invokevirtual   #372 <Method void View.getDrawingRect(Rect)>
		offsetDescendantRectToMyCoords(view1, mTempRect);
	//   32   64:aload_0         
	//   33   65:aload           7
	//   34   67:aload_0         
	//   35   68:getfield        #98  <Field Rect mTempRect>
	//   36   71:invokevirtual   #376 <Method void offsetDescendantRectToMyCoords(View, Rect)>
		doScrollY(computeScrollDeltaToGetChildRectOnScreen(mTempRect));
	//   37   74:aload_0         
	//   38   75:aload_0         
	//   39   76:aload_0         
	//   40   77:getfield        #98  <Field Rect mTempRect>
	//   41   80:invokevirtual   #419 <Method int computeScrollDeltaToGetChildRectOnScreen(Rect)>
	//   42   83:invokespecial   #414 <Method void doScrollY(int)>
		view1.requestFocus(i);
	//   43   86:aload           7
	//   44   88:iload_1         
	//   45   89:invokevirtual   #412 <Method boolean View.requestFocus(int)>
	//   46   92:pop             
_L8:
	...
	//*  48   95:ifnull          137
	//*  49   98:aload           6
	//*  50  100:invokevirtual   #452 <Method boolean View.isFocused()>
	//*  51  103:ifeq            137
	//*  52  106:aload_0         
	//*  53  107:aload           6
	//*  54  109:invokespecial   #454 <Method boolean isOffScreen(View)>
	//*  55  112:ifeq            137
		{
			i = getDescendantFocusability();
	//   56  115:aload_0         
	//   57  116:invokevirtual   #457 <Method int getDescendantFocusability()>
	//   58  119:istore_1        
			setDescendantFocusability(0x20000);
	//   59  120:aload_0         
	//   60  121:ldc2            #458 <Int 0x20000>
	//   61  124:invokevirtual   #328 <Method void setDescendantFocusability(int)>
			requestFocus();
	//   62  127:aload_0         
	//   63  128:invokevirtual   #460 <Method boolean requestFocus()>
	//   64  131:pop             
			setDescendantFocusability(i);
	//   65  132:aload_0         
	//   66  133:iload_1         
	//   67  134:invokevirtual   #328 <Method void setDescendantFocusability(int)>
		}
		return true;
	//   68  137:iconst_1        
	//   69  138:ireturn         
_L2:
	...
	//   72  142:icmpne          164
	//   73  145:aload_0         
	//   74  146:invokevirtual   #240 <Method int getScrollY()>
	//   75  149:iload_3         
	//   76  150:icmpge          164
_L3:
		int j = getScrollY();
	//   77  153:aload_0         
	//   78  154:invokevirtual   #240 <Method int getScrollY()>
	//   79  157:istore_2        
_L6:
		if(j == 0)
	//*  80  158:iload_2         
...
_L4:
	...
	//   90  174:istore_2        
			if(getChildCount() > 0)
	//*  91  175:aload_0         
	//*  92  176:invokevirtual   #298 <Method int getChildCount()>
	//*  93  179:ifle            158
			{
				int l = getChildAt(0).getBottom();
	//   94  182:aload_0         
	//   95  183:iconst_0        
	//   96  184:invokevirtual   #165 <Method View getChildAt(int)>
	//   97  187:invokevirtual   #236 <Method int View.getBottom()>
	//   98  190:istore          4
				int i1 = (getScrollY() + getHeight()) - getPaddingBottom();
	//   99  192:aload_0         
	//  100  193:invokevirtual   #240 <Method int getScrollY()>
	//  101  196:aload_0         
	//  102  197:invokevirtual   #172 <Method int getHeight()>
	//  103  200:iadd            
	//  104  201:aload_0         
	//  105  202:invokevirtual   #178 <Method int getPaddingBottom()>
	//  106  205:isub            
	//  107  206:istore          5
				j = k;
	//  108  208:iload_3         
...
_L5:
	...
	//* 123  235:aload_0         
	//* 124  236:iload_2         
	//* 125  237:invokespecial   #414 <Method void doScrollY(int)>
	//* 126  240:goto            93
			j = -j;
	//  127  243:iload_2         
	//  128  244:ineg            
...
_L2:
	...
	//*  51   92:icmple          121
				j = (rect.top - j) + 0;
	//   52   95:aload_1         
	//   53   96:getfield        #382 <Field int Rect.top>
	//   54   99:iload_3         
	//   55  100:isub            
	//   56  101:iconst_0        
	//   57  102:iadd            
	...
	//*  69  120:ireturn         
				j = (rect.bottom - i) + 0;
	//   70  121:aload_1         
	//   71  122:getfield        #379 <Field int Rect.bottom>
	//   72  125:iload_2         
	//   73  126:isub            
	//   74  127:iconst_0        
	//   75  128:iadd            
	...
	//*  78  133:aload_1         
	//*  79  134:getfield        #382 <Field int Rect.top>
	//*  80  137:iload_3         
	//*  81  138:icmpge          192
	//*  82  141:aload_1         
	//*  83  142:getfield        #379 <Field int Rect.bottom>
	//*  84  145:iload_2         
	//*  85  146:icmpge          192
		{
			if(rect.height() > l)
	//*  86  149:aload_1         
	//*  87  150:invokevirtual   #521 <Method int Rect.height()>
	//*  88  153:iload           5
	//*  89  155:icmple          180
				i = 0 - (i - rect.bottom);
	//   90  158:iconst_0        
	//   91  159:iload_2         
	//   92  160:aload_1         
	//   93  161:getfield        #379 <Field int Rect.bottom>
	//   94  164:isub            
	//   95  165:isub            
	//   96  166:istore_2        
			else
	//*  97  167:iload_2         
	//*  98  168:aload_0         
	//*  99  169:invokevirtual   #240 <Method int getScrollY()>
	//* 100  172:ineg            
	//* 101  173:invokestatic    #530 <Method int Math.max(int, int)>
	//* 102  176:istore_2        
	//* 103  177:goto            119
				i = 0 - (j - rect.top);
	//  104  180:iconst_0        
	//  105  181:iload_3         
	//  106  182:aload_1         
	//  107  183:getfield        #382 <Field int Rect.top>
	//  108  186:isub            
	//  109  187:isub            
	//  110  188:istore_2        
	...
	//    3    4:istore          4
		mTempRect.setEmpty();
	//    4    6:aload_0         
	//    5    7:getfield        #98  <Field Rect mTempRect>
	//    6   10:invokevirtual   #596 <Method void Rect.setEmpty()>
		boolean flag;
		if(!canScroll())
	//*   7   13:aload_0         
	//*   8   14:invokespecial   #598 <Method boolean canScroll()>
	//*   9   17:ifne            98
		{
			flag = flag1;
	//   10   20:iload           4
	//   11   22:istore_3        
			if(isFocused())
	//*  12   23:aload_0         
	//*  13   24:invokevirtual   #599 <Method boolean isFocused()>
	//*  14   27:ifeq            91
			{
				flag = flag1;
	//   15   30:iload           4
	...
	//*  17   33:aload_1         
	//*  18   34:invokevirtual   #604 <Method int KeyEvent.getKeyCode()>
	//*  19   37:iconst_4        
	//*  20   38:icmpeq          91
				{
					View view = findFocus();
	//   21   41:aload_0         
	//   22   42:invokevirtual   #408 <Method View findFocus()>
	//   23   45:astore          5
	...
	//   31   58:invokestatic    #442 <Method FocusFinder FocusFinder.getInstance()>
	//   32   61:aload_0         
	//   33   62:aload_1         
	//   34   63:sipush          130
	//   35   66:invokevirtual   #446 <Method View FocusFinder.findNextFocus(ViewGroup, View, int)>
	//   36   69:astore_1        
					if(keyevent != null && keyevent != this && ((View) (keyevent)).requestFocus(130))
	//*  37   70:aload_1         
	//*  38   71:ifnull          93
	//*  39   74:aload_1         
	//*  40   75:aload_0         
	...
	//*  42   79:aload_1         
	//*  43   80:sipush          130
	//*  44   83:invokevirtual   #412 <Method boolean View.requestFocus(int)>
	//*  45   86:ifeq            93
						flag = true;
	//   46   89:iconst_1        
	//   47   90:istore_3        
	...
	//*  55  101:aload_1         
	//*  56  102:invokevirtual   #607 <Method int KeyEvent.getAction()>
	//*  57  105:ifne            91
			{
				switch(keyevent.getKeyCode())
	//*  58  108:aload_1         
	//*  59  109:invokevirtual   #604 <Method int KeyEvent.getKeyCode()>
				{
	//*  60  112:lookupswitch    3: default 148
	//	               19: 150
	//	               20: 171
	//	               62: 194
				default:
	...
	//*  63  150:aload_1         
	//*  64  151:invokevirtual   #610 <Method boolean KeyEvent.isAltPressed()>
	//*  65  154:ifne            164
						return arrowScroll(33);
	//   66  157:aload_0         
	//   67  158:bipush          33
	//   68  160:invokevirtual   #612 <Method boolean arrowScroll(int)>
	//   69  163:ireturn         
					else
						return fullScroll(33);
	//   70  164:aload_0         
	//   71  165:bipush          33
	//   72  167:invokevirtual   #615 <Method boolean fullScroll(int)>
	//   73  170:ireturn         

				case 20: // '\024'
					if(!keyevent.isAltPressed())
	//*  74  171:aload_1         
	//*  75  172:invokevirtual   #610 <Method boolean KeyEvent.isAltPressed()>
	//*  76  175:ifne            186
						return arrowScroll(130);
	//   77  178:aload_0         
	//   78  179:sipush          130
	//   79  182:invokevirtual   #612 <Method boolean arrowScroll(int)>
	//   80  185:ireturn         
					else
						return fullScroll(130);
	//   81  186:aload_0         
	//   82  187:sipush          130
	//   83  190:invokevirtual   #615 <Method boolean fullScroll(int)>
	//   84  193:ireturn         
	...
	//*  85  194:aload_1         
	//*  86  195:invokevirtual   #618 <Method boolean KeyEvent.isShiftPressed()>
	//*  87  198:ifeq            209
	//*  88  201:aload_0         
	//*  89  202:iload_2         
	//*  90  203:invokevirtual   #621 <Method boolean pageScroll(int)>
	//*  91  206:pop             
	//*  92  207:iconst_0        
	//*  93  208:ireturn         
					c = '\202';
	...
	//    4    9:iload_2         
	//    5   10:aload_0         
	//    6   11:invokevirtual   #572 <Method int getPaddingLeft()>
	//    7   14:aload_0         
	//    8   15:invokevirtual   #575 <Method int getPaddingRight()>
	//    9   18:iadd            
	//   10   19:aload           6
	//   11   21:getfield        #675 <Field int android.view.ViewGroup$MarginLayoutParams.leftMargin>
	//   12   24:iadd            
	//   13   25:aload           6
	//   14   27:getfield        #678 <Field int android.view.ViewGroup$MarginLayoutParams.rightMargin>
	//   15   30:iadd            
	//   16   31:iload_3         
	//   17   32:iadd            
	//   18   33:aload           6
	//   19   35:getfield        #679 <Field int android.view.ViewGroup$MarginLayoutParams.width>
	//   20   38:invokestatic    #660 <Method int getChildMeasureSpec(int, int, int)>
	//   21   41:istore_2        
	...
	//   26   49:iload_2         
	//   27   50:aload           6
	//   28   52:getfield        #685 <Field int android.view.ViewGroup$MarginLayoutParams.bottomMargin>
	//   29   55:iload_3         
	//   30   56:iadd            
	//   31   57:iconst_0        
	//   32   58:invokestatic    #665 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   33   61:invokevirtual   #668 <Method void View.measure(int, int)>
	//   34   64:return          
	}
...
_L3:
	...
	//   21   54:fload_2         
	//   22   55:aload_0         
	//   23   56:invokespecial   #699 <Method float getVerticalScrollFactorCompat()>
	//   24   59:fmul            
	//   25   60:f2i             
	//   26   61:istore_3        
		j = getScrollRange();
...
_L14:
	...
	//*  81  149:aload_0         
	//*  82  150:iconst_1        
	//*  83  151:invokevirtual   #515 <Method boolean hasNestedScrollingParent(int)>
	//*  84  154:ifne            174
	//*  85  157:aload_0         
	//*  86  158:getfield        #321 <Field OverScroller mScroller>
	//*  87  161:iload_1         
	//*  88  162:iload_2         
	//*  89  163:iconst_0        
	//*  90  164:iconst_0        
	//*  91  165:iconst_0        
	//*  92  166:aload_0         
	//*  93  167:invokevirtual   #243 <Method int getScrollRange()>
	//*  94  170:invokevirtual   #761 <Method boolean OverScroller.springBack(int, int, int, int, int, int)>
	//*  95  173:pop             
	//*  96  174:aload_0         
	//*  97  175:iload_1         
	//*  98  176:iload_2         
	//*  99  177:iload           9
	//* 100  179:iload           13
	//* 101  181:invokevirtual   #892 <Method void onOverScrolled(int, int, boolean, boolean)>
	//* 102  184:iload           9
	//* 103  186:ifne            194
	//* 104  189:iload           13
	//* 105  191:ifeq            248
