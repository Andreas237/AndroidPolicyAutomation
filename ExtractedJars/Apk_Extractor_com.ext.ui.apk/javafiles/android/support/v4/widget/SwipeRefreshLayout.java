	...
	implements NestedScrollingChild, NestedScrollingParent
{
	...
	//   29   50:putfield        #156 <Field android.view.animation.Animation$AnimationListener mRefreshListener>
		mAnimateToCorrectPosition = ((Animation) (new Animation() {
			...
			//   51   99:istore_3        
				...
				setTargetOffsetTopAndBottom((j + k) - l);
	...
	//   78  149:aload_0         
	//   79  150:aload           4
	//   80  152:getfield        #208 <Field float DisplayMetrics.density>
...
_L7:
	...
	//   30   60:iload_2         
	//   31   61:aload_0         
	//   32   62:invokevirtual   #606 <Method int getPaddingLeft()>
	//   33   65:isub            
	//   34   66:aload_0         
	//   35   67:invokevirtual   #612 <Method int getPaddingRight()>
	//   36   70:isub            
	//   37   71:iload           4
	//   38   73:iadd            
	//   39   74:iload_3         
	//   40   75:aload_0         
	//   41   76:invokevirtual   #609 <Method int getPaddingTop()>
	//   42   79:isub            
	//   43   80:aload_0         
	//   44   81:invokevirtual   #615 <Method int getPaddingBottom()>
	//   45   84:isub            
	//   46   85:iload           5
	//   47   87:iadd            
	...
	//   90  141:aload_0         
	//   91  142:aload_0         
	//   92  143:getfield        #646 <Field float mTotalUnconsumed>
	//   93  146:iload_3         
	//   94  147:i2f             
	//   95  148:fsub            
	//   96  149:putfield        #646 <Field float mTotalUnconsumed>
				ai[1] = j;
	//   97  152:aload           4
	//   98  154:iconst_1        
	//   99  155:iload_3         
	...
	//    9   15:aload_0         
	//   10   16:getfield        #147 <Field int[] mParentOffsetInWindow>
	//   11   19:iconst_1        
	//   12   20:iaload          
	//   13   21:iload           5
	//   14   23:iadd            
	...
	//   21   36:aload_0         
	//   22   37:getfield        #646 <Field float mTotalUnconsumed>
	//   23   40:fstore          6
			mTotalUnconsumed = (float)Math.abs(i) + f;
	//   24   42:aload_0         
	//   25   43:iload_2         
	//   26   44:invokestatic    #650 <Method int Math.abs(int)>
	//   27   47:i2f             
	//   28   48:fload           6
	//   29   50:fadd            
	//   30   51:putfield        #646 <Field float mTotalUnconsumed>
			moveSpinner(mTotalUnconsumed);
	//   31   54:aload_0         
	//   32   55:aload_0         
	//   33   56:getfield        #646 <Field float mTotalUnconsumed>
	//   34   59:invokespecial   #648 <Method void moveSpinner(float)>
		}
	//   35   62:return          
	}
...
_L7:
	...
	//   12   22:aload_0         
	//   13   23:aload_2         
	//   14   24:getfield        #208 <Field float DisplayMetrics.density>
	...
	//   33   63:aload_0         
	//   34   64:aload_2         
	//   35   65:getfield        #208 <Field float DisplayMetrics.density>
	//   36   68:ldc1            #203 <Float 40F>
	//   37   70:fmul            
	//   38   71:f2i             
