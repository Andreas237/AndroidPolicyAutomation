...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat
{
	...
	//   26   57:aload           4
	//   27   59:invokevirtual   #360 <Method int ArrayList.size()>
	//   28   62:istore_2        
		for(int i = 0; i < j; i++)
	//*  29   63:iconst_0        
	//*  30   64:istore_1        
...
label1:
	...
	//   20   42:astore_1        
				if(((View) (rect)).getAlpha() <= 0.0F || ((View) (rect)).getVisibility() != 0)
					break label0;
	//   21   43:aload_1         
...
_L3:
	...
	//    2    3:aload_0         
	//    3    4:invokespecial   #425 <Method SparseArrayCompat getAllNodes()>
	//    4    7:astore          6
		int j = mKeyboardFocusedVirtualViewId;
	//    5    9:aload_0         
	//    6   10:getfield        #76  <Field int mKeyboardFocusedVirtualViewId>
	//    7   13:istore_3        
		if(j == 0x80000000)
	//*   8   14:iload_3         
	//*   9   15:ldc1            #20  <Int 0x80000000>
	//*  10   17:icmpne          95
	...
	//*  13   23:iload_1         
	//*  14   24:lookupswitch    6: default 84
	//	               1: 109
	//	               2: 109
	//	               17: 160
	//	               33: 160
	//	               66: 160
	//	               130: 160
	//*  15   84:new             #80  <Class IllegalArgumentException>
	//*  16   87:dup             
	//*  17   88:ldc2            #427 <String "direction must be one of {FOCUS_FORWARD, FOCUS_BACKWARD, FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}.">
	//*  18   91:invokespecial   #85  <Method void IllegalArgumentException(String)>
	//*  19   94:athrow          
			accessibilitynodeinfocompat = (AccessibilityNodeInfoCompat)sparsearraycompat.get(j);
	//   20   95:aload           6
	//   21   97:iload_3         
	//   22   98:invokevirtual   #428 <Method Object SparseArrayCompat.get(int)>
	//   23  101:checkcast       #162 <Class AccessibilityNodeInfoCompat>
	//   24  104:astore          5
		switch(i)
		{
		default:
	...
	//*  26  109:aload_0         
	//*  27  110:getfield        #87  <Field View mHost>
	//*  28  113:invokestatic    #431 <Method int ViewCompat.getLayoutDirection(View)>
	//*  29  116:iconst_1        
	//*  30  117:icmpne          154
	//*  31  120:aload           6
	//*  32  122:getstatic       #60  <Field FocusStrategy$CollectionAdapter SPARSE_VALUES_ADAPTER>
	//*  33  125:getstatic       #57  <Field FocusStrategy$BoundsAdapter NODE_ADAPTER>
	//*  34  128:aload           5
	//*  35  130:iload_1         
	//*  36  131:iload           4
	//*  37  133:iconst_0        
	//*  38  134:invokestatic    #437 <Method Object FocusStrategy.findNextFocusInRelativeDirection(Object, FocusStrategy$CollectionAdapter, FocusStrategy$BoundsAdapter, Object, int, boolean, boolean)>
	//*  39  137:checkcast       #162 <Class AccessibilityNodeInfoCompat>
	//*  40  140:astore_2        
	//*  41  141:aload_2         
	//*  42  142:ifnonnull       238
	//*  43  145:ldc1            #20  <Int 0x80000000>
	//*  44  147:istore_1        
	//*  45  148:aload_0         
	//*  46  149:iload_1         
	//*  47  150:invokevirtual   #440 <Method boolean requestKeyboardFocusForVirtualView(int)>
	//*  48  153:ireturn         
				flag = false;
	//   49  154:iconst_0        
	//   50  155:istore          4
...
_L1:
	...
	//*  51  157:goto            120
	//*  52  160:new             #46  <Class Rect>
	//*  53  163:dup             
	//*  54  164:invokespecial   #64  <Method void Rect()>
	//*  55  167:astore          7
	//*  56  169:aload_0         
	//*  57  170:getfield        #76  <Field int mKeyboardFocusedVirtualViewId>
	//*  58  173:ldc1            #20  <Int 0x80000000>
	//*  59  175:icmpeq          211
	//*  60  178:aload_0         
	//*  61  179:aload_0         
	//*  62  180:getfield        #76  <Field int mKeyboardFocusedVirtualViewId>
	//*  63  183:aload           7
	//*  64  185:invokespecial   #442 <Method void getBoundsInParent(int, Rect)>
	//*  65  188:aload           6
	//*  66  190:getstatic       #60  <Field FocusStrategy$CollectionAdapter SPARSE_VALUES_ADAPTER>
	//*  67  193:getstatic       #57  <Field FocusStrategy$BoundsAdapter NODE_ADAPTER>
	//*  68  196:aload           5
	//*  69  198:aload           7
	//*  70  200:iload_1         
	//*  71  201:invokestatic    #446 <Method Object FocusStrategy.findNextFocusInAbsoluteDirection(Object, FocusStrategy$CollectionAdapter, FocusStrategy$BoundsAdapter, Object, Rect, int)>
	//*  72  204:checkcast       #162 <Class AccessibilityNodeInfoCompat>
	//*  73  207:astore_2        
	//*  74  208:goto            141
	//*  75  211:aload_2         
	//*  76  212:ifnull          224
	//*  77  215:aload           7
	//*  78  217:aload_2         
	//*  79  218:invokevirtual   #448 <Method void Rect.set(Rect)>
	//*  80  221:goto            188
	//*  81  224:aload_0         
	//*  82  225:getfield        #87  <Field View mHost>
	//*  83  228:iload_1         
	//*  84  229:aload           7
	//*  85  231:invokestatic    #450 <Method Rect guessPreviouslyFocusedRect(View, int, Rect)>
	//*  86  234:pop             
	//*  87  235:goto            188
	...
	//   89  240:aload           6
	//   90  242:aload_2         
	//   91  243:invokevirtual   #454 <Method int SparseArrayCompat.indexOfValue(Object)>
	//   92  246:invokevirtual   #457 <Method int SparseArrayCompat.keyAt(int)>
	//   93  249:istore_1        
