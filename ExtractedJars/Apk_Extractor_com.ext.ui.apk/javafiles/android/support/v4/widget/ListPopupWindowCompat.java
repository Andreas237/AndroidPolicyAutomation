...
public final class ListPopupWindowCompat
{
	...
	//    3    8:aload_0         
	//    4    9:aload_1         
	//    5   10:invokevirtual   #22  <Method android.view.View$OnTouchListener ListPopupWindow.createDragToOpenListener(View)>
	//    6   13:areturn         
		else
			return null;
	//    7   14:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:checkcast       #19  <Class ListPopupWindow>
	//    2    4:aload_1         
	//    3    5:invokestatic    #26  <Method android.view.View$OnTouchListener createDragToOpenListener(ListPopupWindow, View)>
	//    4    8:areturn         
	}
}
