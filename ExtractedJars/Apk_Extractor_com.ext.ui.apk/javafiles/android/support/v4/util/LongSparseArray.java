	...
	implements Cloneable
{
	...
	//   17   33:iload_1         
	//   18   34:invokestatic    #48  <Method int ContainerHelpers.idealLongArraySize(int)>
	//   19   37:istore_1        
			mKeys = new long[i];
	//   20   38:aload_0         
	//   21   39:iload_1         
	//   22   40:newarray        long[]
	//   23   42:putfield        #37  <Field long[] mKeys>
	...
	//   28   50:invokespecial   #56  <Method void gc()>
		int i = mSize;
	//   29   53:aload_0         
	//   30   54:getfield        #44  <Field int mSize>
	//   31   57:istore          4
		if(i >= mKeys.length)
	//*  32   59:iload           4
	//*  33   61:aload_0         
	...
	//   38   71:iconst_1        
	//   39   72:iadd            
	//   40   73:invokestatic    #48  <Method int ContainerHelpers.idealLongArraySize(int)>
	//   41   76:istore          5
			long al[] = new long[j];
	//   42   78:iload           5
	//   43   80:newarray        long[]
	...
	//   84  154:iconst_1        
	//   85  155:iadd            
	//   86  156:putfield        #44  <Field int mSize>
	//   87  159:return          
	}
	...
	public LongSparseArray clone()
	{
		...
		try
		{
			obj = ((Object) ((LongSparseArray)super.clone()));
	//    0    0:aload_0         
	...
	//   20   40:areturn         
		...
		try
		{
			obj.mKeys = (long[])((long []) (mKeys)).clone();
	...
	//*  47   88:aload_0         
	//*  48   89:getfield        #44  <Field int mSize>
	//*  49   92:aload_0         
	...
	//   57  108:aload_0         
	//   58  109:getfield        #44  <Field int mSize>
	//   59  112:lload_1         
	...
	//   63  118:istore          4
		...
		if(mSize >= mKeys.length)
	//*  64  120:aload_0         
	//*  65  121:getfield        #44  <Field int mSize>
	//*  66  124:aload_0         
	...
	//   70  132:aload_0         
	//   71  133:getfield        #44  <Field int mSize>
	//   72  136:iconst_1        
	//   73  137:iadd            
	//   74  138:invokestatic    #48  <Method int ContainerHelpers.idealLongArraySize(int)>
	//   75  141:istore          5
			long al[] = new long[k];
	//   76  143:iload           5
	...
	//  105  197:putfield        #42  <Field Object[] mValues>
		...
		if(mSize - i != 0)
	//* 106  200:aload_0         
	//* 107  201:getfield        #44  <Field int mSize>
	//* 108  204:iload           4
	//* 109  206:isub            
	//* 110  207:ifeq            258
		{
	...
	//  118  223:iadd            
	//  119  224:aload_0         
	//  120  225:getfield        #44  <Field int mSize>
	//  121  228:iload           4
	//  122  230:isub            
	...
	//  131  247:iadd            
	//  132  248:aload_0         
	//  133  249:getfield        #44  <Field int mSize>
	//  134  252:iload           4
	//  135  254:isub            
	...
	//  147  274:aload_0         
	//  148  275:aload_0         
	//  149  276:getfield        #44  <Field int mSize>
	//  150  279:iconst_1        
	//  151  280:iadd            
	//  152  281:putfield        #44  <Field int mSize>
	//  153  284:return          
	}
	...
	//   55   94:aload_2         
	//   56   95:ldc1            #140 <String "(this Map)">
	//   57   97:invokevirtual   #126 <Method StringBuilder StringBuilder.append(String)>
	//   58  100:pop             
			i++;
		}
	//*  59  101:goto            87
