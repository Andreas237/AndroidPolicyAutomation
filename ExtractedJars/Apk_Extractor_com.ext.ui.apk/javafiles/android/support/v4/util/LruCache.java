...
_L1:
	...
	//   19   28:getstatic       #127 <Field Locale Locale.US>
	//   20   31:ldc1            #129 <String "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]">
	//   21   33:iconst_4        
	//   22   34:anewarray       Object[]
	//   23   37:dup             
	//   24   38:iconst_0        
	//   25   39:aload_0         
	//   26   40:getfield        #30  <Field int maxSize>
	//   27   43:invokestatic    #135 <Method Integer Integer.valueOf(int)>
	//   28   46:aastore         
	//   29   47:dup             
	//   30   48:iconst_1        
	//   31   49:aload_0         
	//   32   50:getfield        #92  <Field int hitCount>
	//   33   53:invokestatic    #135 <Method Integer Integer.valueOf(int)>
	//   34   56:aastore         
	//   35   57:dup             
	//   36   58:iconst_2        
	//   37   59:aload_0         
	//   38   60:getfield        #94  <Field int missCount>
	//   39   63:invokestatic    #135 <Method Integer Integer.valueOf(int)>
	//   40   66:aastore         
	//   41   67:dup             
	//   42   68:iconst_3        
	//   43   69:iload_1         
	//   44   70:invokestatic    #135 <Method Integer Integer.valueOf(int)>
	//   45   73:aastore         
	//   46   74:invokestatic    #141 <Method String String.format(Locale, String, Object[])>
	//   47   77:astore_3        
		this;
	//   48   78:aload_0         
		JVM INSTR monitorexit ;
...
_L2:
	...
	//   17   37:aload_0         
	//   18   38:invokevirtual   #149 <Method Class Object.getClass()>
	//   19   41:invokevirtual   #154 <Method String Class.getName()>
	//   20   44:invokevirtual   #55  <Method StringBuilder StringBuilder.append(String)>
	//   21   47:ldc1            #156 <String ".sizeOf() is reporting inconsistent results!">
	...
	//   37   76:invokevirtual   #145 <Method boolean LinkedHashMap.isEmpty()>
	//   38   79:ifeq            85
		this;
	//   39   82:aload_0         
		JVM INSTR monitorexit ;
	...
	//   44   89:invokevirtual   #160 <Method Set LinkedHashMap.entrySet()>
	//   45   92:invokeinterface #166 <Method Iterator Set.iterator()>
	//   46   97:invokeinterface #172 <Method Object Iterator.next()>
	//   47  102:checkcast       #174 <Class java.util.Map$Entry>
	//   48  105:astore_3        
		obj = ((java.util.Map.Entry) (obj1)).getKey();
	//   49  106:aload_3         
	//   50  107:invokeinterface #177 <Method Object java.util.Map$Entry.getKey()>
	//   51  112:astore_2        
		obj1 = ((java.util.Map.Entry) (obj1)).getValue();
	//   52  113:aload_3         
	//   53  114:invokeinterface #180 <Method Object java.util.Map$Entry.getValue()>
	//   54  119:astore_3        
		map.remove(obj);
	//   55  120:aload_0         
