...
_L1:
		...
		public void addQueueItem(MediaDescriptionCompat mediadescriptioncompat)
		{
			if((getFlags() & 4L) == 0L)
		//*   0    0:aload_0         
		//*   1    1:invokevirtual   #150 <Method long getFlags()>
		//*   2    4:ldc2w           #151 <Long 4L>
		//*   3    7:land            
		//*   4    8:lconst_0        
		//*   5    9:lcmp            
		//*   6   10:ifne            23
...
*/
	...
	//*  11   22:aload_0         
	//*  12   23:ifnull          35
				activity = ((Activity) (((MediaControllerExtraData) (activity)).getMediaController()));
	//   13   26:aload_0         
	//   14   27:invokevirtual   #159 <Method MediaControllerCompat MediaControllerCompat$MediaControllerExtraData.getMediaController()>
	//   15   30:astore_0        
			else
	//*  16   31:aload_0         
	//*  17   32:astore_1        
	...
	//*  22   37:goto            31
		{
			activity1 = ((Activity) (obj1));
	//   23   40:aload_2         
	//   24   41:astore_1        
			if(android.os.Build.VERSION.SDK_INT >= 21)
	//*  25   42:getstatic       #118 <Field int android.os.Build$VERSION.SDK_INT>
	//*  26   45:bipush          21
	//*  27   47:icmplt          33
			{
				Object obj2 = MediaControllerCompatApi21.getMediaController(activity);
	//   28   50:aload_0         
	//   29   51:invokestatic    #164 <Method Object MediaControllerCompatApi21.getMediaController(Activity)>
	//   30   54:astore_3        
				activity1 = ((Activity) (obj1));
	//   31   55:aload_2         
	//   32   56:astore_1        
	...
	//   35   61:aload_3         
	//   36   62:invokestatic    #167 <Method Object MediaControllerCompatApi21.getSessionToken(Object)>
	//   37   65:astore_1        
					try
					{
						activity = ((Activity) (new MediaControllerCompat(((Context) (activity)), MediaSessionCompat.Token.fromToken(obj))));
	//   38   66:new             #2   <Class MediaControllerCompat>
	//   39   69:dup             
	//   40   70:aload_0         
	//   41   71:aload_1         
	//   42   72:invokestatic    #173 <Method MediaSessionCompat$Token MediaSessionCompat$Token.fromToken(Object)>
	//   43   75:invokespecial   #174 <Method void MediaControllerCompat(Context, MediaSessionCompat$Token)>
	//   44   78:astore_0        
					}
	//*  45   79:aload_0         
	//*  46   80:areturn         
	...
	//   48   82:ldc1            #83  <String "MediaControllerCompat">
	//   49   84:ldc1            #176 <String "Dead object in getMediaController.">
	//   50   86:aload_0         
	//   51   87:invokestatic    #182 <Method int Log.e(String, String, Throwable)>
	//   52   90:pop             
						return null;
	//   53   91:aconst_null     
	//   54   92:areturn         
		...
		return ((MediaControllerCompat) (activity1));
	}
