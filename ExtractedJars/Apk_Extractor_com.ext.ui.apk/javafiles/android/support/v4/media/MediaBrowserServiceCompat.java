...
public abstract class MediaBrowserServiceCompat extends Service
{
		...
		implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy
	{
		...
		//*   1    1:ifnull          200
		//*   2    4:aload_3         
		//*   3    5:ldc1            #107 <String "extra_client_version">
		//*   4    7:iconst_0        
		//*   5    8:invokevirtual   #111 <Method int Bundle.getInt(String, int)>
		//*   6   11:ifeq            200
			{
				bundle.remove("extra_client_version");
		//    7   14:aload_3         
		//    8   15:ldc1            #107 <String "extra_client_version">
		//    9   17:invokevirtual   #114 <Method void Bundle.remove(String)>
				mMessenger = new Messenger(((Handler) (mHandler)));
		//   10   20:aload_0         
		//   11   21:new             #116 <Class Messenger>
		//   12   24:dup             
		//   13   25:aload_0         
		//   14   26:getfield        #33  <Field MediaBrowserServiceCompat this$0>
		//   15   29:getfield        #81  <Field MediaBrowserServiceCompat$ServiceHandler MediaBrowserServiceCompat.mHandler>
		//   16   32:invokespecial   #119 <Method void Messenger(Handler)>
		//   17   35:putfield        #46  <Field Messenger mMessenger>
				bundle1 = new Bundle();
		//   18   38:new             #65  <Class Bundle>
		//   19   41:dup             
		//   20   42:invokespecial   #120 <Method void Bundle()>
		//   21   45:astore          4
				bundle1.putInt("extra_service_version", 1);
		//   22   47:aload           4
		//   23   49:ldc1            #122 <String "extra_service_version">
		//   24   51:iconst_1        
		//   25   52:invokevirtual   #126 <Method void Bundle.putInt(String, int)>
				BundleCompat.putBinder(bundle1, "extra_messenger", mMessenger.getBinder());
		//   26   55:aload           4
		//   27   57:ldc1            #128 <String "extra_messenger">
		//   28   59:aload_0         
		//   29   60:getfield        #46  <Field Messenger mMessenger>
		//   30   63:invokevirtual   #132 <Method IBinder Messenger.getBinder()>
		//   31   66:invokestatic    #138 <Method void BundleCompat.putBinder(Bundle, String, IBinder)>
				if(mSession != null)
		//*  32   69:aload_0         
		//*  33   70:getfield        #33  <Field MediaBrowserServiceCompat this$0>
		//*  34   73:getfield        #142 <Field android.support.v4.media.session.MediaSessionCompat$Token MediaBrowserServiceCompat.mSession>
		//*  35   76:ifnull          137
				{
					Object obj = ((Object) (mSession.getExtraBinder()));
		//   36   79:aload_0         
		//   37   80:getfield        #33  <Field MediaBrowserServiceCompat this$0>
		//   38   83:getfield        #142 <Field android.support.v4.media.session.MediaSessionCompat$Token MediaBrowserServiceCompat.mSession>
		//   39   86:invokevirtual   #148 <Method IMediaSession android.support.v4.media.session.MediaSessionCompat$Token.getExtraBinder()>
		//   40   89:astore          5
					if(obj == null)
		//*  41   91:aload           5
		//*  42   93:ifnonnull       125
		...
		//*  45   99:aload           4
		//*  46  101:ldc1            #150 <String "extra_session_binder">
		//*  47  103:aload           5
		//*  48  105:invokestatic    #138 <Method void BundleCompat.putBinder(Bundle, String, IBinder)>
		//*  49  108:aload_0         
		//*  50  109:getfield        #33  <Field MediaBrowserServiceCompat this$0>
		//*  51  112:aload_1         
		//*  52  113:iload_2         
		//*  53  114:aload_3         
		//*  54  115:invokevirtual   #153 <Method MediaBrowserServiceCompat$BrowserRoot MediaBrowserServiceCompat.onGetRoot(String, int, Bundle)>
		//*  55  118:astore_3        
		//*  56  119:aload_3         
		//*  57  120:ifnonnull       152
		//*  58  123:aconst_null     
		//*  59  124:areturn         
						obj = ((Object) (((IMediaSession) (obj)).asBinder()));
		//   60  125:aload           5
		//   61  127:invokeinterface #158 <Method IBinder IMediaSession.asBinder()>
		//   62  132:astore          5
		...
		//   64  137:aload_0         
		//   65  138:getfield        #41  <Field List mRootExtrasList>
		//   66  141:aload           4
		//   67  143:invokeinterface #164 <Method boolean List.add(Object)>
		//   68  148:pop             
				}
			} else
		//*  69  149:goto            108
		//*  70  152:aload           4
		//*  71  154:ifnonnull       175
		//*  72  157:aload_3         
		//*  73  158:invokevirtual   #169 <Method Bundle MediaBrowserServiceCompat$BrowserRoot.getExtras()>
		//*  74  161:astore_1        
		//*  75  162:new             #171 <Class MediaBrowserServiceCompatApi21$BrowserRoot>
		//*  76  165:dup             
		//*  77  166:aload_3         
		//*  78  167:invokevirtual   #175 <Method String MediaBrowserServiceCompat$BrowserRoot.getRootId()>
		//*  79  170:aload_1         
		//*  80  171:invokespecial   #177 <Method void MediaBrowserServiceCompatApi21$BrowserRoot(String, Bundle)>
		//*  81  174:areturn         
		//*  82  175:aload           4
		//*  83  177:astore_1        
		//*  84  178:aload_3         
		//*  85  179:invokevirtual   #169 <Method Bundle MediaBrowserServiceCompat$BrowserRoot.getExtras()>
		//*  86  182:ifnull          162
		//*  87  185:aload           4
		//*  88  187:aload_3         
		//*  89  188:invokevirtual   #169 <Method Bundle MediaBrowserServiceCompat$BrowserRoot.getExtras()>
		//*  90  191:invokevirtual   #180 <Method void Bundle.putAll(Bundle)>
		//*  91  194:aload           4
		//*  92  196:astore_1        
		//*  93  197:goto            162
			{
...
_L3:
		...
		public void onLoadChildren(String s, MediaBrowserServiceCompatApi21.ResultWrapper resultwrapper)
		{
			resultwrapper = ((MediaBrowserServiceCompatApi21.ResultWrapper) (((_cls3) (s)). new Result(resultwrapper) {
				...
				//*  28   61:goto            21
					resultWrapper.sendResult(((Object) (arraylist)));
				//   29   64:aload_0         
...
_L1:
	...
	//    8   18:new             #168 <Class ArrayList>
	//    9   21:dup             
	//   10   22:invokespecial   #169 <Method void ArrayList()>
	//   11   25:astore          5
		for(Iterator iterator = ((List) (obj)).iterator(); iterator.hasNext();)
	//*  12   27:aload           5
	//*  13   29:invokeinterface #173 <Method Iterator List.iterator()>
	//*  14   34:astore          6
	//*  15   36:aload           6
	//*  16   38:invokeinterface #179 <Method boolean Iterator.hasNext()>
	//*  17   43:ifeq            84
		{
			Pair pair = (Pair)iterator.next();
	//   18   46:aload           6
	//   19   48:invokeinterface #183 <Method Object Iterator.next()>
	//   20   53:checkcast       #185 <Class Pair>
	//   21   56:astore          7
			if(ibinder == pair.first && MediaBrowserCompatUtils.areSameOptions(bundle, (Bundle)pair.second))
	//*  22   58:aload_3         
	//*  23   59:aload           7
	//*  24   61:getfield        #189 <Field Object Pair.first>
	//*  25   64:if_acmpne       36
	//*  26   67:aload           4
	//*  27   69:aload           7
	//*  28   71:getfield        #192 <Field Object Pair.second>
	//*  29   74:checkcast       #194 <Class Bundle>
	//*  30   77:invokestatic    #200 <Method boolean MediaBrowserCompatUtils.areSameOptions(Bundle, Bundle)>
	//*  31   80:ifeq            36
				return;
	//   32   83:return          
		}
	...
	//   33   84:aload           5
	//   34   86:new             #185 <Class Pair>
	//   35   89:dup             
	//   36   90:aload_3         
	//   37   91:aload           4
	//   38   93:invokespecial   #203 <Method void Pair(Object, Object)>
	//   39   96:invokeinterface #207 <Method boolean List.add(Object)>
	//   40  101:pop             
		connectionrecord.subscriptions.put(((Object) (s)), obj);
	//   41  102:aload_2         
	//   42  103:getfield        #158 <Field HashMap MediaBrowserServiceCompat$ConnectionRecord.subscriptions>
	//   43  106:aload_1         
	//   44  107:aload           5
	//   45  109:invokevirtual   #211 <Method Object HashMap.put(Object, Object)>
	//   46  112:pop             
	...
	//   49  115:aload_2         
	//   50  116:aload           4
	//   51  118:invokevirtual   #215 <Method void performLoadChildren(String, MediaBrowserServiceCompat$ConnectionRecord, Bundle)>
	//   52  121:return          
	//*  53  122:goto            27
	}
...
;
	...
	//   11   19:aload_2         
	//   12   20:getfield        #158 <Field HashMap MediaBrowserServiceCompat$ConnectionRecord.subscriptions>
	//   13   23:aload_1         
	//   14   24:invokevirtual   #164 <Method Object HashMap.get(Object)>
	//   15   27:checkcast       #166 <Class List>
	//   16   30:astore          6
		boolean flag1;
		if(list != null)
	//*  17   32:aload           6
	...
	//   19   37:aload           6
	//   20   39:invokeinterface #173 <Method Iterator List.iterator()>
	//   21   44:astore          7
			boolean flag = false;
	//   22   46:iconst_0        
	//   23   47:istore          4
			do
			{
				if(!iterator.hasNext())
					break;
	//   24   49:aload           7
	//   25   51:invokeinterface #179 <Method boolean Iterator.hasNext()>
	//   26   56:ifeq            89
				if(ibinder == ((Pair)iterator.next()).first)
	//*  27   59:aload_3         
	//*  28   60:aload           7
	//*  29   62:invokeinterface #183 <Method Object Iterator.next()>
	//*  30   67:checkcast       #185 <Class Pair>
	//*  31   70:getfield        #189 <Field Object Pair.first>
	//*  32   73:if_acmpne       49
				{
					iterator.remove();
	//   33   76:aload           7
	//   34   78:invokeinterface #395 <Method void Iterator.remove()>
					flag = true;
	//   35   83:iconst_1        
	//   36   84:istore          4
				}
	...
	//   39   91:istore          5
			if(list.size() == 0)
	//*  40   93:aload           6
	//*  41   95:invokeinterface #229 <Method int List.size()>
	//*  42  100:ifne            116
			{
				connectionrecord.subscriptions.remove(((Object) (s)));
	//   43  103:aload_2         
	//   44  104:getfield        #158 <Field HashMap MediaBrowserServiceCompat$ConnectionRecord.subscriptions>
	//   45  107:aload_1         
	//   46  108:invokevirtual   #393 <Method Object HashMap.remove(Object)>
	//   47  111:pop             
				flag1 = flag;
	//   48  112:iload           4
	//   49  114:istore          5
