...
//			PathMotion, TransitionListenerAdapter
...
public class TransitionSet extends Transition
{
	...
	//*  44   88:aload           4
	//*  45   90:aload           5
	//*  46   92:invokevirtual   #210 <Method void Transition.createAnimators(ViewGroup, TransitionValuesMaps, TransitionValuesMaps, ArrayList, ArrayList)>
	//*  47   95:iload           6
	//*  48   97:iconst_1        
	//*  49   98:iadd            
	//*  50   99:istore          6
	...
	//   52  104:aload           12
	//   53  106:lload           8
	//   54  108:invokevirtual   #208 <Method Transition Transition.setStartDelay(long)>
	//   55  111:pop             
			}
	...
	//   11   21:iload_1         
	//   12   22:invokevirtual   #131 <Method Object ArrayList.get(int)>
...
_L3:
	...
	//    2   24:new             #303 <Class AndroidRuntimeException>
	//    3   27:dup             
	//    4   28:new             #305 <Class StringBuilder>
	//    5   31:dup             
	//    6   32:invokespecial   #306 <Method void StringBuilder()>
	//    7   35:ldc2            #308 <String "Invalid parameter for TransitionSet ordering: ">
	//    8   38:invokevirtual   #312 <Method StringBuilder StringBuilder.append(String)>
	//    9   41:iload_1         
	//   10   42:invokevirtual   #315 <Method StringBuilder StringBuilder.append(int)>
	//   11   45:invokevirtual   #319 <Method String StringBuilder.toString()>
	//   12   48:invokespecial   #322 <Method void AndroidRuntimeException(String)>
	//   13   51:athrow          
	...
	//   14   52:aload_0         
	//   15   53:iconst_0        
	//   16   54:putfield        #32  <Field boolean mPlayTogether>
			return this;
	//   17   57:aload_0         
	//   18   58:areturn         
	...
	//   19   59:aload_0         
	//   20   60:iconst_1        
	//   21   61:putfield        #32  <Field boolean mPlayTogether>
			return this;
	//   22   64:aload_0         
	//   23   65:areturn         
		}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #331 <Method TransitionSet setSceneRoot(ViewGroup)>
	//    3    5:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #333 <Method Transition Transition.setSceneRoot(ViewGroup)>
	//    3    5:pop             
		int j = mTransitions.size();
	//    4    6:aload_0         
	...
	//   18   32:aload_1         
	//   19   33:invokevirtual   #333 <Method Transition Transition.setSceneRoot(ViewGroup)>
	//   20   36:pop             
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:invokevirtual   #335 <Method TransitionSet setStartDelay(long)>
	//    3    5:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #338 <Method String Transition.toString(String)>
	//    3    5:astore_3        
		for(int i = 0; i < mTransitions.size(); i++)
	//*   4    6:iconst_0        
	//*   5    7:istore_2        
	...
	//   11   19:new             #305 <Class StringBuilder>
	//   12   22:dup             
	//   13   23:invokespecial   #306 <Method void StringBuilder()>
	//   14   26:aload_3         
	//   15   27:invokevirtual   #312 <Method StringBuilder StringBuilder.append(String)>
	//   16   30:ldc2            #340 <String "\n">
	//   17   33:invokevirtual   #312 <Method StringBuilder StringBuilder.append(String)>
	//   18   36:aload_0         
	//   19   37:getfield        #30  <Field ArrayList mTransitions>
	//   20   40:iload_2         
	//   21   41:invokevirtual   #131 <Method Object ArrayList.get(int)>
	//   22   44:checkcast       #4   <Class Transition>
	//   23   47:new             #305 <Class StringBuilder>
	//   24   50:dup             
	//   25   51:invokespecial   #306 <Method void StringBuilder()>
	//   26   54:aload_1         
	//   27   55:invokevirtual   #312 <Method StringBuilder StringBuilder.append(String)>
	//   28   58:ldc2            #342 <String "  ">
	//   29   61:invokevirtual   #312 <Method StringBuilder StringBuilder.append(String)>
	//   30   64:invokevirtual   #319 <Method String StringBuilder.toString()>
	//   31   67:invokevirtual   #338 <Method String Transition.toString(String)>
	//   32   70:invokevirtual   #312 <Method StringBuilder StringBuilder.append(String)>
	//   33   73:invokevirtual   #319 <Method String StringBuilder.toString()>
	//   34   76:astore_3        
