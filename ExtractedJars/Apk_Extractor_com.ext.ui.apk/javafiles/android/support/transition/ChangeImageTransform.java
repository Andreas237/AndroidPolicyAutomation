...
public class ChangeImageTransform extends Transition
{
	...
	//*  48  108:aload_1         
	//*  49  109:aload           7
	//*  50  111:invokevirtual   #189 <Method boolean Rect.equals(Object)>
	//*  51  114:ifeq            130
	//*  52  117:iload           4
	//*  53  119:ifeq            130
	//*  54  122:aconst_null     
	...
	//   78  169:aload_0         
	//   79  170:aload_3         
	//   80  171:invokespecial   #197 <Method ObjectAnimator createNullAnimator(ImageView)>
	//   81  174:astore_1        
		} else
	//*  82  175:aload_3         
	//*  83  176:aload_1         
	//*  84  177:invokestatic    #201 <Method void ImageViewUtils.reserveEndAnimateTransform(ImageView, Animator)>
	//*  85  180:aload_1         
	//*  86  181:areturn         
		{
	...
	//*  89  184:aload_2         
	//*  90  185:ifnonnull       192
				viewgroup = ((ViewGroup) (MatrixUtils.IDENTITY_MATRIX));
	//   91  188:getstatic       #207 <Field Matrix MatrixUtils.IDENTITY_MATRIX>
	//   92  191:astore_1        
	...
	//   94  194:astore_2        
			if(matrix == null)
	//*  95  195:aload           6
	//*  96  197:ifnonnull       204
				transitionvalues = ((TransitionValues) (MatrixUtils.IDENTITY_MATRIX));
	//   97  200:getstatic       #207 <Field Matrix MatrixUtils.IDENTITY_MATRIX>
	//   98  203:astore_2        
			ANIMATED_TRANSFORM_PROPERTY.set(((Object) (transitionvalues1)), ((Object) (viewgroup)));
	//   99  204:getstatic       #45  <Field Property ANIMATED_TRANSFORM_PROPERTY>
	//  100  207:aload_3         
	//  101  208:aload_1         
	//  102  209:invokevirtual   #213 <Method void Property.set(Object, Object)>
			viewgroup = ((ViewGroup) (createMatrixAnimator(((ImageView) (transitionvalues1)), ((Matrix) (viewgroup)), ((Matrix) (transitionvalues)))));
	//  103  212:aload_0         
	//  104  213:aload_3         
	//  105  214:aload_1         
	//  106  215:aload_2         
	//  107  216:invokespecial   #215 <Method ObjectAnimator createMatrixAnimator(ImageView, Matrix, Matrix)>
	//  108  219:astore_1        
		}
