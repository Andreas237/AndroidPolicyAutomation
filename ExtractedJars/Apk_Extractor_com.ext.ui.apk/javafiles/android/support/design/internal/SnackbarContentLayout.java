	...
	implements android.support.design.widget.BaseTransientBottomBar.ContentViewCallback
{
	...
	//*  44   85:ifeq            142
	//*  45   88:aload_0         
	//*  46   89:getfield        #52  <Field int mMaxInlineActionWidth>
	//*  47   92:ifle            142
	//*  48   95:aload_0         
	//*  49   96:getfield        #137 <Field Button mActionView>
	//*  50   99:invokevirtual   #203 <Method int Button.getMeasuredWidth()>
	//*  51  102:aload_0         
	//*  52  103:getfield        #52  <Field int mMaxInlineActionWidth>
	//*  53  106:icmple          142
	//*  54  109:aload_0         
	//*  55  110:iconst_1        
	//*  56  111:iload           4
	...
	//*  58  115:iload           5
	//*  59  117:isub            
	//*  60  118:invokespecial   #205 <Method boolean updateViewsWithinLayout(int, int, int)>
	//*  61  121:ifeq            170
	//*  62  124:iconst_1        
	//*  63  125:istore_1        
	//*  64  126:iload_1         
	...
	//*  67  131:iload_3         
	//*  68  132:iload_2         
	//*  69  133:invokespecial   #167 <Method void LinearLayout.onMeasure(int, int)>
	//*  70  136:return          
			i = 0;
	//   71  137:iconst_0        
	//   72  138:istore_1        
...
_L2:
	...
	//*  80  151:iload_1         
	//*  81  152:iload_1         
	//*  82  153:invokespecial   #205 <Method boolean updateViewsWithinLayout(int, int, int)>
	//*  83  156:ifeq            170
	//*  84  159:iconst_1        
	//*  85  160:istore_1        
	//*  86  161:goto            126
