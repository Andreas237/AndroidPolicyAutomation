...
class ShadowDrawableWrapper extends DrawableWrapper
{
	...
	//*  27   43:aload_0         
	//*  28   44:getfield        #63  <Field boolean mPrintedShadowClipWarning>
	//*  29   47:ifne            55
				mPrintedShadowClipWarning = true;
	//   30   50:aload_0         
	//   31   51:iconst_1        
	//   32   52:putfield        #63  <Field boolean mPrintedShadowClipWarning>
			f = f1;
	//   33   55:fload_2         
	//   34   56:fstore_1        
		}
	...
	//*  35   57:aload_0         
	//*  36   58:getfield        #268 <Field float mRawShadowSize>
	//*  37   61:fload_1         
	//*  38   62:fcmpl           
	//*  39   63:ifne            76
	//*  40   66:aload_0         
	//*  41   67:getfield        #132 <Field float mRawMaxShadowSize>
	//*  42   70:fload_2         
	//*  43   71:fcmpl           
	//*  44   72:ifne            76
		{
	...
	//   46   76:aload_0         
	//   47   77:fload_1         
	//   48   78:putfield        #268 <Field float mRawShadowSize>
			mRawMaxShadowSize = f1;
	//   49   81:aload_0         
	//   50   82:fload_2         
	//   51   83:putfield        #132 <Field float mRawMaxShadowSize>
			mShadowSize = Math.round(f * 1.5F);
	//   52   86:aload_0         
	//   53   87:fload_1         
	//   54   88:ldc1            #13  <Float 1.5F>
	//   55   90:fmul            
	//   56   91:invokestatic    #107 <Method int Math.round(float)>
	//   57   94:i2f             
	//   58   95:putfield        #178 <Field float mShadowSize>
			mMaxShadowSize = f1;
	//   59   98:aload_0         
	//   60   99:fload_2         
	//   61  100:putfield        #344 <Field float mMaxShadowSize>
			mDirty = true;
	//   62  103:aload_0         
	//   63  104:iconst_1        
	//   64  105:putfield        #59  <Field boolean mDirty>
			invalidateSelf();
	//   65  108:aload_0         
	//   66  109:invokevirtual   #326 <Method void invalidateSelf()>
			return;
	//   67  112:return          
		}
	}
