...
label0:
	...
	class TabView extends LinearLayout
	{
		...
		//  105  212:aload_2         
		//  106  213:aconst_null     
		//  107  214:invokevirtual   #129 <Method void ImageView.setImageDrawable(Drawable)>
				}
...
_L1:
			...
			getResources();
		//   36   75:aload_0         
		//   37   76:invokevirtual   #233 <Method Resources getResources()>
		//   38   79:pop             
			f1 = mTabTextSize;
		//   39   80:aload_0         
...
_L5:
	...
	//*  11   21:aload_0         
	//*  12   22:getfield        #162 <Field TabLayout$SlidingTabStrip mTabStrip>
	//*  13   25:iload_1         
	//*  14   26:iconst_0        
	//*  15   27:iconst_0        
	//*  16   28:iconst_0        
	//*  17   29:invokestatic    #471 <Method void ViewCompat.setPaddingRelative(View, int, int, int, int)>
	//*  18   32:aload_0         
	//*  19   33:getfield        #316 <Field int mMode>
	//*  20   36:tableswitch     0 1: default 60
	//	               0 77
	//	               1 66
	//*  21   60:aload_0         
	//*  22   61:iconst_1        
	//*  23   62:invokevirtual   #474 <Method void updateTabViews(boolean)>
	//*  24   65:return          
	//*  25   66:aload_0         
	//*  26   67:getfield        #162 <Field TabLayout$SlidingTabStrip mTabStrip>
	//*  27   70:iconst_1        
	//*  28   71:invokevirtual   #477 <Method void TabLayout$SlidingTabStrip.setGravity(int)>
	//*  29   74:goto            60
	//*  30   77:aload_0         
	//*  31   78:getfield        #162 <Field TabLayout$SlidingTabStrip mTabStrip>
	//*  32   81:ldc2            #478 <Int 0x800003>
	//*  33   84:invokevirtual   #477 <Method void TabLayout$SlidingTabStrip.setGravity(int)>
	//*  34   87:goto            60
			i = 0;
	//   35   90:iconst_0        
	//   36   91:istore_1        
...
label0:
	...
	//    3    3:istore          4
			if(mMode == 0)
	//*   4    5:aload_0         
	//*   5    6:getfield        #316 <Field int mMode>
	//*   6    9:ifne            114
			{
				View view1 = mTabStrip.getChildAt(i);
	//    7   12:aload_0         
	//    8   13:getfield        #162 <Field TabLayout$SlidingTabStrip mTabStrip>
	//    9   16:iload_1         
	//   10   17:invokevirtual   #482 <Method View TabLayout$SlidingTabStrip.getChildAt(int)>
	//   11   20:astore          6
				View view;
	...
	//*  14   24:iadd            
	//*  15   25:aload_0         
	//*  16   26:getfield        #162 <Field TabLayout$SlidingTabStrip mTabStrip>
	//*  17   29:invokevirtual   #485 <Method int TabLayout$SlidingTabStrip.getChildCount()>
	//*  18   32:icmpge          116
					view = mTabStrip.getChildAt(i + 1);
	//   19   35:aload_0         
	//   20   36:getfield        #162 <Field TabLayout$SlidingTabStrip mTabStrip>
	//   21   39:iload_1         
	//   22   40:iconst_1        
	//   23   41:iadd            
	//   24   42:invokevirtual   #482 <Method View TabLayout$SlidingTabStrip.getChildAt(int)>
	//   25   45:astore          5
				else
	//*  26   47:aload           6
	//*  27   49:ifnull          122
	//*  28   52:aload           6
	//*  29   54:invokevirtual   #490 <Method int View.getWidth()>
	//*  30   57:istore_1        
	//*  31   58:iload           4
	//*  32   60:istore_3        
	//*  33   61:aload           5
	//*  34   63:ifnull          72
	//*  35   66:aload           5
	//*  36   68:invokevirtual   #490 <Method int View.getWidth()>
	//*  37   71:istore_3        
	//*  38   72:aload           6
	//*  39   74:invokevirtual   #493 <Method int View.getLeft()>
	//*  40   77:iload_1         
	//*  41   78:iconst_2        
	//*  42   79:idiv            
	//*  43   80:iadd            
	//*  44   81:aload_0         
	//*  45   82:invokevirtual   #494 <Method int getWidth()>
	//*  46   85:iconst_2        
	//*  47   86:idiv            
	//*  48   87:isub            
	//*  49   88:istore          4
	...
	//*  59  101:istore_1        
	//*  60  102:aload_0         
	//*  61  103:invokestatic    #499 <Method int ViewCompat.getLayoutDirection(View)>
	//*  62  106:ifne            127
	//*  63  109:iload_1         
	//*  64  110:iload           4
	//*  65  112:iadd            
...
_L3:
	...
	//   16   28:ifnull          57
	//   17   31:aload_3         
	//   18   32:invokevirtual   #598 <Method Drawable TabLayout$Tab.getIcon()>
	//   19   35:ifnull          57
	//   20   38:aload_3         
	//   21   39:invokevirtual   #601 <Method CharSequence TabLayout$Tab.getText()>
	//   22   42:invokestatic    #387 <Method boolean TextUtils.isEmpty(CharSequence)>
	//   23   45:ifne            57
_L1:
		i = 1;
	//   24   48:iconst_1        
...
_L2:
	...
	//    2    3:aload_0         
	//    3    4:aload_0         
	//    4    5:invokespecial   #788 <Method int getDefaultHeight()>
	//    5    8:invokevirtual   #790 <Method int dpToPx(int)>
	//    6   11:aload_0         
	//    7   12:invokevirtual   #793 <Method int getPaddingTop()>
	//    8   15:iadd            
	//    9   16:aload_0         
	//   10   17:invokevirtual   #796 <Method int getPaddingBottom()>
	//   11   20:iadd            
	//   12   21:istore_3        
		android.view.View.MeasureSpec.getMode(j);
	//   13   22:iload_2         
	//   14   23:invokestatic    #801 <Method int android.view.View$MeasureSpec.getMode(int)>
		JVM INSTR lookupswitch 2: default 52
	//	               -2147483648: 173
	//	               0: 191;
	//   15   26:lookupswitch    2: default 52
	//	               -2147483648: 173
	//	               0: 191
		   goto _L1 _L2 _L3
_L1:
	...
	//   16   52:iload_1         
	//   17   53:invokestatic    #804 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   18   56:istore_3        
		if(android.view.View.MeasureSpec.getMode(i) != 0)
	//*  19   57:iload_1         
	//*  20   58:invokestatic    #801 <Method int android.view.View$MeasureSpec.getMode(int)>
	//*  21   61:ifeq            81
		{
			if(mRequestedTabMaxWidth > 0)
	//*  22   64:aload_0         
	//*  23   65:getfield        #298 <Field int mRequestedTabMaxWidth>
	//*  24   68:ifle            202
				k = mRequestedTabMaxWidth;
	//   25   71:aload_0         
	//   26   72:getfield        #298 <Field int mRequestedTabMaxWidth>
	//   27   75:istore_3        
			else
	//*  28   76:aload_0         
	//*  29   77:iload_3         
	//*  30   78:putfield        #141 <Field int mTabMaxWidth>
	//*  31   81:aload_0         
	//*  32   82:iload_1         
	//*  33   83:iload_2         
	//*  34   84:invokespecial   #806 <Method void HorizontalScrollView.onMeasure(int, int)>
	//*  35   87:aload_0         
	//*  36   88:invokevirtual   #807 <Method int getChildCount()>
	//*  37   91:iconst_1        
	//*  38   92:icmpne          172
	//*  39   95:aload_0         
	//*  40   96:iconst_0        
	//*  41   97:invokevirtual   #808 <Method View getChildAt(int)>
	//*  42  100:astore          5
	//*  43  102:aload_0         
	//*  44  103:getfield        #316 <Field int mMode>
	//*  45  106:tableswitch     0 1: default 128
	//	               0 214
	//	               1 236
	//*  46  128:iconst_0        
	//*  47  129:istore_1        
	...
	//*  50  134:iload_2         
	//*  51  135:aload_0         
	//*  52  136:invokevirtual   #793 <Method int getPaddingTop()>
	//*  53  139:aload_0         
	//*  54  140:invokevirtual   #796 <Method int getPaddingBottom()>
	//*  55  143:iadd            
	//*  56  144:aload           5
	//*  57  146:invokevirtual   #812 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//*  58  149:getfield        #817 <Field int android.view.ViewGroup$LayoutParams.height>
	//*  59  152:invokestatic    #821 <Method int getChildMeasureSpec(int, int, int)>
	//*  60  155:istore_1        
	//*  61  156:aload           5
	//*  62  158:aload_0         
	//*  63  159:invokevirtual   #824 <Method int getMeasuredWidth()>
	//*  64  162:ldc2            #825 <Int 0x40000000>
	//*  65  165:invokestatic    #828 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//*  66  168:iload_1         
	//*  67  169:invokevirtual   #831 <Method void View.measure(int, int)>
	//*  68  172:return          
	//*  69  173:iload_3         
	//*  70  174:iload_2         
	//*  71  175:invokestatic    #804 <Method int android.view.View$MeasureSpec.getSize(int)>
	//*  72  178:invokestatic    #834 <Method int Math.min(int, int)>
	//*  73  181:ldc2            #825 <Int 0x40000000>
	//*  74  184:invokestatic    #828 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//*  75  187:istore_2        
	//*  76  188:goto            52
	//*  77  191:iload_3         
	//*  78  192:ldc2            #825 <Int 0x40000000>
	//*  79  195:invokestatic    #828 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//*  80  198:istore_2        
	//*  81  199:goto            52
				k -= dpToPx(56);
	//   82  202:iload_3         
	//   83  203:aload_0         
	//   84  204:bipush          56
	//   85  206:invokevirtual   #790 <Method int dpToPx(int)>
	//   86  209:isub            
	//   87  210:istore_3        
			mTabMaxWidth = k;
		}
...
_L7:
	...
	//*  89  214:aload           5
	//*  90  216:invokevirtual   #835 <Method int View.getMeasuredWidth()>
	//*  91  219:aload_0         
	//*  92  220:invokevirtual   #824 <Method int getMeasuredWidth()>
	//*  93  223:icmpge          231
			i = 1;
	//   94  226:iconst_1        
	//   95  227:istore_1        
	...
	//*  99  233:goto            130
		if(view.getMeasuredWidth() != getMeasuredWidth())
	//* 100  236:aload           5
	//* 101  238:invokevirtual   #835 <Method int View.getMeasuredWidth()>
	//* 102  241:aload_0         
	//* 103  242:invokevirtual   #824 <Method int getMeasuredWidth()>
	//* 104  245:icmpeq          254
			i = ((int) (flag));
	//  105  248:iload           4
	//  106  250:istore_1        
