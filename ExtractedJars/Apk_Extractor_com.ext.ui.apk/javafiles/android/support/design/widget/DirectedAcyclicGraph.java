...
final class DirectedAcyclicGraph
{
	...
	//    1    1:astore          4
		int j = mGraph.size();
	//    2    3:aload_0         
	//    3    4:getfield        #33  <Field SimpleArrayMap mGraph>
	//    4    7:invokevirtual   #122 <Method int SimpleArrayMap.size()>
	//    5   10:istore_3        
		for(int i = 0; i < j;)
	//*   6   11:iconst_0        
	//*   7   12:istore_2        
	...
	//*  28   55:ifnonnull       99
						arraylist = new ArrayList();
	//   29   58:new             #35  <Class ArrayList>
	//   30   61:dup             
	//   31   62:invokespecial   #36  <Method void ArrayList()>
	//   32   65:astore          4
					arraylist.add(mGraph.keyAt(i));
	//   33   67:aload           4
	//   34   69:aload_0         
	//   35   70:getfield        #33  <Field SimpleArrayMap mGraph>
	//   36   73:iload_2         
	//   37   74:invokevirtual   #139 <Method Object SimpleArrayMap.keyAt(int)>
	//   38   77:invokevirtual   #78  <Method boolean ArrayList.add(Object)>
	//   39   80:pop             
					arraylist1 = arraylist;
	//   40   81:aload           4
	//   41   83:astore          5
