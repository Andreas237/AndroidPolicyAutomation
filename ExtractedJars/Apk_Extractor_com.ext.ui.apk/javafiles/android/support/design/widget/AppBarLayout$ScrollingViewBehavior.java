...
public static class AppBarLayout$ScrollingViewBehavior extends HeaderScrollingViewBehavior
{
	...
	//   16   33:istore          5
			ViewCompat.offsetTopAndBottom(view, (AppBarLayout.Behavior.access$000(((AppBarLayout.Behavior) (coordinatorlayout))) + (i - j) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view1));
	//   17   35:aload_2         
	//   18   36:aload_1         
