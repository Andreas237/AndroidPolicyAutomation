...
label0:
	...
	//   11   21:aload_1         
	//   12   22:invokevirtual   #228 <Method int ViewGroup.getChildCount()>
	//   13   25:istore_3        
			for(int i = 0; i < j; i++)
	//*  14   26:iconst_0        
	//*  15   27:istore_2        
...
_L3:
	...
	//*   2    3:aload_2         
	//*   3    4:invokevirtual   #328 <Method int View.getTop()>
	//*   4    7:aload_0         
	//*   5    8:getfield        #214 <Field int mMinOffset>
	//*   6   11:icmpne          20
			setStateInternal(3);
	//    7   14:aload_0         
	//    8   15:iconst_3        
	//    9   16:invokevirtual   #375 <Method void setStateInternal(int)>
		else
	//*  10   19:return          
		if(mNestedScrollingChildRef != null && view1 == mNestedScrollingChildRef.get() && mNestedScrolled)
	//*  11   20:aload_0         
	//*  12   21:getfield        #293 <Field WeakReference mNestedScrollingChildRef>
	//*  13   24:ifnull          19
	//*  14   27:aload_3         
	//*  15   28:aload_0         
	//*  16   29:getfield        #293 <Field WeakReference mNestedScrollingChildRef>
	//*  17   32:invokevirtual   #202 <Method Object WeakReference.get()>
	//*  18   35:if_acmpne       19
	//*  19   38:aload_0         
	//*  20   39:getfield        #381 <Field boolean mNestedScrolled>
	//*  21   42:ifeq            19
		{
			int i;
			if(mLastNestedScrollDy > 0)
	//*  22   45:aload_0         
	//*  23   46:getfield        #379 <Field int mLastNestedScrollDy>
	//*  24   49:ifle            101
				i = mMinOffset;
	//   25   52:aload_0         
	//   26   53:getfield        #214 <Field int mMinOffset>
	//   27   56:istore          4
			else
	//*  28   58:aload_0         
	...
	//*  86  174:goto            58
				{
					i = mMaxOffset;
	//   87  177:aload_0         
	//   88  178:getfield        #206 <Field int mMaxOffset>
	//   89  181:istore          4
					byte0 = 4;
	//   90  183:iconst_4        
	//   91  184:istore          5
	...
	//*  92  186:goto            58
			{
				i = mMaxOffset;
	//   93  189:aload_0         
	//   94  190:getfield        #206 <Field int mMaxOffset>
	//   95  193:istore          4
				byte0 = 4;
	//   96  195:iconst_4        
	//   97  196:istore          5
	...
	//   99  201:aload_0         
	//  100  202:iload           5
	//  101  204:invokevirtual   #375 <Method void setStateInternal(int)>
			}
			mNestedScrolled = false;
			return;
		}
