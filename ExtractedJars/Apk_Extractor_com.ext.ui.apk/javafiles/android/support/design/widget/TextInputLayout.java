...
label0:
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #506 <Method int ViewGroup.getChildCount()>
	//    2    4:istore_3        
		for(int i = 0; i < j; i++)
	//*   3    5:iconst_0        
	//*   4    6:istore_2        
...
_L3:
	...
	//*  14   24:aload_0         
	//*  15   25:invokestatic    #887 <Method boolean ViewCompat.isLaidOut(View)>
	//*  16   28:ifeq            79
	//*  17   31:aload_0         
	//*  18   32:invokevirtual   #890 <Method boolean isEnabled()>
	//*  19   35:ifeq            79
	//*  20   38:aload_0         
	//*  21   39:iload_2         
	//*  22   40:invokevirtual   #666 <Method void updateLabelState(boolean)>
	//*  23   43:aload_0         
	//*  24   44:invokespecial   #664 <Method void updateEditTextBackground()>
	//*  25   47:aload_0         
	//*  26   48:getfield        #111 <Field CollapsingTextHelper mCollapsingTextHelper>
	//*  27   51:ifnull          84
	//*  28   54:aload_0         
	//*  29   55:getfield        #111 <Field CollapsingTextHelper mCollapsingTextHelper>
	//*  30   58:aload_3         
	//*  31   59:invokevirtual   #894 <Method boolean CollapsingTextHelper.setState(int[])>
	//*  32   62:iconst_0        
	//*  33   63:ior             
	//*  34   64:istore_1        
	//*  35   65:iload_1         
	//*  36   66:ifeq            73
	//*  37   69:aload_0         
	//*  38   70:invokevirtual   #897 <Method void invalidate()>
	//*  39   73:aload_0         
	//*  40   74:iconst_0        
	//*  41   75:putfield        #877 <Field boolean mInDrawableStateChanged>
	//*  42   78:return          
			flag1 = false;
	//   43   79:iconst_0        
	//   44   80:istore_2        
...
_L3:
	...
	//   32   72:aload_0         
	//   33   73:getfield        #617 <Field TextView mErrorView>
	//   34   76:aload_0         
	//   35   77:getfield        #228 <Field int mErrorTextAppearance>
	//   36   80:invokestatic    #1010 <Method void TextViewCompat.setTextAppearance(TextView, int)>
		if(android.os.Build.VERSION.SDK_INT < 23) goto _L6; else goto _L5
	//   37   83:getstatic       #441 <Field int android.os.Build$VERSION.SDK_INT>
	//   38   86:bipush          23
	//   39   88:icmplt          204
_L5:
		int i = mErrorView.getTextColors().getDefaultColor();
	//   40   91:aload_0         
	//   41   92:getfield        #617 <Field TextView mErrorView>
	//   42   95:invokevirtual   #1048 <Method ColorStateList TextView.getTextColors()>
	//   43   98:invokevirtual   #1053 <Method int ColorStateList.getDefaultColor()>
	//   44  101:istore_2        
		if(i != -65281) goto _L6; else goto _L7
	//   45  102:iload_2         
	//   46  103:ldc2            #1054 <Int -65281>
	//   47  106:icmpne          204
_L7:
		boolean flag1 = true;
	//   48  109:iconst_1        
...
_L10:
	...
	//   52  115:aload_0         
	//   53  116:getfield        #617 <Field TextView mErrorView>
	//   54  119:getstatic       #1017 <Field int android.support.v7.appcompat.R$style.TextAppearance_AppCompat_Caption>
	//   55  122:invokestatic    #1010 <Method void TextViewCompat.setTextAppearance(TextView, int)>
			mErrorView.setTextColor(ContextCompat.getColor(getContext(), android.support.v7.appcompat.R.color.error_color_material));
	//   56  125:aload_0         
	//   57  126:getfield        #617 <Field TextView mErrorView>
	//   58  129:aload_0         
	//   59  130:invokevirtual   #338 <Method Context getContext()>
	//   60  133:getstatic       #1022 <Field int android.support.v7.appcompat.R$color.error_color_material>
	//   61  136:invokestatic    #1028 <Method int ContextCompat.getColor(Context, int)>
	//   62  139:invokevirtual   #1031 <Method void TextView.setTextColor(int)>
		}
		mErrorView.setVisibility(4);
	//   63  142:aload_0         
	//   64  143:getfield        #617 <Field TextView mErrorView>
	//   65  146:iconst_4        
	//   66  147:invokevirtual   #630 <Method void TextView.setVisibility(int)>
		ViewCompat.setAccessibilityLiveRegion(((View) (mErrorView)), 1);
	//   67  150:aload_0         
	//   68  151:getfield        #617 <Field TextView mErrorView>
	//   69  154:iconst_1        
	//   70  155:invokestatic    #1057 <Method void ViewCompat.setAccessibilityLiveRegion(View, int)>
		addIndicator(mErrorView, 0);
	//   71  158:aload_0         
	//   72  159:aload_0         
	//   73  160:getfield        #617 <Field TextView mErrorView>
	//   74  163:iconst_0        
	//   75  164:invokespecial   #1012 <Method void addIndicator(TextView, int)>
_L8:
		mErrorEnabled = flag;
	//   76  167:aload_0         
	//   77  168:iload_1         
	//   78  169:putfield        #613 <Field boolean mErrorEnabled>
_L2:
		return;
	//   79  172:return          
		Exception exception;
...
_L4:
	...
	//   84  179:aload_0         
	//   85  180:iconst_0        
	//   86  181:putfield        #615 <Field boolean mErrorShown>
		updateEditTextBackground();
	//   87  184:aload_0         
	//   88  185:invokespecial   #664 <Method void updateEditTextBackground()>
		removeIndicator(mErrorView);
	//   89  188:aload_0         
	//   90  189:aload_0         
	//   91  190:getfield        #617 <Field TextView mErrorView>
	//   92  193:invokespecial   #1033 <Method void removeIndicator(TextView)>
		mErrorView = null;
	//   93  196:aload_0         
	//   94  197:aconst_null     
	//   95  198:putfield        #617 <Field TextView mErrorView>
...
_L5:
	...
	//    1    1:istore          4
		flag4 = isEnabled();
	//    2    3:aload_0         
	//    3    4:invokevirtual   #890 <Method boolean isEnabled()>
	//    4    7:istore          5
		boolean flag2;
		if(mEditText != null && !TextUtils.isEmpty(((CharSequence) (mEditText.getText()))))
	//*   5    9:aload_0         
	//*   6   10:getfield        #356 <Field EditText mEditText>
	//*   7   13:ifnull          142
	//*   8   16:aload_0         
	//*   9   17:getfield        #356 <Field EditText mEditText>
	//*  10   20:invokevirtual   #591 <Method Editable EditText.getText()>
	//*  11   23:invokestatic    #579 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  12   26:ifne            142
			flag2 = true;
	//   13   29:iconst_1        
	//   14   30:istore_3        
	...
	//*  15   31:aload_0         
	//*  16   32:invokevirtual   #883 <Method int[] getDrawableState()>
	//*  17   35:ldc2            #1127 <Int 0x101009c>
	//*  18   38:invokestatic    #1129 <Method boolean arrayContains(int[], int)>
	//*  19   41:istore          6
	//*  20   43:aload_0         
	//*  21   44:invokevirtual   #989 <Method CharSequence getError()>
	//*  22   47:invokestatic    #579 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  23   50:ifne            147
	//*  24   53:aload_0         
