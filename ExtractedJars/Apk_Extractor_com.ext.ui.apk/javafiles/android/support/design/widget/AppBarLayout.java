...
;
	...
	public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior
	{
		...
		//   11   23:aload_3         
		//   12   24:invokevirtual   #70  <Method int View.getBottom()>
		//   13   27:istore          4
				int j = view.getTop();
		//   14   29:aload_2         
		//   15   30:invokevirtual   #73  <Method int View.getTop()>
		//   16   33:istore          5
		...
		//   17   35:aload_2         
		//   18   36:aload_1         
		//   19   37:invokestatic    #77  <Method int AppBarLayout$Behavior.access$000(AppBarLayout$Behavior)>
		//   20   40:iload           4
		//   21   42:iload           5
		//   22   44:isub            
		//   23   45:iadd            
		//   24   46:aload_0         
		//   25   47:invokevirtual   #80  <Method int getVerticalLayoutGap()>
		//   26   50:iadd            
		//   27   51:aload_0         
		//   28   52:aload_3         
		//   29   53:invokevirtual   #84  <Method int getOverlapPixelsForOffset(View)>
		//   30   56:isub            
		//   31   57:invokestatic    #90  <Method void ViewCompat.offsetTopAndBottom(View, int)>
			}
		//   32   60:return          
		}
...
_L3:
	...
	//    8   12:aload_0         
	//    9   13:iload_1         
	//   10   14:invokevirtual   #202 <Method View getChildAt(int)>
	//   11   17:invokevirtual   #208 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   12   20:checkcast       #21  <Class AppBarLayout$LayoutParams>
...
_L4:
	...
	//   17   31:aload_0         
	//   18   32:iload_3         
	//   19   33:invokespecial   #214 <Method boolean setCollapsibleState(boolean)>
	//   20   36:pop             
		return;
	//   21   37:return          
_L2:
	...
	//    3    7:aload_0         
	//    4    8:getfield        #218 <Field List mListeners>
	//    5   11:invokeinterface #237 <Method int List.size()>
	//    6   16:istore_3        
			for(int j = 0; j < k; j++)
	//*   7   17:iconst_0        
	//*   8   18:istore_2        
...
_L3:
	...
	//   35   64:aload           7
	//   36   66:getfield        #292 <Field int AppBarLayout$LayoutParams.topMargin>
	//   37   69:istore          5
		i = layoutparams.bottomMargin + i1 + i;
	//   38   71:aload           7
	//   39   73:getfield        #295 <Field int AppBarLayout$LayoutParams.bottomMargin>
	//   40   76:iload           5
	//   41   78:iadd            
	//   42   79:iload_1         
	//   43   80:iadd            
	...
	//   49   90:iload_1         
	//   50   91:aload           6
	//   51   93:invokestatic    #299 <Method int ViewCompat.getMinimumHeight(View)>
	//   52   96:iadd            
	//   53   97:istore_1        
		else
	//*  54   98:iload_2         
	...
	//   64  113:iload_3         
	//   65  114:aload           6
	//   66  116:invokestatic    #299 <Method int ViewCompat.getMinimumHeight(View)>
	//   67  119:isub            
	//   68  120:iadd            
	//   69  121:istore_1        
		else
	...
	//   72  126:iload_3         
	//   73  127:aload_0         
	//   74  128:invokevirtual   #302 <Method int getTopInset()>
	//   75  131:isub            
	//   76  132:iadd            
	//   77  133:istore_1        
_L6:
...
_L2:
	...
	//   81  141:iconst_0        
	//   82  142:iload_1         
	//   83  143:invokestatic    #307 <Method int Math.max(int, int)>
	//   84  146:istore_1        
		mDownPreScrollRange = i;
	//   85  147:aload_0         
	//   86  148:iload_1         
	//   87  149:putfield        #73  <Field int mDownPreScrollRange>
		return i;
	//   88  152:iload_1         
	//   89  153:ireturn         
	//*  90  154:goto            98
...
label0:
	...
	//   17   27:aload_0         
	//   18   28:iload_2         
	//   19   29:invokevirtual   #202 <Method View getChildAt(int)>
	//   20   32:astore          8
					LayoutParams layoutparams = (LayoutParams)view.getLayoutParams();
	//   21   34:aload           8
	//   22   36:invokevirtual   #208 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   23   39:checkcast       #21  <Class AppBarLayout$LayoutParams>
	//   24   42:astore          9
					int i1 = view.getMeasuredHeight();
	//   25   44:aload           8
	//   26   46:invokevirtual   #286 <Method int View.getMeasuredHeight()>
	//   27   49:istore          5
					int j1 = layoutparams.topMargin;
	//   28   51:aload           9
	//   29   53:getfield        #292 <Field int AppBarLayout$LayoutParams.topMargin>
	//   30   56:istore          6
					int k1 = layoutparams.bottomMargin;
	//   31   58:aload           9
	//   32   60:getfield        #295 <Field int AppBarLayout$LayoutParams.bottomMargin>
	//   33   63:istore          7
					int l = layoutparams.mScrollFlags;
	//   34   65:aload           9
	//   35   67:getfield        #289 <Field int AppBarLayout$LayoutParams.mScrollFlags>
	//   36   70:istore          4
					if((l & 1) != 0)
	//*  37   72:iload           4
	//*  38   74:iconst_1        
	...
	//   53   97:iload_1         
	//   54   98:aload           8
	//   55  100:invokestatic    #299 <Method int ViewCompat.getMinimumHeight(View)>
	//   56  103:aload_0         
	//   57  104:invokevirtual   #302 <Method int getTopInset()>
	//   58  107:iadd            
	//   59  108:isub            
	//   60  109:istore_1        
					}
	...
	//   61  110:iconst_0        
	//   62  111:iload_1         
	//   63  112:invokestatic    #307 <Method int Math.max(int, int)>
	//   64  115:istore_1        
				mDownScrollRange = i;
	//   65  116:aload_0         
	//   66  117:iload_1         
	//   67  118:putfield        #75  <Field int mDownScrollRange>
				return i;
	//   68  121:iload_1         
	//   69  122:ireturn         
			}
...
label0:
	...
	//   27   49:istore          5
					int l = layoutparams.mScrollFlags;
	//   28   51:aload           8
	//   29   53:getfield        #289 <Field int AppBarLayout$LayoutParams.mScrollFlags>
	//   30   56:istore          4
					if((l & 1) != 0)
	//*  31   58:iload           4
	//*  32   60:iconst_1        
	...
	//*  34   62:ifeq            126
					{
						int j1 = layoutparams.topMargin;
	//   35   65:aload           8
	//   36   67:getfield        #292 <Field int AppBarLayout$LayoutParams.topMargin>
	//   37   70:istore          6
						i += layoutparams.bottomMargin + (i1 + j1);
	//   38   72:iload_1         
	//   39   73:aload           8
	//   40   75:getfield        #295 <Field int AppBarLayout$LayoutParams.bottomMargin>
	//   41   78:iload           5
	//   42   80:iload           6
	//   43   82:iadd            
	//   44   83:iadd            
	...
	//   51   93:iload_1         
	//   52   94:aload           7
	//   53   96:invokestatic    #299 <Method int ViewCompat.getMinimumHeight(View)>
	//   54   99:isub            
	//   55  100:istore_1        
					}
				}
	...
	//   57  102:iload_1         
	//   58  103:aload_0         
	//   59  104:invokevirtual   #302 <Method int getTopInset()>
	//   60  107:isub            
	//   61  108:invokestatic    #307 <Method int Math.max(int, int)>
	//   62  111:istore_1        
				mTotalScrollRange = i;
	//   63  112:aload_0         
	//   64  113:iload_1         
	//   65  114:putfield        #71  <Field int mTotalScrollRange>
				return i;
	//   66  117:iload_1         
	//   67  118:ireturn         
			}
	...
	//   11   17:putfield        #333 <Field boolean mHaveChildWithInterpolator>
		j = getChildCount();
	//   12   20:aload_0         
	//   13   21:invokevirtual   #198 <Method int getChildCount()>
	//   14   24:istore_3        
		i = 0;
	//   15   25:iconst_0        
	//   16   26:istore_2        
