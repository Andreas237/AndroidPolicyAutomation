...
public class FloatingActionButton extends VisibilityAwareImageButton
{
	public static class Behavior extends CoordinatorLayout.Behavior
	{
		...
		//    2    3:aload_2         
		//    3    4:getfield        #74  <Field Rect FloatingActionButton.mShadowPadding>
		//    4    7:astore          5
			if(rect == null || rect.centerX() <= 0 || rect.centerY() <= 0) goto _L2; else goto _L1
		//    5    9:aload           5
		//    6   11:ifnull          106
		//    7   14:aload           5
		//    8   16:invokevirtual   #80  <Method int Rect.centerX()>
		//    9   19:ifle            106
		//   10   22:aload           5
		//   11   24:invokevirtual   #83  <Method int Rect.centerY()>
		//   12   27:ifle            106
_L1:
			CoordinatorLayout.LayoutParams layoutparams = (CoordinatorLayout.LayoutParams)floatingactionbutton.getLayoutParams();
		//   13   30:aload_2         
		//   14   31:invokevirtual   #84  <Method android.view.ViewGroup$LayoutParams FloatingActionButton.getLayoutParams()>
		//   15   34:checkcast       #62  <Class CoordinatorLayout$LayoutParams>
		//   16   37:astore          6
			int i;
			if(floatingactionbutton.getRight() >= coordinatorlayout.getWidth() - layoutparams.rightMargin)
		//*  17   39:aload_2         
		//*  18   40:invokevirtual   #87  <Method int FloatingActionButton.getRight()>
		//*  19   43:aload_1         
		//*  20   44:invokevirtual   #92  <Method int CoordinatorLayout.getWidth()>
		//*  21   47:aload           6
		...
		//*  24   53:icmplt          107
				i = rect.right;
		//   25   56:aload           5
		//   26   58:getfield        #98  <Field int Rect.right>
		//   27   61:istore_3        
			else
		//*  28   62:aload_2         
		//*  29   63:invokevirtual   #101 <Method int FloatingActionButton.getBottom()>
		//*  30   66:aload_1         
		//*  31   67:invokevirtual   #104 <Method int CoordinatorLayout.getHeight()>
		//*  32   70:aload           6
		//*  33   72:getfield        #107 <Field int CoordinatorLayout$LayoutParams.bottomMargin>
		//*  34   75:isub            
		//*  35   76:icmplt          129
		//*  36   79:aload           5
		//*  37   81:getfield        #110 <Field int Rect.bottom>
		//*  38   84:istore          4
		//*  39   86:iload           4
		//*  40   88:ifeq            97
		//*  41   91:aload_2         
		//*  42   92:iload           4
		//*  43   94:invokestatic    #116 <Method void ViewCompat.offsetTopAndBottom(View, int)>
		//*  44   97:iload_3         
		//*  45   98:ifeq            106
		//*  46  101:aload_2         
		//*  47  102:iload_3         
		//*  48  103:invokestatic    #119 <Method void ViewCompat.offsetLeftAndRight(View, int)>
		//*  49  106:return          
			if(floatingactionbutton.getLeft() <= layoutparams.leftMargin)
		//*  50  107:aload_2         
		//*  51  108:invokevirtual   #122 <Method int FloatingActionButton.getLeft()>
		//*  52  111:aload           6
		//*  53  113:getfield        #125 <Field int CoordinatorLayout$LayoutParams.leftMargin>
		//*  54  116:icmpgt          152
				i = -rect.left;
		//   55  119:aload           5
		//   56  121:getfield        #128 <Field int Rect.left>
		//   57  124:ineg            
		//   58  125:istore_3        
			else
		//*  59  126:goto            62
		//*  60  129:aload_2         
		//*  61  130:invokevirtual   #131 <Method int FloatingActionButton.getTop()>
		//*  62  133:aload           6
		//*  63  135:getfield        #134 <Field int CoordinatorLayout$LayoutParams.topMargin>
		//*  64  138:icmpgt          86
		//*  65  141:aload           5
		//*  66  143:getfield        #137 <Field int Rect.top>
		//*  67  146:ineg            
		//*  68  147:istore          4
		//*  69  149:goto            86
				i = 0;
...
_L5:
		...
		//   10   18:astore          5
			int i = view.getTop();
		//   11   20:aload_1         
		//   12   21:invokevirtual   #177 <Method int View.getTop()>
		//   13   24:istore_3        
			int j = floatingactionbutton.getHeight() / 2;
		//   14   25:aload_2         
		//   15   26:invokevirtual   #178 <Method int FloatingActionButton.getHeight()>
		//   16   29:iconst_2        
		//   17   30:idiv            
		//   18   31:istore          4
		...
		//*  19   33:iload_3         
		//*  20   34:aload           5
		//*  21   36:getfield        #134 <Field int CoordinatorLayout$LayoutParams.topMargin>
		//*  22   39:iload           4
		//*  23   41:iadd            
		//*  24   42:icmpge          56
				floatingactionbutton.hide(mInternalAutoHideListener, false);
		//   25   45:aload_2         
		//   26   46:aload_0         
		//   27   47:getfield        #168 <Field FloatingActionButton$OnVisibilityChangedListener mInternalAutoHideListener>
		//   28   50:iconst_0        
		//   29   51:invokevirtual   #172 <Method void FloatingActionButton.hide(FloatingActionButton$OnVisibilityChangedListener, boolean)>
			else
		//*  30   54:iconst_1        
		//*  31   55:ireturn         
				floatingactionbutton.show(mInternalAutoHideListener, false);
		//   32   56:aload_2         
		//   33   57:aload_0         
		//   34   58:getfield        #168 <Field FloatingActionButton$OnVisibilityChangedListener mInternalAutoHideListener>
		//   35   61:iconst_0        
		//   36   62:invokevirtual   #175 <Method void FloatingActionButton.show(FloatingActionButton$OnVisibilityChangedListener, boolean)>
			return true;
		//*  37   65:goto            54
		}
...
label0:
	...
	//   10   46:iload_0         
	//   11   47:iload_1         
	//   12   48:invokestatic    #270 <Method int Math.min(int, int)>
	//   13   51:ireturn         
...
;
	...
	//   32   56:iload_1         
	//   33   57:aload_0         
	//   34   58:getfield        #69  <Field Rect mShadowPadding>
	//   35   61:getfield        #328 <Field int Rect.top>
	//   36   64:iadd            
	//   37   65:aload_0         
