...
# static fields
.field private static zzcq:Lcom/google/firebase/iid/zzap;


# instance fields
.field private final zzcr:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzcs:Ljava/lang/Boolean;

.field final zzct:Ljava/util/Queue;
...
.field private final zzcu:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzap;->zzcr:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzap;->zzcs:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzap;->zzct:Ljava/util/Queue;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzap;->zzcu:Ljava/util/Queue;
...
.method public static declared-synchronized zzac()Lcom/google/firebase/iid/zzap;
    .locals 2

    const-class v0, Lcom/google/firebase/iid/zzap;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/zzap;->zzcq:Lcom/google/firebase/iid/zzap;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/iid/zzap;

    invoke-direct {v1}, Lcom/google/firebase/iid/zzap;-><init>()V

    sput-object v1, Lcom/google/firebase/iid/zzap;->zzcq:Lcom/google/firebase/iid/zzap;
...
.method private final zzb(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzap;->zzcr:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/iid/zzap;->zzcr:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :cond_3
    :goto_0
    iget-object v2, p0, Lcom/google/firebase/iid/zzap;->zzcr:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v2

    :try_start_1
    iget-object v3, p0, Lcom/google/firebase/iid/zzap;->zzcr:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_5
    :try_start_2
    iget-object v1, p0, Lcom/google/firebase/iid/zzap;->zzcs:Ljava/lang/Boolean;
    ...
    :cond_a
    iget-object v0, p0, Lcom/google/firebase/iid/zzap;->zzcs:Ljava/lang/Boolean;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzap;->zzcu:Ljava/util/Queue;

    goto :goto_2

    :pswitch_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzap;->zzct:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, p3}, Lcom/google/firebase/iid/zzap;->zzb(Landroid/content/Context;Landroid/content/Intent;)I
...
.method public final zzad()Landroid/content/Intent;
    .locals 1
