.class abstract enum Lcom/nytimes/android/external/cache/LocalCache$Strength;
...
# static fields
.field private static final synthetic $VALUES:[Lcom/nytimes/android/external/cache/LocalCache$Strength;
...
.method static constructor <clinit>()V
    ...
    .line 378
    new-instance v0, Lcom/nytimes/android/external/cache/LocalCache$Strength$2;

    const-string v1, "SOFT"

    const/4 v3, 0x1

    invoke-direct {v0, v1, v3}, Lcom/nytimes/android/external/cache/LocalCache$Strength$2;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/nytimes/android/external/cache/LocalCache$Strength;->SOFT:Lcom/nytimes/android/external/cache/LocalCache$Strength;

    .line 396
    new-instance v0, Lcom/nytimes/android/external/cache/LocalCache$Strength$3;

    const-string v1, "WEAK"

    const/4 v4, 0x2

    invoke-direct {v0, v1, v4}, Lcom/nytimes/android/external/cache/LocalCache$Strength$3;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/nytimes/android/external/cache/LocalCache$Strength;->WEAK:Lcom/nytimes/android/external/cache/LocalCache$Strength;

    const/4 v0, 0x3

    .line 355
    new-array v0, v0, [Lcom/nytimes/android/external/cache/LocalCache$Strength;
    ...
    sget-object v1, Lcom/nytimes/android/external/cache/LocalCache$Strength;->SOFT:Lcom/nytimes/android/external/cache/LocalCache$Strength;

    aput-object v1, v0, v3

    sget-object v1, Lcom/nytimes/android/external/cache/LocalCache$Strength;->WEAK:Lcom/nytimes/android/external/cache/LocalCache$Strength;

    aput-object v1, v0, v4

    sput-object v0, Lcom/nytimes/android/external/cache/LocalCache$Strength;->$VALUES:[Lcom/nytimes/android/external/cache/LocalCache$Strength;
...
# virtual methods
.method abstract defaultEquivalence()Lcom/nytimes/android/external/cache/Equivalence;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method abstract referenceValue(Lcom/nytimes/android/external/cache/LocalCache$Segment;Lcom/nytimes/android/external/cache/LocalCache$ReferenceEntry;Ljava/lang/Object;I)Lcom/nytimes/android/external/cache/LocalCache$ValueReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
            "Ljava/lang/Object;",
