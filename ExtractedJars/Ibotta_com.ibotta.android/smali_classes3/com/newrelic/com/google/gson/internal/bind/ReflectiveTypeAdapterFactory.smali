...
.method private getBoundFields(Lcom/newrelic/com/google/gson/Gson;Lcom/newrelic/com/google/gson/reflect/TypeToken;Ljava/lang/Class;)Ljava/util/Map;
    ...
    .line 111
    invoke-virtual {v7, v2, v0}, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory;->excludeField(Ljava/lang/reflect/Field;Z)Z

    move-result v5

    .line 112
    invoke-virtual {v7, v2, v14}, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory;->excludeField(Ljava/lang/reflect/Field;Z)Z
    ...
    .line 117
    invoke-virtual {v11}, Lcom/newrelic/com/google/gson/reflect/TypeToken;->getType()Ljava/lang/reflect/Type;
    ...
    invoke-static {v0, v10, v1}, Lcom/newrelic/com/google/gson/internal/$Gson$Types;->resolve(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;

    move-result-object v0

    .line 118
    invoke-direct {v7, v2}, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory;->getFieldName(Ljava/lang/reflect/Field;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->name:Ljava/lang/String;
    ...
    .line 127
    invoke-virtual {v11}, Lcom/newrelic/com/google/gson/reflect/TypeToken;->getRawType()Ljava/lang/Class;
...
.method private getFieldName(Ljava/lang/reflect/Field;)Ljava/lang/String;
    ...
    .line 60
    const-class v0, Lcom/newrelic/com/google/gson/annotations/SerializedName;
    ...
    .line 61
    iget-object v0, p0, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory;->fieldNamingPolicy:Lcom/newrelic/com/google/gson/FieldNamingStrategy;

    invoke-interface {v0, p1}, Lcom/newrelic/com/google/gson/FieldNamingStrategy;->translateName(Ljava/lang/reflect/Field;)Ljava/lang/String;
...
.method public create(Lcom/newrelic/com/google/gson/Gson;Lcom/newrelic/com/google/gson/reflect/TypeToken;)Lcom/newrelic/com/google/gson/TypeAdapter;
    ...
    .line 71
    :cond_0
    iget-object v1, p0, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory;->constructorConstructor:Lcom/newrelic/com/google/gson/internal/ConstructorConstructor;
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory;->getBoundFields(Lcom/newrelic/com/google/gson/Gson;Lcom/newrelic/com/google/gson/reflect/TypeToken;Ljava/lang/Class;)Ljava/util/Map;

    move-result-object p1

    invoke-direct {v3, v1, p1, v2}, Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;-><init>(Lcom/newrelic/com/google/gson/internal/ObjectConstructor;Ljava/util/Map;Lcom/newrelic/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$1;)V
