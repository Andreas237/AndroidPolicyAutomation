...
.method opEvaluateParallel(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Ljava9/util/function/IntFunction;)Ljava9/util/stream/Node;
    ...
    iget-wide v12, v9, Ljava9/util/stream/SliceOps$2;->val$skip:J

    iget-wide v14, v9, Ljava9/util/stream/SliceOps$2;->val$limit:J
    ...
    .line 274
    invoke-static {v2, v0, v8}, Ljava9/util/stream/Nodes;->collectInt(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Z)Ljava9/util/stream/Node$OfInt;
    ...
    .line 283
    invoke-static {v9, v0, v8}, Ljava9/util/stream/Nodes;->collectInt(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Z)Ljava9/util/stream/Node$OfInt;
...
.method opEvaluateParallelLazy(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;)Ljava9/util/Spliterator;
    ...
    check-cast v11, Ljava9/util/Spliterator$OfInt;

    iget-wide v12, v9, Ljava9/util/stream/SliceOps$2;->val$skip:J

    iget-wide v1, v9, Ljava9/util/stream/SliceOps$2;->val$limit:J
    ...
    invoke-direct/range {v10 .. v15}, Ljava9/util/stream/StreamSpliterators$SliceSpliterator$OfInt;-><init>(Ljava9/util/Spliterator$OfInt;JJ)V
...
.method opWrapSink(ILjava9/util/stream/Sink;)Ljava9/util/stream/Sink;
    ...
    .line 293
    new-instance p1, Ljava9/util/stream/SliceOps$2$1;

    invoke-direct {p1, p0, p2}, Ljava9/util/stream/SliceOps$2$1;-><init>(Ljava9/util/stream/SliceOps$2;Ljava9/util/stream/Sink;)V
...
.method unorderedSkipLimitSpliterator(Ljava9/util/Spliterator$OfInt;JJJ)Ljava9/util/Spliterator$OfInt;
    ...
    .line 239
    :goto_1
    new-instance p2, Ljava9/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfInt;

    move-object v2, p2

    move-object v3, p1

    invoke-direct/range {v2 .. v7}, Ljava9/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfInt;-><init>(Ljava9/util/Spliterator$OfInt;JJ)V
