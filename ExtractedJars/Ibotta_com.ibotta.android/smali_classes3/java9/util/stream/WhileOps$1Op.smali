.class Ljava9/util/stream/WhileOps$1Op;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ljava9/util/stream/WhileOps;->makeDropWhileRef(Ljava9/util/stream/AbstractPipeline;Ljava9/util/function/Predicate;)Ljava9/util/stream/Stream;
.end annotation
...
# direct methods
.method public constructor <init>(Ljava9/util/stream/AbstractPipeline;Ljava9/util/stream/StreamShape;ILjava9/util/function/Predicate;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 340
    iput-object p4, p0, Ljava9/util/stream/WhileOps$1Op;->val$predicate:Ljava9/util/function/Predicate;
...
.method opEvaluateParallelLazy(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;)Ljava9/util/Spliterator;
    ...
    invoke-virtual {p0, p1, p2, v0}, Ljava9/util/stream/WhileOps$1Op;->opEvaluateParallel(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Ljava9/util/function/IntFunction;)Ljava9/util/stream/Node;
    ...
    iget-object v1, p0, Ljava9/util/stream/WhileOps$1Op;->val$predicate:Ljava9/util/function/Predicate;

    invoke-direct {v0, p1, p2, v1}, Ljava9/util/stream/WhileOps$UnorderedWhileSpliterator$OfRef$Dropping;-><init>(Ljava9/util/Spliterator;ZLjava9/util/function/Predicate;)V
...
.method opWrapSink(ILjava9/util/stream/Sink;)Ljava9/util/stream/Sink;
    ...
    .line 367
    invoke-virtual {p0, p2, p1}, Ljava9/util/stream/WhileOps$1Op;->opWrapSink(Ljava9/util/stream/Sink;Z)Ljava9/util/stream/WhileOps$DropWhileSink;
...
.method public opWrapSink(Ljava9/util/stream/Sink;Z)Ljava9/util/stream/WhileOps$DropWhileSink;
    ...
    .line 399
    new-instance v0, Ljava9/util/stream/WhileOps$1Op$1OpSink;

    invoke-direct {v0, p0, p1, p2}, Ljava9/util/stream/WhileOps$1Op$1OpSink;-><init>(Ljava9/util/stream/WhileOps$1Op;Ljava9/util/stream/Sink;Z)V
