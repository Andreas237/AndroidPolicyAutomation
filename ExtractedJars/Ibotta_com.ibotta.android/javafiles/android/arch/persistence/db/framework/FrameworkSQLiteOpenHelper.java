	...
	implements SupportSQLiteOpenHelper
{
	static class OpenHelper extends SQLiteOpenHelper
	{
		...
		OpenHelper(Context context, String s, final FrameworkSQLiteDatabase dbRef[], final android.arch.persistence.db.SupportSQLiteOpenHelper.Callback callback)
		{
			super(context, s, ((android.database.sqlite.SQLiteDatabase.CursorFactory) (null)), callback.version, new _cls1());
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:aload_2         
		//    3    3:aconst_null     
	...
	FrameworkSQLiteOpenHelper(Context context, String s, android.arch.persistence.db.SupportSQLiteOpenHelper.Callback callback)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #18  <Method void Object()>
		mDelegate = createDelegate(context, s, callback);
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:aload_2         
	//    6    8:aload_3         
	//    7    9:invokespecial   #22  <Method FrameworkSQLiteOpenHelper$OpenHelper createDelegate(Context, String, android.arch.persistence.db.SupportSQLiteOpenHelper$Callback)>
	//    8   12:putfield        #24  <Field FrameworkSQLiteOpenHelper$OpenHelper mDelegate>
	//    9   15:return          
	}

	private OpenHelper createDelegate(Context context, String s, android.arch.persistence.db.SupportSQLiteOpenHelper.Callback callback)
	{
		return new OpenHelper(context, s, new FrameworkSQLiteDatabase[1], callback);
	//    0    0:new             #8   <Class FrameworkSQLiteOpenHelper$OpenHelper>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:iconst_1        
	//    5    7:anewarray       FrameworkSQLiteDatabase[]
	//    6   10:aload_3         
	//    7   11:invokespecial   #30  <Method void FrameworkSQLiteOpenHelper$OpenHelper(Context, String, FrameworkSQLiteDatabase[], android.arch.persistence.db.SupportSQLiteOpenHelper$Callback)>
	//    8   14:areturn         
	}
	...
	public void close()
	{
		mDelegate.close();
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field FrameworkSQLiteOpenHelper$OpenHelper mDelegate>
	//    2    4:invokevirtual   #33  <Method void FrameworkSQLiteOpenHelper$OpenHelper.close()>
	//    3    7:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field FrameworkSQLiteOpenHelper$OpenHelper mDelegate>
	//    2    4:invokevirtual   #37  <Method String FrameworkSQLiteOpenHelper$OpenHelper.getDatabaseName()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field FrameworkSQLiteOpenHelper$OpenHelper mDelegate>
	//    2    4:invokevirtual   #42  <Method SupportSQLiteDatabase FrameworkSQLiteOpenHelper$OpenHelper.getReadableSupportDatabase()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field FrameworkSQLiteOpenHelper$OpenHelper mDelegate>
	//    2    4:invokevirtual   #46  <Method SupportSQLiteDatabase FrameworkSQLiteOpenHelper$OpenHelper.getWritableSupportDatabase()>
	//    3    7:areturn         
	}

	public void setWriteAheadLoggingEnabled(boolean flag)
	{
		mDelegate.setWriteAheadLoggingEnabled(flag);
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field FrameworkSQLiteOpenHelper$OpenHelper mDelegate>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #53  <Method void FrameworkSQLiteOpenHelper$OpenHelper.setWriteAheadLoggingEnabled(boolean)>
	//    4    8:return          
	}

	private final OpenHelper mDelegate;

	// Unreferenced inner class android/arch/persistence/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$1

/* anonymous class */
	class OpenHelper._cls1
