...
class LifecycleDispatcher
{
	...
	private static void dispatchIfLifecycleOwner(Fragment fragment, Lifecycle.Event event)
	{
		if(fragment instanceof LifecycleRegistryOwner)
	//*   0    0:aload_0         
	//*   1    1:instanceof      #38  <Class LifecycleRegistryOwner>
	//*   2    4:ifeq            20
			((LifecycleRegistryOwner)fragment).getLifecycle().handleLifecycleEvent(event);
	//    3    7:aload_0         
	//    4    8:checkcast       #38  <Class LifecycleRegistryOwner>
	//    5   11:invokeinterface #42  <Method LifecycleRegistry LifecycleRegistryOwner.getLifecycle()>
	//    6   16:aload_1         
	//    7   17:invokevirtual   #48  <Method void LifecycleRegistry.handleLifecycleEvent(Lifecycle$Event)>
	//    8   20:return          
	}
	...
	//*   0    0:getstatic       #25  <Field AtomicBoolean sInitialized>
	//*   1    3:iconst_1        
	//*   2    4:invokevirtual   #54  <Method boolean AtomicBoolean.getAndSet(boolean)>
	//*   3    7:ifeq            11
		{
			return;
	//    4   10:return          
	...
	//    5   11:aload_0         
	//    6   12:invokevirtual   #60  <Method Context Context.getApplicationContext()>
	//    7   15:checkcast       #62  <Class Application>
	//    8   18:new             #9   <Class LifecycleDispatcher$DispatcherActivityCallback>
	//    9   21:dup             
	//   10   22:invokespecial   #64  <Method void LifecycleDispatcher$DispatcherActivityCallback()>
	//   11   25:invokevirtual   #68  <Method void Application.registerActivityLifecycleCallbacks(android.app.Application$ActivityLifecycleCallbacks)>
			return;
	//   12   28:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #72  <Method void markStateIn(Object, Lifecycle$State)>
		markState(fragmentactivity.getSupportFragmentManager(), state);
	//    3    5:aload_0         
	//    4    6:invokevirtual   #78  <Method FragmentManager FragmentActivity.getSupportFragmentManager()>
	//    5    9:aload_1         
	//    6   10:invokestatic    #81  <Method void markState(FragmentManager, Lifecycle$State)>
	//    7   13:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #87  <Method java.util.List FragmentManager.getFragments()>
	//    2    4:astore_0        
	...
	//    6   10:aload_0         
	//    7   11:invokeinterface #93  <Method Iterator Collection.iterator()>
	//    8   16:astore_0        
		do
		{
			if(!((Iterator) (fragmentmanager)).hasNext())
				break;
	//    9   17:aload_0         
	//   10   18:invokeinterface #99  <Method boolean Iterator.hasNext()>
	//   11   23:ifeq            66
			Fragment fragment = (Fragment)((Iterator) (fragmentmanager)).next();
	//   12   26:aload_0         
	//   13   27:invokeinterface #103 <Method Object Iterator.next()>
	//   14   32:checkcast       #105 <Class Fragment>
	//   15   35:astore_2        
			if(fragment != null)
	//*  16   36:aload_2         
	//*  17   37:ifnonnull       43
	...
	//   19   43:aload_2         
	//   20   44:aload_1         
	//   21   45:invokestatic    #72  <Method void markStateIn(Object, Lifecycle$State)>
				if(fragment.isAdded())
	//*  22   48:aload_2         
	//*  23   49:invokevirtual   #108 <Method boolean Fragment.isAdded()>
	//*  24   52:ifeq            17
					markState(fragment.getChildFragmentManager(), state);
	//   25   55:aload_2         
	//   26   56:invokevirtual   #111 <Method FragmentManager Fragment.getChildFragmentManager()>
	//   27   59:aload_1         
	//   28   60:invokestatic    #81  <Method void markState(FragmentManager, Lifecycle$State)>
			}
		} while(true);
	//   29   63:goto            17
	//   30   66:return          
	...
	//    5   11:invokeinterface #42  <Method LifecycleRegistry LifecycleRegistryOwner.getLifecycle()>
	//    6   16:aload_1         
	//    7   17:invokevirtual   #114 <Method void LifecycleRegistry.markState(Lifecycle$State)>
	//    8   20:return          
	}
	...
	static 
	{
	//    0    0:new             #19  <Class AtomicBoolean>
	//    1    3:dup             
	//    2    4:iconst_0        
	//    3    5:invokespecial   #23  <Method void AtomicBoolean(boolean)>
	//    4    8:putstatic       #25  <Field AtomicBoolean sInitialized>
	//*   5   11:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #31  <Method void markState(FragmentActivity, Lifecycle$State)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #36  <Method void dispatchIfLifecycleOwner(Fragment, Lifecycle$Event)>
		return;
	//    3    5:return          
	}
