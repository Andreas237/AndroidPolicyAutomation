	...
	implements INotificationSideChannel
{
		...
		implements INotificationSideChannel
	{
		...
		//   20   43:aload           5
		//   21   45:iconst_0        
		//   22   46:invokevirtual   #64  <Method void Notification.writeToParcel(Parcel, int)>
	...
	//   17   34:dup             
	//   18   35:aload_0         
	//   19   36:invokespecial   #24  <Method void INotificationSideChannel$Stub$Proxy(IBinder)>
	//   20   39:areturn         
	}
	...
	//    8   35:aload_3         
	//    9   36:iload           4
	//   10   38:invokespecial   #34  <Method boolean Binder.onTransact(int, Parcel, Parcel, int)>
	//   11   41:ireturn         
	...
	//   14   45:invokevirtual   #40  <Method void Parcel.enforceInterface(String)>
				cancelAll(parcel.readString());
	//   15   48:aload_0         
	//   16   49:aload_2         
	//   17   50:invokevirtual   #44  <Method String Parcel.readString()>
	//   18   53:invokevirtual   #47  <Method void cancelAll(String)>
				return true;
	//   19   56:iconst_1        
	//   20   57:ireturn         
	...
	//   23   61:invokevirtual   #40  <Method void Parcel.enforceInterface(String)>
				cancel(parcel.readString(), parcel.readInt(), parcel.readString());
	//   24   64:aload_0         
	//   25   65:aload_2         
	//   26   66:invokevirtual   #44  <Method String Parcel.readString()>
	//   27   69:aload_2         
	//   28   70:invokevirtual   #51  <Method int Parcel.readInt()>
	//   29   73:aload_2         
	//   30   74:invokevirtual   #44  <Method String Parcel.readString()>
	//   31   77:invokevirtual   #55  <Method void cancel(String, int, String)>
				return true;
	//   32   80:iconst_1        
	//   33   81:ireturn         
	...
	//   36   85:invokevirtual   #40  <Method void Parcel.enforceInterface(String)>
				parcel1 = ((Parcel) (parcel.readString()));
	//   37   88:aload_2         
	//   38   89:invokevirtual   #44  <Method String Parcel.readString()>
	//   39   92:astore_3        
				i = parcel.readInt();
	//   40   93:aload_2         
	//   41   94:invokevirtual   #51  <Method int Parcel.readInt()>
	//   42   97:istore_1        
				s = parcel.readString();
	//   43   98:aload_2         
	//   44   99:invokevirtual   #44  <Method String Parcel.readString()>
	//   45  102:astore          5
				break;
			}
			if(parcel.readInt() != 0)
	//*  46  104:aload_2         
	//*  47  105:invokevirtual   #51  <Method int Parcel.readInt()>
	//*  48  108:ifeq            127
				parcel = ((Parcel) ((Notification)Notification.CREATOR.createFromParcel(parcel)));
	//   49  111:getstatic       #61  <Field android.os.Parcelable$Creator Notification.CREATOR>
	//   50  114:aload_2         
	//   51  115:invokeinterface #67  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
	//   52  120:checkcast       #57  <Class Notification>
	//   53  123:astore_2        
			else
	//*  54  124:goto            129
				parcel = null;
	...
	//   60  132:aload           5
	//   61  134:aload_2         
	//   62  135:invokevirtual   #71  <Method void notify(String, int, String, Notification)>
			return true;
	//   63  138:iconst_1        
	//   64  139:ireturn         
		} else
	...
	//   67  143:invokevirtual   #74  <Method void Parcel.writeString(String)>
			return true;
	//   68  146:iconst_1        
	//   69  147:ireturn         
		}
