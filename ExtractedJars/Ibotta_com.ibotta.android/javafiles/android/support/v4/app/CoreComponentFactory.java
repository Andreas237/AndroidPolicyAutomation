...
public class CoreComponentFactory extends AppComponentFactory
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #18  <Method void AppComponentFactory()>
	//    2    4:return          
	}
	...
	//    5   11:invokeinterface #25  <Method Object CoreComponentFactory$CompatWrapped.getWrapper()>
	//    6   16:astore_1        
			if(obj1 != null)
	//*   7   17:aload_1         
	//*   8   18:ifnull          23
	...
	//    2    2:aload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #37  <Method Activity AppComponentFactory.instantiateActivity(ClassLoader, String, Intent)>
	//    5    7:invokestatic    #39  <Method Object checkCompatWrapper(Object)>
	//    6   10:checkcast       #41  <Class Activity>
	//    7   13:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #46  <Method Application AppComponentFactory.instantiateApplication(ClassLoader, String)>
	//    4    6:invokestatic    #39  <Method Object checkCompatWrapper(Object)>
	//    5    9:checkcast       #48  <Class Application>
	//    6   12:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #52  <Method ContentProvider AppComponentFactory.instantiateProvider(ClassLoader, String)>
	//    4    6:invokestatic    #39  <Method Object checkCompatWrapper(Object)>
	//    5    9:checkcast       #54  <Class ContentProvider>
	//    6   12:areturn         
	}
	...
	//    2    2:aload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #58  <Method BroadcastReceiver AppComponentFactory.instantiateReceiver(ClassLoader, String, Intent)>
	//    5    7:invokestatic    #39  <Method Object checkCompatWrapper(Object)>
	//    6   10:checkcast       #60  <Class BroadcastReceiver>
	//    7   13:areturn         
	}
	...
	//    2    2:aload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #64  <Method Service AppComponentFactory.instantiateService(ClassLoader, String, Intent)>
	//    5    7:invokestatic    #39  <Method Object checkCompatWrapper(Object)>
	//    6   10:checkcast       #66  <Class Service>
	//    7   13:areturn         
	}
}
