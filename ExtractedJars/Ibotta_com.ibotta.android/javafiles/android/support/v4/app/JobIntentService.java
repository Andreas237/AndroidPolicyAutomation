...
public abstract class JobIntentService extends Service
{
		...
		implements CompatJobEngine
	{
		...
		public IBinder compatGetBinder()
		{
			return getBinder();
		//    0    0:aload_0         
		//    1    1:invokevirtual   #41  <Method IBinder getBinder()>
		//    2    4:areturn         
		}
...
label0:
		...
		//*   4    6:monitorenter    
				{
					if(mParams != null)
						break label0;
		//    5    7:aload_0         
		//    6    8:getfield        #45  <Field JobParameters mParams>
		//    7   11:ifnonnull       18
				}
		//    8   14:aload_1         
		//    9   15:monitorexit     
		...
		//   12   18:aload_0         
		//   13   19:getfield        #45  <Field JobParameters mParams>
		//   14   22:invokevirtual   #50  <Method JobWorkItem JobParameters.dequeueWork()>
		//   15   25:astore_2        
			obj;
		//   16   26:aload_1         
			JVM INSTR monitorexit ;
		...
		//   20   32:aload_2         
		//   21   33:invokevirtual   #56  <Method Intent JobWorkItem.getIntent()>
		//   22   36:aload_0         
		//   23   37:getfield        #35  <Field JobIntentService mService>
		//   24   40:invokevirtual   #60  <Method ClassLoader JobIntentService.getClassLoader()>
		//   25   43:invokevirtual   #66  <Method void Intent.setExtrasClassLoader(ClassLoader)>
		...
		//   28   50:aload_0         
		//   29   51:aload_2         
		//   30   52:invokespecial   #69  <Method void JobIntentService$JobServiceEngineImpl$WrapperWorkItem(JobIntentService$JobServiceEngineImpl, JobWorkItem)>
		//   31   55:areturn         
			} else
			{
				return null;
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #45  <Field JobParameters mParams>
			mService.ensureProcessorRunningLocked(false);
		//    3    5:aload_0         
		//    4    6:getfield        #35  <Field JobIntentService mService>
		//    5    9:iconst_0        
		//    6   10:invokevirtual   #75  <Method void JobIntentService.ensureProcessorRunningLocked(boolean)>
			return true;
		//    7   13:iconst_1        
		//    8   14:ireturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #35  <Field JobIntentService mService>
		//    2    4:invokevirtual   #80  <Method boolean JobIntentService.doStopCurrentWork()>
		//    3    7:istore_2        
			synchronized(mLock)
		//*   4    8:aload_0         
		//*   5    9:getfield        #33  <Field Object mLock>
		//*   6   12:astore_1        
		//*   7   13:aload_1         
		//*   8   14:monitorenter    
			{
		...
		//    9   15:aload_0         
		//   10   16:aconst_null     
		//   11   17:putfield        #45  <Field JobParameters mParams>
			}
		//   12   20:aload_1         
		//   13   21:monitorexit     
			return flag;
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokespecial   #26  <Method void JobServiceEngine(Service)>
		//    3    5:aload_0         
		//    4    6:new             #28  <Class Object>
		//    5    9:dup             
		//    6   10:invokespecial   #31  <Method void Object()>
		//    7   13:putfield        #33  <Field Object mLock>
			mService = jobintentservice;
		//    8   16:aload_0         
		//    9   17:aload_1         
		//   10   18:putfield        #35  <Field JobIntentService mService>
		//   11   21:return          
		}
	}
	...
	//*   1    1:ifnull          40
		{
			synchronized(sLock)
	//*   2    4:getstatic       #64  <Field Object sLock>
	//*   3    7:astore          4
	//*   4    9:aload           4
	//*   5   11:monitorenter    
			{
	...
	//    8   14:iconst_1        
	//    9   15:iload_2         
	//   10   16:invokestatic    #95  <Method JobIntentService$WorkEnqueuer getWorkEnqueuer(Context, ComponentName, boolean, int)>
	//   11   19:astore_0        
				((WorkEnqueuer) (context)).ensureJobId(i);
	//   12   20:aload_0         
	//   13   21:iload_2         
	//   14   22:invokevirtual   #99  <Method void JobIntentService$WorkEnqueuer.ensureJobId(int)>
				((WorkEnqueuer) (context)).enqueueWork(intent);
	//   15   25:aload_0         
	//   16   26:aload_3         
	//   17   27:invokevirtual   #102 <Method void JobIntentService$WorkEnqueuer.enqueueWork(Intent)>
			}
	//   18   30:aload           4
	//   19   32:monitorexit     
			return;
	...
	//   26   40:new             #104 <Class IllegalArgumentException>
	//   27   43:dup             
	//   28   44:ldc1            #106 <String "work must not be null">
	//   29   46:invokespecial   #109 <Method void IllegalArgumentException(String)>
	//   30   49:athrow          
		}
		context;
		obj;
	...
	//   14   33:new             #27  <Class JobIntentService$JobWorkEnqueuer>
	//   15   36:dup             
	//   16   37:aload_0         
	//   17   38:aload_1         
	//   18   39:iload_3         
	//   19   40:invokespecial   #125 <Method void JobIntentService$JobWorkEnqueuer(Context, ComponentName, int)>
	//   20   43:astore_0        
				else
	//*  21   44:goto            67
					throw new IllegalArgumentException("Can't be here without a job id");
	//   22   47:new             #104 <Class IllegalArgumentException>
	//   23   50:dup             
	//   24   51:ldc1            #127 <String "Can't be here without a job id">
	//   25   53:invokespecial   #109 <Method void IllegalArgumentException(String)>
	//   26   56:athrow          
			} else
			{
	...
	{
		CompatJobEngine compatjobengine = mJobImpl;
	//    0    0:aload_0         
	...
	//    5    9:aload_1         
	//    6   10:invokeinterface #140 <Method JobIntentService$GenericWorkItem JobIntentService$CompatJobEngine.dequeueWork()>
	//    7   15:areturn         
		ArrayList arraylist = mCompatQueue;
	//    8   16:aload_0         
	//    9   17:getfield        #85  <Field ArrayList mCompatQueue>
	//   10   20:astore_1        
		arraylist;
	//   11   21:aload_1         
		JVM INSTR monitorenter ;
	...
	//   13   23:aload_0         
	//   14   24:getfield        #85  <Field ArrayList mCompatQueue>
	//   15   27:invokevirtual   #144 <Method int ArrayList.size()>
	//   16   30:ifle            49
		genericworkitem = (GenericWorkItem)mCompatQueue.remove(0);
	//   17   33:aload_0         
	//   18   34:getfield        #85  <Field ArrayList mCompatQueue>
	//   19   37:iconst_0        
	//   20   38:invokevirtual   #148 <Method Object ArrayList.remove(int)>
	//   21   41:checkcast       #18  <Class JobIntentService$GenericWorkItem>
	//   22   44:astore_2        
	//*  23   45:aload_1         
	//*  24   46:monitorexit     
	...
	{
		CommandProcessor commandprocessor = mCurProcessor;
	//    0    0:aload_0         
	...
	//*   3    5:aload_1         
	//*   4    6:ifnull          18
			commandprocessor.cancel(mInterruptIfStopped);
	//    5    9:aload_1         
	//    6   10:aload_0         
	//    7   11:getfield        #73  <Field boolean mInterruptIfStopped>
	//    8   14:invokevirtual   #156 <Method boolean JobIntentService$CommandProcessor.cancel(boolean)>
	//    9   17:pop             
		mStopped = true;
	//   10   18:aload_0         
	//   11   19:iconst_1        
	//   12   20:putfield        #75  <Field boolean mStopped>
		return onStopCurrentWork();
	//   13   23:aload_0         
	//   14   24:invokevirtual   #159 <Method boolean onStopCurrentWork()>
	//   15   27:ireturn         
	}
	...
	//   16   32:aload_2         
	//   17   33:invokevirtual   #169 <Method void JobIntentService$WorkEnqueuer.serviceProcessingStarted()>
			mCurProcessor.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, ((Object []) (new Void[0])));
	//   18   36:aload_0         
	//   19   37:getfield        #152 <Field JobIntentService$CommandProcessor mCurProcessor>
	//   20   40:getstatic       #175 <Field java.util.concurrent.Executor AsyncTask.THREAD_POOL_EXECUTOR>
	//   21   43:iconst_0        
	//   22   44:anewarray       Void[]
	//   23   47:invokevirtual   #181 <Method AsyncTask JobIntentService$CommandProcessor.executeOnExecutor(java.util.concurrent.Executor, Object[])>
	//   24   50:pop             
		}
	//   25   51:return          
	}
	...
	//*   3    5:aload_1         
	//*   4    6:ifnull          16
			return ((CompatJobEngine) (intent)).compatGetBinder();
	//    5    9:aload_1         
	//    6   10:invokeinterface #188 <Method IBinder JobIntentService$CompatJobEngine.compatGetBinder()>
	//    7   15:areturn         
		else
			return null;
	//    8   16:aconst_null     
	...
	//   26   49:iconst_0        
	//   27   50:iconst_0        
	//   28   51:invokestatic    #95  <Method JobIntentService$WorkEnqueuer getWorkEnqueuer(Context, ComponentName, boolean, int)>
	...
	//    9   15:aload_0         
	//   10   16:iconst_1        
	//   11   17:putfield        #77  <Field boolean mDestroyed>
		mCompatWorkEnqueuer.serviceProcessingFinished();
	//   12   20:aload_0         
	//   13   21:getfield        #166 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//   14   24:invokevirtual   #202 <Method void JobIntentService$WorkEnqueuer.serviceProcessingFinished()>
		arraylist;
	//   15   27:aload_1         
		JVM INSTR monitorexit ;
	//   16   28:monitorexit     
	...
	//    7   11:aload_0         
	//    8   12:aconst_null     
	//    9   13:putfield        #152 <Field JobIntentService$CommandProcessor mCurProcessor>
		if(mCompatQueue != null && mCompatQueue.size() > 0)
	//*  10   16:aload_0         
	//*  11   17:getfield        #85  <Field ArrayList mCompatQueue>
	//*  12   20:ifnull          41
	//*  13   23:aload_0         
	//*  14   24:getfield        #85  <Field ArrayList mCompatQueue>
	//*  15   27:invokevirtual   #144 <Method int ArrayList.size()>
	...
	//   17   33:aload_0         
	//   18   34:iconst_0        
	//   19   35:invokevirtual   #221 <Method void ensureProcessorRunningLocked(boolean)>
			break MISSING_BLOCK_LABEL_55;
	//   20   38:goto            55
		}
		if(!mDestroyed)
	//*  21   41:aload_0         
	//*  22   42:getfield        #77  <Field boolean mDestroyed>
	//*  23   45:ifne            55
			mCompatWorkEnqueuer.serviceProcessingFinished();
	//   24   48:aload_0         
	//   25   49:getfield        #166 <Field JobIntentService$WorkEnqueuer mCompatWorkEnqueuer>
	//   26   52:invokevirtual   #202 <Method void JobIntentService$WorkEnqueuer.serviceProcessingFinished()>
		arraylist;
	//   27   55:aload_1         
		JVM INSTR monitorexit ;
	//   28   56:monitorexit     
