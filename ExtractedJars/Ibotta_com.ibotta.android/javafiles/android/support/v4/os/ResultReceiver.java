	...
	implements Parcelable
{
	...
	//    8   14:aload_0         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #47  <Method android.os.IBinder Parcel.readStrongBinder()>
	//   11   19:invokestatic    #53  <Method IResultReceiver IResultReceiver$Stub.asInterface(android.os.IBinder)>
	//   12   22:putfield        #55  <Field IResultReceiver mReceiver>
	//   13   25:return          
	}
	...
	//    1    1:monitorenter    
		if(mReceiver == null)
	//*   2    2:aload_0         
	//*   3    3:getfield        #55  <Field IResultReceiver mReceiver>
	//*   4    6:ifnonnull       21
	...
	//    7   13:dup             
	//    8   14:aload_0         
	//    9   15:invokespecial   #64  <Method void ResultReceiver$MyResultReceiver(ResultReceiver)>
	//   10   18:putfield        #55  <Field IResultReceiver mReceiver>
		parcel.writeStrongBinder(mReceiver.asBinder());
	//   11   21:aload_1         
	//   12   22:aload_0         
	//   13   23:getfield        #55  <Field IResultReceiver mReceiver>
	//   14   26:invokeinterface #69  <Method android.os.IBinder IResultReceiver.asBinder()>
	//   15   31:invokevirtual   #73  <Method void Parcel.writeStrongBinder(android.os.IBinder)>
		this;
	//   16   34:aload_0         
