...
;
	...
	//    9   19:dup             
	//   10   20:aload_0         
	//   11   21:invokespecial   #44  <Method void SelfDestructiveThread$1(SelfDestructiveThread)>
	//   12   24:putfield        #46  <Field android.os.Handler$Callback mCallback>
		mThreadName = s;
	//   13   27:aload_0         
	//   14   28:aload_1         
	//   15   29:putfield        #48  <Field String mThreadName>
		mPriority = i;
	//   16   32:aload_0         
	//   17   33:iload_2         
	//   18   34:putfield        #50  <Field int mPriority>
		mDestructAfterMillisec = j;
	//   19   37:aload_0         
	//   20   38:iload_3         
	//   21   39:putfield        #52  <Field int mDestructAfterMillisec>
		mGeneration = 0;
	//   22   42:aload_0         
	//   23   43:iconst_0        
	//   24   44:putfield        #54  <Field int mGeneration>
	//   25   47:return          
	}
	...
	//*   4    6:monitorenter    
		{
			if(mThread == null)
	//*   5    7:aload_0         
	//*   6    8:getfield        #59  <Field HandlerThread mThread>
	//*   7   11:ifnonnull       72
			{
				mThread = new HandlerThread(mThreadName, mPriority);
	//    8   14:aload_0         
	//    9   15:new             #61  <Class HandlerThread>
	//   10   18:dup             
	//   11   19:aload_0         
	//   12   20:getfield        #48  <Field String mThreadName>
	//   13   23:aload_0         
	//   14   24:getfield        #50  <Field int mPriority>
	//   15   27:invokespecial   #64  <Method void HandlerThread(String, int)>
	//   16   30:putfield        #59  <Field HandlerThread mThread>
				mThread.start();
	//   17   33:aload_0         
	//   18   34:getfield        #59  <Field HandlerThread mThread>
	//   19   37:invokevirtual   #67  <Method void HandlerThread.start()>
				mHandler = new Handler(mThread.getLooper(), mCallback);
	//   20   40:aload_0         
	//   21   41:new             #69  <Class Handler>
	//   22   44:dup             
	//   23   45:aload_0         
	//   24   46:getfield        #59  <Field HandlerThread mThread>
	//   25   49:invokevirtual   #73  <Method android.os.Looper HandlerThread.getLooper()>
	//   26   52:aload_0         
	//   27   53:getfield        #46  <Field android.os.Handler$Callback mCallback>
	//   28   56:invokespecial   #76  <Method void Handler(android.os.Looper, android.os.Handler$Callback)>
	//   29   59:putfield        #78  <Field Handler mHandler>
				mGeneration = mGeneration + 1;
	//   30   62:aload_0         
	//   31   63:aload_0         
	//   32   64:getfield        #54  <Field int mGeneration>
	//   33   67:iconst_1        
	//   34   68:iadd            
	//   35   69:putfield        #54  <Field int mGeneration>
			}
			mHandler.removeMessages(0);
	//   36   72:aload_0         
	//   37   73:getfield        #78  <Field Handler mHandler>
	//   38   76:iconst_0        
	//   39   77:invokevirtual   #82  <Method void Handler.removeMessages(int)>
			mHandler.sendMessage(mHandler.obtainMessage(1, ((Object) (runnable))));
	//   40   80:aload_0         
	//   41   81:getfield        #78  <Field Handler mHandler>
	//   42   84:aload_0         
	//   43   85:getfield        #78  <Field Handler mHandler>
	//   44   88:iconst_1        
	//   45   89:aload_1         
	//   46   90:invokevirtual   #86  <Method Message Handler.obtainMessage(int, Object)>
	//   47   93:invokevirtual   #90  <Method boolean Handler.sendMessage(Message)>
	//   48   96:pop             
		}
	//   49   97:aload_2         
	//   50   98:monitorexit     
...
label0:
	...
	//*   4    6:monitorenter    
			{
				if(!mHandler.hasMessages(1))
					break label0;
	//    5    7:aload_0         
	//    6    8:getfield        #78  <Field Handler mHandler>
	//    7   11:iconst_1        
	//    8   12:invokevirtual   #95  <Method boolean Handler.hasMessages(int)>
	//    9   15:ifeq            21
			}
	//   10   18:aload_1         
	//   11   19:monitorexit     
	...
	//   12   20:return          
		...
		mThread.quit();
	//   13   21:aload_0         
	//   14   22:getfield        #59  <Field HandlerThread mThread>
	//   15   25:invokevirtual   #99  <Method boolean HandlerThread.quit()>
	//   16   28:pop             
		mThread = null;
	//   17   29:aload_0         
	//   18   30:aconst_null     
	//   19   31:putfield        #59  <Field HandlerThread mThread>
		mHandler = null;
	//   20   34:aload_0         
	//   21   35:aconst_null     
	//   22   36:putfield        #78  <Field Handler mHandler>
		obj;
	//   23   39:aload_1         
		JVM INSTR monitorexit ;
	//   24   40:monitorexit     
	...
	void onInvokeRunnable(Runnable runnable)
	{
		runnable.run();
	//    0    0:aload_1         
	//    1    1:invokeinterface #105 <Method void Runnable.run()>
		synchronized(mLock)
	//*   2    6:aload_0         
	//*   3    7:getfield        #41  <Field Object mLock>
	//*   4   10:astore_1        
	//*   5   11:aload_1         
	//*   6   12:monitorenter    
		{
			mHandler.removeMessages(0);
	//    7   13:aload_0         
	//    8   14:getfield        #78  <Field Handler mHandler>
	//    9   17:iconst_0        
	//   10   18:invokevirtual   #82  <Method void Handler.removeMessages(int)>
			mHandler.sendMessageDelayed(mHandler.obtainMessage(0), mDestructAfterMillisec);
	//   11   21:aload_0         
	//   12   22:getfield        #78  <Field Handler mHandler>
	//   13   25:aload_0         
	//   14   26:getfield        #78  <Field Handler mHandler>
	//   15   29:iconst_0        
	//   16   30:invokevirtual   #108 <Method Message Handler.obtainMessage(int)>
	//   17   33:aload_0         
	//   18   34:getfield        #52  <Field int mDestructAfterMillisec>
	//   19   37:i2l             
	//   20   38:invokevirtual   #112 <Method boolean Handler.sendMessageDelayed(Message, long)>
	//   21   41:pop             
		}
	//   22   42:aload_1         
	//   23   43:monitorexit     
	...
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:new             #69  <Class Handler>
	//    6   10:dup             
	//    7   11:invokespecial   #115 <Method void Handler()>
	//    8   14:aload_2         
	//    9   15:invokespecial   #118 <Method void SelfDestructiveThread$2(SelfDestructiveThread, Callable, Handler, SelfDestructiveThread$ReplyCallback)>
	//   10   18:invokespecial   #120 <Method void post(Runnable)>
	//   11   21:return          
	}
	...
	//    0    0:new             #128 <Class ReentrantLock>
	//    1    3:dup             
	//    2    4:invokespecial   #129 <Method void ReentrantLock()>
	//    3    7:astore          7
		cond = lock.newCondition();
	//    4    9:aload           7
	//    5   11:invokevirtual   #133 <Method Condition ReentrantLock.newCondition()>
	//    6   14:astore          8
		holder = new AtomicReference();
	//    7   16:new             #135 <Class AtomicReference>
	//    8   19:dup             
	//    9   20:invokespecial   #136 <Method void AtomicReference()>
	//   10   23:astore          9
		running = new AtomicBoolean(true);
	//   11   25:new             #138 <Class AtomicBoolean>
	//   12   28:dup             
	//   13   29:iconst_1        
	//   14   30:invokespecial   #141 <Method void AtomicBoolean(boolean)>
	//   15   33:astore          10
		post(new Runnable() {
	...
	//   23   46:aload           10
	//   24   48:aload           8
	//   25   50:invokespecial   #144 <Method void SelfDestructiveThread$3(SelfDestructiveThread, AtomicReference, Callable, ReentrantLock, AtomicBoolean, Condition)>
	//   26   53:invokespecial   #120 <Method void post(Runnable)>
		lock.lock();
	//   27   56:aload           7
	//   28   58:invokevirtual   #147 <Method void ReentrantLock.lock()>
		if(running.get())
			break MISSING_BLOCK_LABEL_82;
	//   29   61:aload           10
	//   30   63:invokevirtual   #150 <Method boolean AtomicBoolean.get()>
	//   31   66:ifne            82
		callable = ((Callable) (holder.get()));
	//   32   69:aload           9
	//   33   71:invokevirtual   #153 <Method Object AtomicReference.get()>
	//   34   74:astore_1        
		lock.unlock();
	//   35   75:aload           7
	//   36   77:invokevirtual   #156 <Method void ReentrantLock.unlock()>
		return ((Object) (callable));
	//   37   80:aload_1         
	//   38   81:areturn         
		long l = TimeUnit.MILLISECONDS.toNanos(i);
	//   39   82:getstatic       #162 <Field TimeUnit TimeUnit.MILLISECONDS>
	//   40   85:iload_2         
	//   41   86:i2l             
	//   42   87:invokevirtual   #166 <Method long TimeUnit.toNanos(long)>
	//   43   90:lstore_3        
_L1:
		long l1 = cond.awaitNanos(l);
	//   44   91:aload           8
	//   45   93:lload_3         
	//   46   94:invokeinterface #171 <Method long Condition.awaitNanos(long)>
	//   47   99:lstore          5
		l = l1;
	//   48  101:lload           5
	//   49  103:lstore_3        
_L3:
	...
	//   50  104:aload           10
	//   51  106:invokevirtual   #150 <Method boolean AtomicBoolean.get()>
	//   52  109:ifne            125
		callable = ((Callable) (holder.get()));
	//   53  112:aload           9
	//   54  114:invokevirtual   #153 <Method Object AtomicReference.get()>
	//   55  117:astore_1        
		lock.unlock();
	//   56  118:aload           7
	//   57  120:invokevirtual   #156 <Method void ReentrantLock.unlock()>
		return ((Object) (callable));
	//   58  123:aload_1         
	//   59  124:areturn         
...
_L2:
	...
	//   65  134:new             #126 <Class InterruptedException>
	//   66  137:dup             
	//   67  138:ldc1            #173 <String "timeout">
	//   68  140:invokespecial   #176 <Method void InterruptedException(String)>
	//   69  143:athrow          
		callable;
	//   70  144:astore_1        
		lock.unlock();
	//   71  145:aload           7
	//   72  147:invokevirtual   #156 <Method void ReentrantLock.unlock()>
		throw callable;
	//   73  150:aload_1         
	//   74  151:athrow          
		callable;
