...
class TypefaceCompatBaseImpl
{
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #28  <Method android.support.v4.content.res.FontResourcesParserCompat$FontFileResourceEntry[] android.support.v4.content.res.FontResourcesParserCompat$FontFamilyFilesResourceEntry.getEntries()>
	//    2    4:iload_2         
	//    3    5:new             #8   <Class TypefaceCompatBaseImpl$2>
	//    4    8:dup             
	//    5    9:aload_0         
	//    6   10:invokespecial   #31  <Method void TypefaceCompatBaseImpl$2(TypefaceCompatBaseImpl)>
	//    7   13:invokestatic    #35  <Method Object findBestFont(Object[], int, TypefaceCompatBaseImpl$StyleExtractor)>
	//    8   16:checkcast       #37  <Class android.support.v4.content.res.FontResourcesParserCompat$FontFileResourceEntry>
	//    9   19:areturn         
	}
	...
	//   24   40:istore_1        
		int k;
		for(int j = 0x7fffffff; i < i1; j = k)
	//*  25   41:ldc1            #38  <Int 0x7fffffff>
	//*  26   43:istore          4
	//*  27   45:iload_1         
	//*  28   46:iload           7
	//*  29   48:icmpge          137
...
label0:
	...
	//   34   56:aload_2         
	//   35   57:aload           10
	//   36   59:invokeinterface #42  <Method int TypefaceCompatBaseImpl$StyleExtractor.getWeight(Object)>
	//   37   64:iload_3         
	//   38   65:isub            
	//   39   66:invokestatic    #48  <Method int Math.abs(int)>
	//   40   69:istore          6
				if(styleextractor.isItalic(obj1) == flag)
	//*  41   71:aload_2         
	//*  42   72:aload           10
	//*  43   74:invokeinterface #52  <Method boolean TypefaceCompatBaseImpl$StyleExtractor.isItalic(Object)>
	//*  44   79:iload           8
	//*  45   81:icmpne          90
					k = 0;
	//   46   84:iconst_0        
	...
	//    1    1:aload_2         
	//    2    2:iload           4
	//    3    4:invokespecial   #59  <Method android.support.v4.content.res.FontResourcesParserCompat$FontFileResourceEntry findBestEntry(android.support.v4.content.res.FontResourcesParserCompat$FontFamilyFilesResourceEntry, int)>
	//    4    7:astore_2        
	...
	//   10   15:aload_3         
	//   11   16:aload_2         
	//   12   17:invokevirtual   #63  <Method int android.support.v4.content.res.FontResourcesParserCompat$FontFileResourceEntry.getResourceId()>
	//   13   20:aload_2         
	//   14   21:invokevirtual   #67  <Method String android.support.v4.content.res.FontResourcesParserCompat$FontFileResourceEntry.getFileName()>
	//   15   24:iload           4
	//   16   26:invokestatic    #73  <Method Typeface TypefaceCompat.createFromResourcesFontFile(Context, Resources, int, String, int)>
	//   17   29:areturn         
	}
	...
	//   11   16:aload_3         
	//   12   17:iload           4
	//   13   19:invokevirtual   #83  <Method android.support.v4.provider.FontsContractCompat$FontInfo findBestInfo(android.support.v4.provider.FontsContractCompat$FontInfo[], int)>
	//   14   22:astore_2        
	...
	//   15   23:aload_1         
	//   16   24:invokevirtual   #89  <Method ContentResolver Context.getContentResolver()>
	//   17   27:aload_2         
	//   18   28:invokevirtual   #95  <Method android.net.Uri android.support.v4.provider.FontsContractCompat$FontInfo.getUri()>
	//   19   31:invokevirtual   #101 <Method InputStream ContentResolver.openInputStream(android.net.Uri)>
	//   20   34:astore_2        
		context = ((Context) (createFromInputStream(context, ((InputStream) (cancellationsignal)))));
	//   21   35:aload_0         
	//   22   36:aload_1         
	//   23   37:aload_2         
	//   24   38:invokevirtual   #105 <Method Typeface createFromInputStream(Context, InputStream)>
	//   25   41:astore_1        
		TypefaceCompatUtil.closeQuietly(((java.io.Closeable) (cancellationsignal)));
	//   26   42:aload_2         
	//   27   43:invokestatic    #111 <Method void TypefaceCompatUtil.closeQuietly(java.io.Closeable)>
	...
	//   39   60:aload_1         
	//   40   61:invokestatic    #111 <Method void TypefaceCompatUtil.closeQuietly(java.io.Closeable)>
...
_L2:
		TypefaceCompatUtil.closeQuietly(((java.io.Closeable) (cancellationsignal)));
	//   45   68:aload_2         
	//   46   69:invokestatic    #111 <Method void TypefaceCompatUtil.closeQuietly(java.io.Closeable)>
		return null;
	//   47   72:aconst_null     
	//   48   73:areturn         
		context;
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #118 <Method File TypefaceCompatUtil.getTempFile(Context)>
	//    2    4:astore_1        
		if(context == null)
	//*   3    5:aload_1         
	//*   4    6:ifnonnull       11
	...
	//    7   11:aload_1         
	//    8   12:aload_2         
	//    9   13:invokestatic    #122 <Method boolean TypefaceCompatUtil.copyToFile(File, InputStream)>
	//   10   16:istore_3        
		}
	//*  11   17:iload_3         
	//*  12   18:ifne            28
	//*  13   21:aload_1         
	//*  14   22:invokevirtual   #128 <Method boolean File.delete()>
	//*  15   25:pop             
	//*  16   26:aconst_null     
	//*  17   27:areturn         
	//*  18   28:aload_1         
	//*  19   29:invokevirtual   #131 <Method String File.getPath()>
	//*  20   32:invokestatic    #137 <Method Typeface Typeface.createFromFile(String)>
	//*  21   35:astore_2        
	//*  22   36:aload_1         
	//*  23   37:invokevirtual   #128 <Method boolean File.delete()>
	//*  24   40:pop             
	//*  25   41:aload_2         
	//*  26   42:areturn         
	//*  27   43:astore_2        
	//*  28   44:aload_1         
	//*  29   45:invokevirtual   #128 <Method boolean File.delete()>
	//*  30   48:pop             
	//*  31   49:aload_2         
	//*  32   50:athrow          
	//*  33   51:aload_1         
	//*  34   52:invokevirtual   #128 <Method boolean File.delete()>
	//*  35   55:pop             
	//*  36   56:aconst_null     
	//*  37   57:areturn         
	...
	//    8   12:aload_2         
	//    9   13:iload_3         
	//   10   14:invokestatic    #140 <Method boolean TypefaceCompatUtil.copyToFile(File, Resources, int)>
	//   11   17:istore          6
		}
	//*  12   19:iload           6
	//*  13   21:ifne            31
	//*  14   24:aload_1         
	//*  15   25:invokevirtual   #128 <Method boolean File.delete()>
	//*  16   28:pop             
	//*  17   29:aconst_null     
	//*  18   30:areturn         
	//*  19   31:aload_1         
	//*  20   32:invokevirtual   #131 <Method String File.getPath()>
	//*  21   35:invokestatic    #137 <Method Typeface Typeface.createFromFile(String)>
	//*  22   38:astore_2        
	//*  23   39:aload_1         
	//*  24   40:invokevirtual   #128 <Method boolean File.delete()>
	//*  25   43:pop             
	//*  26   44:aload_2         
	//*  27   45:areturn         
	//*  28   46:astore_2        
	//*  29   47:aload_1         
	//*  30   48:invokevirtual   #128 <Method boolean File.delete()>
	//*  31   51:pop             
	//*  32   52:aload_2         
	//*  33   53:athrow          
	//*  34   54:aload_1         
	//*  35   55:invokevirtual   #128 <Method boolean File.delete()>
	//*  36   58:pop             
	//*  37   59:aconst_null     
	//*  38   60:areturn         
		// Misplaced declaration of an exception variable
	...
	//    3    5:dup             
	//    4    6:aload_0         
	//    5    7:invokespecial   #141 <Method void TypefaceCompatBaseImpl$1(TypefaceCompatBaseImpl)>
	//    6   10:invokestatic    #35  <Method Object findBestFont(Object[], int, TypefaceCompatBaseImpl$StyleExtractor)>
	//    7   13:checkcast       #91  <Class android.support.v4.provider.FontsContractCompat$FontInfo>
	//    8   16:areturn         
	}
}
