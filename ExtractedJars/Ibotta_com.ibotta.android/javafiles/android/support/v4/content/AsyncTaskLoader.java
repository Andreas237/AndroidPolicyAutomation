...
public abstract class AsyncTaskLoader extends Loader
{
	...
	//    3    3:aload_3         
	//    4    4:aload           4
	//    5    6:invokespecial   #94  <Method void Loader.dump(String, FileDescriptor, PrintWriter, String[])>
		if(mTask != null)
	//*   6    9:aload_0         
	...
	//    9   16:aload_3         
	//   10   17:aload_1         
	//   11   18:invokevirtual   #100 <Method void PrintWriter.print(String)>
			printwriter.print("mTask=");
	//   12   21:aload_3         
	//   13   22:ldc1            #102 <String "mTask=">
	//   14   24:invokevirtual   #100 <Method void PrintWriter.print(String)>
			printwriter.print(((Object) (mTask)));
	//   15   27:aload_3         
	//   16   28:aload_0         
	//   17   29:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   18   32:invokevirtual   #104 <Method void PrintWriter.print(Object)>
			printwriter.print(" waiting=");
	//   19   35:aload_3         
	//   20   36:ldc1            #106 <String " waiting=">
	//   21   38:invokevirtual   #100 <Method void PrintWriter.print(String)>
			printwriter.println(mTask.waiting);
	//   22   41:aload_3         
	//   23   42:aload_0         
	//   24   43:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   25   46:getfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
	//   26   49:invokevirtual   #113 <Method void PrintWriter.println(boolean)>
		}
	...
	//   30   59:aload_3         
	//   31   60:aload_1         
	//   32   61:invokevirtual   #100 <Method void PrintWriter.print(String)>
			printwriter.print("mCancellingTask=");
	//   33   64:aload_3         
	//   34   65:ldc1            #115 <String "mCancellingTask=">
	//   35   67:invokevirtual   #100 <Method void PrintWriter.print(String)>
			printwriter.print(((Object) (mCancellingTask)));
	//   36   70:aload_3         
	//   37   71:aload_0         
	//   38   72:getfield        #57  <Field AsyncTaskLoader$LoadTask mCancellingTask>
	//   39   75:invokevirtual   #104 <Method void PrintWriter.print(Object)>
			printwriter.print(" waiting=");
	//   40   78:aload_3         
	//   41   79:ldc1            #106 <String " waiting=">
	//   42   81:invokevirtual   #100 <Method void PrintWriter.print(String)>
			printwriter.println(mCancellingTask.waiting);
	//   43   84:aload_3         
	//   44   85:aload_0         
	//   45   86:getfield        #57  <Field AsyncTaskLoader$LoadTask mCancellingTask>
	//   46   89:getfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
	//   47   92:invokevirtual   #113 <Method void PrintWriter.println(boolean)>
		}
		if(mUpdateThrottle != 0L)
	//*  48   95:aload_0         
	//*  49   96:getfield        #117 <Field long mUpdateThrottle>
	//*  50   99:lconst_0        
	//*  51  100:lcmp            
	//*  52  101:ifeq            144
		{
	...
	//   53  104:aload_3         
	//   54  105:aload_1         
	//   55  106:invokevirtual   #100 <Method void PrintWriter.print(String)>
			printwriter.print("mUpdateThrottle=");
	//   56  109:aload_3         
	//   57  110:ldc1            #119 <String "mUpdateThrottle=">
	//   58  112:invokevirtual   #100 <Method void PrintWriter.print(String)>
			TimeUtils.formatDuration(mUpdateThrottle, printwriter);
	//   59  115:aload_0         
	//   60  116:getfield        #117 <Field long mUpdateThrottle>
	//   61  119:aload_3         
	//   62  120:invokestatic    #125 <Method void TimeUtils.formatDuration(long, PrintWriter)>
			printwriter.print(" mLastLoadCompleteTime=");
	//   63  123:aload_3         
	//   64  124:ldc1            #127 <String " mLastLoadCompleteTime=">
	//   65  126:invokevirtual   #100 <Method void PrintWriter.print(String)>
	...
	//   69  136:aload_3         
	//   70  137:invokestatic    #130 <Method void TimeUtils.formatDuration(long, long, PrintWriter)>
			printwriter.println();
	//   71  140:aload_3         
	//   72  141:invokevirtual   #132 <Method void PrintWriter.println()>
		}
	//   73  144:return          
	}
	...
	//*   8   18:getfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
	//*   9   21:ifeq            43
			{
				mTask.waiting = false;
	//   10   24:aload_0         
	...
	//   12   28:iconst_0        
	//   13   29:putfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
				mHandler.removeCallbacks(((Runnable) (mTask)));
	//   14   32:aload_0         
	//   15   33:getfield        #135 <Field Handler mHandler>
	//   16   36:aload_0         
	//   17   37:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   18   40:invokevirtual   #141 <Method void Handler.removeCallbacks(Runnable)>
			}
			if(mUpdateThrottle > 0L && SystemClock.uptimeMillis() < mLastLoadCompleteTime + mUpdateThrottle)
	//*  19   43:aload_0         
	//*  20   44:getfield        #117 <Field long mUpdateThrottle>
	//*  21   47:lconst_0        
	//*  22   48:lcmp            
	//*  23   49:ifle            98
	...
	//*  27   59:aload_0         
	//*  28   60:getfield        #117 <Field long mUpdateThrottle>
	//*  29   63:ladd            
	//*  30   64:lcmp            
	//*  31   65:ifge            98
			{
	...
	//   34   72:iconst_1        
	//   35   73:putfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
				mHandler.postAtTime(((Runnable) (mTask)), mLastLoadCompleteTime + mUpdateThrottle);
	//   36   76:aload_0         
	//   37   77:getfield        #135 <Field Handler mHandler>
	//   38   80:aload_0         
	//   39   81:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   40   84:aload_0         
	//   41   85:getfield        #45  <Field long mLastLoadCompleteTime>
	//   42   88:aload_0         
	//   43   89:getfield        #117 <Field long mUpdateThrottle>
	//   44   92:ladd            
	//   45   93:invokevirtual   #145 <Method boolean Handler.postAtTime(Runnable, long)>
	//   46   96:pop             
				return;
	//   47   97:return          
			}
	...
	//   52  106:aconst_null     
	//   53  107:checkcast       #147 <Class Void[]>
	//   54  110:invokevirtual   #151 <Method ModernAsyncTask AsyncTaskLoader$LoadTask.executeOnExecutor(Executor, Object[])>
	//   55  113:pop             
		}
	//   56  114:return          
	}
	...
	//*   2    4:ifnull          130
		{
			if(!mStarted)
	//*   3    7:aload_0         
	//*   4    8:getfield        #159 <Field boolean mStarted>
	//*   5   11:ifne            19
				mContentChanged = true;
	//    6   14:aload_0         
	//    7   15:iconst_1        
	//    8   16:putfield        #162 <Field boolean mContentChanged>
			if(mCancellingTask != null)
	//*   9   19:aload_0         
	...
	//*  14   30:getfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
	//*  15   33:ifeq            55
				{
					mTask.waiting = false;
	//   16   36:aload_0         
	//   17   37:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   18   40:iconst_0        
	//   19   41:putfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
					mHandler.removeCallbacks(((Runnable) (mTask)));
	//   20   44:aload_0         
	//   21   45:getfield        #135 <Field Handler mHandler>
	//   22   48:aload_0         
	//   23   49:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   24   52:invokevirtual   #141 <Method void Handler.removeCallbacks(Runnable)>
				}
				mTask = null;
	//   25   55:aload_0         
	//   26   56:aconst_null     
	...
	//*  32   66:getfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
	//*  33   69:ifeq            98
			{
				mTask.waiting = false;
	//   34   72:aload_0         
	...
	//   36   76:iconst_0        
	//   37   77:putfield        #109 <Field boolean AsyncTaskLoader$LoadTask.waiting>
				mHandler.removeCallbacks(((Runnable) (mTask)));
	//   38   80:aload_0         
	//   39   81:getfield        #135 <Field Handler mHandler>
	//   40   84:aload_0         
	//   41   85:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   42   88:invokevirtual   #141 <Method void Handler.removeCallbacks(Runnable)>
				mTask = null;
	//   43   91:aload_0         
	//   44   92:aconst_null     
	...
	//   49   99:getfield        #77  <Field AsyncTaskLoader$LoadTask mTask>
	//   50  102:iconst_0        
	//   51  103:invokevirtual   #166 <Method boolean AsyncTaskLoader$LoadTask.cancel(boolean)>
	//   52  106:istore_1        
			if(flag)
	//*  53  107:iload_1         
	//*  54  108:ifeq            123
	...
	//   59  119:aload_0         
	//   60  120:invokevirtual   #168 <Method void cancelLoadInBackground()>
			}
			mTask = null;
	//   61  123:aload_0         
	//   62  124:aconst_null     
	...
	protected void onForceLoad()
	{
		super.onForceLoad();
	//    0    0:aload_0         
	//    1    1:invokespecial   #172 <Method void Loader.onForceLoad()>
		cancelLoad();
	//    2    4:aload_0         
	//    3    5:invokevirtual   #175 <Method boolean cancelLoad()>
	//    4    8:pop             
		mTask = new LoadTask();
	//    5    9:aload_0         
	...
	//    7   13:dup             
	//    8   14:aload_0         
	//    9   15:invokespecial   #178 <Method void AsyncTaskLoader$LoadTask(AsyncTaskLoader)>
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #181 <Method Object loadInBackground()>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:putfield        #117 <Field long mUpdateThrottle>
		if(l != 0L)
	//*   3    5:lload_1         
	//*   4    6:lconst_0        
	//*   5    7:lcmp            
	...
	//    7   11:aload_0         
	//    8   12:new             #137 <Class Handler>
	//    9   15:dup             
	//   10   16:invokespecial   #187 <Method void Handler()>
	//   11   19:putfield        #135 <Field Handler mHandler>
	//   12   22:return          
	}
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #194 <Method void AsyncTaskLoader$LoadTask.waitForLoader()>
	//    7   13:return          
	}
