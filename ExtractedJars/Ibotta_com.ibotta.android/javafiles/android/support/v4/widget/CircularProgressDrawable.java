	...
	implements Animatable
{
	...
	private static class Ring
	{
		...
		//    0    0:aload_0         
		//    1    1:getfield        #221 <Field int[] mColors>
		//    2    4:aload_0         
		//    3    5:invokevirtual   #224 <Method int getNextColorIndex()>
		//    4    8:iaload          
		//    5    9:ireturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #226 <Field int mColorIndex>
		//    2    4:iconst_1        
		//    3    5:iadd            
		//    4    6:aload_0         
		//    5    7:getfield        #221 <Field int[] mColors>
		//    6   10:arraylength     
		//    7   11:irem            
		//    8   12:ireturn         
		}
		...
		//    1    1:getfield        #221 <Field int[] mColors>
		//    2    4:aload_0         
		//    3    5:getfield        #226 <Field int mColorIndex>
		//    4    8:iaload          
		//    5    9:ireturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #231 <Field float mStartingEndTrim>
		//    2    4:freturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #234 <Field float mStartingRotation>
		//    2    4:freturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #237 <Field float mStartingStartTrim>
		//    2    4:freturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_0         
		//    2    2:invokevirtual   #224 <Method int getNextColorIndex()>
		//    3    5:invokevirtual   #241 <Method void setColorIndex(int)>
		//    4    8:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:fconst_0        
		//    2    2:putfield        #237 <Field float mStartingStartTrim>
			mStartingEndTrim = 0.0F;
		//    3    5:aload_0         
		//    4    6:fconst_0        
		//    5    7:putfield        #231 <Field float mStartingEndTrim>
			mStartingRotation = 0.0F;
		//    6   10:aload_0         
		//    7   11:fconst_0        
		//    8   12:putfield        #234 <Field float mStartingRotation>
			setStartTrim(0.0F);
		//    9   15:aload_0         
		//   10   16:fconst_0        
		//   11   17:invokevirtual   #246 <Method void setStartTrim(float)>
			setEndTrim(0.0F);
		//   12   20:aload_0         
		//   13   21:fconst_0        
		//   14   22:invokevirtual   #249 <Method void setEndTrim(float)>
			setRotation(0.0F);
		//   15   25:aload_0         
		//   16   26:fconst_0        
		//   17   27:invokevirtual   #252 <Method void setRotation(float)>
		//   18   30:return          
		}
		...
		//    2    4:aload_1         
		//    3    5:invokevirtual   #260 <Method ColorFilter Paint.setColorFilter(ColorFilter)>
		//    4    8:pop             
		//    5    9:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:putfield        #226 <Field int mColorIndex>
			mCurrentColor = mColors[mColorIndex];
		//    3    5:aload_0         
		//    4    6:aload_0         
		//    5    7:getfield        #221 <Field int[] mColors>
		//    6   10:aload_0         
		//    7   11:getfield        #226 <Field int mColorIndex>
		//    8   14:iaload          
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #221 <Field int[] mColors>
			setColorIndex(0);
		//    3    5:aload_0         
		//    4    6:iconst_0        
		//    5    7:invokevirtual   #241 <Method void setColorIndex(int)>
		//    6   10:return          
		}
		...
		//    5    9:fload_1         
		//    6   10:invokevirtual   #268 <Method void Paint.setStrokeWidth(float)>
		//    7   13:return          
		}
		...
		//    3    5:putfield        #237 <Field float mStartingStartTrim>
			mStartingEndTrim = mEndTrim;
		//    4    8:aload_0         
		//    5    9:aload_0         
		//    6   10:getfield        #57  <Field float mEndTrim>
		//    7   13:putfield        #231 <Field float mStartingEndTrim>
			mStartingRotation = mRotation;
		//    8   16:aload_0         
		//    9   17:aload_0         
		//   10   18:getfield        #59  <Field float mRotation>
		//   11   21:putfield        #234 <Field float mStartingRotation>
		//   12   24:return          
		}
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokestatic    #59  <Method Object Preconditions.checkNotNull(Object)>
	//    5    9:checkcast       #61  <Class Context>
	//    6   12:invokevirtual   #65  <Method Resources Context.getResources()>
	//    7   15:putfield        #67  <Field Resources mResources>
	//    8   18:aload_0         
	//    9   19:new             #15  <Class CircularProgressDrawable$Ring>
	//   10   22:dup             
	//   11   23:invokespecial   #68  <Method void CircularProgressDrawable$Ring()>
	//   12   26:putfield        #70  <Field CircularProgressDrawable$Ring mRing>
		mRing.setColors(COLORS);
	//   13   29:aload_0         
	//   14   30:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//   15   33:getstatic       #49  <Field int[] COLORS>
	//   16   36:invokevirtual   #74  <Method void CircularProgressDrawable$Ring.setColors(int[])>
		setStrokeWidth(2.5F);
	//   17   39:aload_0         
	//   18   40:ldc1            #75  <Float 2.5F>
	//   19   42:invokevirtual   #79  <Method void setStrokeWidth(float)>
		setupAnimators();
	//   20   45:aload_0         
	//   21   46:invokespecial   #82  <Method void setupAnimators()>
	//   22   49:return          
	}
	...
	//    1    1:fload_1         
	//    2    2:aload_2         
	//    3    3:invokevirtual   #88  <Method void updateRingColor(float, CircularProgressDrawable$Ring)>
		float f1 = (float)(Math.floor(ring.getStartingRotation() / 0.8F) + 1.0D);
	//    4    6:aload_2         
	//    5    7:invokevirtual   #92  <Method float CircularProgressDrawable$Ring.getStartingRotation()>
	//    6   10:ldc1            #93  <Float 0.8F>
	//    7   12:fdiv            
	//    8   13:f2d             
	//    9   14:invokestatic    #99  <Method double Math.floor(double)>
	//   10   17:dconst_1        
	//   11   18:dadd            
	//   12   19:d2f             
	//   13   20:fstore_3        
	...
	//   14   21:aload_2         
	//   15   22:aload_2         
	//   16   23:invokevirtual   #102 <Method float CircularProgressDrawable$Ring.getStartingStartTrim()>
	//   17   26:aload_2         
	//   18   27:invokevirtual   #105 <Method float CircularProgressDrawable$Ring.getStartingEndTrim()>
	//   19   30:ldc1            #106 <Float 0.01F>
	//   20   32:fsub            
	//   21   33:aload_2         
	//   22   34:invokevirtual   #102 <Method float CircularProgressDrawable$Ring.getStartingStartTrim()>
	//   23   37:fsub            
	//   24   38:fload_1         
	//   25   39:fmul            
	//   26   40:fadd            
	//   27   41:invokevirtual   #109 <Method void CircularProgressDrawable$Ring.setStartTrim(float)>
		ring.setEndTrim(ring.getStartingEndTrim());
	//   28   44:aload_2         
	//   29   45:aload_2         
	//   30   46:invokevirtual   #105 <Method float CircularProgressDrawable$Ring.getStartingEndTrim()>
	//   31   49:invokevirtual   #112 <Method void CircularProgressDrawable$Ring.setEndTrim(float)>
		ring.setRotation(ring.getStartingRotation() + (f1 - ring.getStartingRotation()) * f);
	//   32   52:aload_2         
	//   33   53:aload_2         
	//   34   54:invokevirtual   #92  <Method float CircularProgressDrawable$Ring.getStartingRotation()>
	//   35   57:fload_3         
	//   36   58:aload_2         
	//   37   59:invokevirtual   #92  <Method float CircularProgressDrawable$Ring.getStartingRotation()>
	//   38   62:fsub            
	//   39   63:fload_1         
	//   40   64:fmul            
	//   41   65:fadd            
	//   42   66:invokevirtual   #115 <Method void CircularProgressDrawable$Ring.setRotation(float)>
	//   43   69:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:fload_1         
	//    2    2:putfield        #119 <Field float mRotation>
	//    3    5:return          
	}
	...
	private void setSizeParameters(float f, float f1, float f2, float f3)
	{
		Ring ring = mRing;
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:astore          6
		float f4 = mResources.getDisplayMetrics().density;
	//    3    6:aload_0         
	//    4    7:getfield        #67  <Field Resources mResources>
	//    5   10:invokevirtual   #127 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//    6   13:getfield        #132 <Field float DisplayMetrics.density>
	//    7   16:fstore          5
	...
	//   10   21:fload           5
	//   11   23:fmul            
	//   12   24:invokevirtual   #133 <Method void CircularProgressDrawable$Ring.setStrokeWidth(float)>
		ring.setCenterRadius(f * f4);
	//   13   27:aload           6
	//   14   29:fload_1         
	//   15   30:fload           5
	//   16   32:fmul            
	//   17   33:invokevirtual   #136 <Method void CircularProgressDrawable$Ring.setCenterRadius(float)>
		ring.setColorIndex(0);
	//   18   36:aload           6
	//   19   38:iconst_0        
	//   20   39:invokevirtual   #140 <Method void CircularProgressDrawable$Ring.setColorIndex(int)>
	...
	//   26   50:fload           5
	//   27   52:fmul            
	//   28   53:invokevirtual   #144 <Method void CircularProgressDrawable$Ring.setArrowDimensions(float, float)>
	//   29   56:return          
	}
	...
	//   11   14:fconst_1        
	//   12   15:fastore         
	//   13   16:invokestatic    #150 <Method ValueAnimator ValueAnimator.ofFloat(float[])>
	//   14   19:astore_2        
	...
	//   18   25:aload_0         
	//   19   26:aload_1         
	//   20   27:invokespecial   #153 <Method void CircularProgressDrawable$1(CircularProgressDrawable, CircularProgressDrawable$Ring)>
	//   21   30:invokevirtual   #157 <Method void ValueAnimator.addUpdateListener(android.animation.ValueAnimator$AnimatorUpdateListener)>
		valueanimator.setRepeatCount(-1);
	//   22   33:aload_2         
	//   23   34:iconst_m1       
	//   24   35:invokevirtual   #160 <Method void ValueAnimator.setRepeatCount(int)>
		valueanimator.setRepeatMode(1);
	//   25   38:aload_2         
	//   26   39:iconst_1        
	//   27   40:invokevirtual   #163 <Method void ValueAnimator.setRepeatMode(int)>
		valueanimator.setInterpolator(((android.animation.TimeInterpolator) (LINEAR_INTERPOLATOR)));
	//   28   43:aload_2         
	//   29   44:getstatic       #41  <Field Interpolator LINEAR_INTERPOLATOR>
	//   30   47:invokevirtual   #167 <Method void ValueAnimator.setInterpolator(android.animation.TimeInterpolator)>
	...
	//   34   55:aload_0         
	//   35   56:aload_1         
	//   36   57:invokespecial   #168 <Method void CircularProgressDrawable$2(CircularProgressDrawable, CircularProgressDrawable$Ring)>
	//   37   60:invokevirtual   #172 <Method void ValueAnimator.addListener(android.animation.Animator$AnimatorListener)>
		mAnimator = ((Animator) (valueanimator));
	//   38   63:aload_0         
	//   39   64:aload_2         
	//   40   65:putfield        #174 <Field Animator mAnimator>
	//   41   68:return          
	}
	...
	void applyTransformation(float f, Ring ring, boolean flag)
	{
		if(mFinishing)
	//*   0    0:aload_0         
	//*   1    1:getfield        #178 <Field boolean mFinishing>
	//*   2    4:ifeq            14
		{
	...
	//    4    8:fload_1         
	//    5    9:aload_2         
	//    6   10:invokespecial   #180 <Method void applyFinishTranslation(float, CircularProgressDrawable$Ring)>
			return;
	//    7   13:return          
		}
		if(f != 1.0F || flag)
	...
	//   14   24:aload_2         
	//   15   25:invokevirtual   #92  <Method float CircularProgressDrawable$Ring.getStartingRotation()>
	//   16   28:fstore          6
			float f1;
			float f2;
			if(f < 0.5F)
	//*  17   30:fload_1         
	//*  18   31:ldc1            #181 <Float 0.5F>
	//*  19   33:fcmpg           
	//*  20   34:ifge            73
			{
				f2 = f / 0.5F;
	//   21   37:fload_1         
	//   22   38:ldc1            #181 <Float 0.5F>
	//   23   40:fdiv            
	//   24   41:fstore          5
				f1 = ring.getStartingStartTrim();
	//   25   43:aload_2         
	//   26   44:invokevirtual   #102 <Method float CircularProgressDrawable$Ring.getStartingStartTrim()>
	//   27   47:fstore          4
				f2 = MATERIAL_INTERPOLATOR.getInterpolation(f2) * 0.79F + 0.01F + f1;
	//   28   49:getstatic       #46  <Field Interpolator MATERIAL_INTERPOLATOR>
	//   29   52:fload           5
	//   30   54:invokeinterface #187 <Method float Interpolator.getInterpolation(float)>
	//   31   59:ldc1            #188 <Float 0.79F>
	//   32   61:fmul            
	//   33   62:ldc1            #106 <Float 0.01F>
	//   34   64:fadd            
	//   35   65:fload           4
	//   36   67:fadd            
	//   37   68:fstore          5
	...
	//*  38   70:goto            114
			{
				f1 = (f - 0.5F) / 0.5F;
	//   39   73:fload_1         
	//   40   74:ldc1            #181 <Float 0.5F>
	//   41   76:fsub            
	//   42   77:ldc1            #181 <Float 0.5F>
	//   43   79:fdiv            
	//   44   80:fstore          4
				f2 = ring.getStartingStartTrim() + 0.79F;
	//   45   82:aload_2         
	//   46   83:invokevirtual   #102 <Method float CircularProgressDrawable$Ring.getStartingStartTrim()>
	//   47   86:ldc1            #188 <Float 0.79F>
	//   48   88:fadd            
	//   49   89:fstore          5
				f1 = f2 - ((1.0F - MATERIAL_INTERPOLATOR.getInterpolation(f1)) * 0.79F + 0.01F);
	//   50   91:fload           5
	//   51   93:fconst_1        
	//   52   94:getstatic       #46  <Field Interpolator MATERIAL_INTERPOLATOR>
	//   53   97:fload           4
	//   54   99:invokeinterface #187 <Method float Interpolator.getInterpolation(float)>
	//   55  104:fsub            
	//   56  105:ldc1            #188 <Float 0.79F>
	//   57  107:fmul            
	//   58  108:ldc1            #106 <Float 0.01F>
	//   59  110:fadd            
	//   60  111:fsub            
	//   61  112:fstore          4
			}
	...
	//   62  114:aload_0         
	//   63  115:getfield        #190 <Field float mRotationCount>
	//   64  118:fstore          7
			ring.setStartTrim(f1);
	//   65  120:aload_2         
	//   66  121:fload           4
	//   67  123:invokevirtual   #109 <Method void CircularProgressDrawable$Ring.setStartTrim(float)>
			ring.setEndTrim(f2);
	//   68  126:aload_2         
	//   69  127:fload           5
	//   70  129:invokevirtual   #112 <Method void CircularProgressDrawable$Ring.setEndTrim(float)>
			ring.setRotation(f3 + 0.21F * f);
	//   71  132:aload_2         
	//   72  133:fload           6
	//   73  135:ldc1            #191 <Float 0.21F>
	//   74  137:fload_1         
	//   75  138:fmul            
	//   76  139:fadd            
	//   77  140:invokevirtual   #115 <Method void CircularProgressDrawable$Ring.setRotation(float)>
			setRotation((f + f4) * 216F);
	//   78  143:aload_0         
	//   79  144:fload_1         
	//   80  145:fload           7
	//   81  147:fadd            
	//   82  148:ldc1            #192 <Float 216F>
	//   83  150:fmul            
	//   84  151:invokespecial   #193 <Method void setRotation(float)>
		}
	//   85  154:return          
	}
	...
	public void draw(Canvas canvas)
	{
		Rect rect = getBounds();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #199 <Method Rect getBounds()>
	//    2    4:astore_2        
		canvas.save();
	//    3    5:aload_1         
	//    4    6:invokevirtual   #205 <Method int Canvas.save()>
	//    5    9:pop             
		canvas.rotate(mRotation, rect.exactCenterX(), rect.exactCenterY());
	//    6   10:aload_1         
	//    7   11:aload_0         
	//    8   12:getfield        #119 <Field float mRotation>
	//    9   15:aload_2         
	//   10   16:invokevirtual   #210 <Method float Rect.exactCenterX()>
	//   11   19:aload_2         
	//   12   20:invokevirtual   #213 <Method float Rect.exactCenterY()>
	//   13   23:invokevirtual   #217 <Method void Canvas.rotate(float, float, float)>
		mRing.draw(canvas, rect);
	//   14   26:aload_0         
	//   15   27:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//   16   30:aload_1         
	//   17   31:aload_2         
	//   18   32:invokevirtual   #220 <Method void CircularProgressDrawable$Ring.draw(Canvas, Rect)>
		canvas.restore();
	//   19   35:aload_1         
	//   20   36:invokevirtual   #223 <Method void Canvas.restore()>
	//   21   39:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:invokevirtual   #226 <Method int CircularProgressDrawable$Ring.getAlpha()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #174 <Field Animator mAnimator>
	//    2    4:invokevirtual   #233 <Method boolean Animator.isRunning()>
	//    3    7:ireturn         
	}
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #236 <Method void CircularProgressDrawable$Ring.setAlpha(int)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #239 <Method void invalidateSelf()>
	//    6   12:return          
	}
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #244 <Method void CircularProgressDrawable$Ring.setShowArrow(boolean)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #239 <Method void invalidateSelf()>
	//    6   12:return          
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:fload_1         
	//    3    5:invokevirtual   #247 <Method void CircularProgressDrawable$Ring.setArrowScale(float)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #239 <Method void invalidateSelf()>
	//    6   12:return          
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #251 <Method void CircularProgressDrawable$Ring.setColorFilter(ColorFilter)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #239 <Method void invalidateSelf()>
	//    6   12:return          
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #74  <Method void CircularProgressDrawable$Ring.setColors(int[])>
		mRing.setColorIndex(0);
	//    4    8:aload_0         
	//    5    9:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    6   12:iconst_0        
	//    7   13:invokevirtual   #140 <Method void CircularProgressDrawable$Ring.setColorIndex(int)>
		invalidateSelf();
	//    8   16:aload_0         
	//    9   17:invokevirtual   #239 <Method void invalidateSelf()>
	//   10   20:return          
	}
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:fload_1         
	//    3    5:invokevirtual   #115 <Method void CircularProgressDrawable$Ring.setRotation(float)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #239 <Method void invalidateSelf()>
	//    6   12:return          
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:fload_1         
	//    3    5:invokevirtual   #109 <Method void CircularProgressDrawable$Ring.setStartTrim(float)>
		mRing.setEndTrim(f1);
	//    4    8:aload_0         
	//    5    9:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    6   12:fload_2         
	//    7   13:invokevirtual   #112 <Method void CircularProgressDrawable$Ring.setEndTrim(float)>
		invalidateSelf();
	//    8   16:aload_0         
	//    9   17:invokevirtual   #239 <Method void invalidateSelf()>
	//   10   20:return          
	...
	//    1    1:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    2    4:fload_1         
	//    3    5:invokevirtual   #133 <Method void CircularProgressDrawable$Ring.setStrokeWidth(float)>
		invalidateSelf();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #239 <Method void invalidateSelf()>
	//    6   12:return          
	...
	//    2    4:aload_0         
	//    3    5:ldc2            #256 <Float 11F>
	//    4    8:ldc2            #257 <Float 3F>
	//    5   11:ldc2            #258 <Float 12F>
	//    6   14:ldc2            #259 <Float 6F>
	//    7   17:invokespecial   #261 <Method void setSizeParameters(float, float, float, float)>
		else
	//*   8   20:goto            38
			setSizeParameters(7.5F, 2.5F, 10F, 5F);
	//    9   23:aload_0         
	//   10   24:ldc2            #262 <Float 7.5F>
	//   11   27:ldc1            #75  <Float 2.5F>
	//   12   29:ldc2            #263 <Float 10F>
	//   13   32:ldc2            #264 <Float 5F>
	//   14   35:invokespecial   #261 <Method void setSizeParameters(float, float, float, float)>
		invalidateSelf();
	//   15   38:aload_0         
	//   16   39:invokevirtual   #239 <Method void invalidateSelf()>
	//   17   42:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #174 <Field Animator mAnimator>
	//    2    4:invokevirtual   #268 <Method void Animator.cancel()>
		mRing.storeOriginals();
	//    3    7:aload_0         
	//    4    8:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    5   11:invokevirtual   #271 <Method void CircularProgressDrawable$Ring.storeOriginals()>
		if(mRing.getEndTrim() != mRing.getStartTrim())
	//*   6   14:aload_0         
	//*   7   15:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//*   8   18:invokevirtual   #274 <Method float CircularProgressDrawable$Ring.getEndTrim()>
	//*   9   21:aload_0         
	//*  10   22:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//*  11   25:invokevirtual   #277 <Method float CircularProgressDrawable$Ring.getStartTrim()>
	//*  12   28:fcmpl           
	//*  13   29:ifeq            56
		{
			mFinishing = true;
	//   14   32:aload_0         
	//   15   33:iconst_1        
	//   16   34:putfield        #178 <Field boolean mFinishing>
			mAnimator.setDuration(666L);
	//   17   37:aload_0         
	//   18   38:getfield        #174 <Field Animator mAnimator>
	//   19   41:ldc2w           #278 <Long 666L>
	//   20   44:invokevirtual   #283 <Method Animator Animator.setDuration(long)>
	//   21   47:pop             
			mAnimator.start();
	//   22   48:aload_0         
	//   23   49:getfield        #174 <Field Animator mAnimator>
	//   24   52:invokevirtual   #285 <Method void Animator.start()>
			return;
	//   25   55:return          
		} else
		{
			mRing.setColorIndex(0);
	//   26   56:aload_0         
	//   27   57:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//   28   60:iconst_0        
	//   29   61:invokevirtual   #140 <Method void CircularProgressDrawable$Ring.setColorIndex(int)>
			mRing.resetOriginals();
	//   30   64:aload_0         
	//   31   65:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//   32   68:invokevirtual   #288 <Method void CircularProgressDrawable$Ring.resetOriginals()>
			mAnimator.setDuration(1332L);
	//   33   71:aload_0         
	//   34   72:getfield        #174 <Field Animator mAnimator>
	//   35   75:ldc2w           #289 <Long 1332L>
	//   36   78:invokevirtual   #283 <Method Animator Animator.setDuration(long)>
	//   37   81:pop             
			mAnimator.start();
	//   38   82:aload_0         
	//   39   83:getfield        #174 <Field Animator mAnimator>
	//   40   86:invokevirtual   #285 <Method void Animator.start()>
			return;
	//   41   89:return          
		}
	}
	...
	//    3    7:aload_0         
	//    4    8:fconst_0        
	//    5    9:invokespecial   #193 <Method void setRotation(float)>
		mRing.setShowArrow(false);
	//    6   12:aload_0         
	//    7   13:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//    8   16:iconst_0        
	//    9   17:invokevirtual   #244 <Method void CircularProgressDrawable$Ring.setShowArrow(boolean)>
		mRing.setColorIndex(0);
	//   10   20:aload_0         
	//   11   21:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//   12   24:iconst_0        
	//   13   25:invokevirtual   #140 <Method void CircularProgressDrawable$Ring.setColorIndex(int)>
		mRing.resetOriginals();
	//   14   28:aload_0         
	//   15   29:getfield        #70  <Field CircularProgressDrawable$Ring mRing>
	//   16   32:invokevirtual   #288 <Method void CircularProgressDrawable$Ring.resetOriginals()>
		invalidateSelf();
	//   17   35:aload_0         
	//   18   36:invokevirtual   #239 <Method void invalidateSelf()>
	//   19   39:return          
	}
	...
	//    5    9:aload_0         
	//    6   10:fload_1         
	//    7   11:ldc2            #292 <Float 0.75F>
	//    8   14:fsub            
	//    9   15:ldc2            #293 <Float 0.25F>
	//   10   18:fdiv            
	//   11   19:aload_2         
	//   12   20:invokevirtual   #296 <Method int CircularProgressDrawable$Ring.getStartingColor()>
	//   13   23:aload_2         
	//   14   24:invokevirtual   #299 <Method int CircularProgressDrawable$Ring.getNextColor()>
	//   15   27:invokespecial   #301 <Method int evaluateColorChange(float, int, int)>
	//   16   30:invokevirtual   #304 <Method void CircularProgressDrawable$Ring.setColor(int)>
			return;
	//   17   33:return          
		} else
		{
	...
	//   18   34:aload_2         
	//   19   35:aload_2         
	//   20   36:invokevirtual   #296 <Method int CircularProgressDrawable$Ring.getStartingColor()>
	//   21   39:invokevirtual   #304 <Method void CircularProgressDrawable$Ring.setColor(int)>
			return;
	//   22   42:return          
		}
	}
	...
	static 
	{
	//    0    0:new             #36  <Class LinearInterpolator>
	//    1    3:dup             
	//    2    4:invokespecial   #39  <Method void LinearInterpolator()>
	//    3    7:putstatic       #41  <Field Interpolator LINEAR_INTERPOLATOR>
	//    4   10:new             #43  <Class FastOutSlowInInterpolator>
	//    5   13:dup             
	//    6   14:invokespecial   #44  <Method void FastOutSlowInInterpolator()>
	//    7   17:putstatic       #46  <Field Interpolator MATERIAL_INTERPOLATOR>
	//    8   20:iconst_1        
	//    9   21:newarray        int[]
	//   10   23:dup             
	//   11   24:iconst_0        
	//   12   25:ldc1            #47  <Int 0xff000000>
	//   13   27:iastore         
	//   14   28:putstatic       #49  <Field int[] COLORS>
	//*  15   31:return          
	}
}
