...
public static abstract class IMediaSession$Stub extends Binder
...
label0:
		...
		//   20   40:getstatic       #97  <Field android.os.Parcelable$Creator PendingIntent.CREATOR>
		//   21   43:aload_3         
		//   22   44:invokeinterface #87  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
		//   23   49:checkcast       #96  <Class PendingIntent>
		//   24   52:astore_1        
					break label0;
		//   25   53:goto            58
				}
...
label0:
		...
		//   20   40:getstatic       #102 <Field android.os.Parcelable$Creator MediaMetadataCompat.CREATOR>
		//   21   43:aload_3         
		//   22   44:invokeinterface #87  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
		//   23   49:checkcast       #101 <Class MediaMetadataCompat>
		//   24   52:astore_1        
					break label0;
		//   25   53:goto            58
				}
		...
		//   17   33:aload_2         
		//   18   34:invokevirtual   #107 <Method String Parcel.readString()>
		//   19   37:astore_3        
			parcel1.recycle();
		//   20   38:aload_2         
...
label0:
		...
		//   20   40:getstatic       #112 <Field android.os.Parcelable$Creator PlaybackStateCompat.CREATOR>
		//   21   43:aload_3         
		//   22   44:invokeinterface #87  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
		//   23   49:checkcast       #111 <Class PlaybackStateCompat>
		//   24   52:astore_1        
					break label0;
		//   25   53:goto            58
				}
		...
		//   17   33:aload_2         
		//   18   34:getstatic       #117 <Field android.os.Parcelable$Creator MediaSessionCompat$QueueItem.CREATOR>
		//   19   37:invokevirtual   #121 <Method java.util.ArrayList Parcel.createTypedArrayList(android.os.Parcelable$Creator)>
		//   20   40:astore_3        
			parcel1.recycle();
		//   21   41:aload_2         
...
label0:
		...
		//   20   40:getstatic       #130 <Field android.os.Parcelable$Creator TextUtils.CHAR_SEQUENCE_CREATOR>
		//   21   43:aload_3         
		//   22   44:invokeinterface #87  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
		//   23   49:checkcast       #132 <Class CharSequence>
		//   24   52:astore_1        
					break label0;
		//   25   53:goto            58
				}
...
label0:
		...
		//   16   30:aload_3         
		//   17   31:iconst_0        
		//   18   32:invokevirtual   #151 <Method void Bundle.writeToParcel(Parcel, int)>
		...
		//   13   25:aload_3         
		//   14   26:iconst_0        
		//   15   27:invokevirtual   #157 <Method void Uri.writeToParcel(Parcel, int)>
			break MISSING_BLOCK_LABEL_38;
		//   16   30:goto            38
			parcel.writeInt(0);
		//   17   33:aload_3         
		...
		//   26   48:aload_3         
		//   27   49:iconst_0        
		//   28   50:invokevirtual   #151 <Method void Bundle.writeToParcel(Parcel, int)>
		...
		//   13   24:aload_2         
		//   14   25:iconst_0        
		//   15   26:invokevirtual   #167 <Method void RatingCompat.writeToParcel(Parcel, int)>
			break MISSING_BLOCK_LABEL_37;
		//   16   29:goto            37
			parcel.writeInt(0);
		//   17   32:aload_2         
		...
		//   13   25:aload_3         
		//   14   26:iconst_0        
		//   15   27:invokevirtual   #167 <Method void RatingCompat.writeToParcel(Parcel, int)>
			break MISSING_BLOCK_LABEL_38;
		//   16   30:goto            38
			parcel.writeInt(0);
		//   17   33:aload_3         
...
_L1:
		...
		//    9   18:aload_1         
		//   10   19:invokeinterface #175 <Method IBinder IMediaControllerCallback.asBinder()>
		//   11   24:astore_1        
		//*  12   25:goto            28
_L4:
		...
		//   13   28:aload_2         
		//   14   29:aload_1         
		//   15   30:invokevirtual   #178 <Method void Parcel.writeStrongBinder(IBinder)>
...
_L3:
		...
		//    7   15:aload_3         
		//    8   16:lload_1         
		//    9   17:invokevirtual   #186 <Method void Parcel.writeLong(long)>
		...
		//   16   34:aload           4
		//   17   36:iconst_0        
		//   18   37:invokevirtual   #151 <Method void Bundle.writeToParcel(Parcel, int)>
		...
		//   29   60:aload           4
		//   30   62:iconst_0        
		//   31   63:invokevirtual   #191 <Method void MediaSessionCompat$ResultReceiverWrapper.writeToParcel(Parcel, int)>
		...
		//   15   30:aload           4
		//   16   32:iconst_0        
		//   17   33:invokevirtual   #197 <Method void KeyEvent.writeToParcel(Parcel, int)>
...
_L3:
	...
	//    6    9:invokeinterface #20  <Method android.os.IInterface IBinder.queryLocalInterface(String)>
	//    7   14:astore_1        
	...
	//   17   34:dup             
	//   18   35:aload_0         
	//   19   36:invokespecial   #24  <Method void IMediaSession$Stub$Proxy(IBinder)>
	//   20   39:areturn         
	}
