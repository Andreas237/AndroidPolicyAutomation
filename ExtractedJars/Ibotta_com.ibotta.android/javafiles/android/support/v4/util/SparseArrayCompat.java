	...
	implements Cloneable
{
	...
	//    4    8:iload_1         
	//    5    9:invokestatic    #90  <Method int ContainerHelpers.binarySearch(int[], int, int)>
	//    6   12:istore_1        
		if(i >= 0)
	//*   7   13:iload_1         
	//*   8   14:iflt            47
	...
	//    1    1:iload_1         
	//    2    2:aconst_null     
	//    3    3:invokevirtual   #96  <Method Object get(int, Object)>
	//    4    6:areturn         
	}
	...
	//    9   19:iload_1         
	//   10   20:invokestatic    #90  <Method int ContainerHelpers.binarySearch(int[], int, int)>
	//   11   23:ireturn         
	}
	...
	//   58  106:iload_1         
	//   59  107:invokestatic    #90  <Method int ContainerHelpers.binarySearch(int[], int, int)>
	//   60  110:istore_3        
			}
		}
		k = mSize;
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #107 <Method void delete(int)>
	//    3    5:return          
	}
	...
	//   30   54:aload_0         
	//   31   55:iload_1         
	//   32   56:invokevirtual   #128 <Method int keyAt(int)>
	//   33   59:invokevirtual   #131 <Method StringBuilder StringBuilder.append(int)>
	//   34   62:pop             
			stringbuilder.append('=');
	//   35   63:aload_2         
	//   36   64:bipush          61
	...
	//   39   70:aload_0         
	//   40   71:iload_1         
	//   41   72:invokevirtual   #134 <Method Object valueAt(int)>
	//   42   75:astore_3        
			if(obj != this)
	//*  43   76:aload_3         
	//*  44   77:aload_0         
	...
	//   46   81:aload_2         
	//   47   82:aload_3         
	//   48   83:invokevirtual   #137 <Method StringBuilder StringBuilder.append(Object)>
	//   49   86:pop             
			else
	//*  50   87:goto            97
				stringbuilder.append("(this Map)");
	//   51   90:aload_2         
	//   52   91:ldc1            #139 <String "(this Map)">
	...
	//   64  111:aload_2         
	//   65  112:invokevirtual   #141 <Method String StringBuilder.toString()>
	//   66  115:areturn         
	}
