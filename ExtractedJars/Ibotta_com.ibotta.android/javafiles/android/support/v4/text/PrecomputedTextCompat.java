	...
	implements Spannable
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #40  <Field Spannable mText>
	//    2    4:iload_1         
	//    3    5:invokeinterface #42  <Method char Spannable.charAt(int)>
	//    4   10:ireturn         
	}
	...
	public Params getParams()
	{
		return mParams;
	//    0    0:aload_0         
	//    1    1:getfield        #46  <Field PrecomputedTextCompat$Params mParams>
	//    2    4:areturn         
	}
	...
	//*   3    5:aload_1         
	//*   4    6:instanceof      #56  <Class PrecomputedText>
	//*   5    9:ifeq            17
			return (PrecomputedText)spannable;
	//    6   12:aload_1         
	//    7   13:checkcast       #56  <Class PrecomputedText>
	//    8   16:areturn         
		else
			return null;
	//    9   17:aconst_null     
	...
	//    1    1:getfield        #40  <Field Spannable mText>
	//    2    4:aload_1         
	//    3    5:invokeinterface #60  <Method int Spannable.getSpanEnd(Object)>
	//    4   10:ireturn         
	}
	...
	//    1    1:getfield        #40  <Field Spannable mText>
	//    2    4:aload_1         
	//    3    5:invokeinterface #63  <Method int Spannable.getSpanFlags(Object)>
	//    4   10:ireturn         
	}
	...
	//    1    1:getfield        #40  <Field Spannable mText>
	//    2    4:aload_1         
	//    3    5:invokeinterface #66  <Method int Spannable.getSpanStart(Object)>
	//    4   10:ireturn         
	}
	...
	{
		if(android.os.Build.VERSION.SDK_INT >= 28)
	//*   0    0:getstatic       #74  <Field int android.os.Build$VERSION.SDK_INT>
	//*   1    3:bipush          28
	//*   2    5:icmplt          19
			return mWrapped.getSpans(i, j, class1);
	//    3    8:aload_0         
	//    4    9:getfield        #76  <Field PrecomputedText mWrapped>
	//    5   12:iload_1         
	//    6   13:iload_2         
	//    7   14:aload_3         
	//    8   15:invokevirtual   #78  <Method Object[] PrecomputedText.getSpans(int, int, Class)>
	//    9   18:areturn         
		else
			return mText.getSpans(i, j, class1);
	//   10   19:aload_0         
	//   11   20:getfield        #40  <Field Spannable mText>
	//   12   23:iload_1         
	//   13   24:iload_2         
	//   14   25:aload_3         
	//   15   26:invokeinterface #79  <Method Object[] Spannable.getSpans(int, int, Class)>
	//   16   31:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #40  <Field Spannable mText>
	//    2    4:invokeinterface #85  <Method int Spannable.length()>
	//    3    9:ireturn         
	}
	...
	//    3    5:iload_2         
	//    4    6:aload_3         
	//    5    7:invokeinterface #89  <Method int Spannable.nextSpanTransition(int, int, Class)>
	//    6   12:ireturn         
	}
	...
	//*   0    0:aload_1         
	//*   1    1:instanceof      #93  <Class MetricAffectingSpan>
	//*   2    4:ifne            35
		{
			if(android.os.Build.VERSION.SDK_INT >= 28)
	//*   3    7:getstatic       #74  <Field int android.os.Build$VERSION.SDK_INT>
	//*   4   10:bipush          28
	//*   5   12:icmplt          24
			{
				mWrapped.removeSpan(obj);
	//    6   15:aload_0         
	//    7   16:getfield        #76  <Field PrecomputedText mWrapped>
	//    8   19:aload_1         
	//    9   20:invokevirtual   #95  <Method void PrecomputedText.removeSpan(Object)>
				return;
	//   10   23:return          
			} else
			{
	...
	//   11   24:aload_0         
	//   12   25:getfield        #40  <Field Spannable mText>
	//   13   28:aload_1         
	//   14   29:invokeinterface #96  <Method void Spannable.removeSpan(Object)>
				return;
	//   15   34:return          
			}
		} else
	...
	//   16   35:new             #98  <Class IllegalArgumentException>
	//   17   38:dup             
	//   18   39:ldc1            #100 <String "MetricAffectingSpan can not be removed from PrecomputedText.">
	//   19   41:invokespecial   #103 <Method void IllegalArgumentException(String)>
	//   20   44:athrow          
		}
	}
	...
	//   10   21:iload_3         
	//   11   22:iload           4
	//   12   24:invokevirtual   #107 <Method void PrecomputedText.setSpan(Object, int, int, int)>
				return;
	//   13   27:return          
			} else
			{
	...
	//   14   28:aload_0         
	//   15   29:getfield        #40  <Field Spannable mText>
	//   16   32:aload_1         
	//   17   33:iload_2         
	//   18   34:iload_3         
	//   19   35:iload           4
	//   20   37:invokeinterface #108 <Method void Spannable.setSpan(Object, int, int, int)>
				return;
	//   21   42:return          
			}
		} else
	...
	//   22   43:new             #98  <Class IllegalArgumentException>
	//   23   46:dup             
	//   24   47:ldc1            #110 <String "MetricAffectingSpan can not be set to PrecomputedText.">
	//   25   49:invokespecial   #103 <Method void IllegalArgumentException(String)>
	//   26   52:athrow          
		}
	}
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokeinterface #114 <Method CharSequence Spannable.subSequence(int, int)>
	//    5   11:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #40  <Field Spannable mText>
	//    2    4:invokevirtual   #118 <Method String Object.toString()>
	//    3    7:areturn         
	}
	...
	//    3    7:putstatic       #33  <Field Object sLock>
	//    4   10:aconst_null     
	//    5   11:putstatic       #35  <Field Executor sExecutor>
	//*   6   14:return          
	}
}
