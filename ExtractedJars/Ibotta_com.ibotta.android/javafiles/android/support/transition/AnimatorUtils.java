...
class AnimatorUtils
{
	...
	//    3    8:aload_0         
	//    4    9:aload_1         
	//    5   10:invokevirtual   #21  <Method void Animator.addPauseListener(android.animation.Animator$AnimatorPauseListener)>
	//    6   13:return          
	}
	...
	//*   2    5:icmplt          13
		{
			animator.pause();
	//    3    8:aload_0         
	//    4    9:invokevirtual   #28  <Method void Animator.pause()>
			return;
	//    5   12:return          
		}
		ArrayList arraylist = animator.getListeners();
	//    6   13:aload_0         
	//    7   14:invokevirtual   #32  <Method ArrayList Animator.getListeners()>
	//    8   17:astore_3        
		if(arraylist != null)
	//*   9   18:aload_3         
	//*  10   19:ifnull          70
	...
	//*  13   24:aload_3         
	//*  14   25:invokevirtual   #38  <Method int ArrayList.size()>
	//*  15   28:istore_2        
	//*  16   29:iload_1         
	//*  17   30:iload_2         
	//*  18   31:icmpge          70
	...
	//   19   34:aload_3         
	//   20   35:iload_1         
	//   21   36:invokevirtual   #42  <Method Object ArrayList.get(int)>
	//   22   39:checkcast       #44  <Class android.animation.Animator$AnimatorListener>
	//   23   42:astore          4
	...
	//   29   57:aload_0         
	//   30   58:invokeinterface #47  <Method void AnimatorUtils$AnimatorPauseListenerCompat.onAnimationPause(Animator)>
			}
	...
	//*   2    5:icmplt          13
		{
			animator.resume();
	//    3    8:aload_0         
	//    4    9:invokevirtual   #50  <Method void Animator.resume()>
			return;
	//    5   12:return          
		}
		ArrayList arraylist = animator.getListeners();
	...
	//   28   54:checkcast       #6   <Class AnimatorUtils$AnimatorPauseListenerCompat>
	//   29   57:aload_0         
	//   30   58:invokeinterface #53  <Method void AnimatorUtils$AnimatorPauseListenerCompat.onAnimationResume(Animator)>
			}
