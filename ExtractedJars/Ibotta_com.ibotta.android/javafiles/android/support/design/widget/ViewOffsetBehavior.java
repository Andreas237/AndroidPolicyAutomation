...
class ViewOffsetBehavior extends CoordinatorLayout.Behavior
{
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #30  <Method int ViewOffsetHelper.getTopAndBottomOffset()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    1    1:aload_2         
	//    2    2:iload_3         
	//    3    3:invokevirtual   #38  <Method void CoordinatorLayout.onLayoutChild(View, int)>
	//    4    6:return          
	}
	...
	//    2    2:aload_2         
	//    3    3:iload_3         
	//    4    4:invokevirtual   #43  <Method void layoutChild(CoordinatorLayout, View, int)>
		if(viewOffsetHelper == null)
	//*   5    7:aload_0         
	...
	//   10   18:dup             
	//   11   19:aload_2         
	//   12   20:invokespecial   #46  <Method void ViewOffsetHelper(View)>
	...
	//   16   30:invokevirtual   #49  <Method void ViewOffsetHelper.onViewLayout()>
	...
	//   24   46:iload_3         
	//   25   47:invokevirtual   #53  <Method boolean ViewOffsetHelper.setTopAndBottomOffset(int)>
	//   26   50:pop             
			tempTopBottomOffset = 0;
	//   27   51:aload_0         
	//   28   52:iconst_0        
	...
	//   37   69:iload_3         
	//   38   70:invokevirtual   #56  <Method boolean ViewOffsetHelper.setLeftAndRightOffset(int)>
	//   39   73:pop             
			tempLeftRightOffset = 0;
	//   40   74:aload_0         
	//   41   75:iconst_0        
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #53  <Method boolean ViewOffsetHelper.setTopAndBottomOffset(int)>
	//    8   14:ireturn         
		} else
		{
