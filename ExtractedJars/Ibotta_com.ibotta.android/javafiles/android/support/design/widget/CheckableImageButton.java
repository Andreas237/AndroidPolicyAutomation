	...
	implements Checkable
{
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:getstatic       #30  <Field int android.support.v7.appcompat.R$attr.imageButtonStyle>
	//    4    6:invokespecial   #33  <Method void CheckableImageButton(Context, AttributeSet, int)>
	//    5    9:return          
	}
	...
	//    2    2:aload_2         
	//    3    3:iload_3         
	//    4    4:invokespecial   #34  <Method void AppCompatImageButton(Context, AttributeSet, int)>
	...
	//    7   11:dup             
	//    8   12:aload_0         
	//    9   13:invokespecial   #37  <Method void CheckableImageButton$1(CheckableImageButton)>
	//   10   16:invokestatic    #43  <Method void ViewCompat.setAccessibilityDelegate(View, AccessibilityDelegateCompat)>
	//   11   19:return          
	}
	...
	public boolean isChecked()
	{
		return checked;
	//    0    0:aload_0         
	//    1    1:getfield        #47  <Field boolean checked>
	//    2    4:ireturn         
	}
	...
	//    6   12:arraylength     
	//    7   13:iadd            
	//    8   14:invokespecial   #51  <Method int[] AppCompatImageButton.onCreateDrawableState(int)>
	//    9   17:getstatic       #21  <Field int[] DRAWABLE_STATE_CHECKED>
	//   10   20:invokestatic    #55  <Method int[] mergeDrawableStates(int[], int[])>
	//   11   23:areturn         
		else
			return super.onCreateDrawableState(i);
	//   12   24:aload_0         
	//   13   25:iload_1         
	//   14   26:invokespecial   #51  <Method int[] AppCompatImageButton.onCreateDrawableState(int)>
	//   15   29:areturn         
	}
	...
	//    4    8:aload_0         
	//    5    9:iload_1         
	//    6   10:putfield        #47  <Field boolean checked>
			refreshDrawableState();
	//    7   13:aload_0         
	//    8   14:invokevirtual   #60  <Method void refreshDrawableState()>
			sendAccessibilityEvent(2048);
	//    9   17:aload_0         
	//   10   18:sipush          2048
	//   11   21:invokevirtual   #64  <Method void sendAccessibilityEvent(int)>
		}
	//   12   24:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #47  <Field boolean checked>
	//    3    5:iconst_1        
	//    4    6:ixor            
	//    5    7:invokevirtual   #67  <Method void setChecked(boolean)>
	//    6   10:return          
	}
