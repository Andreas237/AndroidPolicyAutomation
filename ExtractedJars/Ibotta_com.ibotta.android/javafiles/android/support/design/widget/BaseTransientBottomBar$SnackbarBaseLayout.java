...
protected static class BaseTransientBottomBar$SnackbarBaseLayout extends FrameLayout
{
	...
	//    7   13:aload_1         
	//    8   14:aload_0         
	//    9   15:invokeinterface #110 <Method void BaseTransientBottomBar$OnAttachStateChangeListener.onViewAttachedToWindow(android.view.View)>
		ViewCompat.requestApplyInsets(((android.view.View) (this)));
	//   10   20:aload_0         
	//   11   21:invokestatic    #113 <Method void ViewCompat.requestApplyInsets(android.view.View)>
	//   12   24:return          
	}
	...
	//    7   13:aload_1         
	//    8   14:aload_0         
	//    9   15:invokeinterface #119 <Method void BaseTransientBottomBar$OnAttachStateChangeListener.onViewDetachedFromWindow(android.view.View)>
	...
	//   16   27:iload           4
	//   17   29:iload           5
	//   18   31:invokeinterface #134 <Method void BaseTransientBottomBar$OnLayoutChangeListener.onLayoutChange(android.view.View, int, int, int, int)>
	//   19   36:return          
	}
	...
	private final android.support.v4.view.accessibility.nStateChangeListener touchExplorationStateChangeListener = new android.support.v4.view.accessibility.AccessibilityManagerCompat.TouchExplorationStateChangeListener() {
...
*/
	...
	//   18   34:i2f             
	//   19   35:invokestatic    #57  <Method void ViewCompat.setElevation(android.view.View, float)>
