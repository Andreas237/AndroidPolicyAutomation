...
;
	...
	public static class LayoutParams extends android.widget.LinearLayout.LayoutParams
	{
		...
		//   28   52:invokestatic    #61  <Method Interpolator android.view.animation.AnimationUtils.loadInterpolator(Context, int)>
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #62  <Method void LinearLayout(Context, AttributeSet)>
		totalScrollRange = -1;
	//    4    6:aload_0         
	//    5    7:iconst_m1       
	//    6    8:putfield        #64  <Field int totalScrollRange>
		downPreScrollRange = -1;
	//    7   11:aload_0         
	//    8   12:iconst_m1       
	//    9   13:putfield        #66  <Field int downPreScrollRange>
		downScrollRange = -1;
	//   10   16:aload_0         
	//   11   17:iconst_m1       
	//   12   18:putfield        #68  <Field int downScrollRange>
		pendingAction = 0;
	//   13   21:aload_0         
	//   14   22:iconst_0        
	//   15   23:putfield        #70  <Field int pendingAction>
		setOrientation(1);
	//   16   26:aload_0         
	//   17   27:iconst_1        
	//   18   28:invokevirtual   #74  <Method void setOrientation(int)>
		if(android.os.Build.VERSION.SDK_INT >= 21)
	//*  19   31:getstatic       #79  <Field int android.os.Build$VERSION.SDK_INT>
	//*  20   34:bipush          21
	//*  21   36:icmplt          52
		{
			ViewUtilsLollipop.setBoundsViewOutlineProvider(((View) (this)));
	//   22   39:aload_0         
	//   23   40:invokestatic    #85  <Method void ViewUtilsLollipop.setBoundsViewOutlineProvider(View)>
	...
	//   25   44:aload_2         
	//   26   45:iconst_0        
	//   27   46:getstatic       #90  <Field int android.support.design.R$style.Widget_Design_AppBarLayout>
	//   28   49:invokestatic    #94  <Method void ViewUtilsLollipop.setStateListAnimatorFromAttrs(View, AttributeSet, int, int)>
		}
	...
	//   29   52:aload_1         
	//   30   53:aload_2         
	//   31   54:getstatic       #99  <Field int[] android.support.design.R$styleable.AppBarLayout>
	//   32   57:iconst_0        
	//   33   58:getstatic       #90  <Field int android.support.design.R$style.Widget_Design_AppBarLayout>
	//   34   61:iconst_0        
	//   35   62:newarray        int[]
	//   36   64:invokestatic    #105 <Method TypedArray ThemeEnforcement.obtainStyledAttributes(Context, AttributeSet, int[], int, int, int[])>
	//   37   67:astore_1        
	...
	//   38   68:aload_0         
	//   39   69:aload_1         
	//   40   70:getstatic       #108 <Field int android.support.design.R$styleable.AppBarLayout_android_background>
	//   41   73:invokevirtual   #114 <Method android.graphics.drawable.Drawable TypedArray.getDrawable(int)>
	//   42   76:invokestatic    #120 <Method void ViewCompat.setBackground(View, android.graphics.drawable.Drawable)>
		if(((TypedArray) (context)).hasValue(android.support.design.R.styleable.AppBarLayout_expanded))
	//*  43   79:aload_1         
	//*  44   80:getstatic       #123 <Field int android.support.design.R$styleable.AppBarLayout_expanded>
	//*  45   83:invokevirtual   #127 <Method boolean TypedArray.hasValue(int)>
	//*  46   86:ifeq            103
			setExpanded(((TypedArray) (context)).getBoolean(android.support.design.R.styleable.AppBarLayout_expanded, false), false, false);
	//   47   89:aload_0         
	//   48   90:aload_1         
	//   49   91:getstatic       #123 <Field int android.support.design.R$styleable.AppBarLayout_expanded>
	//   50   94:iconst_0        
	//   51   95:invokevirtual   #131 <Method boolean TypedArray.getBoolean(int, boolean)>
	//   52   98:iconst_0        
	//   53   99:iconst_0        
	//   54  100:invokespecial   #135 <Method void setExpanded(boolean, boolean, boolean)>
	...
	//*  55  103:getstatic       #79  <Field int android.os.Build$VERSION.SDK_INT>
	//*  56  106:bipush          21
	//*  57  108:icmplt          134
	//*  58  111:aload_1         
	//*  59  112:getstatic       #138 <Field int android.support.design.R$styleable.AppBarLayout_elevation>
	//*  60  115:invokevirtual   #127 <Method boolean TypedArray.hasValue(int)>
	//*  61  118:ifeq            134
	...
	//   62  121:aload_0         
	//   63  122:aload_1         
	//   64  123:getstatic       #138 <Field int android.support.design.R$styleable.AppBarLayout_elevation>
	//   65  126:iconst_0        
	//   66  127:invokevirtual   #142 <Method int TypedArray.getDimensionPixelSize(int, int)>
	//   67  130:i2f             
	//   68  131:invokestatic    #146 <Method void ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(View, float)>
		if(android.os.Build.VERSION.SDK_INT >= 26)
	//*  69  134:getstatic       #79  <Field int android.os.Build$VERSION.SDK_INT>
	//*  70  137:bipush          26
	//*  71  139:icmplt          186
		{
			if(((TypedArray) (context)).hasValue(android.support.design.R.styleable.AppBarLayout_android_keyboardNavigationCluster))
	//*  72  142:aload_1         
	//*  73  143:getstatic       #149 <Field int android.support.design.R$styleable.AppBarLayout_android_keyboardNavigationCluster>
	//*  74  146:invokevirtual   #127 <Method boolean TypedArray.hasValue(int)>
	//*  75  149:ifeq            164
	...
	//   76  152:aload_0         
	//   77  153:aload_1         
	//   78  154:getstatic       #149 <Field int android.support.design.R$styleable.AppBarLayout_android_keyboardNavigationCluster>
	//   79  157:iconst_0        
	//   80  158:invokevirtual   #131 <Method boolean TypedArray.getBoolean(int, boolean)>
	//   81  161:invokevirtual   #153 <Method void setKeyboardNavigationCluster(boolean)>
			if(((TypedArray) (context)).hasValue(android.support.design.R.styleable.AppBarLayout_android_touchscreenBlocksFocus))
	//*  82  164:aload_1         
	//*  83  165:getstatic       #156 <Field int android.support.design.R$styleable.AppBarLayout_android_touchscreenBlocksFocus>
	//*  84  168:invokevirtual   #127 <Method boolean TypedArray.hasValue(int)>
	//*  85  171:ifeq            186
	...
	//   86  174:aload_0         
	//   87  175:aload_1         
	//   88  176:getstatic       #156 <Field int android.support.design.R$styleable.AppBarLayout_android_touchscreenBlocksFocus>
	//   89  179:iconst_0        
	//   90  180:invokevirtual   #131 <Method boolean TypedArray.getBoolean(int, boolean)>
	//   91  183:invokevirtual   #159 <Method void setTouchscreenBlocksFocus(boolean)>
		}
		liftOnScroll = ((TypedArray) (context)).getBoolean(android.support.design.R.styleable.AppBarLayout_liftOnScroll, false);
	//   92  186:aload_0         
	//   93  187:aload_1         
	//   94  188:getstatic       #162 <Field int android.support.design.R$styleable.AppBarLayout_liftOnScroll>
	//   95  191:iconst_0        
	//   96  192:invokevirtual   #131 <Method boolean TypedArray.getBoolean(int, boolean)>
	//   97  195:putfield        #164 <Field boolean liftOnScroll>
		((TypedArray) (context)).recycle();
	//   98  198:aload_1         
	//   99  199:invokevirtual   #168 <Method void TypedArray.recycle()>
	...
	//  102  206:dup             
	//  103  207:aload_0         
	//  104  208:invokespecial   #171 <Method void AppBarLayout$1(AppBarLayout)>
	//  105  211:invokestatic    #175 <Method void ViewCompat.setOnApplyWindowInsetsListener(View, OnApplyWindowInsetsListener)>
	//  106  214:return          
	}
	...
	private boolean hasCollapsibleChild()
	{
		int j = getChildCount();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #182 <Method int getChildCount()>
	//    2    4:istore_2        
		for(int i = 0; i < j; i++)
	//*   3    5:iconst_0        
	//*   4    6:istore_1        
	...
	//*   8   12:aload_0         
	//*   9   13:iload_1         
	//*  10   14:invokevirtual   #186 <Method View getChildAt(int)>
	//*  11   17:invokevirtual   #192 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//*  12   20:checkcast       #27  <Class AppBarLayout$LayoutParams>
	//*  13   23:invokevirtual   #195 <Method boolean AppBarLayout$LayoutParams.isCollapsible()>
	//*  14   26:ifeq            31
				return true;
	//   15   29:iconst_1        
	//   16   30:ireturn         
	...
	//    0    0:aload_0         
	//    1    1:iconst_m1       
	//    2    2:putfield        #64  <Field int totalScrollRange>
		downPreScrollRange = -1;
	//    3    5:aload_0         
	//    4    6:iconst_m1       
	//    5    7:putfield        #66  <Field int downPreScrollRange>
		downScrollRange = -1;
	//    6   10:aload_0         
	//    7   11:iconst_m1       
	//    8   12:putfield        #68  <Field int downScrollRange>
	//    9   15:return          
	}
	...
	//   24   43:iload           6
	//   25   45:ior             
	//   26   46:putfield        #70  <Field int pendingAction>
		requestLayout();
	//   27   49:aload_0         
	//   28   50:invokevirtual   #199 <Method void requestLayout()>
	//   29   53:return          
	}
	...
	private boolean setLiftableState(boolean flag)
	{
		if(liftable != flag)
	//*   0    0:aload_0         
	//*   1    1:getfield        #203 <Field boolean liftable>
	//*   2    4:iload_1         
	//*   3    5:icmpeq          19
		{
			liftable = flag;
	//    4    8:aload_0         
	//    5    9:iload_1         
	//    6   10:putfield        #203 <Field boolean liftable>
			refreshDrawableState();
	//    7   13:aload_0         
	//    8   14:invokevirtual   #206 <Method void refreshDrawableState()>
			return true;
	//    9   17:iconst_1        
	//   10   18:ireturn         
		} else
	...
	public void addOnOffsetChangedListener(BaseOnOffsetChangedListener baseonoffsetchangedlistener)
	{
		if(listeners == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #210 <Field List listeners>
	//*   2    4:ifnonnull       18
			listeners = ((List) (new ArrayList()));
	//    3    7:aload_0         
	//    4    8:new             #212 <Class ArrayList>
	//    5   11:dup             
	//    6   12:invokespecial   #214 <Method void ArrayList()>
	//    7   15:putfield        #210 <Field List listeners>
		if(baseonoffsetchangedlistener != null && !listeners.contains(((Object) (baseonoffsetchangedlistener))))
	//*   8   18:aload_1         
	//*   9   19:ifnull          46
	//*  10   22:aload_0         
	//*  11   23:getfield        #210 <Field List listeners>
	//*  12   26:aload_1         
	//*  13   27:invokeinterface #220 <Method boolean List.contains(Object)>
	//*  14   32:ifne            46
			listeners.add(((Object) (baseonoffsetchangedlistener)));
	//   15   35:aload_0         
	//   16   36:getfield        #210 <Field List listeners>
	//   17   39:aload_1         
	//   18   40:invokeinterface #223 <Method boolean List.add(Object)>
	//   19   45:pop             
	//   20   46:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #226 <Method void addOnOffsetChangedListener(AppBarLayout$BaseOnOffsetChangedListener)>
	//    3    5:return          
	}
	...
	//    0    0:aload_1         
	//    1    1:instanceof      #27  <Class AppBarLayout$LayoutParams>
	//    2    4:ireturn         
	}
	...
	//*   7   13:aload           4
	//*   8   15:invokeinterface #232 <Method int List.size()>
	//*   9   20:istore_3        
	//*  10   21:iload_2         
	//*  11   22:iload_3         
	//*  12   23:icmpge          62
	...
	//   13   26:aload_0         
	//   14   27:getfield        #210 <Field List listeners>
	//   15   30:iload_2         
	//   16   31:invokeinterface #236 <Method Object List.get(int)>
	...
	//   22   48:aload_0         
	//   23   49:iload_1         
	//   24   50:invokeinterface #240 <Method void AppBarLayout$BaseOnOffsetChangedListener.onOffsetChanged(AppBarLayout, int)>
			}
	...
	//    0    0:new             #27  <Class AppBarLayout$LayoutParams>
	//    1    3:dup             
	//    2    4:iconst_m1       
	//    3    5:bipush          -2
	//    4    7:invokespecial   #245 <Method void AppBarLayout$LayoutParams(int, int)>
	//    5   10:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #247 <Method AppBarLayout$LayoutParams generateDefaultLayoutParams()>
	//    2    4:areturn         
	}
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokevirtual   #254 <Method Context getContext()>
	//    4    8:aload_1         
	//    5    9:invokespecial   #255 <Method void AppBarLayout$LayoutParams(Context, AttributeSet)>
	//    6   12:areturn         
	}
	...
	//*   2    5:icmplt          27
	//*   3    8:aload_1         
	//*   4    9:instanceof      #258 <Class android.widget.LinearLayout$LayoutParams>
	//*   5   12:ifeq            27
			return new LayoutParams((android.widget.LinearLayout.LayoutParams)layoutparams);
	//    6   15:new             #27  <Class AppBarLayout$LayoutParams>
	//    7   18:dup             
	//    8   19:aload_1         
	//    9   20:checkcast       #258 <Class android.widget.LinearLayout$LayoutParams>
	//   10   23:invokespecial   #261 <Method void AppBarLayout$LayoutParams(android.widget.LinearLayout$LayoutParams)>
	//   11   26:areturn         
		if(layoutparams instanceof android.view.ViewGroup.MarginLayoutParams)
	//*  12   27:aload_1         
	//*  13   28:instanceof      #263 <Class android.view.ViewGroup$MarginLayoutParams>
	//*  14   31:ifeq            46
			return new LayoutParams((android.view.ViewGroup.MarginLayoutParams)layoutparams);
	//   15   34:new             #27  <Class AppBarLayout$LayoutParams>
	//   16   37:dup             
	//   17   38:aload_1         
	//   18   39:checkcast       #263 <Class android.view.ViewGroup$MarginLayoutParams>
	//   19   42:invokespecial   #266 <Method void AppBarLayout$LayoutParams(android.view.ViewGroup$MarginLayoutParams)>
	//   20   45:areturn         
		else
			return new LayoutParams(layoutparams);
	//   21   46:new             #27  <Class AppBarLayout$LayoutParams>
	//   22   49:dup             
	//   23   50:aload_1         
	//   24   51:invokespecial   #269 <Method void AppBarLayout$LayoutParams(android.view.ViewGroup$LayoutParams)>
	//   25   54:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #272 <Method AppBarLayout$LayoutParams generateLayoutParams(AttributeSet)>
	//    3    5:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #275 <Method AppBarLayout$LayoutParams generateLayoutParams(android.view.ViewGroup$LayoutParams)>
	//    3    5:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #66  <Field int downPreScrollRange>
	//    2    4:istore_1        
		if(i != -1)
	//*   3    5:iload_1         
	//*   4    6:iconst_m1       
	...
	//    8   12:aload_0         
	//    9   13:invokevirtual   #182 <Method int getChildCount()>
	//   10   16:iconst_1        
	//   11   17:isub            
	//   12   18:istore_2        
		int k;
	...
	//   17   25:aload_0         
	//   18   26:iload_2         
	//   19   27:invokevirtual   #186 <Method View getChildAt(int)>
	//   20   30:astore          5
			LayoutParams layoutparams = (LayoutParams)view.getLayoutParams();
	//   21   32:aload           5
	//   22   34:invokevirtual   #192 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   23   37:checkcast       #27  <Class AppBarLayout$LayoutParams>
	//   24   40:astore          6
			i = view.getMeasuredHeight();
	//   25   42:aload           5
	//   26   44:invokevirtual   #281 <Method int View.getMeasuredHeight()>
	//   27   47:istore_1        
			int l = layoutparams.scrollFlags;
	//   28   48:aload           6
	//   29   50:getfield        #284 <Field int AppBarLayout$LayoutParams.scrollFlags>
	//   30   53:istore          4
			if((l & 5) == 5)
	//*  31   55:iload           4
	//*  32   57:iconst_5        
	...
	//   36   63:iload_3         
	//   37   64:aload           6
	//   38   66:getfield        #287 <Field int AppBarLayout$LayoutParams.topMargin>
	//   39   69:aload           6
	//   40   71:getfield        #290 <Field int AppBarLayout$LayoutParams.bottomMargin>
	//   41   74:iadd            
	//   42   75:iadd            
	//   43   76:istore_3        
				if((l & 8) != 0)
	...
	//   48   85:iload_3         
	//   49   86:aload           5
	//   50   88:invokestatic    #294 <Method int ViewCompat.getMinimumHeight(View)>
	//   51   91:iadd            
	//   52   92:istore_1        
				else
	//*  53   93:goto            137
	...
	//   59  104:iload_1         
	//   60  105:aload           5
	//   61  107:invokestatic    #294 <Method int ViewCompat.getMinimumHeight(View)>
	//   62  110:isub            
	//   63  111:iadd            
	//   64  112:istore_1        
				else
	...
	//   67  117:iload_1         
	//   68  118:aload_0         
	//   69  119:invokevirtual   #297 <Method int getTopInset()>
	//   70  122:isub            
	//   71  123:iadd            
	//   72  124:istore_1        
			} else
	...
	//   86  146:iconst_0        
	//   87  147:iload_3         
	//   88  148:invokestatic    #302 <Method int Math.max(int, int)>
	//   89  151:istore_1        
		downPreScrollRange = i;
	//   90  152:aload_0         
	//   91  153:iload_1         
	//   92  154:putfield        #66  <Field int downPreScrollRange>
		return i;
	//   93  157:iload_1         
	//   94  158:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #68  <Field int downScrollRange>
	//    2    4:istore_1        
		if(i != -1)
	//*   3    5:iload_1         
	//*   4    6:iconst_m1       
	...
	//   20   30:aload_0         
	//   21   31:iload_2         
	//   22   32:invokevirtual   #186 <Method View getChildAt(int)>
	//   23   35:astore          9
			LayoutParams layoutparams = (LayoutParams)view.getLayoutParams();
	//   24   37:aload           9
	//   25   39:invokevirtual   #192 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   26   42:checkcast       #27  <Class AppBarLayout$LayoutParams>
	//   27   45:astore          10
			int j1 = view.getMeasuredHeight();
	//   28   47:aload           9
	//   29   49:invokevirtual   #281 <Method int View.getMeasuredHeight()>
	//   30   52:istore          6
			int k1 = layoutparams.topMargin;
	//   31   54:aload           10
	//   32   56:getfield        #287 <Field int AppBarLayout$LayoutParams.topMargin>
	//   33   59:istore          7
			int l1 = layoutparams.bottomMargin;
	//   34   61:aload           10
	//   35   63:getfield        #290 <Field int AppBarLayout$LayoutParams.bottomMargin>
	//   36   66:istore          8
			int i1 = layoutparams.scrollFlags;
	//   37   68:aload           10
	//   38   70:getfield        #284 <Field int AppBarLayout$LayoutParams.scrollFlags>
	//   39   73:istore          5
			k = i;
	//   40   75:iload_1         
	//   41   76:istore_3        
	...
	//   58  102:iload_1         
	//   59  103:aload           9
	//   60  105:invokestatic    #294 <Method int ViewCompat.getMinimumHeight(View)>
	//   61  108:aload_0         
	//   62  109:invokevirtual   #297 <Method int getTopInset()>
	//   63  112:iadd            
	//   64  113:isub            
	//   65  114:istore_3        
				break;
	...
	//   72  125:iconst_0        
	//   73  126:iload_3         
	//   74  127:invokestatic    #302 <Method int Math.max(int, int)>
	//   75  130:istore_1        
		downScrollRange = i;
	//   76  131:aload_0         
	//   77  132:iload_1         
	//   78  133:putfield        #68  <Field int downScrollRange>
		return i;
	//   79  136:iload_1         
	//   80  137:ireturn         
	}
	...
	public final int getMinimumHeightForVisibleOverlappingContent()
	{
		int j = getTopInset();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #297 <Method int getTopInset()>
	//    2    4:istore_2        
		int i = ViewCompat.getMinimumHeight(((View) (this)));
	//    3    5:aload_0         
	//    4    6:invokestatic    #294 <Method int ViewCompat.getMinimumHeight(View)>
	//    5    9:istore_1        
		if(i != 0)
	//*   6   10:iload_1         
	//*   7   11:ifeq            20
	...
	//   13   19:ireturn         
		i = getChildCount();
	//   14   20:aload_0         
	//   15   21:invokevirtual   #182 <Method int getChildCount()>
	//   16   24:istore_1        
		if(i >= 1)
	//*  17   25:iload_1         
	//*  18   26:iconst_1        
	...
	//   22   32:iconst_1        
	//   23   33:isub            
	//   24   34:invokevirtual   #186 <Method View getChildAt(int)>
	//   25   37:invokestatic    #294 <Method int ViewCompat.getMinimumHeight(View)>
	//   26   40:istore_1        
		else
	//*  27   41:goto            46
			i = 0;
	...
	//   37   55:ireturn         
			...
			return getHeight() / 3;
	//   38   56:aload_0         
	//   39   57:invokevirtual   #307 <Method int getHeight()>
	//   40   60:iconst_3        
	//   41   61:idiv            
	//   42   62:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field int pendingAction>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #315 <Field WindowInsetsCompat lastInsets>
	//    2    4:astore_1        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #320 <Method int WindowInsetsCompat.getSystemWindowInsetTop()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:getfield        #64  <Field int totalScrollRange>
	//    2    4:istore_1        
		if(i != -1)
	//*   3    5:iload_1         
	//*   4    6:iconst_m1       
	...
	//   30   52:istore          6
			int i1 = layoutparams.scrollFlags;
	//   31   54:aload           8
	//   32   56:getfield        #284 <Field int AppBarLayout$LayoutParams.scrollFlags>
	//   33   59:istore          5
			k = i;
	//   34   61:iload_1         
	//   35   62:istore_3        
	...
	//   41   71:iload           6
	//   42   73:aload           8
	//   43   75:getfield        #287 <Field int AppBarLayout$LayoutParams.topMargin>
	//   44   78:iadd            
	//   45   79:aload           8
	//   46   81:getfield        #290 <Field int AppBarLayout$LayoutParams.bottomMargin>
	//   47   84:iadd            
	//   48   85:iadd            
	//   49   86:istore_1        
			if((i1 & 2) != 0)
	...
	//   54   94:iload_1         
	//   55   95:aload           7
	//   56   97:invokestatic    #294 <Method int ViewCompat.getMinimumHeight(View)>
	//   57  100:isub            
	//   58  101:istore_3        
				break;
	//   59  102:goto            112
	...
	//   66  113:iload_3         
	//   67  114:aload_0         
	//   68  115:invokevirtual   #297 <Method int getTopInset()>
	//   69  118:isub            
	//   70  119:invokestatic    #302 <Method int Math.max(int, int)>
	//   71  122:istore_1        
		totalScrollRange = i;
	//   72  123:aload_0         
	//   73  124:iload_1         
	//   74  125:putfield        #64  <Field int totalScrollRange>
		return i;
	//   75  128:iload_1         
	//   76  129:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #325 <Method int getTotalScrollRange()>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #328 <Field boolean haveChildWithInterpolator>
	//    2    4:ireturn         
	}
	...
	public boolean isLiftOnScroll()
	{
		return liftOnScroll;
	//    0    0:aload_0         
	//    1    1:getfield        #164 <Field boolean liftOnScroll>
	//    2    4:ireturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #334 <Field int[] tmpStatesArray>
	//*   2    4:ifnonnull       14
			tmpStatesArray = new int[4];
	//    3    7:aload_0         
	//    4    8:iconst_4        
	//    5    9:newarray        int[]
	//    6   11:putfield        #334 <Field int[] tmpStatesArray>
		int ai[] = tmpStatesArray;
	//    7   14:aload_0         
	//    8   15:getfield        #334 <Field int[] tmpStatesArray>
	//    9   18:astore_2        
	...
	//   13   22:arraylength     
	//   14   23:iadd            
	//   15   24:invokespecial   #336 <Method int[] LinearLayout.onCreateDrawableState(int)>
	//   16   27:astore_3        
		if(liftable)
	//*  17   28:aload_0         
	//*  18   29:getfield        #203 <Field boolean liftable>
	//*  19   32:ifeq            42
			i = android.support.design.R.attr.state_liftable;
	//   20   35:getstatic       #341 <Field int android.support.design.R$attr.state_liftable>
	//   21   38:istore_1        
		else
	//*  22   39:goto            47
			i = -android.support.design.R.attr.state_liftable;
	//   23   42:getstatic       #341 <Field int android.support.design.R$attr.state_liftable>
	//   24   45:ineg            
	//   25   46:istore_1        
		ai[0] = i;
	//   26   47:aload_2         
	...
	//   29   50:iastore         
		if(liftable && lifted)
	//*  30   51:aload_0         
	//*  31   52:getfield        #203 <Field boolean liftable>
	//*  32   55:ifeq            72
	//*  33   58:aload_0         
	//*  34   59:getfield        #343 <Field boolean lifted>
	//*  35   62:ifeq            72
			i = android.support.design.R.attr.state_lifted;
	//   36   65:getstatic       #346 <Field int android.support.design.R$attr.state_lifted>
	//   37   68:istore_1        
		else
	//*  38   69:goto            77
			i = -android.support.design.R.attr.state_lifted;
	//   39   72:getstatic       #346 <Field int android.support.design.R$attr.state_lifted>
	//   40   75:ineg            
	//   41   76:istore_1        
		ai[1] = i;
	//   42   77:aload_2         
	...
	//   45   80:iastore         
		if(liftable)
	//*  46   81:aload_0         
	//*  47   82:getfield        #203 <Field boolean liftable>
	//*  48   85:ifeq            95
			i = android.support.design.R.attr.state_collapsible;
	//   49   88:getstatic       #349 <Field int android.support.design.R$attr.state_collapsible>
	//   50   91:istore_1        
		else
	//*  51   92:goto            100
			i = -android.support.design.R.attr.state_collapsible;
	//   52   95:getstatic       #349 <Field int android.support.design.R$attr.state_collapsible>
	//   53   98:ineg            
	//   54   99:istore_1        
		ai[2] = i;
	//   55  100:aload_2         
	...
	//   58  103:iastore         
		if(liftable && lifted)
	//*  59  104:aload_0         
	//*  60  105:getfield        #203 <Field boolean liftable>
	//*  61  108:ifeq            125
	//*  62  111:aload_0         
	//*  63  112:getfield        #343 <Field boolean lifted>
	//*  64  115:ifeq            125
			i = android.support.design.R.attr.state_collapsed;
	//   65  118:getstatic       #352 <Field int android.support.design.R$attr.state_collapsed>
	//   66  121:istore_1        
		else
	//*  67  122:goto            130
			i = -android.support.design.R.attr.state_collapsed;
	//   68  125:getstatic       #352 <Field int android.support.design.R$attr.state_collapsed>
	//   69  128:ineg            
	//   70  129:istore_1        
		ai[3] = i;
	//   71  130:aload_2         
	...
	//   75  134:aload_3         
	//   76  135:aload_2         
	//   77  136:invokestatic    #356 <Method int[] mergeDrawableStates(int[], int[])>
	//   78  139:areturn         
	}
	...
	//    4    4:iload           4
	//    5    6:iload           5
	//    6    8:invokespecial   #360 <Method void LinearLayout.onLayout(boolean, int, int, int, int)>
		invalidateScrollRanges();
	//    7   11:aload_0         
	//    8   12:invokespecial   #362 <Method void invalidateScrollRanges()>
		flag = false;
	//    9   15:iconst_0        
	//   10   16:istore_1        
	...
	//   11   17:aload_0         
	//   12   18:iconst_0        
	//   13   19:putfield        #328 <Field boolean haveChildWithInterpolator>
		j = getChildCount();
	//   14   22:aload_0         
	//   15   23:invokevirtual   #182 <Method int getChildCount()>
	//   16   26:istore_3        
		i = 0;
	//   17   27:iconst_0        
	//   18   28:istore_2        
	...
	//*  22   34:aload_0         
	//*  23   35:iload_2         
	//*  24   36:invokevirtual   #186 <Method View getChildAt(int)>
	//*  25   39:invokevirtual   #192 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//*  26   42:checkcast       #27  <Class AppBarLayout$LayoutParams>
	//*  27   45:invokevirtual   #366 <Method Interpolator AppBarLayout$LayoutParams.getScrollInterpolator()>
	//*  28   48:ifnull          59
			{
				haveChildWithInterpolator = true;
	//   29   51:aload_0         
	//   30   52:iconst_1        
	//   31   53:putfield        #328 <Field boolean haveChildWithInterpolator>
				break;
	//   32   56:goto            66
			}
			i++;
	...
	//   37   63:goto            29
		if(!liftableOverride)
	//*  38   66:aload_0         
	//*  39   67:getfield        #368 <Field boolean liftableOverride>
	//*  40   70:ifne            95
		{
			if(liftOnScroll || hasCollapsibleChild())
	//*  41   73:aload_0         
	//*  42   74:getfield        #164 <Field boolean liftOnScroll>
	//*  43   77:ifne            87
	//*  44   80:aload_0         
	//*  45   81:invokespecial   #370 <Method boolean hasCollapsibleChild()>
	//*  46   84:ifeq            89
				flag = true;
	//   47   87:iconst_1        
	//   48   88:istore_1        
	...
	//   49   89:aload_0         
	//   50   90:iload_1         
	//   51   91:invokespecial   #372 <Method boolean setLiftableState(boolean)>
	//   52   94:pop             
		}
	//   53   95:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #375 <Method void LinearLayout.onMeasure(int, int)>
		invalidateScrollRanges();
	//    4    6:aload_0         
	//    5    7:invokespecial   #362 <Method void invalidateScrollRanges()>
	//    6   10:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:invokestatic    #381 <Method boolean ViewCompat.getFitsSystemWindows(View)>
	//*   2    4:ifeq            12
	...
	//*   8   14:aload_0         
	//*   9   15:getfield        #315 <Field WindowInsetsCompat lastInsets>
	//*  10   18:aload_2         
	//*  11   19:invokestatic    #387 <Method boolean ObjectsCompat.equals(Object, Object)>
	//*  12   22:ifne            34
		{
			lastInsets = windowinsetscompat1;
	//   13   25:aload_0         
	//   14   26:aload_2         
	//   15   27:putfield        #315 <Field WindowInsetsCompat lastInsets>
			invalidateScrollRanges();
	//   16   30:aload_0         
	//   17   31:invokespecial   #362 <Method void invalidateScrollRanges()>
		}
	...
	//    7   13:aload_2         
	//    8   14:aload_1         
	//    9   15:invokeinterface #391 <Method boolean List.remove(Object)>
	//   10   20:pop             
	//   11   21:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #393 <Method void removeOnOffsetChangedListener(AppBarLayout$BaseOnOffsetChangedListener)>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:putfield        #70  <Field int pendingAction>
	//    3    5:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:aload_0         
	//    3    3:invokestatic    #397 <Method boolean ViewCompat.isLaidOut(View)>
	//    4    6:invokevirtual   #400 <Method void setExpanded(boolean, boolean)>
	//    5    9:return          
	}
	...
	//    2    2:iload_2         
	//    3    3:iconst_1        
	//    4    4:invokespecial   #135 <Method void setExpanded(boolean, boolean, boolean)>
	//    5    7:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #164 <Field boolean liftOnScroll>
	//    3    5:return          
	}
	...
	boolean setLiftedState(boolean flag)
	{
		if(lifted != flag)
	//*   0    0:aload_0         
	//*   1    1:getfield        #343 <Field boolean lifted>
	//*   2    4:iload_1         
	//*   3    5:icmpeq          19
		{
			lifted = flag;
	//    4    8:aload_0         
	//    5    9:iload_1         
	//    6   10:putfield        #343 <Field boolean lifted>
			refreshDrawableState();
	//    7   13:aload_0         
	//    8   14:invokevirtual   #206 <Method void refreshDrawableState()>
			return true;
	...
	//    3    5:aload_0         
	//    4    6:iload_1         
	//    5    7:invokespecial   #403 <Method void LinearLayout.setOrientation(int)>
			return;
	//    6   10:return          
		} else
		{
			throw new IllegalArgumentException("AppBarLayout is always vertical and does not support horizontal orientation");
	//    7   11:new             #405 <Class IllegalArgumentException>
	//    8   14:dup             
	//    9   15:ldc2            #407 <String "AppBarLayout is always vertical and does not support horizontal orientation">
	//   10   18:invokespecial   #410 <Method void IllegalArgumentException(String)>
	//   11   21:athrow          
		}
	}
	...
	//    3    8:aload_0         
	//    4    9:fload_1         
	//    5   10:invokestatic    #146 <Method void ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(View, float)>
	//    6   13:return          
	}
