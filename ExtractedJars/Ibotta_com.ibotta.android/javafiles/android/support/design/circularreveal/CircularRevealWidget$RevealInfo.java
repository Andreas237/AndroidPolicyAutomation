...
public static class CircularRevealWidget$RevealInfo
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field float radius>
	//    2    4:ldc1            #31  <Float 3.402823E+38F>
	//    3    6:fcmpl           
	//    4    7:ifne            12
	//    5   10:iconst_1        
	//    6   11:ireturn         
	...
	//    0    0:aload_0         
	//    1    1:fload_1         
	//    2    2:putfield        #19  <Field float centerX>
		centerY = f1;
	//    3    5:aload_0         
	//    4    6:fload_2         
	//    5    7:putfield        #21  <Field float centerY>
		radius = f2;
	//    6   10:aload_0         
	//    7   11:fload_3         
	//    8   12:putfield        #23  <Field float radius>
	//    9   15:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:getfield        #19  <Field float centerX>
	//    3    5:aload_1         
	//    4    6:getfield        #21  <Field float centerY>
	//    5    9:aload_1         
	//    6   10:getfield        #23  <Field float radius>
	//    7   13:invokevirtual   #34  <Method void set(float, float, float)>
	//    8   16:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:fload_1         
	//    4    6:putfield        #19  <Field float centerX>
		centerY = f1;
	//    5    9:aload_0         
	//    6   10:fload_2         
	//    7   11:putfield        #21  <Field float centerY>
		radius = f2;
	//    8   14:aload_0         
	//    9   15:fload_3         
	//   10   16:putfield        #23  <Field float radius>
	//   11   19:return          
	}
	...
	CircularRevealWidget$RevealInfo(CircularRevealWidget._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #25  <Method void CircularRevealWidget$RevealInfo()>
	//    2    4:return          
	}
	...
	//    5    9:aload_1         
	//    6   10:getfield        #23  <Field float radius>
	//    7   13:invokespecial   #28  <Method void CircularRevealWidget$RevealInfo(float, float, float)>
	//    8   16:return          
	}
}
