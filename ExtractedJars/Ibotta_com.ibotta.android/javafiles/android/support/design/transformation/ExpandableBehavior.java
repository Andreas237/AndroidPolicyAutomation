...
public abstract class ExpandableBehavior extends android.support.design.widget.CoordinatorLayout.Behavior
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #13  <Method void android.support.design.widget.CoordinatorLayout$Behavior()>
		currentState = 0;
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:putfield        #15  <Field int currentState>
	//    5    9:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #19  <Method void android.support.design.widget.CoordinatorLayout$Behavior(Context, AttributeSet)>
		currentState = 0;
	//    4    6:aload_0         
	//    5    7:iconst_0        
	//    6    8:putfield        #15  <Field int currentState>
	//    7   11:return          
	}
...
label1:
	...
	//    5    6:ifeq            29
				int i = currentState;
	//    6    9:aload_0         
	//    7   10:getfield        #15  <Field int currentState>
	//    8   13:istore_2        
				if(i != 0)
	//*   9   14:iload_2         
	//*  10   15:ifeq            25
	...
	//   21   31:istore_1        
		if(currentState == 1)
	//*  22   32:aload_0         
	//*  23   33:getfield        #15  <Field int currentState>
	//*  24   36:iconst_1        
	//*  25   37:icmpne          42
			flag = true;
	//   26   40:iconst_1        
	...
	//    0    0:aload_1         
	//    1    1:aload_2         
	//    2    2:invokevirtual   #32  <Method List CoordinatorLayout.getDependencies(View)>
	//    3    5:astore          5
		int j = list.size();
	//    4    7:aload           5
	//    5    9:invokeinterface #38  <Method int List.size()>
	//    6   14:istore          4
		for(int i = 0; i < j; i++)
	//*   7   16:iconst_0        
	//*   8   17:istore_3        
	...
	//   12   24:aload           5
	//   13   26:iload_3         
	//   14   27:invokeinterface #42  <Method Object List.get(int)>
	//   15   32:checkcast       #44  <Class View>
	//   16   35:astore          6
	...
	//*  19   39:aload_2         
	//*  20   40:aload           6
	//*  21   42:invokevirtual   #48  <Method boolean layoutDependsOn(CoordinatorLayout, View, View)>
	//*  22   45:ifeq            54
				return (ExpandableWidget)view1;
	//   23   48:aload           6
	//   24   50:checkcast       #50  <Class ExpandableWidget>
	//   25   53:areturn         
		}
	...
	//    0    0:aload_3         
	//    1    1:checkcast       #50  <Class ExpandableWidget>
	//    2    4:astore_1        
		if(didStateChange(((ExpandableWidget) (coordinatorlayout)).isExpanded()))
	//*   3    5:aload_0         
	//*   4    6:aload_1         
	//*   5    7:invokeinterface #57  <Method boolean ExpandableWidget.isExpanded()>
	//*   6   12:invokespecial   #59  <Method boolean didStateChange(boolean)>
	//*   7   15:ifeq            59
		{
			int i;
			if(((ExpandableWidget) (coordinatorlayout)).isExpanded())
	//*   8   18:aload_1         
	//*   9   19:invokeinterface #57  <Method boolean ExpandableWidget.isExpanded()>
	//*  10   24:ifeq            33
				i = 1;
	//   11   27:iconst_1        
	//   12   28:istore          4
	...
	//   16   36:aload_0         
	//   17   37:iload           4
	//   18   39:putfield        #15  <Field int currentState>
			return onExpandedStateChange((View)coordinatorlayout, view, ((ExpandableWidget) (coordinatorlayout)).isExpanded(), true);
	//   19   42:aload_0         
	//   20   43:aload_1         
	//   21   44:checkcast       #44  <Class View>
	//   22   47:aload_2         
	//   23   48:aload_1         
	//   24   49:invokeinterface #57  <Method boolean ExpandableWidget.isExpanded()>
	//   25   54:iconst_1        
	//   26   55:invokevirtual   #63  <Method boolean onExpandedStateChange(View, View, boolean, boolean)>
	//   27   58:ireturn         
		} else
		{
			return false;
	...
	//*   0    0:aload_2         
	//*   1    1:invokestatic    #71  <Method boolean ViewCompat.isLaidOut(View)>
	//*   2    4:ifne            75
		{
	...
	//    4    8:aload_1         
	//    5    9:aload_2         
	//    6   10:invokevirtual   #73  <Method ExpandableWidget findExpandableWidget(CoordinatorLayout, View)>
	//    7   13:astore_1        
	...
	//*  10   18:aload_0         
	//*  11   19:aload_1         
	//*  12   20:invokeinterface #57  <Method boolean ExpandableWidget.isExpanded()>
	//*  13   25:invokespecial   #59  <Method boolean didStateChange(boolean)>
	//*  14   28:ifeq            75
			{
				if(((ExpandableWidget) (dep)).isExpanded())
	//*  15   31:aload_1         
	//*  16   32:invokeinterface #57  <Method boolean ExpandableWidget.isExpanded()>
	//*  17   37:ifeq            45
					expectedState = 1;
	//   18   40:iconst_1        
	//   19   41:istore_3        
	...
	//   23   47:aload_0         
	//   24   48:iload_3         
	//   25   49:putfield        #15  <Field int currentState>
				expectedState = currentState;
	//   26   52:aload_0         
	//   27   53:getfield        #15  <Field int currentState>
	//   28   56:istore_3        
	...
	//   29   57:aload_2         
	//   30   58:invokevirtual   #77  <Method ViewTreeObserver View.getViewTreeObserver()>
	...
	//   35   67:iload_3         
	//   36   68:aload_1         
	//   37   69:invokespecial   #80  <Method void ExpandableBehavior$1(ExpandableBehavior, View, int, ExpandableWidget)>
	//   38   72:invokevirtual   #86  <Method void ViewTreeObserver.addOnPreDrawListener(android.view.ViewTreeObserver$OnPreDrawListener)>
			}
		}
		return false;
	//   39   75:iconst_0        
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field int currentState>
	//    2    4:ireturn         
	}
