...
public class ContextThemeWrapper extends ContextWrapper
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #77  <Method void ContextWrapper.attachBaseContext(Context)>
	//    3    5:return          
	}
	...
	//    2    4:invokevirtual   #81  <Method AssetManager Resources.getAssets()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #83  <Method Resources getResourcesInternal()>
	//    2    4:areturn         
	}
	...
	//*   0    0:ldc1            #87  <String "layout_inflater">
	//*   1    2:aload_1         
	//*   2    3:invokevirtual   #93  <Method boolean String.equals(Object)>
	//*   3    6:ifeq            36
		{
			if(mInflater == null)
	//*   4    9:aload_0         
	//*   5   10:getfield        #95  <Field LayoutInflater mInflater>
	//*   6   13:ifnonnull       31
	...
	//   10   21:invokestatic    #101 <Method LayoutInflater LayoutInflater.from(Context)>
	//   11   24:aload_0         
	//   12   25:invokevirtual   #104 <Method LayoutInflater LayoutInflater.cloneInContext(Context)>
	//   13   28:putfield        #95  <Field LayoutInflater mInflater>
			return ((Object) (mInflater));
	//   14   31:aload_0         
	//   15   32:getfield        #95  <Field LayoutInflater mInflater>
	//   16   35:areturn         
		} else
		{
	...
	//   19   40:aload_1         
	//   20   41:invokevirtual   #106 <Method Object Context.getSystemService(String)>
	//   21   44:areturn         
		}
	}
	...
	//   10   18:aload_0         
	//   11   19:getstatic       #111 <Field int android.support.v7.appcompat.R$style.Theme_AppCompat_Light>
	//   12   22:putfield        #24  <Field int mThemeResource>
		initializeTheme();
	//   13   25:aload_0         
	//   14   26:invokespecial   #113 <Method void initializeTheme()>
		return mTheme;
	//   15   29:aload_0         
	...
	//    1    1:iload_2         
	//    2    2:iconst_1        
	//    3    3:invokevirtual   #119 <Method void android.content.res.Resources$Theme.applyStyle(int, boolean)>
	//    4    6:return          
	}
	...
	//    6   10:putfield        #24  <Field int mThemeResource>
			initializeTheme();
	//    7   13:aload_0         
	//    8   14:invokespecial   #113 <Method void initializeTheme()>
		}
	//    9   17:return          
	}
