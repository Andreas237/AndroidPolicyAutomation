...
public class SupportMenuInflater extends MenuInflater
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #40  <Method void MenuInflater(Context)>
		mContext = context;
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:putfield        #42  <Field Context mContext>
	...
	//   11   17:aload_1         
	//   12   18:aastore         
	//   13   19:putfield        #46  <Field Object[] mActionViewConstructorArguments>
		mActionProviderConstructorArguments = mActionViewConstructorArguments;
	//   14   22:aload_0         
	//   15   23:aload_0         
	//   16   24:getfield        #46  <Field Object[] mActionViewConstructorArguments>
	//   17   27:putfield        #48  <Field Object[] mActionProviderConstructorArguments>
	//   18   30:return          
	}
	...
	//*   0    0:aload_1         
	//*   1    1:instanceof      #52  <Class Activity>
	//*   2    4:ifeq            9
			return obj;
	//    3    7:aload_1         
	//    4    8:areturn         
	...
	//*   5    9:aload_1         
	//*   6   10:instanceof      #54  <Class ContextWrapper>
	//*   7   13:ifeq            28
			return findRealOwner(((Object) (((ContextWrapper)obj).getBaseContext())));
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:checkcast       #54  <Class ContextWrapper>
	//   11   21:invokevirtual   #58  <Method Context ContextWrapper.getBaseContext()>
	//   12   24:invokespecial   #60  <Method Object findRealOwner(Object)>
	//   13   27:areturn         
		else
			return obj;
	//   14   28:aload_1         
	...
	//    2    4:aload_0         
	//    3    5:aload_3         
	//    4    6:invokespecial   #69  <Method void SupportMenuInflater$MenuState(SupportMenuInflater, Menu)>
	//    5    9:astore          10
		int i = xmlpullparser.getEventType();
	//    6   11:aload_1         
	//    7   12:invokeinterface #75  <Method int XmlPullParser.getEventType()>
	//    8   17:istore          4
		do
		{
			if(i == 2)
	...
	//   12   25:aload_1         
	//   13   26:invokeinterface #79  <Method String XmlPullParser.getName()>
	//   14   31:astore_3        
				if(((String) (menu)).equals("menu"))
	//*  15   32:aload_3         
	//*  16   33:ldc1            #81  <String "menu">
	//*  17   35:invokevirtual   #87  <Method boolean String.equals(Object)>
	//*  18   38:ifeq            52
				{
					i = xmlpullparser.next();
	//   19   41:aload_1         
	//   20   42:invokeinterface #90  <Method int XmlPullParser.next()>
	//   21   47:istore          4
				} else
	//*  22   49:goto            107
				{
					xmlpullparser = ((XmlPullParser) (new StringBuilder()));
	//   23   52:new             #92  <Class StringBuilder>
	//   24   55:dup             
	//   25   56:invokespecial   #94  <Method void StringBuilder()>
	//   26   59:astore_1        
					((StringBuilder) (xmlpullparser)).append("Expecting menu, got ");
	//   27   60:aload_1         
	//   28   61:ldc1            #96  <String "Expecting menu, got ">
	//   29   63:invokevirtual   #100 <Method StringBuilder StringBuilder.append(String)>
	//   30   66:pop             
					((StringBuilder) (xmlpullparser)).append(((String) (menu)));
	//   31   67:aload_1         
	//   32   68:aload_3         
	//   33   69:invokevirtual   #100 <Method StringBuilder StringBuilder.append(String)>
	//   34   72:pop             
					throw new RuntimeException(((StringBuilder) (xmlpullparser)).toString());
	//   35   73:new             #102 <Class RuntimeException>
	//   36   76:dup             
	//   37   77:aload_1         
	//   38   78:invokevirtual   #105 <Method String StringBuilder.toString()>
	//   39   81:invokespecial   #108 <Method void RuntimeException(String)>
	//   40   84:athrow          
				}
				break;
			}
	...
	//   41   85:aload_1         
	//   42   86:invokeinterface #90  <Method int XmlPullParser.next()>
	//   43   91:istore          5
			i = j;
	//   44   93:iload           5
	//   45   95:istore          4
	...
	//   70  166:aload_1         
	//   71  167:invokeinterface #79  <Method String XmlPullParser.getName()>
	//   72  172:astore          11
	...
	//*  75  179:aload           11
	//*  76  181:aload           9
	//*  77  183:invokevirtual   #87  <Method boolean String.equals(Object)>
	//*  78  186:ifeq            201
				{
					menu = null;
	//   79  189:aconst_null     
	...
	//   85  198:goto            489
				...
				if(s.equals("group"))
	//*  86  201:aload           11
	//*  87  203:ldc1            #110 <String "group">
	//*  88  205:invokevirtual   #87  <Method boolean String.equals(Object)>
	//*  89  208:ifeq            230
				{
					menustate.resetGroup();
	//   90  211:aload           10
	//   91  213:invokevirtual   #113 <Method void SupportMenuInflater$MenuState.resetGroup()>
					flag = flag2;
	//   92  216:iload           6
	//   93  218:istore          4
					menu = menu1;
	...
	//   98  227:goto            489
				...
				if(s.equals("item"))
	//*  99  230:aload           11
	//* 100  232:ldc1            #115 <String "item">
	//* 101  234:invokevirtual   #87  <Method boolean String.equals(Object)>
	//* 102  237:ifeq            317
				{
					flag = flag2;
	//  103  240:iload           6
	...
	//  108  249:istore          7
					if(menustate.hasAddedItem())
						break;
	//  109  251:aload           10
	//  110  253:invokevirtual   #119 <Method boolean SupportMenuInflater$MenuState.hasAddedItem()>
	//  111  256:ifne            489
					if(menustate.itemActionProvider != null && menustate.itemActionProvider.hasSubMenu())
	//* 112  259:aload           10
	//* 113  261:getfield        #123 <Field ActionProvider SupportMenuInflater$MenuState.itemActionProvider>
	//* 114  264:ifnull          298
	//* 115  267:aload           10
	//* 116  269:getfield        #123 <Field ActionProvider SupportMenuInflater$MenuState.itemActionProvider>
	//* 117  272:invokevirtual   #128 <Method boolean ActionProvider.hasSubMenu()>
	//* 118  275:ifeq            298
					{
						menustate.addSubMenuItem();
	//  119  278:aload           10
	//  120  280:invokevirtual   #132 <Method SubMenu SupportMenuInflater$MenuState.addSubMenuItem()>
	//  121  283:pop             
						flag = flag2;
	//  122  284:iload           6
	//  123  286:istore          4
	...
	//* 128  295:goto            489
					{
						menustate.addItem();
	//  129  298:aload           10
	//  130  300:invokevirtual   #135 <Method void SupportMenuInflater$MenuState.addItem()>
						flag = flag2;
	//  131  303:iload           6
	//  132  305:istore          4
						menu = menu1;
	...
	//  143  326:istore          7
				if(s.equals("menu"))
	//* 144  328:aload           11
	//* 145  330:ldc1            #81  <String "menu">
	//* 146  332:invokevirtual   #87  <Method boolean String.equals(Object)>
	//* 147  335:ifeq            489
				{
					flag3 = true;
	//  148  338:iconst_1        
	...
	//  163  367:goto            489
				...
				menu = ((Menu) (xmlpullparser.getName()));
	//  164  370:aload_1         
	//  165  371:invokeinterface #79  <Method String XmlPullParser.getName()>
	//  166  376:astore_3        
				if(((String) (menu)).equals("group"))
	//* 167  377:aload_3         
	//* 168  378:ldc1            #110 <String "group">
	//* 169  380:invokevirtual   #87  <Method boolean String.equals(Object)>
	//* 170  383:ifeq            406
				{
					menustate.readGroup(attributeset);
	//  171  386:aload           10
	//  172  388:aload_2         
	//  173  389:invokevirtual   #139 <Method void SupportMenuInflater$MenuState.readGroup(AttributeSet)>
					flag = flag2;
	//  174  392:iload           6
	//  175  394:istore          4
					menu = menu1;
	...
	//* 181  406:aload_3         
	//* 182  407:ldc1            #115 <String "item">
	//* 183  409:invokevirtual   #87  <Method boolean String.equals(Object)>
	//* 184  412:ifeq            435
				{
					menustate.readItem(attributeset);
	//  185  415:aload           10
	//  186  417:aload_2         
	//  187  418:invokevirtual   #142 <Method void SupportMenuInflater$MenuState.readItem(AttributeSet)>
					flag = flag2;
	//  188  421:iload           6
	//  189  423:istore          4
					menu = menu1;
	...
	//  194  432:goto            489
				...
				if(((String) (menu)).equals("menu"))
	//* 195  435:aload_3         
	//* 196  436:ldc1            #81  <String "menu">
	//* 197  438:invokevirtual   #87  <Method boolean String.equals(Object)>
	//* 198  441:ifeq            469
				{
	...
	//  201  446:aload_2         
	//  202  447:aload           10
	//  203  449:invokevirtual   #132 <Method SubMenu SupportMenuInflater$MenuState.addSubMenuItem()>
	//  204  452:invokespecial   #144 <Method void parseMenu(XmlPullParser, AttributeSet, Menu)>
					flag = flag2;
	//  205  455:iload           6
	//  206  457:istore          4
					menu = menu1;
	...
	//  217  479:new             #102 <Class RuntimeException>
	//  218  482:dup             
	//  219  483:ldc1            #146 <String "Unexpected end of document">
	//  220  485:invokespecial   #108 <Method void RuntimeException(String)>
	//  221  488:athrow          
			}
			k = xmlpullparser.next();
	//  222  489:aload_1         
	//  223  490:invokeinterface #90  <Method int XmlPullParser.next()>
	//  224  495:istore          8
			flag2 = flag;
	//  225  497:iload           4
	//  226  499:istore          6
	...
	Object getRealOwner()
	{
		if(mRealOwner == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #151 <Field Object mRealOwner>
	//*   2    4:ifnonnull       19
			mRealOwner = findRealOwner(((Object) (mContext)));
	//    3    7:aload_0         
	//    4    8:aload_0         
	//    5    9:aload_0         
	//    6   10:getfield        #42  <Field Context mContext>
	//    7   13:invokespecial   #60  <Method Object findRealOwner(Object)>
	//    8   16:putfield        #151 <Field Object mRealOwner>
		return mRealOwner;
	//    9   19:aload_0         
	//   10   20:getfield        #151 <Field Object mRealOwner>
	//   11   23:areturn         
	}
	...
	//*   0    0:aload_2         
	//*   1    1:instanceof      #156 <Class SupportMenu>
	//*   2    4:ifne            14
		{
	...
	//    4    8:iload_1         
	//    5    9:aload_2         
	//    6   10:invokespecial   #158 <Method void MenuInflater.inflate(int, Menu)>
			return;
	//    7   13:return          
		}
	...
	//   14   22:aload_0         
	//   15   23:getfield        #42  <Field Context mContext>
	//   16   26:invokevirtual   #162 <Method Resources Context.getResources()>
	//   17   29:iload_1         
	//   18   30:invokevirtual   #168 <Method XmlResourceParser Resources.getLayout(int)>
	//   19   33:astore          6
	...
	//   27   47:aload           6
	//   28   49:aload           6
	//   29   51:invokestatic    #174 <Method AttributeSet Xml.asAttributeSet(XmlPullParser)>
	//   30   54:aload_2         
	//   31   55:invokespecial   #144 <Method void parseMenu(XmlPullParser, AttributeSet, Menu)>
		if(xmlresourceparser3 != null)
	//*  32   58:aload           6
	//*  33   60:ifnull          70
			xmlresourceparser3.close();
	//   34   63:aload           6
	//   35   65:invokeinterface #179 <Method void XmlResourceParser.close()>
		return;
	//   36   70:return          
		menu;
	//   37   71:astore_2        
	...
	//   42   79:new             #181 <Class InflateException>
	//   43   82:dup             
	//   44   83:ldc1            #183 <String "Error inflating menu XML">
	//   45   85:aload_2         
	//   46   86:invokespecial   #186 <Method void InflateException(String, Throwable)>
	//   47   89:athrow          
		menu;
	//   48   90:astore_2        
		xmlresourceparser = xmlresourceparser2;
	...
	//   50   93:astore_3        
		throw new InflateException("Error inflating menu XML", ((Throwable) (menu)));
	//   51   94:new             #181 <Class InflateException>
	//   52   97:dup             
	//   53   98:ldc1            #183 <String "Error inflating menu XML">
	//   54  100:aload_2         
	//   55  101:invokespecial   #186 <Method void InflateException(String, Throwable)>
	//   56  104:athrow          
	...
	//   59  109:aload_3         
	//   60  110:invokeinterface #179 <Method void XmlResourceParser.close()>
		throw menu;
	//   61  115:aload_2         
	//   62  116:athrow          
	}
	...
	//    2    4:dup             
	//    3    5:iconst_0        
	//    4    6:ldc1            #31  <Class Context>
	//    5    8:aastore         
	//    6    9:putstatic       #33  <Field Class[] ACTION_VIEW_CONSTRUCTOR_SIGNATURE>
	//    7   12:getstatic       #33  <Field Class[] ACTION_VIEW_CONSTRUCTOR_SIGNATURE>
	//    8   15:putstatic       #35  <Field Class[] ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE>
	//*   9   18:return          
	}
}
