	...
	implements android.content.DialogInterface.OnClickListener, android.content.DialogInterface.OnDismissListener, android.content.DialogInterface.OnKeyListener, MenuPresenter.Callback
{
	...
	//    3    5:new             #129 <Class android.support.v7.app.AlertDialog$Builder>
	//    4    8:dup             
	//    5    9:aload_2         
	//    6   10:invokevirtual   #133 <Method android.content.Context MenuBuilder.getContext()>
	//    7   13:invokespecial   #136 <Method void android.support.v7.app.AlertDialog$Builder(android.content.Context)>
	//    8   16:astore_3        
	...
	//   11   21:dup             
	//   12   22:aload_3         
	//   13   23:invokevirtual   #137 <Method android.content.Context android.support.v7.app.AlertDialog$Builder.getContext()>
	//   14   26:getstatic       #143 <Field int android.support.v7.appcompat.R$layout.abc_list_menu_item_layout>
	//   15   29:invokespecial   #146 <Method void ListMenuPresenter(android.content.Context, int)>
	...
	//   19   39:aload_0         
	//   20   40:invokevirtual   #150 <Method void ListMenuPresenter.setCallback(MenuPresenter$Callback)>
	...
	//   25   51:invokevirtual   #154 <Method void MenuBuilder.addMenuPresenter(MenuPresenter)>
	...
	//   30   62:aload_0         
	//   31   63:invokevirtual   #158 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setAdapter(ListAdapter, android.content.DialogInterface$OnClickListener)>
	//   32   66:pop             
		View view = ((MenuBuilder) (obj)).getHeaderView();
	//   33   67:aload_2         
	//   34   68:invokevirtual   #161 <Method View MenuBuilder.getHeaderView()>
	//   35   71:astore          4
		if(view != null)
	//*  36   73:aload           4
	//*  37   75:ifnull          88
	...
	//   38   78:aload_3         
	//   39   79:aload           4
	//   40   81:invokevirtual   #165 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setCustomTitle(View)>
	//   41   84:pop             
		else
	//*  42   85:goto            104
	...
	//   43   88:aload_3         
	//   44   89:aload_2         
	//   45   90:invokevirtual   #169 <Method android.graphics.drawable.Drawable MenuBuilder.getHeaderIcon()>
	//   46   93:invokevirtual   #173 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setIcon(android.graphics.drawable.Drawable)>
	//   47   96:aload_2         
	//   48   97:invokevirtual   #177 <Method CharSequence MenuBuilder.getHeaderTitle()>
	//   49  100:invokevirtual   #181 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setTitle(CharSequence)>
	//   50  103:pop             
		builder.setOnKeyListener(((android.content.DialogInterface.OnKeyListener) (this)));
	//   51  104:aload_3         
	//   52  105:aload_0         
	//   53  106:invokevirtual   #185 <Method android.support.v7.app.AlertDialog$Builder android.support.v7.app.AlertDialog$Builder.setOnKeyListener(android.content.DialogInterface$OnKeyListener)>
	//   54  109:pop             
		mDialog = builder.create();
	//   55  110:aload_0         
	//   56  111:aload_3         
	//   57  112:invokevirtual   #189 <Method AlertDialog android.support.v7.app.AlertDialog$Builder.create()>
	...
	//   61  122:aload_0         
	//   62  123:invokevirtual   #193 <Method void AlertDialog.setOnDismissListener(android.content.DialogInterface$OnDismissListener)>
	...
	//   66  133:invokevirtual   #197 <Method android.view.WindowManager$LayoutParams Window.getAttributes()>
	//   67  136:astore_2        
		obj.type = 1003;
	//   68  137:aload_2         
	//   69  138:sipush          1003
	//   70  141:putfield        #202 <Field int android.view.WindowManager$LayoutParams.type>
		if(ibinder != null)
	//*  71  144:aload_1         
	//*  72  145:ifnull          153
			obj.token = ibinder;
	//   73  148:aload_2         
	//   74  149:aload_1         
	//   75  150:putfield        #206 <Field IBinder android.view.WindowManager$LayoutParams.token>
		obj.flags = ((android.view.WindowManager.LayoutParams) (obj)).flags | 0x20000;
	//   76  153:aload_2         
	//   77  154:aload_2         
	//   78  155:getfield        #209 <Field int android.view.WindowManager$LayoutParams.flags>
	//   79  158:ldc1            #210 <Int 0x20000>
	//   80  160:ior             
	//   81  161:putfield        #209 <Field int android.view.WindowManager$LayoutParams.flags>
		mDialog.show();
	//   82  164:aload_0         
	//   83  165:getfield        #31  <Field AlertDialog mDialog>
	//   84  168:invokevirtual   #212 <Method void AlertDialog.show()>
	//   85  171:return          
	}
