...
public final class MenuWrapperFactory
{
	...
	//    0    0:new             #12  <Class MenuWrapperICS>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokespecial   #16  <Method void MenuWrapperICS(Context, SupportMenu)>
	//    5    9:areturn         
	}
	...
	//    3    8:new             #27  <Class MenuItemWrapperJB>
	//    4   11:dup             
	//    5   12:aload_0         
	//    6   13:aload_1         
	//    7   14:invokespecial   #30  <Method void MenuItemWrapperJB(Context, SupportMenuItem)>
	//    8   17:areturn         
		else
			return ((MenuItem) (new MenuItemWrapperICS(context, supportmenuitem)));
	//    9   18:new             #32  <Class MenuItemWrapperICS>
	//   10   21:dup             
	//   11   22:aload_0         
	//   12   23:aload_1         
	//   13   24:invokespecial   #33  <Method void MenuItemWrapperICS(Context, SupportMenuItem)>
	//   14   27:areturn         
	}
	...
	//    0    0:new             #37  <Class SubMenuWrapperICS>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokespecial   #40  <Method void SubMenuWrapperICS(Context, SupportSubMenu)>
	//    5    9:areturn         
	}
}
