...
*/
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:getstatic       #51  <Field int android.support.v7.appcompat.R$attr.spinnerStyle>
	//    4    6:invokespecial   #54  <Method void AppCompatSpinner(Context, AttributeSet, int)>
	//    5    9:return          
	}
	...
	//    3    3:iload_3         
	//    4    4:iconst_m1       
	//    5    5:invokespecial   #57  <Method void AppCompatSpinner(Context, AttributeSet, int, int)>
	//    6    8:return          
	}
	...
	//    4    4:iload           4
	//    5    6:aconst_null     
	//    6    7:invokespecial   #60  <Method void AppCompatSpinner(Context, AttributeSet, int, int, android.content.res.Resources$Theme)>
	//    7   10:return          
	}
	...
	//    2    2:aload_2         
	//    3    3:iload_3         
	//    4    4:invokespecial   #63  <Method void Spinner(Context, AttributeSet, int)>
		mTempRect = new Rect();
	//    5    7:aload_0         
	//    6    8:new             #65  <Class Rect>
	//    7   11:dup             
	//    8   12:invokespecial   #67  <Method void Rect()>
	//    9   15:putfield        #69  <Field Rect mTempRect>
	...
	//   10   18:aload_1         
	//   11   19:aload_2         
	//   12   20:getstatic       #74  <Field int[] android.support.v7.appcompat.R$styleable.Spinner>
	//   13   23:iload_3         
	//   14   24:iconst_0        
	//   15   25:invokestatic    #80  <Method TintTypedArray TintTypedArray.obtainStyledAttributes(Context, AttributeSet, int[], int, int)>
	//   16   28:astore          10
		mBackgroundTintHelper = new AppCompatBackgroundHelper(((View) (this)));
	//   17   30:aload_0         
	//   18   31:new             #82  <Class AppCompatBackgroundHelper>
	//   19   34:dup             
	//   20   35:aload_0         
	//   21   36:invokespecial   #85  <Method void AppCompatBackgroundHelper(View)>
	//   22   39:putfield        #87  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
		if(theme != null)
	//*  23   42:aload           5
	//*  24   44:ifnull          64
		{
	...
	//   25   47:aload_0         
	//   26   48:new             #89  <Class ContextThemeWrapper>
	//   27   51:dup             
	//   28   52:aload_1         
	//   29   53:aload           5
	//   30   55:invokespecial   #92  <Method void ContextThemeWrapper(Context, android.content.res.Resources$Theme)>
	//   31   58:putfield        #94  <Field Context mPopupContext>
		} else
	//*  32   61:goto            120
		{
			int k = tinttypedarray1.getResourceId(android.support.v7.appcompat.R.styleable.Spinner_popupTheme, 0);
	//   33   64:aload           10
	//   34   66:getstatic       #97  <Field int android.support.v7.appcompat.R$styleable.Spinner_popupTheme>
	//   35   69:iconst_0        
	//   36   70:invokevirtual   #101 <Method int TintTypedArray.getResourceId(int, int)>
	//   37   73:istore          6
			if(k != 0)
	//*  38   75:iload           6
	//*  39   77:ifeq            97
	...
	//   40   80:aload_0         
	//   41   81:new             #89  <Class ContextThemeWrapper>
	//   42   84:dup             
	//   43   85:aload_1         
	//   44   86:iload           6
	//   45   88:invokespecial   #104 <Method void ContextThemeWrapper(Context, int)>
	//   46   91:putfield        #94  <Field Context mPopupContext>
			} else
	//*  47   94:goto            120
			{
				if(android.os.Build.VERSION.SDK_INT < 23)
	//*  48   97:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*  49  100:bipush          23
	//*  50  102:icmpge          111
	...
	//   56  114:aload_0         
	//   57  115:aload           5
	//   58  117:putfield        #94  <Field Context mPopupContext>
			}
		}
		if(mPopupContext == null)
			break MISSING_BLOCK_LABEL_363;
	//   59  120:aload_0         
	//   60  121:getfield        #94  <Field Context mPopupContext>
	//   61  124:ifnull          363
		i1 = j;
	//   62  127:iload           4
	//   63  129:istore          7
...
_L1:
	...
	//   67  137:aload_1         
	//   68  138:aload_2         
	//   69  139:getstatic       #43  <Field int[] ATTRS_ANDROID_SPINNERMODE>
	//   70  142:iload_3         
	//   71  143:iconst_0        
	//   72  144:invokevirtual   #114 <Method TypedArray Context.obtainStyledAttributes(AttributeSet, int[], int, int)>
	//   73  147:astore          5
		int l;
	...
	//   78  157:aload           5
	//   79  159:iconst_0        
	//   80  160:invokevirtual   #120 <Method boolean TypedArray.hasValue(int)>
	//   81  163:ifeq            179
		theme1 = theme;
	//   82  166:aload           5
	//   83  168:astore          8
	...
	//   85  172:iconst_0        
	//   86  173:iconst_0        
	//   87  174:invokevirtual   #123 <Method int TypedArray.getInt(int, int)>
	//   88  177:istore          6
		i1 = l;
	//   89  179:iload           6
	//   90  181:istore          7
...
_L6:
	...
	//   95  192:aload           5
	//   96  194:invokevirtual   #126 <Method void TypedArray.recycle()>
		i1 = j;
	//   97  197:iload           4
	//   98  199:istore          7
...
_L4:
	...
	//  111  225:ldc1            #128 <String "AppCompatSpinner">
	//  112  227:ldc1            #130 <String "Could not read android:spinnerMode">
	//  113  229:aload           9
	//  114  231:invokestatic    #136 <Method int Log.i(String, String, Throwable)>
	//  115  234:pop             
		i1 = j;
	//  116  235:iload           4
	//  117  237:istore          7
...
_L5:
	...
	//  124  253:aload           8
	//  125  255:invokevirtual   #126 <Method void TypedArray.recycle()>
		throw context;
	//  126  258:aload_1         
	//  127  259:athrow          
_L2:
	...
	//  133  270:aload_0         
	//  134  271:aload_0         
	//  135  272:getfield        #94  <Field Context mPopupContext>
	//  136  275:aload_2         
	//  137  276:iload_3         
	//  138  277:invokespecial   #139 <Method void AppCompatSpinner$DropdownPopup(AppCompatSpinner, Context, AttributeSet, int)>
	//  139  280:astore          5
	...
	//  140  282:aload_0         
	//  141  283:getfield        #94  <Field Context mPopupContext>
	//  142  286:aload_2         
	//  143  287:getstatic       #74  <Field int[] android.support.v7.appcompat.R$styleable.Spinner>
	//  144  290:iload_3         
	//  145  291:iconst_0        
	//  146  292:invokestatic    #80  <Method TintTypedArray TintTypedArray.obtainStyledAttributes(Context, AttributeSet, int[], int, int)>
	//  147  295:astore          8
	...
	//  148  297:aload_0         
	//  149  298:aload           8
	//  150  300:getstatic       #142 <Field int android.support.v7.appcompat.R$styleable.Spinner_android_dropDownWidth>
	//  151  303:bipush          -2
	//  152  305:invokevirtual   #145 <Method int TintTypedArray.getLayoutDimension(int, int)>
	//  153  308:putfield        #147 <Field int mDropDownWidth>
	...
	//  154  311:aload           5
	//  155  313:aload           8
	//  156  315:getstatic       #150 <Field int android.support.v7.appcompat.R$styleable.Spinner_android_popupBackground>
	//  157  318:invokevirtual   #154 <Method Drawable TintTypedArray.getDrawable(int)>
	//  158  321:invokevirtual   #158 <Method void AppCompatSpinner$DropdownPopup.setBackgroundDrawable(Drawable)>
	...
	//  159  324:aload           5
	//  160  326:aload           10
	//  161  328:getstatic       #161 <Field int android.support.v7.appcompat.R$styleable.Spinner_android_prompt>
	//  162  331:invokevirtual   #165 <Method String TintTypedArray.getString(int)>
	//  163  334:invokevirtual   #169 <Method void AppCompatSpinner$DropdownPopup.setPromptText(CharSequence)>
			tinttypedarray.recycle();
	//  164  337:aload           8
	//  165  339:invokevirtual   #170 <Method void TintTypedArray.recycle()>
			mPopup = ((DropdownPopup) (theme));
	//  166  342:aload_0         
	//  167  343:aload           5
	//  168  345:putfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	...
	//  173  354:aload_0         
	//  174  355:aload           5
	//  175  357:invokespecial   #175 <Method void AppCompatSpinner$1(AppCompatSpinner, View, AppCompatSpinner$DropdownPopup)>
	//  176  360:putfield        #177 <Field ForwardingListener mForwardingListener>
		}
	...
	//  177  363:aload           10
	//  178  365:getstatic       #180 <Field int android.support.v7.appcompat.R$styleable.Spinner_android_entries>
	//  179  368:invokevirtual   #184 <Method CharSequence[] TintTypedArray.getTextArray(int)>
	//  180  371:astore          5
		if(theme != null)
	//* 181  373:aload           5
	//* 182  375:ifnull          403
	...
	//  183  378:new             #186 <Class ArrayAdapter>
	//  184  381:dup             
	//  185  382:aload_1         
	//  186  383:ldc1            #187 <Int 0x1090008>
	//  187  385:aload           5
	//  188  387:invokespecial   #190 <Method void ArrayAdapter(Context, int, Object[])>
	//  189  390:astore_1        
			((ArrayAdapter) (context)).setDropDownViewResource(android.support.v7.appcompat.R.layout.support_simple_spinner_dropdown_item);
	//  190  391:aload_1         
	//  191  392:getstatic       #195 <Field int android.support.v7.appcompat.R$layout.support_simple_spinner_dropdown_item>
	//  192  395:invokevirtual   #199 <Method void ArrayAdapter.setDropDownViewResource(int)>
			setAdapter(((SpinnerAdapter) (context)));
	//  193  398:aload_0         
	//  194  399:aload_1         
	//  195  400:invokevirtual   #203 <Method void setAdapter(SpinnerAdapter)>
		}
		tinttypedarray1.recycle();
	//  196  403:aload           10
	//  197  405:invokevirtual   #170 <Method void TintTypedArray.recycle()>
		mPopupSet = true;
	//  198  408:aload_0         
	//  199  409:iconst_1        
	//  200  410:putfield        #205 <Field boolean mPopupSet>
		context = ((Context) (mTempAdapter));
	//  201  413:aload_0         
	//  202  414:getfield        #207 <Field SpinnerAdapter mTempAdapter>
	//  203  417:astore_1        
		if(context != null)
	//* 204  418:aload_1         
	//* 205  419:ifnull          432
	...
	//  206  422:aload_0         
	//  207  423:aload_1         
	//  208  424:invokevirtual   #203 <Method void setAdapter(SpinnerAdapter)>
			mTempAdapter = null;
	//  209  427:aload_0         
	//  210  428:aconst_null     
	//  211  429:putfield        #207 <Field SpinnerAdapter mTempAdapter>
		}
		mBackgroundTintHelper.loadFromAttributes(attributeset, i);
	//  212  432:aload_0         
	//  213  433:getfield        #87  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//  214  436:aload_2         
	//  215  437:iload_3         
	//  216  438:invokevirtual   #211 <Method void AppCompatBackgroundHelper.loadFromAttributes(AttributeSet, int)>
		return;
	//  217  441:return          
	}
	...
	//    6    9:aload_0         
	//    7   10:invokevirtual   #217 <Method int getMeasuredWidth()>
	//    8   13:iconst_0        
	//    9   14:invokestatic    #222 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   10   17:istore          8
		int k1 = android.view.View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 0);
	//   11   19:aload_0         
	//   12   20:invokevirtual   #225 <Method int getMeasuredHeight()>
	//   13   23:iconst_0        
	//   14   24:invokestatic    #222 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   15   27:istore          9
		int i = Math.max(0, getSelectedItemPosition());
	//   16   29:iconst_0        
	//   17   30:aload_0         
	//   18   31:invokevirtual   #228 <Method int getSelectedItemPosition()>
	//   19   34:invokestatic    #233 <Method int Math.max(int, int)>
	//   20   37:istore_3        
		int l1 = Math.min(spinneradapter.getCount(), i + 15);
	//   21   38:aload_1         
	//   22   39:invokeinterface #238 <Method int SpinnerAdapter.getCount()>
	//   23   44:iload_3         
	//   24   45:bipush          15
	//   25   47:iadd            
	//   26   48:invokestatic    #241 <Method int Math.min(int, int)>
	//   27   51:istore          10
	...
	//   34   61:isub            
	//   35   62:isub            
	//   36   63:invokestatic    #233 <Method int Math.max(int, int)>
	//   37   66:istore          4
		View view = null;
	//   38   68:aconst_null     
	//   39   69:astore          11
	...
	//   45   80:aload_1         
	//   46   81:iload           4
	//   47   83:invokeinterface #245 <Method int SpinnerAdapter.getItemViewType(int)>
	//   48   88:istore          7
			int l = k;
	//   49   90:iload           5
	//   50   92:istore          6
	...
	//   60  111:aload           11
	//   61  113:aload_0         
	//   62  114:invokeinterface #249 <Method View SpinnerAdapter.getView(int, View, ViewGroup)>
	//   63  119:astore          11
			if(view.getLayoutParams() == null)
	//*  64  121:aload           11
	//*  65  123:invokevirtual   #255 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//*  66  126:ifnonnull       145
				view.setLayoutParams(new android.view.ViewGroup.LayoutParams(-2, -2));
	//   67  129:aload           11
	//   68  131:new             #257 <Class android.view.ViewGroup$LayoutParams>
	//   69  134:dup             
	//   70  135:bipush          -2
	//   71  137:bipush          -2
	//   72  139:invokespecial   #260 <Method void android.view.ViewGroup$LayoutParams(int, int)>
	//   73  142:invokevirtual   #264 <Method void View.setLayoutParams(android.view.ViewGroup$LayoutParams)>
			view.measure(j1, k1);
	//   74  145:aload           11
	//   75  147:iload           8
	//   76  149:iload           9
	//   77  151:invokevirtual   #267 <Method void View.measure(int, int)>
			i = Math.max(i, view.getMeasuredWidth());
	//   78  154:iload_3         
	//   79  155:aload           11
	//   80  157:invokevirtual   #268 <Method int View.getMeasuredWidth()>
	//   81  160:invokestatic    #233 <Method int Math.max(int, int)>
	//   82  163:istore_3        
			j++;
	//   83  164:iload           4
	//   84  166:iconst_1        
	...
	//   94  184:aload_2         
	//   95  185:aload_0         
	//   96  186:getfield        #69  <Field Rect mTempRect>
	//   97  189:invokevirtual   #274 <Method boolean Drawable.getPadding(Rect)>
	//   98  192:pop             
			j = i + (mTempRect.left + mTempRect.right);
	//   99  193:iload_3         
	//  100  194:aload_0         
	//  101  195:getfield        #69  <Field Rect mTempRect>
	//  102  198:getfield        #277 <Field int Rect.left>
	//  103  201:aload_0         
	//  104  202:getfield        #69  <Field Rect mTempRect>
	//  105  205:getfield        #280 <Field int Rect.right>
	//  106  208:iadd            
	//  107  209:iadd            
	//  108  210:istore          4
		}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #283 <Method void Spinner.drawableStateChanged()>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    2    4:aload_0         
	//    3    5:getfield        #87  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    4    8:astore_1        
	...
	//    7   13:aload_1         
	//    8   14:invokevirtual   #286 <Method void AppCompatBackgroundHelper.applySupportBackgroundTint()>
	//    9   17:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	//    2    4:astore_1        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #290 <Method int AppCompatSpinner$DropdownPopup.getHorizontalOffset()>
	//    7   13:ireturn         
		if(android.os.Build.VERSION.SDK_INT >= 16)
	//*   8   14:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*   9   17:bipush          16
	//*  10   19:icmplt          27
			return super.getDropDownHorizontalOffset();
	//   11   22:aload_0         
	//   12   23:invokespecial   #292 <Method int Spinner.getDropDownHorizontalOffset()>
	//   13   26:ireturn         
		else
			return 0;
	//   14   27:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #296 <Method int AppCompatSpinner$DropdownPopup.getVerticalOffset()>
	//    7   13:ireturn         
		if(android.os.Build.VERSION.SDK_INT >= 16)
	//*   8   14:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*   9   17:bipush          16
	...
	//   11   22:aload_0         
	//   12   23:invokespecial   #298 <Method int Spinner.getDropDownVerticalOffset()>
	//   13   26:ireturn         
		else
			return 0;
	//   14   27:iconst_0        
	...
	//    3    7:aload_0         
	//    4    8:getfield        #147 <Field int mDropDownWidth>
	//    5   11:ireturn         
		if(android.os.Build.VERSION.SDK_INT >= 16)
	//*   6   12:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*   7   15:bipush          16
	//*   8   17:icmplt          25
			return super.getDropDownWidth();
	//    9   20:aload_0         
	//   10   21:invokespecial   #301 <Method int Spinner.getDropDownWidth()>
	//   11   24:ireturn         
		else
			return 0;
	//   12   25:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #306 <Method Drawable AppCompatSpinner$DropdownPopup.getBackground()>
	//    7   13:areturn         
		if(android.os.Build.VERSION.SDK_INT >= 16)
	//*   8   14:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*   9   17:bipush          16
	...
	//   11   22:aload_0         
	//   12   23:invokespecial   #308 <Method Drawable Spinner.getPopupBackground()>
	//   13   26:areturn         
		else
			return null;
	//   14   27:aconst_null     
	...
	//    3    7:aload_0         
	//    4    8:getfield        #94  <Field Context mPopupContext>
	//    5   11:areturn         
		if(android.os.Build.VERSION.SDK_INT >= 23)
	//*   6   12:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*   7   15:bipush          23
	...
	//    9   20:aload_0         
	//   10   21:invokespecial   #312 <Method Context Spinner.getPopupContext()>
	//   11   24:areturn         
		else
			return null;
	//   12   25:aconst_null     
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #317 <Method CharSequence AppCompatSpinner$DropdownPopup.getHintText()>
	//    7   13:areturn         
		else
			return super.getPrompt();
	//    8   14:aload_0         
	//    9   15:invokespecial   #319 <Method CharSequence Spinner.getPrompt()>
	//   10   18:areturn         
	}
	...
	public ColorStateList getSupportBackgroundTintList()
	{
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    0    0:aload_0         
	//    1    1:getfield        #87  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    2    4:astore_1        
		if(appcompatbackgroundhelper != null)
	//*   3    5:aload_1         
	//*   4    6:ifnull          14
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #328 <Method ColorStateList AppCompatBackgroundHelper.getSupportBackgroundTintList()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #333 <Method android.graphics.PorterDuff$Mode AppCompatBackgroundHelper.getSupportBackgroundTintMode()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #336 <Method void Spinner.onDetachedFromWindow()>
		DropdownPopup dropdownpopup = mPopup;
	//    2    4:aload_0         
	//    3    5:getfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	//    4    8:astore_1        
		if(dropdownpopup != null && dropdownpopup.isShowing())
	//*   5    9:aload_1         
	//*   6   10:ifnull          27
	//*   7   13:aload_1         
	//*   8   14:invokevirtual   #340 <Method boolean AppCompatSpinner$DropdownPopup.isShowing()>
	//*   9   17:ifeq            27
			mPopup.dismiss();
	//   10   20:aload_0         
	//   11   21:getfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	//   12   24:invokevirtual   #343 <Method void AppCompatSpinner$DropdownPopup.dismiss()>
	//   13   27:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #346 <Method void Spinner.onMeasure(int, int)>
		if(mPopup != null && android.view.View.MeasureSpec.getMode(i) == 0x80000000)
	//*   4    6:aload_0         
	//*   5    7:getfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	//*   6   10:ifnull          57
	//*   7   13:iload_1         
	//*   8   14:invokestatic    #349 <Method int android.view.View$MeasureSpec.getMode(int)>
	//*   9   17:ldc2            #350 <Int 0x80000000>
	//*  10   20:icmpne          57
	...
	//   11   23:aload_0         
	//   12   24:aload_0         
	//   13   25:invokevirtual   #217 <Method int getMeasuredWidth()>
	//   14   28:aload_0         
	//   15   29:aload_0         
	//   16   30:invokevirtual   #354 <Method SpinnerAdapter getAdapter()>
	//   17   33:aload_0         
	//   18   34:invokevirtual   #355 <Method Drawable getBackground()>
	//   19   37:invokevirtual   #357 <Method int compatMeasureContentWidth(SpinnerAdapter, Drawable)>
	//   20   40:invokestatic    #233 <Method int Math.max(int, int)>
	//   21   43:iload_1         
	//   22   44:invokestatic    #360 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   23   47:invokestatic    #241 <Method int Math.min(int, int)>
	//   24   50:aload_0         
	//   25   51:invokevirtual   #225 <Method int getMeasuredHeight()>
	//   26   54:invokevirtual   #363 <Method void setMeasuredDimension(int, int)>
	//   27   57:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #177 <Field ForwardingListener mForwardingListener>
	//    2    4:astore_2        
	...
	//*   6   10:aload_0         
	//*   7   11:aload_1         
	//*   8   12:invokevirtual   #371 <Method boolean ForwardingListener.onTouch(View, MotionEvent)>
	//*   9   15:ifeq            20
			return true;
	//   10   18:iconst_1        
	//   11   19:ireturn         
	...
	//   12   20:aload_0         
	//   13   21:aload_1         
	//   14   22:invokespecial   #373 <Method boolean Spinner.onTouchEvent(MotionEvent)>
	//   15   25:ireturn         
	}
	...
	//*   5    9:aload_1         
	//*   6   10:invokevirtual   #340 <Method boolean AppCompatSpinner$DropdownPopup.isShowing()>
	//*   7   13:ifne            23
				mPopup.show();
	//    8   16:aload_0         
	//    9   17:getfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	//   10   20:invokevirtual   #377 <Method void AppCompatSpinner$DropdownPopup.show()>
			return true;
	//   11   23:iconst_1        
	//   12   24:ireturn         
		} else
	...
	//   13   25:aload_0         
	//   14   26:invokespecial   #379 <Method boolean Spinner.performClick()>
	//   15   29:ireturn         
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #235 <Class SpinnerAdapter>
	//    3    5:invokevirtual   #203 <Method void setAdapter(SpinnerAdapter)>
	//    4    8:return          
	}
	...
	public void setAdapter(SpinnerAdapter spinneradapter)
	{
		if(!mPopupSet)
	//*   0    0:aload_0         
	//*   1    1:getfield        #205 <Field boolean mPopupSet>
	//*   2    4:ifne            13
		{
			mTempAdapter = spinneradapter;
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #207 <Field SpinnerAdapter mTempAdapter>
			return;
	//    6   12:return          
		}
	...
	//    7   13:aload_0         
	//    8   14:aload_1         
	//    9   15:invokespecial   #381 <Method void Spinner.setAdapter(SpinnerAdapter)>
		if(mPopup != null)
	//*  10   18:aload_0         
	//*  11   19:getfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	//*  12   22:ifnull          60
		{
			Context context1 = mPopupContext;
	//   13   25:aload_0         
	//   14   26:getfield        #94  <Field Context mPopupContext>
	//   15   29:astore_3        
	...
	//*  19   33:ifnonnull       41
				context = getContext();
	//   20   36:aload_0         
	//   21   37:invokevirtual   #384 <Method Context getContext()>
	//   22   40:astore_2        
			mPopup.setAdapter(((ListAdapter) (new DropDownAdapter(spinneradapter, context.getTheme()))));
	//   23   41:aload_0         
	//   24   42:getfield        #172 <Field AppCompatSpinner$DropdownPopup mPopup>
	//   25   45:new             #10  <Class AppCompatSpinner$DropDownAdapter>
	//   26   48:dup             
	//   27   49:aload_1         
	//   28   50:aload_2         
	//   29   51:invokevirtual   #388 <Method android.content.res.Resources$Theme Context.getTheme()>
	//   30   54:invokespecial   #391 <Method void AppCompatSpinner$DropDownAdapter(SpinnerAdapter, android.content.res.Resources$Theme)>
	//   31   57:invokevirtual   #394 <Method void AppCompatSpinner$DropdownPopup.setAdapter(ListAdapter)>
		}
	//   32   60:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #395 <Method void Spinner.setBackgroundDrawable(Drawable)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	//    4    6:getfield        #87  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    5    9:astore_2        
		if(appcompatbackgroundhelper != null)
	//*   6   10:aload_2         
	//*   7   11:ifnull          19
	...
	//    8   14:aload_2         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #398 <Method void AppCompatBackgroundHelper.onSetBackgroundDrawable(Drawable)>
	//   11   19:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #402 <Method void Spinner.setBackgroundResource(int)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	//    4    6:getfield        #87  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    5    9:astore_2        
	...
	//    8   14:aload_2         
	//    9   15:iload_1         
	//   10   16:invokevirtual   #405 <Method void AppCompatBackgroundHelper.onSetBackgroundResource(int)>
	//   11   19:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #410 <Method void AppCompatSpinner$DropdownPopup.setHorizontalOffset(int)>
			return;
	//    8   14:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 16)
	//*   9   15:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*  10   18:bipush          16
	//*  11   20:icmplt          28
			super.setDropDownHorizontalOffset(i);
	//   12   23:aload_0         
	//   13   24:iload_1         
	//   14   25:invokespecial   #412 <Method void Spinner.setDropDownHorizontalOffset(int)>
	//   15   28:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #416 <Method void AppCompatSpinner$DropdownPopup.setVerticalOffset(int)>
			return;
	//    8   14:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 16)
	...
	//   12   23:aload_0         
	//   13   24:iload_1         
	//   14   25:invokespecial   #418 <Method void Spinner.setDropDownVerticalOffset(int)>
	//   15   28:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:iload_1         
	//    5    9:putfield        #147 <Field int mDropDownWidth>
			return;
	//    6   12:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 16)
	//*   7   13:getstatic       #109 <Field int android.os.Build$VERSION.SDK_INT>
	//*   8   16:bipush          16
	//*   9   18:icmplt          26
			super.setDropDownWidth(i);
	//   10   21:aload_0         
	//   11   22:iload_1         
	//   12   23:invokespecial   #421 <Method void Spinner.setDropDownWidth(int)>
	//   13   26:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #158 <Method void AppCompatSpinner$DropdownPopup.setBackgroundDrawable(Drawable)>
			return;
	//    8   14:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 16)
	...
	//   12   23:aload_0         
	//   13   24:aload_1         
	//   14   25:invokespecial   #424 <Method void Spinner.setPopupBackgroundDrawable(Drawable)>
	//   15   28:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:invokevirtual   #426 <Method Context getPopupContext()>
	//    3    5:iload_1         
	//    4    6:invokestatic    #431 <Method Drawable AppCompatResources.getDrawable(Context, int)>
	//    5    9:invokevirtual   #432 <Method void setPopupBackgroundDrawable(Drawable)>
	//    6   12:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #169 <Method void AppCompatSpinner$DropdownPopup.setPromptText(CharSequence)>
			return;
	//    8   14:return          
		} else
		{
	...
	//    9   15:aload_0         
	//   10   16:aload_1         
	//   11   17:invokespecial   #435 <Method void Spinner.setPrompt(CharSequence)>
			return;
	//   12   20:return          
		}
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #439 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintList(ColorStateList)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #443 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintMode(android.graphics.PorterDuff$Mode)>
	//    8   14:return          
	}
	...
	//    2    3:dup             
	//    3    4:iconst_0        
	//    4    5:ldc1            #41  <Int 0x10102f1>
	//    5    7:iastore         
	//    6    8:putstatic       #43  <Field int[] ATTRS_ANDROID_SPINNERMODE>
	//*   7   11:return          
	}
