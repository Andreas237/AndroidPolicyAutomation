...
class RoundRectDrawable extends Drawable
{
	...
	//*   3    6:aload_0         
	//*   4    7:getfield        #147 <Field PorterDuffColorFilter mTintFilter>
	//*   5   10:ifnull          36
	//*   6   13:aload           4
	//*   7   15:invokevirtual   #151 <Method ColorFilter Paint.getColorFilter()>
	//*   8   18:ifnonnull       36
		{
			paint.setColorFilter(((ColorFilter) (mTintFilter)));
	//    9   21:aload           4
	//   10   23:aload_0         
	//   11   24:getfield        #147 <Field PorterDuffColorFilter mTintFilter>
	//   12   27:invokevirtual   #155 <Method ColorFilter Paint.setColorFilter(ColorFilter)>
	//   13   30:pop             
			flag = true;
	//   14   31:iconst_1        
	//   15   32:istore_3        
	...
	//   19   38:aload_0         
	//   20   39:getfield        #60  <Field RectF mBoundsF>
	//   21   42:astore          5
		float f = mRadius;
	//   22   44:aload_0         
	//   23   45:getfield        #44  <Field float mRadius>
	//   24   48:fstore_2        
	...
	//   28   53:fload_2         
	//   29   54:aload           4
	//   30   56:invokevirtual   #161 <Method void Canvas.drawRoundRect(RectF, float, float, Paint)>
		if(flag)
	//*  31   59:iload_3         
	//*  32   60:ifeq            70
	...
	//   33   63:aload           4
	//   34   65:aconst_null     
	//   35   66:invokevirtual   #155 <Method ColorFilter Paint.setColorFilter(ColorFilter)>
	//   36   69:pop             
	//   37   70:return          
	}
...
label0:
	...
	//*   4    6:ifnull          16
	//*   5    9:aload_1         
	//*   6   10:invokevirtual   #181 <Method boolean ColorStateList.isStateful()>
	//*   7   13:ifne            39
			{
				ColorStateList colorstatelist1 = mBackground;
	//    8   16:aload_0         
	//    9   17:getfield        #89  <Field ColorStateList mBackground>
	//   10   20:astore_1        
	...
	//   12   22:ifnull          32
	//   13   25:aload_1         
	//   14   26:invokevirtual   #181 <Method boolean ColorStateList.isStateful()>
	//   15   29:ifne            39
	//   16   32:aload_0         
	//   17   33:invokespecial   #182 <Method boolean Drawable.isStateful()>
	//   18   36:ifeq            41
			}
			return true;
	//   19   39:iconst_1        
	...
	//    4    8:aload_1         
	//    5    9:aload           4
	//    6   11:invokevirtual   #93  <Method int ColorStateList.getDefaultColor()>
	//    7   14:invokevirtual   #80  <Method int ColorStateList.getColorForState(int[], int)>
	//    8   17:istore_2        
		boolean flag;
		if(i != mPaint.getColor())
	//*   9   18:iload_2         
	//*  10   19:aload_0         
	//*  11   20:getfield        #51  <Field Paint mPaint>
	//*  12   23:invokevirtual   #191 <Method int Paint.getColor()>
	//*  13   26:icmpeq          34
			flag = true;
	//   14   29:iconst_1        
	//   15   30:istore_3        
	...
	//*  20   37:ifeq            48
			mPaint.setColor(i);
	//   21   40:aload_0         
	//   22   41:getfield        #51  <Field Paint mPaint>
	//   23   44:iload_2         
	//   24   45:invokevirtual   #96  <Method void Paint.setColor(int)>
		ai = ((int []) (mTint));
	//   25   48:aload_0         
	//   26   49:getfield        #179 <Field ColorStateList mTint>
	//   27   52:astore_1        
		if(ai != null)
	//*  28   53:aload_1         
	//*  29   54:ifnull          81
	...
	//   30   57:aload_0         
	//   31   58:getfield        #42  <Field android.graphics.PorterDuff$Mode mTintMode>
	//   32   61:astore          4
			if(mode != null)
	//*  33   63:aload           4
	//*  34   65:ifnull          81
	...
	//   37   70:aload_1         
	//   38   71:aload           4
	//   39   73:invokespecial   #193 <Method PorterDuffColorFilter createTintFilter(ColorStateList, android.graphics.PorterDuff$Mode)>
	//   40   76:putfield        #147 <Field PorterDuffColorFilter mTintFilter>
				return true;
	//   41   79:iconst_1        
	//   42   80:ireturn         
			}
