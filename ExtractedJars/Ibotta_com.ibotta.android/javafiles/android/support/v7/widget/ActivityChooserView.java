...
//			ListPopupWindow, ActivityChooserModel, TintTypedArray, ForwardingListener
...
_L9:
		...
		//   73  178:aload           5
		//   74  180:aload_2         
		//   75  181:invokevirtual   #150 <Method Drawable ResolveInfo.loadIcon(android.content.pm.PackageManager)>
		//   76  184:invokevirtual   #154 <Method void ImageView.setImageDrawable(Drawable)>
		...
		//   14   30:getfield        #199 <Field DataSetObserver ActivityChooserView.mModelDataSetObserver>
		...
		//   28   60:getfield        #199 <Field DataSetObserver ActivityChooserView.mModelDataSetObserver>
...
label0:
		...
		//   48   99:aload_1         
		//   49  100:iconst_0        
		//   50  101:putfield        #90  <Field boolean ActivityChooserView.mIsSelectingDefaultActivity>
					((ActivityChooserView) (view)).showPopupUnchecked(((ActivityChooserView) (view)).mInitialActivityCount);
		//   51  104:aload_1         
		//   52  105:aload_1         
		//   53  106:getfield        #94  <Field int ActivityChooserView.mInitialActivityCount>
		//   54  109:invokevirtual   #98  <Method void ActivityChooserView.showPopupUnchecked(int)>
				}
				return;
		//   55  112:return          
			}
			throw new IllegalArgumentException();
		//   56  113:new             #100 <Class IllegalArgumentException>
		//   57  116:dup             
		//   58  117:invokespecial   #101 <Method void IllegalArgumentException()>
		//   59  120:athrow          
		}
		...
		//   13   29:aload_1         
		//   14   30:iconst_1        
		//   15   31:putfield        #90  <Field boolean ActivityChooserView.mIsSelectingDefaultActivity>
					((ActivityChooserView) (view)).showPopupUnchecked(((ActivityChooserView) (view)).mInitialActivityCount);
		//   16   34:aload_1         
		//   17   35:aload_1         
		//   18   36:getfield        #94  <Field int ActivityChooserView.mInitialActivityCount>
		//   19   39:invokevirtual   #98  <Method void ActivityChooserView.showPopupUnchecked(int)>
				}
				return true;
		//   20   42:iconst_1        
		//   21   43:ireturn         
			...
			{
				throw new IllegalArgumentException();
		//   22   44:new             #100 <Class IllegalArgumentException>
		//   23   47:dup             
		//   24   48:invokespecial   #101 <Method void IllegalArgumentException()>
		//   25   51:athrow          
			}
		}
	...
	public static class InnerLayout extends LinearLayout
	{
		...
		//    1    1:aload_1         
		//    2    2:aload_2         
		//    3    3:invokespecial   #23  <Method void LinearLayout(Context, AttributeSet)>
	...
	//    1    1:aload_1         
	//    2    2:aconst_null     
	//    3    3:invokespecial   #65  <Method void ActivityChooserView(Context, AttributeSet)>
	//    4    6:return          
	}
	...
	//    2    2:aload_2         
	//    3    3:iconst_0        
	//    4    4:invokespecial   #69  <Method void ActivityChooserView(Context, AttributeSet, int)>
	//    5    7:return          
	}
	...
	//    2    2:aload_2         
	//    3    3:iload_3         
	//    4    4:invokespecial   #70  <Method void ViewGroup(Context, AttributeSet, int)>
	...
	//    7   11:dup             
	//    8   12:aload_0         
	//    9   13:invokespecial   #73  <Method void ActivityChooserView$1(ActivityChooserView)>
	//   10   16:putfield        #75  <Field DataSetObserver mModelDataSetObserver>
...
;
	...
	//   13   23:dup             
	//   14   24:aload_0         
	//   15   25:invokespecial   #76  <Method void ActivityChooserView$2(ActivityChooserView)>
	//   16   28:putfield        #78  <Field android.view.ViewTreeObserver$OnGlobalLayoutListener mOnGlobalLayoutListener>
		mInitialActivityCount = 4;
	//   17   31:aload_0         
	//   18   32:iconst_4        
	//   19   33:putfield        #80  <Field int mInitialActivityCount>
	...
	//   20   36:aload_1         
	//   21   37:aload_2         
	//   22   38:getstatic       #86  <Field int[] android.support.v7.appcompat.R$styleable.ActivityChooserView>
	//   23   41:iload_3         
	//   24   42:iconst_0        
	//   25   43:invokevirtual   #92  <Method TypedArray Context.obtainStyledAttributes(AttributeSet, int[], int, int)>
	//   26   46:astore          4
	...
	//   27   48:aload_0         
	//   28   49:aload           4
	//   29   51:getstatic       #95  <Field int android.support.v7.appcompat.R$styleable.ActivityChooserView_initialActivityCount>
	//   30   54:iconst_4        
	//   31   55:invokevirtual   #101 <Method int TypedArray.getInt(int, int)>
	//   32   58:putfield        #80  <Field int mInitialActivityCount>
	...
	//   33   61:aload           4
	//   34   63:getstatic       #104 <Field int android.support.v7.appcompat.R$styleable.ActivityChooserView_expandActivityOverflowButtonDrawable>
	//   35   66:invokevirtual   #108 <Method Drawable TypedArray.getDrawable(int)>
	//   36   69:astore_2        
		((TypedArray) (obj)).recycle();
	//   37   70:aload           4
	//   38   72:invokevirtual   #112 <Method void TypedArray.recycle()>
	...
	//   39   75:aload_0         
	//   40   76:invokevirtual   #116 <Method Context getContext()>
	//   41   79:invokestatic    #122 <Method LayoutInflater LayoutInflater.from(Context)>
	//   42   82:getstatic       #127 <Field int android.support.v7.appcompat.R$layout.abc_activity_chooser_view>
	//   43   85:aload_0         
	//   44   86:iconst_1        
	//   45   87:invokevirtual   #131 <Method View LayoutInflater.inflate(int, ViewGroup, boolean)>
	//   46   90:pop             
	...
	//   49   95:dup             
	//   50   96:aload_0         
	//   51   97:invokespecial   #132 <Method void ActivityChooserView$Callbacks(ActivityChooserView)>
	//   52  100:putfield        #134 <Field ActivityChooserView$Callbacks mCallbacks>
		mActivityChooserContent = findViewById(android.support.v7.appcompat.R.id.activity_chooser_view_content);
	//   53  103:aload_0         
	//   54  104:aload_0         
	//   55  105:getstatic       #139 <Field int android.support.v7.appcompat.R$id.activity_chooser_view_content>
	//   56  108:invokevirtual   #143 <Method View findViewById(int)>
	//   57  111:putfield        #145 <Field View mActivityChooserContent>
		mActivityChooserContentBackground = mActivityChooserContent.getBackground();
	//   58  114:aload_0         
	//   59  115:aload_0         
	//   60  116:getfield        #145 <Field View mActivityChooserContent>
	//   61  119:invokevirtual   #151 <Method Drawable View.getBackground()>
	//   62  122:putfield        #153 <Field Drawable mActivityChooserContentBackground>
		mDefaultActivityButton = (FrameLayout)findViewById(android.support.v7.appcompat.R.id.default_activity_button);
	//   63  125:aload_0         
	//   64  126:aload_0         
	//   65  127:getstatic       #156 <Field int android.support.v7.appcompat.R$id.default_activity_button>
	//   66  130:invokevirtual   #143 <Method View findViewById(int)>
	//   67  133:checkcast       #158 <Class FrameLayout>
	//   68  136:putfield        #160 <Field FrameLayout mDefaultActivityButton>
		mDefaultActivityButton.setOnClickListener(((android.view.View.OnClickListener) (mCallbacks)));
	//   69  139:aload_0         
	//   70  140:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//   71  143:aload_0         
	//   72  144:getfield        #134 <Field ActivityChooserView$Callbacks mCallbacks>
	//   73  147:invokevirtual   #164 <Method void FrameLayout.setOnClickListener(android.view.View$OnClickListener)>
		mDefaultActivityButton.setOnLongClickListener(((android.view.View.OnLongClickListener) (mCallbacks)));
	//   74  150:aload_0         
	//   75  151:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//   76  154:aload_0         
	//   77  155:getfield        #134 <Field ActivityChooserView$Callbacks mCallbacks>
	//   78  158:invokevirtual   #168 <Method void FrameLayout.setOnLongClickListener(android.view.View$OnLongClickListener)>
		mDefaultActivityButtonImage = (ImageView)mDefaultActivityButton.findViewById(android.support.v7.appcompat.R.id.image);
	//   79  161:aload_0         
	//   80  162:aload_0         
	//   81  163:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//   82  166:getstatic       #171 <Field int android.support.v7.appcompat.R$id.image>
	//   83  169:invokevirtual   #172 <Method View FrameLayout.findViewById(int)>
	//   84  172:checkcast       #174 <Class ImageView>
	//   85  175:putfield        #176 <Field ImageView mDefaultActivityButtonImage>
		obj = ((Object) ((FrameLayout)findViewById(android.support.v7.appcompat.R.id.expand_activities_button)));
	//   86  178:aload_0         
	//   87  179:getstatic       #179 <Field int android.support.v7.appcompat.R$id.expand_activities_button>
	//   88  182:invokevirtual   #143 <Method View findViewById(int)>
	//   89  185:checkcast       #158 <Class FrameLayout>
	//   90  188:astore          4
		((FrameLayout) (obj)).setOnClickListener(((android.view.View.OnClickListener) (mCallbacks)));
	//   91  190:aload           4
	//   92  192:aload_0         
	//   93  193:getfield        #134 <Field ActivityChooserView$Callbacks mCallbacks>
	//   94  196:invokevirtual   #164 <Method void FrameLayout.setOnClickListener(android.view.View$OnClickListener)>
	...
	//   95  199:aload           4
	//   96  201:new             #12  <Class ActivityChooserView$3>
	//   97  204:dup             
	//   98  205:aload_0         
	//   99  206:invokespecial   #180 <Method void ActivityChooserView$3(ActivityChooserView)>
	//  100  209:invokevirtual   #184 <Method void FrameLayout.setAccessibilityDelegate(android.view.View$AccessibilityDelegate)>
	...
	//  101  212:aload           4
	//  102  214:new             #14  <Class ActivityChooserView$4>
	//  103  217:dup             
	//  104  218:aload_0         
	//  105  219:aload           4
	//  106  221:invokespecial   #187 <Method void ActivityChooserView$4(ActivityChooserView, View)>
	//  107  224:invokevirtual   #191 <Method void FrameLayout.setOnTouchListener(android.view.View$OnTouchListener)>
		mExpandActivityOverflowButton = ((FrameLayout) (obj));
	//  108  227:aload_0         
	//  109  228:aload           4
	//  110  230:putfield        #193 <Field FrameLayout mExpandActivityOverflowButton>
		mExpandActivityOverflowButtonImage = (ImageView)((FrameLayout) (obj)).findViewById(android.support.v7.appcompat.R.id.image);
	//  111  233:aload_0         
	//  112  234:aload           4
	//  113  236:getstatic       #171 <Field int android.support.v7.appcompat.R$id.image>
	//  114  239:invokevirtual   #172 <Method View FrameLayout.findViewById(int)>
	//  115  242:checkcast       #174 <Class ImageView>
	//  116  245:putfield        #195 <Field ImageView mExpandActivityOverflowButtonImage>
		mExpandActivityOverflowButtonImage.setImageDrawable(((Drawable) (attributeset)));
	//  117  248:aload_0         
	//  118  249:getfield        #195 <Field ImageView mExpandActivityOverflowButtonImage>
	//  119  252:aload_2         
	//  120  253:invokevirtual   #199 <Method void ImageView.setImageDrawable(Drawable)>
		mAdapter = new ActivityChooserViewAdapter();
	//  121  256:aload_0         
	//  122  257:new             #18  <Class ActivityChooserView$ActivityChooserViewAdapter>
	//  123  260:dup             
	//  124  261:aload_0         
	//  125  262:invokespecial   #200 <Method void ActivityChooserView$ActivityChooserViewAdapter(ActivityChooserView)>
	//  126  265:putfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	...
	//  127  268:aload_0         
	//  128  269:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//  129  272:new             #16  <Class ActivityChooserView$5>
	//  130  275:dup             
	//  131  276:aload_0         
	//  132  277:invokespecial   #203 <Method void ActivityChooserView$5(ActivityChooserView)>
	//  133  280:invokevirtual   #207 <Method void ActivityChooserView$ActivityChooserViewAdapter.registerDataSetObserver(DataSetObserver)>
		context = ((Context) (context.getResources()));
	//  134  283:aload_1         
	//  135  284:invokevirtual   #211 <Method Resources Context.getResources()>
	//  136  287:astore_1        
	...
	//  137  288:aload_0         
	//  138  289:aload_1         
	//  139  290:invokevirtual   #217 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//  140  293:getfield        #222 <Field int DisplayMetrics.widthPixels>
	//  141  296:iconst_2        
	//  142  297:idiv            
	//  143  298:aload_1         
	//  144  299:getstatic       #227 <Field int android.support.v7.appcompat.R$dimen.abc_config_prefDialogWidth>
	//  145  302:invokevirtual   #231 <Method int Resources.getDimensionPixelSize(int)>
	//  146  305:invokestatic    #236 <Method int Math.max(int, int)>
	//  147  308:putfield        #238 <Field int mListPopupMaxWidth>
	//  148  311:return          
	}
	...
	public boolean dismissPopup()
	{
		if(isShowingPopup())
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #243 <Method boolean isShowingPopup()>
	//*   2    4:ifeq            34
		{
			getListPopupWindow().dismiss();
	//    3    7:aload_0         
	//    4    8:invokevirtual   #247 <Method ListPopupWindow getListPopupWindow()>
	//    5   11:invokevirtual   #252 <Method void ListPopupWindow.dismiss()>
			ViewTreeObserver viewtreeobserver = getViewTreeObserver();
	//    6   14:aload_0         
	//    7   15:invokevirtual   #256 <Method ViewTreeObserver getViewTreeObserver()>
	//    8   18:astore_1        
			if(viewtreeobserver.isAlive())
	//*   9   19:aload_1         
	//*  10   20:invokevirtual   #261 <Method boolean ViewTreeObserver.isAlive()>
	//*  11   23:ifeq            34
				viewtreeobserver.removeGlobalOnLayoutListener(mOnGlobalLayoutListener);
	//   12   26:aload_1         
	//   13   27:aload_0         
	//   14   28:getfield        #78  <Field android.view.ViewTreeObserver$OnGlobalLayoutListener mOnGlobalLayoutListener>
	//   15   31:invokevirtual   #265 <Method void ViewTreeObserver.removeGlobalOnLayoutListener(android.view.ViewTreeObserver$OnGlobalLayoutListener)>
		}
		return true;
	//   16   34:iconst_1        
	//   17   35:ireturn         
	...
	//    0    0:aload_0         
	//    1    1:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//    2    4:invokevirtual   #269 <Method ActivityChooserModel ActivityChooserView$ActivityChooserViewAdapter.getDataModel()>
	//    3    7:areturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #271 <Field ListPopupWindow mListPopupWindow>
	//*   2    4:ifnonnull       71
		{
			mListPopupWindow = new ListPopupWindow(getContext());
	//    3    7:aload_0         
	//    4    8:new             #249 <Class ListPopupWindow>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:invokevirtual   #116 <Method Context getContext()>
	//    8   16:invokespecial   #273 <Method void ListPopupWindow(Context)>
	//    9   19:putfield        #271 <Field ListPopupWindow mListPopupWindow>
			mListPopupWindow.setAdapter(((android.widget.ListAdapter) (mAdapter)));
	//   10   22:aload_0         
	//   11   23:getfield        #271 <Field ListPopupWindow mListPopupWindow>
	//   12   26:aload_0         
	//   13   27:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//   14   30:invokevirtual   #277 <Method void ListPopupWindow.setAdapter(android.widget.ListAdapter)>
			mListPopupWindow.setAnchorView(((View) (this)));
	//   15   33:aload_0         
	//   16   34:getfield        #271 <Field ListPopupWindow mListPopupWindow>
	//   17   37:aload_0         
	//   18   38:invokevirtual   #281 <Method void ListPopupWindow.setAnchorView(View)>
			mListPopupWindow.setModal(true);
	//   19   41:aload_0         
	//   20   42:getfield        #271 <Field ListPopupWindow mListPopupWindow>
	//   21   45:iconst_1        
	//   22   46:invokevirtual   #285 <Method void ListPopupWindow.setModal(boolean)>
			mListPopupWindow.setOnItemClickListener(((android.widget.AdapterView.OnItemClickListener) (mCallbacks)));
	//   23   49:aload_0         
	//   24   50:getfield        #271 <Field ListPopupWindow mListPopupWindow>
	//   25   53:aload_0         
	//   26   54:getfield        #134 <Field ActivityChooserView$Callbacks mCallbacks>
	//   27   57:invokevirtual   #289 <Method void ListPopupWindow.setOnItemClickListener(android.widget.AdapterView$OnItemClickListener)>
			mListPopupWindow.setOnDismissListener(((android.widget.PopupWindow.OnDismissListener) (mCallbacks)));
	//   28   60:aload_0         
	//   29   61:getfield        #271 <Field ListPopupWindow mListPopupWindow>
	//   30   64:aload_0         
	//   31   65:getfield        #134 <Field ActivityChooserView$Callbacks mCallbacks>
	//   32   68:invokevirtual   #293 <Method void ListPopupWindow.setOnDismissListener(android.widget.PopupWindow$OnDismissListener)>
		}
		return mListPopupWindow;
	//   33   71:aload_0         
	//   34   72:getfield        #271 <Field ListPopupWindow mListPopupWindow>
	//   35   75:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #247 <Method ListPopupWindow getListPopupWindow()>
	//    2    4:invokevirtual   #296 <Method boolean ListPopupWindow.isShowing()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #299 <Method void ViewGroup.onAttachedToWindow()>
		ActivityChooserModel activitychoosermodel = mAdapter.getDataModel();
	//    2    4:aload_0         
	//    3    5:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//    4    8:invokevirtual   #269 <Method ActivityChooserModel ActivityChooserView$ActivityChooserViewAdapter.getDataModel()>
	//    5   11:astore_1        
	...
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #75  <Field DataSetObserver mModelDataSetObserver>
	//   11   21:invokevirtual   #305 <Method void ActivityChooserModel.registerObserver(Object)>
		mIsAttachedToWindow = true;
	//   12   24:aload_0         
	//   13   25:iconst_1        
	//   14   26:putfield        #307 <Field boolean mIsAttachedToWindow>
	//   15   29:return          
	}
	...
	//    9   17:aload_0         
	//   10   18:getfield        #75  <Field DataSetObserver mModelDataSetObserver>
	//   11   21:invokevirtual   #313 <Method void ActivityChooserModel.unregisterObserver(Object)>
		obj = ((Object) (getViewTreeObserver()));
	//   12   24:aload_0         
	//   13   25:invokevirtual   #256 <Method ViewTreeObserver getViewTreeObserver()>
	//   14   28:astore_1        
		if(((ViewTreeObserver) (obj)).isAlive())
	//*  15   29:aload_1         
	//*  16   30:invokevirtual   #261 <Method boolean ViewTreeObserver.isAlive()>
	//*  17   33:ifeq            44
			((ViewTreeObserver) (obj)).removeGlobalOnLayoutListener(mOnGlobalLayoutListener);
	//   18   36:aload_1         
	//   19   37:aload_0         
	//   20   38:getfield        #78  <Field android.view.ViewTreeObserver$OnGlobalLayoutListener mOnGlobalLayoutListener>
	//   21   41:invokevirtual   #265 <Method void ViewTreeObserver.removeGlobalOnLayoutListener(android.view.ViewTreeObserver$OnGlobalLayoutListener)>
		if(isShowingPopup())
	//*  22   44:aload_0         
	//*  23   45:invokevirtual   #243 <Method boolean isShowingPopup()>
	//*  24   48:ifeq            56
			dismissPopup();
	//   25   51:aload_0         
	//   26   52:invokevirtual   #315 <Method boolean dismissPopup()>
	//   27   55:pop             
		mIsAttachedToWindow = false;
	//   28   56:aload_0         
	//   29   57:iconst_0        
	//   30   58:putfield        #307 <Field boolean mIsAttachedToWindow>
	//   31   61:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #145 <Field View mActivityChooserContent>
	//    2    4:iconst_0        
	//    3    5:iconst_0        
	//    4    6:iload           4
	//    5    8:iload_2         
	...
	//    8   12:iload_3         
	//    9   13:isub            
	//   10   14:invokevirtual   #321 <Method void View.layout(int, int, int, int)>
		if(!isShowingPopup())
	//*  11   17:aload_0         
	//*  12   18:invokevirtual   #243 <Method boolean isShowingPopup()>
	//*  13   21:ifne            29
			dismissPopup();
	//   14   24:aload_0         
	//   15   25:invokevirtual   #315 <Method boolean dismissPopup()>
	//   16   28:pop             
	//   17   29:return          
	}
	...
	//*   5    8:aload_0         
	//*   6    9:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//*   7   12:invokevirtual   #327 <Method int FrameLayout.getVisibility()>
	//*   8   15:ifeq            29
			k = android.view.View.MeasureSpec.makeMeasureSpec(android.view.View.MeasureSpec.getSize(j), 0x40000000);
	//    9   18:iload_2         
	//   10   19:invokestatic    #332 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   11   22:ldc2            #333 <Int 0x40000000>
	//   12   25:invokestatic    #336 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   13   28:istore_3        
	...
	//   16   32:iload_1         
	//   17   33:iload_3         
	//   18   34:invokevirtual   #340 <Method void measureChild(View, int, int)>
		setMeasuredDimension(view.getMeasuredWidth(), view.getMeasuredHeight());
	//   19   37:aload_0         
	//   20   38:aload           4
	//   21   40:invokevirtual   #343 <Method int View.getMeasuredWidth()>
	//   22   43:aload           4
	//   23   45:invokevirtual   #346 <Method int View.getMeasuredHeight()>
	//   24   48:invokevirtual   #349 <Method void setMeasuredDimension(int, int)>
	//   25   51:return          
	}
	...
	//    1    1:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #354 <Method void ActivityChooserView$ActivityChooserViewAdapter.setDataModel(ActivityChooserModel)>
		if(isShowingPopup())
	//*   4    8:aload_0         
	//*   5    9:invokevirtual   #243 <Method boolean isShowingPopup()>
	//*   6   12:ifeq            25
		{
			dismissPopup();
	//    7   15:aload_0         
	//    8   16:invokevirtual   #315 <Method boolean dismissPopup()>
	//    9   19:pop             
			showPopup();
	//   10   20:aload_0         
	//   11   21:invokevirtual   #357 <Method boolean showPopup()>
	//   12   24:pop             
		}
	//   13   25:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #361 <Field int mDefaultActionButtonContentDescription>
	//    3    5:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:invokevirtual   #366 <Method String Context.getString(int)>
	//    4    8:astore_2        
		mExpandActivityOverflowButtonImage.setContentDescription(((CharSequence) (s)));
	//    5    9:aload_0         
	//    6   10:getfield        #195 <Field ImageView mExpandActivityOverflowButtonImage>
	//    7   13:aload_2         
	//    8   14:invokevirtual   #370 <Method void ImageView.setContentDescription(CharSequence)>
	//    9   17:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #195 <Field ImageView mExpandActivityOverflowButtonImage>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #199 <Method void ImageView.setImageDrawable(Drawable)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #80  <Field int mInitialActivityCount>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #374 <Field android.widget.PopupWindow$OnDismissListener mOnDismissListener>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #378 <Field ActionProvider mProvider>
	//    3    5:return          
	}
	...
	//*   3    7:aload_0         
	//*   4    8:getfield        #307 <Field boolean mIsAttachedToWindow>
	//*   5   11:ifne            16
			{
				return false;
	//    6   14:iconst_0        
	...
	//    8   16:aload_0         
	//    9   17:iconst_0        
	//   10   18:putfield        #381 <Field boolean mIsSelectingDefaultActivity>
				showPopupUnchecked(mInitialActivityCount);
	//   11   21:aload_0         
	//   12   22:aload_0         
	//   13   23:getfield        #80  <Field int mInitialActivityCount>
	//   14   26:invokevirtual   #384 <Method void showPopupUnchecked(int)>
				return true;
	//   15   29:iconst_1        
	//   16   30:ireturn         
			}
	...
	//    3    7:invokespecial   #393 <Method void Runtime(String)>
	//    4   10:athrow          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//*   2    4:invokevirtual   #397 <Method int ActivityChooserView$ActivityChooserViewAdapter.getCount()>
	//*   3    7:ifle            21
			mExpandActivityOverflowButton.setEnabled(true);
	//    4   10:aload_0         
	//    5   11:getfield        #193 <Field FrameLayout mExpandActivityOverflowButton>
	//    6   14:iconst_1        
	//    7   15:invokevirtual   #400 <Method void FrameLayout.setEnabled(boolean)>
		else
	//*   8   18:goto            29
			mExpandActivityOverflowButton.setEnabled(false);
	//    9   21:aload_0         
	//   10   22:getfield        #193 <Field FrameLayout mExpandActivityOverflowButton>
	//   11   25:iconst_0        
	//   12   26:invokevirtual   #400 <Method void FrameLayout.setEnabled(boolean)>
		int i = mAdapter.getActivityCount();
	//   13   29:aload_0         
	//   14   30:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//   15   33:invokevirtual   #403 <Method int ActivityChooserView$ActivityChooserViewAdapter.getActivityCount()>
	//   16   36:istore_1        
		int j = mAdapter.getHistorySize();
	//   17   37:aload_0         
	//   18   38:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//   19   41:invokevirtual   #406 <Method int ActivityChooserView$ActivityChooserViewAdapter.getHistorySize()>
	//   20   44:istore_2        
		if(i != 1 && (i <= 1 || j <= 0))
	//*  21   45:iload_1         
	//*  22   46:iconst_1        
	...
	//   30   62:aload_0         
	//   31   63:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//   32   66:bipush          8
	//   33   68:invokevirtual   #409 <Method void FrameLayout.setVisibility(int)>
		} else
	//*  34   71:goto            154
		{
			mDefaultActivityButton.setVisibility(0);
	//   35   74:aload_0         
	//   36   75:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//   37   78:iconst_0        
	//   38   79:invokevirtual   #409 <Method void FrameLayout.setVisibility(int)>
			Object obj = ((Object) (mAdapter.getDefaultActivity()));
	//   39   82:aload_0         
	//   40   83:getfield        #202 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//   41   86:invokevirtual   #413 <Method ResolveInfo ActivityChooserView$ActivityChooserViewAdapter.getDefaultActivity()>
	//   42   89:astore_3        
			android.content.pm.PackageManager packagemanager = getContext().getPackageManager();
	//   43   90:aload_0         
	//   44   91:invokevirtual   #116 <Method Context getContext()>
	//   45   94:invokevirtual   #417 <Method android.content.pm.PackageManager Context.getPackageManager()>
	//   46   97:astore          4
			mDefaultActivityButtonImage.setImageDrawable(((ResolveInfo) (obj)).loadIcon(packagemanager));
	//   47   99:aload_0         
	//   48  100:getfield        #176 <Field ImageView mDefaultActivityButtonImage>
	//   49  103:aload_3         
	//   50  104:aload           4
	//   51  106:invokevirtual   #423 <Method Drawable ResolveInfo.loadIcon(android.content.pm.PackageManager)>
	//   52  109:invokevirtual   #199 <Method void ImageView.setImageDrawable(Drawable)>
			if(mDefaultActionButtonContentDescription != 0)
	//*  53  112:aload_0         
	//*  54  113:getfield        #361 <Field int mDefaultActionButtonContentDescription>
	//*  55  116:ifeq            154
			{
				obj = ((Object) (((ResolveInfo) (obj)).loadLabel(packagemanager)));
	//   56  119:aload_3         
	//   57  120:aload           4
	//   58  122:invokevirtual   #427 <Method CharSequence ResolveInfo.loadLabel(android.content.pm.PackageManager)>
	//   59  125:astore_3        
				obj = ((Object) (getContext().getString(mDefaultActionButtonContentDescription, new Object[] {
					obj
				})));
	//   60  126:aload_0         
	//   61  127:invokevirtual   #116 <Method Context getContext()>
	//   62  130:aload_0         
	//   63  131:getfield        #361 <Field int mDefaultActionButtonContentDescription>
	//   64  134:iconst_1        
	...
	//   68  140:aload_3         
	//   69  141:aastore         
	//   70  142:invokevirtual   #432 <Method String Context.getString(int, Object[])>
	//   71  145:astore_3        
				mDefaultActivityButton.setContentDescription(((CharSequence) (obj)));
	//   72  146:aload_0         
	//   73  147:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//   74  150:aload_3         
	//   75  151:invokevirtual   #433 <Method void FrameLayout.setContentDescription(CharSequence)>
			}
		}
		if(mDefaultActivityButton.getVisibility() == 0)
	//*  76  154:aload_0         
	//*  77  155:getfield        #160 <Field FrameLayout mDefaultActivityButton>
	//*  78  158:invokevirtual   #327 <Method int FrameLayout.getVisibility()>
	//*  79  161:ifne            176
		{
			mActivityChooserContent.setBackgroundDrawable(mActivityChooserContentBackground);
	//   80  164:aload_0         
	//   81  165:getfield        #145 <Field View mActivityChooserContent>
	//   82  168:aload_0         
	//   83  169:getfield        #153 <Field Drawable mActivityChooserContentBackground>
	//   84  172:invokevirtual   #436 <Method void View.setBackgroundDrawable(Drawable)>
			return;
	//   85  175:return          
		} else
		{
	...
	//   86  176:aload_0         
	//   87  177:getfield        #145 <Field View mActivityChooserContent>
	//   88  180:aconst_null     
	//   89  181:invokevirtual   #436 <Method void View.setBackgroundDrawable(Drawable)>
			return;
	//   90  184:return          
		}
	}
