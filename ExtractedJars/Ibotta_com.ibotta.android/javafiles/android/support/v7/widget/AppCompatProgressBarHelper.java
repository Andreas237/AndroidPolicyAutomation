...
class AppCompatProgressBarHelper
{
	...
	//*   0    0:aload_1         
	//*   1    1:instanceof      #35  <Class WrappedDrawable>
	//*   2    4:ifeq            43
		{
			WrappedDrawable wrappeddrawable = (WrappedDrawable)drawable;
	//    3    7:aload_1         
	//    4    8:checkcast       #35  <Class WrappedDrawable>
	//    5   11:astore          7
			Drawable drawable1 = wrappeddrawable.getWrappedDrawable();
	//    6   13:aload           7
	//    7   15:invokeinterface #39  <Method Drawable WrappedDrawable.getWrappedDrawable()>
	//    8   20:astore          8
			if(drawable1 != null)
	//*   9   22:aload           8
	//*  10   24:ifnull          283
			{
				wrappeddrawable.setWrappedDrawable(tileify(drawable1, flag));
	//   11   27:aload           7
	//   12   29:aload_0         
	//   13   30:aload           8
	//   14   32:iload_2         
	//   15   33:invokespecial   #41  <Method Drawable tileify(Drawable, boolean)>
	//   16   36:invokeinterface #45  <Method void WrappedDrawable.setWrappedDrawable(Drawable)>
				return drawable;
	//   17   41:aload_1         
	//   18   42:areturn         
			}
	...
	//*  19   43:aload_1         
	//*  20   44:instanceof      #47  <Class LayerDrawable>
	//*  21   47:ifeq            176
			{
				drawable = ((Drawable) ((LayerDrawable)drawable));
	//   22   50:aload_1         
	//   23   51:checkcast       #47  <Class LayerDrawable>
	//   24   54:astore_1        
				int k = ((LayerDrawable) (drawable)).getNumberOfLayers();
	//   25   55:aload_1         
	//   26   56:invokevirtual   #51  <Method int LayerDrawable.getNumberOfLayers()>
	//   27   59:istore          5
	...
	//   38   79:aload_1         
	//   39   80:iload_3         
	//   40   81:invokevirtual   #57  <Method int LayerDrawable.getId(int)>
	//   41   84:istore          6
					Drawable drawable2 = ((LayerDrawable) (drawable)).getDrawable(i);
	//   42   86:aload_1         
	//   43   87:iload_3         
	//   44   88:invokevirtual   #61  <Method Drawable LayerDrawable.getDrawable(int)>
	//   45   91:astore          8
					if(l != 0x102000d && l != 0x102000f)
	//*  46   93:iload           6
	//*  47   95:ldc1            #62  <Int 0x102000d>
	//*  48   97:icmpeq          115
	//*  49  100:iload           6
	//*  50  102:ldc1            #63  <Int 0x102000f>
	//*  51  104:icmpne          110
	//*  52  107:goto            115
						flag = false;
	//   53  110:iconst_0        
	...
	//   70  135:new             #47  <Class LayerDrawable>
	//   71  138:dup             
	//   72  139:aload           7
	...
	//*  93  176:aload_1         
	//*  94  177:instanceof      #72  <Class BitmapDrawable>
	//*  95  180:ifeq            283
			{
				drawable = ((Drawable) ((BitmapDrawable)drawable));
	//   96  183:aload_1         
	//   97  184:checkcast       #72  <Class BitmapDrawable>
	//   98  187:astore_1        
				Object obj = ((Object) (((BitmapDrawable) (drawable)).getBitmap()));
	//   99  188:aload_1         
	//  100  189:invokevirtual   #76  <Method Bitmap BitmapDrawable.getBitmap()>
	//  101  192:astore          8
				if(mSampleTile == null)
	//* 102  194:aload_0         
	//* 103  195:getfield        #78  <Field Bitmap mSampleTile>
	//* 104  198:ifnonnull       207
					mSampleTile = ((Bitmap) (obj));
	//  105  201:aload_0         
	//  106  202:aload           8
	//  107  204:putfield        #78  <Field Bitmap mSampleTile>
				ShapeDrawable shapedrawable = new ShapeDrawable(getDrawableShape());
	//  108  207:new             #80  <Class ShapeDrawable>
	//  109  210:dup             
	//  110  211:aload_0         
	//  111  212:invokespecial   #82  <Method Shape getDrawableShape()>
	//  112  215:invokespecial   #85  <Method void ShapeDrawable(Shape)>
	//  113  218:astore          7
				obj = ((Object) (new BitmapShader(((Bitmap) (obj)), android.graphics.Shader.TileMode.REPEAT, android.graphics.Shader.TileMode.CLAMP)));
	//  114  220:new             #87  <Class BitmapShader>
	//  115  223:dup             
	//  116  224:aload           8
	//  117  226:getstatic       #93  <Field android.graphics.Shader$TileMode android.graphics.Shader$TileMode.REPEAT>
	//  118  229:getstatic       #96  <Field android.graphics.Shader$TileMode android.graphics.Shader$TileMode.CLAMP>
	//  119  232:invokespecial   #99  <Method void BitmapShader(Bitmap, android.graphics.Shader$TileMode, android.graphics.Shader$TileMode)>
	//  120  235:astore          8
				shapedrawable.getPaint().setShader(((android.graphics.Shader) (obj)));
	//  121  237:aload           7
	//  122  239:invokevirtual   #103 <Method Paint ShapeDrawable.getPaint()>
	//  123  242:aload           8
	//  124  244:invokevirtual   #109 <Method android.graphics.Shader Paint.setShader(android.graphics.Shader)>
	//  125  247:pop             
				shapedrawable.getPaint().setColorFilter(((BitmapDrawable) (drawable)).getPaint().getColorFilter());
	//  126  248:aload           7
	//  127  250:invokevirtual   #103 <Method Paint ShapeDrawable.getPaint()>
	//  128  253:aload_1         
	//  129  254:invokevirtual   #110 <Method Paint BitmapDrawable.getPaint()>
	//  130  257:invokevirtual   #114 <Method android.graphics.ColorFilter Paint.getColorFilter()>
	//  131  260:invokevirtual   #118 <Method android.graphics.ColorFilter Paint.setColorFilter(android.graphics.ColorFilter)>
	//  132  263:pop             
				if(flag)
	//* 133  264:iload_2         
	//* 134  265:ifeq            280
