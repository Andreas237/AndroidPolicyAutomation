...
public static class SearchView$SearchAutoComplete extends AppCompatAutoCompleteTextView
{
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #75  <Method android.text.Editable getText()>
	...
	//   20   44:aload_0         
	//   21   45:iconst_1        
	//   22   46:invokevirtual   #189 <Method void SearchView$AutoCompleteTextViewReflector.ensureImeVisible(android.widget.AutoCompleteTextView, boolean)>
		}
	//   23   49:return          
	}
	...
	//*  23   42:aload_2         
	//*  24   43:aload_0         
	//*  25   44:invokevirtual   #214 <Method boolean InputMethodManager.isActive(android.view.View)>
	//*  26   47:ifeq            72
		{
			mHasPendingShowSoftInputRequest = false;
	//   27   50:aload_0         
	...
	//   36   65:aload_0         
	//   37   66:iconst_0        
	//   38   67:invokevirtual   #218 <Method boolean InputMethodManager.showSoftInput(android.view.View, int)>
	//   39   70:pop             
			return;
	//   40   71:return          
		} else
	...
	//    8   19:aload_0         
	//    9   20:iconst_0        
	//   10   21:invokevirtual   #218 <Method boolean InputMethodManager.showSoftInput(android.view.View, int)>
	//   11   24:pop             
			mHasPendingShowSoftInputRequest = false;
	//   12   25:aload_0         
	//   13   26:iconst_0        
