...
;
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #90  <Method void android.support.v7.widget.RecyclerView$ItemDecoration()>
	//    2    4:aload_0         
	//    3    5:new             #92  <Class ArrayList>
	//    4    8:dup             
	//    5    9:invokespecial   #93  <Method void ArrayList()>
	//    6   12:putfield        #95  <Field List mPendingCleanup>
	//    7   15:aload_0         
	//    8   16:iconst_2        
	//    9   17:newarray        float[]
	//   10   19:putfield        #97  <Field float[] mTmpPosition>
		mSelected = null;
	//   11   22:aload_0         
	//   12   23:aconst_null     
	//   13   24:putfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
		mActivePointerId = -1;
	//   14   27:aload_0         
	//   15   28:iconst_m1       
	//   16   29:putfield        #101 <Field int mActivePointerId>
		mActionState = 0;
	//   17   32:aload_0         
	//   18   33:iconst_0        
	//   19   34:putfield        #103 <Field int mActionState>
		mRecoverAnimations = ((List) (new ArrayList()));
	//   20   37:aload_0         
	//   21   38:new             #92  <Class ArrayList>
	//   22   41:dup             
	//   23   42:invokespecial   #93  <Method void ArrayList()>
	//   24   45:putfield        #105 <Field List mRecoverAnimations>
	//   25   48:aload_0         
	//   26   49:new             #8   <Class ItemTouchHelper$1>
	//   27   52:dup             
	//   28   53:aload_0         
	//   29   54:invokespecial   #108 <Method void ItemTouchHelper$1(ItemTouchHelper)>
	//   30   57:putfield        #110 <Field Runnable mScrollRunnable>
		mChildDrawingOrderCallback = null;
	//   31   60:aload_0         
	//   32   61:aconst_null     
	//   33   62:putfield        #112 <Field android.support.v7.widget.RecyclerView$ChildDrawingOrderCallback mChildDrawingOrderCallback>
		mOverdrawChild = null;
	//   34   65:aload_0         
	//   35   66:aconst_null     
	//   36   67:putfield        #114 <Field View mOverdrawChild>
		mOverdrawChildPosition = -1;
	//   37   70:aload_0         
	//   38   71:iconst_m1       
	//   39   72:putfield        #116 <Field int mOverdrawChildPosition>
	//   40   75:aload_0         
	//   41   76:new             #10  <Class ItemTouchHelper$2>
	//   42   79:dup             
	//   43   80:aload_0         
	//   44   81:invokespecial   #117 <Method void ItemTouchHelper$2(ItemTouchHelper)>
	//   45   84:putfield        #119 <Field android.support.v7.widget.RecyclerView$OnItemTouchListener mOnItemTouchListener>
		mCallback = callback;
	//   46   87:aload_0         
	//   47   88:aload_1         
	//   48   89:putfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   49   92:return          
	}
	...
	//*   0    0:getstatic       #129 <Field int android.os.Build$VERSION.SDK_INT>
	//*   1    3:bipush          21
	//*   2    5:icmplt          9
			return;
	//    3    8:return          
	...
	//*   4    9:aload_0         
	//*   5   10:getfield        #112 <Field android.support.v7.widget.RecyclerView$ChildDrawingOrderCallback mChildDrawingOrderCallback>
	//*   6   13:ifnonnull       28
...
;
	...
	//    9   20:dup             
	//   10   21:aload_0         
	//   11   22:invokespecial   #130 <Method void ItemTouchHelper$5(ItemTouchHelper)>
	//   12   25:putfield        #112 <Field android.support.v7.widget.RecyclerView$ChildDrawingOrderCallback mChildDrawingOrderCallback>
		mRecyclerView.setChildDrawingOrderCallback(mChildDrawingOrderCallback);
	//   13   28:aload_0         
	//   14   29:getfield        #132 <Field RecyclerView mRecyclerView>
	//   15   32:aload_0         
	//   16   33:getfield        #112 <Field android.support.v7.widget.RecyclerView$ChildDrawingOrderCallback mChildDrawingOrderCallback>
	//   17   36:invokevirtual   #138 <Method void RecyclerView.setChildDrawingOrderCallback(android.support.v7.widget.RecyclerView$ChildDrawingOrderCallback)>
	//   18   39:return          
	}
	...
	//*   3    4:ifeq            203
		{
			float f = mDx;
	//    4    7:aload_0         
	//    5    8:getfield        #142 <Field float mDx>
	//    6   11:fstore_3        
			byte byte1 = 8;
	//    7   12:bipush          8
	//    8   14:istore          6
	...
	//   18   32:aload_0         
	//   19   33:getfield        #144 <Field VelocityTracker mVelocityTracker>
	//   20   36:astore          7
			if(velocitytracker != null && mActivePointerId > -1)
	//*  21   38:aload           7
	//*  22   40:ifnull          159
	//*  23   43:aload_0         
	//*  24   44:getfield        #101 <Field int mActivePointerId>
	//*  25   47:iconst_m1       
	//*  26   48:icmple          159
			{
	...
	//   28   53:sipush          1000
	//   29   56:aload_0         
	//   30   57:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   31   60:aload_0         
	//   32   61:getfield        #146 <Field float mMaxSwipeVelocity>
	//   33   64:invokevirtual   #150 <Method float ItemTouchHelper$Callback.getSwipeVelocityThreshold(float)>
	//   34   67:invokevirtual   #156 <Method void VelocityTracker.computeCurrentVelocity(int, float)>
				float f1 = mVelocityTracker.getXVelocity(mActivePointerId);
	//   35   70:aload_0         
	//   36   71:getfield        #144 <Field VelocityTracker mVelocityTracker>
	//   37   74:aload_0         
	//   38   75:getfield        #101 <Field int mActivePointerId>
	//   39   78:invokevirtual   #160 <Method float VelocityTracker.getXVelocity(int)>
	//   40   81:fstore          4
				f = mVelocityTracker.getYVelocity(mActivePointerId);
	//   41   83:aload_0         
	//   42   84:getfield        #144 <Field VelocityTracker mVelocityTracker>
	//   43   87:aload_0         
	//   44   88:getfield        #101 <Field int mActivePointerId>
	//   45   91:invokevirtual   #163 <Method float VelocityTracker.getYVelocity(int)>
	//   46   94:fstore_3        
				if(f1 <= 0.0F)
	//*  47   95:fload           4
	//*  48   97:fconst_0        
	...
	//   53  106:istore          6
				f1 = Math.abs(f1);
	//   54  108:fload           4
	//   55  110:invokestatic    #168 <Method float Math.abs(float)>
	//   56  113:fstore          4
	...
	//*  64  129:fload           4
	//*  65  131:aload_0         
	//*  66  132:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//*  67  135:aload_0         
	//*  68  136:getfield        #170 <Field float mSwipeEscapeVelocity>
	//*  69  139:invokevirtual   #173 <Method float ItemTouchHelper$Callback.getSwipeEscapeVelocity(float)>
	//*  70  142:fcmpl           
	//*  71  143:iflt            159
	//*  72  146:fload           4
	//*  73  148:fload_3         
	//*  74  149:invokestatic    #168 <Method float Math.abs(float)>
	//*  75  152:fcmpl           
	//*  76  153:ifle            159
					return ((int) (byte1));
	//   77  156:iload           6
	...
	//   79  159:aload_0         
	//   80  160:getfield        #132 <Field RecyclerView mRecyclerView>
	//   81  163:invokevirtual   #177 <Method int RecyclerView.getWidth()>
	//   82  166:i2f             
	//   83  167:fstore_3        
			float f2 = mCallback.getSwipeThreshold(viewholder);
	//   84  168:aload_0         
	//   85  169:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   86  172:aload_1         
	//   87  173:invokevirtual   #181 <Method float ItemTouchHelper$Callback.getSwipeThreshold(android.support.v7.widget.RecyclerView$ViewHolder)>
	//   88  176:fstore          4
	...
	//*  92  182:ifeq            203
	//*  93  185:aload_0         
	//*  94  186:getfield        #142 <Field float mDx>
	//*  95  189:invokestatic    #168 <Method float Math.abs(float)>
	//*  96  192:fload_3         
	//*  97  193:fload           4
	//*  98  195:fmul            
	//*  99  196:fcmpl           
	...
	//*   3    3:ifeq            200
		{
			float f = mDy;
	//    4    6:aload_0         
	//    5    7:getfield        #184 <Field float mDy>
	//    6   10:fstore_3        
			byte byte1 = 2;
	//    7   11:iconst_2        
	//    8   12:istore          6
	...
	//   17   27:istore          5
			VelocityTracker velocitytracker = mVelocityTracker;
	//   18   29:aload_0         
	//   19   30:getfield        #144 <Field VelocityTracker mVelocityTracker>
	//   20   33:astore          7
			if(velocitytracker != null && mActivePointerId > -1)
	//*  21   35:aload           7
	//*  22   37:ifnull          156
	//*  23   40:aload_0         
	//*  24   41:getfield        #101 <Field int mActivePointerId>
	//*  25   44:iconst_m1       
	//*  26   45:icmple          156
			{
				velocitytracker.computeCurrentVelocity(1000, mCallback.getSwipeVelocityThreshold(mMaxSwipeVelocity));
	...
	//   28   50:sipush          1000
	//   29   53:aload_0         
	//   30   54:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   31   57:aload_0         
	//   32   58:getfield        #146 <Field float mMaxSwipeVelocity>
	//   33   61:invokevirtual   #150 <Method float ItemTouchHelper$Callback.getSwipeVelocityThreshold(float)>
	//   34   64:invokevirtual   #156 <Method void VelocityTracker.computeCurrentVelocity(int, float)>
				f = mVelocityTracker.getXVelocity(mActivePointerId);
	//   35   67:aload_0         
	//   36   68:getfield        #144 <Field VelocityTracker mVelocityTracker>
	//   37   71:aload_0         
	//   38   72:getfield        #101 <Field int mActivePointerId>
	//   39   75:invokevirtual   #160 <Method float VelocityTracker.getXVelocity(int)>
	//   40   78:fstore_3        
				float f1 = mVelocityTracker.getYVelocity(mActivePointerId);
	//   41   79:aload_0         
	//   42   80:getfield        #144 <Field VelocityTracker mVelocityTracker>
	//   43   83:aload_0         
	//   44   84:getfield        #101 <Field int mActivePointerId>
	//   45   87:invokevirtual   #163 <Method float VelocityTracker.getYVelocity(int)>
	//   46   90:fstore          4
				if(f1 <= 0.0F)
	//*  47   92:fload           4
	//*  48   94:fconst_0        
	...
	//   53  103:istore          6
				f1 = Math.abs(f1);
	//   54  105:fload           4
	//   55  107:invokestatic    #168 <Method float Math.abs(float)>
	//   56  110:fstore          4
	...
	//*  64  126:fload           4
	//*  65  128:aload_0         
	//*  66  129:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//*  67  132:aload_0         
	//*  68  133:getfield        #170 <Field float mSwipeEscapeVelocity>
	//*  69  136:invokevirtual   #173 <Method float ItemTouchHelper$Callback.getSwipeEscapeVelocity(float)>
	//*  70  139:fcmpl           
	//*  71  140:iflt            156
	//*  72  143:fload           4
	//*  73  145:fload_3         
	//*  74  146:invokestatic    #168 <Method float Math.abs(float)>
	//*  75  149:fcmpl           
	//*  76  150:ifle            156
					return ((int) (byte1));
	//   77  153:iload           6
	...
	//   79  156:aload_0         
	//   80  157:getfield        #132 <Field RecyclerView mRecyclerView>
	//   81  160:invokevirtual   #187 <Method int RecyclerView.getHeight()>
	//   82  163:i2f             
	//   83  164:fstore_3        
			float f2 = mCallback.getSwipeThreshold(viewholder);
	//   84  165:aload_0         
	//   85  166:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   86  169:aload_1         
	//   87  170:invokevirtual   #181 <Method float ItemTouchHelper$Callback.getSwipeThreshold(android.support.v7.widget.RecyclerView$ViewHolder)>
	//   88  173:fstore          4
	...
	//*  92  179:ifeq            200
	//*  93  182:aload_0         
	//*  94  183:getfield        #184 <Field float mDy>
	//*  95  186:invokestatic    #168 <Method float Math.abs(float)>
	//*  96  189:fload_3         
	//*  97  190:fload           4
	//*  98  192:fmul            
	//*  99  193:fcmpl           
	...
	//    0    0:aload_0         
	//    1    1:getfield        #132 <Field RecyclerView mRecyclerView>
	//    2    4:aload_0         
	//    3    5:invokevirtual   #192 <Method void RecyclerView.removeItemDecoration(android.support.v7.widget.RecyclerView$ItemDecoration)>
		mRecyclerView.removeOnItemTouchListener(mOnItemTouchListener);
	//    4    8:aload_0         
	//    5    9:getfield        #132 <Field RecyclerView mRecyclerView>
	//    6   12:aload_0         
	//    7   13:getfield        #119 <Field android.support.v7.widget.RecyclerView$OnItemTouchListener mOnItemTouchListener>
	//    8   16:invokevirtual   #196 <Method void RecyclerView.removeOnItemTouchListener(android.support.v7.widget.RecyclerView$OnItemTouchListener)>
	...
	//    9   19:aload_0         
	//   10   20:getfield        #132 <Field RecyclerView mRecyclerView>
	//   11   23:aload_0         
	//   12   24:invokevirtual   #200 <Method void RecyclerView.removeOnChildAttachStateChangeListener(android.support.v7.widget.RecyclerView$OnChildAttachStateChangeListener)>
		for(int i = mRecoverAnimations.size() - 1; i >= 0; i--)
	//*  13   27:aload_0         
	//*  14   28:getfield        #105 <Field List mRecoverAnimations>
	//*  15   31:invokeinterface #205 <Method int List.size()>
	//*  16   36:iconst_1        
	//*  17   37:isub            
	//*  18   38:istore_1        
	//*  19   39:iload_1         
	...
	//   21   43:aload_0         
	//   22   44:getfield        #105 <Field List mRecoverAnimations>
	//   23   47:iconst_0        
	//   24   48:invokeinterface #209 <Method Object List.get(int)>
	//   25   53:checkcast       #28  <Class ItemTouchHelper$RecoverAnimation>
	//   26   56:astore_2        
			mCallback.clearView(mRecyclerView, recoveranimation.mViewHolder);
	//   27   57:aload_0         
	//   28   58:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   29   61:aload_0         
	//   30   62:getfield        #132 <Field RecyclerView mRecyclerView>
	//   31   65:aload_2         
	//   32   66:getfield        #212 <Field android.support.v7.widget.RecyclerView$ViewHolder ItemTouchHelper$RecoverAnimation.mViewHolder>
	//   33   69:invokevirtual   #216 <Method void ItemTouchHelper$Callback.clearView(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
		}
	...
	//   39   79:aload_0         
	//   40   80:getfield        #105 <Field List mRecoverAnimations>
	//   41   83:invokeinterface #219 <Method void List.clear()>
		mOverdrawChild = null;
	//   42   88:aload_0         
	//   43   89:aconst_null     
	//   44   90:putfield        #114 <Field View mOverdrawChild>
		mOverdrawChildPosition = -1;
	//   45   93:aload_0         
	//   46   94:iconst_m1       
	//   47   95:putfield        #116 <Field int mOverdrawChildPosition>
		releaseVelocityTracker();
	//   48   98:aload_0         
	//   49   99:invokespecial   #222 <Method void releaseVelocityTracker()>
		stopGestureDetection();
	//   50  102:aload_0         
	//   51  103:invokespecial   #225 <Method void stopGestureDetection()>
	//   52  106:return          
	}
	...
	//    2    3:aload_0         
	//    3    4:getfield        #229 <Field List mSwapTargets>
	//    4    7:astore          15
		if(list == null)
	//*   5    9:aload           15
	//*   6   11:ifnonnull       39
	...
	//    7   14:aload_0         
	//    8   15:new             #92  <Class ArrayList>
	//    9   18:dup             
	//   10   19:invokespecial   #93  <Method void ArrayList()>
	//   11   22:putfield        #229 <Field List mSwapTargets>
			mDistances = ((List) (new ArrayList()));
	//   12   25:aload_0         
	//   13   26:new             #92  <Class ArrayList>
	//   14   29:dup             
	//   15   30:invokespecial   #93  <Method void ArrayList()>
	//   16   33:putfield        #231 <Field List mDistances>
		} else
	//*  17   36:goto            55
		{
			list.clear();
	//   18   39:aload           15
	//   19   41:invokeinterface #219 <Method void List.clear()>
			mDistances.clear();
	//   20   46:aload_0         
	//   21   47:getfield        #231 <Field List mDistances>
	//   22   50:invokeinterface #219 <Method void List.clear()>
		}
		int k = mCallback.getBoundingBoxMargin();
	//   23   55:aload_0         
	//   24   56:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   25   59:invokevirtual   #234 <Method int ItemTouchHelper$Callback.getBoundingBoxMargin()>
	//   26   62:istore_3        
		int j1 = Math.round(mSelectedStartX + mDx) - k;
	//   27   63:aload_0         
	//   28   64:getfield        #236 <Field float mSelectedStartX>
	//   29   67:aload_0         
	//   30   68:getfield        #142 <Field float mDx>
	//   31   71:fadd            
	//   32   72:invokestatic    #240 <Method int Math.round(float)>
	//   33   75:iload_3         
	//   34   76:isub            
	//   35   77:istore          5
		int k1 = Math.round(mSelectedStartY + mDy) - k;
	//   36   79:aload_0         
	//   37   80:getfield        #242 <Field float mSelectedStartY>
	//   38   83:aload_0         
	//   39   84:getfield        #184 <Field float mDy>
	//   40   87:fadd            
	//   41   88:invokestatic    #240 <Method int Math.round(float)>
	//   42   91:iload_3         
	//   43   92:isub            
	//   44   93:istore          6
		int i = ((android.support.v7.widget.RecyclerView.ViewHolder) (obj)).itemView.getWidth();
	//   45   95:aload           14
	//   46   97:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   47  100:invokevirtual   #250 <Method int View.getWidth()>
	//   48  103:istore_2        
		k *= 2;
	//   49  104:iload_3         
	//   50  105:iconst_2        
	...
	//   59  116:aload           14
	//   60  118:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   61  121:invokevirtual   #251 <Method int View.getHeight()>
	//   62  124:iload           6
	//   63  126:iadd            
	//   64  127:iload_3         
	//   65  128:iadd            
	...
	//   79  149:aload_0         
	//   80  150:getfield        #132 <Field RecyclerView mRecyclerView>
	//   81  153:invokevirtual   #255 <Method android.support.v7.widget.RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//   82  156:astore          14
		int l2 = ((android.support.v7.widget.RecyclerView.LayoutManager) (obj)).getChildCount();
	//   83  158:aload           14
	//   84  160:invokevirtual   #260 <Method int android.support.v7.widget.RecyclerView$LayoutManager.getChildCount()>
	//   85  163:istore          11
		for(int j = 0; j < l2; j++)
	//*  86  165:iconst_0        
	//*  87  166:istore_2        
	...
	//   91  173:aload           14
	//   92  175:iload_2         
	//   93  176:invokevirtual   #264 <Method View android.support.v7.widget.RecyclerView$LayoutManager.getChildAt(int)>
	//   94  179:astore          15
			if(view == viewholder.itemView || view.getBottom() < k1 || view.getTop() > i2 || view.getRight() < j1 || view.getLeft() > l1)
	//*  95  181:aload           15
	//*  96  183:aload_1         
	//*  97  184:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  98  187:if_acmpne       193
	//*  99  190:goto            404
	//* 100  193:aload           15
	//* 101  195:invokevirtual   #267 <Method int View.getBottom()>
	//* 102  198:iload           6
	//* 103  200:icmplt          404
	//* 104  203:aload           15
	//* 105  205:invokevirtual   #270 <Method int View.getTop()>
	//* 106  208:iload           8
	//* 107  210:icmpgt          404
	//* 108  213:aload           15
	//* 109  215:invokevirtual   #273 <Method int View.getRight()>
	//* 110  218:iload           5
	//* 111  220:icmplt          404
	//* 112  223:aload           15
	//* 113  225:invokevirtual   #276 <Method int View.getLeft()>
	//* 114  228:iload           7
	//* 115  230:icmple          236
				continue;
	//  116  233:goto            404
	...
	//  117  236:aload_0         
	//  118  237:getfield        #132 <Field RecyclerView mRecyclerView>
	//  119  240:aload           15
	//  120  242:invokevirtual   #280 <Method android.support.v7.widget.RecyclerView$ViewHolder RecyclerView.getChildViewHolder(View)>
	//  121  245:astore          16
			if(!mCallback.canDropOver(mRecyclerView, mSelected, viewholder1))
				continue;
	//  122  247:aload_0         
	//  123  248:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  124  251:aload_0         
	//  125  252:getfield        #132 <Field RecyclerView mRecyclerView>
	//  126  255:aload_0         
	//  127  256:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//  128  259:aload           16
	//  129  261:invokevirtual   #284 <Method boolean ItemTouchHelper$Callback.canDropOver(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder, android.support.v7.widget.RecyclerView$ViewHolder)>
	//  130  264:ifeq            404
			int l = Math.abs(j2 - (view.getLeft() + view.getRight()) / 2);
	//  131  267:iload           9
	//  132  269:aload           15
	//  133  271:invokevirtual   #276 <Method int View.getLeft()>
	//  134  274:aload           15
	//  135  276:invokevirtual   #273 <Method int View.getRight()>
	//  136  279:iadd            
	//  137  280:iconst_2        
	//  138  281:idiv            
	//  139  282:isub            
	//  140  283:invokestatic    #287 <Method int Math.abs(int)>
	//  141  286:istore_3        
			int i1 = Math.abs(k2 - (view.getTop() + view.getBottom()) / 2);
	//  142  287:iload           10
	//  143  289:aload           15
	//  144  291:invokevirtual   #270 <Method int View.getTop()>
	//  145  294:aload           15
	//  146  296:invokevirtual   #267 <Method int View.getBottom()>
	//  147  299:iadd            
	//  148  300:iconst_2        
	//  149  301:idiv            
	//  150  302:isub            
	//  151  303:invokestatic    #287 <Method int Math.abs(int)>
	//  152  306:istore          4
			int i3 = l * l + i1 * i1;
	//  153  308:iload_3         
	//  154  309:iload_3         
	...
	//  161  319:aload_0         
	//  162  320:getfield        #229 <Field List mSwapTargets>
	//  163  323:invokeinterface #205 <Method int List.size()>
	//  164  328:istore          13
			l = 0;
	//  165  330:iconst_0        
	//  166  331:istore_3        
	...
	//* 172  341:iload           12
	//* 173  343:aload_0         
	//* 174  344:getfield        #231 <Field List mDistances>
	//* 175  347:iload_3         
	//* 176  348:invokeinterface #209 <Method Object List.get(int)>
	//* 177  353:checkcast       #289 <Class Integer>
	//* 178  356:invokevirtual   #292 <Method int Integer.intValue()>
	//* 179  359:icmple          375
				i1++;
	//  180  362:iload           4
	//  181  364:iconst_1        
	...
	//  189  375:aload_0         
	//  190  376:getfield        #229 <Field List mSwapTargets>
	//  191  379:iload           4
	//  192  381:aload           16
	//  193  383:invokeinterface #296 <Method void List.add(int, Object)>
			mDistances.add(i1, ((Object) (Integer.valueOf(i3))));
	//  194  388:aload_0         
	//  195  389:getfield        #231 <Field List mDistances>
	//  196  392:iload           4
	//  197  394:iload           12
	//  198  396:invokestatic    #300 <Method Integer Integer.valueOf(int)>
	//  199  399:invokeinterface #296 <Method void List.add(int, Object)>
		}
	...
	//* 204  408:goto            167
		return mSwapTargets;
	//  205  411:aload_0         
	//  206  412:getfield        #229 <Field List mSwapTargets>
	//  207  415:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #132 <Field RecyclerView mRecyclerView>
	//    2    4:invokevirtual   #255 <Method android.support.v7.widget.RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//    3    7:astore          7
		int i = mActivePointerId;
	//    4    9:aload_0         
	//    5   10:getfield        #101 <Field int mActivePointerId>
	//    6   13:istore          6
		if(i == -1)
	//*   7   15:iload           6
	//*   8   17:iconst_m1       
	...
	//   12   23:aload_1         
	//   13   24:iload           6
	//   14   26:invokevirtual   #309 <Method int MotionEvent.findPointerIndex(int)>
	//   15   29:istore          6
		float f2 = motionevent.getX(i);
	//   16   31:aload_1         
	//   17   32:iload           6
	//   18   34:invokevirtual   #312 <Method float MotionEvent.getX(int)>
	//   19   37:fstore          4
		float f3 = mInitialTouchX;
	//   20   39:aload_0         
	//   21   40:getfield        #314 <Field float mInitialTouchX>
	//   22   43:fstore          5
		float f = motionevent.getY(i);
	//   23   45:aload_1         
	//   24   46:iload           6
	//   25   48:invokevirtual   #317 <Method float MotionEvent.getY(int)>
	//   26   51:fstore_2        
		float f1 = mInitialTouchY;
	//   27   52:aload_0         
	//   28   53:getfield        #319 <Field float mInitialTouchY>
	//   29   56:fstore_3        
		f2 = Math.abs(f2 - f3);
	//   30   57:fload           4
	//   31   59:fload           5
	//   32   61:fsub            
	//   33   62:invokestatic    #168 <Method float Math.abs(float)>
	//   34   65:fstore          4
		f = Math.abs(f - f1);
	//   35   67:fload_2         
	//   36   68:fload_3         
	//   37   69:fsub            
	//   38   70:invokestatic    #168 <Method float Math.abs(float)>
	//   39   73:fstore_2        
		i = mSlop;
	//   40   74:aload_0         
	//   41   75:getfield        #321 <Field int mSlop>
	//   42   78:istore          6
	...
	//*  58  103:ifle            116
	//*  59  106:aload           7
	//*  60  108:invokevirtual   #325 <Method boolean android.support.v7.widget.RecyclerView$LayoutManager.canScrollHorizontally()>
	//*  61  111:ifeq            116
			return null;
	//   62  114:aconst_null     
	//   63  115:areturn         
	...
	//*  67  120:ifle            133
	//*  68  123:aload           7
	//*  69  125:invokevirtual   #328 <Method boolean android.support.v7.widget.RecyclerView$LayoutManager.canScrollVertically()>
	//*  70  128:ifeq            133
			return null;
	//   71  131:aconst_null     
	//   72  132:areturn         
	...
	//   73  133:aload_0         
	//   74  134:aload_1         
	//   75  135:invokevirtual   #332 <Method View findChildView(MotionEvent)>
	//   76  138:astore_1        
		if(motionevent == null)
	//*  77  139:aload_1         
	...
	//   81  145:aload_0         
	//   82  146:getfield        #132 <Field RecyclerView mRecyclerView>
	//   83  149:aload_1         
	//   84  150:invokevirtual   #280 <Method android.support.v7.widget.RecyclerView$ViewHolder RecyclerView.getChildViewHolder(View)>
	//   85  153:areturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #336 <Field int mSelectedFlags>
	//*   2    4:bipush          12
	//*   3    6:iand            
	//*   4    7:ifeq            37
	...
	//    6   11:iconst_0        
	//    7   12:aload_0         
	//    8   13:getfield        #236 <Field float mSelectedStartX>
	//    9   16:aload_0         
	//   10   17:getfield        #142 <Field float mDx>
	//   11   20:fadd            
	//   12   21:aload_0         
	//   13   22:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   14   25:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   15   28:invokevirtual   #276 <Method int View.getLeft()>
	//   16   31:i2f             
	//   17   32:fsub            
	//   18   33:fastore         
		else
	...
	//   21   38:iconst_0        
	//   22   39:aload_0         
	//   23   40:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   24   43:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   25   46:invokevirtual   #340 <Method float View.getTranslationX()>
	//   26   49:fastore         
		if((mSelectedFlags & 3) != 0)
	//*  27   50:aload_0         
	//*  28   51:getfield        #336 <Field int mSelectedFlags>
	//*  29   54:iconst_3        
	//*  30   55:iand            
	//*  31   56:ifeq            84
		{
	...
	//   33   60:iconst_1        
	//   34   61:aload_0         
	//   35   62:getfield        #242 <Field float mSelectedStartY>
	//   36   65:aload_0         
	//   37   66:getfield        #184 <Field float mDy>
	//   38   69:fadd            
	//   39   70:aload_0         
	//   40   71:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   41   74:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   42   77:invokevirtual   #270 <Method int View.getTop()>
	//   43   80:i2f             
	//   44   81:fsub            
	//   45   82:fastore         
			return;
	...
	//   48   85:iconst_1        
	//   49   86:aload_0         
	//   50   87:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   51   90:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   52   93:invokevirtual   #343 <Method float View.getTranslationY()>
	//   53   96:fastore         
			return;
	//   54   97:return          
		}
	...
	//    5    7:fload_3         
	//    6    8:aload_0         
	//    7    9:invokevirtual   #250 <Method int View.getWidth()>
	//    8   12:i2f             
	//    9   13:fadd            
	//   10   14:fcmpg           
	//   11   15:ifgt            40
	...
	//   17   26:fload           4
	//   18   28:aload_0         
	//   19   29:invokevirtual   #251 <Method int View.getHeight()>
	//   20   32:i2f             
	//   21   33:fadd            
	//   22   34:fcmpg           
	//   23   35:ifgt            40
	...
	private void releaseVelocityTracker()
	{
		VelocityTracker velocitytracker = mVelocityTracker;
	//    0    0:aload_0         
	//    1    1:getfield        #144 <Field VelocityTracker mVelocityTracker>
	//    2    4:astore_1        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #348 <Method void VelocityTracker.recycle()>
			mVelocityTracker = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #144 <Field VelocityTracker mVelocityTracker>
		}
	//   10   18:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #132 <Field RecyclerView mRecyclerView>
	//    3    5:invokevirtual   #353 <Method android.content.Context RecyclerView.getContext()>
	//    4    8:invokestatic    #358 <Method ViewConfiguration ViewConfiguration.get(android.content.Context)>
	//    5   11:invokevirtual   #361 <Method int ViewConfiguration.getScaledTouchSlop()>
	//    6   14:putfield        #321 <Field int mSlop>
		mRecyclerView.addItemDecoration(((android.support.v7.widget.RecyclerView.ItemDecoration) (this)));
	//    7   17:aload_0         
	//    8   18:getfield        #132 <Field RecyclerView mRecyclerView>
	//    9   21:aload_0         
	//   10   22:invokevirtual   #364 <Method void RecyclerView.addItemDecoration(android.support.v7.widget.RecyclerView$ItemDecoration)>
		mRecyclerView.addOnItemTouchListener(mOnItemTouchListener);
	//   11   25:aload_0         
	//   12   26:getfield        #132 <Field RecyclerView mRecyclerView>
	//   13   29:aload_0         
	//   14   30:getfield        #119 <Field android.support.v7.widget.RecyclerView$OnItemTouchListener mOnItemTouchListener>
	//   15   33:invokevirtual   #367 <Method void RecyclerView.addOnItemTouchListener(android.support.v7.widget.RecyclerView$OnItemTouchListener)>
	...
	//   16   36:aload_0         
	//   17   37:getfield        #132 <Field RecyclerView mRecyclerView>
	//   18   40:aload_0         
	//   19   41:invokevirtual   #370 <Method void RecyclerView.addOnChildAttachStateChangeListener(android.support.v7.widget.RecyclerView$OnChildAttachStateChangeListener)>
		startGestureDetection();
	//   20   44:aload_0         
	//   21   45:invokespecial   #373 <Method void startGestureDetection()>
	//   22   48:return          
	}
	...
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:invokespecial   #374 <Method void ItemTouchHelper$ItemTouchHelperGestureListener(ItemTouchHelper)>
	//    5    9:putfield        #376 <Field ItemTouchHelper$ItemTouchHelperGestureListener mItemTouchHelperGestureListener>
	...
	//    6   12:aload_0         
	//    7   13:new             #378 <Class GestureDetectorCompat>
	//    8   16:dup             
	//    9   17:aload_0         
	//   10   18:getfield        #132 <Field RecyclerView mRecyclerView>
	//   11   21:invokevirtual   #353 <Method android.content.Context RecyclerView.getContext()>
	//   12   24:aload_0         
	//   13   25:getfield        #376 <Field ItemTouchHelper$ItemTouchHelperGestureListener mItemTouchHelperGestureListener>
	//   14   28:invokespecial   #381 <Method void GestureDetectorCompat(android.content.Context, android.view.GestureDetector$OnGestureListener)>
	//   15   31:putfield        #383 <Field GestureDetectorCompat mGestureDetector>
	//   16   34:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #376 <Field ItemTouchHelper$ItemTouchHelperGestureListener mItemTouchHelperGestureListener>
	//    2    4:astore_1        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #386 <Method void ItemTouchHelper$ItemTouchHelperGestureListener.doNotReactToLongPress()>
			mItemTouchHelperGestureListener = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #376 <Field ItemTouchHelper$ItemTouchHelperGestureListener mItemTouchHelperGestureListener>
		}
		if(mGestureDetector != null)
	//*  10   18:aload_0         
	//*  11   19:getfield        #383 <Field GestureDetectorCompat mGestureDetector>
	//*  12   22:ifnull          30
			mGestureDetector = null;
	//   13   25:aload_0         
	//   14   26:aconst_null     
	//   15   27:putfield        #383 <Field GestureDetectorCompat mGestureDetector>
	//   16   30:return          
	}
	...
	private int swipeIfNecessary(android.support.v7.widget.RecyclerView.ViewHolder viewholder)
	{
		if(mActionState == 2)
	//*   0    0:aload_0         
	//*   1    1:getfield        #103 <Field int mActionState>
	//*   2    4:iconst_2        
	//*   3    5:icmpne          10
			return 0;
	//    4    8:iconst_0        
	...
	//    6   10:aload_0         
	//    7   11:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//    8   14:aload_0         
	//    9   15:getfield        #132 <Field RecyclerView mRecyclerView>
	//   10   18:aload_1         
	//   11   19:invokevirtual   #392 <Method int ItemTouchHelper$Callback.getMovementFlags(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
	//   12   22:istore_3        
		int i = (mCallback.convertToAbsoluteDirection(j, ViewCompat.getLayoutDirection(((View) (mRecyclerView)))) & 0xff00) >> 8;
	//   13   23:aload_0         
	//   14   24:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   15   27:iload_3         
	//   16   28:aload_0         
	//   17   29:getfield        #132 <Field RecyclerView mRecyclerView>
	//   18   32:invokestatic    #398 <Method int ViewCompat.getLayoutDirection(View)>
	//   19   35:invokevirtual   #402 <Method int ItemTouchHelper$Callback.convertToAbsoluteDirection(int, int)>
	//   20   38:ldc2            #403 <Int 65280>
	//   21   41:iand            
	//   22   42:bipush          8
	//   23   44:ishr            
	//   24   45:istore_2        
	...
	//*  35   61:aload_0         
	//*  36   62:getfield        #142 <Field float mDx>
	//*  37   65:invokestatic    #168 <Method float Math.abs(float)>
	//*  38   68:aload_0         
	//*  39   69:getfield        #184 <Field float mDy>
	//*  40   72:invokestatic    #168 <Method float Math.abs(float)>
	//*  41   75:fcmpl           
	//*  42   76:ifle            128
		{
	...
	//   44   80:aload_1         
	//   45   81:iload_2         
	//   46   82:invokespecial   #405 <Method int checkHorizontalSwipe(android.support.v7.widget.RecyclerView$ViewHolder, int)>
	//   47   85:istore          4
			if(k > 0)
	//*  48   87:iload           4
	//*  49   89:ifle            115
	...
	//   54   99:iload           4
	//   55  101:aload_0         
	//   56  102:getfield        #132 <Field RecyclerView mRecyclerView>
	//   57  105:invokestatic    #398 <Method int ViewCompat.getLayoutDirection(View)>
	//   58  108:invokestatic    #408 <Method int ItemTouchHelper$Callback.convertToRelativeDirection(int, int)>
	//   59  111:ireturn         
				else
					return k;
	//   60  112:iload           4
	...
	//   63  116:aload_1         
	//   64  117:iload_2         
	//   65  118:invokespecial   #410 <Method int checkVerticalSwipe(android.support.v7.widget.RecyclerView$ViewHolder, int)>
	//   66  121:istore_2        
			if(i > 0)
	//*  67  122:iload_2         
	//*  68  123:ifle            175
	...
	//   72  129:aload_1         
	//   73  130:iload_2         
	//   74  131:invokespecial   #410 <Method int checkVerticalSwipe(android.support.v7.widget.RecyclerView$ViewHolder, int)>
	//   75  134:istore          4
			if(l > 0)
	//*  76  136:iload           4
	//*  77  138:ifle            144
	...
	//   81  145:aload_1         
	//   82  146:iload_2         
	//   83  147:invokespecial   #405 <Method int checkHorizontalSwipe(android.support.v7.widget.RecyclerView$ViewHolder, int)>
	//   84  150:istore_2        
			if(i > 0)
	//*  85  151:iload_2         
	//*  86  152:ifle            175
	...
	//   91  161:iload_2         
	//   92  162:aload_0         
	//   93  163:getfield        #132 <Field RecyclerView mRecyclerView>
	//   94  166:invokestatic    #398 <Method int ViewCompat.getLayoutDirection(View)>
	//   95  169:invokestatic    #408 <Method int ItemTouchHelper$Callback.convertToRelativeDirection(int, int)>
	//   96  172:ireturn         
				else
					return i;
	//   97  173:iload_2         
	...
	//*   8   12:ifnull          19
			destroyCallbacks();
	//    9   15:aload_0         
	//   10   16:invokespecial   #415 <Method void destroyCallbacks()>
		mRecyclerView = recyclerview;
	//   11   19:aload_0         
	//   12   20:aload_1         
	//   13   21:putfield        #132 <Field RecyclerView mRecyclerView>
		if(recyclerview != null)
	//*  14   24:aload_1         
	//*  15   25:ifnull          59
		{
	...
	//   16   28:aload_1         
	//   17   29:invokevirtual   #419 <Method Resources RecyclerView.getResources()>
	//   18   32:astore_1        
	...
	//   19   33:aload_0         
	//   20   34:aload_1         
	//   21   35:getstatic       #424 <Field int android.support.v7.recyclerview.R$dimen.item_touch_helper_swipe_escape_velocity>
	//   22   38:invokevirtual   #429 <Method float Resources.getDimension(int)>
	//   23   41:putfield        #170 <Field float mSwipeEscapeVelocity>
	...
	//   24   44:aload_0         
	//   25   45:aload_1         
	//   26   46:getstatic       #432 <Field int android.support.v7.recyclerview.R$dimen.item_touch_helper_swipe_escape_max_velocity>
	//   27   49:invokevirtual   #429 <Method float Resources.getDimension(int)>
	//   28   52:putfield        #146 <Field float mMaxSwipeVelocity>
			setupCallbacks();
	//   29   55:aload_0         
	//   30   56:invokespecial   #434 <Method void setupCallbacks()>
		}
	//   31   59:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//*   2    4:ifnonnull       242
	//*   3    7:iload_1         
	//*   4    8:iconst_2        
	//*   5    9:icmpne          242
	//*   6   12:aload_0         
	//*   7   13:getfield        #103 <Field int mActionState>
	//*   8   16:iconst_2        
	//*   9   17:icmpeq          242
		{
			if(!mCallback.isItemViewSwipeEnabled())
	//*  10   20:aload_0         
	//*  11   21:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//*  12   24:invokevirtual   #439 <Method boolean ItemTouchHelper$Callback.isItemViewSwipeEnabled()>
	//*  13   27:ifne            31
				return;
	//   14   30:return          
			if(mRecyclerView.getScrollState() == 1)
	//*  15   31:aload_0         
	//*  16   32:getfield        #132 <Field RecyclerView mRecyclerView>
	//*  17   35:invokevirtual   #442 <Method int RecyclerView.getScrollState()>
	//*  18   38:iconst_1        
	//*  19   39:icmpne          43
				return;
	//   20   42:return          
	...
	//   21   43:aload_0         
	//   22   44:aload_2         
	//   23   45:invokespecial   #444 <Method android.support.v7.widget.RecyclerView$ViewHolder findSwipedView(MotionEvent)>
	//   24   48:astore          8
			if(viewholder == null)
	//*  25   50:aload           8
	//*  26   52:ifnonnull       56
	...
	//   28   56:aload_0         
	//   29   57:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   30   60:aload_0         
	//   31   61:getfield        #132 <Field RecyclerView mRecyclerView>
	//   32   64:aload           8
	//   33   66:invokevirtual   #447 <Method int ItemTouchHelper$Callback.getAbsoluteMovementFlags(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
	//   34   69:ldc2            #403 <Int 65280>
	//   35   72:iand            
	//   36   73:bipush          8
	//   37   75:ishr            
	//   38   76:istore_1        
	...
	//   42   82:aload_2         
	//   43   83:iload_3         
	//   44   84:invokevirtual   #312 <Method float MotionEvent.getX(int)>
	//   45   87:fstore          4
			float f1 = motionevent.getY(j);
	//   46   89:aload_2         
	//   47   90:iload_3         
	//   48   91:invokevirtual   #317 <Method float MotionEvent.getY(int)>
	//   49   94:fstore          5
			f -= mInitialTouchX;
	//   50   96:fload           4
	//   51   98:aload_0         
	//   52   99:getfield        #314 <Field float mInitialTouchX>
	//   53  102:fsub            
	//   54  103:fstore          4
			f1 -= mInitialTouchY;
	//   55  105:fload           5
	//   56  107:aload_0         
	//   57  108:getfield        #319 <Field float mInitialTouchY>
	//   58  111:fsub            
	//   59  112:fstore          5
			float f2 = Math.abs(f);
	//   60  114:fload           4
	//   61  116:invokestatic    #168 <Method float Math.abs(float)>
	//   62  119:fstore          6
			float f3 = Math.abs(f1);
	//   63  121:fload           5
	//   64  123:invokestatic    #168 <Method float Math.abs(float)>
	//   65  126:fstore          7
			j = mSlop;
	//   66  128:aload_0         
	//   67  129:getfield        #321 <Field int mSlop>
	//   68  132:istore_3        
	...
	//  120  215:aload_0         
	//  121  216:fconst_0        
	//  122  217:putfield        #184 <Field float mDy>
			mDx = 0.0F;
	//  123  220:aload_0         
	//  124  221:fconst_0        
	//  125  222:putfield        #142 <Field float mDx>
			mActivePointerId = motionevent.getPointerId(0);
	//  126  225:aload_0         
	//  127  226:aload_2         
	//  128  227:iconst_0        
	//  129  228:invokevirtual   #450 <Method int MotionEvent.getPointerId(int)>
	//  130  231:putfield        #101 <Field int mActivePointerId>
			select(viewholder, 1);
	//  131  234:aload_0         
	//  132  235:aload           8
	//  133  237:iconst_1        
	//  134  238:invokevirtual   #454 <Method void select(android.support.v7.widget.RecyclerView$ViewHolder, int)>
			return;
	//  135  241:return          
		} else
		{
	...
	void endRecoverAnimation(android.support.v7.widget.RecyclerView.ViewHolder viewholder, boolean flag)
	{
		for(int i = mRecoverAnimations.size() - 1; i >= 0; i--)
	//*   0    0:aload_0         
	//*   1    1:getfield        #105 <Field List mRecoverAnimations>
	//*   2    4:invokeinterface #205 <Method int List.size()>
	//*   3    9:iconst_1        
	//*   4   10:isub            
	//*   5   11:istore_3        
	//*   6   12:iload_3         
	...
	//    8   16:aload_0         
	//    9   17:getfield        #105 <Field List mRecoverAnimations>
	//   10   20:iload_3         
	//   11   21:invokeinterface #209 <Method Object List.get(int)>
	//   12   26:checkcast       #28  <Class ItemTouchHelper$RecoverAnimation>
	//   13   29:astore          4
			if(recoveranimation.mViewHolder == viewholder)
	//*  14   31:aload           4
	//*  15   33:getfield        #212 <Field android.support.v7.widget.RecyclerView$ViewHolder ItemTouchHelper$RecoverAnimation.mViewHolder>
	//*  16   36:aload_1         
	//*  17   37:if_acmpne       77
			{
	...
	//   18   40:aload           4
	//   19   42:aload           4
	//   20   44:getfield        #460 <Field boolean ItemTouchHelper$RecoverAnimation.mOverridden>
	//   21   47:iload_2         
	//   22   48:ior             
	//   23   49:putfield        #460 <Field boolean ItemTouchHelper$RecoverAnimation.mOverridden>
				if(!recoveranimation.mEnded)
	//*  24   52:aload           4
	//*  25   54:getfield        #463 <Field boolean ItemTouchHelper$RecoverAnimation.mEnded>
	//*  26   57:ifne            65
					recoveranimation.cancel();
	//   27   60:aload           4
	//   28   62:invokevirtual   #466 <Method void ItemTouchHelper$RecoverAnimation.cancel()>
				mRecoverAnimations.remove(i);
	//   29   65:aload_0         
	//   30   66:getfield        #105 <Field List mRecoverAnimations>
	//   31   69:iload_3         
	//   32   70:invokeinterface #469 <Method Object List.remove(int)>
	//   33   75:pop             
				return;
	//   34   76:return          
			}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #105 <Field List mRecoverAnimations>
	//*   2    4:invokeinterface #474 <Method boolean List.isEmpty()>
	//*   3    9:ifeq            14
			return null;
	//    4   12:aconst_null     
	//    5   13:areturn         
	...
	//    6   14:aload_0         
	//    7   15:aload_1         
	//    8   16:invokevirtual   #332 <Method View findChildView(MotionEvent)>
	//    9   19:astore_1        
		for(int i = mRecoverAnimations.size() - 1; i >= 0; i--)
	//*  10   20:aload_0         
	//*  11   21:getfield        #105 <Field List mRecoverAnimations>
	//*  12   24:invokeinterface #205 <Method int List.size()>
	//*  13   29:iconst_1        
	//*  14   30:isub            
	//*  15   31:istore_2        
	//*  16   32:iload_2         
	//*  17   33:iflt            70
		{
			RecoverAnimation recoveranimation = (RecoverAnimation)mRecoverAnimations.get(i);
	//   18   36:aload_0         
	//   19   37:getfield        #105 <Field List mRecoverAnimations>
	//   20   40:iload_2         
	//   21   41:invokeinterface #209 <Method Object List.get(int)>
	//   22   46:checkcast       #28  <Class ItemTouchHelper$RecoverAnimation>
	//   23   49:astore_3        
			if(recoveranimation.mViewHolder.itemView == motionevent)
	//*  24   50:aload_3         
	//*  25   51:getfield        #212 <Field android.support.v7.widget.RecyclerView$ViewHolder ItemTouchHelper$RecoverAnimation.mViewHolder>
	//*  26   54:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  27   57:aload_1         
	//*  28   58:if_acmpne       63
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #476 <Method float MotionEvent.getX()>
	//    2    4:fstore_2        
		float f1 = motionevent.getY();
	//    3    5:aload_1         
	//    4    6:invokevirtual   #478 <Method float MotionEvent.getY()>
	//    5    9:fstore_3        
		motionevent = ((MotionEvent) (mSelected));
	//    6   10:aload_0         
	//    7   11:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//    8   14:astore_1        
		if(motionevent != null)
	//*   9   15:aload_1         
	//*  10   16:ifnull          53
	...
	//   11   19:aload_1         
	//   12   20:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   13   23:astore_1        
	...
	//*  16   26:fload_3         
	//*  17   27:aload_0         
	//*  18   28:getfield        #236 <Field float mSelectedStartX>
	//*  19   31:aload_0         
	//*  20   32:getfield        #142 <Field float mDx>
	//*  21   35:fadd            
	//*  22   36:aload_0         
	//*  23   37:getfield        #242 <Field float mSelectedStartY>
	//*  24   40:aload_0         
	//*  25   41:getfield        #184 <Field float mDy>
	//*  26   44:fadd            
	//*  27   45:invokestatic    #480 <Method boolean hitTest(View, float, float, float, float)>
	//*  28   48:ifeq            53
	...
	//   30   52:areturn         
		...
		for(int i = mRecoverAnimations.size() - 1; i >= 0; i--)
	//*  31   53:aload_0         
	//*  32   54:getfield        #105 <Field List mRecoverAnimations>
	//*  33   57:invokeinterface #205 <Method int List.size()>
	//*  34   62:iconst_1        
	//*  35   63:isub            
	//*  36   64:istore          4
	//*  37   66:iload           4
	...
	//   39   71:aload_0         
	//   40   72:getfield        #105 <Field List mRecoverAnimations>
	//   41   75:iload           4
	//   42   77:invokeinterface #209 <Method Object List.get(int)>
	//   43   82:checkcast       #28  <Class ItemTouchHelper$RecoverAnimation>
	//   44   85:astore_1        
			View view = ((RecoverAnimation) (motionevent)).mViewHolder.itemView;
	//   45   86:aload_1         
	//   46   87:getfield        #212 <Field android.support.v7.widget.RecyclerView$ViewHolder ItemTouchHelper$RecoverAnimation.mViewHolder>
	//   47   90:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   48   93:astore          5
	...
	//*  51   98:fload_3         
	//*  52   99:aload_1         
	//*  53  100:getfield        #483 <Field float ItemTouchHelper$RecoverAnimation.mX>
	//*  54  103:aload_1         
	//*  55  104:getfield        #486 <Field float ItemTouchHelper$RecoverAnimation.mY>
	//*  56  107:invokestatic    #480 <Method boolean hitTest(View, float, float, float, float)>
	//*  57  110:ifeq            116
				return view;
	//   58  113:aload           5
	//   59  115:areturn         
	...
	//   65  125:aload_0         
	//   66  126:getfield        #132 <Field RecyclerView mRecyclerView>
	//   67  129:fload_2         
	//   68  130:fload_3         
	//   69  131:invokevirtual   #490 <Method View RecyclerView.findChildViewUnder(float, float)>
	//   70  134:areturn         
	}
	...
	public void getItemOffsets(Rect rect, View view, RecyclerView recyclerview, android.support.v7.widget.RecyclerView.State state)
	{
		rect.setEmpty();
	//    0    0:aload_1         
	//    1    1:invokevirtual   #497 <Method void Rect.setEmpty()>
	//    2    4:return          
	}
	...
	//*   9   17:aload_0         
	//*  10   18:getfield        #105 <Field List mRecoverAnimations>
	//*  11   21:iload_1         
	//*  12   22:invokeinterface #209 <Method Object List.get(int)>
	//*  13   27:checkcast       #28  <Class ItemTouchHelper$RecoverAnimation>
	//*  14   30:getfield        #463 <Field boolean ItemTouchHelper$RecoverAnimation.mEnded>
	//*  15   33:ifne            38
				return true;
	//   16   36:iconst_1        
	//   17   37:ireturn         
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #132 <Field RecyclerView mRecyclerView>
	//*   2    4:invokevirtual   #503 <Method boolean RecyclerView.isLayoutRequested()>
	//*   3    7:ifeq            11
			return;
	//    4   10:return          
		if(mActionState != 2)
	//*   5   11:aload_0         
	//*   6   12:getfield        #103 <Field int mActionState>
	//*   7   15:iconst_2        
	//*   8   16:icmpeq          20
			return;
	//    9   19:return          
	...
	//   11   21:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   12   24:aload_1         
	//   13   25:invokevirtual   #506 <Method float ItemTouchHelper$Callback.getMoveThreshold(android.support.v7.widget.RecyclerView$ViewHolder)>
	//   14   28:fstore_2        
		int i = (int)(mSelectedStartX + mDx);
	//   15   29:aload_0         
	//   16   30:getfield        #236 <Field float mSelectedStartX>
	//   17   33:aload_0         
	//   18   34:getfield        #142 <Field float mDx>
	//   19   37:fadd            
	//   20   38:f2i             
	//   21   39:istore_3        
		int j = (int)(mSelectedStartY + mDy);
	//   22   40:aload_0         
	//   23   41:getfield        #242 <Field float mSelectedStartY>
	//   24   44:aload_0         
	//   25   45:getfield        #184 <Field float mDy>
	//   26   48:fadd            
	//   27   49:f2i             
	//   28   50:istore          4
	...
	//*  29   52:iload           4
	//*  30   54:aload_1         
	//*  31   55:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  32   58:invokevirtual   #270 <Method int View.getTop()>
	//*  33   61:isub            
	//*  34   62:invokestatic    #287 <Method int Math.abs(int)>
	//*  35   65:i2f             
	//*  36   66:aload_1         
	//*  37   67:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  38   70:invokevirtual   #251 <Method int View.getHeight()>
	//*  39   73:i2f             
	//*  40   74:fload_2         
	//*  41   75:fmul            
	//*  42   76:fcmpg           
	...
	//*  44   80:iload_3         
	//*  45   81:aload_1         
	//*  46   82:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  47   85:invokevirtual   #276 <Method int View.getLeft()>
	//*  48   88:isub            
	//*  49   89:invokestatic    #287 <Method int Math.abs(int)>
	//*  50   92:i2f             
	//*  51   93:aload_1         
	//*  52   94:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  53   97:invokevirtual   #250 <Method int View.getWidth()>
	//*  54  100:i2f             
	//*  55  101:fload_2         
	//*  56  102:fmul            
	//*  57  103:fcmpg           
	...
	//   60  108:aload_0         
	//   61  109:aload_1         
	//   62  110:invokespecial   #508 <Method List findSwapTargets(android.support.v7.widget.RecyclerView$ViewHolder)>
	//   63  113:astore          7
		if(((List) (obj)).size() == 0)
	//*  64  115:aload           7
	//*  65  117:invokeinterface #205 <Method int List.size()>
	//*  66  122:ifne            126
			return;
	//   67  125:return          
		obj = ((Object) (mCallback.chooseDropTarget(viewholder, ((List) (obj)), i, j)));
	//   68  126:aload_0         
	//   69  127:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   70  130:aload_1         
	//   71  131:aload           7
	//   72  133:iload_3         
	//   73  134:iload           4
	//   74  136:invokevirtual   #512 <Method android.support.v7.widget.RecyclerView$ViewHolder ItemTouchHelper$Callback.chooseDropTarget(android.support.v7.widget.RecyclerView$ViewHolder, List, int, int)>
	//   75  139:astore          7
		if(obj == null)
	//*  76  141:aload           7
	//*  77  143:ifnonnull       165
		{
			mSwapTargets.clear();
	//   78  146:aload_0         
	//   79  147:getfield        #229 <Field List mSwapTargets>
	//   80  150:invokeinterface #219 <Method void List.clear()>
			mDistances.clear();
	//   81  155:aload_0         
	//   82  156:getfield        #231 <Field List mDistances>
	//   83  159:invokeinterface #219 <Method void List.clear()>
			return;
	//   84  164:return          
		}
		int k = ((android.support.v7.widget.RecyclerView.ViewHolder) (obj)).getAdapterPosition();
	//   85  165:aload           7
	//   86  167:invokevirtual   #515 <Method int android.support.v7.widget.RecyclerView$ViewHolder.getAdapterPosition()>
	//   87  170:istore          5
		int l = viewholder.getAdapterPosition();
	//   88  172:aload_1         
	//   89  173:invokevirtual   #515 <Method int android.support.v7.widget.RecyclerView$ViewHolder.getAdapterPosition()>
	//   90  176:istore          6
		if(mCallback.onMove(mRecyclerView, viewholder, ((android.support.v7.widget.RecyclerView.ViewHolder) (obj))))
	//*  91  178:aload_0         
	//*  92  179:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//*  93  182:aload_0         
	//*  94  183:getfield        #132 <Field RecyclerView mRecyclerView>
	//*  95  186:aload_1         
	//*  96  187:aload           7
	//*  97  189:invokevirtual   #518 <Method boolean ItemTouchHelper$Callback.onMove(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder, android.support.v7.widget.RecyclerView$ViewHolder)>
	//*  98  192:ifeq            216
			mCallback.onMoved(mRecyclerView, viewholder, l, ((android.support.v7.widget.RecyclerView.ViewHolder) (obj)), k, i, j);
	//   99  195:aload_0         
	//  100  196:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  101  199:aload_0         
	//  102  200:getfield        #132 <Field RecyclerView mRecyclerView>
	//  103  203:aload_1         
	//  104  204:iload           6
	//  105  206:aload           7
	//  106  208:iload           5
	//  107  210:iload_3         
	//  108  211:iload           4
	//  109  213:invokevirtual   #522 <Method void ItemTouchHelper$Callback.onMoved(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder, int, android.support.v7.widget.RecyclerView$ViewHolder, int, int, int)>
	//  110  216:return          
	}
	...
	//    7   13:aload_0         
	//    8   14:invokestatic    #527 <Method VelocityTracker VelocityTracker.obtain()>
	//    9   17:putfield        #144 <Field VelocityTracker mVelocityTracker>
	//   10   20:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #533 <Method void removeChildDrawingOrderCallbackIfNecessary(View)>
		view = ((View) (mRecyclerView.getChildViewHolder(view)));
	//    3    5:aload_0         
	//    4    6:getfield        #132 <Field RecyclerView mRecyclerView>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #280 <Method android.support.v7.widget.RecyclerView$ViewHolder RecyclerView.getChildViewHolder(View)>
	//    7   13:astore_1        
		if(view == null)
	//*   8   14:aload_1         
	//*   9   15:ifnonnull       19
	...
	//   11   19:aload_0         
	//   12   20:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   13   23:astore_2        
	...
	//   20   34:aconst_null     
	//   21   35:iconst_0        
	//   22   36:invokevirtual   #454 <Method void select(android.support.v7.widget.RecyclerView$ViewHolder, int)>
			return;
	//   23   39:return          
		}
	...
	//   25   41:aload_1         
	//   26   42:iconst_0        
	//   27   43:invokevirtual   #535 <Method void endRecoverAnimation(android.support.v7.widget.RecyclerView$ViewHolder, boolean)>
		if(mPendingCleanup.remove(((Object) (((android.support.v7.widget.RecyclerView.ViewHolder) (view)).itemView))))
	//*  28   46:aload_0         
	//*  29   47:getfield        #95  <Field List mPendingCleanup>
	//*  30   50:aload_1         
	//*  31   51:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  32   54:invokeinterface #538 <Method boolean List.remove(Object)>
	//*  33   59:ifeq            74
			mCallback.clearView(mRecyclerView, ((android.support.v7.widget.RecyclerView.ViewHolder) (view)));
	//   34   62:aload_0         
	//   35   63:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   36   66:aload_0         
	//   37   67:getfield        #132 <Field RecyclerView mRecyclerView>
	//   38   70:aload_1         
	//   39   71:invokevirtual   #216 <Method void ItemTouchHelper$Callback.clearView(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
	//   40   74:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_m1       
	//    2    2:putfield        #116 <Field int mOverdrawChildPosition>
		float f;
		float f1;
		if(mSelected != null)
	//*   3    5:aload_0         
	//*   4    6:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//*   5    9:ifnull          38
		{
			getSelectedDxDy(mTmpPosition);
	//    6   12:aload_0         
	//    7   13:aload_0         
	//    8   14:getfield        #97  <Field float[] mTmpPosition>
	//    9   17:invokespecial   #542 <Method void getSelectedDxDy(float[])>
			state = ((android.support.v7.widget.RecyclerView.State) (mTmpPosition));
	//   10   20:aload_0         
	//   11   21:getfield        #97  <Field float[] mTmpPosition>
	//   12   24:astore_3        
			f = state[0];
	//   13   25:aload_3         
	//   14   26:iconst_0        
	...
	//   26   44:aload_0         
	//   27   45:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   28   48:aload_1         
	//   29   49:aload_2         
	//   30   50:aload_0         
	//   31   51:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   32   54:aload_0         
	//   33   55:getfield        #105 <Field List mRecoverAnimations>
	//   34   58:aload_0         
	//   35   59:getfield        #103 <Field int mActionState>
	//   36   62:fload           4
	//   37   64:fload           5
	//   38   66:invokevirtual   #545 <Method void ItemTouchHelper$Callback.onDraw(Canvas, RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder, List, int, float, float)>
	//   39   69:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:aload_0         
	//    5    9:getfield        #97  <Field float[] mTmpPosition>
	//    6   12:invokespecial   #542 <Method void getSelectedDxDy(float[])>
			state = ((android.support.v7.widget.RecyclerView.State) (mTmpPosition));
	//    7   15:aload_0         
	//    8   16:getfield        #97  <Field float[] mTmpPosition>
	//    9   19:astore_3        
			f = state[0];
	//   10   20:aload_3         
	//   11   21:iconst_0        
	...
	//   23   39:aload_0         
	//   24   40:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//   25   43:aload_1         
	//   26   44:aload_2         
	//   27   45:aload_0         
	//   28   46:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   29   49:aload_0         
	//   30   50:getfield        #105 <Field List mRecoverAnimations>
	//   31   53:aload_0         
	//   32   54:getfield        #103 <Field int mActionState>
	//   33   57:fload           4
	//   34   59:fload           5
	//   35   61:invokevirtual   #548 <Method void ItemTouchHelper$Callback.onDrawOver(Canvas, RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder, List, int, float, float)>
	//   36   64:return          
	}
	...
	//    5    9:aload_1         
	//    6   10:iload_2         
	//    7   11:invokespecial   #553 <Method void ItemTouchHelper$4(ItemTouchHelper, ItemTouchHelper$RecoverAnimation, int)>
	//    8   14:invokevirtual   #557 <Method boolean RecyclerView.post(Runnable)>
	//    9   17:pop             
	//   10   18:return          
	}
	...
	//*   0    0:aload_1         
	//*   1    1:aload_0         
	//*   2    2:getfield        #114 <Field View mOverdrawChild>
	//*   3    5:if_acmpne       28
		{
			mOverdrawChild = null;
	//    4    8:aload_0         
	//    5    9:aconst_null     
	//    6   10:putfield        #114 <Field View mOverdrawChild>
			if(mChildDrawingOrderCallback != null)
	//*   7   13:aload_0         
	//*   8   14:getfield        #112 <Field android.support.v7.widget.RecyclerView$ChildDrawingOrderCallback mChildDrawingOrderCallback>
	//*   9   17:ifnull          28
				mRecyclerView.setChildDrawingOrderCallback(((android.support.v7.widget.RecyclerView.ChildDrawingOrderCallback) (null)));
	//   10   20:aload_0         
	//   11   21:getfield        #132 <Field RecyclerView mRecyclerView>
	//   12   24:aconst_null     
	//   13   25:invokevirtual   #138 <Method void RecyclerView.setChildDrawingOrderCallback(android.support.v7.widget.RecyclerView$ChildDrawingOrderCallback)>
		}
	//   14   28:return          
	}
...
label0:
	...
	//    3    7:aload_0         
	//    4    8:ldc2w           #559 <Long 0x0L>
	//    5   11:putfield        #562 <Field long mDragScrollStartTimeInMs>
				return false;
	//    6   14:iconst_0        
	//    7   15:ireturn         
			}
			l2 = System.currentTimeMillis();
	//    8   16:invokestatic    #568 <Method long System.currentTimeMillis()>
	//    9   19:lstore          6
			l1 = mDragScrollStartTimeInMs;
	//   10   21:aload_0         
	//   11   22:getfield        #562 <Field long mDragScrollStartTimeInMs>
	//   12   25:lstore          4
			if(l1 == 0x0L)
	//*  13   27:lload           4
	//*  14   29:ldc2w           #559 <Long 0x0L>
	//*  15   32:lcmp            
	//*  16   33:ifne            42
				l1 = 0L;
	//   17   36:lconst_0        
	...
	//   24   49:aload_0         
	//   25   50:getfield        #132 <Field RecyclerView mRecyclerView>
	//   26   53:invokevirtual   #255 <Method android.support.v7.widget.RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//   27   56:astore          8
			if(mTmpRect == null)
	//*  28   58:aload_0         
	//*  29   59:getfield        #570 <Field Rect mTmpRect>
	//*  30   62:ifnonnull       76
				mTmpRect = new Rect();
	//   31   65:aload_0         
	//   32   66:new             #494 <Class Rect>
	//   33   69:dup             
	//   34   70:invokespecial   #571 <Method void Rect()>
	//   35   73:putfield        #570 <Field Rect mTmpRect>
			layoutmanager.calculateItemDecorationsForChild(mSelected.itemView, mTmpRect);
	//   36   76:aload           8
	//   37   78:aload_0         
	//   38   79:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   39   82:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   40   85:aload_0         
	//   41   86:getfield        #570 <Field Rect mTmpRect>
	//   42   89:invokevirtual   #575 <Method void android.support.v7.widget.RecyclerView$LayoutManager.calculateItemDecorationsForChild(View, Rect)>
			if(layoutmanager.canScrollHorizontally())
	//*  43   92:aload           8
	//*  44   94:invokevirtual   #325 <Method boolean android.support.v7.widget.RecyclerView$LayoutManager.canScrollHorizontally()>
	//*  45   97:ifeq            198
			{
				int j = (int)(mSelectedStartX + mDx);
	//   46  100:aload_0         
	//   47  101:getfield        #236 <Field float mSelectedStartX>
	//   48  104:aload_0         
	//   49  105:getfield        #142 <Field float mDx>
	//   50  108:fadd            
	//   51  109:f2i             
	//   52  110:istore_2        
	...
	//   53  111:iload_2         
	//   54  112:aload_0         
	//   55  113:getfield        #570 <Field Rect mTmpRect>
	//   56  116:getfield        #578 <Field int Rect.left>
	//   57  119:isub            
	//   58  120:aload_0         
	//   59  121:getfield        #132 <Field RecyclerView mRecyclerView>
	//   60  124:invokevirtual   #581 <Method int RecyclerView.getPaddingLeft()>
	//   61  127:isub            
	//   62  128:istore_1        
				if(mDx < 0.0F && i < 0)
	//*  63  129:aload_0         
	//*  64  130:getfield        #142 <Field float mDx>
	//*  65  133:fconst_0        
	//*  66  134:fcmpg           
	//*  67  135:ifge            145
	//*  68  138:iload_1         
	...
	//   70  142:goto            200
				if(mDx > 0.0F)
	//*  71  145:aload_0         
	//*  72  146:getfield        #142 <Field float mDx>
	//*  73  149:fconst_0        
	//*  74  150:fcmpl           
	//*  75  151:ifle            198
				{
	...
	//   76  154:iload_2         
	//   77  155:aload_0         
	//   78  156:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   79  159:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   80  162:invokevirtual   #250 <Method int View.getWidth()>
	//   81  165:iadd            
	//   82  166:aload_0         
	//   83  167:getfield        #570 <Field Rect mTmpRect>
	//   84  170:getfield        #584 <Field int Rect.right>
	//   85  173:iadd            
	//   86  174:aload_0         
	//   87  175:getfield        #132 <Field RecyclerView mRecyclerView>
	//   88  178:invokevirtual   #177 <Method int RecyclerView.getWidth()>
	//   89  181:aload_0         
	//   90  182:getfield        #132 <Field RecyclerView mRecyclerView>
	//   91  185:invokevirtual   #587 <Method int RecyclerView.getPaddingRight()>
	//   92  188:isub            
	//   93  189:isub            
	//   94  190:istore_1        
					if(i > 0)
...
label1:
		{
			if(layoutmanager.canScrollVertically())
	//* 100  200:aload           8
	//* 101  202:invokevirtual   #328 <Method boolean android.support.v7.widget.RecyclerView$LayoutManager.canScrollVertically()>
	//* 102  205:ifeq            306
			{
				int l = (int)(mSelectedStartY + mDy);
	//  103  208:aload_0         
	//  104  209:getfield        #242 <Field float mSelectedStartY>
	//  105  212:aload_0         
	//  106  213:getfield        #184 <Field float mDy>
	//  107  216:fadd            
	//  108  217:f2i             
	//  109  218:istore_3        
	...
	//  110  219:iload_3         
	//  111  220:aload_0         
	//  112  221:getfield        #570 <Field Rect mTmpRect>
	//  113  224:getfield        #590 <Field int Rect.top>
	//  114  227:isub            
	//  115  228:aload_0         
	//  116  229:getfield        #132 <Field RecyclerView mRecyclerView>
	//  117  232:invokevirtual   #593 <Method int RecyclerView.getPaddingTop()>
	//  118  235:isub            
	//  119  236:istore_2        
				if(mDy < 0.0F && k < 0)
	//* 120  237:aload_0         
	//* 121  238:getfield        #184 <Field float mDy>
	//* 122  241:fconst_0        
	//* 123  242:fcmpg           
	//* 124  243:ifge            253
	//* 125  246:iload_2         
	...
	//  127  250:goto            308
				if(mDy > 0.0F)
	//* 128  253:aload_0         
	//* 129  254:getfield        #184 <Field float mDy>
	//* 130  257:fconst_0        
	//* 131  258:fcmpl           
	//* 132  259:ifle            306
				{
	...
	//  133  262:iload_3         
	//  134  263:aload_0         
	//  135  264:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//  136  267:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//  137  270:invokevirtual   #251 <Method int View.getHeight()>
	//  138  273:iadd            
	//  139  274:aload_0         
	//  140  275:getfield        #570 <Field Rect mTmpRect>
	//  141  278:getfield        #596 <Field int Rect.bottom>
	//  142  281:iadd            
	//  143  282:aload_0         
	//  144  283:getfield        #132 <Field RecyclerView mRecyclerView>
	//  145  286:invokevirtual   #187 <Method int RecyclerView.getHeight()>
	//  146  289:aload_0         
	//  147  290:getfield        #132 <Field RecyclerView mRecyclerView>
	//  148  293:invokevirtual   #599 <Method int RecyclerView.getPaddingBottom()>
	//  149  296:isub            
	//  150  297:isub            
	//  151  298:istore_2        
					if(k > 0)
	...
	//  159  312:aload_0         
	//  160  313:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  161  316:aload_0         
	//  162  317:getfield        #132 <Field RecyclerView mRecyclerView>
	//  163  320:aload_0         
	//  164  321:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//  165  324:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//  166  327:invokevirtual   #250 <Method int View.getWidth()>
	//  167  330:iload_1         
	//  168  331:aload_0         
	//  169  332:getfield        #132 <Field RecyclerView mRecyclerView>
	//  170  335:invokevirtual   #177 <Method int RecyclerView.getWidth()>
	//  171  338:lload           4
	//  172  340:invokevirtual   #603 <Method int ItemTouchHelper$Callback.interpolateOutOfBoundsScroll(RecyclerView, int, int, int, long)>
	//  173  343:istore_1        
	//* 174  344:goto            347
		if(k != 0)
	//* 175  347:iload_2         
	...
	//  177  351:aload_0         
	//  178  352:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  179  355:aload_0         
	//  180  356:getfield        #132 <Field RecyclerView mRecyclerView>
	//  181  359:aload_0         
	//  182  360:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//  183  363:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//  184  366:invokevirtual   #251 <Method int View.getHeight()>
	//  185  369:iload_2         
	//  186  370:aload_0         
	//  187  371:getfield        #132 <Field RecyclerView mRecyclerView>
	//  188  374:invokevirtual   #187 <Method int RecyclerView.getHeight()>
	//  189  377:lload           4
	//  190  379:invokevirtual   #603 <Method int ItemTouchHelper$Callback.interpolateOutOfBoundsScroll(RecyclerView, int, int, int, long)>
	//  191  382:istore_2        
	//* 192  383:goto            386
		if(i == 0 && k == 0)
	//* 193  386:iload_1         
	...
	//* 197  394:goto            406
		{
			mDragScrollStartTimeInMs = 0x0L;
	//  198  397:aload_0         
	//  199  398:ldc2w           #559 <Long 0x0L>
	//  200  401:putfield        #562 <Field long mDragScrollStartTimeInMs>
			return false;
	//  201  404:iconst_0        
	//  202  405:ireturn         
		}
	...
	//* 203  406:aload_0         
	//* 204  407:getfield        #562 <Field long mDragScrollStartTimeInMs>
	//* 205  410:ldc2w           #559 <Long 0x0L>
	//* 206  413:lcmp            
	//* 207  414:ifne            423
			mDragScrollStartTimeInMs = l2;
	//  208  417:aload_0         
	//  209  418:lload           6
	//  210  420:putfield        #562 <Field long mDragScrollStartTimeInMs>
		mRecyclerView.scrollBy(i, k);
	//  211  423:aload_0         
	//  212  424:getfield        #132 <Field RecyclerView mRecyclerView>
	//  213  427:iload_1         
	//  214  428:iload_2         
	//  215  429:invokevirtual   #607 <Method void RecyclerView.scrollBy(int, int)>
		return true;
	//  216  432:iconst_1        
	//  217  433:ireturn         
	}
	...
	//*   0    0:aload_1         
	//*   1    1:aload_0         
	//*   2    2:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//*   3    5:if_acmpne       17
	//*   4    8:iload_2         
	//*   5    9:aload_0         
	//*   6   10:getfield        #103 <Field int mActionState>
	//*   7   13:icmpne          17
			return;
	//    8   16:return          
		mDragScrollStartTimeInMs = 0x0L;
	//    9   17:aload_0         
	//   10   18:ldc2w           #559 <Long 0x0L>
	//   11   21:putfield        #562 <Field long mDragScrollStartTimeInMs>
		int k = mActionState;
	//   12   24:aload_0         
	//   13   25:getfield        #103 <Field int mActionState>
	//   14   28:istore          9
		endRecoverAnimation(viewholder, true);
	//   15   30:aload_0         
	//   16   31:aload_1         
	//   17   32:iconst_1        
	//   18   33:invokevirtual   #535 <Method void endRecoverAnimation(android.support.v7.widget.RecyclerView$ViewHolder, boolean)>
		mActionState = i;
	//   19   36:aload_0         
	//   20   37:iload_2         
	//   21   38:putfield        #103 <Field int mActionState>
		if(i == 2)
	//*  22   41:iload_2         
	//*  23   42:iconst_2        
	//*  24   43:icmpne          76
	...
	//   27   50:aload_0         
	//   28   51:aload_1         
	//   29   52:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//   30   55:putfield        #114 <Field View mOverdrawChild>
				addChildDrawingOrderCallback();
	//   31   58:aload_0         
	//   32   59:invokespecial   #609 <Method void addChildDrawingOrderCallback()>
			} else
	//*  33   62:goto            76
			{
				throw new IllegalArgumentException("Must pass a ViewHolder when dragging");
	//   34   65:new             #611 <Class IllegalArgumentException>
	//   35   68:dup             
	//   36   69:ldc2            #613 <String "Must pass a ViewHolder when dragging">
	//   37   72:invokespecial   #616 <Method void IllegalArgumentException(String)>
	//   38   75:athrow          
			}
		final Object final_viewholder = ((Object) (mSelected));
	//   39   76:aload_0         
	//   40   77:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//   41   80:astore          11
		boolean flag;
	...
	//*  44   87:aload           11
	//*  45   89:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  46   92:invokevirtual   #620 <Method ViewParent View.getParent()>
	//*  47   95:ifnull          353
			{
				int j;
				if(k == 2)
	...
	//   54  110:aload_0         
	//   55  111:aload           11
	//   56  113:invokespecial   #622 <Method int swipeIfNecessary(android.support.v7.widget.RecyclerView$ViewHolder)>
	//   57  116:istore          8
				releaseVelocityTracker();
	//   58  118:aload_0         
	//   59  119:invokespecial   #222 <Method void releaseVelocityTracker()>
				float f;
				float f1;
	...
	//   79  180:aload_0         
	//   80  181:getfield        #184 <Field float mDy>
	//   81  184:invokestatic    #625 <Method float Math.signum(float)>
	//   82  187:aload_0         
	//   83  188:getfield        #132 <Field RecyclerView mRecyclerView>
	//   84  191:invokevirtual   #187 <Method int RecyclerView.getHeight()>
	//   85  194:i2f             
	//   86  195:fmul            
	//   87  196:fstore          4
						f = 0.0F;
	...
	//   91  203:aload_0         
	//   92  204:getfield        #142 <Field float mDx>
	//   93  207:invokestatic    #625 <Method float Math.signum(float)>
	//   94  210:aload_0         
	//   95  211:getfield        #132 <Field RecyclerView mRecyclerView>
	//   96  214:invokevirtual   #177 <Method int RecyclerView.getWidth()>
	//   97  217:i2f             
	//   98  218:fmul            
	//   99  219:fstore_3        
					f1 = 0.0F;
	...
	//  115  250:aload_0         
	//  116  251:aload_0         
	//  117  252:getfield        #97  <Field float[] mTmpPosition>
	//  118  255:invokespecial   #542 <Method void getSelectedDxDy(float[])>
				float af[] = mTmpPosition;
	//  119  258:aload_0         
	//  120  259:getfield        #97  <Field float[] mTmpPosition>
	//  121  262:astore          12
				float f2 = af[0];
	//  122  264:aload           12
	//  123  266:iconst_0        
	...
	//  130  276:new             #12  <Class ItemTouchHelper$3>
	//  131  279:dup             
	//  132  280:aload_0         
	//  133  281:aload           11
	//  134  283:iload           7
	...
	//  140  294:iload           8
	//  141  296:aload           11
	//  142  298:invokespecial   #628 <Method void ItemTouchHelper$3(ItemTouchHelper, android.support.v7.widget.RecyclerView$ViewHolder, int, int, float, float, float, float, int, android.support.v7.widget.RecyclerView$ViewHolder)>
	//  143  301:astore          11
				((RecoverAnimation) (final_viewholder)).setDuration(mCallback.getAnimationDuration(mRecyclerView, ((int) (final_i)), f - f2, f1 - f3));
	//  144  303:aload           11
	//  145  305:aload_0         
	//  146  306:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  147  309:aload_0         
	//  148  310:getfield        #132 <Field RecyclerView mRecyclerView>
	//  149  313:iload           7
	//  150  315:fload_3         
	//  151  316:fload           5
	//  152  318:fsub            
	...
	//  154  321:fload           6
	//  155  323:fsub            
	//  156  324:invokevirtual   #632 <Method long ItemTouchHelper$Callback.getAnimationDuration(RecyclerView, int, float, float)>
	//  157  327:invokevirtual   #636 <Method void ItemTouchHelper$RecoverAnimation.setDuration(long)>
				mRecoverAnimations.add(final_viewholder);
	//  158  330:aload_0         
	//  159  331:getfield        #105 <Field List mRecoverAnimations>
	//  160  334:aload           11
	//  161  336:invokeinterface #638 <Method boolean List.add(Object)>
	//  162  341:pop             
				((RecoverAnimation) (final_viewholder)).start();
	//  163  342:aload           11
	//  164  344:invokevirtual   #641 <Method void ItemTouchHelper$RecoverAnimation.start()>
				flag = true;
	//  165  347:iconst_1        
	//  166  348:istore          7
			} else
	...
	//  168  353:aload_0         
	//  169  354:aload           11
	//  170  356:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//  171  359:invokevirtual   #533 <Method void removeChildDrawingOrderCallbackIfNecessary(View)>
				mCallback.clearView(mRecyclerView, ((android.support.v7.widget.RecyclerView.ViewHolder) (final_viewholder)));
	//  172  362:aload_0         
	//  173  363:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  174  366:aload_0         
	//  175  367:getfield        #132 <Field RecyclerView mRecyclerView>
	//  176  370:aload           11
	//  177  372:invokevirtual   #216 <Method void ItemTouchHelper$Callback.clearView(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
				flag = false;
	//  178  375:iconst_0        
	//  179  376:istore          7
			}
	...
	//  180  378:aload_0         
	//  181  379:aconst_null     
	//  182  380:putfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
		} else
	//* 183  383:goto            389
		{
			flag = false;
	...
	//  188  393:aload_0         
	//  189  394:aload_0         
	//  190  395:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  191  398:aload_0         
	//  192  399:getfield        #132 <Field RecyclerView mRecyclerView>
	//  193  402:aload_1         
	//  194  403:invokevirtual   #447 <Method int ItemTouchHelper$Callback.getAbsoluteMovementFlags(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
	//  195  406:iconst_1        
	//  196  407:iload_2         
	//  197  408:bipush          8
	//  198  410:imul            
	...
	//  204  417:iand            
	//  205  418:aload_0         
	//  206  419:getfield        #103 <Field int mActionState>
	//  207  422:bipush          8
	//  208  424:imul            
	//  209  425:ishr            
	//  210  426:putfield        #336 <Field int mSelectedFlags>
			mSelectedStartX = viewholder.itemView.getLeft();
	//  211  429:aload_0         
	//  212  430:aload_1         
	//  213  431:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//  214  434:invokevirtual   #276 <Method int View.getLeft()>
	//  215  437:i2f             
	//  216  438:putfield        #236 <Field float mSelectedStartX>
			mSelectedStartY = viewholder.itemView.getTop();
	//  217  441:aload_0         
	//  218  442:aload_1         
	//  219  443:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//  220  446:invokevirtual   #270 <Method int View.getTop()>
	//  221  449:i2f             
	//  222  450:putfield        #242 <Field float mSelectedStartY>
			mSelected = viewholder;
	//  223  453:aload_0         
	//  224  454:aload_1         
	//  225  455:putfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
			if(i == 2)
	//* 226  458:iload_2         
	//* 227  459:iconst_2        
	//* 228  460:icmpne          478
	...
	//  229  463:aload_0         
	//  230  464:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//  231  467:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//  232  470:iconst_0        
	//  233  471:invokevirtual   #645 <Method boolean View.performHapticFeedback(int)>
	//  234  474:pop             
		}
	//* 235  475:goto            481
	//* 236  478:goto            481
	...
	//  239  484:aload_0         
	//  240  485:getfield        #132 <Field RecyclerView mRecyclerView>
	//  241  488:invokevirtual   #646 <Method ViewParent RecyclerView.getParent()>
	//  242  491:astore_1        
		if(viewholder != null)
	//* 243  492:aload_1         
	//* 244  493:ifnull          514
		{
			if(mSelected != null)
	//* 245  496:aload_0         
	//* 246  497:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//* 247  500:ifnull          506
				flag1 = true;
	//  248  503:iconst_1        
	//  249  504:istore          10
	...
	//  250  506:aload_1         
	//  251  507:iload           10
	//  252  509:invokeinterface #652 <Method void ViewParent.requestDisallowInterceptTouchEvent(boolean)>
		}
		if(!flag)
	//* 253  514:iload           7
	//* 254  516:ifne            529
	...
	//  255  519:aload_0         
	//  256  520:getfield        #132 <Field RecyclerView mRecyclerView>
	//  257  523:invokevirtual   #255 <Method android.support.v7.widget.RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//  258  526:invokevirtual   #655 <Method void android.support.v7.widget.RecyclerView$LayoutManager.requestSimpleAnimationsInNextLayout()>
		mCallback.onSelectedChanged(mSelected, mActionState);
	//  259  529:aload_0         
	//  260  530:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//  261  533:aload_0         
	//  262  534:getfield        #99  <Field android.support.v7.widget.RecyclerView$ViewHolder mSelected>
	//  263  537:aload_0         
	//  264  538:getfield        #103 <Field int mActionState>
	//  265  541:invokevirtual   #658 <Method void ItemTouchHelper$Callback.onSelectedChanged(android.support.v7.widget.RecyclerView$ViewHolder, int)>
		mRecyclerView.invalidate();
	//  266  544:aload_0         
	//  267  545:getfield        #132 <Field RecyclerView mRecyclerView>
	//  268  548:invokevirtual   #661 <Method void RecyclerView.invalidate()>
	//  269  551:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #121 <Field ItemTouchHelper$Callback mCallback>
	//*   2    4:aload_0         
	//*   3    5:getfield        #132 <Field RecyclerView mRecyclerView>
	//*   4    8:aload_1         
	//*   5    9:invokevirtual   #666 <Method boolean ItemTouchHelper$Callback.hasDragFlag(RecyclerView, android.support.v7.widget.RecyclerView$ViewHolder)>
	//*   6   12:ifne            26
		{
			Log.e("ItemTouchHelper", "Start drag has been called but dragging is not enabled");
	//    7   15:ldc2            #668 <String "ItemTouchHelper">
	//    8   18:ldc2            #670 <String "Start drag has been called but dragging is not enabled">
	//    9   21:invokestatic    #676 <Method int Log.e(String, String)>
	//   10   24:pop             
			return;
	//   11   25:return          
		}
	...
	//*  12   26:aload_1         
	//*  13   27:getfield        #247 <Field View android.support.v7.widget.RecyclerView$ViewHolder.itemView>
	//*  14   30:invokevirtual   #620 <Method ViewParent View.getParent()>
	//*  15   33:aload_0         
	//*  16   34:getfield        #132 <Field RecyclerView mRecyclerView>
	//*  17   37:if_acmpeq       51
		{
			Log.e("ItemTouchHelper", "Start drag has been called with a view holder which is not a child of the RecyclerView which is controlled by this ItemTouchHelper.");
	//   18   40:ldc2            #668 <String "ItemTouchHelper">
	//   19   43:ldc2            #678 <String "Start drag has been called with a view holder which is not a child of the RecyclerView which is controlled by this ItemTouchHelper.">
	//   20   46:invokestatic    #676 <Method int Log.e(String, String)>
	//   21   49:pop             
			return;
	//   22   50:return          
		} else
	...
	//   23   51:aload_0         
	//   24   52:invokevirtual   #680 <Method void obtainVelocityTracker()>
			mDy = 0.0F;
	//   25   55:aload_0         
	//   26   56:fconst_0        
	//   27   57:putfield        #184 <Field float mDy>
			mDx = 0.0F;
	//   28   60:aload_0         
	//   29   61:fconst_0        
	//   30   62:putfield        #142 <Field float mDx>
			select(viewholder, 2);
	//   31   65:aload_0         
	//   32   66:aload_1         
	//   33   67:iconst_2        
	//   34   68:invokevirtual   #454 <Method void select(android.support.v7.widget.RecyclerView$ViewHolder, int)>
			return;
	//   35   71:return          
		}
	}
	...
	//    0    0:aload_1         
	//    1    1:iload_3         
	//    2    2:invokevirtual   #312 <Method float MotionEvent.getX(int)>
	//    3    5:fstore          4
		float f1 = motionevent.getY(j);
	//    4    7:aload_1         
	//    5    8:iload_3         
	//    6    9:invokevirtual   #317 <Method float MotionEvent.getY(int)>
	//    7   12:fstore          5
		mDx = f - mInitialTouchX;
	//    8   14:aload_0         
	//    9   15:fload           4
	//   10   17:aload_0         
	//   11   18:getfield        #314 <Field float mInitialTouchX>
	//   12   21:fsub            
	//   13   22:putfield        #142 <Field float mDx>
		mDy = f1 - mInitialTouchY;
	//   14   25:aload_0         
	//   15   26:fload           5
	//   16   28:aload_0         
	//   17   29:getfield        #319 <Field float mInitialTouchY>
	//   18   32:fsub            
	//   19   33:putfield        #184 <Field float mDy>
		if((i & 4) == 0)
	//*  20   36:iload_2         
	//*  21   37:iconst_4        
	//*  22   38:iand            
	...
	//   25   43:fconst_0        
	//   26   44:aload_0         
	//   27   45:getfield        #142 <Field float mDx>
	//   28   48:invokestatic    #686 <Method float Math.max(float, float)>
	//   29   51:putfield        #142 <Field float mDx>
		if((i & 8) == 0)
	//*  30   54:iload_2         
	//*  31   55:bipush          8
	//*  32   57:iand            
	...
	//   35   62:fconst_0        
	//   36   63:aload_0         
	//   37   64:getfield        #142 <Field float mDx>
	//   38   67:invokestatic    #689 <Method float Math.min(float, float)>
	//   39   70:putfield        #142 <Field float mDx>
		if((i & 1) == 0)
	//*  40   73:iload_2         
	//*  41   74:iconst_1        
	//*  42   75:iand            
	...
	//   45   80:fconst_0        
	//   46   81:aload_0         
	//   47   82:getfield        #184 <Field float mDy>
	//   48   85:invokestatic    #686 <Method float Math.max(float, float)>
	//   49   88:putfield        #184 <Field float mDy>
		if((i & 2) == 0)
	//*  50   91:iload_2         
	//*  51   92:iconst_2        
	//*  52   93:iand            
	...
	//   55   98:fconst_0        
	//   56   99:aload_0         
	//   57  100:getfield        #184 <Field float mDy>
	//   58  103:invokestatic    #689 <Method float Math.min(float, float)>
	//   59  106:putfield        #184 <Field float mDy>
	//   60  109:return          
	}
