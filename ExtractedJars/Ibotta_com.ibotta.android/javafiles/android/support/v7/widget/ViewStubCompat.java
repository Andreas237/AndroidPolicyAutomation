...
public final class ViewStubCompat extends View
{
	...
	//   20   40:aload_0         
	//   21   41:invokevirtual   #99  <Method Context getContext()>
	//   22   44:invokestatic    #105 <Method LayoutInflater LayoutInflater.from(Context)>
	//   23   47:astore_2        
				obj = ((Object) (((LayoutInflater) (obj)).inflate(mLayoutResource, ((ViewGroup) (obj1)), false)));
	//   24   48:aload_2         
	//   25   49:aload_0         
	//   26   50:getfield        #30  <Field int mLayoutResource>
	//   27   53:aload_3         
	//   28   54:iconst_0        
	//   29   55:invokevirtual   #108 <Method View LayoutInflater.inflate(int, ViewGroup, boolean)>
	//   30   58:astore_2        
				int i = mInflatedId;
	//   31   59:aload_0         
	//   32   60:getfield        #53  <Field int mInflatedId>
	//   33   63:istore_1        
				if(i != -1)
	//*  34   64:iload_1         
	//*  35   65:iconst_m1       
	...
	//   37   69:aload_2         
	//   38   70:iload_1         
	//   39   71:invokevirtual   #109 <Method void View.setId(int)>
				i = ((ViewGroup) (obj1)).indexOfChild(((View) (this)));
	//   40   74:aload_3         
	//   41   75:aload_0         
	//   42   76:invokevirtual   #113 <Method int ViewGroup.indexOfChild(View)>
	//   43   79:istore_1        
				((ViewGroup) (obj1)).removeViewInLayout(((View) (this)));
	//   44   80:aload_3         
	//   45   81:aload_0         
	//   46   82:invokevirtual   #117 <Method void ViewGroup.removeViewInLayout(View)>
				android.view.ViewGroup.LayoutParams layoutparams = getLayoutParams();
	//   47   85:aload_0         
	//   48   86:invokevirtual   #121 <Method android.view.ViewGroup$LayoutParams getLayoutParams()>
	//   49   89:astore          4
	...
	//   54   98:iload_1         
	//   55   99:aload           4
	//   56  101:invokevirtual   #125 <Method void ViewGroup.addView(View, int, android.view.ViewGroup$LayoutParams)>
				else
	//*  57  104:goto            113
	...
	//   59  108:aload_2         
	//   60  109:iload_1         
	//   61  110:invokevirtual   #128 <Method void ViewGroup.addView(View, int)>
				mInflatedViewRef = new WeakReference(obj);
	//   62  113:aload_0         
	//   63  114:new             #130 <Class WeakReference>
	//   64  117:dup             
	//   65  118:aload_2         
	//   66  119:invokespecial   #133 <Method void WeakReference(Object)>
	//   67  122:putfield        #135 <Field WeakReference mInflatedViewRef>
				obj1 = ((Object) (mInflateListener));
	//   68  125:aload_0         
	//   69  126:getfield        #137 <Field ViewStubCompat$OnInflateListener mInflateListener>
	//   70  129:astore_3        
				if(obj1 != null)
	//*  71  130:aload_3         
	//*  72  131:ifnull          142
	...
	//   74  135:aload_0         
	//   75  136:aload_2         
	//   76  137:invokeinterface #141 <Method void ViewStubCompat$OnInflateListener.onInflate(ViewStubCompat, View)>
				return ((View) (obj));
	//   77  142:aload_2         
	//   78  143:areturn         
			} else
	...
	//   79  144:new             #143 <Class IllegalArgumentException>
	//   80  147:dup             
	//   81  148:ldc1            #145 <String "ViewStub must have a valid layoutResource">
	//   82  150:invokespecial   #148 <Method void IllegalArgumentException(String)>
	//   83  153:athrow          
			}
		} else
		{
			throw new IllegalStateException("ViewStub must have a non-null ViewGroup viewParent");
	//   84  154:new             #150 <Class IllegalStateException>
	//   85  157:dup             
	//   86  158:ldc1            #152 <String "ViewStub must have a non-null ViewGroup viewParent">
	//   87  160:invokespecial   #153 <Method void IllegalStateException(String)>
	//   88  163:athrow          
		}
	}
	...
	//    5    9:aload_2         
	//    6   10:invokevirtual   #168 <Method Object WeakReference.get()>
	...
	//   11   21:aload_2         
	//   12   22:iload_1         
	//   13   23:invokevirtual   #169 <Method void View.setVisibility(int)>
				return;
	//   14   26:return          
			} else
			{
				throw new IllegalStateException("setVisibility called on un-referenced view");
	//   15   27:new             #150 <Class IllegalStateException>
	//   16   30:dup             
	//   17   31:ldc1            #171 <String "setVisibility called on un-referenced view">
	//   18   33:invokespecial   #153 <Method void IllegalStateException(String)>
	//   19   36:athrow          
			}
		}
	...
	//   20   37:aload_0         
	//   21   38:iload_1         
	//   22   39:invokespecial   #169 <Method void View.setVisibility(int)>
		if(i == 0 || i == 4)
	//*  23   42:iload_1         
	//*  24   43:ifeq            51
	//*  25   46:iload_1         
	...
	//*  27   48:icmpne          56
			inflate();
	//   28   51:aload_0         
	//   29   52:invokevirtual   #173 <Method View inflate()>
	//   30   55:pop             
	//   31   56:return          
	}
