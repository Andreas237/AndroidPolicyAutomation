	...
	implements TintableBackgroundView
{
	...
	//    4    6:invokespecial   #29  <Method void AppCompatMultiAutoCompleteTextView(Context, AttributeSet, int)>
	//    5    9:return          
	}
	...
	//    3    5:aload_2         
	//    4    6:iload_3         
	//    5    7:invokespecial   #36  <Method void MultiAutoCompleteTextView(Context, AttributeSet, int)>
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #86  <Method void MultiAutoCompleteTextView.drawableStateChanged()>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #107 <Method InputConnection MultiAutoCompleteTextView.onCreateInputConnection(EditorInfo)>
	//    3    5:aload_1         
	//    4    6:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #115 <Method void MultiAutoCompleteTextView.setBackgroundDrawable(Drawable)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #123 <Method void MultiAutoCompleteTextView.setBackgroundResource(int)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	//    4    6:getfield        #68  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    5    9:astore_2        
	...
	//    3    5:iload_1         
	//    4    6:invokestatic    #133 <Method Drawable AppCompatResources.getDrawable(Context, int)>
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #137 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintList(ColorStateList)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #141 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintMode(android.graphics.PorterDuff$Mode)>
	//    8   14:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #145 <Method void MultiAutoCompleteTextView.setTextAppearance(Context, int)>
	...
	//   10   16:aload_1         
	//   11   17:iload_2         
	//   12   18:invokevirtual   #148 <Method void AppCompatTextHelper.onSetTextAppearance(Context, int)>
	//   13   21:return          
	}
