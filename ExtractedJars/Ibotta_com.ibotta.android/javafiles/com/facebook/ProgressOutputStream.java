	...
	implements RequestOutputStream
{
	...
	{
		RequestProgress requestprogress = currentRequestProgress;
	//    0    0:aload_0         
	...
	//*   3    5:aload_3         
	//*   4    6:ifnull          14
			requestprogress.addProgress(l);
	//    5    9:aload_3         
	//    6   10:lload_1         
	//    7   11:invokevirtual   #57  <Method void RequestProgress.addProgress(long)>
		batchProgress = batchProgress + l;
	//    8   14:aload_0         
	//    9   15:aload_0         
	//   10   16:getfield        #48  <Field long batchProgress>
	//   11   19:lload_1         
	//   12   20:ladd            
	//   13   21:putfield        #48  <Field long batchProgress>
		l = batchProgress;
	//   14   24:aload_0         
	//   15   25:getfield        #48  <Field long batchProgress>
	//   16   28:lstore_1        
		if(l >= lastReportedProgress + threshold || l >= maxProgress)
	//*  17   29:lload_1         
	//*  18   30:aload_0         
	//*  19   31:getfield        #59  <Field long lastReportedProgress>
	//*  20   34:aload_0         
	//*  21   35:getfield        #39  <Field long threshold>
	//*  22   38:ladd            
	//*  23   39:lcmp            
	//*  24   40:ifge            52
	//*  25   43:lload_1         
	//*  26   44:aload_0         
	//*  27   45:getfield        #31  <Field long maxProgress>
	//*  28   48:lcmp            
	//*  29   49:iflt            56
			reportBatchProgress();
	//   30   52:aload_0         
	//   31   53:invokespecial   #63  <Method void reportBatchProgress()>
	//   32   56:return          
	}
	...
	//    3    5:getfield        #29  <Field Map progressMap>
	//    4    8:aload_1         
	//    5    9:invokeinterface #130 <Method Object Map.get(Object)>
		...
		throws IOException
	{
		out.write(i);
	//    0    0:aload_0         
	//    1    1:getfield        #136 <Field OutputStream out>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #140 <Method void OutputStream.write(int)>
		addProgress(1L);
	//    4    8:aload_0         
	//    5    9:lconst_1        
	//    6   10:invokespecial   #141 <Method void addProgress(long)>
	//    7   13:return          
	}
	...
	//    1    1:getfield        #136 <Field OutputStream out>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #144 <Method void OutputStream.write(byte[])>
		addProgress(abyte0.length);
	//    4    8:aload_0         
	//    5    9:aload_1         
	//    6   10:arraylength     
	//    7   11:i2l             
	//    8   12:invokespecial   #141 <Method void addProgress(long)>
	//    9   15:return          
	}
	...
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:invokevirtual   #147 <Method void OutputStream.write(byte[], int, int)>
		addProgress(j);
	//    6   10:aload_0         
	//    7   11:iload_3         
	//    8   12:i2l             
	//    9   13:invokespecial   #141 <Method void addProgress(long)>
	//   10   16:return          
	}
