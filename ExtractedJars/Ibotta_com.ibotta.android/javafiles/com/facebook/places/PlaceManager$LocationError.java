...
public static final class PlaceManager$LocationError extends Enum
{

	public static PlaceManager$LocationError valueOf(String s)
	{
		return (PlaceManager$LocationError)Enum.valueOf(com/facebook/places/PlaceManager$LocationError, s);
	...
	{
		return (PlaceManager$LocationError[])((PlaceManager$LocationError []) ($VALUES)).clone();
	...
	private static final PlaceManager$LocationError $VALUES[];
	public static final PlaceManager$LocationError LOCATION_PERMISSION_DENIED;
	public static final PlaceManager$LocationError LOCATION_SERVICES_DISABLED;
	...
	static 
	{
		LOCATION_PERMISSION_DENIED = new PlaceManager$LocationError("LOCATION_PERMISSION_DENIED", 0);
	...
	//    5   10:putstatic       #24  <Field PlaceManager$LocationError LOCATION_PERMISSION_DENIED>
		LOCATION_SERVICES_DISABLED = new PlaceManager$LocationError("LOCATION_SERVICES_DISABLED", 1);
	...
	//   11   23:putstatic       #27  <Field PlaceManager$LocationError LOCATION_SERVICES_DISABLED>
		LOCATION_TIMEOUT = new PlaceManager$LocationError("LOCATION_TIMEOUT", 2);
	...
	//   17   36:putstatic       #30  <Field PlaceManager$LocationError LOCATION_TIMEOUT>
		UNKNOWN_ERROR = new PlaceManager$LocationError("UNKNOWN_ERROR", 3);
	...
	private PlaceManager$LocationError(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
