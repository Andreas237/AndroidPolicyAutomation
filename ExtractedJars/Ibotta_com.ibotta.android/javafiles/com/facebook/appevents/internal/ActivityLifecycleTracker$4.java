	...
	//*  18   44:ifgt            100
		{
			Runnable runnable = new Runnable() {
				...
				//*   2    6:ifgt            40
					{
						SessionLogger.logDeactivateApp(applicationContext, activityName, ActivityLifecycleTracker.access$200(), ActivityLifecycleTracker.access$300());
				//    3    9:aload_0         
...
;
	...
	ActivityLifecycleTracker$4(long l, Context context, String s)
	{
		val$currentTime = l;
	//    0    0:aload_0         
	//    1    1:lload_1         
