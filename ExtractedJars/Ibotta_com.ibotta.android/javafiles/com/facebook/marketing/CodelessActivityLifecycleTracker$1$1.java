...
//			CodelessActivityLifecycleTracker, ViewIndexingTrigger, ViewIndexer

class CodelessActivityLifecycleTracker$1$1
	implements ViewIndexingTrigger.OnShakeListener
{
	...
	//    4    8:invokevirtual   #46  <Method void ViewIndexingTrigger.resetCount()>
			MarketingLogger marketinglogger = new MarketingLogger(val$applicationContext, val$appId);
	...
	//*  22   44:ifeq            55
				CodelessActivityLifecycleTracker.checkCodelessSession(val$appId, marketinglogger);
	//   23   47:aload_0         
	...
	CodelessActivityLifecycleTracker$1$1()
	{
		this$0 = final__pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//    8   12:putfield        #27  <Field String val$appId>
		val$appSettings = FetchedAppSettings.this;
	//    9   15:aload_0         
	//   10   16:aload           4
	...
	// Unreferenced inner class com/facebook/marketing/CodelessActivityLifecycleTracker$1

/* anonymous class */
	static final class CodelessActivityLifecycleTracker._cls1
		implements android.app.Application.ActivityLifecycleCallbacks
	{
		...
		//   23   48:pop             
			CodelessActivityLifecycleTracker.access$200().setOnShakeListener(((ViewIndexingTrigger.OnShakeListener) (((CodelessActivityLifecycleTracker._cls1._cls1) (fetchedappsettings)). new CodelessActivityLifecycleTracker._cls1._cls1())));
