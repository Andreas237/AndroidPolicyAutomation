...
class FetchedAppSettingsManager$2$1
	implements Runnable
{

	public void run()
	{
		AutomaticAnalyticsLogger.logInAppPurchaseEvent(val$context, val$finalResultCode, val$finalData);
	//    0    0:aload_0         
	...
	// Unreferenced inner class com/facebook/internal/FetchedAppSettingsManager$2

/* anonymous class */
	static final class FetchedAppSettingsManager._cls2
		implements CallbackManagerImpl.Callback
	{

		public boolean onActivityResult(final int finalResultCode, Intent intent)
		{
			FacebookSdk.getExecutor().execute(((Runnable) (((FetchedAppSettingsManager._cls2._cls1) (intent)). new FetchedAppSettingsManager._cls2._cls1())));
