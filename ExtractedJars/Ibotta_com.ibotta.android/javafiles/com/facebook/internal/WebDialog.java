...
public class WebDialog extends Dialog
{
		...
		implements TraceFieldInterface
	{
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #45  <Field Trace _nr_trace>
				return;
		//    3    5:return          
			}
			// Misplaced declaration of an exception variable
		...
		{
			TraceMachine.enterMethod(_nr_trace, "WebDialog$UploadStagingResourcesTask#doInBackground", ((java.util.ArrayList) (null)));
		//    0    0:aload_0         
		//    1    1:getfield        #45  <Field Trace _nr_trace>
		//    2    4:ldc1            #51  <String "WebDialog$UploadStagingResourcesTask#doInBackground">
		//    3    6:aconst_null     
		//    4    7:invokestatic    #57  <Method void TraceMachine.enterMethod(Trace, String, java.util.ArrayList)>
			  goto _L1
		//*   5   10:goto            20
_L3:
			TraceMachine.enterMethod(((Trace) (null)), "WebDialog$UploadStagingResourcesTask#doInBackground", ((java.util.ArrayList) (null)));
		//    6   13:aconst_null     
		//    7   14:ldc1            #51  <String "WebDialog$UploadStagingResourcesTask#doInBackground">
		//    8   16:aconst_null     
		//    9   17:invokestatic    #57  <Method void TraceMachine.enterMethod(Trace, String, java.util.ArrayList)>
_L1:
			aobj = ((Object []) (doInBackground((Void[])aobj)));
		//   10   20:aload_0         
		//   11   21:aload_1         
		//   12   22:checkcast       #59  <Class Void[]>
		//   13   25:invokevirtual   #62  <Method String[] doInBackground(Void[])>
		//   14   28:astore_1        
			TraceMachine.exitMethod();
		//   15   29:invokestatic    #65  <Method void TraceMachine.exitMethod()>
			TraceMachine.unloadTraceContext(((Object) (this)));
		//   16   32:aload_0         
		//   17   33:invokestatic    #69  <Method void TraceMachine.unloadTraceContext(Object)>
			return ((Object) (aobj));
		//   18   36:aload_1         
		//   19   37:areturn         
...
_L2:
		...
		//    0    0:aload_0         
		//    1    1:getfield        #34  <Field Bundle parameters>
		//    2    4:ldc1            #71  <String "media">
		//    3    6:invokevirtual   #77  <Method String[] Bundle.getStringArray(String)>
		//    4    9:astore_3        
		...
		//   13   23:putfield        #39  <Field Exception[] exceptions>
			countdownlatch = new CountDownLatch(obj.length);
		//   14   26:new             #81  <Class CountDownLatch>
		//   15   29:dup             
		//   16   30:aload_3         
		//   17   31:arraylength     
		//   18   32:invokespecial   #84  <Method void CountDownLatch(int)>
		//   19   35:astore          5
			avoid = ((Void []) (new ConcurrentLinkedQueue()));
		//   20   37:new             #86  <Class ConcurrentLinkedQueue>
		//   21   40:dup             
		//   22   41:invokespecial   #87  <Method void ConcurrentLinkedQueue()>
		//   23   44:astore_1        
			accesstoken = AccessToken.getCurrentAccessToken();
		//   24   45:invokestatic    #93  <Method AccessToken AccessToken.getCurrentAccessToken()>
		//   25   48:astore          6
			writeIndex = 0;
		//   26   50:iconst_0        
		//   27   51:istore_2        
_L2:
		...
		//   31   55:icmpge          160
			if(isCancelled())
		//*  32   58:aload_0         
		//*  33   59:invokevirtual   #97  <Method boolean isCancelled()>
		//*  34   62:ifeq            96
			{
				for(obj = ((Object) (((ConcurrentLinkedQueue) (avoid)).iterator())); ((Iterator) (obj)).hasNext(); ((AsyncTask)((Iterator) (obj)).next()).cancel(true));
		//   35   65:aload_1         
		//   36   66:invokevirtual   #101 <Method Iterator ConcurrentLinkedQueue.iterator()>
		//   37   69:astore_3        
		//   38   70:aload_3         
		//   39   71:invokeinterface #106 <Method boolean Iterator.hasNext()>
		//   40   76:ifeq            205
		//   41   79:aload_3         
		//   42   80:invokeinterface #110 <Method Object Iterator.next()>
		//   43   85:checkcast       #5   <Class AsyncTask>
		//   44   88:iconst_1        
		//   45   89:invokevirtual   #114 <Method boolean AsyncTask.cancel(boolean)>
		//   46   92:pop             
		...
		//   49   97:iload_2         
		//   50   98:aaload          
		//   51   99:invokestatic    #120 <Method Uri Uri.parse(String)>
		//   52  102:astore          7
			if(Utility.isWebUri(uri))
		//*  53  104:aload           7
		//*  54  106:invokestatic    #126 <Method boolean Utility.isWebUri(Uri)>
		//*  55  109:ifeq            129
			{
		...
		//   57  114:iload_2         
		//   58  115:aload           7
		//   59  117:invokevirtual   #130 <Method String Uri.toString()>
		//   60  120:aastore         
				countdownlatch.countDown();
		//   61  121:aload           5
		//   62  123:invokevirtual   #133 <Method void CountDownLatch.countDown()>
		...
		//   65  130:aload           6
		//   66  132:aload           7
		//   67  134:new             #12  <Class WebDialog$UploadStagingResourcesTask$1>
		//   68  137:dup             
		//   69  138:aload_0         
		//   70  139:aload           4
		//   71  141:iload_2         
		//   72  142:aload           5
		//   73  144:invokespecial   #136 <Method void WebDialog$UploadStagingResourcesTask$1(WebDialog$UploadStagingResourcesTask, String[], int, CountDownLatch)>
		//   74  147:invokestatic    #142 <Method GraphRequest ShareInternalUtility.newUploadStagingResourceWithImageRequest(AccessToken, Uri, com.facebook.GraphRequest$Callback)>
		//   75  150:invokevirtual   #148 <Method com.facebook.GraphRequestAsyncTask GraphRequest.executeAsync()>
		//   76  153:invokevirtual   #152 <Method boolean ConcurrentLinkedQueue.add(Object)>
		//   77  156:pop             
			}
		//*  78  157:goto            207
		//*  79  160:aload           5
		//*  80  162:invokevirtual   #155 <Method void CountDownLatch.await()>
		//*  81  165:aload           4
		//*  82  167:areturn         
		//*  83  168:aload_1         
		//*  84  169:invokevirtual   #101 <Method Iterator ConcurrentLinkedQueue.iterator()>
		//*  85  172:astore_1        
		//*  86  173:aload_1         
		//*  87  174:invokeinterface #106 <Method boolean Iterator.hasNext()>
		//*  88  179:ifeq            199
		//*  89  182:aload_1         
		//*  90  183:invokeinterface #110 <Method Object Iterator.next()>
		//*  91  188:checkcast       #5   <Class AsyncTask>
		//*  92  191:iconst_1        
		//*  93  192:invokevirtual   #114 <Method boolean AsyncTask.cancel(boolean)>
		//*  94  195:pop             
		//*  95  196:goto            173
		//*  96  199:aconst_null     
		//*  97  200:areturn         
...
_L1:
		...
		{
			TraceMachine.enterMethod(_nr_trace, "WebDialog$UploadStagingResourcesTask#onPostExecute", ((java.util.ArrayList) (null)));
		//    0    0:aload_0         
		//    1    1:getfield        #45  <Field Trace _nr_trace>
		//    2    4:ldc1            #158 <String "WebDialog$UploadStagingResourcesTask#onPostExecute">
		//    3    6:aconst_null     
		//    4    7:invokestatic    #57  <Method void TraceMachine.enterMethod(Trace, String, java.util.ArrayList)>
			  goto _L1
		//*   5   10:goto            20
_L3:
			TraceMachine.enterMethod(((Trace) (null)), "WebDialog$UploadStagingResourcesTask#onPostExecute", ((java.util.ArrayList) (null)));
		//    6   13:aconst_null     
		//    7   14:ldc1            #158 <String "WebDialog$UploadStagingResourcesTask#onPostExecute">
		//    8   16:aconst_null     
		//    9   17:invokestatic    #57  <Method void TraceMachine.enterMethod(Trace, String, java.util.ArrayList)>
_L1:
		...
		//   10   20:aload_0         
		//   11   21:aload_1         
		//   12   22:checkcast       #160 <Class String[]>
		//   13   25:invokevirtual   #163 <Method void onPostExecute(String[])>
			TraceMachine.exitMethod();
		//   14   28:invokestatic    #65  <Method void TraceMachine.exitMethod()>
			return;
		//   15   31:return          
			NoSuchFieldError nosuchfielderror;
			nosuchfielderror;
...
_L2:
		...
		protected void onPostExecute(String as[])
		{
			spinner.dismiss();
		//    0    0:aload_0         
		//    1    1:getfield        #27  <Field WebDialog this$0>
		//    2    4:invokestatic    #167 <Method ProgressDialog WebDialog.access$300(WebDialog)>
		//    3    7:invokevirtual   #172 <Method void ProgressDialog.dismiss()>
			Exception aexception[] = exceptions;
		//    4   10:aload_0         
		//    5   11:getfield        #39  <Field Exception[] exceptions>
		//    6   14:astore          4
		...
		//   21   38:aload_0         
		//   22   39:getfield        #27  <Field WebDialog this$0>
		//   23   42:aload           5
		//   24   44:invokevirtual   #176 <Method void WebDialog.sendErrorToListener(Throwable)>
					return;
		//   25   47:return          
				}
			}
		...
		//   33   59:aload_0         
		//   34   60:getfield        #27  <Field WebDialog this$0>
		//   35   63:new             #178 <Class FacebookException>
		//   36   66:dup             
		//   37   67:ldc1            #180 <String "Failed to stage photos for web dialog">
		//   38   69:invokespecial   #183 <Method void FacebookException(String)>
		//   39   72:invokevirtual   #176 <Method void WebDialog.sendErrorToListener(Throwable)>
				return;
		//   40   75:return          
			}
			as = ((String []) (Arrays.asList(((Object []) (as)))));
		//   41   76:aload_1         
		//   42   77:invokestatic    #189 <Method List Arrays.asList(Object[])>
		//   43   80:astore_1        
			if(((List) (as)).contains(((Object) (null))))
		//*  44   81:aload_1         
		//*  45   82:aconst_null     
		//*  46   83:invokeinterface #194 <Method boolean List.contains(Object)>
		//*  47   88:ifeq            108
			{
				sendErrorToListener(((Throwable) (new FacebookException("Failed to stage photos for web dialog"))));
		//   48   91:aload_0         
		//   49   92:getfield        #27  <Field WebDialog this$0>
		//   50   95:new             #178 <Class FacebookException>
		//   51   98:dup             
		//   52   99:ldc1            #180 <String "Failed to stage photos for web dialog">
		//   53  101:invokespecial   #183 <Method void FacebookException(String)>
		//   54  104:invokevirtual   #176 <Method void WebDialog.sendErrorToListener(Throwable)>
				return;
		//   55  107:return          
			} else
			{
		...
		//   56  108:aload_0         
		//   57  109:getfield        #34  <Field Bundle parameters>
		//   58  112:ldc1            #71  <String "media">
		//   59  114:new             #196 <Class JSONArray>
		//   60  117:dup             
		//   61  118:aload_1         
		//   62  119:invokespecial   #199 <Method void JSONArray(java.util.Collection)>
		//   63  122:invokestatic    #203 <Method boolean Utility.putJSONValueInBundle(Bundle, String, Object)>
		//   64  125:pop             
				as = ((String []) (ServerProtocol.getDialogAuthority()));
		//   65  126:invokestatic    #208 <Method String ServerProtocol.getDialogAuthority()>
		//   66  129:astore_1        
				StringBuilder stringbuilder = new StringBuilder();
		//   67  130:new             #210 <Class StringBuilder>
		//   68  133:dup             
		//   69  134:invokespecial   #211 <Method void StringBuilder()>
		//   70  137:astore          4
				stringbuilder.append(FacebookSdk.getGraphApiVersion());
		//   71  139:aload           4
		//   72  141:invokestatic    #216 <Method String FacebookSdk.getGraphApiVersion()>
		//   73  144:invokevirtual   #220 <Method StringBuilder StringBuilder.append(String)>
		//   74  147:pop             
				stringbuilder.append("/");
		//   75  148:aload           4
		//   76  150:ldc1            #222 <String "/">
		//   77  152:invokevirtual   #220 <Method StringBuilder StringBuilder.append(String)>
		//   78  155:pop             
				stringbuilder.append("dialog/");
		//   79  156:aload           4
		//   80  158:ldc1            #224 <String "dialog/">
		//   81  160:invokevirtual   #220 <Method StringBuilder StringBuilder.append(String)>
		//   82  163:pop             
				stringbuilder.append(action);
		//   83  164:aload           4
		//   84  166:aload_0         
		//   85  167:getfield        #32  <Field String action>
		//   86  170:invokevirtual   #220 <Method StringBuilder StringBuilder.append(String)>
		//   87  173:pop             
				as = ((String []) (Utility.buildUri(((String) (as)), stringbuilder.toString(), parameters)));
		//   88  174:aload_1         
		//   89  175:aload           4
		//   90  177:invokevirtual   #225 <Method String StringBuilder.toString()>
		//   91  180:aload_0         
		//   92  181:getfield        #34  <Field Bundle parameters>
		//   93  184:invokestatic    #229 <Method Uri Utility.buildUri(String, String, Bundle)>
		//   94  187:astore_1        
				url = ((Uri) (as)).toString();
		//   95  188:aload_0         
		//   96  189:getfield        #27  <Field WebDialog this$0>
		//   97  192:aload_1         
		//   98  193:invokevirtual   #130 <Method String Uri.toString()>
		//   99  196:invokestatic    #233 <Method String WebDialog.access$902(WebDialog, String)>
		//  100  199:pop             
				int j = crossImageView.getDrawable().getIntrinsicWidth();
		//  101  200:aload_0         
		//  102  201:getfield        #27  <Field WebDialog this$0>
		//  103  204:invokestatic    #237 <Method ImageView WebDialog.access$600(WebDialog)>
		//  104  207:invokevirtual   #243 <Method Drawable ImageView.getDrawable()>
		//  105  210:invokevirtual   #249 <Method int Drawable.getIntrinsicWidth()>
		//  106  213:istore_2        
				setUpWebView(j / 2 + 1);
		//  107  214:aload_0         
		//  108  215:getfield        #27  <Field WebDialog this$0>
		//  109  218:iload_2         
		//  110  219:iconst_2        
		//  111  220:idiv            
		//  112  221:iconst_1        
		//  113  222:iadd            
		//  114  223:invokestatic    #253 <Method void WebDialog.access$1000(WebDialog, int)>
				return;
		//  115  226:return          
			}
		}
...
/*
		...
		//    0    0:aload_0         
		//    1    1:getfield        #39  <Field Exception[] exceptions>
		//    2    4:areturn         
		}
...
*/
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #27  <Field WebDialog this$0>
			super();
		//    3    5:aload_0         
		//    4    6:invokespecial   #30  <Method void AsyncTask()>
			action = s;
		//    5    9:aload_0         
		//    6   10:aload_2         
		//    7   11:putfield        #32  <Field String action>
			parameters = bundle;
		//    8   14:aload_0         
		//    9   15:aload_3         
		//   10   16:putfield        #34  <Field Bundle parameters>
		//   11   19:return          
		}
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokestatic    #67  <Method int getWebDialogTheme()>
	//    4    6:invokespecial   #70  <Method void WebDialog(Context, String, int)>
	//    5    9:return          
	}
	...
	//*   3    4:ifne            12
			j = getWebDialogTheme();
	//    4    7:invokestatic    #67  <Method int getWebDialogTheme()>
	//    5   10:istore          4
		super(context, j);
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:iload           4
	//    9   16:invokespecial   #73  <Method void Dialog(Context, int)>
		expectedRedirectUrl = "fbconnect://success";
	//   10   19:aload_0         
	//   11   20:ldc1            #75  <String "fbconnect://success">
	//   12   22:putfield        #77  <Field String expectedRedirectUrl>
		listenerCalled = false;
	//   13   25:aload_0         
	//   14   26:iconst_0        
	//   15   27:putfield        #79  <Field boolean listenerCalled>
		isDetached = false;
	//   16   30:aload_0         
	//   17   31:iconst_0        
	//   18   32:putfield        #81  <Field boolean isDetached>
		isPageFinished = false;
	//   19   35:aload_0         
	//   20   36:iconst_0        
	//   21   37:putfield        #83  <Field boolean isPageFinished>
		url = s;
	//   22   40:aload_0         
	//   23   41:aload_2         
	//   24   42:putfield        #85  <Field String url>
	//   25   45:return          
	}
	...
	//*   3    6:ifne            14
			j = getWebDialogTheme();
	//    4    9:invokestatic    #67  <Method int getWebDialogTheme()>
	//    5   12:istore          6
		super(context, j);
	//    6   14:aload_0         
	//    7   15:aload_1         
	//    8   16:iload           6
	//    9   18:invokespecial   #73  <Method void Dialog(Context, int)>
		expectedRedirectUrl = "fbconnect://success";
	//   10   21:aload_0         
	//   11   22:ldc1            #75  <String "fbconnect://success">
	//   12   24:putfield        #77  <Field String expectedRedirectUrl>
		listenerCalled = false;
	//   13   27:aload_0         
	//   14   28:iconst_0        
	//   15   29:putfield        #79  <Field boolean listenerCalled>
		isDetached = false;
	//   16   32:aload_0         
	//   17   33:iconst_0        
	//   18   34:putfield        #81  <Field boolean isDetached>
		isPageFinished = false;
	//   19   37:aload_0         
	//   20   38:iconst_0        
	//   21   39:putfield        #83  <Field boolean isPageFinished>
	...
	//*  25   46:ifnonnull       58
			bundle1 = new Bundle();
	//   26   49:new             #88  <Class Bundle>
	//   27   52:dup             
	//   28   53:invokespecial   #90  <Method void Bundle()>
	//   29   56:astore          7
		if(Utility.isChromeOS(context))
	//*  30   58:aload_1         
	//*  31   59:invokestatic    #96  <Method boolean Utility.isChromeOS(Context)>
	//*  32   62:ifeq            71
			context = "fbconnect://chrome_os_success";
	//   33   65:ldc1            #98  <String "fbconnect://chrome_os_success">
	//   34   67:astore_1        
		else
	//*  35   68:goto            74
			context = "fbconnect://success";
	//   36   71:ldc1            #75  <String "fbconnect://success">
	//   37   73:astore_1        
		expectedRedirectUrl = ((String) (context));
	//   38   74:aload_0         
	//   39   75:aload_1         
	//   40   76:putfield        #77  <Field String expectedRedirectUrl>
		bundle1.putString("redirect_uri", expectedRedirectUrl);
	//   41   79:aload           7
	//   42   81:ldc1            #100 <String "redirect_uri">
	//   43   83:aload_0         
	//   44   84:getfield        #77  <Field String expectedRedirectUrl>
	//   45   87:invokevirtual   #104 <Method void Bundle.putString(String, String)>
		bundle1.putString("display", "touch");
	//   46   90:aload           7
	//   47   92:ldc1            #106 <String "display">
	//   48   94:ldc1            #108 <String "touch">
	//   49   96:invokevirtual   #104 <Method void Bundle.putString(String, String)>
		bundle1.putString("client_id", FacebookSdk.getApplicationId());
	//   50   99:aload           7
	//   51  101:ldc1            #110 <String "client_id">
	//   52  103:invokestatic    #116 <Method String FacebookSdk.getApplicationId()>
	//   53  106:invokevirtual   #104 <Method void Bundle.putString(String, String)>
		bundle1.putString("sdk", String.format(Locale.ROOT, "android-%s", new Object[] {
			FacebookSdk.getSdkVersion()
		}));
	//   54  109:aload           7
	//   55  111:ldc1            #118 <String "sdk">
	//   56  113:getstatic       #124 <Field Locale Locale.ROOT>
	//   57  116:ldc1            #126 <String "android-%s">
	//   58  118:iconst_1        
	//   59  119:anewarray       Object[]
	//   60  122:dup             
	//   61  123:iconst_0        
	//   62  124:invokestatic    #131 <Method String FacebookSdk.getSdkVersion()>
	//   63  127:aastore         
	//   64  128:invokestatic    #137 <Method String String.format(Locale, String, Object[])>
	//   65  131:invokevirtual   #104 <Method void Bundle.putString(String, String)>
		onCompleteListener = oncompletelistener;
	//   66  134:aload_0         
	//   67  135:aload           5
	//   68  137:putfield        #139 <Field WebDialog$OnCompleteListener onCompleteListener>
		if(s.equals("share") && bundle1.containsKey("media"))
	//*  69  140:aload_2         
	//*  70  141:ldc1            #141 <String "share">
	//*  71  143:invokevirtual   #145 <Method boolean String.equals(Object)>
	//*  72  146:ifeq            175
	//*  73  149:aload           7
	//*  74  151:ldc1            #147 <String "media">
	//*  75  153:invokevirtual   #151 <Method boolean Bundle.containsKey(String)>
	//*  76  156:ifeq            175
		{
	...
	//   81  165:aload_2         
	//   82  166:aload           7
	//   83  168:invokespecial   #154 <Method void WebDialog$UploadStagingResourcesTask(WebDialog, String, Bundle)>
	//   84  171:putfield        #156 <Field WebDialog$UploadStagingResourcesTask uploadTask>
			return;
	//   85  174:return          
		} else
		{
			context = ((Context) (ServerProtocol.getDialogAuthority()));
	//   86  175:invokestatic    #161 <Method String ServerProtocol.getDialogAuthority()>
	//   87  178:astore_1        
			bundle = ((Bundle) (new StringBuilder()));
	//   88  179:new             #163 <Class StringBuilder>
	//   89  182:dup             
	//   90  183:invokespecial   #164 <Method void StringBuilder()>
	//   91  186:astore_3        
			((StringBuilder) (bundle)).append(FacebookSdk.getGraphApiVersion());
	//   92  187:aload_3         
	//   93  188:invokestatic    #167 <Method String FacebookSdk.getGraphApiVersion()>
	//   94  191:invokevirtual   #171 <Method StringBuilder StringBuilder.append(String)>
	//   95  194:pop             
			((StringBuilder) (bundle)).append("/");
	//   96  195:aload_3         
	//   97  196:ldc1            #173 <String "/">
	//   98  198:invokevirtual   #171 <Method StringBuilder StringBuilder.append(String)>
	//   99  201:pop             
			((StringBuilder) (bundle)).append("dialog/");
	//  100  202:aload_3         
	//  101  203:ldc1            #175 <String "dialog/">
	//  102  205:invokevirtual   #171 <Method StringBuilder StringBuilder.append(String)>
	//  103  208:pop             
			((StringBuilder) (bundle)).append(s);
	//  104  209:aload_3         
	//  105  210:aload_2         
	//  106  211:invokevirtual   #171 <Method StringBuilder StringBuilder.append(String)>
	//  107  214:pop             
			url = Utility.buildUri(((String) (context)), ((StringBuilder) (bundle)).toString(), bundle1).toString();
	//  108  215:aload_0         
	//  109  216:aload_1         
	//  110  217:aload_3         
	//  111  218:invokevirtual   #178 <Method String StringBuilder.toString()>
	//  112  221:aload           7
	//  113  223:invokestatic    #182 <Method Uri Utility.buildUri(String, String, Bundle)>
	//  114  226:invokevirtual   #185 <Method String Uri.toString()>
	//  115  229:putfield        #85  <Field String url>
			return;
	//  116  232:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #218 <Class ImageView>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:invokevirtual   #222 <Method Context getContext()>
	//    5    9:invokespecial   #225 <Method void ImageView(Context)>
	//    6   12:putfield        #211 <Field ImageView crossImageView>
		Object obj = ((Object) (crossImageView));
	//    7   15:aload_0         
	//    8   16:getfield        #211 <Field ImageView crossImageView>
	//    9   19:astore_1        
...
;
	//   10   20:new             #8   <Class WebDialog$2>
	//   11   23:dup             
	//   12   24:aload_0         
	//   13   25:invokespecial   #228 <Method void WebDialog$2(WebDialog)>
	//   14   28:astore_2        
		if(!(obj instanceof View))
	//*  15   29:aload_1         
	//*  16   30:instanceof      #230 <Class View>
	//*  17   33:ifne            44
			((ImageView) (obj)).setOnClickListener(onclicklistener);
	//   18   36:aload_1         
	//   19   37:aload_2         
	//   20   38:invokevirtual   #234 <Method void ImageView.setOnClickListener(android.view.View$OnClickListener)>
		else
	//*  21   41:goto            52
			ViewInstrumentation.setOnClickListener((View)obj, onclicklistener);
	//   22   44:aload_1         
	//   23   45:checkcast       #230 <Class View>
	//   24   48:aload_2         
	//   25   49:invokestatic    #239 <Method void ViewInstrumentation.setOnClickListener(View, android.view.View$OnClickListener)>
		obj = ((Object) (getContext().getResources().getDrawable(com.facebook.common.R.drawable.com_facebook_close)));
	//   26   52:aload_0         
	//   27   53:invokevirtual   #222 <Method Context getContext()>
	//   28   56:invokevirtual   #245 <Method Resources Context.getResources()>
	//   29   59:getstatic       #250 <Field int com.facebook.common.R$drawable.com_facebook_close>
	//   30   62:invokevirtual   #256 <Method Drawable Resources.getDrawable(int)>
	//   31   65:astore_1        
		crossImageView.setImageDrawable(((Drawable) (obj)));
	//   32   66:aload_0         
	//   33   67:getfield        #211 <Field ImageView crossImageView>
	//   34   70:aload_1         
	//   35   71:invokevirtual   #260 <Method void ImageView.setImageDrawable(Drawable)>
		crossImageView.setVisibility(4);
	//   36   74:aload_0         
	//   37   75:getfield        #211 <Field ImageView crossImageView>
	//   38   78:iconst_4        
	//   39   79:invokevirtual   #263 <Method void ImageView.setVisibility(int)>
	//   40   82:return          
	}
	...
	//    0    0:invokestatic    #272 <Method void Validate.sdkInitialized()>
		return webDialogTheme;
	//    1    3:getstatic       #274 <Field int webDialogTheme>
	//    2    6:ireturn         
	}
	...
	//    3    5:aload_0         
	//    4    6:invokevirtual   #281 <Method PackageManager Context.getPackageManager()>
	//    5    9:aload_0         
	//    6   10:invokevirtual   #284 <Method String Context.getPackageName()>
	//    7   13:sipush          128
	//    8   16:invokevirtual   #290 <Method ApplicationInfo PackageManager.getApplicationInfo(String, int)>
	//    9   19:astore_0        
		}
	//*  10   20:aload_0         
	//*  11   21:ifnull          52
	//*  12   24:aload_0         
	//*  13   25:getfield        #296 <Field Bundle ApplicationInfo.metaData>
	//*  14   28:ifnonnull       32
	//*  15   31:return          
	//*  16   32:getstatic       #274 <Field int webDialogTheme>
	//*  17   35:ifne            51
	//*  18   38:aload_0         
	//*  19   39:getfield        #296 <Field Bundle ApplicationInfo.metaData>
	//*  20   42:ldc2            #298 <String "com.facebook.sdk.WebDialogTheme">
	//*  21   45:invokevirtual   #302 <Method int Bundle.getInt(String)>
	//*  22   48:invokestatic    #305 <Method void setWebDialogTheme(int)>
	//*  23   51:return          
	//*  24   52:return          
		// Misplaced declaration of an exception variable
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #309 <Method void initDefaultTheme(Context)>
	...
	//    7   11:iload_3         
	//    8   12:aload           4
	//    9   14:invokespecial   #311 <Method void WebDialog(Context, String, Bundle, int, WebDialog$OnCompleteListener)>
	//   10   17:areturn         
	}
	...
	//    0    0:new             #316 <Class LinearLayout>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokevirtual   #222 <Method Context getContext()>
	//    4    8:invokespecial   #317 <Method void LinearLayout(Context)>
	//    5   11:astore_2        
	...
	//    9   17:aload_0         
	//   10   18:aload_0         
	//   11   19:invokevirtual   #222 <Method Context getContext()>
	//   12   22:invokespecial   #320 <Method void WebDialog$3(WebDialog, Context)>
	//   13   25:putfield        #207 <Field WebView webView>
		webView.setVerticalScrollBarEnabled(false);
	//   14   28:aload_0         
	//   15   29:getfield        #207 <Field WebView webView>
	//   16   32:iconst_0        
	//   17   33:invokevirtual   #326 <Method void WebView.setVerticalScrollBarEnabled(boolean)>
		webView.setHorizontalScrollBarEnabled(false);
	//   18   36:aload_0         
	//   19   37:getfield        #207 <Field WebView webView>
	//   20   40:iconst_0        
	//   21   41:invokevirtual   #329 <Method void WebView.setHorizontalScrollBarEnabled(boolean)>
		webView.setWebViewClient(((WebViewClient) (new DialogWebViewClient())));
	//   22   44:aload_0         
	//   23   45:getfield        #207 <Field WebView webView>
	//   24   48:new             #17  <Class WebDialog$DialogWebViewClient>
	//   25   51:dup             
	//   26   52:aload_0         
	//   27   53:aconst_null     
	//   28   54:invokespecial   #332 <Method void WebDialog$DialogWebViewClient(WebDialog, WebDialog$1)>
	//   29   57:invokevirtual   #336 <Method void WebView.setWebViewClient(WebViewClient)>
		webView.getSettings().setJavaScriptEnabled(true);
	//   30   60:aload_0         
	//   31   61:getfield        #207 <Field WebView webView>
	//   32   64:invokevirtual   #340 <Method WebSettings WebView.getSettings()>
	//   33   67:iconst_1        
	//   34   68:invokevirtual   #345 <Method void WebSettings.setJavaScriptEnabled(boolean)>
		webView.loadUrl(url);
	//   35   71:aload_0         
	//   36   72:getfield        #207 <Field WebView webView>
	//   37   75:aload_0         
	//   38   76:getfield        #85  <Field String url>
	//   39   79:invokevirtual   #349 <Method void WebView.loadUrl(String)>
		webView.setLayoutParams(((android.view.ViewGroup.LayoutParams) (new android.widget.FrameLayout.LayoutParams(-1, -1))));
	//   40   82:aload_0         
	//   41   83:getfield        #207 <Field WebView webView>
	//   42   86:new             #351 <Class android.widget.FrameLayout$LayoutParams>
	//   43   89:dup             
	//   44   90:iconst_m1       
	//   45   91:iconst_m1       
	//   46   92:invokespecial   #354 <Method void android.widget.FrameLayout$LayoutParams(int, int)>
	//   47   95:invokevirtual   #358 <Method void WebView.setLayoutParams(android.view.ViewGroup$LayoutParams)>
		webView.setVisibility(4);
	//   48   98:aload_0         
	//   49   99:getfield        #207 <Field WebView webView>
	//   50  102:iconst_4        
	//   51  103:invokevirtual   #359 <Method void WebView.setVisibility(int)>
		webView.getSettings().setSavePassword(false);
	//   52  106:aload_0         
	//   53  107:getfield        #207 <Field WebView webView>
	//   54  110:invokevirtual   #340 <Method WebSettings WebView.getSettings()>
	//   55  113:iconst_0        
	//   56  114:invokevirtual   #362 <Method void WebSettings.setSavePassword(boolean)>
		webView.getSettings().setSaveFormData(false);
	//   57  117:aload_0         
	//   58  118:getfield        #207 <Field WebView webView>
	//   59  121:invokevirtual   #340 <Method WebSettings WebView.getSettings()>
	//   60  124:iconst_0        
	//   61  125:invokevirtual   #365 <Method void WebSettings.setSaveFormData(boolean)>
		webView.setFocusable(true);
	//   62  128:aload_0         
	//   63  129:getfield        #207 <Field WebView webView>
	//   64  132:iconst_1        
	//   65  133:invokevirtual   #368 <Method void WebView.setFocusable(boolean)>
		webView.setFocusableInTouchMode(true);
	//   66  136:aload_0         
	//   67  137:getfield        #207 <Field WebView webView>
	//   68  140:iconst_1        
	//   69  141:invokevirtual   #371 <Method void WebView.setFocusableInTouchMode(boolean)>
		WebView webview = webView;
	//   70  144:aload_0         
	//   71  145:getfield        #207 <Field WebView webView>
	//   72  148:astore_3        
...
;
	//   73  149:new             #12  <Class WebDialog$4>
	//   74  152:dup             
	//   75  153:aload_0         
	//   76  154:invokespecial   #372 <Method void WebDialog$4(WebDialog)>
	//   77  157:astore          4
		if(!(webview instanceof View))
	//*  78  159:aload_3         
	//*  79  160:instanceof      #230 <Class View>
	//*  80  163:ifne            175
			webview.setOnTouchListener(ontouchlistener);
	//   81  166:aload_3         
	//   82  167:aload           4
	//   83  169:invokevirtual   #376 <Method void WebView.setOnTouchListener(android.view.View$OnTouchListener)>
		else
	//*  84  172:goto            184
			ViewInstrumentation.setOnTouchListener((View)webview, ontouchlistener);
	//   85  175:aload_3         
	//   86  176:checkcast       #230 <Class View>
	//   87  179:aload           4
	//   88  181:invokestatic    #379 <Method void ViewInstrumentation.setOnTouchListener(View, android.view.View$OnTouchListener)>
	...
	//   92  187:iload_1         
	//   93  188:iload_1         
	//   94  189:invokevirtual   #383 <Method void LinearLayout.setPadding(int, int, int, int)>
		linearlayout.addView(((View) (webView)));
	//   95  192:aload_2         
	//   96  193:aload_0         
	//   97  194:getfield        #207 <Field WebView webView>
	//   98  197:invokevirtual   #387 <Method void LinearLayout.addView(View)>
		linearlayout.setBackgroundColor(0xcc000000);
	//   99  200:aload_2         
	//  100  201:ldc2            #388 <Int 0xcc000000>
	//  101  204:invokevirtual   #391 <Method void LinearLayout.setBackgroundColor(int)>
		contentFrameLayout.addView(((View) (linearlayout)));
	//  102  207:aload_0         
	//  103  208:getfield        #203 <Field FrameLayout contentFrameLayout>
	//  104  211:aload_2         
	//  105  212:invokevirtual   #394 <Method void FrameLayout.addView(View)>
	//  106  215:return          
	}
	...
	//*   2    4:goto            11
			i = DEFAULT_THEME;
	//    3    7:getstatic       #60  <Field int DEFAULT_THEME>
	//    4   10:istore_0        
		webDialogTheme = i;
	//    5   11:iload_0         
	//    6   12:putstatic       #274 <Field int webDialogTheme>
	//    7   15:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #139 <Field WebDialog$OnCompleteListener onCompleteListener>
	//*   2    4:ifnull          25
	//*   3    7:aload_0         
	//*   4    8:getfield        #79  <Field boolean listenerCalled>
	//*   5   11:ifne            25
			sendErrorToListener(((Throwable) (new FacebookOperationCanceledException())));
	//    6   14:aload_0         
	//    7   15:new             #398 <Class FacebookOperationCanceledException>
	//    8   18:dup             
	//    9   19:invokespecial   #399 <Method void FacebookOperationCanceledException()>
	//   10   22:invokevirtual   #403 <Method void sendErrorToListener(Throwable)>
	//   11   25:return          
	}
	...
	public void dismiss()
	{
		WebView webview = webView;
	//    0    0:aload_0         
	//    1    1:getfield        #207 <Field WebView webView>
	//    2    4:astore_1        
		if(webview != null)
	//*   3    5:aload_1         
	//*   4    6:ifnull          13
			webview.stopLoading();
	//    5    9:aload_1         
	//    6   10:invokevirtual   #407 <Method void WebView.stopLoading()>
		if(!isDetached)
	//*   7   13:aload_0         
	//*   8   14:getfield        #81  <Field boolean isDetached>
	//*   9   17:ifne            43
		{
			ProgressDialog progressdialog = spinner;
	//   10   20:aload_0         
	//   11   21:getfield        #199 <Field ProgressDialog spinner>
	//   12   24:astore_1        
			if(progressdialog != null && progressdialog.isShowing())
	//*  13   25:aload_1         
	//*  14   26:ifnull          43
	//*  15   29:aload_1         
	//*  16   30:invokevirtual   #413 <Method boolean ProgressDialog.isShowing()>
	//*  17   33:ifeq            43
				spinner.dismiss();
	//   18   36:aload_0         
	//   19   37:getfield        #199 <Field ProgressDialog spinner>
	//   20   40:invokevirtual   #415 <Method void ProgressDialog.dismiss()>
		}
		super.dismiss();
	//   21   43:aload_0         
	//   22   44:invokespecial   #416 <Method void Dialog.dismiss()>
	//   23   47:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #79  <Field boolean listenerCalled>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #83  <Field boolean isPageFinished>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_0        
	//    2    2:putfield        #81  <Field boolean isDetached>
		if(Utility.mustFixWindowParamsForAutofill(getContext()))
	//*   3    5:aload_0         
	//*   4    6:invokevirtual   #222 <Method Context getContext()>
	//*   5    9:invokestatic    #423 <Method boolean Utility.mustFixWindowParamsForAutofill(Context)>
	//*   6   12:ifeq            89
		{
			android.view.WindowManager.LayoutParams layoutparams = windowParams;
	//    7   15:aload_0         
	//    8   16:getfield        #425 <Field android.view.WindowManager$LayoutParams windowParams>
	//    9   19:astore_1        
			if(layoutparams != null && layoutparams.token == null)
	//*  10   20:aload_1         
	//*  11   21:ifnull          89
	//*  12   24:aload_1         
	//*  13   25:getfield        #431 <Field android.os.IBinder android.view.WindowManager$LayoutParams.token>
	//*  14   28:ifnonnull       89
			{
				windowParams.token = getOwnerActivity().getWindow().getAttributes().token;
	//   15   31:aload_0         
	//   16   32:getfield        #425 <Field android.view.WindowManager$LayoutParams windowParams>
	//   17   35:aload_0         
	//   18   36:invokevirtual   #435 <Method Activity getOwnerActivity()>
	//   19   39:invokevirtual   #441 <Method Window Activity.getWindow()>
	//   20   42:invokevirtual   #447 <Method android.view.WindowManager$LayoutParams Window.getAttributes()>
	//   21   45:getfield        #431 <Field android.os.IBinder android.view.WindowManager$LayoutParams.token>
	//   22   48:putfield        #431 <Field android.os.IBinder android.view.WindowManager$LayoutParams.token>
				StringBuilder stringbuilder = new StringBuilder();
	//   23   51:new             #163 <Class StringBuilder>
	//   24   54:dup             
	//   25   55:invokespecial   #164 <Method void StringBuilder()>
	//   26   58:astore_1        
				stringbuilder.append("Set token on onAttachedToWindow(): ");
	//   27   59:aload_1         
	//   28   60:ldc2            #449 <String "Set token on onAttachedToWindow(): ">
	//   29   63:invokevirtual   #171 <Method StringBuilder StringBuilder.append(String)>
	//   30   66:pop             
				stringbuilder.append(((Object) (windowParams.token)));
	//   31   67:aload_1         
	//   32   68:aload_0         
	//   33   69:getfield        #425 <Field android.view.WindowManager$LayoutParams windowParams>
	//   34   72:getfield        #431 <Field android.os.IBinder android.view.WindowManager$LayoutParams.token>
	//   35   75:invokevirtual   #452 <Method StringBuilder StringBuilder.append(Object)>
	//   36   78:pop             
				Utility.logd("FacebookSDK.WebDialog", stringbuilder.toString());
	//   37   79:ldc2            #454 <String "FacebookSDK.WebDialog">
	//   38   82:aload_1         
	//   39   83:invokevirtual   #178 <Method String StringBuilder.toString()>
	//   40   86:invokestatic    #457 <Method void Utility.logd(String, String)>
			}
		}
		super.onAttachedToWindow();
	//   41   89:aload_0         
	//   42   90:invokespecial   #459 <Method void Dialog.onAttachedToWindow()>
	//   43   93:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #463 <Method void Dialog.onCreate(Bundle)>
		spinner = new ProgressDialog(getContext());
	//    3    5:aload_0         
	//    4    6:new             #409 <Class ProgressDialog>
	//    5    9:dup             
	//    6   10:aload_0         
	//    7   11:invokevirtual   #222 <Method Context getContext()>
	//    8   14:invokespecial   #464 <Method void ProgressDialog(Context)>
	//    9   17:putfield        #199 <Field ProgressDialog spinner>
		spinner.requestWindowFeature(1);
	//   10   20:aload_0         
	//   11   21:getfield        #199 <Field ProgressDialog spinner>
	//   12   24:iconst_1        
	//   13   25:invokevirtual   #468 <Method boolean ProgressDialog.requestWindowFeature(int)>
	//   14   28:pop             
		spinner.setMessage(((CharSequence) (getContext().getString(com.facebook.common.R.string.com_facebook_loading))));
	//   15   29:aload_0         
	//   16   30:getfield        #199 <Field ProgressDialog spinner>
	//   17   33:aload_0         
	//   18   34:invokevirtual   #222 <Method Context getContext()>
	//   19   37:getstatic       #473 <Field int com.facebook.common.R$string.com_facebook_loading>
	//   20   40:invokevirtual   #477 <Method String Context.getString(int)>
	//   21   43:invokevirtual   #481 <Method void ProgressDialog.setMessage(CharSequence)>
		spinner.setCanceledOnTouchOutside(false);
	//   22   46:aload_0         
	//   23   47:getfield        #199 <Field ProgressDialog spinner>
	//   24   50:iconst_0        
	//   25   51:invokevirtual   #484 <Method void ProgressDialog.setCanceledOnTouchOutside(boolean)>
	...
	//   26   54:aload_0         
	//   27   55:getfield        #199 <Field ProgressDialog spinner>
	//   28   58:new             #6   <Class WebDialog$1>
	//   29   61:dup             
	//   30   62:aload_0         
	//   31   63:invokespecial   #485 <Method void WebDialog$1(WebDialog)>
	//   32   66:invokevirtual   #489 <Method void ProgressDialog.setOnCancelListener(android.content.DialogInterface$OnCancelListener)>
		requestWindowFeature(1);
	//   33   69:aload_0         
	//   34   70:iconst_1        
	//   35   71:invokevirtual   #490 <Method boolean requestWindowFeature(int)>
	//   36   74:pop             
		contentFrameLayout = new FrameLayout(getContext());
	//   37   75:aload_0         
	//   38   76:new             #393 <Class FrameLayout>
	//   39   79:dup             
	//   40   80:aload_0         
	//   41   81:invokevirtual   #222 <Method Context getContext()>
	//   42   84:invokespecial   #491 <Method void FrameLayout(Context)>
	//   43   87:putfield        #203 <Field FrameLayout contentFrameLayout>
		resize();
	//   44   90:aload_0         
	//   45   91:invokevirtual   #494 <Method void resize()>
		getWindow().setGravity(17);
	//   46   94:aload_0         
	//   47   95:invokevirtual   #495 <Method Window getWindow()>
	//   48   98:bipush          17
	//   49  100:invokevirtual   #498 <Method void Window.setGravity(int)>
		getWindow().setSoftInputMode(16);
	//   50  103:aload_0         
	//   51  104:invokevirtual   #495 <Method Window getWindow()>
	//   52  107:bipush          16
	//   53  109:invokevirtual   #501 <Method void Window.setSoftInputMode(int)>
		createCrossImage();
	//   54  112:aload_0         
	//   55  113:invokespecial   #503 <Method void createCrossImage()>
		if(url != null)
	//*  56  116:aload_0         
	//*  57  117:getfield        #85  <Field String url>
	//*  58  120:ifnull          141
			setUpWebView(crossImageView.getDrawable().getIntrinsicWidth() / 2 + 1);
	//   59  123:aload_0         
	//   60  124:aload_0         
	//   61  125:getfield        #211 <Field ImageView crossImageView>
	//   62  128:invokevirtual   #506 <Method Drawable ImageView.getDrawable()>
	//   63  131:invokevirtual   #511 <Method int Drawable.getIntrinsicWidth()>
	//   64  134:iconst_2        
	//   65  135:idiv            
	//   66  136:iconst_1        
	//   67  137:iadd            
	//   68  138:invokespecial   #193 <Method void setUpWebView(int)>
		contentFrameLayout.addView(((View) (crossImageView)), new android.view.ViewGroup.LayoutParams(-2, -2));
	//   69  141:aload_0         
	//   70  142:getfield        #203 <Field FrameLayout contentFrameLayout>
	//   71  145:aload_0         
	//   72  146:getfield        #211 <Field ImageView crossImageView>
	//   73  149:new             #513 <Class android.view.ViewGroup$LayoutParams>
	//   74  152:dup             
	//   75  153:bipush          -2
	//   76  155:bipush          -2
	//   77  157:invokespecial   #514 <Method void android.view.ViewGroup$LayoutParams(int, int)>
	//   78  160:invokevirtual   #517 <Method void FrameLayout.addView(View, android.view.ViewGroup$LayoutParams)>
		setContentView(((View) (contentFrameLayout)));
	//   79  163:aload_0         
	//   80  164:aload_0         
	//   81  165:getfield        #203 <Field FrameLayout contentFrameLayout>
	//   82  168:invokevirtual   #520 <Method void setContentView(View)>
	//   83  171:return          
	}
	...
	//    3    5:aload_0         
	//    4    6:invokespecial   #523 <Method void Dialog.onDetachedFromWindow()>
	//    5    9:return          
	}
	...
	//*   2    2:icmpne          9
			cancel();
	//    3    5:aload_0         
	//    4    6:invokevirtual   #527 <Method void cancel()>
		return super.onKeyDown(i, keyevent);
	//    5    9:aload_0         
	//    6   10:iload_1         
	//    7   11:aload_2         
	//    8   12:invokespecial   #529 <Method boolean Dialog.onKeyDown(int, KeyEvent)>
	//    9   15:ireturn         
	}
	...
	protected void onStart()
	{
		super.onStart();
	//    0    0:aload_0         
	//    1    1:invokespecial   #532 <Method void Dialog.onStart()>
		UploadStagingResourcesTask uploadstagingresourcestask = uploadTask;
	//    2    4:aload_0         
	//    3    5:getfield        #156 <Field WebDialog$UploadStagingResourcesTask uploadTask>
	//    4    8:astore_1        
		if(uploadstagingresourcestask != null && uploadstagingresourcestask.getStatus() == android.os.AsyncTask.Status.PENDING)
	//*   5    9:aload_1         
	//*   6   10:ifnull          66
	//*   7   13:aload_1         
	//*   8   14:invokevirtual   #536 <Method android.os.AsyncTask$Status WebDialog$UploadStagingResourcesTask.getStatus()>
	//*   9   17:getstatic       #542 <Field android.os.AsyncTask$Status android.os.AsyncTask$Status.PENDING>
	//*  10   20:if_acmpne       66
		{
			UploadStagingResourcesTask uploadstagingresourcestask1 = uploadTask;
	//   11   23:aload_0         
	//   12   24:getfield        #156 <Field WebDialog$UploadStagingResourcesTask uploadTask>
	//   13   27:astore_1        
			Void avoid[] = new Void[0];
	//   14   28:iconst_0        
	//   15   29:anewarray       Void[]
	//   16   32:astore_2        
			if(!(uploadstagingresourcestask1 instanceof AsyncTask))
	//*  17   33:aload_1         
	//*  18   34:instanceof      #546 <Class AsyncTask>
	//*  19   37:ifne            49
				uploadstagingresourcestask1.execute(((Object []) (avoid)));
	//   20   40:aload_1         
	//   21   41:aload_2         
	//   22   42:invokevirtual   #550 <Method AsyncTask WebDialog$UploadStagingResourcesTask.execute(Object[])>
	//   23   45:pop             
			else
	//*  24   46:goto            58
				AsyncTaskInstrumentation.execute((AsyncTask)uploadstagingresourcestask1, ((Object []) (avoid)));
	//   25   49:aload_1         
	//   26   50:checkcast       #546 <Class AsyncTask>
	//   27   53:aload_2         
	//   28   54:invokestatic    #555 <Method AsyncTask AsyncTaskInstrumentation.execute(AsyncTask, Object[])>
	//   29   57:pop             
			spinner.show();
	//   30   58:aload_0         
	//   31   59:getfield        #199 <Field ProgressDialog spinner>
	//   32   62:invokevirtual   #558 <Method void ProgressDialog.show()>
			return;
	//   33   65:return          
		} else
		{
			resize();
	//   34   66:aload_0         
	//   35   67:invokevirtual   #494 <Method void resize()>
			return;
	//   36   70:return          
		}
	}
	...
	protected void onStop()
	{
		UploadStagingResourcesTask uploadstagingresourcestask = uploadTask;
	//    0    0:aload_0         
	//    1    1:getfield        #156 <Field WebDialog$UploadStagingResourcesTask uploadTask>
	//    2    4:astore_1        
	...
	//    8   14:pop             
			spinner.dismiss();
	//    9   15:aload_0         
	//   10   16:getfield        #199 <Field ProgressDialog spinner>
	//   11   19:invokevirtual   #415 <Method void ProgressDialog.dismiss()>
		}
		super.onStop();
	//   12   22:aload_0         
	...
	//*   0    0:aload_1         
	//*   1    1:getfield        #431 <Field android.os.IBinder android.view.WindowManager$LayoutParams.token>
	//*   2    4:ifnonnull       12
			windowParams = layoutparams;
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #425 <Field android.view.WindowManager$LayoutParams windowParams>
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #222 <Method Context getContext()>
	...
	//   60  140:aload_0         
	//   61  141:invokevirtual   #495 <Method Window getWindow()>
	//   62  144:iload_1         
	//   63  145:iload_2         
	...
	//    6   14:aload_0         
	//    7   15:iconst_1        
	//    8   16:putfield        #79  <Field boolean listenerCalled>
	...
	//   21   43:aload_0         
	//   22   44:getfield        #139 <Field WebDialog$OnCompleteListener onCompleteListener>
	//   23   47:aconst_null     
	//   24   48:aload_1         
	...
	//*   4    6:ifnull          33
	//*   5    9:aload_0         
	//*   6   10:getfield        #79  <Field boolean listenerCalled>
	//*   7   13:ifne            33
		{
			listenerCalled = true;
	//    8   16:aload_0         
	//    9   17:iconst_1        
	//   10   18:putfield        #79  <Field boolean listenerCalled>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #77  <Field String expectedRedirectUrl>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #139 <Field WebDialog$OnCompleteListener onCompleteListener>
	//    3    5:return          
	}
	...
	//    0    0:getstatic       #58  <Field int com.facebook.common.R$style.com_facebook_activity_theme>
	//    1    3:putstatic       #60  <Field int DEFAULT_THEME>
	//*   2    6:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field String expectedRedirectUrl>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #193 <Method void setUpWebView(int)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #81  <Field boolean isDetached>
	//    2    4:ireturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #199 <Field ProgressDialog spinner>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #203 <Field FrameLayout contentFrameLayout>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #211 <Field ImageView crossImageView>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #83  <Field boolean isPageFinished>
		return flag;
	//    3    5:iload_1         
	//    4    6:ireturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #85  <Field String url>
		return s;
	//    3    5:aload_1         
	//    4    6:areturn         
	}
