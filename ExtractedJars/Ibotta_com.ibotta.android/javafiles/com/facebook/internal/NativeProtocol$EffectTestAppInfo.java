...
private static class NativeProtocol$EffectTestAppInfo extends NativeProtocol.NativeAppInfo
{
	...
	NativeProtocol$EffectTestAppInfo(NativeProtocol._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #15  <Method void NativeProtocol$EffectTestAppInfo()>
	//    2    4:return          
	}
}
