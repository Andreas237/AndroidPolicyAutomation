...
public class WorkQueue
{
		...
		implements WorkItem
	{
		...
		public boolean isRunning()
		{
			return isRunning;
		//    0    0:aload_0         
		//    1    1:getfield        #61  <Field boolean isRunning>
		//    2    4:ireturn         
		}
		...
		//   24   48:iconst_1        
		//   25   49:invokevirtual   #64  <Method WorkQueue$WorkNode addToList(WorkQueue$WorkNode, boolean)>
		...
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:putfield        #61  <Field boolean isRunning>
		//    3    5:return          
		}
	...
	//    0    0:aload_0         
	//    1    1:bipush          8
	//    2    3:invokespecial   #32  <Method void WorkQueue(int)>
	//    3    6:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokestatic    #38  <Method Executor FacebookSdk.getExecutor()>
	//    3    5:invokespecial   #41  <Method void WorkQueue(int, Executor)>
	//    4    8:return          
	}
	...
	//    6   12:putfield        #45  <Field Object workLock>
		runningJobs = null;
	//    7   15:aload_0         
	//    8   16:aconst_null     
	//    9   17:putfield        #47  <Field WorkQueue$WorkNode runningJobs>
		runningCount = 0;
	//   10   20:aload_0         
	//   11   21:iconst_0        
	//   12   22:putfield        #49  <Field int runningCount>
		maxConcurrent = i;
	//   13   25:aload_0         
	//   14   26:iload_1         
	//   15   27:putfield        #51  <Field int maxConcurrent>
		executor = executor1;
	//   16   30:aload_0         
	//   17   31:aload_2         
	//   18   32:putfield        #53  <Field Executor executor>
	//   19   35:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #53  <Field Executor executor>
	//    2    4:new             #6   <Class WorkQueue$1>
	//    3    7:dup             
	//    4    8:aload_0         
	//    5    9:aload_1         
	//    6   10:invokespecial   #70  <Method void WorkQueue$1(WorkQueue, WorkQueue$WorkNode)>
	//    7   13:invokeinterface #75  <Method void Executor.execute(Runnable)>
	//    8   18:return          
	}
	...
	private void finishItemAndStartNew(WorkNode worknode)
	{
		Object obj = workLock;
	//    0    0:aload_0         
	//    1    1:getfield        #45  <Field Object workLock>
	//    2    4:astore_3        
		obj;
	//    3    5:aload_3         
		JVM INSTR monitorenter ;
	...
	//    8   12:aload_1         
	//    9   13:aload_0         
	//   10   14:getfield        #47  <Field WorkQueue$WorkNode runningJobs>
	//   11   17:invokevirtual   #79  <Method WorkQueue$WorkNode WorkQueue$WorkNode.removeFromList(WorkQueue$WorkNode)>
	//   12   20:putfield        #47  <Field WorkQueue$WorkNode runningJobs>
		runningCount = runningCount - 1;
	//   13   23:aload_0         
	//   14   24:aload_0         
	//   15   25:getfield        #49  <Field int runningCount>
	//   16   28:iconst_1        
	//   17   29:isub            
	//   18   30:putfield        #49  <Field int runningCount>
		if(runningCount >= maxConcurrent) goto _L2; else goto _L1
	//   19   33:aload_0         
	//   20   34:getfield        #49  <Field int runningCount>
	//   21   37:aload_0         
	//   22   38:getfield        #51  <Field int maxConcurrent>
	//   23   41:icmpge          117
_L1:
		WorkNode worknode1 = pendingJobs;
	//   24   44:aload_0         
	//   25   45:getfield        #65  <Field WorkQueue$WorkNode pendingJobs>
	//   26   48:astore_2        
		worknode = worknode1;
	//   27   49:aload_2         
	//   28   50:astore_1        
	...
	//   32   56:aload_2         
	//   33   57:aload_0         
	//   34   58:getfield        #65  <Field WorkQueue$WorkNode pendingJobs>
	//   35   61:invokevirtual   #79  <Method WorkQueue$WorkNode WorkQueue$WorkNode.removeFromList(WorkQueue$WorkNode)>
	//   36   64:putfield        #65  <Field WorkQueue$WorkNode pendingJobs>
		runningJobs = worknode1.addToList(runningJobs, false);
	//   37   67:aload_0         
	//   38   68:aload_2         
	//   39   69:aload_0         
	//   40   70:getfield        #47  <Field WorkQueue$WorkNode runningJobs>
	//   41   73:iconst_0        
	//   42   74:invokevirtual   #83  <Method WorkQueue$WorkNode WorkQueue$WorkNode.addToList(WorkQueue$WorkNode, boolean)>
	//   43   77:putfield        #47  <Field WorkQueue$WorkNode runningJobs>
		runningCount = runningCount + 1;
	//   44   80:aload_0         
	//   45   81:aload_0         
	//   46   82:getfield        #49  <Field int runningCount>
	//   47   85:iconst_1        
	//   48   86:iadd            
	//   49   87:putfield        #49  <Field int runningCount>
		worknode1.setIsRunning(true);
	//   50   90:aload_2         
	//   51   91:iconst_1        
	//   52   92:invokevirtual   #87  <Method void WorkQueue$WorkNode.setIsRunning(boolean)>
		worknode = worknode1;
	//   53   95:aload_2         
	//   54   96:astore_1        
	//*  55   97:goto            100
_L4:
	...
	//   60  106:aload_0         
	//   61  107:aload_1         
	//   62  108:invokespecial   #89  <Method void execute(WorkQueue$WorkNode)>
		return;
	//   63  111:return          
		worknode;
	//   64  112:astore_1        
...
_L3:
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:invokespecial   #59  <Method void finishItemAndStartNew(WorkQueue$WorkNode)>
	//    3    5:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iconst_1        
	//    3    3:invokevirtual   #95  <Method WorkQueue$WorkItem addActiveWorkItem(Runnable, boolean)>
	//    4    6:areturn         
	}
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokespecial   #98  <Method void WorkQueue$WorkNode(WorkQueue, Runnable)>
	//    5    9:astore_3        
		synchronized(workLock)
	//*   6   10:aload_0         
	//*   7   11:getfield        #45  <Field Object workLock>
	//*   8   14:astore_1        
	//*   9   15:aload_1         
	//*  10   16:monitorenter    
		{
	...
	//   12   18:aload_3         
	//   13   19:aload_0         
	//   14   20:getfield        #65  <Field WorkQueue$WorkNode pendingJobs>
	//   15   23:iload_2         
	//   16   24:invokevirtual   #83  <Method WorkQueue$WorkNode WorkQueue$WorkNode.addToList(WorkQueue$WorkNode, boolean)>
	//   17   27:putfield        #65  <Field WorkQueue$WorkNode pendingJobs>
		}
	//   18   30:aload_1         
	//   19   31:monitorexit     
		startItem();
	//   20   32:aload_0         
	//   21   33:invokespecial   #100 <Method void startItem()>
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #65  <Field WorkQueue$WorkNode pendingJobs>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #65  <Field WorkQueue$WorkNode pendingJobs>
		return worknode;
	//    3    5:aload_1         
	//    4    6:areturn         
	}
