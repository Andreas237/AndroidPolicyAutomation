...
public class LockOnGetVariable
{
	...
	//    2    4:aload_0         
	//    3    5:new             #19  <Class CountDownLatch>
	//    4    8:dup             
	//    5    9:iconst_1        
	//    6   10:invokespecial   #22  <Method void CountDownLatch(int)>
	//    7   13:putfield        #24  <Field CountDownLatch initLatch>
	...
	//    8   16:invokestatic    #30  <Method Executor FacebookSdk.getExecutor()>
	//    9   19:new             #32  <Class FutureTask>
	//   10   22:dup             
	//   11   23:new             #7   <Class LockOnGetVariable$1>
	//   12   26:dup             
	//   13   27:aload_0         
	//   14   28:aload_1         
	//   15   29:invokespecial   #35  <Method void LockOnGetVariable$1(LockOnGetVariable, Callable)>
	//   16   32:invokespecial   #37  <Method void FutureTask(Callable)>
	//   17   35:invokeinterface #43  <Method void Executor.execute(Runnable)>
	//   18   40:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field CountDownLatch initLatch>
	//    2    4:astore_1        
	...
	//    6   10:aload_1         
	//    7   11:invokevirtual   #58  <Method void CountDownLatch.await()>
			return;
	//    8   14:return          
		}
	...
	public Object getValue()
	{
		waitOnInit();
	//    0    0:aload_0         
	//    1    1:invokespecial   #62  <Method void waitOnInit()>
		return value;
	//    2    4:aload_0         
	//    3    5:getfield        #50  <Field Object value>
	//    4    8:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #50  <Field Object value>
		return obj;
	//    3    5:aload_1         
	//    4    6:areturn         
	}
