...
private class ShareDialog$CameraEffectHandler extends com.facebook.internal.FacebookDialogBase.ModeHandler
{

	public boolean canShow(ShareContent sharecontent, boolean flag)
	{
		return (sharecontent instanceof ShareCameraEffectContent) && ShareDialog.access$400(((Object) (sharecontent)).getClass());
	//    0    0:aload_1         
	...
	//    5   11:astore_2        
		DialogPresenter.setupAppCallForNativeDialog(appCall, new com.facebook.internal.DialogPresenter.ParameterProvider() {
			...
			final ShareDialog.CameraEffectHandler this$1;
			...
			{
				this$1 = ShareDialog.CameraEffectHandler.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
...
, ShareDialog.access$700(((Object) (content)).getClass()));
	...
	//   18   34:invokestatic    #65  <Method com.facebook.internal.DialogFeature ShareDialog.access$700(Class)>
	...
	ShareDialog$CameraEffectHandler(ShareDialog._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #23  <Method void ShareDialog$CameraEffectHandler(ShareDialog)>
	//    3    5:return          
	}
}
