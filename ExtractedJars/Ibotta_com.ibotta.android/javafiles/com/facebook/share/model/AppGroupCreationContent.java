	...
	implements ShareModel
{
	...
	//    5    9:putfield        #37  <Field String name>
		description = parcel.readString();
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:invokevirtual   #35  <Method String Parcel.readString()>
	//    9   17:putfield        #39  <Field String description>
		privacy = (AppGroupPrivacy)parcel.readSerializable();
	//   10   20:aload_0         
	//   11   21:aload_1         
	//   12   22:invokevirtual   #43  <Method java.io.Serializable Parcel.readSerializable()>
	//   13   25:checkcast       #10  <Class AppGroupCreationContent$AppGroupPrivacy>
	//   14   28:putfield        #45  <Field AppGroupCreationContent$AppGroupPrivacy privacy>
	//   15   31:return          
	}
	...
	//    0    0:aload_1         
	//    1    1:aload_0         
	//    2    2:getfield        #37  <Field String name>
	//    3    5:invokevirtual   #53  <Method void Parcel.writeString(String)>
		parcel.writeString(description);
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:getfield        #39  <Field String description>
	//    7   13:invokevirtual   #53  <Method void Parcel.writeString(String)>
		parcel.writeSerializable(((java.io.Serializable) (privacy)));
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #45  <Field AppGroupCreationContent$AppGroupPrivacy privacy>
	//   11   21:invokevirtual   #57  <Method void Parcel.writeSerializable(java.io.Serializable)>
	//   12   24:return          
	}
...
;
	...
	//    1    3:dup             
	//    2    4:invokespecial   #24  <Method void AppGroupCreationContent$1()>
