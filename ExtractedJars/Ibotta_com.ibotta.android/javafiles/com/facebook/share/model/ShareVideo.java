...
public final class ShareVideo extends ShareMedia
{
	public static final class Builder extends ShareMedia.Builder
	{
		...
		//    4    6:aload_0         
		//    5    7:aload_1         
		//    6    8:invokespecial   #48  <Method ShareMedia$Builder ShareMedia$Builder.readFrom(ShareMedia)>
		//    7   11:checkcast       #2   <Class ShareVideo$Builder>
		//    8   14:aload_1         
		//    9   15:invokevirtual   #52  <Method Uri ShareVideo.getLocalUrl()>
		//   10   18:invokevirtual   #56  <Method ShareVideo$Builder setLocalUrl(Uri)>
		//   11   21:areturn         
		}
...
*/
	...
	//    0    0:getstatic       #66  <Field ShareMedia$Type ShareMedia$Type.VIDEO>
	//    1    3:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #70  <Method void ShareMedia.writeToParcel(Parcel, int)>
		parcel.writeParcelable(((android.os.Parcelable) (localUrl)), 0);
	//    4    6:aload_1         
	//    5    7:aload_0         
	//    6    8:getfield        #41  <Field Uri localUrl>
	//    7   11:iconst_0        
	//    8   12:invokevirtual   #74  <Method void Parcel.writeParcelable(android.os.Parcelable, int)>
	//    9   15:return          
	}
