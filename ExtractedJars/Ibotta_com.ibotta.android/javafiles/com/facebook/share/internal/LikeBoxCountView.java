...
public class LikeBoxCountView extends FrameLayout
{
	...
	{
		Path path = new Path();
	//    0    0:new             #27  <Class Path>
	//    1    3:dup             
	//    2    4:invokespecial   #31  <Method void Path()>
	//    3    7:astore          10
		float f5 = borderRadius * 2.0F;
	//    4    9:aload_0         
	//    5   10:getfield        #33  <Field float borderRadius>
	//    6   13:fconst_2        
	//    7   14:fmul            
	//    8   15:fstore          7
		float f4 = f + f5;
	...
	//   17   29:aload           10
	//   18   31:new             #35  <Class RectF>
	//   19   34:dup             
	//   20   35:fload_2         
	//   21   36:fload_3         
	//   22   37:fload           6
	//   23   39:fload           9
	//   24   41:invokespecial   #38  <Method void RectF(float, float, float, float)>
	//   25   44:ldc1            #39  <Float -180F>
	//   26   46:ldc1            #40  <Float 90F>
	//   27   48:invokevirtual   #44  <Method void Path.addArc(RectF, float, float)>
		if(caretPosition == LikeBoxCountViewCaretPosition.TOP)
	//*  28   51:aload_0         
	//*  29   52:getfield        #46  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition caretPosition>
	//*  30   55:getstatic       #49  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition LikeBoxCountView$LikeBoxCountViewCaretPosition.TOP>
	//*  31   58:if_acmpne       118
		{
			float f6 = f2 - f;
	//   32   61:fload           4
	...
	//   37   69:fload           8
	//   38   71:aload_0         
	//   39   72:getfield        #51  <Field float caretWidth>
	//   40   75:fsub            
	//   41   76:fconst_2        
	//   42   77:fdiv            
	//   43   78:fload_2         
	//   44   79:fadd            
	//   45   80:fload_3         
	//   46   81:invokevirtual   #55  <Method void Path.lineTo(float, float)>
	...
	//   53   92:fload_3         
	//   54   93:aload_0         
	//   55   94:getfield        #57  <Field float caretHeight>
	//   56   97:fsub            
	//   57   98:invokevirtual   #55  <Method void Path.lineTo(float, float)>
			path.lineTo((f6 + caretWidth) / 2.0F + f, f1);
	//   58  101:aload           10
	//   59  103:fload           8
	//   60  105:aload_0         
	//   61  106:getfield        #51  <Field float caretWidth>
	//   62  109:fadd            
	//   63  110:fconst_2        
	//   64  111:fdiv            
	//   65  112:fload_2         
	//   66  113:fadd            
	//   67  114:fload_3         
	//   68  115:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		}
		path.lineTo(f2 - borderRadius, f1);
	//   69  118:aload           10
	//   70  120:fload           4
	//   71  122:aload_0         
	//   72  123:getfield        #33  <Field float borderRadius>
	//   73  126:fsub            
	//   74  127:fload_3         
	//   75  128:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		float f7 = f2 - f5;
	//   76  131:fload           4
	//   77  133:fload           7
	//   78  135:fsub            
	...
	//   80  138:aload           10
	//   81  140:new             #35  <Class RectF>
	//   82  143:dup             
	//   83  144:fload           8
	//   84  146:fload_3         
	//   85  147:fload           4
	//   86  149:fload           9
	//   87  151:invokespecial   #38  <Method void RectF(float, float, float, float)>
	//   88  154:ldc1            #58  <Float -90F>
	//   89  156:ldc1            #40  <Float 90F>
	//   90  158:invokevirtual   #44  <Method void Path.addArc(RectF, float, float)>
		if(caretPosition == LikeBoxCountViewCaretPosition.RIGHT)
	//*  91  161:aload_0         
	//*  92  162:getfield        #46  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition caretPosition>
	//*  93  165:getstatic       #61  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition LikeBoxCountView$LikeBoxCountViewCaretPosition.RIGHT>
	...
	//  101  181:fload           9
	//  102  183:aload_0         
	//  103  184:getfield        #51  <Field float caretWidth>
	//  104  187:fsub            
	//  105  188:fconst_2        
	//  106  189:fdiv            
	//  107  190:fload_3         
	//  108  191:fadd            
	//  109  192:invokevirtual   #55  <Method void Path.lineTo(float, float)>
			path.lineTo(caretHeight + f2, f9 / 2.0F + f1);
	//  110  195:aload           10
	//  111  197:aload_0         
	//  112  198:getfield        #57  <Field float caretHeight>
	//  113  201:fload           4
	//  114  203:fadd            
	//  115  204:fload           9
	//  116  206:fconst_2        
	...
	//  118  208:fload_3         
	//  119  209:fadd            
	//  120  210:invokevirtual   #55  <Method void Path.lineTo(float, float)>
			path.lineTo(f2, (f9 + caretWidth) / 2.0F + f1);
	//  121  213:aload           10
	//  122  215:fload           4
	//  123  217:fload           9
	//  124  219:aload_0         
	//  125  220:getfield        #51  <Field float caretWidth>
	//  126  223:fadd            
	//  127  224:fconst_2        
	//  128  225:fdiv            
	//  129  226:fload_3         
	//  130  227:fadd            
	//  131  228:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		}
	...
	//  134  235:fload           5
	//  135  237:aload_0         
	//  136  238:getfield        #33  <Field float borderRadius>
	//  137  241:fsub            
	//  138  242:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		f5 = f3 - f5;
	//  139  245:fload           5
	//  140  247:fload           7
	//  141  249:fsub            
	...
	//  143  252:aload           10
	//  144  254:new             #35  <Class RectF>
	//  145  257:dup             
	//  146  258:fload           8
	//  147  260:fload           7
	//  148  262:fload           4
	//  149  264:fload           5
	//  150  266:invokespecial   #38  <Method void RectF(float, float, float, float)>
	//  151  269:fconst_0        
	//  152  270:ldc1            #40  <Float 90F>
	//  153  272:invokevirtual   #44  <Method void Path.addArc(RectF, float, float)>
		if(caretPosition == LikeBoxCountViewCaretPosition.BOTTOM)
	//* 154  275:aload_0         
	//* 155  276:getfield        #46  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition caretPosition>
	//* 156  279:getstatic       #64  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition LikeBoxCountView$LikeBoxCountViewCaretPosition.BOTTOM>
	...
	//  162  291:aload           10
	//  163  293:aload_0         
	//  164  294:getfield        #51  <Field float caretWidth>
	//  165  297:fload           4
	//  166  299:fadd            
	//  167  300:fconst_2        
	//  168  301:fdiv            
	...
	//  170  303:fadd            
	//  171  304:fload           5
	//  172  306:invokevirtual   #55  <Method void Path.lineTo(float, float)>
	...
	//  178  316:fadd            
	//  179  317:aload_0         
	//  180  318:getfield        #57  <Field float caretHeight>
	//  181  321:fload           5
	//  182  323:fadd            
	//  183  324:invokevirtual   #55  <Method void Path.lineTo(float, float)>
			path.lineTo((f2 - caretWidth) / 2.0F + f, f3);
	//  184  327:aload           10
	//  185  329:fload           4
	//  186  331:aload_0         
	//  187  332:getfield        #51  <Field float caretWidth>
	//  188  335:fsub            
	//  189  336:fconst_2        
	//  190  337:fdiv            
	//  191  338:fload_2         
	//  192  339:fadd            
	//  193  340:fload           5
	//  194  342:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		}
		path.lineTo(borderRadius + f, f3);
	//  195  345:aload           10
	//  196  347:aload_0         
	//  197  348:getfield        #33  <Field float borderRadius>
	//  198  351:fload_2         
	//  199  352:fadd            
	//  200  353:fload           5
	//  201  355:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		path.addArc(new RectF(f, f5, f4, f3), 90F, 90F);
	//  202  358:aload           10
	//  203  360:new             #35  <Class RectF>
	//  204  363:dup             
	//  205  364:fload_2         
	//  206  365:fload           7
	//  207  367:fload           6
	//  208  369:fload           5
	//  209  371:invokespecial   #38  <Method void RectF(float, float, float, float)>
	//  210  374:ldc1            #40  <Float 90F>
	//  211  376:ldc1            #40  <Float 90F>
	//  212  378:invokevirtual   #44  <Method void Path.addArc(RectF, float, float)>
		if(caretPosition == LikeBoxCountViewCaretPosition.LEFT)
	//* 213  381:aload_0         
	//* 214  382:getfield        #46  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition caretPosition>
	//* 215  385:getstatic       #67  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition LikeBoxCountView$LikeBoxCountViewCaretPosition.LEFT>
	...
	//  222  399:fload_2         
	//  223  400:aload_0         
	//  224  401:getfield        #51  <Field float caretWidth>
	//  225  404:fload           4
	//  226  406:fadd            
	//  227  407:fconst_2        
	//  228  408:fdiv            
	//  229  409:fload_3         
	//  230  410:fadd            
	//  231  411:invokevirtual   #55  <Method void Path.lineTo(float, float)>
			path.lineTo(f - caretHeight, f2 / 2.0F + f1);
	//  232  414:aload           10
	//  233  416:fload_2         
	//  234  417:aload_0         
	//  235  418:getfield        #57  <Field float caretHeight>
	//  236  421:fsub            
	//  237  422:fload           4
	//  238  424:fconst_2        
	//  239  425:fdiv            
	//  240  426:fload_3         
	//  241  427:fadd            
	//  242  428:invokevirtual   #55  <Method void Path.lineTo(float, float)>
			path.lineTo(f, (f2 - caretWidth) / 2.0F + f1);
	//  243  431:aload           10
	//  244  433:fload_2         
	//  245  434:fload           4
	//  246  436:aload_0         
	//  247  437:getfield        #51  <Field float caretWidth>
	//  248  440:fsub            
	//  249  441:fconst_2        
	//  250  442:fdiv            
	//  251  443:fload_3         
	//  252  444:fadd            
	//  253  445:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		}
	...
	//  256  451:fload_3         
	//  257  452:aload_0         
	//  258  453:getfield        #33  <Field float borderRadius>
	//  259  456:fadd            
	//  260  457:invokevirtual   #55  <Method void Path.lineTo(float, float)>
		canvas.drawPath(path, borderPaint);
	//  261  460:aload_1         
	//  262  461:aload           10
	//  263  463:aload_0         
	//  264  464:getfield        #69  <Field Paint borderPaint>
	//  265  467:invokevirtual   #75  <Method void Canvas.drawPath(Path, Paint)>
	//  266  470:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #80  <Field TextView likeCountLabel>
	//    2    4:astore          6
		int i1 = textPadding;
	//    3    6:aload_0         
	//    4    7:getfield        #82  <Field int textPadding>
	//    5   10:istore          5
	...
	//   17   28:iload           4
	//   18   30:iadd            
	//   19   31:invokevirtual   #87  <Method void TextView.setPadding(int, int, int, int)>
	//   20   34:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #91  <Method void FrameLayout.onDraw(Canvas)>
		int i = getPaddingTop();
	//    3    5:aload_0         
	//    4    6:invokevirtual   #95  <Method int getPaddingTop()>
	//    5    9:istore_2        
		int j = getPaddingLeft();
	//    6   10:aload_0         
	//    7   11:invokevirtual   #98  <Method int getPaddingLeft()>
	//    8   14:istore_3        
		int k = getWidth() - getPaddingRight();
	//    9   15:aload_0         
	//   10   16:invokevirtual   #101 <Method int getWidth()>
	//   11   19:aload_0         
	//   12   20:invokevirtual   #104 <Method int getPaddingRight()>
	//   13   23:isub            
	//   14   24:istore          4
		int l = getHeight() - getPaddingBottom();
	//   15   26:aload_0         
	//   16   27:invokevirtual   #107 <Method int getHeight()>
	//   17   30:aload_0         
	//   18   31:invokevirtual   #110 <Method int getPaddingBottom()>
	//   19   34:isub            
	//   20   35:istore          5
		static class _cls1
		{
	...
	//*  21   37:getstatic       #114 <Field int[] LikeBoxCountView$1.$SwitchMap$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition>
	//*  22   40:aload_0         
	//*  23   41:getfield        #46  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition caretPosition>
	//*  24   44:invokevirtual   #117 <Method int LikeBoxCountView$LikeBoxCountViewCaretPosition.ordinal()>
	//*  25   47:iaload          
		{
	...
	//   29   85:i2f             
	//   30   86:aload_0         
	//   31   87:getfield        #57  <Field float caretHeight>
	//   32   90:fsub            
	//   33   91:f2i             
	//   34   92:istore          5
			break;
	...
	//   37   99:i2f             
	//   38  100:aload_0         
	//   39  101:getfield        #57  <Field float caretHeight>
	//   40  104:fsub            
	//   41  105:f2i             
	//   42  106:istore          4
			break;
	...
	//   45  112:i2f             
	//   46  113:aload_0         
	//   47  114:getfield        #57  <Field float caretHeight>
	//   48  117:fadd            
	//   49  118:f2i             
	//   50  119:istore_2        
			break;
	...
	//   53  124:i2f             
	//   54  125:aload_0         
	//   55  126:getfield        #57  <Field float caretHeight>
	//   56  129:fadd            
	//   57  130:f2i             
	//   58  131:istore_3        
			break;
	...
	//   67  141:iload           5
	//   68  143:i2f             
	//   69  144:invokespecial   #119 <Method void drawBorder(Canvas, float, float, float, float)>
	//   70  147:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #46  <Field LikeBoxCountView$LikeBoxCountViewCaretPosition caretPosition>
	...
	//*   3    5:getstatic       #114 <Field int[] LikeBoxCountView$1.$SwitchMap$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition>
	//*   4    8:aload_1         
	//*   5    9:invokevirtual   #117 <Method int LikeBoxCountView$LikeBoxCountViewCaretPosition.ordinal()>
	//*   6   12:iaload          
		{
	...
	//   12   48:iconst_0        
	//   13   49:aload_0         
	//   14   50:getfield        #123 <Field int additionalTextPadding>
	//   15   53:invokespecial   #125 <Method void setAdditionalTextPadding(int, int, int, int)>
			return;
	//   16   56:return          
	...
	//   19   59:iconst_0        
	//   20   60:aload_0         
	//   21   61:getfield        #123 <Field int additionalTextPadding>
	//   22   64:iconst_0        
	//   23   65:invokespecial   #125 <Method void setAdditionalTextPadding(int, int, int, int)>
			return;
	//   24   68:return          
	...
	//   26   70:iconst_0        
	//   27   71:aload_0         
	//   28   72:getfield        #123 <Field int additionalTextPadding>
	//   29   75:iconst_0        
	//   30   76:iconst_0        
	//   31   77:invokespecial   #125 <Method void setAdditionalTextPadding(int, int, int, int)>
			return;
	//   32   80:return          
	...
	//   33   81:aload_0         
	//   34   82:aload_0         
	//   35   83:getfield        #123 <Field int additionalTextPadding>
	//   36   86:iconst_0        
	//   37   87:iconst_0        
	//   38   88:iconst_0        
	//   39   89:invokespecial   #125 <Method void setAdditionalTextPadding(int, int, int, int)>
			return;
	//   40   92:return          
		}
	}
	...
	//    1    1:getfield        #80  <Field TextView likeCountLabel>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #131 <Method void TextView.setText(CharSequence)>
	//    4    8:return          
	}
