	...
	implements questCompletionCallback
{
	...
	//   22   47:astore_1        
			final blishLikeRequestWrapper likeRequest = ((blishLikeRequestWrapper) (LikeActionController.this));
	//   23   48:aload_0         
	//   24   49:getfield        #21  <Field LikeActionController this$0>
	//   25   52:astore_2        
			likeRequest = new blishLikeRequestWrapper(((LikeActionController) (likeRequest)), LikeActionController.access$1600(((LikeActionController) (likeRequest))), LikeActionController.access$1700(LikeActionController.this));
