	...
	implements questCompletionCallback
{
	...
	public void onComplete()
	{
		...
		if(..SwitchMap.com.facebook.share.widget.LikeView.ObjectType[LikeActionController.access$1700(LikeActionController.this).ordinal()] != 1)
	...
	//   10   22:astore_1        
			likeRequestWrapper = ((Object) (new tOGObjectLikesRequestWrapper(((LikeActionController) (likeRequestWrapper)), LikeActionController.access$1600(((LikeActionController) (likeRequestWrapper))), LikeActionController.access$1700(LikeActionController.this))));
	...
	//   24   50:astore_1        
			likeRequestWrapper = ((Object) (new tPageLikesRequestWrapper(((LikeActionController) (likeRequestWrapper)), LikeActionController.access$1600(((LikeActionController) (likeRequestWrapper))))));
	...
	//   31   63:astore_1        
		...
		final tEngagementRequestWrapper engagementRequest = ((tEngagementRequestWrapper) (LikeActionController.this));
	//   32   64:aload_0         
	//   33   65:getfield        #19  <Field LikeActionController this$0>
	//   34   68:astore_2        
		engagementRequest = new tEngagementRequestWrapper(((LikeActionController) (engagementRequest)), LikeActionController.access$1600(((LikeActionController) (engagementRequest))), LikeActionController.access$1700(LikeActionController.this));
	...
	//   48   96:astore_3        
		((keRequestWrapper) (likeRequestWrapper)).addToBatch(graphrequestbatch);
	//   49   97:aload_1         
	//   50   98:aload_3         
	//   51   99:invokeinterface #65  <Method void LikeActionController$LikeRequestWrapper.addToBatch(GraphRequestBatch)>
		engagementRequest.addToBatch(graphrequestbatch);
	//   52  104:aload_2         
	//   53  105:aload_3         
	//   54  106:invokevirtual   #66  <Method void LikeActionController$GetEngagementRequestWrapper.addToBatch(GraphRequestBatch)>
		graphrequestbatch.addCallback(new com.facebook.GraphRequestBatch.Callback() {
			...
			//*   8   22:goto            82
				{
					LikeActionController.access$1300(this$0, likeRequestWrapper.isObjectLiked(), engagementRequest.likeCountStringWithLike, engagementRequest.likeCountStringWithoutLike, engagementRequest.socialSentenceStringWithLike, engagementRequest.socialSentenceStringWithoutLike, likeRequestWrapper.getUnlikeToken());
			//    9   25:aload_0         
			...
			{
				this$1 = LikeActionController._cls9.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
