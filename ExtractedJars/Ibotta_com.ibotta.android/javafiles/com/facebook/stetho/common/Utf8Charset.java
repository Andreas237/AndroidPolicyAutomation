...
public class Utf8Charset
{
	...
	public static String decodeUTF8(byte abyte0[])
	{
		return new String(abyte0, INSTANCE);
	//    0    0:new             #28  <Class String>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getstatic       #20  <Field Charset INSTANCE>
	//    4    8:invokespecial   #31  <Method void String(byte[], Charset)>
	//    5   11:areturn         
	}
	...
	//    2    3:invokevirtual   #38  <Method byte[] String.getBytes(String)>
	//    3    6:astore_0        
		}
	//*   4    7:aload_0         
	//*   5    8:areturn         
	...
	//    7   10:new             #40  <Class RuntimeException>
	//    8   13:dup             
	//    9   14:aload_0         
	//   10   15:invokespecial   #43  <Method void RuntimeException(Throwable)>
	//   11   18:athrow          
		}
		return ((byte []) (s));
	}
