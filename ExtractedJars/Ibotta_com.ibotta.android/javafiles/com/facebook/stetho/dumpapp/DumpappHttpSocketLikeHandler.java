...
//			Dumper, Framer, DumpappSocketLikeHandler
	...
	implements SocketLikeHandler
{
	...
	//    2    4:new             #19  <Class HandlerRegistry>
	//    3    7:dup             
	//    4    8:invokespecial   #20  <Method void HandlerRegistry()>
	//    5   11:astore_2        
		handlerregistry.register(((com.facebook.stetho.server.http.PathMatcher) (new ExactPathMatcher("/dumpapp"))), ((HttpHandler) (new DumpappLegacyHttpHandler(dumper))));
	//    6   12:aload_2         
	//    7   13:new             #22  <Class ExactPathMatcher>
	//    8   16:dup             
	//    9   17:ldc1            #24  <String "/dumpapp">
	//   10   19:invokespecial   #27  <Method void ExactPathMatcher(String)>
	//   11   22:new             #8   <Class DumpappHttpSocketLikeHandler$DumpappLegacyHttpHandler>
	//   12   25:dup             
	//   13   26:aload_1         
	//   14   27:invokespecial   #29  <Method void DumpappHttpSocketLikeHandler$DumpappLegacyHttpHandler(Dumper)>
	//   15   30:invokevirtual   #33  <Method void HandlerRegistry.register(com.facebook.stetho.server.http.PathMatcher, HttpHandler)>
		mServer = new LightHttpServer(handlerregistry);
	//   16   33:aload_0         
	//   17   34:new             #35  <Class LightHttpServer>
	//   18   37:dup             
	//   19   38:aload_2         
	//   20   39:invokespecial   #38  <Method void LightHttpServer(HandlerRegistry)>
	//   21   42:putfield        #40  <Field LightHttpServer mServer>
	//   22   45:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #40  <Field LightHttpServer mServer>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #48  <Method void LightHttpServer.serve(SocketLike)>
	//    4    8:return          
	}
