	...
	implements Accumulator
{
	...
	{
		if(val$docUpdate.isElementChanged(obj))
	//*   0    0:aload_0         
	...
	// Unreferenced inner class com/facebook/stetho/inspector/elements/Document$5

/* anonymous class */
	class Document._cls5
		implements Accumulator
	{
		...
		//   34   75:astore          5
			Document.ChildEventingList childeventinglist = Document.access$900(Document.this, obj, ((DocumentView) (docUpdate)));
		//   35   77:aload_0         
		...
		//   79  170:istore_2        
		//*  80  171:goto            101
			Document.access$1000(childeventinglist, ((List) (obj2)), insertedElements);
		//   81  174:aload           6
		//   82  176:aload           5
		//   83  178:aload_0         
		...
		//   85  182:invokestatic    #113 <Method void Document.access$1000(Document$ChildEventingList, List, Accumulator)>
			Document.access$1100(Document.this, childeventinglist);
		//   86  185:aload_0         
...
/*
			static HashSet access$800(Document._cls5 _pcls5)
			{
...
*/
			...
			//    2    2:putfield        #28  <Field Document this$0>
				docUpdate = ShadowDocument.Update.this;
			//    3    5:aload_0         
			//    4    6:aload_2         
			...
			//   12   22:putfield        #38  <Field HashSet listenerInsertedElements>
				insertedElements = ((Accumulator) (new Document._cls5._cls1()));
			//   13   25:aload_0         
