...
abstract class ViewHighlighter
{
	private static final class NoopHighlighter extends ViewHighlighter
	{
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #9   <Method void ViewHighlighter()>
		//    2    4:return          
		}
	...
	private static final class OverlayHighlighter extends ViewHighlighter
	{
		...
		private final Runnable mHighlightViewOnUiThreadRunnable = new _cls1();
		private View mHighlightedView;
		private AtomicReference mViewToHighlight;


/*
		static void access$100(OverlayHighlighter overlayhighlighter)
		{
...
*/
	...
	//*   2    5:icmplt          16
		{
			return ((ViewHighlighter) (new OverlayHighlighter()));
	//    3    8:new             #11  <Class ViewHighlighter$OverlayHighlighter>
	//    4   11:dup             
	//    5   12:invokespecial   #28  <Method void ViewHighlighter$OverlayHighlighter()>
	//    6   15:areturn         
		} else
		{
			LogUtil.w("Running on pre-JBMR2: View highlighting is not supported");
	//    7   16:ldc1            #30  <String "Running on pre-JBMR2: View highlighting is not supported">
	//    8   18:invokestatic    #36  <Method void LogUtil.w(String)>
			return ((ViewHighlighter) (new NoopHighlighter()));
	//    9   21:new             #8   <Class ViewHighlighter$NoopHighlighter>
	//   10   24:dup             
	//   11   25:aconst_null     
	//   12   26:invokespecial   #39  <Method void ViewHighlighter$NoopHighlighter(ViewHighlighter$1)>
	//   13   29:areturn         
		}
	}
	...
	// Unreferenced inner class com/facebook/stetho/inspector/elements/android/ViewHighlighter$OverlayHighlighter$1

/* anonymous class */
	class OverlayHighlighter._cls1
		implements Runnable
	{
		...
		final OverlayHighlighter this$0;

			
			{
				this$0 = OverlayHighlighter.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
