	...
	implements ChromeDevtoolsDomain
{
	...
	//    1    3:dup             
	//    2    4:aconst_null     
	//    3    5:invokespecial   #76  <Method void Network$GetResponseBodyResponse(Network$1)>
	//    4    8:astore_2        
		try
		{
	...
	//    7   13:aload_1         
	//    8   14:invokevirtual   #82  <Method ResponseBodyData ResponseBodyFileManager.readFile(String)>
	//    9   17:astore_1        
		}
	//*  10   18:aload_2         
	//*  11   19:aload_1         
	//*  12   20:getfield        #88  <Field String ResponseBodyData.data>
	//*  13   23:putfield        #91  <Field String Network$GetResponseBodyResponse.body>
	//*  14   26:aload_2         
	//*  15   27:aload_1         
	//*  16   28:getfield        #95  <Field boolean ResponseBodyData.base64Encoded>
	//*  17   31:putfield        #96  <Field boolean Network$GetResponseBodyResponse.base64Encoded>
	//*  18   34:aload_2         
	//*  19   35:areturn         
	...
	//*  20   36:astore_1        
		{
			throw new JsonRpcException(new JsonRpcError(com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError.ErrorCode.INTERNAL_ERROR, ((OutOfMemoryError) (s)).toString(), ((JSONObject) (null))));
	//   21   37:new             #71  <Class JsonRpcException>
	//   22   40:dup             
	//   23   41:new             #98  <Class JsonRpcError>
	//   24   44:dup             
	//   25   45:getstatic       #104 <Field com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode.INTERNAL_ERROR>
	//   26   48:aload_1         
	//   27   49:invokevirtual   #108 <Method String OutOfMemoryError.toString()>
	//   28   52:aconst_null     
	//   29   53:invokespecial   #111 <Method void JsonRpcError(com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode, String, JSONObject)>
	//   30   56:invokespecial   #114 <Method void JsonRpcException(JsonRpcError)>
	//   31   59:athrow          
		}
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #122 <Method void NetworkPeerManager.removePeer(JsonRpcPeer)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #58  <Field NetworkPeerManager mNetworkPeerManager>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #128 <Method boolean NetworkPeerManager.addPeer(JsonRpcPeer)>
	//    4    8:pop             
	//    5    9:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_2         
	//    2    2:ldc1            #134 <String "requestId">
	//    3    4:invokevirtual   #140 <Method String JSONObject.getString(String)>
	//    4    7:invokespecial   #142 <Method Network$GetResponseBodyResponse readResponseBody(String)>
	//    5   10:astore_1        
		}
	//*   6   11:aload_1         
	//*   7   12:areturn         
	//*   8   13:astore_1        
	//*   9   14:new             #71  <Class JsonRpcException>
	//*  10   17:dup             
	//*  11   18:new             #98  <Class JsonRpcError>
	//*  12   21:dup             
	//*  13   22:getstatic       #104 <Field com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode.INTERNAL_ERROR>
	//*  14   25:aload_1         
	//*  15   26:invokevirtual   #143 <Method String JSONException.toString()>
	//*  16   29:aconst_null     
	//*  17   30:invokespecial   #111 <Method void JsonRpcError(com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode, String, JSONObject)>
	//*  18   33:invokespecial   #114 <Method void JsonRpcException(JsonRpcError)>
	//*  19   36:athrow          
		// Misplaced declaration of an exception variable
	...
	//   21   38:new             #71  <Class JsonRpcException>
	//   22   41:dup             
	//   23   42:new             #98  <Class JsonRpcError>
	//   24   45:dup             
	//   25   46:getstatic       #104 <Field com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode.INTERNAL_ERROR>
	//   26   49:aload_1         
	//   27   50:invokevirtual   #144 <Method String IOException.toString()>
	//   28   53:aconst_null     
	//   29   54:invokespecial   #111 <Method void JsonRpcError(com.facebook.stetho.inspector.jsonrpc.protocol.JsonRpcError$ErrorCode, String, JSONObject)>
	//   30   57:invokespecial   #114 <Method void JsonRpcException(JsonRpcError)>
	//   31   60:athrow          
		}
		// Misplaced declaration of an exception variable
		catch(JsonRpcPeer jsonrpcpeer)
	...
	{
		Util.throwIfNull(((Object) (asyncprettyprinterinitializer)));
	//    0    0:aload_1         
	//    1    1:invokestatic    #152 <Method Object Util.throwIfNull(Object)>
	//    2    4:pop             
		mNetworkPeerManager.setPrettyPrinterInitializer(asyncprettyprinterinitializer);
	//    3    5:aload_0         
	//    4    6:getfield        #58  <Field NetworkPeerManager mNetworkPeerManager>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #154 <Method void NetworkPeerManager.setPrettyPrinterInitializer(AsyncPrettyPrinterInitializer)>
	//    7   13:return          
	}
