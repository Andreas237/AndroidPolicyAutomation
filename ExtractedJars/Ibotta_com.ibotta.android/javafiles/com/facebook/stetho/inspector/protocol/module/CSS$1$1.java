	...
	implements StyleAccumulator
{
	...
	// Unreferenced inner class com/facebook/stetho/inspector/protocol/module/CSS$1
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		public void run()
		{
			Object obj = CSS.access$200(CSS.this).getElementForNodeId(request.nodeId);
		//    0    0:aload_0         
		...
		//   27   56:return          
			...
			{
				CSS.access$200(CSS.this).getElementStyles(obj, ((StyleAccumulator) (new CSS._cls1._cls1())));
		//   28   57:aload_0         
		...
		final CSS this$0;
		final CSS.GetComputedStyleForNodeRequest val$request;
		final CSS.GetComputedStyleForNodeResult val$result;
			...
			//    5    7:putfield        #25  <Field CSS$GetComputedStyleForNodeRequest val$request>
				result = CSS.GetComputedStyleForNodeResult.this;
			//    6   10:aload_0         
			//    7   11:aload_3         
