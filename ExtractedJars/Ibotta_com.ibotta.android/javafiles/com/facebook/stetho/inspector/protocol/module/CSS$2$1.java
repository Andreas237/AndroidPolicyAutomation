	...
	implements StyleAccumulator
{
	...
	//*   1    1:ifne            50
		{
			roperty roperty = new roperty(((CSS._cls1) (null)));
	...
	//   12   23:putfield        #34  <Field String CSS$CSSProperty.value>
			val$match.rule.style.cssProperties.add(((Object) (roperty)));
	//   13   26:aload_0         
	...
	// Unreferenced inner class com/facebook/stetho/inspector/protocol/module/CSS$2
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//   27   56:return          
			...
			{
				CSS.access$200(CSS.this).getElementStyles(obj, ((StyleAccumulator) (new CSS._cls2._cls1())));
		//   28   57:aload_0         
		...
		final CSS this$0;
		final CSS.RuleMatch val$match;
		final CSS.GetMatchedStylesForNodeRequest val$request;
