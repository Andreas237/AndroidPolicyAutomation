	...
	implements ChromeDevtoolsDomain
{
	...
	public static class ScreencastFrameEventMetadata
	{
		...
		public ScreencastFrameEventMetadata()
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #21  <Method void Object()>
		//    2    4:return          
	...
	//    2    4:aload_0         
	//    3    5:new             #52  <Class ObjectMapper>
	//    4    8:dup             
	//    5    9:invokespecial   #53  <Method void ObjectMapper()>
	//    6   12:putfield        #55  <Field ObjectMapper mObjectMapper>
		mContext = context;
	//    7   15:aload_0         
	//    8   16:aload_1         
	//    9   17:putfield        #57  <Field Context mContext>
	//   10   20:return          
	}
	...
	//    1    3:dup             
	//    2    4:aconst_null     
	//    3    5:invokespecial   #63  <Method void Page$Frame(Page$1)>
	//    4    8:astore          4
		frame.id = s;
	//    5   10:aload           4
	//    6   12:aload_0         
	//    7   13:putfield        #67  <Field String Page$Frame.id>
		frame.parentId = s1;
	//    8   16:aload           4
	//    9   18:aload_1         
	//   10   19:putfield        #70  <Field String Page$Frame.parentId>
		frame.loaderId = "1";
	//   11   22:aload           4
	//   12   24:ldc1            #72  <String "1">
	//   13   26:putfield        #75  <Field String Page$Frame.loaderId>
		frame.name = s2;
	//   14   29:aload           4
	//   15   31:aload_2         
	//   16   32:putfield        #78  <Field String Page$Frame.name>
		frame.url = "";
	//   17   35:aload           4
	//   18   37:ldc1            #80  <String "">
	//   19   39:putfield        #83  <Field String Page$Frame.url>
		frame.securityOrigin = s3;
	//   20   42:aload           4
	//   21   44:aload_3         
	//   22   45:putfield        #86  <Field String Page$Frame.securityOrigin>
		frame.mimeType = "text/plain";
	//   23   48:aload           4
	//   24   50:ldc1            #88  <String "text/plain">
	//   25   52:putfield        #91  <Field String Page$Frame.mimeType>
		s = ((String) (new FrameResourceTree()));
	//   26   55:new             #19  <Class Page$FrameResourceTree>
	//   27   58:dup             
	//   28   59:aconst_null     
	//   29   60:invokespecial   #92  <Method void Page$FrameResourceTree(Page$1)>
	//   30   63:astore_0        
		s.frame = frame;
	//   31   64:aload_0         
	//   32   65:aload           4
	//   33   67:putfield        #96  <Field Page$Frame Page$FrameResourceTree.frame>
		s.resources = Collections.emptyList();
	//   34   70:aload_0         
	//   35   71:invokestatic    #102 <Method List Collections.emptyList()>
	//   36   74:putfield        #106 <Field List Page$FrameResourceTree.resources>
		s.childFrames = null;
	//   37   77:aload_0         
	//   38   78:aconst_null     
	//   39   79:putfield        #109 <Field List Page$FrameResourceTree.childFrames>
	...
	//    1    3:dup             
	//    2    4:aconst_null     
	//    3    5:invokespecial   #112 <Method void Page$ExecutionContextDescription(Page$1)>
	//    4    8:astore_2        
		executioncontextdescription.frameId = "1";
	//    5    9:aload_2         
	//    6   10:ldc1            #72  <String "1">
	//    7   12:putfield        #115 <Field String Page$ExecutionContextDescription.frameId>
		executioncontextdescription.id = 1;
	//    8   15:aload_2         
	//    9   16:iconst_1        
	//   10   17:putfield        #118 <Field int Page$ExecutionContextDescription.id>
	...
	//   12   23:dup             
	//   13   24:aconst_null     
	//   14   25:invokespecial   #119 <Method void Page$ExecutionContextCreatedParams(Page$1)>
	//   15   28:astore_3        
		executioncontextcreatedparams.context = executioncontextdescription;
	//   16   29:aload_3         
	//   17   30:aload_2         
	//   18   31:putfield        #123 <Field Page$ExecutionContextDescription Page$ExecutionContextCreatedParams.context>
	...
	//   19   34:aload_1         
	//   20   35:ldc1            #125 <String "Runtime.executionContextCreated">
	//   21   37:aload_3         
	//   22   38:aconst_null     
	//   23   39:invokevirtual   #131 <Method void JsonRpcPeer.invokeMethod(String, Object, com.facebook.stetho.inspector.jsonrpc.PendingRequestCallback)>
	//   24   42:return          
	}
	...
	//    0    0:new             #134 <Class Console$ConsoleMessage>
	//    1    3:dup             
	//    2    4:invokespecial   #135 <Method void Console$ConsoleMessage()>
	//    3    7:astore_2        
		consolemessage.source = Console.MessageSource.JAVASCRIPT;
	//    4    8:aload_2         
	//    5    9:getstatic       #141 <Field Console$MessageSource Console$MessageSource.JAVASCRIPT>
	//    6   12:putfield        #144 <Field Console$MessageSource Console$ConsoleMessage.source>
		consolemessage.level = Console.MessageLevel.LOG;
	//    7   15:aload_2         
	//    8   16:getstatic       #150 <Field Console$MessageLevel Console$MessageLevel.LOG>
	//    9   19:putfield        #153 <Field Console$MessageLevel Console$ConsoleMessage.level>
		Object obj = ((Object) (new StringBuilder()));
	//   10   22:new             #155 <Class StringBuilder>
	//   11   25:dup             
	//   12   26:invokespecial   #156 <Method void StringBuilder()>
	//   13   29:astore_3        
	...
	//   14   30:aload_3         
	//   15   31:ldc1            #158 <String "_____/\\\\\\\\\\\\\\\\\\\\\\_______________________________________________/\\\\\\_______________________\n ___/\\\\\\/////////\\\\\\____________________________________________\\/\\\\\\_______________________\n  __\\//\\\\\\______\\///______/\\\\\\_________________________/\\\\\\______\\/\\\\\\_______________________\n   ___\\////\\\\\\__________/\\\\\\\\\\\\\\\\\\\\\\_____/\\\\\\\\\\\\\\\\___/\\\\\\\\\\\\\\\\\\\\\\_\\/\\\\\\_____________/\\\\\\\\\\____\n    ______\\////\\\\\\______\\////\\\\\\////____/\\\\\\/////\\\\\\_\\////\\\\\\////__\\/\\\\\\\\\\\\\\\\\\\\____/\\\\\\///\\\\\\__\n     _________\\////\\\\\\______\\/\\\\\\_______/\\\\\\\\\\\\\\\\\\\\\\_____\\/\\\\\\______\\/\\\\\\/////\\\\\\__/\\\\\\__\\//\\\\\\_\n      __/\\\\\\______\\//\\\\\\_____\\/\\\\\\_/\\\\__\\//\\\\///////______\\/\\\\\\_/\\\\__\\/\\\\\\___\\/\\\\\\_\\//\\\\\\__/\\\\\\__\n       _\\///\\\\\\\\\\\\\\\\\\\\\\/______\\//\\\\\\\\\\____\\//\\\\\\\\\\\\\\\\\\\\____\\//\\\\\\\\\\___\\/\\\\\\___\\/\\\\\\__\\///\\\\\\\\\\/___\n        ___\\///////////_________\\/////______\\//////////______\\/////____\\///____\\///_____\\/////_____\n         Welcome to Stetho\n          Attached to ">
	//   16   33:invokevirtual   #162 <Method StringBuilder StringBuilder.append(String)>
	//   17   36:pop             
		((StringBuilder) (obj)).append(ProcessUtil.getProcessName());
	//   18   37:aload_3         
	//   19   38:invokestatic    #168 <Method String ProcessUtil.getProcessName()>
	//   20   41:invokevirtual   #162 <Method StringBuilder StringBuilder.append(String)>
	//   21   44:pop             
		((StringBuilder) (obj)).append("\n");
	//   22   45:aload_3         
	//   23   46:ldc1            #170 <String "\n">
	//   24   48:invokevirtual   #162 <Method StringBuilder StringBuilder.append(String)>
	//   25   51:pop             
		consolemessage.text = ((StringBuilder) (obj)).toString();
	//   26   52:aload_2         
	//   27   53:aload_3         
	//   28   54:invokevirtual   #173 <Method String StringBuilder.toString()>
	//   29   57:putfield        #176 <Field String Console$ConsoleMessage.text>
		obj = ((Object) (new Console.MessageAddedRequest()));
	//   30   60:new             #178 <Class Console$MessageAddedRequest>
	//   31   63:dup             
	//   32   64:invokespecial   #179 <Method void Console$MessageAddedRequest()>
	//   33   67:astore_3        
		obj.message = consolemessage;
	//   34   68:aload_3         
	//   35   69:aload_2         
	//   36   70:putfield        #183 <Field Console$ConsoleMessage Console$MessageAddedRequest.message>
		jsonrpcpeer.invokeMethod("Console.messageAdded", obj, ((com.facebook.stetho.inspector.jsonrpc.PendingRequestCallback) (null)));
	//   37   73:aload_1         
	//   38   74:ldc1            #185 <String "Console.messageAdded">
	//   39   76:aload_3         
	//   40   77:aconst_null     
	//   41   78:invokevirtual   #131 <Method void JsonRpcPeer.invokeMethod(String, Object, com.facebook.stetho.inspector.jsonrpc.PendingRequestCallback)>
	//   42   81:return          
	}
	...
	//    0    0:new             #190 <Class SimpleBooleanResult>
	//    1    3:dup             
	//    2    4:iconst_1        
	//    3    5:invokespecial   #193 <Method void SimpleBooleanResult(boolean)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #201 <Method void notifyExecutionContexts(JsonRpcPeer)>
		sendWelcomeMessage(jsonrpcpeer);
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokespecial   #203 <Method void sendWelcomeMessage(JsonRpcPeer)>
	//    6   10:return          
	}
	...
	//    2    4:invokestatic    #210 <Method List SharedPreferencesHelper.getSharedPreferenceTags(Context)>
	//    3    7:invokeinterface #216 <Method Iterator List.iterator()>
	//    4   12:astore_2        
		if(((Iterator) (jsonobject)).hasNext())
	//*   5   13:aload_2         
	//*   6   14:invokeinterface #222 <Method boolean Iterator.hasNext()>
	//*   7   19:ifeq            35
			jsonrpcpeer = ((JsonRpcPeer) ((String)((Iterator) (jsonobject)).next()));
	//    8   22:aload_2         
	//    9   23:invokeinterface #226 <Method Object Iterator.next()>
	//   10   28:checkcast       #228 <Class String>
	//   11   31:astore_1        
		else
	//*  12   32:goto            38
			jsonrpcpeer = "";
	//   13   35:ldc1            #80  <String "">
	//   14   37:astore_1        
		jsonrpcpeer = ((JsonRpcPeer) (createSimpleFrameResourceTree("1", ((String) (null)), "Stetho", ((String) (jsonrpcpeer)))));
	//   15   38:ldc1            #72  <String "1">
	//   16   40:aconst_null     
	//   17   41:ldc1            #230 <String "Stetho">
	//   18   43:aload_1         
	//   19   44:invokestatic    #232 <Method Page$FrameResourceTree createSimpleFrameResourceTree(String, String, String, String)>
	//   20   47:astore_1        
		if(((FrameResourceTree) (jsonrpcpeer)).childFrames == null)
	//*  21   48:aload_1         
	//*  22   49:getfield        #109 <Field List Page$FrameResourceTree.childFrames>
	//*  23   52:ifnonnull       66
			jsonrpcpeer.childFrames = ((List) (new ArrayList()));
	//   24   55:aload_1         
	//   25   56:new             #234 <Class ArrayList>
	//   26   59:dup             
	//   27   60:invokespecial   #235 <Method void ArrayList()>
	//   28   63:putfield        #109 <Field List Page$FrameResourceTree.childFrames>
		for(int i = 1; ((Iterator) (jsonobject)).hasNext(); i++)
	//*  29   66:iconst_1        
	//*  30   67:istore_3        
	//*  31   68:aload_2         
	//*  32   69:invokeinterface #222 <Method boolean Iterator.hasNext()>
	//*  33   74:ifeq            179
		{
			Object obj = ((Object) (new StringBuilder()));
	//   34   77:new             #155 <Class StringBuilder>
	//   35   80:dup             
	//   36   81:invokespecial   #156 <Method void StringBuilder()>
	//   37   84:astore          4
			((StringBuilder) (obj)).append("1.");
	//   38   86:aload           4
	//   39   88:ldc1            #237 <String "1.">
	//   40   90:invokevirtual   #162 <Method StringBuilder StringBuilder.append(String)>
	//   41   93:pop             
			((StringBuilder) (obj)).append(i);
	//   42   94:aload           4
	//   43   96:iload_3         
	//   44   97:invokevirtual   #240 <Method StringBuilder StringBuilder.append(int)>
	//   45  100:pop             
			obj = ((Object) (((StringBuilder) (obj)).toString()));
	//   46  101:aload           4
	//   47  103:invokevirtual   #173 <Method String StringBuilder.toString()>
	//   48  106:astore          4
			String s = (String)((Iterator) (jsonobject)).next();
	//   49  108:aload_2         
	//   50  109:invokeinterface #226 <Method Object Iterator.next()>
	//   51  114:checkcast       #228 <Class String>
	//   52  117:astore          5
			StringBuilder stringbuilder = new StringBuilder();
	//   53  119:new             #155 <Class StringBuilder>
	//   54  122:dup             
	//   55  123:invokespecial   #156 <Method void StringBuilder()>
	//   56  126:astore          6
			stringbuilder.append("Child #");
	//   57  128:aload           6
	//   58  130:ldc1            #242 <String "Child #">
	//   59  132:invokevirtual   #162 <Method StringBuilder StringBuilder.append(String)>
	//   60  135:pop             
			stringbuilder.append(((String) (obj)));
	//   61  136:aload           6
	//   62  138:aload           4
	//   63  140:invokevirtual   #162 <Method StringBuilder StringBuilder.append(String)>
	//   64  143:pop             
			obj = ((Object) (createSimpleFrameResourceTree(((String) (obj)), "1", stringbuilder.toString(), s)));
	//   65  144:aload           4
	//   66  146:ldc1            #72  <String "1">
	//   67  148:aload           6
	//   68  150:invokevirtual   #173 <Method String StringBuilder.toString()>
	//   69  153:aload           5
	//   70  155:invokestatic    #232 <Method Page$FrameResourceTree createSimpleFrameResourceTree(String, String, String, String)>
	//   71  158:astore          4
			((FrameResourceTree) (jsonrpcpeer)).childFrames.add(obj);
	//   72  160:aload_1         
	//   73  161:getfield        #109 <Field List Page$FrameResourceTree.childFrames>
	//   74  164:aload           4
	//   75  166:invokeinterface #246 <Method boolean List.add(Object)>
	//   76  171:pop             
		}
	...
	//   83  182:dup             
	//   84  183:aconst_null     
	//   85  184:invokespecial   #247 <Method void Page$GetResourceTreeParams(Page$1)>
	//   86  187:astore_2        
		jsonobject.frameTree = ((FrameResourceTree) (jsonrpcpeer));
	//   87  188:aload_2         
	//   88  189:aload_1         
	//   89  190:putfield        #251 <Field Page$FrameResourceTree Page$GetResourceTreeParams.frameTree>
	...
	{
		jsonobject = ((JSONObject) ((StartScreencastRequest)mObjectMapper.convertValue(((Object) (jsonobject)), com/facebook/stetho/inspector/protocol/module/Page$StartScreencastRequest)));
	//    0    0:aload_0         
	//    1    1:getfield        #55  <Field ObjectMapper mObjectMapper>
	//    2    4:aload_2         
	//    3    5:ldc1            #37  <Class Page$StartScreencastRequest>
	//    4    7:invokevirtual   #262 <Method Object ObjectMapper.convertValue(Object, Class)>
	//    5   10:checkcast       #37  <Class Page$StartScreencastRequest>
	//    6   13:astore_2        
		if(mScreencastDispatcher == null)
	//*   7   14:aload_0         
	//*   8   15:getfield        #264 <Field ScreencastDispatcher mScreencastDispatcher>
	//*   9   18:ifnonnull       41
		{
			mScreencastDispatcher = new ScreencastDispatcher();
	//   10   21:aload_0         
	//   11   22:new             #266 <Class ScreencastDispatcher>
	//   12   25:dup             
	//   13   26:invokespecial   #267 <Method void ScreencastDispatcher()>
	//   14   29:putfield        #264 <Field ScreencastDispatcher mScreencastDispatcher>
			mScreencastDispatcher.startScreencast(jsonrpcpeer, ((StartScreencastRequest) (jsonobject)));
	//   15   32:aload_0         
	//   16   33:getfield        #264 <Field ScreencastDispatcher mScreencastDispatcher>
	//   17   36:aload_1         
	//   18   37:aload_2         
	//   19   38:invokevirtual   #270 <Method void ScreencastDispatcher.startScreencast(JsonRpcPeer, Page$StartScreencastRequest)>
		}
	//   20   41:return          
	}
	...
	{
		jsonrpcpeer = ((JsonRpcPeer) (mScreencastDispatcher));
	//    0    0:aload_0         
	//    1    1:getfield        #264 <Field ScreencastDispatcher mScreencastDispatcher>
	//    2    4:astore_1        
		if(jsonrpcpeer != null)
	//*   3    5:aload_1         
	//*   4    6:ifnull          18
		{
			((ScreencastDispatcher) (jsonrpcpeer)).stopScreencast();
	//    5    9:aload_1         
	//    6   10:invokevirtual   #273 <Method void ScreencastDispatcher.stopScreencast()>
			mScreencastDispatcher = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #264 <Field ScreencastDispatcher mScreencastDispatcher>
		}
	//   10   18:return          
	}
