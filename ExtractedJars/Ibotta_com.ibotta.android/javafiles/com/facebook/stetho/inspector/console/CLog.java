...
// Referenced classes of package com.facebook.stetho.inspector.console:
//			ConsolePeerManager
...
public class CLog
{
	...
	public static void writeToConsole(com.facebook.stetho.inspector.protocol.module.Console.MessageLevel messagelevel, com.facebook.stetho.inspector.protocol.module.Console.MessageSource messagesource, String s)
	{
		ConsolePeerManager consolepeermanager = ConsolePeerManager.getInstanceOrNull();
	//    0    0:invokestatic    #57  <Method ConsolePeerManager ConsolePeerManager.getInstanceOrNull()>
	//    1    3:astore_3        
	...
	//    4    8:return          
		...
		{
			writeToConsole(((ChromePeerManager) (consolepeermanager)), messagelevel, messagesource, s);
	//    5    9:aload_3         
	//    6   10:aload_0         
	//    7   11:aload_1         
	//    8   12:aload_2         
	//    9   13:invokestatic    #59  <Method void writeToConsole(ChromePeerManager, com.facebook.stetho.inspector.protocol.module.Console$MessageLevel, com.facebook.stetho.inspector.protocol.module.Console$MessageSource, String)>
			return;
	//   10   16:return          
		}
	}
