...
_L1:
	...
	{
		CountingOutputStream countingoutputstream = mDecompressedCounter;
	//    0    0:aload_0         
	...
	//    5   11:aload           4
	//    6   13:invokevirtual   #131 <Method long CountingOutputStream.getCount()>
	//    7   16:lstore_2        
			int i = (int)(l - mLastDecompressedCount);
	//    8   17:lload_2         
	//    9   18:aload_0         
	//   10   19:getfield        #38  <Field long mLastDecompressedCount>
	//   11   22:lsub            
	//   12   23:l2i             
	//   13   24:istore_1        
			mResponseHandler.onReadDecoded(i);
	//   14   25:aload_0         
	//   15   26:getfield        #48  <Field ResponseHandler mResponseHandler>
	//   16   29:iload_1         
	//   17   30:invokeinterface #135 <Method void ResponseHandler.onReadDecoded(int)>
			mLastDecompressedCount = l;
	//   18   35:aload_0         
	//   19   36:lload_2         
	//   20   37:putfield        #38  <Field long mLastDecompressedCount>
		}
	//   21   40:return          
	}
