...
public static final class JsonReader$Token extends Enum
{

	public static JsonReader$Token valueOf(String s)
	{
		return (JsonReader$Token)Enum.valueOf(com/apollographql/apollo/internal/json/JsonReader$Token, s);
	...
	{
		return (JsonReader$Token[])((JsonReader$Token []) ($VALUES)).clone();
	...
	private static final JsonReader$Token $VALUES[];
	...
	static 
	{
		BEGIN_ARRAY = new JsonReader$Token("BEGIN_ARRAY", 0);
	...
	//    5   10:putstatic       #30  <Field JsonReader$Token BEGIN_ARRAY>
		END_ARRAY = new JsonReader$Token("END_ARRAY", 1);
	...
	//   11   23:putstatic       #33  <Field JsonReader$Token END_ARRAY>
		BEGIN_OBJECT = new JsonReader$Token("BEGIN_OBJECT", 2);
	...
	//   17   36:putstatic       #36  <Field JsonReader$Token BEGIN_OBJECT>
		END_OBJECT = new JsonReader$Token("END_OBJECT", 3);
	...
	//   23   49:putstatic       #39  <Field JsonReader$Token END_OBJECT>
		NAME = new JsonReader$Token("NAME", 4);
	...
	//   29   62:putstatic       #42  <Field JsonReader$Token NAME>
		STRING = new JsonReader$Token("STRING", 5);
	...
	//   35   75:putstatic       #45  <Field JsonReader$Token STRING>
		NUMBER = new JsonReader$Token("NUMBER", 6);
	...
	//   41   89:putstatic       #48  <Field JsonReader$Token NUMBER>
		BOOLEAN = new JsonReader$Token("BOOLEAN", 7);
	...
	//   47  103:putstatic       #51  <Field JsonReader$Token BOOLEAN>
		NULL = new JsonReader$Token("NULL", 8);
	...
	//   53  117:putstatic       #54  <Field JsonReader$Token NULL>
		END_DOCUMENT = new JsonReader$Token("END_DOCUMENT", 9);
	...
	private JsonReader$Token(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
