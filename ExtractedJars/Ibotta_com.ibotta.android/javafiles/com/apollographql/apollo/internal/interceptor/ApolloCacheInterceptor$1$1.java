...
class ApolloCacheInterceptor$1$1
	implements com.apollographql.apollo.interceptor.ApolloInterceptor$CallBack
{
	...
	{
		rollbackOptimisticUpdatesAndPublish(val$request);
	//    0    0:aload_0         
	...
	public void onFetch(com.apollographql.apollo.interceptor.ceType cetype)
	{
		val$callBack.onFetch(cetype);
	//    0    0:aload_0         
	//    1    1:getfield        #17  <Field ApolloCacheInterceptor$1 this$1>
	...
	public void onResponse(com.apollographql.apollo.interceptor.orResponse orresponse)
	{
		if(disposed)
	//*   0    0:aload_0         
	//*   1    1:getfield        #17  <Field ApolloCacheInterceptor$1 this$1>
	...
	//    5   13:return          
		try
		{
			Set set = cacheResponse(orresponse, val$request);
	//    6   14:aload_0         
	...
	//   14   32:astore_2        
			Set set1 = rollbackOptimisticUpdates(val$request);
	//   15   33:aload_0         
	...
	//*  49  115:return          
		...
		catch(com.apollographql.apollo.interceptor.orResponse orresponse)
	//*  50  116:astore_1        
		{
			rollbackOptimisticUpdatesAndPublish(val$request);
	//   51  117:aload_0         
	...
	// Unreferenced inner class com/apollographql/apollo/internal/interceptor/ApolloCacheInterceptor$1

/* anonymous class */
	class ApolloCacheInterceptor._cls1
		implements Runnable
	{
		...
		//   37   85:invokevirtual   #82  <Method void ApolloCacheInterceptor.writeOptimisticUpdatesAndPublish(com.apollographql.apollo.interceptor.ApolloInterceptor$InterceptorRequest)>
				chain.proceedAsync(request, dispatcher, ((com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack) (new ApolloCacheInterceptor._cls1._cls1())));
		//   38   88:aload_0         
