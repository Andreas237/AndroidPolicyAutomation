...
class ApolloServerInterceptor$1$1
	implements Callback
{
	...
	//   23   54:invokevirtual   #66  <Method void ApolloLogger.e(Throwable, String, Object[])>
			val$callBack.onFailure(((com.apollographql.apollo.exception.ApolloException) (new ApolloNetworkException("Failed to execute http call", ((Throwable) (ioexception))))));
	//   24   57:aload_0         
	...
	//    5   13:return          
		...
		{
			val$callBack.onResponse(new com.apollographql.apollo.interceptor.rResponse(response));
	//    6   14:aload_0         
	//    7   15:getfield        #17  <Field ApolloServerInterceptor$1 this$1>
	...
	// Unreferenced inner class com/apollographql/apollo/internal/interceptor/ApolloServerInterceptor$1

/* anonymous class */
	class ApolloServerInterceptor._cls1
		implements Runnable
	{
		...
		//   47  111:return          
			...
			httpCall.enqueue(((Callback) (new ApolloServerInterceptor._cls1._cls1())));
		}
