	...
	implements Transaction
{
	...
	{
		return doWrite(val$fragment, val$cacheKey, val$variables);
	//    0    0:aload_0         
	...
	// Unreferenced inner class com/apollographql/apollo/internal/cache/normalized/RealApolloStore$11

/* anonymous class */
	class RealApolloStore._cls11 extends ApolloStoreOperation
	{
		...
		{
			return (Set)writeTransaction(((Transaction) (new RealApolloStore._cls11._cls1())));
		//    0    0:aload_0         
