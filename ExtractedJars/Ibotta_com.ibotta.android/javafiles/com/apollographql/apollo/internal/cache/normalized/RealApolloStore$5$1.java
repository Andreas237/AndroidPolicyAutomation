...
class RealApolloStore$5$1
	implements Transaction
{

	public Integer execute(WriteableStore writeablestore)
	{
		writeablestore = ((WriteableStore) (val$cacheKeys.iterator()));
	//    0    0:aload_0         
	...
	// Unreferenced inner class com/apollographql/apollo/internal/cache/normalized/RealApolloStore$5

/* anonymous class */
	class RealApolloStore._cls5 extends ApolloStoreOperation
	{

		protected Integer perform()
		{
			return (Integer)writeTransaction(((Transaction) (new RealApolloStore._cls5._cls1())));
		//    0    0:aload_0         
