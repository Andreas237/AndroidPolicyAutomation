...
//			Transaction, WriteableStore, RealApolloStore

class RealApolloStore$16$1
	implements Transaction
{
	...
	{
		return optimisticCache.removeOptimisticUpdates(val$mutationId);
	//    0    0:aload_0         
	...
	// Unreferenced inner class com/apollographql/apollo/internal/cache/normalized/RealApolloStore$16

/* anonymous class */
	class RealApolloStore._cls16 extends ApolloStoreOperation
	{

		protected Boolean perform()
		{
			Set set = (Set)writeTransaction(((Transaction) (new RealApolloStore._cls16._cls1())));
		//    0    0:aload_0         
