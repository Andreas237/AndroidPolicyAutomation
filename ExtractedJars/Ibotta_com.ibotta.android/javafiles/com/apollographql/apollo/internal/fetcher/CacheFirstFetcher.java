	...
	implements ResponseFetcher
{
		...
		implements ApolloInterceptor
	{
		...
		{
			chain.proceedAsync(request.toBuilder().fetchFromCache(true).build(), executor, ((_cls1) (executor)). new com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack() {
				...
				final CacheFirstInterceptor this$0;
	...
	{
		return ((ApolloInterceptor) (new CacheFirstInterceptor()));
	//    0    0:new             #10  <Class CacheFirstFetcher$CacheFirstInterceptor>
	//    1    3:dup             
	//    2    4:aconst_null     
	//    3    5:invokespecial   #23  <Method void CacheFirstFetcher$CacheFirstInterceptor(CacheFirstFetcher$1)>
	//    4    8:areturn         
	}
}
