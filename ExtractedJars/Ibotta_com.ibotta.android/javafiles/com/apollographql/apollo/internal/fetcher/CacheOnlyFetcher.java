	...
	implements ResponseFetcher
{
		...
		implements ApolloInterceptor
	{
		...
		{
			apollointerceptorchain.proceedAsync(interceptorrequest.toBuilder().fetchFromCache(true).build(), executor, ((_cls1) (interceptorrequest)). new com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack() {
				...
				final CacheOnlyInterceptor this$0;
			...
			//    5    7:putfield        #26  <Field com.apollographql.apollo.interceptor.ApolloInterceptor$CallBack val$callBack>
				request = com.apollographql.apollo.interceptor.ApolloInterceptor.InterceptorRequest.this;
			//    6   10:aload_0         
			//    7   11:aload_3         
	...
	{
		return ((ApolloInterceptor) (new CacheOnlyInterceptor()));
	//    0    0:new             #10  <Class CacheOnlyFetcher$CacheOnlyInterceptor>
	//    1    3:dup             
	//    2    4:aconst_null     
	//    3    5:invokespecial   #23  <Method void CacheOnlyFetcher$CacheOnlyInterceptor(CacheOnlyFetcher$1)>
	//    4    8:areturn         
	}
}
