	...
	implements ResponseFetcher
{
		...
		implements ApolloInterceptor
	{
		...
		public void interceptAsync(final com.apollographql.apollo.interceptor.ApolloInterceptor.InterceptorRequest request, final ApolloInterceptorChain chain, Executor executor, final com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack callBack)
		{
			chain.proceedAsync(request.toBuilder().fetchFromCache(false).build(), executor, ((_cls1) (executor)). new com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack() {
				...
				//   24   51:astore_2        
						chain.proceedAsync(interceptorrequest, dispatcher, ((_cls1) (apolloexception)). new com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack() {
							...
							final NetworkFirstInterceptor._cls1 this$1;
			...
			//    8   14:return          
				...
				final NetworkFirstInterceptor this$0;
			...
			{
				this$0 = final_networkfirstinterceptor;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	{
		return ((ApolloInterceptor) (new NetworkFirstInterceptor(apollologger)));
	//    0    0:new             #8   <Class NetworkFirstFetcher$NetworkFirstInterceptor>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokespecial   #23  <Method void NetworkFirstFetcher$NetworkFirstInterceptor(ApolloLogger)>
	//    4    8:areturn         
	}
}
