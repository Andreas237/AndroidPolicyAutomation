...
private static final class CacheAndNetworkFetcher$CacheAndNetworkInterceptor
	implements ApolloInterceptor
{
	...
	public void interceptAsync(com.apollographql.apollo.interceptor.ApolloInterceptor.InterceptorRequest interceptorrequest, ApolloInterceptorChain apollointerceptorchain, Executor executor, final com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack callBack)
	{
		if(disposed)
	//*   0    0:aload_0         
	...
	//    6   11:putfield        #57  <Field com.apollographql.apollo.interceptor.ApolloInterceptor$CallBack originalCallback>
			apollointerceptorchain.proceedAsync(interceptorrequest.toBuilder().fetchFromCache(true).build(), executor, new com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack() {
			...
			{
				this$0 = CacheAndNetworkFetcher.CacheAndNetworkInterceptor.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	//   19   37:invokeinterface #117 <Method void ApolloInterceptorChain.proceedAsync(com.apollographql.apollo.interceptor.ApolloInterceptor$InterceptorRequest, Executor, com.apollographql.apollo.interceptor.ApolloInterceptor$CallBack)>
			apollointerceptorchain.proceedAsync(interceptorrequest.toBuilder().fetchFromCache(false).build(), executor, new com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack() {
	...
	private CacheAndNetworkFetcher$CacheAndNetworkInterceptor()
	{
	//    0    0:aload_0         
	...
	CacheAndNetworkFetcher$CacheAndNetworkInterceptor(CacheAndNetworkFetcher._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #46  <Method void CacheAndNetworkFetcher$CacheAndNetworkInterceptor()>
	//    2    4:return          
	}
}
