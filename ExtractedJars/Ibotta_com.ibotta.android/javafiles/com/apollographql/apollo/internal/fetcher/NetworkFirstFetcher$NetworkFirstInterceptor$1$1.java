...
class NetworkFirstFetcher$NetworkFirstInterceptor$1$1
	implements com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack
{
	...
	{
		val$callBack.onFailure(val$networkException);
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field NetworkFirstFetcher$NetworkFirstInterceptor$1 this$1>
	//    2    4:getfield        #35  <Field com.apollographql.apollo.interceptor.ApolloInterceptor$CallBack NetworkFirstFetcher$NetworkFirstInterceptor$1.val$callBack>
	//    3    7:aload_0         
	...
	final NetworkFirstFetcher.NetworkFirstInterceptor._cls1 this$1;
	final ApolloException val$networkException;

	NetworkFirstFetcher$NetworkFirstInterceptor$1$1()
	{
		this$1 = final__pcls1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #24  <Field NetworkFirstFetcher$NetworkFirstInterceptor$1 this$1>
		val$networkException = ApolloException.this;
	//    3    5:aload_0         
	//    4    6:aload_2         
	...
	// Unreferenced inner class com/apollographql/apollo/internal/fetcher/NetworkFirstFetcher$NetworkFirstInterceptor$1

/* anonymous class */
	class NetworkFirstFetcher.NetworkFirstInterceptor._cls1
		implements com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack
	{
		...
		//   24   51:astore_2        
				chain.proceedAsync(interceptorrequest, dispatcher, ((com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack) (((NetworkFirstFetcher.NetworkFirstInterceptor._cls1._cls1) (apolloexception)). new NetworkFirstFetcher.NetworkFirstInterceptor._cls1._cls1())));
		//   25   52:aload_0         
