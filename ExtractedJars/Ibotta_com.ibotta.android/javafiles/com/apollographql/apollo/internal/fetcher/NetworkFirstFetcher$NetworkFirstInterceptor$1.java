...
class NetworkFirstFetcher$NetworkFirstInterceptor$1
	implements com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack
{
	...
	{
		logger.d(((Throwable) (networkException)), "Failed to fetch network response for operation %s, trying to return cached one", new Object[] {
	...
	//*  17   34:ifne            75
		{
			com.apollographql.apollo.interceptor.ApolloInterceptor.InterceptorRequest interceptorrequest = val$request.toBuilder().fetchFromCache(true).build();
	//   18   37:aload_0         
	...
	//   24   51:astore_2        
			val$chain.proceedAsync(interceptorrequest, val$dispatcher, new com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack() {
			...
			{
				this$1 = NetworkFirstFetcher.NetworkFirstInterceptor._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
			//    2    2:putfield        #24  <Field NetworkFirstFetcher$NetworkFirstInterceptor$1 this$1>
				networkException = apolloexception;
			//    3    5:aload_0         
			//    4    6:aload_2         
	...
	NetworkFirstFetcher$NetworkFirstInterceptor$1()
	{
