...
class RealApolloCall$1$1
	implements Action
{

	public void apply(com.apollographql.apollo. )
	{
		switch(RealApolloCall._cls3.$SwitchMap$com$apollographql$apollo$interceptor$ApolloInterceptor$FetchSourceType[val$sourceType.ordinal()])
	...
	//    6   32:return          
		...
		case 2: // '\002'
			.onStatusEvent(com.apollographql.apollo.ent.FETCH_NETWORK);
	//    7   33:aload_1         
	...
	//   10   40:return          
		...
		case 1: // '\001'
			.onStatusEvent(com.apollographql.apollo.ent.FETCH_CACHE);
	//   11   41:aload_1         
	...
	{
		apply((com.apollographql.apollo.)obj);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	final com.apollographql.apollo.interceptor.etchSourceType val$sourceType;
	...
	//    2    2:putfield        #20  <Field RealApolloCall$1 this$1>
		val$sourceType = com.apollographql.apollo.interceptor.etchSourceType.this;
	//    3    5:aload_0         
	//    4    6:aload_2         
	...
	// Unreferenced inner class com/apollographql/apollo/internal/RealApolloCall$1

/* anonymous class */
	class RealApolloCall._cls1
		implements com.apollographql.apollo.interceptor.ApolloInterceptor.CallBack
	{
		...
		{
			responseCallback().apply(((Action) (((RealApolloCall._cls1._cls1) (fetchsourcetype)). new RealApolloCall._cls1._cls1())));
		//    0    0:aload_0         
		//    1    1:getfield        #19  <Field RealApolloCall this$0>
