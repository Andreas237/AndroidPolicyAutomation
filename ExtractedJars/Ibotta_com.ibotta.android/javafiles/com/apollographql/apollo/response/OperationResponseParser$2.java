...
class OperationResponseParser$2
	implements com.apollographql.apollo.internal.json.istReader
{

	public Error read(ResponseJsonStreamReader responsejsonstreamreader)
		throws IOException
	{
		return (Error)responsejsonstreamreader.nextObject(true, new com.apollographql.apollo.internal.json.ResponseJsonStreamReader.ObjectReader() {

			public Error read(ResponseJsonStreamReader responsejsonstreamreader1)
				throws IOException
			{
				return OperationResponseParser.access$000(this$0, responsejsonstreamreader1.toMap());
			//    0    0:aload_0         
