...
public class PoolingByteArrayOutputStream extends ByteArrayOutputStream
{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #13  <Field ByteArrayPool mPool>
		buf = mPool.getBuf(Math.max(i, 256));
	//    5    9:aload_0         
	//    6   10:aload_0         
	//    7   11:getfield        #13  <Field ByteArrayPool mPool>
	//    8   14:iload_2         
	//    9   15:sipush          256
	//   10   18:invokestatic    #19  <Method int Math.max(int, int)>
	//   11   21:invokevirtual   #25  <Method byte[] ByteArrayPool.getBuf(int)>
	...
	//    9   15:aload_0         
	//   10   16:getfield        #13  <Field ByteArrayPool mPool>
	//   11   19:aload_0         
	...
	//   15   25:iconst_2        
	//   16   26:imul            
	//   17   27:invokevirtual   #25  <Method byte[] ByteArrayPool.getBuf(int)>
	//   18   30:astore_2        
	...
	//   26   42:invokestatic    #42  <Method void System.arraycopy(Object, int, Object, int, int)>
			mPool.returnBuf(buf);
	//   27   45:aload_0         
	//   28   46:getfield        #13  <Field ByteArrayPool mPool>
	//   29   49:aload_0         
	//   30   50:getfield        #29  <Field byte[] buf>
	//   31   53:invokevirtual   #46  <Method void ByteArrayPool.returnBuf(byte[])>
			buf = abyte0;
	//   32   56:aload_0         
	//   33   57:aload_2         
		...
		throws IOException
	{
		mPool.returnBuf(buf);
	//    0    0:aload_0         
	//    1    1:getfield        #13  <Field ByteArrayPool mPool>
	//    2    4:aload_0         
	//    3    5:getfield        #29  <Field byte[] buf>
	//    4    8:invokevirtual   #46  <Method void ByteArrayPool.returnBuf(byte[])>
		buf = null;
	//    5   11:aload_0         
	//    6   12:aconst_null     
	...
	//    2    2:aload_0         
	//    3    3:iconst_1        
	//    4    4:invokespecial   #56  <Method void expand(int)>
		super.write(i);
	//    5    7:aload_0         
	//    6    8:iload_1         
