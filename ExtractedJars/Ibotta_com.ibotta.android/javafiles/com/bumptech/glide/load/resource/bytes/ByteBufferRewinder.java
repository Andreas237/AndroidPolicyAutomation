	...
	implements DataRewinder
{
		...
		implements com.bumptech.glide.load.data.DataRewinder.Factory
	{
		...
		//    3    5:invokevirtual   #23  <Method DataRewinder build(ByteBuffer)>
		//    4    8:areturn         
		}
		...
		//    1    3:dup             
		//    2    4:aload_1         
		//    3    5:invokespecial   #27  <Method void ByteBufferRewinder(ByteBuffer)>
		//    4    8:areturn         
		}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #29  <Method ByteBuffer rewindAndGet()>
	//    2    4:areturn         
	}
	...
	//    2    4:iconst_0        
	//    3    5:invokevirtual   #37  <Method java.nio.Buffer ByteBuffer.position(int)>
	//    4    8:pop             
		return buffer;
	//    5    9:aload_0         
