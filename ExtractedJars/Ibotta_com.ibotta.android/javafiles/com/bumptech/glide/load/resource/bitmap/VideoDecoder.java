	...
	implements ResourceDecoder
{
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:getstatic       #72  <Field VideoDecoder$MediaMetadataRetrieverFactory DEFAULT_FACTORY>
	//    4    6:invokespecial   #77  <Method void VideoDecoder(BitmapPool, VideoDecoder$MediaMetadataRetrieverInitializer, VideoDecoder$MediaMetadataRetrieverFactory)>
	//    5    9:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #83  <Field BitmapPool bitmapPool>
		initializer = mediametadataretrieverinitializer;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #85  <Field VideoDecoder$MediaMetadataRetrieverInitializer initializer>
		factory = mediametadataretrieverfactory;
	//    8   14:aload_0         
	//    9   15:aload_3         
	//   10   16:putfield        #87  <Field VideoDecoder$MediaMetadataRetrieverFactory factory>
	//   11   19:return          
	}
	...
	//    4    8:dup             
	//    5    9:aconst_null     
	//    6   10:invokespecial   #94  <Method void VideoDecoder$AssetFileDescriptorInitializer(VideoDecoder$1)>
	//    7   13:invokespecial   #96  <Method void VideoDecoder(BitmapPool, VideoDecoder$MediaMetadataRetrieverInitializer)>
	//    8   16:areturn         
	}
	...
	//*   2    5:icmplt          47
	//*   3    8:iload           4
	//*   4   10:ldc1            #107 <Int 0x80000000>
	//*   5   12:icmpeq          47
	//*   6   15:iload           5
	//*   7   17:ldc1            #107 <Int 0x80000000>
	//*   8   19:icmpeq          47
	//*   9   22:aload           6
	//*  10   24:getstatic       #113 <Field DownsampleStrategy DownsampleStrategy.NONE>
	//*  11   27:if_acmpeq       47
	...
	//   16   35:iload           5
	//   17   37:aload           6
	//   18   39:invokestatic    #116 <Method Bitmap decodeScaledFrame(MediaMetadataRetriever, long, int, int, int, DownsampleStrategy)>
	//   19   42:astore          6
		else
	//*  20   44:goto            50
	...
	//   28   60:lload_1         
	//   29   61:iload_3         
	//   30   62:invokestatic    #120 <Method Bitmap decodeOriginalFrame(MediaMetadataRetriever, long, int)>
	//   31   65:astore          7
		return ((Bitmap) (obj));
	//   32   67:aload           7
	//   33   69:areturn         
	...
	//    1    1:lload_1         
	//    2    2:iload_3         
	//    3    3:invokevirtual   #126 <Method Bitmap MediaMetadataRetriever.getFrameAtTime(long, int)>
	//    4    6:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:bipush          18
	//    2    3:invokevirtual   #135 <Method String MediaMetadataRetriever.extractMetadata(int)>
	//    3    6:invokestatic    #139 <Method int Integer.parseInt(String)>
	//    4    9:istore          10
			i1 = Integer.parseInt(mediametadataretriever.extractMetadata(19));
	//    5   11:aload_0         
	//    6   12:bipush          19
	//    7   14:invokevirtual   #135 <Method String MediaMetadataRetriever.extractMetadata(int)>
	//    8   17:invokestatic    #139 <Method int Integer.parseInt(String)>
	//    9   20:istore          8
			i2 = Integer.parseInt(mediametadataretriever.extractMetadata(24));
	//   10   22:aload_0         
	//   11   23:bipush          24
	//   12   25:invokevirtual   #135 <Method String MediaMetadataRetriever.extractMetadata(int)>
	//   13   28:invokestatic    #139 <Method int Integer.parseInt(String)>
	//   14   31:istore          12
		}
	//*  15   33:iload           12
	//*  16   35:bipush          90
	...
	//*  29   65:iload           4
	//*  30   67:iload           5
	//*  31   69:invokevirtual   #143 <Method float DownsampleStrategy.getScaleFactor(int, int, int, int)>
	//*  32   72:fstore          7
	//*  33   74:aload_0         
	//*  34   75:lload_1         
	//*  35   76:iload_3         
	...
	//*  38   80:fload           7
	//*  39   82:fmul            
	//*  40   83:invokestatic    #149 <Method int Math.round(float)>
	//*  41   86:fload           7
	//*  42   88:iload           11
	//*  43   90:i2f             
	//*  44   91:fmul            
	//*  45   92:invokestatic    #149 <Method int Math.round(float)>
	//*  46   95:invokevirtual   #153 <Method Bitmap MediaMetadataRetriever.getScaledFrameAtTime(long, int, int, int)>
	//*  47   98:astore_0        
	//*  48   99:aload_0         
	//*  49  100:areturn         
	...
	//*  51  102:ldc1            #155 <String "VideoDecoder">
	//*  52  104:iconst_3        
	//*  53  105:invokestatic    #161 <Method boolean Log.isLoggable(String, int)>
	//*  54  108:ifeq            120
				Log.d("VideoDecoder", "Exception trying to decode frame on oreo+", ((Throwable) (mediametadataretriever)));
	//   55  111:ldc1            #155 <String "VideoDecoder">
	//   56  113:ldc1            #163 <String "Exception trying to decode frame on oreo+">
	//   57  115:aload_0         
	//   58  116:invokestatic    #167 <Method int Log.d(String, String, Throwable)>
	//   59  119:pop             
			return null;
	//   60  120:aconst_null     
	//   61  121:areturn         
...
_L4:
	...
	//    4    8:dup             
	//    5    9:invokespecial   #169 <Method void VideoDecoder$ParcelFileDescriptorInitializer()>
	//    6   12:invokespecial   #96  <Method void VideoDecoder(BitmapPool, VideoDecoder$MediaMetadataRetrieverInitializer)>
	//    7   15:areturn         
	}
	...
	//    0    0:aload           4
	//    1    2:getstatic       #59  <Field Option TARGET_FRAME>
	//    2    5:invokevirtual   #183 <Method Object Options.get(Option)>
	//    3    8:checkcast       #44  <Class Long>
	//    4   11:invokevirtual   #187 <Method long Long.longValue()>
	//    5   14:lstore          5
		if(l < 0L && l != -1L)
	//*   6   16:lload           5
	//*   7   18:lconst_0        
	...
	//*   9   20:ifge            69
	//*  10   23:lload           5
	//*  11   25:ldc2w           #41  <Long -1L>
	//*  12   28:lcmp            
	//*  13   29:ifne            35
	//*  14   32:goto            69
		{
			obj = ((Object) (new StringBuilder()));
	//   15   35:new             #189 <Class StringBuilder>
	//   16   38:dup             
	//   17   39:invokespecial   #190 <Method void StringBuilder()>
	//   18   42:astore_1        
			((StringBuilder) (obj)).append("Requested frame must be non-negative, or DEFAULT_FRAME, given: ");
	//   19   43:aload_1         
	//   20   44:ldc1            #192 <String "Requested frame must be non-negative, or DEFAULT_FRAME, given: ">
	//   21   46:invokevirtual   #196 <Method StringBuilder StringBuilder.append(String)>
	//   22   49:pop             
			((StringBuilder) (obj)).append(l);
	//   23   50:aload_1         
	//   24   51:lload           5
	//   25   53:invokevirtual   #199 <Method StringBuilder StringBuilder.append(long)>
	//   26   56:pop             
			throw new IllegalArgumentException(((StringBuilder) (obj)).toString());
	//   27   57:new             #201 <Class IllegalArgumentException>
	//   28   60:dup             
	//   29   61:aload_1         
	//   30   62:invokevirtual   #205 <Method String StringBuilder.toString()>
	//   31   65:invokespecial   #208 <Method void IllegalArgumentException(String)>
	//   32   68:athrow          
		}
		obj1 = ((Object) ((Integer)options.get(FRAME_OPTION)));
	//   33   69:aload           4
	//   34   71:getstatic       #69  <Field Option FRAME_OPTION>
	//   35   74:invokevirtual   #183 <Method Object Options.get(Option)>
	//   36   77:checkcast       #63  <Class Integer>
	//   37   80:astore          8
	...
	//   42   91:iconst_2        
	//   43   92:invokestatic    #66  <Method Integer Integer.valueOf(int)>
	//   44   95:astore          7
		options = ((Options) ((DownsampleStrategy)options.get(DownsampleStrategy.OPTION)));
	//   45   97:aload           4
	//   46   99:getstatic       #211 <Field Option DownsampleStrategy.OPTION>
	//   47  102:invokevirtual   #183 <Method Object Options.get(Option)>
	//   48  105:checkcast       #109 <Class DownsampleStrategy>
	//   49  108:astore          4
		if(options == null)
	//*  50  110:aload           4
	//*  51  112:ifnonnull       123
			options = ((Options) (DownsampleStrategy.DEFAULT));
	//   52  115:getstatic       #214 <Field DownsampleStrategy DownsampleStrategy.DEFAULT>
	//   53  118:astore          4
	//*  54  120:goto            123
		obj1 = ((Object) (factory.build()));
	//   55  123:aload_0         
	//   56  124:getfield        #87  <Field VideoDecoder$MediaMetadataRetrieverFactory factory>
	//   57  127:invokevirtual   #218 <Method MediaMetadataRetriever VideoDecoder$MediaMetadataRetrieverFactory.build()>
	//   58  130:astore          8
		initializer.initialize(((MediaMetadataRetriever) (obj1)), obj);
	//   59  132:aload_0         
	//   60  133:getfield        #85  <Field VideoDecoder$MediaMetadataRetrieverInitializer initializer>
	//   61  136:aload           8
	//   62  138:aload_1         
	//   63  139:invokeinterface #222 <Method void VideoDecoder$MediaMetadataRetrieverInitializer.initialize(MediaMetadataRetriever, Object)>
		obj = ((Object) (decodeFrame(((MediaMetadataRetriever) (obj1)), l, integer.intValue(), i, j, ((DownsampleStrategy) (options)))));
	//   64  144:aload           8
	//   65  146:lload           5
	//   66  148:aload           7
	//   67  150:invokevirtual   #226 <Method int Integer.intValue()>
	//   68  153:iload_2         
	//   69  154:iload_3         
	//   70  155:aload           4
	//   71  157:invokestatic    #228 <Method Bitmap decodeFrame(MediaMetadataRetriever, long, int, int, int, DownsampleStrategy)>
	//   72  160:astore_1        
		((MediaMetadataRetriever) (obj1)).release();
	//   73  161:aload           8
	//   74  163:invokevirtual   #231 <Method void MediaMetadataRetriever.release()>
		return ((Resource) (BitmapResource.obtain(((Bitmap) (obj)), bitmapPool)));
	//   75  166:aload_1         
	//   76  167:aload_0         
	//   77  168:getfield        #83  <Field BitmapPool bitmapPool>
	//   78  171:invokestatic    #237 <Method BitmapResource BitmapResource.obtain(Bitmap, BitmapPool)>
	//   79  174:areturn         
		obj;
	//   80  175:astore_1        
	...
	//   83  180:new             #174 <Class IOException>
	//   84  183:dup             
	//   85  184:aload_1         
	//   86  185:invokespecial   #240 <Method void IOException(Throwable)>
	//   87  188:athrow          
		((MediaMetadataRetriever) (obj1)).release();
	//   88  189:aload           8
	//   89  191:invokevirtual   #231 <Method void MediaMetadataRetriever.release()>
		throw obj;
	//   90  194:aload_1         
	//   91  195:athrow          
	}
	...
	static 
	{
	//    0    0:ldc1            #40  <String "com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame">
	//    1    2:ldc2w           #41  <Long -1L>
	//    2    5:invokestatic    #48  <Method Long Long.valueOf(long)>
	//    3    8:new             #9   <Class VideoDecoder$1>
	//    4   11:dup             
	//    5   12:invokespecial   #51  <Method void VideoDecoder$1()>
	//    6   15:invokestatic    #57  <Method Option Option.disk(String, Object, com.bumptech.glide.load.Option$CacheKeyUpdater)>
	//    7   18:putstatic       #59  <Field Option TARGET_FRAME>
	//    8   21:ldc1            #61  <String "com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption">
	//    9   23:iconst_2        
	//   10   24:invokestatic    #66  <Method Integer Integer.valueOf(int)>
	//   11   27:new             #11  <Class VideoDecoder$2>
	//   12   30:dup             
	//   13   31:invokespecial   #67  <Method void VideoDecoder$2()>
	//   14   34:invokestatic    #57  <Method Option Option.disk(String, Object, com.bumptech.glide.load.Option$CacheKeyUpdater)>
	//   15   37:putstatic       #69  <Field Option FRAME_OPTION>
	//   16   40:new             #16  <Class VideoDecoder$MediaMetadataRetrieverFactory>
	//   17   43:dup             
	//   18   44:invokespecial   #70  <Method void VideoDecoder$MediaMetadataRetrieverFactory()>
	//   19   47:putstatic       #72  <Field VideoDecoder$MediaMetadataRetrieverFactory DEFAULT_FACTORY>
	//*  20   50:return          
	}
}
