...
public static final class ImageHeaderParser$ImageType extends Enum
{

	public static ImageHeaderParser$ImageType valueOf(String s)
	{
		return (ImageHeaderParser$ImageType)Enum.valueOf(com/bumptech/glide/load/ImageHeaderParser$ImageType, s);
	...
	{
		return (ImageHeaderParser$ImageType[])((ImageHeaderParser$ImageType []) ($VALUES)).clone();
	...
	static 
	{
		GIF = new ImageHeaderParser$ImageType("GIF", 0, true);
	...
	//    6   11:putstatic       #30  <Field ImageHeaderParser$ImageType GIF>
		JPEG = new ImageHeaderParser$ImageType("JPEG", 1, false);
	...
	//   13   25:putstatic       #33  <Field ImageHeaderParser$ImageType JPEG>
		RAW = new ImageHeaderParser$ImageType("RAW", 2, false);
	...
	//   20   39:putstatic       #36  <Field ImageHeaderParser$ImageType RAW>
		PNG_A = new ImageHeaderParser$ImageType("PNG_A", 3, true);
	...
	//   27   53:putstatic       #39  <Field ImageHeaderParser$ImageType PNG_A>
		PNG = new ImageHeaderParser$ImageType("PNG", 4, false);
	...
	//   34   67:putstatic       #42  <Field ImageHeaderParser$ImageType PNG>
		WEBP_A = new ImageHeaderParser$ImageType("WEBP_A", 5, true);
	...
	//   41   81:putstatic       #45  <Field ImageHeaderParser$ImageType WEBP_A>
		WEBP = new ImageHeaderParser$ImageType("WEBP", 6, false);
	...
	//   48   96:putstatic       #48  <Field ImageHeaderParser$ImageType WEBP>
		UNKNOWN = new ImageHeaderParser$ImageType("UNKNOWN", 7, false);
	...
	//   55  111:putstatic       #51  <Field ImageHeaderParser$ImageType UNKNOWN>
		$VALUES = (new ImageHeaderParser$ImageType[] {
			GIF, JPEG, RAW, PNG_A, PNG, WEBP_A, WEBP, UNKNOWN
		});
	//   56  114:bipush          8
	//   57  116:anewarray       ImageHeaderParser$ImageType[]
	//   58  119:dup             
	//   59  120:iconst_0        
	...
	private ImageHeaderParser$ImageType(String s, int i, boolean flag)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
