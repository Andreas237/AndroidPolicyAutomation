	...
	implements DataRewinder
{
	...
	//    2    4:aload_0         
	//    3    5:new             #19  <Class RecyclableBufferedInputStream>
	//    4    8:dup             
	//    5    9:aload_1         
	//    6   10:aload_2         
	//    7   11:invokespecial   #21  <Method void RecyclableBufferedInputStream(InputStream, ArrayPool)>
	//    8   14:putfield        #23  <Field RecyclableBufferedInputStream bufferedStream>
		bufferedStream.mark(0x500000);
	//    9   17:aload_0         
	//   10   18:getfield        #23  <Field RecyclableBufferedInputStream bufferedStream>
	//   11   21:ldc1            #24  <Int 0x500000>
	//   12   23:invokevirtual   #28  <Method void RecyclableBufferedInputStream.mark(int)>
	//   13   26:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field RecyclableBufferedInputStream bufferedStream>
	//    2    4:invokevirtual   #33  <Method void RecyclableBufferedInputStream.release()>
	//    3    7:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #23  <Field RecyclableBufferedInputStream bufferedStream>
	//    2    4:invokevirtual   #41  <Method void RecyclableBufferedInputStream.reset()>
		return ((InputStream) (bufferedStream));
	//    3    7:aload_0         
	//    4    8:getfield        #23  <Field RecyclableBufferedInputStream bufferedStream>
	//    5   11:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #46  <Method InputStream rewindAndGet()>
	//    2    4:areturn         
	}
