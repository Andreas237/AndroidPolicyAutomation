	...
	implements DataFetcher
{
	...
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #23  <Field Uri uri>
	//    8   14:return          
	}
	...
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #34  <Method void close(Object)>
		return;
	//    8   14:return          
	...
	//    1    1:aload_0         
	//    2    2:aload_0         
	//    3    3:getfield        #23  <Field Uri uri>
	//    4    6:aload_0         
	//    5    7:getfield        #21  <Field ContentResolver contentResolver>
	//    6   10:invokevirtual   #52  <Method Object loadResource(Uri, ContentResolver)>
	//    7   13:putfield        #30  <Field Object data>
		}
	//*   8   16:aload_2         
	//*   9   17:aload_0         
	//*  10   18:getfield        #30  <Field Object data>
	//*  11   21:invokeinterface #57  <Method void DataFetcher$DataCallback.onDataReady(Object)>
	//*  12   26:return          
	...
	//*  14   28:ldc1            #59  <String "LocalUriFetcher">
	//*  15   30:iconst_3        
	//*  16   31:invokestatic    #65  <Method boolean Log.isLoggable(String, int)>
	//*  17   34:ifeq            46
				Log.d("LocalUriFetcher", "Failed to open Uri", ((Throwable) (priority)));
	//   18   37:ldc1            #59  <String "LocalUriFetcher">
	//   19   39:ldc1            #67  <String "Failed to open Uri">
	//   20   41:aload_1         
	//   21   42:invokestatic    #71  <Method int Log.d(String, String, Throwable)>
	//   22   45:pop             
			datacallback.onLoadFailed(((Exception) (priority)));
	//   23   46:aload_2         
	//   24   47:aload_1         
	//   25   48:invokeinterface #75  <Method void DataFetcher$DataCallback.onLoadFailed(Exception)>
			return;
	//   26   53:return          
		}
