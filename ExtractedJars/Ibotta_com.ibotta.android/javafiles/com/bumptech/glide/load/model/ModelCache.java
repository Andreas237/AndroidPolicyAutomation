...
public class ModelCache
{
	...
	public ModelCache()
	{
		this(250L);
	//    0    0:aload_0         
	//    1    1:ldc2w           #16  <Long 250L>
	//    2    4:invokespecial   #20  <Method void ModelCache(long)>
	//    3    7:return          
	}
	...
	//    5    9:aload_0         
	//    6   10:lload_1         
	//    7   11:invokespecial   #26  <Method void ModelCache$1(ModelCache, long)>
	//    8   14:putfield        #28  <Field LruCache cache>
	//    9   17:return          
	}
	...
	//    1    1:iload_2         
	//    2    2:iload_3         
	//    3    3:invokestatic    #34  <Method ModelCache$ModelKey ModelCache$ModelKey.get(Object, int, int)>
	//    4    6:astore_1        
		Object obj1 = cache.get(obj);
	//    5    7:aload_0         
	//    6    8:getfield        #28  <Field LruCache cache>
	//    7   11:aload_1         
	//    8   12:invokevirtual   #39  <Method Object LruCache.get(Object)>
	//    9   15:astore          4
		((ModelKey) (obj)).release();
	//   10   17:aload_1         
	//   11   18:invokevirtual   #42  <Method void ModelCache$ModelKey.release()>
		return obj1;
	//   12   21:aload           4
	//   13   23:areturn         
	}
	...
	//    7   11:aload_1         
	//    8   12:aload           4
	//    9   14:invokevirtual   #50  <Method Object LruCache.put(Object, Object)>
	//   10   17:pop             
	//   11   18:return          
	}
