	...
	implements ModelLoader
{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #31  <Field Resources resources>
		uriLoader = modelloader;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #33  <Field ModelLoader uriLoader>
	//    8   14:return          
	}
	...
	//    4    8:aload_2         
	//    5    9:ldc1            #46  <String "android.resource://">
	...
	//    8   15:aload_2         
	//    9   16:aload_0         
	//   10   17:getfield        #31  <Field Resources resources>
	//   11   20:aload_1         
	//   12   21:invokevirtual   #56  <Method int Integer.intValue()>
	//   13   24:invokevirtual   #62  <Method String Resources.getResourcePackageName(int)>
	//   14   27:invokevirtual   #50  <Method StringBuilder StringBuilder.append(String)>
	//   15   30:pop             
			((StringBuilder) (obj)).append('/');
	//   16   31:aload_2         
	//   17   32:bipush          47
	//   18   34:invokevirtual   #65  <Method StringBuilder StringBuilder.append(char)>
	//   19   37:pop             
			((StringBuilder) (obj)).append(resources.getResourceTypeName(integer.intValue()));
	//   20   38:aload_2         
	//   21   39:aload_0         
	//   22   40:getfield        #31  <Field Resources resources>
	//   23   43:aload_1         
	//   24   44:invokevirtual   #56  <Method int Integer.intValue()>
	//   25   47:invokevirtual   #68  <Method String Resources.getResourceTypeName(int)>
	//   26   50:invokevirtual   #50  <Method StringBuilder StringBuilder.append(String)>
	//   27   53:pop             
			((StringBuilder) (obj)).append('/');
	//   28   54:aload_2         
	//   29   55:bipush          47
	//   30   57:invokevirtual   #65  <Method StringBuilder StringBuilder.append(char)>
	//   31   60:pop             
			((StringBuilder) (obj)).append(resources.getResourceEntryName(integer.intValue()));
	//   32   61:aload_2         
	//   33   62:aload_0         
	//   34   63:getfield        #31  <Field Resources resources>
	//   35   66:aload_1         
	//   36   67:invokevirtual   #56  <Method int Integer.intValue()>
	//   37   70:invokevirtual   #71  <Method String Resources.getResourceEntryName(int)>
	//   38   73:invokevirtual   #50  <Method StringBuilder StringBuilder.append(String)>
	//   39   76:pop             
			obj = ((Object) (Uri.parse(((StringBuilder) (obj)).toString())));
	//   40   77:aload_2         
	//   41   78:invokevirtual   #75  <Method String StringBuilder.toString()>
	//   42   81:invokestatic    #81  <Method Uri Uri.parse(String)>
	//   43   84:astore_2        
		}
	//*  44   85:aload_2         
	//*  45   86:areturn         
	...
	//*  47   88:ldc1            #83  <String "ResourceLoader">
	//*  48   90:iconst_5        
	//*  49   91:invokestatic    #89  <Method boolean Log.isLoggable(String, int)>
	//*  50   94:ifeq            129
			{
				StringBuilder stringbuilder = new StringBuilder();
	//   51   97:new             #43  <Class StringBuilder>
	//   52  100:dup             
	//   53  101:invokespecial   #44  <Method void StringBuilder()>
	//   54  104:astore_3        
				stringbuilder.append("Received invalid resource id: ");
	//   55  105:aload_3         
	//   56  106:ldc1            #91  <String "Received invalid resource id: ">
	//   57  108:invokevirtual   #50  <Method StringBuilder StringBuilder.append(String)>
	//   58  111:pop             
				stringbuilder.append(((Object) (integer)));
	//   59  112:aload_3         
	//   60  113:aload_1         
	//   61  114:invokevirtual   #94  <Method StringBuilder StringBuilder.append(Object)>
	//   62  117:pop             
				Log.w("ResourceLoader", stringbuilder.toString(), ((Throwable) (notfoundexception)));
	//   63  118:ldc1            #83  <String "ResourceLoader">
	//   64  120:aload_3         
	//   65  121:invokevirtual   #75  <Method String StringBuilder.toString()>
	//   66  124:aload_2         
	//   67  125:invokestatic    #98  <Method int Log.w(String, String, Throwable)>
	//   68  128:pop             
			}
			return null;
	//   69  129:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #104 <Method Uri getResourceUri(Integer)>
	//    3    5:astore_1        
		if(integer == null)
	//*   4    6:aload_1         
	//*   5    7:ifnonnull       12
	...
	//    8   12:aload_0         
	//    9   13:getfield        #33  <Field ModelLoader uriLoader>
	//   10   16:aload_1         
	//   11   17:iload_2         
	//   12   18:iload_3         
	//   13   19:aload           4
	//   14   21:invokeinterface #107 <Method ModelLoader$LoadData ModelLoader.buildLoadData(Object, int, int, Options)>
	//   15   26:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #52  <Class Integer>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #111 <Method ModelLoader$LoadData buildLoadData(Integer, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:checkcast       #52  <Class Integer>
	//    3    5:invokevirtual   #116 <Method boolean handles(Integer)>
	//    4    8:ireturn         
	}
