...
//			MultiModelLoaderFactory, ModelLoader, ModelLoaderFactory
...
public class ModelLoaderRegistry
{
	...
	//    5    7:aload_2         
	//    6    8:aload_3         
	//    7    9:invokevirtual   #66  <Method void MultiModelLoaderFactory.append(Class, Class, ModelLoaderFactory)>
		cache.clear();
	//    8   12:aload_0         
	//    9   13:getfield        #34  <Field ModelLoaderRegistry$ModelLoaderCache cache>
	//   10   16:invokevirtual   #69  <Method void ModelLoaderRegistry$ModelLoaderCache.clear()>
		this;
	//   11   19:aload_0         
		JVM INSTR monitorexit ;
	//   12   20:monitorexit     
	...
	//    3    3:getfield        #36  <Field MultiModelLoaderFactory multiModelLoaderFactory>
	//    4    6:aload_1         
	//    5    7:invokevirtual   #73  <Method List MultiModelLoaderFactory.getDataClasses(Class)>
	//    6   10:astore_1        
		this;
	//    7   11:aload_0         
		JVM INSTR monitorexit ;
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #78  <Method Class getClass(Object)>
	//    3    5:invokespecial   #80  <Method List getModelLoadersForClass(Class)>
	//    4    8:astore          8
		int j = list.size();
	//    5   10:aload           8
	//    6   12:invokeinterface #86  <Method int List.size()>
	//    7   17:istore          5
		Object obj1 = ((Object) (Collections.emptyList()));
	//    8   19:invokestatic    #90  <Method List Collections.emptyList()>
	//    9   22:astore          6
		int i = 0;
	//   10   24:iconst_0        
	//   11   25:istore          4
		boolean flag1;
		for(boolean flag = true; i < j; flag = flag1)
	//*  12   27:iconst_1        
	//*  13   28:istore_2        
	//*  14   29:iload           4
	//*  15   31:iload           5
	...
	//   17   36:aload           8
	//   18   38:iload           4
	//   19   40:invokeinterface #93  <Method Object List.get(int)>
	//   20   45:checkcast       #95  <Class ModelLoader>
	//   21   48:astore          9
			Object obj2 = obj1;
	//   22   50:aload           6
	//   23   52:astore          7
	...
	//*  26   56:aload           9
	//*  27   58:aload_1         
	//*  28   59:invokeinterface #99  <Method boolean ModelLoader.handles(Object)>
	//*  29   64:ifeq            103
			{
				flag1 = flag;
	//   30   67:iload_2         
	...
	//   34   73:new             #101 <Class ArrayList>
	//   35   76:dup             
	//   36   77:iload           5
	//   37   79:iload           4
	//   38   81:isub            
	//   39   82:invokespecial   #104 <Method void ArrayList(int)>
	//   40   85:astore          6
					flag1 = false;
	//   41   87:iconst_0        
	//   42   88:istore_3        
	...
	//   43   89:aload           6
	//   44   91:aload           9
	//   45   93:invokeinterface #107 <Method boolean List.add(Object)>
	//   46   98:pop             
				obj2 = obj1;
	//   47   99:aload           6
	//   48  101:astore          7
