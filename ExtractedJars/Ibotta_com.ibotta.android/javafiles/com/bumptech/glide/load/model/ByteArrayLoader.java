	...
	implements ModelLoader
{
		...
		implements DataFetcher
	{
		...
		Fetcher(byte abyte0[], Converter converter1)
		{
		//    0    0:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #41  <Class byte[]>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #44  <Method ModelLoader$LoadData buildLoadData(byte[], int, int, Options)>
	//    7   12:areturn         
	}

	public ModelLoader.LoadData buildLoadData(byte abyte0[], int i, int j, Options options)
	{
		return new ModelLoader.LoadData(((com.bumptech.glide.load.Key) (new ObjectKey(((Object) (abyte0))))), ((DataFetcher) (new Fetcher(abyte0, converter))));
	...
	//    6   12:new             #17  <Class ByteArrayLoader$Fetcher>
	//    7   15:dup             
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #33  <Field ByteArrayLoader$Converter converter>
	//   11   21:invokespecial   #55  <Method void ByteArrayLoader$Fetcher(byte[], ByteArrayLoader$Converter)>
	...
	//    1    1:aload_1         
	//    2    2:checkcast       #41  <Class byte[]>
	//    3    5:invokevirtual   #64  <Method boolean handles(byte[])>
	//    4    8:ireturn         
	}
