	...
	implements ArrayAdapterInterface
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #16  <Class int[]>
	//    3    5:invokevirtual   #19  <Method int getArrayLength(int[])>
	//    4    8:ireturn         
	}
	...
	//    0    0:ldc1            #25  <String "IntegerArrayPool">
	//    1    2:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #30  <Method int[] newArray(int)>
	//    3    5:areturn         
	}
