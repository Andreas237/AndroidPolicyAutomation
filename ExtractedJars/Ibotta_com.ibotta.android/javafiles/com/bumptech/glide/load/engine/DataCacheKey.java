	...
	implements Key
{
	...
	//    2    4:invokeinterface #27  <Method int Key.hashCode()>
	//    3    9:bipush          31
	//    4   11:imul            
	//    5   12:aload_0         
	//    6   13:getfield        #18  <Field Key signature>
	//    7   16:invokeinterface #27  <Method int Key.hashCode()>
	//    8   21:iadd            
	//    9   22:ireturn         
	}
	...
	//    4    8:aload_1         
	//    5    9:ldc1            #34  <String "DataCacheKey{sourceKey=">
	...
	//   11   20:invokevirtual   #41  <Method StringBuilder StringBuilder.append(Object)>
	//   12   23:pop             
		stringbuilder.append(", signature=");
	//   13   24:aload_1         
	//   14   25:ldc1            #43  <String ", signature=">
	...
	//   22   40:aload_1         
	//   23   41:bipush          125
	//   24   43:invokevirtual   #46  <Method StringBuilder StringBuilder.append(char)>
	//   25   46:pop             
		return stringbuilder.toString();
	//   26   47:aload_1         
	//   27   48:invokevirtual   #48  <Method String StringBuilder.toString()>
	//   28   51:areturn         
	}
	...
	//    1    1:getfield        #16  <Field Key sourceKey>
	//    2    4:aload_1         
	//    3    5:invokeinterface #53  <Method void Key.updateDiskCacheKey(MessageDigest)>
		signature.updateDiskCacheKey(messagedigest);
	//    4   10:aload_0         
	//    5   11:getfield        #18  <Field Key signature>
	//    6   14:aload_1         
	//    7   15:invokeinterface #53  <Method void Key.updateDiskCacheKey(MessageDigest)>
	//    8   20:return          
	}
