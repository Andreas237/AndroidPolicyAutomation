...
final class Jobs
{
	...
	//    0    0:aload_0         
	//    1    1:aload_2         
	//    2    2:invokevirtual   #42  <Method boolean EngineJob.onlyRetrieveFromCache()>
	//    3    5:invokespecial   #28  <Method Map getJobMap(boolean)>
	//    4    8:aload_1         
	//    5    9:aload_2         
	//    6   10:invokeinterface #45  <Method Object Map.put(Object, Object)>
	//    7   15:pop             
	//    8   16:return          
	}
	...
	//*   9   17:invokevirtual   #51  <Method boolean Object.equals(Object)>
	//*  10   20:ifeq            31
			map.remove(((Object) (key)));
	//   11   23:aload_3         
	//   12   24:aload_1         
	//   13   25:invokeinterface #54  <Method Object Map.remove(Object)>
	//   14   30:pop             
	//   15   31:return          
	}
