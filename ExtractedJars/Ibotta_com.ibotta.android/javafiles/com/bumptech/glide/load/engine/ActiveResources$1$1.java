	...
	implements Runnable
{
	...
	// Unreferenced inner class com/bumptech/glide/load/engine/ActiveResources$1

/* anonymous class */
	class ActiveResources._cls1
		implements ThreadFactory
	{

		public Thread newThread(Runnable runnable)
		{
			return new Thread(((Runnable) (((ActiveResources._cls1._cls1) (runnable)). new ActiveResources._cls1._cls1())), "glide-active-resources");
