	...
	implements ConnectivityMonitor
{
	...
	//    4    8:dup             
	//    5    9:aload_0         
	//    6   10:invokespecial   #26  <Method void DefaultConnectivityMonitor$1(DefaultConnectivityMonitor)>
	//    7   13:putfield        #28  <Field BroadcastReceiver connectivityReceiver>
		context = context1.getApplicationContext();
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:invokevirtual   #34  <Method Context Context.getApplicationContext()>
	//   11   21:putfield        #36  <Field Context context>
		listener = connectivitylistener;
	//   12   24:aload_0         
	//   13   25:aload_2         
	//   14   26:putfield        #38  <Field ConnectivityMonitor$ConnectivityListener listener>
	//   15   29:return          
	}
	...
	private void register()
	{
		if(isRegistered)
	//*   0    0:aload_0         
	//*   1    1:getfield        #45  <Field boolean isRegistered>
	//*   2    4:ifeq            8
			return;
	//    3    7:return          
	...
	//    5    9:aload_0         
	//    6   10:aload_0         
	//    7   11:getfield        #36  <Field Context context>
	//    8   14:invokevirtual   #48  <Method boolean isConnected(Context)>
	//    9   17:putfield        #50  <Field boolean isConnected>
		try
		{
			context.registerReceiver(connectivityReceiver, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
	//   10   20:aload_0         
	//   11   21:getfield        #36  <Field Context context>
	//   12   24:aload_0         
	//   13   25:getfield        #28  <Field BroadcastReceiver connectivityReceiver>
	//   14   28:new             #52  <Class IntentFilter>
	//   15   31:dup             
	//   16   32:ldc1            #54  <String "android.net.conn.CONNECTIVITY_CHANGE">
	//   17   34:invokespecial   #57  <Method void IntentFilter(String)>
	//   18   37:invokevirtual   #61  <Method Intent Context.registerReceiver(BroadcastReceiver, IntentFilter)>
	//   19   40:pop             
			isRegistered = true;
	//   20   41:aload_0         
	//   21   42:iconst_1        
	//   22   43:putfield        #45  <Field boolean isRegistered>
			return;
	//   23   46:return          
		}
	...
	//*  25   48:ldc1            #63  <String "ConnectivityMonitor">
	//*  26   50:iconst_5        
	//*  27   51:invokestatic    #69  <Method boolean Log.isLoggable(String, int)>
	//*  28   54:ifeq            66
				Log.w("ConnectivityMonitor", "Failed to register", ((Throwable) (securityexception)));
	//   29   57:ldc1            #63  <String "ConnectivityMonitor">
	//   30   59:ldc1            #71  <String "Failed to register">
	//   31   61:aload_1         
	//   32   62:invokestatic    #75  <Method int Log.w(String, String, Throwable)>
	//   33   65:pop             
		}
	//   34   66:return          
	}
	...
	//    4    8:aload_0         
	//    5    9:getfield        #36  <Field Context context>
	//    6   12:aload_0         
	//    7   13:getfield        #28  <Field BroadcastReceiver connectivityReceiver>
	//    8   16:invokevirtual   #80  <Method void Context.unregisterReceiver(BroadcastReceiver)>
			isRegistered = false;
	//    9   19:aload_0         
	//   10   20:iconst_0        
	//   11   21:putfield        #45  <Field boolean isRegistered>
			return;
	//   12   24:return          
		}
	}
	...
	//    0    0:aload_1         
	//    1    1:ldc1            #87  <String "connectivity">
	//    2    3:invokevirtual   #91  <Method Object Context.getSystemService(String)>
	//    3    6:checkcast       #93  <Class ConnectivityManager>
	//    4    9:invokestatic    #99  <Method Object Preconditions.checkNotNull(Object)>
	//    5   12:checkcast       #93  <Class ConnectivityManager>
	//    6   15:astore_1        
		try
		{
			context1 = ((Context) (((ConnectivityManager) (context1)).getActiveNetworkInfo()));
	//    7   16:aload_1         
	//    8   17:invokevirtual   #103 <Method NetworkInfo ConnectivityManager.getActiveNetworkInfo()>
	//    9   20:astore_1        
		}
	//*  10   21:aload_1         
	//*  11   22:ifnull          34
	//*  12   25:aload_1         
	//*  13   26:invokevirtual   #108 <Method boolean NetworkInfo.isConnected()>
	//*  14   29:ifeq            34
	//*  15   32:iconst_1        
	//*  16   33:ireturn         
	//*  17   34:iconst_0        
	...
	//*  19   36:astore_1        
		{
			if(Log.isLoggable("ConnectivityMonitor", 5))
	//*  20   37:ldc1            #63  <String "ConnectivityMonitor">
	//*  21   39:iconst_5        
	//*  22   40:invokestatic    #69  <Method boolean Log.isLoggable(String, int)>
	//*  23   43:ifeq            55
				Log.w("ConnectivityMonitor", "Failed to determine connectivity status when connectivity changed", ((Throwable) (context1)));
	//   24   46:ldc1            #63  <String "ConnectivityMonitor">
	//   25   48:ldc1            #110 <String "Failed to determine connectivity status when connectivity changed">
	//   26   50:aload_1         
	//   27   51:invokestatic    #75  <Method int Log.w(String, String, Throwable)>
	//   28   54:pop             
			return true;
	//   29   55:iconst_1        
	//   30   56:ireturn         
	...
	public void onStart()
	{
		register();
	//    0    0:aload_0         
	//    1    1:invokespecial   #115 <Method void register()>
	//    2    4:return          
	}
	...
	public void onStop()
	{
		unregister();
	//    0    0:aload_0         
	//    1    1:invokespecial   #118 <Method void unregister()>
	//    2    4:return          
	}
