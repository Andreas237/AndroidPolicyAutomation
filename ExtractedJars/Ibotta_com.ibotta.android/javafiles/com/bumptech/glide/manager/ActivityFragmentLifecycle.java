	...
	implements Lifecycle
{
	...
	//    4   10:pop             
		if(isDestroyed)
	//*   5   11:aload_0         
	//*   6   12:getfield        #39  <Field boolean isDestroyed>
	//*   7   15:ifeq            25
		{
			lifecyclelistener.onDestroy();
	//    8   18:aload_1         
	//    9   19:invokeinterface #44  <Method void LifecycleListener.onDestroy()>
			return;
	//   10   24:return          
		}
		if(isStarted)
	//*  11   25:aload_0         
	//*  12   26:getfield        #46  <Field boolean isStarted>
	//*  13   29:ifeq            39
		{
			lifecyclelistener.onStart();
	//   14   32:aload_1         
	//   15   33:invokeinterface #49  <Method void LifecycleListener.onStart()>
			return;
	//   16   38:return          
		} else
		{
	...
	//   17   39:aload_1         
	//   18   40:invokeinterface #52  <Method void LifecycleListener.onStop()>
			return;
	//   19   45:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_1        
	//    2    2:putfield        #39  <Field boolean isDestroyed>
	...
	//    5    9:invokestatic    #59  <Method List Util.getSnapshot(java.util.Collection)>
	//    6   12:invokeinterface #65  <Method Iterator List.iterator()>
	//    7   17:astore_1        
	//    8   18:aload_1         
	...
	//   13   33:checkcast       #41  <Class LifecycleListener>
	//   14   36:invokeinterface #44  <Method void LifecycleListener.onDestroy()>
	//*  15   41:goto            18
	//   16   44:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_1        
	//    2    2:putfield        #46  <Field boolean isStarted>
	...
	//   12   28:invokeinterface #75  <Method Object Iterator.next()>
	//   13   33:checkcast       #41  <Class LifecycleListener>
	//   14   36:invokeinterface #49  <Method void LifecycleListener.onStart()>
	//*  15   41:goto            18
	//   16   44:return          
	}
	...
	//   12   28:invokeinterface #75  <Method Object Iterator.next()>
	//   13   33:checkcast       #41  <Class LifecycleListener>
	//   14   36:invokeinterface #52  <Method void LifecycleListener.onStop()>
	//*  15   41:goto            18
	//   16   44:return          
	}
	...
	//    1    1:getfield        #27  <Field Set lifecycleListeners>
	//    2    4:aload_1         
	//    3    5:invokeinterface #79  <Method boolean Set.remove(Object)>
	//    4   10:pop             
	//    5   11:return          
	}
