...
_L1:
	...
	//    6   10:invokespecial   #100 <Method void ArrayList(java.util.Collection)>
	//    7   13:astore_2        
		bucketPriorityList.clear();
	//    8   14:aload_0         
	//    9   15:getfield        #22  <Field List bucketPriorityList>
	//   10   18:invokeinterface #103 <Method void List.clear()>
		bucketPriorityList.addAll(((java.util.Collection) (list)));
	//   11   23:aload_0         
	//   12   24:getfield        #22  <Field List bucketPriorityList>
	//   13   27:aload_1         
	//   14   28:invokeinterface #107 <Method boolean List.addAll(java.util.Collection)>
	//   15   33:pop             
		obj = ((Object) (((List) (obj)).iterator()));
	//   16   34:aload_2         
