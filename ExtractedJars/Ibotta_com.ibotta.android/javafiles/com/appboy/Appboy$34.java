	...
	implements Runnable
{
	...
	//*  61  104:getfield        #90  <Field bo.app.dx Appboy.f>
	//*  62  107:invokestatic    #58  <Method java.util.Set Appboy.e()>
	//*  63  110:invokestatic    #96  <Method boolean ValidationUtils.isValidLogPurchaseInput(String, String, BigDecimal, int, bo.app.dx, java.util.Set)>
	//*  64  113:ifne            128
	//*  65  116:aload_2         
	//*  66  117:astore_1        
	...
	//  135  242:invokestatic    #137 <Method void Appboy.a(Appboy, Throwable)>
		...
		s = s1;
		obj = ((Object) (ci.a(s1, ((String) (obj)), c, d, e)));
		s = s1;
		if(!f.g.a(((bo.app.cc) (obj))))
			break MISSING_BLOCK_LABEL_245;
		s = s1;
		f.d.a(((bo.app.fr) (new fv(s1, e, ((bo.app.cc) (obj))))));
		return;
	//  136  245:return          
	}
	...
	Appboy$34(Appboy appboy, String s, String s1, BigDecimal bigdecimal, int i, AppboyProperties appboyproperties)
	{
		f = appboy;
	//    0    0:aload_0         
	//    1    1:aload_1         
