	...
	implements Runnable
{
	...
	//    8   12:getfield        #36  <Field bo.app.dx Appboy.f>
	//    9   15:invokestatic    #42  <Method boolean ValidationUtils.isValidLogCustomEventInput(String, bo.app.dx)>
	//   10   18:ifne            80
		s = s1;
	//   11   21:aload_2         
	//   12   22:astore_1        
	...
	//  105  185:invokestatic    #105 <Method void Appboy.a(Appboy, Throwable)>
		...
		s = s1;
		obj = ((Object) (ci.a(s1, b)));
		s = s1;
		if(!c.g.a(((bo.app.cc) (obj))))
			break MISSING_BLOCK_LABEL_188;
		s = s1;
		c.d.a(((bo.app.fr) (new fq(s1, b, ((bo.app.cc) (obj))))));
		return;
	//  106  188:return          
	}
	...
	Appboy$33(Appboy appboy, String s, AppboyProperties appboyproperties)
	{
		c = appboy;
	//    0    0:aload_0         
	//    1    1:aload_1         
