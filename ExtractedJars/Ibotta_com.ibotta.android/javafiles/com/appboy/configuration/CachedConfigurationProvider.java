...
public class CachedConfigurationProvider
{
	...
	//   10   20:putfield        #41  <Field Map mConfigurationCache>
		mRuntimeAppConfigurationProvider = new m(context);
	//   11   23:aload_0         
	//   12   24:new             #43  <Class m>
	//   13   27:dup             
	//   14   28:aload_1         
	//   15   29:invokespecial   #45  <Method void m(Context)>
	//   16   32:putfield        #47  <Field m mRuntimeAppConfigurationProvider>
	//   17   35:return          
	}
	...
	//*  12   30:aload_0         
	//*  13   31:getfield        #47  <Field m mRuntimeAppConfigurationProvider>
	//*  14   34:aload_1         
	//*  15   35:invokevirtual   #68  <Method boolean m.a(String)>
	//*  16   38:ifeq            121
		{
			flag = mRuntimeAppConfigurationProvider.a(s, flag);
	//   17   41:aload_0         
	//   18   42:getfield        #47  <Field m mRuntimeAppConfigurationProvider>
	//   19   45:aload_1         
	//   20   46:iload_2         
	//   21   47:invokevirtual   #70  <Method boolean m.a(String, boolean)>
	//   22   50:istore_2        
	...
	//   19   45:aload_1         
	//   20   46:iload_2         
	//   21   47:invokevirtual   #115 <Method int m.a(String, int)>
	//   22   50:istore_2        
	...
	protected Set getStringSetValue(String s, Set set)
	{
		if(mConfigurationCache.containsKey(((Object) (s))))
	//*   0    0:aload_0         
	//*   1    1:getfield        #41  <Field Map mConfigurationCache>
	...
	//*   3    5:invokeinterface #55  <Method boolean Map.containsKey(Object)>
	//*   4   10:ifeq            27
			return (Set)mConfigurationCache.get(((Object) (s)));
	//    5   13:aload_0         
	//    6   14:getfield        #41  <Field Map mConfigurationCache>
	//    7   17:aload_1         
	//    8   18:invokeinterface #59  <Method Object Map.get(Object)>
	//    9   23:checkcast       #128 <Class Set>
	//   10   26:areturn         
		if(mRuntimeAppConfigurationProvider.a(s))
	//*  11   27:aload_0         
	//*  12   28:getfield        #47  <Field m mRuntimeAppConfigurationProvider>
	//*  13   31:aload_1         
	//*  14   32:invokevirtual   #68  <Method boolean m.a(String)>
	//*  15   35:ifeq            115
		{
			set = mRuntimeAppConfigurationProvider.a(s, set);
	//   16   38:aload_0         
	//   17   39:getfield        #47  <Field m mRuntimeAppConfigurationProvider>
	//   18   42:aload_1         
	//   19   43:aload_2         
	//   20   44:invokevirtual   #130 <Method Set m.a(String, Set)>
	//   21   47:astore_2        
			mConfigurationCache.put(((Object) (s)), ((Object) (set)));
	//   22   48:aload_0         
	...
	//   46   96:aload           4
	//   47   98:aload_2         
	//   48   99:invokevirtual   #133 <Method StringBuilder StringBuilder.append(Object)>
	//   49  102:pop             
			AppboyLogger.d(s1, stringbuilder.toString());
	//   50  103:aload_3         
	//   51  104:aload           4
	...
	//   56  114:areturn         
		...
		String as[] = readStringArrayResourceValue(s, new String[0]);
	//   57  115:aload_0         
	//   58  116:aload_1         
	//   59  117:iconst_0        
	//   60  118:anewarray       String[]
	//   61  121:invokevirtual   #139 <Method String[] readStringArrayResourceValue(String, String[])>
	//   62  124:astore_3        
		if(as.length != 0)
	//*  63  125:aload_3         
	//*  64  126:arraylength     
	//*  65  127:ifne            133
	//*  66  130:goto            145
			set = ((Set) (new HashSet(((java.util.Collection) (Arrays.asList(((Object []) (as))))))));
	//   67  133:new             #141 <Class HashSet>
	//   68  136:dup             
	//   69  137:aload_3         
	//   70  138:invokestatic    #147 <Method java.util.List Arrays.asList(Object[])>
	//   71  141:invokespecial   #150 <Method void HashSet(java.util.Collection)>
	//   72  144:astore_2        
		mConfigurationCache.put(((Object) (s)), ((Object) (set)));
	//   73  145:aload_0         
	//   74  146:getfield        #41  <Field Map mConfigurationCache>
	//   75  149:aload_1         
	//   76  150:aload_2         
	//   77  151:invokeinterface #78  <Method Object Map.put(Object, Object)>
	//   78  156:pop             
		String s2 = a;
	//   79  157:getstatic       #23  <Field String a>
	//   80  160:astore_3        
		StringBuilder stringbuilder1 = new StringBuilder();
	//   81  161:new             #80  <Class StringBuilder>
	//   82  164:dup             
	//   83  165:invokespecial   #81  <Method void StringBuilder()>
	//   84  168:astore          4
		stringbuilder1.append("Defaulting to using xml value for key: ");
	//   85  170:aload           4
	//   86  172:ldc1            #105 <String "Defaulting to using xml value for key: ">
	//   87  174:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   88  177:pop             
		stringbuilder1.append(s);
	//   89  178:aload           4
	//   90  180:aload_1         
	//   91  181:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   92  184:pop             
		stringbuilder1.append(" and value: ");
	//   93  185:aload           4
	//   94  187:ldc1            #89  <String " and value: ">
	//   95  189:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   96  192:pop             
		stringbuilder1.append(((Object) (set)));
	//   97  193:aload           4
	//   98  195:aload_2         
	//   99  196:invokevirtual   #133 <Method StringBuilder StringBuilder.append(Object)>
	//  100  199:pop             
		AppboyLogger.d(s2, stringbuilder1.toString());
	//  101  200:aload_3         
	//  102  201:aload           4
	//  103  203:invokevirtual   #96  <Method String StringBuilder.toString()>
	//  104  206:invokestatic    #100 <Method int AppboyLogger.d(String, String)>
	//  105  209:pop             
		return set;
	//  106  210:aload_2         
	//  107  211:areturn         
	...
	//    7   17:aload_1         
	//    8   18:invokeinterface #59  <Method Object Map.get(Object)>
	//    9   23:checkcast       #135 <Class String>
	//   10   26:areturn         
		if(mRuntimeAppConfigurationProvider.a(s))
	//*  11   27:aload_0         
	//*  12   28:getfield        #47  <Field m mRuntimeAppConfigurationProvider>
	...
	//   18   42:aload_1         
	//   19   43:aload_2         
	//   20   44:invokevirtual   #156 <Method String m.a(String, String)>
	//   21   47:astore_2        
	...
	//   58  116:aload_1         
	//   59  117:aload_2         
	//   60  118:invokevirtual   #159 <Method String readStringResourceValue(String, String)>
	//   61  121:astore_2        
			mConfigurationCache.put(((Object) (s)), ((Object) (s1)));
	//   62  122:aload_0         
	...
	//    6   10:invokevirtual   #167 <Method Resources Context.getResources()>
	//    7   13:aload_1         
	//    8   14:ldc1            #169 <String "bool">
	//    9   16:aload_0         
	//   10   17:getfield        #30  <Field Context b>
	//   11   20:invokestatic    #175 <Method String PackageUtils.getResourcePackageName(Context)>
	//   12   23:invokevirtual   #181 <Method int Resources.getIdentifier(String, String, String)>
	//   13   26:istore_3        
		}
	//*  14   27:iload_3         
	//*  15   28:ifne            96
	...
	//*  21   43:astore          6
	//*  22   45:aload           6
	//*  23   47:ldc1            #183 <String "Unable to find the xml boolean configuration value with key ">
	...
	//*  29   59:pop             
	//*  30   60:aload           6
	//*  31   62:ldc1            #185 <String ". Using default value '">
	...
	//*  51  100:invokevirtual   #167 <Method Resources Context.getResources()>
	//*  52  103:iload_3         
	//*  53  104:invokevirtual   #191 <Method boolean Resources.getBoolean(int)>
	//*  54  107:istore          4
	//*  55  109:iload           4
	//*  56  111:ireturn         
	...
	//*  62  124:astore          6
	//*  63  126:aload           6
	//*  64  128:ldc1            #193 <String "Unexpected exception retrieving the xml boolean configuration value with key ">
	...
	//*  70  140:pop             
	//*  71  141:aload           6
	//*  72  143:ldc1            #195 <String ". Using default value ">
	...
	//    3    5:ireturn         
		...
		try
		{
			j = b.getResources().getIdentifier(s, "integer", PackageUtils.getResourcePackageName(b));
	//    4    6:aload_0         
	//    5    7:getfield        #30  <Field Context b>
	//    6   10:invokevirtual   #167 <Method Resources Context.getResources()>
	//    7   13:aload_1         
	//    8   14:ldc1            #197 <String "integer">
	//    9   16:aload_0         
	//   10   17:getfield        #30  <Field Context b>
	//   11   20:invokestatic    #175 <Method String PackageUtils.getResourcePackageName(Context)>
	//   12   23:invokevirtual   #181 <Method int Resources.getIdentifier(String, String, String)>
	...
	//*  21   43:astore          5
	//*  22   45:aload           5
	//*  23   47:ldc1            #199 <String "Unable to find the xml integer configuration value with key ">
	//*  24   49:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//*  25   52:pop             
	//*  26   53:aload           5
	//*  27   55:aload_1         
	...
	//*  51  100:invokevirtual   #167 <Method Resources Context.getResources()>
	//*  52  103:iload_3         
	//*  53  104:invokevirtual   #203 <Method int Resources.getInteger(int)>
	//*  54  107:istore_3        
	//*  55  108:iload_3         
	//*  56  109:ireturn         
	...
	//*  62  122:astore          5
	//*  63  124:aload           5
	//*  64  126:ldc1            #205 <String "Unexpected exception retrieving the xml integer configuration value with key ">
	...
	//*  70  138:pop             
	//*  71  139:aload           5
	//*  72  141:ldc1            #195 <String ". Using default value ">
	...
	//*  21   43:astore          5
	//*  22   45:aload           5
	//*  23   47:ldc1            #209 <String "Unable to find the xml string array configuration value with key ">
	//*  24   49:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//*  25   52:pop             
	//*  26   53:aload           5
	//*  27   55:aload_1         
	...
	//*  34   68:aload           5
	//*  35   70:aload_2         
	//*  36   71:invokestatic    #212 <Method String Arrays.toString(Object[])>
	//*  37   74:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//*  38   77:pop             
	//*  39   78:aload           5
	//*  40   80:ldc1            #187 <String "'.">
	...
	//*  52  103:invokevirtual   #167 <Method Resources Context.getResources()>
	//*  53  106:iload_3         
	//*  54  107:invokevirtual   #216 <Method String[] Resources.getStringArray(int)>
	//*  55  110:astore          4
	//*  56  112:aload           4
	//*  57  114:areturn         
	...
	//*  63  127:astore          5
	//*  64  129:aload           5
	//*  65  131:ldc1            #218 <String "Unexpected exception retrieving the xml string array configuration value with key ">
	...
	//*  21   43:astore          5
	//*  22   45:aload           5
	//*  23   47:ldc1            #222 <String "Unable to find the xml string configuration value with key ">
	//*  24   49:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//*  25   52:pop             
	//*  26   53:aload           5
	//*  27   55:aload_1         
	...
	//*  51  100:invokevirtual   #167 <Method Resources Context.getResources()>
	//*  52  103:iload_3         
	//*  53  104:invokevirtual   #226 <Method String Resources.getString(int)>
	//*  54  107:astore          4
	//*  55  109:aload           4
	//*  56  111:areturn         
	//*  57  112:getstatic       #23  <Field String a>
	...
	//*  62  124:astore          5
	//*  63  126:aload           5
	//*  64  128:ldc1            #228 <String "Unexpected exception retrieving the xml string configuration value with key ">
	//*  65  130:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//*  66  133:pop             
	//*  67  134:aload           5
	//*  68  136:aload_1         
