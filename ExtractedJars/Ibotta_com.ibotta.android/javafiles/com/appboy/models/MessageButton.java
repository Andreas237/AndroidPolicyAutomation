	...
	implements IPutIntoJson
{
	...
	{
		this(jsonobject, jsonobject.optInt("id", -1), (ClickAction)ek.a(jsonobject, "click_action", com/appboy/enums/inappmessage/ClickAction, ((Enum) (ClickAction.NEWS_FEED))), jsonobject.optString("uri"), jsonobject.optString("text"), jsonobject.optInt("bg_color"), jsonobject.optInt("text_color"), jsonobject.optBoolean("use_webview", false));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_1         
	...
	//   10   17:invokestatic    #68  <Method Enum ek.a(JSONObject, String, Class, Enum)>
