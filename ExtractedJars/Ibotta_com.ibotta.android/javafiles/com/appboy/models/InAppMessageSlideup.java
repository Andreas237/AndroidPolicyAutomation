...
public class InAppMessageSlideup extends InAppMessageBase
{
	...
	public InAppMessageSlideup(JSONObject jsonobject, bt bt)
	{
		this(jsonobject, bt, (SlideFrom)ek.a(jsonobject, "slide_from", com/appboy/enums/inappmessage/SlideFrom, ((Enum) (SlideFrom.BOTTOM))), jsonobject.optInt("close_btn_color"));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:aload_1         
	...
	//    7   11:invokestatic    #38  <Method Enum ek.a(JSONObject, String, Class, Enum)>
	...
	//   12   23:invokespecial   #49  <Method void InAppMessageSlideup(JSONObject, bt, SlideFrom, int)>
	//   13   26:return          
	}

	private InAppMessageSlideup(JSONObject jsonobject, bt bt, SlideFrom slidefrom, int i)
	{
		super(jsonobject, bt);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #51  <Method void InAppMessageBase(JSONObject, bt)>
		j = SlideFrom.BOTTOM;
	//    4    6:aload_0         
	...
	//   24   47:invokestatic    #38  <Method Enum ek.a(JSONObject, String, Class, Enum)>
	//   25   50:checkcast       #57  <Class CropType>
	//   26   53:putfield        #64  <Field CropType e>
		f = (TextAlign)ek.a(jsonobject, "text_align_message", com/appboy/enums/inappmessage/TextAlign, ((Enum) (TextAlign.START)));
	//   27   56:aload_0         
	//   28   57:aload_1         
	//   29   58:ldc1            #66  <String "text_align_message">
	//   30   60:ldc1            #21  <Class TextAlign>
	//   31   62:getstatic       #25  <Field TextAlign TextAlign.START>
	//   32   65:invokestatic    #38  <Method Enum ek.a(JSONObject, String, Class, Enum)>
