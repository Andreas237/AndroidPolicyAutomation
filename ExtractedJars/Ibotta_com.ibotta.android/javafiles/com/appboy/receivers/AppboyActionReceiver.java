...
public class AppboyActionReceiver extends BroadcastReceiver
{
		...
		implements Runnable
	{
		...
		//*  35   60:icmpne          105
			{
				for(geofencingevent = ((GeofencingEvent) (((List) (geofencingevent)).iterator())); ((Iterator) (geofencingevent)).hasNext(); AppboyInternal.recordGeofenceTransition(context, ((Geofence)((Iterator) (geofencingevent)).next()).getRequestId(), x.a));
		//   36   63:aload_1         
		...
		//   47   94:getstatic       #105 <Field x x.a>
		//   48   97:invokestatic    #111 <Method void AppboyInternal.recordGeofenceTransition(Context, String, x)>
		//*  49  100:goto            70
				return true;
		//   50  103:iconst_1        
		//   51  104:ireturn         
		...
		//*  54  107:icmpne          152
			{
				for(geofencingevent = ((GeofencingEvent) (((List) (geofencingevent)).iterator())); ((Iterator) (geofencingevent)).hasNext(); AppboyInternal.recordGeofenceTransition(context, ((Geofence)((Iterator) (geofencingevent)).next()).getRequestId(), x.b));
		//   55  110:aload_1         
		...
		//   66  141:getstatic       #113 <Field x x.b>
		//   67  144:invokestatic    #111 <Method void AppboyInternal.recordGeofenceTransition(Context, String, x)>
		//*  68  147:goto            117
				return true;
		//   69  150:iconst_1        
		//   70  151:ireturn         
		...
		//    2    4:astore_1        
				AppboyInternal.requestGeofenceRefresh(context, ((bo.app.cd) (new cj(((Location) (locationresult)).getLatitude(), ((Location) (locationresult)).getLongitude(), Double.valueOf(((Location) (locationresult)).getAltitude()), Double.valueOf(((Location) (locationresult)).getAccuracy())))));
		//    3    5:aload_0         
		//    4    6:new             #130 <Class cj>
		//    5    9:dup             
		//    6   10:aload_1         
		...
		//   17   33:invokespecial   #155 <Method void cj(double, double, Double, Double)>
		//   18   36:invokestatic    #159 <Method void AppboyInternal.requestGeofenceRefresh(Context, bo.app.cd)>
			}
		//*  19   39:iconst_1        
		//*  20   40:ireturn         
		...
		//    5   12:invokestatic    #168 <Method int AppboyLogger.d(String, String)>
		//    6   15:pop             
				return false;
		//    7   16:iconst_0        
		//    8   17:ireturn         
		...
		//   15   30:aload_2         
		//   16   31:ldc1            #170 <String "Received intent with action ">
		...
		//   27   51:invokestatic    #168 <Method int AppboyLogger.d(String, String)>
		//   28   54:pop             
			if(a.equals("com.appboy.action.receiver.DATA_SYNC"))
		//*  29   55:aload_0         
		//*  30   56:getfield        #35  <Field String a>
		//*  31   59:ldc1            #172 <String "com.appboy.action.receiver.DATA_SYNC">
		//*  32   61:invokevirtual   #178 <Method boolean String.equals(Object)>
		//*  33   64:ifeq            89
			{
		...
		//   35   70:ldc1            #180 <String "Requesting immediate data flush from AppboyActionReceiver.">
		//   36   72:iconst_0        
		//   37   73:invokestatic    #183 <Method int AppboyLogger.d(String, String, boolean)>
		//   38   76:pop             
				Appboy.getInstance(b).requestImmediateDataFlush();
		//   39   77:aload_0         
		//   40   78:getfield        #25  <Field Context b>
		//   41   81:invokestatic    #189 <Method Appboy Appboy.getInstance(Context)>
		//   42   84:invokevirtual   #192 <Method void Appboy.requestImmediateDataFlush()>
				return true;
		//   43   87:iconst_1        
		//   44   88:ireturn         
			}
		...
		//*  47   93:ldc1            #194 <String "com.appboy.action.receiver.APPBOY_GEOFENCE_LOCATION_UPDATE">
		//*  48   95:invokevirtual   #178 <Method boolean String.equals(Object)>
		//*  49   98:ifeq            202
				if(LocationResult.hasResult(d))
		//*  50  101:aload_0         
		//*  51  102:getfield        #27  <Field Intent d>
		//*  52  105:invokestatic    #198 <Method boolean LocationResult.hasResult(Intent)>
		//*  53  108:ifeq            163
				{
		...
		//   60  123:aload_2         
		//   61  124:ldc1            #200 <String "AppboyActionReceiver received intent with location result: ">
		...
		//   72  144:invokestatic    #168 <Method int AppboyLogger.d(String, String)>
		//   73  147:pop             
		...
		//   78  156:invokestatic    #204 <Method LocationResult LocationResult.extractResult(Intent)>
		//   79  159:invokestatic    #206 <Method boolean a(Context, LocationResult)>
		//   80  162:ireturn         
				} else
				{
		...
		//   87  175:aload_2         
		//   88  176:ldc1            #208 <String "AppboyActionReceiver received intent without location result: ">
		...
		//* 105  206:ldc1            #210 <String "com.appboy.action.receiver.APPBOY_GEOFENCE_UPDATE">
		//* 106  208:invokevirtual   #178 <Method boolean String.equals(Object)>
		//* 107  211:ifeq            266
			{
		...
		//  114  226:aload_2         
		//  115  227:ldc1            #212 <String "AppboyActionReceiver received intent with geofence transition: ">
		...
		//  126  247:invokestatic    #168 <Method int AppboyLogger.d(String, String)>
		//  127  250:pop             
		...
		//  132  259:invokestatic    #216 <Method GeofencingEvent GeofencingEvent.fromIntent(Intent)>
		//  133  262:invokestatic    #218 <Method boolean a(Context, GeofencingEvent)>
		//  134  265:ireturn         
			} else
			{
		...
		//  141  278:aload_2         
		//  142  279:ldc1            #220 <String "Unknown intent received in AppboyActionReceiver with action: ">
		...
		public void run()
		{
			try
			{
				a();
		//    0    0:aload_0         
		//    1    1:invokevirtual   #223 <Method boolean a()>
		//    2    4:pop             
			}
		//*   3    5:goto            63
		...
		//   11   21:aload_3         
		//   12   22:ldc1            #225 <String "Caught exception while performing the AppboyActionReceiver work. Action: ">
		...
		//   27   49:invokevirtual   #230 <Method StringBuilder StringBuilder.append(Object)>
		//   28   52:pop             
		...
		//   37   67:invokevirtual   #235 <Method void android.content.BroadcastReceiver$PendingResult.finish()>
		//   38   70:return          
		}

		private final String a;
		private final Context b;
		private final android.content.BroadcastReceiver.PendingResult c;
	...
	//    3    7:ldc1            #27  <String "AppboyActionReceiver received null intent. Doing nothing.">
	//    4    9:invokestatic    #31  <Method int AppboyLogger.w(String, String)>
	//    5   12:pop             
			return;
	//    6   13:return          
		} else
		{
			(new Thread(((Runnable) (new a(context.getApplicationContext(), intent, goAsync()))))).start();
	//    7   14:new             #33  <Class Thread>
	//    8   17:dup             
	//    9   18:new             #6   <Class AppboyActionReceiver$a>
	//   10   21:dup             
	//   11   22:aload_1         
	//   12   23:invokevirtual   #39  <Method Context Context.getApplicationContext()>
	//   13   26:aload_2         
	//   14   27:aload_0         
	//   15   28:invokevirtual   #43  <Method android.content.BroadcastReceiver$PendingResult goAsync()>
	//   16   31:invokespecial   #46  <Method void AppboyActionReceiver$a(Context, Intent, android.content.BroadcastReceiver$PendingResult)>
	//   17   34:invokespecial   #49  <Method void Thread(Runnable)>
	//   18   37:invokevirtual   #52  <Method void Thread.start()>
			return;
	//   19   40:return          
		}
	}

	private static final String a = AppboyLogger.getAppboyLogTag(com/appboy/receivers/AppboyActionReceiver);

	static 
	{
	//    0    0:ldc1            #2   <Class AppboyActionReceiver>
