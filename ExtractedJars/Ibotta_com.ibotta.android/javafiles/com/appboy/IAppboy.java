...
public interface IAppboy
{
	...
	public abstract int getContentCardCount();

	public abstract int getContentCardUnviewedCount();

	public abstract long getContentCardsLastUpdatedInSecondsFromEpoch();

	public abstract AppboyUser getCurrentUser();

	public abstract String getInstallTrackingId();

	public abstract void logContentCardsDisplayed();
	...
	public abstract void requestContentCardsRefresh(boolean flag);
	...
	public abstract void subscribeToContentCardsUpdates(IEventSubscriber ieventsubscriber);
