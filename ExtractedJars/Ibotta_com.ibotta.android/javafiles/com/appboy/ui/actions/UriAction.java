...
label0:
	...
	//   65  132:invokestatic    #129 <Method int AppboyLogger.d(String, String)>
	//   66  135:pop             
	...
	//   71  144:invokevirtual   #133 <Method Intent Intent.setPackage(String)>
	//   72  147:pop             
		}
		return intent;
	//   73  148:aload_3         
	...
	//    0    0:new             #137 <Class AppboyConfigurationProvider>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #140 <Method void AppboyConfigurationProvider(Context)>
	//    4    8:astore_3        
		TaskStackBuilder taskstackbuilder = TaskStackBuilder.create(context);
	//    5    9:aload_0         
	//    6   10:invokestatic    #146 <Method TaskStackBuilder TaskStackBuilder.create(Context)>
	//    7   13:astore_2        
		if(((AppboyConfigurationProvider) (obj)).getIsPushDeepLinkBackStackActivityEnabled())
	//*   8   14:aload_3         
	//*   9   15:invokevirtual   #149 <Method boolean AppboyConfigurationProvider.getIsPushDeepLinkBackStackActivityEnabled()>
	//*  10   18:ifeq            155
		{
			obj = ((Object) (((AppboyConfigurationProvider) (obj)).getPushDeepLinkBackStackActivityClassName()));
	//   11   21:aload_3         
	//   12   22:invokevirtual   #152 <Method String AppboyConfigurationProvider.getPushDeepLinkBackStackActivityClassName()>
	//   13   25:astore_3        
			if(StringUtils.isNullOrBlank(((String) (obj))))
	//*  14   26:aload_3         
	//*  15   27:invokestatic    #158 <Method boolean StringUtils.isNullOrBlank(String)>
	//*  16   30:ifeq            54
			{
	...
	//   18   36:ldc1            #160 <String "Adding main activity intent to back stack while opening uri from push">
	//   19   38:invokestatic    #163 <Method int AppboyLogger.i(String, String)>
	//   20   41:pop             
				taskstackbuilder.addNextIntent(UriUtils.getMainActivityIntent(context, bundle));
	//   21   42:aload_2         
	//   22   43:aload_0         
	//   23   44:aload_1         
	//   24   45:invokestatic    #169 <Method Intent UriUtils.getMainActivityIntent(Context, Bundle)>
	//   25   48:invokevirtual   #173 <Method TaskStackBuilder TaskStackBuilder.addNextIntent(Intent)>
	//   26   51:pop             
	...
	//*  29   54:aload_0         
	//*  30   55:aload_3         
	//*  31   56:invokestatic    #177 <Method boolean UriUtils.isActivityRegisteredInManifest(Context, String)>
	//*  32   59:ifeq            119
			{
				bundle = ((Bundle) (TAG));
	...
	//   39   75:aload           4
	//   40   77:ldc1            #179 <String "Adding custom back stack activity while opening uri from push: ">
	...
	//   50   96:invokestatic    #163 <Method int AppboyLogger.i(String, String)>
	//   51   99:pop             
				taskstackbuilder.addNextIntent((new Intent()).setClassName(context, ((String) (obj))));
	//   52  100:aload_2         
	//   53  101:new             #45  <Class Intent>
	//   54  104:dup             
	//   55  105:invokespecial   #180 <Method void Intent()>
	//   56  108:aload_0         
	//   57  109:aload_3         
	//   58  110:invokevirtual   #184 <Method Intent Intent.setClassName(Context, String)>
	//   59  113:invokevirtual   #173 <Method TaskStackBuilder TaskStackBuilder.addNextIntent(Intent)>
	//   60  116:pop             
				return taskstackbuilder;
	//   61  117:aload_2         
	//   62  118:areturn         
	...
	//   69  131:aload_1         
	//   70  132:ldc1            #186 <String "Not adding unregistered activity to the back stack while opening uri from push: ">
	...
	//   80  149:invokestatic    #163 <Method int AppboyLogger.i(String, String)>
	//   81  152:pop             
				return taskstackbuilder;
	//   82  153:aload_2         
	//   83  154:areturn         
	...
	//   85  158:ldc1            #188 <String "Not adding back stack activity while opening uri from push due to disabled configuration setting.">
	//   86  160:invokestatic    #163 <Method int AppboyLogger.i(String, String)>
	//   87  163:pop             
			return taskstackbuilder;
	//   88  164:aload_2         
	//   89  165:areturn         
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:ldc1            #191 <Class AppboyWebViewActivity>
	//    4    7:invokespecial   #194 <Method void Intent(Context, Class)>
	//    5   10:astore_0        
		if(bundle != null)
	//*   6   11:aload_2         
	//*   7   12:ifnull          21
	...
	//   12   21:aload_0         
	//   13   22:ldc1            #196 <String "url">
	//   14   24:aload_1         
	//   15   25:invokevirtual   #199 <Method String Uri.toString()>
	//   16   28:invokevirtual   #203 <Method Intent Intent.putExtra(String, String)>
	//   17   31:pop             
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokestatic    #207 <Method Intent getActionViewIntent(Context, Uri, Bundle)>
	//    4    6:astore_2        
		((Intent) (bundle)).setFlags(0x34000000);
	//    5    7:aload_2         
	//    6    8:ldc1            #208 <Int 0x34000000>
	//    7   10:invokevirtual   #212 <Method Intent Intent.setFlags(int)>
	//    8   13:pop             
	...
	//*  12   19:invokevirtual   #216 <Method android.content.ComponentName Intent.resolveActivity(PackageManager)>
	//*  13   22:ifnull          31
		{
			context.startActivity(((Intent) (bundle)));
	//   14   25:aload_0         
	//   15   26:aload_2         
	//   16   27:invokevirtual   #220 <Method void Context.startActivity(Intent)>
			return;
	//   17   30:return          
		} else
		{
	...
	//   24   43:aload_2         
	//   25   44:ldc1            #222 <String "Could not find appropriate activity to open for deep link ">
	//   26   46:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   27   49:pop             
			((StringBuilder) (bundle)).append(((Object) (uri)));
	//   28   50:aload_2         
	//   29   51:aload_1         
	//   30   52:invokevirtual   #225 <Method StringBuilder StringBuilder.append(Object)>
	//   31   55:pop             
			((StringBuilder) (bundle)).append(".");
	//   32   56:aload_2         
	...
	//   39   68:invokestatic    #228 <Method int AppboyLogger.w(String, String)>
	//   40   71:pop             
			return;
	//   41   72:return          
		}
	...
	//    0    0:aload_0         
	//    1    1:aload_2         
	//    2    2:invokestatic    #233 <Method TaskStackBuilder getConfiguredTaskBackStackBuilder(Context, Bundle)>
	//    3    5:astore_3        
	...
	//    6    8:aload_1         
	//    7    9:aload_2         
	//    8   10:invokestatic    #207 <Method Intent getActionViewIntent(Context, Uri, Bundle)>
	//    9   13:invokevirtual   #173 <Method TaskStackBuilder TaskStackBuilder.addNextIntent(Intent)>
	//   10   16:pop             
		try
		{
	...
	//   11   17:aload_3         
	//   12   18:aload_2         
	//   13   19:invokevirtual   #237 <Method void TaskStackBuilder.startActivities(Bundle)>
			return;
	//   14   22:return          
		}
	...
	//   22   36:aload_3         
	//   23   37:ldc1            #222 <String "Could not find appropriate activity to open for deep link ">
	//   24   39:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   25   42:pop             
		((StringBuilder) (obj)).append(((Object) (uri)));
	//   26   43:aload_3         
	//   27   44:aload_1         
	//   28   45:invokevirtual   #225 <Method StringBuilder StringBuilder.append(Object)>
	//   29   48:pop             
		AppboyLogger.w(((String) (bundle)), ((StringBuilder) (obj)).toString(), ((Throwable) (context)));
	//   30   49:aload_2         
	//   31   50:aload_3         
	//   32   51:invokevirtual   #125 <Method String StringBuilder.toString()>
	//   33   54:aload_0         
	//   34   55:invokestatic    #240 <Method int AppboyLogger.w(String, String, Throwable)>
	//   35   58:pop             
	//   36   59:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokestatic    #245 <Method Intent getWebViewActivityIntent(Context, Uri, Bundle)>
	//    4    6:astore_1        
	...
	//    9   14:aload_0         
	//   10   15:aload_1         
	//   11   16:invokevirtual   #220 <Method void Context.startActivity(Intent)>
			return;
	//   12   19:return          
		}
		// Misplaced declaration of an exception variable
	...
	//   15   24:ldc1            #247 <String "Appboy AppboyWebViewActivity not opened successfully.">
	//   16   26:aload_0         
	//   17   27:invokestatic    #250 <Method int AppboyLogger.e(String, String, Throwable)>
	//   18   30:pop             
		}
	//   19   31:return          
	}
	...
	//    6    8:aload_1         
	//    7    9:aload_2         
	//    8   10:invokestatic    #245 <Method Intent getWebViewActivityIntent(Context, Uri, Bundle)>
	//    9   13:invokevirtual   #173 <Method TaskStackBuilder TaskStackBuilder.addNextIntent(Intent)>
	//   10   16:pop             
		try
		{
	...
	//*  15   23:astore_0        
		{
			AppboyLogger.e(TAG, "Appboy AppboyWebViewActivity not opened successfully.", ((Throwable) (context)));
	//   16   24:getstatic       #26  <Field String TAG>
	//   17   27:ldc1            #247 <String "Appboy AppboyWebViewActivity not opened successfully.">
	//   18   29:aload_0         
	//   19   30:invokestatic    #250 <Method int AppboyLogger.e(String, String, Throwable)>
	//   20   33:pop             
		}
	//   21   34:return          
	}
	...
	//*   2    4:invokestatic    #258 <Method boolean AppboyFileUtils.isLocalUri(Uri)>
	//*   3    7:ifeq            49
		{
			context = ((Context) (TAG));
	...
	//   10   22:aload_2         
	//   11   23:ldc2            #260 <String "Not executing local Uri: ">
	...
	//   17   35:invokevirtual   #225 <Method StringBuilder StringBuilder.append(Object)>
	//   18   38:pop             
			AppboyLogger.d(((String) (context)), stringbuilder.toString());
	//   19   39:aload_1         
	//   20   40:aload_2         
	//   21   41:invokevirtual   #125 <Method String StringBuilder.toString()>
	//   22   44:invokestatic    #129 <Method int AppboyLogger.d(String, String)>
	//   23   47:pop             
			return;
	//   24   48:return          
		}
	...
	//   31   61:aload_3         
	//   32   62:ldc2            #262 <String "Executing Uri action from channel ">
	...
	//   38   74:invokevirtual   #225 <Method StringBuilder StringBuilder.append(Object)>
	//   39   77:pop             
		stringbuilder1.append(": ");
	//   40   78:aload_3         
	//   41   79:ldc2            #264 <String ": ">
	...
	//   47   91:invokevirtual   #225 <Method StringBuilder StringBuilder.append(Object)>
	//   48   94:pop             
		stringbuilder1.append(". UseWebView: ");
	//   49   95:aload_3         
	//   50   96:ldc2            #266 <String ". UseWebView: ">
	...
	//   56  108:invokevirtual   #269 <Method StringBuilder StringBuilder.append(boolean)>
	//   57  111:pop             
		stringbuilder1.append(". Extras: ");
	//   58  112:aload_3         
	//   59  113:ldc2            #271 <String ". Extras: ">
	...
	//   65  125:invokevirtual   #225 <Method StringBuilder StringBuilder.append(Object)>
	//   66  128:pop             
		AppboyLogger.d(s, stringbuilder1.toString());
	//   67  129:aload_2         
	//   68  130:aload_3         
	//   69  131:invokevirtual   #125 <Method String StringBuilder.toString()>
	//   70  134:invokestatic    #129 <Method int AppboyLogger.d(String, String)>
	//   71  137:pop             
		if(mUseWebView && AppboyFileUtils.REMOTE_SCHEMES.contains(((Object) (mUri.getScheme()))))
	//*  72  138:aload_0         
	//*  73  139:getfield        #38  <Field boolean mUseWebView>
	//*  74  142:ifeq            202
	//*  75  145:getstatic       #275 <Field List AppboyFileUtils.REMOTE_SCHEMES>
	//*  76  148:aload_0         
	//*  77  149:getfield        #34  <Field Uri mUri>
	//*  78  152:invokevirtual   #278 <Method String Uri.getScheme()>
	//*  79  155:invokeinterface #281 <Method boolean List.contains(Object)>
	//*  80  160:ifeq            202
			if(mChannel.equals(((Object) (Channel.PUSH))))
	//*  81  163:aload_0         
	//*  82  164:getfield        #40  <Field Channel mChannel>
	//*  83  167:getstatic       #286 <Field Channel Channel.PUSH>
	//*  84  170:invokevirtual   #287 <Method boolean Channel.equals(Object)>
	//*  85  173:ifeq            189
			{
	...
	//   91  185:invokestatic    #289 <Method void openUriWithWebViewActivityFromPush(Context, Uri, Bundle)>
				return;
	//   92  188:return          
			} else
			{
	...
	//   98  198:invokestatic    #291 <Method void openUriWithWebViewActivity(Context, Uri, Bundle)>
				return;
	//   99  201:return          
			}
		if(mChannel.equals(((Object) (Channel.PUSH))))
	...
	//* 102  206:getstatic       #286 <Field Channel Channel.PUSH>
	//* 103  209:invokevirtual   #287 <Method boolean Channel.equals(Object)>
	//* 104  212:ifeq            228
		{
	...
	//  110  224:invokestatic    #293 <Method void openUriWithActionViewFromPush(Context, Uri, Bundle)>
			return;
	//  111  227:return          
		} else
		{
	...
	//  117  237:invokestatic    #295 <Method void openUriWithActionView(Context, Uri, Bundle)>
			return;
	//  118  240:return          
		}
	}
