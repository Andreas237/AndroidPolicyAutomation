	...
	implements IContentCardsUpdateHandler
{
	...
	public List handleCardUpdate(ContentCardsUpdatedEvent contentcardsupdatedevent)
	{
		contentcardsupdatedevent = ((ContentCardsUpdatedEvent) (contentcardsupdatedevent.getAllCards()));
	//    0    0:aload_1         
	//    1    1:invokevirtual   #21  <Method List ContentCardsUpdatedEvent.getAllCards()>
	//    2    4:astore_1        
		Collections.sort(((List) (contentcardsupdatedevent)), new Comparator() {
	...
	//    3    5:aload_1         
	//    4    6:new             #8   <Class DefaultContentCardsUpdateHandler$1>
	//    5    9:dup             
	//    6   10:aload_0         
	//    7   11:invokespecial   #24  <Method void DefaultContentCardsUpdateHandler$1(DefaultContentCardsUpdateHandler)>
	//    8   14:invokestatic    #30  <Method void Collections.sort(List, Comparator)>
		return ((List) (contentcardsupdatedevent));
	//    9   17:aload_1         
	//   10   18:areturn         
	}
}
