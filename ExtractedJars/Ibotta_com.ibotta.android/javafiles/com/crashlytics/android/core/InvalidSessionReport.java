	...
	implements Report
{
	...
	//   17   25:new             #66  <Class StringBuilder>
	//   18   28:dup             
	//   19   29:invokespecial   #67  <Method void StringBuilder()>
	//   20   32:astore          6
			stringbuilder.append("Removing invalid report file at ");
	//   21   34:aload           6
	//   22   36:ldc1            #69  <String "Removing invalid report file at ">
	//   23   38:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   24   41:pop             
			stringbuilder.append(file.getPath());
	//   25   42:aload           6
	//   26   44:aload           4
	//   27   46:invokevirtual   #76  <Method String File.getPath()>
	//   28   49:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   29   52:pop             
			logger.d("CrashlyticsCore", stringbuilder.toString());
	//   30   53:aload           5
	//   31   55:ldc1            #78  <String "CrashlyticsCore">
	//   32   57:aload           6
	//   33   59:invokevirtual   #81  <Method String StringBuilder.toString()>
	//   34   62:invokeinterface #87  <Method void Logger.d(String, String)>
			file.delete();
	//   35   67:aload           4
	//   36   69:invokevirtual   #91  <Method boolean File.delete()>
	//   37   72:pop             
		}
