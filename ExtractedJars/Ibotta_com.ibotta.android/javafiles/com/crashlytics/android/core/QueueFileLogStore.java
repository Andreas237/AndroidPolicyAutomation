	...
	implements FileLogStore
{
	...
	//   22   35:aload_2         
	//   23   36:invokevirtual   #102 <Method int QueueFile.usedBytes()>
	//   24   39:newarray        byte[]
	//   25   41:astore_2        
		try
		{
	...
	//   26   42:aload_0         
	//   27   43:getfield        #30  <Field QueueFile logFile>
	//   28   46:new             #8   <Class QueueFileLogStore$1>
	//   29   49:dup             
	//   30   50:aload_0         
	//   31   51:aload_2         
	//   32   52:aload_1         
	//   33   53:invokespecial   #157 <Method void QueueFileLogStore$1(QueueFileLogStore, byte[], int[])>
	//   34   56:invokevirtual   #161 <Method void QueueFile.forEach(io.fabric.sdk.android.services.common.QueueFile$ElementReader)>
		}
	//*  35   59:goto            76
		catch(IOException ioexception)
	//*  36   62:astore_3        
	...
	//   37   63:invokestatic    #111 <Method Logger Fabric.getLogger()>
	//   38   66:ldc1            #113 <String "CrashlyticsCore">
	//   39   68:ldc1            #163 <String "A problem occurred while reading the Crashlytics log file.">
	//   40   70:aload_3         
	//   41   71:invokeinterface #121 <Method void Logger.e(String, String, Throwable)>
		}
	...
	//   45   79:iconst_0        
	//   46   80:iaload          
	//   47   81:invokestatic    #169 <Method ByteString ByteString.copyFrom(byte[], int, int)>
	//   48   84:areturn         
	}
