...
final class SessionEvent
{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #35  <Field SessionEventMetadata sessionEventMetadata>
		timestamp = l;
	//    5    9:aload_0         
	//    6   10:lload_2         
	//    7   11:putfield        #37  <Field long timestamp>
		type = type1;
	//    8   14:aload_0         
	//    9   15:aload           4
	//   10   17:putfield        #39  <Field SessionEvent$Type type>
		details = map;
	//   11   20:aload_0         
	//   12   21:aload           5
	//   13   23:putfield        #41  <Field Map details>
		customType = s;
	//   14   26:aload_0         
	//   15   27:aload           6
	//   16   29:putfield        #43  <Field String customType>
		customAttributes = map1;
	//   17   32:aload_0         
	//   18   33:aload           7
	//   19   35:putfield        #45  <Field Map customAttributes>
		predefinedType = s1;
	//   20   38:aload_0         
	//   21   39:aload           8
	//   22   41:putfield        #47  <Field String predefinedType>
		predefinedAttributes = map2;
	//   23   44:aload_0         
	//   24   45:aload           9
	//   25   47:putfield        #49  <Field Map predefinedAttributes>
	//   26   50:return          
	}
	...
	//    7   11:aload           8
	//    8   13:aload           9
	//    9   15:invokespecial   #55  <Method void SessionEvent(SessionEventMetadata, long, SessionEvent$Type, Map, String, Map, String, Map)>
	//   10   18:return          
	}
	...
	//    0    0:ldc1            #59  <String "sessionId">
	//    1    2:aload_0         
	//    2    3:invokestatic    #65  <Method Map Collections.singletonMap(Object, Object)>
	//    3    6:astore_0        
		return (new Builder(Type.CRASH)).details(((Map) (s)));
	//    4    7:new             #8   <Class SessionEvent$Builder>
	//    5   10:dup             
	//    6   11:getstatic       #68  <Field SessionEvent$Type SessionEvent$Type.CRASH>
	//    7   14:invokespecial   #71  <Method void SessionEvent$Builder(SessionEvent$Type)>
	//    8   17:aload_0         
	//    9   18:invokevirtual   #74  <Method SessionEvent$Builder SessionEvent$Builder.details(Map)>
	//   10   21:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #77  <Method SessionEvent$Builder crashEventBuilder(String)>
	//    2    4:ldc1            #79  <String "exceptionName">
	//    3    6:aload_1         
	//    4    7:invokestatic    #65  <Method Map Collections.singletonMap(Object, Object)>
	//    5   10:invokevirtual   #81  <Method SessionEvent$Builder SessionEvent$Builder.customAttributes(Map)>
	//    6   13:areturn         
	}
	...
	//    1    3:dup             
	//    2    4:getstatic       #86  <Field SessionEvent$Type SessionEvent$Type.INSTALL>
	//    3    7:invokespecial   #71  <Method void SessionEvent$Builder(SessionEvent$Type)>
	//    4   10:ldc1            #88  <String "installedAt">
	//    5   12:lload_0         
	//    6   13:invokestatic    #94  <Method String String.valueOf(long)>
	//    7   16:invokestatic    #65  <Method Map Collections.singletonMap(Object, Object)>
	//    8   19:invokevirtual   #74  <Method SessionEvent$Builder SessionEvent$Builder.details(Map)>
	//    9   22:areturn         
	}
	...
	//    0    0:ldc1            #98  <String "activity">
	//    1    2:aload_1         
	//    2    3:invokevirtual   #102 <Method Class Object.getClass()>
	//    3    6:invokevirtual   #108 <Method String Class.getName()>
	//    4    9:invokestatic    #65  <Method Map Collections.singletonMap(Object, Object)>
	//    5   12:astore_1        
		return (new Builder(type1)).details(((Map) (activity)));
	//    6   13:new             #8   <Class SessionEvent$Builder>
	//    7   16:dup             
	//    8   17:aload_0         
	//    9   18:invokespecial   #71  <Method void SessionEvent$Builder(SessionEvent$Type)>
	//   10   21:aload_1         
	//   11   22:invokevirtual   #74  <Method SessionEvent$Builder SessionEvent$Builder.details(Map)>
	//   12   25:areturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #111 <Field String stringRepresentation>
	//*   2    4:ifnonnull       184
		{
			StringBuilder stringbuilder = new StringBuilder();
	//    3    7:new             #113 <Class StringBuilder>
	//    4   10:dup             
	//    5   11:invokespecial   #114 <Method void StringBuilder()>
	//    6   14:astore_1        
			stringbuilder.append("[");
	//    7   15:aload_1         
	//    8   16:ldc1            #116 <String "[">
	//    9   18:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   10   21:pop             
			stringbuilder.append(((Object)this).getClass().getSimpleName());
	//   11   22:aload_1         
	//   12   23:aload_0         
	//   13   24:invokevirtual   #102 <Method Class Object.getClass()>
	//   14   27:invokevirtual   #123 <Method String Class.getSimpleName()>
	//   15   30:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   16   33:pop             
			stringbuilder.append(": ");
	//   17   34:aload_1         
	//   18   35:ldc1            #125 <String ": ">
	//   19   37:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   20   40:pop             
			stringbuilder.append("timestamp=");
	//   21   41:aload_1         
	//   22   42:ldc1            #127 <String "timestamp=">
	//   23   44:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   24   47:pop             
			stringbuilder.append(timestamp);
	//   25   48:aload_1         
	//   26   49:aload_0         
	//   27   50:getfield        #37  <Field long timestamp>
	//   28   53:invokevirtual   #130 <Method StringBuilder StringBuilder.append(long)>
	//   29   56:pop             
			stringbuilder.append(", type=");
	//   30   57:aload_1         
	//   31   58:ldc1            #132 <String ", type=">
	//   32   60:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   33   63:pop             
			stringbuilder.append(((Object) (type)));
	//   34   64:aload_1         
	//   35   65:aload_0         
	//   36   66:getfield        #39  <Field SessionEvent$Type type>
	//   37   69:invokevirtual   #135 <Method StringBuilder StringBuilder.append(Object)>
	//   38   72:pop             
			stringbuilder.append(", details=");
	//   39   73:aload_1         
	//   40   74:ldc1            #137 <String ", details=">
	//   41   76:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   42   79:pop             
			stringbuilder.append(((Object) (details)));
	//   43   80:aload_1         
	//   44   81:aload_0         
	//   45   82:getfield        #41  <Field Map details>
	//   46   85:invokevirtual   #135 <Method StringBuilder StringBuilder.append(Object)>
	//   47   88:pop             
			stringbuilder.append(", customType=");
	//   48   89:aload_1         
	//   49   90:ldc1            #139 <String ", customType=">
	//   50   92:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   51   95:pop             
			stringbuilder.append(customType);
	//   52   96:aload_1         
	//   53   97:aload_0         
	//   54   98:getfield        #43  <Field String customType>
	//   55  101:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   56  104:pop             
			stringbuilder.append(", customAttributes=");
	//   57  105:aload_1         
	//   58  106:ldc1            #141 <String ", customAttributes=">
	//   59  108:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   60  111:pop             
			stringbuilder.append(((Object) (customAttributes)));
	//   61  112:aload_1         
	//   62  113:aload_0         
	//   63  114:getfield        #45  <Field Map customAttributes>
	//   64  117:invokevirtual   #135 <Method StringBuilder StringBuilder.append(Object)>
	//   65  120:pop             
			stringbuilder.append(", predefinedType=");
	//   66  121:aload_1         
	//   67  122:ldc1            #143 <String ", predefinedType=">
	//   68  124:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   69  127:pop             
			stringbuilder.append(predefinedType);
	//   70  128:aload_1         
	//   71  129:aload_0         
	//   72  130:getfield        #47  <Field String predefinedType>
	//   73  133:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   74  136:pop             
			stringbuilder.append(", predefinedAttributes=");
	//   75  137:aload_1         
	//   76  138:ldc1            #145 <String ", predefinedAttributes=">
	//   77  140:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   78  143:pop             
			stringbuilder.append(((Object) (predefinedAttributes)));
	//   79  144:aload_1         
	//   80  145:aload_0         
	//   81  146:getfield        #49  <Field Map predefinedAttributes>
	//   82  149:invokevirtual   #135 <Method StringBuilder StringBuilder.append(Object)>
	//   83  152:pop             
			stringbuilder.append(", metadata=[");
	//   84  153:aload_1         
	//   85  154:ldc1            #147 <String ", metadata=[">
	//   86  156:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   87  159:pop             
			stringbuilder.append(((Object) (sessionEventMetadata)));
	//   88  160:aload_1         
	//   89  161:aload_0         
	//   90  162:getfield        #35  <Field SessionEventMetadata sessionEventMetadata>
	//   91  165:invokevirtual   #135 <Method StringBuilder StringBuilder.append(Object)>
	//   92  168:pop             
			stringbuilder.append("]]");
	//   93  169:aload_1         
	//   94  170:ldc1            #149 <String "]]">
	//   95  172:invokevirtual   #120 <Method StringBuilder StringBuilder.append(String)>
	//   96  175:pop             
			stringRepresentation = stringbuilder.toString();
	//   97  176:aload_0         
	//   98  177:aload_1         
	//   99  178:invokevirtual   #151 <Method String StringBuilder.toString()>
	//  100  181:putfield        #111 <Field String stringRepresentation>
		}
		return stringRepresentation;
	//  101  184:aload_0         
	//  102  185:getfield        #111 <Field String stringRepresentation>
	//  103  188:areturn         
	}
