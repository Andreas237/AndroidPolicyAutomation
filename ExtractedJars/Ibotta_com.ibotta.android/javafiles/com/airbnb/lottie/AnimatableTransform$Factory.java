...
//			AnimatableTransform, AnimatablePathValue, AnimatableScaleValue, ScaleXY, 
//			AnimatableIntegerValue, LottieComposition

static class AnimatableTransform$Factory
{

	static AnimatableTransform newInstance()
	{
		return new AnimatableTransform(new AnimatablePathValue(), ((AnimatableValue) (new AnimatablePathValue())), .newInstance(), .newInstance(), ry.newInstance(), ((AnimatableTransform._cls1) (null)));
	...
	//*  38   71:aload           4
	//*  39   73:ifnull          87
			obj2 = ((Object) (.newInstance(((JSONObject) (obj2)), lottiecomposition)));
	//   40   76:aload           4
	//   41   78:aload_1         
	...
	//*  66  133:ifnull          148
		{
			obj3 = ((Object) (.newInstance(((JSONObject) (obj3)), lottiecomposition, false)));
	//   67  136:aload           5
	//   68  138:aload_1         
	//   69  139:iconst_0        
	...
	//*  81  163:aload_0         
	//*  82  164:ifnull          176
			jsonobject = ((JSONObject) (ry.newInstance(jsonobject, lottiecomposition)));
	//   83  167:aload_0         
	//   84  168:aload_1         
	...
	//   94  191:astore_0        
		return new AnimatableTransform(((AnimatablePathValue) (obj)), ((AnimatableValue) (obj1)), ((AnimatableScaleValue) (obj2)), ((AnimatableFloatValue) (obj3)), ((AnimatableIntegerValue) (jsonobject)), ((AnimatableTransform._cls1) (null)));
