...
//			GradientStroke, GradientType, LottieComposition

static class GradientStroke$Factory
{
...
label1:
	...
	//*  22   45:aload_3         
	//*  23   46:ifnull          58
					obj = ((Object) (Value.Factory.newInstance(((JSONObject) (obj)), lottiecomposition)));
	//   24   49:aload_3         
	//   25   50:aload_1         
	...
	//*  35   68:aload           4
	//*  36   70:ifnull          84
					obj1 = ((Object) (com.airbnb.lottie.Factory.newInstance(((JSONObject) (obj1)), lottiecomposition)));
	//   37   73:aload           4
	//   38   75:aload_1         
	...
	//*  59  119:aload           6
	//*  60  121:ifnull          135
					obj2 = ((Object) (ctory.newInstance(((JSONObject) (obj2)), lottiecomposition)));
	//   61  124:aload           6
	//   62  126:aload_1         
	...
	//*  72  146:aload           7
	//*  73  148:ifnull          162
					obj3 = ((Object) (ctory.newInstance(((JSONObject) (obj3)), lottiecomposition)));
	//   74  151:aload           7
	//   75  153:aload_1         
	...
	//   79  162:aconst_null     
	//   80  163:astore          7
				animatablefloatvalue = ctory.newInstance(jsonobject.optJSONObject("w"), lottiecomposition);
	//   81  165:aload_0         
	...
	//   86  175:astore          11
				 = com.airbnb.lottie..values()[jsonobject.optInt("lc") - 1];
	...
	//   93  188:aaload          
	//   94  189:astore          12
				e = com.airbnb.lottie.e.values()[jsonobject.optInt("lj") - 1];
...
label2:
	...
	//* 134  268:ifeq            287
						{
							obj4 = ((Object) (ctory.newInstance(jsonobject1.optJSONObject("v"), lottiecomposition)));
	//  135  271:aload           15
	...
	//  151  307:ifeq            332
						...
						((List) (arraylist)).add(((Object) (ctory.newInstance(jsonobject1.optJSONObject("v"), lottiecomposition))));
	//  152  310:aload           14
	//  153  312:aload           15
	...
	//  181  373:astore_0        
		...
		return new GradientStroke(s, gradienttype, ((AnimatableGradientColorValue) (obj)), ((AnimatableIntegerValue) (obj1)), ((AnimatablePointValue) (obj2)), ((AnimatablePointValue) (obj3)), animatablefloatvalue, , e, ((List) (arraylist)), ((AnimatableFloatValue) (jsonobject)), ((GradientStroke._cls1) (null)));
