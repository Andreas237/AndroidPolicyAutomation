...
static class PolystarContent$1
{
	...
	static 
	{
		$SwitchMap$com$airbnb$lottie$PolystarShape$Type = new int[.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$com$airbnb$lottie$PolystarShape$Type>
		try
		{
			$SwitchMap$com$airbnb$lottie$PolystarShape$Type[.Star.ordinal()] = 1;
	...
	//   15   32:astore_0        
		try
		{
			$SwitchMap$com$airbnb$lottie$PolystarShape$Type[.Polygon.ordinal()] = 2;
		}
	//*  16   33:goto            20
