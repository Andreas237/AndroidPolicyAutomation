...
//			LottieComposition, Layer, FileCompositionLoader, Utils, 
//			JsonCompositionLoader, LottieImageAsset, OnCompositionLoadedListener, Cancellable
...
public static class LottieComposition$Factory
{
	...
	//   37   60:aconst_null     
	//   38   61:astore_0        
		resources = ((Resources) (new LottieComposition(((Rect) (resources)), jsonobject.optLong("ip", 0L), jsonobject.optLong("op", 0L), jsonobject.optInt("fr", 0), f, ((LottieComposition._cls1) (null)))));
	...
	//   22   42:astore          4
				LottieComposition.access$400(lottiecomposition).put(((Object) (((LottieImageAsset) (obj)).getId())), obj);
	//   23   44:aload_1         
	...
	//   17   28:astore          4
			addLayer(LottieComposition.access$100(lottiecomposition), LottieComposition.access$200(lottiecomposition), layer);
	//   18   30:aload_1         
	...
	//   61  126:astore          6
			LottieComposition.access$300(lottiecomposition).put(obj, ((Object) (arraylist)));
	//   62  128:aload_1         
