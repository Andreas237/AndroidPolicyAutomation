...
final class JsonCompositionLoader extends CompositionLoader
{
	...
	protected transient LottieComposition doInBackground(JSONObject ajsonobject[])
	{
		return LottieComposition.Factory.fromJsonSync(res, ajsonobject[0]);
	//    0    0:aload_0         
	//    1    1:getfield        #16  <Field Resources res>
	//    2    4:aload_1         
	//    3    5:iconst_0        
	//    4    6:aaload          
	//    5    7:invokestatic    #27  <Method LottieComposition LottieComposition$Factory.fromJsonSync(Resources, JSONObject)>
	//    6   10:areturn         
	}

	protected volatile Object doInBackground(Object aobj[])
	{
		return ((Object) (doInBackground((JSONObject[])aobj)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #30  <Class JSONObject[]>
	//    3    5:invokevirtual   #32  <Method LottieComposition doInBackground(JSONObject[])>
	//    4    8:areturn         
	}
