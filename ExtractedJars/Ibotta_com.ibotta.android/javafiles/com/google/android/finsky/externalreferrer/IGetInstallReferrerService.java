...
public interface IGetInstallReferrerService
	extends IInterface
{
		...
		implements IGetInstallReferrerService
	{
		...
		//    1    1:invokespecial   #21  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.google.android.finsky.externalreferrer.IGetInstallReferrerService");
		//    2    4:aload_0         
		//    3    5:aload_0         
	...
	public abstract Bundle getInstallReferrer(Bundle bundle)
		throws RemoteException;
}
