	...
	implements ReflectedParcelable
{
	public static class Builder
	{
		...
		static boolean zzd(Builder builder)
		{
			return builder.zzcq;
		//    0    0:aload_0         
		//    1    1:getfield        #18  <Field boolean zzcq>
		//    2    4:ireturn         
		}
		...
		static int zzf(Builder builder)
		{
			return builder.zzct;
		//    0    0:aload_0         
		//    1    1:getfield        #22  <Field int zzct>
		//    2    4:ireturn         
		}

		public CredentialPickerConfig build()
		{
			return new CredentialPickerConfig(this, ((zze) (null)));
		//    0    0:new             #6   <Class CredentialPickerConfig>
		//    1    3:dup             
		//    2    4:aload_0         
		//    3    5:aconst_null     
		//    4    6:invokespecial   #33  <Method void CredentialPickerConfig(CredentialPickerConfig$Builder, zze)>
		//    5    9:areturn         
		}
		...
		//    7   11:aload_0         
		//    8   12:iload_2         
		//    9   13:putfield        #22  <Field int zzct>
			return this;
		//   10   16:aload_0         
		//   11   17:areturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:putfield        #22  <Field int zzct>
			return this;
		//    3    5:aload_0         
		//    4    6:areturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:putfield        #18  <Field boolean zzcq>
			return this;
		//    3    5:aload_0         
		//    4    6:areturn         
		}
		...
		//    2    4:aload_0         
		//    3    5:iconst_0        
		//    4    6:putfield        #18  <Field boolean zzcq>
		...
		//    8   14:aload_0         
		//    9   15:iconst_1        
		//   10   16:putfield        #22  <Field int zzct>
		//   11   19:return          
		}
	}
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:putfield        #54  <Field int zzy>
		zzcq = flag;
	//    5    9:aload_0         
	//    6   10:iload_2         
	//    7   11:putfield        #56  <Field boolean zzcq>
	...
	//   18   29:aload_0         
	//   19   30:iload           4
	//   20   32:putfield        #60  <Field boolean zzcr>
			i = ((int) (flag3));
	//   21   35:iload           6
	//   22   37:istore_1        
			if(flag2)
	...
	//   27   45:aload_0         
	//   28   46:iload_1         
	//   29   47:putfield        #62  <Field int zzcs>
			return;
	//   30   50:return          
		}
		if(j != 3)
	...
	//   37   62:aload_0         
	//   38   63:iload_2         
	//   39   64:putfield        #60  <Field boolean zzcr>
		zzcs = j;
	//   40   67:aload_0         
	//   41   68:iload           5
	//   42   70:putfield        #62  <Field int zzcs>
	//   43   73:return          
	}

	private CredentialPickerConfig(Builder builder)
	{
		this(2, Builder.zzd(builder), Builder.zze(builder), false, Builder.zzf(builder));
	//    0    0:aload_0         
	//    1    1:iconst_2        
	//    2    2:aload_1         
	//    3    3:invokestatic    #69  <Method boolean CredentialPickerConfig$Builder.zzd(CredentialPickerConfig$Builder)>
	//    4    6:aload_1         
	//    5    7:invokestatic    #72  <Method boolean CredentialPickerConfig$Builder.zze(CredentialPickerConfig$Builder)>
	//    6   10:iconst_0        
	//    7   11:aload_1         
	//    8   12:invokestatic    #76  <Method int CredentialPickerConfig$Builder.zzf(CredentialPickerConfig$Builder)>
	//    9   15:invokespecial   #78  <Method void CredentialPickerConfig(int, boolean, boolean, boolean, int)>
	//   10   18:return          
	}

	CredentialPickerConfig(Builder builder, zze zze)
	{
		this(builder);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public final boolean isForNewAccount()
	{
		return zzcs == 3;
	//    0    0:aload_0         
	//    1    1:getfield        #62  <Field int zzcs>
	//    2    4:iconst_3        
	//    3    5:icmpne          10
	//    4    8:iconst_1        
	//    5    9:ireturn         
	...
	public final boolean shouldShowAddAccountButton()
	{
		return zzcq;
	//    0    0:aload_0         
	//    1    1:getfield        #56  <Field boolean zzcq>
	//    2    4:ireturn         
	}
	...
	static 
	{
	//    0    0:new             #42  <Class zzf>
	//    1    3:dup             
	//    2    4:invokespecial   #45  <Method void zzf()>
