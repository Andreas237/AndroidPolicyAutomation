...
final class zzn extends zzp
{
	...
	//    2    4:astore_1        
		((zzv)((zzh) (anyclient)).getService()).zzf(((zzt) (new zzo(this))), ((zzh) (anyclient)).zzn());
	//    3    5:aload_1         
	//    4    6:invokevirtual   #22  <Method android.os.IInterface zzh.getService()>
	//    5    9:checkcast       #24  <Class zzv>
	//    6   12:new             #26  <Class zzo>
	//    7   15:dup             
	//    8   16:aload_0         
	//    9   17:invokespecial   #29  <Method void zzo(zzn)>
	//   10   20:aload_1         
	//   11   21:invokevirtual   #33  <Method com.google.android.gms.auth.api.signin.GoogleSignInOptions zzh.zzn()>
	//   12   24:invokeinterface #37  <Method void zzv.zzf(zzt, com.google.android.gms.auth.api.signin.GoogleSignInOptions)>
	//   13   29:return          
	}
}
