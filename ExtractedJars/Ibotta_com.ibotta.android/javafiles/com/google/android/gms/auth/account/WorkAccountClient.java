...
//			WorkAccount, WorkAccountApi, zzj
...
public class WorkAccountClient extends GoogleApi
{
	...
	//    5    9:invokespecial   #25  <Method void GoogleApi(Activity, com.google.android.gms.common.api.Api, com.google.android.gms.common.api.Api$ApiOptions, com.google.android.gms.common.api.GoogleApi$Settings)>
		zzae = ((WorkAccountApi) (new zzk()));
	//    6   12:aload_0         
	//    7   13:new             #27  <Class zzk>
	//    8   16:dup             
	//    9   17:invokespecial   #30  <Method void zzk()>
	//   10   20:putfield        #32  <Field WorkAccountApi zzae>
	//   11   23:return          
	}
	...
	{
		return PendingResultUtil.toTask(zzae.addWorkAccount(asGoogleApiClient(), s), ((com.google.android.gms.common.internal.PendingResultUtil.ResultConverter) (new zzj(this))));
	//    0    0:aload_0         
	//    1    1:getfield        #32  <Field WorkAccountApi zzae>
	//    2    4:aload_0         
	...
	//    6   14:new             #51  <Class zzj>
	//    7   17:dup             
	//    8   18:aload_0         
	//    9   19:invokespecial   #54  <Method void zzj(WorkAccountClient)>
	...
	{
		return PendingResultUtil.toVoidTask(zzae.removeWorkAccount(asGoogleApiClient(), account));
	//    0    0:aload_0         
	//    1    1:getfield        #32  <Field WorkAccountApi zzae>
	//    2    4:aload_0         
	//    3    5:invokevirtual   #44  <Method com.google.android.gms.common.api.GoogleApiClient asGoogleApiClient()>
	...
	{
		return PendingResultUtil.toVoidTask(zzae.setWorkAuthenticatorEnabledWithResult(asGoogleApiClient(), flag));
	//    0    0:aload_0         
	//    1    1:getfield        #32  <Field WorkAccountApi zzae>
	//    2    4:aload_0         
	//    3    5:invokevirtual   #44  <Method com.google.android.gms.common.api.GoogleApiClient asGoogleApiClient()>
