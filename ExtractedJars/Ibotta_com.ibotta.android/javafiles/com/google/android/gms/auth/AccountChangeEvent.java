...
public class AccountChangeEvent extends AbstractSafeParcelable
{
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:putfield        #44  <Field int zzh>
		zzi = l;
	//    5    9:aload_0         
	//    6   10:lload_2         
	//    7   11:putfield        #46  <Field long zzi>
		zzj = (String)Preconditions.checkNotNull(((Object) (s)));
	//    8   14:aload_0         
	//    9   15:aload           4
	//   10   17:invokestatic    #52  <Method Object Preconditions.checkNotNull(Object)>
	//   11   20:checkcast       #54  <Class String>
	//   12   23:putfield        #56  <Field String zzj>
		zzk = j;
	//   13   26:aload_0         
	//   14   27:iload           5
	//   15   29:putfield        #58  <Field int zzk>
		zzl = k;
	//   16   32:aload_0         
	//   17   33:iload           6
	//   18   35:putfield        #60  <Field int zzl>
		zzm = s1;
	//   19   38:aload_0         
	//   20   39:aload           7
	//   21   41:putfield        #62  <Field String zzm>
	//   22   44:return          
	}
	...
	//   12   22:putfield        #56  <Field String zzj>
		zzk = i;
	//   13   25:aload_0         
	//   14   26:iload           4
	//   15   28:putfield        #58  <Field int zzk>
		zzl = j;
	//   16   31:aload_0         
	//   17   32:iload           5
	//   18   34:putfield        #60  <Field int zzl>
		zzm = s1;
	//   19   37:aload_0         
	//   20   38:aload           6
	//   21   40:putfield        #62  <Field String zzm>
	//   22   43:return          
	}
	...
	//   10   18:astore_1        
			if(zzh == ((AccountChangeEvent) (obj)).zzh && zzi == ((AccountChangeEvent) (obj)).zzi && Objects.equal(((Object) (zzj)), ((Object) (((AccountChangeEvent) (obj)).zzj))) && zzk == ((AccountChangeEvent) (obj)).zzk && zzl == ((AccountChangeEvent) (obj)).zzl && Objects.equal(((Object) (zzm)), ((Object) (((AccountChangeEvent) (obj)).zzm))))
	//*  11   19:aload_0         
	//*  12   20:getfield        #44  <Field int zzh>
	//*  13   23:aload_1         
	//*  14   24:getfield        #44  <Field int zzh>
	//*  15   27:icmpne          94
	//*  16   30:aload_0         
	//*  17   31:getfield        #46  <Field long zzi>
	//*  18   34:aload_1         
	//*  19   35:getfield        #46  <Field long zzi>
	//*  20   38:lcmp            
	//*  21   39:ifne            94
	//*  22   42:aload_0         
	//*  23   43:getfield        #56  <Field String zzj>
	//*  24   46:aload_1         
	//*  25   47:getfield        #56  <Field String zzj>
	//*  26   50:invokestatic    #73  <Method boolean Objects.equal(Object, Object)>
	//*  27   53:ifeq            94
	//*  28   56:aload_0         
	//*  29   57:getfield        #58  <Field int zzk>
	//*  30   60:aload_1         
	//*  31   61:getfield        #58  <Field int zzk>
	//*  32   64:icmpne          94
	//*  33   67:aload_0         
	//*  34   68:getfield        #60  <Field int zzl>
	//*  35   71:aload_1         
	//*  36   72:getfield        #60  <Field int zzl>
	//*  37   75:icmpne          94
	//*  38   78:aload_0         
	//*  39   79:getfield        #62  <Field String zzm>
	//*  40   82:aload_1         
	//*  41   83:getfield        #62  <Field String zzm>
	...
	public String getAccountName()
	{
		return zzj;
	//    0    0:aload_0         
	//    1    1:getfield        #56  <Field String zzj>
	//    2    4:areturn         
	}
	...
	public String getChangeData()
	{
		return zzm;
	//    0    0:aload_0         
	//    1    1:getfield        #62  <Field String zzm>
	//    2    4:areturn         
	}
	...
	public int hashCode()
	{
		return Objects.hashCode(new Object[] {
			Integer.valueOf(zzh), Long.valueOf(zzi), zzj, Integer.valueOf(zzk), Integer.valueOf(zzl), zzm
		});
	//    0    0:bipush          6
	...
	//   16   59:astore_2        
		...
		String s1 = zzj;
	//   17   60:aload_0         
	//   18   61:getfield        #56  <Field String zzj>
	//   19   64:astore_3        
		String s2 = zzm;
	//   20   65:aload_0         
	//   21   66:getfield        #62  <Field String zzm>
	//   22   69:astore          4
		int i = zzl;
	//   23   71:aload_0         
	//   24   72:getfield        #60  <Field int zzl>
	//   25   75:istore_1        
	...
	//    4    6:iconst_1        
	//    5    7:aload_0         
	//    6    8:getfield        #44  <Field int zzh>
	//    7   11:invokestatic    #149 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeLong(parcel, 2, zzi);
	//    8   14:aload_1         
	//    9   15:iconst_2        
	//   10   16:aload_0         
	//   11   17:getfield        #46  <Field long zzi>
	...
	//   14   24:iconst_3        
	//   15   25:aload_0         
	//   16   26:getfield        #56  <Field String zzj>
	//   17   29:iconst_0        
	//   18   30:invokestatic    #157 <Method void SafeParcelWriter.writeString(Parcel, int, String, boolean)>
		SafeParcelWriter.writeInt(parcel, 4, zzk);
	//   19   33:aload_1         
	//   20   34:iconst_4        
	//   21   35:aload_0         
	//   22   36:getfield        #58  <Field int zzk>
	//   23   39:invokestatic    #149 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeInt(parcel, 5, zzl);
	//   24   42:aload_1         
	//   25   43:iconst_5        
	//   26   44:aload_0         
	//   27   45:getfield        #60  <Field int zzl>
	//   28   48:invokestatic    #149 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeString(parcel, 6, zzm, false);
	//   29   51:aload_1         
	//   30   52:bipush          6
	//   31   54:aload_0         
	//   32   55:getfield        #62  <Field String zzm>
	//   33   58:iconst_0        
