...
public class CredentialsClient extends GoogleApi
{
	...
	{
		return zzaw.zzd(getApplicationContext(), (com.google.android.gms.auth.api.Auth.AuthCredentialsOptions)getApiOptions(), hintrequest);
	//    0    0:aload_0         
	...
	//    5   11:aload_1         
	//    6   12:invokestatic    #75  <Method PendingIntent zzaw.zzd(Context, com.google.android.gms.auth.api.Auth$AuthCredentialsOptions, HintRequest)>
	//    7   15:areturn         
	}
