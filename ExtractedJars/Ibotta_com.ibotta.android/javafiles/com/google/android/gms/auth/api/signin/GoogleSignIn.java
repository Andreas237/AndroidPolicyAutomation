...
public final class GoogleSignIn
{
	...
	//   16   28:astore_0        
		return ((GoogleSignInAccount) (context)).requestExtraScopes(zzd(googlesigninoptionsextension.getImpliedScopes()));
	//   17   29:aload_0         
	//   18   30:aload_1         
	//   19   31:invokeinterface #38  <Method List GoogleSignInOptionsExtension.getImpliedScopes()>
	//   20   36:invokestatic    #42  <Method Scope[] zzd(List)>
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #77  <Method zzq zzq.zze(Context)>
	//    2    4:invokevirtual   #80  <Method GoogleSignInAccount zzq.zzo()>
	//    3    7:areturn         
	}

	public static Task getSignedInAccountFromIntent(Intent intent)
	{
		intent = ((Intent) (zzi.getSignInResultFromIntent(intent)));
	//    0    0:aload_0         
	//    1    1:invokestatic    #88  <Method GoogleSignInResult zzi.getSignInResultFromIntent(Intent)>
	//    2    4:astore_0        
		if(intent == null)
	//*   3    5:aload_0         
	//*   4    6:ifnonnull       19
	...
	//    7   14:invokestatic    #42  <Method Scope[] zzd(List)>
	...
	//   13   23:invokestatic    #42  <Method Scope[] zzd(List)>
	...
	//    6   10:invokestatic    #20  <Method Object Preconditions.checkNotNull(Object, Object)>
	//    7   13:pop             
		activity.startActivityForResult(zzd(activity, googlesigninaccount, ascope), i);
	//    8   14:aload_0         
	//    9   15:aload_0         
	//   10   16:aload_2         
	//   11   17:aload_3         
	//   12   18:invokestatic    #163 <Method Intent zzd(Activity, GoogleSignInAccount, Scope[])>
	//   13   21:iload_1         
	...
	//    6   10:invokestatic    #20  <Method Object Preconditions.checkNotNull(Object, Object)>
	//    7   13:pop             
		fragment.startActivityForResult(zzd(((Activity) (fragment.getActivity())), googlesigninaccount, ascope), i);
	//    8   14:aload_0         
	//    9   15:aload_0         
	//   10   16:invokevirtual   #181 <Method android.support.v4.app.FragmentActivity Fragment.getActivity()>
	//   11   19:aload_2         
	//   12   20:aload_3         
	//   13   21:invokestatic    #163 <Method Intent zzd(Activity, GoogleSignInAccount, Scope[])>
	//   14   24:iload_1         
	//   15   25:invokevirtual   #182 <Method void Fragment.startActivityForResult(Intent, int)>
	//   16   28:return          
	}

	private static transient Intent zzd(Activity activity, GoogleSignInAccount googlesigninaccount, Scope ascope[])
	{
	...
	private static Scope[] zzd(List list)
	{
		if(list == null)
	//*   0    0:aload_0         
	//*   1    1:ifnonnull       9
