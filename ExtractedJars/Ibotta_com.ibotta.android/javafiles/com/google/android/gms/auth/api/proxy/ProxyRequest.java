...
public class ProxyRequest extends AbstractSafeParcelable
{
	...
	//   17   31:aload_0         
	//   18   32:aload           7
	//   19   34:putfield        #88  <Field Bundle zzdw>
	//   20   37:return          
	}

	public Map getHeaderMap()
	{
		LinkedHashMap linkedhashmap = new LinkedHashMap(zzdw.size());
	//    0    0:new             #94  <Class LinkedHashMap>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #88  <Field Bundle zzdw>
	//    4    8:invokevirtual   #100 <Method int Bundle.size()>
	//    5   11:invokespecial   #103 <Method void LinkedHashMap(int)>
	//    6   14:astore_1        
		String s;
		for(Iterator iterator = zzdw.keySet().iterator(); iterator.hasNext(); ((Map) (linkedhashmap)).put(((Object) (s)), ((Object) (zzdw.getString(s)))))
	//*   7   15:aload_0         
	//*   8   16:getfield        #88  <Field Bundle zzdw>
	...
	//   20   48:aload_3         
	//   21   49:aload_0         
	//   22   50:getfield        #88  <Field Bundle zzdw>
	//   23   53:aload_3         
	...
	//   24   40:invokestatic    #194 <Method void SafeParcelWriter.writeByteArray(Parcel, int, byte[], boolean)>
		SafeParcelWriter.writeBundle(parcel, 5, zzdw, false);
	//   25   43:aload_1         
	//   26   44:iconst_5        
	//   27   45:aload_0         
	//   28   46:getfield        #88  <Field Bundle zzdw>
	//   29   49:iconst_0        
	...
	static 
	{
	//    0    0:new             #48  <Class zzd>
	//    1    3:dup             
	//    2    4:invokespecial   #51  <Method void zzd()>
