...
public static class CredentialPickerConfig$Builder
{
	...
	{
		return credentialpickerconfig$builder.zzcq;
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field boolean zzcq>
	//    2    4:ireturn         
	}

	static boolean zze(CredentialPickerConfig$Builder credentialpickerconfig$builder)
	{
	...
	static int zzf(CredentialPickerConfig$Builder credentialpickerconfig$builder)
	{
		return credentialpickerconfig$builder.zzct;
	//    0    0:aload_0         
