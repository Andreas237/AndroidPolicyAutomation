	...
	implements MediationBannerAdapter, MediationInterstitialAdapter, MediationNativeAdapter
{
	...
	//   14   24:invokevirtual   #71  <Method int String.length()>
	//   15   27:bipush          46
	//   16   29:iadd            
	//   17   30:aload_1         
	...
	//*   3    5:aload_1         
	//*   4    6:ifnull          15
			((CustomEventBanner) (obj)).onDestroy();
	//    5    9:aload_1         
	//    6   10:invokeinterface #102 <Method void CustomEventBanner.onDestroy()>
		obj = ((Object) (zzdgf));
	//    7   15:aload_0         
	//    8   16:getfield        #104 <Field CustomEventInterstitial zzdgf>
	//    9   19:astore_1        
		if(obj != null)
	//*  10   20:aload_1         
	//*  11   21:ifnull          30
			((CustomEventInterstitial) (obj)).onDestroy();
	//   12   24:aload_1         
	//   13   25:invokeinterface #107 <Method void CustomEventInterstitial.onDestroy()>
		obj = ((Object) (zzdgg));
	//   14   30:aload_0         
	//   15   31:getfield        #109 <Field CustomEventNative zzdgg>
	//   16   34:astore_1        
		if(obj != null)
	//*  17   35:aload_1         
	//*  18   36:ifnull          45
			((CustomEventNative) (obj)).onDestroy();
	//   19   39:aload_1         
	//   20   40:invokeinterface #112 <Method void CustomEventNative.onDestroy()>
	//   21   45:return          
	}
	...
	//*   3    5:aload_1         
	//*   4    6:ifnull          15
			((CustomEventBanner) (obj)).onPause();
	//    5    9:aload_1         
	//    6   10:invokeinterface #115 <Method void CustomEventBanner.onPause()>
		obj = ((Object) (zzdgf));
	//    7   15:aload_0         
	//    8   16:getfield        #104 <Field CustomEventInterstitial zzdgf>
	//    9   19:astore_1        
	...
	//*  10   20:aload_1         
	//*  11   21:ifnull          30
			((CustomEventInterstitial) (obj)).onPause();
	//   12   24:aload_1         
	//   13   25:invokeinterface #116 <Method void CustomEventInterstitial.onPause()>
		obj = ((Object) (zzdgg));
	//   14   30:aload_0         
	//   15   31:getfield        #109 <Field CustomEventNative zzdgg>
	//   16   34:astore_1        
	...
	//*  17   35:aload_1         
	//*  18   36:ifnull          45
			((CustomEventNative) (obj)).onPause();
	//   19   39:aload_1         
	//   20   40:invokeinterface #117 <Method void CustomEventNative.onPause()>
	//   21   45:return          
	}
	...
	//*   3    5:aload_1         
	//*   4    6:ifnull          15
			((CustomEventBanner) (obj)).onResume();
	//    5    9:aload_1         
	//    6   10:invokeinterface #120 <Method void CustomEventBanner.onResume()>
		obj = ((Object) (zzdgf));
	//    7   15:aload_0         
	//    8   16:getfield        #104 <Field CustomEventInterstitial zzdgf>
	//    9   19:astore_1        
	...
	//*  10   20:aload_1         
	//*  11   21:ifnull          30
			((CustomEventInterstitial) (obj)).onResume();
	//   12   24:aload_1         
	//   13   25:invokeinterface #121 <Method void CustomEventInterstitial.onResume()>
		obj = ((Object) (zzdgg));
	//   14   30:aload_0         
	//   15   31:getfield        #109 <Field CustomEventNative zzdgg>
	//   16   34:astore_1        
	...
	//*  17   35:aload_1         
	//*  18   36:ifnull          45
			((CustomEventNative) (obj)).onResume();
	//   19   39:aload_1         
	//   20   40:invokeinterface #122 <Method void CustomEventNative.onResume()>
	//   21   45:return          
	}
	...
	//   26   56:aload_0         
	//   27   57:getfield        #98  <Field CustomEventBanner zzdge>
	//   28   60:aload_1         
	//   29   61:new             #12  <Class CustomEventAdapter$zza>
	//   30   64:dup             
	//   31   65:aload_0         
	//   32   66:aload_2         
	//   33   67:invokespecial   #147 <Method void CustomEventAdapter$zza(CustomEventAdapter, MediationBannerListener)>
	//   34   70:aload_3         
	//   35   71:ldc1            #149 <String "parameter">
	//   36   73:invokevirtual   #132 <Method String Bundle.getString(String)>
	//   37   76:aload           4
	//   38   78:aload           5
	//   39   80:aload           6
	//   40   82:invokeinterface #152 <Method void CustomEventBanner.requestBannerAd(Context, CustomEventBannerListener, String, AdSize, MediationAdRequest, Bundle)>
	//   41   87:return          
	}
	...
	//   26   56:aload_0         
	//   27   57:getfield        #104 <Field CustomEventInterstitial zzdgf>
	//   28   60:aload_1         
	//   29   61:new             #15  <Class CustomEventAdapter$zzb>
	//   30   64:dup             
	//   31   65:aload_0         
	//   32   66:aload_0         
	//   33   67:aload_2         
	//   34   68:invokespecial   #162 <Method void CustomEventAdapter$zzb(CustomEventAdapter, CustomEventAdapter, MediationInterstitialListener)>
	//   35   71:aload_3         
	//   36   72:ldc1            #149 <String "parameter">
	//   37   74:invokevirtual   #132 <Method String Bundle.getString(String)>
	//   38   77:aload           4
	//   39   79:aload           5
	//   40   81:invokeinterface #165 <Method void CustomEventInterstitial.requestInterstitialAd(Context, CustomEventInterstitialListener, String, MediationAdRequest, Bundle)>
	//   41   86:return          
	}
	...
	//   26   56:aload_0         
	//   27   57:getfield        #109 <Field CustomEventNative zzdgg>
	//   28   60:aload_1         
	//   29   61:new             #18  <Class CustomEventAdapter$zzc>
	//   30   64:dup             
	//   31   65:aload_0         
	//   32   66:aload_2         
	//   33   67:invokespecial   #175 <Method void CustomEventAdapter$zzc(CustomEventAdapter, MediationNativeListener)>
	//   34   70:aload_3         
	//   35   71:ldc1            #149 <String "parameter">
	//   36   73:invokevirtual   #132 <Method String Bundle.getString(String)>
	//   37   76:aload           4
	//   38   78:aload           5
	//   39   80:invokeinterface #178 <Method void CustomEventNative.requestNativeAd(Context, CustomEventNativeListener, String, NativeMediationAdRequest, Bundle)>
	//   40   85:return          
	}
