...
_L1:
	...
	//*  21   49:iload_2         
	//*  22   50:ifeq            124
	//*  23   53:getstatic       #91  <Field int GOOGLE_PLAY_SERVICES_VERSION_CODE>
	//*  24   56:istore_3        
	//*  25   57:iload_2         
	//*  26   58:iload_3         
	//*  27   59:icmpne          65
	//*  28   62:goto            135
	//*  29   65:new             #113 <Class StringBuilder>
	//*  30   68:dup             
	//*  31   69:sipush          320
	//*  32   72:invokespecial   #115 <Method void StringBuilder(int)>
	//*  33   75:astore_0        
	//*  34   76:aload_0         
	//*  35   77:ldc2            #309 <String "The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected ">
	//*  36   80:invokevirtual   #121 <Method StringBuilder StringBuilder.append(String)>
	//*  37   83:pop             
	//*  38   84:aload_0         
	//*  39   85:iload_3         
	//*  40   86:invokevirtual   #124 <Method StringBuilder StringBuilder.append(int)>
	//*  41   89:pop             
	//*  42   90:aload_0         
	//*  43   91:ldc2            #311 <String " but found ">
	//*  44   94:invokevirtual   #121 <Method StringBuilder StringBuilder.append(String)>
	//*  45   97:pop             
	//*  46   98:aload_0         
	//*  47   99:iload_2         
	//*  48  100:invokevirtual   #124 <Method StringBuilder StringBuilder.append(int)>
	//*  49  103:pop             
	//*  50  104:aload_0         
	//*  51  105:ldc2            #313 <String ".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />">
	//*  52  108:invokevirtual   #121 <Method StringBuilder StringBuilder.append(String)>
	//*  53  111:pop             
	//*  54  112:new             #315 <Class IllegalStateException>
	//*  55  115:dup             
	//*  56  116:aload_0         
	//*  57  117:invokevirtual   #130 <Method String StringBuilder.toString()>
	//*  58  120:invokespecial   #318 <Method void IllegalStateException(String)>
	//*  59  123:athrow          
	//*  60  124:new             #315 <Class IllegalStateException>
	//*  61  127:dup             
	//*  62  128:ldc2            #320 <String "A required meta-data tag in your app's AndroidManifest.xml does not exist.  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />">
	//*  63  131:invokespecial   #318 <Method void IllegalStateException(String)>
	//*  64  134:athrow          
	//*  65  135:aload_0         
	//*  66  136:invokestatic    #325 <Method boolean DeviceProperties.isWearableWithoutPlayStore(Context)>
	//*  67  139:ifne            155
	//*  68  142:aload_0         
	//*  69  143:invokestatic    #328 <Method boolean DeviceProperties.isIoT(Context)>
	//*  70  146:ifne            155
	//*  71  149:iconst_1        
	//*  72  150:istore          4
	//*  73  152:goto            158
	...
	//*  77  159:iload           4
	//*  78  161:iload_1         
	//*  79  162:invokestatic    #331 <Method int zza(Context, boolean, int)>
	//*  80  165:ireturn         
		// Misplaced declaration of an exception variable
...
_L2:
	...
	//*  87  178:pop             
	//*  88  179:aload_0         
	//*  89  180:ldc2            #311 <String " but found ">
