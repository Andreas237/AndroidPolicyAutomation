...
public final class LoadingImageView extends ImageView
{
	...
	{
		com.google.android.gms.common.images.ImageManager.OnImageLoadedListener onimageloadedlistener = mOnImageLoadedListener;
	//    0    0:aload_0         
	...
	//*   3    5:aload_2         
	//*   4    6:ifnull          21
			onimageloadedlistener.onImageLoaded(zzqn, ((android.graphics.drawable.Drawable) (null)), flag);
	//    5    9:aload_2         
	//    6   10:aload_0         
	//    7   11:getfield        #104 <Field Uri zzqn>
	//    8   14:aconst_null     
	//    9   15:iload_1         
	//   10   16:invokeinterface #110 <Method void com.google.android.gms.common.images.ImageManager$OnImageLoadedListener.onImageLoaded(Uri, android.graphics.drawable.Drawable, boolean)>
	//   11   21:return          
	}
	...
	{
		ClipPathProvider clippathprovider = zzqr;
	//    0    0:aload_0         
	...
	//    6   10:aload_3         
	//    7   11:aload_0         
	//    8   12:invokevirtual   #201 <Method int getWidth()>
	//    9   15:aload_0         
	//   10   16:invokevirtual   #204 <Method int getHeight()>
	//   11   19:invokeinterface #208 <Method Path LoadingImageView$ClipPathProvider.getClipPath(int, int)>
	//   12   24:invokevirtual   #214 <Method boolean Canvas.clipPath(Path)>
	//   13   27:pop             
		super.onDraw(canvas);
	//   14   28:aload_0         
	//   15   29:aload_1         
	//   16   30:invokespecial   #216 <Method void ImageView.onDraw(Canvas)>
		int i = zzqq;
	//   17   33:aload_0         
	//   18   34:getfield        #50  <Field int zzqq>
	//   19   37:istore_2        
		if(i != 0)
	//*  20   38:iload_2         
	//*  21   39:ifeq            47
	...
	//   22   42:aload_1         
	//   23   43:iload_2         
	//   24   44:invokevirtual   #219 <Method void Canvas.drawColor(int)>
	//   25   47:return          
	}
	...
	//   11   21:aload_0         
	//   12   22:aload_2         
	//   13   23:invokevirtual   #264 <Method void setColorFilter(android.graphics.ColorFilter)>
		invalidate();
	//   14   26:aload_0         
	//   15   27:invokevirtual   #267 <Method void invalidate()>
	//   16   30:return          
	}
