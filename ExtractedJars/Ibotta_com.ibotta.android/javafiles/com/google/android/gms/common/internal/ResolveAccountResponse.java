...
//			ResolveAccountResponseCreator, IAccountAccessor
...
public class ResolveAccountResponse extends AbstractSafeParcelable
{
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:putfield        #56  <Field int zzal>
		zzqv = ibinder;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #58  <Field IBinder zzqv>
		zzeu = connectionresult;
	//    8   14:aload_0         
	//    9   15:aload_3         
	//   10   16:putfield        #60  <Field ConnectionResult zzeu>
		zzhs = flag;
	//   11   19:aload_0         
	//   12   20:iload           4
	//   13   22:putfield        #62  <Field boolean zzhs>
		zzuv = flag1;
	//   14   25:aload_0         
	//   15   26:iload           5
	//   16   28:putfield        #64  <Field boolean zzuv>
	//   17   31:return          
	}
	...
	//   12   20:astore_1        
		return zzeu.equals(((Object) (((ResolveAccountResponse) (obj)).zzeu))) && ((Object) (getAccountAccessor())).equals(((Object) (((ResolveAccountResponse) (obj)).getAccountAccessor())));
	//   13   21:aload_0         
	//   14   22:getfield        #60  <Field ConnectionResult zzeu>
	//   15   25:aload_1         
	//   16   26:getfield        #60  <Field ConnectionResult zzeu>
	...
	{
		return IAccountAccessor.Stub.asInterface(zzqv);
	//    0    0:aload_0         
	//    1    1:getfield        #58  <Field IBinder zzqv>
	...
	public ConnectionResult getConnectionResult()
	{
		return zzeu;
	//    0    0:aload_0         
	//    1    1:getfield        #60  <Field ConnectionResult zzeu>
	//    2    4:areturn         
	}
	...
	public boolean getSaveDefaultAccount()
	{
		return zzhs;
	//    0    0:aload_0         
	//    1    1:getfield        #62  <Field boolean zzhs>
	//    2    4:ireturn         
	}
	...
	public boolean isFromCrossClientAuth()
	{
		return zzuv;
	//    0    0:aload_0         
	//    1    1:getfield        #64  <Field boolean zzuv>
	//    2    4:ireturn         
	}
	...
	//    7   15:astore_1        
		zzqv = ((IBinder) (iaccountaccessor));
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:putfield        #58  <Field IBinder zzqv>
		return this;
	//   11   21:aload_0         
	//   12   22:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #64  <Field boolean zzuv>
		return this;
	//    3    5:aload_0         
	//    4    6:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #62  <Field boolean zzhs>
		return this;
	//    3    5:aload_0         
	//    4    6:areturn         
	}
	...
	//    4    6:iconst_1        
	//    5    7:aload_0         
	//    6    8:getfield        #56  <Field int zzal>
	...
	//    9   15:iconst_2        
	//   10   16:aload_0         
	//   11   17:getfield        #58  <Field IBinder zzqv>
	//   12   20:iconst_0        
	...
	static 
	{
	//    0    0:new             #35  <Class ResolveAccountResponseCreator>
	//    1    3:dup             
	//    2    4:invokespecial   #38  <Method void ResolveAccountResponseCreator()>
