	...
	implements ReflectedParcelable
{
	...
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:putfield        #34  <Field boolean zzsm>
	//    5    9:return          
	}
	...
	//    0    0:invokestatic    #42  <Method ClassLoader getUnparcelClassLoader()>
	//    1    3:astore_2        
		if(classloader == null)
	//*   2    4:aload_2         
	//*   3    5:ifnonnull       10
	...
	//    6   10:aload_2         
	//    7   11:aload_0         
	//    8   12:invokevirtual   #48  <Method Class ClassLoader.loadClass(String)>
	//    9   15:invokestatic    #52  <Method boolean zza(Class)>
	//   10   18:istore_1        
		}
	//*  11   19:iload_1         
	//*  12   20:ireturn         
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #59  <Method ClassLoader Context.getClassLoader()>
	//    4    8:aload_2         
	//    5    9:invokestatic    #62  <Method void zza(ClassLoader, Integer)>
		if(intent.getExtras() == null)
			break MISSING_BLOCK_LABEL_48;
	//    6   12:aload_0         
	//    7   13:invokevirtual   #67  <Method Bundle Intent.getExtras()>
	//    8   16:ifnull          48
		context = ((Context) (new Bundle()));
	//    9   19:new             #69  <Class Bundle>
	//   10   22:dup             
	//   11   23:invokespecial   #70  <Method void Bundle()>
	//   12   26:astore_1        
		((Bundle) (context)).putAll(intent.getExtras());
	//   13   27:aload_1         
	//   14   28:aload_0         
	//   15   29:invokevirtual   #67  <Method Bundle Intent.getExtras()>
	//   16   32:invokevirtual   #74  <Method void Bundle.putAll(Bundle)>
	...
	//   21   41:aconst_null     
	//   22   42:aconst_null     
	//   23   43:invokestatic    #62  <Method void zza(ClassLoader, Integer)>
		throw intent;
	//   24   46:aload_0         
	//   25   47:athrow          
		intent = null;
	...
	//   28   50:aconst_null     
	//   29   51:aconst_null     
	//   30   52:invokestatic    #62  <Method void zza(ClassLoader, Integer)>
		return ((Bundle) (intent));
	//   31   55:aload_0         
	//   32   56:areturn         
	}
	...
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:invokevirtual   #80  <Method Parcelable Intent.getParcelableExtra(String)>
	//    9   17:astore_0        
	...
	//   12   22:aconst_null     
	//   13   23:aconst_null     
	//   14   24:invokestatic    #62  <Method void zza(ClassLoader, Integer)>
		throw intent;
	//   15   27:aload_0         
	//   16   28:athrow          
		intent = null;
	...
	//   19   31:aconst_null     
	//   20   32:aconst_null     
	//   21   33:invokestatic    #62  <Method void zza(ClassLoader, Integer)>
		return ((Parcelable) (intent));
	//   22   36:aload_0         
	//   23   37:areturn         
	}
	...
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:invokevirtual   #85  <Method Parcelable Bundle.getParcelable(String)>
	//    9   17:astore_0        
		break MISSING_BLOCK_LABEL_31;
	//   10   18:goto            31
		bundle;
	...
	//*   3    5:monitorenter    
		{
			classloader = zzsk;
	//    4    6:getstatic       #28  <Field ClassLoader zzsk>
	//    5    9:astore_1        
		}
	//    6   10:aload_0         
	//    7   11:monitorexit     
	...
	//*   3    5:monitorenter    
		{
			integer = zzsl;
	//    4    6:getstatic       #30  <Field Integer zzsl>
	//    5    9:astore_1        
		}
	//    6   10:aload_0         
	//    7   11:monitorexit     
	...
	//*   3    5:monitorenter    
		{
			zzsk = classloader;
	//    4    6:aload_0         
	//    5    7:putstatic       #28  <Field ClassLoader zzsk>
			zzsl = integer;
	//    6   10:aload_1         
	//    7   11:putstatic       #30  <Field Integer zzsl>
		}
	//    8   14:aload_2         
	//    9   15:monitorexit     
		return;
	...
	//    6   12:ireturn         
		boolean flag;
		if(!zza(context.getClassLoader().loadClass(((Object)this).getClass().getCanonicalName())))
	//*   7   13:aload_1         
	//*   8   14:invokevirtual   #59  <Method ClassLoader Context.getClassLoader()>
	//*   9   17:aload_0         
	//*  10   18:invokevirtual   #110 <Method Class Object.getClass()>
	//*  11   21:invokevirtual   #116 <Method String Class.getCanonicalName()>
	//*  12   24:invokevirtual   #48  <Method Class ClassLoader.loadClass(String)>
	//*  13   27:invokestatic    #52  <Method boolean zza(Class)>
	//*  14   30:ifne            48
			flag = true;
	//   15   33:iconst_1        
	//   16   34:istore_3        
	...
	//*  18   38:aload_0         
	//*  19   39:iload_3         
	//*  20   40:invokevirtual   #120 <Method void setShouldDowngrade(boolean)>
	//*  21   43:iconst_1        
	//*  22   44:ireturn         
	//*  23   45:astore_1        
	//*  24   46:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #34  <Field boolean zzsm>
	//    3    5:return          
	}
	...
	protected boolean shouldDowngrade()
	{
		return zzsm;
	//    0    0:aload_0         
	//    1    1:getfield        #34  <Field boolean zzsm>
	//    2    4:ireturn         
	}
	...
	//    4   10:aconst_null     
	//    5   11:putstatic       #28  <Field ClassLoader zzsk>
	//    6   14:aconst_null     
	//    7   15:putstatic       #30  <Field Integer zzsl>
	//*   8   18:return          
	}
}
