...
public final class ImageManager
{
	...
	private static final class zza extends LruCache
	{
		...
		//   25   47:aload_0         
		//   26   48:iload_2         
		//   27   49:ldc1            #31  <Int 0x100000>
		//   28   51:imul            
		//   29   52:i2f             
		//   30   53:ldc1            #39  <Float 0.33F>
		//   31   55:fmul            
		//   32   56:f2i             
		...
		implements Runnable
	{
		...
		//   13   22:invokestatic    #55  <Method Bitmap BitmapFactoryInstrumentation.decodeFileDescriptor(java.io.FileDescriptor)>
		//   14   25:astore_3        
			obj = obj1;
		//   15   26:aload_3         
		//   16   27:astore_2        
		...
		//   78  147:iload_1         
		//   79  148:aload_3         
		//   80  149:invokespecial   #105 <Method void ImageManager$zze(ImageManager, Uri, Bitmap, boolean, CountDownLatch)>
	...
	//    6   10:areturn         
			...
			return (Bitmap)zza2.get(((Object) (zza1)));
	//    7   11:aload_2         
	//    8   12:aload_1         
	//    9   13:invokevirtual   #145 <Method Object ImageManager$zza.get(Object)>
	//   10   16:checkcast       #147 <Class Bitmap>
	//   11   19:areturn         
	}
