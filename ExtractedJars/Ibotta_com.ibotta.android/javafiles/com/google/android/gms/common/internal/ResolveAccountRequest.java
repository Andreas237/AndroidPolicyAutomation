...
public class ResolveAccountRequest extends AbstractSafeParcelable
{
	...
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #46  <Field Account zzs>
		zzut = j;
	//    8   14:aload_0         
	//    9   15:iload_3         
	//   10   16:putfield        #48  <Field int zzut>
		zzuu = googlesigninaccount;
	//   11   19:aload_0         
	//   12   20:aload           4
	//   13   22:putfield        #50  <Field GoogleSignInAccount zzuu>
	//   14   25:return          
	}
	...
	public Account getAccount()
	{
		return zzs;
	//    0    0:aload_0         
	//    1    1:getfield        #46  <Field Account zzs>
	//    2    4:areturn         
	}
	...
	public int getSessionId()
	{
		return zzut;
	//    0    0:aload_0         
	//    1    1:getfield        #48  <Field int zzut>
	//    2    4:ireturn         
	}
	...
	public GoogleSignInAccount getSignInAccountHint()
	{
		return zzuu;
	//    0    0:aload_0         
	//    1    1:getfield        #50  <Field GoogleSignInAccount zzuu>
	//    2    4:areturn         
	}
	...
	//    9   15:iconst_2        
	//   10   16:aload_0         
	//   11   17:invokevirtual   #73  <Method Account getAccount()>
	//   12   20:iload_2         
	//   13   21:iconst_0        
	//   14   22:invokestatic    #77  <Method void SafeParcelWriter.writeParcelable(Parcel, int, android.os.Parcelable, int, boolean)>
		SafeParcelWriter.writeInt(parcel, 3, getSessionId());
	//   15   25:aload_1         
	//   16   26:iconst_3        
	//   17   27:aload_0         
	//   18   28:invokevirtual   #79  <Method int getSessionId()>
	//   19   31:invokestatic    #71  <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeParcelable(parcel, 4, ((android.os.Parcelable) (getSignInAccountHint())), i, false);
	//   20   34:aload_1         
	//   21   35:iconst_4        
	//   22   36:aload_0         
	//   23   37:invokevirtual   #81  <Method GoogleSignInAccount getSignInAccountHint()>
	//   24   40:iload_2         
	//   25   41:iconst_0        
	//   26   42:invokestatic    #77  <Method void SafeParcelWriter.writeParcelable(Parcel, int, android.os.Parcelable, int, boolean)>
		SafeParcelWriter.finishObjectHeader(parcel, j);
	//   27   45:aload_1         
	//   28   46:iload_3         
	//   29   47:invokestatic    #84  <Method void SafeParcelWriter.finishObjectHeader(Parcel, int)>
	//   30   50:return          
	}
	...
	static 
	{
	//    0    0:new             #32  <Class ResolveAccountRequestCreator>
	//    1    3:dup             
	//    2    4:invokespecial   #35  <Method void ResolveAccountRequestCreator()>
