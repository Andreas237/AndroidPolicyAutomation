...
public abstract class BasePendingResult extends PendingResult
{
	...
	//*  18   34:aload_0         
	//*  19   35:getfield        #146 <Field Result zzdm>
	//*  20   38:astore_3        
	//*  21   39:aload_0         
	//*  22   40:aconst_null     
	//*  23   41:putfield        #146 <Field Result zzdm>
	//*  24   44:aload_0         
	//*  25   45:aconst_null     
	//*  26   46:putfield        #148 <Field ResultCallback zzff>
	//*  27   49:aload_0         
	//*  28   50:iconst_1        
	//*  29   51:putfield        #132 <Field boolean zzfh>
	//*  30   54:aload_2         
	//*  31   55:monitorexit     
	//*  32   56:aload_0         
	//*  33   57:getfield        #86  <Field AtomicReference zzfg>
	//*  34   60:aconst_null     
	//*  35   61:invokevirtual   #152 <Method Object AtomicReference.getAndSet(Object)>
	//*  36   64:checkcast       #154 <Class zzcn>
	//*  37   67:astore_2        
	//*  38   68:aload_2         
	//*  39   69:ifnull          79
	//*  40   72:aload_2         
	//*  41   73:aload_0         
	//*  42   74:invokeinterface #158 <Method void zzcn.zzc(BasePendingResult)>
	//*  43   79:aload_3         
	//*  44   80:areturn         
	//*  45   81:astore_3        
	//*  46   82:aload_2         
	...
	//    5    9:aload_0         
	//    6   10:getfield        #317 <Field boolean zzfj>
	//    7   13:ifne            79
	//    8   16:aload_0         
	//    9   17:getfield        #176 <Field boolean zzfi>
	//   10   20:ifne            79
		isReady();
	//   11   23:aload_0         
	...
	//*  27   51:aload_0         
	//*  28   52:getfield        #132 <Field boolean zzfh>
	//*  29   55:ifne            98
	//*  30   58:iload_3         
	//*  31   59:istore_2        
	//*  32   60:goto            63
	...
	//*  36   70:aload_0         
	//*  37   71:aload_1         
	//*  38   72:invokespecial   #307 <Method void zza(Result)>
	//*  39   75:aload           4
	//*  40   77:monitorexit     
	//*  41   78:return          
	//*  42   79:aload_1         
	//*  43   80:invokestatic    #298 <Method void zzb(Result)>
	//*  44   83:aload           4
	//*  45   85:monitorexit     
	//*  46   86:return          
	//*  47   87:astore_1        
	...
	//*  26   44:aload_0         
	//*  27   45:getfield        #268 <Field zzch zzfl>
	//*  28   48:ifnonnull       116
	//*  29   51:iload_3         
	//*  30   52:istore_2        
	//*  31   53:goto            56
	...
	//*  43   78:ifeq            96
	//*  44   81:aload_0         
	//*  45   82:getfield        #99  <Field BasePendingResult$CallbackHandler zzfb>
	//*  46   85:aload_1         
	//*  47   86:aload_0         
	//*  48   87:invokespecial   #188 <Method Result get()>
	//*  49   90:invokevirtual   #191 <Method void BasePendingResult$CallbackHandler.zza(ResultCallback, Result)>
	//*  50   93:goto            101
	//*  51   96:aload_0         
	//*  52   97:aload_1         
	//*  53   98:putfield        #148 <Field ResultCallback zzff>
	//*  54  101:aload           4
	//*  55  103:monitorexit     
	//*  56  104:return          
	//*  57  105:astore_1        
	...
	//*  26   49:aload_0         
	//*  27   50:getfield        #268 <Field zzch zzfl>
	//*  28   53:ifnonnull       149
	//*  29   56:iload           6
	//*  30   58:istore          5
	//*  31   60:goto            63
	...
	//*  43   86:ifeq            104
	//*  44   89:aload_0         
	//*  45   90:getfield        #99  <Field BasePendingResult$CallbackHandler zzfb>
	//*  46   93:aload_1         
	//*  47   94:aload_0         
	//*  48   95:invokespecial   #188 <Method Result get()>
	//*  49   98:invokevirtual   #191 <Method void BasePendingResult$CallbackHandler.zza(ResultCallback, Result)>
	//*  50  101:goto            133
	//*  51  104:aload_0         
	//*  52  105:aload_1         
	//*  53  106:putfield        #148 <Field ResultCallback zzff>
	//*  54  109:aload_0         
	//*  55  110:getfield        #99  <Field BasePendingResult$CallbackHandler zzfb>
	//*  56  113:astore_1        
	//*  57  114:aload           4
	//*  58  116:lload_2         
	...
	//*  24   45:aload_0         
	//*  25   46:getfield        #148 <Field ResultCallback zzff>
	//*  26   49:ifnonnull       160
	//*  27   52:iconst_1        
	//*  28   53:istore_2        
	//*  29   54:goto            57
	...
	//*  34   65:istore_2        
	//*  35   66:aload_0         
	//*  36   67:getfield        #176 <Field boolean zzfi>
	//*  37   70:ifne            75
	//*  38   73:iconst_1        
	//*  39   74:istore_2        
	//*  40   75:iload_2         
	...
	//*  43   82:aload_0         
	//*  44   83:iconst_1        
	//*  45   84:putfield        #88  <Field boolean zzfm>
	//*  46   87:aload_0         
	//*  47   88:new             #352 <Class zzch>
	//*  48   91:dup             
	//*  49   92:aload_0         
	//*  50   93:getfield        #106 <Field WeakReference zzfc>
	//*  51   96:invokespecial   #355 <Method void zzch(WeakReference)>
	//*  52   99:putfield        #268 <Field zzch zzfl>
	//*  53  102:aload_0         
	//*  54  103:getfield        #268 <Field zzch zzfl>
	//*  55  106:aload_1         
	...
	//*  60  115:ifeq            136
	//*  61  118:aload_0         
	//*  62  119:getfield        #99  <Field BasePendingResult$CallbackHandler zzfb>
	//*  63  122:aload_0         
	//*  64  123:getfield        #268 <Field zzch zzfl>
	//*  65  126:aload_0         
	//*  66  127:invokespecial   #188 <Method Result get()>
	//*  67  130:invokevirtual   #191 <Method void BasePendingResult$CallbackHandler.zza(ResultCallback, Result)>
	//*  68  133:goto            144
	//*  69  136:aload_0         
	//*  70  137:aload_0         
	//*  71  138:getfield        #268 <Field zzch zzfl>
	//*  72  141:putfield        #148 <Field ResultCallback zzff>
	//*  73  144:aload           4
	//*  74  146:monitorexit     
	//*  75  147:aload_1         
	//*  76  148:areturn         
