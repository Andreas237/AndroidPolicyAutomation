	...
	implements DataBuffer
{
	...
	public void close()
	{
		((AbstractDataBuffer)((Response)this).getResult()).close();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	...
	{
		return ((AbstractDataBuffer)((Response)this).getResult()).get(i);
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	//    2    4:checkcast       #29  <Class AbstractDataBuffer>
	//    3    7:iload_1         
	...
	public int getCount()
	{
		return ((AbstractDataBuffer)((Response)this).getResult()).getCount();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	//    2    4:checkcast       #29  <Class AbstractDataBuffer>
	...
	{
		return ((AbstractDataBuffer)((Response)this).getResult()).getMetadata();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	//    2    4:checkcast       #29  <Class AbstractDataBuffer>
	...
	{
		return ((AbstractDataBuffer)((Response)this).getResult()).isClosed();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	//    2    4:checkcast       #29  <Class AbstractDataBuffer>
	...
	{
		return ((AbstractDataBuffer)((Response)this).getResult()).iterator();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	//    2    4:checkcast       #29  <Class AbstractDataBuffer>
	...
	public void release()
	{
		((AbstractDataBuffer)((Response)this).getResult()).release();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	//    2    4:checkcast       #29  <Class AbstractDataBuffer>
	...
	{
		return ((AbstractDataBuffer)((Response)this).getResult()).singleRefIterator();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #27  <Method Result Response.getResult()>
	//    2    4:checkcast       #29  <Class AbstractDataBuffer>
