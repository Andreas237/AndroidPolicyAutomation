...
public final class PostProcessedResourceCache extends LruCache
{
	public static final class PostProcessedResource
	{
		...
		//    8   14:iconst_1        
		//    9   15:ireturn         
			obj = ((Object) ((PostProcessedResource)obj));
		//   10   16:aload_1         
		//   11   17:checkcast       #2   <Class PostProcessedResourceCache$PostProcessedResource>
		//   12   20:astore_1        
			return ((PostProcessedResource) (obj)).resId == resId && ((PostProcessedResource) (obj)).postProcessingFlags == postProcessingFlags;
		//   13   21:aload_1         
	...
	//    0    0:aload_0         
	//    1    1:bipush          10
	//    2    3:invokespecial   #13  <Method void LruCache(int)>
	//    3    6:return          
	}
}
