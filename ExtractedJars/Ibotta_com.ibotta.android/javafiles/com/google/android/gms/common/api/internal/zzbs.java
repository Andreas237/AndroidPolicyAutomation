...
//			zzbr, LifecycleCallback

final class zzbs
	implements Runnable
{

	zzbs(zzbr zzbr1, LifecycleCallback lifecyclecallback, String s)
	{
		zzlg = zzbr1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #16  <Field zzbr zzlg>
	...
	public final void run()
	{
		if(zzbr.zza(zzlg) > 0)
	//*   0    0:aload_0         
	//*   1    1:getfield        #16  <Field zzbr zzlg>
	//*   2    4:invokestatic    #31  <Method int zzbr.zza(zzbr)>
	//*   3    7:ifle            50
		{
	...
	//    6   14:astore_2        
			Bundle bundle;
			if(zzbr.zzb(zzlg) != null)
	//*   7   15:aload_0         
	//*   8   16:getfield        #16  <Field zzbr zzlg>
	//*   9   19:invokestatic    #35  <Method Bundle zzbr.zzb(zzbr)>
	//*  10   22:ifnull          43
				bundle = zzbr.zzb(zzlg).getBundle(zzlf);
	//   11   25:aload_0         
	//   12   26:getfield        #16  <Field zzbr zzlg>
	//   13   29:invokestatic    #35  <Method Bundle zzbr.zzb(zzbr)>
	//   14   32:aload_0         
	...
	//   23   47:invokevirtual   #47  <Method void LifecycleCallback.onCreate(Bundle)>
		...
		if(zzbr.zza(zzlg) >= 2)
	//*  24   50:aload_0         
	//*  25   51:getfield        #16  <Field zzbr zzlg>
	//*  26   54:invokestatic    #31  <Method int zzbr.zza(zzbr)>
	//*  27   57:iconst_2        
	//*  28   58:icmplt          68
			zzle.onStart();
	//   29   61:aload_0         
	...
	//   31   65:invokevirtual   #50  <Method void LifecycleCallback.onStart()>
		if(zzbr.zza(zzlg) >= 3)
	//*  32   68:aload_0         
	//*  33   69:getfield        #16  <Field zzbr zzlg>
	//*  34   72:invokestatic    #31  <Method int zzbr.zza(zzbr)>
	//*  35   75:iconst_3        
	//*  36   76:icmplt          86
			zzle.onResume();
	//   37   79:aload_0         
	...
	//   39   83:invokevirtual   #53  <Method void LifecycleCallback.onResume()>
		if(zzbr.zza(zzlg) >= 4)
	//*  40   86:aload_0         
	//*  41   87:getfield        #16  <Field zzbr zzlg>
	//*  42   90:invokestatic    #31  <Method int zzbr.zza(zzbr)>
	//*  43   93:iconst_4        
	//*  44   94:icmplt          104
			zzle.onStop();
	//   45   97:aload_0         
	...
	//   47  101:invokevirtual   #56  <Method void LifecycleCallback.onStop()>
		if(zzbr.zza(zzlg) >= 5)
	//*  48  104:aload_0         
	//*  49  105:getfield        #16  <Field zzbr zzlg>
	//*  50  108:invokestatic    #31  <Method int zzbr.zza(zzbr)>
	//*  51  111:iconst_5        
	//*  52  112:icmplt          122
			zzle.onDestroy();
	//   53  115:aload_0         
