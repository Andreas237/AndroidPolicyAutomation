	...
	implements ReflectedParcelable
{
	...
	//    5    9:ldc1            #83  <String "teleporter">
	//    6   11:ldc1            #85  <String ".tmp">
	//    7   13:aload_1         
	//    8   14:invokestatic    #91  <Method File File.createTempFile(String, String, File)>
	//    9   17:astore_1        
			}
	//*  10   18:new             #93  <Class FileOutputStream>
	//*  11   21:dup             
	//*  12   22:aload_1         
	//*  13   23:invokespecial   #96  <Method void FileOutputStream(File)>
	//*  14   26:astore_2        
	//*  15   27:aload_0         
	//*  16   28:aload_1         
	//*  17   29:ldc1            #97  <Int 0x10000000>
	//*  18   31:invokestatic    #103 <Method ParcelFileDescriptor ParcelFileDescriptor.open(File, int)>
	//*  19   34:putfield        #47  <Field ParcelFileDescriptor zznb>
	//*  20   37:aload_1         
	//*  21   38:invokevirtual   #107 <Method boolean File.delete()>
	//*  22   41:pop             
	//*  23   42:aload_2         
	//*  24   43:areturn         
	//*  25   44:new             #109 <Class IllegalStateException>
	//*  26   47:dup             
	//*  27   48:ldc1            #111 <String "Temporary file is somehow already deleted">
	//*  28   50:invokespecial   #114 <Method void IllegalStateException(String)>
	//*  29   53:athrow          
			catch(IOException ioexception)
	//*  30   54:astore_1        
			{
				throw new IllegalStateException("Could not create temporary file", ((Throwable) (ioexception)));
	//   31   55:new             #109 <Class IllegalStateException>
	//   32   58:dup             
	//   33   59:ldc1            #116 <String "Could not create temporary file">
	//   34   61:aload_1         
	//   35   62:invokespecial   #119 <Method void IllegalStateException(String, Throwable)>
	//   36   65:athrow          
			}
			try
			{
	...
	//*  37   66:new             #109 <Class IllegalStateException>
	//*  38   69:dup             
	//*  39   70:ldc1            #121 <String "setTempDir() must be called before writing this object to a parcel">
	//*  40   72:invokespecial   #114 <Method void IllegalStateException(String)>
	//*  41   75:athrow          
			// Misplaced declaration of an exception variable
	...
	//   53  106:new             #109 <Class IllegalStateException>
	//   54  109:dup             
	//   55  110:ldc1            #171 <String "Could not read from parcel file descriptor">
	//   56  112:aload           4
	//   57  114:invokespecial   #119 <Method void IllegalStateException(String, Throwable)>
	//   58  117:athrow          
		zza(((Closeable) (obj)));
	//   59  118:aload_3         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #81  <Field File zzne>
			return;
	//    5    9:return          
		} else
		{
			throw new NullPointerException("Cannot set null temp directory");
	//    6   10:new             #178 <Class NullPointerException>
	//    7   13:dup             
	//    8   14:ldc1            #180 <String "Cannot set null temp directory">
	//    9   16:invokespecial   #181 <Method void NullPointerException(String)>
	//   10   19:athrow          
		}
	}
	...
	//   54  124:new             #109 <Class IllegalStateException>
	//   55  127:dup             
	//   56  128:ldc1            #233 <String "Could not write into unlinked file">
	//   57  130:aload_1         
	//   58  131:invokespecial   #119 <Method void IllegalStateException(String, Throwable)>
	//   59  134:athrow          
		zza(((Closeable) (obj)));
	//   60  135:aload           4
