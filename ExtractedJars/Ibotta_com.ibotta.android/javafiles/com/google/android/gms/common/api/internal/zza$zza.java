...
//			LifecycleCallback, zza, LifecycleFragment

static class zza$zza extends LifecycleCallback
{

	private static zza$zza zza(Activity activity)
	{
		activity;
	//    0    0:aload_0         
	...
	//    4    6:astore_3        
		zza$zza2 = (zza$zza)lifecyclefragment.getCallbackOrNull("LifecycleObserverOnStop", com/google/android/gms/common/api/internal/zza$zza);
	//    5    7:aload_3         
	//    6    8:ldc1            #30  <String "LifecycleObserverOnStop">
	//    7   10:ldc1            #2   <Class zza$zza>
	//    8   12:invokeinterface #46  <Method LifecycleCallback LifecycleFragment.getCallbackOrNull(String, Class)>
	//    9   17:checkcast       #2   <Class zza$zza>
	//   10   20:astore_2        
		zza$zza zza$zza1;
		zza$zza1 = zza$zza2;
	//   11   21:aload_2         
	...
	//   13   23:aload_2         
	//   14   24:ifnonnull       36
		zza$zza1 = new zza$zza(lifecyclefragment);
	//   15   27:new             #2   <Class zza$zza>
	//   16   30:dup             
	//   17   31:aload_3         
	//   18   32:invokespecial   #47  <Method void zza$zza(LifecycleFragment)>
	//   19   35:astore_1        
		activity;
	//   20   36:aload_0         
	...
	static void zza(zza$zza zza$zza1, Runnable runnable)
	{
		zza$zza1.zza(runnable);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #51  <Method void zza(Runnable)>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
		JVM INSTR monitorenter ;
	//    1    1:monitorenter    
		zzdt.add(((Object) (runnable)));
	//    2    2:aload_0         
	//    3    3:getfield        #24  <Field List zzdt>
	//    4    6:aload_1         
	...
	static zza$zza zzb(Activity activity)
	{
		return zza(activity);
	//    0    0:aload_0         
	//    1    1:invokestatic    #60  <Method zza$zza zza(Activity)>
	//    2    4:areturn         
	}
	...
	private zza$zza(LifecycleFragment lifecyclefragment)
	{
	...
	//    7   13:putfield        #24  <Field List zzdt>
