...
public class HttpUtils
{
	...
	//   46   84:aaload          
	//   47   85:aload_1         
	//   48   86:invokestatic    #113 <Method String decode(String, String)>
	//   49   89:astore          4
						uri = null;
	//   50   91:aconst_null     
	//   51   92:astore_0        
	...
	//   58  103:aaload          
	//   59  104:aload_1         
	//   60  105:invokestatic    #113 <Method String decode(String, String)>
	//   61  108:astore_0        
						((Map) (hashmap)).put(((Object) (s1)), ((Object) (uri)));
	//   62  109:aload_2         
	//   63  110:aload           4
	//   64  112:aload_0         
	//   65  113:invokeinterface #119 <Method Object Map.put(Object, Object)>
	//   66  118:pop             
					} else
	//*  67  119:goto            48
					{
						throw new IllegalArgumentException("bad parameter");
	//   68  122:new             #44  <Class IllegalArgumentException>
	//   69  125:dup             
	//   70  126:ldc1            #121 <String "bad parameter">
	//   71  128:invokespecial   #122 <Method void IllegalArgumentException(String)>
	//   72  131:athrow          
					}
				} while(true);
			}
