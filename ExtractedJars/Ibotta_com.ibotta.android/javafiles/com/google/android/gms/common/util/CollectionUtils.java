...
public final class CollectionUtils
{
	...
	//   12   14:new             #307 <Class StringBuilder>
	//   13   17:dup             
	//   14   18:bipush          66
	//   15   20:invokespecial   #310 <Method void StringBuilder(int)>
	//   16   23:astore_0        
			((StringBuilder) (aobj)).append("Key and values array lengths not equal: ");
	//   17   24:aload_0         
	//   18   25:ldc2            #312 <String "Key and values array lengths not equal: ">
	//   19   28:invokevirtual   #316 <Method StringBuilder StringBuilder.append(String)>
	//   20   31:pop             
			((StringBuilder) (aobj)).append(i);
	//   21   32:aload_0         
	//   22   33:iload_2         
	//   23   34:invokevirtual   #319 <Method StringBuilder StringBuilder.append(int)>
	//   24   37:pop             
			((StringBuilder) (aobj)).append(" != ");
	//   25   38:aload_0         
	//   26   39:ldc2            #321 <String " != ">
	//   27   42:invokevirtual   #316 <Method StringBuilder StringBuilder.append(String)>
	//   28   45:pop             
			((StringBuilder) (aobj)).append(j);
	//   29   46:aload_0         
	//   30   47:iload_3         
	//   31   48:invokevirtual   #319 <Method StringBuilder StringBuilder.append(int)>
	//   32   51:pop             
			throw new IllegalArgumentException(((StringBuilder) (aobj)).toString());
	//   33   52:new             #323 <Class IllegalArgumentException>
	//   34   55:dup             
	//   35   56:aload_0         
	//   36   57:invokevirtual   #327 <Method String StringBuilder.toString()>
	//   37   60:invokespecial   #330 <Method void IllegalArgumentException(String)>
	//   38   63:athrow          
		}
	}
