...
label0:
	...
	//    1    3:aload_0         
	//    2    4:invokevirtual   #48  <Method Object WeakHashMap.get(Object)>
	//    3    7:checkcast       #50  <Class WeakReference>
	//    4   10:astore_1        
			if(obj != null)
	//*   5   11:aload_1         
	//*   6   12:ifnull          29
	...
	//    7   15:aload_1         
	//    8   16:invokevirtual   #53  <Method Object WeakReference.get()>
	...
	//   15   29:aload_0         
	//   16   30:invokevirtual   #59  <Method FragmentManager FragmentActivity.getSupportFragmentManager()>
	//   17   33:ldc1            #61  <String "SupportLifecycleFragmentImpl">
	//   18   35:invokevirtual   #67  <Method Fragment FragmentManager.findFragmentByTag(String)>
	...
	//*  24   47:astore_1        
	//*  25   48:aload_2         
	//*  26   49:invokevirtual   #71  <Method boolean isRemoving()>
	//*  27   52:ifeq            80
	//*  28   55:new             #2   <Class zzcc>
	//*  29   58:dup             
	//*  30   59:invokespecial   #72  <Method void zzcc()>
	//*  31   62:astore_1        
	//*  32   63:aload_0         
	//*  33   64:invokevirtual   #59  <Method FragmentManager FragmentActivity.getSupportFragmentManager()>
	//*  34   67:invokevirtual   #76  <Method FragmentTransaction FragmentManager.beginTransaction()>
	//*  35   70:aload_1         
	//*  36   71:ldc1            #61  <String "SupportLifecycleFragmentImpl">
	//*  37   73:invokevirtual   #82  <Method FragmentTransaction FragmentTransaction.add(Fragment, String)>
	//*  38   76:invokevirtual   #86  <Method int FragmentTransaction.commitAllowingStateLoss()>
	//*  39   79:pop             
	//*  40   80:getstatic       #30  <Field WeakHashMap zzla>
	//*  41   83:aload_0         
	//*  42   84:new             #50  <Class WeakReference>
	//*  43   87:dup             
	//*  44   88:aload_1         
	//*  45   89:invokespecial   #89  <Method void WeakReference(Object)>
	//*  46   92:invokevirtual   #93  <Method Object WeakHashMap.put(Object, Object)>
	//*  47   95:pop             
	//*  48   96:aload_1         
	//*  49   97:areturn         
	...
	//   51   99:new             #95  <Class IllegalStateException>
	//   52  102:dup             
	//   53  103:ldc1            #97  <String "Fragment with tag SupportLifecycleFragmentImpl is not a SupportLifecycleFragmentImpl">
	//   54  105:aload_0         
	//   55  106:invokespecial   #100 <Method void IllegalStateException(String, Throwable)>
	//   56  109:athrow          
			}
			if(zzcc1 != null)
			{
	...
	static Bundle zzb(zzcc zzcc1)
	{
		return zzcc1.zzld;
	//    0    0:aload_0         
	//    1    1:getfield        #104 <Field Bundle zzld>
	//    2    4:areturn         
	}
	...
	//*   2    4:aload_1         
	//*   3    5:invokeinterface #113 <Method boolean Map.containsKey(Object)>
	//*   4   10:ifne            57
		{
	...
	//    7   17:aload_1         
	//    8   18:aload_2         
	//    9   19:invokeinterface #114 <Method Object Map.put(Object, Object)>
	//   10   24:pop             
			if(zzlc > 0)
	//*  11   25:aload_0         
	...
	//   14   32:new             #116 <Class Handler>
	//   15   35:dup             
	//   16   36:invokestatic    #122 <Method Looper Looper.getMainLooper()>
	//   17   39:invokespecial   #125 <Method void Handler(Looper)>
	//   18   42:new             #127 <Class zzcd>
	//   19   45:dup             
	//   20   46:aload_0         
	//   21   47:aload_2         
	//   22   48:aload_1         
	//   23   49:invokespecial   #130 <Method void zzcd(zzcc, LifecycleCallback, String)>
	//   24   52:invokevirtual   #134 <Method boolean Handler.post(Runnable)>
	//   25   55:pop             
			return;
	//   26   56:return          
		} else
	...
	//   27   57:new             #136 <Class StringBuilder>
	//   28   60:dup             
	//   29   61:aload_1         
	//   30   62:invokestatic    #142 <Method String String.valueOf(Object)>
	//   31   65:invokevirtual   #145 <Method int String.length()>
	//   32   68:bipush          59
	//   33   70:iadd            
	//   34   71:invokespecial   #148 <Method void StringBuilder(int)>
	//   35   74:astore_2        
			((StringBuilder) (lifecyclecallback)).append("LifecycleCallback with tag ");
	//   36   75:aload_2         
	//   37   76:ldc1            #150 <String "LifecycleCallback with tag ">
	//   38   78:invokevirtual   #154 <Method StringBuilder StringBuilder.append(String)>
	//   39   81:pop             
			((StringBuilder) (lifecyclecallback)).append(s);
	//   40   82:aload_2         
	//   41   83:aload_1         
	//   42   84:invokevirtual   #154 <Method StringBuilder StringBuilder.append(String)>
	//   43   87:pop             
			((StringBuilder) (lifecyclecallback)).append(" already added to this fragment.");
	//   44   88:aload_2         
	//   45   89:ldc1            #156 <String " already added to this fragment.">
	//   46   91:invokevirtual   #154 <Method StringBuilder StringBuilder.append(String)>
	//   47   94:pop             
			throw new IllegalArgumentException(((StringBuilder) (lifecyclecallback)).toString());
	//   48   95:new             #158 <Class IllegalArgumentException>
	//   49   98:dup             
	//   50   99:aload_2         
	//   51  100:invokevirtual   #162 <Method String StringBuilder.toString()>
	//   52  103:invokespecial   #165 <Method void IllegalArgumentException(String)>
	//   53  106:athrow          
		}
	}
	...
	//    3    3:aload_3         
	//    4    4:aload           4
	//    5    6:invokespecial   #170 <Method void Fragment.dump(String, FileDescriptor, PrintWriter, String[])>
	...
	//    8   13:invokeinterface #174 <Method Collection Map.values()>
	//    9   18:invokeinterface #180 <Method Iterator Collection.iterator()>
	//   10   23:astore          5
	//   11   25:aload           5
	//   12   27:invokeinterface #185 <Method boolean Iterator.hasNext()>
	//   13   32:ifeq            56
	//   14   35:aload           5
	//   15   37:invokeinterface #188 <Method Object Iterator.next()>
	//   16   42:checkcast       #190 <Class LifecycleCallback>
	//   17   45:aload_1         
	//   18   46:aload_2         
	//   19   47:aload_3         
	//   20   48:aload           4
	//   21   50:invokevirtual   #191 <Method void LifecycleCallback.dump(String, FileDescriptor, PrintWriter, String[])>
	//*  22   53:goto            25
	//   23   56:return          
	}
	...
	//    3    5:aload_1         
	//    4    6:invokeinterface #194 <Method Object Map.get(Object)>
	//    5   11:invokevirtual   #199 <Method Object Class.cast(Object)>
	//    6   14:checkcast       #190 <Class LifecycleCallback>
	//    7   17:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #207 <Method FragmentActivity getActivity()>
	//    2    4:areturn         
	}
	...
	//    7   11:invokeinterface #174 <Method Collection Map.values()>
	//    8   16:invokeinterface #180 <Method Iterator Collection.iterator()>
	//    9   21:astore          4
	//   10   23:aload           4
	//   11   25:invokeinterface #185 <Method boolean Iterator.hasNext()>
	//   12   30:ifeq            52
	//   13   33:aload           4
	//   14   35:invokeinterface #188 <Method Object Iterator.next()>
	//   15   40:checkcast       #190 <Class LifecycleCallback>
	//   16   43:iload_1         
	//   17   44:iload_2         
	//   18   45:aload_3         
	...
	{
		TraceMachine.startTracing("zzcc");
	//    0    0:ldc1            #220 <String "zzcc">
	//    1    2:invokestatic    #225 <Method void TraceMachine.startTracing(String)>
		TraceMachine.enterMethod(_nr_trace, "zzcc#onCreate", ((java.util.ArrayList) (null)));
	//    2    5:aload_0         
	//    3    6:getfield        #227 <Field Trace _nr_trace>
	//    4    9:ldc1            #229 <String "zzcc#onCreate">
	//    5   11:aconst_null     
	//    6   12:invokestatic    #233 <Method void TraceMachine.enterMethod(Trace, String, java.util.ArrayList)>
		  goto _L1
	//*   7   15:goto            25
_L3:
		TraceMachine.enterMethod(((Trace) (null)), "zzcc#onCreate", ((java.util.ArrayList) (null)));
	//    8   18:aconst_null     
	//    9   19:ldc1            #229 <String "zzcc#onCreate">
	//   10   21:aconst_null     
...
_L1:
	...
	//   18   35:aload_0         
	//   19   36:aload_1         
	//   20   37:putfield        #104 <Field Bundle zzld>
		Object obj;
	...
	//*  25   54:astore_3        
	//*  26   55:aload_3         
	//*  27   56:invokeinterface #185 <Method boolean Iterator.hasNext()>
	//*  28   61:ifeq            117
		{
			obj = ((Object) ((java.util.Map.Entry)iterator.next()));
	//   29   64:aload_3         
	//   30   65:invokeinterface #188 <Method Object Iterator.next()>
	...
	//   35   80:checkcast       #190 <Class LifecycleCallback>
	//   36   83:astore          4
			if(bundle != null)
	//*  37   85:aload_1         
	//*  38   86:ifnull          106
	...
	//   42   96:checkcast       #138 <Class String>
...
_L2:
	...
	//    7   13:invokeinterface #174 <Method Collection Map.values()>
	//    8   18:invokeinterface #180 <Method Iterator Collection.iterator()>
	//    9   23:astore_1        
	//   10   24:aload_1         
	//   11   25:invokeinterface #185 <Method boolean Iterator.hasNext()>
	//   12   30:ifeq            48
	//   13   33:aload_1         
	//   14   34:invokeinterface #188 <Method Object Iterator.next()>
	//   15   39:checkcast       #190 <Class LifecycleCallback>
	...
	//*  10   24:astore_2        
	//*  11   25:aload_2         
	//*  12   26:invokeinterface #185 <Method boolean Iterator.hasNext()>
	//*  13   31:ifeq            85
		{
			entry = (java.util.Map.Entry)iterator.next();
	//   14   34:aload_2         
	//   15   35:invokeinterface #188 <Method Object Iterator.next()>
	...
	//   24   59:checkcast       #190 <Class LifecycleCallback>
	//   25   62:aload           4
	...
	//   30   74:checkcast       #138 <Class String>
	//   31   77:aload           4
	...
	//   10   20:invokeinterface #174 <Method Collection Map.values()>
	//   11   25:invokeinterface #180 <Method Iterator Collection.iterator()>
	//   12   30:astore_1        
	//   13   31:aload_1         
	//   14   32:invokeinterface #185 <Method boolean Iterator.hasNext()>
	//   15   37:ifeq            55
	//   16   40:aload_1         
	//   17   41:invokeinterface #188 <Method Object Iterator.next()>
	//   18   46:checkcast       #190 <Class LifecycleCallback>
