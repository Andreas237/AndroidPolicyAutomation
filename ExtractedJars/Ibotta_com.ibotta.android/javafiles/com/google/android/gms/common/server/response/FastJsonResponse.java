...
public abstract class FastJsonResponse
{
	public static class Field extends AbstractSafeParcelable
	{
		...
		{
			FieldConverter fieldconverter = zzwo;
		//    0    0:aload_0         
		//    1    1:getfield        #93  <Field FastJsonResponse$FieldConverter zzwo>
		//    2    4:astore_1        
	...
	//    7   17:dup             
	//    8   18:aload_0         
	//    9   19:invokestatic    #187 <Method String String.valueOf(Object)>
	//   10   22:invokevirtual   #190 <Method int String.length()>
	//   11   25:bipush          58
	//   12   27:iadd            
	...
	//   52  101:dup             
	//   53  102:aload_1         
	//   54  103:invokestatic    #187 <Method String String.valueOf(Object)>
	//   55  106:invokevirtual   #190 <Method int String.length()>
	//   56  109:iconst_4        
	//   57  110:iadd            
...
_L9:
	...
	//*  40  102:goto            109
			s = ",";
	//   41  105:ldc2            #608 <String ",">
	//   42  108:astore_3        
		stringbuilder.append(s);
	//   43  109:aload           4
	//   44  111:aload_3         
	//   45  112:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   46  115:pop             
		stringbuilder.append("\"");
	//   47  116:aload           4
	//   48  118:ldc1            #17  <String "\"">
	//   49  120:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   50  123:pop             
		stringbuilder.append(s2);
	//   51  124:aload           4
	//   52  126:aload           8
	//   53  128:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   54  131:pop             
		stringbuilder.append("\":");
	//   55  132:aload           4
	//   56  134:ldc2            #610 <String "\":">
	//   57  137:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   58  140:pop             
		if(obj2 != null) goto _L2; else goto _L1
	//   59  141:aload           9
	//   60  143:ifnonnull       160
_L1:
		Object obj = "null";
	//   61  146:ldc2            #612 <String "null">
	//   62  149:astore_3        
_L7:
		stringbuilder.append(((String) (obj)));
	//   63  150:aload           4
	//   64  152:aload_3         
	//   65  153:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   66  156:pop             
		continue; /* Loop/switch isn't completed */
	//   67  157:goto            31
_L2:
		field.getTypeOut();
	//   68  160:aload           7
	//   69  162:invokevirtual   #62  <Method int FastJsonResponse$Field.getTypeOut()>
		JVM INSTR tableswitch 8 10: default 192
	//	               8 258
	//	               9 238
	//	               10 225;
	//   70  165:tableswitch     8 10: default 192
	//	               8 258
	//	               9 238
	//	               10 225
		   goto _L3 _L4 _L5 _L6
	//*  71  192:aload           7
	//*  72  194:invokevirtual   #615 <Method boolean FastJsonResponse$Field.isTypeInArray()>
	//*  73  197:ifeq            341
	//*  74  200:aload           9
	//*  75  202:checkcast       #617 <Class ArrayList>
	//*  76  205:astore_3        
	//*  77  206:aload           4
	//*  78  208:ldc2            #619 <String "[">
	//*  79  211:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//*  80  214:pop             
	//*  81  215:iconst_0        
	//*  82  216:istore_1        
	//*  83  217:aload_3         
	//*  84  218:invokevirtual   #622 <Method int ArrayList.size()>
	//*  85  221:istore_2        
	//*  86  222:goto            288
_L6:
	...
	//   87  225:aload           4
	//   88  227:aload           9
	//   89  229:checkcast       #624 <Class HashMap>
	//   90  232:invokestatic    #630 <Method void MapUtils.writeStringMapToJson(StringBuilder, HashMap)>
		continue; /* Loop/switch isn't completed */
	//   91  235:goto            31
_L5:
		stringbuilder.append("\"");
	//   92  238:aload           4
	//   93  240:ldc1            #17  <String "\"">
	//   94  242:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//   95  245:pop             
		obj = ((Object) (Base64Utils.encodeUrlSafe((byte[])obj2)));
	//   96  246:aload           9
	//   97  248:checkcast       #89  <Class byte[]>
	//   98  251:invokestatic    #636 <Method String Base64Utils.encodeUrlSafe(byte[])>
	//   99  254:astore_3        
		break; /* Loop/switch isn't completed */
	//  100  255:goto            275
_L4:
		stringbuilder.append("\"");
	//  101  258:aload           4
	//  102  260:ldc1            #17  <String "\"">
	//  103  262:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//  104  265:pop             
		obj = ((Object) (Base64Utils.encode((byte[])obj2)));
	//  105  266:aload           9
	//  106  268:checkcast       #89  <Class byte[]>
	//  107  271:invokestatic    #639 <Method String Base64Utils.encode(byte[])>
	//  108  274:astore_3        
		stringbuilder.append(((String) (obj)));
	//  109  275:aload           4
	//  110  277:aload_3         
	//  111  278:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//  112  281:pop             
		obj = "\"";
	//  113  282:ldc1            #17  <String "\"">
	//  114  284:astore_3        
		  goto _L7
_L3:
	...
	//* 120  294:ifle            306
				stringbuilder.append(",");
	//  121  297:aload           4
	//  122  299:ldc2            #608 <String ",">
	//  123  302:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//  124  305:pop             
			Object obj1 = ((ArrayList) (obj)).get(i);
	//  125  306:aload_3         
	//  126  307:iload_1         
	//  127  308:invokevirtual   #642 <Method Object ArrayList.get(int)>
	//  128  311:astore          8
			if(obj1 != null)
	//* 129  313:aload           8
	//* 130  315:ifnull          327
	...
	//  132  320:aload           7
	//  133  322:aload           8
	//  134  324:invokestatic    #644 <Method void zza(StringBuilder, FastJsonResponse$Field, Object)>
		}
	...
	//  144  343:aload           7
	//  145  345:aload           9
	//  146  347:invokestatic    #644 <Method void zza(StringBuilder, FastJsonResponse$Field, Object)>
...
_L8:
		...
		if(stringbuilder.length() > 0)
	//* 148  353:aload           4
	//* 149  355:invokevirtual   #604 <Method int StringBuilder.length()>
	//* 150  358:ifle            368
			s1 = "}";
	//  151  361:ldc2            #648 <String "}">
	//  152  364:astore_3        
		else
	//* 153  365:goto            372
			s1 = "{}";
	//  154  368:ldc2            #650 <String "{}">
	//  155  371:astore_3        
		stringbuilder.append(s1);
	//  156  372:aload           4
	//  157  374:aload_3         
	//  158  375:invokevirtual   #73  <Method StringBuilder StringBuilder.append(String)>
	//  159  378:pop             
		return stringbuilder.toString();
	//  160  379:aload           4
	//  161  381:invokevirtual   #81  <Method String StringBuilder.toString()>
	//  162  384:areturn         
	}
