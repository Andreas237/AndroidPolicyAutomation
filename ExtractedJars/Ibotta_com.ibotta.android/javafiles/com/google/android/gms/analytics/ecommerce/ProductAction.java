...
public class ProductAction
{
	...
	//    6   12:putfield        #47  <Field Map zzuy>
		put("&pa", s);
	//    7   15:aload_0         
	...
	//    4    7:aload_0         
	//    5    8:getfield        #47  <Field Map zzuy>
	//    6   11:aload_1         
	//    7   12:aload_2         
	...
	{
		return ((Map) (new HashMap(zzuy)));
	//    0    0:new             #44  <Class HashMap>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #47  <Field Map zzuy>
	...
	//    3    7:astore_2        
		...
		for(Iterator iterator = zzuy.entrySet().iterator(); iterator.hasNext(); ((Map) (hashmap)).put(((Object) (s)), ((Object) ((String)entry.getValue()))))
	//*   4    8:aload_0         
	//*   5    9:getfield        #47  <Field Map zzuy>
	...
	//   29   79:aload           4
	//   30   81:invokeinterface #144 <Method Object java.util.Map$Entry.getKey()>
	//   31   86:checkcast       #146 <Class String>
	//   32   89:astore_1        
		}
	...
	//   34   91:aload_1         
	//   35   92:aload           4
	//   36   94:invokeinterface #158 <Method Object java.util.Map$Entry.getValue()>
	//   37   99:checkcast       #146 <Class String>
	//   38  102:invokeinterface #66  <Method Object Map.put(Object, Object)>
	//   39  107:pop             
	//*  40  108:goto            23
