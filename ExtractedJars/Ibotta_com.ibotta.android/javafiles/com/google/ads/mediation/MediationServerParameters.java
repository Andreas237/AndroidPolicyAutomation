...
_L8:
	...
	//   71  172:astore_1        
		obj = ((Object) (new StringBuilder(String.valueOf(((Object) (map))).length() + 43)));
	//   72  173:new             #102 <Class StringBuilder>
	//   73  176:dup             
	//   74  177:aload_1         
	//   75  178:invokestatic    #106 <Method String String.valueOf(Object)>
	//   76  181:invokevirtual   #110 <Method int String.length()>
	//   77  184:bipush          43
	//   78  186:iadd            
...
_L7:
	...
	//   95  222:astore_1        
		obj = ((Object) (new StringBuilder(String.valueOf(((Object) (map))).length() + 49)));
	//   96  223:new             #102 <Class StringBuilder>
	//   97  226:dup             
	//   98  227:aload_1         
	//   99  228:invokestatic    #106 <Method String String.valueOf(Object)>
	//  100  231:invokevirtual   #110 <Method int String.length()>
	//  101  234:bipush          49
	//  102  236:iadd            
...
_L4:
	...
	//  130  298:astore_1        
		StringBuilder stringbuilder1 = new StringBuilder(String.valueOf(((Object) (s))).length() + 31 + String.valueOf(((Object) (map))).length());
	//  131  299:new             #102 <Class StringBuilder>
	//  132  302:dup             
	//  133  303:aload           4
	//  134  305:invokestatic    #106 <Method String String.valueOf(Object)>
	//  135  308:invokevirtual   #110 <Method int String.length()>
	//  136  311:bipush          31
	//  137  313:iadd            
	//  138  314:aload_1         
