...
class m$15$1 extends w
{
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #30  <Method Object w.read(a)>
	//    4    8:checkcast       #32  <Class Date>
	//    5   11:astore_1        
		if(a1 != null)
	//*   6   12:aload_1         
	//*   7   13:ifnull          28
			return new Timestamp(((Date) (a1)).getTime());
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #49  <Method Timestamp a(a)>
	//    3    5:areturn         
	}
	...
	// Unreferenced inner class com/google/ads/interactivemedia/v3/b/b/a/m$15
...
/* anonymous class */
		...
		implements x
	{
		...
		public w a(f f1, com.google.ads.interactivemedia.v3.b.c.a a1)
		{
			if(a1.a() != java/sql/Timestamp)
		//*   0    0:aload_2         
		//*   1    1:invokevirtual   #22  <Method Class com.google.ads.interactivemedia.v3.b.c.a.a()>
		...
		//    5   10:areturn         
				...
				return ((w) (new m._cls15._cls1(this, f1.a(java/util/Date))));
