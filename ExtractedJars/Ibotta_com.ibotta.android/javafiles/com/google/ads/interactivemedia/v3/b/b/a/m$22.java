	...
	implements x
{
	...
	{
		String s = String.valueOf(((Object) (b.getName())));
	//    0    0:aload_0         
	//    1    1:getfield        #21  <Field Class b>
	//    2    4:invokevirtual   #42  <Method String Class.getName()>
	//    3    7:invokestatic    #48  <Method String String.valueOf(Object)>
	//    4   10:astore_1        
		String s1 = String.valueOf(((Object) (a.getName())));
	//    5   11:aload_0         
	//    6   12:getfield        #19  <Field Class a>
	...
	m$22(Class class1, Class class2, w w)
	{
		a = class1;
	//    0    0:aload_0         
	//    1    1:aload_1         
