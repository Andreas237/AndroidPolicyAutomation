...
class s$1 extends WebChromeClient
{
	...
	//   10   21:invokevirtual   #47  <Method void android.webkit.WebView$WebViewTransport.setWebView(WebView)>
		((android.webkit.iew.WebViewTransport) (webview)).getWebView().setWebViewClient(((WebViewClient) (new WebViewClient() {
			...
			//    4    8:invokevirtual   #31  <Method void ab.d(String)>
				for(webview1 = ((WebView) (a.c.iterator())); ((Iterator) (webview1)).hasNext(); ((com.google.ads.interactivemedia.v3.api.CompanionAdSlot.ClickListener)((Iterator) (webview1)).next()).onCompanionAdClick());
			//    5   11:aload_0         
	...
	s$1(s s1, Context context, ab ab, List list)
	{
		a = context;
	//    0    0:aload_0         
	//    1    1:aload_2         
