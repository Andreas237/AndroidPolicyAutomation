...
//			DaggerBonusesPickerComponent, BonusesPickerModule, BonusesPickerComponent

public static final class DaggerBonusesPickerComponent$Builder
{

	public DaggerBonusesPickerComponent$Builder bonusesPickerModule(BonusesPickerModule bonusespickermodule)
	{
	...
	//*   5   11:ifnull          24
			{
				return ((BonusesPickerComponent) (new DaggerBonusesPickerComponent(this, ((DaggerBonusesPickerComponent._cls1) (null)))));
	...
	public DaggerBonusesPickerComponent$Builder mainComponent(MainComponent maincomponent)
	{
...
/*
	static BonusesPickerModule access$100(DaggerBonusesPickerComponent$Builder daggerbonusespickercomponent$builder)
	{
		return daggerbonusespickercomponent$builder.bonusesPickerModule;
	//    0    0:aload_0         
	//    1    1:getfield        #22  <Field BonusesPickerModule bonusesPickerModule>
	//    2    4:areturn         
	}
...
/*
	static MainComponent access$200(DaggerBonusesPickerComponent$Builder daggerbonusespickercomponent$builder)
	{
		return daggerbonusespickercomponent$builder.mainComponent;
	//    0    0:aload_0         
...
*/
	...
	private DaggerBonusesPickerComponent$Builder()
	{
	//    0    0:aload_0         
	...
	DaggerBonusesPickerComponent$Builder(DaggerBonusesPickerComponent._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #18  <Method void DaggerBonusesPickerComponent$Builder()>
	//    2    4:return          
	}
}
