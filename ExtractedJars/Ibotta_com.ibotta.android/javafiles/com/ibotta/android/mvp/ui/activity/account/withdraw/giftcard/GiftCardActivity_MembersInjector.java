...
public final class GiftCardActivity_MembersInjector
	implements MembersInjector
{

	public GiftCardActivity_MembersInjector(Provider provider, Provider provider1, Provider provider2, Provider provider3, Provider provider4, Provider provider5, Provider provider6, 
	...
	//   44   85:aload_0         
	//   45   86:aload           15
	//   46   88:putfield        #77  <Field Provider imageCacheProvider>
		formattingProvider = provider15;
	//   47   91:aload_0         
	//   48   92:aload           16
	//   49   94:putfield        #79  <Field Provider formattingProvider>
		passwordPrompterFactoryProvider = provider16;
	//   50   97:aload_0         
	//   51   98:aload           17
	//   52  100:putfield        #81  <Field Provider passwordPrompterFactoryProvider>
	//   53  103:return          
	}
	...
	{
		return ((MembersInjector) (new GiftCardActivity_MembersInjector(provider, provider1, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15, provider16)));
	//    0    0:new             #2   <Class GiftCardActivity_MembersInjector>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:aload_2         
	...
	//   17   30:aload           15
	//   18   32:aload           16
	//   19   34:invokespecial   #88  <Method void GiftCardActivity_MembersInjector(Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider, Provider)>
	//   20   37:areturn         
	}

	public static void injectFormatting(GiftCardActivity giftcardactivity, Formatting formatting)
	{
		giftcardactivity.formatting = formatting;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #97  <Field Formatting GiftCardActivity.formatting>
	//    3    5:return          
	}

	public static void injectImageCache(GiftCardActivity giftcardactivity, ImageCache imagecache)
	{
		giftcardactivity.imageCache = imagecache;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #103 <Field ImageCache GiftCardActivity.imageCache>
	//    3    5:return          
	}

	public static void injectPasswordPrompterFactory(GiftCardActivity giftcardactivity, PasswordPrompterFactory passwordprompterfactory)
	{
		giftcardactivity.passwordPrompterFactory = passwordprompterfactory;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #109 <Field PasswordPrompterFactory GiftCardActivity.passwordPrompterFactory>
	//    3    5:return          
	}

	public void injectMembers(GiftCardActivity giftcardactivity)
	{
		MvpActivity_MembersInjector.injectAppHelper(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (AppHelper)appHelperProvider.get());
	//    0    0:aload_1         
	//    1    1:aload_0         
	...
	//    5   13:invokestatic    #125 <Method void MvpActivity_MembersInjector.injectAppHelper(com.ibotta.android.mvp.base.MvpActivity, AppHelper)>
		MvpActivity_MembersInjector.injectHandler(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (Handler)handlerProvider.get());
	//    6   16:aload_1         
	//    7   17:aload_0         
	...
	//   11   29:invokestatic    #131 <Method void MvpActivity_MembersInjector.injectHandler(com.ibotta.android.mvp.base.MvpActivity, Handler)>
		MvpActivity_MembersInjector.injectAuthManager(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (AuthManager)authManagerProvider.get());
	//   12   32:aload_1         
	//   13   33:aload_0         
	...
	//   17   45:invokestatic    #137 <Method void MvpActivity_MembersInjector.injectAuthManager(com.ibotta.android.mvp.base.MvpActivity, AuthManager)>
		MvpActivity_MembersInjector.injectButtonSdkManager(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (ButtonSdkManager)buttonSdkManagerProvider.get());
	//   18   48:aload_1         
	//   19   49:aload_0         
	...
	//   23   61:invokestatic    #143 <Method void MvpActivity_MembersInjector.injectButtonSdkManager(com.ibotta.android.mvp.base.MvpActivity, ButtonSdkManager)>
		MvpActivity_MembersInjector.injectUpgradeState(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (UpgradeState)upgradeStateProvider.get());
	//   24   64:aload_1         
	//   25   65:aload_0         
	...
	//   29   77:invokestatic    #149 <Method void MvpActivity_MembersInjector.injectUpgradeState(com.ibotta.android.mvp.base.MvpActivity, UpgradeState)>
		MvpActivity_MembersInjector.injectAppCacheState(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (AppCacheState)appCacheStateProvider.get());
	//   30   80:aload_1         
	//   31   81:aload_0         
	...
	//   35   93:invokestatic    #155 <Method void MvpActivity_MembersInjector.injectAppCacheState(com.ibotta.android.mvp.base.MvpActivity, AppCacheState)>
		MvpActivity_MembersInjector.injectDebugState(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (DebugState)debugStateProvider.get());
	//   36   96:aload_1         
	//   37   97:aload_0         
	...
	//   41  109:invokestatic    #161 <Method void MvpActivity_MembersInjector.injectDebugState(com.ibotta.android.mvp.base.MvpActivity, DebugState)>
		MvpActivity_MembersInjector.injectCacheClearFactory(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (CacheClearJobFactory)cacheClearFactoryProvider.get());
	//   42  112:aload_1         
	//   43  113:aload_0         
	...
	//   47  125:invokestatic    #167 <Method void MvpActivity_MembersInjector.injectCacheClearFactory(com.ibotta.android.mvp.base.MvpActivity, CacheClearJobFactory)>
		MvpActivity_MembersInjector.injectGlobalEventManager(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (GlobalEventManager)globalEventManagerProvider.get());
	//   48  128:aload_1         
	//   49  129:aload_0         
	...
	//   53  141:invokestatic    #173 <Method void MvpActivity_MembersInjector.injectGlobalEventManager(com.ibotta.android.mvp.base.MvpActivity, GlobalEventManager)>
		MvpActivity_MembersInjector.injectBuildProfile(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (BuildProfile)buildProfileProvider.get());
	//   54  144:aload_1         
	//   55  145:aload_0         
	...
	//   59  157:invokestatic    #179 <Method void MvpActivity_MembersInjector.injectBuildProfile(com.ibotta.android.mvp.base.MvpActivity, BuildProfile)>
		MvpActivity_MembersInjector.injectTracker(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (Tracker)trackerProvider.get());
	//   60  160:aload_1         
	//   61  161:aload_0         
	...
	//   65  173:invokestatic    #185 <Method void MvpActivity_MembersInjector.injectTracker(com.ibotta.android.mvp.base.MvpActivity, Tracker)>
		MvpActivity_MembersInjector.injectTrackingFlushWorker(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (TrackingFlushWorker)trackingFlushWorkerProvider.get());
	//   66  176:aload_1         
	//   67  177:aload_0         
	...
	//   71  189:invokestatic    #191 <Method void MvpActivity_MembersInjector.injectTrackingFlushWorker(com.ibotta.android.mvp.base.MvpActivity, TrackingFlushWorker)>
		MvpActivity_MembersInjector.injectNotificationTracking(((com.ibotta.android.mvp.base.MvpActivity) (giftcardactivity)), (NotificationTracking)notificationTrackingProvider.get());
	//   72  192:aload_1         
	//   73  193:aload_0         
	...
	//   77  205:invokestatic    #197 <Method void MvpActivity_MembersInjector.injectNotificationTracking(com.ibotta.android.mvp.base.MvpActivity, NotificationTracking)>
		ContentEventsActivity_MembersInjector.injectRetailerParcelHelper(((com.ibotta.android.mvp.base.contentevents.ContentEventsActivity) (giftcardactivity)), (RetailerParcelHelper)retailerParcelHelperProvider.get());
	//   78  208:aload_1         
	//   79  209:aload_0         
	...
	//   83  221:invokestatic    #205 <Method void ContentEventsActivity_MembersInjector.injectRetailerParcelHelper(com.ibotta.android.mvp.base.contentevents.ContentEventsActivity, RetailerParcelHelper)>
		injectImageCache(giftcardactivity, (ImageCache)imageCacheProvider.get());
	//   84  224:aload_1         
	//   85  225:aload_0         
	//   86  226:getfield        #77  <Field Provider imageCacheProvider>
	//   87  229:invokeinterface #117 <Method Object Provider.get()>
	//   88  234:checkcast       #207 <Class ImageCache>
	//   89  237:invokestatic    #209 <Method void injectImageCache(GiftCardActivity, ImageCache)>
		injectFormatting(giftcardactivity, (Formatting)formattingProvider.get());
	//   90  240:aload_1         
	//   91  241:aload_0         
	//   92  242:getfield        #79  <Field Provider formattingProvider>
	//   93  245:invokeinterface #117 <Method Object Provider.get()>
	//   94  250:checkcast       #211 <Class Formatting>
	//   95  253:invokestatic    #213 <Method void injectFormatting(GiftCardActivity, Formatting)>
		injectPasswordPrompterFactory(giftcardactivity, (PasswordPrompterFactory)passwordPrompterFactoryProvider.get());
	//   96  256:aload_1         
	//   97  257:aload_0         
	//   98  258:getfield        #81  <Field Provider passwordPrompterFactoryProvider>
	//   99  261:invokeinterface #117 <Method Object Provider.get()>
	//  100  266:checkcast       #215 <Class PasswordPrompterFactory>
	//  101  269:invokestatic    #217 <Method void injectPasswordPrompterFactory(GiftCardActivity, PasswordPrompterFactory)>
	//  102  272:return          
	}

	public volatile void injectMembers(Object obj)
	{
		injectMembers((GiftCardActivity)obj);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #93  <Class GiftCardActivity>
	//    3    5:invokevirtual   #220 <Method void injectMembers(GiftCardActivity)>
	//    4    8:return          
	}
