...
//			DaggerAddUpcComponent, AddUpcModule, AddUpcComponent

public static final class DaggerAddUpcComponent$Builder
{

	public DaggerAddUpcComponent$Builder addUpcModule(AddUpcModule addupcmodule)
	{
	...
	//*   5   11:ifnull          24
			{
				return ((AddUpcComponent) (new DaggerAddUpcComponent(this, ((DaggerAddUpcComponent._cls1) (null)))));
	...
	public DaggerAddUpcComponent$Builder mainComponent(MainComponent maincomponent)
	{
...
/*
	static AddUpcModule access$100(DaggerAddUpcComponent$Builder daggeraddupccomponent$builder)
	{
		return daggeraddupccomponent$builder.addUpcModule;
	//    0    0:aload_0         
	//    1    1:getfield        #22  <Field AddUpcModule addUpcModule>
	//    2    4:areturn         
	}
...
/*
	static MainComponent access$200(DaggerAddUpcComponent$Builder daggeraddupccomponent$builder)
	{
		return daggeraddupccomponent$builder.mainComponent;
	//    0    0:aload_0         
...
*/
	...
	private DaggerAddUpcComponent$Builder()
	{
	//    0    0:aload_0         
	...
	DaggerAddUpcComponent$Builder(DaggerAddUpcComponent._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:invokespecial   #18  <Method void DaggerAddUpcComponent$Builder()>
	//    2    4:return          
	}
}
