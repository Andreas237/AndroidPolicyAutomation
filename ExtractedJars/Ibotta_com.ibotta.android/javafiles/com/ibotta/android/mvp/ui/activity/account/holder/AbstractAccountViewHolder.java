...
public abstract class AbstractAccountViewHolder extends android.support.v7.widget.RecyclerView.ViewHolder
{

	public AbstractAccountViewHolder(View view)
	{
		super(view);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public abstract void bind(AbstractAccountRow abstractaccountrow, AccountAdapterListener accountadapterlistener);
}
