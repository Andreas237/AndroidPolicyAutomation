...
static class JsonGenerator$1
{
	...
	static 
	{
		$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion = new int[com.fasterxml.jackson.core.type.nclusion.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion>
		try
		{
			$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion[com.fasterxml.jackson.core.type.nclusion.PARENT_PROPERTY.ordinal()] = 1;
	...
	//   30   65:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion[com.fasterxml.jackson.core.type.nclusion.PAYLOAD_PROPERTY.ordinal()] = 2;
		}
	//*  31   66:goto            20
	...
	//   32   69:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion[com.fasterxml.jackson.core.type.nclusion.METADATA_PROPERTY.ordinal()] = 3;
		}
	//*  33   70:goto            31
	...
	//   34   73:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion[com.fasterxml.jackson.core.type.nclusion.WRAPPER_OBJECT.ordinal()] = 4;
		}
	//*  35   74:goto            42
	...
	//   36   77:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion[com.fasterxml.jackson.core.type.nclusion.WRAPPER_ARRAY.ordinal()] = 5;
		}
	//*  37   78:goto            53
