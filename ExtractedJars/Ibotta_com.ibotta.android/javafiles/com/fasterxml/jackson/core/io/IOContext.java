...
public class IOContext
{
	...
	//    1    3:dup             
	//    2    4:ldc1            #38  <String "Trying to release buffer smaller than original">
	...
	//    3    5:new             #45  <Class IllegalStateException>
	//    4    8:dup             
	//    5    9:ldc1            #47  <String "Trying to call same allocXxx() method second time">
	//    6   11:invokespecial   #48  <Method void IllegalStateException(String)>
	//    7   14:athrow          
	}
	...
	//    8   12:return          
				...
				throw wrongBuf();
	//    9   13:aload_0         
	//   10   14:invokespecial   #52  <Method IllegalArgumentException wrongBuf()>
	//   11   17:athrow          
		} else
		{
			return;
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #85  <Field char[] _tokenCBuffer>
	//    3    5:invokevirtual   #59  <Method void _verifyAlloc(Object)>
	...
	//    9   17:aload_0         
	//   10   18:aload_1         
	//   11   19:putfield        #85  <Field char[] _tokenCBuffer>
		return ac;
	//   12   22:aload_1         
	//   13   23:areturn         
	}
	...
	//   10   18:aload_0         
	//   11   19:aload_2         
	//   12   20:putfield        #85  <Field char[] _tokenCBuffer>
		return ac;
	//   13   23:aload_2         
	//   14   24:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:getfield        #88  <Field byte[] _writeEncodingBuffer>
	//    3    5:invokevirtual   #59  <Method void _verifyAlloc(Object)>
	...
	//    9   17:aload_0         
	//   10   18:aload_1         
	//   11   19:putfield        #88  <Field byte[] _writeEncodingBuffer>
		return abyte0;
	//   12   22:aload_1         
	//   13   23:areturn         
	}
	...
	//    0    0:new             #92  <Class TextBuffer>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #27  <Field BufferRecycler _bufferRecycler>
	//    4    8:invokespecial   #95  <Method void TextBuffer(BufferRecycler)>
	//    5   11:areturn         
	}
	...
	public JsonEncoding getEncoding()
	{
		return _encoding;
	//    0    0:aload_0         
	//    1    1:getfield        #99  <Field JsonEncoding _encoding>
	//    2    4:areturn         
	}
	...
	//    6   10:invokevirtual   #107 <Method void _verifyRelease(byte[], byte[])>
			_base64Buffer = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	...
	//   12   22:iconst_3        
	//   13   23:aload_1         
	//   14   24:invokevirtual   #111 <Method void BufferRecycler.releaseByteBuffer(int, byte[])>
		}
	//   15   27:return          
	}
	...
	//    6   10:invokevirtual   #115 <Method void _verifyRelease(char[], char[])>
			_concatCBuffer = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	...
	//   12   22:iconst_1        
	//   13   23:aload_1         
	//   14   24:invokevirtual   #119 <Method void BufferRecycler.releaseCharBuffer(int, char[])>
		}
	//   15   27:return          
	}
	...
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:getfield        #85  <Field char[] _tokenCBuffer>
	//    6   10:invokevirtual   #115 <Method void _verifyRelease(char[], char[])>
			_tokenCBuffer = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #85  <Field char[] _tokenCBuffer>
	...
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:getfield        #88  <Field byte[] _writeEncodingBuffer>
	//    6   10:invokevirtual   #107 <Method void _verifyRelease(byte[], byte[])>
			_writeEncodingBuffer = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #88  <Field byte[] _writeEncodingBuffer>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #99  <Field JsonEncoding _encoding>
	//    3    5:return          
	}
