...
public static final class JsonProperty$Access extends Enum
{

	public static JsonProperty$Access valueOf(String s)
	{
		return (JsonProperty$Access)Enum.valueOf(com/fasterxml/jackson/annotation/JsonProperty$Access, s);
	...
	{
		return (JsonProperty$Access[])((JsonProperty$Access []) ($VALUES)).clone();
	...
	private static final JsonProperty$Access $VALUES[];
	...
	static 
	{
		AUTO = new JsonProperty$Access("AUTO", 0);
	...
	//    5   10:putstatic       #24  <Field JsonProperty$Access AUTO>
		READ_ONLY = new JsonProperty$Access("READ_ONLY", 1);
	...
	//   11   23:putstatic       #27  <Field JsonProperty$Access READ_ONLY>
		WRITE_ONLY = new JsonProperty$Access("WRITE_ONLY", 2);
	...
	//   17   36:putstatic       #30  <Field JsonProperty$Access WRITE_ONLY>
		READ_WRITE = new JsonProperty$Access("READ_WRITE", 3);
	...
	//   23   49:putstatic       #33  <Field JsonProperty$Access READ_WRITE>
		$VALUES = (new JsonProperty$Access[] {
			AUTO, READ_ONLY, WRITE_ONLY, READ_WRITE
		});
	//   24   52:iconst_4        
	//   25   53:anewarray       JsonProperty$Access[]
	//   26   56:dup             
	//   27   57:iconst_0        
	...
	private JsonProperty$Access(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
