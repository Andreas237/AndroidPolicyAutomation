...
label1:
		...
		//    1    3:astore          7
					boolean flag5 = value1._ignoreUnknown;
		//    2    5:aload           7
		...
		//    5   12:iconst_0        
		//    6   13:istore          5
					if(flag != flag5 || flag1 != value1._allowGetters || flag2 != value1._allowSetters || flag3 != value1._merge)
						break label0;
		//    7   15:iload_1         
		//    8   16:iload           6
		//    9   18:icmpne          69
		...
		private static boolean _equals(Value value1, Value value2)
		{
			return value1._ignoreUnknown == value2._ignoreUnknown && value1._merge == value2._merge && value1._allowGetters == value2._allowGetters && value1._allowSetters == value2._allowSetters && value1._ignored.equals(((Object) (value2._ignored)));
		//    0    0:aload_0         
		...
		public static Value construct(Set set, boolean flag, boolean flag1, boolean flag2, boolean flag3)
		{
		...
		//    8   15:areturn         
				...
				return new Value(set, flag, flag1, flag2, flag3);
		...
		//   16   30:aload_0         
		//   17   31:areturn         
				Set set = _merge(_ignored, value1._ignored);
		//   18   32:aload_0         
		...
		//   39   73:istore_2        
				boolean flag1;
				if(!_allowGetters && !value1._allowGetters)
		//*  40   74:aload_0         
		...
		//   50   96:iconst_1        
		//   51   97:istore_3        
				if(_allowSetters || value1._allowSetters)
		//*  52   98:aload_0         
		...
		protected Value(Set set, boolean flag, boolean flag1, boolean flag2, boolean flag3)
		{
		//    0    0:aload_0         
