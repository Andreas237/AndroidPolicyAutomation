...
public static final class JsonCreator$Mode extends Enum
{

	public static JsonCreator$Mode valueOf(String s)
	{
		return (JsonCreator$Mode)Enum.valueOf(com/fasterxml/jackson/annotation/JsonCreator$Mode, s);
	...
	{
		return (JsonCreator$Mode[])((JsonCreator$Mode []) ($VALUES)).clone();
	...
	private static final JsonCreator$Mode $VALUES[];
	...
	static 
	{
		DEFAULT = new JsonCreator$Mode("DEFAULT", 0);
	...
	//    5   10:putstatic       #24  <Field JsonCreator$Mode DEFAULT>
		DELEGATING = new JsonCreator$Mode("DELEGATING", 1);
	...
	//   11   23:putstatic       #27  <Field JsonCreator$Mode DELEGATING>
		PROPERTIES = new JsonCreator$Mode("PROPERTIES", 2);
	...
	//   17   36:putstatic       #30  <Field JsonCreator$Mode PROPERTIES>
		DISABLED = new JsonCreator$Mode("DISABLED", 3);
	...
	//   23   49:putstatic       #33  <Field JsonCreator$Mode DISABLED>
		$VALUES = (new JsonCreator$Mode[] {
			DEFAULT, DELEGATING, PROPERTIES, DISABLED
		});
	//   24   52:iconst_4        
	//   25   53:anewarray       JsonCreator$Mode[]
	//   26   56:dup             
	//   27   57:iconst_0        
	...
	private JsonCreator$Mode(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
