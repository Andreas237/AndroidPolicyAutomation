	...
	extends Annotation
{
		...
		implements JacksonAnnotationValue, Serializable
	{
		...
		private static boolean _empty(Nulls nulls1, Nulls nulls2)
		{
			return nulls1 == Nulls.DEFAULT && nulls2 == Nulls.DEFAULT;
		//    0    0:aload_0         
		...
		public static Value construct(Nulls nulls1, Nulls nulls2)
		{
			Nulls nulls3 = nulls1;
		//    0    0:aload_0         
		//    1    1:astore_2        
		...
		//   17   31:areturn         
				...
				return new Value(nulls3, nulls1);
		...
		//   16   28:astore_1        
				return ((Value) (obj))._nulls == _nulls && ((Value) (obj))._contentNulls == _contentNulls;
		//   17   29:aload_1         
		...
		//    5   11:aload_0         
		//    6   12:areturn         
				Nulls nulls1 = value1._nulls;
		//    7   13:aload_1         
		//    8   14:getfield        #39  <Field Nulls _nulls>
		//    9   17:astore_2        
				Nulls nulls2 = value1._contentNulls;
		//   10   18:aload_1         
		...
		//*  25   43:if_acmpne       51
					nulls1 = _contentNulls;
		//   26   46:aload_0         
		//   27   47:getfield        #41  <Field Nulls _contentNulls>
		//   28   50:astore_2        
				if(value1 == _nulls && nulls1 == _contentNulls)
		//*  29   51:aload_1         
		//*  30   52:aload_0         
		...
		//   38   68:areturn         
					...
					return construct(((Nulls) (value1)), nulls1);
		//   39   69:aload_1         
		//   40   70:aload_2         
		...
		protected Value(Nulls nulls1, Nulls nulls2)
		{
		//    0    0:aload_0         
