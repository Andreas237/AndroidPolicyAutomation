...
//			JacksonAnnotationValue, JacksonInject, OptBoolean
	...
	implements JacksonAnnotationValue, Serializable
{
	...
	public static JacksonInject$Value construct(Object obj, Boolean boolean1)
	{
		Object obj1 = obj;
	//    0    0:aload_0         
	//    1    1:astore_2        
	...
	//   13   24:areturn         
			...
			return new JacksonInject$Value(obj1, boolean1);
	...
	public static JacksonInject$Value from(JacksonInject jacksoninject)
	{
	...
	//*  13   21:if_acmpne       72
		{
			obj = ((Object) ((JacksonInject$Value)obj));
	//   14   24:aload_1         
	//   15   25:checkcast       #2   <Class JacksonInject$Value>
	//   16   28:astore_1        
			if(OptBoolean.equals(_useInput, ((JacksonInject$Value) (obj))._useInput))
	//*  17   29:aload_0         
	...
	//*  26   48:aload_2         
	//*  27   49:ifnonnull       63
					return ((JacksonInject$Value) (obj))._id == null;
	//   28   52:aload_1         
	...
	//   34   62:ireturn         
					...
					return obj1.equals(((JacksonInject$Value) (obj))._id);
	//   35   63:aload_2         
	//   36   64:aload_1         
	...
	//   12   24:aload_0         
	//   13   25:areturn         
		return new JacksonInject$Value(obj, _useInput);
	...
	protected JacksonInject$Value(Object obj, Boolean boolean1)
	{
	//    0    0:aload_0         
