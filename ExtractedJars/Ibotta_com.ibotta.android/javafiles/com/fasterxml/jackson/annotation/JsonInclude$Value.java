	...
	implements JacksonAnnotationValue, Serializable
{
	...
	//*   9   19:ifnonnull       25
	//*  10   22:goto            37
			return new JsonInclude$Value(e, e1, ((Class) (null)), ((Class) (null)));
	...
	public static JsonInclude$Value construct(e e, e e1, Class class1, Class class2)
	{
		Class class3 = class1;
	//    0    0:aload_2         
	//    1    1:astore          4
	...
	//   12   20:aconst_null     
	//   13   21:astore_2        
		if((e == e.USE_DEFAULTS || e == null) && (e1 == e.USE_DEFAULTS || e1 == null) && class3 == null && class1 == null)
	//*  14   22:aload_0         
	...
	//   29   56:areturn         
			...
			return new JsonInclude$Value(e, e1, class3, class1);
	...
	//   36   74:aconst_null     
	//   37   75:astore_0        
		return new JsonInclude$Value(e, e1, class1, ((Class) (jsoninclude)));
	...
	public static JsonInclude$Value merge(JsonInclude$Value jsoninclude$value, JsonInclude$Value jsoninclude$value1)
	{
		if(jsoninclude$value == null)
	//*   0    0:aload_0         
	//*   1    1:ifnonnull       6
			return jsoninclude$value1;
	//    2    4:aload_1         
	//    3    5:areturn         
		else
			return jsoninclude$value.withOverrides(jsoninclude$value1);
	//    4    6:aload_0         
	//    5    7:aload_1         
	...
	public static transient JsonInclude$Value mergeAll(JsonInclude$Value ajsoninclude$value[])
	{
		int j = ajsoninclude$value.length;
	//    0    0:aload_0         
	//    1    1:arraylength     
	//    2    2:istore_2        
	...
	//*   9    9:icmpge          55
		{
			JsonInclude$Value jsoninclude$value2 = ajsoninclude$value[i];
	//   10   12:aload_0         
	//   11   13:iload_1         
	//   12   14:aaload          
	//   13   15:astore          5
			JsonInclude$Value jsoninclude$value1 = jsoninclude$value;
	//   14   17:aload_3         
	//   15   18:astore          4
	...
	//*  22   32:goto            42
					jsoninclude$value = jsoninclude$value.withOverrides(jsoninclude$value2);
	//   23   35:aload_3         
	//   24   36:aload           5
	//   25   38:invokevirtual   #81  <Method JsonInclude$Value withOverrides(JsonInclude$Value)>
	//   26   41:astore_3        
				jsoninclude$value1 = jsoninclude$value;
	//   27   42:aload_3         
	//   28   43:astore          4
			}
			i++;
	...
	//   31   47:iadd            
	//   32   48:istore_1        
			jsoninclude$value = jsoninclude$value1;
	//   33   49:aload           4
	//   34   51:astore_3        
		}
	...
	//   18   30:astore_1        
		return ((JsonInclude$Value) (obj))._valueInclusion == _valueInclusion && ((JsonInclude$Value) (obj))._contentInclusion == _contentInclusion && ((JsonInclude$Value) (obj))._valueFilter == _valueFilter && ((JsonInclude$Value) (obj))._contentFilter == _contentFilter;
	//   19   31:aload_1         
	...
	{
		if(_valueInclusion == e.USE_DEFAULTS && _contentInclusion == e.USE_DEFAULTS && _valueFilter == null && _contentFilter == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #43  <Field JsonInclude$Include _valueInclusion>
	...
	public JsonInclude$Value withContentFilter(Class class1)
	{
		e e;
	...
	//   12   25:astore_1        
		...
		return construct(_valueInclusion, e, _valueFilter, class1);
	//   13   26:aload_0         
	...
	//    5    9:areturn         
			...
			return new JsonInclude$Value(_valueInclusion, e, _valueFilter, _contentFilter);
	...
	//    9   17:astore          6
			e e1 = jsoninclude$value._contentInclusion;
	//   10   19:aload_1         
	//   11   20:getfield        #45  <Field JsonInclude$Include _contentInclusion>
	//   12   23:astore          7
			Class class1 = jsoninclude$value._valueFilter;
	//   13   25:aload_1         
	//   14   26:getfield        #49  <Field Class _valueFilter>
	//   15   29:astore          8
			jsoninclude$value = ((JsonInclude$Value) (jsoninclude$value._contentFilter));
	//   16   31:aload_1         
	...
	//   34   66:istore_2        
			boolean flag1;
			if(e1 != _contentInclusion && e1 != e.USE_DEFAULTS)
	//*  35   67:aload           7
	//*  36   69:aload_0         
	...
	//*  65  128:iload_3         
	//*  66  129:ifeq            147
					return new JsonInclude$Value(e, e1, class1, ((Class) (jsoninclude$value)));
	...
	//   74  146:areturn         
					...
					return new JsonInclude$Value(e, _contentInclusion, class1, ((Class) (jsoninclude$value)));
	...
	//*  84  164:iload_3         
	//*  85  165:ifeq            185
				return new JsonInclude$Value(_valueInclusion, e1, class1, ((Class) (jsoninclude$value)));
	...
	//*  95  185:iload           4
	//*  96  187:ifeq            209
				return new JsonInclude$Value(_valueInclusion, _contentInclusion, class1, ((Class) (jsoninclude$value)));
	...
	//    5    9:areturn         
			...
			return new JsonInclude$Value(e, _contentInclusion, _valueFilter, _contentFilter);
	//    6   10:new             #2   <Class JsonInclude$Value>
	//    7   13:dup             
	//    8   14:aload_1         
	//    9   15:aload_0         
	...
	static 
	{
		EMPTY = new JsonInclude$Value(e.USE_DEFAULTS, e.USE_DEFAULTS, ((Class) (null)), ((Class) (null)));
	...
	protected JsonInclude$Value(e e, e e1, Class class1, Class class2)
	{
	//    0    0:aload_0         
