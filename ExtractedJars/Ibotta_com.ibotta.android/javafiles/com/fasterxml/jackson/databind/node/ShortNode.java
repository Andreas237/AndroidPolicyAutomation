...
public class ShortNode extends NumericNode
{
	...
	//    1    1:getfield        #13  <Field short _value>
	//    2    4:i2l             
	//    3    5:invokestatic    #50  <Method BigDecimal BigDecimal.valueOf(long)>
	//    4    8:areturn         
	}
	...
	//*  11   17:ifeq            38
			return ((ShortNode)obj)._value == _value;
	//   12   20:aload_1         
	...
	//    0    0:getstatic       #67  <Field com.fasterxml.jackson.core.JsonParser$NumberType com.fasterxml.jackson.core.JsonParser$NumberType.INT>
	//    1    3:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #13  <Field short _value>
	//    2    4:invokestatic    #74  <Method Short Short.valueOf(short)>
	//    3    7:areturn         
	}
	...
	//    3    5:invokevirtual   #85  <Method void JsonGenerator.writeNumber(short)>
	//    4    8:return          
	}
