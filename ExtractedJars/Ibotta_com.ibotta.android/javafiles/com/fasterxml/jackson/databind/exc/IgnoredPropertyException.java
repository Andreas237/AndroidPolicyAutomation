...
public class IgnoredPropertyException extends PropertyBindingException
{
	...
	//    9   20:astore          4
		jsonparser = ((JsonParser) (new IgnoredPropertyException(jsonparser, String.format("Ignored field \"%s\" (class %s) encountered; mapper configured not to allow this", new Object[] {
			s, class1.getName()
		}), jsonparser.getCurrentLocation(), class1, s, collection)));
	//   10   22:new             #2   <Class IgnoredPropertyException>
	//   11   25:dup             
	//   12   26:aload_0         
	//   13   27:ldc1            #27  <String "Ignored field \"%s\" (class %s) encountered; mapper configured not to allow this">
	//   14   29:iconst_2        
	...
	//   29   54:aload_2         
	//   30   55:aload_3         
	//   31   56:invokespecial   #44  <Method void IgnoredPropertyException(JsonParser, String, JsonLocation, Class, String, Collection)>
	//   32   59:astore_0        
