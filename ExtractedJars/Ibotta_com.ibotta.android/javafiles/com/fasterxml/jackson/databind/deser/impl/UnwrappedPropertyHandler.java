...
public class UnwrappedPropertyHandler
{
	...
	//   11   25:iload           5
	//   12   27:invokeinterface #40  <Method Object List.get(int)>
	//   13   32:checkcast       #42  <Class SettableBeanProperty>
	//   14   35:astore_1        
			JsonParser jsonparser1 = tokenbuffer.asParser();
	//   15   36:aload           4
	//   16   38:invokevirtual   #48  <Method JsonParser TokenBuffer.asParser()>
	//   17   41:astore          7
			jsonparser1.nextToken();
	//   18   43:aload           7
	//   19   45:invokevirtual   #54  <Method com.fasterxml.jackson.core.JsonToken JsonParser.nextToken()>
	//   20   48:pop             
	...
	//   23   52:aload_2         
	//   24   53:aload_3         
	//   25   54:invokevirtual   #58  <Method void SettableBeanProperty.deserializeAndSet(JsonParser, DeserializationContext, Object)>
		}
	...
	//    4    8:invokeinterface #36  <Method int List.size()>
	//    5   13:invokespecial   #64  <Method void ArrayList(int)>
	//    6   16:astore          4
	...
	//*   9   22:invokeinterface #68  <Method Iterator List.iterator()>
	//*  10   27:astore          5
	//*  11   29:aload           5
	//*  12   31:invokeinterface #74  <Method boolean Iterator.hasNext()>
	//*  13   36:ifeq            110
		{
			settablebeanproperty = (SettableBeanProperty)iterator.next();
	//   14   39:aload           5
	//   15   41:invokeinterface #78  <Method Object Iterator.next()>
	//   16   46:checkcast       #42  <Class SettableBeanProperty>
	//   17   49:astore_2        
	...
	//   19   51:aload_1         
	//   20   52:aload_2         
	//   21   53:invokevirtual   #82  <Method String SettableBeanProperty.getName()>
	//   22   56:invokevirtual   #88  <Method String NameTransformer.transform(String)>
	//   23   59:invokevirtual   #92  <Method SettableBeanProperty SettableBeanProperty.withSimpleName(String)>
	//   24   62:astore_3        
			JsonDeserializer jsondeserializer = settablebeanproperty1.getValueDeserializer();
	//   25   63:aload_3         
	//   26   64:invokevirtual   #96  <Method JsonDeserializer SettableBeanProperty.getValueDeserializer()>
	//   27   67:astore          6
	...
	//   32   76:aload           6
	//   33   78:aload_1         
	//   34   79:invokevirtual   #102 <Method JsonDeserializer JsonDeserializer.unwrappingDeserializer(NameTransformer)>
	//   35   82:astore          7
			settablebeanproperty = settablebeanproperty1;
	//   36   84:aload_3         
	//   37   85:astore_2        
	...
	//   41   93:aload_3         
	//   42   94:aload           7
	//   43   96:invokevirtual   #106 <Method SettableBeanProperty SettableBeanProperty.withValueDeserializer(JsonDeserializer)>
	//   44   99:astore_2        
		}

	//   45  100:aload           4
	//   46  102:aload_2         
	//   47  103:invokevirtual   #107 <Method boolean ArrayList.add(Object)>
	//   48  106:pop             
	//*  49  107:goto            29
	...
	//   51  113:dup             
	//   52  114:aload           4
	//   53  116:invokespecial   #109 <Method void UnwrappedPropertyHandler(List)>
	//   54  119:areturn         
	}
