...
public static class DateDeserializers$TimestampDeserializer extends DateDeserializers$DateBasedDeserializer
{
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokevirtual   #40  <Method Date _parseDate(JsonParser, DeserializationContext)>
	//    4    6:astore_1        
		if(jsonparser == null)
	//*   5    7:aload_1         
	//*   6    8:ifnonnull       13
	...
	//    8   12:areturn         
			...
			return new Timestamp(((Date) (jsonparser)).getTime());
	//    9   13:new             #12  <Class Timestamp>
	//   10   16:dup             
	//   11   17:aload_1         
	//   12   18:invokevirtual   #46  <Method long Date.getTime()>
