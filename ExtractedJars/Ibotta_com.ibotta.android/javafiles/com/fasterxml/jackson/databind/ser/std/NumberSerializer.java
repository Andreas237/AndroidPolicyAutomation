...
public class NumberSerializer extends StdScalarSerializer
{
	...
	//    6   13:ldc1            #69  <String "number">
	//    7   15:astore_1        
		return ((JsonNode) (createSchemaNode(((String) (serializerprovider)), true)));
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:iconst_1        
	//   11   19:invokevirtual   #73  <Method com.fasterxml.jackson.databind.node.ObjectNode createSchemaNode(String, boolean)>
	//   12   22:areturn         
	}
	...
	//   50  104:aload_2         
	//   51  105:aload_1         
	//   52  106:invokevirtual   #125 <Method String Object.toString()>
	//   53  109:invokevirtual   #128 <Method void JsonGenerator.writeNumber(String)>
			return;
	//   54  112:return          
		} else
		{
	...
	//   55  113:aload_2         
	//   56  114:aload_1         
	//   57  115:invokevirtual   #132 <Method int Number.intValue()>
	//   58  118:invokevirtual   #135 <Method void JsonGenerator.writeNumber(int)>
			return;
	//   59  121:return          
		}
	}
