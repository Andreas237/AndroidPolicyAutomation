...
public class UUIDSerializer extends StdScalarSerializer
{
	...
	{
		char ac1[] = HEX_CHARS;
	//    0    0:getstatic       #19  <Field char[] HEX_CHARS>
	//    1    3:astore_3        
		ac[j] = ac1[i >> 12 & 0xf];
	//    2    4:aload_1         
	//    3    5:iload_2         
	...
	//    0    0:aload_2         
	//    1    1:invokevirtual   #41  <Method long UUID.getLeastSignificantBits()>
	//    2    4:lconst_0        
	//    3    5:lcmp            
	//    4    6:ifne            20
	//    5    9:aload_2         
	//    6   10:invokevirtual   #38  <Method long UUID.getMostSignificantBits()>
	//    7   13:lconst_0        
	//    8   14:lcmp            
	//    9   15:ifne            20
	//   10   18:iconst_1        
