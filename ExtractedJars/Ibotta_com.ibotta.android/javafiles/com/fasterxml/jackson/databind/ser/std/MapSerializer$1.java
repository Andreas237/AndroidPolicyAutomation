...
static class MapSerializer$1
{
	...
	static 
	{
		$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include = new int[com.fasterxml.jackson.annotation.ude.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include>
		try
		{
			$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[com.fasterxml.jackson.annotation.ude.NON_DEFAULT.ordinal()] = 1;
	...
	//   35   77:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[com.fasterxml.jackson.annotation.ude.NON_ABSENT.ordinal()] = 2;
		}
	//*  36   78:goto            20
	...
	//   37   81:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[com.fasterxml.jackson.annotation.ude.NON_EMPTY.ordinal()] = 3;
		}
	//*  38   82:goto            31
	...
	//   39   85:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[com.fasterxml.jackson.annotation.ude.CUSTOM.ordinal()] = 4;
		}
	//*  40   86:goto            42
	...
	//   41   89:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[com.fasterxml.jackson.annotation.ude.NON_NULL.ordinal()] = 5;
		}
	//*  42   90:goto            53
	...
	//   43   93:astore_0        
		try
		{
			$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[com.fasterxml.jackson.annotation.ude.ALWAYS.ordinal()] = 6;
		}
	//*  44   94:goto            64
