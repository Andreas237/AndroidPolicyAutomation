...
private static final class Connection$State extends Enum
{

	public static Connection$State valueOf(String s)
	{
		return (Connection$State)Enum.valueOf(com/firebase/client/realtime/Connection$State, s);
	...
	{
		return (Connection$State[])((Connection$State []) ($VALUES)).clone();
	...
	private static final Connection$State $VALUES[];
	public static final Connection$State REALTIME_CONNECTED;
	public static final Connection$State REALTIME_CONNECTING;
	public static final Connection$State REALTIME_DISCONNECTED;

	static 
	{
		REALTIME_CONNECTING = new Connection$State("REALTIME_CONNECTING", 0);
	...
	//    5   10:putstatic       #23  <Field Connection$State REALTIME_CONNECTING>
		REALTIME_CONNECTED = new Connection$State("REALTIME_CONNECTED", 1);
	...
	//   11   23:putstatic       #26  <Field Connection$State REALTIME_CONNECTED>
		REALTIME_DISCONNECTED = new Connection$State("REALTIME_DISCONNECTED", 2);
	...
	private Connection$State(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
