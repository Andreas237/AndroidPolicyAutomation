...
class AuthenticationManager$8$2
	implements Runnable
{

	public void run()
	{
		val$handler.onError(val$e);
	//    0    0:aload_0         
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//*  30   62:ifne            75
			{
				result = ((Map) (((DefaultHttpClient) (result)).execute(httpurirequest, ((org.apache.http.client.ResponseHandler) (jsonbasicresponsehandler)))));
		//   31   65:aload_1         
		//   32   66:aload_2         
		//   33   67:aload_3         
		...
		//   36   72:goto            85
			...
			result = ((Map) (ApacheInstrumentation.execute((HttpClient)result, httpurirequest, ((org.apache.http.client.ResponseHandler) (jsonbasicresponsehandler)))));
		//   37   75:aload_1         
		...
		//*  47   91:ifnull          111
			{
				try
				{
					AuthenticationManager.access$600(AuthenticationManager.this, new AuthenticationManager._cls8._cls1());
		//   48   94:aload_0         
		...
		//*  62  121:astore_1        
				{
					AuthenticationManager.access$600(AuthenticationManager.this, ((Runnable) (((AuthenticationManager._cls8._cls2) (ioexception)). new AuthenticationManager._cls8._cls2())));
		//   63  122:aload_0         
		...
		// Unreferenced inner class com/firebase/client/authentication/AuthenticationManager$8$1

/* anonymous class */
		class AuthenticationManager._cls8._cls1
			implements Runnable
		{
