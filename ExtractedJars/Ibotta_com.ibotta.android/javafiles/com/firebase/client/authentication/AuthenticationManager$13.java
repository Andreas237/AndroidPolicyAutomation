...
class AuthenticationManager$13
	implements Runnable
{

	public void run()
	{
		AuthenticationManager.access$1900(AuthenticationManager.this).add(((Object) (val$listener)));
	//    0    0:aload_0         
	...
	//    6   16:pop             
		final AuthData authData = AuthenticationManager.access$1100(AuthenticationManager.this);
	//    7   17:aload_0         
	...
	//   10   24:astore_1        
		AuthenticationManager.access$200(AuthenticationManager.this, new Runnable() {
			...
			{
				this$1 = AuthenticationManager._cls13.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
