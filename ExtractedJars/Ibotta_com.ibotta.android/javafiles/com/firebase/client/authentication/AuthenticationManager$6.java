...
class AuthenticationManager$6
	implements Runnable
{

	public void run()
	{
		AuthenticationManager.access$500(AuthenticationManager.this).auth(val$tokenString, new com.firebase.client.Firebase.AuthListener() {

			public void onAuthError(FirebaseError firebaseerror)
			{
				AuthenticationManager.access$300(this$0, firebaseerror, ((AuthenticationManager.AuthAttempt) (null)), false);
			//    0    0:aload_0         
			...
			{
				AuthenticationManager.access$300(this$0, firebaseerror, ((AuthenticationManager.AuthAttempt) (null)), true);
			//    0    0:aload_0         
			//    1    1:getfield        #17  <Field AuthenticationManager$6 this$1>
			//    2    4:getfield        #26  <Field AuthenticationManager AuthenticationManager$6.this$0>
			//    3    7:aload_1         
			...
			{
				AuthenticationManager.access$400(this$0, tokenString, authDataObj, userData, false, ((AuthenticationManager.AuthAttempt) (null)));
			//    0    0:aload_0         
			//    1    1:getfield        #17  <Field AuthenticationManager$6 this$1>
			//    2    4:getfield        #26  <Field AuthenticationManager AuthenticationManager$6.this$0>
			//    3    7:aload_0         
