...
//			AuthenticationManager, RequestHandler

class AuthenticationManager$10$1
	implements Runnable
{

	public void run()
	{
		AuthenticationManager.access$1200(this$0, val$handler, ((Object) (val$result)));
	//    0    0:aload_0         
	...
	// Unreferenced inner class com/firebase/client/authentication/AuthenticationManager$10

/* anonymous class */
	class AuthenticationManager._cls10
		implements RequestHandler
	{
		...
		//   19   37:astore_1        
			AuthenticationManager.access$1300(AuthenticationManager.this, handler, ((FirebaseError) (ioexception)));
		//   20   38:aload_0         
		...
		//*   8   17:ifeq            72
				{
					obj = ((Object) ((String)Utilities.getOrNull(((Object) (map)), "uid", java/lang/String)));
		//    9   20:aload_1         
		...
		//   32   69:invokevirtual   #97  <Method void AuthenticationManager.unauth(com.firebase.client.Firebase$CompletionListener, boolean)>
				...
				AuthenticationManager.access$600(AuthenticationManager.this, ((Runnable) (((AuthenticationManager._cls10._cls1) (map)). new AuthenticationManager._cls10._cls1())));
		//   33   72:aload_0         
		...
		//   46   97:astore_1        
				AuthenticationManager.access$1300(AuthenticationManager.this, handler, ((FirebaseError) (map)));
		//   47   98:aload_0         
		...
		final boolean val$logUserOut;
			...
			//    5    7:putfield        #25  <Field boolean val$logUserOut>
				handler = com.firebase.client.Firebase.ValueResultHandler.this;
			//    6   10:aload_0         
			//    7   11:aload_3         
