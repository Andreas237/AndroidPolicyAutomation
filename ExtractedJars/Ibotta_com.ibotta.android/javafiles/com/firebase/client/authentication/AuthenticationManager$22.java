...
class AuthenticationManager$22
	implements Runnable
{
	...
	//    3    7:astore_1        
		((Map) (hashmap)).put("oldPassword", ((Object) (val$oldPassword)));
	//    4    8:aload_1         
	...
	//   13   28:astore_2        
		((Map) (hashmap1)).put("password", ((Object) (val$newPassword)));
	//   14   29:aload_2         
