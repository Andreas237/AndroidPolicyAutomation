...
public static final class Event$EventType extends Enum
{

	public static Event$EventType valueOf(String s)
	{
		return (Event$EventType)Enum.valueOf(com/firebase/client/core/view/Event$EventType, s);
	...
	{
		return (Event$EventType[])((Event$EventType []) ($VALUES)).clone();
	...
	private static final Event$EventType $VALUES[];
	public static final Event$EventType CHILD_ADDED;
	public static final Event$EventType CHILD_CHANGED;
	public static final Event$EventType CHILD_MOVED;
	public static final Event$EventType CHILD_REMOVED;
	public static final Event$EventType VALUE;

	static 
	{
		CHILD_REMOVED = new Event$EventType("CHILD_REMOVED", 0);
	...
	//    5   10:putstatic       #25  <Field Event$EventType CHILD_REMOVED>
		CHILD_ADDED = new Event$EventType("CHILD_ADDED", 1);
	...
	//   11   23:putstatic       #28  <Field Event$EventType CHILD_ADDED>
		CHILD_MOVED = new Event$EventType("CHILD_MOVED", 2);
	...
	//   17   36:putstatic       #31  <Field Event$EventType CHILD_MOVED>
		CHILD_CHANGED = new Event$EventType("CHILD_CHANGED", 3);
	...
	//   23   49:putstatic       #34  <Field Event$EventType CHILD_CHANGED>
		VALUE = new Event$EventType("VALUE", 4);
	...
	//   29   62:putstatic       #37  <Field Event$EventType VALUE>
		$VALUES = (new Event$EventType[] {
			CHILD_REMOVED, CHILD_ADDED, CHILD_MOVED, CHILD_CHANGED, VALUE
		});
	//   30   65:iconst_5        
	//   31   66:anewarray       Event$EventType[]
	//   32   69:dup             
	//   33   70:iconst_0        
	...
	private Event$EventType(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
