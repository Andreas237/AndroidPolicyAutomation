	...
	implements e.ListenProvider
{
	...
	public void startListening(QuerySpec queryspec, Tag tag, e.SyncTreeHash synctreehash, final e.CompletionListener onListenComplete)
	{
		Repo.access$400(Repo.this).listen(queryspec, synctreehash, tag, new PersistentConnection.RequestResultListener() {
			...
			{
				this$1 = Repo._cls3.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
			//    2    2:putfield        #19  <Field Repo$3 this$1>
				onListenComplete = completionlistener;
			//    3    5:aload_0         
			//    4    6:aload_2         
