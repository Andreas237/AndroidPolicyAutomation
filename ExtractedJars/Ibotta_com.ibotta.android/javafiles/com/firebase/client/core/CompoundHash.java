...
/*
		static void access$000(CompoundHashBuilder compoundhashbuilder)
		{
...
/*
		static List access$100(CompoundHashBuilder compoundhashbuilder)
		{
...
/*
		static List access$200(CompoundHashBuilder compoundhashbuilder)
		{
...
/*
		static void access$300(CompoundHashBuilder compoundhashbuilder, LeafNode leafnode)
		{
			compoundhashbuilder.processLeaf(leafnode);
		//    0    0:aload_0         
		//    1    1:aload_1         
...
/*
		static void access$400(CompoundHashBuilder compoundhashbuilder, ChildKey childkey)
		{
...
/*
		static void access$600(CompoundHashBuilder compoundhashbuilder)
		{
...
*/
	...
	public static interface SplitStrategy
	{
		...
		public abstract boolean shouldSplit(CompoundHashBuilder compoundhashbuilder);
	}


	private CompoundHash(List list, List list1)
	{
	//    0    0:aload_0         
	...
	//*   4   10:aload_2         
	//*   5   11:invokeinterface #31  <Method int List.size()>
	//*   6   16:iconst_1        
	//*   7   17:isub            
	//*   8   18:icmpne          32
		{
	...
	//    9   21:aload_0         
	//   10   22:aload_1         
	//   11   23:putfield        #33  <Field List posts>
			hashes = list1;
	//   12   26:aload_0         
	//   13   27:aload_2         
	//   14   28:putfield        #35  <Field List hashes>
			return;
	//   15   31:return          
		} else
		{
			throw new IllegalArgumentException("Number of posts need to be n-1 for n hashes in CompoundHash");
	//   16   32:new             #37  <Class IllegalArgumentException>
	//   17   35:dup             
	//   18   36:ldc1            #39  <String "Number of posts need to be n-1 for n hashes in CompoundHash">
	//   19   38:invokespecial   #42  <Method void IllegalArgumentException(String)>
	//   20   41:athrow          
		}
	}
	...
	{
		return fromNode(node, ((SplitStrategy) (new SimpleSizeSplitStrategy(node))));
	//    0    0:aload_0         
	//    1    1:new             #11  <Class CompoundHash$SimpleSizeSplitStrategy>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:invokespecial   #55  <Method void CompoundHash$SimpleSizeSplitStrategy(Node)>
	//    5    9:invokestatic    #58  <Method CompoundHash fromNode(Node, CompoundHash$SplitStrategy)>
	//    6   12:areturn         
	}
	...
	public static CompoundHash fromNode(Node node, SplitStrategy splitstrategy)
	{
		if(node.isEmpty())
	//*   0    0:aload_0         
	//*   1    1:invokeinterface #64  <Method boolean Node.isEmpty()>
	//*   2    6:ifeq            25
		{
			return new CompoundHash(Collections.emptyList(), Collections.singletonList(""));
	//    3    9:new             #2   <Class CompoundHash>
	//    4   12:dup             
	//    5   13:invokestatic    #70  <Method List Collections.emptyList()>
	//    6   16:ldc1            #72  <String "">
	//    7   18:invokestatic    #76  <Method List Collections.singletonList(Object)>
	//    8   21:invokespecial   #78  <Method void CompoundHash(List, List)>
	//    9   24:areturn         
		} else
		{
			splitstrategy = ((SplitStrategy) (new CompoundHashBuilder(splitstrategy)));
	//   10   25:new             #8   <Class CompoundHash$CompoundHashBuilder>
	//   11   28:dup             
	//   12   29:aload_1         
	//   13   30:invokespecial   #81  <Method void CompoundHash$CompoundHashBuilder(CompoundHash$SplitStrategy)>
	//   14   33:astore_1        
			processNode(node, ((CompoundHashBuilder) (splitstrategy)));
	//   15   34:aload_0         
	//   16   35:aload_1         
	//   17   36:invokestatic    #50  <Method void processNode(Node, CompoundHash$CompoundHashBuilder)>
			((CompoundHashBuilder) (splitstrategy)).finishHashing();
	//   18   39:aload_1         
	//   19   40:invokestatic    #85  <Method void CompoundHash$CompoundHashBuilder.access$000(CompoundHash$CompoundHashBuilder)>
			return new CompoundHash(((CompoundHashBuilder) (splitstrategy)).currentPaths, ((CompoundHashBuilder) (splitstrategy)).currentHashes);
	//   20   43:new             #2   <Class CompoundHash>
	//   21   46:dup             
	//   22   47:aload_1         
	//   23   48:invokestatic    #89  <Method List CompoundHash$CompoundHashBuilder.access$100(CompoundHash$CompoundHashBuilder)>
	//   24   51:aload_1         
	//   25   52:invokestatic    #92  <Method List CompoundHash$CompoundHashBuilder.access$200(CompoundHash$CompoundHashBuilder)>
	//   26   55:invokespecial   #78  <Method void CompoundHash(List, List)>
	//   27   58:areturn         
		}
	}

	private static void processNode(Node node, CompoundHashBuilder compoundhashbuilder)
	{
		if(node.isLeafNode())
	//*   0    0:aload_0         
	//*   1    1:invokeinterface #95  <Method boolean Node.isLeafNode()>
	//*   2    6:ifeq            18
		{
			compoundhashbuilder.processLeaf((LeafNode)node);
	//    3    9:aload_1         
	//    4   10:aload_0         
	//    5   11:checkcast       #97  <Class LeafNode>
	//    6   14:invokestatic    #101 <Method void CompoundHash$CompoundHashBuilder.access$300(CompoundHash$CompoundHashBuilder, LeafNode)>
			return;
	//    7   17:return          
		}
		if(!node.isEmpty())
	...
	//*  11   27:aload_0         
	//*  12   28:instanceof      #103 <Class ChildrenNode>
	//*  13   31:ifeq            51
			{
				((ChildrenNode)node).forEachChild(((com.firebase.client.snapshot.ChildrenNode.ChildVisitor) (new com.firebase.client.snapshot.ChildrenNode.ChildVisitor(compoundhashbuilder) {
					...
					//    3    5:invokestatic    #27  <Method void CompoundHash$CompoundHashBuilder.access$400(CompoundHash$CompoundHashBuilder, ChildKey)>
						CompoundHash.processNode(node1, state);
					//    4    8:aload_2         
					//    5    9:aload_0         
	...
	//   14   34:aload_0         
	//   15   35:checkcast       #103 <Class ChildrenNode>
	//   16   38:new             #6   <Class CompoundHash$1>
	//   17   41:dup             
	//   18   42:aload_1         
	//   19   43:invokespecial   #105 <Method void CompoundHash$1(CompoundHash$CompoundHashBuilder)>
	//   20   46:iconst_1        
	//   21   47:invokevirtual   #109 <Method void ChildrenNode.forEachChild(com.firebase.client.snapshot.ChildrenNode$ChildVisitor, boolean)>
				return;
	//   22   50:return          
			} else
			{
				compoundhashbuilder = ((CompoundHashBuilder) (new StringBuilder()));
	//   23   51:new             #111 <Class StringBuilder>
	//   24   54:dup             
	//   25   55:invokespecial   #112 <Method void StringBuilder()>
	//   26   58:astore_1        
				((StringBuilder) (compoundhashbuilder)).append("Expected children node, but got: ");
	//   27   59:aload_1         
	//   28   60:ldc1            #114 <String "Expected children node, but got: ">
	//   29   62:invokevirtual   #118 <Method StringBuilder StringBuilder.append(String)>
	//   30   65:pop             
				((StringBuilder) (compoundhashbuilder)).append(((Object) (node)));
	//   31   66:aload_1         
	//   32   67:aload_0         
	//   33   68:invokevirtual   #121 <Method StringBuilder StringBuilder.append(Object)>
	//   34   71:pop             
				throw new IllegalStateException(((StringBuilder) (compoundhashbuilder)).toString());
	//   35   72:new             #123 <Class IllegalStateException>
	//   36   75:dup             
	//   37   76:aload_1         
	//   38   77:invokevirtual   #127 <Method String StringBuilder.toString()>
	//   39   80:invokespecial   #128 <Method void IllegalStateException(String)>
	//   40   83:athrow          
			}
		} else
		{
			throw new IllegalArgumentException("Can't calculate hash on empty node!");
	//   41   84:new             #37  <Class IllegalArgumentException>
	//   42   87:dup             
	//   43   88:ldc1            #130 <String "Can't calculate hash on empty node!">
	//   44   90:invokespecial   #42  <Method void IllegalArgumentException(String)>
	//   45   93:athrow          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #35  <Field List hashes>
	//    2    4:invokestatic    #135 <Method List Collections.unmodifiableList(List)>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #33  <Field List posts>
	//    2    4:invokestatic    #135 <Method List Collections.unmodifiableList(List)>
	//    3    7:areturn         
	}
...
/*
	static void access$500(Node node, CompoundHashBuilder compoundhashbuilder)
	{
		processNode(node, compoundhashbuilder);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #50  <Method void processNode(Node, CompoundHash$CompoundHashBuilder)>
		return;
	//    3    5:return          
	}
