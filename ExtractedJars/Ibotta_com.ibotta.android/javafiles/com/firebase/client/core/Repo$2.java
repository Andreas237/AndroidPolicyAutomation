...
//			Repo, Tag, SnapshotHolder, SyncTree

class Repo$2
	implements e.ListenProvider
{

	public void startListening(final QuerySpec query, Tag tag, e.SyncTreeHash synctreehash, final e.CompletionListener onComplete)
	{
		scheduleNow(new Runnable() {

			public void run()
			{
				Object obj = ((Object) (Repo.access$100(this$0).getNode(query.getPath())));
			//    0    0:aload_0         
			...
			//*  11   27:ifne            74
				{
					obj = ((Object) (Repo.access$200(this$0).applyServerOverwrite(query.getPath(), ((Node) (obj)))));
			//   12   30:aload_0         
			...
			//   26   60:invokestatic    #72  <Method void Repo.access$300(Repo, java.util.List)>
					onComplete.onListenComplete(((com.firebase.client.FirebaseError) (null)));
			//   27   63:aload_0         
