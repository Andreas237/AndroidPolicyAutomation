	...
	implements Runnable
{
	...
	public void run()
	{
		actionData.access._mth2100(val$txn).onComplete(((FirebaseError) (null)), true, val$snap);
	//    0    0:aload_0         
	...
	// Unreferenced inner class com/firebase/client/core/Repo$15

/* anonymous class */
	class Repo._cls15
		implements com.firebase.client.Firebase.CompletionListener
	{

		public void onComplete(FirebaseError firebaseerror, Firebase firebase)
		{
			Repo.access$500(Repo.this, "Transaction", path, firebaseerror);
		//    0    0:aload_0         
		...
		//   16   33:astore_1        
				final Repo.TransactionData txn;
				Object obj;
				for(Iterator iterator = queue.iterator(); iterator.hasNext(); ((Repo) (obj)).removeEventCallback(((EventRegistration) (new ValueEventRegistration(((Repo) (obj)), Repo.TransactionData.access$2200(txn), QuerySpec.defaultQueryAtPath(Repo.TransactionData.access$1900(txn)))))))
		//*  17   34:aload_0         
		...
		//*  23   52:ifeq            195
				{
					txn = (Repo.TransactionData)iterator.next();
		//   24   55:aload           4
		//   25   57:invokeinterface #61  <Method Object Iterator.next()>
		//   26   62:checkcast       #63  <Class Repo$TransactionData>
		//   27   65:astore          5
					Repo.TransactionData.access$1502(txn, Repo.TransactionStatus.COMPLETED);
		//   28   67:aload           5
		...
		//   31   75:pop             
					((List) (firebase)).addAll(((java.util.Collection) (Repo.access$800(Repo.this).ackUserWrite(Repo.TransactionData.access$1600(txn), false, false, ((com.firebase.client.utilities.Clock) (Repo.access$2000(Repo.this)))))));
		//   32   76:aload_2         
		//   33   77:aload_0         
		...
		//   45  106:pop             
					obj = ((Object) (Repo.TransactionData.access$1400(txn)));
		//   46  107:aload           5
		//   47  109:invokestatic    #99  <Method com.firebase.client.snapshot.Node Repo$TransactionData.access$1400(Repo$TransactionData)>
		//   48  112:astore          6
					((List) (firebaseerror)).add(((Object) (((Repo._cls15._cls1) (new DataSnapshot(new Firebase(repo, Repo.TransactionData.access$1900(txn)), IndexedNode.from(((com.firebase.client.snapshot.Node) (obj)))))). new Repo._cls15._cls1())));
		//   49  114:aload_1         
		...
		//   86  199:astore          4
				Repo.access$2400(repo1, Repo.access$2300(repo1).subTree(path));
		//   87  201:aload           4
		//   88  203:aload           4
		...
		//   96  222:invokestatic    #163 <Method void Repo.access$2500(Repo)>
				Repo.access$300(repo, ((List) (firebase)));
		//   97  225:aload_0         
		...
		//* 129  293:ifeq            387
					{
						firebase = ((Firebase) ((Repo.TransactionData)((Iterator) (firebaseerror)).next()));
		//  130  296:aload_1         
		//  131  297:invokeinterface #61  <Method Object Iterator.next()>
		//  132  302:checkcast       #63  <Class Repo$TransactionData>
		//  133  305:astore_2        
						if(Repo.TransactionData.access$1500(((Repo.TransactionData) (firebase))) == Repo.TransactionStatus.SENT_NEEDS_ABORT)
		//* 134  306:aload_2         
		...
		//* 137  313:if_acmpne       327
							Repo.TransactionData.access$1502(((Repo.TransactionData) (firebase)), Repo.TransactionStatus.NEEDS_ABORT);
		//  138  316:aload_2         
		...
		//* 142  324:goto            287
							Repo.TransactionData.access$1502(((Repo.TransactionData) (firebase)), Repo.TransactionStatus.RUN);
		//  143  327:aload_2         
		...
		//* 147  335:goto            287
				{
					Repo.TransactionData transactiondata;
					for(firebase = ((Firebase) (queue.iterator())); ((Iterator) (firebase)).hasNext(); Repo.TransactionData.access$2602(transactiondata, firebaseerror))
		//* 148  338:aload_0         
		...
		//* 154  354:ifeq            387
					{
						transactiondata = (Repo.TransactionData)((Iterator) (firebase)).next();
		//  155  357:aload_2         
		//  156  358:invokeinterface #61  <Method Object Iterator.next()>
		//  157  363:checkcast       #63  <Class Repo$TransactionData>
		//  158  366:astore          4
						Repo.TransactionData.access$1502(transactiondata, Repo.TransactionStatus.NEEDS_ABORT);
		//  159  368:aload           4
