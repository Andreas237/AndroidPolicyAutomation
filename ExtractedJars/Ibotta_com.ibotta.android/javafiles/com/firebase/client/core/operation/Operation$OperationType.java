...
public static final class Operation$OperationType extends Enum
{

	public static Operation$OperationType valueOf(String s)
	{
		return (Operation$OperationType)Enum.valueOf(com/firebase/client/core/operation/Operation$OperationType, s);
	...
	{
		return (Operation$OperationType[])((Operation$OperationType []) ($VALUES)).clone();
	...
	private static final Operation$OperationType $VALUES[];
	public static final Operation$OperationType AckUserWrite;
	public static final Operation$OperationType ListenComplete;
	public static final Operation$OperationType Merge;
	public static final Operation$OperationType Overwrite;

	static 
	{
		Overwrite = new Operation$OperationType("Overwrite", 0);
	...
	//    5   10:putstatic       #24  <Field Operation$OperationType Overwrite>
		Merge = new Operation$OperationType("Merge", 1);
	...
	//   11   23:putstatic       #27  <Field Operation$OperationType Merge>
		AckUserWrite = new Operation$OperationType("AckUserWrite", 2);
	...
	//   17   36:putstatic       #30  <Field Operation$OperationType AckUserWrite>
		ListenComplete = new Operation$OperationType("ListenComplete", 3);
	...
	//   23   49:putstatic       #33  <Field Operation$OperationType ListenComplete>
		$VALUES = (new Operation$OperationType[] {
			Overwrite, Merge, AckUserWrite, ListenComplete
		});
	//   24   52:iconst_4        
	//   25   53:anewarray       Operation$OperationType[]
	//   26   56:dup             
	//   27   57:iconst_0        
	...
	private Operation$OperationType(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
