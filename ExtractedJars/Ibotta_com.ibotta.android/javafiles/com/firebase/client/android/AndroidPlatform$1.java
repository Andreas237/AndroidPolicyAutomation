...
class AndroidPlatform$1 extends DefaultRunLoop
{
	...
	//   18   34:astore_2        
		val$logger.error(message, e);
	//   19   35:aload_0         
	//   20   36:getfield        #21  <Field LogWrapper val$logger>
	//   21   39:aload_2         
	//   22   40:aload_1         
	//   23   41:invokevirtual   #53  <Method void LogWrapper.error(String, Throwable)>
		(new Handler(AndroidPlatform.access$000(AndroidPlatform.this).getMainLooper())).post(new Runnable() {
			...
			{
				this$1 = AndroidPlatform._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
