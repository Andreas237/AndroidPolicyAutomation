...
static class LeafNode$1
{
	...
	static 
	{
		$SwitchMap$com$firebase$client$snapshot$Node$HashVersion = new int[rsion.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$com$firebase$client$snapshot$Node$HashVersion>
		try
		{
			$SwitchMap$com$firebase$client$snapshot$Node$HashVersion[rsion.V1.ordinal()] = 1;
	...
	//   15   32:astore_0        
		try
		{
			$SwitchMap$com$firebase$client$snapshot$Node$HashVersion[rsion.V2.ordinal()] = 2;
		}
	//*  16   33:goto            20
