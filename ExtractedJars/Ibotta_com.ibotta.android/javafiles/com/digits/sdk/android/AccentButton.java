...
public class AccentButton extends Button
{
	...
	//    4    5:invokespecial   #10  <Method void AccentButton(Context, AttributeSet, int)>
	//    5    8:return          
	}
	...
	//    4    4:invokespecial   #12  <Method void Button(Context, AttributeSet, int)>
		init();
	//    5    7:aload_0         
	//    6    8:invokespecial   #16  <Method void init()>
	//    7   11:return          
	}
	...
	//   15   29:invokevirtual   #45  <Method void ButtonThemer.disableDropShadow(android.view.View)>
		buttonthemer.setBackgroundAccentColor(((android.view.View) (this)), i);
	//   16   32:aload_2         
	//   17   33:aload_0         
	//   18   34:iload_1         
	//   19   35:invokevirtual   #49  <Method void ButtonThemer.setBackgroundAccentColor(android.view.View, int)>
		buttonthemer.setTextAccentColor(((android.widget.TextView) (this)), i);
	//   20   38:aload_2         
	//   21   39:aload_0         
	//   22   40:iload_1         
	//   23   41:invokevirtual   #53  <Method void ButtonThemer.setTextAccentColor(android.widget.TextView, int)>
	//   24   44:return          
	}
}
