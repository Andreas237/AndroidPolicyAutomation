...
class WorkSpecDao_Impl$11$1 extends android.arch.persistence.room.server
{
	...
	transient WorkSpecDao_Impl$11$1(String s, String as[])
	{
	...
	// Unreferenced inner class androidx/work/impl/model/WorkSpecDao_Impl$11

/* anonymous class */
	class WorkSpecDao_Impl._cls11 extends ComputableLiveData
	{
		...
		//*   2    4:ifnonnull       52
			{
				_observer = ((android.arch.persistence.room.InvalidationTracker.Observer) (new WorkSpecDao_Impl._cls11._cls1("WorkTag", new String[] {
					"workspec", "worktag"
				})));
		//    3    7:aload_0         
