	...
	implements Function
{
	...
	//    9   19:astore_2        
		for(list = ((List) (list.iterator())); ((Iterator) (list)).hasNext(); ((List) (arraylist)).add(((Object) (((rkStatusPojo)((Iterator) (list)).next()).toWorkStatus()))));
	//   10   20:aload_1         
	...
	//   20   46:invokevirtual   #50  <Method androidx.work.WorkStatus WorkSpec$WorkStatusPojo.toWorkStatus()>
