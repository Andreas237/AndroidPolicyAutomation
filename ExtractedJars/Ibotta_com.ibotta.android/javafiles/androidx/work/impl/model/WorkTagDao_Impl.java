	...
	implements WorkTagDao
{
	...
	//    4    6:putfield        #19  <Field RoomDatabase __db>
		__insertionAdapterOfWorkTag = ((EntityInsertionAdapter) (new EntityInsertionAdapter(roomdatabase) {
	...
	//    5    9:aload_0         
	//    6   10:new             #8   <Class WorkTagDao_Impl$1>
	//    7   13:dup             
	//    8   14:aload_0         
	//    9   15:aload_1         
	//   10   16:invokespecial   #22  <Method void WorkTagDao_Impl$1(WorkTagDao_Impl, RoomDatabase)>
	//   11   19:putfield        #24  <Field EntityInsertionAdapter __insertionAdapterOfWorkTag>
	//   12   22:return          
	}
	...
	//    0    0:ldc1            #29  <String "SELECT DISTINCT tag FROM worktag WHERE work_spec_id=?">
	//    1    2:iconst_1        
	...
	//    0    0:ldc1            #84  <String "SELECT work_spec_id FROM worktag WHERE tag=?">
	//    1    2:iconst_1        
	//    2    3:invokestatic    #35  <Method RoomSQLiteQuery RoomSQLiteQuery.acquire(String, int)>
	//    3    6:astore_2        
		if(s == null)
	...
	//    2    4:invokevirtual   #89  <Method void RoomDatabase.beginTransaction()>
		__insertionAdapterOfWorkTag.insert(((Object) (worktag)));
	//    3    7:aload_0         
	//    4    8:getfield        #24  <Field EntityInsertionAdapter __insertionAdapterOfWorkTag>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #94  <Method void EntityInsertionAdapter.insert(Object)>
		__db.setTransactionSuccessful();
	//    7   15:aload_0         
	//    8   16:getfield        #19  <Field RoomDatabase __db>
	//    9   19:invokevirtual   #97  <Method void RoomDatabase.setTransactionSuccessful()>
		__db.endTransaction();
	//   10   22:aload_0         
	//   11   23:getfield        #19  <Field RoomDatabase __db>
	//   12   26:invokevirtual   #100 <Method void RoomDatabase.endTransaction()>
		return;
	//   13   29:return          
		worktag;
	//   14   30:astore_1        
	...
	//   17   35:invokevirtual   #100 <Method void RoomDatabase.endTransaction()>
		throw worktag;
	//   18   38:aload_1         
	//   19   39:athrow          
	}
