...
public class StorageNotLowController extends ConstraintController
{
	...
	{
		super(((androidx.work.impl.constraints.trackers.ConstraintTracker) (Trackers.getInstance(context).getStorageNotLowTracker())));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #13  <Method Trackers Trackers.getInstance(Context)>
	//    3    5:invokevirtual   #17  <Method androidx.work.impl.constraints.trackers.StorageNotLowTracker Trackers.getStorageNotLowTracker()>
	...
	//    2    4:invokevirtual   #36  <Method boolean Constraints.requiresStorageNotLow()>
	//    3    7:ireturn         
	}
