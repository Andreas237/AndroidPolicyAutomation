...
public class NetworkNotRoamingController extends ConstraintController
{
	...
	//    3    7:getstatic       #42  <Field NetworkType NetworkType.NOT_ROAMING>
	//    4   10:if_acmpne       15
	//    5   13:iconst_1        
	//    6   14:ireturn         
	//    7   15:iconst_0        
	...
	//*   6    9:icmpge          30
		{
			Logger.debug("NetworkNotRoamingCtrlr", "Not-roaming network constraint is not supported before API 24, only checking for connected state.", new Throwable[0]);
	//    7   12:ldc1            #53  <String "NetworkNotRoamingCtrlr">
	//    8   14:ldc1            #55  <String "Not-roaming network constraint is not supported before API 24, only checking for connected state.">
	//    9   16:iconst_0        
	...
	//*  20   37:aload_1         
	//*  21   38:invokevirtual   #72  <Method boolean NetworkState.isNotRoaming()>
	//*  22   41:ifne            46
				return true;
	//   23   44:iconst_1        
	//   24   45:ireturn         
