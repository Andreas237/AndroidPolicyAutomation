	...
	implements IPutIntoJson
{
	...
	public cf(cg cg1, double d1)
	{
		this(cg1, d1, ((Double) (null)), false);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:dload_2         
	//    3    3:aconst_null     
	//    4    4:iconst_0        
	//    5    5:invokespecial   #33  <Method void cf(cg, double, Double, boolean)>
	//    6    8:return          
	}

	public cf(cg cg1, double d1, Double double1, boolean flag)
	{
	//    0    0:aload_0         
	...
	//    3    5:iconst_0        
	//    4    6:putfield        #37  <Field boolean e>
		b = cg.a(jsonobject.getString("session_id"));
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:ldc1            #47  <String "session_id">
	//    8   13:invokevirtual   #53  <Method String JSONObject.getString(String)>
	//    9   16:invokestatic    #58  <Method cg cg.a(String)>
	//   10   19:putfield        #39  <Field cg b>
	...
	//    3    5:aload_0         
	//    4    6:invokestatic    #91  <Method double eb.b()>
	...
	private static final String a = AppboyLogger.getAppboyLogTag(bo/app/cf);
	private final cg b;
