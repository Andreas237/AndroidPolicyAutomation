...
public class bi
{
	...
	public bi(Context context, bx bx1)
	{
	//    0    0:aload_0         
	...
	public void a()
	{
		if(b.a() != null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #29  <Field bx b>
	//*   2    4:invokeinterface #69  <Method String bx.a()>
	//*   3    9:ifnull          81
		{
	...
	//   18   40:aload_2         
	//   19   41:aload_0         
	//   20   42:getfield        #29  <Field bx b>
	//   21   45:invokeinterface #69  <Method String bx.a()>
	...
	//   28   62:pop             
			obj = ((Object) (b));
	//   29   63:aload_0         
	//   30   64:getfield        #29  <Field bx b>
	//   31   67:astore_1        
			((bx) (obj)).a(((bx) (obj)).a());
	//   32   68:aload_1         
	//   33   69:aload_1         
	//   34   70:invokeinterface #69  <Method String bx.a()>
	//   35   75:invokeinterface #86  <Method void bx.a(String)>
			return;
	//   36   80:return          
		}
		ADM adm = new ADM(a);
	...
	private static final String c = AppboyLogger.getAppboyLogTag(bo/app/bi);
