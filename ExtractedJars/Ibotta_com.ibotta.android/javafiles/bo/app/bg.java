	...
	implements Closeable
{
	...
	public bg(InputStream inputstream, int i, Charset charset)
	{
	//    0    0:aload_0         
	...
	//*   7   13:iflt            54
			{
				if(charset.equals(((Object) (bh.a))))
	//*   8   16:aload_3         
	//*   9   17:getstatic       #26  <Field Charset bh.a>
	...
	//    2    2:sipush          8192
	//    3    5:aload_2         
	//    4    6:invokespecial   #54  <Method void bg(InputStream, int, Charset)>
	//    5    9:return          
	}

	static Charset a(bg bg1)
	{
		return bg1.b;
	//    0    0:aload_0         
...
_L4:
		obj = ((Object) (new ByteArrayOutputStream((e - d) + 80) {
			...
			//   20   37:istore_1        
				...
				try
				{
					s = new String(buf, 0, k, bg.a(a).name());
			...
			//   26   47:iload_1         
			//   27   48:aload_0         
			//   28   49:getfield        #14  <Field bg a>
			//   29   52:invokestatic    #34  <Method Charset bg.a(bg)>
	...
	//   77  139:bipush          80
	//   78  141:iadd            
	//   79  142:invokespecial   #82  <Method void bg$1(bg, int)>
	//   80  145:astore          4
_L11:
