	...
	implements Closeable
{
	...
	private be$b(be be1, String s, long l, InputStream ainputstream[], long al[])
	{
		a = be1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	be$b(be be1, String s, long l, InputStream ainputstream[], long al[], be$1 be$1)
	{
		this(be1, s, l, ainputstream, al);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:lload_3         
