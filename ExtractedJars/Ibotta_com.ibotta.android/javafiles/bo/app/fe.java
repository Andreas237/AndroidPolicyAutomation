	...
	implements ey
{
	...
	//    5   10:astore_1        
		if(jsonobject != null && !jsonobject.isNull("campaign_id"))
	//*   6   11:aload_1         
	//*   7   12:ifnull          35
	//*   8   15:aload_1         
	//*   9   16:ldc1            #24  <String "campaign_id">
	//*  10   18:invokevirtual   #28  <Method boolean JSONObject.isNull(String)>
	//*  11   21:ifne            35
			a = jsonobject.optString("campaign_id", ((String) (null)));
	//   12   24:aload_0         
	//   13   25:aload_1         
	//   14   26:ldc1            #24  <String "campaign_id">
	//   15   28:aconst_null     
	...
	//    6   11:ldc1            #42  <String "push_click">
	...
	//   15   31:astore_2        
				jsonobject1.putOpt("campaign_id", ((Object) (a)));
	//   16   32:aload_2         
	//   17   33:ldc1            #24  <String "campaign_id">
	//   18   35:aload_0         
	...
	//    8   18:ireturn         
			fr = ((fr) ((fw)fr));
	//    9   19:aload_1         
	//   10   20:checkcast       #52  <Class fw>
	//   11   23:astore_1        
			if(!StringUtils.isNullOrBlank(((fw) (fr)).a()) && ((fw) (fr)).a().equals(((Object) (a))))
	//*  12   24:aload_1         
	//*  13   25:invokevirtual   #60  <Method String fw.a()>
	//*  14   28:invokestatic    #57  <Method boolean StringUtils.isNullOrBlank(String)>
	//*  15   31:ifne            50
	//*  16   34:aload_1         
	//*  17   35:invokevirtual   #60  <Method String fw.a()>
	//*  18   38:aload_0         
