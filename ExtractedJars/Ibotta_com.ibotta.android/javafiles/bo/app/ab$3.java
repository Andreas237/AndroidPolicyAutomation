	...
	implements IEventSubscriber
{
	...
	public void a(Throwable throwable)
	{
		ab.f(b).a(throwable);
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field ab b>
	//    2    4:invokestatic    #32  <Method bt ab.f(ab)>
	//    3    7:aload_1         
	//    4    8:invokeinterface #36  <Method void bt.a(Throwable)>
...
_L1:
	...
	//   14   28:goto            55
		throwable;
	//   15   31:astore_1        
		AppboyLogger.e(ab.q(), "Failed to log error.", throwable);
	//   16   32:invokestatic    #45  <Method String ab.q()>
...
_L2:
	...
	ab$3(ab ab1, Semaphore semaphore)
	{
		b = ab1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #19  <Field ab b>
		a = semaphore;
	//    3    5:aload_0         
	//    4    6:aload_2         
