...
public final class be$a
{
	class a extends FilterOutputStream
	{
		...
		a(OutputStream outputstream, be._cls1 _pcls1)
		{
			this(outputstream);
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:aload_2         
		//    3    3:invokespecial   #21  <Method void be$a$a(be$a, OutputStream)>
		//    4    6:return          
		}
	}


	static bf a(be$a be$a1)
	{
		return be$a1.b;
	//    0    0:aload_0         
	...
	static boolean a(be$a be$a1, boolean flag)
	{
		be$a1.d = flag;
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	{
		if(i < 0 || i >= be.e(a)) goto _L2; else goto _L1
	//    0    0:iload_1         
	//    1    1:iflt            130
	//    2    4:iload_1         
	//    3    5:aload_0         
...
_L6:
	...
	//   46   93:astore_2        
_L5:
		obj = ((Object) (new a(((OutputStream) (obj)), ((be$1) (null)))));
...
_L2:
	...
	be$a(be be1, bf bf1, be$1 be$1)
	{
		this(be1, bf1);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #39  <Method void be$a(be, bf)>
	//    4    6:return          
	}
}
