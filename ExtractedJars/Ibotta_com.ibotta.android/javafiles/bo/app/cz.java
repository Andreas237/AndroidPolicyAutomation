...
public final class cz extends cu
{
	...
	//   18   33:aload_0         
	//   19   34:aload_2         
	//   20   35:invokestatic    #50  <Method ci ci.a(cd)>
	//   21   38:putfield        #52  <Field cc c>
	//   22   41:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #65  <Method JSONObject cu.g()>
	//    2    4:astore_1        
		if(jsonobject == null)
	//*   3    5:aload_1         
	//*   4    6:ifnonnull       11
	...
	//    6   10:areturn         
		try
		{
			if(c != null)
	//*   7   11:aload_0         
	//*   8   12:getfield        #52  <Field cc c>
	//*   9   15:ifnull          34
				jsonobject.put("location_event", c.forJsonPut());
	//   10   18:aload_1         
	//   11   19:ldc1            #67  <String "location_event">
	//   12   21:aload_0         
	//   13   22:getfield        #52  <Field cc c>
	//   14   25:invokeinterface #73  <Method Object cc.forJsonPut()>
