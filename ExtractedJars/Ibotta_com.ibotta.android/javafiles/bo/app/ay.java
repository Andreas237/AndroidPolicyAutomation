	...
	implements ThreadFactory
{
	...
	//    7   13:putfield        #23  <Field AtomicInteger a>
		b = ((Class) (bo/app/ay)).getSimpleName();
	//    8   16:aload_0         
	//    9   17:ldc1            #2   <Class ay>
	...
	//    3    7:new             #41  <Class StringBuilder>
	//    4   10:dup             
	...
	//   10   20:invokevirtual   #46  <Method StringBuilder StringBuilder.append(String)>
	//   11   23:pop             
			stringbuilder.append(" #");
	//   12   24:aload_2         
	//   13   25:ldc1            #48  <String " #">
	//   14   27:invokevirtual   #46  <Method StringBuilder StringBuilder.append(String)>
	//   15   30:pop             
			stringbuilder.append(a.getAndIncrement());
	//   16   31:aload_2         
	//   17   32:aload_0         
	//   18   33:getfield        #23  <Field AtomicInteger a>
	//   19   36:invokevirtual   #52  <Method int AtomicInteger.getAndIncrement()>
	//   20   39:invokevirtual   #55  <Method StringBuilder StringBuilder.append(int)>
	//   21   42:pop             
			runnable = ((Runnable) (new Thread(runnable, stringbuilder.toString())));
	//   22   43:new             #57  <Class Thread>
	//   23   46:dup             
	//   24   47:aload_1         
	//   25   48:aload_2         
	//   26   49:invokevirtual   #60  <Method String StringBuilder.toString()>
	//   27   52:invokespecial   #63  <Method void Thread(Runnable, String)>
	//   28   55:astore_1        
			((Thread) (runnable)).setUncaughtExceptionHandler(c);
	//   29   56:aload_1         
	//   30   57:aload_0         
	//   31   58:getfield        #36  <Field Thread$UncaughtExceptionHandler c>
	//   32   61:invokevirtual   #66  <Method void Thread.setUncaughtExceptionHandler(Thread$UncaughtExceptionHandler)>
	...
	//   35   66:new             #68  <Class IllegalStateException>
	//   36   69:dup             
	//   37   70:ldc1            #70  <String "No UncaughtExceptionHandler. You must call setUncaughtExceptionHandler before creating a new thread">
	//   38   72:invokespecial   #72  <Method void IllegalStateException(String)>
	//   39   75:athrow          
		}
	}
