...
public final class fd extends fg
{
	...
	//    8   18:ireturn         
			fv fv1 = (fv)fr;
	//    9   19:aload_1         
	//   10   20:checkcast       #61  <Class fv>
	//   11   23:astore_2        
			if(!StringUtils.isNullOrBlank(fv1.a()) && fv1.a().equals(((Object) (c))))
	//*  12   24:aload_2         
	//*  13   25:invokevirtual   #70  <Method String fv.a()>
	//*  14   28:invokestatic    #67  <Method boolean StringUtils.isNullOrBlank(String)>
	//*  15   31:ifne            54
	//*  16   34:aload_2         
	//*  17   35:invokevirtual   #70  <Method String fv.a()>
	//*  18   38:aload_0         
	...
	//   22   48:aload_0         
	//   23   49:aload_1         
	//   24   50:invokespecial   #78  <Method boolean fg.a(fr)>
	//   25   53:ireturn         
		}
		return false;
	//   26   54:iconst_0        
	...
	private static final String b = AppboyLogger.getAppboyLogTag(bo/app/fd);
	private String c;
