	...
	implements IPutIntoJson
{
	...
	//    3    7:invokespecial   #34  <Method void cg(UUID)>
	//    4   10:areturn         
	}

	public static cg a(String s)
	{
		return new cg(UUID.fromString(s));
	//    0    0:new             #2   <Class cg>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokestatic    #39  <Method UUID UUID.fromString(String)>
	//    4    8:invokespecial   #34  <Method void cg(UUID)>
	//    5   11:areturn         
	}
	...
	//*  12   22:goto            42
		{
			obj = ((Object) ((cg)obj));
	//   13   25:aload_1         
	//   14   26:checkcast       #2   <Class cg>
	//   15   29:astore_1        
			return a.equals(((Object) (((cg) (obj)).a)));
	//   16   30:aload_0         
