...
public class bs
{
	...
	//    9   20:ireturn         
		...
		if(!eg.b(context))
	//*  10   21:aload_0         
	//*  11   22:invokestatic    #59  <Method boolean eg.b(Context)>
	//*  12   25:ifne            39
		{
	...
	//   18   38:ireturn         
		...
		try
		{
			appboyconfigurationprovider = ((AppboyConfigurationProvider) (((Class) (bo/app/bs)).getClassLoader()));
	//   19   39:ldc1            #2   <Class bs>
	...
	private static String b(String s)
	{
		...
		try
		{
			obj = ((Object) (en.a("com.google.firebase.iid.FirebaseInstanceId", "getInstance", new Class[0])));
	//    0    0:ldc1            #24  <String "com.google.firebase.iid.FirebaseInstanceId">
	//    1    2:ldc1            #93  <String "getInstance">
	//    2    4:iconst_0        
	//    3    5:anewarray       Class[]
	//    4    8:invokestatic    #98  <Method java.lang.reflect.Method en.a(String, String, Class[])>
	//    5   11:astore_1        
		}
	//*   6   12:aload_1         
	//*   7   13:ifnonnull       27
	...
	//*  18   33:invokestatic    #106 <Method Object en.a(Object, java.lang.reflect.Method, Object[])>
	//*  19   36:astore_1        
	//*  20   37:aload_1         
	//*  21   38:ifnonnull       52
	...
	//*  40   71:aastore         
	//*  41   72:invokestatic    #117 <Method java.lang.reflect.Method en.a(Class, String, Class[])>
	//*  42   75:astore_2        
	//*  43   76:aload_2         
	//*  44   77:ifnonnull       91
	...
	//*  62  105:aastore         
	//*  63  106:invokestatic    #106 <Method Object en.a(Object, java.lang.reflect.Method, Object[])>
	//*  64  109:astore_0        
	//*  65  110:aload_0         
	//*  66  111:ifnull          128
	//*  67  114:aload_0         
	...
	//   84  142:areturn         
		...
		return null;
		obj = en.a(((Object) (null)), ((java.lang.reflect.Method) (obj)), new Object[0]);
		if(obj != null)
		...
		return null;
		method = en.a(obj.getClass(), "getToken", new Class[] {
		...
		return null;
		s = ((String) (en.a(obj, method, new Object[] {
			s, "FCM"
		})));
		if(s == null)
