	...
	implements ds
{
	...
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:putfield        #33  <Field ds b>
		c = ad1;
	//    8   14:aload_0         
	//    9   15:aload_2         
	//   10   16:putfield        #35  <Field ad c>
	//   11   19:return          
	}

	private void a(ad ad1, Throwable throwable)
	{
		try
		{
	...
	//    1    1:new             #40  <Class ax>
	//    2    4:dup             
	//    3    5:ldc1            #42  <String "A storage exception has occurred. Please view the stack trace for more details.">
	//    4    7:aload_2         
	//    5    8:invokespecial   #45  <Method void ax(String, Throwable)>
	//    6   11:ldc1            #40  <Class ax>
	//    7   13:invokeinterface #50  <Method void ad.a(Object, Class)>
			return;
	//    8   18:return          
		}
	...
	//    8   19:areturn         
		...
		try
		{
			collection = b.a();
	//    9   20:aload_0         
	//   10   21:getfield        #33  <Field ds b>
	//   11   24:invokeinterface #72  <Method Collection ds.a()>
	//   12   29:astore_1        
		}
	//*  13   30:aload_1         
	//*  14   31:areturn         
	...
	//   21   43:aload_0         
	//   22   44:aload_0         
	//   23   45:getfield        #35  <Field ad c>
	//   24   48:aload_1         
	//   25   49:invokespecial   #76  <Method void a(ad, Throwable)>
			return ((Collection) (Collections.emptyList()));
	...
	//   22   41:return          
		...
		try
		{
			b.a(cc);
	//   23   42:aload_0         
	//   24   43:getfield        #33  <Field ds b>
	//   25   46:aload_1         
	//   26   47:invokeinterface #98  <Method void ds.a(cc)>
			return;
	//   27   52:return          
		}
		// Misplaced declaration of an exception variable
	...
	//*  28   53:astore_1        
		{
			AppboyLogger.e(a, "Failed to insert event into storage.", ((Throwable) (cc)));
	...
	//   34   64:aload_0         
	//   35   65:aload_0         
	//   36   66:getfield        #35  <Field ad c>
	//   37   69:aload_1         
	//   38   70:invokespecial   #76  <Method void a(ad, Throwable)>
	//   39   73:return          
	}
	...
	//    6   11:putfield        #31  <Field boolean d>
		b.b();
	//    7   14:aload_0         
	//    8   15:getfield        #33  <Field ds b>
	//    9   18:invokeinterface #104 <Method void ds.b()>
	//   10   23:return          
	}
	...
	//   24   43:getfield        #33  <Field ds b>
	//   25   46:aload_1         
	//   26   47:invokeinterface #108 <Method void ds.b(cc)>
			return;
	//   27   52:return          
		}
		// Misplaced declaration of an exception variable
	...
	//*  28   53:astore_1        
		{
			AppboyLogger.e(a, "Failed to delete event from storage.", ((Throwable) (cc)));
	//   29   54:getstatic       #24  <Field String a>
