	...
	implements ey
{
	...
	//*  31   59:icmpge          90
				((List) (arraylist1)).add(((Object) (new fb(jsonarray.getJSONObject(j)))));
	//   32   62:aload           6
	//   33   64:new             #53  <Class fb>
	//   34   67:dup             
	//   35   68:aload           5
	//   36   70:iload_3         
	//   37   71:invokevirtual   #56  <Method JSONObject JSONArray.getJSONObject(int)>
	//   38   74:invokespecial   #58  <Method void fb(JSONObject)>
	...
	//   44   86:istore_3        
	//*  45   87:goto            53
			((List) (arraylist)).add(((Object) (new fj(((List) (arraylist1))))));
	//   46   90:aload           4
	//   47   92:new             #66  <Class fj>
	//   48   95:dup             
	//   49   96:aload           6
	//   50   98:invokespecial   #69  <Method void fj(List)>
	...
	//   56  110:istore_2        
	//*  57  111:goto            27
		a = new fh(((List) (arraylist)));
	//   58  114:aload_0         
	//   59  115:new             #71  <Class fh>
	//   60  118:dup             
	//   61  119:aload           4
	//   62  121:invokespecial   #72  <Method void fh(List)>
	//   63  124:putfield        #74  <Field fh a>
	//   64  127:return          
	}
	...
	//   10   19:aload_0         
	//   11   20:getfield        #74  <Field fh a>
	//   12   23:invokevirtual   #81  <Method JSONArray fh.a()>
	...
	public boolean a(fr fr)
	{
		return a.a(fr);
	//    0    0:aload_0         
	//    1    1:getfield        #74  <Field fh a>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #94  <Method boolean fh.a(fr)>
	//    4    8:ireturn         
	}
	...
	private static final String b = AppboyLogger.getAppboyLogTag(bo/app/fg);
	fh a;
