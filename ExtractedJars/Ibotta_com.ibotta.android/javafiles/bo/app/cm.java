	...
	implements ce, IPutIntoJson
{
	...
	private cm(String s, Boolean boolean1, Boolean boolean2, cl cl1)
	{
	//    0    0:aload_0         
	...
	//   31   64:pop             
			if(d != null)
	//*  32   65:aload_0         
	//*  33   66:getfield        #33  <Field cl d>
	//*  34   69:ifnull          86
				jsonobject.put("config", ((Object) (d.a())));
	//   35   72:aload_1         
	//   36   73:ldc1            #61  <String "config">
	//   37   75:aload_0         
	//   38   76:getfield        #33  <Field cl d>
	//   39   79:invokevirtual   #65  <Method JSONObject cl.a()>
