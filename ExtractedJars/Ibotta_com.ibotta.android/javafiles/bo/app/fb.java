	...
	implements ex
{
	...
	protected fb(JSONObject jsonobject)
	{
		this((fo)ek.a(jsonobject, "property_type", bo/app/fo, ((Enum) (fo.e))), jsonobject.getString("property_key"), jsonobject.getInt("comparator"));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:ldc1            #41  <String "property_type">
	//    3    4:ldc1            #43  <Class fo>
	//    4    6:getstatic       #45  <Field fo fo.e>
	//    5    9:invokestatic    #50  <Method Enum ek.a(JSONObject, String, Class, Enum)>
	//    6   12:checkcast       #43  <Class fo>
	//    7   15:aload_1         
	...
	//   13   27:invokespecial   #66  <Method void fb(fo, String, int)>
	...
	//*  17   36:ifeq            143
		{
			if(b.equals(((Object) (fo.a))))
	//*  18   39:aload_0         
	//*  19   40:getfield        #34  <Field fo b>
	//*  20   43:getstatic       #74  <Field fo fo.a>
	//*  21   46:invokevirtual   #78  <Method boolean fo.equals(Object)>
	//*  22   49:ifeq            63
			{
	...
	//   28   62:return          
			...
			if(b.equals(((Object) (fo.d))))
	//*  29   63:aload_0         
	//*  30   64:getfield        #34  <Field fo b>
	//*  31   67:getstatic       #82  <Field fo fo.d>
	//*  32   70:invokevirtual   #78  <Method boolean fo.equals(Object)>
	//*  33   73:ifeq            90
			{
	...
	//   40   89:return          
			...
			if(b.equals(((Object) (fo.c))))
	//*  41   90:aload_0         
	//*  42   91:getfield        #34  <Field fo b>
	//*  43   94:getstatic       #93  <Field fo fo.c>
	//*  44   97:invokevirtual   #78  <Method boolean fo.equals(Object)>
	//*  45  100:ifeq            117
			{
	...
	//   52  116:return          
			...
			if(b.equals(((Object) (fo.b))))
	//*  53  117:aload_0         
	//*  54  118:getfield        #34  <Field fo b>
	//*  55  121:getstatic       #103 <Field fo fo.b>
	//*  56  124:invokevirtual   #78  <Method boolean fo.equals(Object)>
	//*  57  127:ifeq            143
	...
	//*   2    4:ifeq            21
			obj = ((Object) (eb.a((String)obj, u.b)));
	//    3    7:aload_1         
	//    4    8:checkcast       #123 <Class String>
	//    5   11:getstatic       #128 <Field u u.b>
	//    6   14:invokestatic    #133 <Method java.util.Date eb.a(String, u)>
	//    7   17:astore_1        
		else
	//*   8   18:goto            23
			obj = null;
	...
	//   19   37:iconst_0        
	//   20   38:ireturn         
		long l1 = eb.a(((java.util.Date) (obj)));
	//   21   39:aload_1         
	//   22   40:invokestatic    #136 <Method long eb.a(java.util.Date)>
	//   23   43:lstore          5
	...
	//    3    7:astore_1        
		try
		{
			if(!b.equals(((Object) (fo.e))))
	//*   4    8:aload_0         
	//*   5    9:getfield        #34  <Field fo b>
	//*   6   12:getstatic       #45  <Field fo fo.e>
	//*   7   15:invokevirtual   #78  <Method boolean fo.equals(Object)>
	//*   8   18:ifne            35
				jsonobject.put("property_type", ((Object) (b.toString())));
	//    9   21:aload_1         
	//   10   22:ldc1            #41  <String "property_type">
	//   11   24:aload_0         
	//   12   25:getfield        #34  <Field fo b>
	//   13   28:invokevirtual   #152 <Method String fo.toString()>
	...
	{
		boolean flag;
		if(!(fr1 instanceof fs))
	//*   0    0:aload_1         
	//*   1    1:instanceof      #169 <Class fs>
	//*   2    4:ifne            9
			return false;
	//    3    7:iconst_0        
	//    4    8:ireturn         
		AppboyProperties appboyproperties = ((fs)fr1).f();
	//    5    9:aload_1         
	//    6   10:checkcast       #169 <Class fs>
	//    7   13:invokeinterface #173 <Method AppboyProperties fs.f()>
	//    8   18:astore          5
		Object obj = null;
	//    9   20:aconst_null     
	//   10   21:astore          4
	...
	//*  52  104:iconst_0        
	//*  53  105:ireturn         
	//*  54  106:getstatic       #185 <Field int[] fb$1.a>
	//*  55  109:aload_0         
	//*  56  110:getfield        #34  <Field fo b>
	//*  57  113:invokevirtual   #189 <Method int fo.ordinal()>
	//*  58  116:iaload          
	...
	//*  65  156:aload           4
	//*  66  158:aload_1         
	//*  67  159:invokeinterface #195 <Method long fr.c()>
	...
	//*  86  195:ireturn         
			...
			{
				AppboyLogger.e(a, "Caught exception checking property filter condition.", ((Throwable) (fr1)));
				return false;
			}
		flag1 = true;
...
_L5:
	...
	private static final String a = AppboyLogger.getAppboyLogTag(bo/app/fb);
	private fo b;
	private String c;
	private int d;
	private Object e;
