	...
	extends IInterface
{
		...
		implements IAASA
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.samsung.aasaservice.IAASA");
		//    4    6:aload_0         
		//    5    7:ldc1            #14  <String "com.samsung.aasaservice.IAASA">
		//    6    9:invokeinterface #74  <Method IInterface IBinder.queryLocalInterface(String)>
		//    7   14:astore_1        
		...
		//    1    1:invokespecial   #61  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.samsung.aasaservice.IAASA");
		//    2    4:aload_0         
		//    3    5:aload_0         
		//    4    6:ldc1            #14  <String "com.samsung.aasaservice.IAASA">
		//    5    8:invokevirtual   #65  <Method void attachInterface(IInterface, String)>
		//    6   11:return          
		}
	}
	...
	public abstract boolean IsEnabledSPDupdate()
		throws RemoteException;

	public abstract int NotifyAASAFileUpdate(String s)
		throws RemoteException;

	public abstract void allowAutoRun(String as[])
		throws RemoteException;

	public abstract void allowPermission(int ai[], String as[], String as1[])
		throws RemoteException;

	public abstract void blockAutoRun(String as[])
		throws RemoteException;

	public abstract void blockPermission(int ai[], String as[], String as1[])
		throws RemoteException;

	public abstract String getAASARuleVersion()
		throws RemoteException;

	public abstract int getAlertDialogEnableType()
		throws RemoteException;

	public abstract boolean getAlertDialogVisible(String s)
		throws RemoteException;

	public abstract boolean getAlertDialogVisibleAll()
		throws RemoteException;

	public abstract String[] getAutoRunPackages()
		throws RemoteException;

	public abstract String[] getBlockedAutoRunPackages()
		throws RemoteException;

	public abstract String[] getManagedPackages(String s)
		throws RemoteException;

	public abstract String[] getManagedPermissions(int i, String s)
		throws RemoteException;

	public abstract boolean getPackageManaged()
		throws RemoteException;

	public abstract boolean isBlockedAutoRunPackage(String s)
		throws RemoteException;

	public abstract void removeBlockedPackageData(String s)
		throws RemoteException;

	public abstract void setAlertDialogEnableType(int i)
		throws RemoteException;

	public abstract void setAlertDialogVisible(String s, boolean flag)
		throws RemoteException;

	public abstract void setAlertDialogVisibleAll(boolean flag)
		throws RemoteException;

	public abstract void setPackageManaged(boolean flag)
		throws RemoteException;
}
