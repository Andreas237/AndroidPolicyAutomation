...
public interface ISensorDeviceScanCallback
	extends IInterface
{
		...
		implements ISensorDeviceScanCallback
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.samsung.android.sensor.aidl.ISensorDeviceScanCallback");
		//    4    6:aload_0         
		...
		//    1    1:invokespecial   #27  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.samsung.android.sensor.aidl.ISensorDeviceScanCallback");
		//    2    4:aload_0         
		//    3    5:aload_0         
...
_L1:
	...
	public abstract void onDeviceFound(SensorDeviceInfo sensordeviceinfo)
		throws RemoteException;

	public abstract void onDeviceManufactureIdFound(String s, int i)
		throws RemoteException;

	public abstract void onDeviceScanStarted()
		throws RemoteException;

	public abstract void onDeviceScanStopped()
		throws RemoteException;
}
