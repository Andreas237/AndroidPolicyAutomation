	...
	extends IInterface
{
		...
		implements ISensorServiceCallback
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.samsung.android.sensor.aidl.ISensorServiceCallback");
		//    4    6:aload_0         
		...
		//    1    1:invokespecial   #29  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.samsung.android.sensor.aidl.ISensorServiceCallback");
		//    2    4:aload_0         
		//    3    5:aload_0         
...
_L1:
	...
	public abstract void onDataReceived(String s, SensorData sensordata)
		throws RemoteException;

	public abstract void onDeviceAccessResultReceived(int i, SensorDeviceInfo sensordeviceinfo)
		throws RemoteException;

	public abstract void onSensorDeviceRegistered(SensorDeviceInfo sensordeviceinfo)
		throws RemoteException;

	public abstract void onSensorDeviceUnregistered(SensorDeviceInfo sensordeviceinfo)
		throws RemoteException;

	public abstract void onStateChanged(int i, SensorDeviceInfo sensordeviceinfo)
		throws RemoteException;
}
