...
public static abstract class ISensorServiceInterface$Stub extends Binder
...
_L1:
	...
	//    2    4:aconst_null     
	//    3    5:areturn         
		android.os.IInterface iinterface = ibinder.queryLocalInterface("com.samsung.android.sensor.aidl.ISensorServiceInterface");
	//    4    6:aload_0         
	//    5    7:ldc1            #14  <String "com.samsung.android.sensor.aidl.ISensorServiceInterface">
	//    6    9:invokeinterface #68  <Method android.os.IInterface IBinder.queryLocalInterface(String)>
	//    7   14:astore_1        
	...
	//   99  334:aconst_null     
	//  100  335:astore          8
			startAccessoryDeviceScan(sensorconnectorinfo, b.asInterface(parcel.readStrongBinder()));
			parcel1.writeNoException();
			return true;
	...
	public ISensorServiceInterface$Stub()
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #55  <Method void Binder()>
		attachInterface(((android.os.IInterface) (this)), "com.samsung.android.sensor.aidl.ISensorServiceInterface");
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:ldc1            #14  <String "com.samsung.android.sensor.aidl.ISensorServiceInterface">
	//    5    8:invokevirtual   #59  <Method void attachInterface(android.os.IInterface, String)>
	//    6   11:return          
	}
}
