...
public static final class SensorTypes$SensorConnectionType extends Enum
{

	public static SensorTypes$SensorConnectionType valueOf(String s)
	{
		return (SensorTypes$SensorConnectionType)Enum.valueOf(com/samsung/android/sensor/data/SensorTypes$SensorConnectionType, s);
	...
	public static SensorTypes$SensorConnectionType[] values()
	{
		return (SensorTypes$SensorConnectionType[])((SensorTypes$SensorConnectionType []) ($VALUES)).clone();
	...
	private static final SensorTypes$SensorConnectionType $VALUES[];
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_ALL;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_ANDROID_DEFAULT;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_ANT;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_AUX_PORT;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_BLE;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_BLUETOOTH;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_NFC;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_NONE;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_SAMSUNG_ACCESSORY;
	public static final SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_USB;

	static 
	{
		SENSOR_CONNECTION_TYPE_NONE = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_NONE", 0);
	...
	//    5   10:putstatic       #30  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_NONE>
		SENSOR_CONNECTION_TYPE_ANDROID_DEFAULT = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_ANDROID_DEFAULT", 1);
	...
	//   11   23:putstatic       #33  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_ANDROID_DEFAULT>
		SENSOR_CONNECTION_TYPE_BLUETOOTH = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_BLUETOOTH", 2);
	...
	//   17   36:putstatic       #36  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_BLUETOOTH>
		SENSOR_CONNECTION_TYPE_BLE = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_BLE", 3);
	...
	//   23   49:putstatic       #39  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_BLE>
		SENSOR_CONNECTION_TYPE_USB = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_USB", 4);
	...
	//   29   62:putstatic       #42  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_USB>
		SENSOR_CONNECTION_TYPE_SAMSUNG_ACCESSORY = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_SAMSUNG_ACCESSORY", 5);
	...
	//   35   75:putstatic       #45  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_SAMSUNG_ACCESSORY>
		SENSOR_CONNECTION_TYPE_ANT = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_ANT", 6);
	...
	//   41   89:putstatic       #48  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_ANT>
		SENSOR_CONNECTION_TYPE_NFC = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_NFC", 7);
	...
	//   47  103:putstatic       #51  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_NFC>
		SENSOR_CONNECTION_TYPE_AUX_PORT = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_AUX_PORT", 8);
	...
	//   53  117:putstatic       #54  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_AUX_PORT>
		SENSOR_CONNECTION_TYPE_ALL = new SensorTypes$SensorConnectionType("SENSOR_CONNECTION_TYPE_ALL", 9);
	...
	//   59  131:putstatic       #57  <Field SensorTypes$SensorConnectionType SENSOR_CONNECTION_TYPE_ALL>
		$VALUES = (new SensorTypes$SensorConnectionType[] {
	...
	//   60  134:bipush          10
	//   61  136:anewarray       SensorTypes$SensorConnectionType[]
	//   62  139:dup             
	//   63  140:iconst_0        
	...
	private SensorTypes$SensorConnectionType(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
