...
public interface _PlatformSensorService
	extends IInterface
{
		...
		implements _PlatformSensorService
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.samsung.android.sdk.health.sensor._PlatformSensorService");
		//    4    6:aload_0         
		//    5    7:ldc1            #14  <String "com.samsung.android.sdk.health.sensor._PlatformSensorService">
		//    6    9:invokeinterface #44  <Method IInterface IBinder.queryLocalInterface(String)>
		//    7   14:astore_1        
		...
		//   87  221:aconst_null     
		//   88  222:astore          8
				flag2 = registerListener(_lprivilegesensordevice, _PlatformSensorDataListener.Stub.asInterface(parcel.readStrongBinder()));
				parcel1.writeNoException();
				i = ((int) (flag));
				if(flag2)
					i = 1;
		...
		//    1    1:invokespecial   #31  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.samsung.android.sdk.health.sensor._PlatformSensorService");
		//    2    4:aload_0         
		//    3    5:aload_0         
		//    4    6:ldc1            #14  <String "com.samsung.android.sdk.health.sensor._PlatformSensorService">
		//    5    8:invokevirtual   #35  <Method void attachInterface(IInterface, String)>
		//    6   11:return          
		}
	}
...
_L1:
	...
	public abstract int checkAvailability(int i, int j, int k)
		throws RemoteException;

	public abstract void close(_PrivilegeSensorDevice _pprivilegesensordevice)
		throws RemoteException;

	public abstract int getAPIVersion()
		throws RemoteException;

	public abstract List getConnectedDevices(int i, int j, int k)
		throws RemoteException;

	public abstract boolean registerListener(_PrivilegeSensorDevice _pprivilegesensordevice, _PlatformSensorDataListener _pplatformsensordatalistener)
		throws RemoteException;

	public abstract boolean unregisterListener(_PrivilegeSensorDevice _pprivilegesensordevice)
		throws RemoteException;
}
