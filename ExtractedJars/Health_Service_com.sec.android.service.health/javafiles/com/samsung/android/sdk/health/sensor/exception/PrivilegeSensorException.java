...
public class PrivilegeSensorException extends Exception
{

	public PrivilegeSensorException()
	{
	//    0    0:aload_0         
	...
	public PrivilegeSensorException(String s)
	{
		super(s);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public PrivilegeSensorException(String s, Throwable throwable)
	{
		super(s, throwable);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	public PrivilegeSensorException(Throwable throwable)
	{
		super(throwable);
	//    0    0:aload_0         
	//    1    1:aload_1         
