...
public interface _PlatformSensorDataListener
	extends IInterface
{
		...
		implements _PlatformSensorDataListener
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.samsung.android.sdk.health.sensor._PlatformSensorDataListener");
		//    4    6:aload_0         
		...
		//    1    1:invokespecial   #27  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.samsung.android.sdk.health.sensor._PlatformSensorDataListener");
		//    2    4:aload_0         
		//    3    5:aload_0         
...
_L1:
	...
	public abstract void onBulkDataReceived(int i, Bundle abundle[])
		throws RemoteException;
