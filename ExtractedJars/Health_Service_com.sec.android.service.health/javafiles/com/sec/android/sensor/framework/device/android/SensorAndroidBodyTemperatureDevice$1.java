...
//			SensorAndroidBodyTemperatureDevice

class SensorAndroidBodyTemperatureDevice$1
	implements SensorEventListener
{

	public void onAccuracyChanged(Sensor sensor, int i)
	{
		LOG.i(SensorAndroidBodyTemperatureDevice.access$000(), "onAccuracyChanged()");
	...
	//*   3    8:aload_1         
	//*   4    9:ifnonnull       20
			LOG.w(SensorAndroidBodyTemperatureDevice.access$000(), "onAccuracyChanged() Sensor is null");
	...
	{
		LOG.i(SensorAndroidBodyTemperatureDevice.access$000(), "onSensorChanged()");
	//    0    0:invokestatic    #24  <Method Class SensorAndroidBodyTemperatureDevice.access$000()>
	...
	//*   7   16:ifnonnull       28
			LOG.e(SensorAndroidBodyTemperatureDevice.access$000(), "Sensor Event is null !!!");
	...
	//   28   60:faload          
	//   29   61:fstore_3        
			LOG.d(SensorAndroidBodyTemperatureDevice.access$000(), (new StringBuilder()).append("infraredValue = ").append(f).append(" ledValue = ").append(f1).toString());
	...
	SensorAndroidBodyTemperatureDevice$1()
	{
