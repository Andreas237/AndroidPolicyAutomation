...
public interface IAutoRunInterface
	extends IInterface
{
		...
		implements IAutoRunInterface
	{
		...
		//    2    4:aconst_null     
		//    3    5:areturn         
			IInterface iinterface = ibinder.queryLocalInterface("com.sec.android.service.health.autorun.IAutoRunInterface");
		//    4    6:aload_0         
		...
		//    1    1:invokespecial   #23  <Method void Binder()>
			attachInterface(((IInterface) (this)), "com.sec.android.service.health.autorun.IAutoRunInterface");
		//    2    4:aload_0         
		//    3    5:aload_0         
	...
	public abstract int isAutoRunModeEnabled(String s)
		throws RemoteException;

	public abstract int setAutoRunMode(String s, int i)
		throws RemoteException;
}
