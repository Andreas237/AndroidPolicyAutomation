...
public interface BaseSensorManagerListener
{

	public abstract void onDataReceived(Bundle bundle, RemoteCallbackList remotecallbacklist, _PrivilegeSensorDevice _pprivilegesensordevice, int i, int j);

	public abstract void onDataReceived(Bundle abundle[], RemoteCallbackList remotecallbacklist, _PrivilegeSensorDevice _pprivilegesensordevice, int i, int j);
