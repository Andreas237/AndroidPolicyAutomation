...
.method static synthetic access$500(Lcom/usebutton/sdk/internal/WebViewPresenter;)Lcom/usebutton/sdk/purchasepath/BrowserInterface;
    .locals 0
...
.method static synthetic access$600(Lcom/usebutton/sdk/internal/WebViewPresenter;)Lcom/usebutton/sdk/internal/MainThreadExecutor;
    .locals 0
...
.method private initAutofill()V
    ...
    .line 183
    invoke-virtual {v0}, Lcom/usebutton/sdk/internal/purchasepath/CheckoutManager;->hasAutofillSaveCardModel()Z
    ...
    invoke-virtual {v1}, Lcom/usebutton/sdk/internal/purchasepath/CheckoutManager;->getAutofillSaveCardModel()Lcom/usebutton/sdk/internal/purchasepath/autofill/AutofillModel$SaveCard;

    move-result-object v4

    .line 196
    new-instance v8, Lcom/usebutton/sdk/internal/purchasepath/autofill/AutofillExtension;
    ...
    invoke-virtual {v1}, Lcom/usebutton/sdk/internal/ButtonPrivate;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v5, p0, Lcom/usebutton/sdk/internal/WebViewPresenter;->buttonRepository:Lcom/usebutton/sdk/internal/ButtonRepository;
...
.method public onAutofillFormSubmitted(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v0, p1}, Lcom/usebutton/sdk/internal/purchasepath/autofill/AutofillExtension;->cacheSaveFields(Lorg/json/JSONObject;)V

    :cond_0
    return-void
.end method

.method public onAutofillSaveAccepted(Ljava/util/Map;)V
    .locals 5
    ...
    const-string v1, "btn:autofill-save-accepted"
    ...
    invoke-virtual {v0, p1}, Lcom/usebutton/sdk/internal/user/UserImpl;->savePersonalData(Ljava/util/Map;)V
    ...
    .line 506
    :cond_1
    iget-object p1, p0, Lcom/usebutton/sdk/internal/WebViewPresenter;->checkoutManager:Lcom/usebutton/sdk/internal/purchasepath/CheckoutManager;

    invoke-virtual {p1}, Lcom/usebutton/sdk/internal/purchasepath/CheckoutManager;->hasAutofillExtension()Z
    ...
    invoke-virtual {p1}, Lcom/usebutton/sdk/internal/purchasepath/CheckoutManager;->getAutofillExtension()Lcom/usebutton/sdk/internal/purchasepath/autofill/AutofillExtension;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/usebutton/sdk/internal/purchasepath/autofill/AutofillExtension;->hideAutofillCards(Lcom/usebutton/sdk/purchasepath/CardList;Lcom/usebutton/sdk/purchasepath/BrowserInterface;)V
...
.method public onAutofillSaveDeclined()V
    ...
    const-string v1, "btn:autofill-save-denied"
    ...
    .line 522
    invoke-interface {v1}, Lcom/usebutton/sdk/purchasepath/BrowserInterface;->getCardList()Lcom/usebutton/sdk/purchasepath/CardList;

    move-result-object v1

    iget-object v2, p0, Lcom/usebutton/sdk/internal/WebViewPresenter;->browserInterface:Lcom/usebutton/sdk/purchasepath/BrowserInterface;

    invoke-virtual {v0, v1, v2}, Lcom/usebutton/sdk/internal/purchasepath/autofill/AutofillExtension;->hideAutofillCards(Lcom/usebutton/sdk/purchasepath/CardList;Lcom/usebutton/sdk/purchasepath/BrowserInterface;)V

    return-void
.end method

.method public onAutofillSaveDisplayed()V
    .locals 5

    .line 491
    iget-object v0, p0, Lcom/usebutton/sdk/internal/WebViewPresenter;->eventTracker:Lcom/usebutton/sdk/internal/events/EventTracker;

    const-string v1, "btn:autofill-save-shown"
...
.method public onAutofillUpdateDisplayed()V
    .locals 5
...
.method public onPageCommitVisible(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lcom/usebutton/sdk/internal/browser/BrowserStateMachine;->commit(Ljava/lang/String;)V
