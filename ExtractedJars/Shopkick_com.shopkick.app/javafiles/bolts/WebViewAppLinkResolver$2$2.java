...
//			TaskCompletionSource, Continuation, WebViewAppLinkResolver, Capture, 
//			Task
...
class WebViewAppLinkResolver$2$2
{
	...
	public void setValue(String s)
	{
		try
		{
			val$tcs.trySetResult(((Object) (new JSONArray(s))));
	//    0    0:aload_0         
	...
	//*   9   17:astore_1        
		{
			val$tcs.trySetError(((Exception) (s)));
	//   10   18:aload_0         
	...
	WebViewAppLinkResolver$2$2()
	{
		this$1 = final__pcls2;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #17  <Field WebViewAppLinkResolver$2 this$1>
		val$tcs = TaskCompletionSource.this;
	//    3    5:aload_0         
	//    4    6:aload_2         
...
/* anonymous class */
		...
		implements Continuation
	{
		...
		//   17   33:invokevirtual   #66  <Method void WebView.setNetworkAvailable(boolean)>
			webview.setWebViewClient(((WebViewClient) (new WebViewAppLinkResolver._cls2._cls1())));
		//   18   36:aload_3         
		...
		//   23   45:invokevirtual   #73  <Method void WebView.setWebViewClient(WebViewClient)>
			webview.addJavascriptInterface(((Object) (((WebViewAppLinkResolver._cls2._cls2) (taskcompletionsource)). new WebViewAppLinkResolver._cls2._cls2())), "boltsWebViewAppLinkResolverResult");
		//   24   48:aload_3         
