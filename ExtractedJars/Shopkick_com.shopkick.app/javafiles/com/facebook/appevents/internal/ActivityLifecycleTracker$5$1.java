	...
	implements Runnable
{
	...
	// Unreferenced inner class com/facebook/appevents/internal/ActivityLifecycleTracker$5

/* anonymous class */
	static final class ActivityLifecycleTracker._cls5
		implements Runnable
	{
		...
		//*  18   44:ifgt            100
			{
				ActivityLifecycleTracker._cls5._cls1 _lcls1 = new ActivityLifecycleTracker._cls5._cls1();
