	...
	implements Runnable
{
	...
	InAppPurchaseActivityLifecycleTracker$2$1()
	{
...
/* anonymous class */
		...
		implements android.app.Application.ActivityLifecycleCallbacks
	{
		...
		{
			FacebookSdk.getExecutor().execute(((Runnable) (new InAppPurchaseActivityLifecycleTracker._cls2._cls1())));
		...
		//*   7   18:ifeq            37
				FacebookSdk.getExecutor().execute(new InAppPurchaseActivityLifecycleTracker._cls2._cls2());
		...
		// Unreferenced inner class com/facebook/appevents/internal/InAppPurchaseActivityLifecycleTracker$2$2

/* anonymous class */
		class InAppPurchaseActivityLifecycleTracker._cls2._cls2
			implements Runnable
		{
