...
class SessionLogger
{
	...
	public static void logActivateApp(String s, SourceApplicationInfo sourceapplicationinfo, String s1)
	{
		if(sourceapplicationinfo != null)
	//*   0    0:aload_1         
	//*   1    1:ifnull          12
			sourceapplicationinfo = ((SourceApplicationInfo) (sourceapplicationinfo.toString()));
	//    2    4:aload_1         
	//    3    5:invokevirtual   #71  <Method String SourceApplicationInfo.toString()>
	//    4    8:astore_1        
		else
	//*   5    9:goto            15
			sourceapplicationinfo = "Unclassified";
	...
	//   11   22:astore_3        
		bundle.putString("fb_mobile_launch_source", ((String) (sourceapplicationinfo)));
	//   12   23:aload_3         
	//   13   24:ldc1            #78  <String "fb_mobile_launch_source">
	//   14   26:aload_1         
	//   15   27:invokevirtual   #82  <Method void Bundle.putString(String, String)>
		s = ((String) (new InternalAppEventsLogger(s, s1, ((com.facebook.AccessToken) (null)))));
	...
	//   22   40:astore_0        
		((AppEventsLogger) (s)).logEvent("fb_mobile_activate_app", bundle);
	//   23   41:aload_0         
	...
	public static void logDeactivateApp(String s, SessionInfo sessioninfo, String s1)
	{
		Long long1 = Long.valueOf(sessioninfo.getDiskRestoreTime() - sessioninfo.getSessionLastEventTime().longValue());
	//    0    0:aload_1         
	...
	//   80  169:invokevirtual   #194 <Method void Bundle.putLong(String, long)>
		(new InternalAppEventsLogger(s, s1, ((com.facebook.AccessToken) (null)))).logEvent("fb_mobile_deactivate_app", long1.longValue() / 1000L, ((Bundle) (obj1)));
