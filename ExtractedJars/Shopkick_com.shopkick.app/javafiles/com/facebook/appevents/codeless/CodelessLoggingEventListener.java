...
{
	public static class AutoLoggingAccessibilityDelegate extends android.view.View.AccessibilityDelegate
	{
		...
		//    3    7:astore_1        
			Bundle bundle = CodelessMatcher.getParameters(mapping, (View)rootView.get(), (View)hostView.get());
		//    4    8:aload_0         
		...
		//*  19   42:ifeq            60
				bundle.putDouble("_valueToSum", AppEventUtility.normalizePrice(bundle.getString("_valueToSum")));
		//   20   45:aload_2         
		...
		//   30   65:invokevirtual   #136 <Method void Bundle.putString(String, String)>
			FacebookSdk.getExecutor().execute(((_cls1) (bundle)). new Runnable() {
				...
				final AutoLoggingAccessibilityDelegate this$0;
				final String val$eventName;
				final Bundle val$params;

			
			{
				this$0 = final_autologgingaccessibilitydelegate;
			//    0    0:aload_0         
			//    1    1:aload_1         
		...
		public AutoLoggingAccessibilityDelegate(EventBinding eventbinding, View view, View view1)
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #26  <Method void android.view.View$AccessibilityDelegate()>
			supportCodelessLogging = false;
		...
		//   36   68:astore_2        
				switch(_cls1..SwitchMap.com.facebook.appevents.codeless.internal.EventBinding.ActionType[eventbinding.getType().ordinal()])
	...
	public CodelessLoggingEventListener()
	{
	//    0    0:aload_0         
	...
	public static AutoLoggingAccessibilityDelegate getAccessibilityDelegate(EventBinding eventbinding, View view, View view1)
	{
		return new AutoLoggingAccessibilityDelegate(eventbinding, view, view1);
	//    0    0:new             #8   <Class CodelessLoggingEventListener$AutoLoggingAccessibilityDelegate>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:aload_2         
	//    5    7:invokespecial   #33  <Method void CodelessLoggingEventListener$AutoLoggingAccessibilityDelegate(EventBinding, View, View)>
	//    6   10:areturn         
	}

	private static final String TAG = ((Class) (com/facebook/appevents/codeless/CodelessLoggingEventListener)).getCanonicalName();

	static 
	{
	//    0    0:ldc1            #2   <Class CodelessLoggingEventListener>
...
*/
	...
	// Unreferenced inner class com/facebook/appevents/codeless/CodelessLoggingEventListener$1
