...
public class RCTCodelessLoggingEventListener
{
		...
		implements android.view.View.OnTouchListener
	{
		...
		//   35   72:invokevirtual   #98  <Method void Bundle.putString(String, String)>
			FacebookSdk.getExecutor().execute(((_cls1) (bundle)). new Runnable() {
				...
				final AutoLoggingOnTouchListener this$0;
		...
		public AutoLoggingOnTouchListener(EventBinding eventbinding, View view, View view1)
		{
		//    0    0:aload_0         
	...
	public RCTCodelessLoggingEventListener()
	{
	//    0    0:aload_0         
	...
	public static AutoLoggingOnTouchListener getOnTouchListener(EventBinding eventbinding, View view, View view1)
	{
		return new AutoLoggingOnTouchListener(eventbinding, view, view1);
	//    0    0:new             #6   <Class RCTCodelessLoggingEventListener$AutoLoggingOnTouchListener>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:aload_2         
	//    5    7:invokespecial   #30  <Method void RCTCodelessLoggingEventListener$AutoLoggingOnTouchListener(EventBinding, View, View)>
	//    6   10:areturn         
	}

	private static final String TAG = ((Class) (com/facebook/appevents/codeless/RCTCodelessLoggingEventListener)).getCanonicalName();

	static 
	{
	//    0    0:ldc1            #2   <Class RCTCodelessLoggingEventListener>
