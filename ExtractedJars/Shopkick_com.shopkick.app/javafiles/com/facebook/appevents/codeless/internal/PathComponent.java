...
public final class PathComponent
{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:ldc1            #11  <String "class_name">
	//    5    8:invokevirtual   #48  <Method String JSONObject.getString(String)>
	//    6   11:putfield        #50  <Field String className>
		index = jsonobject.optInt("index", -1);
	//    7   14:aload_0         
	//    8   15:aload_1         
	//    9   16:ldc1            #23  <String "index">
	//   10   18:iconst_m1       
	//   11   19:invokevirtual   #54  <Method int JSONObject.optInt(String, int)>
	//   12   22:putfield        #56  <Field int index>
		id = jsonobject.optInt("id");
	//   13   25:aload_0         
	//   14   26:aload_1         
	//   15   27:ldc1            #20  <String "id">
	//   16   29:invokevirtual   #59  <Method int JSONObject.optInt(String)>
	//   17   32:putfield        #61  <Field int id>
		text = jsonobject.optString("text");
	//   18   35:aload_0         
	//   19   36:aload_1         
	//   20   37:ldc1            #32  <String "text">
	//   21   39:invokevirtual   #64  <Method String JSONObject.optString(String)>
	//   22   42:putfield        #66  <Field String text>
		tag = jsonobject.optString("tag");
	//   23   45:aload_0         
	//   24   46:aload_1         
	//   25   47:ldc1            #29  <String "tag">
	//   26   49:invokevirtual   #64  <Method String JSONObject.optString(String)>
	//   27   52:putfield        #68  <Field String tag>
		description = jsonobject.optString("description");
	//   28   55:aload_0         
	//   29   56:aload_1         
	//   30   57:ldc1            #14  <String "description">
	//   31   59:invokevirtual   #64  <Method String JSONObject.optString(String)>
	//   32   62:putfield        #70  <Field String description>
		hint = jsonobject.optString("hint");
	//   33   65:aload_0         
	//   34   66:aload_1         
	//   35   67:ldc1            #17  <String "hint">
	//   36   69:invokevirtual   #64  <Method String JSONObject.optString(String)>
	//   37   72:putfield        #72  <Field String hint>
		matchBitmask = jsonobject.optInt("match_bitmask");
	//   38   75:aload_0         
	//   39   76:aload_1         
	//   40   77:ldc1            #26  <String "match_bitmask">
	//   41   79:invokevirtual   #59  <Method int JSONObject.optInt(String)>
	//   42   82:putfield        #74  <Field int matchBitmask>
	//   43   85:return          
	}
