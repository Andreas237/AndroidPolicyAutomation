	...
	implements Runnable
{
	...
	//    7   17:invokevirtual   #36  <Method void Timer.cancel()>
			ViewIndexer.access$402(ViewIndexer.this, ((String) (null)));
	//    8   20:aload_0         
	...
	//   19   43:pop             
			ViewIndexer.access$300(ViewIndexer.this).scheduleAtFixedRate(val$indexingTask, 0L, 1000L);
	//   20   44:aload_0         
	...
	//*  29   63:astore_1        
		{
			Log.e(ViewIndexer.access$100(), "Error scheduling indexing job", ((Throwable) (exception)));
