...
public class BundleJSONConverter
{
	...
	//   44  102:aload           4
	//   45  104:aload_1         
	//   46  105:invokeinterface #110 <Method void BundleJSONConverter$Setter.setOnBundle(Bundle, String, Object)>
					} else
	//*  47  110:goto            13
					{
						jsonobject = ((JSONObject) (new StringBuilder()));
	//   48  113:new             #112 <Class StringBuilder>
	//   49  116:dup             
	//   50  117:invokespecial   #113 <Method void StringBuilder()>
	//   51  120:astore_0        
						((StringBuilder) (jsonobject)).append("Unsupported type: ");
	//   52  121:aload_0         
	//   53  122:ldc1            #115 <String "Unsupported type: ">
	//   54  124:invokevirtual   #119 <Method StringBuilder StringBuilder.append(String)>
	//   55  127:pop             
						((StringBuilder) (jsonobject)).append(((Object) (obj.getClass())));
	//   56  128:aload_0         
	//   57  129:aload_1         
	//   58  130:invokevirtual   #103 <Method Class Object.getClass()>
	//   59  133:invokevirtual   #122 <Method StringBuilder StringBuilder.append(Object)>
	//   60  136:pop             
						throw new IllegalArgumentException(((StringBuilder) (jsonobject)).toString());
	//   61  137:new             #124 <Class IllegalArgumentException>
	//   62  140:dup             
	//   63  141:aload_0         
	//   64  142:invokevirtual   #128 <Method String StringBuilder.toString()>
	//   65  145:invokespecial   #131 <Method void IllegalArgumentException(String)>
	//   66  148:athrow          
					}
				}
		} while(true);
	...
	//   70  172:aload_3         
	//   71  173:aload           4
	//   72  175:invokeinterface #161 <Method void BundleJSONConverter$Setter.setOnJSON(JSONObject, String, Object)>
					} else
	//*  73  180:goto            18
					{
						bundle = ((Bundle) (new StringBuilder()));
	//   74  183:new             #112 <Class StringBuilder>
	//   75  186:dup             
	//   76  187:invokespecial   #113 <Method void StringBuilder()>
	//   77  190:astore_0        
						((StringBuilder) (bundle)).append("Unsupported type: ");
	//   78  191:aload_0         
	//   79  192:ldc1            #115 <String "Unsupported type: ">
	//   80  194:invokevirtual   #119 <Method StringBuilder StringBuilder.append(String)>
	//   81  197:pop             
						((StringBuilder) (bundle)).append(((Object) (obj.getClass())));
	//   82  198:aload_0         
	//   83  199:aload           4
	//   84  201:invokevirtual   #103 <Method Class Object.getClass()>
	//   85  204:invokevirtual   #122 <Method StringBuilder StringBuilder.append(Object)>
	//   86  207:pop             
						throw new IllegalArgumentException(((StringBuilder) (bundle)).toString());
	//   87  208:new             #124 <Class IllegalArgumentException>
	//   88  211:dup             
	//   89  212:aload_0         
	//   90  213:invokevirtual   #128 <Method String StringBuilder.toString()>
	//   91  216:invokespecial   #131 <Method void IllegalArgumentException(String)>
	//   92  219:athrow          
					}
				}
		} while(true);
