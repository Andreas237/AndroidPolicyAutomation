	...
	implements ServiceConnection
{
	...
	//    0    0:aload_1         
	//    1    1:getfield        #114 <Field int Message.what>
	//    2    4:aload_0         
	//    3    5:getfield        #44  <Field int replyMessage>
	//    4    8:icmpne          46
		message = ((Message) (message.getData()));
	//    5   11:aload_1         
	//    6   12:invokevirtual   #118 <Method Bundle Message.getData()>
	//    7   15:astore_1        
		if(((Bundle) (message)).getString("com.facebook.platform.status.ERROR_TYPE") != null)
	//*   8   16:aload_1         
	//*   9   17:ldc1            #120 <String "com.facebook.platform.status.ERROR_TYPE">
	//*  10   19:invokevirtual   #124 <Method String Bundle.getString(String)>
	//*  11   22:ifnull          33
			callback(((Bundle) (null)));
	//   12   25:aload_0         
	//   13   26:aconst_null     
	...
	//   21   42:aload_0         
	//   22   43:invokevirtual   #128 <Method void Context.unbindService(ServiceConnection)>
		return;
	//   23   46:return          
		message;
	//   24   47:astore_1        
	...
	//    2    4:dup             
	//    3    5:aload_2         
	//    4    6:invokespecial   #133 <Method void Messenger(IBinder)>
	//    5    9:putfield        #100 <Field Messenger sender>
		sendMessage();
	//    6   12:aload_0         
	//    7   13:invokespecial   #135 <Method void sendMessage()>
	//    8   16:return          
	}
	...
	//    5    9:aload_0         
	//    6   10:invokevirtual   #128 <Method void Context.unbindService(ServiceConnection)>
		}
	//*   7   13:aload_0         
	//*   8   14:aconst_null     
