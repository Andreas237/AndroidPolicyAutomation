...
_L4:
	...
	//    6   10:new             #130 <Class File>
	//    7   13:dup             
	//    8   14:aload_2         
	//    9   15:aload_0         
	//   10   16:invokevirtual   #204 <Method String UUID.toString()>
	//   11   19:invokespecial   #189 <Method void File(File, String)>
	//   12   22:astore_0        
		if(flag && !((File) (uuid)).exists())
	//*  13   23:iload_1         
	//*  14   24:ifeq            39
	//*  15   27:aload_0         
	//*  16   28:invokevirtual   #207 <Method boolean File.exists()>
	//*  17   31:ifne            39
			((File) (uuid)).mkdirs();
	//   18   34:aload_0         
	//   19   35:invokevirtual   #176 <Method boolean File.mkdirs()>
	//   20   38:pop             
		return ((File) (uuid));
	//   21   39:aload_0         
	//   22   40:areturn         
	...
	//    6   12:aload_1         
	//    7   13:iconst_0        
	//    8   14:invokestatic    #78  <Method File getAttachmentFile(UUID, String, boolean)>
	//    9   17:astore_0        
			}
	//*  10   18:aload_0         
	//*  11   19:areturn         
	//*  12   20:new             #211 <Class FileNotFoundException>
	//*  13   23:dup             
	//*  14   24:invokespecial   #216 <Method void FileNotFoundException()>
	//*  15   27:athrow          
	//*  16   28:new             #211 <Class FileNotFoundException>
	//*  17   31:dup             
	//*  18   32:invokespecial   #216 <Method void FileNotFoundException()>
	//*  19   35:athrow          
			// Misplaced declaration of an exception variable
			catch(UUID uuid)
			{
	...
	//   26   50:astore_0        
		Utility.closeQuietly(((java.io.Closeable) (file)));
	//   27   51:aload_2         
	//   28   52:invokestatic    #236 <Method void Utility.closeQuietly(java.io.Closeable)>
		throw uri;
	//   29   55:aload_0         
	//   30   56:athrow          
	}
