...
class KatanaProxyLoginMethodHandler extends NativeAppLoginMethodHandler
{
	...
	//    0    0:ldc1            #29  <String "katana_proxy_auth">
	//    1    2:areturn         
	}
	...
	//    1    3:astore_2        
		request = ((LoginClient.Request) (NativeProtocol.createProxyAuthIntent(((android.content.Context) (loginClient.getActivity())), request.getApplicationId(), ((java.util.Collection) (request.getPermissions())), s, request.isRerequest(), request.hasPublishPermission(), request.getDefaultAudience(), getClientState(request.getAuthId()), request.getAuthType())));
	//    2    4:aload_0         
	...
	//   22   44:invokestatic    #80  <Method android.content.Intent NativeProtocol.createProxyAuthIntent(android.content.Context, String, java.util.Collection, String, boolean, boolean, DefaultAudience, String, String)>
	//   23   47:astore_1        
