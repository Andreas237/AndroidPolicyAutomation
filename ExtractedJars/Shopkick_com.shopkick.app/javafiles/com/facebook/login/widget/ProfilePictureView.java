...
public class ProfilePictureView extends FrameLayout
{
	...
	//    9   44:getstatic       #107 <Field int com.facebook.login.R$dimen.com_facebook_profilepictureview_preset_size_normal>
	//   10   47:istore_2        
			break;
	...
	//   12   51:getstatic       #110 <Field int com.facebook.login.R$dimen.com_facebook_profilepictureview_preset_size_small>
	//   13   54:istore_2        
			break;
	...
	//*  14   55:goto            69
		case -3: 
			i = com.facebook.login.R.dimen.com_facebook_profilepictureview_preset_size_normal;
	//   15   58:getstatic       #107 <Field int com.facebook.login.R$dimen.com_facebook_profilepictureview_preset_size_normal>
	//   16   61:istore_2        
			break;
	...
	//   18   65:getstatic       #113 <Field int com.facebook.login.R$dimen.com_facebook_profilepictureview_preset_size_large>
	//   19   68:istore_2        
			break;
		}
	...
	{
		attributeset = ((AttributeSet) (getContext().obtainStyledAttributes(attributeset, com.facebook.login.R.styleable.com_facebook_profile_picture_view)));
	//    0    0:aload_0         
	//    1    1:invokevirtual   #158 <Method Context getContext()>
	//    2    4:aload_1         
	//    3    5:getstatic       #164 <Field int[] com.facebook.login.R$styleable.com_facebook_profile_picture_view>
	//    4    8:invokevirtual   #170 <Method TypedArray Context.obtainStyledAttributes(AttributeSet, int[])>
	//    5   11:astore_1        
		setPresetSize(((TypedArray) (attributeset)).getInt(com.facebook.login.R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:getstatic       #173 <Field int com.facebook.login.R$styleable.com_facebook_profile_picture_view_com_facebook_preset_size>
	//    9   17:iconst_m1       
	//   10   18:invokevirtual   #179 <Method int TypedArray.getInt(int, int)>
	//   11   21:invokevirtual   #183 <Method void setPresetSize(int)>
		isCropped = ((TypedArray) (attributeset)).getBoolean(com.facebook.login.R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
	//   12   24:aload_0         
	//   13   25:aload_1         
	//   14   26:getstatic       #186 <Field int com.facebook.login.R$styleable.com_facebook_profile_picture_view_com_facebook_is_cropped>
	//   15   29:iconst_1        
	...
	//*   7   11:ifnull          52
	//*   8   14:aload_3         
	//*   9   15:invokevirtual   #278 <Method int String.length()>
	//*  10   18:ifeq            52
	//*  11   21:aload_0         
	//*  12   22:getfield        #75  <Field int queryWidth>
	//*  13   25:ifne            38
	//*  14   28:aload_0         
	//*  15   29:getfield        #73  <Field int queryHeight>
	//*  16   32:ifne            38
	//*  17   35:goto            52
		{
			if(flag1 || flag)
	...
	//   22   46:aload_0         
	//   23   47:iconst_1        
	//   24   48:invokespecial   #266 <Method void sendImageRequest(boolean)>
				return;
	//   25   51:return          
			}
		} else
	...
	//   26   52:aload_0         
	//   27   53:invokespecial   #281 <Method void setBlankProfilePicture()>
		}
	//   28   56:return          
	}
	...
	//   28   58:aload_3         
	//   29   59:invokestatic    #316 <Method boolean ImageDownloader.cancelRequest(ImageRequest)>
	//   30   62:pop             
		lastRequest = imagerequest;
	//   31   63:aload_0         
	//   32   64:aload_2         
	//   33   65:putfield        #201 <Field ImageRequest lastRequest>
		ImageDownloader.downloadAsync(imagerequest);
	//   34   68:aload_2         
	//   35   69:invokestatic    #320 <Method void ImageDownloader.downloadAsync(ImageRequest)>
	//   36   72:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:invokestatic    #316 <Method boolean ImageDownloader.cancelRequest(ImageRequest)>
	//    7   13:pop             
		if(customizedDefaultProfilePicture == null)
	//*   8   14:aload_0         
	//*   9   15:getfield        #81  <Field Bitmap customizedDefaultProfilePicture>
	//*  10   18:ifnonnull       52
		{
			int i;
			if(isCropped())
	//*  11   21:aload_0         
	//*  12   22:invokevirtual   #322 <Method boolean isCropped()>
	//*  13   25:ifeq            35
				i = com.facebook.login.R.drawable.com_facebook_profile_picture_blank_square;
	//   14   28:getstatic       #327 <Field int com.facebook.login.R$drawable.com_facebook_profile_picture_blank_square>
	//   15   31:istore_1        
			else
	//*  16   32:goto            39
				i = com.facebook.login.R.drawable.com_facebook_profile_picture_blank_portrait;
	//   17   35:getstatic       #330 <Field int com.facebook.login.R$drawable.com_facebook_profile_picture_blank_portrait>
	//   18   38:istore_1        
			setImageBitmap(BitmapFactory.decodeResource(getResources(), i));
	//   19   39:aload_0         
	//   20   40:aload_0         
	//   21   41:invokevirtual   #117 <Method Resources getResources()>
	//   22   44:iload_1         
	//   23   45:invokestatic    #336 <Method Bitmap BitmapFactory.decodeResource(Resources, int)>
	//   24   48:invokespecial   #258 <Method void setImageBitmap(Bitmap)>
			return;
	//   25   51:return          
		} else
		{
	...
	//   26   52:aload_0         
	//   27   53:invokespecial   #270 <Method boolean updateImageQueryParameters()>
	//   28   56:pop             
			setImageBitmap(Bitmap.createScaledBitmap(customizedDefaultProfilePicture, queryWidth, queryHeight, false));
	//   29   57:aload_0         
	//   30   58:aload_0         
	//   31   59:getfield        #81  <Field Bitmap customizedDefaultProfilePicture>
	//   32   62:aload_0         
	//   33   63:getfield        #75  <Field int queryWidth>
	//   34   66:aload_0         
	//   35   67:getfield        #73  <Field int queryHeight>
	//   36   70:iconst_0        
	//   37   71:invokestatic    #342 <Method Bitmap Bitmap.createScaledBitmap(Bitmap, int, int, boolean)>
	//   38   74:invokespecial   #258 <Method void setImageBitmap(Bitmap)>
			return;
	//   39   77:return          
		}
	}
	...
	//    7   13:aload_0         
	//    8   14:aload_1         
	//    9   15:putfield        #344 <Field Bitmap imageContents>
			imageview.setImageBitmap(bitmap);
	//   10   18:aload_2         
	//   11   19:aload_1         
	//   12   20:invokevirtual   #345 <Method void ImageView.setImageBitmap(Bitmap)>
		}
	//   13   23:return          
	}
	...
	//   41   81:aload_0         
	//   42   82:iconst_1        
	//   43   83:invokespecial   #365 <Method void refreshImage(boolean)>
			return;
	//   44   86:return          
		}
	}
	...
	//   26   50:aload_3         
	//   27   51:ldc1            #19  <String "ProfilePictureView_width">
	//   28   53:aload_0         
	//   29   54:getfield        #75  <Field int queryWidth>
	//   30   57:invokevirtual   #441 <Method void Bundle.putInt(String, int)>
		bundle.putInt("ProfilePictureView_height", queryHeight);
	//   31   60:aload_3         
	//   32   61:ldc1            #13  <String "ProfilePictureView_height">
	//   33   63:aload_0         
	//   34   64:getfield        #73  <Field int queryHeight>
	//   35   67:invokevirtual   #441 <Method void Bundle.putInt(String, int)>
		boolean flag;
		if(lastRequest != null)
	//*  36   70:aload_0         
	//*  37   71:getfield        #201 <Field ImageRequest lastRequest>
	//*  38   74:ifnull          82
			flag = true;
	//   39   77:iconst_1        
	//   40   78:istore_1        
	...
	//   44   84:aload_3         
	//   45   85:ldc1            #36  <String "ProfilePictureView_refresh">
	//   46   87:iload_1         
	//   47   88:invokevirtual   #445 <Method void Bundle.putBoolean(String, boolean)>
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #272 <Field String profileId>
	//*   2    4:invokestatic    #466 <Method boolean Utility.isNullOrEmpty(String)>
	//*   3    7:ifne            29
	//*   4   10:aload_0         
	//*   5   11:getfield        #272 <Field String profileId>
	//*   6   14:aload_1         
	//*   7   15:invokevirtual   #469 <Method boolean String.equalsIgnoreCase(String)>
	//*   8   18:ifne            24
	//*   9   21:goto            29
		{
			flag = false;
