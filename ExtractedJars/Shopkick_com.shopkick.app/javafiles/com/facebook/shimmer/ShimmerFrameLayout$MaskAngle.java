...
public static final class ShimmerFrameLayout$MaskAngle extends Enum
{

	public static ShimmerFrameLayout$MaskAngle valueOf(String s)
	{
		return (ShimmerFrameLayout$MaskAngle)Enum.valueOf(com/facebook/shimmer/ShimmerFrameLayout$MaskAngle, s);
	...
	public static ShimmerFrameLayout$MaskAngle[] values()
	{
		return (ShimmerFrameLayout$MaskAngle[])((ShimmerFrameLayout$MaskAngle []) ($VALUES)).clone();
	...
	private static final ShimmerFrameLayout$MaskAngle $VALUES[];
	public static final ShimmerFrameLayout$MaskAngle CW_0;
	public static final ShimmerFrameLayout$MaskAngle CW_180;
	public static final ShimmerFrameLayout$MaskAngle CW_270;
	public static final ShimmerFrameLayout$MaskAngle CW_90;

	static 
	{
		CW_0 = new ShimmerFrameLayout$MaskAngle("CW_0", 0);
	...
	//    5   10:putstatic       #24  <Field ShimmerFrameLayout$MaskAngle CW_0>
		CW_90 = new ShimmerFrameLayout$MaskAngle("CW_90", 1);
	...
	//   11   23:putstatic       #27  <Field ShimmerFrameLayout$MaskAngle CW_90>
		CW_180 = new ShimmerFrameLayout$MaskAngle("CW_180", 2);
	...
	//   17   36:putstatic       #30  <Field ShimmerFrameLayout$MaskAngle CW_180>
		CW_270 = new ShimmerFrameLayout$MaskAngle("CW_270", 3);
	...
	//   23   49:putstatic       #33  <Field ShimmerFrameLayout$MaskAngle CW_270>
		$VALUES = (new ShimmerFrameLayout$MaskAngle[] {
			CW_0, CW_90, CW_180, CW_270
		});
	//   24   52:iconst_4        
	//   25   53:anewarray       ShimmerFrameLayout$MaskAngle[]
	//   26   56:dup             
	//   27   57:iconst_0        
	...
	private ShimmerFrameLayout$MaskAngle(String s, int i)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
