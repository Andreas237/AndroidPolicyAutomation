...
public class ScannerException extends Exception
{
	...
	public ScannerException(Type type1)
	{
	...
	//    4    8:aload_2         
	//    5    9:ldc1            #18  <String "Type: ">
	//    6   11:invokevirtual   #22  <Method StringBuilder StringBuilder.append(String)>
	//    7   14:pop             
		stringbuilder.append(type1.name());
	//    8   15:aload_2         
	//    9   16:aload_1         
	//   10   17:invokevirtual   #26  <Method String ScannerException$Type.name()>
	//   11   20:invokevirtual   #22  <Method StringBuilder StringBuilder.append(String)>
	//   12   23:pop             
		super(stringbuilder.toString());
	//   13   24:aload_0         
	//   14   25:aload_2         
	//   15   26:invokevirtual   #29  <Method String StringBuilder.toString()>
	//   16   29:invokespecial   #32  <Method void Exception(String)>
		type = type1;
	//   17   32:aload_0         
	//   18   33:aload_1         
	//   19   34:putfield        #34  <Field ScannerException$Type type>
	//   20   37:return          
	}

	public ScannerException(Type type1, Exception exception)
	{
		StringBuilder stringbuilder = new StringBuilder();
	//    0    0:new             #13  <Class StringBuilder>
	//    1    3:dup             
	...
	//   15   26:invokevirtual   #29  <Method String StringBuilder.toString()>
	//   16   29:aload_2         
	//   17   30:invokespecial   #39  <Method void Exception(String, Throwable)>
		type = type1;
	//   18   33:aload_0         
	//   19   34:aload_1         
	//   20   35:putfield        #34  <Field ScannerException$Type type>
	//   21   38:return          
	}

	public ScannerException(Type type1, String s)
	{
		super(s);
	//    0    0:aload_0         
	//    1    1:aload_2         
	//    2    2:invokespecial   #32  <Method void Exception(String)>
		type = type1;
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:putfield        #34  <Field ScannerException$Type type>
	//    6   10:return          
	}
