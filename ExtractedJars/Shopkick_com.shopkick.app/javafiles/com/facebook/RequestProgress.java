...
class RequestProgress
{
	...
	//*  16   29:ifle            101
	//*  17   32:aload           5
	//*  18   34:instanceof      #55  <Class GraphRequest$OnProgressCallback>
	//*  19   37:ifeq            101
			{
	...
	//   23   45:aload           5
	//   24   47:checkcast       #55  <Class GraphRequest$OnProgressCallback>
	//   25   50:astore          5
	...
	//   32   65:lload_3         
	//   33   66:lload_1         
	//   34   67:invokeinterface #59  <Method void GraphRequest$OnProgressCallback.onProgress(long, long)>
				else
	//*  35   72:goto            93
	...
	//   41   84:lload_3         
	//   42   85:lload_1         
	//   43   86:invokespecial   #62  <Method void RequestProgress$1(RequestProgress, GraphRequest$OnProgressCallback, long, long)>
	//   44   89:invokevirtual   #68  <Method boolean Handler.post(Runnable)>
	//   45   92:pop             
