...
static final class ShareInternalUtility$9
	implements com.facebook.internal.Utility.Mapper
{

	public com.facebook.internal.Store.Attachment apply(SharePhoto sharephoto)
	{
		return ShareInternalUtility.access$000(val$appCallId, ((com.facebook.share.model.ShareMedia) (sharephoto)));
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field UUID val$appCallId>
	//    2    4:aload_1         
	//    3    5:invokestatic    #28  <Method com.facebook.internal.NativeAppCallAttachmentStore$Attachment ShareInternalUtility.access$000(UUID, com.facebook.share.model.ShareMedia)>
	//    4    8:areturn         
	}
	...
	ShareInternalUtility$9(UUID uuid)
	{
		val$appCallId = uuid;
	//    0    0:aload_0         
	//    1    1:aload_1         
