...
static final class ShareInternalUtility$7
	implements otoJSONProcessor
{

	public JSONObject toJSONObject(SharePhoto sharephoto)
	{
		com.facebook.internal.Store.Attachment attachment = ShareInternalUtility.access$000(val$callId, ((com.facebook.share.model.ShareMedia) (sharephoto)));
	//    0    0:aload_0         
	//    1    1:getfield        #19  <Field UUID val$callId>
	//    2    4:aload_1         
	//    3    5:invokestatic    #33  <Method com.facebook.internal.NativeAppCallAttachmentStore$Attachment ShareInternalUtility.access$000(UUID, com.facebook.share.model.ShareMedia)>
	//    4    8:astore_2        
		if(attachment == null)
	//*   5    9:aload_2         
	//*   6   10:ifnonnull       15
