...
public class CameraEffectJSONUtility
{
	...
	public CameraEffectJSONUtility()
	{
	//    0    0:aload_0         
	...
	//    4    6:new             #48  <Class com.facebook.share.model.CameraEffectArguments$Builder>
	//    5    9:dup             
	//    6   10:invokespecial   #49  <Method void com.facebook.share.model.CameraEffectArguments$Builder()>
	//    7   13:astore_2        
		Iterator iterator = jsonobject.keys();
	//    8   14:aload_0         
	//    9   15:invokevirtual   #55  <Method Iterator JSONObject.keys()>
	//   10   18:astore_3        
		do
		{
			if(!iterator.hasNext())
				break;
	//   11   19:aload_3         
	//   12   20:invokeinterface #61  <Method boolean Iterator.hasNext()>
	//   13   25:ifeq            132
			String s = (String)iterator.next();
	//   14   28:aload_3         
	//   15   29:invokeinterface #65  <Method Object Iterator.next()>
	//   16   34:checkcast       #27  <Class String>
	//   17   37:astore          4
			Object obj = jsonobject.get(s);
	//   18   39:aload_0         
	//   19   40:aload           4
	//   20   42:invokevirtual   #69  <Method Object JSONObject.get(String)>
	//   21   45:astore_1        
			if(obj != null && obj != JSONObject.NULL)
	//*  22   46:aload_1         
	//*  23   47:ifnull          19
	//*  24   50:aload_1         
	//*  25   51:getstatic       #73  <Field Object JSONObject.NULL>
	//*  26   54:if_acmpne       60
	//*  27   57:goto            19
			{
				Setter setter = (Setter)SETTERS.get(((Object) (obj.getClass())));
	//   28   60:getstatic       #25  <Field Map SETTERS>
	//   29   63:aload_1         
	//   30   64:invokevirtual   #77  <Method Class Object.getClass()>
	//   31   67:invokeinterface #80  <Method Object Map.get(Object)>
	//   32   72:checkcast       #12  <Class CameraEffectJSONUtility$Setter>
	//   33   75:astore          5
				if(setter != null)
	//*  34   77:aload           5
	//*  35   79:ifnull          96
				{
					setter.setOnArgumentsBuilder(builder, s, obj);
	//   36   82:aload           5
	//   37   84:aload_2         
	//   38   85:aload           4
	//   39   87:aload_1         
	//   40   88:invokeinterface #84  <Method void CameraEffectJSONUtility$Setter.setOnArgumentsBuilder(com.facebook.share.model.CameraEffectArguments$Builder, String, Object)>
				} else
	//*  41   93:goto            19
				{
					jsonobject = ((JSONObject) (new StringBuilder()));
	//   42   96:new             #86  <Class StringBuilder>
	//   43   99:dup             
	//   44  100:invokespecial   #87  <Method void StringBuilder()>
	//   45  103:astore_0        
					((StringBuilder) (jsonobject)).append("Unsupported type: ");
	//   46  104:aload_0         
	//   47  105:ldc1            #89  <String "Unsupported type: ">
	//   48  107:invokevirtual   #93  <Method StringBuilder StringBuilder.append(String)>
	//   49  110:pop             
					((StringBuilder) (jsonobject)).append(((Object) (obj.getClass())));
	//   50  111:aload_0         
	//   51  112:aload_1         
	//   52  113:invokevirtual   #77  <Method Class Object.getClass()>
	//   53  116:invokevirtual   #96  <Method StringBuilder StringBuilder.append(Object)>
	//   54  119:pop             
					throw new IllegalArgumentException(((StringBuilder) (jsonobject)).toString());
	//   55  120:new             #98  <Class IllegalArgumentException>
	//   56  123:dup             
	//   57  124:aload_0         
	//   58  125:invokevirtual   #102 <Method String StringBuilder.toString()>
	//   59  128:invokespecial   #105 <Method void IllegalArgumentException(String)>
	//   60  131:athrow          
				}
			}
		} while(true);
	...
	//   61  132:aload_2         
	//   62  133:invokevirtual   #109 <Method CameraEffectArguments com.facebook.share.model.CameraEffectArguments$Builder.build()>
	//   63  136:areturn         
	}
	...
	//    4    6:new             #51  <Class JSONObject>
	//    5    9:dup             
	//    6   10:invokespecial   #113 <Method void JSONObject()>
	//    7   13:astore_2        
		Iterator iterator = cameraeffectarguments.keySet().iterator();
	//    8   14:aload_0         
	//    9   15:invokevirtual   #119 <Method Set CameraEffectArguments.keySet()>
	//   10   18:invokeinterface #124 <Method Iterator Set.iterator()>
	//   11   23:astore_3        
		do
		{
			if(!iterator.hasNext())
				break;
	//   12   24:aload_3         
	//   13   25:invokeinterface #61  <Method boolean Iterator.hasNext()>
	//   14   30:ifeq            130
			String s = (String)iterator.next();
	//   15   33:aload_3         
	//   16   34:invokeinterface #65  <Method Object Iterator.next()>
	//   17   39:checkcast       #27  <Class String>
	//   18   42:astore          4
			Object obj = cameraeffectarguments.get(s);
	//   19   44:aload_0         
	//   20   45:aload           4
	//   21   47:invokevirtual   #125 <Method Object CameraEffectArguments.get(String)>
	//   22   50:astore_1        
			if(obj != null)
	//*  23   51:aload_1         
	//*  24   52:ifnonnull       58
	...
	//   27   61:aload_1         
	//   28   62:invokevirtual   #77  <Method Class Object.getClass()>
	//   29   65:invokeinterface #80  <Method Object Map.get(Object)>
	...
	//   36   83:aload           4
	//   37   85:aload_1         
	//   38   86:invokeinterface #129 <Method void CameraEffectJSONUtility$Setter.setOnJSON(JSONObject, String, Object)>
				} else
	//*  39   91:goto            24
				{
					cameraeffectarguments = ((CameraEffectArguments) (new StringBuilder()));
	//   40   94:new             #86  <Class StringBuilder>
	//   41   97:dup             
	//   42   98:invokespecial   #87  <Method void StringBuilder()>
	//   43  101:astore_0        
					((StringBuilder) (cameraeffectarguments)).append("Unsupported type: ");
	//   44  102:aload_0         
	//   45  103:ldc1            #89  <String "Unsupported type: ">
	//   46  105:invokevirtual   #93  <Method StringBuilder StringBuilder.append(String)>
	//   47  108:pop             
					((StringBuilder) (cameraeffectarguments)).append(((Object) (obj.getClass())));
	//   48  109:aload_0         
	//   49  110:aload_1         
	//   50  111:invokevirtual   #77  <Method Class Object.getClass()>
	//   51  114:invokevirtual   #96  <Method StringBuilder StringBuilder.append(Object)>
	//   52  117:pop             
					throw new IllegalArgumentException(((StringBuilder) (cameraeffectarguments)).toString());
	//   53  118:new             #98  <Class IllegalArgumentException>
	//   54  121:dup             
	//   55  122:aload_0         
	//   56  123:invokevirtual   #102 <Method String StringBuilder.toString()>
	//   57  126:invokespecial   #105 <Method void IllegalArgumentException(String)>
	//   58  129:athrow          
				}
			}
		} while(true);
