...
public class LikeActionController
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #214 <Method void Object()>
		objectId = s;
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #216 <Field String objectId>
		objectType = objecttype;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//    8   14:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aconst_null     
	//    3    3:invokestatic    #259 <Method void broadcastAction(LikeActionController, String, Bundle)>
	//    4    6:return          
	}
	...
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokespecial   #342 <Method void Intent(String)>
	//    4    8:astore_3        
		s = ((String) (bundle));
	//    5    9:aload_2         
	//    6   10:astore_1        
	...
	//*  12   18:ifnonnull       29
				s = ((String) (new Bundle()));
	//   13   21:new             #344 <Class Bundle>
	//   14   24:dup             
	//   15   25:invokespecial   #345 <Method void Bundle()>
	//   16   28:astore_1        
			((Bundle) (s)).putString("com.facebook.sdk.LikeActionController.OBJECT_ID", likeactioncontroller.getObjectId());
	//   17   29:aload_1         
	//   18   30:ldc1            #93  <String "com.facebook.sdk.LikeActionController.OBJECT_ID">
	//   19   32:aload_0         
	//   20   33:invokevirtual   #348 <Method String getObjectId()>
	//   21   36:invokevirtual   #351 <Method void Bundle.putString(String, String)>
		}
		if(s != null)
	//*  22   39:aload_1         
	//*  23   40:ifnull          49
	...
	//   24   43:aload_3         
	//   25   44:aload_1         
	//   26   45:invokevirtual   #355 <Method Intent Intent.putExtras(Bundle)>
	//   27   48:pop             
		LocalBroadcastManager.getInstance(FacebookSdk.getApplicationContext()).sendBroadcast(intent);
	//   28   49:invokestatic    #361 <Method Context FacebookSdk.getApplicationContext()>
	//   29   52:invokestatic    #367 <Method LocalBroadcastManager LocalBroadcastManager.getInstance(Context)>
	//   30   55:aload_3         
	//   31   56:invokevirtual   #371 <Method boolean LocalBroadcastManager.sendBroadcast(Intent)>
	//   32   59:pop             
	//   33   60:return          
	}
	...
	{
		AccessToken accesstoken = AccessToken.getCurrentAccessToken();
	//    0    0:invokestatic    #379 <Method AccessToken AccessToken.getCurrentAccessToken()>
	//    1    3:astore_1        
	...
	//    2    4:aload_0         
	//    3    5:getfield        #293 <Field boolean objectIsPage>
	//    4    8:ifne            48
	//    5   11:aload_0         
	//    6   12:getfield        #262 <Field String verifiedObjectId>
	//    7   15:ifnull          48
	//    8   18:invokestatic    #382 <Method boolean AccessToken.isCurrentAccessTokenActive()>
	//    9   21:ifeq            48
	//   10   24:aload_1         
	//   11   25:invokevirtual   #386 <Method Set AccessToken.getPermissions()>
	//   12   28:ifnull          48
	//   13   31:aload_1         
	//   14   32:invokevirtual   #386 <Method Set AccessToken.getPermissions()>
	//   15   35:ldc2            #388 <String "publish_actions">
	//   16   38:invokeinterface #394 <Method boolean Set.contains(Object)>
	//   17   43:ifeq            48
	//   18   46:iconst_1        
	//   19   47:ireturn         
	//   20   48:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:putfield        #397 <Field Bundle facebookDialogAnalyticsBundle>
		storeObjectIdForPendingController(((String) (null)));
	//    3    5:aconst_null     
	//    4    6:invokestatic    #400 <Method void storeObjectIdForPendingController(String)>
	//    5    9:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #404 <Method LikeActionController getControllerFromInMemoryCache(String)>
	//    2    4:astore_3        
		if(likeactioncontroller != null)
	//*   3    5:aload_3         
	//*   4    6:ifnull          16
	...
	//    6   10:aload_1         
	//    7   11:aload_2         
	//    8   12:invokestatic    #408 <Method void verifyControllerAndInvokeCallback(LikeActionController, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
			return;
	//    9   15:return          
		}
		LikeActionController likeactioncontroller1 = deserializeFromDiskSynchronously(s);
	//   10   16:aload_0         
	//   11   17:invokestatic    #411 <Method LikeActionController deserializeFromDiskSynchronously(String)>
	//   12   20:astore          4
	...
	//   19   34:aload_0         
	//   20   35:aload_1         
	//   21   36:invokespecial   #413 <Method void LikeActionController(String, com.facebook.share.widget.LikeView$ObjectType)>
	//   22   39:astore_3        
			serializeToDiskAsync(likeactioncontroller);
	//   23   40:aload_3         
	//   24   41:invokestatic    #416 <Method void serializeToDiskAsync(LikeActionController)>
		}
		putControllerInMemoryCache(s, likeactioncontroller);
	//   25   44:aload_0         
	//   26   45:aload_3         
	//   27   46:invokestatic    #420 <Method void putControllerInMemoryCache(String, LikeActionController)>
	...
	//   28   49:getstatic       #422 <Field Handler handler>
	//   29   52:new             #14  <Class LikeActionController$2>
	//   30   55:dup             
	//   31   56:aload_3         
	//   32   57:invokespecial   #424 <Method void LikeActionController$2(LikeActionController)>
	//   33   60:invokevirtual   #430 <Method boolean Handler.post(Runnable)>
	//   34   63:pop             
		invokeCallbackWithController(creationcallback, likeactioncontroller, ((FacebookException) (null)));
	//   35   64:aload_2         
	//   36   65:aload_3         
	//   37   66:aconst_null     
	//   38   67:invokestatic    #434 <Method void invokeCallbackWithController(LikeActionController$CreationCallback, LikeActionController, FacebookException)>
	//   39   70:return          
	}
	...
	//    6    8:aload_0         
	//    7    9:invokestatic    #440 <Method String getCacheKeyForObjectId(String)>
	//    8   12:astore_0        
		obj = ((Object) (controllerDiskCache.get(s)));
	//    9   13:getstatic       #324 <Field FileLruCache controllerDiskCache>
	//   10   16:aload_0         
	//   11   17:invokevirtual   #446 <Method java.io.InputStream FileLruCache.get(String)>
	//   12   20:astore_1        
		s = ((String) (obj2));
	//   13   21:aload_3         
	//   14   22:astore_0        
...
_L1:
	...
	//   19   29:aload_1         
	//   20   30:invokestatic    #452 <Method String Utility.readStreamToString(java.io.InputStream)>
	//   21   33:astore          6
		s = ((String) (obj2));
	//   22   35:aload_3         
	//   23   36:astore_0        
	...
	//   26   39:aload           6
	//   27   41:invokestatic    #456 <Method boolean Utility.isNullOrEmpty(String)>
	//   28   44:ifne            64
_L3:
		obj1 = obj;
	//   29   47:aload_1         
	...
	//   31   49:aload           6
	//   32   51:invokestatic    #459 <Method LikeActionController deserializeFromJson(String)>
	//   33   54:astore_0        
		  goto _L2
	//*  34   55:goto            64
...
_L7:
	...
	//   47   74:aload_2         
	//   48   75:invokestatic    #463 <Method void Utility.closeQuietly(java.io.Closeable)>
...
_L4:
	...
	//   60   91:getstatic       #228 <Field String TAG>
	//   61   94:ldc2            #465 <String "Unable to deserialize controller from disk">
	//   62   97:aload_3         
	//   63   98:invokestatic    #471 <Method int Log.e(String, String, Throwable)>
	//   64  101:pop             
		obj1 = ((Object) (obj4));
	//   65  102:aload           5
	//   66  104:astore_2        
...
_L6:
	...
	//*  78  121:ifnull          128
			Utility.closeQuietly(((java.io.Closeable) (obj1)));
	//   79  124:aload_2         
	//   80  125:invokestatic    #463 <Method void Utility.closeQuietly(java.io.Closeable)>
		throw s;
	//   81  128:aload_0         
	//   82  129:athrow          
	}
	...
	//    0    0:new             #475 <Class JSONObject>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #476 <Method void JSONObject(String)>
	//    4    8:astore_1        
		if(jsonobject.optInt("com.facebook.share.internal.LikeActionController.version", -1) != 3)
	//*   5    9:aload_1         
	//*   6   10:ldc1            #114 <String "com.facebook.share.internal.LikeActionController.version">
	//*   7   12:iconst_m1       
	//*   8   13:invokevirtual   #480 <Method int JSONObject.optInt(String, int)>
	//*   9   16:iconst_3        
	//*  10   17:icmpeq          22
			return null;
	//   11   20:aconst_null     
	...
	//   14   25:dup             
	//   15   26:aload_1         
	//   16   27:ldc1            #123 <String "object_id">
	//   17   29:invokevirtual   #483 <Method String JSONObject.getString(String)>
	//   18   32:aload_1         
	//   19   33:ldc1            #111 <String "object_type">
	//   20   35:getstatic       #488 <Field com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.UNKNOWN>
	//   21   38:invokevirtual   #491 <Method int com.facebook.share.widget.LikeView$ObjectType.getValue()>
	//   22   41:invokevirtual   #480 <Method int JSONObject.optInt(String, int)>
	//   23   44:invokestatic    #495 <Method com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.fromInt(int)>
	//   24   47:invokespecial   #413 <Method void LikeActionController(String, com.facebook.share.widget.LikeView$ObjectType)>
	//   25   50:astore_0        
			s.likeCountStringWithLike = jsonobject.optString("like_count_string_with_like", ((String) (null)));
	//   26   51:aload_0         
	//   27   52:aload_1         
	//   28   53:ldc1            #120 <String "like_count_string_with_like">
	//   29   55:aconst_null     
	//   30   56:invokevirtual   #499 <Method String JSONObject.optString(String, String)>
	//   31   59:putfield        #331 <Field String likeCountStringWithLike>
			s.likeCountStringWithoutLike = jsonobject.optString("like_count_string_without_like", ((String) (null)));
	//   32   62:aload_0         
	//   33   63:aload_1         
	//   34   64:ldc1            #117 <String "like_count_string_without_like">
	//   35   66:aconst_null     
	//   36   67:invokevirtual   #499 <Method String JSONObject.optString(String, String)>
	//   37   70:putfield        #334 <Field String likeCountStringWithoutLike>
			s.socialSentenceWithLike = jsonobject.optString("social_sentence_with_like", ((String) (null)));
	//   38   73:aload_0         
	//   39   74:aload_1         
	//   40   75:ldc1            #129 <String "social_sentence_with_like">
	//   41   77:aconst_null     
	//   42   78:invokevirtual   #499 <Method String JSONObject.optString(String, String)>
	//   43   81:putfield        #337 <Field String socialSentenceWithLike>
			s.socialSentenceWithoutLike = jsonobject.optString("social_sentence_without_like", ((String) (null)));
	//   44   84:aload_0         
	//   45   85:aload_1         
	//   46   86:ldc1            #126 <String "social_sentence_without_like">
	//   47   88:aconst_null     
	//   48   89:invokevirtual   #499 <Method String JSONObject.optString(String, String)>
	//   49   92:putfield        #232 <Field String socialSentenceWithoutLike>
			s.isObjectLiked = jsonobject.optBoolean("is_object_liked");
	//   50   95:aload_0         
	//   51   96:aload_1         
	//   52   97:ldc1            #105 <String "is_object_liked">
	//   53   99:invokevirtual   #502 <Method boolean JSONObject.optBoolean(String)>
	//   54  102:putfield        #302 <Field boolean isObjectLiked>
			s.unlikeToken = jsonobject.optString("unlike_token", ((String) (null)));
	//   55  105:aload_0         
	//   56  106:aload_1         
	//   57  107:ldc1            #132 <String "unlike_token">
	//   58  109:aconst_null     
	//   59  110:invokevirtual   #499 <Method String JSONObject.optString(String, String)>
	//   60  113:putfield        #235 <Field String unlikeToken>
			jsonobject = jsonobject.optJSONObject("facebook_dialog_analytics_bundle");
	//   61  116:aload_1         
	//   62  117:ldc1            #108 <String "facebook_dialog_analytics_bundle">
	//   63  119:invokevirtual   #506 <Method JSONObject JSONObject.optJSONObject(String)>
	//   64  122:astore_1        
		}
	//*  65  123:aload_1         
	//*  66  124:ifnull          135
	//*  67  127:aload_0         
	//*  68  128:aload_1         
	//*  69  129:invokestatic    #512 <Method Bundle BundleJSONConverter.convertToBundle(JSONObject)>
	//*  70  132:putfield        #397 <Field Bundle facebookDialogAnalyticsBundle>
	//*  71  135:aload_0         
	//*  72  136:areturn         
	...
	//   74  138:getstatic       #228 <Field String TAG>
	//   75  141:ldc2            #514 <String "Unable to deserialize controller from JSON">
	//   76  144:aload_0         
	//   77  145:invokestatic    #471 <Method int Log.e(String, String, Throwable)>
	//   78  148:pop             
			return null;
	//   79  149:aconst_null     
	//   80  150:areturn         
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #262 <Field String verifiedObjectId>
	//*   2    4:invokestatic    #456 <Method boolean Utility.isNullOrEmpty(String)>
	//*   3    7:ifne            21
		{
	...
	//    6   14:aload_1         
	//    7   15:invokeinterface #519 <Method void LikeActionController$RequestCompletionCallback.onComplete()>
			return;
	//    8   20:return          
		} else
		{
	...
	//   11   25:aload_0         
	//   12   26:aload_0         
	//   13   27:getfield        #216 <Field String objectId>
	//   14   30:aload_0         
	//   15   31:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   16   34:invokespecial   #522 <Method void LikeActionController$GetOGObjectIdRequestWrapper(LikeActionController, String, com.facebook.share.widget.LikeView$ObjectType)>
	//   17   37:astore_2        
	...
	//   20   42:aload_0         
	//   21   43:aload_0         
	//   22   44:getfield        #216 <Field String objectId>
	//   23   47:aload_0         
	//   24   48:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   25   51:invokespecial   #523 <Method void LikeActionController$GetPageIdRequestWrapper(LikeActionController, String, com.facebook.share.widget.LikeView$ObjectType)>
	//   26   54:astore_3        
			GraphRequestBatch graphrequestbatch = new GraphRequestBatch();
	//   27   55:new             #525 <Class GraphRequestBatch>
	//   28   58:dup             
	//   29   59:invokespecial   #526 <Method void GraphRequestBatch()>
	//   30   62:astore          4
			objectIdRequest.addToBatch(graphrequestbatch);
	//   31   64:aload_2         
	//   32   65:aload           4
	//   33   67:invokevirtual   #530 <Method void LikeActionController$GetOGObjectIdRequestWrapper.addToBatch(GraphRequestBatch)>
			pageIdRequest.addToBatch(graphrequestbatch);
	//   34   70:aload_3         
	//   35   71:aload           4
	//   36   73:invokevirtual   #531 <Method void LikeActionController$GetPageIdRequestWrapper.addToBatch(GraphRequestBatch)>
	...
	//   42   84:aload_3         
	//   43   85:aload_1         
	//   44   86:invokespecial   #534 <Method void LikeActionController$11(LikeActionController, LikeActionController$GetOGObjectIdRequestWrapper, LikeActionController$GetPageIdRequestWrapper, LikeActionController$RequestCompletionCallback)>
	//   45   89:invokevirtual   #538 <Method void GraphRequestBatch.addCallback(com.facebook.GraphRequestBatch$Callback)>
			graphrequestbatch.executeAsync();
	//   46   92:aload           4
	//   47   94:invokevirtual   #542 <Method com.facebook.GraphRequestAsyncTask GraphRequestBatch.executeAsync()>
	//   48   97:pop             
			return;
	//   49   98:return          
		}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #544 <Field AppEventsLogger appEventsLogger>
	//*   2    4:ifnonnull       17
			appEventsLogger = AppEventsLogger.newLogger(FacebookSdk.getApplicationContext());
	//    3    7:aload_0         
	//    4    8:invokestatic    #361 <Method Context FacebookSdk.getApplicationContext()>
	//    5   11:invokestatic    #550 <Method AppEventsLogger AppEventsLogger.newLogger(Context)>
	//    6   14:putfield        #544 <Field AppEventsLogger appEventsLogger>
		return appEventsLogger;
	//    7   17:aload_0         
	//    8   18:getfield        #544 <Field AppEventsLogger appEventsLogger>
	//    9   21:areturn         
	}
	...
	//*   2    4:invokestatic    #382 <Method boolean AccessToken.isCurrentAccessTokenActive()>
	//*   3    7:ifeq            18
			obj = ((Object) (((AccessToken) (obj)).getToken()));
	//    4   10:aload_1         
	//    5   11:invokevirtual   #553 <Method String AccessToken.getToken()>
	//    6   14:astore_1        
		else
	//*   7   15:goto            20
			obj = null;
	...
	//   14   26:aload_1         
	//   15   27:invokestatic    #556 <Method String Utility.md5hash(String)>
	//   16   30:astore_2        
	...
	//   17   31:getstatic       #562 <Field Locale Locale.ROOT>
	//   18   34:ldc2            #564 <String "%s|%s|com.fb.sdk.like|%d">
	//   19   37:iconst_3        
	...
	//   26   46:iconst_1        
	//   27   47:aload_2         
	//   28   48:ldc2            #566 <String "">
	//   29   51:invokestatic    #569 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   30   54:aastore         
	//   31   55:dup             
	//   32   56:iconst_2        
	//   33   57:getstatic       #316 <Field int objectSuffix>
	//   34   60:invokestatic    #575 <Method Integer Integer.valueOf(int)>
	//   35   63:aastore         
	//   36   64:invokestatic    #581 <Method String String.format(Locale, String, Object[])>
	//   37   67:areturn         
	}
	...
	{
		if(!isInitialized)
	//*   0    0:getstatic       #584 <Field boolean isInitialized>
	//*   1    3:ifne            9
			performFirstInitialize();
	//    2    6:invokestatic    #587 <Method void performFirstInitialize()>
		LikeActionController likeactioncontroller = getControllerFromInMemoryCache(s);
	//    3    9:aload_0         
	//    4   10:invokestatic    #404 <Method LikeActionController getControllerFromInMemoryCache(String)>
	//    5   13:astore_3        
		if(likeactioncontroller != null)
	//*   6   14:aload_3         
	//*   7   15:ifnull          25
	...
	//    9   19:aload_1         
	//   10   20:aload_2         
	//   11   21:invokestatic    #408 <Method void verifyControllerAndInvokeCallback(LikeActionController, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
			return;
	//   12   24:return          
		} else
		{
			diskIOWorkQueue.addActiveWorkItem(((Runnable) (new CreateLikeActionControllerWorkItem(s, objecttype, creationcallback))));
	//   13   25:getstatic       #211 <Field WorkQueue diskIOWorkQueue>
	//   14   28:new             #39  <Class LikeActionController$CreateLikeActionControllerWorkItem>
	//   15   31:dup             
	//   16   32:aload_0         
	//   17   33:aload_1         
	//   18   34:aload_2         
	//   19   35:invokespecial   #589 <Method void LikeActionController$CreateLikeActionControllerWorkItem(String, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
	//   20   38:invokevirtual   #593 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   21   41:pop             
			return;
	//   22   42:return          
		}
	...
	private static LikeActionController getControllerFromInMemoryCache(String s)
	{
		s = getCacheKeyForObjectId(s);
	//    0    0:aload_0         
	//    1    1:invokestatic    #440 <Method String getCacheKeyForObjectId(String)>
	//    2    4:astore_0        
		LikeActionController likeactioncontroller = (LikeActionController)cache.get(((Object) (s)));
	//    3    5:getstatic       #202 <Field ConcurrentHashMap cache>
	//    4    8:aload_0         
	//    5    9:invokevirtual   #597 <Method Object ConcurrentHashMap.get(Object)>
	...
	//   10   20:getstatic       #209 <Field WorkQueue mruCacheWorkQueue>
	//   11   23:new             #63  <Class LikeActionController$MRUCacheWorkItem>
	//   12   26:dup             
	//   13   27:aload_0         
	//   14   28:iconst_0        
	//   15   29:invokespecial   #600 <Method void LikeActionController$MRUCacheWorkItem(String, boolean)>
	//   16   32:invokevirtual   #593 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   17   35:pop             
	...
	//    3    5:aconst_null     
	//    4    6:aload_1         
	//    5    7:invokespecial   #605 <Method void LikeActionController$6(LikeActionController, FacebookCallback, Bundle)>
	//    6   10:areturn         
	}
	...
	//*   0    0:getstatic       #609 <Field String objectIdForPendingController>
	//*   1    3:invokestatic    #456 <Method boolean Utility.isNullOrEmpty(String)>
	//*   2    6:ifeq            29
	...
	//    3    9:invokestatic    #361 <Method Context FacebookSdk.getApplicationContext()>
	//    4   12:ldc1            #135 <String "com.facebook.LikeActionController.CONTROLLER_STORE_KEY">
	//    5   14:iconst_0        
	//    6   15:invokevirtual   #615 <Method SharedPreferences Context.getSharedPreferences(String, int)>
	//    7   18:ldc1            #141 <String "PENDING_CONTROLLER_KEY">
	//    8   20:aconst_null     
	//    9   21:invokeinterface #619 <Method String SharedPreferences.getString(String, String)>
	//   10   26:putstatic       #609 <Field String objectIdForPendingController>
		if(Utility.isNullOrEmpty(objectIdForPendingController))
	//*  11   29:getstatic       #609 <Field String objectIdForPendingController>
	//*  12   32:invokestatic    #456 <Method boolean Utility.isNullOrEmpty(String)>
	//*  13   35:ifeq            40
		{
			return false;
	//   14   38:iconst_0        
	...
	//   16   40:getstatic       #609 <Field String objectIdForPendingController>
	//   17   43:getstatic       #488 <Field com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.UNKNOWN>
	//   18   46:new             #6   <Class LikeActionController$1>
	//   19   49:dup             
	//   20   50:iload_0         
	//   21   51:iload_1         
	//   22   52:aload_2         
	//   23   53:invokespecial   #621 <Method void LikeActionController$1(int, int, Intent)>
	//   24   56:invokestatic    #623 <Method void getControllerForObjectId(String, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
			return true;
	//   25   59:iconst_1        
	//   26   60:ireturn         
		}
	...
	//    3    5:getstatic       #422 <Field Handler handler>
	//    4    8:new             #18  <Class LikeActionController$4>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:aload_2         
	//    9   15:invokespecial   #625 <Method void LikeActionController$4(LikeActionController$CreationCallback, LikeActionController, FacebookException)>
	//   10   18:invokevirtual   #430 <Method boolean Handler.post(Runnable)>
	//   11   21:pop             
			return;
	//   12   22:return          
		}
	...
	//    0    0:new             #344 <Class Bundle>
	//    1    3:dup             
	//    2    4:aload_2         
	//    3    5:invokespecial   #627 <Method void Bundle(Bundle)>
	//    4    8:astore_2        
		bundle.putString("object_id", objectId);
	//    5    9:aload_2         
	//    6   10:ldc1            #123 <String "object_id">
	//    7   12:aload_0         
	//    8   13:getfield        #216 <Field String objectId>
	//    9   16:invokevirtual   #351 <Method void Bundle.putString(String, String)>
		bundle.putString("object_type", objectType.toString());
	//   10   19:aload_2         
	//   11   20:ldc1            #111 <String "object_type">
	//   12   22:aload_0         
	//   13   23:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   14   26:invokevirtual   #630 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   15   29:invokevirtual   #351 <Method void Bundle.putString(String, String)>
		bundle.putString("current_action", s);
	//   16   32:aload_2         
	//   17   33:ldc2            #632 <String "current_action">
	//   18   36:aload_1         
	//   19   37:invokevirtual   #351 <Method void Bundle.putString(String, String)>
		getAppEventsLogger().logSdkEvent("fb_like_control_error", ((Double) (null)), bundle);
	//   20   40:aload_0         
	//   21   41:invokespecial   #243 <Method AppEventsLogger getAppEventsLogger()>
	//   22   44:ldc2            #634 <String "fb_like_control_error">
	//   23   47:aconst_null     
	//   24   48:aload_2         
	//   25   49:invokevirtual   #638 <Method void AppEventsLogger.logSdkEvent(String, Double, Bundle)>
	//   26   52:return          
	}
	...
	//    0    0:new             #344 <Class Bundle>
	//    1    3:dup             
	//    2    4:invokespecial   #345 <Method void Bundle()>
	//    3    7:astore_3        
	...
	//    6   12:aload_2         
	//    7   13:invokevirtual   #644 <Method JSONObject FacebookRequestError.getRequestResult()>
	//    8   16:astore_2        
			if(facebookrequesterror != null)
	//*   9   17:aload_2         
	//*  10   18:ifnull          32
	...
	//   11   21:aload_3         
	//   12   22:ldc2            #646 <String "error">
	//   13   25:aload_2         
	//   14   26:invokevirtual   #647 <Method String JSONObject.toString()>
	//   15   29:invokevirtual   #351 <Method void Bundle.putString(String, String)>
		}
	...
	//   17   33:aload_1         
	//   18   34:aload_3         
	//   19   35:invokespecial   #255 <Method void logAppEventForError(String, Bundle)>
	//   20   38:return          
	}
	...
	//    3    3:aload_0         
	//    4    4:aload_0         
	//    5    5:getfield        #397 <Field Bundle facebookDialogAnalyticsBundle>
	//    6    8:invokespecial   #649 <Method ResultProcessor getResultProcessor(Bundle)>
	//    7   11:invokestatic    #655 <Method boolean ShareInternalUtility.handleActivityResult(int, int, Intent, ResultProcessor)>
	//    8   14:pop             
		clearState();
	//    9   15:aload_0         
	//   10   16:invokespecial   #657 <Method void clearState()>
	//   11   19:return          
	}
	...
	//    2    3:getstatic       #584 <Field boolean isInitialized>
	//    3    6:istore_0        
		if(!flag)
	...
	//    9   15:new             #426 <Class Handler>
	//   10   18:dup             
	//   11   19:invokestatic    #663 <Method Looper Looper.getMainLooper()>
	//   12   22:invokespecial   #666 <Method void Handler(Looper)>
	//   13   25:putstatic       #422 <Field Handler handler>
	...
	//   14   28:invokestatic    #361 <Method Context FacebookSdk.getApplicationContext()>
	//   15   31:ldc1            #135 <String "com.facebook.LikeActionController.CONTROLLER_STORE_KEY">
	//   16   33:iconst_0        
	//   17   34:invokevirtual   #615 <Method SharedPreferences Context.getSharedPreferences(String, int)>
	//   18   37:ldc1            #138 <String "OBJECT_SUFFIX">
	//   19   39:iconst_1        
	//   20   40:invokeinterface #669 <Method int SharedPreferences.getInt(String, int)>
	//   21   45:putstatic       #316 <Field int objectSuffix>
		controllerDiskCache = new FileLruCache(TAG, new com.facebook.internal.FileLruCache.Limits());
	//   22   48:new             #442 <Class FileLruCache>
	//   23   51:dup             
	//   24   52:getstatic       #228 <Field String TAG>
	//   25   55:new             #671 <Class com.facebook.internal.FileLruCache$Limits>
	//   26   58:dup             
	//   27   59:invokespecial   #672 <Method void com.facebook.internal.FileLruCache$Limits()>
	//   28   62:invokespecial   #675 <Method void FileLruCache(String, com.facebook.internal.FileLruCache$Limits)>
	//   29   65:putstatic       #324 <Field FileLruCache controllerDiskCache>
		registerAccessTokenTracker();
	//   30   68:invokestatic    #678 <Method void registerAccessTokenTracker()>
	...
	//   31   71:getstatic       #684 <Field com.facebook.internal.CallbackManagerImpl$RequestCodeOffset com.facebook.internal.CallbackManagerImpl$RequestCodeOffset.Like>
	//   32   74:invokevirtual   #687 <Method int com.facebook.internal.CallbackManagerImpl$RequestCodeOffset.toRequestCode()>
	//   33   77:new             #16  <Class LikeActionController$3>
	//   34   80:dup             
	//   35   81:invokespecial   #688 <Method void LikeActionController$3()>
	//   36   84:invokestatic    #694 <Method void CallbackManagerImpl.registerStaticCallback(int, com.facebook.internal.CallbackManagerImpl$Callback)>
		isInitialized = true;
	//   37   87:iconst_1        
	//   38   88:putstatic       #584 <Field boolean isInitialized>
		com/facebook/share/internal/LikeActionController;
	...
	//*   0    0:invokestatic    #701 <Method boolean LikeDialog.canShowNativeDialog()>
	//*   1    3:ifeq            14
			s = "fb_like_control_did_present_dialog";
	//    2    6:ldc2            #703 <String "fb_like_control_did_present_dialog">
	//    3    9:astore          4
		else
	//*   4   11:goto            54
		if(LikeDialog.canShowWebFallback())
	//*   5   14:invokestatic    #706 <Method boolean LikeDialog.canShowWebFallback()>
	//*   6   17:ifeq            28
		{
			s = "fb_like_control_did_present_fallback_dialog";
	//    7   20:ldc2            #708 <String "fb_like_control_did_present_fallback_dialog">
	//    8   23:astore          4
		} else
	//*   9   25:goto            54
		{
	...
	//   10   28:aload_0         
	//   11   29:ldc2            #710 <String "present_dialog">
	//   12   32:aload_3         
	//   13   33:invokespecial   #255 <Method void logAppEventForError(String, Bundle)>
			Utility.logd(TAG, "Cannot show the Like Dialog on this device.");
	//   14   36:getstatic       #228 <Field String TAG>
	//   15   39:ldc2            #712 <String "Cannot show the Like Dialog on this device.">
	//   16   42:invokestatic    #715 <Method void Utility.logd(String, String)>
			broadcastAction(((LikeActionController) (null)), "com.facebook.sdk.LikeActionController.UPDATED");
	//   17   45:aconst_null     
	//   18   46:ldc1            #90  <String "com.facebook.sdk.LikeActionController.UPDATED">
	//   19   48:invokestatic    #328 <Method void broadcastAction(LikeActionController, String)>
			s = null;
	//   20   51:aconst_null     
	//   21   52:astore          4
		}
	...
	//   24   59:aload_0         
	//   25   60:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   26   63:astore          4
			if(obj != null)
	//*  27   65:aload           4
	//*  28   67:ifnull          80
	...
	//   29   70:aload           4
	//   30   72:invokevirtual   #630 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   31   75:astore          4
			else
	//*  32   77:goto            88
				obj = ((Object) (com.facebook.share.widget.LikeView.ObjectType.UNKNOWN.toString()));
	//   33   80:getstatic       #488 <Field com.facebook.share.widget.LikeView$ObjectType com.facebook.share.widget.LikeView$ObjectType.UNKNOWN>
	//   34   83:invokevirtual   #630 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   35   86:astore          4
			obj = ((Object) ((new LikeContent.Builder()).setObjectId(objectId).setObjectType(((String) (obj))).build()));
	//   36   88:new             #717 <Class LikeContent$Builder>
	//   37   91:dup             
	//   38   92:invokespecial   #718 <Method void LikeContent$Builder()>
	//   39   95:aload_0         
	//   40   96:getfield        #216 <Field String objectId>
	//   41   99:invokevirtual   #722 <Method LikeContent$Builder LikeContent$Builder.setObjectId(String)>
	//   42  102:aload           4
	//   43  104:invokevirtual   #725 <Method LikeContent$Builder LikeContent$Builder.setObjectType(String)>
	//   44  107:invokevirtual   #729 <Method LikeContent LikeContent$Builder.build()>
	//   45  110:astore          4
			if(fragmentwrapper != null)
	//*  46  112:aload_2         
	//*  47  113:ifnull          132
				(new LikeDialog(fragmentwrapper)).show(((LikeContent) (obj)));
	//   48  116:new             #698 <Class LikeDialog>
	//   49  119:dup             
	//   50  120:aload_2         
	//   51  121:invokespecial   #732 <Method void LikeDialog(FragmentWrapper)>
	//   52  124:aload           4
	//   53  126:invokevirtual   #736 <Method void LikeDialog.show(LikeContent)>
			else
	//*  54  129:goto            145
				(new LikeDialog(activity)).show(((LikeContent) (obj)));
	//   55  132:new             #698 <Class LikeDialog>
	//   56  135:dup             
	//   57  136:aload_1         
	//   58  137:invokespecial   #739 <Method void LikeDialog(Activity)>
	//   59  140:aload           4
	//   60  142:invokevirtual   #736 <Method void LikeDialog.show(LikeContent)>
			saveState(bundle);
	//   61  145:aload_0         
	//   62  146:aload_3         
	//   63  147:invokespecial   #742 <Method void saveState(Bundle)>
			getAppEventsLogger().logSdkEvent("fb_like_control_did_present_dialog", ((Double) (null)), bundle);
	//   64  150:aload_0         
	//   65  151:invokespecial   #243 <Method AppEventsLogger getAppEventsLogger()>
	//   66  154:ldc2            #703 <String "fb_like_control_did_present_dialog">
	//   67  157:aconst_null     
	//   68  158:aload_3         
	//   69  159:invokevirtual   #638 <Method void AppEventsLogger.logSdkEvent(String, Double, Bundle)>
		}
	//   70  162:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #302 <Field boolean isObjectLiked>
	//    2    4:istore_2        
		if(flag != isObjectLikedOnServer && !publishLikeOrUnlikeAsync(flag, bundle))
	//*   3    5:iload_2         
	//*   4    6:aload_0         
	//*   5    7:getfield        #283 <Field boolean isObjectLikedOnServer>
	//*   6   10:icmpeq          32
	//*   7   13:aload_0         
	//*   8   14:iload_2         
	//*   9   15:aload_1         
	//*  10   16:invokespecial   #746 <Method boolean publishLikeOrUnlikeAsync(boolean, Bundle)>
	//*  11   19:ifne            32
			publishDidError(isObjectLiked ^ true);
	//   12   22:aload_0         
	//   13   23:aload_0         
	//   14   24:getfield        #302 <Field boolean isObjectLiked>
	//   15   27:iconst_1        
	//   16   28:ixor            
	//   17   29:invokespecial   #275 <Method void publishDidError(boolean)>
	//   18   32:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #749 <Method void updateLikeState(boolean)>
		Bundle bundle = new Bundle();
	//    3    5:new             #344 <Class Bundle>
	//    4    8:dup             
	//    5    9:invokespecial   #345 <Method void Bundle()>
	//    6   12:astore_2        
		bundle.putString("com.facebook.platform.status.ERROR_DESCRIPTION", "Unable to publish the like/unlike action");
	//    7   13:aload_2         
	//    8   14:ldc2            #751 <String "com.facebook.platform.status.ERROR_DESCRIPTION">
	//    9   17:ldc1            #102 <String "Unable to publish the like/unlike action">
	//   10   19:invokevirtual   #351 <Method void Bundle.putString(String, String)>
		broadcastAction(this, "com.facebook.sdk.LikeActionController.DID_ERROR", bundle);
	//   11   22:aload_0         
	//   12   23:ldc1            #84  <String "com.facebook.sdk.LikeActionController.DID_ERROR">
	//   13   25:aload_2         
	//   14   26:invokestatic    #259 <Method void broadcastAction(LikeActionController, String, Bundle)>
	//   15   29:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iconst_1        
	//    2    2:putfield        #269 <Field boolean isPendingLikeOrUnlike>
	...
	//    6   10:aload_0         
	//    7   11:aload_1         
	//    8   12:invokespecial   #754 <Method void LikeActionController$7(LikeActionController, Bundle)>
	//    9   15:invokespecial   #756 <Method void fetchVerifiedObjectId(LikeActionController$RequestCompletionCallback)>
	//   10   18:return          
	}
	...
	private boolean publishLikeOrUnlikeAsync(boolean flag, Bundle bundle)
	{
		if(canUseOGPublish())
	//*   0    0:aload_0         
	//*   1    1:invokespecial   #758 <Method boolean canUseOGPublish()>
	//*   2    4:ifeq            35
		{
			if(flag)
	//*   3    7:iload_1         
	...
	//    5   11:aload_0         
	//    6   12:aload_2         
	//    7   13:invokespecial   #760 <Method void publishLikeAsync(Bundle)>
				return true;
	//    8   16:iconst_1        
	//    9   17:ireturn         
			}
	...
	//*  10   18:aload_0         
	//*  11   19:getfield        #235 <Field String unlikeToken>
	//*  12   22:invokestatic    #456 <Method boolean Utility.isNullOrEmpty(String)>
	//*  13   25:ifne            35
			{
				publishUnlikeAsync(bundle);
	//   14   28:aload_0         
	//   15   29:aload_2         
	//   16   30:invokespecial   #763 <Method void publishUnlikeAsync(Bundle)>
				return true;
	//   17   33:iconst_1        
	//   18   34:ireturn         
			}
	...
	//    2    2:putfield        #269 <Field boolean isPendingLikeOrUnlike>
		GraphRequestBatch graphrequestbatch = new GraphRequestBatch();
	//    3    5:new             #525 <Class GraphRequestBatch>
	//    4    8:dup             
	//    5    9:invokespecial   #526 <Method void GraphRequestBatch()>
	//    6   12:astore_2        
	...
	//   10   18:aload_0         
	//   11   19:getfield        #235 <Field String unlikeToken>
	//   12   22:invokespecial   #765 <Method void LikeActionController$PublishUnlikeRequestWrapper(LikeActionController, String)>
	//   13   25:astore_3        
		unlikeRequest.addToBatch(graphrequestbatch);
	//   14   26:aload_3         
	//   15   27:aload_2         
	//   16   28:invokevirtual   #766 <Method void LikeActionController$PublishUnlikeRequestWrapper.addToBatch(GraphRequestBatch)>
		graphrequestbatch.addCallback(new com.facebook.GraphRequestBatch.Callback() {
	...
	//   21   37:aload_3         
	//   22   38:aload_1         
	//   23   39:invokespecial   #769 <Method void LikeActionController$8(LikeActionController, LikeActionController$PublishUnlikeRequestWrapper, Bundle)>
	//   24   42:invokevirtual   #538 <Method void GraphRequestBatch.addCallback(com.facebook.GraphRequestBatch$Callback)>
		graphrequestbatch.executeAsync();
	//   25   45:aload_2         
	//   26   46:invokevirtual   #542 <Method com.facebook.GraphRequestAsyncTask GraphRequestBatch.executeAsync()>
	//   27   49:pop             
	//   28   50:return          
	}
	...
	//    3    5:getstatic       #209 <Field WorkQueue mruCacheWorkQueue>
	//    4    8:new             #63  <Class LikeActionController$MRUCacheWorkItem>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:iconst_1        
	//    8   14:invokespecial   #600 <Method void LikeActionController$MRUCacheWorkItem(String, boolean)>
	//    9   17:invokevirtual   #593 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   10   20:pop             
		cache.put(((Object) (s)), ((Object) (likeactioncontroller)));
	//   11   21:getstatic       #202 <Field ConcurrentHashMap cache>
	//   12   24:aload_0         
	//   13   25:aload_1         
	//   14   26:invokevirtual   #773 <Method Object ConcurrentHashMap.put(Object, Object)>
	//   15   29:pop             
	//   16   30:return          
	}
	...
	{
		if(!AccessToken.isCurrentAccessTokenActive())
	//*   0    0:invokestatic    #382 <Method boolean AccessToken.isCurrentAccessTokenActive()>
	//*   1    3:ifne            11
		{
			refreshStatusViaService();
	//    2    6:aload_0         
	//    3    7:invokespecial   #776 <Method void refreshStatusViaService()>
			return;
	//    4   10:return          
		} else
		{
	...
	//    7   15:dup             
	//    8   16:aload_0         
	//    9   17:invokespecial   #777 <Method void LikeActionController$9(LikeActionController)>
	//   10   20:invokespecial   #756 <Method void fetchVerifiedObjectId(LikeActionController$RequestCompletionCallback)>
			return;
	//   11   23:return          
		}
	}
	...
	//    0    0:new             #779 <Class LikeStatusClient>
	//    1    3:dup             
	//    2    4:invokestatic    #361 <Method Context FacebookSdk.getApplicationContext()>
	//    3    7:invokestatic    #782 <Method String FacebookSdk.getApplicationId()>
	//    4   10:aload_0         
	//    5   11:getfield        #216 <Field String objectId>
	//    6   14:invokespecial   #785 <Method void LikeStatusClient(Context, String, String)>
	//    7   17:astore_1        
		if(!likestatusclient.start())
	//*   8   18:aload_1         
	//*   9   19:invokevirtual   #788 <Method boolean LikeStatusClient.start()>
	//*  10   22:ifne            26
		{
			return;
	//   11   25:return          
	...
	//   14   30:dup             
	//   15   31:aload_0         
	//   16   32:invokespecial   #789 <Method void LikeActionController$10(LikeActionController)>
	//   17   35:invokevirtual   #793 <Method void LikeStatusClient.setCompletedListener(com.facebook.internal.PlatformServiceClient$CompletedListener)>
			return;
	//   18   38:return          
		}
	}
	...
	//    1    3:dup             
	//    2    4:invokespecial   #794 <Method void LikeActionController$5()>
	//    3    7:putstatic       #796 <Field AccessTokenTracker accessTokenTracker>
	//    4   10:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #216 <Field String objectId>
	//    2    4:invokestatic    #400 <Method void storeObjectIdForPendingController(String)>
		facebookDialogAnalyticsBundle = bundle;
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:putfield        #397 <Field Bundle facebookDialogAnalyticsBundle>
		serializeToDiskAsync(this);
	//    6   12:aload_0         
	//    7   13:invokestatic    #416 <Method void serializeToDiskAsync(LikeActionController)>
	//    8   16:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #799 <Method String serializeToJson(LikeActionController)>
	//    2    4:astore_1        
		likeactioncontroller = ((LikeActionController) (getCacheKeyForObjectId(likeactioncontroller.objectId)));
	//    3    5:aload_0         
	//    4    6:getfield        #216 <Field String objectId>
	//    5    9:invokestatic    #440 <Method String getCacheKeyForObjectId(String)>
	//    6   12:astore_0        
		if(!Utility.isNullOrEmpty(s) && !Utility.isNullOrEmpty(((String) (likeactioncontroller))))
	//*   7   13:aload_1         
	//*   8   14:invokestatic    #456 <Method boolean Utility.isNullOrEmpty(String)>
	//*   9   17:ifne            43
	//*  10   20:aload_0         
	//*  11   21:invokestatic    #456 <Method boolean Utility.isNullOrEmpty(String)>
	//*  12   24:ifne            43
			diskIOWorkQueue.addActiveWorkItem(((Runnable) (new SerializeToDiskWorkItem(((String) (likeactioncontroller)), s))));
	//   13   27:getstatic       #211 <Field WorkQueue diskIOWorkQueue>
	//   14   30:new             #78  <Class LikeActionController$SerializeToDiskWorkItem>
	//   15   33:dup             
	//   16   34:aload_0         
	//   17   35:aload_1         
	//   18   36:invokespecial   #801 <Method void LikeActionController$SerializeToDiskWorkItem(String, String)>
	//   19   39:invokevirtual   #593 <Method com.facebook.internal.WorkQueue$WorkItem WorkQueue.addActiveWorkItem(Runnable)>
	//   20   42:pop             
	//   21   43:return          
	}
	...
	//    4    4:getstatic       #324 <Field FileLruCache controllerDiskCache>
	//    5    7:aload_0         
	//    6    8:invokevirtual   #805 <Method OutputStream FileLruCache.openPutStream(String)>
	//    7   11:astore_0        
		s3 = s;
	//    8   12:aload_0         
	//    9   13:astore_3        
	...
	//   12   16:aload_0         
	//   13   17:aload_1         
	//   14   18:invokevirtual   #809 <Method byte[] String.getBytes()>
	//   15   21:invokevirtual   #815 <Method void OutputStream.write(byte[])>
...
_L1:
	...
	//   18   28:aload_0         
	//   19   29:invokestatic    #463 <Method void Utility.closeQuietly(java.io.Closeable)>
		return;
	//   20   32:return          
		s;
	//   21   33:astore_0        
	...
	//   26   40:getstatic       #228 <Field String TAG>
	//   27   43:ldc2            #817 <String "Unable to serialize controller to disk">
	//   28   46:aload_0         
	//   29   47:invokestatic    #471 <Method int Log.e(String, String, Throwable)>
	//   30   50:pop             
		if(s2 == null)
			break; /* Loop/switch isn't completed */
	//   31   51:aload_2         
...
_L2:
	...
	//   39   65:aload_3         
	//   40   66:invokestatic    #463 <Method void Utility.closeQuietly(java.io.Closeable)>
		throw s;
	//   41   69:aload_0         
	//   42   70:athrow          
	}
	...
	//    0    0:new             #475 <Class JSONObject>
	//    1    3:dup             
	//    2    4:invokespecial   #818 <Method void JSONObject()>
	//    3    7:astore_1        
		jsonobject.put("com.facebook.share.internal.LikeActionController.version", 3);
	//    4    8:aload_1         
	//    5    9:ldc1            #114 <String "com.facebook.share.internal.LikeActionController.version">
	//    6   11:iconst_3        
	//    7   12:invokevirtual   #821 <Method JSONObject JSONObject.put(String, int)>
	//    8   15:pop             
		jsonobject.put("object_id", ((Object) (likeactioncontroller.objectId)));
	//    9   16:aload_1         
	//   10   17:ldc1            #123 <String "object_id">
	//   11   19:aload_0         
	//   12   20:getfield        #216 <Field String objectId>
	//   13   23:invokevirtual   #824 <Method JSONObject JSONObject.put(String, Object)>
	//   14   26:pop             
		jsonobject.put("object_type", likeactioncontroller.objectType.getValue());
	//   15   27:aload_1         
	//   16   28:ldc1            #111 <String "object_type">
	//   17   30:aload_0         
	//   18   31:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   19   34:invokevirtual   #491 <Method int com.facebook.share.widget.LikeView$ObjectType.getValue()>
	//   20   37:invokevirtual   #821 <Method JSONObject JSONObject.put(String, int)>
	//   21   40:pop             
		jsonobject.put("like_count_string_with_like", ((Object) (likeactioncontroller.likeCountStringWithLike)));
	//   22   41:aload_1         
	//   23   42:ldc1            #120 <String "like_count_string_with_like">
	//   24   44:aload_0         
	//   25   45:getfield        #331 <Field String likeCountStringWithLike>
	//   26   48:invokevirtual   #824 <Method JSONObject JSONObject.put(String, Object)>
	//   27   51:pop             
		jsonobject.put("like_count_string_without_like", ((Object) (likeactioncontroller.likeCountStringWithoutLike)));
	//   28   52:aload_1         
	//   29   53:ldc1            #117 <String "like_count_string_without_like">
	//   30   55:aload_0         
	//   31   56:getfield        #334 <Field String likeCountStringWithoutLike>
	//   32   59:invokevirtual   #824 <Method JSONObject JSONObject.put(String, Object)>
	//   33   62:pop             
		jsonobject.put("social_sentence_with_like", ((Object) (likeactioncontroller.socialSentenceWithLike)));
	//   34   63:aload_1         
	//   35   64:ldc1            #129 <String "social_sentence_with_like">
	//   36   66:aload_0         
	//   37   67:getfield        #337 <Field String socialSentenceWithLike>
	//   38   70:invokevirtual   #824 <Method JSONObject JSONObject.put(String, Object)>
	//   39   73:pop             
		jsonobject.put("social_sentence_without_like", ((Object) (likeactioncontroller.socialSentenceWithoutLike)));
	//   40   74:aload_1         
	//   41   75:ldc1            #126 <String "social_sentence_without_like">
	//   42   77:aload_0         
	//   43   78:getfield        #232 <Field String socialSentenceWithoutLike>
	//   44   81:invokevirtual   #824 <Method JSONObject JSONObject.put(String, Object)>
	//   45   84:pop             
		jsonobject.put("is_object_liked", likeactioncontroller.isObjectLiked);
	//   46   85:aload_1         
	//   47   86:ldc1            #105 <String "is_object_liked">
	//   48   88:aload_0         
	//   49   89:getfield        #302 <Field boolean isObjectLiked>
	//   50   92:invokevirtual   #827 <Method JSONObject JSONObject.put(String, boolean)>
	//   51   95:pop             
		jsonobject.put("unlike_token", ((Object) (likeactioncontroller.unlikeToken)));
	//   52   96:aload_1         
	//   53   97:ldc1            #132 <String "unlike_token">
	//   54   99:aload_0         
	//   55  100:getfield        #235 <Field String unlikeToken>
	//   56  103:invokevirtual   #824 <Method JSONObject JSONObject.put(String, Object)>
	//   57  106:pop             
		if(likeactioncontroller.facebookDialogAnalyticsBundle == null)
			break MISSING_BLOCK_LABEL_134;
	//   58  107:aload_0         
	//   59  108:getfield        #397 <Field Bundle facebookDialogAnalyticsBundle>
	//   60  111:ifnull          134
	...
	//   61  114:aload_0         
	//   62  115:getfield        #397 <Field Bundle facebookDialogAnalyticsBundle>
	//   63  118:invokestatic    #831 <Method JSONObject BundleJSONConverter.convertToJSON(Bundle)>
	//   64  121:astore_0        
		if(likeactioncontroller != null)
	//*  65  122:aload_0         
	//*  66  123:ifnull          134
	...
	//   67  126:aload_1         
	//   68  127:ldc1            #108 <String "facebook_dialog_analytics_bundle">
	//   69  129:aload_0         
	//   70  130:invokevirtual   #824 <Method JSONObject JSONObject.put(String, Object)>
	//   71  133:pop             
			}
	//*  72  134:aload_1         
	//*  73  135:invokevirtual   #647 <Method String JSONObject.toString()>
	//*  74  138:areturn         
			// Misplaced declaration of an exception variable
	...
	//   76  140:getstatic       #228 <Field String TAG>
	//   77  143:ldc2            #833 <String "Unable to serialize controller to JSON">
	//   78  146:aload_0         
	//   79  147:invokestatic    #471 <Method int Log.e(String, String, Throwable)>
	//   80  150:pop             
				return null;
	//   81  151:aconst_null     
	//   82  152:areturn         
	...
	//    0    0:aload_0         
	//    1    1:putstatic       #609 <Field String objectIdForPendingController>
	...
	//    2    4:invokestatic    #361 <Method Context FacebookSdk.getApplicationContext()>
	//    3    7:ldc1            #135 <String "com.facebook.LikeActionController.CONTROLLER_STORE_KEY">
	//    4    9:iconst_0        
	//    5   10:invokevirtual   #615 <Method SharedPreferences Context.getSharedPreferences(String, int)>
	//    6   13:invokeinterface #837 <Method android.content.SharedPreferences$Editor SharedPreferences.edit()>
	//    7   18:ldc1            #141 <String "PENDING_CONTROLLER_KEY">
	//    8   20:getstatic       #609 <Field String objectIdForPendingController>
	//    9   23:invokeinterface #842 <Method android.content.SharedPreferences$Editor android.content.SharedPreferences$Editor.putString(String, String)>
	//   10   28:invokeinterface #845 <Method void android.content.SharedPreferences$Editor.apply()>
	//   11   33:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:aload_0         
	//    3    3:getfield        #331 <Field String likeCountStringWithLike>
	//    4    6:aload_0         
	//    5    7:getfield        #334 <Field String likeCountStringWithoutLike>
	//    6   10:aload_0         
	//    7   11:getfield        #337 <Field String socialSentenceWithLike>
	//    8   14:aload_0         
	//    9   15:getfield        #232 <Field String socialSentenceWithoutLike>
	//   10   18:aload_0         
	//   11   19:getfield        #235 <Field String unlikeToken>
	//   12   22:invokespecial   #249 <Method void updateState(boolean, String, String, String, String, String)>
	//   13   25:return          
	}
	...
	//    0    0:aload_2         
	//    1    1:aconst_null     
	//    2    2:invokestatic    #569 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//    3    5:astore_2        
		s1 = Utility.coerceValueIfNullOrEmpty(s1, ((String) (null)));
	//    4    6:aload_3         
	//    5    7:aconst_null     
	//    6    8:invokestatic    #569 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//    7   11:astore_3        
		s2 = Utility.coerceValueIfNullOrEmpty(s2, ((String) (null)));
	//    8   12:aload           4
	//    9   14:aconst_null     
	//   10   15:invokestatic    #569 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   11   18:astore          4
		s3 = Utility.coerceValueIfNullOrEmpty(s3, ((String) (null)));
	//   12   20:aload           5
	//   13   22:aconst_null     
	//   14   23:invokestatic    #569 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   15   26:astore          5
		s4 = Utility.coerceValueIfNullOrEmpty(s4, ((String) (null)));
	//   16   28:aload           6
	//   17   30:aconst_null     
	//   18   31:invokestatic    #569 <Method String Utility.coerceValueIfNullOrEmpty(String, String)>
	//   19   34:astore          6
		boolean flag1;
	...
	//*  20   36:iload_1         
	//*  21   37:aload_0         
	//*  22   38:getfield        #302 <Field boolean isObjectLiked>
	//*  23   41:icmpne          111
	//*  24   44:aload_2         
	//*  25   45:aload_0         
	//*  26   46:getfield        #331 <Field String likeCountStringWithLike>
	//*  27   49:invokestatic    #849 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  28   52:ifeq            111
	//*  29   55:aload_3         
	//*  30   56:aload_0         
	//*  31   57:getfield        #334 <Field String likeCountStringWithoutLike>
	//*  32   60:invokestatic    #849 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  33   63:ifeq            111
	//*  34   66:aload           4
	//*  35   68:aload_0         
	//*  36   69:getfield        #337 <Field String socialSentenceWithLike>
	//*  37   72:invokestatic    #849 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  38   75:ifeq            111
	//*  39   78:aload           5
	//*  40   80:aload_0         
	//*  41   81:getfield        #232 <Field String socialSentenceWithoutLike>
	//*  42   84:invokestatic    #849 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  43   87:ifeq            111
	//*  44   90:aload           6
	//*  45   92:aload_0         
	//*  46   93:getfield        #235 <Field String unlikeToken>
	//*  47   96:invokestatic    #849 <Method boolean Utility.areObjectsEqual(Object, Object)>
	//*  48   99:ifne            105
	//*  49  102:goto            111
			flag1 = false;
	//   50  105:iconst_0        
	...
	//   58  120:aload_0         
	//   59  121:iload_1         
	//   60  122:putfield        #302 <Field boolean isObjectLiked>
			likeCountStringWithLike = s;
	//   61  125:aload_0         
	//   62  126:aload_2         
	//   63  127:putfield        #331 <Field String likeCountStringWithLike>
			likeCountStringWithoutLike = s1;
	//   64  130:aload_0         
	//   65  131:aload_3         
	//   66  132:putfield        #334 <Field String likeCountStringWithoutLike>
			socialSentenceWithLike = s2;
	//   67  135:aload_0         
	//   68  136:aload           4
	//   69  138:putfield        #337 <Field String socialSentenceWithLike>
			socialSentenceWithoutLike = s3;
	//   70  141:aload_0         
	//   71  142:aload           5
	//   72  144:putfield        #232 <Field String socialSentenceWithoutLike>
			unlikeToken = s4;
	//   73  147:aload_0         
	//   74  148:aload           6
	//   75  150:putfield        #235 <Field String unlikeToken>
			serializeToDiskAsync(this);
	//   76  153:aload_0         
	//   77  154:invokestatic    #416 <Method void serializeToDiskAsync(LikeActionController)>
			broadcastAction(this, "com.facebook.sdk.LikeActionController.UPDATED");
	//   78  157:aload_0         
	//   79  158:ldc1            #90  <String "com.facebook.sdk.LikeActionController.UPDATED">
	//   80  160:invokestatic    #328 <Method void broadcastAction(LikeActionController, String)>
			return;
	//   81  163:return          
		}
	}
	...
	//    0    0:aload_1         
	//    1    1:aload_0         
	//    2    2:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//    3    5:invokestatic    #853 <Method com.facebook.share.widget.LikeView$ObjectType ShareInternalUtility.getMostSpecificObjectType(com.facebook.share.widget.LikeView$ObjectType, com.facebook.share.widget.LikeView$ObjectType)>
	//    4    8:astore_3        
		if(objecttype1 == null)
	//*   5    9:aload_3         
	//*   6   10:ifnonnull       57
	...
	//    7   13:new             #855 <Class FacebookException>
	//    8   16:dup             
	//    9   17:ldc2            #857 <String "Object with id:\"%s\" is already marked as type:\"%s\". Cannot change the type to:\"%s\"">
	//   10   20:iconst_3        
	//   11   21:anewarray       Object[]
	//   12   24:dup             
	//   13   25:iconst_0        
	//   14   26:aload_0         
	//   15   27:getfield        #216 <Field String objectId>
	//   16   30:aastore         
	//   17   31:dup             
	//   18   32:iconst_1        
	//   19   33:aload_0         
	//   20   34:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//   21   37:invokevirtual   #630 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   22   40:aastore         
	//   23   41:dup             
	//   24   42:iconst_2        
	//   25   43:aload_1         
	//   26   44:invokevirtual   #630 <Method String com.facebook.share.widget.LikeView$ObjectType.toString()>
	//   27   47:aastore         
	//   28   48:invokespecial   #860 <Method void FacebookException(String, Object[])>
	//   29   51:astore_0        
			objecttype = null;
	//   30   52:aconst_null     
	//   31   53:astore_1        
	...
	//   33   57:aload_0         
	//   34   58:aload_3         
	//   35   59:putfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
			objecttype1 = null;
	//   36   62:aconst_null     
	//   37   63:astore_3        
	...
	//   43   69:aload_1         
	//   44   70:aload_0         
	//   45   71:invokestatic    #434 <Method void invokeCallbackWithController(LikeActionController$CreationCallback, LikeActionController, FacebookException)>
	//   46   74:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #331 <Field String likeCountStringWithLike>
	//    5   11:areturn         
		else
			return likeCountStringWithoutLike;
	//    6   12:aload_0         
	//    7   13:getfield        #334 <Field String likeCountStringWithoutLike>
	//    8   16:areturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #337 <Field String socialSentenceWithLike>
	//    5   11:areturn         
		else
			return socialSentenceWithoutLike;
	//    6   12:aload_0         
	//    7   13:getfield        #232 <Field String socialSentenceWithoutLike>
	//    8   16:areturn         
	}
	...
	//    8   13:istore          5
		if(canUseOGPublish())
	//*   9   15:aload_0         
	//*  10   16:invokespecial   #758 <Method boolean canUseOGPublish()>
	//*  11   19:ifeq            83
		{
			updateLikeState(flag1);
	//   12   22:aload_0         
	//   13   23:iload           5
	//   14   25:invokespecial   #749 <Method void updateLikeState(boolean)>
			if(isPendingLikeOrUnlike)
	//*  15   28:aload_0         
	//*  16   29:getfield        #269 <Field boolean isPendingLikeOrUnlike>
	//*  17   32:ifeq            48
			{
				getAppEventsLogger().logSdkEvent("fb_like_control_did_undo_quickly", ((Double) (null)), bundle);
	//   18   35:aload_0         
	//   19   36:invokespecial   #243 <Method AppEventsLogger getAppEventsLogger()>
	//   20   39:ldc2            #866 <String "fb_like_control_did_undo_quickly">
	//   21   42:aconst_null     
	//   22   43:aload_3         
	//   23   44:invokevirtual   #638 <Method void AppEventsLogger.logSdkEvent(String, Double, Bundle)>
				return;
	//   24   47:return          
			}
	...
	//*  26   49:iload           5
	//*  27   51:aload_3         
	//*  28   52:invokespecial   #746 <Method boolean publishLikeOrUnlikeAsync(boolean, Bundle)>
	//*  29   55:ifne            90
			{
				if(flag1)
	//*  30   58:iload           5
	...
	//   35   69:aload_0         
	//   36   70:iload           4
	//   37   72:invokespecial   #749 <Method void updateLikeState(boolean)>
				presentLikeDialog(activity, fragmentwrapper, bundle);
	//   38   75:aload_0         
	//   39   76:aload_1         
	//   40   77:aload_2         
	//   41   78:aload_3         
	//   42   79:invokespecial   #868 <Method void presentLikeDialog(Activity, FragmentWrapper, Bundle)>
				return;
	//   43   82:return          
			}
		} else
	...
	//   46   85:aload_2         
	//   47   86:aload_3         
	//   48   87:invokespecial   #868 <Method void presentLikeDialog(Activity, FragmentWrapper, Bundle)>
		}
	//   49   90:return          
	}
	...
	static 
	{
	//    0    0:new             #197 <Class ConcurrentHashMap>
	//    1    3:dup             
	//    2    4:invokespecial   #200 <Method void ConcurrentHashMap()>
	//    3    7:putstatic       #202 <Field ConcurrentHashMap cache>
	//    4   10:new             #204 <Class WorkQueue>
	//    5   13:dup             
	//    6   14:iconst_1        
	//    7   15:invokespecial   #207 <Method void WorkQueue(int)>
	//    8   18:putstatic       #209 <Field WorkQueue mruCacheWorkQueue>
	//    9   21:new             #204 <Class WorkQueue>
	//   10   24:dup             
	//   11   25:iconst_1        
	//   12   26:invokespecial   #207 <Method void WorkQueue(int)>
	//   13   29:putstatic       #211 <Field WorkQueue diskIOWorkQueue>
	//*  14   32:return          
	}
...
/*
	...
	//    2    2:iload_2         
	//    3    3:aload_3         
	//    4    4:invokespecial   #224 <Method void onActivityResult(int, int, Intent)>
		return;
	//    5    7:return          
	}
...
/*
	...
	{
		return TAG;
	//    0    0:getstatic       #228 <Field String TAG>
	//    1    3:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #232 <Field String socialSentenceWithoutLike>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #235 <Field String unlikeToken>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #235 <Field String unlikeToken>
		return s;
	//    3    5:aload_1         
	//    4    6:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #243 <Method AppEventsLogger getAppEventsLogger()>
	//    2    4:areturn         
	}
...
/*
	...
	//    5    6:aload           5
	//    6    8:aload           6
	//    7   10:invokespecial   #249 <Method void updateState(boolean, String, String, String, String, String)>
		return;
	//    8   13:return          
	}
...
/*
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #255 <Method void logAppEventForError(String, Bundle)>
		return;
	//    4    6:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #262 <Field String verifiedObjectId>
		return s;
	//    3    5:aload_1         
	//    4    6:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #218 <Field com.facebook.share.widget.LikeView$ObjectType objectType>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #275 <Method void publishDidError(boolean)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #280 <Method void refreshStatusAsync()>
		return;
	//    2    4:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #283 <Field boolean isObjectLikedOnServer>
		return flag;
	//    3    5:iload_1         
	//    4    6:ireturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #289 <Method void publishAgainIfNeeded(Bundle)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #293 <Field boolean objectIsPage>
		return flag;
	//    3    5:iload_1         
	//    4    6:ireturn         
	}
...
/*
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #298 <Method void logAppEventForError(String, FacebookRequestError)>
		return;
	//    4    6:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #307 <Method void serializeToDiskSynchronously(String, String)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokestatic    #312 <Method void createControllerForObjectIdAndType(String, com.facebook.share.widget.LikeView$ObjectType, LikeActionController$CreationCallback)>
		return;
	//    4    6:return          
	}
...
/*
	...
	{
		return objectSuffix;
	//    0    0:getstatic       #316 <Field int objectSuffix>
	//    1    3:ireturn         
	}
...
/*
	static int access$302(int i)
	{
		objectSuffix = i;
	//    0    0:iload_0         
	//    1    1:putstatic       #316 <Field int objectSuffix>
		return i;
	//    2    4:iload_0         
	//    3    5:ireturn         
	}
...
/*
	...
	{
		return cache;
	//    0    0:getstatic       #202 <Field ConcurrentHashMap cache>
	//    1    3:areturn         
	}
...
/*
	...
	//    0    0:getstatic       #324 <Field FileLruCache controllerDiskCache>
	//    1    3:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #328 <Method void broadcastAction(LikeActionController, String)>
		return;
	//    3    5:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #331 <Field String likeCountStringWithLike>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #334 <Field String likeCountStringWithoutLike>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #337 <Field String socialSentenceWithLike>
	//    2    4:areturn         
	}
