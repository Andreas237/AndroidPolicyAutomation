...
, LikeDialog.getFeature());
	...
	//    5    9:invokespecial   #56  <Method void LikeDialog(FragmentWrapper)>
	//    6   12:return          
	}
	...
	//    4    8:aload_1         
	//    5    9:ldc1            #81  <String "object_id">
	//    6   11:aload_0         
	//    7   12:invokevirtual   #87  <Method String LikeContent.getObjectId()>
	//    8   15:invokevirtual   #91  <Method void Bundle.putString(String, String)>
		bundle.putString("object_type", likecontent.getObjectType());
	//    9   18:aload_1         
	//   10   19:ldc1            #93  <String "object_type">
	//   11   21:aload_0         
	//   12   22:invokevirtual   #96  <Method String LikeContent.getObjectType()>
	//   13   25:invokevirtual   #91  <Method void Bundle.putString(String, String)>
		return bundle;
	//   14   28:aload_1         
	//   15   29:areturn         
	}
	...
	//    0    0:getstatic       #102 <Field LikeDialogFeature LikeDialogFeature.LIKE_DIALOG>
	//    1    3:areturn         
	}
	...
	//    0    0:new             #106 <Class AppCall>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokevirtual   #109 <Method int getRequestCode()>
	//    4    8:invokespecial   #112 <Method void AppCall(int)>
	//    5   11:areturn         
	}
	...
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:invokespecial   #120 <Method void LikeDialog$NativeHandler(LikeDialog, LikeDialog$1)>
	//   10   18:invokevirtual   #124 <Method boolean ArrayList.add(Object)>
	//   11   21:pop             
	...
	//   15   27:aload_0         
	//   16   28:aconst_null     
	//   17   29:invokespecial   #125 <Method void LikeDialog$WebFallbackHandler(LikeDialog, LikeDialog$1)>
	//   18   32:invokevirtual   #124 <Method boolean ArrayList.add(Object)>
	//   19   35:pop             
	...
	//    8   14:aload_2         
	//    9   15:aload_2         
	//   10   16:invokespecial   #132 <Method void LikeDialog$1(LikeDialog, FacebookCallback, FacebookCallback)>
	//   11   19:astore_2        
	...
	//   14   24:aload_0         
	//   15   25:aload_2         
	//   16   26:invokespecial   #135 <Method void LikeDialog$2(LikeDialog, ResultProcessor)>
	//   17   29:astore_2        
	...
	//   18   30:aload_1         
	//   19   31:aload_0         
	//   20   32:invokevirtual   #109 <Method int getRequestCode()>
	//   21   35:aload_2         
	//   22   36:invokevirtual   #141 <Method void CallbackManagerImpl.registerCallback(int, com.facebook.internal.CallbackManagerImpl$Callback)>
	//   23   39:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #83  <Class LikeContent>
	//    3    5:invokevirtual   #147 <Method void show(LikeContent)>
	//    4    8:return          
	}
	...
	//    0    0:getstatic       #35  <Field com.facebook.internal.CallbackManagerImpl$RequestCodeOffset com.facebook.internal.CallbackManagerImpl$RequestCodeOffset.Like>
...
/*
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #67  <Method Bundle createParameters(LikeContent)>
	//    2    4:areturn         
	}
