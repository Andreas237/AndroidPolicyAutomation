...
public final class ShareOpenGraphAction extends ShareOpenGraphValueContainer
{
	public static final class Builder extends ShareOpenGraphValueContainer.Builder
	{
		...
		//    3    5:invokevirtual   #30  <Method ShareOpenGraphAction$Builder readFrom(ShareOpenGraphAction)>
		//    4    8:areturn         
		}
		...
		//    6   13:invokevirtual   #30  <Method ShareOpenGraphAction$Builder readFrom(ShareOpenGraphAction)>
		//    7   16:areturn         
		}
		...
		//    4    6:aload_0         
		//    5    7:aload_1         
		//    6    8:invokespecial   #46  <Method ShareOpenGraphValueContainer$Builder ShareOpenGraphValueContainer$Builder.readFrom(ShareOpenGraphValueContainer)>
		//    7   11:checkcast       #2   <Class ShareOpenGraphAction$Builder>
		//    8   14:aload_1         
		//    9   15:invokevirtual   #50  <Method String ShareOpenGraphAction.getActionType()>
		//   10   18:invokevirtual   #54  <Method ShareOpenGraphAction$Builder setActionType(String)>
		//   11   21:areturn         
		}
		...
		//    2    3:aload_1         
		//    3    4:invokevirtual   #58  <Method ShareOpenGraphValueContainer$Builder putString(String, String)>
		//    4    7:pop             
			return this;
		//    5    8:aload_0         
		//    6    9:areturn         
