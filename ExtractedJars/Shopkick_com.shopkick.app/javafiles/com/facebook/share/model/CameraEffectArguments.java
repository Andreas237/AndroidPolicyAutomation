...
*/
	...
	//    1    1:getfield        #44  <Field Bundle params>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #68  <Method String Bundle.getString(String)>
	//    4    8:areturn         
	}

	public String[] getStringArray(String s)
	{
		return params.getStringArray(s);
	//    0    0:aload_0         
	//    1    1:getfield        #44  <Field Bundle params>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #72  <Method String[] Bundle.getStringArray(String)>
	//    4    8:areturn         
	}
