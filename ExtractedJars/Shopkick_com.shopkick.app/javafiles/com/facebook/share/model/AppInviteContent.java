	...
	implements ShareModel
{
		...
		implements ShareModelBuilder
	{
		...
		//*   2    2:iload_3         
		//*   3    3:aload_1         
		//*   4    4:invokevirtual   #51  <Method int String.length()>
		//*   5    7:icmpge          46
			{
				char c = s.charAt(i);
		//    6   10:aload_1         
		//    7   11:iload_3         
		//    8   12:invokevirtual   #55  <Method char String.charAt(int)>
		//    9   15:istore_2        
				if(!Character.isDigit(c) && !Character.isLetter(c) && !Character.isSpaceChar(c))
		//*  10   16:iload_2         
		//*  11   17:invokestatic    #61  <Method boolean Character.isDigit(char)>
		//*  12   20:ifne            39
		//*  13   23:iload_2         
		//*  14   24:invokestatic    #64  <Method boolean Character.isLetter(char)>
		//*  15   27:ifne            39
		//*  16   30:iload_2         
		//*  17   31:invokestatic    #67  <Method boolean Character.isSpaceChar(char)>
		//*  18   34:ifne            39
					return false;
		//   19   37:iconst_0        
		//   20   38:ireturn         
		...
		//    2    4:aload_0         
		//    3    5:aconst_null     
		//    4    6:invokespecial   #72  <Method void AppInviteContent(AppInviteContent$Builder, AppInviteContent$1)>
		//    5    9:areturn         
		}
		...
		public volatile Object build()
		{
			return ((Object) (build()));
		//    0    0:aload_0         
		//    1    1:invokevirtual   #76  <Method AppInviteContent build()>
		//    2    4:areturn         
		}
		...
		//    4    6:aload_0         
		//    5    7:aload_1         
		//    6    8:invokevirtual   #82  <Method String AppInviteContent.getApplinkUrl()>
		//    7   11:invokevirtual   #86  <Method AppInviteContent$Builder setApplinkUrl(String)>
		//    8   14:aload_1         
		//    9   15:invokevirtual   #89  <Method String AppInviteContent.getPreviewImageUrl()>
		//   10   18:invokevirtual   #92  <Method AppInviteContent$Builder setPreviewImageUrl(String)>
		//   11   21:aload_1         
		//   12   22:invokevirtual   #95  <Method String AppInviteContent.getPromotionText()>
		//   13   25:aload_1         
		//   14   26:invokevirtual   #98  <Method String AppInviteContent.getPromotionCode()>
		//   15   29:invokevirtual   #102 <Method AppInviteContent$Builder setPromotionDetails(String, String)>
		//   16   32:aload_1         
		//   17   33:invokevirtual   #106 <Method AppInviteContent$Builder$Destination AppInviteContent.getDestination()>
		//   18   36:invokevirtual   #110 <Method AppInviteContent$Builder setDestination(AppInviteContent$Builder$Destination)>
		//   19   39:areturn         
		}
		...
		//    3    5:invokevirtual   #113 <Method AppInviteContent$Builder readFrom(AppInviteContent)>
		//    4    8:areturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #30  <Field String applinkUrl>
			return this;
		//    3    5:aload_0         
		//    4    6:areturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #43  <Field AppInviteContent$Builder$Destination destination>
			return this;
		//    3    5:aload_0         
		//    4    6:areturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #33  <Field String previewImageUrl>
			return this;
		//    3    5:aload_0         
		//    4    6:areturn         
		}
...
label0:
		...
		//*   2    4:ifne            91
				{
					if(s.length() <= 80)
		//*   3    7:aload_1         
		//*   4    8:invokevirtual   #51  <Method int String.length()>
		//*   5   11:bipush          80
		//*   6   13:icmpgt          81
					{
		...
		//*   7   16:aload_0         
		//*   8   17:aload_1         
		//*   9   18:invokespecial   #121 <Method boolean isAlphanumericWithSpaces(String)>
		//*  10   21:ifeq            71
						{
							if(!TextUtils.isEmpty(((CharSequence) (s1))))
		//*  11   24:aload_2         
		//*  12   25:invokestatic    #119 <Method boolean TextUtils.isEmpty(CharSequence)>
		//*  13   28:ifne            98
								if(s1.length() <= 10)
		//*  14   31:aload_2         
		//*  15   32:invokevirtual   #51  <Method int String.length()>
		//*  16   35:bipush          10
		//*  17   37:icmpgt          61
								{
		...
		//*  18   40:aload_0         
		//*  19   41:aload_2         
		//*  20   42:invokespecial   #121 <Method boolean isAlphanumericWithSpaces(String)>
		//*  21   45:ifeq            51
		//*  22   48:goto            98
										throw new IllegalArgumentException("Invalid promotion code, promotionCode can only contain alphanumeric characters and spaces.");
		//   23   51:new             #123 <Class IllegalArgumentException>
		//   24   54:dup             
		//   25   55:ldc1            #125 <String "Invalid promotion code, promotionCode can only contain alphanumeric characters and spaces.">
		//   26   57:invokespecial   #128 <Method void IllegalArgumentException(String)>
		//   27   60:athrow          
								} else
								{
		...
		//   29   64:dup             
		//   30   65:ldc1            #130 <String "Invalid promotion code, promotionCode can be between1 and 10 characters long">
		...
		//   33   71:new             #123 <Class IllegalArgumentException>
		//   34   74:dup             
		//   35   75:ldc1            #132 <String "Invalid promotion text, promotionText can only contain alphanumericcharacters and spaces.">
		//   36   77:invokespecial   #128 <Method void IllegalArgumentException(String)>
		//   37   80:athrow          
						}
					} else
					{
		...
		//   39   84:dup             
		//   40   85:ldc1            #134 <String "Invalid promotion text, promotionText needs to be between1 and 80 characters long">
		//   41   87:invokespecial   #128 <Method void IllegalArgumentException(String)>
		//   42   90:athrow          
					}
				} else
				if(!TextUtils.isEmpty(((CharSequence) (s1))))
		...
		//   46   98:aload_0         
		//   47   99:aload_2         
		//   48  100:putfield        #36  <Field String promoCode>
				promoText = s;
		//   49  103:aload_0         
		//   50  104:aload_1         
		//   51  105:putfield        #39  <Field String promoText>
				return this;
		//   52  108:aload_0         
		//   53  109:areturn         
			}
		...
		//   55  113:dup             
		//   56  114:ldc1            #136 <String "promotionCode cannot be specified without a valid promotionText">
		//   57  116:invokespecial   #128 <Method void IllegalArgumentException(String)>
		//   58  119:athrow          
		}
...
/*
		...
		//    0    0:aload_0         
		//    1    1:getfield        #30  <Field String applinkUrl>
		//    2    4:areturn         
		}
...
/*
		...
		//    0    0:aload_0         
		//    1    1:getfield        #33  <Field String previewImageUrl>
		//    2    4:areturn         
		}
...
/*
		...
		//    0    0:aload_0         
		//    1    1:getfield        #36  <Field String promoCode>
		//    2    4:areturn         
		}
...
/*
		...
		//    0    0:aload_0         
		//    1    1:getfield        #39  <Field String promoText>
		//    2    4:areturn         
		}
...
/*
		...
		//    0    0:aload_0         
		//    1    1:getfield        #43  <Field AppInviteContent$Builder$Destination destination>
		//    2    4:areturn         
		}
