...
//			ShareContent, ShareMessengerGenericTemplateElement, ShareModel, ShareModelBuilder
...
public final class ShareMessengerGenericTemplateContent extends ShareContent
{
	public static class Builder extends ShareContent.Builder
	{
		...
		public Builder setIsSharable(boolean flag)
		{
			isSharable = flag;
		//    0    0:aload_0         
		//    1    1:iload_1         
...
/*
		static ImageAspectRatio access$100(Builder builder)
		{
...
/*
		static ShareMessengerGenericTemplateElement access$200(Builder builder)
		{
...
*/
	...
	//*   3    5:aload_1         
	//*   4    6:invokevirtual   #39  <Method byte Parcel.readByte()>
	//*   5    9:ifeq            17
			flag = true;
	//    6   12:iconst_1        
	//    7   13:istore_2        
	...
	//   11   19:aload_0         
	//   12   20:iload_2         
	//   13   21:putfield        #41  <Field boolean isSharable>
		imageAspectRatio = (ImageAspectRatio)parcel.readSerializable();
	//   14   24:aload_0         
	//   15   25:aload_1         
	//   16   26:invokevirtual   #45  <Method java.io.Serializable Parcel.readSerializable()>
	//   17   29:checkcast       #12  <Class ShareMessengerGenericTemplateContent$ImageAspectRatio>
	//   18   32:putfield        #47  <Field ShareMessengerGenericTemplateContent$ImageAspectRatio imageAspectRatio>
	...
	//   19   35:aload_0         
	//   20   36:aload_1         
	//   21   37:ldc1            #49  <Class ShareMessengerGenericTemplateElement>
	//   22   39:invokevirtual   #55  <Method ClassLoader Class.getClassLoader()>
	//   23   42:invokevirtual   #59  <Method android.os.Parcelable Parcel.readParcelable(ClassLoader)>
	//   24   45:checkcast       #49  <Class ShareMessengerGenericTemplateElement>
	//   25   48:putfield        #61  <Field ShareMessengerGenericTemplateElement genericTemplateElement>
	//   26   51:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #65  <Method void ShareContent(ShareContent$Builder)>
		isSharable = builder.isSharable;
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokestatic    #69  <Method boolean ShareMessengerGenericTemplateContent$Builder.access$000(ShareMessengerGenericTemplateContent$Builder)>
	//    6   10:putfield        #41  <Field boolean isSharable>
		imageAspectRatio = builder.imageAspectRatio;
	//    7   13:aload_0         
	//    8   14:aload_1         
	//    9   15:invokestatic    #73  <Method ShareMessengerGenericTemplateContent$ImageAspectRatio ShareMessengerGenericTemplateContent$Builder.access$100(ShareMessengerGenericTemplateContent$Builder)>
	//   10   18:putfield        #47  <Field ShareMessengerGenericTemplateContent$ImageAspectRatio imageAspectRatio>
		genericTemplateElement = builder.genericTemplateElement;
	//   11   21:aload_0         
	//   12   22:aload_1         
	//   13   23:invokestatic    #77  <Method ShareMessengerGenericTemplateElement ShareMessengerGenericTemplateContent$Builder.access$200(ShareMessengerGenericTemplateContent$Builder)>
	//   14   26:putfield        #61  <Field ShareMessengerGenericTemplateElement genericTemplateElement>
	//   15   29:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #61  <Field ShareMessengerGenericTemplateElement genericTemplateElement>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #47  <Field ShareMessengerGenericTemplateContent$ImageAspectRatio imageAspectRatio>
	//    2    4:areturn         
	}
	...
	public boolean getIsSharable()
	{
		return isSharable;
	//    0    0:aload_0         
	//    1    1:getfield        #41  <Field boolean isSharable>
	//    2    4:ireturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #89  <Method void ShareContent.writeToParcel(Parcel, int)>
		parcel.writeByte((byte)isSharable);
	//    4    6:aload_1         
	//    5    7:aload_0         
	//    6    8:getfield        #41  <Field boolean isSharable>
	//    7   11:int2byte        
	//    8   12:invokevirtual   #93  <Method void Parcel.writeByte(byte)>
		parcel.writeSerializable(((java.io.Serializable) (imageAspectRatio)));
	//    9   15:aload_1         
	//   10   16:aload_0         
	//   11   17:getfield        #47  <Field ShareMessengerGenericTemplateContent$ImageAspectRatio imageAspectRatio>
	//   12   20:invokevirtual   #97  <Method void Parcel.writeSerializable(java.io.Serializable)>
		parcel.writeParcelable(((android.os.Parcelable) (genericTemplateElement)), i);
	//   13   23:aload_1         
	//   14   24:aload_0         
	//   15   25:getfield        #61  <Field ShareMessengerGenericTemplateElement genericTemplateElement>
	//   16   28:iload_2         
	//   17   29:invokevirtual   #101 <Method void Parcel.writeParcelable(android.os.Parcelable, int)>
	//   18   32:return          
	}
...
;
	...
	//    1    3:dup             
	//    2    4:invokespecial   #27  <Method void ShareMessengerGenericTemplateContent$1()>
