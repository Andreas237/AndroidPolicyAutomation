...
//			ShareOpenGraphContent, ShareOpenGraphAction, ShareContent, ShareModel, 
//			ShareModelBuilder
...
public static final class ShareOpenGraphContent$Builder extends ShareContent.Builder
{
	...
	//    4    6:aload_0         
	//    5    7:aload_1         
	//    6    8:invokespecial   #41  <Method ShareContent$Builder ShareContent$Builder.readFrom(ShareContent)>
	//    7   11:checkcast       #2   <Class ShareOpenGraphContent$Builder>
	//    8   14:aload_1         
	//    9   15:invokevirtual   #45  <Method ShareOpenGraphAction ShareOpenGraphContent.getAction()>
	//   10   18:invokevirtual   #49  <Method ShareOpenGraphContent$Builder setAction(ShareOpenGraphAction)>
	//   11   21:aload_1         
	//   12   22:invokevirtual   #53  <Method String ShareOpenGraphContent.getPreviewPropertyName()>
	//   13   25:invokevirtual   #57  <Method ShareOpenGraphContent$Builder setPreviewPropertyName(String)>
	//   14   28:areturn         
	}
	...
	//    5    9:new             #60  <Class ShareOpenGraphAction$Builder>
	//    6   12:dup             
	//    7   13:invokespecial   #61  <Method void ShareOpenGraphAction$Builder()>
	//    8   16:aload_1         
	//    9   17:invokevirtual   #64  <Method ShareOpenGraphAction$Builder ShareOpenGraphAction$Builder.readFrom(ShareOpenGraphAction)>
	//   10   20:invokevirtual   #66  <Method ShareOpenGraphAction ShareOpenGraphAction$Builder.build()>
	//   11   23:astore_1        
