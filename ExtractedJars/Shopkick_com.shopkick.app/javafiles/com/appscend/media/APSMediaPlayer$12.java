	...
	implements Runnable
{
	...
	//    9   15:invokevirtual   #41  <Method void APSMediaEvent.preload()>
		if(val$event.getState() == com.appscend.media.events.ediaEventState.APSMediaEventStatePreloaded)
	//*  10   18:aload_0         
	...
	//*  14   28:if_acmpne       73
		{
			APSMediaPlayer.access$1700().post(new Runnable() {
	...
	//*  26   54:icmpeq          88
			{
				_triggeredEvents.add(((Object) (val$event)));
	//   27   57:aload_0         
	...
	//   34   72:return          
		...
		{
			_preloadedEvents.add(((Object) (val$event)));
	//   35   73:aload_0         
