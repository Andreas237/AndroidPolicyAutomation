...
static class APSMediaBuilder$1
{
	...
	static 
	{
		$SwitchMap$com$appscend$media$events$APSVastAdBreak$APSVASTConfigurationOptions = new int[com.appscend.media.events.VASTConfigurationOptions.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$com$appscend$media$events$APSVastAdBreak$APSVASTConfigurationOptions>
		try
		{
			$SwitchMap$com$appscend$media$events$APSVastAdBreak$APSVASTConfigurationOptions[com.appscend.media.events.VASTConfigurationOptions.APSVASTPreContent.ordinal()] = 1;
	...
	//   25   54:astore_0        
		try
		{
			$SwitchMap$com$appscend$media$events$APSVastAdBreak$APSVASTConfigurationOptions[com.appscend.media.events.VASTConfigurationOptions.APSVASTPostContent.ordinal()] = 2;
		}
	//*  26   55:goto            20
	...
	//   27   58:astore_0        
		try
		{
			$SwitchMap$com$appscend$media$events$APSVastAdBreak$APSVASTConfigurationOptions[com.appscend.media.events.VASTConfigurationOptions.APSVASTMidContent.ordinal()] = 3;
		}
	//*  28   59:goto            31
	...
	//   29   62:astore_0        
		try
		{
			$SwitchMap$com$appscend$media$events$APSVastAdBreak$APSVASTConfigurationOptions[com.appscend.media.events.VASTConfigurationOptions.APSVASTNonLinear.ordinal()] = 4;
		}
	//*  30   63:goto            42
