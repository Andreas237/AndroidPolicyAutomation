...
class APSMediaOverlay$1$1$1
	implements Runnable
{

	public void run()
	{
		APSMediaPlayer.getInstance().viewController().removeView(val$viewToRemove);
...
/* anonymous class */
		...
		implements android.view.animation.Animation.AnimationListener
	{
		...
		//*   6   15:ifeq            40
				handler.post(((Runnable) (new APSMediaOverlay._cls1._cls1._cls1())));
		//    7   18:aload_0         
		...
		//*  16   37:goto            59
				handler.post(new APSMediaOverlay._cls1._cls1._cls2());
		//   17   40:aload_0         
		...
		// Unreferenced inner class com/appscend/media/events/APSMediaOverlay$1$1$2

/* anonymous class */
		class APSMediaOverlay._cls1._cls1._cls2
			implements Runnable
		{
