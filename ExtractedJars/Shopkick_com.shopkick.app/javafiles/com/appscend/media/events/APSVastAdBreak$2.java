...
static class APSVastAdBreak$2
{
	...
	static 
	{
		$SwitchMap$com$appscend$media$APSMediaBuilder$APSResolvMultipleAdsConflictsBy = new int[com.appscend.media.PSResolvMultipleAdsConflictsBy.values().length];
	...
	//    3    6:putstatic       #20  <Field int[] $SwitchMap$com$appscend$media$APSMediaBuilder$APSResolvMultipleAdsConflictsBy>
		try
		{
			$SwitchMap$com$appscend$media$APSMediaBuilder$APSResolvMultipleAdsConflictsBy[com.appscend.media.PSResolvMultipleAdsConflictsBy.APSResolvMultipleAdsConflictsByDropping.ordinal()] = 1;
	...
	//   20   43:astore_0        
		try
		{
			$SwitchMap$com$appscend$media$APSMediaBuilder$APSResolvMultipleAdsConflictsBy[com.appscend.media.PSResolvMultipleAdsConflictsBy.APSResolvMultipleAdsConflictsBySelectingFirst.ordinal()] = 2;
		}
	//*  21   44:goto            20
	...
	//   22   47:astore_0        
		try
		{
			$SwitchMap$com$appscend$media$APSMediaBuilder$APSResolvMultipleAdsConflictsBy[com.appscend.media.PSResolvMultipleAdsConflictsBy.APSResolvMultipleAdsConflictsBySelectingRandom.ordinal()] = 3;
		}
	//*  23   48:goto            31
