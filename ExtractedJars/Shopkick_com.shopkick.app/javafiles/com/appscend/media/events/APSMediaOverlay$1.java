	...
	implements Runnable
{
	...
	public void run()
	{
		try
		{
			final View viewToRemove = (View)((Object) (val$overlay.controller)).getClass().getMethod("getView", new Class[0]).invoke(((Object) (val$overlay.controller)), new Object[0]);
	//    0    0:aload_0         
	...
	//   15   36:astore_1        
			AlphaAnimation alphaanimation = new AlphaAnimation(val$overlayAlpha, 0.0F);
	...
	//   22   49:astore_2        
			alphaanimation.setDuration((int)val$overlay.fadeInDuration * 1000);
	//   23   50:aload_2         
	//   24   51:aload_0         
	...
	//   34   69:invokevirtual   #81  <Method void AlphaAnimation.setFillAfter(boolean)>
			...
			{
				this$1 = APSMediaOverlay._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	//   41   82:invokevirtual   #88  <Method void AlphaAnimation.setAnimationListener(android.view.animation.Animation$AnimationListener)>
			viewToRemove.startAnimation(((Animation) (alphaanimation)));
	//   42   85:aload_1         
	//   43   86:aload_2         
