...
class APSMediaOverlay$1$1
	implements android.view.animation.istener
{

	public void onAnimationEnd(Animation animation)
	{
		if(val$overlay.type.equals("controls"))
	//*   0    0:aload_0         
	...
	//   25   58:pop             
		APSMediaPlayer.getInstance().trackforEvent((ArrayList)val$overlay.trackingURLs.get("finish"), "finish for non-linear", com.appscend.media.ts.MediaEventType.FINISH, ((APSMediaEvent) (this$0)));
	...
	//   39   92:invokevirtual   #99  <Method void APSMediaPlayer.trackforEvent(ArrayList, String, com.appscend.media.APSMediaTrackingEvents$MediaEventType, APSMediaEvent)>
		try
		{
			((Object) (val$overlay.controller)).getClass().getMethod("onDestroy", new Class[0]).invoke(((Object) (val$overlay.controller)), new Object[0]);
	//   40   95:aload_0         
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//   34   69:invokevirtual   #81  <Method void AlphaAnimation.setFillAfter(boolean)>
				alphaanimation.setAnimationListener(((android.view.animation.Animation.AnimationListener) (((APSMediaOverlay._cls1._cls1) (view)). new APSMediaOverlay._cls1._cls1())));
		//   35   72:aload_2         
