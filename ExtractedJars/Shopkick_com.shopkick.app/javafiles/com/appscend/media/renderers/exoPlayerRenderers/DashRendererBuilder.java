	...
	implements ExoPlayerInterface.RendererBuilder
{
		...
		implements com.google.android.exoplayer.util.ManifestFetcher.ManifestCallback, com.google.android.exoplayer.dash.mpd.UtcTimingElementResolver.UtcTimingCallback
	{
		...
		//  145  294:astore          9
			obj2 = ((Object) (new MediaCodecVideoTrackRenderer(context, ((com.google.android.exoplayer.SampleSource) (obj2)), MediaCodecSelector.DEFAULT, 1, 5000L, ((com.google.android.exoplayer.drm.DrmSessionManager) (obj)), true, ((Handler) (obj1)), ((com.google.android.exoplayer.MediaCodecVideoTrackRenderer.EventListener) (player)), 50)));
		...
		//*  12   24:ifnull          47
			{
				UtcTimingElementResolver.resolveTimingElement(manifestDataSource, mediapresentationdescription.utcTiming, manifestFetcher.getManifestLoadCompleteTimestamp(), ((com.google.android.exoplayer.dash.mpd.UtcTimingElementResolver.UtcTimingCallback) (this)));
		//   13   27:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #45  <Field Context context>
		userAgent = s;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #47  <Field String userAgent>
		url = s1;
	//    8   14:aload_0         
	//    9   15:aload_3         
	//   10   16:putfield        #49  <Field String url>
		drmCallback = mediadrmcallback;
	//   11   19:aload_0         
	//   12   20:aload           4
	//   13   22:putfield        #51  <Field MediaDrmCallback drmCallback>
	//   14   25:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #8   <Class DashRendererBuilder$AsyncRendererBuilder>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:getfield        #45  <Field Context context>
	//    5    9:aload_0         
	//    6   10:getfield        #47  <Field String userAgent>
	//    7   13:aload_0         
	//    8   14:getfield        #49  <Field String url>
	//    9   17:aload_0         
	//   10   18:getfield        #51  <Field MediaDrmCallback drmCallback>
	//   11   21:aload_1         
	//   12   22:invokespecial   #57  <Method void DashRendererBuilder$AsyncRendererBuilder(Context, String, String, MediaDrmCallback, ExoPlayerInterface)>
	//   13   25:putfield        #59  <Field DashRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
		currentAsyncBuilder.init();
	//   14   28:aload_0         
	//   15   29:getfield        #59  <Field DashRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
	//   16   32:invokevirtual   #62  <Method void DashRendererBuilder$AsyncRendererBuilder.init()>
	//   17   35:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #59  <Field DashRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
	//    2    4:astore_1        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #65  <Method void DashRendererBuilder$AsyncRendererBuilder.cancel()>
			currentAsyncBuilder = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #59  <Field DashRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
		}
	//   10   18:return          
	}
