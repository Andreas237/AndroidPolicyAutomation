...
//			HlsRendererBuilder, ExoPlayerInterface

private static final class HlsRendererBuilder$AsyncRendererBuilder
	implements com.google.android.exoplayer.util.ManifestFetcher.ManifestCallback
{
	...
	//   76  158:astore          12
		MediaCodecVideoTrackRenderer mediacodecvideotrackrenderer = new MediaCodecVideoTrackRenderer(context, ((SampleSource) (hlssamplesource)), MediaCodecSelector.DEFAULT, 1, 5000L, handler, ((com.google.android.exoplayer.er) (player)), 50);
	...
	//  140  289:aload           5
	//  141  291:aastore         
			obj = ((Object) (new MediaCodecAudioTrackRenderer(asamplesource, MediaCodecSelector.DEFAULT, ((com.google.android.exoplayer.drm.DrmSessionManager) (null)), true, player.getMainHandler(), ((com.google.android.exoplayer.er) (player)), AudioCapabilities.getCapabilities(context), 3)));
	...
	//* 159  327:goto            365
		{
			obj = ((Object) (new MediaCodecAudioTrackRenderer(((SampleSource) (hlssamplesource)), MediaCodecSelector.DEFAULT, ((com.google.android.exoplayer.drm.DrmSessionManager) (null)), true, player.getMainHandler(), ((com.google.android.exoplayer.er) (player)), AudioCapabilities.getCapabilities(context), 3)));
	...
	public HlsRendererBuilder$AsyncRendererBuilder(Context context1, String s, String s1, String s2, ExoPlayerInterface exoplayerinterface)
	{
	//    0    0:aload_0         
