...
public class SmoothStreamingRendererBuilder
	implements ExoPlayerInterface.RendererBuilder
{
		...
		implements com.google.android.exoplayer.util.ManifestFetcher.ManifestCallback
	{
		...
		public AsyncRendererBuilder(Context context1, String s, String s1, MediaDrmCallback mediadrmcallback, ExoPlayerInterface exoplayerinterface)
		{
		//    0    0:aload_0         
	...
	public SmoothStreamingRendererBuilder(Context context1, String s, String s1, MediaDrmCallback mediadrmcallback)
	{
	//    0    0:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #36  <Field Context context>
		userAgent = s;
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #38  <Field String userAgent>
		if(!Util.toLowerInvariant(s1).endsWith("/manifest"))
	//*   8   14:aload_3         
	//*   9   15:invokestatic    #44  <Method String Util.toLowerInvariant(String)>
	//*  10   18:ldc1            #46  <String "/manifest">
	//*  11   20:invokevirtual   #52  <Method boolean String.endsWith(String)>
	//*  12   23:ifeq            29
	//*  13   26:goto            55
		{
			context1 = ((Context) (new StringBuilder()));
	//   14   29:new             #54  <Class StringBuilder>
	//   15   32:dup             
	//   16   33:invokespecial   #55  <Method void StringBuilder()>
	//   17   36:astore_1        
			((StringBuilder) (context1)).append(s1);
	//   18   37:aload_1         
	//   19   38:aload_3         
	//   20   39:invokevirtual   #59  <Method StringBuilder StringBuilder.append(String)>
	//   21   42:pop             
			((StringBuilder) (context1)).append("/Manifest");
	//   22   43:aload_1         
	//   23   44:ldc1            #61  <String "/Manifest">
	//   24   46:invokevirtual   #59  <Method StringBuilder StringBuilder.append(String)>
	//   25   49:pop             
			s1 = ((StringBuilder) (context1)).toString();
	//   26   50:aload_1         
	//   27   51:invokevirtual   #65  <Method String StringBuilder.toString()>
	//   28   54:astore_3        
		}
		url = s1;
	//   29   55:aload_0         
	//   30   56:aload_3         
	//   31   57:putfield        #67  <Field String url>
		drmCallback = mediadrmcallback;
	//   32   60:aload_0         
	//   33   61:aload           4
	//   34   63:putfield        #69  <Field MediaDrmCallback drmCallback>
	//   35   66:return          
	}

	public void buildRenderers(ExoPlayerInterface exoplayerinterface)
	{
		currentAsyncBuilder = new AsyncRendererBuilder(context, userAgent, url, drmCallback, exoplayerinterface);
	//    0    0:aload_0         
	//    1    1:new             #8   <Class SmoothStreamingRendererBuilder$AsyncRendererBuilder>
	//    2    4:dup             
	//    3    5:aload_0         
	//    4    6:getfield        #36  <Field Context context>
	//    5    9:aload_0         
	//    6   10:getfield        #38  <Field String userAgent>
	//    7   13:aload_0         
	//    8   14:getfield        #67  <Field String url>
	//    9   17:aload_0         
	//   10   18:getfield        #69  <Field MediaDrmCallback drmCallback>
	//   11   21:aload_1         
	//   12   22:invokespecial   #75  <Method void SmoothStreamingRendererBuilder$AsyncRendererBuilder(Context, String, String, MediaDrmCallback, ExoPlayerInterface)>
	//   13   25:putfield        #77  <Field SmoothStreamingRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
		currentAsyncBuilder.init();
	//   14   28:aload_0         
	//   15   29:getfield        #77  <Field SmoothStreamingRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
	//   16   32:invokevirtual   #80  <Method void SmoothStreamingRendererBuilder$AsyncRendererBuilder.init()>
	//   17   35:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field SmoothStreamingRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
	//    2    4:astore_1        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #83  <Method void SmoothStreamingRendererBuilder$AsyncRendererBuilder.cancel()>
			currentAsyncBuilder = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #77  <Field SmoothStreamingRendererBuilder$AsyncRendererBuilder currentAsyncBuilder>
		}
	//   10   18:return          
	}
