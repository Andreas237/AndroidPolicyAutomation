...
{
	public static final class MediaEventType extends Enum
	{

		public static MediaEventType valueOf(String s)
		{
			return (MediaEventType)Enum.valueOf(com/appscend/media/APSMediaTrackingEvents$MediaEventType, s);
		...
		{
			return (MediaEventType[])((MediaEventType []) ($VALUES)).clone();
		...
		private static final MediaEventType $VALUES[];
		public static final MediaEventType BUFFER_END;
		public static final MediaEventType BUFFER_START;
		public static final MediaEventType CLICK;
		public static final MediaEventType CLOCK_TICK;
		public static final MediaEventType CLOSE;
		public static final MediaEventType CLOSE_LINEAR;
		public static final MediaEventType COMPLETE;
		public static final MediaEventType CREATIVE_VIEW;
		public static final MediaEventType ERROR;
		public static final MediaEventType EXIT_FULLSCREEN;
		public static final MediaEventType EXIT_FULLSCREEN_OVERLAY_ACTIVITY;
		public static final MediaEventType FINISH;
		public static final MediaEventType FORWARD;
		public static final MediaEventType FULLSCREEN;
		public static final MediaEventType IMPRESSION;
		public static final MediaEventType LAUNCH;
		public static final MediaEventType LICENSE_INVALID;
		public static final MediaEventType MUTE;
		public static final MediaEventType PAUSE;
		public static final MediaEventType PLAYBACK_REQUESTED;
		public static final MediaEventType PLAYBACK_STATE_CHANGED;
		public static final MediaEventType PLAYLIST_FINISHED;
		public static final MediaEventType POSITION;
		public static final MediaEventType RESUME;
		public static final MediaEventType REWIND;
		public static final MediaEventType SKIP;
		public static final MediaEventType START;
		public static final MediaEventType START_PROCESSING_NEW_UNIT;
		public static final MediaEventType UNIT_FINISHED;
		public static final MediaEventType UNIT_FINISHED_URL;
		public static final MediaEventType UNMUTE;
		public static final MediaEventType USER_PAUSE;
		public static final MediaEventType USER_UNPAUSE;

		static 
		{
			FULLSCREEN = new MediaEventType("FULLSCREEN", 0);
		...
		//    5   10:putstatic       #53  <Field APSMediaTrackingEvents$MediaEventType FULLSCREEN>
			EXIT_FULLSCREEN = new MediaEventType("EXIT_FULLSCREEN", 1);
		...
		//   11   23:putstatic       #56  <Field APSMediaTrackingEvents$MediaEventType EXIT_FULLSCREEN>
			EXIT_FULLSCREEN_OVERLAY_ACTIVITY = new MediaEventType("EXIT_FULLSCREEN_OVERLAY_ACTIVITY", 2);
		...
		//   17   36:putstatic       #59  <Field APSMediaTrackingEvents$MediaEventType EXIT_FULLSCREEN_OVERLAY_ACTIVITY>
			LAUNCH = new MediaEventType("LAUNCH", 3);
		...
		//   23   49:putstatic       #62  <Field APSMediaTrackingEvents$MediaEventType LAUNCH>
			FINISH = new MediaEventType("FINISH", 4);
		...
		//   29   62:putstatic       #65  <Field APSMediaTrackingEvents$MediaEventType FINISH>
			RESUME = new MediaEventType("RESUME", 5);
		...
		//   35   75:putstatic       #68  <Field APSMediaTrackingEvents$MediaEventType RESUME>
			PAUSE = new MediaEventType("PAUSE", 6);
		...
		//   41   89:putstatic       #71  <Field APSMediaTrackingEvents$MediaEventType PAUSE>
			REWIND = new MediaEventType("REWIND", 7);
		...
		//   47  103:putstatic       #74  <Field APSMediaTrackingEvents$MediaEventType REWIND>
			FORWARD = new MediaEventType("FORWARD", 8);
		...
		//   53  117:putstatic       #77  <Field APSMediaTrackingEvents$MediaEventType FORWARD>
			SKIP = new MediaEventType("SKIP", 9);
		...
		//   59  131:putstatic       #80  <Field APSMediaTrackingEvents$MediaEventType SKIP>
			IMPRESSION = new MediaEventType("IMPRESSION", 10);
		...
		//   65  145:putstatic       #83  <Field APSMediaTrackingEvents$MediaEventType IMPRESSION>
			CREATIVE_VIEW = new MediaEventType("CREATIVE_VIEW", 11);
		...
		//   71  159:putstatic       #86  <Field APSMediaTrackingEvents$MediaEventType CREATIVE_VIEW>
			START = new MediaEventType("START", 12);
		...
		//   77  173:putstatic       #89  <Field APSMediaTrackingEvents$MediaEventType START>
			COMPLETE = new MediaEventType("COMPLETE", 13);
		...
		//   83  187:putstatic       #92  <Field APSMediaTrackingEvents$MediaEventType COMPLETE>
			CLOSE = new MediaEventType("CLOSE", 14);
		...
		//   89  201:putstatic       #95  <Field APSMediaTrackingEvents$MediaEventType CLOSE>
			CLOSE_LINEAR = new MediaEventType("CLOSE_LINEAR", 15);
		...
		//   95  215:putstatic       #98  <Field APSMediaTrackingEvents$MediaEventType CLOSE_LINEAR>
			ERROR = new MediaEventType("ERROR", 16);
		...
		//  101  229:putstatic       #101 <Field APSMediaTrackingEvents$MediaEventType ERROR>
			MUTE = new MediaEventType("MUTE", 17);
		...
		//  107  243:putstatic       #104 <Field APSMediaTrackingEvents$MediaEventType MUTE>
			UNMUTE = new MediaEventType("UNMUTE", 18);
		...
		//  113  257:putstatic       #107 <Field APSMediaTrackingEvents$MediaEventType UNMUTE>
			CLICK = new MediaEventType("CLICK", 19);
		...
		//  119  271:putstatic       #110 <Field APSMediaTrackingEvents$MediaEventType CLICK>
			UNIT_FINISHED = new MediaEventType("UNIT_FINISHED", 20);
		...
		//  125  285:putstatic       #113 <Field APSMediaTrackingEvents$MediaEventType UNIT_FINISHED>
			UNIT_FINISHED_URL = new MediaEventType("UNIT_FINISHED_URL", 21);
		...
		//  131  299:putstatic       #116 <Field APSMediaTrackingEvents$MediaEventType UNIT_FINISHED_URL>
			LICENSE_INVALID = new MediaEventType("LICENSE_INVALID", 22);
		...
		//  137  313:putstatic       #119 <Field APSMediaTrackingEvents$MediaEventType LICENSE_INVALID>
			PLAYLIST_FINISHED = new MediaEventType("PLAYLIST_FINISHED", 23);
		...
		//  143  327:putstatic       #122 <Field APSMediaTrackingEvents$MediaEventType PLAYLIST_FINISHED>
			CLOCK_TICK = new MediaEventType("CLOCK_TICK", 24);
		...
		//  149  341:putstatic       #125 <Field APSMediaTrackingEvents$MediaEventType CLOCK_TICK>
			USER_PAUSE = new MediaEventType("USER_PAUSE", 25);
		...
		//  155  355:putstatic       #128 <Field APSMediaTrackingEvents$MediaEventType USER_PAUSE>
			USER_UNPAUSE = new MediaEventType("USER_UNPAUSE", 26);
		...
		//  161  369:putstatic       #131 <Field APSMediaTrackingEvents$MediaEventType USER_UNPAUSE>
			POSITION = new MediaEventType("POSITION", 27);
		...
		//  167  383:putstatic       #134 <Field APSMediaTrackingEvents$MediaEventType POSITION>
			PLAYBACK_STATE_CHANGED = new MediaEventType("PLAYBACK_STATE_CHANGED", 28);
		...
		//  173  397:putstatic       #137 <Field APSMediaTrackingEvents$MediaEventType PLAYBACK_STATE_CHANGED>
			BUFFER_START = new MediaEventType("BUFFER_START", 29);
		...
		//  179  411:putstatic       #140 <Field APSMediaTrackingEvents$MediaEventType BUFFER_START>
			BUFFER_END = new MediaEventType("BUFFER_END", 30);
		...
		//  185  425:putstatic       #143 <Field APSMediaTrackingEvents$MediaEventType BUFFER_END>
			START_PROCESSING_NEW_UNIT = new MediaEventType("START_PROCESSING_NEW_UNIT", 31);
		...
		//  191  439:putstatic       #146 <Field APSMediaTrackingEvents$MediaEventType START_PROCESSING_NEW_UNIT>
			PLAYBACK_REQUESTED = new MediaEventType("PLAYBACK_REQUESTED", 32);
		...
		//  198  456:bipush          33
		//  199  458:anewarray       MediaEventType[]
		//  200  461:dup             
		//  201  462:iconst_0        
		...
		private MediaEventType(String s, int i)
		{
			super(s, i);
		//    0    0:aload_0         
		//    1    1:aload_1         
