...
class CraftAROnDeviceCollectionManager$5
	implements Runnable
{
	...
	//    5   12:astore_1        
		dCollectionListener dcollectionlistener = val$addCollectionListener;
	//    6   13:aload_0         
	//    7   14:getfield        #21  <Field CraftAROnDeviceCollectionManager$AddCollectionListener val$addCollectionListener>
	//    8   17:astore_2        
		if(dcollectionlistener != null)
	//*   9   18:aload_2         
	//*  10   19:ifnull          30
		{
			dcollectionlistener.addCollectionFailed(craftarerror);
	//   11   22:aload_2         
	//   12   23:aload_1         
	...
	CraftAROnDeviceCollectionManager$5()
	{
