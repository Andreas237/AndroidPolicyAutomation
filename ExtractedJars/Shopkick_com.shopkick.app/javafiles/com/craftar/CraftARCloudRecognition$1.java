...
//			CraftARCloudRecognition, SearchParams, Build, CRSConnect, 
//			CraftARError, CraftARSearchResponseHandler, CLog

class CraftARCloudRecognition$1
	implements Runnable
{
	...
	//   12   24:putfield        #53  <Field String SearchParams.token>
		searchparams.image = val$imagedata;
	//   13   27:aload_2         
	//   14   28:aload_0         
	...
	//   60  132:putfield        #115 <Field String SearchParams.appID>
		try
		{
			CraftARCloudRecognition.access$600(CraftARCloudRecognition.this).search(searchparams, (() (new archCallback(CraftARCloudRecognition.this, mResponseHandler, val$requestCode, val$timeStamp))));
	//   61  135:aload_0         
	...
	//   81  175:invokevirtual   #136 <Method void Exception.printStackTrace()>
			...
			{
				this$1 = CraftARCloudRecognition._cls1.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
