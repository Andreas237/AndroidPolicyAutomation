...
//			CraftARCloudRecognition, CraftARSearchResponseHandler, CraftARCollection, CraftARItemFactory, 
//			CraftARItem, CraftARImage, CraftARBoundingBox, CLog, 
//			CraftARResult, CraftARError, CraftARNetworkError

class CraftARCloudRecognition$SearchCallback
	implements CRSConnect.NetworkCallback
{

	public void onResult(final int statusCode, final String message)
	{
		if(CraftARCloudRecognition.access$700(CraftARCloudRecognition.this))
	//*   0    0:aload_0         
	...
	//*   3    7:ifeq            20
		{
			CraftARCloudRecognition.access$002(CraftARCloudRecognition.this, 0);
	//    4   10:aload_0         
...
_L5:
			...
			{
				this$1 = CraftARCloudRecognition.SearchCallback.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	//   28   54:pop             
			int _tmp = CraftARCloudRecognition.access$010(CraftARCloudRecognition.this);
	//   29   55:aload_0         
	...
	CraftARCloudRecognition$SearchCallback(CraftARSearchResponseHandler craftarsearchresponsehandler, int i, long l)
	{
