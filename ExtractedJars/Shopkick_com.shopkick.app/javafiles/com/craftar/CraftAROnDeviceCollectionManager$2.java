...
//			CraftAROnDeviceCollectionManager, CLog, CraftARError, CraftAROnDeviceCollection

class CraftAROnDeviceCollectionManager$2
	implements Handler
{
	...
	//    7   16:pop             
		stringbuilder.append(val$bundleURL);
	//    8   17:aload           5
	//    9   19:aload_0         
	...
	//*  28   60:ifeq            96
			{
				url = ((URL) (new File(val$bundleOutputPath)));
	...
	//   34   74:astore_3        
				dCollectionListener dcollectionlistener = new CraftAROnDeviceCollectionManager.AddCollectionListener() {
					...
					//    3    7:astore_3        
						stringbuilder2.append("AddCollectionProgress in sync: ");
					//    4    8:aload_3         
...
;
	...
	//   39   83:astore          5
				addCollection(((File) (url)), dcollectionlistener);
	//   40   85:aload_0         
	...
	//*  72  151:ifnull          163
			{
				((dCollectionListener) (obj)).addCollectionFailed(((CraftARError) (url)));
	//   73  154:aload           5
	//   74  156:aload_3         
	...
	//   22   39:pop             
		((StringBuilder) (obj)).append(val$bundleURL);
	//   23   40:aload           4
	//   24   42:aload_0         
	...
	//*  42   79:aload           4
	//*  43   81:ifnull          94
			((dCollectionListener) (obj)).addCollectionProgress(f / 2.0F);
	//   44   84:aload           4
	//   45   86:fload_3         
	//   46   87:fconst_2        
	//   47   88:fdiv            
	...
	CraftAROnDeviceCollectionManager$2()
	{
