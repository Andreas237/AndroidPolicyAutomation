...
class CraftAROnDeviceCollectionManager$15
	implements Runnable
{
	...
	//*   4    6:ifnull          20
		{
			collectionlistener.addCollectionFailed(val$craftARError);
	//    5    9:aload_1         
	//    6   10:aload_0         
	...
	//    9   19:return          
		...
		{
			CLog.e(val$craftARError.getErrorMessage());
	//   10   20:aload_0         
	...
	CraftAROnDeviceCollectionManager$15()
	{
	...
	//    5    7:putfield        #23  <Field CraftAROnDeviceCollectionManager$AddCollectionListener val$addCollectionListener>
		val$craftARError = CraftARError.this;
	//    6   10:aload_0         
	//    7   11:aload_3         
