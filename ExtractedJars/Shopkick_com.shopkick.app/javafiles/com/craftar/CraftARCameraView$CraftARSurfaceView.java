...
//			AppEventListener, CraftARCameraView, CLog, CameraThread, 
//			CraftARSDK, ImplCraftARCamera, CraftARActivity, VideoCaptureConsumerHub, 
//			AppEventForwarder

private class CraftARCameraView$CraftARSurfaceView extends SurfaceView
	implements android.view.SurfaceHolder.Callback, ureConsumer, android.view.View.OnClickListener, android.view.View.OnTouchListener, AppEventListener
{
	private class OrientationListener extends OrientationEventListener
	{
		...
		//   45   94:putfield        #28  <Field boolean executeOnce>
					mCameraThread.setCameraDisplayOrientation(new CameraThread.DisplayOrientationCallback() {
						...
						final OrientationListener this$2;

			
			{
				this$2 = OrientationListener.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
...
/*
		static int access$202(OrientationListener orientationlistener, int i)
		{
...
*/
	...
	//   10   22:invokevirtual   #205 <Method void ImplCraftARCamera.triggerAutoFocus()>
		if(CraftARCameraView.access$000(CraftARCameraView.this) != null)
	//*  11   25:aload_0         
	...
	//*  14   32:ifnull          51
			CraftARCameraView.access$000(CraftARCameraView.this).onClick(((View) (mParentView)));
	//   15   35:aload_0         
	...
	//   40   78:putfield        #67  <Field double mAspectRatio>
		mCameraThread.setCameraDisplayOrientation(((ck) (null)));
	//   41   81:aload_0         
	...
	{
		if(CraftARCameraView.access$400(CraftARCameraView.this) != null)
	//*   0    0:aload_0         
	...
	//*   3    7:ifnull          28
			CraftARCameraView.access$400(CraftARCameraView.this).onTouch(((View) (mParentView)), motionevent);
	//    4   10:aload_0         
	...
	//   16   37:invokestatic    #100 <Method void CLog.d(String)>
		VideoCaptureConsumerHub.Instance().requestNV21Frames(((ureConsumer) (this)), false);
...
/*
	static Context access$100(CraftARCameraView$CraftARSurfaceView craftarcameraview$craftarsurfaceview)
	{
		return craftarcameraview$craftarsurfaceview.mContext;
	//    0    0:aload_0         
...
/*
	static CameraThread access$300(CraftARCameraView$CraftARSurfaceView craftarcameraview$craftarsurfaceview)
	{
		return craftarcameraview$craftarsurfaceview.mCameraThread;
	//    0    0:aload_0         
...
*/
	...
	public CraftARCameraView$CraftARSurfaceView(Context context)
	{
	...
	public CraftARCameraView$CraftARSurfaceView(Context context, AttributeSet attributeset)
	{
		this$0 = CraftARCameraView.this;
	//    0    0:aload_0         
	//    1    1:aload_1         
