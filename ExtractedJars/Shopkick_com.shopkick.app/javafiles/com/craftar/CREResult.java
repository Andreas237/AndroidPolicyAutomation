...
class CREResult
{
	static final class ErrorCodes
	{
		...
		static final int WARN_FEW_KPS = 0xfffe7896;
		static final int WARN_GENERAL = 0xfffe795f;
		static final int WARN_IMG_SIZE = 0xfffe77c3;
		static final int WARN_USAGE_LOGGING = 0xfffe76a4;
	...
	//    1    1:invokespecial   #19  <Method void Object()>
		bb = new CraftARBoundingBox();
	//    2    4:aload_0         
	//    3    5:new             #21  <Class CraftARBoundingBox>
	//    4    8:dup             
	//    5    9:invokespecial   #22  <Method void CraftARBoundingBox()>
	//    6   12:putfield        #24  <Field CraftARBoundingBox bb>
	//    7   15:return          
	}

	CraftARBoundingBox bb;
	int errorCode;
	String id;
	double score;
}
