...
class CraftAROnDeviceIR$8
	implements Runnable
{

	public void run()
	{
		CraftARError craftarerror = new CraftARError(ODES.ON_DEVICE_IR_INTERNAL_ERROR_LOADING_COLLECTION, "Can't write to collection directory");
