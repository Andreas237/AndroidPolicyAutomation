	...
	implements EventsStorageListener
{
	...
	//    7   15:aload_0         
	//    8   16:aload_1         
	//    9   17:putfield        #46  <Field Kit kit>
		context = context1;
	//   10   20:aload_0         
	//   11   21:aload_2         
	...
	//   19   36:aload_0         
	//   20   37:aload           5
	//   21   39:putfield        #54  <Field HttpRequestFactory requestFactory>
	...
	//    7   13:invokestatic    #87  <Method Logger Fabric.getLogger()>
	//    8   16:ldc1            #89  <String "Answers">
	//    9   18:ldc1            #91  <String "Failed to submit events task">
	//   10   20:aload_1         
	//   11   21:invokeinterface #97  <Method void Logger.e(String, String, Throwable)>
		}
	//   12   26:return          
	}
	...
	//    8   18:invokestatic    #87  <Method Logger Fabric.getLogger()>
	//    9   21:ldc1            #89  <String "Answers">
	//   10   23:ldc1            #106 <String "Failed to run events task">
	//   11   25:aload_1         
	//   12   26:invokeinterface #97  <Method void Logger.e(String, String, Throwable)>
		}
	//   13   31:return          
	}
	...
	public void enable()
	{
		executeAsync(new Runnable() {
			...
			//   35   75:invokespecial   #74  <Method void EnabledSessionAnalyticsManagerStrategy(Kit, Context, ScheduledExecutorService, SessionAnalyticsFilesManager, HttpRequestFactory, SessionEventMetadata, FirebaseAnalyticsApiAdapter)>
	...
	//    4    6:aload_1         
	//    5    7:aload_2         
	//    6    8:invokespecial   #137 <Method void AnswersEventsHandler$1(AnswersEventsHandler, AnalyticsSettingsData, String)>
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #54  <Field HttpRequestFactory requestFactory>
	//    2    4:areturn         
	}
