...
_L2:
	...
	//   13   27:invokestatic    #64  <Method Logger Fabric.getLogger()>
	...
	//   16   34:invokeinterface #74  <Method void Logger.d(String, String)>
	...
	//   30   64:invokestatic    #64  <Method Logger Fabric.getLogger()>
	//   31   67:ldc1            #66  <String "CrashlyticsCore">
	//   32   69:ldc1            #78  <String "An error occurred in the uncaught exception handler">
	//   33   71:aload_3         
	//   34   72:invokeinterface #82  <Method void Logger.e(String, String, Throwable)>
		if(true) goto _L2; else goto _L1
	//   35   77:goto            27
_L1:
		Fabric.getLogger().d("CrashlyticsCore", "Crashlytics completed exception processing. Invoking default exception handler.");
	//   36   80:invokestatic    #64  <Method Logger Fabric.getLogger()>
	...
	//   39   87:invokeinterface #74  <Method void Logger.d(String, String)>
		defaultHandler.uncaughtException(thread, throwable);
	//   40   92:aload_0         
