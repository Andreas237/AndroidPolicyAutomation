	...
	implements Report
{
	...
	//    0    0:getstatic       #95  <Field Report$Type Report$Type.JAVA>
	//    1    3:areturn         
	}
	...
	//    0    0:invokestatic    #102 <Method Logger Fabric.getLogger()>
	//    1    3:astore_1        
		StringBuilder stringbuilder = new StringBuilder();
	//    2    4:new             #104 <Class StringBuilder>
	//    3    7:dup             
	//    4    8:invokespecial   #105 <Method void StringBuilder()>
	//    5   11:astore_2        
		stringbuilder.append("Removing report at ");
	//    6   12:aload_2         
	//    7   13:ldc1            #107 <String "Removing report at ">
	//    8   15:invokevirtual   #111 <Method StringBuilder StringBuilder.append(String)>
	//    9   18:pop             
		stringbuilder.append(file.getPath());
	//   10   19:aload_2         
	//   11   20:aload_0         
	//   12   21:getfield        #30  <Field File file>
	//   13   24:invokevirtual   #114 <Method String File.getPath()>
	//   14   27:invokevirtual   #111 <Method StringBuilder StringBuilder.append(String)>
	//   15   30:pop             
		logger.d("CrashlyticsCore", stringbuilder.toString());
	//   16   31:aload_1         
	//   17   32:ldc1            #116 <String "CrashlyticsCore">
	//   18   34:aload_2         
	//   19   35:invokevirtual   #119 <Method String StringBuilder.toString()>
	//   20   38:invokeinterface #125 <Method void Logger.d(String, String)>
		file.delete();
	//   21   43:aload_0         
	//   22   44:getfield        #30  <Field File file>
	//   23   47:invokevirtual   #129 <Method boolean File.delete()>
	//   24   50:pop             
	//   25   51:return          
	}
