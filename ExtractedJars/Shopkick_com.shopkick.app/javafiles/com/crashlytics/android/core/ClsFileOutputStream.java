...
class ClsFileOutputStream extends FileOutputStream
{
	...
	//*  55   97:aload_0         
	//*  56   98:getfield        #65  <Field File inProgress>
	//*  57  101:invokevirtual   #88  <Method boolean File.exists()>
	//*  58  104:ifne            113
				obj = " (source does not exist)";
	//   59  107:ldc1            #90  <String " (source does not exist)">
	//   60  109:astore_2        
		} else
	//*  61  110:goto            113
	//*  62  113:new             #34  <Class StringBuilder>
	//*  63  116:dup             
	//*  64  117:invokespecial   #35  <Method void StringBuilder()>
	//*  65  120:astore          4
	//*  66  122:aload           4
	//*  67  124:ldc1            #92  <String "Could not rename temp file: ">
	//*  68  126:invokevirtual   #39  <Method StringBuilder StringBuilder.append(String)>
	//*  69  129:pop             
	//*  70  130:aload           4
	//*  71  132:aload_0         
	//*  72  133:getfield        #65  <Field File inProgress>
	//*  73  136:invokevirtual   #55  <Method StringBuilder StringBuilder.append(Object)>
	//*  74  139:pop             
	//*  75  140:aload           4
	//*  76  142:ldc1            #94  <String " -> ">
	//*  77  144:invokevirtual   #39  <Method StringBuilder StringBuilder.append(String)>
	//*  78  147:pop             
	//*  79  148:aload           4
	//*  80  150:aload_3         
	//*  81  151:invokevirtual   #55  <Method StringBuilder StringBuilder.append(Object)>
	//*  82  154:pop             
	//*  83  155:aload           4
	//*  84  157:aload_2         
	//*  85  158:invokevirtual   #39  <Method StringBuilder StringBuilder.append(String)>
	//*  86  161:pop             
	//*  87  162:new             #71  <Class IOException>
	//*  88  165:dup             
	//*  89  166:aload           4
	//*  90  168:invokevirtual   #45  <Method String StringBuilder.toString()>
	//*  91  171:invokespecial   #95  <Method void IOException(String)>
	//*  92  174:athrow          
	//*  93  175:astore_2        
	//*  94  176:aload_0         
	//*  95  177:monitorexit     
	...
	//   98  180:ldc1            #97  <String " (target already exists)">
	//   99  182:astore_2        
		}
