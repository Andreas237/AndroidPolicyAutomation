...
class CrashlyticsBackgroundWorker
{
	...
	//*  18   48:areturn         
	//*  19   49:astore_1        
	//*  20   50:invokestatic    #35  <Method Logger Fabric.getLogger()>
	//*  21   53:ldc1            #37  <String "CrashlyticsCore">
	//*  22   55:ldc1            #86  <String "Failed to execute task.">
	//*  23   57:aload_1         
	//*  24   58:invokeinterface #90  <Method void Logger.e(String, String, Throwable)>
	//*  25   63:aconst_null     
	//*  26   64:areturn         
	//*  27   65:invokestatic    #35  <Method Logger Fabric.getLogger()>
	//*  28   68:ldc1            #37  <String "CrashlyticsCore">
	//*  29   70:ldc1            #39  <String "Executor is shut down because we're handling a fatal crash.">
	//*  30   72:invokeinterface #45  <Method void Logger.d(String, String)>
	//*  31   77:aconst_null     
	//*  32   78:areturn         
		// Misplaced declaration of an exception variable
