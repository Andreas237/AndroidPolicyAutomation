...
class CrashlyticsController$20$1 extends HashMap
{

	final CrashlyticsController._cls20 this$1;

	CrashlyticsController$20$1()
	{
	...
	//    4    6:invokespecial   #19  <Method void HashMap()>
		put("app_identifier", ((Object) (val$appIdentifier)));
	//    5    9:aload_0         
	...
	//   20   42:pop             
		put("version_code", ((Object) (val$versionCode)));
	//   21   43:aload_0         
	...
	//   27   56:pop             
		put("version_name", ((Object) (val$versionName)));
	//   28   57:aload_0         
	...
	//   34   70:pop             
		put("install_uuid", ((Object) (val$installUuid)));
	//   35   71:aload_0         
	...
	//   41   84:pop             
		put("delivery_mechanism", ((Object) (Integer.valueOf(val$deliveryMechanism))));
	//   42   85:aload_0         
	...
	// Unreferenced inner class com/crashlytics/android/core/CrashlyticsController$20

/* anonymous class */
	class CrashlyticsController._cls20
		implements CrashlyticsController.FileOutputStreamWriteAction
	{
		...
		public void writeTo(FileOutputStream fileoutputstream)
			throws Exception
		{
			fileoutputstream.write((new JSONObject(((java.util.Map) (new CrashlyticsController._cls20._cls1())))).toString().getBytes());
		//    0    0:aload_1         
		...
		//    7   13:invokespecial   #52  <Method void JSONObject(java.util.Map)>
