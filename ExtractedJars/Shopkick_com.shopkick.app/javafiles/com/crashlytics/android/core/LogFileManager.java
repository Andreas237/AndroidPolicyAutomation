...
class LogFileManager
{
	...
	//   13   20:bipush          20
	//   14   22:iload_2         
	//   15   23:invokevirtual   #76  <Method String String.substring(int, int)>
	//   16   26:areturn         
	}
	...
	//   16   28:aload_2         
	//   17   29:invokevirtual   #88  <Method String StringBuilder.toString()>
	//   18   32:astore_1        
	...
	//   23   41:invokeinterface #92  <Method File LogFileManager$DirectoryProvider.getLogFileDir()>
	//   24   46:aload_1         
	//   25   47:invokespecial   #95  <Method void File(File, String)>
	//   26   50:areturn         
	}
	...
	//    2    4:invokeinterface #101 <Method void FileLogStore.deleteLogFile()>
	//    3    9:return          
	}
	...
	//    2    4:invokeinterface #92  <Method File LogFileManager$DirectoryProvider.getLogFileDir()>
	//    3    9:invokevirtual   #107 <Method File[] File.listFiles()>
	//    4   12:astore          4
		if(afile != null)
	//*   5   14:aload           4
	//*   6   16:ifnull          64
	...
	//*  20   37:aload_0         
	//*  21   38:aload           5
	//*  22   40:invokespecial   #109 <Method String getSessionIdForFile(File)>
	//*  23   43:invokeinterface #115 <Method boolean Set.contains(Object)>
	//*  24   48:ifne            57
					file.delete();
	//   25   51:aload           5
	//   26   53:invokevirtual   #119 <Method boolean File.delete()>
	//   27   56:pop             
			}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #54  <Field FileLogStore currentLog>
	//    2    4:invokeinterface #126 <Method ByteString FileLogStore.getLogAsByteString()>
	//    3    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #54  <Field FileLogStore currentLog>
	//    2    4:invokeinterface #131 <Method byte[] FileLogStore.getLogAsBytes()>
	//    3    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #54  <Field FileLogStore currentLog>
	//    2    4:invokeinterface #134 <Method void FileLogStore.closeLogFile()>
		currentLog = ((FileLogStore) (NOOP_LOG_STORE));
	//    3    9:aload_0         
	...
	//*  12   27:iconst_1        
	//*  13   28:invokestatic    #140 <Method boolean CommonUtils.getBooleanResourceValue(Context, String, boolean)>
	//*  14   31:ifne            47
		{
			Fabric.getLogger().d("CrashlyticsCore", "Preferences requested no custom logs. Aborting log file creation.");
	//   15   34:invokestatic    #146 <Method Logger Fabric.getLogger()>
	//   16   37:ldc1            #148 <String "CrashlyticsCore">
	//   17   39:ldc1            #150 <String "Preferences requested no custom logs. Aborting log file creation.">
	//   18   41:invokeinterface #156 <Method void Logger.d(String, String)>
			return;
	//   19   46:return          
		} else
		{
	...
	//   21   48:aload_0         
	//   22   49:aload_1         
	//   23   50:invokespecial   #158 <Method File getWorkingFileForSession(String)>
	//   24   53:ldc1            #25  <Int 0x10000>
	//   25   55:invokevirtual   #162 <Method void setLogFile(File, int)>
			return;
	//   26   58:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #164 <Class QueueFileLogStore>
	//    2    4:dup             
	//    3    5:aload_1         
	//    4    6:iload_2         
	//    5    7:invokespecial   #166 <Method void QueueFileLogStore(File, int)>
	//    6   10:putfield        #54  <Field FileLogStore currentLog>
	//    7   13:return          
	}

	void writeToLog(long l, String s)
	{
	...
	//    2    4:lload_1         
	//    3    5:aload_3         
	//    4    6:invokeinterface #170 <Method void FileLogStore.writeToLog(long, String)>
	//    5   11:return          
	}
