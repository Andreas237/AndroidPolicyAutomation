...
class MetaDataStore
{
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #57  <Method void JSONObject(String)>
	//    4    8:astore_0        
		HashMap hashmap = new HashMap();
	//    5    9:new             #59  <Class HashMap>
	//    6   12:dup             
	//    7   13:invokespecial   #60  <Method void HashMap()>
	//    8   16:astore_1        
		String s1;
		for(Iterator iterator = ((JSONObject) (s)).keys(); iterator.hasNext(); ((Map) (hashmap)).put(((Object) (s1)), ((Object) (valueOrNull(((JSONObject) (s)), s1)))))
	//*   9   17:aload_0         
	//*  10   18:invokevirtual   #63  <Method Iterator JSONObject.keys()>
	//*  11   21:astore_2        
	//*  12   22:aload_2         
	//*  13   23:invokeinterface #69  <Method boolean Iterator.hasNext()>
	//*  14   28:ifeq            57
			s1 = (String)iterator.next();
	//   15   31:aload_2         
	//   16   32:invokeinterface #73  <Method Object Iterator.next()>
	//   17   37:checkcast       #75  <Class String>
	//   18   40:astore_3        
	...
	//   21   43:aload_0         
	//   22   44:aload_3         
	//   23   45:invokestatic    #79  <Method String valueOrNull(JSONObject, String)>
	//   24   48:invokeinterface #85  <Method Object Map.put(Object, Object)>
	//   25   53:pop             
	//*  26   54:goto            22
		return ((Map) (hashmap));
	//   27   57:aload_1         
	...
	//    5    9:new             #92  <Class UserMetaData>
	//    6   12:dup             
	//    7   13:aload_0         
	//    8   14:ldc1            #16  <String "userId">
	//    9   16:invokestatic    #79  <Method String valueOrNull(JSONObject, String)>
	//   10   19:aload_0         
	//   11   20:ldc1            #19  <String "userName">
	//   12   22:invokestatic    #79  <Method String valueOrNull(JSONObject, String)>
	//   13   25:aload_0         
	//   14   26:ldc1            #13  <String "userEmail">
	//   15   28:invokestatic    #79  <Method String valueOrNull(JSONObject, String)>
	//   16   31:invokespecial   #95  <Method void UserMetaData(String, String, String)>
	//   17   34:areturn         
	}
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #100 <Method void JSONObject(Map)>
	//    4    8:invokevirtual   #104 <Method String JSONObject.toString()>
	//    5   11:areturn         
	}
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #110 <Method void MetaDataStore$1(UserMetaData)>
	//    4    8:invokevirtual   #111 <Method String MetaDataStore$1.toString()>
	//    5   11:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #115 <Method boolean JSONObject.isNull(String)>
	//    3    5:istore_2        
		String s1 = null;
	//    4    6:aconst_null     
	//    5    7:astore_3        
	...
	//    9   13:aload_1         
	//   10   14:aconst_null     
	//   11   15:invokevirtual   #119 <Method String JSONObject.optString(String, String)>
	//   12   18:astore_3        
		return s1;
	//   13   19:aload_3         
	//   14   20:areturn         
	...
	//    3    5:new             #123 <Class StringBuilder>
	//    4    8:dup             
	//    5    9:invokespecial   #124 <Method void StringBuilder()>
	//    6   12:astore_3        
		stringbuilder.append(s);
	//    7   13:aload_3         
	//    8   14:aload_1         
	//    9   15:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   10   18:pop             
		stringbuilder.append("keys");
	//   11   19:aload_3         
	//   12   20:ldc1            #10  <String "keys">
	//   13   22:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   14   25:pop             
		stringbuilder.append(".meta");
	//   15   26:aload_3         
	//   16   27:ldc1            #22  <String ".meta">
	//   17   29:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   18   32:pop             
		return new File(file, stringbuilder.toString());
	//   19   33:new             #130 <Class File>
	//   20   36:dup             
	//   21   37:aload_2         
	//   22   38:aload_3         
	//   23   39:invokevirtual   #131 <Method String StringBuilder.toString()>
	//   24   42:invokespecial   #134 <Method void File(File, String)>
	//   25   45:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #140 <Method File getKeysFileForSession(String)>
	//    3    5:astore_2        
		if(!((File) (obj)).exists())
	//*   4    6:aload_2         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #186 <Method File getUserDataFileForSession(String)>
	//    3    5:astore_2        
		if(!((File) (obj)).exists())
	//*   4    6:aload_2         
	//*   5    7:invokevirtual   #143 <Method boolean File.exists()>
