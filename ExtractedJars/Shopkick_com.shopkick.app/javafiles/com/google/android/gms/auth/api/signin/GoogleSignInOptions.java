	...
	implements com.google.android.gms.common.api.Api.ApiOptions.Optional, ReflectedParcelable
{
	public static final class Builder
	{
		...
		//    7   15:aload_2         
		//    8   16:invokestatic    #208 <Method List Arrays.asList(Object[])>
		...
		//   49   99:invokestatic    #91  <Method Map GoogleSignInOptions.zab(List)>
	...
	//    0    0:new             #182 <Class HashMap>
	//    1    3:dup             
	//    2    4:invokespecial   #183 <Method void HashMap()>
	//    3    7:astore_1        
		if(list == null)
	//*   4    8:aload_0         
	//*   5    9:ifnonnull       14
	...
	//*   8   14:aload_0         
	//*   9   15:invokeinterface #189 <Method Iterator List.iterator()>
	//*  10   20:astore_0        
	//*  11   21:aload_0         
	//*  12   22:invokeinterface #195 <Method boolean Iterator.hasNext()>
	//*  13   27:ifeq            58
			googlesigninoptionsextensionparcelable = (GoogleSignInOptionsExtensionParcelable)((Iterator) (list)).next();
	//   14   30:aload_0         
	//   15   31:invokeinterface #199 <Method Object Iterator.next()>
	//   16   36:checkcast       #201 <Class GoogleSignInOptionsExtensionParcelable>
	//   17   39:astore_2        

	//   18   40:aload_1         
	//   19   41:aload_2         
	//   20   42:invokevirtual   #205 <Method int GoogleSignInOptionsExtensionParcelable.getType()>
	//   21   45:invokestatic    #211 <Method Integer Integer.valueOf(int)>
	//   22   48:aload_2         
	//   23   49:invokeinterface #215 <Method Object Map.put(Object, Object)>
	//   24   54:pop             
	//*  25   55:goto            21
		return ((Map) (hashmap));
	//   26   58:aload_1         
	...
	//*   0    0:aload_0         
	//*   1    1:invokestatic    #226 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*   2    4:ifeq            9
			return null;
	//    3    7:aconst_null     
	//    4    8:areturn         
		JSONObject jsonobject = new JSONObject(s);
	//    5    9:new             #228 <Class JSONObject>
	//    6   12:dup             
	//    7   13:aload_0         
	//    8   14:invokespecial   #229 <Method void JSONObject(String)>
	//    9   17:astore_3        
		HashSet hashset = new HashSet();
	//   10   18:new             #231 <Class HashSet>
	//   11   21:dup             
	//   12   22:invokespecial   #232 <Method void HashSet()>
	//   13   25:astore          4
		s = ((String) (jsonobject.getJSONArray("scopes")));
	//   14   27:aload_3         
	//   15   28:ldc1            #234 <String "scopes">
	//   16   30:invokevirtual   #238 <Method JSONArray JSONObject.getJSONArray(String)>
	//   17   33:astore_0        
		int j = ((JSONArray) (s)).length();
	//   18   34:aload_0         
	//   19   35:invokevirtual   #243 <Method int JSONArray.length()>
	//   20   38:istore_2        
		for(int i = 0; i < j; i++)
	//*  21   39:iconst_0        
	//*  22   40:istore_1        
	...
	//   29   52:aload_0         
	//   30   53:iload_1         
	//   31   54:invokevirtual   #247 <Method String JSONArray.getString(int)>
	//   32   57:invokespecial   #80  <Method void Scope(String)>
	//   33   60:invokeinterface #253 <Method boolean Set.add(Object)>
	//   34   65:pop             
	...
	//   40   73:aload_3         
	//   41   74:ldc1            #255 <String "accountName">
	//   42   76:aconst_null     
	//   43   77:invokevirtual   #259 <Method String JSONObject.optString(String, String)>
	//   44   80:astore_0        
		if(!TextUtils.isEmpty(((CharSequence) (s))))
	//*  45   81:aload_0         
	//*  46   82:invokestatic    #226 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  47   85:ifne            103
			s = ((String) (new Account(s, "com.google")));
	//   48   88:new             #261 <Class Account>
	//   49   91:dup             
	//   50   92:aload_0         
	//   51   93:ldc2            #263 <String "com.google">
	//   52   96:invokespecial   #266 <Method void Account(String, String)>
	//   53   99:astore_0        
		else
	//*  54  100:goto            105
			s = null;
	...
	//   64  119:aload_0         
	//   65  120:aload_3         
	//   66  121:ldc2            #268 <String "idTokenRequested">
	//   67  124:invokevirtual   #272 <Method boolean JSONObject.getBoolean(String)>
	//   68  127:aload_3         
	//   69  128:ldc2            #274 <String "serverAuthRequested">
	//   70  131:invokevirtual   #272 <Method boolean JSONObject.getBoolean(String)>
	//   71  134:aload_3         
	//   72  135:ldc2            #276 <String "forceCodeForRefreshToken">
	//   73  138:invokevirtual   #272 <Method boolean JSONObject.getBoolean(String)>
	//   74  141:aload_3         
	//   75  142:ldc2            #278 <String "serverClientId">
	//   76  145:aconst_null     
	//   77  146:invokevirtual   #259 <Method String JSONObject.optString(String, String)>
	//   78  149:aload_3         
	//   79  150:ldc2            #280 <String "hostedDomain">
	//   80  153:aconst_null     
	//   81  154:invokevirtual   #259 <Method String JSONObject.optString(String, String)>
	//   82  157:new             #182 <Class HashMap>
	//   83  160:dup             
	//   84  161:invokespecial   #183 <Method void HashMap()>
	...
	//    0    0:new             #228 <Class JSONObject>
	//    1    3:dup             
	//    2    4:invokespecial   #286 <Method void JSONObject()>
	//    3    7:astore_3        
		int i;
		int j;
		JSONArray jsonarray;
	...
	//    5   11:dup             
	//    6   12:invokespecial   #287 <Method void JSONArray()>
	//    7   15:astore          4
			Collections.sort(((List) (zaw)), zaaf);
	//    8   17:aload_0         
	//    9   18:getfield        #149 <Field ArrayList zaw>
	//   10   21:getstatic       #129 <Field Comparator zaaf>
	//   11   24:invokestatic    #293 <Method void Collections.sort(List, Comparator)>
	...
	//   15   34:astore          5
			j = arraylist.size();
	//   16   36:aload           5
	//   17   38:invokevirtual   #296 <Method int ArrayList.size()>
	//   18   41:istore_2        
		}
	//*  19   42:iconst_0        
	//*  20   43:istore_1        
	...
	//*  24   49:aload           5
	//*  25   51:iload_1         
	//*  26   52:invokevirtual   #300 <Method Object ArrayList.get(int)>
	//*  27   55:astore          6
	//*  28   57:iload_1         
	//*  29   58:iconst_1        
	//*  30   59:iadd            
	...
	//*  35   68:invokevirtual   #304 <Method String Scope.getScopeUri()>
	//*  36   71:invokevirtual   #307 <Method JSONArray JSONArray.put(Object)>
	//*  37   74:pop             
	//*  38   75:goto            44
	//*  39   78:aload_3         
	//*  40   79:ldc1            #234 <String "scopes">
	//*  41   81:aload           4
	//*  42   83:invokevirtual   #310 <Method JSONObject JSONObject.put(String, Object)>
	//*  43   86:pop             
	//*  44   87:aload_0         
	//*  45   88:getfield        #151 <Field Account zax>
	//*  46   91:ifnull          108
	//*  47   94:aload_3         
	//*  48   95:ldc1            #255 <String "accountName">
	//*  49   97:aload_0         
	//*  50   98:getfield        #151 <Field Account zax>
	//*  51  101:getfield        #313 <Field String Account.name>
	//*  52  104:invokevirtual   #310 <Method JSONObject JSONObject.put(String, Object)>
	//*  53  107:pop             
	//*  54  108:aload_3         
	//*  55  109:ldc2            #268 <String "idTokenRequested">
	//*  56  112:aload_0         
	//*  57  113:getfield        #153 <Field boolean zay>
	//*  58  116:invokevirtual   #316 <Method JSONObject JSONObject.put(String, boolean)>
	//*  59  119:pop             
	//*  60  120:aload_3         
	//*  61  121:ldc2            #276 <String "forceCodeForRefreshToken">
	//*  62  124:aload_0         
	//*  63  125:getfield        #157 <Field boolean zaaa>
	//*  64  128:invokevirtual   #316 <Method JSONObject JSONObject.put(String, boolean)>
	//*  65  131:pop             
	//*  66  132:aload_3         
	//*  67  133:ldc2            #274 <String "serverAuthRequested">
	//*  68  136:aload_0         
	//*  69  137:getfield        #155 <Field boolean zaz>
	//*  70  140:invokevirtual   #316 <Method JSONObject JSONObject.put(String, boolean)>
	//*  71  143:pop             
	//*  72  144:aload_0         
	//*  73  145:getfield        #159 <Field String zaab>
	//*  74  148:invokestatic    #226 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  75  151:ifne            166
	//*  76  154:aload_3         
	//*  77  155:ldc2            #278 <String "serverClientId">
	//*  78  158:aload_0         
	//*  79  159:getfield        #159 <Field String zaab>
	//*  80  162:invokevirtual   #310 <Method JSONObject JSONObject.put(String, Object)>
	//*  81  165:pop             
	//*  82  166:aload_0         
	//*  83  167:getfield        #161 <Field String zaac>
	//*  84  170:invokestatic    #226 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  85  173:ifne            188
	//*  86  176:aload_3         
	//*  87  177:ldc2            #280 <String "hostedDomain">
	//*  88  180:aload_0         
	//*  89  181:getfield        #161 <Field String zaac>
	//*  90  184:invokevirtual   #310 <Method JSONObject JSONObject.put(String, Object)>
	//*  91  187:pop             
	//*  92  188:aload_3         
	//*  93  189:areturn         
	...
	//   95  191:new             #318 <Class RuntimeException>
	//   96  194:dup             
	//   97  195:aload_3         
	//   98  196:invokespecial   #321 <Method void RuntimeException(Throwable)>
	//   99  199:athrow          
		}
		i = 0;
		if(i >= j)
	...
	//    9   15:invokevirtual   #296 <Method int ArrayList.size()>
	//   10   18:ifgt            177
		if(((GoogleSignInOptions) (obj)).zaad.size() > 0)
	//*  11   21:aload_1         
	//*  12   22:getfield        #174 <Field ArrayList zaad>
	//*  13   25:invokevirtual   #296 <Method int ArrayList.size()>
	//*  14   28:ifle            33
			return false;
	//   15   31:iconst_0        
	//   16   32:ireturn         
	...
	//   19   37:invokevirtual   #296 <Method int ArrayList.size()>
	//   20   40:aload_1         
	//   21   41:invokevirtual   #333 <Method ArrayList getScopes()>
	//   22   44:invokevirtual   #296 <Method int ArrayList.size()>
	//   23   47:icmpne          175
		if(!zaw.containsAll(((java.util.Collection) (((GoogleSignInOptions) (obj)).getScopes()))))
	//*  24   50:aload_0         
	//*  25   51:getfield        #149 <Field ArrayList zaw>
	//*  26   54:aload_1         
	//*  27   55:invokevirtual   #333 <Method ArrayList getScopes()>
	//*  28   58:invokevirtual   #337 <Method boolean ArrayList.containsAll(java.util.Collection)>
	//*  29   61:ifne            66
			return false;
	//   30   64:iconst_0        
	//   31   65:ireturn         
	...
	//*  35   73:aload_1         
	//*  36   74:invokevirtual   #340 <Method Account getAccount()>
	//*  37   77:ifnonnull       173
	...
	//*  41   87:aload_1         
	//*  42   88:invokevirtual   #340 <Method Account getAccount()>
	//*  43   91:invokevirtual   #342 <Method boolean Account.equals(Object)>
	//*  44   94:ifeq            173
	//*  45   97:aload_0         
	//*  46   98:getfield        #159 <Field String zaab>
	//*  47  101:invokestatic    #226 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  48  104:ifeq            120
	//*  49  107:aload_1         
	//*  50  108:invokevirtual   #344 <Method String getServerClientId()>
	//*  51  111:invokestatic    #226 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  52  114:ifeq            173
	//*  53  117:goto            134
	//*  54  120:aload_0         
	//*  55  121:getfield        #159 <Field String zaab>
	//*  56  124:aload_1         
	//*  57  125:invokevirtual   #344 <Method String getServerClientId()>
	//*  58  128:invokevirtual   #347 <Method boolean String.equals(Object)>
	//*  59  131:ifeq            173
	//*  60  134:aload_0         
	//*  61  135:getfield        #157 <Field boolean zaaa>
	//*  62  138:aload_1         
	//*  63  139:invokevirtual   #349 <Method boolean isForceCodeForRefreshToken()>
	//*  64  142:icmpne          173
	//*  65  145:aload_0         
	//*  66  146:getfield        #153 <Field boolean zay>
	//*  67  149:aload_1         
	//*  68  150:invokevirtual   #351 <Method boolean isIdTokenRequested()>
	//*  69  153:icmpne          173
	//*  70  156:aload_0         
	//*  71  157:getfield        #155 <Field boolean zaz>
	//*  72  160:istore_2        
	//*  73  161:aload_1         
	//*  74  162:invokevirtual   #353 <Method boolean isServerAuthCodeRequested()>
	//*  75  165:istore_3        
	//*  76  166:iload_2         
	//*  77  167:iload_3         
	//*  78  168:icmpne          173
	...
	//    3    5:aload_1         
	//    4    6:aload_1         
	//    5    7:invokevirtual   #296 <Method int ArrayList.size()>
	//    6   10:anewarray       Scope[]
	//    7   13:invokevirtual   #361 <Method Object[] ArrayList.toArray(Object[])>
	//    8   16:checkcast       #363 <Class Scope[]>
	//    9   19:areturn         
	}
	...
	//    0    0:new             #163 <Class ArrayList>
	//    1    3:dup             
	//    2    4:invokespecial   #366 <Method void ArrayList()>
	//    3    7:astore_3        
	...
	//    8   17:aload           4
	//    9   19:invokevirtual   #296 <Method int ArrayList.size()>
	//   10   22:istore_2        
		for(int i = 0; i < j;)
	//*  11   23:iconst_0        
	//*  12   24:istore_1        
	...
	//   16   30:aload           4
	//   17   32:iload_1         
	//   18   33:invokevirtual   #300 <Method Object ArrayList.get(int)>
	//   19   36:astore          5
			i++;
	//   20   38:iload_1         
	//   21   39:iconst_1        
	...
	//   27   48:invokevirtual   #304 <Method String Scope.getScopeUri()>
	//   28   51:invokevirtual   #367 <Method boolean ArrayList.add(Object)>
	//   29   54:pop             
		}
	...
	//   31   58:aload_3         
	//   32   59:invokestatic    #370 <Method void Collections.sort(List)>
	...
	//   33   62:new             #372 <Class HashAccumulator>
	//   34   65:dup             
	//   35   66:invokespecial   #373 <Method void HashAccumulator()>
	//   36   69:aload_3         
	//   37   70:invokevirtual   #377 <Method HashAccumulator HashAccumulator.addObject(Object)>
	//   38   73:aload_0         
	//   39   74:getfield        #151 <Field Account zax>
	//   40   77:invokevirtual   #377 <Method HashAccumulator HashAccumulator.addObject(Object)>
	//   41   80:aload_0         
	//   42   81:getfield        #159 <Field String zaab>
	//   43   84:invokevirtual   #377 <Method HashAccumulator HashAccumulator.addObject(Object)>
	//   44   87:aload_0         
	//   45   88:getfield        #157 <Field boolean zaaa>
	//   46   91:invokevirtual   #380 <Method HashAccumulator HashAccumulator.zaa(boolean)>
	//   47   94:aload_0         
	//   48   95:getfield        #153 <Field boolean zay>
	//   49   98:invokevirtual   #380 <Method HashAccumulator HashAccumulator.zaa(boolean)>
	//   50  101:aload_0         
	//   51  102:getfield        #155 <Field boolean zaz>
	//   52  105:invokevirtual   #380 <Method HashAccumulator HashAccumulator.zaa(boolean)>
	//   53  108:invokevirtual   #383 <Method int HashAccumulator.hash()>
	//   54  111:ireturn         
	}
	...
	//    9   15:iconst_2        
	//   10   16:aload_0         
	//   11   17:invokevirtual   #333 <Method ArrayList getScopes()>
	//   12   20:iconst_0        
	//   13   21:invokestatic    #399 <Method void SafeParcelWriter.writeTypedList(Parcel, int, List, boolean)>
		SafeParcelWriter.writeParcelable(parcel, 3, ((android.os.Parcelable) (getAccount())), i, false);
	//   14   24:aload_1         
	//   15   25:iconst_3        
	//   16   26:aload_0         
	//   17   27:invokevirtual   #340 <Method Account getAccount()>
	//   18   30:iload_2         
	//   19   31:iconst_0        
	//   20   32:invokestatic    #403 <Method void SafeParcelWriter.writeParcelable(Parcel, int, android.os.Parcelable, int, boolean)>
		SafeParcelWriter.writeBoolean(parcel, 4, isIdTokenRequested());
	//   21   35:aload_1         
	//   22   36:iconst_4        
	//   23   37:aload_0         
	//   24   38:invokevirtual   #351 <Method boolean isIdTokenRequested()>
	//   25   41:invokestatic    #407 <Method void SafeParcelWriter.writeBoolean(Parcel, int, boolean)>
		SafeParcelWriter.writeBoolean(parcel, 5, isServerAuthCodeRequested());
	//   26   44:aload_1         
	//   27   45:iconst_5        
	//   28   46:aload_0         
	//   29   47:invokevirtual   #353 <Method boolean isServerAuthCodeRequested()>
	//   30   50:invokestatic    #407 <Method void SafeParcelWriter.writeBoolean(Parcel, int, boolean)>
		SafeParcelWriter.writeBoolean(parcel, 6, isForceCodeForRefreshToken());
	//   31   53:aload_1         
	//   32   54:bipush          6
	//   33   56:aload_0         
	//   34   57:invokevirtual   #349 <Method boolean isForceCodeForRefreshToken()>
	//   35   60:invokestatic    #407 <Method void SafeParcelWriter.writeBoolean(Parcel, int, boolean)>
		SafeParcelWriter.writeString(parcel, 7, getServerClientId(), false);
	//   36   63:aload_1         
	//   37   64:bipush          7
	//   38   66:aload_0         
	//   39   67:invokevirtual   #344 <Method String getServerClientId()>
	//   40   70:iconst_0        
	//   41   71:invokestatic    #411 <Method void SafeParcelWriter.writeString(Parcel, int, String, boolean)>
	...
	//   46   81:iconst_0        
	//   47   82:invokestatic    #411 <Method void SafeParcelWriter.writeString(Parcel, int, String, boolean)>
		SafeParcelWriter.writeTypedList(parcel, 9, ((List) (getExtensions())), false);
	//   48   85:aload_1         
	//   49   86:bipush          9
	//   50   88:aload_0         
	//   51   89:invokevirtual   #413 <Method ArrayList getExtensions()>
	//   52   92:iconst_0        
	//   53   93:invokestatic    #399 <Method void SafeParcelWriter.writeTypedList(Parcel, int, List, boolean)>
		SafeParcelWriter.finishObjectHeader(parcel, j);
	//   54   96:aload_1         
	//   55   97:iload_3         
	//   56   98:invokestatic    #416 <Method void SafeParcelWriter.finishObjectHeader(Parcel, int)>
	//   57  101:return          
	}
	...
	public final String zae()
	{
		return zad().toString();
	//    0    0:aload_0         
	//    1    1:invokespecial   #418 <Method JSONObject zad()>
	//    2    4:invokevirtual   #421 <Method String JSONObject.toString()>
	//    3    7:areturn         
	}
