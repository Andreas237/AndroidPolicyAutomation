...
public class ProxyResponse extends AbstractSafeParcelable
{
	...
	//   11   20:aload_0         
	//   12   21:aload           5
	//   13   23:putfield        #54  <Field Bundle zzby>
		body = abyte0;
	//   14   26:aload_0         
	//   15   27:aload           6
	...
	{
		this(i, zza(map), abyte0);
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:aload_2         
	//    3    3:invokestatic    #69  <Method Bundle zza(Map)>
	//    4    6:aload_3         
	...
	{
		return new ProxyResponse(1, i, pendingintent, j, zza(map), abyte0);
	...
	//    5    7:iload_2         
	//    6    8:aload_3         
	//    7    9:invokestatic    #69  <Method Bundle zza(Map)>
	//    8   12:aload           4
	...
	public Map getHeaders()
	{
		if(zzby == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #54  <Field Bundle zzby>
	//*   2    4:ifnonnull       11
	...
	//    8   18:astore_1        
		String s;
		for(Iterator iterator = zzby.keySet().iterator(); iterator.hasNext(); ((Map) (hashmap)).put(((Object) (s)), ((Object) (zzby.getString(s)))))
	//*   9   19:aload_0         
	//*  10   20:getfield        #54  <Field Bundle zzby>
	...
	//   22   52:aload_3         
	//   23   53:aload_0         
	//   24   54:getfield        #54  <Field Bundle zzby>
	//   25   57:aload_3         
	...
	//   19   31:invokestatic    #150 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeBundle(parcel, 4, zzby, false);
	//   20   34:aload_1         
	//   21   35:iconst_4        
	//   22   36:aload_0         
	//   23   37:getfield        #54  <Field Bundle zzby>
	//   24   40:iconst_0        
