	...
	implements ReflectedParcelable
{
	...
	//    1    1:invokespecial   #44  <Method void AbstractSafeParcelable()>
		zzbb = googlesigninaccount;
	//    2    4:aload_0         
	//    3    5:aload_2         
	//    4    6:putfield        #46  <Field GoogleSignInAccount zzbb>
		zzba = Preconditions.checkNotEmpty(s, "8.3 and 8.4 SDKs require non-null email");
	//    5    9:aload_0         
	//    6   10:aload_1         
	...
	//    9   16:putfield        #56  <Field String zzba>
		zzbc = Preconditions.checkNotEmpty(s1, "8.3 and 8.4 SDKs require non-null userId");
	//   10   19:aload_0         
	//   11   20:aload_3         
	...
	//   14   26:putfield        #60  <Field String zzbc>
	//   15   29:return          
	}
	...
	public final GoogleSignInAccount getGoogleSignInAccount()
	{
		return zzbb;
	//    0    0:aload_0         
	//    1    1:getfield        #46  <Field GoogleSignInAccount zzbb>
	//    2    4:areturn         
	}
	...
	//    2    4:istore_3        
		SafeParcelWriter.writeString(parcel, 4, zzba, false);
	//    3    5:aload_1         
	//    4    6:iconst_4        
	//    5    7:aload_0         
	//    6    8:getfield        #56  <Field String zzba>
	//    7   11:iconst_0        
	//    8   12:invokestatic    #77  <Method void SafeParcelWriter.writeString(Parcel, int, String, boolean)>
		SafeParcelWriter.writeParcelable(parcel, 7, ((android.os.Parcelable) (zzbb)), i, false);
	//    9   15:aload_1         
	//   10   16:bipush          7
	//   11   18:aload_0         
	//   12   19:getfield        #46  <Field GoogleSignInAccount zzbb>
	//   13   22:iload_2         
	//   14   23:iconst_0        
	//   15   24:invokestatic    #81  <Method void SafeParcelWriter.writeParcelable(Parcel, int, android.os.Parcelable, int, boolean)>
		SafeParcelWriter.writeString(parcel, 8, zzbc, false);
	//   16   27:aload_1         
	//   17   28:bipush          8
	//   18   30:aload_0         
	//   19   31:getfield        #60  <Field String zzbc>
	//   20   34:iconst_0        
	...
	static 
	{
	//    0    0:new             #34  <Class zzd>
	//    1    3:dup             
	//    2    4:invokespecial   #37  <Method void zzd()>
