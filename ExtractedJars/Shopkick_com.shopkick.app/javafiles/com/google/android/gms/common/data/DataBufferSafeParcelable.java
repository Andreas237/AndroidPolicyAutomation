...
public class DataBufferSafeParcelable extends AbstractDataBuffer
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #25  <Method void AbstractDataBuffer(DataHolder)>
		zalo = creator;
	//    3    5:aload_0         
	//    4    6:aload_2         
	//    5    7:putfield        #27  <Field android.os.Parcelable$Creator zalo>
	//    6   10:return          
	}
	...
	//    0    0:getstatic       #19  <Field String[] zaln>
	...
	//   20   33:invokevirtual   #96  <Method void Parcel.setDataPosition(int)>
		SafeParcelable safeparcelable = (SafeParcelable)zalo.createFromParcel(parcel);
	//   21   36:aload_0         
	//   22   37:getfield        #27  <Field android.os.Parcelable$Creator zalo>
	//   23   40:aload_2         
	...
	private final android.os.Parcelable.Creator zalo;
	...
	//    2    4:dup             
	//    3    5:iconst_0        
	//    4    6:ldc1            #17  <String "data">
	//    5    8:aastore         
	//    6    9:putstatic       #19  <Field String[] zaln>
	//*   7   12:return          
	}
}
