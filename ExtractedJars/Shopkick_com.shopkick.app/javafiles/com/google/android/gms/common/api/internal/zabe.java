	...
	implements zabs, zar
{
	...
	//*  34   72:areturn         
		...
		ConnectionResult connectionresult = zahq;
...
_L3:
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #252 <Method void BasePendingResult.zau()>
		return zahp.enqueue(apimethodimpl);
	//    2    4:aload_0         
	//    3    5:getfield        #108 <Field zabd zahp>
	//    4    8:aload_1         
	//    5    9:invokeinterface #254 <Method BaseImplementation$ApiMethodImpl zabd.enqueue(BaseImplementation$ApiMethodImpl)>
	//    6   14:areturn         
	}
	...
	//    3    5:getfield        #108 <Field zabd zahp>
	//    4    8:aload_1         
	//    5    9:invokeinterface #259 <Method BaseImplementation$ApiMethodImpl zabd.execute(BaseImplementation$ApiMethodImpl)>
	//    6   14:areturn         
	}
	...
	//    5   13:aload_1         
	//    6   14:invokeinterface #283 <Method void zabd.onConnected(Bundle)>
		zaen.unlock();
	//    7   19:aload_0         
	...
	//    4   10:getfield        #108 <Field zabd zahp>
	//    5   13:iload_1         
	//    6   14:invokeinterface #290 <Method void zabd.onConnectionSuspended(int)>
		zaen.unlock();
	//    7   19:aload_0         
	//    8   20:getfield        #56  <Field Lock zaen>
	//    9   23:invokeinterface #286 <Method void Lock.unlock()>
	...
	//    6   14:aload_2         
	//    7   15:iload_3         
	//    8   16:invokeinterface #293 <Method void zabd.zaa(ConnectionResult, Api, boolean)>
		zaen.unlock();
	//    9   21:aload_0         
	...
	//    2    4:iconst_1        
	//    3    5:aload_1         
	//    4    6:invokevirtual   #299 <Method android.os.Message zabg.obtainMessage(int, Object)>
	//    5    9:astore_1        
		zahn.sendMessage(((android.os.Message) (zabf)));
	//    6   10:aload_0         
	//    7   11:getfield        #93  <Field zabg zahn>
	//    8   14:aload_1         
	//    9   15:invokevirtual   #303 <Method boolean zabg.sendMessage(android.os.Message)>
	//   10   18:pop             
	//   11   19:return          
	}
	...
	//   19   39:invokespecial   #307 <Method void zaak(zabe, ClientSettings, Map, GoogleApiAvailabilityLight, com.google.android.gms.common.api.Api$AbstractClientBuilder, Lock, Context)>
	//   20   42:putfield        #108 <Field zabd zahp>
		zahp.begin();
	//   21   45:aload_0         
	//   22   46:getfield        #108 <Field zabd zahp>
	//   23   49:invokeinterface #310 <Method void zabd.begin()>
		zahm.signalAll();
	//   24   54:aload_0         
	//   25   55:getfield        #101 <Field Condition zahm>
	//   26   58:invokeinterface #313 <Method void Condition.signalAll()>
		zaen.unlock();
	//   27   63:aload_0         
	...
	//    5   13:invokevirtual   #320 <Method boolean zaaw.zaaw()>
	//    6   16:pop             
		zahp = ((zabd) (new zaah(this)));
	//    7   17:aload_0         
	//    8   18:new             #271 <Class zaah>
	//    9   21:dup             
	//   10   22:aload_0         
	//   11   23:invokespecial   #321 <Method void zaah(zabe)>
	//   12   26:putfield        #108 <Field zabd zahp>
		zahp.begin();
	//   13   29:aload_0         
	//   14   30:getfield        #108 <Field zabd zahp>
	//   15   33:invokeinterface #310 <Method void zabd.begin()>
		zahm.signalAll();
	//   16   38:aload_0         
	//   17   39:getfield        #101 <Field Condition zahm>
	//   18   42:invokeinterface #313 <Method void Condition.signalAll()>
		zaen.unlock();
	//   19   47:aload_0         
	...
	//   14   30:invokeinterface #310 <Method void zabd.begin()>
		zahm.signalAll();
	//   15   35:aload_0         
	//   16   36:getfield        #101 <Field Condition zahm>
	//   17   39:invokeinterface #313 <Method void Condition.signalAll()>
		zaen.unlock();
	//   18   44:aload_0         
	...
	//    5   11:checkcast       #271 <Class zaah>
	//    6   14:invokevirtual   #327 <Method void zaah.zaam()>
	//    7   17:return          
	}
