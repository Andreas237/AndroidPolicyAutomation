...
label1:
			do
			{
				for(Iterator iterator = ((FastJsonResponse)this).getFieldMappings().values().iterator(); iterator.hasNext();)
	//*  15   25:aload_0         
	...
	//   30   64:ifeq            95
					if(((FastJsonResponse) (obj)).isFieldSet(field))
	//*  31   67:aload_1         
	//*  32   68:aload_3         
	//*  33   69:invokevirtual   #61  <Method boolean FastJsonResponse.isFieldSet(FastJsonResponse$Field)>
	//*  34   72:ifeq            93
					{
						if(!((FastJsonResponse)this).getFieldValue(field).equals(((FastJsonResponse) (obj)).getFieldValue(field)))
	//*  35   75:aload_0         
	//*  36   76:aload_3         
	...
	//   47   95:aload_1         
	//   48   96:aload_3         
	//   49   97:invokevirtual   #61  <Method boolean FastJsonResponse.isFieldSet(FastJsonResponse$Field)>
	//   50  100:ifeq            40
			return false;
	//   51  103:iconst_0        
	//   52  104:ireturn         
