...
public final class Api
{
	...
	public static class zaa extends BaseClientBuilder
	{
	}

	public static final class zab extends AnyClientKey
	{
	}
	...
	//   13   23:aload_0         
	//   14   24:aload_2         
	//   15   25:putfield        #86  <Field Api$AbstractClientBuilder zaau>
	//   16   28:aload_0         
	//   17   29:aconst_null     
	//   18   30:putfield        #88  <Field Api$zaa zaav>
		zaaw = clientkey;
	//   19   33:aload_0         
	//   20   34:aload_3         
	//   21   35:putfield        #90  <Field Api$ClientKey zaaw>
	//   22   38:aload_0         
	//   23   39:aconst_null     
	//   24   40:putfield        #92  <Field Api$zab zaax>
	//   25   43:return          
	}

	public final AnyClientKey getClientKey()
	{
		ClientKey clientkey = zaaw;
	//    0    0:aload_0         
	//    1    1:getfield        #90  <Field Api$ClientKey zaaw>
	//    2    4:astore_1        
		if(clientkey != null)
	//*   3    5:aload_1         
	//*   4    6:ifnull          11
			return ((AnyClientKey) (clientkey));
	//    5    9:aload_1         
	//    6   10:areturn         
		else
			throw new IllegalStateException("This API was constructed with null client keys. This should not be possible.");
	//    7   11:new             #99  <Class IllegalStateException>
	//    8   14:dup             
	//    9   15:ldc1            #101 <String "This API was constructed with null client keys. This should not be possible.">
	//   10   17:invokespecial   #104 <Method void IllegalStateException(String)>
	//   11   20:athrow          
	}
	...
	{
		return ((BaseClientBuilder) (zaau));
	//    0    0:aload_0         
	//    1    1:getfield        #86  <Field Api$AbstractClientBuilder zaau>
	//    2    4:areturn         
	}
	...
	//   10   17:invokestatic    #118 <Method void Preconditions.checkState(boolean, Object)>
		return zaau;
	//   11   20:aload_0         
	//   12   21:getfield        #86  <Field Api$AbstractClientBuilder zaau>
	//   13   24:areturn         
	}

	private final String mName;
	private final AbstractClientBuilder zaau;
	private final zaa zaav = null;
