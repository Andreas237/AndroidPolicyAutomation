	...
	implements com.google.android.gms.common.server.response.FastJsonResponse.FieldConverter
{
	...
	//    2    4:astore_1        
		obj = ((Object) ((String)zapm.get(((Integer) (obj)).intValue())));
	//    3    5:aload_0         
	...
	//    9   19:astore_1        
		if(obj == null && zapl.containsKey("gms_unknown"))
	//*  10   20:aload_1         
	//*  11   21:ifnonnull       39
	//*  12   24:aload_0         
	//*  13   25:getfield        #53  <Field HashMap zapl>
	//*  14   28:ldc1            #109 <String "gms_unknown">
	//*  15   30:invokevirtual   #118 <Method boolean HashMap.containsKey(Object)>
	//*  16   33:ifeq            39
			return ((Object) ("gms_unknown"));
	//   17   36:ldc1            #109 <String "gms_unknown">
	//   18   38:areturn         
		else
			return obj;
	//   19   39:aload_1         
