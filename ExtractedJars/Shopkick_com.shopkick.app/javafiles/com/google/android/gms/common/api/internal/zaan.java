...
label0:
	...
	//    4    8:invokestatic    #32  <Method com.google.android.gms.common.GoogleApiAvailabilityLight zaak.zab(zaak)>
	...
	//*  34   93:checkcast       #72  <Class zaam>
	//*  35   96:invokestatic    #76  <Method boolean zaam.zaa(zaam)>
	//*  36   99:ifne            115
	...
	//   81  193:invokestatic    #95  <Method android.content.Context zaak.zaa(zaak)>
	//   82  196:aload           8
	...
	//  117  260:invokestatic    #95  <Method android.content.Context zaak.zaa(zaak)>
	//  118  263:aload           8
	...
	//  137  296:invokestatic    #108 <Method zabe com.google.android.gms.common.api.internal.zaak.zad(zaak)>
	//  138  299:new             #110 <Class zaao>
	//  139  302:dup             
	//  140  303:aload_0         
	//  141  304:aload_0         
	//  142  305:getfield        #13  <Field zaak zagi>
	//  143  308:aload           6
	//  144  310:invokespecial   #113 <Method void zaao(zaan, zabd, ConnectionResult)>
	//  145  313:invokevirtual   #118 <Method void zabe.zaa(zabf)>
			return;
	//  146  316:return          
		}
		if(zaak.zae(zagi))
	...
	//* 149  321:invokestatic    #122 <Method boolean zaak.zae(zaak)>
	//* 150  324:ifeq            339
			zaak.zaf(zagi).connect();
	//  151  327:aload_0         
	//  152  328:getfield        #13  <Field zaak zagi>
	//  153  331:invokestatic    #126 <Method zad zaak.zaf(zaak)>
	//  154  334:invokeinterface #131 <Method void zad.connect()>
	...
	//* 179  409:invokestatic    #95  <Method android.content.Context zaak.zaa(zaak)>
	//* 180  412:aload           8
	...
	//  185  424:invokestatic    #108 <Method zabe com.google.android.gms.common.api.internal.zaak.zad(zaak)>
	//  186  427:new             #135 <Class zaap>
	//  187  430:dup             
	//  188  431:aload_0         
	//  189  432:aload_0         
	//  190  433:getfield        #13  <Field zaak zagi>
	//  191  436:aload           9
	//  192  438:invokespecial   #138 <Method void zaap(zaan, zabd, com.google.android.gms.common.internal.BaseGmsClient$ConnectionProgressReportCallbacks)>
	//  193  441:invokevirtual   #118 <Method void zabe.zaa(zabf)>
			else
	//* 194  444:goto            355
