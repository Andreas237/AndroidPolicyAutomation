...
public class ProcessUtils
{
	...
	{
		if(zzhe == null)
	//*   0    0:getstatic       #20  <Field String zzhe>
	//*   1    3:ifnonnull       27
		{
			if(zzhf == 0)
	//*   2    6:getstatic       #22  <Field int zzhf>
	//*   3    9:ifne            18
				zzhf = Process.myPid();
	//    4   12:invokestatic    #28  <Method int Process.myPid()>
	//    5   15:putstatic       #22  <Field int zzhf>
			zzhe = zzd(zzhf);
	//    6   18:getstatic       #22  <Field int zzhf>
	//    7   21:invokestatic    #32  <Method String zzd(int)>
	//    8   24:putstatic       #20  <Field String zzhe>
		}
		return zzhe;
	//    9   27:getstatic       #20  <Field String zzhe>
	//   10   30:areturn         
	}
