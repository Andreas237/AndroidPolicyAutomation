...
final class zabb extends zal
{
	...
	zabb(zaaw zaaw1, Looper looper)
	{
		zahg = zaaw1;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #10  <Field zaaw zahg>
		super(looper);
	//    3    5:aload_0         
	//    4    6:aload_2         
	...
	//   24   66:return          
		...
		case 2: // '\002'
			zaaw.zaa(zahg);
	//   25   67:aload_0         
	//   26   68:getfield        #10  <Field zaaw zahg>
	//   27   71:invokestatic    #54  <Method void zaaw.zaa(zaaw)>
			return;
	//   28   74:return          
		...
		case 1: // '\001'
			zaaw.zab(zahg);
	//   29   75:aload_0         
	//   30   76:getfield        #10  <Field zaaw zahg>
	//   31   79:invokestatic    #57  <Method void zaaw.zab(zaaw)>
			return;
	//   32   82:return          
		}
	}
