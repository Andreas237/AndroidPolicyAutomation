...
public final class GoogleServices
{
	...
	//   28   53:iconst_1        
	//   29   54:ixor            
	//   30   55:putfield        #61  <Field boolean zzbc>
		} else
	//*  31   58:goto            69
		{
			zzbc = false;
	//   32   61:aload_0         
	//   33   62:iconst_0        
	//   34   63:putfield        #61  <Field boolean zzbc>
			flag = flag1;
	//   35   66:iload           4
	//   36   68:istore_3        
		}
	...
	//   37   69:aload_0         
	//   38   70:iload_3         
	//   39   71:putfield        #63  <Field boolean zzbb>
	...
	//   63  124:putfield        #94  <Field Status zzba>
			zzaz = null;
	//   64  127:aload_0         
	//   65  128:aconst_null     
	//   66  129:putfield        #96  <Field String zzaz>
			return;
	//   67  132:return          
		} else
		{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #96  <Field String zzaz>
		zzba = Status.RESULT_SUCCESS;
	//    5    9:aload_0         
	//    6   10:getstatic       #99  <Field Status Status.RESULT_SUCCESS>
	//    7   13:putfield        #94  <Field Status zzba>
		zzbb = flag;
	//    8   16:aload_0         
	//    9   17:iload_2         
	//   10   18:putfield        #63  <Field boolean zzbb>
		zzbc = flag ^ true;
	//   11   21:aload_0         
	//   12   22:iload_2         
	//   13   23:iconst_1        
	//   14   24:ixor            
	//   15   25:putfield        #61  <Field boolean zzbc>
	//   16   28:return          
	}
...
label0:
	...
	//*   3    5:monitorenter    
			{
				if(zzay == null)
					break label0;
	//    4    6:getstatic       #105 <Field GoogleServices zzay>
	//    5    9:ifnull          20
				s = ((String) (zzay));
	//    6   12:getstatic       #105 <Field GoogleServices zzay>
	//    7   15:astore_0        
			}
	//    8   16:aload_1         
	//    9   17:monitorexit     
	...
	//*   3    5:monitorenter    
		{
			zzay = null;
	//    4    6:aconst_null     
	//    5    7:putstatic       #105 <Field GoogleServices zzay>
		}
	//    6   10:aload_0         
	//    7   11:monitorexit     
		return;
	...
	//    2    5:getfield        #96  <Field String zzaz>
	//    3    8:areturn         
	}
	...
	//*   7   12:monitorenter    
		{
			if(zzay == null)
	//*   8   13:getstatic       #105 <Field GoogleServices zzay>
	//*   9   16:ifnonnull       30
	...
	//   14   27:putstatic       #105 <Field GoogleServices zzay>
			context = ((Context) (zzay.zzba));
	//   15   30:getstatic       #105 <Field GoogleServices zzay>
	//   16   33:getfield        #94  <Field Status zzba>
	//   17   36:astore_0        
		}
	//   18   37:aload_1         
	//   19   38:monitorexit     
...
label0:
	...
	//*  11   19:monitorenter    
			{
				if(zzay == null)
					break label0;
	//   12   20:getstatic       #105 <Field GoogleServices zzay>
	//   13   23:ifnull          38
				s = ((String) (zzay.checkGoogleAppId(s)));
	//   14   26:getstatic       #105 <Field GoogleServices zzay>
	//   15   29:aload_1         
	...
	//   27   47:astore_1        
		zzay = ((GoogleServices) (s));
	//   28   48:aload_1         
	//   29   49:putstatic       #105 <Field GoogleServices zzay>
		s = ((String) (((GoogleServices) (s)).zzba));
	//   30   52:aload_1         
	//   31   53:getfield        #94  <Field Status zzba>
	//   32   56:astore_1        
		context;
	//   33   57:aload_0         
		JVM INSTR monitorexit ;
	...
	//    3    6:aload_0         
	//    4    7:getfield        #94  <Field Status zzba>
	//    5   10:invokevirtual   #172 <Method boolean Status.isSuccess()>
	//    6   13:ifeq            25
	//    7   16:aload_0         
	//    8   17:getfield        #63  <Field boolean zzbb>
	//    9   20:ifeq            25
	//   10   23:iconst_1        
	//   11   24:ireturn         
	//   12   25:iconst_0        
	...
	//    1    2:invokestatic    #142 <Method GoogleServices checkInitialized(String)>
	//    2    5:getfield        #61  <Field boolean zzbc>
	//    3    8:ireturn         
	}
	...
	final Status checkGoogleAppId(String s)
	{
		String s1 = zzaz;
	//    0    0:aload_0         
	//    1    1:getfield        #96  <Field String zzaz>
	//    2    4:astore_2        
	...
	//*   5    9:aload_2         
	//*   6   10:aload_1         
	//*   7   11:invokevirtual   #178 <Method boolean String.equals(Object)>
	//*   8   14:ifne            74
		{
			s = zzaz;
	//    9   17:aload_0         
	//   10   18:getfield        #96  <Field String zzaz>
	//   11   21:astore_1        
	...
	//   21   40:aload_2         
	//   22   41:ldc1            #180 <String "Initialize was called with two different Google App IDs.  Only the first app ID will be used: '">
