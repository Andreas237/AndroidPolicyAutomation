...
public class GetServiceRequest extends AbstractSafeParcelable
{
	...
	//    7   13:putfield        #68  <Field int zzdh>
		zzdg = i;
	//    8   16:aload_0         
	//    9   17:iload_1         
	//   10   18:putfield        #70  <Field int zzdg>
		zzdo = true;
	//   11   21:aload_0         
	//   12   22:iconst_1        
	...
	//    5    9:aload_0         
	//    6   10:iload_2         
	//    7   11:putfield        #70  <Field int zzdg>
		zzdh = k;
	//    8   14:aload_0         
	//    9   15:iload_3         
	//   10   16:putfield        #68  <Field int zzdh>
	...
	//*  14   26:ifeq            38
			zzy = "com.google.android.gms";
	//   15   29:aload_0         
	//   16   30:ldc1            #77  <String "com.google.android.gms">
	//   17   32:putfield        #85  <Field String zzy>
		else
	//*  18   35:goto            44
			zzy = s;
	//   19   38:aload_0         
	//   20   39:aload           4
	//   21   41:putfield        #85  <Field String zzy>
		if(i < 2)
	//*  22   44:iload_1         
	//*  23   45:iconst_2        
	//*  24   46:icmpge          76
	...
	//    7   11:invokestatic    #125 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeInt(parcel, 2, zzdg);
	//    8   14:aload_1         
	//    9   15:iconst_2        
	//   10   16:aload_0         
	//   11   17:getfield        #70  <Field int zzdg>
	//   12   20:invokestatic    #125 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeInt(parcel, 3, zzdh);
	//   13   23:aload_1         
	//   14   24:iconst_3        
	//   15   25:aload_0         
	//   16   26:getfield        #68  <Field int zzdh>
	//   17   29:invokestatic    #125 <Method void SafeParcelWriter.writeInt(Parcel, int, int)>
		SafeParcelWriter.writeString(parcel, 4, zzy, false);
	//   18   32:aload_1         
	//   19   33:iconst_4        
	//   20   34:aload_0         
	//   21   35:getfield        #85  <Field String zzy>
	//   22   38:iconst_0        
