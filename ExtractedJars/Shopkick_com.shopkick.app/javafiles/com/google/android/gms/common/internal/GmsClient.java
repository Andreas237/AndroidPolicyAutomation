	...
	implements com.google.android.gms.common.api.Api.Client, GmsClientEventManager.GmsClientEventState
{
	...
	//    4    6:new             #90  <Class zaf>
	//    5    9:dup             
	//    6   10:aload_0         
	//    7   11:invokespecial   #93  <Method void zaf(com.google.android.gms.common.api.GoogleApiClient$ConnectionCallbacks)>
	//    8   14:areturn         
	}
	...
	//    4    6:new             #95  <Class zag>
	//    5    9:dup             
	//    6   10:aload_0         
	//    7   11:invokespecial   #98  <Method void zag(com.google.android.gms.common.api.GoogleApiClient$OnConnectionFailedListener)>
	//    8   14:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #102 <Method Set validateScopes(Set)>
	//    3    5:astore_2        
		for(Iterator iterator = set1.iterator(); iterator.hasNext();)
	//*   4    6:aload_2         
	//*   5    7:invokeinterface #108 <Method Iterator Set.iterator()>
	//*   6   12:astore_3        
	//*   7   13:aload_3         
	//*   8   14:invokeinterface #114 <Method boolean Iterator.hasNext()>
	//*   9   19:ifeq            53
			if(!set.contains(((Object) ((Scope)iterator.next()))))
	//*  10   22:aload_1         
	//*  11   23:aload_3         
	//*  12   24:invokeinterface #118 <Method Object Iterator.next()>
	//*  13   29:checkcast       #120 <Class Scope>
	//*  14   32:invokeinterface #124 <Method boolean Set.contains(Object)>
	//*  15   37:ifeq            43
	//*  16   40:goto            13
				throw new IllegalStateException("Expanding scopes is not permitted, use implied scopes instead");
	//   17   43:new             #126 <Class IllegalStateException>
	//   18   46:dup             
	//   19   47:ldc1            #128 <String "Expanding scopes is not permitted, use implied scopes instead">
	//   20   49:invokespecial   #131 <Method void IllegalStateException(String)>
	//   21   52:athrow          
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #140 <Method int BaseGmsClient.getMinApkVersion()>
	//    2    4:ireturn         
	}
