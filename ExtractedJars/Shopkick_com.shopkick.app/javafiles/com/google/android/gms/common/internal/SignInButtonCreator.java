...
public final class SignInButtonCreator extends RemoteCreator
{
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokespecial   #27  <Method View zaa(Context, int, int)>
	//    5    9:areturn         
	}
	...
	//   10   18:aload_0         
	//   11   19:aload_1         
	//   12   20:invokevirtual   #45  <Method Object getRemoteCreatorInstance(Context)>
	...
	//    4    6:aload_1         
	//    5    7:ldc1            #84  <String "com.google.android.gms.common.internal.ISignInButtonCreator">
	//    6    9:invokeinterface #90  <Method android.os.IInterface IBinder.queryLocalInterface(String)>
	//    7   14:astore_2        
		if(iinterface instanceof ISignInButtonCreator)
	//*   8   15:aload_2         
	//*   9   16:instanceof      #47  <Class ISignInButtonCreator>
	//*  10   19:ifeq            27
			return (ISignInButtonCreator)iinterface;
	//   11   22:aload_2         
	//   12   23:checkcast       #47  <Class ISignInButtonCreator>
	//   13   26:areturn         
		else
			return ((ISignInButtonCreator) (new zah(ibinder)));
	//   14   27:new             #92  <Class zah>
	//   15   30:dup             
	//   16   31:aload_1         
	//   17   32:invokespecial   #95  <Method void zah(IBinder)>
	//   18   35:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #98  <Method ISignInButtonCreator getRemoteCreator(IBinder)>
	//    3    5:areturn         
	}
