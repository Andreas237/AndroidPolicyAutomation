	...
	extends IInterface
{
		...
		implements IStatusCallback
	{
		...
		//    6   10:invokestatic    #44  <Method android.os.Parcelable zac.zaa(Parcel, android.os.Parcelable$Creator)>
	...
	public static final class Stub.zaa extends com.google.android.gms.internal.base.zaa
		implements IStatusCallback
	{
		...
		//    0    0:aload_0         
		//    1    1:invokevirtual   #25  <Method Parcel com.google.android.gms.internal.base.zaa.zaa()>
		//    2    4:astore_2        
			zac.zaa(parcel, ((android.os.Parcelable) (status)));
		//    3    5:aload_2         
		//    4    6:aload_1         
		//    5    7:invokestatic    #30  <Method void zac.zaa(Parcel, android.os.Parcelable)>
			((com.google.android.gms.internal.base.zaa)this).zac(1, parcel);
		//    6   10:aload_0         
		//    7   11:iconst_1        
		//    8   12:aload_2         
		//    9   13:invokevirtual   #34  <Method void com.google.android.gms.internal.base.zaa.zac(int, Parcel)>
		//   10   16:return          
		}

		Stub.zaa(IBinder ibinder)
		{
