	...
	implements ThreadFactory
{
	...
	//    1    1:invokespecial   #25  <Method void Object()>
		zzhs = new AtomicInteger();
	//    2    4:aload_0         
	//    3    5:new             #27  <Class AtomicInteger>
	//    4    8:dup             
	//    5    9:invokespecial   #28  <Method void AtomicInteger()>
	//    6   12:putfield        #30  <Field AtomicInteger zzhs>
		zzhq = Executors.defaultThreadFactory();
	//    7   15:aload_0         
	//    8   16:invokestatic    #36  <Method ThreadFactory Executors.defaultThreadFactory()>
	//    9   19:putfield        #38  <Field ThreadFactory zzhq>
		zzhr = (String)Preconditions.checkNotNull(((Object) (s)), "Name must not be null");
	//   10   22:aload_0         
	//   11   23:aload_1         
	...
	//   15   32:putfield        #50  <Field String zzhr>
		priority = 0;
	//   16   35:aload_0         
	//   17   36:iconst_0        
	...
	{
		runnable = ((Runnable) (zzhq.newThread(((Runnable) (new zza(runnable, 0))))));
	//    0    0:aload_0         
	//    1    1:getfield        #38  <Field ThreadFactory zzhq>
	...
	//    8   18:astore_1        
		String s = zzhr;
	//    9   19:aload_0         
	//   10   20:getfield        #50  <Field String zzhr>
	//   11   23:astore_3        
		int i = zzhs.getAndIncrement();
	//   12   24:aload_0         
	//   13   25:getfield        #30  <Field AtomicInteger zzhs>
