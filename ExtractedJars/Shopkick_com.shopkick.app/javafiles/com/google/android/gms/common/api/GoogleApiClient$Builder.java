...
public static final class GoogleApiClient$Builder
{
	...
	//   25   45:istore          4
	//*  26   47:goto            23
		zabx.put(((Object) (api)), ((Object) (new com.google.android.gms.common.internal.piSettings(((Set) (apioptions))))));
	//   27   50:aload_0         
	...
	//   13   25:pop             
		api = ((Api) (api.zah().getImpliedScopes(((Object) (s)))));
	//   14   26:aload_1         
	...
	//   12   20:invokeinterface #170 <Method Object Map.put(Object, Object)>
	//   13   25:pop             
		zaa(api, ((Api.ApiOptions) (s)), ascope);
	//   14   26:aload_0         
	//   15   27:aload_1         
	//   16   28:aload_2         
	//   17   29:aload_3         
	...
	//    2    3:invokestatic    #134 <Method Object Preconditions.checkNotNull(Object, Object)>
	//    3    6:pop             
		zacf.add(((Object) (tionfailedlistener)));
	//    4    7:aload_0         
	...
	//   73  170:astore          13
			obj4 = ((Object) (r.buildClient(mContext, zabj, ((ClientSettings) (obj2)), obj3, ((onCallbacks) (obj4)), ((tionFailedListener) (obj4)))));
	//   74  172:aload           13
	//   75  174:aload_0         
	...
	private int zaca;
	private tionFailedListener zacb;
