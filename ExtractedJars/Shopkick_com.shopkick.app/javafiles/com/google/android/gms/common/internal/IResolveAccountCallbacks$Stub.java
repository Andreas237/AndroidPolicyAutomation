...
public static abstract class IResolveAccountCallbacks$Stub extends zab
	implements IResolveAccountCallbacks
{
		...
		implements IResolveAccountCallbacks
	{
		...
		//    0    0:aload_0         
		//    1    1:invokevirtual   #26  <Method Parcel zaa.zaa()>
		//    2    4:astore_2        
			zac.zaa(parcel, ((android.os.Parcelable) (resolveaccountresponse)));
		//    3    5:aload_2         
		//    4    6:aload_1         
		//    5    7:invokestatic    #31  <Method void zac.zaa(Parcel, android.os.Parcelable)>
			((zaa)this).zab(2, parcel);
		//    6   10:aload_0         
		//    7   11:iconst_2        
		//    8   12:aload_2         
		//    9   13:invokevirtual   #35  <Method void zaa.zab(int, Parcel)>
		//   10   16:return          
		}
	...
	//    6   10:invokestatic    #45  <Method android.os.Parcelable zac.zaa(Parcel, android.os.Parcelable$Creator)>
