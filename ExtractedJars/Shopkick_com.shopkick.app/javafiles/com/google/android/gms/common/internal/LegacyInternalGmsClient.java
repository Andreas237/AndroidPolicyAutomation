...
public abstract class LegacyInternalGmsClient extends GmsClient
{
	...
	//    5    9:aload_0         
	//    6   10:invokevirtual   #69  <Method android.os.Bundle getConnectionHint()>
	//    7   13:invokevirtual   #73  <Method void GmsClientEventManager.onConnectionSuccess(android.os.Bundle)>
	//    8   16:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #80  <Method void GmsClient.onConnectionFailed(ConnectionResult)>
		zagr.onConnectionFailure(connectionresult);
	//    3    5:aload_0         
	//    4    6:getfield        #26  <Field GmsClientEventManager zagr>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #83  <Method void GmsClientEventManager.onConnectionFailure(ConnectionResult)>
	//    7   13:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #87  <Method void GmsClient.onConnectionSuspended(int)>
		zagr.onUnintentionalDisconnection(i);
	//    3    5:aload_0         
	//    4    6:getfield        #26  <Field GmsClientEventManager zagr>
	//    5    9:iload_1         
	//    6   10:invokevirtual   #90  <Method void GmsClientEventManager.onUnintentionalDisconnection(int)>
	//    7   13:return          
	}
	...
	//    1    1:getfield        #26  <Field GmsClientEventManager zagr>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #93  <Method void GmsClientEventManager.unregisterConnectionCallbacks(com.google.android.gms.common.api.GoogleApiClient$ConnectionCallbacks)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #26  <Field GmsClientEventManager zagr>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #96  <Method void GmsClientEventManager.unregisterConnectionFailedListener(com.google.android.gms.common.api.GoogleApiClient$OnConnectionFailedListener)>
	//    4    8:return          
	}
