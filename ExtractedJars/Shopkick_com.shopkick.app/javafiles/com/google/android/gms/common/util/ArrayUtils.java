...
public final class ArrayUtils
{
	...
	//    5   11:new             #15  <Class IllegalArgumentException>
	//    6   14:dup             
	//    7   15:ldc1            #17  <String "Cannot generate array of generic type w/o class info">
	//    8   17:invokespecial   #20  <Method void IllegalArgumentException(String)>
	//    9   20:athrow          
		if(aobj == null)
	//*  10   21:aload_0         
	//*  11   22:ifnonnull       40
	...
	//   12   25:aload_1         
	//   13   26:invokevirtual   #24  <Method Class Object.getClass()>
	//   14   29:iconst_1        
	//   15   30:invokestatic    #30  <Method Object Array.newInstance(Class, int)>
	//   16   33:checkcast       #32  <Class Object[]>
	//   17   36:astore_0        
		else
	//*  18   37:goto            49
	...
	//   22   43:iconst_1        
	//   23   44:iadd            
	//   24   45:invokestatic    #38  <Method Object[] Arrays.copyOf(Object[], int)>
	//   25   48:astore_0        
...
label0:
	...
	//*  46   75:aaload          
	//*  47   76:aload           7
	//*  48   78:invokestatic    #64  <Method boolean Objects.equal(Object, Object)>
	//*  49   81:ifne            94
					{
						aobj2[j] = obj;
	//   50   84:aload           6
	...
	//*  81  128:aload_1         
	//*  82  129:aload           7
	//*  83  131:invokestatic    #80  <Method boolean contains(Object[], Object)>
	//*  84  134:ifne            147
					{
						aobj2[k] = obj1;
	//   85  137:aload           6
	...
	//  110  175:aload           6
	//  111  177:iload_3         
	//  112  178:invokestatic    #38  <Method Object[] Arrays.copyOf(Object[], int)>
	//  113  181:astore_0        
			return aobj;
	//  114  182:aload_0         
	//  115  183:areturn         
	...
	//  117  185:aload_0         
	//  118  186:arraylength     
	//  119  187:invokestatic    #38  <Method Object[] Arrays.copyOf(Object[], int)>
	//  120  190:areturn         
		}
	}
