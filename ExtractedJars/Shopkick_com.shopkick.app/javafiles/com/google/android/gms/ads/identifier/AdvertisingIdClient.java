...
public class AdvertisingIdClient
{
	...
	//*  15   27:icmpne          33
	//*  16   30:goto            43
	//*  17   33:new             #71  <Class IOException>
	//*  18   36:dup             
	//*  19   37:ldc1            #164 <String "Google Play services not available">
	//*  20   39:invokespecial   #167 <Method void IOException(String)>
	//*  21   42:athrow          
	//*  22   43:iload_1         
	//*  23   44:ifeq            53
	//*  24   47:ldc1            #131 <String "com.google.android.gms.ads.identifier.service.PERSISTENT_START">
	//*  25   49:astore_3        
	//*  26   50:goto            56
	//*  27   53:ldc1            #169 <String "com.google.android.gms.ads.identifier.service.START">
	//*  28   55:astore_3        
	//*  29   56:new             #171 <Class BlockingServiceConnection>
	//*  30   59:dup             
	//*  31   60:invokespecial   #172 <Method void BlockingServiceConnection()>
	//*  32   63:astore          4
	//*  33   65:new             #174 <Class Intent>
	//*  34   68:dup             
	//*  35   69:aload_3         
	//*  36   70:invokespecial   #175 <Method void Intent(String)>
	//*  37   73:astore_3        
	//*  38   74:aload_3         
	//*  39   75:ldc1            #177 <String "com.google.android.gms">
	//*  40   77:invokevirtual   #181 <Method Intent Intent.setPackage(String)>
	//*  41   80:pop             
	//*  42   81:invokestatic    #186 <Method ConnectionTracker ConnectionTracker.getInstance()>
	//*  43   84:aload_0         
	//*  44   85:aload_3         
	//*  45   86:aload           4
	//*  46   88:iconst_1        
	//*  47   89:invokevirtual   #190 <Method boolean ConnectionTracker.bindService(Context, Intent, android.content.ServiceConnection, int)>
	//*  48   92:istore_1        
	//*  49   93:iload_1         
	//*  50   94:ifeq            100
	//*  51   97:aload           4
	//*  52   99:areturn         
	//*  53  100:new             #71  <Class IOException>
	//*  54  103:dup             
	//*  55  104:ldc1            #192 <String "Connection failure">
	//*  56  106:invokespecial   #167 <Method void IOException(String)>
	//*  57  109:athrow          
	//*  58  110:astore_0        
	//*  59  111:new             #71  <Class IOException>
	//*  60  114:dup             
	//*  61  115:aload_0         
	//*  62  116:invokespecial   #195 <Method void IOException(Throwable)>
	//*  63  119:athrow          
	//*  64  120:new             #75  <Class GooglePlayServicesNotAvailableException>
	//*  65  123:dup             
	//*  66  124:bipush          9
	//*  67  126:invokespecial   #198 <Method void GooglePlayServicesNotAvailableException(int)>
	//*  68  129:athrow          
		// Misplaced declaration of an exception variable
	...
	//   21   40:aload_0         
	//   22   41:iconst_0        
	//   23   42:invokespecial   #116 <Method void zza(boolean)>
		if(zzg)
	//*  24   45:aload_0         
	//*  25   46:getfield        #63  <Field boolean zzg>
	//*  26   49:ifeq            55
			break MISSING_BLOCK_LABEL_95;
	//   27   52:goto            95
	...
	//   56  107:invokestatic    #53  <Method Object Preconditions.checkNotNull(Object)>
	//   57  110:pop             
		Info info = new Info(zzf.getId(), zzf.zzb(true));
