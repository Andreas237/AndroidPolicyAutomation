	...
	extends IInterface
{
		...
		implements ILocationSourceDelegate
	{
		...
		//*  14   44:goto            83
				{
					IInterface iinterface = ((IBinder) (parcel)).queryLocalInterface("com.google.android.gms.maps.internal.IOnLocationChangeListener");
		//   15   47:aload_2         
		//   16   48:ldc1            #30  <String "com.google.android.gms.maps.internal.IOnLocationChangeListener">
		//   17   50:invokeinterface #36  <Method IInterface IBinder.queryLocalInterface(String)>
		//   18   55:astore          5
	...
	public abstract void activate(zzah zzah)
		throws RemoteException;
