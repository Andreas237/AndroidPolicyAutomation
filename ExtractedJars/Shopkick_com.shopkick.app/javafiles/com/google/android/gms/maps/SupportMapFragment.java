...
//			GoogleMapOptions, OnMapReadyCallback, zzak, MapsInitializer
...
public class SupportMapFragment extends Fragment
{
		...
		implements MapLifecycleDelegate
	{
		...
		public final void getMapAsync(OnMapReadyCallback onmapreadycallback)
		{
			try
			{
				zzba.getMapAsync(((com.google.android.gms.maps.internal.zzap) (new zzak(this, onmapreadycallback))));
		//    0    0:aload_0         
		//    1    1:getfield        #29  <Field IMapFragmentDelegate zzba>
		//    2    4:new             #40  <Class zzak>
		//    3    7:dup             
		//    4    8:aload_0         
		//    5    9:aload_1         
		//    6   10:invokespecial   #43  <Method void zzak(SupportMapFragment$zza, OnMapReadyCallback)>
		...
		public zza(Fragment fragment1, IMapFragmentDelegate imapfragmentdelegate)
		{
		//    0    0:aload_0         
	...
	static final class zzb extends DeferredLifecycleHelper
	{
		...
		//*  26   58:new             #78  <Class SupportMapFragment$zza>
		//*  27   61:dup             
		//*  28   62:aload_0         
		//*  29   63:getfield        #31  <Field Fragment fragment>
		//*  30   66:aload_1         
		//*  31   67:invokespecial   #81  <Method void SupportMapFragment$zza(Fragment, IMapFragmentDelegate)>
		...
		//*  46  108:checkcast       #78  <Class SupportMapFragment$zza>
		//*  47  111:aload_2         
		//*  48  112:invokevirtual   #109 <Method void SupportMapFragment$zza.getMapAsync(OnMapReadyCallback)>
		//*  49  115:goto            85
		//*  50  118:aload_0         
		...
		//   62  140:return          
			...
			if(obj == null)
				return;
			zzbc.onDelegateCreated(((com.google.android.gms.dynamic.LifecycleDelegate) (new zza(fragment, ((IMapFragmentDelegate) (obj))))));
		...
		//    5   11:checkcast       #78  <Class SupportMapFragment$zza>
		//    6   14:aload_1         
		//    7   15:invokevirtual   #109 <Method void SupportMapFragment$zza.getMapAsync(OnMapReadyCallback)>
				return;
		//    8   18:return          
			} else
			{
	...
	//    2    4:aload_0         
	//    3    5:new             #9   <Class SupportMapFragment$zzb>
	//    4    8:dup             
	//    5    9:aload_0         
	//    6   10:invokespecial   #19  <Method void SupportMapFragment$zzb(Fragment)>
	//    7   13:putfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    8   16:return          
	}
	...
	//    1    3:dup             
	//    2    4:invokespecial   #25  <Method void SupportMapFragment()>
	//    3    7:areturn         
	}
	...
	//    8   16:aload_2         
	//    9   17:ldc1            #31  <String "MapOptions">
	//   10   19:aload_0         
	...
	//    1    2:invokestatic    #49  <Method void Preconditions.checkMainThread(String)>
		zzcg.getMapAsync(onmapreadycallback);
	//    2    5:aload_0         
	//    3    6:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    4    9:aload_1         
	//    5   10:invokevirtual   #51  <Method void SupportMapFragment$zzb.getMapAsync(OnMapReadyCallback)>
	//    6   13:return          
	}
	...
	//    2    2:invokespecial   #68  <Method void Fragment.onAttach(Activity)>
		zzb.zza(zzcg, activity);
	//    3    5:aload_0         
	//    4    6:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    5    9:aload_1         
	//    6   10:invokestatic    #71  <Method void SupportMapFragment$zzb.zza(SupportMapFragment$zzb, Activity)>
	//    7   13:return          
	}
	...
	//    2    2:invokespecial   #74  <Method void Fragment.onCreate(Bundle)>
		zzcg.onCreate(bundle);
	//    3    5:aload_0         
	//    4    6:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #75  <Method void SupportMapFragment$zzb.onCreate(Bundle)>
	//    7   13:return          
	}

	public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
	{
		layoutinflater = ((LayoutInflater) (zzcg.onCreateView(layoutinflater, viewgroup, bundle)));
	//    0    0:aload_0         
	//    1    1:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:aload_3         
	//    5    7:invokevirtual   #79  <Method View SupportMapFragment$zzb.onCreateView(LayoutInflater, ViewGroup, Bundle)>
	//    6   10:astore_1        
		((View) (layoutinflater)).setClickable(true);
	//    7   11:aload_1         
	//    8   12:iconst_1        
	//    9   13:invokevirtual   #85  <Method void View.setClickable(boolean)>
	...
	//    0    0:aload_0         
	//    1    1:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    2    4:invokevirtual   #88  <Method void SupportMapFragment$zzb.onDestroy()>
		super.onDestroy();
	//    3    7:aload_0         
	//    4    8:invokespecial   #89  <Method void Fragment.onDestroy()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    2    4:invokevirtual   #92  <Method void SupportMapFragment$zzb.onDestroyView()>
		super.onDestroyView();
	//    3    7:aload_0         
	//    4    8:invokespecial   #93  <Method void Fragment.onDestroyView()>
	//    5   11:return          
	}
	...
	//    0    0:ldc1            #96  <String "onEnterAmbient must be called on the main thread.">
	//    1    2:invokestatic    #49  <Method void Preconditions.checkMainThread(String)>
		zzb zzb1 = zzcg;
	//    2    5:aload_0         
	//    3    6:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	...
	//*   5   10:aload_2         
	//*   6   11:invokevirtual   #100 <Method com.google.android.gms.dynamic.LifecycleDelegate SupportMapFragment$zzb.getDelegate()>
	//*   7   14:ifnull          28
			((zza)zzb1.getDelegate()).onEnterAmbient(bundle);
	//    8   17:aload_2         
	//    9   18:invokevirtual   #100 <Method com.google.android.gms.dynamic.LifecycleDelegate SupportMapFragment$zzb.getDelegate()>
	//   10   21:checkcast       #6   <Class SupportMapFragment$zza>
	//   11   24:aload_1         
	//   12   25:invokevirtual   #102 <Method void SupportMapFragment$zza.onEnterAmbient(Bundle)>
	//   13   28:return          
	}
	...
	//    0    0:ldc1            #105 <String "onExitAmbient must be called on the main thread.">
	//    1    2:invokestatic    #49  <Method void Preconditions.checkMainThread(String)>
		zzb zzb1 = zzcg;
	//    2    5:aload_0         
	//    3    6:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	...
	//    9   18:invokevirtual   #100 <Method com.google.android.gms.dynamic.LifecycleDelegate SupportMapFragment$zzb.getDelegate()>
	//   10   21:checkcast       #6   <Class SupportMapFragment$zza>
	//   11   24:invokevirtual   #107 <Method void SupportMapFragment$zza.onExitAmbient()>
	//   12   27:return          
	}
	...
	//    0    0:invokestatic    #115 <Method android.os.StrictMode$ThreadPolicy StrictMode.getThreadPolicy()>
	//    1    3:astore          4
		StrictMode.setThreadPolicy((new android.os.StrictMode.ThreadPolicy.Builder(threadpolicy)).permitAll().build());
	//    2    5:new             #117 <Class android.os.StrictMode$ThreadPolicy$Builder>
	//    3    8:dup             
	//    4    9:aload           4
	//    5   11:invokespecial   #120 <Method void android.os.StrictMode$ThreadPolicy$Builder(android.os.StrictMode$ThreadPolicy)>
	//    6   14:invokevirtual   #124 <Method android.os.StrictMode$ThreadPolicy$Builder android.os.StrictMode$ThreadPolicy$Builder.permitAll()>
	//    7   17:invokevirtual   #127 <Method android.os.StrictMode$ThreadPolicy android.os.StrictMode$ThreadPolicy$Builder.build()>
	//    8   20:invokestatic    #130 <Method void StrictMode.setThreadPolicy(android.os.StrictMode$ThreadPolicy)>
		super.onInflate(activity, attributeset, bundle);
	//    9   23:aload_0         
	//   10   24:aload_1         
	//   11   25:aload_2         
	//   12   26:aload_3         
	//   13   27:invokespecial   #132 <Method void Fragment.onInflate(Activity, AttributeSet, Bundle)>
		zzb.zza(zzcg, activity);
	//   14   30:aload_0         
	//   15   31:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//   16   34:aload_1         
	//   17   35:invokestatic    #71  <Method void SupportMapFragment$zzb.zza(SupportMapFragment$zzb, Activity)>
		attributeset = ((AttributeSet) (GoogleMapOptions.createFromAttributes(((android.content.Context) (activity)), attributeset)));
	//   18   38:aload_1         
	//   19   39:aload_2         
	//   20   40:invokestatic    #138 <Method GoogleMapOptions GoogleMapOptions.createFromAttributes(android.content.Context, AttributeSet)>
	//   21   43:astore_2        
		Bundle bundle1 = new Bundle();
	//   22   44:new             #28  <Class Bundle>
	//   23   47:dup             
	//   24   48:invokespecial   #29  <Method void Bundle()>
	//   25   51:astore          5
		bundle1.putParcelable("MapOptions", ((android.os.Parcelable) (attributeset)));
	//   26   53:aload           5
	//   27   55:ldc1            #31  <String "MapOptions">
	//   28   57:aload_2         
	//   29   58:invokevirtual   #35  <Method void Bundle.putParcelable(String, android.os.Parcelable)>
		zzcg.onInflate(activity, bundle1, bundle);
	//   30   61:aload_0         
	//   31   62:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//   32   65:aload_1         
	//   33   66:aload           5
	//   34   68:aload_3         
	//   35   69:invokevirtual   #141 <Method void SupportMapFragment$zzb.onInflate(Activity, Bundle, Bundle)>
		StrictMode.setThreadPolicy(threadpolicy);
	//   36   72:aload           4
	//   37   74:invokestatic    #130 <Method void StrictMode.setThreadPolicy(android.os.StrictMode$ThreadPolicy)>
		return;
	//   38   77:return          
		activity;
	//   39   78:astore_1        
		StrictMode.setThreadPolicy(threadpolicy);
	//   40   79:aload           4
	//   41   81:invokestatic    #130 <Method void StrictMode.setThreadPolicy(android.os.StrictMode$ThreadPolicy)>
		throw activity;
	//   42   84:aload_1         
	//   43   85:athrow          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    2    4:invokevirtual   #144 <Method void SupportMapFragment$zzb.onLowMemory()>
		super.onLowMemory();
	//    3    7:aload_0         
	//    4    8:invokespecial   #145 <Method void Fragment.onLowMemory()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    2    4:invokevirtual   #148 <Method void SupportMapFragment$zzb.onPause()>
		super.onPause();
	//    3    7:aload_0         
	//    4    8:invokespecial   #149 <Method void Fragment.onPause()>
	//    5   11:return          
	}
	...
	public void onResume()
	{
		super.onResume();
	//    0    0:aload_0         
	//    1    1:invokespecial   #152 <Method void Fragment.onResume()>
		zzcg.onResume();
	//    2    4:aload_0         
	//    3    5:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    4    8:invokevirtual   #153 <Method void SupportMapFragment$zzb.onResume()>
	//    5   11:return          
	}
	...
	//    6   13:aload_0         
	//    7   14:aload_1         
	//    8   15:invokespecial   #156 <Method void Fragment.onSaveInstanceState(Bundle)>
		zzcg.onSaveInstanceState(bundle);
	//    9   18:aload_0         
	//   10   19:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//   11   22:aload_1         
	//   12   23:invokevirtual   #157 <Method void SupportMapFragment$zzb.onSaveInstanceState(Bundle)>
	//   13   26:return          
	}
	...
	public void onStart()
	{
		super.onStart();
	//    0    0:aload_0         
	//    1    1:invokespecial   #160 <Method void Fragment.onStart()>
		zzcg.onStart();
	//    2    4:aload_0         
	//    3    5:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    4    8:invokevirtual   #161 <Method void SupportMapFragment$zzb.onStart()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #21  <Field SupportMapFragment$zzb zzcg>
	//    2    4:invokevirtual   #164 <Method void SupportMapFragment$zzb.onStop()>
		super.onStop();
	//    3    7:aload_0         
	//    4    8:invokespecial   #165 <Method void Fragment.onStop()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #166 <Method void Fragment.setArguments(Bundle)>
	//    3    5:return          
	}

	private final zzb zzcg = new zzb(((Fragment) (this)));
}
