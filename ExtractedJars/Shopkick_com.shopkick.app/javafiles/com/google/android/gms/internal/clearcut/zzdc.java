	...
	implements zzcn, RandomAccess
{
	...
	//    2    3:newarray        long[]
	//    3    5:iconst_0        
	//    4    6:invokespecial   #29  <Method void zzdc(long[], int)>
	//    5    9:return          
	}

	private zzdc(long al[], int i)
	{
	//    0    0:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #32  <Field long[] zzlx>
		size = i;
	//    5    9:aload_0         
	//    6   10:iload_2         
	...
	{
		return zzlw;
	//    0    0:getstatic       #22  <Field zzdc zzlw>
	//    1    3:areturn         
	}
	...
	//*   9   17:icmpgt          127
			{
				long al[] = zzlx;
	//   10   20:aload_0         
	//   11   21:getfield        #32  <Field long[] zzlx>
	//   12   24:astore          5
				if(j < al.length)
	//*  13   26:iload           4
	//*  14   28:aload           5
	...
	//   42   71:invokestatic    #77  <Method void System.arraycopy(Object, int, Object, int, int)>
					System.arraycopy(((Object) (zzlx)), i, ((Object) (al1)), i + 1, size - i);
	//   43   74:aload_0         
	//   44   75:getfield        #32  <Field long[] zzlx>
	//   45   78:iload_1         
	//   46   79:aload           6
	//   47   81:iload_1         
	//   48   82:iconst_1        
	...
	//   55   93:aload_0         
	//   56   94:aload           6
	//   57   96:putfield        #32  <Field long[] zzlx>
				}
				zzlx[i] = l;
	//   58   99:aload_0         
	//   59  100:getfield        #32  <Field long[] zzlx>
	//   60  103:iload_1         
	//   61  104:lload_2         
	//   62  105:lastore         
				size = size + 1;
	...
	//   78  131:aload_0         
	//   79  132:iload_1         
	//   80  133:invokespecial   #44  <Method String zzh(int)>
	...
	//   11   21:ireturn         
		collection = ((Collection) ((zzdc)collection));
	//   12   22:aload_1         
	//   13   23:checkcast       #2   <Class zzdc>
	//   14   26:astore_1        
		int i = ((zzdc) (collection)).size;
	//   15   27:aload_1         
	...
	//   33   54:istore_2        
			long al[] = zzlx;
	//   34   55:aload_0         
	//   35   56:getfield        #32  <Field long[] zzlx>
	//   36   59:astore          4
			if(i > al.length)
	//*  37   61:iload_2         
	//*  38   62:aload           4
	//*  39   64:arraylength     
	//*  40   65:icmple          78
				zzlx = Arrays.copyOf(al, i);
	//   41   68:aload_0         
	//   42   69:aload           4
	//   43   71:iload_2         
	//   44   72:invokestatic    #107 <Method long[] Arrays.copyOf(long[], int)>
	//   45   75:putfield        #32  <Field long[] zzlx>
			System.arraycopy(((Object) (((zzdc) (collection)).zzlx)), 0, ((Object) (zzlx)), size, ((zzdc) (collection)).size);
	//   46   78:aload_1         
	//   47   79:getfield        #32  <Field long[] zzlx>
	//   48   82:iconst_0        
	//   49   83:aload_0         
	//   50   84:getfield        #32  <Field long[] zzlx>
	//   51   87:aload_0         
	...
	//   11   19:ireturn         
		obj = ((Object) ((zzdc)obj));
	//   12   20:aload_1         
	//   13   21:checkcast       #2   <Class zzdc>
	//   14   24:astore_1        
		if(size != ((zzdc) (obj)).size)
	//*  15   25:aload_0         
	...
	//   20   36:iconst_0        
	//   21   37:ireturn         
		obj = ((Object) (((zzdc) (obj)).zzlx));
	//   22   38:aload_1         
	//   23   39:getfield        #32  <Field long[] zzlx>
	//   24   42:astore_1        
	...
	//*  30   50:icmpge          75
			if(zzlx[i] != obj[i])
	//*  31   53:aload_0         
	//*  32   54:getfield        #32  <Field long[] zzlx>
	//*  33   57:iload_2         
	//*  34   58:laload          
	//*  35   59:aload_1         
	//*  36   60:iload_2         
	...
	//    2    2:invokespecial   #128 <Method void zzg(int)>
		return zzlx[i];
	//    3    5:aload_0         
	//    4    6:getfield        #32  <Field long[] zzlx>
	//    5    9:iload_1         
	//    6   10:laload          
	//    7   11:lreturn         
	}
	...
	//*   7    9:icmpge          34
			j = j * 31 + zzci.zzl(zzlx[i]);
	//    8   12:iload_2         
	//    9   13:bipush          31
	//   10   15:imul            
	//   11   16:aload_0         
	//   12   17:getfield        #32  <Field long[] zzlx>
	//   13   20:iload_1         
	//   14   21:laload          
	//   15   22:invokestatic    #134 <Method int zzci.zzl(long)>
	//   16   25:iadd            
	//   17   26:istore_2        
	...
	//    4    6:invokespecial   #128 <Method void zzg(int)>
		long al[] = zzlx;
	//    5    9:aload_0         
	//    6   10:getfield        #32  <Field long[] zzlx>
	//    7   13:astore          5
		long l = al[i];
	//    8   15:aload           5
	//    9   17:iload_1         
	...
	//*   7   11:icmpge          79
			if(obj.equals(((Object) (Long.valueOf(zzlx[i])))))
	//*   8   14:aload_1         
	//*   9   15:aload_0         
	//*  10   16:getfield        #32  <Field long[] zzlx>
	//*  11   19:iload_2         
	//*  12   20:laload          
	...
	//*  15   27:ifeq            72
			{
				obj = ((Object) (zzlx));
	//   16   30:aload_0         
	//   17   31:getfield        #32  <Field long[] zzlx>
	//   18   34:astore_1        
	...
	//    8   14:invokespecial   #128 <Method void zzg(int)>
		obj = ((Object) (zzlx));
	//    9   17:aload_0         
	//   10   18:getfield        #32  <Field long[] zzlx>
	//   11   21:astore_2        
		long l1 = obj[i];
	//   12   22:aload_2         
	//   13   23:iload_1         
	...
	//*   3    5:icmplt          28
			return ((zzcn) (new zzdc(Arrays.copyOf(zzlx, i), size)));
	//    4    8:new             #2   <Class zzdc>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:getfield        #32  <Field long[] zzlx>
	//    8   16:iload_1         
	//    9   17:invokestatic    #107 <Method long[] Arrays.copyOf(long[], int)>
	//   10   20:aload_0         
	//   11   21:getfield        #34  <Field int size>
	//   12   24:invokespecial   #29  <Method void zzdc(long[], int)>
	//   13   27:areturn         
		else
	...
	{
		zzdc zzdc1 = new zzdc();
	//    0    0:new             #2   <Class zzdc>
	//    1    3:dup             
	//    2    4:invokespecial   #20  <Method void zzdc()>
	//    3    7:astore_0        
		zzlw = zzdc1;
	//    4    8:aload_0         
	//    5    9:putstatic       #22  <Field zzdc zzlw>
		((zzav) (zzdc1)).zzv();
	//    6   12:aload_0         
