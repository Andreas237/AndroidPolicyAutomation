	...
	implements zzge, zzhr, RandomAccess
{
	...
	//    2    3:newarray        int[]
	//    3    5:iconst_0        
	//    4    6:invokespecial   #31  <Method void zzfz(int[], int)>
	//    5    9:return          
	}

	private zzfz(int ai[], int i)
	{
	//    0    0:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #34  <Field int[] zzxm>
		size = i;
	//    5    9:aload_0         
	//    6   10:iload_2         
	...
	private final void zzq(int i, int j)
	{
		((zzef)this).zzcj();
	//    0    0:aload_0         
	...
	//*   9   15:icmpgt          122
			{
				int ai[] = zzxm;
	//   10   18:aload_0         
	//   11   19:getfield        #34  <Field int[] zzxm>
	//   12   22:astore          4
				if(k < ai.length)
	//*  13   24:iload_3         
	//*  14   25:aload           4
	...
	//   42   66:invokestatic    #77  <Method void System.arraycopy(Object, int, Object, int, int)>
					System.arraycopy(((Object) (zzxm)), i, ((Object) (ai1)), i + 1, size - i);
	//   43   69:aload_0         
	//   44   70:getfield        #34  <Field int[] zzxm>
	//   45   73:iload_1         
	//   46   74:aload           5
	//   47   76:iload_1         
	//   48   77:iconst_1        
	...
	//   55   88:aload_0         
	//   56   89:aload           5
	//   57   91:putfield        #34  <Field int[] zzxm>
				}
				zzxm[i] = j;
	//   58   94:aload_0         
	//   59   95:getfield        #34  <Field int[] zzxm>
	//   60   98:iload_1         
	//   61   99:iload_2         
	//   62  100:iastore         
				size = size + 1;
	...
	//    5    9:invokespecial   #90  <Method void zzq(int, int)>
	//    6   12:return          
	}
	...
	//   11   21:ireturn         
		collection = ((Collection) ((zzfz)collection));
	//   12   22:aload_1         
	//   13   23:checkcast       #2   <Class zzfz>
	//   14   26:astore_1        
		int i = ((zzfz) (collection)).size;
	//   15   27:aload_1         
	...
	//   33   54:istore_2        
			int ai[] = zzxm;
	//   34   55:aload_0         
	//   35   56:getfield        #34  <Field int[] zzxm>
	//   36   59:astore          4
			if(i > ai.length)
	//*  37   61:iload_2         
	//*  38   62:aload           4
	//*  39   64:arraylength     
	//*  40   65:icmple          78
				zzxm = Arrays.copyOf(ai, i);
	//   41   68:aload_0         
	//   42   69:aload           4
	//   43   71:iload_2         
	//   44   72:invokestatic    #107 <Method int[] Arrays.copyOf(int[], int)>
	//   45   75:putfield        #34  <Field int[] zzxm>
			System.arraycopy(((Object) (((zzfz) (collection)).zzxm)), 0, ((Object) (zzxm)), size, ((zzfz) (collection)).size);
	//   46   78:aload_1         
	//   47   79:getfield        #34  <Field int[] zzxm>
	//   48   82:iconst_0        
	//   49   83:aload_0         
	//   50   84:getfield        #34  <Field int[] zzxm>
	//   51   87:aload_0         
	...
	//   11   19:ireturn         
		obj = ((Object) ((zzfz)obj));
	//   12   20:aload_1         
	//   13   21:checkcast       #2   <Class zzfz>
	//   14   24:astore_1        
		if(size != ((zzfz) (obj)).size)
	//*  15   25:aload_0         
	...
	//   20   36:iconst_0        
	//   21   37:ireturn         
		obj = ((Object) (((zzfz) (obj)).zzxm));
	//   22   38:aload_1         
	//   23   39:getfield        #34  <Field int[] zzxm>
	//   24   42:astore_1        
	...
	//*  30   50:icmpge          74
			if(zzxm[i] != obj[i])
	//*  31   53:aload_0         
	//*  32   54:getfield        #34  <Field int[] zzxm>
	//*  33   57:iload_2         
	//*  34   58:iaload          
	//*  35   59:aload_1         
	//*  36   60:iload_2         
	...
	//    2    2:invokespecial   #128 <Method void zzaf(int)>
		return zzxm[i];
	//    3    5:aload_0         
	//    4    6:getfield        #34  <Field int[] zzxm>
	//    5    9:iload_1         
	//    6   10:iaload          
	//    7   11:ireturn         
	}
	...
	//   10   15:imul            
	//   11   16:aload_0         
	//   12   17:getfield        #34  <Field int[] zzxm>
	//   13   20:iload_1         
	//   14   21:iaload          
	//   15   22:iadd            
	//   16   23:istore_2        
	...
	//    4    6:invokespecial   #128 <Method void zzaf(int)>
		int ai[] = zzxm;
	//    5    9:aload_0         
	//    6   10:getfield        #34  <Field int[] zzxm>
	//    7   13:astore          4
		int j = ai[i];
	//    8   15:aload           4
	//    9   17:iload_1         
	...
	//*   7   11:icmpge          79
			if(obj.equals(((Object) (Integer.valueOf(zzxm[i])))))
	//*   8   14:aload_1         
	//*   9   15:aload_0         
	//*  10   16:getfield        #34  <Field int[] zzxm>
	//*  11   19:iload_2         
	//*  12   20:iaload          
	...
	//*  15   27:ifeq            72
			{
				obj = ((Object) (zzxm));
	//   16   30:aload_0         
	//   17   31:getfield        #34  <Field int[] zzxm>
	//   18   34:astore_1        
	...
	//    8   14:invokespecial   #128 <Method void zzaf(int)>
		obj = ((Object) (zzxm));
	//    9   17:aload_0         
	//   10   18:getfield        #34  <Field int[] zzxm>
	//   11   21:astore_2        
		int k = obj[i];
	//   12   22:aload_2         
	//   13   23:iload_1         
	...
	//*   3    5:icmplt          28
			return ((zzge) (new zzfz(Arrays.copyOf(zzxm, i), size)));
	//    4    8:new             #2   <Class zzfz>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:getfield        #34  <Field int[] zzxm>
	//    8   16:iload_1         
	//    9   17:invokestatic    #107 <Method int[] Arrays.copyOf(int[], int)>
	//   10   20:aload_0         
	//   11   21:getfield        #36  <Field int size>
	//   12   24:invokespecial   #31  <Method void zzfz(int[], int)>
	//   13   27:areturn         
		else
	...
	//    2    2:getfield        #36  <Field int size>
	//    3    5:iload_1         
	//    4    6:invokespecial   #90  <Method void zzq(int, int)>
	//    5    9:return          
	}
	...
	{
		zzfz zzfz1 = new zzfz();
	//    0    0:new             #2   <Class zzfz>
	//    1    3:dup             
	//    2    4:invokespecial   #22  <Method void zzfz()>
	//    3    7:astore_0        
		zzxl = zzfz1;
	//    4    8:aload_0         
	//    5    9:putstatic       #24  <Field zzfz zzxl>
		((zzef) (zzfz1)).zzci();
	//    6   12:aload_0         
