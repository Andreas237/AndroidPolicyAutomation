	...
	implements Cloneable
{
	...
	//    2    4:aload_0         
	//    3    5:iconst_0        
	//    4    6:putfield        #32  <Field boolean zzcex>
	...
	//    9   15:iload_1         
	//   10   16:newarray        int[]
	//   11   18:putfield        #38  <Field int[] zzcey>
		zzcez = new zzyf[i];
	//   12   21:aload_0         
	//   13   22:iload_1         
	//   14   23:anewarray       zzyf[]
	//   15   26:putfield        #40  <Field zzyf[] zzcez>
		mSize = 0;
	//   16   29:aload_0         
	//   17   30:iconst_0        
	...
	//   15   19:istore          4
			int i1 = zzcey[l];
	//   16   21:aload_0         
	//   17   22:getfield        #38  <Field int[] zzcey>
	//   18   25:iload           4
	//   19   27:iaload          
	//   20   28:istore          5
			if(i1 < i)
	...
	//    7   13:astore_3        
		int ai[] = zzcey;
	//    8   14:aload_0         
	//    9   15:getfield        #38  <Field int[] zzcey>
	//   10   18:astore          4
		int ai1[] = zzye1.zzcey;
	//   11   20:aload_3         
	//   12   21:getfield        #38  <Field int[] zzcey>
	//   13   24:astore          5
		int i = 0;
	//   14   26:iconst_0        
	//   15   27:istore_1        
	...
	//*  24   40:icmpge          79
		{
			zzyf azzyf[] = zzcez;
	//   25   43:aload_0         
	//   26   44:getfield        #40  <Field zzyf[] zzcez>
	//   27   47:astore          4
			if(azzyf[i] != null)
	//*  28   49:aload           4
	//*  29   51:iload_1         
	//*  30   52:aaload          
	//*  31   53:ifnull          72
				zzye1.zzcez[i] = (zzyf)azzyf[i].clone();
	//   32   56:aload_3         
	//   33   57:getfield        #40  <Field zzyf[] zzcez>
	//   34   60:iload_1         
	//   35   61:aload           4
	//   36   63:iload_1         
	//   37   64:aaload          
	//   38   65:invokevirtual   #55  <Method Object zzyf.clone()>
	//   39   68:checkcast       #20  <Class zzyf>
	//   40   71:aastore         
		}
...
label0:
	...
	//   21   35:ireturn         
			int ai[] = zzcey;
	//   22   36:aload_0         
	//   23   37:getfield        #38  <Field int[] zzcey>
	//   24   40:astore          4
			int ai1[] = ((zzye) (obj)).zzcey;
	//   25   42:aload_1         
	//   26   43:getfield        #38  <Field int[] zzcey>
	//   27   46:astore          5
			i = 0;
	//   28   48:iconst_0        
	//   29   49:istore_2        
...
label2:
	...
	//   51   81:ifeq            140
				zzyf azzyf[] = zzcez;
	//   52   84:aload_0         
	//   53   85:getfield        #40  <Field zzyf[] zzcez>
	//   54   88:astore          4
				obj = ((Object) (((zzye) (obj)).zzcez));
	//   55   90:aload_1         
	//   56   91:getfield        #40  <Field zzyf[] zzcez>
	//   57   94:astore_1        
				int k = mSize;
	//   58   95:aload_0         
	...
	//*  70  112:iload_2         
	//*  71  113:aaload          
	//*  72  114:invokevirtual   #60  <Method boolean zzyf.equals(Object)>
	//*  73  117:ifne            125
					{
						i = 0;
	//   74  120:iconst_0        
	...
	//*   7   10:icmpge          45
			j = (j * 31 + zzcey[i]) * 31 + zzcez[i].hashCode();
	//    8   13:iload_2         
	//    9   14:bipush          31
	//   10   16:imul            
	//   11   17:aload_0         
	//   12   18:getfield        #38  <Field int[] zzcey>
	//   13   21:iload_1         
	//   14   22:iaload          
	//   15   23:iadd            
	//   16   24:bipush          31
	//   17   26:imul            
	//   18   27:aload_0         
	//   19   28:getfield        #40  <Field zzyf[] zzcez>
	//   20   31:iload_1         
	//   21   32:aaload          
	//   22   33:invokevirtual   #64  <Method int zzyf.hashCode()>
	//   23   36:iadd            
	//   24   37:istore_2        
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #71  <Method int zzcg(int)>
	//    3    5:istore_3        
		if(j >= 0)
	//*   4    6:iload_3         
	//*   5    7:iflt            18
		{
			zzcez[j] = zzyf1;
	//    6   10:aload_0         
	//    7   11:getfield        #40  <Field zzyf[] zzcez>
	//    8   14:iload_3         
	//    9   15:aload_2         
	//   10   16:aastore         
			return;
	...
	//*  17   25:icmpge          57
		{
			zzyf azzyf[] = zzcez;
	//   18   28:aload_0         
	//   19   29:getfield        #40  <Field zzyf[] zzcez>
	//   20   32:astore          6
			if(azzyf[j] == zzcew)
	//*  21   34:aload           6
	//*  22   36:iload_3         
	//*  23   37:aaload          
	//*  24   38:getstatic       #25  <Field zzyf zzcew>
	//*  25   41:if_acmpne       57
			{
				zzcey[j] = i;
	//   26   44:aload_0         
	//   27   45:getfield        #38  <Field int[] zzcey>
	//   28   48:iload_3         
	//   29   49:iload_1         
	//   30   50:iastore         
				azzyf[j] = zzyf1;
	...
	//*  39   63:iload           4
	//*  40   65:aload_0         
	//*  41   66:getfield        #38  <Field int[] zzcey>
	//*  42   69:arraylength     
	//*  43   70:icmplt          143
		{
	...
	//   50   84:newarray        int[]
	//   51   86:astore          6
			zzyf azzyf1[] = new zzyf[k];
	//   52   88:iload           4
	//   53   90:anewarray       zzyf[]
	//   54   93:astore          7
			Object aobj1[] = ((Object []) (zzcey));
	//   55   95:aload_0         
	//   56   96:getfield        #38  <Field int[] zzcey>
	//   57   99:astore          8
	...
	//   64  110:invokestatic    #53  <Method void System.arraycopy(Object, int, Object, int, int)>
			aobj1 = ((Object []) (zzcez));
	//   65  113:aload_0         
	//   66  114:getfield        #40  <Field zzyf[] zzcez>
	//   67  117:astore          8
			System.arraycopy(((Object) (aobj1)), 0, ((Object) (azzyf1)), 0, aobj1.length);
	//   68  119:aload           8
	//   69  121:iconst_0        
	//   70  122:aload           7
	//   71  124:iconst_0        
	...
	//   75  131:aload_0         
	//   76  132:aload           6
	//   77  134:putfield        #38  <Field int[] zzcey>
			zzcez = azzyf1;
	//   78  137:aload_0         
	//   79  138:aload           7
	//   80  140:putfield        #40  <Field zzyf[] zzcez>
		}
		k = mSize;
	//   81  143:aload_0         
	...
	//*  87  153:ifeq            203
		{
			Object aobj[] = ((Object []) (zzcey));
	//   88  156:aload_0         
	//   89  157:getfield        #38  <Field int[] zzcey>
	//   90  160:astore          6
			int l = j + 1;
	//   91  162:iload_3         
	//   92  163:iconst_1        
	...
	//  102  178:invokestatic    #53  <Method void System.arraycopy(Object, int, Object, int, int)>
			aobj = ((Object []) (zzcez));
	//  103  181:aload_0         
	//  104  182:getfield        #40  <Field zzyf[] zzcez>
	//  105  185:astore          6
	...
	//  114  200:invokestatic    #53  <Method void System.arraycopy(Object, int, Object, int, int)>
		...
		zzcey[j] = i;
	//  115  203:aload_0         
	//  116  204:getfield        #38  <Field int[] zzcey>
	//  117  207:iload_3         
	//  118  208:iload_1         
	//  119  209:iastore         
		zzcez[j] = zzyf1;
	//  120  210:aload_0         
	//  121  211:getfield        #40  <Field zzyf[] zzcez>
	//  122  214:iload_3         
	//  123  215:aload_2         
	//  124  216:aastore         
		mSize = mSize + 1;
	...
	//*  10   16:iload_1         
	//*  11   17:aaload          
	//*  12   18:getstatic       #25  <Field zzyf zzcew>
	//*  13   21:if_acmpne       27
	//*  14   24:goto            31
				return azzyf[i];
	//   15   27:aload_2         
	...
	final zzyf zzcf(int i)
	{
		return zzcez[i];
	//    0    0:aload_0         
	//    1    1:getfield        #40  <Field zzyf[] zzcez>
	//    2    4:iload_1         
	//    3    5:aaload          
	//    4    6:areturn         
	}
	...
	//    3    7:putstatic       #25  <Field zzyf zzcew>
	//*   4   10:return          
	}
}
