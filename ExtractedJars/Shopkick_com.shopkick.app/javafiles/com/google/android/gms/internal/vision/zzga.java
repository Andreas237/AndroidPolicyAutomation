...
public final class zzga
{
	...
	//    5    5:iconst_0        
	//    6    6:iload_1         
	//    7    7:invokestatic    #63  <Method int zza(int, byte[], int, int)>
	//    8   10:istore_1        
		if(i == 0)
	//*   9   11:iload_1         
	//*  10   12:ifne            17
	...
	{
		return ((Object) (((zzhf)obj).zzez().zza((zzhf)obj1).zzff()));
	//    0    0:aload_0         
	//    1    1:checkcast       #66  <Class zzhf>
	//    2    4:invokeinterface #70  <Method zzhg zzhf.zzez()>
	//    3    9:aload_1         
	//    4   10:checkcast       #66  <Class zzhf>
	//    5   13:invokeinterface #75  <Method zzhg zzhg.zza(zzhf)>
	//    6   18:invokeinterface #79  <Method zzhf zzhg.zzff()>
	//    7   23:areturn         
	}
	...
	//    5    9:dup             
	//    6   10:aload_1         
	//    7   11:invokespecial   #83  <Method void NullPointerException(String)>
	//    8   14:athrow          
	}

	static boolean zzf(zzhf zzhf1)
	{
		return false;
	//    0    0:iconst_0        
	//    1    1:ireturn         
	...
	{
		return zziw.zzi(abyte0);
	//    0    0:aload_0         
	//    1    1:invokestatic    #91  <Method boolean zziw.zzi(byte[])>
	//    2    4:ireturn         
	}

	public static int zzj(boolean flag)
	{
	...
	//    0    0:new             #96  <Class String>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getstatic       #25  <Field Charset UTF_8>
	//    4    8:invokespecial   #99  <Method void String(byte[], Charset)>
	//    5   11:areturn         
	}
	...
	//    8   19:astore_0        
		zzxn = abyte0;
	//    9   20:aload_0         
	//   10   21:putstatic       #31  <Field byte[] zzxn>
		zzxo = ByteBuffer.wrap(abyte0);
	//   11   24:aload_0         
	//   12   25:invokestatic    #37  <Method ByteBuffer ByteBuffer.wrap(byte[])>
	//   13   28:putstatic       #39  <Field ByteBuffer zzxo>
		zzxp = zzez.zzf(zzxn);
	//   14   31:getstatic       #31  <Field byte[] zzxn>
	//   15   34:invokestatic    #45  <Method zzez zzez.zzf(byte[])>
	//   16   37:putstatic       #47  <Field zzez zzxp>
	//*  17   40:return          
	}
}
