...
final class zzjb extends zziy
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #8   <Method void zziy()>
	//    2    4:return          
	}
	...
	//    5   35:athrow          
		...
		case 2: // '\002'
			return zziw.zzd(i, ((int) (zziu.zza(abyte0, l))), ((int) (zziu.zza(abyte0, l + 1L))));
	//    6   36:iload_1         
	//    7   37:aload_0         
	//    8   38:lload_2         
	//    9   39:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//   10   42:aload_0         
	//   11   43:lload_2         
	//   12   44:lconst_1        
	//   13   45:ladd            
	//   14   46:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//   15   49:invokestatic    #25  <Method int zziw.zzd(int, int, int)>
	//   16   52:ireturn         

		case 1: // '\001'
			return zziw.zzu(i, ((int) (zziu.zza(abyte0, l))));
	//   17   53:iload_1         
	//   18   54:aload_0         
	//   19   55:lload_2         
	//   20   56:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//   21   59:invokestatic    #29  <Method int zziw.zzu(int, int)>
	//   22   62:ireturn         

		case 0: // '\0'
			return zziw.zzbs(i);
	//   23   63:iload_1         
	//   24   64:invokestatic    #33  <Method int zziw.zzbs(int)>
	//   25   67:ireturn         
		}
	}
...
label1:
	...
	//*  30   44:icmpge          72
				{
					if(zziu.zza(abyte0, l) < 0)
	//*  31   47:aload_2         
	//*  32   48:lload           5
	//*  33   50:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//*  34   53:ifge            59
						break label1;
	//   35   56:goto            74
					i++;
...
label2:
	...
	//   66  100:ladd            
	//   67  101:lstore          7
								j = ((int) (zziu.zza(abyte0, l1)));
	//   68  103:aload_2         
	//   69  104:lload           5
	//   70  106:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//   71  109:istore_3        
								if(j < 0)
									break;
	//   72  110:iload_3         
	...
	//* 102  154:icmplt          179
							{
								if(zziu.zza(abyte0, l2) > -65)
	//* 103  157:aload_2         
	//* 104  158:lload           7
	//* 105  160:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//* 106  163:bipush          -65
	//* 107  165:icmple          170
									return -1;
	//  108  168:iconst_m1       
	...
	//  135  208:ladd            
	//  136  209:lstore          9
						k = ((int) (zziu.zza(abyte0, l2)));
	//  137  211:aload_2         
	//  138  212:lload           7
	//  139  214:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  140  217:istore          4
	...
	//  158  255:ladd            
	//  159  256:lstore          5
					} while(zziu.zza(abyte0, l3) <= -65);
	//  160  258:aload_2         
	//  161  259:lload           9
	//  162  261:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  163  264:bipush          -65
	//  164  266:icmple          87
					return -1;
	//  165  269:iconst_m1       
	...
	//  184  295:aload_2         
	//  185  296:lload           7
	//  186  298:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  187  301:istore          4
	...
	//  203  329:ladd            
	//  204  330:lstore          7
				if(zziu.zza(abyte0, l1) > -65)
					break;
	//  205  332:aload_2         
	//  206  333:lload           5
	//  207  335:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  208  338:bipush          -65
	//  209  340:icmpgt          360
				l1 = l2 + 1L;
	//  210  343:lload           7
	...
	//  212  346:ladd            
	//  213  347:lstore          5
			} while(zziu.zza(abyte0, l2) <= -65);
	//  214  349:aload_2         
	//  215  350:lload           7
	//  216  352:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  217  355:bipush          -65
	//  218  357:icmple          87
			return -1;
	//  219  360:iconst_m1       
...
label2:
	...
	//   30   56:sipush          128
	//   31   59:icmpge          85
						zziu.zza(abyte0, l, (byte)i);
	//   32   62:aload_2         
	//   33   63:lload           8
	//   34   65:iload_3         
	//   35   66:int2byte        
	//   36   67:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
						j++;
	//   37   70:iload           4
	//   38   72:iconst_1        
	//   39   73:iadd            
	...
	//*  69  131:ifge            152
						{
							zziu.zza(abyte0, l2, (byte)c);
	//   70  134:aload_2         
	//   71  135:lload           10
	//   72  137:iload           5
	//   73  139:int2byte        
	//   74  140:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							l1 = l2 + 1L;
	//   75  143:lload           10
	//   76  145:lconst_1        
	//   77  146:ladd            
	...
	//   91  175:ladd            
	//   92  176:lstore          14
							zziu.zza(abyte0, l2, (byte)(c >>> 6 | 0x3c0));
	//   93  178:aload_2         
	//   94  179:lload           10
	//   95  181:iload           5
	//   96  183:bipush          6
	...
	//   99  189:ior             
	//  100  190:int2byte        
	//  101  191:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							l1 = l4 + 1L;
	//  102  194:lload           14
	//  103  196:lconst_1        
	//  104  197:ladd            
	//  105  198:lstore          8
							zziu.zza(abyte0, l4, (byte)(c & 0x3f | 0x80));
	//  106  200:aload_2         
	//  107  201:lload           14
	//  108  203:iload           5
	//  109  205:bipush          63
	...
	//  112  211:ior             
	//  113  212:int2byte        
	//  114  213:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
						} else
	//* 115  216:goto            465
						if((c < '\uD800' || '\uDFFF' < c) && l2 <= l3 - 3L)
	//* 116  219:iload           5
	...
	//  130  248:ladd            
	//  131  249:lstore          8
							zziu.zza(abyte0, l2, (byte)(c >>> 12 | 0x1e0));
	//  132  251:aload_2         
	//  133  252:lload           10
	//  134  254:iload           5
	//  135  256:bipush          12
	...
	//  138  262:ior             
	//  139  263:int2byte        
	//  140  264:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							l2 = l1 + 1L;
	//  141  267:lload           8
	//  142  269:lconst_1        
	//  143  270:ladd            
	//  144  271:lstore          10
							zziu.zza(abyte0, l1, (byte)(c >>> 6 & 0x3f | 0x80));
	//  145  273:aload_2         
	//  146  274:lload           8
	//  147  276:iload           5
	//  148  278:bipush          6
	...
	//  153  287:ior             
	//  154  288:int2byte        
	//  155  289:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							zziu.zza(abyte0, l2, (byte)(c & 0x3f | 0x80));
	//  156  292:aload_2         
	//  157  293:lload           10
	//  158  295:iload           5
	//  159  297:bipush          63
	...
	//  162  303:ior             
	//  163  304:int2byte        
	//  164  305:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							l1 = l2 + 1L;
	//  165  308:lload           10
	//  166  310:lconst_1        
	//  167  311:ladd            
	...
	//  199  375:ladd            
	//  200  376:lstore          8
							zziu.zza(abyte0, l2, (byte)(i >>> 18 | 0xf0));
	//  201  378:aload_2         
	//  202  379:lload           10
	//  203  381:iload_3         
	//  204  382:bipush          18
	...
	//  207  388:ior             
	//  208  389:int2byte        
	//  209  390:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							l2 = l1 + 1L;
	//  210  393:lload           8
	//  211  395:lconst_1        
	//  212  396:ladd            
	//  213  397:lstore          10
							zziu.zza(abyte0, l1, (byte)(i >>> 12 & 0x3f | 0x80));
	//  214  399:aload_2         
	//  215  400:lload           8
	//  216  402:iload_3         
	//  217  403:bipush          12
	...
	//  222  412:ior             
	//  223  413:int2byte        
	//  224  414:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							long l5 = l2 + 1L;
	//  225  417:lload           10
	//  226  419:lconst_1        
	//  227  420:ladd            
	//  228  421:lstore          14
							zziu.zza(abyte0, l2, (byte)(i >>> 6 & 0x3f | 0x80));
	//  229  423:aload_2         
	//  230  424:lload           10
	//  231  426:iload_3         
	//  232  427:bipush          6
	...
	//  237  436:ior             
	//  238  437:int2byte        
	//  239  438:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							l1 = l5 + 1L;
	//  240  441:lload           14
	//  241  443:lconst_1        
	//  242  444:ladd            
	//  243  445:lstore          8
							zziu.zza(abyte0, l5, (byte)(i & 0x3f | 0x80));
	//  244  447:aload_2         
	//  245  448:lload           14
	//  246  450:iload_3         
	//  247  451:bipush          63
	...
	//  250  457:ior             
	//  251  458:int2byte        
	//  252  459:invokestatic    #72  <Method void zziu.zza(byte[], long, byte)>
							i = j;
	//  253  462:iload           4
	//  254  464:istore_3        
						}
	...
	//  261  473:goto            103
					throw new zzja(i - 1, k);
	//  262  476:new             #92  <Class zzja>
	//  263  479:dup             
	//  264  480:iload_3         
	//  265  481:iconst_1        
	//  266  482:isub            
	//  267  483:iload           7
	//  268  485:invokespecial   #95  <Method void zzja(int, int)>
	//  269  488:athrow          
				}
				if('\uD800' <= c && c <= '\uDFFF')
	...
	//* 288  528:ifne            542
						throw new zzja(i, k);
	//  289  531:new             #92  <Class zzja>
	//  290  534:dup             
	//  291  535:iload_3         
	//  292  536:iload           7
	//  293  538:invokespecial   #95  <Method void zzja(int, int)>
	//  294  541:athrow          
				}
...
label3:
					{
						l5 = zziu.zzb(bytebuffer);
	//    0    0:aload_2         
	//    1    1:invokestatic    #125 <Method long zziu.zzb(ByteBuffer)>
	//    2    4:lstore          15
	...
	//   42   84:iload           5
	//   43   86:int2byte        
	//   44   87:invokestatic    #136 <Method void zziu.zza(long, byte)>
							k++;
	//   45   90:iload           6
	//   46   92:iconst_1        
	//   47   93:iadd            
	...
	//   88  171:iload_3         
	//   89  172:int2byte        
	//   90  173:invokestatic    #136 <Method void zziu.zza(long, byte)>
								k = i;
	//   91  176:iload           5
	//   92  178:istore          6
								i = i1;
	...
	//  114  222:ior             
	//  115  223:int2byte        
	//  116  224:invokestatic    #136 <Method void zziu.zza(long, byte)>
								zziu.zza(l3, (byte)(c & 0x3f | 0x80));
	//  117  227:lload           11
	//  118  229:iload_3         
	//  119  230:bipush          63
	//  120  232:iand            
	...
	//  122  236:ior             
	//  123  237:int2byte        
	//  124  238:invokestatic    #136 <Method void zziu.zza(long, byte)>
								l3 += l1;
	//  125  241:lload           11
	//  126  243:lload           9
	//  127  245:ladd            
	...
	//  157  304:ior             
	//  158  305:int2byte        
	//  159  306:invokestatic    #136 <Method void zziu.zza(long, byte)>
								l1 = l3 + l1;
	//  160  309:lload           11
	//  161  311:lload           9
	//  162  313:ladd            
	//  163  314:lstore          9
								zziu.zza(l3, (byte)(c >>> 6 & 0x3f | 0x80));
	//  164  316:lload           11
	//  165  318:iload_3         
	//  166  319:bipush          6
	//  167  321:iushr           
	...
	//  171  328:ior             
	//  172  329:int2byte        
	//  173  330:invokestatic    #136 <Method void zziu.zza(long, byte)>
								zziu.zza(l1, (byte)(c & 0x3f | 0x80));
	//  174  333:lload           9
	//  175  335:iload_3         
	//  176  336:bipush          63
	//  177  338:iand            
	...
	//  179  342:ior             
	//  180  343:int2byte        
	//  181  344:invokestatic    #136 <Method void zziu.zza(long, byte)>
								l3 = l1 + 1L;
	//  182  347:lload           9
	//  183  349:lconst_1        
	//  184  350:ladd            
	...
	//  229  440:ior             
	//  230  441:int2byte        
	//  231  442:invokestatic    #136 <Method void zziu.zza(long, byte)>
								l3 = l1 + 1L;
	//  232  445:lload           9
	//  233  447:lconst_1        
	//  234  448:ladd            
	...
	//  236  451:sipush          128
	//  237  454:istore          5
								zziu.zza(l1, (byte)(i1 >>> 12 & 0x3f | 0x80));
	//  238  456:lload           9
	//  239  458:iload           7
	//  240  460:bipush          12
	//  241  462:iushr           
	...
	//  245  469:ior             
	//  246  470:int2byte        
	//  247  471:invokestatic    #136 <Method void zziu.zza(long, byte)>
								l4 = l3 + 1L;
	//  248  474:lload           11
	//  249  476:lconst_1        
	//  250  477:ladd            
	//  251  478:lstore          13
								zziu.zza(l3, (byte)(i1 >>> 6 & 0x3f | 0x80));
	//  252  480:lload           11
	//  253  482:iload           7
	//  254  484:bipush          6
	//  255  486:iushr           
	...
	//  259  493:ior             
	//  260  494:int2byte        
	//  261  495:invokestatic    #136 <Method void zziu.zza(long, byte)>
								l1 = 1L;
	//  262  498:lconst_1        
	//  263  499:lstore          9
								zziu.zza(l4, (byte)(i1 & 0x3f | 0x80));
	//  264  501:lload           13
	//  265  503:iload           7
	//  266  505:bipush          63
	//  267  507:iand            
	...
	//  269  511:ior             
	//  270  512:int2byte        
	//  271  513:invokestatic    #136 <Method void zziu.zza(long, byte)>
								l3 = l4 + 1L;
	//  272  516:lload           13
	//  273  518:lconst_1        
	//  274  519:ladd            
	...
	//  288  545:istore          5
					...
					throw new zzja(i - 1, j1);
	//  289  547:new             #92  <Class zzja>
	//  290  550:dup             
	//  291  551:iload           5
	//  292  553:iconst_1        
	//  293  554:isub            
	//  294  555:iload           8
	//  295  557:invokespecial   #95  <Method void zzja(int, int)>
	//  296  560:athrow          
				}
				if('\uD800' <= c && c <= '\uDFFF')
	...
	//* 315  598:ifne            613
						throw new zzja(i, j1);
	//  316  601:new             #92  <Class zzja>
	//  317  604:dup             
	//  318  605:iload           5
	//  319  607:iload           8
	//  320  609:invokespecial   #95  <Method void zzja(int, int)>
	//  321  612:athrow          
				}
				charsequence = ((CharSequence) (new StringBuilder(46)));
	...
	final String zzi(byte abyte0[], int i, int j)
		throws zzgf
	{
	...
	//   21   26:iload           7
	//   22   28:icmpge          66
				byte byte0 = zziu.zza(abyte0, i);
	//   23   31:aload_1         
	//   24   32:iload_2         
	//   25   33:i2l             
	//   26   34:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//   27   37:istore          4
				if(!zzix.zzh(byte0))
					break;
	//   28   39:iload           4
	//   29   41:invokestatic    #149 <Method boolean zzix.zzh(byte)>
	//   30   44:ifeq            66
				i++;
	//   31   47:iload_2         
	//   32   48:iconst_1        
	...
	//   36   53:aload           8
	//   37   55:iload_3         
	//   38   56:invokestatic    #152 <Method void zzix.zzb(byte, char[], int)>
				j++;
	//   39   59:iload_3         
	//   40   60:iconst_1        
	//   41   61:iadd            
...
label0:
	...
	//   55   82:iadd            
	//   56   83:istore          6
				byte byte1 = zziu.zza(abyte0, j);
	//   57   85:aload_1         
	//   58   86:iload_3         
	//   59   87:i2l             
	//   60   88:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//   61   91:istore          4
				if(zzix.zzh(byte1))
	//*  62   93:iload           4
	//*  63   95:invokestatic    #149 <Method boolean zzix.zzh(byte)>
	//*  64   98:ifeq            162
				{
					j = i + 1;
	//   65  101:iload_2         
	...
	//   70  107:aload           8
	//   71  109:iload_2         
	//   72  110:invokestatic    #152 <Method void zzix.zzb(byte, char[], int)>
					i = j;
	//   73  113:iload_3         
	//   74  114:istore_2        
					j = l;
	...
	//   78  119:iload           7
	//   79  121:icmpge          159
						byte1 = zziu.zza(abyte0, j);
	//   80  124:aload_1         
	//   81  125:iload_3         
	//   82  126:i2l             
	//   83  127:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//   84  130:istore          4
						if(!zzix.zzh(byte1))
							continue label0;
	//   85  132:iload           4
	//   86  134:invokestatic    #149 <Method boolean zzix.zzh(byte)>
	//   87  137:ifeq            159
						j++;
	//   88  140:iload_3         
	//   89  141:iconst_1        
	...
	//   93  146:aload           8
	//   94  148:iload_2         
	//   95  149:invokestatic    #152 <Method void zzix.zzb(byte, char[], int)>
						i++;
	//   96  152:iload_2         
	//   97  153:iconst_1        
	//   98  154:iadd            
	...
	//* 101  159:goto            74
				if(zzix.zzi(byte1))
	//* 102  162:iload           4
	//* 103  164:invokestatic    #154 <Method boolean zzix.zzi(byte)>
	//* 104  167:ifeq            208
				{
					if(l < i1)
	//* 105  170:iload           6
	...
	//* 107  174:icmpge          204
					{
						zzix.zzb(byte1, zziu.zza(abyte0, l), ac, i);
	//  108  177:iload           4
	//  109  179:aload_1         
	//  110  180:iload           6
	//  111  182:i2l             
	//  112  183:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  113  186:aload           8
	//  114  188:iload_2         
	//  115  189:invokestatic    #157 <Method void zzix.zzb(byte, byte, char[], int)>
						j = l + 1;
	//  116  192:iload           6
	//  117  194:iconst_1        
	//  118  195:iadd            
	...
	//* 124  201:goto            74
					{
						throw zzgf.zzfp();
	//  125  204:invokestatic    #161 <Method zzgf zzgf.zzfp()>
	//  126  207:athrow          
					}
				} else
				if(zzix.zzj(byte1))
	//* 127  208:iload           4
	//* 128  210:invokestatic    #164 <Method boolean zzix.zzj(byte)>
	//* 129  213:ifeq            266
				{
					if(l < i1 - 1)
	//* 130  216:iload           6
	...
	//  137  228:iadd            
	//  138  229:istore_3        
						zzix.zzb(byte1, zziu.zza(abyte0, l), zziu.zza(abyte0, j), ac, i);
	//  139  230:iload           4
	//  140  232:aload_1         
	//  141  233:iload           6
	//  142  235:i2l             
	//  143  236:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  144  239:aload_1         
	//  145  240:iload_3         
	//  146  241:i2l             
	//  147  242:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  148  245:aload           8
	//  149  247:iload_2         
	//  150  248:invokestatic    #167 <Method void zzix.zzb(byte, byte, byte, char[], int)>
						j++;
	//  151  251:iload_3         
	//  152  252:iconst_1        
	//  153  253:iadd            
	...
	//* 159  259:goto            74
					{
						throw zzgf.zzfp();
	//  160  262:invokestatic    #161 <Method zzgf zzgf.zzfp()>
	//  161  265:athrow          
					}
				} else
				if(l < i1 - 2)
	...
	//  169  278:iadd            
	//  170  279:istore_3        
					byte byte2 = zziu.zza(abyte0, l);
	//  171  280:aload_1         
	//  172  281:iload           6
	//  173  283:i2l             
	//  174  284:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  175  287:istore          5
					l = j + 1;
	//  176  289:iload_3         
	//  177  290:iconst_1        
	//  178  291:iadd            
	//  179  292:istore          6
					zzix.zzb(byte1, byte2, zziu.zza(abyte0, j), zziu.zza(abyte0, l), ac, i);
	//  180  294:iload           4
	//  181  296:iload           5
	//  182  298:aload_1         
	//  183  299:iload_3         
	//  184  300:i2l             
	//  185  301:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  186  304:aload_1         
	//  187  305:iload           6
	//  188  307:i2l             
	//  189  308:invokestatic    #19  <Method byte zziu.zza(byte[], long)>
	//  190  311:aload           8
	//  191  313:iload_2         
	//  192  314:invokestatic    #170 <Method void zzix.zzb(byte, byte, byte, byte, char[], int)>
					j = l + 1;
	//  193  317:iload           6
	//  194  319:iconst_1        
	//  195  320:iadd            
	...
	//* 203  328:goto            74
				{
					throw zzgf.zzfp();
	//  204  331:invokestatic    #161 <Method zzgf zzgf.zzfp()>
	//  205  334:athrow          
				}
			} while(true);
