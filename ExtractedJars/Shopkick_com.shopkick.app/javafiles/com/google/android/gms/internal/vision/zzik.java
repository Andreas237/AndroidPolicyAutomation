...
final class zzik
{
	...
	{
		zzeo = ((zzeo) (new zzil(zzeo)));
	//    0    0:new             #8   <Class zzil>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #12  <Method void zzil(zzeo)>
	//    4    8:astore_0        
		StringBuilder stringbuilder = new StringBuilder(((zzim) (zzeo)).size());
	//    5    9:new             #14  <Class StringBuilder>
	//    6   12:dup             
	//    7   13:aload_0         
	//    8   14:invokeinterface #20  <Method int zzim.size()>
	//    9   19:invokespecial   #23  <Method void StringBuilder(int)>
	//   10   22:astore_3        
		for(int i = 0; i < ((zzim) (zzeo)).size(); i++)
	//*  11   23:iconst_0        
	//*  12   24:istore_1        
	//*  13   25:iload_1         
	//*  14   26:aload_0         
	//*  15   27:invokeinterface #20  <Method int zzim.size()>
	//*  16   32:icmpge          283
		{
			byte byte0 = ((zzim) (zzeo)).zzai(i);
	//   17   35:aload_0         
	//   18   36:iload_1         
	//   19   37:invokeinterface #27  <Method byte zzim.zzai(int)>
	//   20   42:istore_2        
			if(byte0 != 34)
	//*  21   43:iload_2         
	//*  22   44:bipush          34
