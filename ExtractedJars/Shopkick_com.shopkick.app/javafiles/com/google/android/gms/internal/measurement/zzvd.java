	...
	implements zzve, RandomAccess
{
	...
	//    1    1:invokespecial   #39  <Method void zzta()>
		zzbzz = ((List) (arraylist));
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #41  <Field List zzbzz>
	//    5    9:return          
	}
	...
	//    4    6:invokevirtual   #66  <Method void zzta.zzua()>
		zzbzz.add(i, obj);
	//    5    9:aload_0         
	//    6   10:getfield        #41  <Field List zzbzz>
	//    7   13:iload_1         
	//    8   14:aload_2         
	...
	//   10   23:astore          4
		boolean flag = zzbzz.addAll(i, ((Collection) (obj)));
	//   11   25:aload_0         
	//   12   26:getfield        #41  <Field List zzbzz>
	//   13   29:iload_1         
	//   14   30:aload           4
	...
	//    1    1:invokevirtual   #66  <Method void zzta.zzua()>
		zzbzz.clear();
	//    2    4:aload_0         
	//    3    5:getfield        #41  <Field List zzbzz>
	...
	{
		Object obj = zzbzz.get(i);
	//    0    0:aload_0         
	//    1    1:getfield        #41  <Field List zzbzz>
	//    2    4:iload_1         
	...
	//*  22   44:ifeq            59
				zzbzz.set(i, ((Object) (s)));
	//   23   47:aload_0         
	//   24   48:getfield        #41  <Field List zzbzz>
	//   25   51:iload_1         
	//   26   52:aload_3         
	...
	//*  39   75:ifeq            90
			zzbzz.set(i, ((Object) (s1)));
	//   40   78:aload_0         
	//   41   79:getfield        #41  <Field List zzbzz>
	//   42   82:iload_1         
	//   43   83:aload_3         
	...
	//    3    5:aload_0         
	//    4    6:invokevirtual   #66  <Method void zzta.zzua()>
		return ((Object) (zzaa(zzbzz.set(i, obj))));
	//    5    9:aload_0         
	//    6   10:getfield        #41  <Field List zzbzz>
	//    7   13:iload_1         
	//    8   14:aload_2         
	...
	//    8   16:astore_2        
			arraylist.addAll(((Collection) (zzbzz)));
	//    9   17:aload_2         
	//   10   18:aload_0         
	//   11   19:getfield        #41  <Field List zzbzz>
	//   12   22:invokevirtual   #134 <Method boolean ArrayList.addAll(Collection)>
	//   13   25:pop             
			return ((zzuu) (new zzvd(arraylist)));
	//   14   26:new             #2   <Class zzvd>
	//   15   29:dup             
	//   16   30:aload_2         
	//   17   31:invokespecial   #38  <Method void zzvd(ArrayList)>
	//   18   34:areturn         
		} else
		{
	...
	//   20   38:dup             
	//   21   39:invokespecial   #137 <Method void IllegalArgumentException()>
	//   22   42:athrow          
		}
	}
	...
	{
		return Collections.unmodifiableList(zzbzz);
	//    0    0:aload_0         
	//    1    1:getfield        #41  <Field List zzbzz>
	...
	//    3    7:astore_0        
		zzbzx = zzvd1;
	//    4    8:aload_0         
	//    5    9:putstatic       #23  <Field zzvd zzbzx>
		((zzta) (zzvd1)).zzsw();
	//    6   12:aload_0         
	//    7   13:invokevirtual   #26  <Method void zzta.zzsw()>
		zzbzy = ((zzve) (zzbzx));
	//    8   16:getstatic       #23  <Field zzvd zzbzx>
	//    9   19:putstatic       #28  <Field zzve zzbzy>
	//*  10   22:return          
	}
}
