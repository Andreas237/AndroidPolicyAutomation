	...
	implements zzge, zzhr, RandomAccess
{
	...
	//    3    5:iconst_0        
	//    4    6:invokespecial   #31  <Method void zzem(boolean[], int)>
	//    5    9:return          
	}

	private zzem(boolean aflag[], int i)
	{
	//    0    0:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #34  <Field boolean[] zzrw>
		size = i;
	//    5    9:aload_0         
	//    6   10:iload_2         
	...
	private final void zza(int i, boolean flag)
	{
		((zzef)this).zzcj();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #41  <Method void zzef.zzcj()>
		if(i >= 0)
	//*   2    4:iload_1         
	//*   3    5:iflt            122
		{
	...
	//*   9   15:icmpgt          122
			{
				boolean aflag[] = zzrw;
	//   10   18:aload_0         
	//   11   19:getfield        #34  <Field boolean[] zzrw>
	//   12   22:astore          4
				if(j < aflag.length)
	//*  13   24:iload_3         
	//*  14   25:aload           4
	...
	//   42   66:invokestatic    #47  <Method void System.arraycopy(Object, int, Object, int, int)>
					System.arraycopy(((Object) (zzrw)), i, ((Object) (aflag1)), i + 1, size - i);
	//   43   69:aload_0         
	//   44   70:getfield        #34  <Field boolean[] zzrw>
	//   45   73:iload_1         
	//   46   74:aload           5
	//   47   76:iload_1         
	//   48   77:iconst_1        
	...
	//   55   88:aload_0         
	//   56   89:aload           5
	//   57   91:putfield        #34  <Field boolean[] zzrw>
				}
				zzrw[i] = flag;
	//   58   94:aload_0         
	//   59   95:getfield        #34  <Field boolean[] zzrw>
	//   60   98:iload_1         
	//   61   99:iload_2         
	//   62  100:bastore         
				size = size + 1;
	...
	//   78  126:aload_0         
	//   79  127:iload_1         
	//   80  128:invokespecial   #56  <Method String zzag(int)>
	...
	//    9   17:aload_0         
	//   10   18:iload_1         
	//   11   19:invokespecial   #56  <Method String zzag(int)>
	...
	//   11   21:ireturn         
		collection = ((Collection) ((zzem)collection));
	//   12   22:aload_1         
	//   13   23:checkcast       #2   <Class zzem>
	//   14   26:astore_1        
		int i = ((zzem) (collection)).size;
	//   15   27:aload_1         
	...
	//   33   54:istore_2        
			boolean aflag[] = zzrw;
	//   34   55:aload_0         
	//   35   56:getfield        #34  <Field boolean[] zzrw>
	//   36   59:astore          4
			if(i > aflag.length)
	//*  37   61:iload_2         
	//*  38   62:aload           4
	//*  39   64:arraylength     
	//*  40   65:icmple          78
				zzrw = Arrays.copyOf(aflag, i);
	//   41   68:aload_0         
	//   42   69:aload           4
	//   43   71:iload_2         
	//   44   72:invokestatic    #107 <Method boolean[] Arrays.copyOf(boolean[], int)>
	//   45   75:putfield        #34  <Field boolean[] zzrw>
			System.arraycopy(((Object) (((zzem) (collection)).zzrw)), 0, ((Object) (zzrw)), size, ((zzem) (collection)).size);
	//   46   78:aload_1         
	//   47   79:getfield        #34  <Field boolean[] zzrw>
	//   48   82:iconst_0        
	//   49   83:aload_0         
	//   50   84:getfield        #34  <Field boolean[] zzrw>
	//   51   87:aload_0         
	...
	//*   5    7:aload_1         
	//*   6    8:instanceof      #2   <Class zzem>
	//*   7   11:ifne            20
			return super.equals(obj);
	//    8   14:aload_0         
	//    9   15:aload_1         
	//   10   16:invokespecial   #118 <Method boolean zzef.equals(Object)>
	//   11   19:ireturn         
		obj = ((Object) ((zzem)obj));
	//   12   20:aload_1         
	//   13   21:checkcast       #2   <Class zzem>
	//   14   24:astore_1        
		if(size != ((zzem) (obj)).size)
	//*  15   25:aload_0         
	...
	//   20   36:iconst_0        
	//   21   37:ireturn         
		obj = ((Object) (((zzem) (obj)).zzrw));
	//   22   38:aload_1         
	//   23   39:getfield        #34  <Field boolean[] zzrw>
	//   24   42:astore_1        
	...
	//*  30   50:icmpge          74
			if(zzrw[i] != obj[i])
	//*  31   53:aload_0         
	//*  32   54:getfield        #34  <Field boolean[] zzrw>
	//*  33   57:iload_2         
	//*  34   58:baload          
	//*  35   59:aload_1         
	//*  36   60:iload_2         
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #122 <Method void zzaf(int)>
		return ((Object) (Boolean.valueOf(zzrw[i])));
	//    3    5:aload_0         
	//    4    6:getfield        #34  <Field boolean[] zzrw>
	//    5    9:iload_1         
	//    6   10:baload          
	...
	//*   7    9:icmpge          34
			j = j * 31 + zzga.zzj(zzrw[i]);
	//    8   12:iload_2         
	//    9   13:bipush          31
	//   10   15:imul            
	//   11   16:aload_0         
	//   12   17:getfield        #34  <Field boolean[] zzrw>
	//   13   20:iload_1         
	//   14   21:baload          
	//   15   22:invokestatic    #132 <Method int zzga.zzj(boolean)>
	//   16   25:iadd            
	//   17   26:istore_2        
	...
	//    2    4:aload_0         
	//    3    5:iload_1         
	//    4    6:invokespecial   #122 <Method void zzaf(int)>
		boolean aflag[] = zzrw;
	//    5    9:aload_0         
	//    6   10:getfield        #34  <Field boolean[] zzrw>
	//    7   13:astore          4
	...
	//*  18   28:isub            
	//*  19   29:icmpge          46
			System.arraycopy(((Object) (aflag)), i + 1, ((Object) (aflag)), i, j - i);
	//   20   32:aload           4
	//   21   34:iload_1         
	//   22   35:iconst_1        
	//   23   36:iadd            
	...
	//   27   41:iload_1         
	//   28   42:isub            
	//   29   43:invokestatic    #47  <Method void System.arraycopy(Object, int, Object, int, int)>
		size = size - 1;
	//   30   46:aload_0         
	//   31   47:aload_0         
	...
	//   36   56:aload_0         
	//   37   57:aload_0         
	//   38   58:getfield        #50  <Field int modCount>
	//   39   61:iconst_1        
	//   40   62:iadd            
	//   41   63:putfield        #50  <Field int modCount>
		return ((Object) (Boolean.valueOf(flag)));
	//   42   66:iload_3         
	//   43   67:invokestatic    #126 <Method Boolean Boolean.valueOf(boolean)>
	//   44   70:areturn         
	}
	...
	//*   7   11:icmpge          79
			if(obj.equals(((Object) (Boolean.valueOf(zzrw[i])))))
	//*   8   14:aload_1         
	//*   9   15:aload_0         
	//*  10   16:getfield        #34  <Field boolean[] zzrw>
	//*  11   19:iload_2         
	//*  12   20:baload          
	...
	//*  15   27:ifeq            72
			{
				obj = ((Object) (zzrw));
	//   16   30:aload_0         
	//   17   31:getfield        #34  <Field boolean[] zzrw>
	//   18   34:astore_1        
	...
	//   27   45:iload_2         
	//   28   46:isub            
	//   29   47:invokestatic    #47  <Method void System.arraycopy(Object, int, Object, int, int)>
				size = size - 1;
	//   30   50:aload_0         
	//   31   51:aload_0         
	...
	//   36   60:aload_0         
	//   37   61:aload_0         
	//   38   62:getfield        #50  <Field int modCount>
	//   39   65:iconst_1        
	//   40   66:iadd            
	//   41   67:putfield        #50  <Field int modCount>
				return true;
	//   42   70:iconst_1        
	//   43   71:ireturn         
			}
	...
	//    3    7:istore_3        
		((zzef)this).zzcj();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #41  <Method void zzef.zzcj()>
		zzaf(i);
	//    6   12:aload_0         
	//    7   13:iload_1         
	//    8   14:invokespecial   #122 <Method void zzaf(int)>
		obj = ((Object) (zzrw));
	//    9   17:aload_0         
	//   10   18:getfield        #34  <Field boolean[] zzrw>
	//   11   21:astore_2        
	...
	//*   2    2:getfield        #36  <Field int size>
	//*   3    5:icmplt          28
			return ((zzge) (new zzem(Arrays.copyOf(zzrw, i), size)));
	//    4    8:new             #2   <Class zzem>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:getfield        #34  <Field boolean[] zzrw>
	//    8   16:iload_1         
	//    9   17:invokestatic    #107 <Method boolean[] Arrays.copyOf(boolean[], int)>
	//   10   20:aload_0         
	//   11   21:getfield        #36  <Field int size>
	//   12   24:invokespecial   #31  <Method void zzem(boolean[], int)>
	//   13   27:areturn         
		else
	...
	{
		zzem zzem1 = new zzem();
	//    0    0:new             #2   <Class zzem>
	//    1    3:dup             
	//    2    4:invokespecial   #22  <Method void zzem()>
	//    3    7:astore_0        
		zzrv = zzem1;
	//    4    8:aload_0         
	//    5    9:putstatic       #24  <Field zzem zzrv>
		((zzef) (zzem1)).zzci();
	//    6   12:aload_0         
