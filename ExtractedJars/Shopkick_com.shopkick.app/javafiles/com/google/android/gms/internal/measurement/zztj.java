...
final class zztj extends zzto
{
	...
	//   11   15:aload_0         
	//   12   16:iload_2         
	//   13   17:putfield        #18  <Field int zzbtu>
		zzbtv = j;
	//   14   20:aload_0         
	//   15   21:iload_3         
	//   16   22:putfield        #20  <Field int zzbtv>
	//   17   25:return          
	}
	...
	public final int size()
	{
		return zzbtv;
	//    0    0:aload_0         
	//    1    1:getfield        #20  <Field int zzbtv>
	//    2    4:ireturn         
	}
	...
	//   58  101:athrow          
		...
		{
			return zzbtx[zzbtu + i];
	//   59  102:aload_0         
	//   60  103:getfield        #60  <Field byte[] zzbtx>
	//   61  106:aload_0         
	//   62  107:getfield        #18  <Field int zzbtu>
	//   63  110:iload_1         
	//   64  111:iadd            
	//   65  112:baload          
	//   66  113:ireturn         
	...
	final byte zzan(int i)
	{
		return zzbtx[zzbtu + i];
	//    0    0:aload_0         
	//    1    1:getfield        #60  <Field byte[] zzbtx>
	//    2    4:aload_0         
	//    3    5:getfield        #18  <Field int zzbtu>
	//    4    8:iload_1         
	//    5    9:iadd            
	//    6   10:baload          
	//    7   11:ireturn         
	...
	protected final int zzug()
	{
		return zzbtu;
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field int zzbtu>
	//    2    4:ireturn         
	}
