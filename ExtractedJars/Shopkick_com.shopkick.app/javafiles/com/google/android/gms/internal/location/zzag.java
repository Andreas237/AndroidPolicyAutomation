...
final class zzag extends zzai
{
	...
	{
		zzcs = geofencingrequest;
	//    0    0:aload_0         
	//    1    1:aload_3         
	//    2    2:putfield        #12  <Field GeofencingRequest zzcs>
		zzbz = pendingintent;
	//    3    5:aload_0         
	//    4    6:aload           4
	...
	//    6   11:aload_0         
	//    7   12:aload_2         
	//    8   13:invokespecial   #17  <Method void zzai(GoogleApiClient)>
	//    9   16:return          
	}
	...
	{
		((zzaz)anyclient).zza(zzcs, zzbz, ((com.google.android.gms.common.api.internal.BaseImplementation.ResultHolder) (this)));
	//    0    0:aload_1         
	//    1    1:checkcast       #24  <Class zzaz>
	//    2    4:aload_0         
	//    3    5:getfield        #12  <Field GeofencingRequest zzcs>
	//    4    8:aload_0         
	//    5    9:getfield        #14  <Field PendingIntent zzbz>
	//    6   12:aload_0         
	//    7   13:invokevirtual   #28  <Method void zzaz.zza(GeofencingRequest, PendingIntent, com.google.android.gms.common.api.internal.BaseImplementation$ResultHolder)>
	//    8   16:return          
	}
