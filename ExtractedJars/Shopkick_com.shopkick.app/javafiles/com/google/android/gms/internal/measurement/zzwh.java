...
final class zzwh
{
	...
	//    6   12:putfield        #25  <Field ConcurrentMap zzcbl>
	//    7   15:aload_0         
	//    8   16:new             #27  <Class zzvk>
	//    9   19:dup             
	//   10   20:invokespecial   #28  <Method void zzvk()>
	//   11   23:putfield        #30  <Field zzwm zzcbk>
	//   12   26:return          
	}
	...
	{
		return zzcbj;
	//    0    0:getstatic       #18  <Field zzwh zzcbj>
	//    1    3:areturn         
	}
	...
	//    3    6:pop             
		zzwl zzwl1 = (zzwl)zzcbl.get(((Object) (class1)));
	//    4    7:aload_0         
	//    5    8:getfield        #25  <Field ConcurrentMap zzcbl>
	//    6   11:aload_1         
	...
	//*  13   24:ifnonnull       73
		{
			obj = ((Object) (zzcbk.zzh(class1)));
	//   14   27:aload_0         
	//   15   28:getfield        #30  <Field zzwm zzcbk>
	//   16   31:aload_1         
	...
	//   26   51:pop             
			class1 = ((Class) ((zzwl)zzcbl.putIfAbsent(((Object) (class1)), obj)));
	//   27   52:aload_0         
	//   28   53:getfield        #25  <Field ConcurrentMap zzcbl>
	//   29   56:aload_1         
	//   30   57:aload_2         
	...
	private final ConcurrentMap zzcbl = new ConcurrentHashMap();
	...
	//    3    7:putstatic       #18  <Field zzwh zzcbj>
	//*   4   10:return          
	}
}
