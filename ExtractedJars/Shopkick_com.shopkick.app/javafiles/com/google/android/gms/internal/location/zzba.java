...
final class zzba extends zzan
{
	...
	//    1    2:ldc1            #23  <String "Unexpected call to onRemoveGeofencesByPendingIntentResult">
	...
	//    4    9:ldc1            #32  <String "onAddGeofenceResult called multiple times">
	...
	//    7   15:return          
		...
		{
			as = ((String []) (LocationStatusCodes.zzd(LocationStatusCodes.zzc(i))));
	//    8   16:iload_1         
	//    9   17:invokestatic    #38  <Method int LocationStatusCodes.zzc(int)>
	//   10   20:invokestatic    #42  <Method com.google.android.gms.common.api.Status LocationStatusCodes.zzd(int)>
	//   11   23:astore_2        
			zzdf.setResult(((Object) (as)));
	//   12   24:aload_0         
	//   13   25:getfield        #14  <Field com.google.android.gms.common.api.internal.BaseImplementation$ResultHolder zzdf>
	//   14   28:aload_2         
	//   15   29:invokeinterface #48  <Method void com.google.android.gms.common.api.internal.BaseImplementation$ResultHolder.setResult(Object)>
			zzdf = null;
	//   16   34:aload_0         
	//   17   35:aconst_null     
	...
	//    0    0:ldc1            #21  <String "LocationClientImpl">
	//    1    2:ldc1            #51  <String "Unexpected call to onRemoveGeofencesByRequestIdsResult">
	//    2    4:invokestatic    #29  <Method int Log.wtf(String, String)>
	//    3    7:pop             
	//    4    8:return          
	}
