...
final class zzuk extends Enum
{
	...
	//    4    6:aload_0         
	//    5    7:iload_3         
	//    6    8:putfield        #44  <Field boolean zzbxx>
	//    7   11:return          
	}

	public static zzuk[] values()
	{
		return (zzuk[])((zzuk []) (zzbxy)).clone();
	//    0    0:getstatic       #38  <Field zzuk[] zzbxy>
	...
	public static final zzuk zzbxt;
	public static final zzuk zzbxu;
	public static final zzuk zzbxv;
	public static final zzuk zzbxw;
	private static final zzuk zzbxy[];
	private final boolean zzbxx;

	static 
	{
		zzbxt = new zzuk("SCALAR", 0, false);
	...
	//    6   11:putstatic       #24  <Field zzuk zzbxt>
		zzbxu = new zzuk("VECTOR", 1, true);
	...
	//   13   25:putstatic       #28  <Field zzuk zzbxu>
		zzbxv = new zzuk("PACKED_VECTOR", 2, true);
	...
	//   20   39:putstatic       #32  <Field zzuk zzbxv>
		zzbxw = new zzuk("MAP", 3, false);
	...
	//   27   53:putstatic       #36  <Field zzuk zzbxw>
		zzbxy = (new zzuk[] {
			zzbxt, zzbxu, zzbxv, zzbxw
		});
	//   28   56:iconst_4        
	//   29   57:anewarray       zzuk[]
	//   30   60:dup             
	//   31   61:iconst_0        
	//   32   62:getstatic       #24  <Field zzuk zzbxt>
	//   33   65:aastore         
	//   34   66:dup             
	//   35   67:iconst_1        
	//   36   68:getstatic       #28  <Field zzuk zzbxu>
	//   37   71:aastore         
	//   38   72:dup             
	//   39   73:iconst_2        
	//   40   74:getstatic       #32  <Field zzuk zzbxv>
	//   41   77:aastore         
	//   42   78:dup             
	//   43   79:iconst_3        
	//   44   80:getstatic       #36  <Field zzuk zzbxw>
	//   45   83:aastore         
	//   46   84:putstatic       #38  <Field zzuk[] zzbxy>
	//*  47   87:return          
	}
}
