...
public static final class zzge$zzv$zzb extends Enum
	implements zzcj
{

	public static zzge$zzv$zzb[] values()
	{
		return (zzge$zzv$zzb[])((zzge$zzv$zzb []) (zzbhp)).clone();
	...
	public static final zzge$zzv$zzb zzbhk;
	private static final zzge$zzv$zzb zzbhl;
	private static final zzge$zzv$zzb zzbhm;
	private static final zzge$zzv$zzb zzbhn;
	private static final zzge$zzv$zzb zzbho;
	private static final zzge$zzv$zzb zzbhp[];
	private static final zzck zzbq = new zzgr();
	private final int value;

	static 
	{
		zzbhk = new zzge$zzv$zzb("DEFAULT", 0, 0);
	...
	//    6   11:putstatic       #36  <Field zzge$zzv$zzb zzbhk>
		zzbhl = new zzge$zzv$zzb("UNMETERED_ONLY", 1, 1);
	...
	//   13   25:putstatic       #40  <Field zzge$zzv$zzb zzbhl>
		zzbhm = new zzge$zzv$zzb("UNMETERED_OR_DAILY", 2, 2);
	...
	//   20   39:putstatic       #44  <Field zzge$zzv$zzb zzbhm>
		zzbhn = new zzge$zzv$zzb("FAST_IF_RADIO_AWAKE", 3, 3);
	...
	//   27   53:putstatic       #48  <Field zzge$zzv$zzb zzbhn>
		zzbho = new zzge$zzv$zzb("NEVER", 4, 4);
	...
	//   34   67:putstatic       #52  <Field zzge$zzv$zzb zzbho>
		zzbhp = (new zzge$zzv$zzb[] {
			zzbhk, zzbhl, zzbhm, zzbhn, zzbho
		});
	//   35   70:iconst_5        
	//   36   71:anewarray       zzge$zzv$zzb[]
	//   37   74:dup             
	//   38   75:iconst_0        
	...
	private zzge$zzv$zzb(String s, int i, int j)
	{
		super(s, i);
	//    0    0:aload_0         
	//    1    1:aload_1         
