...
public final class zzsr
{
	...
	{
		zzbsd.zza(throwable, printstream);
	//    0    0:getstatic       #91  <Field zzss zzbsd>
	//    1    3:aload_0         
	//    2    4:aload_1         
	...
	//   67  138:invokevirtual   #89  <Method void Throwable.printStackTrace(PrintStream)>
		obj = ((Object) (new zza()));
	//   68  141:new             #6   <Class zzsr$zza>
	//   69  144:dup             
	//   70  145:invokespecial   #42  <Method void zzsr$zza()>
	//   71  148:astore_1        
		zzbsd = ((zzss) (obj));
	//   72  149:aload_1         
	//   73  150:putstatic       #91  <Field zzss zzbsd>
		if(integer != null)
	//*  74  153:aload_2         
	...
	//   79  164:istore_0        
		zzbse = i;
	//   80  165:iload_0         
	//   81  166:putstatic       #93  <Field int zzbse>
	//   82  169:return          
	}
}
