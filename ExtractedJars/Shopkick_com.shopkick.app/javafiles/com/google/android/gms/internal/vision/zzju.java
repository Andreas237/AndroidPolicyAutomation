...
public final class zzju
{
	...
	//    1    1:ifnull          845
_L1:
		if(!(obj instanceof zzjt)) goto _L4; else goto _L3
	//    2    4:aload_1         
	//    3    5:instanceof      #14  <Class zzjt>
	//    4    8:ifeq            471
_L3:
		int j;
		int k1;
	...
	//   13   26:pop             
			stringbuffer1.append(zzs(s));
	//   14   27:aload_3         
	//   15   28:aload_0         
	//   16   29:invokestatic    #28  <Method String zzs(String)>
...
_L4:
		s = zzs(s);
	//  226  471:aload_0         
	//  227  472:invokestatic    #28  <Method String zzs(String)>
	//  228  475:astore_0        
		stringbuffer1.append(stringbuffer);
	//  229  476:aload_3         
	//  230  477:aload_2         
...
_L2:
	...
	public static String zzb(zzjt zzjt1)
	{
		if(zzjt1 == null)
	//*   0    0:aload_0         
	//*   1    1:ifnonnull       7
	...
	//    7   14:astore_1        
		try
		{
			zza(((String) (null)), ((Object) (zzjt1)), new StringBuffer(), stringbuffer);
	//    8   15:aconst_null     
	//    9   16:aload_0         
	...
	//*  35   66:astore_0        
		{
			zzjt1 = ((zzjt) (String.valueOf(((Object) (((IllegalAccessException) (zzjt1)).getMessage())))));
	//   36   67:aload_0         
	...
	//   39   74:astore_0        
			if(((String) (zzjt1)).length() != 0)
	//*  40   75:aload_0         
	//*  41   76:invokevirtual   #120 <Method int String.length()>
	//*  42   79:ifeq            89
				return "Error printing proto: ".concat(((String) (zzjt1)));
	...
	//   51   98:areturn         
		...
		{
			zzjt1 = ((zzjt) (String.valueOf(((Object) (((InvocationTargetException) (zzjt1)).getMessage())))));
			if(((String) (zzjt1)).length() != 0)
				return "Error printing proto: ".concat(((String) (zzjt1)));
			else
				return new String("Error printing proto: ");
	...
	private static String zzs(String s)
	{
		StringBuffer stringbuffer = new StringBuffer();
