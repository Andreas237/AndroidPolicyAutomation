	...
	implements zzge, zzhr, RandomAccess
{
	...
	//    2    3:newarray        double[]
	//    3    5:iconst_0        
	//    4    6:invokespecial   #31  <Method void zzfh(double[], int)>
	//    5    9:return          
	}

	private zzfh(double ad[], int i)
	{
	//    0    0:aload_0         
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #34  <Field double[] zztd>
		size = i;
	//    5    9:aload_0         
	//    6   10:iload_2         
	...
	//*   9   17:icmpgt          127
			{
				double ad[] = zztd;
	//   10   20:aload_0         
	//   11   21:getfield        #34  <Field double[] zztd>
	//   12   24:astore          5
				if(j < ad.length)
	//*  13   26:iload           4
	//*  14   28:aload           5
	...
	//   42   71:invokestatic    #77  <Method void System.arraycopy(Object, int, Object, int, int)>
					System.arraycopy(((Object) (zztd)), i, ((Object) (ad1)), i + 1, size - i);
	//   43   74:aload_0         
	//   44   75:getfield        #34  <Field double[] zztd>
	//   45   78:iload_1         
	//   46   79:aload           6
	//   47   81:iload_1         
	//   48   82:iconst_1        
	...
	//   55   93:aload_0         
	//   56   94:aload           6
	//   57   96:putfield        #34  <Field double[] zztd>
				}
				zztd[i] = d;
	//   58   99:aload_0         
	//   59  100:getfield        #34  <Field double[] zztd>
	//   60  103:iload_1         
	//   61  104:dload_2         
	//   62  105:dastore         
				size = size + 1;
	...
	//   11   21:ireturn         
		collection = ((Collection) ((zzfh)collection));
	//   12   22:aload_1         
	//   13   23:checkcast       #2   <Class zzfh>
	//   14   26:astore_1        
		int i = ((zzfh) (collection)).size;
	//   15   27:aload_1         
	...
	//   33   54:istore_2        
			double ad[] = zztd;
	//   34   55:aload_0         
	//   35   56:getfield        #34  <Field double[] zztd>
	//   36   59:astore          4
			if(i > ad.length)
	//*  37   61:iload_2         
	//*  38   62:aload           4
	//*  39   64:arraylength     
	//*  40   65:icmple          78
				zztd = Arrays.copyOf(ad, i);
	//   41   68:aload_0         
	//   42   69:aload           4
	//   43   71:iload_2         
	//   44   72:invokestatic    #107 <Method double[] Arrays.copyOf(double[], int)>
	//   45   75:putfield        #34  <Field double[] zztd>
			System.arraycopy(((Object) (((zzfh) (collection)).zztd)), 0, ((Object) (zztd)), size, ((zzfh) (collection)).size);
	//   46   78:aload_1         
	//   47   79:getfield        #34  <Field double[] zztd>
	//   48   82:iconst_0        
	//   49   83:aload_0         
	//   50   84:getfield        #34  <Field double[] zztd>
	//   51   87:aload_0         
	...
	//   11   19:ireturn         
		obj = ((Object) ((zzfh)obj));
	//   12   20:aload_1         
	//   13   21:checkcast       #2   <Class zzfh>
	//   14   24:astore_1        
		if(size != ((zzfh) (obj)).size)
	//*  15   25:aload_0         
	...
	//   20   36:iconst_0        
	//   21   37:ireturn         
		obj = ((Object) (((zzfh) (obj)).zztd));
	//   22   38:aload_1         
	//   23   39:getfield        #34  <Field double[] zztd>
	//   24   42:astore_1        
	...
	//*  30   50:icmpge          81
			if(Double.doubleToLongBits(zztd[i]) != Double.doubleToLongBits(obj[i]))
	//*  31   53:aload_0         
	//*  32   54:getfield        #34  <Field double[] zztd>
	//*  33   57:iload_2         
	//*  34   58:daload          
	...
	//    2    2:invokespecial   #124 <Method void zzaf(int)>
		return ((Object) (Double.valueOf(zztd[i])));
	//    3    5:aload_0         
	//    4    6:getfield        #34  <Field double[] zztd>
	//    5    9:iload_1         
	//    6   10:daload          
	...
	//*   7    9:icmpge          37
			j = j * 31 + zzga.zzo(Double.doubleToLongBits(zztd[i]));
	//    8   12:iload_2         
	//    9   13:bipush          31
	//   10   15:imul            
	//   11   16:aload_0         
	//   12   17:getfield        #34  <Field double[] zztd>
	//   13   20:iload_1         
	//   14   21:daload          
	//   15   22:invokestatic    #120 <Method long Double.doubleToLongBits(double)>
	//   16   25:invokestatic    #134 <Method int zzga.zzo(long)>
	//   17   28:iadd            
	//   18   29:istore_2        
	...
	//    4    6:invokespecial   #124 <Method void zzaf(int)>
		double ad[] = zztd;
	//    5    9:aload_0         
	//    6   10:getfield        #34  <Field double[] zztd>
	//    7   13:astore          5
		double d = ad[i];
	//    8   15:aload           5
	//    9   17:iload_1         
	...
	//   27   44:iload_1         
	//   28   45:isub            
	//   29   46:invokestatic    #77  <Method void System.arraycopy(Object, int, Object, int, int)>
		size = size - 1;
	//   30   49:aload_0         
	//   31   50:aload_0         
	//   32   51:getfield        #36  <Field int size>
	//   33   54:iconst_1        
	//   34   55:isub            
	//   35   56:putfield        #36  <Field int size>
		modCount = modCount + 1;
	//   36   59:aload_0         
	//   37   60:aload_0         
	//   38   61:getfield        #80  <Field int modCount>
	//   39   64:iconst_1        
	//   40   65:iadd            
	//   41   66:putfield        #80  <Field int modCount>
		return ((Object) (Double.valueOf(d)));
	//   42   69:dload_2         
	//   43   70:invokestatic    #128 <Method Double Double.valueOf(double)>
	//   44   73:areturn         
	}
	...
	//*   7   11:icmpge          79
			if(obj.equals(((Object) (Double.valueOf(zztd[i])))))
	//*   8   14:aload_1         
	//*   9   15:aload_0         
	//*  10   16:getfield        #34  <Field double[] zztd>
	//*  11   19:iload_2         
	//*  12   20:daload          
	...
	//*  15   27:ifeq            72
			{
				obj = ((Object) (zztd));
	//   16   30:aload_0         
	//   17   31:getfield        #34  <Field double[] zztd>
	//   18   34:astore_1        
	...
	//    8   14:invokespecial   #124 <Method void zzaf(int)>
		obj = ((Object) (zztd));
	//    9   17:aload_0         
	//   10   18:getfield        #34  <Field double[] zztd>
	//   11   21:astore_2        
		double d1 = obj[i];
	//   12   22:aload_2         
	//   13   23:iload_1         
	...
	//*   3    5:icmplt          28
			return ((zzge) (new zzfh(Arrays.copyOf(zztd, i), size)));
	//    4    8:new             #2   <Class zzfh>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:getfield        #34  <Field double[] zztd>
	//    8   16:iload_1         
	//    9   17:invokestatic    #107 <Method double[] Arrays.copyOf(double[], int)>
	//   10   20:aload_0         
	//   11   21:getfield        #36  <Field int size>
	//   12   24:invokespecial   #31  <Method void zzfh(double[], int)>
	//   13   27:areturn         
		else
	...
	{
		zzfh zzfh1 = new zzfh();
	//    0    0:new             #2   <Class zzfh>
	//    1    3:dup             
	//    2    4:invokespecial   #22  <Method void zzfh()>
	//    3    7:astore_0        
		zztc = zzfh1;
	//    4    8:aload_0         
	//    5    9:putstatic       #24  <Field zzfh zztc>
		((zzef) (zzfh1)).zzci();
	//    6   12:aload_0         
