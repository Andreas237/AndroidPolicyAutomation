	...
	implements zzhe
{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #15  <Field zzhe[] zzyu>
	//    5    9:return          
	}
	...
	public final boolean zzb(Class class1)
	{
		zzhe azzhe[] = zzyu;
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field zzhe[] zzyu>
	//    2    4:astore          4
		int j = azzhe.length;
	//    3    6:aload           4
	//    4    8:arraylength     
	...
	//*   9   13:iload_3         
	//*  10   14:icmpge          39
			if(azzhe[i].zzb(class1))
	//*  11   17:aload           4
	//*  12   19:iload_2         
	//*  13   20:aaload          
	//*  14   21:aload_1         
	//*  15   22:invokeinterface #20  <Method boolean zzhe.zzb(Class)>
	//*  16   27:ifeq            32
				return true;
	//   17   30:iconst_1        
	//   18   31:ireturn         
	...
	//*  15   23:aload           5
	//*  16   25:aload_1         
	//*  17   26:invokeinterface #20  <Method boolean zzhe.zzb(Class)>
	//*  18   31:ifeq            43
				return zzhe1.zzc(class1);
	//   19   34:aload           5
	//   20   36:aload_1         
	//   21   37:invokeinterface #26  <Method zzhd zzhe.zzc(Class)>
	//   22   42:areturn         
		}
