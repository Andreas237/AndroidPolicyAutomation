...
public final class zzux extends Enum
{
	...
	//    4    6:aload_0         
	//    5    7:aload_3         
	//    6    8:putfield        #125 <Field Class zzbzo>
		zzbzp = class2;
	//    7   11:aload_0         
	//    8   12:aload           4
	//    9   14:putfield        #127 <Field Class zzbzp>
		zzbzq = obj;
	//   10   17:aload_0         
	//   11   18:aload           5
	//   12   20:putfield        #129 <Field Object zzbzq>
	//   13   23:return          
	}

	public static zzux[] values()
	{
		return (zzux[])((zzux []) (zzbzr)).clone();
	//    0    0:getstatic       #119 <Field zzux[] zzbzr>
	...
	public final Class zzwy()
	{
		return zzbzp;
	//    0    0:aload_0         
	//    1    1:getfield        #127 <Field Class zzbzp>
	//    2    4:areturn         
	}

	public static final zzux zzbze;
	public static final zzux zzbzf;
	...
	private static final zzux zzbzr[];
	...
	static 
	{
		zzbze = new zzux("VOID", 0, java/lang/Void, java/lang/Void, ((Object) (null)));
	...
	//    8   15:putstatic       #36  <Field zzux zzbze>
		zzbzf = new zzux("INT", 1, Integer.TYPE, java/lang/Integer, ((Object) (Integer.valueOf(0))));
	...
	//   18   37:putstatic       #49  <Field zzux zzbzf>
		zzbzg = new zzux("LONG", 2, Long.TYPE, java/lang/Long, ((Object) (Long.valueOf(0L))));
	...
	//   28   59:putstatic       #59  <Field zzux zzbzg>
		zzbzh = new zzux("FLOAT", 3, Float.TYPE, java/lang/Float, ((Object) (Float.valueOf(0.0F))));
	...
	//   38   81:putstatic       #69  <Field zzux zzbzh>
		zzbzi = new zzux("DOUBLE", 4, Double.TYPE, java/lang/Double, ((Object) (Double.valueOf(0.0D))));
	...
	//   48  103:putstatic       #79  <Field zzux zzbzi>
		zzbzj = new zzux("BOOLEAN", 5, Boolean.TYPE, java/lang/Boolean, ((Object) (Boolean.valueOf(false))));
	...
	//   58  125:putstatic       #89  <Field zzux zzbzj>
		zzbzk = new zzux("STRING", 6, java/lang/String, java/lang/String, "");
	...
	//   67  145:putstatic       #97  <Field zzux zzbzk>
		zzbzl = new zzux("BYTE_STRING", 7, com/google/android/gms/internal/measurement/zzte, com/google/android/gms/internal/measurement/zzte, ((Object) (zzte.zzbtq)));
	...
	//   74  160:getstatic       #105 <Field zzte zzte.zzbtq>
	//   75  163:invokespecial   #34  <Method void zzux(String, int, Class, Class, Object)>
	//   76  166:putstatic       #107 <Field zzux zzbzl>
		zzbzm = new zzux("ENUM", 8, Integer.TYPE, java/lang/Integer, ((Object) (null)));
	...
	//   85  186:putstatic       #111 <Field zzux zzbzm>
		zzbzn = new zzux("MESSAGE", 9, java/lang/Object, java/lang/Object, ((Object) (null)));
	...
	//   94  205:putstatic       #117 <Field zzux zzbzn>
		zzbzr = (new zzux[] {
			zzbze, zzbzf, zzbzg, zzbzh, zzbzi, zzbzj, zzbzk, zzbzl, zzbzm, zzbzn
		});
	//   95  208:bipush          10
	//   96  210:anewarray       zzux[]
	//   97  213:dup             
	//   98  214:iconst_0        
	//   99  215:getstatic       #36  <Field zzux zzbze>
	//  100  218:aastore         
	//  101  219:dup             
	//  102  220:iconst_1        
	//  103  221:getstatic       #49  <Field zzux zzbzf>
	//  104  224:aastore         
	//  105  225:dup             
	//  106  226:iconst_2        
	//  107  227:getstatic       #59  <Field zzux zzbzg>
	//  108  230:aastore         
	//  109  231:dup             
	//  110  232:iconst_3        
	//  111  233:getstatic       #69  <Field zzux zzbzh>
	//  112  236:aastore         
	//  113  237:dup             
	//  114  238:iconst_4        
	//  115  239:getstatic       #79  <Field zzux zzbzi>
	//  116  242:aastore         
	//  117  243:dup             
	//  118  244:iconst_5        
	//  119  245:getstatic       #89  <Field zzux zzbzj>
	//  120  248:aastore         
	//  121  249:dup             
	//  122  250:bipush          6
	//  123  252:getstatic       #97  <Field zzux zzbzk>
	//  124  255:aastore         
	//  125  256:dup             
	//  126  257:bipush          7
	//  127  259:getstatic       #107 <Field zzux zzbzl>
	//  128  262:aastore         
	//  129  263:dup             
	//  130  264:bipush          8
	//  131  266:getstatic       #111 <Field zzux zzbzm>
	//  132  269:aastore         
	//  133  270:dup             
	//  134  271:bipush          9
	//  135  273:getstatic       #117 <Field zzux zzbzn>
	//  136  276:aastore         
	//  137  277:putstatic       #119 <Field zzux[] zzbzr>
	//* 138  280:return          
	}
}
