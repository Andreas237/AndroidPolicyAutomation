	...
	implements zzuu, zzwg, RandomAccess
{
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #34  <Field long[] zzcae>
		size = i;
	//    5    9:aload_0         
	//    6   10:iload_2         
	...
	//*   9   17:icmpgt          127
			{
				long al[] = zzcae;
	//   10   20:aload_0         
	//   11   21:getfield        #34  <Field long[] zzcae>
	//   12   24:astore          5
				if(j < al.length)
	//*  13   26:iload           4
	//*  14   28:aload           5
	...
	//   42   71:invokestatic    #77  <Method void System.arraycopy(Object, int, Object, int, int)>
					System.arraycopy(((Object) (zzcae)), i, ((Object) (al1)), i + 1, size - i);
	//   43   74:aload_0         
	//   44   75:getfield        #34  <Field long[] zzcae>
	//   45   78:iload_1         
	//   46   79:aload           6
	//   47   81:iload_1         
	//   48   82:iconst_1        
	...
	//   55   93:aload_0         
	//   56   94:aload           6
	//   57   96:putfield        #34  <Field long[] zzcae>
				}
				zzcae[i] = l;
	//   58   99:aload_0         
	//   59  100:getfield        #34  <Field long[] zzcae>
	//   60  103:iload_1         
	//   61  104:lload_2         
	//   62  105:lastore         
				size = size + 1;
	...
	//   33   54:istore_2        
			long al[] = zzcae;
	//   34   55:aload_0         
	//   35   56:getfield        #34  <Field long[] zzcae>
	//   36   59:astore          4
			if(i > al.length)
	//*  37   61:iload_2         
	//*  38   62:aload           4
	//*  39   64:arraylength     
	//*  40   65:icmple          78
				zzcae = Arrays.copyOf(al, i);
	//   41   68:aload_0         
	//   42   69:aload           4
	//   43   71:iload_2         
	//   44   72:invokestatic    #107 <Method long[] Arrays.copyOf(long[], int)>
	//   45   75:putfield        #34  <Field long[] zzcae>
			System.arraycopy(((Object) (((zzvj) (collection)).zzcae)), 0, ((Object) (zzcae)), size, ((zzvj) (collection)).size);
	//   46   78:aload_1         
	//   47   79:getfield        #34  <Field long[] zzcae>
	//   48   82:iconst_0        
	//   49   83:aload_0         
	//   50   84:getfield        #34  <Field long[] zzcae>
	//   51   87:aload_0         
	...
	//   20   36:iconst_0        
	//   21   37:ireturn         
		obj = ((Object) (((zzvj) (obj)).zzcae));
	//   22   38:aload_1         
	//   23   39:getfield        #34  <Field long[] zzcae>
	//   24   42:astore_1        
	...
	//*  30   50:icmpge          75
			if(zzcae[i] != obj[i])
	//*  31   53:aload_0         
	//*  32   54:getfield        #34  <Field long[] zzcae>
	//*  33   57:iload_2         
	//*  34   58:laload          
	//*  35   59:aload_1         
	//*  36   60:iload_2         
	...
	//    2    2:invokespecial   #128 <Method void zzaj(int)>
		return zzcae[i];
	//    3    5:aload_0         
	//    4    6:getfield        #34  <Field long[] zzcae>
	//    5    9:iload_1         
	//    6   10:laload          
	//    7   11:lreturn         
	}
	...
	//*   7    9:icmpge          34
			j = j * 31 + zzuq.zzbd(zzcae[i]);
	//    8   12:iload_2         
	//    9   13:bipush          31
	//   10   15:imul            
	//   11   16:aload_0         
	//   12   17:getfield        #34  <Field long[] zzcae>
	//   13   20:iload_1         
	//   14   21:laload          
	...
	//    4    6:invokespecial   #128 <Method void zzaj(int)>
		long al[] = zzcae;
	//    5    9:aload_0         
	//    6   10:getfield        #34  <Field long[] zzcae>
	//    7   13:astore          5
		long l = al[i];
	//    8   15:aload           5
	//    9   17:iload_1         
	...
	//   44   68:lload_3         
	//   45   69:invokestatic    #126 <Method Long Long.valueOf(long)>
	//   46   72:areturn         
	}
	...
	//*   7   11:icmpge          81
			if(obj.equals(((Object) (Long.valueOf(zzcae[i])))))
	//*   8   14:aload_1         
	//*   9   15:aload_0         
	//*  10   16:getfield        #34  <Field long[] zzcae>
	//*  11   19:iload_2         
	//*  12   20:laload          
	...
	//*  15   27:ifeq            74
			{
				obj = ((Object) (zzcae));
	//   16   30:aload_0         
	//   17   31:getfield        #34  <Field long[] zzcae>
	//   18   34:astore_1        
	...
	//    8   14:invokespecial   #128 <Method void zzaj(int)>
		obj = ((Object) (zzcae));
	//    9   17:aload_0         
	//   10   18:getfield        #34  <Field long[] zzcae>
	//   11   21:astore_2        
		long l1 = obj[i];
	//   12   22:aload_2         
	//   13   23:iload_1         
	...
	//*   3    5:icmplt          28
			return ((zzuu) (new zzvj(Arrays.copyOf(zzcae, i), size)));
	//    4    8:new             #2   <Class zzvj>
	//    5   11:dup             
	//    6   12:aload_0         
	//    7   13:getfield        #34  <Field long[] zzcae>
	//    8   16:iload_1         
	//    9   17:invokestatic    #107 <Method long[] Arrays.copyOf(long[], int)>
	//   10   20:aload_0         
	//   11   21:getfield        #36  <Field int size>
	//   12   24:invokespecial   #31  <Method void zzvj(long[], int)>
	//   13   27:areturn         
		else
	...
	//    3    7:astore_0        
		zzcad = zzvj1;
	//    4    8:aload_0         
	//    5    9:putstatic       #24  <Field zzvj zzcad>
		((zzta) (zzvj1)).zzsw();
	//    6   12:aload_0         
