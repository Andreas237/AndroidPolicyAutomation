...
public abstract class zzyi
{
	...
	//    2    4:aload_0         
	//    3    5:iconst_m1       
	//    4    6:putfield        #12  <Field int zzcfd>
	//    5    9:return          
	}
	...
	//    3    3:aload_1         
	//    4    4:arraylength     
	//    5    5:invokestatic    #21  <Method zzyi zzb(zzyi, byte[], int, int)>
	//    6    8:areturn         
	}
	...
	//    1    1:iconst_0        
	//    2    2:iload_3         
	//    3    3:invokestatic    #33  <Method zzya zzya.zzk(byte[], int, int)>
	//    4    6:astore_1        
			zzyi1.zza(((zzya) (abyte0)));
	//    5    7:aload_0         
	//    6    8:aload_1         
	//    7    9:invokevirtual   #36  <Method void zza(zzya)>
			((zzya) (abyte0)).zzza();
	//    8   12:aload_1         
	//    9   13:invokevirtual   #39  <Method void zzya.zzza()>
			return;
	//   10   16:return          
		}
	...
	//    1    1:iconst_0        
	//    2    2:iload_3         
	//    3    3:invokestatic    #52  <Method zzxz zzxz.zzj(byte[], int, int)>
	//    4    6:astore_1        
			zzyi1.zza(((zzxz) (abyte0)));
	//    5    7:aload_0         
	//    6    8:aload_1         
	//    7    9:invokevirtual   #55  <Method zzyi zza(zzxz)>
	//    8   12:pop             
			((zzxz) (abyte0)).zzap(0);
	//    9   13:aload_1         
	//   10   14:iconst_0        
	//   11   15:invokevirtual   #59  <Method void zzxz.zzap(int)>
		}
	//*  12   18:aload_0         
	//*  13   19:areturn         
	//*  14   20:astore_0        
		...
		throws CloneNotSupportedException
	{
		return ((Object) (zzzb()));
	//    0    0:aload_0         
	//    1    1:invokevirtual   #70  <Method zzyi zzzb()>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokestatic    #78  <Method String zzyj.zzc(zzyi)>
	//    2    4:areturn         
	}
	...
	public final int zzvx()
	{
		int i = zzf();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #83  <Method int zzf()>
	//    2    4:istore_1        
		zzcfd = i;
	//    3    5:aload_0         
	//    4    6:iload_1         
	//    5    7:putfield        #12  <Field int zzcfd>
		return i;
	//    6   10:iload_1         
	//    7   11:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #85  <Method Object Object.clone()>
	...
	public final int zzzh()
	{
		if(zzcfd < 0)
	//*   0    0:aload_0         
	//*   1    1:getfield        #12  <Field int zzcfd>
	//*   2    4:ifge            12
			zzvx();
	//    3    7:aload_0         
	//    4    8:invokevirtual   #88  <Method int zzvx()>
	//    5   11:pop             
		return zzcfd;
	//    6   12:aload_0         
	//    7   13:getfield        #12  <Field int zzcfd>
	//    8   16:ireturn         
	}

	protected volatile int zzcfd;
}
