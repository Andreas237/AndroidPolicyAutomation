...
label0:
	...
	public FormatEvaluator$AdaptiveEvaluator(BandwidthMeter bandwidthmeter)
	{
	...
	public FormatEvaluator$AdaptiveEvaluator(BandwidthMeter bandwidthmeter, int i, int j, int k, int l, float f)
	{
	//    0    0:aload_0         
