...
final class TtmlRenderUtil
{
	...
	//*  92  183:aload_3         
	//*  93  184:invokevirtual   #80  <Method int TtmlStyle.getFontSizeUnit()>
			{
	//*  94  187:tableswitch     1 3: default 212
	//	               1 256
	//	               2 236
	//	               3 213
			default:
	...
	//   96  213:aload_0         
	//   97  214:new             #82  <Class RelativeSizeSpan>
	//   98  217:dup             
	//   99  218:aload_3         
	//  100  219:invokevirtual   #86  <Method float TtmlStyle.getFontSize()>
	//  101  222:ldc1            #87  <Float 100F>
	//  102  224:fdiv            
	//  103  225:invokespecial   #90  <Method void RelativeSizeSpan(float)>
	//  104  228:iload_1         
	//  105  229:iload_2         
	//  106  230:bipush          33
	//  107  232:invokevirtual   #28  <Method void SpannableStringBuilder.setSpan(Object, int, int, int)>
				return;
	//  108  235:return          
	...
	//  109  236:aload_0         
	//  110  237:new             #82  <Class RelativeSizeSpan>
	//  111  240:dup             
	//  112  241:aload_3         
	//  113  242:invokevirtual   #86  <Method float TtmlStyle.getFontSize()>
	//  114  245:invokespecial   #90  <Method void RelativeSizeSpan(float)>
	//  115  248:iload_1         
	//  116  249:iload_2         
	//  117  250:bipush          33
	//  118  252:invokevirtual   #28  <Method void SpannableStringBuilder.setSpan(Object, int, int, int)>
				return;
	//  119  255:return          
	...
	//  120  256:aload_0         
	//  121  257:new             #92  <Class AbsoluteSizeSpan>
	//  122  260:dup             
	//  123  261:aload_3         
	//  124  262:invokevirtual   #86  <Method float TtmlStyle.getFontSize()>
	//  125  265:f2i             
	//  126  266:iconst_1        
	//  127  267:invokespecial   #95  <Method void AbsoluteSizeSpan(int, boolean)>
	//  128  270:iload_1         
	//  129  271:iload_2         
	//  130  272:bipush          33
	//  131  274:invokevirtual   #28  <Method void SpannableStringBuilder.setSpan(Object, int, int, int)>
				break;
			}
	//  132  277:return          
	}
