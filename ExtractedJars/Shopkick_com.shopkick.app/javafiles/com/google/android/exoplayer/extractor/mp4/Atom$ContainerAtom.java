...
static final class Atom$ContainerAtom extends Atom
{
	...
	//   13   26:pop             
		stringbuilder.append(Arrays.toString(leafChildren.toArray(((Object []) (new Atom.LeafAtom[0])))));
	//   14   27:aload_1         
	//   15   28:aload_0         
	//   16   29:getfield        #26  <Field List leafChildren>
	//   17   32:iconst_0        
	//   18   33:anewarray       Atom.LeafAtom[]
	...
	//   26   54:pop             
		stringbuilder.append(Arrays.toString(containerChildren.toArray(((Object []) (new Atom$ContainerAtom[0])))));
	//   27   55:aload_1         
	//   28   56:aload_0         
	//   29   57:getfield        #28  <Field List containerChildren>
	//   30   60:iconst_0        
	//   31   61:anewarray       Atom$ContainerAtom[]
