...
private static abstract class SmoothStreamingManifestParser$ElementParser
{

	private SmoothStreamingManifestParser$ElementParser newChildParser(SmoothStreamingManifestParser$ElementParser smoothstreamingmanifestparser$elementparser, String s, String s1)
	{
	...
	//*   3    6:ifeq            19
			return ((SmoothStreamingManifestParser$ElementParser) (new rser(smoothstreamingmanifestparser$elementparser, s1)));
	...
	//*  13   25:ifeq            38
			return ((SmoothStreamingManifestParser$ElementParser) (new entParser(smoothstreamingmanifestparser$elementparser, s1)));
	...
	//*  23   44:ifeq            57
			return ((SmoothStreamingManifestParser$ElementParser) (new arser(smoothstreamingmanifestparser$elementparser, s1)));
	...
	//   25   51:istore_2        
	//*  26   52:goto            2
		SmoothStreamingManifestParser$ElementParser smoothstreamingmanifestparser$elementparser = parent;
	//   27   55:aload_0         
	//   28   56:getfield        #22  <Field SmoothStreamingManifestParser$ElementParser parent>
	//   29   59:astore_3        
		if(smoothstreamingmanifestparser$elementparser == null)
	//*  30   60:aload_3         
	//*  31   61:ifnonnull       66
			return ((Object) (null));
	//   32   64:aconst_null     
	//   33   65:areturn         
			...
			return smoothstreamingmanifestparser$elementparser.getNormalizedAttribute(s);
	//   34   66:aload_3         
	//   35   67:aload_1         
	...
	//* 120  249:goto            273
				{
					addChild(((SmoothStreamingManifestParser$ElementParser) (obj)).parse(xmlpullparser));
	//  121  252:aload_0         
	//  122  253:aload           6
	//  123  255:aload_1         
	...
	private final SmoothStreamingManifestParser$ElementParser parent;
	private final String tag;

	public SmoothStreamingManifestParser$ElementParser(SmoothStreamingManifestParser$ElementParser smoothstreamingmanifestparser$elementparser, String s, String s1)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #20  <Method void Object()>
		parent = smoothstreamingmanifestparser$elementparser;
	//    2    4:aload_0         
	//    3    5:aload_1         
