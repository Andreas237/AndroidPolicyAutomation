	...
	implements Cloneable
{
	...
	//    2    4:invokevirtual   #47  <Method TransitionOptions transition(TransitionFactory)>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #53  <Class ViewAnimationFactory>
	//    2    4:dup             
	//    3    5:iload_1         
	//    4    6:invokespecial   #56  <Method void ViewAnimationFactory(int)>
	//    5    9:invokevirtual   #47  <Method TransitionOptions transition(TransitionFactory)>
	//    6   12:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #63  <Method Object Preconditions.checkNotNull(Object)>
	//    3    5:checkcast       #65  <Class TransitionFactory>
	//    4    8:putfield        #22  <Field TransitionFactory transitionFactory>
		return self();
	//    5   11:aload_0         
	//    6   12:invokespecial   #67  <Method TransitionOptions self()>
	//    7   15:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #72  <Class ViewPropertyAnimationFactory>
	//    2    4:dup             
	//    3    5:aload_1         
	//    4    6:invokespecial   #75  <Method void ViewPropertyAnimationFactory(com.bumptech.glide.request.transition.ViewPropertyTransition$Animator)>
	//    5    9:invokevirtual   #47  <Method TransitionOptions transition(TransitionFactory)>
	//    6   12:areturn         
	}
