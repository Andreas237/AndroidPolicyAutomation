...
public final class FactoryPools
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #48  <Method FactoryPools$Resetter emptyResetter()>
	//    3    5:invokestatic    #51  <Method android.support.v4.util.Pools$Pool build(android.support.v4.util.Pools$Pool, FactoryPools$Factory, FactoryPools$Resetter)>
	//    4    8:areturn         
	}
	...
	//    3    5:aload_1         
	//    4    6:aload_2         
	//    5    7:invokespecial   #58  <Method void FactoryPools$FactoryPool(android.support.v4.util.Pools$Pool, FactoryPools$Factory, FactoryPools$Resetter)>
	//    6   10:areturn         
	}
	...
	//    0    0:new             #64  <Class android.support.v4.util.Pools$SimplePool>
	//    1    3:dup             
	//    2    4:iload_0         
	//    3    5:invokespecial   #67  <Method void android.support.v4.util.Pools$SimplePool(int)>
	//    4    8:aload_1         
	//    5    9:invokestatic    #69  <Method android.support.v4.util.Pools$Pool build(android.support.v4.util.Pools$Pool, FactoryPools$Factory)>
	//    6   12:areturn         
	}
	...
	//    0    0:new             #73  <Class android.support.v4.util.Pools$SynchronizedPool>
	//    1    3:dup             
	//    2    4:iload_0         
	//    3    5:invokespecial   #74  <Method void android.support.v4.util.Pools$SynchronizedPool(int)>
	//    4    8:aload_1         
	//    5    9:invokestatic    #69  <Method android.support.v4.util.Pools$Pool build(android.support.v4.util.Pools$Pool, FactoryPools$Factory)>
	//    6   12:areturn         
	}
	...
	//    0    0:bipush          20
	//    1    2:invokestatic    #79  <Method android.support.v4.util.Pools$Pool threadSafeList(int)>
	//    2    5:areturn         
	}
...
, new Resetter() {
	...
	//    5   11:dup             
	//    6   12:invokespecial   #81  <Method void FactoryPools$2()>
	//    7   15:new             #10  <Class FactoryPools$3>
	//    8   18:dup             
	//    9   19:invokespecial   #82  <Method void FactoryPools$3()>
	//   10   22:invokestatic    #51  <Method android.support.v4.util.Pools$Pool build(android.support.v4.util.Pools$Pool, FactoryPools$Factory, FactoryPools$Resetter)>
	//   11   25:areturn         
	}
