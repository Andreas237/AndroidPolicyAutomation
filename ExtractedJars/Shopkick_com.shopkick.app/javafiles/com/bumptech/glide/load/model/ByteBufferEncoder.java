	...
	implements Encoder
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #21  <Class ByteBuffer>
	//    3    5:aload_2         
	//    4    6:aload_3         
	//    5    7:invokevirtual   #24  <Method boolean encode(ByteBuffer, File, Options)>
	//    6   10:ireturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:aload_2         
	//    2    2:invokestatic    #33  <Method void ByteBufferUtil.toFile(ByteBuffer, File)>
		}
	//*   3    5:iconst_1        
	//*   4    6:ireturn         
	...
	//*   7   10:iconst_3        
	//*   8   11:invokestatic    #39  <Method boolean Log.isLoggable(String, int)>
	//*   9   14:ifeq            26
				Log.d("ByteBufferEncoder", "Failed to write data", ((Throwable) (bytebuffer)));
	//   10   17:ldc1            #11  <String "ByteBufferEncoder">
	//   11   19:ldc1            #41  <String "Failed to write data">
	//   12   21:aload_1         
	//   13   22:invokestatic    #45  <Method int Log.d(String, String, Throwable)>
	//   14   25:pop             
			return false;
	//   15   26:iconst_0        
	//   16   27:ireturn         
