	...
	implements ModelLoader
{
		...
		implements ModelLoaderFactory
	{
		...
		//    4    8:invokespecial   #25  <Method void MediaStoreVideoThumbLoader(Context)>
		//    5   11:areturn         
		}
	...
	public MediaStoreVideoThumbLoader(Context context1)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #17  <Method void Object()>
	...
	{
		options = ((Options) ((Long)options.get(VideoDecoder.TARGET_FRAME)));
	//    0    0:aload_1         
	//    1    1:getstatic       #34  <Field com.bumptech.glide.load.Option VideoDecoder.TARGET_FRAME>
	...
	//*   0    0:iload_2         
	//*   1    1:iload_3         
	//*   2    2:invokestatic    #58  <Method boolean MediaStoreUtil.isThumbnailSize(int, int)>
	//*   3    5:ifeq            41
	//*   4    8:aload_0         
	//*   5    9:aload           4
	//*   6   11:invokespecial   #60  <Method boolean isRequestingDefaultFrame(Options)>
	//*   7   14:ifeq            41
	...
	//    8   17:new             #62  <Class com.bumptech.glide.load.model.ModelLoader$LoadData>
	//    9   20:dup             
	//   10   21:new             #64  <Class ObjectKey>
	//   11   24:dup             
	//   12   25:aload_1         
	//   13   26:invokespecial   #67  <Method void ObjectKey(Object)>
	//   14   29:aload_0         
	//   15   30:getfield        #25  <Field Context context>
	//   16   33:aload_1         
	//   17   34:invokestatic    #73  <Method ThumbFetcher ThumbFetcher.buildVideoFetcher(Context, Uri)>
	//   18   37:invokespecial   #76  <Method void com.bumptech.glide.load.model.ModelLoader$LoadData(com.bumptech.glide.load.Key, com.bumptech.glide.load.data.DataFetcher)>
	//   19   40:areturn         
		else
			return null;
	//   20   41:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #83  <Class Uri>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #85  <Method com.bumptech.glide.load.model.ModelLoader$LoadData buildLoadData(Uri, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #90  <Method boolean MediaStoreUtil.isMediaStoreVideoUri(Uri)>
	//    2    4:ireturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:checkcast       #83  <Class Uri>
	//    3    5:invokevirtual   #93  <Method boolean handles(Uri)>
	//    4    8:ireturn         
	}
