	...
	implements ModelLoader
{
	...
	//    0    0:new             #48  <Class ModelLoader$LoadData>
	//    1    3:dup             
	//    2    4:new             #50  <Class ObjectKey>
	//    3    7:dup             
	//    4    8:aload_1         
	//    5    9:invokespecial   #53  <Method void ObjectKey(Object)>
	//    6   12:new             #17  <Class FileLoader$FileFetcher>
	//    7   15:dup             
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #40  <Field FileLoader$FileOpener fileOpener>
	//   11   21:invokespecial   #56  <Method void FileLoader$FileFetcher(File, FileLoader$FileOpener)>
	//   12   24:invokespecial   #59  <Method void ModelLoader$LoadData(com.bumptech.glide.load.Key, DataFetcher)>
	//   13   27:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #64  <Class File>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #66  <Method ModelLoader$LoadData buildLoadData(File, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:checkcast       #64  <Class File>
	//    3    5:invokevirtual   #71  <Method boolean handles(File)>
	//    4    8:ireturn         
	}
