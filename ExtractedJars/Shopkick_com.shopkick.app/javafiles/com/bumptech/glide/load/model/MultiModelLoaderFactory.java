...
public class MultiModelLoaderFactory
{
	...
	//    5    5:aload_3         
	//    6    6:iconst_1        
	//    7    7:invokespecial   #108 <Method void add(Class, Class, ModelLoaderFactory, boolean)>
		this;
	//    8   10:aload_0         
	...
	//    8   15:invokeinterface #116 <Method Iterator List.iterator()>
	//    9   20:astore          5
		boolean flag = false;
	//   10   22:iconst_0        
	//   11   23:istore_3        
_L3:
	...
	//   12   24:aload           5
	//   13   26:invokeinterface #122 <Method boolean Iterator.hasNext()>
	//   14   31:ifeq            116
		entry = (Entry)iterator.next();
	//   15   34:aload           5
	//   16   36:invokeinterface #126 <Method Object Iterator.next()>
	...
	//   21   50:aload           6
	//   22   52:invokeinterface #132 <Method boolean Set.contains(Object)>
	//   23   57:ifeq            65
_L1:
		flag = true;
	//   24   60:iconst_1        
...
_L2:
	...
	//   28   67:aload_1         
	//   29   68:aload_2         
	//   30   69:invokevirtual   #136 <Method boolean MultiModelLoaderFactory$Entry.handles(Class, Class)>
	//   31   72:ifeq            24
_L4:
	...
	//   34   79:aload           6
	//   35   81:invokeinterface #138 <Method boolean Set.add(Object)>
	//   36   86:pop             
		((List) (arraylist)).add(((Object) (build(entry))));
	//   37   87:aload           4
	//   38   89:aload_0         
	//   39   90:aload           6
	//   40   92:invokespecial   #140 <Method ModelLoader build(MultiModelLoaderFactory$Entry)>
	//   41   95:invokeinterface #141 <Method boolean List.add(Object)>
	//   42  100:pop             
		alreadyUsedEntries.remove(((Object) (entry)));
	//   43  101:aload_0         
	//   44  102:getfield        #59  <Field Set alreadyUsedEntries>
	//   45  105:aload           6
	//   46  107:invokeinterface #144 <Method boolean Set.remove(Object)>
	//   47  112:pop             
		  goto _L3
	//*  48  113:goto            24
	...
	//   58  137:invokevirtual   #147 <Method MultiModelLoader MultiModelLoaderFactory$Factory.build(List, android.support.v4.util.Pools$Pool)>
	//   59  140:astore_1        
		this;
	//   60  141:aload_0         
		JVM INSTR monitorexit ;
	...
	//   68  156:aload           4
	//   69  158:iconst_0        
	//   70  159:invokeinterface #151 <Method Object List.get(int)>
	...
	//   79  176:invokestatic    #153 <Method ModelLoader emptyModelLoader()>
	//   80  179:astore_1        
		this;
	//   81  180:aload_0         
		JVM INSTR monitorexit ;
	...
	//   85  184:new             #155 <Class com.bumptech.glide.Registry$NoModelLoaderAvailableException>
	//   86  187:dup             
	//   87  188:aload_1         
	//   88  189:aload_2         
	//   89  190:invokespecial   #158 <Method void com.bumptech.glide.Registry$NoModelLoaderAvailableException(Class, Class)>
	//   90  193:athrow          
		}
	//*  91  194:astore_1        
	//*  92  195:goto            210
	...
	//   96  203:invokeinterface #161 <Method void Set.clear()>
		throw class1;
	//   97  208:aload_1         
	//   98  209:athrow          
		this;
	...
	//    8   14:invokeinterface #116 <Method Iterator List.iterator()>
	//    9   19:astore_3        
_L2:
		Entry entry;
		do
	...
	//   10   20:aload_3         
	//   11   21:invokeinterface #122 <Method boolean Iterator.hasNext()>
	//   12   26:ifeq            106
			entry = (Entry)iterator.next();
	//   13   29:aload_3         
	//   14   30:invokeinterface #126 <Method Object Iterator.next()>
	...
	//   19   44:aload           4
	//   20   46:invokeinterface #132 <Method boolean Set.contains(Object)>
	//   21   51:ifeq            57
	//*  22   54:goto            20
		if(!entry.handles(class1)) goto _L2; else goto _L1
	//   23   57:aload           4
	//   24   59:aload_1         
	//   25   60:invokevirtual   #166 <Method boolean MultiModelLoaderFactory$Entry.handles(Class)>
	//   26   63:ifeq            20
_L1:
		alreadyUsedEntries.add(((Object) (entry)));
	//   27   66:aload_0         
	...
	//   29   70:aload           4
	//   30   72:invokeinterface #138 <Method boolean Set.add(Object)>
	//   31   77:pop             
		((List) (arraylist)).add(((Object) (build(entry))));
	//   32   78:aload_2         
	//   33   79:aload_0         
	//   34   80:aload           4
	//   35   82:invokespecial   #140 <Method ModelLoader build(MultiModelLoaderFactory$Entry)>
	//   36   85:invokeinterface #141 <Method boolean List.add(Object)>
	//   37   90:pop             
		alreadyUsedEntries.remove(((Object) (entry)));
	//   38   91:aload_0         
	//   39   92:getfield        #59  <Field Set alreadyUsedEntries>
	//   40   95:aload           4
	//   41   97:invokeinterface #144 <Method boolean Set.remove(Object)>
	//   42  102:pop             
		  goto _L2
	//*  43  103:goto            20
		this;
	...
	//   53  119:invokeinterface #161 <Method void Set.clear()>
		throw class1;
	//   54  124:aload_1         
	//   55  125:athrow          
	//*  56  126:aload_0         
	...
	//*  17   40:aload_2         
	//*  18   41:aload           4
	//*  19   43:getfield        #172 <Field Class MultiModelLoaderFactory$Entry.dataClass>
	//*  20   46:invokeinterface #173 <Method boolean List.contains(Object)>
	//*  21   51:ifne            20
	//*  22   54:aload           4
	//*  23   56:aload_1         
	//*  24   57:invokevirtual   #166 <Method boolean MultiModelLoaderFactory$Entry.handles(Class)>
	//*  25   60:ifeq            20
				((List) (arraylist)).add(((Object) (entry.dataClass)));
	//   26   63:aload_2         
	//   27   64:aload           4
	//   28   66:getfield        #172 <Field Class MultiModelLoaderFactory$Entry.dataClass>
	//   29   69:invokeinterface #141 <Method boolean List.add(Object)>
	//   30   74:pop             
		} while(true);
	//   31   75:goto            20
		this;
	...
	//    9   19:astore          4
		do
		{
			if(!iterator.hasNext())
				break;
	//   10   21:aload           4
	//   11   23:invokeinterface #122 <Method boolean Iterator.hasNext()>
	//   12   28:ifeq            76
			Entry entry = (Entry)iterator.next();
	//   13   31:aload           4
	//   14   33:invokeinterface #126 <Method Object Iterator.next()>
	...
	//*  18   45:aload_1         
	//*  19   46:aload_2         
	//*  20   47:invokevirtual   #136 <Method boolean MultiModelLoaderFactory$Entry.handles(Class, Class)>
	//*  21   50:ifeq            21
			{
				iterator.remove();
	//   22   53:aload           4
	//   23   55:invokeinterface #178 <Method void Iterator.remove()>
				((List) (arraylist)).add(((Object) (getFactory(entry))));
	//   24   60:aload_3         
	//   25   61:aload_0         
	//   26   62:aload           5
	//   27   64:invokespecial   #180 <Method ModelLoaderFactory getFactory(MultiModelLoaderFactory$Entry)>
	//   28   67:invokeinterface #141 <Method boolean List.add(Object)>
	//   29   72:pop             
			}
		} while(true);
	//   30   73:goto            21
	...
	//    3    3:aload_1         
	//    4    4:aload_2         
	//    5    5:invokevirtual   #185 <Method List remove(Class, Class)>
	//    6    8:astore          4
	...
	//    9   12:aload_2         
	//   10   13:aload_3         
	//   11   14:invokevirtual   #187 <Method void append(Class, Class, ModelLoaderFactory)>
		this;
	//   12   17:aload_0         
		JVM INSTR monitorexit ;
	//   13   18:monitorexit     
