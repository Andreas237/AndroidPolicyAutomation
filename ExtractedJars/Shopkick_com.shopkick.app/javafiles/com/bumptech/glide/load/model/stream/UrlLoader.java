	...
	implements ModelLoader
{
		...
		implements ModelLoaderFactory
	{
		...
		//    6   12:invokespecial   #30  <Method void UrlLoader(ModelLoader)>
		//    7   15:areturn         
		}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #28  <Class URL>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #31  <Method com.bumptech.glide.load.model.ModelLoader$LoadData buildLoadData(URL, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    2    4:new             #34  <Class GlideUrl>
	//    3    7:dup             
	//    4    8:aload_1         
	//    5    9:invokespecial   #37  <Method void GlideUrl(URL)>
	//    6   12:iload_2         
	//    7   13:iload_3         
	//    8   14:aload           4
	//    9   16:invokeinterface #39  <Method com.bumptech.glide.load.model.ModelLoader$LoadData ModelLoader.buildLoadData(Object, int, int, Options)>
	//   10   21:areturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:checkcast       #28  <Class URL>
	//    3    5:invokevirtual   #45  <Method boolean handles(URL)>
	//    4    8:ireturn         
	}
