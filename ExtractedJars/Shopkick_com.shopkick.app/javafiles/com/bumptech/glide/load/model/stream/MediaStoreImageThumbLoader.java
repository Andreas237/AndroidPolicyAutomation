	...
	implements ModelLoader
{
		...
		implements ModelLoaderFactory
	{
		...
		//    4    8:invokespecial   #25  <Method void MediaStoreImageThumbLoader(Context)>
		//    5   11:areturn         
		}
	...
	//*   0    0:iload_2         
	//*   1    1:iload_3         
	//*   2    2:invokestatic    #35  <Method boolean MediaStoreUtil.isThumbnailSize(int, int)>
	//*   3    5:ifeq            32
	...
	//    4    8:new             #37  <Class com.bumptech.glide.load.model.ModelLoader$LoadData>
	//    5   11:dup             
	//    6   12:new             #39  <Class ObjectKey>
	//    7   15:dup             
	//    8   16:aload_1         
	//    9   17:invokespecial   #42  <Method void ObjectKey(Object)>
	//   10   20:aload_0         
	//   11   21:getfield        #25  <Field Context context>
	//   12   24:aload_1         
	//   13   25:invokestatic    #48  <Method ThumbFetcher ThumbFetcher.buildImageFetcher(Context, Uri)>
	//   14   28:invokespecial   #51  <Method void com.bumptech.glide.load.model.ModelLoader$LoadData(com.bumptech.glide.load.Key, com.bumptech.glide.load.data.DataFetcher)>
	//   15   31:areturn         
		else
			return null;
	//   16   32:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #57  <Class Uri>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #59  <Method com.bumptech.glide.load.model.ModelLoader$LoadData buildLoadData(Uri, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #64  <Method boolean MediaStoreUtil.isMediaStoreImageUri(Uri)>
	//    2    4:ireturn         
	}
	...
	//    1    1:aload_1         
	//    2    2:checkcast       #57  <Class Uri>
	//    3    5:invokevirtual   #67  <Method boolean handles(Uri)>
	//    4    8:ireturn         
	}
