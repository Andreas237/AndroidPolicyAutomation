	...
	implements ArrayAdapterInterface
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #20  <Class byte[]>
	//    3    5:invokevirtual   #23  <Method int getArrayLength(byte[])>
	//    4    8:ireturn         
	}
	...
	//    0    0:ldc1            #11  <String "ByteArrayPool">
	//    1    2:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #32  <Method byte[] newArray(int)>
	//    3    5:areturn         
	}
