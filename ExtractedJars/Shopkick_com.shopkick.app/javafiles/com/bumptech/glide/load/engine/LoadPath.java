...
_L1:
	...
	//    2    4:invokeinterface #107 <Method Object android.support.v4.util.Pools$Pool.acquire()>
	//    3    9:invokestatic    #111 <Method Object Preconditions.checkNotNull(Object)>
	...
	//   11   23:aload           5
	//   12   25:aload           6
	//   13   27:invokespecial   #113 <Method Resource loadWithExceptionList(DataRewinder, Options, int, int, DecodePath$DecodeCallback, List)>
	//   14   30:astore_1        
		listPool.release(((Object) (list)));
	//   15   31:aload_0         
	//   16   32:getfield        #25  <Field android.support.v4.util.Pools$Pool listPool>
	//   17   35:aload           6
	//   18   37:invokeinterface #116 <Method boolean android.support.v4.util.Pools$Pool.release(Object)>
	//   19   42:pop             
	...
	//   25   50:aload           6
	//   26   52:invokeinterface #116 <Method boolean android.support.v4.util.Pools$Pool.release(Object)>
	//   27   57:pop             
		throw datarewinder;
	//   28   58:aload_1         
	//   29   59:athrow          
	...
	//    4    8:aload_1         
	//    5    9:ldc1            #119 <String "LoadPath{decodePaths=">
	...
	//   11   20:invokeinterface #123 <Method Object[] List.toArray()>
	//   12   25:invokestatic    #128 <Method String Arrays.toString(Object[])>
	//   13   28:invokevirtual   #44  <Method StringBuilder StringBuilder.append(String)>
	//   14   31:pop             
		stringbuilder.append('}');
	//   15   32:aload_1         
	//   16   33:bipush          125
	//   17   35:invokevirtual   #131 <Method StringBuilder StringBuilder.append(char)>
	//   18   38:pop             
