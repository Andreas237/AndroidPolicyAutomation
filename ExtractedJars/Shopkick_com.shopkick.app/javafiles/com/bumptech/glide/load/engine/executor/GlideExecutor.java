...
;
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #70  <Field ExecutorService _flddelegate>
	//    5    9:return          
	}
	...
	//*   0    0:getstatic       #75  <Field int bestThreadCount>
	//*   1    3:ifne            16
			bestThreadCount = Math.min(4, RuntimeCompat.availableProcessors());
	//    2    6:iconst_4        
	//    3    7:invokestatic    #80  <Method int RuntimeCompat.availableProcessors()>
	//    4   10:invokestatic    #86  <Method int Math.min(int, int)>
	//    5   13:putstatic       #75  <Field int bestThreadCount>
		return bestThreadCount;
	//    6   16:getstatic       #75  <Field int bestThreadCount>
	//    7   19:ireturn         
	}
	...
	//*   0    0:invokestatic    #90  <Method int calculateBestThreadCount()>
	//*   1    3:iconst_4        
	//*   2    4:icmplt          12
			byte0 = 2;
	//    3    7:iconst_2        
	...
	//    8   14:iload_0         
	//    9   15:getstatic       #94  <Field GlideExecutor$UncaughtThrowableStrategy GlideExecutor$UncaughtThrowableStrategy.DEFAULT>
	//   10   18:invokestatic    #97  <Method GlideExecutor newAnimationExecutor(int, GlideExecutor$UncaughtThrowableStrategy)>
	//   11   21:areturn         
	}
	...
	//    1    3:dup             
	//    2    4:new             #99  <Class ThreadPoolExecutor>
	//    3    7:dup             
	//    4    8:iconst_0        
	//    5    9:iload_0         
	//    6   10:getstatic       #62  <Field long KEEP_ALIVE_TIME_MS>
	//    7   13:getstatic       #102 <Field TimeUnit TimeUnit.MILLISECONDS>
	//    8   16:new             #104 <Class PriorityBlockingQueue>
	//    9   19:dup             
	//   10   20:invokespecial   #105 <Method void PriorityBlockingQueue()>
	//   11   23:new             #8   <Class GlideExecutor$DefaultThreadFactory>
	//   12   26:dup             
	//   13   27:ldc1            #24  <String "animation">
	//   14   29:aload_1         
	//   15   30:iconst_1        
	//   16   31:invokespecial   #108 <Method void GlideExecutor$DefaultThreadFactory(String, GlideExecutor$UncaughtThrowableStrategy, boolean)>
	//   17   34:invokespecial   #111 <Method void ThreadPoolExecutor(int, int, long, TimeUnit, java.util.concurrent.BlockingQueue, ThreadFactory)>
	//   18   37:invokespecial   #113 <Method void GlideExecutor(ExecutorService)>
	//   19   40:areturn         
	}
	...
	//    0    0:iconst_1        
	//    1    1:ldc1            #27  <String "disk-cache">
	//    2    3:getstatic       #94  <Field GlideExecutor$UncaughtThrowableStrategy GlideExecutor$UncaughtThrowableStrategy.DEFAULT>
	//    3    6:invokestatic    #117 <Method GlideExecutor newDiskCacheExecutor(int, String, GlideExecutor$UncaughtThrowableStrategy)>
	//    4    9:areturn         
	}
	...
	//    5    9:iload_0         
	//    6   10:lconst_0        
	//    7   11:getstatic       #102 <Field TimeUnit TimeUnit.MILLISECONDS>
	//    8   14:new             #104 <Class PriorityBlockingQueue>
	//    9   17:dup             
	//   10   18:invokespecial   #105 <Method void PriorityBlockingQueue()>
	//   11   21:new             #8   <Class GlideExecutor$DefaultThreadFactory>
	//   12   24:dup             
	//   13   25:aload_1         
	//   14   26:aload_2         
	//   15   27:iconst_1        
	//   16   28:invokespecial   #108 <Method void GlideExecutor$DefaultThreadFactory(String, GlideExecutor$UncaughtThrowableStrategy, boolean)>
	//   17   31:invokespecial   #111 <Method void ThreadPoolExecutor(int, int, long, TimeUnit, java.util.concurrent.BlockingQueue, ThreadFactory)>
	//   18   34:invokespecial   #113 <Method void GlideExecutor(ExecutorService)>
	//   19   37:areturn         
	}
	...
	//    1    1:ldc1            #27  <String "disk-cache">
	//    2    3:aload_0         
	//    3    4:invokestatic    #117 <Method GlideExecutor newDiskCacheExecutor(int, String, GlideExecutor$UncaughtThrowableStrategy)>
	//    4    7:areturn         
	}
	...
	//    0    0:invokestatic    #90  <Method int calculateBestThreadCount()>
	//    1    3:ldc1            #33  <String "source">
	//    2    5:getstatic       #94  <Field GlideExecutor$UncaughtThrowableStrategy GlideExecutor$UncaughtThrowableStrategy.DEFAULT>
	//    3    8:invokestatic    #121 <Method GlideExecutor newSourceExecutor(int, String, GlideExecutor$UncaughtThrowableStrategy)>
	//    4   11:areturn         
	}
	...
	//    1    3:ldc1            #33  <String "source">
	//    2    5:aload_0         
	//    3    6:invokestatic    #121 <Method GlideExecutor newSourceExecutor(int, String, GlideExecutor$UncaughtThrowableStrategy)>
	//    4    9:areturn         
	}
	...
	//    3    7:dup             
	//    4    8:iconst_0        
	//    5    9:ldc1            #123 <Int 0x7fffffff>
	//    6   11:getstatic       #62  <Field long KEEP_ALIVE_TIME_MS>
	//    7   14:getstatic       #102 <Field TimeUnit TimeUnit.MILLISECONDS>
	//    8   17:new             #125 <Class SynchronousQueue>
	//    9   20:dup             
	//   10   21:invokespecial   #126 <Method void SynchronousQueue()>
	//   11   24:new             #8   <Class GlideExecutor$DefaultThreadFactory>
	//   12   27:dup             
	//   13   28:ldc1            #40  <String "source-unlimited">
	//   14   30:getstatic       #94  <Field GlideExecutor$UncaughtThrowableStrategy GlideExecutor$UncaughtThrowableStrategy.DEFAULT>
	//   15   33:iconst_0        
	//   16   34:invokespecial   #108 <Method void GlideExecutor$DefaultThreadFactory(String, GlideExecutor$UncaughtThrowableStrategy, boolean)>
	//   17   37:invokespecial   #111 <Method void ThreadPoolExecutor(int, int, long, TimeUnit, java.util.concurrent.BlockingQueue, ThreadFactory)>
	//   18   40:invokespecial   #113 <Method void GlideExecutor(ExecutorService)>
	//   19   43:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:lload_1         
	//    3    5:aload_3         
	//    4    6:invokeinterface #133 <Method boolean ExecutorService.awaitTermination(long, TimeUnit)>
	//    5   11:ireturn         
	}
	...
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokeinterface #139 <Method void ExecutorService.execute(Runnable)>
	//    4   10:return          
	}
	...
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokeinterface #143 <Method List ExecutorService.invokeAll(Collection)>
	//    4   10:areturn         
	}
	...
	//    3    5:lload_2         
	//    4    6:aload           4
	//    5    8:invokeinterface #148 <Method List ExecutorService.invokeAll(Collection, long, TimeUnit)>
	//    6   13:areturn         
	}
	...
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokeinterface #155 <Method Object ExecutorService.invokeAny(Collection)>
	//    4   10:areturn         
	}
	...
	//    3    5:lload_2         
	//    4    6:aload           4
	//    5    8:invokeinterface #161 <Method Object ExecutorService.invokeAny(Collection, long, TimeUnit)>
	//    6   13:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:invokeinterface #166 <Method boolean ExecutorService.isShutdown()>
	//    3    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:invokeinterface #169 <Method boolean ExecutorService.isTerminated()>
	//    3    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:invokeinterface #172 <Method void ExecutorService.shutdown()>
	//    3    9:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:invokeinterface #176 <Method List ExecutorService.shutdownNow()>
	//    3    9:areturn         
	}
	...
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokeinterface #181 <Method Future ExecutorService.submit(Runnable)>
	//    4   10:areturn         
	}
	...
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:invokeinterface #185 <Method Future ExecutorService.submit(Runnable, Object)>
	//    5   11:areturn         
	}
	...
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:aload_1         
	//    3    5:invokeinterface #189 <Method Future ExecutorService.submit(Callable)>
	//    4   10:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #70  <Field ExecutorService _flddelegate>
	//    2    4:invokevirtual   #194 <Method String Object.toString()>
	//    3    7:areturn         
	}
	...
	//    3    9:putstatic       #62  <Field long KEEP_ALIVE_TIME_MS>
	//*   4   12:return          
	}
}
