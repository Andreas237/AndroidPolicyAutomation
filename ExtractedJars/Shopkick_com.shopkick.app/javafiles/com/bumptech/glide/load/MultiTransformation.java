	...
	implements Transformation
{
	...
	//    5    9:aload_0         
	//    6   10:aload_1         
	//    7   11:invokestatic    #43  <Method java.util.List Arrays.asList(Object[])>
	//    8   14:putfield        #24  <Field Collection transformations>
			return;
	//    9   17:return          
		} else
		{
			throw new IllegalArgumentException("MultiTransformation must contain at least one Transformation");
	//   10   18:new             #26  <Class IllegalArgumentException>
	//   11   21:dup             
	//   12   22:ldc1            #28  <String "MultiTransformation must contain at least one Transformation">
	//   13   24:invokespecial   #31  <Method void IllegalArgumentException(String)>
	//   14   27:athrow          
		}
	}
	...
	//   10   20:invokeinterface #49  <Method boolean Collection.equals(Object)>
	//   11   25:ireturn         
		} else
		{
			return false;
	...
	//    2    4:invokeinterface #53  <Method int Collection.hashCode()>
	//    3    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field Collection transformations>
	//    2    4:invokeinterface #59  <Method Iterator Collection.iterator()>
	//    3    9:astore          7
		Resource resource1;
		Resource resource2;
	...
	//*   5   12:astore          5
	//*   6   14:aload           7
	//*   7   16:invokeinterface #64  <Method boolean Iterator.hasNext()>
	//*   8   21:ifeq            85
		{
			resource2 = ((Transformation)iterator.next()).transform(context, resource1, i, j);
	//    9   24:aload           7
	//   10   26:invokeinterface #68  <Method Object Iterator.next()>
	//   11   31:checkcast       #7   <Class Transformation>
	//   12   34:aload_1         
	//   13   35:aload           5
	//   14   37:iload_3         
	//   15   38:iload           4
	//   16   40:invokeinterface #70  <Method Resource Transformation.transform(Context, Resource, int, int)>
	//   17   45:astore          6
	...
	//*  20   52:aload           5
	//*  21   54:aload_2         
	//*  22   55:invokevirtual   #71  <Method boolean Object.equals(Object)>
	//*  23   58:ifne            78
	//*  24   61:aload           5
	//*  25   63:aload           6
	//*  26   65:invokevirtual   #71  <Method boolean Object.equals(Object)>
	//*  27   68:ifne            78
				resource1.recycle();
	//   28   71:aload           5
	//   29   73:invokeinterface #76  <Method void Resource.recycle()>
		}
	...
	//   10   28:aload_1         
	//   11   29:invokeinterface #82  <Method void Transformation.updateDiskCacheKey(MessageDigest)>
	//*  12   34:goto            10
	//   13   37:return          
	}
