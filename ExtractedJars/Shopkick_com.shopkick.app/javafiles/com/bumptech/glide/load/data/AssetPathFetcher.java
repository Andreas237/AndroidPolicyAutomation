	...
	implements DataFetcher
{
	...
	//    6   10:aload_0         
	//    7   11:aload_1         
	//    8   12:invokevirtual   #37  <Method void close(Object)>
			return;
	//    9   15:return          
		}
	...
	//*   8   16:aload_2         
	//*   9   17:aload_0         
	//*  10   18:getfield        #33  <Field Object data>
	//*  11   21:invokeinterface #58  <Method void DataFetcher$DataCallback.onDataReady(Object)>
	//*  12   26:return          
	...
	//*  14   28:ldc1            #11  <String "AssetPathFetcher">
	//*  15   30:iconst_3        
	//*  16   31:invokestatic    #64  <Method boolean Log.isLoggable(String, int)>
	//*  17   34:ifeq            46
				Log.d("AssetPathFetcher", "Failed to load data from asset manager", ((Throwable) (priority)));
	//   18   37:ldc1            #11  <String "AssetPathFetcher">
	//   19   39:ldc1            #66  <String "Failed to load data from asset manager">
	//   20   41:aload_1         
	//   21   42:invokestatic    #70  <Method int Log.d(String, String, Throwable)>
	//   22   45:pop             
			datacallback.onLoadFailed(((Exception) (priority)));
	//   23   46:aload_2         
	//   24   47:aload_1         
	//   25   48:invokeinterface #74  <Method void DataFetcher$DataCallback.onLoadFailed(Exception)>
			return;
	//   26   53:return          
		}
