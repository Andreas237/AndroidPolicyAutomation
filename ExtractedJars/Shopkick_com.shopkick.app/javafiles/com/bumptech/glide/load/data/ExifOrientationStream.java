...
public final class ExifOrientationStream extends FilterInputStream
{
	...
	//   10   17:iload_2         
	//   11   18:int2byte        
	//   12   19:putfield        #42  <Field byte orientation>
			return;
	//   13   22:return          
		} else
		{
			inputstream = ((InputStream) (new StringBuilder()));
	//   14   23:new             #44  <Class StringBuilder>
	//   15   26:dup             
	//   16   27:invokespecial   #46  <Method void StringBuilder()>
	//   17   30:astore_1        
			((StringBuilder) (inputstream)).append("Cannot add invalid orientation: ");
	//   18   31:aload_1         
	//   19   32:ldc1            #48  <String "Cannot add invalid orientation: ">
	//   20   34:invokevirtual   #52  <Method StringBuilder StringBuilder.append(String)>
	//   21   37:pop             
			((StringBuilder) (inputstream)).append(i);
	//   22   38:aload_1         
	//   23   39:iload_2         
	//   24   40:invokevirtual   #55  <Method StringBuilder StringBuilder.append(int)>
	//   25   43:pop             
			throw new IllegalArgumentException(((StringBuilder) (inputstream)).toString());
	//   26   44:new             #57  <Class IllegalArgumentException>
	//   27   47:dup             
	//   28   48:aload_1         
	//   29   49:invokevirtual   #61  <Method String StringBuilder.toString()>
	//   30   52:invokespecial   #64  <Method void IllegalArgumentException(String)>
	//   31   55:athrow          
		}
	}
...
label0:
	...
	//    6   10:getstatic       #34  <Field int ORIENTATION_POSITION>
	//    7   13:istore_2        
				if(i <= j)
	//*   8   14:iload_1         
	//*   9   15:iload_2         
	...
	//*  14   24:icmpne          35
						i = ((int) (orientation));
	//   15   27:aload_0         
	//   16   28:getfield        #42  <Field byte orientation>
	//   17   31:istore_1        
					else
	//*  18   32:goto            55
						i = EXIF_SEGMENT[i - 2] & 0xff;
	//   19   35:getstatic       #30  <Field byte[] EXIF_SEGMENT>
	//   20   38:iload_1         
	//   21   39:iconst_2        
	//   22   40:isub            
	//   23   41:baload          
	...
	//   27   47:goto            55
			...
			i = super.read();
	//   28   50:aload_0         
	//   29   51:invokespecial   #79  <Method int FilterInputStream.read()>
	//   30   54:istore_1        
		}
		if(i != -1)
	//*  31   55:iload_1         
	...
	//   34   60:aload_0         
	//   35   61:aload_0         
	//   36   62:getfield        #77  <Field int position>
	//   37   65:iconst_1        
	//   38   66:iadd            
	//   39   67:putfield        #77  <Field int position>
		return i;
	//   40   70:iload_1         
	//   41   71:ireturn         
	}
	...
	//    3    6:getstatic       #34  <Field int ORIENTATION_POSITION>
	//    4    9:istore          5
		if(k > l)
	//*   5   11:iload           4
	//*   6   13:iload           5
	...
	//   10   20:iload_2         
	//   11   21:iload_3         
	//   12   22:invokespecial   #84  <Method int FilterInputStream.read(byte[], int, int)>
	//   13   25:istore_2        
		else
	//*  14   26:goto            95
		if(k == l)
	...
	//   19   37:iload_2         
	//   20   38:aload_0         
	//   21   39:getfield        #42  <Field byte orientation>
	//   22   42:bastore         
			i = 1;
	//   23   43:iconst_1        
	//   24   44:istore_2        
	...
	//   33   58:iload           4
	//   34   60:isub            
	//   35   61:invokespecial   #84  <Method int FilterInputStream.read(byte[], int, int)>
	//   36   64:istore_2        
		} else
	//*  37   65:goto            95
		{
	...
	//   40   72:isub            
	//   41   73:iload_3         
	//   42   74:invokestatic    #90  <Method int Math.min(int, int)>
	//   43   77:istore_3        
			System.arraycopy(((Object) (EXIF_SEGMENT)), position - 2, ((Object) (abyte0)), i, j);
	//   44   78:getstatic       #30  <Field byte[] EXIF_SEGMENT>
	//   45   81:aload_0         
	//   46   82:getfield        #77  <Field int position>
	//   47   85:iconst_2        
	//   48   86:isub            
	//   49   87:aload_1         
	//   50   88:iload_2         
	//   51   89:iload_3         
	//   52   90:invokestatic    #96  <Method void System.arraycopy(Object, int, Object, int, int)>
			i = j;
	//   53   93:iload_3         
	//   54   94:istore_2        
		}
	...
	//   57   99:aload_0         
	//   58  100:aload_0         
	//   59  101:getfield        #77  <Field int position>
	//   60  104:iload_2         
	//   61  105:iadd            
	//   62  106:putfield        #77  <Field int position>
		return i;
	//   63  109:iload_2         
	//   64  110:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:invokespecial   #102 <Method long FilterInputStream.skip(long)>
	//    3    5:lstore_1        
		if(l > 0L)
	//*   4    6:lload_1         
	//*   5    7:lconst_0        
