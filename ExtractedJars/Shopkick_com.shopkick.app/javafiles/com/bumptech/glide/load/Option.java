...
public final class Option
{
	...
	private byte[] getKeyBytes()
	{
		if(keyBytes == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #68  <Field byte[] keyBytes>
	//*   2    4:ifnonnull       21
			keyBytes = key.getBytes(Key.CHARSET);
	//    3    7:aload_0         
	//    4    8:aload_0         
	//    5    9:getfield        #42  <Field String key>
	//    6   12:getstatic       #74  <Field java.nio.charset.Charset Key.CHARSET>
	//    7   15:invokevirtual   #80  <Method byte[] String.getBytes(java.nio.charset.Charset)>
	//    8   18:putfield        #68  <Field byte[] keyBytes>
		return keyBytes;
	//    9   21:aload_0         
	//   10   22:getfield        #68  <Field byte[] keyBytes>
	//   11   25:areturn         
	}
	...
	//    2    4:aload_0         
	//    3    5:aconst_null     
	//    4    6:invokestatic    #84  <Method Option$CacheKeyUpdater emptyUpdater()>
	...
	//   10   20:invokevirtual   #91  <Method boolean String.equals(Object)>
	//   11   23:ireturn         
		} else
		{
			return false;
	...
	//    4    8:aload_1         
	//    5    9:ldc1            #105 <String "Option{key='">
	...
	//   13   24:aload_1         
	//   14   25:bipush          39
	//   15   27:invokevirtual   #112 <Method StringBuilder StringBuilder.append(char)>
	//   16   30:pop             
		stringbuilder.append('}');
	//   17   31:aload_1         
	//   18   32:bipush          125
	//   19   34:invokevirtual   #112 <Method StringBuilder StringBuilder.append(char)>
	//   20   37:pop             
		return stringbuilder.toString();
	//   21   38:aload_1         
	//   22   39:invokevirtual   #114 <Method String StringBuilder.toString()>
	//   23   42:areturn         
	}
	...
	//    2    4:aload_0         
	//    3    5:invokespecial   #118 <Method byte[] getKeyBytes()>
	//    4    8:aload_1         
	//    5    9:aload_2         
	//    6   10:invokeinterface #121 <Method void Option$CacheKeyUpdater.update(byte[], Object, MessageDigest)>
	//    7   15:return          
	}
