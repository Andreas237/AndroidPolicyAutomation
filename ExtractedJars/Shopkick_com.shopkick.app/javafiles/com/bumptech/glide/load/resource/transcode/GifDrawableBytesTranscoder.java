	...
	implements ResourceTranscoder
{
	...
	//    0    0:new             #18  <Class BytesResource>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokeinterface #24  <Method Object Resource.get()>
	//    4   10:checkcast       #26  <Class GifDrawable>
	//    5   13:invokevirtual   #30  <Method java.nio.ByteBuffer GifDrawable.getBuffer()>
	//    6   16:invokestatic    #36  <Method byte[] ByteBufferUtil.toBytes(java.nio.ByteBuffer)>
	//    7   19:invokespecial   #39  <Method void BytesResource(byte[])>
	//    8   22:areturn         
	}
}
