...
final class HardwareConfigState
{
	...
	//   15   22:aload_0         
	//   16   23:iconst_0        
	//   17   24:putfield        #44  <Field int decodesSinceLastFdCheck>
		i = FD_SIZE_LIST.list().length;
	//   18   27:getstatic       #30  <Field File FD_SIZE_LIST>
	//   19   30:invokevirtual   #48  <Method String[] File.list()>
	//   20   33:arraylength     
	//   21   34:istore_1        
		if(i < 700)
	//*  22   35:iload_1         
	...
	//   27   44:aload_0         
	//   28   45:iload_2         
	//   29   46:putfield        #35  <Field boolean isHardwareConfigAllowed>
		if(!isHardwareConfigAllowed && Log.isLoggable("Downsampler", 5))
	//*  30   49:aload_0         
	//*  31   50:getfield        #35  <Field boolean isHardwareConfigAllowed>
	//*  32   53:ifne            111
	//*  33   56:ldc1            #50  <String "Downsampler">
	//*  34   58:iconst_5        
	//*  35   59:invokestatic    #56  <Method boolean Log.isLoggable(String, int)>
	//*  36   62:ifeq            111
		{
			StringBuilder stringbuilder = new StringBuilder();
	//   37   65:new             #58  <Class StringBuilder>
	//   38   68:dup             
	//   39   69:invokespecial   #59  <Method void StringBuilder()>
	//   40   72:astore_3        
			stringbuilder.append("Excluding HARDWARE bitmap config because we're over the file descriptor limit, file descriptors ");
	//   41   73:aload_3         
	//   42   74:ldc1            #61  <String "Excluding HARDWARE bitmap config because we're over the file descriptor limit, file descriptors ">
	//   43   76:invokevirtual   #65  <Method StringBuilder StringBuilder.append(String)>
	//   44   79:pop             
			stringbuilder.append(i);
	//   45   80:aload_3         
	//   46   81:iload_1         
	//   47   82:invokevirtual   #68  <Method StringBuilder StringBuilder.append(int)>
	//   48   85:pop             
			stringbuilder.append(", limit ");
	//   49   86:aload_3         
	//   50   87:ldc1            #70  <String ", limit ">
	//   51   89:invokevirtual   #65  <Method StringBuilder StringBuilder.append(String)>
	//   52   92:pop             
			stringbuilder.append(700);
	//   53   93:aload_3         
	//   54   94:sipush          700
	//   55   97:invokevirtual   #68  <Method StringBuilder StringBuilder.append(int)>
	//   56  100:pop             
			Log.w("Downsampler", stringbuilder.toString());
	//   57  101:ldc1            #50  <String "Downsampler">
	//   58  103:aload_3         
	//   59  104:invokevirtual   #74  <Method String StringBuilder.toString()>
	//   60  107:invokestatic    #78  <Method int Log.w(String, String)>
	//   61  110:pop             
		}
		flag = isHardwareConfigAllowed;
	//   62  111:aload_0         
	//   63  112:getfield        #35  <Field boolean isHardwareConfigAllowed>
	//   64  115:istore_2        
		this;
	//   65  116:aload_0         
		JVM INSTR monitorexit ;
	...
	//*  14   31:icmplt          47
	//*  15   34:aload_0         
	//*  16   35:invokespecial   #90  <Method boolean isFdSizeBelowHardwareLimit()>
	//*  17   38:ifeq            47
				flag = true;
	//   18   41:iconst_1        
	//   19   42:istore          5
	...
	//   25   55:aload_3         
	//   26   56:getstatic       #96  <Field android.graphics.Bitmap$Config android.graphics.Bitmap$Config.HARDWARE>
	//   27   59:putfield        #101 <Field android.graphics.Bitmap$Config android.graphics.BitmapFactory$Options.inPreferredConfig>
				options.inMutable = false;
	//   28   62:aload_3         
	//   29   63:iconst_0        
	//   30   64:putfield        #104 <Field boolean android.graphics.BitmapFactory$Options.inMutable>
			}
			return flag;
	//   31   67:iload           5
	//   32   69:ireturn         
