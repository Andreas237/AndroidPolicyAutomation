	...
	implements ResourceDecoder
{
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #24  <Class ByteBuffer>
	//    3    5:iload_2         
	//    4    6:iload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #27  <Method Resource decode(ByteBuffer, int, int, Options)>
	//    7   12:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #35  <Method java.io.InputStream ByteBufferUtil.toStream(ByteBuffer)>
	//    2    4:astore_1        
	...
	//    7   11:iload_3         
	//    8   12:aload           4
	//    9   14:invokevirtual   #40  <Method Resource Downsampler.decode(java.io.InputStream, int, int, Options)>
	//   10   17:areturn         
	}
	...
	//    2    2:checkcast       #24  <Class ByteBuffer>
	//    3    5:aload_2         
	//    4    6:invokevirtual   #47  <Method boolean handles(ByteBuffer, Options)>
	//    5    9:ireturn         
	}
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #50  <Method boolean Downsampler.handles(ByteBuffer)>
	//    4    8:ireturn         
	}
