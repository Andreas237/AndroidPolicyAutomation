...
class GifFrameLoader
{
	...
	{
		return requestmanager.asBitmap().apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).useAnimationPool(true).skipMemoryCache(true).override(i, j));
	//    0    0:aload_0         
	...
	//    4   10:iconst_1        
	//    5   11:invokevirtual   #175 <Method RequestOptions RequestOptions.useAnimationPool(boolean)>
	//    6   14:iconst_1        
	//    7   15:invokevirtual   #178 <Method RequestOptions RequestOptions.skipMemoryCache(boolean)>
	//    8   18:iload_1         
	//    9   19:iload_2         
	//   10   20:invokevirtual   #182 <Method RequestOptions RequestOptions.override(int, int)>
	//   11   23:invokevirtual   #188 <Method RequestBuilder RequestBuilder.apply(RequestOptions)>
	//   12   26:areturn         
	}
	...
	//   66  136:putfield        #235 <Field GifFrameLoader$DelayTarget next>
				requestBuilder.apply(RequestOptions.signatureOf(getFrameSignature())).load(((Object) (gifDecoder))).into(((com.bumptech.glide.request.target.Target) (next)));
	//   67  139:aload_0         
	...
	//   71  149:invokevirtual   #188 <Method RequestBuilder RequestBuilder.apply(RequestOptions)>
	//   72  152:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:getfield        #305 <Field Transformation transformation>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #105 <Field GifDecoder gifDecoder>
	//    2    4:invokeinterface #310 <Method int GifDecoder.getTotalIterationCount()>
	//    3    9:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #105 <Field GifDecoder gifDecoder>
	//    2    4:invokeinterface #314 <Method int GifDecoder.getByteSize()>
	//    3    9:aload_0         
	//    4   10:invokespecial   #316 <Method int getFrameSize()>
	//    5   13:iadd            
	//    6   14:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #319 <Field GifFrameLoader$OnEveryFrameListener onEveryFrameListener>
	//    2    4:astore_3        
	...
	//    5    9:aload_3         
	//    6   10:invokeinterface #321 <Method void GifFrameLoader$OnEveryFrameListener.onFrameReady()>
		isLoadPending = false;
	//    7   15:aload_0         
	//    8   16:iconst_0        
	...
	//   15   31:iconst_2        
	//   16   32:aload_1         
	//   17   33:invokevirtual   #325 <Method Message Handler.obtainMessage(int, Object)>
	//   18   36:invokevirtual   #330 <Method void Message.sendToTarget()>
			return;
	//   19   39:return          
		}
		if(!isRunning)
	...
	//*  40   78:invokeinterface #333 <Method int List.size()>
	//*  41   83:iconst_1        
	//*  42   84:isub            
	//*  43   85:istore_2        
	//*  44   86:iload_2         
	...
	//   48   94:iload_2         
	//   49   95:invokeinterface #337 <Method Object List.get(int)>
	//   50  100:checkcast       #9   <Class GifFrameLoader$FrameCallback>
	//   51  103:invokeinterface #338 <Method void GifFrameLoader$FrameCallback.onFrameReady()>
	...
	//   61  123:iconst_2        
	//   62  124:aload_3         
	//   63  125:invokevirtual   #325 <Method Message Handler.obtainMessage(int, Object)>
	//   64  128:invokevirtual   #330 <Method void Message.sendToTarget()>
		}
		loadNextFrame();
	//   65  131:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #343 <Method Object Preconditions.checkNotNull(Object)>
	//    3    5:checkcast       #345 <Class Transformation>
	//    4    8:putfield        #305 <Field Transformation transformation>
		firstFrame = (Bitmap)Preconditions.checkNotNull(((Object) (bitmap)));
	//    5   11:aload_0         
	//    6   12:aload_2         
	//    7   13:invokestatic    #343 <Method Object Preconditions.checkNotNull(Object)>
	...
	//   14   30:dup             
	//   15   31:invokespecial   #346 <Method void RequestOptions()>
	//   16   34:aload_1         
	//   17   35:invokevirtual   #350 <Method RequestOptions RequestOptions.transform(Transformation)>
	//   18   38:invokevirtual   #188 <Method RequestBuilder RequestBuilder.apply(RequestOptions)>
	...
	//    2    4:iconst_1        
	//    3    5:ixor            
	//    4    6:ldc2            #354 <String "Can't restart a running animation">
	//    5    9:invokestatic    #206 <Method void Preconditions.checkArgument(boolean, String)>
		startFromFirstFrame = true;
	//    6   12:aload_0         
	//    7   13:iconst_1        
	//    8   14:putfield        #196 <Field boolean startFromFirstFrame>
		DelayTarget delaytarget = pendingTarget;
	//    9   17:aload_0         
	//   10   18:getfield        #198 <Field GifFrameLoader$DelayTarget pendingTarget>
	//   11   21:astore_1        
		if(delaytarget != null)
	//*  12   22:aload_1         
	//*  13   23:ifnull          39
		{
			requestManager.clear(((com.bumptech.glide.request.target.Target) (delaytarget)));
	//   14   26:aload_0         
	//   15   27:getfield        #83  <Field RequestManager requestManager>
	//   16   30:aload_1         
	//   17   31:invokevirtual   #278 <Method void RequestManager.clear(com.bumptech.glide.request.target.Target)>
			pendingTarget = null;
	//   18   34:aload_0         
	//   19   35:aconst_null     
	//   20   36:putfield        #198 <Field GifFrameLoader$DelayTarget pendingTarget>
		}
	//   21   39:return          
	}
	...
	{
		onEveryFrameListener = oneveryframelistener;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #319 <Field GifFrameLoader$OnEveryFrameListener onEveryFrameListener>
	//    3    5:return          
	}
	...
	//*   5   11:aload_1         
	//*   6   12:invokeinterface #363 <Method boolean List.contains(Object)>
	//*   7   17:ifne            50
			{
				boolean flag = callbacks.isEmpty();
	//    8   20:aload_0         
	//    9   21:getfield        #81  <Field List callbacks>
	//   10   24:invokeinterface #367 <Method boolean List.isEmpty()>
	//   11   29:istore_2        
				callbacks.add(((Object) (framecallback)));
	//   12   30:aload_0         
	//   13   31:getfield        #81  <Field List callbacks>
	//   14   34:aload_1         
	//   15   35:invokeinterface #370 <Method boolean List.add(Object)>
	//   16   40:pop             
				if(flag)
	//*  17   41:iload_2         
	//*  18   42:ifeq            49
					start();
	//   19   45:aload_0         
	//   20   46:invokespecial   #372 <Method void start()>
				return;
	//   21   49:return          
			} else
			{
				throw new IllegalStateException("Cannot subscribe twice in a row");
	//   22   50:new             #374 <Class IllegalStateException>
	//   23   53:dup             
	//   24   54:ldc2            #376 <String "Cannot subscribe twice in a row">
	//   25   57:invokespecial   #379 <Method void IllegalStateException(String)>
	//   26   60:athrow          
			}
		} else
		{
			throw new IllegalStateException("Cannot subscribe to a cleared frame loader");
	//   27   61:new             #374 <Class IllegalStateException>
	//   28   64:dup             
	//   29   65:ldc2            #381 <String "Cannot subscribe to a cleared frame loader">
	//   30   68:invokespecial   #379 <Method void IllegalStateException(String)>
	//   31   71:athrow          
		}
	}
	...
	//    1    1:getfield        #81  <Field List callbacks>
	//    2    4:aload_1         
	//    3    5:invokeinterface #385 <Method boolean List.remove(Object)>
	//    4   10:pop             
		if(callbacks.isEmpty())
	//*   5   11:aload_0         
	//*   6   12:getfield        #81  <Field List callbacks>
	//*   7   15:invokeinterface #367 <Method boolean List.isEmpty()>
	//*   8   20:ifeq            27
			stop();
	//    9   23:aload_0         
