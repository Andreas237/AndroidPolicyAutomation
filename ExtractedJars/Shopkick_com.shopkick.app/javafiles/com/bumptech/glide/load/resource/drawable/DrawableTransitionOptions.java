...
public final class DrawableTransitionOptions extends TransitionOptions
{
	...
	//    1    3:dup             
	//    2    4:invokespecial   #14  <Method void DrawableTransitionOptions()>
	//    3    7:aload_0         
	...
	//    1    3:dup             
	//    2    4:invokespecial   #14  <Method void DrawableTransitionOptions()>
	//    3    7:invokevirtual   #27  <Method DrawableTransitionOptions crossFade()>
	//    4   10:areturn         
	}
	...
	//    2    4:invokespecial   #14  <Method void DrawableTransitionOptions()>
	//    3    7:iload_0         
	//    4    8:invokevirtual   #30  <Method DrawableTransitionOptions crossFade(int)>
	//    5   11:areturn         
	}
	...
	//    2    4:invokespecial   #14  <Method void DrawableTransitionOptions()>
	//    3    7:aload_0         
	//    4    8:invokevirtual   #33  <Method DrawableTransitionOptions crossFade(com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder)>
	//    5   11:areturn         
	}
	...
	//    2    4:invokespecial   #14  <Method void DrawableTransitionOptions()>
	//    3    7:aload_0         
	//    4    8:invokevirtual   #36  <Method DrawableTransitionOptions crossFade(DrawableCrossFadeFactory)>
	//    5   11:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #38  <Class com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder>
	//    2    4:dup             
	//    3    5:invokespecial   #39  <Method void com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder()>
	//    4    8:invokevirtual   #33  <Method DrawableTransitionOptions crossFade(com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder)>
	//    5   11:areturn         
	}
	...
	//    2    4:dup             
	//    3    5:iload_1         
	//    4    6:invokespecial   #42  <Method void com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder(int)>
	//    5    9:invokevirtual   #33  <Method DrawableTransitionOptions crossFade(com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder)>
	//    6   12:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #46  <Method DrawableCrossFadeFactory com.bumptech.glide.request.transition.DrawableCrossFadeFactory$Builder.build()>
	//    3    5:invokevirtual   #36  <Method DrawableTransitionOptions crossFade(DrawableCrossFadeFactory)>
	//    4    8:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #18  <Method TransitionOptions transition(TransitionFactory)>
