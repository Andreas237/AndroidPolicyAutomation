...
public class NotificationTarget extends SimpleTarget
{
	...
	private void update()
	{
		((NotificationManager)Preconditions.checkNotNull(((Object) ((NotificationManager)context.getSystemService("notification"))))).notify(notificationTag, notificationId, notification);
	//    0    0:aload_0         
	...
	//    5   12:invokestatic    #71  <Method Object Preconditions.checkNotNull(Object)>
	//    6   15:checkcast       #68  <Class NotificationManager>
	//    7   18:aload_0         
	//    8   19:getfield        #51  <Field String notificationTag>
	//    9   22:aload_0         
	//   10   23:getfield        #49  <Field int notificationId>
	//   11   26:aload_0         
	//   12   27:getfield        #39  <Field Notification notification>
	//   13   30:invokevirtual   #75  <Method void NotificationManager.notify(String, int, Notification)>
	//   14   33:return          
	}
	...
	//    4    8:aload_1         
	//    5    9:invokevirtual   #83  <Method void RemoteViews.setImageViewBitmap(int, Bitmap)>
		update();
	//    6   12:aload_0         
	//    7   13:invokespecial   #85  <Method void update()>
	//    8   16:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:checkcast       #91  <Class Bitmap>
	//    3    5:aload_2         
	//    4    6:invokevirtual   #93  <Method void onResourceReady(Bitmap, Transition)>
	//    5    9:return          
	}
