...
public final class PreloadTarget extends SimpleTarget
{
	...
	//    1    1:iload_2         
	//    2    2:iload_3         
	//    3    3:invokespecial   #37  <Method void SimpleTarget(int, int)>
		requestManager = requestmanager;
	//    4    6:aload_0         
	//    5    7:aload_1         
	//    6    8:putfield        #39  <Field RequestManager requestManager>
	//    7   11:return          
	}
	...
	//    3    5:iload_1         
	//    4    6:iload_2         
	//    5    7:invokespecial   #43  <Method void PreloadTarget(RequestManager, int, int)>
	//    6   10:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #39  <Field RequestManager requestManager>
	//    2    4:aload_0         
	//    3    5:invokevirtual   #51  <Method void RequestManager.clear(Target)>
	//    4    8:return          
	}
	...
	//    0    0:getstatic       #32  <Field Handler HANDLER>
	//    1    3:iconst_1        
	//    2    4:aload_0         
	//    3    5:invokevirtual   #59  <Method Message Handler.obtainMessage(int, Object)>
	//    4    8:invokevirtual   #64  <Method void Message.sendToTarget()>
	//    5   11:return          
	}
	...
	//    4   10:dup             
	//    5   11:invokespecial   #27  <Method void PreloadTarget$1()>
	//    6   14:invokespecial   #30  <Method void Handler(Looper, android.os.Handler$Callback)>
	//    7   17:putstatic       #32  <Field Handler HANDLER>
	//*   8   20:return          
	}
}
