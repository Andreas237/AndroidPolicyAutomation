	...
	implements TransitionFactory
{
		...
		implements ViewTransition.ViewTransitionAnimationFactory
	{
		...
		ConcreteViewTransitionAnimationFactory(Animation animation1)
		{
		//    0    0:aload_0         
	...
	//*   5   11:goto            41
		{
			if(transition == null)
	//*   6   14:aload_0         
	//*   7   15:getfield        #44  <Field Transition transition>
	//*   8   18:ifnonnull       36
				transition = ((Transition) (new ViewTransition(viewTransitionAnimationFactory)));
	//    9   21:aload_0         
	//   10   22:new             #46  <Class ViewTransition>
	//   11   25:dup             
	//   12   26:aload_0         
	//   13   27:getfield        #34  <Field ViewTransition$ViewTransitionAnimationFactory viewTransitionAnimationFactory>
	//   14   30:invokespecial   #47  <Method void ViewTransition(ViewTransition$ViewTransitionAnimationFactory)>
	//   15   33:putfield        #44  <Field Transition transition>
			return transition;
	//   16   36:aload_0         
	//   17   37:getfield        #44  <Field Transition transition>
	//   18   40:areturn         
		} else
		{
			return NoTransition.get();
	//   19   41:invokestatic    #53  <Method Transition NoTransition.get()>
	//   20   44:areturn         
		}
	}
