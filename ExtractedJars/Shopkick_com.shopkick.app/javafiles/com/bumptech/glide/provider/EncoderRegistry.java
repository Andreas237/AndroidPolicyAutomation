...
public class EncoderRegistry
{
	...
	public void prepend(Class class1, Encoder encoder)
	{
		this;
	//    0    0:aload_0         
		JVM INSTR monitorenter ;
	//    1    1:monitorenter    
		encoders.add(0, ((Object) (new Entry(class1, encoder))));
	//    2    2:aload_0         
	//    3    3:getfield        #19  <Field List encoders>
	//    4    6:iconst_0        
	//    5    7:new             #6   <Class EncoderRegistry$Entry>
	//    6   10:dup             
	//    7   11:aload_1         
	//    8   12:aload_2         
	//    9   13:invokespecial   #25  <Method void EncoderRegistry$Entry(Class, Encoder)>
	//   10   16:invokeinterface #65  <Method void List.add(int, Object)>
		this;
	//   11   21:aload_0         
		JVM INSTR monitorexit ;
	//   12   22:monitorexit     
