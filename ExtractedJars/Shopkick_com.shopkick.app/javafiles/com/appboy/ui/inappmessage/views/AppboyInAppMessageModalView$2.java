...
class AppboyInAppMessageModalView$2 extends BaseControllerListener
{
	...
	//    9   19:ddiv            
	//   10   20:dstore          4
			AppboyInAppMessageModalView.access$200(AppboyInAppMessageModalView.this).post(new Runnable() {

				public void run()
				{
					AppboyInAppMessageModalView.access$100(this$0, activity, inAppMessage, imageAspectRatio);
				//    0    0:aload_0         
			...
			{
				this$1 = AppboyInAppMessageModalView._cls2.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	//    5    7:putfield        #24  <Field Activity val$activity>
		val$inAppMessage = IInAppMessageImmersive.this;
	//    6   10:aload_0         
	//    7   11:aload_3         
