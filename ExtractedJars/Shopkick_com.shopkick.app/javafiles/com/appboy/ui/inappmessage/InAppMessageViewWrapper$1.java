	...
	implements android.view.ayoutListener
{
	...
	//   46   89:invokestatic    #76  <Method void InAppMessageViewWrapper.access$200(InAppMessageViewWrapper, FrameLayout, int)>
		ViewUtils.removeOnGlobalLayoutListenerSafe(val$frameLayout.getViewTreeObserver(), ((android.view.ayoutListener) (this)));
	//   47   92:aload_0         
	//   48   93:getfield        #23  <Field FrameLayout val$frameLayout>
	//   49   96:invokevirtual   #80  <Method android.view.ViewTreeObserver FrameLayout.getViewTreeObserver()>
	//   50   99:aload_0         
	//   51  100:invokestatic    #86  <Method void ViewUtils.removeOnGlobalLayoutListenerSafe(android.view.ViewTreeObserver, android.view.ViewTreeObserver$OnGlobalLayoutListener)>
	//   52  103:return          
	}
