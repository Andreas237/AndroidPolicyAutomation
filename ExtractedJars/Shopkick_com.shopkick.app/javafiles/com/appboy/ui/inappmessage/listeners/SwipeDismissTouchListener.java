	...
	implements android.view.View.OnTouchListener
{
	...
	//* 274  540:ifeq            605
	//* 275  543:aload_0         
	//* 276  544:getfield        #89  <Field View mView>
	//* 277  547:invokevirtual   #122 <Method ViewPropertyAnimator View.animate()>
	//* 278  550:astore_1        
	//* 279  551:iload           7
	//* 280  553:ifeq            565
	//* 281  556:aload_0         
	//* 282  557:getfield        #44  <Field int mViewWidth>
	//* 283  560:istore          7
	//* 284  562:goto            572
	//* 285  565:aload_0         
	//* 286  566:getfield        #44  <Field int mViewWidth>
	//* 287  569:ineg            
	//* 288  570:istore          7
	//* 289  572:aload_1         
	//* 290  573:iload           7
	//* 291  575:i2f             
	//* 292  576:invokevirtual   #128 <Method ViewPropertyAnimator ViewPropertyAnimator.translationX(float)>
	//* 293  579:fconst_0        
	//* 294  580:invokevirtual   #131 <Method ViewPropertyAnimator ViewPropertyAnimator.alpha(float)>
	//* 295  583:aload_0         
	//* 296  584:getfield        #87  <Field long mAnimationTime>
	//* 297  587:invokevirtual   #135 <Method ViewPropertyAnimator ViewPropertyAnimator.setDuration(long)>
	//* 298  590:new             #8   <Class SwipeDismissTouchListener$1>
	//* 299  593:dup             
	//* 300  594:aload_0         
	//* 301  595:invokespecial   #211 <Method void SwipeDismissTouchListener$1(SwipeDismissTouchListener)>
	//* 302  598:invokevirtual   #139 <Method ViewPropertyAnimator ViewPropertyAnimator.setListener(android.animation.Animator$AnimatorListener)>
	//* 303  601:pop             
	//* 304  602:goto            639
	//* 305  605:aload_0         
	//* 306  606:getfield        #150 <Field boolean mSwiping>
	//* 307  609:ifeq            639
	//* 308  612:aload_0         
	//* 309  613:getfield        #89  <Field View mView>
	//* 310  616:invokevirtual   #122 <Method ViewPropertyAnimator View.animate()>
	//* 311  619:fconst_0        
	//* 312  620:invokevirtual   #128 <Method ViewPropertyAnimator ViewPropertyAnimator.translationX(float)>
	//* 313  623:fconst_1        
	//* 314  624:invokevirtual   #131 <Method ViewPropertyAnimator ViewPropertyAnimator.alpha(float)>
	//* 315  627:aload_0         
	//* 316  628:getfield        #87  <Field long mAnimationTime>
	//* 317  631:invokevirtual   #135 <Method ViewPropertyAnimator ViewPropertyAnimator.setDuration(long)>
	//* 318  634:aconst_null     
	//* 319  635:invokevirtual   #139 <Method ViewPropertyAnimator ViewPropertyAnimator.setListener(android.animation.Animator$AnimatorListener)>
	//* 320  638:pop             
	//* 321  639:aload_0         
	//* 322  640:getfield        #118 <Field VelocityTracker mVelocityTracker>
	//* 323  643:invokevirtual   #144 <Method void VelocityTracker.recycle()>
	//* 324  646:aload_0         
	//* 325  647:aconst_null     
	//* 326  648:putfield        #118 <Field VelocityTracker mVelocityTracker>
	//* 327  651:aload_0         
	//* 328  652:fconst_0        
	//* 329  653:putfield        #104 <Field float mTranslationX>
	//* 330  656:aload_0         
	//* 331  657:fconst_0        
	//* 332  658:putfield        #146 <Field float mDownX>
	//* 333  661:aload_0         
	//* 334  662:fconst_0        
	//* 335  663:putfield        #148 <Field float mDownY>
	//* 336  666:aload_0         
	//* 337  667:iconst_0        
	//* 338  668:putfield        #150 <Field boolean mSwiping>
	//* 339  671:iconst_0        
	//* 340  672:ireturn         
	//* 341  673:aload_0         
	//* 342  674:aload_2         
	//* 343  675:invokevirtual   #158 <Method float MotionEvent.getRawX()>
	//* 344  678:putfield        #146 <Field float mDownX>
	//* 345  681:aload_0         
	//* 346  682:aload_2         
	//* 347  683:invokevirtual   #161 <Method float MotionEvent.getRawY()>
	//* 348  686:putfield        #148 <Field float mDownY>
	//* 349  689:aload_0         
	//* 350  690:getfield        #93  <Field SwipeDismissTouchListener$DismissCallbacks mCallbacks>
	//* 351  693:aload_0         
	//* 352  694:getfield        #91  <Field Object mToken>
	//* 353  697:invokeinterface #215 <Method boolean SwipeDismissTouchListener$DismissCallbacks.canDismiss(Object)>
	//* 354  702:ifeq            720
	//* 355  705:aload_0         
	//* 356  706:invokestatic    #218 <Method VelocityTracker VelocityTracker.obtain()>
	//* 357  709:putfield        #118 <Field VelocityTracker mVelocityTracker>
	//* 358  712:aload_0         
	//* 359  713:getfield        #118 <Field VelocityTracker mVelocityTracker>
	//* 360  716:aload_2         
	//* 361  717:invokevirtual   #154 <Method void VelocityTracker.addMovement(MotionEvent)>
	//* 362  720:iconst_0        
	//* 363  721:ireturn         
			{
				return false;
