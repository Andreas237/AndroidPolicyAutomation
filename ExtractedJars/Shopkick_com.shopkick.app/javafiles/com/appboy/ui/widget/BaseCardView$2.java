	...
	implements android.view.r.OnGlobalLayoutListener
{
	...
	//   16   28:invokevirtual   #45  <Method void ImageView.setLayoutParams(android.view.ViewGroup$LayoutParams)>
		ViewUtils.removeOnGlobalLayoutListenerSafe(val$imageView.getViewTreeObserver(), ((android.view.r.OnGlobalLayoutListener) (this)));
	//   17   31:aload_0         
	//   18   32:getfield        #23  <Field ImageView val$imageView>
	//   19   35:invokevirtual   #49  <Method android.view.ViewTreeObserver ImageView.getViewTreeObserver()>
	//   20   38:aload_0         
	//   21   39:invokestatic    #55  <Method void ViewUtils.removeOnGlobalLayoutListenerSafe(android.view.ViewTreeObserver, android.view.ViewTreeObserver$OnGlobalLayoutListener)>
	//   22   42:return          
	}
