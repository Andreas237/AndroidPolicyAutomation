	...
	implements Runnable
{
	...
	//   34   72:invokevirtual   #81  <Method void LinearLayout.setVisibility(int)>
		if(val$event.getCardCount(AppboyXamarinFormsFeedFragment.access$1000(this$0)) == 0)
	//*  35   75:aload_0         
	...
	//* 163  385:goto            429
		{
			AppboyXamarinFormsFeedFragment.access$500(this$0).replaceFeed(val$event.getFeedCards(AppboyXamarinFormsFeedFragment.access$1000(this$0)));
	//  164  388:aload_0         
	...
	AppboyXamarinFormsFeedFragment$5$1()
	{
		this$1 = final__pcls5;
	//    0    0:aload_0         
	//    1    1:aload_1         
...
/* anonymous class */
		...
		implements IEventSubscriber
	{
		...
		//    6   12:return          
			...
			{
				activity.runOnUiThread(((Runnable) (((AppboyXamarinFormsFeedFragment._cls5._cls1) (feedupdatedevent)). new AppboyXamarinFormsFeedFragment._cls5._cls1())));
		//    7   13:aload_2         
