	...
	implements IEventSubscriber
{
	...
	//    6   12:return          
		...
		{
			((Activity) (fragmentactivity)).runOnUiThread(new Runnable() {
				...
				//   34   72:invokevirtual   #81  <Method void LinearLayout.setVisibility(int)>
					if(event.getCardCount(AppboyFeedFragment.access$800(this$0)) == 0)
				//*  35   75:aload_0         
				...
				//* 103  242:ifne            325
						{
							AppboyLogger.d(AppboyFeedFragment.access$500(), "Old feed was empty, putting up a network spinner and registering the network error message on a delay of 5000ms.");
				...
				//* 164  388:goto            525
					{
						if(AppboyFeedFragment.access$1100(this$0) && event.getCardCount(AppboyFeedFragment.access$800(this$0)) != event.getUnreadCardCount(AppboyFeedFragment.access$800(this$0)))
				//* 165  391:aload_0         
				...
				//* 184  438:icmpeq          484
							AppboyFeedFragment.access$400(this$0).replaceFeed(sortFeedCards(event.getFeedCards(AppboyFeedFragment.access$800(this$0))));
				//  185  441:aload_0         
				...
				//* 201  481:goto            514
							AppboyFeedFragment.access$400(this$0).replaceFeed(event.getFeedCards(AppboyFeedFragment.access$800(this$0)));
				//  202  484:aload_0         
