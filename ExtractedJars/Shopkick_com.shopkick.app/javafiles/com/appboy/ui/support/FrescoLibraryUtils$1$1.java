...
class FrescoLibraryUtils$1$1
	implements Runnable
{

	public void run()
	{
		val$simpleDraweeView.setAspectRatio(val$imageAspectRatio);
	//    0    0:aload_0         
...
/* anonymous class */
	static final class FrescoLibraryUtils._cls1 extends BaseControllerListener
	{
		...
		//   15   34:i2f             
		//   16   35:fstore          4
			simpleDraweeView.post(((Runnable) (((FrescoLibraryUtils._cls1._cls1) (f)). new FrescoLibraryUtils._cls1._cls1())));
		//   17   37:aload_0         
