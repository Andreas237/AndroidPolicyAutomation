...
public class AppboyLogger
{
	...
	{
		br br1 = a;
	//    0    0:getstatic       #37  <Field br a>
	//    1    3:astore_3        
		if(br1 != null && br1.a() && s != null)
	//*   2    4:aload_3         
	//*   3    5:ifnull          28
	//*   4    8:aload_3         
	//*   5    9:invokevirtual   #42  <Method boolean br.a()>
	//*   6   12:ifeq            28
	//*   7   15:aload_0         
	//*   8   16:ifnull          28
			a.a(s, s1, throwable);
	//    9   19:getstatic       #37  <Field br a>
	//   10   22:aload_0         
	//   11   23:aload_1         
	//   12   24:aload_2         
	//   13   25:invokevirtual   #44  <Method void br.a(String, String, Throwable)>
	//   14   28:return          
	}
	...
	//    1    2:monitorenter    
		String s = dy.a("log.tag.APPBOY", "");
	//    2    3:ldc1            #47  <String "log.tag.APPBOY">
	//    3    5:ldc1            #49  <String "">
	//    4    7:invokestatic    #54  <Method String dy.a(String, String)>
	//    5   10:astore_0        
	...
	//   21   37:astore_3        
		stringbuilder.append("Appboy v2.5.1 .");
	//   22   38:aload_3         
	//   23   39:ldc1            #124 <String "Appboy v2.5.1 .">
	...
	public static void setTestUserDeviceLoggingManager(br br1)
	{
		a = br1;
	//    0    0:aload_0         
	//    1    1:putstatic       #37  <Field br a>
	//    2    4:return          
	}
