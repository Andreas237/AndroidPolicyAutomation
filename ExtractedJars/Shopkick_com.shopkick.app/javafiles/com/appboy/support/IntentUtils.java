...
public final class IntentUtils
{
	...
	//   22   41:pop             
			Log.d(((String) (context)), ((StringBuilder) (obj)).toString());
	//   23   42:aload_0         
	//   24   43:aload_2         
	//   25   44:invokevirtual   #68  <Method String StringBuilder.toString()>
	//   26   47:invokestatic    #74  <Method int Log.d(String, String)>
	//   27   50:pop             
			return;
	//   28   51:return          
		}
	...
	private static final String a = String.format("%s.%s", new Object[] {
		"Appboy v2.5.1 .", ((Class) (com/appboy/support/IntentUtils)).getName()
	});
	...
	//    3    6:dup             
	//    4    7:iconst_0        
	//    5    8:ldc1            #14  <String "Appboy v2.5.1 .">
	//    6   10:aastore         
	//    7   11:dup             
	//    8   12:iconst_1        
