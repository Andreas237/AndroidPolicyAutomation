...
public final class ValidationUtils
{
	...
	public static boolean isValidLogCustomEventInput(String s, dh dh1)
	{
		if(StringUtils.isNullOrBlank(s))
	//*   0    0:aload_0         
	//*   1    1:invokestatic    #86  <Method boolean StringUtils.isNullOrBlank(String)>
	//*   2    4:ifeq            18
		{
	...
	//    4   10:ldc1            #88  <String "The custom event name cannot be null or contain only whitespaces. Invalid custom event.">
	...
	//    8   17:ireturn         
		...
		if(dh1.l().contains(((Object) (s))))
	//*   9   18:aload_1         
	//*  10   19:invokevirtual   #94  <Method Set dh.l()>
	//*  11   22:aload_0         
	//*  12   23:invokeinterface #100 <Method boolean Set.contains(Object)>
	//*  13   28:ifeq            74
		{
			dh1 = ((dh) (a));
	...
	//   20   43:aload_2         
	//   21   44:ldc1            #102 <String "The custom event is a blacklisted custom event: ">
	...
	//   28   56:aload_2         
	//   29   57:ldc1            #104 <String ". Invalid custom event.">
	//   30   59:invokevirtual   #44  <Method StringBuilder StringBuilder.append(String)>
	//   31   62:pop             
			AppboyLogger.w(((String) (dh1)), stringbuilder.toString());
	//   32   63:aload_1         
	//   33   64:aload_2         
	...
	public static boolean isValidLogPurchaseInput(String s, String s1, BigDecimal bigdecimal, int i, dh dh1, Set set)
	{
		if(StringUtils.isNullOrBlank(s))
	//*   0    0:aload_0         
	//*   1    1:invokestatic    #86  <Method boolean StringUtils.isNullOrBlank(String)>
	...
	//    3    7:getstatic       #19  <Field String a>
	//    4   10:ldc1            #109 <String "The productId is empty, not logging in-app purchase to Appboy.">
	//    5   12:invokestatic    #58  <Method int AppboyLogger.w(String, String)>
	//    6   15:pop             
			return false;
	//    7   16:iconst_0        
	//    8   17:ireturn         
		...
		if(dh1.n().contains(((Object) (s))))
	//*   9   18:aload           4
	//*  10   20:invokevirtual   #112 <Method Set dh.n()>
	//*  11   23:aload_0         
	//*  12   24:invokeinterface #100 <Method boolean Set.contains(Object)>
	//*  13   29:ifeq            68
		{
			s1 = a;
	...
	//   20   44:aload_2         
	//   21   45:ldc1            #114 <String "The productId is a blacklisted productId: ">
	...
	//   43   84:aload_1         
	//   44   85:ldc1            #116 <String "The currencyCode is null. Expected one of ">
	//   45   87:invokevirtual   #44  <Method StringBuilder StringBuilder.append(String)>
	//   46   90:pop             
			((StringBuilder) (s1)).append(((Object) (set)));
	//   47   91:aload_1         
	//   48   92:aload           5
	//   49   94:invokevirtual   #119 <Method StringBuilder StringBuilder.append(Object)>
	//   50   97:pop             
	...
	//*  58  109:aload           5
	//*  59  111:aload_1         
	//*  60  112:invokeinterface #100 <Method boolean Set.contains(Object)>
	//*  61  117:ifne            170
		{
			s = a;
	...
	//   68  132:aload_2         
	//   69  133:ldc1            #121 <String "The currencyCode ">
	...
	//   76  145:aload_2         
	//   77  146:ldc1            #123 <String " is invalid. Expected one of ">
	//   78  148:invokevirtual   #44  <Method StringBuilder StringBuilder.append(String)>
	//   79  151:pop             
			((StringBuilder) (bigdecimal)).append(((Object) (set)));
	//   80  152:aload_2         
	//   81  153:aload           5
	//   82  155:invokevirtual   #119 <Method StringBuilder StringBuilder.append(Object)>
	//   83  158:pop             
	...
	//   94  177:ldc1            #125 <String "The price is null.">
	...
	//  107  201:aload_1         
	//  108  202:ldc1            #127 <String "The requested purchase quantity of ">
	...
	//  115  214:aload_1         
	//  116  215:ldc1            #129 <String " is less than zero.">
	...
	//  134  249:astore_1        
			((StringBuilder) (s1)).append("The requested purchase quantity of ");
	//  135  250:aload_1         
	//  136  251:ldc1            #127 <String "The requested purchase quantity of ">
	...
	//  143  263:aload_1         
	//  144  264:ldc1            #131 <String " is greater than the maximum of ">
	...
	//    3    7:getstatic       #19  <Field String a>
	//    4   10:ldc1            #141 <String "Campaign ID cannot be null or blank">
	//    5   12:invokestatic    #58  <Method int AppboyLogger.w(String, String)>
	//    6   15:pop             
			return false;
	//    7   16:iconst_0        
	...
	//*   9   18:aload_1         
	//*  10   19:invokestatic    #86  <Method boolean StringUtils.isNullOrBlank(String)>
	//*  11   22:ifeq            36
		{
			AppboyLogger.w(a, "Push story page ID cannot be null or blank");
	//   12   25:getstatic       #19  <Field String a>
	//   13   28:ldc1            #143 <String "Push story page ID cannot be null or blank">
