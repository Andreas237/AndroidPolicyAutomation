	...
	implements IInAppMessage
{
	...
	private InAppMessageBase(String s1, Map map, boolean flag, boolean flag1, ClickAction clickaction, String s2, int i1, 
			...
			boolean flag5, JSONObject jsonobject, bl bl1)
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #77  <Method void Object()>
		l = true;
	...
	//  143  287:aload_0         
	//  144  288:aload           24
	//  145  290:putfield        #188 <Field bl i>
	//  146  293:return          
	}

	public InAppMessageBase(JSONObject jsonobject, bl bl1)
	{
		this(jsonobject.optString("message"), dt.a(jsonobject.optJSONObject("extras"), ((Map) (new HashMap()))), jsonobject.optBoolean("animate_in", true), jsonobject.optBoolean("animate_out", true), (ClickAction)dt.a(jsonobject, "click_action", com/appboy/enums/inappmessage/ClickAction, ((Enum) (ClickAction.NONE))), jsonobject.optString("uri"), jsonobject.optInt("bg_color"), jsonobject.optInt("icon_color"), jsonobject.optInt("icon_bg_color"), jsonobject.optInt("text_color"), jsonobject.optString("icon"), jsonobject.optString("image_url"), (DismissType)dt.a(jsonobject, "message_close", com/appboy/enums/inappmessage/DismissType, ((Enum) (DismissType.AUTO_DISMISS))), jsonobject.optInt("duration"), jsonobject.optString("campaign_id"), jsonobject.optString("card_id"), jsonobject.optString("trigger_id"), false, false, (Orientation)dt.a(jsonobject, "orientation", com/appboy/enums/inappmessage/Orientation, ((Enum) (Orientation.ANY))), jsonobject.optBoolean("use_webview", false), jsonobject.optBoolean("is_control"), jsonobject, bl1);
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	//   10   20:invokestatic    #213 <Method Map dt.a(JSONObject, Map)>
	//   11   23:aload_1         
	...
	//   23   45:invokestatic    #226 <Method Enum dt.a(JSONObject, String, Class, Enum)>
	...
	//   50  101:invokestatic    #226 <Method Enum dt.a(JSONObject, String, Class, Enum)>
	...
	//   70  142:invokestatic    #226 <Method Enum dt.a(JSONObject, String, Class, Enum)>
	...
	//   79  162:aload_1         
	//   80  163:aload_2         
	//   81  164:invokespecial   #262 <Method void InAppMessageBase(String, Map, boolean, boolean, ClickAction, String, int, int, int, int, String, String, DismissType, int, String, String, String, boolean, boolean, Orientation, boolean, boolean, JSONObject, bl)>
	//   82  167:return          
	}
	...
	//   51  111:invokestatic    #392 <Method cc cc.c(String, String, String)>
	//   52  114:astore_1        
			i.a(((bo.app.bu) (cc1)));
	//   53  115:aload_0         
	//   54  116:getfield        #188 <Field bl i>
	//   55  119:aload_1         
	//   56  120:invokeinterface #397 <Method boolean bl.a(bo.app.bu)>
	//   57  125:pop             
			B = true;
	//   58  126:aload_0         
	//   59  127:iconst_1        
	...
	//   64  134:aload_0         
	//   65  135:getfield        #188 <Field bl i>
	//   66  138:aload_1         
	//   67  139:invokeinterface #400 <Method void bl.a(Throwable)>
			return false;
	//   68  144:iconst_0        
	//   69  145:ireturn         
		}
	...
	//   44   98:ireturn         
		...
		if(i == null)
	//*  45   99:aload_0         
	//*  46  100:getfield        #188 <Field bl i>
	...
	//   53  117:ireturn         
		...
		try
		{
			inappmessagefailuretype = ((InAppMessageFailureType) (cc.a(b, c, d, inappmessagefailuretype)));
	//   54  118:aload_0         
	...
	//   60  130:aload_1         
	//   61  131:invokestatic    #411 <Method cc cc.a(String, String, String, InAppMessageFailureType)>
	//   62  134:astore_1        
			i.a(((bo.app.bu) (inappmessagefailuretype)));
	//   63  135:aload_0         
	//   64  136:getfield        #188 <Field bl i>
	//   65  139:aload_1         
	//   66  140:invokeinterface #397 <Method boolean bl.a(bo.app.bu)>
	//   67  145:pop             
			C = true;
	//   68  146:aload_0         
	//   69  147:iconst_1        
	...
	//   74  154:aload_0         
	//   75  155:getfield        #188 <Field bl i>
	//   76  158:aload_1         
	//   77  159:invokeinterface #400 <Method void bl.a(Throwable)>
			return false;
	//   78  164:iconst_0        
	//   79  165:ireturn         
		}
	...
	//   49  107:aload_0         
	//   50  108:getfield        #184 <Field String d>
	//   51  111:invokestatic    #421 <Method cc cc.b(String, String, String)>
	//   52  114:astore_1        
			i.a(((bo.app.bu) (cc1)));
	//   53  115:aload_0         
	//   54  116:getfield        #188 <Field bl i>
	...
	//*   6   14:ifne            37
			i.a(((bo.app.fb) (new fd(d))));
	//    7   17:aload_0         
	//    8   18:getfield        #188 <Field bl i>
	//    9   21:new             #424 <Class fd>
	//   10   24:dup             
	//   11   25:aload_0         
	//   12   26:getfield        #184 <Field String d>
	//   13   29:invokespecial   #427 <Method void fd(String)>
	//   14   32:invokeinterface #430 <Method void bl.a(bo.app.fb)>
	//   15   37:return          
	}
