...
public class InAppMessageFull extends InAppMessageImmersiveBase
{
	...
	public InAppMessageFull(JSONObject jsonobject, bl bl)
	{
		super(jsonobject, bl);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #21  <Method void InAppMessageImmersiveBase(JSONObject, bl)>
	...
	//    9   15:invokestatic    #29  <Method Enum dt.a(JSONObject, String, Class, Enum)>
