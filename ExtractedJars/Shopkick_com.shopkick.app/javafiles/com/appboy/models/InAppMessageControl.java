...
public class InAppMessageControl extends InAppMessageBase
{
	...
	public InAppMessageControl(JSONObject jsonobject, bl bl1)
	{
		super(jsonobject, bl1);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #10  <Method void InAppMessageBase(JSONObject, bl)>
		j = false;
	//    4    6:aload_0         
	//    5    7:iconst_0        
	...
	//   38   78:invokestatic    #67  <Method cc cc.a(String, String, String)>
	//   39   81:astore_1        
			i.a(((bo.app.bu) (cc1)));
	//   40   82:aload_0         
	//   41   83:getfield        #46  <Field bl i>
	//   42   86:aload_1         
	//   43   87:invokeinterface #72  <Method boolean bl.a(bo.app.bu)>
	//   44   92:pop             
			j = true;
	//   45   93:aload_0         
	//   46   94:iconst_1        
	...
	//   51  101:aload_0         
	//   52  102:getfield        #46  <Field bl i>
	//   53  105:aload_1         
	//   54  106:invokeinterface #75  <Method void bl.a(Throwable)>
			return false;
	//   55  111:iconst_0        
	//   56  112:ireturn         
		}
