	...
	implements IInAppMessageImmersive
{
	...
	public InAppMessageImmersiveBase(JSONObject jsonobject, bl bl1)
	{
		this(jsonobject, bl1, jsonobject.optString("header"), jsonobject.optInt("header_text_color"), jsonobject.optInt("close_btn_color"), (ImageStyle)dt.a(jsonobject, "image_style", com/appboy/enums/inappmessage/ImageStyle, ((Enum) (ImageStyle.TOP))), (TextAlign)dt.a(jsonobject, "text_align_header", com/appboy/enums/inappmessage/TextAlign, ((Enum) (TextAlign.CENTER))), (TextAlign)dt.a(jsonobject, "text_align_message", com/appboy/enums/inappmessage/TextAlign, ((Enum) (TextAlign.CENTER))));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:aload_1         
	...
	//   16   29:invokestatic    #75  <Method Enum dt.a(JSONObject, String, Class, Enum)>
	...
	//   22   43:invokestatic    #75  <Method Enum dt.a(JSONObject, String, Class, Enum)>
	...
	//   28   57:invokestatic    #75  <Method Enum dt.a(JSONObject, String, Class, Enum)>
	//   29   60:checkcast       #42  <Class TextAlign>
	//   30   63:invokespecial   #82  <Method void InAppMessageImmersiveBase(JSONObject, bl, String, int, int, ImageStyle, TextAlign, TextAlign)>
	...
	//*  48   97:icmpge          126
				((List) (bl1)).add(((Object) (new MessageButton(((JSONArray) (jsonobject)).optJSONObject(i)))));
	//   49  100:aload_2         
	...
	private InAppMessageImmersiveBase(JSONObject jsonobject, bl bl1, String s, int i, int i1, ImageStyle imagestyle, TextAlign textalign, 
			TextAlign textalign1)
	{
		super(jsonobject, bl1);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #118 <Method void InAppMessageBase(JSONObject, bl)>
		l = 0;
	//    4    6:aload_0         
	//    5    7:iconst_0        
	...
	//   43   91:ireturn         
		...
		try
		{
			cc cc1 = cc.a(b, c, d, messagebutton);
	//   44   92:aload_0         
	...
	//   50  104:aload_1         
	//   51  105:invokestatic    #248 <Method cc cc.a(String, String, String, MessageButton)>
	//   52  108:astore_2        
			r = cc.a(messagebutton);
	//   53  109:aload_0         
	//   54  110:aload_1         
	//   55  111:invokestatic    #251 <Method String cc.a(MessageButton)>
	//   56  114:putfield        #49  <Field String r>
			i.a(((bo.app.bu) (cc1)));
	//   57  117:aload_0         
	//   58  118:getfield        #238 <Field bl i>
	//   59  121:aload_2         
	//   60  122:invokeinterface #256 <Method boolean bl.a(bo.app.bu)>
	//   61  127:pop             
			q = true;
	//   62  128:aload_0         
	//   63  129:iconst_1        
	...
	//   68  136:aload_0         
	//   69  137:getfield        #238 <Field bl i>
	//   70  140:aload_1         
	//   71  141:invokeinterface #259 <Method void bl.a(Throwable)>
			return false;
	//   72  146:iconst_0        
	//   73  147:ireturn         
		}
	...
	//*  12   28:ifne            55
			i.a(((bo.app.fb) (new fd(d, r))));
	//   13   31:aload_0         
	//   14   32:getfield        #238 <Field bl i>
	//   15   35:new             #264 <Class fd>
	//   16   38:dup             
	//   17   39:aload_0         
	//   18   40:getfield        #214 <Field String d>
	//   19   43:aload_0         
	//   20   44:getfield        #49  <Field String r>
	//   21   47:invokespecial   #267 <Method void fd(String, String)>
	//   22   50:invokeinterface #270 <Method void bl.a(bo.app.fb)>
	//   23   55:return          
	}
