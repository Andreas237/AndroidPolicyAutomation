...
public class InAppMessageModal extends InAppMessageImmersiveBase
{
	...
	public InAppMessageModal(JSONObject jsonobject, bl bl)
	{
		super(jsonobject, bl);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #12  <Method void InAppMessageImmersiveBase(JSONObject, bl)>
	...
	//*   8   16:ifeq            38
		{
			e = (CropType)dt.a(jsonobject, "crop_type", com/appboy/enums/inappmessage/CropType, ((Enum) (CropType.CENTER_CROP)));
	//    9   19:aload_0         
	//   10   20:aload_1         
	//   11   21:ldc1            #27  <String "crop_type">
	//   12   23:ldc1            #29  <Class CropType>
	//   13   25:getstatic       #33  <Field CropType CropType.CENTER_CROP>
	//   14   28:invokestatic    #39  <Method Enum dt.a(JSONObject, String, Class, Enum)>
	...
	//   23   47:invokestatic    #39  <Method Enum dt.a(JSONObject, String, Class, Enum)>
