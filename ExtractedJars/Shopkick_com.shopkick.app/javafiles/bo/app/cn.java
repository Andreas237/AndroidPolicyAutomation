...
public final class cn extends ci
{
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #60  <Method JSONObject ci.g()>
	//    2    4:astore_1        
		if(jsonobject == null)
	//*   3    5:aload_1         
	//*   4    6:ifnonnull       11
	...
	//    6   10:areturn         
		try
		{
			if(c != null)
	//*   7   11:aload_0         
	//*   8   12:getfield        #46  <Field bu c>
	//*   9   15:ifnull          34
				jsonobject.put("geofence_event", c.forJsonPut());
	//   10   18:aload_1         
	//   11   19:ldc1            #62  <String "geofence_event">
	//   12   21:aload_0         
	//   13   22:getfield        #46  <Field bu c>
	//   14   25:invokeinterface #68  <Method Object bu.forJsonPut()>
	...
	{
		return v.b;
	//    0    0:getstatic       #89  <Field v v.b>
	//    1    3:areturn         
	}

	private static final String b = AppboyLogger.getAppboyLogTag(bo/app/cn);
	private final bu c;
