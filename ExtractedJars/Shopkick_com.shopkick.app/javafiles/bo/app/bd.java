...
public class bd
{
	...
	bd(Context context, String s, dh dh1)
	{
	//    0    0:aload_0         
	...
	//   60  124:aload_0         
	//   61  125:aload_3         
	//   62  126:invokevirtual   #83  <Method int dh.e()>
	//   63  129:putfield        #85  <Field int f>
		g = dh1.f();
	//   64  132:aload_0         
	//   65  133:aload_3         
	//   66  134:invokevirtual   #87  <Method int dh.f()>
	...
	//    3    7:astore_3        
		stringbuilder.append(u1.toString().toLowerCase(Locale.US));
	//    4    8:aload_3         
	//    5    9:aload_2         
	//    6   10:invokevirtual   #111 <Method String u.toString()>
	...
	void a(bz bz1)
	{
		int i = bz1.j();
	//    0    0:aload_1         
	//    1    1:invokevirtual   #181 <Method int bz.j()>
	//    2    4:istore_2        
		if(i >= 0)
	//*   3    5:iload_2         
	//*   4    6:iflt            60
	...
	//   14   27:aload           4
	//   15   29:ldc1            #183 <String "Min time since last geofence request reset via server configuration: ">
	//   16   31:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   17   34:pop             
			stringbuilder1.append(i);
	//   18   35:aload           4
	//   19   37:iload_2         
	//   20   38:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//   21   41:pop             
			stringbuilder1.append("s.");
	//   22   42:aload           4
	//   23   44:ldc1            #188 <String "s.">
	...
	//   29   56:invokestatic    #190 <Method int AppboyLogger.i(String, String)>
	//   30   59:pop             
		}
		i = bz1.k();
	//   31   60:aload_1         
	//   32   61:invokevirtual   #193 <Method int bz.k()>
	//   33   64:istore_2        
		if(i >= 0)
	//*  34   65:iload_2         
	//*  35   66:iflt            115
	...
	//   45   86:aload_3         
	//   46   87:ldc1            #195 <String "Min time since last geofence report reset via server configuration: ">
	//   47   89:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   48   92:pop             
			stringbuilder.append(i);
	//   49   93:aload_3         
	//   50   94:iload_2         
	//   51   95:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//   52   98:pop             
			stringbuilder.append("s.");
	//   53   99:aload_3         
	//   54  100:ldc1            #188 <String "s.">
	//   55  102:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   56  105:pop             
			AppboyLogger.i(((String) (bz1)), stringbuilder.toString());
	//   57  106:aload_1         
	//   58  107:aload_3         
	//   59  108:invokevirtual   #47  <Method String StringBuilder.toString()>
	//   60  111:invokestatic    #190 <Method int AppboyLogger.i(String, String)>
	//   61  114:pop             
		}
	//   62  115:return          
	}
	...
	//    0    0:new             #198 <Class HashSet>
	//    1    3:dup             
	//    2    4:invokespecial   #199 <Method void HashSet()>
	//    3    7:astore_2        
		for(list = ((List) (list.iterator())); ((Iterator) (list)).hasNext(); ((Set) (hashset)).add(((Object) (((AppboyGeofence)((Iterator) (list)).next()).getId()))));
	//    4    8:aload_1         
	//    5    9:invokeinterface #202 <Method Iterator List.iterator()>
	//    6   14:astore_1        
	//    7   15:aload_1         
	...
	//   13   31:checkcast       #204 <Class AppboyGeofence>
	//   14   34:invokevirtual   #207 <Method String AppboyGeofence.getId()>
	//   15   37:invokeinterface #211 <Method boolean Set.add(Object)>
	//   16   42:pop             
	//*  17   43:goto            15
		Object obj = ((Object) (new HashSet(((java.util.Collection) (c.keySet())))));
	//   18   46:new             #198 <Class HashSet>
	//   19   49:dup             
	//   20   50:aload_0         
	//   21   51:getfield        #64  <Field Map c>
	//   22   54:invokeinterface #137 <Method Set Map.keySet()>
	//   23   59:invokespecial   #214 <Method void HashSet(java.util.Collection)>
	//   24   62:astore_3        
		list = ((List) (b.edit()));
	//   25   63:aload_0         
	//   26   64:getfield        #59  <Field SharedPreferences b>
	//   27   67:invokeinterface #218 <Method android.content.SharedPreferences$Editor SharedPreferences.edit()>
	//   28   72:astore_1        
	...
	//*  43  107:invokeinterface #221 <Method boolean Set.contains(Object)>
	//*  44  112:ifne            188
			{
				String s1 = h;
	...
	//   51  129:aload           6
	//   52  131:ldc1            #223 <String "Deleting outdated re-eligibility id ">
	...
	//   59  145:aload           6
	//   60  147:ldc1            #225 <String " from re-eligibility list.">
	...
	//   70  168:aload           4
	//   71  170:invokeinterface #229 <Method Object Map.remove(Object)>
	//   72  175:pop             
				((android.content.SharedPreferences.Editor) (list)).remove(s);
	//   73  176:aload_1         
	//   74  177:aload           4
	//   75  179:invokeinterface #234 <Method android.content.SharedPreferences$Editor android.content.SharedPreferences$Editor.remove(String)>
	//   76  184:pop             
			} else
	//*  77  185:goto            80
			{
	...
	//   84  202:aload           6
	//   85  204:ldc1            #236 <String "Retaining re-eligibility id ">
	...
	//   92  218:aload           6
	//   93  220:ldc1            #238 <String " in re-eligibility list.">
	...
	//  102  240:aload_1         
	//  103  241:invokeinterface #241 <Method void android.content.SharedPreferences$Editor.apply()>
	//  104  246:return          
	}

	boolean a(long l, AppboyGeofence appboygeofence, u u1)
	{
	...
	//    3    7:ldc1            #245 <String "Geofence passed into getReportEligible() was null.">
	//    4    9:invokestatic    #248 <Method int AppboyLogger.w(String, String)>
	//    5   12:pop             
			return false;
	//    6   13:iconst_0        
	//    7   14:ireturn         
	...
	//    8   15:aload_3         
	//    9   16:invokevirtual   #207 <Method String AppboyGeofence.getId()>
	//   10   19:astore          10
		Object obj = ((Object) (a(s, u1)));
	//   11   21:aload_0         
	//   12   22:aload           10
	//   13   24:aload           4
	//   14   26:invokevirtual   #250 <Method String a(String, u)>
	//   15   29:astore          11
		int i;
		if(u1.equals(((Object) (u.a))))
	//*  16   31:aload           4
	//*  17   33:getstatic       #253 <Field u u.a>
	//*  18   36:invokevirtual   #256 <Method boolean u.equals(Object)>
	//*  19   39:ifeq            51
			i = appboygeofence.getCooldownEnterSeconds();
	//   20   42:aload_3         
	//   21   43:invokevirtual   #259 <Method int AppboyGeofence.getCooldownEnterSeconds()>
	//   22   46:istore          5
		else
	//*  23   48:goto            57
			i = appboygeofence.getCooldownExitSeconds();
	//   24   51:aload_3         
	//   25   52:invokevirtual   #262 <Method int AppboyGeofence.getCooldownExitSeconds()>
	//   26   55:istore          5
		long l1 = l - e;
	//   27   57:lload_1         
	//   28   58:aload_0         
	...
	//   43   87:astore          4
			((StringBuilder) (u1)).append("Geofence report suppressed since only ");
	//   44   89:aload           4
	//   45   91:ldc2            #264 <String "Geofence report suppressed since only ">
	//   46   94:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   47   97:pop             
			((StringBuilder) (u1)).append(l1);
	//   48   98:aload           4
	//   49  100:lload           6
	//   50  102:invokevirtual   #267 <Method StringBuilder StringBuilder.append(long)>
	//   51  105:pop             
			((StringBuilder) (u1)).append(" seconds have passed since the last time geofences were reported globally (minimum interval: ");
	//   52  106:aload           4
	//   53  108:ldc2            #269 <String " seconds have passed since the last time geofences were reported globally (minimum interval: ">
	//   54  111:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   55  114:pop             
			((StringBuilder) (u1)).append(g);
	//   56  115:aload           4
	//   57  117:aload_0         
	//   58  118:getfield        #89  <Field int g>
	//   59  121:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//   60  124:pop             
			((StringBuilder) (u1)).append("). id:");
	//   61  125:aload           4
	//   62  127:ldc2            #271 <String "). id:">
	//   63  130:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   64  133:pop             
			((StringBuilder) (u1)).append(s);
	//   65  134:aload           4
	//   66  136:aload           10
	//   67  138:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   68  141:pop             
			AppboyLogger.d(((String) (appboygeofence)), ((StringBuilder) (u1)).toString());
	//   69  142:aload_3         
	//   70  143:aload           4
	...
	//*  78  158:aload           11
	//*  79  160:invokeinterface #274 <Method boolean Map.containsKey(Object)>
	//*  80  165:ifeq            376
		{
	...
	//   84  173:aload           11
	//   85  175:invokeinterface #277 <Method Object Map.get(Object)>
	//   86  180:checkcast       #165 <Class Long>
	//   87  183:invokevirtual   #281 <Method long Long.longValue()>
	//   88  186:lsub            
	//   89  187:lstore          8
			if((long)i > l2)
	//*  90  189:iload           5
	...
	//  101  211:aload           11
	//  102  213:ldc2            #264 <String "Geofence report suppressed since only ">
	//  103  216:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//  104  219:pop             
				((StringBuilder) (obj)).append(l2);
	//  105  220:aload           11
	//  106  222:lload           8
	//  107  224:invokevirtual   #267 <Method StringBuilder StringBuilder.append(long)>
	//  108  227:pop             
	...
	//  109  228:aload           11
	//  110  230:ldc2            #283 <String " seconds have passed since the last time this geofence/transition combination was reported (minimum interval: ">
	//  111  233:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//  112  236:pop             
				((StringBuilder) (obj)).append(i);
	//  113  237:aload           11
	//  114  239:iload           5
	//  115  241:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//  116  244:pop             
				((StringBuilder) (obj)).append("). id:");
	//  117  245:aload           11
	//  118  247:ldc2            #271 <String "). id:">
	...
	//  125  262:aload           11
	//  126  264:ldc2            #285 <String " transition:">
	//  127  267:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//  128  270:pop             
				((StringBuilder) (obj)).append(((Object) (u1)));
	//  129  271:aload           11
	//  130  273:aload           4
	//  131  275:invokevirtual   #288 <Method StringBuilder StringBuilder.append(Object)>
	//  132  278:pop             
	...
	//  146  304:aload           12
	//  147  306:lload           8
	//  148  308:invokevirtual   #267 <Method StringBuilder StringBuilder.append(long)>
	//  149  311:pop             
	...
	//  150  312:aload           12
	//  151  314:ldc2            #283 <String " seconds have passed since the last time this geofence/transition combination was reported (minimum interval: ">
	//  152  317:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//  153  320:pop             
			stringbuilder.append(i);
	//  154  321:aload           12
	//  155  323:iload           5
	//  156  325:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//  157  328:pop             
			stringbuilder.append("). id:");
	//  158  329:aload           12
	//  159  331:ldc2            #271 <String "). id:">
	...
	//  166  346:aload           12
	//  167  348:ldc2            #285 <String " transition:">
	//  168  351:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//  169  354:pop             
			stringbuilder.append(((Object) (u1)));
	//  170  355:aload           12
	//  171  357:aload           4
	//  172  359:invokevirtual   #288 <Method StringBuilder StringBuilder.append(Object)>
	//  173  362:pop             
	...
	//  186  389:aload           12
	//  187  391:ldc2            #290 <String "Geofence report eligible since this geofence/transition combination has never reported. id:">
	...
	//  194  406:aload           12
	//  195  408:ldc2            #292 <String " ">
	//  196  411:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//  197  414:pop             
			stringbuilder1.append(((Object) (u1)));
	//  198  415:aload           12
	//  199  417:aload           4
	//  200  419:invokevirtual   #288 <Method StringBuilder StringBuilder.append(Object)>
	//  201  422:pop             
	...
	//  212  444:astore          4
		((StringBuilder) (u1)).append("Geofence report eligible since ");
	//  213  446:aload           4
	//  214  448:ldc2            #294 <String "Geofence report eligible since ">
	//  215  451:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//  216  454:pop             
		((StringBuilder) (u1)).append(l1);
	//  217  455:aload           4
	//  218  457:lload           6
	//  219  459:invokevirtual   #267 <Method StringBuilder StringBuilder.append(long)>
	//  220  462:pop             
		((StringBuilder) (u1)).append(" seconds have passed since the last time geofences were reported globally (minimum interval: ");
	//  221  463:aload           4
	//  222  465:ldc2            #269 <String " seconds have passed since the last time geofences were reported globally (minimum interval: ">
	...
	//  228  478:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//  229  481:pop             
		((StringBuilder) (u1)).append("). id:");
	//  230  482:aload           4
	//  231  484:ldc2            #271 <String "). id:">
	...
	//  252  529:invokeinterface #218 <Method android.content.SharedPreferences$Editor SharedPreferences.edit()>
	//  253  534:astore_3        
		((android.content.SharedPreferences.Editor) (appboygeofence)).putLong(((String) (obj)), l);
	//  254  535:aload_3         
	//  255  536:aload           11
	//  256  538:lload_1         
	//  257  539:invokeinterface #298 <Method android.content.SharedPreferences$Editor android.content.SharedPreferences$Editor.putLong(String, long)>
	//  258  544:pop             
		((android.content.SharedPreferences.Editor) (appboygeofence)).apply();
	//  259  545:aload_3         
	//  260  546:invokeinterface #241 <Method void android.content.SharedPreferences$Editor.apply()>
		e = l;
	//  261  551:aload_0         
	//  262  552:lload_1         
	...
	//  266  560:invokeinterface #218 <Method android.content.SharedPreferences$Editor SharedPreferences.edit()>
	//  267  565:astore_3        
	...
	//  270  569:lload_1         
	//  271  570:invokeinterface #298 <Method android.content.SharedPreferences$Editor android.content.SharedPreferences$Editor.putLong(String, long)>
	//  272  575:pop             
		((android.content.SharedPreferences.Editor) (appboygeofence)).apply();
	//  273  576:aload_3         
	//  274  577:invokeinterface #241 <Method void android.content.SharedPreferences$Editor.apply()>
		return true;
	//  275  582:iconst_1        
	//  276  583:ireturn         
	}
	...
	//   19   37:aload           7
	//   20   39:ldc2            #301 <String "Geofence request suppressed since only ">
	//   21   42:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   22   45:pop             
			stringbuilder.append(l1);
	//   23   46:aload           7
	//   24   48:lload           4
	//   25   50:invokevirtual   #267 <Method StringBuilder StringBuilder.append(long)>
	//   26   53:pop             
			stringbuilder.append(" seconds have passed since the last time geofences were requested (minimum interval: ");
	//   27   54:aload           7
	//   28   56:ldc2            #303 <String " seconds have passed since the last time geofences were requested (minimum interval: ">
	...
	//   34   69:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//   35   72:pop             
			stringbuilder.append(").");
	//   36   73:aload           7
	//   37   75:ldc2            #305 <String ").">
	...
	//   55  113:aload           7
	//   56  115:ldc2            #307 <String "Geofence request eligible. Ignoring rate limit for this geofence request. Elapsed time since last request:">
	//   57  118:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   58  121:pop             
			stringbuilder1.append(l1);
	//   59  122:aload           7
	//   60  124:lload           4
	//   61  126:invokevirtual   #267 <Method StringBuilder StringBuilder.append(long)>
	//   62  129:pop             
	...
	//   75  158:aload           7
	//   76  160:ldc2            #309 <String "Geofence request eligible since ">
	//   77  163:invokevirtual   #43  <Method StringBuilder StringBuilder.append(String)>
	//   78  166:pop             
			stringbuilder2.append(l1);
	//   79  167:aload           7
	//   80  169:lload           4
	//   81  171:invokevirtual   #267 <Method StringBuilder StringBuilder.append(long)>
	//   82  174:pop             
			stringbuilder2.append(" seconds have passed since the last time geofences were requested (minimum interval: ");
	//   83  175:aload           7
	//   84  177:ldc2            #303 <String " seconds have passed since the last time geofences were requested (minimum interval: ">
	...
	//   90  190:invokevirtual   #186 <Method StringBuilder StringBuilder.append(int)>
	//   91  193:pop             
			stringbuilder2.append(").");
	//   92  194:aload           7
	//   93  196:ldc2            #305 <String ").">
	...
	//  106  223:invokeinterface #218 <Method android.content.SharedPreferences$Editor SharedPreferences.edit()>
	//  107  228:astore          6
	...
	//  112  238:invokeinterface #298 <Method android.content.SharedPreferences$Editor android.content.SharedPreferences$Editor.putLong(String, long)>
	//  113  243:pop             
		editor.apply();
	//  114  244:aload           6
	//  115  246:invokeinterface #241 <Method void android.content.SharedPreferences$Editor.apply()>
		return true;
	//  116  251:iconst_1        
	//  117  252:ireturn         
	}

	private static final String h = AppboyLogger.getAppboyLogTag(bo/app/bd);
