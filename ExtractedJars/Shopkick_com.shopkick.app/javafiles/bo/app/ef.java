	...
	implements ei
{
	...
	public boolean a(fb fb)
	{
		if(fb instanceof fa)
	//*   0    0:aload_1         
	//*   1    1:instanceof      #45  <Class fa>
	//*   2    4:ifeq            38
		{
			fb = ((fb) ((fa)fb));
	//    3    7:aload_1         
	//    4    8:checkcast       #45  <Class fa>
	//    5   11:astore_1        
			if(!StringUtils.isNullOrBlank(((fa) (fb)).a()) && ((fa) (fb)).a().equals(((Object) (a))))
	//*   6   12:aload_1         
	//*   7   13:invokevirtual   #48  <Method String fa.a()>
	//*   8   16:invokestatic    #54  <Method boolean StringUtils.isNullOrBlank(String)>
	//*   9   19:ifne            38
	//*  10   22:aload_1         
	//*  11   23:invokevirtual   #48  <Method String fa.a()>
	//*  12   26:aload_0         
