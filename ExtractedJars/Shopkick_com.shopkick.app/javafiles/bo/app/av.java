...
public final class av
{
	public final class a
	{
		...
		{
			if(i1 < 0 || i1 >= av.e(a)) goto _L2; else goto _L1
		//    0    0:iload_1         
		//    1    1:iflt            130
		//    2    4:iload_1         
		//    3    5:aload_0         
...
_L2:
		...
		//*  13   23:goto            33
				av1 = ((av) (new boolean[av.e(av.this)]));
		//   14   26:aload_1         
		...
		implements Closeable
	{
		...
		//*   9   11:iload_2         
		//*  10   12:icmpge          28
				ay.a(((Closeable) (ainputstream[i1])));
		//   11   15:aload_3         
		//   12   16:iload_1         
		//   13   17:aaload          
		//   14   18:invokestatic    #44  <Method void ay.a(Closeable)>
		...
		//    4    4:aload           5
		//    5    6:aload           6
		//    6    8:invokespecial   #37  <Method void av$b(av, String, long, InputStream[], long[])>
		//    7   11:return          
		}
	}


	private av(File file, int i1, int j1, long l1)
	{
	//    0    0:aload_0         
	...
	//   28   55:aload_0         
	//   29   56:new             #6   <Class av$1>
	//   30   59:dup             
	//   31   60:aload_0         
	//   32   61:invokespecial   #104 <Method void av$1(av)>
	...
	//   18   34:ifnull          51
		long l2 = ((aw) (obj)).e;
	//   19   37:aload           6
	//   20   39:getfield        #150 <Field long aw.e>
	//   21   42:lstore          4
		if(l2 == l1)
			break MISSING_BLOCK_LABEL_55;
	//   22   44:lload           4
	...
	//   30   55:aload           6
	//   31   57:ifnonnull       92
		obj = ((Object) (new aw(s, j, d)));
	//   32   60:new             #146 <Class aw>
	//   33   63:dup             
	//   34   64:aload_1         
	//   35   65:aload_0         
	...
	//   39   73:invokespecial   #153 <Method void aw(String, int, File)>
	//   40   76:astore          6
		m.put(((Object) (s)), obj);
	//   41   78:aload_0         
	...
	//   47   89:goto            108
		a a1 = ((aw) (obj)).d;
	//   48   92:aload           6
	//   49   94:getfield        #160 <Field av$a aw.d>
	//   50   97:astore          7
		if(a1 == null)
			break MISSING_BLOCK_LABEL_108;
	//   51   99:aload           7
	...
	//   56  107:areturn         
		a1 = new a(((aw) (obj)));
	//   57  108:new             #10  <Class av$a>
	//   58  111:dup             
	//   59  112:aload_0         
	//   60  113:aload           6
	//   61  115:aconst_null     
	//   62  116:invokespecial   #163 <Method void av$a(av, aw, av$1)>
	//   63  119:astore          7
		obj.d = a1;
	//   64  121:aload           6
	//   65  123:aload           7
	//   66  125:putfield        #160 <Field av$a aw.d>
		obj = ((Object) (l));
	//   67  128:aload_0         
	...
	public static av a(File file, int i1, int j1, long l1)
	{
		Object obj;
		if(l1 <= 0L)
	...
	//   31   64:invokestatic    #202 <Method void a(File, File, boolean)>
		...
		obj = ((Object) (new av(file, i1, j1, l1)));
	//   32   67:new             #2   <Class av>
	//   33   70:dup             
	//   34   71:aload_0         
	//   35   72:iload_1         
	//   36   73:iload_2         
	//   37   74:lload_3         
	//   38   75:invokespecial   #204 <Method void av(File, int, int, long)>
	//   39   78:astore          5
		if(!((av) (obj)).e.exists())
	...
	//   87  182:pop             
		file = ((File) (new av(file, i1, j1, l1)));
	//   88  183:new             #2   <Class av>
	//   89  186:dup             
	//   90  187:aload_0         
	//   91  188:iload_1         
	//   92  189:iload_2         
	//   93  190:lload_3         
	//   94  191:invokespecial   #204 <Method void av(File, int, int, long)>
	//   95  194:astore_0        
		((av) (file)).f();
	//   96  195:aload_0         
	...
	//    1    1:monitorenter    
		aw aw1 = a.a(a1);
	//    2    2:aload_1         
	//    3    3:invokestatic    #243 <Method aw av$a.a(av$a)>
	//    4    6:astore          10
		if(aw1.d != a1) goto _L2; else goto _L1
	//    5    8:aload           10
	//    6   10:getfield        #160 <Field av$a aw.d>
	//    7   13:aload_1         
	//    8   14:if_acmpne       448
_L1:
		int j1;
	...
	//   16   30:istore          4
		if(aw1.c)
			break MISSING_BLOCK_LABEL_126;
	//   17   32:aload           10
	//   18   34:getfield        #246 <Field boolean aw.c>
	//   19   37:ifne            126
		int i1 = 0;
	//   20   40:iconst_0        
	//   21   41:istore_3        
_L4:
	...
	//   28   54:aload_1         
	//   29   55:invokestatic    #249 <Method boolean[] av$a.b(av$a)>
	//   30   58:iload_3         
	//   31   59:baload          
	//   32   60:ifeq            89
		if(aw1.b(i1).exists())
	...
	//   33   63:aload           10
	//   34   65:iload_3         
	//   35   66:invokevirtual   #252 <Method File aw.b(int)>
	//   36   69:invokevirtual   #196 <Method boolean File.exists()>
	//   37   72:ifne            82
		a1.b();
	//   38   75:aload_1         
	//   39   76:invokevirtual   #253 <Method void av$a.b()>
		this;
	//   40   79:aload_0         
		JVM INSTR monitorexit ;
	//   41   80:monitorexit     
...
_L3:
		a1.b();
	//   48   89:aload_1         
	//   49   90:invokevirtual   #253 <Method void av$a.b()>
...
_L5:
	...
	//   72  135:aload           10
	//   73  137:iload           4
	//   74  139:invokevirtual   #252 <Method File aw.b(int)>
	//   75  142:astore_1        
		if(!flag)
	...
	//   81  154:aload           10
	//   82  156:iload           4
	//   83  158:invokevirtual   #263 <Method File aw.a(int)>
	//   84  161:astore          11
	...
	//   88  169:pop             
			long l1 = aw1.b[j1];
	//   89  170:aload           10
	//   90  172:getfield        #270 <Field long[] aw.b>
	//   91  175:iload           4
	//   92  177:laload          
	//   93  178:lstore          6
			long l3 = file.length();
	...
	//   96  185:lstore          8
			aw1.b[j1] = l3;
	//   97  187:aload           10
	//   98  189:getfield        #270 <Field long[] aw.b>
	//   99  192:iload           4
	//  100  194:lload           8
	//  101  196:lastore         
			k = (k - l1) + l3;
...
_L6:
	...
	//  120  231:aload           10
	//  121  233:aconst_null     
	//  122  234:putfield        #160 <Field av$a aw.d>
		if(!(aw1.c | flag))
			break MISSING_BLOCK_LABEL_343;
	//  123  237:aload           10
	//  124  239:getfield        #246 <Field boolean aw.c>
	//  125  242:iload_2         
	//  126  243:ior             
	//  127  244:ifeq            343
		aw1.c = true;
	//  128  247:aload           10
	//  129  249:iconst_1        
	//  130  250:putfield        #246 <Field boolean aw.c>
		a1 = ((a) (l));
	//  131  253:aload_0         
	...
	//  141  275:pop             
		stringbuilder.append(aw1.a);
	//  142  276:aload           11
	//  143  278:aload           10
	//  144  280:getfield        #281 <Field String aw.a>
	//  145  283:invokevirtual   #174 <Method StringBuilder StringBuilder.append(String)>
	//  146  286:pop             
		stringbuilder.append(aw1.a());
	//  147  287:aload           11
	//  148  289:aload           10
	//  149  291:invokevirtual   #283 <Method String aw.a()>
	...
	//  170  333:aload           10
	//  171  335:lload           6
	//  172  337:putfield        #150 <Field long aw.e>
		break MISSING_BLOCK_LABEL_407;
	//  173  340:goto            407
		m.remove(((Object) (aw1.a)));
	//  174  343:aload_0         
	//  175  344:getfield        #81  <Field LinkedHashMap m>
	//  176  347:aload           10
	//  177  349:getfield        #281 <Field String aw.a>
	...
	//  190  378:pop             
		stringbuilder1.append(aw1.a);
	//  191  379:aload           11
	//  192  381:aload           10
	//  193  383:getfield        #281 <Field String aw.a>
...
_L2:
	...
	static void a(av av1, a a1, boolean flag)
	{
		av1.a(a1, flag);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #298 <Method void a(av$a, boolean)>
	//    4    6:return          
	}
	...
	private void d()
	{
		ax ax1 = new ax(((InputStream) (new FileInputStream(e))), ay.a);
	//    0    0:new             #307 <Class ax>
	//    1    3:dup             
	...
	//    7   15:getstatic       #316 <Field java.nio.charset.Charset ay.a>
	//    8   18:invokespecial   #319 <Method void ax(InputStream, java.nio.charset.Charset)>
	//    9   21:astore_3        
		String s;
		String s1;
		String s2;
		...
		s = ax1.a();
	//   10   22:aload_3         
	//   11   23:invokevirtual   #320 <Method String ax.a()>
	//   12   26:astore          4
		s1 = ax1.a();
	//   13   28:aload_3         
	//   14   29:invokevirtual   #320 <Method String ax.a()>
	//   15   32:astore          5
		s4 = ax1.a();
	//   16   34:aload_3         
	//   17   35:invokevirtual   #320 <Method String ax.a()>
	//   18   38:astore          8
		s2 = ax1.a();
	//   19   40:aload_3         
	//   20   41:invokevirtual   #320 <Method String ax.a()>
	//   21   44:astore          6
		s3 = ax1.a();
	//   22   46:aload_3         
	//   23   47:invokevirtual   #320 <Method String ax.a()>
	//   24   50:astore          7
...
_L5:
	...
	//   53  119:aload_0         
	//   54  120:aload_3         
	//   55  121:invokevirtual   #320 <Method String ax.a()>
...
_L4:
	...
	//   68  144:putfield        #134 <Field int n>
		if(ax1.b())
	//*  69  147:aload_3         
	//*  70  148:invokevirtual   #345 <Method boolean ax.b()>
	//*  71  151:ifeq            161
		{
			f();
	//   72  154:aload_0         
	...
	//   74  158:goto            194
		...
		l = ((Writer) (new BufferedWriter(((Writer) (new OutputStreamWriter(((OutputStream) (new FileOutputStream(e, true))), ay.a))))));
	//   75  161:aload_0         
	...
	//   86  182:getstatic       #316 <Field java.nio.charset.Charset ay.a>
	...
	//   89  191:putfield        #165 <Field Writer l>
		ay.a(((Closeable) (ax1)));
	//   90  194:aload_3         
	//   91  195:invokestatic    #363 <Method void ay.a(Closeable)>
		return;
	//   92  198:return          
_L2:
		StringBuilder stringbuilder = new StringBuilder();
	...
	//  139  298:astore          4
		ay.a(((Closeable) (ax1)));
	//  140  300:aload_3         
	//  141  301:invokestatic    #363 <Method void ay.a(Closeable)>
		throw obj;
	//  142  304:aload           4
	//  143  306:athrow          
		obj;
...
_L6:
	...
	//   62  119:invokespecial   #153 <Method void aw(String, int, File)>
	//   63  122:astore          6
				m.put(((Object) (s1)), ((Object) (aw1)));
	//   64  124:aload_0         
	...
	//   88  172:aload           6
	//   89  174:iconst_1        
	//   90  175:putfield        #246 <Field boolean aw.c>
				aw1.d = null;
	//   91  178:aload           6
	//   92  180:aconst_null     
	//   93  181:putfield        #160 <Field av$a aw.d>
				aw1.a(((String []) (s)));
	//   94  184:aload           6
	//   95  186:aload_1         
	//   96  187:invokevirtual   #400 <Method void aw.a(String[])>
				return;
	//   97  190:return          
			}
	...
	//* 107  209:ifeq            229
			{
				aw1.d = new a(aw1);
	//  108  212:aload           6
	//  109  214:new             #10  <Class av$a>
	//  110  217:dup             
	//  111  218:aload_0         
	//  112  219:aload           6
	//  113  221:aconst_null     
	//  114  222:invokespecial   #163 <Method void av$a(av, aw, av$1)>
	//  115  225:putfield        #160 <Field av$a aw.d>
				return;
	//  116  228:return          
			}
	...
	//   13   35:checkcast       #146 <Class aw>
	//   14   38:astore          4
			a a1 = aw1.d;
	//   15   40:aload           4
	//   16   42:getfield        #160 <Field av$a aw.d>
	//   17   45:astore          5
			boolean flag = false;
	//   18   47:iconst_0        
	//   19   48:istore_2        
	...
	//   31   69:aload           4
	//   32   71:getfield        #270 <Field long[] aw.b>
	//   33   74:iload_1         
	//   34   75:laload          
	//   35   76:ladd            
	...
	//   42   87:aload           4
	//   43   89:aconst_null     
	//   44   90:putfield        #160 <Field av$a aw.d>
	...
	//   51  103:aload           4
	//   52  105:iload_1         
	//   53  106:invokevirtual   #263 <Method File aw.a(int)>
	//   54  109:invokestatic    #277 <Method void a(File)>
					a(aw1.b(j1));
	//   55  112:aload           4
	//   56  114:iload_1         
	//   57  115:invokevirtual   #252 <Method File aw.b(int)>
	...
	//    7   13:invokevirtual   #445 <Method void Writer.close()>
		bufferedwriter = new BufferedWriter(((Writer) (new OutputStreamWriter(((OutputStream) (new FileOutputStream(f))), ay.a))));
	...
	//   17   35:getstatic       #316 <Field java.nio.charset.Charset ay.a>
...
_L1:
	...
	//   62  144:checkcast       #146 <Class aw>
	//   63  147:astore_3        
			if(aw1.d == null)
				break MISSING_BLOCK_LABEL_202;
	//   64  148:aload_3         
	//   65  149:getfield        #160 <Field av$a aw.d>
	//   66  152:ifnull          202
			StringBuilder stringbuilder = new StringBuilder();
	...
	//   75  172:aload           4
	//   76  174:aload_3         
	//   77  175:getfield        #281 <Field String aw.a>
	...
	//   97  220:aload           4
	//   98  222:aload_3         
	//   99  223:getfield        #281 <Field String aw.a>
	//  100  226:invokevirtual   #174 <Method StringBuilder StringBuilder.append(String)>
	//  101  229:pop             
		stringbuilder1.append(aw1.a());
	//  102  230:aload           4
	//  103  232:aload_3         
	//  104  233:invokevirtual   #283 <Method String aw.a()>
	...
	//  149  327:getstatic       #316 <Field java.nio.charset.Charset ay.a>
	...
	//   18   32:areturn         
		boolean flag1 = aw1.c;
	//   19   33:aload           6
	//   20   35:getfield        #246 <Field boolean aw.c>
	//   21   38:istore          4
		if(flag1)
...
_L2:
	...
	//   39   67:icmpge          94
		ainputstream[i1] = ((InputStream) (new FileInputStream(aw1.a(i1))));
	//   40   70:aload           5
	//   41   72:iload_2         
	...
	//   44   77:aload           6
	//   45   79:iload_2         
	//   46   80:invokevirtual   #263 <Method File aw.a(int)>
...
_L1:
	...
	//   92  172:pop             
		s = ((String) (new b(s, aw1.e, ainputstream, aw1.b)));
	//   93  173:new             #15  <Class av$b>
	//   94  176:dup             
	//   95  177:aload_0         
	//   96  178:aload_1         
	//   97  179:aload           6
	//   98  181:getfield        #150 <Field long aw.e>
	//   99  184:aload           5
	//  100  186:aload           6
	//  101  188:getfield        #270 <Field long[] aw.b>
	//  102  191:aconst_null     
	//  103  192:invokespecial   #477 <Method void av$b(av, String, long, InputStream[], long[], av$1)>
	//  104  195:astore_1        
		this;
	//  105  196:aload_0         
		JVM INSTR monitorexit ;
...
_L4:
	...
	//  118  217:iload_2         
	//  119  218:aaload          
	//  120  219:invokestatic    #363 <Method void ay.a(Closeable)>
		i1++;
	//  121  222:iload_2         
	//  122  223:iconst_1        
	//  123  224:iadd            
...
_L3:
	...
	//   23   47:checkcast       #146 <Class aw>
	//   24   50:astore_2        
			if(aw1.d != null)
	//*  25   51:aload_2         
	//*  26   52:getfield        #160 <Field av$a aw.d>
	//*  27   55:ifnull          32
				aw1.d.b();
	//   28   58:aload_2         
	//   29   59:getfield        #160 <Field av$a aw.d>
	//   30   62:invokevirtual   #253 <Method void av$a.b()>
		} while(true);
	//   31   65:goto            32
		i();
	//   32   68:aload_0         
	...
	//    3    5:invokespecial   #486 <Method av$a a(String, long)>
	//    4    8:areturn         
	}
	...
	//    4    8:invokestatic    #489 <Method void ay.a(File)>
	//    5   11:return          
	}
	...
	//   16   28:ifnull          229
		if(aw1.d != null)
	//*  17   31:aload           4
	//*  18   33:getfield        #160 <Field av$a aw.d>
	//*  19   36:ifnull          42
			break MISSING_BLOCK_LABEL_229;
	//   20   39:goto            229
_L2:
	...
	//   25   50:aload           4
	//   26   52:iload_2         
	//   27   53:invokevirtual   #263 <Method File aw.a(int)>
	//   28   56:astore_3        
	...
	//   57  113:aload           4
	//   58  115:getfield        #270 <Field long[] aw.b>
	//   59  118:iload_2         
	//   60  119:laload          
	//   61  120:lsub            
	//   62  121:putfield        #73  <Field long k>
		aw1.b[i1] = 0L;
	//   63  124:aload           4
	//   64  126:getfield        #270 <Field long[] aw.b>
	//   65  129:iload_2         
	//   66  130:lconst_0        
	//   67  131:lastore         
		i1++;
...
_L1:
	...
	private static final String c = AppboyLogger.getAppboyLogTag(bo/app/av);
...
label0:
		...
		//    7   11:invokestatic    #23  <Method Writer av.a(av)>
		//    8   14:ifnonnull       21
				}
		//    9   17:aload_1         
		//   10   18:monitorexit     
...
;
	...
	//    6   16:new             #8   <Class av$2>
	//    7   19:dup             
	//    8   20:invokespecial   #66  <Method void av$2()>
