	...
	implements eh
{
	...
	//    3    7:astore_1        
		try
		{
			for(Iterator iterator = a.iterator(); iterator.hasNext(); jsonarray.put(((eh)iterator.next()).forJsonPut()));
	//    4    8:aload_0         
	...
	//   14   34:checkcast       #6   <Class eh>
	//   15   37:invokeinterface #55  <Method Object eh.forJsonPut()>
	...
	private static final String b = AppboyLogger.getAppboyLogTag(bo/app/es);
	protected List a;
