	...
	implements OnFailureListener
{
	...
	//	               1002 83
				default:
					exception = ((Exception) (bo.app.do.a()));
	...
	//   90  187:return          
			...
			{
				AppboyLogger.d(bo.app.do.a(), "Received Geofence registration success code in failure block with Google Play Services.");
	...
	//   95  197:return          
		...
		{
			AppboyLogger.e(bo.app.do.a(), "Geofence exception encountered while adding geofences.", ((Throwable) (exception)));
