	...
	implements eb
{
	...
	public ed(JSONObject jsonobject, bl bl1)
	{
		super(jsonobject);
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #32  <Method void ee(JSONObject)>
		g = -1L;
	//    3    5:aload_0         
	...
	//   16   33:aload           4
	//   17   35:aload_1         
	//   18   36:invokestatic    #51  <Method String dt.a(JSONObject)>
	...
	//   57  110:aload_0         
	//   58  111:aload_2         
	//   59  112:putfield        #93  <Field bl b>
	//   60  115:return          
	}

	public void a(Context context, aa aa, fb fb, long l)
	{
		if(b != null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #93  <Field bl b>
	//*   2    4:ifnull          73
		{
			g = l;
	//    3    7:aload_0         
	...
	//   11   24:astore_2        
			((StringBuilder) (aa)).append("Posting templating request after delay of ");
	//   12   25:aload_2         
	...
	//   15   31:pop             
			((StringBuilder) (aa)).append(c().d());
	//   16   32:aload_2         
	//   17   33:aload_0         
	//   18   34:invokevirtual   #99  <Method ev c()>
	//   19   37:invokeinterface #104 <Method int ev.d()>
	//   20   42:invokevirtual   #107 <Method StringBuilder StringBuilder.append(int)>
	//   21   45:pop             
			((StringBuilder) (aa)).append(" seconds.");
	//   22   46:aload_2         
	//   23   47:ldc1            #109 <String " seconds.">
	//   24   49:invokevirtual   #46  <Method StringBuilder StringBuilder.append(String)>
	//   25   52:pop             
			AppboyLogger.d(((String) (context)), ((StringBuilder) (aa)).toString());
	//   26   53:aload_1         
	//   27   54:aload_2         
	...
	//   30   61:pop             
			b.a(this, fb);
	//   31   62:aload_0         
	//   32   63:getfield        #93  <Field bl b>
	//   33   66:aload_0         
	//   34   67:aload_3         
	//   35   68:invokeinterface #114 <Method void bl.a(ed, fb)>
		}
	//   36   73:return          
	}
	...
	//*   3    7:ifne            25
			return new fr(ez.b, d);
	//    4   10:new             #126 <Class fr>
	//    5   13:dup             
	//    6   14:getstatic       #131 <Field ez ez.b>
	//    7   17:aload_0         
	//    8   18:getfield        #87  <Field String d>
	//    9   21:invokespecial   #134 <Method void fr(ez, String)>
	//   10   24:areturn         
	...
	//*  14   32:ifne            50
			return new fr(ez.a, e);
	//   15   35:new             #126 <Class fr>
	//   16   38:dup             
	//   17   39:getstatic       #136 <Field ez ez.a>
	//   18   42:aload_0         
	//   19   43:getfield        #91  <Field String e>
	//   20   46:invokespecial   #134 <Method void fr(ez, String)>
	//   21   49:areturn         
		else
			return null;
	//   22   50:aconst_null     
	...
	public JSONObject e()
	{
		...
		try
		{
			jsonobject = super.e();
	//    0    0:aload_0         
	//    1    1:invokespecial   #141 <Method JSONObject ee.e()>
	//    2    4:astore_1        
	...
	public Object forJsonPut()
	{
		return ((Object) (e()));
	//    0    0:aload_0         
	//    1    1:invokevirtual   #158 <Method JSONObject e()>
	//    2    4:areturn         
	}
