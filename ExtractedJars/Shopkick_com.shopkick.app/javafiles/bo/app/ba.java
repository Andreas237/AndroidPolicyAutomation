	...
	implements bn
{
	...
	//    5   12:astore_1        
		if(c())
	//*   6   13:aload_0         
	//*   7   14:invokespecial   #79  <Method boolean c()>
	//*   8   17:ifeq            22
			s = null;
	//    9   20:aconst_null     
	//   10   21:astore_1        
	...
	//   13   26:invokestatic    #85  <Method UUID UUID.randomUUID()>
	//   14   29:invokevirtual   #88  <Method String UUID.toString()>
	//   15   32:astore_1        
			a(s);
	//   16   33:aload_0         
	//   17   34:aload_1         
	//   18   35:invokespecial   #90  <Method void a(String)>
			return s;
	//   19   38:aload_1         
	//   20   39:areturn         
		}
	...
	//   26   54:aload_0         
	//   27   55:aload_1         
	//   28   56:invokespecial   #90  <Method void a(String)>
		return s;
	//   29   59:aload_1         
	//   30   60:areturn         
	}
