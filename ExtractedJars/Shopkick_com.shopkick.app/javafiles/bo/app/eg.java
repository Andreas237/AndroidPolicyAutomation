...
public final class eg extends eq
{
	...
	public boolean a(fb fb)
	{
		if(fb instanceof fa)
	//*   0    0:aload_1         
	//*   1    1:instanceof      #61  <Class fa>
	//*   2    4:ifeq            42
		{
			fa fa1 = (fa)fb;
	//    3    7:aload_1         
	//    4    8:checkcast       #61  <Class fa>
	//    5   11:astore_2        
			if(!StringUtils.isNullOrBlank(fa1.a()) && fa1.a().equals(((Object) (c))))
	//*   6   12:aload_2         
	//*   7   13:invokevirtual   #64  <Method String fa.a()>
	//*   8   16:invokestatic    #70  <Method boolean StringUtils.isNullOrBlank(String)>
	//*   9   19:ifne            42
	//*  10   22:aload_2         
	//*  11   23:invokevirtual   #64  <Method String fa.a()>
	//*  12   26:aload_0         
	...
	//   16   36:aload_0         
	//   17   37:aload_1         
	//   18   38:invokespecial   #78  <Method boolean eq.a(fb)>
	//   19   41:ireturn         
		}
		return false;
	//   20   42:iconst_0        
	...
	private static final String b = AppboyLogger.getAppboyLogTag(bo/app/eg);
	private String c;
