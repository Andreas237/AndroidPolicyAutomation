	...
	implements ei
{
	...
	{
		boolean flag = fb instanceof fd;
	//    0    0:aload_1         
	//    1    1:instanceof      #97  <Class fd>
	//    2    4:istore_2        
		boolean flag2 = false;
	//    3    5:iconst_0        
	//    4    6:istore_3        
	...
	//*   6    8:ifeq            94
		{
			fb = ((fb) ((fd)fb));
	//    7   11:aload_1         
	//    8   12:checkcast       #97  <Class fd>
	//    9   15:astore_1        
			if(!StringUtils.isNullOrBlank(((fd) (fb)).a()) && ((fd) (fb)).a().equals(((Object) (a))))
	//*  10   16:aload_1         
	//*  11   17:invokevirtual   #100 <Method String fd.a()>
	//*  12   20:invokestatic    #106 <Method boolean StringUtils.isNullOrBlank(String)>
	//*  13   23:ifne            94
	//*  14   26:aload_1         
	//*  15   27:invokevirtual   #100 <Method String fd.a()>
	//*  16   30:aload_0         
	...
	//   24   52:iload_3         
	//   25   53:istore_2        
					if(!StringUtils.isNullOrBlank(((fd) (fb)).f()))
	//*  26   54:aload_1         
	//*  27   55:invokevirtual   #112 <Method String fd.f()>
	...
	//   30   64:iload_3         
	//   31   65:istore_2        
						if(b.contains(((Object) (((fd) (fb)).f()))))
	//*  32   66:aload_0         
	//*  33   67:getfield        #21  <Field Set b>
	//*  34   70:aload_1         
	//*  35   71:invokevirtual   #112 <Method String fd.f()>
	...
	//   41   85:ireturn         
				...
				{
					return StringUtils.isNullOrBlank(((fd) (fb)).f());
	//   42   86:aload_1         
	//   43   87:invokevirtual   #112 <Method String fd.f()>
