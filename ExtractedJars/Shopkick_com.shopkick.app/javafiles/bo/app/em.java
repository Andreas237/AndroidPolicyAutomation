	...
	implements ei
{
	...
	//    8   18:ireturn         
			fb = ((fb) ((ff)fb));
	//    9   19:aload_1         
	//   10   20:checkcast       #52  <Class ff>
	//   11   23:astore_1        
			if(!StringUtils.isNullOrBlank(((ff) (fb)).a()) && ((ff) (fb)).a().equals(((Object) (a))))
	//*  12   24:aload_1         
	//*  13   25:invokevirtual   #60  <Method String ff.a()>
	//*  14   28:invokestatic    #57  <Method boolean StringUtils.isNullOrBlank(String)>
	//*  15   31:ifne            50
	//*  16   34:aload_1         
	//*  17   35:invokevirtual   #60  <Method String ff.a()>
	//*  18   38:aload_0         
