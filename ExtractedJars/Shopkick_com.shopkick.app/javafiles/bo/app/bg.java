...
public class bg
{
	...
	public bg(Context context, aa aa1, dh dh1)
	{
	//    0    0:aload_0         
	...
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:putfield        #34  <Field aa b>
		e = dh1;
	//    8   14:aload_0         
	//    9   15:aload_3         
	//   10   16:putfield        #36  <Field dh e>
	...
	//    6   15:pop             
			b.a(((Object) (af.a)), bo/app/af);
	//    7   16:aload_0         
	//    8   17:getfield        #34  <Field aa b>
	//    9   20:getstatic       #59  <Field af af.a>
	//   10   23:ldc1            #56  <Class af>
	//   11   25:invokeinterface #64  <Method void aa.a(Object, Class)>
			c = true;
	//   12   30:aload_0         
	//   13   31:iconst_1        
	...
	{
		long l = dl.a();
	//    0    0:invokestatic    #71  <Method long dl.a()>
	//    1    3:lstore_1        
		String s = d;
	...
	boolean c()
	{
		long l = e.i();
	//    0    0:aload_0         
	//    1    1:getfield        #36  <Field dh e>
	//    2    4:invokevirtual   #109 <Method long dh.i()>
	//    3    7:lstore_1        
		boolean flag = false;
	//    4    8:iconst_0        
	//    5    9:istore          7
	...
	//   18   40:lstore_3        
			long l2 = dl.a();
	//   19   41:invokestatic    #71  <Method long dl.a()>
	//   20   44:lstore          5
			String s = d;
	...
	private static final String d = AppboyLogger.getAppboyLogTag(bo/app/bg);
