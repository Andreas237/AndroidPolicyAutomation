...
//			MapProviderFactory, DaggerCollections, Preconditions

public static final class MapProviderFactory$Builder
{

	public MapProviderFactory build()
	{
		return new MapProviderFactory(((java.util.Map) (map)), ((MapProviderFactory._cls1) (null)));
	//    0    0:new             #7   <Class MapProviderFactory>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:getfield        #24  <Field LinkedHashMap map>
	//    4    8:aconst_null     
	//    5    9:invokespecial   #33  <Method void MapProviderFactory(java.util.Map, MapProviderFactory$1)>
	//    6   12:areturn         
	}

	public MapProviderFactory$Builder put(Object obj, Provider provider)
	{
	...
	private MapProviderFactory$Builder(int i)
	{
	//    0    0:aload_0         
	...
	MapProviderFactory$Builder(int i, MapProviderFactory._cls1 _pcls1)
	{
		this(i);
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #28  <Method void MapProviderFactory$Builder(int)>
	//    3    5:return          
	}
}
