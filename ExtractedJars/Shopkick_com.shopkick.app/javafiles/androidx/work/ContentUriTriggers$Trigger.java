...
public static final class ContentUriTriggers$Trigger
{
	...
	//   12   22:iconst_0        
	//   13   23:ireturn         
			obj = ((Object) ((ContentUriTriggers$Trigger)obj));
	//   14   24:aload_1         
	//   15   25:checkcast       #2   <Class ContentUriTriggers$Trigger>
	//   16   28:astore_1        
			return mTriggerForDescendants == ((ContentUriTriggers$Trigger) (obj)).mTriggerForDescendants && mUri.equals(((Object) (((ContentUriTriggers$Trigger) (obj)).mUri)));
	//   17   29:aload_0         
	...
	ContentUriTriggers$Trigger(Uri uri, boolean flag)
	{
	//    0    0:aload_0         
