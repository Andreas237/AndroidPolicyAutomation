...
public static abstract class Operation$State
{
	...
	public static final class IN_PROGRESS extends Operation.State
	{
		...
		IN_PROGRESS(Operation._cls1 _pcls1)
		{
			this();
		//    0    0:aload_0         
		//    1    1:invokespecial   #15  <Method void Operation$State$IN_PROGRESS()>
		//    2    4:return          
		}
	}
	...
	public static final class SUCCESS extends Operation.State
	{
		...
		SUCCESS(Operation._cls1 _pcls1)
		{
			this();
		//    0    0:aload_0         
		//    1    1:invokespecial   #15  <Method void Operation$State$SUCCESS()>
		//    2    4:return          
		}
	}
