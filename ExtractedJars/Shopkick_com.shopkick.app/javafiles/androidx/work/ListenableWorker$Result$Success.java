...
public static final class ListenableWorker$Result$Success extends ListenableWorker.Result
{
	...
	//*  12   22:goto            42
		{
			obj = ((Object) ((ListenableWorker$Result$Success)obj));
	//   13   25:aload_1         
	//   14   26:checkcast       #2   <Class ListenableWorker$Result$Success>
	//   15   29:astore_1        
			return mOutputData.equals(((Object) (((ListenableWorker$Result$Success) (obj)).mOutputData)));
	//   16   30:aload_0         
