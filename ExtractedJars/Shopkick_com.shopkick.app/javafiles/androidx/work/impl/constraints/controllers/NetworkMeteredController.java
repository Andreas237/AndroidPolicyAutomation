...
public class NetworkMeteredController extends ConstraintController
{
	...
	//    3    7:getstatic       #56  <Field NetworkType NetworkType.METERED>
	//    4   10:if_acmpne       15
	//    5   13:iconst_1        
	//    6   14:ireturn         
	//    7   15:iconst_0        
	...
	//    9   18:ldc1            #71  <String "Metered network constraint is not supported before API 26, only checking for connected state.">
	//   10   20:iconst_0        
	...
	//*  21   41:aload_1         
	//*  22   42:invokevirtual   #86  <Method boolean NetworkState.isMetered()>
	//*  23   45:ifne            50
				return true;
	//   24   48:iconst_1        
	//   25   49:ireturn         
	...
	static 
	{
	//    0    0:ldc1            #11  <String "NetworkMeteredCtrlr">
