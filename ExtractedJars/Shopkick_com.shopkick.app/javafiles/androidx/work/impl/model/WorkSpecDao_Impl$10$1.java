...
class WorkSpecDao_Impl$10$1 extends android.arch.persistence.room.server
{
	...
	transient WorkSpecDao_Impl$10$1(String s, String as[])
	{
	...
	// Unreferenced inner class androidx/work/impl/model/WorkSpecDao_Impl$10

/* anonymous class */
	class WorkSpecDao_Impl._cls10 extends ComputableLiveData
	{
		...
		//*   2    4:ifnonnull       47
			{
				_observer = ((android.arch.persistence.room.InvalidationTracker.Observer) (new WorkSpecDao_Impl._cls10._cls1("WorkTag", new String[] {
					"workspec"
				})));
		//    3    7:aload_0         
