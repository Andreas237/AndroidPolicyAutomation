...
public static class WorkSpec$WorkInfoPojo
{
	...
	//   12   22:iconst_0        
	//   13   23:ireturn         
			obj = ((Object) ((WorkSpec$WorkInfoPojo)obj));
	//   14   24:aload_1         
	...
	//*  21   35:ifnull          51
			{
				if(!((String) (obj1)).equals(((Object) (((WorkSpec$WorkInfoPojo) (obj)).id))))
	//*  22   38:aload_2         
	//*  23   39:aload_1         
	...
	//   28   50:ireturn         
			...
			if(((WorkSpec$WorkInfoPojo) (obj)).id != null)
	//*  29   51:aload_1         
	...
	//   32   58:iconst_0        
	//   33   59:ireturn         
			if(state != ((WorkSpec$WorkInfoPojo) (obj)).state)
	//*  34   60:aload_0         
	...
	//*  45   79:ifnull          95
			{
				if(!((Data) (obj1)).equals(((Object) (((WorkSpec$WorkInfoPojo) (obj)).output))))
	//*  46   82:aload_2         
	//*  47   83:aload_1         
	...
	//   52   94:ireturn         
			...
			if(((WorkSpec$WorkInfoPojo) (obj)).output != null)
	//*  53   95:aload_1         
	...
	//*  61  109:aload_2         
	//*  62  110:ifnull          124
				return ((List) (obj1)).equals(((Object) (((WorkSpec$WorkInfoPojo) (obj)).tags)));
	//   63  113:aload_2         
	//   64  114:aload_1         
	//   65  115:getfield        #52  <Field List tags>
	//   66  118:invokeinterface #55  <Method boolean List.equals(Object)>
	//   67  123:ireturn         
			return ((WorkSpec$WorkInfoPojo) (obj)).tags == null;
	//   68  124:aload_1         
