...
class WorkSpecDao_Impl$12$1 extends android.arch.persistence.room.server
{
	...
	final WorkSpecDao_Impl._cls12 this$1;

	transient WorkSpecDao_Impl$12$1(String s, String as[])
	{
		this$1 = WorkSpecDao_Impl._cls12.this;
	//    0    0:aload_0         
	//    1    1:aload_1         
	...
	// Unreferenced inner class androidx/work/impl/model/WorkSpecDao_Impl$12

/* anonymous class */
	class WorkSpecDao_Impl._cls12 extends ComputableLiveData
	{
		...
		//*   2    4:ifnonnull       52
			{
				_observer = ((android.arch.persistence.room.InvalidationTracker.Observer) (new WorkSpecDao_Impl._cls12._cls1("WorkTag", new String[] {
					"workspec", "workname"
				})));
		//    3    7:aload_0         
		...
		//   30   59:invokevirtual   #65  <Method void RoomDatabase.beginTransaction()>
			Cursor cursor = WorkSpecDao_Impl.access$000(WorkSpecDao_Impl.this).query(((android.arch.persistence.db.SupportSQLiteQuery) (_statement)));
		//   31   62:aload_0         
...
_L1:
		...
		final RoomSQLiteQuery val$_statement;
			...
			//    2    2:putfield        #22  <Field WorkSpecDao_Impl this$0>
				_statement = RoomSQLiteQuery.this;
			//    3    5:aload_0         
			//    4    6:aload_2         
