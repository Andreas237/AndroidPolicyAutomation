...
public interface WorkSpecDao
{
	...
	public abstract androidx.work.WorkInfo.State getState(String s);
	...
	public abstract WorkSpec.WorkInfoPojo getWorkStatusPojoForId(String s);
	...
	public transient abstract int setState(androidx.work.WorkInfo.State state, String as[]);
}
