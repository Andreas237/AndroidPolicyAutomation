...
class WorkDatabase_Impl$1 extends android.arch.persistence.room.ate
{
	...
	//*   2    4:invokestatic    #67  <Method List WorkDatabase_Impl.access$000(WorkDatabase_Impl)>
	//*   3    7:ifnull          57
		{
			int i = 0;
	//    4   10:iconst_0        
	//    5   11:istore_2        
			for(int j = WorkDatabase_Impl.access$100(WorkDatabase_Impl.this).size(); i < j; i++)
	//*   6   12:aload_0         
	//*   7   13:getfield        #15  <Field WorkDatabase_Impl this$0>
	//*   8   16:invokestatic    #70  <Method List WorkDatabase_Impl.access$100(WorkDatabase_Impl)>
	//*   9   19:invokeinterface #76  <Method int List.size()>
	//*  10   24:istore_3        
	//*  11   25:iload_2         
	//*  12   26:iload_3         
	//*  13   27:icmpge          57
				((android.arch.persistence.room.k)WorkDatabase_Impl.access$200(WorkDatabase_Impl.this).get(i)).onCreate(supportsqlitedatabase);
	//   14   30:aload_0         
	//   15   31:getfield        #15  <Field WorkDatabase_Impl this$0>
	//   16   34:invokestatic    #79  <Method List WorkDatabase_Impl.access$200(WorkDatabase_Impl)>
	//   17   37:iload_2         
	//   18   38:invokeinterface #83  <Method Object List.get(int)>
	//   19   43:checkcast       #85  <Class android.arch.persistence.room.RoomDatabase$Callback>
	//   20   46:aload_1         
	//   21   47:invokevirtual   #87  <Method void android.arch.persistence.room.RoomDatabase$Callback.onCreate(SupportSQLiteDatabase)>
	...
	{
		WorkDatabase_Impl.access$302(WorkDatabase_Impl.this, supportsqlitedatabase);
	//    0    0:aload_0         
	//    1    1:getfield        #15  <Field WorkDatabase_Impl this$0>
	//    2    4:aload_1         
	...
	//    7   12:invokeinterface #29  <Method void SupportSQLiteDatabase.execSQL(String)>
		WorkDatabase_Impl.access$400(WorkDatabase_Impl.this, supportsqlitedatabase);
	//    8   17:aload_0         
	...
	//   11   22:invokestatic    #98  <Method void WorkDatabase_Impl.access$400(WorkDatabase_Impl, SupportSQLiteDatabase)>
		if(WorkDatabase_Impl.access$500(WorkDatabase_Impl.this) != null)
	//*  12   25:aload_0         
	//*  13   26:getfield        #15  <Field WorkDatabase_Impl this$0>
	//*  14   29:invokestatic    #101 <Method List WorkDatabase_Impl.access$500(WorkDatabase_Impl)>
	//*  15   32:ifnull          82
		{
			int i = 0;
	//   16   35:iconst_0        
	//   17   36:istore_2        
			for(int j = WorkDatabase_Impl.access$600(WorkDatabase_Impl.this).size(); i < j; i++)
	//*  18   37:aload_0         
	//*  19   38:getfield        #15  <Field WorkDatabase_Impl this$0>
	//*  20   41:invokestatic    #104 <Method List WorkDatabase_Impl.access$600(WorkDatabase_Impl)>
	//*  21   44:invokeinterface #76  <Method int List.size()>
	//*  22   49:istore_3        
	//*  23   50:iload_2         
	//*  24   51:iload_3         
	//*  25   52:icmpge          82
				((android.arch.persistence.room.k)WorkDatabase_Impl.access$700(WorkDatabase_Impl.this).get(i)).onOpen(supportsqlitedatabase);
	//   26   55:aload_0         
	//   27   56:getfield        #15  <Field WorkDatabase_Impl this$0>
	//   28   59:invokestatic    #107 <Method List WorkDatabase_Impl.access$700(WorkDatabase_Impl)>
	//   29   62:iload_2         
	//   30   63:invokeinterface #83  <Method Object List.get(int)>
	//   31   68:checkcast       #85  <Class android.arch.persistence.room.RoomDatabase$Callback>
	//   32   71:aload_1         
	//   33   72:invokevirtual   #109 <Method void android.arch.persistence.room.RoomDatabase$Callback.onOpen(SupportSQLiteDatabase)>
	...
	{
		Object obj = ((Object) (new HashMap(2)));
	//    0    0:new             #112 <Class HashMap>
	//    1    3:dup             
	//    2    4:iconst_2        
	//    3    5:invokespecial   #113 <Method void HashMap(int)>
	//    4    8:astore_2        
		((HashMap) (obj)).put("work_spec_id", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("work_spec_id", "TEXT", true, 1))));
	//    5    9:aload_2         
	...
	//   15   28:pop             
		((HashMap) (obj)).put("prerequisite_id", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("prerequisite_id", "TEXT", true, 2))));
	//   16   29:aload_2         
	...
	//   26   48:pop             
		Object obj1 = ((Object) (new HashSet(2)));
	//   27   49:new             #130 <Class HashSet>
	//   28   52:dup             
	//   29   53:iconst_2        
	//   30   54:invokespecial   #131 <Method void HashSet(int)>
	//   31   57:astore_3        
		((HashSet) (obj1)).add(((Object) (new android.arch.persistence.room.util.("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(((Object []) (new String[] {
			"work_spec_id"
	...
	//  112  207:pop             
		obj = ((Object) (new TableInfo("Dependency", ((java.util.Map) (obj)), ((java.util.Set) (obj1)), ((java.util.Set) (hashset)))));
	...
	//  144  266:pop             
			((HashMap) (obj)).put("state", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("state", "INTEGER", true, 0))));
	//  145  267:aload_2         
	...
	//  155  286:pop             
			((HashMap) (obj)).put("worker_class_name", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("worker_class_name", "TEXT", true, 0))));
	//  156  287:aload_2         
	...
	//  166  306:pop             
			((HashMap) (obj)).put("input_merger_class_name", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("input_merger_class_name", "TEXT", false, 0))));
	//  167  307:aload_2         
	...
	//  177  326:pop             
			((HashMap) (obj)).put("input", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("input", "BLOB", true, 0))));
	//  178  327:aload_2         
	...
	//  188  346:pop             
			((HashMap) (obj)).put("output", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("output", "BLOB", true, 0))));
	//  189  347:aload_2         
	...
	//  199  366:pop             
			((HashMap) (obj)).put("initial_delay", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("initial_delay", "INTEGER", true, 0))));
	//  200  367:aload_2         
	...
	//  210  386:pop             
			((HashMap) (obj)).put("interval_duration", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("interval_duration", "INTEGER", true, 0))));
	//  211  387:aload_2         
	...
	//  221  406:pop             
			((HashMap) (obj)).put("flex_duration", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("flex_duration", "INTEGER", true, 0))));
	//  222  407:aload_2         
	...
	//  232  426:pop             
			((HashMap) (obj)).put("run_attempt_count", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("run_attempt_count", "INTEGER", true, 0))));
	//  233  427:aload_2         
	...
	//  243  446:pop             
			((HashMap) (obj)).put("backoff_policy", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("backoff_policy", "INTEGER", true, 0))));
	//  244  447:aload_2         
	...
	//  254  466:pop             
			((HashMap) (obj)).put("backoff_delay_duration", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("backoff_delay_duration", "INTEGER", true, 0))));
	//  255  467:aload_2         
	...
	//  265  486:pop             
			((HashMap) (obj)).put("period_start_time", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("period_start_time", "INTEGER", true, 0))));
	//  266  487:aload_2         
	...
	//  276  506:pop             
			((HashMap) (obj)).put("minimum_retention_duration", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("minimum_retention_duration", "INTEGER", true, 0))));
	//  277  507:aload_2         
	...
	//  287  526:pop             
			((HashMap) (obj)).put("schedule_requested_at", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("schedule_requested_at", "INTEGER", true, 0))));
	//  288  527:aload_2         
	...
	//  298  546:pop             
			((HashMap) (obj)).put("required_network_type", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("required_network_type", "INTEGER", false, 0))));
	//  299  547:aload_2         
	...
	//  309  566:pop             
			((HashMap) (obj)).put("requires_charging", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("requires_charging", "INTEGER", true, 0))));
	//  310  567:aload_2         
	...
	//  320  586:pop             
			((HashMap) (obj)).put("requires_device_idle", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("requires_device_idle", "INTEGER", true, 0))));
	//  321  587:aload_2         
	...
	//  331  606:pop             
			((HashMap) (obj)).put("requires_battery_not_low", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("requires_battery_not_low", "INTEGER", true, 0))));
	//  332  607:aload_2         
	...
	//  342  626:pop             
			((HashMap) (obj)).put("requires_storage_not_low", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("requires_storage_not_low", "INTEGER", true, 0))));
	//  343  627:aload_2         
	...
	//  353  646:pop             
			((HashMap) (obj)).put("trigger_content_update_delay", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("trigger_content_update_delay", "INTEGER", true, 0))));
	//  354  647:aload_2         
	...
	//  364  666:pop             
			((HashMap) (obj)).put("trigger_max_content_delay", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("trigger_max_content_delay", "INTEGER", true, 0))));
	//  365  667:aload_2         
	...
	//  375  686:pop             
			((HashMap) (obj)).put("content_uri_triggers", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("content_uri_triggers", "BLOB", false, 0))));
	//  376  687:aload_2         
	...
	//  411  753:pop             
			obj = ((Object) (new TableInfo("WorkSpec", ((java.util.Map) (obj)), ((java.util.Set) (obj1)), ((java.util.Set) (hashset1)))));
	...
	//  419  767:astore_2        
			obj1 = ((Object) (TableInfo.read(supportsqlitedatabase, "WorkSpec")));
	//  420  768:aload_1         
	...
	//* 427  780:ifeq            1396
			{
				obj = ((Object) (new HashMap(2)));
	//  428  783:new             #112 <Class HashMap>
	//  429  786:dup             
	//  430  787:iconst_2        
	//  431  788:invokespecial   #113 <Method void HashMap(int)>
	//  432  791:astore_2        
				((HashMap) (obj)).put("tag", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("tag", "TEXT", true, 1))));
	//  433  792:aload_2         
	...
	//  443  811:pop             
				((HashMap) (obj)).put("work_spec_id", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("work_spec_id", "TEXT", true, 2))));
	//  444  812:aload_2         
	...
	//  502  920:pop             
				obj = ((Object) (new TableInfo("WorkTag", ((java.util.Map) (obj)), ((java.util.Set) (obj1)), ((java.util.Set) (hashset2)))));
	...
	//  510  934:astore_2        
				obj1 = ((Object) (TableInfo.read(supportsqlitedatabase, "WorkTag")));
	//  511  935:aload_1         
	...
	//  534  978:pop             
					((HashMap) (obj)).put("system_id", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("system_id", "INTEGER", true, 0))));
	//  535  979:aload_2         
	...
	//  573 1049:pop             
					obj = ((Object) (new TableInfo("SystemIdInfo", ((java.util.Map) (obj)), ((java.util.Set) (obj1)), ((java.util.Set) (new HashSet(0))))));
	...
	//  584 1069:astore_2        
					obj1 = ((Object) (TableInfo.read(supportsqlitedatabase, "SystemIdInfo")));
	//  585 1070:aload_1         
	...
	//  597 1093:astore_2        
						((HashMap) (obj)).put("name", ((Object) (new android.arch.persistence.room.util.TableInfo.Column("name", "TEXT", true, 1))));
	//  598 1094:aload_2         
	...
	//  667 1222:pop             
						obj = ((Object) (new TableInfo("WorkName", ((java.util.Map) (obj)), ((java.util.Set) (obj1)), ((java.util.Set) (hashset3)))));
	...
	//  679 1243:astore_1        
						if(((TableInfo) (obj)).equals(((Object) (supportsqlitedatabase))))
	//* 680 1244:aload_2         
	//* 681 1245:aload_1         
	...
	//  688 1260:astore_3        
							((StringBuilder) (obj1)).append("Migration didn't properly handle WorkName(androidx.work.impl.model.WorkName).\n Expected:\n");
	//  689 1261:aload_3         
	...
	//  700 1281:pop             
							((StringBuilder) (obj1)).append(((Object) (supportsqlitedatabase)));
	//  701 1282:aload_3         
	//  702 1283:aload_1         
	...
	//  718 1315:pop             
						((StringBuilder) (supportsqlitedatabase)).append(obj);
	//  719 1316:aload_1         
	//  720 1317:aload_2         
