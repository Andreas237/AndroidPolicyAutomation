	...
	implements Runnable
{
	...
	//    5    9:monitorenter    
		Object obj1 = val$mappingMethod.apply(val$input);
	//    6   10:aload_0         
	...
	//   22   46:putfield        #42  <Field Object LiveDataUtils$1.mCurrentOutput>
		val$outputLiveData.postValue(obj1);
	//   23   49:aload_0         
	...
	// Unreferenced inner class androidx/work/impl/utils/LiveDataUtils$1

/* anonymous class */
	static final class LiveDataUtils._cls1
		implements Observer
	{

		public void onChanged(Object obj)
		{
			workTaskExecutor.executeOnBackgroundThread(((Runnable) (((LiveDataUtils._cls1._cls1) (obj)). new LiveDataUtils._cls1._cls1())));
		//    0    0:aload_0         
