...
static final class StatusRunnable$3 extends StatusRunnable
{
	...
	List runInternal()
	{
		List list = val$workManager.getWorkDatabase().workSpecDao().getWorkStatusPojoForTag(val$tag);
	//    0    0:aload_0         
	...
	StatusRunnable$3(WorkManagerImpl workmanagerimpl, String s)
	{
