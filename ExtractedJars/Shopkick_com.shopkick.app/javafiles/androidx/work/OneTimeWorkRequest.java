...
public final class OneTimeWorkRequest extends WorkRequest
{
	public static final class Builder extends WorkRequest.Builder
	{
		...
		public Builder setInputMerger(Class class1)
		{
	...
	public static OneTimeWorkRequest from(Class class1)
	{
		return (OneTimeWorkRequest)(new Builder(class1)).build();
	//    0    0:new             #6   <Class OneTimeWorkRequest$Builder>
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #31  <Method void OneTimeWorkRequest$Builder(Class)>
	//    4    8:invokevirtual   #35  <Method WorkRequest OneTimeWorkRequest$Builder.build()>
	//    5   11:checkcast       #2   <Class OneTimeWorkRequest>
	//    6   14:areturn         
	}
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokeinterface #48  <Method int List.size()>
	//    4   10:invokespecial   #51  <Method void ArrayList(int)>
	//    5   13:astore_1        
		for(list = ((List) (list.iterator())); ((Iterator) (list)).hasNext(); ((List) (arraylist)).add(((Object) ((new Builder((Class)((Iterator) (list)).next())).build()))));
	//    6   14:aload_0         
	//    7   15:invokeinterface #55  <Method Iterator List.iterator()>
	//    8   20:astore_0        
	//    9   21:aload_0         
	//   10   22:invokeinterface #61  <Method boolean Iterator.hasNext()>
	//   11   27:ifeq            59
	//   12   30:aload_1         
	...
	//   17   41:checkcast       #67  <Class Class>
	//   18   44:invokespecial   #31  <Method void OneTimeWorkRequest$Builder(Class)>
	//   19   47:invokevirtual   #35  <Method WorkRequest OneTimeWorkRequest$Builder.build()>
	//   20   50:invokeinterface #71  <Method boolean List.add(Object)>
	//   21   55:pop             
	//*  22   56:goto            21
