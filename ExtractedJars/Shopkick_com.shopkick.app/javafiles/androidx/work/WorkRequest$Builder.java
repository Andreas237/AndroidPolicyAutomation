...
//			WorkRequest, BackoffPolicy, Constraints, Data
...
public static abstract class WorkRequest$Builder
{
	...
	public final WorkRequest$Builder keepResultsForAtLeast(long l, TimeUnit timeunit)
	{
	...
	public final WorkRequest$Builder keepResultsForAtLeast(Duration duration)
	{
	...
	public final WorkRequest$Builder setBackoffCriteria(BackoffPolicy backoffpolicy, long l, TimeUnit timeunit)
	{
	...
	public final WorkRequest$Builder setBackoffCriteria(BackoffPolicy backoffpolicy, Duration duration)
	{
		mBackoffCriteriaSet = true;
	//    0    0:aload_0         
	//    1    1:iconst_1        
	...
	public final WorkRequest$Builder setInitialRunAttemptCount(int i)
	{
	...
	public final WorkRequest$Builder setInitialState(WorkInfo.State state)
	{
	...
	public final WorkRequest$Builder setInputData(Data data)
	{
	...
	public final WorkRequest$Builder setPeriodStartTime(long l, TimeUnit timeunit)
	{
	...
	public final WorkRequest$Builder setScheduleRequestedAt(long l, TimeUnit timeunit)
	{
