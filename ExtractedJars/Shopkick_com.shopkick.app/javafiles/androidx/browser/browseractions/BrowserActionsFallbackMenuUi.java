	...
	implements android.widget.AdapterView.OnItemClickListener
{
	...
	//    0    0:aload_1         
	//    1    1:getstatic       #50  <Field int android.support.customtabs.R$id.browser_actions_menu_view>
	//    2    4:invokevirtual   #56  <Method View View.findViewById(int)>
	//    3    7:checkcast       #58  <Class BrowserActionsFallbackMenuView>
	//    4   10:astore_2        
		final TextView urlTextView = (TextView)view.findViewById(android.support.customtabs.R.id.browser_actions_header_text);
	//    5   11:aload_1         
	//    6   12:getstatic       #61  <Field int android.support.customtabs.R$id.browser_actions_header_text>
	//    7   15:invokevirtual   #56  <Method View View.findViewById(int)>
	//    8   18:checkcast       #63  <Class TextView>
	//    9   21:astore_3        
		urlTextView.setText(((CharSequence) (mUri.toString())));
	//   10   22:aload_3         
	//   11   23:aload_0         
	//   12   24:getfield        #37  <Field Uri mUri>
	//   13   27:invokevirtual   #69  <Method String Uri.toString()>
	//   14   30:invokevirtual   #73  <Method void TextView.setText(CharSequence)>
	...
	//   18   38:aload_0         
	//   19   39:aload_3         
	//   20   40:invokespecial   #76  <Method void BrowserActionsFallbackMenuUi$2(BrowserActionsFallbackMenuUi, TextView)>
	//   21   43:invokevirtual   #80  <Method void TextView.setOnClickListener(android.view.View$OnClickListener)>
		view = ((View) ((ListView)view.findViewById(android.support.customtabs.R.id.browser_actions_menu_items)));
	//   22   46:aload_1         
	//   23   47:getstatic       #83  <Field int android.support.customtabs.R$id.browser_actions_menu_items>
	//   24   50:invokevirtual   #56  <Method View View.findViewById(int)>
	//   25   53:checkcast       #85  <Class ListView>
	//   26   56:astore_1        
		((ListView) (view)).setAdapter(((android.widget.ListAdapter) (new BrowserActionsFallbackMenuAdapter(mMenuItems, mContext))));
	//   27   57:aload_1         
	//   28   58:new             #87  <Class BrowserActionsFallbackMenuAdapter>
	//   29   61:dup             
	//   30   62:aload_0         
	//   31   63:getfield        #39  <Field List mMenuItems>
	//   32   66:aload_0         
	//   33   67:getfield        #35  <Field Context mContext>
	//   34   70:invokespecial   #90  <Method void BrowserActionsFallbackMenuAdapter(List, Context)>
	//   35   73:invokevirtual   #94  <Method void ListView.setAdapter(android.widget.ListAdapter)>
		((ListView) (view)).setOnItemClickListener(((android.widget.AdapterView.OnItemClickListener) (this)));
	//   36   76:aload_1         
	//   37   77:aload_0         
	//   38   78:invokevirtual   #98  <Method void ListView.setOnItemClickListener(android.widget.AdapterView$OnItemClickListener)>
	...
	//    2    4:invokestatic    #105 <Method LayoutInflater LayoutInflater.from(Context)>
	//    3    7:getstatic       #110 <Field int android.support.customtabs.R$layout.browser_actions_context_menu_page>
	//    4   10:aconst_null     
	//    5   11:invokevirtual   #114 <Method View LayoutInflater.inflate(int, android.view.ViewGroup)>
	//    6   14:astore_1        
		mBrowserActionsDialog = new BrowserActionsFallbackMenuDialog(mContext, ((View) (initMenuView(view))));
	//    7   15:aload_0         
	//    8   16:new             #116 <Class BrowserActionsFallbackMenuDialog>
	//    9   19:dup             
	//   10   20:aload_0         
	//   11   21:getfield        #35  <Field Context mContext>
	//   12   24:aload_0         
	//   13   25:aload_1         
	//   14   26:invokespecial   #118 <Method BrowserActionsFallbackMenuView initMenuView(View)>
	//   15   29:invokespecial   #121 <Method void BrowserActionsFallbackMenuDialog(Context, View)>
	//   16   32:putfield        #123 <Field BrowserActionsFallbackMenuDialog mBrowserActionsDialog>
		mBrowserActionsDialog.setContentView(view);
	//   17   35:aload_0         
	//   18   36:getfield        #123 <Field BrowserActionsFallbackMenuDialog mBrowserActionsDialog>
	//   19   39:aload_1         
	//   20   40:invokevirtual   #127 <Method void BrowserActionsFallbackMenuDialog.setContentView(View)>
		if(mMenuUiListener != null)
	//*  21   43:aload_0         
	//*  22   44:getfield        #129 <Field BrowserActionsFallbackMenuUi$BrowserActionsFallMenuUiListener mMenuUiListener>
	//*  23   47:ifnull          66
			mBrowserActionsDialog.setOnShowListener(new android.content.DialogInterface.OnShowListener() {
				...
				//    2    4:getfield        #30  <Field BrowserActionsFallbackMenuUi$BrowserActionsFallMenuUiListener BrowserActionsFallbackMenuUi.mMenuUiListener>
				//    3    7:aload_0         
	...
	//   24   50:aload_0         
	//   25   51:getfield        #123 <Field BrowserActionsFallbackMenuDialog mBrowserActionsDialog>
	//   26   54:new             #8   <Class BrowserActionsFallbackMenuUi$1>
	//   27   57:dup             
	//   28   58:aload_0         
	//   29   59:aload_1         
	//   30   60:invokespecial   #132 <Method void BrowserActionsFallbackMenuUi$1(BrowserActionsFallbackMenuUi, View)>
	//   31   63:invokevirtual   #136 <Method void BrowserActionsFallbackMenuDialog.setOnShowListener(android.content.DialogInterface$OnShowListener)>
		mBrowserActionsDialog.show();
	//   32   66:aload_0         
	//   33   67:getfield        #123 <Field BrowserActionsFallbackMenuDialog mBrowserActionsDialog>
	//   34   70:invokevirtual   #139 <Method void BrowserActionsFallbackMenuDialog.show()>
	//   35   73:return          
	}
	...
	//    2    4:iload_3         
	//    3    5:invokeinterface #149 <Method Object List.get(int)>
	//    4   10:checkcast       #151 <Class BrowserActionItem>
	//    5   13:invokevirtual   #155 <Method PendingIntent BrowserActionItem.getAction()>
	//    6   16:astore_1        
		try
		{
			((PendingIntent) (adapterview)).send();
	//    7   17:aload_1         
	//    8   18:invokevirtual   #160 <Method void PendingIntent.send()>
			mBrowserActionsDialog.dismiss();
	//    9   21:aload_0         
	//   10   22:getfield        #123 <Field BrowserActionsFallbackMenuDialog mBrowserActionsDialog>
	//   11   25:invokevirtual   #163 <Method void BrowserActionsFallbackMenuDialog.dismiss()>
			return;
	//   12   28:return          
		}
	...
	//   15   32:ldc1            #165 <String "Failed to send custom item action">
	//   16   34:aload_1         
	//   17   35:invokestatic    #171 <Method int Log.e(String, String, Throwable)>
	//   18   38:pop             
		}
	//   19   39:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #129 <Field BrowserActionsFallbackMenuUi$BrowserActionsFallMenuUiListener mMenuUiListener>
	//    3    5:return          
	}
