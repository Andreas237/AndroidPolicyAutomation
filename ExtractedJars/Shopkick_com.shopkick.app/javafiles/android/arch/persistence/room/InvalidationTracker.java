...
_L1:
	...
	//    5    9:putfield        #89  <Field Object[] mQueryArgs>
		mMaxVersion = 0L;
	//    6   12:aload_0         
	//    7   13:lconst_0        
	//    8   14:putfield        #91  <Field long mMaxVersion>
		int i = 0;
	//    9   17:iconst_0        
	//   10   18:istore_3        
		mPendingRefresh = new AtomicBoolean(false);
	//   11   19:aload_0         
	//   12   20:new             #93  <Class AtomicBoolean>
	//   13   23:dup             
	//   14   24:iconst_0        
	//   15   25:invokespecial   #96  <Method void AtomicBoolean(boolean)>
	//   16   28:putfield        #98  <Field AtomicBoolean mPendingRefresh>
		mInitialized = false;
	//   17   31:aload_0         
	//   18   32:iconst_0        
	//   19   33:putfield        #100 <Field boolean mInitialized>
	//   20   36:aload_0         
	//   21   37:new             #102 <Class SafeIterableMap>
	//   22   40:dup             
	//   23   41:invokespecial   #103 <Method void SafeIterableMap()>
	//   24   44:putfield        #105 <Field SafeIterableMap mObserverMap>
...
;
	...
	//   27   51:dup             
	//   28   52:aload_0         
	//   29   53:invokespecial   #108 <Method void InvalidationTracker$1(InvalidationTracker)>
	//   30   56:putfield        #110 <Field Runnable mRefreshRunnable>
		mDatabase = roomdatabase;
	//   31   59:aload_0         
	//   32   60:aload_1         
	//   33   61:putfield        #112 <Field RoomDatabase mDatabase>
	...
	//   37   69:aload_2         
	//   38   70:arraylength     
	//   39   71:invokespecial   #115 <Method void InvalidationTracker$ObservedTableTracker(int)>
	//   40   74:putfield        #117 <Field InvalidationTracker$ObservedTableTracker mObservedTableTracker>
		mTableIdLookup = new ArrayMap();
	//   41   77:aload_0         
	//   42   78:new             #119 <Class ArrayMap>
	//   43   81:dup             
	//   44   82:invokespecial   #120 <Method void ArrayMap()>
	//   45   85:putfield        #122 <Field ArrayMap mTableIdLookup>
		int j = as.length;
	//   46   88:aload_2         
	//   47   89:arraylength     
	//   48   90:istore          4
	...
	//   52   98:putfield        #124 <Field String[] mTableNames>
		for(; i < j; i++)
	//*  53  101:iload_3         
	//*  54  102:iload           4
	//*  55  104:icmpge          144
	...
	//   57  108:iload_3         
	//   58  109:aaload          
	//   59  110:getstatic       #130 <Field Locale Locale.US>
	//   60  113:invokevirtual   #134 <Method String String.toLowerCase(Locale)>
	//   61  116:astore_1        
			mTableIdLookup.put(((Object) (roomdatabase)), ((Object) (Integer.valueOf(i))));
	//   62  117:aload_0         
	//   63  118:getfield        #122 <Field ArrayMap mTableIdLookup>
	//   64  121:aload_1         
	//   65  122:iload_3         
	//   66  123:invokestatic    #140 <Method Integer Integer.valueOf(int)>
	//   67  126:invokevirtual   #144 <Method Object ArrayMap.put(Object, Object)>
	//   68  129:pop             
			mTableNames[i] = ((String) (roomdatabase));
	//   69  130:aload_0         
	//   70  131:getfield        #124 <Field String[] mTableNames>
	//   71  134:iload_3         
	//   72  135:aload_1         
	//   73  136:aastore         
		}
	...
	//   83  149:putfield        #146 <Field long[] mTableVersions>
		Arrays.fill(mTableVersions, 0L);
	//   84  152:aload_0         
	//   85  153:getfield        #146 <Field long[] mTableVersions>
	//   86  156:lconst_0        
	//   87  157:invokestatic    #152 <Method void Arrays.fill(long[], long)>
	//   88  160:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:ldc1            #175 <String "`">
	//    2    3:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//    3    6:pop             
		stringbuilder.append("room_table_modification_trigger_");
	//    4    7:aload_0         
	//    5    8:ldc1            #183 <String "room_table_modification_trigger_">
	//    6   10:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//    7   13:pop             
		stringbuilder.append(s);
	//    8   14:aload_0         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   11   19:pop             
		stringbuilder.append("_");
	//   12   20:aload_0         
	//   13   21:ldc1            #185 <String "_">
	//   14   23:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   15   26:pop             
		stringbuilder.append(s1);
	//   16   27:aload_0         
	//   17   28:aload_2         
	//   18   29:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   19   32:pop             
		stringbuilder.append("`");
	//   20   33:aload_0         
	//   21   34:ldc1            #175 <String "`">
	//   22   36:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   23   39:pop             
	//   24   40:return          
	}
	...
	private boolean ensureInitialization()
	{
		if(!mDatabase.isOpen())
	//*   0    0:aload_0         
	//*   1    1:getfield        #112 <Field RoomDatabase mDatabase>
	//*   2    4:invokevirtual   #190 <Method boolean RoomDatabase.isOpen()>
	//*   3    7:ifne            12
			return false;
	//    4   10:iconst_0        
	//    5   11:ireturn         
		if(!mInitialized)
	//*   6   12:aload_0         
	//*   7   13:getfield        #100 <Field boolean mInitialized>
	//*   8   16:ifne            32
			mDatabase.getOpenHelper().getWritableDatabase();
	//    9   19:aload_0         
	//   10   20:getfield        #112 <Field RoomDatabase mDatabase>
	//   11   23:invokevirtual   #194 <Method SupportSQLiteOpenHelper RoomDatabase.getOpenHelper()>
	//   12   26:invokeinterface #200 <Method SupportSQLiteDatabase SupportSQLiteOpenHelper.getWritableDatabase()>
	//   13   31:pop             
		if(!mInitialized)
	//*  14   32:aload_0         
	//*  15   33:getfield        #100 <Field boolean mInitialized>
	//*  16   36:ifne            49
		{
			Log.e("ROOM", "database is not initialized even though it is open");
	//   17   39:ldc1            #202 <String "ROOM">
	//   18   41:ldc1            #204 <String "database is not initialized even though it is open">
	//   19   43:invokestatic    #210 <Method int Log.e(String, String)>
	//   20   46:pop             
			return false;
	//   21   47:iconst_0        
	//   22   48:ireturn         
	...
	//    0    0:aload_0         
	//    1    1:getfield        #124 <Field String[] mTableNames>
	//    2    4:iload_2         
	//    3    5:aaload          
	//    4    6:astore          5
		StringBuilder stringbuilder = new StringBuilder();
	//    5    8:new             #177 <Class StringBuilder>
	//    6   11:dup             
	//    7   12:invokespecial   #213 <Method void StringBuilder()>
	//    8   15:astore          6
		String as[] = TRIGGERS;
	//    9   17:getstatic       #78  <Field String[] TRIGGERS>
	//   10   20:astore          7
		int k = as.length;
	//   11   22:aload           7
	//   12   24:arraylength     
	...
	//   23   41:aload           6
	//   24   43:iconst_0        
	//   25   44:invokevirtual   #216 <Method void StringBuilder.setLength(int)>
			stringbuilder.append("CREATE TEMP TRIGGER IF NOT EXISTS ");
	//   26   47:aload           6
	//   27   49:ldc1            #218 <String "CREATE TEMP TRIGGER IF NOT EXISTS ">
	//   28   51:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   29   54:pop             
			appendTriggerName(stringbuilder, s, s1);
	//   30   55:aload           6
	//   31   57:aload           5
	//   32   59:aload           8
	//   33   61:invokestatic    #220 <Method void appendTriggerName(StringBuilder, String, String)>
			stringbuilder.append(" AFTER ");
	//   34   64:aload           6
	//   35   66:ldc1            #222 <String " AFTER ">
	//   36   68:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   37   71:pop             
			stringbuilder.append(s1);
	//   38   72:aload           6
	//   39   74:aload           8
	//   40   76:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   41   79:pop             
			stringbuilder.append(" ON `");
	//   42   80:aload           6
	//   43   82:ldc1            #224 <String " ON `">
	//   44   84:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   45   87:pop             
			stringbuilder.append(s);
	//   46   88:aload           6
	//   47   90:aload           5
	//   48   92:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   49   95:pop             
			stringbuilder.append("` BEGIN INSERT OR REPLACE INTO ");
	//   50   96:aload           6
	//   51   98:ldc1            #226 <String "` BEGIN INSERT OR REPLACE INTO ">
	//   52  100:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   53  103:pop             
			stringbuilder.append("room_table_modification_log");
	//   54  104:aload           6
	//   55  106:ldc1            #37  <String "room_table_modification_log">
	//   56  108:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   57  111:pop             
			stringbuilder.append(" VALUES(null, ");
	//   58  112:aload           6
	//   59  114:ldc1            #228 <String " VALUES(null, ">
	//   60  116:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   61  119:pop             
			stringbuilder.append(i);
	//   62  120:aload           6
	//   63  122:iload_2         
	//   64  123:invokevirtual   #231 <Method StringBuilder StringBuilder.append(int)>
	//   65  126:pop             
			stringbuilder.append("); END");
	//   66  127:aload           6
	//   67  129:ldc1            #233 <String "); END">
	//   68  131:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   69  134:pop             
			supportsqlitedatabase.execSQL(stringbuilder.toString());
	//   70  135:aload_1         
	//   71  136:aload           6
	//   72  138:invokevirtual   #237 <Method String StringBuilder.toString()>
	//   73  141:invokeinterface #243 <Method void SupportSQLiteDatabase.execSQL(String)>
		}
	...
	//   23   39:aload           5
	//   24   41:iconst_0        
	//   25   42:invokevirtual   #216 <Method void StringBuilder.setLength(int)>
			stringbuilder.append("DROP TRIGGER IF EXISTS ");
	//   26   45:aload           5
	//   27   47:ldc1            #246 <String "DROP TRIGGER IF EXISTS ">
	//   28   49:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   29   52:pop             
			appendTriggerName(stringbuilder, s, s1);
	//   30   53:aload           5
	//   31   55:aload           4
	//   32   57:aload           7
	//   33   59:invokestatic    #220 <Method void appendTriggerName(StringBuilder, String, String)>
			supportsqlitedatabase.execSQL(stringbuilder.toString());
	//   34   62:aload_1         
	//   35   63:aload           5
	//   36   65:invokevirtual   #237 <Method String StringBuilder.toString()>
	//   37   68:invokeinterface #243 <Method void SupportSQLiteDatabase.execSQL(String)>
		}
	...
	//    0    0:aload_1         
	//    1    1:getfield        #252 <Field String[] InvalidationTracker$Observer.mTables>
	//    2    4:astore          5
	...
	//   19   31:aload_0         
	//   20   32:getfield        #122 <Field ArrayMap mTableIdLookup>
	//   21   35:aload           5
	//   22   37:iload_2         
	//   23   38:aaload          
	//   24   39:getstatic       #130 <Field Locale Locale.US>
	//   25   42:invokevirtual   #134 <Method String String.toLowerCase(Locale)>
	//   26   45:invokevirtual   #256 <Method Object ArrayMap.get(Object)>
	//   27   48:checkcast       #136 <Class Integer>
	//   28   51:astore          7
			if(integer != null)
	//*  29   53:aload           7
	//*  30   55:ifnull          82
	...
	//   32   60:iload_2         
	//   33   61:aload           7
	//   34   63:invokevirtual   #260 <Method int Integer.intValue()>
	//   35   66:iastore         
				al[i] = mMaxVersion;
	//   36   67:aload           6
	//   37   69:iload_2         
	//   38   70:aload_0         
	//   39   71:getfield        #91  <Field long mMaxVersion>
	//   40   74:lastore         
				i++;
	//   41   75:iload_2         
	//   42   76:iconst_1        
	...
	//   46   82:new             #177 <Class StringBuilder>
	//   47   85:dup             
	//   48   86:invokespecial   #213 <Method void StringBuilder()>
	//   49   89:astore_1        
				((StringBuilder) (observer)).append("There is no table with name ");
	//   50   90:aload_1         
	//   51   91:ldc2            #262 <String "There is no table with name ">
	//   52   94:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   53   97:pop             
	...
	//   56  101:iload_2         
	//   57  102:aaload          
	//   58  103:invokevirtual   #181 <Method StringBuilder StringBuilder.append(String)>
	//   59  106:pop             
				throw new IllegalArgumentException(((StringBuilder) (observer)).toString());
	//   60  107:new             #264 <Class IllegalArgumentException>
	//   61  110:dup             
	//   62  111:aload_1         
	//   63  112:invokevirtual   #237 <Method String StringBuilder.toString()>
	//   64  115:invokespecial   #266 <Method void IllegalArgumentException(String)>
	//   65  118:athrow          
			}
		}

		ObserverWrapper observerwrapper = new ObserverWrapper(observer, ai, as, al);
	//   66  119:new             #14  <Class InvalidationTracker$ObserverWrapper>
	//   67  122:dup             
	//   68  123:aload_1         
	//   69  124:aload           4
	//   70  126:aload           5
	//   71  128:aload           6
	//   72  130:invokespecial   #269 <Method void InvalidationTracker$ObserverWrapper(InvalidationTracker$Observer, int[], String[], long[])>
	//   73  133:astore          6
		synchronized(mObserverMap)
	//*  74  135:aload_0         
	//*  75  136:getfield        #105 <Field SafeIterableMap mObserverMap>
	//*  76  139:astore          5
	//*  77  141:aload           5
	//*  78  143:monitorenter    
		{
	...
	//   79  144:aload_0         
	//   80  145:getfield        #105 <Field SafeIterableMap mObserverMap>
	//   81  148:aload_1         
	//   82  149:aload           6
	//   83  151:invokevirtual   #272 <Method Object SafeIterableMap.putIfAbsent(Object, Object)>
	//   84  154:checkcast       #14  <Class InvalidationTracker$ObserverWrapper>
	//   85  157:astore_1        
		}
	//   86  158:aload           5
	//   87  160:monitorexit     
	...
	//*  88  161:aload_1         
	//*  89  162:ifnonnull       181
	//*  90  165:aload_0         
	//*  91  166:getfield        #117 <Field InvalidationTracker$ObservedTableTracker mObservedTableTracker>
	//*  92  169:aload           4
	//*  93  171:invokevirtual   #276 <Method boolean InvalidationTracker$ObservedTableTracker.onAdded(int[])>
	//*  94  174:ifeq            181
			syncTriggers();
	//   95  177:aload_0         
	//   96  178:invokevirtual   #279 <Method void syncTriggers()>
		return;
	//   97  181:return          
		observer;
	//   98  182:astore_1        
	...
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokespecial   #284 <Method void InvalidationTracker$WeakObserver(InvalidationTracker, InvalidationTracker$Observer)>
	//    6   10:invokevirtual   #286 <Method void addObserver(InvalidationTracker$Observer)>
	//    7   13:return          
	}
	...
	//    2    2:aload_0         
	//    3    3:getfield        #100 <Field boolean mInitialized>
	//    4    6:ifeq            21
		Log.e("ROOM", "Invalidation tracker is initialized twice :/.");
	//    5    9:ldc1            #202 <String "ROOM">
	//    6   11:ldc2            #290 <String "Invalidation tracker is initialized twice :/.">
	//    7   14:invokestatic    #210 <Method int Log.e(String, String)>
	//    8   17:pop             
		this;
	//    9   18:aload_0         
		JVM INSTR monitorexit ;
	...
	//   12   21:aload_1         
	//   13   22:invokeinterface #293 <Method void SupportSQLiteDatabase.beginTransaction()>
		supportsqlitedatabase.execSQL("PRAGMA temp_store = MEMORY;");
	//   14   27:aload_1         
	//   15   28:ldc2            #295 <String "PRAGMA temp_store = MEMORY;">
	//   16   31:invokeinterface #243 <Method void SupportSQLiteDatabase.execSQL(String)>
		supportsqlitedatabase.execSQL("PRAGMA recursive_triggers='ON';");
	//   17   36:aload_1         
	//   18   37:ldc2            #297 <String "PRAGMA recursive_triggers='ON';">
	//   19   40:invokeinterface #243 <Method void SupportSQLiteDatabase.execSQL(String)>
	...
	//   20   45:aload_1         
	//   21   46:ldc1            #26  <String "CREATE TEMP TABLE room_table_modification_log(version INTEGER PRIMARY KEY AUTOINCREMENT, table_id INTEGER)">
	//   22   48:invokeinterface #243 <Method void SupportSQLiteDatabase.execSQL(String)>
		supportsqlitedatabase.setTransactionSuccessful();
	//   23   53:aload_1         
	//   24   54:invokeinterface #300 <Method void SupportSQLiteDatabase.setTransactionSuccessful()>
		supportsqlitedatabase.endTransaction();
	//   25   59:aload_1         
	//   26   60:invokeinterface #303 <Method void SupportSQLiteDatabase.endTransaction()>
		syncTriggers(supportsqlitedatabase);
	//   27   65:aload_0         
	//   28   66:aload_1         
	//   29   67:invokevirtual   #305 <Method void syncTriggers(SupportSQLiteDatabase)>
	...
	//   30   70:aload_0         
	//   31   71:aload_1         
	//   32   72:ldc1            #22  <String "DELETE FROM room_table_modification_log WHERE version NOT IN( SELECT MAX(version) FROM room_table_modification_log GROUP BY table_id)">
	//   33   74:invokeinterface #309 <Method SupportSQLiteStatement SupportSQLiteDatabase.compileStatement(String)>
	//   34   79:putfield        #165 <Field SupportSQLiteStatement mCleanupStatement>
		mInitialized = true;
	//   35   82:aload_0         
	//   36   83:iconst_1        
	//   37   84:putfield        #100 <Field boolean mInitialized>
		this;
	//   38   87:aload_0         
		JVM INSTR monitorexit ;
	//   39   88:monitorexit     
	...
	//   41   90:astore_2        
		supportsqlitedatabase.endTransaction();
	//   42   91:aload_1         
	//   43   92:invokeinterface #303 <Method void SupportSQLiteDatabase.endTransaction()>
		throw exception;
	//   44   97:aload_2         
	//   45   98:athrow          
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #98  <Field AtomicBoolean mPendingRefresh>
	//*   2    4:iconst_0        
	//*   3    5:iconst_1        
	//*   4    6:invokevirtual   #314 <Method boolean AtomicBoolean.compareAndSet(boolean, boolean)>
	//*   5    9:ifeq            22
			ArchTaskExecutor.getInstance().executeOnDiskIO(mRefreshRunnable);
	//    6   12:invokestatic    #320 <Method ArchTaskExecutor ArchTaskExecutor.getInstance()>
	//    7   15:aload_0         
	//    8   16:getfield        #110 <Field Runnable mRefreshRunnable>
	//    9   19:invokevirtual   #324 <Method void ArchTaskExecutor.executeOnDiskIO(Runnable)>
	//   10   22:return          
	}
	...
	public void refreshVersionsSync()
	{
		syncTriggers();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #279 <Method void syncTriggers()>
		mRefreshRunnable.run();
	//    2    4:aload_0         
	//    3    5:getfield        #110 <Field Runnable mRefreshRunnable>
	//    4    8:invokeinterface #330 <Method void Runnable.run()>
	//    5   13:return          
	}
	...
	public void removeObserver(Observer observer)
	{
		synchronized(mObserverMap)
	//*   0    0:aload_0         
	//*   1    1:getfield        #105 <Field SafeIterableMap mObserverMap>
	//*   2    4:astore_2        
	//*   3    5:aload_2         
	//*   4    6:monitorenter    
		{
	...
	//    5    7:aload_0         
	//    6    8:getfield        #105 <Field SafeIterableMap mObserverMap>
	//    7   11:aload_1         
	//    8   12:invokevirtual   #334 <Method Object SafeIterableMap.remove(Object)>
	...
	//*  14   22:ifnull          43
	//*  15   25:aload_0         
	//*  16   26:getfield        #117 <Field InvalidationTracker$ObservedTableTracker mObservedTableTracker>
	//*  17   29:aload_1         
	//*  18   30:getfield        #338 <Field int[] InvalidationTracker$ObserverWrapper.mTableIds>
	//*  19   33:invokevirtual   #341 <Method boolean InvalidationTracker$ObservedTableTracker.onRemoved(int[])>
	//*  20   36:ifeq            43
			syncTriggers();
	//   21   39:aload_0         
	//   22   40:invokevirtual   #279 <Method void syncTriggers()>
		return;
	//   23   43:return          
		observer;
	//   24   44:astore_1        
	...
	//    5   11:aload_0         
	//    6   12:aload_0         
	//    7   13:getfield        #112 <Field RoomDatabase mDatabase>
	//    8   16:invokevirtual   #194 <Method SupportSQLiteOpenHelper RoomDatabase.getOpenHelper()>
	//    9   19:invokeinterface #200 <Method SupportSQLiteDatabase SupportSQLiteOpenHelper.getWritableDatabase()>
	//   10   24:invokevirtual   #305 <Method void syncTriggers(SupportSQLiteDatabase)>
			return;
	//   11   27:return          
		}
	}
	...
	//*   0    0:aload_1         
	//*   1    1:invokeinterface #348 <Method boolean SupportSQLiteDatabase.inTransaction()>
	//*   2    6:ifeq            10
			return;
	//    3    9:return          
_L3:
	...
	//    4   10:aload_0         
	//    5   11:getfield        #112 <Field RoomDatabase mDatabase>
	//    6   14:invokevirtual   #352 <Method Lock RoomDatabase.getCloseLock()>
	//    7   17:astore          4
		lock.lock();
	//    8   19:aload           4
	//    9   21:invokeinterface #357 <Method void Lock.lock()>
		Object obj = ((Object) (mObservedTableTracker.getTablesToSync()));
	//   10   26:aload_0         
	//   11   27:getfield        #117 <Field InvalidationTracker$ObservedTableTracker mObservedTableTracker>
	//   12   30:invokevirtual   #361 <Method int[] InvalidationTracker$ObservedTableTracker.getTablesToSync()>
	//   13   33:astore          5
		int i;
		int j;
		if(obj == null)
	...
	//*  15   37:ifnonnull       48
		{
			try
			{
				lock.unlock();
	//   16   40:aload           4
	//   17   42:invokeinterface #364 <Method void Lock.unlock()>
				return;
	//   18   47:return          
			}
	//*  19   48:aload           5
	...
	//*  21   51:istore_3        
	//*  22   52:aload_1         
	//*  23   53:invokeinterface #293 <Method void SupportSQLiteDatabase.beginTransaction()>
	//*  24   58:iconst_0        
	//*  25   59:istore_2        
	//*  26   60:goto            147
	//*  27   63:aload_0         
	//*  28   64:aload_1         
	//*  29   65:iload_2         
	//*  30   66:invokespecial   #366 <Method void stopTrackingTable(SupportSQLiteDatabase, int)>
	//*  31   69:goto            180
	//*  32   72:aload_0         
	//*  33   73:aload_1         
	//*  34   74:iload_2         
	//*  35   75:invokespecial   #368 <Method void startTrackingTable(SupportSQLiteDatabase, int)>
	//*  36   78:goto            180
	//*  37   81:aload_1         
	//*  38   82:invokeinterface #300 <Method void SupportSQLiteDatabase.setTransactionSuccessful()>
	//*  39   87:aload_1         
	//*  40   88:invokeinterface #303 <Method void SupportSQLiteDatabase.endTransaction()>
	//*  41   93:aload_0         
	//*  42   94:getfield        #117 <Field InvalidationTracker$ObservedTableTracker mObservedTableTracker>
	//*  43   97:invokevirtual   #371 <Method void InvalidationTracker$ObservedTableTracker.onSyncCompleted()>
	//*  44  100:aload           4
	//*  45  102:invokeinterface #364 <Method void Lock.unlock()>
	//*  46  107:goto            10
	//*  47  110:astore          5
	//*  48  112:aload_1         
	//*  49  113:invokeinterface #303 <Method void SupportSQLiteDatabase.endTransaction()>
	//*  50  118:aload           5
	//*  51  120:athrow          
	//*  52  121:astore_1        
	//*  53  122:aload           4
	//*  54  124:invokeinterface #364 <Method void Lock.unlock()>
	//*  55  129:aload_1         
	//*  56  130:athrow          
	//*  57  131:astore_1        
	//*  58  132:goto            136
	...
	//   60  136:ldc1            #202 <String "ROOM">
	//   61  138:ldc2            #373 <String "Cannot run invalidation tracker. Is the db closed?">
	//   62  141:aload_1         
	//   63  142:invokestatic    #376 <Method int Log.e(String, String, Throwable)>
	//   64  145:pop             
			return;
	//   65  146:return          
		}
...
_L2:
	...
	//    2    4:dup             
	//    3    5:iconst_0        
	//    4    6:ldc1            #72  <String "UPDATE">
	//    5    8:aastore         
	//    6    9:dup             
	//    7   10:iconst_1        
	//    8   11:ldc1            #74  <String "DELETE">
	//    9   13:aastore         
	//   10   14:dup             
	//   11   15:iconst_2        
	//   12   16:ldc1            #76  <String "INSERT">
	//   13   18:aastore         
	//   14   19:putstatic       #78  <Field String[] TRIGGERS>
	//*  15   22:return          
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #161 <Method boolean ensureInitialization()>
	//    2    4:ireturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #165 <Field SupportSQLiteStatement mCleanupStatement>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #89  <Field Object[] mQueryArgs>
	//    2    4:areturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:getfield        #91  <Field long mMaxVersion>
	//    2    4:lreturn         
	}
...
/*
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:putfield        #91  <Field long mMaxVersion>
		return l;
	//    3    5:lload_1         
	//    4    6:lreturn         
	}
