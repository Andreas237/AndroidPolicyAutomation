...
public class TableInfo
{
	...
	public TableInfo(String s, Map map, Set set)
	{
	...
	//    2    2:aload_2         
	//    3    3:aload_3         
	//    4    4:invokestatic    #39  <Method Set Collections.emptySet()>
	//    5    7:invokespecial   #42  <Method void TableInfo(String, Map, Set, Set)>
	//    6   10:return          
	}
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #50  <Field String name>
		columns = Collections.unmodifiableMap(map);
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:invokestatic    #54  <Method Map Collections.unmodifiableMap(Map)>
	//    8   14:putfield        #56  <Field Map columns>
		foreignKeys = Collections.unmodifiableSet(set);
	//    9   17:aload_0         
	//   10   18:aload_3         
	//   11   19:invokestatic    #60  <Method Set Collections.unmodifiableSet(Set)>
	//   12   22:putfield        #62  <Field Set foreignKeys>
		if(set1 == null)
	//*  13   25:aload           4
	//*  14   27:ifnonnull       35
			s = null;
	...
	//   18   35:aload           4
	//   19   37:invokestatic    #60  <Method Set Collections.unmodifiableSet(Set)>
	//   20   40:astore_1        
		indices = ((Set) (s));
	//   21   41:aload_0         
	//   22   42:aload_1         
	//   23   43:putfield        #64  <Field Set indices>
	//   24   46:return          
	}
	...
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokestatic    #71  <Method Map readColumns(SupportSQLiteDatabase, String)>
	//    6   10:aload_0         
	//    7   11:aload_1         
	//    8   12:invokestatic    #75  <Method Set readForeignKeys(SupportSQLiteDatabase, String)>
	//    9   15:aload_0         
	//   10   16:aload_1         
	//   11   17:invokestatic    #78  <Method Set readIndices(SupportSQLiteDatabase, String)>
	//   12   20:invokespecial   #42  <Method void TableInfo(String, Map, Set, Set)>
	//   13   23:areturn         
	}
	...
	//    4    9:aload           7
	//    5   11:ldc1            #83  <String "PRAGMA table_info(`">
	//    6   13:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//    7   16:pop             
	...
	//   11   23:pop             
		stringbuilder.append("`)");
	//   12   24:aload           7
	//   13   26:ldc1            #89  <String "`)">
	//   14   28:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   15   31:pop             
		supportsqlitedatabase = ((SupportSQLiteDatabase) (supportsqlitedatabase.query(stringbuilder.toString())));
	//   16   32:aload_0         
	//   17   33:aload           7
	//   18   35:invokevirtual   #93  <Method String StringBuilder.toString()>
	//   19   38:invokeinterface #99  <Method Cursor SupportSQLiteDatabase.query(String)>
	//   20   43:astore_0        
		s = ((String) (new HashMap()));
	//   21   44:new             #101 <Class HashMap>
	//   22   47:dup             
	//   23   48:invokespecial   #102 <Method void HashMap()>
	//   24   51:astore_1        
		int i;
		int j;
		int k;
	...
	//   25   52:aload_0         
	//   26   53:invokeinterface #108 <Method int Cursor.getColumnCount()>
	//   27   58:ifle            176
		i = ((Cursor) (supportsqlitedatabase)).getColumnIndex("name");
	//   28   61:aload_0         
	//   29   62:ldc1            #109 <String "name">
	//   30   64:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   31   69:istore_2        
		j = ((Cursor) (supportsqlitedatabase)).getColumnIndex("type");
	//   32   70:aload_0         
	//   33   71:ldc1            #115 <String "type">
	//   34   73:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   35   78:istore_3        
		k = ((Cursor) (supportsqlitedatabase)).getColumnIndex("notnull");
	//   36   79:aload_0         
	//   37   80:ldc1            #117 <String "notnull">
	//   38   82:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   39   87:istore          4
		l = ((Cursor) (supportsqlitedatabase)).getColumnIndex("pk");
	//   40   89:aload_0         
	//   41   90:ldc1            #119 <String "pk">
	//   42   92:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   43   97:istore          5
_L1:
		String s1;
		String s2;
		if(!((Cursor) (supportsqlitedatabase)).moveToNext())
			break MISSING_BLOCK_LABEL_176;
	//   44   99:aload_0         
	//   45  100:invokeinterface #123 <Method boolean Cursor.moveToNext()>
	//   46  105:ifeq            176
		s1 = ((Cursor) (supportsqlitedatabase)).getString(i);
	//   47  108:aload_0         
	//   48  109:iload_2         
	//   49  110:invokeinterface #127 <Method String Cursor.getString(int)>
	//   50  115:astore          7
		s2 = ((Cursor) (supportsqlitedatabase)).getString(j);
	//   51  117:aload_0         
	//   52  118:iload_3         
	//   53  119:invokeinterface #127 <Method String Cursor.getString(int)>
	//   54  124:astore          8
		boolean flag;
		if(((Cursor) (supportsqlitedatabase)).getInt(k) != 0)
	//*  55  126:aload_0         
	//*  56  127:iload           4
	//*  57  129:invokeinterface #131 <Method int Cursor.getInt(int)>
	//*  58  134:ifeq            193
			flag = true;
	//   59  137:iconst_1        
	//   60  138:istore          6
	...
	//*  69  156:aload_0         
	//*  70  157:iload           5
	//*  71  159:invokeinterface #131 <Method int Cursor.getInt(int)>
	//*  72  164:invokespecial   #134 <Method void TableInfo$Column(String, String, boolean, int)>
	//*  73  167:invokeinterface #140 <Method Object Map.put(Object, Object)>
	//*  74  172:pop             
	//*  75  173:goto            99
	//*  76  176:aload_0         
	//*  77  177:invokeinterface #143 <Method void Cursor.close()>
	//*  78  182:aload_1         
	//*  79  183:areturn         
	//*  80  184:astore_1        
	//*  81  185:aload_0         
	//*  82  186:invokeinterface #143 <Method void Cursor.close()>
	//*  83  191:aload_1         
	//*  84  192:athrow          
			flag = false;
	//   85  193:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:ldc1            #148 <String "id">
	//    2    3:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//    3    8:istore_2        
		int k = cursor.getColumnIndex("seq");
	//    4    9:aload_0         
	//    5   10:ldc1            #150 <String "seq">
	//    6   12:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//    7   17:istore_3        
		int l = cursor.getColumnIndex("from");
	//    8   18:aload_0         
	//    9   19:ldc1            #152 <String "from">
	//   10   21:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   11   26:istore          4
		int i1 = cursor.getColumnIndex("to");
	//   12   28:aload_0         
	//   13   29:ldc1            #154 <String "to">
	//   14   31:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   15   36:istore          5
		int j1 = cursor.getCount();
	//   16   38:aload_0         
	//   17   39:invokeinterface #157 <Method int Cursor.getCount()>
	//   18   44:istore          6
		ArrayList arraylist = new ArrayList();
	//   19   46:new             #159 <Class ArrayList>
	//   20   49:dup             
	//   21   50:invokespecial   #160 <Method void ArrayList()>
	//   22   53:astore          7
		for(int i = 0; i < j1; i++)
	//*  23   55:iconst_0        
	//*  24   56:istore_1        
	...
	//   28   63:aload_0         
	//   29   64:iload_1         
	//   30   65:invokeinterface #164 <Method boolean Cursor.moveToPosition(int)>
	//   31   70:pop             
	...
	//   35   77:aload_0         
	//   36   78:iload_2         
	//   37   79:invokeinterface #131 <Method int Cursor.getInt(int)>
	//   38   84:aload_0         
	//   39   85:iload_3         
	//   40   86:invokeinterface #131 <Method int Cursor.getInt(int)>
	//   41   91:aload_0         
	//   42   92:iload           4
	//   43   94:invokeinterface #127 <Method String Cursor.getString(int)>
	//   44   99:aload_0         
	//   45  100:iload           5
	//   46  102:invokeinterface #127 <Method String Cursor.getString(int)>
	//   47  107:invokespecial   #167 <Method void TableInfo$ForeignKeyWithSequence(int, int, String, String)>
	//   48  110:invokeinterface #173 <Method boolean List.add(Object)>
	//   49  115:pop             
		}
	...
	//   55  123:aload           7
	//   56  125:invokestatic    #177 <Method void Collections.sort(List)>
	...
	private static Set readForeignKeys(SupportSQLiteDatabase supportsqlitedatabase, String s)
	{
		HashSet hashset;
		hashset = new HashSet();
	//    0    0:new             #180 <Class HashSet>
	//    1    3:dup             
	//    2    4:invokespecial   #181 <Method void HashSet()>
	//    3    7:astore          10
		StringBuilder stringbuilder = new StringBuilder();
	...
	//    8   18:aload           11
	//    9   20:ldc1            #183 <String "PRAGMA foreign_key_list(`">
	...
	//   15   32:pop             
		stringbuilder.append("`)");
	//   16   33:aload           11
	//   17   35:ldc1            #89  <String "`)">
	//   18   37:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   19   40:pop             
		supportsqlitedatabase = ((SupportSQLiteDatabase) (supportsqlitedatabase.query(stringbuilder.toString())));
	//   20   41:aload_0         
	//   21   42:aload           11
	//   22   44:invokevirtual   #93  <Method String StringBuilder.toString()>
	//   23   47:invokeinterface #99  <Method Cursor SupportSQLiteDatabase.query(String)>
	//   24   52:astore_0        
		int j;
		int k;
		int l;
	...
	//   25   53:aload_0         
	//   26   54:ldc1            #148 <String "id">
	//   27   56:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   28   61:istore_3        
		k = ((Cursor) (supportsqlitedatabase)).getColumnIndex("seq");
	//   29   62:aload_0         
	//   30   63:ldc1            #150 <String "seq">
	//   31   65:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   32   70:istore          4
		l = ((Cursor) (supportsqlitedatabase)).getColumnIndex("table");
	//   33   72:aload_0         
	//   34   73:ldc1            #185 <String "table">
	//   35   75:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   36   80:istore          5
		i1 = ((Cursor) (supportsqlitedatabase)).getColumnIndex("on_delete");
	//   37   82:aload_0         
	//   38   83:ldc1            #187 <String "on_delete">
	//   39   85:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   40   90:istore          6
		j1 = ((Cursor) (supportsqlitedatabase)).getColumnIndex("on_update");
	//   41   92:aload_0         
	//   42   93:ldc1            #189 <String "on_update">
	//   43   95:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   44  100:istore          7
		s = ((String) (readForeignKeyFieldMappings(((Cursor) (supportsqlitedatabase)))));
	//   45  102:aload_0         
	//   46  103:invokestatic    #191 <Method List readForeignKeyFieldMappings(Cursor)>
	//   47  106:astore_1        
		k1 = ((Cursor) (supportsqlitedatabase)).getCount();
	//   48  107:aload_0         
	//   49  108:invokeinterface #157 <Method int Cursor.getCount()>
	//   50  113:istore          8
		int i = 0;
	//   51  115:iconst_0        
	//   52  116:istore_2        
...
_L1:
	...
	//   56  123:aload_0         
	//   57  124:iload_2         
	//   58  125:invokeinterface #164 <Method boolean Cursor.moveToPosition(int)>
	//   59  130:pop             
		if(((Cursor) (supportsqlitedatabase)).getInt(k) != 0)
	//*  60  131:aload_0         
	//*  61  132:iload           4
	//*  62  134:invokeinterface #131 <Method int Cursor.getInt(int)>
	//*  63  139:ifeq            145
	...
	//   65  145:aload_0         
	//   66  146:iload_3         
	//   67  147:invokeinterface #131 <Method int Cursor.getInt(int)>
	//   68  152:istore          9
		arraylist = new ArrayList();
	//   69  154:new             #159 <Class ArrayList>
	//   70  157:dup             
	//   71  158:invokespecial   #160 <Method void ArrayList()>
	//   72  161:astore          11
		arraylist1 = new ArrayList();
	//   73  163:new             #159 <Class ArrayList>
	//   74  166:dup             
	//   75  167:invokespecial   #160 <Method void ArrayList()>
	//   76  170:astore          12
		Iterator iterator = ((List) (s)).iterator();
	//   77  172:aload_1         
	//   78  173:invokeinterface #195 <Method Iterator List.iterator()>
	//   79  178:astore          13
		do
		{
			if(!iterator.hasNext())
				break;
	//   80  180:aload           13
	//   81  182:invokeinterface #200 <Method boolean Iterator.hasNext()>
	//   82  187:ifeq            241
			ForeignKeyWithSequence foreignkeywithsequence = (ForeignKeyWithSequence)iterator.next();
	//   83  190:aload           13
	//   84  192:invokeinterface #204 <Method Object Iterator.next()>
	//   85  197:checkcast       #12  <Class TableInfo$ForeignKeyWithSequence>
	//   86  200:astore          14
			if(foreignkeywithsequence.mId == l1)
	//*  87  202:aload           14
	//*  88  204:getfield        #208 <Field int TableInfo$ForeignKeyWithSequence.mId>
	//*  89  207:iload           9
	//*  90  209:icmpne          180
			{
	...
	//   91  212:aload           11
	//   92  214:aload           14
	//   93  216:getfield        #211 <Field String TableInfo$ForeignKeyWithSequence.mFrom>
	//   94  219:invokeinterface #173 <Method boolean List.add(Object)>
	//   95  224:pop             
				((List) (arraylist1)).add(((Object) (foreignkeywithsequence.mTo)));
	//   96  225:aload           12
	//   97  227:aload           14
	//   98  229:getfield        #214 <Field String TableInfo$ForeignKeyWithSequence.mTo>
	//   99  232:invokeinterface #173 <Method boolean List.add(Object)>
	//  100  237:pop             
			}
		} while(true);
	//  101  238:goto            180
	...
	//  105  247:aload_0         
	//  106  248:iload           5
	//  107  250:invokeinterface #127 <Method String Cursor.getString(int)>
	//  108  255:aload_0         
	//  109  256:iload           6
	//  110  258:invokeinterface #127 <Method String Cursor.getString(int)>
	//  111  263:aload_0         
	//  112  264:iload           7
	//  113  266:invokeinterface #127 <Method String Cursor.getString(int)>
	//  114  271:aload           11
	//  115  273:aload           12
	//  116  275:invokespecial   #217 <Method void TableInfo$ForeignKey(String, String, String, List, List)>
	//  117  278:invokeinterface #220 <Method boolean Set.add(Object)>
	//  118  283:pop             
		i++;
	//  119  284:iload_2         
	//  120  285:iconst_1        
...
_L2:
		((Cursor) (supportsqlitedatabase)).close();
	//  124  291:aload_0         
	//  125  292:invokeinterface #143 <Method void Cursor.close()>
		return ((Set) (hashset));
	//  126  297:aload           10
	//  127  299:areturn         
		s;
	//  128  300:astore_1        
		((Cursor) (supportsqlitedatabase)).close();
	//  129  301:aload_0         
	//  130  302:invokeinterface #143 <Method void Cursor.close()>
		throw s;
	//  131  307:aload_1         
	//  132  308:athrow          
	}
	...
	//    4    9:aload           6
	//    5   11:ldc1            #225 <String "PRAGMA index_xinfo(`">
	//    6   13:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//    7   16:pop             
		stringbuilder.append(s);
	//    8   17:aload           6
	...
	//   21   44:aload_0         
	//   22   45:ldc1            #227 <String "seqno">
	//   23   47:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   24   52:istore_3        
		j = ((Cursor) (supportsqlitedatabase)).getColumnIndex("cid");
	//   25   53:aload_0         
	//   26   54:ldc1            #229 <String "cid">
	//   27   56:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   28   61:istore          4
		k = ((Cursor) (supportsqlitedatabase)).getColumnIndex("name");
	//   29   63:aload_0         
	//   30   64:ldc1            #109 <String "name">
	//   31   66:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   32   71:istore          5
		if(i == -1 || j == -1 || k == -1)
	//*  33   73:iload_3         
	//*  34   74:iconst_m1       
	...
	//   43   93:new             #231 <Class TreeMap>
	//   44   96:dup             
	//   45   97:invokespecial   #232 <Method void TreeMap()>
	//   46  100:astore          6
_L1:
		do
			if(!((Cursor) (supportsqlitedatabase)).moveToNext())
	...
	//   47  102:aload_0         
	//   48  103:invokeinterface #123 <Method boolean Cursor.moveToNext()>
	//   49  108:ifeq            152
		while(((Cursor) (supportsqlitedatabase)).getInt(j) < 0);
	//   50  111:aload_0         
	//   51  112:iload           4
	//   52  114:invokeinterface #131 <Method int Cursor.getInt(int)>
	//   53  119:ifge            125
	//*  54  122:goto            102
	...
	//   56  127:aload_0         
	//   57  128:iload_3         
	//   58  129:invokeinterface #131 <Method int Cursor.getInt(int)>
	//   59  134:invokestatic    #238 <Method Integer Integer.valueOf(int)>
	//   60  137:aload_0         
	//   61  138:iload           5
	//   62  140:invokeinterface #127 <Method String Cursor.getString(int)>
	//   63  145:invokevirtual   #239 <Method Object TreeMap.put(Object, Object)>
	//   64  148:pop             
		  goto _L1
	//*  65  149:goto            102
		ArrayList arraylist = new ArrayList(treemap.size());
	//   66  152:new             #159 <Class ArrayList>
	//   67  155:dup             
	//   68  156:aload           6
	//   69  158:invokevirtual   #242 <Method int TreeMap.size()>
	//   70  161:invokespecial   #245 <Method void ArrayList(int)>
	//   71  164:astore          7
		((List) (arraylist)).addAll(treemap.values());
	//   72  166:aload           7
	//   73  168:aload           6
	//   74  170:invokevirtual   #249 <Method java.util.Collection TreeMap.values()>
	//   75  173:invokeinterface #253 <Method boolean List.addAll(java.util.Collection)>
	//   76  178:pop             
	...
	//   80  184:iload_2         
	//   81  185:aload           7
	//   82  187:invokespecial   #256 <Method void TableInfo$Index(String, boolean, List)>
	//   83  190:astore_1        
		((Cursor) (supportsqlitedatabase)).close();
	//   84  191:aload_0         
	//   85  192:invokeinterface #143 <Method void Cursor.close()>
		return ((Index) (s));
	//   86  197:aload_1         
	//   87  198:areturn         
		((Cursor) (supportsqlitedatabase)).close();
	//   88  199:aload_0         
	//   89  200:invokeinterface #143 <Method void Cursor.close()>
		return null;
	//   90  205:aconst_null     
	//   91  206:areturn         
		s;
	//   92  207:astore_1        
		((Cursor) (supportsqlitedatabase)).close();
	//   93  208:aload_0         
	//   94  209:invokeinterface #143 <Method void Cursor.close()>
		throw s;
	//   95  214:aload_1         
	//   96  215:athrow          
	}
	...
	//    4    9:aload           7
	//    5   11:ldc2            #259 <String "PRAGMA index_list(`">
	//    6   14:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//    7   17:pop             
		stringbuilder.append(s);
	//    8   18:aload           7
	//    9   20:aload_1         
	//   10   21:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   11   24:pop             
		stringbuilder.append("`)");
	//   12   25:aload           7
	//   13   27:ldc1            #89  <String "`)">
	//   14   29:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   15   32:pop             
		s = ((String) (supportsqlitedatabase.query(stringbuilder.toString())));
	//   16   33:aload_0         
	//   17   34:aload           7
	//   18   36:invokevirtual   #93  <Method String StringBuilder.toString()>
	//   19   39:invokeinterface #99  <Method Cursor SupportSQLiteDatabase.query(String)>
	//   20   44:astore_1        
		int i;
		int j;
		int k;
	...
	//   21   45:aload_1         
	//   22   46:ldc1            #109 <String "name">
	//   23   48:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   24   53:istore_2        
		j = ((Cursor) (s)).getColumnIndex("origin");
	//   25   54:aload_1         
	//   26   55:ldc2            #261 <String "origin">
	//   27   58:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   28   63:istore_3        
		k = ((Cursor) (s)).getColumnIndex("unique");
	//   29   64:aload_1         
	//   30   65:ldc2            #263 <String "unique">
	//   31   68:invokeinterface #113 <Method int Cursor.getColumnIndex(String)>
	//   32   73:istore          4
		if(i == -1 || j == -1 || k == -1)
	//*  33   75:iload_2         
	//*  34   76:iconst_m1       
	...
	//   43   94:new             #180 <Class HashSet>
	//   44   97:dup             
	//   45   98:invokespecial   #181 <Method void HashSet()>
	//   46  101:astore          7
_L1:
		do
	...
	//   47  103:aload_1         
	//   48  104:invokeinterface #123 <Method boolean Cursor.moveToNext()>
	//   49  109:ifeq            196
		while(!"c".equals(((Object) (((Cursor) (s)).getString(j)))));
	//   50  112:ldc2            #265 <String "c">
	//   51  115:aload_1         
	//   52  116:iload_3         
	//   53  117:invokeinterface #127 <Method String Cursor.getString(int)>
	//   54  122:invokevirtual   #270 <Method boolean String.equals(Object)>
	//   55  125:ifne            131
	//*  56  128:goto            103
		int l;
		Object obj;
	...
	//   57  131:aload_1         
	//   58  132:iload_2         
	//   59  133:invokeinterface #127 <Method String Cursor.getString(int)>
	//   60  138:astore          8
		l = ((Cursor) (s)).getInt(k);
	//   61  140:aload_1         
	//   62  141:iload           4
	//   63  143:invokeinterface #131 <Method int Cursor.getInt(int)>
	//   64  148:istore          5
		boolean flag = true;
	//   65  150:iconst_1        
	//   66  151:istore          6
	...
	//*  72  163:aload           8
	//*  73  165:iload           6
	//*  74  167:invokestatic    #272 <Method TableInfo$Index readIndex(SupportSQLiteDatabase, String, boolean)>
	//*  75  170:astore          8
	//*  76  172:aload           8
	//*  77  174:ifnonnull       185
	//*  78  177:aload_1         
	//*  79  178:invokeinterface #143 <Method void Cursor.close()>
	//*  80  183:aconst_null     
	//*  81  184:areturn         
	//*  82  185:aload           7
	//*  83  187:aload           8
	//*  84  189:invokevirtual   #273 <Method boolean HashSet.add(Object)>
	//*  85  192:pop             
	//*  86  193:goto            103
	//*  87  196:aload_1         
	//*  88  197:invokeinterface #143 <Method void Cursor.close()>
	//*  89  202:aload           7
	//*  90  204:areturn         
	//*  91  205:aload_1         
	//*  92  206:invokeinterface #143 <Method void Cursor.close()>
	//*  93  211:aconst_null     
	//*  94  212:areturn         
	//*  95  213:astore_0        
	//*  96  214:aload_1         
	//*  97  215:invokeinterface #143 <Method void Cursor.close()>
	//*  98  220:aload_0         
	//*  99  221:athrow          
			flag = false;
	//  100  222:iconst_0        
	...
	//*   6    8:ifnull          156
		{
			if(((Object)this).getClass() != obj.getClass())
	//*   7   11:aload_0         
	//*   8   12:invokevirtual   #278 <Method Class Object.getClass()>
	//*   9   15:aload_1         
	//*  10   16:invokevirtual   #278 <Method Class Object.getClass()>
	//*  11   19:if_acmpeq       24
				return false;
	//   12   22:iconst_0        
	//   13   23:ireturn         
	...
	//   17   29:aload_0         
	//   18   30:getfield        #50  <Field String name>
	//   19   33:astore_2        
			if(obj1 != null)
	//*  20   34:aload_2         
	//*  21   35:ifnull          51
	...
	//*  22   38:aload_2         
	//*  23   39:aload_1         
	//*  24   40:getfield        #50  <Field String name>
	//*  25   43:invokevirtual   #270 <Method boolean String.equals(Object)>
	//*  26   46:ifne            60
					return false;
	//   27   49:iconst_0        
	//   28   50:ireturn         
	...
	//*  29   51:aload_1         
	//*  30   52:getfield        #50  <Field String name>
	//*  31   55:ifnull          60
				return false;
	//   32   58:iconst_0        
	//   33   59:ireturn         
			obj1 = ((Object) (columns));
	//   34   60:aload_0         
	//   35   61:getfield        #56  <Field Map columns>
	//   36   64:astore_2        
			if(obj1 != null)
	//*  37   65:aload_2         
	//*  38   66:ifnull          84
	...
	//*  39   69:aload_2         
	//*  40   70:aload_1         
	//*  41   71:getfield        #56  <Field Map columns>
	//*  42   74:invokeinterface #279 <Method boolean Map.equals(Object)>
	//*  43   79:ifne            93
					return false;
	//   44   82:iconst_0        
	//   45   83:ireturn         
	...
	//*  46   84:aload_1         
	//*  47   85:getfield        #56  <Field Map columns>
	//*  48   88:ifnull          93
				return false;
	//   49   91:iconst_0        
	//   50   92:ireturn         
	...
	//   51   93:aload_0         
	//   52   94:getfield        #62  <Field Set foreignKeys>
	//   53   97:astore_2        
			if(obj1 != null)
	//*  54   98:aload_2         
	//*  55   99:ifnull          117
	...
	//*  56  102:aload_2         
	//*  57  103:aload_1         
	//*  58  104:getfield        #62  <Field Set foreignKeys>
	//*  59  107:invokeinterface #280 <Method boolean Set.equals(Object)>
	//*  60  112:ifne            126
					return false;
	//   61  115:iconst_0        
	//   62  116:ireturn         
	...
	//*  63  117:aload_1         
	//*  64  118:getfield        #62  <Field Set foreignKeys>
	//*  65  121:ifnull          126
				return false;
	//   66  124:iconst_0        
	//   67  125:ireturn         
			obj1 = ((Object) (indices));
	//   68  126:aload_0         
	//   69  127:getfield        #64  <Field Set indices>
	//   70  130:astore_2        
			if(obj1 != null)
	//*  71  131:aload_2         
	//*  72  132:ifnull          154
	...
	//   73  135:aload_1         
	//   74  136:getfield        #64  <Field Set indices>
	//   75  139:astore_1        
				if(obj == null)
	//*  76  140:aload_1         
	...
	//   80  146:aload_2         
	//   81  147:aload_1         
	//   82  148:invokeinterface #280 <Method boolean Set.equals(Object)>
	//   83  153:ireturn         
			} else
			{
				return true;
	...
	//    7   13:aload           4
	//    8   15:invokevirtual   #283 <Method int String.hashCode()>
	//    9   18:istore_1        
		else
	//*  10   19:goto            24
			i = 0;
	...
	//   12   23:istore_1        
		obj = ((Object) (columns));
	//   13   24:aload_0         
	//   14   25:getfield        #56  <Field Map columns>
	//   15   28:astore          4
		int j;
		if(obj != null)
	//*  16   30:aload           4
	//*  17   32:ifnull          46
			j = ((Map) (obj)).hashCode();
	//   18   35:aload           4
	//   19   37:invokeinterface #284 <Method int Map.hashCode()>
	//   20   42:istore_2        
		else
	//*  21   43:goto            48
			j = 0;
	...
	//   24   48:aload_0         
	//   25   49:getfield        #62  <Field Set foreignKeys>
	//   26   52:astore          4
		if(obj != null)
	//*  27   54:aload           4
	//*  28   56:ifnull          67
			k = ((Set) (obj)).hashCode();
	//   29   59:aload           4
	//   30   61:invokeinterface #285 <Method int Set.hashCode()>
	//   31   66:istore_3        
		return (i * 31 + j) * 31 + k;
	//   32   67:iload_1         
	//   33   68:bipush          31
	...
	//    4    8:aload_1         
	//    5    9:ldc2            #287 <String "TableInfo{name='">
	//    6   12:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//    7   15:pop             
		stringbuilder.append(name);
	//    8   16:aload_1         
	//    9   17:aload_0         
	//   10   18:getfield        #50  <Field String name>
	//   11   21:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   12   24:pop             
		stringbuilder.append('\'');
	//   13   25:aload_1         
	//   14   26:bipush          39
	//   15   28:invokevirtual   #290 <Method StringBuilder StringBuilder.append(char)>
	//   16   31:pop             
		stringbuilder.append(", columns=");
	//   17   32:aload_1         
	//   18   33:ldc2            #292 <String ", columns=">
	//   19   36:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   20   39:pop             
		stringbuilder.append(((Object) (columns)));
	//   21   40:aload_1         
	//   22   41:aload_0         
	//   23   42:getfield        #56  <Field Map columns>
	//   24   45:invokevirtual   #295 <Method StringBuilder StringBuilder.append(Object)>
	//   25   48:pop             
		stringbuilder.append(", foreignKeys=");
	//   26   49:aload_1         
	//   27   50:ldc2            #297 <String ", foreignKeys=">
	//   28   53:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   29   56:pop             
		stringbuilder.append(((Object) (foreignKeys)));
	//   30   57:aload_1         
	//   31   58:aload_0         
	//   32   59:getfield        #62  <Field Set foreignKeys>
	//   33   62:invokevirtual   #295 <Method StringBuilder StringBuilder.append(Object)>
	//   34   65:pop             
		stringbuilder.append(", indices=");
	//   35   66:aload_1         
	//   36   67:ldc2            #299 <String ", indices=">
	//   37   70:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   38   73:pop             
		stringbuilder.append(((Object) (indices)));
	//   39   74:aload_1         
	//   40   75:aload_0         
	//   41   76:getfield        #64  <Field Set indices>
	//   42   79:invokevirtual   #295 <Method StringBuilder StringBuilder.append(Object)>
	//   43   82:pop             
		stringbuilder.append('}');
	//   44   83:aload_1         
	//   45   84:bipush          125
	//   46   86:invokevirtual   #290 <Method StringBuilder StringBuilder.append(char)>
	//   47   89:pop             
		return stringbuilder.toString();
	//   48   90:aload_1         
	//   49   91:invokevirtual   #93  <Method String StringBuilder.toString()>
	//   50   94:areturn         
	}
