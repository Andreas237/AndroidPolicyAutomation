...
_L3:
	...
	public static class Configuration
	{
		...
		Configuration(Context context1, String s, Callback callback1)
		{
		//    0    0:aload_0         
	...
	public static class Configuration.Builder
	{
		...
		//*   8   14:aload_2         
		//*   9   15:ifnull          32
					return new Configuration(context, mName, callback1);
		...
		public Configuration.Builder callback(Callback callback1)
		{
			mCallback = callback1;
		//    0    0:aload_0         
		//    1    1:aload_1         
		...
		public Configuration.Builder name(String s)
		{
			mName = s;
		//    0    0:aload_0         
		//    1    1:aload_1         
	...
	public static interface Factory
	{
		...
		public abstract SupportSQLiteOpenHelper create(Configuration configuration);
	}
	...
	public abstract void setWriteAheadLoggingEnabled(boolean flag);
}
