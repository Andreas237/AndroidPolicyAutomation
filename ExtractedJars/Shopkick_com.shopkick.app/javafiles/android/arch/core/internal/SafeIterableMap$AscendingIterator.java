...
static class SafeIterableMap$AscendingIterator extends SafeIterableMap.ListIterator
{
	...
	SafeIterableMap$AscendingIterator(SafeIterableMap.Entry entry, SafeIterableMap.Entry entry1)
	{
		super(entry, entry1);
	//    0    0:aload_0         
	//    1    1:aload_1         
