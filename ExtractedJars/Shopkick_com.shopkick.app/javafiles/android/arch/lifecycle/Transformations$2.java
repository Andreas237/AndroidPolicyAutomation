...
//			Observer, Transformations, LiveData, MediatorLiveData
	...
	implements Observer
{
	...
	{
		obj = ((Object) ((LiveData)val$func.apply(obj)));
	//    0    0:aload_0         
	...
	//*  13   25:aload_2         
	//*  14   26:ifnull          37
			val$result.removeSource(livedata);
	//   15   29:aload_0         
	...
	//*  25   47:aload_1         
	//*  26   48:ifnull          67
			val$result.addSource(((LiveData) (obj)), new Observer() {

				public void onChanged(Object obj1)
				{
					result.setValue(obj1);
				//    0    0:aload_0         
