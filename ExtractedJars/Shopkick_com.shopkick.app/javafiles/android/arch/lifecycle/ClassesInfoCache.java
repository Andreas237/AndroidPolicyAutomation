...
_L1:
	...
	//   11   26:aload_2         
	//   12   27:getfield        #83  <Field Method ClassesInfoCache$MethodReference.mMethod>
	//   13   30:astore_1        
			methodreference = ((MethodReference) (new StringBuilder()));
	//   14   31:new             #85  <Class StringBuilder>
	//   15   34:dup             
	//   16   35:invokespecial   #86  <Method void StringBuilder()>
	//   17   38:astore_2        
			((StringBuilder) (methodreference)).append("Method ");
	//   18   39:aload_2         
	//   19   40:ldc1            #88  <String "Method ">
	//   20   42:invokevirtual   #92  <Method StringBuilder StringBuilder.append(String)>
	//   21   45:pop             
			((StringBuilder) (methodreference)).append(((Method) (map)).getName());
	//   22   46:aload_2         
	//   23   47:aload_1         
	//   24   48:invokevirtual   #98  <Method String Method.getName()>
	//   25   51:invokevirtual   #92  <Method StringBuilder StringBuilder.append(String)>
	//   26   54:pop             
			((StringBuilder) (methodreference)).append(" in ");
	//   27   55:aload_2         
	//   28   56:ldc1            #100 <String " in ">
	//   29   58:invokevirtual   #92  <Method StringBuilder StringBuilder.append(String)>
	//   30   61:pop             
			((StringBuilder) (methodreference)).append(class1.getName());
	//   31   62:aload_2         
	//   32   63:aload           4
	//   33   65:invokevirtual   #101 <Method String Class.getName()>
	//   34   68:invokevirtual   #92  <Method StringBuilder StringBuilder.append(String)>
	//   35   71:pop             
			((StringBuilder) (methodreference)).append(" already declared with different @OnLifecycleEvent value: previous value ");
	//   36   72:aload_2         
	//   37   73:ldc1            #103 <String " already declared with different @OnLifecycleEvent value: previous value ">
	//   38   75:invokevirtual   #92  <Method StringBuilder StringBuilder.append(String)>
	//   39   78:pop             
			((StringBuilder) (methodreference)).append(((Object) (event1)));
	//   40   79:aload_2         
	//   41   80:aload           5
	//   42   82:invokevirtual   #106 <Method StringBuilder StringBuilder.append(Object)>
	//   43   85:pop             
			((StringBuilder) (methodreference)).append(", new value ");
	//   44   86:aload_2         
	//   45   87:ldc1            #108 <String ", new value ">
	//   46   89:invokevirtual   #92  <Method StringBuilder StringBuilder.append(String)>
	//   47   92:pop             
			((StringBuilder) (methodreference)).append(((Object) (event)));
	//   48   93:aload_2         
	//   49   94:aload_3         
	//   50   95:invokevirtual   #106 <Method StringBuilder StringBuilder.append(Object)>
	//   51   98:pop             
			throw new IllegalArgumentException(((StringBuilder) (methodreference)).toString());
	//   52   99:new             #64  <Class IllegalArgumentException>
	//   53  102:dup             
	//   54  103:aload_2         
	//   55  104:invokevirtual   #111 <Method String StringBuilder.toString()>
	//   56  107:invokespecial   #112 <Method void IllegalArgumentException(String)>
	//   57  110:athrow          
		}
		if(event1 == null)
	//*  58  111:aload           5
	...
	//   61  117:aload_2         
	//   62  118:aload_3         
	//   63  119:invokeinterface #116 <Method Object Map.put(Object, Object)>
	//   64  124:pop             
	//   65  125:return          
	}
	...
	//   11   21:aload_1         
	//   12   22:aconst_null     
	//   13   23:invokespecial   #122 <Method ClassesInfoCache$CallbackInfo createInfo(Class, Method[])>
	//   14   26:areturn         
	}
	...
	//*   2    4:aload_1         
	//*   3    5:invokeinterface #128 <Method boolean Map.containsKey(Object)>
	//*   4   10:ifeq            30
	...
	//    9   23:checkcast       #130 <Class Boolean>
	//   10   26:invokevirtual   #134 <Method boolean Boolean.booleanValue()>
	//   11   29:ireturn         
		Method amethod[] = getDeclaredMethods(class1);
	//   12   30:aload_0         
	//   13   31:aload_1         
	//   14   32:invokespecial   #136 <Method Method[] getDeclaredMethods(Class)>
	//   15   35:astore          4
	...
	//*  25   50:iload_2         
	//*  26   51:aaload          
	//*  27   52:ldc1            #138 <Class OnLifecycleEvent>
	//*  28   54:invokevirtual   #142 <Method java.lang.annotation.Annotation Method.getAnnotation(Class)>
	//*  29   57:checkcast       #138 <Class OnLifecycleEvent>
	//*  30   60:ifnull          73
			{
	...
	//   32   64:aload_1         
	//   33   65:aload           4
	//   34   67:invokespecial   #122 <Method ClassesInfoCache$CallbackInfo createInfo(Class, Method[])>
	//   35   70:pop             
				return true;
	//   36   71:iconst_1        
	//   37   72:ireturn         
	...
	//   45   84:aload_1         
	//   46   85:iconst_0        
	//   47   86:invokestatic    #146 <Method Boolean Boolean.valueOf(boolean)>
	//   48   89:invokeinterface #116 <Method Object Map.put(Object, Object)>
	//   49   94:pop             
		return false;
	//   50   95:iconst_0        
	//   51   96:ireturn         
