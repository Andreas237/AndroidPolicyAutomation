...
public abstract class LiveData
{
	...
	//   14   28:putfield        #51  <Field int mActiveCount>
		Object obj = NOT_SET;
	//   15   31:getstatic       #41  <Field Object NOT_SET>
	//   16   34:astore_1        
		mData = obj;
	//   17   35:aload_0         
	//   18   36:aload_1         
	//   19   37:putfield        #53  <Field Object mData>
		mPendingData = obj;
	//   20   40:aload_0         
	//   21   41:aload_1         
	//   22   42:putfield        #55  <Field Object mPendingData>
		mVersion = -1;
	//   23   45:aload_0         
	//   24   46:iconst_m1       
	//   25   47:putfield        #57  <Field int mVersion>
	//   26   50:aload_0         
	//   27   51:new             #7   <Class LiveData$1>
	//   28   54:dup             
	//   29   55:aload_0         
	//   30   56:invokespecial   #60  <Method void LiveData$1(LiveData)>
	//   31   59:putfield        #62  <Field Runnable mPostValueRunnable>
	//   32   62:return          
	}
	...
	//    4   10:new             #93  <Class StringBuilder>
	//    5   13:dup             
	//    6   14:invokespecial   #94  <Method void StringBuilder()>
	//    7   17:astore_1        
			stringbuilder.append("Cannot invoke ");
	//    8   18:aload_1         
	//    9   19:ldc1            #96  <String "Cannot invoke ">
	//   10   21:invokevirtual   #100 <Method StringBuilder StringBuilder.append(String)>
	//   11   24:pop             
			stringbuilder.append(s);
	//   12   25:aload_1         
	//   13   26:aload_0         
	//   14   27:invokevirtual   #100 <Method StringBuilder StringBuilder.append(String)>
	//   15   30:pop             
			stringbuilder.append(" on a background");
	//   16   31:aload_1         
	//   17   32:ldc1            #102 <String " on a background">
	//   18   34:invokevirtual   #100 <Method StringBuilder StringBuilder.append(String)>
	//   19   37:pop             
			stringbuilder.append(" thread");
	//   20   38:aload_1         
	//   21   39:ldc1            #104 <String " thread">
	//   22   41:invokevirtual   #100 <Method StringBuilder StringBuilder.append(String)>
	//   23   44:pop             
			throw new IllegalStateException(stringbuilder.toString());
	//   24   45:new             #106 <Class IllegalStateException>
	//   25   48:dup             
	//   26   49:aload_1         
	//   27   50:invokevirtual   #110 <Method String StringBuilder.toString()>
	//   28   53:invokespecial   #112 <Method void IllegalStateException(String)>
	//   29   56:athrow          
		}
	}
	...
	//   13   25:istore_2        
		int j = mVersion;
	//   14   26:aload_0         
	//   15   27:getfield        #57  <Field int mVersion>
	//   16   30:istore_3        
		if(i >= j)
	//*  17   31:iload_2         
	//*  18   32:iload_3         
	...
	//   21   37:aload_1         
	//   22   38:iload_3         
	//   23   39:putfield        #126 <Field int LiveData$ObserverWrapper.mLastVersion>
			observerwrapper.mObserver.onChanged(mData);
	//   24   42:aload_1         
	//   25   43:getfield        #130 <Field Observer LiveData$ObserverWrapper.mObserver>
	//   26   46:aload_0         
	//   27   47:getfield        #53  <Field Object mData>
	//   28   50:invokeinterface #136 <Method void Observer.onChanged(Object)>
			return;
	//   29   55:return          
		}
	}
...
label0:
	...
	//   27   55:new             #207 <Class IllegalArgumentException>
	//   28   58:dup             
	//   29   59:ldc1            #209 <String "Cannot add the same observer with different lifecycles">
	//   30   61:invokespecial   #210 <Method void IllegalArgumentException(String)>
	//   31   64:athrow          
		if(observer != null)
	//*  32   65:aload_2         
	//*  33   66:ifnull          70
	...
	//   35   70:aload_1         
	//   36   71:invokeinterface #182 <Method Lifecycle LifecycleOwner.getLifecycle()>
	//   37   76:aload_3         
	//   38   77:invokevirtual   #214 <Method void Lifecycle.addObserver(LifecycleObserver)>
			return;
	//   39   80:return          
		}
	}
	...
	//*  18   34:goto            47
			throw new IllegalArgumentException("Cannot add the same observer with different lifecycles");
	//   19   37:new             #207 <Class IllegalArgumentException>
	//   20   40:dup             
	//   21   41:ldc1            #209 <String "Cannot add the same observer with different lifecycles">
	//   22   43:invokespecial   #210 <Method void IllegalArgumentException(String)>
	//   23   46:athrow          
		if(observer != null)
	//*  24   47:aload_1         
	//*  25   48:ifnull          52
	...
	//   27   52:aload_2         
	//   28   53:iconst_1        
	//   29   54:invokevirtual   #221 <Method void LiveData$AlwaysActiveObserver.activeStateChanged(boolean)>
			return;
	//   30   57:return          
		}
	}
