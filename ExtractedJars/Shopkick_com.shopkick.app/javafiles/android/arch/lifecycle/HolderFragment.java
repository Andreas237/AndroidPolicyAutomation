...
//			ViewModelStoreOwner, ViewModelStore, EmptyActivityLifecycleCallbacks
	...
	implements ViewModelStoreOwner
{
	static class HolderFragmentManager
	{
		...
		private android.app.Application.ActivityLifecycleCallbacks mActivityCallbacks;
...
/*
		static Map access$000(HolderFragmentManager holderfragmentmanager)
		{
...
/*
		static Map access$100(HolderFragmentManager holderfragmentmanager)
		{
...
*/
		...
		//   11   23:putfield        #33  <Field Map mNotCommittedFragmentHolders>
			mActivityCallbacks = ((android.app.Application.ActivityLifecycleCallbacks) (new _cls1()));
		//   12   26:aload_0         
		...
		//   20   40:putfield        #40  <Field boolean mActivityCallbacksIsAdded>
			mParentDestroyedCallback = ((android.support.v4.app.FragmentManager.FragmentLifecycleCallbacks) (new _cls2()));
		//   21   43:aload_0         
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #37  <Method void Fragment()>
		mViewModelStore = new ViewModelStore();
	//    2    4:aload_0         
	//    3    5:new             #39  <Class ViewModelStore>
	//    4    8:dup             
	//    5    9:invokespecial   #40  <Method void ViewModelStore()>
	//    6   12:putfield        #42  <Field ViewModelStore mViewModelStore>
		setRetainInstance(true);
	//    7   15:aload_0         
	//    8   16:iconst_1        
	//    9   17:invokevirtual   #46  <Method void setRetainInstance(boolean)>
	//   10   20:return          
	}
	...
	//    0    0:getstatic       #35  <Field HolderFragment$HolderFragmentManager sHolderFragmentManager>
	//    1    3:aload_0         
	//    2    4:invokevirtual   #50  <Method HolderFragment HolderFragment$HolderFragmentManager.holderFragmentFor(Fragment)>
	//    3    7:areturn         
	}
	...
	//    0    0:getstatic       #35  <Field HolderFragment$HolderFragmentManager sHolderFragmentManager>
	//    1    3:aload_0         
	//    2    4:invokevirtual   #54  <Method HolderFragment HolderFragment$HolderFragmentManager.holderFragmentFor(FragmentActivity)>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #42  <Field ViewModelStore mViewModelStore>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #62  <Method void Fragment.onCreate(Bundle)>
		sHolderFragmentManager.holderFragmentCreated(((Fragment) (this)));
	//    3    5:getstatic       #35  <Field HolderFragment$HolderFragmentManager sHolderFragmentManager>
	//    4    8:aload_0         
	//    5    9:invokevirtual   #66  <Method void HolderFragment$HolderFragmentManager.holderFragmentCreated(Fragment)>
	//    6   12:return          
	}
	...
	public void onDestroy()
	{
		super.onDestroy();
	//    0    0:aload_0         
	//    1    1:invokespecial   #70  <Method void Fragment.onDestroy()>
		mViewModelStore.clear();
	//    2    4:aload_0         
	//    3    5:getfield        #42  <Field ViewModelStore mViewModelStore>
	//    4    8:invokevirtual   #73  <Method void ViewModelStore.clear()>
	//    5   11:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #76  <Method void Fragment.onSaveInstanceState(Bundle)>
	//    3    5:return          
	}
	...
	static 
	{
	//    0    0:new             #8   <Class HolderFragment$HolderFragmentManager>
	//    1    3:dup             
	//    2    4:invokespecial   #33  <Method void HolderFragment$HolderFragmentManager()>
	//    3    7:putstatic       #35  <Field HolderFragment$HolderFragmentManager sHolderFragmentManager>
	//*   4   10:return          
	}

	// Unreferenced inner class android/arch/lifecycle/HolderFragment$HolderFragmentManager$1

/* anonymous class */
	class HolderFragmentManager._cls1 extends EmptyActivityLifecycleCallbacks
	{
		...
		final HolderFragmentManager this$0;

			
			{
				this$0 = HolderFragmentManager.this;
			//    0    0:aload_0         
			//    1    1:aload_1         
	...
	// Unreferenced inner class android/arch/lifecycle/HolderFragment$HolderFragmentManager$2

/* anonymous class */
	class HolderFragmentManager._cls2 extends android.support.v4.app.FragmentManager.FragmentLifecycleCallbacks
	{
