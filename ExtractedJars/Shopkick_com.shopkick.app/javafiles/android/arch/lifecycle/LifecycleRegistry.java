...
public class LifecycleRegistry extends Lifecycle
{
	...
	//   24   48:aload_2         
	//   25   49:aload_2         
	//   26   50:invokevirtual   #131 <Method int ArrayList.size()>
	//   27   53:iconst_1        
	//   28   54:isub            
	//   29   55:invokevirtual   #135 <Method Object ArrayList.get(int)>
	//   30   58:checkcast       #60  <Class Lifecycle$State>
	//   31   61:astore_2        
		}
		return min(min(mState, ((Lifecycle.State) (lifecycleobserver))), ((Lifecycle.State) (obj)));
	//   32   62:aload_0         
	//   33   63:getfield        #65  <Field Lifecycle$State mState>
	//   34   66:aload_1         
	//   35   67:invokestatic    #139 <Method Lifecycle$State min(Lifecycle$State, Lifecycle$State)>
	//   36   70:aload_2         
	//   37   71:invokestatic    #139 <Method Lifecycle$State min(Lifecycle$State, Lifecycle$State)>
	//   38   74:areturn         
	}
	...
	//    3    5:aload_1         
	//    4    6:aload_1         
	//    5    7:invokevirtual   #131 <Method int ArrayList.size()>
	//    6   10:iconst_1        
	//    7   11:isub            
	//    8   12:invokevirtual   #223 <Method Object ArrayList.remove(int)>
	//    9   15:pop             
	//   10   16:return          
	}
