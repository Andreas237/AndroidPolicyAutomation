	...
	implements ObservableMap
{
	...
	{
		MapChangeRegistry mapchangeregistry = mListeners;
	//    0    0:aload_0         
	...
	//*   3    5:aload_2         
	//*   4    6:ifnull          16
			mapchangeregistry.notifyCallbacks(((Object) (this)), 0, obj);
	//    5    9:aload_2         
	//    6   10:aload_0         
	//    7   11:iconst_0        
	//    8   12:aload_1         
	//    9   13:invokevirtual   #24  <Method void MapChangeRegistry.notifyCallbacks(Object, int, Object)>
	//   10   16:return          
	}
	...
	//    0    0:aload_1         
	//    1    1:invokeinterface #54  <Method Iterator Collection.iterator()>
	//    2    6:astore_1        
		boolean flag = false;
	//    3    7:iconst_0        
	//    4    8:istore_3        
	...
	//*   3    5:aload_2         
	//*   4    6:ifnull          14
			mapchangeregistry.remove(((Object) (onmapchangedcallback)));
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #81  <Method void MapChangeRegistry.remove(Object)>
	//    8   14:return          
	}
	...
	public boolean retainAll(Collection collection)
	{
		int i = size() - 1;
	//    0    0:aload_0         
	//    1    1:invokevirtual   #86  <Method int size()>
	//    2    4:iconst_1        
	//    3    5:isub            
	//    4    6:istore_2        
		boolean flag = false;
