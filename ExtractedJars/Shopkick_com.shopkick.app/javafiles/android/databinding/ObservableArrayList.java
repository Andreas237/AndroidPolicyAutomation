	...
	implements ObservableList
{
	...
	{
		ListChangeRegistry listchangeregistry = mListeners;
	//    0    0:aload_0         
	...
	//*   3    5:aload_3         
	//*   4    6:ifnull          16
			listchangeregistry.notifyInserted(((ObservableList) (this)), i, j);
	//    5    9:aload_3         
	//    6   10:aload_0         
	//    7   11:iload_1         
	//    8   12:iload_2         
	//    9   13:invokevirtual   #25  <Method void ListChangeRegistry.notifyInserted(ObservableList, int, int)>
	//   10   16:return          
	}
	...
	//*   3    5:aload_3         
	//*   4    6:ifnull          16
			listchangeregistry.notifyRemoved(((ObservableList) (this)), i, j);
	//    5    9:aload_3         
	//    6   10:aload_0         
	//    7   11:iload_1         
	//    8   12:iload_2         
	//    9   13:invokevirtual   #29  <Method void ListChangeRegistry.notifyRemoved(ObservableList, int, int)>
	//   10   16:return          
	}
	...
	//*   3    5:aload_2         
	//*   4    6:ifnull          14
			listchangeregistry.remove(((Object) (onlistchangedcallback)));
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #80  <Method void ListChangeRegistry.remove(Object)>
	//    8   14:return          
	}
	...
	//*   8   12:aload_3         
	//*   9   13:ifnull          23
			listchangeregistry.notifyChanged(((ObservableList) (this)), i, 1);
	//   10   16:aload_3         
	//   11   17:aload_0         
	//   12   18:iload_1         
	//   13   19:iconst_1        
	//   14   20:invokevirtual   #90  <Method void ListChangeRegistry.notifyChanged(ObservableList, int, int)>
		return obj;
	//   15   23:aload_2         
	//   16   24:areturn         
	}
