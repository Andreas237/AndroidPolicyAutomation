...
public final class EditorInfoCompat
{
	...
	//    3    8:aload_0         
	//    4    9:getfield        #40  <Field String[] EditorInfo.contentMimeTypes>
	//    5   12:astore_0        
			if(editorinfo != null)
	//*   6   13:aload_0         
	//*   7   14:ifnull          19
	...
	//*  12   23:aload_0         
	//*  13   24:getfield        #44  <Field Bundle EditorInfo.extras>
	//*  14   27:ifnonnull       34
			return EMPTY_STRING_ARRAY;
	...
	//   17   34:aload_0         
	//   18   35:getfield        #44  <Field Bundle EditorInfo.extras>
	//   19   38:ldc1            #8   <String "android.support.v13.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES">
	//   20   40:invokevirtual   #50  <Method String[] Bundle.getStringArray(String)>
	//   21   43:astore_0        
		if(editorinfo != null)
	//*  22   44:aload_0         
	//*  23   45:ifnull          50
	...
	//    3    8:aload_0         
	//    4    9:aload_1         
	//    5   10:putfield        #40  <Field String[] EditorInfo.contentMimeTypes>
			return;
	//    6   13:return          
		}
		if(editorinfo.extras == null)
	//*   7   14:aload_0         
	//*   8   15:getfield        #44  <Field Bundle EditorInfo.extras>
	//*   9   18:ifnonnull       32
			editorinfo.extras = new Bundle();
	//   10   21:aload_0         
	//   11   22:new             #46  <Class Bundle>
	//   12   25:dup             
	//   13   26:invokespecial   #55  <Method void Bundle()>
	//   14   29:putfield        #44  <Field Bundle EditorInfo.extras>
		editorinfo.extras.putStringArray("android.support.v13.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES", as);
	//   15   32:aload_0         
	//   16   33:getfield        #44  <Field Bundle EditorInfo.extras>
	//   17   36:ldc1            #8   <String "android.support.v13.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES">
	//   18   38:aload_1         
	//   19   39:invokevirtual   #59  <Method void Bundle.putStringArray(String, String[])>
	//   20   42:return          
	}
