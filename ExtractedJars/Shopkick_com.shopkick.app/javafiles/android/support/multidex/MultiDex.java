...
label0:
	...
	//  112  227:ldc1            #46  <String "MultiDex">
	//  113  229:ldc2            #256 <String "Failed to install extracted secondary dex files, retrying with forced extraction">
	//  114  232:aload           8
	//  115  234:invokestatic    #237 <Method int Log.w(String, String, Throwable)>
	//  116  237:pop             
	...
	//  121  243:aload           4
	//  122  245:iconst_1        
	//  123  246:invokevirtual   #250 <Method List MultiDexExtractor.load(Context, String, boolean)>
	//  124  249:invokestatic    #254 <Method void installSecondaryDexes(ClassLoader, File, List)>
		((MultiDexExtractor) (s)).close();
	//  125  252:aload_3         
	//  126  253:invokevirtual   #259 <Method void MultiDexExtractor.close()>
...
_L2:
	...
	//   14   32:aload_0         
	//   15   33:invokestatic    #355 <Method ApplicationInfo getApplicationInfo(Context)>
	//   16   36:astore_1        
	...
	//   19   41:ldc1            #46  <String "MultiDex">
	//   20   43:ldc2            #357 <String "No ApplicationInfo available, i.e. running on a test Context: MultiDex support library is disabled.">
	//   21   46:invokestatic    #145 <Method int Log.i(String, String)>
	//   22   49:pop             
				return;
	//   23   50:return          
			}
	//*  24   51:aload_0         
	//*  25   52:new             #108 <Class File>
	//*  26   55:dup             
	//*  27   56:aload_1         
	//*  28   57:getfield        #362 <Field String ApplicationInfo.sourceDir>
	//*  29   60:invokespecial   #363 <Method void File(String)>
	//*  30   63:new             #108 <Class File>
	//*  31   66:dup             
	//*  32   67:aload_1         
	//*  33   68:getfield        #366 <Field String ApplicationInfo.dataDir>
	//*  34   71:invokespecial   #363 <Method void File(String)>
	//*  35   74:ldc1            #32  <String "secondary-dexes">
	//*  36   76:ldc1            #42  <String "">
	//*  37   78:iconst_1        
	//*  38   79:invokestatic    #368 <Method void doInstallation(Context, File, File, String, String, boolean)>
	//*  39   82:ldc1            #46  <String "MultiDex">
	//*  40   84:ldc2            #370 <String "install done">
	//*  41   87:invokestatic    #145 <Method int Log.i(String, String)>
	//*  42   90:pop             
	//*  43   91:return          
			// Misplaced declaration of an exception variable
			catch(Context context)
	...
	//   45   93:ldc1            #46  <String "MultiDex">
	//   46   95:ldc2            #372 <String "MultiDex installation failure">
	//   47   98:aload_0         
	//   48   99:invokestatic    #374 <Method int Log.e(String, String, Throwable)>
	//   49  102:pop             
			}
		...
		return;
		StringBuilder stringbuilder = new StringBuilder();
	//   50  103:new             #123 <Class StringBuilder>
	//   51  106:dup             
	//   52  107:invokespecial   #124 <Method void StringBuilder()>
	//   53  110:astore_1        
		stringbuilder.append("MultiDex installation failed (");
	//   54  111:aload_1         
	//   55  112:ldc2            #376 <String "MultiDex installation failed (">
	//   56  115:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//   57  118:pop             
		stringbuilder.append(((Exception) (context)).getMessage());
	//   58  119:aload_1         
	//   59  120:aload_0         
	//   60  121:invokevirtual   #379 <Method String Exception.getMessage()>
	//   61  124:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//   62  127:pop             
		stringbuilder.append(").");
	//   63  128:aload_1         
	//   64  129:ldc1            #136 <String ").">
	//   65  131:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//   66  134:pop             
		throw new RuntimeException(stringbuilder.toString());
	//   67  135:new             #190 <Class RuntimeException>
	//   68  138:dup             
	//   69  139:aload_1         
	//   70  140:invokevirtual   #139 <Method String StringBuilder.toString()>
	//   71  143:invokespecial   #380 <Method void RuntimeException(String)>
	//   72  146:athrow          
		context = ((Context) (new StringBuilder()));
	//   73  147:new             #123 <Class StringBuilder>
	//   74  150:dup             
	//   75  151:invokespecial   #124 <Method void StringBuilder()>
	//   76  154:astore_0        
		((StringBuilder) (context)).append("MultiDex installation failed. SDK ");
	//   77  155:aload_0         
	//   78  156:ldc2            #382 <String "MultiDex installation failed. SDK ">
	//   79  159:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//   80  162:pop             
		((StringBuilder) (context)).append(android.os.Build.VERSION.SDK_INT);
	//   81  163:aload_0         
	//   82  164:getstatic       #206 <Field int android.os.Build$VERSION.SDK_INT>
	//   83  167:invokevirtual   #211 <Method StringBuilder StringBuilder.append(int)>
	//   84  170:pop             
		((StringBuilder) (context)).append(" is unsupported. Min SDK version is ");
	//   85  171:aload_0         
	//   86  172:ldc2            #384 <String " is unsupported. Min SDK version is ">
	//   87  175:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//   88  178:pop             
		((StringBuilder) (context)).append(4);
	//   89  179:aload_0         
	//   90  180:iconst_4        
	//   91  181:invokevirtual   #211 <Method StringBuilder StringBuilder.append(int)>
	//   92  184:pop             
		((StringBuilder) (context)).append(".");
	//   93  185:aload_0         
	//   94  186:ldc2            #386 <String ".">
	...
	//  101  201:invokespecial   #380 <Method void RuntimeException(String)>
	//  102  204:athrow          
	}
	...
	//   19   41:ldc1            #46  <String "MultiDex">
	//   20   43:ldc2            #392 <String "No ApplicationInfo available for instrumentation, i.e. running on a test Context: MultiDex support library is disabled.">
	//   21   46:invokestatic    #145 <Method int Log.i(String, String)>
	//   22   49:pop             
				return;
	//   23   50:return          
	...
	//*  24   51:aload_1         
	//*  25   52:invokestatic    #355 <Method ApplicationInfo getApplicationInfo(Context)>
	//*  26   55:astore_2        
	//*  27   56:aload_2         
	//*  28   57:ifnonnull       70
	//*  29   60:ldc1            #46  <String "MultiDex">
	//*  30   62:ldc2            #357 <String "No ApplicationInfo available, i.e. running on a test Context: MultiDex support library is disabled.">
	//*  31   65:invokestatic    #145 <Method int Log.i(String, String)>
	//*  32   68:pop             
	//*  33   69:return          
	//*  34   70:new             #123 <Class StringBuilder>
	//*  35   73:dup             
	//*  36   74:invokespecial   #124 <Method void StringBuilder()>
	//*  37   77:astore          4
	//*  38   79:aload           4
	//*  39   81:aload_0         
	//*  40   82:invokevirtual   #395 <Method String Context.getPackageName()>
	//*  41   85:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//*  42   88:pop             
	//*  43   89:aload           4
	//*  44   91:ldc2            #386 <String ".">
	//*  45   94:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//*  46   97:pop             
	//*  47   98:aload           4
	//*  48  100:invokevirtual   #139 <Method String StringBuilder.toString()>
	//*  49  103:astore_0        
	//*  50  104:new             #108 <Class File>
	//*  51  107:dup             
	//*  52  108:aload_2         
	//*  53  109:getfield        #366 <Field String ApplicationInfo.dataDir>
	//*  54  112:invokespecial   #363 <Method void File(String)>
	//*  55  115:astore          4
	//*  56  117:new             #108 <Class File>
	//*  57  120:dup             
	//*  58  121:aload_3         
	//*  59  122:getfield        #362 <Field String ApplicationInfo.sourceDir>
	//*  60  125:invokespecial   #363 <Method void File(String)>
	//*  61  128:astore_3        
	//*  62  129:new             #123 <Class StringBuilder>
	//*  63  132:dup             
	//*  64  133:invokespecial   #124 <Method void StringBuilder()>
	//*  65  136:astore          5
	//*  66  138:aload           5
	//*  67  140:aload_0         
	//*  68  141:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//*  69  144:pop             
	//*  70  145:aload           5
	//*  71  147:ldc1            #32  <String "secondary-dexes">
	//*  72  149:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//*  73  152:pop             
	//*  74  153:aload_1         
	//*  75  154:aload_3         
	//*  76  155:aload           4
	//*  77  157:aload           5
	//*  78  159:invokevirtual   #139 <Method String StringBuilder.toString()>
	//*  79  162:aload_0         
	//*  80  163:iconst_0        
	//*  81  164:invokestatic    #368 <Method void doInstallation(Context, File, File, String, String, boolean)>
	//*  82  167:aload_1         
	//*  83  168:new             #108 <Class File>
	//*  84  171:dup             
	//*  85  172:aload_2         
	//*  86  173:getfield        #362 <Field String ApplicationInfo.sourceDir>
	//*  87  176:invokespecial   #363 <Method void File(String)>
	//*  88  179:aload           4
	//*  89  181:ldc1            #32  <String "secondary-dexes">
	//*  90  183:ldc1            #42  <String "">
	//*  91  185:iconst_0        
	//*  92  186:invokestatic    #368 <Method void doInstallation(Context, File, File, String, String, boolean)>
	//*  93  189:ldc1            #46  <String "MultiDex">
	//*  94  191:ldc2            #397 <String "Installation done">
	//*  95  194:invokestatic    #145 <Method int Log.i(String, String)>
	//*  96  197:pop             
	//*  97  198:return          
			// Misplaced declaration of an exception variable
			catch(Context context)
	//*  98  199:astore_0        
			{
				Log.e("MultiDex", "MultiDex installation failure", ((Throwable) (context)));
	//   99  200:ldc1            #46  <String "MultiDex">
	//  100  202:ldc2            #372 <String "MultiDex installation failure">
	//  101  205:aload_0         
	//  102  206:invokestatic    #374 <Method int Log.e(String, String, Throwable)>
	//  103  209:pop             
			}
	...
	//  104  210:new             #123 <Class StringBuilder>
	//  105  213:dup             
	//  106  214:invokespecial   #124 <Method void StringBuilder()>
	//  107  217:astore_1        
		((StringBuilder) (context1)).append("MultiDex installation failed (");
	//  108  218:aload_1         
	//  109  219:ldc2            #376 <String "MultiDex installation failed (">
	//  110  222:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//  111  225:pop             
		((StringBuilder) (context1)).append(((Exception) (context)).getMessage());
	//  112  226:aload_1         
	//  113  227:aload_0         
	//  114  228:invokevirtual   #379 <Method String Exception.getMessage()>
	//  115  231:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//  116  234:pop             
		((StringBuilder) (context1)).append(").");
	//  117  235:aload_1         
	//  118  236:ldc1            #136 <String ").">
	//  119  238:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//  120  241:pop             
		throw new RuntimeException(((StringBuilder) (context1)).toString());
	//  121  242:new             #190 <Class RuntimeException>
	//  122  245:dup             
	//  123  246:aload_1         
	//  124  247:invokevirtual   #139 <Method String StringBuilder.toString()>
	//  125  250:invokespecial   #380 <Method void RuntimeException(String)>
	//  126  253:athrow          
		context = ((Context) (new StringBuilder()));
	//  127  254:new             #123 <Class StringBuilder>
	//  128  257:dup             
	//  129  258:invokespecial   #124 <Method void StringBuilder()>
	//  130  261:astore_0        
		((StringBuilder) (context)).append("MultiDex installation failed. SDK ");
	//  131  262:aload_0         
	//  132  263:ldc2            #382 <String "MultiDex installation failed. SDK ">
	//  133  266:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//  134  269:pop             
		((StringBuilder) (context)).append(android.os.Build.VERSION.SDK_INT);
	//  135  270:aload_0         
	//  136  271:getstatic       #206 <Field int android.os.Build$VERSION.SDK_INT>
	//  137  274:invokevirtual   #211 <Method StringBuilder StringBuilder.append(int)>
	//  138  277:pop             
		((StringBuilder) (context)).append(" is unsupported. Min SDK version is ");
	//  139  278:aload_0         
	//  140  279:ldc2            #384 <String " is unsupported. Min SDK version is ">
	//  141  282:invokevirtual   #130 <Method StringBuilder StringBuilder.append(String)>
	//  142  285:pop             
		((StringBuilder) (context)).append(4);
	//  143  286:aload_0         
	//  144  287:iconst_4        
	//  145  288:invokevirtual   #211 <Method StringBuilder StringBuilder.append(int)>
	//  146  291:pop             
		((StringBuilder) (context)).append(".");
	//  147  292:aload_0         
	//  148  293:ldc2            #386 <String ".">
	...
	//  155  308:invokespecial   #380 <Method void RuntimeException(String)>
	//  156  311:athrow          
	}
