	...
	implements Runnable
{
	...
	{
		Object obj;
		for(Iterator iterator = mConnections.keySet().iterator(); iterator.hasNext(); notifyChildrenChangedOnHandler(((MediaBrowserServiceCompat.ConnectionRecord) (obj)), val$parentId, val$options))
	//*   0    0:aload_0         
