...
//			MediaControllerCompatApi21, MediaSessionCompat
...
static class MediaControllerCompatApi21$CallbackProxy extends android.media.session.MediaController.Callback
{
	...
	//    0    0:aload_1         
	//    1    1:invokestatic    #56  <Method void MediaSessionCompat.ensureClassLoader(Bundle)>
		mCallback.onExtrasChanged(bundle);
	//    2    4:aload_0         
	//    3    5:getfield        #18  <Field MediaControllerCompatApi21$Callback mCallback>
	//    4    8:aload_1         
	//    5    9:invokeinterface #58  <Method void MediaControllerCompatApi21$Callback.onExtrasChanged(Bundle)>
	//    6   14:return          
	}
	...
	//    1    1:getfield        #18  <Field MediaControllerCompatApi21$Callback mCallback>
	//    2    4:aload_1         
	//    3    5:invokeinterface #63  <Method void MediaControllerCompatApi21$Callback.onMetadataChanged(Object)>
	//    4   10:return          
	}
	...
	//    1    1:getfield        #18  <Field MediaControllerCompatApi21$Callback mCallback>
	//    2    4:aload_1         
	//    3    5:invokeinterface #67  <Method void MediaControllerCompatApi21$Callback.onPlaybackStateChanged(Object)>
	//    4   10:return          
	}
	...
	//    1    1:getfield        #18  <Field MediaControllerCompatApi21$Callback mCallback>
	//    2    4:aload_1         
	//    3    5:invokeinterface #71  <Method void MediaControllerCompatApi21$Callback.onQueueChanged(List)>
	//    4   10:return          
	}
	...
	//    1    1:getfield        #18  <Field MediaControllerCompatApi21$Callback mCallback>
	//    2    4:aload_1         
	//    3    5:invokeinterface #76  <Method void MediaControllerCompatApi21$Callback.onQueueTitleChanged(CharSequence)>
	//    4   10:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #18  <Field MediaControllerCompatApi21$Callback mCallback>
	//    2    4:invokeinterface #79  <Method void MediaControllerCompatApi21$Callback.onSessionDestroyed()>
	//    3    9:return          
	}
	...
	//    4    8:aload_1         
	//    5    9:aload_2         
	//    6   10:invokeinterface #83  <Method void MediaControllerCompatApi21$Callback.onSessionEvent(String, Bundle)>
	//    7   15:return          
	}
