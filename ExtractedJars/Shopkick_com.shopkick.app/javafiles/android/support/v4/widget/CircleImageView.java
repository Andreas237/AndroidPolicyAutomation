...
class CircleImageView extends ImageView
{
	...
	//   41   74:new             #58  <Class ShapeDrawable>
	//   42   77:dup             
	//   43   78:new             #6   <Class CircleImageView$OvalShadow>
	//   44   81:dup             
	//   45   82:aload_0         
	//   46   83:aload_0         
	//   47   84:getfield        #52  <Field int mShadowRadius>
	//   48   87:invokespecial   #76  <Method void CircleImageView$OvalShadow(CircleImageView, int)>
	//   49   90:invokespecial   #66  <Method void ShapeDrawable(android.graphics.drawable.shapes.Shape)>
	//   50   93:astore_1        
			setLayerType(1, ((ShapeDrawable) (context)).getPaint());
	//   51   94:aload_0         
	//   52   95:iconst_1        
	//   53   96:aload_1         
	//   54   97:invokevirtual   #80  <Method Paint ShapeDrawable.getPaint()>
	//   55  100:invokevirtual   #84  <Method void setLayerType(int, Paint)>
			((ShapeDrawable) (context)).getPaint().setShadowLayer(mShadowRadius, k, j, 0x1e000000);
	//   56  103:aload_1         
	//   57  104:invokevirtual   #80  <Method Paint ShapeDrawable.getPaint()>
	//   58  107:aload_0         
	//   59  108:getfield        #52  <Field int mShadowRadius>
	//   60  111:i2f             
	//   61  112:iload           5
	//   62  114:i2f             
	//   63  115:iload           4
	//   64  117:i2f             
	//   65  118:ldc1            #12  <Int 0x1e000000>
	//   66  120:invokevirtual   #90  <Method void Paint.setShadowLayer(float, float, float, int)>
			j = mShadowRadius;
	//   67  123:aload_0         
	//   68  124:getfield        #52  <Field int mShadowRadius>
	//   69  127:istore          4
			setPadding(j, j, j, j);
	//   70  129:aload_0         
	//   71  130:iload           4
	...
	//   73  134:iload           4
	//   74  136:iload           4
	//   75  138:invokevirtual   #94  <Method void setPadding(int, int, int, int)>
		}
		((ShapeDrawable) (context)).getPaint().setColor(i);
	//   76  141:aload_1         
	//   77  142:invokevirtual   #80  <Method Paint ShapeDrawable.getPaint()>
	//   78  145:iload_2         
	//   79  146:invokevirtual   #98  <Method void Paint.setColor(int)>
		ViewCompat.setBackground(((android.view.View) (this)), ((android.graphics.drawable.Drawable) (context)));
	//   80  149:aload_0         
	//   81  150:aload_1         
	//   82  151:invokestatic    #102 <Method void ViewCompat.setBackground(android.view.View, android.graphics.drawable.Drawable)>
	//   83  154:return          
	}
	...
	//    7   13:aload_1         
	//    8   14:aload_0         
	//    9   15:invokevirtual   #117 <Method android.view.animation.Animation getAnimation()>
	//   10   18:invokeinterface #122 <Method void android.view.animation.Animation$AnimationListener.onAnimationEnd(android.view.animation.Animation)>
	//   11   23:return          
	}
	...
	//    8   14:aload_0         
	//    9   15:invokevirtual   #117 <Method android.view.animation.Animation getAnimation()>
	//   10   18:invokeinterface #127 <Method void android.view.animation.Animation$AnimationListener.onAnimationStart(android.view.animation.Animation)>
	//   11   23:return          
	}
	...
	//    7   17:invokevirtual   #80  <Method Paint ShapeDrawable.getPaint()>
	//    8   20:iload_1         
	//    9   21:invokevirtual   #98  <Method void Paint.setColor(int)>
	//   10   24:return          
	}
