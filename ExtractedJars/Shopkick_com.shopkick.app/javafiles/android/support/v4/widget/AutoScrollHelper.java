	...
	implements android.view.View.OnTouchListener
{
	...
	//   78  117:aload_1         
	//   79  118:getfield        #115 <Field float DisplayMetrics.density>
	//   80  121:ldc1            #116 <Float 1575F>
	//   81  123:fmul            
	...
	//   21   31:aload_0         
	//   22   32:getfield        #94  <Field float[] mRelativeVelocity>
	//   23   35:iload_1         
	//   24   36:faload          
	//   25   37:fstore          6
		f1 = mMinimumVelocity[i];
	//   26   39:aload_0         
	//   27   40:getfield        #96  <Field float[] mMinimumVelocity>
	//   28   43:iload_1         
	//   29   44:faload          
	//   30   45:fstore_3        
		float f3 = mMaximumVelocity[i];
	//   31   46:aload_0         
	//   32   47:getfield        #98  <Field float[] mMaximumVelocity>
	//   33   50:iload_1         
	//   34   51:faload          
	//   35   52:fstore          5
		f2 = f4 * f2;
	...
	//   45   70:fload_3         
	//   46   71:fload           5
	//   47   73:invokestatic    #158 <Method float constrain(float, float, float)>
	//   48   76:freturn         
		else
			return -constrain(-f * f2, f1, f3);
	//   49   77:fload_2         
	...
	//   53   82:fload_3         
	//   54   83:fload           5
	//   55   85:invokestatic    #158 <Method float constrain(float, float, float)>
	//   56   88:fneg            
	//   57   89:freturn         
	}
	...
	//   35   70:freturn         
			if(mAnimating && i == 1)
	//*  36   71:aload_0         
	//*  37   72:getfield        #165 <Field boolean mAnimating>
	//*  38   75:ifeq            85
	//*  39   78:iload_3         
	//*  40   79:iconst_1        
	//*  41   80:icmpne          85
...
label0:
	...
	//   23   45:aload_0         
	//   24   46:getfield        #100 <Field View mTarget>
	//   25   49:aload_0         
	//   26   50:getfield        #182 <Field Runnable mRunnable>
	//   27   53:iload_1         
	//   28   54:i2l             
	//   29   55:invokestatic    #195 <Method void ViewCompat.postOnAnimationDelayed(View, Runnable, long)>
					break label0;
	//   30   58:goto            70
				}
			}
			mRunnable.run();
	//   31   61:aload_0         
	//   32   62:getfield        #182 <Field Runnable mRunnable>
	//   33   65:invokeinterface #200 <Method void Runnable.run()>
		}
		mAlreadyDelayed = true;
	//   34   70:aload_0         
	//   35   71:iconst_1        
	//   36   72:putfield        #187 <Field boolean mAlreadyDelayed>
	//   37   75:return          
	}
