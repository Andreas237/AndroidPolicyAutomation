...
_L3:
		...
		String as[];
		HashSet hashset;
		as = ((String) (obj)).split(":", -1);
	//   15   30:aload_3         
	//   16   31:ldc1            #135 <String ":">
	//   17   33:iconst_m1       
	//   18   34:invokevirtual   #139 <Method String[] String.split(String, int)>
	//   19   37:astore          4
		hashset = new HashSet(as.length);
	//   20   39:new             #85  <Class HashSet>
	//   21   42:dup             
	//   22   43:aload           4
	//   23   45:arraylength     
	//   24   46:invokespecial   #142 <Method void HashSet(int)>
	//   25   49:astore          5
		j = as.length;
	//   26   51:aload           4
	//   27   53:arraylength     
...
_L4:
	...
	//   35   64:iload_1         
	//   36   65:aaload          
	//   37   66:invokestatic    #148 <Method ComponentName ComponentName.unflattenFromString(String)>
	//   38   69:astore          6
...
_L6:
	...
	//   41   76:aload           5
	//   42   78:aload           6
	//   43   80:invokevirtual   #152 <Method String ComponentName.getPackageName()>
	//   44   83:invokeinterface #157 <Method boolean Set.add(Object)>
	//   45   88:pop             
		  goto _L7
	//*  46   89:goto            114
_L5:
	...
	//   47   92:aload           5
	//   48   94:putstatic       #88  <Field Set sEnabledNotificationListenerPackages>
		sEnabledNotificationListeners = ((String) (obj));
	//   49   97:aload_3         
	//   50   98:putstatic       #127 <Field String sEnabledNotificationListeners>
_L2:
		obj = ((Object) (sEnabledNotificationListenerPackages));
	//   51  101:getstatic       #88  <Field Set sEnabledNotificationListenerPackages>
	//   52  104:astore_3        
		context;
	//   53  105:aload_0         
