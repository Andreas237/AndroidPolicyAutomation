...
class LoaderManagerImpl extends LoaderManager
{
	...
	static class LoaderViewModel extends ViewModel
	{
		...
		//*  14   26:invokevirtual   #107 <Method boolean LoaderManagerImpl$LoaderInfo.isCallbackWaitingForData()>
		//*  15   29:ifeq            34
					return true;
		//   16   32:iconst_1        
		//   17   33:ireturn         
		...
		//   12   20:invokevirtual   #79  <Method Object SparseArrayCompat.valueAt(int)>
		//   13   23:checkcast       #81  <Class LoaderManagerImpl$LoaderInfo>
		//   14   26:invokevirtual   #111 <Method void LoaderManagerImpl$LoaderInfo.markForRedelivery()>
		...
		protected void onCleared()
		{
			super.onCleared();
		//    0    0:aload_0         
		//    1    1:invokespecial   #114 <Method void ViewModel.onCleared()>
			int j = mLoaders.size();
		//    2    4:aload_0         
		...
		//   16   30:iconst_1        
		//   17   31:invokevirtual   #118 <Method Loader LoaderManagerImpl$LoaderInfo.destroy(boolean)>
		//   18   34:pop             
		...
		//   26   46:invokevirtual   #121 <Method void SparseArrayCompat.clear()>
		//   27   49:return          
		}
		...
		//    2    4:iload_1         
		//    3    5:aload_2         
		//    4    6:invokevirtual   #127 <Method void SparseArrayCompat.put(int, Object)>
		//    5    9:return          
		}
		...
		//    1    1:getfield        #30  <Field SparseArrayCompat mLoaders>
		//    2    4:iload_1         
		//    3    5:invokevirtual   #132 <Method void SparseArrayCompat.remove(int)>
		//    4    8:return          
		}
...
;
	...
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:putfield        #36  <Field LifecycleOwner mLifecycleOwner>
		mLoaderViewModel = LoaderViewModel.getInstance(viewmodelstore);
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:invokestatic    #40  <Method LoaderManagerImpl$LoaderViewModel LoaderManagerImpl$LoaderViewModel.getInstance(ViewModelStore)>
	//    8   14:putfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//    9   17:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//    2    4:invokevirtual   #50  <Method void LoaderManagerImpl$LoaderViewModel.startCreatingLoader()>
		loader1 = loadercallbacks.onCreateLoader(i, bundle);
	//    3    7:aload_3         
	//    4    8:iload_1         
	//    5    9:aload_2         
	//    6   10:invokeinterface #56  <Method Loader LoaderManager$LoaderCallbacks.onCreateLoader(int, Bundle)>
	//    7   15:astore          5
		if(loader1 == null)
	...
	//*  10   22:aload           5
	//*  11   24:invokevirtual   #62  <Method Class Object.getClass()>
	//*  12   27:invokevirtual   #68  <Method boolean Class.isMemberClass()>
	//*  13   30:ifeq            84
	//*  14   33:aload           5
	//*  15   35:invokevirtual   #62  <Method Class Object.getClass()>
	//*  16   38:invokevirtual   #72  <Method int Class.getModifiers()>
	//*  17   41:invokestatic    #78  <Method boolean Modifier.isStatic(int)>
	//*  18   44:ifeq            50
			break MISSING_BLOCK_LABEL_84;
	//   19   47:goto            84
		bundle = ((Bundle) (new StringBuilder()));
	//   20   50:new             #80  <Class StringBuilder>
	//   21   53:dup             
	//   22   54:invokespecial   #81  <Method void StringBuilder()>
	//   23   57:astore_2        
		((StringBuilder) (bundle)).append("Object returned from onCreateLoader must not be a non-static inner member class: ");
	//   24   58:aload_2         
	//   25   59:ldc1            #83  <String "Object returned from onCreateLoader must not be a non-static inner member class: ">
	//   26   61:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   27   64:pop             
		((StringBuilder) (bundle)).append(((Object) (loader1)));
	//   28   65:aload_2         
	//   29   66:aload           5
	//   30   68:invokevirtual   #90  <Method StringBuilder StringBuilder.append(Object)>
	//   31   71:pop             
		throw new IllegalArgumentException(((StringBuilder) (bundle)).toString());
	//   32   72:new             #92  <Class IllegalArgumentException>
	//   33   75:dup             
	//   34   76:aload_2         
	//   35   77:invokevirtual   #96  <Method String StringBuilder.toString()>
	//   36   80:invokespecial   #99  <Method void IllegalArgumentException(String)>
	//   37   83:athrow          
	...
	//   42   90:aload           5
	//   43   92:aload           4
	//   44   94:invokespecial   #102 <Method void LoaderManagerImpl$LoaderInfo(int, Bundle, Loader, Loader)>
	//   45   97:astore_2        
		if(DEBUG)
	//*  46   98:getstatic       #104 <Field boolean DEBUG>
	//*  47  101:ifeq            139
		{
			loader = ((Loader) (new StringBuilder()));
	//   48  104:new             #80  <Class StringBuilder>
	//   49  107:dup             
	//   50  108:invokespecial   #81  <Method void StringBuilder()>
	//   51  111:astore          4
			((StringBuilder) (loader)).append("  Created new loader ");
	//   52  113:aload           4
	//   53  115:ldc1            #106 <String "  Created new loader ">
	//   54  117:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   55  120:pop             
			((StringBuilder) (loader)).append(((Object) (bundle)));
	//   56  121:aload           4
	//   57  123:aload_2         
	//   58  124:invokevirtual   #90  <Method StringBuilder StringBuilder.append(Object)>
	//   59  127:pop             
			Log.v("LoaderManager", ((StringBuilder) (loader)).toString());
	//   60  128:ldc1            #22  <String "LoaderManager">
	//   61  130:aload           4
	//   62  132:invokevirtual   #96  <Method String StringBuilder.toString()>
	//   63  135:invokestatic    #112 <Method int Log.v(String, String)>
	//   64  138:pop             
		}
		mLoaderViewModel.putLoader(i, ((LoaderInfo) (bundle)));
	//   65  139:aload_0         
	//   66  140:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//   67  143:iload_1         
	//   68  144:aload_2         
	//   69  145:invokevirtual   #116 <Method void LoaderManagerImpl$LoaderViewModel.putLoader(int, LoaderManagerImpl$LoaderInfo)>
		mLoaderViewModel.finishCreatingLoader();
	//   70  148:aload_0         
	//   71  149:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//   72  152:invokevirtual   #119 <Method void LoaderManagerImpl$LoaderViewModel.finishCreatingLoader()>
		return ((LoaderInfo) (bundle)).setCallback(mLifecycleOwner, loadercallbacks);
	//   73  155:aload_2         
	//   74  156:aload_0         
	//   75  157:getfield        #36  <Field LifecycleOwner mLifecycleOwner>
	//   76  160:aload_3         
	//   77  161:invokevirtual   #123 <Method Loader LoaderManagerImpl$LoaderInfo.setCallback(LifecycleOwner, LoaderManager$LoaderCallbacks)>
	//   78  164:areturn         
		throw new IllegalArgumentException("Object returned from onCreateLoader must not be null");
	//   79  165:new             #92  <Class IllegalArgumentException>
	//   80  168:dup             
	//   81  169:ldc1            #125 <String "Object returned from onCreateLoader must not be null">
	//   82  171:invokespecial   #99  <Method void IllegalArgumentException(String)>
	//   83  174:athrow          
		bundle;
	//   84  175:astore_2        
		mLoaderViewModel.finishCreatingLoader();
	//   85  176:aload_0         
	//   86  177:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//   87  180:invokevirtual   #119 <Method void LoaderManagerImpl$LoaderViewModel.finishCreatingLoader()>
		throw bundle;
	//   88  183:aload_2         
	//   89  184:athrow          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//*   2    4:invokevirtual   #133 <Method boolean LoaderManagerImpl$LoaderViewModel.isCreatingLoader()>
	//*   3    7:ifne            107
		{
			if(Looper.getMainLooper() == Looper.myLooper())
	//*   4   10:invokestatic    #139 <Method Looper Looper.getMainLooper()>
	//*   5   13:invokestatic    #142 <Method Looper Looper.myLooper()>
	//*   6   16:if_acmpne       97
			{
				if(DEBUG)
	//*   7   19:getstatic       #104 <Field boolean DEBUG>
	//*   8   22:ifeq            69
				{
					StringBuilder stringbuilder = new StringBuilder();
	//    9   25:new             #80  <Class StringBuilder>
	//   10   28:dup             
	//   11   29:invokespecial   #81  <Method void StringBuilder()>
	//   12   32:astore_2        
					stringbuilder.append("destroyLoader in ");
	//   13   33:aload_2         
	//   14   34:ldc1            #144 <String "destroyLoader in ">
	//   15   36:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   16   39:pop             
					stringbuilder.append(((Object) (this)));
	//   17   40:aload_2         
	//   18   41:aload_0         
	//   19   42:invokevirtual   #90  <Method StringBuilder StringBuilder.append(Object)>
	//   20   45:pop             
					stringbuilder.append(" of ");
	//   21   46:aload_2         
	//   22   47:ldc1            #146 <String " of ">
	//   23   49:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   24   52:pop             
					stringbuilder.append(i);
	//   25   53:aload_2         
	//   26   54:iload_1         
	//   27   55:invokevirtual   #149 <Method StringBuilder StringBuilder.append(int)>
	//   28   58:pop             
					Log.v("LoaderManager", stringbuilder.toString());
	//   29   59:ldc1            #22  <String "LoaderManager">
	//   30   61:aload_2         
	//   31   62:invokevirtual   #96  <Method String StringBuilder.toString()>
	//   32   65:invokestatic    #112 <Method int Log.v(String, String)>
	//   33   68:pop             
				}
				LoaderInfo loaderinfo = mLoaderViewModel.getLoader(i);
	//   34   69:aload_0         
	//   35   70:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//   36   73:iload_1         
	//   37   74:invokevirtual   #153 <Method LoaderManagerImpl$LoaderInfo LoaderManagerImpl$LoaderViewModel.getLoader(int)>
	//   38   77:astore_2        
				if(loaderinfo != null)
	//*  39   78:aload_2         
	//*  40   79:ifnull          96
	...
	//   41   82:aload_2         
	//   42   83:iconst_1        
	//   43   84:invokevirtual   #157 <Method Loader LoaderManagerImpl$LoaderInfo.destroy(boolean)>
	//   44   87:pop             
					mLoaderViewModel.removeLoader(i);
	//   45   88:aload_0         
	//   46   89:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//   47   92:iload_1         
	//   48   93:invokevirtual   #160 <Method void LoaderManagerImpl$LoaderViewModel.removeLoader(int)>
				}
				return;
	//   49   96:return          
			} else
	...
	//   50   97:new             #162 <Class IllegalStateException>
	//   51  100:dup             
	//   52  101:ldc1            #164 <String "destroyLoader must be called on the main thread">
	//   53  103:invokespecial   #165 <Method void IllegalStateException(String)>
	//   54  106:athrow          
			}
		} else
		{
			throw new IllegalStateException("Called while creating a loader");
	//   55  107:new             #162 <Class IllegalStateException>
	//   56  110:dup             
	//   57  111:ldc1            #167 <String "Called while creating a loader">
	//   58  113:invokespecial   #165 <Method void IllegalStateException(String)>
	//   59  116:athrow          
		}
	}
	...
	//    4    6:aload_3         
	//    5    7:aload           4
	//    6    9:invokevirtual   #172 <Method void LoaderManagerImpl$LoaderViewModel.dump(String, FileDescriptor, PrintWriter, String[])>
	//    7   12:return          
	}
	...
	//*   3    7:ifne            30
		{
			LoaderInfo loaderinfo = mLoaderViewModel.getLoader(i);
	//    4   10:aload_0         
	//    5   11:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//    6   14:iload_1         
	//    7   15:invokevirtual   #153 <Method LoaderManagerImpl$LoaderInfo LoaderManagerImpl$LoaderViewModel.getLoader(int)>
	//    8   18:astore_2        
			if(loaderinfo != null)
	//*   9   19:aload_2         
	//*  10   20:ifnull          28
	...
	//   11   23:aload_2         
	//   12   24:invokevirtual   #177 <Method Loader LoaderManagerImpl$LoaderInfo.getLoader()>
	//   13   27:areturn         
			else
				return null;
	//   14   28:aconst_null     
	//   15   29:areturn         
		...
		{
			throw new IllegalStateException("Called while creating a loader");
	//   16   30:new             #162 <Class IllegalStateException>
	//   17   33:dup             
	//   18   34:ldc1            #167 <String "Called while creating a loader">
	//   19   36:invokespecial   #165 <Method void IllegalStateException(String)>
	//   20   39:athrow          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//    2    4:invokevirtual   #181 <Method boolean LoaderManagerImpl$LoaderViewModel.hasRunningLoaders()>
	//    3    7:ireturn         
	}
	...
	//*   6   16:if_acmpne       148
			{
				LoaderInfo loaderinfo = mLoaderViewModel.getLoader(i);
	//    7   19:aload_0         
	//    8   20:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//    9   23:iload_1         
	//   10   24:invokevirtual   #153 <Method LoaderManagerImpl$LoaderInfo LoaderManagerImpl$LoaderViewModel.getLoader(int)>
	//   11   27:astore          4
				if(DEBUG)
	//*  12   29:getstatic       #104 <Field boolean DEBUG>
	//*  13   32:ifeq            85
				{
					StringBuilder stringbuilder = new StringBuilder();
	//   14   35:new             #80  <Class StringBuilder>
	//   15   38:dup             
	//   16   39:invokespecial   #81  <Method void StringBuilder()>
	//   17   42:astore          5
					stringbuilder.append("initLoader in ");
	//   18   44:aload           5
	//   19   46:ldc1            #185 <String "initLoader in ">
	//   20   48:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   21   51:pop             
					stringbuilder.append(((Object) (this)));
	//   22   52:aload           5
	//   23   54:aload_0         
	//   24   55:invokevirtual   #90  <Method StringBuilder StringBuilder.append(Object)>
	//   25   58:pop             
					stringbuilder.append(": args=");
	//   26   59:aload           5
	//   27   61:ldc1            #187 <String ": args=">
	//   28   63:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   29   66:pop             
					stringbuilder.append(((Object) (bundle)));
	//   30   67:aload           5
	//   31   69:aload_2         
	//   32   70:invokevirtual   #90  <Method StringBuilder StringBuilder.append(Object)>
	//   33   73:pop             
					Log.v("LoaderManager", stringbuilder.toString());
	//   34   74:ldc1            #22  <String "LoaderManager">
	//   35   76:aload           5
	//   36   78:invokevirtual   #96  <Method String StringBuilder.toString()>
	//   37   81:invokestatic    #112 <Method int Log.v(String, String)>
	//   38   84:pop             
				}
				if(loaderinfo == null)
	//*  39   85:aload           4
	...
	//   44   93:aload_3         
	//   45   94:aconst_null     
	//   46   95:invokespecial   #189 <Method Loader createAndInstallLoader(int, Bundle, LoaderManager$LoaderCallbacks, Loader)>
	//   47   98:areturn         
				if(DEBUG)
	//*  48   99:getstatic       #104 <Field boolean DEBUG>
	//*  49  102:ifeq            137
				{
					bundle = ((Bundle) (new StringBuilder()));
	//   50  105:new             #80  <Class StringBuilder>
	//   51  108:dup             
	//   52  109:invokespecial   #81  <Method void StringBuilder()>
	//   53  112:astore_2        
					((StringBuilder) (bundle)).append("  Re-using existing loader ");
	//   54  113:aload_2         
	//   55  114:ldc1            #191 <String "  Re-using existing loader ">
	//   56  116:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   57  119:pop             
					((StringBuilder) (bundle)).append(((Object) (loaderinfo)));
	//   58  120:aload_2         
	//   59  121:aload           4
	//   60  123:invokevirtual   #90  <Method StringBuilder StringBuilder.append(Object)>
	//   61  126:pop             
					Log.v("LoaderManager", ((StringBuilder) (bundle)).toString());
	//   62  127:ldc1            #22  <String "LoaderManager">
	//   63  129:aload_2         
	//   64  130:invokevirtual   #96  <Method String StringBuilder.toString()>
	//   65  133:invokestatic    #112 <Method int Log.v(String, String)>
	//   66  136:pop             
				}
				return loaderinfo.setCallback(mLifecycleOwner, loadercallbacks);
	//   67  137:aload           4
	//   68  139:aload_0         
	//   69  140:getfield        #36  <Field LifecycleOwner mLifecycleOwner>
	//   70  143:aload_3         
	//   71  144:invokevirtual   #123 <Method Loader LoaderManagerImpl$LoaderInfo.setCallback(LifecycleOwner, LoaderManager$LoaderCallbacks)>
	//   72  147:areturn         
			} else
			{
				throw new IllegalStateException("initLoader must be called on the main thread");
	//   73  148:new             #162 <Class IllegalStateException>
	//   74  151:dup             
	//   75  152:ldc1            #193 <String "initLoader must be called on the main thread">
	//   76  154:invokespecial   #165 <Method void IllegalStateException(String)>
	//   77  157:athrow          
			}
		} else
		{
			throw new IllegalStateException("Called while creating a loader");
	//   78  158:new             #162 <Class IllegalStateException>
	//   79  161:dup             
	//   80  162:ldc1            #167 <String "Called while creating a loader">
	//   81  164:invokespecial   #165 <Method void IllegalStateException(String)>
	//   82  167:athrow          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//    2    4:invokevirtual   #197 <Method void LoaderManagerImpl$LoaderViewModel.markForRedelivery()>
	//    3    7:return          
	}
	...
	//   13   34:aload           4
	//   14   36:ldc1            #200 <String "restartLoader in ">
	//   15   38:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   16   41:pop             
					stringbuilder.append(((Object) (this)));
	//   17   42:aload           4
	//   18   44:aload_0         
	//   19   45:invokevirtual   #90  <Method StringBuilder StringBuilder.append(Object)>
	//   20   48:pop             
					stringbuilder.append(": args=");
	//   21   49:aload           4
	//   22   51:ldc1            #187 <String ": args=">
	//   23   53:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   24   56:pop             
					stringbuilder.append(((Object) (bundle)));
	//   25   57:aload           4
	//   26   59:aload_2         
	...
	//   28   63:pop             
					Log.v("LoaderManager", stringbuilder.toString());
	//   29   64:ldc1            #22  <String "LoaderManager">
	//   30   66:aload           4
	//   31   68:invokevirtual   #96  <Method String StringBuilder.toString()>
	//   32   71:invokestatic    #112 <Method int Log.v(String, String)>
	//   33   74:pop             
				}
				LoaderInfo loaderinfo = mLoaderViewModel.getLoader(i);
	//   34   75:aload_0         
	//   35   76:getfield        #42  <Field LoaderManagerImpl$LoaderViewModel mLoaderViewModel>
	//   36   79:iload_1         
	//   37   80:invokevirtual   #153 <Method LoaderManagerImpl$LoaderInfo LoaderManagerImpl$LoaderViewModel.getLoader(int)>
	//   38   83:astore          5
				Loader loader = null;
	//   39   85:aconst_null     
	//   40   86:astore          4
	...
	//   43   93:aload           5
	//   44   95:iconst_0        
	//   45   96:invokevirtual   #157 <Method Loader LoaderManagerImpl$LoaderInfo.destroy(boolean)>
	//   46   99:astore          4
	...
	//   50  104:aload_3         
	//   51  105:aload           4
	//   52  107:invokespecial   #189 <Method Loader createAndInstallLoader(int, Bundle, LoaderManager$LoaderCallbacks, Loader)>
	//   53  110:areturn         
			} else
			{
				throw new IllegalStateException("restartLoader must be called on the main thread");
	//   54  111:new             #162 <Class IllegalStateException>
	//   55  114:dup             
	//   56  115:ldc1            #202 <String "restartLoader must be called on the main thread">
	//   57  117:invokespecial   #165 <Method void IllegalStateException(String)>
	//   58  120:athrow          
			}
		} else
		{
			throw new IllegalStateException("Called while creating a loader");
	//   59  121:new             #162 <Class IllegalStateException>
	//   60  124:dup             
	//   61  125:ldc1            #167 <String "Called while creating a loader">
	//   62  127:invokespecial   #165 <Method void IllegalStateException(String)>
	//   63  130:athrow          
		}
	}
	...
	//    1    3:dup             
	//    2    4:sipush          128
	//    3    7:invokespecial   #204 <Method void StringBuilder(int)>
	//    4   10:astore_1        
		stringbuilder.append("LoaderManager{");
	//    5   11:aload_1         
	//    6   12:ldc1            #206 <String "LoaderManager{">
	//    7   14:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//    8   17:pop             
		stringbuilder.append(Integer.toHexString(System.identityHashCode(((Object) (this)))));
	//    9   18:aload_1         
	//   10   19:aload_0         
	//   11   20:invokestatic    #212 <Method int System.identityHashCode(Object)>
	//   12   23:invokestatic    #218 <Method String Integer.toHexString(int)>
	//   13   26:invokevirtual   #87  <Method StringBuilder StringBuilder.append(String)>
	//   14   29:pop             
		stringbuilder.append(" in ");
	//   15   30:aload_1         
	//   16   31:ldc1            #220 <String " in ">
	...
	//   19   37:aload_0         
	//   20   38:getfield        #36  <Field LifecycleOwner mLifecycleOwner>
	//   21   41:aload_1         
	//   22   42:invokestatic    #226 <Method void DebugUtils.buildShortClassTag(Object, StringBuilder)>
		stringbuilder.append("}}");
	//   23   45:aload_1         
	//   24   46:ldc1            #228 <String "}}">
