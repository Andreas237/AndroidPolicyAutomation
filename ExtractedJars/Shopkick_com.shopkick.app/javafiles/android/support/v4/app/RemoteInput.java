...
public final class RemoteInput
{
	...
	//*  36   81:ifeq            54
				{
					String s1 = s2.substring(39);
	//   37   84:aload           5
	//   38   86:bipush          39
	//   39   88:invokevirtual   #278 <Method String String.substring(int)>
	//   40   91:astore          4
					if(!s1.isEmpty())
	//*  41   93:aload           4
	//*  42   95:invokevirtual   #281 <Method boolean String.isEmpty()>
	//*  43   98:ifeq            104
	//*  44  101:goto            54
					{
	...
	//   45  104:aload_0         
	//   46  105:aload           5
	//   47  107:invokevirtual   #118 <Method Bundle Intent.getBundleExtra(String)>
	//   48  110:aload_1         
	//   49  111:invokevirtual   #284 <Method String Bundle.getString(String)>
	//   50  114:astore          5
						if(s2 != null && !s2.isEmpty())
	//*  51  116:aload           5
	//*  52  118:ifnull          54
	//*  53  121:aload           5
	//*  54  123:invokevirtual   #281 <Method boolean String.isEmpty()>
	//*  55  126:ifeq            132
	//*  56  129:goto            54
	...
	//   58  133:aload           4
	//   59  135:aload           5
	//   60  137:invokestatic    #288 <Method Uri Uri.parse(String)>
	//   61  140:invokeinterface #292 <Method Object Map.put(Object, Object)>
	//   62  145:pop             
					}
				}
			} while(true);
	...
	//*  66  151:aload_2         
	//*  67  152:invokeinterface #293 <Method boolean Map.isEmpty()>
	//*  68  157:ifeq            162
				intent = null;
	//   69  160:aconst_null     
	//   70  161:astore_0        
	...
	//   72  163:areturn         
		...
		{
			Log.w("RemoteInput", "RemoteInput is only supported from API Level 16");
	//   73  164:ldc1            #20  <String "RemoteInput">
	//   74  166:ldc1            #148 <String "RemoteInput is only supported from API Level 16">
	//   75  168:invokestatic    #154 <Method int Log.w(String, String)>
	//   76  171:pop             
			return null;
	//   77  172:aconst_null     
	//   78  173:areturn         
	...
	//    6   11:invokevirtual   #301 <Method StringBuilder StringBuilder.append(String)>
	//    7   14:pop             
		stringbuilder.append(s);
	//    8   15:aload_1         
	//    9   16:aload_0         
	//   10   17:invokevirtual   #301 <Method StringBuilder StringBuilder.append(String)>
	//   11   20:pop             
		return stringbuilder.toString();
	//   12   21:aload_1         
	//   13   22:invokevirtual   #302 <Method String StringBuilder.toString()>
	//   14   25:areturn         
	}
	...
	//    3    8:aload_0         
	//    4    9:invokestatic    #303 <Method Bundle android.app.RemoteInput.getResultsFromIntent(Intent)>
	//    5   12:areturn         
		if(android.os.Build.VERSION.SDK_INT >= 16)
	...
	//   19   38:invokevirtual   #307 <Method android.os.Parcelable Bundle.getParcelable(String)>
	...
	//    9   19:ifne            43
	//   10   22:aload_0         
	//   11   23:invokevirtual   #312 <Method Set getAllowedDataTypes()>
	//   12   26:ifnull          43
	//   13   29:aload_0         
	//   14   30:invokevirtual   #312 <Method Set getAllowedDataTypes()>
	//   15   33:invokeinterface #313 <Method boolean Set.isEmpty()>
	//   16   38:ifne            43
	//   17   41:iconst_1        
	//   18   42:ireturn         
	//   19   43:iconst_0        
