	...
	implements android.graphics.drawable.Drawable.Callback
{
	...
	//    3    5:invokevirtual   #48  <Method void copyBounds(Rect)>
		canvas.save();
	//    4    8:aload_1         
	//    5    9:invokevirtual   #54  <Method int Canvas.save()>
	//    6   12:pop             
		int i = ViewCompat.getLayoutDirection(mActivity.getWindow().getDecorView());
	//    7   13:aload_0         
	//    8   14:getfield        #22  <Field ActionBarDrawerToggle this$0>
	//    9   17:getfield        #58  <Field Activity ActionBarDrawerToggle.mActivity>
	//   10   20:invokevirtual   #64  <Method Window Activity.getWindow()>
	//   11   23:invokevirtual   #70  <Method android.view.View Window.getDecorView()>
	//   12   26:invokestatic    #76  <Method int ViewCompat.getLayoutDirection(android.view.View)>
	//   13   29:istore          4
		int j = 1;
	//   14   31:iconst_1        
	//   15   32:istore          5
	...
	//   30   61:invokevirtual   #79  <Method int Rect.width()>
	//   31   64:istore          6
		float f = -mOffset;
	//   32   66:aload_0         
	//   33   67:getfield        #81  <Field float mOffset>
	//   34   70:fneg            
	//   35   71:fstore_2        
		float f1 = k;
	//   36   72:iload           6
	...
	//   42   79:fmul            
	//   43   80:aload_0         
	//   44   81:getfield        #83  <Field float mPosition>
	//   45   84:fmul            
	//   46   85:iload           5
	//   47   87:i2f             
	//   48   88:fmul            
	//   49   89:fconst_0        
	//   50   90:invokevirtual   #87  <Method void Canvas.translate(float, float)>
	...
	//   57  106:fload_3         
	//   58  107:fconst_0        
	//   59  108:invokevirtual   #87  <Method void Canvas.translate(float, float)>
			canvas.scale(-1F, 1.0F);
	//   60  111:aload_1         
	//   61  112:ldc1            #88  <Float -1F>
	//   62  114:fconst_1        
	//   63  115:invokevirtual   #91  <Method void Canvas.scale(float, float)>
		}
		super.draw(canvas);
	//   64  118:aload_0         
	//   65  119:aload_1         
	//   66  120:invokespecial   #93  <Method void InsetDrawable.draw(Canvas)>
		canvas.restore();
	//   67  123:aload_1         
	//   68  124:invokevirtual   #96  <Method void Canvas.restore()>
	//   69  127:return          
	}
