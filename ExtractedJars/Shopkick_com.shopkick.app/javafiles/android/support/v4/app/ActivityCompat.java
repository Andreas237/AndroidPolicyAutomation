...
public class ActivityCompat extends ContextCompat
{
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #26  <Method void ContextCompat()>
	//    2    4:return          
	}
	...
	//    3    8:aload_0         
	//    4    9:invokevirtual   #40  <Method void Activity.finishAffinity()>
			return;
	//    5   12:return          
		} else
		{
			activity.finish();
	//    6   13:aload_0         
	//    7   14:invokevirtual   #43  <Method void Activity.finish()>
			return;
	//    8   17:return          
		}
	}
	...
	//    3    8:aload_0         
	//    4    9:invokevirtual   #47  <Method void Activity.finishAfterTransition()>
			return;
	//    5   12:return          
		} else
		{
	...
	{
		return sDelegate;
	//    0    0:getstatic       #55  <Field ActivityCompat$PermissionCompatDelegate sDelegate>
	//    1    3:areturn         
	}
	...
	//    3    8:aload_0         
	//    4    9:invokevirtual   #62  <Method Uri Activity.getReferrer()>
	//    5   12:areturn         
		activity = ((Activity) (activity.getIntent()));
	//    6   13:aload_0         
	//    7   14:invokevirtual   #66  <Method Intent Activity.getIntent()>
	//    8   17:astore_0        
		Uri uri = (Uri)((Intent) (activity)).getParcelableExtra("android.intent.extra.REFERRER");
	//    9   18:aload_0         
	//   10   19:ldc1            #68  <String "android.intent.extra.REFERRER">
	//   11   21:invokevirtual   #74  <Method Parcelable Intent.getParcelableExtra(String)>
	//   12   24:checkcast       #76  <Class Uri>
	//   13   27:astore_1        
		if(uri != null)
	//*  14   28:aload_1         
	//*  15   29:ifnull          34
	...
	//   18   34:aload_0         
	//   19   35:ldc1            #78  <String "android.intent.extra.REFERRER_NAME">
	//   20   37:invokevirtual   #82  <Method String Intent.getStringExtra(String)>
	//   21   40:astore_0        
		if(activity != null)
	//*  22   41:aload_0         
	//*  23   42:ifnull          50
	...
	//   24   45:aload_0         
	//   25   46:invokestatic    #86  <Method Uri Uri.parse(String)>
	//   26   49:areturn         
		else
			return null;
	//   27   50:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #91  <Method void Activity.invalidateOptionsMenu()>
		return true;
	//    2    4:iconst_1        
	//    3    5:ireturn         
	}
	...
	//    3    8:aload_0         
	//    4    9:invokevirtual   #95  <Method void Activity.postponeEnterTransition()>
	//    5   12:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokestatic    #102 <Method DragAndDropPermissionsCompat DragAndDropPermissionsCompat.request(Activity, DragEvent)>
	//    3    5:areturn         
	}
	...
	//*   6   10:aload_1         
	//*   7   11:iload_2         
	//*   8   12:invokeinterface #111 <Method boolean ActivityCompat$PermissionCompatDelegate.requestPermissions(Activity, String[], int)>
	//*   9   17:ifeq            21
			return;
	//   10   20:return          
		if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  11   21:getstatic       #36  <Field int android.os.Build$VERSION.SDK_INT>
	//*  12   24:bipush          23
	//*  13   26:icmplt          53
		{
	...
	//   19   40:iload_2         
	//   20   41:invokeinterface #115 <Method void ActivityCompat$RequestPermissionsRequestCodeValidator.validateRequestPermissionsRequestCode(int)>
			activity.requestPermissions(as, i);
	//   21   46:aload_0         
	//   22   47:aload_1         
	//   23   48:iload_2         
	//   24   49:invokevirtual   #118 <Method void Activity.requestPermissions(String[], int)>
			return;
	//   25   52:return          
		}
	...
	//   29   60:new             #120 <Class Handler>
	//   30   63:dup             
	//   31   64:invokestatic    #126 <Method Looper Looper.getMainLooper()>
	//   32   67:invokespecial   #129 <Method void Handler(Looper)>
	//   33   70:new             #6   <Class ActivityCompat$1>
	//   34   73:dup             
	//   35   74:aload_1         
	//   36   75:aload_0         
	//   37   76:iload_2         
	//   38   77:invokespecial   #132 <Method void ActivityCompat$1(String[], Activity, int)>
	//   39   80:invokevirtual   #136 <Method boolean Handler.post(Runnable)>
	//   40   83:pop             
	//   41   84:return          
	}
	...
	//    3    8:aload_0         
	//    4    9:iload_1         
	//    5   10:invokevirtual   #142 <Method View Activity.requireViewById(int)>
	//    6   13:areturn         
		activity = ((Activity) (activity.findViewById(i)));
	//    7   14:aload_0         
	//    8   15:iload_1         
	//    9   16:invokevirtual   #145 <Method View Activity.findViewById(int)>
	//   10   19:astore_0        
		if(activity != null)
	//*  11   20:aload_0         
	//*  12   21:ifnull          26
	...
	//   15   26:new             #147 <Class IllegalArgumentException>
	//   16   29:dup             
	//   17   30:ldc1            #149 <String "ID does not reference a View inside this Activity">
	//   18   32:invokespecial   #152 <Method void IllegalArgumentException(String)>
	//   19   35:athrow          
	}
	...
	//    6   15:dup             
	//    7   16:aload_1         
	//    8   17:invokespecial   #159 <Method void ActivityCompat$SharedElementCallback21Impl(android.support.v4.app.SharedElementCallback)>
	//    9   20:astore_1        
			else
	//*  10   21:goto            26
	...
	//   13   26:aload_0         
	//   14   27:aload_1         
	//   15   28:invokevirtual   #162 <Method void Activity.setEnterSharedElementCallback(SharedElementCallback)>
		}
	//   16   31:return          
	}
	...
	//   13   26:aload_0         
	//   14   27:aload_1         
	//   15   28:invokevirtual   #165 <Method void Activity.setExitSharedElementCallback(SharedElementCallback)>
		}
	//   16   31:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:putstatic       #55  <Field ActivityCompat$PermissionCompatDelegate sDelegate>
	//    2    4:return          
	}
	...
	//    3    8:aload_0         
	//    4    9:aload_1         
	//    5   10:invokevirtual   #172 <Method boolean Activity.shouldShowRequestPermissionRationale(String)>
	//    6   13:ireturn         
		else
			return false;
	//    7   14:iconst_0        
	...
	//    5   10:iload_2         
	//    6   11:aload_3         
	//    7   12:invokevirtual   #177 <Method void Activity.startActivityForResult(Intent, int, Bundle)>
			return;
	//    8   15:return          
		} else
		{
	...
	//   10   17:aload_1         
	//   11   18:iload_2         
	//   12   19:invokevirtual   #180 <Method void Activity.startActivityForResult(Intent, int)>
			return;
	//   13   22:return          
		}
	}
	...
	//    9   16:iload           6
	//   10   18:aload           7
	//   11   20:invokevirtual   #187 <Method void Activity.startIntentSenderForResult(IntentSender, int, Intent, int, int, int, Bundle)>
			return;
	//   12   23:return          
		} else
		{
	...
	//   18   30:iload           5
	//   19   32:iload           6
	//   20   34:invokevirtual   #190 <Method void Activity.startIntentSenderForResult(IntentSender, int, Intent, int, int, int)>
			return;
	//   21   37:return          
		}
	}
	...
	//    3    8:aload_0         
	//    4    9:invokevirtual   #194 <Method void Activity.startPostponedEnterTransition()>
	//    5   12:return          
	}
