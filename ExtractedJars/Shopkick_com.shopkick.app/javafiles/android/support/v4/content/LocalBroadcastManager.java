...
public final class LocalBroadcastManager
{
	...
	//*   3    5:monitorenter    
		{
			if(mInstance == null)
	//*   4    6:getstatic       #77  <Field LocalBroadcastManager mInstance>
	//*   5    9:ifnonnull       26
				mInstance = new LocalBroadcastManager(context.getApplicationContext());
	//    6   12:new             #2   <Class LocalBroadcastManager>
	//    7   15:dup             
	//    8   16:aload_0         
	//    9   17:invokevirtual   #81  <Method Context Context.getApplicationContext()>
	//   10   20:invokespecial   #83  <Method void LocalBroadcastManager(Context)>
	//   11   23:putstatic       #77  <Field LocalBroadcastManager mInstance>
			context = ((Context) (mInstance));
	//   12   26:getstatic       #77  <Field LocalBroadcastManager mInstance>
	//   13   29:astore_0        
		}
	//   14   30:aload_1         
	//   15   31:monitorexit     
...
_L2:
	...
	//    7   13:invokevirtual   #90  <Method int ArrayList.size()>
	//    8   16:istore_1        
		if(i > 0)
	...
	//   19   35:aload           4
	//   20   37:invokevirtual   #94  <Method Object[] ArrayList.toArray(Object[])>
	//   21   40:pop             
		mPendingBroadcasts.clear();
	//   22   41:aload_0         
	//   23   42:getfield        #59  <Field ArrayList mPendingBroadcasts>
	//   24   45:invokevirtual   #97  <Method void ArrayList.clear()>
		obj;
	//   25   48:aload           5
		JVM INSTR monitorexit ;
	//   26   50:monitorexit     
	...
	//   37   66:aload           5
	//   38   68:getfield        #100 <Field ArrayList LocalBroadcastManager$BroadcastRecord.receivers>
	//   39   71:invokevirtual   #90  <Method int ArrayList.size()>
	//   40   74:istore_3        
			for(int k = 0; k < l; k++)
	//*  41   75:iconst_0        
	//*  42   76:istore_2        
	...
	//   46   82:aload           5
	//   47   84:getfield        #100 <Field ArrayList LocalBroadcastManager$BroadcastRecord.receivers>
	//   48   87:iload_2         
	//   49   88:invokevirtual   #104 <Method Object ArrayList.get(int)>
	//   50   91:checkcast       #11  <Class LocalBroadcastManager$ReceiverRecord>
	//   51   94:astore          6
				if(!receiverrecord.dead)
	//*  52   96:aload           6
	//*  53   98:getfield        #107 <Field boolean LocalBroadcastManager$ReceiverRecord.dead>
	//*  54  101:ifne            121
					receiverrecord.receiver.onReceive(mAppContext, ((BroadcastRecord) (obj)).intent);
	//   55  104:aload           6
	//   56  106:getfield        #111 <Field BroadcastReceiver LocalBroadcastManager$ReceiverRecord.receiver>
	//   57  109:aload_0         
	//   58  110:getfield        #61  <Field Context mAppContext>
	//   59  113:aload           5
	//   60  115:getfield        #115 <Field Intent LocalBroadcastManager$BroadcastRecord.intent>
	//   61  118:invokevirtual   #121 <Method void BroadcastReceiver.onReceive(Context, Intent)>
			}
...
_L1:
	...
	//    7   13:aload_2         
	//    8   14:aload_1         
	//    9   15:invokespecial   #126 <Method void LocalBroadcastManager$ReceiverRecord(IntentFilter, BroadcastReceiver)>
	//   10   18:astore          7
		obj = ((Object) ((ArrayList)mReceivers.get(((Object) (broadcastreceiver)))));
	//   11   20:aload_0         
	//   12   21:getfield        #52  <Field HashMap mReceivers>
	//   13   24:aload_1         
	//   14   25:invokevirtual   #129 <Method Object HashMap.get(Object)>
	...
	//   22   45:dup             
	//   23   46:iconst_1        
	//   24   47:invokespecial   #132 <Method void ArrayList(int)>
	//   25   50:astore          4
	...
	//   28   56:aload_1         
	//   29   57:aload           4
	//   30   59:invokevirtual   #136 <Method Object HashMap.put(Object, Object)>
	//   31   62:pop             
		arraylist.add(((Object) (receiverrecord)));
	//   32   63:aload           4
	//   33   65:aload           7
	//   34   67:invokevirtual   #140 <Method boolean ArrayList.add(Object)>
	//   35   70:pop             
		int i = 0;
	//   36   71:iconst_0        
	//   37   72:istore_3        
_L2:
	...
	//   38   73:iload_3         
	//   39   74:aload_2         
	//   40   75:invokevirtual   #145 <Method int IntentFilter.countActions()>
	//   41   78:icmpge          144
		obj = ((Object) (intentfilter.getAction(i)));
	//   42   81:aload_2         
	//   43   82:iload_3         
	//   44   83:invokevirtual   #149 <Method String IntentFilter.getAction(int)>
	//   45   86:astore          5
		arraylist = (ArrayList)mActions.get(obj);
	//   46   88:aload_0         
	//   47   89:getfield        #54  <Field HashMap mActions>
	//   48   92:aload           5
	//   49   94:invokevirtual   #129 <Method Object HashMap.get(Object)>
	...
	//   57  113:dup             
	//   58  114:iconst_1        
	//   59  115:invokespecial   #132 <Method void ArrayList(int)>
	//   60  118:astore_1        
	...
	//   63  123:aload           5
	//   64  125:aload_1         
	//   65  126:invokevirtual   #136 <Method Object HashMap.put(Object, Object)>
	//   66  129:pop             
		((ArrayList) (broadcastreceiver)).add(((Object) (receiverrecord)));
	//   67  130:aload_1         
	//   68  131:aload           7
	//   69  133:invokevirtual   #140 <Method boolean ArrayList.add(Object)>
	//   70  136:pop             
		i++;
	//   71  137:iload_3         
	//   72  138:iconst_1        
...
_L1:
	...
	//    4    8:monitorenter    
		...
		s = intent.getAction();
	//    5    9:aload_1         
	//    6   10:invokevirtual   #156 <Method String Intent.getAction()>
	//    7   13:astore          8
		s1 = intent.resolveTypeIfNeeded(mAppContext.getContentResolver());
	//    8   15:aload_1         
	//    9   16:aload_0         
	//   10   17:getfield        #61  <Field Context mAppContext>
	//   11   20:invokevirtual   #160 <Method android.content.ContentResolver Context.getContentResolver()>
	//   12   23:invokevirtual   #164 <Method String Intent.resolveTypeIfNeeded(android.content.ContentResolver)>
	//   13   26:astore          9
		uri = intent.getData();
	//   14   28:aload_1         
	//   15   29:invokevirtual   #168 <Method android.net.Uri Intent.getData()>
	//   16   32:astore          11
		s2 = intent.getScheme();
	//   17   34:aload_1         
	//   18   35:invokevirtual   #171 <Method String Intent.getScheme()>
	//   19   38:astore          12
		set = intent.getCategories();
	//   20   40:aload_1         
	//   21   41:invokevirtual   #175 <Method java.util.Set Intent.getCategories()>
	//   22   44:astore          13
		int i;
		int j;
		int k;
	...
	//*  23   46:aload_1         
	//*  24   47:invokevirtual   #178 <Method int Intent.getFlags()>
	//*  25   50:bipush          8
	//*  26   52:iand            
	//*  27   53:ifeq            516
			i = 1;
	...
	//*  31   61:iload_2         
	//*  32   62:ifeq            132
	//*  33   65:new             #180 <Class StringBuilder>
	//*  34   68:dup             
	//*  35   69:invokespecial   #181 <Method void StringBuilder()>
	//*  36   72:astore          5
	//*  37   74:aload           5
	//*  38   76:ldc1            #183 <String "Resolving type ">
	//*  39   78:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//*  40   81:pop             
	//*  41   82:aload           5
	//*  42   84:aload           9
	//*  43   86:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//*  44   89:pop             
	//*  45   90:aload           5
	//*  46   92:ldc1            #189 <String " scheme ">
	//*  47   94:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//*  48   97:pop             
	//*  49   98:aload           5
	//*  50  100:aload           12
	//*  51  102:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//*  52  105:pop             
	//*  53  106:aload           5
	//*  54  108:ldc1            #191 <String " of intent ">
	//*  55  110:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//*  56  113:pop             
	//*  57  114:aload           5
	//*  58  116:aload_1         
	//*  59  117:invokevirtual   #194 <Method StringBuilder StringBuilder.append(Object)>
	//*  60  120:pop             
	//*  61  121:ldc1            #22  <String "LocalBroadcastManager">
	//*  62  123:aload           5
	//*  63  125:invokevirtual   #197 <Method String StringBuilder.toString()>
	//*  64  128:invokestatic    #203 <Method int Log.v(String, String)>
	//*  65  131:pop             
	//*  66  132:aload_0         
	//*  67  133:getfield        #54  <Field HashMap mActions>
	//*  68  136:aload_1         
	//*  69  137:invokevirtual   #156 <Method String Intent.getAction()>
	//*  70  140:invokevirtual   #129 <Method Object HashMap.get(Object)>
	...
	//*  75  153:iload_2         
	//*  76  154:ifeq            521
	//*  77  157:new             #180 <Class StringBuilder>
	//*  78  160:dup             
	//*  79  161:invokespecial   #181 <Method void StringBuilder()>
	//*  80  164:astore          5
	//*  81  166:aload           5
	//*  82  168:ldc1            #205 <String "Action list: ">
	//*  83  170:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//*  84  173:pop             
	//*  85  174:aload           5
	//*  86  176:aload           7
	//*  87  178:invokevirtual   #194 <Method StringBuilder StringBuilder.append(Object)>
	//*  88  181:pop             
	//*  89  182:ldc1            #22  <String "LocalBroadcastManager">
	//*  90  184:aload           5
	//*  91  186:invokevirtual   #197 <Method String StringBuilder.toString()>
	//*  92  189:invokestatic    #203 <Method int Log.v(String, String)>
	//*  93  192:pop             
	//*  94  193:goto            521
	//*  95  196:iload_3         
	//*  96  197:aload           7
	//*  97  199:invokevirtual   #90  <Method int ArrayList.size()>
	//*  98  202:icmpge          618
	//*  99  205:aload           7
	//* 100  207:iload_3         
	//* 101  208:invokevirtual   #104 <Method Object ArrayList.get(int)>
	//* 102  211:checkcast       #11  <Class LocalBroadcastManager$ReceiverRecord>
	//* 103  214:astore          14
	//* 104  216:iload_2         
	//* 105  217:ifeq            259
	//* 106  220:new             #180 <Class StringBuilder>
	//* 107  223:dup             
	//* 108  224:invokespecial   #181 <Method void StringBuilder()>
	//* 109  227:astore          5
	//* 110  229:aload           5
	//* 111  231:ldc1            #207 <String "Matching against filter ">
	//* 112  233:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//* 113  236:pop             
	//* 114  237:aload           5
	//* 115  239:aload           14
	//* 116  241:getfield        #211 <Field IntentFilter LocalBroadcastManager$ReceiverRecord.filter>
	//* 117  244:invokevirtual   #194 <Method StringBuilder StringBuilder.append(Object)>
	//* 118  247:pop             
	//* 119  248:ldc1            #22  <String "LocalBroadcastManager">
	//* 120  250:aload           5
	//* 121  252:invokevirtual   #197 <Method String StringBuilder.toString()>
	//* 122  255:invokestatic    #203 <Method int Log.v(String, String)>
	//* 123  258:pop             
	//* 124  259:aload           14
	//* 125  261:getfield        #214 <Field boolean LocalBroadcastManager$ReceiverRecord.broadcasting>
	//* 126  264:ifeq            282
	//* 127  267:iload_2         
	//* 128  268:ifeq            529
	//* 129  271:ldc1            #22  <String "LocalBroadcastManager">
	//* 130  273:ldc1            #216 <String "  Filter's target already added">
	//* 131  275:invokestatic    #203 <Method int Log.v(String, String)>
	//* 132  278:pop             
	//* 133  279:goto            611
	//* 134  282:aload           14
	//* 135  284:getfield        #211 <Field IntentFilter LocalBroadcastManager$ReceiverRecord.filter>
	//* 136  287:astore          15
	//* 137  289:aload           6
	//* 138  291:astore          5
	//* 139  293:aload           15
	...
	//* 146  307:invokevirtual   #220 <Method int IntentFilter.match(String, String, String, android.net.Uri, java.util.Set, String)>
	//* 147  310:istore          4
	//* 148  312:iload           4
	//* 149  314:iflt            539
	//* 150  317:iload_2         
	//* 151  318:ifeq            360
	//* 152  321:new             #180 <Class StringBuilder>
	//* 153  324:dup             
	//* 154  325:invokespecial   #181 <Method void StringBuilder()>
	//* 155  328:astore          6
	//* 156  330:aload           6
	//* 157  332:ldc1            #222 <String "  Filter matched!  match=0x">
	//* 158  334:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//* 159  337:pop             
	//* 160  338:aload           6
	//* 161  340:iload           4
	//* 162  342:invokestatic    #227 <Method String Integer.toHexString(int)>
	//* 163  345:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//* 164  348:pop             
	//* 165  349:ldc1            #22  <String "LocalBroadcastManager">
	//* 166  351:aload           6
	//* 167  353:invokevirtual   #197 <Method String StringBuilder.toString()>
	//* 168  356:invokestatic    #203 <Method int Log.v(String, String)>
	//* 169  359:pop             
	//* 170  360:aload           5
	...
	//* 177  377:aload           6
	//* 178  379:aload           14
	//* 179  381:invokevirtual   #140 <Method boolean ArrayList.add(Object)>
	//* 180  384:pop             
	//* 181  385:aload           14
	//* 182  387:iconst_1        
	//* 183  388:putfield        #214 <Field boolean LocalBroadcastManager$ReceiverRecord.broadcasting>
	//* 184  391:goto            611
	//* 185  394:new             #180 <Class StringBuilder>
	//* 186  397:dup             
	//* 187  398:invokespecial   #181 <Method void StringBuilder()>
	//* 188  401:astore          14
	//* 189  403:aload           14
	//* 190  405:ldc1            #229 <String "  Filter did not match: ">
	//* 191  407:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//* 192  410:pop             
	//* 193  411:aload           14
	//* 194  413:aload           5
	//* 195  415:invokevirtual   #187 <Method StringBuilder StringBuilder.append(String)>
	//* 196  418:pop             
	//* 197  419:ldc1            #22  <String "LocalBroadcastManager">
	//* 198  421:aload           14
	//* 199  423:invokevirtual   #197 <Method String StringBuilder.toString()>
	//* 200  426:invokestatic    #203 <Method int Log.v(String, String)>
	//* 201  429:pop             
	//* 202  430:goto            611
	//* 203  433:iload_2         
	//* 204  434:aload           6
	//* 205  436:invokevirtual   #90  <Method int ArrayList.size()>
	//* 206  439:icmpge          462
	//* 207  442:aload           6
	//* 208  444:iload_2         
	//* 209  445:invokevirtual   #104 <Method Object ArrayList.get(int)>
	//* 210  448:checkcast       #11  <Class LocalBroadcastManager$ReceiverRecord>
	//* 211  451:iconst_0        
	//* 212  452:putfield        #214 <Field boolean LocalBroadcastManager$ReceiverRecord.broadcasting>
	//* 213  455:iload_2         
	//* 214  456:iconst_1        
	//* 215  457:iadd            
	//* 216  458:istore_2        
	...
	//* 222  470:aload_1         
	//* 223  471:aload           6
	//* 224  473:invokespecial   #232 <Method void LocalBroadcastManager$BroadcastRecord(Intent, ArrayList)>
	//* 225  476:invokevirtual   #140 <Method boolean ArrayList.add(Object)>
	//* 226  479:pop             
	//* 227  480:aload_0         
	//* 228  481:getfield        #72  <Field Handler mHandler>
	//* 229  484:iconst_1        
	//* 230  485:invokevirtual   #238 <Method boolean Handler.hasMessages(int)>
	//* 231  488:ifne            500
	//* 232  491:aload_0         
	//* 233  492:getfield        #72  <Field Handler mHandler>
	//* 234  495:iconst_1        
	//* 235  496:invokevirtual   #241 <Method boolean Handler.sendEmptyMessage(int)>
	//* 236  499:pop             
	//* 237  500:aload           10
	//* 238  502:monitorexit     
	//* 239  503:iconst_1        
...
_L19:
		obj = "unknown reason";
	//  266  576:ldc1            #243 <String "unknown reason">
	//  267  578:astore          5
		  goto _L25
	//* 268  580:goto            394
_L23:
		obj = "type";
	//  269  583:ldc1            #245 <String "type">
	//  270  585:astore          5
		  goto _L25
	//* 271  587:goto            394
_L22:
		obj = "data";
	//  272  590:ldc1            #247 <String "data">
	//  273  592:astore          5
		  goto _L25
	//* 274  594:goto            394
_L21:
		obj = "action";
	//  275  597:ldc1            #249 <String "action">
	//  276  599:astore          5
		  goto _L25
	//* 277  601:goto            394
_L20:
		obj = "category";
	//  278  604:ldc1            #251 <String "category">
	//  279  606:astore          5
		  goto _L25
	//* 280  608:goto            394
_L10:
...
_L70:
	...
	//*   0    0:aload_0         
	//*   1    1:aload_1         
	//*   2    2:invokevirtual   #255 <Method boolean sendBroadcast(Intent)>
	//*   3    5:ifeq            12
			executePendingBroadcasts();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #257 <Method void executePendingBroadcasts()>
	//    6   12:return          
	}
	...
	//    7   13:aload_1         
	//    8   14:invokevirtual   #262 <Method Object HashMap.remove(Object)>
	...
	//   16   31:aload           6
	//   17   33:invokevirtual   #90  <Method int ArrayList.size()>
	//   18   36:iconst_1        
	//   19   37:isub            
	//   20   38:istore_2        
_L12:
...
_L1:
	...
	//   23   43:aload           6
	//   24   45:iload_2         
	//   25   46:invokevirtual   #104 <Method Object ArrayList.get(int)>
	//   26   49:checkcast       #11  <Class LocalBroadcastManager$ReceiverRecord>
	//   27   52:astore          7
		receiverrecord.dead = true;
	//   28   54:aload           7
	//   29   56:iconst_1        
	//   30   57:putfield        #107 <Field boolean LocalBroadcastManager$ReceiverRecord.dead>
		int j = 0;
	//   31   60:iconst_0        
	//   32   61:istore_3        
_L10:
	...
	//   33   62:iload_3         
	//   34   63:aload           7
	//   35   65:getfield        #211 <Field IntentFilter LocalBroadcastManager$ReceiverRecord.filter>
	//   36   68:invokevirtual   #145 <Method int IntentFilter.countActions()>
	//   37   71:icmpge          203
		s = receiverrecord.filter.getAction(j);
	//   38   74:aload           7
	//   39   76:getfield        #211 <Field IntentFilter LocalBroadcastManager$ReceiverRecord.filter>
	//   40   79:iload_3         
	//   41   80:invokevirtual   #149 <Method String IntentFilter.getAction(int)>
	//   42   83:astore          8
		arraylist1 = (ArrayList)mActions.get(((Object) (s)));
	//   43   85:aload_0         
	//   44   86:getfield        #54  <Field HashMap mActions>
	//   45   89:aload           8
	//   46   91:invokevirtual   #129 <Method Object HashMap.get(Object)>
...
_L3:
	...
	//   51  104:aload           9
	//   52  106:invokevirtual   #90  <Method int ArrayList.size()>
	//   53  109:iconst_1        
	//   54  110:isub            
	//   55  111:istore          4
_L8:
...
_L5:
	...
	//   58  118:aload           9
	//   59  120:iload           4
	//   60  122:invokevirtual   #104 <Method Object ArrayList.get(int)>
	//   61  125:checkcast       #11  <Class LocalBroadcastManager$ReceiverRecord>
	//   62  128:astore          10
		if(receiverrecord1.receiver == broadcastreceiver)
	//*  63  130:aload           10
	//*  64  132:getfield        #111 <Field BroadcastReceiver LocalBroadcastManager$ReceiverRecord.receiver>
	//*  65  135:aload_1         
	...
	//   67  139:aload           10
	//   68  141:iconst_1        
	//   69  142:putfield        #107 <Field boolean LocalBroadcastManager$ReceiverRecord.dead>
			arraylist1.remove(k);
	//   70  145:aload           9
	//   71  147:iload           4
	//   72  149:invokevirtual   #264 <Method Object ArrayList.remove(int)>
	//   73  152:pop             
		}
		  goto _L7
	//*  74  153:goto            187
_L6:
	...
	//*  75  156:aload           9
	//*  76  158:invokevirtual   #90  <Method int ArrayList.size()>
	//*  77  161:ifgt            196
			mActions.remove(((Object) (s)));
	//   78  164:aload_0         
	//   79  165:getfield        #54  <Field HashMap mActions>
	//   80  168:aload           8
	//   81  170:invokevirtual   #262 <Method Object HashMap.remove(Object)>
	//   82  173:pop             
		break; /* Loop/switch isn't completed */
	//   83  174:goto            196
_L2:
