...
public final class PermissionChecker
{
	...
	//*   2    2:iload_2         
	//*   3    3:iload_3         
	//*   4    4:invokevirtual   #53  <Method int Context.checkPermission(String, int, int)>
	//*   5    7:iconst_m1       
	//*   6    8:icmpne          13
			return -1;
	//    7   11:iconst_m1       
	...
	//    9   13:aload_1         
	//   10   14:invokestatic    #59  <Method String AppOpsManagerCompat.permissionToOp(String)>
	//   11   17:astore          5
		if(s2 == null)
	//*  12   19:aload           5
	//*  13   21:ifnonnull       26
	...
	//   20   34:aload_0         
	//   21   35:invokevirtual   #63  <Method PackageManager Context.getPackageManager()>
	//   22   38:iload_3         
	//   23   39:invokevirtual   #69  <Method String[] PackageManager.getPackagesForUid(int)>
	//   24   42:astore_1        
			if(s != null)
	//*  25   43:aload_1         
	//*  26   44:ifnull          61
	...
	//   40   64:aload           5
	//   41   66:aload_1         
	//   42   67:invokestatic    #72  <Method int AppOpsManagerCompat.noteProxyOpNoThrow(Context, String, String)>
	//   43   70:ifeq            76
	//   44   73:bipush          -2
	//   45   75:ireturn         
	//   46   76:iconst_0        
	...
	//    3    5:invokestatic    #76  <Method int Process.myUid()>
	//    4    8:aload_0         
