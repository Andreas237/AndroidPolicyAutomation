...
abstract class ModernAsyncTask
{
	...
	//    1    3:aload_0         
	//    2    4:invokeinterface #119 <Method void Executor.execute(Runnable)>
	//    3    9:return          
	}
	...
	//    1    2:monitorenter    
		...
		if(sHandler == null)
	//*   2    3:getstatic       #123 <Field ModernAsyncTask$InternalHandler sHandler>
	//*   3    6:ifnonnull       19
			sHandler = new InternalHandler();
	//    4    9:new             #18  <Class ModernAsyncTask$InternalHandler>
	//    5   12:dup             
	//    6   13:invokespecial   #124 <Method void ModernAsyncTask$InternalHandler()>
	//    7   16:putstatic       #123 <Field ModernAsyncTask$InternalHandler sHandler>
		internalhandler = sHandler;
	//    8   19:getstatic       #123 <Field ModernAsyncTask$InternalHandler sHandler>
	//    9   22:astore_0        
		android/support/v4/content/ModernAsyncTask;
	...
	//    2    4:iconst_1        
	//    3    5:invokevirtual   #137 <Method void AtomicBoolean.set(boolean)>
		return mFuture.cancel(flag);
	//    4    8:aload_0         
	//    5    9:getfield        #113 <Field FutureTask mFuture>
	//    6   12:iload_1         
	//    7   13:invokevirtual   #141 <Method boolean FutureTask.cancel(boolean)>
	//    8   16:ireturn         
	}
	...
	//    2    4:aload_1         
	//    3    5:invokevirtual   #148 <Method ModernAsyncTask executeOnExecutor(Executor, Object[])>
	//    4    8:areturn         
	}
	...
	//*   4   10:getstatic       #154 <Field int[] ModernAsyncTask$4.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status>
	//*   5   13:aload_0         
	//*   6   14:getfield        #96  <Field ModernAsyncTask$Status mStatus>
	//*   7   17:invokevirtual   #158 <Method int ModernAsyncTask$Status.ordinal()>
	//*   8   20:iaload          
			{
	...
	//   10   44:new             #160 <Class IllegalStateException>
	//   11   47:dup             
	//   12   48:ldc1            #162 <String "We should never reach this state">
	//   13   50:invokespecial   #165 <Method void IllegalStateException(String)>
	//   14   53:athrow          

			case 2: // '\002'
				throw new IllegalStateException("Cannot execute task: the task has already been executed (a task can be executed only once)");
	//   15   54:new             #160 <Class IllegalStateException>
	//   16   57:dup             
	//   17   58:ldc1            #167 <String "Cannot execute task: the task has already been executed (a task can be executed only once)">
	//   18   60:invokespecial   #165 <Method void IllegalStateException(String)>
	//   19   63:athrow          

			case 1: // '\001'
				throw new IllegalStateException("Cannot execute task: the task is already running.");
	//   20   64:new             #160 <Class IllegalStateException>
	//   21   67:dup             
	//   22   68:ldc1            #169 <String "Cannot execute task: the task is already running.">
	//   23   70:invokespecial   #165 <Method void IllegalStateException(String)>
	//   24   73:athrow          
			}
		} else
		{
	...
	//   25   74:aload_0         
	//   26   75:getstatic       #172 <Field ModernAsyncTask$Status ModernAsyncTask$Status.RUNNING>
	//   27   78:putfield        #96  <Field ModernAsyncTask$Status mStatus>
			onPreExecute();
	//   28   81:aload_0         
	//   29   82:invokevirtual   #175 <Method void onPreExecute()>
			mWorker.mParams = aobj;
	//   30   85:aload_0         
	//   31   86:getfield        #108 <Field ModernAsyncTask$WorkerRunnable mWorker>
	//   32   89:aload_2         
	//   33   90:putfield        #179 <Field Object[] ModernAsyncTask$WorkerRunnable.mParams>
			executor.execute(((Runnable) (mFuture)));
	//   34   93:aload_1         
	//   35   94:aload_0         
	//   36   95:getfield        #113 <Field FutureTask mFuture>
	//   37   98:invokeinterface #119 <Method void Executor.execute(Runnable)>
			return this;
	//   38  103:aload_0         
	//   39  104:areturn         
		}
	...
	void finish(Object obj)
	{
		if(isCancelled())
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #186 <Method boolean isCancelled()>
	//*   2    4:ifeq            15
			onCancelled(obj);
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:invokevirtual   #189 <Method void onCancelled(Object)>
		else
	//*   6   12:goto            20
			onPostExecute(obj);
	//    7   15:aload_0         
	//    8   16:aload_1         
	//    9   17:invokevirtual   #192 <Method void onPostExecute(Object)>
		mStatus = Status.FINISHED;
	//   10   20:aload_0         
	//   11   21:getstatic       #195 <Field ModernAsyncTask$Status ModernAsyncTask$Status.FINISHED>
	...
	//    2    4:invokevirtual   #204 <Method Object FutureTask.get()>
	//    3    7:areturn         
	}
	...
	//    2    4:lload_1         
	//    3    5:aload_3         
	//    4    6:invokevirtual   #211 <Method Object FutureTask.get(long, TimeUnit)>
	//    5    9:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #101 <Field AtomicBoolean mCancelled>
	//    2    4:invokevirtual   #216 <Method boolean AtomicBoolean.get()>
	//    3    7:ireturn         
	}
	...
	protected void onCancelled(Object obj)
	{
		onCancelled();
	//    0    0:aload_0         
	//    1    1:invokevirtual   #218 <Method void onCancelled()>
	//    2    4:return          
	}
	...
	//    0    0:invokestatic    #225 <Method Handler getHandler()>
	//    1    3:iconst_1        
	...
	//    9   15:aload_1         
	//   10   16:aastore         
	//   11   17:invokespecial   #228 <Method void ModernAsyncTask$AsyncTaskResult(ModernAsyncTask, Object[])>
	//   12   20:invokevirtual   #234 <Method Message Handler.obtainMessage(int, Object)>
	//   13   23:invokevirtual   #239 <Method void Message.sendToTarget()>
		return obj;
	//   14   26:aload_1         
	//   15   27:areturn         
	}
	...
	//    4   10:aload_0         
	//    5   11:aload_1         
	//    6   12:invokevirtual   #243 <Method Object postResult(Object)>
	//    7   15:pop             
	//    8   16:return          
	}
	...
	//    3    7:invokestatic    #225 <Method Handler getHandler()>
	//    4   10:iconst_2        
	//    5   11:new             #15  <Class ModernAsyncTask$AsyncTaskResult>
	//    6   14:dup             
	//    7   15:aload_0         
	//    8   16:aload_1         
	//    9   17:invokespecial   #228 <Method void ModernAsyncTask$AsyncTaskResult(ModernAsyncTask, Object[])>
	//   10   20:invokevirtual   #234 <Method Message Handler.obtainMessage(int, Object)>
	//   11   23:invokevirtual   #239 <Method void Message.sendToTarget()>
	//   12   26:return          
	}
