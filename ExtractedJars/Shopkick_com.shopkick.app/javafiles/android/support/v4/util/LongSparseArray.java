	...
	implements Cloneable
{
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:invokevirtual   #91  <Method int indexOfKey(long)>
	//    3    5:iflt            10
	//    4    8:iconst_1        
	//    5    9:ireturn         
	//    6   10:iconst_0        
	...
	//    4    8:lload_1         
	//    5    9:invokestatic    #104 <Method int ContainerHelpers.binarySearch(long[], int, long)>
	//    6   12:istore_3        
		if(i >= 0)
	//*   7   13:iload_3         
	//*   8   14:iflt            52
	...
	//    1    1:lload_1         
	//    2    2:aconst_null     
	//    3    3:invokevirtual   #110 <Method Object get(long, Object)>
	//    4    6:areturn         
	}
	...
	//    9   19:lload_1         
	//   10   20:invokestatic    #104 <Method int ContainerHelpers.binarySearch(long[], int, long)>
	//   11   23:ireturn         
	}
	...
	public boolean isEmpty()
	{
		return size() == 0;
	//    0    0:aload_0         
	//    1    1:invokevirtual   #120 <Method int size()>
	//    2    4:ifne            9
	//    3    7:iconst_1        
	//    4    8:ireturn         
	//    5    9:iconst_0        
	...
	//   58  112:lload_1         
	//   59  113:invokestatic    #104 <Method int ContainerHelpers.binarySearch(long[], int, long)>
	//   60  116:istore          4
			}
		}
		j = mSize;
	...
	//    9   13:aload_1         
	//   10   14:iload_2         
	//   11   15:invokevirtual   #127 <Method long keyAt(int)>
	//   12   18:aload_1         
	//   13   19:iload_2         
	//   14   20:invokevirtual   #131 <Method Object valueAt(int)>
	//   15   23:invokevirtual   #54  <Method void put(long, Object)>
	...
	//    0    0:aload_0         
	//    1    1:lload_1         
	//    2    2:invokevirtual   #136 <Method void delete(long)>
	//    3    5:return          
	}
	...
	//    5   10:new             #146 <Class StringBuilder>
	//    6   13:dup             
	//    7   14:aload_0         
	//    8   15:getfield        #48  <Field int mSize>
	//    9   18:bipush          28
	//   10   20:imul            
	//   11   21:invokespecial   #147 <Method void StringBuilder(int)>
	//   12   24:astore_2        
		stringbuilder.append('{');
	//   13   25:aload_2         
	//   14   26:bipush          123
	//   15   28:invokevirtual   #150 <Method StringBuilder StringBuilder.append(char)>
	//   16   31:pop             
		for(int i = 0; i < mSize; i++)
	//*  17   32:iconst_0        
	//*  18   33:istore_1        
	...
	//*  24   43:ifle            53
				stringbuilder.append(", ");
	//   25   46:aload_2         
	//   26   47:ldc1            #152 <String ", ">
	//   27   49:invokevirtual   #155 <Method StringBuilder StringBuilder.append(String)>
	//   28   52:pop             
			stringbuilder.append(keyAt(i));
	//   29   53:aload_2         
	//   30   54:aload_0         
	//   31   55:iload_1         
	//   32   56:invokevirtual   #127 <Method long keyAt(int)>
	//   33   59:invokevirtual   #158 <Method StringBuilder StringBuilder.append(long)>
	//   34   62:pop             
			stringbuilder.append('=');
	//   35   63:aload_2         
	//   36   64:bipush          61
	//   37   66:invokevirtual   #150 <Method StringBuilder StringBuilder.append(char)>
	//   38   69:pop             
	...
	//   46   81:aload_2         
	//   47   82:aload_3         
	//   48   83:invokevirtual   #161 <Method StringBuilder StringBuilder.append(Object)>
	//   49   86:pop             
			else
	//*  50   87:goto            97
				stringbuilder.append("(this Map)");
	//   51   90:aload_2         
	//   52   91:ldc1            #163 <String "(this Map)">
	//   53   93:invokevirtual   #155 <Method StringBuilder StringBuilder.append(String)>
	//   54   96:pop             
		}
	...
	//   60  104:aload_2         
	//   61  105:bipush          125
	//   62  107:invokevirtual   #150 <Method StringBuilder StringBuilder.append(char)>
	//   63  110:pop             
		return stringbuilder.toString();
	//   64  111:aload_2         
	//   65  112:invokevirtual   #165 <Method String StringBuilder.toString()>
	//   66  115:areturn         
	}
