	...
	implements android.os.ner
{
	...
	PrintHelper$PrintUriAdapter$1$1()
	{
	...
	// Unreferenced inner class android/support/v4/print/PrintHelper$PrintUriAdapter$1

/* anonymous class */
	class PrintHelper.PrintUriAdapter._cls1 extends AsyncTask
	{
		...
		{
			cancellationSignal.setOnCancelListener(((android.os.CancellationSignal.OnCancelListener) (new PrintHelper.PrintUriAdapter._cls1._cls1())));
		//    0    0:aload_0         
