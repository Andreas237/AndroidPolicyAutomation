...
public final class DrawableCompat
{
	...
	//   37   79:invokevirtual   #117 <Method Object Method.invoke(Object, Object[])>
	//   38   82:checkcast       #119 <Class Integer>
	//   39   85:invokevirtual   #122 <Method int Integer.intValue()>
	//   40   88:istore_1        
		return i;
	//   41   89:iload_1         
	//   42   90:ireturn         
	...
	//   44   92:ldc1            #8   <String "DrawableCompat">
	//   45   94:ldc1            #124 <String "Failed to invoke getLayoutDirection() via reflection">
	//   46   96:aload_0         
	//   47   97:invokestatic    #113 <Method int Log.i(String, String, Throwable)>
	//   48  100:pop             
		sGetLayoutDirectionMethod = null;
	//   49  101:aconst_null     
	//   50  102:putstatic       #99  <Field Method sGetLayoutDirectionMethod>
		return 0;
	//   51  105:iconst_0        
	//   52  106:ireturn         
		return 0;
	...
	//   43   87:iconst_0        
	//   44   88:iload_1         
	//   45   89:invokestatic    #180 <Method Integer Integer.valueOf(int)>
	//   46   92:aastore         
	//   47   93:invokevirtual   #117 <Method Object Method.invoke(Object, Object[])>
	//   48   96:pop             
		return true;
	//   49   97:iconst_1        
	//   50   98:ireturn         
	...
	//   52  100:ldc1            #8   <String "DrawableCompat">
	//   53  102:ldc1            #182 <String "Failed to invoke setLayoutDirection(int) via reflection">
	//   54  104:aload_0         
	//   55  105:invokestatic    #113 <Method int Log.i(String, String, Throwable)>
	//   56  108:pop             
		sSetLayoutDirectionMethod = null;
	//   57  109:aconst_null     
	//   58  110:putstatic       #174 <Field Method sSetLayoutDirectionMethod>
		return false;
	//   59  113:iconst_0        
	//   60  114:ireturn         
		return false;
	...
	//   17   35:areturn         
		if(!(drawable instanceof TintAwareDrawable))
	//*  18   36:aload_0         
	//*  19   37:instanceof      #190 <Class TintAwareDrawable>
	//*  20   40:ifne            52
			return ((Drawable) (new WrappedDrawableApi14(drawable)));
	//   21   43:new             #214 <Class WrappedDrawableApi14>
	//   22   46:dup             
	//   23   47:aload_0         
	//   24   48:invokespecial   #215 <Method void WrappedDrawableApi14(Drawable)>
	//   25   51:areturn         
		else
			return drawable;
	//   26   52:aload_0         
