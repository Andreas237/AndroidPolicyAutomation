...
label0:
	...
	//*  50   90:astore_1        
	//*  51   91:aload           5
	//*  52   93:invokevirtual   #132 <Method void FileInputStream.close()>
	//*  53   96:aload_3         
	//*  54   97:ifnull          104
	//*  55  100:aload_3         
	//*  56  101:invokevirtual   #118 <Method void ParcelFileDescriptor.close()>
	//*  57  104:aload_1         
	//*  58  105:areturn         
	//*  59  106:astore_1        
	//*  60  107:aconst_null     
	...
	//*  68  117:ifnull          139
	//*  69  120:aload           5
	//*  70  122:invokevirtual   #132 <Method void FileInputStream.close()>
	//*  71  125:goto            144
	//*  72  128:astore          5
	//*  73  130:aload_2         
	//*  74  131:aload           5
	//*  75  133:invokevirtual   #136 <Method void Throwable.addSuppressed(Throwable)>
	//*  76  136:goto            144
	//*  77  139:aload           5
	//*  78  141:invokevirtual   #132 <Method void FileInputStream.close()>
	//*  79  144:aload_1         
	//*  80  145:athrow          
	//*  81  146:astore_1        
	//*  82  147:aconst_null     
	...
	//*  92  161:ifnull          180
	//*  93  164:aload_3         
	//*  94  165:invokevirtual   #118 <Method void ParcelFileDescriptor.close()>
	//*  95  168:goto            184
	//*  96  171:astore_3        
	//*  97  172:aload_2         
	//*  98  173:aload_3         
	//*  99  174:invokevirtual   #136 <Method void Throwable.addSuppressed(Throwable)>
	//* 100  177:goto            184
	//* 101  180:aload_3         
	//* 102  181:invokevirtual   #118 <Method void ParcelFileDescriptor.close()>
	//* 103  184:aload_1         
	//* 104  185:athrow          
		// Misplaced declaration of an exception variable
