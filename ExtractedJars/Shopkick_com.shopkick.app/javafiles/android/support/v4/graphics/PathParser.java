...
_L23:
	...
	//*  20   28:iload_2         
	//*  21   29:aaload          
	//*  22   30:getfield        #42  <Field char PathParser$PathDataNode.mType>
	//*  23   33:aload_1         
	//*  24   34:iload_2         
	//*  25   35:aaload          
	//*  26   36:getfield        #42  <Field char PathParser$PathDataNode.mType>
	//*  27   39:icmpne          68
				{
	...
	//*  29   43:iload_2         
	//*  30   44:aaload          
	//*  31   45:getfield        #46  <Field float[] PathParser$PathDataNode.mParams>
	//*  32   48:arraylength     
	//*  33   49:aload_1         
	//*  34   50:iload_2         
	//*  35   51:aaload          
	//*  36   52:getfield        #46  <Field float[] PathParser$PathDataNode.mParams>
	//*  37   55:arraylength     
	//*  38   56:icmpeq          61
						return false;
	//   39   59:iconst_0        
	...
	//   17   23:iload_1         
	//   18   24:isub            
	//   19   25:invokestatic    #54  <Method int Math.min(int, int)>
	//   20   28:istore_3        
	...
	//   27   38:iconst_0        
	//   28   39:iload_3         
	//   29   40:invokestatic    #60  <Method void System.arraycopy(Object, int, Object, int, int)>
				return af1;
	//   30   43:aload           4
	//   31   45:areturn         
			} else
	...
	//   32   46:new             #62  <Class ArrayIndexOutOfBoundsException>
	//   33   49:dup             
	//   34   50:invokespecial   #63  <Method void ArrayIndexOutOfBoundsException()>
	//   35   53:athrow          
			}
		} else
		{
			throw new IllegalArgumentException();
	//   36   54:new             #65  <Class IllegalArgumentException>
	//   37   57:dup             
	//   38   58:invokespecial   #66  <Method void IllegalArgumentException()>
	//   39   61:athrow          
		}
	}
	...
	//    5    9:dup             
	//    6   10:invokespecial   #69  <Method void ArrayList()>
	//    7   13:astore_3        
		int j = 1;
	//    8   14:iconst_1        
	//    9   15:istore_2        
	...
	//*  14   24:astore_1        
			{
				StringBuilder stringbuilder = new StringBuilder();
	//   15   25:new             #121 <Class StringBuilder>
	//   16   28:dup             
	//   17   29:invokespecial   #122 <Method void StringBuilder()>
	//   18   32:astore_2        
				stringbuilder.append("Error in parsing ");
	//   19   33:aload_2         
	//   20   34:ldc1            #124 <String "Error in parsing ">
	//   21   36:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   22   39:pop             
				stringbuilder.append(s);
	//   23   40:aload_2         
	//   24   41:aload_0         
	//   25   42:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   26   45:pop             
				throw new RuntimeException(stringbuilder.toString(), ((Throwable) (runtimeexception)));
	//   27   46:new             #110 <Class RuntimeException>
	//   28   49:dup             
	//   29   50:aload_2         
	//   30   51:invokevirtual   #131 <Method String StringBuilder.toString()>
	//   31   54:aload_1         
	//   32   55:invokespecial   #134 <Method void RuntimeException(String, Throwable)>
	//   33   58:athrow          
			}
			return path;
		} else
	...
	//   19   27:iload_1         
	//   20   28:aaload          
	//   21   29:invokespecial   #139 <Method void PathParser$PathDataNode(PathParser$PathDataNode)>
	//   22   32:aastore         
	...
	//    0    0:aload_2         
	//    1    1:iconst_0        
	//    2    2:putfield        #145 <Field boolean PathParser$ExtractFloatResult.mEndWithNegOrDot>
		j = i;
	//    3    5:iload_1         
	//    4    6:istore          5
		boolean flag3 = false;
...
_L9:
	...
	//   15   23:iload           5
	//   16   25:aload_0         
	//   17   26:invokevirtual   #75  <Method int String.length()>
	//   18   29:icmpge          172
		c = s.charAt(j);
	//   19   32:aload_0         
	//   20   33:iload           5
	//   21   35:invokevirtual   #95  <Method char String.charAt(int)>
	//   22   38:istore          7
...
_L3:
		c;
	//   32   61:iload           7
		JVM INSTR tableswitch 44 46: default 88
	//	               44 150
	//	               45 117
	//	               46 91;
	//   33   63:tableswitch     44 46: default 88
	//	               44 150
	//	               45 117
	//	               46 91
...
_L7:
	...
	//   42  104:aload_2         
	//   43  105:iconst_1        
	//   44  106:putfield        #145 <Field boolean PathParser$ExtractFloatResult.mEndWithNegOrDot>
			flag = false;
	//   45  109:iconst_0        
	//   46  110:istore_3        
			flag1 = true;
...
_L6:
	...
	//   55  127:aload_2         
	//   56  128:iconst_1        
	//   57  129:putfield        #145 <Field boolean PathParser$ExtractFloatResult.mEndWithNegOrDot>
			flag = false;
	//   58  132:iconst_0        
	//   59  133:istore_3        
			flag1 = true;
...
_L8:
	...
	//   81  172:aload_2         
	//   82  173:iload           5
	//   83  175:putfield        #149 <Field int PathParser$ExtractFloatResult.mEndPosition>
		return;
	//   84  178:return          
	}
...
_L2:
	...
	//   11   23:aload_0         
	//   12   24:invokevirtual   #75  <Method int String.length()>
	//   13   27:newarray        float[]
	//   14   29:astore          6
			extractfloatresult = new ExtractFloatResult();
	//   15   31:new             #6   <Class PathParser$ExtractFloatResult>
	//   16   34:dup             
	//   17   35:invokespecial   #152 <Method void PathParser$ExtractFloatResult()>
	//   18   38:astore          7
			i1 = s.length();
	//   19   40:aload_0         
	//   20   41:invokevirtual   #75  <Method int String.length()>
	//   21   44:istore          5
		}
	//*  22   46:iconst_1        
	//*  23   47:istore_1        
	...
	//*  30   57:iload_1         
	//*  31   58:aload           7
	//*  32   60:invokestatic    #154 <Method void extract(String, int, PathParser$ExtractFloatResult)>
	//*  33   63:aload           7
	//*  34   65:getfield        #149 <Field int PathParser$ExtractFloatResult.mEndPosition>
	//*  35   68:istore          4
	//*  36   70:iload_3         
	//*  37   71:istore_2        
	//*  38   72:iload_1         
	...
	//*  44   82:iload_1         
	//*  45   83:iload           4
	//*  46   85:invokevirtual   #83  <Method String String.substring(int, int)>
	//*  47   88:invokestatic    #160 <Method float Float.parseFloat(String)>
	//*  48   91:fastore         
	//*  49   92:iload_3         
	//*  50   93:iconst_1        
	//*  51   94:iadd            
	//*  52   95:istore_2        
	//*  53   96:aload           7
	//*  54   98:getfield        #145 <Field boolean PathParser$ExtractFloatResult.mEndWithNegOrDot>
	//*  55  101:ifeq            177
	//*  56  104:iload           4
	//*  57  106:istore_1        
	//*  58  107:iload_2         
	...
	//*  62  114:iconst_0        
	//*  63  115:iload_3         
	//*  64  116:invokestatic    #162 <Method float[] copyOfRange(float[], int, int)>
	//*  65  119:astore          6
	//*  66  121:aload           6
	//*  67  123:areturn         
	...
	//*  68  124:astore          6
		{
			StringBuilder stringbuilder = new StringBuilder();
	//   69  126:new             #121 <Class StringBuilder>
	//   70  129:dup             
	//   71  130:invokespecial   #122 <Method void StringBuilder()>
	//   72  133:astore          7
			stringbuilder.append("error in parsing \"");
	//   73  135:aload           7
	//   74  137:ldc1            #164 <String "error in parsing \"">
	//   75  139:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   76  142:pop             
			stringbuilder.append(s);
	//   77  143:aload           7
	//   78  145:aload_0         
	//   79  146:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   80  149:pop             
			stringbuilder.append("\"");
	//   81  150:aload           7
	//   82  152:ldc1            #166 <String "\"">
	//   83  154:invokevirtual   #128 <Method StringBuilder StringBuilder.append(String)>
	//   84  157:pop             
			throw new RuntimeException(stringbuilder.toString(), ((Throwable) (numberformatexception)));
	//   85  158:new             #110 <Class RuntimeException>
	//   86  161:dup             
	//   87  162:aload           7
	//   88  164:invokevirtual   #131 <Method String StringBuilder.toString()>
	//   89  167:aload           6
	//   90  169:invokespecial   #134 <Method void RuntimeException(String, Throwable)>
	//   91  172:athrow          
		}
		i = 1;
		k = 0;
