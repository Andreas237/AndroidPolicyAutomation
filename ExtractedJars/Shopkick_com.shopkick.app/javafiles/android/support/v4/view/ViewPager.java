...
;
	...
	//   49   97:aload           7
	//   50   99:aload           7
	//   51  101:invokevirtual   #259 <Method int ArrayList.size()>
	//   52  104:iconst_1        
	//   53  105:isub            
	//   54  106:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   55  109:checkcast       #17  <Class ViewPager$ItemInfo>
	...
	//   57  114:aload           6
	//   58  116:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//   59  119:iload_1         
	//   60  120:aload           7
	//   61  122:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//   62  125:invokestatic    #339 <Method int Math.min(int, int)>
	//   63  128:invokestatic    #342 <Method int Math.max(int, int)>
	//   64  131:istore_3        
		}
		return j;
	//   65  132:iload_3         
	...
	//    7   14:fload_2         
	//    8   15:iload_3         
	//    9   16:invokeinterface #349 <Method void ViewPager$OnPageChangeListener.onPageScrolled(int, float, int)>
		obj = ((Object) (mOnPageChangeListeners));
	//   10   21:aload_0         
	//   11   22:getfield        #351 <Field List mOnPageChangeListeners>
	//   12   25:astore          6
		if(obj != null)
	//*  13   27:aload           6
	//*  14   29:ifnull          91
	...
	//*  17   35:aload           6
	//*  18   37:invokeinterface #354 <Method int List.size()>
	//*  19   42:istore          5
	//*  20   44:iload           4
	//*  21   46:iload           5
	//*  22   48:icmpge          91
	...
	//   23   51:aload_0         
	//   24   52:getfield        #351 <Field List mOnPageChangeListeners>
	//   25   55:iload           4
	//   26   57:invokeinterface #355 <Method Object List.get(int)>
	...
	//   33   75:fload_2         
	//   34   76:iload_3         
	//   35   77:invokeinterface #349 <Method void ViewPager$OnPageChangeListener.onPageScrolled(int, float, int)>
			}
	...
	//   41   91:aload_0         
	//   42   92:getfield        #357 <Field ViewPager$OnPageChangeListener mInternalPageChangeListener>
	//   43   95:astore          6
		if(obj != null)
	//*  44   97:aload           6
	//*  45   99:ifnull          112
	...
	//   48  105:fload_2         
	//   49  106:iload_3         
	//   50  107:invokeinterface #349 <Method void ViewPager$OnPageChangeListener.onPageScrolled(int, float, int)>
	//   51  112:return          
	}
	...
	//    5   11:aload           4
	//    6   13:iload_1         
	//    7   14:invokeinterface #362 <Method void ViewPager$OnPageChangeListener.onPageSelected(int)>
		obj = ((Object) (mOnPageChangeListeners));
	//    8   19:aload_0         
	//    9   20:getfield        #351 <Field List mOnPageChangeListeners>
	//   10   23:astore          4
		if(obj != null)
	//*  11   25:aload           4
	//*  12   27:ifnull          80
	...
	//*  15   32:aload           4
	//*  16   34:invokeinterface #354 <Method int List.size()>
	//*  17   39:istore_3        
	//*  18   40:iload_2         
	//*  19   41:iload_3         
	//*  20   42:icmpge          80
	...
	//   21   45:aload_0         
	//   22   46:getfield        #351 <Field List mOnPageChangeListeners>
	//   23   49:iload_2         
	//   24   50:invokeinterface #355 <Method Object List.get(int)>
	...
	//   29   65:aload           4
	//   30   67:iload_1         
	//   31   68:invokeinterface #362 <Method void ViewPager$OnPageChangeListener.onPageSelected(int)>
			}
	...
	//*  36   77:goto            40
		obj = ((Object) (mInternalPageChangeListener));
	//   37   80:aload_0         
	//   38   81:getfield        #357 <Field ViewPager$OnPageChangeListener mInternalPageChangeListener>
	//   39   84:astore          4
		if(obj != null)
	//*  40   86:aload           4
	//*  41   88:ifnull          99
	...
	//   42   91:aload           4
	//   43   93:iload_1         
	//   44   94:invokeinterface #362 <Method void ViewPager$OnPageChangeListener.onPageSelected(int)>
	//   45   99:return          
	}
	...
	//    5   11:aload           4
	//    6   13:iload_1         
	//    7   14:invokeinterface #366 <Method void ViewPager$OnPageChangeListener.onPageScrollStateChanged(int)>
		obj = ((Object) (mOnPageChangeListeners));
	//    8   19:aload_0         
	//    9   20:getfield        #351 <Field List mOnPageChangeListeners>
	//   10   23:astore          4
	...
	//   29   65:aload           4
	//   30   67:iload_1         
	//   31   68:invokeinterface #366 <Method void ViewPager$OnPageChangeListener.onPageScrollStateChanged(int)>
			}
	...
	//   42   91:aload           4
	//   43   93:iload_1         
	//   44   94:invokeinterface #366 <Method void ViewPager$OnPageChangeListener.onPageScrollStateChanged(int)>
	//   45   99:return          
	}
	...
	//   11   19:aload_1         
	//   12   20:invokevirtual   #394 <Method void VelocityTracker.recycle()>
			mVelocityTracker = null;
	//   13   23:aload_0         
	//   14   24:aconst_null     
	//   15   25:putfield        #389 <Field VelocityTracker mVelocityTracker>
		}
	//   16   28:return          
	}
	...
	//   31   55:aload_1         
	//   32   56:invokevirtual   #483 <Method void VelocityTracker.clear()>
		}
	//   33   59:return          
	}
	...
	//   22   40:new             #488 <Class IllegalStateException>
	//   23   43:dup             
	//   24   44:ldc2            #490 <String "onPageScrolled did not call superclass implementation">
	//   25   47:invokespecial   #493 <Method void IllegalStateException(String)>
	//   26   50:athrow          
		}
	...
	//   46   81:aload           7
	//   47   83:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//   48   86:istore          4
	...
	//   52   91:fdiv            
	//   53   92:aload           7
	//   54   94:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//   55   97:fsub            
	//   56   98:aload           7
	//   57  100:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//   58  103:fload_3         
	//   59  104:fadd            
	//   60  105:fdiv            
	//   61  106:fstore_2        
	...
	//   70  117:aload_0         
	//   71  118:iconst_0        
	//   72  119:putfield        #485 <Field boolean mCalledSuper>
		onPageScrolled(j, f, i);
	//   73  122:aload_0         
	//   74  123:iload           4
	//   75  125:fload_2         
	//   76  126:iload_1         
	//   77  127:invokevirtual   #486 <Method void onPageScrolled(int, float, int)>
		if(mCalledSuper)
	//*  78  130:aload_0         
	//*  79  131:getfield        #485 <Field boolean mCalledSuper>
	//*  80  134:ifeq            139
			return true;
	//   81  137:iconst_1        
	//   82  138:ireturn         
			...
			throw new IllegalStateException("onPageScrolled did not call superclass implementation");
	//   83  139:new             #488 <Class IllegalStateException>
	//   84  142:dup             
	//   85  143:ldc2            #490 <String "onPageScrolled did not call superclass implementation">
	//   86  146:invokespecial   #493 <Method void IllegalStateException(String)>
	//   87  149:athrow          
	}
	...
	//   45   75:aload           11
	//   46   77:aload           11
	//   47   79:invokevirtual   #259 <Method int ArrayList.size()>
	//   48   82:iconst_1        
	//   49   83:isub            
	//   50   84:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   51   87:checkcast       #17  <Class ViewPager$ItemInfo>
	//   52   90:astore          11
		boolean flag;
		if(((ItemInfo) (obj)).position != 0)
	//*  53   92:aload           10
	//*  54   94:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//*  55   97:ifeq            115
		{
			f = ((ItemInfo) (obj)).offset * f3;
	//   56  100:aload           10
	//   57  102:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//   58  105:fload           4
	//   59  107:fmul            
	//   60  108:fstore_1        
			flag = false;
	...
	//*  66  118:aload           11
	//*  67  120:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//*  68  123:aload_0         
	//*  69  124:getfield        #236 <Field PagerAdapter mAdapter>
	//*  70  127:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//*  71  130:iconst_1        
	//*  72  131:isub            
	//*  73  132:icmpeq          150
		{
	...
	//   74  135:aload           11
	//   75  137:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//   76  140:fload           4
	//   77  142:fmul            
	//   78  143:fstore_2        
			flag1 = false;
	...
	//   90  164:aload_0         
	//   91  165:getfield        #499 <Field EdgeEffect mLeftEdge>
	//   92  168:fload_1         
	//   93  169:fload_3         
	//   94  170:fsub            
	//   95  171:invokestatic    #502 <Method float Math.abs(float)>
	//   96  174:fload           4
	//   97  176:fdiv            
	//   98  177:invokevirtual   #508 <Method void EdgeEffect.onPull(float)>
				flag2 = true;
	//   99  180:iconst_1        
	//  100  181:istore          7
			}
	...
	//  114  207:aload_0         
	//  115  208:getfield        #510 <Field EdgeEffect mRightEdge>
	//  116  211:fload_3         
	//  117  212:fload_2         
	//  118  213:fsub            
	//  119  214:invokestatic    #502 <Method float Math.abs(float)>
	//  120  217:fload           4
	//  121  219:fdiv            
	//  122  220:invokevirtual   #508 <Method void EdgeEffect.onPull(float)>
					flag2 = true;
	//  123  223:iconst_1        
	//  124  224:istore          7
				}
	...
	//  126  227:fstore_1        
		...
		f1 = mLastMotionX;
	//  127  228:aload_0         
	//  128  229:getfield        #480 <Field float mLastMotionX>
	//  129  232:fstore_2        
		int i = (int)f;
	//  130  233:fload_1         
	//  131  234:f2i             
	...
	//  138  243:fsub            
	//  139  244:fadd            
	//  140  245:putfield        #480 <Field float mLastMotionX>
		scrollTo(i, getScrollY());
	//  141  248:aload_0         
	//  142  249:iload           5
	//  143  251:aload_0         
	//  144  252:invokevirtual   #289 <Method int getScrollY()>
	//  145  255:invokevirtual   #299 <Method void scrollTo(int, int)>
		pageScrolled(i);
	//  146  258:aload_0         
	//  147  259:iload           5
	//  148  261:invokespecial   #303 <Method boolean pageScrolled(int)>
	//  149  264:pop             
		return flag2;
	//  150  265:iload           7
	//  151  267:ireturn         
	...
	//    8   16:aload_0         
	//    9   17:new             #186 <Class ArrayList>
	//   10   20:dup             
	//   11   21:invokespecial   #187 <Method void ArrayList()>
	//   12   24:putfield        #571 <Field ArrayList mDrawingOrderedChildren>
			else
	//*  13   27:goto            34
				arraylist.clear();
	//   14   30:aload_3         
	//   15   31:invokevirtual   #572 <Method void ArrayList.clear()>
			int j = getChildCount();
	//   16   34:aload_0         
	//   17   35:invokevirtual   #370 <Method int getChildCount()>
	//   18   38:istore_2        
			for(int i = 0; i < j; i++)
	//*  19   39:iconst_0        
	//*  20   40:istore_1        
	...
	//   24   46:aload_0         
	//   25   47:iload_1         
	//   26   48:invokevirtual   #376 <Method View getChildAt(int)>
	//   27   51:astore_3        
				mDrawingOrderedChildren.add(((Object) (view)));
	//   28   52:aload_0         
	//   29   53:getfield        #571 <Field ArrayList mDrawingOrderedChildren>
	//   30   56:aload_3         
	//   31   57:invokevirtual   #576 <Method boolean ArrayList.add(Object)>
	//   32   60:pop             
			}
	...
	//   38   68:aload_0         
	//   39   69:getfield        #571 <Field ArrayList mDrawingOrderedChildren>
	//   40   72:getstatic       #179 <Field ViewPager$ViewPositionComparator sPositionComparator>
	//   41   75:invokestatic    #582 <Method void Collections.sort(List, Comparator)>
		}
	//   42   78:return          
	}
	...
	//   29   58:new             #488 <Class IllegalStateException>
	//   30   61:dup             
	//   31   62:ldc2            #650 <String "Cannot add pager decor view during layout">
	//   32   65:invokespecial   #493 <Method void IllegalStateException(String)>
	//   33   68:athrow          
			} else
			{
	...
	//   34   69:aload_3         
	//   35   70:iconst_1        
	//   36   71:putfield        #653 <Field boolean ViewPager$LayoutParams.needsMeasure>
				addViewInLayout(view, i, layoutparams1);
	//   37   74:aload_0         
	//   38   75:aload_1         
	//   39   76:iload_2         
	//   40   77:aload           4
	//   41   79:invokevirtual   #657 <Method boolean addViewInLayout(View, int, android.view.ViewGroup$LayoutParams)>
	//   42   82:pop             
				return;
	//   43   83:return          
			}
	...
	//   46   86:iload_2         
	//   47   87:aload           4
	//   48   89:invokespecial   #659 <Method void ViewGroup.addView(View, int, android.view.ViewGroup$LayoutParams)>
			return;
	//   49   92:return          
		}
	}
...
label2:
	...
	//   22   38:aload_0         
	//   23   39:invokestatic    #730 <Method VelocityTracker VelocityTracker.obtain()>
	//   24   42:putfield        #389 <Field VelocityTracker mVelocityTracker>
		else
	//*  25   45:goto            52
			((VelocityTracker) (obj)).clear();
	//   26   48:aload_3         
	//   27   49:invokevirtual   #483 <Method void VelocityTracker.clear()>
		long l = SystemClock.uptimeMillis();
	//   28   52:invokestatic    #736 <Method long SystemClock.uptimeMillis()>
	//   29   55:lstore_1        
	...
	//   34   60:fconst_0        
	//   35   61:iconst_0        
	//   36   62:invokestatic    #739 <Method MotionEvent MotionEvent.obtain(long, long, int, float, float, int)>
	//   37   65:astore_3        
		mVelocityTracker.addMovement(((MotionEvent) (obj)));
	//   38   66:aload_0         
	//   39   67:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//   40   70:aload_3         
	//   41   71:invokevirtual   #742 <Method void VelocityTracker.addMovement(MotionEvent)>
		((MotionEvent) (obj)).recycle();
	//   42   74:aload_3         
	//   43   75:invokevirtual   #743 <Method void MotionEvent.recycle()>
		mFakeDragBeginTime = l;
	//   44   78:aload_0         
	//   45   79:lload_1         
	//   46   80:putfield        #745 <Field long mFakeDragBeginTime>
		return true;
	//   47   83:iconst_1        
	//   48   84:ireturn         
	}
	...
	//*   4    6:ifnull          15
			list.clear();
	//    5    9:aload_1         
	//    6   10:invokeinterface #759 <Method void List.clear()>
	//    7   15:return          
	}
	...
	//*  34   63:iload           4
	//*  35   65:aload_0         
	//*  36   66:getfield        #189 <Field ArrayList mItems>
	//*  37   69:invokevirtual   #259 <Method int ArrayList.size()>
	//*  38   72:icmpge          300
		{
			ItemInfo iteminfo = (ItemInfo)mItems.get(j1);
	//   39   75:aload_0         
	//   40   76:getfield        #189 <Field ArrayList mItems>
	//   41   79:iload           4
	//   42   81:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   43   84:checkcast       #17  <Class ViewPager$ItemInfo>
	//   44   87:astore          10
			int j2 = mAdapter.getItemPosition(iteminfo.object);
	//   45   89:aload_0         
	//   46   90:getfield        #236 <Field PagerAdapter mAdapter>
	//   47   93:aload           10
	//   48   95:getfield        #619 <Field Object ViewPager$ItemInfo.object>
	//   49   98:invokevirtual   #776 <Method int PagerAdapter.getItemPosition(Object)>
	//   50  101:istore          8
			int k1;
			int l1;
			int i2;
	...
	//*  63  126:icmpne          231
			{
				mItems.remove(j1);
	//   64  129:aload_0         
	//   65  130:getfield        #189 <Field ArrayList mItems>
	//   66  133:iload           4
	//   67  135:invokevirtual   #779 <Method Object ArrayList.remove(int)>
	//   68  138:pop             
				l1 = j1 - 1;
	//   69  139:iload           4
	//   70  141:iconst_1        
	...
	//   77  151:aload_0         
	//   78  152:getfield        #236 <Field PagerAdapter mAdapter>
	//   79  155:aload_0         
	//   80  156:invokevirtual   #783 <Method void PagerAdapter.startUpdate(ViewGroup)>
					i = 1;
	//   81  159:iconst_1        
	//   82  160:istore_1        
				}
	...
	//   83  161:aload_0         
	//   84  162:getfield        #236 <Field PagerAdapter mAdapter>
	//   85  165:aload_0         
	//   86  166:aload           10
	//   87  168:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//   88  171:aload           10
	//   89  173:getfield        #619 <Field Object ViewPager$ItemInfo.object>
	//   90  176:invokevirtual   #787 <Method void PagerAdapter.destroyItem(ViewGroup, int, Object)>
				if(mCurItem == iteminfo.position)
	//*  91  179:aload_0         
	//*  92  180:getfield        #333 <Field int mCurItem>
	//*  93  183:aload           10
	//*  94  185:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//*  95  188:icmpne          218
				{
					k1 = Math.max(0, Math.min(mCurItem, k2 - 1));
	//   96  191:iconst_0        
	//   97  192:aload_0         
	//   98  193:getfield        #333 <Field int mCurItem>
	//   99  196:iload           9
	//  100  198:iconst_1        
	//  101  199:isub            
	//  102  200:invokestatic    #339 <Method int Math.min(int, int)>
	//  103  203:invokestatic    #342 <Method int Math.max(int, int)>
	//  104  206:istore          5
					k = 1;
	//  105  208:iconst_1        
	//  106  209:istore_2        
	...
	//* 127  241:aload           10
	//* 128  243:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 129  246:iload           8
	//* 130  248:icmpeq          285
				{
					if(iteminfo.position == mCurItem)
	//* 131  251:aload           10
	//* 132  253:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 133  256:aload_0         
	//* 134  257:getfield        #333 <Field int mCurItem>
	//* 135  260:icmpne          266
						k = j2;
	//  136  263:iload           8
	//  137  265:istore_2        
	...
	//  138  266:aload           10
	//  139  268:iload           8
	//  140  270:putfield        #250 <Field int ViewPager$ItemInfo.position>
					i = 1;
	//  141  273:iconst_1        
	//  142  274:istore_1        
					k1 = k;
	...
	//  160  304:aload_0         
	//  161  305:getfield        #236 <Field PagerAdapter mAdapter>
	//  162  308:aload_0         
	//  163  309:invokevirtual   #790 <Method void PagerAdapter.finishUpdate(ViewGroup)>
		Collections.sort(((List) (mItems)), COMPARATOR);
	//  164  312:aload_0         
	//  165  313:getfield        #189 <Field ArrayList mItems>
	//  166  316:getstatic       #173 <Field Comparator COMPARATOR>
	//  167  319:invokestatic    #582 <Method void Collections.sort(List, Comparator)>
		if(i != 0)
	//* 168  322:iload_1         
	//* 169  323:ifeq            383
		{
	...
	//  170  326:aload_0         
	//  171  327:invokevirtual   #370 <Method int getChildCount()>
	//  172  330:istore_3        
			for(int j = 0; j < i1; j++)
	//* 173  331:iconst_0        
	//* 174  332:istore_1        
	...
	//  178  338:aload_0         
	//  179  339:iload_1         
	//  180  340:invokevirtual   #376 <Method View getChildAt(int)>
	//  181  343:invokevirtual   #534 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//  182  346:checkcast       #20  <Class ViewPager$LayoutParams>
	//  183  349:astore          10
				if(!layoutparams.isDecor)
	//* 184  351:aload           10
	//* 185  353:getfield        #537 <Field boolean ViewPager$LayoutParams.isDecor>
	//* 186  356:ifne            365
					layoutparams.widthFactor = 0.0F;
	//  187  359:aload           10
	//  188  361:fconst_0        
	//  189  362:putfield        #791 <Field float ViewPager$LayoutParams.widthFactor>
			}
	...
	//  197  374:iconst_0        
	//  198  375:iconst_1        
	//  199  376:invokevirtual   #795 <Method void setCurrentItemInternal(int, boolean, boolean)>
			requestLayout();
	//  200  379:aload_0         
	//  201  380:invokevirtual   #798 <Method void requestLayout()>
		}
	//  202  383:return          
	}
...
label1:
	...
	//*  19   34:ifnull          49
	//*  20   37:aload           8
	//*  21   39:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//*  22   42:iconst_1        
	//*  23   43:icmple          49
						break label1;
	//   24   46:goto            66
				...
				mLeftEdge.finish();
	//   25   49:aload_0         
	//   26   50:getfield        #499 <Field EdgeEffect mLeftEdge>
	//   27   53:invokevirtual   #832 <Method void EdgeEffect.finish()>
				mRightEdge.finish();
	//   28   56:aload_0         
	//   29   57:getfield        #510 <Field EdgeEffect mRightEdge>
	//   30   60:invokevirtual   #832 <Method void EdgeEffect.finish()>
				break label0;
	//   31   63:goto            256
			}
			if(!mLeftEdge.isFinished())
	//*  32   66:aload_0         
	//*  33   67:getfield        #499 <Field EdgeEffect mLeftEdge>
	//*  34   70:invokevirtual   #554 <Method boolean EdgeEffect.isFinished()>
	//*  35   73:ifne            155
			{
				j = canvas.save();
	//   36   76:aload_1         
	//   37   77:invokevirtual   #837 <Method int Canvas.save()>
	//   38   80:istore_3        
				i = getHeight() - getPaddingTop() - getPaddingBottom();
	//   39   81:aload_0         
	//   40   82:invokevirtual   #840 <Method int getHeight()>
	//   41   85:aload_0         
	//   42   86:invokevirtual   #843 <Method int getPaddingTop()>
	//   43   89:isub            
	//   44   90:aload_0         
	//   45   91:invokevirtual   #846 <Method int getPaddingBottom()>
	//   46   94:isub            
	//   47   95:istore_2        
				int l = getWidth();
	//   48   96:aload_0         
	//   49   97:invokevirtual   #465 <Method int getWidth()>
	//   50  100:istore          4
				canvas.rotate(270F);
	//   51  102:aload_1         
	//   52  103:ldc2            #847 <Float 270F>
	//   53  106:invokevirtual   #850 <Method void Canvas.rotate(float)>
				canvas.translate(-i + getPaddingTop(), mFirstOffset * (float)l);
	//   54  109:aload_1         
	//   55  110:iload_2         
	//   56  111:ineg            
	//   57  112:aload_0         
	//   58  113:invokevirtual   #843 <Method int getPaddingTop()>
	//   59  116:iadd            
	//   60  117:i2f             
	//   61  118:aload_0         
	//   62  119:getfield        #206 <Field float mFirstOffset>
	//   63  122:iload           4
	//   64  124:i2f             
	//   65  125:fmul            
	//   66  126:invokevirtual   #854 <Method void Canvas.translate(float, float)>
				mLeftEdge.setSize(i, l);
	//   67  129:aload_0         
	//   68  130:getfield        #499 <Field EdgeEffect mLeftEdge>
	//   69  133:iload_2         
	//   70  134:iload           4
	//   71  136:invokevirtual   #857 <Method void EdgeEffect.setSize(int, int)>
				i = ((int) (false | mLeftEdge.draw(canvas)));
	//   72  139:iconst_0        
	//   73  140:aload_0         
	//   74  141:getfield        #499 <Field EdgeEffect mLeftEdge>
	//   75  144:aload_1         
	//   76  145:invokevirtual   #860 <Method boolean EdgeEffect.draw(Canvas)>
	//   77  148:ior             
	//   78  149:istore_2        
				canvas.restoreToCount(j);
	//   79  150:aload_1         
	//   80  151:iload_3         
	//   81  152:invokevirtual   #863 <Method void Canvas.restoreToCount(int)>
			}
			j = i;
	//   82  155:iload_2         
	//   83  156:istore_3        
	...
	//*  84  157:aload_0         
	//*  85  158:getfield        #510 <Field EdgeEffect mRightEdge>
	//*  86  161:invokevirtual   #554 <Method boolean EdgeEffect.isFinished()>
	//*  87  164:ifne            256
			{
				int i1 = canvas.save();
	//   88  167:aload_1         
	//   89  168:invokevirtual   #837 <Method int Canvas.save()>
	//   90  171:istore          4
				j = getWidth();
	//   91  173:aload_0         
	//   92  174:invokevirtual   #465 <Method int getWidth()>
	//   93  177:istore_3        
				int j1 = getHeight();
	//   94  178:aload_0         
	//   95  179:invokevirtual   #840 <Method int getHeight()>
	//   96  182:istore          5
				int k1 = getPaddingTop();
	//   97  184:aload_0         
	//   98  185:invokevirtual   #843 <Method int getPaddingTop()>
	//   99  188:istore          6
				int l1 = getPaddingBottom();
	//  100  190:aload_0         
	//  101  191:invokevirtual   #846 <Method int getPaddingBottom()>
	//  102  194:istore          7
				canvas.rotate(90F);
	//  103  196:aload_1         
	//  104  197:ldc2            #864 <Float 90F>
	//  105  200:invokevirtual   #850 <Method void Canvas.rotate(float)>
				canvas.translate(-getPaddingTop(), -(mLastOffset + 1.0F) * (float)j);
	//  106  203:aload_1         
	//  107  204:aload_0         
	//  108  205:invokevirtual   #843 <Method int getPaddingTop()>
	//  109  208:ineg            
	//  110  209:i2f             
	//  111  210:aload_0         
	//  112  211:getfield        #209 <Field float mLastOffset>
	//  113  214:fconst_1        
	//  114  215:fadd            
	//  115  216:fneg            
	//  116  217:iload_3         
	//  117  218:i2f             
	//  118  219:fmul            
	//  119  220:invokevirtual   #854 <Method void Canvas.translate(float, float)>
				mRightEdge.setSize(j1 - k1 - l1, j);
	//  120  223:aload_0         
	//  121  224:getfield        #510 <Field EdgeEffect mRightEdge>
	//  122  227:iload           5
	//  123  229:iload           6
	//  124  231:isub            
	//  125  232:iload           7
	//  126  234:isub            
	//  127  235:iload_3         
	//  128  236:invokevirtual   #857 <Method void EdgeEffect.setSize(int, int)>
				j = i | mRightEdge.draw(canvas);
	//  129  239:iload_2         
	//  130  240:aload_0         
	//  131  241:getfield        #510 <Field EdgeEffect mRightEdge>
	//  132  244:aload_1         
	//  133  245:invokevirtual   #860 <Method boolean EdgeEffect.draw(Canvas)>
	//  134  248:ior             
	//  135  249:istore_3        
				canvas.restoreToCount(i1);
	//  136  250:aload_1         
	//  137  251:iload           4
	//  138  253:invokevirtual   #863 <Method void Canvas.restoreToCount(int)>
			}
		}
		if(j != 0)
	//* 139  256:iload_3         
	//* 140  257:ifeq            264
			ViewCompat.postInvalidateOnAnimation(((View) (this)));
	//  141  260:aload_0         
	//  142  261:invokestatic    #769 <Method void ViewCompat.postInvalidateOnAnimation(View)>
	//  143  264:return          
	}
	...
	//*   5   11:ifnull          109
			{
				Object obj = ((Object) (mVelocityTracker));
	//    6   14:aload_0         
	//    7   15:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//    8   18:astore          4
				((VelocityTracker) (obj)).computeCurrentVelocity(1000, mMaximumVelocity);
	//    9   20:aload           4
	//   10   22:sipush          1000
	//   11   25:aload_0         
	//   12   26:getfield        #885 <Field int mMaximumVelocity>
	//   13   29:i2f             
	//   14   30:invokevirtual   #889 <Method void VelocityTracker.computeCurrentVelocity(int, float)>
				int i = (int)((VelocityTracker) (obj)).getXVelocity(mActivePointerId);
	//   15   33:aload           4
	//   16   35:aload_0         
	//   17   36:getfield        #213 <Field int mActivePointerId>
	//   18   39:invokevirtual   #892 <Method float VelocityTracker.getXVelocity(int)>
	//   19   42:f2i             
	//   20   43:istore_1        
				mPopulatePending = true;
	//   21   44:aload_0         
	//   22   45:iconst_1        
	//   23   46:putfield        #305 <Field boolean mPopulatePending>
				int j = getClientWidth();
	//   24   49:aload_0         
	//   25   50:invokespecial   #245 <Method int getClientWidth()>
	//   26   53:istore_2        
				int k = getScrollX();
	//   27   54:aload_0         
	//   28   55:invokevirtual   #286 <Method int getScrollX()>
	//   29   58:istore_3        
				obj = ((Object) (infoForCurrentScrollPosition()));
	//   30   59:aload_0         
	//   31   60:invokespecial   #495 <Method ViewPager$ItemInfo infoForCurrentScrollPosition()>
	//   32   63:astore          4
	...
	//   34   66:aload_0         
	//   35   67:aload           4
	//   36   69:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//   37   72:iload_3         
	//   38   73:i2f             
	//   39   74:iload_2         
	//   40   75:i2f             
	//   41   76:fdiv            
	//   42   77:aload           4
	//   43   79:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//   44   82:fsub            
	//   45   83:aload           4
	//   46   85:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//   47   88:fdiv            
	//   48   89:iload_1         
	//   49   90:aload_0         
	//   50   91:getfield        #480 <Field float mLastMotionX>
	//   51   94:aload_0         
	//   52   95:getfield        #726 <Field float mInitialMotionX>
	//   53   98:fsub            
	//   54   99:f2i             
	//   55  100:invokespecial   #894 <Method int determineTargetPage(int, float, int, int)>
	//   56  103:iconst_1        
	//   57  104:iconst_1        
	//   58  105:iload_1         
	//   59  106:invokevirtual   #897 <Method void setCurrentItemInternal(int, boolean, boolean, int)>
			}
			endDrag();
	//   60  109:aload_0         
	//   61  110:invokespecial   #550 <Method void endDrag()>
			mFakeDragging = false;
	//   62  113:aload_0         
	//   63  114:iconst_0        
	//   64  115:putfield        #721 <Field boolean mFakeDragging>
			return;
	//   65  118:return          
		} else
		{
			throw new IllegalStateException("No fake drag in progress. Call beginFakeDrag first.");
	//   66  119:new             #488 <Class IllegalStateException>
	//   67  122:dup             
	//   68  123:ldc2            #899 <String "No fake drag in progress. Call beginFakeDrag first.">
	//   69  126:invokespecial   #493 <Method void IllegalStateException(String)>
	//   70  129:athrow          
		}
	}
	...
	//    7   15:aload_0         
	//    8   16:aload_0         
	//    9   17:getfield        #480 <Field float mLastMotionX>
	//   10   20:fload_1         
	//   11   21:fadd            
	//   12   22:putfield        #480 <Field float mLastMotionX>
			float f2 = (float)getScrollX() - f;
	//   13   25:aload_0         
	//   14   26:invokevirtual   #286 <Method int getScrollX()>
	//   15   29:i2f             
	//   16   30:fload_1         
	//   17   31:fsub            
	//   18   32:fstore_3        
			float f3 = getClientWidth();
	//   19   33:aload_0         
	//   20   34:invokespecial   #245 <Method int getClientWidth()>
	//   21   37:i2f             
	//   22   38:fstore          4
			f = mFirstOffset * f3;
	//   23   40:aload_0         
	//   24   41:getfield        #206 <Field float mFirstOffset>
	//   25   44:fload           4
	//   26   46:fmul            
	//   27   47:fstore_1        
			float f1 = mLastOffset * f3;
	//   28   48:aload_0         
	//   29   49:getfield        #209 <Field float mLastOffset>
	//   30   52:fload           4
	//   31   54:fmul            
	//   32   55:fstore_2        
			Object obj = ((Object) ((ItemInfo)mItems.get(0)));
	//   33   56:aload_0         
	//   34   57:getfield        #189 <Field ArrayList mItems>
	//   35   60:iconst_0        
	//   36   61:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   37   64:checkcast       #17  <Class ViewPager$ItemInfo>
	//   38   67:astore          8
			Object obj1 = ((Object) (mItems));
	//   39   69:aload_0         
	//   40   70:getfield        #189 <Field ArrayList mItems>
	//   41   73:astore          9
			obj1 = ((Object) ((ItemInfo)((ArrayList) (obj1)).get(((ArrayList) (obj1)).size() - 1)));
	//   42   75:aload           9
	//   43   77:aload           9
	//   44   79:invokevirtual   #259 <Method int ArrayList.size()>
	//   45   82:iconst_1        
	//   46   83:isub            
	//   47   84:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   48   87:checkcast       #17  <Class ViewPager$ItemInfo>
	//   49   90:astore          9
			if(((ItemInfo) (obj)).position != 0)
	//*  50   92:aload           8
	//*  51   94:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//*  52   97:ifeq            109
				f = ((ItemInfo) (obj)).offset * f3;
	//   53  100:aload           8
	//   54  102:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//   55  105:fload           4
	//   56  107:fmul            
	//   57  108:fstore_1        
			if(((ItemInfo) (obj1)).position != mAdapter.getCount() - 1)
	//*  58  109:aload           9
	//*  59  111:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//*  60  114:aload_0         
	//*  61  115:getfield        #236 <Field PagerAdapter mAdapter>
	//*  62  118:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//*  63  121:iconst_1        
	//*  64  122:isub            
	//*  65  123:icmpeq          135
				f1 = ((ItemInfo) (obj1)).offset * f3;
	//   66  126:aload           9
	//   67  128:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//   68  131:fload           4
	//   69  133:fmul            
	//   70  134:fstore_2        
			if(f2 >= f)
	...
	//   83  153:fstore_1        
			...
			f1 = mLastMotionX;
	//   84  154:aload_0         
	//   85  155:getfield        #480 <Field float mLastMotionX>
	//   86  158:fstore_2        
			int i = (int)f;
	//   87  159:fload_1         
	//   88  160:f2i             
	...
	//   95  169:fsub            
	//   96  170:fadd            
	//   97  171:putfield        #480 <Field float mLastMotionX>
			scrollTo(i, getScrollY());
	//   98  174:aload_0         
	//   99  175:iload           5
	//  100  177:aload_0         
	//  101  178:invokevirtual   #289 <Method int getScrollY()>
	//  102  181:invokevirtual   #299 <Method void scrollTo(int, int)>
			pageScrolled(i);
	//  103  184:aload_0         
	//  104  185:iload           5
	//  105  187:invokespecial   #303 <Method boolean pageScrolled(int)>
	//  106  190:pop             
			long l = SystemClock.uptimeMillis();
	//  107  191:invokestatic    #736 <Method long SystemClock.uptimeMillis()>
	//  108  194:lstore          6
			obj = ((Object) (MotionEvent.obtain(mFakeDragBeginTime, l, 2, mLastMotionX, 0.0F, 0)));
	//  109  196:aload_0         
	//  110  197:getfield        #745 <Field long mFakeDragBeginTime>
	//  111  200:lload           6
	//  112  202:iconst_2        
	//  113  203:aload_0         
	//  114  204:getfield        #480 <Field float mLastMotionX>
	//  115  207:fconst_0        
	//  116  208:iconst_0        
	//  117  209:invokestatic    #739 <Method MotionEvent MotionEvent.obtain(long, long, int, float, float, int)>
	//  118  212:astore          8
			mVelocityTracker.addMovement(((MotionEvent) (obj)));
	//  119  214:aload_0         
	//  120  215:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//  121  218:aload           8
	//  122  220:invokevirtual   #742 <Method void VelocityTracker.addMovement(MotionEvent)>
			((MotionEvent) (obj)).recycle();
	//  123  223:aload           8
	//  124  225:invokevirtual   #743 <Method void MotionEvent.recycle()>
			return;
	//  125  228:return          
		} else
		{
			throw new IllegalStateException("No fake drag in progress. Call beginFakeDrag first.");
	//  126  229:new             #488 <Class IllegalStateException>
	//  127  232:dup             
	//  128  233:ldc2            #899 <String "No fake drag in progress. Call beginFakeDrag first.">
	//  129  236:invokespecial   #493 <Method void IllegalStateException(String)>
	//  130  239:athrow          
		}
	}
	...
	//   40   76:putfield        #885 <Field int mMaximumVelocity>
	...
	//*   9   15:ifnull          32
	//*  10   18:aload_1         
	//*  11   19:invokevirtual   #280 <Method boolean Scroller.isFinished()>
	//*  12   22:ifne            32
			mScroller.abortAnimation();
	//   13   25:aload_0         
	//   14   26:getfield        #274 <Field Scroller mScroller>
	//   15   29:invokevirtual   #283 <Method void Scroller.abortAnimation()>
		super.onDetachedFromWindow();
	//   16   32:aload_0         
	//   17   33:invokespecial   #1019 <Method void ViewGroup.onDetachedFromWindow()>
	//   18   36:return          
	}
	...
	//   91  191:aload           13
	//   92  193:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//   93  196:fadd            
	//   94  197:fload           6
	//   95  199:fmul            
	//   96  200:fstore          4
	...
	//   97  202:aload           13
	//   98  204:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//   99  207:aload           13
	//  100  209:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  101  212:fadd            
	//  102  213:fload_3         
	//  103  214:fadd            
	//  104  215:fstore_2        
	...
	//  106  219:aload_0         
	//  107  220:getfield        #236 <Field PagerAdapter mAdapter>
	//  108  223:iload           7
	//  109  225:invokevirtual   #267 <Method float PagerAdapter.getPageWidth(int)>
	//  110  228:fstore          5
					f2 = f + (f3 + f1);
	//  111  230:fload_2         
	//  112  231:fload           5
	...
	//* 127  254:aload_0         
	//* 128  255:getfield        #247 <Field int mPageMargin>
	//* 129  258:i2f             
	//* 130  259:fload           4
	//* 131  261:fadd            
	//* 132  262:iload           9
	...
	//  136  269:aload_0         
	//  137  270:getfield        #869 <Field Drawable mMarginDrawable>
	//  138  273:fload           4
	//  139  275:invokestatic    #1026 <Method int Math.round(float)>
	//  140  278:aload_0         
	//  141  279:getfield        #1028 <Field int mTopPageBounds>
	//  142  282:aload_0         
	//  143  283:getfield        #247 <Field int mPageMargin>
	//  144  286:i2f             
	//  145  287:fload           4
	//  146  289:fadd            
	//  147  290:invokestatic    #1026 <Method int Math.round(float)>
	//  148  293:aload_0         
	//  149  294:getfield        #1030 <Field int mBottomPageBounds>
	//  150  297:invokevirtual   #1033 <Method void Drawable.setBounds(int, int, int, int)>
					mMarginDrawable.draw(canvas);
	//  151  300:aload_0         
	//  152  301:getfield        #869 <Field Drawable mMarginDrawable>
	//  153  304:aload_1         
	//  154  305:invokevirtual   #1034 <Method void Drawable.draw(Canvas)>
				}
	//* 155  308:goto            311
				if(f2 > (float)(k + l))
	//* 156  311:fload           4
	...
	//*  76  150:aload_0         
	//*  77  151:aload_0         
	//*  78  152:getfield        #480 <Field float mLastMotionX>
	//*  79  155:fload_2         
	//*  80  156:invokespecial   #1049 <Method boolean isGutterDrag(float, float)>
	//*  81  159:ifne            196
	//*  82  162:aload_0         
	//*  83  163:aload_0         
	//*  84  164:iconst_0        
	...
	//*  89  169:fload           4
	//*  90  171:f2i             
	//*  91  172:invokevirtual   #753 <Method boolean canScroll(View, boolean, int, int, int)>
	//*  92  175:ifeq            196
						{
							mLastMotionX = f3;
	//   93  178:aload_0         
	//   94  179:fload_3         
	//   95  180:putfield        #480 <Field float mLastMotionX>
							mLastMotionY = f4;
	//   96  183:aload_0         
	//   97  184:fload           4
	//   98  186:putfield        #1051 <Field float mLastMotionY>
							mIsUnableToDrag = true;
	//   99  189:aload_0         
	//  100  190:iconst_1        
	//  101  191:putfield        #387 <Field boolean mIsUnableToDrag>
							return false;
	//  102  194:iconst_0        
	//  103  195:ireturn         
						}
	...
	//* 104  196:fload           5
	//* 105  198:aload_0         
	//* 106  199:getfield        #979 <Field int mTouchSlop>
	//* 107  202:i2f             
	//* 108  203:fcmpl           
	//* 109  204:ifle            283
	//* 110  207:fload           5
	//* 111  209:ldc2            #817 <Float 0.5F>
	//* 112  212:fmul            
	//* 113  213:fload           6
	//* 114  215:fcmpl           
	//* 115  216:ifle            283
	...
	//  116  219:aload_0         
	//  117  220:iconst_1        
	//  118  221:putfield        #385 <Field boolean mIsBeingDragged>
							requestParentDisallowInterceptTouchEvent(true);
	//  119  224:aload_0         
	//  120  225:iconst_1        
	//  121  226:invokespecial   #1053 <Method void requestParentDisallowInterceptTouchEvent(boolean)>
							setScrollState(1);
	//  122  229:aload_0         
	//  123  230:iconst_1        
	//  124  231:invokevirtual   #724 <Method void setScrollState(int)>
							float f1;
							if(j > 0)
	//* 125  234:iload           7
	//* 126  236:ifle            253
	...
	//  127  239:aload_0         
	//  128  240:getfield        #726 <Field float mInitialMotionX>
	//  129  243:aload_0         
	//  130  244:getfield        #979 <Field int mTouchSlop>
	//  131  247:i2f             
	//  132  248:fadd            
	//  133  249:fstore_2        
							else
	//* 134  250:goto            264
								f1 = mInitialMotionX - (float)mTouchSlop;
	//  135  253:aload_0         
	//  136  254:getfield        #726 <Field float mInitialMotionX>
	//  137  257:aload_0         
	//  138  258:getfield        #979 <Field int mTouchSlop>
	//  139  261:i2f             
	//  140  262:fsub            
	//  141  263:fstore_2        
							mLastMotionX = f1;
	//  142  264:aload_0         
	//  143  265:fload_2         
	//  144  266:putfield        #480 <Field float mLastMotionX>
							mLastMotionY = f4;
	//  145  269:aload_0         
	//  146  270:fload           4
	//  147  272:putfield        #1051 <Field float mLastMotionY>
							setScrollingCacheEnabled(true);
	//  148  275:aload_0         
	//  149  276:iconst_1        
	//  150  277:invokespecial   #272 <Method void setScrollingCacheEnabled(boolean)>
						} else
	//* 151  280:goto            299
						if(f6 > (float)mTouchSlop)
	//* 152  283:fload           6
	//* 153  285:aload_0         
	//* 154  286:getfield        #979 <Field int mTouchSlop>
	//* 155  289:i2f             
	//* 156  290:fcmpl           
	//* 157  291:ifle            299
							mIsUnableToDrag = true;
	//  158  294:aload_0         
	//  159  295:iconst_1        
	//  160  296:putfield        #387 <Field boolean mIsUnableToDrag>
						if(mIsBeingDragged && performDrag(f3))
	//* 161  299:aload_0         
	//* 162  300:getfield        #385 <Field boolean mIsBeingDragged>
	//* 163  303:ifeq            455
	//* 164  306:aload_0         
	//* 165  307:fload_3         
	//* 166  308:invokespecial   #1055 <Method boolean performDrag(float)>
	//* 167  311:ifeq            455
							ViewCompat.postInvalidateOnAnimation(((View) (this)));
	//  168  314:aload_0         
	//  169  315:invokestatic    #769 <Method void ViewCompat.postInvalidateOnAnimation(View)>
					}
				}
			} else
	//* 170  318:goto            455
	...
	//  171  321:aload_1         
	//  172  322:invokevirtual   #1058 <Method float MotionEvent.getX()>
	//  173  325:fstore_2        
				mInitialMotionX = f2;
	//  174  326:aload_0         
	//  175  327:fload_2         
	//  176  328:putfield        #726 <Field float mInitialMotionX>
				mLastMotionX = f2;
	//  177  331:aload_0         
	//  178  332:fload_2         
	//  179  333:putfield        #480 <Field float mLastMotionX>
				f2 = motionevent.getY();
	//  180  336:aload_1         
	//  181  337:invokevirtual   #1060 <Method float MotionEvent.getY()>
	//  182  340:fstore_2        
				mInitialMotionY = f2;
	//  183  341:aload_0         
	//  184  342:fload_2         
	//  185  343:putfield        #1047 <Field float mInitialMotionY>
				mLastMotionY = f2;
	//  186  346:aload_0         
	//  187  347:fload_2         
	//  188  348:putfield        #1051 <Field float mLastMotionY>
				mActivePointerId = motionevent.getPointerId(0);
	//  189  351:aload_0         
	//  190  352:aload_1         
	//  191  353:iconst_0        
	//  192  354:invokevirtual   #475 <Method int MotionEvent.getPointerId(int)>
	//  193  357:putfield        #213 <Field int mActivePointerId>
				mIsUnableToDrag = false;
	//  194  360:aload_0         
	//  195  361:iconst_0        
	//  196  362:putfield        #387 <Field boolean mIsUnableToDrag>
				mIsScrollStarted = true;
	//  197  365:aload_0         
	//  198  366:iconst_1        
	//  199  367:putfield        #762 <Field boolean mIsScrollStarted>
				mScroller.computeScrollOffset();
	//  200  370:aload_0         
	//  201  371:getfield        #274 <Field Scroller mScroller>
	//  202  374:invokevirtual   #765 <Method boolean Scroller.computeScrollOffset()>
	//  203  377:pop             
				if(mScrollState == 2 && Math.abs(mScroller.getFinalX() - mScroller.getCurrX()) > mCloseEnough)
	//* 204  378:aload_0         
	//* 205  379:getfield        #224 <Field int mScrollState>
	//* 206  382:iconst_2        
	//* 207  383:icmpne          445
	//* 208  386:aload_0         
	//* 209  387:getfield        #274 <Field Scroller mScroller>
	//* 210  390:invokevirtual   #1063 <Method int Scroller.getFinalX()>
	//* 211  393:aload_0         
	//* 212  394:getfield        #274 <Field Scroller mScroller>
	//* 213  397:invokevirtual   #292 <Method int Scroller.getCurrX()>
	//* 214  400:isub            
	//* 215  401:invokestatic    #327 <Method int Math.abs(int)>
	//* 216  404:aload_0         
	//* 217  405:getfield        #987 <Field int mCloseEnough>
	//* 218  408:icmple          445
				{
					mScroller.abortAnimation();
	//  219  411:aload_0         
	//  220  412:getfield        #274 <Field Scroller mScroller>
	//  221  415:invokevirtual   #283 <Method void Scroller.abortAnimation()>
					mPopulatePending = false;
	//  222  418:aload_0         
	//  223  419:iconst_0        
	//  224  420:putfield        #305 <Field boolean mPopulatePending>
					populate();
	//  225  423:aload_0         
	//  226  424:invokevirtual   #1066 <Method void populate()>
					mIsBeingDragged = true;
	//  227  427:aload_0         
	//  228  428:iconst_1        
	//  229  429:putfield        #385 <Field boolean mIsBeingDragged>
					requestParentDisallowInterceptTouchEvent(true);
	//  230  432:aload_0         
	//  231  433:iconst_1        
	//  232  434:invokespecial   #1053 <Method void requestParentDisallowInterceptTouchEvent(boolean)>
					setScrollState(1);
	//  233  437:aload_0         
	//  234  438:iconst_1        
	//  235  439:invokevirtual   #724 <Method void setScrollState(int)>
				} else
	//* 236  442:goto            455
				{
					completeScroll(false);
	//  237  445:aload_0         
	//  238  446:iconst_0        
	//  239  447:invokespecial   #529 <Method void completeScroll(boolean)>
					mIsBeingDragged = false;
	//  240  450:aload_0         
	//  241  451:iconst_0        
	//  242  452:putfield        #385 <Field boolean mIsBeingDragged>
				}
			}
			if(mVelocityTracker == null)
	//* 243  455:aload_0         
	//* 244  456:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//* 245  459:ifnonnull       469
				mVelocityTracker = VelocityTracker.obtain();
	//  246  462:aload_0         
	//  247  463:invokestatic    #730 <Method VelocityTracker VelocityTracker.obtain()>
	//  248  466:putfield        #389 <Field VelocityTracker mVelocityTracker>
			mVelocityTracker.addMovement(motionevent);
	//  249  469:aload_0         
	//  250  470:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//  251  473:aload_1         
	//  252  474:invokevirtual   #742 <Method void VelocityTracker.addMovement(MotionEvent)>
			return mIsBeingDragged;
	//  253  477:aload_0         
	//  254  478:getfield        #385 <Field boolean mIsBeingDragged>
	//  255  481:ireturn         
		} else
		{
			resetTouch();
	//  256  482:aload_0         
	//  257  483:invokespecial   #1068 <Method boolean resetTouch()>
	//  258  486:pop             
			return false;
	//  259  487:iconst_0        
	//  260  488:ireturn         
	...
	//  148  288:istore          5
								k1 = 0x40000000;
	//  149  290:ldc2            #1081 <Int 0x40000000>
	//  150  293:istore          4
							} else
	//* 151  295:goto            312
							{
	...
	//  153  299:istore          5
								k1 = 0x40000000;
	//  154  301:ldc2            #1081 <Int 0x40000000>
	//  155  304:istore          4
							}
						} else
	//* 156  306:goto            312
	...
	//* 159  312:aload           13
	//* 160  314:getfield        #1108 <Field int ViewPager$LayoutParams.height>
	//* 161  317:bipush          -2
	//* 162  319:icmpeq          345
						{
							if(layoutparams.height != -1)
	//* 163  322:aload           13
	//* 164  324:getfield        #1108 <Field int ViewPager$LayoutParams.height>
	//* 165  327:iconst_m1       
	//* 166  328:icmpeq          340
								l = layoutparams.height;
	//  167  331:aload           13
	//  168  333:getfield        #1108 <Field int ViewPager$LayoutParams.height>
	//  169  336:istore_3        
							else
	//* 170  337:goto            354
								l = j;
	...
	//  181  356:iload           5
	//  182  358:iload           4
	//  183  360:invokestatic    #1086 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  184  363:iload_3         
	//  185  364:iload           10
	//  186  366:invokestatic    #1086 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  187  369:invokevirtual   #1089 <Method void View.measure(int, int)>
						if(flag1)
	//* 188  372:iload           8
	//* 189  374:ifeq            391
						{
	...
	//  190  377:iload_2         
	//  191  378:aload           12
	//  192  380:invokevirtual   #1077 <Method int View.getMeasuredHeight()>
	//  193  383:isub            
	//  194  384:istore          4
							l = i;
	//  195  386:iload_1         
	...
	//  204  401:iload_1         
	//  205  402:aload           12
	//  206  404:invokevirtual   #1074 <Method int View.getMeasuredWidth()>
	//  207  407:isub            
	//  208  408:istore_3        
								k1 = j;
	//  209  409:iload_2         
	...
	//  220  426:aload_0         
	//  221  427:iload_1         
	//  222  428:ldc2            #1081 <Int 0x40000000>
	//  223  431:invokestatic    #1086 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  224  434:putfield        #1110 <Field int mChildWidthMeasureSpec>
		mChildHeightMeasureSpec = android.view.View.MeasureSpec.makeMeasureSpec(j, 0x40000000);
	//  225  437:aload_0         
	//  226  438:iload_2         
	//  227  439:ldc2            #1081 <Int 0x40000000>
	//  228  442:invokestatic    #1086 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  229  445:putfield        #1112 <Field int mChildHeightMeasureSpec>
		mInLayout = true;
	//  230  448:aload_0         
	//  231  449:iconst_1        
	//  232  450:putfield        #648 <Field boolean mInLayout>
		populate();
	//  233  453:aload_0         
	//  234  454:invokevirtual   #1066 <Method void populate()>
		j = 0;
	//  235  457:iconst_0        
	//  236  458:istore_2        
		mInLayout = false;
	//  237  459:aload_0         
	//  238  460:iconst_0        
	//  239  461:putfield        #648 <Field boolean mInLayout>
		for(int i1 = getChildCount(); j < i1; j++)
	//* 240  464:aload_0         
	//* 241  465:invokevirtual   #370 <Method int getChildCount()>
	//* 242  468:istore_3        
	//* 243  469:iload_2         
	//* 244  470:iload_3         
	//* 245  471:icmpge          545
	...
	//  246  474:aload_0         
	//  247  475:iload_2         
	//  248  476:invokevirtual   #376 <Method View getChildAt(int)>
	//  249  479:astore          12
			if(view1.getVisibility() == 8)
				continue;
	//  250  481:aload           12
	//  251  483:invokevirtual   #591 <Method int View.getVisibility()>
	//  252  486:bipush          8
	//  253  488:icmpeq          538
			LayoutParams layoutparams1 = (LayoutParams)view1.getLayoutParams();
	//  254  491:aload           12
	//  255  493:invokevirtual   #534 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	...
	//* 259  503:ifnull          514
	//* 260  506:aload           13
	//* 261  508:getfield        #537 <Field boolean ViewPager$LayoutParams.isDecor>
	//* 262  511:ifne            538
	...
	//  265  517:i2f             
	//  266  518:aload           13
	//  267  520:getfield        #791 <Field float ViewPager$LayoutParams.widthFactor>
	//  268  523:fmul            
	//  269  524:f2i             
	//  270  525:ldc2            #1081 <Int 0x40000000>
	//  271  528:invokestatic    #1086 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  272  531:aload_0         
	//  273  532:getfield        #1112 <Field int mChildHeightMeasureSpec>
	//  274  535:invokevirtual   #1089 <Method void View.measure(int, int)>
		}
	...
	//*  59  123:goto            198
						{
							k1 = view.getMeasuredWidth();
	//   60  126:aload           13
	//   61  128:invokevirtual   #1074 <Method int View.getMeasuredWidth()>
	//   62  131:istore          6
							int j2 = j1 + view.getMeasuredWidth();
	//   63  133:iload           5
	//   64  135:aload           13
	//   65  137:invokevirtual   #1074 <Method int View.getMeasuredWidth()>
	//   66  140:iadd            
	//   67  141:istore          8
							k1 = i3 - j1 - k1;
	//   68  143:iload           11
	...
	//   77  160:aload           13
	//   78  162:invokevirtual   #1114 <Method int View.getWidth()>
	//   79  165:iload           4
	//   80  167:iadd            
	//   81  168:istore          8
						k1 = l;
	...
	//   87  181:iload           11
	//   88  183:aload           13
	//   89  185:invokevirtual   #1074 <Method int View.getMeasuredWidth()>
	//   90  188:isub            
	//   91  189:iconst_2        
	//   92  190:idiv            
	//   93  191:iload           4
	//   94  193:invokestatic    #342 <Method int Math.max(int, int)>
	//   95  196:istore          6
				}
	...
	//   98  202:iadd            
	//   99  203:aload           13
	//  100  205:invokevirtual   #403 <Method int View.getLeft()>
	//  101  208:isub            
	//  102  209:istore          6
				if(k1 != 0)
	//* 103  211:iload           6
	...
	//  105  216:aload           13
	//  106  218:iload           6
	//  107  220:invokevirtual   #1117 <Method void View.offsetLeftAndRight(int)>
			}
	...
	//  115  234:fload_2         
	//  116  235:iload_3         
	//  117  236:invokespecial   #1119 <Method void dispatchOnPageScrolled(int, float, int)>
		if(mPageTransformer != null)
	//* 118  239:aload_0         
	//* 119  240:getfield        #1121 <Field ViewPager$PageTransformer mPageTransformer>
	//* 120  243:ifnull          324
		{
			j = getScrollX();
	//  121  246:aload_0         
	//  122  247:invokevirtual   #286 <Method int getScrollX()>
	//  123  250:istore_3        
			int i1 = getChildCount();
	//  124  251:aload_0         
	//  125  252:invokevirtual   #370 <Method int getChildCount()>
	//  126  255:istore          4
	...
	//  132  266:aload_0         
	//  133  267:iload_1         
	//  134  268:invokevirtual   #376 <Method View getChildAt(int)>
	//  135  271:astore          13
				if(!((LayoutParams)view1.getLayoutParams()).isDecor)
	//* 136  273:aload           13
	//* 137  275:invokevirtual   #534 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//* 138  278:checkcast       #20  <Class ViewPager$LayoutParams>
	//* 139  281:getfield        #537 <Field boolean ViewPager$LayoutParams.isDecor>
	//* 140  284:ifeq            290
	//* 141  287:goto            317
				{
					f = (float)(view1.getLeft() - j) / (float)getClientWidth();
	//  142  290:aload           13
	//  143  292:invokevirtual   #403 <Method int View.getLeft()>
	//  144  295:iload_3         
	//  145  296:isub            
	//  146  297:i2f             
	//  147  298:aload_0         
	//  148  299:invokespecial   #245 <Method int getClientWidth()>
	//  149  302:i2f             
	//  150  303:fdiv            
	//  151  304:fstore_2        
					mPageTransformer.transformPage(view1, f);
	//  152  305:aload_0         
	//  153  306:getfield        #1121 <Field ViewPager$PageTransformer mPageTransformer>
	//  154  309:aload           13
	//  155  311:fload_2         
	//  156  312:invokeinterface #1125 <Method void ViewPager$PageTransformer.transformPage(View, float)>
				}
			}
	...
	//  162  324:aload_0         
	//  163  325:iconst_1        
	//  164  326:putfield        #485 <Field boolean mCalledSuper>
	//  165  329:return          
	}
	...
	//   19   35:aload_2         
	//   20   36:aload_1         
	//   21   37:getfield        #1140 <Field Parcelable ViewPager$SavedState.adapterState>
	//   22   40:aload_1         
	//   23   41:getfield        #1143 <Field ClassLoader ViewPager$SavedState.loader>
	//   24   44:invokevirtual   #1147 <Method void PagerAdapter.restoreState(Parcelable, ClassLoader)>
			setCurrentItemInternal(((SavedState) (parcelable)).position, false, true);
	//   25   47:aload_0         
	//   26   48:aload_1         
	//   27   49:getfield        #1148 <Field int ViewPager$SavedState.position>
	//   28   52:iconst_0        
	//   29   53:iconst_1        
	//   30   54:invokevirtual   #795 <Method void setCurrentItemInternal(int, boolean, boolean)>
			return;
	//   31   57:return          
		} else
		{
	...
	//   32   58:aload_0         
	//   33   59:aload_1         
	//   34   60:getfield        #1148 <Field int ViewPager$SavedState.position>
	//   35   63:putfield        #199 <Field int mRestoredCurItem>
			mRestoredAdapterState = ((SavedState) (parcelable)).adapterState;
	//   36   66:aload_0         
	//   37   67:aload_1         
	//   38   68:getfield        #1140 <Field Parcelable ViewPager$SavedState.adapterState>
	//   39   71:putfield        #201 <Field Parcelable mRestoredAdapterState>
			mRestoredClassLoader = ((SavedState) (parcelable)).loader;
	//   40   74:aload_0         
	//   41   75:aload_1         
	//   42   76:getfield        #1143 <Field ClassLoader ViewPager$SavedState.loader>
	//   43   79:putfield        #203 <Field ClassLoader mRestoredClassLoader>
			return;
	//   44   82:return          
		}
	}
	...
	//   15   29:aload_1         
	//   16   30:aload_2         
	//   17   31:invokevirtual   #1156 <Method Parcelable PagerAdapter.saveState()>
	//   18   34:putfield        #1140 <Field Parcelable ViewPager$SavedState.adapterState>
	...
	//*   8   11:icmpeq          27
		{
			j = mPageMargin;
	//    9   14:aload_0         
	//   10   15:getfield        #247 <Field int mPageMargin>
	//   11   18:istore_2        
	...
	//   15   22:iload_2         
	//   16   23:iload_2         
	//   17   24:invokespecial   #1161 <Method void recomputeScrollPosition(int, int, int, int)>
		}
	//   18   27:return          
	}
	...
	//*  22   43:aload           10
	//*  23   45:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//*  24   48:ifne            53
				return false;
	//   25   51:iconst_0        
	//   26   52:ireturn         
			if(mVelocityTracker == null)
	//*  27   53:aload_0         
	//*  28   54:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//*  29   57:ifnonnull       67
				mVelocityTracker = VelocityTracker.obtain();
	//   30   60:aload_0         
	//   31   61:invokestatic    #730 <Method VelocityTracker VelocityTracker.obtain()>
	//   32   64:putfield        #389 <Field VelocityTracker mVelocityTracker>
			mVelocityTracker.addMovement(motionevent);
	//   33   67:aload_0         
	//   34   68:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//   35   71:aload_1         
	//   36   72:invokevirtual   #742 <Method void VelocityTracker.addMovement(MotionEvent)>
			switch(motionevent.getAction() & 0xff)
	//*  37   75:aload_1         
	//*  38   76:invokevirtual   #1037 <Method int MotionEvent.getAction()>
	//*  39   79:sipush          255
	//*  40   82:iand            
			{
			case 4: // '\004'
	...
	//   43  127:aload_0         
	//   44  128:aload_1         
	//   45  129:invokespecial   #1039 <Method void onSecondaryPointerUp(MotionEvent)>
				mLastMotionX = motionevent.getX(motionevent.findPointerIndex(mActivePointerId));
	//   46  132:aload_0         
	//   47  133:aload_1         
	//   48  134:aload_1         
	//   49  135:aload_0         
	//   50  136:getfield        #213 <Field int mActivePointerId>
	//   51  139:invokevirtual   #1042 <Method int MotionEvent.findPointerIndex(int)>
	//   52  142:invokevirtual   #478 <Method float MotionEvent.getX(int)>
	//   53  145:putfield        #480 <Field float mLastMotionX>
				break;
	//   54  148:goto            604
	...
	//   55  151:aload_1         
	//   56  152:invokevirtual   #472 <Method int MotionEvent.getActionIndex()>
	//   57  155:istore          6
				mLastMotionX = motionevent.getX(j);
	//   58  157:aload_0         
	//   59  158:aload_1         
	//   60  159:iload           6
	//   61  161:invokevirtual   #478 <Method float MotionEvent.getX(int)>
	//   62  164:putfield        #480 <Field float mLastMotionX>
				mActivePointerId = motionevent.getPointerId(j);
	//   63  167:aload_0         
	//   64  168:aload_1         
	//   65  169:iload           6
	//   66  171:invokevirtual   #475 <Method int MotionEvent.getPointerId(int)>
	//   67  174:putfield        #213 <Field int mActivePointerId>
				break;
	//   68  177:goto            604
			...
			case 3: // '\003'
				if(mIsBeingDragged)
	//*  69  180:aload_0         
	//*  70  181:getfield        #385 <Field boolean mIsBeingDragged>
	//*  71  184:ifeq            604
				{
					scrollToItem(mCurItem, true, 0, false);
	//   72  187:aload_0         
	//   73  188:aload_0         
	//   74  189:getfield        #333 <Field int mCurItem>
	//   75  192:iconst_1        
	//   76  193:iconst_0        
	//   77  194:iconst_0        
	//   78  195:invokespecial   #1093 <Method void scrollToItem(int, boolean, int, boolean)>
					flag = resetTouch();
	//   79  198:aload_0         
	//   80  199:invokespecial   #1068 <Method boolean resetTouch()>
	//   81  202:istore          9
				}
				break;
	//   82  204:goto            604
			...
			case 2: // '\002'
				if(!mIsBeingDragged)
	//*  83  207:aload_0         
	//*  84  208:getfield        #385 <Field boolean mIsBeingDragged>
	//*  85  211:ifne            379
				{
					int k = motionevent.findPointerIndex(mActivePointerId);
	//   86  214:aload_1         
	//   87  215:aload_0         
	//   88  216:getfield        #213 <Field int mActivePointerId>
	//   89  219:invokevirtual   #1042 <Method int MotionEvent.findPointerIndex(int)>
	//   90  222:istore          6
					if(k == -1)
	//*  91  224:iload           6
	//*  92  226:iconst_m1       
	//*  93  227:icmpne          239
					{
						flag = resetTouch();
	//   94  230:aload_0         
	//   95  231:invokespecial   #1068 <Method boolean resetTouch()>
	//   96  234:istore          9
						break;
	//   97  236:goto            604
					}
	...
	//   98  239:aload_1         
	//   99  240:iload           6
	//  100  242:invokevirtual   #478 <Method float MotionEvent.getX(int)>
	//  101  245:fstore_2        
					float f5 = Math.abs(f - mLastMotionX);
	//  102  246:fload_2         
	//  103  247:aload_0         
	//  104  248:getfield        #480 <Field float mLastMotionX>
	//  105  251:fsub            
	//  106  252:invokestatic    #502 <Method float Math.abs(float)>
	//  107  255:fstore          4
					float f3 = motionevent.getY(k);
	//  108  257:aload_1         
	//  109  258:iload           6
	//  110  260:invokevirtual   #1045 <Method float MotionEvent.getY(int)>
	//  111  263:fstore_3        
					float f7 = Math.abs(f3 - mLastMotionY);
	//  112  264:fload_3         
	//  113  265:aload_0         
	//  114  266:getfield        #1051 <Field float mLastMotionY>
	//  115  269:fsub            
	//  116  270:invokestatic    #502 <Method float Math.abs(float)>
	//  117  273:fstore          5
					if(f5 > (float)mTouchSlop && f5 > f7)
	//* 118  275:fload           4
	//* 119  277:aload_0         
	//* 120  278:getfield        #979 <Field int mTouchSlop>
	//* 121  281:i2f             
	//* 122  282:fcmpl           
	//* 123  283:ifle            379
	//* 124  286:fload           4
	...
	//  128  294:aload_0         
	//  129  295:iconst_1        
	//  130  296:putfield        #385 <Field boolean mIsBeingDragged>
						requestParentDisallowInterceptTouchEvent(true);
	//  131  299:aload_0         
	//  132  300:iconst_1        
	//  133  301:invokespecial   #1053 <Method void requestParentDisallowInterceptTouchEvent(boolean)>
						float f6 = mInitialMotionX;
	//  134  304:aload_0         
	//  135  305:getfield        #726 <Field float mInitialMotionX>
	//  136  308:fstore          4
						if(f - f6 > 0.0F)
	//* 137  310:fload_2         
	//* 138  311:fload           4
	...
	//  143  319:fload           4
	//  144  321:aload_0         
	//  145  322:getfield        #979 <Field int mTouchSlop>
	//  146  325:i2f             
	//  147  326:fadd            
	//  148  327:fstore_2        
						else
	...
	//  150  331:fload           4
	//  151  333:aload_0         
	//  152  334:getfield        #979 <Field int mTouchSlop>
	//  153  337:i2f             
	//  154  338:fsub            
	//  155  339:fstore_2        
						mLastMotionX = f;
	//  156  340:aload_0         
	//  157  341:fload_2         
	//  158  342:putfield        #480 <Field float mLastMotionX>
						mLastMotionY = f3;
	//  159  345:aload_0         
	//  160  346:fload_3         
	//  161  347:putfield        #1051 <Field float mLastMotionY>
						setScrollState(1);
	//  162  350:aload_0         
	//  163  351:iconst_1        
	//  164  352:invokevirtual   #724 <Method void setScrollState(int)>
						setScrollingCacheEnabled(true);
	//  165  355:aload_0         
	//  166  356:iconst_1        
	//  167  357:invokespecial   #272 <Method void setScrollingCacheEnabled(boolean)>
						ViewParent viewparent = getParent();
	//  168  360:aload_0         
	//  169  361:invokevirtual   #542 <Method ViewParent getParent()>
	//  170  364:astore          10
						if(viewparent != null)
	//* 171  366:aload           10
	//* 172  368:ifnull          379
	...
	//  173  371:aload           10
	//  174  373:iconst_1        
	//  175  374:invokeinterface #547 <Method void ViewParent.requestDisallowInterceptTouchEvent(boolean)>
					}
				}
				if(mIsBeingDragged)
	//* 176  379:aload_0         
	//* 177  380:getfield        #385 <Field boolean mIsBeingDragged>
	//* 178  383:ifeq            604
	...
	//  182  389:aload_1         
	//  183  390:aload_0         
	//  184  391:getfield        #213 <Field int mActivePointerId>
	//  185  394:invokevirtual   #1042 <Method int MotionEvent.findPointerIndex(int)>
	//  186  397:invokevirtual   #478 <Method float MotionEvent.getX(int)>
	//  187  400:invokespecial   #1055 <Method boolean performDrag(float)>
	//  188  403:ior             
	//  189  404:istore          9
				break;
	...
	//* 190  406:goto            604
			case 1: // '\001'
				if(mIsBeingDragged)
	//* 191  409:aload_0         
	//* 192  410:getfield        #385 <Field boolean mIsBeingDragged>
	//* 193  413:ifeq            604
				{
					Object obj = ((Object) (mVelocityTracker));
	//  194  416:aload_0         
	//  195  417:getfield        #389 <Field VelocityTracker mVelocityTracker>
	//  196  420:astore          10
					((VelocityTracker) (obj)).computeCurrentVelocity(1000, mMaximumVelocity);
	//  197  422:aload           10
	//  198  424:sipush          1000
	//  199  427:aload_0         
	//  200  428:getfield        #885 <Field int mMaximumVelocity>
	//  201  431:i2f             
	//  202  432:invokevirtual   #889 <Method void VelocityTracker.computeCurrentVelocity(int, float)>
					int l = (int)((VelocityTracker) (obj)).getXVelocity(mActivePointerId);
	//  203  435:aload           10
	//  204  437:aload_0         
	//  205  438:getfield        #213 <Field int mActivePointerId>
	//  206  441:invokevirtual   #892 <Method float VelocityTracker.getXVelocity(int)>
	//  207  444:f2i             
	//  208  445:istore          6
					mPopulatePending = true;
	//  209  447:aload_0         
	//  210  448:iconst_1        
	//  211  449:putfield        #305 <Field boolean mPopulatePending>
					int i1 = getClientWidth();
	//  212  452:aload_0         
	//  213  453:invokespecial   #245 <Method int getClientWidth()>
	//  214  456:istore          7
					int j1 = getScrollX();
	//  215  458:aload_0         
	//  216  459:invokevirtual   #286 <Method int getScrollX()>
	//  217  462:istore          8
					obj = ((Object) (infoForCurrentScrollPosition()));
	//  218  464:aload_0         
	//  219  465:invokespecial   #495 <Method ViewPager$ItemInfo infoForCurrentScrollPosition()>
	//  220  468:astore          10
					float f4 = mPageMargin;
	//  221  470:aload_0         
	//  222  471:getfield        #247 <Field int mPageMargin>
	//  223  474:i2f             
	//  224  475:fstore_3        
					float f1 = i1;
	//  225  476:iload           7
	...
	//  233  485:aload_0         
	//  234  486:aload           10
	//  235  488:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//  236  491:iload           8
	//  237  493:i2f             
	//  238  494:fload_2         
	//  239  495:fdiv            
	//  240  496:aload           10
	//  241  498:getfield        #253 <Field float ViewPager$ItemInfo.offset>
	//  242  501:fsub            
	//  243  502:aload           10
	//  244  504:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  245  507:fload_3         
	//  246  508:fadd            
	//  247  509:fdiv            
	//  248  510:iload           6
	...
	//  250  513:aload_1         
	//  251  514:aload_0         
	//  252  515:getfield        #213 <Field int mActivePointerId>
	//  253  518:invokevirtual   #1042 <Method int MotionEvent.findPointerIndex(int)>
	//  254  521:invokevirtual   #478 <Method float MotionEvent.getX(int)>
	//  255  524:aload_0         
	//  256  525:getfield        #726 <Field float mInitialMotionX>
	//  257  528:fsub            
	//  258  529:f2i             
	//  259  530:invokespecial   #894 <Method int determineTargetPage(int, float, int, int)>
	//  260  533:iconst_1        
	//  261  534:iconst_1        
	//  262  535:iload           6
	//  263  537:invokevirtual   #897 <Method void setCurrentItemInternal(int, boolean, boolean, int)>
					flag = resetTouch();
	//  264  540:aload_0         
	//  265  541:invokespecial   #1068 <Method boolean resetTouch()>
	//  266  544:istore          9
				}
				break;
	...
	//* 267  546:goto            604
			case 0: // '\0'
				mScroller.abortAnimation();
	//  268  549:aload_0         
	//  269  550:getfield        #274 <Field Scroller mScroller>
	//  270  553:invokevirtual   #283 <Method void Scroller.abortAnimation()>
				mPopulatePending = false;
	//  271  556:aload_0         
	//  272  557:iconst_0        
	//  273  558:putfield        #305 <Field boolean mPopulatePending>
				populate();
	//  274  561:aload_0         
	//  275  562:invokevirtual   #1066 <Method void populate()>
				float f2 = motionevent.getX();
	//  276  565:aload_1         
	//  277  566:invokevirtual   #1058 <Method float MotionEvent.getX()>
	//  278  569:fstore_2        
				mInitialMotionX = f2;
	//  279  570:aload_0         
	//  280  571:fload_2         
	//  281  572:putfield        #726 <Field float mInitialMotionX>
				mLastMotionX = f2;
	//  282  575:aload_0         
	//  283  576:fload_2         
	//  284  577:putfield        #480 <Field float mLastMotionX>
				f2 = motionevent.getY();
	//  285  580:aload_1         
	//  286  581:invokevirtual   #1060 <Method float MotionEvent.getY()>
	//  287  584:fstore_2        
				mInitialMotionY = f2;
	//  288  585:aload_0         
	//  289  586:fload_2         
	//  290  587:putfield        #1047 <Field float mInitialMotionY>
				mLastMotionY = f2;
	//  291  590:aload_0         
	//  292  591:fload_2         
	//  293  592:putfield        #1051 <Field float mLastMotionY>
				mActivePointerId = motionevent.getPointerId(0);
	//  294  595:aload_0         
	//  295  596:aload_1         
	//  296  597:iconst_0        
	//  297  598:invokevirtual   #475 <Method int MotionEvent.getPointerId(int)>
	//  298  601:putfield        #213 <Field int mActivePointerId>
				break;
			}
			if(flag)
	//* 299  604:iload           9
	//* 300  606:ifeq            613
				ViewCompat.postInvalidateOnAnimation(((View) (this)));
	//  301  609:aload_0         
	//  302  610:invokestatic    #769 <Method void ViewCompat.postInvalidateOnAnimation(View)>
			return true;
	//  303  613:iconst_1        
	//  304  614:ireturn         
		} else
	...
	//    8   12:isub            
	//    9   13:iconst_1        
	//   10   14:invokevirtual   #1169 <Method void setCurrentItem(int, boolean)>
			return true;
	//   11   17:iconst_1        
	//   12   18:ireturn         
		} else
	...
	//*   7   13:aload_1         
	//*   8   14:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//*   9   17:iconst_1        
	//*  10   18:isub            
	//*  11   19:icmpge          35
		{
	...
	//   12   22:aload_0         
	//   13   23:aload_0         
	//   14   24:getfield        #333 <Field int mCurItem>
	//   15   27:iconst_1        
	//   16   28:iadd            
	//   17   29:iconst_1        
	//   18   30:invokevirtual   #1169 <Method void setCurrentItem(int, boolean)>
			return true;
	//   19   33:iconst_1        
	//   20   34:ireturn         
		} else
...
label1:
	...
	//    6   12:aload_0         
	//    7   13:iload           5
	//    8   15:invokevirtual   #524 <Method ViewPager$ItemInfo infoForPosition(int)>
	//    9   18:astore          14
					mCurItem = i;
	//   10   20:aload_0         
	//   11   21:iload_1         
	//   12   22:putfield        #333 <Field int mCurItem>
				} else
	//*  13   25:goto            31
				{
					iteminfo5 = null;
	...
	//   15   29:astore          14
				...
				if(mAdapter == null)
	//*  16   31:aload_0         
	//*  17   32:getfield        #236 <Field PagerAdapter mAdapter>
	//*  18   35:ifnonnull       43
				{
					sortChildDrawingOrder();
	//   19   38:aload_0         
	//   20   39:invokespecial   #1175 <Method void sortChildDrawingOrder()>
					return;
	//   21   42:return          
				}
				if(mPopulatePending)
	//*  22   43:aload_0         
	//*  23   44:getfield        #305 <Field boolean mPopulatePending>
	//*  24   47:ifeq            55
				{
					sortChildDrawingOrder();
	//   25   50:aload_0         
	//   26   51:invokespecial   #1175 <Method void sortChildDrawingOrder()>
					return;
	//   27   54:return          
				}
				if(getWindowToken() == null)
	//*  28   55:aload_0         
	//*  29   56:invokevirtual   #1179 <Method android.os.IBinder getWindowToken()>
	//*  30   59:ifnonnull       63
					return;
	//   31   62:return          
				mAdapter.startUpdate(((ViewGroup) (this)));
	//   32   63:aload_0         
	//   33   64:getfield        #236 <Field PagerAdapter mAdapter>
	//   34   67:aload_0         
	//   35   68:invokevirtual   #783 <Method void PagerAdapter.startUpdate(ViewGroup)>
				i = mOffscreenPageLimit;
	//   36   71:aload_0         
	//   37   72:getfield        #211 <Field int mOffscreenPageLimit>
	//   38   75:istore_1        
				l2 = Math.max(0, mCurItem - i);
	//   39   76:iconst_0        
	//   40   77:aload_0         
	//   41   78:getfield        #333 <Field int mCurItem>
	//   42   81:iload_1         
	//   43   82:isub            
	//   44   83:invokestatic    #342 <Method int Math.max(int, int)>
	//   45   86:istore          11
				j2 = mAdapter.getCount();
	//   46   88:aload_0         
	//   47   89:getfield        #236 <Field PagerAdapter mAdapter>
	//   48   92:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//   49   95:istore          9
	...
	//   52  100:isub            
	//   53  101:aload_0         
	//   54  102:getfield        #333 <Field int mCurItem>
	//   55  105:iload_1         
	//   56  106:iadd            
	//   57  107:invokestatic    #339 <Method int Math.min(int, int)>
	//   58  110:istore          10
				if(j2 != mExpectedAdapterCount)
					break label0;
	//   59  112:iload           9
	//   60  114:aload_0         
	//   61  115:getfield        #772 <Field int mExpectedAdapterCount>
	//   62  118:icmpne          1177
				i = 0;
	//   63  121:iconst_0        
	//   64  122:istore_1        
	...
	//   65  123:iload_1         
	//   66  124:aload_0         
	//   67  125:getfield        #189 <Field ArrayList mItems>
	//   68  128:invokevirtual   #259 <Method int ArrayList.size()>
	//   69  131:icmpge          181
					iteminfo = (ItemInfo)mItems.get(i);
	//   70  134:aload_0         
	//   71  135:getfield        #189 <Field ArrayList mItems>
	//   72  138:iload_1         
	//   73  139:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   74  142:checkcast       #17  <Class ViewPager$ItemInfo>
	//   75  145:astore          13
					if(iteminfo.position >= mCurItem)
	//*  76  147:aload           13
	//*  77  149:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//*  78  152:aload_0         
	//*  79  153:getfield        #333 <Field int mCurItem>
	//*  80  156:icmplt          174
					{
						if(iteminfo.position == mCurItem)
	//*  81  159:aload           13
	//*  82  161:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//*  83  164:aload_0         
	//*  84  165:getfield        #333 <Field int mCurItem>
	//*  85  168:icmpne          181
							break label1;
	//   86  171:goto            184
						break;
	...
	//  102  202:aload_0         
	//  103  203:aload_0         
	//  104  204:getfield        #333 <Field int mCurItem>
	//  105  207:iload_1         
	//  106  208:invokevirtual   #1181 <Method ViewPager$ItemInfo addNewItem(int, int)>
	//  107  211:astore          15
			}
			if(iteminfo7 != null)
	//* 108  213:aload           15
	...
	//  116  228:aload_0         
	//  117  229:getfield        #189 <Field ArrayList mItems>
	//  118  232:iload           8
	//  119  234:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//  125  248:aload_0         
	//  126  249:invokespecial   #245 <Method int getClientWidth()>
	//  127  252:istore          12
				float f2;
				if(i3 <= 0)
	//* 128  254:iload           12
	...
	//  133  264:fconst_2        
	//  134  265:aload           15
	//  135  267:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  136  270:fsub            
	//  137  271:aload_0         
	//  138  272:invokevirtual   #439 <Method int getPaddingLeft()>
	//  139  275:i2f             
	//  140  276:iload           12
	//  141  278:i2f             
	//  142  279:fdiv            
	...
	//  144  281:fstore_3        
				int k1 = mCurItem - 1;
	//  145  282:aload_0         
	//  146  283:getfield        #333 <Field int mCurItem>
	//  147  286:iconst_1        
	//  148  287:isub            
	//  149  288:istore          7
				float f4 = 0.0F;
	...
	//* 176  341:iload           7
	//* 177  343:aload           16
	//* 178  345:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 179  348:icmpne          552
						{
							f = f4;
	//  180  351:fload           4
	...
	//* 188  365:aload           16
	//* 189  367:getfield        #308 <Field boolean ViewPager$ItemInfo.scrolling>
	//* 190  370:ifne            552
							{
								mItems.remove(i2);
	//  191  373:aload_0         
	//  192  374:getfield        #189 <Field ArrayList mItems>
	//  193  377:iload           8
	//  194  379:invokevirtual   #779 <Method Object ArrayList.remove(int)>
	//  195  382:pop             
								mAdapter.destroyItem(((ViewGroup) (this)), k1, iteminfo8.object);
	//  196  383:aload_0         
	//  197  384:getfield        #236 <Field PagerAdapter mAdapter>
	//  198  387:aload_0         
	//  199  388:iload           7
	//  200  390:aload           16
	//  201  392:getfield        #619 <Field Object ViewPager$ItemInfo.object>
	//  202  395:invokevirtual   #787 <Method void PagerAdapter.destroyItem(ViewGroup, int, Object)>
								k = i2 - 1;
	//  203  398:iload           8
	//  204  400:iconst_1        
	//  205  401:isub            
	...
	//  213  414:aload_0         
	//  214  415:getfield        #189 <Field ArrayList mItems>
	//  215  418:iload           5
	//  216  420:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//* 227  445:iload           7
	//* 228  447:aload           16
	//* 229  449:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 230  452:icmpne          501
					{
						f = f4 + iteminfo8.widthFactor;
	//  231  455:fload           4
	//  232  457:aload           16
	//  233  459:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  234  462:fadd            
	//  235  463:fstore_2        
						k = i2 - 1;
	//  236  464:iload           8
	...
	//* 241  472:iflt            492
							iteminfo2 = (ItemInfo)mItems.get(k);
	//  242  475:aload_0         
	//  243  476:getfield        #189 <Field ArrayList mItems>
	//  244  479:iload           5
	//  245  481:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//  258  508:iconst_1        
	//  259  509:iadd            
	//  260  510:invokevirtual   #1181 <Method ViewPager$ItemInfo addNewItem(int, int)>
	//  261  513:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  262  516:fadd            
	//  263  517:fstore_2        
						i = j1 + 1;
	//  264  518:iload           6
	...
	//  270  528:aload_0         
	//  271  529:getfield        #189 <Field ArrayList mItems>
	//  272  532:iload           8
	//  273  534:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//  294  575:aload           15
	//  295  577:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  296  580:fstore          4
				int l = j1 + 1;
	//  297  582:iload           6
	//  298  584:iconst_1        
	...
	//* 305  595:iload           5
	//* 306  597:aload_0         
	//* 307  598:getfield        #189 <Field ArrayList mItems>
	//* 308  601:invokevirtual   #259 <Method int ArrayList.size()>
	//* 309  604:icmpge          624
						iteminfo3 = (ItemInfo)mItems.get(l);
	//  310  607:aload_0         
	//  311  608:getfield        #189 <Field ArrayList mItems>
	//  312  611:iload           5
	//  313  613:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//  324  637:aload_0         
	//  325  638:invokevirtual   #442 <Method int getPaddingRight()>
	//  326  641:i2f             
	//  327  642:iload           12
	//  328  644:i2f             
	//  329  645:fdiv            
	...
	//  332  648:fstore_3        
					i = mCurItem;
	//  333  649:aload_0         
	//  334  650:getfield        #333 <Field int mCurItem>
	//  335  653:istore_1        
	...
	//* 361  702:iload           7
	//* 362  704:aload           16
	//* 363  706:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 364  709:icmpne          918
							{
								f1 = f4;
	//  365  712:fload           4
	...
	//* 371  722:aload           16
	//* 372  724:getfield        #308 <Field boolean ViewPager$ItemInfo.scrolling>
	//* 373  727:ifne            918
								{
									mItems.remove(l);
	//  374  730:aload_0         
	//  375  731:getfield        #189 <Field ArrayList mItems>
	//  376  734:iload           5
	//  377  736:invokevirtual   #779 <Method Object ArrayList.remove(int)>
	//  378  739:pop             
									mAdapter.destroyItem(((ViewGroup) (this)), l1, iteminfo9.object);
	//  379  740:aload_0         
	//  380  741:getfield        #236 <Field PagerAdapter mAdapter>
	//  381  744:aload_0         
	//  382  745:iload           7
	//  383  747:aload           16
	//  384  749:getfield        #619 <Field Object ViewPager$ItemInfo.object>
	//  385  752:invokevirtual   #787 <Method void PagerAdapter.destroyItem(ViewGroup, int, Object)>
									if(l < mItems.size())
	//* 386  755:iload           5
	//* 387  757:aload_0         
	//* 388  758:getfield        #189 <Field ArrayList mItems>
	//* 389  761:invokevirtual   #259 <Method int ArrayList.size()>
	//* 390  764:icmpge          790
									{
										iteminfo4 = (ItemInfo)mItems.get(l);
	//  391  767:aload_0         
	//  392  768:getfield        #189 <Field ArrayList mItems>
	//  393  771:iload           5
	//  394  773:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//* 411  807:iload           7
	//* 412  809:aload           16
	//* 413  811:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 414  814:icmpne          864
						{
							f1 = f4 + iteminfo9.widthFactor;
	//  415  817:fload           4
	//  416  819:aload           16
	//  417  821:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  418  824:fadd            
	//  419  825:fstore_2        
							i = l + 1;
	//  420  826:iload           5
	...
	//* 424  831:iload_1         
	//* 425  832:aload_0         
	//* 426  833:getfield        #189 <Field ArrayList mItems>
	//* 427  836:invokevirtual   #259 <Method int ArrayList.size()>
	//* 428  839:icmpge          858
								iteminfo4 = (ItemInfo)mItems.get(i);
	//  429  842:aload_0         
	//  430  843:getfield        #189 <Field ArrayList mItems>
	//  431  846:iload_1         
	//  432  847:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//  440  865:iload           7
	//  441  867:iload           5
	//  442  869:invokevirtual   #1181 <Method ViewPager$ItemInfo addNewItem(int, int)>
	//  443  872:astore          13
							i = l + 1;
	//  444  874:iload           5
	//  445  876:iconst_1        
	...
	//  448  879:fload           4
	//  449  881:aload           13
	//  450  883:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  451  886:fadd            
	//  452  887:fstore_2        
							if(i < mItems.size())
	//* 453  888:iload_1         
	//* 454  889:aload_0         
	//* 455  890:getfield        #189 <Field ArrayList mItems>
	//* 456  893:invokevirtual   #259 <Method int ArrayList.size()>
	//* 457  896:icmpge          915
								iteminfo4 = (ItemInfo)mItems.get(i);
	//  458  899:aload_0         
	//  459  900:getfield        #189 <Field ArrayList mItems>
	//  460  903:iload_1         
	//  461  904:invokevirtual   #263 <Method Object ArrayList.get(int)>
	...
	//  478  937:iload           6
	//  479  939:aload           14
	//  480  941:invokespecial   #1183 <Method void calculatePageOffsets(ViewPager$ItemInfo, int, ViewPager$ItemInfo)>
				mAdapter.setPrimaryItem(((ViewGroup) (this)), mCurItem, iteminfo7.object);
	//  481  944:aload_0         
	//  482  945:getfield        #236 <Field PagerAdapter mAdapter>
	//  483  948:aload_0         
	//  484  949:aload_0         
	//  485  950:getfield        #333 <Field int mCurItem>
	//  486  953:aload           15
	//  487  955:getfield        #619 <Field Object ViewPager$ItemInfo.object>
	//  488  958:invokevirtual   #1186 <Method void PagerAdapter.setPrimaryItem(ViewGroup, int, Object)>
			}
			mAdapter.finishUpdate(((ViewGroup) (this)));
	//  489  961:aload_0         
	//  490  962:getfield        #236 <Field PagerAdapter mAdapter>
	//  491  965:aload_0         
	//  492  966:invokevirtual   #790 <Method void PagerAdapter.finishUpdate(ViewGroup)>
			int i1 = getChildCount();
	//  493  969:aload_0         
	//  494  970:invokevirtual   #370 <Method int getChildCount()>
	//  495  973:istore          5
			for(i = 0; i < i1; i++)
	//* 496  975:iconst_0        
	//* 497  976:istore_1        
	...
	//  501  983:aload_0         
	//  502  984:iload_1         
	//  503  985:invokevirtual   #376 <Method View getChildAt(int)>
	//  504  988:astore          14
				LayoutParams layoutparams = (LayoutParams)((View) (obj1)).getLayoutParams();
	//  505  990:aload           14
	//  506  992:invokevirtual   #534 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//  507  995:checkcast       #20  <Class ViewPager$LayoutParams>
	//  508  998:astore          13
				layoutparams.childIndex = i;
	//  509 1000:aload           13
	//  510 1002:iload_1         
	//  511 1003:putfield        #933 <Field int ViewPager$LayoutParams.childIndex>
				if(layoutparams.isDecor || layoutparams.widthFactor != 0.0F)
					continue;
	//  512 1006:aload           13
	//  513 1008:getfield        #537 <Field boolean ViewPager$LayoutParams.isDecor>
	//  514 1011:ifne            1057
	//  515 1014:aload           13
	//  516 1016:getfield        #791 <Field float ViewPager$LayoutParams.widthFactor>
	//  517 1019:fconst_0        
	//  518 1020:fcmpl           
	//  519 1021:ifne            1057
	...
	//  520 1024:aload_0         
	//  521 1025:aload           14
	//  522 1027:invokevirtual   #595 <Method ViewPager$ItemInfo infoForChild(View)>
	//  523 1030:astore          14
				if(obj1 != null)
	//* 524 1032:aload           14
	...
	//  526 1037:aload           13
	//  527 1039:aload           14
	//  528 1041:getfield        #256 <Field float ViewPager$ItemInfo.widthFactor>
	//  529 1044:putfield        #791 <Field float ViewPager$LayoutParams.widthFactor>
					layoutparams.position = ((ItemInfo) (obj1)).position;
	//  530 1047:aload           13
	//  531 1049:aload           14
	//  532 1051:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//  533 1054:putfield        #1187 <Field int ViewPager$LayoutParams.position>
				}
			}
	...
	//* 538 1061:goto            977
			sortChildDrawingOrder();
	//  539 1064:aload_0         
	//  540 1065:invokespecial   #1175 <Method void sortChildDrawingOrder()>
			if(hasFocus())
	//* 541 1068:aload_0         
	//* 542 1069:invokevirtual   #1190 <Method boolean hasFocus()>
	//* 543 1072:ifeq            1176
			{
				Object obj = ((Object) (findFocus()));
	//  544 1075:aload_0         
	//  545 1076:invokevirtual   #664 <Method View findFocus()>
	//  546 1079:astore          13
				if(obj != null)
	//* 547 1081:aload           13
	...
	//  549 1086:aload_0         
	//  550 1087:aload           13
	//  551 1089:invokevirtual   #1192 <Method ViewPager$ItemInfo infoForAnyChild(View)>
	//  552 1092:astore          13
				else
	//* 553 1094:goto            1100
					obj = null;
	...
	//* 558 1105:aload           13
	//* 559 1107:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 560 1110:aload_0         
	//* 561 1111:getfield        #333 <Field int mCurItem>
	...
	//* 565 1119:iload_1         
	//* 566 1120:aload_0         
	//* 567 1121:invokevirtual   #370 <Method int getChildCount()>
	//* 568 1124:icmpge          1176
					{
						View view = getChildAt(i);
	//  569 1127:aload_0         
	//  570 1128:iload_1         
	//  571 1129:invokevirtual   #376 <Method View getChildAt(int)>
	//  572 1132:astore          13
						ItemInfo iteminfo6 = infoForChild(view);
	//  573 1134:aload_0         
	//  574 1135:aload           13
	//  575 1137:invokevirtual   #595 <Method ViewPager$ItemInfo infoForChild(View)>
	//  576 1140:astore          14
						if(iteminfo6 != null && iteminfo6.position == mCurItem && view.requestFocus(2))
	//* 577 1142:aload           14
	//* 578 1144:ifnull          1169
	//* 579 1147:aload           14
	//* 580 1149:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//* 581 1152:aload_0         
	//* 582 1153:getfield        #333 <Field int mCurItem>
	//* 583 1156:icmpne          1169
	//* 584 1159:aload           13
	//* 585 1161:iconst_2        
	//* 586 1162:invokevirtual   #1194 <Method boolean View.requestFocus(int)>
	//* 587 1165:ifeq            1169
							return;
	//  588 1168:return          
					}
	...
	//  595 1177:aload_0         
	//  596 1178:invokevirtual   #1195 <Method Resources getResources()>
	//  597 1181:aload_0         
	//  598 1182:invokevirtual   #1198 <Method int getId()>
	//  599 1185:invokevirtual   #1202 <Method String Resources.getResourceName(int)>
	//  600 1188:astore          13
		}
	//* 601 1190:goto            1202
	//* 602 1193:aload_0         
	//* 603 1194:invokevirtual   #1198 <Method int getId()>
	//* 604 1197:invokestatic    #1207 <Method String Integer.toHexString(int)>
	//* 605 1200:astore          13
	//* 606 1202:new             #667 <Class StringBuilder>
	//* 607 1205:dup             
	//* 608 1206:invokespecial   #668 <Method void StringBuilder()>
	//* 609 1209:astore          14
	//* 610 1211:aload           14
	//* 611 1213:ldc2            #1209 <String "The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: ">
	//* 612 1216:invokevirtual   #676 <Method StringBuilder StringBuilder.append(String)>
	//* 613 1219:pop             
	//* 614 1220:aload           14
	//* 615 1222:aload_0         
	//* 616 1223:getfield        #772 <Field int mExpectedAdapterCount>
	//* 617 1226:invokevirtual   #1212 <Method StringBuilder StringBuilder.append(int)>
	//* 618 1229:pop             
	//* 619 1230:aload           14
	//* 620 1232:ldc2            #1214 <String ", found: ">
	//* 621 1235:invokevirtual   #676 <Method StringBuilder StringBuilder.append(String)>
	//* 622 1238:pop             
	//* 623 1239:aload           14
	//* 624 1241:iload           9
	//* 625 1243:invokevirtual   #1212 <Method StringBuilder StringBuilder.append(int)>
	//* 626 1246:pop             
	//* 627 1247:aload           14
	//* 628 1249:ldc2            #1216 <String " Pager id: ">
	//* 629 1252:invokevirtual   #676 <Method StringBuilder StringBuilder.append(String)>
	//* 630 1255:pop             
	//* 631 1256:aload           14
	//* 632 1258:aload           13
	//* 633 1260:invokevirtual   #676 <Method StringBuilder StringBuilder.append(String)>
	//* 634 1263:pop             
	//* 635 1264:aload           14
	//* 636 1266:ldc2            #1218 <String " Pager class: ">
	//* 637 1269:invokevirtual   #676 <Method StringBuilder StringBuilder.append(String)>
	//* 638 1272:pop             
	//* 639 1273:aload           14
	//* 640 1275:aload_0         
	//* 641 1276:invokevirtual   #452 <Method Class Object.getClass()>
	//* 642 1279:invokevirtual   #1221 <Method StringBuilder StringBuilder.append(Object)>
	//* 643 1282:pop             
	//* 644 1283:aload           14
	//* 645 1285:ldc2            #1223 <String " Problematic adapter: ">
	//* 646 1288:invokevirtual   #676 <Method StringBuilder StringBuilder.append(String)>
	//* 647 1291:pop             
	//* 648 1292:aload           14
	//* 649 1294:aload_0         
	//* 650 1295:getfield        #236 <Field PagerAdapter mAdapter>
	//* 651 1298:invokevirtual   #452 <Method Class Object.getClass()>
	//* 652 1301:invokevirtual   #1221 <Method StringBuilder StringBuilder.append(Object)>
	//* 653 1304:pop             
	//* 654 1305:new             #488 <Class IllegalStateException>
	//* 655 1308:dup             
	//* 656 1309:aload           14
	//* 657 1311:invokevirtual   #683 <Method String StringBuilder.toString()>
	//* 658 1314:invokespecial   #493 <Method void IllegalStateException(String)>
	//* 659 1317:athrow          
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokeinterface #1226 <Method boolean List.remove(Object)>
	//    8   16:pop             
	//    9   17:return          
	}
	...
	//    7   13:aload           6
	//    8   15:aconst_null     
	//    9   16:invokevirtual   #1239 <Method void PagerAdapter.setViewPagerObserver(DataSetObserver)>
			mAdapter.startUpdate(((ViewGroup) (this)));
	//   10   19:aload_0         
	//   11   20:getfield        #236 <Field PagerAdapter mAdapter>
	//   12   23:aload_0         
	//   13   24:invokevirtual   #783 <Method void PagerAdapter.startUpdate(ViewGroup)>
			for(int i = 0; i < mItems.size(); i++)
	//*  14   27:iconst_0        
	//*  15   28:istore_2        
	//*  16   29:iload_2         
	//*  17   30:aload_0         
	//*  18   31:getfield        #189 <Field ArrayList mItems>
	//*  19   34:invokevirtual   #259 <Method int ArrayList.size()>
	//*  20   37:icmpge          78
			{
				obj = ((Object) ((ItemInfo)mItems.get(i)));
	//   21   40:aload_0         
	//   22   41:getfield        #189 <Field ArrayList mItems>
	//   23   44:iload_2         
	//   24   45:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   25   48:checkcast       #17  <Class ViewPager$ItemInfo>
	//   26   51:astore          6
				mAdapter.destroyItem(((ViewGroup) (this)), ((ItemInfo) (obj)).position, ((ItemInfo) (obj)).object);
	//   27   53:aload_0         
	//   28   54:getfield        #236 <Field PagerAdapter mAdapter>
	//   29   57:aload_0         
	//   30   58:aload           6
	//   31   60:getfield        #250 <Field int ViewPager$ItemInfo.position>
	//   32   63:aload           6
	//   33   65:getfield        #619 <Field Object ViewPager$ItemInfo.object>
	//   34   68:invokevirtual   #787 <Method void PagerAdapter.destroyItem(ViewGroup, int, Object)>
			}
	...
	//*  39   75:goto            29
			mAdapter.finishUpdate(((ViewGroup) (this)));
	//   40   78:aload_0         
	//   41   79:getfield        #236 <Field PagerAdapter mAdapter>
	//   42   82:aload_0         
	//   43   83:invokevirtual   #790 <Method void PagerAdapter.finishUpdate(ViewGroup)>
			mItems.clear();
	//   44   86:aload_0         
	//   45   87:getfield        #189 <Field ArrayList mItems>
	//   46   90:invokevirtual   #572 <Method void ArrayList.clear()>
			removeNonDecorViews();
	//   47   93:aload_0         
	//   48   94:invokespecial   #1241 <Method void removeNonDecorViews()>
			mCurItem = 0;
	//   49   97:aload_0         
	//   50   98:iconst_0        
	//   51   99:putfield        #333 <Field int mCurItem>
			scrollTo(0, 0);
	//   52  102:aload_0         
	//   53  103:iconst_0        
	//   54  104:iconst_0        
	//   55  105:invokevirtual   #299 <Method void scrollTo(int, int)>
		}
		obj = ((Object) (mAdapter));
	//   56  108:aload_0         
	//   57  109:getfield        #236 <Field PagerAdapter mAdapter>
	//   58  112:astore          6
		mAdapter = pageradapter;
	//   59  114:aload_0         
	//   60  115:aload_1         
	//   61  116:putfield        #236 <Field PagerAdapter mAdapter>
		mExpectedAdapterCount = 0;
	//   62  119:aload_0         
	//   63  120:iconst_0        
	//   64  121:putfield        #772 <Field int mExpectedAdapterCount>
		if(mAdapter != null)
	//*  65  124:aload_0         
	//*  66  125:getfield        #236 <Field PagerAdapter mAdapter>
	//*  67  128:ifnull          254
		{
			if(mObserver == null)
	//*  68  131:aload_0         
	//*  69  132:getfield        #1243 <Field ViewPager$PagerObserver mObserver>
	...
	//   73  142:dup             
	//   74  143:aload_0         
	//   75  144:invokespecial   #1244 <Method void ViewPager$PagerObserver(ViewPager)>
	//   76  147:putfield        #1243 <Field ViewPager$PagerObserver mObserver>
			mAdapter.setViewPagerObserver(((DataSetObserver) (mObserver)));
	//   77  150:aload_0         
	//   78  151:getfield        #236 <Field PagerAdapter mAdapter>
	//   79  154:aload_0         
	//   80  155:getfield        #1243 <Field ViewPager$PagerObserver mObserver>
	//   81  158:invokevirtual   #1239 <Method void PagerAdapter.setViewPagerObserver(DataSetObserver)>
			mPopulatePending = false;
	//   82  161:aload_0         
	//   83  162:iconst_0        
	//   84  163:putfield        #305 <Field boolean mPopulatePending>
			boolean flag1 = mFirstLayout;
	//   85  166:aload_0         
	//   86  167:getfield        #215 <Field boolean mFirstLayout>
	//   87  170:istore          5
			mFirstLayout = true;
	//   88  172:aload_0         
	//   89  173:iconst_1        
	//   90  174:putfield        #215 <Field boolean mFirstLayout>
			mExpectedAdapterCount = mAdapter.getCount();
	//   91  177:aload_0         
	//   92  178:aload_0         
	//   93  179:getfield        #236 <Field PagerAdapter mAdapter>
	//   94  182:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//   95  185:putfield        #772 <Field int mExpectedAdapterCount>
			if(mRestoredCurItem >= 0)
	//*  96  188:aload_0         
	//*  97  189:getfield        #199 <Field int mRestoredCurItem>
	//*  98  192:iflt            238
			{
				mAdapter.restoreState(mRestoredAdapterState, mRestoredClassLoader);
	//   99  195:aload_0         
	//  100  196:getfield        #236 <Field PagerAdapter mAdapter>
	//  101  199:aload_0         
	//  102  200:getfield        #201 <Field Parcelable mRestoredAdapterState>
	//  103  203:aload_0         
	//  104  204:getfield        #203 <Field ClassLoader mRestoredClassLoader>
	//  105  207:invokevirtual   #1147 <Method void PagerAdapter.restoreState(Parcelable, ClassLoader)>
				setCurrentItemInternal(mRestoredCurItem, false, true);
	//  106  210:aload_0         
	//  107  211:aload_0         
	//  108  212:getfield        #199 <Field int mRestoredCurItem>
	//  109  215:iconst_0        
	//  110  216:iconst_1        
	//  111  217:invokevirtual   #795 <Method void setCurrentItemInternal(int, boolean, boolean)>
				mRestoredCurItem = -1;
	//  112  220:aload_0         
	//  113  221:iconst_m1       
	//  114  222:putfield        #199 <Field int mRestoredCurItem>
				mRestoredAdapterState = null;
	//  115  225:aload_0         
	//  116  226:aconst_null     
	//  117  227:putfield        #201 <Field Parcelable mRestoredAdapterState>
				mRestoredClassLoader = null;
	//  118  230:aload_0         
	//  119  231:aconst_null     
	//  120  232:putfield        #203 <Field ClassLoader mRestoredClassLoader>
			} else
	//* 121  235:goto            254
			if(!flag1)
	//* 122  238:iload           5
	//* 123  240:ifne            250
				populate();
	//  124  243:aload_0         
	//  125  244:invokevirtual   #1066 <Method void populate()>
			else
	//* 126  247:goto            254
				requestLayout();
	//  127  250:aload_0         
	//  128  251:invokevirtual   #798 <Method void requestLayout()>
		}
		List list = mAdapterChangeListeners;
	//  129  254:aload_0         
	//  130  255:getfield        #626 <Field List mAdapterChangeListeners>
	//  131  258:astore          7
	...
	//    3    3:iload_3         
	//    4    4:iconst_0        
	//    5    5:invokevirtual   #897 <Method void setCurrentItemInternal(int, boolean, boolean, int)>
	//    6    8:return          
	}
	...
	//*   4    8:ifnull          210
	//*   5   11:aload           7
	//*   6   13:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//*   7   16:ifgt            22
	//*   8   19:goto            210
		{
	...
	//*  10   23:ifne            50
	//*  11   26:aload_0         
	//*  12   27:getfield        #333 <Field int mCurItem>
	//*  13   30:iload_1         
	//*  14   31:icmpne          50
	//*  15   34:aload_0         
	//*  16   35:getfield        #189 <Field ArrayList mItems>
	//*  17   38:invokevirtual   #259 <Method int ArrayList.size()>
	//*  18   41:ifeq            50
			{
				setScrollingCacheEnabled(false);
	//   19   44:aload_0         
	//   20   45:iconst_0        
	//   21   46:invokespecial   #272 <Method void setScrollingCacheEnabled(boolean)>
				return;
	//   22   49:return          
			}
			flag1 = true;
	...
	//*  32   65:iload_1         
	//*  33   66:aload_0         
	//*  34   67:getfield        #236 <Field PagerAdapter mAdapter>
	//*  35   70:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//*  36   73:icmplt          87
					k = mAdapter.getCount() - 1;
	//   37   76:aload_0         
	//   38   77:getfield        #236 <Field PagerAdapter mAdapter>
	//   39   80:invokevirtual   #242 <Method int PagerAdapter.getCount()>
	//   40   83:iconst_1        
	//   41   84:isub            
	//   42   85:istore          5
			}
			i = mOffscreenPageLimit;
	//   43   87:aload_0         
	//   44   88:getfield        #211 <Field int mOffscreenPageLimit>
	//   45   91:istore_1        
			int l = mCurItem;
	//   46   92:aload_0         
	...
	//*  61  118:iload_1         
	//*  62  119:aload_0         
	//*  63  120:getfield        #189 <Field ArrayList mItems>
	//*  64  123:invokevirtual   #259 <Method int ArrayList.size()>
	//*  65  126:icmpge          151
					((ItemInfo)mItems.get(i)).scrolling = true;
	//   66  129:aload_0         
	//   67  130:getfield        #189 <Field ArrayList mItems>
	//   68  133:iload_1         
	//   69  134:invokevirtual   #263 <Method Object ArrayList.get(int)>
	//   70  137:checkcast       #17  <Class ViewPager$ItemInfo>
	//   71  140:iconst_1        
	//   72  141:putfield        #308 <Field boolean ViewPager$ItemInfo.scrolling>
	...
	//*  77  148:goto            118
			if(mCurItem == k)
	//*  78  151:aload_0         
	//*  79  152:getfield        #333 <Field int mCurItem>
	//*  80  155:iload           5
	//*  81  157:icmpeq          163
	//*  82  160:goto            165
				flag1 = false;
	...
	//   84  164:istore_3        
			if(mFirstLayout)
	//*  85  165:aload_0         
	//*  86  166:getfield        #215 <Field boolean mFirstLayout>
	//*  87  169:ifeq            193
			{
				mCurItem = k;
	//   88  172:aload_0         
	//   89  173:iload           5
	//   90  175:putfield        #333 <Field int mCurItem>
				if(flag1)
	//*  91  178:iload_3         
	//*  92  179:ifeq            188
	...
	//   93  182:aload_0         
	//   94  183:iload           5
	//   95  185:invokespecial   #564 <Method void dispatchOnPageSelected(int)>
				requestLayout();
	//   96  188:aload_0         
	//   97  189:invokevirtual   #798 <Method void requestLayout()>
				return;
	//   98  192:return          
			} else
			{
	...
	//   99  193:aload_0         
	//  100  194:iload           5
	//  101  196:invokevirtual   #1171 <Method void populate(int)>
	...
	//  105  203:iload           4
	//  106  205:iload_3         
	//  107  206:invokespecial   #1093 <Method void scrollToItem(int, boolean, int, boolean)>
				return;
	//  108  209:return          
			}
		} else
	...
	//  109  210:aload_0         
	//  110  211:iconst_0        
	//  111  212:invokespecial   #272 <Method void setScrollingCacheEnabled(boolean)>
			return;
	//  112  215:return          
		}
	}
	...
	//   13   23:aload_3         
	//   14   24:iload_1         
	//   15   25:invokevirtual   #1212 <Method StringBuilder StringBuilder.append(int)>
	//   16   28:pop             
	...
	//   21   37:aload_3         
	//   22   38:iconst_1        
	//   23   39:invokevirtual   #1212 <Method StringBuilder StringBuilder.append(int)>
	//   24   42:pop             
	...
	//*  11   21:ifnull          38
	//*  12   24:aload           11
	//*  13   26:invokevirtual   #280 <Method boolean Scroller.isFinished()>
	//*  14   29:ifne            38
			flag = true;
	//   15   32:iconst_1        
	//   16   33:istore          7
	...
	//*  21   43:ifeq            89
		{
			if(mIsScrollStarted)
	//*  22   46:aload_0         
	//*  23   47:getfield        #762 <Field boolean mIsScrollStarted>
	//*  24   50:ifeq            65
				l = mScroller.getCurrX();
	//   25   53:aload_0         
	//   26   54:getfield        #274 <Field Scroller mScroller>
	//   27   57:invokevirtual   #292 <Method int Scroller.getCurrX()>
	//   28   60:istore          7
			else
	//*  29   62:goto            74
				l = mScroller.getStartX();
	//   30   65:aload_0         
	//   31   66:getfield        #274 <Field Scroller mScroller>
	//   32   69:invokevirtual   #1295 <Method int Scroller.getStartX()>
	//   33   72:istore          7
			mScroller.abortAnimation();
	//   34   74:aload_0         
	//   35   75:getfield        #274 <Field Scroller mScroller>
	//   36   78:invokevirtual   #283 <Method void Scroller.abortAnimation()>
			setScrollingCacheEnabled(false);
	//   37   81:aload_0         
	//   38   82:iconst_0        
	//   39   83:invokespecial   #272 <Method void setScrollingCacheEnabled(boolean)>
		} else
	//*  40   86:goto            95
		{
			l = getScrollX();
	//   41   89:aload_0         
	//   42   90:invokevirtual   #286 <Method int getScrollX()>
	//   43   93:istore          7
		}
		int i1 = getScrollY();
	//   44   95:aload_0         
	//   45   96:invokevirtual   #289 <Method int getScrollY()>
	//   46   99:istore          8
		int j1 = i - l;
	//   47  101:iload_1         
	//   48  102:iload           7
	...
	//   59  121:aload_0         
	//   60  122:iconst_0        
	//   61  123:invokespecial   #529 <Method void completeScroll(boolean)>
			populate();
	//   62  126:aload_0         
	//   63  127:invokevirtual   #1066 <Method void populate()>
			setScrollState(0);
	//   64  130:aload_0         
	//   65  131:iconst_0        
	//   66  132:invokevirtual   #724 <Method void setScrollState(int)>
			return;
	//   67  135:return          
		}
		setScrollingCacheEnabled(true);
	//   68  136:aload_0         
	//   69  137:iconst_1        
	//   70  138:invokespecial   #272 <Method void setScrollingCacheEnabled(boolean)>
		setScrollState(2);
	//   71  141:aload_0         
	//   72  142:iconst_2        
	//   73  143:invokevirtual   #724 <Method void setScrollState(int)>
		i = getClientWidth();
	//   74  146:aload_0         
	//   75  147:invokespecial   #245 <Method int getClientWidth()>
	//   76  150:istore_1        
		int k1 = i / 2;
	//   77  151:iload_1         
	//   78  152:iconst_2        
	...
	//   81  156:iload           9
	//   82  158:invokestatic    #327 <Method int Math.abs(int)>
	//   83  161:i2f             
	//   84  162:fstore          5
		float f = i;
	//   85  164:iload_1         
	...
	//   92  173:fload           4
	//   93  175:fdiv            
	//   94  176:invokestatic    #527 <Method float Math.min(float, float)>
	//   95  179:fstore          6
		f1 = k1;
	//   96  181:iload           10
	//   97  183:i2f             
	...
	//   99  186:aload_0         
	//  100  187:fload           6
	//  101  189:invokevirtual   #1297 <Method float distanceInfluenceForSnapDuration(float)>
	//  102  192:fstore          6
		i = Math.abs(k);
	//  103  194:iload_3         
	//  104  195:invokestatic    #327 <Method int Math.abs(int)>
	//  105  198:istore_1        
		if(i > 0)
	//* 106  199:iload_1         
	//* 107  200:ifle            230
	...
	//  114  212:i2f             
	//  115  213:fdiv            
	//  116  214:invokestatic    #502 <Method float Math.abs(float)>
	//  117  217:ldc2            #1298 <Float 1000F>
	//  118  220:fmul            
	//  119  221:invokestatic    #1026 <Method int Math.round(float)>
	//  120  224:iconst_4        
	//  121  225:imul            
	//  122  226:istore_1        
		} else
	...
	//  124  230:aload_0         
	//  125  231:getfield        #236 <Field PagerAdapter mAdapter>
	//  126  234:aload_0         
	//  127  235:getfield        #333 <Field int mCurItem>
	//  128  238:invokevirtual   #267 <Method float PagerAdapter.getPageWidth(int)>
	//  129  241:fstore          5
			i = (int)(((float)Math.abs(j1) / (f * f2 + (float)mPageMargin) + 1.0F) * 100F);
	//  130  243:iload           9
	//  131  245:invokestatic    #327 <Method int Math.abs(int)>
	//  132  248:i2f             
	//  133  249:fload           4
	//  134  251:fload           5
	//  135  253:fmul            
	//  136  254:aload_0         
	//  137  255:getfield        #247 <Field int mPageMargin>
	//  138  258:i2f             
	//  139  259:fadd            
	//  140  260:fdiv            
	//  141  261:fconst_1        
	//  142  262:fadd            
	//  143  263:ldc2            #1299 <Float 100F>
	//  144  266:fmul            
	//  145  267:f2i             
	//  146  268:istore_1        
		}
	...
	//  147  269:iload_1         
	//  148  270:sipush          600
	//  149  273:invokestatic    #339 <Method int Math.min(int, int)>
	//  150  276:istore_1        
		mIsScrollStarted = false;
	//  151  277:aload_0         
	//  152  278:iconst_0        
	//  153  279:putfield        #762 <Field boolean mIsScrollStarted>
		mScroller.startScroll(l, i1, j1, j, i);
	//  154  282:aload_0         
	//  155  283:getfield        #274 <Field Scroller mScroller>
	//  156  286:iload           7
	//  157  288:iload           8
	//  158  290:iload           9
	//  159  292:iload_2         
	//  160  293:iload_1         
	//  161  294:invokevirtual   #1303 <Method void Scroller.startScroll(int, int, int, int, int)>
		ViewCompat.postInvalidateOnAnimation(((View) (this)));
	//  162  297:aload_0         
	//  163  298:invokestatic    #769 <Method void ViewCompat.postInvalidateOnAnimation(View)>
	//  164  301:return          
	}
