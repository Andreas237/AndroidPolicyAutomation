...
;
	...
	//    2    4:aload_0         
	//    3    5:getfield        #58  <Field AsyncLayoutInflater$InflateThread mInflateThread>
	//    4    8:invokevirtual   #69  <Method AsyncLayoutInflater$InflateRequest AsyncLayoutInflater$InflateThread.obtainRequest()>
	//    5   11:astore          4
			inflaterequest.inflater = this;
	//    6   13:aload           4
	//    7   15:aload_0         
	//    8   16:putfield        #73  <Field AsyncLayoutInflater AsyncLayoutInflater$InflateRequest.inflater>
			inflaterequest.resid = i;
	//    9   19:aload           4
	//   10   21:iload_1         
	//   11   22:putfield        #77  <Field int AsyncLayoutInflater$InflateRequest.resid>
			inflaterequest.parent = viewgroup;
	//   12   25:aload           4
	//   13   27:aload_2         
	//   14   28:putfield        #81  <Field ViewGroup AsyncLayoutInflater$InflateRequest.parent>
			inflaterequest.callback = oninflatefinishedlistener;
	//   15   31:aload           4
	//   16   33:aload_3         
	//   17   34:putfield        #85  <Field AsyncLayoutInflater$OnInflateFinishedListener AsyncLayoutInflater$InflateRequest.callback>
			mInflateThread.enqueue(inflaterequest);
	//   18   37:aload_0         
	//   19   38:getfield        #58  <Field AsyncLayoutInflater$InflateThread mInflateThread>
	//   20   41:aload           4
	//   21   43:invokevirtual   #89  <Method void AsyncLayoutInflater$InflateThread.enqueue(AsyncLayoutInflater$InflateRequest)>
			return;
	//   22   46:return          
		} else
		{
			throw new NullPointerException("callback argument may not be null!");
	//   23   47:new             #91  <Class NullPointerException>
	//   24   50:dup             
	//   25   51:ldc1            #93  <String "callback argument may not be null!">
	//   26   53:invokespecial   #96  <Method void NullPointerException(String)>
	//   27   56:athrow          
		}
	}
