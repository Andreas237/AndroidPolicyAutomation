...
public final class FingerprintManagerCompat
{
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #30  <Method void FingerprintManagerCompat(Context)>
	//    4    8:areturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #44  <Method PackageManager Context.getPackageManager()>
	//*   2    4:ldc1            #46  <String "android.hardware.fingerprint">
	//*   3    6:invokevirtual   #52  <Method boolean PackageManager.hasSystemFeature(String)>
	//*   4    9:ifeq            22
			return (FingerprintManager)context.getSystemService(android/hardware/fingerprint/FingerprintManager);
	//    5   12:aload_0         
	//    6   13:ldc1            #54  <Class FingerprintManager>
	//    7   15:invokevirtual   #58  <Method Object Context.getSystemService(Class)>
	//    8   18:checkcast       #54  <Class FingerprintManager>
	//    9   21:areturn         
		else
			return null;
	//   10   22:aconst_null     
	...
	//*   4    6:aload_0         
	//*   5    7:invokevirtual   #66  <Method Cipher android.hardware.fingerprint.FingerprintManager$CryptoObject.getCipher()>
	//*   6   10:ifnull          25
			return new CryptoObject(cryptoobject.getCipher());
	//    7   13:new             #14  <Class FingerprintManagerCompat$CryptoObject>
	//    8   16:dup             
	//    9   17:aload_0         
	//   10   18:invokevirtual   #66  <Method Cipher android.hardware.fingerprint.FingerprintManager$CryptoObject.getCipher()>
	//   11   21:invokespecial   #69  <Method void FingerprintManagerCompat$CryptoObject(Cipher)>
	//   12   24:areturn         
		if(cryptoobject.getSignature() != null)
	//*  13   25:aload_0         
	//*  14   26:invokevirtual   #73  <Method Signature android.hardware.fingerprint.FingerprintManager$CryptoObject.getSignature()>
	//*  15   29:ifnull          44
			return new CryptoObject(cryptoobject.getSignature());
	//   16   32:new             #14  <Class FingerprintManagerCompat$CryptoObject>
	//   17   35:dup             
	//   18   36:aload_0         
	//   19   37:invokevirtual   #73  <Method Signature android.hardware.fingerprint.FingerprintManager$CryptoObject.getSignature()>
	//   20   40:invokespecial   #76  <Method void FingerprintManagerCompat$CryptoObject(Signature)>
	//   21   43:areturn         
		if(cryptoobject.getMac() != null)
	//*  22   44:aload_0         
	//*  23   45:invokevirtual   #80  <Method Mac android.hardware.fingerprint.FingerprintManager$CryptoObject.getMac()>
	//*  24   48:ifnull          63
			return new CryptoObject(cryptoobject.getMac());
	//   25   51:new             #14  <Class FingerprintManagerCompat$CryptoObject>
	//   26   54:dup             
	//   27   55:aload_0         
	//   28   56:invokevirtual   #80  <Method Mac android.hardware.fingerprint.FingerprintManager$CryptoObject.getMac()>
	//   29   59:invokespecial   #83  <Method void FingerprintManagerCompat$CryptoObject(Mac)>
	//   30   62:areturn         
		else
			return null;
	//   31   63:aconst_null     
	...
	private static android.hardware.fingerprint.FingerprintManager.AuthenticationCallback wrapCallback(AuthenticationCallback authenticationcallback)
	{
		return ((android.hardware.fingerprint.FingerprintManager.AuthenticationCallback) (new android.hardware.fingerprint.FingerprintManager.AuthenticationCallback(authenticationcallback) {
			...
			//    6   12:invokestatic    #45  <Method FingerprintManagerCompat$CryptoObject FingerprintManagerCompat.unwrapCryptoObject(android.hardware.fingerprint.FingerprintManager$CryptoObject)>
	...
	//    1    3:dup             
	//    2    4:aload_0         
	//    3    5:invokespecial   #88  <Method void FingerprintManagerCompat$1(FingerprintManagerCompat$AuthenticationCallback)>
	//    4    8:areturn         
	}
	...
	//    3    5:areturn         
		if(cryptoobject.getCipher() != null)
	//*   4    6:aload_0         
	//*   5    7:invokevirtual   #91  <Method Cipher FingerprintManagerCompat$CryptoObject.getCipher()>
	//*   6   10:ifnull          25
			return new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getCipher());
	//    7   13:new             #62  <Class android.hardware.fingerprint.FingerprintManager$CryptoObject>
	//    8   16:dup             
	//    9   17:aload_0         
	//   10   18:invokevirtual   #91  <Method Cipher FingerprintManagerCompat$CryptoObject.getCipher()>
	//   11   21:invokespecial   #92  <Method void android.hardware.fingerprint.FingerprintManager$CryptoObject(Cipher)>
	//   12   24:areturn         
		if(cryptoobject.getSignature() != null)
	//*  13   25:aload_0         
	//*  14   26:invokevirtual   #93  <Method Signature FingerprintManagerCompat$CryptoObject.getSignature()>
	//*  15   29:ifnull          44
			return new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getSignature());
	//   16   32:new             #62  <Class android.hardware.fingerprint.FingerprintManager$CryptoObject>
	//   17   35:dup             
	//   18   36:aload_0         
	//   19   37:invokevirtual   #93  <Method Signature FingerprintManagerCompat$CryptoObject.getSignature()>
	//   20   40:invokespecial   #94  <Method void android.hardware.fingerprint.FingerprintManager$CryptoObject(Signature)>
	//   21   43:areturn         
		if(cryptoobject.getMac() != null)
	//*  22   44:aload_0         
	//*  23   45:invokevirtual   #95  <Method Mac FingerprintManagerCompat$CryptoObject.getMac()>
	//*  24   48:ifnull          63
			return new android.hardware.fingerprint.FingerprintManager.CryptoObject(cryptoobject.getMac());
	//   25   51:new             #62  <Class android.hardware.fingerprint.FingerprintManager$CryptoObject>
	//   26   54:dup             
	//   27   55:aload_0         
	//   28   56:invokevirtual   #95  <Method Mac FingerprintManagerCompat$CryptoObject.getMac()>
	//   29   59:invokespecial   #96  <Method void android.hardware.fingerprint.FingerprintManager$CryptoObject(Mac)>
	//   30   62:areturn         
		else
			return null;
	//   31   63:aconst_null     
	...
	//    5   12:invokestatic    #108 <Method FingerprintManager getFingerprintManagerOrNull(Context)>
	//    6   15:astore          6
	...
	//   11   26:aload_3         
	//   12   27:invokevirtual   #114 <Method Object CancellationSignal.getCancellationSignalObject()>
	//   13   30:checkcast       #116 <Class android.os.CancellationSignal>
	//   14   33:astore_3        
				else
	//*  15   34:goto            39
	...
	//   18   39:aload           6
	//   19   41:aload_1         
	//   20   42:invokestatic    #118 <Method android.hardware.fingerprint.FingerprintManager$CryptoObject wrapCryptoObject(FingerprintManagerCompat$CryptoObject)>
	//   21   45:aload_3         
	//   22   46:iload_2         
	//   23   47:aload           4
	//   24   49:invokestatic    #120 <Method android.hardware.fingerprint.FingerprintManager$AuthenticationCallback wrapCallback(FingerprintManagerCompat$AuthenticationCallback)>
	//   25   52:aload           5
	//   26   54:invokevirtual   #123 <Method void FingerprintManager.authenticate(android.hardware.fingerprint.FingerprintManager$CryptoObject, android.os.CancellationSignal, int, android.hardware.fingerprint.FingerprintManager$AuthenticationCallback, Handler)>
			}
		}
	//   27   57:return          
	}
	...
	//    9   16:invokestatic    #108 <Method FingerprintManager getFingerprintManagerOrNull(Context)>
	//   10   19:astore          4
			boolean flag = flag1;
	//   11   21:iload_3         
	//   12   22:istore_2        
	...
	//*  17   30:aload           4
	//*  18   32:invokevirtual   #127 <Method boolean FingerprintManager.hasEnrolledFingerprints()>
	//*  19   35:ifeq            40
					flag = true;
	//   20   38:iconst_1        
	//   21   39:istore_2        
	...
	//*  17   30:aload           4
	//*  18   32:invokevirtual   #130 <Method boolean FingerprintManager.isHardwareDetected()>
	//*  19   35:ifeq            40
					flag = true;
	//   20   38:iconst_1        
	//   21   39:istore_2        
