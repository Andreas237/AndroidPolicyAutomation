	...
	implements Parcelable
{
	...
	//*   7   13:ifnull          32
			{
				handler.post(((Runnable) (new MyRunnable(i, bundle))));
	//    8   16:aload_3         
	//    9   17:new             #13  <Class ResultReceiver$MyRunnable>
	//   10   20:dup             
	//   11   21:aload_0         
	//   12   22:iload_1         
	//   13   23:aload_2         
	//   14   24:invokespecial   #66  <Method void ResultReceiver$MyRunnable(ResultReceiver, int, Bundle)>
	//   15   27:invokevirtual   #72  <Method boolean Handler.post(Runnable)>
	//   16   30:pop             
				return;
	//   17   31:return          
			} else
	...
	//   19   33:iload_1         
	//   20   34:aload_2         
	//   21   35:invokevirtual   #74  <Method void onReceiveResult(int, Bundle)>
				return;
	//   22   38:return          
			}
		}
	...
	//   23   39:aload_0         
	//   24   40:getfield        #56  <Field IResultReceiver mReceiver>
	//   25   43:astore_3        
	...
	//   29   49:iload_1         
	//   30   50:aload_2         
	//   31   51:invokeinterface #78  <Method void IResultReceiver.send(int, Bundle)>
		return;
	//   32   56:return          
		bundle;
	//   33   57:astore_2        
