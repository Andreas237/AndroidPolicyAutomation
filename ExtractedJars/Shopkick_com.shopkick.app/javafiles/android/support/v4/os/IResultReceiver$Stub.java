...
public static abstract class IResultReceiver$Stub extends Binder
	implements IResultReceiver
{
	...
	//    2    4:aconst_null     
	//    3    5:areturn         
		android.os.IInterface iinterface = ibinder.queryLocalInterface("android.support.v4.os.IResultReceiver");
	//    4    6:aload_0         
	...
	//   13   21:aload_3         
	//   14   22:ldc1            #14  <String "android.support.v4.os.IResultReceiver">
	...
	//   18   29:aload_2         
	//   19   30:ldc1            #14  <String "android.support.v4.os.IResultReceiver">
	...
	//   23   39:istore_1        
		if(parcel.readInt() != 0)
	//*  24   40:aload_2         
	//*  25   41:invokevirtual   #59  <Method int Parcel.readInt()>
	//*  26   44:ifeq            63
			parcel = ((Parcel) ((Bundle)Bundle.CREATOR.createFromParcel(parcel)));
	//   27   47:getstatic       #65  <Field android.os.Parcelable$Creator Bundle.CREATOR>
	//   28   50:aload_2         
	//   29   51:invokeinterface #71  <Method Object android.os.Parcelable$Creator.createFromParcel(Parcel)>
	//   30   56:checkcast       #61  <Class Bundle>
	//   31   59:astore_2        
		else
	//*  32   60:goto            65
			parcel = null;
	...
	//   36   66:iload_1         
	//   37   67:aload_2         
	//   38   68:invokevirtual   #75  <Method void send(int, Bundle)>
		return true;
	//   39   71:iconst_1        
	//   40   72:ireturn         
	}
	...
	//    1    1:invokespecial   #21  <Method void Binder()>
		attachInterface(((android.os.IInterface) (this)), "android.support.v4.os.IResultReceiver");
	//    2    4:aload_0         
	//    3    5:aload_0         
