...
public static abstract class ICustomTabsService$Stub extends Binder
	implements ICustomTabsService
{
		...
		implements ICustomTabsService
	{
		...
		//    0    0:ldc1            #34  <String "android.support.customtabs.ICustomTabsService">
		//    1    2:areturn         
		}
...
_L1:
		...
		//    9   21:aload_1         
		//   10   22:invokeinterface #86  <Method IBinder ICustomTabsCallback.asBinder()>
		//   11   27:astore_1        
		//*  12   28:goto            31
_L4:
		...
		//   13   31:aload           7
		//   14   33:aload_1         
		//   15   34:invokevirtual   #89  <Method void Parcel.writeStrongBinder(IBinder)>
			boolean flag;
			flag = true;
		//   16   37:iconst_1        
		//   17   38:istore          6
		...
		//   24   51:aload           7
		//   25   53:iconst_0        
		//   26   54:invokevirtual   #92  <Method void Uri.writeToParcel(Parcel, int)>
		...
		//   44   92:aload           7
		//   45   94:aload           4
		//   46   96:invokevirtual   #96  <Method void Parcel.writeTypedList(List)>
...
_L4:
		...
		//   27   57:aload           6
		//   28   59:iconst_0        
		//   29   60:invokevirtual   #92  <Method void Uri.writeToParcel(Parcel, int)>
...
_L3:
		...
		//    7   17:aload           5
		//    8   19:lload_1         
		//    9   20:invokevirtual   #114 <Method void Parcel.writeLong(long)>
			ibinder = mRemote;
		//   10   23:aload_0         
	...
	//    2    4:aconst_null     
	//    3    5:areturn         
		android.os.IInterface iinterface = ibinder.queryLocalInterface("android.support.customtabs.ICustomTabsService");
	//    4    6:aload_0         
	//    5    7:ldc1            #14  <String "android.support.customtabs.ICustomTabsService">
	//    6    9:invokeinterface #48  <Method android.os.IInterface IBinder.queryLocalInterface(String)>
	//    7   14:astore_1        
	...
	//   17   34:dup             
	//   18   35:aload_0         
	//   19   36:invokespecial   #51  <Method void ICustomTabsService$Stub$Proxy(IBinder)>
	//   20   39:areturn         
	}
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #35  <Method void Binder()>
		attachInterface(((android.os.IInterface) (this)), "android.support.customtabs.ICustomTabsService");
	//    2    4:aload_0         
	//    3    5:aload_0         
	//    4    6:ldc1            #14  <String "android.support.customtabs.ICustomTabsService">
	//    5    8:invokevirtual   #39  <Method void attachInterface(android.os.IInterface, String)>
	//    6   11:return          
	}
}
