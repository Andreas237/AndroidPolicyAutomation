...
public class VectorDrawableCompat extends VectorDrawableCommon
{
	...
	private static class VFullPath extends VPath
	{
		...
		//    4   30:getstatic       #79  <Field android.graphics.Paint$Cap android.graphics.Paint$Cap.SQUARE>
		//    5   33:areturn         

			case 1: // '\001'
				return android.graphics.Paint.Cap.ROUND;
		//    6   34:getstatic       #82  <Field android.graphics.Paint$Cap android.graphics.Paint$Cap.ROUND>
		//    7   37:areturn         
		...
		//    4   30:getstatic       #87  <Field android.graphics.Paint$Join android.graphics.Paint$Join.BEVEL>
		//    5   33:areturn         

			case 1: // '\001'
				return android.graphics.Paint.Join.ROUND;
		//    6   34:getstatic       #89  <Field android.graphics.Paint$Join android.graphics.Paint$Join.ROUND>
		//    7   37:areturn         
		...
		//    0    0:aload_0         
		//    1    1:aconst_null     
		//    2    2:putfield        #70  <Field int[] mThemeAttrs>
			if(!TypedArrayUtils.hasAttribute(xmlpullparser, "pathData"))
		//*   3    5:aload_2         
		//*   4    6:ldc1            #93  <String "pathData">
		//*   5    8:invokestatic    #99  <Method boolean TypedArrayUtils.hasAttribute(XmlPullParser, String)>
		//*   6   11:ifne            15
				return;
		//    7   14:return          
			String s = typedarray.getString(0);
		//    8   15:aload_1         
		//    9   16:iconst_0        
		//   10   17:invokevirtual   #105 <Method String TypedArray.getString(int)>
		//   11   20:astore          4
			if(s != null)
		//*  12   22:aload           4
		//*  13   24:ifnull          33
		...
		//   14   27:aload_0         
		//   15   28:aload           4
		//   16   30:putfield        #109 <Field String mPathName>
			s = typedarray.getString(2);
		//   17   33:aload_1         
		//   18   34:iconst_2        
		//   19   35:invokevirtual   #105 <Method String TypedArray.getString(int)>
		//   20   38:astore          4
			if(s != null)
		//*  21   40:aload           4
		//*  22   42:ifnull          54
		...
		//   23   45:aload_0         
		//   24   46:aload           4
		//   25   48:invokestatic    #115 <Method android.support.v4.graphics.PathParser$PathDataNode[] PathParser.createNodesFromPathData(String)>
		//   26   51:putfield        #119 <Field android.support.v4.graphics.PathParser$PathDataNode[] mNodes>
			mFillColor = TypedArrayUtils.getNamedComplexColor(typedarray, xmlpullparser, theme, "fillColor", 1, 0);
		//   27   54:aload_0         
		//   28   55:aload_1         
		//   29   56:aload_2         
		//   30   57:aload_3         
		//   31   58:ldc1            #121 <String "fillColor">
		//   32   60:iconst_1        
		//   33   61:iconst_0        
		//   34   62:invokestatic    #125 <Method ComplexColorCompat TypedArrayUtils.getNamedComplexColor(TypedArray, XmlPullParser, android.content.res.Resources$Theme, String, int, int)>
		//   35   65:putfield        #74  <Field ComplexColorCompat mFillColor>
			mFillAlpha = TypedArrayUtils.getNamedFloat(typedarray, xmlpullparser, "fillAlpha", 12, mFillAlpha);
		//   36   68:aload_0         
		//   37   69:aload_1         
		//   38   70:aload_2         
		//   39   71:ldc1            #127 <String "fillAlpha">
		//   40   73:bipush          12
		//   41   75:aload_0         
		//   42   76:getfield        #40  <Field float mFillAlpha>
		//   43   79:invokestatic    #131 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
		//   44   82:putfield        #40  <Field float mFillAlpha>
			mStrokeLineCap = getStrokeLineCap(TypedArrayUtils.getNamedInt(typedarray, xmlpullparser, "strokeLineCap", 8, -1), mStrokeLineCap);
		//   45   85:aload_0         
		//   46   86:aload_0         
		//   47   87:aload_1         
		//   48   88:aload_2         
		//   49   89:ldc1            #133 <String "strokeLineCap">
		//   50   91:bipush          8
		//   51   93:iconst_m1       
		//   52   94:invokestatic    #137 <Method int TypedArrayUtils.getNamedInt(TypedArray, XmlPullParser, String, int, int)>
		//   53   97:aload_0         
		//   54   98:getfield        #53  <Field android.graphics.Paint$Cap mStrokeLineCap>
		//   55  101:invokespecial   #139 <Method android.graphics.Paint$Cap getStrokeLineCap(int, android.graphics.Paint$Cap)>
		//   56  104:putfield        #53  <Field android.graphics.Paint$Cap mStrokeLineCap>
		...
		//   59  109:aload_1         
		//   60  110:aload_2         
		//   61  111:ldc1            #141 <String "strokeLineJoin">
		//   62  113:bipush          9
		//   63  115:iconst_m1       
		//   64  116:invokestatic    #137 <Method int TypedArrayUtils.getNamedInt(TypedArray, XmlPullParser, String, int, int)>
		//   65  119:aload_0         
		//   66  120:getfield        #60  <Field android.graphics.Paint$Join mStrokeLineJoin>
		//   67  123:invokespecial   #143 <Method android.graphics.Paint$Join getStrokeLineJoin(int, android.graphics.Paint$Join)>
		//   68  126:putfield        #60  <Field android.graphics.Paint$Join mStrokeLineJoin>
			mStrokeMiterlimit = TypedArrayUtils.getNamedFloat(typedarray, xmlpullparser, "strokeMiterLimit", 10, mStrokeMiterlimit);
		//   69  129:aload_0         
		//   70  130:aload_1         
		//   71  131:aload_2         
		//   72  132:ldc1            #145 <String "strokeMiterLimit">
		//   73  134:bipush          10
		//   74  136:aload_0         
		//   75  137:getfield        #63  <Field float mStrokeMiterlimit>
		//   76  140:invokestatic    #131 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
		//   77  143:putfield        #63  <Field float mStrokeMiterlimit>
			mStrokeColor = TypedArrayUtils.getNamedComplexColor(typedarray, xmlpullparser, theme, "strokeColor", 3, 0);
		//   78  146:aload_0         
		//   79  147:aload_1         
		//   80  148:aload_2         
		//   81  149:aload_3         
		//   82  150:ldc1            #147 <String "strokeColor">
		//   83  152:iconst_3        
		//   84  153:iconst_0        
		//   85  154:invokestatic    #125 <Method ComplexColorCompat TypedArrayUtils.getNamedComplexColor(TypedArray, XmlPullParser, android.content.res.Resources$Theme, String, int, int)>
		//   86  157:putfield        #72  <Field ComplexColorCompat mStrokeColor>
			mStrokeAlpha = TypedArrayUtils.getNamedFloat(typedarray, xmlpullparser, "strokeAlpha", 11, mStrokeAlpha);
		//   87  160:aload_0         
		//   88  161:aload_1         
		//   89  162:aload_2         
		//   90  163:ldc1            #149 <String "strokeAlpha">
		//   91  165:bipush          11
		//   92  167:aload_0         
		//   93  168:getfield        #36  <Field float mStrokeAlpha>
		//   94  171:invokestatic    #131 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
		//   95  174:putfield        #36  <Field float mStrokeAlpha>
			mStrokeWidth = TypedArrayUtils.getNamedFloat(typedarray, xmlpullparser, "strokeWidth", 4, mStrokeWidth);
		//   96  177:aload_0         
		//   97  178:aload_1         
		//   98  179:aload_2         
		//   99  180:ldc1            #151 <String "strokeWidth">
		//  100  182:iconst_4        
		//  101  183:aload_0         
		//  102  184:getfield        #34  <Field float mStrokeWidth>
		//  103  187:invokestatic    #131 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
		//  104  190:putfield        #34  <Field float mStrokeWidth>
			mTrimPathEnd = TypedArrayUtils.getNamedFloat(typedarray, xmlpullparser, "trimPathEnd", 6, mTrimPathEnd);
		//  105  193:aload_0         
		//  106  194:aload_1         
		//  107  195:aload_2         
		//  108  196:ldc1            #153 <String "trimPathEnd">
		//  109  198:bipush          6
		//  110  200:aload_0         
		//  111  201:getfield        #44  <Field float mTrimPathEnd>
		//  112  204:invokestatic    #131 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
		//  113  207:putfield        #44  <Field float mTrimPathEnd>
			mTrimPathOffset = TypedArrayUtils.getNamedFloat(typedarray, xmlpullparser, "trimPathOffset", 7, mTrimPathOffset);
		//  114  210:aload_0         
		//  115  211:aload_1         
		//  116  212:aload_2         
		//  117  213:ldc1            #155 <String "trimPathOffset">
		//  118  215:bipush          7
		//  119  217:aload_0         
		//  120  218:getfield        #46  <Field float mTrimPathOffset>
		//  121  221:invokestatic    #131 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
		//  122  224:putfield        #46  <Field float mTrimPathOffset>
			mTrimPathStart = TypedArrayUtils.getNamedFloat(typedarray, xmlpullparser, "trimPathStart", 5, mTrimPathStart);
		//  123  227:aload_0         
		//  124  228:aload_1         
		//  125  229:aload_2         
		//  126  230:ldc1            #157 <String "trimPathStart">
		//  127  232:iconst_5        
		//  128  233:aload_0         
		//  129  234:getfield        #42  <Field float mTrimPathStart>
		//  130  237:invokestatic    #131 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
		//  131  240:putfield        #42  <Field float mTrimPathStart>
			mFillRule = TypedArrayUtils.getNamedInt(typedarray, xmlpullparser, "fillType", 13, mFillRule);
		//  132  243:aload_0         
		//  133  244:aload_1         
		//  134  245:aload_2         
		//  135  246:ldc1            #159 <String "fillType">
		//  136  248:bipush          13
		//  137  250:aload_0         
		//  138  251:getfield        #38  <Field int mFillRule>
		//  139  254:invokestatic    #137 <Method int TypedArrayUtils.getNamedInt(TypedArray, XmlPullParser, String, int, int)>
		//  140  257:putfield        #38  <Field int mFillRule>
		//  141  260:return          
		}
		...
		public void applyTheme(android.content.res.Resources.Theme theme)
		{
			if(mThemeAttrs == null)
		//*   0    0:aload_0         
		//*   1    1:getfield        #70  <Field int[] mThemeAttrs>
		//*   2    4:ifnonnull       8
				return;
		//    3    7:return          
			else
		...
		float getFillAlpha()
		{
			return mFillAlpha;
		//    0    0:aload_0         
		//    1    1:getfield        #40  <Field float mFillAlpha>
		//    2    4:freturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #74  <Field ComplexColorCompat mFillColor>
		//    2    4:invokevirtual   #173 <Method int ComplexColorCompat.getColor()>
		//    3    7:ireturn         
		}
		...
		float getStrokeAlpha()
		{
			return mStrokeAlpha;
		//    0    0:aload_0         
		//    1    1:getfield        #36  <Field float mStrokeAlpha>
		//    2    4:freturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #72  <Field ComplexColorCompat mStrokeColor>
		//    2    4:invokevirtual   #173 <Method int ComplexColorCompat.getColor()>
		//    3    7:ireturn         
		}
		...
		float getStrokeWidth()
		{
			return mStrokeWidth;
		//    0    0:aload_0         
		//    1    1:getfield        #34  <Field float mStrokeWidth>
		//    2    4:freturn         
		}
		...
		float getTrimPathEnd()
		{
			return mTrimPathEnd;
		//    0    0:aload_0         
		//    1    1:getfield        #44  <Field float mTrimPathEnd>
		//    2    4:freturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #46  <Field float mTrimPathOffset>
		//    2    4:freturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #42  <Field float mTrimPathStart>
		//    2    4:freturn         
		}
		...
		//    1    1:aload_3         
		//    2    2:aload_2         
		//    3    3:getstatic       #187 <Field int[] AndroidResources.STYLEABLE_VECTOR_DRAWABLE_PATH>
		//    4    6:invokestatic    #191 <Method TypedArray TypedArrayUtils.obtainAttributes(Resources, android.content.res.Resources$Theme, AttributeSet, int[])>
		//    5    9:astore_1        
		...
		//    8   12:aload           4
		//    9   14:aload_3         
		//   10   15:invokespecial   #193 <Method void updateStateFromTypedArray(TypedArray, XmlPullParser, android.content.res.Resources$Theme)>
			((TypedArray) (resources)).recycle();
		//   11   18:aload_1         
		//   12   19:invokevirtual   #196 <Method void TypedArray.recycle()>
		//   13   22:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #74  <Field ComplexColorCompat mFillColor>
		//    2    4:invokevirtual   #199 <Method boolean ComplexColorCompat.isStateful()>
		//    3    7:ifne            25
		//    4   10:aload_0         
		//    5   11:getfield        #72  <Field ComplexColorCompat mStrokeColor>
		//    6   14:invokevirtual   #199 <Method boolean ComplexColorCompat.isStateful()>
		//    7   17:ifeq            23
		//    8   20:goto            25
		//    9   23:iconst_0        
		//   10   24:ireturn         
		...
		//    1    1:getfield        #74  <Field ComplexColorCompat mFillColor>
		//    2    4:aload_1         
		//    3    5:invokevirtual   #203 <Method boolean ComplexColorCompat.onStateChanged(int[])>
		//    4    8:istore_2        
			return mStrokeColor.onStateChanged(ai) | flag;
		//    5    9:aload_0         
		//    6   10:getfield        #72  <Field ComplexColorCompat mStrokeColor>
		//    7   13:aload_1         
		//    8   14:invokevirtual   #203 <Method boolean ComplexColorCompat.onStateChanged(int[])>
		//    9   17:iload_2         
		//   10   18:ior             
		//   11   19:ireturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:fload_1         
		//    2    2:putfield        #40  <Field float mFillAlpha>
		//    3    5:return          
		}
		...
		//    1    1:getfield        #74  <Field ComplexColorCompat mFillColor>
		//    2    4:iload_1         
		//    3    5:invokevirtual   #210 <Method void ComplexColorCompat.setColor(int)>
		//    4    8:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:fload_1         
		//    2    2:putfield        #36  <Field float mStrokeAlpha>
		//    3    5:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:fload_1         
		//    2    2:putfield        #34  <Field float mStrokeWidth>
		//    3    5:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:fload_1         
		//    2    2:putfield        #44  <Field float mTrimPathEnd>
		//    3    5:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:fload_1         
		//    2    2:putfield        #46  <Field float mTrimPathOffset>
		//    3    5:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:fload_1         
		//    2    2:putfield        #42  <Field float mTrimPathStart>
		//    3    5:return          
		}
		...
		{
		//    0    0:aload_0         
		//    1    1:invokespecial   #32  <Method void VectorDrawableCompat$VPath()>
			mStrokeWidth = 0.0F;
		//    2    4:aload_0         
		//    3    5:fconst_0        
		//    4    6:putfield        #34  <Field float mStrokeWidth>
			mStrokeAlpha = 1.0F;
		//    5    9:aload_0         
		//    6   10:fconst_1        
		//    7   11:putfield        #36  <Field float mStrokeAlpha>
			mFillRule = 0;
		//    8   14:aload_0         
		//    9   15:iconst_0        
		//   10   16:putfield        #38  <Field int mFillRule>
			mFillAlpha = 1.0F;
		//   11   19:aload_0         
		//   12   20:fconst_1        
		//   13   21:putfield        #40  <Field float mFillAlpha>
			mTrimPathStart = 0.0F;
		//   14   24:aload_0         
		//   15   25:fconst_0        
		//   16   26:putfield        #42  <Field float mTrimPathStart>
			mTrimPathEnd = 1.0F;
		//   17   29:aload_0         
		//   18   30:fconst_1        
		//   19   31:putfield        #44  <Field float mTrimPathEnd>
			mTrimPathOffset = 0.0F;
		//   20   34:aload_0         
		//   21   35:fconst_0        
		//   22   36:putfield        #46  <Field float mTrimPathOffset>
			mStrokeLineCap = android.graphics.Paint.Cap.BUTT;
		//   23   39:aload_0         
		//   24   40:getstatic       #51  <Field android.graphics.Paint$Cap android.graphics.Paint$Cap.BUTT>
		//   25   43:putfield        #53  <Field android.graphics.Paint$Cap mStrokeLineCap>
			mStrokeLineJoin = android.graphics.Paint.Join.MITER;
		//   26   46:aload_0         
		//   27   47:getstatic       #58  <Field android.graphics.Paint$Join android.graphics.Paint$Join.MITER>
		//   28   50:putfield        #60  <Field android.graphics.Paint$Join mStrokeLineJoin>
			mStrokeMiterlimit = 4F;
		//   29   53:aload_0         
		//   30   54:ldc1            #61  <Float 4F>
		//   31   56:putfield        #63  <Field float mStrokeMiterlimit>
		//   32   59:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokespecial   #68  <Method void VectorDrawableCompat$VPath(VectorDrawableCompat$VPath)>
			mStrokeWidth = 0.0F;
		//    3    5:aload_0         
		//    4    6:fconst_0        
		//    5    7:putfield        #34  <Field float mStrokeWidth>
			mStrokeAlpha = 1.0F;
		//    6   10:aload_0         
		//    7   11:fconst_1        
		//    8   12:putfield        #36  <Field float mStrokeAlpha>
			mFillRule = 0;
		//    9   15:aload_0         
		//   10   16:iconst_0        
		//   11   17:putfield        #38  <Field int mFillRule>
			mFillAlpha = 1.0F;
		//   12   20:aload_0         
		//   13   21:fconst_1        
		//   14   22:putfield        #40  <Field float mFillAlpha>
			mTrimPathStart = 0.0F;
		//   15   25:aload_0         
		//   16   26:fconst_0        
		//   17   27:putfield        #42  <Field float mTrimPathStart>
			mTrimPathEnd = 1.0F;
		//   18   30:aload_0         
		//   19   31:fconst_1        
		//   20   32:putfield        #44  <Field float mTrimPathEnd>
			mTrimPathOffset = 0.0F;
		//   21   35:aload_0         
		//   22   36:fconst_0        
		//   23   37:putfield        #46  <Field float mTrimPathOffset>
			mStrokeLineCap = android.graphics.Paint.Cap.BUTT;
		//   24   40:aload_0         
		//   25   41:getstatic       #51  <Field android.graphics.Paint$Cap android.graphics.Paint$Cap.BUTT>
		//   26   44:putfield        #53  <Field android.graphics.Paint$Cap mStrokeLineCap>
			mStrokeLineJoin = android.graphics.Paint.Join.MITER;
		//   27   47:aload_0         
		//   28   48:getstatic       #58  <Field android.graphics.Paint$Join android.graphics.Paint$Join.MITER>
		//   29   51:putfield        #60  <Field android.graphics.Paint$Join mStrokeLineJoin>
			mStrokeMiterlimit = 4F;
		//   30   54:aload_0         
		//   31   55:ldc1            #61  <Float 4F>
		//   32   57:putfield        #63  <Field float mStrokeMiterlimit>
			mThemeAttrs = vfullpath.mThemeAttrs;
		//   33   60:aload_0         
		//   34   61:aload_1         
		//   35   62:getfield        #70  <Field int[] mThemeAttrs>
		//   36   65:putfield        #70  <Field int[] mThemeAttrs>
			mStrokeColor = vfullpath.mStrokeColor;
		//   37   68:aload_0         
		//   38   69:aload_1         
		//   39   70:getfield        #72  <Field ComplexColorCompat mStrokeColor>
		//   40   73:putfield        #72  <Field ComplexColorCompat mStrokeColor>
			mStrokeWidth = vfullpath.mStrokeWidth;
		//   41   76:aload_0         
		//   42   77:aload_1         
		//   43   78:getfield        #34  <Field float mStrokeWidth>
		//   44   81:putfield        #34  <Field float mStrokeWidth>
			mStrokeAlpha = vfullpath.mStrokeAlpha;
		//   45   84:aload_0         
		//   46   85:aload_1         
		//   47   86:getfield        #36  <Field float mStrokeAlpha>
		//   48   89:putfield        #36  <Field float mStrokeAlpha>
			mFillColor = vfullpath.mFillColor;
		//   49   92:aload_0         
		//   50   93:aload_1         
		//   51   94:getfield        #74  <Field ComplexColorCompat mFillColor>
		//   52   97:putfield        #74  <Field ComplexColorCompat mFillColor>
			mFillRule = vfullpath.mFillRule;
		//   53  100:aload_0         
		//   54  101:aload_1         
		//   55  102:getfield        #38  <Field int mFillRule>
		//   56  105:putfield        #38  <Field int mFillRule>
			mFillAlpha = vfullpath.mFillAlpha;
		//   57  108:aload_0         
		//   58  109:aload_1         
		//   59  110:getfield        #40  <Field float mFillAlpha>
		//   60  113:putfield        #40  <Field float mFillAlpha>
			mTrimPathStart = vfullpath.mTrimPathStart;
		//   61  116:aload_0         
		//   62  117:aload_1         
		//   63  118:getfield        #42  <Field float mTrimPathStart>
		//   64  121:putfield        #42  <Field float mTrimPathStart>
			mTrimPathEnd = vfullpath.mTrimPathEnd;
		//   65  124:aload_0         
		//   66  125:aload_1         
		//   67  126:getfield        #44  <Field float mTrimPathEnd>
		//   68  129:putfield        #44  <Field float mTrimPathEnd>
			mTrimPathOffset = vfullpath.mTrimPathOffset;
		//   69  132:aload_0         
		//   70  133:aload_1         
		//   71  134:getfield        #46  <Field float mTrimPathOffset>
		//   72  137:putfield        #46  <Field float mTrimPathOffset>
			mStrokeLineCap = vfullpath.mStrokeLineCap;
		//   73  140:aload_0         
		//   74  141:aload_1         
		//   75  142:getfield        #53  <Field android.graphics.Paint$Cap mStrokeLineCap>
		//   76  145:putfield        #53  <Field android.graphics.Paint$Cap mStrokeLineCap>
			mStrokeLineJoin = vfullpath.mStrokeLineJoin;
		//   77  148:aload_0         
		//   78  149:aload_1         
		//   79  150:getfield        #60  <Field android.graphics.Paint$Join mStrokeLineJoin>
		//   80  153:putfield        #60  <Field android.graphics.Paint$Join mStrokeLineJoin>
			mStrokeMiterlimit = vfullpath.mStrokeMiterlimit;
		//   81  156:aload_0         
		//   82  157:aload_1         
		//   83  158:getfield        #63  <Field float mStrokeMiterlimit>
		//   84  161:putfield        #63  <Field float mStrokeMiterlimit>
		//   85  164:return          
		}
	}
...
label0:
	...
	private static class VectorDrawableCompatState extends android.graphics.drawable.Drawable.ConstantState
	{
		...
		//    0    0:iload_1         
		//    1    1:aload_0         
		//    2    2:getfield        #68  <Field Bitmap mCachedBitmap>
		//    3    5:invokevirtual   #74  <Method int Bitmap.getWidth()>
		//    4    8:icmpne          24
		//    5   11:iload_2         
		//    6   12:aload_0         
		//    7   13:getfield        #68  <Field Bitmap mCachedBitmap>
		//    8   16:invokevirtual   #77  <Method int Bitmap.getHeight()>
		//    9   19:icmpne          24
		//   10   22:iconst_1        
		//   11   23:ireturn         
		//   12   24:iconst_0        
		...
		//    0    0:aload_0         
		//    1    1:getfield        #81  <Field boolean mCacheDirty>
		//    2    4:ifne            56
		//    3    7:aload_0         
		//    4    8:getfield        #83  <Field ColorStateList mCachedTint>
		//    5   11:aload_0         
		//    6   12:getfield        #34  <Field ColorStateList mTint>
		//    7   15:if_acmpne       56
		//    8   18:aload_0         
		//    9   19:getfield        #85  <Field android.graphics.PorterDuff$Mode mCachedTintMode>
		//   10   22:aload_0         
		//   11   23:getfield        #39  <Field android.graphics.PorterDuff$Mode mTintMode>
		//   12   26:if_acmpne       56
		//   13   29:aload_0         
		//   14   30:getfield        #87  <Field boolean mCachedAutoMirrored>
		//   15   33:aload_0         
		//   16   34:getfield        #64  <Field boolean mAutoMirrored>
		//   17   37:icmpne          56
		//   18   40:aload_0         
		//   19   41:getfield        #89  <Field int mCachedRootAlpha>
		//   20   44:aload_0         
		//   21   45:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//   22   48:invokevirtual   #92  <Method int VectorDrawableCompat$VPathRenderer.getRootAlpha()>
		//   23   51:icmpne          56
		//   24   54:iconst_1        
		//   25   55:ireturn         
		//   26   56:iconst_0        
		...
		//*   0    0:aload_0         
		//*   1    1:getfield        #68  <Field Bitmap mCachedBitmap>
		//*   2    4:ifnull          16
		//*   3    7:aload_0         
		//*   4    8:iload_1         
		//*   5    9:iload_2         
		//*   6   10:invokevirtual   #96  <Method boolean canReuseBitmap(int, int)>
		//*   7   13:ifne            33
			{
		...
		//    9   17:iload_1         
		//   10   18:iload_2         
		//   11   19:getstatic       #102 <Field android.graphics.Bitmap$Config android.graphics.Bitmap$Config.ARGB_8888>
		//   12   22:invokestatic    #106 <Method Bitmap Bitmap.createBitmap(int, int, android.graphics.Bitmap$Config)>
		//   13   25:putfield        #68  <Field Bitmap mCachedBitmap>
				mCacheDirty = true;
		//   14   28:aload_0         
		//   15   29:iconst_1        
		//   16   30:putfield        #81  <Field boolean mCacheDirty>
			}
		//   17   33:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_2         
		//    2    2:invokevirtual   #112 <Method Paint getPaint(ColorFilter)>
		//    3    5:astore_2        
			canvas.drawBitmap(mCachedBitmap, ((Rect) (null)), rect, ((Paint) (colorfilter)));
		//    4    6:aload_1         
		//    5    7:aload_0         
		//    6    8:getfield        #68  <Field Bitmap mCachedBitmap>
		//    7   11:aconst_null     
		//    8   12:aload_3         
		//    9   13:aload_2         
		//   10   14:invokevirtual   #118 <Method void Canvas.drawBitmap(Bitmap, Rect, Rect, Paint)>
		//   11   17:return          
		}
		...
		//*   0    0:aload_0         
		//*   1    1:invokevirtual   #122 <Method boolean hasTranslucentRoot()>
		//*   2    4:ifne            13
		//*   3    7:aload_1         
		//*   4    8:ifnonnull       13
				return null;
		...
		//    6   12:areturn         
			if(mTempPaint == null)
		//*   7   13:aload_0         
		//*   8   14:getfield        #124 <Field Paint mTempPaint>
		//*   9   17:ifnonnull       39
			{
				mTempPaint = new Paint();
		//   10   20:aload_0         
		//   11   21:new             #56  <Class Paint>
		//   12   24:dup             
		//   13   25:invokespecial   #125 <Method void Paint()>
		//   14   28:putfield        #124 <Field Paint mTempPaint>
				mTempPaint.setFilterBitmap(true);
		//   15   31:aload_0         
		//   16   32:getfield        #124 <Field Paint mTempPaint>
		//   17   35:iconst_1        
		//   18   36:invokevirtual   #129 <Method void Paint.setFilterBitmap(boolean)>
			}
			mTempPaint.setAlpha(mVPathRenderer.getRootAlpha());
		//   19   39:aload_0         
		//   20   40:getfield        #124 <Field Paint mTempPaint>
		//   21   43:aload_0         
		//   22   44:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//   23   47:invokevirtual   #92  <Method int VectorDrawableCompat$VPathRenderer.getRootAlpha()>
		//   24   50:invokevirtual   #133 <Method void Paint.setAlpha(int)>
			mTempPaint.setColorFilter(colorfilter);
		//   25   53:aload_0         
		//   26   54:getfield        #124 <Field Paint mTempPaint>
		//   27   57:aload_1         
		//   28   58:invokevirtual   #137 <Method ColorFilter Paint.setColorFilter(ColorFilter)>
		//   29   61:pop             
			return mTempPaint;
		//   30   62:aload_0         
		//   31   63:getfield        #124 <Field Paint mTempPaint>
		//   32   66:areturn         
		}
		...
		//    2    4:invokevirtual   #92  <Method int VectorDrawableCompat$VPathRenderer.getRootAlpha()>
		//    3    7:sipush          255
		//    4   10:icmpge          15
		//    5   13:iconst_1        
		//    6   14:ireturn         
		...
		//    0    0:aload_0         
		//    1    1:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//    2    4:invokevirtual   #140 <Method boolean VectorDrawableCompat$VPathRenderer.isStateful()>
		//    3    7:ireturn         
		}
		...
		//    1    3:dup             
		//    2    4:aload_0         
		//    3    5:invokespecial   #145 <Method void VectorDrawableCompat(VectorDrawableCompat$VectorDrawableCompatState)>
		//    4    8:areturn         
		}
		...
		//    1    1:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//    2    4:aload_1         
		//    3    5:invokevirtual   #151 <Method boolean VectorDrawableCompat$VPathRenderer.onStateChanged(int[])>
		//    4    8:istore_2        
			mCacheDirty = mCacheDirty | flag;
		//    5    9:aload_0         
		//    6   10:aload_0         
		//    7   11:getfield        #81  <Field boolean mCacheDirty>
		//    8   14:iload_2         
		//    9   15:ior             
		//   10   16:putfield        #81  <Field boolean mCacheDirty>
			return flag;
		//   11   19:iload_2         
		//   12   20:ireturn         
		}
		...
		//    3    5:putfield        #83  <Field ColorStateList mCachedTint>
			mCachedTintMode = mTintMode;
		//    4    8:aload_0         
		//    5    9:aload_0         
		//    6   10:getfield        #39  <Field android.graphics.PorterDuff$Mode mTintMode>
		//    7   13:putfield        #85  <Field android.graphics.PorterDuff$Mode mCachedTintMode>
			mCachedRootAlpha = mVPathRenderer.getRootAlpha();
		//    8   16:aload_0         
		//    9   17:aload_0         
		//   10   18:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//   11   21:invokevirtual   #92  <Method int VectorDrawableCompat$VPathRenderer.getRootAlpha()>
		//   12   24:putfield        #89  <Field int mCachedRootAlpha>
			mCachedAutoMirrored = mAutoMirrored;
		//   13   27:aload_0         
		//   14   28:aload_0         
		//   15   29:getfield        #64  <Field boolean mAutoMirrored>
		//   16   32:putfield        #87  <Field boolean mCachedAutoMirrored>
			mCacheDirty = false;
		//   17   35:aload_0         
		//   18   36:iconst_0        
		//   19   37:putfield        #81  <Field boolean mCacheDirty>
		//   20   40:return          
		}
		...
		//    1    1:getfield        #68  <Field Bitmap mCachedBitmap>
		//    2    4:iconst_0        
		//    3    5:invokevirtual   #156 <Method void Bitmap.eraseColor(int)>
			Canvas canvas = new Canvas(mCachedBitmap);
		//    4    8:new             #114 <Class Canvas>
		//    5   11:dup             
		//    6   12:aload_0         
		//    7   13:getfield        #68  <Field Bitmap mCachedBitmap>
		//    8   16:invokespecial   #159 <Method void Canvas(Bitmap)>
		//    9   19:astore_3        
		...
		//   14   26:iload_2         
		//   15   27:aconst_null     
		//   16   28:invokevirtual   #163 <Method void VectorDrawableCompat$VPathRenderer.draw(Canvas, int, int, ColorFilter)>
		//   17   31:return          
		}
		...
		//*  21   43:aload_1         
		//*  22   44:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//*  23   47:getfield        #54  <Field Paint VectorDrawableCompat$VPathRenderer.mFillPaint>
		//*  24   50:ifnull          74
		...
		//   27   57:new             #56  <Class Paint>
		//   28   60:dup             
		//   29   61:aload_1         
		//   30   62:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//   31   65:getfield        #54  <Field Paint VectorDrawableCompat$VPathRenderer.mFillPaint>
		//   32   68:invokespecial   #59  <Method void Paint(Paint)>
		//   33   71:putfield        #54  <Field Paint VectorDrawableCompat$VPathRenderer.mFillPaint>
				if(vectordrawablecompatstate.mVPathRenderer.mStrokePaint != null)
		//*  34   74:aload_1         
		//*  35   75:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//*  36   78:getfield        #62  <Field Paint VectorDrawableCompat$VPathRenderer.mStrokePaint>
		//*  37   81:ifnull          105
					mVPathRenderer.mStrokePaint = new Paint(vectordrawablecompatstate.mVPathRenderer.mStrokePaint);
		//   38   84:aload_0         
		//   39   85:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//   40   88:new             #56  <Class Paint>
		//   41   91:dup             
		//   42   92:aload_1         
		//   43   93:getfield        #44  <Field VectorDrawableCompat$VPathRenderer mVPathRenderer>
		//   44   96:getfield        #62  <Field Paint VectorDrawableCompat$VPathRenderer.mStrokePaint>
		//   45   99:invokespecial   #59  <Method void Paint(Paint)>
		//   46  102:putfield        #62  <Field Paint VectorDrawableCompat$VPathRenderer.mStrokePaint>
				mTint = vectordrawablecompatstate.mTint;
		//   47  105:aload_0         
		//   48  106:aload_1         
		//   49  107:getfield        #34  <Field ColorStateList mTint>
		//   50  110:putfield        #34  <Field ColorStateList mTint>
				mTintMode = vectordrawablecompatstate.mTintMode;
		//   51  113:aload_0         
		//   52  114:aload_1         
		//   53  115:getfield        #39  <Field android.graphics.PorterDuff$Mode mTintMode>
		//   54  118:putfield        #39  <Field android.graphics.PorterDuff$Mode mTintMode>
				mAutoMirrored = vectordrawablecompatstate.mAutoMirrored;
		//   55  121:aload_0         
		//   56  122:aload_1         
		//   57  123:getfield        #64  <Field boolean mAutoMirrored>
		//   58  126:putfield        #64  <Field boolean mAutoMirrored>
			}
		//   59  129:return          
		}
	}
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #91  <Method void VectorDrawableCommon()>
		mAllowCaching = true;
	//    2    4:aload_0         
	//    3    5:iconst_1        
	//    4    6:putfield        #93  <Field boolean mAllowCaching>
		mTmpFloats = new float[9];
	//    5    9:aload_0         
	//    6   10:bipush          9
	//    7   12:newarray        float[]
	//    8   14:putfield        #95  <Field float[] mTmpFloats>
		mTmpMatrix = new Matrix();
	//    9   17:aload_0         
	//   10   18:new             #97  <Class Matrix>
	//   11   21:dup             
	//   12   22:invokespecial   #98  <Method void Matrix()>
	//   13   25:putfield        #100 <Field Matrix mTmpMatrix>
		mTmpBounds = new Rect();
	//   14   28:aload_0         
	//   15   29:new             #102 <Class Rect>
	//   16   32:dup             
	//   17   33:invokespecial   #103 <Method void Rect()>
	//   18   36:putfield        #105 <Field Rect mTmpBounds>
		mVectorState = new VectorDrawableCompatState();
	//   19   39:aload_0         
	//   20   40:new             #26  <Class VectorDrawableCompat$VectorDrawableCompatState>
	//   21   43:dup             
	//   22   44:invokespecial   #106 <Method void VectorDrawableCompat$VectorDrawableCompatState()>
	//   23   47:putfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   24   50:return          
	}
	...
	//   19   39:aload_0         
	//   20   40:aload_1         
	//   21   41:putfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
		mTintFilter = updateTintFilter(mTintFilter, vectordrawablecompatstate.mTint, vectordrawablecompatstate.mTintMode);
	//   22   44:aload_0         
	//   23   45:aload_0         
	//   24   46:aload_0         
	//   25   47:getfield        #112 <Field PorterDuffColorFilter mTintFilter>
	//   26   50:aload_1         
	//   27   51:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//   28   54:aload_1         
	//   29   55:getfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
	//   30   58:invokevirtual   #123 <Method PorterDuffColorFilter updateTintFilter(PorterDuffColorFilter, ColorStateList, android.graphics.PorterDuff$Mode)>
	//   31   61:putfield        #112 <Field PorterDuffColorFilter mTintFilter>
	//   32   64:return          
	}
	...
	//    0    0:iload_0         
	//    1    1:ldc1            #127 <Int 0xffffff>
	//    2    3:iand            
	//    3    4:iload_0         
	//    4    5:invokestatic    #133 <Method int Color.alpha(int)>
	//    5    8:i2f             
	//    6    9:fload_1         
	//    7   10:fmul            
	//    8   11:f2i             
	...
	//    4   11:dup             
	//    5   12:invokespecial   #147 <Method void VectorDrawableCompat()>
	//    6   15:astore_3        
	...
	//    9   18:iload_1         
	//   10   19:aload_2         
	//   11   20:invokestatic    #153 <Method Drawable ResourcesCompat.getDrawable(Resources, int, android.content.res.Resources$Theme)>
	//   12   23:putfield        #157 <Field Drawable mDelegateDrawable>
	...
	//   15   30:dup             
	//   16   31:aload_3         
	//   17   32:getfield        #157 <Field Drawable mDelegateDrawable>
	//   18   35:invokevirtual   #163 <Method android.graphics.drawable.Drawable$ConstantState Drawable.getConstantState()>
	//   19   38:invokespecial   #166 <Method void VectorDrawableCompat$VectorDrawableDelegateState(android.graphics.drawable.Drawable$ConstantState)>
	//   20   41:putfield        #168 <Field android.graphics.drawable.Drawable$ConstantState mCachedConstantStateDelegate>
	...
	//   23   46:aload_0         
	//   24   47:iload_1         
	//   25   48:invokevirtual   #174 <Method android.content.res.XmlResourceParser Resources.getXml(int)>
	//   26   51:astore_3        
		attributeset = Xml.asAttributeSet(((XmlPullParser) (xmlresourceparser)));
	//   27   52:aload_3         
	//   28   53:invokestatic    #180 <Method AttributeSet Xml.asAttributeSet(XmlPullParser)>
	//   29   56:astore          4
		do
			i = ((XmlPullParser) (xmlresourceparser)).next();
	//   30   58:aload_3         
	//   31   59:invokeinterface #186 <Method int XmlPullParser.next()>
	//   32   64:istore_1        
		while(i != 2 && i != 1);
	//   33   65:iload_1         
	//   34   66:iconst_2        
	...
	//   45   85:aload           4
	//   46   87:aload_2         
	//   47   88:invokestatic    #190 <Method VectorDrawableCompat createFromXmlInner(Resources, XmlPullParser, AttributeSet, android.content.res.Resources$Theme)>
	//   48   91:areturn         
		throw new XmlPullParserException("No start tag found");
	//   49   92:new             #139 <Class XmlPullParserException>
	//   50   95:dup             
	//   51   96:ldc1            #192 <String "No start tag found">
	//   52   98:invokespecial   #195 <Method void XmlPullParserException(String)>
	//   53  101:athrow          
		resources;
	//   54  102:astore_0        
		Log.e("VectorDrawableCompat", "parser error", ((Throwable) (resources)));
	//   55  103:ldc1            #48  <String "VectorDrawableCompat">
	//   56  105:ldc1            #197 <String "parser error">
	//   57  107:aload_0         
	//   58  108:invokestatic    #203 <Method int Log.e(String, String, Throwable)>
	//   59  111:pop             
	...
	//   61  115:astore_0        
		Log.e("VectorDrawableCompat", "parser error", ((Throwable) (resources)));
	//   62  116:ldc1            #48  <String "VectorDrawableCompat">
	//   63  118:ldc1            #197 <String "parser error">
	//   64  120:aload_0         
	//   65  121:invokestatic    #203 <Method int Log.e(String, String, Throwable)>
	//   66  124:pop             
		return null;
	//   67  125:aconst_null     
	//   68  126:areturn         
	...
	//    1    3:dup             
	//    2    4:invokespecial   #147 <Method void VectorDrawableCompat()>
	//    3    7:astore          4
	...
	//    7   13:aload_2         
	//    8   14:aload_3         
	//    9   15:invokevirtual   #208 <Method void inflate(Resources, XmlPullParser, AttributeSet, android.content.res.Resources$Theme)>
		return vectordrawablecompat;
	//   10   18:aload           4
	//   11   20:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//    2    4:astore          9
		VPathRenderer vpathrenderer = vectordrawablecompatstate.mVPathRenderer;
	//    3    6:aload           9
	//    4    8:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//    5   11:astore          10
		ArrayDeque arraydeque = new ArrayDeque();
	//    6   13:new             #216 <Class ArrayDeque>
	//    7   16:dup             
	//    8   17:invokespecial   #217 <Method void ArrayDeque()>
	//    9   20:astore          11
		arraydeque.push(((Object) (vpathrenderer.mRootGroup)));
	//   10   22:aload           11
	//   11   24:aload           10
	//   12   26:getfield        #221 <Field VectorDrawableCompat$VGroup VectorDrawableCompat$VPathRenderer.mRootGroup>
	//   13   29:invokevirtual   #225 <Method void ArrayDeque.push(Object)>
		int k = xmlpullparser.getEventType();
	//   14   32:aload_2         
	//   15   33:invokeinterface #228 <Method int XmlPullParser.getEventType()>
	//   16   38:istore          7
		int l = xmlpullparser.getDepth();
	//   17   40:aload_2         
	//   18   41:invokeinterface #231 <Method int XmlPullParser.getDepth()>
	//   19   46:istore          8
		int i;
		int j;
	...
	//*  24   54:icmpeq          436
	//*  25   57:aload_2         
	//*  26   58:invokeinterface #231 <Method int XmlPullParser.getDepth()>
	//*  27   63:iload           8
	//*  28   65:iconst_1        
	//*  29   66:iadd            
	//*  30   67:icmpge          76
	...
	//   37   82:aload_2         
	//   38   83:invokeinterface #235 <Method String XmlPullParser.getName()>
	//   39   88:astore          13
				VGroup vgroup = (VGroup)arraydeque.peek();
	//   40   90:aload           11
	//   41   92:invokevirtual   #239 <Method Object ArrayDeque.peek()>
	//   42   95:checkcast       #14  <Class VectorDrawableCompat$VGroup>
	//   43   98:astore          12
				if("path".equals(obj))
	//*  44  100:ldc1            #59  <String "path">
	//*  45  102:aload           13
	//*  46  104:invokevirtual   #245 <Method boolean String.equals(Object)>
	//*  47  107:ifeq            190
				{
					obj = ((Object) (new VFullPath()));
	//   48  110:new             #11  <Class VectorDrawableCompat$VFullPath>
	//   49  113:dup             
	//   50  114:invokespecial   #246 <Method void VectorDrawableCompat$VFullPath()>
	//   51  117:astore          13
	...
	//   55  123:aload           4
	//   56  125:aload_2         
	//   57  126:invokevirtual   #249 <Method void VectorDrawableCompat$VFullPath.inflate(Resources, AttributeSet, android.content.res.Resources$Theme, XmlPullParser)>
					vgroup.mChildren.add(obj);
	//   58  129:aload           12
	//   59  131:getfield        #253 <Field ArrayList VectorDrawableCompat$VGroup.mChildren>
	//   60  134:aload           13
	//   61  136:invokevirtual   #258 <Method boolean ArrayList.add(Object)>
	//   62  139:pop             
					if(((VFullPath) (obj)).getPathName() != null)
	//*  63  140:aload           13
	//*  64  142:invokevirtual   #261 <Method String VectorDrawableCompat$VFullPath.getPathName()>
	//*  65  145:ifnull          164
						vpathrenderer.mVGTargetsMap.put(((Object) (((VFullPath) (obj)).getPathName())), obj);
	//   66  148:aload           10
	//   67  150:getfield        #265 <Field ArrayMap VectorDrawableCompat$VPathRenderer.mVGTargetsMap>
	//   68  153:aload           13
	//   69  155:invokevirtual   #261 <Method String VectorDrawableCompat$VFullPath.getPathName()>
	//   70  158:aload           13
	//   71  160:invokevirtual   #271 <Method Object ArrayMap.put(Object, Object)>
	//   72  163:pop             
					j = 0;
	//   73  164:iconst_0        
	//   74  165:istore          6
	...
	//   75  167:aload           9
	//   76  169:getfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
	//   77  172:istore          5
					vectordrawablecompatstate.mChangingConfigurations = ((VFullPath) (obj)).mChangingConfigurations | i;
	//   78  174:aload           9
	//   79  176:aload           13
	//   80  178:getfield        #275 <Field int VectorDrawableCompat$VFullPath.mChangingConfigurations>
	//   81  181:iload           5
	//   82  183:ior             
	//   83  184:putfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
				} else
	//*  84  187:goto            421
				if("clip-path".equals(obj))
	//*  85  190:ldc1            #53  <String "clip-path">
	//*  86  192:aload           13
	//*  87  194:invokevirtual   #245 <Method boolean String.equals(Object)>
	//*  88  197:ifeq            281
				{
					obj = ((Object) (new VClipPath()));
	//   89  200:new             #8   <Class VectorDrawableCompat$VClipPath>
	//   90  203:dup             
	//   91  204:invokespecial   #276 <Method void VectorDrawableCompat$VClipPath()>
	//   92  207:astore          13
	...
	//   96  213:aload           4
	//   97  215:aload_2         
	//   98  216:invokevirtual   #277 <Method void VectorDrawableCompat$VClipPath.inflate(Resources, AttributeSet, android.content.res.Resources$Theme, XmlPullParser)>
					vgroup.mChildren.add(obj);
	//   99  219:aload           12
	//  100  221:getfield        #253 <Field ArrayList VectorDrawableCompat$VGroup.mChildren>
	//  101  224:aload           13
	//  102  226:invokevirtual   #258 <Method boolean ArrayList.add(Object)>
	//  103  229:pop             
					if(((VClipPath) (obj)).getPathName() != null)
	//* 104  230:aload           13
	//* 105  232:invokevirtual   #278 <Method String VectorDrawableCompat$VClipPath.getPathName()>
	//* 106  235:ifnull          254
						vpathrenderer.mVGTargetsMap.put(((Object) (((VClipPath) (obj)).getPathName())), obj);
	//  107  238:aload           10
	//  108  240:getfield        #265 <Field ArrayMap VectorDrawableCompat$VPathRenderer.mVGTargetsMap>
	//  109  243:aload           13
	//  110  245:invokevirtual   #278 <Method String VectorDrawableCompat$VClipPath.getPathName()>
	//  111  248:aload           13
	//  112  250:invokevirtual   #271 <Method Object ArrayMap.put(Object, Object)>
	//  113  253:pop             
					j = vectordrawablecompatstate.mChangingConfigurations;
	//  114  254:aload           9
	//  115  256:getfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
	//  116  259:istore          6
					vectordrawablecompatstate.mChangingConfigurations = ((VClipPath) (obj)).mChangingConfigurations | j;
	//  117  261:aload           9
	//  118  263:aload           13
	//  119  265:getfield        #279 <Field int VectorDrawableCompat$VClipPath.mChangingConfigurations>
	//  120  268:iload           6
	//  121  270:ior             
	//  122  271:putfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
					j = i;
	//  123  274:iload           5
	//  124  276:istore          6
				} else
	...
	//  127  283:istore          6
					if("group".equals(obj))
	//* 128  285:ldc1            #56  <String "group">
	//* 129  287:aload           13
	//* 130  289:invokevirtual   #245 <Method boolean String.equals(Object)>
	//* 131  292:ifeq            421
					{
						VGroup vgroup1 = new VGroup();
	//  132  295:new             #14  <Class VectorDrawableCompat$VGroup>
	//  133  298:dup             
	//  134  299:invokespecial   #280 <Method void VectorDrawableCompat$VGroup()>
	//  135  302:astore          13
	...
	//  139  308:aload           4
	//  140  310:aload_2         
	//  141  311:invokevirtual   #281 <Method void VectorDrawableCompat$VGroup.inflate(Resources, AttributeSet, android.content.res.Resources$Theme, XmlPullParser)>
						vgroup.mChildren.add(((Object) (vgroup1)));
	//  142  314:aload           12
	//  143  316:getfield        #253 <Field ArrayList VectorDrawableCompat$VGroup.mChildren>
	//  144  319:aload           13
	//  145  321:invokevirtual   #258 <Method boolean ArrayList.add(Object)>
	//  146  324:pop             
						arraydeque.push(((Object) (vgroup1)));
	//  147  325:aload           11
	//  148  327:aload           13
	//  149  329:invokevirtual   #225 <Method void ArrayDeque.push(Object)>
						if(vgroup1.getGroupName() != null)
	//* 150  332:aload           13
	//* 151  334:invokevirtual   #284 <Method String VectorDrawableCompat$VGroup.getGroupName()>
	//* 152  337:ifnull          356
							vpathrenderer.mVGTargetsMap.put(((Object) (vgroup1.getGroupName())), ((Object) (vgroup1)));
	//  153  340:aload           10
	//  154  342:getfield        #265 <Field ArrayMap VectorDrawableCompat$VPathRenderer.mVGTargetsMap>
	//  155  345:aload           13
	//  156  347:invokevirtual   #284 <Method String VectorDrawableCompat$VGroup.getGroupName()>
	//  157  350:aload           13
	//  158  352:invokevirtual   #271 <Method Object ArrayMap.put(Object, Object)>
	//  159  355:pop             
						j = vectordrawablecompatstate.mChangingConfigurations;
	//  160  356:aload           9
	//  161  358:getfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
	//  162  361:istore          6
						vectordrawablecompatstate.mChangingConfigurations = vgroup1.mChangingConfigurations | j;
	//  163  363:aload           9
	//  164  365:aload           13
	//  165  367:getfield        #285 <Field int VectorDrawableCompat$VGroup.mChangingConfigurations>
	//  166  370:iload           6
	//  167  372:ior             
	//  168  373:putfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
						j = i;
	//  169  376:iload           5
	//  170  378:istore          6
					}
	...
	//* 179  397:ldc1            #56  <String "group">
	//* 180  399:aload_2         
	//* 181  400:invokeinterface #235 <Method String XmlPullParser.getName()>
	//* 182  405:invokevirtual   #245 <Method boolean String.equals(Object)>
	//* 183  408:ifeq            421
					{
						arraydeque.pop();
	//  184  411:aload           11
	//  185  413:invokevirtual   #288 <Method Object ArrayDeque.pop()>
	//  186  416:pop             
						j = i;
	//  187  417:iload           5
	//  188  419:istore          6
	...
	//  189  421:aload_2         
	//  190  422:invokeinterface #186 <Method int XmlPullParser.next()>
	//  191  427:istore          7
		}
	...
	//  198  442:new             #139 <Class XmlPullParserException>
	//  199  445:dup             
	//  200  446:ldc2            #290 <String "no path defined">
	//  201  449:invokespecial   #195 <Method void XmlPullParserException(String)>
	//  202  452:athrow          
	}
	...
	//    8   13:istore_2        
			if(isAutoMirrored())
	//*   9   14:aload_0         
	//*  10   15:invokevirtual   #295 <Method boolean isAutoMirrored()>
	//*  11   18:ifeq            33
			{
				flag = flag1;
	//   12   21:iload_3         
	...
	//*  14   23:aload_0         
	//*  15   24:invokestatic    #301 <Method int DrawableCompat.getLayoutDirection(Drawable)>
	//*  16   27:iconst_1        
	//*  17   28:icmpne          33
					flag = true;
	//   18   31:iconst_1        
	...
	//   13   46:getstatic       #306 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.ADD>
	//   14   49:areturn         

					case 15: // '\017'
						return android.graphics.PorterDuff.Mode.SCREEN;
	//   15   50:getstatic       #309 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SCREEN>
	//   16   53:areturn         

					case 14: // '\016'
						return android.graphics.PorterDuff.Mode.MULTIPLY;
	//   17   54:getstatic       #312 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.MULTIPLY>
	//   18   57:areturn         
					}
				else
					return android.graphics.PorterDuff.Mode.SRC_ATOP;
	//   19   58:getstatic       #315 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_ATOP>
	//   20   61:areturn         
			} else
			{
				return android.graphics.PorterDuff.Mode.SRC_IN;
	//   21   62:getstatic       #85  <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_IN>
	//   22   65:areturn         
			}
		} else
		{
			return android.graphics.PorterDuff.Mode.SRC_OVER;
	//   23   66:getstatic       #318 <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_OVER>
	//   24   69:areturn         
		}
	}
	...
	//*   8   12:icmpge          55
		{
			StringBuilder stringbuilder = new StringBuilder();
	//    9   15:new             #324 <Class StringBuilder>
	//   10   18:dup             
	//   11   19:invokespecial   #325 <Method void StringBuilder()>
	//   12   22:astore          6
			stringbuilder.append(s);
	//   13   24:aload           6
	//   14   26:aload           5
	//   15   28:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   16   31:pop             
			stringbuilder.append("    ");
	//   17   32:aload           6
	//   18   34:ldc2            #331 <String "    ">
	//   19   37:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   20   40:pop             
			s = stringbuilder.toString();
	//   21   41:aload           6
	//   22   43:invokevirtual   #334 <Method String StringBuilder.toString()>
	//   23   46:astore          5
		}
	...
	//*  28   52:goto            10
		StringBuilder stringbuilder1 = new StringBuilder();
	//   29   55:new             #324 <Class StringBuilder>
	//   30   58:dup             
	//   31   59:invokespecial   #325 <Method void StringBuilder()>
	//   32   62:astore          6
		stringbuilder1.append(s);
	//   33   64:aload           6
	//   34   66:aload           5
	//   35   68:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   36   71:pop             
		stringbuilder1.append("current group is :");
	//   37   72:aload           6
	//   38   74:ldc2            #336 <String "current group is :">
	//   39   77:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   40   80:pop             
		stringbuilder1.append(vgroup.getGroupName());
	//   41   81:aload           6
	//   42   83:aload_1         
	//   43   84:invokevirtual   #284 <Method String VectorDrawableCompat$VGroup.getGroupName()>
	//   44   87:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   45   90:pop             
		stringbuilder1.append(" rotation is ");
	//   46   91:aload           6
	//   47   93:ldc2            #338 <String " rotation is ">
	//   48   96:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   49   99:pop             
		stringbuilder1.append(vgroup.mRotate);
	//   50  100:aload           6
	//   51  102:aload_1         
	//   52  103:getfield        #342 <Field float VectorDrawableCompat$VGroup.mRotate>
	//   53  106:invokevirtual   #345 <Method StringBuilder StringBuilder.append(float)>
	//   54  109:pop             
		Log.v("VectorDrawableCompat", stringbuilder1.toString());
	//   55  110:ldc1            #48  <String "VectorDrawableCompat">
	//   56  112:aload           6
	//   57  114:invokevirtual   #334 <Method String StringBuilder.toString()>
	//   58  117:invokestatic    #349 <Method int Log.v(String, String)>
	//   59  120:pop             
		stringbuilder1 = new StringBuilder();
	//   60  121:new             #324 <Class StringBuilder>
	//   61  124:dup             
	//   62  125:invokespecial   #325 <Method void StringBuilder()>
	//   63  128:astore          6
		stringbuilder1.append(s);
	//   64  130:aload           6
	//   65  132:aload           5
	//   66  134:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   67  137:pop             
		stringbuilder1.append("matrix is :");
	//   68  138:aload           6
	//   69  140:ldc2            #351 <String "matrix is :">
	//   70  143:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   71  146:pop             
		stringbuilder1.append(vgroup.getLocalMatrix().toString());
	//   72  147:aload           6
	//   73  149:aload_1         
	//   74  150:invokevirtual   #355 <Method Matrix VectorDrawableCompat$VGroup.getLocalMatrix()>
	//   75  153:invokevirtual   #356 <Method String Matrix.toString()>
	//   76  156:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//   77  159:pop             
		Log.v("VectorDrawableCompat", stringbuilder1.toString());
	//   78  160:ldc1            #48  <String "VectorDrawableCompat">
	//   79  162:aload           6
	//   80  164:invokevirtual   #334 <Method String StringBuilder.toString()>
	//   81  167:invokestatic    #349 <Method int Log.v(String, String)>
	//   82  170:pop             
	...
	//*  85  174:iload_3         
	//*  86  175:aload_1         
	//*  87  176:getfield        #253 <Field ArrayList VectorDrawableCompat$VGroup.mChildren>
	//*  88  179:invokevirtual   #359 <Method int ArrayList.size()>
	//*  89  182:icmpge          239
		{
			VObject vobject = (VObject)vgroup.mChildren.get(k);
	//   90  185:aload_1         
	//   91  186:getfield        #253 <Field ArrayList VectorDrawableCompat$VGroup.mChildren>
	//   92  189:iload_3         
	//   93  190:invokevirtual   #363 <Method Object ArrayList.get(int)>
	//   94  193:checkcast       #17  <Class VectorDrawableCompat$VObject>
	//   95  196:astore          5
			if(vobject instanceof VGroup)
	//*  96  198:aload           5
	//*  97  200:instanceof      #14  <Class VectorDrawableCompat$VGroup>
	//*  98  203:ifeq            221
				printGroupTree((VGroup)vobject, i + 1);
	//   99  206:aload_0         
	//  100  207:aload           5
	//  101  209:checkcast       #14  <Class VectorDrawableCompat$VGroup>
	//  102  212:iload_2         
	//  103  213:iconst_1        
	//  104  214:iadd            
	//  105  215:invokespecial   #365 <Method void printGroupTree(VectorDrawableCompat$VGroup, int)>
			else
	//* 106  218:goto            232
				((VPath)vobject).printVPath(i + 1);
	//  107  221:aload           5
	//  108  223:checkcast       #20  <Class VectorDrawableCompat$VPath>
	//  109  226:iload_2         
	//  110  227:iconst_1        
	//  111  228:iadd            
	//  112  229:invokevirtual   #369 <Method void VectorDrawableCompat$VPath.printVPath(int)>
		}
	...
	//    7   14:aload_1         
	//    8   15:aload_2         
	//    9   16:ldc2            #373 <String "tintMode">
	//   10   19:bipush          6
	//   11   21:iconst_m1       
	//   12   22:invokestatic    #379 <Method int TypedArrayUtils.getNamedInt(TypedArray, XmlPullParser, String, int, int)>
	//   13   25:getstatic       #85  <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_IN>
	//   14   28:invokestatic    #381 <Method android.graphics.PorterDuff$Mode parseTintModeCompat(int, android.graphics.PorterDuff$Mode)>
	//   15   31:putfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
		ColorStateList colorstatelist = typedarray.getColorStateList(1);
	//   16   34:aload_1         
	//   17   35:iconst_1        
	//   18   36:invokevirtual   #387 <Method ColorStateList TypedArray.getColorStateList(int)>
	//   19   39:astore          5
	...
	//   22   46:aload           4
	//   23   48:aload           5
	//   24   50:putfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	...
	//   26   55:aload_1         
	//   27   56:aload_2         
	//   28   57:ldc2            #389 <String "autoMirrored">
	//   29   60:iconst_5        
	//   30   61:aload           4
	//   31   63:getfield        #392 <Field boolean VectorDrawableCompat$VectorDrawableCompatState.mAutoMirrored>
	//   32   66:invokestatic    #396 <Method boolean TypedArrayUtils.getNamedBoolean(TypedArray, XmlPullParser, String, int, boolean)>
	//   33   69:putfield        #392 <Field boolean VectorDrawableCompat$VectorDrawableCompatState.mAutoMirrored>
	...
	//   35   73:aload_1         
	//   36   74:aload_2         
	//   37   75:ldc2            #398 <String "viewportWidth">
	//   38   78:bipush          7
	//   39   80:aload_3         
	//   40   81:getfield        #401 <Field float VectorDrawableCompat$VPathRenderer.mViewportWidth>
	//   41   84:invokestatic    #405 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
	//   42   87:putfield        #401 <Field float VectorDrawableCompat$VPathRenderer.mViewportWidth>
	...
	//   44   91:aload_1         
	//   45   92:aload_2         
	//   46   93:ldc2            #407 <String "viewportHeight">
	//   47   96:bipush          8
	//   48   98:aload_3         
	//   49   99:getfield        #410 <Field float VectorDrawableCompat$VPathRenderer.mViewportHeight>
	//   50  102:invokestatic    #405 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
	//   51  105:putfield        #410 <Field float VectorDrawableCompat$VPathRenderer.mViewportHeight>
		if(vpathrenderer.mViewportWidth > 0.0F)
	//*  52  108:aload_3         
	//*  53  109:getfield        #401 <Field float VectorDrawableCompat$VPathRenderer.mViewportWidth>
	//*  54  112:fconst_0        
	//*  55  113:fcmpg           
	//*  56  114:ifle            324
		{
	...
	//*  57  117:aload_3         
	//*  58  118:getfield        #410 <Field float VectorDrawableCompat$VPathRenderer.mViewportHeight>
	//*  59  121:fconst_0        
	//*  60  122:fcmpg           
	//*  61  123:ifle            287
			{
	...
	//   64  128:iconst_3        
	//   65  129:aload_3         
	//   66  130:getfield        #413 <Field float VectorDrawableCompat$VPathRenderer.mBaseWidth>
	//   67  133:invokevirtual   #417 <Method float TypedArray.getDimension(int, float)>
	//   68  136:putfield        #413 <Field float VectorDrawableCompat$VPathRenderer.mBaseWidth>
				vpathrenderer.mBaseHeight = typedarray.getDimension(2, vpathrenderer.mBaseHeight);
	//   69  139:aload_3         
	//   70  140:aload_1         
	//   71  141:iconst_2        
	//   72  142:aload_3         
	//   73  143:getfield        #420 <Field float VectorDrawableCompat$VPathRenderer.mBaseHeight>
	//   74  146:invokevirtual   #417 <Method float TypedArray.getDimension(int, float)>
	//   75  149:putfield        #420 <Field float VectorDrawableCompat$VPathRenderer.mBaseHeight>
				if(vpathrenderer.mBaseWidth > 0.0F)
	//*  76  152:aload_3         
	//*  77  153:getfield        #413 <Field float VectorDrawableCompat$VPathRenderer.mBaseWidth>
	//*  78  156:fconst_0        
	//*  79  157:fcmpg           
	//*  80  158:ifle            250
				{
	...
	//*  81  161:aload_3         
	//*  82  162:getfield        #420 <Field float VectorDrawableCompat$VPathRenderer.mBaseHeight>
	//*  83  165:fconst_0        
	//*  84  166:fcmpg           
	//*  85  167:ifle            213
					{
	...
	//   87  171:aload_1         
	//   88  172:aload_2         
	//   89  173:ldc2            #421 <String "alpha">
	//   90  176:iconst_4        
	//   91  177:aload_3         
	//   92  178:invokevirtual   #425 <Method float VectorDrawableCompat$VPathRenderer.getAlpha()>
	//   93  181:invokestatic    #405 <Method float TypedArrayUtils.getNamedFloat(TypedArray, XmlPullParser, String, int, float)>
	//   94  184:invokevirtual   #429 <Method void VectorDrawableCompat$VPathRenderer.setAlpha(float)>
						typedarray = ((TypedArray) (typedarray.getString(0)));
	//   95  187:aload_1         
	//   96  188:iconst_0        
	//   97  189:invokevirtual   #433 <Method String TypedArray.getString(int)>
	//   98  192:astore_1        
						if(typedarray != null)
	//*  99  193:aload_1         
	//* 100  194:ifnull          212
	...
	//  101  197:aload_3         
	//  102  198:aload_1         
	//  103  199:putfield        #436 <Field String VectorDrawableCompat$VPathRenderer.mRootName>
							vpathrenderer.mVGTargetsMap.put(((Object) (typedarray)), ((Object) (vpathrenderer)));
	//  104  202:aload_3         
	//  105  203:getfield        #265 <Field ArrayMap VectorDrawableCompat$VPathRenderer.mVGTargetsMap>
	//  106  206:aload_1         
	//  107  207:aload_3         
	//  108  208:invokevirtual   #271 <Method Object ArrayMap.put(Object, Object)>
	//  109  211:pop             
						}
						return;
	//  110  212:return          
	...
	//  111  213:new             #324 <Class StringBuilder>
	//  112  216:dup             
	//  113  217:invokespecial   #325 <Method void StringBuilder()>
	//  114  220:astore_2        
						((StringBuilder) (xmlpullparser)).append(typedarray.getPositionDescription());
	//  115  221:aload_2         
	//  116  222:aload_1         
	//  117  223:invokevirtual   #439 <Method String TypedArray.getPositionDescription()>
	//  118  226:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  119  229:pop             
						((StringBuilder) (xmlpullparser)).append("<vector> tag requires height > 0");
	//  120  230:aload_2         
	//  121  231:ldc2            #441 <String "<vector> tag requires height > 0">
	//  122  234:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  123  237:pop             
						throw new XmlPullParserException(((StringBuilder) (xmlpullparser)).toString());
	//  124  238:new             #139 <Class XmlPullParserException>
	//  125  241:dup             
	//  126  242:aload_2         
	//  127  243:invokevirtual   #334 <Method String StringBuilder.toString()>
	//  128  246:invokespecial   #195 <Method void XmlPullParserException(String)>
	//  129  249:athrow          
					}
				} else
				{
					xmlpullparser = ((XmlPullParser) (new StringBuilder()));
	//  130  250:new             #324 <Class StringBuilder>
	//  131  253:dup             
	//  132  254:invokespecial   #325 <Method void StringBuilder()>
	//  133  257:astore_2        
					((StringBuilder) (xmlpullparser)).append(typedarray.getPositionDescription());
	//  134  258:aload_2         
	//  135  259:aload_1         
	//  136  260:invokevirtual   #439 <Method String TypedArray.getPositionDescription()>
	//  137  263:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  138  266:pop             
					((StringBuilder) (xmlpullparser)).append("<vector> tag requires width > 0");
	//  139  267:aload_2         
	//  140  268:ldc2            #443 <String "<vector> tag requires width > 0">
	//  141  271:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  142  274:pop             
					throw new XmlPullParserException(((StringBuilder) (xmlpullparser)).toString());
	//  143  275:new             #139 <Class XmlPullParserException>
	//  144  278:dup             
	//  145  279:aload_2         
	//  146  280:invokevirtual   #334 <Method String StringBuilder.toString()>
	//  147  283:invokespecial   #195 <Method void XmlPullParserException(String)>
	//  148  286:athrow          
				}
			} else
			{
				xmlpullparser = ((XmlPullParser) (new StringBuilder()));
	//  149  287:new             #324 <Class StringBuilder>
	//  150  290:dup             
	//  151  291:invokespecial   #325 <Method void StringBuilder()>
	//  152  294:astore_2        
				((StringBuilder) (xmlpullparser)).append(typedarray.getPositionDescription());
	//  153  295:aload_2         
	//  154  296:aload_1         
	//  155  297:invokevirtual   #439 <Method String TypedArray.getPositionDescription()>
	//  156  300:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  157  303:pop             
				((StringBuilder) (xmlpullparser)).append("<vector> tag requires viewportHeight > 0");
	//  158  304:aload_2         
	//  159  305:ldc2            #445 <String "<vector> tag requires viewportHeight > 0">
	//  160  308:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  161  311:pop             
				throw new XmlPullParserException(((StringBuilder) (xmlpullparser)).toString());
	//  162  312:new             #139 <Class XmlPullParserException>
	//  163  315:dup             
	//  164  316:aload_2         
	//  165  317:invokevirtual   #334 <Method String StringBuilder.toString()>
	//  166  320:invokespecial   #195 <Method void XmlPullParserException(String)>
	//  167  323:athrow          
			}
		} else
		{
			xmlpullparser = ((XmlPullParser) (new StringBuilder()));
	//  168  324:new             #324 <Class StringBuilder>
	//  169  327:dup             
	//  170  328:invokespecial   #325 <Method void StringBuilder()>
	//  171  331:astore_2        
			((StringBuilder) (xmlpullparser)).append(typedarray.getPositionDescription());
	//  172  332:aload_2         
	//  173  333:aload_1         
	//  174  334:invokevirtual   #439 <Method String TypedArray.getPositionDescription()>
	//  175  337:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  176  340:pop             
			((StringBuilder) (xmlpullparser)).append("<vector> tag requires viewportWidth > 0");
	//  177  341:aload_2         
	//  178  342:ldc2            #447 <String "<vector> tag requires viewportWidth > 0">
	//  179  345:invokevirtual   #329 <Method StringBuilder StringBuilder.append(String)>
	//  180  348:pop             
			throw new XmlPullParserException(((StringBuilder) (xmlpullparser)).toString());
	//  181  349:new             #139 <Class XmlPullParserException>
	//  182  352:dup             
	//  183  353:aload_2         
	//  184  354:invokevirtual   #334 <Method String StringBuilder.toString()>
	//  185  357:invokespecial   #195 <Method void XmlPullParserException(String)>
	//  186  360:athrow          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #451 <Method void VectorDrawableCommon.applyTheme(android.content.res.Resources$Theme)>
	//    3    5:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #157 <Field Drawable mDelegateDrawable>
	//*   2    4:ifnull          15
			DrawableCompat.canApplyTheme(mDelegateDrawable);
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #458 <Method void VectorDrawableCommon.clearColorFilter()>
	//    2    4:return          
	}
	...
	//   28   60:aload_0         
	//   29   61:getfield        #112 <Field PorterDuffColorFilter mTintFilter>
	//   30   64:astore          9
			canvas.getMatrix(mTmpMatrix);
	//   31   66:aload_1         
	//   32   67:aload_0         
	//   33   68:getfield        #100 <Field Matrix mTmpMatrix>
	//   34   71:invokevirtual   #480 <Method void Canvas.getMatrix(Matrix)>
			mTmpMatrix.getValues(mTmpFloats);
	//   35   74:aload_0         
	//   36   75:getfield        #100 <Field Matrix mTmpMatrix>
	//   37   78:aload_0         
	//   38   79:getfield        #95  <Field float[] mTmpFloats>
	//   39   82:invokevirtual   #484 <Method void Matrix.getValues(float[])>
			float f = Math.abs(mTmpFloats[0]);
	//   40   85:aload_0         
	//   41   86:getfield        #95  <Field float[] mTmpFloats>
	//   42   89:iconst_0        
	//   43   90:faload          
	//   44   91:invokestatic    #490 <Method float Math.abs(float)>
	//   45   94:fstore_2        
			float f1 = Math.abs(mTmpFloats[4]);
	//   46   95:aload_0         
	//   47   96:getfield        #95  <Field float[] mTmpFloats>
	//   48   99:iconst_4        
	//   49  100:faload          
	//   50  101:invokestatic    #490 <Method float Math.abs(float)>
	//   51  104:fstore_3        
			float f3 = Math.abs(mTmpFloats[1]);
	//   52  105:aload_0         
	//   53  106:getfield        #95  <Field float[] mTmpFloats>
	//   54  109:iconst_1        
	//   55  110:faload          
	//   56  111:invokestatic    #490 <Method float Math.abs(float)>
	//   57  114:fstore          5
			float f2 = Math.abs(mTmpFloats[3]);
	//   58  116:aload_0         
	//   59  117:getfield        #95  <Field float[] mTmpFloats>
	//   60  120:iconst_3        
	//   61  121:faload          
	//   62  122:invokestatic    #490 <Method float Math.abs(float)>
	//   63  125:fstore          4
			if(f3 != 0.0F || f2 != 0.0F)
	//*  64  127:fload           5
	//*  65  129:fconst_0        
	...
	//   76  145:aload_0         
	//   77  146:getfield        #105 <Field Rect mTmpBounds>
	//   78  149:invokevirtual   #469 <Method int Rect.width()>
	//   79  152:i2f             
	//   80  153:fload_2         
	//   81  154:fmul            
	//   82  155:f2i             
	...
	//   84  158:aload_0         
	//   85  159:getfield        #105 <Field Rect mTmpBounds>
	//   86  162:invokevirtual   #472 <Method int Rect.height()>
	//   87  165:i2f             
	//   88  166:fload_3         
	//   89  167:fmul            
	//   90  168:f2i             
	...
	//   92  171:sipush          2048
	//   93  174:iload           6
	//   94  176:invokestatic    #494 <Method int Math.min(int, int)>
	//   95  179:istore          6
			j = Math.min(2048, j);
	//   96  181:sipush          2048
	//   97  184:iload           7
	//   98  186:invokestatic    #494 <Method int Math.min(int, int)>
	//   99  189:istore          7
			if(i > 0)
	//* 100  191:iload           6
	//* 101  193:ifle            346
	...
	//  104  201:return          
				int k = canvas.save();
	//  105  202:aload_1         
	//  106  203:invokevirtual   #497 <Method int Canvas.save()>
	//  107  206:istore          8
				canvas.translate(mTmpBounds.left, mTmpBounds.top);
	//  108  208:aload_1         
	//  109  209:aload_0         
	//  110  210:getfield        #105 <Field Rect mTmpBounds>
	//  111  213:getfield        #500 <Field int Rect.left>
	//  112  216:i2f             
	//  113  217:aload_0         
	//  114  218:getfield        #105 <Field Rect mTmpBounds>
	//  115  221:getfield        #503 <Field int Rect.top>
	//  116  224:i2f             
	//  117  225:invokevirtual   #507 <Method void Canvas.translate(float, float)>
				if(needMirroring())
	//* 118  228:aload_0         
	//* 119  229:invokespecial   #509 <Method boolean needMirroring()>
	//* 120  232:ifeq            256
				{
					canvas.translate(mTmpBounds.width(), 0.0F);
	//  121  235:aload_1         
	//  122  236:aload_0         
	//  123  237:getfield        #105 <Field Rect mTmpBounds>
	//  124  240:invokevirtual   #469 <Method int Rect.width()>
	//  125  243:i2f             
	//  126  244:fconst_0        
	//  127  245:invokevirtual   #507 <Method void Canvas.translate(float, float)>
					canvas.scale(-1F, 1.0F);
	//  128  248:aload_1         
	//  129  249:ldc2            #510 <Float -1F>
	//  130  252:fconst_1        
	//  131  253:invokevirtual   #513 <Method void Canvas.scale(float, float)>
				}
				mTmpBounds.offsetTo(0, 0);
	//  132  256:aload_0         
	//  133  257:getfield        #105 <Field Rect mTmpBounds>
	//  134  260:iconst_0        
	//  135  261:iconst_0        
	//  136  262:invokevirtual   #517 <Method void Rect.offsetTo(int, int)>
				mVectorState.createCachedBitmapIfNeeded(i, j);
	//  137  265:aload_0         
	//  138  266:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//  139  269:iload           6
	//  140  271:iload           7
	//  141  273:invokevirtual   #520 <Method void VectorDrawableCompat$VectorDrawableCompatState.createCachedBitmapIfNeeded(int, int)>
				if(!mAllowCaching)
	//* 142  276:aload_0         
	//* 143  277:getfield        #93  <Field boolean mAllowCaching>
	//* 144  280:ifne            297
					mVectorState.updateCachedBitmap(i, j);
	//  145  283:aload_0         
	//  146  284:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//  147  287:iload           6
	//  148  289:iload           7
	//  149  291:invokevirtual   #523 <Method void VectorDrawableCompat$VectorDrawableCompatState.updateCachedBitmap(int, int)>
				else
	//* 150  294:goto            325
				if(!mVectorState.canReuseCache())
	//* 151  297:aload_0         
	//* 152  298:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//* 153  301:invokevirtual   #526 <Method boolean VectorDrawableCompat$VectorDrawableCompatState.canReuseCache()>
	//* 154  304:ifne            325
				{
					mVectorState.updateCachedBitmap(i, j);
	//  155  307:aload_0         
	//  156  308:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//  157  311:iload           6
	//  158  313:iload           7
	//  159  315:invokevirtual   #523 <Method void VectorDrawableCompat$VectorDrawableCompatState.updateCachedBitmap(int, int)>
					mVectorState.updateCacheStates();
	//  160  318:aload_0         
	//  161  319:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//  162  322:invokevirtual   #529 <Method void VectorDrawableCompat$VectorDrawableCompatState.updateCacheStates()>
				}
				mVectorState.drawCachedBitmapWithRootAlpha(canvas, ((ColorFilter) (obj)), mTmpBounds);
	//  163  325:aload_0         
	//  164  326:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//  165  329:aload_1         
	//  166  330:aload           9
	//  167  332:aload_0         
	//  168  333:getfield        #105 <Field Rect mTmpBounds>
	//  169  336:invokevirtual   #533 <Method void VectorDrawableCompat$VectorDrawableCompatState.drawCachedBitmapWithRootAlpha(Canvas, ColorFilter, Rect)>
				canvas.restoreToCount(k);
	//  170  339:aload_1         
	//  171  340:iload           8
	//  172  342:invokevirtual   #536 <Method void Canvas.restoreToCount(int)>
				return;
	//  173  345:return          
			} else
			{
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokestatic    #538 <Method int DrawableCompat.getAlpha(Drawable)>
	//    6   14:ireturn         
		else
			return mVectorState.mVPathRenderer.getRootAlpha();
	//    7   15:aload_0         
	//    8   16:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//    9   19:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   10   22:invokevirtual   #541 <Method int VectorDrawableCompat$VPathRenderer.getRootAlpha()>
	//   11   25:ireturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokevirtual   #544 <Method int Drawable.getChangingConfigurations()>
	//    6   14:ireturn         
		else
			return super.getChangingConfigurations() | mVectorState.getChangingConfigurations();
	//    7   15:aload_0         
	//    8   16:invokespecial   #545 <Method int VectorDrawableCommon.getChangingConfigurations()>
	//    9   19:aload_0         
	//   10   20:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   11   23:invokevirtual   #546 <Method int VectorDrawableCompat$VectorDrawableCompatState.getChangingConfigurations()>
	//   12   26:ior             
	//   13   27:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #550 <Method ColorFilter VectorDrawableCommon.getColorFilter()>
	//    2    4:areturn         
	}
	...
	//    7   18:dup             
	//    8   19:aload_0         
	//    9   20:getfield        #157 <Field Drawable mDelegateDrawable>
	//   10   23:invokevirtual   #163 <Method android.graphics.drawable.Drawable$ConstantState Drawable.getConstantState()>
	//   11   26:invokespecial   #166 <Method void VectorDrawableCompat$VectorDrawableDelegateState(android.graphics.drawable.Drawable$ConstantState)>
	//   12   29:areturn         
		} else
		{
			mVectorState.mChangingConfigurations = getChangingConfigurations();
	//   13   30:aload_0         
	//   14   31:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   15   34:aload_0         
	//   16   35:invokevirtual   #551 <Method int getChangingConfigurations()>
	//   17   38:putfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
			return ((android.graphics.drawable.Drawable.ConstantState) (mVectorState));
	//   18   41:aload_0         
	//   19   42:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   20   45:areturn         
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #555 <Method Drawable VectorDrawableCommon.getCurrent()>
	//    2    4:areturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokevirtual   #558 <Method int Drawable.getIntrinsicHeight()>
	//    6   14:ireturn         
		else
	...
	//    8   16:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//    9   19:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   10   22:getfield        #420 <Field float VectorDrawableCompat$VPathRenderer.mBaseHeight>
	//   11   25:f2i             
	//   12   26:ireturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokevirtual   #561 <Method int Drawable.getIntrinsicWidth()>
	//    6   14:ireturn         
		else
	...
	//    8   16:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//    9   19:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   10   22:getfield        #413 <Field float VectorDrawableCompat$VPathRenderer.mBaseWidth>
	//   11   25:f2i             
	//   12   26:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #564 <Method int VectorDrawableCommon.getMinimumHeight()>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #567 <Method int VectorDrawableCommon.getMinimumWidth()>
	//    2    4:ireturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokevirtual   #570 <Method int Drawable.getOpacity()>
	//    6   14:ireturn         
		else
			return -3;
	//    7   15:bipush          -3
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #574 <Method boolean VectorDrawableCommon.getPadding(Rect)>
	//    3    5:ireturn         
	}
	...
	//    1    1:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//    2    4:astore          5
		if(vectordrawablecompatstate != null && vectordrawablecompatstate.mVPathRenderer != null && mVectorState.mVPathRenderer.mBaseWidth != 0.0F && mVectorState.mVPathRenderer.mBaseHeight != 0.0F && mVectorState.mVPathRenderer.mViewportHeight != 0.0F && mVectorState.mVPathRenderer.mViewportWidth != 0.0F)
	//*   3    6:aload           5
	//*   4    8:ifnull          138
	//*   5   11:aload           5
	//*   6   13:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//*   7   16:ifnull          138
	//*   8   19:aload_0         
	//*   9   20:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//*  10   23:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//*  11   26:getfield        #413 <Field float VectorDrawableCompat$VPathRenderer.mBaseWidth>
	//*  12   29:fconst_0        
	//*  13   30:fcmpl           
	//*  14   31:ifeq            138
	//*  15   34:aload_0         
	//*  16   35:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//*  17   38:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//*  18   41:getfield        #420 <Field float VectorDrawableCompat$VPathRenderer.mBaseHeight>
	//*  19   44:fconst_0        
	//*  20   45:fcmpl           
	//*  21   46:ifeq            138
	//*  22   49:aload_0         
	//*  23   50:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//*  24   53:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//*  25   56:getfield        #410 <Field float VectorDrawableCompat$VPathRenderer.mViewportHeight>
	//*  26   59:fconst_0        
	//*  27   60:fcmpl           
	//*  28   61:ifeq            138
	//*  29   64:aload_0         
	//*  30   65:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//*  31   68:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//*  32   71:getfield        #401 <Field float VectorDrawableCompat$VPathRenderer.mViewportWidth>
	//*  33   74:fconst_0        
	//*  34   75:fcmpl           
	//*  35   76:ifne            82
	//*  36   79:goto            138
	...
	//   37   82:aload_0         
	//   38   83:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   39   86:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   40   89:getfield        #413 <Field float VectorDrawableCompat$VPathRenderer.mBaseWidth>
	//   41   92:fstore_1        
			float f1 = mVectorState.mVPathRenderer.mBaseHeight;
	//   42   93:aload_0         
	//   43   94:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   44   97:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   45  100:getfield        #420 <Field float VectorDrawableCompat$VPathRenderer.mBaseHeight>
	//   46  103:fstore_2        
			float f2 = mVectorState.mVPathRenderer.mViewportWidth;
	//   47  104:aload_0         
	//   48  105:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   49  108:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   50  111:getfield        #401 <Field float VectorDrawableCompat$VPathRenderer.mViewportWidth>
	//   51  114:fstore_3        
			float f3 = mVectorState.mVPathRenderer.mViewportHeight;
	//   52  115:aload_0         
	//   53  116:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   54  119:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   55  122:getfield        #410 <Field float VectorDrawableCompat$VPathRenderer.mViewportHeight>
	//   56  125:fstore          4
	...
	//   61  132:fload_2         
	//   62  133:fdiv            
	//   63  134:invokestatic    #582 <Method float Math.min(float, float)>
	//   64  137:freturn         
		} else
		{
			return 1.0F;
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #586 <Method int[] VectorDrawableCommon.getState()>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//    2    4:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//    3    7:getfield        #265 <Field ArrayMap VectorDrawableCompat$VPathRenderer.mVGTargetsMap>
	//    4   10:aload_1         
	//    5   11:invokevirtual   #591 <Method Object ArrayMap.get(Object)>
	//    6   14:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #595 <Method Region VectorDrawableCommon.getTransparentRegion()>
	//    2    4:areturn         
	}
	...
	//    6   12:aload_2         
	//    7   13:aload_3         
	//    8   14:invokevirtual   #598 <Method void Drawable.inflate(Resources, XmlPullParser, AttributeSet)>
			return;
	//    9   17:return          
		} else
		{
	...
	//   13   21:aload_3         
	//   14   22:aconst_null     
	//   15   23:invokevirtual   #208 <Method void inflate(Resources, XmlPullParser, AttributeSet, android.content.res.Resources$Theme)>
			return;
	//   16   26:return          
		}
	}
	...
	//    7   13:aload_3         
	//    8   14:aload           4
	//    9   16:invokestatic    #601 <Method void DrawableCompat.inflate(Drawable, Resources, XmlPullParser, AttributeSet, android.content.res.Resources$Theme)>
			return;
	//   10   19:return          
		} else
		{
			VectorDrawableCompatState vectordrawablecompatstate = mVectorState;
	//   11   20:aload_0         
	//   12   21:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   13   24:astore          5
			vectordrawablecompatstate.mVPathRenderer = new VPathRenderer();
	//   14   26:aload           5
	//   15   28:new             #23  <Class VectorDrawableCompat$VPathRenderer>
	//   16   31:dup             
	//   17   32:invokespecial   #602 <Method void VectorDrawableCompat$VPathRenderer()>
	//   18   35:putfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	...
	//   20   39:aload           4
	//   21   41:aload_3         
	//   22   42:getstatic       #608 <Field int[] AndroidResources.STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY>
	//   23   45:invokestatic    #612 <Method TypedArray TypedArrayUtils.obtainAttributes(Resources, android.content.res.Resources$Theme, AttributeSet, int[])>
	//   24   48:astore          6
			updateStateFromTypedArray(typedarray, xmlpullparser);
	//   25   50:aload_0         
	//   26   51:aload           6
	//   27   53:aload_2         
	//   28   54:invokespecial   #614 <Method void updateStateFromTypedArray(TypedArray, XmlPullParser)>
			typedarray.recycle();
	//   29   57:aload           6
	//   30   59:invokevirtual   #617 <Method void TypedArray.recycle()>
			vectordrawablecompatstate.mChangingConfigurations = getChangingConfigurations();
	//   31   62:aload           5
	//   32   64:aload_0         
	//   33   65:invokevirtual   #551 <Method int getChangingConfigurations()>
	//   34   68:putfield        #274 <Field int VectorDrawableCompat$VectorDrawableCompatState.mChangingConfigurations>
			vectordrawablecompatstate.mCacheDirty = true;
	//   35   71:aload           5
	//   36   73:iconst_1        
	//   37   74:putfield        #620 <Field boolean VectorDrawableCompat$VectorDrawableCompatState.mCacheDirty>
	...
	//   41   80:aload_3         
	//   42   81:aload           4
	//   43   83:invokespecial   #622 <Method void inflateInternal(Resources, XmlPullParser, AttributeSet, android.content.res.Resources$Theme)>
			mTintFilter = updateTintFilter(mTintFilter, vectordrawablecompatstate.mTint, vectordrawablecompatstate.mTintMode);
	//   44   86:aload_0         
	//   45   87:aload_0         
	//   46   88:aload_0         
	//   47   89:getfield        #112 <Field PorterDuffColorFilter mTintFilter>
	//   48   92:aload           5
	//   49   94:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//   50   97:aload           5
	//   51   99:getfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
	//   52  102:invokevirtual   #123 <Method PorterDuffColorFilter updateTintFilter(PorterDuffColorFilter, ColorStateList, android.graphics.PorterDuff$Mode)>
	//   53  105:putfield        #112 <Field PorterDuffColorFilter mTintFilter>
			return;
	//   54  108:return          
		}
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokevirtual   #625 <Method void Drawable.invalidateSelf()>
			return;
	//    6   14:return          
		} else
		{
	...
	//    7   15:aload_0         
	//    8   16:invokespecial   #626 <Method void VectorDrawableCommon.invalidateSelf()>
			return;
	//    9   19:return          
		}
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokestatic    #628 <Method boolean DrawableCompat.isAutoMirrored(Drawable)>
	//    6   14:ireturn         
		else
			return mVectorState.mAutoMirrored;
	//    7   15:aload_0         
	//    8   16:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//    9   19:getfield        #392 <Field boolean VectorDrawableCompat$VectorDrawableCompatState.mAutoMirrored>
	//   10   22:ireturn         
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokevirtual   #631 <Method boolean Drawable.isStateful()>
	//    6   14:ireturn         
		if(!super.isStateful())
	//*   7   15:aload_0         
	//*   8   16:invokespecial   #632 <Method boolean VectorDrawableCommon.isStateful()>
	//*   9   19:ifne            66
		{
			VectorDrawableCompatState vectordrawablecompatstate = mVectorState;
	//   10   22:aload_0         
	//   11   23:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   12   26:astore_1        
	...
	//*  14   28:ifnull          64
	//*  15   31:aload_1         
	//*  16   32:invokevirtual   #633 <Method boolean VectorDrawableCompat$VectorDrawableCompatState.isStateful()>
	//*  17   35:ifne            66
	//*  18   38:aload_0         
	//*  19   39:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//*  20   42:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//*  21   45:ifnull          64
	//*  22   48:aload_0         
	//*  23   49:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//*  24   52:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//*  25   55:invokevirtual   #636 <Method boolean ColorStateList.isStateful()>
	//*  26   58:ifeq            64
	//*  27   61:goto            66
				return false;
	//   28   64:iconst_0        
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #639 <Method void VectorDrawableCommon.jumpToCurrentState()>
	//    2    4:return          
	}
	...
	//    3    7:aload_0         
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:invokevirtual   #642 <Method Drawable Drawable.mutate()>
	//    6   14:pop             
	...
	//*   9   17:aload_0         
	//*  10   18:getfield        #644 <Field boolean mMutated>
	//*  11   21:ifne            52
	//*  12   24:aload_0         
	//*  13   25:invokespecial   #645 <Method Drawable VectorDrawableCommon.mutate()>
	//*  14   28:aload_0         
	//*  15   29:if_acmpne       52
		{
	...
	//   18   36:dup             
	//   19   37:aload_0         
	//   20   38:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   21   41:invokespecial   #647 <Method void VectorDrawableCompat$VectorDrawableCompatState(VectorDrawableCompat$VectorDrawableCompatState)>
	//   22   44:putfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
			mMutated = true;
	//   23   47:aload_0         
	//   24   48:iconst_1        
	//   25   49:putfield        #644 <Field boolean mMutated>
		}
		return ((Drawable) (this));
	//   26   52:aload_0         
	//   27   53:areturn         
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #651 <Method void Drawable.setBounds(Rect)>
	//    7   15:return          
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #656 <Method boolean Drawable.setState(int[])>
	//    7   15:ireturn         
		boolean flag1 = false;
	//    8   16:iconst_0        
	//    9   17:istore_3        
		VectorDrawableCompatState vectordrawablecompatstate = mVectorState;
	//   10   18:aload_0         
	//   11   19:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   12   22:astore          4
		boolean flag = flag1;
	//   13   24:iload_3         
	//   14   25:istore_2        
	...
	//*  15   26:aload           4
	//*  16   28:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//*  17   31:ifnull          72
		{
			flag = flag1;
	//   18   34:iload_3         
	...
	//*  20   36:aload           4
	//*  21   38:getfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
	//*  22   41:ifnull          72
			{
				mTintFilter = updateTintFilter(mTintFilter, vectordrawablecompatstate.mTint, vectordrawablecompatstate.mTintMode);
	//   23   44:aload_0         
	//   24   45:aload_0         
	//   25   46:aload_0         
	//   26   47:getfield        #112 <Field PorterDuffColorFilter mTintFilter>
	//   27   50:aload           4
	//   28   52:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//   29   55:aload           4
	//   30   57:getfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
	//   31   60:invokevirtual   #123 <Method PorterDuffColorFilter updateTintFilter(PorterDuffColorFilter, ColorStateList, android.graphics.PorterDuff$Mode)>
	//   32   63:putfield        #112 <Field PorterDuffColorFilter mTintFilter>
				invalidateSelf();
	//   33   66:aload_0         
	//   34   67:invokevirtual   #657 <Method void invalidateSelf()>
				flag = true;
	//   35   70:iconst_1        
	//   36   71:istore_2        
			}
	...
	//*  39   74:aload           4
	//*  40   76:invokevirtual   #633 <Method boolean VectorDrawableCompat$VectorDrawableCompatState.isStateful()>
	//*  41   79:ifeq            99
		{
			flag1 = flag;
	//   42   82:iload_2         
	...
	//*  44   84:aload           4
	//*  45   86:aload_1         
	//*  46   87:invokevirtual   #660 <Method boolean VectorDrawableCompat$VectorDrawableCompatState.onStateChanged(int[])>
	//*  47   90:ifeq            99
			{
				invalidateSelf();
	//   48   93:aload_0         
	//   49   94:invokevirtual   #657 <Method void invalidateSelf()>
				flag1 = true;
	//   50   97:iconst_1        
	//   51   98:istore_3        
			}
	...
	//    5   11:aload_1         
	//    6   12:lload_2         
	//    7   13:invokevirtual   #664 <Method void Drawable.scheduleSelf(Runnable, long)>
			return;
	//    8   16:return          
		} else
		{
	...
	//   10   18:aload_1         
	//   11   19:lload_2         
	//   12   20:invokespecial   #665 <Method void VectorDrawableCommon.scheduleSelf(Runnable, long)>
			return;
	//   13   23:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #93  <Field boolean mAllowCaching>
	//    3    5:return          
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:iload_1         
	//    6   12:invokevirtual   #669 <Method void Drawable.setAlpha(int)>
			return;
	//    7   15:return          
		}
		if(mVectorState.mVPathRenderer.getRootAlpha() != i)
	//*   8   16:aload_0         
	//*   9   17:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//*  10   20:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//*  11   23:invokevirtual   #541 <Method int VectorDrawableCompat$VPathRenderer.getRootAlpha()>
	//*  12   26:iload_1         
	//*  13   27:icmpeq          45
		{
			mVectorState.mVPathRenderer.setRootAlpha(i);
	//   14   30:aload_0         
	//   15   31:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   16   34:getfield        #214 <Field VectorDrawableCompat$VPathRenderer VectorDrawableCompat$VectorDrawableCompatState.mVPathRenderer>
	//   17   37:iload_1         
	//   18   38:invokevirtual   #672 <Method void VectorDrawableCompat$VPathRenderer.setRootAlpha(int)>
			invalidateSelf();
	//   19   41:aload_0         
	//   20   42:invokevirtual   #657 <Method void invalidateSelf()>
		}
	//   21   45:return          
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:iload_1         
	//    6   12:invokestatic    #676 <Method void DrawableCompat.setAutoMirrored(Drawable, boolean)>
			return;
	//    7   15:return          
		} else
		{
	...
	//    9   17:getfield        #108 <Field VectorDrawableCompat$VectorDrawableCompatState mVectorState>
	//   10   20:iload_1         
	//   11   21:putfield        #392 <Field boolean VectorDrawableCompat$VectorDrawableCompatState.mAutoMirrored>
			return;
	//   12   24:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #679 <Method void VectorDrawableCommon.setChangingConfigurations(int)>
	//    3    5:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #683 <Method void VectorDrawableCommon.setColorFilter(int, android.graphics.PorterDuff$Mode)>
	//    4    6:return          
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #686 <Method void Drawable.setColorFilter(ColorFilter)>
			return;
	//    7   15:return          
		} else
		{
	...
	//   10   18:putfield        #474 <Field ColorFilter mColorFilter>
			invalidateSelf();
	//   11   21:aload_0         
	//   12   22:invokevirtual   #657 <Method void invalidateSelf()>
			return;
	//   13   25:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #689 <Method void VectorDrawableCommon.setFilterBitmap(boolean)>
	//    3    5:return          
	}
	...
	//    1    1:fload_1         
	//    2    2:fload_2         
	//    3    3:invokespecial   #692 <Method void VectorDrawableCommon.setHotspot(float, float)>
	//    4    6:return          
	}
	...
	//    3    3:iload_3         
	//    4    4:iload           4
	//    5    6:invokespecial   #696 <Method void VectorDrawableCommon.setHotspotBounds(int, int, int, int)>
	//    6    9:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #697 <Method boolean VectorDrawableCommon.setState(int[])>
	//    3    5:ireturn         
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:iload_1         
	//    6   12:invokestatic    #701 <Method void DrawableCompat.setTint(Drawable, int)>
			return;
	//    7   15:return          
		} else
		{
	...
	//    8   16:aload_0         
	//    9   17:iload_1         
	//   10   18:invokestatic    #704 <Method ColorStateList ColorStateList.valueOf(int)>
	//   11   21:invokevirtual   #708 <Method void setTintList(ColorStateList)>
			return;
	//   12   24:return          
		}
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:aload_1         
	//    6   12:invokestatic    #711 <Method void DrawableCompat.setTintList(Drawable, ColorStateList)>
			return;
	//    7   15:return          
		}
		VectorDrawableCompatState vectordrawablecompatstate = mVectorState;
	...
	//*  11   21:aload_2         
	//*  12   22:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//*  13   25:aload_1         
	//*  14   26:if_acmpeq       55
		{
			vectordrawablecompatstate.mTint = colorstatelist;
	//   15   29:aload_2         
	//   16   30:aload_1         
	//   17   31:putfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
			mTintFilter = updateTintFilter(mTintFilter, colorstatelist, vectordrawablecompatstate.mTintMode);
	//   18   34:aload_0         
	//   19   35:aload_0         
	//   20   36:aload_0         
	//   21   37:getfield        #112 <Field PorterDuffColorFilter mTintFilter>
	//   22   40:aload_1         
	//   23   41:aload_2         
	//   24   42:getfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
	//   25   45:invokevirtual   #123 <Method PorterDuffColorFilter updateTintFilter(PorterDuffColorFilter, ColorStateList, android.graphics.PorterDuff$Mode)>
	//   26   48:putfield        #112 <Field PorterDuffColorFilter mTintFilter>
			invalidateSelf();
	//   27   51:aload_0         
	//   28   52:invokevirtual   #657 <Method void invalidateSelf()>
		}
	//   29   55:return          
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:aload_1         
	//    6   12:invokestatic    #716 <Method void DrawableCompat.setTintMode(Drawable, android.graphics.PorterDuff$Mode)>
			return;
	//    7   15:return          
		}
		VectorDrawableCompatState vectordrawablecompatstate = mVectorState;
	...
	//*  11   21:aload_2         
	//*  12   22:getfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
	//*  13   25:aload_1         
	//*  14   26:if_acmpeq       55
		{
	...
	//   15   29:aload_2         
	//   16   30:aload_1         
	//   17   31:putfield        #119 <Field android.graphics.PorterDuff$Mode VectorDrawableCompat$VectorDrawableCompatState.mTintMode>
	...
	//   21   37:getfield        #112 <Field PorterDuffColorFilter mTintFilter>
	//   22   40:aload_2         
	//   23   41:getfield        #116 <Field ColorStateList VectorDrawableCompat$VectorDrawableCompatState.mTint>
	//   24   44:aload_1         
	//   25   45:invokevirtual   #123 <Method PorterDuffColorFilter updateTintFilter(PorterDuffColorFilter, ColorStateList, android.graphics.PorterDuff$Mode)>
	//   26   48:putfield        #112 <Field PorterDuffColorFilter mTintFilter>
			invalidateSelf();
	...
	//    5   11:iload_1         
	//    6   12:iload_2         
	//    7   13:invokevirtual   #720 <Method boolean Drawable.setVisible(boolean, boolean)>
	//    8   16:ireturn         
		else
	...
	//   10   18:iload_1         
	//   11   19:iload_2         
	//   12   20:invokespecial   #721 <Method boolean VectorDrawableCommon.setVisible(boolean, boolean)>
	//   13   23:ireturn         
	}
	...
	//    4    8:getfield        #157 <Field Drawable mDelegateDrawable>
	//    5   11:aload_1         
	//    6   12:invokevirtual   #725 <Method void Drawable.unscheduleSelf(Runnable)>
			return;
	//    7   15:return          
		} else
		{
	...
	//    8   16:aload_0         
	//    9   17:aload_1         
	//   10   18:invokespecial   #726 <Method void VectorDrawableCommon.unscheduleSelf(Runnable)>
			return;
	//   11   21:return          
		}
	}
	...
	//    5   11:new             #728 <Class PorterDuffColorFilter>
	//    6   14:dup             
	//    7   15:aload_2         
	//    8   16:aload_0         
	//    9   17:invokevirtual   #729 <Method int[] getState()>
	//   10   20:iconst_0        
	//   11   21:invokevirtual   #733 <Method int ColorStateList.getColorForState(int[], int)>
	//   12   24:aload_3         
	//   13   25:invokespecial   #735 <Method void PorterDuffColorFilter(int, android.graphics.PorterDuff$Mode)>
	//   14   28:areturn         
		else
			return null;
	//   15   29:aconst_null     
	...
	//    0    0:getstatic       #85  <Field android.graphics.PorterDuff$Mode android.graphics.PorterDuff$Mode.SRC_IN>
	//    1    3:putstatic       #87  <Field android.graphics.PorterDuff$Mode DEFAULT_TINT_MODE>
	//*   2    6:return          
	}
}
