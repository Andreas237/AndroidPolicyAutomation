	...
	implements TypeEvaluator
{
	...
	//  158  280:istore          12
		return ((Object) (Integer.valueOf(Math.round(f4 * 255F) << 16 | i << 24 | Math.round(f5 * 255F) << 8 | Math.round(f3 * 255F))));
	//  159  282:fload           7
	...
	//  168  298:ior             
	//  169  299:fload           8
	//  170  301:ldc1            #32  <Float 255F>
	//  171  303:fmul            
	//  172  304:invokestatic    #46  <Method int Math.round(float)>
	//  173  307:bipush          8
	//  174  309:ishl            
	//  175  310:ior             
	//  176  311:fload           6
	//  177  313:ldc1            #32  <Float 255F>
	//  178  315:fmul            
	//  179  316:invokestatic    #46  <Method int Math.round(float)>
	//  180  319:ior             
	//  181  320:invokestatic    #50  <Method Integer Integer.valueOf(int)>
	//  182  323:areturn         
	}
