...
class AndroidResources
{
	...
	public static final int FAST_OUT_LINEAR_IN = 0x10c000f;
	public static final int FAST_OUT_SLOW_IN = 0x10c000d;
	public static final int LINEAR_OUT_SLOW_IN = 0x10c000e;
	...
	public static final int STYLEABLE_KEYFRAME[] = {
		0x1010024, 0x1010141, 0x10102e0, 0x10104d8
	};
	...
	public static final int STYLEABLE_PATH_INTERPOLATOR[] = {
		0x10103fc, 0x10103fd, 0x10103fe, 0x10103ff, 0x1010405
	};
	...
	public static final int STYLEABLE_PROPERTY_ANIMATOR[] = {
		0x10102e1, 0x1010405, 0x1010474, 0x1010475
	};
	...
	public static final int STYLEABLE_PROPERTY_VALUES_HOLDER[] = {
		0x10102de, 0x10102df, 0x10102e0, 0x10102e1
	};
	...
	static final int STYLEABLE_VECTOR_DRAWABLE_GROUP[] = {
		0x1010003, 0x10101b5, 0x10101b6, 0x1010324, 0x1010325, 0x1010326, 0x101045a, 0x101045b
	};
	...
	static final int STYLEABLE_VECTOR_DRAWABLE_PATH[] = {
		0x1010003, 0x1010404, 0x1010405, 0x1010406, 0x1010407, 0x1010408, 0x1010409, 0x101040a, 0x101040b, 0x101040c, 
		0x101040d, 0x10104cb, 0x10104cc, 0x101051e
	};
	...
	static final int STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY[] = {
		0x1010003, 0x1010121, 0x1010155, 0x1010159, 0x101031f, 0x10103ea, 0x10103fb, 0x1010402, 0x1010403
	};
	...
	//    2    4:dup             
	//    3    5:iconst_0        
	//    4    6:ldc1            #104 <Int 0x1010003>
	//    5    8:iastore         
	//    6    9:dup             
	//    7   10:iconst_1        
	//    8   11:ldc1            #105 <Int 0x1010121>
	//    9   13:iastore         
	//   10   14:dup             
	//   11   15:iconst_2        
	//   12   16:ldc1            #106 <Int 0x1010155>
	//   13   18:iastore         
	//   14   19:dup             
	//   15   20:iconst_3        
	//   16   21:ldc1            #107 <Int 0x1010159>
	//   17   23:iastore         
	//   18   24:dup             
	//   19   25:iconst_4        
	//   20   26:ldc1            #108 <Int 0x101031f>
	//   21   28:iastore         
	//   22   29:dup             
	//   23   30:iconst_5        
	//   24   31:ldc1            #109 <Int 0x10103ea>
	//   25   33:iastore         
	//   26   34:dup             
	//   27   35:bipush          6
	//   28   37:ldc1            #110 <Int 0x10103fb>
	//   29   39:iastore         
	//   30   40:dup             
	//   31   41:bipush          7
	//   32   43:ldc1            #111 <Int 0x1010402>
	//   33   45:iastore         
	//   34   46:dup             
	//   35   47:bipush          8
	//   36   49:ldc1            #112 <Int 0x1010403>
	//   37   51:iastore         
	//   38   52:putstatic       #114 <Field int[] STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY>
	//   39   55:bipush          8
	//   40   57:newarray        int[]
	//   41   59:dup             
	//   42   60:iconst_0        
	//   43   61:ldc1            #104 <Int 0x1010003>
	//   44   63:iastore         
	//   45   64:dup             
	//   46   65:iconst_1        
	//   47   66:ldc1            #115 <Int 0x10101b5>
	//   48   68:iastore         
	//   49   69:dup             
	//   50   70:iconst_2        
	//   51   71:ldc1            #116 <Int 0x10101b6>
	//   52   73:iastore         
	//   53   74:dup             
	//   54   75:iconst_3        
	//   55   76:ldc1            #117 <Int 0x1010324>
	//   56   78:iastore         
	//   57   79:dup             
	//   58   80:iconst_4        
	//   59   81:ldc1            #118 <Int 0x1010325>
	//   60   83:iastore         
	//   61   84:dup             
	//   62   85:iconst_5        
	//   63   86:ldc1            #119 <Int 0x1010326>
	//   64   88:iastore         
	//   65   89:dup             
	//   66   90:bipush          6
	//   67   92:ldc1            #120 <Int 0x101045a>
	//   68   94:iastore         
	//   69   95:dup             
	//   70   96:bipush          7
	//   71   98:ldc1            #121 <Int 0x101045b>
	//   72  100:iastore         
	//   73  101:putstatic       #123 <Field int[] STYLEABLE_VECTOR_DRAWABLE_GROUP>
	//   74  104:bipush          14
	//   75  106:newarray        int[]
	//   76  108:dup             
	//   77  109:iconst_0        
	//   78  110:ldc1            #104 <Int 0x1010003>
	//   79  112:iastore         
	//   80  113:dup             
	//   81  114:iconst_1        
	//   82  115:ldc1            #124 <Int 0x1010404>
	//   83  117:iastore         
	//   84  118:dup             
	//   85  119:iconst_2        
	//   86  120:ldc1            #125 <Int 0x1010405>
	//   87  122:iastore         
	//   88  123:dup             
	//   89  124:iconst_3        
	//   90  125:ldc1            #126 <Int 0x1010406>
	//   91  127:iastore         
	//   92  128:dup             
	//   93  129:iconst_4        
	//   94  130:ldc1            #127 <Int 0x1010407>
	//   95  132:iastore         
	//   96  133:dup             
	//   97  134:iconst_5        
	//   98  135:ldc1            #128 <Int 0x1010408>
	//   99  137:iastore         
	//  100  138:dup             
	//  101  139:bipush          6
	//  102  141:ldc1            #129 <Int 0x1010409>
	//  103  143:iastore         
	//  104  144:dup             
	//  105  145:bipush          7
	//  106  147:ldc1            #130 <Int 0x101040a>
	//  107  149:iastore         
	//  108  150:dup             
	//  109  151:bipush          8
	//  110  153:ldc1            #131 <Int 0x101040b>
	//  111  155:iastore         
	//  112  156:dup             
	//  113  157:bipush          9
	//  114  159:ldc1            #132 <Int 0x101040c>
	//  115  161:iastore         
	//  116  162:dup             
	//  117  163:bipush          10
	//  118  165:ldc1            #133 <Int 0x101040d>
	//  119  167:iastore         
	//  120  168:dup             
	//  121  169:bipush          11
	//  122  171:ldc1            #134 <Int 0x10104cb>
	//  123  173:iastore         
	//  124  174:dup             
	//  125  175:bipush          12
	//  126  177:ldc1            #135 <Int 0x10104cc>
	//  127  179:iastore         
	//  128  180:dup             
	//  129  181:bipush          13
	//  130  183:ldc1            #136 <Int 0x101051e>
	//  131  185:iastore         
	//  132  186:putstatic       #138 <Field int[] STYLEABLE_VECTOR_DRAWABLE_PATH>
	//  133  189:iconst_2        
	//  134  190:newarray        int[]
	//  135  192:dup             
	//  136  193:iconst_0        
	//  137  194:ldc1            #104 <Int 0x1010003>
	//  138  196:iastore         
	//  139  197:dup             
	//  140  198:iconst_1        
	//  141  199:ldc1            #125 <Int 0x1010405>
	//  142  201:iastore         
	//  143  202:putstatic       #140 <Field int[] STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH>
	//  144  205:iconst_1        
	//  145  206:newarray        int[]
	//  146  208:dup             
	//  147  209:iconst_0        
	//  148  210:ldc1            #141 <Int 0x1010199>
	//  149  212:iastore         
	//  150  213:putstatic       #143 <Field int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE>
	//  151  216:iconst_2        
	//  152  217:newarray        int[]
	//  153  219:dup             
	//  154  220:iconst_0        
	//  155  221:ldc1            #104 <Int 0x1010003>
	//  156  223:iastore         
	//  157  224:dup             
	//  158  225:iconst_1        
	//  159  226:ldc1            #144 <Int 0x10101cd>
	//  160  228:iastore         
	//  161  229:putstatic       #146 <Field int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET>
	//  162  232:bipush          8
	//  163  234:newarray        int[]
	//  164  236:dup             
	//  165  237:iconst_0        
	//  166  238:ldc1            #147 <Int 0x1010141>
	//  167  240:iastore         
	//  168  241:dup             
	//  169  242:iconst_1        
	//  170  243:ldc1            #148 <Int 0x1010198>
	//  171  245:iastore         
	//  172  246:dup             
	//  173  247:iconst_2        
	//  174  248:ldc1            #149 <Int 0x10101be>
	//  175  250:iastore         
	//  176  251:dup             
	//  177  252:iconst_3        
	//  178  253:ldc1            #150 <Int 0x10101bf>
	//  179  255:iastore         
	//  180  256:dup             
	//  181  257:iconst_4        
	//  182  258:ldc1            #151 <Int 0x10101c0>
	//  183  260:iastore         
	//  184  261:dup             
	//  185  262:iconst_5        
	//  186  263:ldc1            #152 <Int 0x10102de>
	//  187  265:iastore         
	//  188  266:dup             
	//  189  267:bipush          6
	//  190  269:ldc1            #153 <Int 0x10102df>
	//  191  271:iastore         
	//  192  272:dup             
	//  193  273:bipush          7
	//  194  275:ldc1            #154 <Int 0x10102e0>
	//  195  277:iastore         
	//  196  278:putstatic       #156 <Field int[] STYLEABLE_ANIMATOR>
	//  197  281:iconst_1        
	//  198  282:newarray        int[]
	//  199  284:dup             
	//  200  285:iconst_0        
	//  201  286:ldc1            #157 <Int 0x10102e2>
	//  202  288:iastore         
	//  203  289:putstatic       #159 <Field int[] STYLEABLE_ANIMATOR_SET>
	//  204  292:iconst_4        
	//  205  293:newarray        int[]
	//  206  295:dup             
	//  207  296:iconst_0        
	//  208  297:ldc1            #152 <Int 0x10102de>
	//  209  299:iastore         
	//  210  300:dup             
	//  211  301:iconst_1        
	//  212  302:ldc1            #153 <Int 0x10102df>
	//  213  304:iastore         
	//  214  305:dup             
	//  215  306:iconst_2        
	//  216  307:ldc1            #154 <Int 0x10102e0>
	//  217  309:iastore         
	//  218  310:dup             
	//  219  311:iconst_3        
	//  220  312:ldc1            #160 <Int 0x10102e1>
	//  221  314:iastore         
	//  222  315:putstatic       #162 <Field int[] STYLEABLE_PROPERTY_VALUES_HOLDER>
	//  223  318:iconst_4        
	//  224  319:newarray        int[]
	//  225  321:dup             
	//  226  322:iconst_0        
	//  227  323:ldc1            #163 <Int 0x1010024>
	//  228  325:iastore         
	//  229  326:dup             
	//  230  327:iconst_1        
	//  231  328:ldc1            #147 <Int 0x1010141>
	//  232  330:iastore         
	//  233  331:dup             
	//  234  332:iconst_2        
	//  235  333:ldc1            #154 <Int 0x10102e0>
	//  236  335:iastore         
	//  237  336:dup             
	//  238  337:iconst_3        
	//  239  338:ldc1            #164 <Int 0x10104d8>
	//  240  340:iastore         
	//  241  341:putstatic       #166 <Field int[] STYLEABLE_KEYFRAME>
	//  242  344:iconst_4        
	//  243  345:newarray        int[]
	//  244  347:dup             
	//  245  348:iconst_0        
	//  246  349:ldc1            #160 <Int 0x10102e1>
	//  247  351:iastore         
	//  248  352:dup             
	//  249  353:iconst_1        
	//  250  354:ldc1            #125 <Int 0x1010405>
	//  251  356:iastore         
	//  252  357:dup             
	//  253  358:iconst_2        
	//  254  359:ldc1            #167 <Int 0x1010474>
	//  255  361:iastore         
	//  256  362:dup             
	//  257  363:iconst_3        
	//  258  364:ldc1            #168 <Int 0x1010475>
	//  259  366:iastore         
	//  260  367:putstatic       #170 <Field int[] STYLEABLE_PROPERTY_ANIMATOR>
	//  261  370:iconst_5        
	//  262  371:newarray        int[]
	//  263  373:dup             
	//  264  374:iconst_0        
	//  265  375:ldc1            #171 <Int 0x10103fc>
	//  266  377:iastore         
	//  267  378:dup             
	//  268  379:iconst_1        
	//  269  380:ldc1            #172 <Int 0x10103fd>
	//  270  382:iastore         
	//  271  383:dup             
	//  272  384:iconst_2        
	//  273  385:ldc1            #173 <Int 0x10103fe>
	//  274  387:iastore         
	//  275  388:dup             
	//  276  389:iconst_3        
	//  277  390:ldc1            #174 <Int 0x10103ff>
	//  278  392:iastore         
	//  279  393:dup             
	//  280  394:iconst_4        
	//  281  395:ldc1            #125 <Int 0x1010405>
	//  282  397:iastore         
	//  283  398:putstatic       #176 <Field int[] STYLEABLE_PATH_INTERPOLATOR>
	//* 284  401:return          
	}
}
