...
public class Scene
{
	...
	//   26   58:invokevirtual   #96  <Method void ViewGroup.addView(View)>
		...
		Runnable runnable = mEnterAction;
	//   27   61:aload_0         
	...
	//*  31   67:ifnull          76
			runnable.run();
	//   32   70:aload_1         
	//   33   71:invokeinterface #103 <Method void Runnable.run()>
		setCurrentScene(((View) (mSceneRoot)), this);
	//   34   76:aload_0         
	//   35   77:getfield        #25  <Field ViewGroup mSceneRoot>
	//   36   80:aload_0         
	//   37   81:invokestatic    #105 <Method void setCurrentScene(View, Scene)>
	//   38   84:return          
	}
	...
	//*   9   17:ifnull          26
				runnable.run();
	//   10   20:aload_1         
	//   11   21:invokeinterface #103 <Method void Runnable.run()>
		}
	//   12   26:return          
	}
