...
public abstract class Visibility extends Transition
{
	...
	//    1    3:dup             
	//    2    4:invokespecial   #120 <Method void Visibility$VisibilityInfo()>
	//    3    7:astore_3        
		visibilityinfo.mVisibilityChange = false;
	//    4    8:aload_3         
	//    5    9:iconst_0        
	//    6   10:putfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
		visibilityinfo.mFadeIn = false;
	//    7   13:aload_3         
	//    8   14:iconst_0        
	//    9   15:putfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
		if(transitionvalues != null && transitionvalues.values.containsKey("android:visibility:visibility"))
	//*  10   18:aload_1         
	//*  11   19:ifnull          78
	//*  12   22:aload_1         
	//*  13   23:getfield        #97  <Field Map TransitionValues.values>
	//*  14   26:ldc1            #30  <String "android:visibility:visibility">
	//*  15   28:invokeinterface #131 <Method boolean Map.containsKey(Object)>
	//*  16   33:ifeq            78
		{
			visibilityinfo.mStartVisibility = ((Integer)transitionvalues.values.get("android:visibility:visibility")).intValue();
	//   17   36:aload_3         
	//   18   37:aload_1         
	//   19   38:getfield        #97  <Field Map TransitionValues.values>
	//   20   41:ldc1            #30  <String "android:visibility:visibility">
	//   21   43:invokeinterface #135 <Method Object Map.get(Object)>
	//   22   48:checkcast       #99  <Class Integer>
	//   23   51:invokevirtual   #138 <Method int Integer.intValue()>
	//   24   54:putfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
			visibilityinfo.mStartParent = (ViewGroup)transitionvalues.values.get("android:visibility:parent");
	//   25   57:aload_3         
	//   26   58:aload_1         
	//   27   59:getfield        #97  <Field Map TransitionValues.values>
	//   28   62:ldc1            #24  <String "android:visibility:parent">
	//   29   64:invokeinterface #135 <Method Object Map.get(Object)>
	//   30   69:checkcast       #143 <Class ViewGroup>
	//   31   72:putfield        #147 <Field ViewGroup Visibility$VisibilityInfo.mStartParent>
		} else
	//*  32   75:goto            88
		{
	...
	//   33   78:aload_3         
	//   34   79:iconst_m1       
	//   35   80:putfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
			visibilityinfo.mStartParent = null;
	//   36   83:aload_3         
	//   37   84:aconst_null     
	//   38   85:putfield        #147 <Field ViewGroup Visibility$VisibilityInfo.mStartParent>
		}
		if(transitionvalues1 != null && transitionvalues1.values.containsKey("android:visibility:visibility"))
	//*  39   88:aload_2         
	//*  40   89:ifnull          148
	//*  41   92:aload_2         
	//*  42   93:getfield        #97  <Field Map TransitionValues.values>
	//*  43   96:ldc1            #30  <String "android:visibility:visibility">
	//*  44   98:invokeinterface #131 <Method boolean Map.containsKey(Object)>
	//*  45  103:ifeq            148
		{
			visibilityinfo.mEndVisibility = ((Integer)transitionvalues1.values.get("android:visibility:visibility")).intValue();
	//   46  106:aload_3         
	//   47  107:aload_2         
	//   48  108:getfield        #97  <Field Map TransitionValues.values>
	//   49  111:ldc1            #30  <String "android:visibility:visibility">
	//   50  113:invokeinterface #135 <Method Object Map.get(Object)>
	//   51  118:checkcast       #99  <Class Integer>
	//   52  121:invokevirtual   #138 <Method int Integer.intValue()>
	//   53  124:putfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
			visibilityinfo.mEndParent = (ViewGroup)transitionvalues1.values.get("android:visibility:parent");
	//   54  127:aload_3         
	//   55  128:aload_2         
	//   56  129:getfield        #97  <Field Map TransitionValues.values>
	//   57  132:ldc1            #24  <String "android:visibility:parent">
	//   58  134:invokeinterface #135 <Method Object Map.get(Object)>
	//   59  139:checkcast       #143 <Class ViewGroup>
	//   60  142:putfield        #153 <Field ViewGroup Visibility$VisibilityInfo.mEndParent>
		} else
	//*  61  145:goto            158
		{
	...
	//   62  148:aload_3         
	//   63  149:iconst_m1       
	//   64  150:putfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
			visibilityinfo.mEndParent = null;
	//   65  153:aload_3         
	//   66  154:aconst_null     
	//   67  155:putfield        #153 <Field ViewGroup Visibility$VisibilityInfo.mEndParent>
		}
	...
	//*  72  166:aload_3         
	//*  73  167:getfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
	//*  74  170:aload_3         
	//*  75  171:getfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
	//*  76  174:icmpne          190
	//*  77  177:aload_3         
	//*  78  178:getfield        #147 <Field ViewGroup Visibility$VisibilityInfo.mStartParent>
	//*  79  181:aload_3         
	//*  80  182:getfield        #153 <Field ViewGroup Visibility$VisibilityInfo.mEndParent>
	...
	//*  84  190:aload_3         
	//*  85  191:getfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
	//*  86  194:aload_3         
	//*  87  195:getfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
	//*  88  198:icmpeq          239
			{
				if(visibilityinfo.mStartVisibility == 0)
	//*  89  201:aload_3         
	//*  90  202:getfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
	//*  91  205:ifne            220
				{
					visibilityinfo.mFadeIn = false;
	//   92  208:aload_3         
	//   93  209:iconst_0        
	//   94  210:putfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
					visibilityinfo.mVisibilityChange = true;
	//   95  213:aload_3         
	//   96  214:iconst_1        
	//   97  215:putfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
					return visibilityinfo;
	//   98  218:aload_3         
	//   99  219:areturn         
				}
	...
	//* 100  220:aload_3         
	//* 101  221:getfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
	//* 102  224:ifne            321
				{
					visibilityinfo.mFadeIn = true;
	//  103  227:aload_3         
	//  104  228:iconst_1        
	//  105  229:putfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
					visibilityinfo.mVisibilityChange = true;
	//  106  232:aload_3         
	//  107  233:iconst_1        
	//  108  234:putfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
					return visibilityinfo;
	//  109  237:aload_3         
	//  110  238:areturn         
				}
	...
	//* 111  239:aload_3         
	//* 112  240:getfield        #153 <Field ViewGroup Visibility$VisibilityInfo.mEndParent>
	//* 113  243:ifnonnull       258
				{
					visibilityinfo.mFadeIn = false;
	//  114  246:aload_3         
	//  115  247:iconst_0        
	//  116  248:putfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
					visibilityinfo.mVisibilityChange = true;
	//  117  251:aload_3         
	//  118  252:iconst_1        
	//  119  253:putfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
					return visibilityinfo;
	//  120  256:aload_3         
	//  121  257:areturn         
				}
	...
	//* 122  258:aload_3         
	//* 123  259:getfield        #147 <Field ViewGroup Visibility$VisibilityInfo.mStartParent>
	//* 124  262:ifnonnull       321
				{
					visibilityinfo.mFadeIn = true;
	//  125  265:aload_3         
	//  126  266:iconst_1        
	//  127  267:putfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
					visibilityinfo.mVisibilityChange = true;
	//  128  270:aload_3         
	//  129  271:iconst_1        
	//  130  272:putfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
					return visibilityinfo;
	//  131  275:aload_3         
	//  132  276:areturn         
				}
	...
	//* 135  281:aload_3         
	//* 136  282:getfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
	//* 137  285:ifne            300
			{
				visibilityinfo.mFadeIn = true;
	//  138  288:aload_3         
	//  139  289:iconst_1        
	//  140  290:putfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
				visibilityinfo.mVisibilityChange = true;
	//  141  293:aload_3         
	//  142  294:iconst_1        
	//  143  295:putfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
				return visibilityinfo;
	//  144  298:aload_3         
	//  145  299:areturn         
			}
	...
	//* 148  304:aload_3         
	//* 149  305:getfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
	//* 150  308:ifne            321
			{
				visibilityinfo.mFadeIn = false;
	//  151  311:aload_3         
	//  152  312:iconst_0        
	//  153  313:putfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
				visibilityinfo.mVisibilityChange = true;
	//  154  316:aload_3         
	//  155  317:iconst_1        
	//  156  318:putfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
			}
		}
		return visibilityinfo;
	//  157  321:aload_3         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #157 <Method void captureValues(TransitionValues)>
	//    3    5:return          
	}
	...
	//    1    1:aload_2         
	//    2    2:aload_3         
	//    3    3:invokespecial   #164 <Method Visibility$VisibilityInfo getVisibilityChangeInfo(TransitionValues, TransitionValues)>
	//    4    6:astore          4
		if(visibilityinfo.mVisibilityChange && (visibilityinfo.mStartParent != null || visibilityinfo.mEndParent != null))
	//*   5    8:aload           4
	//*   6   10:getfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
	//*   7   13:ifeq            76
	//*   8   16:aload           4
	//*   9   18:getfield        #147 <Field ViewGroup Visibility$VisibilityInfo.mStartParent>
	//*  10   21:ifnonnull       32
	//*  11   24:aload           4
	//*  12   26:getfield        #153 <Field ViewGroup Visibility$VisibilityInfo.mEndParent>
	//*  13   29:ifnull          76
		{
			if(visibilityinfo.mFadeIn)
	//*  14   32:aload           4
	//*  15   34:getfield        #127 <Field boolean Visibility$VisibilityInfo.mFadeIn>
	//*  16   37:ifeq            58
	...
	//   19   42:aload_2         
	//   20   43:aload           4
	//   21   45:getfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
	//   22   48:aload_3         
	//   23   49:aload           4
	//   24   51:getfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
	//   25   54:invokevirtual   #168 <Method Animator onAppear(ViewGroup, TransitionValues, int, TransitionValues, int)>
	//   26   57:areturn         
			else
	...
	//   29   60:aload_2         
	//   30   61:aload           4
	//   31   63:getfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
	//   32   66:aload_3         
	//   33   67:aload           4
	//   34   69:getfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
	//   35   72:invokevirtual   #171 <Method Animator onDisappear(ViewGroup, TransitionValues, int, TransitionValues, int)>
	//   36   75:areturn         
		} else
		{
			return null;
...
label0:
	...
	//*  15   27:invokeinterface #131 <Method boolean Map.containsKey(Object)>
	//*  16   32:aload_1         
	//*  17   33:getfield        #97  <Field Map TransitionValues.values>
	//*  18   36:ldc1            #30  <String "android:visibility:visibility">
	//*  19   38:invokeinterface #131 <Method boolean Map.containsKey(Object)>
	//*  20   43:icmpeq          48
				return false;
	//   21   46:iconst_0        
	//   22   47:ireturn         
	...
	//   24   49:aload_1         
	//   25   50:aload_2         
	//   26   51:invokespecial   #164 <Method Visibility$VisibilityInfo getVisibilityChangeInfo(TransitionValues, TransitionValues)>
	//   27   54:astore_1        
			flag = flag1;
	//   28   55:iload           4
	//   29   57:istore_3        
			if(!((VisibilityInfo) (transitionvalues)).mVisibilityChange)
				break label0;
	//   30   58:aload_1         
	//   31   59:getfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
	//   32   62:ifeq            84
			if(((VisibilityInfo) (transitionvalues)).mStartVisibility != 0)
	//*  33   65:aload_1         
	//*  34   66:getfield        #141 <Field int Visibility$VisibilityInfo.mStartVisibility>
	//*  35   69:ifeq            82
			{
				flag = flag1;
	//   36   72:iload           4
	//   37   74:istore_3        
				if(((VisibilityInfo) (transitionvalues)).mEndVisibility != 0)
					break label0;
	//   38   75:aload_1         
	//   39   76:getfield        #150 <Field int Visibility$VisibilityInfo.mEndVisibility>
	//   40   79:ifne            84
			}
			flag = true;
	//   41   82:iconst_1        
	...
	//    9   15:invokeinterface #135 <Method Object Map.get(Object)>
	//   10   20:checkcast       #99  <Class Integer>
	//   11   23:invokevirtual   #138 <Method int Integer.intValue()>
	//   12   26:istore_2        
	...
	//   16   33:invokeinterface #135 <Method Object Map.get(Object)>
	...
	//*  19   36:aload           6
	//*  20   38:iconst_0        
	//*  21   39:invokevirtual   #183 <Method TransitionValues getMatchedTransitionValues(View, boolean)>
	//*  22   42:aload_0         
	//*  23   43:aload           6
	//*  24   45:iconst_0        
	//*  25   46:invokevirtual   #186 <Method TransitionValues getTransitionValues(View, boolean)>
	//*  26   49:invokespecial   #164 <Method Visibility$VisibilityInfo getVisibilityChangeInfo(TransitionValues, TransitionValues)>
	//*  27   52:getfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
	//*  28   55:ifeq            60
					return null;
	//   29   58:aconst_null     
	//   30   59:areturn         
	...
	//   35   67:aload_2         
	//   36   68:aload           4
	//   37   70:invokevirtual   #189 <Method Animator onAppear(ViewGroup, View, TransitionValues, TransitionValues)>
	//   38   73:areturn         
		} else
		{
			return null;
...
label2:
	...
	//   39   81:goto            261
						...
						if(!mCanRemoveViews)
	//*  40   84:aload_0         
	//*  41   85:getfield        #192 <Field boolean mCanRemoveViews>
	//*  42   88:ifeq            94
	//*  43   91:goto            144
						{
	...
	//   45   95:aload           7
	//   46   97:aload           7
	//   47   99:invokevirtual   #113 <Method android.view.ViewParent View.getParent()>
	//   48  102:checkcast       #89  <Class View>
	//   49  105:invokestatic    #198 <Method View TransitionUtils.copyViewImage(ViewGroup, View, View)>
	//   50  108:astore          7
							overlay = null;
	//   51  110:aconst_null     
	//   52  111:astore          6
	...
	//   62  133:ifnull          254
						if(((View) (finalOverlayView)).getParent() != null)
							break label2;
	//   63  136:aload           7
	//   64  138:invokevirtual   #113 <Method android.view.ViewParent View.getParent()>
...
label3:
				{
					if(!(((View) (finalOverlayView)).getParent() instanceof View))
						break label1;
	//   69  150:aload           7
	//   70  152:invokevirtual   #113 <Method android.view.ViewParent View.getParent()>
	//   71  155:instanceof      #89  <Class View>
	//   72  158:ifeq            254
					overlay = ((Object) ((View)((View) (finalOverlayView)).getParent()));
	//   73  161:aload           7
	//   74  163:invokevirtual   #113 <Method android.view.ViewParent View.getParent()>
	//   75  166:checkcast       #89  <Class View>
	//   76  169:astore          6
	...
	//*  79  173:aload           6
	//*  80  175:iconst_1        
	//*  81  176:invokevirtual   #186 <Method TransitionValues getTransitionValues(View, boolean)>
	//*  82  179:aload_0         
	//*  83  180:aload           6
	//*  84  182:iconst_1        
	//*  85  183:invokevirtual   #183 <Method TransitionValues getMatchedTransitionValues(View, boolean)>
	//*  86  186:invokespecial   #164 <Method Visibility$VisibilityInfo getVisibilityChangeInfo(TransitionValues, TransitionValues)>
	//*  87  189:getfield        #124 <Field boolean Visibility$VisibilityInfo.mVisibilityChange>
	//*  88  192:ifne            208
					{
	...
	//   90  196:aload           7
	//   91  198:aload           6
	//   92  200:invokestatic    #198 <Method View TransitionUtils.copyViewImage(ViewGroup, View, View)>
	//   93  203:astore          7
						break label3;
	//   94  205:goto            248
					}
	...
	//*  95  208:aload           6
	//*  96  210:invokevirtual   #113 <Method android.view.ViewParent View.getParent()>
	//*  97  213:ifnonnull       245
					{
						i = ((View) (overlay)).getId();
	//   98  216:aload           6
	//   99  218:invokevirtual   #201 <Method int View.getId()>
	//  100  221:istore_3        
	...
	//* 104  227:aload_1         
	//* 105  228:iload_3         
	//* 106  229:invokevirtual   #205 <Method View ViewGroup.findViewById(int)>
	//* 107  232:ifnull          245
	//* 108  235:aload_0         
	//* 109  236:getfield        #192 <Field boolean mCanRemoveViews>
	//* 110  239:ifeq            245
							break label3;
	//  111  242:goto            248
					}
	...
	//  125  270:aload_2         
	//  126  271:getfield        #97  <Field Map TransitionValues.values>
	//  127  274:ldc1            #27  <String "android:visibility:screenLocation">
	//  128  276:invokeinterface #135 <Method Object Map.get(Object)>
	//  129  281:checkcast       #206 <Class int[]>
	//  130  284:astore          6
			i = overlay[0];
	//  131  286:aload           6
	//  132  288:iconst_0        
	...
	//  142  302:aload_1         
	//  143  303:aload           6
	//  144  305:invokevirtual   #207 <Method void ViewGroup.getLocationOnScreen(int[])>
	...
	//  150  315:isub            
	//  151  316:aload           7
	//  152  318:invokevirtual   #210 <Method int View.getLeft()>
	//  153  321:isub            
	//  154  322:invokevirtual   #213 <Method void View.offsetLeftAndRight(int)>
	...
	//  160  333:isub            
	//  161  334:aload           7
	//  162  336:invokevirtual   #216 <Method int View.getTop()>
	//  163  339:isub            
	//  164  340:invokevirtual   #219 <Method void View.offsetTopAndBottom(int)>
			overlay = ((Object) (ViewGroupUtils.getOverlay(viewgroup)));
	//  165  343:aload_1         
	//  166  344:invokestatic    #225 <Method ViewGroupOverlayImpl ViewGroupUtils.getOverlay(ViewGroup)>
	//  167  347:astore          6
			((ViewGroupOverlayImpl) (overlay)).add(((View) (finalOverlayView)));
	//  168  349:aload           6
	//  169  351:aload           7
	//  170  353:invokeinterface #231 <Method void ViewGroupOverlayImpl.add(View)>
	...
	//  174  362:aload_2         
	//  175  363:aload           4
	//  176  365:invokevirtual   #233 <Method Animator onDisappear(ViewGroup, View, TransitionValues, TransitionValues)>
	//  177  368:astore_1        
			if(viewgroup == null)
	//* 178  369:aload_1         
	...
	//  180  373:aload           6
	//  181  375:aload           7
	//  182  377:invokeinterface #236 <Method void ViewGroupOverlayImpl.remove(View)>
	...
	//  189  390:aload           6
	//  190  392:aload           7
	//  191  394:invokespecial   #239 <Method void Visibility$1(Visibility, ViewGroupOverlayImpl, View)>
	//  192  397:invokevirtual   #245 <Method void Animator.addListener(android.animation.Animator$AnimatorListener)>
				return ((Animator) (viewgroup));
	//  193  400:aload_1         
	//  194  401:areturn         
			}
	...
	//  197  407:aload           6
	//  198  409:invokevirtual   #93  <Method int View.getVisibility()>
	//  199  412:istore_3        
			ViewUtils.setTransitionVisibility(((View) (overlay)), 0);
	//  200  413:aload           6
	//  201  415:iconst_0        
	//  202  416:invokestatic    #251 <Method void ViewUtils.setTransitionVisibility(View, int)>
	...
	//  206  423:aload_2         
	//  207  424:aload           4
	//  208  426:invokevirtual   #233 <Method Animator onDisappear(ViewGroup, View, TransitionValues, TransitionValues)>
	//  209  429:astore_1        
			if(viewgroup != null)
	//* 210  430:aload_1         
	//* 211  431:ifnull          465
	...
	//  215  440:iload           5
	//  216  442:iconst_1        
	//  217  443:invokespecial   #254 <Method void Visibility$DisappearListener(View, int, boolean)>
	//  218  446:astore_2        
				((Animator) (viewgroup)).addListener(((android.animation.Animator.AnimatorListener) (transitionvalues)));
	//  219  447:aload_1         
	//  220  448:aload_2         
	//  221  449:invokevirtual   #245 <Method void Animator.addListener(android.animation.Animator$AnimatorListener)>
				AnimatorUtils.addPauseListener(((Animator) (viewgroup)), ((AnimatorListenerAdapter) (transitionvalues)));
	//  222  452:aload_1         
	//  223  453:aload_2         
	//  224  454:invokestatic    #260 <Method void AnimatorUtils.addPauseListener(Animator, AnimatorListenerAdapter)>
				addListener(((Transition.TransitionListener) (transitionvalues)));
	//  225  457:aload_0         
	//  226  458:aload_2         
	//  227  459:invokevirtual   #263 <Method Transition addListener(Transition$TransitionListener)>
	//  228  462:pop             
				return ((Animator) (viewgroup));
	//  229  463:aload_1         
	//  230  464:areturn         
	...
	//  231  465:aload           6
	//  232  467:iload_3         
	//  233  468:invokestatic    #251 <Method void ViewUtils.setTransitionVisibility(View, int)>
				return ((Animator) (viewgroup));
	//  234  471:aload_1         
	//  235  472:areturn         
			}
	...
	//    4    7:aload_0         
	//    5    8:iload_1         
	//    6    9:putfield        #45  <Field int mMode>
			return;
	//    7   12:return          
		} else
		{
			throw new IllegalArgumentException("Only MODE_IN and MODE_OUT flags are allowed");
	//    8   13:new             #265 <Class IllegalArgumentException>
	//    9   16:dup             
	//   10   17:ldc2            #267 <String "Only MODE_IN and MODE_OUT flags are allowed">
	//   11   20:invokespecial   #270 <Method void IllegalArgumentException(String)>
	//   12   23:athrow          
		}
	}
