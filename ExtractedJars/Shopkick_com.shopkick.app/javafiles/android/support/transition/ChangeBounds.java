...
public class ChangeBounds extends Transition
{
	...
	//    8   14:aload_1         
	//    9   15:iconst_1        
	//   10   16:invokevirtual   #220 <Method TransitionValues getMatchedTransitionValues(View, boolean)>
	//   11   19:astore          5
	...
	//*  21   35:aload_2         
	//*  22   36:aload           5
	//*  23   38:getfield        #154 <Field View TransitionValues.view>
	//*  24   41:if_acmpne       46
				return true;
	//   25   44:iconst_1        
	//   26   45:ireturn         
...
label4:
	...
	//  428  851:aload_2         
	//  429  852:getfield        #173 <Field Map TransitionValues.values>
	//  430  855:ldc1            #48  <String "android:changeBounds:windowX">
	//  431  857:invokeinterface #233 <Method Object Map.get(Object)>
	//  432  862:checkcast       #206 <Class Integer>
	//  433  865:invokevirtual   #340 <Method int Integer.intValue()>
	//  434  868:istore          5
				int i1 = ((Integer)viewBounds.values.get("android:changeBounds:windowY")).intValue();
	//  435  870:aload_2         
	//  436  871:getfield        #173 <Field Map TransitionValues.values>
	//  437  874:ldc1            #51  <String "android:changeBounds:windowY">
	//  438  876:invokeinterface #233 <Method Object Map.get(Object)>
	//  439  881:checkcast       #206 <Class Integer>
	//  440  884:invokevirtual   #340 <Method int Integer.intValue()>
	//  441  887:istore          6
				int k1 = ((Integer)transitionvalues.values.get("android:changeBounds:windowX")).intValue();
	//  442  889:aload_3         
	//  443  890:getfield        #173 <Field Map TransitionValues.values>
	//  444  893:ldc1            #48  <String "android:changeBounds:windowX">
	//  445  895:invokeinterface #233 <Method Object Map.get(Object)>
	//  446  900:checkcast       #206 <Class Integer>
	//  447  903:invokevirtual   #340 <Method int Integer.intValue()>
	//  448  906:istore          7
				int l1 = ((Integer)transitionvalues.values.get("android:changeBounds:windowY")).intValue();
	//  449  908:aload_3         
	//  450  909:getfield        #173 <Field Map TransitionValues.values>
	//  451  912:ldc1            #51  <String "android:changeBounds:windowY">
	//  452  914:invokeinterface #233 <Method Object Map.get(Object)>
	//  453  919:checkcast       #206 <Class Integer>
	//  454  922:invokevirtual   #340 <Method int Integer.intValue()>
	//  455  925:istore          8
				if(j == k1 && i1 == l1)
	//* 456  927:iload           5
	//* 457  929:iload           7
	...
	//  465  946:aload_1         
	//  466  947:aload_0         
	//  467  948:getfield        #109 <Field int[] mTempLocation>
	//  468  951:invokevirtual   #341 <Method void ViewGroup.getLocationInWindow(int[])>
					viewBounds = ((TransitionValues) (Bitmap.createBitmap(view.getWidth(), view.getHeight(), android.graphics.Bitmap.Config.ARGB_8888)));
	//  469  954:aload           19
	//  470  956:invokevirtual   #166 <Method int View.getWidth()>
	//  471  959:aload           19
	//  472  961:invokevirtual   #169 <Method int View.getHeight()>
	//  473  964:getstatic       #347 <Field android.graphics.Bitmap$Config android.graphics.Bitmap$Config.ARGB_8888>
	//  474  967:invokestatic    #353 <Method Bitmap Bitmap.createBitmap(int, int, android.graphics.Bitmap$Config)>
	//  475  970:astore_2        
					view.draw(new Canvas(((Bitmap) (viewBounds))));
	//  476  971:aload           19
	//  477  973:new             #355 <Class Canvas>
	//  478  976:dup             
	//  479  977:aload_2         
	//  480  978:invokespecial   #358 <Method void Canvas(Bitmap)>
	//  481  981:invokevirtual   #362 <Method void View.draw(Canvas)>
					viewBounds = ((TransitionValues) (new BitmapDrawable(((Bitmap) (viewBounds)))));
	//  482  984:new             #364 <Class BitmapDrawable>
	//  483  987:dup             
	//  484  988:aload_2         
	//  485  989:invokespecial   #365 <Method void BitmapDrawable(Bitmap)>
	//  486  992:astore_2        
					final float transitionAlpha = ViewUtils.getTransitionAlpha(view);
	//  487  993:aload           19
	//  488  995:invokestatic    #369 <Method float ViewUtils.getTransitionAlpha(View)>
	//  489  998:fstore          4
					ViewUtils.setTransitionAlpha(view, 0.0F);
	//  490 1000:aload           19
	//  491 1002:fconst_0        
	//  492 1003:invokestatic    #373 <Method void ViewUtils.setTransitionAlpha(View, float)>
					ViewUtils.getOverlay(((View) (sceneRoot))).add(((Drawable) (viewBounds)));
	//  493 1006:aload_1         
	//  494 1007:invokestatic    #377 <Method ViewOverlayImpl ViewUtils.getOverlay(View)>
	//  495 1010:aload_2         
	//  496 1011:invokeinterface #383 <Method void ViewOverlayImpl.add(Drawable)>
					transitionvalues = ((TransitionValues) (getPathMotion()));
	//  497 1016:aload_0         
	//  498 1017:invokevirtual   #264 <Method PathMotion getPathMotion()>
	//  499 1020:astore_3        
					int ai[] = mTempLocation;
	//  500 1021:aload_0         
	//  501 1022:getfield        #109 <Field int[] mTempLocation>
	//  502 1025:astore          20
	...
	//  526 1058:isub            
	//  527 1059:i2f             
	//  528 1060:invokevirtual   #270 <Method android.graphics.Path PathMotion.getPath(float, float, float, float)>
	//  529 1063:astore_3        
	...
	//  533 1069:dup             
	//  534 1070:iconst_0        
	//  535 1071:getstatic       #78  <Field Property DRAWABLE_ORIGIN_PROPERTY>
	//  536 1074:aload_3         
	//  537 1075:invokestatic    #390 <Method PropertyValuesHolder PropertyValuesHolderUtils.ofPointF(Property, android.graphics.Path)>
	//  538 1078:aastore         
	//  539 1079:invokestatic    #394 <Method ObjectAnimator ObjectAnimator.ofPropertyValuesHolder(Object, PropertyValuesHolder[])>
	//  540 1082:astore_3        
	...
	//  547 1091:aload           19
	//  548 1093:fload           4
	//  549 1095:invokespecial   #397 <Method void ChangeBounds$10(ChangeBounds, ViewGroup, BitmapDrawable, View, float)>
	//  550 1098:invokevirtual   #319 <Method void ObjectAnimator.addListener(android.animation.Animator$AnimatorListener)>
