...
class TranslationAnimationCreator
{
	...
	//    3    6:aload_0         
	//    4    7:invokevirtual   #23  <Method float View.getTranslationY()>
	//    5   10:fstore          10
		int ai[] = (int[])transitionvalues.view.getTag(R.id.transition_position);
	//    6   12:aload_1         
	//    7   13:getfield        #29  <Field View TransitionValues.view>
	//    8   16:getstatic       #35  <Field int R$id.transition_position>
	//    9   19:invokevirtual   #39  <Method Object View.getTag(int)>
	//   10   22:checkcast       #41  <Class int[]>
	//   11   25:astore          13
		if(ai != null)
	//*  12   27:aload           13
	//*  13   29:ifnull          59
	...
	//   34   61:fload           9
	//   35   63:fsub            
	//   36   64:invokestatic    #47  <Method int Math.round(float)>
	//   37   67:istore          11
		int l = Math.round(f1 - f5);
	//   38   69:fload           5
	//   39   71:fload           10
	//   40   73:fsub            
	//   41   74:invokestatic    #47  <Method int Math.round(float)>
	//   42   77:istore          12
		view.setTranslationX(f);
	//   43   79:aload_0         
	//   44   80:fload           4
	//   45   82:invokevirtual   #51  <Method void View.setTranslationX(float)>
		view.setTranslationY(f1);
	//   46   85:aload_0         
	//   47   86:fload           5
	//   48   88:invokevirtual   #54  <Method void View.setTranslationY(float)>
		if(f == f2 && f1 == f3)
	//*  49   91:fload           4
	//*  50   93:fload           6
	//*  51   95:fcmpl           
	...
	//   62  114:dup             
	//   63  115:iconst_0        
	//   64  116:getstatic       #60  <Field android.util.Property View.TRANSLATION_X>
	//   65  119:iconst_2        
	...
	//   73  129:fload           6
	//   74  131:fastore         
	//   75  132:invokestatic    #64  <Method PropertyValuesHolder PropertyValuesHolder.ofFloat(android.util.Property, float[])>
	//   76  135:aastore         
	//   77  136:dup             
	//   78  137:iconst_1        
	//   79  138:getstatic       #67  <Field android.util.Property View.TRANSLATION_Y>
	//   80  141:iconst_2        
	...
	//   88  151:fload           7
	//   89  153:fastore         
	//   90  154:invokestatic    #64  <Method PropertyValuesHolder PropertyValuesHolder.ofFloat(android.util.Property, float[])>
	//   91  157:aastore         
	//   92  158:invokestatic    #73  <Method ObjectAnimator ObjectAnimator.ofPropertyValuesHolder(Object, PropertyValuesHolder[])>
	//   93  161:astore          13
	...
	//   96  167:aload_0         
	//   97  168:aload_1         
	//   98  169:getfield        #29  <Field View TransitionValues.view>
	//   99  172:iload_2         
	//  100  173:iload           11
	//  101  175:iadd            
	//  102  176:iload_3         
	...
	//  105  180:fload           9
	//  106  182:fload           10
	//  107  184:invokespecial   #76  <Method void TranslationAnimationCreator$TransitionPositionListener(View, View, int, int, float, float)>
	//  108  187:astore_0        
			objectanimator.addListener(((android.animation.Animator.AnimatorListener) (view)));
	//  109  188:aload           13
	//  110  190:aload_0         
	//  111  191:invokevirtual   #80  <Method void ObjectAnimator.addListener(android.animation.Animator$AnimatorListener)>
			AnimatorUtils.addPauseListener(((Animator) (objectanimator)), ((AnimatorListenerAdapter) (view)));
	//  112  194:aload           13
	//  113  196:aload_0         
	//  114  197:invokestatic    #86  <Method void AnimatorUtils.addPauseListener(Animator, AnimatorListenerAdapter)>
			objectanimator.setInterpolator(timeinterpolator);
	//  115  200:aload           13
	//  116  202:aload           8
	//  117  204:invokevirtual   #90  <Method void ObjectAnimator.setInterpolator(TimeInterpolator)>
