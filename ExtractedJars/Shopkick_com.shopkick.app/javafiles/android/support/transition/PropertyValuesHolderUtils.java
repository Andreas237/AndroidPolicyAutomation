...
class PropertyValuesHolderUtils
{
	...
	//    4    9:aconst_null     
	//    5   10:aload_1         
	//    6   11:invokestatic    #23  <Method PropertyValuesHolder PropertyValuesHolder.ofObject(Property, android.animation.TypeConverter, Path)>
	//    7   14:areturn         
		else
			return PropertyValuesHolder.ofFloat(((Property) (new PathProperty(property, path))), new float[] {
				0.0F, 1.0F
			});
	//    8   15:new             #25  <Class PathProperty>
	//    9   18:dup             
	//   10   19:aload_0         
	//   11   20:aload_1         
	//   12   21:invokespecial   #28  <Method void PathProperty(Property, Path)>
	//   13   24:iconst_2        
	...
	//   21   33:fconst_1        
	//   22   34:fastore         
	//   23   35:invokestatic    #32  <Method PropertyValuesHolder PropertyValuesHolder.ofFloat(Property, float[])>
	//   24   38:areturn         
	}
}
