...
abstract class HeaderBehavior extends ViewOffsetBehavior
{
	...
	//    2    4:aload_0         
	//    3    5:iconst_m1       
	//    4    6:putfield        #28  <Field int activePointerId>
		touchSlop = -1;
	//    5    9:aload_0         
	//    6   10:iconst_m1       
	//    7   11:putfield        #30  <Field int touchSlop>
	//    8   14:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iconst_m1       
	//    6    8:putfield        #28  <Field int activePointerId>
		touchSlop = -1;
	//    7   11:aload_0         
	//    8   12:iconst_m1       
	//    9   13:putfield        #30  <Field int touchSlop>
	//   10   16:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #37  <Field VelocityTracker velocityTracker>
	//*   2    4:ifnonnull       14
			velocityTracker = VelocityTracker.obtain();
	//    3    7:aload_0         
	//    4    8:invokestatic    #43  <Method VelocityTracker VelocityTracker.obtain()>
	//    5   11:putfield        #37  <Field VelocityTracker velocityTracker>
	//    6   14:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #51  <Field Runnable flingRunnable>
	//    2    4:astore          6
		if(runnable != null)
	//*   3    6:aload           6
	//*   4    8:ifnull          23
	...
	//    5   11:aload_2         
	//    6   12:aload           6
	//    7   14:invokevirtual   #57  <Method boolean View.removeCallbacks(Runnable)>
	//    8   17:pop             
			flingRunnable = null;
	//    9   18:aload_0         
	//   10   19:aconst_null     
	//   11   20:putfield        #51  <Field Runnable flingRunnable>
		}
		if(scroller == null)
	//*  12   23:aload_0         
	//*  13   24:getfield        #59  <Field OverScroller scroller>
	//*  14   27:ifnonnull       45
			scroller = new OverScroller(view.getContext());
	//   15   30:aload_0         
	//   16   31:new             #61  <Class OverScroller>
	//   17   34:dup             
	//   18   35:aload_2         
	//   19   36:invokevirtual   #65  <Method Context View.getContext()>
	//   20   39:invokespecial   #68  <Method void OverScroller(Context)>
	//   21   42:putfield        #59  <Field OverScroller scroller>
		scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f), 0, 0, i, j);
	//   22   45:aload_0         
	//   23   46:getfield        #59  <Field OverScroller scroller>
	//   24   49:iconst_0        
	//   25   50:aload_0         
	//   26   51:invokevirtual   #72  <Method int getTopAndBottomOffset()>
	//   27   54:iconst_0        
	//   28   55:fload           5
	//   29   57:invokestatic    #78  <Method int Math.round(float)>
	//   30   60:iconst_0        
	//   31   61:iconst_0        
	//   32   62:iload_3         
	//   33   63:iload           4
	//   34   65:invokevirtual   #81  <Method void OverScroller.fling(int, int, int, int, int, int, int, int)>
		if(scroller.computeScrollOffset())
	//*  35   68:aload_0         
	//*  36   69:getfield        #59  <Field OverScroller scroller>
	//*  37   72:invokevirtual   #85  <Method boolean OverScroller.computeScrollOffset()>
	//*  38   75:ifeq            102
		{
	...
	//   43   84:aload_1         
	//   44   85:aload_2         
	//   45   86:invokespecial   #88  <Method void HeaderBehavior$FlingRunnable(HeaderBehavior, CoordinatorLayout, View)>
	//   46   89:putfield        #51  <Field Runnable flingRunnable>
			ViewCompat.postOnAnimation(view, flingRunnable);
	//   47   92:aload_2         
	//   48   93:aload_0         
	//   49   94:getfield        #51  <Field Runnable flingRunnable>
	//   50   97:invokestatic    #94  <Method void ViewCompat.postOnAnimation(View, Runnable)>
			return true;
	//   51  100:iconst_1        
	//   52  101:ireturn         
		} else
	...
	//   54  103:aload_1         
	//   55  104:aload_2         
	//   56  105:invokevirtual   #98  <Method void onFlingFinished(CoordinatorLayout, View)>
			return false;
	//   57  108:iconst_0        
	//   58  109:ireturn         
		}
	...
	public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorlayout, View view, MotionEvent motionevent)
	{
		if(touchSlop < 0)
	//*   0    0:aload_0         
	//*   1    1:getfield        #30  <Field int touchSlop>
	//*   2    4:ifge            21
	...
	//    8   18:putfield        #30  <Field int touchSlop>
	...
	//*  12   26:icmpne          38
	//*  13   29:aload_0         
	//*  14   30:getfield        #129 <Field boolean isBeingDragged>
	//*  15   33:ifeq            38
			return true;
	//   16   36:iconst_1        
	//   17   37:ireturn         
	...
	//   22   75:aload_0         
	//   23   76:getfield        #28  <Field int activePointerId>
	//   24   79:istore          4
			if(i != -1)
	//*  25   81:iload           4
	//*  26   83:iconst_m1       
	...
	//*  42  116:iload           4
	//*  43  118:aload_0         
	//*  44  119:getfield        #142 <Field int lastMotionY>
	//*  45  122:isub            
	//*  46  123:invokestatic    #145 <Method int Math.abs(int)>
	//*  47  126:aload_0         
	//*  48  127:getfield        #30  <Field int touchSlop>
	//*  49  130:icmple          236
					{
						isBeingDragged = true;
	//   50  133:aload_0         
	//   51  134:iconst_1        
	//   52  135:putfield        #129 <Field boolean isBeingDragged>
						lastMotionY = i;
	//   53  138:aload_0         
	//   54  139:iload           4
	//   55  141:putfield        #142 <Field int lastMotionY>
					}
				}
			}
			break;
	...
	//   57  147:aload_0         
	//   58  148:iconst_0        
	//   59  149:putfield        #129 <Field boolean isBeingDragged>
			activePointerId = -1;
	//   60  152:aload_0         
	//   61  153:iconst_m1       
	//   62  154:putfield        #28  <Field int activePointerId>
			coordinatorlayout = ((CoordinatorLayout) (velocityTracker));
	//   63  157:aload_0         
	//   64  158:getfield        #37  <Field VelocityTracker velocityTracker>
	//   65  161:astore_1        
	...
	//   68  166:aload_1         
	//   69  167:invokevirtual   #148 <Method void VelocityTracker.recycle()>
				velocityTracker = null;
	//   70  170:aload_0         
	//   71  171:aconst_null     
	//   72  172:putfield        #37  <Field VelocityTracker velocityTracker>
			}
			break;
	//   73  175:goto            236
	...
	//   74  178:aload_0         
	//   75  179:iconst_0        
	//   76  180:putfield        #129 <Field boolean isBeingDragged>
			int j = (int)motionevent.getX();
	//   77  183:aload_3         
	//   78  184:invokevirtual   #152 <Method float MotionEvent.getX()>
	//   79  187:f2i             
	//   80  188:istore          4
			int k = (int)motionevent.getY();
	//   81  190:aload_3         
	//   82  191:invokevirtual   #154 <Method float MotionEvent.getY()>
	//   83  194:f2i             
	//   84  195:istore          5
			if(canDragView(view) && coordinatorlayout.isPointInChildBounds(view, j, k))
	//*  85  197:aload_0         
	//*  86  198:aload_2         
	//*  87  199:invokevirtual   #156 <Method boolean canDragView(View)>
	//*  88  202:ifeq            236
	//*  89  205:aload_1         
	//*  90  206:aload_2         
	//*  91  207:iload           4
	//*  92  209:iload           5
	//*  93  211:invokevirtual   #160 <Method boolean CoordinatorLayout.isPointInChildBounds(View, int, int)>
	//*  94  214:ifeq            236
			{
				lastMotionY = k;
	//   95  217:aload_0         
	//   96  218:iload           5
	//   97  220:putfield        #142 <Field int lastMotionY>
				activePointerId = motionevent.getPointerId(0);
	//   98  223:aload_0         
	//   99  224:aload_3         
	//  100  225:iconst_0        
	//  101  226:invokevirtual   #163 <Method int MotionEvent.getPointerId(int)>
	//  102  229:putfield        #28  <Field int activePointerId>
				ensureVelocityTracker();
	//  103  232:aload_0         
	//  104  233:invokespecial   #165 <Method void ensureVelocityTracker()>
			}
			break;
		}
		coordinatorlayout = ((CoordinatorLayout) (velocityTracker));
	//  105  236:aload_0         
	//  106  237:getfield        #37  <Field VelocityTracker velocityTracker>
	//  107  240:astore_1        
		if(coordinatorlayout != null)
	//* 108  241:aload_1         
	//* 109  242:ifnull          250
	...
	//  110  245:aload_1         
	//  111  246:aload_3         
	//  112  247:invokevirtual   #169 <Method void VelocityTracker.addMovement(MotionEvent)>
		return isBeingDragged;
	//  113  250:aload_0         
	//  114  251:getfield        #129 <Field boolean isBeingDragged>
	//  115  254:ireturn         
	}
	...
	//   13   59:aload_3         
	//   14   60:aload_0         
	//   15   61:getfield        #28  <Field int activePointerId>
	...
	//   27   84:istore          6
			i = lastMotionY - k;
	//   28   86:aload_0         
	//   29   87:getfield        #142 <Field int lastMotionY>
	//   30   90:iload           6
	//   31   92:isub            
	//   32   93:istore          5
			if(!isBeingDragged)
	//*  33   95:aload_0         
	//*  34   96:getfield        #129 <Field boolean isBeingDragged>
	//*  35   99:ifne            152
			{
				int i1 = Math.abs(i);
	//   36  102:iload           5
	//   37  104:invokestatic    #145 <Method int Math.abs(int)>
	//   38  107:istore          7
				int j1 = touchSlop;
	//   39  109:aload_0         
	//   40  110:getfield        #30  <Field int touchSlop>
	//   41  113:istore          8
				if(i1 > j1)
	//*  42  115:iload           7
	//*  43  117:iload           8
	...
	//   45  122:aload_0         
	//   46  123:iconst_1        
	//   47  124:putfield        #129 <Field boolean isBeingDragged>
					if(i > 0)
	//*  48  127:iload           5
	//*  49  129:ifle            142
						i -= j1;
	...
	//*  59  149:goto            152
			if(isBeingDragged)
	//*  60  152:aload_0         
	//*  61  153:getfield        #129 <Field boolean isBeingDragged>
	//*  62  156:ifeq            328
			{
				lastMotionY = k;
	//   63  159:aload_0         
	//   64  160:iload           6
	//   65  162:putfield        #142 <Field int lastMotionY>
	...
	//   70  170:aload_0         
	//   71  171:aload_2         
	//   72  172:invokevirtual   #173 <Method int getMaxDragOffset(View)>
	//   73  175:iconst_0        
	//   74  176:invokevirtual   #177 <Method int scroll(CoordinatorLayout, View, int, int, int)>
	//   75  179:pop             
			}
			break;
	//   76  180:goto            328
	...
	//   77  183:aload_0         
	//   78  184:getfield        #37  <Field VelocityTracker velocityTracker>
	//   79  187:astore          9
			if(velocitytracker != null)
	//*  80  189:aload           9
	//*  81  191:ifnull          239
	...
	//   82  194:aload           9
	//   83  196:aload_3         
	//   84  197:invokevirtual   #169 <Method void VelocityTracker.addMovement(MotionEvent)>
				velocityTracker.computeCurrentVelocity(1000);
	//   85  200:aload_0         
	//   86  201:getfield        #37  <Field VelocityTracker velocityTracker>
	//   87  204:sipush          1000
	//   88  207:invokevirtual   #181 <Method void VelocityTracker.computeCurrentVelocity(int)>
				float f = velocityTracker.getYVelocity(activePointerId);
	//   89  210:aload_0         
	//   90  211:getfield        #37  <Field VelocityTracker velocityTracker>
	//   91  214:aload_0         
	//   92  215:getfield        #28  <Field int activePointerId>
	//   93  218:invokevirtual   #184 <Method float VelocityTracker.getYVelocity(int)>
	//   94  221:fstore          4
	...
	//   98  226:aload_0         
	//   99  227:aload_2         
	//  100  228:invokevirtual   #186 <Method int getScrollRangeForDragFling(View)>
	//  101  231:ineg            
	//  102  232:iconst_0        
	//  103  233:fload           4
	//  104  235:invokevirtual   #188 <Method boolean fling(CoordinatorLayout, View, int, int, float)>
	//  105  238:pop             
			}
			// fall through
	...
	//  106  239:aload_0         
	//  107  240:iconst_0        
	//  108  241:putfield        #129 <Field boolean isBeingDragged>
			activePointerId = -1;
	//  109  244:aload_0         
	//  110  245:iconst_m1       
	//  111  246:putfield        #28  <Field int activePointerId>
			coordinatorlayout = ((CoordinatorLayout) (velocityTracker));
	//  112  249:aload_0         
	//  113  250:getfield        #37  <Field VelocityTracker velocityTracker>
	//  114  253:astore_1        
			if(coordinatorlayout != null)
	//* 115  254:aload_1         
	//* 116  255:ifnull          328
			{
				((VelocityTracker) (coordinatorlayout)).recycle();
	//  117  258:aload_1         
	//  118  259:invokevirtual   #148 <Method void VelocityTracker.recycle()>
				velocityTracker = null;
	//  119  262:aload_0         
	//  120  263:aconst_null     
	//  121  264:putfield        #37  <Field VelocityTracker velocityTracker>
			}
			break;
	//  122  267:goto            328
		...
		case 0: // '\0'
			int j = (int)motionevent.getX();
	//  123  270:aload_3         
	//  124  271:invokevirtual   #152 <Method float MotionEvent.getX()>
	//  125  274:f2i             
	//  126  275:istore          5
			int l = (int)motionevent.getY();
	//  127  277:aload_3         
	//  128  278:invokevirtual   #154 <Method float MotionEvent.getY()>
	//  129  281:f2i             
	//  130  282:istore          6
	...
	//* 133  286:iload           5
	//* 134  288:iload           6
	//* 135  290:invokevirtual   #160 <Method boolean CoordinatorLayout.isPointInChildBounds(View, int, int)>
	//* 136  293:ifeq            326
	//* 137  296:aload_0         
	//* 138  297:aload_2         
	//* 139  298:invokevirtual   #156 <Method boolean canDragView(View)>
	//* 140  301:ifeq            326
			{
				lastMotionY = l;
	//  141  304:aload_0         
	//  142  305:iload           6
	//  143  307:putfield        #142 <Field int lastMotionY>
				activePointerId = motionevent.getPointerId(0);
	//  144  310:aload_0         
	//  145  311:aload_3         
	//  146  312:iconst_0        
	//  147  313:invokevirtual   #163 <Method int MotionEvent.getPointerId(int)>
	//  148  316:putfield        #28  <Field int activePointerId>
				ensureVelocityTracker();
	//  149  319:aload_0         
	//  150  320:invokespecial   #165 <Method void ensureVelocityTracker()>
			} else
	//* 151  323:goto            328
			{
				return false;
	...
	//  153  327:ireturn         
		...
		coordinatorlayout = ((CoordinatorLayout) (velocityTracker));
	//  154  328:aload_0         
	//  155  329:getfield        #37  <Field VelocityTracker velocityTracker>
	//  156  332:astore_1        
		if(coordinatorlayout != null)
	//* 157  333:aload_1         
	//* 158  334:ifnull          342
	...
	//  159  337:aload_1         
	//  160  338:aload_3         
	//  161  339:invokevirtual   #169 <Method void VelocityTracker.addMovement(MotionEvent)>
		return true;
	//  162  342:iconst_1        
	//  163  343:ireturn         
	}
