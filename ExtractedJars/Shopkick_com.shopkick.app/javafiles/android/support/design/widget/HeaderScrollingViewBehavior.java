...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior
{
	...
	//    6   12:putfield        #20  <Field Rect tempRect1>
		tempRect2 = new Rect();
	//    7   15:aload_0         
	//    8   16:new             #17  <Class Rect>
	//    9   19:dup             
	//   10   20:invokespecial   #18  <Method void Rect()>
	//   11   23:putfield        #22  <Field Rect tempRect2>
		verticalLayoutGap = 0;
	//   12   26:aload_0         
	//   13   27:iconst_0        
	//   14   28:putfield        #24  <Field int verticalLayoutGap>
	//   15   31:return          
	}
	...
	//    8   14:putfield        #20  <Field Rect tempRect1>
		tempRect2 = new Rect();
	//    9   17:aload_0         
	//   10   18:new             #17  <Class Rect>
	//   11   21:dup             
	//   12   22:invokespecial   #18  <Method void Rect()>
	//   13   25:putfield        #22  <Field Rect tempRect2>
		verticalLayoutGap = 0;
	//   14   28:aload_0         
	//   15   29:iconst_0        
	//   16   30:putfield        #24  <Field int verticalLayoutGap>
	//   17   33:return          
	}
	...
	final int getOverlapPixelsForOffset(View view)
	{
		if(overlayTop == 0)
	//*   0    0:aload_0         
	//*   1    1:getfield        #37  <Field int overlayTop>
	//*   2    4:ifne            9
		{
			return 0;
	//    3    7:iconst_0        
	//    4    8:ireturn         
		...
		{
			float f = getOverlapRatioForOffset(view);
	//    5    9:aload_0         
	//    6   10:aload_1         
	...
	//    8   14:fstore_2        
			int i = overlayTop;
	//    9   15:aload_0         
	//   10   16:getfield        #37  <Field int overlayTop>
	//   11   19:istore_3        
	...
	//   17   25:iconst_0        
	//   18   26:iload_3         
	//   19   27:invokestatic    #47  <Method int MathUtils.clamp(int, int, int)>
	//   20   30:ireturn         
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #24  <Field int verticalLayoutGap>
	//    2    4:ireturn         
	}
	...
	//   11   23:astore          5
			Rect rect = tempRect1;
	//   12   25:aload_0         
	//   13   26:getfield        #20  <Field Rect tempRect1>
	//   14   29:astore          6
	...
	//   70  147:putfield        #127 <Field int Rect.right>
			...
			coordinatorlayout = ((CoordinatorLayout) (tempRect2));
	//   71  150:aload_0         
	//   72  151:getfield        #22  <Field Rect tempRect2>
	//   73  154:astore_1        
	...
	//  108  219:isub            
	//  109  220:putfield        #24  <Field int verticalLayoutGap>
			return;
	//  110  223:return          
		} else
		{
	...
	//  116  231:aload_0         
	//  117  232:iconst_0        
	//  118  233:putfield        #24  <Field int verticalLayoutGap>
			return;
	//  119  236:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #37  <Field int overlayTop>
	//    3    5:return          
	}
