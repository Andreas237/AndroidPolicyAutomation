	...
	implements CircularRevealWidget
{
	...
	//    1    1:aload_1         
	//    2    2:aconst_null     
	//    3    3:invokespecial   #13  <Method void CircularRevealCoordinatorLayout(Context, AttributeSet)>
	//    4    6:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_2         
	//    3    3:invokespecial   #15  <Method void CoordinatorLayout(Context, AttributeSet)>
		helper = new CircularRevealHelper(((android.support.design.circularreveal.CircularRevealHelper.Delegate) (this)));
	//    4    6:aload_0         
	//    5    7:new             #17  <Class CircularRevealHelper>
	//    6   10:dup             
	//    7   11:aload_0         
	//    8   12:invokespecial   #20  <Method void CircularRevealHelper(android.support.design.circularreveal.CircularRevealHelper$Delegate)>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #27  <Method void CoordinatorLayout.draw(Canvas)>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #32  <Method boolean CoordinatorLayout.isOpaque()>
	//    2    4:ireturn         
	}
	...
	//    9   15:aload_0         
	//   10   16:aload_1         
	//   11   17:invokespecial   #27  <Method void CoordinatorLayout.draw(Canvas)>
			return;
	//   12   20:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #22  <Field CircularRevealHelper helper>
	//    2    4:invokevirtual   #54  <Method android.support.design.circularreveal.CircularRevealWidget$RevealInfo CircularRevealHelper.getRevealInfo()>
	//    3    7:areturn         
	}
	...
	//    7   13:ireturn         
			...
			return super.isOpaque();
	//    8   14:aload_0         
	//    9   15:invokespecial   #32  <Method boolean CoordinatorLayout.isOpaque()>
	//   10   18:ireturn         
	}
	...
	//    1    1:getfield        #22  <Field CircularRevealHelper helper>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #69  <Method void CircularRevealHelper.setRevealInfo(android.support.design.circularreveal.CircularRevealWidget$RevealInfo)>
	//    4    8:return          
	}
