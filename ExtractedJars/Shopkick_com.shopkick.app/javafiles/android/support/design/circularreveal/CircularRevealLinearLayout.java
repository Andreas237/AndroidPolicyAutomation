...
public class CircularRevealLinearLayout extends LinearLayout
	implements CircularRevealWidget
{
	...
	//    1    1:aload_1         
	//    2    2:aconst_null     
	//    3    3:invokespecial   #13  <Method void CircularRevealLinearLayout(Context, AttributeSet)>
	//    4    6:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #27  <Method void LinearLayout.draw(Canvas)>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #32  <Method boolean LinearLayout.isOpaque()>
	//    2    4:ireturn         
	}
	...
	//    9   15:aload_0         
	//   10   16:aload_1         
	//   11   17:invokespecial   #27  <Method void LinearLayout.draw(Canvas)>
			return;
	//   12   20:return          
		}
	}
	...
	//    7   13:ireturn         
			...
			return super.isOpaque();
	//    8   14:aload_0         
	//    9   15:invokespecial   #32  <Method boolean LinearLayout.isOpaque()>
	//   10   18:ireturn         
	}
