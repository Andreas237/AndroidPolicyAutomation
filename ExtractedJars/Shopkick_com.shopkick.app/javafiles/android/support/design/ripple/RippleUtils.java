...
public class RippleUtils
{
	...
	//    6   15:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//    7   18:istore_1        
			int ai2[] = StateSet.NOTHING;
	//    8   19:getstatic       #69  <Field int[] StateSet.NOTHING>
	//    9   22:astore          10
			int k = getColorForState(colorstatelist, PRESSED_STATE_SET);
	//   10   24:aload_0         
	//   11   25:getstatic       #33  <Field int[] PRESSED_STATE_SET>
	//   12   28:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   13   31:istore_2        
	...
	//   14   32:new             #71  <Class ColorStateList>
	//   15   35:dup             
	//   16   36:iconst_2        
	//   17   37:anewarray       int[][]
	//   18   40:dup             
	...
	//   34   59:iload_2         
	//   35   60:iastore         
	//   36   61:invokespecial   #75  <Method void ColorStateList(int[][], int[])>
	//   37   64:areturn         
		} else
		{
	...
	//   40   70:aload_0         
	//   41   71:aload           9
	//   42   73:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   43   76:istore_1        
	...
	//   46   82:aload_0         
	//   47   83:aload           10
	//   48   85:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   49   88:istore_2        
	...
	//   52   94:aload_0         
	//   53   95:aload           11
	//   54   97:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   55  100:istore_3        
	...
	//   58  106:aload_0         
	//   59  107:aload           12
	//   60  109:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   61  112:istore          4
	...
	//   66  124:aload_0         
	//   67  125:aload           14
	//   68  127:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   69  130:istore          5
	...
	//   72  137:aload_0         
	//   73  138:aload           15
	//   74  140:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   75  143:istore          6
	...
	//   78  150:aload_0         
	//   79  151:aload           16
	//   80  153:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   81  156:istore          7
	...
	//   84  163:aload_0         
	//   85  164:aload           17
	//   86  166:invokestatic    #64  <Method int getColorForState(ColorStateList, int[])>
	//   87  169:istore          8
			return new ColorStateList(new int[][] {
	...
	//   88  171:new             #71  <Class ColorStateList>
	//   89  174:dup             
	//   90  175:bipush          10
	...
	//  128  228:dup             
	//  129  229:bipush          9
	//  130  231:getstatic       #69  <Field int[] StateSet.NOTHING>
	//  131  234:aastore         
	//  132  235:bipush          10
	...
	//  172  286:iconst_0        
	//  173  287:iastore         
	//  174  288:invokespecial   #75  <Method void ColorStateList(int[][], int[])>
	//  175  291:areturn         
		}
	}
	...
	//    0    0:iload_0         
	//    1    1:iload_0         
	//    2    2:invokestatic    #87  <Method int Color.alpha(int)>
	//    3    5:iconst_2        
	//    4    6:imul            
	//    5    7:sipush          255
	//    6   10:invokestatic    #93  <Method int Math.min(int, int)>
	//    7   13:invokestatic    #98  <Method int ColorUtils.setAlphaComponent(int, int)>
	//    8   16:ireturn         
	}
	...
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:invokevirtual   #102 <Method int ColorStateList.getDefaultColor()>
	//    6   10:invokevirtual   #105 <Method int ColorStateList.getColorForState(int[], int)>
	//    7   13:istore_2        
		else
	//*   8   14:goto            19
			i = 0;
	...
	//*  14   24:ifeq            32
			j = doubleAlpha(i);
	//   15   27:iload_2         
	//   16   28:invokestatic    #107 <Method int doubleAlpha(int)>
	//   17   31:istore_3        
		return j;
	//   18   32:iload_3         
	//   19   33:ireturn         
