	...
	implements android.support.v7.view.menu.MenuView.ItemView
{
	...
	//   10   16:putfield        #52  <Field AccessibilityDelegateCompat accessibilityDelegate>
		setOrientation(0);
	//   11   19:aload_0         
	//   12   20:iconst_0        
	...
	//   26   48:putfield        #90  <Field int iconSize>
	...
	//   32   62:putfield        #103 <Field CheckedTextView textView>
		textView.setDuplicateParentStateEnabled(true);
	//   33   65:aload_0         
	//   34   66:getfield        #103 <Field CheckedTextView textView>
	//   35   69:iconst_1        
	...
	//   37   73:aload_0         
	//   38   74:getfield        #103 <Field CheckedTextView textView>
	//   39   77:aload_0         
	//   40   78:getfield        #52  <Field AccessibilityDelegateCompat accessibilityDelegate>
	...
	//   12   25:aload_1         
	//   13   26:invokevirtual   #129 <Method android.view.ViewGroup$LayoutParams FrameLayout.getLayoutParams()>
	//   14   29:checkcast       #131 <Class android.support.v7.widget.LinearLayoutCompat$LayoutParams>
	//   15   32:astore_1        
				obj.width = -1;
	//   16   33:aload_1         
	//   17   34:iconst_m1       
	//   18   35:putfield        #134 <Field int android.support.v7.widget.LinearLayoutCompat$LayoutParams.width>
				actionArea.setLayoutParams(((android.view.ViewGroup.LayoutParams) (obj)));
	//   19   38:aload_0         
	//   20   39:getfield        #123 <Field FrameLayout actionArea>
	//   21   42:aload_1         
	//   22   43:invokevirtual   #138 <Method void FrameLayout.setLayoutParams(android.view.ViewGroup$LayoutParams)>
				return;
	//   23   46:return          
			}
		} else
	...
	//   24   47:aload_0         
	//   25   48:getfield        #103 <Field CheckedTextView textView>
	//   26   51:iconst_0        
	//   27   52:invokevirtual   #121 <Method void CheckedTextView.setVisibility(int)>
			Object obj1 = ((Object) (actionArea));
	//   28   55:aload_0         
	//   29   56:getfield        #123 <Field FrameLayout actionArea>
	//   30   59:astore_1        
			if(obj1 != null)
	//*  31   60:aload_1         
	//*  32   61:ifnull          86
	...
	//   33   64:aload_1         
	//   34   65:invokevirtual   #129 <Method android.view.ViewGroup$LayoutParams FrameLayout.getLayoutParams()>
	//   35   68:checkcast       #131 <Class android.support.v7.widget.LinearLayoutCompat$LayoutParams>
	//   36   71:astore_1        
				obj1.width = -2;
	//   37   72:aload_1         
	//   38   73:bipush          -2
	//   39   75:putfield        #134 <Field int android.support.v7.widget.LinearLayoutCompat$LayoutParams.width>
				actionArea.setLayoutParams(((android.view.ViewGroup.LayoutParams) (obj1)));
	//   40   78:aload_0         
	//   41   79:getfield        #123 <Field FrameLayout actionArea>
	//   42   82:aload_1         
	//   43   83:invokevirtual   #138 <Method void FrameLayout.setLayoutParams(android.view.ViewGroup$LayoutParams)>
			}
		}
	//   44   86:return          
	}
	...
	//*   1    1:ifnull          46
		{
			if(actionArea == null)
	//*   2    4:aload_0         
	//*   3    5:getfield        #123 <Field FrameLayout actionArea>
	//*   4    8:ifnonnull       31
	...
	//   12   28:putfield        #123 <Field FrameLayout actionArea>
			actionArea.removeAllViews();
	//   13   31:aload_0         
	//   14   32:getfield        #123 <Field FrameLayout actionArea>
	//   15   35:invokevirtual   #193 <Method void FrameLayout.removeAllViews()>
			actionArea.addView(view);
	//   16   38:aload_0         
	//   17   39:getfield        #123 <Field FrameLayout actionArea>
	//   18   42:aload_1         
	...
	//    0    0:aload_0         
	//    1    1:getfield        #198 <Field MenuItemImpl itemData>
	//    2    4:invokevirtual   #204 <Method CharSequence MenuItemImpl.getTitle()>
	//    3    7:ifnonnull       32
	//    4   10:aload_0         
	//    5   11:getfield        #198 <Field MenuItemImpl itemData>
	//    6   14:invokevirtual   #208 <Method Drawable MenuItemImpl.getIcon()>
	//    7   17:ifnonnull       32
	//    8   20:aload_0         
	//    9   21:getfield        #198 <Field MenuItemImpl itemData>
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #198 <Field MenuItemImpl itemData>
	...
	//    6    8:aload_0         
	//    7    9:getfield        #198 <Field MenuItemImpl itemData>
	//    8   12:astore_3        
		if(menuitemimpl != null && menuitemimpl.isCheckable() && itemData.isChecked())
	//*   9   13:aload_3         
	//*  10   14:ifnull          42
	//*  11   17:aload_3         
	//*  12   18:invokevirtual   #231 <Method boolean MenuItemImpl.isCheckable()>
	//*  13   21:ifeq            42
	//*  14   24:aload_0         
	//*  15   25:getfield        #198 <Field MenuItemImpl itemData>
	//*  16   28:invokevirtual   #237 <Method boolean MenuItemImpl.isChecked()>
	//*  17   31:ifeq            42
			mergeDrawableStates(ai, CHECKED_STATE_SET);
	//   18   34:aload_2         
	//   19   35:getstatic       #37  <Field int[] CHECKED_STATE_SET>
	//   20   38:invokestatic    #281 <Method int[] mergeDrawableStates(int[], int[])>
	//   21   41:pop             
		return ai;
	//   22   42:aload_2         
	//   23   43:areturn         
	...
	//    0    0:aload_0         
	//    1    1:getfield        #123 <Field FrameLayout actionArea>
	//    2    4:astore_1        
		if(framelayout != null)
	//*   3    5:aload_1         
	//*   4    6:ifnull          13
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #193 <Method void FrameLayout.removeAllViews()>
		textView.setCompoundDrawables(((Drawable) (null)), ((Drawable) (null)), ((Drawable) (null)), ((Drawable) (null)));
	//    7   13:aload_0         
	//    8   14:getfield        #103 <Field CheckedTextView textView>
	//    9   17:aconst_null     
	//   10   18:aconst_null     
	//   11   19:aconst_null     
	//   12   20:aconst_null     
	//   13   21:invokevirtual   #287 <Method void CheckedTextView.setCompoundDrawables(Drawable, Drawable, Drawable, Drawable)>
	//   14   24:return          
	}
	...
	//    1    1:invokevirtual   #290 <Method void refreshDrawableState()>
		if(checkable != flag)
	//*   2    4:aload_0         
	//*   3    5:getfield        #292 <Field boolean checkable>
	//*   4    8:iload_1         
	//*   5    9:icmpeq          31
		{
			checkable = flag;
	//    6   12:aload_0         
	//    7   13:iload_1         
	//    8   14:putfield        #292 <Field boolean checkable>
			accessibilityDelegate.sendAccessibilityEvent(((View) (textView)), 2048);
	//    9   17:aload_0         
	//   10   18:getfield        #52  <Field AccessibilityDelegateCompat accessibilityDelegate>
	//   11   21:aload_0         
	//   12   22:getfield        #103 <Field CheckedTextView textView>
	//   13   25:sipush          2048
	...
	//    2    4:aload_0         
	//    3    5:getfield        #103 <Field CheckedTextView textView>
	//    4    8:iload_1         
	...
	//    3    3:iload_1         
	//    4    4:iconst_0        
	//    5    5:invokevirtual   #304 <Method void setPadding(int, int, int, int)>
	//    6    8:return          
	}
	...
	//    3    5:astore_3        
			if(hasIconTintList)
	//*   4    6:aload_0         
	//*   5    7:getfield        #306 <Field boolean hasIconTintList>
	//*   6   10:ifeq            46
			{
				obj = ((Object) (drawable.getConstantState()));
	//    7   13:aload_1         
	//    8   14:invokevirtual   #312 <Method android.graphics.drawable.Drawable$ConstantState Drawable.getConstantState()>
	//    9   17:astore_3        
				if(obj != null)
	//*  10   18:aload_3         
	//*  11   19:ifnonnull       25
	...
	//   13   25:aload_3         
	//   14   26:invokevirtual   #317 <Method Drawable android.graphics.drawable.Drawable$ConstantState.newDrawable()>
	//   15   29:astore_1        
				obj = ((Object) (DrawableCompat.wrap(drawable).mutate()));
	//   16   30:aload_1         
	//   17   31:invokestatic    #323 <Method Drawable DrawableCompat.wrap(Drawable)>
	//   18   34:invokevirtual   #326 <Method Drawable Drawable.mutate()>
	//   19   37:astore_3        
				DrawableCompat.setTintList(((Drawable) (obj)), iconTintList);
	//   20   38:aload_3         
	//   21   39:aload_0         
	//   22   40:getfield        #328 <Field ColorStateList iconTintList>
	//   23   43:invokestatic    #332 <Method void DrawableCompat.setTintList(Drawable, ColorStateList)>
			}
			int i = iconSize;
	//   24   46:aload_0         
	//   25   47:getfield        #90  <Field int iconSize>
	//   26   50:istore_2        
	...
	//   30   54:iload_2         
	//   31   55:iload_2         
	//   32   56:invokevirtual   #335 <Method void Drawable.setBounds(int, int, int, int)>
	...
	//*  35   61:goto            126
		if(needsEmptyIcon)
	//*  36   64:aload_0         
	//*  37   65:getfield        #337 <Field boolean needsEmptyIcon>
	//*  38   68:ifeq            126
		{
			if(emptyDrawable == null)
	//*  39   71:aload_0         
	//*  40   72:getfield        #339 <Field Drawable emptyDrawable>
	//*  41   75:ifnonnull       121
			{
	...
	//   42   78:aload_0         
	//   43   79:aload_0         
	//   44   80:invokevirtual   #340 <Method Resources getResources()>
	//   45   83:getstatic       #345 <Field int android.support.design.R$drawable.navigation_empty_icon>
	//   46   86:aload_0         
	//   47   87:invokevirtual   #148 <Method Context getContext()>
	//   48   90:invokevirtual   #152 <Method android.content.res.Resources$Theme Context.getTheme()>
	//   49   93:invokestatic    #351 <Method Drawable ResourcesCompat.getDrawable(Resources, int, android.content.res.Resources$Theme)>
	//   50   96:putfield        #339 <Field Drawable emptyDrawable>
				drawable = emptyDrawable;
	//   51   99:aload_0         
	//   52  100:getfield        #339 <Field Drawable emptyDrawable>
	//   53  103:astore_1        
				if(drawable != null)
	//*  54  104:aload_1         
	//*  55  105:ifnull          121
				{
					int j = iconSize;
	//   56  108:aload_0         
	//   57  109:getfield        #90  <Field int iconSize>
	//   58  112:istore_2        
	...
	//   62  116:iload_2         
	//   63  117:iload_2         
	//   64  118:invokevirtual   #335 <Method void Drawable.setBounds(int, int, int, int)>
				}
			}
			drawable = emptyDrawable;
	//   65  121:aload_0         
	//   66  122:getfield        #339 <Field Drawable emptyDrawable>
	//   67  125:astore_1        
		}
	...
	//   68  126:aload_0         
	//   69  127:getfield        #103 <Field CheckedTextView textView>
	//   70  130:aload_1         
	//   71  131:aconst_null     
	//   72  132:aconst_null     
	//   73  133:aconst_null     
	//   74  134:invokestatic    #357 <Method void TextViewCompat.setCompoundDrawablesRelative(android.widget.TextView, Drawable, Drawable, Drawable, Drawable)>
	//   75  137:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #103 <Field CheckedTextView textView>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #361 <Method void CheckedTextView.setCompoundDrawablePadding(int)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #328 <Field ColorStateList iconTintList>
		boolean flag;
		if(iconTintList != null)
	//*   3    5:aload_0         
	//*   4    6:getfield        #328 <Field ColorStateList iconTintList>
	//*   5    9:ifnull          17
			flag = true;
	//    6   12:iconst_1        
	//    7   13:istore_2        
	...
	//   11   19:aload_0         
	//   12   20:iload_2         
	//   13   21:putfield        #306 <Field boolean hasIconTintList>
	...
	//   19   33:aload_0         
	//   20   34:aload_1         
	//   21   35:invokevirtual   #208 <Method Drawable MenuItemImpl.getIcon()>
	//   22   38:invokevirtual   #254 <Method void setIcon(Drawable)>
	//   23   41:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #337 <Field boolean needsEmptyIcon>
	//    3    5:return          
	}
	...
	//    1    1:getfield        #103 <Field CheckedTextView textView>
	//    2    4:iload_1         
	//    3    5:invokestatic    #370 <Method void TextViewCompat.setTextAppearance(android.widget.TextView, int)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #103 <Field CheckedTextView textView>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #373 <Method void CheckedTextView.setTextColor(ColorStateList)>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #103 <Field CheckedTextView textView>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #376 <Method void CheckedTextView.setText(CharSequence)>
	//    4    8:return          
	}
