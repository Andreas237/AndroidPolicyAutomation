...
private class Chip$ChipTouchHelper extends ExploreByTouchHelper
{
	...
	//   45   90:invokestatic    #137 <Method android.graphics.Rect Chip.access$300(Chip)>
	//   46   93:invokevirtual   #141 <Method void AccessibilityNodeInfoCompat.setBoundsInParent(android.graphics.Rect)>
	...
	//   59  121:aload_2         
	//   60  122:invokestatic    #161 <Method android.graphics.Rect Chip.access$400()>
	//   61  125:invokevirtual   #141 <Method void AccessibilityNodeInfoCompat.setBoundsInParent(android.graphics.Rect)>
			return;
	//   62  128:return          
		}
	}
	...
	Chip$ChipTouchHelper(Chip chip1)
	{
		this$0 = Chip.this;
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #13  <Field Chip this$0>
		super(((android.view.View) (chip1)));
	//    3    5:aload_0         
	//    4    6:aload_2         
	//    5    7:invokespecial   #16  <Method void ExploreByTouchHelper(android.view.View)>
	//    6   10:return          
	}
}
