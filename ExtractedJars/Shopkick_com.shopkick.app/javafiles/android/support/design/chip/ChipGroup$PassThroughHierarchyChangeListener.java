...
*/
	...
	private ChipGroup$PassThroughHierarchyChangeListener()
	{
	...
	ChipGroup$PassThroughHierarchyChangeListener(ChipGroup._cls1 _pcls1)
	{
		this();
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #24  <Method void ChipGroup$PassThroughHierarchyChangeListener(ChipGroup)>
	//    3    5:return          
	}
}
