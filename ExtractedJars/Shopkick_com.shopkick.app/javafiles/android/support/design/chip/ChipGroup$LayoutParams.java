...
public static class ChipGroup$LayoutParams extends android.view.arams
{

	public ChipGroup$LayoutParams(int i, int j)
	{
		super(i, j);
	//    0    0:aload_0         
	//    1    1:iload_1         
	...
	public ChipGroup$LayoutParams(android.view.ViewGroup$LayoutParams viewgroup$layoutparams)
	{
	...
	public ChipGroup$LayoutParams(android.view.arams arams)
	{
		super(arams);
	//    0    0:aload_0         
	//    1    1:aload_1         
