	...
	implements ThreadUtil
{
	static class MessageQueue
	{
		...
		//   10   14:areturn         
			syncqueueitem = mRoot;
		//   11   15:aload_0         
		//   12   16:getfield        #18  <Field MessageThreadUtil$SyncQueueItem mRoot>
		//   13   19:astore_1        
			mRoot = mRoot.next;
		//   14   20:aload_0         
		//   15   21:aload_0         
		//   16   22:getfield        #18  <Field MessageThreadUtil$SyncQueueItem mRoot>
		//   17   25:getfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
		//   18   28:putfield        #18  <Field MessageThreadUtil$SyncQueueItem mRoot>
			this;
		//   19   31:aload_0         
			JVM INSTR monitorexit ;
		//   20   32:monitorexit     
		...
		//*   7   13:getfield        #28  <Field int MessageThreadUtil$SyncQueueItem.what>
		//*   8   16:iload_1         
		//*   9   17:icmpne          43
			{
				SyncQueueItem syncqueueitem = mRoot;
		...
		//   16   30:getfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
		//   17   33:putfield        #18  <Field MessageThreadUtil$SyncQueueItem mRoot>
				syncqueueitem.recycle();
		//   18   36:aload_2         
		//   19   37:invokevirtual   #31  <Method void MessageThreadUtil$SyncQueueItem.recycle()>
			}
		//*  20   40:goto            2
		...
		//   27   55:aload_3         
		//   28   56:getfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
		//   29   59:astore_2        
_L3:
...
_L1:
		...
		//   32   64:aload_2         
		//   33   65:getfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
		//   34   68:astore          4
			if(syncqueueitem1.what == i)
		//*  35   70:aload_2         
		//*  36   71:getfield        #28  <Field int MessageThreadUtil$SyncQueueItem.what>
		//*  37   74:iload_1         
		//*  38   75:icmpne          91
			{
		...
		//   39   78:aload_3         
		//   40   79:aload           4
		//   41   81:putfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
				syncqueueitem1.recycle();
		//   42   84:aload_2         
		//   43   85:invokevirtual   #31  <Method void MessageThreadUtil$SyncQueueItem.recycle()>
...
_L2:
		...
		//   13   21:astore_2        
		//   14   22:aload_2         
		//   15   23:getfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
		//   16   26:ifnull          37
		//   17   29:aload_2         
		//   18   30:getfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
		//   19   33:astore_2        
		//*  20   34:goto            22
			syncqueueitem1.next = syncqueueitem;
		//   21   37:aload_2         
		//   22   38:aload_1         
		//   23   39:putfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
			this;
		//   24   42:aload_0         
			JVM INSTR monitorexit ;
		//   25   43:monitorexit     
		...
		//    5    7:putfield        #22  <Field MessageThreadUtil$SyncQueueItem MessageThreadUtil$SyncQueueItem.next>
			mRoot = syncqueueitem;
		//    6   10:aload_0         
		//    7   11:aload_1         
		//    8   12:putfield        #18  <Field MessageThreadUtil$SyncQueueItem mRoot>
			this;
		//    9   15:aload_0         
			JVM INSTR monitorexit ;
		//   10   16:monitorexit     
	...
	static class SyncQueueItem
	{
		...
		//    5    5:iconst_0        
		//    6    6:aconst_null     
		//    7    7:invokestatic    #33  <Method MessageThreadUtil$SyncQueueItem obtainMessage(int, int, int, int, int, int, Object)>
		//    8   10:areturn         
		}
		...
		//    3    7:monitorenter    
			...
			if(sPool == null)
		//*   4    8:getstatic       #35  <Field MessageThreadUtil$SyncQueueItem sPool>
		//*   5   11:ifnonnull       26
			{
				syncqueueitem = new SyncQueueItem();
		//    6   14:new             #2   <Class MessageThreadUtil$SyncQueueItem>
		//    7   17:dup             
		//    8   18:invokespecial   #36  <Method void MessageThreadUtil$SyncQueueItem()>
		//    9   21:astore          7
				break MISSING_BLOCK_LABEL_46;
		//   10   23:goto            46
			}
			syncqueueitem = sPool;
		//   11   26:getstatic       #35  <Field MessageThreadUtil$SyncQueueItem sPool>
		//   12   29:astore          7
			sPool = sPool.next;
		//   13   31:getstatic       #35  <Field MessageThreadUtil$SyncQueueItem sPool>
		//   14   34:getfield        #38  <Field MessageThreadUtil$SyncQueueItem next>
		//   15   37:putstatic       #35  <Field MessageThreadUtil$SyncQueueItem sPool>
			syncqueueitem.next = null;
		//   16   40:aload           7
		//   17   42:aconst_null     
		//   18   43:putfield        #38  <Field MessageThreadUtil$SyncQueueItem next>
			syncqueueitem.what = i;
		//   19   46:aload           7
		//   20   48:iload_0         
		//   21   49:putfield        #40  <Field int what>
			syncqueueitem.arg1 = j;
		//   22   52:aload           7
		//   23   54:iload_1         
		//   24   55:putfield        #42  <Field int arg1>
			syncqueueitem.arg2 = k;
		//   25   58:aload           7
		//   26   60:iload_2         
		//   27   61:putfield        #44  <Field int arg2>
			syncqueueitem.arg3 = l;
		//   28   64:aload           7
		//   29   66:iload_3         
		//   30   67:putfield        #46  <Field int arg3>
			syncqueueitem.arg4 = i1;
		//   31   70:aload           7
		//   32   72:iload           4
		//   33   74:putfield        #48  <Field int arg4>
			syncqueueitem.arg5 = j1;
		//   34   77:aload           7
		//   35   79:iload           5
		//   36   81:putfield        #50  <Field int arg5>
			syncqueueitem.data = obj;
		//   37   84:aload           7
		//   38   86:aload           6
		//   39   88:putfield        #52  <Field Object data>
			obj1;
		//   40   91:aload           8
			JVM INSTR monitorexit ;
		//   41   93:monitorexit     
		...
		//    0    0:aload_0         
		//    1    1:aconst_null     
		//    2    2:putfield        #38  <Field MessageThreadUtil$SyncQueueItem next>
			arg5 = 0;
		//    3    5:aload_0         
		//    4    6:iconst_0        
		//    5    7:putfield        #50  <Field int arg5>
			arg4 = 0;
		//    6   10:aload_0         
		//    7   11:iconst_0        
		//    8   12:putfield        #48  <Field int arg4>
			arg3 = 0;
		//    9   15:aload_0         
		//   10   16:iconst_0        
		//   11   17:putfield        #46  <Field int arg3>
			arg2 = 0;
		//   12   20:aload_0         
		//   13   21:iconst_0        
		//   14   22:putfield        #44  <Field int arg2>
			arg1 = 0;
		//   15   25:aload_0         
		//   16   26:iconst_0        
		//   17   27:putfield        #42  <Field int arg1>
			what = 0;
		//   18   30:aload_0         
		//   19   31:iconst_0        
		//   20   32:putfield        #40  <Field int what>
			data = null;
		//   21   35:aload_0         
		//   22   36:aconst_null     
		//   23   37:putfield        #52  <Field Object data>
		...
		//*  27   45:monitorenter    
			{
				if(sPool != null)
		//*  28   46:getstatic       #35  <Field MessageThreadUtil$SyncQueueItem sPool>
		//*  29   49:ifnull          59
					next = sPool;
		//   30   52:aload_0         
		//   31   53:getstatic       #35  <Field MessageThreadUtil$SyncQueueItem sPool>
		//   32   56:putfield        #38  <Field MessageThreadUtil$SyncQueueItem next>
				sPool = this;
		//   33   59:aload_0         
		//   34   60:putstatic       #35  <Field MessageThreadUtil$SyncQueueItem sPool>
			}
		//   35   63:aload_1         
		//   36   64:monitorexit     
			return;
...
/* anonymous class */
		...
		implements Runnable
	{
		...
		//   35   97:aload_0         
		//   36   98:getfield        #14  <Field MessageThreadUtil$2 this$1>
		...
		//   43  119:aload_0         
		//   44  120:getfield        #14  <Field MessageThreadUtil$2 this$1>
		...
		//   52  142:aload_0         
		//   53  143:getfield        #14  <Field MessageThreadUtil$2 this$1>
		...
		//   57  153:aload_0         
		//   58  154:getfield        #14  <Field MessageThreadUtil$2 this$1>
		...
		//   62  164:aload_0         
		//   63  165:getfield        #14  <Field MessageThreadUtil$2 this$1>
		...
		//   77  199:aload_0         
		//   78  200:getfield        #14  <Field MessageThreadUtil$2 this$1>
		...
		//   82  210:aload_0         
		//   83  211:getfield        #14  <Field MessageThreadUtil$2 this$1>
