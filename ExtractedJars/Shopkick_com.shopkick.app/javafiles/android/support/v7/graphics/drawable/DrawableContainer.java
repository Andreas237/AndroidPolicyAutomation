...
_L1:
		...
		//    0    0:aload_0         
		//    1    1:iconst_0        
		//    2    2:putfield        #88  <Field boolean mMutated>
		//    3    5:return          
		}
		...
		//   32   53:aload           5
		//   33   55:invokevirtual   #245 <Method int Drawable.getIntrinsicWidth()>
		//   34   58:istore_3        
				if(k > mConstantWidth)
		//*  35   59:iload_3         
		//*  36   60:aload_0         
		...
		//   42   72:aload           5
		//   43   74:invokevirtual   #248 <Method int Drawable.getIntrinsicHeight()>
		//   44   77:istore_3        
		...
		//   52   91:aload           5
		//   53   93:invokevirtual   #251 <Method int Drawable.getMinimumWidth()>
		//   54   96:istore_3        
		...
		//   62  110:aload           5
		//   63  112:invokevirtual   #254 <Method int Drawable.getMinimumHeight()>
		//   64  115:istore_3        
		...
		//   14   22:aload_3         
		//   15   23:iload_1         
		//   16   24:invokevirtual   #260 <Method int SparseArray.indexOfKey(int)>
		//   17   27:istore_2        
				if(j >= 0)
		//*  18   28:iload_2         
		//*  19   29:iflt            87
		...
		//   38   66:iload_2         
		//   39   67:invokevirtual   #263 <Method void SparseArray.removeAt(int)>
		...
		//*   2    4:ifne            11
				computeConstantSize();
		//    3    7:aload_0         
		//    4    8:invokevirtual   #267 <Method void computeConstantSize()>
		...
		//   15   33:dup             
		//   16   34:invokespecial   #272 <Method void Rect()>
		//   17   37:astore          6
				int j = mNumChildren;
		//   18   39:aload_0         
		...
		//*  35   65:aaload          
		//*  36   66:aload           6
		//*  37   68:invokevirtual   #276 <Method boolean Drawable.getPadding(Rect)>
		//*  38   71:ifeq            194
					{
						Rect rect1 = rect;
		//   39   74:aload_3         
		...
		//   47   87:iconst_0        
		//   48   88:iconst_0        
		//   49   89:invokespecial   #279 <Method void Rect(int, int, int, int)>
		//   50   92:astore          4
						if(rect3.left > rect1.left)
		//*  51   94:aload           6
		//*  52   96:getfield        #282 <Field int Rect.left>
		//*  53   99:aload           4
		//*  54  101:getfield        #282 <Field int Rect.left>
		//*  55  104:icmple          117
							rect1.left = rect3.left;
		//   56  107:aload           4
		//   57  109:aload           6
		//   58  111:getfield        #282 <Field int Rect.left>
		//   59  114:putfield        #282 <Field int Rect.left>
						if(rect3.top > rect1.top)
		//*  60  117:aload           6
		//*  61  119:getfield        #285 <Field int Rect.top>
		//*  62  122:aload           4
		//*  63  124:getfield        #285 <Field int Rect.top>
		//*  64  127:icmple          140
							rect1.top = rect3.top;
		//   65  130:aload           4
		//   66  132:aload           6
		//   67  134:getfield        #285 <Field int Rect.top>
		//   68  137:putfield        #285 <Field int Rect.top>
						if(rect3.right > rect1.right)
		//*  69  140:aload           6
		//*  70  142:getfield        #288 <Field int Rect.right>
		//*  71  145:aload           4
		//*  72  147:getfield        #288 <Field int Rect.right>
		//*  73  150:icmple          163
							rect1.right = rect3.right;
		//   74  153:aload           4
		//   75  155:aload           6
		//   76  157:getfield        #288 <Field int Rect.right>
		//   77  160:putfield        #288 <Field int Rect.right>
						rect2 = rect1;
		//   78  163:aload           4
		//   79  165:astore          5
						if(rect3.bottom > rect1.bottom)
		//*  80  167:aload           6
		//*  81  169:getfield        #291 <Field int Rect.bottom>
		//*  82  172:aload           4
		//*  83  174:getfield        #291 <Field int Rect.bottom>
		//*  84  177:icmple          194
						{
							rect1.bottom = rect3.bottom;
		//   85  180:aload           4
		//   86  182:aload           6
		//   87  184:getfield        #291 <Field int Rect.bottom>
		//   88  187:putfield        #291 <Field int Rect.bottom>
							rect2 = rect1;
		//   89  190:aload           4
		//   90  192:astore          5
						}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #68  <Field int mEnterFadeDuration>
		//    2    4:ireturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:getfield        #70  <Field int mExitFadeDuration>
		//    2    4:ireturn         
		}
		...
		//   17   35:iconst_0        
		//   18   36:aaload          
		//   19   37:invokevirtual   #297 <Method int Drawable.getOpacity()>
		//   20   40:istore_1        
			else
		//*  21   41:goto            47
				i = -2;
		...
		//   35   62:iload_1         
		//   36   63:aaload          
		//   37   64:invokevirtual   #297 <Method int Drawable.getOpacity()>
		//   38   67:invokestatic    #301 <Method int Drawable.resolveOpacity(int, int)>
		//   39   70:istore_2        
		...
		//    7   11:iconst_0        
		//    8   12:iload_1         
		//    9   13:invokestatic    #307 <Method void System.arraycopy(Object, int, Object, int, int)>
		...
		//*  24   42:iload_1         
		//*  25   43:aaload          
		//*  26   44:invokevirtual   #311 <Method boolean Drawable.isStateful()>
		//*  27   47:ifeq            55
				{
					flag = true;
		//   28   50:iconst_1        
		...
		//    0    0:new             #318 <Class RuntimeException>
		//    1    3:dup             
		//    2    4:ldc2            #320 <String "d2j fail translate: java.lang.RuntimeException: can not merge Z and I\n\tat com.googlecode.dex2jar.ir.TypeClass.merge(TypeClass.java:100)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeRef.updateTypeClass(TypeTransformer.java:174)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.copyTypes(TypeTransformer.java:311)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.fixTypes(TypeTransformer.java:226)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.analyze(TypeTransformer.java:207)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer.transform(TypeTransformer.java:44)\n\tat com.googlecode.d2j.dex.Dex2jar$2.optimize(Dex2jar.java:162)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertCode(Dex2Asm.java:414)\n\tat com.googlecode.d2j.dex.ExDex2Asm.convertCode(ExDex2Asm.java:42)\n\tat com.googlecode.d2j.dex.Dex2jar$2.convertCode(Dex2jar.java:128)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertMethod(Dex2Asm.java:509)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertClass(Dex2Asm.java:406)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertDex(Dex2Asm.java:422)\n\tat com.googlecode.d2j.dex.Dex2jar.doTranslate(Dex2jar.java:172)\n\tat com.googlecode.d2j.dex.Dex2jar.to(Dex2jar.java:272)\n\tat com.googlecode.dex2jar.tools.Dex2jarCmd.doCommandLine(Dex2jarCmd.java:108)\n\tat com.googlecode.dex2jar.tools.BaseCmd.doMain(BaseCmd.java:288)\n\tat com.googlecode.dex2jar.tools.Dex2jarCmd.main(Dex2jarCmd.java:32)\n">
		//    3    7:invokespecial   #325 <Method void Runtime(String)>
		//    4   10:athrow          
		}
	...
	{
	//    0    0:aload_0         
	//    1    1:invokespecial   #51  <Method void Drawable()>
		mAlpha = 255;
	//    2    4:aload_0         
	//    3    5:sipush          255
	//    4    8:putfield        #53  <Field int mAlpha>
		mCurIndex = -1;
	//    5   11:aload_0         
	//    6   12:iconst_m1       
	//    7   13:putfield        #55  <Field int mCurIndex>
		mLastIndex = -1;
	//    8   16:aload_0         
	//    9   17:iconst_m1       
	//   10   18:putfield        #57  <Field int mLastIndex>
	//   11   21:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #62  <Field DrawableContainer$BlockInvalidateCallback mBlockInvalidateCallback>
	//*   2    4:ifnonnull       18
			mBlockInvalidateCallback = new BlockInvalidateCallback();
	//    3    7:aload_0         
	//    4    8:new             #10  <Class DrawableContainer$BlockInvalidateCallback>
	//    5   11:dup             
	//    6   12:invokespecial   #63  <Method void DrawableContainer$BlockInvalidateCallback()>
	//    7   15:putfield        #62  <Field DrawableContainer$BlockInvalidateCallback mBlockInvalidateCallback>
		drawable.setCallback(((android.graphics.drawable.Drawable.Callback) (mBlockInvalidateCallback.wrap(drawable.getCallback()))));
	//    8   18:aload_1         
	//    9   19:aload_0         
	//   10   20:getfield        #62  <Field DrawableContainer$BlockInvalidateCallback mBlockInvalidateCallback>
	//   11   23:aload_1         
	//   12   24:invokevirtual   #67  <Method android.graphics.drawable.Drawable$Callback Drawable.getCallback()>
	//   13   27:invokevirtual   #71  <Method DrawableContainer$BlockInvalidateCallback DrawableContainer$BlockInvalidateCallback.wrap(android.graphics.drawable.Drawable$Callback)>
	//   14   30:invokevirtual   #75  <Method void Drawable.setCallback(android.graphics.drawable.Drawable$Callback)>
		if(mDrawableContainerState.mEnterFadeDuration <= 0 && mHasAlpha)
	//*  15   33:aload_0         
	//*  16   34:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*  17   37:getfield        #80  <Field int DrawableContainer$DrawableContainerState.mEnterFadeDuration>
	//*  18   40:ifgt            58
	//*  19   43:aload_0         
	//*  20   44:getfield        #82  <Field boolean mHasAlpha>
	//*  21   47:ifeq            58
			drawable.setAlpha(mAlpha);
	//   22   50:aload_1         
	//   23   51:aload_0         
	//   24   52:getfield        #53  <Field int mAlpha>
	//   25   55:invokevirtual   #86  <Method void Drawable.setAlpha(int)>
		if(mDrawableContainerState.mHasColorFilter)
	//*  26   58:aload_0         
	//*  27   59:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*  28   62:getfield        #89  <Field boolean DrawableContainer$DrawableContainerState.mHasColorFilter>
	//*  29   65:ifeq            82
		{
			drawable.setColorFilter(mDrawableContainerState.mColorFilter);
	//   30   68:aload_1         
	//   31   69:aload_0         
	//   32   70:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   33   73:getfield        #93  <Field ColorFilter DrawableContainer$DrawableContainerState.mColorFilter>
	//   34   76:invokevirtual   #97  <Method void Drawable.setColorFilter(ColorFilter)>
			break MISSING_BLOCK_LABEL_124;
	//   35   79:goto            124
		}
		if(mDrawableContainerState.mHasTintList)
	//*  36   82:aload_0         
	//*  37   83:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*  38   86:getfield        #100 <Field boolean DrawableContainer$DrawableContainerState.mHasTintList>
	//*  39   89:ifeq            103
			DrawableCompat.setTintList(drawable, mDrawableContainerState.mTintList);
	//   40   92:aload_1         
	//   41   93:aload_0         
	//   42   94:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   43   97:getfield        #104 <Field ColorStateList DrawableContainer$DrawableContainerState.mTintList>
	//   44  100:invokestatic    #110 <Method void DrawableCompat.setTintList(Drawable, ColorStateList)>
		if(mDrawableContainerState.mHasTintMode)
	//*  45  103:aload_0         
	//*  46  104:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*  47  107:getfield        #113 <Field boolean DrawableContainer$DrawableContainerState.mHasTintMode>
	//*  48  110:ifeq            124
			DrawableCompat.setTintMode(drawable, mDrawableContainerState.mTintMode);
	//   49  113:aload_1         
	//   50  114:aload_0         
	//   51  115:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   52  118:getfield        #117 <Field android.graphics.PorterDuff$Mode DrawableContainer$DrawableContainerState.mTintMode>
	//   53  121:invokestatic    #121 <Method void DrawableCompat.setTintMode(Drawable, android.graphics.PorterDuff$Mode)>
		Rect rect;
		drawable.setVisible(isVisible(), true);
	//   54  124:aload_1         
	//   55  125:aload_0         
	//   56  126:invokevirtual   #125 <Method boolean isVisible()>
	//   57  129:iconst_1        
	//   58  130:invokevirtual   #129 <Method boolean Drawable.setVisible(boolean, boolean)>
	//   59  133:pop             
		drawable.setDither(mDrawableContainerState.mDither);
	//   60  134:aload_1         
	//   61  135:aload_0         
	//   62  136:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   63  139:getfield        #132 <Field boolean DrawableContainer$DrawableContainerState.mDither>
	//   64  142:invokevirtual   #136 <Method void Drawable.setDither(boolean)>
		drawable.setState(getState());
	//   65  145:aload_1         
	//   66  146:aload_0         
	//   67  147:invokevirtual   #140 <Method int[] getState()>
	//   68  150:invokevirtual   #144 <Method boolean Drawable.setState(int[])>
	//   69  153:pop             
		drawable.setLevel(getLevel());
	//   70  154:aload_1         
	//   71  155:aload_0         
	//   72  156:invokevirtual   #148 <Method int getLevel()>
	//   73  159:invokevirtual   #152 <Method boolean Drawable.setLevel(int)>
	//   74  162:pop             
		drawable.setBounds(getBounds());
	//   75  163:aload_1         
	//   76  164:aload_0         
	//   77  165:invokevirtual   #156 <Method Rect getBounds()>
	//   78  168:invokevirtual   #160 <Method void Drawable.setBounds(Rect)>
		if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  79  171:getstatic       #165 <Field int android.os.Build$VERSION.SDK_INT>
	//*  80  174:bipush          23
	//*  81  176:icmplt          188
			drawable.setLayoutDirection(getLayoutDirection());
	//   82  179:aload_1         
	//   83  180:aload_0         
	//   84  181:invokevirtual   #168 <Method int getLayoutDirection()>
	//   85  184:invokevirtual   #171 <Method boolean Drawable.setLayoutDirection(int)>
	//   86  187:pop             
		if(android.os.Build.VERSION.SDK_INT >= 19)
	//*  87  188:getstatic       #165 <Field int android.os.Build$VERSION.SDK_INT>
	//*  88  191:bipush          19
	//*  89  193:icmplt          207
			drawable.setAutoMirrored(mDrawableContainerState.mAutoMirrored);
	//   90  196:aload_1         
	//   91  197:aload_0         
	//   92  198:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   93  201:getfield        #174 <Field boolean DrawableContainer$DrawableContainerState.mAutoMirrored>
	//   94  204:invokevirtual   #177 <Method void Drawable.setAutoMirrored(boolean)>
		rect = mHotspotBounds;
	//   95  207:aload_0         
	//   96  208:getfield        #179 <Field Rect mHotspotBounds>
	//   97  211:astore_2        
		if(android.os.Build.VERSION.SDK_INT < 21 || rect == null)
			break MISSING_BLOCK_LABEL_244;
	//   98  212:getstatic       #165 <Field int android.os.Build$VERSION.SDK_INT>
	//   99  215:bipush          21
	//  100  217:icmplt          244
	//  101  220:aload_2         
	//  102  221:ifnull          244
	...
	//  103  224:aload_1         
	//  104  225:aload_2         
	//  105  226:getfield        #184 <Field int Rect.left>
	//  106  229:aload_2         
	//  107  230:getfield        #187 <Field int Rect.top>
	//  108  233:aload_2         
	//  109  234:getfield        #190 <Field int Rect.right>
	//  110  237:aload_2         
	//  111  238:getfield        #193 <Field int Rect.bottom>
	//  112  241:invokevirtual   #197 <Method void Drawable.setHotspotBounds(int, int, int, int)>
		drawable.setCallback(mBlockInvalidateCallback.unwrap());
	//  113  244:aload_1         
	//  114  245:aload_0         
	//  115  246:getfield        #62  <Field DrawableContainer$BlockInvalidateCallback mBlockInvalidateCallback>
	//  116  249:invokevirtual   #200 <Method android.graphics.drawable.Drawable$Callback DrawableContainer$BlockInvalidateCallback.unwrap()>
	//  117  252:invokevirtual   #75  <Method void Drawable.setCallback(android.graphics.drawable.Drawable$Callback)>
		return;
	//  118  255:return          
		Exception exception;
		exception;
	...
	//  120  257:aload_1         
	//  121  258:aload_0         
	//  122  259:getfield        #62  <Field DrawableContainer$BlockInvalidateCallback mBlockInvalidateCallback>
	//  123  262:invokevirtual   #200 <Method android.graphics.drawable.Drawable$Callback DrawableContainer$BlockInvalidateCallback.unwrap()>
	//  124  265:invokevirtual   #75  <Method void Drawable.setCallback(android.graphics.drawable.Drawable$Callback)>
		throw exception;
	//  125  268:aload_2         
	//  126  269:athrow          
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #208 <Method boolean isAutoMirrored()>
	//    2    4:ifeq            17
	//    3    7:aload_0         
	//    4    8:invokevirtual   #168 <Method int getLayoutDirection()>
	//    5   11:iconst_1        
	//    6   12:icmpne          17
	//    7   15:iconst_1        
	//    8   16:ireturn         
	...
	//    3    7:aload_0         
	//    4    8:invokevirtual   #218 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//    5   11:getfield        #223 <Field int DisplayMetrics.densityDpi>
	//    6   14:istore_1        
		int j = i;
	//    7   15:iload_1         
	//    8   16:istore_2        
...
label0:
	...
	//    2    2:aload_0         
	//    3    3:iconst_1        
	//    4    4:putfield        #82  <Field boolean mHasAlpha>
			l = SystemClock.uptimeMillis();
	//    5    7:invokestatic    #231 <Method long SystemClock.uptimeMillis()>
	//    6   10:lstore          4
			Drawable drawable = mCurrDrawable;
	//    7   12:aload_0         
	//    8   13:getfield        #233 <Field Drawable mCurrDrawable>
	//    9   16:astore          8
			if(drawable != null)
	//*  10   18:aload           8
	//*  11   20:ifnull          106
	...
	//   12   23:aload_0         
	//   13   24:getfield        #235 <Field long mEnterAnimationEnd>
	//   14   27:lstore          6
				if(l1 != 0L)
	//*  15   29:lload           6
	//*  16   31:lconst_0        
	...
	//   23   44:aload           8
	//   24   46:aload_0         
	//   25   47:getfield        #53  <Field int mAlpha>
	//   26   50:invokevirtual   #86  <Method void Drawable.setAlpha(int)>
						mEnterAnimationEnd = 0L;
	//   27   53:aload_0         
	//   28   54:lconst_0        
	//   29   55:putfield        #235 <Field long mEnterAnimationEnd>
					} else
	//*  30   58:goto            111
					{
	...
	//   32   63:lload           4
	//   33   65:lsub            
	//   34   66:ldc2w           #236 <Long 255L>
	//   35   69:lmul            
	//   36   70:l2i             
	//   37   71:aload_0         
	//   38   72:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   39   75:getfield        #80  <Field int DrawableContainer$DrawableContainerState.mEnterFadeDuration>
	//   40   78:idiv            
	//   41   79:istore_2        
						mCurrDrawable.setAlpha(((255 - i) * mAlpha) / 255);
	//   42   80:aload_0         
	//   43   81:getfield        #233 <Field Drawable mCurrDrawable>
	//   44   84:sipush          255
	//   45   87:iload_2         
	//   46   88:isub            
	//   47   89:aload_0         
	//   48   90:getfield        #53  <Field int mAlpha>
	//   49   93:imul            
	//   50   94:sipush          255
	//   51   97:idiv            
	//   52   98:invokevirtual   #86  <Method void Drawable.setAlpha(int)>
						i = 1;
	//   53  101:iconst_1        
	//   54  102:istore_2        
						break label0;
	...
	//   56  106:aload_0         
	//   57  107:lconst_0        
	//   58  108:putfield        #235 <Field long mEnterAnimationEnd>
			}
			i = 0;
	//   59  111:iconst_0        
	//   60  112:istore_2        
	...
	//   61  113:aload_0         
	//   62  114:getfield        #239 <Field Drawable mLastDrawable>
	//   63  117:astore          8
		if(drawable1 != null)
	//*  64  119:aload           8
	//*  65  121:ifnull          212
	...
	//   66  124:aload_0         
	//   67  125:getfield        #241 <Field long mExitAnimationEnd>
	//   68  128:lstore          6
			if(l2 != 0L)
	//*  69  130:lload           6
	//*  70  132:lconst_0        
	...
	//   78  147:iconst_0        
	//   79  148:iconst_0        
	//   80  149:invokevirtual   #129 <Method boolean Drawable.setVisible(boolean, boolean)>
	//   81  152:pop             
					mLastDrawable = null;
	//   82  153:aload_0         
	//   83  154:aconst_null     
	//   84  155:putfield        #239 <Field Drawable mLastDrawable>
					mLastIndex = -1;
	//   85  158:aload_0         
	//   86  159:iconst_m1       
	//   87  160:putfield        #57  <Field int mLastIndex>
					mExitAnimationEnd = 0L;
	//   88  163:aload_0         
	//   89  164:lconst_0        
	//   90  165:putfield        #241 <Field long mExitAnimationEnd>
				} else
	//*  91  168:goto            217
				{
	...
	//   93  173:lload           4
	//   94  175:lsub            
	//   95  176:ldc2w           #236 <Long 255L>
	//   96  179:lmul            
	//   97  180:l2i             
	//   98  181:aload_0         
	//   99  182:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//  100  185:getfield        #244 <Field int DrawableContainer$DrawableContainerState.mExitFadeDuration>
	//  101  188:idiv            
	//  102  189:istore_2        
					mLastDrawable.setAlpha((i * mAlpha) / 255);
	//  103  190:aload_0         
	//  104  191:getfield        #239 <Field Drawable mLastDrawable>
	//  105  194:iload_2         
	//  106  195:aload_0         
	//  107  196:getfield        #53  <Field int mAlpha>
	//  108  199:imul            
	//  109  200:sipush          255
	//  110  203:idiv            
	//  111  204:invokevirtual   #86  <Method void Drawable.setAlpha(int)>
					i = ((int) (flag1));
	//  112  207:iload_3         
	//  113  208:istore_2        
				}
	...
	//  115  212:aload_0         
	//  116  213:lconst_0        
	//  117  214:putfield        #241 <Field long mExitAnimationEnd>
		}
		if(flag && i != 0)
	//* 118  217:iload_1         
	//* 119  218:ifeq            239
	...
	//  122  225:aload_0         
	//  123  226:aload_0         
	//  124  227:getfield        #246 <Field Runnable mAnimationRunnable>
	//  125  230:lload           4
	//  126  232:ldc2w           #247 <Long 16L>
	//  127  235:ladd            
	//  128  236:invokevirtual   #252 <Method void scheduleSelf(Runnable, long)>
	//  129  239:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #259 <Method void DrawableContainer$DrawableContainerState.applyTheme(android.content.res.Resources$Theme)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:invokevirtual   #262 <Method boolean DrawableContainer$DrawableContainerState.canApplyTheme()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:invokevirtual   #265 <Method void DrawableContainer$DrawableContainerState.clearMutated()>
		mMutated = false;
	//    3    7:aload_0         
	//    4    8:iconst_0        
	//    5    9:putfield        #267 <Field boolean mMutated>
	//    6   12:return          
	}
	...
	public void draw(Canvas canvas)
	{
		Drawable drawable = mCurrDrawable;
	//    0    0:aload_0         
	//    1    1:getfield        #233 <Field Drawable mCurrDrawable>
	//    2    4:astore_2        
		if(drawable != null)
	//*   3    5:aload_2         
	//*   4    6:ifnull          14
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #273 <Method void Drawable.draw(Canvas)>
		drawable = mLastDrawable;
	//    8   14:aload_0         
	//    9   15:getfield        #239 <Field Drawable mLastDrawable>
	//   10   18:astore_2        
		if(drawable != null)
	//*  11   19:aload_2         
	//*  12   20:ifnull          28
	...
	//   13   23:aload_2         
	//   14   24:aload_1         
	//   15   25:invokevirtual   #273 <Method void Drawable.draw(Canvas)>
	//   16   28:return          
	}
	...
	public int getAlpha()
	{
		return mAlpha;
	//    0    0:aload_0         
	//    1    1:getfield        #53  <Field int mAlpha>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #277 <Method int Drawable.getChangingConfigurations()>
	//    2    4:aload_0         
	//    3    5:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    4    8:invokevirtual   #278 <Method int DrawableContainer$DrawableContainerState.getChangingConfigurations()>
	//    5   11:ior             
	//    6   12:ireturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*   2    4:invokevirtual   #283 <Method boolean DrawableContainer$DrawableContainerState.canConstantState()>
	//*   3    7:ifeq            26
		{
			mDrawableContainerState.mChangingConfigurations = getChangingConfigurations();
	//    4   10:aload_0         
	//    5   11:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    6   14:aload_0         
	//    7   15:invokevirtual   #284 <Method int getChangingConfigurations()>
	//    8   18:putfield        #287 <Field int DrawableContainer$DrawableContainerState.mChangingConfigurations>
			return ((android.graphics.drawable.Drawable.ConstantState) (mDrawableContainerState));
	//    9   21:aload_0         
	//   10   22:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   11   25:areturn         
		} else
		{
			return null;
	...
	int getCurrentIndex()
	{
		return mCurIndex;
	//    0    0:aload_0         
	//    1    1:getfield        #55  <Field int mCurIndex>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #179 <Field Rect mHotspotBounds>
	//    2    4:astore_2        
		if(rect1 != null)
	//*   3    5:aload_2         
	//*   4    6:ifnull          15
	...
	//    5    9:aload_1         
	//    6   10:aload_2         
	//    7   11:invokevirtual   #294 <Method void Rect.set(Rect)>
			return;
	//    8   14:return          
		} else
		{
	...
	//    9   15:aload_0         
	//   10   16:aload_1         
	//   11   17:invokespecial   #296 <Method void Drawable.getHotspotBounds(Rect)>
			return;
	//   12   20:return          
		}
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*   2    4:invokevirtual   #300 <Method boolean DrawableContainer$DrawableContainerState.isConstantSize()>
	//*   3    7:ifeq            18
			return mDrawableContainerState.getConstantHeight();
	//    4   10:aload_0         
	//    5   11:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    6   14:invokevirtual   #303 <Method int DrawableContainer$DrawableContainerState.getConstantHeight()>
	//    7   17:ireturn         
		Drawable drawable = mCurrDrawable;
	//    8   18:aload_0         
	//    9   19:getfield        #233 <Field Drawable mCurrDrawable>
	//   10   22:astore_1        
		if(drawable != null)
	//*  11   23:aload_1         
	//*  12   24:ifnull          32
	...
	//   13   27:aload_1         
	//   14   28:invokevirtual   #305 <Method int Drawable.getIntrinsicHeight()>
	//   15   31:ireturn         
		else
			return -1;
	//   16   32:iconst_m1       
	...
	//    4   10:aload_0         
	//    5   11:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    6   14:invokevirtual   #309 <Method int DrawableContainer$DrawableContainerState.getConstantWidth()>
	//    7   17:ireturn         
		Drawable drawable = mCurrDrawable;
	//    8   18:aload_0         
	//    9   19:getfield        #233 <Field Drawable mCurrDrawable>
	...
	//   13   27:aload_1         
	//   14   28:invokevirtual   #311 <Method int Drawable.getIntrinsicWidth()>
	//   15   31:ireturn         
		else
			return -1;
	//   16   32:iconst_m1       
	...
	//    4   10:aload_0         
	//    5   11:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    6   14:invokevirtual   #315 <Method int DrawableContainer$DrawableContainerState.getConstantMinimumHeight()>
	//    7   17:ireturn         
		Drawable drawable = mCurrDrawable;
	//    8   18:aload_0         
	//    9   19:getfield        #233 <Field Drawable mCurrDrawable>
	...
	//   13   27:aload_1         
	//   14   28:invokevirtual   #317 <Method int Drawable.getMinimumHeight()>
	//   15   31:ireturn         
		else
			return 0;
	//   16   32:iconst_0        
	...
	//    4   10:aload_0         
	//    5   11:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    6   14:invokevirtual   #321 <Method int DrawableContainer$DrawableContainerState.getConstantMinimumWidth()>
	//    7   17:ireturn         
		Drawable drawable = mCurrDrawable;
	//    8   18:aload_0         
	//    9   19:getfield        #233 <Field Drawable mCurrDrawable>
	...
	//   13   27:aload_1         
	//   14   28:invokevirtual   #323 <Method int Drawable.getMinimumWidth()>
	//   15   31:ireturn         
		else
			return 0;
	//   16   32:iconst_0        
	...
	//*   4    6:ifnull          27
	//*   5    9:aload_1         
	//*   6   10:invokevirtual   #325 <Method boolean Drawable.isVisible()>
	//*   7   13:ifne            19
	//*   8   16:goto            27
			return mDrawableContainerState.getOpacity();
	//    9   19:aload_0         
	//   10   20:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   11   23:invokevirtual   #327 <Method int DrawableContainer$DrawableContainerState.getOpacity()>
	//   12   26:ireturn         
		else
			return -2;
	//   13   27:bipush          -2
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #331 <Method void Drawable.getOutline(Outline)>
	//    8   14:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:invokevirtual   #336 <Method Rect DrawableContainer$DrawableContainerState.getConstantPadding()>
	//    3    7:astore          6
		boolean flag;
		if(rect1 != null)
	//*   4    9:aload           6
	...
	//    6   14:aload_1         
	//    7   15:aload           6
	//    8   17:invokevirtual   #294 <Method void Rect.set(Rect)>
			int i = rect1.left;
	//    9   20:aload           6
	//   10   22:getfield        #184 <Field int Rect.left>
	//   11   25:istore_2        
			int k = rect1.top;
	//   12   26:aload           6
	//   13   28:getfield        #187 <Field int Rect.top>
	//   14   31:istore_3        
			int l = rect1.bottom;
	//   15   32:aload           6
	//   16   34:getfield        #193 <Field int Rect.bottom>
	//   17   37:istore          4
			if((rect1.right | (i | k | l)) != 0)
	//*  18   39:aload           6
	//*  19   41:getfield        #190 <Field int Rect.right>
	//*  20   44:iload_2         
	//*  21   45:iload_3         
	//*  22   46:ior             
	//*  23   47:iload           4
	...
	//*  32   63:goto            95
		{
			Drawable drawable = mCurrDrawable;
	//   33   66:aload_0         
	//   34   67:getfield        #233 <Field Drawable mCurrDrawable>
	//   35   70:astore          6
			if(drawable != null)
	//*  36   72:aload           6
	//*  37   74:ifnull          88
	...
	//   38   77:aload           6
	//   39   79:aload_1         
	//   40   80:invokevirtual   #338 <Method boolean Drawable.getPadding(Rect)>
	//   41   83:istore          5
			else
	//*  42   85:goto            95
	...
	//   43   88:aload_0         
	//   44   89:aload_1         
	//   45   90:invokespecial   #338 <Method boolean Drawable.getPadding(Rect)>
	//   46   93:istore          5
		}
		if(needsMirroring())
	//*  47   95:aload_0         
	//*  48   96:invokespecial   #340 <Method boolean needsMirroring()>
	//*  49   99:ifeq            120
		{
			int j = rect.left;
	//   50  102:aload_1         
	//   51  103:getfield        #184 <Field int Rect.left>
	//   52  106:istore_2        
			rect.left = rect.right;
	//   53  107:aload_1         
	//   54  108:aload_1         
	//   55  109:getfield        #190 <Field int Rect.right>
	//   56  112:putfield        #184 <Field int Rect.left>
			rect.right = j;
	//   57  115:aload_1         
	//   58  116:iload_2         
	//   59  117:putfield        #190 <Field int Rect.right>
		}
		return flag;
	//   60  120:iload           5
	//   61  122:ireturn         
	...
	//    5    9:aload_2         
	//    6   10:invokevirtual   #344 <Method void DrawableContainer$DrawableContainerState.invalidateCache()>
		if(drawable == mCurrDrawable && getCallback() != null)
	//*   7   13:aload_1         
	//*   8   14:aload_0         
	//*   9   15:getfield        #233 <Field Drawable mCurrDrawable>
	//*  10   18:if_acmpne       38
	//*  11   21:aload_0         
	//*  12   22:invokevirtual   #345 <Method android.graphics.drawable.Drawable$Callback getCallback()>
	//*  13   25:ifnull          38
			getCallback().invalidateDrawable(((Drawable) (this)));
	//   14   28:aload_0         
	//   15   29:invokevirtual   #345 <Method android.graphics.drawable.Drawable$Callback getCallback()>
	//   16   32:aload_0         
	//   17   33:invokeinterface #347 <Method void android.graphics.drawable.Drawable$Callback.invalidateDrawable(Drawable)>
	//   18   38:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:getfield        #174 <Field boolean DrawableContainer$DrawableContainerState.mAutoMirrored>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:invokevirtual   #350 <Method boolean DrawableContainer$DrawableContainerState.isStateful()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #239 <Field Drawable mLastDrawable>
	//    2    4:astore_2        
		boolean flag;
		if(drawable != null)
	//*   3    5:aload_2         
	...
	//    5    9:aload_2         
	//    6   10:invokevirtual   #353 <Method void Drawable.jumpToCurrentState()>
			mLastDrawable = null;
	//    7   13:aload_0         
	//    8   14:aconst_null     
	//    9   15:putfield        #239 <Field Drawable mLastDrawable>
			mLastIndex = -1;
	//   10   18:aload_0         
	//   11   19:iconst_m1       
	//   12   20:putfield        #57  <Field int mLastIndex>
			flag = true;
	//   13   23:iconst_1        
	//   14   24:istore_1        
		} else
	...
	//   18   30:aload_0         
	//   19   31:getfield        #233 <Field Drawable mCurrDrawable>
	//   20   34:astore_2        
		if(drawable != null)
	//*  21   35:aload_2         
	//*  22   36:ifnull          61
		{
			drawable.jumpToCurrentState();
	//   23   39:aload_2         
	//   24   40:invokevirtual   #353 <Method void Drawable.jumpToCurrentState()>
			if(mHasAlpha)
	//*  25   43:aload_0         
	//*  26   44:getfield        #82  <Field boolean mHasAlpha>
	//*  27   47:ifeq            61
				mCurrDrawable.setAlpha(mAlpha);
	//   28   50:aload_0         
	//   29   51:getfield        #233 <Field Drawable mCurrDrawable>
	//   30   54:aload_0         
	//   31   55:getfield        #53  <Field int mAlpha>
	//   32   58:invokevirtual   #86  <Method void Drawable.setAlpha(int)>
		}
		if(mExitAnimationEnd != 0L)
	//*  33   61:aload_0         
	//*  34   62:getfield        #241 <Field long mExitAnimationEnd>
	//*  35   65:lconst_0        
	//*  36   66:lcmp            
	//*  37   67:ifeq            77
		{
	...
	//   38   70:aload_0         
	//   39   71:lconst_0        
	//   40   72:putfield        #241 <Field long mExitAnimationEnd>
			flag = true;
	//   41   75:iconst_1        
	//   42   76:istore_1        
		}
	...
	//*  43   77:aload_0         
	//*  44   78:getfield        #235 <Field long mEnterAnimationEnd>
	//*  45   81:lconst_0        
	//*  46   82:lcmp            
	//*  47   83:ifeq            93
		{
	...
	//   48   86:aload_0         
	//   49   87:lconst_0        
	//   50   88:putfield        #235 <Field long mEnterAnimationEnd>
			flag = true;
	//   51   91:iconst_1        
	//   52   92:istore_1        
		}
	...
	//*  54   94:ifeq            101
			invalidateSelf();
	//   55   97:aload_0         
	//   56   98:invokevirtual   #356 <Method void invalidateSelf()>
	//   57  101:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #267 <Field boolean mMutated>
	//*   2    4:ifne            34
	//*   3    7:aload_0         
	//*   4    8:invokespecial   #359 <Method Drawable Drawable.mutate()>
	//*   5   11:aload_0         
	//*   6   12:if_acmpne       34
		{
			DrawableContainerState drawablecontainerstate = cloneConstantState();
	//    7   15:aload_0         
	//    8   16:invokevirtual   #361 <Method DrawableContainer$DrawableContainerState cloneConstantState()>
	//    9   19:astore_1        
			drawablecontainerstate.mutate();
	//   10   20:aload_1         
	//   11   21:invokevirtual   #363 <Method void DrawableContainer$DrawableContainerState.mutate()>
			setConstantState(drawablecontainerstate);
	//   12   24:aload_0         
	//   13   25:aload_1         
	//   14   26:invokevirtual   #367 <Method void setConstantState(DrawableContainer$DrawableContainerState)>
			mMutated = true;
	//   15   29:aload_0         
	//   16   30:iconst_1        
	//   17   31:putfield        #267 <Field boolean mMutated>
		}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #160 <Method void Drawable.setBounds(Rect)>
		drawable = mCurrDrawable;
	//    8   14:aload_0         
	//    9   15:getfield        #233 <Field Drawable mCurrDrawable>
	//   10   18:astore_2        
	...
	//   13   23:aload_2         
	//   14   24:aload_1         
	//   15   25:invokevirtual   #160 <Method void Drawable.setBounds(Rect)>
	//   16   28:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:aload_0         
	//    4    6:invokevirtual   #371 <Method int getCurrentIndex()>
	//    5    9:invokevirtual   #374 <Method boolean DrawableContainer$DrawableContainerState.setLayoutDirection(int, int)>
	//    6   12:ireturn         
	}
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #152 <Method boolean Drawable.setLevel(int)>
	//    8   14:ireturn         
		drawable = mCurrDrawable;
	//    9   15:aload_0         
	//   10   16:getfield        #233 <Field Drawable mCurrDrawable>
	//   11   19:astore_2        
		if(drawable != null)
	//*  12   20:aload_2         
	//*  13   21:ifnull          30
	...
	//   14   24:aload_2         
	//   15   25:iload_1         
	//   16   26:invokevirtual   #152 <Method boolean Drawable.setLevel(int)>
	//   17   29:ireturn         
		else
			return false;
	//   18   30:iconst_0        
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #144 <Method boolean Drawable.setState(int[])>
	//    8   14:ireturn         
		drawable = mCurrDrawable;
	//    9   15:aload_0         
	//   10   16:getfield        #233 <Field Drawable mCurrDrawable>
	...
	//   14   24:aload_2         
	//   15   25:aload_1         
	//   16   26:invokevirtual   #144 <Method boolean Drawable.setState(int[])>
	//   17   29:ireturn         
		else
			return false;
	//   18   30:iconst_0        
	...
	//*   0    0:aload_1         
	//*   1    1:aload_0         
	//*   2    2:getfield        #233 <Field Drawable mCurrDrawable>
	//*   3    5:if_acmpne       27
	//*   4    8:aload_0         
	//*   5    9:invokevirtual   #345 <Method android.graphics.drawable.Drawable$Callback getCallback()>
	//*   6   12:ifnull          27
			getCallback().scheduleDrawable(((Drawable) (this)), runnable, l);
	//    7   15:aload_0         
	//    8   16:invokevirtual   #345 <Method android.graphics.drawable.Drawable$Callback getCallback()>
	//    9   19:aload_0         
	//   10   20:aload_2         
	//   11   21:lload_3         
	//   12   22:invokeinterface #380 <Method void android.graphics.drawable.Drawable$Callback.scheduleDrawable(Drawable, Runnable, long)>
	//   13   27:return          
	}
	...
	//*   0    0:iload_1         
	//*   1    1:aload_0         
	//*   2    2:getfield        #55  <Field int mCurIndex>
	//*   3    5:icmpne          10
			return false;
	//    4    8:iconst_0        
	//    5    9:ireturn         
		long l = SystemClock.uptimeMillis();
	//    6   10:invokestatic    #231 <Method long SystemClock.uptimeMillis()>
	//    7   13:lstore_2        
		if(mDrawableContainerState.mExitFadeDuration > 0)
	//*   8   14:aload_0         
	//*   9   15:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*  10   18:getfield        #244 <Field int DrawableContainer$DrawableContainerState.mExitFadeDuration>
	//*  11   21:ifle            103
		{
			Drawable drawable = mLastDrawable;
	//   12   24:aload_0         
	//   13   25:getfield        #239 <Field Drawable mLastDrawable>
	//   14   28:astore          4
			if(drawable != null)
	//*  15   30:aload           4
	//*  16   32:ifnull          43
	...
	//   18   37:iconst_0        
	//   19   38:iconst_0        
	//   20   39:invokevirtual   #129 <Method boolean Drawable.setVisible(boolean, boolean)>
	//   21   42:pop             
			drawable = mCurrDrawable;
	//   22   43:aload_0         
	//   23   44:getfield        #233 <Field Drawable mCurrDrawable>
	//   24   47:astore          4
			if(drawable != null)
	//*  25   49:aload           4
	//*  26   51:ifnull          85
	...
	//   27   54:aload_0         
	//   28   55:aload           4
	//   29   57:putfield        #239 <Field Drawable mLastDrawable>
				mLastIndex = mCurIndex;
	//   30   60:aload_0         
	//   31   61:aload_0         
	//   32   62:getfield        #55  <Field int mCurIndex>
	//   33   65:putfield        #57  <Field int mLastIndex>
				mExitAnimationEnd = (long)mDrawableContainerState.mExitFadeDuration + l;
	//   34   68:aload_0         
	//   35   69:aload_0         
	//   36   70:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   37   73:getfield        #244 <Field int DrawableContainer$DrawableContainerState.mExitFadeDuration>
	//   38   76:i2l             
	//   39   77:lload_2         
	//   40   78:ladd            
	//   41   79:putfield        #241 <Field long mExitAnimationEnd>
			} else
	//*  42   82:goto            122
			{
				mLastDrawable = null;
	//   43   85:aload_0         
	//   44   86:aconst_null     
	//   45   87:putfield        #239 <Field Drawable mLastDrawable>
				mLastIndex = -1;
	//   46   90:aload_0         
	//   47   91:iconst_m1       
	//   48   92:putfield        #57  <Field int mLastIndex>
				mExitAnimationEnd = 0L;
	//   49   95:aload_0         
	//   50   96:lconst_0        
	//   51   97:putfield        #241 <Field long mExitAnimationEnd>
			}
		} else
	//*  52  100:goto            122
		{
	...
	//   53  103:aload_0         
	//   54  104:getfield        #233 <Field Drawable mCurrDrawable>
	//   55  107:astore          4
			if(drawable1 != null)
	//*  56  109:aload           4
	//*  57  111:ifnull          122
	...
	//   59  116:iconst_0        
	//   60  117:iconst_0        
	//   61  118:invokevirtual   #129 <Method boolean Drawable.setVisible(boolean, boolean)>
	//   62  121:pop             
		}
	...
	//*  65  126:iload_1         
	//*  66  127:aload_0         
	//*  67  128:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*  68  131:getfield        #384 <Field int DrawableContainer$DrawableContainerState.mNumChildren>
	//*  69  134:icmpge          196
		{
			Drawable drawable2 = mDrawableContainerState.getChild(i);
	//   70  137:aload_0         
	//   71  138:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   72  141:iload_1         
	//   73  142:invokevirtual   #388 <Method Drawable DrawableContainer$DrawableContainerState.getChild(int)>
	//   74  145:astore          4
			mCurrDrawable = drawable2;
	//   75  147:aload_0         
	//   76  148:aload           4
	//   77  150:putfield        #233 <Field Drawable mCurrDrawable>
			mCurIndex = i;
	//   78  153:aload_0         
	//   79  154:iload_1         
	//   80  155:putfield        #55  <Field int mCurIndex>
			if(drawable2 != null)
	//*  81  158:aload           4
	//*  82  160:ifnull          206
			{
	...
	//*  83  163:aload_0         
	//*  84  164:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*  85  167:getfield        #80  <Field int DrawableContainer$DrawableContainerState.mEnterFadeDuration>
	//*  86  170:ifle            187
					mEnterAnimationEnd = l + (long)mDrawableContainerState.mEnterFadeDuration;
	//   87  173:aload_0         
	//   88  174:lload_2         
	//   89  175:aload_0         
	//   90  176:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   91  179:getfield        #80  <Field int DrawableContainer$DrawableContainerState.mEnterFadeDuration>
	//   92  182:i2l             
	//   93  183:ladd            
	//   94  184:putfield        #235 <Field long mEnterAnimationEnd>
				initializeDrawableForDisplay(drawable2);
	//   95  187:aload_0         
	//   96  188:aload           4
	//   97  190:invokespecial   #390 <Method void initializeDrawableForDisplay(Drawable)>
			}
		} else
	//*  98  193:goto            206
		{
	...
	//   99  196:aload_0         
	//  100  197:aconst_null     
	//  101  198:putfield        #233 <Field Drawable mCurrDrawable>
			mCurIndex = -1;
	//  102  201:aload_0         
	//  103  202:iconst_m1       
	//  104  203:putfield        #55  <Field int mCurIndex>
		}
		if(mEnterAnimationEnd != 0L || mExitAnimationEnd != 0L)
	//* 105  206:aload_0         
	//* 106  207:getfield        #235 <Field long mEnterAnimationEnd>
	//* 107  210:lconst_0        
	//* 108  211:lcmp            
	//* 109  212:ifne            224
	//* 110  215:aload_0         
	//* 111  216:getfield        #241 <Field long mExitAnimationEnd>
	//* 112  219:lconst_0        
	//* 113  220:lcmp            
	//* 114  221:ifeq            261
		{
	...
	//  115  224:aload_0         
	//  116  225:getfield        #246 <Field Runnable mAnimationRunnable>
	//  117  228:astore          4
			if(runnable == null)
	//* 118  230:aload           4
...
;
	...
	//  122  239:dup             
	//  123  240:aload_0         
	//  124  241:invokespecial   #393 <Method void DrawableContainer$1(DrawableContainer)>
	//  125  244:putfield        #246 <Field Runnable mAnimationRunnable>
			else
	//* 126  247:goto            256
				unscheduleSelf(runnable);
	//  127  250:aload_0         
	//  128  251:aload           4
	//  129  253:invokevirtual   #397 <Method void unscheduleSelf(Runnable)>
			animate(true);
	//  130  256:aload_0         
	//  131  257:iconst_1        
	//  132  258:invokevirtual   #399 <Method void animate(boolean)>
		}
		invalidateSelf();
	//  133  261:aload_0         
	//  134  262:invokevirtual   #356 <Method void invalidateSelf()>
		return true;
	//  135  265:iconst_1        
	//  136  266:ireturn         
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #82  <Field boolean mHasAlpha>
	//*   2    4:ifeq            15
	//*   3    7:aload_0         
	//*   4    8:getfield        #53  <Field int mAlpha>
	//*   5   11:iload_1         
	//*   6   12:icmpeq          54
		{
			mHasAlpha = true;
	//    7   15:aload_0         
	//    8   16:iconst_1        
	//    9   17:putfield        #82  <Field boolean mHasAlpha>
			mAlpha = i;
	//   10   20:aload_0         
	//   11   21:iload_1         
	//   12   22:putfield        #53  <Field int mAlpha>
			Drawable drawable = mCurrDrawable;
	//   13   25:aload_0         
	//   14   26:getfield        #233 <Field Drawable mCurrDrawable>
	//   15   29:astore_2        
			if(drawable != null)
	//*  16   30:aload_2         
	//*  17   31:ifnull          54
			{
				if(mEnterAnimationEnd == 0L)
	//*  18   34:aload_0         
	//*  19   35:getfield        #235 <Field long mEnterAnimationEnd>
	//*  20   38:lconst_0        
	//*  21   39:lcmp            
	//*  22   40:ifne            49
				{
	...
	//   23   43:aload_2         
	//   24   44:iload_1         
	//   25   45:invokevirtual   #86  <Method void Drawable.setAlpha(int)>
					return;
	//   26   48:return          
				}
				animate(false);
	//   27   49:aload_0         
	//   28   50:iconst_0        
	//   29   51:invokevirtual   #399 <Method void animate(boolean)>
			}
		}
	//   30   54:return          
	}
	...
	//*   4    8:icmpeq          38
		{
			DrawableContainerState drawablecontainerstate = mDrawableContainerState;
	//    5   11:aload_0         
	//    6   12:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    7   15:astore_2        
			drawablecontainerstate.mAutoMirrored = flag;
	//    8   16:aload_2         
	//    9   17:iload_1         
	//   10   18:putfield        #174 <Field boolean DrawableContainer$DrawableContainerState.mAutoMirrored>
			Drawable drawable = mCurrDrawable;
	//   11   21:aload_0         
	//   12   22:getfield        #233 <Field Drawable mCurrDrawable>
	//   13   25:astore_3        
			if(drawable != null)
	//*  14   26:aload_3         
	//*  15   27:ifnull          38
	...
	//   16   30:aload_3         
	//   17   31:aload_2         
	//   18   32:getfield        #174 <Field boolean DrawableContainer$DrawableContainerState.mAutoMirrored>
	//   19   35:invokestatic    #402 <Method void DrawableCompat.setAutoMirrored(Drawable, boolean)>
		}
	//   20   38:return          
	}
	...
	//    3    5:aload_2         
	//    4    6:iconst_1        
	//    5    7:putfield        #89  <Field boolean DrawableContainer$DrawableContainerState.mHasColorFilter>
		if(drawablecontainerstate.mColorFilter != colorfilter)
	//*   6   10:aload_2         
	//*   7   11:getfield        #93  <Field ColorFilter DrawableContainer$DrawableContainerState.mColorFilter>
	//*   8   14:aload_1         
	//*   9   15:if_acmpeq       40
		{
			mDrawableContainerState.mColorFilter = colorfilter;
	//   10   18:aload_0         
	//   11   19:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   12   22:aload_1         
	//   13   23:putfield        #93  <Field ColorFilter DrawableContainer$DrawableContainerState.mColorFilter>
			Drawable drawable = mCurrDrawable;
	//   14   26:aload_0         
	//   15   27:getfield        #233 <Field Drawable mCurrDrawable>
	//   16   30:astore_2        
			if(drawable != null)
	//*  17   31:aload_2         
	//*  18   32:ifnull          40
	...
	//   19   35:aload_2         
	//   20   36:aload_1         
	//   21   37:invokevirtual   #97  <Method void Drawable.setColorFilter(ColorFilter)>
		}
	//   22   40:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
		int i = mCurIndex;
	//    3    5:aload_0         
	//    4    6:getfield        #55  <Field int mCurIndex>
	//    5    9:istore_2        
		if(i >= 0)
	//*   6   10:iload_2         
	//*   7   11:iflt            37
	...
	//    9   15:aload_1         
	//   10   16:iload_2         
	//   11   17:invokevirtual   #388 <Method Drawable DrawableContainer$DrawableContainerState.getChild(int)>
	//   12   20:putfield        #233 <Field Drawable mCurrDrawable>
			drawablecontainerstate = ((DrawableContainerState) (mCurrDrawable));
	//   13   23:aload_0         
	//   14   24:getfield        #233 <Field Drawable mCurrDrawable>
	//   15   27:astore_1        
			if(drawablecontainerstate != null)
	//*  16   28:aload_1         
	//*  17   29:ifnull          37
	...
	//   18   32:aload_0         
	//   19   33:aload_1         
	//   20   34:invokespecial   #390 <Method void initializeDrawableForDisplay(Drawable)>
		}
		mLastIndex = -1;
	//   21   37:aload_0         
	//   22   38:iconst_m1       
	//   23   39:putfield        #57  <Field int mLastIndex>
		mLastDrawable = null;
	//   24   42:aload_0         
	//   25   43:aconst_null     
	//   26   44:putfield        #239 <Field Drawable mLastDrawable>
	//   27   47:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #405 <Method boolean selectDrawable(int)>
	//    3    5:pop             
	//    4    6:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//*   2    4:getfield        #132 <Field boolean DrawableContainer$DrawableContainerState.mDither>
	//*   3    7:iload_1         
	//*   4    8:icmpeq          38
		{
			DrawableContainerState drawablecontainerstate = mDrawableContainerState;
	...
	//    8   16:aload_2         
	//    9   17:iload_1         
	//   10   18:putfield        #132 <Field boolean DrawableContainer$DrawableContainerState.mDither>
			Drawable drawable = mCurrDrawable;
	//   11   21:aload_0         
	//   12   22:getfield        #233 <Field Drawable mCurrDrawable>
	//   13   25:astore_3        
	...
	//   16   30:aload_3         
	//   17   31:aload_2         
	//   18   32:getfield        #132 <Field boolean DrawableContainer$DrawableContainerState.mDither>
	//   19   35:invokevirtual   #136 <Method void Drawable.setDither(boolean)>
		}
	//   20   38:return          
	}
	...
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:iload_1         
	//    3    5:putfield        #80  <Field int DrawableContainer$DrawableContainerState.mEnterFadeDuration>
	//    4    8:return          
	}
	...
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:iload_1         
	//    3    5:putfield        #244 <Field int DrawableContainer$DrawableContainerState.mExitFadeDuration>
	//    4    8:return          
	}
	...
	//    6   10:fload_1         
	//    7   11:fload_2         
	//    8   12:invokestatic    #412 <Method void DrawableCompat.setHotspot(Drawable, float, float)>
	//    9   15:return          
	}
	...
	//    5   11:aload_0         
	//    6   12:new             #181 <Class Rect>
	//    7   15:dup             
	//    8   16:iload_1         
	//    9   17:iload_2         
	//   10   18:iload_3         
	//   11   19:iload           4
	//   12   21:invokespecial   #414 <Method void Rect(int, int, int, int)>
	//   13   24:putfield        #179 <Field Rect mHotspotBounds>
		else
	//*  14   27:goto            40
	...
	//   18   34:iload_3         
	//   19   35:iload           4
	//   20   37:invokevirtual   #416 <Method void Rect.set(int, int, int, int)>
		obj = ((Object) (mCurrDrawable));
	//   21   40:aload_0         
	//   22   41:getfield        #233 <Field Drawable mCurrDrawable>
	//   23   44:astore          5
		if(obj != null)
	//*  24   46:aload           5
	//*  25   48:ifnull          61
	...
	//   29   55:iload_3         
	//   30   56:iload           4
	//   31   58:invokestatic    #419 <Method void DrawableCompat.setHotspotBounds(Drawable, int, int, int, int)>
	//   32   61:return          
	}
	...
	//    3    5:aload_2         
	//    4    6:iconst_1        
	//    5    7:putfield        #100 <Field boolean DrawableContainer$DrawableContainerState.mHasTintList>
		if(drawablecontainerstate.mTintList != colorstatelist)
	//*   6   10:aload_2         
	//*   7   11:getfield        #104 <Field ColorStateList DrawableContainer$DrawableContainerState.mTintList>
	//*   8   14:aload_1         
	//*   9   15:if_acmpeq       34
		{
	...
	//   11   19:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   12   22:aload_1         
	//   13   23:putfield        #104 <Field ColorStateList DrawableContainer$DrawableContainerState.mTintList>
			DrawableCompat.setTintList(mCurrDrawable, colorstatelist);
	//   14   26:aload_0         
	//   15   27:getfield        #233 <Field Drawable mCurrDrawable>
	//   16   30:aload_1         
	//   17   31:invokestatic    #110 <Method void DrawableCompat.setTintList(Drawable, ColorStateList)>
		}
	//   18   34:return          
	}
	...
	//    3    5:aload_2         
	//    4    6:iconst_1        
	//    5    7:putfield        #113 <Field boolean DrawableContainer$DrawableContainerState.mHasTintMode>
		if(drawablecontainerstate.mTintMode != mode)
	//*   6   10:aload_2         
	//*   7   11:getfield        #117 <Field android.graphics.PorterDuff$Mode DrawableContainer$DrawableContainerState.mTintMode>
	//*   8   14:aload_1         
	//*   9   15:if_acmpeq       34
		{
	...
	//   11   19:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//   12   22:aload_1         
	//   13   23:putfield        #117 <Field android.graphics.PorterDuff$Mode DrawableContainer$DrawableContainerState.mTintMode>
			DrawableCompat.setTintMode(mCurrDrawable, mode);
	//   14   26:aload_0         
	//   15   27:getfield        #233 <Field Drawable mCurrDrawable>
	//   16   30:aload_1         
	//   17   31:invokestatic    #121 <Method void DrawableCompat.setTintMode(Drawable, android.graphics.PorterDuff$Mode)>
		}
	//   18   34:return          
	}
	...
	//    1    1:iload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #129 <Method boolean Drawable.setVisible(boolean, boolean)>
	//    4    6:istore_3        
		Drawable drawable = mLastDrawable;
	//    5    7:aload_0         
	//    6    8:getfield        #239 <Field Drawable mLastDrawable>
	//    7   11:astore          4
		if(drawable != null)
	//*   8   13:aload           4
	//*   9   15:ifnull          26
	...
	//   11   20:iload_1         
	//   12   21:iload_2         
	//   13   22:invokevirtual   #129 <Method boolean Drawable.setVisible(boolean, boolean)>
	//   14   25:pop             
		drawable = mCurrDrawable;
	//   15   26:aload_0         
	//   16   27:getfield        #233 <Field Drawable mCurrDrawable>
	//   17   30:astore          4
		if(drawable != null)
	//*  18   32:aload           4
	//*  19   34:ifnull          45
	...
	//   21   39:iload_1         
	//   22   40:iload_2         
	//   23   41:invokevirtual   #129 <Method boolean Drawable.setVisible(boolean, boolean)>
	//   24   44:pop             
		return flag2;
	//   25   45:iload_3         
	//   26   46:ireturn         
	...
	//    9   19:aload_0         
	//   10   20:aload_2         
	//   11   21:invokeinterface #425 <Method void android.graphics.drawable.Drawable$Callback.unscheduleDrawable(Drawable, Runnable)>
	//   12   26:return          
	}
	...
	//    1    1:getfield        #77  <Field DrawableContainer$DrawableContainerState mDrawableContainerState>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #429 <Method void DrawableContainer$DrawableContainerState.updateDensity(Resources)>
	//    4    8:return          
	}
