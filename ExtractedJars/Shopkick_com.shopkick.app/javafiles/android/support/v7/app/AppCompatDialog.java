	...
	implements AppCompatCallback
{
	...
	//    1    1:aload_1         
	//    2    2:iconst_0        
	//    3    3:invokespecial   #17  <Method void AppCompatDialog(Context, int)>
	//    4    6:return          
	}
	...
	//    2    2:aload_1         
	//    3    3:iload_2         
	//    4    4:invokestatic    #22  <Method int getThemeResId(Context, int)>
	//    5    7:invokespecial   #23  <Method void Dialog(Context, int)>
		mKeyDispatcher = new android.support.v4.view.KeyEventDispatcher.Component() {
...
;
	//    6   10:aload_0         
	//    7   11:new             #8   <Class AppCompatDialog$1>
	//    8   14:dup             
	//    9   15:aload_0         
	//   10   16:invokespecial   #26  <Method void AppCompatDialog$1(AppCompatDialog)>
	//   11   19:putfield        #28  <Field android.support.v4.view.KeyEventDispatcher$Component mKeyDispatcher>
	...
	//    4    4:invokespecial   #45  <Method void Dialog(Context, boolean, android.content.DialogInterface$OnCancelListener)>
		mKeyDispatcher = new _cls1();
	//    5    7:aload_0         
	//    6    8:new             #8   <Class AppCompatDialog$1>
	//    7   11:dup             
	//    8   12:aload_0         
	//    9   13:invokespecial   #26  <Method void AppCompatDialog$1(AppCompatDialog)>
	//   10   16:putfield        #28  <Field android.support.v4.view.KeyEventDispatcher$Component mKeyDispatcher>
	//   11   19:return          
	}
	...
	//    3    7:astore_2        
		return KeyEventDispatcher.dispatchKeyEvent(mKeyDispatcher, view, ((android.view.Window.Callback) (this)), keyevent);
	//    4    8:aload_0         
	//    5    9:getfield        #28  <Field android.support.v4.view.KeyEventDispatcher$Component mKeyDispatcher>
	//    6   12:aload_2         
	//    7   13:aload_0         
	//    8   14:aload_1         
	//    9   15:invokestatic    #92  <Method boolean KeyEventDispatcher.dispatchKeyEvent(android.support.v4.view.KeyEventDispatcher$Component, View, android.view.Window$Callback, KeyEvent)>
	//   10   18:ireturn         
	}
	...
	//    1    1:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #98  <Method View AppCompatDelegate.findViewById(int)>
	//    4    8:areturn         
	}
	...
	public AppCompatDelegate getDelegate()
	{
		if(mDelegate == null)
	//*   0    0:aload_0         
	//*   1    1:getfield        #104 <Field AppCompatDelegate mDelegate>
	//*   2    4:ifnonnull       16
			mDelegate = AppCompatDelegate.create(((Dialog) (this)), ((AppCompatCallback) (this)));
	//    3    7:aload_0         
	//    4    8:aload_0         
	//    5    9:aload_0         
	//    6   10:invokestatic    #108 <Method AppCompatDelegate AppCompatDelegate.create(Dialog, AppCompatCallback)>
	//    7   13:putfield        #104 <Field AppCompatDelegate mDelegate>
		return mDelegate;
	//    8   16:aload_0         
	//    9   17:getfield        #104 <Field AppCompatDelegate mDelegate>
	//   10   20:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    2    4:invokevirtual   #112 <Method ActionBar AppCompatDelegate.getSupportActionBar()>
	//    3    7:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    2    4:invokevirtual   #122 <Method void AppCompatDelegate.installViewFactory()>
		super.onCreate(bundle);
	//    3    7:aload_0         
	//    4    8:aload_1         
	//    5    9:invokespecial   #123 <Method void Dialog.onCreate(Bundle)>
	...
	protected void onStop()
	{
		super.onStop();
	//    0    0:aload_0         
	//    1    1:invokespecial   #126 <Method void Dialog.onStop()>
		getDelegate().onStop();
	//    2    4:aload_0         
	//    3    5:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    4    8:invokevirtual   #127 <Method void AppCompatDelegate.onStop()>
	//    5   11:return          
	}
	...
	//    1    1:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #137 <Method void AppCompatDelegate.setContentView(int)>
	//    4    8:return          
	}
	...
	//    1    1:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #140 <Method void AppCompatDelegate.setContentView(View)>
	//    4    8:return          
	}
	...
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:invokevirtual   #142 <Method void AppCompatDelegate.setContentView(View, android.view.ViewGroup$LayoutParams)>
	//    5    9:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #145 <Method void Dialog.setTitle(int)>
		getDelegate().setTitle(((CharSequence) (getContext().getString(i))));
	//    3    5:aload_0         
	//    4    6:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    5    9:aload_0         
	//    6   10:invokevirtual   #149 <Method Context getContext()>
	//    7   13:iload_1         
	//    8   14:invokevirtual   #153 <Method String Context.getString(int)>
	//    9   17:invokevirtual   #156 <Method void AppCompatDelegate.setTitle(CharSequence)>
	//   10   20:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #157 <Method void Dialog.setTitle(CharSequence)>
		getDelegate().setTitle(charsequence);
	//    3    5:aload_0         
	//    4    6:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    5    9:aload_1         
	//    6   10:invokevirtual   #156 <Method void AppCompatDelegate.setTitle(CharSequence)>
	//    7   13:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #160 <Method boolean Dialog.dispatchKeyEvent(KeyEvent)>
	//    3    5:ireturn         
	}
	...
	//    1    1:invokevirtual   #32  <Method AppCompatDelegate getDelegate()>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #165 <Method boolean AppCompatDelegate.requestWindowFeature(int)>
	//    4    8:ireturn         
	}
