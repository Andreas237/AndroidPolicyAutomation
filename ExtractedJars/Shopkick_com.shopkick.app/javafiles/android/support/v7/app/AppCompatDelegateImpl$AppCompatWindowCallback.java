...
class AppCompatDelegateImpl$AppCompatWindowCallback extends WindowCallbackWrapper
{
	...
	//    9   20:aload_0         
	//   10   21:aload_1         
	//   11   22:invokevirtual   #98  <Method ActionMode startAsSupportActionMode(android.view.ActionMode$Callback)>
	//   12   25:areturn         
		else
			return super.onWindowStartingActionMode(callback);
	//   13   26:aload_0         
	//   14   27:aload_1         
	//   15   28:invokespecial   #100 <Method ActionMode WindowCallbackWrapper.onWindowStartingActionMode(android.view.ActionMode$Callback)>
	//   16   31:areturn         
	}
	...
	//    7   17:aload_0         
	//    8   18:aload_1         
	//    9   19:invokevirtual   #98  <Method ActionMode startAsSupportActionMode(android.view.ActionMode$Callback)>
	//   10   22:areturn         
		else
	...
	//   12   24:aload_1         
	//   13   25:iload_2         
	//   14   26:invokespecial   #104 <Method ActionMode WindowCallbackWrapper.onWindowStartingActionMode(android.view.ActionMode$Callback, int)>
	//   15   29:areturn         
	}
	...
	//    4    8:getfield        #110 <Field android.content.Context AppCompatDelegateImpl.mContext>
	//    5   11:aload_1         
	//    6   12:invokespecial   #113 <Method void android.support.v7.view.SupportActionModeWrapper$CallbackWrapper(android.content.Context, android.view.ActionMode$Callback)>
	//    7   15:astore_1        
	...
	//   10   20:aload_1         
	//   11   21:invokevirtual   #117 <Method android.support.v7.view.ActionMode AppCompatDelegateImpl.startSupportActionMode(android.support.v7.view.ActionMode$Callback)>
	//   12   24:astore_2        
		if(actionmode != null)
	//*  13   25:aload_2         
	//*  14   26:ifnull          35
	...
	//   15   29:aload_1         
	//   16   30:aload_2         
	//   17   31:invokevirtual   #121 <Method ActionMode android.support.v7.view.SupportActionModeWrapper$CallbackWrapper.getActionModeWrapper(android.support.v7.view.ActionMode)>
	//   18   34:areturn         
		else
			return null;
	//   19   35:aconst_null     
