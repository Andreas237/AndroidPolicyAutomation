...
class ToolbarActionBar extends ActionBar
{
	...
	//   11   19:iand            
	//   12   20:ior             
	//   13   21:invokeinterface #328 <Method void DecorToolbar.setDisplayOptions(int)>
	//   14   26:return          
	}
	...
	//    3    5:aload_0         
	//    4    6:getfield        #57  <Field DecorToolbar mDecorToolbar>
	//    5    9:iload_1         
	//    6   10:invokeinterface #381 <Method void DecorToolbar.setNavigationMode(int)>
			return;
	//    7   15:return          
		} else
		{
			throw new IllegalArgumentException("Tabs not supported in this configuration");
	//    8   16:new             #383 <Class IllegalArgumentException>
	//    9   19:dup             
	//   10   20:ldc2            #385 <String "Tabs not supported in this configuration">
	//   11   23:invokespecial   #386 <Method void IllegalArgumentException(String)>
	//   12   26:athrow          
		}
	}
	...
	//    5   13:aload_0         
	//    6   14:getfield        #57  <Field DecorToolbar mDecorToolbar>
	//    7   17:iload_1         
	//    8   18:invokeinterface #392 <Method void DecorToolbar.setDropdownSelectedPosition(int)>
			return;
	//    9   23:return          
		} else
		{
			throw new IllegalStateException("setSelectedNavigationIndex not valid for current navigation mode");
	//   10   24:new             #394 <Class IllegalStateException>
	//   11   27:dup             
	//   12   28:ldc2            #396 <String "setSelectedNavigationIndex not valid for current navigation mode">
	//   13   31:invokespecial   #397 <Method void IllegalStateException(String)>
	//   14   34:athrow          
		}
	}
	...
	//    5    9:aload_3         
	//    6   10:invokeinterface #175 <Method Context DecorToolbar.getContext()>
	//    7   15:iload_1         
	//    8   16:invokevirtual   #407 <Method CharSequence Context.getText(int)>
	//    9   19:astore_2        
		else
	//*  10   20:goto            25
			charsequence = null;
	...
	//   13   25:aload_3         
	//   14   26:aload_2         
	//   15   27:invokeinterface #409 <Method void DecorToolbar.setSubtitle(CharSequence)>
	//   16   32:return          
	}
	...
	//   13   25:aload_3         
	//   14   26:aload_2         
	//   15   27:invokeinterface #412 <Method void DecorToolbar.setTitle(CharSequence)>
	//   16   32:return          
	}
