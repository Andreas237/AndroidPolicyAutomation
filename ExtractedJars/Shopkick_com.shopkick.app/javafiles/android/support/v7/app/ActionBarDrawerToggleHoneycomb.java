...
class ActionBarDrawerToggleHoneycomb
{
	static class SetIndicatorInfo
	{
		...
		//*  25   46:aload_1         
		//*  26   47:ldc1            #42  <Int 0x102002c>
		//*  27   49:invokevirtual   #48  <Method View Activity.findViewById(int)>
		//*  28   52:astore_1        
		//*  29   53:aload_1         
		//*  30   54:ifnonnull       58
		//*  31   57:return          
		...
		//*  41   75:aload_2         
		//*  42   76:iconst_0        
		//*  43   77:invokevirtual   #63  <Method View ViewGroup.getChildAt(int)>
		//*  44   80:astore_1        
		//*  45   81:aload_2         
		//*  46   82:iconst_1        
		//*  47   83:invokevirtual   #63  <Method View ViewGroup.getChildAt(int)>
		//*  48   86:astore_2        
		//*  49   87:aload_1         
		//*  50   88:invokevirtual   #66  <Method int View.getId()>
		//*  51   91:ldc1            #42  <Int 0x102002c>
		//*  52   93:icmpne          101
		//*  53   96:aload_2         
		//*  54   97:astore_1        
		//*  55   98:goto            101
		//*  56  101:aload_1         
		//*  57  102:instanceof      #68  <Class ImageView>
		//*  58  105:ifeq            116
		//*  59  108:aload_0         
		//*  60  109:aload_1         
		//*  61  110:checkcast       #68  <Class ImageView>
		//*  62  113:putfield        #70  <Field ImageView upIndicatorView>
		//*  63  116:return          
	...
	//    0    0:aload_0         
	//    1    1:getstatic       #18  <Field int[] THEME_ATTRS>
	//    2    4:invokevirtual   #30  <Method TypedArray Activity.obtainStyledAttributes(int[])>
	//    3    7:astore_0        
		Drawable drawable = ((TypedArray) (activity)).getDrawable(0);
	//    4    8:aload_0         
	//    5    9:iconst_0        
	//    6   10:invokevirtual   #36  <Method Drawable TypedArray.getDrawable(int)>
	//    7   13:astore_1        
		((TypedArray) (activity)).recycle();
	//    8   14:aload_0         
	//    9   15:invokevirtual   #39  <Method void TypedArray.recycle()>
		return drawable;
	//   10   18:aload_1         
	//   11   19:areturn         
	}
	...
	//    5    9:dup             
	//    6   10:aload_1         
	//    7   11:invokespecial   #46  <Method void ActionBarDrawerToggleHoneycomb$SetIndicatorInfo(Activity)>
	//    8   14:astore_3        
		if(setindicatorinfo1.setHomeAsUpIndicator == null)
			break MISSING_BLOCK_LABEL_75;
	//    9   15:aload_3         
	//   10   16:getfield        #50  <Field Method ActionBarDrawerToggleHoneycomb$SetIndicatorInfo.setHomeAsUpIndicator>
	//   11   19:ifnull          75
		setindicatorinfo = ((SetIndicatorInfo) (activity.getActionBar()));
	//   12   22:aload_1         
	//   13   23:invokevirtual   #54  <Method ActionBar Activity.getActionBar()>
	//   14   26:astore_0        
		setindicatorinfo1.setHomeActionContentDescription.invoke(((Object) (setindicatorinfo)), new Object[] {
			Integer.valueOf(i)
		});
	//   15   27:aload_3         
	//   16   28:getfield        #57  <Field Method ActionBarDrawerToggleHoneycomb$SetIndicatorInfo.setHomeActionContentDescription>
	//   17   31:aload_0         
	//   18   32:iconst_1        
	...
	//   21   37:iconst_0        
	//   22   38:iload_2         
	//   23   39:invokestatic    #63  <Method Integer Integer.valueOf(int)>
	//   24   42:aastore         
	//   25   43:invokevirtual   #69  <Method Object Method.invoke(Object, Object[])>
	//   26   46:pop             
		if(android.os.Build.VERSION.SDK_INT > 19)
			break MISSING_BLOCK_LABEL_75;
	//   27   47:getstatic       #75  <Field int android.os.Build$VERSION.SDK_INT>
	//   28   50:bipush          19
	//   29   52:icmpgt          75
		((ActionBar) (setindicatorinfo)).setSubtitle(((ActionBar) (setindicatorinfo)).getSubtitle());
	//   30   55:aload_0         
	//   31   56:aload_0         
	//   32   57:invokevirtual   #81  <Method CharSequence ActionBar.getSubtitle()>
	//   33   60:invokevirtual   #85  <Method void ActionBar.setSubtitle(CharSequence)>
	...
	//   37   66:ldc1            #11  <String "ActionBarDrawerToggleHC">
	//   38   68:ldc1            #87  <String "Couldn't set content description via JB-MR2 API">
	//   39   70:aload_0         
	//   40   71:invokestatic    #93  <Method int Log.w(String, String, Throwable)>
	//   41   74:pop             
		return setindicatorinfo1;
	//   42   75:aload_3         
	//   43   76:areturn         
	...
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokespecial   #46  <Method void ActionBarDrawerToggleHoneycomb$SetIndicatorInfo(Activity)>
	//    4    8:astore_0        
		if(setindicatorinfo.setHomeAsUpIndicator != null)
	//*   5    9:aload_0         
	//*   6   10:getfield        #50  <Field Method ActionBarDrawerToggleHoneycomb$SetIndicatorInfo.setHomeAsUpIndicator>
	//*   7   13:ifnull          72
		{
			try
			{
	...
	//    8   16:aload_1         
	//    9   17:invokevirtual   #54  <Method ActionBar Activity.getActionBar()>
	//   10   20:astore_1        
				setindicatorinfo.setHomeAsUpIndicator.invoke(((Object) (activity)), new Object[] {
					drawable
				});
	//   11   21:aload_0         
	//   12   22:getfield        #50  <Field Method ActionBarDrawerToggleHoneycomb$SetIndicatorInfo.setHomeAsUpIndicator>
	//   13   25:aload_1         
	//   14   26:iconst_1        
	...
	//   18   32:aload_2         
	//   19   33:aastore         
	//   20   34:invokevirtual   #69  <Method Object Method.invoke(Object, Object[])>
	//   21   37:pop             
				setindicatorinfo.setHomeActionContentDescription.invoke(((Object) (activity)), new Object[] {
					Integer.valueOf(i)
				});
	//   22   38:aload_0         
	//   23   39:getfield        #57  <Field Method ActionBarDrawerToggleHoneycomb$SetIndicatorInfo.setHomeActionContentDescription>
	//   24   42:aload_1         
	//   25   43:iconst_1        
	...
	//   28   48:iconst_0        
	//   29   49:iload_3         
	//   30   50:invokestatic    #63  <Method Integer Integer.valueOf(int)>
	//   31   53:aastore         
	//   32   54:invokevirtual   #69  <Method Object Method.invoke(Object, Object[])>
	//   33   57:pop             
			}
	//*  34   58:aload_0         
	//*  35   59:areturn         
	...
	//   37   61:ldc1            #11  <String "ActionBarDrawerToggleHC">
	//   38   63:ldc1            #97  <String "Couldn't set home-as-up indicator via JB-MR2 API">
	//   39   65:aload_1         
	//   40   66:invokestatic    #93  <Method int Log.w(String, String, Throwable)>
	//   41   69:pop             
	...
	//*  44   72:aload_0         
	//*  45   73:getfield        #101 <Field ImageView ActionBarDrawerToggleHoneycomb$SetIndicatorInfo.upIndicatorView>
	//*  46   76:ifnull          89
		{
			setindicatorinfo.upIndicatorView.setImageDrawable(drawable);
	//   47   79:aload_0         
	//   48   80:getfield        #101 <Field ImageView ActionBarDrawerToggleHoneycomb$SetIndicatorInfo.upIndicatorView>
	//   49   83:aload_2         
	//   50   84:invokevirtual   #107 <Method void ImageView.setImageDrawable(Drawable)>
			return setindicatorinfo;
	//   51   87:aload_0         
	//   52   88:areturn         
		} else
	...
	//   53   89:ldc1            #11  <String "ActionBarDrawerToggleHC">
	//   54   91:ldc1            #109 <String "Couldn't set home-as-up indicator">
	//   55   93:invokestatic    #112 <Method int Log.w(String, String)>
	//   56   96:pop             
			return setindicatorinfo;
	//   57   97:aload_0         
	//   58   98:areturn         
