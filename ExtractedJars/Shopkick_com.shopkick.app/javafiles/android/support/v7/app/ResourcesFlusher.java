...
class ResourcesFlusher
{
	...
	//*   4    9:getstatic       #33  <Field int android.os.Build$VERSION.SDK_INT>
	//*   5   12:bipush          24
	//*   6   14:icmplt          22
		{
			flushNougats(resources);
	//    7   17:aload_0         
	//    8   18:invokestatic    #36  <Method void flushNougats(Resources)>
			return;
	//    9   21:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  10   22:getstatic       #33  <Field int android.os.Build$VERSION.SDK_INT>
	//*  11   25:bipush          23
	//*  12   27:icmplt          35
		{
			flushMarshmallows(resources);
	//   13   30:aload_0         
	//   14   31:invokestatic    #39  <Method void flushMarshmallows(Resources)>
			return;
	//   15   34:return          
		}
		if(android.os.Build.VERSION.SDK_INT >= 21)
	//*  16   35:getstatic       #33  <Field int android.os.Build$VERSION.SDK_INT>
	//*  17   38:bipush          21
	//*  18   40:icmplt          47
			flushLollipops(resources);
	//   19   43:aload_0         
	//   20   44:invokestatic    #42  <Method void flushLollipops(Resources)>
	//   21   47:return          
	}
	...
	//   22   48:aload_1         
	//   23   49:aload_0         
	//   24   50:invokevirtual   #82  <Method Object Field.get(Object)>
	//   25   53:checkcast       #84  <Class Map>
	//   26   56:astore_0        
			}
	//*  27   57:goto            72
	...
	//   30   63:ldc1            #86  <String "Could not retrieve value from Resources#mDrawableCache">
	//   31   65:aload_0         
	//   32   66:invokestatic    #78  <Method int Log.e(String, String, Throwable)>
	//   33   69:pop             
				resources = null;
	//   34   70:aconst_null     
	//   35   71:astore_0        
	...
	//*  37   73:ifnull          82
				((Map) (resources)).clear();
	//   38   76:aload_0         
	//   39   77:invokeinterface #89  <Method void Map.clear()>
		}
	//   40   82:return          
	}
	...
	//   19   41:astore_2        
		Field field = sDrawableCacheField;
	//   20   42:getstatic       #64  <Field Field sDrawableCacheField>
	//   21   45:astore_3        
	...
	//   26   52:aload_3         
	//   27   53:aload_0         
	//   28   54:invokevirtual   #82  <Method Object Field.get(Object)>
	//   29   57:astore_1        
			}
	//*  30   58:goto            73
			// Misplaced declaration of an exception variable
	...
	//   33   64:ldc1            #86  <String "Could not retrieve value from Resources#mDrawableCache">
	//   34   66:aload_0         
	//   35   67:invokestatic    #78  <Method int Log.e(String, String, Throwable)>
	//   36   70:pop             
				obj = ((Object) (obj1));
	//   37   71:aload_2         
	//   38   72:astore_1        
	...
	//   42   78:aload_1         
	//   43   79:invokestatic    #95  <Method void flushThemedResourcesCache(Object)>
			return;
	//   44   82:return          
		}
	}
	...
	//   25   51:aload_1         
	//   26   52:aload_0         
	//   27   53:invokevirtual   #82  <Method Object Field.get(Object)>
	//   28   56:astore_0        
		}
	//*  29   57:goto            72
		// Misplaced declaration of an exception variable
	...
	//   32   63:ldc1            #106 <String "Could not retrieve value from Resources#mResourcesImpl">
	//   33   65:aload_0         
	//   34   66:invokestatic    #78  <Method int Log.e(String, String, Throwable)>
	//   35   69:pop             
			resources = null;
	//   36   70:aconst_null     
	//   37   71:astore_0        
	...
	//   40   76:return          
		if(!sDrawableCacheFieldFetched)
	//*  41   77:getstatic       #52  <Field boolean sDrawableCacheFieldFetched>
	//*  42   80:ifne            119
		{
			try
			{
	...
	//   43   83:aload_0         
	//   44   84:invokevirtual   #110 <Method Class Object.getClass()>
	//   45   87:ldc1            #56  <String "mDrawableCache">
	//   46   89:invokevirtual   #62  <Method Field Class.getDeclaredField(String)>
	//   47   92:putstatic       #64  <Field Field sDrawableCacheField>
				sDrawableCacheField.setAccessible(true);
	//   48   95:getstatic       #64  <Field Field sDrawableCacheField>
	//   49   98:iconst_1        
	//   50   99:invokevirtual   #70  <Method void Field.setAccessible(boolean)>
			}
	//*  51  102:goto            115
	...
	//   54  108:ldc1            #112 <String "Could not retrieve ResourcesImpl#mDrawableCache field">
	//   55  110:aload_1         
	//   56  111:invokestatic    #78  <Method int Log.e(String, String, Throwable)>
	//   57  114:pop             
			}
			sDrawableCacheFieldFetched = true;
	//   58  115:iconst_1        
	//   59  116:putstatic       #52  <Field boolean sDrawableCacheFieldFetched>
		}
		Field field = sDrawableCacheField;
	//   60  119:getstatic       #64  <Field Field sDrawableCacheField>
	//   61  122:astore_3        
	...
	//   66  129:aload_3         
	//   67  130:aload_0         
	//   68  131:invokevirtual   #82  <Method Object Field.get(Object)>
	//   69  134:astore_1        
			}
	//*  70  135:goto            150
			// Misplaced declaration of an exception variable
	...
	//   73  141:ldc1            #114 <String "Could not retrieve value from ResourcesImpl#mDrawableCache">
	//   74  143:aload_0         
	//   75  144:invokestatic    #78  <Method int Log.e(String, String, Throwable)>
	//   76  147:pop             
				nosuchfieldexception1 = ((NoSuchFieldException) (obj1));
	//   77  148:aload_2         
	//   78  149:astore_1        
	...
	//   81  154:aload_1         
	//   82  155:invokestatic    #95  <Method void flushThemedResourcesCache(Object)>
	//   83  158:return          
	}
	...
	//*  19   40:getstatic       #131 <Field boolean sThemedResourceCache_mUnthemedEntriesFieldFetched>
	//*  20   43:ifne            79
		{
			try
			{
	...
	//   21   46:aload_1         
	//   22   47:ldc1            #133 <String "mUnthemedEntries">
	//   23   49:invokevirtual   #62  <Method Field Class.getDeclaredField(String)>
	//   24   52:putstatic       #135 <Field Field sThemedResourceCache_mUnthemedEntriesField>
				sThemedResourceCache_mUnthemedEntriesField.setAccessible(true);
	//   25   55:getstatic       #135 <Field Field sThemedResourceCache_mUnthemedEntriesField>
	//   26   58:iconst_1        
	//   27   59:invokevirtual   #70  <Method void Field.setAccessible(boolean)>
			}
	//*  28   62:goto            75
			catch(NoSuchFieldException nosuchfieldexception)
	//*  29   65:astore_1        
	...
	//   31   68:ldc1            #137 <String "Could not retrieve ThemedResourceCache#mUnthemedEntries field">
	//   32   70:aload_1         
	//   33   71:invokestatic    #78  <Method int Log.e(String, String, Throwable)>
	//   34   74:pop             
			}
			sThemedResourceCache_mUnthemedEntriesFieldFetched = true;
	//   35   75:iconst_1        
	//   36   76:putstatic       #131 <Field boolean sThemedResourceCache_mUnthemedEntriesFieldFetched>
		}
		nosuchfieldexception = ((NoSuchFieldException) (sThemedResourceCache_mUnthemedEntriesField));
	//   37   79:getstatic       #135 <Field Field sThemedResourceCache_mUnthemedEntriesField>
	//   38   82:astore_1        
	...
	//   42   88:aload_1         
	//   43   89:aload_0         
	//   44   90:invokevirtual   #82  <Method Object Field.get(Object)>
	//   45   93:checkcast       #139 <Class LongSparseArray>
	//   46   96:astore_0        
		}
	//*  47   97:goto            112
		// Misplaced declaration of an exception variable
	...
	//   50  103:ldc1            #141 <String "Could not retrieve value from ThemedResourceCache#mUnthemedEntries">
	//   51  105:aload_0         
	//   52  106:invokestatic    #78  <Method int Log.e(String, String, Throwable)>
	//   53  109:pop             
			obj = null;
	//   54  110:aconst_null     
	//   55  111:astore_0        
	...
	//   58  116:aload_0         
	//   59  117:invokevirtual   #142 <Method void LongSparseArray.clear()>
	//   60  120:return          
	}
