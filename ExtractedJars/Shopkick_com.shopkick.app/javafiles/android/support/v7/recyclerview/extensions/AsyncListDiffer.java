...
public class AsyncListDiffer
{
	...
	//    2    4:aload_0         
	//    3    5:invokestatic    #46  <Method List Collections.emptyList()>
	//    4    8:putfield        #48  <Field List mReadOnlyList>
		mUpdateCallback = listupdatecallback;
	//    5   11:aload_0         
	//    6   12:aload_1         
	//    7   13:putfield        #50  <Field ListUpdateCallback mUpdateCallback>
		mConfig = asyncdifferconfig;
	//    8   16:aload_0         
	//    9   17:aload_2         
	//   10   18:putfield        #52  <Field AsyncDifferConfig mConfig>
		if(asyncdifferconfig.getMainThreadExecutor() != null)
	//*  11   21:aload_2         
	//*  12   22:invokevirtual   #58  <Method Executor AsyncDifferConfig.getMainThreadExecutor()>
	//*  13   25:ifnull          37
		{
			mMainThreadExecutor = asyncdifferconfig.getMainThreadExecutor();
	//   14   28:aload_0         
	//   15   29:aload_2         
	//   16   30:invokevirtual   #58  <Method Executor AsyncDifferConfig.getMainThreadExecutor()>
	//   17   33:putfield        #60  <Field Executor mMainThreadExecutor>
			return;
	//   18   36:return          
		} else
		{
	...
	//   19   37:aload_0         
	//   20   38:getstatic       #37  <Field Executor sMainThreadExecutor>
	//   21   41:putfield        #60  <Field Executor mMainThreadExecutor>
			return;
	//   22   44:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:new             #66  <Class AdapterListUpdateCallback>
	//    2    4:dup             
	//    3    5:aload_1         
	//    4    6:invokespecial   #69  <Method void AdapterListUpdateCallback(android.support.v7.widget.RecyclerView$Adapter)>
	//    5    9:new             #71  <Class AsyncDifferConfig$Builder>
	//    6   12:dup             
	//    7   13:aload_2         
	//    8   14:invokespecial   #74  <Method void AsyncDifferConfig$Builder(android.support.v7.util.DiffUtil$ItemCallback)>
	//    9   17:invokevirtual   #78  <Method AsyncDifferConfig AsyncDifferConfig$Builder.build()>
	//   10   20:invokespecial   #80  <Method void AsyncListDiffer(ListUpdateCallback, AsyncDifferConfig)>
	//   11   23:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #48  <Field List mReadOnlyList>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #88  <Field List mList>
		mReadOnlyList = Collections.unmodifiableList(list);
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokestatic    #92  <Method List Collections.unmodifiableList(List)>
	//    6   10:putfield        #48  <Field List mReadOnlyList>
		diffresult.dispatchUpdatesTo(mUpdateCallback);
	//    7   13:aload_2         
	//    8   14:aload_0         
	//    9   15:getfield        #50  <Field ListUpdateCallback mUpdateCallback>
	//   10   18:invokevirtual   #98  <Method void android.support.v7.util.DiffUtil$DiffResult.dispatchUpdatesTo(ListUpdateCallback)>
	//   11   21:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #103 <Field int mMaxScheduledGeneration>
	//    2    4:iconst_1        
	//    3    5:iadd            
	//    4    6:istore_2        
	...
	//    5    7:aload_0         
	//    6    8:iload_2         
	//    7    9:putfield        #103 <Field int mMaxScheduledGeneration>
		final List oldList = mList;
	//    8   12:aload_0         
	//    9   13:getfield        #88  <Field List mList>
	//   10   16:astore_3        
		if(newList == oldList)
	//*  11   17:aload_1         
	//*  12   18:aload_3         
	...
	//   17   27:aload_3         
	//   18   28:invokeinterface #109 <Method int List.size()>
	//   19   33:istore_2        
			mList = null;
	//   20   34:aload_0         
	//   21   35:aconst_null     
	//   22   36:putfield        #88  <Field List mList>
			mReadOnlyList = Collections.emptyList();
	//   23   39:aload_0         
	//   24   40:invokestatic    #46  <Method List Collections.emptyList()>
	//   25   43:putfield        #48  <Field List mReadOnlyList>
			mUpdateCallback.onRemoved(0, runGeneration);
	//   26   46:aload_0         
	//   27   47:getfield        #50  <Field ListUpdateCallback mUpdateCallback>
	//   28   50:iconst_0        
	//   29   51:iload_2         
	//   30   52:invokeinterface #115 <Method void ListUpdateCallback.onRemoved(int, int)>
			return;
	//   31   57:return          
		}
		if(oldList == null)
	...
	//   34   62:aload_0         
	//   35   63:aload_1         
	//   36   64:putfield        #88  <Field List mList>
			mReadOnlyList = Collections.unmodifiableList(newList);
	//   37   67:aload_0         
	//   38   68:aload_1         
	//   39   69:invokestatic    #92  <Method List Collections.unmodifiableList(List)>
	//   40   72:putfield        #48  <Field List mReadOnlyList>
			mUpdateCallback.onInserted(0, newList.size());
	//   41   75:aload_0         
	//   42   76:getfield        #50  <Field ListUpdateCallback mUpdateCallback>
	//   43   79:iconst_0        
	//   44   80:aload_1         
	//   45   81:invokeinterface #109 <Method int List.size()>
	//   46   86:invokeinterface #118 <Method void ListUpdateCallback.onInserted(int, int)>
			return;
	//   47   91:return          
		} else
		{
			...
			//    5    9:return          
				...
				//    5   11:astore_1        
					mMainThreadExecutor.execute(((_cls2) (diffresult)). new Runnable() {
	...
	//   48   92:aload_0         
	//   49   93:getfield        #52  <Field AsyncDifferConfig mConfig>
	//   50   96:invokevirtual   #121 <Method Executor AsyncDifferConfig.getBackgroundThreadExecutor()>
	//   51   99:new             #7   <Class AsyncListDiffer$1>
	//   52  102:dup             
	//   53  103:aload_0         
	//   54  104:aload_3         
	//   55  105:aload_1         
	//   56  106:iload_2         
	//   57  107:invokespecial   #124 <Method void AsyncListDiffer$1(AsyncListDiffer, List, List, int)>
	//   58  110:invokeinterface #130 <Method void Executor.execute(Runnable)>
			return;
	//   59  115:return          
		}
	}
	...
	static 
	{
	//    0    0:new             #13  <Class AsyncListDiffer$MainThreadExecutor>
	//    1    3:dup             
	//    2    4:invokespecial   #35  <Method void AsyncListDiffer$MainThreadExecutor()>
	//    3    7:putstatic       #37  <Field Executor sMainThreadExecutor>
	//*   4   10:return          
	}
}
