...
class ThemeUtils
{
	...
	//    0    0:new             #58  <Class ColorStateList>
	//    1    3:dup             
	//    2    4:iconst_2        
	//    3    5:anewarray       int[][]
	//    4    8:dup             
	//    5    9:iconst_0        
	//    6   10:getstatic       #29  <Field int[] DISABLED_STATE_SET>
	//    7   13:aastore         
	//    8   14:dup             
	//    9   15:iconst_1        
	//   10   16:getstatic       #50  <Field int[] EMPTY_STATE_SET>
	//   11   19:aastore         
	//   12   20:iconst_2        
	//   13   21:newarray        int[]
	//   14   23:dup             
	...
	//   20   29:iload_0         
	//   21   30:iastore         
	//   22   31:invokespecial   #62  <Method void ColorStateList(int[][], int[])>
	//   23   34:areturn         
	}
	...
	//    7    9:aconst_null     
	//    8   10:aload_2         
	//    9   11:invokestatic    #113 <Method TintTypedArray TintTypedArray.obtainStyledAttributes(Context, android.util.AttributeSet, int[])>
	//   10   14:astore_0        
		i = ((TintTypedArray) (context)).getColor(0, 0);
	//   11   15:aload_0         
	//   12   16:iconst_0        
	//   13   17:iconst_0        
	//   14   18:invokevirtual   #117 <Method int TintTypedArray.getColor(int, int)>
	//   15   21:istore_1        
		((TintTypedArray) (context)).recycle();
	//   16   22:aload_0         
	//   17   23:invokevirtual   #120 <Method void TintTypedArray.recycle()>
		return i;
	//   18   26:iload_1         
	//   19   27:ireturn         
		Exception exception;
	...
	//   20   28:astore_2        
		((TintTypedArray) (context)).recycle();
	//   21   29:aload_0         
	//   22   30:invokevirtual   #120 <Method void TintTypedArray.recycle()>
		throw exception;
	//   23   33:aload_2         
	//   24   34:athrow          
	}
	...
	//   11   15:aload_0         
	//   12   16:iconst_0        
	//   13   17:invokevirtual   #143 <Method ColorStateList TintTypedArray.getColorStateList(int)>
	//   14   20:astore_2        
		((TintTypedArray) (context)).recycle();
	//   15   21:aload_0         
	//   16   22:invokevirtual   #120 <Method void TintTypedArray.recycle()>
	...
	//   19   27:astore_2        
		((TintTypedArray) (context)).recycle();
	//   20   28:aload_0         
	//   21   29:invokevirtual   #120 <Method void TintTypedArray.recycle()>
		throw exception;
	//   22   32:aload_2         
	//   23   33:athrow          
	}
