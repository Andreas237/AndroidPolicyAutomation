	...
	implements TintableBackgroundView
{
	...
	//    3    5:aload_2         
	//    4    6:iload_3         
	//    5    7:invokespecial   #39  <Method void AutoCompleteTextView(Context, AttributeSet, int)>
	...
	//    0    0:aload_0         
	//    1    1:invokespecial   #89  <Method void AutoCompleteTextView.drawableStateChanged()>
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #101 <Method ColorStateList AppCompatBackgroundHelper.getSupportBackgroundTintList()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #106 <Method android.graphics.PorterDuff$Mode AppCompatBackgroundHelper.getSupportBackgroundTintMode()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #110 <Method InputConnection AutoCompleteTextView.onCreateInputConnection(EditorInfo)>
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:invokestatic    #115 <Method InputConnection AppCompatHintHelper.onCreateInputConnection(InputConnection, EditorInfo, android.view.View)>
	//    6   10:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #118 <Method void AutoCompleteTextView.setBackgroundDrawable(Drawable)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	...
	//    8   14:aload_2         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #121 <Method void AppCompatBackgroundHelper.onSetBackgroundDrawable(Drawable)>
	//   11   19:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #126 <Method void AutoCompleteTextView.setBackgroundResource(int)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	//    4    6:getfield        #71  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    5    9:astore_2        
	...
	//    8   14:aload_2         
	//    9   15:iload_1         
	//   10   16:invokevirtual   #129 <Method void AppCompatBackgroundHelper.onSetBackgroundResource(int)>
	//   11   19:return          
	}
	...
	//    1    1:aload_0         
	//    2    2:aload_1         
	//    3    3:invokestatic    #138 <Method android.view.ActionMode$Callback TextViewCompat.wrapCustomSelectionActionModeCallback(android.widget.TextView, android.view.ActionMode$Callback)>
	//    4    6:invokespecial   #140 <Method void AutoCompleteTextView.setCustomSelectionActionModeCallback(android.view.ActionMode$Callback)>
	//    5    9:return          
	}
	...
	//    3    5:iload_1         
	//    4    6:invokestatic    #146 <Method Drawable AppCompatResources.getDrawable(Context, int)>
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #150 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintList(ColorStateList)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #154 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintMode(android.graphics.PorterDuff$Mode)>
	//    8   14:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #158 <Method void AutoCompleteTextView.setTextAppearance(Context, int)>
	...
	//   10   16:aload_1         
	//   11   17:iload_2         
	//   12   18:invokevirtual   #161 <Method void AppCompatTextHelper.onSetTextAppearance(Context, int)>
	//   13   21:return          
	}
