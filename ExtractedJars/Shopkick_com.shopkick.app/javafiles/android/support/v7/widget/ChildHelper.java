...
class ChildHelper
{
	...
	//*   6   12:iflt            29
		{
			mBucket.set(i);
	//    7   15:aload_0         
	//    8   16:getfield        #34  <Field ChildHelper$Bucket mBucket>
	//    9   19:iload_2         
	//   10   20:invokevirtual   #138 <Method void ChildHelper$Bucket.set(int)>
			hideViewInternal(view);
	//   11   23:aload_0         
	//   12   24:aload_1         
	//   13   25:invokespecial   #82  <Method void hideViewInternal(View)>
			return;
	//   14   28:return          
		} else
		{
			StringBuilder stringbuilder = new StringBuilder();
	//   15   29:new             #140 <Class StringBuilder>
	//   16   32:dup             
	//   17   33:invokespecial   #141 <Method void StringBuilder()>
	//   18   36:astore_3        
			stringbuilder.append("view is not a child, cannot hide ");
	//   19   37:aload_3         
	//   20   38:ldc1            #143 <String "view is not a child, cannot hide ">
	//   21   40:invokevirtual   #147 <Method StringBuilder StringBuilder.append(String)>
	//   22   43:pop             
			stringbuilder.append(((Object) (view)));
	//   23   44:aload_3         
	//   24   45:aload_1         
	//   25   46:invokevirtual   #150 <Method StringBuilder StringBuilder.append(Object)>
	//   26   49:pop             
			throw new IllegalArgumentException(stringbuilder.toString());
	//   27   50:new             #152 <Class IllegalArgumentException>
	//   28   53:dup             
	//   29   54:aload_3         
	//   30   55:invokevirtual   #156 <Method String StringBuilder.toString()>
	//   31   58:invokespecial   #159 <Method void IllegalArgumentException(String)>
	//   32   61:athrow          
		}
	}
	...
	//    4    8:aload_1         
	//    5    9:aload_0         
	//    6   10:getfield        #34  <Field ChildHelper$Bucket mBucket>
	//    7   13:invokevirtual   #180 <Method String ChildHelper$Bucket.toString()>
	//    8   16:invokevirtual   #147 <Method StringBuilder StringBuilder.append(String)>
	//    9   19:pop             
		stringbuilder.append(", hidden list:");
	//   10   20:aload_1         
	//   11   21:ldc1            #182 <String ", hidden list:">
	//   12   23:invokevirtual   #147 <Method StringBuilder StringBuilder.append(String)>
	//   13   26:pop             
		stringbuilder.append(mHiddenViews.size());
	//   14   27:aload_1         
	//   15   28:aload_0         
	//   16   29:getfield        #39  <Field List mHiddenViews>
	//   17   32:invokeinterface #104 <Method int List.size()>
	//   18   37:invokevirtual   #185 <Method StringBuilder StringBuilder.append(int)>
	//   19   40:pop             
		return stringbuilder.toString();
	//   20   41:aload_1         
	//   21   42:invokevirtual   #156 <Method String StringBuilder.toString()>
	//   22   45:areturn         
	}
	...
	//*   8   16:getfield        #34  <Field ChildHelper$Bucket mBucket>
	//*   9   19:iload_2         
	//*  10   20:invokevirtual   #53  <Method boolean ChildHelper$Bucket.get(int)>
	//*  11   23:ifeq            41
			{
				mBucket.clear(i);
	//   12   26:aload_0         
	//   13   27:getfield        #34  <Field ChildHelper$Bucket mBucket>
	//   14   30:iload_2         
	//   15   31:invokevirtual   #189 <Method void ChildHelper$Bucket.clear(int)>
				unhideViewInternal(view);
	//   16   34:aload_0         
	//   17   35:aload_1         
	//   18   36:invokespecial   #175 <Method boolean unhideViewInternal(View)>
	//   19   39:pop             
				return;
	//   20   40:return          
			} else
			{
				StringBuilder stringbuilder = new StringBuilder();
	//   21   41:new             #140 <Class StringBuilder>
	//   22   44:dup             
	//   23   45:invokespecial   #141 <Method void StringBuilder()>
	//   24   48:astore_3        
				stringbuilder.append("trying to unhide a view that was not hidden");
	//   25   49:aload_3         
	//   26   50:ldc1            #191 <String "trying to unhide a view that was not hidden">
	//   27   52:invokevirtual   #147 <Method StringBuilder StringBuilder.append(String)>
	//   28   55:pop             
				stringbuilder.append(((Object) (view)));
	//   29   56:aload_3         
	//   30   57:aload_1         
	//   31   58:invokevirtual   #150 <Method StringBuilder StringBuilder.append(Object)>
	//   32   61:pop             
				throw new RuntimeException(stringbuilder.toString());
	//   33   62:new             #193 <Class RuntimeException>
	//   34   65:dup             
	//   35   66:aload_3         
	//   36   67:invokevirtual   #156 <Method String StringBuilder.toString()>
	//   37   70:invokespecial   #194 <Method void RuntimeException(String)>
	//   38   73:athrow          
			}
		} else
		{
			StringBuilder stringbuilder1 = new StringBuilder();
	//   39   74:new             #140 <Class StringBuilder>
	//   40   77:dup             
	//   41   78:invokespecial   #141 <Method void StringBuilder()>
	//   42   81:astore_3        
			stringbuilder1.append("view is not a child, cannot hide ");
	//   43   82:aload_3         
	//   44   83:ldc1            #143 <String "view is not a child, cannot hide ">
	//   45   85:invokevirtual   #147 <Method StringBuilder StringBuilder.append(String)>
	//   46   88:pop             
			stringbuilder1.append(((Object) (view)));
	//   47   89:aload_3         
	//   48   90:aload_1         
	//   49   91:invokevirtual   #150 <Method StringBuilder StringBuilder.append(Object)>
	//   50   94:pop             
			throw new IllegalArgumentException(stringbuilder1.toString());
	//   51   95:new             #152 <Class IllegalArgumentException>
	//   52   98:dup             
	//   53   99:aload_3         
	//   54  100:invokevirtual   #156 <Method String StringBuilder.toString()>
	//   55  103:invokespecial   #159 <Method void IllegalArgumentException(String)>
	//   56  106:athrow          
		}
	}
