	...
	implements MenuItemHoverListener
{
	...
	//    6   10:aload_1         
	//    7   11:aload_2         
	//    8   12:invokeinterface #72  <Method void MenuItemHoverListener.onItemHoverEnter(MenuBuilder, MenuItem)>
	//    9   17:return          
	}
	...
	//    6   10:aload_1         
	//    7   11:aload_2         
	//    8   12:invokeinterface #76  <Method void MenuItemHoverListener.onItemHoverExit(MenuBuilder, MenuItem)>
	//    9   17:return          
	}
	...
	//    4    8:aload_2         
	//    5    9:aload_0         
	//    6   10:getfield        #88  <Field PopupWindow mPopup>
	//    7   13:iconst_1        
	//    8   14:anewarray       Object[]
	//    9   17:dup             
	//   10   18:iconst_0        
	//   11   19:iload_1         
	//   12   20:invokestatic    #105 <Method Boolean Boolean.valueOf(boolean)>
	//   13   23:aastore         
	//   14   24:invokevirtual   #111 <Method Object Method.invoke(Object, Object[])>
	//   15   27:pop             
				return;
	//   16   28:return          
			}
	//*  17   29:ldc1            #17  <String "MenuPopupWindow">
	//*  18   31:ldc1            #113 <String "Could not invoke setTouchModal() on PopupWindow. Oh well.">
	//*  19   33:invokestatic    #51  <Method int Log.i(String, String)>
	//*  20   36:pop             
	//*  21   37:return          
	...
	//*  11   21:ldc1            #17  <String "MenuPopupWindow">
	//*  12   23:ldc1            #45  <String "Could not find method setTouchModal() on PopupWindow. Oh well.">
	//*  13   25:invokestatic    #51  <Method int Log.i(String, String)>
	//*  14   28:pop             
	//*  15   29:return          
		// Misplaced declaration of an exception variable
