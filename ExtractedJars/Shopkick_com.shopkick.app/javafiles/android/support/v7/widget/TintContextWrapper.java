...
public class TintContextWrapper extends ContextWrapper
{
	...
	//*   6    8:ifne            51
	//*   7   11:aload_0         
	//*   8   12:invokevirtual   #43  <Method Resources Context.getResources()>
	//*   9   15:instanceof      #67  <Class TintResources>
	//*  10   18:ifne            51
		{
			if(context.getResources() instanceof VectorEnabledTintResources)
	//*  11   21:aload_0         
	//*  12   22:invokevirtual   #43  <Method Resources Context.getResources()>
	//*  13   25:instanceof      #33  <Class VectorEnabledTintResources>
	//*  14   28:ifeq            33
				return false;
	//   15   31:iconst_0        
	//   16   32:ireturn         
			if(android.os.Build.VERSION.SDK_INT < 21 || VectorEnabledTintResources.shouldBeUsed())
	//*  17   33:getstatic       #77  <Field int android.os.Build$VERSION.SDK_INT>
	//*  18   36:bipush          21
	//*  19   38:icmplt          47
	//*  20   41:invokestatic    #37  <Method boolean VectorEnabledTintResources.shouldBeUsed()>
	//*  21   44:ifeq            49
				flag = true;
	//   22   47:iconst_1        
	//   23   48:istore_1        
...
_L5:
	...
	//   66  136:dup             
	//   67  137:aload_0         
	//   68  138:invokespecial   #107 <Method void TintContextWrapper(Context)>
	//   69  141:astore_0        
		sCache.add(((Object) (new WeakReference(((Object) (context))))));
	//   70  142:getstatic       #83  <Field ArrayList sCache>
	//   71  145:new             #96  <Class WeakReference>
	//   72  148:dup             
	//   73  149:aload_0         
	//   74  150:invokespecial   #110 <Method void WeakReference(Object)>
	//   75  153:invokevirtual   #114 <Method boolean ArrayList.add(Object)>
	//   76  156:pop             
		obj1;
	//   77  157:aload_3         
		JVM INSTR monitorexit ;
...
_L13:
	...
	//    7   11:aload_0         
	//    8   12:invokespecial   #119 <Method android.content.res.Resources$Theme ContextWrapper.getTheme()>
	//    9   15:astore_1        
		return theme;
	//   10   16:aload_1         
	//   11   17:areturn         
	...
	//    5    9:aload_0         
	//    6   10:iload_1         
	//    7   11:invokespecial   #123 <Method void ContextWrapper.setTheme(int)>
			return;
	//    8   14:return          
		} else
		{
	...
	//   10   16:iload_1         
	//   11   17:iconst_1        
	//   12   18:invokevirtual   #127 <Method void android.content.res.Resources$Theme.applyStyle(int, boolean)>
			return;
	//   13   21:return          
		}
	}
