...
public abstract class SnapHelper extends RecyclerView.OnFlingListener
{
	...
	//    4   10:aload_0         
	//    5   11:getfield        #30  <Field RecyclerView mRecyclerView>
	//    6   14:aload_0         
	//    7   15:getfield        #26  <Field RecyclerView$OnScrollListener mScrollListener>
	//    8   18:invokevirtual   #50  <Method void RecyclerView.addOnScrollListener(RecyclerView$OnScrollListener)>
			mRecyclerView.setOnFlingListener(((RecyclerView.OnFlingListener) (this)));
	//    9   21:aload_0         
	//   10   22:getfield        #30  <Field RecyclerView mRecyclerView>
	//   11   25:aload_0         
	//   12   26:invokevirtual   #40  <Method void RecyclerView.setOnFlingListener(RecyclerView$OnFlingListener)>
			return;
	//   13   29:return          
		} else
		{
			throw new IllegalStateException("An instance of OnFlingListener already set.");
	//   14   30:new             #43  <Class IllegalStateException>
	//   15   33:dup             
	//   16   34:ldc1            #52  <String "An instance of OnFlingListener already set.">
	//   17   36:invokespecial   #55  <Method void IllegalStateException(String)>
	//   18   39:athrow          
		}
	}
	...
	//*   8   12:ifnull          19
			destroyCallbacks();
	//    9   15:aload_0         
	//   10   16:invokespecial   #87  <Method void destroyCallbacks()>
		mRecyclerView = recyclerview;
	//   11   19:aload_0         
	//   12   20:aload_1         
	//   13   21:putfield        #30  <Field RecyclerView mRecyclerView>
		if(mRecyclerView != null)
	//*  14   24:aload_0         
	//*  15   25:getfield        #30  <Field RecyclerView mRecyclerView>
	//*  16   28:ifnull          64
		{
			setupCallbacks();
	//   17   31:aload_0         
	//   18   32:invokespecial   #89  <Method void setupCallbacks()>
			mGravityScroller = new Scroller(mRecyclerView.getContext(), ((android.view.animation.Interpolator) (new DecelerateInterpolator())));
	//   19   35:aload_0         
	//   20   36:new             #91  <Class Scroller>
	//   21   39:dup             
	//   22   40:aload_0         
	//   23   41:getfield        #30  <Field RecyclerView mRecyclerView>
	//   24   44:invokevirtual   #95  <Method Context RecyclerView.getContext()>
	//   25   47:new             #97  <Class DecelerateInterpolator>
	//   26   50:dup             
	//   27   51:invokespecial   #98  <Method void DecelerateInterpolator()>
	//   28   54:invokespecial   #101 <Method void Scroller(Context, android.view.animation.Interpolator)>
	//   29   57:putfield        #103 <Field Scroller mGravityScroller>
			snapToTargetExistingView();
	//   30   60:aload_0         
	//   31   61:invokevirtual   #106 <Method void snapToTargetExistingView()>
		}
	//   32   64:return          
	}
...
label0:
	...
	//*  10   19:aload_0         
	//*  11   20:getfield        #30  <Field RecyclerView mRecyclerView>
	//*  12   23:invokevirtual   #145 <Method RecyclerView$Adapter RecyclerView.getAdapter()>
	//*  13   26:ifnonnull       31
				return false;
	//   14   29:iconst_0        
	//   15   30:ireturn         
	...
	//   16   31:aload_0         
	//   17   32:getfield        #30  <Field RecyclerView mRecyclerView>
	//   18   35:invokevirtual   #148 <Method int RecyclerView.getMinFlingVelocity()>
	//   19   38:istore_3        
			if(Math.abs(j) <= k)
	//*  20   39:iload_2         
	//*  21   40:invokestatic    #154 <Method int Math.abs(int)>
	//*  22   43:iload_3         
	//*  23   44:icmpgt          59
			{
				flag = flag1;
	...
	//   25   49:istore          4
				if(Math.abs(i) <= k)
					break label0;
	//   26   51:iload_1         
	//   27   52:invokestatic    #154 <Method int Math.abs(int)>
	//   28   55:iload_3         
	//   29   56:icmple          77
			}
			flag = flag1;
	...
	//*  34   66:iload_1         
	//*  35   67:iload_2         
	//*  36   68:invokespecial   #156 <Method boolean snapFromFling(RecyclerView$LayoutManager, int, int)>
	//*  37   71:ifeq            77
				flag = true;
	//   38   74:iconst_1        
	//   39   75:istore          4
	...
	//    6   10:aload_1         
	//    7   11:invokevirtual   #141 <Method RecyclerView$LayoutManager RecyclerView.getLayoutManager()>
	//    8   14:astore_1        
		if(obj == null)
	//*   9   15:aload_1         
	//*  10   16:ifnonnull       20
	...
	//   12   20:aload_0         
	//   13   21:aload_1         
	//   14   22:invokevirtual   #158 <Method View findSnapView(RecyclerView$LayoutManager)>
	//   15   25:astore_2        
		if(view == null)
	//*  16   26:aload_2         
	//*  17   27:ifnonnull       31
	...
	//   20   32:aload_1         
	//   21   33:aload_2         
	//   22   34:invokevirtual   #160 <Method int[] calculateDistanceToFinalSnap(RecyclerView$LayoutManager, View)>
	//   23   37:astore_1        
		if(ai[0] != 0 || ai[1] != 0)
	//*  24   38:aload_1         
	//*  25   39:iconst_0        
	...
	//   32   50:aload_0         
	//   33   51:getfield        #30  <Field RecyclerView mRecyclerView>
	//   34   54:aload_1         
	//   35   55:iconst_0        
	//   36   56:iaload          
	//   37   57:aload_1         
	//   38   58:iconst_1        
	//   39   59:iaload          
	//   40   60:invokevirtual   #164 <Method void RecyclerView.smoothScrollBy(int, int)>
	//   41   63:return          
	}
