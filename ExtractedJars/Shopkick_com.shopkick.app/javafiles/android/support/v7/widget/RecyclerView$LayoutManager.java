...
label4:
	...
	//   45   75:iload_0         
	//   46   76:iload_1         
	//   47   77:invokestatic    #237 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   48   80:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #245 <Method int getPaddingLeft()>
	//    2    4:istore          5
		int j = getPaddingTop();
	//    3    6:aload_0         
	//    4    7:invokevirtual   #248 <Method int getPaddingTop()>
	//    5   10:istore          6
		int k = getWidth();
	//    6   12:aload_0         
	//    7   13:invokevirtual   #251 <Method int getWidth()>
	//    8   16:istore          7
		int j2 = getPaddingRight();
	//    9   18:aload_0         
	//   10   19:invokevirtual   #254 <Method int getPaddingRight()>
	//   11   22:istore          14
		int i1 = getHeight();
	//   12   24:aload_0         
	//   13   25:invokevirtual   #257 <Method int getHeight()>
	//   14   28:istore          9
		int j1 = getPaddingBottom();
	//   15   30:aload_0         
	//   16   31:invokevirtual   #260 <Method int getPaddingBottom()>
	//   17   34:istore          10
		int k2 = (view.getLeft() + rect.left) - view.getScrollX();
	//   18   36:aload_2         
	//   19   37:invokevirtual   #263 <Method int View.getLeft()>
	//   20   40:aload_3         
	//   21   41:getfield        #268 <Field int Rect.left>
	//   22   44:iadd            
	//   23   45:aload_2         
	//   24   46:invokevirtual   #271 <Method int View.getScrollX()>
	//   25   49:isub            
	//   26   50:istore          15
		int k1 = (view.getTop() + rect.top) - view.getScrollY();
	//   27   52:aload_2         
	//   28   53:invokevirtual   #274 <Method int View.getTop()>
	//   29   56:aload_3         
	//   30   57:getfield        #277 <Field int Rect.top>
	//   31   60:iadd            
	//   32   61:aload_2         
	//   33   62:invokevirtual   #280 <Method int View.getScrollY()>
	//   34   65:isub            
	//   35   66:istore          11
		int l2 = rect.width();
	//   36   68:aload_3         
	//   37   69:invokevirtual   #283 <Method int Rect.width()>
	//   38   72:istore          16
		int l1 = rect.height();
	//   39   74:aload_3         
	//   40   75:invokevirtual   #286 <Method int Rect.height()>
	//   41   78:istore          12
		int i2 = k2 - i;
	//   42   80:iload           15
	//   43   82:iload           5
	...
	//*  80  148:aload_0         
	//*  81  149:invokevirtual   #289 <Method int getLayoutDirection()>
	//*  82  152:iconst_1        
	//*  83  153:icmpne          180
		{
			if(k != 0)
	...
	//    1    3:dup             
	//    2    4:invokespecial   #292 <Method void RecyclerView$LayoutManager$Properties()>
	//    3    7:astore          4
		context = ((Context) (context.obtainStyledAttributes(attributeset, android.support.v7.recyclerview.R.styleable.RecyclerView, i, j)));
	//    4    9:aload_0         
	//    5   10:aload_1         
	//    6   11:getstatic       #298 <Field int[] android.support.v7.recyclerview.R$styleable.RecyclerView>
	//    7   14:iload_2         
	//    8   15:iload_3         
	//    9   16:invokevirtual   #304 <Method TypedArray Context.obtainStyledAttributes(AttributeSet, int[], int, int)>
	//   10   19:astore_0        
	...
	//   11   20:aload           4
	//   12   22:aload_0         
	//   13   23:getstatic       #307 <Field int android.support.v7.recyclerview.R$styleable.RecyclerView_android_orientation>
	//   14   26:iconst_1        
	//   15   27:invokevirtual   #312 <Method int TypedArray.getInt(int, int)>
	//   16   30:putfield        #315 <Field int RecyclerView$LayoutManager$Properties.orientation>
		properties.spanCount = ((TypedArray) (context)).getInt(android.support.v7.recyclerview.R.styleable.RecyclerView_spanCount, 1);
	//   17   33:aload           4
	//   18   35:aload_0         
	//   19   36:getstatic       #318 <Field int android.support.v7.recyclerview.R$styleable.RecyclerView_spanCount>
	//   20   39:iconst_1        
	//   21   40:invokevirtual   #312 <Method int TypedArray.getInt(int, int)>
	//   22   43:putfield        #321 <Field int RecyclerView$LayoutManager$Properties.spanCount>
	...
	//   23   46:aload           4
	//   24   48:aload_0         
	//   25   49:getstatic       #324 <Field int android.support.v7.recyclerview.R$styleable.RecyclerView_reverseLayout>
	//   26   52:iconst_0        
	//   27   53:invokevirtual   #328 <Method boolean TypedArray.getBoolean(int, boolean)>
	//   28   56:putfield        #331 <Field boolean RecyclerView$LayoutManager$Properties.reverseLayout>
	...
	//   29   59:aload           4
	//   30   61:aload_0         
	//   31   62:getstatic       #334 <Field int android.support.v7.recyclerview.R$styleable.RecyclerView_stackFromEnd>
	//   32   65:iconst_0        
	//   33   66:invokevirtual   #328 <Method boolean TypedArray.getBoolean(int, boolean)>
	//   34   69:putfield        #337 <Field boolean RecyclerView$LayoutManager$Properties.stackFromEnd>
		((TypedArray) (context)).recycle();
	//   35   72:aload_0         
	//   36   73:invokevirtual   #340 <Method void TypedArray.recycle()>
		return properties;
	//   37   76:aload           4
	//   38   78:areturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #346 <Method View RecyclerView.getFocusedChild()>
	//    2    4:astore_1        
	...
	//    7   11:aload_0         
	//    8   12:invokevirtual   #245 <Method int getPaddingLeft()>
	//    9   15:istore          4
		int l = getPaddingTop();
	//   10   17:aload_0         
	//   11   18:invokevirtual   #248 <Method int getPaddingTop()>
	//   12   21:istore          5
		int i1 = getWidth();
	//   13   23:aload_0         
	//   14   24:invokevirtual   #251 <Method int getWidth()>
	//   15   27:istore          6
		int j1 = getPaddingRight();
	//   16   29:aload_0         
	//   17   30:invokevirtual   #254 <Method int getPaddingRight()>
	//   18   33:istore          7
		int k1 = getHeight();
	//   19   35:aload_0         
	//   20   36:invokevirtual   #257 <Method int getHeight()>
	//   21   39:istore          8
		int l1 = getPaddingBottom();
	//   22   41:aload_0         
	//   23   42:invokevirtual   #260 <Method int getPaddingBottom()>
	//   24   45:istore          9
		Rect rect = mRecyclerView.mTempRect;
	//   25   47:aload_0         
	//   26   48:getfield        #89  <Field RecyclerView mRecyclerView>
	//   27   51:getfield        #350 <Field Rect RecyclerView.mTempRect>
	//   28   54:astore          10
		getDecoratedBoundsWithMargins(((View) (recyclerview)), rect);
	//   29   56:aload_0         
	//   30   57:aload_1         
	//   31   58:aload           10
	//   32   60:invokevirtual   #354 <Method void getDecoratedBoundsWithMargins(View, Rect)>
		if(rect.left - i < i1 - j1 && rect.right - i > k && rect.top - j < k1 - l1)
	//*  33   63:aload           10
	//*  34   65:getfield        #268 <Field int Rect.left>
	//*  35   68:iload_2         
	//*  36   69:isub            
	//*  37   70:iload           6
	//*  38   72:iload           7
	...
	//*  40   75:icmpge          121
	//*  41   78:aload           10
	//*  42   80:getfield        #357 <Field int Rect.right>
	//*  43   83:iload_2         
	//*  44   84:isub            
	//*  45   85:iload           4
	//*  46   87:icmple          121
	//*  47   90:aload           10
	//*  48   92:getfield        #277 <Field int Rect.top>
	//*  49   95:iload_3         
	//*  50   96:isub            
	//*  51   97:iload           8
	//*  52   99:iload           9
	...
	//   55  105:aload           10
	//   56  107:getfield        #360 <Field int Rect.bottom>
	//   57  110:iload_3         
	//   58  111:isub            
	//   59  112:iload           5
	//   60  114:icmpgt          119
	...
	//*   3    6:aload           4
	//*   4    8:invokevirtual   #367 <Method boolean RecyclerView$ViewHolder.shouldIgnore()>
	//*   5   11:ifeq            15
			return;
	//    6   14:return          
		if(viewholder.isInvalid() && !viewholder.isRemoved() && !mRecyclerView.mAdapter.hasStableIds())
	//*   7   15:aload           4
	//*   8   17:invokevirtual   #370 <Method boolean RecyclerView$ViewHolder.isInvalid()>
	//*   9   20:ifeq            56
	//*  10   23:aload           4
	...
	//*  15   35:getfield        #374 <Field RecyclerView$Adapter RecyclerView.mAdapter>
	//*  16   38:invokevirtual   #379 <Method boolean RecyclerView$Adapter.hasStableIds()>
	//*  17   41:ifne            56
		{
			removeViewAt(i);
	//   18   44:aload_0         
	//   19   45:iload_2         
	//   20   46:invokevirtual   #382 <Method void removeViewAt(int)>
			recycler.recycleViewHolderInternal(viewholder);
	//   21   49:aload_1         
	//   22   50:aload           4
	//   23   52:invokevirtual   #387 <Method void RecyclerView$Recycler.recycleViewHolderInternal(RecyclerView$ViewHolder)>
			return;
	//   24   55:return          
		} else
		{
	...
	//   25   56:aload_0         
	//   26   57:iload_2         
	//   27   58:invokevirtual   #390 <Method void detachViewAt(int)>
			recycler.scrapView(view);
	//   28   61:aload_1         
	//   29   62:aload_3         
	//   30   63:invokevirtual   #393 <Method void RecyclerView$Recycler.scrapView(View)>
	...
	//   34   73:aload           4
	//   35   75:invokevirtual   #396 <Method void ViewInfoStore.onViewDetached(RecyclerView$ViewHolder)>
			return;
	//   36   78:return          
		}
	}
	...
	//    1    1:aload_1         
	//    2    2:iconst_m1       
	//    3    3:invokevirtual   #400 <Method void addDisappearingView(View, int)>
	//    4    6:return          
	}
	...
	//    2    2:iload_2         
	//    3    3:iconst_1        
	//    4    4:invokespecial   #402 <Method void addViewInt(View, int, boolean)>
	//    5    7:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iconst_m1       
	//    3    3:invokevirtual   #404 <Method void addView(View, int)>
	//    4    6:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #407 <Method void RecyclerView.assertInLayoutOrScroll(String)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #410 <Method void RecyclerView.assertNotInLayoutOrScroll(String)>
	//    8   14:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iconst_m1       
	//    3    3:invokevirtual   #413 <Method void attachView(View, int)>
	//    4    6:return          
	}
	...
	//    6   10:invokevirtual   #416 <Method void attachView(View, int, RecyclerView$LayoutParams)>
	//    7   13:return          
	}
	...
	//    8   12:iconst_0        
	//    9   13:iconst_0        
	//   10   14:invokevirtual   #421 <Method void Rect.set(int, int, int, int)>
			return;
	//   11   17:return          
		} else
		{
	...
	//   13   19:aload_3         
	//   14   20:aload_1         
	//   15   21:invokevirtual   #425 <Method Rect RecyclerView.getItemDecorInsetsForChild(View)>
	//   16   24:invokevirtual   #428 <Method void Rect.set(Rect)>
			return;
	//   17   27:return          
		}
	}
	...
	//   10   14:aload_0         
	//   11   15:iload_2         
	//   12   16:invokevirtual   #450 <Method View getChildAt(int)>
	//   13   19:invokespecial   #452 <Method void scrapOrRecycleView(RecyclerView$Recycler, int, View)>
	...
	//    1    1:aload_2         
	//    2    2:aload_0         
	//    3    3:getfield        #122 <Field ChildHelper mChildHelper>
	//    4    6:aload_1         
	//    5    7:invokevirtual   #128 <Method int ChildHelper.indexOfChild(View)>
	//    6   10:aload_1         
	//    7   11:invokespecial   #452 <Method void scrapOrRecycleView(RecyclerView$Recycler, int, View)>
	//    8   14:return          
	}
	...
	//    3    3:aload_0         
	//    4    4:iload_1         
	//    5    5:invokevirtual   #450 <Method View getChildAt(int)>
	//    6    8:invokespecial   #452 <Method void scrapOrRecycleView(RecyclerView$Recycler, int, View)>
	//    7   11:return          
	}
	...
	//    1    1:getfield        #122 <Field ChildHelper mChildHelper>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #128 <Method int ChildHelper.indexOfChild(View)>
	//    4    8:istore_2        
		if(i >= 0)
	//*   5    9:iload_2         
	//*   6   10:iflt            19
	...
	//    8   14:iload_2         
	//    9   15:aload_1         
	//   10   16:invokespecial   #459 <Method void detachViewInternal(int, View)>
	//   11   19:return          
	}
	...
	//    2    2:aload_0         
	//    3    3:iload_1         
	//    4    4:invokevirtual   #450 <Method View getChildAt(int)>
	//    5    7:invokespecial   #459 <Method void detachViewInternal(int, View)>
	//    6   10:return          
	}
	...
	//    3    5:aload_0         
	//    4    6:aload_1         
	//    5    7:invokevirtual   #464 <Method void onAttachedToWindow(RecyclerView)>
	//    6   10:return          
	}
	...
	//    4    6:aload_1         
	//    5    7:aload_2         
	//    6    8:invokevirtual   #469 <Method void onDetachedFromWindow(RecyclerView, RecyclerView$Recycler)>
	//    7   11:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #89  <Field RecyclerView mRecyclerView>
	//*   2    4:getfield        #474 <Field RecyclerView$ItemAnimator RecyclerView.mItemAnimator>
	//*   3    7:ifnull          24
			mRecyclerView.mItemAnimator.endAnimation(RecyclerView.getChildViewHolderInt(view));
	//    4   10:aload_0         
	//    5   11:getfield        #89  <Field RecyclerView mRecyclerView>
	//    6   14:getfield        #474 <Field RecyclerView$ItemAnimator RecyclerView.mItemAnimator>
	//    7   17:aload_1         
	//    8   18:invokestatic    #81  <Method RecyclerView$ViewHolder RecyclerView.getChildViewHolderInt(View)>
	//    9   21:invokevirtual   #478 <Method void RecyclerView$ItemAnimator.endAnimation(RecyclerView$ViewHolder)>
	//   10   24:return          
	}
	...
	//    7   11:aload_2         
	//    8   12:aload_1         
	//    9   13:invokevirtual   #482 <Method View RecyclerView.findContainingItemView(View)>
	//   10   16:astore_1        
		if(view == null)
	//*  11   17:aload_1         
	//*  12   18:ifnonnull       23
	...
	//*  17   27:aload_1         
	//*  18   28:invokevirtual   #486 <Method boolean ChildHelper.isHidden(View)>
	//*  19   31:ifeq            36
			return null;
	//   20   34:aconst_null     
	//   21   35:areturn         
	...
	//    8   12:aload_0         
	//    9   13:iload_2         
	//   10   14:invokevirtual   #450 <Method View getChildAt(int)>
	//   11   17:astore          4
			RecyclerView.ViewHolder viewholder = RecyclerView.getChildViewHolderInt(view);
	//   12   19:aload           4
	...
	//*  17   31:goto            75
	//*  18   34:aload           5
	//*  19   36:invokevirtual   #491 <Method int RecyclerView$ViewHolder.getLayoutPosition()>
	//*  20   39:iload_1         
	//*  21   40:icmpne          75
	//*  22   43:aload           5
	//*  23   45:invokevirtual   #367 <Method boolean RecyclerView$ViewHolder.shouldIgnore()>
	//*  24   48:ifne            75
	//*  25   51:aload_0         
	//*  26   52:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  27   55:getfield        #495 <Field RecyclerView$State RecyclerView.mState>
	//*  28   58:invokevirtual   #500 <Method boolean RecyclerView$State.isPreLayout()>
	//*  29   61:ifne            72
	//*  30   64:aload           5
	...
	//    2    4:aload_1         
	//    3    5:aload_2         
	//    4    6:invokespecial   #507 <Method void RecyclerView$LayoutParams(Context, AttributeSet)>
	//    5    9:areturn         
	}
	...
	//    7   15:invokespecial   #511 <Method void RecyclerView$LayoutParams(RecyclerView$LayoutParams)>
	//    8   18:areturn         
		if(layoutparams instanceof android.view.s)
	//*   9   19:aload_1         
	//*  10   20:instanceof      #513 <Class android.view.ViewGroup$MarginLayoutParams>
	//*  11   23:ifeq            38
			return new RecyclerView.LayoutParams((android.view.s)layoutparams);
	//   12   26:new             #110 <Class RecyclerView$LayoutParams>
	//   13   29:dup             
	//   14   30:aload_1         
	//   15   31:checkcast       #513 <Class android.view.ViewGroup$MarginLayoutParams>
	//   16   34:invokespecial   #516 <Method void RecyclerView$LayoutParams(android.view.ViewGroup$MarginLayoutParams)>
	//   17   37:areturn         
		else
	...
	//   19   41:dup             
	//   20   42:aload_1         
	//   21   43:invokespecial   #519 <Method void RecyclerView$LayoutParams(android.view.ViewGroup$LayoutParams)>
	//   22   46:areturn         
	}
	...
	//    3    7:getfield        #524 <Field Rect RecyclerView$LayoutParams.mDecorInsets>
	//    4   10:getfield        #360 <Field int Rect.bottom>
	//    5   13:ireturn         
	}
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #525 <Method View ChildHelper.getChildAt(int)>
	//    8   14:areturn         
		else
			return null;
	//    9   15:aconst_null     
	...
	//    4    6:ifnull          18
	//    5    9:aload_1         
	//    6   10:getfield        #529 <Field boolean RecyclerView.mClipToPadding>
	//    7   13:ifeq            18
	//    8   16:iconst_1        
	//    9   17:ireturn         
	//   10   18:iconst_0        
	...
	//*   7   11:aload_1         
	//*   8   12:getfield        #374 <Field RecyclerView$Adapter RecyclerView.mAdapter>
	//*   9   15:ifnonnull       20
				return 1;
	//   10   18:iconst_1        
	//   11   19:ireturn         
	...
	//*  12   20:aload_0         
	//*  13   21:invokevirtual   #533 <Method boolean canScrollHorizontally()>
	//*  14   24:ifeq            38
				i = mRecyclerView.mAdapter.getItemCount();
	//   15   27:aload_0         
	//   16   28:getfield        #89  <Field RecyclerView mRecyclerView>
	//   17   31:getfield        #374 <Field RecyclerView$Adapter RecyclerView.mAdapter>
	//   18   34:invokevirtual   #536 <Method int RecyclerView$Adapter.getItemCount()>
	//   19   37:istore_3        
			return i;
	//   20   38:iload_3         
	//   21   39:ireturn         
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #540 <Method int View.getBottom()>
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokevirtual   #542 <Method int getBottomDecorationHeight(View)>
	//    5    9:iadd            
	//    6   10:ireturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:aload_2         
	//    2    2:invokestatic    #545 <Method void RecyclerView.getDecoratedBoundsWithMarginsInt(View, Rect)>
	//    3    5:return          
	}
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #263 <Method int View.getLeft()>
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokevirtual   #549 <Method int getLeftDecorationWidth(View)>
	//    5    9:isub            
	//    6   10:ireturn         
	}
	...
	//    5   11:aload_1         
	//    6   12:invokevirtual   #553 <Method int View.getMeasuredHeight()>
	//    7   15:aload_2         
	//    8   16:getfield        #277 <Field int Rect.top>
	//    9   19:iadd            
	//   10   20:aload_2         
	//   11   21:getfield        #360 <Field int Rect.bottom>
	//   12   24:iadd            
	//   13   25:ireturn         
	}
	...
	//    5   11:aload_1         
	//    6   12:invokevirtual   #557 <Method int View.getMeasuredWidth()>
	//    7   15:aload_2         
	//    8   16:getfield        #268 <Field int Rect.left>
	//    9   19:iadd            
	//   10   20:aload_2         
	//   11   21:getfield        #357 <Field int Rect.right>
	//   12   24:iadd            
	//   13   25:ireturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #561 <Method int View.getRight()>
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokevirtual   #564 <Method int getRightDecorationWidth(View)>
	//    5    9:iadd            
	//    6   10:ireturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #274 <Method int View.getTop()>
	//    2    4:aload_0         
	//    3    5:aload_1         
	//    4    6:invokevirtual   #568 <Method int getTopDecorationHeight(View)>
	//    5    9:isub            
	//    6   10:ireturn         
	}
	...
	//    7   11:aload_1         
	//    8   12:invokevirtual   #346 <Method View RecyclerView.getFocusedChild()>
	//    9   15:astore_1        
		if(obj != null)
	//*  10   16:aload_1         
	//*  11   17:ifnull          35
	...
	//*  14   24:aload_1         
	//*  15   25:invokevirtual   #486 <Method boolean ChildHelper.isHidden(View)>
	//*  16   28:ifeq            33
				return null;
	//   17   31:aconst_null     
	//   18   32:areturn         
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #578 <Method RecyclerView$Adapter RecyclerView.getAdapter()>
	//    7   13:astore_1        
		else
	//*   8   14:goto            19
			obj = null;
	...
	//   13   23:aload_1         
	//   14   24:invokevirtual   #536 <Method int RecyclerView$Adapter.getItemCount()>
	//   15   27:ireturn         
		else
			return 0;
	//   16   28:iconst_0        
	...
	//    2    4:checkcast       #110 <Class RecyclerView$LayoutParams>
	//    3    7:getfield        #524 <Field Rect RecyclerView$LayoutParams.mDecorInsets>
	//    4   10:getfield        #268 <Field int Rect.left>
	//    5   13:ireturn         
	}
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #592 <Method int RecyclerView.getPaddingBottom()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokestatic    #595 <Method int ViewCompat.getPaddingEnd(View)>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #596 <Method int RecyclerView.getPaddingLeft()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #597 <Method int RecyclerView.getPaddingRight()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokestatic    #600 <Method int ViewCompat.getPaddingStart(View)>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #601 <Method int RecyclerView.getPaddingTop()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    2    4:checkcast       #110 <Class RecyclerView$LayoutParams>
	//    3    7:getfield        #524 <Field Rect RecyclerView$LayoutParams.mDecorInsets>
	//    4   10:getfield        #357 <Field int Rect.right>
	//    5   13:ireturn         
	}
	...
	//*  12   20:aload_0         
	//*  13   21:invokevirtual   #608 <Method boolean canScrollVertically()>
	//*  14   24:ifeq            38
				i = mRecyclerView.mAdapter.getItemCount();
	//   15   27:aload_0         
	//   16   28:getfield        #89  <Field RecyclerView mRecyclerView>
	...
	//    2    4:checkcast       #110 <Class RecyclerView$LayoutParams>
	//    3    7:getfield        #524 <Field Rect RecyclerView$LayoutParams.mDecorInsets>
	//    4   10:getfield        #277 <Field int Rect.top>
	//    5   13:ireturn         
	}
	...
	//    5   11:getfield        #524 <Field Rect RecyclerView$LayoutParams.mDecorInsets>
	//    6   14:astore          4
			rect.set(-rect1.left, -rect1.top, view.getWidth() + rect1.right, view.getHeight() + rect1.bottom);
	//    7   16:aload_3         
	//    8   17:aload           4
	//    9   19:getfield        #268 <Field int Rect.left>
	//   10   22:ineg            
	//   11   23:aload           4
	//   12   25:getfield        #277 <Field int Rect.top>
	//   13   28:ineg            
	//   14   29:aload_1         
	//   15   30:invokevirtual   #612 <Method int View.getWidth()>
	//   16   33:aload           4
	//   17   35:getfield        #357 <Field int Rect.right>
	//   18   38:iadd            
	//   19   39:aload_1         
	//   20   40:invokevirtual   #613 <Method int View.getHeight()>
	//   21   43:aload           4
	//   22   45:getfield        #360 <Field int Rect.bottom>
	//   23   48:iadd            
	//   24   49:invokevirtual   #421 <Method void Rect.set(int, int, int, int)>
		} else
	//*  25   52:goto            69
		{
	...
	//   33   66:invokevirtual   #421 <Method void Rect.set(int, int, int, int)>
		}
	...
	//   76  158:d2i             
	//   77  159:invokevirtual   #421 <Method void Rect.set(int, int, int, int)>
			}
		}
		rect.offset(view.getLeft(), view.getTop());
	//   78  162:aload_3         
	//   79  163:aload_1         
	//   80  164:invokevirtual   #263 <Method int View.getLeft()>
	//   81  167:aload_1         
	//   82  168:invokevirtual   #274 <Method int View.getTop()>
	...
	//    4    6:ifnull          18
	//    5    9:aload_1         
	//    6   10:invokevirtual   #667 <Method boolean RecyclerView.hasFocus()>
	//    7   13:ifeq            18
	//    8   16:iconst_1        
	//    9   17:ireturn         
	//   10   18:iconst_0        
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #120 <Method android.view.ViewParent View.getParent()>
	//    2    4:astore_2        
		RecyclerView recyclerview = mRecyclerView;
	//    3    5:aload_0         
	//    4    6:getfield        #89  <Field RecyclerView mRecyclerView>
	//    5    9:astore_3        
	...
	//*   9   15:aload_3         
	//*  10   16:aload_1         
	//*  11   17:invokevirtual   #150 <Method int RecyclerView.indexOfChild(View)>
	//*  12   20:iconst_m1       
	//*  13   21:icmpeq          48
		{
			view = ((View) (RecyclerView.getChildViewHolderInt(view)));
	//   14   24:aload_1         
	//   15   25:invokestatic    #81  <Method RecyclerView$ViewHolder RecyclerView.getChildViewHolderInt(View)>
	//   16   28:astore_1        
			((RecyclerView.ViewHolder) (view)).addFlags(128);
	//   17   29:aload_1         
	//   18   30:sipush          128
	//   19   33:invokevirtual   #671 <Method void RecyclerView$ViewHolder.addFlags(int)>
			mRecyclerView.mViewInfoStore.removeViewHolder(((RecyclerView.ViewHolder) (view)));
	//   20   36:aload_0         
	//   21   37:getfield        #89  <Field RecyclerView mRecyclerView>
	//   22   40:getfield        #93  <Field ViewInfoStore RecyclerView.mViewInfoStore>
	//   23   43:aload_1         
	//   24   44:invokevirtual   #674 <Method void ViewInfoStore.removeViewHolder(RecyclerView$ViewHolder)>
			return;
	//   25   47:return          
		} else
		{
			view = ((View) (new StringBuilder()));
	//   26   48:new             #142 <Class StringBuilder>
	//   27   51:dup             
	//   28   52:invokespecial   #143 <Method void StringBuilder()>
	//   29   55:astore_1        
			((StringBuilder) (view)).append("View should be fully attached to be ignored");
	//   30   56:aload_1         
	//   31   57:ldc2            #676 <String "View should be fully attached to be ignored">
	//   32   60:invokevirtual   #149 <Method StringBuilder StringBuilder.append(String)>
	//   33   63:pop             
			((StringBuilder) (view)).append(mRecyclerView.exceptionLabel());
	//   34   64:aload_1         
	//   35   65:aload_0         
	//   36   66:getfield        #89  <Field RecyclerView mRecyclerView>
	//   37   69:invokevirtual   #157 <Method String RecyclerView.exceptionLabel()>
	//   38   72:invokevirtual   #149 <Method StringBuilder StringBuilder.append(String)>
	//   39   75:pop             
			throw new IllegalArgumentException(((StringBuilder) (view)).toString());
	//   40   76:new             #678 <Class IllegalArgumentException>
	//   41   79:dup             
	//   42   80:aload_1         
	//   43   81:invokevirtual   #162 <Method String StringBuilder.toString()>
	//   44   84:invokespecial   #679 <Method void IllegalArgumentException(String)>
	//   45   87:athrow          
		}
	}
	...
	//    4    6:ifnull          18
	//    5    9:aload_1         
	//    6   10:invokevirtual   #684 <Method boolean RecyclerView.isFocused()>
	//    7   13:ifeq            18
	//    8   16:iconst_1        
	//    9   17:ireturn         
	//   10   18:iconst_0        
	...
	//*   2    4:aload_1         
	//*   3    5:sipush          24579
	//*   4    8:invokevirtual   #695 <Method boolean ViewBoundsCheck.isViewWithinBoundFlags(View, int)>
	//*   5   11:ifeq            33
	//*   6   14:aload_0         
	//*   7   15:getfield        #64  <Field ViewBoundsCheck mVerticalBoundCheck>
	//*   8   18:aload_1         
	//*   9   19:sipush          24579
	//*  10   22:invokevirtual   #695 <Method boolean ViewBoundsCheck.isViewWithinBoundFlags(View, int)>
	//*  11   25:ifeq            33
			flag1 = true;
	//   12   28:iconst_1        
	//   13   29:istore_3        
	...
	//   10   20:iload_3         
	//   11   21:aload           6
	//   12   23:getfield        #277 <Field int Rect.top>
	//   13   26:iadd            
	//   14   27:iload           4
	//   15   29:aload           6
	//   16   31:getfield        #357 <Field int Rect.right>
	//   17   34:isub            
	//   18   35:iload           5
	//   19   37:aload           6
	//   20   39:getfield        #360 <Field int Rect.bottom>
	//   21   42:isub            
	//   22   43:invokevirtual   #700 <Method void View.layout(int, int, int, int)>
	//   23   46:return          
	}
	...
	//    8   17:iload_2         
	//    9   18:aload           7
	//   10   20:getfield        #268 <Field int Rect.left>
	//   11   23:iadd            
	//   12   24:aload           6
	//   13   26:getfield        #704 <Field int RecyclerView$LayoutParams.leftMargin>
	//   14   29:iadd            
	//   15   30:iload_3         
	//   16   31:aload           7
	//   17   33:getfield        #277 <Field int Rect.top>
	//   18   36:iadd            
	//   19   37:aload           6
	//   20   39:getfield        #707 <Field int RecyclerView$LayoutParams.topMargin>
	//   21   42:iadd            
	//   22   43:iload           4
	//   23   45:aload           7
	//   24   47:getfield        #357 <Field int Rect.right>
	//   25   50:isub            
	//   26   51:aload           6
	//   27   53:getfield        #710 <Field int RecyclerView$LayoutParams.rightMargin>
	//   28   56:isub            
	//   29   57:iload           5
	//   30   59:aload           7
	//   31   61:getfield        #360 <Field int Rect.bottom>
	//   32   64:isub            
	//   33   65:aload           6
	//   34   67:getfield        #713 <Field int RecyclerView$LayoutParams.bottomMargin>
	//   35   70:isub            
	//   36   71:invokevirtual   #700 <Method void View.layout(int, int, int, int)>
	//   37   74:return          
	}
	...
	//    6   13:aload_1         
	//    7   14:invokevirtual   #425 <Method Rect RecyclerView.getItemDecorInsetsForChild(View)>
	//    8   17:astore          9
		int i1 = rect.left;
	//    9   19:aload           9
	//   10   21:getfield        #268 <Field int Rect.left>
	//   11   24:istore          6
		int j1 = rect.right;
	//   12   26:aload           9
	//   13   28:getfield        #357 <Field int Rect.right>
	//   14   31:istore          7
		int k = rect.top;
	//   15   33:aload           9
	//   16   35:getfield        #277 <Field int Rect.top>
	//   17   38:istore          4
		int l = rect.bottom;
	//   18   40:aload           9
	//   19   42:getfield        #360 <Field int Rect.bottom>
	//   20   45:istore          5
	...
	//   21   47:aload_0         
	//   22   48:invokevirtual   #251 <Method int getWidth()>
	//   23   51:aload_0         
	//   24   52:invokevirtual   #717 <Method int getWidthMode()>
	//   25   55:aload_0         
	//   26   56:invokevirtual   #245 <Method int getPaddingLeft()>
	//   27   59:aload_0         
	//   28   60:invokevirtual   #254 <Method int getPaddingRight()>
	//   29   63:iadd            
	//   30   64:iload_2         
	//   31   65:iload           6
	//   32   67:iload           7
	...
	//   35   71:iadd            
	//   36   72:aload           8
	//   37   74:getfield        #718 <Field int RecyclerView$LayoutParams.width>
	//   38   77:aload_0         
	//   39   78:invokevirtual   #533 <Method boolean canScrollHorizontally()>
	//   40   81:invokestatic    #720 <Method int getChildMeasureSpec(int, int, int, int, boolean)>
	//   41   84:istore_2        
	...
	//   42   85:aload_0         
	//   43   86:invokevirtual   #257 <Method int getHeight()>
	//   44   89:aload_0         
	//   45   90:invokevirtual   #722 <Method int getHeightMode()>
	//   46   93:aload_0         
	//   47   94:invokevirtual   #248 <Method int getPaddingTop()>
	//   48   97:aload_0         
	//   49   98:invokevirtual   #260 <Method int getPaddingBottom()>
	//   50  101:iadd            
	//   51  102:iload_3         
	//   52  103:iload           4
	//   53  105:iload           5
	...
	//   56  109:iadd            
	//   57  110:aload           8
	//   58  112:getfield        #723 <Field int RecyclerView$LayoutParams.height>
	//   59  115:aload_0         
	//   60  116:invokevirtual   #608 <Method boolean canScrollVertically()>
	//   61  119:invokestatic    #720 <Method int getChildMeasureSpec(int, int, int, int, boolean)>
	//   62  122:istore_3        
	...
	//*  66  126:iload_3         
	//*  67  127:aload           8
	//*  68  129:invokevirtual   #727 <Method boolean shouldMeasureChild(View, int, int, RecyclerView$LayoutParams)>
	//*  69  132:ifeq            141
			view.measure(i, j);
	//   70  135:aload_1         
	//   71  136:iload_2         
	//   72  137:iload_3         
	//   73  138:invokevirtual   #730 <Method void View.measure(int, int)>
	//   74  141:return          
	}
	...
	//   29   63:iadd            
	//   30   64:aload           8
	//   31   66:getfield        #704 <Field int RecyclerView$LayoutParams.leftMargin>
	//   32   69:iadd            
	//   33   70:aload           8
	//   34   72:getfield        #710 <Field int RecyclerView$LayoutParams.rightMargin>
	//   35   75:iadd            
	//   36   76:iload_2         
	//   37   77:iload           6
	//   38   79:iload           7
	...
	//   41   83:iadd            
	//   42   84:aload           8
	//   43   86:getfield        #718 <Field int RecyclerView$LayoutParams.width>
	//   44   89:aload_0         
	//   45   90:invokevirtual   #533 <Method boolean canScrollHorizontally()>
	//   46   93:invokestatic    #720 <Method int getChildMeasureSpec(int, int, int, int, boolean)>
	//   47   96:istore_2        
	...
	//   48   97:aload_0         
	//   49   98:invokevirtual   #257 <Method int getHeight()>
	//   50  101:aload_0         
	//   51  102:invokevirtual   #722 <Method int getHeightMode()>
	//   52  105:aload_0         
	//   53  106:invokevirtual   #248 <Method int getPaddingTop()>
	//   54  109:aload_0         
	//   55  110:invokevirtual   #260 <Method int getPaddingBottom()>
	//   56  113:iadd            
	//   57  114:aload           8
	//   58  116:getfield        #707 <Field int RecyclerView$LayoutParams.topMargin>
	//   59  119:iadd            
	//   60  120:aload           8
	//   61  122:getfield        #713 <Field int RecyclerView$LayoutParams.bottomMargin>
	//   62  125:iadd            
	//   63  126:iload_3         
	//   64  127:iload           4
	//   65  129:iload           5
	...
	//   68  133:iadd            
	//   69  134:aload           8
	//   70  136:getfield        #723 <Field int RecyclerView$LayoutParams.height>
	//   71  139:aload_0         
	//   72  140:invokevirtual   #608 <Method boolean canScrollVertically()>
	//   73  143:invokestatic    #720 <Method int getChildMeasureSpec(int, int, int, int, boolean)>
	//   74  146:istore_3        
		if(shouldMeasureChild(view, i, j, layoutparams))
	//*  75  147:aload_0         
	//*  76  148:aload_1         
	...
	//*  78  150:iload_3         
	//*  79  151:aload           8
	//*  80  153:invokevirtual   #727 <Method boolean shouldMeasureChild(View, int, int, RecyclerView$LayoutParams)>
	//*  81  156:ifeq            165
			view.measure(i, j);
	//   82  159:aload_1         
	//   83  160:iload_2         
	//   84  161:iload_3         
	//   85  162:invokevirtual   #730 <Method void View.measure(int, int)>
	//   86  165:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokevirtual   #450 <Method View getChildAt(int)>
	//    3    5:astore_3        
		if(view != null)
	//*   4    6:aload_3         
	//*   5    7:ifnull          22
	...
	//    6   10:aload_0         
	//    7   11:iload_1         
	//    8   12:invokevirtual   #390 <Method void detachViewAt(int)>
			attachView(view, j);
	//    9   15:aload_0         
	//   10   16:aload_3         
	//   11   17:iload_2         
	//   12   18:invokevirtual   #413 <Method void attachView(View, int)>
			return;
	//   13   21:return          
		} else
		{
	...
	//   18   30:aload_3         
	//   19   31:ldc2            #733 <String "Cannot move a child from non-existing index:">
	...
	//   29   49:invokevirtual   #734 <Method String RecyclerView.toString()>
	//   30   52:invokevirtual   #149 <Method StringBuilder StringBuilder.append(String)>
	//   31   55:pop             
			throw new IllegalArgumentException(stringbuilder.toString());
	//   32   56:new             #678 <Class IllegalArgumentException>
	//   33   59:dup             
	//   34   60:aload_3         
	//   35   61:invokevirtual   #162 <Method String StringBuilder.toString()>
	//   36   64:invokespecial   #679 <Method void IllegalArgumentException(String)>
	//   37   67:athrow          
		}
	}
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #737 <Method void RecyclerView.offsetChildrenHorizontal(int)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #740 <Method void RecyclerView.offsetChildrenVertical(int)>
	//    8   14:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #749 <Method void onDetachedFromWindow(RecyclerView)>
	//    3    5:return          
	}
	...
	//*  12   21:aload_1         
	//*  13   22:iconst_1        
	//*  14   23:invokevirtual   #756 <Method boolean RecyclerView.canScrollVertically(int)>
	//*  15   26:ifne            80
			{
				flag = flag1;
	//   16   29:iload           5
	...
	//*  20   37:iconst_m1       
	//*  21   38:invokevirtual   #756 <Method boolean RecyclerView.canScrollVertically(int)>
	//*  22   41:ifne            80
				{
					flag = flag1;
	//   23   44:iload           5
	...
	//*  27   52:iconst_m1       
	//*  28   53:invokevirtual   #758 <Method boolean RecyclerView.canScrollHorizontally(int)>
	//*  29   56:ifne            80
						if(mRecyclerView.canScrollHorizontally(1))
	//*  30   59:aload_0         
	//*  31   60:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  32   63:iconst_1        
	//*  33   64:invokevirtual   #758 <Method boolean RecyclerView.canScrollHorizontally(int)>
	//*  34   67:ifeq            77
							flag = flag1;
	//   35   70:iload           5
	//   36   72:istore          4
	...
	//   40   80:aload_3         
	//   41   81:iload           4
	//   42   83:invokevirtual   #764 <Method void AccessibilityEvent.setScrollable(boolean)>
			if(mRecyclerView.mAdapter != null)
	//*  43   86:aload_0         
	//*  44   87:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  45   90:getfield        #374 <Field RecyclerView$Adapter RecyclerView.mAdapter>
	//*  46   93:ifnull          110
				accessibilityevent.setItemCount(mRecyclerView.mAdapter.getItemCount());
	//   47   96:aload_3         
	//   48   97:aload_0         
	//   49   98:getfield        #89  <Field RecyclerView mRecyclerView>
	//   50  101:getfield        #374 <Field RecyclerView$Adapter RecyclerView.mAdapter>
	//   51  104:invokevirtual   #536 <Method int RecyclerView$Adapter.getItemCount()>
	//   52  107:invokevirtual   #767 <Method void AccessibilityEvent.setItemCount(int)>
			return;
	//   53  110:return          
		} else
		{
	...
	//    3    5:getfield        #772 <Field RecyclerView$Recycler RecyclerView.mRecycler>
	//    4    8:aload_0         
	//    5    9:getfield        #89  <Field RecyclerView mRecyclerView>
	//    6   12:getfield        #495 <Field RecyclerView$State RecyclerView.mState>
	//    7   15:aload_1         
	//    8   16:invokevirtual   #774 <Method void onInitializeAccessibilityEvent(RecyclerView$Recycler, RecyclerView$State, AccessibilityEvent)>
	//    9   19:return          
	}
	...
	//    6   12:getfield        #495 <Field RecyclerView$State RecyclerView.mState>
	//    7   15:aload_1         
	//    8   16:invokevirtual   #779 <Method void onInitializeAccessibilityNodeInfo(RecyclerView$Recycler, RecyclerView$State, AccessibilityNodeInfoCompat)>
	//    9   19:return          
	}
	...
	//*   1    1:getfield        #89  <Field RecyclerView mRecyclerView>
	//*   2    4:iconst_m1       
	//*   3    5:invokevirtual   #756 <Method boolean RecyclerView.canScrollVertically(int)>
	//*   4    8:ifne            22
	//*   5   11:aload_0         
	//*   6   12:getfield        #89  <Field RecyclerView mRecyclerView>
	//*   7   15:iconst_m1       
	//*   8   16:invokevirtual   #758 <Method boolean RecyclerView.canScrollHorizontally(int)>
	//*   9   19:ifeq            34
		{
			accessibilitynodeinfocompat.addAction(8192);
	//   10   22:aload_3         
	//   11   23:sipush          8192
	//   12   26:invokevirtual   #784 <Method void AccessibilityNodeInfoCompat.addAction(int)>
			accessibilitynodeinfocompat.setScrollable(true);
	//   13   29:aload_3         
	//   14   30:iconst_1        
	//   15   31:invokevirtual   #785 <Method void AccessibilityNodeInfoCompat.setScrollable(boolean)>
		}
		if(mRecyclerView.canScrollVertically(1) || mRecyclerView.canScrollHorizontally(1))
	//*  16   34:aload_0         
	//*  17   35:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  18   38:iconst_1        
	//*  19   39:invokevirtual   #756 <Method boolean RecyclerView.canScrollVertically(int)>
	//*  20   42:ifne            56
	//*  21   45:aload_0         
	//*  22   46:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  23   49:iconst_1        
	//*  24   50:invokevirtual   #758 <Method boolean RecyclerView.canScrollHorizontally(int)>
	//*  25   53:ifeq            68
		{
			accessibilitynodeinfocompat.addAction(4096);
	//   26   56:aload_3         
	//   27   57:sipush          4096
	//   28   60:invokevirtual   #784 <Method void AccessibilityNodeInfoCompat.addAction(int)>
			accessibilitynodeinfocompat.setScrollable(true);
	//   29   63:aload_3         
	//   30   64:iconst_1        
	//   31   65:invokevirtual   #785 <Method void AccessibilityNodeInfoCompat.setScrollable(boolean)>
		}
	...
	//   34   70:aload_1         
	//   35   71:aload_2         
	//   36   72:invokevirtual   #787 <Method int getRowCountForAccessibility(RecyclerView$Recycler, RecyclerView$State)>
	//   37   75:aload_0         
	//   38   76:aload_1         
	//   39   77:aload_2         
	//   40   78:invokevirtual   #789 <Method int getColumnCountForAccessibility(RecyclerView$Recycler, RecyclerView$State)>
	//   41   81:aload_0         
	//   42   82:aload_1         
	//   43   83:aload_2         
	//   44   84:invokevirtual   #791 <Method boolean isLayoutHierarchical(RecyclerView$Recycler, RecyclerView$State)>
	//   45   87:aload_0         
	//   46   88:aload_1         
	//   47   89:aload_2         
	//   48   90:invokevirtual   #793 <Method int getSelectionModeForAccessibility(RecyclerView$Recycler, RecyclerView$State)>
	//   49   93:invokestatic    #799 <Method android.support.v4.view.accessibility.AccessibilityNodeInfoCompat$CollectionInfoCompat android.support.v4.view.accessibility.AccessibilityNodeInfoCompat$CollectionInfoCompat.obtain(int, int, boolean, int)>
	//   50   96:invokevirtual   #803 <Method void AccessibilityNodeInfoCompat.setCollectionInfo(Object)>
	//   51   99:return          
	}
	...
	//    7   14:aload_0         
	//    8   15:aload_3         
	//    9   16:invokevirtual   #807 <Method int getPosition(View)>
	//   10   19:istore          5
		else
	//*  11   21:goto            27
			i = 0;
	...
	//   13   25:istore          5
		if(canScrollHorizontally())
	//*  14   27:aload_0         
	//*  15   28:invokevirtual   #533 <Method boolean canScrollHorizontally()>
	//*  16   31:ifeq            41
			j = getPosition(view);
	//   17   34:aload_0         
	//   18   35:aload_3         
	//   19   36:invokevirtual   #807 <Method int getPosition(View)>
	//   20   39:istore          6
	...
	//   26   49:iconst_0        
	//   27   50:iconst_0        
	//   28   51:invokestatic    #812 <Method android.support.v4.view.accessibility.AccessibilityNodeInfoCompat$CollectionItemInfoCompat android.support.v4.view.accessibility.AccessibilityNodeInfoCompat$CollectionItemInfoCompat.obtain(int, int, int, int, boolean, boolean)>
	//   29   54:invokevirtual   #815 <Method void AccessibilityNodeInfoCompat.setCollectionItemInfo(Object)>
	//   30   57:return          
	}
	...
	//*  12   24:invokevirtual   #486 <Method boolean ChildHelper.isHidden(View)>
	//*  13   27:ifne            50
	...
	//   17   35:getfield        #772 <Field RecyclerView$Recycler RecyclerView.mRecycler>
	//   18   38:aload_0         
	//   19   39:getfield        #89  <Field RecyclerView mRecyclerView>
	//   20   42:getfield        #495 <Field RecyclerView$State RecyclerView.mState>
	//   21   45:aload_1         
	//   22   46:aload_2         
	//   23   47:invokevirtual   #818 <Method void onInitializeAccessibilityNodeInfoForItem(RecyclerView$Recycler, RecyclerView$State, View, AccessibilityNodeInfoCompat)>
	//   24   50:return          
	}
	...
	//    2    2:iload_2         
	//    3    3:iload_3         
	//    4    4:invokevirtual   #830 <Method void onItemsUpdated(RecyclerView, int, int)>
	//    5    7:return          
	}
	...
	//    0    0:ldc2            #833 <String "RecyclerView">
	//    1    3:ldc2            #835 <String "You must override onLayoutChildren(Recycler recycler, State state) ">
	//    2    6:invokestatic    #841 <Method int Log.e(String, String)>
	//    3    9:pop             
	//    4   10:return          
	}
	...
	//    2    4:iload_3         
	//    3    5:iload           4
	//    4    7:invokevirtual   #848 <Method void RecyclerView.defaultOnMeasure(int, int)>
	//    5   10:return          
	}
	...
	//    2    2:aload_3         
	//    3    3:aload           4
	//    4    5:invokevirtual   #853 <Method boolean onRequestChildFocus(RecyclerView, View, View)>
	//    5    8:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #855 <Method boolean isSmoothScrolling()>
	//    2    4:ifne            19
	//    3    7:aload_1         
	//    4    8:invokevirtual   #858 <Method boolean RecyclerView.isComputingLayout()>
	//    5   11:ifeq            17
	//    6   14:goto            19
	//    7   17:iconst_0        
	//    8   18:ireturn         
	...
	//    7   15:iload_1         
	//    8   16:aload_2         
	//    9   17:invokevirtual   #870 <Method boolean performAccessibilityAction(RecyclerView$Recycler, RecyclerView$State, int, Bundle)>
	//   10   20:ireturn         
	}
	...
	//*  18   34:aload_1         
	//*  19   35:iconst_m1       
	//*  20   36:invokevirtual   #756 <Method boolean RecyclerView.canScrollVertically(int)>
	//*  21   39:ifeq            62
					j = -(getHeight() - getPaddingTop() - getPaddingBottom());
	//   22   42:aload_0         
	//   23   43:invokevirtual   #257 <Method int getHeight()>
	//   24   46:aload_0         
	//   25   47:invokevirtual   #248 <Method int getPaddingTop()>
	//   26   50:isub            
	//   27   51:aload_0         
	//   28   52:invokevirtual   #260 <Method int getPaddingBottom()>
	//   29   55:isub            
	//   30   56:ineg            
	//   31   57:istore          5
				else
	...
	//*  36   66:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  37   69:iconst_m1       
	//*  38   70:invokevirtual   #758 <Method boolean RecyclerView.canScrollHorizontally(int)>
	//*  39   73:ifeq            95
					i = -(getWidth() - getPaddingLeft() - getPaddingRight());
	//   40   76:aload_0         
	//   41   77:invokevirtual   #251 <Method int getWidth()>
	//   42   80:aload_0         
	//   43   81:invokevirtual   #245 <Method int getPaddingLeft()>
	//   44   84:isub            
	//   45   85:aload_0         
	//   46   86:invokevirtual   #254 <Method int getPaddingRight()>
	//   47   89:isub            
	//   48   90:ineg            
	//   49   91:istore_3        
				else
	...
	//*  54  100:aload_1         
	//*  55  101:iconst_1        
	//*  56  102:invokevirtual   #756 <Method boolean RecyclerView.canScrollVertically(int)>
	//*  57  105:ifeq            127
				j = getHeight() - getPaddingTop() - getPaddingBottom();
	//   58  108:aload_0         
	//   59  109:invokevirtual   #257 <Method int getHeight()>
	//   60  112:aload_0         
	//   61  113:invokevirtual   #248 <Method int getPaddingTop()>
	//   62  116:isub            
	//   63  117:aload_0         
	//   64  118:invokevirtual   #260 <Method int getPaddingBottom()>
	//   65  121:isub            
	//   66  122:istore          5
			else
	//*  67  124:goto            130
	...
	//   69  128:istore          5
			if(mRecyclerView.canScrollHorizontally(1))
	//*  70  130:aload_0         
	//*  71  131:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  72  134:iconst_1        
	//*  73  135:invokevirtual   #758 <Method boolean RecyclerView.canScrollHorizontally(int)>
	//*  74  138:ifeq            159
				i = getWidth() - getPaddingLeft() - getPaddingRight();
	//   75  141:aload_0         
	//   76  142:invokevirtual   #251 <Method int getWidth()>
	//   77  145:aload_0         
	//   78  146:invokevirtual   #245 <Method int getPaddingLeft()>
	//   79  149:isub            
	//   80  150:aload_0         
	//   81  151:invokevirtual   #254 <Method int getPaddingRight()>
	//   82  154:isub            
	//   83  155:istore_3        
			else
	//*  84  156:goto            161
	...
	//   93  172:aload_0         
	//   94  173:getfield        #89  <Field RecyclerView mRecyclerView>
	//   95  176:iload_3         
	//   96  177:iload           5
	//   97  179:invokevirtual   #873 <Method void RecyclerView.smoothScrollBy(int, int)>
			return true;
	//   98  182:iconst_1        
	//   99  183:ireturn         
		}
	...
	//    8   16:iload_2         
	//    9   17:aload_3         
	//   10   18:invokevirtual   #878 <Method boolean performAccessibilityActionForItem(RecyclerView$Recycler, RecyclerView$State, View, int, Bundle)>
	//   11   21:ireturn         
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokestatic    #883 <Method void ViewCompat.postOnAnimation(View, Runnable)>
	//    8   14:return          
	}
	...
	//    7   11:aload_0         
	//    8   12:getfield        #122 <Field ChildHelper mChildHelper>
	//    9   15:iload_1         
	//   10   16:invokevirtual   #885 <Method void ChildHelper.removeViewAt(int)>
	...
	//*   7   11:aload_0         
	//*   8   12:iload_2         
	//*   9   13:invokevirtual   #450 <Method View getChildAt(int)>
	//*  10   16:invokestatic    #81  <Method RecyclerView$ViewHolder RecyclerView.getChildViewHolderInt(View)>
	//*  11   19:invokevirtual   #367 <Method boolean RecyclerView$ViewHolder.shouldIgnore()>
	//*  12   22:ifne            31
				removeAndRecycleViewAt(i, recycler);
	//   13   25:aload_0         
	//   14   26:iload_2         
	//   15   27:aload_1         
	//   16   28:invokevirtual   #889 <Method void removeAndRecycleViewAt(int, RecyclerView$Recycler)>
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #893 <Method int RecyclerView$Recycler.getScrapCount()>
	//    2    4:istore_3        
		for(int i = j - 1; i >= 0; i--)
	//*   3    5:iload_3         
	//*   4    6:iconst_1        
	...
	//    9   13:aload_1         
	//   10   14:iload_2         
	//   11   15:invokevirtual   #896 <Method View RecyclerView$Recycler.getScrapViewAt(int)>
	//   12   18:astore          4
			RecyclerView.ViewHolder viewholder = RecyclerView.getChildViewHolderInt(view);
	//   13   20:aload           4
	...
	//   15   25:astore          5
			if(viewholder.shouldIgnore())
	//*  16   27:aload           5
	//*  17   29:invokevirtual   #367 <Method boolean RecyclerView$ViewHolder.shouldIgnore()>
	//*  18   32:ifeq            38
				continue;
	//   19   35:goto            96
	...
	//   20   38:aload           5
	//   21   40:iconst_0        
	//   22   41:invokevirtual   #899 <Method void RecyclerView$ViewHolder.setIsRecyclable(boolean)>
			if(viewholder.isTmpDetached())
	//*  23   44:aload           5
	//*  24   46:invokevirtual   #902 <Method boolean RecyclerView$ViewHolder.isTmpDetached()>
	//*  25   49:ifeq            62
	...
	//   28   56:aload           4
	//   29   58:iconst_0        
	//   30   59:invokevirtual   #906 <Method void RecyclerView.removeDetachedView(View, boolean)>
			if(mRecyclerView.mItemAnimator != null)
	//*  31   62:aload_0         
	//*  32   63:getfield        #89  <Field RecyclerView mRecyclerView>
	//*  33   66:getfield        #474 <Field RecyclerView$ItemAnimator RecyclerView.mItemAnimator>
	//*  34   69:ifnull          84
				mRecyclerView.mItemAnimator.endAnimation(viewholder);
	//   35   72:aload_0         
	//   36   73:getfield        #89  <Field RecyclerView mRecyclerView>
	//   37   76:getfield        #474 <Field RecyclerView$ItemAnimator RecyclerView.mItemAnimator>
	//   38   79:aload           5
	//   39   81:invokevirtual   #478 <Method void RecyclerView$ItemAnimator.endAnimation(RecyclerView$ViewHolder)>
			viewholder.setIsRecyclable(true);
	//   40   84:aload           5
	//   41   86:iconst_1        
	//   42   87:invokevirtual   #899 <Method void RecyclerView$ViewHolder.setIsRecyclable(boolean)>
			recycler.quickRecycleScrapView(view);
	//   43   90:aload_1         
	//   44   91:aload           4
	//   45   93:invokevirtual   #909 <Method void RecyclerView$Recycler.quickRecycleScrapView(View)>
		}
	...
	//*  50  100:goto            9
		recycler.clearScrap();
	//   51  103:aload_1         
	//   52  104:invokevirtual   #912 <Method void RecyclerView$Recycler.clearScrap()>
		if(j > 0)
	//*  53  107:iload_3         
	//*  54  108:ifle            118
	...
	//   57  115:invokevirtual   #913 <Method void RecyclerView.invalidate()>
	//   58  118:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokevirtual   #917 <Method void removeView(View)>
		recycler.recycleView(view);
	//    3    5:aload_2         
	//    4    6:aload_1         
	//    5    7:invokevirtual   #920 <Method void RecyclerView$Recycler.recycleView(View)>
	//    6   10:return          
	}
	...
	//    4    6:aload_0         
	//    5    7:iload_1         
	//    6    8:invokevirtual   #382 <Method void removeViewAt(int)>
		recycler.recycleView(view);
	//    7   11:aload_2         
	//    8   12:aload_3         
	//    9   13:invokevirtual   #920 <Method void RecyclerView$Recycler.recycleView(View)>
	//   10   16:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #924 <Method boolean RecyclerView.removeCallbacks(Runnable)>
	//    8   14:ireturn         
		else
			return false;
	//    9   15:iconst_0        
	...
	//    2    4:aload_1         
	//    3    5:iconst_0        
	//    4    6:invokevirtual   #906 <Method void RecyclerView.removeDetachedView(View, boolean)>
	//    5    9:return          
	}
	...
	//    1    1:getfield        #122 <Field ChildHelper mChildHelper>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #925 <Method void ChildHelper.removeView(View)>
	//    4    8:return          
	}
	...
	//    4    4:iload           4
	//    5    6:iconst_0        
	//    6    7:invokevirtual   #930 <Method boolean requestChildRectangleOnScreen(RecyclerView, View, Rect, boolean, boolean)>
	//    7   10:ireturn         
	}
	...
	//    3    3:aload_3         
	//    4    4:iload           4
	//    5    6:invokespecial   #932 <Method int[] getChildRectangleOnScreenScrollAmount(RecyclerView, View, Rect, boolean)>
	//    6    9:astore_2        
		int i = view[0];
	//    7   10:aload_2         
	//    8   11:iconst_0        
	...
	//*  19   27:iload           6
	//*  20   29:iload           7
	//*  21   31:invokespecial   #934 <Method boolean isFocusedChildVisibleAfterScrolling(RecyclerView, int, int)>
	//*  22   34:ifeq            50
	//*  23   37:iload           6
	//*  24   39:ifne            52
	//*  25   42:iload           7
	...
	//   33   58:iload           6
	//   34   60:iload           7
	//   35   62:invokevirtual   #937 <Method void RecyclerView.scrollBy(int, int)>
			return true;
	//   36   65:iconst_1        
	//   37   66:ireturn         
		} else
	...
	//   39   68:iload           6
	//   40   70:iload           7
	//   41   72:invokevirtual   #873 <Method void RecyclerView.smoothScrollBy(int, int)>
			return true;
	//   42   75:iconst_1        
	//   43   76:ireturn         
		}
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #940 <Method void RecyclerView.requestLayout()>
	//    7   13:return          
	}
	...
	//    7   13:aload_0         
	//    8   14:iconst_0        
	//    9   15:putfield        #955 <Field int mPrefetchMaxCountObserved>
			RecyclerView recyclerview = mRecyclerView;
	//   10   18:aload_0         
	//   11   19:getfield        #89  <Field RecyclerView mRecyclerView>
	//   12   22:astore_2        
			if(recyclerview != null)
	//*  13   23:aload_2         
	//*  14   24:ifnull          34
	...
	//   15   27:aload_2         
	//   16   28:getfield        #772 <Field RecyclerView$Recycler RecyclerView.mRecycler>
	//   17   31:invokevirtual   #958 <Method void RecyclerView$Recycler.updateViewCacheSize()>
		}
	//   18   34:return          
	}
	...
	//*  10   20:ifne            34
	//*  11   23:getstatic       #961 <Field boolean RecyclerView.ALLOW_SIZE_IN_UNSPECIFIED_SPEC>
	//*  12   26:ifne            34
			mWidth = 0;
	//   13   29:aload_0         
	//   14   30:iconst_0        
	...
	//*  26   54:ifne            68
	//*  27   57:getstatic       #961 <Field boolean RecyclerView.ALLOW_SIZE_IN_UNSPECIFIED_SPEC>
	//*  28   60:ifne            68
			mHeight = 0;
	//   29   63:aload_0         
	//   30   64:iconst_0        
	...
	//    2    4:iload_1         
	//    3    5:iload_2         
	//    4    6:invokestatic    #965 <Method void RecyclerView.access$300(RecyclerView, int, int)>
	//    5    9:return          
	}
	...
	public void setMeasuredDimension(Rect rect, int i, int j)
	{
		int k = rect.width();
	//    0    0:aload_1         
	//    1    1:invokevirtual   #283 <Method int Rect.width()>
	//    2    4:istore          4
		int l = getPaddingLeft();
	//    3    6:aload_0         
	//    4    7:invokevirtual   #245 <Method int getPaddingLeft()>
	//    5   10:istore          5
		int i1 = getPaddingRight();
	//    6   12:aload_0         
	//    7   13:invokevirtual   #254 <Method int getPaddingRight()>
	//    8   16:istore          6
		int j1 = rect.height();
	//    9   18:aload_1         
	//   10   19:invokevirtual   #286 <Method int Rect.height()>
	//   11   22:istore          7
		int k1 = getPaddingTop();
	//   12   24:aload_0         
	//   13   25:invokevirtual   #248 <Method int getPaddingTop()>
	//   14   28:istore          8
		int l1 = getPaddingBottom();
	//   15   30:aload_0         
	//   16   31:invokevirtual   #260 <Method int getPaddingBottom()>
	...
	//   24   45:iadd            
	//   25   46:aload_0         
	//   26   47:invokevirtual   #968 <Method int getMinimumWidth()>
	//   27   50:invokestatic    #970 <Method int chooseSize(int, int, int)>
	//   28   53:iload_3         
	//   29   54:iload           7
	//   30   56:iload           8
	//   31   58:iadd            
	...
	//   33   61:iadd            
	//   34   62:aload_0         
	//   35   63:invokevirtual   #972 <Method int getMinimumHeight()>
	//   36   66:invokestatic    #970 <Method int chooseSize(int, int, int)>
	//   37   69:invokevirtual   #974 <Method void setMeasuredDimension(int, int)>
	//   38   72:return          
	}
	...
	//    7   15:iload_1         
	//    8   16:iload_2         
	//    9   17:invokevirtual   #848 <Method void RecyclerView.defaultOnMeasure(int, int)>
			return;
	//   10   20:return          
		}
		int l = 0;
	...
	//   12   22:istore          4
		int i2 = 0x7fffffff;
	//   13   24:ldc2            #976 <Int 0x7fffffff>
	//   14   27:istore          9
		int k1 = 0x80000000;
	//   15   29:ldc1            #214 <Int 0x80000000>
	//   16   31:istore          7
		int k = k1;
	//   17   33:iload           7
	//   18   35:istore_3        
		int j1 = 0x7fffffff;
	//   19   36:ldc2            #976 <Int 0x7fffffff>
	//   20   39:istore          6
		while(l < k2) 
	//*  21   41:iload           4
	//*  22   43:iload           11
	...
	//   24   48:aload_0         
	//   25   49:iload           4
	//   26   51:invokevirtual   #450 <Method View getChildAt(int)>
	//   27   54:astore          12
			Rect rect = mRecyclerView.mTempRect;
	//   28   56:aload_0         
	//   29   57:getfield        #89  <Field RecyclerView mRecyclerView>
	//   30   60:getfield        #350 <Field Rect RecyclerView.mTempRect>
	//   31   63:astore          13
			getDecoratedBoundsWithMargins(view, rect);
	//   32   65:aload_0         
	//   33   66:aload           12
	//   34   68:aload           13
	//   35   70:invokevirtual   #354 <Method void getDecoratedBoundsWithMargins(View, Rect)>
			int i1 = i2;
	//   36   73:iload           9
	//   37   75:istore          5
			if(rect.left < i2)
	//*  38   77:aload           13
	//*  39   79:getfield        #268 <Field int Rect.left>
	//*  40   82:iload           9
	//*  41   84:icmpge          94
				i1 = rect.left;
	//   42   87:aload           13
	//   43   89:getfield        #268 <Field int Rect.left>
	//   44   92:istore          5
			int l1 = k1;
	//   45   94:iload           7
	//   46   96:istore          8
			if(rect.right > k1)
	//*  47   98:aload           13
	//*  48  100:getfield        #357 <Field int Rect.right>
	//*  49  103:iload           7
	//*  50  105:icmple          115
				l1 = rect.right;
	//   51  108:aload           13
	//   52  110:getfield        #357 <Field int Rect.right>
	//   53  113:istore          8
			k1 = j1;
	//   54  115:iload           6
	//   55  117:istore          7
			if(rect.top < j1)
	//*  56  119:aload           13
	//*  57  121:getfield        #277 <Field int Rect.top>
	//*  58  124:iload           6
	//*  59  126:icmpge          136
				k1 = rect.top;
	//   60  129:aload           13
	//   61  131:getfield        #277 <Field int Rect.top>
	//   62  134:istore          7
			int j2 = k;
	//   63  136:iload_3         
	//   64  137:istore          10
			if(rect.bottom > k)
	//*  65  139:aload           13
	//*  66  141:getfield        #360 <Field int Rect.bottom>
	//*  67  144:iload_3         
	//*  68  145:icmple          155
				j2 = rect.bottom;
	//   69  148:aload           13
	//   70  150:getfield        #360 <Field int Rect.bottom>
	//   71  153:istore          10
			l++;
	//   72  155:iload           4
	//   73  157:iconst_1        
	...
	//   87  183:getfield        #350 <Field Rect RecyclerView.mTempRect>
	//   88  186:iload           9
	//   89  188:iload           6
	//   90  190:iload           7
	//   91  192:iload_3         
	//   92  193:invokevirtual   #421 <Method void Rect.set(int, int, int, int)>
		setMeasuredDimension(mRecyclerView.mTempRect, i, j);
	//   93  196:aload_0         
	//   94  197:aload_0         
	//   95  198:getfield        #89  <Field RecyclerView mRecyclerView>
	//   96  201:getfield        #350 <Field Rect RecyclerView.mTempRect>
	//   97  204:iload_1         
	//   98  205:iload_2         
	//   99  206:invokevirtual   #978 <Method void setMeasuredDimension(Rect, int, int)>
	//  100  209:return          
	}
	...
	//   18   32:aload_0         
	//   19   33:aload_1         
	//   20   34:getfield        #981 <Field ChildHelper RecyclerView.mChildHelper>
	//   21   37:putfield        #122 <Field ChildHelper mChildHelper>
			mWidth = recyclerview.getWidth();
	//   22   40:aload_0         
	//   23   41:aload_1         
	//   24   42:invokevirtual   #948 <Method int RecyclerView.getWidth()>
	//   25   45:putfield        #654 <Field int mWidth>
			mHeight = recyclerview.getHeight();
	//   26   48:aload_0         
	//   27   49:aload_1         
	//   28   50:invokevirtual   #949 <Method int RecyclerView.getHeight()>
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #984 <Method boolean View.isLayoutRequested()>
	//    2    4:ifne            51
	//    3    7:aload_0         
	...
	//    8   18:iload_2         
	//    9   19:aload           4
	//   10   21:getfield        #718 <Field int RecyclerView$LayoutParams.width>
	//   11   24:invokestatic    #986 <Method boolean isMeasurementUpToDate(int, int, int)>
	//   12   27:ifeq            51
	//   13   30:aload_1         
	//   14   31:invokevirtual   #613 <Method int View.getHeight()>
	//   15   34:iload_3         
	//   16   35:aload           4
	//   17   37:getfield        #723 <Field int RecyclerView$LayoutParams.height>
	//   18   40:invokestatic    #986 <Method boolean isMeasurementUpToDate(int, int, int)>
	//   19   43:ifne            49
	//   20   46:goto            51
	//   21   49:iconst_0        
	//   22   50:ireturn         
	...
	//    2    4:ifeq            44
	//    3    7:aload_1         
	//    4    8:invokevirtual   #557 <Method int View.getMeasuredWidth()>
	//    5   11:iload_2         
	//    6   12:aload           4
	//    7   14:getfield        #718 <Field int RecyclerView$LayoutParams.width>
	//    8   17:invokestatic    #986 <Method boolean isMeasurementUpToDate(int, int, int)>
	//    9   20:ifeq            44
	//   10   23:aload_1         
	//   11   24:invokevirtual   #553 <Method int View.getMeasuredHeight()>
	//   12   27:iload_3         
	//   13   28:aload           4
	//   14   30:getfield        #723 <Field int RecyclerView$LayoutParams.height>
	//   15   33:invokestatic    #986 <Method boolean isMeasurementUpToDate(int, int, int)>
	//   16   36:ifne            42
	//   17   39:goto            44
	//   18   42:iconst_0        
	//   19   43:ireturn         
	...
	//    0    0:ldc2            #833 <String "RecyclerView">
	//    1    3:ldc2            #992 <String "You must override smoothScrollToPosition to support smooth scrolling">
	//    2    6:invokestatic    #841 <Method int Log.e(String, String)>
	//    3    9:pop             
	//    4   10:return          
	}
	...
	//   13   25:invokevirtual   #996 <Method void RecyclerView$SmoothScroller.stop()>
		mSmoothScroller = ;
	//   14   28:aload_0         
	//   15   29:aload_1         
	...
	//   21   41:aload_0         
	//   22   42:invokevirtual   #1000 <Method void RecyclerView$SmoothScroller.start(RecyclerView, RecyclerView$LayoutManager)>
	//   23   45:return          
	}
	...
	//    3    5:aload_1         
	//    4    6:invokevirtual   #1004 <Method void RecyclerView$ViewHolder.stopIgnoring()>
		((RecyclerView.ViewHolder) (view)).resetInternal();
	//    5    9:aload_1         
	//    6   10:invokevirtual   #1007 <Method void RecyclerView$ViewHolder.resetInternal()>
		((RecyclerView.ViewHolder) (view)).addFlags(4);
	//    7   13:aload_1         
	//    8   14:iconst_4        
	//    9   15:invokevirtual   #671 <Method void RecyclerView$ViewHolder.addFlags(int)>
	//   10   18:return          
	}
	...
	//*   4    6:ifnull          13
			.stop();
	//    5    9:aload_1         
	//    6   10:invokevirtual   #996 <Method void RecyclerView$SmoothScroller.stop()>
	//    7   13:return          
	}
