...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper
{
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #129 <Method void Drawable.jumpToCurrentState()>
	//    7   13:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #133 <Method void AppCompatProgressBarHelper.loadFromAttributes(AttributeSet, int)>
	...
	//    6   10:invokevirtual   #137 <Method android.content.Context SeekBar.getContext()>
	//    7   13:aload_1         
	//    8   14:getstatic       #143 <Field int[] android.support.v7.appcompat.R$styleable.AppCompatSeekBar>
	//    9   17:iload_2         
	//   10   18:iconst_0        
	//   11   19:invokestatic    #149 <Method TintTypedArray TintTypedArray.obtainStyledAttributes(android.content.Context, AttributeSet, int[], int, int)>
	//   12   22:astore_1        
	...
	//   13   23:aload_1         
	//   14   24:getstatic       #153 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_android_thumb>
	//   15   27:invokevirtual   #157 <Method Drawable TintTypedArray.getDrawableIfKnown(int)>
	//   16   30:astore_3        
		if(drawable != null)
	//*  17   31:aload_3         
	//*  18   32:ifnull          43
	...
	//   21   39:aload_3         
	//   22   40:invokevirtual   #160 <Method void SeekBar.setThumb(Drawable)>
		setTickMark(((TintTypedArray) (attributeset)).getDrawable(android.support.v7.appcompat.R.styleable.AppCompatSeekBar_tickMark));
	//   23   43:aload_0         
	//   24   44:aload_1         
	//   25   45:getstatic       #163 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMark>
	//   26   48:invokevirtual   #166 <Method Drawable TintTypedArray.getDrawable(int)>
	//   27   51:invokevirtual   #169 <Method void setTickMark(Drawable)>
		if(((TintTypedArray) (attributeset)).hasValue(android.support.v7.appcompat.R.styleable.AppCompatSeekBar_tickMarkTintMode))
	//*  28   54:aload_1         
	//*  29   55:getstatic       #172 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTintMode>
	//*  30   58:invokevirtual   #176 <Method boolean TintTypedArray.hasValue(int)>
	//*  31   61:ifeq            88
		{
	...
	//   32   64:aload_0         
	//   33   65:aload_1         
	//   34   66:getstatic       #172 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTintMode>
	//   35   69:iconst_m1       
	//   36   70:invokevirtual   #180 <Method int TintTypedArray.getInt(int, int)>
	//   37   73:aload_0         
	//   38   74:getfield        #24  <Field android.graphics.PorterDuff$Mode mTickMarkTintMode>
	//   39   77:invokestatic    #186 <Method android.graphics.PorterDuff$Mode DrawableUtils.parseTintMode(int, android.graphics.PorterDuff$Mode)>
	...
	//*  44   88:aload_1         
	//*  45   89:getstatic       #189 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTint>
	//*  46   92:invokevirtual   #176 <Method boolean TintTypedArray.hasValue(int)>
	//*  47   95:ifeq            114
		{
	...
	//   48   98:aload_0         
	//   49   99:aload_1         
	//   50  100:getstatic       #189 <Field int android.support.v7.appcompat.R$styleable.AppCompatSeekBar_tickMarkTint>
	//   51  103:invokevirtual   #193 <Method ColorStateList TintTypedArray.getColorStateList(int)>
	...
	//   56  114:aload_1         
	//   57  115:invokevirtual   #196 <Method void TintTypedArray.recycle()>
		applyTickMarkTint();
	//   58  118:aload_0         
	//   59  119:invokespecial   #198 <Method void applyTickMarkTint()>
	//   60  122:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aconst_null     
	//    7   11:invokevirtual   #202 <Method void Drawable.setCallback(android.graphics.drawable.Drawable$Callback)>
		mTickMark = drawable;
	//    8   14:aload_0         
	//    9   15:aload_1         
	...
	//   16   28:invokevirtual   #202 <Method void Drawable.setCallback(android.graphics.drawable.Drawable$Callback)>
	...
	//   20   36:invokestatic    #208 <Method int ViewCompat.getLayoutDirection(android.view.View)>
	//   21   39:invokestatic    #212 <Method boolean DrawableCompat.setLayoutDirection(Drawable, int)>
	//   22   42:pop             
	...
	//   31   61:pop             
			applyTickMarkTint();
	//   32   62:aload_0         
	//   33   63:invokespecial   #198 <Method void applyTickMarkTint()>
		}
		mView.invalidate();
	//   34   66:aload_0         
	//   35   67:getfield        #30  <Field SeekBar mView>
	//   36   70:invokevirtual   #215 <Method void SeekBar.invalidate()>
	//   37   73:return          
	}
	...
	//    5    7:putfield        #26  <Field boolean mHasTickMarkTint>
		applyTickMarkTint();
	//    6   10:aload_0         
	//    7   11:invokespecial   #198 <Method void applyTickMarkTint()>
	//    8   14:return          
	}
