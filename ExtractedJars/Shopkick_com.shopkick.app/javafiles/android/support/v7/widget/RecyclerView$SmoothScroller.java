...
public static abstract class RecyclerView$SmoothScroller
{
	...
	//    1    1:getfield        #79  <Field RecyclerView mRecyclerView>
	//    2    4:iload_1         
	//    3    5:invokevirtual   #104 <Method void RecyclerView.scrollToPosition(int)>
	//    4    8:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #109 <Field boolean mPendingInitialRun>
	//    2    4:ireturn         
	}
	...
	public boolean isRunning()
	{
		return mRunning;
	//    0    0:aload_0         
	//    1    1:getfield        #112 <Field boolean mRunning>
	//    2    4:ireturn         
	}
	...
	//    0    0:aload_1         
	//    1    1:getfield        #121 <Field float PointF.x>
	//    2    4:aload_1         
	//    3    5:getfield        #121 <Field float PointF.x>
	//    4    8:fmul            
	//    5    9:aload_1         
	//    6   10:getfield        #124 <Field float PointF.y>
	//    7   13:aload_1         
	//    8   14:getfield        #124 <Field float PointF.y>
	//    9   17:fmul            
	//   10   18:fadd            
	//   11   19:f2d             
	//   12   20:invokestatic    #130 <Method double Math.sqrt(double)>
	//   13   23:d2f             
	//   14   24:fstore_2        
		pointf.x = pointf.x / f;
	//   15   25:aload_1         
	//   16   26:aload_1         
	//   17   27:getfield        #121 <Field float PointF.x>
	//   18   30:fload_2         
	//   19   31:fdiv            
	//   20   32:putfield        #121 <Field float PointF.x>
		pointf.y = pointf.y / f;
	//   21   35:aload_1         
	//   22   36:aload_1         
	//   23   37:getfield        #124 <Field float PointF.y>
	//   24   40:fload_2         
	//   25   41:fdiv            
	//   26   42:putfield        #124 <Field float PointF.y>
	//   27   45:return          
	}
	...
	//*   3    6:aload_0         
	//*   4    7:getfield        #112 <Field boolean mRunning>
	//*   5   10:ifeq            26
	//*   6   13:aload_0         
	...
	//*  11   23:ifnonnull       30
			stop();
	//   12   26:aload_0         
	//   13   27:invokevirtual   #135 <Method void stop()>
		if(mPendingInitialRun && mTargetView == null && mLayoutManager != null)
	//*  14   30:aload_0         
	//*  15   31:getfield        #109 <Field boolean mPendingInitialRun>
	//*  16   34:ifeq            110
	//*  17   37:aload_0         
	//*  18   38:getfield        #137 <Field View mTargetView>
	//*  19   41:ifnonnull       110
	//*  20   44:aload_0         
	...
	//   26   56:invokevirtual   #138 <Method PointF computeScrollVectorForPosition(int)>
	//   27   59:astore          5
			if(pointf != null && (pointf.x != 0.0F || pointf.y != 0.0F))
	//*  28   61:aload           5
	//*  29   63:ifnull          110
	//*  30   66:aload           5
	//*  31   68:getfield        #121 <Field float PointF.x>
	//*  32   71:fconst_0        
	//*  33   72:fcmpl           
	//*  34   73:ifne            86
	//*  35   76:aload           5
	//*  36   78:getfield        #124 <Field float PointF.y>
	//*  37   81:fconst_0        
	//*  38   82:fcmpl           
	//*  39   83:ifeq            110
	...
	//   40   86:aload           4
	//   41   88:aload           5
	//   42   90:getfield        #121 <Field float PointF.x>
	//   43   93:invokestatic    #142 <Method float Math.signum(float)>
	//   44   96:f2i             
	//   45   97:aload           5
	//   46   99:getfield        #124 <Field float PointF.y>
	//   47  102:invokestatic    #142 <Method float Math.signum(float)>
	//   48  105:f2i             
	//   49  106:aconst_null     
	//   50  107:invokevirtual   #146 <Method void RecyclerView.scrollStep(int, int, int[])>
		}
		mPendingInitialRun = false;
	//   51  110:aload_0         
	//   52  111:iconst_0        
	//   53  112:putfield        #109 <Field boolean mPendingInitialRun>
		View view = mTargetView;
	//   54  115:aload_0         
	//   55  116:getfield        #137 <Field View mTargetView>
	//   56  119:astore          5
		if(view != null)
	//*  57  121:aload           5
	//*  58  123:ifnull          185
	...
	//*  59  126:aload_0         
	//*  60  127:aload           5
	//*  61  129:invokevirtual   #148 <Method int getChildPosition(View)>
	//*  62  132:aload_0         
	...
	//   65  139:aload_0         
	//   66  140:aload_0         
	//   67  141:getfield        #137 <Field View mTargetView>
	//   68  144:aload           4
	//   69  146:getfield        #152 <Field RecyclerView$State RecyclerView.mState>
	//   70  149:aload_0         
	//   71  150:getfield        #38  <Field RecyclerView$SmoothScroller$Action mRecyclingAction>
	//   72  153:invokevirtual   #156 <Method void onTargetFound(View, RecyclerView$State, RecyclerView$SmoothScroller$Action)>
				mRecyclingAction.runIfNecessary(recyclerview);
	//   73  156:aload_0         
	//   74  157:getfield        #38  <Field RecyclerView$SmoothScroller$Action mRecyclingAction>
	//   75  160:aload           4
	//   76  162:invokevirtual   #160 <Method void RecyclerView$SmoothScroller$Action.runIfNecessary(RecyclerView)>
				stop();
	//   77  165:aload_0         
	//   78  166:invokevirtual   #135 <Method void stop()>
			} else
	//*  79  169:goto            185
			{
				Log.e("RecyclerView", "Passed over target position while smooth scrolling.");
	//   80  172:ldc1            #65  <String "RecyclerView">
	//   81  174:ldc1            #162 <String "Passed over target position while smooth scrolling.">
	//   82  176:invokestatic    #165 <Method int Log.e(String, String)>
	//   83  179:pop             
				mTargetView = null;
	//   84  180:aload_0         
	//   85  181:aconst_null     
	//   86  182:putfield        #137 <Field View mTargetView>
			}
		if(mRunning)
	//*  87  185:aload_0         
	//*  88  186:getfield        #112 <Field boolean mRunning>
	//*  89  189:ifeq            253
		{
	...
	//   92  194:iload_2         
	//   93  195:aload           4
	//   94  197:getfield        #152 <Field RecyclerView$State RecyclerView.mState>
	//   95  200:aload_0         
	//   96  201:getfield        #38  <Field RecyclerView$SmoothScroller$Action mRecyclingAction>
	//   97  204:invokevirtual   #169 <Method void onSeekTargetStep(int, int, RecyclerView$State, RecyclerView$SmoothScroller$Action)>
			boolean flag = mRecyclingAction.hasJumpTarget();
	//   98  207:aload_0         
	//   99  208:getfield        #38  <Field RecyclerView$SmoothScroller$Action mRecyclingAction>
	//  100  211:invokevirtual   #172 <Method boolean RecyclerView$SmoothScroller$Action.hasJumpTarget()>
	//  101  214:istore_3        
			mRecyclingAction.runIfNecessary(recyclerview);
	//  102  215:aload_0         
	//  103  216:getfield        #38  <Field RecyclerView$SmoothScroller$Action mRecyclingAction>
	//  104  219:aload           4
	//  105  221:invokevirtual   #160 <Method void RecyclerView$SmoothScroller$Action.runIfNecessary(RecyclerView)>
			if(flag)
	//* 106  224:iload_3         
	//* 107  225:ifeq            253
			{
				if(mRunning)
	//* 108  228:aload_0         
	//* 109  229:getfield        #112 <Field boolean mRunning>
	//* 110  232:ifeq            249
				{
					mPendingInitialRun = true;
	//  111  235:aload_0         
	//  112  236:iconst_1        
	//  113  237:putfield        #109 <Field boolean mPendingInitialRun>
					recyclerview.mViewFlinger.postOnAnimation();
	//  114  240:aload           4
	//  115  242:getfield        #176 <Field RecyclerView$ViewFlinger RecyclerView.mViewFlinger>
	//  116  245:invokevirtual   #181 <Method void RecyclerView$ViewFlinger.postOnAnimation()>
					return;
	//  117  248:return          
				}
				stop();
	//  118  249:aload_0         
	//  119  250:invokevirtual   #135 <Method void stop()>
			}
		}
	//  120  253:return          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:aload_1         
	//*   2    2:invokevirtual   #148 <Method int getChildPosition(View)>
	//*   3    5:aload_0         
	//*   4    6:invokevirtual   #185 <Method int getTargetPosition()>
	//*   5    9:icmpne          17
			mTargetView = view;
	//    6   12:aload_0         
	//    7   13:aload_1         
	//    8   14:putfield        #137 <Field View mTargetView>
	//    9   17:return          
	}
	...
	void start(RecyclerView recyclerview, RecyclerView.LayoutManager layoutmanager)
	{
		if(mStarted)
	//*   0    0:aload_0         
	//*   1    1:getfield        #193 <Field boolean mStarted>
	//*   2    4:ifeq            91
		{
			StringBuilder stringbuilder = new StringBuilder();
	...
	//    7   15:aload_3         
	//    8   16:ldc1            #195 <String "An instance of ">
	...
	//   11   22:aload_3         
	//   12   23:aload_0         
	//   13   24:invokevirtual   #199 <Method Class Object.getClass()>
	//   14   27:invokevirtual   #202 <Method String Class.getSimpleName()>
	//   15   30:invokevirtual   #57  <Method StringBuilder StringBuilder.append(String)>
	//   16   33:pop             
			stringbuilder.append(" was started ");
	//   17   34:aload_3         
	//   18   35:ldc1            #204 <String " was started ">
	...
	//   21   41:aload_3         
	//   22   42:ldc1            #206 <String "more than once. Each instance of">
	//   23   44:invokevirtual   #57  <Method StringBuilder StringBuilder.append(String)>
	//   24   47:pop             
			stringbuilder.append(((Object)this).getClass().getSimpleName());
	//   25   48:aload_3         
	//   26   49:aload_0         
	//   27   50:invokevirtual   #199 <Method Class Object.getClass()>
	//   28   53:invokevirtual   #202 <Method String Class.getSimpleName()>
	//   29   56:invokevirtual   #57  <Method StringBuilder StringBuilder.append(String)>
	//   30   59:pop             
			stringbuilder.append(" ");
	//   31   60:aload_3         
	//   32   61:ldc1            #208 <String " ">
	...
	//   35   67:aload_3         
	//   36   68:ldc1            #210 <String "is intended to only be used once. You should create a new instance for ">
	//   37   70:invokevirtual   #57  <Method StringBuilder StringBuilder.append(String)>
	//   38   73:pop             
			stringbuilder.append("each use.");
	//   39   74:aload_3         
	//   40   75:ldc1            #212 <String "each use.">
	...
	//   60  113:getfield        #152 <Field RecyclerView$State RecyclerView.mState>
	//   61  116:aload_0         
	//   62  117:getfield        #33  <Field int mTargetPosition>
	//   63  120:putfield        #215 <Field int RecyclerView$State.mTargetPosition>
			mRunning = true;
	//   64  123:aload_0         
	//   65  124:iconst_1        
	//   66  125:putfield        #112 <Field boolean mRunning>
			mPendingInitialRun = true;
	//   67  128:aload_0         
	//   68  129:iconst_1        
	//   69  130:putfield        #109 <Field boolean mPendingInitialRun>
			mTargetView = findViewByPosition(getTargetPosition());
	//   70  133:aload_0         
	//   71  134:aload_0         
	//   72  135:aload_0         
	//   73  136:invokevirtual   #185 <Method int getTargetPosition()>
	//   74  139:invokevirtual   #216 <Method View findViewByPosition(int)>
	//   75  142:putfield        #137 <Field View mTargetView>
			onStart();
	//   76  145:aload_0         
	//   77  146:invokevirtual   #218 <Method void onStart()>
			mRecyclerView.mViewFlinger.postOnAnimation();
	//   78  149:aload_0         
	//   79  150:getfield        #79  <Field RecyclerView mRecyclerView>
	//   80  153:getfield        #176 <Field RecyclerView$ViewFlinger RecyclerView.mViewFlinger>
	//   81  156:invokevirtual   #181 <Method void RecyclerView$ViewFlinger.postOnAnimation()>
			mStarted = true;
	//   82  159:aload_0         
	//   83  160:iconst_1        
	//   84  161:putfield        #193 <Field boolean mStarted>
			return;
	//   85  164:return          
		} else
		{
			throw new IllegalArgumentException("Invalid target position");
	//   86  165:new             #220 <Class IllegalArgumentException>
	//   87  168:dup             
	//   88  169:ldc1            #222 <String "Invalid target position">
	//   89  171:invokespecial   #225 <Method void IllegalArgumentException(String)>
	//   90  174:athrow          
		}
	}
	...
	//    4    8:aload_0         
	//    5    9:iconst_0        
	//    6   10:putfield        #112 <Field boolean mRunning>
			onStop();
	//    7   13:aload_0         
	//    8   14:invokevirtual   #227 <Method void onStop()>
			mRecyclerView.mState.mTargetPosition = -1;
	//    9   17:aload_0         
	//   10   18:getfield        #79  <Field RecyclerView mRecyclerView>
	//   11   21:getfield        #152 <Field RecyclerView$State RecyclerView.mState>
	//   12   24:iconst_m1       
	//   13   25:putfield        #215 <Field int RecyclerView$State.mTargetPosition>
			mTargetView = null;
	//   14   28:aload_0         
	//   15   29:aconst_null     
	//   16   30:putfield        #137 <Field View mTargetView>
			mTargetPosition = -1;
	//   17   33:aload_0         
	//   18   34:iconst_m1       
	...
	//   20   38:aload_0         
	//   21   39:iconst_0        
	//   22   40:putfield        #109 <Field boolean mPendingInitialRun>
			mLayoutManager.onSmoothScrollerStopped(this);
	//   23   43:aload_0         
	//   24   44:getfield        #97  <Field RecyclerView$LayoutManager mLayoutManager>
	//   25   47:aload_0         
	//   26   48:invokevirtual   #231 <Method void RecyclerView$LayoutManager.onSmoothScrollerStopped(RecyclerView$SmoothScroller)>
			mLayoutManager = null;
	//   27   51:aload_0         
	//   28   52:aconst_null     
