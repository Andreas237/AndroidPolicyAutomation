	...
	implements TintableBackgroundView
{
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #70  <Method ColorStateList AppCompatBackgroundHelper.getSupportBackgroundTintList()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #75  <Method android.graphics.PorterDuff$Mode AppCompatBackgroundHelper.getSupportBackgroundTintMode()>
	//    7   13:areturn         
		else
			return null;
	//    8   14:aconst_null     
	...
	//    3    8:aload_0         
	//    4    9:invokespecial   #84  <Method Editable EditText.getText()>
	//    5   12:areturn         
		else
			return super.getEditableText();
	//    6   13:aload_0         
	//    7   14:invokespecial   #87  <Method Editable EditText.getEditableText()>
	//    8   17:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #89  <Method Editable getText()>
	//    2    4:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #93  <Method InputConnection EditText.onCreateInputConnection(EditorInfo)>
	//    3    5:aload_1         
	//    4    6:aload_0         
	//    5    7:invokestatic    #98  <Method InputConnection AppCompatHintHelper.onCreateInputConnection(InputConnection, EditorInfo, android.view.View)>
	//    6   10:areturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #102 <Method void EditText.setBackgroundDrawable(Drawable)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	...
	//    8   14:aload_2         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #105 <Method void AppCompatBackgroundHelper.onSetBackgroundDrawable(Drawable)>
	//   11   19:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #110 <Method void EditText.setBackgroundResource(int)>
		AppCompatBackgroundHelper appcompatbackgroundhelper = mBackgroundTintHelper;
	//    3    5:aload_0         
	//    4    6:getfield        #39  <Field AppCompatBackgroundHelper mBackgroundTintHelper>
	//    5    9:astore_2        
	...
	//    8   14:aload_2         
	//    9   15:iload_1         
	//   10   16:invokevirtual   #113 <Method void AppCompatBackgroundHelper.onSetBackgroundResource(int)>
	//   11   19:return          
	}
	...
	//    1    1:aload_0         
	//    2    2:aload_1         
	//    3    3:invokestatic    #122 <Method android.view.ActionMode$Callback TextViewCompat.wrapCustomSelectionActionModeCallback(android.widget.TextView, android.view.ActionMode$Callback)>
	//    4    6:invokespecial   #124 <Method void EditText.setCustomSelectionActionModeCallback(android.view.ActionMode$Callback)>
	//    5    9:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #128 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintList(ColorStateList)>
	//    8   14:return          
	}
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #132 <Method void AppCompatBackgroundHelper.setSupportBackgroundTintMode(android.graphics.PorterDuff$Mode)>
	//    8   14:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #136 <Method void EditText.setTextAppearance(Context, int)>
	...
	//   10   16:aload_1         
	//   11   17:iload_2         
	//   12   18:invokevirtual   #139 <Method void AppCompatTextHelper.onSetTextAppearance(Context, int)>
	//   13   21:return          
	}
