	...
	implements android.view.View.OnClickListener
{
	...
	//*  39   75:aload           4
	//*  40   77:aconst_null     
	//*  41   78:invokestatic    #325 <Method Drawable Drawable.createFromStream(InputStream, String)>
	//*  42   81:astore_3        
	//*  43   82:aload           4
	//*  44   84:invokevirtual   #330 <Method void InputStream.close()>
	//*  45   87:aload_3         
	//*  46   88:areturn         
	//*  47   89:astore          4
	//*  48   91:new             #211 <Class StringBuilder>
	//*  49   94:dup             
	//*  50   95:invokespecial   #212 <Method void StringBuilder()>
	//*  51   98:astore          5
	//*  52  100:aload           5
	//*  53  102:ldc2            #332 <String "Error closing icon stream for ">
	//*  54  105:invokevirtual   #218 <Method StringBuilder StringBuilder.append(String)>
	//*  55  108:pop             
	//*  56  109:aload           5
	//*  57  111:aload_1         
	//*  58  112:invokevirtual   #308 <Method StringBuilder StringBuilder.append(Object)>
	//*  59  115:pop             
	//*  60  116:ldc1            #19  <String "SuggestionsAdapter">
	//*  61  118:aload           5
	//*  62  120:invokevirtual   #229 <Method String StringBuilder.toString()>
	//*  63  123:aload           4
	//*  64  125:invokestatic    #336 <Method int Log.e(String, String, Throwable)>
	//*  65  128:pop             
	//*  66  129:aload_3         
	//*  67  130:areturn         
	//*  68  131:astore_3        
	//*  69  132:aload           4
	//*  70  134:invokevirtual   #330 <Method void InputStream.close()>
	//*  71  137:goto            180
	//*  72  140:astore          4
	//*  73  142:new             #211 <Class StringBuilder>
	//*  74  145:dup             
	//*  75  146:invokespecial   #212 <Method void StringBuilder()>
	//*  76  149:astore          5
	//*  77  151:aload           5
	//*  78  153:ldc2            #332 <String "Error closing icon stream for ">
	//*  79  156:invokevirtual   #218 <Method StringBuilder StringBuilder.append(String)>
	//*  80  159:pop             
	//*  81  160:aload           5
	//*  82  162:aload_1         
	//*  83  163:invokevirtual   #308 <Method StringBuilder StringBuilder.append(Object)>
	//*  84  166:pop             
	//*  85  167:ldc1            #19  <String "SuggestionsAdapter">
	//*  86  169:aload           5
	//*  87  171:invokevirtual   #229 <Method String StringBuilder.toString()>
	//*  88  174:aload           4
	//*  89  176:invokestatic    #336 <Method int Log.e(String, String, Throwable)>
	//*  90  179:pop             
	//*  91  180:aload_3         
	//*  92  181:athrow          
	//*  93  182:new             #211 <Class StringBuilder>
	//*  94  185:dup             
	//*  95  186:invokespecial   #212 <Method void StringBuilder()>
	//*  96  189:astore_3        
	//*  97  190:aload_3         
	//*  98  191:ldc2            #338 <String "Failed to open ">
	//*  99  194:invokevirtual   #218 <Method StringBuilder StringBuilder.append(String)>
	//* 100  197:pop             
	//* 101  198:aload_3         
	//* 102  199:aload_1         
	//* 103  200:invokevirtual   #308 <Method StringBuilder StringBuilder.append(Object)>
	//* 104  203:pop             
	//* 105  204:new             #284 <Class FileNotFoundException>
	//* 106  207:dup             
	//* 107  208:aload_3         
	//* 108  209:invokevirtual   #229 <Method String StringBuilder.toString()>
	//* 109  212:invokespecial   #311 <Method void FileNotFoundException(String)>
	//* 110  215:athrow          
		// Misplaced declaration of an exception variable
...
_L3:
	...
	//    9   13:aload_1         
	//   10   14:iload_2         
	//   11   15:invokeinterface #388 <Method String Cursor.getString(int)>
	//   12   20:invokespecial   #390 <Method Drawable getDrawableFromResourceValue(String)>
	//   13   23:astore_3        
		if(drawable != null)
	//*  14   24:aload_3         
	//*  15   25:ifnull          30
	...
	//   18   30:aload_0         
	//   19   31:aload_1         
	//   20   32:invokespecial   #392 <Method Drawable getDefaultIcon1(Cursor)>
	//   21   35:areturn         
	}
	...
	//   14   23:aload_0         
	//   15   24:invokestatic    #336 <Method int Log.e(String, String, Throwable)>
	//   16   27:pop             
			return null;
	//   17   28:aconst_null     
	//   18   29:areturn         
	...
	//   10   20:aload_3         
	//   11   21:iload           4
	//   12   23:invokeinterface #452 <Method int Cursor.getInt(int)>
	//   13   28:istore          4
		else
	//*  14   30:goto            36
			i = 0;
	...
	//*  17   36:aload_2         
	//*  18   37:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//*  19   40:ifnull          61
		{
			view = ((View) (getStringOrNull(cursor, mText1Col)));
	//   20   43:aload_3         
	//   21   44:aload_0         
	//   22   45:getfield        #65  <Field int mText1Col>
	//   23   48:invokestatic    #268 <Method String getStringOrNull(Cursor, int)>
	//   24   51:astore_1        
			setViewText(((ChildViewCache) (context)).mText1, ((CharSequence) (view)));
	//   25   52:aload_0         
	//   26   53:aload_2         
	//   27   54:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//   28   57:aload_1         
	//   29   58:invokespecial   #458 <Method void setViewText(TextView, CharSequence)>
		}
		if(((ChildViewCache) (context)).mText2 != null)
	//*  30   61:aload_2         
	//*  31   62:getfield        #461 <Field TextView SuggestionsAdapter$ChildViewCache.mText2>
	//*  32   65:ifnull          164
		{
			view = ((View) (getStringOrNull(cursor, mText2UrlCol)));
	//   33   68:aload_3         
	//   34   69:aload_0         
	//   35   70:getfield        #69  <Field int mText2UrlCol>
	//   36   73:invokestatic    #268 <Method String getStringOrNull(Cursor, int)>
	//   37   76:astore_1        
			if(view != null)
	//*  38   77:aload_1         
	//*  39   78:ifnull          90
	...
	//   40   81:aload_0         
	//   41   82:aload_1         
	//   42   83:invokespecial   #463 <Method CharSequence formatUrl(CharSequence)>
	//   43   86:astore_1        
			else
	//*  44   87:goto            99
	...
	//   45   90:aload_3         
	//   46   91:aload_0         
	//   47   92:getfield        #67  <Field int mText2Col>
	//   48   95:invokestatic    #268 <Method String getStringOrNull(Cursor, int)>
	//   49   98:astore_1        
			if(TextUtils.isEmpty(((CharSequence) (view))))
	//*  50   99:aload_1         
	//*  51  100:invokestatic    #425 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  52  103:ifeq            132
			{
				if(((ChildViewCache) (context)).mText1 != null)
	//*  53  106:aload_2         
	//*  54  107:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//*  55  110:ifnull          155
				{
					((ChildViewCache) (context)).mText1.setSingleLine(false);
	//   56  113:aload_2         
	//   57  114:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//   58  117:iconst_0        
	//   59  118:invokevirtual   #467 <Method void TextView.setSingleLine(boolean)>
					((ChildViewCache) (context)).mText1.setMaxLines(2);
	//   60  121:aload_2         
	//   61  122:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//   62  125:iconst_2        
	//   63  126:invokevirtual   #470 <Method void TextView.setMaxLines(int)>
				}
			} else
	//*  64  129:goto            155
			if(((ChildViewCache) (context)).mText1 != null)
	//*  65  132:aload_2         
	//*  66  133:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//*  67  136:ifnull          155
			{
				((ChildViewCache) (context)).mText1.setSingleLine(true);
	//   68  139:aload_2         
	//   69  140:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//   70  143:iconst_1        
	//   71  144:invokevirtual   #467 <Method void TextView.setSingleLine(boolean)>
				((ChildViewCache) (context)).mText1.setMaxLines(1);
	//   72  147:aload_2         
	//   73  148:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//   74  151:iconst_1        
	//   75  152:invokevirtual   #470 <Method void TextView.setMaxLines(int)>
			}
			setViewText(((ChildViewCache) (context)).mText2, ((CharSequence) (view)));
	//   76  155:aload_0         
	//   77  156:aload_2         
	//   78  157:getfield        #461 <Field TextView SuggestionsAdapter$ChildViewCache.mText2>
	//   79  160:aload_1         
	//   80  161:invokespecial   #458 <Method void setViewText(TextView, CharSequence)>
		}
		if(((ChildViewCache) (context)).mIcon1 != null)
	//*  81  164:aload_2         
	//*  82  165:getfield        #474 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon1>
	//*  83  168:ifnull          185
			setViewDrawable(((ChildViewCache) (context)).mIcon1, getIcon1(cursor), 4);
	//   84  171:aload_0         
	//   85  172:aload_2         
	//   86  173:getfield        #474 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon1>
	//   87  176:aload_0         
	//   88  177:aload_3         
	//   89  178:invokespecial   #476 <Method Drawable getIcon1(Cursor)>
	//   90  181:iconst_4        
	//   91  182:invokespecial   #478 <Method void setViewDrawable(ImageView, Drawable, int)>
		if(((ChildViewCache) (context)).mIcon2 != null)
	//*  92  185:aload_2         
	//*  93  186:getfield        #481 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon2>
	//*  94  189:ifnull          207
			setViewDrawable(((ChildViewCache) (context)).mIcon2, getIcon2(cursor), 8);
	//   95  192:aload_0         
	//   96  193:aload_2         
	//   97  194:getfield        #481 <Field ImageView SuggestionsAdapter$ChildViewCache.mIcon2>
	//   98  197:aload_0         
	//   99  198:aload_3         
	//  100  199:invokespecial   #483 <Method Drawable getIcon2(Cursor)>
	//  101  202:bipush          8
	//  102  204:invokespecial   #478 <Method void setViewDrawable(ImageView, Drawable, int)>
		int j = mQueryRefinement;
	//  103  207:aload_0         
	//  104  208:getfield        #63  <Field int mQueryRefinement>
	//  105  211:istore          5
		if(j != 2 && (j != 1 || (i & 1) == 0))
	//* 106  213:iload           5
	//* 107  215:iconst_2        
	...
	//  117  235:aload_2         
	//  118  236:getfield        #486 <Field ImageView SuggestionsAdapter$ChildViewCache.mIconRefine>
	//  119  239:bipush          8
	//  120  241:invokevirtual   #409 <Method void ImageView.setVisibility(int)>
			return;
	//  121  244:return          
		} else
		{
	...
	//  122  245:aload_2         
	//  123  246:getfield        #486 <Field ImageView SuggestionsAdapter$ChildViewCache.mIconRefine>
	//  124  249:iconst_0        
	//  125  250:invokevirtual   #409 <Method void ImageView.setVisibility(int)>
	...
	//  128  257:aload_2         
	//  129  258:getfield        #456 <Field TextView SuggestionsAdapter$ChildViewCache.mText1>
	//  130  261:invokevirtual   #490 <Method CharSequence TextView.getText()>
	//  131  264:invokevirtual   #494 <Method void ImageView.setTag(Object)>
			((ChildViewCache) (context)).mIconRefine.setOnClickListener(((android.view.View.OnClickListener) (this)));
	//  132  267:aload_2         
	//  133  268:getfield        #486 <Field ImageView SuggestionsAdapter$ChildViewCache.mIconRefine>
	//  134  271:aload_0         
	//  135  272:invokevirtual   #498 <Method void ImageView.setOnClickListener(android.view.View$OnClickListener)>
			return;
	//  136  275:return          
		}
	}
	...
	//   51  121:aload_1         
	//   52  122:invokestatic    #336 <Method int Log.e(String, String, Throwable)>
	//   53  125:pop             
			}
		return;
	//   54  126:return          
...
label2:
	...
	//    6   12:aload_0         
	//    7   13:getfield        #78  <Field Context mContext>
	//    8   16:invokevirtual   #184 <Method PackageManager Context.getPackageManager()>
	//    9   19:aload_3         
	//   10   20:invokevirtual   #540 <Method Resources PackageManager.getResourcesForApplication(String)>
	//   11   23:astore          4
					}
	//*  12   25:aload_1         
	//*  13   26:invokevirtual   #544 <Method List Uri.getPathSegments()>
	//*  14   29:astore          5
	//*  15   31:aload           5
	//*  16   33:ifnull          214
	//*  17   36:aload           5
	//*  18   38:invokeinterface #549 <Method int List.size()>
	//*  19   43:istore_2        
	//*  20   44:iload_2         
	//*  21   45:iconst_1        
	//*  22   46:icmpne          101
	//*  23   49:aload           5
	//*  24   51:iconst_0        
	//*  25   52:invokeinterface #552 <Method Object List.get(int)>
	//*  26   57:checkcast       #297 <Class String>
	//*  27   60:invokestatic    #359 <Method int Integer.parseInt(String)>
	//*  28   63:istore_2        
	//*  29   64:goto            135
	//*  30   67:new             #211 <Class StringBuilder>
	//*  31   70:dup             
	//*  32   71:invokespecial   #212 <Method void StringBuilder()>
	//*  33   74:astore_3        
	//*  34   75:aload_3         
	//*  35   76:ldc2            #554 <String "Single path segment is not a resource ID: ">
	//*  36   79:invokevirtual   #218 <Method StringBuilder StringBuilder.append(String)>
	//*  37   82:pop             
	//*  38   83:aload_3         
	//*  39   84:aload_1         
	//*  40   85:invokevirtual   #308 <Method StringBuilder StringBuilder.append(Object)>
	//*  41   88:pop             
	//*  42   89:new             #284 <Class FileNotFoundException>
	//*  43   92:dup             
	//*  44   93:aload_3         
	//*  45   94:invokevirtual   #229 <Method String StringBuilder.toString()>
	//*  46   97:invokespecial   #311 <Method void FileNotFoundException(String)>
	//*  47  100:athrow          
	//*  48  101:iload_2         
	//*  49  102:iconst_2        
	//*  50  103:icmpne          180
	...
	//*  52  108:aload           5
	//*  53  110:iconst_1        
	//*  54  111:invokeinterface #552 <Method Object List.get(int)>
	//*  55  116:checkcast       #297 <Class String>
	//*  56  119:aload           5
	//*  57  121:iconst_0        
	//*  58  122:invokeinterface #552 <Method Object List.get(int)>
	//*  59  127:checkcast       #297 <Class String>
	//*  60  130:aload_3         
	//*  61  131:invokevirtual   #558 <Method int Resources.getIdentifier(String, String, String)>
	//*  62  134:istore_2        
	//*  63  135:iload_2         
	//*  64  136:ifeq            146
	//*  65  139:aload           4
	//*  66  141:iload_2         
	//*  67  142:invokevirtual   #561 <Method Drawable Resources.getDrawable(int)>
	//*  68  145:areturn         
	//*  69  146:new             #211 <Class StringBuilder>
	//*  70  149:dup             
	//*  71  150:invokespecial   #212 <Method void StringBuilder()>
	//*  72  153:astore_3        
	//*  73  154:aload_3         
	//*  74  155:ldc2            #563 <String "No resource found for: ">
	//*  75  158:invokevirtual   #218 <Method StringBuilder StringBuilder.append(String)>
	//*  76  161:pop             
	//*  77  162:aload_3         
	//*  78  163:aload_1         
	//*  79  164:invokevirtual   #308 <Method StringBuilder StringBuilder.append(Object)>
	//*  80  167:pop             
	//*  81  168:new             #284 <Class FileNotFoundException>
	//*  82  171:dup             
	//*  83  172:aload_3         
	//*  84  173:invokevirtual   #229 <Method String StringBuilder.toString()>
	//*  85  176:invokespecial   #311 <Method void FileNotFoundException(String)>
	//*  86  179:athrow          
	//*  87  180:new             #211 <Class StringBuilder>
	//*  88  183:dup             
	//*  89  184:invokespecial   #212 <Method void StringBuilder()>
	//*  90  187:astore_3        
	//*  91  188:aload_3         
	//*  92  189:ldc2            #565 <String "More than two path segments: ">
	//*  93  192:invokevirtual   #218 <Method StringBuilder StringBuilder.append(String)>
	//*  94  195:pop             
	//*  95  196:aload_3         
	//*  96  197:aload_1         
	//*  97  198:invokevirtual   #308 <Method StringBuilder StringBuilder.append(Object)>
	//*  98  201:pop             
	//*  99  202:new             #284 <Class FileNotFoundException>
	//* 100  205:dup             
	//* 101  206:aload_3         
	//* 102  207:invokevirtual   #229 <Method String StringBuilder.toString()>
	//* 103  210:invokespecial   #311 <Method void FileNotFoundException(String)>
	//* 104  213:athrow          
	//* 105  214:new             #211 <Class StringBuilder>
	//* 106  217:dup             
	//* 107  218:invokespecial   #212 <Method void StringBuilder()>
	//* 108  221:astore_3        
	//* 109  222:aload_3         
	//* 110  223:ldc2            #567 <String "No path: ">
	//* 111  226:invokevirtual   #218 <Method StringBuilder StringBuilder.append(String)>
	//* 112  229:pop             
	//* 113  230:aload_3         
	//* 114  231:aload_1         
	//* 115  232:invokevirtual   #308 <Method StringBuilder StringBuilder.append(Object)>
	//* 116  235:pop             
	//* 117  236:new             #284 <Class FileNotFoundException>
	//* 118  239:dup             
	//* 119  240:aload_3         
	//* 120  241:invokevirtual   #229 <Method String StringBuilder.toString()>
	//* 121  244:invokespecial   #311 <Method void FileNotFoundException(String)>
	//* 122  247:athrow          
	...
	//* 126  255:astore_3        
	//* 127  256:aload_3         
	//* 128  257:ldc2            #569 <String "No package found for authority: ">
	...
	//* 144  289:astore_3        
	//* 145  290:aload_3         
	//* 146  291:ldc2            #571 <String "No authority: ">
	...
	//   11   19:new             #599 <Class android.net.Uri$Builder>
	//   12   22:dup             
	//   13   23:invokespecial   #600 <Method void android.net.Uri$Builder()>
	//   14   26:ldc2            #602 <String "content">
	//   15   29:invokevirtual   #606 <Method android.net.Uri$Builder android.net.Uri$Builder.scheme(String)>
	//   16   32:aload           4
	//   17   34:invokevirtual   #609 <Method android.net.Uri$Builder android.net.Uri$Builder.authority(String)>
	//   18   37:ldc2            #611 <String "">
	//   19   40:invokevirtual   #614 <Method android.net.Uri$Builder android.net.Uri$Builder.query(String)>
	//   20   43:ldc2            #611 <String "">
	//   21   46:invokevirtual   #617 <Method android.net.Uri$Builder android.net.Uri$Builder.fragment(String)>
	//   22   49:astore          4
		String s1 = searchableinfo.getSuggestPath();
	//   23   51:aload_1         
	//   24   52:invokevirtual   #620 <Method String SearchableInfo.getSuggestPath()>
	//   25   55:astore          5
		if(s1 != null)
	//*  26   57:aload           5
	//*  27   59:ifnull          70
	...
	//   28   62:aload           4
	//   29   64:aload           5
	//   30   66:invokevirtual   #623 <Method android.net.Uri$Builder android.net.Uri$Builder.appendEncodedPath(String)>
	//   31   69:pop             
		((android.net.Uri.Builder) (obj)).appendPath("search_suggest_query");
	//   32   70:aload           4
	//   33   72:ldc2            #625 <String "search_suggest_query">
	//   34   75:invokevirtual   #628 <Method android.net.Uri$Builder android.net.Uri$Builder.appendPath(String)>
	//   35   78:pop             
		s1 = searchableinfo.getSuggestSelection();
	//   36   79:aload_1         
	//   37   80:invokevirtual   #631 <Method String SearchableInfo.getSuggestSelection()>
	//   38   83:astore          5
		if(s1 != null)
	//*  39   85:aload           5
	//*  40   87:ifnull          102
	...
	//   49  102:aload           4
	//   50  104:aload_2         
	//   51  105:invokevirtual   #628 <Method android.net.Uri$Builder android.net.Uri$Builder.appendPath(String)>
	//   52  108:pop             
			searchableinfo = null;
	//   53  109:aconst_null     
	//   54  110:astore_1        
	...
	//   57  115:aload           4
	//   58  117:ldc2            #633 <String "limit">
	//   59  120:iload_3         
	//   60  121:invokestatic    #636 <Method String String.valueOf(int)>
	//   61  124:invokevirtual   #640 <Method android.net.Uri$Builder android.net.Uri$Builder.appendQueryParameter(String, String)>
	//   62  127:pop             
		s = ((String) (((android.net.Uri.Builder) (obj)).build()));
	//   63  128:aload           4
	//   64  130:invokevirtual   #644 <Method Uri android.net.Uri$Builder.build()>
	//   65  133:astore_2        
	...
	//   72  145:aload_1         
	//   73  146:aconst_null     
	//   74  147:invokevirtual   #647 <Method Cursor ContentResolver.query(Uri, String[], String, String[], String)>
	//   75  150:areturn         
	}
