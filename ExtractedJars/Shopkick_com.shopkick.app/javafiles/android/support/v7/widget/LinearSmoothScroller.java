...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller
{
	...
	//    0    0:aload_0         
	//    1    1:getfield        #176 <Field PointF mTargetVector>
	//    2    4:astore_1        
		if(pointf != null && pointf.x != 0.0F)
	//*   3    5:aload_1         
	//*   4    6:ifnull          37
	//*   5    9:aload_1         
	//*   6   10:getfield        #181 <Field float PointF.x>
	//*   7   13:fconst_0        
	//*   8   14:fcmpl           
	//*   9   15:ifne            21
	//*  10   18:goto            37
	...
	//   11   21:aload_0         
	//   12   22:getfield        #176 <Field PointF mTargetVector>
	//   13   25:getfield        #181 <Field float PointF.x>
	//   14   28:fconst_0        
	//   15   29:fcmpl           
	//   16   30:ifle            35
	//   17   33:iconst_1        
	...
	//*   4    6:ifnull          37
	//*   5    9:aload_1         
	//*   6   10:getfield        #185 <Field float PointF.y>
	//*   7   13:fconst_0        
	//*   8   14:fcmpl           
	//*   9   15:ifne            21
	//*  10   18:goto            37
	...
	//   11   21:aload_0         
	//   12   22:getfield        #176 <Field PointF mTargetVector>
	//   13   25:getfield        #185 <Field float PointF.y>
	//   14   28:fconst_0        
	//   15   29:fcmpl           
	//   16   30:ifle            35
	//   17   33:iconst_1        
	...
	protected void onSeekTargetStep(int i, int j, RecyclerView.State state, RecyclerView.SmoothScroller.Action action)
	{
		if(getChildCount() == 0)
	//*   0    0:aload_0         
	//*   1    1:invokevirtual   #190 <Method int getChildCount()>
	//*   2    4:ifne            12
		{
			stop();
	//    3    7:aload_0         
	...
	//   10   18:iload_1         
	//   11   19:invokespecial   #195 <Method int clampApplyScroll(int, int)>
	...
	//   17   31:iload_2         
	//   18   32:invokespecial   #195 <Method int clampApplyScroll(int, int)>
	...
	//   26   52:aload_0         
	//   27   53:aload           4
	//   28   55:invokevirtual   #199 <Method void updateActionForInterimTarget(RecyclerView$SmoothScroller$Action)>
	//   29   58:return          
	}
	...
	//    6   10:aload_0         
	//    7   11:aconst_null     
	//    8   12:putfield        #176 <Field PointF mTargetVector>
	//    9   15:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:aload_0         
	//    3    3:invokevirtual   #205 <Method int getHorizontalSnapPreference()>
	//    4    6:invokevirtual   #207 <Method int calculateDxToMakeVisible(View, int)>
	//    5    9:istore          4
		int j = calculateDyToMakeVisible(view, getVerticalSnapPreference());
	//    6   11:aload_0         
	//    7   12:aload_1         
	//    8   13:aload_0         
	//    9   14:invokevirtual   #209 <Method int getVerticalSnapPreference()>
	//   10   17:invokevirtual   #211 <Method int calculateDyToMakeVisible(View, int)>
	//   11   20:istore          5
	...
	//   19   33:iadd            
	//   20   34:i2d             
	//   21   35:invokestatic    #214 <Method double Math.sqrt(double)>
	//   22   38:d2i             
	//   23   39:invokevirtual   #216 <Method int calculateTimeForDeceleration(int)>
	//   24   42:istore          6
		if(k > 0)
	//*  25   44:iload           6
	//*  26   46:ifle            65
	...
	//   35   62:invokevirtual   #222 <Method void RecyclerView$SmoothScroller$Action.update(int, int, int, android.view.animation.Interpolator)>
	//   36   65:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_0         
	//    2    2:invokevirtual   #225 <Method int getTargetPosition()>
	//    3    5:invokevirtual   #229 <Method PointF computeScrollVectorForPosition(int)>
	//    4    8:astore_3        
		if(pointf != null && (pointf.x != 0.0F || pointf.y != 0.0F))
	//*   5    9:aload_3         
	//*   6   10:ifnull          109
	//*   7   13:aload_3         
	//*   8   14:getfield        #181 <Field float PointF.x>
	//*   9   17:fconst_0        
	//*  10   18:fcmpl           
	//*  11   19:ifne            34
	//*  12   22:aload_3         
	//*  13   23:getfield        #185 <Field float PointF.y>
	//*  14   26:fconst_0        
	//*  15   27:fcmpl           
	//*  16   28:ifne            34
	//*  17   31:goto            109
	...
	//   18   34:aload_0         
	//   19   35:aload_3         
	//   20   36:invokevirtual   #233 <Method void normalize(PointF)>
			mTargetVector = pointf;
	//   21   39:aload_0         
	//   22   40:aload_3         
	//   23   41:putfield        #176 <Field PointF mTargetVector>
			mInterimTargetDx = (int)(pointf.x * 10000F);
	//   24   44:aload_0         
	//   25   45:aload_3         
	//   26   46:getfield        #181 <Field float PointF.x>
	//   27   49:ldc1            #234 <Float 10000F>
	//   28   51:fmul            
	//   29   52:f2i             
	...
	//   31   56:aload_0         
	//   32   57:aload_3         
	//   33   58:getfield        #185 <Field float PointF.y>
	//   34   61:ldc1            #234 <Float 10000F>
	//   35   63:fmul            
	//   36   64:f2i             
	...
	//   62  105:invokevirtual   #222 <Method void RecyclerView$SmoothScroller$Action.update(int, int, int, android.view.animation.Interpolator)>
			return;
	//   63  108:return          
		} else
		{
	...
	//   64  109:aload_1         
	//   65  110:aload_0         
	//   66  111:invokevirtual   #225 <Method int getTargetPosition()>
	//   67  114:invokevirtual   #238 <Method void RecyclerView$SmoothScroller$Action.jumpTo(int)>
			stop();
	//   68  117:aload_0         
	//   69  118:invokevirtual   #193 <Method void stop()>
			return;
	//   70  121:return          
		}
	}
