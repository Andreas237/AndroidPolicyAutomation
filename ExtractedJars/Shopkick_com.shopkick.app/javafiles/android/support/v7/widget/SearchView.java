	...
	implements CollapsibleActionView
{
	private static class AutoCompleteTextViewReflector
	{
		...
		//    9   15:invokevirtual   #58  <Method Object Method.invoke(Object, Object[])>
		//   10   18:pop             
			return;
		//   11   19:return          
		...
		//   10   16:iconst_0        
		//   11   17:iload_2         
		//   12   18:invokestatic    #63  <Method Boolean Boolean.valueOf(boolean)>
		//   13   21:aastore         
		//   14   22:invokevirtual   #58  <Method Object Method.invoke(Object, Object[])>
		//   15   25:pop             
			return;
		//   16   26:return          
			autocompletetextview;
...
;
	...
	public static class SearchAutoComplete extends AppCompatAutoCompleteTextView
	{
		...
		//    0    0:aload_0         
		//    1    1:invokevirtual   #52  <Method Resources getResources()>
		//    2    4:invokevirtual   #58  <Method Configuration Resources.getConfiguration()>
		//    3    7:astore_3        
			int i = configuration.screenWidthDp;
		//    4    8:aload_3         
		//    5    9:getfield        #63  <Field int Configuration.screenWidthDp>
		//    6   12:istore_1        
			int j = configuration.screenHeightDp;
		//    7   13:aload_3         
		//    8   14:getfield        #66  <Field int Configuration.screenHeightDp>
		//    9   17:istore_2        
		...
		//*  15   29:icmplt          44
		//*  16   32:aload_3         
		//*  17   33:getfield        #69  <Field int Configuration.orientation>
		//*  18   36:iconst_2        
		//*  19   37:icmpne          44
				return 256;
		//   20   40:sipush          256
		...
		//    2    4:ifle            19
		//    3    7:aload_0         
		//    4    8:invokespecial   #73  <Method boolean AppCompatAutoCompleteTextView.enoughToFilter()>
		//    5   11:ifeq            17
		//    6   14:goto            19
		//    7   17:iconst_0        
		//    8   18:ireturn         
		...
		//    0    0:aload_0         
		//    1    1:invokevirtual   #78  <Method Editable getText()>
		//    2    4:invokestatic    #84  <Method int TextUtils.getTrimmedLength(CharSequence)>
		//    3    7:ifne            12
		//    4   10:iconst_1        
		//    5   11:ireturn         
		//    6   12:iconst_0        
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:invokespecial   #88  <Method InputConnection AppCompatAutoCompleteTextView.onCreateInputConnection(EditorInfo)>
		//    3    5:astore_1        
			if(mHasPendingShowSoftInputRequest)
		//*   4    6:aload_0         
		//*   5    7:getfield        #90  <Field boolean mHasPendingShowSoftInputRequest>
		//*   6   10:ifeq            31
			{
		...
		//   10   18:invokevirtual   #94  <Method boolean removeCallbacks(Runnable)>
		//   11   21:pop             
				post(mRunShowSoftInputIfNecessary);
		//   12   22:aload_0         
		//   13   23:aload_0         
		//   14   24:getfield        #41  <Field Runnable mRunShowSoftInputIfNecessary>
		//   15   27:invokevirtual   #97  <Method boolean post(Runnable)>
		//   16   30:pop             
			}
		...
		//    0    0:aload_0         
		//    1    1:invokespecial   #101 <Method void AppCompatAutoCompleteTextView.onFinishInflate()>
			android.util.DisplayMetrics displaymetrics = getResources().getDisplayMetrics();
		//    2    4:aload_0         
		//    3    5:invokevirtual   #52  <Method Resources getResources()>
		//    4    8:invokevirtual   #105 <Method android.util.DisplayMetrics Resources.getDisplayMetrics()>
		//    5   11:astore_1        
			setMinWidth((int)TypedValue.applyDimension(1, getSearchViewTextMinWidthDp(), displaymetrics));
		//    6   12:aload_0         
		//    7   13:iconst_1        
		//    8   14:aload_0         
		//    9   15:invokespecial   #107 <Method int getSearchViewTextMinWidthDp()>
		//   10   18:i2f             
		//   11   19:aload_1         
		//   12   20:invokestatic    #113 <Method float TypedValue.applyDimension(int, float, android.util.DisplayMetrics)>
		//   13   23:f2i             
		//   14   24:invokevirtual   #117 <Method void setMinWidth(int)>
		//   15   27:return          
		}
		...
		//    2    2:iload_2         
		//    3    3:aload_3         
		//    4    4:invokespecial   #121 <Method void AppCompatAutoCompleteTextView.onFocusChanged(boolean, int, Rect)>
			mSearchView.onTextFocusChanged();
		//    5    7:aload_0         
		//    6    8:getfield        #123 <Field SearchView mSearchView>
		//    7   11:invokevirtual   #126 <Method void SearchView.onTextFocusChanged()>
		//    8   14:return          
		}
		...
		//*   3    5:aload_2         
		//*   4    6:invokevirtual   #133 <Method int KeyEvent.getAction()>
		//*   5    9:ifne            36
		//*   6   12:aload_2         
		//*   7   13:invokevirtual   #136 <Method int KeyEvent.getRepeatCount()>
		//*   8   16:ifne            36
				{
					android.view.KeyEvent.DispatcherState dispatcherstate = getKeyDispatcherState();
		//    9   19:aload_0         
		//   10   20:invokevirtual   #140 <Method android.view.KeyEvent$DispatcherState getKeyDispatcherState()>
		//   11   23:astore_3        
		...
		//   15   29:aload_2         
		//   16   30:aload_0         
		//   17   31:invokevirtual   #146 <Method void android.view.KeyEvent$DispatcherState.startTracking(KeyEvent, Object)>
					return true;
		//   18   34:iconst_1        
		//   19   35:ireturn         
				}
		...
		//*  20   36:aload_2         
		//*  21   37:invokevirtual   #133 <Method int KeyEvent.getAction()>
		//*  22   40:iconst_1        
		//*  23   41:icmpne          86
				{
					android.view.KeyEvent.DispatcherState dispatcherstate1 = getKeyDispatcherState();
		//   24   44:aload_0         
		//   25   45:invokevirtual   #140 <Method android.view.KeyEvent$DispatcherState getKeyDispatcherState()>
		//   26   48:astore_3        
		...
		//   29   53:aload_3         
		//   30   54:aload_2         
		//   31   55:invokevirtual   #150 <Method void android.view.KeyEvent$DispatcherState.handleUpEvent(KeyEvent)>
					if(keyevent.isTracking() && !keyevent.isCanceled())
		//*  32   58:aload_2         
		//*  33   59:invokevirtual   #153 <Method boolean KeyEvent.isTracking()>
		//*  34   62:ifeq            86
		//*  35   65:aload_2         
		//*  36   66:invokevirtual   #156 <Method boolean KeyEvent.isCanceled()>
		//*  37   69:ifne            86
					{
						mSearchView.clearFocus();
		//   38   72:aload_0         
		//   39   73:getfield        #123 <Field SearchView mSearchView>
		//   40   76:invokevirtual   #159 <Method void SearchView.clearFocus()>
						setImeVisibility(false);
		//   41   79:aload_0         
		//   42   80:iconst_0        
		//   43   81:invokevirtual   #163 <Method void setImeVisibility(boolean)>
						return true;
		//   44   84:iconst_1        
		//   45   85:ireturn         
					}
		...
		//   47   87:iload_1         
		//   48   88:aload_2         
		//   49   89:invokespecial   #165 <Method boolean AppCompatAutoCompleteTextView.onKeyPreIme(int, KeyEvent)>
		//   50   92:ireturn         
		}
		...
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:invokespecial   #168 <Method void AppCompatAutoCompleteTextView.onWindowFocusChanged(boolean)>
			if(flag && mSearchView.hasFocus() && getVisibility() == 0)
		//*   3    5:iload_1         
		//*   4    6:ifeq            49
		//*   5    9:aload_0         
		//*   6   10:getfield        #123 <Field SearchView mSearchView>
		//*   7   13:invokevirtual   #171 <Method boolean SearchView.hasFocus()>
		//*   8   16:ifeq            49
		//*   9   19:aload_0         
		//*  10   20:invokevirtual   #174 <Method int getVisibility()>
		//*  11   23:ifne            49
			{
				mHasPendingShowSoftInputRequest = true;
		//   12   26:aload_0         
		//   13   27:iconst_1        
		//   14   28:putfield        #90  <Field boolean mHasPendingShowSoftInputRequest>
				if(SearchView.isLandscapeMode(getContext()))
		//*  15   31:aload_0         
		//*  16   32:invokevirtual   #178 <Method Context getContext()>
		//*  17   35:invokestatic    #182 <Method boolean SearchView.isLandscapeMode(Context)>
		//*  18   38:ifeq            49
					SearchView.HIDDEN_METHOD_INVOKER.ensureImeVisible(((AutoCompleteTextView) (this)), true);
		//   19   41:getstatic       #186 <Field SearchView$AutoCompleteTextViewReflector SearchView.HIDDEN_METHOD_INVOKER>
		//   20   44:aload_0         
		//   21   45:iconst_1        
		//   22   46:invokevirtual   #192 <Method void SearchView$AutoCompleteTextViewReflector.ensureImeVisible(AutoCompleteTextView, boolean)>
			}
		//   23   49:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:invokevirtual   #178 <Method Context getContext()>
		//    2    4:ldc1            #197 <String "input_method">
		//    3    6:invokevirtual   #203 <Method Object Context.getSystemService(String)>
		//    4    9:checkcast       #205 <Class InputMethodManager>
		//    5   12:astore_2        
			if(!flag)
		//*   6   13:iload_1         
		//*   7   14:ifne            42
		...
		//    8   17:aload_0         
		//    9   18:iconst_0        
		//   10   19:putfield        #90  <Field boolean mHasPendingShowSoftInputRequest>
				removeCallbacks(mRunShowSoftInputIfNecessary);
		//   11   22:aload_0         
		//   12   23:aload_0         
		//   13   24:getfield        #41  <Field Runnable mRunShowSoftInputIfNecessary>
		//   14   27:invokevirtual   #94  <Method boolean removeCallbacks(Runnable)>
		//   15   30:pop             
				inputmethodmanager.hideSoftInputFromWindow(getWindowToken(), 0);
		//   16   31:aload_2         
		//   17   32:aload_0         
		//   18   33:invokevirtual   #209 <Method android.os.IBinder getWindowToken()>
		//   19   36:iconst_0        
		//   20   37:invokevirtual   #213 <Method boolean InputMethodManager.hideSoftInputFromWindow(android.os.IBinder, int)>
		//   21   40:pop             
				return;
		//   22   41:return          
			}
		...
		//*  23   42:aload_2         
		//*  24   43:aload_0         
		//*  25   44:invokevirtual   #217 <Method boolean InputMethodManager.isActive(View)>
		//*  26   47:ifeq            72
			{
				mHasPendingShowSoftInputRequest = false;
		//   27   50:aload_0         
		//   28   51:iconst_0        
		//   29   52:putfield        #90  <Field boolean mHasPendingShowSoftInputRequest>
				removeCallbacks(mRunShowSoftInputIfNecessary);
		//   30   55:aload_0         
		//   31   56:aload_0         
		//   32   57:getfield        #41  <Field Runnable mRunShowSoftInputIfNecessary>
		//   33   60:invokevirtual   #94  <Method boolean removeCallbacks(Runnable)>
		//   34   63:pop             
				inputmethodmanager.showSoftInput(((View) (this)), 0);
		//   35   64:aload_2         
		//   36   65:aload_0         
		//   37   66:iconst_0        
		//   38   67:invokevirtual   #221 <Method boolean InputMethodManager.showSoftInput(View, int)>
		//   39   70:pop             
				return;
		//   40   71:return          
			} else
		...
		//   41   72:aload_0         
		//   42   73:iconst_1        
		//   43   74:putfield        #90  <Field boolean mHasPendingShowSoftInputRequest>
				return;
		//   44   77:return          
			}
		}
		...
		//    0    0:aload_0         
		//    1    1:aload_1         
		//    2    2:putfield        #123 <Field SearchView mSearchView>
		//    3    5:return          
		}
		...
		//    0    0:aload_0         
		//    1    1:iload_1         
		//    2    2:invokespecial   #226 <Method void AppCompatAutoCompleteTextView.setThreshold(int)>
			mThreshold = i;
		//    3    5:aload_0         
		//    4    6:iload_1         
		...
		void showSoftInputIfNecessary()
		{
			if(mHasPendingShowSoftInputRequest)
		//*   0    0:aload_0         
		//*   1    1:getfield        #90  <Field boolean mHasPendingShowSoftInputRequest>
		//*   2    4:ifeq            30
			{
				((InputMethodManager)getContext().getSystemService("input_method")).showSoftInput(((View) (this)), 0);
		//    3    7:aload_0         
		//    4    8:invokevirtual   #178 <Method Context getContext()>
		//    5   11:ldc1            #197 <String "input_method">
		//    6   13:invokevirtual   #203 <Method Object Context.getSystemService(String)>
		//    7   16:checkcast       #205 <Class InputMethodManager>
		//    8   19:aload_0         
		//    9   20:iconst_0        
		//   10   21:invokevirtual   #221 <Method boolean InputMethodManager.showSoftInput(View, int)>
		//   11   24:pop             
				mHasPendingShowSoftInputRequest = false;
		//   12   25:aload_0         
		//   13   26:iconst_0        
		//   14   27:putfield        #90  <Field boolean mHasPendingShowSoftInputRequest>
			}
		//   15   30:return          
		}
...
;
	...
	//  370  782:dup             
	//  371  783:aload_0         
	//  372  784:invokespecial   #483 <Method void SearchView$4(SearchView)>
	//  373  787:invokevirtual   #489 <Method void View.addOnLayoutChangeListener(android.view.View$OnLayoutChangeListener)>
		updateViewsVisibility(mIconifiedByDefault);
	//  374  790:aload_0         
	//  375  791:aload_0         
	//  376  792:getfield        #491 <Field boolean mIconifiedByDefault>
	//  377  795:invokespecial   #494 <Method void updateViewsVisibility(boolean)>
		updateQueryHint();
	//  378  798:aload_0         
	//  379  799:invokespecial   #497 <Method void updateQueryHint()>
	//  380  802:return          
	}
	...
	//   40   76:aload_1         
	//   41   77:ldc2            #518 <String "app_data">
	//   42   80:aload_2         
	//   43   81:invokevirtual   #521 <Method Intent Intent.putExtra(String, Bundle)>
	//   44   84:pop             
		if(i != 0)
	//*  45   85:iload           5
	//*  46   87:ifeq            110
	...
	//   47   90:aload_1         
	//   48   91:ldc2            #523 <String "action_key">
	//   49   94:iload           5
	//   50   96:invokevirtual   #526 <Method Intent Intent.putExtra(String, int)>
	//   51   99:pop             
			((Intent) (s)).putExtra("action_msg", s3);
	//   52  100:aload_1         
	//   53  101:ldc2            #528 <String "action_msg">
	//   54  104:aload           6
	//   55  106:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//   56  109:pop             
		}
		((Intent) (s)).setComponent(mSearchable.getSearchActivity());
	//   57  110:aload_1         
	//   58  111:aload_0         
	//   59  112:getfield        #530 <Field SearchableInfo mSearchable>
	//   60  115:invokevirtual   #536 <Method ComponentName SearchableInfo.getSearchActivity()>
	//   61  118:invokevirtual   #540 <Method Intent Intent.setComponent(ComponentName)>
	//   62  121:pop             
		return ((Intent) (s));
	//   63  122:aload_1         
	//   64  123:areturn         
...
_L2:
	...
	//  113  234:ldc2            #611 <String "android.intent.action.SEARCH">
	//  114  237:astore          5
		else
	//* 115  239:goto            30
			obj1 = obj;
...
_L7:
	...
	//   28   61:aload           9
	//   29   63:ldc2            #518 <String "app_data">
	//   30   66:aload           5
	//   31   68:invokevirtual   #631 <Method void Bundle.putParcelable(String, Parcelable)>
		Intent intent1 = new Intent(intent);
	//   32   71:new             #452 <Class Intent>
	//   33   74:dup             
	//   34   75:aload_1         
	//   35   76:invokespecial   #634 <Method void Intent(Intent)>
	//   36   79:astore          11
		intent = "free_form";
	//   37   81:ldc2            #636 <String "free_form">
	//   38   84:astore_1        
		int i = 1;
	//   39   85:iconst_1        
	//   40   86:istore_3        
	...
	//   41   87:aload_0         
	//   42   88:invokevirtual   #331 <Method Resources getResources()>
	//   43   91:astore          6
		if(searchableinfo.getVoiceLanguageModeId() != 0)
	//*  44   93:aload_2         
	//*  45   94:invokevirtual   #639 <Method int SearchableInfo.getVoiceLanguageModeId()>
	//*  46   97:ifeq            110
			intent = ((Intent) (((Resources) (obj1)).getString(searchableinfo.getVoiceLanguageModeId())));
	//   47  100:aload           6
	//   48  102:aload_2         
	//   49  103:invokevirtual   #639 <Method int SearchableInfo.getVoiceLanguageModeId()>
	//   50  106:invokevirtual   #342 <Method String Resources.getString(int)>
	//   51  109:astore_1        
		int j = searchableinfo.getVoicePromptTextId();
	//   52  110:aload_2         
	//   53  111:invokevirtual   #642 <Method int SearchableInfo.getVoicePromptTextId()>
	//   54  114:istore          4
		Object obj2 = null;
	//   55  116:aconst_null     
	//   56  117:astore          7
	...
	//   59  124:aload           6
	//   60  126:aload_2         
	//   61  127:invokevirtual   #642 <Method int SearchableInfo.getVoicePromptTextId()>
	//   62  130:invokevirtual   #342 <Method String Resources.getString(int)>
	//   63  133:astore          5
		else
	//*  64  135:goto            141
			obj = null;
	...
	//   70  148:aload           6
	//   71  150:aload_2         
	//   72  151:invokevirtual   #645 <Method int SearchableInfo.getVoiceLanguageId()>
	//   73  154:invokevirtual   #342 <Method String Resources.getString(int)>
	//   74  157:astore          6
		else
	//*  75  159:goto            165
			obj1 = null;
	...
	//*  78  165:aload_2         
	//*  79  166:invokevirtual   #648 <Method int SearchableInfo.getVoiceMaxResults()>
	//*  80  169:ifeq            177
			i = searchableinfo.getVoiceMaxResults();
	//   81  172:aload_2         
	//   82  173:invokevirtual   #648 <Method int SearchableInfo.getVoiceMaxResults()>
	//   83  176:istore_3        
		intent1.putExtra("android.speech.extra.LANGUAGE_MODEL", ((String) (intent)));
	//   84  177:aload           11
	//   85  179:ldc2            #466 <String "android.speech.extra.LANGUAGE_MODEL">
	//   86  182:aload_1         
	//   87  183:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//   88  186:pop             
		intent1.putExtra("android.speech.extra.PROMPT", ((String) (obj)));
	//   89  187:aload           11
	//   90  189:ldc2            #650 <String "android.speech.extra.PROMPT">
	//   91  192:aload           5
	//   92  194:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//   93  197:pop             
		intent1.putExtra("android.speech.extra.LANGUAGE", ((String) (obj1)));
	//   94  198:aload           11
	//   95  200:ldc2            #652 <String "android.speech.extra.LANGUAGE">
	//   96  203:aload           6
	//   97  205:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//   98  208:pop             
		intent1.putExtra("android.speech.extra.MAX_RESULTS", i);
	//   99  209:aload           11
	//  100  211:ldc2            #654 <String "android.speech.extra.MAX_RESULTS">
	//  101  214:iload_3         
	//  102  215:invokevirtual   #526 <Method Intent Intent.putExtra(String, int)>
	//  103  218:pop             
	...
	//  109  230:aload           10
	//  110  232:invokevirtual   #659 <Method String ComponentName.flattenToShortString()>
	//  111  235:astore_1        
		intent1.putExtra("calling_package", ((String) (intent)));
	//  112  236:aload           11
	//  113  238:ldc2            #661 <String "calling_package">
	//  114  241:aload_1         
	//  115  242:invokevirtual   #472 <Method Intent Intent.putExtra(String, String)>
	//  116  245:pop             
		intent1.putExtra("android.speech.extra.RESULTS_PENDINGINTENT", ((Parcelable) (pendingintent)));
	//  117  246:aload           11
	//  118  248:ldc2            #663 <String "android.speech.extra.RESULTS_PENDINGINTENT">
	//  119  251:aload           8
	//  120  253:invokevirtual   #666 <Method Intent Intent.putExtra(String, Parcelable)>
	//  121  256:pop             
		intent1.putExtra("android.speech.extra.RESULTS_PENDINGINTENT_BUNDLE", bundle);
	//  122  257:aload           11
	//  123  259:ldc2            #668 <String "android.speech.extra.RESULTS_PENDINGINTENT_BUNDLE">
	//  124  262:aload           9
	//  125  264:invokevirtual   #521 <Method Intent Intent.putExtra(String, Bundle)>
	//  126  267:pop             
		return intent1;
	//  127  268:aload           11
	//  128  270:areturn         
	...
	//   14   26:istore_3        
		int ai1[] = mTemp2;
	//   15   27:aload_0         
	//   16   28:getfield        #171 <Field int[] mTemp2>
	//   17   31:astore          6
		i -= ai1[1];
	//   18   33:iload_3         
	//   19   34:aload           6
	...
	//   34   54:iload_3         
	//   35   55:aload_1         
	//   36   56:invokevirtual   #683 <Method int View.getWidth()>
	//   37   59:iload           4
	//   38   61:iadd            
	//   39   62:aload_1         
	//   40   63:invokevirtual   #686 <Method int View.getHeight()>
	//   41   66:iload_3         
	//   42   67:iadd            
	//   43   68:invokevirtual   #690 <Method void Rect.set(int, int, int, int)>
	//   44   71:return          
	}
	...
	//*   6    8:ifnull          78
	//*   7   11:aload_2         
	//*   8   12:invokevirtual   #742 <Method boolean SearchableInfo.getVoiceSearchEnabled()>
	//*   9   15:ifeq            78
		{
			Intent intent = null;
	//   10   18:aconst_null     
	...
	//*  12   20:aload_0         
	//*  13   21:getfield        #530 <Field SearchableInfo mSearchable>
	//*  14   24:invokevirtual   #745 <Method boolean SearchableInfo.getVoiceSearchLaunchWebSearch()>
	//*  15   27:ifeq            38
				intent = mVoiceWebSearchIntent;
	//   16   30:aload_0         
	//   17   31:getfield        #459 <Field Intent mVoiceWebSearchIntent>
	//   18   34:astore_2        
			else
	//*  19   35:goto            53
			if(mSearchable.getVoiceSearchLaunchRecognizer())
	//*  20   38:aload_0         
	//*  21   39:getfield        #530 <Field SearchableInfo mSearchable>
	//*  22   42:invokevirtual   #748 <Method boolean SearchableInfo.getVoiceSearchLaunchRecognizer()>
	//*  23   45:ifeq            53
				intent = mVoiceAppSearchIntent;
	//   24   48:aload_0         
	//   25   49:getfield        #476 <Field Intent mVoiceAppSearchIntent>
	//   26   52:astore_2        
			if(intent != null)
	//*  27   53:aload_2         
	//*  28   54:ifnull          78
	...
	//*  29   57:aload_0         
	//*  30   58:invokevirtual   #617 <Method Context getContext()>
	//*  31   61:invokevirtual   #752 <Method PackageManager Context.getPackageManager()>
	//*  32   64:aload_2         
	//*  33   65:ldc2            #753 <Int 0x10000>
	//*  34   68:invokevirtual   #759 <Method android.content.pm.ResolveInfo PackageManager.resolveActivity(Intent, int)>
	//*  35   71:ifnull          76
					flag = true;
	//   36   74:iconst_1        
	//   37   75:istore_1        
	...
	//   50   95:aload           4
	//   51   97:aconst_null     
	//   52   98:invokevirtual   #895 <Method void CursorAdapter.changeCursor(Cursor)>
		if(mSearchable.getSuggestAuthority() != null)
	//*  53  101:aload_0         
	//*  54  102:getfield        #530 <Field SearchableInfo mSearchable>
	//*  55  105:invokevirtual   #889 <Method String SearchableInfo.getSuggestAuthority()>
	//*  56  108:ifnull          172
		{
			mSuggestionsAdapter = ((CursorAdapter) (new SuggestionsAdapter(getContext(), this, mSearchable, mOutsideDrawablesCache)));
	//   57  111:aload_0         
	//   58  112:new             #548 <Class SuggestionsAdapter>
	//   59  115:dup             
	//   60  116:aload_0         
	//   61  117:invokevirtual   #617 <Method Context getContext()>
	//   62  120:aload_0         
	//   63  121:aload_0         
	//   64  122:getfield        #530 <Field SearchableInfo mSearchable>
	//   65  125:aload_0         
	//   66  126:getfield        #184 <Field WeakHashMap mOutsideDrawablesCache>
	//   67  129:invokespecial   #898 <Method void SuggestionsAdapter(Context, SearchView, SearchableInfo, WeakHashMap)>
	//   68  132:putfield        #794 <Field CursorAdapter mSuggestionsAdapter>
			mSearchSrcTextView.setAdapter(((android.widget.ListAdapter) (mSuggestionsAdapter)));
	//   69  135:aload_0         
	//   70  136:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   71  139:aload_0         
	//   72  140:getfield        #794 <Field CursorAdapter mSuggestionsAdapter>
	//   73  143:invokevirtual   #902 <Method void SearchView$SearchAutoComplete.setAdapter(android.widget.ListAdapter)>
			SuggestionsAdapter suggestionsadapter = (SuggestionsAdapter)mSuggestionsAdapter;
	//   74  146:aload_0         
	//   75  147:getfield        #794 <Field CursorAdapter mSuggestionsAdapter>
	//   76  150:checkcast       #548 <Class SuggestionsAdapter>
	//   77  153:astore          4
	...
	//   79  156:istore_1        
			if(mQueryRefinement)
	//*  80  157:aload_0         
	//*  81  158:getfield        #904 <Field boolean mQueryRefinement>
	//*  82  161:ifeq            166
				byte0 = 2;
	//   83  164:iconst_2        
	//   84  165:istore_1        
	...
	//   85  166:aload           4
	//   86  168:iload_1         
	//   87  169:invokevirtual   #907 <Method void SuggestionsAdapter.setQueryRefinement(int)>
		}
	//   88  172:return          
	}
	...
	//    9   17:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   10   20:iconst_0        
	//   11   21:invokevirtual   #973 <Method void SearchView$SearchAutoComplete.setImeVisibility(boolean)>
	...
	//    3    7:invokevirtual   #978 <Method void SearchView$AutoCompleteTextViewReflector.doBeforeTextChanged(AutoCompleteTextView)>
	...
	//    7   17:invokevirtual   #981 <Method void SearchView$AutoCompleteTextViewReflector.doAfterTextChanged(AutoCompleteTextView)>
	//    8   20:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//    2    4:invokevirtual   #982 <Method int SearchView$SearchAutoComplete.getImeOptions()>
	//    3    7:ireturn         
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//    2    4:invokevirtual   #983 <Method int SearchView$SearchAutoComplete.getInputType()>
	//    3    7:ireturn         
	}
	...
	public int getMaxWidth()
	{
		return mMaxWidth;
	//    0    0:aload_0         
	//    1    1:getfield        #986 <Field int mMaxWidth>
	//    2    4:ireturn         
	}
	...
	//*  11   17:ifnull          42
	//*  12   20:aload_1         
	//*  13   21:invokevirtual   #991 <Method int SearchableInfo.getHintId()>
	//*  14   24:ifeq            42
			return getContext().getText(mSearchable.getHintId());
	//   15   27:aload_0         
	//   16   28:invokevirtual   #617 <Method Context getContext()>
	//   17   31:aload_0         
	//   18   32:getfield        #530 <Field SearchableInfo mSearchable>
	//   19   35:invokevirtual   #991 <Method int SearchableInfo.getHintId()>
	//   20   38:invokevirtual   #992 <Method CharSequence Context.getText(int)>
	//   21   41:areturn         
		else
			return mDefaultQueryHint;
	//   22   42:aload_0         
	//   23   43:getfield        #421 <Field CharSequence mDefaultQueryHint>
	//   24   46:areturn         
	}
	...
	//    1    1:ldc2            #866 <String "">
	//    2    4:iconst_0        
	//    3    5:invokevirtual   #1006 <Method void setQuery(CharSequence, boolean)>
		clearFocus();
	//    4    8:aload_0         
	//    5    9:invokevirtual   #1007 <Method void clearFocus()>
	...
	//   11   21:aload_0         
	//   12   22:getfield        #1009 <Field int mCollapsedImeOptions>
	...
	//   10   18:invokevirtual   #982 <Method int SearchView$SearchAutoComplete.getImeOptions()>
	//   11   21:putfield        #1009 <Field int mCollapsedImeOptions>
	...
	//   14   28:aload_0         
	//   15   29:getfield        #1009 <Field int mCollapsedImeOptions>
	//   16   32:ldc2            #1011 <Int 0x2000000>
	//   17   35:ior             
	...
	//   23   49:aload_0         
	//   24   50:iconst_0        
	//   25   51:invokevirtual   #1014 <Method void setIconified(boolean)>
			return;
	//   26   54:return          
		}
	}
	...
	//    8   20:aload_0         
	//    9   21:getfield        #1017 <Field SearchView$OnCloseListener mOnCloseListener>
	//   10   24:astore_1        
				if(oncloselistener == null || !oncloselistener.onClose())
	//*  11   25:aload_1         
	//*  12   26:ifnull          38
	//*  13   29:aload_1         
	//*  14   30:invokeinterface #1020 <Method boolean SearchView$OnCloseListener.onClose()>
	//*  15   35:ifne            74
				{
					clearFocus();
	//   16   38:aload_0         
	//   17   39:invokevirtual   #1007 <Method void clearFocus()>
					updateViewsVisibility(true);
	//   18   42:aload_0         
	//   19   43:iconst_1        
	//   20   44:invokespecial   #494 <Method void updateViewsVisibility(boolean)>
					return;
	//   21   47:return          
				}
			}
		} else
		{
			mSearchSrcTextView.setText("");
	//   22   48:aload_0         
	//   23   49:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   24   52:ldc2            #866 <String "">
	//   25   55:invokevirtual   #827 <Method void SearchView$SearchAutoComplete.setText(CharSequence)>
			mSearchSrcTextView.requestFocus();
	//   26   58:aload_0         
	//   27   59:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   28   62:invokevirtual   #1023 <Method boolean SearchView$SearchAutoComplete.requestFocus()>
	//   29   65:pop             
			mSearchSrcTextView.setImeVisibility(true);
	//   30   66:aload_0         
	//   31   67:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   32   70:iconst_1        
	//   33   71:invokevirtual   #973 <Method void SearchView$SearchAutoComplete.setImeVisibility(boolean)>
		}
	//   34   74:return          
	}
	...
	//    1    1:aload_0         
	//    2    2:getfield        #176 <Field Runnable mUpdateDrawableStateRunnable>
	//    3    5:invokevirtual   #1027 <Method boolean removeCallbacks(Runnable)>
	//    4    8:pop             
	...
	//   10   18:aload_0         
	//   11   19:invokespecial   #1029 <Method void LinearLayoutCompat.onDetachedFromWindow()>
	//   12   22:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #1032 <Field SearchView$OnSuggestionListener mOnSuggestionListener>
	//    2    4:astore_3        
	...
	//*   5    9:aload_3         
	//*   6   10:iload_1         
	//*   7   11:invokeinterface #1035 <Method boolean SearchView$OnSuggestionListener.onSuggestionClick(int)>
	//*   8   16:ifne            22
	//*   9   19:goto            24
		{
			return false;
	...
	//   14   26:iconst_0        
	//   15   27:aconst_null     
	//   16   28:invokespecial   #1037 <Method boolean launchSuggestion(int, int, String)>
	//   17   31:pop             
			mSearchSrcTextView.setImeVisibility(false);
	//   18   32:aload_0         
	//   19   33:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   20   36:iconst_0        
	//   21   37:invokevirtual   #973 <Method void SearchView$SearchAutoComplete.setImeVisibility(boolean)>
			dismissSuggestions();
	//   22   40:aload_0         
	//   23   41:invokespecial   #1039 <Method void dismissSuggestions()>
			return true;
	//   24   44:iconst_1        
	//   25   45:ireturn         
		}
	...
	//*   5    9:aload_2         
	//*   6   10:iload_1         
	//*   7   11:invokeinterface #1043 <Method boolean SearchView$OnSuggestionListener.onSuggestionSelect(int)>
	//*   8   16:ifne            22
	//*   9   19:goto            24
		{
			return false;
	...
	//   12   24:aload_0         
	//   13   25:iload_1         
	//   14   26:invokespecial   #1045 <Method void rewriteQueryFromSuggestion(int)>
			return true;
	//   15   29:iconst_1        
	//   16   30:ireturn         
		}
	...
	//    4    4:iload           4
	//    5    6:iload           5
	//    6    8:invokespecial   #1049 <Method void LinearLayoutCompat.onLayout(boolean, int, int, int, int)>
		if(flag)
	//*   7   11:iload_1         
	//*   8   12:ifeq            109
		{
	...
	//   14   24:invokespecial   #1051 <Method void getChildBoundsWithinSearchView(View, Rect)>
	...
	//   28   53:aload_0         
	//   29   54:getfield        #1053 <Field SearchView$UpdatableTouchDelegate mTouchDelegate>
	//   30   57:astore          6
	...
	//   35   68:dup             
	//   36   69:aload_0         
	//   37   70:getfield        #167 <Field Rect mSearchSrtTextViewBoundsExpanded>
	//   38   73:aload_0         
	//   39   74:getfield        #165 <Field Rect mSearchSrcTextViewBounds>
	//   40   77:aload_0         
	//   41   78:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   42   81:invokespecial   #1056 <Method void SearchView$UpdatableTouchDelegate(Rect, Rect, View)>
	//   43   84:putfield        #1053 <Field SearchView$UpdatableTouchDelegate mTouchDelegate>
				setTouchDelegate(((TouchDelegate) (mTouchDelegate)));
	//   44   87:aload_0         
	//   45   88:aload_0         
	//   46   89:getfield        #1053 <Field SearchView$UpdatableTouchDelegate mTouchDelegate>
	//   47   92:invokevirtual   #1060 <Method void setTouchDelegate(TouchDelegate)>
				return;
	//   48   95:return          
			}
	...
	//   49   96:aload           6
	//   50   98:aload_0         
	//   51   99:getfield        #167 <Field Rect mSearchSrtTextViewBoundsExpanded>
	//   52  102:aload_0         
	//   53  103:getfield        #165 <Field Rect mSearchSrcTextViewBounds>
	//   54  106:invokevirtual   #1063 <Method void SearchView$UpdatableTouchDelegate.setBounds(Rect, Rect)>
		}
	//   55  109:return          
	}
	...
	//    4    8:iload_1         
	//    5    9:iload_2         
	//    6   10:invokespecial   #1067 <Method void LinearLayoutCompat.onMeasure(int, int)>
			return;
	//    7   13:return          
		}
		int l = android.view.View.MeasureSpec.getMode(i);
	//    8   14:iload_1         
	//    9   15:invokestatic    #1072 <Method int android.view.View$MeasureSpec.getMode(int)>
	//   10   18:istore          4
		int k = android.view.View.MeasureSpec.getSize(i);
	//   11   20:iload_1         
	//   12   21:invokestatic    #1075 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   13   24:istore_3        
		if(l != 0x80000000)
	//*  14   25:iload           4
	//*  15   27:ldc2            #1076 <Int 0x80000000>
	//*  16   30:icmpeq          94
		{
			if(l != 0)
	//*  17   33:iload           4
	...
	//*  24   48:goto            121
				{
					int i1 = mMaxWidth;
	//   25   51:aload_0         
	//   26   52:getfield        #986 <Field int mMaxWidth>
	//   27   55:istore          4
					i = k;
	//   28   57:iload_3         
	//   29   58:istore_1        
	...
	//   32   64:iload           4
	//   33   66:iload_3         
	//   34   67:invokestatic    #1081 <Method int Math.min(int, int)>
	//   35   70:istore_1        
				}
			} else
	//*  36   71:goto            121
			{
				i = mMaxWidth;
	//   37   74:aload_0         
	//   38   75:getfield        #986 <Field int mMaxWidth>
	//   39   78:istore_1        
				if(i <= 0)
	//*  40   79:iload_1         
	//*  41   80:ifle            86
	//*  42   83:goto            121
					i = getPreferredWidth();
	//   43   86:aload_0         
	//   44   87:invokespecial   #1083 <Method int getPreferredWidth()>
	//   45   90:istore_1        
			}
		} else
	//*  46   91:goto            121
		{
			i = mMaxWidth;
	//   47   94:aload_0         
	//   48   95:getfield        #986 <Field int mMaxWidth>
	//   49   98:istore_1        
			if(i > 0)
	//*  50   99:iload_1         
	//*  51  100:ifle            112
	...
	//   52  103:iload_1         
	//   53  104:iload_3         
	//   54  105:invokestatic    #1081 <Method int Math.min(int, int)>
	//   55  108:istore_1        
			else
	//*  56  109:goto            121
				i = Math.min(getPreferredWidth(), k);
	//   57  112:aload_0         
	//   58  113:invokespecial   #1083 <Method int getPreferredWidth()>
	//   59  116:iload_3         
	//   60  117:invokestatic    #1081 <Method int Math.min(int, int)>
	//   61  120:istore_1        
		}
		k = android.view.View.MeasureSpec.getMode(j);
	//   62  121:iload_2         
	//   63  122:invokestatic    #1072 <Method int android.view.View$MeasureSpec.getMode(int)>
	//   64  125:istore_3        
		j = android.view.View.MeasureSpec.getSize(j);
	//   65  126:iload_2         
	//   66  127:invokestatic    #1075 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   67  130:istore_2        
		if(k != 0x80000000)
	//*  68  131:iload_3         
	//*  69  132:ldc2            #1076 <Int 0x80000000>
	//*  70  135:icmpeq          153
		{
			if(k == 0)
	//*  71  138:iload_3         
	...
	//   74  145:aload_0         
	//   75  146:invokespecial   #1085 <Method int getPreferredHeight()>
	//   76  149:istore_2        
		} else
	//*  77  150:goto            162
		{
	...
	//   78  153:aload_0         
	//   79  154:invokespecial   #1085 <Method int getPreferredHeight()>
	//   80  157:iload_2         
	//   81  158:invokestatic    #1081 <Method int Math.min(int, int)>
	//   82  161:istore_2        
		}
	...
	//   83  162:aload_0         
	//   84  163:iload_1         
	//   85  164:ldc2            #618 <Int 0x40000000>
	//   86  167:invokestatic    #1088 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   87  170:iload_2         
	//   88  171:ldc2            #618 <Int 0x40000000>
	//   89  174:invokestatic    #1088 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   90  177:invokespecial   #1067 <Method void LinearLayoutCompat.onMeasure(int, int)>
	//   91  180:return          
	}
	...
	//    3    5:aload_0         
	//    4    6:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//    5    9:invokevirtual   #1023 <Method boolean SearchView$SearchAutoComplete.requestFocus()>
	//    6   12:pop             
		mSearchSrcTextView.setImeVisibility(true);
	//    7   13:aload_0         
	//    8   14:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//    9   17:iconst_1        
	//   10   18:invokevirtual   #973 <Method void SearchView$SearchAutoComplete.setImeVisibility(boolean)>
	...
	//   16   30:aload_1         
	//   17   31:aload_0         
	//   18   32:invokeinterface #1116 <Method void android.view.View$OnClickListener.onClick(View)>
	//   19   37:return          
	}
	...
	//*  14   28:aload_2         
	//*  15   29:aload_1         
	//*  16   30:invokeinterface #1124 <Method String CharSequence.toString()>
	//*  17   35:invokeinterface #1128 <Method boolean SearchView$OnQueryTextListener.onQueryTextSubmit(String)>
	//*  18   40:ifne            74
			{
				if(mSearchable != null)
	//*  19   43:aload_0         
	//*  20   44:getfield        #530 <Field SearchableInfo mSearchable>
	//*  21   47:ifnull          62
	...
	//   24   52:aconst_null     
	//   25   53:aload_1         
	//   26   54:invokeinterface #1124 <Method String CharSequence.toString()>
	//   27   59:invokevirtual   #1130 <Method void launchQuerySearch(int, String, String)>
				mSearchSrcTextView.setImeVisibility(false);
	//   28   62:aload_0         
	//   29   63:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   30   66:iconst_0        
	//   31   67:invokevirtual   #973 <Method void SearchView$SearchAutoComplete.setImeVisibility(boolean)>
				dismissSuggestions();
	//   32   70:aload_0         
	//   33   71:invokespecial   #1039 <Method void dismissSuggestions()>
			}
		}
	//   34   74:return          
	}
	...
	//*  10   18:aload_3         
	//*  11   19:invokevirtual   #1137 <Method int KeyEvent.getAction()>
	//*  12   22:ifne            155
	//*  13   25:aload_3         
	//*  14   26:invokevirtual   #1140 <Method boolean KeyEvent.hasNoModifiers()>
	//*  15   29:ifeq            155
			if(i != 66 && i != 84 && i != 61)
	//*  16   32:iload_2         
	//*  17   33:bipush          66
	...
	//*  38   78:invokevirtual   #1143 <Method int SearchView$SearchAutoComplete.getListSelection()>
	//*  39   81:ifne            155
						return false;
	//   40   84:iconst_0        
	//   41   85:ireturn         
	...
	//   50  101:invokevirtual   #1144 <Method int SearchView$SearchAutoComplete.length()>
	//   51  104:istore_2        
	...
	//   58  117:iconst_0        
	//   59  118:invokevirtual   #1147 <Method void SearchView$SearchAutoComplete.setListSelection(int)>
					mSearchSrcTextView.clearListSelection();
	//   60  121:aload_0         
	//   61  122:getfield        #245 <Field SearchView$SearchAutoComplete mSearchSrcTextView>
	//   62  125:invokevirtual   #1150 <Method void SearchView$SearchAutoComplete.clearListSelection()>
	...
	//   66  135:iconst_1        
	//   67  136:invokevirtual   #1154 <Method void SearchView$AutoCompleteTextViewReflector.ensureImeVisible(AutoCompleteTextView, boolean)>
					return true;
	//   68  139:iconst_1        
	//   69  140:ireturn         
				}
	...
	//   73  146:invokevirtual   #1143 <Method int SearchView$SearchAutoComplete.getListSelection()>
	//   74  149:iconst_0        
	//   75  150:aconst_null     
	//   76  151:invokevirtual   #1156 <Method boolean onItemClicked(int, int, String)>
	//   77  154:ireturn         
			}
		return false;
	//   78  155:iconst_0        
	...
	//*  31   54:aload_0         
	//*  32   55:getfield        #1123 <Field SearchView$OnQueryTextListener mOnQueryChangeListener>
	//*  33   58:ifnull          88
	//*  34   61:aload_1         
	//*  35   62:aload_0         
	//*  36   63:getfield        #1159 <Field CharSequence mOldQueryText>
	//*  37   66:invokestatic    #1163 <Method boolean TextUtils.equals(CharSequence, CharSequence)>
	//*  38   69:ifne            88
			mOnQueryChangeListener.onQueryTextChange(charsequence.toString());
	//   39   72:aload_0         
	//   40   73:getfield        #1123 <Field SearchView$OnQueryTextListener mOnQueryChangeListener>
	//   41   76:aload_1         
	//   42   77:invokeinterface #1124 <Method String CharSequence.toString()>
	//   43   82:invokeinterface #1166 <Method boolean SearchView$OnQueryTextListener.onQueryTextChange(String)>
	//   44   87:pop             
		mOldQueryText = ((CharSequence) (charsequence.toString()));
	//   45   88:aload_0         
	//   46   89:aload_1         
	//   47   90:invokeinterface #1124 <Method String CharSequence.toString()>
	//   48   95:putfield        #1159 <Field CharSequence mOldQueryText>
	//   49   98:return          
	}
	...
	//*   6   10:aload_1         
	//*   7   11:invokevirtual   #745 <Method boolean SearchableInfo.getVoiceSearchLaunchWebSearch()>
	//*   8   14:ifeq            36
		{
			obj = ((Object) (createVoiceWebSearchIntent(mVoiceWebSearchIntent, ((SearchableInfo) (obj)))));
	//    9   17:aload_0         
	//   10   18:aload_0         
	//   11   19:getfield        #459 <Field Intent mVoiceWebSearchIntent>
	//   12   22:aload_1         
	//   13   23:invokespecial   #1177 <Method Intent createVoiceWebSearchIntent(Intent, SearchableInfo)>
	//   14   26:astore_1        
			getContext().startActivity(((Intent) (obj)));
	//   15   27:aload_0         
	//   16   28:invokevirtual   #617 <Method Context getContext()>
	//   17   31:aload_1         
	//   18   32:invokevirtual   #782 <Method void Context.startActivity(Intent)>
			return;
	//   19   35:return          
		}
	...
	//*  20   36:aload_1         
	//*  21   37:invokevirtual   #748 <Method boolean SearchableInfo.getVoiceSearchLaunchRecognizer()>
	//*  22   40:ifeq            71
			{
				obj = ((Object) (createVoiceAppSearchIntent(mVoiceAppSearchIntent, ((SearchableInfo) (obj)))));
	//   23   43:aload_0         
	//   24   44:aload_0         
	//   25   45:getfield        #476 <Field Intent mVoiceAppSearchIntent>
	//   26   48:aload_1         
	//   27   49:invokespecial   #1179 <Method Intent createVoiceAppSearchIntent(Intent, SearchableInfo)>
	//   28   52:astore_1        
				getContext().startActivity(((Intent) (obj)));
	//   29   53:aload_0         
	//   30   54:invokevirtual   #617 <Method Context getContext()>
	//   31   57:aload_1         
	//   32   58:invokevirtual   #782 <Method void Context.startActivity(Intent)>
				return;
	//   33   61:return          
			}
		}
	//*  34   62:ldc1            #63  <String "SearchView">
	//*  35   64:ldc2            #1181 <String "Could not find voice search activity">
	//*  36   67:invokestatic    #1184 <Method int Log.w(String, String)>
	//*  37   70:pop             
	//*  38   71:return          
		// Misplaced declaration of an exception variable
	...
	//    4    8:ireturn         
		if(!isFocusable())
	//*   5    9:aload_0         
	//*   6   10:invokevirtual   #1191 <Method boolean isFocusable()>
	//*   7   13:ifne            18
			return false;
	//    8   16:iconst_0        
	//    9   17:ireturn         
	...
	//   15   29:iload_1         
	//   16   30:aload_2         
	//   17   31:invokevirtual   #1193 <Method boolean SearchView$SearchAutoComplete.requestFocus(int, Rect)>
	//   18   34:istore_3        
			if(flag)
	//*  19   35:iload_3         
	//*  20   36:ifeq            44
	...
	//   27   47:iload_1         
	//   28   48:aload_2         
	//   29   49:invokespecial   #1194 <Method boolean LinearLayoutCompat.requestFocus(int, Rect)>
	//   30   52:ireturn         
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #986 <Field int mMaxWidth>
		requestLayout();
	//    3    5:aload_0         
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #1017 <Field SearchView$OnCloseListener mOnCloseListener>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #1032 <Field SearchView$OnSuggestionListener mOnSuggestionListener>
	//    3    5:return          
	}
	...
	//    9   17:aload_3         
	//   10   18:aload_3         
	//   11   19:invokevirtual   #1144 <Method int SearchView$SearchAutoComplete.length()>
	//   12   22:invokevirtual   #841 <Method void SearchView$SearchAutoComplete.setSelection(int)>
			mUserQuery = charsequence;
	//   13   25:aload_0         
	//   14   26:aload_1         
	//   15   27:putfield        #507 <Field CharSequence mUserQuery>
		}
		if(flag && !TextUtils.isEmpty(charsequence))
	//*  16   30:iload_2         
	//*  17   31:ifeq            45
	//*  18   34:aload_1         
	//*  19   35:invokestatic    #833 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  20   38:ifne            45
			onSubmitQuery();
	//   21   41:aload_0         
	//   22   42:invokevirtual   #1216 <Method void onSubmitQuery()>
	//   23   45:return          
	}
	...
	//*   6   10:aload_3         
	//*   7   11:instanceof      #548 <Class SuggestionsAdapter>
	//*   8   14:ifeq            38
		{
			obj = ((Object) ((SuggestionsAdapter)obj));
	//    9   17:aload_3         
	//   10   18:checkcast       #548 <Class SuggestionsAdapter>
	//   11   21:astore_3        
			byte byte0;
			if(flag)
	//*  12   22:iload_1         
	...
	//   19   33:aload_3         
	//   20   34:iload_2         
	//   21   35:invokevirtual   #907 <Method void SuggestionsAdapter.setQueryRefinement(int)>
		}
	//   22   38:return          
	}
	...
	//   11   25:invokevirtual   #1238 <Method Drawable View.getBackground()>
	//   12   28:astore_2        
		if(drawable != null)
	//*  13   29:aload_2         
	//*  14   30:ifnull          39
	...
	//   21   43:invokevirtual   #1238 <Method Drawable View.getBackground()>
	//   22   46:astore_2        
		if(drawable != null)
	//*  23   47:aload_2         
	//*  24   48:ifnull          57
	...
	//   28   56:pop             
		invalidate();
	//   29   57:aload_0         
	//   30   58:invokevirtual   #1241 <Method void invalidate()>
	//   31   61:return          
	}
