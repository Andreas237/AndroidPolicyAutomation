...
public static class RecyclerView$RecycledViewPool
{
	...
	//*   5    7:invokevirtual   #46  <Method int SparseArray.size()>
	//*   6   10:icmpge          37
			((ScrapData)mScrap.valueAt(i)).mScrapHeap.clear();
	//    7   13:aload_0         
	//    8   14:getfield        #26  <Field SparseArray mScrap>
	//    9   17:iload_1         
	//   10   18:invokevirtual   #49  <Method Object SparseArray.valueAt(int)>
	//   11   21:checkcast       #9   <Class RecyclerView$RecycledViewPool$ScrapData>
	//   12   24:getfield        #53  <Field ArrayList RecyclerView$RecycledViewPool$ScrapData.mScrapHeap>
	//   13   27:invokevirtual   #57  <Method void ArrayList.clear()>
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:invokespecial   #62  <Method RecyclerView$RecycledViewPool$ScrapData getScrapDataForType(int)>
	//    3    5:astore          4
		scrapdata.mBindRunningAverageNs = runningAverage(scrapdata.mBindRunningAverageNs, l);
	//    4    7:aload           4
	//    5    9:aload_0         
	//    6   10:aload           4
	//    7   12:getfield        #66  <Field long RecyclerView$RecycledViewPool$ScrapData.mBindRunningAverageNs>
	//    8   15:lload_2         
	//    9   16:invokevirtual   #70  <Method long runningAverage(long, long)>
	//   10   19:putfield        #66  <Field long RecyclerView$RecycledViewPool$ScrapData.mBindRunningAverageNs>
	//   11   22:return          
	}
	...
	//    5    9:aload_0         
	//    6   10:aload           4
	//    7   12:getfield        #74  <Field long RecyclerView$RecycledViewPool$ScrapData.mCreateRunningAverageNs>
	//    8   15:lload_2         
	//    9   16:invokevirtual   #70  <Method long runningAverage(long, long)>
	//   10   19:putfield        #74  <Field long RecyclerView$RecycledViewPool$ScrapData.mCreateRunningAverageNs>
	//   11   22:return          
	}
	...
	//*   7   13:ifnull          45
	//*   8   16:aload_2         
	//*   9   17:getfield        #53  <Field ArrayList RecyclerView$RecycledViewPool$ScrapData.mScrapHeap>
	//*  10   20:invokevirtual   #81  <Method boolean ArrayList.isEmpty()>
	//*  11   23:ifne            45
		{
			obj = ((Object) (((ScrapData) (obj)).mScrapHeap));
	//   12   26:aload_2         
	//   13   27:getfield        #53  <Field ArrayList RecyclerView$RecycledViewPool$ScrapData.mScrapHeap>
	//   14   30:astore_2        
	...
	//    1    1:iload_1         
	//    2    2:invokespecial   #62  <Method RecyclerView$RecycledViewPool$ScrapData getScrapDataForType(int)>
	//    3    5:getfield        #53  <Field ArrayList RecyclerView$RecycledViewPool$ScrapData.mScrapHeap>
	...
	//*   1    1:ifnull          8
			detach();
	//    2    4:aload_0         
	//    3    5:invokevirtual   #94  <Method void detach()>
	...
	//*   8   16:ifne            23
			clear();
	//    9   19:aload_0         
	//   10   20:invokevirtual   #95  <Method void clear()>
		if(adapter1 != null)
	//*  11   23:aload_2         
	//*  12   24:ifnull          31
			attach();
	//   13   27:aload_0         
	//   14   28:invokevirtual   #97  <Method void attach()>
	//   15   31:return          
	}
	...
	//    0    0:aload_1         
	//    1    1:invokevirtual   #102 <Method int RecyclerView$ViewHolder.getItemViewType()>
	//    2    4:istore_2        
		ArrayList arraylist = getScrapDataForType(i).mScrapHeap;
	//    3    5:aload_0         
	//    4    6:iload_2         
	//    5    7:invokespecial   #62  <Method RecyclerView$RecycledViewPool$ScrapData getScrapDataForType(int)>
	//    6   10:getfield        #53  <Field ArrayList RecyclerView$RecycledViewPool$ScrapData.mScrapHeap>
	//    7   13:astore_3        
	...
	//*  13   25:getfield        #105 <Field int RecyclerView$RecycledViewPool$ScrapData.mMaxScrap>
	//*  14   28:aload_3         
	...
	//   18   36:aload_1         
	//   19   37:invokevirtual   #108 <Method void RecyclerView$ViewHolder.resetInternal()>
			arraylist.add(((Object) (viewholder)));
	//   20   40:aload_3         
	//   21   41:aload_1         
	//   22   42:invokevirtual   #112 <Method boolean ArrayList.add(Object)>
	//   23   45:pop             
			return;
	//   24   46:return          
		}
	...
	//    6    8:lload_1         
	//    7    9:ldc2w           #113 <Long 4L>
	//    8   12:ldiv            
	//    9   13:ldc2w           #115 <Long 3L>
	//   10   16:lmul            
	//   11   17:lload_3         
	//   12   18:ldc2w           #113 <Long 4L>
	//   13   21:ldiv            
	//   14   22:ladd            
	//   15   23:lreturn         
	}
	...
	//    4    6:aload_3         
	//    5    7:iload_2         
	//    6    8:putfield        #105 <Field int RecyclerView$RecycledViewPool$ScrapData.mMaxScrap>
		for(obj = ((Object) (((ScrapData) (obj)).mScrapHeap)); ((ArrayList) (obj)).size() > j; ((ArrayList) (obj)).remove(((ArrayList) (obj)).size() - 1));
	//    7   11:aload_3         
	//    8   12:getfield        #53  <Field ArrayList RecyclerView$RecycledViewPool$ScrapData.mScrapHeap>
	//    9   15:astore_3        
	//   10   16:aload_3         
	//   11   17:invokevirtual   #82  <Method int ArrayList.size()>
	//   12   20:iload_2         
	//   13   21:icmple          38
	//   14   24:aload_3         
	//   15   25:aload_3         
	//   16   26:invokevirtual   #82  <Method int ArrayList.size()>
	//   17   29:iconst_1        
	//   18   30:isub            
	//   19   31:invokevirtual   #85  <Method Object ArrayList.remove(int)>
	//   20   34:pop             
	//*  21   35:goto            16
	//   22   38:return          
	}
	...
	//*   7    9:invokevirtual   #46  <Method int SparseArray.size()>
	//*   8   12:icmpge          55
		{
	...
	//   11   19:iload_1         
	//   12   20:invokevirtual   #49  <Method Object SparseArray.valueAt(int)>
	//   13   23:checkcast       #9   <Class RecyclerView$RecycledViewPool$ScrapData>
	//   14   26:getfield        #53  <Field ArrayList RecyclerView$RecycledViewPool$ScrapData.mScrapHeap>
	//   15   29:astore          4
			k = j;
	//   16   31:iload_2         
	//   17   32:istore_3        
	...
	//    1    1:iload_1         
	//    2    2:invokespecial   #62  <Method RecyclerView$RecycledViewPool$ScrapData getScrapDataForType(int)>
	//    3    5:getfield        #66  <Field long RecyclerView$RecycledViewPool$ScrapData.mBindRunningAverageNs>
	//    4    8:lstore          6
	...
	//    1    1:iload_1         
	//    2    2:invokespecial   #62  <Method RecyclerView$RecycledViewPool$ScrapData getScrapDataForType(int)>
	//    3    5:getfield        #74  <Field long RecyclerView$RecycledViewPool$ScrapData.mCreateRunningAverageNs>
	//    4    8:lstore          6
		return l2 == 0L || l + l2 < l1;
	//    5   10:lload           6
	//    6   12:lconst_0        
