...
public class AppCompatCheckedTextView extends CheckedTextView
{
	...
	//    3    5:iload_1         
	//    4    6:invokestatic    #84  <Method android.graphics.drawable.Drawable AppCompatResources.getDrawable(Context, int)>
	...
	//    1    1:aload_0         
	//    2    2:aload_1         
	//    3    3:invokestatic    #93  <Method android.view.ActionMode$Callback TextViewCompat.wrapCustomSelectionActionModeCallback(android.widget.TextView, android.view.ActionMode$Callback)>
	//    4    6:invokespecial   #95  <Method void CheckedTextView.setCustomSelectionActionModeCallback(android.view.ActionMode$Callback)>
	//    5    9:return          
	}
	...
	//    1    1:aload_1         
	//    2    2:iload_2         
	//    3    3:invokespecial   #99  <Method void CheckedTextView.setTextAppearance(Context, int)>
		AppCompatTextHelper appcompattexthelper = mTextHelper;
	//    4    6:aload_0         
	...
	//   10   16:aload_1         
	//   11   17:iload_2         
	//   12   18:invokevirtual   #102 <Method void AppCompatTextHelper.onSetTextAppearance(Context, int)>
	//   13   21:return          
	}
