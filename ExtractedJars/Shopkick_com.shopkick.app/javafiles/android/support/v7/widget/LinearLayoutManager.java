...
;
	...
	//  107  229:aload           13
	//  108  231:iload           7
	//  109  233:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
				layoutstate.mAvailable = 0;
	//  110  236:aload           13
	//  111  238:iconst_0        
	//  112  239:putfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	...
	//  135  284:aload           13
	//  136  286:iload           6
	//  137  288:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
				layoutstate1.mAvailable = 0;
	//  138  291:aload           13
	//  139  293:iconst_0        
	//  140  294:putfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	...
	//*  17   30:iload_3         
	//*  18   31:aload_1         
	//*  19   32:invokevirtual   #160 <Method int RecyclerView$State.getItemCount()>
	//*  20   35:icmplt          41
	//*  21   38:goto            399
			{
	...
	//   22   41:aload_2         
	//   23   42:aload_0         
	//   24   43:getfield        #79  <Field int mPendingScrollPosition>
	//   25   46:putfield        #393 <Field int LinearLayoutManager$AnchorInfo.mPosition>
				state = ((RecyclerView.State) (mPendingSavedState));
	//   26   49:aload_0         
	//   27   50:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//   28   53:astore_1        
				if(state != null && ((SavedState) (state)).hasValidAnchor())
	//*  29   54:aload_1         
	//*  30   55:ifnull          125
	//*  31   58:aload_1         
	//*  32   59:invokevirtual   #396 <Method boolean LinearLayoutManager$SavedState.hasValidAnchor()>
	//*  33   62:ifeq            125
				{
					anchorinfo.mLayoutFromEnd = mPendingSavedState.mAnchorLayoutFromEnd;
	//   34   65:aload_2         
	//   35   66:aload_0         
	//   36   67:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//   37   70:getfield        #399 <Field boolean LinearLayoutManager$SavedState.mAnchorLayoutFromEnd>
	//   38   73:putfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
					if(anchorinfo.mLayoutFromEnd)
	//*  39   76:aload_2         
	//*  40   77:getfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
	//*  41   80:ifeq            104
					{
						anchorinfo.mCoordinate = mOrientationHelper.getEndAfterPadding() - mPendingSavedState.mAnchorOffset;
	//   42   83:aload_2         
	//   43   84:aload_0         
	//   44   85:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   45   88:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//   46   91:aload_0         
	//   47   92:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//   48   95:getfield        #402 <Field int LinearLayoutManager$SavedState.mAnchorOffset>
	//   49   98:isub            
	//   50   99:putfield        #388 <Field int LinearLayoutManager$AnchorInfo.mCoordinate>
						return true;
	//   51  102:iconst_1        
	//   52  103:ireturn         
					} else
	...
	//   53  104:aload_2         
	//   54  105:aload_0         
	//   55  106:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   56  109:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//   57  112:aload_0         
	//   58  113:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//   59  116:getfield        #402 <Field int LinearLayoutManager$SavedState.mAnchorOffset>
	//   60  119:iadd            
	//   61  120:putfield        #388 <Field int LinearLayoutManager$AnchorInfo.mCoordinate>
						return true;
	//   62  123:iconst_1        
	//   63  124:ireturn         
					}
	...
	//*  64  125:aload_0         
	//*  65  126:getfield        #81  <Field int mPendingScrollPositionOffset>
	//*  66  129:ldc1            #29  <Int 0x80000000>
	//*  67  131:icmpne          346
				{
					state = ((RecyclerView.State) (findViewByPosition(mPendingScrollPosition)));
	//   68  134:aload_0         
	//   69  135:aload_0         
	//   70  136:getfield        #79  <Field int mPendingScrollPosition>
	//   71  139:invokevirtual   #405 <Method View findViewByPosition(int)>
	//   72  142:astore_1        
					if(state != null)
	//*  73  143:aload_1         
	//*  74  144:ifnull          288
	...
	//*  75  147:aload_0         
	//*  76  148:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  77  151:aload_1         
	//*  78  152:invokevirtual   #253 <Method int OrientationHelper.getDecoratedMeasurement(View)>
	//*  79  155:aload_0         
	//*  80  156:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  81  159:invokevirtual   #408 <Method int OrientationHelper.getTotalSpace()>
	//*  82  162:icmple          171
						{
							anchorinfo.assignCoordinateFromPadding();
	//   83  165:aload_2         
	//   84  166:invokevirtual   #411 <Method void LinearLayoutManager$AnchorInfo.assignCoordinateFromPadding()>
							return true;
	//   85  169:iconst_1        
	//   86  170:ireturn         
						}
	...
	//*  87  171:aload_0         
	//*  88  172:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  89  175:aload_1         
	//*  90  176:invokevirtual   #309 <Method int OrientationHelper.getDecoratedStart(View)>
	//*  91  179:aload_0         
	//*  92  180:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  93  183:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//*  94  186:isub            
	//*  95  187:ifge            208
						{
	...
	//   96  190:aload_2         
	//   97  191:aload_0         
	//   98  192:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   99  195:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//  100  198:putfield        #388 <Field int LinearLayoutManager$AnchorInfo.mCoordinate>
							anchorinfo.mLayoutFromEnd = false;
	//  101  201:aload_2         
	//  102  202:iconst_0        
	//  103  203:putfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
							return true;
	//  104  206:iconst_1        
	//  105  207:ireturn         
						}
	...
	//* 106  208:aload_0         
	//* 107  209:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//* 108  212:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//* 109  215:aload_0         
	//* 110  216:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//* 111  219:aload_1         
	//* 112  220:invokevirtual   #353 <Method int OrientationHelper.getDecoratedEnd(View)>
	//* 113  223:isub            
	//* 114  224:ifge            245
						{
	...
	//  115  227:aload_2         
	//  116  228:aload_0         
	//  117  229:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  118  232:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//  119  235:putfield        #388 <Field int LinearLayoutManager$AnchorInfo.mCoordinate>
							anchorinfo.mLayoutFromEnd = true;
	//  120  238:aload_2         
	//  121  239:iconst_1        
	//  122  240:putfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
							return true;
	//  123  243:iconst_1        
	//  124  244:ireturn         
						}
						...
						if(anchorinfo.mLayoutFromEnd)
	//* 125  245:aload_2         
	//* 126  246:getfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
	//* 127  249:ifeq            272
							j = mOrientationHelper.getDecoratedEnd(((View) (state))) + mOrientationHelper.getTotalSpaceChange();
	//  128  252:aload_0         
	//  129  253:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  130  256:aload_1         
	//  131  257:invokevirtual   #353 <Method int OrientationHelper.getDecoratedEnd(View)>
	//  132  260:aload_0         
	//  133  261:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  134  264:invokevirtual   #414 <Method int OrientationHelper.getTotalSpaceChange()>
	//  135  267:iadd            
	//  136  268:istore_3        
						else
	//* 137  269:goto            281
	...
	//  138  272:aload_0         
	//  139  273:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  140  276:aload_1         
	//  141  277:invokevirtual   #309 <Method int OrientationHelper.getDecoratedStart(View)>
	//  142  280:istore_3        
						anchorinfo.mCoordinate = j;
	//  143  281:aload_2         
	//  144  282:iload_3         
	//  145  283:putfield        #388 <Field int LinearLayoutManager$AnchorInfo.mCoordinate>
						return true;
	//  146  286:iconst_1        
	//  147  287:ireturn         
					}
					if(getChildCount() > 0)
	//* 148  288:aload_0         
	//* 149  289:invokevirtual   #124 <Method int getChildCount()>
	//* 150  292:ifle            340
					{
	...
	//  152  296:aload_0         
	//  153  297:iconst_0        
	//  154  298:invokevirtual   #206 <Method View getChildAt(int)>
	//  155  301:invokevirtual   #234 <Method int getPosition(View)>
	//  156  304:istore_3        
						boolean flag1;
						if(mPendingScrollPosition < k)
	//* 157  305:aload_0         
	//* 158  306:getfield        #79  <Field int mPendingScrollPosition>
	//* 159  309:iload_3         
	//* 160  310:icmpge          319
							flag1 = true;
	//  161  313:iconst_1        
	...
	//* 166  322:iload           4
	//* 167  324:aload_0         
	//* 168  325:getfield        #73  <Field boolean mShouldReverseLayout>
	//* 169  328:icmpne          334
							flag3 = true;
	//  170  331:iconst_1        
	//  171  332:istore          5
	...
	//  172  334:aload_2         
	//  173  335:iload           5
	//  174  337:putfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
					}
					anchorinfo.assignCoordinateFromPadding();
	//  175  340:aload_2         
	//  176  341:invokevirtual   #411 <Method void LinearLayoutManager$AnchorInfo.assignCoordinateFromPadding()>
					return true;
	//  177  344:iconst_1        
	//  178  345:ireturn         
				}
	...
	//  179  346:aload_0         
	//  180  347:getfield        #73  <Field boolean mShouldReverseLayout>
	//  181  350:istore          4
				anchorinfo.mLayoutFromEnd = flag2;
	//  182  352:aload_2         
	//  183  353:iload           4
	//  184  355:putfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
				if(flag2)
	//* 185  358:iload           4
	//* 186  360:ifeq            381
				{
	...
	//  187  363:aload_2         
	//  188  364:aload_0         
	//  189  365:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  190  368:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//  191  371:aload_0         
	//  192  372:getfield        #81  <Field int mPendingScrollPositionOffset>
	//  193  375:isub            
	//  194  376:putfield        #388 <Field int LinearLayoutManager$AnchorInfo.mCoordinate>
					return true;
	//  195  379:iconst_1        
	//  196  380:ireturn         
				} else
	...
	//  197  381:aload_2         
	//  198  382:aload_0         
	//  199  383:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  200  386:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//  201  389:aload_0         
	//  202  390:getfield        #81  <Field int mPendingScrollPositionOffset>
	//  203  393:iadd            
	//  204  394:putfield        #388 <Field int LinearLayoutManager$AnchorInfo.mCoordinate>
					return true;
	//  205  397:iconst_1        
	//  206  398:ireturn         
				}
	...
	//  207  399:aload_0         
	//  208  400:iconst_m1       
	//  209  401:putfield        #79  <Field int mPendingScrollPosition>
				mPendingScrollPositionOffset = 0x80000000;
	//  210  404:aload_0         
	//  211  405:ldc1            #29  <Int 0x80000000>
	//  212  407:putfield        #81  <Field int mPendingScrollPositionOffset>
				return false;
	//  213  410:iconst_0        
	//  214  411:ireturn         
			}
	...
	//   14   30:aload           4
	//   15   32:iload_1         
	//   16   33:putfield        #326 <Field int LinearLayoutManager$LayoutState.mLayoutDirection>
		int k = -1;
	//   17   36:iconst_m1       
	//   18   37:istore          5
		if(i == 1)
	...
	//   22   44:aload           4
	//   23   46:aload           4
	//   24   48:getfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
	//   25   51:aload_0         
	//   26   52:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   27   55:invokevirtual   #431 <Method int OrientationHelper.getEndPadding()>
	//   28   58:iadd            
	//   29   59:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
			state = ((RecyclerView.State) (getChildClosestToEnd()));
	//   30   62:aload_0         
	//   31   63:invokespecial   #280 <Method View getChildClosestToEnd()>
	//   32   66:astore          4
			LayoutState layoutstate = mLayoutState;
	//   33   68:aload_0         
	//   34   69:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   35   72:astore          6
			if(!mShouldReverseLayout)
	//*  36   74:aload_0         
	//*  37   75:getfield        #73  <Field boolean mShouldReverseLayout>
	//*  38   78:ifeq            84
	//*  39   81:goto            87
				k = 1;
	//   40   84:iconst_1        
	...
	//   42   87:aload           6
	//   43   89:iload           5
	//   44   91:putfield        #434 <Field int LinearLayoutManager$LayoutState.mItemDirection>
			mLayoutState.mCurrentPosition = getPosition(((View) (state))) + mLayoutState.mItemDirection;
	//   45   94:aload_0         
	//   46   95:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   47   98:aload_0         
	//   48   99:aload           4
	//   49  101:invokevirtual   #234 <Method int getPosition(View)>
	//   50  104:aload_0         
	//   51  105:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   52  108:getfield        #434 <Field int LinearLayoutManager$LayoutState.mItemDirection>
	//   53  111:iadd            
	//   54  112:putfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
			mLayoutState.mOffset = mOrientationHelper.getDecoratedEnd(((View) (state)));
	//   55  115:aload_0         
	//   56  116:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   57  119:aload_0         
	//   58  120:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   59  123:aload           4
	//   60  125:invokevirtual   #353 <Method int OrientationHelper.getDecoratedEnd(View)>
	//   61  128:putfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
			i = mOrientationHelper.getDecoratedEnd(((View) (state))) - mOrientationHelper.getEndAfterPadding();
	//   62  131:aload_0         
	//   63  132:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   64  135:aload           4
	//   65  137:invokevirtual   #353 <Method int OrientationHelper.getDecoratedEnd(View)>
	//   66  140:aload_0         
	//   67  141:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   68  144:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//   69  147:isub            
	//   70  148:istore_1        
		} else
	//*  71  149:goto            261
	...
	//   72  152:aload_0         
	//   73  153:invokespecial   #261 <Method View getChildClosestToStart()>
	//   74  156:astore          4
			LayoutState layoutstate1 = mLayoutState;
	//   75  158:aload_0         
	//   76  159:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   77  162:astore          6
			layoutstate1.mExtra = layoutstate1.mExtra + mOrientationHelper.getStartAfterPadding();
	//   78  164:aload           6
	//   79  166:aload           6
	//   80  168:getfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
	//   81  171:aload_0         
	//   82  172:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   83  175:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//   84  178:iadd            
	//   85  179:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
			layoutstate1 = mLayoutState;
	//   86  182:aload_0         
	//   87  183:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   88  186:astore          6
			if(mShouldReverseLayout)
	//*  89  188:aload_0         
	//*  90  189:getfield        #73  <Field boolean mShouldReverseLayout>
	//*  91  192:ifeq            198
				k = 1;
	//   92  195:iconst_1        
	//   93  196:istore          5
	...
	//   94  198:aload           6
	//   95  200:iload           5
	//   96  202:putfield        #434 <Field int LinearLayoutManager$LayoutState.mItemDirection>
			mLayoutState.mCurrentPosition = getPosition(((View) (state))) + mLayoutState.mItemDirection;
	//   97  205:aload_0         
	//   98  206:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   99  209:aload_0         
	//  100  210:aload           4
	//  101  212:invokevirtual   #234 <Method int getPosition(View)>
	//  102  215:aload_0         
	//  103  216:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  104  219:getfield        #434 <Field int LinearLayoutManager$LayoutState.mItemDirection>
	//  105  222:iadd            
	//  106  223:putfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
			mLayoutState.mOffset = mOrientationHelper.getDecoratedStart(((View) (state)));
	//  107  226:aload_0         
	//  108  227:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  109  230:aload_0         
	//  110  231:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  111  234:aload           4
	//  112  236:invokevirtual   #309 <Method int OrientationHelper.getDecoratedStart(View)>
	//  113  239:putfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
			i = -mOrientationHelper.getDecoratedStart(((View) (state))) + mOrientationHelper.getStartAfterPadding();
	//  114  242:aload_0         
	//  115  243:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  116  246:aload           4
	//  117  248:invokevirtual   #309 <Method int OrientationHelper.getDecoratedStart(View)>
	//  118  251:ineg            
	//  119  252:aload_0         
	//  120  253:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  121  256:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//  122  259:iadd            
	//  123  260:istore_1        
		}
		state = ((RecyclerView.State) (mLayoutState));
	//  124  261:aload_0         
	//  125  262:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  126  265:astore          4
		state.mAvailable = j;
	//  127  267:aload           4
	//  128  269:iload_2         
	//  129  270:putfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
		if(flag)
	//* 130  273:iload_3         
	//* 131  274:ifeq            289
	...
	//  132  277:aload           4
	//  133  279:aload           4
	//  134  281:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//  135  284:iload_1         
	//  136  285:isub            
	//  137  286:putfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
		mLayoutState.mScrollingOffset = i;
	//  138  289:aload_0         
	//  139  290:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  140  293:iload_1         
	//  141  294:putfield        #329 <Field int LinearLayoutManager$LayoutState.mScrollingOffset>
	//  142  297:return          
	}
	...
	//   25   48:aload           4
	//   26   50:iload_1         
	//   27   51:putfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
		layoutstate.mLayoutDirection = 1;
	//   28   54:aload           4
	//   29   56:iconst_1        
	//   30   57:putfield        #326 <Field int LinearLayoutManager$LayoutState.mLayoutDirection>
	...
	//   34   66:aload           4
	//   35   68:ldc1            #29  <Int 0x80000000>
	//   36   70:putfield        #329 <Field int LinearLayoutManager$LayoutState.mScrollingOffset>
	//   37   73:return          
	}
	...
	//   11   21:aload_3         
	//   12   22:iload_1         
	//   13   23:putfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
		if(mShouldReverseLayout)
	//*  14   26:aload_0         
	//*  15   27:getfield        #73  <Field boolean mShouldReverseLayout>
	//*  16   30:ifeq            38
			i = 1;
	//   17   33:iconst_1        
	//   18   34:istore_1        
	...
	//   22   40:aload_3         
	//   23   41:iload_1         
	//   24   42:putfield        #434 <Field int LinearLayoutManager$LayoutState.mItemDirection>
		layoutstate = mLayoutState;
	//   25   45:aload_0         
	//   26   46:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   27   49:astore_3        
		layoutstate.mLayoutDirection = -1;
	//   28   50:aload_3         
	//   29   51:iconst_m1       
	//   30   52:putfield        #326 <Field int LinearLayoutManager$LayoutState.mLayoutDirection>
		layoutstate.mOffset = j;
	//   31   55:aload_3         
	//   32   56:iload_2         
	//   33   57:putfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
		layoutstate.mScrollingOffset = 0x80000000;
	//   34   60:aload_3         
	//   35   61:ldc1            #29  <Int 0x80000000>
	//   36   63:putfield        #329 <Field int LinearLayoutManager$LayoutState.mScrollingOffset>
	//   37   66:return          
	}
	...
	//*   6   11:ifnull          42
	//*   7   14:aload           9
	//*   8   16:invokevirtual   #396 <Method boolean LinearLayoutManager$SavedState.hasValidAnchor()>
	//*   9   19:ifeq            42
		{
			flag1 = mPendingSavedState.mAnchorLayoutFromEnd;
	//   10   22:aload_0         
	//   11   23:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//   12   26:getfield        #399 <Field boolean LinearLayoutManager$SavedState.mAnchorLayoutFromEnd>
	//   13   29:istore          7
			j = mPendingSavedState.mAnchorPosition;
	//   14   31:aload_0         
	//   15   32:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//   16   35:getfield        #466 <Field int LinearLayoutManager$SavedState.mAnchorPosition>
	//   17   38:istore_3        
		} else
	//*  18   39:goto            93
		{
	...
	//   19   42:aload_0         
	//   20   43:invokespecial   #468 <Method void resolveShouldLayoutReverse()>
			boolean flag2 = mShouldReverseLayout;
	//   21   46:aload_0         
	//   22   47:getfield        #73  <Field boolean mShouldReverseLayout>
	//   23   50:istore          8
			int l = mPendingScrollPosition;
	//   24   52:aload_0         
	//   25   53:getfield        #79  <Field int mPendingScrollPosition>
	//   26   56:istore          5
			flag1 = flag2;
	//   27   58:iload           8
	//   28   60:istore          7
	...
	//*  58  113:iload_3         
	//*  59  114:aload_0         
	//*  60  115:getfield        #91  <Field int mInitialPrefetchItemCount>
	//*  61  118:icmpge          155
	//*  62  121:iload           5
	//*  63  123:iflt            155
	//*  64  126:iload           5
	...
	//   68  133:iload           5
	//   69  135:iconst_0        
	//   70  136:invokeinterface #473 <Method void RecyclerView$LayoutManager$LayoutPrefetchRegistry.addPosition(int, int)>
			i1 += ((int) (byte0));
	//   71  141:iload           5
	//   72  143:iload           4
	//   73  145:iadd            
...
label1:
	...
	//   21   36:iload_2         
	//   22   37:aload_0         
	//   23   38:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   24   41:invokevirtual   #408 <Method int OrientationHelper.getTotalSpace()>
	//   25   44:i2f             
	...
	//   37   63:putfield        #329 <Field int LinearLayoutManager$LayoutState.mScrollingOffset>
		view.mRecycle = false;
	//   38   66:aload_1         
	//   39   67:iconst_0        
	//   40   68:putfield        #320 <Field boolean LinearLayoutManager$LayoutState.mRecycle>
	...
	//   44   74:aload           4
	//   45   76:iconst_1        
	//   46   77:invokevirtual   #278 <Method int fill(RecyclerView$Recycler, LinearLayoutManager$LayoutState, RecyclerView$State, boolean)>
	//   47   80:pop             
		if(i == -1)
	//*  48   81:iload_2         
	//*  49   82:iconst_m1       
	...
	//   52   87:aload_3         
	//   53   88:aload           4
	//   54   90:invokespecial   #638 <Method View findPartiallyOrCompletelyInvisibleChildClosestToStart(RecyclerView$Recycler, RecyclerView$State)>
	//   55   93:astore_1        
		else
	//*  56   94:goto            105
	...
	//   58   98:aload_3         
	//   59   99:aload           4
	//   60  101:invokespecial   #640 <Method View findPartiallyOrCompletelyInvisibleChildClosestToEnd(RecyclerView$Recycler, RecyclerView$State)>
	//   61  104:astore_1        
		if(i == -1)
	//*  62  105:iload_2         
	//*  63  106:iconst_m1       
	...
	//   65  110:aload_0         
	//   66  111:invokespecial   #261 <Method View getChildClosestToStart()>
	//   67  114:astore_3        
		else
	//*  68  115:goto            123
			recycler = ((RecyclerView.Recycler) (getChildClosestToEnd()));
	//   69  118:aload_0         
	//   70  119:invokespecial   #280 <Method View getChildClosestToEnd()>
	//   71  122:astore_3        
		if(((View) (recycler)).hasFocusable())
	//*  72  123:aload_3         
	//*  73  124:invokevirtual   #619 <Method boolean View.hasFocusable()>
	//*  74  127:ifeq            138
		{
			if(view == null)
	//*  75  130:aload_1         
	...
	//*  22   43:ifnull          65
	//*  23   46:aload           9
	//*  24   48:invokevirtual   #396 <Method boolean LinearLayoutManager$SavedState.hasValidAnchor()>
	//*  25   51:ifeq            65
			mPendingScrollPosition = mPendingSavedState.mAnchorPosition;
	//   26   54:aload_0         
	//   27   55:aload_0         
	//   28   56:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//   29   59:getfield        #466 <Field int LinearLayoutManager$SavedState.mAnchorPosition>
	//   30   62:putfield        #79  <Field int mPendingScrollPosition>
		ensureLayoutState();
	//   31   65:aload_0         
	//   32   66:invokevirtual   #127 <Method void ensureLayoutState()>
		mLayoutState.mRecycle = false;
	//   33   69:aload_0         
	//   34   70:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//   35   73:iconst_0        
	//   36   74:putfield        #320 <Field boolean LinearLayoutManager$LayoutState.mRecycle>
		resolveShouldLayoutReverse();
	//   37   77:aload_0         
	//   38   78:invokespecial   #468 <Method void resolveShouldLayoutReverse()>
		obj = ((Object) (getFocusedChild()));
	//   39   81:aload_0         
	//   40   82:invokevirtual   #365 <Method View getFocusedChild()>
	//   41   85:astore          9
		if(mAnchorInfo.mValid && mPendingScrollPosition == -1 && mPendingSavedState == null)
	//*  42   87:aload_0         
	//*  43   88:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//*  44   91:getfield        #661 <Field boolean LinearLayoutManager$AnchorInfo.mValid>
	//*  45   94:ifeq            176
	//*  46   97:aload_0         
	//*  47   98:getfield        #79  <Field int mPendingScrollPosition>
	//*  48  101:iconst_m1       
	//*  49  102:icmpne          176
	//*  50  105:aload_0         
	//*  51  106:getfield        #83  <Field LinearLayoutManager$SavedState mPendingSavedState>
	//*  52  109:ifnull          115
	//*  53  112:goto            176
		{
	...
	//*  55  117:ifnull          219
	//*  56  120:aload_0         
	//*  57  121:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  58  124:aload           9
	//*  59  126:invokevirtual   #309 <Method int OrientationHelper.getDecoratedStart(View)>
	//*  60  129:aload_0         
	//*  61  130:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  62  133:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//*  63  136:icmpge          158
	//*  64  139:aload_0         
	//*  65  140:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  66  143:aload           9
	//*  67  145:invokevirtual   #353 <Method int OrientationHelper.getDecoratedEnd(View)>
	//*  68  148:aload_0         
	//*  69  149:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  70  152:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//*  71  155:icmpgt          219
				mAnchorInfo.assignFromViewAndKeepVisibleRect(((View) (obj)), getPosition(((View) (obj))));
	//   72  158:aload_0         
	//   73  159:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//   74  162:aload           9
	//   75  164:aload_0         
	//   76  165:aload           9
	//   77  167:invokevirtual   #234 <Method int getPosition(View)>
	//   78  170:invokevirtual   #373 <Method void LinearLayoutManager$AnchorInfo.assignFromViewAndKeepVisibleRect(View, int)>
		} else
	//*  79  173:goto            219
		{
			mAnchorInfo.reset();
	//   80  176:aload_0         
	//   81  177:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//   82  180:invokevirtual   #664 <Method void LinearLayoutManager$AnchorInfo.reset()>
			AnchorInfo anchorinfo = mAnchorInfo;
	//   83  183:aload_0         
	//   84  184:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//   85  187:astore          9
			anchorinfo.mLayoutFromEnd = mShouldReverseLayout ^ mStackFromEnd;
	//   86  189:aload           9
	//   87  191:aload_0         
	//   88  192:getfield        #73  <Field boolean mShouldReverseLayout>
	//   89  195:aload_0         
	//   90  196:getfield        #75  <Field boolean mStackFromEnd>
	//   91  199:ixor            
	//   92  200:putfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
			updateAnchorInfoForLayout(recycler, state, anchorinfo);
	//   93  203:aload_0         
	//   94  204:aload_1         
	//   95  205:aload_2         
	//   96  206:aload           9
	//   97  208:invokespecial   #666 <Method void updateAnchorInfoForLayout(RecyclerView$Recycler, RecyclerView$State, LinearLayoutManager$AnchorInfo)>
			mAnchorInfo.mValid = true;
	//   98  211:aload_0         
	//   99  212:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//  100  215:iconst_1        
	//  101  216:putfield        #661 <Field boolean LinearLayoutManager$AnchorInfo.mValid>
		}
		int j = getExtraLayoutSpace(state);
	//  102  219:aload_0         
	//  103  220:aload_2         
	//  104  221:invokevirtual   #428 <Method int getExtraLayoutSpace(RecyclerView$State)>
	//  105  224:istore          4
		int i;
		if(mLayoutState.mLastScrollDelta >= 0)
	//* 106  226:aload_0         
	//* 107  227:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//* 108  230:getfield        #669 <Field int LinearLayoutManager$LayoutState.mLastScrollDelta>
	//* 109  233:iflt            245
		{
			i = j;
	//  110  236:iload           4
	...
	//  117  247:iload           4
	//  118  249:aload_0         
	//  119  250:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  120  253:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//  121  256:iadd            
	//  122  257:istore          6
		int i1 = i + mOrientationHelper.getEndPadding();
	//  123  259:iload_3         
	//  124  260:aload_0         
	//  125  261:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  126  264:invokevirtual   #431 <Method int OrientationHelper.getEndPadding()>
	//  127  267:iadd            
	//  128  268:istore          7
		i = l;
	//  129  270:iload           6
	...
	//  132  275:istore          4
		if(state.isPreLayout())
	//* 133  277:aload_2         
	//* 134  278:invokevirtual   #216 <Method boolean RecyclerView$State.isPreLayout()>
	//* 135  281:ifeq            426
		{
			int l1 = mPendingScrollPosition;
	//  136  284:aload_0         
	//  137  285:getfield        #79  <Field int mPendingScrollPosition>
	//  138  288:istore          8
			i = l;
	//  139  290:iload           6
	//  140  292:istore_3        
	...
	//  149  308:istore          4
				if(mPendingScrollPositionOffset != 0x80000000)
	//* 150  310:aload_0         
	//* 151  311:getfield        #81  <Field int mPendingScrollPositionOffset>
	//* 152  314:ldc1            #29  <Int 0x80000000>
	//* 153  316:icmpeq          426
				{
					View view = findViewByPosition(l1);
	//  154  319:aload_0         
	//  155  320:iload           8
	//  156  322:invokevirtual   #405 <Method View findViewByPosition(int)>
	//  157  325:astore          9
					i = l;
	//  158  327:iload           6
	//  159  329:istore_3        
	...
	//* 163  336:ifnull          426
					{
						if(mShouldReverseLayout)
	//* 164  339:aload_0         
	//* 165  340:getfield        #73  <Field boolean mShouldReverseLayout>
	//* 166  343:ifeq            372
						{
							i = mOrientationHelper.getEndAfterPadding() - mOrientationHelper.getDecoratedEnd(view) - mPendingScrollPositionOffset;
	//  167  346:aload_0         
	//  168  347:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  169  350:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//  170  353:aload_0         
	//  171  354:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  172  357:aload           9
	//  173  359:invokevirtual   #353 <Method int OrientationHelper.getDecoratedEnd(View)>
	//  174  362:isub            
	//  175  363:aload_0         
	//  176  364:getfield        #81  <Field int mPendingScrollPositionOffset>
	//  177  367:isub            
	//  178  368:istore_3        
						} else
	//* 179  369:goto            401
	...
	//  180  372:aload_0         
	//  181  373:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  182  376:aload           9
	//  183  378:invokevirtual   #309 <Method int OrientationHelper.getDecoratedStart(View)>
	//  184  381:istore_3        
							j = mOrientationHelper.getStartAfterPadding();
	//  185  382:aload_0         
	//  186  383:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  187  386:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//  188  389:istore          4
							i = mPendingScrollPositionOffset - (i - j);
	//  189  391:aload_0         
	//  190  392:getfield        #81  <Field int mPendingScrollPositionOffset>
	//  191  395:iload_3         
	//  192  396:iload           4
	//  193  398:isub            
	//  194  399:isub            
	...
	//* 211  426:aload_0         
	//* 212  427:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//* 213  430:getfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
	//* 214  433:ifeq            449
		{
			if(mShouldReverseLayout)
	//* 215  436:aload_0         
	//* 216  437:getfield        #73  <Field boolean mShouldReverseLayout>
	//* 217  440:ifeq            462
				k = 1;
	//  218  443:iconst_1        
	//  219  444:istore          5
	...
	//* 220  446:goto            462
		if(!mShouldReverseLayout)
	//* 221  449:aload_0         
	//* 222  450:getfield        #73  <Field boolean mShouldReverseLayout>
	//* 223  453:ifeq            459
	//* 224  456:goto            462
			k = 1;
	//  225  459:iconst_1        
	...
	//  229  464:aload_2         
	//  230  465:aload_0         
	//  231  466:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//  232  469:iload           5
	//  233  471:invokevirtual   #671 <Method void onAnchorReady(RecyclerView$Recycler, RecyclerView$State, LinearLayoutManager$AnchorInfo, int)>
		detachAndScrapAttachedViews(recycler);
	//  234  474:aload_0         
	//  235  475:aload_1         
	//  236  476:invokevirtual   #674 <Method void detachAndScrapAttachedViews(RecyclerView$Recycler)>
		mLayoutState.mInfinite = resolveIsInfinite();
	//  237  479:aload_0         
	//  238  480:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  239  483:aload_0         
	//  240  484:invokevirtual   #425 <Method boolean resolveIsInfinite()>
	//  241  487:putfield        #323 <Field boolean LinearLayoutManager$LayoutState.mInfinite>
		mLayoutState.mIsPreLayout = state.isPreLayout();
	//  242  490:aload_0         
	//  243  491:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  244  494:aload_2         
	//  245  495:invokevirtual   #216 <Method boolean RecyclerView$State.isPreLayout()>
	//  246  498:putfield        #677 <Field boolean LinearLayoutManager$LayoutState.mIsPreLayout>
		if(mAnchorInfo.mLayoutFromEnd)
	//* 247  501:aload_0         
	//* 248  502:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//* 249  505:getfield        #378 <Field boolean LinearLayoutManager$AnchorInfo.mLayoutFromEnd>
	//* 250  508:ifeq            712
		{
			updateLayoutStateToFillStart(mAnchorInfo);
	//  251  511:aload_0         
	//  252  512:aload_0         
	//  253  513:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//  254  516:invokespecial   #679 <Method void updateLayoutStateToFillStart(LinearLayoutManager$AnchorInfo)>
			LayoutState layoutstate = mLayoutState;
	//  255  519:aload_0         
	//  256  520:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  257  523:astore          9
			layoutstate.mExtra = i;
	//  258  525:aload           9
	//  259  527:iload_3         
	//  260  528:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
	...
	//  264  535:aload_2         
	//  265  536:iconst_0        
	//  266  537:invokevirtual   #278 <Method int fill(RecyclerView$Recycler, LinearLayoutManager$LayoutState, RecyclerView$State, boolean)>
	//  267  540:pop             
			k = mLayoutState.mOffset;
	//  268  541:aload_0         
	//  269  542:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  270  545:getfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
	//  271  548:istore          5
			int j1 = mLayoutState.mCurrentPosition;
	//  272  550:aload_0         
	//  273  551:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  274  554:getfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
	//  275  557:istore          7
			i = j;
	//  276  559:iload           4
	//  277  561:istore_3        
	...
	//* 278  562:aload_0         
	//* 279  563:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//* 280  566:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//* 281  569:ifle            583
				i = j + mLayoutState.mAvailable;
	//  282  572:iload           4
	//  283  574:aload_0         
	//  284  575:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  285  578:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//  286  581:iadd            
	//  287  582:istore_3        
			updateLayoutStateToFillEnd(mAnchorInfo);
	//  288  583:aload_0         
	//  289  584:aload_0         
	//  290  585:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//  291  588:invokespecial   #681 <Method void updateLayoutStateToFillEnd(LinearLayoutManager$AnchorInfo)>
			layoutstate = mLayoutState;
	//  292  591:aload_0         
	//  293  592:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  294  595:astore          9
			layoutstate.mExtra = i;
	//  295  597:aload           9
	//  296  599:iload_3         
	//  297  600:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
			layoutstate.mCurrentPosition = layoutstate.mCurrentPosition + mLayoutState.mItemDirection;
	//  298  603:aload           9
	//  299  605:aload           9
	//  300  607:getfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
	//  301  610:aload_0         
	//  302  611:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  303  614:getfield        #434 <Field int LinearLayoutManager$LayoutState.mItemDirection>
	//  304  617:iadd            
	//  305  618:putfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
			fill(recycler, mLayoutState, state, false);
	//  306  621:aload_0         
	//  307  622:aload_1         
	//  308  623:aload_0         
	//  309  624:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  310  627:aload_2         
	//  311  628:iconst_0        
	//  312  629:invokevirtual   #278 <Method int fill(RecyclerView$Recycler, LinearLayoutManager$LayoutState, RecyclerView$State, boolean)>
	//  313  632:pop             
			l = mLayoutState.mOffset;
	//  314  633:aload_0         
	//  315  634:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  316  637:getfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
	//  317  640:istore          6
			j = k;
	//  318  642:iload           5
	//  319  644:istore          4
	...
	//  321  648:istore_3        
			if(mLayoutState.mAvailable > 0)
	//* 322  649:aload_0         
	//* 323  650:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//* 324  653:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//* 325  656:ifle            912
			{
				i = mLayoutState.mAvailable;
	//  326  659:aload_0         
	//  327  660:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  328  663:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//  329  666:istore_3        
				updateLayoutStateToFillStart(j1, k);
	//  330  667:aload_0         
	//  331  668:iload           7
	//  332  670:iload           5
	//  333  672:invokespecial   #265 <Method void updateLayoutStateToFillStart(int, int)>
				LayoutState layoutstate1 = mLayoutState;
	//  334  675:aload_0         
	//  335  676:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  336  679:astore          9
				layoutstate1.mExtra = i;
	//  337  681:aload           9
	//  338  683:iload_3         
	//  339  684:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
	...
	//  343  691:aload_2         
	//  344  692:iconst_0        
	//  345  693:invokevirtual   #278 <Method int fill(RecyclerView$Recycler, LinearLayoutManager$LayoutState, RecyclerView$State, boolean)>
	//  346  696:pop             
				j = mLayoutState.mOffset;
	//  347  697:aload_0         
	//  348  698:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  349  701:getfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
	//  350  704:istore          4
				i = l;
	//  351  706:iload           6
	//  352  708:istore_3        
	...
	//  354  712:aload_0         
	//  355  713:aload_0         
	//  356  714:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//  357  717:invokespecial   #681 <Method void updateLayoutStateToFillEnd(LinearLayoutManager$AnchorInfo)>
			LayoutState layoutstate2 = mLayoutState;
	//  358  720:aload_0         
	//  359  721:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  360  724:astore          9
			layoutstate2.mExtra = j;
	//  361  726:aload           9
	//  362  728:iload           4
	//  363  730:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
	...
	//  367  737:aload_2         
	//  368  738:iconst_0        
	//  369  739:invokevirtual   #278 <Method int fill(RecyclerView$Recycler, LinearLayoutManager$LayoutState, RecyclerView$State, boolean)>
	//  370  742:pop             
			k = mLayoutState.mOffset;
	//  371  743:aload_0         
	//  372  744:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  373  747:getfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
	//  374  750:istore          5
			int k1 = mLayoutState.mCurrentPosition;
	//  375  752:aload_0         
	//  376  753:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  377  756:getfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
	//  378  759:istore          7
			j = i;
	//  379  761:iload_3         
	//  380  762:istore          4
			if(mLayoutState.mAvailable > 0)
	//* 381  764:aload_0         
	//* 382  765:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//* 383  768:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//* 384  771:ifle            785
				j = i + mLayoutState.mAvailable;
	//  385  774:iload_3         
	//  386  775:aload_0         
	//  387  776:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  388  779:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//  389  782:iadd            
	//  390  783:istore          4
			updateLayoutStateToFillStart(mAnchorInfo);
	//  391  785:aload_0         
	//  392  786:aload_0         
	//  393  787:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//  394  790:invokespecial   #679 <Method void updateLayoutStateToFillStart(LinearLayoutManager$AnchorInfo)>
			layoutstate2 = mLayoutState;
	//  395  793:aload_0         
	//  396  794:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  397  797:astore          9
			layoutstate2.mExtra = j;
	//  398  799:aload           9
	//  399  801:iload           4
	//  400  803:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
			layoutstate2.mCurrentPosition = layoutstate2.mCurrentPosition + mLayoutState.mItemDirection;
	//  401  806:aload           9
	//  402  808:aload           9
	//  403  810:getfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
	//  404  813:aload_0         
	//  405  814:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  406  817:getfield        #434 <Field int LinearLayoutManager$LayoutState.mItemDirection>
	//  407  820:iadd            
	//  408  821:putfield        #437 <Field int LinearLayoutManager$LayoutState.mCurrentPosition>
			fill(recycler, mLayoutState, state, false);
	//  409  824:aload_0         
	//  410  825:aload_1         
	//  411  826:aload_0         
	//  412  827:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  413  830:aload_2         
	//  414  831:iconst_0        
	//  415  832:invokevirtual   #278 <Method int fill(RecyclerView$Recycler, LinearLayoutManager$LayoutState, RecyclerView$State, boolean)>
	//  416  835:pop             
			l = mLayoutState.mOffset;
	//  417  836:aload_0         
	//  418  837:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  419  840:getfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
	//  420  843:istore          6
			j = l;
	//  421  845:iload           6
	//  422  847:istore          4
	...
	//  424  851:istore_3        
			if(mLayoutState.mAvailable > 0)
	//* 425  852:aload_0         
	//* 426  853:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//* 427  856:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//* 428  859:ifle            912
			{
				i = mLayoutState.mAvailable;
	//  429  862:aload_0         
	//  430  863:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  431  866:getfield        #271 <Field int LinearLayoutManager$LayoutState.mAvailable>
	//  432  869:istore_3        
				updateLayoutStateToFillEnd(k1, k);
	//  433  870:aload_0         
	//  434  871:iload           7
	//  435  873:iload           5
	//  436  875:invokespecial   #283 <Method void updateLayoutStateToFillEnd(int, int)>
				LayoutState layoutstate3 = mLayoutState;
	//  437  878:aload_0         
	//  438  879:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  439  882:astore          9
				layoutstate3.mExtra = i;
	//  440  884:aload           9
	//  441  886:iload_3         
	//  442  887:putfield        #268 <Field int LinearLayoutManager$LayoutState.mExtra>
	...
	//  446  894:aload_2         
	//  447  895:iconst_0        
	//  448  896:invokevirtual   #278 <Method int fill(RecyclerView$Recycler, LinearLayoutManager$LayoutState, RecyclerView$State, boolean)>
	//  449  899:pop             
				i = mLayoutState.mOffset;
	//  450  900:aload_0         
	//  451  901:getfield        #255 <Field LinearLayoutManager$LayoutState mLayoutState>
	//  452  904:getfield        #440 <Field int LinearLayoutManager$LayoutState.mOffset>
	//  453  907:istore_3        
				j = l;
	//  454  908:iload           6
	//  455  910:istore          4
	...
	//  459  917:istore          6
		if(getChildCount() > 0)
	//* 460  919:aload_0         
	//* 461  920:invokevirtual   #124 <Method int getChildCount()>
	//* 462  923:ifle            1027
			if(mShouldReverseLayout ^ mStackFromEnd)
	//* 463  926:aload_0         
	//* 464  927:getfield        #73  <Field boolean mShouldReverseLayout>
	//* 465  930:aload_0         
	//* 466  931:getfield        #75  <Field boolean mStackFromEnd>
	//* 467  934:ixor            
	//* 468  935:ifeq            985
			{
	...
	//  472  941:aload_2         
	//  473  942:iconst_1        
	//  474  943:invokespecial   #683 <Method int fixLayoutEndGap(int, RecyclerView$Recycler, RecyclerView$State, boolean)>
	//  475  946:istore          6
				k = j + l;
	//  476  948:iload           4
	//  477  950:iload           6
	...
	//  483  959:aload_2         
	//  484  960:iconst_0        
	//  485  961:invokespecial   #685 <Method int fixLayoutStartGap(int, RecyclerView$Recycler, RecyclerView$State, boolean)>
	//  486  964:istore          4
				k += j;
	//  487  966:iload           5
	//  488  968:iload           4
	...
	//  501  989:aload_2         
	//  502  990:iconst_1        
	//  503  991:invokespecial   #685 <Method int fixLayoutStartGap(int, RecyclerView$Recycler, RecyclerView$State, boolean)>
	//  504  994:istore          5
				i += k;
	//  505  996:iload_3         
	//  506  997:iload           5
	...
	//  512 1004:aload_2         
	//  513 1005:iconst_0        
	//  514 1006:invokespecial   #683 <Method int fixLayoutEndGap(int, RecyclerView$Recycler, RecyclerView$State, boolean)>
	//  515 1009:istore          6
				k = j + k + l;
	//  516 1011:iload           4
	//  517 1013:iload           5
	...
	//  529 1030:iload           5
	//  530 1032:iload           6
	//  531 1034:invokespecial   #687 <Method void layoutForPredictiveAnimations(RecyclerView$Recycler, RecyclerView$State, int, int)>
		if(!state.isPreLayout())
	//* 532 1037:aload_2         
	//* 533 1038:invokevirtual   #216 <Method boolean RecyclerView$State.isPreLayout()>
	//* 534 1041:ifne            1054
			mOrientationHelper.onLayoutComplete();
	//  535 1044:aload_0         
	//  536 1045:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//  537 1048:invokevirtual   #690 <Method void OrientationHelper.onLayoutComplete()>
		else
	//* 538 1051:goto            1061
			mAnchorInfo.reset();
	//  539 1054:aload_0         
	//  540 1055:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//  541 1058:invokevirtual   #664 <Method void LinearLayoutManager$AnchorInfo.reset()>
		mLastStackFromEnd = mStackFromEnd;
	//  542 1061:aload_0         
	//  543 1062:aload_0         
	//  544 1063:getfield        #75  <Field boolean mStackFromEnd>
	//  545 1066:putfield        #375 <Field boolean mLastStackFromEnd>
	//  546 1069:return          
	}
	...
	//    6   12:dup             
	//    7   13:aload_2         
	//    8   14:invokespecial   #704 <Method void LinearLayoutManager$SavedState(LinearLayoutManager$SavedState)>
	//    9   17:areturn         
		savedstate = new SavedState();
	//   10   18:new             #19  <Class LinearLayoutManager$SavedState>
	//   11   21:dup             
	//   12   22:invokespecial   #705 <Method void LinearLayoutManager$SavedState()>
	//   13   25:astore_2        
		if(getChildCount() > 0)
	//*  14   26:aload_0         
	//*  15   27:invokevirtual   #124 <Method int getChildCount()>
	//*  16   30:ifle            128
		{
			ensureLayoutState();
	//   17   33:aload_0         
	//   18   34:invokevirtual   #127 <Method void ensureLayoutState()>
			boolean flag = mLastStackFromEnd ^ mShouldReverseLayout;
	//   19   37:aload_0         
	//   20   38:getfield        #375 <Field boolean mLastStackFromEnd>
	//   21   41:aload_0         
	//   22   42:getfield        #73  <Field boolean mShouldReverseLayout>
	//   23   45:ixor            
	//   24   46:istore_1        
			savedstate.mAnchorLayoutFromEnd = flag;
	//   25   47:aload_2         
	//   26   48:iload_1         
	//   27   49:putfield        #399 <Field boolean LinearLayoutManager$SavedState.mAnchorLayoutFromEnd>
			if(flag)
	//*  28   52:iload_1         
	//*  29   53:ifeq            92
			{
	...
	//   30   56:aload_0         
	//   31   57:invokespecial   #280 <Method View getChildClosestToEnd()>
	//   32   60:astore_3        
				savedstate.mAnchorOffset = mOrientationHelper.getEndAfterPadding() - mOrientationHelper.getDecoratedEnd(view);
	//   33   61:aload_2         
	//   34   62:aload_0         
	//   35   63:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   36   66:invokevirtual   #189 <Method int OrientationHelper.getEndAfterPadding()>
	//   37   69:aload_0         
	//   38   70:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   39   73:aload_3         
	//   40   74:invokevirtual   #353 <Method int OrientationHelper.getDecoratedEnd(View)>
	//   41   77:isub            
	//   42   78:putfield        #402 <Field int LinearLayoutManager$SavedState.mAnchorOffset>
				savedstate.mAnchorPosition = getPosition(view);
	//   43   81:aload_2         
	//   44   82:aload_0         
	//   45   83:aload_3         
	//   46   84:invokevirtual   #234 <Method int getPosition(View)>
	//   47   87:putfield        #466 <Field int LinearLayoutManager$SavedState.mAnchorPosition>
	...
	//   50   92:aload_0         
	//   51   93:invokespecial   #261 <Method View getChildClosestToStart()>
	//   52   96:astore_3        
				savedstate.mAnchorPosition = getPosition(view1);
	//   53   97:aload_2         
	//   54   98:aload_0         
	//   55   99:aload_3         
	//   56  100:invokevirtual   #234 <Method int getPosition(View)>
	//   57  103:putfield        #466 <Field int LinearLayoutManager$SavedState.mAnchorPosition>
				savedstate.mAnchorOffset = mOrientationHelper.getDecoratedStart(view1) - mOrientationHelper.getStartAfterPadding();
	//   58  106:aload_2         
	//   59  107:aload_0         
	//   60  108:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   61  111:aload_3         
	//   62  112:invokevirtual   #309 <Method int OrientationHelper.getDecoratedStart(View)>
	//   63  115:aload_0         
	//   64  116:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   65  119:invokevirtual   #200 <Method int OrientationHelper.getStartAfterPadding()>
	//   66  122:isub            
	//   67  123:putfield        #402 <Field int LinearLayoutManager$SavedState.mAnchorOffset>
				return ((Parcelable) (savedstate));
	//   68  126:aload_2         
	//   69  127:areturn         
			}
	...
	//   70  128:aload_2         
	//   71  129:invokevirtual   #708 <Method void LinearLayoutManager$SavedState.invalidateAnchor()>
			return ((Parcelable) (savedstate));
	//   72  132:aload_2         
	//   73  133:areturn         
		}
	...
	//    0    0:aload_0         
	//    1    1:ldc2            #717 <String "Cannot drop a view during a scroll or layout calculation">
	//    2    4:invokevirtual   #718 <Method void assertNotInLayoutOrScroll(String)>
		ensureLayoutState();
	//    3    7:aload_0         
	...
	//   42   79:iadd            
	//   43   80:isub            
	//   44   81:invokevirtual   #721 <Method void scrollToPositionWithOffset(int, int)>
				return;
	//   45   84:return          
			} else
			{
	...
	//   55  103:isub            
	//   56  104:invokevirtual   #721 <Method void scrollToPositionWithOffset(int, int)>
				return;
	//   57  107:return          
			}
		if(i == -1)
	...
	//   67  124:invokevirtual   #721 <Method void scrollToPositionWithOffset(int, int)>
			return;
	//   68  127:return          
		} else
		{
	...
	//   79  147:isub            
	//   80  148:invokevirtual   #721 <Method void scrollToPositionWithOffset(int, int)>
			return;
	//   81  151:return          
		}
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//    2    4:invokevirtual   #726 <Method int OrientationHelper.getMode()>
	//    3    7:ifne            22
	//    4   10:aload_0         
	...
	//*  10   17:ifnull          24
			savedstate.invalidateAnchor();
	//   11   20:aload_2         
	//   12   21:invokevirtual   #708 <Method void LinearLayoutManager$SavedState.invalidateAnchor()>
		requestLayout();
	//   13   24:aload_0         
	//   14   25:invokevirtual   #699 <Method void requestLayout()>
	//   15   28:return          
	}
	...
	//*  10   16:ifnull          23
			savedstate.invalidateAnchor();
	//   11   19:aload_3         
	//   12   20:invokevirtual   #708 <Method void LinearLayoutManager$SavedState.invalidateAnchor()>
		requestLayout();
	//   13   23:aload_0         
	//   14   24:invokevirtual   #699 <Method void requestLayout()>
	//   15   27:return          
	}
	...
	//*   5    9:goto            46
		{
			StringBuilder stringbuilder = new StringBuilder();
	//    6   12:new             #294 <Class StringBuilder>
	//    7   15:dup             
	//    8   16:invokespecial   #295 <Method void StringBuilder()>
	//    9   19:astore_2        
			stringbuilder.append("invalid orientation:");
	//   10   20:aload_2         
	//   11   21:ldc2            #732 <String "invalid orientation:">
	//   12   24:invokevirtual   #301 <Method StringBuilder StringBuilder.append(String)>
	//   13   27:pop             
			stringbuilder.append(i);
	//   14   28:aload_2         
	//   15   29:iload_1         
	//   16   30:invokevirtual   #304 <Method StringBuilder StringBuilder.append(int)>
	//   17   33:pop             
			throw new IllegalArgumentException(stringbuilder.toString());
	//   18   34:new             #734 <Class IllegalArgumentException>
	//   19   37:dup             
	//   20   38:aload_2         
	//   21   39:invokevirtual   #313 <Method String StringBuilder.toString()>
	//   22   42:invokespecial   #736 <Method void IllegalArgumentException(String)>
	//   23   45:athrow          
		}
		assertNotInLayoutOrScroll(((String) (null)));
	//   24   46:aload_0         
	//   25   47:aconst_null     
	//   26   48:invokevirtual   #718 <Method void assertNotInLayoutOrScroll(String)>
		if(i != mOrientation || mOrientationHelper == null)
	//*  27   51:iload_1         
	//*  28   52:aload_0         
	//*  29   53:getfield        #69  <Field int mOrientation>
	//*  30   56:icmpne          66
	//*  31   59:aload_0         
	//*  32   60:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//*  33   63:ifnonnull       95
		{
	...
	//   35   67:aload_0         
	//   36   68:iload_1         
	//   37   69:invokestatic    #740 <Method OrientationHelper OrientationHelper.createOrientationHelper(RecyclerView$LayoutManager, int)>
	//   38   72:putfield        #129 <Field OrientationHelper mOrientationHelper>
			mAnchorInfo.mOrientationHelper = mOrientationHelper;
	//   39   75:aload_0         
	//   40   76:getfield        #86  <Field LinearLayoutManager$AnchorInfo mAnchorInfo>
	//   41   79:aload_0         
	//   42   80:getfield        #129 <Field OrientationHelper mOrientationHelper>
	//   43   83:putfield        #741 <Field OrientationHelper LinearLayoutManager$AnchorInfo.mOrientationHelper>
			mOrientation = i;
	//   44   86:aload_0         
	//   45   87:iload_1         
	//   46   88:putfield        #69  <Field int mOrientation>
			requestLayout();
	//   47   91:aload_0         
	//   48   92:invokevirtual   #699 <Method void requestLayout()>
		}
	//   49   95:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aconst_null     
	//    2    2:invokevirtual   #718 <Method void assertNotInLayoutOrScroll(String)>
	...
	//    0    0:aload_0         
	//    1    1:invokevirtual   #747 <Method int getHeightMode()>
	//    2    4:ldc2            #748 <Int 0x40000000>
	//    3    7:icmpeq          29
	//    4   10:aload_0         
	//    5   11:invokevirtual   #751 <Method int getWidthMode()>
	//    6   14:ldc2            #748 <Int 0x40000000>
	//    7   17:icmpeq          29
	//    8   20:aload_0         
	//    9   21:invokevirtual   #754 <Method boolean hasFlexibleChildInBothOrientations()>
	//   10   24:ifeq            29
	//   11   27:iconst_1        
	//   12   28:ireturn         
	//   13   29:iconst_0        
	...
	//    0    0:new             #758 <Class LinearSmoothScroller>
	//    1    3:dup             
	//    2    4:aload_1         
	//    3    5:invokevirtual   #764 <Method Context RecyclerView.getContext()>
	//    4    8:invokespecial   #766 <Method void LinearSmoothScroller(Context)>
	//    5   11:astore_1        
		((LinearSmoothScroller) (recyclerview)).setTargetPosition(i);
	//    6   12:aload_1         
	//    7   13:iload_3         
	//    8   14:invokevirtual   #769 <Method void LinearSmoothScroller.setTargetPosition(int)>
		startSmoothScroll(((RecyclerView.SmoothScroller) (recyclerview)));
	//    9   17:aload_0         
	//   10   18:aload_1         
	//   11   19:invokevirtual   #773 <Method void startSmoothScroll(RecyclerView$SmoothScroller)>
	//   12   22:return          
	}
	...
	//    4    9:aload           8
	//    5   11:ldc2            #776 <String "validating child count ">
	...
	//*  64  123:icmpge          178
				{
					logChildren();
	//   65  126:aload_0         
	//   66  127:invokespecial   #778 <Method void logChildren()>
	...
	//   71  139:aload           8
	//   72  141:ldc2            #780 <String "detected invalid position. loc invalid? ">
	...
	//   80  157:aload           8
	//   81  159:iload           6
	//   82  161:invokevirtual   #783 <Method StringBuilder StringBuilder.append(boolean)>
	//   83  164:pop             
					throw new RuntimeException(stringbuilder1.toString());
	//   84  165:new             #785 <Class RuntimeException>
	//   85  168:dup             
	//   86  169:aload           8
	//   87  171:invokevirtual   #313 <Method String StringBuilder.toString()>
	//   88  174:invokespecial   #786 <Method void RuntimeException(String)>
	//   89  177:athrow          
				}
				if(k1 <= l)
	//*  90  178:iload           5
	...
	//*  97  188:goto            86
				{
					logChildren();
	//   98  191:aload_0         
	//   99  192:invokespecial   #778 <Method void logChildren()>
					throw new RuntimeException("detected invalid location");
	//  100  195:new             #785 <Class RuntimeException>
	//  101  198:dup             
	//  102  199:ldc2            #788 <String "detected invalid location">
	//  103  202:invokespecial   #786 <Method void RuntimeException(String)>
	//  104  205:athrow          
				}
			}
	...
	//* 126  245:icmpge          304
				{
					logChildren();
	//  127  248:aload_0         
	//  128  249:invokespecial   #778 <Method void logChildren()>
	...
	//  133  261:aload           8
	//  134  263:ldc2            #780 <String "detected invalid position. loc invalid? ">
	...
	//  144  283:aload           8
	//  145  285:iload           6
	//  146  287:invokevirtual   #783 <Method StringBuilder StringBuilder.append(boolean)>
	//  147  290:pop             
					throw new RuntimeException(stringbuilder2.toString());
	//  148  291:new             #785 <Class RuntimeException>
	//  149  294:dup             
	//  150  295:aload           8
	//  151  297:invokevirtual   #313 <Method String StringBuilder.toString()>
	//  152  300:invokespecial   #786 <Method void RuntimeException(String)>
	//  153  303:athrow          
				}
				if(l1 >= l)
	//* 154  304:iload           5
	...
	//* 161  314:goto            208
				{
					logChildren();
	//  162  317:aload_0         
	//  163  318:invokespecial   #778 <Method void logChildren()>
					throw new RuntimeException("detected invalid location");
	//  164  321:new             #785 <Class RuntimeException>
	//  165  324:dup             
	//  166  325:ldc2            #788 <String "detected invalid location">
	//  167  328:invokespecial   #786 <Method void RuntimeException(String)>
	//  168  331:athrow          
				}
			}
