...
class AppCompatTextViewAutoSizeHelper
{
	...
	//   46  104:new             #231 <Class StaticLayout>
	//   47  107:dup             
	//   48  108:aload_1         
	//   49  109:aload_0         
	//   50  110:getfield        #148 <Field TextPaint mTempTextPaint>
	//   51  113:iload_3         
	//   52  114:aload_2         
	//   53  115:fload           4
	//   54  117:fload           5
	//   55  119:iload           6
	//   56  121:invokespecial   #234 <Method void StaticLayout(CharSequence, TextPaint, int, android.text.Layout$Alignment, float, float, boolean)>
	//   57  124:areturn         
	}
	...
	//   21   30:idiv            
	//   22   31:istore          5
				if(suggestedSizeFitsInSpace(mAutoSizeTextSizesInPx[i1], rectf))
	//*  23   33:aload_0         
	//*  24   34:aload_0         
	//*  25   35:getfield        #69  <Field int[] mAutoSizeTextSizesInPx>
	//*  26   38:iload           5
	//*  27   40:iaload          
	//*  28   41:aload_1         
	//*  29   42:invokespecial   #240 <Method boolean suggestedSizeFitsInSpace(int, RectF)>
	//*  30   45:ifeq            58
				{
					k = j;
	//   31   48:iload_2         
	...
	//*  44   66:goto            19
			return mAutoSizeTextSizesInPx[k];
	//   45   69:aload_0         
	//   46   70:getfield        #69  <Field int[] mAutoSizeTextSizesInPx>
	//   47   73:iload_3         
	//   48   74:iaload          
	//   49   75:ireturn         
		} else
	...
	//   50   76:new             #242 <Class IllegalStateException>
	//   51   79:dup             
	//   52   80:ldc1            #244 <String "No available text sizes to choose from.">
	//   53   82:invokespecial   #247 <Method void IllegalStateException(String)>
	//   54   85:athrow          
		}
	}
	...
	//   20   34:aload_0         
	//   21   35:getfield        #69  <Field int[] mAutoSizeTextSizesInPx>
	//   22   38:astore_3        
	...
	//   26   42:iaload          
	//   27   43:i2f             
	//   28   44:putfield        #65  <Field float mAutoSizeMinTextSizeInPx>
	...
	//   34   52:iaload          
	//   35   53:i2f             
	//   36   54:putfield        #67  <Field float mAutoSizeMaxTextSizeInPx>
			mAutoSizeStepGranularityInPx = -1F;
	//   37   57:aload_0         
	//   38   58:ldc1            #20  <Float -1F>
	//   39   60:putfield        #63  <Field float mAutoSizeStepGranularityInPx>
		}
		return mHasPresetAutoSizeValues;
	//   40   63:aload_0         
	//   41   64:getfield        #71  <Field boolean mHasPresetAutoSizeValues>
	//   42   67:ireturn         
	}
	...
	//   39   87:aload_0         
	//   40   88:new             #312 <Class TextPaint>
	//   41   91:dup             
	//   42   92:invokespecial   #380 <Method void TextPaint()>
	//   43   95:putfield        #148 <Field TextPaint mTempTextPaint>
		else
	//*  44   98:goto            106
			((TextPaint) (obj)).reset();
	//   45  101:aload           5
	//   46  103:invokevirtual   #383 <Method void TextPaint.reset()>
		mTempTextPaint.set(mTextView.getPaint());
	//   47  106:aload_0         
	//   48  107:getfield        #148 <Field TextPaint mTempTextPaint>
	//   49  110:aload_0         
	//   50  111:getfield        #73  <Field TextView mTextView>
	//   51  114:invokevirtual   #310 <Method TextPaint TextView.getPaint()>
	//   52  117:invokevirtual   #387 <Method void TextPaint.set(TextPaint)>
		mTempTextPaint.setTextSize(i);
	//   53  120:aload_0         
	//   54  121:getfield        #148 <Field TextPaint mTempTextPaint>
	//   55  124:iload_1         
	//   56  125:i2f             
	//   57  126:invokevirtual   #318 <Method void TextPaint.setTextSize(float)>
	...
	//   58  129:aload_0         
	//   59  130:aload_0         
	//   60  131:getfield        #73  <Field TextView mTextView>
	//   61  134:ldc2            #389 <String "getLayoutAlignment">
	//   62  137:getstatic       #395 <Field android.text.Layout$Alignment android.text.Layout$Alignment.ALIGN_NORMAL>
	//   63  140:invokespecial   #139 <Method Object invokeAndReturnWithDefault(Object, String, Object)>
	//   64  143:checkcast       #391 <Class android.text.Layout$Alignment>
	//   65  146:astore          5
		if(android.os.Build.VERSION.SDK_INT >= 23)
	//*  66  148:getstatic       #210 <Field int android.os.Build$VERSION.SDK_INT>
	//*  67  151:bipush          23
	//*  68  153:icmplt          177
	...
	//   71  159:aload           5
	//   72  161:aload_2         
	//   73  162:getfield        #398 <Field float RectF.right>
	//   74  165:invokestatic    #348 <Method int Math.round(float)>
	//   75  168:iload_3         
	//   76  169:invokespecial   #400 <Method StaticLayout createStaticLayoutForMeasuring(CharSequence, android.text.Layout$Alignment, int, int)>
	//   77  172:astore          5
		else
	//*  78  174:goto            194
	...
	//   81  180:aload           5
	//   82  182:aload_2         
	//   83  183:getfield        #398 <Field float RectF.right>
	//   84  186:invokestatic    #348 <Method int Math.round(float)>
	//   85  189:invokespecial   #402 <Method StaticLayout createStaticLayoutForMeasuringPre23(CharSequence, android.text.Layout$Alignment, int)>
	//   86  192:astore          5
	...
	//*  89  196:icmpeq          232
	//*  90  199:aload           5
	//*  91  201:invokevirtual   #405 <Method int StaticLayout.getLineCount()>
	//*  92  204:iload_3         
	//*  93  205:icmpgt          230
	//*  94  208:aload           5
	//*  95  210:aload           5
	//*  96  212:invokevirtual   #405 <Method int StaticLayout.getLineCount()>
	//*  97  215:iconst_1        
	//*  98  216:isub            
	//*  99  217:invokevirtual   #409 <Method int StaticLayout.getLineEnd(int)>
	//* 100  220:aload           4
	//* 101  222:invokeinterface #146 <Method int CharSequence.length()>
	//* 102  227:icmpeq          232
			return false;
	//  103  230:iconst_0        
	//  104  231:ireturn         
	...
	//  105  232:aload           5
	//  106  234:invokevirtual   #412 <Method int StaticLayout.getHeight()>
	//  107  237:i2f             
	//  108  238:aload_2         
	//  109  239:getfield        #415 <Field float RectF.bottom>
	//  110  242:fcmpl           
	//  111  243:ifle            248
	//  112  246:iconst_0        
	//  113  247:ireturn         
	...
	//   12   18:aload_0         
	//   13   19:iconst_1        
	//   14   20:putfield        #59  <Field int mAutoSizeTextType>
					mAutoSizeMinTextSizeInPx = f;
	//   15   23:aload_0         
	//   16   24:fload_1         
	//   17   25:putfield        #65  <Field float mAutoSizeMinTextSizeInPx>
					mAutoSizeMaxTextSizeInPx = f1;
	//   18   28:aload_0         
	//   19   29:fload_2         
	//   20   30:putfield        #67  <Field float mAutoSizeMaxTextSizeInPx>
					mAutoSizeStepGranularityInPx = f2;
	//   21   33:aload_0         
	//   22   34:fload_3         
	//   23   35:putfield        #63  <Field float mAutoSizeStepGranularityInPx>
					mHasPresetAutoSizeValues = false;
	//   24   38:aload_0         
	//   25   39:iconst_0        
	//   26   40:putfield        #71  <Field boolean mHasPresetAutoSizeValues>
					return;
	//   27   43:return          
				} else
				{
					StringBuilder stringbuilder = new StringBuilder();
	//   28   44:new             #274 <Class StringBuilder>
	//   29   47:dup             
	//   30   48:invokespecial   #275 <Method void StringBuilder()>
	//   31   51:astore          4
					stringbuilder.append("The auto-size step granularity (");
	//   32   53:aload           4
	//   33   55:ldc2            #423 <String "The auto-size step granularity (">
	//   34   58:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   35   61:pop             
					stringbuilder.append(f2);
	//   36   62:aload           4
	//   37   64:fload_3         
	//   38   65:invokevirtual   #426 <Method StringBuilder StringBuilder.append(float)>
	//   39   68:pop             
					stringbuilder.append("px) is less or equal to (0px)");
	//   40   69:aload           4
	//   41   71:ldc2            #428 <String "px) is less or equal to (0px)">
	//   42   74:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   43   77:pop             
					throw new IllegalArgumentException(stringbuilder.toString());
	//   44   78:new             #421 <Class IllegalArgumentException>
	//   45   81:dup             
	//   46   82:aload           4
	//   47   84:invokevirtual   #287 <Method String StringBuilder.toString()>
	//   48   87:invokespecial   #429 <Method void IllegalArgumentException(String)>
	//   49   90:athrow          
				}
			} else
			{
				StringBuilder stringbuilder1 = new StringBuilder();
	//   50   91:new             #274 <Class StringBuilder>
	//   51   94:dup             
	//   52   95:invokespecial   #275 <Method void StringBuilder()>
	//   53   98:astore          4
				stringbuilder1.append("Maximum auto-size text size (");
	//   54  100:aload           4
	//   55  102:ldc2            #431 <String "Maximum auto-size text size (">
	//   56  105:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   57  108:pop             
				stringbuilder1.append(f1);
	//   58  109:aload           4
	//   59  111:fload_2         
	//   60  112:invokevirtual   #426 <Method StringBuilder StringBuilder.append(float)>
	//   61  115:pop             
				stringbuilder1.append("px) is less or equal to minimum auto-size ");
	//   62  116:aload           4
	//   63  118:ldc2            #433 <String "px) is less or equal to minimum auto-size ">
	//   64  121:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   65  124:pop             
				stringbuilder1.append("text size (");
	//   66  125:aload           4
	//   67  127:ldc2            #435 <String "text size (">
	//   68  130:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   69  133:pop             
				stringbuilder1.append(f);
	//   70  134:aload           4
	//   71  136:fload_1         
	//   72  137:invokevirtual   #426 <Method StringBuilder StringBuilder.append(float)>
	//   73  140:pop             
				stringbuilder1.append("px)");
	//   74  141:aload           4
	//   75  143:ldc2            #437 <String "px)">
	//   76  146:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   77  149:pop             
				throw new IllegalArgumentException(stringbuilder1.toString());
	//   78  150:new             #421 <Class IllegalArgumentException>
	//   79  153:dup             
	//   80  154:aload           4
	//   81  156:invokevirtual   #287 <Method String StringBuilder.toString()>
	//   82  159:invokespecial   #429 <Method void IllegalArgumentException(String)>
	//   83  162:athrow          
			}
		} else
		{
			StringBuilder stringbuilder2 = new StringBuilder();
	//   84  163:new             #274 <Class StringBuilder>
	//   85  166:dup             
	//   86  167:invokespecial   #275 <Method void StringBuilder()>
	//   87  170:astore          4
			stringbuilder2.append("Minimum auto-size text size (");
	//   88  172:aload           4
	//   89  174:ldc2            #439 <String "Minimum auto-size text size (">
	//   90  177:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   91  180:pop             
			stringbuilder2.append(f);
	//   92  181:aload           4
	//   93  183:fload_1         
	//   94  184:invokevirtual   #426 <Method StringBuilder StringBuilder.append(float)>
	//   95  187:pop             
			stringbuilder2.append("px) is less or equal to (0px)");
	//   96  188:aload           4
	//   97  190:ldc2            #428 <String "px) is less or equal to (0px)">
	//   98  193:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   99  196:pop             
			throw new IllegalArgumentException(stringbuilder2.toString());
	//  100  197:new             #421 <Class IllegalArgumentException>
	//  101  200:dup             
	//  102  201:aload           4
	//  103  203:invokevirtual   #287 <Method String StringBuilder.toString()>
	//  104  206:invokespecial   #429 <Method void IllegalArgumentException(String)>
	//  105  209:athrow          
		}
	}
	...
	//*  54  102:goto            151
				{
					StringBuilder stringbuilder = new StringBuilder();
	//   55  105:new             #274 <Class StringBuilder>
	//   56  108:dup             
	//   57  109:invokespecial   #275 <Method void StringBuilder()>
	//   58  112:astore          5
					stringbuilder.append("None of the preset sizes is valid: ");
	//   59  114:aload           5
	//   60  116:ldc2            #570 <String "None of the preset sizes is valid: ">
	//   61  119:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   62  122:pop             
					stringbuilder.append(Arrays.toString(ai));
	//   63  123:aload           5
	//   64  125:aload_1         
	//   65  126:invokestatic    #573 <Method String Arrays.toString(int[])>
	//   66  129:invokevirtual   #281 <Method StringBuilder StringBuilder.append(String)>
	//   67  132:pop             
					throw new IllegalArgumentException(stringbuilder.toString());
	//   68  133:new             #421 <Class IllegalArgumentException>
	//   69  136:dup             
	//   70  137:aload           5
	//   71  139:invokevirtual   #287 <Method String StringBuilder.toString()>
	//   72  142:invokespecial   #429 <Method void IllegalArgumentException(String)>
	//   73  145:athrow          
				}
			} else
			{
	...
	//   74  146:aload_0         
	//   75  147:iconst_0        
	//   76  148:putfield        #71  <Field boolean mHasPresetAutoSizeValues>
			}
			if(setupAutoSizeText())
	//*  77  151:aload_0         
	//*  78  152:invokespecial   #558 <Method boolean setupAutoSizeText()>
	//*  79  155:ifeq            162
				autoSizeText();
	//   80  158:aload_0         
	//   81  159:invokevirtual   #562 <Method void autoSizeText()>
		}
	//   82  162:return          
	}
	...
	//    5    9:invokestatic    #585 <Method Resources Resources.getSystem()>
	//    6   12:astore_3        
		else
	//*   7   13:goto            21
			obj = ((Object) (((Context) (obj)).getResources()));
	//    8   16:aload_3         
	//    9   17:invokevirtual   #542 <Method Resources Context.getResources()>
	//   10   20:astore_3        
	...
	//   13   23:fload_2         
	//   14   24:aload_3         
	//   15   25:invokevirtual   #546 <Method android.util.DisplayMetrics Resources.getDisplayMetrics()>
	//   16   28:invokestatic    #553 <Method float TypedValue.applyDimension(int, float, android.util.DisplayMetrics)>
	//   17   31:invokespecial   #587 <Method void setRawTextSize(float)>
	//   18   34:return          
	}
