...
label1:
	...
	//   25   50:iload_2         
	//   26   51:iand            
	//   27   52:putfield        #49  <Field int ViewInfoStore$InfoRecord.flags>
				if(i == 4)
	//*  28   55:iload_2         
	//*  29   56:iconst_4        
	//*  30   57:icmpne          69
	...
	//   31   60:aload           4
	//   32   62:getfield        #53  <Field RecyclerView$ItemAnimator$ItemHolderInfo ViewInfoStore$InfoRecord.preInfo>
	//   33   65:astore_1        
				} else
	//*  34   66:goto            81
				{
	...
	//   38   75:aload           4
	//   39   77:getfield        #56  <Field RecyclerView$ItemAnimator$ItemHolderInfo ViewInfoStore$InfoRecord.postInfo>
	//   40   80:astore_1        
				}
				if((inforecord.flags & 0xc) == 0)
	//*  41   81:aload           4
	//*  42   83:getfield        #49  <Field int ViewInfoStore$InfoRecord.flags>
	//*  43   86:bipush          12
	//*  44   88:iand            
	//*  45   89:ifne            106
				{
	...
	//   46   92:aload_0         
	//   47   93:getfield        #29  <Field ArrayMap mLayoutHolderMap>
	//   48   96:iload_3         
	//   49   97:invokevirtual   #59  <Method Object ArrayMap.removeAt(int)>
	//   50  100:pop             
					InfoRecord.recycle(inforecord);
	//   51  101:aload           4
	//   52  103:invokestatic    #63  <Method void ViewInfoStore$InfoRecord.recycle(ViewInfoStore$InfoRecord)>
				}
	...
	//   55  108:new             #65  <Class IllegalArgumentException>
	//   56  111:dup             
	//   57  112:ldc1            #67  <String "Must provide flag PRE or POST">
	//   58  114:invokespecial   #70  <Method void IllegalArgumentException(String)>
	//   59  117:athrow          
		}
		return null;
	//   60  118:aconst_null     
