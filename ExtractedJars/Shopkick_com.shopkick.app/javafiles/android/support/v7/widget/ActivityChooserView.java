...
;
	...
	//   57  111:putfield        #148 <Field View mActivityChooserContent>
		mActivityChooserContentBackground = mActivityChooserContent.getBackground();
	//   58  114:aload_0         
	//   59  115:aload_0         
	//   60  116:getfield        #148 <Field View mActivityChooserContent>
	//   61  119:invokevirtual   #154 <Method Drawable View.getBackground()>
	//   62  122:putfield        #156 <Field Drawable mActivityChooserContentBackground>
		mDefaultActivityButton = (FrameLayout)findViewById(android.support.v7.appcompat.R.id.default_activity_button);
	//   63  125:aload_0         
	//   64  126:aload_0         
	//   65  127:getstatic       #159 <Field int android.support.v7.appcompat.R$id.default_activity_button>
	//   66  130:invokevirtual   #146 <Method View findViewById(int)>
	//   67  133:checkcast       #161 <Class FrameLayout>
	//   68  136:putfield        #163 <Field FrameLayout mDefaultActivityButton>
		mDefaultActivityButton.setOnClickListener(((android.view.View.OnClickListener) (mCallbacks)));
	//   69  139:aload_0         
	//   70  140:getfield        #163 <Field FrameLayout mDefaultActivityButton>
	//   71  143:aload_0         
	//   72  144:getfield        #137 <Field ActivityChooserView$Callbacks mCallbacks>
	//   73  147:invokevirtual   #167 <Method void FrameLayout.setOnClickListener(android.view.View$OnClickListener)>
		mDefaultActivityButton.setOnLongClickListener(((android.view.View.OnLongClickListener) (mCallbacks)));
	//   74  150:aload_0         
	//   75  151:getfield        #163 <Field FrameLayout mDefaultActivityButton>
	//   76  154:aload_0         
	//   77  155:getfield        #137 <Field ActivityChooserView$Callbacks mCallbacks>
	//   78  158:invokevirtual   #171 <Method void FrameLayout.setOnLongClickListener(android.view.View$OnLongClickListener)>
		mDefaultActivityButtonImage = (ImageView)mDefaultActivityButton.findViewById(android.support.v7.appcompat.R.id.image);
	//   79  161:aload_0         
	//   80  162:aload_0         
	//   81  163:getfield        #163 <Field FrameLayout mDefaultActivityButton>
	//   82  166:getstatic       #174 <Field int android.support.v7.appcompat.R$id.image>
	//   83  169:invokevirtual   #175 <Method View FrameLayout.findViewById(int)>
	//   84  172:checkcast       #177 <Class ImageView>
	//   85  175:putfield        #179 <Field ImageView mDefaultActivityButtonImage>
		obj = ((Object) ((FrameLayout)findViewById(android.support.v7.appcompat.R.id.expand_activities_button)));
	//   86  178:aload_0         
	//   87  179:getstatic       #182 <Field int android.support.v7.appcompat.R$id.expand_activities_button>
	//   88  182:invokevirtual   #146 <Method View findViewById(int)>
	//   89  185:checkcast       #161 <Class FrameLayout>
	//   90  188:astore          4
		((FrameLayout) (obj)).setOnClickListener(((android.view.View.OnClickListener) (mCallbacks)));
	//   91  190:aload           4
	//   92  192:aload_0         
	//   93  193:getfield        #137 <Field ActivityChooserView$Callbacks mCallbacks>
	//   94  196:invokevirtual   #167 <Method void FrameLayout.setOnClickListener(android.view.View$OnClickListener)>
	...
	//   97  204:dup             
	//   98  205:aload_0         
	//   99  206:invokespecial   #183 <Method void ActivityChooserView$3(ActivityChooserView)>
	//  100  209:invokevirtual   #187 <Method void FrameLayout.setAccessibilityDelegate(android.view.View$AccessibilityDelegate)>
	...
	//  104  218:aload_0         
	//  105  219:aload           4
	//  106  221:invokespecial   #190 <Method void ActivityChooserView$4(ActivityChooserView, View)>
	//  107  224:invokevirtual   #194 <Method void FrameLayout.setOnTouchListener(android.view.View$OnTouchListener)>
		mExpandActivityOverflowButton = ((FrameLayout) (obj));
	//  108  227:aload_0         
	//  109  228:aload           4
	//  110  230:putfield        #196 <Field FrameLayout mExpandActivityOverflowButton>
		mExpandActivityOverflowButtonImage = (ImageView)((FrameLayout) (obj)).findViewById(android.support.v7.appcompat.R.id.image);
	//  111  233:aload_0         
	//  112  234:aload           4
	//  113  236:getstatic       #174 <Field int android.support.v7.appcompat.R$id.image>
	//  114  239:invokevirtual   #175 <Method View FrameLayout.findViewById(int)>
	//  115  242:checkcast       #177 <Class ImageView>
	//  116  245:putfield        #198 <Field ImageView mExpandActivityOverflowButtonImage>
		mExpandActivityOverflowButtonImage.setImageDrawable(((Drawable) (attributeset)));
	//  117  248:aload_0         
	//  118  249:getfield        #198 <Field ImageView mExpandActivityOverflowButtonImage>
	//  119  252:aload_2         
	//  120  253:invokevirtual   #202 <Method void ImageView.setImageDrawable(Drawable)>
		mAdapter = new ActivityChooserViewAdapter();
	//  121  256:aload_0         
	//  122  257:new             #18  <Class ActivityChooserView$ActivityChooserViewAdapter>
	//  123  260:dup             
	//  124  261:aload_0         
	//  125  262:invokespecial   #203 <Method void ActivityChooserView$ActivityChooserViewAdapter(ActivityChooserView)>
	//  126  265:putfield        #205 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	...
	//  127  268:aload_0         
	//  128  269:getfield        #205 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//  129  272:new             #16  <Class ActivityChooserView$5>
	//  130  275:dup             
	//  131  276:aload_0         
	//  132  277:invokespecial   #206 <Method void ActivityChooserView$5(ActivityChooserView)>
	//  133  280:invokevirtual   #210 <Method void ActivityChooserView$ActivityChooserViewAdapter.registerDataSetObserver(DataSetObserver)>
		context = ((Context) (context.getResources()));
	//  134  283:aload_1         
	//  135  284:invokevirtual   #214 <Method Resources Context.getResources()>
	//  136  287:astore_1        
	...
	//  137  288:aload_0         
	//  138  289:aload_1         
	//  139  290:invokevirtual   #220 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//  140  293:getfield        #225 <Field int DisplayMetrics.widthPixels>
	//  141  296:iconst_2        
	//  142  297:idiv            
	//  143  298:aload_1         
	//  144  299:getstatic       #230 <Field int android.support.v7.appcompat.R$dimen.abc_config_prefDialogWidth>
	//  145  302:invokevirtual   #234 <Method int Resources.getDimensionPixelSize(int)>
	//  146  305:invokestatic    #239 <Method int Math.max(int, int)>
	//  147  308:putfield        #241 <Field int mListPopupMaxWidth>
	//  148  311:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:getfield        #148 <Field View mActivityChooserContent>
	//    2    4:iconst_0        
	//    3    5:iconst_0        
	//    4    6:iload           4
	//    5    8:iload_2         
	...
	//    8   12:iload_3         
	//    9   13:isub            
	//   10   14:invokevirtual   #324 <Method void View.layout(int, int, int, int)>
		if(!isShowingPopup())
	//*  11   17:aload_0         
	...
	//   19   37:aload_0         
	//   20   38:aload           4
	//   21   40:invokevirtual   #346 <Method int View.getMeasuredWidth()>
	//   22   43:aload           4
	//   23   45:invokevirtual   #349 <Method int View.getMeasuredHeight()>
	//   24   48:invokevirtual   #352 <Method void setMeasuredDimension(int, int)>
	//   25   51:return          
	}
	...
	//    1    1:getfield        #205 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//    2    4:aload_1         
	//    3    5:invokevirtual   #357 <Method void ActivityChooserView$ActivityChooserViewAdapter.setDataModel(ActivityChooserModel)>
		if(isShowingPopup())
	//*   4    8:aload_0         
	...
	//    9   19:pop             
			showPopup();
	//   10   20:aload_0         
	//   11   21:invokevirtual   #360 <Method boolean showPopup()>
	//   12   24:pop             
		}
	//   13   25:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:iload_1         
	//    2    2:putfield        #364 <Field int mDefaultActionButtonContentDescription>
	//    3    5:return          
	}
	...
	//    2    4:iload_1         
	//    3    5:invokevirtual   #369 <Method String Context.getString(int)>
	//    4    8:astore_2        
	...
	//    7   13:aload_2         
	//    8   14:invokevirtual   #373 <Method void ImageView.setContentDescription(CharSequence)>
	//    9   17:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #377 <Field android.widget.PopupWindow$OnDismissListener mOnDismissListener>
	//    3    5:return          
	}
	...
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:putfield        #381 <Field ActionProvider mProvider>
	//    3    5:return          
	}
	...
	//    8   16:aload_0         
	//    9   17:iconst_0        
	//   10   18:putfield        #384 <Field boolean mIsSelectingDefaultActivity>
				showPopupUnchecked(mInitialActivityCount);
	//   11   21:aload_0         
	//   12   22:aload_0         
	//   13   23:getfield        #84  <Field int mInitialActivityCount>
	//   14   26:invokevirtual   #387 <Method void showPopupUnchecked(int)>
				return true;
	//   15   29:iconst_1        
	//   16   30:ireturn         
			}
	...
	//    0    0:new             #389 <Class RuntimeException>
	//    1    3:dup             
	//    2    4:ldc2            #391 <String "d2j fail translate: java.lang.RuntimeException: can not merge I and Z\n\tat com.googlecode.dex2jar.ir.TypeClass.merge(TypeClass.java:100)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeRef.updateTypeClass(TypeTransformer.java:174)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.useAs(TypeTransformer.java:868)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.enexpr(TypeTransformer.java:668)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.exExpr(TypeTransformer.java:719)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.exExpr(TypeTransformer.java:703)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.s1stmt(TypeTransformer.java:810)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.sxStmt(TypeTransformer.java:840)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer$TypeAnalyze.analyze(TypeTransformer.java:206)\n\tat com.googlecode.dex2jar.ir.ts.TypeTransformer.transform(TypeTransformer.java:44)\n\tat com.googlecode.d2j.dex.Dex2jar$2.optimize(Dex2jar.java:162)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertCode(Dex2Asm.java:414)\n\tat com.googlecode.d2j.dex.ExDex2Asm.convertCode(ExDex2Asm.java:42)\n\tat com.googlecode.d2j.dex.Dex2jar$2.convertCode(Dex2jar.java:128)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertMethod(Dex2Asm.java:509)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertClass(Dex2Asm.java:406)\n\tat com.googlecode.d2j.dex.Dex2Asm.convertDex(Dex2Asm.java:422)\n\tat com.googlecode.d2j.dex.Dex2jar.doTranslate(Dex2jar.java:172)\n\tat com.googlecode.d2j.dex.Dex2jar.to(Dex2jar.java:272)\n\tat com.googlecode.dex2jar.tools.Dex2jarCmd.doCommandLine(Dex2jarCmd.java:108)\n\tat com.googlecode.dex2jar.tools.BaseCmd.doMain(BaseCmd.java:288)\n\tat com.googlecode.dex2jar.tools.Dex2jarCmd.main(Dex2jarCmd.java:32)\n">
	//    3    7:invokespecial   #396 <Method void Runtime(String)>
	//    4   10:athrow          
	}
	...
	//*   0    0:aload_0         
	//*   1    1:getfield        #205 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//*   2    4:invokevirtual   #400 <Method int ActivityChooserView$ActivityChooserViewAdapter.getCount()>
	//*   3    7:ifle            21
			mExpandActivityOverflowButton.setEnabled(true);
	//    4   10:aload_0         
	//    5   11:getfield        #196 <Field FrameLayout mExpandActivityOverflowButton>
	//    6   14:iconst_1        
	//    7   15:invokevirtual   #403 <Method void FrameLayout.setEnabled(boolean)>
		else
	//*   8   18:goto            29
			mExpandActivityOverflowButton.setEnabled(false);
	//    9   21:aload_0         
	//   10   22:getfield        #196 <Field FrameLayout mExpandActivityOverflowButton>
	//   11   25:iconst_0        
	//   12   26:invokevirtual   #403 <Method void FrameLayout.setEnabled(boolean)>
		int i = mAdapter.getActivityCount();
	//   13   29:aload_0         
	//   14   30:getfield        #205 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//   15   33:invokevirtual   #406 <Method int ActivityChooserView$ActivityChooserViewAdapter.getActivityCount()>
	//   16   36:istore_1        
		int j = mAdapter.getHistorySize();
	//   17   37:aload_0         
	//   18   38:getfield        #205 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//   19   41:invokevirtual   #409 <Method int ActivityChooserView$ActivityChooserViewAdapter.getHistorySize()>
	//   20   44:istore_2        
		if(i != 1 && (i <= 1 || j <= 0))
	//*  21   45:iload_1         
	//*  22   46:iconst_1        
	...
	//   30   62:aload_0         
	//   31   63:getfield        #163 <Field FrameLayout mDefaultActivityButton>
	//   32   66:bipush          8
	//   33   68:invokevirtual   #412 <Method void FrameLayout.setVisibility(int)>
		} else
	//*  34   71:goto            154
		{
			mDefaultActivityButton.setVisibility(0);
	//   35   74:aload_0         
	//   36   75:getfield        #163 <Field FrameLayout mDefaultActivityButton>
	//   37   78:iconst_0        
	//   38   79:invokevirtual   #412 <Method void FrameLayout.setVisibility(int)>
			Object obj = ((Object) (mAdapter.getDefaultActivity()));
	//   39   82:aload_0         
	//   40   83:getfield        #205 <Field ActivityChooserView$ActivityChooserViewAdapter mAdapter>
	//   41   86:invokevirtual   #416 <Method ResolveInfo ActivityChooserView$ActivityChooserViewAdapter.getDefaultActivity()>
	//   42   89:astore_3        
			android.content.pm.PackageManager packagemanager = getContext().getPackageManager();
	//   43   90:aload_0         
	//   44   91:invokevirtual   #119 <Method Context getContext()>
	//   45   94:invokevirtual   #420 <Method android.content.pm.PackageManager Context.getPackageManager()>
	//   46   97:astore          4
			mDefaultActivityButtonImage.setImageDrawable(((ResolveInfo) (obj)).loadIcon(packagemanager));
	//   47   99:aload_0         
	//   48  100:getfield        #179 <Field ImageView mDefaultActivityButtonImage>
	//   49  103:aload_3         
	//   50  104:aload           4
	//   51  106:invokevirtual   #426 <Method Drawable ResolveInfo.loadIcon(android.content.pm.PackageManager)>
	//   52  109:invokevirtual   #202 <Method void ImageView.setImageDrawable(Drawable)>
			if(mDefaultActionButtonContentDescription != 0)
	//*  53  112:aload_0         
	//*  54  113:getfield        #364 <Field int mDefaultActionButtonContentDescription>
	//*  55  116:ifeq            154
			{
				obj = ((Object) (((ResolveInfo) (obj)).loadLabel(packagemanager)));
	//   56  119:aload_3         
	//   57  120:aload           4
	//   58  122:invokevirtual   #430 <Method CharSequence ResolveInfo.loadLabel(android.content.pm.PackageManager)>
	//   59  125:astore_3        
				obj = ((Object) (getContext().getString(mDefaultActionButtonContentDescription, new Object[] {
					obj
				})));
	//   60  126:aload_0         
	//   61  127:invokevirtual   #119 <Method Context getContext()>
	//   62  130:aload_0         
	//   63  131:getfield        #364 <Field int mDefaultActionButtonContentDescription>
	//   64  134:iconst_1        
	...
	//   68  140:aload_3         
	//   69  141:aastore         
	//   70  142:invokevirtual   #435 <Method String Context.getString(int, Object[])>
	//   71  145:astore_3        
				mDefaultActivityButton.setContentDescription(((CharSequence) (obj)));
	//   72  146:aload_0         
	//   73  147:getfield        #163 <Field FrameLayout mDefaultActivityButton>
	//   74  150:aload_3         
	//   75  151:invokevirtual   #436 <Method void FrameLayout.setContentDescription(CharSequence)>
			}
		}
		if(mDefaultActivityButton.getVisibility() == 0)
	//*  76  154:aload_0         
	//*  77  155:getfield        #163 <Field FrameLayout mDefaultActivityButton>
	//*  78  158:invokevirtual   #330 <Method int FrameLayout.getVisibility()>
	//*  79  161:ifne            176
		{
			mActivityChooserContent.setBackgroundDrawable(mActivityChooserContentBackground);
	//   80  164:aload_0         
	//   81  165:getfield        #148 <Field View mActivityChooserContent>
	//   82  168:aload_0         
	//   83  169:getfield        #156 <Field Drawable mActivityChooserContentBackground>
	//   84  172:invokevirtual   #439 <Method void View.setBackgroundDrawable(Drawable)>
			return;
	//   85  175:return          
		} else
		{
	...
	//   86  176:aload_0         
	//   87  177:getfield        #148 <Field View mActivityChooserContent>
	//   88  180:aconst_null     
	//   89  181:invokevirtual   #439 <Method void View.setBackgroundDrawable(Drawable)>
			return;
	//   90  184:return          
		}
	}
