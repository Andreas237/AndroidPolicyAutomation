...
_L4:
	...
	//*  10   20:aload_0         
	//*  11   21:getfield        #160 <Field String mHistoryFileName>
	//*  12   24:invokestatic    #141 <Method boolean TextUtils.isEmpty(CharSequence)>
	//*  13   27:ifne            70
	...
	//   15   33:dup             
	//   16   34:aload_0         
	//   17   35:invokespecial   #231 <Method void ActivityChooserModel$PersistHistoryAsyncTask(ActivityChooserModel)>
	//   18   38:getstatic       #237 <Field java.util.concurrent.Executor AsyncTask.THREAD_POOL_EXECUTOR>
	//   19   41:iconst_2        
	//   20   42:anewarray       Object[]
	//   21   45:dup             
	//   22   46:iconst_0        
	//   23   47:new             #109 <Class ArrayList>
	//   24   50:dup             
	//   25   51:aload_0         
	//   26   52:getfield        #114 <Field List mHistoricalRecords>
	//   27   55:invokespecial   #240 <Method void ArrayList(java.util.Collection)>
	//   28   58:aastore         
	//   29   59:dup             
	//   30   60:iconst_1        
	//   31   61:aload_0         
	//   32   62:getfield        #160 <Field String mHistoryFileName>
	//   33   65:aastore         
	//   34   66:invokevirtual   #244 <Method AsyncTask ActivityChooserModel$PersistHistoryAsyncTask.executeOnExecutor(java.util.concurrent.Executor, Object[])>
	//   35   69:pop             
			return;
	//   36   70:return          
		} else
	...
	//   37   71:new             #246 <Class IllegalStateException>
	//   38   74:dup             
	//   39   75:ldc1            #248 <String "No preceding call to #readHistoricalData">
	//   40   77:invokespecial   #251 <Method void IllegalStateException(String)>
	//   41   80:athrow          
		}
	}
	...
	//*  28   59:ifeq            185
	//*  29   62:aload_0         
	//*  30   63:getfield        #114 <Field List mHistoricalRecords>
	//*  31   66:astore          4
	//*  32   68:aload           4
	//*  33   70:invokeinterface #206 <Method void List.clear()>
	//*  34   75:aload_3         
	//*  35   76:invokeinterface #284 <Method int XmlPullParser.next()>
	//*  36   81:istore_1        
	//*  37   82:iload_1         
	//*  38   83:iconst_1        
	//*  39   84:icmpne          96
	...
	//*  41   88:ifnull          306
	//*  42   91:aload_2         
	//*  43   92:invokevirtual   #295 <Method void FileInputStream.close()>
	//*  44   95:return          
	//*  45   96:iload_1         
	//*  46   97:iconst_3        
	//*  47   98:icmpeq          75
	...
	//*  50  103:icmpne          109
	//*  51  106:goto            75
	//*  52  109:ldc1            #60  <String "historical-record">
	//*  53  111:aload_3         
	//*  54  112:invokeinterface #287 <Method String XmlPullParser.getName()>
	//*  55  117:invokevirtual   #290 <Method boolean String.equals(Object)>
	//*  56  120:ifeq            174
	//*  57  123:aload           4
	//*  58  125:new             #18  <Class ActivityChooserModel$HistoricalRecord>
	//*  59  128:dup             
	//*  60  129:aload_3         
	//*  61  130:aconst_null     
	//*  62  131:ldc1            #29  <String "activity">
	//*  63  133:invokeinterface #299 <Method String XmlPullParser.getAttributeValue(String, String)>
	//*  64  138:aload_3         
	//*  65  139:aconst_null     
	//*  66  140:ldc1            #32  <String "time">
	//*  67  142:invokeinterface #299 <Method String XmlPullParser.getAttributeValue(String, String)>
	//*  68  147:invokestatic    #305 <Method long Long.parseLong(String)>
	//*  69  150:aload_3         
	//*  70  151:aconst_null     
	//*  71  152:ldc1            #35  <String "weight">
	//*  72  154:invokeinterface #299 <Method String XmlPullParser.getAttributeValue(String, String)>
	//*  73  159:invokestatic    #311 <Method float Float.parseFloat(String)>
	//*  74  162:invokespecial   #314 <Method void ActivityChooserModel$HistoricalRecord(String, long, float)>
	//*  75  165:invokeinterface #168 <Method boolean List.add(Object)>
	//*  76  170:pop             
	//*  77  171:goto            75
	//*  78  174:new             #261 <Class XmlPullParserException>
	//*  79  177:dup             
	//*  80  178:ldc2            #316 <String "Share records file not well-formed.">
	//*  81  181:invokespecial   #317 <Method void XmlPullParserException(String)>
	//*  82  184:athrow          
	//*  83  185:new             #261 <Class XmlPullParserException>
	//*  84  188:dup             
	//*  85  189:ldc2            #319 <String "Share records file does not start with historical-records tag.">
	//*  86  192:invokespecial   #317 <Method void XmlPullParserException(String)>
	//*  87  195:athrow          
	//*  88  196:astore_3        
	//*  89  197:goto            307
	//*  90  200:astore_3        
	...
	//* 142  308:ifnull          315
	//* 143  311:aload_2         
	//* 144  312:invokevirtual   #295 <Method void FileInputStream.close()>
	//* 145  315:aload_3         
	//* 146  316:athrow          
