	...
	implements DecorToolbar
{
	...
	//   95  200:aload_0         
	//   96  201:aload           7
	//   97  203:invokevirtual   #166 <Method void setNavigationIcon(Drawable)>
			}
			setDisplayOptions(((TintTypedArray) (toolbar)).getInt(android.support.v7.appcompat.R.styleable.ActionBar_displayOptions, 0));
	//   98  206:aload_0         
	//   99  207:aload_1         
	//  100  208:getstatic       #169 <Field int android.support.v7.appcompat.R$styleable.ActionBar_displayOptions>
	//  101  211:iconst_0        
	//  102  212:invokevirtual   #173 <Method int TintTypedArray.getInt(int, int)>
	//  103  215:invokevirtual   #177 <Method void setDisplayOptions(int)>
			j = ((TintTypedArray) (toolbar)).getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_customNavigationLayout, 0);
	//  104  218:aload_1         
	//  105  219:getstatic       #180 <Field int android.support.v7.appcompat.R$styleable.ActionBar_customNavigationLayout>
	//  106  222:iconst_0        
	//  107  223:invokevirtual   #183 <Method int TintTypedArray.getResourceId(int, int)>
	//  108  226:istore          4
			if(j != 0)
	//* 109  228:iload           4
	//* 110  230:ifeq            268
	...
	//  111  233:aload_0         
	//  112  234:aload_0         
	//  113  235:getfield        #76  <Field Toolbar mToolbar>
	//  114  238:invokevirtual   #101 <Method Context Toolbar.getContext()>
	//  115  241:invokestatic    #189 <Method LayoutInflater LayoutInflater.from(Context)>
	//  116  244:iload           4
	//  117  246:aload_0         
	//  118  247:getfield        #76  <Field Toolbar mToolbar>
	//  119  250:iconst_0        
	//  120  251:invokevirtual   #193 <Method View LayoutInflater.inflate(int, ViewGroup, boolean)>
	//  121  254:invokevirtual   #197 <Method void setCustomView(View)>
				setDisplayOptions(mDisplayOpts | 0x10);
	//  122  257:aload_0         
	//  123  258:aload_0         
	//  124  259:getfield        #199 <Field int mDisplayOpts>
	//  125  262:bipush          16
	//  126  264:ior             
	//  127  265:invokevirtual   #177 <Method void setDisplayOptions(int)>
			}
			j = ((TintTypedArray) (toolbar)).getLayoutDimension(android.support.v7.appcompat.R.styleable.ActionBar_height, 0);
	//  128  268:aload_1         
	//  129  269:getstatic       #202 <Field int android.support.v7.appcompat.R$styleable.ActionBar_height>
	//  130  272:iconst_0        
	//  131  273:invokevirtual   #205 <Method int TintTypedArray.getLayoutDimension(int, int)>
	//  132  276:istore          4
			if(j > 0)
	//* 133  278:iload           4
	//* 134  280:ifle            308
	...
	//  135  283:aload_0         
	//  136  284:getfield        #76  <Field Toolbar mToolbar>
	//  137  287:invokevirtual   #209 <Method android.view.ViewGroup$LayoutParams Toolbar.getLayoutParams()>
	//  138  290:astore          7
				layoutparams.height = j;
	//  139  292:aload           7
	//  140  294:iload           4
	//  141  296:putfield        #214 <Field int android.view.ViewGroup$LayoutParams.height>
				mToolbar.setLayoutParams(layoutparams);
	//  142  299:aload_0         
	//  143  300:getfield        #76  <Field Toolbar mToolbar>
	//  144  303:aload           7
	//  145  305:invokevirtual   #218 <Method void Toolbar.setLayoutParams(android.view.ViewGroup$LayoutParams)>
			}
			j = ((TintTypedArray) (toolbar)).getDimensionPixelOffset(android.support.v7.appcompat.R.styleable.ActionBar_contentInsetStart, -1);
	//  146  308:aload_1         
	//  147  309:getstatic       #221 <Field int android.support.v7.appcompat.R$styleable.ActionBar_contentInsetStart>
	//  148  312:iconst_m1       
	//  149  313:invokevirtual   #224 <Method int TintTypedArray.getDimensionPixelOffset(int, int)>
	//  150  316:istore          4
	...
	//  151  318:aload_1         
	//  152  319:getstatic       #227 <Field int android.support.v7.appcompat.R$styleable.ActionBar_contentInsetEnd>
	//  153  322:iconst_m1       
	//  154  323:invokevirtual   #224 <Method int TintTypedArray.getDimensionPixelOffset(int, int)>
	//  155  326:istore          5
			if(j >= 0 || k >= 0)
	//* 156  328:iload           4
	//* 157  330:ifge            338
	...
	//  160  338:aload_0         
	//  161  339:getfield        #76  <Field Toolbar mToolbar>
	//  162  342:iload           4
	//  163  344:iconst_0        
	//  164  345:invokestatic    #232 <Method int Math.max(int, int)>
	//  165  348:iload           5
	//  166  350:iconst_0        
	//  167  351:invokestatic    #232 <Method int Math.max(int, int)>
	//  168  354:invokevirtual   #236 <Method void Toolbar.setContentInsetsRelative(int, int)>
			j = ((TintTypedArray) (toolbar)).getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_titleTextStyle, 0);
	//  169  357:aload_1         
	//  170  358:getstatic       #239 <Field int android.support.v7.appcompat.R$styleable.ActionBar_titleTextStyle>
	//  171  361:iconst_0        
	//  172  362:invokevirtual   #183 <Method int TintTypedArray.getResourceId(int, int)>
	//  173  365:istore          4
			if(j != 0)
	//* 174  367:iload           4
	//* 175  369:ifeq            390
	...
	//  176  372:aload_0         
	//  177  373:getfield        #76  <Field Toolbar mToolbar>
	//  178  376:astore          7
				toolbar1.setTitleTextAppearance(toolbar1.getContext(), j);
	//  179  378:aload           7
	//  180  380:aload           7
	//  181  382:invokevirtual   #101 <Method Context Toolbar.getContext()>
	//  182  385:iload           4
	//  183  387:invokevirtual   #243 <Method void Toolbar.setTitleTextAppearance(Context, int)>
			}
			j = ((TintTypedArray) (toolbar)).getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_subtitleTextStyle, 0);
	//  184  390:aload_1         
	//  185  391:getstatic       #246 <Field int android.support.v7.appcompat.R$styleable.ActionBar_subtitleTextStyle>
	//  186  394:iconst_0        
	//  187  395:invokevirtual   #183 <Method int TintTypedArray.getResourceId(int, int)>
	//  188  398:istore          4
			if(j != 0)
	//* 189  400:iload           4
	//* 190  402:ifeq            423
	...
	//  194  411:aload           7
	//  195  413:aload           7
	//  196  415:invokevirtual   #101 <Method Context Toolbar.getContext()>
	//  197  418:iload           4
	//  198  420:invokevirtual   #249 <Method void Toolbar.setSubtitleTextAppearance(Context, int)>
			}
			j = ((TintTypedArray) (toolbar)).getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_popupTheme, 0);
	//  199  423:aload_1         
	//  200  424:getstatic       #252 <Field int android.support.v7.appcompat.R$styleable.ActionBar_popupTheme>
	//  201  427:iconst_0        
	//  202  428:invokevirtual   #183 <Method int TintTypedArray.getResourceId(int, int)>
	//  203  431:istore          4
			if(j != 0)
	//* 204  433:iload           4
	//* 205  435:ifeq            458
	...
	//  206  438:aload_0         
	//  207  439:getfield        #76  <Field Toolbar mToolbar>
	//  208  442:iload           4
	//  209  444:invokevirtual   #255 <Method void Toolbar.setPopupTheme(int)>
		} else
	//* 210  447:goto            458
		{
	...
	//  211  450:aload_0         
	//  212  451:aload_0         
	//  213  452:invokespecial   #259 <Method int detectDisplayOptions()>
	//  214  455:putfield        #199 <Field int mDisplayOpts>
		}
		((TintTypedArray) (toolbar)).recycle();
	//  215  458:aload_1         
	//  216  459:invokevirtual   #262 <Method void TintTypedArray.recycle()>
		setDefaultNavigationContentDescription(i);
	//  217  462:aload_0         
	//  218  463:iload_3         
	//  219  464:invokevirtual   #265 <Method void setDefaultNavigationContentDescription(int)>
		mHomeDescription = mToolbar.getNavigationContentDescription();
	//  220  467:aload_0         
	//  221  468:aload_0         
	//  222  469:getfield        #76  <Field Toolbar mToolbar>
	//  223  472:invokevirtual   #268 <Method CharSequence Toolbar.getNavigationContentDescription()>
	//  224  475:putfield        #270 <Field CharSequence mHomeDescription>
	...
	//  225  478:aload_0         
	//  226  479:getfield        #76  <Field Toolbar mToolbar>
	//  227  482:new             #8   <Class ToolbarWidgetWrapper$1>
	//  228  485:dup             
	//  229  486:aload_0         
	//  230  487:invokespecial   #273 <Method void ToolbarWidgetWrapper$1(ToolbarWidgetWrapper)>
	//  231  490:invokevirtual   #277 <Method void Toolbar.setNavigationOnClickListener(android.view.View$OnClickListener)>
	//  232  493:return          
	}
	...
	//*   2    4:invokevirtual   #95  <Method Drawable Toolbar.getNavigationIcon()>
	//*   3    7:ifnull          24
		{
			mDefaultNavigationIcon = mToolbar.getNavigationIcon();
	//    4   10:aload_0         
	//    5   11:aload_0         
	//    6   12:getfield        #76  <Field Toolbar mToolbar>
	//    7   15:invokevirtual   #95  <Method Drawable Toolbar.getNavigationIcon()>
	//    8   18:putfield        #127 <Field Drawable mDefaultNavigationIcon>
			return 15;
	//    9   21:bipush          15
	//   10   23:ireturn         
		} else
	...
	//   14   26:aload_0         
	//   15   27:getfield        #127 <Field Drawable mDefaultNavigationIcon>
	//   16   30:astore_1        
			toolbar.setNavigationIcon(drawable);
	//   17   31:aload_2         
	//   18   32:aload_1         
	//   19   33:invokevirtual   #308 <Method void Toolbar.setNavigationIcon(Drawable)>
			return;
	//   20   36:return          
		} else
		{
	...
	//   21   37:aload_0         
	//   22   38:getfield        #76  <Field Toolbar mToolbar>
	//   23   41:aconst_null     
	//   24   42:invokevirtual   #308 <Method void Toolbar.setNavigationIcon(Drawable)>
			return;
	//   25   45:return          
		}
	}
	...
	//*  10   14:ifeq            37
			{
				drawable = mLogo;
	//   11   17:aload_0         
	//   12   18:getfield        #311 <Field Drawable mLogo>
	//   13   21:astore_2        
				if(drawable == null)
	//*  14   22:aload_2         
	//*  15   23:ifnull          29
	//*  16   26:goto            47
					drawable = mIcon;
	//   17   29:aload_0         
	//   18   30:getfield        #313 <Field Drawable mIcon>
	//   19   33:astore_2        
			} else
	//*  20   34:goto            47
			{
				drawable = mIcon;
	//   21   37:aload_0         
	//   22   38:getfield        #313 <Field Drawable mIcon>
	//   23   41:astore_2        
			}
		} else
	//*  24   42:goto            47
	...
	//   27   47:aload_0         
	//   28   48:getfield        #76  <Field Toolbar mToolbar>
	//   29   51:aload_2         
	//   30   52:invokevirtual   #314 <Method void Toolbar.setLogo(Drawable)>
	//   31   55:return          
	}
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #343 <Method int Spinner.getCount()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #347 <Method int Spinner.getSelectedItemPosition()>
	//    7   13:ireturn         
		else
			return 0;
	//    8   14:iconst_0        
	...
	//*   4    6:ifnull          27
	//*   5    9:aload_0         
	//*   6   10:getfield        #199 <Field int mDisplayOpts>
	//*   7   13:bipush          16
	//*   8   15:iand            
	//*   9   16:ifeq            27
			mToolbar.removeView(view1);
	//   10   19:aload_0         
	//   11   20:getfield        #76  <Field Toolbar mToolbar>
	//   12   23:aload_2         
	//   13   24:invokevirtual   #413 <Method void Toolbar.removeView(View)>
		mCustomView = view;
	//   14   27:aload_0         
	//   15   28:aload_1         
	//   16   29:putfield        #338 <Field View mCustomView>
		if(view != null && (mDisplayOpts & 0x10) != 0)
	//*  17   32:aload_1         
	//*  18   33:ifnull          57
	//*  19   36:aload_0         
	//*  20   37:getfield        #199 <Field int mDisplayOpts>
	//*  21   40:bipush          16
	//*  22   42:iand            
	//*  23   43:ifeq            57
			mToolbar.addView(mCustomView);
	//   24   46:aload_0         
	//   25   47:getfield        #76  <Field Toolbar mToolbar>
	//   26   50:aload_0         
	//   27   51:getfield        #338 <Field View mCustomView>
	//   28   54:invokevirtual   #416 <Method void Toolbar.addView(View)>
	//   29   57:return          
	}
	...
	//   68  124:aload_0         
	//   69  125:getfield        #76  <Field Toolbar mToolbar>
	//   70  128:aload_3         
	//   71  129:invokevirtual   #416 <Method void Toolbar.addView(View)>
						return;
	//   72  132:return          
					}
					mToolbar.removeView(view);
	//   73  133:aload_0         
	//   74  134:getfield        #76  <Field Toolbar mToolbar>
	//   75  137:aload_3         
	//   76  138:invokevirtual   #413 <Method void Toolbar.removeView(View)>
				}
			}
		}
	//   77  141:return          
	...
	//    5    9:aload_2         
	//    6   10:iload_1         
	//    7   11:invokevirtual   #441 <Method void Spinner.setSelection(int)>
			return;
	//    8   14:return          
		} else
		{
			throw new IllegalStateException("Can't set dropdown selected position without an adapter");
	//    9   15:new             #443 <Class IllegalStateException>
	//   10   18:dup             
	//   11   19:ldc2            #445 <String "Can't set dropdown selected position without an adapter">
	//   12   22:invokespecial   #448 <Method void IllegalStateException(String)>
	//   13   25:athrow          
		}
	}
	...
	//    5    9:aload_2         
	//    6   10:invokevirtual   #456 <Method android.view.ViewParent View.getParent()>
	//    7   13:astore_2        
			Toolbar toolbar = mToolbar;
	//    8   14:aload_0         
	//    9   15:getfield        #76  <Field Toolbar mToolbar>
	...
	//   14   24:aload_3         
	//   15   25:aload_0         
	//   16   26:getfield        #363 <Field View mTabView>
	//   17   29:invokevirtual   #413 <Method void Toolbar.removeView(View)>
		}
		mTabView = ((View) (scrollingtabcontainerview));
	//   18   32:aload_0         
	//   19   33:aload_1         
	//   20   34:putfield        #363 <Field View mTabView>
		if(scrollingtabcontainerview != null && mNavigationMode == 2)
	//*  21   37:aload_1         
	//*  22   38:ifnull          96
	//*  23   41:aload_0         
	//*  24   42:getfield        #72  <Field int mNavigationMode>
	//*  25   45:iconst_2        
	//*  26   46:icmpne          96
		{
			mToolbar.addView(mTabView, 0);
	//   27   49:aload_0         
	//   28   50:getfield        #76  <Field Toolbar mToolbar>
	//   29   53:aload_0         
	//   30   54:getfield        #363 <Field View mTabView>
	//   31   57:iconst_0        
	//   32   58:invokevirtual   #459 <Method void Toolbar.addView(View, int)>
			Toolbar.LayoutParams layoutparams = (Toolbar.LayoutParams)mTabView.getLayoutParams();
	//   33   61:aload_0         
	//   34   62:getfield        #363 <Field View mTabView>
	//   35   65:invokevirtual   #460 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   36   68:checkcast       #291 <Class Toolbar$LayoutParams>
	//   37   71:astore_2        
			layoutparams.width = -2;
	//   38   72:aload_2         
	//   39   73:bipush          -2
	//   40   75:putfield        #463 <Field int Toolbar$LayoutParams.width>
			layoutparams.height = -2;
	//   41   78:aload_2         
	//   42   79:bipush          -2
	//   43   81:putfield        #464 <Field int Toolbar$LayoutParams.height>
			layoutparams.gravity = 0x800053;
	//   44   84:aload_2         
	//   45   85:ldc2            #465 <Int 0x800053>
	//   46   88:putfield        #468 <Field int Toolbar$LayoutParams.gravity>
			scrollingtabcontainerview.setAllowCollapse(true);
	//   47   91:aload_1         
	//   48   92:iconst_1        
	//   49   93:invokevirtual   #473 <Method void ScrollingTabContainerView.setAllowCollapse(boolean)>
		}
	//   50   96:return          
	}
	...
	//*   8   32:goto            108
			case 2: // '\002'
				Object obj = ((Object) (mTabView));
	//    9   35:aload_0         
	//   10   36:getfield        #363 <Field View mTabView>
	//   11   39:astore_3        
				if(obj != null)
	//*  12   40:aload_3         
	//*  13   41:ifnull          108
				{
					obj = ((Object) (((View) (obj)).getParent()));
	//   14   44:aload_3         
	//   15   45:invokevirtual   #456 <Method android.view.ViewParent View.getParent()>
	//   16   48:astore_3        
					Toolbar toolbar = mToolbar;
	//   17   49:aload_0         
	//   18   50:getfield        #76  <Field Toolbar mToolbar>
	//   19   53:astore          4
					if(obj == toolbar)
	//*  20   55:aload_3         
	//*  21   56:aload           4
	...
	//   23   61:aload           4
	//   24   63:aload_0         
	//   25   64:getfield        #363 <Field View mTabView>
	//   26   67:invokevirtual   #413 <Method void Toolbar.removeView(View)>
				}
				break;
	//   27   70:goto            108
	...
	//   28   73:aload_0         
	//   29   74:getfield        #280 <Field Spinner mSpinner>
	//   30   77:astore_3        
				if(obj1 == null)
					break;
	//   31   78:aload_3         
	...
	//   33   82:aload_3         
	//   34   83:invokevirtual   #521 <Method android.view.ViewParent Spinner.getParent()>
	//   35   86:astore_3        
				Toolbar toolbar1 = mToolbar;
	//   36   87:aload_0         
	//   37   88:getfield        #76  <Field Toolbar mToolbar>
	//   38   91:astore          4
				if(obj1 == toolbar1)
	//*  39   93:aload_3         
	//*  40   94:aload           4
	...
	//   42   99:aload           4
	//   43  101:aload_0         
	//   44  102:getfield        #280 <Field Spinner mSpinner>
	//   45  105:invokevirtual   #413 <Method void Toolbar.removeView(View)>
				break;
			}
			mNavigationMode = i;
	//   46  108:aload_0         
	//   47  109:iload_1         
	//   48  110:putfield        #72  <Field int mNavigationMode>
			switch(i)
	//*  49  113:iload_1         
			{
	...
	//   51  140:new             #523 <Class StringBuilder>
	//   52  143:dup             
	//   53  144:invokespecial   #524 <Method void StringBuilder()>
	//   54  147:astore_3        
				stringbuilder.append("Invalid navigation mode ");
	//   55  148:aload_3         
	//   56  149:ldc2            #526 <String "Invalid navigation mode ">
	//   57  152:invokevirtual   #530 <Method StringBuilder StringBuilder.append(String)>
	//   58  155:pop             
				stringbuilder.append(i);
	//   59  156:aload_3         
	//   60  157:iload_1         
	//   61  158:invokevirtual   #533 <Method StringBuilder StringBuilder.append(int)>
	//   62  161:pop             
				throw new IllegalArgumentException(stringbuilder.toString());
	//   63  162:new             #535 <Class IllegalArgumentException>
	//   64  165:dup             
	//   65  166:aload_3         
	//   66  167:invokevirtual   #539 <Method String StringBuilder.toString()>
	//   67  170:invokespecial   #540 <Method void IllegalArgumentException(String)>
	//   68  173:athrow          
	...
	//   69  174:aload_0         
	//   70  175:getfield        #363 <Field View mTabView>
	//   71  178:astore_3        
				if(obj2 != null)
	//*  72  179:aload_3         
	//*  73  180:ifnull          239
	...
	//   74  183:aload_0         
	//   75  184:getfield        #76  <Field Toolbar mToolbar>
	//   76  187:aload_3         
	//   77  188:iconst_0        
	//   78  189:invokevirtual   #459 <Method void Toolbar.addView(View, int)>
					obj2 = ((Object) ((Toolbar.LayoutParams)mTabView.getLayoutParams()));
	//   79  192:aload_0         
	//   80  193:getfield        #363 <Field View mTabView>
	//   81  196:invokevirtual   #460 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   82  199:checkcast       #291 <Class Toolbar$LayoutParams>
	//   83  202:astore_3        
					obj2.width = -2;
	//   84  203:aload_3         
	//   85  204:bipush          -2
	//   86  206:putfield        #463 <Field int Toolbar$LayoutParams.width>
					obj2.height = -2;
	//   87  209:aload_3         
	//   88  210:bipush          -2
	//   89  212:putfield        #464 <Field int Toolbar$LayoutParams.height>
					obj2.gravity = 0x800053;
	//   90  215:aload_3         
	//   91  216:ldc2            #465 <Int 0x800053>
	//   92  219:putfield        #468 <Field int Toolbar$LayoutParams.gravity>
					return;
	//   93  222:return          
				}
				break;
			...
			case 1: // '\001'
				ensureSpinner();
	//   94  223:aload_0         
	//   95  224:invokespecial   #429 <Method void ensureSpinner()>
				mToolbar.addView(((View) (mSpinner)), 0);
	//   96  227:aload_0         
	//   97  228:getfield        #76  <Field Toolbar mToolbar>
	//   98  231:aload_0         
	//   99  232:getfield        #280 <Field Spinner mSpinner>
	//  100  235:iconst_0        
	//  101  236:invokevirtual   #459 <Method void Toolbar.addView(View, int)>
				break;
			}
		}
	//  102  239:return          
