...
public class ActionBarContextView extends AbsActionBarView
{
	...
	//   85  178:aload           5
	//   86  180:iload_1         
	//   87  181:invokevirtual   #177 <Method void TextView.setVisibility(int)>
		obj = ((Object) (mTitleLayout));
	//   88  184:aload_0         
	//   89  185:getfield        #111 <Field LinearLayout mTitleLayout>
	//   90  188:astore          5
		byte0 = ((byte) (flag));
	//   91  190:iload_2         
	//   92  191:istore_1        
	...
	//  104  211:aload           5
	//  105  213:iload_1         
	//  106  214:invokevirtual   #178 <Method void LinearLayout.setVisibility(int)>
		if(mTitleLayout.getParent() == null)
	//* 107  217:aload_0         
	//* 108  218:getfield        #111 <Field LinearLayout mTitleLayout>
	//* 109  221:invokevirtual   #182 <Method android.view.ViewParent LinearLayout.getParent()>
	//* 110  224:ifnonnull       235
			addView(((View) (mTitleLayout)));
	//  111  227:aload_0         
	//  112  228:aload_0         
	//  113  229:getfield        #111 <Field LinearLayout mTitleLayout>
	//  114  232:invokevirtual   #186 <Method void addView(View)>
	//  115  235:return          
	}
	...
	//    5    9:aload_0         
	//    6   10:aload_0         
	//    7   11:invokevirtual   #115 <Method Context getContext()>
	//    8   14:invokestatic    #121 <Method LayoutInflater LayoutInflater.from(Context)>
	//    9   17:aload_0         
	//   10   18:getfield        #104 <Field int mCloseItemLayout>
	//   11   21:aload_0         
	//   12   22:iconst_0        
	//   13   23:invokevirtual   #235 <Method View LayoutInflater.inflate(int, android.view.ViewGroup, boolean)>
	//   14   26:putfield        #196 <Field View mClose>
			addView(mClose);
	//   15   29:aload_0         
	//   16   30:aload_0         
	//   17   31:getfield        #196 <Field View mClose>
	//   18   34:invokevirtual   #186 <Method void addView(View)>
		} else
	//*  19   37:goto            55
		if(((View) (obj)).getParent() == null)
	//*  20   40:aload_2         
	//*  21   41:invokevirtual   #238 <Method android.view.ViewParent View.getParent()>
	//*  22   44:ifnonnull       55
			addView(mClose);
	//   23   47:aload_0         
	//   24   48:aload_0         
	//   25   49:getfield        #196 <Field View mClose>
	//   26   52:invokevirtual   #186 <Method void addView(View)>
	...
	//   27   55:aload_0         
	//   28   56:getfield        #196 <Field View mClose>
	//   29   59:getstatic       #241 <Field int android.support.v7.appcompat.R$id.action_mode_close_button>
	//   30   62:invokevirtual   #242 <Method View View.findViewById(int)>
	//   31   65:new             #6   <Class ActionBarContextView$1>
	//   32   68:dup             
	//   33   69:aload_0         
	//   34   70:aload_1         
	//   35   71:invokespecial   #245 <Method void ActionBarContextView$1(ActionBarContextView, ActionMode)>
	//   36   74:invokevirtual   #249 <Method void View.setOnClickListener(android.view.View$OnClickListener)>
		mode = ((ActionMode) ((MenuBuilder)mode.getMenu()));
	//   37   77:aload_1         
	//   38   78:invokevirtual   #255 <Method android.view.Menu ActionMode.getMenu()>
	//   39   81:checkcast       #257 <Class MenuBuilder>
	//   40   84:astore_1        
		if(mActionMenuPresenter != null)
	//*  41   85:aload_0         
	//*  42   86:getfield        #226 <Field ActionMenuPresenter mActionMenuPresenter>
	//*  43   89:ifnull          100
			mActionMenuPresenter.dismissPopupMenus();
	//   44   92:aload_0         
	//   45   93:getfield        #226 <Field ActionMenuPresenter mActionMenuPresenter>
	//   46   96:invokevirtual   #259 <Method boolean ActionMenuPresenter.dismissPopupMenus()>
	//   47   99:pop             
		mActionMenuPresenter = new ActionMenuPresenter(getContext());
	//   48  100:aload_0         
	//   49  101:new             #228 <Class ActionMenuPresenter>
	//   50  104:dup             
	//   51  105:aload_0         
	//   52  106:invokevirtual   #115 <Method Context getContext()>
	//   53  109:invokespecial   #261 <Method void ActionMenuPresenter(Context)>
	//   54  112:putfield        #226 <Field ActionMenuPresenter mActionMenuPresenter>
		mActionMenuPresenter.setReserveOverflow(true);
	//   55  115:aload_0         
	//   56  116:getfield        #226 <Field ActionMenuPresenter mActionMenuPresenter>
	//   57  119:iconst_1        
	//   58  120:invokevirtual   #265 <Method void ActionMenuPresenter.setReserveOverflow(boolean)>
		obj = ((Object) (new android.view.ViewGroup.LayoutParams(-2, -1)));
	//   59  123:new             #267 <Class android.view.ViewGroup$LayoutParams>
	//   60  126:dup             
	//   61  127:bipush          -2
	//   62  129:iconst_m1       
	//   63  130:invokespecial   #268 <Method void android.view.ViewGroup$LayoutParams(int, int)>
	//   64  133:astore_2        
		((MenuBuilder) (mode)).addMenuPresenter(((android.support.v7.view.menu.MenuPresenter) (mActionMenuPresenter)), mPopupContext);
	//   65  134:aload_1         
	//   66  135:aload_0         
	//   67  136:getfield        #226 <Field ActionMenuPresenter mActionMenuPresenter>
	//   68  139:aload_0         
	//   69  140:getfield        #272 <Field Context mPopupContext>
	//   70  143:invokevirtual   #276 <Method void MenuBuilder.addMenuPresenter(android.support.v7.view.menu.MenuPresenter, Context)>
		mMenuView = (ActionMenuView)mActionMenuPresenter.getMenuView(((android.view.ViewGroup) (this)));
	//   71  146:aload_0         
	//   72  147:aload_0         
	//   73  148:getfield        #226 <Field ActionMenuPresenter mActionMenuPresenter>
	//   74  151:aload_0         
	//   75  152:invokevirtual   #280 <Method android.support.v7.view.menu.MenuView ActionMenuPresenter.getMenuView(android.view.ViewGroup)>
	//   76  155:checkcast       #282 <Class ActionMenuView>
	//   77  158:putfield        #286 <Field ActionMenuView mMenuView>
		ViewCompat.setBackground(((View) (mMenuView)), ((android.graphics.drawable.Drawable) (null)));
	//   78  161:aload_0         
	//   79  162:getfield        #286 <Field ActionMenuView mMenuView>
	//   80  165:aconst_null     
	//   81  166:invokestatic    #71  <Method void ViewCompat.setBackground(View, android.graphics.drawable.Drawable)>
		addView(((View) (mMenuView)), ((android.view.ViewGroup.LayoutParams) (obj)));
	//   82  169:aload_0         
	//   83  170:aload_0         
	//   84  171:getfield        #286 <Field ActionMenuView mMenuView>
	//   85  174:aload_2         
	//   86  175:invokevirtual   #289 <Method void addView(View, android.view.ViewGroup$LayoutParams)>
	//   87  178:return          
	}
	...
	//*  33   59:ifnull          158
	//*  34   62:aload           9
	//*  35   64:invokevirtual   #377 <Method int View.getVisibility()>
	//*  36   67:bipush          8
	//*  37   69:icmpeq          158
		{
			obj = ((Object) ((android.view.ViewGroup.MarginLayoutParams)mClose.getLayoutParams()));
	//   38   72:aload_0         
	//   39   73:getfield        #196 <Field View mClose>
	//   40   76:invokevirtual   #380 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   41   79:checkcast       #206 <Class android.view.ViewGroup$MarginLayoutParams>
	//   42   82:astore          9
			if(flag)
	//*  43   84:iload_1         
	//*  44   85:ifeq            97
	...
	//   45   88:aload           9
	//   46   90:getfield        #383 <Field int android.view.ViewGroup$MarginLayoutParams.rightMargin>
	//   47   93:istore_3        
			else
	//*  48   94:goto            103
				j = ((android.view.ViewGroup.MarginLayoutParams) (obj)).leftMargin;
	//   49   97:aload           9
	//   50   99:getfield        #386 <Field int android.view.ViewGroup$MarginLayoutParams.leftMargin>
	//   51  102:istore_3        
			if(flag)
	//*  52  103:iload_1         
	//*  53  104:ifeq            117
	...
	//   54  107:aload           9
	//   55  109:getfield        #386 <Field int android.view.ViewGroup$MarginLayoutParams.leftMargin>
	//   56  112:istore          5
			else
	//*  57  114:goto            124
				l = ((android.view.ViewGroup.MarginLayoutParams) (obj)).rightMargin;
	//   58  117:aload           9
	//   59  119:getfield        #383 <Field int android.view.ViewGroup$MarginLayoutParams.rightMargin>
	//   60  122:istore          5
			j = next(i1, j, flag);
	//   61  124:iload           6
	//   62  126:iload_3         
	//   63  127:iload_1         
	//   64  128:invokestatic    #390 <Method int next(int, int, boolean)>
	//   65  131:istore_3        
			j = next(j + positionChild(mClose, j, j1, k1, flag), l, flag);
	//   66  132:iload_3         
	//   67  133:aload_0         
	//   68  134:aload_0         
	//   69  135:getfield        #196 <Field View mClose>
	//   70  138:iload_3         
	//   71  139:iload           7
	//   72  141:iload           8
	//   73  143:iload_1         
	//   74  144:invokevirtual   #394 <Method int positionChild(View, int, int, int, boolean)>
	//   75  147:iadd            
	//   76  148:iload           5
	//   77  150:iload_1         
	//   78  151:invokestatic    #390 <Method int next(int, int, boolean)>
	//   79  154:istore_3        
		} else
	//*  80  155:goto            161
		{
	...
	//   82  160:istore_3        
		...
		obj = ((Object) (mTitleLayout));
	//   83  161:aload_0         
	//   84  162:getfield        #111 <Field LinearLayout mTitleLayout>
	//   85  165:astore          9
		if(obj != null && mCustomView == null && ((LinearLayout) (obj)).getVisibility() != 8)
	//*  86  167:aload           9
	//*  87  169:ifnull          209
	//*  88  172:aload_0         
	//*  89  173:getfield        #306 <Field View mCustomView>
	//*  90  176:ifnonnull       209
	//*  91  179:aload           9
	//*  92  181:invokevirtual   #395 <Method int LinearLayout.getVisibility()>
	//*  93  184:bipush          8
	//*  94  186:icmpeq          209
	...
	//   96  190:aload_0         
	//   97  191:aload_0         
	//   98  192:getfield        #111 <Field LinearLayout mTitleLayout>
	//   99  195:iload_3         
	//  100  196:iload           7
	//  101  198:iload           8
	//  102  200:iload_1         
	//  103  201:invokevirtual   #394 <Method int positionChild(View, int, int, int, boolean)>
	//  104  204:iadd            
	//  105  205:istore_3        
	//* 106  206:goto            209
		obj = ((Object) (mCustomView));
	//  107  209:aload_0         
	//  108  210:getfield        #306 <Field View mCustomView>
	//  109  213:astore          9
		if(obj != null)
	//* 110  215:aload           9
	//* 111  217:ifnull          233
	...
	//  116  226:iload           8
	//  117  228:iload_1         
	//  118  229:invokevirtual   #394 <Method int positionChild(View, int, int, int, boolean)>
	//  119  232:pop             
		if(flag)
	//* 120  233:iload_1         
	//* 121  234:ifeq            245
			i = getPaddingLeft();
	//  122  237:aload_0         
	//  123  238:invokevirtual   #368 <Method int getPaddingLeft()>
	//  124  241:istore_2        
		else
	//* 125  242:goto            255
	...
	//  128  248:isub            
	//  129  249:aload_0         
	//  130  250:invokevirtual   #365 <Method int getPaddingRight()>
	//  131  253:isub            
	//  132  254:istore_2        
		if(mMenuView != null)
	//* 133  255:aload_0         
	//* 134  256:getfield        #286 <Field ActionMenuView mMenuView>
	//* 135  259:ifnull          279
			positionChild(((View) (mMenuView)), i, j1, k1, flag ^ true);
	//  136  262:aload_0         
	//  137  263:aload_0         
	//  138  264:getfield        #286 <Field ActionMenuView mMenuView>
	//  139  267:iload_2         
	//  140  268:iload           7
	//  141  270:iload           8
	//  142  272:iload_1         
	//  143  273:iconst_1        
	//  144  274:ixor            
	//  145  275:invokevirtual   #394 <Method int positionChild(View, int, int, int, boolean)>
	//  146  278:pop             
	//  147  279:return          
	}
	...
	//*   8   17:iload_2         
	//*   9   18:invokestatic    #402 <Method int android.view.View$MeasureSpec.getMode(int)>
	//*  10   21:ifeq            495
			{
				int k2 = android.view.View.MeasureSpec.getSize(i);
	//   11   24:iload_1         
	//   12   25:invokestatic    #406 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   13   28:istore          8
				int l;
				if(mContentHeight > 0)
	//*  14   30:aload_0         
	//*  15   31:getfield        #94  <Field int mContentHeight>
	//*  16   34:ifle            45
					l = mContentHeight;
	//   17   37:aload_0         
	//   18   38:getfield        #94  <Field int mContentHeight>
	//   19   41:istore_3        
				else
	//*  20   42:goto            50
					l = android.view.View.MeasureSpec.getSize(j);
	//   21   45:iload_2         
	//   22   46:invokestatic    #406 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   23   49:istore_3        
				int l2 = getPaddingTop() + getPaddingBottom();
	//   24   50:aload_0         
	//   25   51:invokevirtual   #371 <Method int getPaddingTop()>
	//   26   54:aload_0         
	//   27   55:invokevirtual   #374 <Method int getPaddingBottom()>
	//   28   58:iadd            
	//   29   59:istore          9
				i = k2 - getPaddingLeft() - getPaddingRight();
	//   30   61:iload           8
	//   31   63:aload_0         
	//   32   64:invokevirtual   #368 <Method int getPaddingLeft()>
	//   33   67:isub            
	//   34   68:aload_0         
	//   35   69:invokevirtual   #365 <Method int getPaddingRight()>
	//   36   72:isub            
	//   37   73:istore_1        
				int j2 = l - l2;
	//   38   74:iload_3         
	...
	//   42   80:iload           7
	//   43   82:ldc2            #407 <Int 0x80000000>
	//   44   85:invokestatic    #410 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   45   88:istore          4
				Object obj = ((Object) (mClose));
	//   46   90:aload_0         
	//   47   91:getfield        #196 <Field View mClose>
	//   48   94:astore          11
				boolean flag = false;
	//   49   96:iconst_0        
	//   50   97:istore          6
	...
	//   58  110:iload           4
	//   59  112:iconst_0        
	//   60  113:invokevirtual   #414 <Method int measureChildView(View, int, int, int)>
	//   61  116:istore_1        
					obj = ((Object) ((android.view.ViewGroup.MarginLayoutParams)mClose.getLayoutParams()));
	//   62  117:aload_0         
	//   63  118:getfield        #196 <Field View mClose>
	//   64  121:invokevirtual   #380 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   65  124:checkcast       #206 <Class android.view.ViewGroup$MarginLayoutParams>
	//   66  127:astore          11
					j = i - (((android.view.ViewGroup.MarginLayoutParams) (obj)).leftMargin + ((android.view.ViewGroup.MarginLayoutParams) (obj)).rightMargin);
	//   67  129:iload_1         
	//   68  130:aload           11
	//   69  132:getfield        #386 <Field int android.view.ViewGroup$MarginLayoutParams.leftMargin>
	//   70  135:aload           11
	//   71  137:getfield        #383 <Field int android.view.ViewGroup$MarginLayoutParams.rightMargin>
	//   72  140:iadd            
	//   73  141:isub            
	//   74  142:istore_2        
				}
	...
	//   76  144:istore_1        
				if(mMenuView != null)
	//*  77  145:aload_0         
	//*  78  146:getfield        #286 <Field ActionMenuView mMenuView>
	//*  79  149:ifnull          178
				{
					i = j;
	//   80  152:iload_2         
	...
	//*  82  154:aload_0         
	//*  83  155:getfield        #286 <Field ActionMenuView mMenuView>
	//*  84  158:invokevirtual   #415 <Method android.view.ViewParent ActionMenuView.getParent()>
	//*  85  161:aload_0         
	//*  86  162:if_acmpne       178
						i = measureChildView(((View) (mMenuView)), j, i1, 0);
	//   87  165:aload_0         
	//   88  166:aload_0         
	//   89  167:getfield        #286 <Field ActionMenuView mMenuView>
	//   90  170:iload_2         
	//   91  171:iload           4
	//   92  173:iconst_0        
	//   93  174:invokevirtual   #414 <Method int measureChildView(View, int, int, int)>
	//   94  177:istore_1        
				}
				obj = ((Object) (mTitleLayout));
	//   95  178:aload_0         
	//   96  179:getfield        #111 <Field LinearLayout mTitleLayout>
	//   97  182:astore          11
				j = i;
	//   98  184:iload_1         
	//   99  185:istore_2        
	...
	//  103  192:istore_2        
					if(mCustomView == null)
	//* 104  193:aload_0         
	//* 105  194:getfield        #306 <Field View mCustomView>
	//* 106  197:ifnonnull       298
						if(mTitleOptional)
	//* 107  200:aload_0         
	//* 108  201:getfield        #301 <Field boolean mTitleOptional>
	//* 109  204:ifeq            287
						{
							j = android.view.View.MeasureSpec.makeMeasureSpec(0, 0);
	//  110  207:iconst_0        
	//  111  208:iconst_0        
	//  112  209:invokestatic    #410 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  113  212:istore_2        
							mTitleLayout.measure(j, i1);
	//  114  213:aload_0         
	//  115  214:getfield        #111 <Field LinearLayout mTitleLayout>
	//  116  217:iload_2         
	//  117  218:iload           4
	//  118  220:invokevirtual   #418 <Method void LinearLayout.measure(int, int)>
							int i3 = mTitleLayout.getMeasuredWidth();
	//  119  223:aload_0         
	//  120  224:getfield        #111 <Field LinearLayout mTitleLayout>
	//  121  227:invokevirtual   #421 <Method int LinearLayout.getMeasuredWidth()>
	//  122  230:istore          10
							if(i3 <= i)
	//* 123  232:iload           10
	//* 124  234:iload_1         
	...
	//  138  258:istore_2        
							obj = ((Object) (mTitleLayout));
	//  139  259:aload_0         
	//  140  260:getfield        #111 <Field LinearLayout mTitleLayout>
	//  141  263:astore          11
							if(i1 != 0)
	//* 142  265:iload           4
	//* 143  267:ifeq            275
	...
	//  149  278:aload           11
	//  150  280:iload_1         
	//  151  281:invokevirtual   #178 <Method void LinearLayout.setVisibility(int)>
						} else
	//* 152  284:goto            298
						{
	...
	//  156  291:iload           4
	//  157  293:iconst_0        
	//  158  294:invokevirtual   #414 <Method int measureChildView(View, int, int, int)>
	//  159  297:istore_2        
						}
				}
				obj = ((Object) (mCustomView));
	//  160  298:aload_0         
	//  161  299:getfield        #306 <Field View mCustomView>
	//  162  302:astore          11
				if(obj != null)
	//* 163  304:aload           11
	//* 164  306:ifnull          422
	...
	//  165  309:aload           11
	//  166  311:invokevirtual   #380 <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//  167  314:astore          11
					if(((android.view.ViewGroup.LayoutParams) (obj)).width != -2)
	//* 168  316:aload           11
	//* 169  318:getfield        #424 <Field int android.view.ViewGroup$LayoutParams.width>
	//* 170  321:bipush          -2
	//* 171  323:icmpeq          333
						i = 0x40000000;
	//  172  326:ldc2            #403 <Int 0x40000000>
	//  173  329:istore_1        
					else
	//* 174  330:goto            337
						i = 0x80000000;
	//  175  333:ldc2            #407 <Int 0x80000000>
	//  176  336:istore_1        
					int j1 = j;
	//  177  337:iload_2         
	//  178  338:istore          4
	...
	//* 179  340:aload           11
	//* 180  342:getfield        #424 <Field int android.view.ViewGroup$LayoutParams.width>
	//* 181  345:iflt            359
						j1 = Math.min(((android.view.ViewGroup.LayoutParams) (obj)).width, j);
	//  182  348:aload           11
	//  183  350:getfield        #424 <Field int android.view.ViewGroup$LayoutParams.width>
	//  184  353:iload_2         
	//  185  354:invokestatic    #429 <Method int Math.min(int, int)>
	//  186  357:istore          4
					if(((android.view.ViewGroup.LayoutParams) (obj)).height != -2)
	//* 187  359:aload           11
	//* 188  361:getfield        #432 <Field int android.view.ViewGroup$LayoutParams.height>
	//* 189  364:bipush          -2
	//* 190  366:icmpeq          375
						j = l1;
	//  191  369:iload           5
	...
	//* 193  372:goto            379
						j = 0x80000000;
	//  194  375:ldc2            #407 <Int 0x80000000>
	//  195  378:istore_2        
					l1 = j2;
	//  196  379:iload           7
	//  197  381:istore          5
	...
	//* 198  383:aload           11
	//* 199  385:getfield        #432 <Field int android.view.ViewGroup$LayoutParams.height>
	//* 200  388:iflt            403
						l1 = Math.min(((android.view.ViewGroup.LayoutParams) (obj)).height, j2);
	//  201  391:aload           11
	//  202  393:getfield        #432 <Field int android.view.ViewGroup$LayoutParams.height>
	//  203  396:iload           7
	//  204  398:invokestatic    #429 <Method int Math.min(int, int)>
	//  205  401:istore          5
	...
	//  206  403:aload_0         
	//  207  404:getfield        #306 <Field View mCustomView>
	//  208  407:iload           4
	//  209  409:iload_1         
	//  210  410:invokestatic    #410 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  211  413:iload           5
	//  212  415:iload_2         
	//  213  416:invokestatic    #410 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//  214  419:invokevirtual   #433 <Method void View.measure(int, int)>
				}
				if(mContentHeight <= 0)
	//* 215  422:aload_0         
	//* 216  423:getfield        #94  <Field int mContentHeight>
	//* 217  426:ifgt            487
				{
					int i2 = getChildCount();
	//  218  429:aload_0         
	//  219  430:invokevirtual   #132 <Method int getChildCount()>
	//  220  433:istore          5
					j = 0;
	//  221  435:iconst_0        
	//  222  436:istore_2        
	...
	//  228  446:aload_0         
	//  229  447:iload_1         
	//  230  448:invokevirtual   #136 <Method View getChildAt(int)>
	//  231  451:invokevirtual   #436 <Method int View.getMeasuredHeight()>
	//  232  454:iload           9
	//  233  456:iadd            
	//  234  457:istore          4
						l = j;
	...
	//  250  480:iload           8
	//  251  482:iload_2         
	//  252  483:invokevirtual   #439 <Method void setMeasuredDimension(int, int)>
					return;
	//  253  486:return          
				} else
				{
	...
	//  255  488:iload           8
	//  256  490:iload_3         
	//  257  491:invokevirtual   #439 <Method void setMeasuredDimension(int, int)>
					return;
	//  258  494:return          
				}
			} else
	...
	//  259  495:new             #441 <Class StringBuilder>
	//  260  498:dup             
	//  261  499:invokespecial   #443 <Method void StringBuilder()>
	//  262  502:astore          11
				stringbuilder.append(((Object)this).getClass().getSimpleName());
	//  263  504:aload           11
	//  264  506:aload_0         
	//  265  507:invokevirtual   #332 <Method Class Object.getClass()>
	//  266  510:invokevirtual   #446 <Method String Class.getSimpleName()>
	//  267  513:invokevirtual   #450 <Method StringBuilder StringBuilder.append(String)>
	//  268  516:pop             
				stringbuilder.append(" can only be used ");
	//  269  517:aload           11
	//  270  519:ldc2            #452 <String " can only be used ">
	//  271  522:invokevirtual   #450 <Method StringBuilder StringBuilder.append(String)>
	//  272  525:pop             
				stringbuilder.append("with android:layout_height=\"wrap_content\"");
	//  273  526:aload           11
	//  274  528:ldc2            #454 <String "with android:layout_height=\"wrap_content\"">
	//  275  531:invokevirtual   #450 <Method StringBuilder StringBuilder.append(String)>
	//  276  534:pop             
				throw new IllegalStateException(stringbuilder.toString());
	//  277  535:new             #456 <Class IllegalStateException>
	//  278  538:dup             
	//  279  539:aload           11
	//  280  541:invokevirtual   #459 <Method String StringBuilder.toString()>
	//  281  544:invokespecial   #462 <Method void IllegalStateException(String)>
	//  282  547:athrow          
			}
		} else
		{
			StringBuilder stringbuilder1 = new StringBuilder();
	//  283  548:new             #441 <Class StringBuilder>
	//  284  551:dup             
	//  285  552:invokespecial   #443 <Method void StringBuilder()>
	//  286  555:astore          11
			stringbuilder1.append(((Object)this).getClass().getSimpleName());
	//  287  557:aload           11
	//  288  559:aload_0         
	//  289  560:invokevirtual   #332 <Method Class Object.getClass()>
	//  290  563:invokevirtual   #446 <Method String Class.getSimpleName()>
	//  291  566:invokevirtual   #450 <Method StringBuilder StringBuilder.append(String)>
	//  292  569:pop             
			stringbuilder1.append(" can only be used ");
	//  293  570:aload           11
	//  294  572:ldc2            #452 <String " can only be used ">
	//  295  575:invokevirtual   #450 <Method StringBuilder StringBuilder.append(String)>
	//  296  578:pop             
			stringbuilder1.append("with android:layout_width=\"match_parent\" (or fill_parent)");
	//  297  579:aload           11
	//  298  581:ldc2            #464 <String "with android:layout_width=\"match_parent\" (or fill_parent)">
	//  299  584:invokevirtual   #450 <Method StringBuilder StringBuilder.append(String)>
	//  300  587:pop             
			throw new IllegalStateException(stringbuilder1.toString());
	//  301  588:new             #456 <Class IllegalStateException>
	//  302  591:dup             
	//  303  592:aload           11
	//  304  594:invokevirtual   #459 <Method String StringBuilder.toString()>
	//  305  597:invokespecial   #462 <Method void IllegalStateException(String)>
	//  306  600:athrow          
		}
	}
	...
	//    5    9:aload_0         
	//    6   10:aload_2         
	//    7   11:invokevirtual   #475 <Method void removeView(View)>
		mCustomView = view;
	//    8   14:aload_0         
	//    9   15:aload_1         
	//   10   16:putfield        #306 <Field View mCustomView>
		if(view != null)
	//*  11   19:aload_1         
	//*  12   20:ifnull          42
		{
	...
	//   13   23:aload_0         
	//   14   24:getfield        #111 <Field LinearLayout mTitleLayout>
	//   15   27:astore_2        
	...
	//   18   32:aload_0         
	//   19   33:aload_2         
	//   20   34:invokevirtual   #475 <Method void removeView(View)>
				mTitleLayout = null;
	//   21   37:aload_0         
	//   22   38:aconst_null     
	//   23   39:putfield        #111 <Field LinearLayout mTitleLayout>
			}
		}
		if(view != null)
	//*  24   42:aload_1         
	...
	//   26   46:aload_0         
	//   27   47:aload_1         
	//   28   48:invokevirtual   #186 <Method void addView(View)>
		requestLayout();
	//   29   51:aload_0         
	//   30   52:invokevirtual   #478 <Method void requestLayout()>
	//   31   55:return          
	}
