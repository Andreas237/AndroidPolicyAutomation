...
public class AlertDialogLayout extends LinearLayoutCompat
{
	...
	//   57   99:aload_0         
	//   58  100:invokevirtual   #156 <Method Drawable getDividerDrawable()>
	//   59  103:astore          15
		if(drawable == null)
	//*  60  105:aload           15
	...
	//   65  116:aload           15
	//   66  118:invokevirtual   #161 <Method int Drawable.getIntrinsicHeight()>
	//   67  121:istore          4
		for(l = 0; l < j2;)
	//*  68  123:iconst_0        
	//*  69  124:istore          5
	...
	//   73  133:aload_0         
	//   74  134:iload           5
	//   75  136:invokevirtual   #35  <Method View getChildAt(int)>
	//   76  139:astore          15
			j = i;
	//   77  141:iload_2         
	//   78  142:istore_3        
	...
	//   82  149:istore_3        
				if(view.getVisibility() != 8)
	//*  83  150:aload           15
	//*  84  152:invokevirtual   #40  <Method int View.getVisibility()>
	//*  85  155:bipush          8
	//*  86  157:icmpeq          336
				{
					int l2 = view.getMeasuredWidth();
	//   87  160:aload           15
	//   88  162:invokevirtual   #131 <Method int View.getMeasuredWidth()>
	//   89  165:istore          13
					int i3 = view.getMeasuredHeight();
	//   90  167:aload           15
	//   91  169:invokevirtual   #56  <Method int View.getMeasuredHeight()>
	//   92  172:istore          14
					LinearLayoutCompat.LayoutParams layoutparams = (LinearLayoutCompat.LayoutParams)view.getLayoutParams();
	//   93  174:aload           15
	//   94  176:invokevirtual   #44  <Method android.view.ViewGroup$LayoutParams View.getLayoutParams()>
	//   95  179:checkcast       #46  <Class LinearLayoutCompat$LayoutParams>
	//   96  182:astore          16
					int i1 = layoutparams.gravity;
	//   97  184:aload           16
	//   98  186:getfield        #164 <Field int LinearLayoutCompat$LayoutParams.gravity>
	//   99  189:istore          6
					j = i1;
	//  100  191:iload           6
	//  101  193:istore_3        
	...
	//* 103  196:ifge            205
						j = k2 & 0x800007;
	//  104  199:iload           12
	//  105  201:ldc1            #165 <Int 0x800007>
	//  106  203:iand            
	//  107  204:istore_3        
					j = GravityCompat.getAbsoluteGravity(j, ViewCompat.getLayoutDirection(((View) (this)))) & 7;
	//  108  205:iload_3         
	//  109  206:aload_0         
	//  110  207:invokestatic    #168 <Method int ViewCompat.getLayoutDirection(View)>
	//  111  210:invokestatic    #173 <Method int GravityCompat.getAbsoluteGravity(int, int)>
	//  112  213:bipush          7
	//  113  215:iand            
	//  114  216:istore_3        
					if(j != 1)
	...
	//  121  227:aload           16
	//  122  229:getfield        #176 <Field int LinearLayoutCompat$LayoutParams.leftMargin>
	//  123  232:iload           7
	//  124  234:iadd            
	//  125  235:istore_3        
						else
	...
	//  131  246:isub            
	//  132  247:aload           16
	//  133  249:getfield        #179 <Field int LinearLayoutCompat$LayoutParams.rightMargin>
	//  134  252:isub            
	//  135  253:istore_3        
					} else
	//* 136  254:goto            286
	...
	//  147  272:iadd            
	//  148  273:aload           16
	//  149  275:getfield        #176 <Field int LinearLayoutCompat$LayoutParams.leftMargin>
	//  150  278:iadd            
	//  151  279:aload           16
	//  152  281:getfield        #179 <Field int LinearLayoutCompat$LayoutParams.rightMargin>
	//  153  284:isub            
	//  154  285:istore_3        
					}
					i1 = i;
	...
	//* 157  289:aload_0         
	//* 158  290:iload           5
	//* 159  292:invokevirtual   #183 <Method boolean hasDividerBeforeChildAt(int)>
	//* 160  295:ifeq            304
						i1 = i + k;
	//  161  298:iload_2         
	//  162  299:iload           4
	...
	//  165  304:iload           6
	//  166  306:aload           16
	//  167  308:getfield        #186 <Field int LinearLayoutCompat$LayoutParams.topMargin>
	//  168  311:iadd            
	//  169  312:istore_2        
	...
	//  174  318:iload           13
	//  175  320:iload           14
	//  176  322:invokespecial   #188 <Method void setChildFrame(View, int, int, int, int)>
					j = i + (i3 + layoutparams.bottomMargin);
	//  177  325:iload_2         
	//  178  326:iload           14
	//  179  328:aload           16
	//  180  330:getfield        #191 <Field int LinearLayoutCompat$LayoutParams.bottomMargin>
	//  181  333:iadd            
	//  182  334:iadd            
	//  183  335:istore_3        
				}
