...
;
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #222 <Method Drawable ActionMenuPresenter$OverflowMenuButton.getDrawable()>
	//    7   13:areturn         
		if(mPendingOverflowIconSet)
	//*   8   14:aload_0         
	//*   9   15:getfield        #224 <Field boolean mPendingOverflowIconSet>
	//*  10   18:ifeq            26
			return mPendingOverflowIcon;
	//   11   21:aload_0         
	//   12   22:getfield        #226 <Field Drawable mPendingOverflowIcon>
	//   13   25:areturn         
		else
			return null;
	//   14   26:aconst_null     
	...
	//    5    9:aload_1         
	//    6   10:invokevirtual   #242 <Method void ActionMenuPresenter$ActionButtonSubmenu.dismiss()>
			return true;
	//    7   13:iconst_1        
	//    8   14:ireturn         
		} else
	...
	//   84  165:aload_0         
	//   85  166:aload_2         
	//   86  167:invokevirtual   #313 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//   87  170:getfield        #319 <Field float DisplayMetrics.density>
	//   88  173:ldc2            #320 <Float 56F>
	//   89  176:fmul            
	//   90  177:f2i             
	...
	//    4    6:ifnull          18
	//    5    9:aload_1         
	//    6   10:invokevirtual   #332 <Method boolean ActionMenuPresenter$OverflowPopup.isShowing()>
	//    7   13:ifeq            18
	//    8   16:iconst_1        
	//    9   17:ireturn         
	//   10   18:iconst_0        
	...
	//    5    9:aload_2         
	//    6   10:aload_1         
	//    7   11:invokevirtual   #292 <Method void ActionMenuPresenter$OverflowMenuButton.setImageDrawable(Drawable)>
			return;
	//    8   14:return          
		} else
		{
	...
	//    9   15:aload_0         
	//   10   16:iconst_1        
	//   11   17:putfield        #224 <Field boolean mPendingOverflowIconSet>
			mPendingOverflowIcon = drawable;
	//   12   20:aload_0         
	//   13   21:aload_1         
	//   14   22:putfield        #226 <Field Drawable mPendingOverflowIcon>
			return;
	//   15   25:return          
		}
	}
	...
	//* 125  258:ifnull          287
	//* 126  261:aload           5
	//* 127  263:invokevirtual   #483 <Method android.view.ViewParent ActionMenuPresenter$OverflowMenuButton.getParent()>
	//* 128  266:aload_0         
	//* 129  267:getfield        #106 <Field MenuView mMenuView>
	//* 130  270:if_acmpne       287
				((ViewGroup)mMenuView).removeView(((View) (mOverflowButton)));
	//  131  273:aload_0         
	//  132  274:getfield        #106 <Field MenuView mMenuView>
	//  133  277:checkcast       #113 <Class ViewGroup>
	//  134  280:aload_0         
	//  135  281:getfield        #160 <Field ActionMenuPresenter$OverflowMenuButton mOverflowButton>
	//  136  284:invokevirtual   #487 <Method void ViewGroup.removeView(View)>
		}
		((ActionMenuView)mMenuView).setOverflowReserved(mReserveOverflow);
	//  137  287:aload_0         
	//  138  288:getfield        #106 <Field MenuView mMenuView>
	//  139  291:checkcast       #135 <Class ActionMenuView>
	//  140  294:aload_0         
	//  141  295:getfield        #267 <Field boolean mReserveOverflow>
	//  142  298:invokevirtual   #498 <Method void ActionMenuView.setOverflowReserved(boolean)>
	//  143  301:return          
	}
