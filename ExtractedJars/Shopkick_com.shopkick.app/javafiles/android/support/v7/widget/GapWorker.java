...
label0:
	...
	//   95  187:aload_0         
	//   96  188:getfield        #49  <Field ArrayList mTasks>
	//   97  191:iload_1         
	//   98  192:invokevirtual   #58  <Method Object ArrayList.get(int)>
	//   99  195:checkcast       #13  <Class GapWorker$Task>
	//  100  198:astore          8
				}
				int k1 = layoutprefetchregistryimpl.mPrefetchArray[l + 1];
	//  101  200:aload           10
	//  102  202:getfield        #100 <Field int[] GapWorker$LayoutPrefetchRegistryImpl.mPrefetchArray>
	//  103  205:iload_3         
	//  104  206:iconst_1        
	//  105  207:iadd            
	//  106  208:iaload          
	...
	//  116  227:aload           8
	//  117  229:iload           7
	//  118  231:putfield        #104 <Field boolean GapWorker$Task.immediate>
				task.viewVelocity = j1;
	//  119  234:aload           8
	//  120  236:iload           5
	//  121  238:putfield        #107 <Field int GapWorker$Task.viewVelocity>
				task.distanceToItem = k1;
	//  122  241:aload           8
	//  123  243:iload           6
	//  124  245:putfield        #110 <Field int GapWorker$Task.distanceToItem>
				task.view = recyclerview1;
	//  125  248:aload           8
	//  126  250:aload           9
	//  127  252:putfield        #114 <Field RecyclerView GapWorker$Task.view>
				task.position = layoutprefetchregistryimpl.mPrefetchArray[l];
	//  128  255:aload           8
	//  129  257:aload           10
	//  130  259:getfield        #100 <Field int[] GapWorker$LayoutPrefetchRegistryImpl.mPrefetchArray>
	//  131  262:iload_3         
	//  132  263:iaload          
	//  133  264:putfield        #117 <Field int GapWorker$Task.position>
				i++;
	//  134  267:iload_1         
	//  135  268:iconst_1        
	//  136  269:iadd            
	...
	//  148  285:aload_0         
	//  149  286:getfield        #49  <Field ArrayList mTasks>
	//  150  289:getstatic       #40  <Field Comparator sTaskComparator>
	//  151  292:invokestatic    #123 <Method void Collections.sort(java.util.List, Comparator)>
	//  152  295:return          
	}
	...
	//*  20   41:ifnull          73
	//*  21   44:aload_1         
	//*  22   45:invokevirtual   #141 <Method boolean RecyclerView$ViewHolder.isBound()>
	//*  23   48:ifeq            73
	//*  24   51:aload_1         
	//*  25   52:invokevirtual   #144 <Method boolean RecyclerView$ViewHolder.isInvalid()>
	//*  26   55:ifne            73
			prefetchInnerRecyclerViewWithDeadline((RecyclerView)((RecyclerView.ViewHolder) (task)).mNestedRecyclerView.get(), l);
	//   27   58:aload_0         
	//   28   59:aload_1         
	//   29   60:getfield        #137 <Field WeakReference RecyclerView$ViewHolder.mNestedRecyclerView>
	//   30   63:invokevirtual   #149 <Method Object WeakReference.get()>
	//   31   66:checkcast       #60  <Class RecyclerView>
	//   32   69:lload_2         
	//   33   70:invokespecial   #153 <Method void prefetchInnerRecyclerViewWithDeadline(RecyclerView, long)>
	//   34   73:return          
	}
...
_L1:
	...
	//   31   66:aload           6
	//   32   68:iconst_0        
	//   33   69:invokevirtual   #242 <Method void RecyclerView$Recycler.addViewHolderToRecycledViewPool(RecyclerView$ViewHolder, boolean)>
		recyclerview.onExitLayoutOrScroll(false);
	//   34   72:aload_1         
	//   35   73:iconst_0        
	//   36   74:invokevirtual   #246 <Method void RecyclerView.onExitLayoutOrScroll(boolean)>
		return viewholder;
	//   37   77:aload           6
	//   38   79:areturn         
		Exception exception;
	...
	//   40   82:aload_1         
	//   41   83:iconst_0        
	//   42   84:invokevirtual   #246 <Method void RecyclerView.onExitLayoutOrScroll(boolean)>
		throw exception;
	//   43   87:aload           5
	//   44   89:athrow          
	}
...
_L2:
	...
	static Comparator sTaskComparator = new Comparator() {
		...
		//   11   20:istore_3        
			...
			if(task1.view == null)
		//*  12   21:aload_2         
		//*  13   22:getfield        #22  <Field RecyclerView GapWorker$Task.view>
		//*  14   25:ifnonnull       34
				flag = true;
		//   15   28:iconst_1        
		//   16   29:istore          4
		...
		//   23   43:aload_1         
		//   24   44:getfield        #22  <Field RecyclerView GapWorker$Task.view>
		//   25   47:ifnonnull       52
		//   26   50:iconst_1        
		//   27   51:ireturn         
		//   28   52:iconst_m1       
		...
		//*  32   58:aload_2         
		//*  33   59:getfield        #26  <Field boolean GapWorker$Task.immediate>
		//*  34   62:icmpeq          79
			{
				i = ((int) (flag1));
		//   35   65:iload           5
		//   36   67:istore_3        
				if(task.immediate)
		//*  37   68:aload_1         
		//*  38   69:getfield        #26  <Field boolean GapWorker$Task.immediate>
		//*  39   72:ifeq            77
					i = -1;
		//   40   75:iconst_m1       
		//   41   76:istore_3        
		...
		//   44   79:aload_2         
		//   45   80:getfield        #30  <Field int GapWorker$Task.viewVelocity>
		//   46   83:aload_1         
		//   47   84:getfield        #30  <Field int GapWorker$Task.viewVelocity>
		//   48   87:isub            
		//   49   88:istore_3        
			if(i != 0)
		//*  50   89:iload_3         
		...
		//   54   95:aload_1         
		//   55   96:getfield        #33  <Field int GapWorker$Task.distanceToItem>
		//   56   99:aload_2         
		//   57  100:getfield        #33  <Field int GapWorker$Task.distanceToItem>
		//   58  103:isub            
		//   59  104:istore_3        
			if(i != 0)
		//*  60  105:iload_3         
