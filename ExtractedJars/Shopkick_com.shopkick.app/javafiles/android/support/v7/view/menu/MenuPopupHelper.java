...
;
	...
	//   32   65:aload_0         
	//   33   66:getfield        #64  <Field Context mContext>
	//   34   69:invokevirtual   #123 <Method Resources Context.getResources()>
	//   35   72:invokevirtual   #210 <Method DisplayMetrics Resources.getDisplayMetrics()>
	//   36   75:getfield        #216 <Field float DisplayMetrics.density>
	//   37   78:ldc1            #217 <Float 48F>
	//   38   80:fmul            
	//   39   81:fconst_2        
	//   40   82:fdiv            
	//   41   83:f2i             
	...
	//    4    6:ifnull          18
	//    5    9:aload_1         
	//    6   10:invokevirtual   #246 <Method boolean MenuPopup.isShowing()>
	//    7   13:ifeq            18
	//    8   16:iconst_1        
	//    9   17:ireturn         
	//   10   18:iconst_0        
	...
	//    8   14:aload_1         
	//    9   15:invokeinterface #253 <Method void android.widget.PopupWindow$OnDismissListener.onDismiss()>
	//   10   20:return          
	}
	...
	//    8   14:aload_2         
	//    9   15:iload_1         
	//   10   16:invokevirtual   #170 <Method void MenuPopup.setForceShowIcon(boolean)>
	//   11   19:return          
	}
	...
	//    8   14:aload_2         
	//    9   15:aload_1         
	//   10   16:invokevirtual   #164 <Method void MenuPopup.setCallback(MenuPresenter$Callback)>
	//   11   19:return          
	}
	...
	//    5   11:dup             
	//    6   12:ldc2            #262 <String "MenuPopupHelper cannot be used without an anchor">
	//    7   15:invokespecial   #265 <Method void IllegalStateException(String)>
	//    8   18:athrow          
	}
	...
	//    5    9:return          
			...
			throw new IllegalStateException("MenuPopupHelper cannot be used without an anchor");
	//    6   10:new             #260 <Class IllegalStateException>
	//    7   13:dup             
	//    8   14:ldc2            #262 <String "MenuPopupHelper cannot be used without an anchor">
	//    9   17:invokespecial   #265 <Method void IllegalStateException(String)>
	//   10   20:athrow          
	}
