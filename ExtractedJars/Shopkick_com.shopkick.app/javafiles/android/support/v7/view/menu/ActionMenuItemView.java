...
label0:
	...
	//    5    9:aload_1         
	//    6   10:aload_0         
	//    7   11:getfield        #149 <Field MenuItemImpl mItemData>
	//    8   14:invokeinterface #244 <Method boolean MenuBuilder$ItemInvoker.invokeItem(MenuItemImpl)>
	//    9   19:pop             
	//   10   20:return          
	}
	...
	//   11   21:iload_3         
	//   12   22:aload_0         
	//   13   23:invokevirtual   #255 <Method int getPaddingTop()>
	//   14   26:aload_0         
	//   15   27:invokevirtual   #258 <Method int getPaddingRight()>
	//   16   30:aload_0         
	//   17   31:invokevirtual   #261 <Method int getPaddingBottom()>
	//   18   34:invokespecial   #265 <Method void AppCompatTextView.setPadding(int, int, int, int)>
		}
		super.onMeasure(i, j);
	//   19   37:aload_0         
	//   20   38:iload_1         
	//   21   39:iload_2         
	//   22   40:invokespecial   #267 <Method void AppCompatTextView.onMeasure(int, int)>
		int l = android.view.View.MeasureSpec.getMode(i);
	//   23   43:iload_1         
	//   24   44:invokestatic    #273 <Method int android.view.View$MeasureSpec.getMode(int)>
	//   25   47:istore_3        
		i = android.view.View.MeasureSpec.getSize(i);
	//   26   48:iload_1         
	//   27   49:invokestatic    #276 <Method int android.view.View$MeasureSpec.getSize(int)>
	//   28   52:istore_1        
		int i1 = getMeasuredWidth();
	//   29   53:aload_0         
	//   30   54:invokevirtual   #279 <Method int getMeasuredWidth()>
	//   31   57:istore          4
		if(l == 0x80000000)
	//*  32   59:iload_3         
	//*  33   60:ldc2            #280 <Int 0x80000000>
	//*  34   63:icmpne          78
			i = Math.min(i, mMinWidth);
	//   35   66:iload_1         
	//   36   67:aload_0         
	//   37   68:getfield        #87  <Field int mMinWidth>
	//   38   71:invokestatic    #285 <Method int Math.min(int, int)>
	//   39   74:istore_1        
		else
	//*  40   75:goto            83
			i = mMinWidth;
	//   41   78:aload_0         
	//   42   79:getfield        #87  <Field int mMinWidth>
	//   43   82:istore_1        
		if(l != 0x40000000 && mMinWidth > 0 && i1 < i)
	//*  44   83:iload_3         
	//*  45   84:ldc2            #286 <Int 0x40000000>
	//*  46   87:icmpeq          115
	//*  47   90:aload_0         
	//*  48   91:getfield        #87  <Field int mMinWidth>
	//*  49   94:ifle            115
	//*  50   97:iload           4
	//*  51   99:iload_1         
	//*  52  100:icmpge          115
	...
	//   53  103:aload_0         
	//   54  104:iload_1         
	//   55  105:ldc2            #286 <Int 0x40000000>
	//   56  108:invokestatic    #289 <Method int android.view.View$MeasureSpec.makeMeasureSpec(int, int)>
	//   57  111:iload_2         
	//   58  112:invokespecial   #267 <Method void AppCompatTextView.onMeasure(int, int)>
		if(!flag && mIcon != null)
	//*  59  115:iload           5
	//*  60  117:ifne            160
	//*  61  120:aload_0         
	//*  62  121:getfield        #147 <Field Drawable mIcon>
	//*  63  124:ifnull          160
			super.setPadding((getMeasuredWidth() - mIcon.getBounds().width()) / 2, getPaddingTop(), getPaddingRight(), getPaddingBottom());
	//   64  127:aload_0         
	//   65  128:aload_0         
	//   66  129:invokevirtual   #279 <Method int getMeasuredWidth()>
	//   67  132:aload_0         
	//   68  133:getfield        #147 <Field Drawable mIcon>
	//   69  136:invokevirtual   #295 <Method Rect Drawable.getBounds()>
	//   70  139:invokevirtual   #300 <Method int Rect.width()>
	//   71  142:isub            
	//   72  143:iconst_2        
	//   73  144:idiv            
	//   74  145:aload_0         
	//   75  146:invokevirtual   #255 <Method int getPaddingTop()>
	//   76  149:aload_0         
	//   77  150:invokevirtual   #258 <Method int getPaddingRight()>
	//   78  153:aload_0         
	//   79  154:invokevirtual   #261 <Method int getPaddingBottom()>
	//   80  157:invokespecial   #265 <Method void AppCompatTextView.setPadding(int, int, int, int)>
	//   81  160:return          
	}
	...
	//*  10   20:aload_0         
	//*  11   21:aload_1         
	//*  12   22:invokevirtual   #312 <Method boolean ForwardingListener.onTouch(View, MotionEvent)>
	//*  13   25:ifeq            30
				return true;
	//   14   28:iconst_1        
	//   15   29:ireturn         
	...
	//   16   30:aload_0         
	//   17   31:aload_1         
	//   18   32:invokespecial   #314 <Method boolean AppCompatTextView.onTouchEvent(MotionEvent)>
	//   19   35:ireturn         
	}
	...
	//   12   22:aload_2         
	//   13   23:invokevirtual   #321 <Method void MenuItemImpl.actionFormatChanged()>
		}
	//   14   26:return          
	}
	...
	//   10   19:istore          7
			int k = mMaxIconSize;
	//   11   21:aload_0         
	//   12   22:getfield        #107 <Field int mMaxIconSize>
	//   13   25:istore          5
			int j = l;
	//   14   27:iload           6
	//   15   29:istore          4
	...
	//   34   58:istore          4
			...
			i1 = mMaxIconSize;
	//   35   60:aload_0         
	//   36   61:getfield        #107 <Field int mMaxIconSize>
	//   37   64:istore          7
			l = j;
	//   38   66:iload           4
	//   39   68:istore          6
	...
	//   62  101:iload           6
	//   63  103:iload           5
	//   64  105:invokevirtual   #330 <Method void Drawable.setBounds(int, int, int, int)>
		}
	...
	//   68  111:aconst_null     
	//   69  112:aconst_null     
	//   70  113:invokevirtual   #334 <Method void setCompoundDrawables(Drawable, Drawable, Drawable, Drawable)>
		updateTextButtonVisibility();
	//   71  116:aload_0         
	//   72  117:invokespecial   #250 <Method void updateTextButtonVisibility()>
	//   73  120:return          
	}
