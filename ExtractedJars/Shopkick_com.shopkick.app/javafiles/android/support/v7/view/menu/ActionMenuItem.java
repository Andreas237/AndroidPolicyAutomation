	...
	implements SupportMenuItem
{
	...
	//    6   10:areturn         
			...
			return mTitle;
	//    7   11:aload_0         
	//    8   12:getfield        #87  <Field CharSequence mTitle>
	//    9   15:areturn         
	}
	...
	//*   5    9:aload_1         
	//*   6   10:aload_0         
	//*   7   11:invokeinterface #170 <Method boolean android.view.MenuItem$OnMenuItemClickListener.onMenuItemClick(MenuItem)>
	//*   8   16:ifeq            21
			return true;
	//    9   19:iconst_1        
	//   10   20:ireturn         
		obj = ((Object) (mIntent));
	//   11   21:aload_0         
	//   12   22:getfield        #141 <Field Intent mIntent>
	//   13   25:astore_1        
		if(obj != null)
	//*  14   26:aload_1         
	//*  15   27:ifnull          40
	...
	//   16   30:aload_0         
	//   17   31:getfield        #77  <Field Context mContext>
	//   18   34:aload_1         
	//   19   35:invokevirtual   #176 <Method void Context.startActivity(Intent)>
			return true;
	//   20   38:iconst_1        
	//   21   39:ireturn         
		} else
	...
	//    1    1:iload_1         
	//    2    2:aload_0         
	//    3    3:getfield        #75  <Field int mFlags>
	//    4    6:bipush          -2
	//    5    8:iand            
	//    6    9:ior             
	//    7   10:putfield        #75  <Field int mFlags>
		return ((MenuItem) (this));
	//    8   13:aload_0         
	//    9   14:areturn         
	}
	...
	//   14   21:iand            
	//   15   22:ior             
	//   16   23:putfield        #75  <Field int mFlags>
		return ((MenuItem) (this));
	//   17   26:aload_0         
	//   18   27:areturn         
	}
	...
	//   14   22:iand            
	//   15   23:ior             
	//   16   24:putfield        #75  <Field int mFlags>
		return ((MenuItem) (this));
	//   17   27:aload_0         
	//   18   28:areturn         
	}
	...
	//   13   19:iload_2         
	//   14   20:ior             
	//   15   21:putfield        #75  <Field int mFlags>
		return ((MenuItem) (this));
	//   16   24:aload_0         
	//   17   25:areturn         
	}
