...
public static class Constraints$LayoutParams extends rams
{
	...
	{
		super(((rams) (constraints$layoutparams)));
	//    0    0:aload_0         
	//    1    1:aload_1         
	//    2    2:invokespecial   #123 <Method void ConstraintLayout$LayoutParams(ConstraintLayout$LayoutParams)>
		alpha = 1.0F;
	//    3    5:aload_0         
	//    4    6:fconst_1        
	//    5    7:putfield        #28  <Field float alpha>
		applyElevation = false;
	//    6   10:aload_0         
	//    7   11:iconst_0        
	//    8   12:putfield        #30  <Field boolean applyElevation>
		elevation = 0.0F;
	//    9   15:aload_0         
	//   10   16:fconst_0        
	//   11   17:putfield        #32  <Field float elevation>
		rotation = 0.0F;
	//   12   20:aload_0         
	//   13   21:fconst_0        
	//   14   22:putfield        #34  <Field float rotation>
		rotationX = 0.0F;
	//   15   25:aload_0         
	//   16   26:fconst_0        
	//   17   27:putfield        #36  <Field float rotationX>
		rotationY = 0.0F;
	//   18   30:aload_0         
	//   19   31:fconst_0        
	//   20   32:putfield        #38  <Field float rotationY>
		scaleX = 1.0F;
	//   21   35:aload_0         
	//   22   36:fconst_1        
	//   23   37:putfield        #40  <Field float scaleX>
		scaleY = 1.0F;
	//   24   40:aload_0         
	//   25   41:fconst_1        
	//   26   42:putfield        #42  <Field float scaleY>
		transformPivotX = 0.0F;
	//   27   45:aload_0         
	//   28   46:fconst_0        
	//   29   47:putfield        #44  <Field float transformPivotX>
		transformPivotY = 0.0F;
	//   30   50:aload_0         
	//   31   51:fconst_0        
	//   32   52:putfield        #46  <Field float transformPivotY>
		translationX = 0.0F;
	//   33   55:aload_0         
	//   34   56:fconst_0        
	//   35   57:putfield        #48  <Field float translationX>
		translationY = 0.0F;
	//   36   60:aload_0         
	//   37   61:fconst_0        
	//   38   62:putfield        #50  <Field float translationY>
		translationZ = 0.0F;
	//   39   65:aload_0         
	//   40   66:fconst_0        
	//   41   67:putfield        #52  <Field float translationZ>
	//   42   70:return          
	}
}
