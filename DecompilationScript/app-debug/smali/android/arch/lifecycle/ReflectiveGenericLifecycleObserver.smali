...
.method private static createInfo(Ljava/lang/Class;)Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$CallbackInfo;
    ...
    const-string/jumbo v18, "invalid parameter type. Must be one and instanceof LifecycleOwner"
    ...
    const-string/jumbo v18, "invalid parameter type. second arg must be an event"
    ...
    const-string/jumbo v18, "Second arg is supported only for ON_ANY value"
    ...
    const-string/jumbo v18, "cannot have more than 2 params"
