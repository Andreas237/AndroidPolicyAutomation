...
.method public static final byteRangeContains(Lkotlin/ranges/ClosedRange;D)Z
    ...
    .restart local v0    # "it":Ljava/lang/Byte;
    :cond_0
    const/4 v1, 0x0
...
.method public static final coerceAtLeast(BB)B
    ...
    .end local p1    # "minimumValue":B
    :goto_0
    return p1

    .restart local p1    # "minimumValue":B
    :cond_0
    move p1, p0
...
.method public static final coerceAtLeast(DD)D
    ...
    .end local p2    # "minimumValue":D
    :goto_0
    return-wide p2

    .restart local p2    # "minimumValue":D
    :cond_0
    move-wide p2, p0
...
.method public static final coerceAtLeast(FF)F
    ...
    .end local p1    # "minimumValue":F
    :goto_0
    return p1

    .restart local p1    # "minimumValue":F
    :cond_0
    move p1, p0
...
.method public static final coerceAtLeast(Ljava/lang/Comparable;Ljava/lang/Comparable;)Ljava/lang/Comparable;
    ...
    .end local p1    # "minimumValue":Ljava/lang/Comparable;
    :goto_0
    return-object p1

    .restart local p1    # "minimumValue":Ljava/lang/Comparable;
    :cond_0
    move-object p1, p0
...
.method public static final coerceAtLeast(SS)S
    ...
    .end local p1    # "minimumValue":S
    :goto_0
    return p1

    .restart local p1    # "minimumValue":S
    :cond_0
    move p1, p0
...
.method public static final coerceAtMost(BB)B
    ...
    .end local p1    # "maximumValue":B
    :goto_0
    return p1

    .restart local p1    # "maximumValue":B
    :cond_0
    move p1, p0
...
.method public static final coerceAtMost(DD)D
    ...
    .end local p2    # "maximumValue":D
    :goto_0
    return-wide p2

    .restart local p2    # "maximumValue":D
    :cond_0
    move-wide p2, p0
...
.method public static final coerceAtMost(FF)F
    ...
    .end local p1    # "maximumValue":F
    :goto_0
    return p1

    .restart local p1    # "maximumValue":F
    :cond_0
    move p1, p0
...
.method public static final coerceAtMost(Ljava/lang/Comparable;Ljava/lang/Comparable;)Ljava/lang/Comparable;
    ...
    .end local p1    # "maximumValue":Ljava/lang/Comparable;
    :goto_0
    return-object p1

    .restart local p1    # "maximumValue":Ljava/lang/Comparable;
    :cond_0
    move-object p1, p0
...
.method public static final coerceAtMost(SS)S
    ...
    .end local p1    # "maximumValue":S
    :goto_0
    return p1

    .restart local p1    # "maximumValue":S
    :cond_0
    move p1, p0
...
.method public static final coerceIn(BBB)B
    ...
    const-string/jumbo v2, "Cannot coerce value to an empty range: maximum "
    ...
    const-string/jumbo v2, " is less than minimum "
...
.method public static final coerceIn(ILkotlin/ranges/ClosedRange;)I
    ...
    .end local p1    # "range":Lkotlin/ranges/ClosedRange;
    ...
    .line 911
    .end local p0    # "$receiver":I
    .restart local p1    # "range":Lkotlin/ranges/ClosedRange;
    :cond_0
    :goto_0
    return p0

    .line 910
    .restart local p0    # "$receiver":I
    :cond_1
    ...
    const-string/jumbo v2, "Cannot coerce value to an empty range: "
...
.method public static final coerceIn(JLkotlin/ranges/ClosedRange;)J
    ...
    .end local p2    # "range":Lkotlin/ranges/ClosedRange;
    invoke-static {v0, p2}, Lkotlin/ranges/RangesKt;->coerceIn(Ljava/lang/Comparable;Lkotlin/ranges/ClosedFloatingPointRange;)Ljava/lang/Comparable;
    ...
    .line 928
    .end local p0    # "$receiver":J
    .restart local p2    # "range":Lkotlin/ranges/ClosedRange;
    :cond_0
    :goto_0
    return-wide p0

    .line 927
    .restart local p0    # "$receiver":J
    :cond_1
...
.method public static final coerceIn(Ljava/lang/Comparable;Lkotlin/ranges/ClosedFloatingPointRange;)Ljava/lang/Comparable;
    ...
    .end local p0    # "$receiver":Ljava/lang/Comparable;
    :cond_1
    :goto_0
    return-object p0

    .line 879
    .restart local p0    # "$receiver":Ljava/lang/Comparable;
    :cond_2
...
.method public static final longRangeContains(Lkotlin/ranges/ClosedRange;D)Z
    ...
    .restart local v0    # "it":Ljava/lang/Long;
    :cond_0
    const/4 v1, 0x0
...
.method public static final shortRangeContains(Lkotlin/ranges/ClosedRange;D)Z
    ...
    .restart local v0    # "it":Ljava/lang/Short;
    :cond_0
    const/4 v1, 0x0
...
.method public static final until(JB)Lkotlin/ranges/LongRange;
    ...
    invoke-direct {v0, p0, p1, v2, v3}, Lkotlin/ranges/LongRange;-><init>(JJ)V
