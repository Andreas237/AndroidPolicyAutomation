...
.method public static final mapOf(Lkotlin/Pair;)Ljava/util/Map;
    ...
    const-string/jumbo v1, "java.util.Collections.si\u2026(pair.first, pair.second)"
...
.method public static final plus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .end local p0    # "$receiver":Ljava/util/Map;
    invoke-static {v1, p1}, Lkotlin/collections/MapsKt;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final plus(Ljava/util/Map;Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    .end local p0    # "$receiver":Ljava/util/Map;
    invoke-static {v1, p1}, Lkotlin/collections/MapsKt;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V
...
.method public static final toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .local p0, "$receiver":Ljava/util/Map$Entry;
    invoke-interface {p0}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;
    ...
    const-string/jumbo v1, "java.util.Collections.singletonMap(key, value)"

    invoke-static {v0, v1}, Lkotlin/jvm/internal/Intrinsics;->checkExpressionValueIsNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    const-string/jumbo v1, "with (entries.iterator()\u2026ingletonMap(key, value) }"
