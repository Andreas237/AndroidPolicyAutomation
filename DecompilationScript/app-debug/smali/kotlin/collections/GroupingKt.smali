...
.method public static final aggregate(Lkotlin/collections/Grouping;Lkotlin/jvm/functions/Function4;)Ljava/util/Map;
    ...
    .line 319
    .local v0, "accumulator$iv":Ljava/lang/Object;
    if-nez v0, :cond_0
    ...
    invoke-interface {p1, v2, v0, v1, v4}, Lkotlin/jvm/functions/Function4;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 321
    .end local v0    # "accumulator$iv":Ljava/lang/Object;
...
.method public static final aggregateTo(Lkotlin/collections/Grouping;Ljava/util/Map;Lkotlin/jvm/functions/Function4;)Ljava/util/Map;
    ...
    .line 73
    .local v0, "accumulator":Ljava/lang/Object;
    if-nez v0, :cond_0
    ...
    invoke-interface {p2, v2, v0, v1, v3}, Lkotlin/jvm/functions/Function4;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 75
    .end local v0    # "accumulator":Ljava/lang/Object;
...
.method public static final eachCount(Lkotlin/collections/Grouping;)Ljava/util/Map;
    ...
    .line 363
    .local v1, "$receiver$iv$iv":Lkotlin/collections/Grouping;
    invoke-interface {v1}, Lkotlin/collections/Grouping;->sourceIterator()Ljava/util/Iterator;

    move-result-object v8

    .end local p0    # "$receiver":Lkotlin/collections/Grouping;
    :goto_0
    ...
    .line 364
    .local v3, "e$iv$iv":Ljava/lang/Object;
    invoke-interface {v1, v3}, Lkotlin/collections/Grouping;->keyOf(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    .line 365
    .local v5, "key$iv$iv":Ljava/lang/Object;
    invoke-interface {v6, v5}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    .line 366
    .local v2, "accumulator$iv$iv":Ljava/lang/Object;
    if-nez v2, :cond_0
    ...
    .line 242
    .local v0, "$noName_0":Ljava/lang/Object;
    .local p0, "$receiver":Lkotlin/jvm/internal/Ref$IntRef;
    ...
    .line 366
    .end local v0    # "$noName_0":Ljava/lang/Object;
    .end local p0    # "$receiver":Lkotlin/jvm/internal/Ref$IntRef;
    :cond_0
    const/4 v7, 0x0

    goto :goto_1

    .restart local v4    # "key$iv":Ljava/lang/Object;
    :cond_1
    move-object p0, v2
    ...
    .end local v2    # "accumulator$iv$iv":Ljava/lang/Object;
    .end local v3    # "e$iv$iv":Ljava/lang/Object;
    .end local v5    # "key$iv$iv":Ljava/lang/Object;
    :cond_2
    nop
    ...
    const-string/jumbo v7, "null cannot be cast to non-null type kotlin.collections.MutableMap.MutableEntry<K, R>"
    ...
    :cond_3
    invoke-static {v7}, Lkotlin/jvm/internal/TypeIntrinsics;->asMutableMapEntry(Ljava/lang/Object;)Ljava/util/Map$Entry;
...
.method public static final eachCountTo(Lkotlin/collections/Grouping;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 369
    .local v5, "initialValue$iv":Ljava/lang/Integer;
    move-object v1, p0
    ...
    .line 372
    .local v4, "e$iv$iv":Ljava/lang/Object;
    invoke-interface {v1, v4}, Lkotlin/collections/Grouping;->keyOf(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    .line 373
    .local v6, "key$iv$iv":Ljava/lang/Object;
    invoke-interface {p1, v6}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    .line 374
    .local v3, "accumulator$iv$iv":Ljava/lang/Object;
    if-nez v3, :cond_0
    ...
    .line 370
    .local v0, "$noName_0$iv":Ljava/lang/Object;
    if-eqz v7, :cond_1
    ...
    .end local v0    # "$noName_0$iv":Ljava/lang/Object;
    .end local v2    # "acc":I
    :cond_0
    move v7, v8
    ...
    .restart local v0    # "$noName_0$iv":Ljava/lang/Object;
    :cond_1
    move-object v7, v3
    ...
    .end local v0    # "$noName_0$iv":Ljava/lang/Object;
    .end local v3    # "accumulator$iv$iv":Ljava/lang/Object;
    .end local v4    # "e$iv$iv":Ljava/lang/Object;
    .end local v6    # "key$iv$iv":Ljava/lang/Object;
    :cond_2
    nop
...
.method public static final fold(Lkotlin/collections/Grouping;Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)Ljava/util/Map;
    ...
    .line 338
    .local v4, "key$iv$iv":Ljava/lang/Object;
    ...
    .line 339
    .end local v0    # "$noName_0":Ljava/lang/Object;
    .restart local v2    # "accumulator$iv$iv":Ljava/lang/Object;
    :cond_1
    const/4 v6, 0x0
    ...
    .end local v2    # "accumulator$iv$iv":Ljava/lang/Object;
    .end local v3    # "e$iv$iv":Ljava/lang/Object;
    .end local v4    # "key$iv$iv":Ljava/lang/Object;
    :cond_2
    nop
...
.method public static final fold(Lkotlin/collections/Grouping;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    const-string/jumbo v5, "initialValueSelector"
    ...
    .line 322
    .local v0, "$receiver$iv":Lkotlin/collections/Grouping;
    new-instance v5, Ljava/util/LinkedHashMap;
    ...
    .line 324
    .local v2, "e$iv$iv":Ljava/lang/Object;
    ...
    .line 326
    .local v1, "accumulator$iv$iv":Ljava/lang/Object;
    if-nez v1, :cond_1
    ...
    .end local v1    # "accumulator$iv$iv":Ljava/lang/Object;
    :cond_0
    ...
    .restart local v1    # "accumulator$iv$iv":Ljava/lang/Object;
    :cond_1
    const/4 v6, 0x0
    ...
    .line 328
    .end local v1    # "accumulator$iv$iv":Ljava/lang/Object;
    .end local v2    # "e$iv$iv":Ljava/lang/Object;
    .end local v4    # "key$iv$iv":Ljava/lang/Object;
    :cond_2
    nop
...
.method public static final foldTo(Lkotlin/collections/Grouping;Ljava/util/Map;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    .line 332
    .end local v3    # "key":Ljava/lang/Object;
    .restart local v1    # "accumulator$iv":Ljava/lang/Object;
    :cond_1
    const/4 v5, 0x0
    ...
    .line 131
    .end local v1    # "accumulator$iv":Ljava/lang/Object;
    .end local v2    # "e$iv":Ljava/lang/Object;
    .end local v4    # "key$iv":Ljava/lang/Object;
    :cond_2
    return-object p1
.end method
...
.method private static final mapValuesInPlace(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    const-string/jumbo v4, "null cannot be cast to non-null type kotlin.collections.MutableMap.MutableEntry<K, R>"
    ...
    const-string/jumbo v4, "null cannot be cast to non-null type kotlin.collections.MutableMap<K, R>"
...
.method public static final reduce(Lkotlin/collections/Grouping;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    .line 352
    .end local v3    # "key":Ljava/lang/Object;
    .restart local v2    # "e$iv$iv":Ljava/lang/Object;
    :cond_0
    const/4 v6, 0x0
    ...
    :cond_1
    invoke-interface {p1, v3, v1, v2}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final reduceTo(Lkotlin/collections/Grouping;Ljava/util/Map;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    .line 358
    .end local v3    # "key":Ljava/lang/Object;
    .restart local v2    # "e$iv":Ljava/lang/Object;
    :cond_0
    const/4 v5, 0x0
