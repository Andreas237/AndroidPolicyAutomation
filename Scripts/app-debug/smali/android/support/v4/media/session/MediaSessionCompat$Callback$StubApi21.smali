...
.method public onCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    .line 1247
    :try_start_0
    const-string/jumbo v6, "android.support.v4.media.session.command.GET_EXTRA_BINDER"
    ...
    const-string/jumbo v6, "android.support.v4.media.session.EXTRA_BINDER"
...
.method public onCustomAction(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 1365
    const-string/jumbo v8, "android.support.v4.media.session.action.PLAY_FROM_URI"
    ...
    .line 1366
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_URI"
    ...
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_EXTRAS"
    ...
    .line 1369
    :cond_0
    const-string/jumbo v8, "android.support.v4.media.session.action.PREPARE"
    ...
    .line 1371
    :cond_1
    const-string/jumbo v8, "android.support.v4.media.session.action.PREPARE_FROM_MEDIA_ID"
    ...
    .line 1372
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_MEDIA_ID"
    ...
    :cond_2
    const-string/jumbo v8, "android.support.v4.media.session.action.PREPARE_FROM_SEARCH"
    ...
    .line 1376
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_QUERY"
    ...
    :cond_3
    const-string/jumbo v8, "android.support.v4.media.session.action.PREPARE_FROM_URI"
    ...
    .end local v7    # "uri":Landroid/net/Uri;
    :cond_4
    const-string/jumbo v8, "android.support.v4.media.session.action.SET_CAPTIONING_ENABLED"
    ...
    .line 1384
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_CAPTIONING_ENABLED"
    ...
    :cond_5
    const-string/jumbo v8, "android.support.v4.media.session.action.SET_REPEAT_MODE"
    ...
    .line 1387
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_REPEAT_MODE"
    ...
    :cond_6
    const-string/jumbo v8, "android.support.v4.media.session.action.SET_SHUFFLE_MODE_ENABLED"
    ...
    .line 1390
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_SHUFFLE_MODE_ENABLED"
    ...
    .end local v1    # "enabled":Z
    :cond_7
    const-string/jumbo v8, "android.support.v4.media.session.action.SET_SHUFFLE_MODE"
    ...
    .line 1393
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_SHUFFLE_MODE"
    ...
    :cond_8
    const-string/jumbo v8, "android.support.v4.media.session.action.SET_RATING"
    ...
    .line 1397
    const-string/jumbo v8, "android.support.v4.media.session.action.ARGUMENT_RATING"
